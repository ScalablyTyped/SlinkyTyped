...
object PlotMaplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMaplineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMaplineConnectorsStartMarkerOptionsOps[Self <: PlotMaplineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
