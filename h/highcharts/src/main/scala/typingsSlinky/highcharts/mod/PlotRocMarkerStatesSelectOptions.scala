...
object PlotRocMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotRocMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotRocMarkerStatesSelectOptionsOps[Self <: PlotRocMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
