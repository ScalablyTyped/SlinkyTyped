...
trait PlotBoxplotTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotBoxplotTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotBoxplotTooltipOptions {
  @scala.inline
  def apply(): PlotBoxplotTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotTooltipOptions]
  }
  @scala.inline
  implicit class PlotBoxplotTooltipOptionsOps[Self <: PlotBoxplotTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotBoxplotTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
