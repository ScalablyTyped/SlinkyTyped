...
object PlotTemaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTemaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTemaConnectorsStartMarkerOptionsOps[Self <: PlotTemaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
