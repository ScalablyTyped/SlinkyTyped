...
object PlotKeltnerchannelsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsConnectorsStartMarkerOptionsOps[Self <: PlotKeltnerchannelsConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
