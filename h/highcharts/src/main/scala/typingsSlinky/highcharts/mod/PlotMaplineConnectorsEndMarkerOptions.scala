...
object PlotMaplineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMaplineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMaplineConnectorsEndMarkerOptionsOps[Self <: PlotMaplineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
