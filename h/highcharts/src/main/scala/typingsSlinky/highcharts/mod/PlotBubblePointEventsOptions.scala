...
@js.native
trait PlotBubblePointEventsOptions extends js.Object {
  /**
...
object PlotBubblePointEventsOptions {
  @scala.inline
  def apply(): PlotBubblePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubblePointEventsOptions]
  }
  @scala.inline
  implicit class PlotBubblePointEventsOptionsOps[Self <: PlotBubblePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
