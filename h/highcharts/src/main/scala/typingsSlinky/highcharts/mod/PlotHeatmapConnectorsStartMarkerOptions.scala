...
object PlotHeatmapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotHeatmapConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotHeatmapConnectorsStartMarkerOptionsOps[Self <: PlotHeatmapConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
