...
object SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesNetworkgraphDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesNetworkgraphDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
