...
object YAxisDateTimeLabelFormatsHourOptions {
  @scala.inline
  def apply(): YAxisDateTimeLabelFormatsHourOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisDateTimeLabelFormatsHourOptions]
  }
  @scala.inline
  implicit class YAxisDateTimeLabelFormatsHourOptionsOps[Self <: YAxisDateTimeLabelFormatsHourOptions] (val x: Self) extends AnyVal {
    @scala.inline
