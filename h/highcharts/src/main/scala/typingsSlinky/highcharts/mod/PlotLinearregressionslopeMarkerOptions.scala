...
trait PlotLinearregressionslopeMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionslopeMarkerStatesOptions] = js.native
  /**
...
object PlotLinearregressionslopeMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeMarkerOptionsOps[Self <: PlotLinearregressionslopeMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotLinearregressionslopeMarkerStatesOptions): Self = {
        val ret = this.duplicate
