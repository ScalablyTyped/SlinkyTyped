...
object PlotPsarMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotPsarMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotPsarMarkerStatesInactiveOptionsOps[Self <: PlotPsarMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
