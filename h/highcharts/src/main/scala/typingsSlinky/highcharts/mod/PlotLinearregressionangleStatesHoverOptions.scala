...
trait PlotLinearregressionangleStatesHoverOptions extends js.Object {
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionangleStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressionangleStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleStatesHoverOptionsOps[Self <: PlotLinearregressionangleStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressionangleStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
