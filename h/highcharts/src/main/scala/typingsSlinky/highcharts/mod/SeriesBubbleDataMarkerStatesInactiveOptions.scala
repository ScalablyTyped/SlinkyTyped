...
object SeriesBubbleDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesBubbleDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataMarkerStatesInactiveOptionsOps[Self <: SeriesBubbleDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
