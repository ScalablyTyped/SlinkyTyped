...
trait PlotPyramid3dDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotPyramid3dDragDropDragHandleOptions] = js.native
  /**
...
object PlotPyramid3dDragDropOptions {
  @scala.inline
  def apply(): PlotPyramid3dDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dDragDropOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dDragDropOptionsOps[Self <: PlotPyramid3dDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotPyramid3dDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotPyramid3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
