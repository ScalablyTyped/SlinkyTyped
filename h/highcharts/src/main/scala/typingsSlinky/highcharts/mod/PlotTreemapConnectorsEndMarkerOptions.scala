...
object PlotTreemapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTreemapConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTreemapConnectorsEndMarkerOptionsOps[Self <: PlotTreemapConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
