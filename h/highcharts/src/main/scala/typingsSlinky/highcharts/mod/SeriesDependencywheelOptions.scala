...
trait SeriesDependencywheelOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[SeriesDependencywheelDataOptions]] = js.native
  /**
    * Not available
    */
  ...
  /**
    ...
    * `id`.
    */
  var nodes: js.UndefOr[js.Array[SeriesDependencywheelNodesOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesDependencywheelOptions {
  ...
  implicit class SeriesDependencywheelOptionsOps[Self <: SeriesDependencywheelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | dependencywheel): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBorderRadius(value: scala.Nothing): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withData(value: js.Array[SeriesDependencywheelDataOptions]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEdgeWidth(value: scala.Nothing): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNodes(value: js.Array[SeriesDependencywheelNodesOptions]): Self = {
        val ret = this.duplicate
