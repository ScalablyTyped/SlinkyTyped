...
trait PlotVennAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVennAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVennAccessibilityOptions {
  @scala.inline
  def apply(): PlotVennAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVennAccessibilityOptionsOps[Self <: PlotVennAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVennAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
