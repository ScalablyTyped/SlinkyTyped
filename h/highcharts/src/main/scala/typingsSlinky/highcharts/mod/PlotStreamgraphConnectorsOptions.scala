...
trait PlotStreamgraphConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotStreamgraphConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotStreamgraphConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotStreamgraphConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotStreamgraphConnectorsOptions {
  @scala.inline
  def apply(): PlotStreamgraphConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphConnectorsOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphConnectorsOptionsOps[Self <: PlotStreamgraphConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotStreamgraphConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotStreamgraphConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotStreamgraphConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
