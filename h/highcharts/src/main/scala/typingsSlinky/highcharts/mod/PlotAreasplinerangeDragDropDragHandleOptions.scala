...
@js.native
trait PlotAreasplinerangeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAreasplinerangeDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeDragDropDragHandleOptionsOps[Self <: PlotAreasplinerangeDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
