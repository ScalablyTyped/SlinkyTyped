...
@js.native
trait PlotAoDataSortingOptions extends js.Object {
...
object PlotAoDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotAoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAoDataSortingOptionsOps[Self <: PlotAoDataSortingOptions] (val x: Self) extends AnyVal {
