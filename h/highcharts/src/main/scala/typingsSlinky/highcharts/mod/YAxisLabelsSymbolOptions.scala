...
@js.native
trait YAxisLabelsSymbolOptions extends StObject {
...
object YAxisLabelsSymbolOptions {
  ...
  @scala.inline
  implicit class YAxisLabelsSymbolOptionsMutableBuilder[Self <: YAxisLabelsSymbolOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: SymbolKeyValue): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
