...
trait PlotDpoConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDpoConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDpoConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDpoConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotDpoConnectorsOptions {
  @scala.inline
  def apply(): PlotDpoConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoConnectorsOptions]
  }
  @scala.inline
  implicit class PlotDpoConnectorsOptionsOps[Self <: PlotDpoConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotDpoConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotDpoConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotDpoConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
