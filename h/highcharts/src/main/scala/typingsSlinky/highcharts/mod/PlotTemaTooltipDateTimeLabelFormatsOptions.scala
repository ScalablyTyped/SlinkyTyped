...
object PlotTemaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotTemaTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotTemaTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotTemaTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
