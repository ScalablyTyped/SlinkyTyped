...
@js.native
trait PlotScatterDataSortingOptions extends js.Object {
  /**
...
object PlotScatterDataSortingOptions {
  @scala.inline
  def apply(): PlotScatterDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterDataSortingOptions]
  }
  @scala.inline
  implicit class PlotScatterDataSortingOptionsOps[Self <: PlotScatterDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
