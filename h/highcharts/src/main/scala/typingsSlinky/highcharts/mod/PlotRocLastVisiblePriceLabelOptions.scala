...
object PlotRocLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotRocLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotRocLastVisiblePriceLabelOptionsOps[Self <: PlotRocLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
