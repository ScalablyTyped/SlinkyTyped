...
@js.native
trait PlotLinearregressionangleMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotLinearregressionangleMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleMarkerStatesHoverOptionsOps[Self <: PlotLinearregressionangleMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
