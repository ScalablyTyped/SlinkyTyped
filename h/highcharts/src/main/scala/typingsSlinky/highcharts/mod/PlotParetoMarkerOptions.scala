...
trait PlotParetoMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotParetoMarkerStatesOptions] = js.native
  /**
...
object PlotParetoMarkerOptions {
  @scala.inline
  def apply(): PlotParetoMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoMarkerOptions]
  }
  @scala.inline
  implicit class PlotParetoMarkerOptionsOps[Self <: PlotParetoMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotParetoMarkerStatesOptions): Self = {
        val ret = this.duplicate
