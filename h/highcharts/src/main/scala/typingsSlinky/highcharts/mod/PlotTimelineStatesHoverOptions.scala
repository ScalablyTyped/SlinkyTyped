...
trait PlotTimelineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTimelineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTimelineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotTimelineStatesHoverOptions {
  @scala.inline
  def apply(): PlotTimelineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTimelineStatesHoverOptionsOps[Self <: PlotTimelineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotTimelineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTimelineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
