...
trait PlotCandlestickStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotCandlestickStatesHoverOptions] = js.native
  /**
    * (Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotCandlestickStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotCandlestickStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotCandlestickStatesSelectOptions] = js.native
}

object PlotCandlestickStatesOptions {
  @scala.inline
  def apply(): PlotCandlestickStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickStatesOptions]
  }
  @scala.inline
  implicit class PlotCandlestickStatesOptionsOps[Self <: PlotCandlestickStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotCandlestickStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotCandlestickStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotCandlestickStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotCandlestickStatesSelectOptions): Self = {
        val ret = this.duplicate
