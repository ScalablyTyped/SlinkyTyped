...
@js.native
trait PlotLinearregressionangleTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotLinearregressionangleTooltipOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleTooltipOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleTooltipOptionsOps[Self <: PlotLinearregressionangleTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
