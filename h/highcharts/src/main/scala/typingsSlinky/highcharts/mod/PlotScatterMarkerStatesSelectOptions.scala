...
object PlotScatterMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotScatterMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotScatterMarkerStatesSelectOptionsOps[Self <: PlotScatterMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
