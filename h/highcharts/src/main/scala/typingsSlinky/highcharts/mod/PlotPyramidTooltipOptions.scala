...
trait PlotPyramidTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPyramidTooltipOptions {
  @scala.inline
  def apply(): PlotPyramidTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidTooltipOptions]
  }
  @scala.inline
  implicit class PlotPyramidTooltipOptionsOps[Self <: PlotPyramidTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
