...
object SeriesAreaRangeDataLabelsOptionsObject {
  ...
  @scala.inline
  implicit class SeriesAreaRangeDataLabelsOptionsObjectMutableBuilder[Self <: SeriesAreaRangeDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(
      value: Boolean | PlotArearangeDataLabelsAnimationOptions | PlotAreasplinerangeDataLabelsAnimationOptions | PlotColumnrangeDataLabelsAnimationOptions | PlotDumbbellDataLabelsAnimationOptions | PlotLollipopDataLabelsAnimationOptions | PartialAnimationOptionsOb
    ...
    @scala.inline
    def setXHigh(value: Double): Self = StObject.set(x, "xHigh", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setXHighUndefined: Self = StObject.set(x, "xHigh", js.undefined)
    
    @scala.inline
    def setXLow(value: Double): Self = StObject.set(x, "xLow", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setXLowUndefined: Self = StObject.set(x, "xLow", js.undefined)
    ...
    @scala.inline
    def setYHigh(value: Double): Self = StObject.set(x, "yHigh", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setYHighUndefined: Self = StObject.set(x, "yHigh", js.undefined)
    
    @scala.inline
    def setYLow(value: Double): Self = StObject.set(x, "yLow", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setYLowUndefined: Self = StObject.set(x, "yLow", js.undefined)
