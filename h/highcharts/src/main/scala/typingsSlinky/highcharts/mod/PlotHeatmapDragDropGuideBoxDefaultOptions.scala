...
object PlotHeatmapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotHeatmapDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotHeatmapDragDropGuideBoxDefaultOptionsOps[Self <: PlotHeatmapDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
