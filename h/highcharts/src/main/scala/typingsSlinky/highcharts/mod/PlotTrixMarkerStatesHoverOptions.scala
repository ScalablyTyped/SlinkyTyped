...
@js.native
trait PlotTrixMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotTrixMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotTrixMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTrixMarkerStatesHoverOptionsOps[Self <: PlotTrixMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
