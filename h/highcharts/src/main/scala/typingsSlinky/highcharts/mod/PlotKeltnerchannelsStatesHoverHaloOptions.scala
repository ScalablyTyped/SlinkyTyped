...
@js.native
trait PlotKeltnerchannelsStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesHoverHaloOptionsOps[Self <: PlotKeltnerchannelsStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
