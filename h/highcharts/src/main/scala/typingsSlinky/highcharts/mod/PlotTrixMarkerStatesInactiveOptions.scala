...
object PlotTrixMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotTrixMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotTrixMarkerStatesInactiveOptionsOps[Self <: PlotTrixMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
