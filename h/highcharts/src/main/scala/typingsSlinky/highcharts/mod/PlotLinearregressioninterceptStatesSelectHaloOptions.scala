...
object PlotLinearregressioninterceptStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptStatesSelectHaloOptionsOps[Self <: PlotLinearregressioninterceptStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
