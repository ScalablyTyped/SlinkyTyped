...
@js.native
trait PlotMfiConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMfiConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMfiConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMfiConnectorsMarkerOptionsOps[Self <: PlotMfiConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
