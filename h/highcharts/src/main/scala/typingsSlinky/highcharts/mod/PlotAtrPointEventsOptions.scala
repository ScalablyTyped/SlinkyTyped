...
@js.native
trait PlotAtrPointEventsOptions extends js.Object {
  /**
...
object PlotAtrPointEventsOptions {
  @scala.inline
  def apply(): PlotAtrPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrPointEventsOptions]
  }
  @scala.inline
  implicit class PlotAtrPointEventsOptionsOps[Self <: PlotAtrPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
