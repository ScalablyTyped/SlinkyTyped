...
object PlotLinearregressionslopePointEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopePointEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopePointEventsOptionsOps[Self <: PlotLinearregressionslopePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
