...
trait PlotBubbleTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotBubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotBubbleTooltipOptions {
  @scala.inline
  def apply(): PlotBubbleTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleTooltipOptions]
  }
  @scala.inline
  implicit class PlotBubbleTooltipOptionsOps[Self <: PlotBubbleTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotBubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
