...
object PlotFunnelOptions {
  ...
  implicit class PlotFunnelOptionsOps[Self <: PlotFunnelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotFunnelAnimationOptions): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNeckHeight(value: Double | String): Self = this.set("neckHeight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNeckHeight: Self = this.set("neckHeight", js.undefined)
    
    @scala.inline
    def setNeckWidth(value: Double | String): Self = this.set("neckWidth", value.asInstanceOf[js.Any])
