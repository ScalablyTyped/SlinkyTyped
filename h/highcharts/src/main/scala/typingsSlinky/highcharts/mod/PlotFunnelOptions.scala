...
@js.native
trait PlotFunnelOptions extends StObject {
...
object PlotFunnelOptions {
  ...
  @scala.inline
  implicit class PlotFunnelOptionsMutableBuilder[Self <: PlotFunnelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotFunnelAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
