...
object PlotBellcurveMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotBellcurveMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotBellcurveMarkerStatesInactiveOptionsOps[Self <: PlotBellcurveMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
