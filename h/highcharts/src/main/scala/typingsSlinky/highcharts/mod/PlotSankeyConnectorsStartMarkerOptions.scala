...
object PlotSankeyConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSankeyConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSankeyConnectorsStartMarkerOptionsOps[Self <: PlotSankeyConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
