...
trait PlotSupertrendMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSupertrendMarkerStatesOptions] = js.native
  /**
...
object PlotSupertrendMarkerOptions {
  @scala.inline
  def apply(): PlotSupertrendMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendMarkerOptions]
  }
  @scala.inline
  implicit class PlotSupertrendMarkerOptionsOps[Self <: PlotSupertrendMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotSupertrendMarkerStatesOptions): Self = {
        val ret = this.duplicate
