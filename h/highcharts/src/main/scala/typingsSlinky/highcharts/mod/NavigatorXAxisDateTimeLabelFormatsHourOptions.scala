...
object NavigatorXAxisDateTimeLabelFormatsHourOptions {
  @scala.inline
  def apply(): NavigatorXAxisDateTimeLabelFormatsHourOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisDateTimeLabelFormatsHourOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisDateTimeLabelFormatsHourOptionsOps[Self <: NavigatorXAxisDateTimeLabelFormatsHourOptions] (val x: Self) extends AnyVal {
    @scala.inline
