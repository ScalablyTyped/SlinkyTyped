...
@js.native
trait PlotTrixMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTrixMarkerStatesOptions] = js.native
  /**
...
object PlotTrixMarkerOptions {
  @scala.inline
  def apply(): PlotTrixMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrixMarkerOptionsOps[Self <: PlotTrixMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotTrixMarkerStatesOptions): Self = {
        val ret = this.duplicate
