...
trait PlotIkhStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotIkhStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotIkhStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotIkhStatesHoverOptions {
  @scala.inline
  def apply(): PlotIkhStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotIkhStatesHoverOptionsOps[Self <: PlotIkhStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotIkhStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotIkhStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
