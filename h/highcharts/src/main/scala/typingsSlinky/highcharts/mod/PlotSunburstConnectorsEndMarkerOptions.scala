...
object PlotSunburstConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSunburstConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSunburstConnectorsEndMarkerOptionsOps[Self <: PlotSunburstConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
