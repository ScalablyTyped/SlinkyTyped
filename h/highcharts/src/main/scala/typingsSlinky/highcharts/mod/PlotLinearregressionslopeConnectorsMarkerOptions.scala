...
object PlotLinearregressionslopeConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeConnectorsMarkerOptionsOps[Self <: PlotLinearregressionslopeConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
