...
@js.native
trait PlotScatter3dEventsOptions extends js.Object {
  /**
...
object PlotScatter3dEventsOptions {
  @scala.inline
  def apply(): PlotScatter3dEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dEventsOptions]
  }
  @scala.inline
  implicit class PlotScatter3dEventsOptionsOps[Self <: PlotScatter3dEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
