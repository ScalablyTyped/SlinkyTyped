...
object PlotPackedbubbleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPackedbubbleConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleConnectorsEndMarkerOptionsOps[Self <: PlotPackedbubbleConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
