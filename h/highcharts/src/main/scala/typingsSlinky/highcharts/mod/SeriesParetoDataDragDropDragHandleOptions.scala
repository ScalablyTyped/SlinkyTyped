...
object SeriesParetoDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesParetoDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesParetoDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesParetoDataDragDropDragHandleOptionsOps[Self <: SeriesParetoDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
