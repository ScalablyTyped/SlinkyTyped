...
object PlotAbandsMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAbandsMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAbandsMarkerStatesHoverOptionsOps[Self <: PlotAbandsMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
