...
object PlotLinearregressioninterceptConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptConnectorsEndMarkerOptionsOps[Self <: PlotLinearregressioninterceptConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
