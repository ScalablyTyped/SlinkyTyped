...
@js.native
trait SeriesGaugeDataEventsOptions extends js.Object {
  /**
...
object SeriesGaugeDataEventsOptions {
  @scala.inline
  def apply(): SeriesGaugeDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGaugeDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesGaugeDataEventsOptionsOps[Self <: SeriesGaugeDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
