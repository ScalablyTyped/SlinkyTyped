...
@js.native
trait PlotColumnpyramidPointEventsOptions extends js.Object {
  /**
...
object PlotColumnpyramidPointEventsOptions {
  @scala.inline
  def apply(): PlotColumnpyramidPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidPointEventsOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidPointEventsOptionsOps[Self <: PlotColumnpyramidPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
