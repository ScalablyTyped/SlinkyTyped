...
object PlotCciMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotCciMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotCciMarkerStatesHoverOptionsOps[Self <: PlotCciMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
