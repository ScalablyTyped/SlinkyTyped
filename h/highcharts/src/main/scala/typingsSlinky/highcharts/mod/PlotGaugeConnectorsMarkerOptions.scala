...
object PlotGaugeConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotGaugeConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotGaugeConnectorsMarkerOptionsOps[Self <: PlotGaugeConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
