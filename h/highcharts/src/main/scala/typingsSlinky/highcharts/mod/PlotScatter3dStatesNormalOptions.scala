...
object PlotScatter3dStatesNormalOptions {
  @scala.inline
  def apply(): PlotScatter3dStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotScatter3dStatesNormalOptionsOps[Self <: PlotScatter3dStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
