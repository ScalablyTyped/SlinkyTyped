...
object SeriesFunnel3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesFunnel3dDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFunnel3dDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesFunnel3dDataDragDropDragHandleOptionsOps[Self <: SeriesFunnel3dDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
