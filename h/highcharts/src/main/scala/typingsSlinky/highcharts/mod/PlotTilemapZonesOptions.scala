...
@js.native
trait PlotTilemapZonesOptions extends js.Object {
  /**
...
object PlotTilemapZonesOptions {
  @scala.inline
  def apply(): PlotTilemapZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapZonesOptions]
  }
  @scala.inline
  implicit class PlotTilemapZonesOptionsOps[Self <: PlotTilemapZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
