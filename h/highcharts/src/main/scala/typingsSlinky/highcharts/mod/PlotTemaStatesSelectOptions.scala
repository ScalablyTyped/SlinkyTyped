...
trait PlotTemaStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotTemaStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTemaStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotTemaStatesSelectOptions {
  @scala.inline
  def apply(): PlotTemaStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTemaStatesSelectOptionsOps[Self <: PlotTemaStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotTemaStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTemaStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
