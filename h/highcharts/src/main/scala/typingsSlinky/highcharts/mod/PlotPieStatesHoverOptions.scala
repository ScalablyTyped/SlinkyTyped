...
trait PlotPieStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPieStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPieStatesHoverHaloOptions | Null] = js.native
}

object PlotPieStatesHoverOptions {
  @scala.inline
  def apply(): PlotPieStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPieStatesHoverOptionsOps[Self <: PlotPieStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPieStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPieStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
