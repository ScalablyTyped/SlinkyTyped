...
object PlotEmaStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotEmaStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotEmaStatesSelectHaloOptionsOps[Self <: PlotEmaStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
