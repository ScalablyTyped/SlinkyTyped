...
object PlotSplineMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotSplineMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotSplineMarkerStatesInactiveOptionsOps[Self <: PlotSplineMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
