...
trait PlotVariwideTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotVariwideTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotVariwideTooltipOptions {
  @scala.inline
  def apply(): PlotVariwideTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideTooltipOptions]
  }
  @scala.inline
  implicit class PlotVariwideTooltipOptionsOps[Self <: PlotVariwideTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotVariwideTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
