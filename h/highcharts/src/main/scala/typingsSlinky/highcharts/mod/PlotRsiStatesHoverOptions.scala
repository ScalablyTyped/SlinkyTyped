...
trait PlotRsiStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRsiStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRsiStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotRsiStatesHoverOptions {
  @scala.inline
  def apply(): PlotRsiStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotRsiStatesHoverOptionsOps[Self <: PlotRsiStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotRsiStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotRsiStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
