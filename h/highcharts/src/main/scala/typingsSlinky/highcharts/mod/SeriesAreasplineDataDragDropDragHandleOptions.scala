...
object SeriesAreasplineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesAreasplineDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplineDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesAreasplineDataDragDropDragHandleOptionsOps[Self <: SeriesAreasplineDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
