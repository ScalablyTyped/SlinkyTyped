...
trait PlotVariablepieTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotVariablepieTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotVariablepieTooltipOptions {
  @scala.inline
  def apply(): PlotVariablepieTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieTooltipOptions]
  }
  @scala.inline
  implicit class PlotVariablepieTooltipOptionsOps[Self <: PlotVariablepieTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotVariablepieTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
