...
object PlotCylinderConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotCylinderConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotCylinderConnectorsStartMarkerOptionsOps[Self <: PlotCylinderConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
