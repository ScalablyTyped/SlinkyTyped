...
@js.native
trait PlotParetoStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotParetoStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotParetoStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotParetoStatesHoverHaloOptionsOps[Self <: PlotParetoStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
