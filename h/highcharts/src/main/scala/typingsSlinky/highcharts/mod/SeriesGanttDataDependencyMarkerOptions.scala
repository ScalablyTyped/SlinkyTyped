...
object SeriesGanttDataDependencyMarkerOptions {
  @scala.inline
  def apply(): SeriesGanttDataDependencyMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDependencyMarkerOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDependencyMarkerOptionsOps[Self <: SeriesGanttDataDependencyMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
