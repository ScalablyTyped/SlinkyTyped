...
object PlotAreasplinerangePointEventsOptions {
  @scala.inline
  def apply(): PlotAreasplinerangePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangePointEventsOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangePointEventsOptionsOps[Self <: PlotAreasplinerangePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
