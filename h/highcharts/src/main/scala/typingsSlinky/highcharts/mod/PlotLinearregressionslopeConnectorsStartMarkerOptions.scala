...
object PlotLinearregressionslopeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeConnectorsStartMarkerOptionsOps[Self <: PlotLinearregressionslopeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
