...
object PlotAtrStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotAtrStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotAtrStatesSelectAnimationOptionsOps[Self <: PlotAtrStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
