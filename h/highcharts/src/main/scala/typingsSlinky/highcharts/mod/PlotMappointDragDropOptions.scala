...
trait PlotMappointDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotMappointDragDropDragHandleOptions] = js.native
  /**
...
object PlotMappointDragDropOptions {
  @scala.inline
  def apply(): PlotMappointDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDragDropOptions]
  }
  @scala.inline
  implicit class PlotMappointDragDropOptionsOps[Self <: PlotMappointDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotMappointDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotMappointDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
