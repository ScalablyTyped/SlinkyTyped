...
@js.native
trait PlotAbandsStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotAbandsStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotAbandsStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotAbandsStatesHoverHaloOptionsOps[Self <: PlotAbandsStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
