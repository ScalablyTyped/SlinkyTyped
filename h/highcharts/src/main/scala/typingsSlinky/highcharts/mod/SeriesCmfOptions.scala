...
object SeriesCmfOptions {
  ...
  @scala.inline
  implicit class SeriesCmfOptionsMutableBuilder[Self <: SeriesCmfOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | cmf): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
