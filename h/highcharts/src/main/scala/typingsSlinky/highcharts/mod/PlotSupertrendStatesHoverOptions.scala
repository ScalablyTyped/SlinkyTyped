...
trait PlotSupertrendStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSupertrendStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSupertrendStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotSupertrendStatesHoverOptions {
  @scala.inline
  def apply(): PlotSupertrendStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSupertrendStatesHoverOptionsOps[Self <: PlotSupertrendStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSupertrendStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSupertrendStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
