...
@js.native
trait PlotAdDataSortingOptions extends StObject {
...
object PlotAdDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAdDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAdDataSortingOptionsMutableBuilder[Self <: PlotAdDataSortingOptions] (val x: Self) extends AnyVal {
