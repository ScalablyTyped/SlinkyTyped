...
trait SeriesScatter3dDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesScatter3dDataMarkerStatesOptions] = js.native
  /**
...
object SeriesScatter3dDataMarkerOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataMarkerOptionsOps[Self <: SeriesScatter3dDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesScatter3dDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
