...
@js.native
trait PlotSankeyPointEventsOptions extends js.Object {
  /**
...
object PlotSankeyPointEventsOptions {
  @scala.inline
  def apply(): PlotSankeyPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyPointEventsOptions]
  }
  @scala.inline
  implicit class PlotSankeyPointEventsOptionsOps[Self <: PlotSankeyPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
