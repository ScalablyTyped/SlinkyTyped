...
object PlotStreamgraphMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotStreamgraphMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphMarkerStatesNormalOptionsOps[Self <: PlotStreamgraphMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
