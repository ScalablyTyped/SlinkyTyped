...
trait PlotTreemapConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTreemapConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTreemapConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTreemapConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotTreemapConnectorsOptions {
  @scala.inline
  def apply(): PlotTreemapConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapConnectorsOptions]
  }
  @scala.inline
  implicit class PlotTreemapConnectorsOptionsOps[Self <: PlotTreemapConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotTreemapConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotTreemapConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotTreemapConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
