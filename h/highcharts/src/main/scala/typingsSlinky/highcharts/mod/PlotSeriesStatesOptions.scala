...
trait PlotSeriesStatesOptions extends js.Object {
  /**
    ...
    * over or touched.
    */
  var hover: js.UndefOr[PlotSeriesStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock, Highmaps, Gantt) The opposite state of a hover
    * for series.
    */
  var inactive: js.UndefOr[PlotSeriesStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotSeriesStatesNormalOptions] = js.native
  /**
    ...
    * programmatically.
    */
  var select: js.UndefOr[PlotSeriesStatesSelectOptions] = js.native
}

object PlotSeriesStatesOptions {
  @scala.inline
  def apply(): PlotSeriesStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesStatesOptions]
  }
  @scala.inline
  implicit class PlotSeriesStatesOptionsOps[Self <: PlotSeriesStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotSeriesStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotSeriesStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotSeriesStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotSeriesStatesSelectOptions): Self = {
        val ret = this.duplicate
