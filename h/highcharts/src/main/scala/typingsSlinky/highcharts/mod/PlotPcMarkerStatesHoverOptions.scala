...
@js.native
trait PlotPcMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotPcMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPcMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPcMarkerStatesHoverOptionsOps[Self <: PlotPcMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
