...
@js.native
trait PlotWilliamsrEventsOptions extends js.Object {
  /**
...
object PlotWilliamsrEventsOptions {
  @scala.inline
  def apply(): PlotWilliamsrEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrEventsOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrEventsOptionsOps[Self <: PlotWilliamsrEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
