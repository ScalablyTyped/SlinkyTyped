...
object SeriesParetoDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesParetoDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesParetoDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesParetoDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesParetoDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
