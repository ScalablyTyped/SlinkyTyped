...
@js.native
trait PlotBarConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBarConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotBarConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotBarConnectorsMarkerOptionsOps[Self <: PlotBarConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
