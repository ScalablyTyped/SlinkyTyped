...
object SeriesPyramidDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesPyramidDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramidDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesPyramidDataDragDropDragHandleOptionsOps[Self <: SeriesPyramidDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
