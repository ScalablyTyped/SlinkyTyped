...
object PlotAroonoscillatorMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorMarkerStatesHoverOptionsOps[Self <: PlotAroonoscillatorMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
