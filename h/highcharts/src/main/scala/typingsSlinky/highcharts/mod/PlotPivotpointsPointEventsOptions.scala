...
@js.native
trait PlotPivotpointsPointEventsOptions extends js.Object {
  /**
...
object PlotPivotpointsPointEventsOptions {
  @scala.inline
  def apply(): PlotPivotpointsPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsPointEventsOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsPointEventsOptionsOps[Self <: PlotPivotpointsPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
