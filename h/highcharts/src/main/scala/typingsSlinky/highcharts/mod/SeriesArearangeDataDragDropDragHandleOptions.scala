...
object SeriesArearangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesArearangeDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesArearangeDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesArearangeDataDragDropDragHandleOptionsOps[Self <: SeriesArearangeDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
