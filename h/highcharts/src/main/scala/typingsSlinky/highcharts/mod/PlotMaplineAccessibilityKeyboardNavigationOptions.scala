...
object PlotMaplineAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotMaplineAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotMaplineAccessibilityKeyboardNavigationOptionsOps[Self <: PlotMaplineAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
