...
@js.native
trait SeriesLollipopDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesLollipopDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesLollipopDataDataLabelsAnimationOptionsOps[Self <: SeriesLollipopDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
