...
trait PlotBbTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotBbTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotBbTooltipOptions {
  @scala.inline
  def apply(): PlotBbTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbTooltipOptions]
  }
  @scala.inline
  implicit class PlotBbTooltipOptionsOps[Self <: PlotBbTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotBbTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
