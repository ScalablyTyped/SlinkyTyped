...
trait PlotMapbubbleAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMapbubbleAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMapbubbleAccessibilityOptions {
  @scala.inline
  def apply(): PlotMapbubbleAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleAccessibilityOptionsOps[Self <: PlotMapbubbleAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMapbubbleAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
