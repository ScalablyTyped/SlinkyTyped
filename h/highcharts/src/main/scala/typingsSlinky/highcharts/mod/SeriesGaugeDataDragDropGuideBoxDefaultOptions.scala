...
object SeriesGaugeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesGaugeDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGaugeDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesGaugeDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesGaugeDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
