...
@js.native
trait PlotSeriesStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotSeriesStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotSeriesStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotSeriesStatesHoverHaloOptionsOps[Self <: PlotSeriesStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
