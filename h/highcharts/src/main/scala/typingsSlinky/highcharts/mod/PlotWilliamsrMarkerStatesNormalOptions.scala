...
object PlotWilliamsrMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotWilliamsrMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrMarkerStatesNormalOptionsOps[Self <: PlotWilliamsrMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
