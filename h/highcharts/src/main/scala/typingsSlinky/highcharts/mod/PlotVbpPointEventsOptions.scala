...
@js.native
trait PlotVbpPointEventsOptions extends js.Object {
  /**
...
object PlotVbpPointEventsOptions {
  @scala.inline
  def apply(): PlotVbpPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpPointEventsOptions]
  }
  @scala.inline
  implicit class PlotVbpPointEventsOptionsOps[Self <: PlotVbpPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
