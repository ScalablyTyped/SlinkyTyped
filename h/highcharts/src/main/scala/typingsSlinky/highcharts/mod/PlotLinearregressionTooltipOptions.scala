...
@js.native
trait PlotLinearregressionTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotLinearregressionTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotLinearregressionTooltipOptions {
  @scala.inline
  def apply(): PlotLinearregressionTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionTooltipOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionTooltipOptionsOps[Self <: PlotLinearregressionTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotLinearregressionTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
