...
object PlotHistogramConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotHistogramConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotHistogramConnectorsEndMarkerOptionsOps[Self <: PlotHistogramConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
