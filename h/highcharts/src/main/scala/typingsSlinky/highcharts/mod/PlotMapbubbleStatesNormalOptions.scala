...
object PlotMapbubbleStatesNormalOptions {
  @scala.inline
  def apply(): PlotMapbubbleStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleStatesNormalOptionsOps[Self <: PlotMapbubbleStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
