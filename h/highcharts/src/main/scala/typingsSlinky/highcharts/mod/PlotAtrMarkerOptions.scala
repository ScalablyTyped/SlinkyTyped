...
@js.native
trait PlotAtrMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAtrMarkerStatesOptions] = js.native
  /**
...
object PlotAtrMarkerOptions {
  @scala.inline
  def apply(): PlotAtrMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrMarkerOptions]
  }
  @scala.inline
  implicit class PlotAtrMarkerOptionsOps[Self <: PlotAtrMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAtrMarkerStatesOptions): Self = {
        val ret = this.duplicate
