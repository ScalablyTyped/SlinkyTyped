...
object PlotVariablepieDataGroupingOptions {
  @scala.inline
  def apply(): PlotVariablepieDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotVariablepieDataGroupingOptionsOps[Self <: PlotVariablepieDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
