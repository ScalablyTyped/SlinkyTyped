...
@js.native
trait PlotTemaDataSortingOptions extends js.Object {
...
object PlotTemaDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotTemaDataSortingOptionsOps[Self <: PlotTemaDataSortingOptions] (val x: Self) extends AnyVal {
