...
trait PlotOhlcStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotOhlcStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotOhlcStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotOhlcStatesHoverAnimationOptions = null,
