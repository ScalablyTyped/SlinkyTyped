...
@js.native
trait PlotOhlcStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotOhlcStatesHoverAnimationOptions] = js.native
  /**
...
object PlotOhlcStatesHoverOptions {
  @scala.inline
  def apply(): PlotOhlcStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotOhlcStatesHoverOptionsOps[Self <: PlotOhlcStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotOhlcStatesHoverAnimationOptions): Self = {
