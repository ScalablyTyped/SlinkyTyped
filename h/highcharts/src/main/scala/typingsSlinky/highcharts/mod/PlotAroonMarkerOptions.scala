...
trait PlotAroonMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonMarkerStatesOptions] = js.native
  /**
...
object PlotAroonMarkerOptions {
  @scala.inline
  def apply(): PlotAroonMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonMarkerOptionsOps[Self <: PlotAroonMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAroonMarkerStatesOptions): Self = {
        val ret = this.duplicate
