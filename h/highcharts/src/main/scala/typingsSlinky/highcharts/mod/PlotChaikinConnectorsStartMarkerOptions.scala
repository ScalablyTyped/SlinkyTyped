...
@js.native
trait PlotChaikinConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotChaikinConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotChaikinConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotChaikinConnectorsStartMarkerOptionsOps[Self <: PlotChaikinConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
