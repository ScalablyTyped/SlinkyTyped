...
trait PlotWilliamsrAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWilliamsrAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotWilliamsrAccessibilityOptions {
  @scala.inline
  def apply(): PlotWilliamsrAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrAccessibilityOptionsOps[Self <: PlotWilliamsrAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotWilliamsrAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
