...
@js.native
trait PlotGanttTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotGanttTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotGanttTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotGanttTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotGanttTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
