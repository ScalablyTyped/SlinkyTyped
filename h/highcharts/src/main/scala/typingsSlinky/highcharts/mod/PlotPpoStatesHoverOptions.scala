...
trait PlotPpoStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPpoStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPpoStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotPpoStatesHoverOptions {
  @scala.inline
  def apply(): PlotPpoStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPpoStatesHoverOptionsOps[Self <: PlotPpoStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPpoStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPpoStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
