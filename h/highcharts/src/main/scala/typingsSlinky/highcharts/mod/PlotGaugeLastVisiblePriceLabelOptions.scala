...
object PlotGaugeLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotGaugeLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotGaugeLastVisiblePriceLabelOptionsOps[Self <: PlotGaugeLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
