...
object PlotNatrStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotNatrStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotNatrStatesSelectHaloOptionsOps[Self <: PlotNatrStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
