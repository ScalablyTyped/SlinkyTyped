...
@js.native
trait PlotWmaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotWmaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotWmaTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotWmaTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotWmaTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
