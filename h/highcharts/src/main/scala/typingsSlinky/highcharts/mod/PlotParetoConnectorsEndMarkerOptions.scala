...
object PlotParetoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotParetoConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotParetoConnectorsEndMarkerOptionsOps[Self <: PlotParetoConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
