...
object PlotTimelineDataGroupingOptions {
  @scala.inline
  def apply(): PlotTimelineDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotTimelineDataGroupingOptionsOps[Self <: PlotTimelineDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
