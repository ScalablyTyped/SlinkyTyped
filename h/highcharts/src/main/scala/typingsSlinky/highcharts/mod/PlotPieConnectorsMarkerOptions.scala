...
@js.native
trait PlotPieConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPieConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPieConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPieConnectorsMarkerOptionsOps[Self <: PlotPieConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
