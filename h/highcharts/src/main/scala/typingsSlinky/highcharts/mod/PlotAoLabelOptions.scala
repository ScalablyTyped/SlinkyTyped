...
@js.native
trait PlotAoLabelOptions extends js.Object {
  /**
...
object PlotAoLabelOptions {
  @scala.inline
  def apply(): PlotAoLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoLabelOptions]
  }
  @scala.inline
  implicit class PlotAoLabelOptionsOps[Self <: PlotAoLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
