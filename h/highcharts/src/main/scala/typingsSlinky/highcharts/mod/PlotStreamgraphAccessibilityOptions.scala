...
@js.native
trait PlotStreamgraphAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotStreamgraphAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotStreamgraphAccessibilityOptions {
  @scala.inline
  def apply(): PlotStreamgraphAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphAccessibilityOptionsOps[Self <: PlotStreamgraphAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotStreamgraphAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
