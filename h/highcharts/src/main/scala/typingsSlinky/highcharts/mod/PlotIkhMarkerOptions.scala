...
trait PlotIkhMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotIkhMarkerStatesOptions] = js.native
  /**
...
object PlotIkhMarkerOptions {
  @scala.inline
  def apply(): PlotIkhMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhMarkerOptions]
  }
  @scala.inline
  implicit class PlotIkhMarkerOptionsOps[Self <: PlotIkhMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotIkhMarkerStatesOptions): Self = {
        val ret = this.duplicate
