...
@js.native
trait PlotPolygonConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPolygonConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPolygonConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPolygonConnectorsEndMarkerOptionsOps[Self <: PlotPolygonConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
