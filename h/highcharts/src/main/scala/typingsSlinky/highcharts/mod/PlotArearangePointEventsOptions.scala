...
object PlotArearangePointEventsOptions {
  @scala.inline
  def apply(): PlotArearangePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangePointEventsOptions]
  }
  @scala.inline
  implicit class PlotArearangePointEventsOptionsOps[Self <: PlotArearangePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
