...
trait PlotAdAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAdAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAdAccessibilityOptions {
  @scala.inline
  def apply(): PlotAdAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAdAccessibilityOptionsOps[Self <: PlotAdAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAdAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
