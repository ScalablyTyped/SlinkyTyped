...
@js.native
trait PlotPriceenvelopesAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPriceenvelopesAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPriceenvelopesAccessibilityOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesAccessibilityOptionsOps[Self <: PlotPriceenvelopesAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPriceenvelopesAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
