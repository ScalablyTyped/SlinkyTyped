...
@js.native
trait PlotPyramid3dDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPyramid3dDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotPyramid3dDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dDragDropGuideBoxDefaultOptionsOps[Self <: PlotPyramid3dDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
