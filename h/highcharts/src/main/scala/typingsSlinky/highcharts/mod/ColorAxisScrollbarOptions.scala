...
@js.native
trait ColorAxisScrollbarOptions extends StObject {
...
object ColorAxisScrollbarOptions {
  ...
  @scala.inline
  implicit class ColorAxisScrollbarOptionsMutableBuilder[Self <: ColorAxisScrollbarOptions] (val x: Self) extends AnyVal {
