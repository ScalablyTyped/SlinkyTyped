...
@js.native
trait PlotTilemapConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTilemapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTilemapConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTilemapConnectorsStartMarkerOptionsOps[Self <: PlotTilemapConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
