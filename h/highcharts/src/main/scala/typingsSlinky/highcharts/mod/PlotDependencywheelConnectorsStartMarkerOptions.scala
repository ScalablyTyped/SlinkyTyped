...
object PlotDependencywheelConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotDependencywheelConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelConnectorsStartMarkerOptionsOps[Self <: PlotDependencywheelConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
