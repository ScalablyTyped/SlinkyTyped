...
object PlotBellcurveConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotBellcurveConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotBellcurveConnectorsStartMarkerOptionsOps[Self <: PlotBellcurveConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
