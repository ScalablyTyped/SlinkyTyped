...
object PlotScatter3dMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotScatter3dMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotScatter3dMarkerStatesSelectOptionsOps[Self <: PlotScatter3dMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
