...
@js.native
trait PlotArearangeDataGroupingOptions extends js.Object {
  /**
...
object PlotArearangeDataGroupingOptions {
  @scala.inline
  def apply(): PlotArearangeDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotArearangeDataGroupingOptionsOps[Self <: PlotArearangeDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
