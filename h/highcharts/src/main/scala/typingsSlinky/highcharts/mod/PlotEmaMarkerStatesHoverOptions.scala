...
object PlotEmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotEmaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotEmaMarkerStatesHoverOptionsOps[Self <: PlotEmaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
