...
trait PlotCandlestickTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotCandlestickTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotCandlestickTooltipOptions {
  @scala.inline
  def apply(): PlotCandlestickTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickTooltipOptions]
  }
  @scala.inline
  implicit class PlotCandlestickTooltipOptionsOps[Self <: PlotCandlestickTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotCandlestickTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
