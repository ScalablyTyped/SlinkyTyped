...
object PlotItemStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotItemStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotItemStatesHoverHaloOptionsOps[Self <: PlotItemStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
