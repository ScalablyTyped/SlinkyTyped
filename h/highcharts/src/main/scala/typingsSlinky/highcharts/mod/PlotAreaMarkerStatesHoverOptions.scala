...
object PlotAreaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAreaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAreaMarkerStatesHoverOptionsOps[Self <: PlotAreaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
