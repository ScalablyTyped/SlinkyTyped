...
object PlotSupertrendConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSupertrendConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSupertrendConnectorsStartMarkerOptionsOps[Self <: PlotSupertrendConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
