...
object SeriesScatterDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesScatterDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataMarkerStatesHoverOptionsOps[Self <: SeriesScatterDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
