...
@js.native
trait PlotDependencywheelLevelsDataLabelsAnimationOptions extends js.Object {
...
object PlotDependencywheelLevelsDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotDependencywheelLevelsDataLabelsAnimationOptionsOps[Self <: PlotDependencywheelLevelsDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
