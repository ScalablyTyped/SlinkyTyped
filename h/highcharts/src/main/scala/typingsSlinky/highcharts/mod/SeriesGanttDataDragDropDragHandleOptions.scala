...
object SeriesGanttDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesGanttDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDragDropDragHandleOptionsOps[Self <: SeriesGanttDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
