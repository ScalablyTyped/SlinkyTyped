...
trait PlotMapbubbleConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMapbubbleConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMapbubbleConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMapbubbleConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotMapbubbleConnectorsOptions {
  @scala.inline
  def apply(): PlotMapbubbleConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleConnectorsOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleConnectorsOptionsOps[Self <: PlotMapbubbleConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotMapbubbleConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotMapbubbleConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotMapbubbleConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
