...
trait PlotZigzagConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotZigzagConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotZigzagConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotZigzagConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotZigzagConnectorsOptions {
  @scala.inline
  def apply(): PlotZigzagConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagConnectorsOptions]
  }
  @scala.inline
  implicit class PlotZigzagConnectorsOptionsOps[Self <: PlotZigzagConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotZigzagConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotZigzagConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotZigzagConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
