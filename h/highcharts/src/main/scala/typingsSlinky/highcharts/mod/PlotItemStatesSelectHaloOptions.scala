...
@js.native
trait PlotItemStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotItemStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotItemStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotItemStatesSelectHaloOptionsOps[Self <: PlotItemStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
