...
object PlotWaterfallConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotWaterfallConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotWaterfallConnectorsStartMarkerOptionsOps[Self <: PlotWaterfallConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
