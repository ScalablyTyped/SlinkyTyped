...
trait SeriesAreaDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesAreaDataMarkerStatesOptions] = js.native
  /**
...
object SeriesAreaDataMarkerOptions {
  @scala.inline
  def apply(): SeriesAreaDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataMarkerOptionsOps[Self <: SeriesAreaDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesAreaDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
