...
object PlotAtrConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAtrConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAtrConnectorsMarkerOptionsOps[Self <: PlotAtrConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
