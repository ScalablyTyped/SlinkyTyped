...
object PlotWmaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotWmaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotWmaMarkerStatesSelectOptionsOps[Self <: PlotWmaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
