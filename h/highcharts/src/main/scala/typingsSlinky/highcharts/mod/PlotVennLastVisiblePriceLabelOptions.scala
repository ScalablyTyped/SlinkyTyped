...
object PlotVennLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotVennLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotVennLastVisiblePriceLabelOptionsOps[Self <: PlotVennLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
