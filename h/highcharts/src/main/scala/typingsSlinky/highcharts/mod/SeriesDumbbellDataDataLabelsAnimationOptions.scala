...
@js.native
trait SeriesDumbbellDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesDumbbellDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesDumbbellDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesDumbbellDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesDumbbellDataDataLabelsAnimationOptionsOps[Self <: SeriesDumbbellDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
