...
object PlotMappointDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotMappointDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotMappointDragDropDragHandleOptionsOps[Self <: PlotMappointDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
