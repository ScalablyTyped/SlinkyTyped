...
@js.native
trait PlotMapbubbleLabelOptions extends js.Object {
  /**
...
object PlotMapbubbleLabelOptions {
  @scala.inline
  def apply(): PlotMapbubbleLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleLabelOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleLabelOptionsOps[Self <: PlotMapbubbleLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
