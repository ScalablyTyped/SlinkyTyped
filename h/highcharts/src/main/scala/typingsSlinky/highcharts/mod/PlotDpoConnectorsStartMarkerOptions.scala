...
object PlotDpoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotDpoConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotDpoConnectorsStartMarkerOptionsOps[Self <: PlotDpoConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
