...
@js.native
trait PlotWilliamsrMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotWilliamsrMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotWilliamsrMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrMarkerStatesHoverOptionsOps[Self <: PlotWilliamsrMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
