...
object PlotMomentumLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotMomentumLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotMomentumLastVisiblePriceLabelOptionsOps[Self <: PlotMomentumLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
