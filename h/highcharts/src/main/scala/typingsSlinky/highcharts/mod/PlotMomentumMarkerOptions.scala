...
trait PlotMomentumMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMomentumMarkerStatesOptions] = js.native
  /**
...
object PlotMomentumMarkerOptions {
  @scala.inline
  def apply(): PlotMomentumMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumMarkerOptions]
  }
  @scala.inline
  implicit class PlotMomentumMarkerOptionsOps[Self <: PlotMomentumMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotMomentumMarkerStatesOptions): Self = {
        val ret = this.duplicate
