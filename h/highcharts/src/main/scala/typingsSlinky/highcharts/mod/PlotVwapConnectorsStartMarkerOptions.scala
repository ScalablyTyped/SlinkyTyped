...
object PlotVwapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVwapConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVwapConnectorsStartMarkerOptionsOps[Self <: PlotVwapConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
