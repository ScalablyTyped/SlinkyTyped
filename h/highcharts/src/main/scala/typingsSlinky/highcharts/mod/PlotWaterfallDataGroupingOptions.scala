...
object PlotWaterfallDataGroupingOptions {
  @scala.inline
  def apply(): PlotWaterfallDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotWaterfallDataGroupingOptionsOps[Self <: PlotWaterfallDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
