...
trait SeriesGanttDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesGanttDataMarkerStatesOptions] = js.native
  /**
...
object SeriesGanttDataMarkerOptions {
  @scala.inline
  def apply(): SeriesGanttDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataMarkerOptionsOps[Self <: SeriesGanttDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesGanttDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
