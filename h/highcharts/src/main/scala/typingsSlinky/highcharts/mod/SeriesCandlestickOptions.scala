...
object SeriesCandlestickOptions {
  ...
  @scala.inline
  implicit class SeriesCandlestickOptionsOps[Self <: SeriesCandlestickOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | candlestick): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(
