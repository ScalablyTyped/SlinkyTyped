...
trait SeriesCandlestickOptions extends PlotCandlestickOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | candlestick = js.native
...
object SeriesCandlestickOptions {
  ...
  @scala.inline
  def apply(`type`: String | candlestick): SeriesCandlestickOptions = {
  ...
  @scala.inline
  implicit class SeriesCandlestickOptionsMutableBuilder[Self <: SeriesCandlestickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | candlestick): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
