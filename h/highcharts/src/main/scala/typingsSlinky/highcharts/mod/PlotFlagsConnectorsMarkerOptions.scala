...
object PlotFlagsConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotFlagsConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotFlagsConnectorsMarkerOptionsOps[Self <: PlotFlagsConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
