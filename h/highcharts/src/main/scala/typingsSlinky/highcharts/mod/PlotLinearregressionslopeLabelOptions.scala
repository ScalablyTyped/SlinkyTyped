...
object PlotLinearregressionslopeLabelOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeLabelOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeLabelOptionsOps[Self <: PlotLinearregressionslopeLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
