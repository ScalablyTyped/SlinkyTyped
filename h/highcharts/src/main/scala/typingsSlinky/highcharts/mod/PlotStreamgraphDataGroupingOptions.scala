...
object PlotStreamgraphDataGroupingOptions {
  @scala.inline
  def apply(): PlotStreamgraphDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphDataGroupingOptionsOps[Self <: PlotStreamgraphDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
