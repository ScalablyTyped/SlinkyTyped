...
object PlotAreasplinerangeMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeMarkerStatesInactiveOptionsOps[Self <: PlotAreasplinerangeMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
