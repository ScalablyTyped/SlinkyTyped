...
@js.native
trait PlotAreasplinerangeZonesOptions extends js.Object {
  /**
...
object PlotAreasplinerangeZonesOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeZonesOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeZonesOptionsOps[Self <: PlotAreasplinerangeZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
