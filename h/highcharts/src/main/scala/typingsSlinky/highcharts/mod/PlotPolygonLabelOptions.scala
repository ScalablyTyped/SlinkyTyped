...
@js.native
trait PlotPolygonLabelOptions extends js.Object {
  /**
...
object PlotPolygonLabelOptions {
  @scala.inline
  def apply(): PlotPolygonLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonLabelOptions]
  }
  @scala.inline
  implicit class PlotPolygonLabelOptionsOps[Self <: PlotPolygonLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
