...
object PlotRocStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotRocStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotRocStatesSelectHaloOptionsOps[Self <: PlotRocStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
