...
object PlotErrorbarPointEventsOptions {
  @scala.inline
  def apply(): PlotErrorbarPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarPointEventsOptions]
  }
  @scala.inline
  implicit class PlotErrorbarPointEventsOptionsOps[Self <: PlotErrorbarPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
