...
object PlotTrixConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTrixConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrixConnectorsMarkerOptionsOps[Self <: PlotTrixConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
