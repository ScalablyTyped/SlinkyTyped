...
object SeriesLineDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesLineDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesLineDataMarkerStatesSelectOptionsOps[Self <: SeriesLineDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
