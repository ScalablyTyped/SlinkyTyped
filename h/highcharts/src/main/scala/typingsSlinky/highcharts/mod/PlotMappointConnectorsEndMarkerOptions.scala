...
object PlotMappointConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMappointConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMappointConnectorsEndMarkerOptionsOps[Self <: PlotMappointConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
