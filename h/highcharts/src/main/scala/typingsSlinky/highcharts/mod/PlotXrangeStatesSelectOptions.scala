...
trait PlotXrangeStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotXrangeStatesSelectAnimationOptions] = js.native
  /**
...
object PlotXrangeStatesSelectOptions {
  @scala.inline
  def apply(): PlotXrangeStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotXrangeStatesSelectOptionsOps[Self <: PlotXrangeStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotXrangeStatesSelectAnimationOptions): Self = {
