...
object PlotPolygonStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotPolygonStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotPolygonStatesHoverHaloOptionsOps[Self <: PlotPolygonStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
