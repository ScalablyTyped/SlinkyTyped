...
object PlotSupertrendMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotSupertrendMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSupertrendMarkerStatesHoverOptionsOps[Self <: PlotSupertrendMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
