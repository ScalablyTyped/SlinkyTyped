...
object PlotTrixDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTrixDataLabelsOptionsMutableBuilder[Self <: PlotTrixDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrixDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
