...
@js.native
trait PlotTrixDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTrixDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotTrixDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotTrixDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTrixDataLabelsOptionsOps[Self <: PlotTrixDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrixDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
