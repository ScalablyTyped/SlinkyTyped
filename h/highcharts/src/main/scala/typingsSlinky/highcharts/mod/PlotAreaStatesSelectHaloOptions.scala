...
@js.native
trait PlotAreaStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotAreaStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAreaStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAreaStatesSelectHaloOptionsOps[Self <: PlotAreaStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
