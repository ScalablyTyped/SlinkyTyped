...
object PlotBarConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBarConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBarConnectorsEndMarkerOptionsOps[Self <: PlotBarConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
