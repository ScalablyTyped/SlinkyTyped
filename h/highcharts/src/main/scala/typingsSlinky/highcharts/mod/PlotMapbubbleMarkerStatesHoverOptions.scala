...
object PlotMapbubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotMapbubbleMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleMarkerStatesHoverOptionsOps[Self <: PlotMapbubbleMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
