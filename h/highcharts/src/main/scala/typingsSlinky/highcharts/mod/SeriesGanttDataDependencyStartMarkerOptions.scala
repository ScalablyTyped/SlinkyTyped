...
object SeriesGanttDataDependencyStartMarkerOptions {
  @scala.inline
  def apply(): SeriesGanttDataDependencyStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDependencyStartMarkerOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDependencyStartMarkerOptionsOps[Self <: SeriesGanttDataDependencyStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
