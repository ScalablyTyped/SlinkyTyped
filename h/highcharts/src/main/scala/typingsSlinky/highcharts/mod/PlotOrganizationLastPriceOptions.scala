...
object PlotOrganizationLastPriceOptions {
  @scala.inline
  def apply(): PlotOrganizationLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationLastPriceOptions]
  }
  @scala.inline
  implicit class PlotOrganizationLastPriceOptionsOps[Self <: PlotOrganizationLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
