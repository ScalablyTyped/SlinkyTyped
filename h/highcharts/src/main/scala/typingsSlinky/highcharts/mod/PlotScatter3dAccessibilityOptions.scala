...
@js.native
trait PlotScatter3dAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotScatter3dAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotScatter3dAccessibilityOptions {
  @scala.inline
  def apply(): PlotScatter3dAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotScatter3dAccessibilityOptionsOps[Self <: PlotScatter3dAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotScatter3dAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
