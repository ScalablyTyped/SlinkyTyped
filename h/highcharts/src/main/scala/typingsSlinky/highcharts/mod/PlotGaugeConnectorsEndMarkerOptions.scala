...
@js.native
trait PlotGaugeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotGaugeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotGaugeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotGaugeConnectorsEndMarkerOptionsOps[Self <: PlotGaugeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
