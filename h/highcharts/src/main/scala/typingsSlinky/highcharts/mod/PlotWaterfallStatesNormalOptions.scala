...
object PlotWaterfallStatesNormalOptions {
  @scala.inline
  def apply(): PlotWaterfallStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotWaterfallStatesNormalOptionsOps[Self <: PlotWaterfallStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
