...
object SeriesBoxplotDataEventsOptions {
  @scala.inline
  def apply(): SeriesBoxplotDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBoxplotDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesBoxplotDataEventsOptionsOps[Self <: SeriesBoxplotDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
