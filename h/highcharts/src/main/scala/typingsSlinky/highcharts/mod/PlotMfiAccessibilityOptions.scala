...
trait PlotMfiAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMfiAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMfiAccessibilityOptions {
  @scala.inline
  def apply(): PlotMfiAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMfiAccessibilityOptionsOps[Self <: PlotMfiAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMfiAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
