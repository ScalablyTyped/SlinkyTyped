...
object PlotOrganizationPointEventsOptions {
  @scala.inline
  def apply(): PlotOrganizationPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationPointEventsOptions]
  }
  @scala.inline
  implicit class PlotOrganizationPointEventsOptionsOps[Self <: PlotOrganizationPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
