...
trait PlotDpoOptions extends js.Object {
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotDpoAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotDpoAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotDpoConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotDpoDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotDpoEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotDpoLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotDpoLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotDpoLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDpoMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    * series points.
    */
  var params: js.UndefOr[PlotDpoParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotDpoPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotDpoStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotDpoTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotDpoZonesOptions]] = js.undefined
}
