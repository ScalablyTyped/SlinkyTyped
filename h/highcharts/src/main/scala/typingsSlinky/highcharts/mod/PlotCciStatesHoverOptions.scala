...
trait PlotCciStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCciStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCciStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotCciStatesHoverOptions {
  @scala.inline
  def apply(): PlotCciStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotCciStatesHoverOptionsOps[Self <: PlotCciStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotCciStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotCciStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
