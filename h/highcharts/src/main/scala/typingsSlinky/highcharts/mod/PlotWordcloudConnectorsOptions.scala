...
trait PlotWordcloudConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWordcloudConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWordcloudConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWordcloudConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotWordcloudConnectorsOptions {
  @scala.inline
  def apply(): PlotWordcloudConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudConnectorsOptions]
  }
  @scala.inline
  implicit class PlotWordcloudConnectorsOptionsOps[Self <: PlotWordcloudConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotWordcloudConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotWordcloudConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotWordcloudConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
