...
trait PlotAreasplinerangeTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAreasplinerangeTooltipOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeTooltipOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeTooltipOptionsOps[Self <: PlotAreasplinerangeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
