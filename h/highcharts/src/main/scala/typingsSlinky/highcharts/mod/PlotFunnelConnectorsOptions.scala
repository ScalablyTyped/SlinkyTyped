...
trait PlotFunnelConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFunnelConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFunnelConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFunnelConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotFunnelConnectorsOptions {
  @scala.inline
  def apply(): PlotFunnelConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelConnectorsOptions]
  }
  @scala.inline
  implicit class PlotFunnelConnectorsOptionsOps[Self <: PlotFunnelConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotFunnelConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotFunnelConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotFunnelConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
