...
@js.native
trait PlotPsarAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPsarAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPsarAccessibilityOptions {
  @scala.inline
  def apply(): PlotPsarAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPsarAccessibilityOptionsOps[Self <: PlotPsarAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPsarAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
