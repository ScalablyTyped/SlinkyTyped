...
@js.native
trait PlotChaikinStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotChaikinStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotChaikinStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotChaikinStatesSelectHaloOptionsOps[Self <: PlotChaikinStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
