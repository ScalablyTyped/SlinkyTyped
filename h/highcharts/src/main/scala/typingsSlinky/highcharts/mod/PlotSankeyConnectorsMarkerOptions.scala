...
@js.native
trait PlotSankeyConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSankeyConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSankeyConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSankeyConnectorsMarkerOptionsOps[Self <: PlotSankeyConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
