...
object PlotLinearregressionangleZonesOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleZonesOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleZonesOptionsOps[Self <: PlotLinearregressionangleZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
