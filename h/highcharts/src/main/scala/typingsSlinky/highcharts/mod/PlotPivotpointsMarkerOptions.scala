...
trait PlotPivotpointsMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPivotpointsMarkerStatesOptions] = js.native
  /**
...
object PlotPivotpointsMarkerOptions {
  @scala.inline
  def apply(): PlotPivotpointsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsMarkerOptionsOps[Self <: PlotPivotpointsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPivotpointsMarkerStatesOptions): Self = {
        val ret = this.duplicate
