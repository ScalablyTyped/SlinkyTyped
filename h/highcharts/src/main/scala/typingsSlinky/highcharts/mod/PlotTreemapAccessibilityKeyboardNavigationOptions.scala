...
object PlotTreemapAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotTreemapAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotTreemapAccessibilityKeyboardNavigationOptionsOps[Self <: PlotTreemapAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
