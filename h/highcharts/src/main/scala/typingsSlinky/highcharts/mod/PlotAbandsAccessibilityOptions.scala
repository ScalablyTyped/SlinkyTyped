...
trait PlotAbandsAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAbandsAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAbandsAccessibilityOptions {
  @scala.inline
  def apply(): PlotAbandsAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAbandsAccessibilityOptionsOps[Self <: PlotAbandsAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAbandsAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
