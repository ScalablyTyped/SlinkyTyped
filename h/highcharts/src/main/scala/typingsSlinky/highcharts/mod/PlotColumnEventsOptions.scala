...
@js.native
trait PlotColumnEventsOptions extends js.Object {
  /**
...
object PlotColumnEventsOptions {
  @scala.inline
  def apply(): PlotColumnEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnEventsOptions]
  }
  @scala.inline
  implicit class PlotColumnEventsOptionsOps[Self <: PlotColumnEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
