...
object SeriesTilemapDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesTilemapDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTilemapDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesTilemapDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesTilemapDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
