...
trait SeriesGanttDataDependencyOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[SeriesGanttDataDependencyEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[SeriesGanttDataDependencyMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[SeriesGanttDataDependencyStartMarkerOptions] = js.native
  /**
...
object SeriesGanttDataDependencyOptions {
  @scala.inline
  def apply(): SeriesGanttDataDependencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDependencyOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDependencyOptionsOps[Self <: SeriesGanttDataDependencyOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: SeriesGanttDataDependencyEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: SeriesGanttDataDependencyMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: SeriesGanttDataDependencyStartMarkerOptions): Self = {
        val ret = this.duplicate
