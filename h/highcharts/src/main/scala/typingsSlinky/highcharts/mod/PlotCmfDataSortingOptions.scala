...
@js.native
trait PlotCmfDataSortingOptions extends StObject {
...
object PlotCmfDataSortingOptions {
  
  @scala.inline
  def apply(): PlotCmfDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotCmfDataSortingOptionsMutableBuilder[Self <: PlotCmfDataSortingOptions] (val x: Self) extends AnyVal {
