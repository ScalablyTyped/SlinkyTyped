...
trait PlotSmaTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotSmaTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotSmaTooltipOptions {
  @scala.inline
  def apply(): PlotSmaTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaTooltipOptions]
  }
  @scala.inline
  implicit class PlotSmaTooltipOptionsOps[Self <: PlotSmaTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotSmaTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
