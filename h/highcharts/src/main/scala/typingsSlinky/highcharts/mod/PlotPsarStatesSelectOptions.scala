...
trait PlotPsarStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotPsarStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPsarStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotPsarStatesSelectOptions {
  @scala.inline
  def apply(): PlotPsarStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPsarStatesSelectOptionsOps[Self <: PlotPsarStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotPsarStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPsarStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
