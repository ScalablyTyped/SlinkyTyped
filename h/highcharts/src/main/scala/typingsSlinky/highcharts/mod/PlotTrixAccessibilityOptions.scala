...
trait PlotTrixAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTrixAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTrixAccessibilityOptions {
  @scala.inline
  def apply(): PlotTrixAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTrixAccessibilityOptionsOps[Self <: PlotTrixAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTrixAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
