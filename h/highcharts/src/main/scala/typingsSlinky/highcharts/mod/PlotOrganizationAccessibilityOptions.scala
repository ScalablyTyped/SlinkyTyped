...
trait PlotOrganizationAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotOrganizationAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotOrganizationAccessibilityOptions {
  @scala.inline
  def apply(): PlotOrganizationAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotOrganizationAccessibilityOptionsOps[Self <: PlotOrganizationAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotOrganizationAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
