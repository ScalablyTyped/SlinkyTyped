...
@js.native
trait PlotAroonoscillatorAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAroonoscillatorAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAroonoscillatorAccessibilityOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorAccessibilityOptionsOps[Self <: PlotAroonoscillatorAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAroonoscillatorAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
