...
object PlotCmfConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotCmfConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotCmfConnectorsEndMarkerOptionsOps[Self <: PlotCmfConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
