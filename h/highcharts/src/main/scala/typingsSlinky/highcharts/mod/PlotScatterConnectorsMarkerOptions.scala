...
object PlotScatterConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotScatterConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatterConnectorsMarkerOptionsOps[Self <: PlotScatterConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
