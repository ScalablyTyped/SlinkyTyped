...
object PlotPriceenvelopesMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesMarkerStatesHoverOptionsOps[Self <: PlotPriceenvelopesMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
