...
object PlotLinearregressionPointEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionPointEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionPointEventsOptionsOps[Self <: PlotLinearregressionPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
