...
trait PlotVbpTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotVbpTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotVbpTooltipOptions {
  @scala.inline
  def apply(): PlotVbpTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpTooltipOptions]
  }
  @scala.inline
  implicit class PlotVbpTooltipOptionsOps[Self <: PlotVbpTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotVbpTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
