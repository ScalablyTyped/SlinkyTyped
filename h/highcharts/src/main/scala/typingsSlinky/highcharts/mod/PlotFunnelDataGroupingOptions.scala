...
@js.native
trait PlotFunnelDataGroupingOptions extends js.Object {
  /**
...
object PlotFunnelDataGroupingOptions {
  @scala.inline
  def apply(): PlotFunnelDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotFunnelDataGroupingOptionsOps[Self <: PlotFunnelDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
