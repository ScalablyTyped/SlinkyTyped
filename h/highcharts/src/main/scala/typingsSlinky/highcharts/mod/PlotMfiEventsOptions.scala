...
@js.native
trait PlotMfiEventsOptions extends js.Object {
  /**
...
object PlotMfiEventsOptions {
  @scala.inline
  def apply(): PlotMfiEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiEventsOptions]
  }
  @scala.inline
  implicit class PlotMfiEventsOptionsOps[Self <: PlotMfiEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
