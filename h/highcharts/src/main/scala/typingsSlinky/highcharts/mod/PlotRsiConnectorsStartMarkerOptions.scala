...
object PlotRsiConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotRsiConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotRsiConnectorsStartMarkerOptionsOps[Self <: PlotRsiConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
