...
@js.native
trait PlotPolygonTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPolygonTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotPolygonTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotPolygonTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotPolygonTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
