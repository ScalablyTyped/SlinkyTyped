...
object PlotLinearregressionanglePointEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionanglePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionanglePointEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionanglePointEventsOptionsOps[Self <: PlotLinearregressionanglePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
