...
object SeriesBarDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesBarDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBarDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesBarDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesBarDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
