...
object YAxisDateTimeLabelFormatsYearOptions {
  @scala.inline
  def apply(): YAxisDateTimeLabelFormatsYearOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisDateTimeLabelFormatsYearOptions]
  }
  @scala.inline
  implicit class YAxisDateTimeLabelFormatsYearOptionsOps[Self <: YAxisDateTimeLabelFormatsYearOptions] (val x: Self) extends AnyVal {
    @scala.inline
