...
trait PlotColumnpyramidConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnpyramidConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnpyramidConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnpyramidConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotColumnpyramidConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotColumnpyramidConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotColumnpyramidConnectorsMarkerOptions = null,
    startMarker: PlotColumnpyramidConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotColumnpyramidConnectorsOptions = {
