...
@js.native
trait PlotColumnpyramidConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnpyramidConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnpyramidConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnpyramidConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotColumnpyramidConnectorsOptions {
  @scala.inline
  def apply(): PlotColumnpyramidConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidConnectorsOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidConnectorsOptionsOps[Self <: PlotColumnpyramidConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotColumnpyramidConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotColumnpyramidConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotColumnpyramidConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
