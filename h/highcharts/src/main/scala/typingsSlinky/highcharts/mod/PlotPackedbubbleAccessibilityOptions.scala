...
trait PlotPackedbubbleAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPackedbubbleAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPackedbubbleAccessibilityOptions {
  @scala.inline
  def apply(): PlotPackedbubbleAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleAccessibilityOptionsOps[Self <: PlotPackedbubbleAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPackedbubbleAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
