...
@js.native
trait PlotSupertrendStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotSupertrendStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotSupertrendStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotSupertrendStatesSelectHaloOptionsOps[Self <: PlotSupertrendStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
