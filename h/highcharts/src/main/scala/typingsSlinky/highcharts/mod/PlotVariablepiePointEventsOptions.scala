...
object PlotVariablepiePointEventsOptions {
  @scala.inline
  def apply(): PlotVariablepiePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepiePointEventsOptions]
  }
  @scala.inline
  implicit class PlotVariablepiePointEventsOptionsOps[Self <: PlotVariablepiePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
