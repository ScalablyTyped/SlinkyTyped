...
trait PlotCandlestickConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCandlestickConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCandlestickConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCandlestickConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotCandlestickConnectorsOptions {
  @scala.inline
  def apply(): PlotCandlestickConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickConnectorsOptions]
  }
  @scala.inline
  implicit class PlotCandlestickConnectorsOptionsOps[Self <: PlotCandlestickConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotCandlestickConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotCandlestickConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotCandlestickConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
