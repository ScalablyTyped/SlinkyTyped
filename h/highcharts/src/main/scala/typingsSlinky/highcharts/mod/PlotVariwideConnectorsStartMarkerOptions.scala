...
@js.native
trait PlotVariwideConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotVariwideConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVariwideConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariwideConnectorsStartMarkerOptionsOps[Self <: PlotVariwideConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
