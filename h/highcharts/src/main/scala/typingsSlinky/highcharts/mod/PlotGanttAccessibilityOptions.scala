...
@js.native
trait PlotGanttAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotGanttAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotGanttAccessibilityOptions {
  @scala.inline
  def apply(): PlotGanttAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotGanttAccessibilityOptionsOps[Self <: PlotGanttAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotGanttAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
