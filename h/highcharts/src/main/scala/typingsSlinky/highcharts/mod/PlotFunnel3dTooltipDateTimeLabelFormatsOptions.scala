...
@js.native
trait PlotFunnel3dTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotFunnel3dTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotFunnel3dTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotFunnel3dTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
