...
object PlotMappointMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotMappointMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotMappointMarkerStatesInactiveOptionsOps[Self <: PlotMappointMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
