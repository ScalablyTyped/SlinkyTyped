...
object SeriesScatter3dDataMarkerStatesNormalOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataMarkerStatesNormalOptionsOps[Self <: SeriesScatter3dDataMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
