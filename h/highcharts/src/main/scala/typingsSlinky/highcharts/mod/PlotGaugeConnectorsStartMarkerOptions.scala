...
@js.native
trait PlotGaugeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotGaugeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotGaugeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotGaugeConnectorsStartMarkerOptionsOps[Self <: PlotGaugeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
