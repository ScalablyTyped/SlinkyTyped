...
@js.native
trait PlotLinearregressionAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressionAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotLinearregressionAccessibilityOptions {
  @scala.inline
  def apply(): PlotLinearregressionAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionAccessibilityOptionsOps[Self <: PlotLinearregressionAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotLinearregressionAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
