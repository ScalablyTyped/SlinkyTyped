...
@js.native
trait PlotSeriesConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSeriesConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSeriesConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSeriesConnectorsStartMarkerOptionsOps[Self <: PlotSeriesConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
