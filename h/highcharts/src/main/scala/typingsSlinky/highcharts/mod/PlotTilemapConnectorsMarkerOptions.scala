...
object PlotTilemapConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTilemapConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTilemapConnectorsMarkerOptionsOps[Self <: PlotTilemapConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
