...
@js.native
trait PlotSolidgaugeEventsOptions extends js.Object {
  /**
...
object PlotSolidgaugeEventsOptions {
  @scala.inline
  def apply(): PlotSolidgaugeEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeEventsOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeEventsOptionsOps[Self <: PlotSolidgaugeEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
