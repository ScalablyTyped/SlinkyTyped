...
trait PlotArearangeStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotArearangeStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotArearangeStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotArearangeStatesHoverOptions {
  @scala.inline
  def apply(): PlotArearangeStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotArearangeStatesHoverOptionsOps[Self <: PlotArearangeStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotArearangeStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotArearangeStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
