...
@js.native
trait PlotLinearregressioninterceptLabelOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptLabelOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptLabelOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptLabelOptionsOps[Self <: PlotLinearregressioninterceptLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
