...
@js.native
trait SeriesTimelineDataEventsOptions extends js.Object {
  /**
...
object SeriesTimelineDataEventsOptions {
  @scala.inline
  def apply(): SeriesTimelineDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTimelineDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesTimelineDataEventsOptionsOps[Self <: SeriesTimelineDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
