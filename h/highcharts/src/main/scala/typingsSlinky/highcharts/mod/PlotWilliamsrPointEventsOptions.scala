...
@js.native
trait PlotWilliamsrPointEventsOptions extends js.Object {
  /**
...
object PlotWilliamsrPointEventsOptions {
  @scala.inline
  def apply(): PlotWilliamsrPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrPointEventsOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrPointEventsOptionsOps[Self <: PlotWilliamsrPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
