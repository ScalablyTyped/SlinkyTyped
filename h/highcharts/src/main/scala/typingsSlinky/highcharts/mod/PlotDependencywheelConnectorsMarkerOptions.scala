...
@js.native
trait PlotDependencywheelConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotDependencywheelConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotDependencywheelConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelConnectorsMarkerOptionsOps[Self <: PlotDependencywheelConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
