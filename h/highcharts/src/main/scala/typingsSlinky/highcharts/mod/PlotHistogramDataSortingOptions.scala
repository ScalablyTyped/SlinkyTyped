...
@js.native
trait PlotHistogramDataSortingOptions extends js.Object {
...
object PlotHistogramDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotHistogramDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotHistogramDataSortingOptionsOps[Self <: PlotHistogramDataSortingOptions] (val x: Self) extends AnyVal {
