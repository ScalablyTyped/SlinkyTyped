...
@js.native
trait PlotGaugeDataLabelsOptions extends js.Object {
...
object PlotGaugeDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotGaugeDataLabelsOptionsOps[Self <: PlotGaugeDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
