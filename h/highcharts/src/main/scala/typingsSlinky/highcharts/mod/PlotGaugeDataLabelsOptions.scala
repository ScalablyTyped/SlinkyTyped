...
@js.native
trait PlotGaugeDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotGaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotGaugeDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotGaugeDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotGaugeDataLabelsOptionsMutableBuilder[Self <: PlotGaugeDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
