...
object PlotScatter3dStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotScatter3dStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotScatter3dStatesHoverHaloOptionsOps[Self <: PlotScatter3dStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
