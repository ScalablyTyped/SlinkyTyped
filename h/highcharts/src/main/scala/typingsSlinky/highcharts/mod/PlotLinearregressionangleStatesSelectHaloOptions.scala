...
object PlotLinearregressionangleStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleStatesSelectHaloOptionsOps[Self <: PlotLinearregressionangleStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
