...
trait PlotHistogramAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotHistogramAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotHistogramAccessibilityOptions {
  @scala.inline
  def apply(): PlotHistogramAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotHistogramAccessibilityOptionsOps[Self <: PlotHistogramAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotHistogramAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
