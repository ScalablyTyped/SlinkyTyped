...
@js.native
trait PlotCciZonesOptions extends js.Object {
  /**
...
object PlotCciZonesOptions {
  @scala.inline
  def apply(): PlotCciZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciZonesOptions]
  }
  @scala.inline
  implicit class PlotCciZonesOptionsOps[Self <: PlotCciZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
