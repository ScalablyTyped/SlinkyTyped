...
trait PlotFunnelAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotFunnelAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotFunnelAccessibilityOptions {
  @scala.inline
  def apply(): PlotFunnelAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotFunnelAccessibilityOptionsOps[Self <: PlotFunnelAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotFunnelAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
