...
@js.native
trait PlotWindbarbConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotWindbarbConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotWindbarbConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotWindbarbConnectorsEndMarkerOptionsOps[Self <: PlotWindbarbConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
