...
object PlotPriceenvelopesEventsOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesEventsOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesEventsOptionsOps[Self <: PlotPriceenvelopesEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
