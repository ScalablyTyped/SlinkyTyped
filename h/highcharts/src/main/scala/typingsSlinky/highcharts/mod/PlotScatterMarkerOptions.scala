...
@js.native
trait PlotScatterMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatterMarkerStatesOptions] = js.native
  /**
...
object PlotScatterMarkerOptions {
  @scala.inline
  def apply(): PlotScatterMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatterMarkerOptionsOps[Self <: PlotScatterMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotScatterMarkerStatesOptions): Self = {
        val ret = this.duplicate
