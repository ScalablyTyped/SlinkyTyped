...
object PlotAreaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAreaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreaConnectorsEndMarkerOptionsOps[Self <: PlotAreaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
