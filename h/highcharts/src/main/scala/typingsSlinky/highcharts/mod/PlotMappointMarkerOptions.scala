...
trait PlotMappointMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMappointMarkerStatesOptions] = js.native
  /**
...
object PlotMappointMarkerOptions {
  @scala.inline
  def apply(): PlotMappointMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointMarkerOptions]
  }
  @scala.inline
  implicit class PlotMappointMarkerOptionsOps[Self <: PlotMappointMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotMappointMarkerStatesOptions): Self = {
        val ret = this.duplicate
