...
object PlotPyramid3dDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotPyramid3dDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dDragDropDragHandleOptionsOps[Self <: PlotPyramid3dDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
