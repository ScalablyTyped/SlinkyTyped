...
object PlotParetoAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotParetoAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotParetoAccessibilityKeyboardNavigationOptionsOps[Self <: PlotParetoAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
