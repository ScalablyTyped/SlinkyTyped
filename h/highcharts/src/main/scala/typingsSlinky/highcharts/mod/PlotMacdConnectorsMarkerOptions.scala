...
object PlotMacdConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMacdConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMacdConnectorsMarkerOptionsOps[Self <: PlotMacdConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
