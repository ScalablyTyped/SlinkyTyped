...
object SeriesSankeyDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesSankeyDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSankeyDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesSankeyDataAccessibilityOptionsOps[Self <: SeriesSankeyDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
