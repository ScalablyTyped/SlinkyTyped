...
@js.native
trait PlotScatterConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotScatterConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotScatterConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatterConnectorsEndMarkerOptionsOps[Self <: PlotScatterConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
