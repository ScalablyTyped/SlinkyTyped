...
@js.native
trait PlotCciTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotCciTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotCciTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotCciTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotCciTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
