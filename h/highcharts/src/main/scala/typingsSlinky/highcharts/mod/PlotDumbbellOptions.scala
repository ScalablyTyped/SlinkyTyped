...
object PlotDumbbellOptions {
  ...
  @scala.inline
  implicit class PlotDumbbellOptionsMutableBuilder[Self <: PlotDumbbellOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDumbbellAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotDumbbellDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
