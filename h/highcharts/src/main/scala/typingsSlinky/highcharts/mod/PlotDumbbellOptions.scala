...
@js.native
trait PlotDumbbellOptions extends js.Object {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotDumbbellAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotDumbbellDataSortingOptions] = js.native
...
object PlotDumbbellOptions {
  ...
  @scala.inline
  def apply(): PlotDumbbellOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellOptions]
  }
  
  @scala.inline
  implicit class PlotDumbbellOptionsOps[Self <: PlotDumbbellOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDumbbellAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotDumbbellDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
