...
object PlotTimelineMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotTimelineMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTimelineMarkerStatesHoverOptionsOps[Self <: PlotTimelineMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
