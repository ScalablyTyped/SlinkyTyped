...
@js.native
trait PlotLineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotLineAccessibilityOptions {
  @scala.inline
  def apply(): PlotLineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotLineAccessibilityOptionsOps[Self <: PlotLineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotLineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
