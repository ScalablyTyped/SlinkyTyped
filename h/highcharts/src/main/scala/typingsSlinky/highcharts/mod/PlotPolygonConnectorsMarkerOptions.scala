...
object PlotPolygonConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPolygonConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPolygonConnectorsMarkerOptionsOps[Self <: PlotPolygonConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
