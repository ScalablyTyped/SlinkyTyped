...
@js.native
trait PlotVectorZonesOptions extends js.Object {
  /**
...
object PlotVectorZonesOptions {
  @scala.inline
  def apply(): PlotVectorZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorZonesOptions]
  }
  @scala.inline
  implicit class PlotVectorZonesOptionsOps[Self <: PlotVectorZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
