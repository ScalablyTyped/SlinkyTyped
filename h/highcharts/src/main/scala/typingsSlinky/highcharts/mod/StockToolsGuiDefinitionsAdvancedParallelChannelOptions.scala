...
object StockToolsGuiDefinitionsAdvancedParallelChannelOptions {
  ...
  @scala.inline
  implicit class StockToolsGuiDefinitionsAdvancedParallelChannelOptionsOps[Self <: StockToolsGuiDefinitionsAdvancedParallelChannelOptions] (val x: Self) extends AnyVal {
    @scala.inline
