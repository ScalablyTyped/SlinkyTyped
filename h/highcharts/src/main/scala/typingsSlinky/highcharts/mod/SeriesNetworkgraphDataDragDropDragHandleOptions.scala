...
object SeriesNetworkgraphDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesNetworkgraphDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesNetworkgraphDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesNetworkgraphDataDragDropDragHandleOptionsOps[Self <: SeriesNetworkgraphDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
