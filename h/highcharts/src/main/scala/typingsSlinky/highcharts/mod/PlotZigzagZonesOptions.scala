...
@js.native
trait PlotZigzagZonesOptions extends js.Object {
  /**
...
object PlotZigzagZonesOptions {
  @scala.inline
  def apply(): PlotZigzagZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagZonesOptions]
  }
  @scala.inline
  implicit class PlotZigzagZonesOptionsOps[Self <: PlotZigzagZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
