...
object PlotAroonConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAroonConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonConnectorsEndMarkerOptionsOps[Self <: PlotAroonConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
