...
object PlotNetworkgraphLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotNetworkgraphLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphLastVisiblePriceLabelOptionsOps[Self <: PlotNetworkgraphLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
