...
object SeriesAreasplinerangeDataEventsOptions {
  @scala.inline
  def apply(): SeriesAreasplinerangeDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplinerangeDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesAreasplinerangeDataEventsOptionsOps[Self <: SeriesAreasplinerangeDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
