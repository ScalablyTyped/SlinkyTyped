...
@js.native
trait PlotBulletEventsOptions extends js.Object {
  /**
...
object PlotBulletEventsOptions {
  @scala.inline
  def apply(): PlotBulletEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletEventsOptions]
  }
  @scala.inline
  implicit class PlotBulletEventsOptionsOps[Self <: PlotBulletEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
