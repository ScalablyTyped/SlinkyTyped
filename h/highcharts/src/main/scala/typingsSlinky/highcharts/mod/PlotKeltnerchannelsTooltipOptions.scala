...
@js.native
trait PlotKeltnerchannelsTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotKeltnerchannelsTooltipOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsTooltipOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsTooltipOptionsOps[Self <: PlotKeltnerchannelsTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
