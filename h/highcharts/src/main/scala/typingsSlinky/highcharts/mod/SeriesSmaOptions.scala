...
object SeriesSmaOptions {
  ...
  @scala.inline
  implicit class SeriesSmaOptionsOps[Self <: SeriesSmaOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | sma): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
