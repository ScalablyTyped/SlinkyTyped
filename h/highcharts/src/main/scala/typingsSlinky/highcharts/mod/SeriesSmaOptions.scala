...
trait SeriesSmaOptions extends PlotSmaOptions {
...
object SeriesSmaOptions {
  ...
  @scala.inline
  def apply(`type`: String | sma): SeriesSmaOptions = {
  ...
  @scala.inline
  implicit class SeriesSmaOptionsMutableBuilder[Self <: SeriesSmaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | sma): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
