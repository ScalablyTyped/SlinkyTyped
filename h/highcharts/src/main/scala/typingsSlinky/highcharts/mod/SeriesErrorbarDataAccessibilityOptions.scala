...
object SeriesErrorbarDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesErrorbarDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesErrorbarDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesErrorbarDataAccessibilityOptionsOps[Self <: SeriesErrorbarDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
