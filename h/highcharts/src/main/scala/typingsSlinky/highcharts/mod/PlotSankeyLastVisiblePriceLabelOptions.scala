...
object PlotSankeyLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotSankeyLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotSankeyLastVisiblePriceLabelOptionsOps[Self <: PlotSankeyLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
