...
@js.native
trait PlotAreasplineDataLabelsOptions extends js.Object {
...
object PlotAreasplineDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAreasplineDataLabelsOptionsOps[Self <: PlotAreasplineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAreasplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
