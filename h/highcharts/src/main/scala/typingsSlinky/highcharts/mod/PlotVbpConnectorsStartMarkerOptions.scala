...
object PlotVbpConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVbpConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVbpConnectorsStartMarkerOptionsOps[Self <: PlotVbpConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
