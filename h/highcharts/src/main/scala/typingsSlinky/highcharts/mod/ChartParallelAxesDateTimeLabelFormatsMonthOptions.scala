...
object ChartParallelAxesDateTimeLabelFormatsMonthOptions {
  @scala.inline
  def apply(): ChartParallelAxesDateTimeLabelFormatsMonthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesDateTimeLabelFormatsMonthOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesDateTimeLabelFormatsMonthOptionsOps[Self <: ChartParallelAxesDateTimeLabelFormatsMonthOptions] (val x: Self) extends AnyVal {
    @scala.inline
