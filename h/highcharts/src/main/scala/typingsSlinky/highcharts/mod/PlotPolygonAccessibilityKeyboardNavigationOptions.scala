...
object PlotPolygonAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotPolygonAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotPolygonAccessibilityKeyboardNavigationOptionsOps[Self <: PlotPolygonAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
