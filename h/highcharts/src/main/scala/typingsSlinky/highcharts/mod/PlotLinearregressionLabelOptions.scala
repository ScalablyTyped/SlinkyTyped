...
object PlotLinearregressionLabelOptions {
  @scala.inline
  def apply(): PlotLinearregressionLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionLabelOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionLabelOptionsOps[Self <: PlotLinearregressionLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
