...
@js.native
trait PlotAreasplineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAreasplineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAreasplineAccessibilityOptions {
  @scala.inline
  def apply(): PlotAreasplineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAreasplineAccessibilityOptionsOps[Self <: PlotAreasplineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAreasplineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
