...
trait PlotPivotpointsAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPivotpointsAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPivotpointsAccessibilityOptions {
  @scala.inline
  def apply(): PlotPivotpointsAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsAccessibilityOptionsOps[Self <: PlotPivotpointsAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPivotpointsAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
