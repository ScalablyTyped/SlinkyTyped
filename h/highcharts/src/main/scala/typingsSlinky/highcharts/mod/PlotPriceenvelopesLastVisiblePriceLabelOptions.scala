...
object PlotPriceenvelopesLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesLastVisiblePriceLabelOptionsOps[Self <: PlotPriceenvelopesLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
