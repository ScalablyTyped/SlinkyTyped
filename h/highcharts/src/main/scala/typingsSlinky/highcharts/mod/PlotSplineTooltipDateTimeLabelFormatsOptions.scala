...
object PlotSplineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotSplineTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotSplineTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotSplineTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
