...
object PlotAreasplineLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotAreasplineLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotAreasplineLastVisiblePriceLabelOptionsOps[Self <: PlotAreasplineLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
