...
trait PlotWaterfallTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWaterfallTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotWaterfallTooltipOptions {
  @scala.inline
  def apply(): PlotWaterfallTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallTooltipOptions]
  }
  @scala.inline
  implicit class PlotWaterfallTooltipOptionsOps[Self <: PlotWaterfallTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotWaterfallTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
