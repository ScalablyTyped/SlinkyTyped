...
object PlotStreamgraphConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotStreamgraphConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphConnectorsEndMarkerOptionsOps[Self <: PlotStreamgraphConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
