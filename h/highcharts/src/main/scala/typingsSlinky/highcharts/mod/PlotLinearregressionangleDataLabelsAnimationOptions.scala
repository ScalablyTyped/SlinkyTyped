...
@js.native
trait PlotLinearregressionangleDataLabelsAnimationOptions extends js.Object {
...
object PlotLinearregressionangleDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionangleDataLabelsAnimationOptionsOps[Self <: PlotLinearregressionangleDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
