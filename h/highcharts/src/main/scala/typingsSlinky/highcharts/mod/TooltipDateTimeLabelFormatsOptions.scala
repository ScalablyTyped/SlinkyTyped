...
@js.native
trait TooltipDateTimeLabelFormatsOptions extends js.Object {
...
object TooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): TooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class TooltipDateTimeLabelFormatsOptionsOps[Self <: TooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
