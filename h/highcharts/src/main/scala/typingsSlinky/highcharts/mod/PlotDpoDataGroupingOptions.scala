...
@js.native
trait PlotDpoDataGroupingOptions extends js.Object {
  /**
...
object PlotDpoDataGroupingOptions {
  @scala.inline
  def apply(): PlotDpoDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotDpoDataGroupingOptionsOps[Self <: PlotDpoDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
