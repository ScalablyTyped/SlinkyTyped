...
trait PlotGanttTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotGanttTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
  ...
  /**
    ...
    * color.
    */
  var pointFormat: js.UndefOr[js.Any] = js.native
  /**
...
object PlotGanttTooltipOptions {
  @scala.inline
  def apply(): PlotGanttTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttTooltipOptions]
  }
  @scala.inline
  implicit class PlotGanttTooltipOptionsOps[Self <: PlotGanttTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotGanttTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPointFormat(value: js.Any): Self = {
        val ret = this.duplicate
