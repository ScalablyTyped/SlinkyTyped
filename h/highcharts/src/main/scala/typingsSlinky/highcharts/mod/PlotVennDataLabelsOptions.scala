...
object PlotVennDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotVennDataLabelsOptionsMutableBuilder[Self <: PlotVennDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVennDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
