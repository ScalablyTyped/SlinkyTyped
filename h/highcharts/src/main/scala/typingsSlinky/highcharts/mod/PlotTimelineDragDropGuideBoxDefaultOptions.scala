...
@js.native
trait PlotTimelineDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotTimelineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotTimelineDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotTimelineDragDropGuideBoxDefaultOptionsOps[Self <: PlotTimelineDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
