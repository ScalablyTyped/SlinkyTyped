...
object PlotPsarMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPsarMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPsarMarkerStatesHoverOptionsOps[Self <: PlotPsarMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
