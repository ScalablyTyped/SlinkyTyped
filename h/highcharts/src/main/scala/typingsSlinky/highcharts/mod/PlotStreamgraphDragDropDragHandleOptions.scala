...
object PlotStreamgraphDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotStreamgraphDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphDragDropDragHandleOptionsOps[Self <: PlotStreamgraphDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
