...
object SeriesColumnrangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesColumnrangeDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnrangeDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesColumnrangeDataDragDropDragHandleOptionsOps[Self <: SeriesColumnrangeDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
