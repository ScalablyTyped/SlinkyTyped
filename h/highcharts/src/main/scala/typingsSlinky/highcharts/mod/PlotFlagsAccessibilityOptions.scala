...
trait PlotFlagsAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotFlagsAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotFlagsAccessibilityOptions {
  @scala.inline
  def apply(): PlotFlagsAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotFlagsAccessibilityOptionsOps[Self <: PlotFlagsAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotFlagsAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
