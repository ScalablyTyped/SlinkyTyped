...
object PlotWilliamsrDataGroupingOptions {
  @scala.inline
  def apply(): PlotWilliamsrDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrDataGroupingOptionsOps[Self <: PlotWilliamsrDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
