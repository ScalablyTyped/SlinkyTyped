...
object PlotSmaStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotSmaStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotSmaStatesSelectHaloOptionsOps[Self <: PlotSmaStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
