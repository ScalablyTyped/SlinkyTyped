...
object SeriesAreasplineDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesAreasplineDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplineDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesAreasplineDataMarkerStatesInactiveOptionsOps[Self <: SeriesAreasplineDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
