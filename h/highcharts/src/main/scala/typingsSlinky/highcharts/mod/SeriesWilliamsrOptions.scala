...
trait SeriesWilliamsrOptions extends PlotWilliamsrOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | williamsr = js.native
...
object SeriesWilliamsrOptions {
  ...
  @scala.inline
  def apply(`type`: String | williamsr): SeriesWilliamsrOptions = {
  ...
  @scala.inline
  implicit class SeriesWilliamsrOptionsMutableBuilder[Self <: SeriesWilliamsrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | williamsr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
