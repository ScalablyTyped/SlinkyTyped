...
object SeriesWilliamsrOptions {
  ...
  @scala.inline
  implicit class SeriesWilliamsrOptionsOps[Self <: SeriesWilliamsrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | williamsr): Self = this.set("type", value.asInstanceOf[js.Any])
