...
trait PlotCandlestickDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotCandlestickDragDropDragHandleOptions] = js.native
  /**
...
object PlotCandlestickDragDropOptions {
  @scala.inline
  def apply(): PlotCandlestickDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickDragDropOptions]
  }
  @scala.inline
  implicit class PlotCandlestickDragDropOptionsOps[Self <: PlotCandlestickDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotCandlestickDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: PlotCandlestickDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
