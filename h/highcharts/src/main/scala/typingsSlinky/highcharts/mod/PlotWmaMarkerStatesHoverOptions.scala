...
object PlotWmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotWmaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWmaMarkerStatesHoverOptionsOps[Self <: PlotWmaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
