...
@js.native
trait PlotSupertrendDataGroupingOptions extends js.Object {
  /**
...
object PlotSupertrendDataGroupingOptions {
  @scala.inline
  def apply(): PlotSupertrendDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotSupertrendDataGroupingOptionsOps[Self <: PlotSupertrendDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
