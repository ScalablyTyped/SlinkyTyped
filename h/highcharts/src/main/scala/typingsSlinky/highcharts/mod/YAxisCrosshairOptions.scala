...
trait YAxisCrosshairOptions extends AxisCrosshairOptions {
  ...
  /**
    ...
    */
  var label: js.UndefOr[YAxisCrosshairLabelOptions] = js.native
  /**
...
object YAxisCrosshairOptions {
  @scala.inline
  def apply(): YAxisCrosshairOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisCrosshairOptions]
  }
  @scala.inline
  implicit class YAxisCrosshairOptionsOps[Self <: YAxisCrosshairOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: YAxisCrosshairLabelOptions): Self = {
        val ret = this.duplicate
