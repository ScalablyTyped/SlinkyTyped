...
object PlotBulletDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotBulletDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotBulletDragDropGuideBoxDefaultOptionsOps[Self <: PlotBulletDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
