...
@js.native
trait PlotDemaConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotDemaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotDemaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotDemaConnectorsMarkerOptionsOps[Self <: PlotDemaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
