...
@js.native
trait SeriesStreamgraphDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesStreamgraphDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataMarkerStatesHoverOptionsOps[Self <: SeriesStreamgraphDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
