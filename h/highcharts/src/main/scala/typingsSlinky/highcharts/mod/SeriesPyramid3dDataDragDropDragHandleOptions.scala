...
object SeriesPyramid3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesPyramid3dDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramid3dDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesPyramid3dDataDragDropDragHandleOptionsOps[Self <: SeriesPyramid3dDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
