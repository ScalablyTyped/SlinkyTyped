...
trait PointInstrumentObject extends js.Object {
  /**
    ...
    */
  var instrument: String | typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Instrument
  /**
    * Mapping of instrument parameters for this instrument.
    */
  var instrumentMapping: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentMappingObject
  /**
...
object PointInstrumentObject {
  ...
  def apply(
    ...
    instrumentOptions: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentOptionsObject = null,
