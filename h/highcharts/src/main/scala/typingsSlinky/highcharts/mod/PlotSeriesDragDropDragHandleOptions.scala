...
@js.native
trait PlotSeriesDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSeriesDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotSeriesDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotSeriesDragDropDragHandleOptionsOps[Self <: PlotSeriesDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
