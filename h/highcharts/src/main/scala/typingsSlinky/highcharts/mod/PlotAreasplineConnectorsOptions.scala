...
trait PlotAreasplineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAreasplineConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreasplineConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAreasplineConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotAreasplineConnectorsOptions {
  @scala.inline
  def apply(): PlotAreasplineConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineConnectorsOptions]
  }
  @scala.inline
  implicit class PlotAreasplineConnectorsOptionsOps[Self <: PlotAreasplineConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotAreasplineConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotAreasplineConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotAreasplineConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
