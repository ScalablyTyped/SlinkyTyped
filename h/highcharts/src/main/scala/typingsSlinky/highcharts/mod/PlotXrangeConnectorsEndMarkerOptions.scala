...
object PlotXrangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotXrangeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotXrangeConnectorsEndMarkerOptionsOps[Self <: PlotXrangeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
