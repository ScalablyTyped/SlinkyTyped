...
object PlotVariwidePointEventsOptions {
  @scala.inline
  def apply(): PlotVariwidePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwidePointEventsOptions]
  }
  @scala.inline
  implicit class PlotVariwidePointEventsOptionsOps[Self <: PlotVariwidePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
