...
@js.native
trait SeriesWaterfallDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesWaterfallDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesWaterfallDataDataLabelsAnimationOptionsOps[Self <: SeriesWaterfallDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
