...
trait SeriesSplineDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesSplineDataMarkerStatesOptions] = js.native
  /**
...
object SeriesSplineDataMarkerOptions {
  @scala.inline
  def apply(): SeriesSplineDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSplineDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesSplineDataMarkerOptionsOps[Self <: SeriesSplineDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesSplineDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
