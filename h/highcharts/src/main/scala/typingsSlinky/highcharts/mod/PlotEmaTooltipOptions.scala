...
trait PlotEmaTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotEmaTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotEmaTooltipOptions {
  @scala.inline
  def apply(): PlotEmaTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaTooltipOptions]
  }
  @scala.inline
  implicit class PlotEmaTooltipOptionsOps[Self <: PlotEmaTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotEmaTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
