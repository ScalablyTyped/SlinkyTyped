...
object PlotVwapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVwapConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVwapConnectorsEndMarkerOptionsOps[Self <: PlotVwapConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
