...
object PlotSupertrendMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotSupertrendMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSupertrendMarkerStatesSelectOptionsOps[Self <: PlotSupertrendMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
