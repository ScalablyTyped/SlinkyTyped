...
trait PlotSunburstStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotSunburstStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotSunburstStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotSunburstStatesNormalOptions] = js.native
  /**
    * (Highcharts) Specific options for point in selected states, after being
    * selected by allowPointSelect or programmatically.
    */
  var select: js.UndefOr[PlotSunburstStatesSelectOptions] = js.native
}

object PlotSunburstStatesOptions {
  @scala.inline
  def apply(): PlotSunburstStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstStatesOptions]
  }
  @scala.inline
  implicit class PlotSunburstStatesOptionsOps[Self <: PlotSunburstStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotSunburstStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotSunburstStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotSunburstStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotSunburstStatesSelectOptions): Self = {
        val ret = this.duplicate
