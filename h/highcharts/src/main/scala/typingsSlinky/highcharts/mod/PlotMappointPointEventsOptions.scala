...
object PlotMappointPointEventsOptions {
  @scala.inline
  def apply(): PlotMappointPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointPointEventsOptions]
  }
  @scala.inline
  implicit class PlotMappointPointEventsOptionsOps[Self <: PlotMappointPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
