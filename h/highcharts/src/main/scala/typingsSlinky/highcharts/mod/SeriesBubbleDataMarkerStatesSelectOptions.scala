...
object SeriesBubbleDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesBubbleDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataMarkerStatesSelectOptionsOps[Self <: SeriesBubbleDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
