...
object PlotAroonoscillatorConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorConnectorsMarkerOptionsOps[Self <: PlotAroonoscillatorConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
