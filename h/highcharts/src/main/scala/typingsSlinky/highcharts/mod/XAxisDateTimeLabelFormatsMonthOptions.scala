...
object XAxisDateTimeLabelFormatsMonthOptions {
  @scala.inline
  def apply(): XAxisDateTimeLabelFormatsMonthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisDateTimeLabelFormatsMonthOptions]
  }
  @scala.inline
  implicit class XAxisDateTimeLabelFormatsMonthOptionsOps[Self <: XAxisDateTimeLabelFormatsMonthOptions] (val x: Self) extends AnyVal {
    @scala.inline
