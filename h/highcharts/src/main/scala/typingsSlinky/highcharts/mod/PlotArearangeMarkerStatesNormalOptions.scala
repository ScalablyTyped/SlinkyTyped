...
object PlotArearangeMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotArearangeMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotArearangeMarkerStatesNormalOptionsOps[Self <: PlotArearangeMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
