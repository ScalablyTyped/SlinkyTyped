...
@js.native
trait PlotZigzagTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotZigzagTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotZigzagTooltipOptions {
  @scala.inline
  def apply(): PlotZigzagTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagTooltipOptions]
  }
  @scala.inline
  implicit class PlotZigzagTooltipOptionsOps[Self <: PlotZigzagTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotZigzagTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
