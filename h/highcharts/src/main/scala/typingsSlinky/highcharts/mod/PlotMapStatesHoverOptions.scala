...
@js.native
trait PlotMapStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMapStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMapStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotMapStatesHoverOptions {
  @scala.inline
  def apply(): PlotMapStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMapStatesHoverOptionsOps[Self <: PlotMapStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMapStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMapStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
