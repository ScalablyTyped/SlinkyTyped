...
@js.native
trait PlotBarStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBarStatesHoverAnimationOptions] = js.native
  /**
...
object PlotBarStatesHoverOptions {
  @scala.inline
  def apply(): PlotBarStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBarStatesHoverOptionsOps[Self <: PlotBarStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotBarStatesHoverAnimationOptions): Self = {
