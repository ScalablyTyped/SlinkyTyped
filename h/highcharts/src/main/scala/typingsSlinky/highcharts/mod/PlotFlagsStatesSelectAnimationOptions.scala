...
object PlotFlagsStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotFlagsStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotFlagsStatesSelectAnimationOptionsOps[Self <: PlotFlagsStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
