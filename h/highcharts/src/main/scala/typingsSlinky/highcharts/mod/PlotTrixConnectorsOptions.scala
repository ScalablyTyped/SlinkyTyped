...
trait PlotTrixConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTrixConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTrixConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTrixConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotTrixConnectorsOptions {
  @scala.inline
  def apply(): PlotTrixConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixConnectorsOptions]
  }
  @scala.inline
  implicit class PlotTrixConnectorsOptionsOps[Self <: PlotTrixConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotTrixConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotTrixConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotTrixConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
