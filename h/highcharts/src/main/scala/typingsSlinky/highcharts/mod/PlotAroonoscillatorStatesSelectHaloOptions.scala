...
object PlotAroonoscillatorStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorStatesSelectHaloOptionsOps[Self <: PlotAroonoscillatorStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
