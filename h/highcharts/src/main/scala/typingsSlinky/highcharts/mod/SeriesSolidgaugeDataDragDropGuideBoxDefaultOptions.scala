...
object SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesSolidgaugeDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
