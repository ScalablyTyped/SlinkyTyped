...
object PlotIkhConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotIkhConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotIkhConnectorsEndMarkerOptionsOps[Self <: PlotIkhConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
