...
object PlotTrendlineMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotTrendlineMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTrendlineMarkerStatesSelectOptionsOps[Self <: PlotTrendlineMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
