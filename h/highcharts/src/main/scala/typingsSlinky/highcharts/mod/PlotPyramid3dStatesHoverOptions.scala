...
@js.native
trait PlotPyramid3dStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPyramid3dStatesHoverAnimationOptions] = js.native
  /**
...
object PlotPyramid3dStatesHoverOptions {
  @scala.inline
  def apply(): PlotPyramid3dStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dStatesHoverOptionsOps[Self <: PlotPyramid3dStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPyramid3dStatesHoverAnimationOptions): Self = {
