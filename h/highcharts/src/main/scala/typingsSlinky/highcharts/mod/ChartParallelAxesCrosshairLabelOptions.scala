...
@js.native
trait ChartParallelAxesCrosshairLabelOptions extends js.Object {
  /**
...
object ChartParallelAxesCrosshairLabelOptions {
  @scala.inline
  def apply(): ChartParallelAxesCrosshairLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesCrosshairLabelOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesCrosshairLabelOptionsOps[Self <: ChartParallelAxesCrosshairLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
