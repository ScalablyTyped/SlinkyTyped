...
trait PlotScatterDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotScatterDragDropDragHandleOptions] = js.native
  /**
...
object PlotScatterDragDropOptions {
  @scala.inline
  def apply(): PlotScatterDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterDragDropOptions]
  }
  @scala.inline
  implicit class PlotScatterDragDropOptionsOps[Self <: PlotScatterDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotScatterDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotScatterDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
