...
@js.native
trait PlotTemaMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTemaMarkerStatesOptions] = js.native
  /**
...
object PlotTemaMarkerOptions {
  @scala.inline
  def apply(): PlotTemaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaMarkerOptions]
  }
  @scala.inline
  implicit class PlotTemaMarkerOptionsOps[Self <: PlotTemaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotTemaMarkerStatesOptions): Self = {
        val ret = this.duplicate
