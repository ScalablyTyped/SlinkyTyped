...
object PlotLinearregressionslopeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeConnectorsEndMarkerOptionsOps[Self <: PlotLinearregressionslopeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
