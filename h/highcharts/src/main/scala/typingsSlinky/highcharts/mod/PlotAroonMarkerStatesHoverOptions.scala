...
@js.native
trait PlotAroonMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotAroonMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAroonMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAroonMarkerStatesHoverOptionsOps[Self <: PlotAroonMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
