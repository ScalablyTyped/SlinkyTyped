...
@js.native
trait PlotOrganizationEventsOptions extends js.Object {
  /**
...
object PlotOrganizationEventsOptions {
  @scala.inline
  def apply(): PlotOrganizationEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationEventsOptions]
  }
  @scala.inline
  implicit class PlotOrganizationEventsOptionsOps[Self <: PlotOrganizationEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
