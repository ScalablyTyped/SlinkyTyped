...
object PlotBellcurveAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotBellcurveAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotBellcurveAccessibilityKeyboardNavigationOptionsOps[Self <: PlotBellcurveAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
