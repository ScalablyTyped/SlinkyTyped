...
object PlotColumnrangeDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotColumnrangeDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeDragDropDragHandleOptionsOps[Self <: PlotColumnrangeDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
