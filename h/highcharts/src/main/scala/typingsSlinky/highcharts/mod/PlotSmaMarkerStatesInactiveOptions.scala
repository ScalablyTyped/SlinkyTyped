...
object PlotSmaMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotSmaMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotSmaMarkerStatesInactiveOptionsOps[Self <: PlotSmaMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
