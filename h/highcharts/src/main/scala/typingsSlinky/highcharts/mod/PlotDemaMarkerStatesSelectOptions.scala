...
@js.native
trait PlotDemaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDemaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotDemaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotDemaMarkerStatesSelectOptionsOps[Self <: PlotDemaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
