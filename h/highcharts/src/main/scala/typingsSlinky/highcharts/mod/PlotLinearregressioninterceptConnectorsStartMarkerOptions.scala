...
object PlotLinearregressioninterceptConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptConnectorsStartMarkerOptionsOps[Self <: PlotLinearregressioninterceptConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
