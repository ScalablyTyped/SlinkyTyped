...
@js.native
trait PlotWmaEventsOptions extends js.Object {
  /**
...
object PlotWmaEventsOptions {
  @scala.inline
  def apply(): PlotWmaEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaEventsOptions]
  }
  @scala.inline
  implicit class PlotWmaEventsOptionsOps[Self <: PlotWmaEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
