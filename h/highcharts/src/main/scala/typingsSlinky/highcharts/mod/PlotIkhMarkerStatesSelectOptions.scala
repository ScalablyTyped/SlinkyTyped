...
@js.native
trait PlotIkhMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotIkhMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotIkhMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotIkhMarkerStatesSelectOptionsOps[Self <: PlotIkhMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
