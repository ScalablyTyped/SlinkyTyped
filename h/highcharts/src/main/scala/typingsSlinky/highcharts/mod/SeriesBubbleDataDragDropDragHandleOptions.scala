...
object SeriesBubbleDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesBubbleDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataDragDropDragHandleOptionsOps[Self <: SeriesBubbleDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
