...
object PlotAroonStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAroonStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAroonStatesSelectHaloOptionsOps[Self <: PlotAroonStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
