...
object PlotTreemapConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTreemapConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTreemapConnectorsMarkerOptionsOps[Self <: PlotTreemapConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
