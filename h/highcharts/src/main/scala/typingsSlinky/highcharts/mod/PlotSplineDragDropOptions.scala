...
trait PlotSplineDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotSplineDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotSplineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSplineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
