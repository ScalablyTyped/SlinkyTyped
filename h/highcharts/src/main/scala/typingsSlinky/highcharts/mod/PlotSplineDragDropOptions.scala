...
@js.native
trait PlotSplineDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSplineDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotSplineDragDropOptions {
  @scala.inline
  def apply(): PlotSplineDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDragDropOptions]
  }
  @scala.inline
  implicit class PlotSplineDragDropOptionsOps[Self <: PlotSplineDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotSplineDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotSplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
