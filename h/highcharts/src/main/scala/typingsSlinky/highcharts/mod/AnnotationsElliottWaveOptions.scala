...
object AnnotationsElliottWaveOptions {
  ...
  implicit class AnnotationsElliottWaveOptionsOps[Self <: AnnotationsElliottWaveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControlPointOptions(value: AnnotationsElliottWaveControlPointOptions): Self = {
    ...
    @scala.inline
    def withLabelOptions(value: AnnotationsElliottWaveLabelOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShapeOptions(value: AnnotationsElliottWaveShapeOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTypeOptions(value: AnnotationsElliottWaveTypeOptions): Self = {
        val ret = this.duplicate
