...
object PlotCciConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotCciConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotCciConnectorsMarkerOptionsOps[Self <: PlotCciConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
