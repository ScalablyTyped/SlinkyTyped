...
@js.native
trait PlotAreasplineZonesOptions extends js.Object {
  /**
...
object PlotAreasplineZonesOptions {
  @scala.inline
  def apply(): PlotAreasplineZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineZonesOptions]
  }
  @scala.inline
  implicit class PlotAreasplineZonesOptionsOps[Self <: PlotAreasplineZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
