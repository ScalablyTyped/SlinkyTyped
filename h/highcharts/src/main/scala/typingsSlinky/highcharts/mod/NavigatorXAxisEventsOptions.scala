...
object NavigatorXAxisEventsOptions {
  ...
  @scala.inline
  def apply(): NavigatorXAxisEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisEventsOptions]
  }
  
  @scala.inline
  implicit class NavigatorXAxisEventsOptionsMutableBuilder[Self <: NavigatorXAxisEventsOptions] (val x: Self) extends AnyVal {
