...
object PlotMappointStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotMappointStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotMappointStatesSelectHaloOptionsOps[Self <: PlotMappointStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
