...
trait PlotMapTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMapTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMapTooltipOptions {
  @scala.inline
  def apply(): PlotMapTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapTooltipOptions]
  }
  @scala.inline
  implicit class PlotMapTooltipOptionsOps[Self <: PlotMapTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMapTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
