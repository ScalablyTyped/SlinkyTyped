...
trait SeriesStreamgraphOptions extends PlotStreamgraphOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | streamgraph = js.native
...
object SeriesStreamgraphOptions {
  ...
  @scala.inline
  def apply(`type`: String | streamgraph): SeriesStreamgraphOptions = {
  ...
  @scala.inline
  implicit class SeriesStreamgraphOptionsMutableBuilder[Self <: SeriesStreamgraphOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | streamgraph): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
