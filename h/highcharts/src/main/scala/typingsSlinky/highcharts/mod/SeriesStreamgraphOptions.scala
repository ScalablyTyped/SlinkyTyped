...
object SeriesStreamgraphOptions {
  ...
  @scala.inline
  implicit class SeriesStreamgraphOptionsOps[Self <: SeriesStreamgraphOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | streamgraph): Self = this.set("type", value.asInstanceOf[js.Any])
