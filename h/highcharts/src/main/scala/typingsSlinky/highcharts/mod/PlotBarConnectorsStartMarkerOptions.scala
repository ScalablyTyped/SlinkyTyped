...
object PlotBarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotBarConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotBarConnectorsStartMarkerOptionsOps[Self <: PlotBarConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
