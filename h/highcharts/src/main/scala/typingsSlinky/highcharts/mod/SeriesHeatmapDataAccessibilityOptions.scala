...
object SeriesHeatmapDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesHeatmapDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesHeatmapDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesHeatmapDataAccessibilityOptionsOps[Self <: SeriesHeatmapDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
