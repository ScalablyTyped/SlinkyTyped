...
trait SeriesColumnOptions extends PlotColumnOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | column = js.native
...
object SeriesColumnOptions {
  ...
  @scala.inline
  def apply(`type`: String | column): SeriesColumnOptions = {
  ...
  @scala.inline
  implicit class SeriesColumnOptionsOps[Self <: SeriesColumnOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | column): Self = this.set("type", value.asInstanceOf[js.Any])
