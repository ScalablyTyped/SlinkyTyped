...
@js.native
trait PlotBbMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotBbMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotBbMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBbMarkerStatesHoverOptionsOps[Self <: PlotBbMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
