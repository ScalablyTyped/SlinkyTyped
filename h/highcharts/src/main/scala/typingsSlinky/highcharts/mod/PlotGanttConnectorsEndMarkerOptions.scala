...
object PlotGanttConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotGanttConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotGanttConnectorsEndMarkerOptionsOps[Self <: PlotGanttConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
