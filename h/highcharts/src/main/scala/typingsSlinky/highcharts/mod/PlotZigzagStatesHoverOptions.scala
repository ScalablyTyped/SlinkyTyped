...
trait PlotZigzagStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotZigzagStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotZigzagStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotZigzagStatesHoverOptions {
  @scala.inline
  def apply(): PlotZigzagStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotZigzagStatesHoverOptionsOps[Self <: PlotZigzagStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotZigzagStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotZigzagStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
