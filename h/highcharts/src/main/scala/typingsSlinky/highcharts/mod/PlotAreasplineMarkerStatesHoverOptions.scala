...
object PlotAreasplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAreasplineMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAreasplineMarkerStatesHoverOptionsOps[Self <: PlotAreasplineMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
