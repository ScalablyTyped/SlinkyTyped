...
object NavigationAnnotationsLabelsPointOptions {
  @scala.inline
  def apply(): NavigationAnnotationsLabelsPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigationAnnotationsLabelsPointOptions]
  }
  @scala.inline
  implicit class NavigationAnnotationsLabelsPointOptionsOps[Self <: NavigationAnnotationsLabelsPointOptions] (val x: Self) extends AnyVal {
    @scala.inline
