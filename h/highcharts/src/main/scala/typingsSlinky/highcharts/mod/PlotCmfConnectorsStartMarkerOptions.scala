...
object PlotCmfConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotCmfConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotCmfConnectorsStartMarkerOptionsOps[Self <: PlotCmfConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
