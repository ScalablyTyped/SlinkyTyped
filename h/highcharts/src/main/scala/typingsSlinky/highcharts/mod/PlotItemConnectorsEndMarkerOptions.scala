...
object PlotItemConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotItemConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotItemConnectorsEndMarkerOptionsOps[Self <: PlotItemConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
