...
@js.native
trait SeriesWaterfallDataEventsOptions extends js.Object {
  /**
...
object SeriesWaterfallDataEventsOptions {
  @scala.inline
  def apply(): SeriesWaterfallDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWaterfallDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesWaterfallDataEventsOptionsOps[Self <: SeriesWaterfallDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
