...
trait PlotVariwideAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVariwideAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVariwideAccessibilityOptions {
  @scala.inline
  def apply(): PlotVariwideAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVariwideAccessibilityOptionsOps[Self <: PlotVariwideAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVariwideAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
