...
trait PlotBoxplotConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBoxplotConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBoxplotConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBoxplotConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotBoxplotConnectorsOptions {
  @scala.inline
  def apply(): PlotBoxplotConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotConnectorsOptions]
  }
  @scala.inline
  implicit class PlotBoxplotConnectorsOptionsOps[Self <: PlotBoxplotConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotBoxplotConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotBoxplotConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotBoxplotConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
