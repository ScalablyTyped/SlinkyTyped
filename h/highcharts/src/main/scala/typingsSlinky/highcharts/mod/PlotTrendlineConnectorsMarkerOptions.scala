...
object PlotTrendlineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTrendlineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrendlineConnectorsMarkerOptionsOps[Self <: PlotTrendlineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
