...
object PlotHeatmapStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotHeatmapStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotHeatmapStatesSelectHaloOptionsOps[Self <: PlotHeatmapStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
