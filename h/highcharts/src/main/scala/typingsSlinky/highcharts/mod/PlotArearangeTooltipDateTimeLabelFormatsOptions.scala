...
object PlotArearangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotArearangeTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotArearangeTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotArearangeTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
