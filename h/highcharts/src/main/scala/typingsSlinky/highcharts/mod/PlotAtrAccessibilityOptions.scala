...
trait PlotAtrAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAtrAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAtrAccessibilityOptions {
  @scala.inline
  def apply(): PlotAtrAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAtrAccessibilityOptionsOps[Self <: PlotAtrAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAtrAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
