...
@js.native
trait SeriesXrangeDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesXrangeDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesXrangeDataDataLabelsAnimationOptionsOps[Self <: SeriesXrangeDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
