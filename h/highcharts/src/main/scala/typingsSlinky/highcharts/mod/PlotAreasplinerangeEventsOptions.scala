...
@js.native
trait PlotAreasplinerangeEventsOptions extends js.Object {
  /**
...
object PlotAreasplinerangeEventsOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeEventsOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeEventsOptionsOps[Self <: PlotAreasplinerangeEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
