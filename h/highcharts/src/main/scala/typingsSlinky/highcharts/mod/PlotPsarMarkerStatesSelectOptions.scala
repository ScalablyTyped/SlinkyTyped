...
object PlotPsarMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPsarMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPsarMarkerStatesSelectOptionsOps[Self <: PlotPsarMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
