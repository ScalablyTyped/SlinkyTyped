...
trait PlotPieStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotPieStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotPieStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotPieStatesNormalOptions] = js.native
  /**
    * (Highcharts) Specific options for point in selected states, after being
    * selected by allowPointSelect or programmatically.
    */
  var select: js.UndefOr[PlotPieStatesSelectOptions] = js.native
}

object PlotPieStatesOptions {
  @scala.inline
  def apply(): PlotPieStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieStatesOptions]
  }
  @scala.inline
  implicit class PlotPieStatesOptionsOps[Self <: PlotPieStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotPieStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotPieStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotPieStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotPieStatesSelectOptions): Self = {
        val ret = this.duplicate
