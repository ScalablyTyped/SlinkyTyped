...
@js.native
trait PlotDpoMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotDpoMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotDpoMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotDpoMarkerStatesHoverOptionsOps[Self <: PlotDpoMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
