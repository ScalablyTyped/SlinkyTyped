...
trait ColorAxisCurrentDateIndicatorOptions extends js.Object {
  ...
  /**
    ...
    */
  var events: js.UndefOr[ColorAxisCurrentDateIndicatorEventsOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[ColorAxisCurrentDateIndicatorLabelOptions] = js.native
  /**
...
object ColorAxisCurrentDateIndicatorOptions {
  @scala.inline
  def apply(): ColorAxisCurrentDateIndicatorOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisCurrentDateIndicatorOptions]
  }
  @scala.inline
  implicit class ColorAxisCurrentDateIndicatorOptionsOps[Self <: ColorAxisCurrentDateIndicatorOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEvents(value: ColorAxisCurrentDateIndicatorEventsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: ColorAxisCurrentDateIndicatorLabelOptions): Self = {
        val ret = this.duplicate
