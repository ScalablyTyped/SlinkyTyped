...
object PlotDependencywheelPointEventsOptions {
  @scala.inline
  def apply(): PlotDependencywheelPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelPointEventsOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelPointEventsOptionsOps[Self <: PlotDependencywheelPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
