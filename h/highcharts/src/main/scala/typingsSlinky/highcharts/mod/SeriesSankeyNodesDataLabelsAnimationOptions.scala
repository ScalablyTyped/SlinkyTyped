...
@js.native
trait SeriesSankeyNodesDataLabelsAnimationOptions extends js.Object {
...
object SeriesSankeyNodesDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesSankeyNodesDataLabelsAnimationOptionsOps[Self <: SeriesSankeyNodesDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
