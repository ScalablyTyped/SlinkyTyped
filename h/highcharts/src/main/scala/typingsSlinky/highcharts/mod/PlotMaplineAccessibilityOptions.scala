...
trait PlotMaplineAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMaplineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMaplineAccessibilityOptions {
  @scala.inline
  def apply(): PlotMaplineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMaplineAccessibilityOptionsOps[Self <: PlotMaplineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMaplineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
