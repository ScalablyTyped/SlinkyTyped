...
@js.native
trait PlotVectorTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotVectorTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotVectorTooltipOptions {
  @scala.inline
  def apply(): PlotVectorTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorTooltipOptions]
  }
  @scala.inline
  implicit class PlotVectorTooltipOptionsOps[Self <: PlotVectorTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotVectorTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
