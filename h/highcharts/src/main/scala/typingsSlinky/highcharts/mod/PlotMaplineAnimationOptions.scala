...
@js.native
trait PlotMaplineAnimationOptions extends js.Object {
...
object PlotMaplineAnimationOptions {
  ...
  @scala.inline
  implicit class PlotMaplineAnimationOptionsOps[Self <: PlotMaplineAnimationOptions] (val x: Self) extends AnyVal {
