...
trait PlotAreasplinerangeMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplinerangeMarkerStatesOptions] = js.native
  /**
...
object PlotAreasplinerangeMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeMarkerOptionsOps[Self <: PlotAreasplinerangeMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAreasplinerangeMarkerStatesOptions): Self = {
        val ret = this.duplicate
