...
object PlotAreasplineDataGroupingOptions {
  @scala.inline
  def apply(): PlotAreasplineDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotAreasplineDataGroupingOptionsOps[Self <: PlotAreasplineDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
