...
object PlotNetworkgraphStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotNetworkgraphStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphStatesSelectHaloOptionsOps[Self <: PlotNetworkgraphStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
