...
object PlotStochasticOptions {
  ...
  implicit class PlotStochasticOptionsOps[Self <: PlotStochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStochasticAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotStochasticDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotStochasticDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotStochasticParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmoothedLine(value: PlotStochasticSmoothedLineOptions): Self = this.set("smoothedLine", value.asInstanceOf[js.Any])
