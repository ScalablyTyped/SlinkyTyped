...
trait PlotStochasticOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotStochasticAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotStochasticDataSortingOptions] = js.native
...
object PlotStochasticOptions {
  ...
  @scala.inline
  implicit class PlotStochasticOptionsMutableBuilder[Self <: PlotStochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStochasticAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotStochasticDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotStochasticDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotStochasticParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmoothedLine(value: PlotStochasticSmoothedLineOptions): Self = StObject.set(x, "smoothedLine", value.asInstanceOf[js.Any])
