...
object PlotBellcurveOptions {
  ...
  implicit class PlotBellcurveOptionsOps[Self <: PlotBellcurveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBellcurveAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotBellcurveDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBellcurveDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIntervals(value: Double): Self = this.set("intervals", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPointsInInterval(value: Double): Self = this.set("pointsInInterval", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePointsInInterval: Self = this.set("pointsInInterval", js.undefined)
