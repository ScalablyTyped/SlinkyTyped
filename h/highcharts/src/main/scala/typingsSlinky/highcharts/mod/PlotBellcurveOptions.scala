...
@js.native
trait PlotBellcurveOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBellcurveAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotBellcurveDataSortingOptions] = js.native
...
object PlotBellcurveOptions {
  ...
  @scala.inline
  implicit class PlotBellcurveOptionsMutableBuilder[Self <: PlotBellcurveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBellcurveAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotBellcurveDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBellcurveDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIntervals(value: Double): Self = StObject.set(x, "intervals", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPointsInInterval(value: Double): Self = StObject.set(x, "pointsInInterval", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointsInIntervalUndefined: Self = StObject.set(x, "pointsInInterval", js.undefined)
