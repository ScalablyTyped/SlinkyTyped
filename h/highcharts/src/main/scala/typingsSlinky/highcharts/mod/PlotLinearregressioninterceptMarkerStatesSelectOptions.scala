...
object PlotLinearregressioninterceptMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptMarkerStatesSelectOptionsOps[Self <: PlotLinearregressioninterceptMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
