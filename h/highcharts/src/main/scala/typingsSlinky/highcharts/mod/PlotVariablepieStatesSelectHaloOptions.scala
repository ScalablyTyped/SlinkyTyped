...
object PlotVariablepieStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotVariablepieStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotVariablepieStatesSelectHaloOptionsOps[Self <: PlotVariablepieStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
