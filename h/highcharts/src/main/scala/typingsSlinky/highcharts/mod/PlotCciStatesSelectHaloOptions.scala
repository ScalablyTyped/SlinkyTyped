...
@js.native
trait PlotCciStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotCciStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotCciStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotCciStatesSelectHaloOptionsOps[Self <: PlotCciStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
