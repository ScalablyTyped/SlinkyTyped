...
@js.native
trait SeriesHeatmapDataEventsOptions extends js.Object {
  /**
...
object SeriesHeatmapDataEventsOptions {
  @scala.inline
  def apply(): SeriesHeatmapDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesHeatmapDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesHeatmapDataEventsOptionsOps[Self <: SeriesHeatmapDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
