...
object SeriesWaterfallDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesWaterfallDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWaterfallDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesWaterfallDataDragDropDragHandleOptionsOps[Self <: SeriesWaterfallDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
