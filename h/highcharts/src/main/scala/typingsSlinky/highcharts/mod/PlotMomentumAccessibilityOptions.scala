...
@js.native
trait PlotMomentumAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMomentumAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMomentumAccessibilityOptions {
  @scala.inline
  def apply(): PlotMomentumAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMomentumAccessibilityOptionsOps[Self <: PlotMomentumAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMomentumAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
