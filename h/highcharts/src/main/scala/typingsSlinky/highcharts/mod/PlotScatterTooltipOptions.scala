...
trait PlotScatterTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotScatterTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotScatterTooltipOptions {
  @scala.inline
  def apply(): PlotScatterTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterTooltipOptions]
  }
  @scala.inline
  implicit class PlotScatterTooltipOptionsOps[Self <: PlotScatterTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotScatterTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
