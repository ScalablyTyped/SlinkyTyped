...
object PlotXrangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotXrangeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotXrangeConnectorsStartMarkerOptionsOps[Self <: PlotXrangeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
