...
trait PlotBubbleConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBubbleConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBubbleConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBubbleConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBubbleConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotBubbleConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotBubbleConnectorsMarkerOptions = null,
    startMarker: PlotBubbleConnectorsStartMarkerOptions = null,
