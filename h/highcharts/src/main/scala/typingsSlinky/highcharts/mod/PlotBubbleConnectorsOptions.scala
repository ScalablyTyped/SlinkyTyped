...
@js.native
trait PlotBubbleConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBubbleConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBubbleConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBubbleConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotBubbleConnectorsOptions {
  @scala.inline
  def apply(): PlotBubbleConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleConnectorsOptions]
  }
  @scala.inline
  implicit class PlotBubbleConnectorsOptionsOps[Self <: PlotBubbleConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotBubbleConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotBubbleConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotBubbleConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
