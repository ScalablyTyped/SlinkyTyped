...
@js.native
trait PlotApoPointEventsOptions extends js.Object {
  /**
...
object PlotApoPointEventsOptions {
  @scala.inline
  def apply(): PlotApoPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoPointEventsOptions]
  }
  @scala.inline
  implicit class PlotApoPointEventsOptionsOps[Self <: PlotApoPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
