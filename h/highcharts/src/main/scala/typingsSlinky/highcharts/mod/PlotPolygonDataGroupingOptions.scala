...
object PlotPolygonDataGroupingOptions {
  @scala.inline
  def apply(): PlotPolygonDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPolygonDataGroupingOptionsOps[Self <: PlotPolygonDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
