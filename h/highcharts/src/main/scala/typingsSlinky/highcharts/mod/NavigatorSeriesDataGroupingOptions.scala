...
@js.native
trait NavigatorSeriesDataGroupingOptions extends js.Object {
  /**
...
object NavigatorSeriesDataGroupingOptions {
  @scala.inline
  def apply(): NavigatorSeriesDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorSeriesDataGroupingOptions]
  }
  @scala.inline
  implicit class NavigatorSeriesDataGroupingOptionsOps[Self <: NavigatorSeriesDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
