...
@js.native
trait PlotScatter3dTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotScatter3dTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotScatter3dTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotScatter3dTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotScatter3dTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
