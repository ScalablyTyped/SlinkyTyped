...
object PlotTemaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTemaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTemaConnectorsEndMarkerOptionsOps[Self <: PlotTemaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
