...
trait PlotPivotpointsTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPivotpointsTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPivotpointsTooltipOptions {
  @scala.inline
  def apply(): PlotPivotpointsTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsTooltipOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsTooltipOptionsOps[Self <: PlotPivotpointsTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPivotpointsTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
