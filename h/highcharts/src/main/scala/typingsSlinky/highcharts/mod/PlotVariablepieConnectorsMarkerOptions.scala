...
@js.native
trait PlotVariablepieConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVariablepieConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVariablepieConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariablepieConnectorsMarkerOptionsOps[Self <: PlotVariablepieConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
