...
trait PlotPackedbubbleStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotPackedbubbleStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPackedbubbleStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotPackedbubbleStatesSelectOptions {
  @scala.inline
  def apply(): PlotPackedbubbleStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleStatesSelectOptionsOps[Self <: PlotPackedbubbleStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotPackedbubbleStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPackedbubbleStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
