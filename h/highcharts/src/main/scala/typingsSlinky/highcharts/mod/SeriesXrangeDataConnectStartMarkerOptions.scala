...
@js.native
trait SeriesXrangeDataConnectStartMarkerOptions extends js.Object {
  /**
...
object SeriesXrangeDataConnectStartMarkerOptions {
  @scala.inline
  def apply(): SeriesXrangeDataConnectStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataConnectStartMarkerOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataConnectStartMarkerOptionsOps[Self <: SeriesXrangeDataConnectStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
