...
object PlotScatter3dStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotScatter3dStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotScatter3dStatesSelectAnimationOptionsOps[Self <: PlotScatter3dStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
