...
trait PlotGanttStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotGanttStatesSelectAnimationOptions] = js.native
  /**
...
object PlotGanttStatesSelectOptions {
  @scala.inline
  def apply(): PlotGanttStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotGanttStatesSelectOptionsOps[Self <: PlotGanttStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotGanttStatesSelectAnimationOptions): Self = {
