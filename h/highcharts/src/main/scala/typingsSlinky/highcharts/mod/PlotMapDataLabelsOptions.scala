...
@js.native
trait PlotMapDataLabelsOptions extends js.Object {
...
object PlotMapDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMapDataLabelsOptionsOps[Self <: PlotMapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
