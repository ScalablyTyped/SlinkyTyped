...
trait PlotPackedbubbleTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPackedbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPackedbubbleTooltipOptions {
  @scala.inline
  def apply(): PlotPackedbubbleTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleTooltipOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleTooltipOptionsOps[Self <: PlotPackedbubbleTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPackedbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
