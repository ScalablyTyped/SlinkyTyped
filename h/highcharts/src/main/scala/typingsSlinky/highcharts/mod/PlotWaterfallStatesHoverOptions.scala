...
trait PlotWaterfallStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWaterfallStatesHoverAnimationOptions] = js.native
  /**
...
object PlotWaterfallStatesHoverOptions {
  @scala.inline
  def apply(): PlotWaterfallStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWaterfallStatesHoverOptionsOps[Self <: PlotWaterfallStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotWaterfallStatesHoverAnimationOptions): Self = {
