...
object PlotAdMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAdMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAdMarkerStatesHoverOptionsOps[Self <: PlotAdMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
