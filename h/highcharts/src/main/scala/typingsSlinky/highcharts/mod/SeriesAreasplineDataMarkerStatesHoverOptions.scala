...
object SeriesAreasplineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesAreasplineDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplineDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesAreasplineDataMarkerStatesHoverOptionsOps[Self <: SeriesAreasplineDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
