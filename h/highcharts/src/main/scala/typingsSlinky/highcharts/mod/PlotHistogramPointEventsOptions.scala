...
object PlotHistogramPointEventsOptions {
  @scala.inline
  def apply(): PlotHistogramPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramPointEventsOptions]
  }
  @scala.inline
  implicit class PlotHistogramPointEventsOptionsOps[Self <: PlotHistogramPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
