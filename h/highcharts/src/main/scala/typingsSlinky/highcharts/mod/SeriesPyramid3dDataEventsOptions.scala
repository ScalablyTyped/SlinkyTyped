...
object SeriesPyramid3dDataEventsOptions {
  @scala.inline
  def apply(): SeriesPyramid3dDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramid3dDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesPyramid3dDataEventsOptionsOps[Self <: SeriesPyramid3dDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
