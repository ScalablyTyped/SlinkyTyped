...
object PlotDependencywheelConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotDependencywheelConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelConnectorsEndMarkerOptionsOps[Self <: PlotDependencywheelConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
