...
trait PlotFunnel3dStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotFunnel3dStatesSelectAnimationOptions] = js.native
  /**
...
object PlotFunnel3dStatesSelectOptions {
  @scala.inline
  def apply(): PlotFunnel3dStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dStatesSelectOptionsOps[Self <: PlotFunnel3dStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotFunnel3dStatesSelectAnimationOptions): Self = {
