...
@js.native
trait PlotErrorbarDataLabelsAnimationOptions extends js.Object {
...
object PlotErrorbarDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotErrorbarDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotErrorbarDataLabelsAnimationOptionsOps[Self <: PlotErrorbarDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
