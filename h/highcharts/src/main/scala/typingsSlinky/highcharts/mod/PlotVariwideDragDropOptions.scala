...
trait PlotVariwideDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotVariwideDragDropDragHandleOptions] = js.native
  /**
...
object PlotVariwideDragDropOptions {
  @scala.inline
  def apply(): PlotVariwideDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDragDropOptions]
  }
  @scala.inline
  implicit class PlotVariwideDragDropOptionsOps[Self <: PlotVariwideDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotVariwideDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotVariwideDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
