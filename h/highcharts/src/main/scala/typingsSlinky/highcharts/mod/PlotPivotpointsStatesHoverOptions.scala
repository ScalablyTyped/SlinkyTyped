...
trait PlotPivotpointsStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPivotpointsStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotPivotpointsStatesHoverOptions {
  @scala.inline
  def apply(): PlotPivotpointsStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsStatesHoverOptionsOps[Self <: PlotPivotpointsStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPivotpointsStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
