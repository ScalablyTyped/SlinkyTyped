...
trait PlotSmaMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSmaMarkerStatesOptions] = js.native
  /**
...
object PlotSmaMarkerOptions {
  @scala.inline
  def apply(): PlotSmaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaMarkerOptions]
  }
  @scala.inline
  implicit class PlotSmaMarkerOptionsOps[Self <: PlotSmaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotSmaMarkerStatesOptions): Self = {
        val ret = this.duplicate
