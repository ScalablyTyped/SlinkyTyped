...
object PlotMapbubbleConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMapbubbleConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleConnectorsMarkerOptionsOps[Self <: PlotMapbubbleConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
