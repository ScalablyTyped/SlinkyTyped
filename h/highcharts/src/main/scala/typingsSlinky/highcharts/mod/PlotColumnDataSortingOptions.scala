...
@js.native
trait PlotColumnDataSortingOptions extends StObject {
...
object PlotColumnDataSortingOptions {
  
  @scala.inline
  def apply(): PlotColumnDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotColumnDataSortingOptionsMutableBuilder[Self <: PlotColumnDataSortingOptions] (val x: Self) extends AnyVal {
