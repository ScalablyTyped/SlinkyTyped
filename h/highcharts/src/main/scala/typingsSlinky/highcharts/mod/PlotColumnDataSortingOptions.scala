...
@js.native
trait PlotColumnDataSortingOptions extends js.Object {
...
object PlotColumnDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotColumnDataSortingOptionsOps[Self <: PlotColumnDataSortingOptions] (val x: Self) extends AnyVal {
