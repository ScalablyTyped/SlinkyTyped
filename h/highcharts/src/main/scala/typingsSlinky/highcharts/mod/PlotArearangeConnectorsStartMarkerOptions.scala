...
object PlotArearangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotArearangeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotArearangeConnectorsStartMarkerOptionsOps[Self <: PlotArearangeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
