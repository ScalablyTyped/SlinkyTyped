...
@js.native
trait PlotStreamgraphStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotStreamgraphStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStreamgraphStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotStreamgraphStatesHoverOptions {
  @scala.inline
  def apply(): PlotStreamgraphStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphStatesHoverOptionsOps[Self <: PlotStreamgraphStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotStreamgraphStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotStreamgraphStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
