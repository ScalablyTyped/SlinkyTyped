...
@js.native
trait PlotSmaDataSortingOptions extends StObject {
...
object PlotSmaDataSortingOptions {
  
  @scala.inline
  def apply(): PlotSmaDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotSmaDataSortingOptionsMutableBuilder[Self <: PlotSmaDataSortingOptions] (val x: Self) extends AnyVal {
