...
trait PlotMappointTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMappointTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMappointTooltipOptions {
  @scala.inline
  def apply(): PlotMappointTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointTooltipOptions]
  }
  @scala.inline
  implicit class PlotMappointTooltipOptionsOps[Self <: PlotMappointTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMappointTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
