...
object SeriesAreaDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesAreaDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataDragDropDragHandleOptionsOps[Self <: SeriesAreaDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
