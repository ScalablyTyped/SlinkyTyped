...
@js.native
trait SeriesPolygonDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesPolygonDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesPolygonDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataMarkerStatesHoverOptionsOps[Self <: SeriesPolygonDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
