...
@js.native
trait PlotSeriesTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotSeriesTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotSeriesTooltipOptions {
  @scala.inline
  def apply(): PlotSeriesTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesTooltipOptions]
  }
  @scala.inline
  implicit class PlotSeriesTooltipOptionsOps[Self <: PlotSeriesTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotSeriesTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
