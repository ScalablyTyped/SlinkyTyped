...
object PlotBubbleStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotBubbleStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotBubbleStatesSelectHaloOptionsOps[Self <: PlotBubbleStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
