...
@js.native
trait PlotLineDataSortingOptions extends js.Object {
...
object PlotLineDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotLineDataSortingOptionsOps[Self <: PlotLineDataSortingOptions] (val x: Self) extends AnyVal {
