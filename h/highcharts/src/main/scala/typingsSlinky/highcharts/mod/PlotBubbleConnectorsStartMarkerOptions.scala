...
object PlotBubbleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotBubbleConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotBubbleConnectorsStartMarkerOptionsOps[Self <: PlotBubbleConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
