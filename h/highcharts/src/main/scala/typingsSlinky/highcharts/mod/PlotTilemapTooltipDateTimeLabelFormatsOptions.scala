...
@js.native
trait PlotTilemapTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTilemapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotTilemapTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotTilemapTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotTilemapTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
