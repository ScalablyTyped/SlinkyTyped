...
trait PlotFlagsTooltipOptions extends js.Object {
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotFlagsTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotFlagsTooltipOptions {
  @scala.inline
  def apply(): PlotFlagsTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsTooltipOptions]
  }
  @scala.inline
  implicit class PlotFlagsTooltipOptionsOps[Self <: PlotFlagsTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDateTimeLabelFormats(value: PlotFlagsTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
