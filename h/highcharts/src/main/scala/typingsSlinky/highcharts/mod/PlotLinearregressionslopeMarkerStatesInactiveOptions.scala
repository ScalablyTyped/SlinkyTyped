...
object PlotLinearregressionslopeMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeMarkerStatesInactiveOptionsOps[Self <: PlotLinearregressionslopeMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
