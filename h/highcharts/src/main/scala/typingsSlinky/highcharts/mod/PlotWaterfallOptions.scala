...
object PlotWaterfallOptions {
  ...
  @scala.inline
  implicit class PlotWaterfallOptionsOps[Self <: PlotWaterfallOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWaterfallAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotWaterfallDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotWaterfallDataLabelsOptions | js.Array[PlotWaterfallDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotWaterfallDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
