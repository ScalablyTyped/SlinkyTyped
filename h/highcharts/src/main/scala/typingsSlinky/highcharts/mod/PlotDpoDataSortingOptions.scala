...
@js.native
trait PlotDpoDataSortingOptions extends StObject {
...
object PlotDpoDataSortingOptions {
  
  @scala.inline
  def apply(): PlotDpoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotDpoDataSortingOptionsMutableBuilder[Self <: PlotDpoDataSortingOptions] (val x: Self) extends AnyVal {
