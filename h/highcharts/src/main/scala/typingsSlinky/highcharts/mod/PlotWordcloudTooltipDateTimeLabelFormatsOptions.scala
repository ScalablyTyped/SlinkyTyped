...
object PlotWordcloudTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotWordcloudTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotWordcloudTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotWordcloudTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
