...
object SeriesBubbleDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesBubbleDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataAccessibilityOptionsOps[Self <: SeriesBubbleDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
