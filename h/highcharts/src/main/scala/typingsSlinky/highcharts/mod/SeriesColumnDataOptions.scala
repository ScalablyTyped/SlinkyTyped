...
@js.native
trait SeriesColumnDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesColumnDataAccessibilityOptions] = js.native
  /**
  ...
  /**
    * (Highcharts, Highstock) A name for the dash style to use for the column
    * or bar. Overrides dashStyle on the series.
    *
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesColumnDataDragDropOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesColumnDataEventsOptions] = js.native
  /**
...
object SeriesColumnDataOptions {
  @scala.inline
  def apply(): SeriesColumnDataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnDataOptions]
  }
  @scala.inline
  implicit class SeriesColumnDataOptionsOps[Self <: SeriesColumnDataOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccessibility(value: SeriesColumnDataAccessibilityOptions): Self = {
    ...
    @scala.inline
    def withDragDrop(value: SeriesColumnDataDragDropOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEvents(value: SeriesColumnDataEventsOptions): Self = {
        val ret = this.duplicate
