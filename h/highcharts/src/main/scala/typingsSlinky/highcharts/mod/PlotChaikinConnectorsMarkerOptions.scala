...
@js.native
trait PlotChaikinConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotChaikinConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotChaikinConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotChaikinConnectorsMarkerOptionsOps[Self <: PlotChaikinConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
