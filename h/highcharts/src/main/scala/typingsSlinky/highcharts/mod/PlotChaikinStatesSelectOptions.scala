...
trait PlotChaikinStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotChaikinStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotChaikinStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotChaikinStatesSelectOptions {
  @scala.inline
  def apply(): PlotChaikinStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotChaikinStatesSelectOptionsOps[Self <: PlotChaikinStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotChaikinStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotChaikinStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
