...
object PlotMacdMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotMacdMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMacdMarkerStatesSelectOptionsOps[Self <: PlotMacdMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
