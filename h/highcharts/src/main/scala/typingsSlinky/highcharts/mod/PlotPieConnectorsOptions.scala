...
trait PlotPieConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPieConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPieConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPieConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPieConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotPieConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotPieConnectorsMarkerOptions = null,
    startMarker: PlotPieConnectorsStartMarkerOptions = null,
