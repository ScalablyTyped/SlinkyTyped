...
@js.native
trait PlotAoConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAoConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAoConnectorsStartMarkerOptionsOps[Self <: PlotAoConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
