...
trait PlotWilliamsrTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWilliamsrTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotWilliamsrTooltipOptions {
  @scala.inline
  def apply(): PlotWilliamsrTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrTooltipOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrTooltipOptionsOps[Self <: PlotWilliamsrTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotWilliamsrTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
