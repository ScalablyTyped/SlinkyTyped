...
trait PlotLinearregressionslopeStatesHoverOptions extends js.Object {
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionslopeStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressionslopeStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeStatesHoverOptionsOps[Self <: PlotLinearregressionslopeStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressionslopeStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
