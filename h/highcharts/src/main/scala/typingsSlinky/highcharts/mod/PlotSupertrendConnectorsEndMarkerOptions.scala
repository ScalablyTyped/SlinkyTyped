...
object PlotSupertrendConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSupertrendConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSupertrendConnectorsEndMarkerOptionsOps[Self <: PlotSupertrendConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
