...
@js.native
trait PlotPivotpointsStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotPivotpointsStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPivotpointsStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsStatesSelectHaloOptionsOps[Self <: PlotPivotpointsStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
