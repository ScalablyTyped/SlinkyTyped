...
trait PlotTemaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTemaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTemaAccessibilityOptions {
  @scala.inline
  def apply(): PlotTemaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTemaAccessibilityOptionsOps[Self <: PlotTemaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTemaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
