...
trait PlotXrangeDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotXrangeDragDropDragHandleOptions] = js.native
  /**
...
object PlotXrangeDragDropOptions {
  @scala.inline
  def apply(): PlotXrangeDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeDragDropOptions]
  }
  @scala.inline
  implicit class PlotXrangeDragDropOptionsOps[Self <: PlotXrangeDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotXrangeDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotXrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
