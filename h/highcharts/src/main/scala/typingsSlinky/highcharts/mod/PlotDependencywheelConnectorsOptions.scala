...
trait PlotDependencywheelConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDependencywheelConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDependencywheelConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDependencywheelConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotDependencywheelConnectorsOptions {
  @scala.inline
  def apply(): PlotDependencywheelConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelConnectorsOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelConnectorsOptionsOps[Self <: PlotDependencywheelConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotDependencywheelConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotDependencywheelConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotDependencywheelConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
