...
trait PlotBarConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBarConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBarConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBarConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBarConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotBarConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotBarConnectorsMarkerOptions = null,
    startMarker: PlotBarConnectorsStartMarkerOptions = null,
