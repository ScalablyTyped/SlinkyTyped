...
trait SeriesScatterOptions extends PlotScatterOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | scatter = js.native
...
object SeriesScatterOptions {
  ...
  @scala.inline
  def apply(`type`: String | scatter): SeriesScatterOptions = {
  ...
  @scala.inline
  implicit class SeriesScatterOptionsMutableBuilder[Self <: SeriesScatterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | scatter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
