...
object SeriesScatterOptions {
  ...
  @scala.inline
  implicit class SeriesScatterOptionsOps[Self <: SeriesScatterOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | scatter): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
