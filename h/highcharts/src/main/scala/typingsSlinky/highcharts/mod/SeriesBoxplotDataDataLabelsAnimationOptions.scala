...
@js.native
trait SeriesBoxplotDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesBoxplotDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesBoxplotDataDataLabelsAnimationOptionsOps[Self <: SeriesBoxplotDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
