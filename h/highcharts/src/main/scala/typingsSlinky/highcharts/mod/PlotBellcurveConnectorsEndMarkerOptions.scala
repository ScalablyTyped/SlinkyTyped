...
object PlotBellcurveConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBellcurveConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBellcurveConnectorsEndMarkerOptionsOps[Self <: PlotBellcurveConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
