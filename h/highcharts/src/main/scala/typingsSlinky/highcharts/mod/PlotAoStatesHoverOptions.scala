...
trait PlotAoStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAoStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAoStatesHoverHaloOptions] = js.native
  /**
...
object PlotAoStatesHoverOptions {
  @scala.inline
  def apply(): PlotAoStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAoStatesHoverOptionsOps[Self <: PlotAoStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAoStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAoStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
