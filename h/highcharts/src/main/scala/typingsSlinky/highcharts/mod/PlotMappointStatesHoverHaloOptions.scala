...
object PlotMappointStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotMappointStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotMappointStatesHoverHaloOptionsOps[Self <: PlotMappointStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
