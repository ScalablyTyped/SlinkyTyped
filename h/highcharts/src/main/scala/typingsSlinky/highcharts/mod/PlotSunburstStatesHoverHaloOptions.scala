...
@js.native
trait PlotSunburstStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotSunburstStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotSunburstStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotSunburstStatesHoverHaloOptionsOps[Self <: PlotSunburstStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
