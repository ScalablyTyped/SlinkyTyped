...
trait PlotPyramid3dStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotPyramid3dStatesSelectAnimationOptions] = js.native
  /**
...
object PlotPyramid3dStatesSelectOptions {
  @scala.inline
  def apply(): PlotPyramid3dStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dStatesSelectOptionsOps[Self <: PlotPyramid3dStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotPyramid3dStatesSelectAnimationOptions): Self = {
