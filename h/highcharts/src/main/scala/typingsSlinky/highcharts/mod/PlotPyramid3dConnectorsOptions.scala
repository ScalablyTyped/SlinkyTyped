...
trait PlotPyramid3dConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPyramid3dConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPyramid3dConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPyramid3dConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotPyramid3dConnectorsOptions {
  @scala.inline
  def apply(): PlotPyramid3dConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dConnectorsOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dConnectorsOptionsOps[Self <: PlotPyramid3dConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotPyramid3dConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotPyramid3dConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotPyramid3dConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
