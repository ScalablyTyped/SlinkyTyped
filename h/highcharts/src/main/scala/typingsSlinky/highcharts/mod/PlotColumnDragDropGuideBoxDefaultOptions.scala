...
object PlotColumnDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotColumnDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotColumnDragDropGuideBoxDefaultOptionsOps[Self <: PlotColumnDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
