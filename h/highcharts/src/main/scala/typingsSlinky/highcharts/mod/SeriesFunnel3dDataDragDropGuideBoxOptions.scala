...
object SeriesFunnel3dDataDragDropGuideBoxOptions {
  ...
  @scala.inline
  def apply(): SeriesFunnel3dDataDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFunnel3dDataDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit class SeriesFunnel3dDataDragDropGuideBoxOptionsOps[Self <: SeriesFunnel3dDataDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
