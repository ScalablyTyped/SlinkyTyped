...
object PlotScatter3dStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotScatter3dStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotScatter3dStatesSelectHaloOptionsOps[Self <: PlotScatter3dStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
