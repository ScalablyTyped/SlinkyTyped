...
trait PlotXrangeStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotXrangeStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock, Gantt) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotXrangeStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotXrangeStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotXrangeStatesSelectOptions] = js.native
}

object PlotXrangeStatesOptions {
  @scala.inline
  def apply(): PlotXrangeStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeStatesOptions]
  }
  @scala.inline
  implicit class PlotXrangeStatesOptionsOps[Self <: PlotXrangeStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotXrangeStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotXrangeStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotXrangeStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotXrangeStatesSelectOptions): Self = {
        val ret = this.duplicate
