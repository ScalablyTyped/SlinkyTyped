...
@js.native
trait SeriesCandlestickDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesCandlestickDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesCandlestickDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesCandlestickDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesCandlestickDataDragDropDragHandleOptionsOps[Self <: SeriesCandlestickDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
