...
object PlotMomentumStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotMomentumStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotMomentumStatesSelectHaloOptionsOps[Self <: PlotMomentumStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
