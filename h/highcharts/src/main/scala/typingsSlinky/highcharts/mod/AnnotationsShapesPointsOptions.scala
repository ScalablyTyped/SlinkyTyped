...
object AnnotationsShapesPointsOptions {
  @scala.inline
  def apply(): AnnotationsShapesPointsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsShapesPointsOptions]
  }
  @scala.inline
  implicit class AnnotationsShapesPointsOptionsOps[Self <: AnnotationsShapesPointsOptions] (val x: Self) extends AnyVal {
    @scala.inline
