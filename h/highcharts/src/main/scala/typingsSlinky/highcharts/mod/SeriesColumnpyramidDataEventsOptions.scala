...
object SeriesColumnpyramidDataEventsOptions {
  @scala.inline
  def apply(): SeriesColumnpyramidDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnpyramidDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesColumnpyramidDataEventsOptionsOps[Self <: SeriesColumnpyramidDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
