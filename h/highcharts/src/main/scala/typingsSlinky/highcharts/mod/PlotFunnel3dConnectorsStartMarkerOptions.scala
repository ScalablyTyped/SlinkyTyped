...
@js.native
trait PlotFunnel3dConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotFunnel3dConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotFunnel3dConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dConnectorsStartMarkerOptionsOps[Self <: PlotFunnel3dConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
