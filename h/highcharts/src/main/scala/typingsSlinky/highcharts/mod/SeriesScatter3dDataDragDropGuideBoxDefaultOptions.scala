...
object SeriesScatter3dDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesScatter3dDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
