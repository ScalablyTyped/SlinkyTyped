...
trait PlotVariwideStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotVariwideStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotVariwideStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotVariwideStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotVariwideStatesSelectOptions] = js.native
}

object PlotVariwideStatesOptions {
  @scala.inline
  def apply(): PlotVariwideStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideStatesOptions]
  }
  @scala.inline
  implicit class PlotVariwideStatesOptionsOps[Self <: PlotVariwideStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotVariwideStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotVariwideStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotVariwideStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotVariwideStatesSelectOptions): Self = {
        val ret = this.duplicate
