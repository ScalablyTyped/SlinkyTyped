...
trait PlotVariwideStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVariwideStatesHoverAnimationOptions] = js.native
  /**
...
object PlotVariwideStatesHoverOptions {
  @scala.inline
  def apply(): PlotVariwideStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotVariwideStatesHoverOptionsOps[Self <: PlotVariwideStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotVariwideStatesHoverAnimationOptions): Self = {
