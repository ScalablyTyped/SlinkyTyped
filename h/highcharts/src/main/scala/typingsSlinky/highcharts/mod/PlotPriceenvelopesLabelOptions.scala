...
@js.native
trait PlotPriceenvelopesLabelOptions extends js.Object {
  /**
...
object PlotPriceenvelopesLabelOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesLabelOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesLabelOptionsOps[Self <: PlotPriceenvelopesLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
