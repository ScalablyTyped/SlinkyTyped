...
@js.native
trait PlotNetworkgraphConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotNetworkgraphConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotNetworkgraphConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphConnectorsEndMarkerOptionsOps[Self <: PlotNetworkgraphConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
