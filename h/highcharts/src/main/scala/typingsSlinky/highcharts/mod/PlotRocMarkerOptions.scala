...
trait PlotRocMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRocMarkerStatesOptions] = js.native
  /**
...
object PlotRocMarkerOptions {
  @scala.inline
  def apply(): PlotRocMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocMarkerOptions]
  }
  @scala.inline
  implicit class PlotRocMarkerOptionsOps[Self <: PlotRocMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotRocMarkerStatesOptions): Self = {
        val ret = this.duplicate
