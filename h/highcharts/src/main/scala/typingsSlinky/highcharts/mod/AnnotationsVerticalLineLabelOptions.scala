...
object AnnotationsVerticalLineLabelOptions {
  ...
  @scala.inline
  def apply(): AnnotationsVerticalLineLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsVerticalLineLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsVerticalLineLabelOptionsMutableBuilder[Self <: AnnotationsVerticalLineLabelOptions] (val x: Self) extends AnyVal {
