...
@js.native
trait PlotVectorEventsOptions extends js.Object {
  /**
...
object PlotVectorEventsOptions {
  @scala.inline
  def apply(): PlotVectorEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorEventsOptions]
  }
  @scala.inline
  implicit class PlotVectorEventsOptionsOps[Self <: PlotVectorEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
