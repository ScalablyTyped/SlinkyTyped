...
object PlotLinearregressionMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionMarkerStatesHoverOptionsOps[Self <: PlotLinearregressionMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
