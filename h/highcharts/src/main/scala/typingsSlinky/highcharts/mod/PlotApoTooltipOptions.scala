...
trait PlotApoTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotApoTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotApoTooltipOptions {
  @scala.inline
  def apply(): PlotApoTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoTooltipOptions]
  }
  @scala.inline
  implicit class PlotApoTooltipOptionsOps[Self <: PlotApoTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotApoTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
