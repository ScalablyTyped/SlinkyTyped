...
@js.native
trait PlotAroonStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotAroonStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotAroonStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotAroonStatesHoverHaloOptionsOps[Self <: PlotAroonStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
