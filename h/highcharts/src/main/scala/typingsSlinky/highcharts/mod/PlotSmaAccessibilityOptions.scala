...
trait PlotSmaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSmaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSmaAccessibilityOptions {
  @scala.inline
  def apply(): PlotSmaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSmaAccessibilityOptionsOps[Self <: PlotSmaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSmaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
