...
object PlotMapbubbleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMapbubbleConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleConnectorsEndMarkerOptionsOps[Self <: PlotMapbubbleConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
