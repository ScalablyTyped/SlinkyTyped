...
trait PlotColumnrangeAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotColumnrangeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotColumnrangeAccessibilityOptions {
  @scala.inline
  def apply(): PlotColumnrangeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeAccessibilityOptionsOps[Self <: PlotColumnrangeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotColumnrangeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
