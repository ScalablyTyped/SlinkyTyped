...
object PlotBellcurveMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotBellcurveMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBellcurveMarkerStatesSelectOptionsOps[Self <: PlotBellcurveMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
