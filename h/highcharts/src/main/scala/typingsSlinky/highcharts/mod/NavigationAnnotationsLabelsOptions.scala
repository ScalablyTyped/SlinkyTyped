...
trait NavigationAnnotationsLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var point: js.UndefOr[String | MockPointOptionsObject | NavigationAnnotationsLabelsPointOptions] = js.native
  /**
...
object NavigationAnnotationsLabelsOptions {
  ...
  implicit class NavigationAnnotationsLabelsOptionsOps[Self <: NavigationAnnotationsLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPoint(value: String | MockPointOptionsObject | NavigationAnnotationsLabelsPointOptions): Self = {
        val ret = this.duplicate
