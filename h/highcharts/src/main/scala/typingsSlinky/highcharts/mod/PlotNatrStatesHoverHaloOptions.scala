...
object PlotNatrStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotNatrStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotNatrStatesHoverHaloOptionsOps[Self <: PlotNatrStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
