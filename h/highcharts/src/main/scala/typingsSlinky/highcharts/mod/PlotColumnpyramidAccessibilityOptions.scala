...
trait PlotColumnpyramidAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotColumnpyramidAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotColumnpyramidAccessibilityOptions {
  @scala.inline
  def apply(): PlotColumnpyramidAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidAccessibilityOptionsOps[Self <: PlotColumnpyramidAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotColumnpyramidAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
