...
object PlotVbpConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVbpConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVbpConnectorsEndMarkerOptionsOps[Self <: PlotVbpConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
