...
object PlotStochasticDataGroupingOptions {
  @scala.inline
  def apply(): PlotStochasticDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotStochasticDataGroupingOptionsOps[Self <: PlotStochasticDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
