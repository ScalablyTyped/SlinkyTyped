...
object PlotSunburstStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotSunburstStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotSunburstStatesSelectHaloOptionsOps[Self <: PlotSunburstStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
