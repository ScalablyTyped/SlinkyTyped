...
@js.native
trait PlotVennConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVennConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVennConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVennConnectorsMarkerOptionsOps[Self <: PlotVennConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
