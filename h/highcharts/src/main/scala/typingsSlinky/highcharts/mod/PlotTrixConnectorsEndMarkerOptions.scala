...
object PlotTrixConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTrixConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrixConnectorsEndMarkerOptionsOps[Self <: PlotTrixConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
