...
object SeriesGanttDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesGanttDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataMarkerStatesSelectOptionsOps[Self <: SeriesGanttDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
