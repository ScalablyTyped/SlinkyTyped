...
object PlotCandlestickDataGroupingOptions {
  @scala.inline
  def apply(): PlotCandlestickDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotCandlestickDataGroupingOptionsOps[Self <: PlotCandlestickDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
