...
object PlotMapbubbleDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotMapbubbleDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleDragDropGuideBoxDefaultOptionsOps[Self <: PlotMapbubbleDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
