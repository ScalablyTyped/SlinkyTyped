...
@js.native
trait PlotPolygonDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPolygonDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotPolygonDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotPolygonDragDropDragHandleOptionsOps[Self <: PlotPolygonDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
