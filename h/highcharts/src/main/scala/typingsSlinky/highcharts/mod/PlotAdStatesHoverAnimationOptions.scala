...
object PlotAdStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotAdStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotAdStatesHoverAnimationOptionsOps[Self <: PlotAdStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
