...
trait PlotHeatmapDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotHeatmapDragDropDragHandleOptions] = js.native
  /**
...
object PlotHeatmapDragDropOptions {
  @scala.inline
  def apply(): PlotHeatmapDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDragDropOptions]
  }
  @scala.inline
  implicit class PlotHeatmapDragDropOptionsOps[Self <: PlotHeatmapDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotHeatmapDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotHeatmapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
