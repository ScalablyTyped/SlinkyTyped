...
trait PlotSeriesMarkerOptions extends js.Object {
  ...
  /**
    ...
    * marker.
    */
  var states: js.UndefOr[PlotSeriesMarkerStatesOptions] = js.native
  /**
...
object PlotSeriesMarkerOptions {
  @scala.inline
  def apply(): PlotSeriesMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesMarkerOptions]
  }
  @scala.inline
  implicit class PlotSeriesMarkerOptionsOps[Self <: PlotSeriesMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotSeriesMarkerStatesOptions): Self = {
        val ret = this.duplicate
