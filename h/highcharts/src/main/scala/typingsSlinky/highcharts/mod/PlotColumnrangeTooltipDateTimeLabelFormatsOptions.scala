...
object PlotColumnrangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotColumnrangeTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotColumnrangeTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
