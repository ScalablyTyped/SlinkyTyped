...
object PlotVbpMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotVbpMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotVbpMarkerStatesInactiveOptionsOps[Self <: PlotVbpMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
