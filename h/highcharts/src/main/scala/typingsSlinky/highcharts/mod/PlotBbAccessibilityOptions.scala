...
trait PlotBbAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBbAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBbAccessibilityOptions {
  @scala.inline
  def apply(): PlotBbAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBbAccessibilityOptionsOps[Self <: PlotBbAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBbAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
