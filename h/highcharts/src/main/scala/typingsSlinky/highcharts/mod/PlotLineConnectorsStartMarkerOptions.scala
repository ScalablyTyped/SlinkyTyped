...
object PlotLineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotLineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotLineConnectorsStartMarkerOptionsOps[Self <: PlotLineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
