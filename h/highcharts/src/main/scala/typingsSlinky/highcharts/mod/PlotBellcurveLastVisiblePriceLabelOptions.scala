...
object PlotBellcurveLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotBellcurveLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotBellcurveLastVisiblePriceLabelOptionsOps[Self <: PlotBellcurveLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
