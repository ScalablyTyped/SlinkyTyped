...
object PlotLinearregressionangleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleConnectorsEndMarkerOptionsOps[Self <: PlotLinearregressionangleConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
