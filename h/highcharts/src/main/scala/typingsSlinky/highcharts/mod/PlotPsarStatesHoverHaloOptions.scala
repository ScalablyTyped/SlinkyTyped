...
object PlotPsarStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotPsarStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotPsarStatesHoverHaloOptionsOps[Self <: PlotPsarStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
