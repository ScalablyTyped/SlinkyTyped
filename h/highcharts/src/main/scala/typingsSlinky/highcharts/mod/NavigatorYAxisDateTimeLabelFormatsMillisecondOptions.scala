...
object NavigatorYAxisDateTimeLabelFormatsMillisecondOptions {
  @scala.inline
  def apply(): NavigatorYAxisDateTimeLabelFormatsMillisecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisDateTimeLabelFormatsMillisecondOptions]
  }
  @scala.inline
  implicit class NavigatorYAxisDateTimeLabelFormatsMillisecondOptionsOps[Self <: NavigatorYAxisDateTimeLabelFormatsMillisecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
