...
trait PlotVariwideConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVariwideConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVariwideConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVariwideConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotVariwideConnectorsOptions {
  @scala.inline
  def apply(): PlotVariwideConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideConnectorsOptions]
  }
  @scala.inline
  implicit class PlotVariwideConnectorsOptionsOps[Self <: PlotVariwideConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotVariwideConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotVariwideConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotVariwideConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
