...
@js.native
trait PlotGanttConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotGanttConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotGanttConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotGanttConnectorsStartMarkerOptionsOps[Self <: PlotGanttConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
