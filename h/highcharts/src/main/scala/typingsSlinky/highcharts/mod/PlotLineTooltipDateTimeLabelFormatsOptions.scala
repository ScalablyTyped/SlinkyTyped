...
@js.native
trait PlotLineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotLineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotLineTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotLineTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotLineTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
