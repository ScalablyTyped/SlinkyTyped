...
object PlotTrendlinePointEventsOptions {
  @scala.inline
  def apply(): PlotTrendlinePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlinePointEventsOptions]
  }
  @scala.inline
  implicit class PlotTrendlinePointEventsOptionsOps[Self <: PlotTrendlinePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
