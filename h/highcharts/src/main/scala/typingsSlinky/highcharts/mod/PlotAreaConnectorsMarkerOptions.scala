...
object PlotAreaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAreaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreaConnectorsMarkerOptionsOps[Self <: PlotAreaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
