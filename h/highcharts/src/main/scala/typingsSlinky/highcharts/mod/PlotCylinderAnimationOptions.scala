...
@js.native
trait PlotCylinderAnimationOptions extends js.Object {
...
object PlotCylinderAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotCylinderAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotCylinderAnimationOptionsOps[Self <: PlotCylinderAnimationOptions] (val x: Self) extends AnyVal {
