...
object PlotPyramidDataGroupingOptions {
  @scala.inline
  def apply(): PlotPyramidDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPyramidDataGroupingOptionsOps[Self <: PlotPyramidDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
