...
object PlotSeriesMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotSeriesMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSeriesMarkerStatesSelectOptionsOps[Self <: PlotSeriesMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
