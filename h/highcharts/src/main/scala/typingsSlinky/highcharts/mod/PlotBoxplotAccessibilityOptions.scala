...
trait PlotBoxplotAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBoxplotAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBoxplotAccessibilityOptions {
  @scala.inline
  def apply(): PlotBoxplotAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBoxplotAccessibilityOptionsOps[Self <: PlotBoxplotAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBoxplotAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
