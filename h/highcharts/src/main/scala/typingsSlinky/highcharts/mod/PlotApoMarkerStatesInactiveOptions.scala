...
object PlotApoMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotApoMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotApoMarkerStatesInactiveOptionsOps[Self <: PlotApoMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
