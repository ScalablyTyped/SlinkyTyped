...
@js.native
trait PlotAbandsConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAbandsConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAbandsConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAbandsConnectorsMarkerOptionsOps[Self <: PlotAbandsConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
