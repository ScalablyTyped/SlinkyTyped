...
@js.native
trait PlotFunnelConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotFunnelConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotFunnelConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnelConnectorsStartMarkerOptionsOps[Self <: PlotFunnelConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
