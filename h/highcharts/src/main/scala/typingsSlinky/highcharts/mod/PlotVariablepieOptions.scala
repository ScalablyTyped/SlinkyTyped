...
@js.native
trait PlotVariablepieOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVariablepieAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotVariablepieOptions {
  ...
  @scala.inline
  implicit class PlotVariablepieOptionsMutableBuilder[Self <: PlotVariablepieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVariablepieAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxPointSize(value: Double | String): Self = StObject.set(x, "maxPointSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxPointSizeUndefined: Self = StObject.set(x, "maxPointSize", js.undefined)
    
    @scala.inline
    def setMinPointSize(value: Double | String): Self = StObject.set(x, "minPointSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinPointSizeUndefined: Self = StObject.set(x, "minPointSize", js.undefined)
    ...
    @scala.inline
    def setSizeBy(value: VariablePieSizeByValue): Self = StObject.set(x, "sizeBy", value.asInstanceOf[js.Any])
