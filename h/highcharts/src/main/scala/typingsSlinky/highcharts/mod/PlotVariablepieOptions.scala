...
object PlotVariablepieOptions {
  ...
  implicit class PlotVariablepieOptionsOps[Self <: PlotVariablepieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVariablepieAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMaxPointSize(value: Double | String): Self = this.set("maxPointSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaxPointSize: Self = this.set("maxPointSize", js.undefined)
    
    @scala.inline
    def setMinPointSize(value: Double | String): Self = this.set("minPointSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinPointSize: Self = this.set("minPointSize", js.undefined)
    ...
    @scala.inline
    def setSizeBy(value: VariablePieSizeByValue): Self = this.set("sizeBy", value.asInstanceOf[js.Any])
