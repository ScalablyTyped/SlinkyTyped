...
object PlotBulletConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotBulletConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotBulletConnectorsMarkerOptionsOps[Self <: PlotBulletConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
