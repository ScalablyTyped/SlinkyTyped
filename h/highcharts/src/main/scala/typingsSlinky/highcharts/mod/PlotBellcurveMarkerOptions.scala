...
trait PlotBellcurveMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBellcurveMarkerStatesOptions] = js.native
  /**
...
object PlotBellcurveMarkerOptions {
  @scala.inline
  def apply(): PlotBellcurveMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveMarkerOptions]
  }
  @scala.inline
  implicit class PlotBellcurveMarkerOptionsOps[Self <: PlotBellcurveMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotBellcurveMarkerStatesOptions): Self = {
        val ret = this.duplicate
