...
trait PlotApoConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotApoConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotApoConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotApoConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotApoConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotApoConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotApoConnectorsMarkerOptions = null,
    startMarker: PlotApoConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotApoConnectorsOptions = {
