...
trait PlotFunnelStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotFunnelStatesHoverAnimationOptions] = js.native
  /**
...
object PlotFunnelStatesHoverOptions {
  @scala.inline
  def apply(): PlotFunnelStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotFunnelStatesHoverOptionsOps[Self <: PlotFunnelStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotFunnelStatesHoverAnimationOptions): Self = {
