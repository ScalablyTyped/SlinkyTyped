...
trait PlotZigzagMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotZigzagMarkerStatesOptions] = js.native
  /**
...
object PlotZigzagMarkerOptions {
  @scala.inline
  def apply(): PlotZigzagMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagMarkerOptions]
  }
  @scala.inline
  implicit class PlotZigzagMarkerOptionsOps[Self <: PlotZigzagMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotZigzagMarkerStatesOptions): Self = {
        val ret = this.duplicate
