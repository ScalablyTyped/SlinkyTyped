...
@js.native
trait PlotRsiPointEventsOptions extends js.Object {
  /**
...
object PlotRsiPointEventsOptions {
  @scala.inline
  def apply(): PlotRsiPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiPointEventsOptions]
  }
  @scala.inline
  implicit class PlotRsiPointEventsOptionsOps[Self <: PlotRsiPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
