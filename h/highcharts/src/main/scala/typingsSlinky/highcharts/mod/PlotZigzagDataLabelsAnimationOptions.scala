...
@js.native
trait PlotZigzagDataLabelsAnimationOptions extends js.Object {
...
object PlotZigzagDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotZigzagDataLabelsAnimationOptionsOps[Self <: PlotZigzagDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
