...
@js.native
trait SeriesSplineDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesSplineDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesSplineDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSplineDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesSplineDataMarkerStatesSelectOptionsOps[Self <: SeriesSplineDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
