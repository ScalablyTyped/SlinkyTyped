...
object PlotLinearregressionStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionStatesSelectHaloOptionsOps[Self <: PlotLinearregressionStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
