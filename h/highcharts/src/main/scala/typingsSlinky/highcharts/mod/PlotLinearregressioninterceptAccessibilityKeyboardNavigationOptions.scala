...
object PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptionsOps[Self <: PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
