...
object PlotPpoMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPpoMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPpoMarkerStatesSelectOptionsOps[Self <: PlotPpoMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
