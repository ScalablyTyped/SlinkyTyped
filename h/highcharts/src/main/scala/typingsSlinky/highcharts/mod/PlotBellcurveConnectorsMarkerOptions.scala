...
object PlotBellcurveConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotBellcurveConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotBellcurveConnectorsMarkerOptionsOps[Self <: PlotBellcurveConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
