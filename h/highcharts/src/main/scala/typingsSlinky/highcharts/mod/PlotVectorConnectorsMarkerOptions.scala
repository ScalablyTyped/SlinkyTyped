...
object PlotVectorConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVectorConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVectorConnectorsMarkerOptionsOps[Self <: PlotVectorConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
