...
trait PlotDemaConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDemaConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDemaConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDemaConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotDemaConnectorsOptions {
  @scala.inline
  def apply(): PlotDemaConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaConnectorsOptions]
  }
  @scala.inline
  implicit class PlotDemaConnectorsOptionsOps[Self <: PlotDemaConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotDemaConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotDemaConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotDemaConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
