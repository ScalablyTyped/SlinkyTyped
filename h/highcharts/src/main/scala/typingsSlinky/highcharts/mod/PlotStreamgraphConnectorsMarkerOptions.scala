...
object PlotStreamgraphConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotStreamgraphConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphConnectorsMarkerOptionsOps[Self <: PlotStreamgraphConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
