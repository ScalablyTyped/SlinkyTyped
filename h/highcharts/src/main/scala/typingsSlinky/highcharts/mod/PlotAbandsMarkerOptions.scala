...
trait PlotAbandsMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAbandsMarkerStatesOptions] = js.native
  /**
...
object PlotAbandsMarkerOptions {
  @scala.inline
  def apply(): PlotAbandsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAbandsMarkerOptionsOps[Self <: PlotAbandsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAbandsMarkerStatesOptions): Self = {
        val ret = this.duplicate
