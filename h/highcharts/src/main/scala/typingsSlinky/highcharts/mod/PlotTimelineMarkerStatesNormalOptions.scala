...
object PlotTimelineMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotTimelineMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotTimelineMarkerStatesNormalOptionsOps[Self <: PlotTimelineMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
