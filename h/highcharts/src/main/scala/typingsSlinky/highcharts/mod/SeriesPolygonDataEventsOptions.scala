...
object SeriesPolygonDataEventsOptions {
  @scala.inline
  def apply(): SeriesPolygonDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataEventsOptionsOps[Self <: SeriesPolygonDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
