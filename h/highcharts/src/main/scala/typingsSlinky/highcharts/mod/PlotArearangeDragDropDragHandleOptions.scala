...
object PlotArearangeDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotArearangeDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotArearangeDragDropDragHandleOptionsOps[Self <: PlotArearangeDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
