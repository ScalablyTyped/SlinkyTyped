...
trait PlotRsiAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotRsiAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotRsiAccessibilityOptions {
  @scala.inline
  def apply(): PlotRsiAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotRsiAccessibilityOptionsOps[Self <: PlotRsiAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotRsiAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
