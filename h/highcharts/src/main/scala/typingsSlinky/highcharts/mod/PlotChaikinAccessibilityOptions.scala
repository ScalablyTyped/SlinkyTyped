...
trait PlotChaikinAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotChaikinAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotChaikinAccessibilityOptions {
  @scala.inline
  def apply(): PlotChaikinAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotChaikinAccessibilityOptionsOps[Self <: PlotChaikinAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotChaikinAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
