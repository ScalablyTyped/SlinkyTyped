...
object SeriesScatterDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesScatterDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataAccessibilityOptionsOps[Self <: SeriesScatterDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
