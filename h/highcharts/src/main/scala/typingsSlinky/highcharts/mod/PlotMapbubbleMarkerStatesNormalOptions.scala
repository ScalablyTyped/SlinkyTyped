...
object PlotMapbubbleMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotMapbubbleMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleMarkerStatesNormalOptionsOps[Self <: PlotMapbubbleMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
