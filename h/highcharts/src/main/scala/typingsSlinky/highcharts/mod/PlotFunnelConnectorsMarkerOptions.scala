...
object PlotFunnelConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotFunnelConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnelConnectorsMarkerOptionsOps[Self <: PlotFunnelConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
