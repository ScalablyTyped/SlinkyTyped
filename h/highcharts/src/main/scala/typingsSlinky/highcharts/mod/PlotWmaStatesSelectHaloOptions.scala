...
object PlotWmaStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotWmaStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotWmaStatesSelectHaloOptionsOps[Self <: PlotWmaStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
