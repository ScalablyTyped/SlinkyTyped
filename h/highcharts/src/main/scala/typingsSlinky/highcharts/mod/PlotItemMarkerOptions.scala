...
trait PlotItemMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotItemMarkerStatesOptions] = js.native
  /**
...
object PlotItemMarkerOptions {
  @scala.inline
  def apply(): PlotItemMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemMarkerOptions]
  }
  @scala.inline
  implicit class PlotItemMarkerOptionsOps[Self <: PlotItemMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotItemMarkerStatesOptions): Self = {
        val ret = this.duplicate
