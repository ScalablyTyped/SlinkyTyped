...
object PlotLinearregressioninterceptPointEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptPointEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptPointEventsOptionsOps[Self <: PlotLinearregressioninterceptPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
