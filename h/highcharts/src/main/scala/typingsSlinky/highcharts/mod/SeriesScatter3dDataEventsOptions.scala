...
object SeriesScatter3dDataEventsOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataEventsOptionsOps[Self <: SeriesScatter3dDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
