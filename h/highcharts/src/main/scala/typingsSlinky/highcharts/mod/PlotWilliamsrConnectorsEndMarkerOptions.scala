...
object PlotWilliamsrConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotWilliamsrConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrConnectorsEndMarkerOptionsOps[Self <: PlotWilliamsrConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
