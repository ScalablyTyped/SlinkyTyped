...
trait PlotBellcurveStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotBellcurveStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBellcurveStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotBellcurveStatesSelectOptions {
  @scala.inline
  def apply(): PlotBellcurveStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBellcurveStatesSelectOptionsOps[Self <: PlotBellcurveStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotBellcurveStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBellcurveStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
