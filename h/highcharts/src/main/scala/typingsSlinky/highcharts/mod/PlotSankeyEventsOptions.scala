...
@js.native
trait PlotSankeyEventsOptions extends js.Object {
  /**
...
object PlotSankeyEventsOptions {
  @scala.inline
  def apply(): PlotSankeyEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyEventsOptions]
  }
  @scala.inline
  implicit class PlotSankeyEventsOptionsOps[Self <: PlotSankeyEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
