...
@js.native
trait PlotMacdDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotMacdDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotMacdDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotMacdDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotMacdDataLabelsOptionsOps[Self <: PlotMacdDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMacdDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
