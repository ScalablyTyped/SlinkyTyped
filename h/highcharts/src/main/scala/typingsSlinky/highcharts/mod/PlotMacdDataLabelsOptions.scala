...
object PlotMacdDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMacdDataLabelsOptionsMutableBuilder[Self <: PlotMacdDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMacdDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
