...
trait PlotTilemapTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTilemapTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotTilemapTooltipOptions {
  @scala.inline
  def apply(): PlotTilemapTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapTooltipOptions]
  }
  @scala.inline
  implicit class PlotTilemapTooltipOptionsOps[Self <: PlotTilemapTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotTilemapTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
