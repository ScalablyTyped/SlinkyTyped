...
trait PlotSunburstConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSunburstConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSunburstConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSunburstConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSunburstConnectorsOptions {
  @scala.inline
  def apply(): PlotSunburstConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSunburstConnectorsOptionsOps[Self <: PlotSunburstConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSunburstConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSunburstConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSunburstConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
