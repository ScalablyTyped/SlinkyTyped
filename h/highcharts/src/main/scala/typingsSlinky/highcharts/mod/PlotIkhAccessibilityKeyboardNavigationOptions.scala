...
object PlotIkhAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotIkhAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotIkhAccessibilityKeyboardNavigationOptionsOps[Self <: PlotIkhAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
