...
object PlotAoMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAoMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAoMarkerStatesSelectOptionsOps[Self <: PlotAoMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
