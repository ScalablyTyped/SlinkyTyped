...
@js.native
trait PlotMapbubblePointEventsOptions extends js.Object {
  /**
...
object PlotMapbubblePointEventsOptions {
  @scala.inline
  def apply(): PlotMapbubblePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubblePointEventsOptions]
  }
  @scala.inline
  implicit class PlotMapbubblePointEventsOptionsOps[Self <: PlotMapbubblePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
