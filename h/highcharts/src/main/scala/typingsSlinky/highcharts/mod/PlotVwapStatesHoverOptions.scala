...
@js.native
trait PlotVwapStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVwapStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVwapStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotVwapStatesHoverOptions {
  @scala.inline
  def apply(): PlotVwapStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotVwapStatesHoverOptionsOps[Self <: PlotVwapStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotVwapStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotVwapStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
