...
@js.native
trait PlotAroonoscillatorEventsOptions extends js.Object {
  /**
...
object PlotAroonoscillatorEventsOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorEventsOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorEventsOptionsOps[Self <: PlotAroonoscillatorEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
