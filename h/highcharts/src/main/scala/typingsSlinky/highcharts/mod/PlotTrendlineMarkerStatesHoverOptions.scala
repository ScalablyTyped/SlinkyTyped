...
object PlotTrendlineMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotTrendlineMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTrendlineMarkerStatesHoverOptionsOps[Self <: PlotTrendlineMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
