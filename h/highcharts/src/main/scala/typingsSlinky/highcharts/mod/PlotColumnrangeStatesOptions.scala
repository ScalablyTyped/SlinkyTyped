...
trait PlotColumnrangeStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotColumnrangeStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotColumnrangeStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotColumnrangeStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotColumnrangeStatesSelectOptions] = js.native
}

object PlotColumnrangeStatesOptions {
  @scala.inline
  def apply(): PlotColumnrangeStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeStatesOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeStatesOptionsOps[Self <: PlotColumnrangeStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotColumnrangeStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotColumnrangeStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotColumnrangeStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotColumnrangeStatesSelectOptions): Self = {
        val ret = this.duplicate
