...
@js.native
trait PlotAtrStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotAtrStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAtrStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAtrStatesSelectHaloOptionsOps[Self <: PlotAtrStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
