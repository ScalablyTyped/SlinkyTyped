...
object PlotArearangeStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotArearangeStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotArearangeStatesHoverHaloOptionsOps[Self <: PlotArearangeStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
