...
object PlotFlagsDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotFlagsDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotFlagsDragDropGuideBoxDefaultOptionsOps[Self <: PlotFlagsDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
