...
trait PlotCmfMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotCmfMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotCmfMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotCmfMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotCmfMarkerStatesSelectOptions] = js.native
}

object PlotCmfMarkerStatesOptions {
  @scala.inline
  def apply(): PlotCmfMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotCmfMarkerStatesOptionsOps[Self <: PlotCmfMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotCmfMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotCmfMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotCmfMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotCmfMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
