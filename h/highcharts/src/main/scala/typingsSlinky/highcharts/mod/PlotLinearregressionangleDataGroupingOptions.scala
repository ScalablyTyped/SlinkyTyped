...
@js.native
trait PlotLinearregressionangleDataGroupingOptions extends js.Object {
  /**
...
object PlotLinearregressionangleDataGroupingOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleDataGroupingOptionsOps[Self <: PlotLinearregressionangleDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
