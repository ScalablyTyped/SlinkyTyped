...
object PlotSmaStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotSmaStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotSmaStatesSelectAnimationOptionsOps[Self <: PlotSmaStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
