...
object PlotColumnDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotColumnDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotColumnDragDropDragHandleOptionsOps[Self <: PlotColumnDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
