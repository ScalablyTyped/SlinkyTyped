...
object PlotColumnpyramidConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotColumnpyramidConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidConnectorsEndMarkerOptionsOps[Self <: PlotColumnpyramidConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
