...
trait PlotBubbleStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBubbleStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBubbleStatesHoverHaloOptions] = js.native
  /**
...
object PlotBubbleStatesHoverOptions {
  @scala.inline
  def apply(): PlotBubbleStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBubbleStatesHoverOptionsOps[Self <: PlotBubbleStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotBubbleStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBubbleStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
