...
trait PlotLinearregressionangleStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressionangleStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionangleStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressionangleStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleStatesSelectOptionsOps[Self <: PlotLinearregressionangleStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotLinearregressionangleStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressionangleStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
