...
@js.native
trait PlotErrorbarDataSortingOptions extends StObject {
...
object PlotErrorbarDataSortingOptions {
  
  @scala.inline
  def apply(): PlotErrorbarDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotErrorbarDataSortingOptionsMutableBuilder[Self <: PlotErrorbarDataSortingOptions] (val x: Self) extends AnyVal {
