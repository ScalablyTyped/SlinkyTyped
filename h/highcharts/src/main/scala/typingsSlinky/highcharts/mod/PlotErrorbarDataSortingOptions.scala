...
@js.native
trait PlotErrorbarDataSortingOptions extends js.Object {
...
object PlotErrorbarDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotErrorbarDataSortingOptionsOps[Self <: PlotErrorbarDataSortingOptions] (val x: Self) extends AnyVal {
