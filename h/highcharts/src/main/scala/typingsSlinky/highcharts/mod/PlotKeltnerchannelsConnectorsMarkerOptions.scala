...
object PlotKeltnerchannelsConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsConnectorsMarkerOptionsOps[Self <: PlotKeltnerchannelsConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
