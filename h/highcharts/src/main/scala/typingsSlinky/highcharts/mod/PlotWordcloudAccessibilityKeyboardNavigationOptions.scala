...
object PlotWordcloudAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotWordcloudAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotWordcloudAccessibilityKeyboardNavigationOptionsOps[Self <: PlotWordcloudAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
