...
@js.native
trait PlotMfiDataSortingOptions extends js.Object {
...
object PlotMfiDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotMfiDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotMfiDataSortingOptionsOps[Self <: PlotMfiDataSortingOptions] (val x: Self) extends AnyVal {
