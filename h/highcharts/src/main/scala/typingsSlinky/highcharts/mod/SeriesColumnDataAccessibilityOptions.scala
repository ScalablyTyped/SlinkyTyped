...
object SeriesColumnDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesColumnDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesColumnDataAccessibilityOptionsOps[Self <: SeriesColumnDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
