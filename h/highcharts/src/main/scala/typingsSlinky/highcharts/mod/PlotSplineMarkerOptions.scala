...
trait PlotSplineMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSplineMarkerStatesOptions] = js.native
  /**
...
object PlotSplineMarkerOptions {
  @scala.inline
  def apply(): PlotSplineMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineMarkerOptions]
  }
  @scala.inline
  implicit class PlotSplineMarkerOptionsOps[Self <: PlotSplineMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotSplineMarkerStatesOptions): Self = {
        val ret = this.duplicate
