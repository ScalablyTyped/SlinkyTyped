...
object PlotMapbubbleMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotMapbubbleMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleMarkerStatesInactiveOptionsOps[Self <: PlotMapbubbleMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
