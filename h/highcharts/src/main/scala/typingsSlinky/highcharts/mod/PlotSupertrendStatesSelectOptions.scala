...
@js.native
trait PlotSupertrendStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotSupertrendStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSupertrendStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotSupertrendStatesSelectOptions {
  @scala.inline
  def apply(): PlotSupertrendStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSupertrendStatesSelectOptionsOps[Self <: PlotSupertrendStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotSupertrendStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSupertrendStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
