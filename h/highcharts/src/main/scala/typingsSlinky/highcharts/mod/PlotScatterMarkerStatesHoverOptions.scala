...
@js.native
trait PlotScatterMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotScatterMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotScatterMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotScatterMarkerStatesHoverOptionsOps[Self <: PlotScatterMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
