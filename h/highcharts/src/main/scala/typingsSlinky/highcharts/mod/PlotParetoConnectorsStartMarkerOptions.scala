...
object PlotParetoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotParetoConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotParetoConnectorsStartMarkerOptionsOps[Self <: PlotParetoConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
