...
object PlotMapbubbleAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotMapbubbleAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleAccessibilityKeyboardNavigationOptionsOps[Self <: PlotMapbubbleAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
