...
@js.native
trait PlotColumnDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotColumnDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotColumnDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotColumnDragDropOptions {
  @scala.inline
  def apply(): PlotColumnDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnDragDropOptions]
  }
  @scala.inline
  implicit class PlotColumnDragDropOptionsOps[Self <: PlotColumnDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotColumnDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotColumnDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
