...
object NavigatorYAxisDateTimeLabelFormatsSecondOptions {
  @scala.inline
  def apply(): NavigatorYAxisDateTimeLabelFormatsSecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisDateTimeLabelFormatsSecondOptions]
  }
  @scala.inline
  implicit class NavigatorYAxisDateTimeLabelFormatsSecondOptionsOps[Self <: NavigatorYAxisDateTimeLabelFormatsSecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
