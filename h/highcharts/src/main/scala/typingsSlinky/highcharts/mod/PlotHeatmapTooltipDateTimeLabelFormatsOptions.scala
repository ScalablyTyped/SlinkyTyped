...
object PlotHeatmapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotHeatmapTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotHeatmapTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotHeatmapTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
