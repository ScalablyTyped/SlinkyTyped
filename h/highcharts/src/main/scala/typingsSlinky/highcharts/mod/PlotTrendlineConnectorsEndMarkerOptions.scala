...
object PlotTrendlineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTrendlineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrendlineConnectorsEndMarkerOptionsOps[Self <: PlotTrendlineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
