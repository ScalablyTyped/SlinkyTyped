...
object PlotColumnConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotColumnConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnConnectorsStartMarkerOptionsOps[Self <: PlotColumnConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
