...
trait PlotSunburstStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSunburstStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSunburstStatesHoverHaloOptions | Null] = js.native
}

object PlotSunburstStatesHoverOptions {
  @scala.inline
  def apply(): PlotSunburstStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSunburstStatesHoverOptionsOps[Self <: PlotSunburstStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSunburstStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSunburstStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
