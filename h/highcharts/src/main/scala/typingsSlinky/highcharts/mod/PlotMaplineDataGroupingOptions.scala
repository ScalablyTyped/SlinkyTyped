...
@js.native
trait PlotMaplineDataGroupingOptions extends js.Object {
  /**
...
object PlotMaplineDataGroupingOptions {
  @scala.inline
  def apply(): PlotMaplineDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotMaplineDataGroupingOptionsOps[Self <: PlotMaplineDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
