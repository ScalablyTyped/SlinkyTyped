...
object PlotMappointDataGroupingOptions {
  @scala.inline
  def apply(): PlotMappointDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotMappointDataGroupingOptionsOps[Self <: PlotMappointDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
