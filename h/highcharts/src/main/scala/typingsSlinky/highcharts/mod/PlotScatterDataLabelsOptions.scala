...
@js.native
trait PlotScatterDataLabelsOptions extends js.Object {
...
object PlotScatterDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotScatterDataLabelsOptionsOps[Self <: PlotScatterDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotScatterDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
