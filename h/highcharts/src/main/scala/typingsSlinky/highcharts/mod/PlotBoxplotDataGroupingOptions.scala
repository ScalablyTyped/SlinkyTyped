...
@js.native
trait PlotBoxplotDataGroupingOptions extends js.Object {
  /**
...
object PlotBoxplotDataGroupingOptions {
  @scala.inline
  def apply(): PlotBoxplotDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotBoxplotDataGroupingOptionsOps[Self <: PlotBoxplotDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
