...
object PlotLinearregressionZonesOptions {
  @scala.inline
  def apply(): PlotLinearregressionZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionZonesOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionZonesOptionsOps[Self <: PlotLinearregressionZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
