...
@js.native
trait PlotPcDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPcDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotPcDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotPcDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPcDataLabelsOptionsMutableBuilder[Self <: PlotPcDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
