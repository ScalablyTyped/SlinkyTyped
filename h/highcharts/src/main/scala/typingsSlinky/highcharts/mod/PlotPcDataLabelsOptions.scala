...
@js.native
trait PlotPcDataLabelsOptions extends js.Object {
...
object PlotPcDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotPcDataLabelsOptionsOps[Self <: PlotPcDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
