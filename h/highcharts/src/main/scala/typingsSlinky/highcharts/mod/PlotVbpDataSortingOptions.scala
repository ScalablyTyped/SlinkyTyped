...
@js.native
trait PlotVbpDataSortingOptions extends StObject {
...
object PlotVbpDataSortingOptions {
  
  @scala.inline
  def apply(): PlotVbpDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotVbpDataSortingOptionsMutableBuilder[Self <: PlotVbpDataSortingOptions] (val x: Self) extends AnyVal {
