...
trait SeriesLinearregressionslopeOptions extends PlotLinearregressionslopeOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregressionslope = js.native
...
object SeriesLinearregressionslopeOptions {
  
  @scala.inline
  def apply(`type`: String | linearregressionslope): SeriesLinearregressionslopeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesLinearregressionslopeOptions]
  }
  
  @scala.inline
  implicit class SeriesLinearregressionslopeOptionsMutableBuilder[Self <: SeriesLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | linearregressionslope): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
