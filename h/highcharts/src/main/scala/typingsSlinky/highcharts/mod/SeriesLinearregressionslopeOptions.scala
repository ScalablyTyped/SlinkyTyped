...
object SeriesLinearregressionslopeOptions {
  ...
  @scala.inline
  implicit class SeriesLinearregressionslopeOptionsOps[Self <: SeriesLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | linearregressionslope): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
