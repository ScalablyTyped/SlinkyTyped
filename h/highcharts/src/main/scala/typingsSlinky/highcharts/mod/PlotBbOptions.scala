...
object PlotBbOptions {
  ...
  implicit class PlotBbOptionsOps[Self <: PlotBbOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBbAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotBbBottomLineOptions): Self = this.set("bottomLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotBbDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotBbDataLabelsOptions | js.Array[PlotBbDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBbDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotBbParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotBbTopLineOptions): Self = this.set("topLine", value.asInstanceOf[js.Any])
