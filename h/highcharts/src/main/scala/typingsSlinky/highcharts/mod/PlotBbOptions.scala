...
@js.native
trait PlotBbOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBbAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBbDataLabelsOptions | js.Array[PlotBbDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotBbDataSortingOptions] = js.native
...
object PlotBbOptions {
  ...
  @scala.inline
  implicit class PlotBbOptionsMutableBuilder[Self <: PlotBbOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBbAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotBbBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotBbDataLabelsOptions | js.Array[PlotBbDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotBbDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBbDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotBbParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotBbTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
