...
trait PlotWmaMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWmaMarkerStatesOptions] = js.native
  /**
...
object PlotWmaMarkerOptions {
  @scala.inline
  def apply(): PlotWmaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaMarkerOptions]
  }
  @scala.inline
  implicit class PlotWmaMarkerOptionsOps[Self <: PlotWmaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotWmaMarkerStatesOptions): Self = {
        val ret = this.duplicate
