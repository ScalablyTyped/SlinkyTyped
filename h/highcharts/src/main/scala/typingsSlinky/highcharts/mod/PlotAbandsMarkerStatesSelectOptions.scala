...
object PlotAbandsMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAbandsMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAbandsMarkerStatesSelectOptionsOps[Self <: PlotAbandsMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
