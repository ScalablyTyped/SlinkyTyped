...
trait PlotFunnelTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotFunnelTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotFunnelTooltipOptions {
  @scala.inline
  def apply(): PlotFunnelTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelTooltipOptions]
  }
  @scala.inline
  implicit class PlotFunnelTooltipOptionsOps[Self <: PlotFunnelTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotFunnelTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
