...
object PlotVennStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotVennStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotVennStatesSelectAnimationOptionsOps[Self <: PlotVennStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
