...
object PlotBulletDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotBulletDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotBulletDragDropDragHandleOptionsOps[Self <: PlotBulletDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
