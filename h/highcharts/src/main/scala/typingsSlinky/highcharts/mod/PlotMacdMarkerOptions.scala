...
@js.native
trait PlotMacdMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMacdMarkerStatesOptions] = js.native
  /**
...
object PlotMacdMarkerOptions {
  @scala.inline
  def apply(): PlotMacdMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdMarkerOptions]
  }
  @scala.inline
  implicit class PlotMacdMarkerOptionsOps[Self <: PlotMacdMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotMacdMarkerStatesOptions): Self = {
        val ret = this.duplicate
