...
object PlotSplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotSplineMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSplineMarkerStatesHoverOptionsOps[Self <: PlotSplineMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
