...
@js.native
trait XAxisCurrentDateIndicatorLabelOptions extends StObject {
...
object XAxisCurrentDateIndicatorLabelOptions {
  ...
  @scala.inline
  implicit class XAxisCurrentDateIndicatorLabelOptionsMutableBuilder[Self <: XAxisCurrentDateIndicatorLabelOptions] (val x: Self) extends AnyVal {
