...
@js.native
trait NavigatorXAxisLabelsOptions extends StObject {
...
object NavigatorXAxisLabelsOptions {
  ...
  @scala.inline
  def apply(): NavigatorXAxisLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisLabelsOptions]
  }
  
  @scala.inline
  implicit class NavigatorXAxisLabelsOptionsMutableBuilder[Self <: NavigatorXAxisLabelsOptions] (val x: Self) extends AnyVal {
