...
object SeriesLineDataMarkerStatesNormalOptions {
  @scala.inline
  def apply(): SeriesLineDataMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class SeriesLineDataMarkerStatesNormalOptionsOps[Self <: SeriesLineDataMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
