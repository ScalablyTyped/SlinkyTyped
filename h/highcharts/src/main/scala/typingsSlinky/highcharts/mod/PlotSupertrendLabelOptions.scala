...
@js.native
trait PlotSupertrendLabelOptions extends js.Object {
  /**
...
object PlotSupertrendLabelOptions {
  @scala.inline
  def apply(): PlotSupertrendLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendLabelOptions]
  }
  @scala.inline
  implicit class PlotSupertrendLabelOptionsOps[Self <: PlotSupertrendLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
