...
object PlotFunnel3dStatesNormalOptions {
  @scala.inline
  def apply(): PlotFunnel3dStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dStatesNormalOptionsOps[Self <: PlotFunnel3dStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
