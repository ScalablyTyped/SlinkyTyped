...
trait PlotHeatmapTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotHeatmapTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotHeatmapTooltipOptions {
  @scala.inline
  def apply(): PlotHeatmapTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapTooltipOptions]
  }
  @scala.inline
  implicit class PlotHeatmapTooltipOptionsOps[Self <: PlotHeatmapTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotHeatmapTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
