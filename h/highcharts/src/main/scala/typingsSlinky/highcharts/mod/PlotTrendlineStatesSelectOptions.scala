...
trait PlotTrendlineStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotTrendlineStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrendlineStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotTrendlineStatesSelectOptions {
  @scala.inline
  def apply(): PlotTrendlineStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTrendlineStatesSelectOptionsOps[Self <: PlotTrendlineStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotTrendlineStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTrendlineStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
