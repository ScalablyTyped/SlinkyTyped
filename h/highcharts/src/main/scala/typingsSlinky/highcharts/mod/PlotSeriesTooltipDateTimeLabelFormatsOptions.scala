...
object PlotSeriesTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotSeriesTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotSeriesTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotSeriesTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
