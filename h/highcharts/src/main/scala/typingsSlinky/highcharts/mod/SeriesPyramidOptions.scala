...
trait SeriesPyramidOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesPyramidDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesPyramidOptions {
  ...
  implicit class SeriesPyramidOptionsOps[Self <: SeriesPyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | pyramid): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | Null | SeriesPyramidDataOptions]): Self = {
        val ret = this.duplicate
