...
object PlotPackedbubbleLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPackedbubbleLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleLastVisiblePriceLabelOptionsOps[Self <: PlotPackedbubbleLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
