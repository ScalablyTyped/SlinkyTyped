...
@js.native
trait PlotWindbarbConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotWindbarbConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotWindbarbConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotWindbarbConnectorsMarkerOptionsOps[Self <: PlotWindbarbConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
