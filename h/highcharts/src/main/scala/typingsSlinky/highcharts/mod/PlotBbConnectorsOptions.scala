...
trait PlotBbConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBbConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBbConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBbConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBbConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotBbConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotBbConnectorsMarkerOptions = null,
    startMarker: PlotBbConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotBbConnectorsOptions = {
