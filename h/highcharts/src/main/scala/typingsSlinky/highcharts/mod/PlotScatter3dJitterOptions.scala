...
@js.native
trait PlotScatter3dJitterOptions extends js.Object {
  /**
...
object PlotScatter3dJitterOptions {
  @scala.inline
  def apply(): PlotScatter3dJitterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dJitterOptions]
  }
  @scala.inline
  implicit class PlotScatter3dJitterOptionsOps[Self <: PlotScatter3dJitterOptions] (val x: Self) extends AnyVal {
    @scala.inline
