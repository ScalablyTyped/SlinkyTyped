...
object PlotColumnpyramidDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotColumnpyramidDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidDragDropGuideBoxDefaultOptionsOps[Self <: PlotColumnpyramidDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
