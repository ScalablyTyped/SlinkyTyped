...
object PlotPackedbubbleMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotPackedbubbleMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleMarkerStatesInactiveOptionsOps[Self <: PlotPackedbubbleMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
