...
@js.native
trait PlotFunnel3dZonesOptions extends js.Object {
  /**
...
object PlotFunnel3dZonesOptions {
  @scala.inline
  def apply(): PlotFunnel3dZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dZonesOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dZonesOptionsOps[Self <: PlotFunnel3dZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
