...
object PlotVariwideTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotVariwideTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotVariwideTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotVariwideTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
