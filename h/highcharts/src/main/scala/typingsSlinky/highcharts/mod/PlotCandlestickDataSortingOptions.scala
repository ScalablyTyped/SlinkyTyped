...
@js.native
trait PlotCandlestickDataSortingOptions extends StObject {
...
object PlotCandlestickDataSortingOptions {
  
  @scala.inline
  def apply(): PlotCandlestickDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotCandlestickDataSortingOptionsMutableBuilder[Self <: PlotCandlestickDataSortingOptions] (val x: Self) extends AnyVal {
