...
@js.native
trait PlotCandlestickDataSortingOptions extends js.Object {
  /**
...
object PlotCandlestickDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotCandlestickDataSortingOptionsOps[Self <: PlotCandlestickDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
