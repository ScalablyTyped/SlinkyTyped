...
object PlotAreasplinerangeStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeStatesSelectHaloOptionsOps[Self <: PlotAreasplinerangeStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
