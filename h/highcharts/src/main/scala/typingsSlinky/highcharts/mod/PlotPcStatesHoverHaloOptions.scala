...
@js.native
trait PlotPcStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotPcStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotPcStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotPcStatesHoverHaloOptionsOps[Self <: PlotPcStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
