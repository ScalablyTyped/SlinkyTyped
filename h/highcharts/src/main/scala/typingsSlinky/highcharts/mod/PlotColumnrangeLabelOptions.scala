...
@js.native
trait PlotColumnrangeLabelOptions extends js.Object {
  /**
...
object PlotColumnrangeLabelOptions {
  @scala.inline
  def apply(): PlotColumnrangeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeLabelOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeLabelOptionsOps[Self <: PlotColumnrangeLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
