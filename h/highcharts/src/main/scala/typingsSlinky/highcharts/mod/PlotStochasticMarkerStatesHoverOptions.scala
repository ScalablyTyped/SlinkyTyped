...
@js.native
trait PlotStochasticMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotStochasticMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotStochasticMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotStochasticMarkerStatesHoverOptionsOps[Self <: PlotStochasticMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
