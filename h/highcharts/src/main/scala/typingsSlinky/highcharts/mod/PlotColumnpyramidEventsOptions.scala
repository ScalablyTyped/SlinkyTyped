...
@js.native
trait PlotColumnpyramidEventsOptions extends js.Object {
  /**
...
object PlotColumnpyramidEventsOptions {
  @scala.inline
  def apply(): PlotColumnpyramidEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidEventsOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidEventsOptionsOps[Self <: PlotColumnpyramidEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
