...
object PlotMacdMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotMacdMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotMacdMarkerStatesInactiveOptionsOps[Self <: PlotMacdMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
