...
@js.native
trait PlotPivotpointsEventsOptions extends js.Object {
  /**
...
object PlotPivotpointsEventsOptions {
  @scala.inline
  def apply(): PlotPivotpointsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsEventsOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsEventsOptionsOps[Self <: PlotPivotpointsEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
