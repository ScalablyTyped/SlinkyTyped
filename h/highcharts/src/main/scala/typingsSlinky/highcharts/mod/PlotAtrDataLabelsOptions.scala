...
@js.native
trait PlotAtrDataLabelsOptions extends js.Object {
...
object PlotAtrDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAtrDataLabelsOptionsOps[Self <: PlotAtrDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAtrDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
