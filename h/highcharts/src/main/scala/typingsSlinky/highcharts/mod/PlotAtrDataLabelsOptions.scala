...
@js.native
trait PlotAtrDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAtrDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotAtrDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotAtrDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotAtrDataLabelsOptionsMutableBuilder[Self <: PlotAtrDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAtrDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
