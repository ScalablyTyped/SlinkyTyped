...
object PlotWilliamsrConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotWilliamsrConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrConnectorsMarkerOptionsOps[Self <: PlotWilliamsrConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
