...
trait PlotSeriesStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSeriesStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSeriesStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotSeriesStatesHoverOptions {
  @scala.inline
  def apply(): PlotSeriesStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSeriesStatesHoverOptionsOps[Self <: PlotSeriesStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSeriesStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSeriesStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
