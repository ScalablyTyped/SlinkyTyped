...
object PlotFunnelConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotFunnelConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnelConnectorsEndMarkerOptionsOps[Self <: PlotFunnelConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
