...
@js.native
trait PlotGanttDataGroupingOptions extends js.Object {
  /**
...
object PlotGanttDataGroupingOptions {
  @scala.inline
  def apply(): PlotGanttDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotGanttDataGroupingOptionsOps[Self <: PlotGanttDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
