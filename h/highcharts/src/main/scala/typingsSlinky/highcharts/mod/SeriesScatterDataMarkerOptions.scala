...
trait SeriesScatterDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesScatterDataMarkerStatesOptions] = js.native
  /**
...
object SeriesScatterDataMarkerOptions {
  @scala.inline
  def apply(): SeriesScatterDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataMarkerOptionsOps[Self <: SeriesScatterDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesScatterDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
