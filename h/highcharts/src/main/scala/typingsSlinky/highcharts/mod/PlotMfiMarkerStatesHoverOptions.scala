...
object PlotMfiMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotMfiMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMfiMarkerStatesHoverOptionsOps[Self <: PlotMfiMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
