...
object PlotSeriesConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSeriesConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSeriesConnectorsEndMarkerOptionsOps[Self <: PlotSeriesConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
