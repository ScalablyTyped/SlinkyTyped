...
@js.native
trait PlotAroonAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAroonAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotAroonAccessibilityOptions {
  @scala.inline
  def apply(): PlotAroonAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotAroonAccessibilityOptionsOps[Self <: PlotAroonAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotAroonAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
