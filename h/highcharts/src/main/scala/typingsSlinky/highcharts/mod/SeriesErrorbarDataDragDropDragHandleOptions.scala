...
@js.native
trait SeriesErrorbarDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesErrorbarDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesErrorbarDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesErrorbarDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesErrorbarDataDragDropDragHandleOptionsOps[Self <: SeriesErrorbarDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
