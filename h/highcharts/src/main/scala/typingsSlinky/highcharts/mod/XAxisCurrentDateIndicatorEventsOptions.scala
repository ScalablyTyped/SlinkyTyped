...
object XAxisCurrentDateIndicatorEventsOptions {
  @scala.inline
  def apply(): XAxisCurrentDateIndicatorEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisCurrentDateIndicatorEventsOptions]
  }
  @scala.inline
