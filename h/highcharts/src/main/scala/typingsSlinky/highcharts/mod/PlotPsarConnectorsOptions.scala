...
trait PlotPsarConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPsarConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPsarConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPsarConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotPsarConnectorsOptions {
  @scala.inline
  def apply(): PlotPsarConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarConnectorsOptions]
  }
  @scala.inline
  implicit class PlotPsarConnectorsOptionsOps[Self <: PlotPsarConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotPsarConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotPsarConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotPsarConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
