...
@js.native
trait PlotArearangeMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotArearangeMarkerStatesOptions] = js.native
  /**
...
object PlotArearangeMarkerOptions {
  @scala.inline
  def apply(): PlotArearangeMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeMarkerOptions]
  }
  @scala.inline
  implicit class PlotArearangeMarkerOptionsOps[Self <: PlotArearangeMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotArearangeMarkerStatesOptions): Self = {
        val ret = this.duplicate
