...
trait PlotVwapStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotVwapStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVwapStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotVwapStatesSelectOptions {
  @scala.inline
  def apply(): PlotVwapStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotVwapStatesSelectOptionsOps[Self <: PlotVwapStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotVwapStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotVwapStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
