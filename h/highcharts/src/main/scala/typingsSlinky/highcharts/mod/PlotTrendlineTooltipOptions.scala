...
@js.native
trait PlotTrendlineTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTrendlineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotTrendlineTooltipOptions {
  @scala.inline
  def apply(): PlotTrendlineTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineTooltipOptions]
  }
  @scala.inline
  implicit class PlotTrendlineTooltipOptionsOps[Self <: PlotTrendlineTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotTrendlineTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
