...
@js.native
trait PlotColumnConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotColumnConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotColumnConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnConnectorsEndMarkerOptionsOps[Self <: PlotColumnConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
