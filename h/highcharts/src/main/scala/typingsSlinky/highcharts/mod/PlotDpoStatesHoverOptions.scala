...
@js.native
trait PlotDpoStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotDpoStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotDpoStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotDpoStatesHoverOptions {
  @scala.inline
  def apply(): PlotDpoStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotDpoStatesHoverOptionsOps[Self <: PlotDpoStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotDpoStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotDpoStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
