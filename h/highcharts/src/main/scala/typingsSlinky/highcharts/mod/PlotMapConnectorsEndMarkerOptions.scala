...
@js.native
trait PlotMapConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMapConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapConnectorsEndMarkerOptionsOps[Self <: PlotMapConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
