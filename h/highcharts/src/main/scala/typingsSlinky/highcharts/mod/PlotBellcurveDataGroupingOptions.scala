...
object PlotBellcurveDataGroupingOptions {
  @scala.inline
  def apply(): PlotBellcurveDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotBellcurveDataGroupingOptionsOps[Self <: PlotBellcurveDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
