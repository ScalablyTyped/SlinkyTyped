...
trait PlotHeatmapConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotHeatmapConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotHeatmapConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotHeatmapConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotHeatmapConnectorsOptions {
  @scala.inline
  def apply(): PlotHeatmapConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapConnectorsOptions]
  }
  @scala.inline
  implicit class PlotHeatmapConnectorsOptionsOps[Self <: PlotHeatmapConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotHeatmapConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotHeatmapConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotHeatmapConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
