...
trait PlotRocConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotRocConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotRocConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotRocConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotRocConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotRocConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotRocConnectorsMarkerOptions = null,
    startMarker: PlotRocConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotRocConnectorsOptions = {
