...
object PlotAreaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotAreaDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotAreaDragDropGuideBoxDefaultOptionsOps[Self <: PlotAreaDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
