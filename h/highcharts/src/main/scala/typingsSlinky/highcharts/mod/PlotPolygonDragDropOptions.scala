...
trait PlotPolygonDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotPolygonDragDropDragHandleOptions] = js.native
  /**
...
object PlotPolygonDragDropOptions {
  @scala.inline
  def apply(): PlotPolygonDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDragDropOptions]
  }
  @scala.inline
  implicit class PlotPolygonDragDropOptionsOps[Self <: PlotPolygonDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotPolygonDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotPolygonDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
