...
@js.native
trait SeriesArearangeDataEventsOptions extends js.Object {
  /**
...
object SeriesArearangeDataEventsOptions {
  @scala.inline
  def apply(): SeriesArearangeDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesArearangeDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesArearangeDataEventsOptionsOps[Self <: SeriesArearangeDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
