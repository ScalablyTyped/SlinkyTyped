...
object PlotAreasplineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplineConnectorsEndMarkerOptionsOps[Self <: PlotAreasplineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
