...
trait PlotZigzagAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotZigzagAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotZigzagAccessibilityOptions {
  @scala.inline
  def apply(): PlotZigzagAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotZigzagAccessibilityOptionsOps[Self <: PlotZigzagAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotZigzagAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
