...
@js.native
trait PlotCmfTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotCmfTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotCmfTooltipOptions {
  @scala.inline
  def apply(): PlotCmfTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfTooltipOptions]
  }
  @scala.inline
  implicit class PlotCmfTooltipOptionsOps[Self <: PlotCmfTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotCmfTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
