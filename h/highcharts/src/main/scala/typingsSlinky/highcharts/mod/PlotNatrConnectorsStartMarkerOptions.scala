...
object PlotNatrConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotNatrConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotNatrConnectorsStartMarkerOptionsOps[Self <: PlotNatrConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
