...
@js.native
trait PlotWindbarbPointEventsOptions extends js.Object {
  /**
...
object PlotWindbarbPointEventsOptions {
  @scala.inline
  def apply(): PlotWindbarbPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbPointEventsOptions]
  }
  @scala.inline
  implicit class PlotWindbarbPointEventsOptionsOps[Self <: PlotWindbarbPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
