...
object SeriesVectorDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesVectorDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataAccessibilityOptionsOps[Self <: SeriesVectorDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
