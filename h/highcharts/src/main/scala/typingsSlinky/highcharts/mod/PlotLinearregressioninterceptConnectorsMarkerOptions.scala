...
object PlotLinearregressioninterceptConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptConnectorsMarkerOptionsOps[Self <: PlotLinearregressioninterceptConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
