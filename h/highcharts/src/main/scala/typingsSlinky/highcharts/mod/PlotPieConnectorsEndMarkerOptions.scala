...
object PlotPieConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPieConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPieConnectorsEndMarkerOptionsOps[Self <: PlotPieConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
