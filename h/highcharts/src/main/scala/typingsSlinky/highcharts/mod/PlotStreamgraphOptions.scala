...
@js.native
trait PlotStreamgraphOptions extends StObject {
...
object PlotStreamgraphOptions {
  ...
  @scala.inline
  implicit class PlotStreamgraphOptionsMutableBuilder[Self <: PlotStreamgraphOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStreamgraphAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotStreamgraphDataLabelsOptions | js.Array[PlotStreamgraphDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotStreamgraphDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotStreamgraphDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
