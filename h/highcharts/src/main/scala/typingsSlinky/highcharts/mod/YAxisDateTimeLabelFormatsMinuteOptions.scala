...
object YAxisDateTimeLabelFormatsMinuteOptions {
  @scala.inline
  def apply(): YAxisDateTimeLabelFormatsMinuteOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisDateTimeLabelFormatsMinuteOptions]
  }
  @scala.inline
  implicit class YAxisDateTimeLabelFormatsMinuteOptionsOps[Self <: YAxisDateTimeLabelFormatsMinuteOptions] (val x: Self) extends AnyVal {
    @scala.inline
