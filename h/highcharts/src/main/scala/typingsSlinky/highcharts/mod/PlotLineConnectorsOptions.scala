...
trait PlotLineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLineConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLineConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLineConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotLineConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotLineConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotLineConnectorsMarkerOptions = null,
    startMarker: PlotLineConnectorsStartMarkerOptions = null,
