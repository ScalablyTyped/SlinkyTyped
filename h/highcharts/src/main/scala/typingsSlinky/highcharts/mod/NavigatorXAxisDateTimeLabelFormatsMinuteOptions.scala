...
object NavigatorXAxisDateTimeLabelFormatsMinuteOptions {
  @scala.inline
  def apply(): NavigatorXAxisDateTimeLabelFormatsMinuteOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisDateTimeLabelFormatsMinuteOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisDateTimeLabelFormatsMinuteOptionsOps[Self <: NavigatorXAxisDateTimeLabelFormatsMinuteOptions] (val x: Self) extends AnyVal {
    @scala.inline
