...
@js.native
trait PlotBbStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotBbStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBbStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotBbStatesSelectOptions {
  @scala.inline
  def apply(): PlotBbStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBbStatesSelectOptionsOps[Self <: PlotBbStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotBbStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBbStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
