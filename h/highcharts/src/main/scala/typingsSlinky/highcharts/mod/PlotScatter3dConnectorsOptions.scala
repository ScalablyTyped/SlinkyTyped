...
trait PlotScatter3dConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotScatter3dConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatter3dConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotScatter3dConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotScatter3dConnectorsOptions {
  @scala.inline
  def apply(): PlotScatter3dConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dConnectorsOptions]
  }
  @scala.inline
  implicit class PlotScatter3dConnectorsOptionsOps[Self <: PlotScatter3dConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotScatter3dConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotScatter3dConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotScatter3dConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
