...
trait PlotMapbubbleStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotMapbubbleStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMapbubbleStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotMapbubbleStatesSelectOptions {
  @scala.inline
  def apply(): PlotMapbubbleStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleStatesSelectOptionsOps[Self <: PlotMapbubbleStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotMapbubbleStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMapbubbleStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
