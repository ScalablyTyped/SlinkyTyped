...
object PlotHeatmapConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotHeatmapConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotHeatmapConnectorsMarkerOptionsOps[Self <: PlotHeatmapConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
