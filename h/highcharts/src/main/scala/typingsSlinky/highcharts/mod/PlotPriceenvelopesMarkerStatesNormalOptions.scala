...
object PlotPriceenvelopesMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesMarkerStatesNormalOptionsOps[Self <: PlotPriceenvelopesMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
