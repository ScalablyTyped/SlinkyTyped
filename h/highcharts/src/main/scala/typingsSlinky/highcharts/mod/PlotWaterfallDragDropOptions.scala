...
trait PlotWaterfallDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotWaterfallDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotWaterfallDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotWaterfallDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotWaterfallDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotWaterfallDragDropOptions = {
