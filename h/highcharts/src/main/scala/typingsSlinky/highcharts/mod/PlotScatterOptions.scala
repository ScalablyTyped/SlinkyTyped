...
@js.native
trait PlotScatterOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotScatterAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotScatterClusterOptions] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotScatterDataLabelsOptions | js.Array[PlotScatterDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotScatterDataSortingOptions] = js.native
...
object PlotScatterOptions {
  ...
  @scala.inline
  implicit class PlotScatterOptionsMutableBuilder[Self <: PlotScatterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotScatterAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCluster(value: PlotScatterClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotScatterDataLabelsOptions | js.Array[PlotScatterDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotScatterDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotScatterDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotScatterJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
