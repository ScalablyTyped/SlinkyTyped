...
trait PlotDpoTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotDpoTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotDpoTooltipOptions {
  @scala.inline
  def apply(): PlotDpoTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoTooltipOptions]
  }
  @scala.inline
  implicit class PlotDpoTooltipOptionsOps[Self <: PlotDpoTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotDpoTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
