...
object PlotDependencywheelDataGroupingOptions {
  @scala.inline
  def apply(): PlotDependencywheelDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelDataGroupingOptionsOps[Self <: PlotDependencywheelDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
