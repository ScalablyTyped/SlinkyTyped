...
@js.native
trait PlotBarDataSortingOptions extends StObject {
...
object PlotBarDataSortingOptions {
  
  @scala.inline
  def apply(): PlotBarDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotBarDataSortingOptionsMutableBuilder[Self <: PlotBarDataSortingOptions] (val x: Self) extends AnyVal {
