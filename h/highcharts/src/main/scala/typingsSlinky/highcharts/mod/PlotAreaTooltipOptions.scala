...
trait PlotAreaTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAreaTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAreaTooltipOptions {
  @scala.inline
  def apply(): PlotAreaTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaTooltipOptions]
  }
  @scala.inline
  implicit class PlotAreaTooltipOptionsOps[Self <: PlotAreaTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAreaTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
