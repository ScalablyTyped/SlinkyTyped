...
trait PlotTimelineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTimelineConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTimelineConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTimelineConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotTimelineConnectorsOptions {
  @scala.inline
  def apply(): PlotTimelineConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineConnectorsOptions]
  }
  @scala.inline
  implicit class PlotTimelineConnectorsOptionsOps[Self <: PlotTimelineConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotTimelineConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotTimelineConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotTimelineConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
