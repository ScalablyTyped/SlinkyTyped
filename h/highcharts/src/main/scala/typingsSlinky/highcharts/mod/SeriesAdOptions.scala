...
object SeriesAdOptions {
  ...
  @scala.inline
  implicit class SeriesAdOptionsOps[Self <: SeriesAdOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ad): Self = this.set("type", value.asInstanceOf[js.Any])
