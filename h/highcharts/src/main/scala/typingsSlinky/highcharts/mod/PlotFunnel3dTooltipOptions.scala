...
trait PlotFunnel3dTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotFunnel3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotFunnel3dTooltipOptions {
  @scala.inline
  def apply(): PlotFunnel3dTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dTooltipOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dTooltipOptionsOps[Self <: PlotFunnel3dTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotFunnel3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
