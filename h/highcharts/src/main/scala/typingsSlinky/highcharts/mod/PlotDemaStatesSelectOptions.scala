...
@js.native
trait PlotDemaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotDemaStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotDemaStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotDemaStatesSelectOptions {
  @scala.inline
  def apply(): PlotDemaStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotDemaStatesSelectOptionsOps[Self <: PlotDemaStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotDemaStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotDemaStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
