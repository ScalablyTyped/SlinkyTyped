...
object PlotLineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotLineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotLineConnectorsEndMarkerOptionsOps[Self <: PlotLineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
