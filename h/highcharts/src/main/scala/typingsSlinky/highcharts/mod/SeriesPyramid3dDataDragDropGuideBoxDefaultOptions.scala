...
@js.native
trait SeriesPyramid3dDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesPyramid3dDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesPyramid3dDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramid3dDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesPyramid3dDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesPyramid3dDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
