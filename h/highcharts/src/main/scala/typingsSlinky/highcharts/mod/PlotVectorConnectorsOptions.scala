...
trait PlotVectorConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVectorConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVectorConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVectorConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotVectorConnectorsOptions {
  @scala.inline
  def apply(): PlotVectorConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorConnectorsOptions]
  }
  @scala.inline
  implicit class PlotVectorConnectorsOptionsOps[Self <: PlotVectorConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotVectorConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotVectorConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotVectorConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
