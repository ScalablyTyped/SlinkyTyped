...
object PlotAroonMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotAroonMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotAroonMarkerStatesNormalOptionsOps[Self <: PlotAroonMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
