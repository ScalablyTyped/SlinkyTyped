...
trait PlotOrganizationConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotOrganizationConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotOrganizationConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotOrganizationConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotOrganizationConnectorsOptions {
  @scala.inline
  def apply(): PlotOrganizationConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationConnectorsOptions]
  }
  @scala.inline
  implicit class PlotOrganizationConnectorsOptionsOps[Self <: PlotOrganizationConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotOrganizationConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotOrganizationConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotOrganizationConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
