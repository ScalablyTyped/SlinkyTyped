...
object SeriesVbpOptions {
  ...
  @scala.inline
  implicit class SeriesVbpOptionsOps[Self <: SeriesVbpOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | vbp): Self = this.set("type", value.asInstanceOf[js.Any])
