...
trait SeriesVbpOptions extends PlotVbpOptions {
...
object SeriesVbpOptions {
  
  @scala.inline
  def apply(`type`: String | vbp): SeriesVbpOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesVbpOptions]
  }
  
  @scala.inline
  implicit class SeriesVbpOptionsMutableBuilder[Self <: SeriesVbpOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | vbp): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
