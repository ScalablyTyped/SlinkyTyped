...
object PlotPolygonStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPolygonStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPolygonStatesSelectHaloOptionsOps[Self <: PlotPolygonStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
