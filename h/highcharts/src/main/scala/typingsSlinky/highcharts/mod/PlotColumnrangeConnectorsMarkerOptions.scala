...
@js.native
trait PlotColumnrangeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotColumnrangeConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotColumnrangeConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeConnectorsMarkerOptionsOps[Self <: PlotColumnrangeConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
