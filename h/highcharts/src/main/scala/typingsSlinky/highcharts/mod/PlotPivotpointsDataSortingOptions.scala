...
@js.native
trait PlotPivotpointsDataSortingOptions extends StObject {
...
object PlotPivotpointsDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotPivotpointsDataSortingOptionsMutableBuilder[Self <: PlotPivotpointsDataSortingOptions] (val x: Self) extends AnyVal {
