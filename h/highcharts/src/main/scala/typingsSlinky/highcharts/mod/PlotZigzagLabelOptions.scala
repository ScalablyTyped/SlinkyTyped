...
@js.native
trait PlotZigzagLabelOptions extends js.Object {
  /**
...
object PlotZigzagLabelOptions {
  @scala.inline
  def apply(): PlotZigzagLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagLabelOptions]
  }
  @scala.inline
  implicit class PlotZigzagLabelOptionsOps[Self <: PlotZigzagLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
