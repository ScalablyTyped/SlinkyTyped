...
trait SeriesIkhOptions extends PlotIkhOptions {
...
object SeriesIkhOptions {
  
  @scala.inline
  def apply(`type`: String | ikh): SeriesIkhOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesIkhOptions]
  }
  
  @scala.inline
  implicit class SeriesIkhOptionsMutableBuilder[Self <: SeriesIkhOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ikh): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
