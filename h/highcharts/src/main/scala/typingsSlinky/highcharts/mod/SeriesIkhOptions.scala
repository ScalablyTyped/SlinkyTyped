...
object SeriesIkhOptions {
  ...
  @scala.inline
  implicit class SeriesIkhOptionsOps[Self <: SeriesIkhOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | ikh): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
