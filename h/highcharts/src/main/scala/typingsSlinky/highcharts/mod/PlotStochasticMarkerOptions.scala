...
@js.native
trait PlotStochasticMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStochasticMarkerStatesOptions] = js.native
  /**
...
object PlotStochasticMarkerOptions {
  @scala.inline
  def apply(): PlotStochasticMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticMarkerOptions]
  }
  @scala.inline
  implicit class PlotStochasticMarkerOptionsOps[Self <: PlotStochasticMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotStochasticMarkerStatesOptions): Self = {
        val ret = this.duplicate
