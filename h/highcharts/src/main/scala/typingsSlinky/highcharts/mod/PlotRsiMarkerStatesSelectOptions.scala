...
@js.native
trait PlotRsiMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRsiMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotRsiMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerStatesSelectOptionsOps[Self <: PlotRsiMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
