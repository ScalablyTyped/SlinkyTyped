...
trait PlotApoAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotApoAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotApoAccessibilityOptions {
  @scala.inline
  def apply(): PlotApoAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotApoAccessibilityOptionsOps[Self <: PlotApoAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotApoAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
