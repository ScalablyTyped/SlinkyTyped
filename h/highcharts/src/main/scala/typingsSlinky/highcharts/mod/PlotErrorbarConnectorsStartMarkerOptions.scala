...
object PlotErrorbarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotErrorbarConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotErrorbarConnectorsStartMarkerOptionsOps[Self <: PlotErrorbarConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
