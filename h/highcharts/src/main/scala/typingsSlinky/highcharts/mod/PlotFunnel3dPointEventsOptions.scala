...
object PlotFunnel3dPointEventsOptions {
  @scala.inline
  def apply(): PlotFunnel3dPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dPointEventsOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dPointEventsOptionsOps[Self <: PlotFunnel3dPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
