...
object PlotTemaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotTemaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTemaMarkerStatesSelectOptionsOps[Self <: PlotTemaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
