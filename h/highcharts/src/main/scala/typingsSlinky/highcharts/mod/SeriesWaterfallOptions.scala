...
trait SeriesWaterfallOptions extends PlotWaterfallOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | waterfall = js.native
...
object SeriesWaterfallOptions {
  
  @scala.inline
  def apply(`type`: String | waterfall): SeriesWaterfallOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesWaterfallOptions]
  }
  
  @scala.inline
  implicit class SeriesWaterfallOptionsMutableBuilder[Self <: SeriesWaterfallOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | waterfall): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
