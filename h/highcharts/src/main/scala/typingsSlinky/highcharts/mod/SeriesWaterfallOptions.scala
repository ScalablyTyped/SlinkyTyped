...
object SeriesWaterfallOptions {
  ...
  @scala.inline
  implicit class SeriesWaterfallOptionsOps[Self <: SeriesWaterfallOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | waterfall): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
