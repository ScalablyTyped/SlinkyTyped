...
object SeriesGanttDataDependencyEndMarkerOptions {
  @scala.inline
  def apply(): SeriesGanttDataDependencyEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataDependencyEndMarkerOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataDependencyEndMarkerOptionsOps[Self <: SeriesGanttDataDependencyEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
