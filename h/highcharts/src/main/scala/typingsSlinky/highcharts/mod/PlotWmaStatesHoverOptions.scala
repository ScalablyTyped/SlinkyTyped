...
trait PlotWmaStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWmaStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWmaStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotWmaStatesHoverOptions {
  @scala.inline
  def apply(): PlotWmaStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWmaStatesHoverOptionsOps[Self <: PlotWmaStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotWmaStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotWmaStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
