...
@js.native
trait PlotBubbleDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotBubbleDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotBubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotBubbleDragDropOptions {
  @scala.inline
  def apply(): PlotBubbleDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleDragDropOptions]
  }
  @scala.inline
  implicit class PlotBubbleDragDropOptionsOps[Self <: PlotBubbleDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotBubbleDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotBubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
