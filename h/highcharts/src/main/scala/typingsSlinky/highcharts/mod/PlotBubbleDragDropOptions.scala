...
trait PlotBubbleDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotBubbleDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotBubbleDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotBubbleDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotBubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
