...
trait PlotArearangeDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotArearangeDragDropDragHandleOptions] = js.native
  /**
...
object PlotArearangeDragDropOptions {
  @scala.inline
  def apply(): PlotArearangeDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeDragDropOptions]
  }
  @scala.inline
  implicit class PlotArearangeDragDropOptionsOps[Self <: PlotArearangeDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotArearangeDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotArearangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
