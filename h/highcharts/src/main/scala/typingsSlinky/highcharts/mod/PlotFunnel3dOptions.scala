...
object PlotFunnel3dOptions {
  ...
  implicit class PlotFunnel3dOptionsOps[Self <: PlotFunnel3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotFunnel3dDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    @scala.inline
    def setDataLabels(value: PlotFunnel3dDataLabelsOptions | js.Array[PlotFunnel3dDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    @scala.inline
