...
@js.native
trait PlotSolidgaugeDataLabelsAnimationOptions extends js.Object {
...
object PlotSolidgaugeDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotSolidgaugeDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotSolidgaugeDataLabelsAnimationOptionsOps[Self <: PlotSolidgaugeDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
