...
@js.native
trait PlotAreaDataLabelsOptions extends js.Object {
...
object PlotAreaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAreaDataLabelsOptionsOps[Self <: PlotAreaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAreaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
