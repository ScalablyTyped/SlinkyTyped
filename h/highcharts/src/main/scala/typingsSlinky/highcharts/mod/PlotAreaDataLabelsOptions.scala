...
@js.native
trait PlotAreaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAreaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotAreaDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotAreaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotAreaDataLabelsOptionsMutableBuilder[Self <: PlotAreaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAreaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
