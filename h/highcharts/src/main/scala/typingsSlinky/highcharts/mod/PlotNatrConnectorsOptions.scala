...
trait PlotNatrConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotNatrConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNatrConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotNatrConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotNatrConnectorsOptions {
  @scala.inline
  def apply(): PlotNatrConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrConnectorsOptions]
  }
  @scala.inline
  implicit class PlotNatrConnectorsOptionsOps[Self <: PlotNatrConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotNatrConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotNatrConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotNatrConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
