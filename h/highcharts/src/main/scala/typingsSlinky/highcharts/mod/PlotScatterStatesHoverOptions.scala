...
trait PlotScatterStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotScatterStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotScatterStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotScatterStatesHoverOptions {
  @scala.inline
  def apply(): PlotScatterStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotScatterStatesHoverOptionsOps[Self <: PlotScatterStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotScatterStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotScatterStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
