...
trait PlotBarTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotBarTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotBarTooltipOptions {
  @scala.inline
  def apply(): PlotBarTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarTooltipOptions]
  }
  @scala.inline
  implicit class PlotBarTooltipOptionsOps[Self <: PlotBarTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotBarTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
