...
trait PlotFlagsStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotFlagsStatesSelectAnimationOptions] = js.native
  /**
...
object PlotFlagsStatesSelectOptions {
  @scala.inline
  def apply(): PlotFlagsStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotFlagsStatesSelectOptionsOps[Self <: PlotFlagsStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotFlagsStatesSelectAnimationOptions): Self = {
