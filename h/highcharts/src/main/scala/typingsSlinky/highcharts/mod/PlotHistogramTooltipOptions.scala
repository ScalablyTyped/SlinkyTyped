...
@js.native
trait PlotHistogramTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotHistogramTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotHistogramTooltipOptions {
  @scala.inline
  def apply(): PlotHistogramTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramTooltipOptions]
  }
  @scala.inline
  implicit class PlotHistogramTooltipOptionsOps[Self <: PlotHistogramTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotHistogramTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
