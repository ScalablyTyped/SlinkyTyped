...
@js.native
trait ZAxisCurrentDateIndicatorLabelOptions extends js.Object {
  /**
...
object ZAxisCurrentDateIndicatorLabelOptions {
  @scala.inline
  def apply(): ZAxisCurrentDateIndicatorLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisCurrentDateIndicatorLabelOptions]
  }
  @scala.inline
  implicit class ZAxisCurrentDateIndicatorLabelOptionsOps[Self <: ZAxisCurrentDateIndicatorLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
