...
@js.native
trait PlotMomentumTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMomentumTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotMomentumTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotMomentumTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotMomentumTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
