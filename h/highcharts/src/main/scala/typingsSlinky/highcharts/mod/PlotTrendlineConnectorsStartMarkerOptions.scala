...
object PlotTrendlineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTrendlineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrendlineConnectorsStartMarkerOptionsOps[Self <: PlotTrendlineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
