...
@js.native
trait PlotNatrConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotNatrConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotNatrConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotNatrConnectorsMarkerOptionsOps[Self <: PlotNatrConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
