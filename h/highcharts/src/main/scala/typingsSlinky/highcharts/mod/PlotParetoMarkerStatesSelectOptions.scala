...
object PlotParetoMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotParetoMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotParetoMarkerStatesSelectOptionsOps[Self <: PlotParetoMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
