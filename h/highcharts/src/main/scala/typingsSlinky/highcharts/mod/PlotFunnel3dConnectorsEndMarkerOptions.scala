...
@js.native
trait PlotFunnel3dConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotFunnel3dConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotFunnel3dConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dConnectorsEndMarkerOptionsOps[Self <: PlotFunnel3dConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
