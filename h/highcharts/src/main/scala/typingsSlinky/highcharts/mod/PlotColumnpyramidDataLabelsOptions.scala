...
@js.native
trait PlotColumnpyramidDataLabelsOptions extends js.Object {
...
object PlotColumnpyramidDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotColumnpyramidDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotColumnpyramidDataLabelsOptionsOps[Self <: PlotColumnpyramidDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotColumnpyramidDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
