...
object PlotSeriesMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotSeriesMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSeriesMarkerStatesHoverOptionsOps[Self <: PlotSeriesMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
