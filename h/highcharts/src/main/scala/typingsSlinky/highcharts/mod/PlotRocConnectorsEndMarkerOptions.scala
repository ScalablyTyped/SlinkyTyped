...
object PlotRocConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotRocConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotRocConnectorsEndMarkerOptionsOps[Self <: PlotRocConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
