...
trait PlotRocMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotRocMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotRocMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotRocMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotRocMarkerStatesSelectOptions] = js.native
}

object PlotRocMarkerStatesOptions {
  @scala.inline
  def apply(): PlotRocMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotRocMarkerStatesOptionsOps[Self <: PlotRocMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotRocMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotRocMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotRocMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotRocMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
