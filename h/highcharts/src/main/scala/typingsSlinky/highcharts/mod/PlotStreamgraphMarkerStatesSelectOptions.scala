...
object PlotStreamgraphMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotStreamgraphMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphMarkerStatesSelectOptionsOps[Self <: PlotStreamgraphMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
