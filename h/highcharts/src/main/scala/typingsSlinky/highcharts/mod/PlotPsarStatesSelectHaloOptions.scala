...
object PlotPsarStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPsarStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPsarStatesSelectHaloOptionsOps[Self <: PlotPsarStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
