...
object PlotAreasplinerangeMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeMarkerStatesSelectOptionsOps[Self <: PlotAreasplinerangeMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
