...
@js.native
trait PlotPackedbubbleOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPackedbubbleAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var parentNode: js.UndefOr[PlotPackedbubbleParentNodeOptions] = js.native
...
object PlotPackedbubbleOptions {
  ...
  @scala.inline
  implicit class PlotPackedbubbleOptionsMutableBuilder[Self <: PlotPackedbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPackedbubbleAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: SeriesPackedBubbleDataLabelsOptionsObject*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setDisplayNegative(value: Boolean): Self = StObject.set(x, "displayNegative", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisplayNegativeUndefined: Self = StObject.set(x, "displayNegative", js.undefined)
    ...
    @scala.inline
    def setLayoutAlgorithm(value: PlotPackedbubbleLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParentNode(value: PlotPackedbubbleParentNodeOptions): Self = StObject.set(x, "parentNode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSizeBy(value: String): Self = StObject.set(x, "sizeBy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUseSimulation(value: Boolean): Self = StObject.set(x, "useSimulation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUseSimulationUndefined: Self = StObject.set(x, "useSimulation", js.undefined)
