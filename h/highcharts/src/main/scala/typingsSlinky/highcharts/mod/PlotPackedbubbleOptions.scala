...
object PlotPackedbubbleOptions {
  ...
  implicit class PlotPackedbubbleOptionsOps[Self <: PlotPackedbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPackedbubbleAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: SeriesPackedBubbleDataLabelsOptionsObject*): Self = this.set("dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setDisplayNegative(value: Boolean): Self = this.set("displayNegative", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisplayNegative: Self = this.set("displayNegative", js.undefined)
    ...
    @scala.inline
    def setLayoutAlgorithm(value: PlotPackedbubbleLayoutAlgorithmOptions): Self = this.set("layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParentNode(value: PlotPackedbubbleParentNodeOptions): Self = this.set("parentNode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSizeBy(value: String): Self = this.set("sizeBy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUseSimulation(value: Boolean): Self = this.set("useSimulation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUseSimulation: Self = this.set("useSimulation", js.undefined)
