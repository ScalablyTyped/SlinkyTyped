...
object PlotKeltnerchannelsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsConnectorsEndMarkerOptionsOps[Self <: PlotKeltnerchannelsConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
