...
@js.native
trait AnnotationsLabelsPointOptions extends js.Object {
  /**
...
object AnnotationsLabelsPointOptions {
  @scala.inline
  def apply(): AnnotationsLabelsPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsLabelsPointOptions]
  }
  @scala.inline
  implicit class AnnotationsLabelsPointOptionsOps[Self <: AnnotationsLabelsPointOptions] (val x: Self) extends AnyVal {
    @scala.inline
