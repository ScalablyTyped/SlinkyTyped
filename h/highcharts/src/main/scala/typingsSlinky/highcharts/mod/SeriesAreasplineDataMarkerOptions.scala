...
@js.native
trait SeriesAreasplineDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesAreasplineDataMarkerStatesOptions] = js.native
  /**
...
object SeriesAreasplineDataMarkerOptions {
  @scala.inline
  def apply(): SeriesAreasplineDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplineDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesAreasplineDataMarkerOptionsOps[Self <: SeriesAreasplineDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesAreasplineDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
