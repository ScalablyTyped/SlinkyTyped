...
@js.native
trait PlotAdStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotAdStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotAdStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotAdStatesHoverHaloOptionsOps[Self <: PlotAdStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
