...
object YAxisPlotLinesOptions {
  ...
  @scala.inline
  implicit class YAxisPlotLinesOptionsOps[Self <: YAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEvents(value: YAxisPlotLinesEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLabel(value: YAxisPlotLinesLabelOptions): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
