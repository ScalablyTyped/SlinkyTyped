...
object YAxisPlotLinesOptions {
  ...
  @scala.inline
  def apply(): YAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisPlotLinesOptions]
  }
  
  @scala.inline
  implicit class YAxisPlotLinesOptionsMutableBuilder[Self <: YAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: YAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: YAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
