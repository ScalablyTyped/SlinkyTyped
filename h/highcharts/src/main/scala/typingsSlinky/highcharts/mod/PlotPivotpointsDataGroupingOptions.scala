...
@js.native
trait PlotPivotpointsDataGroupingOptions extends js.Object {
  /**
    ...
    */
  var approximation: js.UndefOr[String] = js.native
  /**
...
object PlotPivotpointsDataGroupingOptions {
  @scala.inline
  def apply(): PlotPivotpointsDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsDataGroupingOptionsOps[Self <: PlotPivotpointsDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withApproximation(value: String): Self = {
