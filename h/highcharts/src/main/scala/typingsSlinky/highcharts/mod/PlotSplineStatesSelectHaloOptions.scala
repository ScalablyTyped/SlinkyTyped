...
object PlotSplineStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotSplineStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotSplineStatesSelectHaloOptionsOps[Self <: PlotSplineStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
