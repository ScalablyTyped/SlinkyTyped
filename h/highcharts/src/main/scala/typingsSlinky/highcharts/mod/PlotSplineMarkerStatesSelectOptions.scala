...
object PlotSplineMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotSplineMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSplineMarkerStatesSelectOptionsOps[Self <: PlotSplineMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
