...
trait PlotSeriesAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSeriesAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSeriesAccessibilityOptions {
  @scala.inline
  def apply(): PlotSeriesAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSeriesAccessibilityOptionsOps[Self <: PlotSeriesAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSeriesAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
