...
trait PlotBubbleStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotBubbleStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBubbleStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotBubbleStatesSelectOptions {
  @scala.inline
  def apply(): PlotBubbleStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBubbleStatesSelectOptionsOps[Self <: PlotBubbleStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotBubbleStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotBubbleStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
