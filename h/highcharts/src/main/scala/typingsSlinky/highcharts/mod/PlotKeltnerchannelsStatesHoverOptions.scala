...
trait PlotKeltnerchannelsStatesHoverOptions extends js.Object {
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotKeltnerchannelsStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotKeltnerchannelsStatesHoverOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesHoverOptionsOps[Self <: PlotKeltnerchannelsStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotKeltnerchannelsStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
