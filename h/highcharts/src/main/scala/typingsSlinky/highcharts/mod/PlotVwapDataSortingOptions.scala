...
@js.native
trait PlotVwapDataSortingOptions extends js.Object {
...
object PlotVwapDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotVwapDataSortingOptionsOps[Self <: PlotVwapDataSortingOptions] (val x: Self) extends AnyVal {
