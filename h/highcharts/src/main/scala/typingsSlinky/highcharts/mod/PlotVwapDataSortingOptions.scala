...
@js.native
trait PlotVwapDataSortingOptions extends StObject {
...
object PlotVwapDataSortingOptions {
  
  @scala.inline
  def apply(): PlotVwapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotVwapDataSortingOptionsMutableBuilder[Self <: PlotVwapDataSortingOptions] (val x: Self) extends AnyVal {
