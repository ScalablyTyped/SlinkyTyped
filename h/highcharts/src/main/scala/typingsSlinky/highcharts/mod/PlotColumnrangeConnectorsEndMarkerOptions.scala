...
object PlotColumnrangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotColumnrangeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeConnectorsEndMarkerOptionsOps[Self <: PlotColumnrangeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
