...
@js.native
trait PlotAroonoscillatorTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAroonoscillatorTooltipOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorTooltipOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorTooltipOptionsOps[Self <: PlotAroonoscillatorTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
