...
object PlotVariwideAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotVariwideAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotVariwideAccessibilityKeyboardNavigationOptionsOps[Self <: PlotVariwideAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
