...
object PlotTreemapLevelsDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTreemapLevelsDataLabelsOptionsMutableBuilder[Self <: PlotTreemapLevelsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTreemapLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
