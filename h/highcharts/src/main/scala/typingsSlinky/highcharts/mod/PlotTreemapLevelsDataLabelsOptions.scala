...
@js.native
trait PlotTreemapLevelsDataLabelsOptions extends js.Object {
...
object PlotTreemapLevelsDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotTreemapLevelsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapLevelsDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTreemapLevelsDataLabelsOptionsOps[Self <: PlotTreemapLevelsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTreemapLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
