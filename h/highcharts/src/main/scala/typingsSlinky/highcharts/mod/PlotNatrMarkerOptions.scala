...
trait PlotNatrMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNatrMarkerStatesOptions] = js.native
  /**
...
object PlotNatrMarkerOptions {
  @scala.inline
  def apply(): PlotNatrMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrMarkerOptions]
  }
  @scala.inline
  implicit class PlotNatrMarkerOptionsOps[Self <: PlotNatrMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotNatrMarkerStatesOptions): Self = {
        val ret = this.duplicate
