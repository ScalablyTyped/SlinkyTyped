...
@js.native
trait PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
