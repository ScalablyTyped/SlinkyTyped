...
@js.native
trait SeriesSankeyDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesSankeyDataAccessibilityOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesSankeyDataEventsOptions] = js.native
  /**
...
object SeriesSankeyDataOptions {
  @scala.inline
  def apply(): SeriesSankeyDataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSankeyDataOptions]
  }
  @scala.inline
  implicit class SeriesSankeyDataOptionsOps[Self <: SeriesSankeyDataOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccessibility(value: SeriesSankeyDataAccessibilityOptions): Self = {
    ...
    @scala.inline
    def withEvents(value: SeriesSankeyDataEventsOptions): Self = {
        val ret = this.duplicate
