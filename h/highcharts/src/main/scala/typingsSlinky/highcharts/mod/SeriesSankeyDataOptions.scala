...
trait SeriesSankeyDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesSankeyDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesSankeyDataEventsOptions] = js.undefined
  /**
...
object SeriesSankeyDataOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(outgoing)) __obj.updateDynamic("outgoing")(outgoing.asInstanceOf[js.Any])
