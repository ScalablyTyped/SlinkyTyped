...
@js.native
trait AnnotationsVerticalLineTypePointsOptions extends js.Object {
...
object AnnotationsVerticalLineTypePointsOptions {
  @scala.inline
  def apply(): AnnotationsVerticalLineTypePointsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsVerticalLineTypePointsOptions]
  }
  @scala.inline
  implicit class AnnotationsVerticalLineTypePointsOptionsOps[Self <: AnnotationsVerticalLineTypePointsOptions] (val x: Self) extends AnyVal {
    @scala.inline
