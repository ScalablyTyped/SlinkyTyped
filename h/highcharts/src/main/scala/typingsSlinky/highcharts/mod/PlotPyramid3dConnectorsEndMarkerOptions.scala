...
object PlotPyramid3dConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPyramid3dConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dConnectorsEndMarkerOptionsOps[Self <: PlotPyramid3dConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
