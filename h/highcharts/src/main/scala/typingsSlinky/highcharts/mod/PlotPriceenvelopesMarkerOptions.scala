...
@js.native
trait PlotPriceenvelopesMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPriceenvelopesMarkerStatesOptions] = js.native
  /**
...
object PlotPriceenvelopesMarkerOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesMarkerOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesMarkerOptionsOps[Self <: PlotPriceenvelopesMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPriceenvelopesMarkerStatesOptions): Self = {
        val ret = this.duplicate
