...
trait PlotArearangeAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotArearangeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotArearangeAccessibilityOptions {
  @scala.inline
  def apply(): PlotArearangeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotArearangeAccessibilityOptionsOps[Self <: PlotArearangeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotArearangeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
