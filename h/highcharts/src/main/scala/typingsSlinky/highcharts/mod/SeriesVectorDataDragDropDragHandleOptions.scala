...
object SeriesVectorDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesVectorDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataDragDropDragHandleOptionsOps[Self <: SeriesVectorDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
