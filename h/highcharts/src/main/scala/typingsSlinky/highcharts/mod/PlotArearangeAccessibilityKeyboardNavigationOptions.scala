...
object PlotArearangeAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotArearangeAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotArearangeAccessibilityKeyboardNavigationOptionsOps[Self <: PlotArearangeAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
