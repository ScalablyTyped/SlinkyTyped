...
@js.native
trait PlotHeatmapZonesOptions extends js.Object {
  /**
...
object PlotHeatmapZonesOptions {
  @scala.inline
  def apply(): PlotHeatmapZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapZonesOptions]
  }
  @scala.inline
  implicit class PlotHeatmapZonesOptionsOps[Self <: PlotHeatmapZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
