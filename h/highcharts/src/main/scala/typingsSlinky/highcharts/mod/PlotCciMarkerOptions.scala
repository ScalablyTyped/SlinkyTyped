...
trait PlotCciMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotCciMarkerStatesOptions] = js.native
  /**
...
object PlotCciMarkerOptions {
  @scala.inline
  def apply(): PlotCciMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciMarkerOptions]
  }
  @scala.inline
  implicit class PlotCciMarkerOptionsOps[Self <: PlotCciMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotCciMarkerStatesOptions): Self = {
        val ret = this.duplicate
