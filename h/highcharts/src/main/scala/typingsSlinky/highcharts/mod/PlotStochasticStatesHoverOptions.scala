...
@js.native
trait PlotStochasticStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotStochasticStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStochasticStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotStochasticStatesHoverOptions {
  @scala.inline
  def apply(): PlotStochasticStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotStochasticStatesHoverOptionsOps[Self <: PlotStochasticStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotStochasticStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotStochasticStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
