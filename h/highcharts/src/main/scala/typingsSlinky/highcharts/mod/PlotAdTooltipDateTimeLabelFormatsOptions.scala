...
object PlotAdTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotAdTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotAdTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotAdTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
