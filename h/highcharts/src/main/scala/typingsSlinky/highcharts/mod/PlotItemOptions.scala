...
@js.native
trait PlotItemOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotItemAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotItemOptions {
  ...
  @scala.inline
  implicit class PlotItemOptionsMutableBuilder[Self <: PlotItemOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotItemAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
