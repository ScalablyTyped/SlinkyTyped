...
@js.native
trait PlotLinearregressionConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionConnectorsMarkerOptionsOps[Self <: PlotLinearregressionConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
