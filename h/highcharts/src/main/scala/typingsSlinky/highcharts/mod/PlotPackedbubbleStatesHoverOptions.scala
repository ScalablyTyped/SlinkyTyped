...
trait PlotPackedbubbleStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPackedbubbleStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPackedbubbleStatesHoverHaloOptions] = js.native
  /**
...
object PlotPackedbubbleStatesHoverOptions {
  @scala.inline
  def apply(): PlotPackedbubbleStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleStatesHoverOptionsOps[Self <: PlotPackedbubbleStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPackedbubbleStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPackedbubbleStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
