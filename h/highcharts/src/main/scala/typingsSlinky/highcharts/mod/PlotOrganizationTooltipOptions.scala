...
@js.native
trait PlotOrganizationTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotOrganizationTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotOrganizationTooltipOptions {
  @scala.inline
  def apply(): PlotOrganizationTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationTooltipOptions]
  }
  @scala.inline
  implicit class PlotOrganizationTooltipOptionsOps[Self <: PlotOrganizationTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotOrganizationTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNodeFormatter(value: FormatterCallbackFunction[SankeyNodeObject]): Self = {
        val ret = this.duplicate
