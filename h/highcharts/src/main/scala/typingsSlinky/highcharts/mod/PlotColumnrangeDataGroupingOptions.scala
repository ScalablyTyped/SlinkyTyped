...
object PlotColumnrangeDataGroupingOptions {
  @scala.inline
  def apply(): PlotColumnrangeDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeDataGroupingOptionsOps[Self <: PlotColumnrangeDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
