...
object PlotAoMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotAoMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotAoMarkerStatesNormalOptionsOps[Self <: PlotAoMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
