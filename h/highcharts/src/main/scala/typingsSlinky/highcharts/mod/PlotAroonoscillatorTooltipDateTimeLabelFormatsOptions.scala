...
@js.native
trait PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
