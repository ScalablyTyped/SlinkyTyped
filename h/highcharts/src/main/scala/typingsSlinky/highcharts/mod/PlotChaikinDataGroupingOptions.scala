...
object PlotChaikinDataGroupingOptions {
  @scala.inline
  def apply(): PlotChaikinDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotChaikinDataGroupingOptionsOps[Self <: PlotChaikinDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
