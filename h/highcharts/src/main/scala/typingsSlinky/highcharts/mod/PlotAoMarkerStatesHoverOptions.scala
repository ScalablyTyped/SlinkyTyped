...
@js.native
trait PlotAoMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotAoMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAoMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAoMarkerStatesHoverOptionsOps[Self <: PlotAoMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
