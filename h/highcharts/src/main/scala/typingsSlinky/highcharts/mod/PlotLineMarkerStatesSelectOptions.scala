...
object PlotLineMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotLineMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLineMarkerStatesSelectOptionsOps[Self <: PlotLineMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
