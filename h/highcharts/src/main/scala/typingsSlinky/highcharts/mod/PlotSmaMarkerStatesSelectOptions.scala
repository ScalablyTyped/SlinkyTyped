...
object PlotSmaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotSmaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSmaMarkerStatesSelectOptionsOps[Self <: PlotSmaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
