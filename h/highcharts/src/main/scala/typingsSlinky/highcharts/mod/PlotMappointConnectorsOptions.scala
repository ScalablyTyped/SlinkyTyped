...
@js.native
trait PlotMappointConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMappointConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMappointConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMappointConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotMappointConnectorsOptions {
  @scala.inline
  def apply(): PlotMappointConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointConnectorsOptions]
  }
  @scala.inline
  implicit class PlotMappointConnectorsOptionsOps[Self <: PlotMappointConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotMappointConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotMappointConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotMappointConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
