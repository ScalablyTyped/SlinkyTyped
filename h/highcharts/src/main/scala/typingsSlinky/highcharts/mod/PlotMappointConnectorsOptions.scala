...
trait PlotMappointConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMappointConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMappointConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMappointConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMappointConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotMappointConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotMappointConnectorsMarkerOptions = null,
    startMarker: PlotMappointConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMappointConnectorsOptions = {
