...
@js.native
trait PlotWaterfallDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotWaterfallDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotWaterfallDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotWaterfallDragDropGuideBoxDefaultOptionsOps[Self <: PlotWaterfallDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
