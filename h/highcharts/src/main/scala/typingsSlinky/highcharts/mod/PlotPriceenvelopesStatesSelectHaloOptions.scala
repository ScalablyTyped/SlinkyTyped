...
@js.native
trait PlotPriceenvelopesStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotPriceenvelopesStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesStatesSelectHaloOptionsOps[Self <: PlotPriceenvelopesStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
