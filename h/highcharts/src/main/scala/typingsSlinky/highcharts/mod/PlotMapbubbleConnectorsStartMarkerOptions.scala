...
object PlotMapbubbleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMapbubbleConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleConnectorsStartMarkerOptionsOps[Self <: PlotMapbubbleConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
