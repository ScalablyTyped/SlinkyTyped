...
@js.native
trait PlotDemaLabelOptions extends js.Object {
  /**
...
object PlotDemaLabelOptions {
  @scala.inline
  def apply(): PlotDemaLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaLabelOptions]
  }
  @scala.inline
  implicit class PlotDemaLabelOptionsOps[Self <: PlotDemaLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
