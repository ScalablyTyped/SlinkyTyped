...
@js.native
trait SeriesSunburstDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesSunburstDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesSunburstDataDataLabelsAnimationOptionsOps[Self <: SeriesSunburstDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
