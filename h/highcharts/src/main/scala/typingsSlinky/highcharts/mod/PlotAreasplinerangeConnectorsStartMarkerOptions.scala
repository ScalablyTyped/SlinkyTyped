...
object PlotAreasplinerangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeConnectorsStartMarkerOptionsOps[Self <: PlotAreasplinerangeConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
