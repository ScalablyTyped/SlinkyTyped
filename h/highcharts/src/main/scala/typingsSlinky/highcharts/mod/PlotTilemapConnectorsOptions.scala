...
trait PlotTilemapConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTilemapConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTilemapConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTilemapConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotTilemapConnectorsOptions {
  @scala.inline
  def apply(): PlotTilemapConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapConnectorsOptions]
  }
  @scala.inline
  implicit class PlotTilemapConnectorsOptionsOps[Self <: PlotTilemapConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotTilemapConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotTilemapConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotTilemapConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
