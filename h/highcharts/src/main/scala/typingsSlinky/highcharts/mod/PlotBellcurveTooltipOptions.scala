...
trait PlotBellcurveTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotBellcurveTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotBellcurveTooltipOptions {
  @scala.inline
  def apply(): PlotBellcurveTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveTooltipOptions]
  }
  @scala.inline
  implicit class PlotBellcurveTooltipOptionsOps[Self <: PlotBellcurveTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotBellcurveTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
