...
object PlotLinearregressionslopeMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeMarkerStatesHoverOptionsOps[Self <: PlotLinearregressionslopeMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
