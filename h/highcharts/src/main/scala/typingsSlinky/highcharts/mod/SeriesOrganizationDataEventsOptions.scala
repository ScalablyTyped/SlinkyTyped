...
object SeriesOrganizationDataEventsOptions {
  @scala.inline
  def apply(): SeriesOrganizationDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesOrganizationDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesOrganizationDataEventsOptionsOps[Self <: SeriesOrganizationDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
