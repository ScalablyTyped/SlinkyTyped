...
trait PlotAtrConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAtrConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAtrConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAtrConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotAtrConnectorsOptions {
  @scala.inline
  def apply(): PlotAtrConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrConnectorsOptions]
  }
  @scala.inline
  implicit class PlotAtrConnectorsOptionsOps[Self <: PlotAtrConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotAtrConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotAtrConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotAtrConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
