...
@js.native
trait PlotTilemapConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTilemapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotTilemapConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotTilemapConnectorsEndMarkerOptionsOps[Self <: PlotTilemapConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
