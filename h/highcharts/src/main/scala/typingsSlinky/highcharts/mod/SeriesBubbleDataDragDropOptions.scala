...
trait SeriesBubbleDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesBubbleDataDragDropDragHandleOptions] = js.native
  /**
...
object SeriesBubbleDataDragDropOptions {
  @scala.inline
  def apply(): SeriesBubbleDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesBubbleDataDragDropOptionsOps[Self <: SeriesBubbleDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesBubbleDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesBubbleDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
