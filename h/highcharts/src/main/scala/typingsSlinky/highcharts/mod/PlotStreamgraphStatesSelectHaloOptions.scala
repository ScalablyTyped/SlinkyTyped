...
object PlotStreamgraphStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotStreamgraphStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphStatesSelectHaloOptionsOps[Self <: PlotStreamgraphStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
