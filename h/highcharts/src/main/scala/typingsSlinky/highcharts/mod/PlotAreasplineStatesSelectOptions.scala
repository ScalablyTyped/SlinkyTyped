...
trait PlotAreasplineStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotAreasplineStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreasplineStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotAreasplineStatesSelectOptions {
  @scala.inline
  def apply(): PlotAreasplineStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAreasplineStatesSelectOptionsOps[Self <: PlotAreasplineStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotAreasplineStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAreasplineStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
