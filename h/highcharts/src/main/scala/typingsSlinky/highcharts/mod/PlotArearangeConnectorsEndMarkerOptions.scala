...
@js.native
trait PlotArearangeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotArearangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotArearangeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotArearangeConnectorsEndMarkerOptionsOps[Self <: PlotArearangeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
