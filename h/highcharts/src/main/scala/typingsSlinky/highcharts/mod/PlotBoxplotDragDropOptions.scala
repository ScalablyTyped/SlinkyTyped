...
trait PlotBoxplotDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotBoxplotDragDropDragHandleOptions] = js.native
  /**
...
object PlotBoxplotDragDropOptions {
  @scala.inline
  def apply(): PlotBoxplotDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotDragDropOptions]
  }
  @scala.inline
  implicit class PlotBoxplotDragDropOptionsOps[Self <: PlotBoxplotDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotBoxplotDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotBoxplotDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
