...
object PlotMappointStatesNormalOptions {
  @scala.inline
  def apply(): PlotMappointStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMappointStatesNormalOptionsOps[Self <: PlotMappointStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
