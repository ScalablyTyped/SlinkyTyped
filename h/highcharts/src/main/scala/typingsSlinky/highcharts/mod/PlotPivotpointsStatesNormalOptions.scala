...
object PlotPivotpointsStatesNormalOptions {
  @scala.inline
  def apply(): PlotPivotpointsStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsStatesNormalOptionsOps[Self <: PlotPivotpointsStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
