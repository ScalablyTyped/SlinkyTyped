...
object PlotVariablepieConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotVariablepieConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariablepieConnectorsStartMarkerOptionsOps[Self <: PlotVariablepieConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
