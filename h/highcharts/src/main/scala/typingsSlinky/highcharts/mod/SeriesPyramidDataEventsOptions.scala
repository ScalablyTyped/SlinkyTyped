...
@js.native
trait SeriesPyramidDataEventsOptions extends js.Object {
  /**
...
object SeriesPyramidDataEventsOptions {
  @scala.inline
  def apply(): SeriesPyramidDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramidDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesPyramidDataEventsOptionsOps[Self <: SeriesPyramidDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
