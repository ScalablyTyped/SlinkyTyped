...
object PlotMappointMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotMappointMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMappointMarkerStatesSelectOptionsOps[Self <: PlotMappointMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
