...
object PlotTemaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTemaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTemaConnectorsMarkerOptionsOps[Self <: PlotTemaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
