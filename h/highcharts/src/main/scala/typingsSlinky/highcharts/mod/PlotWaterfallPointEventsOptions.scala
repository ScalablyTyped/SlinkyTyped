...
@js.native
trait PlotWaterfallPointEventsOptions extends js.Object {
  /**
...
object PlotWaterfallPointEventsOptions {
  @scala.inline
  def apply(): PlotWaterfallPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallPointEventsOptions]
  }
  @scala.inline
  implicit class PlotWaterfallPointEventsOptionsOps[Self <: PlotWaterfallPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
