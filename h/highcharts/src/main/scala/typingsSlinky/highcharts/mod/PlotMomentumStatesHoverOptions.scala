...
trait PlotMomentumStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMomentumStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMomentumStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotMomentumStatesHoverOptions {
  @scala.inline
  def apply(): PlotMomentumStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMomentumStatesHoverOptionsOps[Self <: PlotMomentumStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMomentumStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMomentumStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
