...
@js.native
trait SeriesAreaDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesAreaDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesAreaDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesAreaDataDataLabelsAnimationOptionsOps[Self <: SeriesAreaDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
