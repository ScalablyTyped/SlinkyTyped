...
@js.native
trait PlotTimelineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTimelineDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotTimelineDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotTimelineDragDropDragHandleOptionsOps[Self <: PlotTimelineDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
