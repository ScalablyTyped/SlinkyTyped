...
@js.native
trait PlotIkhTenkanLineStylesOptions extends StObject {
...
object PlotIkhTenkanLineStylesOptions {
  ...
  @scala.inline
  def apply(): PlotIkhTenkanLineStylesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhTenkanLineStylesOptions]
  }
  
  @scala.inline
  implicit class PlotIkhTenkanLineStylesOptionsMutableBuilder[Self <: PlotIkhTenkanLineStylesOptions] (val x: Self) extends AnyVal {
