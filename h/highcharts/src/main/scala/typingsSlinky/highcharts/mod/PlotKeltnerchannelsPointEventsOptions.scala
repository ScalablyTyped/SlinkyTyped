...
object PlotKeltnerchannelsPointEventsOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsPointEventsOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsPointEventsOptionsOps[Self <: PlotKeltnerchannelsPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
