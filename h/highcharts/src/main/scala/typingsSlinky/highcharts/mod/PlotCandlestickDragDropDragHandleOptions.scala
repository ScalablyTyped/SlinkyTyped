...
object PlotCandlestickDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotCandlestickDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotCandlestickDragDropDragHandleOptionsOps[Self <: PlotCandlestickDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
