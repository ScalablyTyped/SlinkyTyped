...
object PlotPackedbubbleLayoutAlgorithmParentNodeMarkerOptions {
  @scala.inline
  def apply(): PlotPackedbubbleLayoutAlgorithmParentNodeMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleLayoutAlgorithmParentNodeMarkerOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleLayoutAlgorithmParentNodeMarkerOptionsOps[Self <: PlotPackedbubbleLayoutAlgorithmParentNodeMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
