...
object PlotLineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotLineDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotLineDragDropGuideBoxDefaultOptionsOps[Self <: PlotLineDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
