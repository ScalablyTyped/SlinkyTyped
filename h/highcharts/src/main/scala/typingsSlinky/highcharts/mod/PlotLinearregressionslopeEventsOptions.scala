...
object PlotLinearregressionslopeEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeEventsOptionsOps[Self <: PlotLinearregressionslopeEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
