...
trait PlotTreemapTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTreemapTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotTreemapTooltipOptions {
  @scala.inline
  def apply(): PlotTreemapTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapTooltipOptions]
  }
  @scala.inline
  implicit class PlotTreemapTooltipOptionsOps[Self <: PlotTreemapTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotTreemapTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
