...
object PlotWmaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotWmaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotWmaConnectorsMarkerOptionsOps[Self <: PlotWmaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
