...
object SeriesXrangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesXrangeDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataDragDropDragHandleOptionsOps[Self <: SeriesXrangeDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
