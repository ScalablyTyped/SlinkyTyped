...
object PlotWaterfallLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotWaterfallLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotWaterfallLastVisiblePriceLabelOptionsOps[Self <: PlotWaterfallLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
