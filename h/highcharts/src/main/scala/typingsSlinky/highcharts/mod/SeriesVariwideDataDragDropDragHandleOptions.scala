...
@js.native
trait SeriesVariwideDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesVariwideDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesVariwideDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVariwideDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesVariwideDataDragDropDragHandleOptionsOps[Self <: SeriesVariwideDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
