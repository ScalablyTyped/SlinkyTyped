...
trait SeriesHeatmapOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | SeriesHeatmapDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesHeatmapOptions {
  ...
  implicit class SeriesHeatmapOptionsOps[Self <: SeriesHeatmapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | heatmap): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[js.Array[Double] | SeriesHeatmapDataOptions]): Self = {
        val ret = this.duplicate
