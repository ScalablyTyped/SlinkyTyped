...
@js.native
trait PlotRocDataGroupingOptions extends js.Object {
  /**
...
object PlotRocDataGroupingOptions {
  @scala.inline
  def apply(): PlotRocDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotRocDataGroupingOptionsOps[Self <: PlotRocDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
