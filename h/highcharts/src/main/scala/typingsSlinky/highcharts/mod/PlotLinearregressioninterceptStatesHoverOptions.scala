...
trait PlotLinearregressioninterceptStatesHoverOptions extends js.Object {
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressioninterceptStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressioninterceptStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptStatesHoverOptionsOps[Self <: PlotLinearregressioninterceptStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressioninterceptStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
