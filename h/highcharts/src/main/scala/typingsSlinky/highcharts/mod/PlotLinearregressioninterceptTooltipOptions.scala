...
object PlotLinearregressioninterceptTooltipOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptTooltipOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptTooltipOptionsOps[Self <: PlotLinearregressioninterceptTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
