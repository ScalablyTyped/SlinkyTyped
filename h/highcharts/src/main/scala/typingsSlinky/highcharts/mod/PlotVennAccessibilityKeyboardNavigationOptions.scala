...
object PlotVennAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotVennAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotVennAccessibilityKeyboardNavigationOptionsOps[Self <: PlotVennAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
