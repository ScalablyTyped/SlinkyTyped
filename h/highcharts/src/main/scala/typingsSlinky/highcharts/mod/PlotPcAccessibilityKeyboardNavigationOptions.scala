...
object PlotPcAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotPcAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotPcAccessibilityKeyboardNavigationOptionsOps[Self <: PlotPcAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
