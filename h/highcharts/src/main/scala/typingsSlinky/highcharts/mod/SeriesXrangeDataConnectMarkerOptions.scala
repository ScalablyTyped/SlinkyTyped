...
object SeriesXrangeDataConnectMarkerOptions {
  @scala.inline
  def apply(): SeriesXrangeDataConnectMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataConnectMarkerOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataConnectMarkerOptionsOps[Self <: SeriesXrangeDataConnectMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
