...
trait SeriesScatter3dDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesScatter3dDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesScatter3dDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesScatter3dDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesScatter3dDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesScatter3dDataDragDropOptions = {
