...
object PlotPpoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotPpoTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotPpoTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotPpoTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
