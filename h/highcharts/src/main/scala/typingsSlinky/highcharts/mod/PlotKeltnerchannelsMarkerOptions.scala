...
trait PlotKeltnerchannelsMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotKeltnerchannelsMarkerStatesOptions] = js.native
  /**
...
object PlotKeltnerchannelsMarkerOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsMarkerOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsMarkerOptionsOps[Self <: PlotKeltnerchannelsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotKeltnerchannelsMarkerStatesOptions): Self = {
        val ret = this.duplicate
