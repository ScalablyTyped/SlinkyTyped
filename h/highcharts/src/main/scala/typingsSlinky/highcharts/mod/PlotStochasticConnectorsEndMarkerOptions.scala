...
object PlotStochasticConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotStochasticConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotStochasticConnectorsEndMarkerOptionsOps[Self <: PlotStochasticConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
