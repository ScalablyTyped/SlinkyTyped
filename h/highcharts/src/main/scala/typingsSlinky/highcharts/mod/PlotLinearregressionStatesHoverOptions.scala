...
trait PlotLinearregressionStatesHoverOptions extends js.Object {
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressionStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressionStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionStatesHoverOptionsOps[Self <: PlotLinearregressionStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressionStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressionStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
