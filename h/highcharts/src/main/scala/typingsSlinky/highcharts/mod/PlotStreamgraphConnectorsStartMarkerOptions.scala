...
@js.native
trait PlotStreamgraphConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotStreamgraphConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotStreamgraphConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphConnectorsStartMarkerOptionsOps[Self <: PlotStreamgraphConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
