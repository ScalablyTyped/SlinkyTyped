...
@js.native
trait PlotErrorbarDataLabelsOptions extends js.Object {
...
object PlotErrorbarDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotErrorbarDataLabelsOptionsOps[Self <: PlotErrorbarDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotErrorbarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
