...
@js.native
trait PlotTrendlineStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotTrendlineStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotTrendlineStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotTrendlineStatesHoverHaloOptionsOps[Self <: PlotTrendlineStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
