...
@js.native
trait PlotLinearregressionangleEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionangleEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleEventsOptionsOps[Self <: PlotLinearregressionangleEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
