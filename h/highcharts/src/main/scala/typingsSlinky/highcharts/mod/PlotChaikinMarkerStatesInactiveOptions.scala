...
object PlotChaikinMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotChaikinMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotChaikinMarkerStatesInactiveOptionsOps[Self <: PlotChaikinMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
