...
trait PlotArearangeConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotArearangeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotArearangeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotArearangeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotArearangeConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotArearangeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotArearangeConnectorsMarkerOptions = null,
    startMarker: PlotArearangeConnectorsStartMarkerOptions = null,
