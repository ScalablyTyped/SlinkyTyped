...
@js.native
trait PlotArearangeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotArearangeConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotArearangeConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotArearangeConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotArearangeConnectorsOptions {
  @scala.inline
  def apply(): PlotArearangeConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeConnectorsOptions]
  }
  @scala.inline
  implicit class PlotArearangeConnectorsOptionsOps[Self <: PlotArearangeConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotArearangeConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotArearangeConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotArearangeConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
