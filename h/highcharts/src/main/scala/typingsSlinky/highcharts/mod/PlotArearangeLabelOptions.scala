...
@js.native
trait PlotArearangeLabelOptions extends js.Object {
  /**
...
object PlotArearangeLabelOptions {
  @scala.inline
  def apply(): PlotArearangeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeLabelOptions]
  }
  @scala.inline
  implicit class PlotArearangeLabelOptionsOps[Self <: PlotArearangeLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
