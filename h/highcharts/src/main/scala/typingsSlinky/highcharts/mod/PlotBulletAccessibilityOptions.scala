...
trait PlotBulletAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBulletAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBulletAccessibilityOptions {
  @scala.inline
  def apply(): PlotBulletAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBulletAccessibilityOptionsOps[Self <: PlotBulletAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBulletAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
