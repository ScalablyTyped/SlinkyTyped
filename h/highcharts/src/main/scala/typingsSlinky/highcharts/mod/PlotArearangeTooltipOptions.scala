...
@js.native
trait PlotArearangeTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotArearangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotArearangeTooltipOptions {
  @scala.inline
  def apply(): PlotArearangeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeTooltipOptions]
  }
  @scala.inline
  implicit class PlotArearangeTooltipOptionsOps[Self <: PlotArearangeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotArearangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
