...
trait PlotMacdAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMacdAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMacdAccessibilityOptions {
  @scala.inline
  def apply(): PlotMacdAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMacdAccessibilityOptionsOps[Self <: PlotMacdAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMacdAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
