...
@js.native
trait PlotSankeyDataGroupingOptions extends js.Object {
  /**
...
object PlotSankeyDataGroupingOptions {
  @scala.inline
  def apply(): PlotSankeyDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotSankeyDataGroupingOptionsOps[Self <: PlotSankeyDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
