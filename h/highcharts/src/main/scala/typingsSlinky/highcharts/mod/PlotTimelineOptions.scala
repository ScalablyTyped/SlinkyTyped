...
@js.native
trait PlotTimelineOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotTimelineAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[TimelineDataLabelsOptionsObject | js.Array[TimelineDataLabelsOptionsObject]] = js.native
...
object PlotTimelineOptions {
  ...
  @scala.inline
  implicit class PlotTimelineOptionsMutableBuilder[Self <: PlotTimelineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTimelineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: TimelineDataLabelsOptionsObject | js.Array[TimelineDataLabelsOptionsObject]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: TimelineDataLabelsOptionsObject*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
