...
object PlotTimelineOptions {
  ...
  implicit class PlotTimelineOptionsOps[Self <: PlotTimelineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTimelineAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: TimelineDataLabelsOptionsObject*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: TimelineDataLabelsOptionsObject | js.Array[TimelineDataLabelsOptionsObject]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
