...
trait SeriesNetworkgraphDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesNetworkgraphDataAccessibilityOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesNetworkgraphDataDragDropOptions] = js.native
  /**
    * (Highcharts, Highstock, Gantt) Individual point events
    */
  var events: js.UndefOr[SeriesNetworkgraphDataEventsOptions] = js.native
  /**
...
object SeriesNetworkgraphDataOptions {
  @scala.inline
  def apply(): SeriesNetworkgraphDataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesNetworkgraphDataOptions]
  }
  @scala.inline
  implicit class SeriesNetworkgraphDataOptionsOps[Self <: SeriesNetworkgraphDataOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAccessibility(value: SeriesNetworkgraphDataAccessibilityOptions): Self = {
    ...
    @scala.inline
    def withDragDrop(value: SeriesNetworkgraphDataDragDropOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEvents(value: SeriesNetworkgraphDataEventsOptions): Self = {
        val ret = this.duplicate
