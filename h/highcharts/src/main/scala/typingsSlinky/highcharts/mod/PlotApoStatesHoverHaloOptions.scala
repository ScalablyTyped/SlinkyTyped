...
@js.native
trait PlotApoStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotApoStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotApoStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotApoStatesHoverHaloOptionsOps[Self <: PlotApoStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
