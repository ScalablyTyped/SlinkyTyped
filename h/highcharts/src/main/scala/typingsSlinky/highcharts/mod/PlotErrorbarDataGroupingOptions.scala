...
object PlotErrorbarDataGroupingOptions {
  @scala.inline
  def apply(): PlotErrorbarDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotErrorbarDataGroupingOptionsOps[Self <: PlotErrorbarDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
