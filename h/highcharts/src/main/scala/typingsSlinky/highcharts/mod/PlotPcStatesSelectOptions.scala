...
trait PlotPcStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotPcStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPcStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotPcStatesSelectOptions {
  @scala.inline
  def apply(): PlotPcStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPcStatesSelectOptionsOps[Self <: PlotPcStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotPcStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPcStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
