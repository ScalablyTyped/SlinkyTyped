...
object PlotIkhMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotIkhMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotIkhMarkerStatesHoverOptionsOps[Self <: PlotIkhMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
