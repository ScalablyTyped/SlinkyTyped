...
@js.native
trait PlotVbpDataLabelsOptions extends js.Object {
...
object PlotVbpDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotVbpDataLabelsOptionsOps[Self <: PlotVbpDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVbpDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
