...
object PlotPriceenvelopesMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesMarkerStatesSelectOptionsOps[Self <: PlotPriceenvelopesMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
