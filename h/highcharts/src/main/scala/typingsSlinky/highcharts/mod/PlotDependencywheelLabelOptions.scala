...
@js.native
trait PlotDependencywheelLabelOptions extends js.Object {
  /**
...
object PlotDependencywheelLabelOptions {
  @scala.inline
  def apply(): PlotDependencywheelLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelLabelOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelLabelOptionsOps[Self <: PlotDependencywheelLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
