...
@js.native
trait PlotVbpConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVbpConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVbpConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVbpConnectorsMarkerOptionsOps[Self <: PlotVbpConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
