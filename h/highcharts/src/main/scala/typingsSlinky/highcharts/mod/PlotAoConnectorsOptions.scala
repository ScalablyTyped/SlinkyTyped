...
trait PlotAoConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAoConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAoConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAoConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAoConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotAoConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAoConnectorsMarkerOptions = null,
    startMarker: PlotAoConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAoConnectorsOptions = {
