...
object PlotMfiMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotMfiMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMfiMarkerStatesNormalOptionsOps[Self <: PlotMfiMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
