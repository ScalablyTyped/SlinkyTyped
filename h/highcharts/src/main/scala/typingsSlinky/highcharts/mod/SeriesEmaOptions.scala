...
object SeriesEmaOptions {
  ...
  @scala.inline
  implicit class SeriesEmaOptionsOps[Self <: SeriesEmaOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | ema): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
