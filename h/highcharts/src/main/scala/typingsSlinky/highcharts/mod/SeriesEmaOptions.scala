...
trait SeriesEmaOptions extends PlotEmaOptions {
...
object SeriesEmaOptions {
  ...
  @scala.inline
  def apply(`type`: String | ema): SeriesEmaOptions = {
  ...
  @scala.inline
  implicit class SeriesEmaOptionsMutableBuilder[Self <: SeriesEmaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
