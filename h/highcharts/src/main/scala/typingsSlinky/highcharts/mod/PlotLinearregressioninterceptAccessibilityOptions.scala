...
trait PlotLinearregressioninterceptAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotLinearregressioninterceptAccessibilityOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptAccessibilityOptionsOps[Self <: PlotLinearregressioninterceptAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
