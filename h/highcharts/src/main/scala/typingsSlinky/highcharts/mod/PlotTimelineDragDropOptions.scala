...
trait PlotTimelineDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotTimelineDragDropDragHandleOptions] = js.native
  /**
...
object PlotTimelineDragDropOptions {
  @scala.inline
  def apply(): PlotTimelineDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineDragDropOptions]
  }
  @scala.inline
  implicit class PlotTimelineDragDropOptionsOps[Self <: PlotTimelineDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotTimelineDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotTimelineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
