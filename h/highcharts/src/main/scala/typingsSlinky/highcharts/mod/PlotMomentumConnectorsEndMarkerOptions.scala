...
object PlotMomentumConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMomentumConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMomentumConnectorsEndMarkerOptionsOps[Self <: PlotMomentumConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
