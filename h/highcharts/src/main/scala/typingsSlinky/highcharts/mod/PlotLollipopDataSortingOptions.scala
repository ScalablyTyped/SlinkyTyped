...
@js.native
trait PlotLollipopDataSortingOptions extends js.Object {
...
object PlotLollipopDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotLollipopDataSortingOptionsOps[Self <: PlotLollipopDataSortingOptions] (val x: Self) extends AnyVal {
