...
trait PlotParetoTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotParetoTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotParetoTooltipOptions {
  @scala.inline
  def apply(): PlotParetoTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoTooltipOptions]
  }
  @scala.inline
  implicit class PlotParetoTooltipOptionsOps[Self <: PlotParetoTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotParetoTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
