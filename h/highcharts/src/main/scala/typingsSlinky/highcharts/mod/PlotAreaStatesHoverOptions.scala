...
trait PlotAreaStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreaStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreaStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotAreaStatesHoverOptions {
  @scala.inline
  def apply(): PlotAreaStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAreaStatesHoverOptionsOps[Self <: PlotAreaStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAreaStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAreaStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
