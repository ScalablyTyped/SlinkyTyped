...
@js.native
trait PlotRsiLabelOptions extends js.Object {
  /**
...
object PlotRsiLabelOptions {
  @scala.inline
  def apply(): PlotRsiLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiLabelOptions]
  }
  @scala.inline
  implicit class PlotRsiLabelOptionsOps[Self <: PlotRsiLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
