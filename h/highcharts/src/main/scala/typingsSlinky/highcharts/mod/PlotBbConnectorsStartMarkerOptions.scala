...
@js.native
trait PlotBbConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBbConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotBbConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotBbConnectorsStartMarkerOptionsOps[Self <: PlotBbConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
