...
object PlotParetoStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotParetoStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotParetoStatesSelectHaloOptionsOps[Self <: PlotParetoStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
