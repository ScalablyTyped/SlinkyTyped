...
trait PlotDependencywheelAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotDependencywheelAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotDependencywheelAccessibilityOptions {
  @scala.inline
  def apply(): PlotDependencywheelAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelAccessibilityOptionsOps[Self <: PlotDependencywheelAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotDependencywheelAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
