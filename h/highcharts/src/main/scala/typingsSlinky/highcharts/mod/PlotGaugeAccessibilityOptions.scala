...
trait PlotGaugeAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotGaugeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotGaugeAccessibilityOptions {
  @scala.inline
  def apply(): PlotGaugeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotGaugeAccessibilityOptionsOps[Self <: PlotGaugeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotGaugeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
