...
object PlotWordcloudConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotWordcloudConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotWordcloudConnectorsStartMarkerOptionsOps[Self <: PlotWordcloudConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
