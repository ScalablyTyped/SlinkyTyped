...
@js.native
trait PlotTimelineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTimelineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTimelineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTimelineConnectorsStartMarkerOptionsOps[Self <: PlotTimelineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
