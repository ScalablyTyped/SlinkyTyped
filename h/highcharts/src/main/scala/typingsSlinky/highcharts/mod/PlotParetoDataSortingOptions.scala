...
@js.native
trait PlotParetoDataSortingOptions extends js.Object {
  /**
...
object PlotParetoDataSortingOptions {
  @scala.inline
  def apply(): PlotParetoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoDataSortingOptions]
  }
  @scala.inline
  implicit class PlotParetoDataSortingOptionsOps[Self <: PlotParetoDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
