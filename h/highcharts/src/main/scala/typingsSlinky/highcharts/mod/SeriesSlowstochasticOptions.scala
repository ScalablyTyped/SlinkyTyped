...
object SeriesSlowstochasticOptions {
  ...
  @scala.inline
  implicit class SeriesSlowstochasticOptionsOps[Self <: SeriesSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | slowstochastic): Self = this.set("type", value.asInstanceOf[js.Any])
