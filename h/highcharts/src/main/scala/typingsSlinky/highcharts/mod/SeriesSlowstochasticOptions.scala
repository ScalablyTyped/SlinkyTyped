...
import typingsSlinky.highcharts.highchartsStrings.slowstochastic
...
trait SeriesSlowstochasticOptions extends PlotSlowstochasticOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | slowstochastic = js.native
...
object SeriesSlowstochasticOptions {
  
  @scala.inline
  def apply(`type`: String | slowstochastic): SeriesSlowstochasticOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesSlowstochasticOptions]
  }
  
  @scala.inline
  implicit class SeriesSlowstochasticOptionsMutableBuilder[Self <: SeriesSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | slowstochastic): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
