...
@js.native
trait NavigatorXAxisPlotLinesEventsOptions extends StObject {
...
object NavigatorXAxisPlotLinesEventsOptions {
  ...
  @scala.inline
  implicit class NavigatorXAxisPlotLinesEventsOptionsMutableBuilder[Self <: NavigatorXAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
