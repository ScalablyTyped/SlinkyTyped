...
object PlotLineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotLineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotLineConnectorsMarkerOptionsOps[Self <: PlotLineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
