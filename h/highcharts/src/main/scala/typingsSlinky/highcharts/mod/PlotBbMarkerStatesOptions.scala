...
trait PlotBbMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotBbMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotBbMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotBbMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotBbMarkerStatesSelectOptions] = js.native
}

object PlotBbMarkerStatesOptions {
  @scala.inline
  def apply(): PlotBbMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotBbMarkerStatesOptionsOps[Self <: PlotBbMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotBbMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotBbMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotBbMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotBbMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
