...
object PlotPyramid3dStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotPyramid3dStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dStatesHoverAnimationOptionsOps[Self <: PlotPyramid3dStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
