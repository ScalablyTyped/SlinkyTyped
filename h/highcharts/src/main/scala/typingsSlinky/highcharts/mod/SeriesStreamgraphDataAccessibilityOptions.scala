...
object SeriesStreamgraphDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataAccessibilityOptionsOps[Self <: SeriesStreamgraphDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
