...
trait PlotMfiMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMfiMarkerStatesOptions] = js.native
  /**
...
object PlotMfiMarkerOptions {
  @scala.inline
  def apply(): PlotMfiMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiMarkerOptions]
  }
  @scala.inline
  implicit class PlotMfiMarkerOptionsOps[Self <: PlotMfiMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotMfiMarkerStatesOptions): Self = {
        val ret = this.duplicate
