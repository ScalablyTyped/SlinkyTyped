...
trait PlotPpoAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPpoAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPpoAccessibilityOptions {
  @scala.inline
  def apply(): PlotPpoAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPpoAccessibilityOptionsOps[Self <: PlotPpoAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPpoAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
