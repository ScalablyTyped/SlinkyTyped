...
trait PlotWordcloudStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWordcloudStatesHoverAnimationOptions] = js.native
  /**
...
object PlotWordcloudStatesHoverOptions {
  @scala.inline
  def apply(): PlotWordcloudStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWordcloudStatesHoverOptionsOps[Self <: PlotWordcloudStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotWordcloudStatesHoverAnimationOptions): Self = {
