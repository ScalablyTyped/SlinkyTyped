...
trait PlotLineMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLineMarkerStatesOptions] = js.native
  /**
...
object PlotLineMarkerOptions {
  @scala.inline
  def apply(): PlotLineMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineMarkerOptions]
  }
  @scala.inline
  implicit class PlotLineMarkerOptionsOps[Self <: PlotLineMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotLineMarkerStatesOptions): Self = {
        val ret = this.duplicate
