...
object PlotCylinderConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotCylinderConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotCylinderConnectorsMarkerOptionsOps[Self <: PlotCylinderConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
