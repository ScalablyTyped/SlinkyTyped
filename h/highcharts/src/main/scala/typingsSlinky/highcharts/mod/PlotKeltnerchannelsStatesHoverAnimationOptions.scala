...
object PlotKeltnerchannelsStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesHoverAnimationOptionsOps[Self <: PlotKeltnerchannelsStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
