...
@js.native
trait PlotHeatmapDataGroupingOptions extends js.Object {
  /**
...
object PlotHeatmapDataGroupingOptions {
  @scala.inline
  def apply(): PlotHeatmapDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotHeatmapDataGroupingOptionsOps[Self <: PlotHeatmapDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
