...
object PlotSeriesMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotSeriesMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotSeriesMarkerStatesInactiveOptionsOps[Self <: PlotSeriesMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
