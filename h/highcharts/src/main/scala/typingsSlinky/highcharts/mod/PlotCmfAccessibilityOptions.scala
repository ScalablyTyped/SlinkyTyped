...
trait PlotCmfAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCmfAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotCmfAccessibilityOptions {
  @scala.inline
  def apply(): PlotCmfAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotCmfAccessibilityOptionsOps[Self <: PlotCmfAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotCmfAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
