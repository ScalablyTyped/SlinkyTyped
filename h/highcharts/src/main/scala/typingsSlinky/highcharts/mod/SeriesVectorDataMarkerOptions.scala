...
trait SeriesVectorDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesVectorDataMarkerStatesOptions] = js.native
  /**
...
object SeriesVectorDataMarkerOptions {
  @scala.inline
  def apply(): SeriesVectorDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataMarkerOptionsOps[Self <: SeriesVectorDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesVectorDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
