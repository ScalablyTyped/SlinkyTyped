...
@js.native
trait SeriesColumnDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesColumnDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesColumnDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesColumnDataDragDropDragHandleOptionsOps[Self <: SeriesColumnDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
