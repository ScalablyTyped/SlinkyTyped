...
@js.native
trait PlotTemaStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotTemaStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotTemaStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotTemaStatesHoverHaloOptionsOps[Self <: PlotTemaStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
