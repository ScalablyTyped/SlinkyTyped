...
trait PlotColumnrangeTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotColumnrangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotColumnrangeTooltipOptions {
  @scala.inline
  def apply(): PlotColumnrangeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeTooltipOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeTooltipOptionsOps[Self <: PlotColumnrangeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotColumnrangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
