...
object PlotLineStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotLineStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotLineStatesHoverHaloOptionsOps[Self <: PlotLineStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
