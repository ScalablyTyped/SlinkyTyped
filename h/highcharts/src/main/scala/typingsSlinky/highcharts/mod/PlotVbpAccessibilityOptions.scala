...
trait PlotVbpAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVbpAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVbpAccessibilityOptions {
  @scala.inline
  def apply(): PlotVbpAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVbpAccessibilityOptionsOps[Self <: PlotVbpAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVbpAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
