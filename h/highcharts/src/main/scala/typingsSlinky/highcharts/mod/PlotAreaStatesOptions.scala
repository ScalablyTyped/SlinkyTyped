...
trait PlotAreaStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotAreaStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotAreaStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotAreaStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotAreaStatesSelectOptions] = js.native
}

object PlotAreaStatesOptions {
  @scala.inline
  def apply(): PlotAreaStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaStatesOptions]
  }
  @scala.inline
  implicit class PlotAreaStatesOptionsOps[Self <: PlotAreaStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotAreaStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotAreaStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotAreaStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotAreaStatesSelectOptions): Self = {
        val ret = this.duplicate
