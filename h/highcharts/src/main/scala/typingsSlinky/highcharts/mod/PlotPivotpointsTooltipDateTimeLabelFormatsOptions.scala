...
@js.native
trait PlotPivotpointsTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPivotpointsTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotPivotpointsTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotPivotpointsTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
