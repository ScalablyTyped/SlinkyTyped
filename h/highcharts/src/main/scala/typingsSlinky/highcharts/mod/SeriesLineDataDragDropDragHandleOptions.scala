...
@js.native
trait SeriesLineDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesLineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesLineDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesLineDataDragDropDragHandleOptionsOps[Self <: SeriesLineDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
