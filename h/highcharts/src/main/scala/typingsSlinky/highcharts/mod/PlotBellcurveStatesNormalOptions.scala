...
object PlotBellcurveStatesNormalOptions {
  @scala.inline
  def apply(): PlotBellcurveStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotBellcurveStatesNormalOptionsOps[Self <: PlotBellcurveStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
