...
object SeriesLineDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesLineDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesLineDataAccessibilityOptionsOps[Self <: SeriesLineDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
