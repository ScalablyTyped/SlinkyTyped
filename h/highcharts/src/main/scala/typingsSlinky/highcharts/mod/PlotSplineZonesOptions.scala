...
@js.native
trait PlotSplineZonesOptions extends js.Object {
  /**
...
object PlotSplineZonesOptions {
  @scala.inline
  def apply(): PlotSplineZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineZonesOptions]
  }
  @scala.inline
  implicit class PlotSplineZonesOptionsOps[Self <: PlotSplineZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
