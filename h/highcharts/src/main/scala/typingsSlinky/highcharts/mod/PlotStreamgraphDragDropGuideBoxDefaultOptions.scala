...
object PlotStreamgraphDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotStreamgraphDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphDragDropGuideBoxDefaultOptionsOps[Self <: PlotStreamgraphDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
