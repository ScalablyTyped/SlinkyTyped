...
object PlotPsarConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPsarConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPsarConnectorsEndMarkerOptionsOps[Self <: PlotPsarConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
