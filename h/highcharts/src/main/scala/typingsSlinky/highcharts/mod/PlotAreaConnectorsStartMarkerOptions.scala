...
object PlotAreaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAreaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreaConnectorsStartMarkerOptionsOps[Self <: PlotAreaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
