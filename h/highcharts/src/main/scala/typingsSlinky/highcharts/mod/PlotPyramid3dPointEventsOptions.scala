...
object PlotPyramid3dPointEventsOptions {
  @scala.inline
  def apply(): PlotPyramid3dPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dPointEventsOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dPointEventsOptionsOps[Self <: PlotPyramid3dPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
