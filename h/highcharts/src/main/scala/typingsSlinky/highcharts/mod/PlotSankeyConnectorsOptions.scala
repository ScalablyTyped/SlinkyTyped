...
trait PlotSankeyConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSankeyConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSankeyConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSankeyConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSankeyConnectorsOptions {
  @scala.inline
  def apply(): PlotSankeyConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSankeyConnectorsOptionsOps[Self <: PlotSankeyConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSankeyConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSankeyConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSankeyConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
