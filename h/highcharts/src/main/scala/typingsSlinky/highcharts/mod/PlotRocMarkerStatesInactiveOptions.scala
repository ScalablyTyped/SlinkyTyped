...
object PlotRocMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotRocMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotRocMarkerStatesInactiveOptionsOps[Self <: PlotRocMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
