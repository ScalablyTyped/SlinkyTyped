...
@js.native
trait PlotLinearregressionangleMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionangleMarkerStatesOptions] = js.native
  /**
...
object PlotLinearregressionangleMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleMarkerOptionsOps[Self <: PlotLinearregressionangleMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotLinearregressionangleMarkerStatesOptions): Self = {
        val ret = this.duplicate
