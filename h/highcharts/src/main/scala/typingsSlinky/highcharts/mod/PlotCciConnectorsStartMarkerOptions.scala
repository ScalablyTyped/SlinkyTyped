...
object PlotCciConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotCciConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotCciConnectorsStartMarkerOptionsOps[Self <: PlotCciConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
