...
object PlotStochasticConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotStochasticConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotStochasticConnectorsMarkerOptionsOps[Self <: PlotStochasticConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
