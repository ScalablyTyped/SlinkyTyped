...
@js.native
trait PlotDemaConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotDemaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotDemaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotDemaConnectorsEndMarkerOptionsOps[Self <: PlotDemaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
