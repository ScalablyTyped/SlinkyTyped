...
object SeriesLineDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesLineDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesLineDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesLineDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
