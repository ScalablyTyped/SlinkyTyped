...
trait PlotLinearregressionslopeTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotLinearregressionslopeTooltipOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeTooltipOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeTooltipOptionsOps[Self <: PlotLinearregressionslopeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
