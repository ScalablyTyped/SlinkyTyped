...
object PlotBulletOptions {
  ...
  implicit class PlotBulletOptionsOps[Self <: PlotBulletOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotBulletDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotBulletDataLabelsOptions | js.Array[PlotBulletDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTargetOptions(value: PlotBulletTargetOptions): Self = this.set("targetOptions", value.asInstanceOf[js.Any])
