...
@js.native
trait PlotBulletOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBulletDataLabelsOptions | js.Array[PlotBulletDataLabelsOptions]] = js.native
...
object PlotBulletOptions {
  ...
  @scala.inline
  implicit class PlotBulletOptionsMutableBuilder[Self <: PlotBulletOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBulletAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotBulletDataLabelsOptions | js.Array[PlotBulletDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotBulletDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setTargetOptions(value: PlotBulletTargetOptions): Self = StObject.set(x, "targetOptions", value.asInstanceOf[js.Any])
