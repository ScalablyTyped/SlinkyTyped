...
object PlotSolidgaugePointEventsOptions {
  @scala.inline
  def apply(): PlotSolidgaugePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugePointEventsOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugePointEventsOptionsOps[Self <: PlotSolidgaugePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
