...
object PlotColumnrangeStatesNormalOptions {
  @scala.inline
  def apply(): PlotColumnrangeStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeStatesNormalOptionsOps[Self <: PlotColumnrangeStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
