...
trait PlotPolygonMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPolygonMarkerStatesOptions] = js.native
  /**
...
object PlotPolygonMarkerOptions {
  @scala.inline
  def apply(): PlotPolygonMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonMarkerOptions]
  }
  @scala.inline
  implicit class PlotPolygonMarkerOptionsOps[Self <: PlotPolygonMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPolygonMarkerStatesOptions): Self = {
        val ret = this.duplicate
