...
trait PlotDpoMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDpoMarkerStatesOptions] = js.native
  /**
...
object PlotDpoMarkerOptions {
  @scala.inline
  def apply(): PlotDpoMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoMarkerOptions]
  }
  @scala.inline
  implicit class PlotDpoMarkerOptionsOps[Self <: PlotDpoMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotDpoMarkerStatesOptions): Self = {
        val ret = this.duplicate
