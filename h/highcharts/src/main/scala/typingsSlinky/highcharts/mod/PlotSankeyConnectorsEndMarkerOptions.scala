...
object PlotSankeyConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSankeyConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSankeyConnectorsEndMarkerOptionsOps[Self <: PlotSankeyConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
