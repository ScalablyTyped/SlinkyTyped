...
@js.native
trait PlotLinearregressionOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotLinearregressionAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  var dataLabels: js.UndefOr[
    PlotLinearregressionDataLabelsOptions | js.Array[PlotLinearregressionDataLabelsOptions]
  ] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressionDataSortingOptions] = js.native
...
object PlotLinearregressionOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionOptionsMutableBuilder[Self <: PlotLinearregressionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotLinearregressionDataLabelsOptions | js.Array[PlotLinearregressionDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressionDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressionParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
