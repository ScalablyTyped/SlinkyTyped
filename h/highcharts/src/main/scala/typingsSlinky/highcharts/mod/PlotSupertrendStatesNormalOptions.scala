...
object PlotSupertrendStatesNormalOptions {
  @scala.inline
  def apply(): PlotSupertrendStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotSupertrendStatesNormalOptionsOps[Self <: PlotSupertrendStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
