...
object PlotColumnTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotColumnTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotColumnTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotColumnTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
