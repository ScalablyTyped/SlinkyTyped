...
object PlotCciConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotCciConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotCciConnectorsEndMarkerOptionsOps[Self <: PlotCciConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
