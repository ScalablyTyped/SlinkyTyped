...
object PlotMappointConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMappointConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMappointConnectorsStartMarkerOptionsOps[Self <: PlotMappointConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
