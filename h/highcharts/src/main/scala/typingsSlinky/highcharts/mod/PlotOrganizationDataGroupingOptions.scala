...
object PlotOrganizationDataGroupingOptions {
  @scala.inline
  def apply(): PlotOrganizationDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotOrganizationDataGroupingOptionsOps[Self <: PlotOrganizationDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
