...
@js.native
trait SeriesVariwideDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesVariwideDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesVariwideDataDataLabelsAnimationOptionsOps[Self <: SeriesVariwideDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
