...
object PlotKeltnerchannelsStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesSelectHaloOptionsOps[Self <: PlotKeltnerchannelsStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
