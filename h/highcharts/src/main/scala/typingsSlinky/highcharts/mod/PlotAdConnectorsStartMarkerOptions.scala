...
object PlotAdConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAdConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAdConnectorsStartMarkerOptionsOps[Self <: PlotAdConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
