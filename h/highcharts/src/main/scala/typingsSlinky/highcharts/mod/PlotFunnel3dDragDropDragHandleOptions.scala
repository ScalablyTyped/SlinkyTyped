...
object PlotFunnel3dDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotFunnel3dDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dDragDropDragHandleOptionsOps[Self <: PlotFunnel3dDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
