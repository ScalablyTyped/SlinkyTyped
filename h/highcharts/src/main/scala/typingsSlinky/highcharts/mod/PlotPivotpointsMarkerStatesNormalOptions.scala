...
object PlotPivotpointsMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotPivotpointsMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsMarkerStatesNormalOptionsOps[Self <: PlotPivotpointsMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
