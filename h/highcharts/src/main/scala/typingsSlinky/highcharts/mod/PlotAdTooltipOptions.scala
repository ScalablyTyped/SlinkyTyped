...
trait PlotAdTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAdTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAdTooltipOptions {
  @scala.inline
  def apply(): PlotAdTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdTooltipOptions]
  }
  @scala.inline
  implicit class PlotAdTooltipOptionsOps[Self <: PlotAdTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAdTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
