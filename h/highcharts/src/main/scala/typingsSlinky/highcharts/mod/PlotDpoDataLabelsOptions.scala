...
@js.native
trait PlotDpoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotDpoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotDpoDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotDpoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotDpoDataLabelsOptionsMutableBuilder[Self <: PlotDpoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDpoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
