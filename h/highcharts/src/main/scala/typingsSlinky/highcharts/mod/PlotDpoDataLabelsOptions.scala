...
@js.native
trait PlotDpoDataLabelsOptions extends js.Object {
...
object PlotDpoDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotDpoDataLabelsOptionsOps[Self <: PlotDpoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDpoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
