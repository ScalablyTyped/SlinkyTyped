...
@js.native
trait PlotAreasplinerangeLabelOptions extends js.Object {
  /**
...
object PlotAreasplinerangeLabelOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeLabelOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeLabelOptionsOps[Self <: PlotAreasplinerangeLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
