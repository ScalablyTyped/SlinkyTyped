...
object PlotAtrConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAtrConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAtrConnectorsEndMarkerOptionsOps[Self <: PlotAtrConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
