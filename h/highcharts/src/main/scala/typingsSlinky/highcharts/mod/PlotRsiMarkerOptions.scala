...
trait PlotRsiMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRsiMarkerStatesOptions] = js.native
  /**
...
object PlotRsiMarkerOptions {
  @scala.inline
  def apply(): PlotRsiMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerOptionsOps[Self <: PlotRsiMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotRsiMarkerStatesOptions): Self = {
        val ret = this.duplicate
