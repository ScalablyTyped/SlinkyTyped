...
trait PlotAreasplineMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplineMarkerStatesOptions] = js.native
  /**
...
object PlotAreasplineMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplineMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplineMarkerOptionsOps[Self <: PlotAreasplineMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAreasplineMarkerStatesOptions): Self = {
        val ret = this.duplicate
