...
@js.native
trait PlotRsiZonesOptions extends js.Object {
  /**
...
object PlotRsiZonesOptions {
  @scala.inline
  def apply(): PlotRsiZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiZonesOptions]
  }
  @scala.inline
  implicit class PlotRsiZonesOptionsOps[Self <: PlotRsiZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
