...
object PlotTimelineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotTimelineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotTimelineConnectorsMarkerOptionsOps[Self <: PlotTimelineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
