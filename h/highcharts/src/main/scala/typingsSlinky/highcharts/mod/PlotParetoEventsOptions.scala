...
@js.native
trait PlotParetoEventsOptions extends js.Object {
  /**
...
object PlotParetoEventsOptions {
  @scala.inline
  def apply(): PlotParetoEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoEventsOptions]
  }
  @scala.inline
  implicit class PlotParetoEventsOptionsOps[Self <: PlotParetoEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
