...
object NavigatorYAxisDateTimeLabelFormatsDayOptions {
  @scala.inline
  def apply(): NavigatorYAxisDateTimeLabelFormatsDayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisDateTimeLabelFormatsDayOptions]
  }
  @scala.inline
  implicit class NavigatorYAxisDateTimeLabelFormatsDayOptionsOps[Self <: NavigatorYAxisDateTimeLabelFormatsDayOptions] (val x: Self) extends AnyVal {
    @scala.inline
