...
trait PlotWaterfallConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWaterfallConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWaterfallConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWaterfallConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotWaterfallConnectorsOptions {
  @scala.inline
  def apply(): PlotWaterfallConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallConnectorsOptions]
  }
  @scala.inline
  implicit class PlotWaterfallConnectorsOptionsOps[Self <: PlotWaterfallConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotWaterfallConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotWaterfallConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotWaterfallConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
