...
@js.native
trait PlotMomentumDataSortingOptions extends js.Object {
  /**
...
object PlotMomentumDataSortingOptions {
  @scala.inline
  def apply(): PlotMomentumDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumDataSortingOptions]
  }
  @scala.inline
  implicit class PlotMomentumDataSortingOptionsOps[Self <: PlotMomentumDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
