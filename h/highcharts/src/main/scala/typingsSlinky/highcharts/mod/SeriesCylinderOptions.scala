...
trait SeriesCylinderOptions extends PlotCylinderOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | cylinder = js.native
...
object SeriesCylinderOptions {
  ...
  @scala.inline
  def apply(`type`: String | cylinder): SeriesCylinderOptions = {
  ...
  @scala.inline
  implicit class SeriesCylinderOptionsMutableBuilder[Self <: SeriesCylinderOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | cylinder): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
