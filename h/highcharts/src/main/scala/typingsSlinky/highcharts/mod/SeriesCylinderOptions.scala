...
object SeriesCylinderOptions {
  ...
  @scala.inline
  implicit class SeriesCylinderOptionsOps[Self <: SeriesCylinderOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | cylinder): Self = this.set("type", value.asInstanceOf[js.Any])
