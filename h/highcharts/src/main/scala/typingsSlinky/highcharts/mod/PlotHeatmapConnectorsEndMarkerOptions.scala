...
object PlotHeatmapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotHeatmapConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotHeatmapConnectorsEndMarkerOptionsOps[Self <: PlotHeatmapConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
