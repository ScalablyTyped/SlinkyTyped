...
object PlotTilemapStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotTilemapStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotTilemapStatesSelectAnimationOptionsOps[Self <: PlotTilemapStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
