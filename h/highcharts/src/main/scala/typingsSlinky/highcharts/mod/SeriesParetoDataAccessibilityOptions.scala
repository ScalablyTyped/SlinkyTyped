...
object SeriesParetoDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesParetoDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesParetoDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesParetoDataAccessibilityOptionsOps[Self <: SeriesParetoDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
