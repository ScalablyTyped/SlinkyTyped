...
@js.native
trait PlotArearangeDataSortingOptions extends StObject {
...
object PlotArearangeDataSortingOptions {
  
  @scala.inline
  def apply(): PlotArearangeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotArearangeDataSortingOptionsMutableBuilder[Self <: PlotArearangeDataSortingOptions] (val x: Self) extends AnyVal {
