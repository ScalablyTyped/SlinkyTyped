...
@js.native
trait PlotArearangeDataSortingOptions extends js.Object {
  /**
...
object PlotArearangeDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotArearangeDataSortingOptionsOps[Self <: PlotArearangeDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
