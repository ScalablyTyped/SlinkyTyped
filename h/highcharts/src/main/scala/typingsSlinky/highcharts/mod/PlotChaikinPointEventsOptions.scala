...
@js.native
trait PlotChaikinPointEventsOptions extends js.Object {
  /**
...
object PlotChaikinPointEventsOptions {
  @scala.inline
  def apply(): PlotChaikinPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinPointEventsOptions]
  }
  @scala.inline
  implicit class PlotChaikinPointEventsOptionsOps[Self <: PlotChaikinPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
