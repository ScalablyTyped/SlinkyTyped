...
object AnnotationsElliottWaveTypeOptions {
  ...
  implicit class AnnotationsElliottWaveTypeOptionsOps[Self <: AnnotationsElliottWaveTypeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLine(value: AnnotationsElliottWaveTypeLineOptions): Self = this.set("line", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLine: Self = this.set("line", js.undefined)
    
    @scala.inline
    def setPointsVarargs(value: AnnotationsElliottWaveTypePointsOptions*): Self = this.set("points", js.Array(value :_*))
    
    @scala.inline
    def setPoints(value: js.Array[AnnotationsElliottWaveTypePointsOptions]): Self = this.set("points", value.asInstanceOf[js.Any])
