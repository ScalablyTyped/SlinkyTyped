...
trait PlotParetoStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotParetoStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotParetoStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotParetoStatesHoverOptions {
  @scala.inline
  def apply(): PlotParetoStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotParetoStatesHoverOptionsOps[Self <: PlotParetoStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotParetoStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotParetoStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
