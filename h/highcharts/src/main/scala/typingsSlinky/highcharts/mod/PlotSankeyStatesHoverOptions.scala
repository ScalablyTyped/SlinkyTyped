...
trait PlotSankeyStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSankeyStatesHoverAnimationOptions] = js.native
  /**
...
object PlotSankeyStatesHoverOptions {
  @scala.inline
  def apply(): PlotSankeyStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSankeyStatesHoverOptionsOps[Self <: PlotSankeyStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSankeyStatesHoverAnimationOptions): Self = {
