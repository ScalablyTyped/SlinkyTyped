...
trait PlotTimelineAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTimelineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTimelineAccessibilityOptions {
  @scala.inline
  def apply(): PlotTimelineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTimelineAccessibilityOptionsOps[Self <: PlotTimelineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTimelineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
