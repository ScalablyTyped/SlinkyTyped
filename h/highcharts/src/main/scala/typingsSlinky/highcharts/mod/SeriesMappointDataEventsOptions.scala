...
object SeriesMappointDataEventsOptions {
  @scala.inline
  def apply(): SeriesMappointDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMappointDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesMappointDataEventsOptionsOps[Self <: SeriesMappointDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
