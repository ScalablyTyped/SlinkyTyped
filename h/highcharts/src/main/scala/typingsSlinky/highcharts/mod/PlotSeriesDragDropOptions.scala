...
@js.native
trait PlotSeriesDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock, Highmaps, Gantt) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSeriesDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSeriesDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotSeriesDragDropOptions {
  @scala.inline
  def apply(): PlotSeriesDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDragDropOptions]
  }
  @scala.inline
  implicit class PlotSeriesDragDropOptionsOps[Self <: PlotSeriesDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotSeriesDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotSeriesDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
