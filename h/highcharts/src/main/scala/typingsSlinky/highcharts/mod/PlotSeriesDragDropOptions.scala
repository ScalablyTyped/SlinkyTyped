...
trait PlotSeriesDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotSeriesDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotSeriesDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSeriesDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSeriesDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotSeriesDragDropOptions = {
