...
trait SeriesPolygonDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesPolygonDataMarkerStatesOptions] = js.native
  /**
...
object SeriesPolygonDataMarkerOptions {
  @scala.inline
  def apply(): SeriesPolygonDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataMarkerOptionsOps[Self <: SeriesPolygonDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesPolygonDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
