...
trait PlotIkhTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotIkhTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotIkhTooltipOptions {
  @scala.inline
  def apply(): PlotIkhTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhTooltipOptions]
  }
  @scala.inline
  implicit class PlotIkhTooltipOptionsOps[Self <: PlotIkhTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotIkhTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
