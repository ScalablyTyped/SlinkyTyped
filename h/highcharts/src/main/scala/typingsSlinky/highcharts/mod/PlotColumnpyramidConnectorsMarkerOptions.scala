...
object PlotColumnpyramidConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotColumnpyramidConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidConnectorsMarkerOptionsOps[Self <: PlotColumnpyramidConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
