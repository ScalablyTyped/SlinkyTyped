...
object SeriesPieDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesPieDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPieDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesPieDataDragDropDragHandleOptionsOps[Self <: SeriesPieDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
