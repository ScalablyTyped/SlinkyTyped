...
@js.native
trait SeriesColumnrangeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesColumnrangeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesColumnrangeDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnrangeDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesColumnrangeDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesColumnrangeDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
