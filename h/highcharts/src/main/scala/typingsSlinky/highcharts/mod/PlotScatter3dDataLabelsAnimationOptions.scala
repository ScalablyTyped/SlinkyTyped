...
@js.native
trait PlotScatter3dDataLabelsAnimationOptions extends js.Object {
...
object PlotScatter3dDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotScatter3dDataLabelsAnimationOptionsOps[Self <: PlotScatter3dDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
