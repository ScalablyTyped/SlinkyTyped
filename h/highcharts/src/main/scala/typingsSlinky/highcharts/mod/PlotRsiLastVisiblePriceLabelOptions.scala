...
object PlotRsiLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotRsiLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotRsiLastVisiblePriceLabelOptionsOps[Self <: PlotRsiLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
