...
trait PlotPyramidAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPyramidAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPyramidAccessibilityOptions {
  @scala.inline
  def apply(): PlotPyramidAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPyramidAccessibilityOptionsOps[Self <: PlotPyramidAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPyramidAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
