...
object SeriesTilemapDataEventsOptions {
  @scala.inline
  def apply(): SeriesTilemapDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTilemapDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesTilemapDataEventsOptionsOps[Self <: SeriesTilemapDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
