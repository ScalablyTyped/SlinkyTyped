...
trait PlotHistogramConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotHistogramConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotHistogramConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotHistogramConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotHistogramConnectorsOptions {
  @scala.inline
  def apply(): PlotHistogramConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramConnectorsOptions]
  }
  @scala.inline
  implicit class PlotHistogramConnectorsOptionsOps[Self <: PlotHistogramConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotHistogramConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotHistogramConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotHistogramConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
