...
object PlotMaplineStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotMaplineStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotMaplineStatesSelectHaloOptionsOps[Self <: PlotMaplineStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
