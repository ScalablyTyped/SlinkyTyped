...
@js.native
trait PlotLinearregressionangleStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotLinearregressionangleStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleStatesHoverHaloOptionsOps[Self <: PlotLinearregressionangleStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
