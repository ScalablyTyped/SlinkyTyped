...
trait PlotSankeyStatesInactiveOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[PlotSankeyStatesInactiveAnimationOptions] = js.native
  /**
...
object PlotSankeyStatesInactiveOptions {
  @scala.inline
  def apply(): PlotSankeyStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotSankeyStatesInactiveOptionsOps[Self <: PlotSankeyStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotSankeyStatesInactiveAnimationOptions): Self = {
