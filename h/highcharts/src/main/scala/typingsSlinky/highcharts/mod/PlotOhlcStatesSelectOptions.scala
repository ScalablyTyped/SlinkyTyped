...
trait PlotOhlcStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotOhlcStatesSelectAnimationOptions] = js.native
  /**
...
object PlotOhlcStatesSelectOptions {
  @scala.inline
  def apply(): PlotOhlcStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotOhlcStatesSelectOptionsOps[Self <: PlotOhlcStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotOhlcStatesSelectAnimationOptions): Self = {
