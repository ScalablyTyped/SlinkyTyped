...
object PlotScatterLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotScatterLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotScatterLastVisiblePriceLabelOptionsOps[Self <: PlotScatterLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
