...
object PlotPcMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPcMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPcMarkerStatesSelectOptionsOps[Self <: PlotPcMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
