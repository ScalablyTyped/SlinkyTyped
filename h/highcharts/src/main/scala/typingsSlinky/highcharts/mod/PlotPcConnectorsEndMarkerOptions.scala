...
@js.native
trait PlotPcConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPcConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPcConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPcConnectorsEndMarkerOptionsOps[Self <: PlotPcConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
