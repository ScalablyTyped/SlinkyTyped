...
@js.native
trait PlotVariablepieStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotVariablepieStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVariablepieStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotVariablepieStatesSelectOptions {
  @scala.inline
  def apply(): PlotVariablepieStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotVariablepieStatesSelectOptionsOps[Self <: PlotVariablepieStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotVariablepieStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotVariablepieStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
