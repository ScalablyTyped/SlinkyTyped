...
@js.native
trait PlotAreasplinePointEventsOptions extends js.Object {
  /**
...
object PlotAreasplinePointEventsOptions {
  @scala.inline
  def apply(): PlotAreasplinePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinePointEventsOptions]
  }
  @scala.inline
  implicit class PlotAreasplinePointEventsOptionsOps[Self <: PlotAreasplinePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
