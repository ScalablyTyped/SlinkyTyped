...
object SeriesXrangeDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesXrangeDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataMarkerStatesSelectOptionsOps[Self <: SeriesXrangeDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
