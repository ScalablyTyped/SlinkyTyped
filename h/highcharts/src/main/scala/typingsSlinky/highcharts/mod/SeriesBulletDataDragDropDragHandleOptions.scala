...
object SeriesBulletDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesBulletDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBulletDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesBulletDataDragDropDragHandleOptionsOps[Self <: SeriesBulletDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
