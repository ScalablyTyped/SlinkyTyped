...
@js.native
trait PlotScatter3dTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotScatter3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotScatter3dTooltipOptions {
  @scala.inline
  def apply(): PlotScatter3dTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dTooltipOptions]
  }
  @scala.inline
  implicit class PlotScatter3dTooltipOptionsOps[Self <: PlotScatter3dTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotScatter3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
