...
@js.native
trait PlotSupertrendDataLabelsOptions extends js.Object {
...
object PlotSupertrendDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotSupertrendDataLabelsOptionsOps[Self <: PlotSupertrendDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSupertrendDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
