...
trait PlotPpoTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPpoTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPpoTooltipOptions {
  @scala.inline
  def apply(): PlotPpoTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoTooltipOptions]
  }
  @scala.inline
  implicit class PlotPpoTooltipOptionsOps[Self <: PlotPpoTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPpoTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
