...
trait XAxisCurrentDateIndicatorOptions extends js.Object {
  ...
  /**
    ...
    */
  var events: js.UndefOr[XAxisCurrentDateIndicatorEventsOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[XAxisCurrentDateIndicatorLabelOptions] = js.native
  /**
...
object XAxisCurrentDateIndicatorOptions {
  @scala.inline
  def apply(): XAxisCurrentDateIndicatorOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisCurrentDateIndicatorOptions]
  }
  @scala.inline
  implicit class XAxisCurrentDateIndicatorOptionsOps[Self <: XAxisCurrentDateIndicatorOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEvents(value: XAxisCurrentDateIndicatorEventsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: XAxisCurrentDateIndicatorLabelOptions): Self = {
        val ret = this.duplicate
