...
object PlotLinearregressionAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotLinearregressionAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionAccessibilityKeyboardNavigationOptionsOps[Self <: PlotLinearregressionAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
