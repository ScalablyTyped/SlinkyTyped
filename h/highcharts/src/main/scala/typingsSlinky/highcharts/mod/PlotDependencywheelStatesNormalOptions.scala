...
object PlotDependencywheelStatesNormalOptions {
  @scala.inline
  def apply(): PlotDependencywheelStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelStatesNormalOptionsOps[Self <: PlotDependencywheelStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
