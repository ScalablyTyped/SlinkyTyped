...
object PlotLinearregressionangleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleConnectorsStartMarkerOptionsOps[Self <: PlotLinearregressionangleConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
