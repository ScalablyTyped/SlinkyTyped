...
object PlotApoMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotApoMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotApoMarkerStatesHoverOptionsOps[Self <: PlotApoMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
