...
@js.native
trait PlotEmaEventsOptions extends js.Object {
  /**
...
object PlotEmaEventsOptions {
  @scala.inline
  def apply(): PlotEmaEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaEventsOptions]
  }
  @scala.inline
  implicit class PlotEmaEventsOptionsOps[Self <: PlotEmaEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
