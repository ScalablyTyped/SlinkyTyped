...
object PlotVariwideDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotVariwideDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotVariwideDragDropGuideBoxDefaultOptionsOps[Self <: PlotVariwideDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
