...
@js.native
trait PlotBoxplotTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBoxplotTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotBoxplotTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotBoxplotTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotBoxplotTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
