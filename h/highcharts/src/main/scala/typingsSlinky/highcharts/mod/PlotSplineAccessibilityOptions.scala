...
trait PlotSplineAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSplineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSplineAccessibilityOptions {
  @scala.inline
  def apply(): PlotSplineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSplineAccessibilityOptionsOps[Self <: PlotSplineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSplineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
