...
object PlotWordcloudStatesNormalOptions {
  @scala.inline
  def apply(): PlotWordcloudStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotWordcloudStatesNormalOptionsOps[Self <: PlotWordcloudStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
