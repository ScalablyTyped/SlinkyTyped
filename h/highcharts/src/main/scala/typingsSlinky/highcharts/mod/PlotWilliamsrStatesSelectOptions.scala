...
trait PlotWilliamsrStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotWilliamsrStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWilliamsrStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotWilliamsrStatesSelectOptions {
  @scala.inline
  def apply(): PlotWilliamsrStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrStatesSelectOptionsOps[Self <: PlotWilliamsrStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotWilliamsrStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotWilliamsrStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
