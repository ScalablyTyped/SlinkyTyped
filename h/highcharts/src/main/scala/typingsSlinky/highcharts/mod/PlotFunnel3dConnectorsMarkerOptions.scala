...
object PlotFunnel3dConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotFunnel3dConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dConnectorsMarkerOptionsOps[Self <: PlotFunnel3dConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
