...
@js.native
trait PlotPsarConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPsarConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPsarConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPsarConnectorsMarkerOptionsOps[Self <: PlotPsarConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
