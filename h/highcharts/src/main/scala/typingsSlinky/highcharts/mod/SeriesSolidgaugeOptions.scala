...
trait SeriesSolidgaugeOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesSolidgaugeDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesSolidgaugeOptions {
  ...
  @scala.inline
  implicit class SeriesSolidgaugeOptionsOps[Self <: SeriesSolidgaugeOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withType(value: String | solidgauge): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | Null | SeriesSolidgaugeDataOptions]): Self = {
        val ret = this.duplicate
