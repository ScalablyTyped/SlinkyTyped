...
object PlotMappointConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMappointConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMappointConnectorsMarkerOptionsOps[Self <: PlotMappointConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
