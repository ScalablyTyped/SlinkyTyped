...
object PlotColumnrangeLastPriceOptions {
  @scala.inline
  def apply(): PlotColumnrangeLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeLastPriceOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeLastPriceOptionsOps[Self <: PlotColumnrangeLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
