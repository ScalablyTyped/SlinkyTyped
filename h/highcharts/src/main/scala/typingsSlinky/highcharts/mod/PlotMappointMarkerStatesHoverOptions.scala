...
object PlotMappointMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotMappointMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMappointMarkerStatesHoverOptionsOps[Self <: PlotMappointMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
