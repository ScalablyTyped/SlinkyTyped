...
@js.native
trait PlotErrorbarConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotErrorbarConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotErrorbarConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotErrorbarConnectorsEndMarkerOptionsOps[Self <: PlotErrorbarConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
