...
@js.native
trait PlotNetworkgraphConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotNetworkgraphConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotNetworkgraphConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphConnectorsMarkerOptionsOps[Self <: PlotNetworkgraphConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
