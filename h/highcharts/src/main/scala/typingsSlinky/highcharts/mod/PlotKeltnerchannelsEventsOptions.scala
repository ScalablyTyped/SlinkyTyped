...
@js.native
trait PlotKeltnerchannelsEventsOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsEventsOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsEventsOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsEventsOptionsOps[Self <: PlotKeltnerchannelsEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
