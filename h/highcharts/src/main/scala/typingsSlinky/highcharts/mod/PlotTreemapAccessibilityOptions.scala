...
trait PlotTreemapAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTreemapAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTreemapAccessibilityOptions {
  @scala.inline
  def apply(): PlotTreemapAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTreemapAccessibilityOptionsOps[Self <: PlotTreemapAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTreemapAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
