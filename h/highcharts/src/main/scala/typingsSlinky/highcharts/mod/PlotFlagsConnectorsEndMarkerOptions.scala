...
object PlotFlagsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotFlagsConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotFlagsConnectorsEndMarkerOptionsOps[Self <: PlotFlagsConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
