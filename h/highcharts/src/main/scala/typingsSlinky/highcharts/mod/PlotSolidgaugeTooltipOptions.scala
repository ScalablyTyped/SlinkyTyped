...
trait PlotSolidgaugeTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotSolidgaugeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotSolidgaugeTooltipOptions {
  @scala.inline
  def apply(): PlotSolidgaugeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeTooltipOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeTooltipOptionsOps[Self <: PlotSolidgaugeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotSolidgaugeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
