...
trait PlotWilliamsrStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWilliamsrStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotWilliamsrStatesHoverOptions {
  @scala.inline
  def apply(): PlotWilliamsrStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrStatesHoverOptionsOps[Self <: PlotWilliamsrStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotWilliamsrStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
