...
@js.native
trait PlotLineStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotLineStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotLineStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotLineStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotLineStatesSelectOptions] = js.native
}

object PlotLineStatesOptions {
  @scala.inline
  def apply(): PlotLineStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineStatesOptions]
  }
  @scala.inline
  implicit class PlotLineStatesOptionsOps[Self <: PlotLineStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotLineStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotLineStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotLineStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotLineStatesSelectOptions): Self = {
        val ret = this.duplicate
