...
trait InstrumentOptionsObject extends StObject {
  ...
  var oscillator: js.UndefOr[
    typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.OscillatorOptionsObject
  ] = js.native
...
object InstrumentOptionsObject {
  ...
  implicit class InstrumentOptionsObjectMutableBuilder[Self <: InstrumentOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOscillator(value: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.OscillatorOptionsObject): Self = StObject.set(x, "oscillator", value.asInstanceOf[js.Any])
