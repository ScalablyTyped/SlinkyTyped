...
object InstrumentOptionsObject {
  ...
  implicit class InstrumentOptionsObjectOps[Self <: InstrumentOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOscillator(value: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.OscillatorOptionsObject): Self = this.set("oscillator", value.asInstanceOf[js.Any])
