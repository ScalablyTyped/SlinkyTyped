...
trait PlotCmfStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotCmfStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCmfStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotCmfStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotCmfStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: js.UndefOr[Double] = js.undefined,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: js.UndefOr[Null | PlotCmfStatesSelectHaloOptions] = js.undefined,
    lineWidth: js.UndefOr[Double] = js.undefined,
    lineWidthPlus: js.UndefOr[Double] = js.undefined
  ): PlotCmfStatesSelectOptions = {
