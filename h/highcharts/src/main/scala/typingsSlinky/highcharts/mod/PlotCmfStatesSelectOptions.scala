...
@js.native
trait PlotCmfStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotCmfStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCmfStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotCmfStatesSelectOptions {
  @scala.inline
  def apply(): PlotCmfStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotCmfStatesSelectOptionsOps[Self <: PlotCmfStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotCmfStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotCmfStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
