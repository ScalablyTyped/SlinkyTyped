...
trait PlotNetworkgraphStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNetworkgraphStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotNetworkgraphStatesHoverOptions {
  @scala.inline
  def apply(): PlotNetworkgraphStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphStatesHoverOptionsOps[Self <: PlotNetworkgraphStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotNetworkgraphStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
