...
object PlotRocMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotRocMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotRocMarkerStatesHoverOptionsOps[Self <: PlotRocMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
