...
object PlotGanttConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotGanttConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotGanttConnectorsMarkerOptionsOps[Self <: PlotGanttConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
