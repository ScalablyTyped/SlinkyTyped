...
object ChartParallelAxesDateTimeLabelFormatsDayOptions {
  @scala.inline
  def apply(): ChartParallelAxesDateTimeLabelFormatsDayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesDateTimeLabelFormatsDayOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesDateTimeLabelFormatsDayOptionsOps[Self <: ChartParallelAxesDateTimeLabelFormatsDayOptions] (val x: Self) extends AnyVal {
    @scala.inline
