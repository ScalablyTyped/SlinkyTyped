...
@js.native
trait PlotHistogramConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotHistogramConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotHistogramConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotHistogramConnectorsStartMarkerOptionsOps[Self <: PlotHistogramConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
