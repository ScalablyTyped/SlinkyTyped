...
object PlotMappointMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotMappointMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMappointMarkerStatesNormalOptionsOps[Self <: PlotMappointMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
