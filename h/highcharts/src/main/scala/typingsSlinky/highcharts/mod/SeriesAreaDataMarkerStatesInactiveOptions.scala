...
object SeriesAreaDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesAreaDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataMarkerStatesInactiveOptionsOps[Self <: SeriesAreaDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
