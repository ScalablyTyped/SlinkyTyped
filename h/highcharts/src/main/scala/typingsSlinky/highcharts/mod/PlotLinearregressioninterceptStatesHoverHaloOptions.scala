...
object PlotLinearregressioninterceptStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptStatesHoverHaloOptionsOps[Self <: PlotLinearregressioninterceptStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
