...
@js.native
trait PlotArearangeStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotArearangeStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotArearangeStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotArearangeStatesSelectHaloOptionsOps[Self <: PlotArearangeStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
