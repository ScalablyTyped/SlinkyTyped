...
@js.native
trait PlotTimelinePointEventsOptions extends js.Object {
  /**
...
object PlotTimelinePointEventsOptions {
  @scala.inline
  def apply(): PlotTimelinePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelinePointEventsOptions]
  }
  @scala.inline
  implicit class PlotTimelinePointEventsOptionsOps[Self <: PlotTimelinePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
