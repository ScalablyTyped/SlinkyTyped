...
object PlotVwapConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVwapConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVwapConnectorsMarkerOptionsOps[Self <: PlotVwapConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
