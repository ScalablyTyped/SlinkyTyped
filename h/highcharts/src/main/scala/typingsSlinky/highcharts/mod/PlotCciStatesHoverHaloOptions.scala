...
@js.native
trait PlotCciStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotCciStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotCciStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotCciStatesHoverHaloOptionsOps[Self <: PlotCciStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
