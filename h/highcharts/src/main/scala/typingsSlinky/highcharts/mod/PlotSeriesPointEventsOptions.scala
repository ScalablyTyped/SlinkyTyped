...
@js.native
trait PlotSeriesPointEventsOptions extends js.Object {
  /**
...
object PlotSeriesPointEventsOptions {
  @scala.inline
  def apply(): PlotSeriesPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesPointEventsOptions]
  }
  @scala.inline
  implicit class PlotSeriesPointEventsOptionsOps[Self <: PlotSeriesPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
