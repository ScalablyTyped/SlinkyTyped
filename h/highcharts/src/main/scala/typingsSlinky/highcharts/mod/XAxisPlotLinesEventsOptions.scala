...
@js.native
trait XAxisPlotLinesEventsOptions extends js.Object {
...
object XAxisPlotLinesEventsOptions {
  ...
  @scala.inline
  implicit class XAxisPlotLinesEventsOptionsOps[Self <: XAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
