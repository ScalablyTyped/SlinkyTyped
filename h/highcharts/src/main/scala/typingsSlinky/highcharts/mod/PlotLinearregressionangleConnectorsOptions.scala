...
@js.native
trait PlotLinearregressionangleConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLinearregressionangleConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionangleConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLinearregressionangleConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotLinearregressionangleConnectorsOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleConnectorsOptionsOps[Self <: PlotLinearregressionangleConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotLinearregressionangleConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotLinearregressionangleConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotLinearregressionangleConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
