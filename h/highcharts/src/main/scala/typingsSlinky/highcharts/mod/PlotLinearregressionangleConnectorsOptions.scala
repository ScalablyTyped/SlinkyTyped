...
trait PlotLinearregressionangleConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLinearregressionangleConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionangleConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLinearregressionangleConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotLinearregressionangleConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotLinearregressionangleConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotLinearregressionangleConnectorsMarkerOptions = null,
    startMarker: PlotLinearregressionangleConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotLinearregressionangleConnectorsOptions = {
