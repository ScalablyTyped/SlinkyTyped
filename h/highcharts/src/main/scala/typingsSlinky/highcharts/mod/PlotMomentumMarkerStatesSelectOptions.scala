...
object PlotMomentumMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotMomentumMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMomentumMarkerStatesSelectOptionsOps[Self <: PlotMomentumMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
