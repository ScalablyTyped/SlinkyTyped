...
trait PlotSplineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSplineConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSplineConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSplineConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSplineConnectorsOptions {
  @scala.inline
  def apply(): PlotSplineConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSplineConnectorsOptionsOps[Self <: PlotSplineConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSplineConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSplineConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSplineConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
