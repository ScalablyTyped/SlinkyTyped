...
@js.native
trait NavigatorYAxisGridOptions extends StObject {
...
object NavigatorYAxisGridOptions {
  ...
  @scala.inline
  implicit class NavigatorYAxisGridOptionsMutableBuilder[Self <: NavigatorYAxisGridOptions] (val x: Self) extends AnyVal {
