...
@js.native
trait PlotVennDataLabelsAnimationOptions extends js.Object {
...
object PlotVennDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotVennDataLabelsAnimationOptionsOps[Self <: PlotVennDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
