...
@js.native
trait PlotMappointStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMappointStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMappointStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotMappointStatesHoverOptions {
  @scala.inline
  def apply(): PlotMappointStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMappointStatesHoverOptionsOps[Self <: PlotMappointStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMappointStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMappointStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
