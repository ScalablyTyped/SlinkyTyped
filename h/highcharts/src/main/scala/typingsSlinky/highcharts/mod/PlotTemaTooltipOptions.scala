...
trait PlotTemaTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTemaTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotTemaTooltipOptions {
  @scala.inline
  def apply(): PlotTemaTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaTooltipOptions]
  }
  @scala.inline
  implicit class PlotTemaTooltipOptionsOps[Self <: PlotTemaTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotTemaTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
