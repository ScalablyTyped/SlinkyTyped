...
object PlotAroonoscillatorMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorMarkerStatesSelectOptionsOps[Self <: PlotAroonoscillatorMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
