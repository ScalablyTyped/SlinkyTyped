...
@js.native
trait PlotNatrConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotNatrConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotNatrConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotNatrConnectorsEndMarkerOptionsOps[Self <: PlotNatrConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
