...
@js.native
trait NavigationAnnotationsShapesPointsOptions extends js.Object {
  /**
...
object NavigationAnnotationsShapesPointsOptions {
  @scala.inline
  def apply(): NavigationAnnotationsShapesPointsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigationAnnotationsShapesPointsOptions]
  }
  @scala.inline
  implicit class NavigationAnnotationsShapesPointsOptionsOps[Self <: NavigationAnnotationsShapesPointsOptions] (val x: Self) extends AnyVal {
    @scala.inline
