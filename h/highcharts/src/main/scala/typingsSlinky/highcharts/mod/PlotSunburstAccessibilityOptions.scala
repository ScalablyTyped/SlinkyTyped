...
@js.native
trait PlotSunburstAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSunburstAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSunburstAccessibilityOptions {
  @scala.inline
  def apply(): PlotSunburstAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSunburstAccessibilityOptionsOps[Self <: PlotSunburstAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSunburstAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
