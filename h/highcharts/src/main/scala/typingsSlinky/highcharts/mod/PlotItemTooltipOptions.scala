...
trait PlotItemTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotItemTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotItemTooltipOptions {
  @scala.inline
  def apply(): PlotItemTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemTooltipOptions]
  }
  @scala.inline
  implicit class PlotItemTooltipOptionsOps[Self <: PlotItemTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotItemTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
