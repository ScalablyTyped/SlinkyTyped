...
trait SeriesGanttOptions
  extends PlotGanttOptions
     with SeriesOptionsType {
  /**
    * (Gantt) Data for a Gantt series.
    */
  var data: js.UndefOr[js.Array[SeriesGanttDataOptions]] = js.native
  /**
...
object SeriesGanttOptions {
  ...
  implicit class SeriesGanttOptionsOps[Self <: SeriesGanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | gantt): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[SeriesGanttDataOptions]): Self = {
        val ret = this.duplicate
