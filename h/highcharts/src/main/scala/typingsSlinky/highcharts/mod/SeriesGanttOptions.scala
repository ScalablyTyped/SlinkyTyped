...
trait SeriesGanttOptions extends PlotGanttOptions {
  
  /**
    * (Gantt) Data for a Gantt series.
    */
  var data: js.UndefOr[js.Array[GanttPointOptionsObject]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | gantt = js.native
...
object SeriesGanttOptions {
  ...
  @scala.inline
  def apply(`type`: String | gantt): SeriesGanttOptions = {
  ...
  @scala.inline
  implicit class SeriesGanttOptionsMutableBuilder[Self <: SeriesGanttOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[GanttPointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: GanttPointOptionsObject*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | gantt): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
