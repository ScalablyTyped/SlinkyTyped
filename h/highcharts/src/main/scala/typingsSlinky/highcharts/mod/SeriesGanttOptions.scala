...
object SeriesGanttOptions {
  ...
  @scala.inline
  implicit class SeriesGanttOptionsOps[Self <: SeriesGanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | gantt): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: GanttPointOptionsObject*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[GanttPointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
