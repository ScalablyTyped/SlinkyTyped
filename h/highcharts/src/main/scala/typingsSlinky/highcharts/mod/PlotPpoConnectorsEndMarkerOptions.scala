...
object PlotPpoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPpoConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPpoConnectorsEndMarkerOptionsOps[Self <: PlotPpoConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
