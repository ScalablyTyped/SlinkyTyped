...
trait PlotAbandsStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAbandsStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAbandsStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotAbandsStatesHoverOptions {
  @scala.inline
  def apply(): PlotAbandsStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAbandsStatesHoverOptionsOps[Self <: PlotAbandsStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAbandsStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAbandsStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
