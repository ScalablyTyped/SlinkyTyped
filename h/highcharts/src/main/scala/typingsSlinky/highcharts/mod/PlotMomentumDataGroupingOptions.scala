...
object PlotMomentumDataGroupingOptions {
  @scala.inline
  def apply(): PlotMomentumDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotMomentumDataGroupingOptionsOps[Self <: PlotMomentumDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
