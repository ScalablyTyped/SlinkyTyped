...
object PlotLinearregressionslopeDataGroupingOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeDataGroupingOptionsOps[Self <: PlotLinearregressionslopeDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
