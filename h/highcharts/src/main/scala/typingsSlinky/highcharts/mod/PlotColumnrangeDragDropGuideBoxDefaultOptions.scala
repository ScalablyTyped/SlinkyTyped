...
object PlotColumnrangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotColumnrangeDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeDragDropGuideBoxDefaultOptionsOps[Self <: PlotColumnrangeDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
