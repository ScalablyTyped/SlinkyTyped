...
object PlotAroonOptions {
  ...
  implicit class PlotAroonOptionsOps[Self <: PlotAroonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAroonAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAroonDown(value: PlotAroonAroonDownOptions): Self = this.set("aroonDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAroonDown: Self = this.set("aroonDown", js.undefined)
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotAroonDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotAroonDataLabelsOptions | js.Array[PlotAroonDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAroonDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAroonParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
