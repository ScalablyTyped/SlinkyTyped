...
object PlotDependencywheelTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotDependencywheelTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotDependencywheelTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
