...
trait PlotAbandsTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAbandsTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotAbandsTooltipOptions {
  @scala.inline
  def apply(): PlotAbandsTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsTooltipOptions]
  }
  @scala.inline
  implicit class PlotAbandsTooltipOptionsOps[Self <: PlotAbandsTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotAbandsTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
