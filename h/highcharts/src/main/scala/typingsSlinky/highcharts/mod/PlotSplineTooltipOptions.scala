...
trait PlotSplineTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotSplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotSplineTooltipOptions {
  @scala.inline
  def apply(): PlotSplineTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineTooltipOptions]
  }
  @scala.inline
  implicit class PlotSplineTooltipOptionsOps[Self <: PlotSplineTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotSplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
