...
trait PlotWordcloudAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWordcloudAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotWordcloudAccessibilityOptions {
  @scala.inline
  def apply(): PlotWordcloudAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotWordcloudAccessibilityOptionsOps[Self <: PlotWordcloudAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotWordcloudAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
