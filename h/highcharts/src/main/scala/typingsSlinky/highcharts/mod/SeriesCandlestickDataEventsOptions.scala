...
@js.native
trait SeriesCandlestickDataEventsOptions extends js.Object {
  /**
...
object SeriesCandlestickDataEventsOptions {
  @scala.inline
  def apply(): SeriesCandlestickDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesCandlestickDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesCandlestickDataEventsOptionsOps[Self <: SeriesCandlestickDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
