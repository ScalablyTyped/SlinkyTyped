...
object ChartParallelAxesDateTimeLabelFormatsYearOptions {
  @scala.inline
  def apply(): ChartParallelAxesDateTimeLabelFormatsYearOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesDateTimeLabelFormatsYearOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesDateTimeLabelFormatsYearOptionsOps[Self <: ChartParallelAxesDateTimeLabelFormatsYearOptions] (val x: Self) extends AnyVal {
    @scala.inline
