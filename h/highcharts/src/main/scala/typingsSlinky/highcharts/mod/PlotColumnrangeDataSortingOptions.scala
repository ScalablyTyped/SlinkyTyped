...
@js.native
trait PlotColumnrangeDataSortingOptions extends StObject {
...
object PlotColumnrangeDataSortingOptions {
  
  @scala.inline
  def apply(): PlotColumnrangeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotColumnrangeDataSortingOptionsMutableBuilder[Self <: PlotColumnrangeDataSortingOptions] (val x: Self) extends AnyVal {
