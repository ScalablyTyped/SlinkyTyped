...
@js.native
trait PlotColumnrangeDataSortingOptions extends js.Object {
  /**
...
object PlotColumnrangeDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotColumnrangeDataSortingOptionsOps[Self <: PlotColumnrangeDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
