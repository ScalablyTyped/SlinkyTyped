...
trait PlotParetoAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotParetoAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotParetoAccessibilityOptions {
  @scala.inline
  def apply(): PlotParetoAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotParetoAccessibilityOptionsOps[Self <: PlotParetoAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotParetoAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
