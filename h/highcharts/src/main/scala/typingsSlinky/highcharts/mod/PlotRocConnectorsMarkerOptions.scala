...
@js.native
trait PlotRocConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotRocConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotRocConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotRocConnectorsMarkerOptionsOps[Self <: PlotRocConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
