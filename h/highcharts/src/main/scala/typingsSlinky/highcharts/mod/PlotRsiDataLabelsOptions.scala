...
@js.native
trait PlotRsiDataLabelsOptions extends js.Object {
...
object PlotRsiDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotRsiDataLabelsOptionsOps[Self <: PlotRsiDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotRsiDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
