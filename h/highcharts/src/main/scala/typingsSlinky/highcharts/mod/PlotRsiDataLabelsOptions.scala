...
@js.native
trait PlotRsiDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotRsiDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotRsiDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotRsiDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotRsiDataLabelsOptionsMutableBuilder[Self <: PlotRsiDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotRsiDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
