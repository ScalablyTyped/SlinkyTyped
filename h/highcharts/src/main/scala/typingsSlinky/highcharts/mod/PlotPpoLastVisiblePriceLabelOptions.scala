...
object PlotPpoLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPpoLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPpoLastVisiblePriceLabelOptionsOps[Self <: PlotPpoLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
