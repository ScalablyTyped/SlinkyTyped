...
trait PlotPriceenvelopesTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPriceenvelopesTooltipOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesTooltipOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesTooltipOptionsOps[Self <: PlotPriceenvelopesTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
