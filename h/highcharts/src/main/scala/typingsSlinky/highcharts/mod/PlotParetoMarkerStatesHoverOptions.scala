...
object PlotParetoMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotParetoMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotParetoMarkerStatesHoverOptionsOps[Self <: PlotParetoMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
