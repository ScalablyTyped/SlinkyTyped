...
object PlotTrixStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTrixStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTrixStatesSelectHaloOptionsOps[Self <: PlotTrixStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
