...
object SeriesScatterDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesScatterDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataMarkerStatesInactiveOptionsOps[Self <: SeriesScatterDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
