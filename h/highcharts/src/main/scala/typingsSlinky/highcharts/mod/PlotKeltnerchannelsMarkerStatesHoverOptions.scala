...
@js.native
trait PlotKeltnerchannelsMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsMarkerStatesHoverOptionsOps[Self <: PlotKeltnerchannelsMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
