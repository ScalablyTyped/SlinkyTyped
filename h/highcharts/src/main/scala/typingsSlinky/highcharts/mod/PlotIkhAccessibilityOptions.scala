...
trait PlotIkhAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotIkhAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotIkhAccessibilityOptions {
  @scala.inline
  def apply(): PlotIkhAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotIkhAccessibilityOptionsOps[Self <: PlotIkhAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotIkhAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
