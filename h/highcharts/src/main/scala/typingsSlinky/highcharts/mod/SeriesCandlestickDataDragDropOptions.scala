...
@js.native
trait SeriesCandlestickDataDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesCandlestickDataDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesCandlestickDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object SeriesCandlestickDataDragDropOptions {
  @scala.inline
  def apply(): SeriesCandlestickDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesCandlestickDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesCandlestickDataDragDropOptionsOps[Self <: SeriesCandlestickDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesCandlestickDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesCandlestickDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
