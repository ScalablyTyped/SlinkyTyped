...
trait SeriesCandlestickDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesCandlestickDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesCandlestickDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesCandlestickDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesCandlestickDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesCandlestickDataDragDropOptions = {
