...
object SeriesXrangeOptions {
  ...
  @scala.inline
  implicit class SeriesXrangeOptionsMutableBuilder[Self <: SeriesXrangeOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[XrangePointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: String | xrange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
