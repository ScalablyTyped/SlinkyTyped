...
trait SeriesXrangeOptions
  ...
  /**
    ...
    * example)
    */
  var data: js.UndefOr[js.Array[SeriesXrangeDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesXrangeOptions {
  ...
  implicit class SeriesXrangeOptionsOps[Self <: SeriesXrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | xrange): Self = {
    ...
    @scala.inline
    def withData(value: js.Array[SeriesXrangeDataOptions]): Self = {
        val ret = this.duplicate
