...
object SeriesXrangeOptions {
  ...
  @scala.inline
  implicit class SeriesXrangeOptionsOps[Self <: SeriesXrangeOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | xrange): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(value: XrangePointOptionsObject*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[XrangePointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
