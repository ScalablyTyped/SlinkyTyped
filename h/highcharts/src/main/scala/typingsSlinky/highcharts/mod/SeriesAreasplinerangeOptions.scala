...
object SeriesAreasplinerangeOptions {
  ...
  @scala.inline
  implicit class SeriesAreasplinerangeOptionsOps[Self <: SeriesAreasplinerangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | areasplinerange): Self = this.set("type", value.asInstanceOf[js.Any])
