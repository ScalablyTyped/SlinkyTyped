...
trait SeriesAreasplinerangeOptions extends PlotAreasplinerangeOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | areasplinerange = js.native
...
object SeriesAreasplinerangeOptions {
  
  @scala.inline
  def apply(`type`: String | areasplinerange): SeriesAreasplinerangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesAreasplinerangeOptions]
  }
  
  @scala.inline
  implicit class SeriesAreasplinerangeOptionsMutableBuilder[Self <: SeriesAreasplinerangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | areasplinerange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
