...
trait PlotFunnel3dDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotFunnel3dDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotFunnel3dDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotFunnel3dDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotFunnel3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotFunnel3dDragDropOptions = {
