...
object PlotTemaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotTemaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTemaMarkerStatesHoverOptionsOps[Self <: PlotTemaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
