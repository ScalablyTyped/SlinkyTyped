...
object XAxisDateTimeLabelFormatsMinuteOptions {
  @scala.inline
  def apply(): XAxisDateTimeLabelFormatsMinuteOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisDateTimeLabelFormatsMinuteOptions]
  }
  @scala.inline
  implicit class XAxisDateTimeLabelFormatsMinuteOptionsOps[Self <: XAxisDateTimeLabelFormatsMinuteOptions] (val x: Self) extends AnyVal {
    @scala.inline
