...
@js.native
trait PlotMappointOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMappointAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotMappointClusterOptions] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMappointDataLabelsOptions | js.Array[PlotMappointDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMappointDataSortingOptions] = js.native
...
object PlotMappointOptions {
  ...
  @scala.inline
  implicit class PlotMappointOptionsMutableBuilder[Self <: PlotMappointOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMappointAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCluster(value: PlotMappointClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotMappointDataLabelsOptions | js.Array[PlotMappointDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotMappointDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMappointDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotMappointJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
