...
trait SeriesLineDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesLineDataDragDropDragHandleOptions] = js.native
  /**
...
object SeriesLineDataDragDropOptions {
  ...
  implicit class SeriesLineDataDragDropOptionsOps[Self <: SeriesLineDataDragDropOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDragHandle(value: SeriesLineDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesLineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
