...
object PlotKeltnerchannelsDataGroupingOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsDataGroupingOptionsOps[Self <: PlotKeltnerchannelsDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
