...
object PlotPivotpointsMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotPivotpointsMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsMarkerStatesInactiveOptionsOps[Self <: PlotPivotpointsMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
