...
trait PlotMaplineDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotMaplineDragDropDragHandleOptions] = js.native
  /**
...
object PlotMaplineDragDropOptions {
  @scala.inline
  def apply(): PlotMaplineDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineDragDropOptions]
  }
  @scala.inline
  implicit class PlotMaplineDragDropOptionsOps[Self <: PlotMaplineDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotMaplineDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotMaplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
