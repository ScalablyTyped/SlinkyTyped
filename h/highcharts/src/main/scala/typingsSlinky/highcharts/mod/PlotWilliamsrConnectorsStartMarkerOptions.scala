...
@js.native
trait PlotWilliamsrConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotWilliamsrConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotWilliamsrConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrConnectorsStartMarkerOptionsOps[Self <: PlotWilliamsrConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
