...
object PlotPyramid3dStatesNormalOptions {
  @scala.inline
  def apply(): PlotPyramid3dStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dStatesNormalOptionsOps[Self <: PlotPyramid3dStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
