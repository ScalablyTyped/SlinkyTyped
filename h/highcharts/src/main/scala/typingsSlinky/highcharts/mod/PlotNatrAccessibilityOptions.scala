...
trait PlotNatrAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotNatrAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotNatrAccessibilityOptions {
  @scala.inline
  def apply(): PlotNatrAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotNatrAccessibilityOptionsOps[Self <: PlotNatrAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotNatrAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
