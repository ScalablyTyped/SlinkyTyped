...
@js.native
trait PlotItemAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotItemAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotItemAccessibilityOptions {
  @scala.inline
  def apply(): PlotItemAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotItemAccessibilityOptionsOps[Self <: PlotItemAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotItemAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
