...
object PlotItemMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotItemMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotItemMarkerStatesSelectOptionsOps[Self <: PlotItemMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
