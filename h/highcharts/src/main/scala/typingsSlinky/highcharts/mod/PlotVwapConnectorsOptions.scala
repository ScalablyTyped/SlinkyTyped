...
trait PlotVwapConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVwapConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVwapConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVwapConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotVwapConnectorsOptions {
  @scala.inline
  def apply(): PlotVwapConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapConnectorsOptions]
  }
  @scala.inline
  implicit class PlotVwapConnectorsOptionsOps[Self <: PlotVwapConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotVwapConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotVwapConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotVwapConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
