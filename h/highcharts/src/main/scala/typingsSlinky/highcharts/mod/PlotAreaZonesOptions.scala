...
@js.native
trait PlotAreaZonesOptions extends js.Object {
  /**
...
object PlotAreaZonesOptions {
  @scala.inline
  def apply(): PlotAreaZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaZonesOptions]
  }
  @scala.inline
  implicit class PlotAreaZonesOptionsOps[Self <: PlotAreaZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
