...
@js.native
trait AnnotationsFibonacciLabelOptions extends js.Object {
...
object AnnotationsFibonacciLabelOptions {
  ...
  @scala.inline
  implicit class AnnotationsFibonacciLabelOptionsOps[Self <: AnnotationsFibonacciLabelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStyle(value: AnnotationsFibonacciLabelStyleOptions | CSSObject): Self = this.set("style", value.asInstanceOf[js.Any])
