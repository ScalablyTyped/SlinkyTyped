...
object PlotVariwideDataGroupingOptions {
  @scala.inline
  def apply(): PlotVariwideDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotVariwideDataGroupingOptionsOps[Self <: PlotVariwideDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
