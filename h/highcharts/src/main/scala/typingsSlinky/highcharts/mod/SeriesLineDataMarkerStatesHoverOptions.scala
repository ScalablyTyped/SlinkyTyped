...
object SeriesLineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesLineDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesLineDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesLineDataMarkerStatesHoverOptionsOps[Self <: SeriesLineDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
