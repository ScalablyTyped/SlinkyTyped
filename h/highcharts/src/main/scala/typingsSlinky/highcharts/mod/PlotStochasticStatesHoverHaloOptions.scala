...
@js.native
trait PlotStochasticStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotStochasticStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotStochasticStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotStochasticStatesHoverHaloOptionsOps[Self <: PlotStochasticStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
