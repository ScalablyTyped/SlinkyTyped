...
object PlotBellcurveStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotBellcurveStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotBellcurveStatesHoverHaloOptionsOps[Self <: PlotBellcurveStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
