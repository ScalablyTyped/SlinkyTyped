...
object PlotEmaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotEmaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotEmaConnectorsMarkerOptionsOps[Self <: PlotEmaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
