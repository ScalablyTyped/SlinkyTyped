...
object PlotLinearregressionDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionDataLabelsOptionsMutableBuilder[Self <: PlotLinearregressionDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
