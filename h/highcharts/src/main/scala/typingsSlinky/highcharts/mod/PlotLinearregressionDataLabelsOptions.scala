...
@js.native
trait PlotLinearregressionDataLabelsOptions extends js.Object {
...
object PlotLinearregressionDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotLinearregressionDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionDataLabelsOptionsOps[Self <: PlotLinearregressionDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
