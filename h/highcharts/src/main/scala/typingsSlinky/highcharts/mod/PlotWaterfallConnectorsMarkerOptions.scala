...
@js.native
trait PlotWaterfallConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotWaterfallConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotWaterfallConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotWaterfallConnectorsMarkerOptionsOps[Self <: PlotWaterfallConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
