...
trait PlotDemaTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotDemaTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotDemaTooltipOptions {
  @scala.inline
  def apply(): PlotDemaTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaTooltipOptions]
  }
  @scala.inline
  implicit class PlotDemaTooltipOptionsOps[Self <: PlotDemaTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotDemaTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
