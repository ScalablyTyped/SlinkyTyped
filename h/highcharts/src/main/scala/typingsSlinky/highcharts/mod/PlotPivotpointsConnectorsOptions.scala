...
trait PlotPivotpointsConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPivotpointsConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPivotpointsConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPivotpointsConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotPivotpointsConnectorsOptions {
  @scala.inline
  def apply(): PlotPivotpointsConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsConnectorsOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsConnectorsOptionsOps[Self <: PlotPivotpointsConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotPivotpointsConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotPivotpointsConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotPivotpointsConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
