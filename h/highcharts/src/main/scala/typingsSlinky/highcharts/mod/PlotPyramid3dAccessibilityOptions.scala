...
trait PlotPyramid3dAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPyramid3dAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPyramid3dAccessibilityOptions {
  @scala.inline
  def apply(): PlotPyramid3dAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dAccessibilityOptionsOps[Self <: PlotPyramid3dAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPyramid3dAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
