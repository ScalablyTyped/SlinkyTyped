...
@js.native
trait PlotSupertrendZonesOptions extends js.Object {
  /**
...
object PlotSupertrendZonesOptions {
  @scala.inline
  def apply(): PlotSupertrendZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendZonesOptions]
  }
  @scala.inline
  implicit class PlotSupertrendZonesOptionsOps[Self <: PlotSupertrendZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
