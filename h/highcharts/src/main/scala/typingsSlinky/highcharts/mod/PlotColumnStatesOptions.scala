...
trait PlotColumnStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotColumnStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotColumnStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotColumnStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotColumnStatesSelectOptions] = js.native
}

object PlotColumnStatesOptions {
  @scala.inline
  def apply(): PlotColumnStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnStatesOptions]
  }
  @scala.inline
  implicit class PlotColumnStatesOptionsOps[Self <: PlotColumnStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotColumnStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotColumnStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotColumnStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotColumnStatesSelectOptions): Self = {
        val ret = this.duplicate
