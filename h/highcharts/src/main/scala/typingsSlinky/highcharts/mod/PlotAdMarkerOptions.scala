...
trait PlotAdMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAdMarkerStatesOptions] = js.native
  /**
...
object PlotAdMarkerOptions {
  @scala.inline
  def apply(): PlotAdMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdMarkerOptions]
  }
  @scala.inline
  implicit class PlotAdMarkerOptionsOps[Self <: PlotAdMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAdMarkerStatesOptions): Self = {
        val ret = this.duplicate
