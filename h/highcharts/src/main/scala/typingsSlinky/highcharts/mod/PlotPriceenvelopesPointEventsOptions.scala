...
object PlotPriceenvelopesPointEventsOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesPointEventsOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesPointEventsOptionsOps[Self <: PlotPriceenvelopesPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
