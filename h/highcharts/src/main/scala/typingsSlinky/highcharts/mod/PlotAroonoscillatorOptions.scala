...
object PlotAroonoscillatorOptions {
  ...
  implicit class PlotAroonoscillatorOptionsOps[Self <: PlotAroonoscillatorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAroonoscillatorAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotAroonoscillatorDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotAroonoscillatorDataLabelsOptions | js.Array[PlotAroonoscillatorDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAroonoscillatorParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
