...
@js.native
trait PlotAroonoscillatorOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAroonoscillatorAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  var dataLabels: js.UndefOr[
    PlotAroonoscillatorDataLabelsOptions | js.Array[PlotAroonoscillatorDataLabelsOptions]
  ] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions] = js.native
...
object PlotAroonoscillatorOptions {
  ...
  @scala.inline
  implicit class PlotAroonoscillatorOptionsMutableBuilder[Self <: PlotAroonoscillatorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAroonoscillatorAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAroonoscillatorDataLabelsOptions | js.Array[PlotAroonoscillatorDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAroonoscillatorDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAroonoscillatorParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
