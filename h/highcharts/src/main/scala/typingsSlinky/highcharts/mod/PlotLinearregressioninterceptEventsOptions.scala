...
object PlotLinearregressioninterceptEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptEventsOptionsOps[Self <: PlotLinearregressioninterceptEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
