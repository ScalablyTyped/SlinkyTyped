...
trait PlotColumnTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotColumnTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotColumnTooltipOptions {
  @scala.inline
  def apply(): PlotColumnTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnTooltipOptions]
  }
  @scala.inline
  implicit class PlotColumnTooltipOptionsOps[Self <: PlotColumnTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotColumnTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
