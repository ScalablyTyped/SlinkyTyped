...
object SeriesWordcloudOptions {
  ...
  implicit class SeriesWordcloudOptionsOps[Self <: SeriesWordcloudOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | wordcloud): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple2[String, Double]) | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple2[String, Double]) | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
