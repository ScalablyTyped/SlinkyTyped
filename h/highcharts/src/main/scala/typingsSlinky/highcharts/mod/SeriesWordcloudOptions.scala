...
trait SeriesWordcloudOptions extends PlotWordcloudOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Tuple2[String, Double]) | PointOptionsObject]] = js.native
...
object SeriesWordcloudOptions {
  ...
  @scala.inline
  implicit class SeriesWordcloudOptionsMutableBuilder[Self <: SeriesWordcloudOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple2[String, Double]) | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple2[String, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | wordcloud): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
