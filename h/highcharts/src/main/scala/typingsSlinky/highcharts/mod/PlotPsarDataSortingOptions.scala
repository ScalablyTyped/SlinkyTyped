...
@js.native
trait PlotPsarDataSortingOptions extends StObject {
...
object PlotPsarDataSortingOptions {
  
  @scala.inline
  def apply(): PlotPsarDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotPsarDataSortingOptionsMutableBuilder[Self <: PlotPsarDataSortingOptions] (val x: Self) extends AnyVal {
