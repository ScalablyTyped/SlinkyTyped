...
@js.native
trait PlotPsarDataSortingOptions extends js.Object {
...
object PlotPsarDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotPsarDataSortingOptionsOps[Self <: PlotPsarDataSortingOptions] (val x: Self) extends AnyVal {
