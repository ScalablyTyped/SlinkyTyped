...
object SeriesStreamgraphDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataDragDropDragHandleOptionsOps[Self <: SeriesStreamgraphDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
