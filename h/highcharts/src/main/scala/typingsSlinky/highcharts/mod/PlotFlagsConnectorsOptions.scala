...
trait PlotFlagsConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFlagsConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFlagsConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFlagsConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotFlagsConnectorsOptions {
  @scala.inline
  def apply(): PlotFlagsConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsConnectorsOptions]
  }
  @scala.inline
  implicit class PlotFlagsConnectorsOptionsOps[Self <: PlotFlagsConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotFlagsConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotFlagsConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotFlagsConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
