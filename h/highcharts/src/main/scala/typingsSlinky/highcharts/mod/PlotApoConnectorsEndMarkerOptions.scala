...
@js.native
trait PlotApoConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotApoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotApoConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotApoConnectorsEndMarkerOptionsOps[Self <: PlotApoConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
