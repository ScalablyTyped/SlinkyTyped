...
trait PlotBarDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotBarDragDropDragHandleOptions] = js.native
  /**
...
object PlotBarDragDropOptions {
  @scala.inline
  def apply(): PlotBarDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarDragDropOptions]
  }
  @scala.inline
  implicit class PlotBarDragDropOptionsOps[Self <: PlotBarDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotBarDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotBarDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
