...
@js.native
trait PlotAreaDataSortingOptions extends js.Object {
  /**
...
object PlotAreaDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAreaDataSortingOptionsOps[Self <: PlotAreaDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
