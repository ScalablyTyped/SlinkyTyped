...
@js.native
trait PlotAreaDataSortingOptions extends StObject {
...
object PlotAreaDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAreaDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAreaDataSortingOptionsMutableBuilder[Self <: PlotAreaDataSortingOptions] (val x: Self) extends AnyVal {
