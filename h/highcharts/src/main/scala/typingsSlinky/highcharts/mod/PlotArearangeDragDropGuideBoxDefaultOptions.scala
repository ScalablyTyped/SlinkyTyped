...
object PlotArearangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotArearangeDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotArearangeDragDropGuideBoxDefaultOptionsOps[Self <: PlotArearangeDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
