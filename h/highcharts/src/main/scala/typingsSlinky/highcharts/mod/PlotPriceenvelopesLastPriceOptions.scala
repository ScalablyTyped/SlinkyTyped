...
object PlotPriceenvelopesLastPriceOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesLastPriceOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesLastPriceOptionsOps[Self <: PlotPriceenvelopesLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
