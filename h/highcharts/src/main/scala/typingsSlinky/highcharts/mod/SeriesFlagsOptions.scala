...
trait SeriesFlagsOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[SeriesFlagsDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesFlagsOptions {
  ...
  implicit class SeriesFlagsOptionsOps[Self <: SeriesFlagsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | flags): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[SeriesFlagsDataOptions]): Self = {
        val ret = this.duplicate
