...
@js.native
trait PlotAtrMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotAtrMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotAtrMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAtrMarkerStatesHoverOptionsOps[Self <: PlotAtrMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
