...
@js.native
trait ChartParallelAxesAccessibilityOptions extends js.Object {
  /**
...
object ChartParallelAxesAccessibilityOptions {
  @scala.inline
  def apply(): ChartParallelAxesAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesAccessibilityOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesAccessibilityOptionsOps[Self <: ChartParallelAxesAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
