...
object PlotHeatmapDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotHeatmapDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotHeatmapDragDropDragHandleOptionsOps[Self <: PlotHeatmapDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
