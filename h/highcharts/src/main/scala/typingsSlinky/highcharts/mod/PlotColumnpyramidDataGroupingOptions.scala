...
object PlotColumnpyramidDataGroupingOptions {
  @scala.inline
  def apply(): PlotColumnpyramidDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidDataGroupingOptionsOps[Self <: PlotColumnpyramidDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
