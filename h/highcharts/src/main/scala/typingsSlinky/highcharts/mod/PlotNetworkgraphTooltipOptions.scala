...
trait PlotNetworkgraphTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotNetworkgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotNetworkgraphTooltipOptions {
  @scala.inline
  def apply(): PlotNetworkgraphTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphTooltipOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphTooltipOptionsOps[Self <: PlotNetworkgraphTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotNetworkgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
