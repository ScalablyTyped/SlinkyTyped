...
object SeriesFunnel3dDataEventsOptions {
  @scala.inline
  def apply(): SeriesFunnel3dDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFunnel3dDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesFunnel3dDataEventsOptionsOps[Self <: SeriesFunnel3dDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
