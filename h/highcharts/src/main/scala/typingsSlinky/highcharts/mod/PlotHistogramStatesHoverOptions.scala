...
trait PlotHistogramStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotHistogramStatesHoverAnimationOptions] = js.native
  /**
...
object PlotHistogramStatesHoverOptions {
  @scala.inline
  def apply(): PlotHistogramStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotHistogramStatesHoverOptionsOps[Self <: PlotHistogramStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotHistogramStatesHoverAnimationOptions): Self = {
