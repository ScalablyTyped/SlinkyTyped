...
@js.native
trait PlotTrendlineMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTrendlineMarkerStatesOptions] = js.native
  /**
...
object PlotTrendlineMarkerOptions {
  @scala.inline
  def apply(): PlotTrendlineMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrendlineMarkerOptionsOps[Self <: PlotTrendlineMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotTrendlineMarkerStatesOptions): Self = {
        val ret = this.duplicate
