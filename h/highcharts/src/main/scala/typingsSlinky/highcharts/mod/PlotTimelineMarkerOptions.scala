...
trait PlotTimelineMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTimelineMarkerStatesOptions] = js.native
  /**
...
object PlotTimelineMarkerOptions {
  @scala.inline
  def apply(): PlotTimelineMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineMarkerOptions]
  }
  @scala.inline
  implicit class PlotTimelineMarkerOptionsOps[Self <: PlotTimelineMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotTimelineMarkerStatesOptions): Self = {
        val ret = this.duplicate
