...
object PlotPriceenvelopesStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesStatesHoverHaloOptionsOps[Self <: PlotPriceenvelopesStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
