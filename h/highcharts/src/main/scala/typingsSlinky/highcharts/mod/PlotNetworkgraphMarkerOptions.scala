...
trait PlotNetworkgraphMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNetworkgraphMarkerStatesOptions] = js.native
  /**
...
object PlotNetworkgraphMarkerOptions {
  @scala.inline
  def apply(): PlotNetworkgraphMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphMarkerOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphMarkerOptionsOps[Self <: PlotNetworkgraphMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotNetworkgraphMarkerStatesOptions): Self = {
        val ret = this.duplicate
