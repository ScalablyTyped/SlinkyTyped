...
@js.native
trait PlotAdStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAdStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAdStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotAdStatesSelectOptions {
  @scala.inline
  def apply(): PlotAdStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAdStatesSelectOptionsOps[Self <: PlotAdStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotAdStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAdStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
