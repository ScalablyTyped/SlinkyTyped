...
object PlotDemaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotDemaDataLabelsOptionsMutableBuilder[Self <: PlotDemaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDemaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
