...
@js.native
trait PlotDemaDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotDemaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotDemaDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotDemaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotDemaDataLabelsOptionsOps[Self <: PlotDemaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDemaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
