...
trait PlotHeatmapAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotHeatmapAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotHeatmapAccessibilityOptions {
  @scala.inline
  def apply(): PlotHeatmapAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotHeatmapAccessibilityOptionsOps[Self <: PlotHeatmapAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotHeatmapAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
