...
@js.native
trait PlotOhlcDataGroupingOptions extends js.Object {
  /**
...
object PlotOhlcDataGroupingOptions {
  @scala.inline
  def apply(): PlotOhlcDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotOhlcDataGroupingOptionsOps[Self <: PlotOhlcDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
