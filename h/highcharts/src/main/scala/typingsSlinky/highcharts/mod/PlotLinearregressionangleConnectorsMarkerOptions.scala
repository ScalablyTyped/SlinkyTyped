...
object PlotLinearregressionangleConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleConnectorsMarkerOptionsOps[Self <: PlotLinearregressionangleConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
