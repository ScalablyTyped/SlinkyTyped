...
@js.native
trait SeriesGaugeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesGaugeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesGaugeDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGaugeDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesGaugeDataDragDropDragHandleOptionsOps[Self <: SeriesGaugeDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
