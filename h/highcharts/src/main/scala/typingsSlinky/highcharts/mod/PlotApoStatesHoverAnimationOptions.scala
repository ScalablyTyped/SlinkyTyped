...
object PlotApoStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotApoStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotApoStatesHoverAnimationOptionsOps[Self <: PlotApoStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
