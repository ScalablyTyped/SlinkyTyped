...
trait PlotSankeyOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSankeyAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotSankeyOptions {
  ...
  @scala.inline
  implicit class PlotSankeyOptionsMutableBuilder[Self <: PlotSankeyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSankeyAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCurveFactor(value: Double): Self = StObject.set(x, "curveFactor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurveFactorUndefined: Self = StObject.set(x, "curveFactor", js.undefined)
    ...
    @scala.inline
    def setLevels(value: js.Array[PlotSankeyLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    @scala.inline
    def setLevelsVarargs(value: PlotSankeyLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
