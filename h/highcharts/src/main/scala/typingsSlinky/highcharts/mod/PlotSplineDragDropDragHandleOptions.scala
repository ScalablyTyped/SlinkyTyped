...
object PlotSplineDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotSplineDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotSplineDragDropDragHandleOptionsOps[Self <: PlotSplineDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
