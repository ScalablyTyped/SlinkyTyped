...
trait PlotWindbarbConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWindbarbConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWindbarbConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWindbarbConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotWindbarbConnectorsOptions {
  @scala.inline
  def apply(): PlotWindbarbConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbConnectorsOptions]
  }
  @scala.inline
  implicit class PlotWindbarbConnectorsOptionsOps[Self <: PlotWindbarbConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotWindbarbConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotWindbarbConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotWindbarbConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
