...
@js.native
trait PlotVbpEventsOptions extends js.Object {
  /**
...
object PlotVbpEventsOptions {
  @scala.inline
  def apply(): PlotVbpEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpEventsOptions]
  }
  @scala.inline
  implicit class PlotVbpEventsOptionsOps[Self <: PlotVbpEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
