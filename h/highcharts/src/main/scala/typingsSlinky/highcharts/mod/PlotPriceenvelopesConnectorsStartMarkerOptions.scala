...
object PlotPriceenvelopesConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesConnectorsStartMarkerOptionsOps[Self <: PlotPriceenvelopesConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
