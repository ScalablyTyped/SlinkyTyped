...
trait PlotWindbarbAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWindbarbAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotWindbarbAccessibilityOptions {
  @scala.inline
  def apply(): PlotWindbarbAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotWindbarbAccessibilityOptionsOps[Self <: PlotWindbarbAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotWindbarbAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
