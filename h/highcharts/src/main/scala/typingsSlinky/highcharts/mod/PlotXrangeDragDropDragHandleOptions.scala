...
object PlotXrangeDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotXrangeDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotXrangeDragDropDragHandleOptionsOps[Self <: PlotXrangeDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
