...
@js.native
trait PlotDpoStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotDpoStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotDpoStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotDpoStatesSelectOptions {
  @scala.inline
  def apply(): PlotDpoStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotDpoStatesSelectOptionsOps[Self <: PlotDpoStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotDpoStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotDpoStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
