...
trait PlotLinearregressionslopeAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressionslopeAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotLinearregressionslopeAccessibilityOptions {
  ...
  def apply(
    ...
    keyboardNavigation: js.Object | PlotLinearregressionslopeAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotLinearregressionslopeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (!js.isUndefined(enabled)) __obj.updateDynamic("enabled")(enabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(exposeAsGroupOnly)) __obj.updateDynamic("exposeAsGroupOnly")(exposeAsGroupOnly.get.asInstanceOf[js.Any])
