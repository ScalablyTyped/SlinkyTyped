...
@js.native
trait PlotLinearregressionslopeAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressionslopeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotLinearregressionslopeAccessibilityOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeAccessibilityOptionsOps[Self <: PlotLinearregressionslopeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotLinearregressionslopeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
