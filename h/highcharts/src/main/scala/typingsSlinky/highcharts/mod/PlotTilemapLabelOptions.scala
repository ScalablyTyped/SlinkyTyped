...
@js.native
trait PlotTilemapLabelOptions extends js.Object {
  /**
...
object PlotTilemapLabelOptions {
  @scala.inline
  def apply(): PlotTilemapLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapLabelOptions]
  }
  @scala.inline
  implicit class PlotTilemapLabelOptionsOps[Self <: PlotTilemapLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
