...
object ZAxisDateTimeLabelFormatsYearOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsYearOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsYearOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsYearOptionsOps[Self <: ZAxisDateTimeLabelFormatsYearOptions] (val x: Self) extends AnyVal {
    @scala.inline
