...
object PlotLinearregressionEventsOptions {
  @scala.inline
  def apply(): PlotLinearregressionEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionEventsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionEventsOptionsOps[Self <: PlotLinearregressionEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
