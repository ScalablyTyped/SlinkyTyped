...
object PlotRocConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotRocConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotRocConnectorsStartMarkerOptionsOps[Self <: PlotRocConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
