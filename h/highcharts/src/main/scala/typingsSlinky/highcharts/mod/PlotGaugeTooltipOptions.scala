...
@js.native
trait PlotGaugeTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotGaugeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotGaugeTooltipOptions {
  @scala.inline
  def apply(): PlotGaugeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeTooltipOptions]
  }
  @scala.inline
  implicit class PlotGaugeTooltipOptionsOps[Self <: PlotGaugeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotGaugeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
