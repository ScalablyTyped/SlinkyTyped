...
object PlotApoStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotApoStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotApoStatesSelectHaloOptionsOps[Self <: PlotApoStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
