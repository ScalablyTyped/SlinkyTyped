...
@js.native
trait PlotDemaDataSortingOptions extends StObject {
...
object PlotDemaDataSortingOptions {
  
  @scala.inline
  def apply(): PlotDemaDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotDemaDataSortingOptionsMutableBuilder[Self <: PlotDemaDataSortingOptions] (val x: Self) extends AnyVal {
