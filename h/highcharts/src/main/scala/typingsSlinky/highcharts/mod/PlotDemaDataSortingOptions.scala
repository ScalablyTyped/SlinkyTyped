...
@js.native
trait PlotDemaDataSortingOptions extends js.Object {
  /**
...
object PlotDemaDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotDemaDataSortingOptionsOps[Self <: PlotDemaDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
