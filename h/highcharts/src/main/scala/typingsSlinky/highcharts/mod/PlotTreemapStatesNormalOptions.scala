...
object PlotTreemapStatesNormalOptions {
  @scala.inline
  def apply(): PlotTreemapStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotTreemapStatesNormalOptionsOps[Self <: PlotTreemapStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
