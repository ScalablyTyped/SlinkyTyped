...
@js.native
trait NavigationAnnotationsLabelOptions extends js.Object {
...
object NavigationAnnotationsLabelOptions {
  ...
  @scala.inline
  implicit class NavigationAnnotationsLabelOptionsOps[Self <: NavigationAnnotationsLabelOptions] (val x: Self) extends AnyVal {
