...
object PlotVariwideConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVariwideConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariwideConnectorsEndMarkerOptionsOps[Self <: PlotVariwideConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
