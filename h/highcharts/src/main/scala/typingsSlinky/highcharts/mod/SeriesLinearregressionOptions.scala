...
trait SeriesLinearregressionOptions extends PlotLinearregressionOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregression = js.native
...
object SeriesLinearregressionOptions {
  ...
  @scala.inline
  def apply(`type`: String | linearregression): SeriesLinearregressionOptions = {
  ...
  @scala.inline
  implicit class SeriesLinearregressionOptionsMutableBuilder[Self <: SeriesLinearregressionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | linearregression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
