...
object SeriesLinearregressionOptions {
  ...
  @scala.inline
  implicit class SeriesLinearregressionOptionsOps[Self <: SeriesLinearregressionOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | linearregression): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
