...
@js.native
trait PlotPcStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPcStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPcStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotPcStatesHoverOptions {
  @scala.inline
  def apply(): PlotPcStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPcStatesHoverOptionsOps[Self <: PlotPcStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPcStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPcStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
