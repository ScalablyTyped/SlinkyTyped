...
object PlotSmaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSmaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSmaConnectorsEndMarkerOptionsOps[Self <: PlotSmaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
