...
object PlotTilemapAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotTilemapAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotTilemapAccessibilityKeyboardNavigationOptionsOps[Self <: PlotTilemapAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
