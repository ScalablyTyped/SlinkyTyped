...
@js.native
trait PlotVennConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotVennConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVennConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVennConnectorsEndMarkerOptionsOps[Self <: PlotVennConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
