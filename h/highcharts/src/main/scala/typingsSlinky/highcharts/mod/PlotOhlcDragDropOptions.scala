...
@js.native
trait PlotOhlcDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotOhlcDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotOhlcDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotOhlcDragDropOptions {
  @scala.inline
  def apply(): PlotOhlcDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcDragDropOptions]
  }
  @scala.inline
  implicit class PlotOhlcDragDropOptionsOps[Self <: PlotOhlcDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotOhlcDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withDraggableClose(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableClose")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDraggableClose: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableClose")(js.undefined)
        ret
    }
    @scala.inline
    def withDraggableHigh(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableHigh")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDraggableHigh: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableHigh")(js.undefined)
        ret
    }
    @scala.inline
    def withDraggableLow(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableLow")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDraggableLow: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableLow")(js.undefined)
        ret
    }
    @scala.inline
    def withDraggableOpen(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableOpen")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDraggableOpen: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableOpen")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGuideBox(value: PlotOhlcDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
