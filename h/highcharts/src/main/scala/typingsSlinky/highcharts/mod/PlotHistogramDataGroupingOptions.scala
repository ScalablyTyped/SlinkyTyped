...
@js.native
trait PlotHistogramDataGroupingOptions extends js.Object {
  /**
...
object PlotHistogramDataGroupingOptions {
  @scala.inline
  def apply(): PlotHistogramDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotHistogramDataGroupingOptionsOps[Self <: PlotHistogramDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
