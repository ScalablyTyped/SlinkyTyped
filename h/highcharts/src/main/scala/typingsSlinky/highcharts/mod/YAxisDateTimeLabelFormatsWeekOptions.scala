...
object YAxisDateTimeLabelFormatsWeekOptions {
  @scala.inline
  def apply(): YAxisDateTimeLabelFormatsWeekOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisDateTimeLabelFormatsWeekOptions]
  }
  @scala.inline
  implicit class YAxisDateTimeLabelFormatsWeekOptionsOps[Self <: YAxisDateTimeLabelFormatsWeekOptions] (val x: Self) extends AnyVal {
    @scala.inline
