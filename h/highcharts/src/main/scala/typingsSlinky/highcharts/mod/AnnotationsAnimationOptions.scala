...
@js.native
trait AnnotationsAnimationOptions extends js.Object {
...
object AnnotationsAnimationOptions {
  ...
  @scala.inline
  implicit class AnnotationsAnimationOptionsOps[Self <: AnnotationsAnimationOptions] (val x: Self) extends AnyVal {
