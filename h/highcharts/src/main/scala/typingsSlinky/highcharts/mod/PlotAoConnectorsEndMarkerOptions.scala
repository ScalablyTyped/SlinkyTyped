...
@js.native
trait PlotAoConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAoConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAoConnectorsEndMarkerOptionsOps[Self <: PlotAoConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
