...
@js.native
trait PlotDumbbellDataSortingOptions extends js.Object {
...
object PlotDumbbellDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotDumbbellDataSortingOptionsOps[Self <: PlotDumbbellDataSortingOptions] (val x: Self) extends AnyVal {
