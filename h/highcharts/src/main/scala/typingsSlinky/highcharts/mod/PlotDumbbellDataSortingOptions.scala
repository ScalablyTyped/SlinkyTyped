...
@js.native
trait PlotDumbbellDataSortingOptions extends StObject {
...
object PlotDumbbellDataSortingOptions {
  
  @scala.inline
  def apply(): PlotDumbbellDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotDumbbellDataSortingOptionsMutableBuilder[Self <: PlotDumbbellDataSortingOptions] (val x: Self) extends AnyVal {
