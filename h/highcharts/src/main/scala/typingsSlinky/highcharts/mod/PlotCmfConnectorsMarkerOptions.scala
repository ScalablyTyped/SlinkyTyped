...
object PlotCmfConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotCmfConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotCmfConnectorsMarkerOptionsOps[Self <: PlotCmfConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
