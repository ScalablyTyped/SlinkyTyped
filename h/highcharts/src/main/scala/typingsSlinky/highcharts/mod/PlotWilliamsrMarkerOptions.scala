...
trait PlotWilliamsrMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWilliamsrMarkerStatesOptions] = js.native
  /**
...
object PlotWilliamsrMarkerOptions {
  @scala.inline
  def apply(): PlotWilliamsrMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrMarkerOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrMarkerOptionsOps[Self <: PlotWilliamsrMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotWilliamsrMarkerStatesOptions): Self = {
        val ret = this.duplicate
