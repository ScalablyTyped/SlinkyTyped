...
object PlotAroonoscillatorLastPriceOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorLastPriceOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorLastPriceOptionsOps[Self <: PlotAroonoscillatorLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
