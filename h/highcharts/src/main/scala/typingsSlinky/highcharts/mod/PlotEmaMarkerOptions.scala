...
trait PlotEmaMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotEmaMarkerStatesOptions] = js.native
  /**
...
object PlotEmaMarkerOptions {
  @scala.inline
  def apply(): PlotEmaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaMarkerOptions]
  }
  @scala.inline
  implicit class PlotEmaMarkerOptionsOps[Self <: PlotEmaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotEmaMarkerStatesOptions): Self = {
        val ret = this.duplicate
