...
trait PlotTrendlineAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTrendlineAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotTrendlineAccessibilityOptions {
  @scala.inline
  def apply(): PlotTrendlineAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotTrendlineAccessibilityOptionsOps[Self <: PlotTrendlineAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotTrendlineAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
