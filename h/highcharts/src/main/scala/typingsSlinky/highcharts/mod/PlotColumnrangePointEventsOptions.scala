...
object PlotColumnrangePointEventsOptions {
  @scala.inline
  def apply(): PlotColumnrangePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangePointEventsOptions]
  }
  @scala.inline
  implicit class PlotColumnrangePointEventsOptionsOps[Self <: PlotColumnrangePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
