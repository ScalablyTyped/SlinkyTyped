...
object PlotColumnpyramidLastPriceOptions {
  @scala.inline
  def apply(): PlotColumnpyramidLastPriceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidLastPriceOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidLastPriceOptionsOps[Self <: PlotColumnpyramidLastPriceOptions] (val x: Self) extends AnyVal {
    @scala.inline
