...
@js.native
trait SeriesPyramidDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesPyramidDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesPyramidDataDataLabelsAnimationOptionsOps[Self <: SeriesPyramidDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
