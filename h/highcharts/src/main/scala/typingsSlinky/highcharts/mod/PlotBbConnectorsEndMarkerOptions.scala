...
object PlotBbConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBbConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBbConnectorsEndMarkerOptionsOps[Self <: PlotBbConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
