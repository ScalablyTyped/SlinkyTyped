...
object PlotItemMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotItemMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotItemMarkerStatesHoverOptionsOps[Self <: PlotItemMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
