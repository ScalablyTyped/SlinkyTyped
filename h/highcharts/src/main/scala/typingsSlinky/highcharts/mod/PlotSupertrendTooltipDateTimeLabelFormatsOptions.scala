...
@js.native
trait PlotSupertrendTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSupertrendTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotSupertrendTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotSupertrendTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotSupertrendTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
