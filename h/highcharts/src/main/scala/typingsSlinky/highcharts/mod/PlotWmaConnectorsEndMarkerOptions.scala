...
object PlotWmaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotWmaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotWmaConnectorsEndMarkerOptionsOps[Self <: PlotWmaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
