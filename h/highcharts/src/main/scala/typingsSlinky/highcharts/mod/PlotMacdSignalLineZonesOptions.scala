...
@js.native
trait PlotMacdSignalLineZonesOptions extends js.Object {
  /**
...
object PlotMacdSignalLineZonesOptions {
  @scala.inline
  def apply(): PlotMacdSignalLineZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSignalLineZonesOptions]
  }
  @scala.inline
  implicit class PlotMacdSignalLineZonesOptionsOps[Self <: PlotMacdSignalLineZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
