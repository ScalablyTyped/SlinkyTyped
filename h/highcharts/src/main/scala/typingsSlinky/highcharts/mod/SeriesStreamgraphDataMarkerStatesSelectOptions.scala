...
@js.native
trait SeriesStreamgraphDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesStreamgraphDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataMarkerStatesSelectOptionsOps[Self <: SeriesStreamgraphDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
