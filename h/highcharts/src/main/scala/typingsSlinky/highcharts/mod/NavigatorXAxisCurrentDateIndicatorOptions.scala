...
trait NavigatorXAxisCurrentDateIndicatorOptions extends js.Object {
  ...
  /**
    ...
    */
  var events: js.UndefOr[NavigatorXAxisCurrentDateIndicatorEventsOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[NavigatorXAxisCurrentDateIndicatorLabelOptions] = js.native
  /**
...
object NavigatorXAxisCurrentDateIndicatorOptions {
  @scala.inline
  def apply(): NavigatorXAxisCurrentDateIndicatorOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisCurrentDateIndicatorOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisCurrentDateIndicatorOptionsOps[Self <: NavigatorXAxisCurrentDateIndicatorOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEvents(value: NavigatorXAxisCurrentDateIndicatorEventsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: NavigatorXAxisCurrentDateIndicatorLabelOptions): Self = {
        val ret = this.duplicate
