...
trait PlotPolygonStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPolygonStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPolygonStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotPolygonStatesHoverOptions {
  @scala.inline
  def apply(): PlotPolygonStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPolygonStatesHoverOptionsOps[Self <: PlotPolygonStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPolygonStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPolygonStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
