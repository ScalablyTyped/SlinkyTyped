...
trait PlotBulletDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotBulletDragDropDragHandleOptions] = js.native
  /**
...
object PlotBulletDragDropOptions {
  @scala.inline
  def apply(): PlotBulletDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDragDropOptions]
  }
  @scala.inline
  implicit class PlotBulletDragDropOptionsOps[Self <: PlotBulletDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotBulletDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withDraggableTarget(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableTarget")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDraggableTarget: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("draggableTarget")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGuideBox(value: PlotBulletDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
