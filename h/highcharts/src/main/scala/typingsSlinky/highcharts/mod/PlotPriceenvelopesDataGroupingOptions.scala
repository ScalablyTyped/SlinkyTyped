...
object PlotPriceenvelopesDataGroupingOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesDataGroupingOptionsOps[Self <: PlotPriceenvelopesDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
