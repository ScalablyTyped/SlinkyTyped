...
@js.native
trait PlotBbMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBbMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotBbMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBbMarkerStatesSelectOptionsOps[Self <: PlotBbMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
