...
@js.native
trait SeriesWordcloudDataDragDropGuideBoxOptions extends StObject {
...
object SeriesWordcloudDataDragDropGuideBoxOptions {
  ...
  @scala.inline
  def apply(): SeriesWordcloudDataDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWordcloudDataDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit class SeriesWordcloudDataDragDropGuideBoxOptionsMutableBuilder[Self <: SeriesWordcloudDataDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
