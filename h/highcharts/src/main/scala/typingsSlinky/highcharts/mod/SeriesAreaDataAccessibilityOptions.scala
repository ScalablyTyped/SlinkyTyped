...
object SeriesAreaDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesAreaDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataAccessibilityOptionsOps[Self <: SeriesAreaDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
