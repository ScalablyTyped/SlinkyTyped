...
object PlotNatrStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotNatrStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotNatrStatesSelectAnimationOptionsOps[Self <: PlotNatrStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
