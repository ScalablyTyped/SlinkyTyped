...
@js.native
trait PlotAdStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotAdStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAdStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAdStatesSelectHaloOptionsOps[Self <: PlotAdStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
