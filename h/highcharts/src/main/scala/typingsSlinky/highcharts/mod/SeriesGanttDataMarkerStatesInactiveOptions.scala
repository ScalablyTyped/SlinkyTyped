...
object SeriesGanttDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesGanttDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGanttDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesGanttDataMarkerStatesInactiveOptionsOps[Self <: SeriesGanttDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
