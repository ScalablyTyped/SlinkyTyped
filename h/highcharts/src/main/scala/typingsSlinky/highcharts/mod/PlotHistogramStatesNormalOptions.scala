...
object PlotHistogramStatesNormalOptions {
  @scala.inline
  def apply(): PlotHistogramStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotHistogramStatesNormalOptionsOps[Self <: PlotHistogramStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
