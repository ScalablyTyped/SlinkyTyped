...
@js.native
trait PlotMapbubbleEventsOptions extends js.Object {
  /**
...
object PlotMapbubbleEventsOptions {
  @scala.inline
  def apply(): PlotMapbubbleEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleEventsOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleEventsOptionsOps[Self <: PlotMapbubbleEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
