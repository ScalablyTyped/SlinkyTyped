...
trait PlotNetworkgraphAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotNetworkgraphAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotNetworkgraphAccessibilityOptions {
  @scala.inline
  def apply(): PlotNetworkgraphAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphAccessibilityOptionsOps[Self <: PlotNetworkgraphAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotNetworkgraphAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
