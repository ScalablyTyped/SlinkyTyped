...
object PlotEmaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotEmaConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotEmaConnectorsEndMarkerOptionsOps[Self <: PlotEmaConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
