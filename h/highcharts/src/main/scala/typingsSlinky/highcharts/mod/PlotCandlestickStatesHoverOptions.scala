...
trait PlotCandlestickStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCandlestickStatesHoverAnimationOptions] = js.native
  /**
...
object PlotCandlestickStatesHoverOptions {
  @scala.inline
  def apply(): PlotCandlestickStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotCandlestickStatesHoverOptionsOps[Self <: PlotCandlestickStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotCandlestickStatesHoverAnimationOptions): Self = {
