...
trait PlotCciTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotCciTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotCciTooltipOptions {
  @scala.inline
  def apply(): PlotCciTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciTooltipOptions]
  }
  @scala.inline
  implicit class PlotCciTooltipOptionsOps[Self <: PlotCciTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotCciTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
