...
object PlotBubbleConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotBubbleConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotBubbleConnectorsMarkerOptionsOps[Self <: PlotBubbleConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
