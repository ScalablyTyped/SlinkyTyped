...
object PlotAroonoscillatorPointEventsOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorPointEventsOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorPointEventsOptionsOps[Self <: PlotAroonoscillatorPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
