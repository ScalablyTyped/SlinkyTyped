...
trait PlotWmaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWmaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotWmaAccessibilityOptions {
  @scala.inline
  def apply(): PlotWmaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotWmaAccessibilityOptionsOps[Self <: PlotWmaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotWmaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
