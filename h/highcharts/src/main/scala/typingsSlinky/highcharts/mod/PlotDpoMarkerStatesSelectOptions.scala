...
object PlotDpoMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotDpoMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotDpoMarkerStatesSelectOptionsOps[Self <: PlotDpoMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
