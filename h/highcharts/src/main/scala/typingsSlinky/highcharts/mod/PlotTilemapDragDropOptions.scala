...
@js.native
trait PlotTilemapDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTilemapDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTilemapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotTilemapDragDropOptions {
  @scala.inline
  def apply(): PlotTilemapDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDragDropOptions]
  }
  @scala.inline
  implicit class PlotTilemapDragDropOptionsOps[Self <: PlotTilemapDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotTilemapDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotTilemapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
