...
trait PlotTilemapDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotTilemapDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotTilemapDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTilemapDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTilemapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTilemapDragDropOptions = {
