...
@js.native
trait SeriesScatterDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesScatterDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesScatterDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataDragDropDragHandleOptionsOps[Self <: SeriesScatterDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
