...
@js.native
trait PlotMaplineStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotMaplineStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMaplineStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotMaplineStatesSelectOptions {
  @scala.inline
  def apply(): PlotMaplineStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMaplineStatesSelectOptionsOps[Self <: PlotMaplineStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotMaplineStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMaplineStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
