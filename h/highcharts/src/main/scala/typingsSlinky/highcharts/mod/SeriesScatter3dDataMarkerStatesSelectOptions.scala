...
@js.native
trait SeriesScatter3dDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesScatter3dDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataMarkerStatesSelectOptionsOps[Self <: SeriesScatter3dDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
