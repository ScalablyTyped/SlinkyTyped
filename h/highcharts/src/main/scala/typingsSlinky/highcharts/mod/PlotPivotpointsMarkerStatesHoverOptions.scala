...
object PlotPivotpointsMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPivotpointsMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsMarkerStatesHoverOptionsOps[Self <: PlotPivotpointsMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
