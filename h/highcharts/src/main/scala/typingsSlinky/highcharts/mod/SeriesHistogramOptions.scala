...
object SeriesHistogramOptions {
  ...
  @scala.inline
  implicit class SeriesHistogramOptionsOps[Self <: SeriesHistogramOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | histogram): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setBaseSeries(value: Double | String): Self = this.set("baseSeries", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBaseSeries: Self = this.set("baseSeries", js.undefined)
    @scala.inline
