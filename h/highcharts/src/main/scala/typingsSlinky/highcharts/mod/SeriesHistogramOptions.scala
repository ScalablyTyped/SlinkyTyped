...
object SeriesHistogramOptions {
  ...
  implicit class SeriesHistogramOptionsOps[Self <: SeriesHistogramOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | histogram): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBaseSeries(value: Double | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("baseSeries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBaseSeries: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("baseSeries")(js.undefined)
        ret
    }
    @scala.inline
