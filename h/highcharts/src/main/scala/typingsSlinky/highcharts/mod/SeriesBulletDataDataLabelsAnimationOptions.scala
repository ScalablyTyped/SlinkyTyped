...
@js.native
trait SeriesBulletDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesBulletDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesBulletDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBulletDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesBulletDataDataLabelsAnimationOptionsOps[Self <: SeriesBulletDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
