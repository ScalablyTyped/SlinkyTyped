...
@js.native
trait SeriesHeatmapDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesHeatmapDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesHeatmapDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesHeatmapDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesHeatmapDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesHeatmapDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
