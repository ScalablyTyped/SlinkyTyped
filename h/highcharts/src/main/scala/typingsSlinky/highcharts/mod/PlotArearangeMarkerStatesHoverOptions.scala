...
object PlotArearangeMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotArearangeMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotArearangeMarkerStatesHoverOptionsOps[Self <: PlotArearangeMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
