...
@js.native
trait PlotNatrDataSortingOptions extends js.Object {
...
object PlotNatrDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotNatrDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotNatrDataSortingOptionsOps[Self <: PlotNatrDataSortingOptions] (val x: Self) extends AnyVal {
