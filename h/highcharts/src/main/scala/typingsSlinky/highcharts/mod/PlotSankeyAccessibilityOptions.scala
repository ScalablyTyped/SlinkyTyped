...
trait PlotSankeyAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSankeyAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSankeyAccessibilityOptions {
  @scala.inline
  def apply(): PlotSankeyAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSankeyAccessibilityOptionsOps[Self <: PlotSankeyAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSankeyAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
