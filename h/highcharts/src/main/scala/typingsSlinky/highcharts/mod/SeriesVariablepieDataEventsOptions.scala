...
object SeriesVariablepieDataEventsOptions {
  @scala.inline
  def apply(): SeriesVariablepieDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVariablepieDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesVariablepieDataEventsOptionsOps[Self <: SeriesVariablepieDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
