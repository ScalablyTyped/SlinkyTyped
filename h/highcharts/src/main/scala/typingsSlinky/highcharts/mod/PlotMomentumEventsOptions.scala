...
@js.native
trait PlotMomentumEventsOptions extends js.Object {
  /**
...
object PlotMomentumEventsOptions {
  @scala.inline
  def apply(): PlotMomentumEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumEventsOptions]
  }
  @scala.inline
  implicit class PlotMomentumEventsOptionsOps[Self <: PlotMomentumEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
