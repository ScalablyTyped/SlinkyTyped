...
trait SeriesVariablepieOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Tuple2[Double | String, Double]) | SeriesVariablepieDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesVariablepieOptions {
  ...
  implicit class SeriesVariablepieOptionsOps[Self <: SeriesVariablepieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | variablepie): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[(js.Tuple2[Double | String, Double]) | SeriesVariablepieDataOptions]): Self = {
        val ret = this.duplicate
