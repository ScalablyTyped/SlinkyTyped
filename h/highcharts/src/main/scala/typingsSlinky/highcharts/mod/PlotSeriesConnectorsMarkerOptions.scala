...
object PlotSeriesConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSeriesConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSeriesConnectorsMarkerOptionsOps[Self <: PlotSeriesConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
