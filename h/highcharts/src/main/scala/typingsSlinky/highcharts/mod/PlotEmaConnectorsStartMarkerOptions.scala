...
object PlotEmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotEmaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotEmaConnectorsStartMarkerOptionsOps[Self <: PlotEmaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
