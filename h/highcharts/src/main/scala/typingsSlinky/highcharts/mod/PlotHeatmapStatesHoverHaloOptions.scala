...
object PlotHeatmapStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotHeatmapStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotHeatmapStatesHoverHaloOptionsOps[Self <: PlotHeatmapStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
