...
@js.native
trait PlotMaplineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMaplineDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotMaplineDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotMaplineDragDropDragHandleOptionsOps[Self <: PlotMaplineDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
