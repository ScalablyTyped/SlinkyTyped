...
@js.native
trait PlotZigzagEventsOptions extends js.Object {
  /**
...
object PlotZigzagEventsOptions {
  @scala.inline
  def apply(): PlotZigzagEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagEventsOptions]
  }
  @scala.inline
  implicit class PlotZigzagEventsOptionsOps[Self <: PlotZigzagEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
