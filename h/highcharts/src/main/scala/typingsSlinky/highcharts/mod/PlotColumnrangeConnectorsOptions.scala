...
trait PlotColumnrangeConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnrangeConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnrangeConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnrangeConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotColumnrangeConnectorsOptions {
  @scala.inline
  def apply(): PlotColumnrangeConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeConnectorsOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeConnectorsOptionsOps[Self <: PlotColumnrangeConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotColumnrangeConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotColumnrangeConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotColumnrangeConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
