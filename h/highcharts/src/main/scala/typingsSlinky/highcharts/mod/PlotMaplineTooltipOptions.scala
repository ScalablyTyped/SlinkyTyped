...
@js.native
trait PlotMaplineTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMaplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMaplineTooltipOptions {
  @scala.inline
  def apply(): PlotMaplineTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineTooltipOptions]
  }
  @scala.inline
  implicit class PlotMaplineTooltipOptionsOps[Self <: PlotMaplineTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMaplineTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
