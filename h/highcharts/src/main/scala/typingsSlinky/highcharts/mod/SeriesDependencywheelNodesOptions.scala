...
object SeriesDependencywheelNodesOptions {
  @scala.inline
  def apply(): SeriesDependencywheelNodesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesDependencywheelNodesOptions]
  }
  @scala.inline
  implicit class SeriesDependencywheelNodesOptionsOps[Self <: SeriesDependencywheelNodesOptions] (val x: Self) extends AnyVal {
    @scala.inline
