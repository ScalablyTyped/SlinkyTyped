...
trait PlotTimelineStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotTimelineStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotTimelineStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotTimelineStatesNormalOptions] = js.native
  /**
    * (Highcharts) Specific options for point in selected states, after being
    * selected by allowPointSelect or programmatically.
    */
  var select: js.UndefOr[PlotTimelineStatesSelectOptions] = js.native
}

object PlotTimelineStatesOptions {
  @scala.inline
  def apply(): PlotTimelineStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineStatesOptions]
  }
  @scala.inline
  implicit class PlotTimelineStatesOptionsOps[Self <: PlotTimelineStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotTimelineStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotTimelineStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotTimelineStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotTimelineStatesSelectOptions): Self = {
        val ret = this.duplicate
