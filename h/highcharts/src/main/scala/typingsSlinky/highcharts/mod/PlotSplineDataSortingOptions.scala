...
@js.native
trait PlotSplineDataSortingOptions extends StObject {
...
object PlotSplineDataSortingOptions {
  
  @scala.inline
  def apply(): PlotSplineDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotSplineDataSortingOptionsMutableBuilder[Self <: PlotSplineDataSortingOptions] (val x: Self) extends AnyVal {
