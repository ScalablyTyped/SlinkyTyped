...
@js.native
trait PlotSplineDataSortingOptions extends js.Object {
...
object PlotSplineDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotSplineDataSortingOptionsOps[Self <: PlotSplineDataSortingOptions] (val x: Self) extends AnyVal {
