...
object PlotLinearregressionslopeStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeStatesSelectHaloOptionsOps[Self <: PlotLinearregressionslopeStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
