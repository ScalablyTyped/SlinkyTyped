...
@js.native
trait PlotMacdDataSortingOptions extends StObject {
...
object PlotMacdDataSortingOptions {
  
  @scala.inline
  def apply(): PlotMacdDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotMacdDataSortingOptionsMutableBuilder[Self <: PlotMacdDataSortingOptions] (val x: Self) extends AnyVal {
