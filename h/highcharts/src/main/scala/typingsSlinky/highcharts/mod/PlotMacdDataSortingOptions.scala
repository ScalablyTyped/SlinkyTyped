...
@js.native
trait PlotMacdDataSortingOptions extends js.Object {
  /**
...
object PlotMacdDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotMacdDataSortingOptionsOps[Self <: PlotMacdDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
