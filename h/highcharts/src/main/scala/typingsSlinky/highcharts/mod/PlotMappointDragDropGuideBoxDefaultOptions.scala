...
object PlotMappointDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotMappointDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotMappointDragDropGuideBoxDefaultOptionsOps[Self <: PlotMappointDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
