...
trait PlotLinearregressionConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLinearregressionConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLinearregressionConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotLinearregressionConnectorsOptions {
  @scala.inline
  def apply(): PlotLinearregressionConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionConnectorsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionConnectorsOptionsOps[Self <: PlotLinearregressionConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotLinearregressionConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotLinearregressionConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotLinearregressionConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
