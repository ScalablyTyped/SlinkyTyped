...
trait SeriesPackedbubbleOptions extends PlotPackedbubbleOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[PointOptionsObject | (js.Array[js.Object | js.Array[_]])] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | packedbubble = js.native
...
object SeriesPackedbubbleOptions {
  
  @scala.inline
  def apply(`type`: String | packedbubble): SeriesPackedbubbleOptions = {
  ...
  @scala.inline
  implicit class SeriesPackedbubbleOptionsMutableBuilder[Self <: SeriesPackedbubbleOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: PointOptionsObject | (js.Array[js.Object | js.Array[_]])): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: (js.Object | js.Array[js.Any])*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | packedbubble): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
