...
object SeriesPackedbubbleOptions {
  ...
  @scala.inline
  implicit class SeriesPackedbubbleOptionsOps[Self <: SeriesPackedbubbleOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | packedbubble): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(value: (js.Object | js.Array[js.Any])*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: PointOptionsObject | (js.Array[js.Object | js.Array[_]])): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
