...
trait SeriesPackedbubbleOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[SeriesPackedbubbleDataOptions | (js.Array[js.Object | js.Array[_]])] = js.native
  /**
    * Not available
    */
...
object SeriesPackedbubbleOptions {
  ...
  implicit class SeriesPackedbubbleOptionsOps[Self <: SeriesPackedbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | packedbubble): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: SeriesPackedbubbleDataOptions | (js.Array[js.Object | js.Array[_]])): Self = {
        val ret = this.duplicate
