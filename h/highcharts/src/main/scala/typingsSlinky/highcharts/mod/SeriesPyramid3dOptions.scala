...
trait SeriesPyramid3dOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | js.Array[Double] | SeriesPyramid3dDataOptions]] = js.native
  /**
...
object SeriesPyramid3dOptions {
  ...
  implicit class SeriesPyramid3dOptionsOps[Self <: SeriesPyramid3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | pyramid3d): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | js.Array[Double] | SeriesPyramid3dDataOptions]): Self = {
        val ret = this.duplicate
