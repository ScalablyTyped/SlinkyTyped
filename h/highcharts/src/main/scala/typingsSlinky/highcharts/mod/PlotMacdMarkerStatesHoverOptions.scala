...
object PlotMacdMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotMacdMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMacdMarkerStatesHoverOptionsOps[Self <: PlotMacdMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
