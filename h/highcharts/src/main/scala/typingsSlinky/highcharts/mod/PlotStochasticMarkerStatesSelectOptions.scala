...
object PlotStochasticMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotStochasticMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotStochasticMarkerStatesSelectOptionsOps[Self <: PlotStochasticMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
