...
object PlotPyramidConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPyramidConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramidConnectorsMarkerOptionsOps[Self <: PlotPyramidConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
