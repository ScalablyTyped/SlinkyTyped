...
@js.native
trait PlotTemaZonesOptions extends js.Object {
  /**
...
object PlotTemaZonesOptions {
  @scala.inline
  def apply(): PlotTemaZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaZonesOptions]
  }
  @scala.inline
  implicit class PlotTemaZonesOptionsOps[Self <: PlotTemaZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
