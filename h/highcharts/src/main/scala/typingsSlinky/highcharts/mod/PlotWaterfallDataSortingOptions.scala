...
@js.native
trait PlotWaterfallDataSortingOptions extends js.Object {
  /**
...
object PlotWaterfallDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotWaterfallDataSortingOptionsOps[Self <: PlotWaterfallDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
