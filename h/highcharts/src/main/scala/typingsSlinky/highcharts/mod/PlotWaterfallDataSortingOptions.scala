...
@js.native
trait PlotWaterfallDataSortingOptions extends StObject {
...
object PlotWaterfallDataSortingOptions {
  
  @scala.inline
  def apply(): PlotWaterfallDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotWaterfallDataSortingOptionsMutableBuilder[Self <: PlotWaterfallDataSortingOptions] (val x: Self) extends AnyVal {
