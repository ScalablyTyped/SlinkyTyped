...
object PlotMapConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMapConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapConnectorsMarkerOptionsOps[Self <: PlotMapConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
