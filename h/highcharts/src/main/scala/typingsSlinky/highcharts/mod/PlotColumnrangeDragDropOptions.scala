...
trait PlotColumnrangeDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotColumnrangeDragDropDragHandleOptions] = js.native
  /**
...
object PlotColumnrangeDragDropOptions {
  @scala.inline
  def apply(): PlotColumnrangeDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDragDropOptions]
  }
  @scala.inline
  implicit class PlotColumnrangeDragDropOptionsOps[Self <: PlotColumnrangeDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotColumnrangeDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: PlotColumnrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
