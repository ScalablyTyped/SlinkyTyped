...
object PlotPriceenvelopesOptions {
  ...
  implicit class PlotPriceenvelopesOptionsOps[Self <: PlotPriceenvelopesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPriceenvelopesAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotPriceenvelopesBottomLineOptions): Self = this.set("bottomLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotPriceenvelopesDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotPriceenvelopesDataLabelsOptions | js.Array[PlotPriceenvelopesDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotPriceenvelopesParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotPriceenvelopesTopLineOptions): Self = this.set("topLine", value.asInstanceOf[js.Any])
