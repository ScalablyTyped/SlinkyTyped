...
@js.native
trait PlotPriceenvelopesOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPriceenvelopesAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  var dataLabels: js.UndefOr[
    PlotPriceenvelopesDataLabelsOptions | js.Array[PlotPriceenvelopesDataLabelsOptions]
  ] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions] = js.native
...
object PlotPriceenvelopesOptions {
  ...
  @scala.inline
  implicit class PlotPriceenvelopesOptionsMutableBuilder[Self <: PlotPriceenvelopesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPriceenvelopesAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotPriceenvelopesBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotPriceenvelopesDataLabelsOptions | js.Array[PlotPriceenvelopesDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotPriceenvelopesDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotPriceenvelopesParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotPriceenvelopesTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
