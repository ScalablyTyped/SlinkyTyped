...
trait SeriesBulletOptions extends PlotBulletOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | bullet = js.native
...
object SeriesBulletOptions {
  
  @scala.inline
  def apply(`type`: String | bullet): SeriesBulletOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesBulletOptions]
  }
  
  @scala.inline
  implicit class SeriesBulletOptionsMutableBuilder[Self <: SeriesBulletOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bullet): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
