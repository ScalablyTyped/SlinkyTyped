...
object SeriesBulletOptions {
  ...
  @scala.inline
  implicit class SeriesBulletOptionsOps[Self <: SeriesBulletOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bullet): Self = this.set("type", value.asInstanceOf[js.Any])
