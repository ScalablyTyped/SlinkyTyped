...
object PlotAreasplinerangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeDragDropGuideBoxDefaultOptionsOps[Self <: PlotAreasplinerangeDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
