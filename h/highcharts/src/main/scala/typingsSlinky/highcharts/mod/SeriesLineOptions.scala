...
trait SeriesLineOptions extends PlotLineOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | line = js.native
...
object SeriesLineOptions {
  ...
  @scala.inline
  def apply(`type`: String | line): SeriesLineOptions = {
  ...
  @scala.inline
  implicit class SeriesLineOptionsMutableBuilder[Self <: SeriesLineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | line): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
