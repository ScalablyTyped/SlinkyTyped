...
object SeriesLineOptions {
  ...
  @scala.inline
  implicit class SeriesLineOptionsOps[Self <: SeriesLineOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | line): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
