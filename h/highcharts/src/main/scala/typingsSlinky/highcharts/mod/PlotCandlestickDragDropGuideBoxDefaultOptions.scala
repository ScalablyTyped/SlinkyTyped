...
object PlotCandlestickDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotCandlestickDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotCandlestickDragDropGuideBoxDefaultOptionsOps[Self <: PlotCandlestickDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
