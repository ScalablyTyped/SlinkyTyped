...
@js.native
trait PlotCandlestickConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotCandlestickConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotCandlestickConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotCandlestickConnectorsEndMarkerOptionsOps[Self <: PlotCandlestickConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
