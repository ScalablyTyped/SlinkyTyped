...
object PlotMacdOptions {
  ...
  implicit class PlotMacdOptionsOps[Self <: PlotMacdOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMacdAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotMacdDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMacdDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMacdLine(value: PlotMacdMacdLineOptions): Self = this.set("macdLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotMacdParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSignalLine(value: PlotMacdSignalLineOptions): Self = this.set("signalLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSignalLine: Self = this.set("signalLine", js.undefined)
