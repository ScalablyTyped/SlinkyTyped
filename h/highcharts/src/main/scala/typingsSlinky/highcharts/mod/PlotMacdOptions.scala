...
trait PlotMacdOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMacdAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMacdDataSortingOptions] = js.native
...
object PlotMacdOptions {
  ...
  @scala.inline
  implicit class PlotMacdOptionsMutableBuilder[Self <: PlotMacdOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMacdAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotMacdDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMacdDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMacdLine(value: PlotMacdMacdLineOptions): Self = StObject.set(x, "macdLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotMacdParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSignalLine(value: PlotMacdSignalLineOptions): Self = StObject.set(x, "signalLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSignalLineUndefined: Self = StObject.set(x, "signalLine", js.undefined)
