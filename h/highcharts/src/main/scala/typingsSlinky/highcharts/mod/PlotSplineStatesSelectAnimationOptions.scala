...
object PlotSplineStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotSplineStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotSplineStatesSelectAnimationOptionsOps[Self <: PlotSplineStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
