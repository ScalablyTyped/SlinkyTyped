...
trait PlotStreamgraphStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotStreamgraphStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStreamgraphStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotStreamgraphStatesSelectOptions {
  @scala.inline
  def apply(): PlotStreamgraphStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphStatesSelectOptionsOps[Self <: PlotStreamgraphStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotStreamgraphStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotStreamgraphStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
