...
object SeriesPyramid3dDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesPyramid3dDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramid3dDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesPyramid3dDataAccessibilityOptionsOps[Self <: SeriesPyramid3dDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
