...
@js.native
trait PlotFunnel3dDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotFunnel3dDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotFunnel3dDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dDragDropGuideBoxDefaultOptionsOps[Self <: PlotFunnel3dDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
