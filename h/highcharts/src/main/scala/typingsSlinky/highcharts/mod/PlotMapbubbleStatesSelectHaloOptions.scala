...
object PlotMapbubbleStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotMapbubbleStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleStatesSelectHaloOptionsOps[Self <: PlotMapbubbleStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
