...
object PlotPyramidConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPyramidConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramidConnectorsStartMarkerOptionsOps[Self <: PlotPyramidConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
