...
object PlotStochasticConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotStochasticConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotStochasticConnectorsStartMarkerOptionsOps[Self <: PlotStochasticConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
