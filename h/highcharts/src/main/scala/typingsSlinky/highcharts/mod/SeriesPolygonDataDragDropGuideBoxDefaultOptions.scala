...
@js.native
trait SeriesPolygonDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesPolygonDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesPolygonDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPolygonDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesPolygonDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesPolygonDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
