...
object PlotTrendlineDataGroupingOptions {
  @scala.inline
  def apply(): PlotTrendlineDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotTrendlineDataGroupingOptionsOps[Self <: PlotTrendlineDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
