...
@js.native
trait PlotPsarDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPsarDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotPsarDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotPsarDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPsarDataLabelsOptionsMutableBuilder[Self <: PlotPsarDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPsarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
