...
@js.native
trait PlotPsarDataLabelsOptions extends js.Object {
...
object PlotPsarDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotPsarDataLabelsOptionsOps[Self <: PlotPsarDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPsarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
