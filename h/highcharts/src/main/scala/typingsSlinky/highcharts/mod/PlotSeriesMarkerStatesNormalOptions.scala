...
object PlotSeriesMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotSeriesMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotSeriesMarkerStatesNormalOptionsOps[Self <: PlotSeriesMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
