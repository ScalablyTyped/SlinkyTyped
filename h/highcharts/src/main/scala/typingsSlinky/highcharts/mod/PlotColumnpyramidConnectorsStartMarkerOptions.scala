...
object PlotColumnpyramidConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotColumnpyramidConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidConnectorsStartMarkerOptionsOps[Self <: PlotColumnpyramidConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
