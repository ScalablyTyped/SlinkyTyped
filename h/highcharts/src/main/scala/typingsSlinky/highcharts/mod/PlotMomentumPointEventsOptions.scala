...
object PlotMomentumPointEventsOptions {
  @scala.inline
  def apply(): PlotMomentumPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumPointEventsOptions]
  }
  @scala.inline
  implicit class PlotMomentumPointEventsOptionsOps[Self <: PlotMomentumPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
