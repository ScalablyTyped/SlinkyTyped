...
trait PlotCandlestickAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCandlestickAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotCandlestickAccessibilityOptions {
  @scala.inline
  def apply(): PlotCandlestickAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotCandlestickAccessibilityOptionsOps[Self <: PlotCandlestickAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotCandlestickAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
