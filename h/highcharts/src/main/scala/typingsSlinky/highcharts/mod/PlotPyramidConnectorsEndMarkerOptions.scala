...
object PlotPyramidConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPyramidConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPyramidConnectorsEndMarkerOptionsOps[Self <: PlotPyramidConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
