...
object PlotVectorConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVectorConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVectorConnectorsEndMarkerOptionsOps[Self <: PlotVectorConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
