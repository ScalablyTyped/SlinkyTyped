...
trait PlotWindbarbStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotWindbarbStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotWindbarbStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotWindbarbStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotWindbarbStatesSelectOptions] = js.native
}

object PlotWindbarbStatesOptions {
  @scala.inline
  def apply(): PlotWindbarbStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbStatesOptions]
  }
  @scala.inline
  implicit class PlotWindbarbStatesOptionsOps[Self <: PlotWindbarbStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotWindbarbStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotWindbarbStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotWindbarbStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotWindbarbStatesSelectOptions): Self = {
        val ret = this.duplicate
