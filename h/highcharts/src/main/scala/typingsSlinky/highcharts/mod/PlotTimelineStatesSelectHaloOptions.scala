...
object PlotTimelineStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTimelineStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTimelineStatesSelectHaloOptionsOps[Self <: PlotTimelineStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
