...
object PlotWilliamsrStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotWilliamsrStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrStatesSelectHaloOptionsOps[Self <: PlotWilliamsrStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
