...
object EarconOptionsObject {
  ...
  implicit class EarconOptionsObjectOps[Self <: EarconOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstrumentsVarargs(value: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument*): Self = this.set("instruments", js.Array(value :_*))
    @scala.inline
    def setInstruments(
      value: js.Array[
          typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument
