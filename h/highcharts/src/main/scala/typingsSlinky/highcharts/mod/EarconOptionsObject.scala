...
object EarconOptionsObject {
  ...
  implicit class EarconOptionsObjectMutableBuilder[Self <: EarconOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstrumentsVarargs(value: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument*): Self = StObject.set(x, "instruments", js.Array(value :_*))
