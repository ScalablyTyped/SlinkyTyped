...
object SeriesVectorDataMarkerStatesNormalOptions {
  @scala.inline
  def apply(): SeriesVectorDataMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataMarkerStatesNormalOptionsOps[Self <: SeriesVectorDataMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
