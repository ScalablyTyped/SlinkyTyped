...
@js.native
trait PlotAbandsDataSortingOptions extends StObject {
...
object PlotAbandsDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAbandsDataSortingOptionsMutableBuilder[Self <: PlotAbandsDataSortingOptions] (val x: Self) extends AnyVal {
