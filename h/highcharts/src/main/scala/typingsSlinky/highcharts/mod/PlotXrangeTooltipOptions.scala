...
@js.native
trait PlotXrangeTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotXrangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
    * (Highcharts, Highstock, Gantt) Distance from point to tooltip in pixels.
    */
...
object PlotXrangeTooltipOptions {
  @scala.inline
  def apply(): PlotXrangeTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeTooltipOptions]
  }
  @scala.inline
  implicit class PlotXrangeTooltipOptionsOps[Self <: PlotXrangeTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotXrangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
