...
@js.native
trait PlotParetoConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotParetoConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotParetoConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotParetoConnectorsMarkerOptionsOps[Self <: PlotParetoConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
