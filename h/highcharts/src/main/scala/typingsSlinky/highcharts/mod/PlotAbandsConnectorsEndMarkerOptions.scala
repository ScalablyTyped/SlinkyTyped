...
object PlotAbandsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAbandsConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAbandsConnectorsEndMarkerOptionsOps[Self <: PlotAbandsConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
