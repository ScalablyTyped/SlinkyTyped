...
object PlotSupertrendPointEventsOptions {
  @scala.inline
  def apply(): PlotSupertrendPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendPointEventsOptions]
  }
  @scala.inline
  implicit class PlotSupertrendPointEventsOptionsOps[Self <: PlotSupertrendPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
