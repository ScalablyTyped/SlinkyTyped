...
object PlotSmaConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSmaConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSmaConnectorsMarkerOptionsOps[Self <: PlotSmaConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
