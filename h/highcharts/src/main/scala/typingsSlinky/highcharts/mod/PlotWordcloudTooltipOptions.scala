...
trait PlotWordcloudTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWordcloudTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotWordcloudTooltipOptions {
  @scala.inline
  def apply(): PlotWordcloudTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudTooltipOptions]
  }
  @scala.inline
  implicit class PlotWordcloudTooltipOptionsOps[Self <: PlotWordcloudTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotWordcloudTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
