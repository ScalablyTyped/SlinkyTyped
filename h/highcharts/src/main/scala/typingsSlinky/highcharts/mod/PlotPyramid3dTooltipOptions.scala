...
trait PlotPyramid3dTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPyramid3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPyramid3dTooltipOptions {
  @scala.inline
  def apply(): PlotPyramid3dTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dTooltipOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dTooltipOptionsOps[Self <: PlotPyramid3dTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPyramid3dTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
