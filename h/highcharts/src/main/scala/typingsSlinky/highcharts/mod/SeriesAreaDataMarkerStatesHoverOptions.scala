...
@js.native
trait SeriesAreaDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesAreaDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesAreaDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataMarkerStatesHoverOptionsOps[Self <: SeriesAreaDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
