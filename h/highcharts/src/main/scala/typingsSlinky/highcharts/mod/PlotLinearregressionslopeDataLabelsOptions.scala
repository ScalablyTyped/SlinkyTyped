...
@js.native
trait PlotLinearregressionslopeDataLabelsOptions extends js.Object {
...
object PlotLinearregressionslopeDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionslopeDataLabelsOptionsOps[Self <: PlotLinearregressionslopeDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionslopeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
