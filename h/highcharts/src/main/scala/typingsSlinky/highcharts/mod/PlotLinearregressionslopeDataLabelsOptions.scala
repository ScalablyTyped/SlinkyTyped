...
@js.native
trait PlotLinearregressionslopeDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotLinearregressionslopeDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.native
...
object PlotLinearregressionslopeDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotLinearregressionslopeDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionslopeDataLabelsOptionsMutableBuilder[Self <: PlotLinearregressionslopeDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionslopeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
