...
object PlotCylinderConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotCylinderConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotCylinderConnectorsEndMarkerOptionsOps[Self <: PlotCylinderConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
