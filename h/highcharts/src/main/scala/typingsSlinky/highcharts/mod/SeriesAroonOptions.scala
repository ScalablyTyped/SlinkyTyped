...
trait SeriesAroonOptions extends PlotAroonOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | aroon = js.native
...
object SeriesAroonOptions {
  
  @scala.inline
  def apply(`type`: String | aroon): SeriesAroonOptions = {
  ...
  @scala.inline
  implicit class SeriesAroonOptionsMutableBuilder[Self <: SeriesAroonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | aroon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
