...
object SeriesAroonOptions {
  ...
  @scala.inline
  implicit class SeriesAroonOptionsOps[Self <: SeriesAroonOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | aroon): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
