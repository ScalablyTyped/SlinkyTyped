...
object PlotMaplineLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotMaplineLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotMaplineLastVisiblePriceLabelOptionsOps[Self <: PlotMaplineLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
