...
object PlotVariablepieConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotVariablepieConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariablepieConnectorsEndMarkerOptionsOps[Self <: PlotVariablepieConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
