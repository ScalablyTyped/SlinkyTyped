...
trait PlotCmfConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCmfConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCmfConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCmfConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotCmfConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotCmfConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotCmfConnectorsMarkerOptions = null,
    startMarker: PlotCmfConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotCmfConnectorsOptions = {
