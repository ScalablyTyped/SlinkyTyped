...
@js.native
trait PlotCmfConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCmfConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCmfConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCmfConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotCmfConnectorsOptions {
  @scala.inline
  def apply(): PlotCmfConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfConnectorsOptions]
  }
  @scala.inline
  implicit class PlotCmfConnectorsOptionsOps[Self <: PlotCmfConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotCmfConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotCmfConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotCmfConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
