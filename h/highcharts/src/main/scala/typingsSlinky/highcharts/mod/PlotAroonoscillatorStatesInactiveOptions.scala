...
object PlotAroonoscillatorStatesInactiveOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorStatesInactiveOptionsOps[Self <: PlotAroonoscillatorStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesInactiveAnimationOptions): Self = {
