...
@js.native
trait PlotEmaDataLabelsOptions extends js.Object {
...
object PlotEmaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotEmaDataLabelsOptionsOps[Self <: PlotEmaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotEmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
