...
@js.native
trait PlotEmaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotEmaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotEmaDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotEmaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotEmaDataLabelsOptionsMutableBuilder[Self <: PlotEmaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotEmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
