...
object PlotNetworkgraphConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotNetworkgraphConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphConnectorsStartMarkerOptionsOps[Self <: PlotNetworkgraphConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
