...
trait SeriesXrangeDataMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesXrangeDataMarkerStatesOptions] = js.native
  /**
...
object SeriesXrangeDataMarkerOptions {
  @scala.inline
  def apply(): SeriesXrangeDataMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataMarkerOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataMarkerOptionsOps[Self <: SeriesXrangeDataMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: SeriesXrangeDataMarkerStatesOptions): Self = {
        val ret = this.duplicate
