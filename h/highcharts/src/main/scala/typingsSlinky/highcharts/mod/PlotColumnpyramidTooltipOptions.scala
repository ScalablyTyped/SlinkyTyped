...
@js.native
trait PlotColumnpyramidTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotColumnpyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotColumnpyramidTooltipOptions {
  @scala.inline
  def apply(): PlotColumnpyramidTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidTooltipOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidTooltipOptionsOps[Self <: PlotColumnpyramidTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotColumnpyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
