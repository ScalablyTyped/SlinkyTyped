...
trait PlotColumnpyramidTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotColumnpyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotColumnpyramidTooltipOptions {
  ...
  def apply(
    ...
    dateTimeLabelFormats: PlotColumnpyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
  ...
  ): PlotColumnpyramidTooltipOptions = {
