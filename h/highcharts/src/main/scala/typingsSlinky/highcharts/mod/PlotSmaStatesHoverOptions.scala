...
trait PlotSmaStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSmaStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSmaStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotSmaStatesHoverOptions {
  @scala.inline
  def apply(): PlotSmaStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSmaStatesHoverOptionsOps[Self <: PlotSmaStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotSmaStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSmaStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
