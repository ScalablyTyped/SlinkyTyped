...
@js.native
trait PlotPivotpointsDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPivotpointsDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotPivotpointsDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotPivotpointsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPivotpointsDataLabelsOptionsMutableBuilder[Self <: PlotPivotpointsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPivotpointsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
