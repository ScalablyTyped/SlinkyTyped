...
@js.native
trait PlotPivotpointsDataLabelsOptions extends js.Object {
...
object PlotPivotpointsDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotPivotpointsDataLabelsOptionsOps[Self <: PlotPivotpointsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPivotpointsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
