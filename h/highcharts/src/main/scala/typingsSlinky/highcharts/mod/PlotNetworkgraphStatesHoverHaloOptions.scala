...
object PlotNetworkgraphStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotNetworkgraphStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphStatesHoverHaloOptionsOps[Self <: PlotNetworkgraphStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
