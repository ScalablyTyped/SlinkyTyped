...
trait SeriesNatrOptions extends PlotNatrOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | natr = js.native
...
object SeriesNatrOptions {
  ...
  @scala.inline
  def apply(`type`: String | natr): SeriesNatrOptions = {
  ...
  @scala.inline
  implicit class SeriesNatrOptionsMutableBuilder[Self <: SeriesNatrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | natr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
