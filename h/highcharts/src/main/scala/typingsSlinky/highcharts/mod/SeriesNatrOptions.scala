...
object SeriesNatrOptions {
  ...
  @scala.inline
  implicit class SeriesNatrOptionsOps[Self <: SeriesNatrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | natr): Self = this.set("type", value.asInstanceOf[js.Any])
