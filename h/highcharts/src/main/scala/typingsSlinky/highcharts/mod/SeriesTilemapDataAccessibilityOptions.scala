...
object SeriesTilemapDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesTilemapDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTilemapDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesTilemapDataAccessibilityOptionsOps[Self <: SeriesTilemapDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
