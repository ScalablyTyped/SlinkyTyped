...
object PlotAtrConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAtrConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAtrConnectorsStartMarkerOptionsOps[Self <: PlotAtrConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
