...
object PlotWordcloudConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotWordcloudConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotWordcloudConnectorsEndMarkerOptionsOps[Self <: PlotWordcloudConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
