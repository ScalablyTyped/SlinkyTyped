...
object PlotNetworkgraphPointEventsOptions {
  @scala.inline
  def apply(): PlotNetworkgraphPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphPointEventsOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphPointEventsOptionsOps[Self <: PlotNetworkgraphPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
