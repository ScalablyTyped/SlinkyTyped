...
object PlotPolygonMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPolygonMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPolygonMarkerStatesSelectOptionsOps[Self <: PlotPolygonMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
