...
object PlotAroonConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAroonConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonConnectorsStartMarkerOptionsOps[Self <: PlotAroonConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
