...
object PlotSmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotSmaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotSmaConnectorsStartMarkerOptionsOps[Self <: PlotSmaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
