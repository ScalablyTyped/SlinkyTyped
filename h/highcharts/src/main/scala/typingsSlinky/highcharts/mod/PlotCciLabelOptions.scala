...
@js.native
trait PlotCciLabelOptions extends js.Object {
  /**
...
object PlotCciLabelOptions {
  @scala.inline
  def apply(): PlotCciLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciLabelOptions]
  }
  @scala.inline
  implicit class PlotCciLabelOptionsOps[Self <: PlotCciLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
