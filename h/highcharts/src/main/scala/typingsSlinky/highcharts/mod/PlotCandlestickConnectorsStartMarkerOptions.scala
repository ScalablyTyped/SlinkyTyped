...
object PlotCandlestickConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotCandlestickConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotCandlestickConnectorsStartMarkerOptionsOps[Self <: PlotCandlestickConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
