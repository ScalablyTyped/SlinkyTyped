...
object PlotMfiMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotMfiMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMfiMarkerStatesSelectOptionsOps[Self <: PlotMfiMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
