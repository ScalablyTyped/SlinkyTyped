...
@js.native
trait PlotBulletConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBulletConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBulletConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBulletConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotBulletConnectorsOptions {
  @scala.inline
  def apply(): PlotBulletConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletConnectorsOptions]
  }
  @scala.inline
  implicit class PlotBulletConnectorsOptionsOps[Self <: PlotBulletConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotBulletConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotBulletConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotBulletConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
