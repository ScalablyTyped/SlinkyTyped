...
trait PlotBulletConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBulletConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBulletConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBulletConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBulletConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotBulletConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotBulletConnectorsMarkerOptions = null,
    startMarker: PlotBulletConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotBulletConnectorsOptions = {
