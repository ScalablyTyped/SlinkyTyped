...
object PlotScatter3dConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotScatter3dConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatter3dConnectorsMarkerOptionsOps[Self <: PlotScatter3dConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
