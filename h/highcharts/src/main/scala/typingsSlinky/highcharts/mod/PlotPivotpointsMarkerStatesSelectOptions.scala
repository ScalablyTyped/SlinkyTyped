...
object PlotPivotpointsMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPivotpointsMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsMarkerStatesSelectOptionsOps[Self <: PlotPivotpointsMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
