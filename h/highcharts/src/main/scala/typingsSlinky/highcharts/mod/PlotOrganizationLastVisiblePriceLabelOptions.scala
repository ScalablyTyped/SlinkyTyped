...
object PlotOrganizationLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotOrganizationLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotOrganizationLastVisiblePriceLabelOptionsOps[Self <: PlotOrganizationLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
