...
@js.native
trait SeriesVariwideDataEventsOptions extends js.Object {
  /**
...
object SeriesVariwideDataEventsOptions {
  @scala.inline
  def apply(): SeriesVariwideDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVariwideDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesVariwideDataEventsOptionsOps[Self <: SeriesVariwideDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
