...
@js.native
trait SeriesTilemapDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesTilemapDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesTilemapDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTilemapDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesTilemapDataDragDropDragHandleOptionsOps[Self <: SeriesTilemapDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
