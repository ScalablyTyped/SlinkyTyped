...
trait PlotMappointAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMappointAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMappointAccessibilityOptions {
  @scala.inline
  def apply(): PlotMappointAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMappointAccessibilityOptionsOps[Self <: PlotMappointAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMappointAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
