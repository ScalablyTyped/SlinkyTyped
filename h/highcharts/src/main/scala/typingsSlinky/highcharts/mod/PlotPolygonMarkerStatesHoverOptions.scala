...
object PlotPolygonMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotPolygonMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPolygonMarkerStatesHoverOptionsOps[Self <: PlotPolygonMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
