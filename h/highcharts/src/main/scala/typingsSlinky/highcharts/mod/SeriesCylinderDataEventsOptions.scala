...
@js.native
trait SeriesCylinderDataEventsOptions extends js.Object {
  /**
...
object SeriesCylinderDataEventsOptions {
  @scala.inline
  def apply(): SeriesCylinderDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesCylinderDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesCylinderDataEventsOptionsOps[Self <: SeriesCylinderDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
