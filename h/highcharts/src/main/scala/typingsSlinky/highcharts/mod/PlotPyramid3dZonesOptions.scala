...
@js.native
trait PlotPyramid3dZonesOptions extends js.Object {
  /**
...
object PlotPyramid3dZonesOptions {
  @scala.inline
  def apply(): PlotPyramid3dZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dZonesOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dZonesOptionsOps[Self <: PlotPyramid3dZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
