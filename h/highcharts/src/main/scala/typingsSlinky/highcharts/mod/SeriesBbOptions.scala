...
object SeriesBbOptions {
  ...
  @scala.inline
  implicit class SeriesBbOptionsOps[Self <: SeriesBbOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | bb): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
