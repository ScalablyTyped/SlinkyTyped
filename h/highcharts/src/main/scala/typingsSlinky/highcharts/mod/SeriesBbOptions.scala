...
trait SeriesBbOptions extends PlotBbOptions {
...
object SeriesBbOptions {
  ...
  @scala.inline
  def apply(`type`: String | bb): SeriesBbOptions = {
  ...
  @scala.inline
  implicit class SeriesBbOptionsMutableBuilder[Self <: SeriesBbOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bb): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
