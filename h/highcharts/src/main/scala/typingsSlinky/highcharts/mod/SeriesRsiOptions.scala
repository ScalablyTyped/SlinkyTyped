...
trait SeriesRsiOptions extends PlotRsiOptions {
...
object SeriesRsiOptions {
  ...
  @scala.inline
  def apply(`type`: String | rsi): SeriesRsiOptions = {
  ...
  @scala.inline
  implicit class SeriesRsiOptionsMutableBuilder[Self <: SeriesRsiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | rsi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
