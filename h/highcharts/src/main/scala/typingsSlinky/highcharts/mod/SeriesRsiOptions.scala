...
object SeriesRsiOptions {
  ...
  @scala.inline
  implicit class SeriesRsiOptionsOps[Self <: SeriesRsiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | rsi): Self = this.set("type", value.asInstanceOf[js.Any])
