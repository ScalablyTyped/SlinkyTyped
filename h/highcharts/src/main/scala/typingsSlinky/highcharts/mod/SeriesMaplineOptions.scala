...
object SeriesMaplineOptions {
  ...
  implicit class SeriesMaplineOptionsMutableBuilder[Self <: SeriesMaplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | js.Any)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | mapline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
