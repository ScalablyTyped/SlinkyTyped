...
object SeriesMaplineOptions {
  ...
  @scala.inline
  implicit class SeriesMaplineOptionsOps[Self <: SeriesMaplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | mapline): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | js.Any)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | _]): Self = this.set("data", value.asInstanceOf[js.Any])
