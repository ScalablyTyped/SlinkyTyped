...
- typingsSlinky.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, treemap, `type`, xAxis, yAxis */ trait SeriesMaplineOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | _]] = js.undefined
  /**
    * Not available
    */
