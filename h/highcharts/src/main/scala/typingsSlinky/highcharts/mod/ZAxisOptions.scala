...
object ZAxisOptions {
  ...
  @scala.inline
  implicit class ZAxisOptionsMutableBuilder[Self <: ZAxisOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: ZAxisEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGrid(value: ZAxisGridOptions): Self = StObject.set(x, "grid", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabels(value: ZAxisLabelsOptions): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPlotBands(value: js.Array[ZAxisPlotBandsOptions]): Self = StObject.set(x, "plotBands", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlotBandsUndefined: Self = StObject.set(x, "plotBands", js.undefined)
    
    @scala.inline
    def setPlotBandsVarargs(value: ZAxisPlotBandsOptions*): Self = StObject.set(x, "plotBands", js.Array(value :_*))
    
    @scala.inline
    def setPlotLines(value: js.Array[ZAxisPlotLinesOptions]): Self = StObject.set(x, "plotLines", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlotLinesUndefined: Self = StObject.set(x, "plotLines", js.undefined)
    
    @scala.inline
    def setPlotLinesVarargs(value: ZAxisPlotLinesOptions*): Self = StObject.set(x, "plotLines", js.Array(value :_*))
    ...
    @scala.inline
    def setScrollbar(value: ZAxisScrollbarOptions): Self = StObject.set(x, "scrollbar", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: ZAxisTitleOptions): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
