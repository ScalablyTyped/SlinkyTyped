...
trait ZAxisOptions extends AxisOptions {
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | ZAxisAccessibilityOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var currentDateIndicator: js.UndefOr[Boolean | ZAxisCurrentDateIndicatorOptions] = js.native
  /**
    ...
    *  (see online documentation for example)
    */
  var dateTimeLabelFormats: js.UndefOr[ZAxisDateTimeLabelFormatsOptions] = js.native
  /**
...
object ZAxisOptions {
  ...
  implicit class ZAxisOptionsOps[Self <: ZAxisOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAccessibility(value: js.Object | ZAxisAccessibilityOptions): Self = {
    ...
    @scala.inline
    def withCurrentDateIndicator(value: Boolean | ZAxisCurrentDateIndicatorOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: ZAxisDateTimeLabelFormatsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEvents(value: ZAxisEventsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGrid(value: ZAxisGridOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabels(value: ZAxisLabelsOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlotBands(value: js.Array[ZAxisPlotBandsOptions]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlotLines(value: js.Array[ZAxisPlotLinesOptions]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScrollbar(value: ZAxisScrollbarOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTitle(value: ZAxisTitleOptions): Self = {
        val ret = this.duplicate
