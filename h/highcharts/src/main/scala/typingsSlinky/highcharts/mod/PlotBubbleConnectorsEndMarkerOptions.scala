...
object PlotBubbleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBubbleConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBubbleConnectorsEndMarkerOptionsOps[Self <: PlotBubbleConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
