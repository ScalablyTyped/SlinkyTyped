...
trait PlotVwapAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVwapAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotVwapAccessibilityOptions {
  @scala.inline
  def apply(): PlotVwapAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotVwapAccessibilityOptionsOps[Self <: PlotVwapAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotVwapAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
