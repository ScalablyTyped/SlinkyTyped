...
object PlotPriceenvelopesMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesMarkerStatesInactiveOptionsOps[Self <: PlotPriceenvelopesMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
