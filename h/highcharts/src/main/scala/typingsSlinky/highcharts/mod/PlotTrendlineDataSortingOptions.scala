...
@js.native
trait PlotTrendlineDataSortingOptions extends StObject {
...
object PlotTrendlineDataSortingOptions {
  
  @scala.inline
  def apply(): PlotTrendlineDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotTrendlineDataSortingOptionsMutableBuilder[Self <: PlotTrendlineDataSortingOptions] (val x: Self) extends AnyVal {
