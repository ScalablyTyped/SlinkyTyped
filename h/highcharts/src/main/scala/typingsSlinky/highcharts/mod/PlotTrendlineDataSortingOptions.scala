...
@js.native
trait PlotTrendlineDataSortingOptions extends js.Object {
  /**
...
object PlotTrendlineDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotTrendlineDataSortingOptionsOps[Self <: PlotTrendlineDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
