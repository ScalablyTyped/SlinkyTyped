...
object PlotCmfMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotCmfMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotCmfMarkerStatesSelectOptionsOps[Self <: PlotCmfMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
