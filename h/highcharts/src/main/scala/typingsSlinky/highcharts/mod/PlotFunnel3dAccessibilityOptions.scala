...
trait PlotFunnel3dAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotFunnel3dAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotFunnel3dAccessibilityOptions {
  @scala.inline
  def apply(): PlotFunnel3dAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dAccessibilityOptionsOps[Self <: PlotFunnel3dAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotFunnel3dAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
