...
@js.native
trait PlotTemaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTemaStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTemaStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotTemaStatesHoverOptions {
  @scala.inline
  def apply(): PlotTemaStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTemaStatesHoverOptionsOps[Self <: PlotTemaStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotTemaStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTemaStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
