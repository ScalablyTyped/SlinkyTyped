...
@js.native
trait PlotAbandsStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotAbandsStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotAbandsStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotAbandsStatesSelectHaloOptionsOps[Self <: PlotAbandsStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
