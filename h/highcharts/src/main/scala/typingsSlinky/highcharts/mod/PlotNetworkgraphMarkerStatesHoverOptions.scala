...
object PlotNetworkgraphMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotNetworkgraphMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphMarkerStatesHoverOptionsOps[Self <: PlotNetworkgraphMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
