...
@js.native
trait PlotSlowstochasticDataSortingOptions extends js.Object {
  /**
...
object PlotSlowstochasticDataSortingOptions {
  @scala.inline
  def apply(): PlotSlowstochasticDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticDataSortingOptions]
  }
  @scala.inline
  implicit class PlotSlowstochasticDataSortingOptionsOps[Self <: PlotSlowstochasticDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
