...
object NavigatorXAxisDateTimeLabelFormatsSecondOptions {
  @scala.inline
  def apply(): NavigatorXAxisDateTimeLabelFormatsSecondOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisDateTimeLabelFormatsSecondOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisDateTimeLabelFormatsSecondOptionsOps[Self <: NavigatorXAxisDateTimeLabelFormatsSecondOptions] (val x: Self) extends AnyVal {
    @scala.inline
