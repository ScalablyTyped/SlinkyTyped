...
trait PlotMapAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMapAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotMapAccessibilityOptions {
  @scala.inline
  def apply(): PlotMapAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotMapAccessibilityOptionsOps[Self <: PlotMapAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotMapAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
