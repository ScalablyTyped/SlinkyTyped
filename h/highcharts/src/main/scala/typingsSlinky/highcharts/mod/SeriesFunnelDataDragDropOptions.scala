...
trait SeriesFunnelDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesFunnelDataDragDropDragHandleOptions] = js.native
  /**
...
object SeriesFunnelDataDragDropOptions {
  @scala.inline
  def apply(): SeriesFunnelDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFunnelDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesFunnelDataDragDropOptionsOps[Self <: SeriesFunnelDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesFunnelDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesFunnelDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
