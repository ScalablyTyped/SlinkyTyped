...
object PlotSolidgaugeLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotSolidgaugeLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeLastVisiblePriceLabelOptionsOps[Self <: PlotSolidgaugeLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
