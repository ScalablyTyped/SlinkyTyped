...
trait PlotSupertrendConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSupertrendConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSupertrendConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSupertrendConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSupertrendConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotSupertrendConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotSupertrendConnectorsMarkerOptions = null,
    startMarker: PlotSupertrendConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotSupertrendConnectorsOptions = {
