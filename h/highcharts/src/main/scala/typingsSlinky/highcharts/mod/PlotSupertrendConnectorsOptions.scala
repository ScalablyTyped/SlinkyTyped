...
@js.native
trait PlotSupertrendConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSupertrendConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSupertrendConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSupertrendConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSupertrendConnectorsOptions {
  @scala.inline
  def apply(): PlotSupertrendConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSupertrendConnectorsOptionsOps[Self <: PlotSupertrendConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSupertrendConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSupertrendConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSupertrendConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
