...
object PlotApoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotApoConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotApoConnectorsStartMarkerOptionsOps[Self <: PlotApoConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
