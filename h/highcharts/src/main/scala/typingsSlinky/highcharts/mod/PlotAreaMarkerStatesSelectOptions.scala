...
object PlotAreaMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAreaMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAreaMarkerStatesSelectOptionsOps[Self <: PlotAreaMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
