...
@js.native
trait SeriesScatter3dDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesScatter3dDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataMarkerStatesHoverOptionsOps[Self <: SeriesScatter3dDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
