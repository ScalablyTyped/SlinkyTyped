...
trait PlotRsiConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotRsiConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotRsiConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotRsiConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotRsiConnectorsOptions {
  @scala.inline
  def apply(): PlotRsiConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiConnectorsOptions]
  }
  @scala.inline
  implicit class PlotRsiConnectorsOptionsOps[Self <: PlotRsiConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotRsiConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotRsiConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotRsiConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
