...
object PlotRsiConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotRsiConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotRsiConnectorsEndMarkerOptionsOps[Self <: PlotRsiConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
