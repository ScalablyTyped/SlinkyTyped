...
object NavigatorYAxisCrosshairLabelOptions {
  @scala.inline
  def apply(): NavigatorYAxisCrosshairLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisCrosshairLabelOptions]
  }
  @scala.inline
  implicit class NavigatorYAxisCrosshairLabelOptionsOps[Self <: NavigatorYAxisCrosshairLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
