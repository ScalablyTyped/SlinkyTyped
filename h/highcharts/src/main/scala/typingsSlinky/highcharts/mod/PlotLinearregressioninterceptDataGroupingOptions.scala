...
object PlotLinearregressioninterceptDataGroupingOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptDataGroupingOptionsOps[Self <: PlotLinearregressioninterceptDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
