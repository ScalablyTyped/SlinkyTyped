...
@js.native
trait PlotHeatmapDataSortingOptions extends js.Object {
...
object PlotHeatmapDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotHeatmapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotHeatmapDataSortingOptionsOps[Self <: PlotHeatmapDataSortingOptions] (val x: Self) extends AnyVal {
