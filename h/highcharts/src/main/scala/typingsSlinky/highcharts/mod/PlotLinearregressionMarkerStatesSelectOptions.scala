...
object PlotLinearregressionMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressionMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionMarkerStatesSelectOptionsOps[Self <: PlotLinearregressionMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
