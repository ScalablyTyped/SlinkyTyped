...
trait PlotRocTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotRocTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotRocTooltipOptions {
  @scala.inline
  def apply(): PlotRocTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocTooltipOptions]
  }
  @scala.inline
  implicit class PlotRocTooltipOptionsOps[Self <: PlotRocTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotRocTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
