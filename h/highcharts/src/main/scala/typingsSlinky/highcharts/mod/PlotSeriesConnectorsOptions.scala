...
@js.native
trait PlotSeriesConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSeriesConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSeriesConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSeriesConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSeriesConnectorsOptions {
  @scala.inline
  def apply(): PlotSeriesConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSeriesConnectorsOptionsOps[Self <: PlotSeriesConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSeriesConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSeriesConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSeriesConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
