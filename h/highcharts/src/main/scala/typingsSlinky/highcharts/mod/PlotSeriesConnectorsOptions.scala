...
trait PlotSeriesConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSeriesConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSeriesConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSeriesConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotSeriesConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotSeriesConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotSeriesConnectorsMarkerOptions = null,
    startMarker: PlotSeriesConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotSeriesConnectorsOptions = {
