...
trait SeriesNetworkgraphOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[SeriesNetworkgraphDataOptions | (js.Array[js.Object | js.Array[_] | Double])] = js.native
  /**
...
object SeriesNetworkgraphOptions {
  ...
  implicit class SeriesNetworkgraphOptionsOps[Self <: SeriesNetworkgraphOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | networkgraph): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: SeriesNetworkgraphDataOptions | (js.Array[js.Object | js.Array[_] | Double])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNodes(value: js.Array[SeriesNetworkgraphNodesOptions]): Self = {
        val ret = this.duplicate
