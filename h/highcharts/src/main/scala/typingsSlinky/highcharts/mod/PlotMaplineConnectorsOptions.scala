...
trait PlotMaplineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMaplineConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMaplineConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMaplineConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotMaplineConnectorsOptions {
  @scala.inline
  def apply(): PlotMaplineConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineConnectorsOptions]
  }
  @scala.inline
  implicit class PlotMaplineConnectorsOptionsOps[Self <: PlotMaplineConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotMaplineConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotMaplineConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotMaplineConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
