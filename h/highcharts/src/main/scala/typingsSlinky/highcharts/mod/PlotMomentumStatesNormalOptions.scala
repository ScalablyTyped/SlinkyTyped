...
object PlotMomentumStatesNormalOptions {
  @scala.inline
  def apply(): PlotMomentumStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotMomentumStatesNormalOptionsOps[Self <: PlotMomentumStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
