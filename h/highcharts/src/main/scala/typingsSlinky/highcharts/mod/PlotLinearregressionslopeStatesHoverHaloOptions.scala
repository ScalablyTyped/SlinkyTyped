...
object PlotLinearregressionslopeStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeStatesHoverHaloOptionsOps[Self <: PlotLinearregressionslopeStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
