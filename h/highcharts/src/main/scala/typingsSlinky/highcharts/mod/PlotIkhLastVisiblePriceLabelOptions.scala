...
object PlotIkhLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotIkhLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotIkhLastVisiblePriceLabelOptionsOps[Self <: PlotIkhLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
