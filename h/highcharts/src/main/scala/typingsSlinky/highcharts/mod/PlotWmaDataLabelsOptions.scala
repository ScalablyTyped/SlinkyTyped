...
object PlotWmaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotWmaDataLabelsOptionsMutableBuilder[Self <: PlotWmaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
