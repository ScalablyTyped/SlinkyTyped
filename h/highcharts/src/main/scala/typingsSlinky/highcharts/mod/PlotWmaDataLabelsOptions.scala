...
@js.native
trait PlotWmaDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotWmaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotWmaDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotWmaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotWmaDataLabelsOptionsOps[Self <: PlotWmaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
