...
trait EarconConfiguration extends StObject {
  ...
  /**
    * An Earcon instance.
    */
  var earcon: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon = js.native
...
object EarconConfiguration {
  ...
  @scala.inline
  def apply(earcon: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon): EarconConfiguration = {
  ...
  implicit class EarconConfigurationMutableBuilder[Self <: EarconConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEarcon(value: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon): Self = StObject.set(x, "earcon", value.asInstanceOf[js.Any])
