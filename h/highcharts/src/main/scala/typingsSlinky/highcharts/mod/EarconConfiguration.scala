...
trait EarconConfiguration extends js.Object {
  ...
  /**
    * An Earcon instance.
    */
  var earcon: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon
  /**
...
object EarconConfiguration {
  @scala.inline
  def apply(
    earcon: typingsSlinky.highcharts.sonificationMod.highchartsAugmentingMod.Earcon,
