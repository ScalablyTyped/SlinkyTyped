...
object SeriesPackedbubbleDataEventsOptions {
  @scala.inline
  def apply(): SeriesPackedbubbleDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPackedbubbleDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesPackedbubbleDataEventsOptionsOps[Self <: SeriesPackedbubbleDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
