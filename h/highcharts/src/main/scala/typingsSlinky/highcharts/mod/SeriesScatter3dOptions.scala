...
trait SeriesScatter3dOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | SeriesScatter3dDataOptions]] = js.native
  /**
...
object SeriesScatter3dOptions {
  ...
  implicit class SeriesScatter3dOptionsOps[Self <: SeriesScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | scatter3d): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[js.Array[Double] | SeriesScatter3dDataOptions]): Self = {
        val ret = this.duplicate
