...
trait SeriesMappointOptions
  extends PlotMappointOptions
...
object SeriesMappointOptions {
  ...
  implicit class SeriesMappointOptionsOps[Self <: SeriesMappointOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | mappoint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions]): Self = {
        val ret = this.duplicate
