...
trait SeriesMappointOptions extends PlotMappointOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    js.Array[Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions]
  ] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | mappoint = js.native
...
object SeriesMappointOptions {
  ...
  @scala.inline
  def apply(`type`: String | mappoint): SeriesMappointOptions = {
  ...
  @scala.inline
  implicit class SeriesMappointOptionsMutableBuilder[Self <: SeriesMappointOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | mappoint): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
