...
object SeriesMappointOptions {
  ...
  @scala.inline
  implicit class SeriesMappointOptionsOps[Self <: SeriesMappointOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | mappoint): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions]): Self = this.set("data", value.asInstanceOf[js.Any])
