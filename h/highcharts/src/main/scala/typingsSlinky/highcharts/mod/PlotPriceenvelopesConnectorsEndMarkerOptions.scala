...
object PlotPriceenvelopesConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPriceenvelopesConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPriceenvelopesConnectorsEndMarkerOptionsOps[Self <: PlotPriceenvelopesConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
