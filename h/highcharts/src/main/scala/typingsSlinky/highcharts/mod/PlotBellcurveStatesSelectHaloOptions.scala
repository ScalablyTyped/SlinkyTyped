...
@js.native
trait PlotBellcurveStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotBellcurveStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotBellcurveStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotBellcurveStatesSelectHaloOptionsOps[Self <: PlotBellcurveStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
