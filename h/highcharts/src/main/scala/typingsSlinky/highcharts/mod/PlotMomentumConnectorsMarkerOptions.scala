...
object PlotMomentumConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotMomentumConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotMomentumConnectorsMarkerOptionsOps[Self <: PlotMomentumConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
