...
@js.native
trait PlotVectorStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVectorStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVectorStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotVectorStatesHoverOptions {
  @scala.inline
  def apply(): PlotVectorStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotVectorStatesHoverOptionsOps[Self <: PlotVectorStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotVectorStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotVectorStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
