...
object NavigatorYAxisLabelsOptions {
  ...
  @scala.inline
  implicit class NavigatorYAxisLabelsOptionsMutableBuilder[Self <: NavigatorYAxisLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevels(value: js.Array[NavigatorYAxisLabelsLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    @scala.inline
    def setLevelsVarargs(value: NavigatorYAxisLabelsLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
    ...
    @scala.inline
    def setSymbol(value: NavigatorYAxisLabelsSymbolOptions): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
