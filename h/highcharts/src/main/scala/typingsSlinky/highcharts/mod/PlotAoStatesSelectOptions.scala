...
@js.native
trait PlotAoStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAoStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAoStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotAoStatesSelectOptions {
  @scala.inline
  def apply(): PlotAoStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAoStatesSelectOptionsOps[Self <: PlotAoStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotAoStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAoStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
