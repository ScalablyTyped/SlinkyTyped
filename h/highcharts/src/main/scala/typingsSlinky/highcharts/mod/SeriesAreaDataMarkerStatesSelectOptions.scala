...
object SeriesAreaDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(): SeriesAreaDataMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataMarkerStatesSelectOptionsOps[Self <: SeriesAreaDataMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
