...
object SeriesTimelineOptions {
  ...
  @scala.inline
  implicit class SeriesTimelineOptionsMutableBuilder[Self <: SeriesTimelineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(value: PointOptionsObject*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | timeline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
