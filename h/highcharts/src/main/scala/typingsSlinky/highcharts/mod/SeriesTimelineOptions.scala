...
trait SeriesTimelineOptions extends PlotTimelineOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | timeline = js.native
...
object SeriesTimelineOptions {
  ...
  @scala.inline
  def apply(`type`: String | timeline): SeriesTimelineOptions = {
  ...
  @scala.inline
  implicit class SeriesTimelineOptionsOps[Self <: SeriesTimelineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | timeline): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: PointOptionsObject*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
