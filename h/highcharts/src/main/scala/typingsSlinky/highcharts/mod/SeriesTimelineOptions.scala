...
trait SeriesTimelineOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[SeriesTimelineDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesTimelineOptions {
  ...
  implicit class SeriesTimelineOptionsOps[Self <: SeriesTimelineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | timeline): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[SeriesTimelineDataOptions]): Self = {
        val ret = this.duplicate
