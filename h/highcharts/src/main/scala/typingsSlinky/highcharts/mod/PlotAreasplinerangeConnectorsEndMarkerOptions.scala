...
object PlotAreasplinerangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeConnectorsEndMarkerOptionsOps[Self <: PlotAreasplinerangeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
