...
object PlotWmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotWmaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotWmaConnectorsStartMarkerOptionsOps[Self <: PlotWmaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
