...
object PlotStreamgraphMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotStreamgraphMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphMarkerStatesHoverOptionsOps[Self <: PlotStreamgraphMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
