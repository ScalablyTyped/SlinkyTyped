...
trait PlotPolygonAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPolygonAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotPolygonAccessibilityOptions {
  @scala.inline
  def apply(): PlotPolygonAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotPolygonAccessibilityOptionsOps[Self <: PlotPolygonAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotPolygonAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
