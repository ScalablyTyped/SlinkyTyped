...
trait PlotSankeyStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotSankeyStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for a single point node/link.
    */
  var inactive: js.UndefOr[PlotSankeyStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotSankeyStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotSankeyStatesSelectOptions] = js.native
}

object PlotSankeyStatesOptions {
  @scala.inline
  def apply(): PlotSankeyStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyStatesOptions]
  }
  @scala.inline
  implicit class PlotSankeyStatesOptionsOps[Self <: PlotSankeyStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotSankeyStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotSankeyStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotSankeyStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotSankeyStatesSelectOptions): Self = {
        val ret = this.duplicate
