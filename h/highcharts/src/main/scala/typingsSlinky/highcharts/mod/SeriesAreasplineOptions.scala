...
trait SeriesAreasplineOptions extends PlotAreasplineOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | areaspline = js.native
...
object SeriesAreasplineOptions {
  
  @scala.inline
  def apply(`type`: String | areaspline): SeriesAreasplineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesAreasplineOptions]
  }
  
  @scala.inline
  implicit class SeriesAreasplineOptionsMutableBuilder[Self <: SeriesAreasplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | areaspline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
