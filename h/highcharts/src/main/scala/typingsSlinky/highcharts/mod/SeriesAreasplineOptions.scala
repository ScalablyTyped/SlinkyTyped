...
object SeriesAreasplineOptions {
  ...
  @scala.inline
  implicit class SeriesAreasplineOptionsOps[Self <: SeriesAreasplineOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | areaspline): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
