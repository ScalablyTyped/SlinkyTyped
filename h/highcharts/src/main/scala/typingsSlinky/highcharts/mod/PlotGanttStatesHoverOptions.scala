...
@js.native
trait PlotGanttStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotGanttStatesHoverAnimationOptions] = js.native
  /**
...
object PlotGanttStatesHoverOptions {
  @scala.inline
  def apply(): PlotGanttStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotGanttStatesHoverOptionsOps[Self <: PlotGanttStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotGanttStatesHoverAnimationOptions): Self = {
