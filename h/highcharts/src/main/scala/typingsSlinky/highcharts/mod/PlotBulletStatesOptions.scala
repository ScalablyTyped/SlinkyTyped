...
trait PlotBulletStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotBulletStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotBulletStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotBulletStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotBulletStatesSelectOptions] = js.native
}

object PlotBulletStatesOptions {
  @scala.inline
  def apply(): PlotBulletStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletStatesOptions]
  }
  @scala.inline
  implicit class PlotBulletStatesOptionsOps[Self <: PlotBulletStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotBulletStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotBulletStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotBulletStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotBulletStatesSelectOptions): Self = {
        val ret = this.duplicate
