...
object PlotRsiMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotRsiMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerStatesNormalOptionsOps[Self <: PlotRsiMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
