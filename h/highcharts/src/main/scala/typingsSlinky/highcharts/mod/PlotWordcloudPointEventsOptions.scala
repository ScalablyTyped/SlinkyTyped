...
object PlotWordcloudPointEventsOptions {
  @scala.inline
  def apply(): PlotWordcloudPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudPointEventsOptions]
  }
  @scala.inline
  implicit class PlotWordcloudPointEventsOptionsOps[Self <: PlotWordcloudPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
