...
trait PlotScatter3dMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatter3dMarkerStatesOptions] = js.native
  /**
...
object PlotScatter3dMarkerOptions {
  @scala.inline
  def apply(): PlotScatter3dMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatter3dMarkerOptionsOps[Self <: PlotScatter3dMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotScatter3dMarkerStatesOptions): Self = {
        val ret = this.duplicate
