...
trait PlotLinearregressionMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionMarkerStatesOptions] = js.native
  /**
...
object PlotLinearregressionMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionMarkerOptionsOps[Self <: PlotLinearregressionMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotLinearregressionMarkerStatesOptions): Self = {
        val ret = this.duplicate
