...
trait SeriesBulletDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesBulletDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesBulletDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesBulletDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesBulletDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesBulletDataDragDropOptions = {
