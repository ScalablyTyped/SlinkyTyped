...
@js.native
trait PlotLinearregressioninterceptDataSortingOptions extends StObject {
...
object PlotLinearregressioninterceptDataSortingOptions {
  
  @scala.inline
  def apply(): PlotLinearregressioninterceptDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressioninterceptDataSortingOptionsMutableBuilder[Self <: PlotLinearregressioninterceptDataSortingOptions] (val x: Self) extends AnyVal {
