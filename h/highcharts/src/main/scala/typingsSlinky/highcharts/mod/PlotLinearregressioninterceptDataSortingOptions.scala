...
@js.native
trait PlotLinearregressioninterceptDataSortingOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressioninterceptDataSortingOptionsOps[Self <: PlotLinearregressioninterceptDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
