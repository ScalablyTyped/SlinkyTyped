...
object PlotPpoConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotPpoConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotPpoConnectorsMarkerOptionsOps[Self <: PlotPpoConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
