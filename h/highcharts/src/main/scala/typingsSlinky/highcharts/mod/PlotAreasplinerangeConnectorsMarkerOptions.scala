...
@js.native
trait PlotAreasplinerangeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAreasplinerangeConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeConnectorsMarkerOptionsOps[Self <: PlotAreasplinerangeConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
