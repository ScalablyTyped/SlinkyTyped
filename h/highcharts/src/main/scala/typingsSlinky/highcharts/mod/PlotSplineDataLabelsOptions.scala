...
@js.native
trait PlotSplineDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotSplineDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotSplineDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotSplineDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotSplineDataLabelsOptionsOps[Self <: PlotSplineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
