...
object PlotSplineDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotSplineDataLabelsOptionsMutableBuilder[Self <: PlotSplineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
