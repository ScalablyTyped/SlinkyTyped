...
trait PlotMacdConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMacdConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMacdConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMacdConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMacdConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotMacdConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotMacdConnectorsMarkerOptions = null,
    startMarker: PlotMacdConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMacdConnectorsOptions = {
