...
@js.native
trait PlotMacdConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMacdConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMacdConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMacdConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotMacdConnectorsOptions {
  @scala.inline
  def apply(): PlotMacdConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdConnectorsOptions]
  }
  @scala.inline
  implicit class PlotMacdConnectorsOptionsOps[Self <: PlotMacdConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotMacdConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotMacdConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotMacdConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
