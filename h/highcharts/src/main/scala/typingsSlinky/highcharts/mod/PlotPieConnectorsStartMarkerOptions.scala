...
object PlotPieConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPieConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPieConnectorsStartMarkerOptionsOps[Self <: PlotPieConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
