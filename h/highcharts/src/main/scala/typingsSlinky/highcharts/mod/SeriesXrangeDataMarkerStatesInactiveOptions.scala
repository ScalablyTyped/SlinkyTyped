...
object SeriesXrangeDataMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): SeriesXrangeDataMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataMarkerStatesInactiveOptionsOps[Self <: SeriesXrangeDataMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
