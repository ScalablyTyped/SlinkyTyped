...
object ZAxisDateTimeLabelFormatsMonthOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsMonthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsMonthOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsMonthOptionsOps[Self <: ZAxisDateTimeLabelFormatsMonthOptions] (val x: Self) extends AnyVal {
    @scala.inline
