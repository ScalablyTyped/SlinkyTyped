...
object PlotArearangeLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotArearangeLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotArearangeLastVisiblePriceLabelOptionsOps[Self <: PlotArearangeLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
