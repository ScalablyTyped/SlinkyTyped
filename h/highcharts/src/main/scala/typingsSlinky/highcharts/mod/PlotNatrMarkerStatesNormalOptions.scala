...
object PlotNatrMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotNatrMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotNatrMarkerStatesNormalOptionsOps[Self <: PlotNatrMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
