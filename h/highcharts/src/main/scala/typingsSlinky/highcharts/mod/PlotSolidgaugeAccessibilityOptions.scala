...
@js.native
trait PlotSolidgaugeAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSolidgaugeAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSolidgaugeAccessibilityOptions {
  @scala.inline
  def apply(): PlotSolidgaugeAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeAccessibilityOptionsOps[Self <: PlotSolidgaugeAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSolidgaugeAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
