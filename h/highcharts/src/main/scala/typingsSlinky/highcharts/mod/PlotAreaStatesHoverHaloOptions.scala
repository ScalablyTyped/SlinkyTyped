...
@js.native
trait PlotAreaStatesHoverHaloOptions extends js.Object {
  /**
...
object PlotAreaStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotAreaStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotAreaStatesHoverHaloOptionsOps[Self <: PlotAreaStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
