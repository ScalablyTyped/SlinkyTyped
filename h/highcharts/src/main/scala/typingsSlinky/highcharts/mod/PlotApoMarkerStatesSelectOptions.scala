...
@js.native
trait PlotApoMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotApoMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotApoMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotApoMarkerStatesSelectOptionsOps[Self <: PlotApoMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
