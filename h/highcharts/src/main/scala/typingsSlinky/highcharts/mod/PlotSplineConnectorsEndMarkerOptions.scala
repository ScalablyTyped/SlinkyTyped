...
@js.native
trait PlotSplineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSplineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSplineConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSplineConnectorsEndMarkerOptionsOps[Self <: PlotSplineConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
