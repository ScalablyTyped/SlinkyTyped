...
object PlotPyramid3dDataGroupingOptions {
  @scala.inline
  def apply(): PlotPyramid3dDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPyramid3dDataGroupingOptionsOps[Self <: PlotPyramid3dDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
