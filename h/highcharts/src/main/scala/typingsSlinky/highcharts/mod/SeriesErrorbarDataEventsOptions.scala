...
object SeriesErrorbarDataEventsOptions {
  @scala.inline
  def apply(): SeriesErrorbarDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesErrorbarDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesErrorbarDataEventsOptionsOps[Self <: SeriesErrorbarDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
