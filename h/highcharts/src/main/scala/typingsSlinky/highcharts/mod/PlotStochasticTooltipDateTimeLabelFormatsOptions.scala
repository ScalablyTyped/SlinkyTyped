...
@js.native
trait PlotStochasticTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotStochasticTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotStochasticTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotStochasticTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotStochasticTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
