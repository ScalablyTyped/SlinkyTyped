...
@js.native
trait PlotPolygonTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPolygonTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPolygonTooltipOptions {
  @scala.inline
  def apply(): PlotPolygonTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonTooltipOptions]
  }
  @scala.inline
  implicit class PlotPolygonTooltipOptionsOps[Self <: PlotPolygonTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPolygonTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
