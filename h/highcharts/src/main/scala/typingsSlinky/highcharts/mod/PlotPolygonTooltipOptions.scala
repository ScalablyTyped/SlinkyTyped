...
trait PlotPolygonTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPolygonTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotPolygonTooltipOptions {
  ...
  def apply(
    ...
    dateTimeLabelFormats: PlotPolygonTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
