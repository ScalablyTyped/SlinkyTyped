...
object PlotFlagsDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotFlagsDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotFlagsDragDropDragHandleOptionsOps[Self <: PlotFlagsDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
