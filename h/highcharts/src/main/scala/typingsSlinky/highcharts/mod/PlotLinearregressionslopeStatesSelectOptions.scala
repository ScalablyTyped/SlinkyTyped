...
trait PlotLinearregressionslopeStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressionslopeStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionslopeStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotLinearregressionslopeStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeStatesSelectOptionsOps[Self <: PlotLinearregressionslopeStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotLinearregressionslopeStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLinearregressionslopeStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
