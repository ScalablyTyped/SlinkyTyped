...
object PlotWindbarbConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotWindbarbConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotWindbarbConnectorsStartMarkerOptionsOps[Self <: PlotWindbarbConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
