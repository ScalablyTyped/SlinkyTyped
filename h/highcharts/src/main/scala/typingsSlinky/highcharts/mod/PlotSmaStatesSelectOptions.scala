...
@js.native
trait PlotSmaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotSmaStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSmaStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotSmaStatesSelectOptions {
  @scala.inline
  def apply(): PlotSmaStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSmaStatesSelectOptionsOps[Self <: PlotSmaStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotSmaStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSmaStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
