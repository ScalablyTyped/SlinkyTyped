...
trait PlotOhlcAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotOhlcAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotOhlcAccessibilityOptions {
  @scala.inline
  def apply(): PlotOhlcAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotOhlcAccessibilityOptionsOps[Self <: PlotOhlcAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotOhlcAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
