...
trait PlotWmaConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWmaConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWmaConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWmaConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotWmaConnectorsOptions {
  @scala.inline
  def apply(): PlotWmaConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaConnectorsOptions]
  }
  @scala.inline
  implicit class PlotWmaConnectorsOptionsOps[Self <: PlotWmaConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotWmaConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotWmaConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotWmaConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
