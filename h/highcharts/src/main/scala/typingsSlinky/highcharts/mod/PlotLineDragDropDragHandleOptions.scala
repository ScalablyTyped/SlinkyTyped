...
object PlotLineDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotLineDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotLineDragDropDragHandleOptionsOps[Self <: PlotLineDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
