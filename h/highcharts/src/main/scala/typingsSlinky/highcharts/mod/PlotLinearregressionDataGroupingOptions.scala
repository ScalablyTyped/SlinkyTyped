...
object PlotLinearregressionDataGroupingOptions {
  @scala.inline
  def apply(): PlotLinearregressionDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionDataGroupingOptionsOps[Self <: PlotLinearregressionDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
