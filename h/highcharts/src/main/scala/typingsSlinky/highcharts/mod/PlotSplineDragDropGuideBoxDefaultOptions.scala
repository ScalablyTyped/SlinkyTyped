...
object PlotSplineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotSplineDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotSplineDragDropGuideBoxDefaultOptionsOps[Self <: PlotSplineDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
