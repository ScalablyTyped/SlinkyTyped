...
object PlotSunburstConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSunburstConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSunburstConnectorsMarkerOptionsOps[Self <: PlotSunburstConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
