...
@js.native
trait YAxisPlotLinesEventsOptions extends js.Object {
...
object YAxisPlotLinesEventsOptions {
  ...
  @scala.inline
  implicit class YAxisPlotLinesEventsOptionsOps[Self <: YAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
