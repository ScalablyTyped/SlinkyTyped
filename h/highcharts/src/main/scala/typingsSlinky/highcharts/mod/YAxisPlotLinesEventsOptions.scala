...
@js.native
trait YAxisPlotLinesEventsOptions extends StObject {
...
object YAxisPlotLinesEventsOptions {
  
  @scala.inline
  def apply(): YAxisPlotLinesEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisPlotLinesEventsOptions]
  }
  
  @scala.inline
  implicit class YAxisPlotLinesEventsOptionsMutableBuilder[Self <: YAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
