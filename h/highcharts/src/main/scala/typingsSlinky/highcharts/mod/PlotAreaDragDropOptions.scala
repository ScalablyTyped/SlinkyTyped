...
@js.native
trait PlotAreaDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAreaDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAreaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotAreaDragDropOptions {
  @scala.inline
  def apply(): PlotAreaDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaDragDropOptions]
  }
  @scala.inline
  implicit class PlotAreaDragDropOptionsOps[Self <: PlotAreaDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotAreaDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotAreaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
