...
trait PlotAreaDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotAreaDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotAreaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAreaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAreaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
