...
@js.native
trait PlotSeriesDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSeriesDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotSeriesDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotSeriesDragDropGuideBoxDefaultOptionsOps[Self <: PlotSeriesDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
