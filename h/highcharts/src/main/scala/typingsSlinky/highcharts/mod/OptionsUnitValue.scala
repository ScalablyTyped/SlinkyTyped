...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.highcharts.highchartsStrings.percentage
  - typingsSlinky.highcharts.highchartsStrings.pixels
  - typingsSlinky.highcharts.highchartsStrings.weight
*/
