...
trait SeriesVariwideOptions extends PlotVariwideOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | variwide = js.native
...
object SeriesVariwideOptions {
  
  @scala.inline
  def apply(`type`: String | variwide): SeriesVariwideOptions = {
  ...
  @scala.inline
  implicit class SeriesVariwideOptionsMutableBuilder[Self <: SeriesVariwideOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | variwide): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
