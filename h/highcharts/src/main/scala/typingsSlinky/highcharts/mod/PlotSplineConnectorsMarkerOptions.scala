...
@js.native
trait PlotSplineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSplineConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotSplineConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotSplineConnectorsMarkerOptionsOps[Self <: PlotSplineConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
