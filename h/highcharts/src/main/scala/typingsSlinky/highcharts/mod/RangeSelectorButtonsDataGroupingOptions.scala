...
object RangeSelectorButtonsDataGroupingOptions {
  @scala.inline
  def apply(): RangeSelectorButtonsDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RangeSelectorButtonsDataGroupingOptions]
  }
  @scala.inline
  implicit class RangeSelectorButtonsDataGroupingOptionsOps[Self <: RangeSelectorButtonsDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
