...
@js.native
trait PlotApoMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotApoMarkerStatesOptions] = js.native
  /**
...
object PlotApoMarkerOptions {
  @scala.inline
  def apply(): PlotApoMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoMarkerOptions]
  }
  @scala.inline
  implicit class PlotApoMarkerOptionsOps[Self <: PlotApoMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotApoMarkerStatesOptions): Self = {
        val ret = this.duplicate
