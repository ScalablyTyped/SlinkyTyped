...
@js.native
trait PlotLineDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotLineDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    PlotLineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object PlotLineDragDropOptions {
  @scala.inline
  def apply(): PlotLineDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineDragDropOptions]
  }
  @scala.inline
  implicit class PlotLineDragDropOptionsOps[Self <: PlotLineDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotLineDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: PlotLineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
