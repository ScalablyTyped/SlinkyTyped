...
trait PlotLineDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotLineDragDropDragHandleOptions] = js.undefined
  /**
...
object PlotLineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotLineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotLineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
