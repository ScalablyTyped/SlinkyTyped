...
object PlotLinearregressionslopeOptions {
  ...
  implicit class PlotLinearregressionslopeOptionsOps[Self <: PlotLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionslopeAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressionslopeDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressionslopeParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
