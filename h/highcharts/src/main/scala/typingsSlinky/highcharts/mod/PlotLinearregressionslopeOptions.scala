...
@js.native
trait PlotLinearregressionslopeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotLinearregressionslopeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  var dataLabels: js.UndefOr[
    PlotLinearregressionslopeDataLabelsOptions | js.Array[PlotLinearregressionslopeDataLabelsOptions]
  ] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions] = js.native
...
object PlotLinearregressionslopeOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionslopeOptionsMutableBuilder[Self <: PlotLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionslopeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(
      value: PlotLinearregressionslopeDataLabelsOptions | js.Array[PlotLinearregressionslopeDataLabelsOptions]
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressionslopeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressionslopeParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
