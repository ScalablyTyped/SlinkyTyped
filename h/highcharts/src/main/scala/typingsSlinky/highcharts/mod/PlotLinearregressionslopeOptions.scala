...
trait PlotLinearregressionslopeOptions extends js.Object {
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotLinearregressionslopeAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotLinearregressionslopeAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotLinearregressionslopeConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotLinearregressionslopeDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotLinearregressionslopeEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotLinearregressionslopeLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotLinearregressionslopeLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotLinearregressionslopeLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionslopeMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotLinearregressionslopeParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotLinearregressionslopePointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotLinearregressionslopeStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotLinearregressionslopeTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotLinearregressionslopeZonesOptions]] = js.undefined
}
...
object PlotLinearregressionslopeOptions {
  ...
  ): PlotLinearregressionslopeOptions = {
