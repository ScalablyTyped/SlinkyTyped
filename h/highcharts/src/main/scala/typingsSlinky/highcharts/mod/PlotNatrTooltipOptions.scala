...
trait PlotNatrTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotNatrTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotNatrTooltipOptions {
  @scala.inline
  def apply(): PlotNatrTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrTooltipOptions]
  }
  @scala.inline
  implicit class PlotNatrTooltipOptionsOps[Self <: PlotNatrTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotNatrTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
