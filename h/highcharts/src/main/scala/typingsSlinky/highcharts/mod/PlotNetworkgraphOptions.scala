...
object PlotNetworkgraphOptions {
  ...
  implicit class PlotNetworkgraphOptionsOps[Self <: PlotNetworkgraphOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayoutAlgorithm(value: PlotNetworkgraphLayoutAlgorithmOptions): Self = this.set("layoutAlgorithm", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLink(value: PlotNetworkgraphLinkOptions): Self = this.set("link", value.asInstanceOf[js.Any])
    @scala.inline
