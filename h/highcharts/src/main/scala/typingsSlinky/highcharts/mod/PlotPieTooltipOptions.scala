...
trait PlotPieTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPieTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotPieTooltipOptions {
  ...
  def apply(
    ...
    dateTimeLabelFormats: PlotPieTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
