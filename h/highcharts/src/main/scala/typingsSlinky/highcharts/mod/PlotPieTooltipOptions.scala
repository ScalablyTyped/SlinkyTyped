...
@js.native
trait PlotPieTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPieTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPieTooltipOptions {
  @scala.inline
  def apply(): PlotPieTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieTooltipOptions]
  }
  @scala.inline
  implicit class PlotPieTooltipOptionsOps[Self <: PlotPieTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPieTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
