...
trait SeriesPieDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesPieDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesPieDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesPieDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesPieDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesPieDataDragDropOptions = {
