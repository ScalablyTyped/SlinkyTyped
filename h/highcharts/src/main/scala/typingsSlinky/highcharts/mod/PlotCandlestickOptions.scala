...
object PlotCandlestickOptions {
  ...
  implicit class PlotCandlestickOptionsOps[Self <: PlotCandlestickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCandlestickAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotCandlestickDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotCandlestickDataLabelsOptions | js.Array[PlotCandlestickDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotCandlestickDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPointValKey(value: OptionsPointValKeyValue): Self = this.set("pointValKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePointValKey: Self = this.set("pointValKey", js.undefined)
    ...
    @scala.inline
    def setUpColor(value: ColorString | GradientColorObject | PatternObject): Self = this.set("upColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUpColor: Self = this.set("upColor", js.undefined)
    
    @scala.inline
    def setUpLineColor(value: ColorString | GradientColorObject | PatternObject): Self = this.set("upLineColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUpLineColor: Self = this.set("upLineColor", js.undefined)
