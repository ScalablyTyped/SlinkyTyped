...
@js.native
trait PlotCandlestickOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotCandlestickAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotCandlestickDataLabelsOptions | js.Array[PlotCandlestickDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotCandlestickDataSortingOptions] = js.native
...
object PlotCandlestickOptions {
  ...
  @scala.inline
  implicit class PlotCandlestickOptionsMutableBuilder[Self <: PlotCandlestickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCandlestickAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotCandlestickDataLabelsOptions | js.Array[PlotCandlestickDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotCandlestickDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotCandlestickDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPointValKey(value: OptionsPointValKeyValue): Self = StObject.set(x, "pointValKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointValKeyUndefined: Self = StObject.set(x, "pointValKey", js.undefined)
    ...
    @scala.inline
    def setUpColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "upColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpColorUndefined: Self = StObject.set(x, "upColor", js.undefined)
    
    @scala.inline
    def setUpLineColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "upLineColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpLineColorUndefined: Self = StObject.set(x, "upLineColor", js.undefined)
