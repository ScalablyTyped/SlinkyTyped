...
object PlotAreasplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAreasplineConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreasplineConnectorsStartMarkerOptionsOps[Self <: PlotAreasplineConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
