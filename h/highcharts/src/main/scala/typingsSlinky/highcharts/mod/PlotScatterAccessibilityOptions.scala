...
trait PlotScatterAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotScatterAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotScatterAccessibilityOptions {
  @scala.inline
  def apply(): PlotScatterAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotScatterAccessibilityOptionsOps[Self <: PlotScatterAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotScatterAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
