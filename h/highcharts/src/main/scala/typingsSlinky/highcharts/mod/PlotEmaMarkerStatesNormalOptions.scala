...
object PlotEmaMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotEmaMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotEmaMarkerStatesNormalOptionsOps[Self <: PlotEmaMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
