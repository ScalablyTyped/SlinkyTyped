...
@js.native
trait PlotTimelineMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTimelineMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotTimelineMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTimelineMarkerStatesSelectOptionsOps[Self <: PlotTimelineMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
