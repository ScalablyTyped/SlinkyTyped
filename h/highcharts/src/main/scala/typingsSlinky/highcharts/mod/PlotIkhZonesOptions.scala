...
@js.native
trait PlotIkhZonesOptions extends js.Object {
  /**
...
object PlotIkhZonesOptions {
  @scala.inline
  def apply(): PlotIkhZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhZonesOptions]
  }
  @scala.inline
  implicit class PlotIkhZonesOptionsOps[Self <: PlotIkhZonesOptions] (val x: Self) extends AnyVal {
    @scala.inline
