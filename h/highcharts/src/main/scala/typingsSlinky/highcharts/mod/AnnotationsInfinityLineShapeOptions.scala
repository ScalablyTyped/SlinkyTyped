...
@js.native
trait AnnotationsInfinityLineShapeOptions extends StObject {
...
object AnnotationsInfinityLineShapeOptions {
  ...
  @scala.inline
  implicit class AnnotationsInfinityLineShapeOptionsMutableBuilder[Self <: AnnotationsInfinityLineShapeOptions] (val x: Self) extends AnyVal {
