...
object YAxisDateTimeLabelFormatsMonthOptions {
  @scala.inline
  def apply(): YAxisDateTimeLabelFormatsMonthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisDateTimeLabelFormatsMonthOptions]
  }
  @scala.inline
  implicit class YAxisDateTimeLabelFormatsMonthOptionsOps[Self <: YAxisDateTimeLabelFormatsMonthOptions] (val x: Self) extends AnyVal {
    @scala.inline
