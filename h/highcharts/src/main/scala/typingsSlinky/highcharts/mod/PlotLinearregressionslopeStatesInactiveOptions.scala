...
object PlotLinearregressionslopeStatesInactiveOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeStatesInactiveOptionsOps[Self <: PlotLinearregressionslopeStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesInactiveAnimationOptions): Self = {
