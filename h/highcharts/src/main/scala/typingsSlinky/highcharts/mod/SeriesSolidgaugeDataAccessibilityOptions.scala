...
object SeriesSolidgaugeDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesSolidgaugeDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSolidgaugeDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesSolidgaugeDataAccessibilityOptionsOps[Self <: SeriesSolidgaugeDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
