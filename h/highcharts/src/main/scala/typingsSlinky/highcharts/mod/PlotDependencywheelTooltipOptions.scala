...
trait PlotDependencywheelTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotDependencywheelTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotDependencywheelTooltipOptions {
  @scala.inline
  def apply(): PlotDependencywheelTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelTooltipOptions]
  }
  @scala.inline
  implicit class PlotDependencywheelTooltipOptionsOps[Self <: PlotDependencywheelTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotDependencywheelTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
