...
object PlotAbandsAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotAbandsAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotAbandsAccessibilityKeyboardNavigationOptionsOps[Self <: PlotAbandsAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
