...
object PlotEmaAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotEmaAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotEmaAccessibilityKeyboardNavigationOptionsOps[Self <: PlotEmaAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
