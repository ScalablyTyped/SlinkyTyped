...
@js.native
trait PlotMaplineDataSortingOptions extends js.Object {
  /**
...
object PlotMaplineDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotMaplineDataSortingOptionsOps[Self <: PlotMaplineDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
