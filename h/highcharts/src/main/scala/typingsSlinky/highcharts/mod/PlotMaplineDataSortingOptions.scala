...
@js.native
trait PlotMaplineDataSortingOptions extends StObject {
...
object PlotMaplineDataSortingOptions {
  
  @scala.inline
  def apply(): PlotMaplineDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotMaplineDataSortingOptionsMutableBuilder[Self <: PlotMaplineDataSortingOptions] (val x: Self) extends AnyVal {
