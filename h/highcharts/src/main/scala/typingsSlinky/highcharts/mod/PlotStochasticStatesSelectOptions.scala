...
trait PlotStochasticStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotStochasticStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStochasticStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotStochasticStatesSelectOptions {
  @scala.inline
  def apply(): PlotStochasticStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotStochasticStatesSelectOptionsOps[Self <: PlotStochasticStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotStochasticStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotStochasticStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
