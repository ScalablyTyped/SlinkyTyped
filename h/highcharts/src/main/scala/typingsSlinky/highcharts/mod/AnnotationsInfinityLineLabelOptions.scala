...
@js.native
trait AnnotationsInfinityLineLabelOptions extends js.Object {
...
object AnnotationsInfinityLineLabelOptions {
  ...
  @scala.inline
  implicit class AnnotationsInfinityLineLabelOptionsOps[Self <: AnnotationsInfinityLineLabelOptions] (val x: Self) extends AnyVal {
