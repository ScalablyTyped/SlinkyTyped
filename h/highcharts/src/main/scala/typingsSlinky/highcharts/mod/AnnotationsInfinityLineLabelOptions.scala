...
@js.native
trait AnnotationsInfinityLineLabelOptions extends StObject {
...
object AnnotationsInfinityLineLabelOptions {
  
  @scala.inline
  def apply(): AnnotationsInfinityLineLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsInfinityLineLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsInfinityLineLabelOptionsMutableBuilder[Self <: AnnotationsInfinityLineLabelOptions] (val x: Self) extends AnyVal {
