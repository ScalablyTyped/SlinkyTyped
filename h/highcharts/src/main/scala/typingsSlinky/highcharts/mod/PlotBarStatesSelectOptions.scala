...
@js.native
trait PlotBarStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotBarStatesSelectAnimationOptions] = js.native
  /**
...
object PlotBarStatesSelectOptions {
  @scala.inline
  def apply(): PlotBarStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotBarStatesSelectOptionsOps[Self <: PlotBarStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotBarStatesSelectAnimationOptions): Self = {
