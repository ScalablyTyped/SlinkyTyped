...
trait SeriesParetoOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Array[Double | String]) | SeriesParetoDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesParetoOptions {
  ...
  implicit class SeriesParetoOptionsOps[Self <: SeriesParetoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | pareto): Self = {
    ...
    @scala.inline
    def withData(value: js.Array[(js.Array[Double | String]) | SeriesParetoDataOptions]): Self = {
        val ret = this.duplicate
