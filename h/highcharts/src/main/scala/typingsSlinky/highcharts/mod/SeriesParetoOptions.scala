...
trait SeriesParetoOptions extends PlotParetoOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Array[Double | String]) | PointOptionsObject]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | pareto = js.native
...
object SeriesParetoOptions {
  ...
  @scala.inline
  def apply(`type`: String | pareto): SeriesParetoOptions = {
  ...
  @scala.inline
  implicit class SeriesParetoOptionsMutableBuilder[Self <: SeriesParetoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.Array[(js.Array[Double | String]) | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: ((js.Array[Double | String]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | pareto): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
