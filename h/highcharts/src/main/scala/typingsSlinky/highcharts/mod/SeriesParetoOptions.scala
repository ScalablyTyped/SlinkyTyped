...
object SeriesParetoOptions {
  ...
  @scala.inline
  implicit class SeriesParetoOptionsOps[Self <: SeriesParetoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pareto): Self = this.set("type", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataVarargs(value: ((js.Array[Double | String]) | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[(js.Array[Double | String]) | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
