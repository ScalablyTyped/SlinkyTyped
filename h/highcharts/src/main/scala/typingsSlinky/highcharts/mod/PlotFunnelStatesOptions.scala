...
trait PlotFunnelStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotFunnelStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotFunnelStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotFunnelStatesNormalOptions] = js.native
  /**
    * (Highcharts) Options for a selected funnel item.
    */
  var select: js.UndefOr[PlotFunnelStatesSelectOptions] = js.native
}

object PlotFunnelStatesOptions {
  @scala.inline
  def apply(): PlotFunnelStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelStatesOptions]
  }
  @scala.inline
  implicit class PlotFunnelStatesOptionsOps[Self <: PlotFunnelStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotFunnelStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotFunnelStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotFunnelStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotFunnelStatesSelectOptions): Self = {
        val ret = this.duplicate
