...
trait PlotFunnelStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotFunnelStatesSelectAnimationOptions] = js.native
  /**
...
object PlotFunnelStatesSelectOptions {
  @scala.inline
  def apply(): PlotFunnelStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotFunnelStatesSelectOptionsOps[Self <: PlotFunnelStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotFunnelStatesSelectAnimationOptions): Self = {
