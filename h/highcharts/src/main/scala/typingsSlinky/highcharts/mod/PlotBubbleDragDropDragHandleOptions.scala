...
@js.native
trait PlotBubbleDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotBubbleDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotBubbleDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotBubbleDragDropDragHandleOptionsOps[Self <: PlotBubbleDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
