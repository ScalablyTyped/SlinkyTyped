...
trait SeriesGaugeOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesGaugeDataOptions]] = js.native
  /**
    * Not available
    */
...
object SeriesGaugeOptions {
  ...
  implicit class SeriesGaugeOptionsOps[Self <: SeriesGaugeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | gauge): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | Null | SeriesGaugeDataOptions]): Self = {
        val ret = this.duplicate
