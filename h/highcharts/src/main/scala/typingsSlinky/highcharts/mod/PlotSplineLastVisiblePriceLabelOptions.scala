...
object PlotSplineLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotSplineLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotSplineLastVisiblePriceLabelOptionsOps[Self <: PlotSplineLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
