...
object PlotCylinderPointEventsOptions {
  @scala.inline
  def apply(): PlotCylinderPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderPointEventsOptions]
  }
  @scala.inline
  implicit class PlotCylinderPointEventsOptionsOps[Self <: PlotCylinderPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
