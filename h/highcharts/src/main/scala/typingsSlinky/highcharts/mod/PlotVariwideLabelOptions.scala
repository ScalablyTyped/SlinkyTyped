...
@js.native
trait PlotVariwideLabelOptions extends js.Object {
  /**
...
object PlotVariwideLabelOptions {
  @scala.inline
  def apply(): PlotVariwideLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideLabelOptions]
  }
  @scala.inline
  implicit class PlotVariwideLabelOptionsOps[Self <: PlotVariwideLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
