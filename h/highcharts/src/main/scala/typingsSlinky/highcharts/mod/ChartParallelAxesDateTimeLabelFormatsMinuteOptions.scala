...
object ChartParallelAxesDateTimeLabelFormatsMinuteOptions {
  @scala.inline
  def apply(): ChartParallelAxesDateTimeLabelFormatsMinuteOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesDateTimeLabelFormatsMinuteOptions]
  }
  @scala.inline
  implicit class ChartParallelAxesDateTimeLabelFormatsMinuteOptionsOps[Self <: ChartParallelAxesDateTimeLabelFormatsMinuteOptions] (val x: Self) extends AnyVal {
    @scala.inline
