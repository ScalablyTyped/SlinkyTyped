...
object PlotPivotpointsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotPivotpointsConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsConnectorsEndMarkerOptionsOps[Self <: PlotPivotpointsConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
