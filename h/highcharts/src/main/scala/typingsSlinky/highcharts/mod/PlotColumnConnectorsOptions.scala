...
@js.native
trait PlotColumnConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotColumnConnectorsOptions {
  @scala.inline
  def apply(): PlotColumnConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnConnectorsOptions]
  }
  @scala.inline
  implicit class PlotColumnConnectorsOptionsOps[Self <: PlotColumnConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotColumnConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotColumnConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotColumnConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
