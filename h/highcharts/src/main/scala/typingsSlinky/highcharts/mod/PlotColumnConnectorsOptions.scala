...
trait PlotColumnConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotColumnConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotColumnConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotColumnConnectorsMarkerOptions = null,
    startMarker: PlotColumnConnectorsStartMarkerOptions = null,
