...
object SeriesVectorDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(): SeriesVectorDataMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVectorDataMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class SeriesVectorDataMarkerStatesHoverOptionsOps[Self <: SeriesVectorDataMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
