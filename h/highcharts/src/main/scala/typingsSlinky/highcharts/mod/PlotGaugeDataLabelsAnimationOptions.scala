...
@js.native
trait PlotGaugeDataLabelsAnimationOptions extends js.Object {
...
object PlotGaugeDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotGaugeDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotGaugeDataLabelsAnimationOptionsOps[Self <: PlotGaugeDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
