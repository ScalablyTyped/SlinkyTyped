...
@js.native
trait PlotScatterLabelOptions extends js.Object {
  /**
...
object PlotScatterLabelOptions {
  @scala.inline
  def apply(): PlotScatterLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterLabelOptions]
  }
  @scala.inline
  implicit class PlotScatterLabelOptionsOps[Self <: PlotScatterLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
