...
trait SeriesBellcurveOptions extends PlotBellcurveOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | bellcurve = js.native
...
object SeriesBellcurveOptions {
  ...
  @scala.inline
  def apply(`type`: String | bellcurve): SeriesBellcurveOptions = {
  ...
  @scala.inline
  implicit class SeriesBellcurveOptionsMutableBuilder[Self <: SeriesBellcurveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bellcurve): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
