...
object SeriesBellcurveOptions {
  ...
  @scala.inline
  implicit class SeriesBellcurveOptionsOps[Self <: SeriesBellcurveOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bellcurve): Self = this.set("type", value.asInstanceOf[js.Any])
