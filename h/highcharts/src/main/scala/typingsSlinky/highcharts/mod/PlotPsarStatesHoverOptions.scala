...
@js.native
trait PlotPsarStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPsarStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPsarStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotPsarStatesHoverOptions {
  @scala.inline
  def apply(): PlotPsarStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotPsarStatesHoverOptionsOps[Self <: PlotPsarStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotPsarStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPsarStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
