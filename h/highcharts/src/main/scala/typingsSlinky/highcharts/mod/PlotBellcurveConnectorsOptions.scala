...
trait PlotBellcurveConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBellcurveConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBellcurveConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBellcurveConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBellcurveConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotBellcurveConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotBellcurveConnectorsMarkerOptions = null,
    startMarker: PlotBellcurveConnectorsStartMarkerOptions = null,
