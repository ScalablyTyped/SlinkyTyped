...
@js.native
trait PlotBellcurveConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBellcurveConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBellcurveConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBellcurveConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotBellcurveConnectorsOptions {
  @scala.inline
  def apply(): PlotBellcurveConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveConnectorsOptions]
  }
  @scala.inline
  implicit class PlotBellcurveConnectorsOptionsOps[Self <: PlotBellcurveConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotBellcurveConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotBellcurveConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotBellcurveConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
