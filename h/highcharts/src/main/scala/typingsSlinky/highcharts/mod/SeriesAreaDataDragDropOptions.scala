...
trait SeriesAreaDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesAreaDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesAreaDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesAreaDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesAreaDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesAreaDataDragDropOptions = {
