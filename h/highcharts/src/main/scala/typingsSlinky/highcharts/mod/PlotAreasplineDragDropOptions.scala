...
trait PlotAreasplineDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotAreasplineDragDropDragHandleOptions] = js.native
  /**
...
object PlotAreasplineDragDropOptions {
  @scala.inline
  def apply(): PlotAreasplineDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineDragDropOptions]
  }
  @scala.inline
  implicit class PlotAreasplineDragDropOptionsOps[Self <: PlotAreasplineDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotAreasplineDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: PlotAreasplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
