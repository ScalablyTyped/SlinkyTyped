...
object PlotAdMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAdMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAdMarkerStatesSelectOptionsOps[Self <: PlotAdMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
