...
object PlotScatter3dMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotScatter3dMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotScatter3dMarkerStatesHoverOptionsOps[Self <: PlotScatter3dMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
