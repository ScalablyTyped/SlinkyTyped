...
object PlotTreemapEventsOptions {
  @scala.inline
  def apply(): PlotTreemapEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapEventsOptions]
  }
  @scala.inline
  implicit class PlotTreemapEventsOptionsOps[Self <: PlotTreemapEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSetRootNode(value: js.Function): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setRootNode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
