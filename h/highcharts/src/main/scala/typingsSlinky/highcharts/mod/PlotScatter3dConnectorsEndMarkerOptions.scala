...
object PlotScatter3dConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotScatter3dConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatter3dConnectorsEndMarkerOptionsOps[Self <: PlotScatter3dConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
