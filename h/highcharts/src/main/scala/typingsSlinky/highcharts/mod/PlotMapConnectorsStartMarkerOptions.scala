...
object PlotMapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMapConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMapConnectorsStartMarkerOptionsOps[Self <: PlotMapConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
