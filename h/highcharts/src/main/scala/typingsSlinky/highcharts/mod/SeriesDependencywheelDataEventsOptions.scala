...
@js.native
trait SeriesDependencywheelDataEventsOptions extends js.Object {
  /**
...
object SeriesDependencywheelDataEventsOptions {
  @scala.inline
  def apply(): SeriesDependencywheelDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesDependencywheelDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesDependencywheelDataEventsOptionsOps[Self <: SeriesDependencywheelDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
