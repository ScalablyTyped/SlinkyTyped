...
object PlotVariablepieStatesNormalOptions {
  @scala.inline
  def apply(): PlotVariablepieStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotVariablepieStatesNormalOptionsOps[Self <: PlotVariablepieStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
