...
@js.native
trait PlotSupertrendTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotSupertrendTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotSupertrendTooltipOptions {
  @scala.inline
  def apply(): PlotSupertrendTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendTooltipOptions]
  }
  @scala.inline
  implicit class PlotSupertrendTooltipOptionsOps[Self <: PlotSupertrendTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotSupertrendTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
