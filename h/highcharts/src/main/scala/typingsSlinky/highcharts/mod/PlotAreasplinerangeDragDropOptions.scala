...
trait PlotAreasplinerangeDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[PlotAreasplinerangeDragDropDragHandleOptions] = js.native
  /**
...
object PlotAreasplinerangeDragDropOptions {
  @scala.inline
  def apply(): PlotAreasplinerangeDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeDragDropOptions]
  }
  @scala.inline
  implicit class PlotAreasplinerangeDragDropOptionsOps[Self <: PlotAreasplinerangeDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: PlotAreasplinerangeDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: PlotAreasplinerangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
