...
@js.native
trait PlotMacdStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMacdStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMacdStatesHoverHaloOptions] = js.native
  /**
...
object PlotMacdStatesHoverOptions {
  @scala.inline
  def apply(): PlotMacdStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotMacdStatesHoverOptionsOps[Self <: PlotMacdStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotMacdStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotMacdStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
