...
trait PlotStreamgraphTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotStreamgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotStreamgraphTooltipOptions {
  @scala.inline
  def apply(): PlotStreamgraphTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphTooltipOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphTooltipOptionsOps[Self <: PlotStreamgraphTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotStreamgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
