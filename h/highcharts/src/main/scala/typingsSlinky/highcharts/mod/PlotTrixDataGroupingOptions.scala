...
@js.native
trait PlotTrixDataGroupingOptions extends js.Object {
  /**
...
object PlotTrixDataGroupingOptions {
  @scala.inline
  def apply(): PlotTrixDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotTrixDataGroupingOptionsOps[Self <: PlotTrixDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
