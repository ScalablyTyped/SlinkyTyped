...
object PlotSolidgaugeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotSolidgaugeConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeConnectorsEndMarkerOptionsOps[Self <: PlotSolidgaugeConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
