...
object PlotTilemapDataGroupingOptions {
  @scala.inline
  def apply(): PlotTilemapDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotTilemapDataGroupingOptionsOps[Self <: PlotTilemapDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
