...
trait SeriesMapOptions extends PlotMapOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions]
  ] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | map_ = js.native
...
object SeriesMapOptions {
  
  @scala.inline
  def apply(`type`: String | map_): SeriesMapOptions = {
  ...
  @scala.inline
  implicit class SeriesMapOptionsMutableBuilder[Self <: SeriesMapOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | map_): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
