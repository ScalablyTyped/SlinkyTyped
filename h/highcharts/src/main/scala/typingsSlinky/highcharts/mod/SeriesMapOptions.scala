...
trait SeriesMapOptions
  extends PlotMapOptions
...
object SeriesMapOptions {
  ...
  implicit class SeriesMapOptionsOps[Self <: SeriesMapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | map_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions]): Self = {
        val ret = this.duplicate
