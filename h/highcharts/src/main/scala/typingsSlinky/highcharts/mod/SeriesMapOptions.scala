...
object SeriesMapOptions {
  ...
  @scala.inline
  implicit class SeriesMapOptionsOps[Self <: SeriesMapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | map_): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions]): Self = this.set("data", value.asInstanceOf[js.Any])
