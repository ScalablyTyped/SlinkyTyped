...
trait PlotErrorbarConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotErrorbarConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotErrorbarConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotErrorbarConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotErrorbarConnectorsOptions {
  @scala.inline
  def apply(): PlotErrorbarConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarConnectorsOptions]
  }
  @scala.inline
  implicit class PlotErrorbarConnectorsOptionsOps[Self <: PlotErrorbarConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotErrorbarConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotErrorbarConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotErrorbarConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
