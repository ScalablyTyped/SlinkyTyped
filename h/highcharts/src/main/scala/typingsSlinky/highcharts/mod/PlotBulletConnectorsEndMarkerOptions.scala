...
@js.native
trait PlotBulletConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBulletConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBulletConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBulletConnectorsEndMarkerOptionsOps[Self <: PlotBulletConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
