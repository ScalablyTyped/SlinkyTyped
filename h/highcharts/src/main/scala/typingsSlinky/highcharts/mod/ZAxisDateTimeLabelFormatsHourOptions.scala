...
object ZAxisDateTimeLabelFormatsHourOptions {
  @scala.inline
  def apply(): ZAxisDateTimeLabelFormatsHourOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisDateTimeLabelFormatsHourOptions]
  }
  @scala.inline
  implicit class ZAxisDateTimeLabelFormatsHourOptionsOps[Self <: ZAxisDateTimeLabelFormatsHourOptions] (val x: Self) extends AnyVal {
    @scala.inline
