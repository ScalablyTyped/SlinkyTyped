...
object PlotTrixMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotTrixMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTrixMarkerStatesSelectOptionsOps[Self <: PlotTrixMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
