...
object PlotTreemapOptions {
  ...
  implicit class PlotTreemapOptionsOps[Self <: PlotTreemapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternateStartingDirection(value: Boolean): Self = this.set("alternateStartingDirection", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCluster(value: PlotTreemapClusterOptions): Self = this.set("cluster", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotTreemapDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    @scala.inline
    def setDataLabels(value: PlotTreemapDataLabelsOptions | js.Array[PlotTreemapDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInteractByLeaf(value: Boolean): Self = this.set("interactByLeaf", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteInteractByLeaf: Self = this.set("interactByLeaf", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setLevelsVarargs(value: PlotTreemapLevelsOptions*): Self = this.set("levels", js.Array(value :_*))
    @scala.inline
    def setLevels(value: js.Array[PlotTreemapLevelsOptions]): Self = this.set("levels", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTraverseUpButton(value: PlotTreemapTraverseUpButtonOptions): Self = this.set("traverseUpButton", value.asInstanceOf[js.Any])
    @scala.inline
