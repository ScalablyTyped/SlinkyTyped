...
object PlotTreemapOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(alternateStartingDirection)) __obj.updateDynamic("alternateStartingDirection")(alternateStartingDirection.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(interactByLeaf)) __obj.updateDynamic("interactByLeaf")(interactByLeaf.get.asInstanceOf[js.Any])
