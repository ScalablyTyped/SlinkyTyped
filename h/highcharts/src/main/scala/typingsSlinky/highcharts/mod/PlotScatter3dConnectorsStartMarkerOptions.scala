...
object PlotScatter3dConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotScatter3dConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatter3dConnectorsStartMarkerOptionsOps[Self <: PlotScatter3dConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
