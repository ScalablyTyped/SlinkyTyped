...
object SeriesBarDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesBarDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBarDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesBarDataDragDropDragHandleOptionsOps[Self <: SeriesBarDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
