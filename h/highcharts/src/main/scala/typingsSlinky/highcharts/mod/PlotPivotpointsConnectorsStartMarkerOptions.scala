...
object PlotPivotpointsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPivotpointsConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsConnectorsStartMarkerOptionsOps[Self <: PlotPivotpointsConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
