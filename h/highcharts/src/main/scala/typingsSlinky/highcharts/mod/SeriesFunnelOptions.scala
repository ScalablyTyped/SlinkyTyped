...
object SeriesFunnelOptions {
  ...
  @scala.inline
  implicit class SeriesFunnelOptionsMutableBuilder[Self <: SeriesFunnelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | funnel): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
