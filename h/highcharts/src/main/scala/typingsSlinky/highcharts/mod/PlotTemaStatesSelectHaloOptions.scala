...
object PlotTemaStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTemaStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTemaStatesSelectHaloOptionsOps[Self <: PlotTemaStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
