...
object PlotPieStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotPieStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotPieStatesSelectHaloOptionsOps[Self <: PlotPieStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
