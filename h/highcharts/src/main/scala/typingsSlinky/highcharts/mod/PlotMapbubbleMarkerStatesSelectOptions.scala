...
object PlotMapbubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotMapbubbleMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleMarkerStatesSelectOptionsOps[Self <: PlotMapbubbleMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
