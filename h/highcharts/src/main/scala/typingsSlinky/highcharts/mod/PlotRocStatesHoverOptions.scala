...
trait PlotRocStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRocStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRocStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotRocStatesHoverOptions {
  @scala.inline
  def apply(): PlotRocStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotRocStatesHoverOptionsOps[Self <: PlotRocStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotRocStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotRocStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
