...
@js.native
trait PlotKeltnerchannelsDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotKeltnerchannelsDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.native
...
object PlotKeltnerchannelsDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotKeltnerchannelsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotKeltnerchannelsDataLabelsOptionsMutableBuilder[Self <: PlotKeltnerchannelsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotKeltnerchannelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
