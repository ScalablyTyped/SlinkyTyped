...
@js.native
trait PlotKeltnerchannelsDataLabelsOptions extends js.Object {
...
object PlotKeltnerchannelsDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotKeltnerchannelsDataLabelsOptionsOps[Self <: PlotKeltnerchannelsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotKeltnerchannelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
