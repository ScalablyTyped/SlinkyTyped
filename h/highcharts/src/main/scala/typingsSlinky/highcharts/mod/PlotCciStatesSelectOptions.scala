...
@js.native
trait PlotCciStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotCciStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCciStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotCciStatesSelectOptions {
  @scala.inline
  def apply(): PlotCciStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotCciStatesSelectOptionsOps[Self <: PlotCciStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotCciStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotCciStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
