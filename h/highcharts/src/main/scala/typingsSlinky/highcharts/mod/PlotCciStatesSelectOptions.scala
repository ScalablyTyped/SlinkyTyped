...
trait PlotCciStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotCciStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCciStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotCciStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotCciStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: js.UndefOr[Double] = js.undefined,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: js.UndefOr[Null | PlotCciStatesSelectHaloOptions] = js.undefined,
    lineWidth: js.UndefOr[Double] = js.undefined,
    lineWidthPlus: js.UndefOr[Double] = js.undefined
  ): PlotCciStatesSelectOptions = {
