...
object PlotPackedbubbleDataGroupingOptions {
  @scala.inline
  def apply(): PlotPackedbubbleDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleDataGroupingOptionsOps[Self <: PlotPackedbubbleDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
