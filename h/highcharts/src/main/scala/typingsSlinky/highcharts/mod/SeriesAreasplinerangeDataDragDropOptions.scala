...
trait SeriesAreasplinerangeDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesAreasplinerangeDataDragDropDragHandleOptions] = js.native
  /**
...
object SeriesAreasplinerangeDataDragDropOptions {
  @scala.inline
  def apply(): SeriesAreasplinerangeDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreasplinerangeDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesAreasplinerangeDataDragDropOptionsOps[Self <: SeriesAreasplinerangeDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesAreasplinerangeDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesAreasplinerangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
