...
trait SeriesOhlcDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesOhlcDataDragDropDragHandleOptions] = js.native
  /**
...
object SeriesOhlcDataDragDropOptions {
  @scala.inline
  def apply(): SeriesOhlcDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesOhlcDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesOhlcDataDragDropOptionsOps[Self <: SeriesOhlcDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesOhlcDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesOhlcDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
