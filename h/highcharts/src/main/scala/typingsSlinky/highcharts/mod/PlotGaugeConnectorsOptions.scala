...
trait PlotGaugeConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotGaugeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotGaugeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotGaugeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotGaugeConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotGaugeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotGaugeConnectorsMarkerOptions = null,
    startMarker: PlotGaugeConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotGaugeConnectorsOptions = {
