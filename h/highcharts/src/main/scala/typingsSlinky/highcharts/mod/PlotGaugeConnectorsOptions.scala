...
@js.native
trait PlotGaugeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotGaugeConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotGaugeConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotGaugeConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotGaugeConnectorsOptions {
  @scala.inline
  def apply(): PlotGaugeConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeConnectorsOptions]
  }
  @scala.inline
  implicit class PlotGaugeConnectorsOptionsOps[Self <: PlotGaugeConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotGaugeConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotGaugeConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotGaugeConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
