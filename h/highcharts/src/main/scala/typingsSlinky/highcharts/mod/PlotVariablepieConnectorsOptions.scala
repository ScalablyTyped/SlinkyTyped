...
trait PlotVariablepieConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVariablepieConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVariablepieConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVariablepieConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotVariablepieConnectorsOptions {
  @scala.inline
  def apply(): PlotVariablepieConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieConnectorsOptions]
  }
  @scala.inline
  implicit class PlotVariablepieConnectorsOptionsOps[Self <: PlotVariablepieConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotVariablepieConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotVariablepieConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotVariablepieConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
