...
object PlotCciMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotCciMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotCciMarkerStatesSelectOptionsOps[Self <: PlotCciMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
