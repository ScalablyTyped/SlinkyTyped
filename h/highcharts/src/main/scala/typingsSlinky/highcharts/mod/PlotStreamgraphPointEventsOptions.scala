...
@js.native
trait PlotStreamgraphPointEventsOptions extends js.Object {
  /**
...
object PlotStreamgraphPointEventsOptions {
  @scala.inline
  def apply(): PlotStreamgraphPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphPointEventsOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphPointEventsOptionsOps[Self <: PlotStreamgraphPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
