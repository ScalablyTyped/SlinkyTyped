...
object PlotBulletStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotBulletStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotBulletStatesHoverAnimationOptionsOps[Self <: PlotBulletStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
