...
object SeriesWordcloudDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesWordcloudDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWordcloudDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesWordcloudDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesWordcloudDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
