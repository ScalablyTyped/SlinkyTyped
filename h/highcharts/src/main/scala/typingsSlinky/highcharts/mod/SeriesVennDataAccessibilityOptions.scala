...
object SeriesVennDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesVennDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVennDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesVennDataAccessibilityOptionsOps[Self <: SeriesVennDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
