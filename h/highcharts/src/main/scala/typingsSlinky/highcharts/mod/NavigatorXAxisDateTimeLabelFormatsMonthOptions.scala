...
object NavigatorXAxisDateTimeLabelFormatsMonthOptions {
  @scala.inline
  def apply(): NavigatorXAxisDateTimeLabelFormatsMonthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisDateTimeLabelFormatsMonthOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisDateTimeLabelFormatsMonthOptionsOps[Self <: NavigatorXAxisDateTimeLabelFormatsMonthOptions] (val x: Self) extends AnyVal {
    @scala.inline
