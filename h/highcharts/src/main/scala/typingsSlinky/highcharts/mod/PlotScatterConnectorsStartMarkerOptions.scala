...
@js.native
trait PlotScatterConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotScatterConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotScatterConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotScatterConnectorsStartMarkerOptionsOps[Self <: PlotScatterConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
