...
object SeriesWordcloudDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesWordcloudDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWordcloudDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesWordcloudDataDragDropDragHandleOptionsOps[Self <: SeriesWordcloudDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
