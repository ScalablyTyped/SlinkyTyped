...
object PlotLinearregressionangleMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleMarkerStatesSelectOptionsOps[Self <: PlotLinearregressionangleMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
