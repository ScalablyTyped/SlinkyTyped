...
trait PlotHeatmapStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotHeatmapStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotHeatmapStatesHoverOptions {
  @scala.inline
  def apply(): PlotHeatmapStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotHeatmapStatesHoverOptionsOps[Self <: PlotHeatmapStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotHeatmapStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
