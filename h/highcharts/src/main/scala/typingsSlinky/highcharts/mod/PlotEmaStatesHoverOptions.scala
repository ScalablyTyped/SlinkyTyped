...
@js.native
trait PlotEmaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotEmaStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotEmaStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotEmaStatesHoverOptions {
  @scala.inline
  def apply(): PlotEmaStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotEmaStatesHoverOptionsOps[Self <: PlotEmaStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotEmaStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotEmaStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
