...
object SeriesFunnel3dDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesFunnel3dDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFunnel3dDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesFunnel3dDataAccessibilityOptionsOps[Self <: SeriesFunnel3dDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
