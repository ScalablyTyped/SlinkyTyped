...
object PlotPsarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPsarConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPsarConnectorsStartMarkerOptionsOps[Self <: PlotPsarConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
