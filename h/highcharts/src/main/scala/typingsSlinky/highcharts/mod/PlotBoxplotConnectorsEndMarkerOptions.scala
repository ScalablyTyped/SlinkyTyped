...
object PlotBoxplotConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotBoxplotConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotBoxplotConnectorsEndMarkerOptionsOps[Self <: PlotBoxplotConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
