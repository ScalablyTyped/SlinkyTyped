...
@js.native
trait PlotLinearregressioninterceptMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptMarkerStatesHoverOptionsOps[Self <: PlotLinearregressioninterceptMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
