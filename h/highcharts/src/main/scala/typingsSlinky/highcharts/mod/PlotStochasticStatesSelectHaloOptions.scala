...
@js.native
trait PlotStochasticStatesSelectHaloOptions extends js.Object {
  /**
...
object PlotStochasticStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotStochasticStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotStochasticStatesSelectHaloOptionsOps[Self <: PlotStochasticStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
