...
object PlotChaikinStatesNormalOptions {
  @scala.inline
  def apply(): PlotChaikinStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotChaikinStatesNormalOptionsOps[Self <: PlotChaikinStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
