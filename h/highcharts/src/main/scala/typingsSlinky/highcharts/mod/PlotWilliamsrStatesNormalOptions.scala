...
object PlotWilliamsrStatesNormalOptions {
  @scala.inline
  def apply(): PlotWilliamsrStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrStatesNormalOptionsOps[Self <: PlotWilliamsrStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
