...
object PlotAroonoscillatorLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorLastVisiblePriceLabelOptionsOps[Self <: PlotAroonoscillatorLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
