...
@js.native
trait PlotTrixStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTrixStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrixStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotTrixStatesSelectOptions {
  @scala.inline
  def apply(): PlotTrixStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotTrixStatesSelectOptionsOps[Self <: PlotTrixStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotTrixStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTrixStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
