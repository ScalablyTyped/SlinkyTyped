...
@js.native
trait PlotTrixConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTrixConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotTrixConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotTrixConnectorsStartMarkerOptionsOps[Self <: PlotTrixConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
