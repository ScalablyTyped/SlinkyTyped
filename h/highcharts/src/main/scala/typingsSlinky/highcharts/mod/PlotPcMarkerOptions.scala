...
@js.native
trait PlotPcMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPcMarkerStatesOptions] = js.native
  /**
...
object PlotPcMarkerOptions {
  @scala.inline
  def apply(): PlotPcMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcMarkerOptions]
  }
  @scala.inline
  implicit class PlotPcMarkerOptionsOps[Self <: PlotPcMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPcMarkerStatesOptions): Self = {
        val ret = this.duplicate
