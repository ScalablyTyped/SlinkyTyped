...
object SeriesMapbubbleDataEventsOptions {
  @scala.inline
  def apply(): SeriesMapbubbleDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMapbubbleDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesMapbubbleDataEventsOptionsOps[Self <: SeriesMapbubbleDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
