...
object PlotMacdConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotMacdConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotMacdConnectorsStartMarkerOptionsOps[Self <: PlotMacdConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
