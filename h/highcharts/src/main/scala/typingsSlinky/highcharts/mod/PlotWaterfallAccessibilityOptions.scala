...
@js.native
trait PlotWaterfallAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWaterfallAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotWaterfallAccessibilityOptions {
  @scala.inline
  def apply(): PlotWaterfallAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotWaterfallAccessibilityOptionsOps[Self <: PlotWaterfallAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotWaterfallAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
