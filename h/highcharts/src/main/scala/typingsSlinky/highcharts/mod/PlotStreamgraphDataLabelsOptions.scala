...
@js.native
trait PlotStreamgraphDataLabelsOptions extends js.Object {
...
object PlotStreamgraphDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotStreamgraphDataLabelsOptionsOps[Self <: PlotStreamgraphDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStreamgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
