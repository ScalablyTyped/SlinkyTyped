...
@js.native
trait PlotStreamgraphDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotStreamgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotStreamgraphDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotStreamgraphDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotStreamgraphDataLabelsOptionsMutableBuilder[Self <: PlotStreamgraphDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStreamgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
