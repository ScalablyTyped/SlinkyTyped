...
trait AnnotationsLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var point: js.UndefOr[String | AnnotationsLabelsPointOptions | MockPointOptionsObject] = js.native
  /**
...
object AnnotationsLabelsOptions {
  @scala.inline
  def apply(): AnnotationsLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsLabelsOptions]
  }
  @scala.inline
  implicit class AnnotationsLabelsOptionsOps[Self <: AnnotationsLabelsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPoint(value: String | AnnotationsLabelsPointOptions | MockPointOptionsObject): Self = {
        val ret = this.duplicate
