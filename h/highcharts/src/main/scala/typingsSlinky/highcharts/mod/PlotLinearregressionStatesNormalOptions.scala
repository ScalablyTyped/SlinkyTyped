...
object PlotLinearregressionStatesNormalOptions {
  @scala.inline
  def apply(): PlotLinearregressionStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionStatesNormalOptionsOps[Self <: PlotLinearregressionStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
