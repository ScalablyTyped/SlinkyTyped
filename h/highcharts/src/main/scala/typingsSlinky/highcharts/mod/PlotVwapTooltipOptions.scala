...
trait PlotVwapTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotVwapTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotVwapTooltipOptions {
  @scala.inline
  def apply(): PlotVwapTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapTooltipOptions]
  }
  @scala.inline
  implicit class PlotVwapTooltipOptionsOps[Self <: PlotVwapTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotVwapTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
