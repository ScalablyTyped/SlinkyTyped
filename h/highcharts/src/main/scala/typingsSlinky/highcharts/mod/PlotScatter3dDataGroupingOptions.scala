...
object PlotScatter3dDataGroupingOptions {
  @scala.inline
  def apply(): PlotScatter3dDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotScatter3dDataGroupingOptionsOps[Self <: PlotScatter3dDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
