...
trait PlotPsarTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPsarTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotPsarTooltipOptions {
  @scala.inline
  def apply(): PlotPsarTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarTooltipOptions]
  }
  @scala.inline
  implicit class PlotPsarTooltipOptionsOps[Self <: PlotPsarTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotPsarTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
