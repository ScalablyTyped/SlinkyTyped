...
@js.native
trait PlotStochasticSmoothedLineStylesOptions extends StObject {
...
object PlotStochasticSmoothedLineStylesOptions {
  ...
  @scala.inline
  def apply(): PlotStochasticSmoothedLineStylesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSmoothedLineStylesOptions]
  }
  
  @scala.inline
  implicit class PlotStochasticSmoothedLineStylesOptionsMutableBuilder[Self <: PlotStochasticSmoothedLineStylesOptions] (val x: Self) extends AnyVal {
