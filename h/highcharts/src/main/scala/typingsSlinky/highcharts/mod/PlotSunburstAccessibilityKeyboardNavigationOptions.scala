...
object PlotSunburstAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotSunburstAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotSunburstAccessibilityKeyboardNavigationOptionsOps[Self <: PlotSunburstAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
