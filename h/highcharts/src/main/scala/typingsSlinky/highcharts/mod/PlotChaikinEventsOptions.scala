...
@js.native
trait PlotChaikinEventsOptions extends js.Object {
  /**
...
object PlotChaikinEventsOptions {
  @scala.inline
  def apply(): PlotChaikinEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinEventsOptions]
  }
  @scala.inline
  implicit class PlotChaikinEventsOptionsOps[Self <: PlotChaikinEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
