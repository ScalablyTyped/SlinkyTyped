...
object PlotStochasticPointEventsOptions {
  @scala.inline
  def apply(): PlotStochasticPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticPointEventsOptions]
  }
  @scala.inline
  implicit class PlotStochasticPointEventsOptionsOps[Self <: PlotStochasticPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
