...
@js.native
trait SeriesPackedbubbleDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesPackedbubbleDataDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesPackedbubbleDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object SeriesPackedbubbleDataDragDropOptions {
  @scala.inline
  def apply(): SeriesPackedbubbleDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPackedbubbleDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesPackedbubbleDataDragDropOptionsOps[Self <: SeriesPackedbubbleDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesPackedbubbleDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(
      value: SeriesPackedbubbleDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
    ): Self = {
        val ret = this.duplicate
