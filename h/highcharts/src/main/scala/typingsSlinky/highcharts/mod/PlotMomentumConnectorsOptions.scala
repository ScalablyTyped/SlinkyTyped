...
trait PlotMomentumConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMomentumConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMomentumConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMomentumConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotMomentumConnectorsOptions {
  @scala.inline
  def apply(): PlotMomentumConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumConnectorsOptions]
  }
  @scala.inline
  implicit class PlotMomentumConnectorsOptionsOps[Self <: PlotMomentumConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotMomentumConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotMomentumConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotMomentumConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
