...
object SeriesSplineDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesSplineDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSplineDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesSplineDataDragDropDragHandleOptionsOps[Self <: SeriesSplineDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
