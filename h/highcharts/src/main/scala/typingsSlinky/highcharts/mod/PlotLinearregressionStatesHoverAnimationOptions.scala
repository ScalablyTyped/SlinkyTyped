...
object PlotLinearregressionStatesHoverAnimationOptions {
  @scala.inline
  def apply(): PlotLinearregressionStatesHoverAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionStatesHoverAnimationOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionStatesHoverAnimationOptionsOps[Self <: PlotLinearregressionStatesHoverAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
