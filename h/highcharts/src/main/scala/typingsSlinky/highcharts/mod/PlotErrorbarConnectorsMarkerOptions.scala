...
object PlotErrorbarConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotErrorbarConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotErrorbarConnectorsMarkerOptionsOps[Self <: PlotErrorbarConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
