...
object SeriesAreaDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesAreaDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesAreaDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesAreaDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesAreaDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
