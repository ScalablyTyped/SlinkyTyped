...
@js.native
trait PlotWaterfallDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotWaterfallDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotWaterfallDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotWaterfallDragDropDragHandleOptionsOps[Self <: PlotWaterfallDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
