...
trait PlotAbandsConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAbandsConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAbandsConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAbandsConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotAbandsConnectorsOptions {
  @scala.inline
  def apply(): PlotAbandsConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsConnectorsOptions]
  }
  @scala.inline
  implicit class PlotAbandsConnectorsOptionsOps[Self <: PlotAbandsConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotAbandsConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotAbandsConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotAbandsConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
