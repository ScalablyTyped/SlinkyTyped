...
object PlotSeriesStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotSeriesStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotSeriesStatesSelectHaloOptionsOps[Self <: PlotSeriesStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
