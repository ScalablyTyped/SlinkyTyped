...
object PlotPivotpointsStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotPivotpointsStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsStatesHoverHaloOptionsOps[Self <: PlotPivotpointsStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
