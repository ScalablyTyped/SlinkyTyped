...
object PlotSplineStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotSplineStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotSplineStatesHoverHaloOptionsOps[Self <: PlotSplineStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
