...
object SeriesScatter3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesScatter3dDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatter3dDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesScatter3dDataDragDropDragHandleOptionsOps[Self <: SeriesScatter3dDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
