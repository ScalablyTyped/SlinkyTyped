...
object SeriesOhlcOptions {
  ...
  @scala.inline
  implicit class SeriesOhlcOptionsMutableBuilder[Self <: SeriesOhlcOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ohlc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
