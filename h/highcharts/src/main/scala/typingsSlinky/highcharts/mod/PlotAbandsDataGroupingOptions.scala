...
@js.native
trait PlotAbandsDataGroupingOptions extends js.Object {
  /**
...
object PlotAbandsDataGroupingOptions {
  @scala.inline
  def apply(): PlotAbandsDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotAbandsDataGroupingOptionsOps[Self <: PlotAbandsDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
