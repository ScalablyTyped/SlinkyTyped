...
object PlotLinearregressionConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionConnectorsEndMarkerOptionsOps[Self <: PlotLinearregressionConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
