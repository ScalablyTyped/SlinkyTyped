...
@js.native
trait PlotBubbleDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotBubbleDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): PlotBubbleDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class PlotBubbleDragDropGuideBoxDefaultOptionsOps[Self <: PlotBubbleDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
