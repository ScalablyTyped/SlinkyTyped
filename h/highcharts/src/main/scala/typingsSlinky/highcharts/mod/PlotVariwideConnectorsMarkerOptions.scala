...
object PlotVariwideConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotVariwideConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotVariwideConnectorsMarkerOptionsOps[Self <: PlotVariwideConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
