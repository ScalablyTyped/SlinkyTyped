...
object PlotPackedbubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotPackedbubbleMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPackedbubbleMarkerStatesSelectOptionsOps[Self <: PlotPackedbubbleMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
