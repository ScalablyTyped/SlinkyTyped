...
object PlotStochasticAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotStochasticAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotStochasticAccessibilityKeyboardNavigationOptionsOps[Self <: PlotStochasticAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
