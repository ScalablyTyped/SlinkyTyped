...
@js.native
trait PlotAroonoscillatorDataSortingOptions extends js.Object {
  /**
...
object PlotAroonoscillatorDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAroonoscillatorDataSortingOptionsOps[Self <: PlotAroonoscillatorDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
