...
@js.native
trait PlotAroonoscillatorDataSortingOptions extends StObject {
...
object PlotAroonoscillatorDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAroonoscillatorDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAroonoscillatorDataSortingOptionsMutableBuilder[Self <: PlotAroonoscillatorDataSortingOptions] (val x: Self) extends AnyVal {
