...
object PlotItemConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotItemConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotItemConnectorsMarkerOptionsOps[Self <: PlotItemConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
