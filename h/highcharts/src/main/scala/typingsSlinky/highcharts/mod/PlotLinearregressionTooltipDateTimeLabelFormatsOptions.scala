...
@js.native
trait PlotLinearregressionTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotLinearregressionTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotLinearregressionTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotLinearregressionTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMillisecond(value: String): Self = {
        val ret = this.duplicate
