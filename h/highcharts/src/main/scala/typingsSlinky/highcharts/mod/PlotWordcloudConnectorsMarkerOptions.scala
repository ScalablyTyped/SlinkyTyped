...
object PlotWordcloudConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotWordcloudConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotWordcloudConnectorsMarkerOptionsOps[Self <: PlotWordcloudConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
