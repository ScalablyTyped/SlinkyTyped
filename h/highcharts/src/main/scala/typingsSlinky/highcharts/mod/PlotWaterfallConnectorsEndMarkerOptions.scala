...
object PlotWaterfallConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotWaterfallConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotWaterfallConnectorsEndMarkerOptionsOps[Self <: PlotWaterfallConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
