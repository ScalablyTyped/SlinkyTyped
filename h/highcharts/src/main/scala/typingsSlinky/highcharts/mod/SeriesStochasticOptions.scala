...
trait SeriesStochasticOptions extends PlotStochasticOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | stochastic = js.native
...
object SeriesStochasticOptions {
  ...
  @scala.inline
  def apply(`type`: String | stochastic): SeriesStochasticOptions = {
  ...
  @scala.inline
  implicit class SeriesStochasticOptionsMutableBuilder[Self <: SeriesStochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | stochastic): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
