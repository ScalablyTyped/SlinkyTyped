...
object SeriesStochasticOptions {
  ...
  @scala.inline
  implicit class SeriesStochasticOptionsOps[Self <: SeriesStochasticOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | stochastic): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
