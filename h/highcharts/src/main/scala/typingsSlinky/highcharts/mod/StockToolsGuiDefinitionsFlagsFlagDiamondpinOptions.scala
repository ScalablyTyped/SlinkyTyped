...
object StockToolsGuiDefinitionsFlagsFlagDiamondpinOptions {
  ...
  @scala.inline
  implicit class StockToolsGuiDefinitionsFlagsFlagDiamondpinOptionsOps[Self <: StockToolsGuiDefinitionsFlagsFlagDiamondpinOptions] (val x: Self) extends AnyVal {
    @scala.inline
