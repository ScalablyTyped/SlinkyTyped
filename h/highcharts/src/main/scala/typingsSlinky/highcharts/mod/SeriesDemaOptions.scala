...
trait SeriesDemaOptions extends PlotDemaOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | dema = js.native
...
object SeriesDemaOptions {
  
  @scala.inline
  def apply(`type`: String | dema): SeriesDemaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesDemaOptions]
  }
  
  @scala.inline
  implicit class SeriesDemaOptionsMutableBuilder[Self <: SeriesDemaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | dema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
