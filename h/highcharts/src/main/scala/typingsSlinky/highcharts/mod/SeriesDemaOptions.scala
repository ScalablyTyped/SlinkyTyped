...
object SeriesDemaOptions {
  ...
  @scala.inline
  implicit class SeriesDemaOptionsOps[Self <: SeriesDemaOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | dema): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
