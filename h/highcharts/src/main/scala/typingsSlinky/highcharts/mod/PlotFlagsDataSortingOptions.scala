...
@js.native
trait PlotFlagsDataSortingOptions extends StObject {
...
object PlotFlagsDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotFlagsDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotFlagsDataSortingOptionsMutableBuilder[Self <: PlotFlagsDataSortingOptions] (val x: Self) extends AnyVal {
