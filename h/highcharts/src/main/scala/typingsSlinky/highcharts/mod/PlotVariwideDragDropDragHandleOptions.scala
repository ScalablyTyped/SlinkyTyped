...
@js.native
trait PlotVariwideDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVariwideDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotVariwideDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotVariwideDragDropDragHandleOptionsOps[Self <: PlotVariwideDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
