...
trait XAxisCrosshairOptions extends AxisCrosshairOptions {
  ...
  /**
    ...
    */
  var label: js.UndefOr[XAxisCrosshairLabelOptions] = js.native
  /**
...
object XAxisCrosshairOptions {
  @scala.inline
  def apply(): XAxisCrosshairOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisCrosshairOptions]
  }
  @scala.inline
  implicit class XAxisCrosshairOptionsOps[Self <: XAxisCrosshairOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: XAxisCrosshairLabelOptions): Self = {
        val ret = this.duplicate
