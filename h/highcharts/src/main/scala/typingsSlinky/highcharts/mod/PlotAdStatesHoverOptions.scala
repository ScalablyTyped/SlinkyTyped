...
trait PlotAdStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAdStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAdStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotAdStatesHoverOptions {
  @scala.inline
  def apply(): PlotAdStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAdStatesHoverOptionsOps[Self <: PlotAdStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAdStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAdStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
