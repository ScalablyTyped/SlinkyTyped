...
object PlotAroonoscillatorConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorConnectorsStartMarkerOptionsOps[Self <: PlotAroonoscillatorConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
