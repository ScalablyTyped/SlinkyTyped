...
@js.native
trait PlotLineMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotLineMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotLineMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLineMarkerStatesHoverOptionsOps[Self <: PlotLineMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
