...
object SeriesNetworkgraphDataEventsOptions {
  @scala.inline
  def apply(): SeriesNetworkgraphDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesNetworkgraphDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesNetworkgraphDataEventsOptionsOps[Self <: SeriesNetworkgraphDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
