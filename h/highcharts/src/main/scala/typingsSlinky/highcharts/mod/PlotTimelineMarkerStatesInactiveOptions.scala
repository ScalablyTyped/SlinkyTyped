...
object PlotTimelineMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotTimelineMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotTimelineMarkerStatesInactiveOptionsOps[Self <: PlotTimelineMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
