...
trait SeriesPolygonDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesPolygonDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesPolygonDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesPolygonDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesPolygonDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesPolygonDataDragDropOptions = {
