...
object PlotTreemapStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTreemapStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTreemapStatesSelectHaloOptionsOps[Self <: PlotTreemapStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
