...
object SeriesWordcloudDataAccessibilityOptions {
  @scala.inline
  def apply(): SeriesWordcloudDataAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesWordcloudDataAccessibilityOptions]
  }
  @scala.inline
  implicit class SeriesWordcloudDataAccessibilityOptionsOps[Self <: SeriesWordcloudDataAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
