...
object PlotLineAccessibilityKeyboardNavigationOptions {
  @scala.inline
  def apply(): PlotLineAccessibilityKeyboardNavigationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineAccessibilityKeyboardNavigationOptions]
  }
  @scala.inline
  implicit class PlotLineAccessibilityKeyboardNavigationOptionsOps[Self <: PlotLineAccessibilityKeyboardNavigationOptions] (val x: Self) extends AnyVal {
    @scala.inline
