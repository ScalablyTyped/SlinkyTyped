...
object SeriesVectorOptions {
  ...
  implicit class SeriesVectorOptionsOps[Self <: SeriesVectorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String | vector): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withData(value: js.Array[(js.Tuple4[Double | String, Double, Double, Double]) | SeriesVectorDataOptions]): Self = {
        val ret = this.duplicate
