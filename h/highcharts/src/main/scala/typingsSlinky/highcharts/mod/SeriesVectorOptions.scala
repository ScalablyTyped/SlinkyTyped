...
trait SeriesVectorOptions extends PlotVectorOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    js.Array[(js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject]
  ] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | vector = js.native
...
object SeriesVectorOptions {
  ...
  @scala.inline
  def apply(`type`: String | vector): SeriesVectorOptions = {
  ...
  @scala.inline
  implicit class SeriesVectorOptionsMutableBuilder[Self <: SeriesVectorOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | vector): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
