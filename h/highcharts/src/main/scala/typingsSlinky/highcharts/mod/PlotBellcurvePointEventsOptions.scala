...
@js.native
trait PlotBellcurvePointEventsOptions extends js.Object {
  /**
...
object PlotBellcurvePointEventsOptions {
  @scala.inline
  def apply(): PlotBellcurvePointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurvePointEventsOptions]
  }
  @scala.inline
  implicit class PlotBellcurvePointEventsOptionsOps[Self <: PlotBellcurvePointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
