...
trait PlotOhlcConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotOhlcConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotOhlcConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotOhlcConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotOhlcConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotOhlcConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotOhlcConnectorsMarkerOptions = null,
    startMarker: PlotOhlcConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotOhlcConnectorsOptions = {
