...
@js.native
trait PlotOhlcConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotOhlcConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotOhlcConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotOhlcConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotOhlcConnectorsOptions {
  @scala.inline
  def apply(): PlotOhlcConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcConnectorsOptions]
  }
  @scala.inline
  implicit class PlotOhlcConnectorsOptionsOps[Self <: PlotOhlcConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotOhlcConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotOhlcConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotOhlcConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
