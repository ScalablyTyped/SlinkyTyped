...
object PlotNatrMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotNatrMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotNatrMarkerStatesSelectOptionsOps[Self <: PlotNatrMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
