...
object PlotTreemapStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotTreemapStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotTreemapStatesHoverHaloOptionsOps[Self <: PlotTreemapStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
