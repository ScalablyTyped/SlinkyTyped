...
trait PlotFunnel3dStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotFunnel3dStatesHoverAnimationOptions] = js.native
  /**
...
object PlotFunnel3dStatesHoverOptions {
  @scala.inline
  def apply(): PlotFunnel3dStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotFunnel3dStatesHoverOptionsOps[Self <: PlotFunnel3dStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotFunnel3dStatesHoverAnimationOptions): Self = {
