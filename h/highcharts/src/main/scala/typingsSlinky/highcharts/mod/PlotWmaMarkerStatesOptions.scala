...
trait PlotWmaMarkerStatesOptions extends js.Object {
  /**
    ...
    */
  var hover: js.UndefOr[PlotWmaMarkerStatesHoverOptions] = js.native
  var inactive: js.UndefOr[PlotWmaMarkerStatesInactiveOptions] = js.native
  /**
    * (Highstock) The normal state of a single point marker. Currently only
    * used for setting animation when returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotWmaMarkerStatesNormalOptions] = js.native
  /**
    ...
    * true.
    */
  var select: js.UndefOr[PlotWmaMarkerStatesSelectOptions] = js.native
}

object PlotWmaMarkerStatesOptions {
  @scala.inline
  def apply(): PlotWmaMarkerStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaMarkerStatesOptions]
  }
  @scala.inline
  implicit class PlotWmaMarkerStatesOptionsOps[Self <: PlotWmaMarkerStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotWmaMarkerStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotWmaMarkerStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotWmaMarkerStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotWmaMarkerStatesSelectOptions): Self = {
        val ret = this.duplicate
