...
trait PlotHeatmapDragDropGuideBoxOptions extends js.Object {
  /**
    ...
    */
  var default: js.UndefOr[PlotHeatmapDragDropGuideBoxDefaultOptions] = js.native
}
...
object PlotHeatmapDragDropGuideBoxOptions {
  ...
  @scala.inline
  implicit class PlotHeatmapDragDropGuideBoxOptionsOps[Self <: PlotHeatmapDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDefault(value: PlotHeatmapDragDropGuideBoxDefaultOptions): Self = {
