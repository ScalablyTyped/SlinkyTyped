...
trait NavigatorXAxisCrosshairOptions extends js.Object {
  ...
  /**
    ...
    */
  var label: js.UndefOr[NavigatorXAxisCrosshairLabelOptions] = js.native
  /**
...
object NavigatorXAxisCrosshairOptions {
  @scala.inline
  def apply(): NavigatorXAxisCrosshairOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisCrosshairOptions]
  }
  @scala.inline
  implicit class NavigatorXAxisCrosshairOptionsOps[Self <: NavigatorXAxisCrosshairOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: NavigatorXAxisCrosshairLabelOptions): Self = {
        val ret = this.duplicate
