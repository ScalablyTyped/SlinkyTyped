...
object PlotNetworkgraphDataGroupingOptions {
  @scala.inline
  def apply(): PlotNetworkgraphDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotNetworkgraphDataGroupingOptionsOps[Self <: PlotNetworkgraphDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
