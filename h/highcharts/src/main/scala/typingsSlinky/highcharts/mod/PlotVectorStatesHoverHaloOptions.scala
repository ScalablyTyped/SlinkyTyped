...
object PlotVectorStatesHoverHaloOptions {
  @scala.inline
  def apply(): PlotVectorStatesHoverHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorStatesHoverHaloOptions]
  }
  @scala.inline
  implicit class PlotVectorStatesHoverHaloOptionsOps[Self <: PlotVectorStatesHoverHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
