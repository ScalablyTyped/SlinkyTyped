...
@js.native
trait SeriesSankeyDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesSankeyDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesSankeyDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesSankeyDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesSankeyDataDataLabelsAnimationOptionsOps[Self <: SeriesSankeyDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
