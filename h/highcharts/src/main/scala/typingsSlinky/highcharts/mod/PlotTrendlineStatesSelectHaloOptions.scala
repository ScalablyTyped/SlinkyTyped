...
object PlotTrendlineStatesSelectHaloOptions {
  @scala.inline
  def apply(): PlotTrendlineStatesSelectHaloOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineStatesSelectHaloOptions]
  }
  @scala.inline
  implicit class PlotTrendlineStatesSelectHaloOptionsOps[Self <: PlotTrendlineStatesSelectHaloOptions] (val x: Self) extends AnyVal {
    @scala.inline
