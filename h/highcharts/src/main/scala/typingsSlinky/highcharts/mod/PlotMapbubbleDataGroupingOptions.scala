...
object PlotMapbubbleDataGroupingOptions {
  @scala.inline
  def apply(): PlotMapbubbleDataGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDataGroupingOptions]
  }
  @scala.inline
  implicit class PlotMapbubbleDataGroupingOptionsOps[Self <: PlotMapbubbleDataGroupingOptions] (val x: Self) extends AnyVal {
    @scala.inline
