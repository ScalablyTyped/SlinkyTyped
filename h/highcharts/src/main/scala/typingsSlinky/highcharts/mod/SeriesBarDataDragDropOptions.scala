...
@js.native
trait SeriesBarDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesBarDataDragDropDragHandleOptions] = js.native
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesBarDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.native
  /**
...
object SeriesBarDataDragDropOptions {
  @scala.inline
  def apply(): SeriesBarDataDragDropOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBarDataDragDropOptions]
  }
  @scala.inline
  implicit class SeriesBarDataDragDropOptionsOps[Self <: SeriesBarDataDragDropOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDragHandle(value: SeriesBarDataDragDropDragHandleOptions): Self = {
    ...
    @scala.inline
    def withGuideBox(value: SeriesBarDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]): Self = {
        val ret = this.duplicate
