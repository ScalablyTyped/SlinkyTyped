...
trait SeriesBarDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesBarDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesBarDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesBarDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesBarDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesBarDataDragDropOptions = {
