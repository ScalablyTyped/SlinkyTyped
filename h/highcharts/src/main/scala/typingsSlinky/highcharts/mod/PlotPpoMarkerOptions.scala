...
trait PlotPpoMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPpoMarkerStatesOptions] = js.native
  /**
...
object PlotPpoMarkerOptions {
  @scala.inline
  def apply(): PlotPpoMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoMarkerOptions]
  }
  @scala.inline
  implicit class PlotPpoMarkerOptionsOps[Self <: PlotPpoMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotPpoMarkerStatesOptions): Self = {
        val ret = this.duplicate
