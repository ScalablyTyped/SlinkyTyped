...
trait PlotAreasplineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreasplineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotAreasplineStatesHoverOptions {
  @scala.inline
  def apply(): PlotAreasplineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotAreasplineStatesHoverOptionsOps[Self <: PlotAreasplineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotAreasplineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
