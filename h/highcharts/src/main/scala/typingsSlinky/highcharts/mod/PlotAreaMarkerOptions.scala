...
@js.native
trait PlotAreaMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreaMarkerStatesOptions] = js.native
  /**
...
object PlotAreaMarkerOptions {
  @scala.inline
  def apply(): PlotAreaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaMarkerOptions]
  }
  @scala.inline
  implicit class PlotAreaMarkerOptionsOps[Self <: PlotAreaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAreaMarkerStatesOptions): Self = {
        val ret = this.duplicate
