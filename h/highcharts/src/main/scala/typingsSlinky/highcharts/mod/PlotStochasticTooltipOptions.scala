...
trait PlotStochasticTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotStochasticTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotStochasticTooltipOptions {
  @scala.inline
  def apply(): PlotStochasticTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticTooltipOptions]
  }
  @scala.inline
  implicit class PlotStochasticTooltipOptionsOps[Self <: PlotStochasticTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotStochasticTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
