...
@js.native
trait SeriesColumnDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesColumnDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesColumnDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesColumnDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesColumnDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesColumnDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
