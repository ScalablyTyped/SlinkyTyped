...
trait PlotTimelineTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTimelineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotTimelineTooltipOptions {
  @scala.inline
  def apply(): PlotTimelineTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineTooltipOptions]
  }
  @scala.inline
  implicit class PlotTimelineTooltipOptionsOps[Self <: PlotTimelineTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotTimelineTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
