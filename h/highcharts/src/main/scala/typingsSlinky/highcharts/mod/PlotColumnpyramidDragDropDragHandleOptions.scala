...
object PlotColumnpyramidDragDropDragHandleOptions {
  @scala.inline
  def apply(): PlotColumnpyramidDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class PlotColumnpyramidDragDropDragHandleOptionsOps[Self <: PlotColumnpyramidDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
