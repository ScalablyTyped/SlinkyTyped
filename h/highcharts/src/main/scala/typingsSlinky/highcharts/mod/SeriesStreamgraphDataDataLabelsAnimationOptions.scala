...
@js.native
trait SeriesStreamgraphDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesStreamgraphDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesStreamgraphDataDataLabelsAnimationOptionsOps[Self <: SeriesStreamgraphDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
