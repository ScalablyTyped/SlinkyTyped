...
trait PlotChaikinStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotChaikinStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotChaikinStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotChaikinStatesHoverOptions {
  @scala.inline
  def apply(): PlotChaikinStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotChaikinStatesHoverOptionsOps[Self <: PlotChaikinStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotChaikinStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotChaikinStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
