...
@js.native
trait PlotTemaLabelOptions extends js.Object {
  /**
...
object PlotTemaLabelOptions {
  @scala.inline
  def apply(): PlotTemaLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaLabelOptions]
  }
  @scala.inline
  implicit class PlotTemaLabelOptionsOps[Self <: PlotTemaLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
