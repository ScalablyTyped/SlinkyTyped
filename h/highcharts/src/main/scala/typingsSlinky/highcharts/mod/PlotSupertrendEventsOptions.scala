...
@js.native
trait PlotSupertrendEventsOptions extends js.Object {
  /**
...
object PlotSupertrendEventsOptions {
  @scala.inline
  def apply(): PlotSupertrendEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendEventsOptions]
  }
  @scala.inline
  implicit class PlotSupertrendEventsOptionsOps[Self <: PlotSupertrendEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
