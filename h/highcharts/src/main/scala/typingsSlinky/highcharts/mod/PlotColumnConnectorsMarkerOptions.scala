...
@js.native
trait PlotColumnConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotColumnConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotColumnConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotColumnConnectorsMarkerOptionsOps[Self <: PlotColumnConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
