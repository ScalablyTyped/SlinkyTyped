...
trait PlotWilliamsrConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWilliamsrConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWilliamsrConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWilliamsrConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotWilliamsrConnectorsOptions {
  @scala.inline
  def apply(): PlotWilliamsrConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrConnectorsOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrConnectorsOptionsOps[Self <: PlotWilliamsrConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotWilliamsrConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotWilliamsrConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotWilliamsrConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
