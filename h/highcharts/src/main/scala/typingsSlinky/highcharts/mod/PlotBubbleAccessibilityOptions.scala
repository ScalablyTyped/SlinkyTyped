...
trait PlotBubbleAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBubbleAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBubbleAccessibilityOptions {
  @scala.inline
  def apply(): PlotBubbleAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBubbleAccessibilityOptionsOps[Self <: PlotBubbleAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBubbleAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
