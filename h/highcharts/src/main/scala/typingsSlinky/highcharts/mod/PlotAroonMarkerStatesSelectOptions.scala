...
@js.native
trait PlotAroonMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAroonMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAroonMarkerStatesSelectOptionsOps[Self <: PlotAroonMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
