...
@js.native
trait PlotTrendlineDataLabelsAnimationOptions extends js.Object {
...
object PlotTrendlineDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotTrendlineDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotTrendlineDataLabelsAnimationOptionsOps[Self <: PlotTrendlineDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
