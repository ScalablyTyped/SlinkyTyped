...
trait PlotEmaAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotEmaAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotEmaAccessibilityOptions {
  @scala.inline
  def apply(): PlotEmaAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotEmaAccessibilityOptionsOps[Self <: PlotEmaAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotEmaAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
