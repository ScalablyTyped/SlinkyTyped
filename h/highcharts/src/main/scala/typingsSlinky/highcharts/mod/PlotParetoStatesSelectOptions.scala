...
trait PlotParetoStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotParetoStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotParetoStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotParetoStatesSelectOptions {
  @scala.inline
  def apply(): PlotParetoStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotParetoStatesSelectOptionsOps[Self <: PlotParetoStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotParetoStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotParetoStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
