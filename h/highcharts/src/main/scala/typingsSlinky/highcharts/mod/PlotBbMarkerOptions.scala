...
trait PlotBbMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBbMarkerStatesOptions] = js.native
  /**
...
object PlotBbMarkerOptions {
  @scala.inline
  def apply(): PlotBbMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbMarkerOptions]
  }
  @scala.inline
  implicit class PlotBbMarkerOptionsOps[Self <: PlotBbMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotBbMarkerStatesOptions): Self = {
        val ret = this.duplicate
