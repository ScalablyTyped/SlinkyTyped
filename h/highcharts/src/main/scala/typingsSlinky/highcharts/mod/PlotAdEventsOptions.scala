...
@js.native
trait PlotAdEventsOptions extends js.Object {
  /**
...
object PlotAdEventsOptions {
  @scala.inline
  def apply(): PlotAdEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdEventsOptions]
  }
  @scala.inline
  implicit class PlotAdEventsOptionsOps[Self <: PlotAdEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
