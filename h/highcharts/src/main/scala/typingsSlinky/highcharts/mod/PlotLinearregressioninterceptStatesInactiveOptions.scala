...
object PlotLinearregressioninterceptStatesInactiveOptions {
  @scala.inline
  def apply(): PlotLinearregressioninterceptStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotLinearregressioninterceptStatesInactiveOptionsOps[Self <: PlotLinearregressioninterceptStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAnimation(
      value: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesInactiveAnimationOptions
    ): Self = {
