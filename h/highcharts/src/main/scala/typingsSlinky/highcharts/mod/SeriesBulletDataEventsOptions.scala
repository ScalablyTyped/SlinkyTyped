...
@js.native
trait SeriesBulletDataEventsOptions extends js.Object {
  /**
...
object SeriesBulletDataEventsOptions {
  @scala.inline
  def apply(): SeriesBulletDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBulletDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesBulletDataEventsOptionsOps[Self <: SeriesBulletDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
