...
trait PlotSolidgaugeConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotSolidgaugeConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSolidgaugeConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotSolidgaugeConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotSolidgaugeConnectorsOptions {
  @scala.inline
  def apply(): PlotSolidgaugeConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeConnectorsOptions]
  }
  @scala.inline
  implicit class PlotSolidgaugeConnectorsOptionsOps[Self <: PlotSolidgaugeConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotSolidgaugeConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotSolidgaugeConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotSolidgaugeConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
