...
trait PlotZigzagStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotZigzagStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotZigzagStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotZigzagStatesSelectOptions {
  @scala.inline
  def apply(): PlotZigzagStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotZigzagStatesSelectOptionsOps[Self <: PlotZigzagStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotZigzagStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotZigzagStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
