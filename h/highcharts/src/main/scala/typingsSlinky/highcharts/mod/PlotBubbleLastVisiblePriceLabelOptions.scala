...
object PlotBubbleLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotBubbleLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotBubbleLastVisiblePriceLabelOptionsOps[Self <: PlotBubbleLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
