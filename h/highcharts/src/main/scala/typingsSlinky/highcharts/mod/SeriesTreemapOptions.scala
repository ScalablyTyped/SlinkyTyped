...
import typingsSlinky.highcharts.highchartsStrings.treemap
...
trait SeriesTreemapOptions extends PlotTreemapOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | treemap = js.native
...
object SeriesTreemapOptions {
  ...
  @scala.inline
  def apply(`type`: String | treemap): SeriesTreemapOptions = {
  ...
  @scala.inline
  implicit class SeriesTreemapOptionsMutableBuilder[Self <: SeriesTreemapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | treemap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
