...
object SeriesTreemapOptions {
  ...
  @scala.inline
  implicit class SeriesTreemapOptionsOps[Self <: SeriesTreemapOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | treemap): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
