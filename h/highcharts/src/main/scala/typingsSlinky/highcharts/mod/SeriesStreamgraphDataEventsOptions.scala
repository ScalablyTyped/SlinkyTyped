...
@js.native
trait SeriesStreamgraphDataEventsOptions extends js.Object {
  /**
...
object SeriesStreamgraphDataEventsOptions {
  @scala.inline
  def apply(): SeriesStreamgraphDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesStreamgraphDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesStreamgraphDataEventsOptionsOps[Self <: SeriesStreamgraphDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
