...
@js.native
trait PlotZigzagDataLabelsOptions extends js.Object {
...
object PlotZigzagDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotZigzagDataLabelsOptionsOps[Self <: PlotZigzagDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotZigzagDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
