...
trait SeriesPyramidDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesPyramidDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesPyramidDataDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesPyramidDataEventsOptions] = js.undefined
  /**
...
object SeriesPyramidDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesPyramidDataAccessibilityOptions = null,
    className: String = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    colorIndex: Int | Double = null,
    dataLabels: SeriesPieDataLabelsOptionsObject = null,
    description: String = null,
    dragDrop: SeriesPyramidDataDragDropOptions = null,
    drilldown: String = null,
    events: SeriesPyramidDataEventsOptions = null,
    id: String = null,
