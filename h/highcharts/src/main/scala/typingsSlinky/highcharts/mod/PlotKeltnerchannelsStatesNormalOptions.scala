...
object PlotKeltnerchannelsStatesNormalOptions {
  @scala.inline
  def apply(): PlotKeltnerchannelsStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotKeltnerchannelsStatesNormalOptionsOps[Self <: PlotKeltnerchannelsStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
