...
@js.native
trait PlotLinearregressionslopeDataSortingOptions extends StObject {
...
object PlotLinearregressionslopeDataSortingOptions {
  
  @scala.inline
  def apply(): PlotLinearregressionslopeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionslopeDataSortingOptionsMutableBuilder[Self <: PlotLinearregressionslopeDataSortingOptions] (val x: Self) extends AnyVal {
