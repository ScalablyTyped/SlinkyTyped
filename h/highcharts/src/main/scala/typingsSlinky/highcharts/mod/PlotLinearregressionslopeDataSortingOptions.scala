...
@js.native
trait PlotLinearregressionslopeDataSortingOptions extends js.Object {
...
object PlotLinearregressionslopeDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionslopeDataSortingOptionsOps[Self <: PlotLinearregressionslopeDataSortingOptions] (val x: Self) extends AnyVal {
