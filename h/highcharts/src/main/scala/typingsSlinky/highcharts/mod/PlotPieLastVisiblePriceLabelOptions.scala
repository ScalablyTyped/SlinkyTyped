...
object PlotPieLastVisiblePriceLabelOptions {
  @scala.inline
  def apply(): PlotPieLastVisiblePriceLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieLastVisiblePriceLabelOptions]
  }
  @scala.inline
  implicit class PlotPieLastVisiblePriceLabelOptionsOps[Self <: PlotPieLastVisiblePriceLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
