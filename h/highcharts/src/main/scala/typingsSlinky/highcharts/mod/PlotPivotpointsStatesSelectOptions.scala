...
trait PlotPivotpointsStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotPivotpointsStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPivotpointsStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotPivotpointsStatesSelectOptions {
  @scala.inline
  def apply(): PlotPivotpointsStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotPivotpointsStatesSelectOptionsOps[Self <: PlotPivotpointsStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotPivotpointsStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotPivotpointsStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
