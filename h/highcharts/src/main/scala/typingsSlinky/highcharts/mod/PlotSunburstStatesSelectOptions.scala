...
trait PlotSunburstStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotSunburstStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSunburstStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotSunburstStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotSunburstStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: js.UndefOr[Double] = js.undefined,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: js.UndefOr[Null | PlotSunburstStatesSelectHaloOptions] = js.undefined,
