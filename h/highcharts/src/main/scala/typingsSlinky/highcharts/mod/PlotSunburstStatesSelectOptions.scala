...
@js.native
trait PlotSunburstStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotSunburstStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSunburstStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotSunburstStatesSelectOptions {
  @scala.inline
  def apply(): PlotSunburstStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotSunburstStatesSelectOptionsOps[Self <: PlotSunburstStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotSunburstStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotSunburstStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
