...
object PlotPolygonConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPolygonConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPolygonConnectorsStartMarkerOptionsOps[Self <: PlotPolygonConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
