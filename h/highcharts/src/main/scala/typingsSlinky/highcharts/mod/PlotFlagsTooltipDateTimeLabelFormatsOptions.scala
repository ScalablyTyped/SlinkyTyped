...
object PlotFlagsTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(): PlotFlagsTooltipDateTimeLabelFormatsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsTooltipDateTimeLabelFormatsOptions]
  }
  @scala.inline
  implicit class PlotFlagsTooltipDateTimeLabelFormatsOptionsOps[Self <: PlotFlagsTooltipDateTimeLabelFormatsOptions] (val x: Self) extends AnyVal {
    @scala.inline
