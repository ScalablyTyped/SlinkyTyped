...
object SeriesXrangeDataConnectEndMarkerOptions {
  @scala.inline
  def apply(): SeriesXrangeDataConnectEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesXrangeDataConnectEndMarkerOptions]
  }
  @scala.inline
  implicit class SeriesXrangeDataConnectEndMarkerOptionsOps[Self <: SeriesXrangeDataConnectEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
