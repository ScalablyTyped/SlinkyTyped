...
object PlotAtrMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotAtrMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotAtrMarkerStatesSelectOptionsOps[Self <: PlotAtrMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
