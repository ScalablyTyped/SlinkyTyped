...
@js.native
trait PlotMfiDataLabelsAnimationOptions extends js.Object {
...
object PlotMfiDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotMfiDataLabelsAnimationOptionsOps[Self <: PlotMfiDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
