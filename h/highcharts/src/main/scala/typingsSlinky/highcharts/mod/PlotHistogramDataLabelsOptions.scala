...
@js.native
trait PlotHistogramDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotHistogramDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotHistogramDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotHistogramDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotHistogramDataLabelsOptionsMutableBuilder[Self <: PlotHistogramDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHistogramDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
