...
@js.native
trait PlotHistogramDataLabelsOptions extends js.Object {
...
object PlotHistogramDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotHistogramDataLabelsOptionsOps[Self <: PlotHistogramDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHistogramDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
