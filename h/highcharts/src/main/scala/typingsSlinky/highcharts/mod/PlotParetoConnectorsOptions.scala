...
trait PlotParetoConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotParetoConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotParetoConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotParetoConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotParetoConnectorsOptions {
  @scala.inline
  def apply(): PlotParetoConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoConnectorsOptions]
  }
  @scala.inline
  implicit class PlotParetoConnectorsOptionsOps[Self <: PlotParetoConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotParetoConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotParetoConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotParetoConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
