...
trait PlotLineStatesHoverOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotLineStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLineStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotLineStatesHoverOptions {
  @scala.inline
  def apply(): PlotLineStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotLineStatesHoverOptionsOps[Self <: PlotLineStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLineStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotLineStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
