...
object PlotMfiConnectorsEndMarkerOptions {
  @scala.inline
  def apply(): PlotMfiConnectorsEndMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiConnectorsEndMarkerOptions]
  }
  @scala.inline
  implicit class PlotMfiConnectorsEndMarkerOptionsOps[Self <: PlotMfiConnectorsEndMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
