...
object SeriesScatterDataEventsOptions {
  @scala.inline
  def apply(): SeriesScatterDataEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesScatterDataEventsOptions]
  }
  @scala.inline
  implicit class SeriesScatterDataEventsOptionsOps[Self <: SeriesScatterDataEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
