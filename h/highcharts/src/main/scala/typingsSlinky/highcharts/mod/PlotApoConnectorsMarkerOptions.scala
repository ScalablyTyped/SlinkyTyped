...
object PlotApoConnectorsMarkerOptions {
  @scala.inline
  def apply(): PlotApoConnectorsMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoConnectorsMarkerOptions]
  }
  @scala.inline
  implicit class PlotApoConnectorsMarkerOptionsOps[Self <: PlotApoConnectorsMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
