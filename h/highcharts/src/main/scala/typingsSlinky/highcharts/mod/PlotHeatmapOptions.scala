...
trait PlotHeatmapOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotHeatmapDataLabelsOptions | js.Array[PlotHeatmapDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotHeatmapDataSortingOptions] = js.native
...
object PlotHeatmapOptions {
  ...
  @scala.inline
  implicit class PlotHeatmapOptionsMutableBuilder[Self <: PlotHeatmapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHeatmapAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotHeatmapDataLabelsOptions | js.Array[PlotHeatmapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotHeatmapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotHeatmapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
