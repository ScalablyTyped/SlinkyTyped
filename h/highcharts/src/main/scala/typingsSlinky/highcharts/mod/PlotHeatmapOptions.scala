...
object PlotHeatmapOptions {
  ...
  implicit class PlotHeatmapOptionsOps[Self <: PlotHeatmapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotHeatmapDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    @scala.inline
    def setDataLabels(value: PlotHeatmapDataLabelsOptions | js.Array[PlotHeatmapDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotHeatmapDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    @scala.inline
