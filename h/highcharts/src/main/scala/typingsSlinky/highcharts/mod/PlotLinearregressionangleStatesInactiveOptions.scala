...
object PlotLinearregressionangleStatesInactiveOptions {
  @scala.inline
  def apply(): PlotLinearregressionangleStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionangleStatesInactiveOptionsOps[Self <: PlotLinearregressionangleStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesInactiveAnimationOptions): Self = {
