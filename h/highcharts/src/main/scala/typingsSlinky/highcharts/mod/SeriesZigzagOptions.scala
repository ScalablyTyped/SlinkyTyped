...
trait SeriesZigzagOptions extends PlotZigzagOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | zigzag = js.native
...
object SeriesZigzagOptions {
  ...
  @scala.inline
  def apply(`type`: String | zigzag): SeriesZigzagOptions = {
  ...
  @scala.inline
  implicit class SeriesZigzagOptionsMutableBuilder[Self <: SeriesZigzagOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | zigzag): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
