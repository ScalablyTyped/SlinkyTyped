...
object SeriesZigzagOptions {
  ...
  @scala.inline
  implicit class SeriesZigzagOptionsOps[Self <: SeriesZigzagOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | zigzag): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
