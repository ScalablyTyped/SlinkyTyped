...
object SeriesErrorbarDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(): SeriesErrorbarDataDragDropGuideBoxDefaultOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesErrorbarDataDragDropGuideBoxDefaultOptions]
  }
  @scala.inline
  implicit class SeriesErrorbarDataDragDropGuideBoxDefaultOptionsOps[Self <: SeriesErrorbarDataDragDropGuideBoxDefaultOptions] (val x: Self) extends AnyVal {
    @scala.inline
