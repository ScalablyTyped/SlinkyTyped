...
object PlotDemaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotDemaConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotDemaConnectorsStartMarkerOptionsOps[Self <: PlotDemaConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
