...
object PlotBubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotBubbleMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotBubbleMarkerStatesHoverOptionsOps[Self <: PlotBubbleMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
