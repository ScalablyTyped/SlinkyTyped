...
object PlotAbandsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotAbandsConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotAbandsConnectorsStartMarkerOptionsOps[Self <: PlotAbandsConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
