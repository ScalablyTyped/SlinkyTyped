...
trait PlotRsiTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotRsiTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotRsiTooltipOptions {
  @scala.inline
  def apply(): PlotRsiTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiTooltipOptions]
  }
  @scala.inline
  implicit class PlotRsiTooltipOptionsOps[Self <: PlotRsiTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotRsiTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
