...
object PlotPcConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotPcConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotPcConnectorsStartMarkerOptionsOps[Self <: PlotPcConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
