...
@js.native
trait PlotSupertrendOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSupertrendAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotSupertrendOptions {
  ...
  @scala.inline
  implicit class PlotSupertrendOptionsMutableBuilder[Self <: PlotSupertrendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSupertrendAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setChangeTrendLine(value: PlotSupertrendChangeTrendLineOptions): Self = StObject.set(x, "changeTrendLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setChangeTrendLineUndefined: Self = StObject.set(x, "changeTrendLine", js.undefined)
    ...
    @scala.inline
    def setDataLabels(value: PlotSupertrendDataLabelsOptions | js.Array[PlotSupertrendDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotSupertrendDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSupertrendDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFallingTrendColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "fallingTrendColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFallingTrendColorUndefined: Self = StObject.set(x, "fallingTrendColor", js.undefined)
    ...
    @scala.inline
    def setParams(value: PlotSupertrendParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRisingTrendColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "risingTrendColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRisingTrendColorUndefined: Self = StObject.set(x, "risingTrendColor", js.undefined)
