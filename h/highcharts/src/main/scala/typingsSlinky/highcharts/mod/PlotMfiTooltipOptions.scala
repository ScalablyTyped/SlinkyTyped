...
trait PlotMfiTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotMfiTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotMfiTooltipOptions {
  @scala.inline
  def apply(): PlotMfiTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiTooltipOptions]
  }
  @scala.inline
  implicit class PlotMfiTooltipOptionsOps[Self <: PlotMfiTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotMfiTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
