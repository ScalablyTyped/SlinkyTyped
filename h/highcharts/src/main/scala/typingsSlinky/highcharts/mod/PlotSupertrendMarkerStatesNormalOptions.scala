...
object PlotSupertrendMarkerStatesNormalOptions {
  @scala.inline
  def apply(): PlotSupertrendMarkerStatesNormalOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendMarkerStatesNormalOptions]
  }
  @scala.inline
  implicit class PlotSupertrendMarkerStatesNormalOptionsOps[Self <: PlotSupertrendMarkerStatesNormalOptions] (val x: Self) extends AnyVal {
    @scala.inline
