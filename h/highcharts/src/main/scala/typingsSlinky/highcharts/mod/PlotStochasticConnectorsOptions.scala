...
trait PlotStochasticConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotStochasticConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotStochasticConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotStochasticConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotStochasticConnectorsOptions {
  @scala.inline
  def apply(): PlotStochasticConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticConnectorsOptions]
  }
  @scala.inline
  implicit class PlotStochasticConnectorsOptionsOps[Self <: PlotStochasticConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotStochasticConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotStochasticConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotStochasticConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
