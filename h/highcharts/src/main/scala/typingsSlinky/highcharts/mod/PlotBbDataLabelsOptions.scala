...
@js.native
trait PlotBbDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotBbDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotBbDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotBbDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotBbDataLabelsOptionsOps[Self <: PlotBbDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBbDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
