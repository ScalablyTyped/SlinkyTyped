...
object PlotBbDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotBbDataLabelsOptionsMutableBuilder[Self <: PlotBbDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBbDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
