...
@js.native
trait PlotTrendlineConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTrendlineConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTrendlineConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTrendlineConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotTrendlineConnectorsOptions {
  @scala.inline
  def apply(): PlotTrendlineConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineConnectorsOptions]
  }
  @scala.inline
  implicit class PlotTrendlineConnectorsOptionsOps[Self <: PlotTrendlineConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotTrendlineConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotTrendlineConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotTrendlineConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
