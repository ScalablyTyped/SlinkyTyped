...
trait PlotTrendlineConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTrendlineConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTrendlineConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTrendlineConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTrendlineConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotTrendlineConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: js.UndefOr[Double] = js.undefined,
    marker: PlotTrendlineConnectorsMarkerOptions = null,
    startMarker: PlotTrendlineConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTrendlineConnectorsOptions = {
