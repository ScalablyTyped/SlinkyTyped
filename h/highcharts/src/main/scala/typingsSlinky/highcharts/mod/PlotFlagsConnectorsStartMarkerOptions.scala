...
@js.native
trait PlotFlagsConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotFlagsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotFlagsConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotFlagsConnectorsStartMarkerOptionsOps[Self <: PlotFlagsConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
