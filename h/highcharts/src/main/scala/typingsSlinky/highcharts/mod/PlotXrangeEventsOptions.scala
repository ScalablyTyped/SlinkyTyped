...
@js.native
trait PlotXrangeEventsOptions extends js.Object {
  /**
...
object PlotXrangeEventsOptions {
  @scala.inline
  def apply(): PlotXrangeEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeEventsOptions]
  }
  @scala.inline
  implicit class PlotXrangeEventsOptionsOps[Self <: PlotXrangeEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
