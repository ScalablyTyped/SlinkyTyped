...
object PlotLinearregressionConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotLinearregressionConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionConnectorsStartMarkerOptionsOps[Self <: PlotLinearregressionConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
