...
object PlotRsiMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotRsiMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotRsiMarkerStatesInactiveOptionsOps[Self <: PlotRsiMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
