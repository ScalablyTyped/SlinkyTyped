...
@js.native
trait ChartParallelAxesGridOptions extends js.Object {
  /**
...
object ChartParallelAxesGridOptions {
  ...
  @scala.inline
  implicit class ChartParallelAxesGridOptionsOps[Self <: ChartParallelAxesGridOptions] (val x: Self) extends AnyVal {
    @scala.inline
