...
trait SeriesTrendlineOptions extends PlotTrendlineOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | trendline = js.native
...
object SeriesTrendlineOptions {
  
  @scala.inline
  def apply(`type`: String | trendline): SeriesTrendlineOptions = {
  ...
  @scala.inline
  implicit class SeriesTrendlineOptionsMutableBuilder[Self <: SeriesTrendlineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | trendline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
