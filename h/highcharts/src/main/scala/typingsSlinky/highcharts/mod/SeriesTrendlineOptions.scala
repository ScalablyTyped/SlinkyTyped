...
object SeriesTrendlineOptions {
  ...
  @scala.inline
  implicit class SeriesTrendlineOptionsOps[Self <: SeriesTrendlineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | trendline): Self = this.set("type", value.asInstanceOf[js.Any])
