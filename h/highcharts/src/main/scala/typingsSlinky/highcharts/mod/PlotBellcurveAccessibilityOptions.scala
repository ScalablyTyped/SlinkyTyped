...
trait PlotBellcurveAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBellcurveAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotBellcurveAccessibilityOptions {
  @scala.inline
  def apply(): PlotBellcurveAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotBellcurveAccessibilityOptionsOps[Self <: PlotBellcurveAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotBellcurveAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
