...
@js.native
trait PlotTrixStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTrixStatesHoverAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrixStatesHoverHaloOptions | Null] = js.native
  /**
...
object PlotTrixStatesHoverOptions {
  @scala.inline
  def apply(): PlotTrixStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotTrixStatesHoverOptionsOps[Self <: PlotTrixStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: Boolean | AnimationOptionsObject | PlotTrixStatesHoverAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotTrixStatesHoverHaloOptions): Self = {
        val ret = this.duplicate
