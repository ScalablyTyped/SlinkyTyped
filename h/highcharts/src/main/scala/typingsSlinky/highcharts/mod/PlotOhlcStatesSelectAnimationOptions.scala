...
object PlotOhlcStatesSelectAnimationOptions {
  @scala.inline
  def apply(): PlotOhlcStatesSelectAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcStatesSelectAnimationOptions]
  }
  @scala.inline
  implicit class PlotOhlcStatesSelectAnimationOptionsOps[Self <: PlotOhlcStatesSelectAnimationOptions] (val x: Self) extends AnyVal {
    @scala.inline
