...
@js.native
trait PlotChaikinConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotChaikinConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotChaikinConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotChaikinConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotChaikinConnectorsOptions {
  @scala.inline
  def apply(): PlotChaikinConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinConnectorsOptions]
  }
  @scala.inline
  implicit class PlotChaikinConnectorsOptionsOps[Self <: PlotChaikinConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotChaikinConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotChaikinConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotChaikinConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
