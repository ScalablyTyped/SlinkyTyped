...
trait PlotChaikinConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotChaikinConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotChaikinConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotChaikinConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotChaikinConnectorsOptions {
  ...
  def apply(
    ...
    endMarker: PlotChaikinConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotChaikinConnectorsMarkerOptions = null,
    startMarker: PlotChaikinConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotChaikinConnectorsOptions = {
