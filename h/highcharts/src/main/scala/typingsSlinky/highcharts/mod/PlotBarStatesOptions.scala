...
trait PlotBarStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotBarStatesHoverOptions] = js.native
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotBarStatesInactiveOptions] = js.native
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotBarStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotBarStatesSelectOptions] = js.native
}

object PlotBarStatesOptions {
  @scala.inline
  def apply(): PlotBarStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarStatesOptions]
  }
  @scala.inline
  implicit class PlotBarStatesOptionsOps[Self <: PlotBarStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotBarStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotBarStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotBarStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotBarStatesSelectOptions): Self = {
        val ret = this.duplicate
