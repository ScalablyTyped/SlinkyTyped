...
trait PlotAroonoscillatorMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonoscillatorMarkerStatesOptions] = js.native
  /**
...
object PlotAroonoscillatorMarkerOptions {
  @scala.inline
  def apply(): PlotAroonoscillatorMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorMarkerOptions]
  }
  @scala.inline
  implicit class PlotAroonoscillatorMarkerOptionsOps[Self <: PlotAroonoscillatorMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotAroonoscillatorMarkerStatesOptions): Self = {
        val ret = this.duplicate
