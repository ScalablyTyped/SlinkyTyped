...
trait PlotSupertrendAccessibilityOptions extends js.Object {
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSupertrendAccessibilityKeyboardNavigationOptions] = js.native
  /**
...
object PlotSupertrendAccessibilityOptions {
  @scala.inline
  def apply(): PlotSupertrendAccessibilityOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendAccessibilityOptions]
  }
  @scala.inline
  implicit class PlotSupertrendAccessibilityOptionsOps[Self <: PlotSupertrendAccessibilityOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKeyboardNavigation(value: js.Object | PlotSupertrendAccessibilityKeyboardNavigationOptions): Self = {
        val ret = this.duplicate
