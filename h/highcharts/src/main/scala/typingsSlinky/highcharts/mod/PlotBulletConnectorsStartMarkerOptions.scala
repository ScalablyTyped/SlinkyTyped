...
object PlotBulletConnectorsStartMarkerOptions {
  @scala.inline
  def apply(): PlotBulletConnectorsStartMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletConnectorsStartMarkerOptions]
  }
  @scala.inline
  implicit class PlotBulletConnectorsStartMarkerOptionsOps[Self <: PlotBulletConnectorsStartMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
