...
trait PlotErrorbarTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotErrorbarTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotErrorbarTooltipOptions {
  @scala.inline
  def apply(): PlotErrorbarTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarTooltipOptions]
  }
  @scala.inline
  implicit class PlotErrorbarTooltipOptionsOps[Self <: PlotErrorbarTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotErrorbarTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
