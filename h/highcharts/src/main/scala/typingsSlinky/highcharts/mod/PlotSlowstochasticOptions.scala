...
@js.native
trait PlotSlowstochasticOptions extends js.Object {
...
object PlotSlowstochasticOptions {
  ...
  @scala.inline
  implicit class PlotSlowstochasticOptionsOps[Self <: PlotSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSlowstochasticAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotSlowstochasticDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotSlowstochasticDataLabelsOptions | js.Array[PlotSlowstochasticDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotSlowstochasticParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmoothedLine(value: PlotSlowstochasticSmoothedLineOptions): Self = this.set("smoothedLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSmoothedLine: Self = this.set("smoothedLine", js.undefined)
