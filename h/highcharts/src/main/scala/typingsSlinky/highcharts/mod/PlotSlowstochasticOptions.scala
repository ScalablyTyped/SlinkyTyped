...
trait PlotSlowstochasticOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSlowstochasticAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotSlowstochasticParamsOptions] = js.native
  ...
  /**
    ...
    */
  var smoothedLine: js.UndefOr[PlotSlowstochasticSmoothedLineOptions] = js.native
...
object PlotSlowstochasticOptions {
  ...
  @scala.inline
  def apply(): PlotSlowstochasticOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticOptions]
  }
  
  @scala.inline
  implicit class PlotSlowstochasticOptionsMutableBuilder[Self <: PlotSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSlowstochasticAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotSlowstochasticDataLabelsOptions | js.Array[PlotSlowstochasticDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotSlowstochasticDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotSlowstochasticParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmoothedLine(value: PlotSlowstochasticSmoothedLineOptions): Self = StObject.set(x, "smoothedLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSmoothedLineUndefined: Self = StObject.set(x, "smoothedLine", js.undefined)
