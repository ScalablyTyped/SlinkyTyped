...
object PlotLinearregressionslopeMarkerStatesSelectOptions {
  @scala.inline
  def apply(): PlotLinearregressionslopeMarkerStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotLinearregressionslopeMarkerStatesSelectOptionsOps[Self <: PlotLinearregressionslopeMarkerStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
