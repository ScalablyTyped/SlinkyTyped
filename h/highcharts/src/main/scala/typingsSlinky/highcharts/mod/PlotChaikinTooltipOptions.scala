...
trait PlotChaikinTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotChaikinTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.native
  /**
...
object PlotChaikinTooltipOptions {
  @scala.inline
  def apply(): PlotChaikinTooltipOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinTooltipOptions]
  }
  @scala.inline
  implicit class PlotChaikinTooltipOptionsOps[Self <: PlotChaikinTooltipOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDateTimeLabelFormats(value: PlotChaikinTooltipDateTimeLabelFormatsOptions | Dictionary[String]): Self = {
        val ret = this.duplicate
