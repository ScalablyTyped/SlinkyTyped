...
@js.native
trait PlotSunburstEventsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var checkboxClick: js.UndefOr[js.Function] = js.native
  /**
...
object PlotSunburstEventsOptions {
  @scala.inline
  def apply(): PlotSunburstEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstEventsOptions]
  }
  @scala.inline
  implicit class PlotSunburstEventsOptionsOps[Self <: PlotSunburstEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCheckboxClick(value: js.Function): Self = {
        val ret = this.duplicate
