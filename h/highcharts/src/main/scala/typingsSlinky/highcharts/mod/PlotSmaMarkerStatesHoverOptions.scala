...
@js.native
trait PlotSmaMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotSmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(): PlotSmaMarkerStatesHoverOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaMarkerStatesHoverOptions]
  }
  @scala.inline
  implicit class PlotSmaMarkerStatesHoverOptionsOps[Self <: PlotSmaMarkerStatesHoverOptions] (val x: Self) extends AnyVal {
    @scala.inline
