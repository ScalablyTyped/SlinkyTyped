...
object SeriesVennDataDragDropDragHandleOptions {
  @scala.inline
  def apply(): SeriesVennDataDragDropDragHandleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesVennDataDragDropDragHandleOptions]
  }
  @scala.inline
  implicit class SeriesVennDataDragDropDragHandleOptionsOps[Self <: SeriesVennDataDragDropDragHandleOptions] (val x: Self) extends AnyVal {
    @scala.inline
