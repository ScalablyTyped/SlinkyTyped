...
trait PlotSplineStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotSplineStatesHoverOptions] = js.native
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotSplineStatesInactiveOptions] = js.native
  /**
    ...
    */
  var normal: js.UndefOr[PlotSplineStatesNormalOptions] = js.native
  /**
    ...
    */
  var select: js.UndefOr[PlotSplineStatesSelectOptions] = js.native
}

object PlotSplineStatesOptions {
  @scala.inline
  def apply(): PlotSplineStatesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineStatesOptions]
  }
  @scala.inline
  implicit class PlotSplineStatesOptionsOps[Self <: PlotSplineStatesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHover(value: PlotSplineStatesHoverOptions): Self = {
    ...
    @scala.inline
    def withInactive(value: PlotSplineStatesInactiveOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNormal(value: PlotSplineStatesNormalOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: PlotSplineStatesSelectOptions): Self = {
        val ret = this.duplicate
