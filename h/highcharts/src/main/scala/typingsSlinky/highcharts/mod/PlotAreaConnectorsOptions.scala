...
trait PlotAreaConnectorsOptions extends js.Object {
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAreaConnectorsEndMarkerOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreaConnectorsMarkerOptions] = js.native
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAreaConnectorsStartMarkerOptions] = js.native
  /**
...
object PlotAreaConnectorsOptions {
  @scala.inline
  def apply(): PlotAreaConnectorsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaConnectorsOptions]
  }
  @scala.inline
  implicit class PlotAreaConnectorsOptionsOps[Self <: PlotAreaConnectorsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEndMarker(value: PlotAreaConnectorsEndMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarker(value: PlotAreaConnectorsMarkerOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartMarker(value: PlotAreaConnectorsStartMarkerOptions): Self = {
        val ret = this.duplicate
