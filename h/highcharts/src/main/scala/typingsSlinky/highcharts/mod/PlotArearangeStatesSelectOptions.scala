...
trait PlotArearangeStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotArearangeStatesSelectAnimationOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotArearangeStatesSelectHaloOptions | Null] = js.native
  /**
...
object PlotArearangeStatesSelectOptions {
  @scala.inline
  def apply(): PlotArearangeStatesSelectOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeStatesSelectOptions]
  }
  @scala.inline
  implicit class PlotArearangeStatesSelectOptionsOps[Self <: PlotArearangeStatesSelectOptions] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAnimation(value: PlotArearangeStatesSelectAnimationOptions): Self = {
    ...
    @scala.inline
    def withHalo(value: PlotArearangeStatesSelectHaloOptions): Self = {
        val ret = this.duplicate
