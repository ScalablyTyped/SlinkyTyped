...
trait PlotDemaMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDemaMarkerStatesOptions] = js.native
  /**
...
object PlotDemaMarkerOptions {
  @scala.inline
  def apply(): PlotDemaMarkerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaMarkerOptions]
  }
  @scala.inline
  implicit class PlotDemaMarkerOptionsOps[Self <: PlotDemaMarkerOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStates(value: PlotDemaMarkerStatesOptions): Self = {
        val ret = this.duplicate
