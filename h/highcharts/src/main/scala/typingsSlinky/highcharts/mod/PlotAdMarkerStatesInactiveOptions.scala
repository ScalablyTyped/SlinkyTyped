...
object PlotAdMarkerStatesInactiveOptions {
  @scala.inline
  def apply(): PlotAdMarkerStatesInactiveOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdMarkerStatesInactiveOptions]
  }
  @scala.inline
  implicit class PlotAdMarkerStatesInactiveOptionsOps[Self <: PlotAdMarkerStatesInactiveOptions] (val x: Self) extends AnyVal {
    @scala.inline
