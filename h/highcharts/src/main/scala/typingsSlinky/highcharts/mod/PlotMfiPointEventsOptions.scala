...
@js.native
trait PlotMfiPointEventsOptions extends js.Object {
  /**
...
object PlotMfiPointEventsOptions {
  @scala.inline
  def apply(): PlotMfiPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiPointEventsOptions]
  }
  @scala.inline
  implicit class PlotMfiPointEventsOptionsOps[Self <: PlotMfiPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
