...
@js.native
trait PlotStochasticDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotStochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotStochasticDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotStochasticDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotStochasticDataLabelsOptionsMutableBuilder[Self <: PlotStochasticDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
