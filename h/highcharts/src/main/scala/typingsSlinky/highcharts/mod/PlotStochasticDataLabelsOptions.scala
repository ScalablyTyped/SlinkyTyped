...
@js.native
trait PlotStochasticDataLabelsOptions extends js.Object {
...
object PlotStochasticDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotStochasticDataLabelsOptionsOps[Self <: PlotStochasticDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotStochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
