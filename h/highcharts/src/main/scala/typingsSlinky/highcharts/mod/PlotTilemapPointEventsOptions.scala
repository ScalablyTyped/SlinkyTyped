...
@js.native
trait PlotTilemapPointEventsOptions extends js.Object {
  /**
...
object PlotTilemapPointEventsOptions {
  @scala.inline
  def apply(): PlotTilemapPointEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapPointEventsOptions]
  }
  @scala.inline
  implicit class PlotTilemapPointEventsOptionsOps[Self <: PlotTilemapPointEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
