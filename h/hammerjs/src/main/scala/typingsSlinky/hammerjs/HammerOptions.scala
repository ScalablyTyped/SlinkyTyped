...
object HammerOptions {
  ...
  implicit class HammerOptionsOps[Self <: HammerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnableFunction1(value: /* manager */ HammerManager => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enable")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withEnable(value: Boolean | (js.Function1[/* manager */ HammerManager, Boolean])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRecognizers(value: js.Array[RecognizerTuple]): Self = {
        val ret = this.duplicate
