...
package object hammerjs {
  ...
  type SingleTouchInput = typingsSlinky.hammerjs.HammerInput
  type SwipeRecognizer = typingsSlinky.hammerjs.AttrRecognizer
  type TapRecognizer = typingsSlinky.hammerjs.AttrRecognizer
  type TouchInput = typingsSlinky.hammerjs.HammerInput
  type TouchMouseInput = typingsSlinky.hammerjs.HammerInput
}
