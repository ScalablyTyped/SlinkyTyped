...
object HammerInput {
  ...
  implicit class HammerInputOps[Self <: HammerInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSrcEventPointerEvent(value: PointerEvent): Self = this.set("srcEvent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSrcEventMouseEvent(value: MouseEvent): Self = this.set("srcEvent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSrcEventTouchEvent(value: TouchEvent): Self = this.set("srcEvent", value.asInstanceOf[js.Any])
