...
object UriOptions {
  ...
  implicit class UriOptionsOps[Self <: UriOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSchemeVarargs(value: (String | js.RegExp)*): Self = this.set("scheme", js.Array(value :_*))
    @scala.inline
    def setSchemeRegExp(value: js.RegExp): Self = this.set("scheme", value.asInstanceOf[js.Any])
    @scala.inline
    def setScheme(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = this.set("scheme", value.asInstanceOf[js.Any])
    @scala.inline
