...
trait ExtraInfo extends js.Object {
  var extraInfo: js.UndefOr[typingsSlinky.hapiAuthJwt2.mod.ExtraInfo] = js.undefined
  var key: String | js.Array[String]
}

object ExtraInfo {
  @scala.inline
  def apply(key: String | js.Array[String], extraInfo: typingsSlinky.hapiAuthJwt2.mod.ExtraInfo = null): ExtraInfo = {
