...
object mod extends Shortcut {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var key: js.UndefOr[
        String | js.Array[String] | Buffer | (js.Function1[/* decodedToken */ js.Any, js.Promise[typingsSlinky.hapiAuthJwt2.anon.ExtraInfo]])
      ] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKey(
        value: String | js.Array[String] | Buffer | (js.Function1[/* decodedToken */ js.Any, js.Promise[typingsSlinky.hapiAuthJwt2.anon.ExtraInfo]])
      ): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKeyFunction1(value: /* decodedToken */ js.Any => js.Promise[typingsSlinky.hapiAuthJwt2.anon.ExtraInfo]): Self = StObject.set(x, "key", js.Any.fromFunction1(value))
