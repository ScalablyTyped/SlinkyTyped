...
import typingsSlinky.hexoUtil.anon.AutoDetect
import typingsSlinky.hexoUtil.anon.Length
import typingsSlinky.hexoUtil.anon.Segments
import typingsSlinky.hexoUtil.anon.Separator
import typingsSlinky.hexoUtil.anon.Width
...
object mod {
  ...
  @JSImport("hexo-util", "hash")
  @js.native
  def hash(str: js.typedarray.ArrayBufferView): Buffer = js.native
