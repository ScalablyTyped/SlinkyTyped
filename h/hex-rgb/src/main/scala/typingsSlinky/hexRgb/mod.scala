...
import typingsSlinky.hexRgb.anon.Optionsformatarray
import typingsSlinky.hexRgb.anon.Optionsformatcss
import typingsSlinky.hexRgb.anon.Optionsformatobject
