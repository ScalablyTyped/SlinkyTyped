...
object highlightJsStrings {
  ...
  @js.native
  sealed trait afterColonhighlight extends PluginEvent
  @scala.inline
  def afterColonhighlight: afterColonhighlight = "after:highlight".asInstanceOf[afterColonhighlight]
  
  @js.native
  sealed trait afterColonhighlightBlock extends PluginEvent
  @scala.inline
  ...
  @js.native
  sealed trait end extends MatchType
  @scala.inline
  ...
  @js.native
  sealed trait illegal extends MatchType
  @scala.inline
