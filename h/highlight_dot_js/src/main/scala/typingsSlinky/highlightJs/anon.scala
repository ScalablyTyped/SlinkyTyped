...
import typingsSlinky.highlightJs.highlightJsStrings.self
...
object anon {
  ...
  object OmitHighlightResultsecond {
    ...
    implicit class OmitHighlightResultsecondMutableBuilder[Self <: OmitHighlightResultsecond] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrorRaised(value: js.Error): Self = StObject.set(x, "errorRaised", value.asInstanceOf[js.Any])
  ...
  trait PartialHLJSOptions extends StObject {
    ...
    var languageDetectRe: js.UndefOr[js.RegExp] = js.native
    
    var languages: js.UndefOr[js.Array[String]] = js.native
    
    var noHighlightRe: js.UndefOr[js.RegExp] = js.native
  ...
  trait PartialModebinarystringRe extends StObject {
    ...
    var binary: js.UndefOr[String | js.RegExp] = js.native
  ...
  object PartialModebinarystringRe {
    ...
    implicit class PartialModebinarystringReMutableBuilder[Self <: PartialModebinarystringRe] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBinary(value: String | js.RegExp): Self = StObject.set(x, "binary", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBinaryRegExp(value: js.RegExp): Self = StObject.set(x, "binary", value.asInstanceOf[js.Any])
