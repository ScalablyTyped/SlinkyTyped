...
object HLJSOptions {
  ...
  implicit class HLJSOptionsOps[Self <: HLJSOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLanguageDetectRe(value: js.RegExp): Self = this.set("languageDetectRe", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoHighlightRe(value: js.RegExp): Self = this.set("noHighlightRe", value.asInstanceOf[js.Any])
