...
trait HLJSOptions extends StObject {
  ...
  var languageDetectRe: js.RegExp = js.native
  
  var languages: js.UndefOr[js.Array[String]] = js.native
  
  var noHighlightRe: js.RegExp = js.native
...
object HLJSOptions {
  ...
  implicit class HLJSOptionsMutableBuilder[Self <: HLJSOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLanguageDetectRe(value: js.RegExp): Self = StObject.set(x, "languageDetectRe", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNoHighlightRe(value: js.RegExp): Self = StObject.set(x, "noHighlightRe", value.asInstanceOf[js.Any])
