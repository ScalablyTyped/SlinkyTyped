package typingsSlinky.highlightJs.anon

import typingsSlinky.highlightJs.CompiledMode
import typingsSlinky.highlightJs.Emitter
import typingsSlinky.highlightJs.Language
import typingsSlinky.highlightJs.illegalData
...
@js.native
trait OmitHighlightResultsecond extends js.Object {
  
  var emitter: Emitter = js.native
  
  var errorRaised: js.UndefOr[js.Error] = js.native
...
object OmitHighlightResultsecond {
  ...
  @scala.inline
  implicit class OmitHighlightResultsecondOps[Self <: OmitHighlightResultsecond] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorRaised(value: js.Error): Self = this.set("errorRaised", value.asInstanceOf[js.Any])
