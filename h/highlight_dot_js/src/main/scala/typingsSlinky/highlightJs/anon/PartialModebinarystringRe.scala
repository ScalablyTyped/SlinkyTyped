...
import typingsSlinky.highlightJs.CallbackResponse
import typingsSlinky.highlightJs.Mode
import typingsSlinky.highlightJs.ModeCallback
...
object PartialModebinarystringRe {
  ...
  implicit class PartialModebinarystringReOps[Self <: PartialModebinarystringRe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBinaryRegExp(value: js.RegExp): Self = this.set("binary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBinary(value: String | js.RegExp): Self = this.set("binary", value.asInstanceOf[js.Any])
