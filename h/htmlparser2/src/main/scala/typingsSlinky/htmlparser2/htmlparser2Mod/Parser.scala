...
class Parser protected () extends js.Object {
  def this(handler: Partial[typingsSlinky.domhandler.domhandlerMod.DomHandler]) = this()
  def this(handler: Partial[typingsSlinky.domhandler.domhandlerMod.DomHandler], options: ParserOptions) = this()
  /***
