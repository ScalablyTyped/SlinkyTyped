package typingsSlinky.htmlparser2.parserMod
...
trait ParserOptions extends js.Object {
  /**
    ...
    */
  var Tokenizer: js.UndefOr[Instantiable2[/* options */ DecodeEntities | Null, /* cbs */ Callbacks, default]] = js.native
  /***
...
object ParserOptions {
  ...
  implicit class ParserOptionsOps[Self <: ParserOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTokenizer(value: Instantiable2[/* options */ DecodeEntities | Null, /* cbs */ Callbacks, default]): Self = this.set("Tokenizer", value.asInstanceOf[js.Any])
    @scala.inline
