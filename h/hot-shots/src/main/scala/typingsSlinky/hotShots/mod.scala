...
import typingsSlinky.hotShots.anon.Buffer
import typingsSlinky.hotShots.hotShotsNumbers.`0`
import typingsSlinky.hotShots.hotShotsNumbers.`1`
import typingsSlinky.hotShots.hotShotsNumbers.`2`
import typingsSlinky.hotShots.hotShotsNumbers.`3`
import typingsSlinky.hotShots.hotShotsStrings.error
import typingsSlinky.hotShots.hotShotsStrings.info
import typingsSlinky.hotShots.hotShotsStrings.low
import typingsSlinky.hotShots.hotShotsStrings.normal
import typingsSlinky.hotShots.hotShotsStrings.success
import typingsSlinky.hotShots.hotShotsStrings.tcp
import typingsSlinky.hotShots.hotShotsStrings.udp
import typingsSlinky.hotShots.hotShotsStrings.uds
import typingsSlinky.hotShots.hotShotsStrings.warning
...
object mod {
  ...
  trait CheckOptions extends StObject {
    ...
    var date_happened: js.UndefOr[js.Date] = js.native
  ...
  object CheckOptions {
    ...
    implicit class CheckOptionsMutableBuilder[Self <: CheckOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDate_happened(value: js.Date): Self = StObject.set(x, "date_happened", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.hotShots.hotShotsNumbers.`0`
    - typingsSlinky.hotShots.hotShotsNumbers.`1`
    - typingsSlinky.hotShots.hotShotsNumbers.`2`
    - typingsSlinky.hotShots.hotShotsNumbers.`3`
  */
  trait DatadogChecksValues extends StObject
  object DatadogChecksValues {
    
    @scala.inline
    def `0`: typingsSlinky.hotShots.hotShotsNumbers.`0` = 0.asInstanceOf[typingsSlinky.hotShots.hotShotsNumbers.`0`]
    
    @scala.inline
    def `1`: typingsSlinky.hotShots.hotShotsNumbers.`1` = 1.asInstanceOf[typingsSlinky.hotShots.hotShotsNumbers.`1`]
    
    @scala.inline
    def `2`: typingsSlinky.hotShots.hotShotsNumbers.`2` = 2.asInstanceOf[typingsSlinky.hotShots.hotShotsNumbers.`2`]
    
    @scala.inline
    def `3`: typingsSlinky.hotShots.hotShotsNumbers.`3` = 3.asInstanceOf[typingsSlinky.hotShots.hotShotsNumbers.`3`]
  }
  ...
  type StatsCb = js.Function2[/* error */ js.UndefOr[js.Error], /* bytes */ js.Any, Unit]
