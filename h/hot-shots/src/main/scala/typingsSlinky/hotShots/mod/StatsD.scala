...
class StatsD () extends js.Object {
  ...
  def timing(stat: String, value: js.Date, sampleRate: js.UndefOr[scala.Nothing], tags: Tags): Unit = js.native
  ...
  def timing(stat: String, value: js.Date, sampleRate: Double, tags: js.UndefOr[Tags], callback: StatsCb): Unit = js.native
  def timing(stat: String, value: js.Date, sampleRate: Double, tags: Tags): Unit = js.native
  def timing(stat: String, value: js.Date, tags: js.UndefOr[Tags], callback: StatsCb): Unit = js.native
  ...
  def timing(stat: js.Array[String], value: js.Date, sampleRate: js.UndefOr[scala.Nothing], tags: Tags): Unit = js.native
  ...
  def timing(stat: js.Array[String], value: js.Date, tags: js.UndefOr[Tags], callback: StatsCb): Unit = js.native
