...
import typingsSlinky.httpAuth.anon.IncomingMessageuserstring
import typingsSlinky.httpAuth.httpAuthBooleans.`false`
import typingsSlinky.httpAuth.httpAuthBooleans.`true`
import typingsSlinky.httpAuth.httpAuthStrings.auth
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.httpAuth.httpAuthStrings.MD5
    - typingsSlinky.httpAuth.httpAuthStrings.`MD5-sess`
  */
  trait Algorithm extends StObject
  object Algorithm {
    
    @scala.inline
    def MD5: typingsSlinky.httpAuth.httpAuthStrings.MD5 = "MD5".asInstanceOf[typingsSlinky.httpAuth.httpAuthStrings.MD5]
    
    @scala.inline
    def `MD5-sess`: typingsSlinky.httpAuth.httpAuthStrings.`MD5-sess` = "MD5-sess".asInstanceOf[typingsSlinky.httpAuth.httpAuthStrings.`MD5-sess`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.httpAuth.httpAuthStrings.auth
    - typingsSlinky.httpAuth.httpAuthStrings.none
  */
  trait Qop extends StObject
  object Qop {
    
    @scala.inline
    def auth: typingsSlinky.httpAuth.httpAuthStrings.auth = "auth".asInstanceOf[typingsSlinky.httpAuth.httpAuthStrings.auth]
    
    @scala.inline
    def none: typingsSlinky.httpAuth.httpAuthStrings.none = "none".asInstanceOf[typingsSlinky.httpAuth.httpAuthStrings.none]
  }
