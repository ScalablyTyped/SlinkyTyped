...
object PlusNet {
  ...
  implicit class PlusNetOps[Self <: PlusNet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProgressEvent(value: PlusNetProgressEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgressEvent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutProgressEvent: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgressEvent")(js.undefined)
        ret
    }
    @scala.inline
    def withXMLHttpRequest(value: PlusNetXMLHttpRequest): Self = {
        val ret = this.duplicate
