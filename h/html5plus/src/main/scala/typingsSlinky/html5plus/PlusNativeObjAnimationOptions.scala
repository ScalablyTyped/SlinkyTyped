...
import typingsSlinky.html5plus.html5plusStrings.`pop-in`
import typingsSlinky.html5plus.html5plusStrings.`pop-out`
import typingsSlinky.html5plus.html5plusStrings.`slide-in-right`
import typingsSlinky.html5plus.html5plusStrings.`slide-out-right`
...
object PlusNativeObjAnimationOptions {
  ...
  implicit class PlusNativeObjAnimationOptionsOps[Self <: PlusNativeObjAnimationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: `pop-in` | `pop-out` | `slide-in-right` | `slide-out-right`): Self = {
        val ret = this.duplicate
