...
import typingsSlinky.html5plus.html5plusStrings._empty
import typingsSlinky.html5plus.html5plusStrings.allow
import typingsSlinky.html5plus.html5plusStrings.instant
import typingsSlinky.html5plus.html5plusStrings.none
import typingsSlinky.html5plus.html5plusStrings.redirect
import typingsSlinky.html5plus.html5plusStrings.reject
...
object PlusWebviewWebviewOverrideUrlOptions {
  ...
  implicit class PlusWebviewWebviewOverrideUrlOptionsOps[Self <: PlusWebviewWebviewOverrideUrlOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEffect(value: instant | _empty): Self = {
    ...
    @scala.inline
    def withExclude(value: none | redirect): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMode(value: allow | reject): Self = {
        val ret = this.duplicate
