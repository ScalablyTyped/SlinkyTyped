...
import typingsSlinky.html5plus.html5plusStrings.`line-through`
import typingsSlinky.html5plus.html5plusStrings.bold
import typingsSlinky.html5plus.html5plusStrings.center
import typingsSlinky.html5plus.html5plusStrings.clip
import typingsSlinky.html5plus.html5plusStrings.italic
...
import typingsSlinky.html5plus.html5plusStrings.nowrap
import typingsSlinky.html5plus.html5plusStrings.right
import typingsSlinky.html5plus.html5plusStrings.underline
...
object PlusNativeObjTextStyles {
  ...
  implicit class PlusNativeObjTextStylesOps[Self <: PlusNativeObjTextStyles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDecoration(value: none | underline | `line-through`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLineSpacing(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOverflow(value: clip): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStyle(value: normal | italic): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWeight(value: normal | bold): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWhiteSpace(value: nowrap | normal): Self = {
        val ret = this.duplicate
