...
object Flags {
  ...
  implicit class FlagsOps[Self <: Flags] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnUncaughtException(value: /* err */ js.Error => Unit): Self = this.set("onUncaughtException", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnUncaughtException: Self = this.set("onUncaughtException", js.undefined)
    
    @scala.inline
    def setOnUnhandledRejection(value: /* err */ js.Error => Unit): Self = this.set("onUnhandledRejection", js.Any.fromFunction1(value))
