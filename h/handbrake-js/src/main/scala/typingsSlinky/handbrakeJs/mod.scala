...
import typingsSlinky.handbrakeJs.anon.Stderr
import typingsSlinky.handbrakeJs.handbrakeJsStrings.Encoding
import typingsSlinky.handbrakeJs.handbrakeJsStrings.Muxing
...
object mod {
  ...
  object HandbrakeErrors extends StObject {
    ...
    /* "InvalidInput" */ val INVALID_INPUT: typingsSlinky.handbrakeJs.mod.HandbrakeErrors.INVALID_INPUT with String = js.native
    
    @js.native
    sealed trait INVALID_PRESET extends HandbrakeErrors
    /* "InvalidPreset" */ val INVALID_PRESET: typingsSlinky.handbrakeJs.mod.HandbrakeErrors.INVALID_PRESET with String = js.native
    
    @js.native
    sealed trait NOT_FOUND extends HandbrakeErrors
    /* "HandbrakeCLINotFound" */ val NOT_FOUND: typingsSlinky.handbrakeJs.mod.HandbrakeErrors.NOT_FOUND with String = js.native
    
    @js.native
    sealed trait OTHER extends HandbrakeErrors
    /* "Other" */ val OTHER: typingsSlinky.handbrakeJs.mod.HandbrakeErrors.OTHER with String = js.native
    
    @js.native
    sealed trait VALIDATION extends HandbrakeErrors
    /* "ValidationError" */ val VALIDATION: typingsSlinky.handbrakeJs.mod.HandbrakeErrors.VALIDATION with String = js.native
  }
