...
import typingsSlinky.helmet.contentSecurityPolicyMod.ContentSecurityPolicyOptions
import typingsSlinky.helmet.expectCtMod.ExpectCtOptions
import typingsSlinky.helmet.helmetBooleans.`false`
import typingsSlinky.helmet.referrerPolicyMod.ReferrerPolicyOptions
import typingsSlinky.helmet.strictTransportSecurityMod.StrictTransportSecurityOptions
import typingsSlinky.helmet.xDnsPrefetchControlMod.XDnsPrefetchControlOptions
import typingsSlinky.helmet.xFrameOptionsMod.XFrameOptionsOptions
import typingsSlinky.helmet.xPermittedCrossDomainPoliciesMod.XPermittedCrossDomainPoliciesOptions
...
object mod {
  ...
  object contentSecurityPolicy {
    ...
    @JSImport("helmet/dist", "contentSecurityPolicy.getDefaultDirectives")
    @js.native
    def getDefaultDirectives_FcontentSecurityPolicy: js.Function0[StringDictionary[js.Iterable[ContentSecurityPolicyDirectiveValue]]] = js.native
    
    @scala.inline
    def getDefaultDirectives_FcontentSecurityPolicy_=(x: js.Function0[StringDictionary[js.Iterable[ContentSecurityPolicyDirectiveValue]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getDefaultDirectives")(x.asInstanceOf[js.Any])
  }
