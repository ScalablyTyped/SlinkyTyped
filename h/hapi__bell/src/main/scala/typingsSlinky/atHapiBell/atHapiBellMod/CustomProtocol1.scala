...
import typingsSlinky.atHapiBell.atHapiBellStrings.`HMAC-SHA1`
import typingsSlinky.atHapiBell.atHapiBellStrings.`RSA-SHA1`
import typingsSlinky.atHapiBell.atHapiBellStrings.oauth
