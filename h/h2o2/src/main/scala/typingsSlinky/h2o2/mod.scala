...
object mod extends Shortcut {
  ...
  object hapiAugmentingMod {
    ...
    object ResponseToolkit {
      ...
      @scala.inline
      def apply(proxy: ProxyHandlerOptions => js.Promise[ResponseObject]): typingsSlinky.h2o2.mod.hapiAugmentingMod.ResponseToolkit = {
        val __obj = js.Dynamic.literal(proxy = js.Any.fromFunction1(proxy))
        __obj.asInstanceOf[typingsSlinky.h2o2.mod.hapiAugmentingMod.ResponseToolkit]
      }
      
      @scala.inline
      implicit class ResponseToolkitMutableBuilder[Self <: typingsSlinky.h2o2.mod.hapiAugmentingMod.ResponseToolkit] (val x: Self) extends AnyVal {
