...
object mod {
  ...
  object ClientApi {
    ...
    implicit class ClientApiMutableBuilder[Self <: ClientApi[_], T] (val x: Self with ClientApi[T]) extends AnyVal {
      ...
      @scala.inline
      def setValidateSegmentName(value: String => Null | js.Error): Self = StObject.set(x, "validateSegmentName", js.Any.fromFunction1(value))
    }
  }
  ...
  - typingsSlinky.hapiCatbox.mod.PolicyOptionVariants because Already inherited */ @js.native
  ...
  type Id = String | typingsSlinky.hapiCatbox.anon.Id
  ...
  */
  ...
  object PolicyOptionVariants {
    ...
    @scala.inline
    def DecoratedPolicyOptions[T](): typingsSlinky.hapiCatbox.mod.DecoratedPolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.hapiCatbox.mod.DecoratedPolicyOptions[T]]
    }
    
    @scala.inline
    def PolicyOptions[T](): typingsSlinky.hapiCatbox.mod.PolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.hapiCatbox.mod.PolicyOptions[T]]
    }
  }
