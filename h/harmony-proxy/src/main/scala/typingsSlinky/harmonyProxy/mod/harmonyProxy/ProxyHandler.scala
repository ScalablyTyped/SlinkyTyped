...
object ProxyHandler {
  ...
  implicit class ProxyHandlerOps[Self <: ProxyHandler[_], T] (val x: Self with ProxyHandler[T]) extends AnyVal {
    ...
    @scala.inline
    def setConstruct(value: (/* target */ T, /* thisArg */ js.Any, /* argArray */ js.UndefOr[js.Any]) => _): Self = this.set("construct", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteConstruct: Self = this.set("construct", js.undefined)
    
    @scala.inline
    def setDefineProperty(value: (/* target */ T, /* p */ PropertyKey, /* attributes */ js.PropertyDescriptor) => Boolean): Self = this.set("defineProperty", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteDefineProperty: Self = this.set("defineProperty", js.undefined)
    
    @scala.inline
    def setDeleteProperty(value: (/* target */ T, /* p */ PropertyKey) => Boolean): Self = this.set("deleteProperty", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setGetOwnPropertyDescriptor(value: (/* target */ T, /* p */ PropertyKey) => js.PropertyDescriptor): Self = this.set("getOwnPropertyDescriptor", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteGetOwnPropertyDescriptor: Self = this.set("getOwnPropertyDescriptor", js.undefined)
    
    @scala.inline
    def setGetPrototypeOf(value: /* target */ T => _): Self = this.set("getPrototypeOf", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteGetPrototypeOf: Self = this.set("getPrototypeOf", js.undefined)
    
    @scala.inline
    def setHas(value: (/* target */ T, /* p */ PropertyKey) => Boolean): Self = this.set("has", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteHas: Self = this.set("has", js.undefined)
    
    @scala.inline
    def setIsExtensible(value: /* target */ T => Boolean): Self = this.set("isExtensible", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPreventExtensions(value: /* target */ T => Boolean): Self = this.set("preventExtensions", js.Any.fromFunction1(value))
    
    @scala.inline
    def deletePreventExtensions: Self = this.set("preventExtensions", js.undefined)
    
    @scala.inline
    def setSet(value: (/* target */ T, /* p */ PropertyKey, /* value */ js.Any, /* receiver */ js.Any) => Boolean): Self = this.set("set", js.Any.fromFunction4(value))
    
    @scala.inline
    def deleteSet: Self = this.set("set", js.undefined)
    
    @scala.inline
    def setSetPrototypeOf(value: (/* target */ T, /* v */ js.Any) => Boolean): Self = this.set("setPrototypeOf", js.Any.fromFunction2(value))
