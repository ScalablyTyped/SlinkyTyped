...
object ProxyHandler {
  ...
  def apply[T](
    ...
    defineProperty: (/* target */ T, /* p */ PropertyKey, /* attributes */ js.PropertyDescriptor) => Boolean = null,
    ...
    getOwnPropertyDescriptor: (/* target */ T, /* p */ PropertyKey) => js.PropertyDescriptor = null,
