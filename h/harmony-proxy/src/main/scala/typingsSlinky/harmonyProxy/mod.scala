package typingsSlinky.harmonyProxy

import org.scalablytyped.runtime.Instantiable2
import org.scalablytyped.runtime.Shortcut
import typingsSlinky.harmonyProxy.anon.Proxy
import typingsSlinky.harmonyProxy.mod.harmonyProxy.ProxyConstructor
  ...
  object harmonyProxy {
    ...
    object ProxyHandler {
      ...
      implicit class ProxyHandlerMutableBuilder[Self <: ProxyHandler[_], T] (val x: Self with ProxyHandler[T]) extends AnyVal {
        ...
        @scala.inline
        def setDefineProperty(value: (/* target */ T, /* p */ PropertyKey, /* attributes */ js.PropertyDescriptor) => Boolean): Self = StObject.set(x, "defineProperty", js.Any.fromFunction3(value))
        ...
        @scala.inline
        def setGetOwnPropertyDescriptor(value: (/* target */ T, /* p */ PropertyKey) => js.PropertyDescriptor): Self = StObject.set(x, "getOwnPropertyDescriptor", js.Any.fromFunction2(value))
