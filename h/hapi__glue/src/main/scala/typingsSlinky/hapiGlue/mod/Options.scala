...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPreConnections(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreRegister(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
