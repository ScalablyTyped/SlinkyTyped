...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreConnections(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ js.Any, Unit]) => Unit): Self = this.set("preConnections", js.Any.fromFunction2(value))
    @scala.inline
    def deletePreConnections: Self = this.set("preConnections", js.undefined)
    @scala.inline
    def setPreRegister(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ js.Any, Unit]) => Unit): Self = this.set("preRegister", js.Any.fromFunction2(value))
    @scala.inline
