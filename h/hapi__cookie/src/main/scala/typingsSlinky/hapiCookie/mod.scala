...
import typingsSlinky.hapiCookie.anon.Clear
...
object mod extends Shortcut {
  ...
  object hapiHapiAugmentingMod {
    ...
    object Request {
      ...
      @scala.inline
      def apply(cookieAuth: Clear): typingsSlinky.hapiCookie.mod.hapiHapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(cookieAuth = cookieAuth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.hapiCookie.mod.hapiHapiAugmentingMod.Request]
      }
      
      @scala.inline
      implicit class RequestMutableBuilder[Self <: typingsSlinky.hapiCookie.mod.hapiHapiAugmentingMod.Request] (val x: Self) extends AnyVal {
