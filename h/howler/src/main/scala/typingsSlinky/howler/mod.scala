...
import typingsSlinky.howler.anon.ConeInnerAngle
import typingsSlinky.howler.anon.Headers
import typingsSlinky.howler.howlerStrings.end
import typingsSlinky.howler.howlerStrings.fade
import typingsSlinky.howler.howlerStrings.load
import typingsSlinky.howler.howlerStrings.loaded
import typingsSlinky.howler.howlerStrings.loaderror
import typingsSlinky.howler.howlerStrings.loading
import typingsSlinky.howler.howlerStrings.metadata
import typingsSlinky.howler.howlerStrings.mute
import typingsSlinky.howler.howlerStrings.pause
import typingsSlinky.howler.howlerStrings.play
import typingsSlinky.howler.howlerStrings.playerror
import typingsSlinky.howler.howlerStrings.rate
import typingsSlinky.howler.howlerStrings.seek
import typingsSlinky.howler.howlerStrings.stop
import typingsSlinky.howler.howlerStrings.unloaded
import typingsSlinky.howler.howlerStrings.unlock
import typingsSlinky.howler.howlerStrings.volume
...
object mod {
  ...
  @js.native
  val Howler: typingsSlinky.howler.mod.Howler = js.native
