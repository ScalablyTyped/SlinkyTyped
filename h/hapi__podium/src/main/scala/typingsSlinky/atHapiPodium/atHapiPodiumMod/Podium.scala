package typingsSlinky.atHapiPodium.atHapiPodiumMod

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.Instantiable1
import typingsSlinky.atHapiPodium.Anon_Channel
...
Instantiable0[Podium]
  ...
  def emit(criteria: Anon_Channel, data: js.Any): Unit = js.native
  def emit(criteria: Anon_Channel, data: js.Any, callback: js.Function0[Unit]): Unit = js.native
  /**
