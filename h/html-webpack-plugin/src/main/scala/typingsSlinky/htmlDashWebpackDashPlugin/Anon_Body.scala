...
import typingsSlinky.htmlDashWebpackDashPlugin.htmlDashWebpackDashPluginMod.HtmlTagObject
import typingsSlinky.htmlDashWebpackDashPlugin.htmlDashWebpackDashPluginMod.HtmlWebpackPlugin
