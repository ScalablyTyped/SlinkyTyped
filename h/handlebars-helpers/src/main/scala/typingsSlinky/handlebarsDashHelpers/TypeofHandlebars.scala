package typingsSlinky.handlebarsDashHelpers
...
trait TypeofHandlebars extends js.Object {
  ...
  var Exception: Instantiable1[/* message */ String, typingsSlinky.handlebars.handlebarsMod.Exception] = js.native
  ...
  var Visitor: Instantiable0[typingsSlinky.handlebars.handlebarsMod.Visitor] = js.native
  ...
  def create(): typingsSlinky.handlebars.TypeofHandlebars = js.native
  ...
  def noConflict(): typingsSlinky.handlebars.TypeofHandlebars = js.native
