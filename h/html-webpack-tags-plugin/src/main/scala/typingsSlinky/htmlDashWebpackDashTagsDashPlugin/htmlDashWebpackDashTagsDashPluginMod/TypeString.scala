...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.htmlDashWebpackDashTagsDashPlugin.htmlDashWebpackDashTagsDashPluginStrings.js_
*/
...
object TypeString {
  ...
  @JSName("js")
  @scala.inline
  def js_ : typingsSlinky.htmlDashWebpackDashTagsDashPlugin.htmlDashWebpackDashTagsDashPluginStrings.js_ = this.cast("js")
}
