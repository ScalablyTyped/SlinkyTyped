  ...
  object autoImport {
    object SlinkyTyped {
      object A {
        ...
        val antd = "org.scalablytyped.slinky" % "antd_sjs0.6_2.12" % "3.25.1-83ad3d"
      ...
      object E {
        ...
        val expo = "org.scalablytyped.slinky" % "expo_sjs0.6_2.12" % "35.0.1-b79f04"
        ...
        val `expo-file-system` = "org.scalablytyped.slinky" % "expo-file-system_sjs0.6_2.12" % "7.0.0-148303"
        ...
        val `expo-linear-gradient` = "org.scalablytyped.slinky" % "expo-linear-gradient_sjs0.6_2.12" % "7.0.1-9de094"
        val `expo-location` = "org.scalablytyped.slinky" % "expo-location_sjs0.6_2.12" % "7.0.0-3aa329"
        ...
        val `expo__vector-icons` = "org.scalablytyped.slinky" % "expo__vector-icons_sjs0.6_2.12" % "9.0-dt-20190213Z-d5e688"
      ...
      object M {
        ...
        val `material-ui__core` = "org.scalablytyped.slinky" % "material-ui__core_sjs0.6_2.12" % "3.9.3-183784"
        val `material-ui__icons` = "org.scalablytyped.slinky" % "material-ui__icons_sjs0.6_2.12" % "4.5.1-4e35c5"
        ...
        val `mobx-react` = "org.scalablytyped.slinky" % "mobx-react_sjs0.6_2.12" % "6.1.4-b4e7c9"
      ...
      object R {
        ...
        val `react-native` = "org.scalablytyped.slinky" % "react-native_sjs0.6_2.12" % "0.60-dt-20191028Z-f78437"
        val `react-native-gesture-handler` = "org.scalablytyped.slinky" % "react-native-gesture-handler_sjs0.6_2.12" % "1.5.0-c79017"
        val `react-native-vector-icons` = "org.scalablytyped.slinky" % "react-native-vector-icons_sjs0.6_2.12" % "6.4-dt-20190930Z-d9d6a1"
        val `react-navigation` = "org.scalablytyped.slinky" % "react-navigation_sjs0.6_2.12" % "4.0.10-8fc572"
        ...
        val `react-transition-group` = "org.scalablytyped.slinky" % "react-transition-group_sjs0.6_2.12" % "4.2-dt-20191002Z-a0db09"
      ...
      object S {
        ...
        val `styled-components` = "org.scalablytyped.slinky" % "styled-components_sjs0.6_2.12" % "4.4-dt-20191109Z-098c73"
      ...
      object U {
        val unimodules__core = "org.scalablytyped.slinky" % "unimodules__core_sjs0.6_2.12" % "4.0.0-5e7f92"
        val `unimodules__react-native-adapter` = "org.scalablytyped.slinky" % "unimodules__react-native-adapter_sjs0.6_2.12" % "4.0.0-92ccc4"
      }
      object V {
