...
object LambdaModel {
  ...
  implicit class LambdaModelOps[Self <: LambdaModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHttpVerbsVarargs(value: typingsSlinky.lambdaPhi.httpVerbModelMod.default*): Self = this.set("httpVerbs", js.Array(value :_*))
    @scala.inline
    def setHttpVerbs(value: js.Array[typingsSlinky.lambdaPhi.httpVerbModelMod.default]): Self = this.set("httpVerbs", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPathParamsVarargs(value: typingsSlinky.lambdaPhi.pathParamModelMod.default*): Self = this.set("pathParams", js.Array(value :_*))
    @scala.inline
    def setPathParams(value: js.Array[typingsSlinky.lambdaPhi.pathParamModelMod.default]): Self = this.set("pathParams", value.asInstanceOf[js.Any])
    @scala.inline
    def setPathParamsProperty(value: js.Any): Self = this.set("pathParamsProperty", value.asInstanceOf[js.Any])
    @scala.inline
    def setPathsVarargs(value: typingsSlinky.lambdaPhi.pathModelMod.default*): Self = this.set("paths", js.Array(value :_*))
    @scala.inline
    def setPaths(value: js.Array[typingsSlinky.lambdaPhi.pathModelMod.default]): Self = this.set("paths", value.asInstanceOf[js.Any])
    @scala.inline
