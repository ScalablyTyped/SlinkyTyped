...
trait LambdaModel extends js.Object {
  ...
  var httpVerbs: js.Array[typingsSlinky.lambdaPhi.httpVerbModelMod.default]
  var instance: js.Any
  var methodProperty: js.Any
  var name: js.Any
  var pathParams: js.Array[typingsSlinky.lambdaPhi.pathParamModelMod.default]
  var pathParamsProperty: js.Any
  var paths: js.Array[typingsSlinky.lambdaPhi.pathModelMod.default]
