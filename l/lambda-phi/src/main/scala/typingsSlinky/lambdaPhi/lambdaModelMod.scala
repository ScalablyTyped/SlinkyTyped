...
object lambdaModelMod {
  ...
  object LambdaModel {
    ...
    implicit class LambdaModelMutableBuilder[Self <: LambdaModel] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHttpVerbs(value: js.Array[typingsSlinky.lambdaPhi.httpVerbModelMod.default]): Self = StObject.set(x, "httpVerbs", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHttpVerbsVarargs(value: typingsSlinky.lambdaPhi.httpVerbModelMod.default*): Self = StObject.set(x, "httpVerbs", js.Array(value :_*))
      ...
      @scala.inline
      def setPathParams(value: js.Array[typingsSlinky.lambdaPhi.pathParamModelMod.default]): Self = StObject.set(x, "pathParams", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPathParamsProperty(value: js.Any): Self = StObject.set(x, "pathParamsProperty", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPathParamsVarargs(value: typingsSlinky.lambdaPhi.pathParamModelMod.default*): Self = StObject.set(x, "pathParams", js.Array(value :_*))
      
      @scala.inline
      def setPaths(value: js.Array[typingsSlinky.lambdaPhi.pathModelMod.default]): Self = StObject.set(x, "paths", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPathsVarargs(value: typingsSlinky.lambdaPhi.pathModelMod.default*): Self = StObject.set(x, "paths", js.Array(value :_*))
