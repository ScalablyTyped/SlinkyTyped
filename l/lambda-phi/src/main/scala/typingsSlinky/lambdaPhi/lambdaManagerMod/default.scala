...
class default () extends LambdaManager {
  ...
  /* CompleteClass */
  override def getLambdaByName(name: String): typingsSlinky.lambdaPhi.lambdaModelMod.default = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def upsertLambdaModel(target: js.Any): typingsSlinky.lambdaPhi.lambdaModelMod.default = js.native
}
