...
trait LambdaManager extends js.Object {
  ...
  def getLambdaByName(name: String): typingsSlinky.lambdaPhi.lambdaModelMod.default
  ...
  def upsertLambdaModel(target: js.Any): typingsSlinky.lambdaPhi.lambdaModelMod.default
}
