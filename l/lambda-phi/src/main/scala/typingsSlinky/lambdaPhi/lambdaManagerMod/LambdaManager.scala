...
object LambdaManager {
  ...
  implicit class LambdaManagerOps[Self <: LambdaManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetLambdaByName(value: String => typingsSlinky.lambdaPhi.lambdaModelMod.default): Self = this.set("getLambdaByName", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUpsertLambdaModel(value: js.Any => typingsSlinky.lambdaPhi.lambdaModelMod.default): Self = this.set("upsertLambdaModel", js.Any.fromFunction1(value))
  }
}
