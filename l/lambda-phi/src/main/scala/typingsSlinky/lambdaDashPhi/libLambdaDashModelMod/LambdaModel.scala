package typingsSlinky.lambdaDashPhi.libLambdaDashModelMod
...
trait LambdaModel extends js.Object {
  ...
  var httpVerbs: js.Array[typingsSlinky.lambdaDashPhi.libHttpDashVerbDashModelMod.default]
  var instance: js.Any
  var methodProperty: js.Any
  var name: js.Any
  var pathParams: js.Array[typingsSlinky.lambdaDashPhi.libPathDashParamDashModelMod.default]
  var pathParamsProperty: js.Any
  var paths: js.Array[typingsSlinky.lambdaDashPhi.libPathDashModelMod.default]
...
object LambdaModel {
  ...
  def apply(
    ...
    httpVerbs: js.Array[typingsSlinky.lambdaDashPhi.libHttpDashVerbDashModelMod.default],
    instance: js.Any,
    methodProperty: js.Any,
    name: js.Any,
    pathParams: js.Array[typingsSlinky.lambdaDashPhi.libPathDashParamDashModelMod.default],
    pathParamsProperty: js.Any,
    paths: js.Array[typingsSlinky.lambdaDashPhi.libPathDashModelMod.default],
