package typingsSlinky.lambdaDashPhi.libLambdaDashManagerMod

import typingsSlinky.lambdaDashPhi.libApiDashGatewayMod.ApiGateway
import typingsSlinky.lambdaDashPhi.libLambdaDashConfigMod.LambdaConfig
...
class default () extends LambdaManager {
  ...
  /* CompleteClass */
  override def getLambdaByName(name: String): typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def upsertLambdaModel(target: js.Any): typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default = js.native
}
