...
trait LambdaManager extends js.Object {
  ...
  def getLambdaByName(name: String): typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default
  ...
  def upsertLambdaModel(target: js.Any): typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default
}
...
object LambdaManager {
  ...
  def apply(
    ...
    getLambdaByName: String => typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default,
    processLambdas: () => Unit,
    rawHandler: js.Any,
    ...
    upsertLambdaModel: js.Any => typingsSlinky.lambdaDashPhi.libLambdaDashModelMod.default
  ): LambdaManager = {
