...
import typingsSlinky.lightpick.lightpickMod.Options.Locale.Buttons
import typingsSlinky.lightpick.lightpickMod.Options.Locale.PluralizeFn
import typingsSlinky.lightpick.lightpickMod.Options.Locale.PluralizeFnLocale
