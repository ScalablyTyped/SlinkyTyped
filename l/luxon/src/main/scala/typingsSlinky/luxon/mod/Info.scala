...
object Info {
  ...
  @JSImport("luxon", "Info.eras")
  @js.native
  def eras(): js.Array[String] = js.native
  @JSImport("luxon", "Info.eras")
  @js.native
  def eras(length: js.UndefOr[scala.Nothing], options: InfoOptions): js.Array[String] = js.native
  @JSImport("luxon", "Info.eras")
  @js.native
  ...
  @JSImport("luxon", "Info.features")
  @js.native
  def features(): Features = js.native
  
  @JSImport("luxon", "Info.hasDST")
  @js.native
  ...
  @JSImport("luxon", "Info.isValidIANAZone")
  @js.native
  def isValidIANAZone(zone: String): Boolean = js.native
  
  @JSImport("luxon", "Info.meridiems")
  @js.native
  ...
  @JSImport("luxon", "Info.months")
  @js.native
  def months(): js.Array[String] = js.native
  @JSImport("luxon", "Info.months")
  @js.native
  def months(length: js.UndefOr[scala.Nothing], options: InfoCalendarOptions): js.Array[String] = js.native
  @JSImport("luxon", "Info.months")
  @js.native
  ...
  @JSImport("luxon", "Info.monthsFormat")
  @js.native
  def monthsFormat(): js.Array[String] = js.native
  @JSImport("luxon", "Info.monthsFormat")
  @js.native
  def monthsFormat(length: js.UndefOr[scala.Nothing], options: InfoCalendarOptions): js.Array[String] = js.native
  @JSImport("luxon", "Info.monthsFormat")
  @js.native
  ...
  @JSImport("luxon", "Info.normalizeZone")
  @js.native
  ...
  @JSImport("luxon", "Info.weekdays")
  @js.native
  def weekdays(): js.Array[String] = js.native
  @JSImport("luxon", "Info.weekdays")
  @js.native
  def weekdays(length: js.UndefOr[scala.Nothing], options: InfoUnitOptions): js.Array[String] = js.native
  @JSImport("luxon", "Info.weekdays")
  @js.native
  ...
  @JSImport("luxon", "Info.weekdaysFormat")
  @js.native
  def weekdaysFormat(): js.Array[String] = js.native
  @JSImport("luxon", "Info.weekdaysFormat")
  @js.native
  def weekdaysFormat(length: js.UndefOr[scala.Nothing], options: InfoUnitOptions): js.Array[String] = js.native
  @JSImport("luxon", "Info.weekdaysFormat")
  @js.native
