package typingsSlinky.libp2pGossipsub.messageMod
...
object ControlIWant {
  ...
  implicit class ControlIWantOps[Self <: ControlIWant] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageIDsVarargs(value: js.typedarray.Uint8Array*): Self = this.set("messageIDs", js.Array(value :_*))
    
    @scala.inline
    def setMessageIDs(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("messageIDs", value.asInstanceOf[js.Any])
  }
}
