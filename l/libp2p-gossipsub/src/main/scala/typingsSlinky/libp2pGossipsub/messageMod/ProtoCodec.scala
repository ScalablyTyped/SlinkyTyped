...
object ProtoCodec {
  ...
  implicit class ProtoCodecOps[Self <: ProtoCodec[_], T] (val x: Self with ProtoCodec[T]) extends AnyVal {
    ...
    @scala.inline
    def setDecode(value: js.typedarray.Uint8Array => T): Self = this.set("decode", js.Any.fromFunction1(value))
    
    @scala.inline
    def setEncode(value: T => js.typedarray.Uint8Array): Self = this.set("encode", js.Any.fromFunction1(value))
  }
}
