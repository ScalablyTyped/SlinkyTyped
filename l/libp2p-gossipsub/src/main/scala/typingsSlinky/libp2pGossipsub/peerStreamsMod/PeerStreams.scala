package typingsSlinky.libp2pGossipsub.peerStreamsMod

import typingsSlinky.itPushable.mod.Pushable
import typingsSlinky.libp2pGossipsub.interfacesMod.DuplexIterableStream
...
object PeerStreams {
  ...
  def apply(
    ...
    isReadable: Boolean,
    isWritable: Boolean,
    outboundStream: Pushable[js.typedarray.Uint8Array],
    protocol: String,
  ...
  implicit class PeerStreamsOps[Self <: PeerStreams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutboundStream(value: Pushable[js.typedarray.Uint8Array]): Self = this.set("outboundStream", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProtocol(value: String): Self = this.set("protocol", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWrite(value: js.typedarray.Uint8Array => Unit): Self = this.set("write", js.Any.fromFunction1(value))
  }
}
