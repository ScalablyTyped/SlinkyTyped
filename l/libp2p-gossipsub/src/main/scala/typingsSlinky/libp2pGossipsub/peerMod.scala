...
import typingsSlinky.libp2pGossipsub.messageMod.SubOpts
...
object peerMod {
  ...
  trait Peer extends StObject {
    ...
    var stream: Pushable[js.typedarray.Uint8Array] = js.native
  ...
  object Peer {
    ...
    def apply(
      ...
      stream: Pushable[js.typedarray.Uint8Array],
      topics: Set[String],
      updateSubscriptions: js.Array[SubOpts] => Unit,
      write: js.typedarray.Uint8Array => Unit
    ): Peer = {
    ...
    implicit class PeerMutableBuilder[Self <: Peer] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStream(value: Pushable[js.typedarray.Uint8Array]): Self = StObject.set(x, "stream", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWrite(value: js.typedarray.Uint8Array => Unit): Self = StObject.set(x, "write", js.Any.fromFunction1(value))
    }
  }
