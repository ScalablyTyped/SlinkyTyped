...
import typingsSlinky.leaflet.leafletMod.LayerOptions
...
trait MarkerClusterGroupOptions extends LayerOptions {
  ...
  /*
    ...
    */
  var iconCreateFunction: js.UndefOr[js.Function1[/* cluster */ MarkerCluster, Icon[IconOptions] | DivIcon]] = js.undefined
  /*
