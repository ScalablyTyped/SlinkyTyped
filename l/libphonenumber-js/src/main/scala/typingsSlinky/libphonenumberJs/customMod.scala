...
object customMod extends js.Object {
  ...
  def parsePhoneNumberFromString(text: String, defaultCountry: AnonDefaultCallingCode, metadata: Metadata): typingsSlinky.libphonenumberJs.typesMod.PhoneNumber = js.native
