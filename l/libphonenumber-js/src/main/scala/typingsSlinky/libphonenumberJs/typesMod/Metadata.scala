...
object Metadata {
  ...
  implicit class MetadataOps[Self <: Metadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCountries(value: Countries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("countries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCountry_calling_codes(value: CountryCallingCodes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("country_calling_codes")(value.asInstanceOf[js.Any])
        ret
    }
  }
