...
object FormatNumberOptions {
  ...
  implicit class FormatNumberOptionsOps[Self <: FormatNumberOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNationalPrefix(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nationalPrefix")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNationalPrefix: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nationalPrefix")(js.undefined)
        ret
    }
    @scala.inline
