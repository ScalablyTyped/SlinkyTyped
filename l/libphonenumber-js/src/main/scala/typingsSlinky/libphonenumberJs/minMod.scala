...
object minMod extends js.Object {
  ...
  def parsePhoneNumberFromString(text: String, defaultCountry: AnonDefaultCallingCode): js.UndefOr[typingsSlinky.libphonenumberJs.typesMod.PhoneNumber] = js.native
