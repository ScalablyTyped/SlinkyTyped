...
import typingsSlinky.libphonenumberDashJs.libphonenumberDashJsMod.FormatNumberOptions
import typingsSlinky.libphonenumberDashJs.libphonenumberDashJsMod.ParseNumberOptions
import typingsSlinky.libphonenumberDashJs.libphonenumberDashJsMod.ParsedNumber
...
object customMod extends js.Object {
  ...
  def parsePhoneNumberFromString(text: String, defaultCountry: CountryCode, metadata: Metadata): typingsSlinky.libphonenumberDashJs.typesMod.PhoneNumber = js.native
  def parsePhoneNumberFromString(text: String, metadata: Metadata): typingsSlinky.libphonenumberDashJs.typesMod.PhoneNumber = js.native
