...
trait AnonExcludedpermissionsInteractions extends js.Object {
  ...
  var interactions: AnonPyong = js.native
...
object AnonExcludedpermissionsInteractions {
  ...
  @scala.inline
  implicit class AnonExcludedpermissionsInteractionsOps[Self <: AnonExcludedpermissionsInteractions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInteractions(value: AnonPyong): Self = {
        val ret = this.duplicate
