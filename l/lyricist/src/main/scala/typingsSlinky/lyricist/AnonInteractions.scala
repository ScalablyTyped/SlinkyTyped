...
trait AnonInteractions extends js.Object {
  ...
  var interactions: AnonCosign = js.native
...
object AnonInteractions {
  ...
  @scala.inline
  implicit class AnonInteractionsOps[Self <: AnonInteractions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInteractions(value: AnonCosign): Self = {
        val ret = this.duplicate
