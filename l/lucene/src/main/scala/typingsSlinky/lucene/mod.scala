...
object mod {
  ...
  */
  ...
  object AST {
    ...
    @scala.inline
    def BinaryAST(left: AST | Node, operator: Operator, right: AST | Node): typingsSlinky.lucene.mod.BinaryAST = {
      val __obj = js.Dynamic.literal(left = left.asInstanceOf[js.Any], operator = operator.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.lucene.mod.BinaryAST]
    }
    
    @scala.inline
    def LeftOnlyAST(left: Node): typingsSlinky.lucene.mod.LeftOnlyAST = {
      val __obj = js.Dynamic.literal(left = left.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.lucene.mod.LeftOnlyAST]
    }
  }
  ...
  */
  ...
  object Node {
    ...
    def NodeRangedTerm(
      ...
      __obj.asInstanceOf[typingsSlinky.lucene.mod.NodeRangedTerm]
    }
    ...
    def NodeTerm(
      ...
      __obj.asInstanceOf[typingsSlinky.lucene.mod.NodeTerm]
    }
  }
