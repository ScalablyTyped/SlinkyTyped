...
import typingsSlinky.loadableServer.anon.Entrypoints
import typingsSlinky.loadableServer.anon.Stats
import typingsSlinky.loadableServer.anon.StatsFile
...
object mod {
  ...
  class ChunkExtractor protected () extends StObject {
    ...
    def collectChunks(/**
      ...
      */
    element: ReactElement): ReactElement = js.native
