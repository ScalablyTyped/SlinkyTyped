...
object ICommandChannel {
  ...
  implicit class ICommandChannelOps[Self <: ICommandChannel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnCommand(value: Command => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onCommand")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSendCommand(value: Command => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sendCommand")(js.Any.fromFunction1(value))
        ret
    }
  }
