...
object Authentication {
  ...
  @scala.inline
  def guest_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("guest")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def plain_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("plain")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def transport_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("transport")(x.asInstanceOf[js.Any])
}
