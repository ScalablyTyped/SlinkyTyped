...
trait AnonConfig extends js.Object {
  var config: js.UndefOr[AnonAdditionalTsTypings] = js.native
...
object AnonConfig {
  @scala.inline
  def apply(name: String, version: String): AnonConfig = {
  ...
  implicit class AnonConfigOps[Self <: AnonConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfig(value: AnonAdditionalTsTypings): Self = {
        val ret = this.duplicate
