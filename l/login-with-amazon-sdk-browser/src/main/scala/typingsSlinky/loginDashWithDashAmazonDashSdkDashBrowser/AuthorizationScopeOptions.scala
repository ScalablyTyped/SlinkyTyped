...
object AuthorizationScopeOptions {
  ...
  @scala.inline
  def `profile:user_id`: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.loginDashWithDashAmazonDashSdkDashBrowserStrings.`profile:user_id` = this.cast("profile:user_id")
}
