...
object AuthorizationScopeOptions {
  ...
  @scala.inline
  def postal_code: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.loginDashWithDashAmazonDashSdkDashBrowserStrings.postal_code = this.cast("postal_code")
  @scala.inline
  def profile: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.loginDashWithDashAmazonDashSdkDashBrowserStrings.profile = this.cast("profile")
  @scala.inline
  def profileColonuser_id: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.loginDashWithDashAmazonDashSdkDashBrowserStrings.profileColonuser_id = this.cast("profile:user_id")
}
