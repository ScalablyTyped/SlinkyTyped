...
import typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.amazon.Login.Region
...
object amazon extends js.Object {
  ...
  object Login extends js.Object {
    ...
    object Region extends js.Object {
      ...
      /* 2 */ val AsiaPacific: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.amazon.Login.Region.AsiaPacific with Double = js.native
      /* 1 */ val Europe: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.amazon.Login.Region.Europe with Double = js.native
      /* 0 */ val NorthAmerica: typingsSlinky.loginDashWithDashAmazonDashSdkDashBrowser.amazon.Login.Region.NorthAmerica with Double = js.native
      @JSBracketAccess
