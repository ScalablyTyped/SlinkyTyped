...
import typingsSlinky.ldapjsDashClient.ldapjsDashClientStrings.add
import typingsSlinky.ldapjsDashClient.ldapjsDashClientStrings.delete
import typingsSlinky.ldapjsDashClient.ldapjsDashClientStrings.replace
