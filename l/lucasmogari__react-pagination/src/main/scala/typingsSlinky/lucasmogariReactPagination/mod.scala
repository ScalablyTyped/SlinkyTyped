package typingsSlinky.lucasmogariReactPagination
...
object mod {
  ...
  object PageVariant extends StObject {
    ...
    /* "before" */ val before: typingsSlinky.lucasmogariReactPagination.mod.PageVariant.before with String = js.native
    
    @js.native
    sealed trait gap extends PageVariant
    /* "gap" */ val gap: typingsSlinky.lucasmogariReactPagination.mod.PageVariant.gap with String = js.native
    
    @js.native
    sealed trait next extends PageVariant
    /* "next" */ val next: typingsSlinky.lucasmogariReactPagination.mod.PageVariant.next with String = js.native
  }
