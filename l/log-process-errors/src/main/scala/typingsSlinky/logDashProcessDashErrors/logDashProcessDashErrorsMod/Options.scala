...
import typingsSlinky.logDashProcessDashErrors.Anon_Default
import typingsSlinky.logDashProcessDashErrors.logDashProcessDashErrorsStrings.`node-tap`
import typingsSlinky.logDashProcessDashErrors.logDashProcessDashErrorsStrings.ava
import typingsSlinky.logDashProcessDashErrors.logDashProcessDashErrorsStrings.jasmine
import typingsSlinky.logDashProcessDashErrors.logDashProcessDashErrorsStrings.mocha
import typingsSlinky.logDashProcessDashErrors.logDashProcessDashErrorsStrings.tape
...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var level: js.UndefOr[(Partial[Record[ExceptionType, LogLevel]]) with Anon_Default] = js.undefined
  /**
    * Override logger
    *
...
object Options {
  ...
  def apply(
    ...
    level: (Partial[Record[ExceptionType, LogLevel]]) with Anon_Default = null,
    log: (/* error */ js.Error, /* level */ LogLevel) => js.Promise[Unit] | Unit = null,
