...
trait Server extends js.Object {
  ...
  var sessionConstructor: Instantiable3[
    ...
    typingsSlinky.leadfoot.sessionMod.^
  ] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  /* protected */ def _fillCapabilities(session: typingsSlinky.leadfoot.sessionMod.^): typingsSlinky.leadfoot.sessionMod.^ = js.native
  /**
  		 * A function that performs an HTTP request to a JsonWireProtocol endpoint and normalises response status and
  		 * data.
  		 *
  ...
  /**
  		 ...
  		 */
  def createSession(desiredCapabilities: Capabilities): Promise[typingsSlinky.leadfoot.sessionMod.^] = js.native
  def createSession(desiredCapabilities: Capabilities, requiredCapabilities: Capabilities): Promise[typingsSlinky.leadfoot.sessionMod.^] = js.native
  /**
