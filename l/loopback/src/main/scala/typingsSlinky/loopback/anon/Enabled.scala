...
object Enabled {
  ...
  implicit class EnabledMutableBuilder[Self <: Enabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaths(value: js.Array[_] | String | js.RegExp): Self = StObject.set(x, "paths", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPathsRegExp(value: js.RegExp): Self = StObject.set(x, "paths", value.asInstanceOf[js.Any])
