...
object Enabled {
  ...
  implicit class EnabledOps[Self <: Enabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathsRegExp(value: js.RegExp): Self = this.set("paths", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaths(value: js.Array[_] | String | js.RegExp): Self = this.set("paths", value.asInstanceOf[js.Any])
