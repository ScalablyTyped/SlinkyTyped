...
trait AnonEnabled extends js.Object {
  ...
  var paths: js.UndefOr[js.Array[_] | String | js.RegExp] = js.native
  var phase: String = js.native
}

object AnonEnabled {
  @scala.inline
  def apply(phase: String): AnonEnabled = {
  ...
  implicit class AnonEnabledOps[Self <: AnonEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withParams(value: js.Array[_] | js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPathsRegExp(value: js.RegExp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paths")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPaths(value: js.Array[_] | String | js.RegExp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paths")(value.asInstanceOf[js.Any])
        ret
    }
