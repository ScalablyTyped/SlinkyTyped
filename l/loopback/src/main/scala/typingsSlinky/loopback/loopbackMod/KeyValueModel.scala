...
import typingsSlinky.loopback.Anon_Match
...
object KeyValueModel extends js.Object {
  ...
  /**
    ...
    */
  def iterateKeys(filter: Anon_Match): js.Any = js.native
  /**
    ...
    */
  def keys(filter: Anon_Match, callback: js.Function0[Unit]): js.Thenable[_] = js.native
  /**
