...
import typingsSlinky.loopback.Anon_AclsCaseSensitiveEmail
import typingsSlinky.loopback.Anon_FromGenerateVerificationToken
...
class User () extends PersistedModel {
  ...
  /**
    ...
    */
  @JSName("settings")
  var settings_User: Anon_AclsCaseSensitiveEmail = js.native
  /** The property is not used by LoopBack, you are free to use it for your own purposes. */
  ...
  /**
    ...
    */
  def verify(options: Anon_FromGenerateVerificationToken): Unit = js.native
}
