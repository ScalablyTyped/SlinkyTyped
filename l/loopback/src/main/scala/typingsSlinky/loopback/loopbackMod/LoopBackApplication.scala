...
import typingsSlinky.loopback.Anon_DataSource
import typingsSlinky.loopback.Anon_Enabled
import typingsSlinky.loopback.TypeofClassModel
...
trait LoopBackApplication
  extends typingsSlinky.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.Application {
  /**
