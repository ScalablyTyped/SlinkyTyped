...
import typingsSlinky.loopback.Anon_Connector
import typingsSlinky.loopback.Anon_DataSourceRelations
...
object loopback extends js.Object {
  /**
    ...
    */
  def configureModel(ModelCtor: Model, config: Anon_DataSourceRelations): Unit = js.native
  /**
    ...
    */
  def createDataSource(name: String, options: Anon_Connector): Unit = js.native
  /**
