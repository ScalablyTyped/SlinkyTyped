package typingsSlinky.lodashDashWebpackDashPlugin.lodashDashWebpackDashPluginMod
...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(chaining)) __obj.updateDynamic("chaining")(chaining.asInstanceOf[js.Any])
    if (!js.isUndefined(cloning)) __obj.updateDynamic("cloning")(cloning.asInstanceOf[js.Any])
    if (!js.isUndefined(coercions)) __obj.updateDynamic("coercions")(coercions.asInstanceOf[js.Any])
    if (!js.isUndefined(collections)) __obj.updateDynamic("collections")(collections.asInstanceOf[js.Any])
    if (!js.isUndefined(currying)) __obj.updateDynamic("currying")(currying.asInstanceOf[js.Any])
    if (!js.isUndefined(deburring)) __obj.updateDynamic("deburring")(deburring.asInstanceOf[js.Any])
    if (!js.isUndefined(exotics)) __obj.updateDynamic("exotics")(exotics.asInstanceOf[js.Any])
    if (!js.isUndefined(flattening)) __obj.updateDynamic("flattening")(flattening.asInstanceOf[js.Any])
    if (!js.isUndefined(guards)) __obj.updateDynamic("guards")(guards.asInstanceOf[js.Any])
    if (!js.isUndefined(memoizing)) __obj.updateDynamic("memoizing")(memoizing.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(placeholders)) __obj.updateDynamic("placeholders")(placeholders.asInstanceOf[js.Any])
    if (!js.isUndefined(shorthands)) __obj.updateDynamic("shorthands")(shorthands.asInstanceOf[js.Any])
