package typingsSlinky.lwip.lwipMod

import typingsSlinky.lwip.Anon_Height
...
object open extends js.Object {
  ...
  def apply(source: Buffer, `type`: Anon_Height, callback: ImageCallback): js.Any = js.native
}
