package typingsSlinky.leafletDotLocatecontrol.leafletMod.Control
...
trait LocateOptions extends js.Object {
  ...
  var locateOptions: js.UndefOr[typingsSlinky.leaflet.leafletMod.LocateOptions] = js.undefined
...
object LocateOptions {
  ...
  def apply(
    ...
    layer: Layer = null,
    locateOptions: typingsSlinky.leaflet.leafletMod.LocateOptions = null,
