...
object mod {
  ...
  @js.native
  def check(path: String, callback: js.Function2[/* err */ js.Error | Null, /* isLocked */ Boolean, Unit]): Unit = js.native
  @JSImport("lockfile", "check")
  @js.native
  def check(
    path: String,
  ...
  @js.native
  def lock(path: String, callback: js.Function1[/* err */ js.Error | Null, Unit]): Unit = js.native
  @JSImport("lockfile", "lock")
  @js.native
  def lock(path: String, opts: Options, callback: js.Function1[/* err */ js.Error | Null, Unit]): Unit = js.native
  ...
  @js.native
  def unlock(path: String, callback: js.Function1[/* err */ js.Error | Null, Unit]): Unit = js.native
