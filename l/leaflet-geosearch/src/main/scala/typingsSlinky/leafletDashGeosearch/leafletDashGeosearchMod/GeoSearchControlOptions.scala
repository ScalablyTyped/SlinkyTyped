...
import typingsSlinky.leafletDashGeosearch.Anon_Button
import typingsSlinky.leafletDashGeosearch.Anon_Query
import typingsSlinky.leafletDashGeosearch.leafletDashGeosearchStrings.bar
import typingsSlinky.leafletDashGeosearch.leafletDashGeosearchStrings.button
...
trait GeoSearchControlOptions extends js.Object {
  ...
  /**
    ...
    * }
    */
  var classNames: js.UndefOr[Anon_Button] = js.undefined
  /** @default false */
  ...
  var popupFormat: js.UndefOr[js.Function1[/* hasQueryResult */ Anon_Query, String]] = js.undefined
  /** @default 'topleft' */
...
object GeoSearchControlOptions {
  ...
  def apply(
    ...
    popupFormat: /* hasQueryResult */ Anon_Query => String = null,
