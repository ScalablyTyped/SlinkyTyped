...
object OpenStreetMapProviderOptionsOutputFormat {
  ...
  implicit class OpenStreetMapProviderOptionsOutputFormatOps[Self <: OpenStreetMapProviderOptionsOutputFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withJson_callback(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("json_callback")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutJson_callback: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("json_callback")(js.undefined)
        ret
    }
  }
