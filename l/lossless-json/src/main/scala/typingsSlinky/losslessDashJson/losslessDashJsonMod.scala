...
import typingsSlinky.losslessDashJson.losslessDashJsonBooleans.`true`
...
object losslessDashJsonMod extends js.Object {
  ...
  class LosslessNumber protected () extends js.Object {
    ...
    var `type`: typingsSlinky.losslessDashJson.losslessDashJsonStrings.LosslessNumber = js.native
    // value as string
