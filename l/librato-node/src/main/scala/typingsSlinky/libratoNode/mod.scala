...
import typingsSlinky.libratoNode.anon.RequestCountKey
import typingsSlinky.libratoNode.libratoNodeBooleans.`false`
import typingsSlinky.libratoNode.libratoNodeBooleans.`true`
import typingsSlinky.libratoNode.libratoNodeStrings.SIGINT
import typingsSlinky.libratoNode.libratoNodeStrings.error
...
object mod {
  ...
  @JSImport("librato-node", "flush")
  @js.native
  def flush(cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
  ...
  @JSImport("librato-node", "on")
  @js.native
  def on_error(event: error, handler: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  @JSImport("librato-node", "stop")
  @js.native
  def stop(cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
