package typingsSlinky.ltx.libParserMod
...
trait ParserOptions extends js.Object {
  var Element: js.UndefOr[
    Instantiable2[
      ...
      typingsSlinky.ltx.libElementMod.Element
    ]
  ] = js.undefined
  var Parser: js.UndefOr[
    Instantiable1[js.UndefOr[/* options */ ParserOptions], typingsSlinky.ltx.libParserMod.Parser]
  ] = js.undefined
}
