package typingsSlinky.luminoApplication.mod.Application
...
object IOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoWidgets.mod.Widget */ T](shell: T): IOptions[T] = {
    val __obj = js.Dynamic.literal(shell = shell.asInstanceOf[js.Any])
    __obj.asInstanceOf[IOptions[T]]
  }
  @scala.inline
  implicit class IOptionsOps[Self <: IOptions[_], /* <: typingsSlinky.luminoWidgets.mod.Widget */ T] (val x: Self with IOptions[T]) extends AnyVal {
    @scala.inline
