...
object GPXOptions {
  ...
  def apply(
    ...
    gpx_options: ParseElements = null,
    marker_options: MarkerOptions = null,
    max_point_interval: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(max_point_interval)) __obj.updateDynamic("max_point_interval")(max_point_interval.get.asInstanceOf[js.Any])
