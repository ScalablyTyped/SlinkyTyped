package typingsSlinky.leafletDashGpx.leafletMod

import typingsSlinky.leaflet.leafletMod.MarkerOptions
import typingsSlinky.leaflet.leafletMod.PolylineOptions
import typingsSlinky.leafletDashGpx.Anon_ParseElements
...
trait GPXOptions extends js.Object {
  ...
  var gpx_options: js.UndefOr[Anon_ParseElements] = js.undefined
...
object GPXOptions {
  ...
  def apply(
    ...
    gpx_options: Anon_ParseElements = null,
