package typingsSlinky.lzDashString.lzDashStringMod
...
object LZStringStatic {
  ...
  def apply(
    ...
    compressToUint8Array: String => scala.scalajs.js.typedarray.Uint8Array,
    decompress: String => String,
    decompressFromBase64: String => String,
    decompressFromEncodedURIComponent: String => String,
    decompressFromUTF16: String => String,
    decompressFromUint8Array: scala.scalajs.js.typedarray.Uint8Array => String
  ): LZStringStatic = {
