...
import typingsSlinky.lasso.libDependenciesMod.DependencyConfig
...
trait PageConfig extends js.Object {
  ...
  var lassoContext: js.UndefOr[typingsSlinky.lasso.libLassoContextMod.default] = js.undefined
...
object PageConfig {
  ...
  def apply(
    ...
    from: String = null,
    lassoContext: typingsSlinky.lasso.libLassoContextMod.default = null,
    name: String = null,
