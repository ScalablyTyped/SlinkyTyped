...
import typingsSlinky.luminoAlgorithm.arrayMod.ArrayExt.MutableArrayLike
import typingsSlinky.luminoAlgorithm.arrayMod.ArrayExt.slice.IOptions
import typingsSlinky.luminoAlgorithm.iterMod.IIterator
import typingsSlinky.luminoAlgorithm.iterMod.IterableOrArrayLike
import typingsSlinky.luminoAlgorithm.retroMod.RetroableOrArrayLike
import typingsSlinky.luminoAlgorithm.stringMod.StringExt.IMatchResult
...
object mod {
  ...
  class ArrayIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.iterMod.ArrayIterator[T] {
    /**
  ...
  class ChainIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.chainMod.ChainIterator[T] {
    /**
  ...
  class EmptyIterator[T] ()
    extends typingsSlinky.luminoAlgorithm.emptyMod.EmptyIterator[T]
  
  @JSImport("@lumino/algorithm", "EnumerateIterator")
  @js.native
  class EnumerateIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.enumerateMod.EnumerateIterator[T] {
    /**
  ...
  class FilterIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.filterMod.FilterIterator[T] {
    /**
  ...
  class FnIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.iterMod.FnIterator[T] {
    /**
  ...
  class ItemIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.iterMod.ItemIterator[T] {
    /**
  ...
  class KeyIterator protected ()
    extends typingsSlinky.luminoAlgorithm.iterMod.KeyIterator {
    /**
  ...
  class MapIterator[T, U] protected ()
    extends typingsSlinky.luminoAlgorithm.mapMod.MapIterator[T, U] {
    /**
  ...
  class RangeIterator protected ()
    extends typingsSlinky.luminoAlgorithm.rangeMod.RangeIterator {
    /**
  ...
  class RepeatIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.repeatMod.RepeatIterator[T] {
    /**
  ...
  class RetroArrayIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.retroMod.RetroArrayIterator[T] {
    /**
  ...
  class StrideIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.strideMod.StrideIterator[T] {
    /**
  ...
  class TakeIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.takeMod.TakeIterator[T] {
    /**
  ...
  class ValueIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.iterMod.ValueIterator[T] {
    /**
  ...
  class ZipIterator[T] protected ()
    extends typingsSlinky.luminoAlgorithm.zipMod.ZipIterator[T] {
    /**
