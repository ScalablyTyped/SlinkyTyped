package typingsSlinky.leafletMarkerclusterLayersupport.mod
...
object MarkerClusterGroupLayerSupportOptions {
  ...
  implicit class MarkerClusterGroupLayerSupportOptionsOps[Self <: MarkerClusterGroupLayerSupportOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSingleAddRemoveBufferDuration(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("singleAddRemoveBufferDuration")(value.asInstanceOf[js.Any])
        ret
    }
  }
