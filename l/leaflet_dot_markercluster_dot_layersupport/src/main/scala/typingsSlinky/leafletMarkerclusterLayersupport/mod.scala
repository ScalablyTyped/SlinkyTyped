package typingsSlinky.leafletMarkerclusterLayersupport

import typingsSlinky.leaflet.mod.Layer
import typingsSlinky.leafletMarkercluster.mod.MarkerClusterGroupOptions
import typingsSlinky.leafletMarkerclusterLayersupport.mod.MarkerClusterGroup_.LayerSupport
...
object mod {
  ...
  object MarkerClusterGroup_ {
    ...
    @js.native
    trait LayerSupport
      extends typingsSlinky.leafletMarkercluster.mod.MarkerClusterGroup_ {
