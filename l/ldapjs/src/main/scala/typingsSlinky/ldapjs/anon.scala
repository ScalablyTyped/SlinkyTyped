...
object anon {
  ...
  object Filter {
    ...
    implicit class FilterMutableBuilder[Self <: Filter] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilter(value: typingsSlinky.ldapjs.mod.Filter): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Filters extends StObject {
    ...
    var filters: js.Array[typingsSlinky.ldapjs.mod.Filter] = js.native
  }
  object Filters {
    
    @scala.inline
    def apply(filters: js.Array[typingsSlinky.ldapjs.mod.Filter]): Filters = {
    ...
    implicit class FiltersMutableBuilder[Self <: Filters] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilters(value: js.Array[typingsSlinky.ldapjs.mod.Filter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFiltersVarargs(value: typingsSlinky.ldapjs.mod.Filter*): Self = StObject.set(x, "filters", js.Array(value :_*))
    }
  }
