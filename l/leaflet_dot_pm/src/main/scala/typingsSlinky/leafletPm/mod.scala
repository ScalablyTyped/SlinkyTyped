...
object mod {
  ...
  object LayerGroup {
    ...
    implicit class LayerGroupMutableBuilder[Self <: LayerGroup] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPm(value: typingsSlinky.leafletPm.mod.PM.Edit.LayerGroup): Self = StObject.set(x, "pm", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Map {
    ...
    implicit class MapMutableBuilder[Self <: Map] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPm(value: typingsSlinky.leafletPm.mod.PM.Map): Self = StObject.set(x, "pm", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Marker {
    ...
    @scala.inline
    def apply(pm: typingsSlinky.leafletPm.mod.PM.Edit.Marker): Marker = {
      val __obj = js.Dynamic.literal(pm = pm.asInstanceOf[js.Any])
    ...
    implicit class MarkerMutableBuilder[Self <: Marker] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPm(value: typingsSlinky.leafletPm.mod.PM.Edit.Marker): Self = StObject.set(x, "pm", value.asInstanceOf[js.Any])
    }
  }
