...
object Control_ {
  ...
  class Zoom () extends Control_ {
    def this(options: typingsSlinky.leaflet.mod.Control_.ZoomOptions) = this()
    
    @JSName("options")
    var options_Zoom: typingsSlinky.leaflet.mod.Control_.ZoomOptions = js.native
  }
  ...
  object ZoomOptions {
    ...
    @scala.inline
    def apply(): typingsSlinky.leaflet.mod.Control_.ZoomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.leaflet.mod.Control_.ZoomOptions]
    }
    
    @scala.inline
    implicit class ZoomOptionsMutableBuilder[Self <: typingsSlinky.leaflet.mod.Control_.ZoomOptions] (val x: Self) extends AnyVal {
