...
@js.native
class Bounds_ protected () extends BoundsExpression {
  ...
  def contains(pointOrBounds: BoundsExpression): Boolean = js.native
  def contains(pointOrBounds: PointExpression): Boolean = js.native
