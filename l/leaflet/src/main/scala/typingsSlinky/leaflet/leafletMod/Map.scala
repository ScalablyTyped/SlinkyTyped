...
class Map protected () extends Evented {
  ...
  var zoomControl: typingsSlinky.leaflet.leafletMod.Control.Zoom = js.native
...
object map extends js.Object {
  ...
  def apply(element: typingsSlinky.std.HTMLElement): Map = js.native
  def apply(element: typingsSlinky.std.HTMLElement, options: MapOptions): Map = js.native
}
