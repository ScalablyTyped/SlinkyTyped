...
trait GeoJSONOptions[P] extends LayerOptions {
  ...
  var pointToLayer: js.UndefOr[
    js.Function2[
      /* geoJsonPoint */ Feature[typingsSlinky.geojson.geojsonMod.Point, P], 
      /* latlng */ LatLng, 
      Layer
    ]
  ] = js.undefined
...
object GeoJSONOptions {
  ...
  def apply[P](
    ...
    pane: String = null,
    pointToLayer: (/* geoJsonPoint */ Feature[typingsSlinky.geojson.geojsonMod.Point, P], /* latlng */ LatLng) => Layer = null,
