...
trait AnonAttribution
  ...
  var Scale: Instantiable1[js.UndefOr[/* options */ ScaleOptions], typingsSlinky.leaflet.mod.Control_.Scale] = js.native
  var Zoom: Instantiable1[js.UndefOr[/* options */ ZoomOptions], typingsSlinky.leaflet.mod.Control_.Zoom] = js.native
