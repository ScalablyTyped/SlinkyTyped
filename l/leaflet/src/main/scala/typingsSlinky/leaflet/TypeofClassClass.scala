...
@js.native
trait TypeofClassClass extends Instantiable0[Class] {
  ...
  def extend(props: js.Any): Anon_Args with (/* import warning: importer.ImportType#apply Failed type conversion: typeof Class */ js.Any) = js.native
