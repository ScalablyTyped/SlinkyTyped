...
import typingsSlinky.lestate.anon.Force
import typingsSlinky.lestate.anon.Id
...
object LeState {
  ...
  implicit class LeStateOps[Self <: LeState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateListener(value: Force => Unit): Self = {
    ...
    @scala.inline
    def withSet(value: js.Object => js.Array[Id]): Self = {
        val ret = this.duplicate
