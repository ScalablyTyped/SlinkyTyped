...
object utilsMod {
  ...
  class CompositeKeyWeakMap[T] ()
    extends typingsSlinky.lodashDecorators.compositeKeyWeakMapMod.CompositeKeyWeakMap[T]
  
  @JSImport("lodash-decorators/utils", "assignAll")
  @js.native
  ...
  @JSImport("lodash-decorators/utils", "resolveFunction")
  @js.native
  ...
  @JSImport("lodash-decorators/utils", "returnAtIndex")
  @js.native
  def returnAtIndex(fn: js.Function, index: Double): js.Function = js.native
  
  @JSImport("lodash-decorators/utils", "wrapConstructor")
  @js.native
