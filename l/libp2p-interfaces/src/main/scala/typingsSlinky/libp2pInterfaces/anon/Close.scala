...
object Close {
  ...
  def apply(
    ...
    localPeer: typingsSlinky.peerId.mod.^,
  ...
  implicit class CloseOps[Self <: Close] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalPeer(value: typingsSlinky.peerId.mod.^): Self = this.set("localPeer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNewStream(value: js.Function): Self = this.set("newStream", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRemotePeer(value: typingsSlinky.peerId.mod.^): Self = this.set("remotePeer", value.asInstanceOf[js.Any])
