package typingsSlinky.libp2pInterfaces.recordMod
...
object Record {
  ...
  @scala.inline
  def apply(codec: js.typedarray.Uint8Array, domain: String, equals: Record => Unit, marshal: () => Unit): Record = {
  ...
  implicit class RecordOps[Self <: Record] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCodec(value: js.typedarray.Uint8Array): Self = this.set("codec", value.asInstanceOf[js.Any])
