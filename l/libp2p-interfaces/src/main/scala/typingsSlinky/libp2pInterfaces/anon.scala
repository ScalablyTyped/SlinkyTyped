...
object anon {
  ...
  object Close {
    ...
    implicit class CloseMutableBuilder[Self <: Close] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLocalPeer(value: typingsSlinky.peerId.mod.^): Self = StObject.set(x, "localPeer", value.asInstanceOf[js.Any])
  ...
  object Id {
    ...
    @scala.inline
    def apply(id: typingsSlinky.peerId.mod.^, protocol: String): Id = {
