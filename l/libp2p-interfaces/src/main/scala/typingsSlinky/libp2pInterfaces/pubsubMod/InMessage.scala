...
object InMessage {
  ...
  implicit class InMessageOps[Self <: InMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKey(value: js.typedarray.Uint8Array): Self = this.set("key", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteKey: Self = this.set("key", js.undefined)
    
    @scala.inline
    def setSeqno(value: js.typedarray.Uint8Array): Self = this.set("seqno", value.asInstanceOf[js.Any])
