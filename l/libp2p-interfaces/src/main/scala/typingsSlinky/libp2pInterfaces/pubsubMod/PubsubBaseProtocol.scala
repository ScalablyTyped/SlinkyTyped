package typingsSlinky.libp2pInterfaces.pubsubMod
...
object PubsubBaseProtocol {
  ...
  implicit class PubsubBaseProtocolOps[Self <: PubsubBaseProtocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_addPeer(value: (typingsSlinky.peerId.mod.^, String) => typingsSlinky.libp2pInterfaces.peerStreamsMod.^): Self = this.set("_addPeer", js.Any.fromFunction2(value))
    
    @scala.inline
    def set_buildMessage(value: js.Any => js.Promise[_]): Self = this.set("_buildMessage", js.Any.fromFunction1(value))
    
    @scala.inline
    def set_decodeRpc(value: js.typedarray.Uint8Array => js.Any): Self = this.set("_decodeRpc", js.Any.fromFunction1(value))
    
    @scala.inline
    def set_emitMessage(value: InMessage => Unit): Self = this.set("_emitMessage", js.Any.fromFunction1(value))
    
    @scala.inline
    def set_encodeRpc(value: js.Any => js.typedarray.Uint8Array): Self = this.set("_encodeRpc", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def set_onPeerConnected(value: (typingsSlinky.peerId.mod.^, js.Any) => js.Promise[Unit]): Self = this.set("_onPeerConnected", js.Any.fromFunction2(value))
    
    @scala.inline
    def set_onPeerDisconnected(value: (typingsSlinky.peerId.mod.^, js.Error) => Unit): Self = this.set("_onPeerDisconnected", js.Any.fromFunction2(value))
    
    @scala.inline
    def set_processMessages(value: (String, js.Any, typingsSlinky.libp2pInterfaces.peerStreamsMod.^) => js.Promise[Unit]): Self = this.set("_processMessages", js.Any.fromFunction3(value))
    
    @scala.inline
    def set_processRpc(value: (String, typingsSlinky.libp2pInterfaces.peerStreamsMod.^, js.Any) => Boolean): Self = this.set("_processRpc", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def set_removePeer(value: typingsSlinky.peerId.mod.^ => typingsSlinky.libp2pInterfaces.peerStreamsMod.^): Self = this.set("_removePeer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetMsgId(value: js.Any => js.typedarray.Uint8Array): Self = this.set("getMsgId", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPeers(value: Map[String, typingsSlinky.libp2pInterfaces.peerStreamsMod.^]): Self = this.set("peers", value.asInstanceOf[js.Any])
