...
object recordMod {
  ...
  object Record {
    ...
    @scala.inline
    def apply(codec: js.typedarray.Uint8Array, domain: String, equals_ : Record => Unit, marshal: () => Unit): Record = {
    ...
    implicit class RecordMutableBuilder[Self <: Record] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCodec(value: js.typedarray.Uint8Array): Self = StObject.set(x, "codec", value.asInstanceOf[js.Any])
