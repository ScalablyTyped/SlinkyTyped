...
object TabOptions {
  ...
  def apply(
    ...
    change: js.ThisFunction1[TabOptions, /* tabIndex */ Double, Unit] = null,
    closeBtn: `0` | `1` | `2` = null,
    ...
    moveEnd: js.ThisFunction1[TabOptions, /* layero */ JQuery[HTMLElement], Unit] = null,
