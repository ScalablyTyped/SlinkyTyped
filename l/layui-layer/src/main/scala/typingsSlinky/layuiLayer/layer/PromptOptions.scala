...
object PromptOptions {
  ...
  implicit class PromptOptionsOps[Self <: PromptOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFormType(value: `0` | `1` | `2`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("formType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFormType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("formType")(js.undefined)
        ret
    }
    @scala.inline
