...
object ParserOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(basefix)) __obj.updateDynamic("basefix")(basefix.get.asInstanceOf[js.Any])
    if (!js.isUndefined(big_lines)) __obj.updateDynamic("big_lines")(big_lines.get.asInstanceOf[js.Any])
    if (!js.isUndefined(blanks)) __obj.updateDynamic("blanks")(blanks.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(dict)) __obj.updateDynamic("dict")(dict.get.asInstanceOf[js.Any])
    if (!js.isUndefined(doctype)) __obj.updateDynamic("doctype")(doctype.get.asInstanceOf[js.Any])
    if (dtdattr != null) __obj.updateDynamic("dtdattr")(dtdattr.asInstanceOf[js.Any])
    if (!js.isUndefined(dtdload)) __obj.updateDynamic("dtdload")(dtdload.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dtdvalid)) __obj.updateDynamic("dtdvalid")(dtdvalid.get.asInstanceOf[js.Any])
    if (!js.isUndefined(errors)) __obj.updateDynamic("errors")(errors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(huge)) __obj.updateDynamic("huge")(huge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignore_enc)) __obj.updateDynamic("ignore_enc")(ignore_enc.get.asInstanceOf[js.Any])
    if (!js.isUndefined(implied)) __obj.updateDynamic("implied")(implied.get.asInstanceOf[js.Any])
    if (!js.isUndefined(net)) __obj.updateDynamic("net")(net.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nobasefix)) __obj.updateDynamic("nobasefix")(nobasefix.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noblanks)) __obj.updateDynamic("noblanks")(noblanks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nocdata)) __obj.updateDynamic("nocdata")(nocdata.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nodict)) __obj.updateDynamic("nodict")(nodict.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noent)) __obj.updateDynamic("noent")(noent.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noerror)) __obj.updateDynamic("noerror")(noerror.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nonet)) __obj.updateDynamic("nonet")(nonet.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nowarning)) __obj.updateDynamic("nowarning")(nowarning.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noxincnode)) __obj.updateDynamic("noxincnode")(noxincnode.get.asInstanceOf[js.Any])
    if (!js.isUndefined(nsclean)) __obj.updateDynamic("nsclean")(nsclean.get.asInstanceOf[js.Any])
    if (!js.isUndefined(old)) __obj.updateDynamic("old")(old.get.asInstanceOf[js.Any])
    if (!js.isUndefined(oldsax)) __obj.updateDynamic("oldsax")(oldsax.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pedantic)) __obj.updateDynamic("pedantic")(pedantic.get.asInstanceOf[js.Any])
    if (!js.isUndefined(recover)) __obj.updateDynamic("recover")(recover.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sax1)) __obj.updateDynamic("sax1")(sax1.get.asInstanceOf[js.Any])
    if (!js.isUndefined(warnings)) __obj.updateDynamic("warnings")(warnings.get.asInstanceOf[js.Any])
    if (!js.isUndefined(xinclude)) __obj.updateDynamic("xinclude")(xinclude.get.asInstanceOf[js.Any])
