...
import typingsSlinky.layuiSrc.layuiSrcStrings.always
import typingsSlinky.layuiSrc.layuiSrcStrings.default
import typingsSlinky.layuiSrc.layuiSrcStrings.fade
import typingsSlinky.layuiSrc.layuiSrcStrings.hover
import typingsSlinky.layuiSrc.layuiSrcStrings.insider
import typingsSlinky.layuiSrc.layuiSrcStrings.none
import typingsSlinky.layuiSrc.layuiSrcStrings.outsider
import typingsSlinky.layuiSrc.layuiSrcStrings.updown
...
object CarouselOption {
  ...
  implicit class CarouselOptionOps[Self <: CarouselOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElemHTMLElement(value: HTMLElement): Self = this.set("elem", value.asInstanceOf[js.Any])
    @scala.inline
