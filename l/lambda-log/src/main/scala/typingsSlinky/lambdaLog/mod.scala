...
import typingsSlinky.lambdaLog.lambdaLogStrings.error
import typingsSlinky.lambdaLog.lambdaLogStrings.info
import typingsSlinky.lambdaLog.lambdaLogStrings.log
import typingsSlinky.lambdaLog.lambdaLogStrings.warn
