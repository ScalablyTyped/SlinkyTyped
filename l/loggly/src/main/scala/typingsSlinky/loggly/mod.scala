...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.loggly.mod.SearchOptionsWithQ
    - typingsSlinky.loggly.mod.SearchOptionsWithQuery
  */
  trait SearchOptions extends StObject
  object SearchOptions {
    
    @scala.inline
    def SearchOptionsWithQ(q: String): typingsSlinky.loggly.mod.SearchOptionsWithQ = {
      val __obj = js.Dynamic.literal(q = q.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.loggly.mod.SearchOptionsWithQ]
    }
    
    @scala.inline
    def SearchOptionsWithQuery(query: String): typingsSlinky.loggly.mod.SearchOptionsWithQuery = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.loggly.mod.SearchOptionsWithQuery]
    }
  }
