...
abstract class SharedApply_PluralPropsWithoutI18n1337670846[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: className, id, value */
  def apply(
    other: TagMod[Any],
