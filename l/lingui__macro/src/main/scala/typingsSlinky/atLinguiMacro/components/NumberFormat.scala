...
object NumberFormat
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atLinguiMacro.atLinguiMacroMod.NumberFormat] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atLinguiMacro.atLinguiMacroMod.NumberFormat] = {
