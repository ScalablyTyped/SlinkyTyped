...
object DateFormat
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atLinguiMacro.atLinguiMacroMod.DateFormat] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atLinguiMacro.atLinguiMacroMod.DateFormat] = {
