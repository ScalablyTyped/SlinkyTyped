...
trait INode[T] extends js.Object {
  /**
    ...
    */
  val list: typingsSlinky.luminoCollections.linkedlistMod.LinkedList[T] | Null = js.native
  /**
...
object INode {
  ...
  implicit class INodeOps[Self <: INode[_], T] (val x: Self with INode[T]) extends AnyVal {
    ...
    @scala.inline
    def setList(value: typingsSlinky.luminoCollections.linkedlistMod.LinkedList[T]): Self = this.set("list", value.asInstanceOf[js.Any])
    @scala.inline
