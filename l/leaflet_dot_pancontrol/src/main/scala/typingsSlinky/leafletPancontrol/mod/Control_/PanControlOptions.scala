package typingsSlinky.leafletPancontrol.mod.Control_
...
object PanControlOptions {
  ...
  implicit class PanControlOptionsOps[Self <: PanControlOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPanOffset(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("panOffset")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPanOffset: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("panOffset")(js.undefined)
        ret
    }
  }
