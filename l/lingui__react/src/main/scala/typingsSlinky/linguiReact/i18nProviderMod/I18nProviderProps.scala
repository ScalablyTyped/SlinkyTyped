...
object I18nProviderProps {
  ...
  implicit class I18nProviderPropsOps[Self <: I18nProviderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultRenderReactElement(value: ReactElement): Self = this.set("defaultRender", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultRender(value: ReactElement): Self = this.set("defaultRender", value.asInstanceOf[js.Any])
