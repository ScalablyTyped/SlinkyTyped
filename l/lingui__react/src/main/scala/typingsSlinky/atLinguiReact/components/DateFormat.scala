...
object DateFormat
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atLinguiReact.atLinguiReactMod.DateFormat] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atLinguiReact.atLinguiReactMod.DateFormat] = {
