...
object Select
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atLinguiReact.selectMod.Select] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atLinguiReact.selectMod.Select] = {
