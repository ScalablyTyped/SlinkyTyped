package typingsSlinky.atLinguiReact.i18nMod

import slinky.core.TagMod
import typingsSlinky.atLinguiReact.Anon_I18n
...
trait I18nComponentProps extends js.Object {
  ...
  def children(hasI18nI18nHash: Anon_I18n): TagMod[Any]
}

object I18nComponentProps {
  @scala.inline
  def apply(
    children: Anon_I18n => TagMod[Any],
