...
import typingsSlinky.loadableComponent.anon.Children
import typingsSlinky.loadableComponent.anon.Fallback
...
object mod {
  ...
  type ComponentResolver[Props, Module] = js.Function2[/* module */ Module, /* props */ Props, ReactComponentClass[Props]]
  
  type DefaultComponent[Props] = ReactComponentClass[Props] | DefaultImportedComponent[Props]
  ...
  type LoadableComponent[Props] = (ReactComponentClass[Props with Fallback]) with LoadableComponentMethods[Props]
  ...
  type LoadableLibrary[Module] = ReactComponentClass[Children[Module]] with Module with LoadableComponentMethods[js.Object]
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options[_, _], Props, Module] (val x: Self with (Options[Props, Module])) extends AnyVal {
      ...
      @scala.inline
      def setResolveComponent(value: (Module, Props) => ReactComponentClass[Props]): Self = StObject.set(x, "resolveComponent", js.Any.fromFunction2(value))
