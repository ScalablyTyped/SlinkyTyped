...
object Children {
  ...
  implicit class ChildrenOps[Self <: Children[_], Module] (val x: Self with Children[Module]) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* module */ Module => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[Module]): Self = this.set("ref", value.asInstanceOf[js.Any])
