...
object mod {
  ...
  */
  ...
  object csrfOptionsAngularOrNonAngular {
    ...
    @scala.inline
    def csrfOptionsAngular(angular: `true`): typingsSlinky.lusca.mod.csrfOptionsAngular = {
      val __obj = js.Dynamic.literal(angular = angular.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.lusca.mod.csrfOptionsAngular]
    }
    
    @scala.inline
    def csrfOptionsNonAngular(): typingsSlinky.lusca.mod.csrfOptionsNonAngular = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.lusca.mod.csrfOptionsNonAngular]
    }
  }
  ...
  */
  ...
  object csrfOptionsBlacklistOrWhitelist {
    ...
    @scala.inline
    def csrfOptionsBlacklist(): typingsSlinky.lusca.mod.csrfOptionsBlacklist = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.lusca.mod.csrfOptionsBlacklist]
    }
    
    @scala.inline
    def csrfOptionsWhitelist(): typingsSlinky.lusca.mod.csrfOptionsWhitelist = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.lusca.mod.csrfOptionsWhitelist]
    }
  }
