...
object DateProvider {
  ...
  implicit class DateProviderOps[Self <: DateProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextRollover(value: (js.Date, Double, Modifier, TimePeriod) => js.Date): Self = this.set("nextRollover", js.Any.fromFunction4(value))
    @scala.inline
    def setPrev(
      value: (js.UndefOr[Double], js.UndefOr[Double], js.UndefOr[Double], js.UndefOr[Double], js.UndefOr[Double], js.UndefOr[Double]) => js.Date
    ): Self = this.set("prev", js.Any.fromFunction6(value))
    @scala.inline
    def setPrevRollover(value: (js.Date, Double, Modifier, TimePeriod) => js.Date): Self = this.set("prevRollover", js.Any.fromFunction4(value))
  }
