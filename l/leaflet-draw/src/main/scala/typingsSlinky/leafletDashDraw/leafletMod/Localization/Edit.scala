...
trait Edit extends js.Object {
  ...
  var toolbar: typingsSlinky.leafletDashDraw.leafletMod.Localization.EditToolbar
}

object Edit {
  @scala.inline
  def apply(handlers: EditHandlers, toolbar: typingsSlinky.leafletDashDraw.leafletMod.Localization.EditToolbar): Edit = {
