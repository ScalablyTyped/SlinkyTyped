package typingsSlinky.leafletDashDraw.leafletMod.DrawOptions

import typingsSlinky.leaflet.leafletMod.DivIcon
import typingsSlinky.leaflet.leafletMod.Icon
import typingsSlinky.leaflet.leafletMod.IconOptions
import typingsSlinky.leafletDashDraw.Anon_Clickable
...
trait PolylineOptions extends SimpleShapeOptions {
  ...
  /**
    ...
    */
  var shapeOptions: js.UndefOr[typingsSlinky.leaflet.leafletMod.PolylineOptions with Anon_Clickable] = js.undefined
  /**
...
object PolylineOptions {
  ...
  def apply(
    ...
    shapeOptions: typingsSlinky.leaflet.leafletMod.PolylineOptions with Anon_Clickable = null,
