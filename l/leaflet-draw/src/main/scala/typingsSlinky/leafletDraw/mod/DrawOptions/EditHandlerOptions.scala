...
object EditHandlerOptions {
  ...
  implicit class EditHandlerOptionsOps[Self <: EditHandlerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSelectedPathOptions(value: PathOptions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedPathOptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSelectedPathOptions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedPathOptions")(js.undefined)
        ret
    }
  }
