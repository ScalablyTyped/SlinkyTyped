...
import typingsSlinky.ledgerhqHwAppBtc.anon.Index
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.legacy
    - typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.p2sh
    - typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.bech32
  */
  trait AddressFormat extends StObject
  object AddressFormat {
    
    @scala.inline
    def bech32: typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.bech32 = "bech32".asInstanceOf[typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.bech32]
    
    @scala.inline
    def legacy: typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.legacy = "legacy".asInstanceOf[typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.legacy]
    
    @scala.inline
    def p2sh: typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.p2sh = "p2sh".asInstanceOf[typingsSlinky.ledgerhqHwAppBtc.ledgerhqHwAppBtcStrings.p2sh]
  }
