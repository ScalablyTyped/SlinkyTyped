...
object global {
  ...
  class DynamicView[E /* <: js.Object */] protected ()
    extends typingsSlinky.lokijs.DynamicView[E] {
    /**
      ...
      */
    def this(collection: typingsSlinky.lokijs.Collection[E], name: String) = this()
    def this(collection: typingsSlinky.lokijs.Collection[E], name: String, options: PartialDynamicViewOptions) = this()
  }
  
  @JSGlobal("ExactIndex")
  @js.native
  class ExactIndex[E /* <: js.Object */] protected ()
    extends typingsSlinky.lokijs.ExactIndex[E] {
  ...
  object LokiConstructor {
    ...
    @js.native
    def LokiOps: typingsSlinky.lokijs.LokiOps = js.native
    @scala.inline
    ...
    object persistenceAdapters {
      ...
      @js.native
      def fs: typingsSlinky.lokijs._LokiFsAdapter = js.native
      @scala.inline
      def fs_=(x: typingsSlinky.lokijs._LokiFsAdapter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fs")(x.asInstanceOf[js.Any])
      
      @JSGlobal("LokiConstructor.persistenceAdapters.localStorage")
      @js.native
      def localStorage: typingsSlinky.lokijs._LokiLocalStorageAdapter = js.native
      @scala.inline
      def localStorage_=(x: typingsSlinky.lokijs._LokiLocalStorageAdapter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("localStorage")(x.asInstanceOf[js.Any])
    }
  }
  ...
  class LokiEventEmitter ()
    extends typingsSlinky.lokijs.LokiEventEmitter
  ...
  class Resultset[E /* <: js.Object */] protected ()
    extends typingsSlinky.lokijs.Resultset[E] {
    /**
      * @param collection - The collection which this Resultset will query against.
      * @param options
      */
    def this(collection: typingsSlinky.lokijs.Collection[E]) = this()
    def this(collection: typingsSlinky.lokijs.Collection[E], options: js.Any) = this()
  }
  
  @JSGlobal("SortedIndex")
  @js.native
  class SortedIndex protected ()
    extends typingsSlinky.lokijs.SortedIndex {
  ...
  class UniqueIndex[E /* <: js.Object */] protected ()
    extends typingsSlinky.lokijs.UniqueIndex[E] {
