...
trait AnonExact[E /* <: js.Object */] extends js.Object {
  ...
  {[ P in keyof E ]: lokijs.ExactIndex<E>}
    */ typingsSlinky.lokijs.lokijsStrings.AnonExact with TopLevel[js.Any] = js.native
...
object AnonExact {
  ...
  {[ P in keyof E ]: lokijs.ExactIndex<E>}
    */ typingsSlinky.lokijs.lokijsStrings.AnonExact with TopLevel[js.Any],
  ...
  @scala.inline
  implicit class AnonExactOps[Self[e] <: AnonExact[e], E] (val x: Self[E]) extends AnyVal {
    @scala.inline
