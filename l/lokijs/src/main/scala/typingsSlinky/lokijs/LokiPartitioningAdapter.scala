...
object LokiPartitioningAdapter {
  ...
  implicit class LokiPartitioningAdapterMutableBuilder[Self <: LokiPartitioningAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExportDatabase(value: (String, Loki, js.Function1[/* err */ js.Error | Null, Unit]) => Unit): Self = StObject.set(x, "exportDatabase", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setSaveNextPage(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = StObject.set(x, "saveNextPage", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSaveNextPartition(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = StObject.set(x, "saveNextPartition", js.Any.fromFunction1(value))
  }
}
