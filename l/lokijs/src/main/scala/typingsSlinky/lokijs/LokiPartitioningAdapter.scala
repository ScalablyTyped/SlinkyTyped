...
object LokiPartitioningAdapter {
  ...
  implicit class LokiPartitioningAdapterOps[Self <: LokiPartitioningAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExportDatabase(value: (String, Loki, js.Function1[/* err */ js.Error | Null, Unit]) => Unit): Self = this.set("exportDatabase", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setSaveNextPage(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = this.set("saveNextPage", js.Any.fromFunction1(value))
    @scala.inline
    def setSaveNextPartition(value: js.Function1[/* err */ js.Error | Null, Unit] => Unit): Self = this.set("saveNextPartition", js.Any.fromFunction1(value))
    @scala.inline
