...
object Tag {
  ...
  implicit class TagOps[Self <: Tag] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFind(value: String => typingsSlinky.languageTags.subtagMod.^): Self = this.set("find", js.Any.fromFunction1(value))
    @scala.inline
    def setFormat(value: () => String): Self = this.set("format", js.Any.fromFunction0(value))
    @scala.inline
    def setLanguage(value: () => typingsSlinky.languageTags.subtagMod.^): Self = this.set("language", js.Any.fromFunction0(value))
    @scala.inline
    def setPreferred(value: () => Tag): Self = this.set("preferred", js.Any.fromFunction0(value))
    @scala.inline
    def setRegion(value: () => typingsSlinky.languageTags.subtagMod.^): Self = this.set("region", js.Any.fromFunction0(value))
    @scala.inline
    def setScript(value: () => typingsSlinky.languageTags.subtagMod.^): Self = this.set("script", js.Any.fromFunction0(value))
    @scala.inline
    def setSubtags(value: () => js.Array[typingsSlinky.languageTags.subtagMod.^]): Self = this.set("subtags", js.Any.fromFunction0(value))
    @scala.inline
