package typingsSlinky.loremDashIpsum.loremDashIpsumMod

import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.html
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.paragraph
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.paragraphs
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.plain
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.sentence
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.sentences
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.word
import typingsSlinky.loremDashIpsum.loremDashIpsumStrings.words
import typingsSlinky.loremDashIpsum.typesSrcLibGeneratorMod.IPrng
