...
object SourceMapOption {
  ...
  def apply(
    ...
    if (!js.isUndefined(outputSourceFiles)) __obj.updateDynamic("outputSourceFiles")(outputSourceFiles.get.asInstanceOf[js.Any])
    if (sourceMapBasepath != null) __obj.updateDynamic("sourceMapBasepath")(sourceMapBasepath.asInstanceOf[js.Any])
    if (!js.isUndefined(sourceMapFileInline)) __obj.updateDynamic("sourceMapFileInline")(sourceMapFileInline.get.asInstanceOf[js.Any])
