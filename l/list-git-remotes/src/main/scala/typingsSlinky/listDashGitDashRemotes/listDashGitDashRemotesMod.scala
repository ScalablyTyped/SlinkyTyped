...
import typingsSlinky.listDashGitDashRemotes.listDashGitDashRemotesMod.Callback
import typingsSlinky.listDashGitDashRemotes.listDashGitDashRemotesMod.Remotes
