...
object global {
  ...
  object Linq4JS {
    ...
    object Helper {
      ...
      @js.native
      def Commands: Array[typingsSlinky.linq4js.Linq4JS.EvaluateCommand] = js.native
      @scala.inline
      def Commands_=(x: Array[typingsSlinky.linq4js.Linq4JS.EvaluateCommand]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Commands")(x.asInstanceOf[js.Any])
