...
object Linq4JS {
  ...
  object EvaluateCommand {
    ...
    implicit class EvaluateCommandMutableBuilder[Self <: EvaluateCommand] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFinder(value: Array[js.RegExp]): Self = StObject.set(x, "Finder", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSplitRegex(value: Array[js.RegExp]): Self = StObject.set(x, "SplitRegex", value.asInstanceOf[js.Any])
    }
  }
