...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommittedTransaction = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommittedTransaction,
    reader: BinaryReader
  ): typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommittedTransaction = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommittedTransaction
  ): AsObject = js.native
}
