package typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommitTransactionsRequest
...
trait AsObject extends js.Object {
  ...
  var transactionsList: js.Array[
    typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.CommittedTransaction.AsObject
  ]
}
