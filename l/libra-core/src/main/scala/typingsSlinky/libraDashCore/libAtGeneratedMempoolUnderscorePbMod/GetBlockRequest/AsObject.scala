package typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.GetBlockRequest
...
trait AsObject extends js.Object {
  ...
  var transactionsList: js.Array[
    typingsSlinky.libraDashCore.libAtGeneratedMempoolUnderscorePbMod.TransactionExclusion.AsObject
  ]
}
