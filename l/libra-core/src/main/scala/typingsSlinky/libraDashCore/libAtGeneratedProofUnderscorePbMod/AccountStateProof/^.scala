...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.libraDashCore.libAtGeneratedProofUnderscorePbMod.AccountStateProof = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.libraDashCore.libAtGeneratedProofUnderscorePbMod.AccountStateProof,
    reader: BinaryReader
  ): typingsSlinky.libraDashCore.libAtGeneratedProofUnderscorePbMod.AccountStateProof = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.libraDashCore.libAtGeneratedProofUnderscorePbMod.AccountStateProof
  ): AsObject = js.native
}
