...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.SignedTransaction = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.SignedTransaction,
    reader: BinaryReader
  ): typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.SignedTransaction = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.SignedTransaction
  ): AsObject = js.native
}
