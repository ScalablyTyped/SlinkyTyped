...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction = js.native
  def deserializeBinaryFromReader(
    message: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction,
    reader: BinaryReader
  ): typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction = js.native
  ...
  def toObject(
    ...
    msg: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction
  ): AsObject = js.native
}
