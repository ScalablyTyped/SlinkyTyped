...
object PayloadCase extends js.Object {
  ...
  /* 0 */ val PAYLOAD_NOT_SET: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction.PayloadCase.PAYLOAD_NOT_SET with Double = js.native
  /* 3 */ val PROGRAM: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction.PayloadCase.PROGRAM with Double = js.native
  /* 4 */ val WRITE_SET: typingsSlinky.libraDashCore.libAtGeneratedTransactionUnderscorePbMod.RawTransaction.PayloadCase.WRITE_SET with Double = js.native
  @JSBracketAccess
