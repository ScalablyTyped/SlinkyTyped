...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransactionInfoToEventProof(value: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject): Self = this.set("transactionInfoToEventProof", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTransactionInfoToEventProof: Self = this.set("transactionInfoToEventProof", js.undefined)
  }
