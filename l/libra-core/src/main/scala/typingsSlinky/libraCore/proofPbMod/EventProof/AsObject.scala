...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransactionInfoToEventProof(value: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transactionInfoToEventProof")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTransactionInfoToEventProof: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transactionInfoToEventProof")(js.undefined)
        ret
    }
  }
