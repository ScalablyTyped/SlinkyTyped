...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBlockTimestampUsecs(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("blockTimestampUsecs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTransactionsList(value: js.Array[typingsSlinky.libraCore.mempoolPbMod.CommittedTransaction.AsObject]): Self = {
        val ret = this.duplicate
