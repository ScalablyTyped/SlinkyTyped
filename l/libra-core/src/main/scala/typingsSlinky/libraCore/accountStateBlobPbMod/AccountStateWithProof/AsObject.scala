...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlob(value: typingsSlinky.libraCore.accountStateBlobPbMod.AccountStateBlob.AsObject): Self = this.set("blob", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBlob: Self = this.set("blob", js.undefined)
    
    @scala.inline
    def setProof(value: typingsSlinky.libraCore.proofPbMod.AccountStateProof.AsObject): Self = this.set("proof", value.asInstanceOf[js.Any])
