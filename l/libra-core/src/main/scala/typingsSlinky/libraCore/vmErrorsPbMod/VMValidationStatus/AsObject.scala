...
import typingsSlinky.libraCore.vmErrorsPbMod.VMValidationStatusCode
...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCode(value: VMValidationStatusCode): Self = this.set("code", value.asInstanceOf[js.Any])
