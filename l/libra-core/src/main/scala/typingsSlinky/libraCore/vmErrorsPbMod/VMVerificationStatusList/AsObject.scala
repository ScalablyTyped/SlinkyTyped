...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatusListListVarargs(value: typingsSlinky.libraCore.vmErrorsPbMod.VMVerificationStatus.AsObject*): Self = this.set("statusListList", js.Array(value :_*))
    @scala.inline
    def setStatusListList(value: js.Array[typingsSlinky.libraCore.vmErrorsPbMod.VMVerificationStatus.AsObject]): Self = this.set("statusListList", value.asInstanceOf[js.Any])
  }
