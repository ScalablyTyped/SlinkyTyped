...
import typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase
...
object ExecutionStatus {
  ...
  object ExecutionStatusCase extends StObject {
    ...
    /* 3 */ val ARITHMETIC_ERROR: typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase.ARITHMETIC_ERROR with Double = js.native
    
    @js.native
    sealed trait ASSERTION_FAILURE extends ExecutionStatusCase
    /* 2 */ val ASSERTION_FAILURE: typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase.ASSERTION_FAILURE with Double = js.native
    
    @js.native
    sealed trait EXECUTIONSTATUS_NOT_SET extends ExecutionStatusCase
    /* 0 */ val EXECUTIONSTATUS_NOT_SET: typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase.EXECUTIONSTATUS_NOT_SET with Double = js.native
    
    @js.native
    sealed trait REFERENCE_ERROR extends ExecutionStatusCase
    /* 4 */ val REFERENCE_ERROR: typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase.REFERENCE_ERROR with Double = js.native
    
    @js.native
    sealed trait RUNTIME_STATUS extends ExecutionStatusCase
    /* 1 */ val RUNTIME_STATUS: typingsSlinky.libraCore.vmErrorsPbMod.ExecutionStatus.ExecutionStatusCase.RUNTIME_STATUS with Double = js.native
  }
  
  @JSImport("libra-core/lib/@/generated/vm_errors_pb", "ExecutionStatus.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): ExecutionStatus = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArithmeticError(value: typingsSlinky.libraCore.vmErrorsPbMod.ArithmeticError.AsObject): Self = StObject.set(x, "arithmeticError", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setArithmeticErrorUndefined: Self = StObject.set(x, "arithmeticError", js.undefined)
      
      @scala.inline
      def setAssertionFailure(value: typingsSlinky.libraCore.vmErrorsPbMod.AssertionFailure.AsObject): Self = StObject.set(x, "assertionFailure", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAssertionFailureUndefined: Self = StObject.set(x, "assertionFailure", js.undefined)
      
      @scala.inline
      def setReferenceError(value: typingsSlinky.libraCore.vmErrorsPbMod.DynamicReferenceError.AsObject): Self = StObject.set(x, "referenceError", value.asInstanceOf[js.Any])
