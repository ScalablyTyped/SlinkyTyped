...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArithmeticError(value: typingsSlinky.libraCore.vmErrorsPbMod.ArithmeticError.AsObject): Self = this.set("arithmeticError", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteArithmeticError: Self = this.set("arithmeticError", js.undefined)
    
    @scala.inline
    def setAssertionFailure(value: typingsSlinky.libraCore.vmErrorsPbMod.AssertionFailure.AsObject): Self = this.set("assertionFailure", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAssertionFailure: Self = this.set("assertionFailure", js.undefined)
    
    @scala.inline
    def setReferenceError(value: typingsSlinky.libraCore.vmErrorsPbMod.DynamicReferenceError.AsObject): Self = this.set("referenceError", value.asInstanceOf[js.Any])
