...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidatorPublicKeysListVarargs(value: typingsSlinky.libraCore.validatorPublicKeysPbMod.ValidatorPublicKeys.AsObject*): Self = this.set("validatorPublicKeysList", js.Array(value :_*))
    
    @scala.inline
    def setValidatorPublicKeysList(value: js.Array[typingsSlinky.libraCore.validatorPublicKeysPbMod.ValidatorPublicKeys.AsObject]): Self = this.set("validatorPublicKeysList", value.asInstanceOf[js.Any])
  }
}
