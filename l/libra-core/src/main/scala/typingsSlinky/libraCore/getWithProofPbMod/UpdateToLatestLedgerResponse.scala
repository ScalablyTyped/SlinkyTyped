...
object UpdateToLatestLedgerResponse {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): UpdateToLatestLedgerResponse = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResponseItemsList(value: js.Array[typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.AsObject]): Self = StObject.set(x, "responseItemsList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResponseItemsListVarargs(value: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.AsObject*): Self = StObject.set(x, "responseItemsList", js.Array(value :_*))
      
      @scala.inline
      def setValidatorChangeEventsList(
        value: js.Array[
              typingsSlinky.libraCore.validatorChangePbMod.ValidatorChangeEventWithProof.AsObject
            ]
      ...
      @scala.inline
      def setValidatorChangeEventsListVarargs(value: typingsSlinky.libraCore.validatorChangePbMod.ValidatorChangeEventWithProof.AsObject*): Self = StObject.set(x, "validatorChangeEventsList", js.Array(value :_*))
    }
  }
}
