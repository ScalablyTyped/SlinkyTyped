...
object UpdateToLatestLedgerRequest {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): UpdateToLatestLedgerRequest = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRequestedItemsList(value: js.Array[typingsSlinky.libraCore.getWithProofPbMod.RequestItem.AsObject]): Self = StObject.set(x, "requestedItemsList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRequestedItemsListVarargs(value: typingsSlinky.libraCore.getWithProofPbMod.RequestItem.AsObject*): Self = StObject.set(x, "requestedItemsList", js.Array(value :_*))
    }
  }
}
