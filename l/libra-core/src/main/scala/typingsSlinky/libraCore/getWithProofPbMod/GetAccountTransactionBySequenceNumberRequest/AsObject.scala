...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccountUint8Array(value: js.typedarray.Uint8Array): Self = this.set("account", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAccount(value: js.typedarray.Uint8Array | String): Self = this.set("account", value.asInstanceOf[js.Any])
