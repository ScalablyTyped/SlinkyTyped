...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetAccountStateResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetAccountStateResponse.AsObject): Self = this.set("getAccountStateResponse", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("getAccountTransactionBySequenceNumberResponse", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGetEventsByEventAccessPathResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetEventsByEventAccessPathResponse.AsObject): Self = this.set("getEventsByEventAccessPathResponse", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteGetEventsByEventAccessPathResponse: Self = this.set("getEventsByEventAccessPathResponse", js.undefined)
    @scala.inline
    def setGetTransactionsResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetTransactionsResponse.AsObject): Self = this.set("getTransactionsResponse", value.asInstanceOf[js.Any])
    @scala.inline
