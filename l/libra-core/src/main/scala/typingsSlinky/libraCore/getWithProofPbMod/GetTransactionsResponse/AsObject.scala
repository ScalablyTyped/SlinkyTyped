...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTxnListWithProof(value: typingsSlinky.libraCore.transactionPbMod.TransactionListWithProof.AsObject): Self = this.set("txnListWithProof", value.asInstanceOf[js.Any])
    @scala.inline
