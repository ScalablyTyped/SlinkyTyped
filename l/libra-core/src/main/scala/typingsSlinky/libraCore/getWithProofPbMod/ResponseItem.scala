...
import typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase
...
object ResponseItem {
  ...
  object ResponseItemsCase extends StObject {
    ...
    /* 3 */ val GET_ACCOUNT_STATE_RESPONSE: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase.GET_ACCOUNT_STATE_RESPONSE with Double = js.native
    
    @js.native
    sealed trait GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE extends ResponseItemsCase
    /* 4 */ val GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase.GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE with Double = js.native
    
    @js.native
    sealed trait GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE extends ResponseItemsCase
    /* 5 */ val GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase.GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE with Double = js.native
    
    @js.native
    sealed trait GET_TRANSACTIONS_RESPONSE extends ResponseItemsCase
    /* 6 */ val GET_TRANSACTIONS_RESPONSE: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase.GET_TRANSACTIONS_RESPONSE with Double = js.native
    
    @js.native
    sealed trait RESPONSEITEMS_NOT_SET extends ResponseItemsCase
    /* 0 */ val RESPONSEITEMS_NOT_SET: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.ResponseItemsCase.RESPONSEITEMS_NOT_SET with Double = js.native
  }
  
  @JSImport("libra-core/lib/@/generated/get_with_proof_pb", "ResponseItem.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): ResponseItem = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetAccountStateResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetAccountStateResponse.AsObject): Self = StObject.set(x, "getAccountStateResponse", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGetAccountStateResponseUndefined: Self = StObject.set(x, "getAccountStateResponse", js.undefined)
      
      @scala.inline
      def setGetAccountTransactionBySequenceNumberResponse(
      ...
      @scala.inline
      def setGetEventsByEventAccessPathResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetEventsByEventAccessPathResponse.AsObject): Self = StObject.set(x, "getEventsByEventAccessPathResponse", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGetEventsByEventAccessPathResponseUndefined: Self = StObject.set(x, "getEventsByEventAccessPathResponse", js.undefined)
      
      @scala.inline
      def setGetTransactionsResponse(value: typingsSlinky.libraCore.getWithProofPbMod.GetTransactionsResponse.AsObject): Self = StObject.set(x, "getTransactionsResponse", value.asInstanceOf[js.Any])
