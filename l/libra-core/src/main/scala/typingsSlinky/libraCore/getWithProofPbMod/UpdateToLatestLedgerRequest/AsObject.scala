...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestedItemsListVarargs(value: typingsSlinky.libraCore.getWithProofPbMod.RequestItem.AsObject*): Self = this.set("requestedItemsList", js.Array(value :_*))
    
    @scala.inline
    def setRequestedItemsList(value: js.Array[typingsSlinky.libraCore.getWithProofPbMod.RequestItem.AsObject]): Self = this.set("requestedItemsList", value.asInstanceOf[js.Any])
  }
}
