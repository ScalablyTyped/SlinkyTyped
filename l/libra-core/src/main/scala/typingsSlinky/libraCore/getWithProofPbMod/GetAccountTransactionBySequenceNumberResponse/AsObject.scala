...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProofOfCurrentSequenceNumber(value: typingsSlinky.libraCore.accountStateBlobPbMod.AccountStateWithProof.AsObject): Self = this.set("proofOfCurrentSequenceNumber", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteProofOfCurrentSequenceNumber: Self = this.set("proofOfCurrentSequenceNumber", js.undefined)
    
    @scala.inline
    def setSignedTransactionWithProof(value: typingsSlinky.libraCore.transactionPbMod.SignedTransactionWithProof.AsObject): Self = this.set("signedTransactionWithProof", value.asInstanceOf[js.Any])
