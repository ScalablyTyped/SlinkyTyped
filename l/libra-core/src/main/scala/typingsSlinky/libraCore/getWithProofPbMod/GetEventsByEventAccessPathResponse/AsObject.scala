...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventsWithProofListVarargs(value: typingsSlinky.libraCore.eventsPbMod.EventWithProof.AsObject*): Self = this.set("eventsWithProofList", js.Array(value :_*))
    
    @scala.inline
    def setEventsWithProofList(value: js.Array[typingsSlinky.libraCore.eventsPbMod.EventWithProof.AsObject]): Self = this.set("eventsWithProofList", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProofOfLatestEvent(value: typingsSlinky.libraCore.accountStateBlobPbMod.AccountStateWithProof.AsObject): Self = this.set("proofOfLatestEvent", value.asInstanceOf[js.Any])
