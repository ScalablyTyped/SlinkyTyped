...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponseItemsListVarargs(value: typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.AsObject*): Self = this.set("responseItemsList", js.Array(value :_*))
    @scala.inline
    def setResponseItemsList(value: js.Array[typingsSlinky.libraCore.getWithProofPbMod.ResponseItem.AsObject]): Self = this.set("responseItemsList", value.asInstanceOf[js.Any])
    @scala.inline
    def setValidatorChangeEventsListVarargs(value: typingsSlinky.libraCore.validatorChangePbMod.ValidatorChangeEventWithProof.AsObject*): Self = this.set("validatorChangeEventsList", js.Array(value :_*))
    @scala.inline
    def setValidatorChangeEventsList(
      value: js.Array[
          typingsSlinky.libraCore.validatorChangePbMod.ValidatorChangeEventWithProof.AsObject
        ]
    ): Self = this.set("validatorChangeEventsList", value.asInstanceOf[js.Any])
    @scala.inline
    def setLedgerInfoWithSigs(value: typingsSlinky.libraCore.ledgerInfoPbMod.LedgerInfoWithSignatures.AsObject): Self = this.set("ledgerInfoWithSigs", value.asInstanceOf[js.Any])
    @scala.inline
