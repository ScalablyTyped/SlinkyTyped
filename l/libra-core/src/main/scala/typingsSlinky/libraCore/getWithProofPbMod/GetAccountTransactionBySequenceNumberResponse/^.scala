...
object ^ extends js.Object {
  ...
  def deserializeBinary(bytes: js.typedarray.Uint8Array): typingsSlinky.libraCore.getWithProofPbMod.GetAccountTransactionBySequenceNumberResponse = js.native
