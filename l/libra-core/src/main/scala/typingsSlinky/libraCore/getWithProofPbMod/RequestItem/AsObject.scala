...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetAccountStateRequest(value: typingsSlinky.libraCore.getWithProofPbMod.GetAccountStateRequest.AsObject): Self = this.set("getAccountStateRequest", value.asInstanceOf[js.Any])
    ...
    ): Self = this.set("getAccountTransactionBySequenceNumberRequest", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetEventsByEventAccessPathRequest(value: typingsSlinky.libraCore.getWithProofPbMod.GetEventsByEventAccessPathRequest.AsObject): Self = this.set("getEventsByEventAccessPathRequest", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGetEventsByEventAccessPathRequest: Self = this.set("getEventsByEventAccessPathRequest", js.undefined)
    
    @scala.inline
    def setGetTransactionsRequest(value: typingsSlinky.libraCore.getWithProofPbMod.GetTransactionsRequest.AsObject): Self = this.set("getTransactionsRequest", value.asInstanceOf[js.Any])
