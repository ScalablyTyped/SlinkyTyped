...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSignaturesListVarargs(value: typingsSlinky.libraCore.ledgerInfoPbMod.ValidatorSignature.AsObject*): Self = this.set("signaturesList", js.Array(value :_*))
    
    @scala.inline
    def setSignaturesList(value: js.Array[typingsSlinky.libraCore.ledgerInfoPbMod.ValidatorSignature.AsObject]): Self = this.set("signaturesList", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLedgerInfo(value: typingsSlinky.libraCore.ledgerInfoPbMod.LedgerInfo.AsObject): Self = this.set("ledgerInfo", value.asInstanceOf[js.Any])
