...
object TransactionListWithProof {
  ...
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): TransactionListWithProof = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEventsForVersions(value: typingsSlinky.libraCore.eventsPbMod.EventsForVersions.AsObject): Self = StObject.set(x, "eventsForVersions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEventsForVersionsUndefined: Self = StObject.set(x, "eventsForVersions", js.undefined)
      
      @scala.inline
      def setFirstTransactionVersion(value: typingsSlinky.googleProtobuf.wrappersPbMod.UInt64Value.AsObject): Self = StObject.set(x, "firstTransactionVersion", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFirstTransactionVersionUndefined: Self = StObject.set(x, "firstTransactionVersion", js.undefined)
      
      @scala.inline
      def setInfosList(value: js.Array[typingsSlinky.libraCore.transactionInfoPbMod.TransactionInfo.AsObject]): Self = StObject.set(x, "infosList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInfosListVarargs(value: typingsSlinky.libraCore.transactionInfoPbMod.TransactionInfo.AsObject*): Self = StObject.set(x, "infosList", js.Array(value :_*))
      
      @scala.inline
      def setProofOfFirstTransaction(value: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject): Self = StObject.set(x, "proofOfFirstTransaction", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProofOfFirstTransactionUndefined: Self = StObject.set(x, "proofOfFirstTransaction", js.undefined)
      
      @scala.inline
      def setProofOfLastTransaction(value: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject): Self = StObject.set(x, "proofOfLastTransaction", value.asInstanceOf[js.Any])
