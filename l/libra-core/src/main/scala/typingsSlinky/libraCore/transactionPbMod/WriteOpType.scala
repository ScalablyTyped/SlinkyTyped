...
object WriteOpType extends StObject {
  ...
  /* 1 */ val DELETE: typingsSlinky.libraCore.transactionPbMod.WriteOpType.DELETE with Double = js.native
  
  @js.native
  sealed trait WRITE extends WriteOpType
  /* 0 */ val WRITE: typingsSlinky.libraCore.transactionPbMod.WriteOpType.WRITE with Double = js.native
}
