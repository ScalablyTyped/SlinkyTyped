...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccountStatesListVarargs(value: typingsSlinky.libraCore.transactionPbMod.AccountState.AsObject*): Self = this.set("accountStatesList", js.Array(value :_*))
    
    @scala.inline
    def setAccountStatesList(value: js.Array[typingsSlinky.libraCore.transactionPbMod.AccountState.AsObject]): Self = this.set("accountStatesList", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEventsListVarargs(value: typingsSlinky.libraCore.eventsPbMod.Event.AsObject*): Self = this.set("eventsList", js.Array(value :_*))
    
    @scala.inline
    def setEventsList(value: js.Array[typingsSlinky.libraCore.eventsPbMod.Event.AsObject]): Self = this.set("eventsList", value.asInstanceOf[js.Any])
