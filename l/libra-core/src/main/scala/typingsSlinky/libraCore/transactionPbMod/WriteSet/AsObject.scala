...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWriteSetList(value: js.Array[typingsSlinky.libraCore.transactionPbMod.WriteOp.AsObject]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("writeSetList")(value.asInstanceOf[js.Any])
        ret
    }
  }
