...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWriteSetListVarargs(value: typingsSlinky.libraCore.transactionPbMod.WriteOp.AsObject*): Self = this.set("writeSetList", js.Array(value :_*))
    
    @scala.inline
    def setWriteSetList(value: js.Array[typingsSlinky.libraCore.transactionPbMod.WriteOp.AsObject]): Self = this.set("writeSetList", value.asInstanceOf[js.Any])
  }
}
