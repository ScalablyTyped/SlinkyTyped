...
object RawTransaction {
  ...
  object PayloadCase extends StObject {
    ...
    /* 0 */ val PAYLOAD_NOT_SET: typingsSlinky.libraCore.transactionPbMod.RawTransaction.PayloadCase.PAYLOAD_NOT_SET with Double = js.native
    
    @js.native
    sealed trait PROGRAM extends PayloadCase
    /* 3 */ val PROGRAM: typingsSlinky.libraCore.transactionPbMod.RawTransaction.PayloadCase.PROGRAM with Double = js.native
    
    @js.native
    sealed trait WRITE_SET extends PayloadCase
    /* 4 */ val WRITE_SET: typingsSlinky.libraCore.transactionPbMod.RawTransaction.PayloadCase.WRITE_SET with Double = js.native
  }
  
  @JSImport("libra-core/lib/@/generated/transaction_pb", "RawTransaction.deserializeBinary")
  @js.native
  def deserializeBinary(bytes: js.typedarray.Uint8Array): RawTransaction = js.native
  ...
  object AsObject {
    ...
    implicit class AsObjectMutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setProgram(value: typingsSlinky.libraCore.transactionPbMod.Program.AsObject): Self = StObject.set(x, "program", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setProgramUndefined: Self = StObject.set(x, "program", js.undefined)
      
      @scala.inline
      def setSenderAccount(value: js.typedarray.Uint8Array | String): Self = StObject.set(x, "senderAccount", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSenderAccountUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "senderAccount", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSequenceNumber(value: String): Self = StObject.set(x, "sequenceNumber", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWriteSet(value: typingsSlinky.libraCore.transactionPbMod.WriteSet.AsObject): Self = StObject.set(x, "writeSet", value.asInstanceOf[js.Any])
