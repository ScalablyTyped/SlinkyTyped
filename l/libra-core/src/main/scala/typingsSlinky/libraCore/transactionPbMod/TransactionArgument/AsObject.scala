...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.typedarray.Uint8Array | String): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
    def setType(value: ArgType): Self = this.set("type", value.asInstanceOf[js.Any])
  }
