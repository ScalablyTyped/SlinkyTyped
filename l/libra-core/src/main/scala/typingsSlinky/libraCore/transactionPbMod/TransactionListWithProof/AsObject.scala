...
trait AsObject extends js.Object {
  var eventsForVersions: js.UndefOr[typingsSlinky.libraCore.eventsPbMod.EventsForVersions.AsObject] = js.undefined
  var firstTransactionVersion: js.UndefOr[typingsSlinky.googleProtobuf.wrappersPbMod.UInt64Value.AsObject] = js.undefined
  var infosList: js.Array[typingsSlinky.libraCore.transactionInfoPbMod.TransactionInfo.AsObject]
  var proofOfFirstTransaction: js.UndefOr[typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject] = js.undefined
  var proofOfLastTransaction: js.UndefOr[typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    eventsForVersions: typingsSlinky.libraCore.eventsPbMod.EventsForVersions.AsObject = null,
    firstTransactionVersion: typingsSlinky.googleProtobuf.wrappersPbMod.UInt64Value.AsObject = null,
    proofOfFirstTransaction: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject = null,
    proofOfLastTransaction: typingsSlinky.libraCore.proofPbMod.AccumulatorProof.AsObject = null
  ): AsObject = {
