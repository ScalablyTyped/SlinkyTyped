...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvent(value: typingsSlinky.libraCore.eventsPbMod.Event.AsObject): Self = this.set("event", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEvent: Self = this.set("event", js.undefined)
    @scala.inline
    def setProof(value: typingsSlinky.libraCore.proofPbMod.EventProof.AsObject): Self = this.set("proof", value.asInstanceOf[js.Any])
    @scala.inline
