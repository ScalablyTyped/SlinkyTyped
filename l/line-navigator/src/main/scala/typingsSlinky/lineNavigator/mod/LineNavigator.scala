package typingsSlinky.lineNavigator.mod
...
object LineNavigator {
  ...
  implicit class LineNavigatorOps[Self <: LineNavigator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFind(value: (js.RegExp, Double, FindCallback) => Unit): Self = this.set("find", js.Any.fromFunction3(value))
    
    @scala.inline
    def setFindAll(value: (js.RegExp, Double, Double, FindAllCallback) => Unit): Self = this.set("findAll", js.Any.fromFunction4(value))
