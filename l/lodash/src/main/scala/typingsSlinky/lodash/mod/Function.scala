...
trait Function[T]
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T2](arg2: T2): Function[Function1[_, _]] = js.native
  /**
    * @see _.partialRight
    */
  def partialRight[T2](arg2: T2, plc3: __): Function[Function2[_, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T3[T3](arg3: T3): Function[Function2[_, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  @JSName("partialRight")
  def partialRight_T3[T3](arg3: T3, plc4: __): Function[Function3[_, _, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  @JSName("partialRight")
