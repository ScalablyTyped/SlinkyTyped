...
trait FunctionChain[T]
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T4](arg4: T4): FunctionChain[Function3[_, _, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  def partialRight[T1, T2](arg1: T1, arg2: T2, plc3: __): FunctionChain[Function1[_, _]] = js.native
  /**
    * @see _.partialRight
    */
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T1, T3](arg1: T1, plc2: __, arg3: T3): FunctionChain[Function1[_, _]] = js.native
  /**
    * @see _.partialRight
    */
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T2[T2](arg2: T2): FunctionChain[Function1[_, _]] = js.native
  /**
    * @see _.partialRight
    */
  @JSName("partialRight")
  def partialRight_T2T3[T2, T3](arg2: T2, arg3: T3, plc4: __): FunctionChain[Function2[_, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  @JSName("partialRight")
  def partialRight_T2T4[T2, T4](arg2: T2, plc3: __, arg4: T4): FunctionChain[Function2[_, _, _]] = js.native
  /**
    * @see _.partialRight
    */
  @JSName("partialRight")
