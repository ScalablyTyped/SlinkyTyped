...
object lodashStrings {
  
  @js.native
  sealed trait ConformsPredicateObject extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait ObjectChain extends StObject
  @scala.inline
  def ObjectChain: ObjectChain = "ObjectChain".asInstanceOf[ObjectChain]
  
  @js.native
  sealed trait PartialShallow extends StObject
  @scala.inline
  def PartialShallow: PartialShallow = "PartialShallow".asInstanceOf[PartialShallow]
