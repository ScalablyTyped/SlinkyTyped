...
import typingsSlinky.lodash.Anon_Args
import typingsSlinky.lodash.Fn_Array
import typingsSlinky.lodash.Fn_Collection
import typingsSlinky.lodash.Fn_Value
...
trait LoDashStatic extends js.Object {
  ...
  {[ P in keyof T ]: any}
    */ typingsSlinky.lodash.lodashStrings.LoDashStatic with js.Any = js.native
  /**
    * @see _.mapValues
    */
