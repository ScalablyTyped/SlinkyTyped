...
@js.native
trait LodashPropertyOf extends LodashConvertible {
  ...
  def apply[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ String */](path: TKey): LodashPropertyOf1x1[TObject, TKey] = js.native
