...
@js.native
trait LodashFill extends LodashConvertible {
  ...
  def apply[U](start: Double, end: Double, value: __): LodashFill1x11[U] = js.native
  ...
  def apply[U](start: Double, end: __, value: __): LodashFill1x9[U] = js.native
