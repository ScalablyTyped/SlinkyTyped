...
trait LodashIsMatchWith extends js.Object {
  ...
  def apply(customizer: isMatchWithCustomizer): LodashIsMatchWith1x1 = js.native
  def apply(customizer: isMatchWithCustomizer, source: js.Object): LodashIsMatchWith1x3 = js.native
