...
import typingsSlinky.luminoWidgets.boxlayoutMod.BoxLayout
import typingsSlinky.luminoWidgets.boxpanelMod.BoxPanel.Alignment
import typingsSlinky.luminoWidgets.boxpanelMod.BoxPanel.Direction
...
object boxpanelMod {
  ...
  object BoxPanel {
    ...
    /**
      ...
      */
    type Alignment = typingsSlinky.luminoWidgets.boxlayoutMod.BoxLayout.Alignment
    
    /**
      * A type alias for a box panel direction.
      */
    type Direction = typingsSlinky.luminoWidgets.boxlayoutMod.BoxLayout.Direction
