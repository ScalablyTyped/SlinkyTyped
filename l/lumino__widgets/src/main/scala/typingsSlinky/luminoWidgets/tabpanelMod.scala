...
import typingsSlinky.luminoWidgets.stackedpanelMod.StackedPanel
import typingsSlinky.luminoWidgets.tabbarMod.TabBar
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.IRenderer
import typingsSlinky.luminoWidgets.tabpanelMod.TabPanel.ICurrentChangedArgs
import typingsSlinky.luminoWidgets.tabpanelMod.TabPanel.IOptions
import typingsSlinky.luminoWidgets.tabpanelMod.TabPanel.TabPlacement
...
object tabpanelMod {
  ...
  object TabPanel {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.top
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.left
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.right
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.bottom
    */
    trait TabPlacement extends StObject
    object TabPlacement {
      
      @scala.inline
      def bottom: typingsSlinky.luminoWidgets.luminoWidgetsStrings.bottom = "bottom".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.bottom]
      
      @scala.inline
      def left: typingsSlinky.luminoWidgets.luminoWidgetsStrings.left = "left".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.left]
      
      @scala.inline
      def right: typingsSlinky.luminoWidgets.luminoWidgetsStrings.right = "right".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.right]
      
      @scala.inline
      def top: typingsSlinky.luminoWidgets.luminoWidgetsStrings.top = "top".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.top]
    }
  }
}
