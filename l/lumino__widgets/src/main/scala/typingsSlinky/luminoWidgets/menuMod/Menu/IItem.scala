package typingsSlinky.luminoWidgets.menuMod.Menu
...
trait IItem extends js.Object {
  ...
  /**
    ...
    */
  val submenu: typingsSlinky.luminoWidgets.menuMod.Menu | Null = js.native
...
object IItem {
  ...
  implicit class IItemOps[Self <: IItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIcon(value: typingsSlinky.luminoVirtualdom.mod.VirtualElement.IRenderer | String): Self = this.set("icon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubmenu(value: typingsSlinky.luminoWidgets.menuMod.Menu): Self = this.set("submenu", value.asInstanceOf[js.Any])
