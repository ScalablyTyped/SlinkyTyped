package typingsSlinky.luminoWidgets.focustrackerMod.FocusTracker
...
object IChangedArgs {
  @scala.inline
  def apply[/* <: typingsSlinky.luminoWidgets.widgetMod.Widget */ T](): IChangedArgs[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IChangedArgs[T]]
  }
  @scala.inline
  implicit class IChangedArgsOps[Self <: IChangedArgs[_], /* <: typingsSlinky.luminoWidgets.widgetMod.Widget */ T] (val x: Self with IChangedArgs[T]) extends AnyVal {
    @scala.inline
