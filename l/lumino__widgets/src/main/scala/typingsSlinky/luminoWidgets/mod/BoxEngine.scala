...
object BoxEngine {
  ...
  /**
    ...
    */
  @JSImport("@lumino/widgets", "BoxEngine.adjust")
  @js.native
  def adjust(sizers: ArrayLike[typingsSlinky.luminoWidgets.boxengineMod.BoxSizer], index: Double, delta: Double): Unit = js.native
  ...
  /**
    ...
    */
  @JSImport("@lumino/widgets", "BoxEngine.calc")
  @js.native
  def calc(sizers: ArrayLike[typingsSlinky.luminoWidgets.boxengineMod.BoxSizer], space: Double): Double = js.native
}
