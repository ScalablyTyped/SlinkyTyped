...
import typingsSlinky.luminoVirtualdom.mod.ElementInlineStyle
import typingsSlinky.luminoVirtualdom.mod.VirtualElement
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.ICurrentChangedArgs
...
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.ITabActivateRequestedArgs
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.ITabCloseRequestedArgs
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.ITabDetachRequestedArgs
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.ITabMovedArgs
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.InsertBehavior
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.Orientation
...
object tabbarMod {
  ...
  class TabBar[T] () extends Widget {
    ...
    def addTab(value: typingsSlinky.luminoWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
    ...
    def insertTab(index: Double, value: typingsSlinky.luminoWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  ...
  object TabBar {
    ...
    */
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.none
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-after`
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-before`
      - typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-previous-tab`
    */
    ...
    object RemoveBehavior {
      ...
      @scala.inline
      def `select-previous-tab`: typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-previous-tab` = "select-previous-tab".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-previous-tab`]
      
      @scala.inline
      def `select-tab-after`: typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-after` = "select-tab-after".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-after`]
      
      @scala.inline
      def `select-tab-before`: typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-before` = "select-tab-before".asInstanceOf[typingsSlinky.luminoWidgets.luminoWidgetsStrings.`select-tab-before`]
    }
  }
}
