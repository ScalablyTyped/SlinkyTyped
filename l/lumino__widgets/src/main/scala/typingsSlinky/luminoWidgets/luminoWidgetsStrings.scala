...
import typingsSlinky.luminoWidgets.layoutMod.Layout.FitPolicy
import typingsSlinky.luminoWidgets.layoutMod.Layout.HorizontalAlignment
import typingsSlinky.luminoWidgets.layoutMod.Layout.VerticalAlignment
import typingsSlinky.luminoWidgets.menuMod.Menu.ItemType
import typingsSlinky.luminoWidgets.scrollbarMod.ScrollBar.Orientation
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.InsertBehavior
import typingsSlinky.luminoWidgets.tabbarMod.TabBar.RemoveBehavior
...
object luminoWidgetsStrings {
  ...
  sealed trait center
    extends Alignment
       with typingsSlinky.luminoWidgets.splitlayoutMod.SplitLayout.Alignment
  ...
  sealed trait horizontal
    extends Orientation
       with typingsSlinky.luminoWidgets.splitlayoutMod.SplitLayout.Orientation
       with typingsSlinky.luminoWidgets.tabbarMod.TabBar.Orientation
  @scala.inline
