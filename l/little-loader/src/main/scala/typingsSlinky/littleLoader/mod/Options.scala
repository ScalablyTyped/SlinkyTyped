...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallback(value: js.ThisFunction1[/* this */ js.Any, /* err */ String, Unit]): Self = this.set("callback", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSetup(value: js.ThisFunction1[/* this */ js.Any, /* script */ js.Any, Unit]): Self = this.set("setup", value.asInstanceOf[js.Any])
