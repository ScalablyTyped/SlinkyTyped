...
object itPairMod {
  ...
  trait Stream extends StObject {
    ...
    def sink(source: js.Iterable[_]): Unit = js.native
  ...
  object Stream {
    ...
    @scala.inline
    def apply(sink: js.Iterable[_] => Unit, source: Record[String, _]): Stream = {
    ...
    implicit class StreamMutableBuilder[Self <: Stream] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSink(value: js.Iterable[_] => Unit): Self = StObject.set(x, "sink", js.Any.fromFunction1(value))
