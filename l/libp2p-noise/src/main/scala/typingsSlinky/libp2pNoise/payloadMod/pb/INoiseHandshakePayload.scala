package typingsSlinky.libp2pNoise.payloadMod.pb
...
object INoiseHandshakePayload {
  ...
  implicit class INoiseHandshakePayloadOps[Self <: INoiseHandshakePayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdentityKey(value: js.typedarray.Uint8Array): Self = this.set("identityKey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIdentitySig(value: js.typedarray.Uint8Array): Self = this.set("identitySig", value.asInstanceOf[js.Any])
