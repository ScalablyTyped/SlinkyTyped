...
object mod {
  ...
  class ValidateHost protected () extends StObject {
    def this(packages: typingsSlinky.lockfileLintApi.anon.Packages) = this()
  ...
  */
  ...
  object ValidationResult {
    ...
    @scala.inline
    def ValidationError(errors: js.Array[Error], `type`: error): typingsSlinky.lockfileLintApi.mod.ValidationError = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.lockfileLintApi.mod.ValidationError]
    }
    
    @scala.inline
    def ValidationSuccess(`object`: Packages, `type`: success): typingsSlinky.lockfileLintApi.mod.ValidationSuccess = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.lockfileLintApi.mod.ValidationSuccess]
    }
  }
