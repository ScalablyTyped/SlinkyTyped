package typingsSlinky.lockfileLintApi.anon
...
object Packages {
  ...
  implicit class PackagesOps[Self <: Packages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPackages(value: typingsSlinky.lockfileLintApi.mod.Packages): Self = this.set("packages", value.asInstanceOf[js.Any])
  }
}
