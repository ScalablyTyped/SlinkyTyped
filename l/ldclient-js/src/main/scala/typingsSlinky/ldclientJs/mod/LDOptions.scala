...
object LDOptions {
  ...
  implicit class LDOptionsOps[Self <: LDOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFetchGoals(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetchGoals")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFetchGoals: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetchGoals")(js.undefined)
        ret
    }
    @scala.inline
