package typingsSlinky.leafletPolylinedecorator
  ...
  object Symbol {
    ...
    object MarkerOptions {
      ...
      implicit class MarkerOptionsMutableBuilder[Self <: MarkerOptions] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setMarkerOptions(value: typingsSlinky.leaflet.mod.MarkerOptions): Self = StObject.set(x, "markerOptions", value.asInstanceOf[js.Any])
