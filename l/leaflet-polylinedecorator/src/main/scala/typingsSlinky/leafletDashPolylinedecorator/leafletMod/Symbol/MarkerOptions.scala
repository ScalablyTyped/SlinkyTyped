...
trait MarkerOptions extends js.Object {
  var markerOptions: js.UndefOr[typingsSlinky.leaflet.leafletMod.MarkerOptions] = js.undefined
...
object MarkerOptions {
  @scala.inline
  def apply(
    markerOptions: typingsSlinky.leaflet.leafletMod.MarkerOptions = null,
