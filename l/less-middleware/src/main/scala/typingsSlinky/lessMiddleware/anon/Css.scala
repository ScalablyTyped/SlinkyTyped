...
object Css {
  ...
  implicit class CssOps[Self <: Css] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCss(value: (/* css */ String, /* req */ Request_[ParamsDictionary, _, _, Query]) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("css")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutCss: Self = {
