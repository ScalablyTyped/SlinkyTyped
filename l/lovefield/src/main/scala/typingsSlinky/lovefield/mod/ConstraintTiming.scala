...
object ConstraintTiming extends StObject {
  ...
  /* 1 */ val DEFERRABLE: typingsSlinky.lovefield.mod.ConstraintTiming.DEFERRABLE with Double = js.native
  
  @js.native
  sealed trait IMMEDIATE extends ConstraintTiming
  /* 0 */ val IMMEDIATE: typingsSlinky.lovefield.mod.ConstraintTiming.IMMEDIATE with Double = js.native
}
