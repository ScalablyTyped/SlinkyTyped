...
object ConstraintAction extends StObject {
  ...
  /* 1 */ val CASCADE: typingsSlinky.lovefield.mod.ConstraintAction.CASCADE with Double = js.native
  
  @js.native
  sealed trait RESTRICT extends ConstraintAction
  /* 0 */ val RESTRICT: typingsSlinky.lovefield.mod.ConstraintAction.RESTRICT with Double = js.native
}
