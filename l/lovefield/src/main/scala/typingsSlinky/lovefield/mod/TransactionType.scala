...
object TransactionType extends StObject {
  ...
  /* 0 */ val READ_ONLY: typingsSlinky.lovefield.mod.TransactionType.READ_ONLY with Double = js.native
  
  @js.native
  sealed trait READ_WRITE extends TransactionType
  /* 1 */ val READ_WRITE: typingsSlinky.lovefield.mod.TransactionType.READ_WRITE with Double = js.native
}
