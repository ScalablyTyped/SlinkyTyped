...
object schema {
  ...
  object DataStoreType extends StObject {
    ...
    /* 3 */ val FIREBASE: typingsSlinky.lovefield.mod.schema.DataStoreType.FIREBASE with Double = js.native
    
    @js.native
    sealed trait INDEXED_DB extends DataStoreType
    /* 0 */ val INDEXED_DB: typingsSlinky.lovefield.mod.schema.DataStoreType.INDEXED_DB with Double = js.native
    
    @js.native
    sealed trait LOCAL_STORAGE extends DataStoreType
    /* 2 */ val LOCAL_STORAGE: typingsSlinky.lovefield.mod.schema.DataStoreType.LOCAL_STORAGE with Double = js.native
    
    @js.native
    sealed trait MEMORY extends DataStoreType
    /* 1 */ val MEMORY: typingsSlinky.lovefield.mod.schema.DataStoreType.MEMORY with Double = js.native
    
    @js.native
    sealed trait WEB_SQL extends DataStoreType
    /* 4 */ val WEB_SQL: typingsSlinky.lovefield.mod.schema.DataStoreType.WEB_SQL with Double = js.native
  }
  ...
  trait Builder extends StObject {
    ...
    def connect(): js.Promise[typingsSlinky.lovefield.mod.schema.Database] = js.native
    def connect(options: ConnectOptions): js.Promise[typingsSlinky.lovefield.mod.schema.Database] = js.native
  ...
  object Database {
    ...
    def apply(
      ...
      version: () => Double
    ): typingsSlinky.lovefield.mod.schema.Database = {
      ...
      __obj.asInstanceOf[typingsSlinky.lovefield.mod.schema.Database]
    }
    
    @scala.inline
    implicit class DatabaseMutableBuilder[Self <: typingsSlinky.lovefield.mod.schema.Database] (val x: Self) extends AnyVal {
