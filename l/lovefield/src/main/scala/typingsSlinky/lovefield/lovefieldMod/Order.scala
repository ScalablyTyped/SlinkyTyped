...
object Order extends js.Object {
  ...
  /* 0 */ val ASC: typingsSlinky.lovefield.lovefieldMod.Order.ASC with Double = js.native
  /* 1 */ val DESC: typingsSlinky.lovefield.lovefieldMod.Order.DESC with Double = js.native
  @JSBracketAccess
