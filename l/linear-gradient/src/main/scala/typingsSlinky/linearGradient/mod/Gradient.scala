package typingsSlinky.linearGradient.mod
...
object Gradient {
  ...
  implicit class GradientOps[Self <: Gradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCalcArray(value: Double => Color): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calcArray")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCalcHex(value: Double => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("calcHex")(js.Any.fromFunction1(value))
        ret
    }
  }
