...
import typingsSlinky.log4javascript.anon.AppendResult
...
object mod {
  ...
  object Level extends StObject {
    ...
    /* 0 */ val ALL: typingsSlinky.log4javascript.mod.Level.ALL with Double = js.native
    
    @js.native
    sealed trait DEBUG extends Level
    /* 2 */ val DEBUG: typingsSlinky.log4javascript.mod.Level.DEBUG with Double = js.native
    
    @js.native
    sealed trait ERROR extends Level
    /* 5 */ val ERROR: typingsSlinky.log4javascript.mod.Level.ERROR with Double = js.native
    
    @js.native
    sealed trait FATAL extends Level
    /* 6 */ val FATAL: typingsSlinky.log4javascript.mod.Level.FATAL with Double = js.native
    
    @js.native
    sealed trait INFO extends Level
    /* 3 */ val INFO: typingsSlinky.log4javascript.mod.Level.INFO with Double = js.native
    
    @js.native
    sealed trait OFF extends Level
    /* 7 */ val OFF: typingsSlinky.log4javascript.mod.Level.OFF with Double = js.native
    
    @js.native
    sealed trait TRACE extends Level
    /* 1 */ val TRACE: typingsSlinky.log4javascript.mod.Level.TRACE with Double = js.native
    
    @js.native
    sealed trait WARN extends Level
    /* 4 */ val WARN: typingsSlinky.log4javascript.mod.Level.WARN with Double = js.native
  }
