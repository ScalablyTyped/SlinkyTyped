...
import typingsSlinky.labeledStreamSplicer.labeledStreamSplicerStrings.close
...
object mod extends js.Object {
  ...
  trait splicer extends js.Object {
    ...
    @JSName("_final")
    var _final_Original: js.Function1[/* callback */ js.Function1[/* error */ js.UndefOr[js.Error | Null], Unit], Unit] = js.native
