package typingsSlinky.luminoPolling.mod.IPoll
...
object State {
  @scala.inline
  def apply[T, U, /* <: java.lang.String */ V](interval: Double, phase: Phase[V], timestamp: Double): State[T, U, V] = {
  ...
  @scala.inline
  implicit class StateOps[Self <: State[_, _, _], T, U, /* <: java.lang.String */ V] (val x: Self with (State[T, U, V])) extends AnyVal {
    @scala.inline
