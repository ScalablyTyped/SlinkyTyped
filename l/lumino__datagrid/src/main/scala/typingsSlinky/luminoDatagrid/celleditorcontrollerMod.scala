...
import typingsSlinky.luminoDatagrid.celleditorMod.ICellEditOptions
import typingsSlinky.luminoDatagrid.celleditorMod.ICellEditor
...
object celleditorcontrollerMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.luminoDatagrid.celleditorMod.CellDataType
    - typingsSlinky.luminoDatagrid.datamodelMod.DataModel.Metadata
    - typingsSlinky.luminoDatagrid.luminoDatagridStrings.default
  */
