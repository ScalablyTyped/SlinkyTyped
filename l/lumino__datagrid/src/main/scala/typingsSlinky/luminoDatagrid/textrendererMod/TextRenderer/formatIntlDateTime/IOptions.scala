package typingsSlinky.luminoDatagrid.textrendererMod.TextRenderer.formatIntlDateTime
...
object IOptions {
  ...
  implicit class IOptionsOps[Self <: IOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: DateTimeFormatOptions): Self = this.set("options", value.asInstanceOf[js.Any])
