...
object mod {
  ...
  object Query {
    ...
    object presence extends StObject {
      ...
      /* 1 */ val OPTIONAL: typingsSlinky.lunr.mod.Query.presence.OPTIONAL with Double = js.native
      ...
      /* 3 */ val PROHIBITED: typingsSlinky.lunr.mod.Query.presence.PROHIBITED with Double = js.native
      ...
      /* 2 */ val REQUIRED: typingsSlinky.lunr.mod.Query.presence.REQUIRED with Double = js.native
    }
    ...
    object wildcard extends StObject {
      ...
      /* 1 << 0 */ val LEADING: typingsSlinky.lunr.mod.Query.wildcard.LEADING with Double = js.native
      
      @js.native
      sealed trait NONE extends wildcard
      /* 0 */ val NONE: typingsSlinky.lunr.mod.Query.wildcard.NONE with Double = js.native
      
      @js.native
      sealed trait TRAILING extends wildcard
      /* 1 << 1 */ val TRAILING: typingsSlinky.lunr.mod.Query.wildcard.TRAILING with Double = js.native
    }
  ...
  object tokenizer {
    ...
    @scala.inline
    def separator_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("separator")(x.asInstanceOf[js.Any])
  }
