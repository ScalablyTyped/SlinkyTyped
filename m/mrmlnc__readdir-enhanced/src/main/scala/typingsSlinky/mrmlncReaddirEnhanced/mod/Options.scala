...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeep(value: Boolean | Double | js.RegExp | FilterFunction): Self = this.set("deep", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFilter(value: String | js.RegExp | FilterFunction): Self = this.set("filter", value.asInstanceOf[js.Any])
