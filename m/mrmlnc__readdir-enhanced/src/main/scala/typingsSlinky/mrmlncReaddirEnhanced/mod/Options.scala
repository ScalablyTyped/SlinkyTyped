...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeepFunction1(value: /* stat */ Entry => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDeep(value: Boolean | Double | js.RegExp | FilterFunction): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deep")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withFilterFunction1(value: /* stat */ Entry => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilter(value: String | js.RegExp | FilterFunction): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filter")(value.asInstanceOf[js.Any])
        ret
    }
