...
object mod {
  ...
  trait Options extends StObject {
    ...
    var deep: js.UndefOr[Boolean | Double | js.RegExp | FilterFunction] = js.native
    
    var filter: js.UndefOr[String | js.RegExp | FilterFunction] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeep(value: Boolean | Double | js.RegExp | FilterFunction): Self = StObject.set(x, "deep", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilter(value: String | js.RegExp | FilterFunction): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
