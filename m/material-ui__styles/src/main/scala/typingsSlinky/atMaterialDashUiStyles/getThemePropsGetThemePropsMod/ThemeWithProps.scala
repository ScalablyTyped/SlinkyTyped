...
trait ThemeWithProps[Components] extends js.Object {
  ...
  {[ K in keyof Components ]: std.Partial<Components[K]>}
    */ typingsSlinky.atMaterialDashUiStyles.atMaterialDashUiStylesStrings.ThemeWithProps with Components
  ] = js.undefined
}
...
object ThemeWithProps {
  ...
  {[ K in keyof Components ]: std.Partial<Components[K]>}
    */ typingsSlinky.atMaterialDashUiStyles.atMaterialDashUiStylesStrings.ThemeWithProps with Components = null
