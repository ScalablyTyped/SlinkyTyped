...
trait AnonName[Props, Name /* <: String */, Theme /* <: ThemeWithProps[_] */] extends js.Object {
  var name: Name
  var props: Props
...
object AnonName {
  @scala.inline
  def apply[Props, Name /* <: String */, Theme /* <: ThemeWithProps[_] */](name: Name, props: Props, theme: Theme = null): AnonName[Props, Name, Theme] = {
