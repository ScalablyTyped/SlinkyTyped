...
object Theme {
  @scala.inline
  def apply[/* <: typingsSlinky.materialUiStyles.withStylesWithStylesMod.ClassKeyInferable[_, _] */ StylesType](theme: ThemeOfStyles[StylesType]): Theme[StylesType] = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[Theme[StylesType]]
  }
  @scala.inline
  implicit class ThemeOps[Self <: Theme[_], /* <: typingsSlinky.materialUiStyles.withStylesWithStylesMod.ClassKeyInferable[_, _] */ StylesType] (val x: Self with Theme[StylesType]) extends AnyVal {
    @scala.inline
