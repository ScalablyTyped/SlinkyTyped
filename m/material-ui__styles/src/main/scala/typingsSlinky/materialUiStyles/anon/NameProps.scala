...
object NameProps {
  @scala.inline
  def apply[Props, /* <: / * keyof any * / java.lang.String */ Name, /* <: typingsSlinky.materialUiStyles.getThemePropsGetThemePropsMod.ThemeWithProps[_] */ Theme](name: Name, props: Props): NameProps[Props, Name, Theme] = {
  ...
  @scala.inline
  implicit class NamePropsOps[Self <: NameProps[_, _, _], Props, /* <: / * keyof any * / java.lang.String */ Name, /* <: typingsSlinky.materialUiStyles.getThemePropsGetThemePropsMod.ThemeWithProps[_] */ Theme] (val x: Self with (NameProps[Props, Name, Theme])) extends AnyVal {
    @scala.inline
