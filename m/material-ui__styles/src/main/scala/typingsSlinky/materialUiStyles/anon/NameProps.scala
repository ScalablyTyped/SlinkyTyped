...
object NameProps {
  @scala.inline
  def apply[Props, Name, Theme](name: Name, props: Props): NameProps[Props, Name, Theme] = {
  ...
  @scala.inline
  implicit class NamePropsOps[Self[props, name, theme] <: NameProps[props, name, theme], Props, Name, Theme] (val x: Self[Props, Name, Theme]) extends AnyVal {
    @scala.inline
