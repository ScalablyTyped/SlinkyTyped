...
trait ThemeWithProps[Components] extends js.Object {
  ...
  {[ K in keyof Components ]: std.Partial<Components[K]>}
    */ typingsSlinky.materialUiStyles.materialUiStylesStrings.ThemeWithProps with Components
  ] = js.undefined
}
...
object ThemeWithProps {
  ...
  {[ K in keyof Components ]: std.Partial<Components[K]>}
    */ typingsSlinky.materialUiStyles.materialUiStylesStrings.ThemeWithProps with Components = null
