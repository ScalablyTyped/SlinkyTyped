...
object AnonThemeThemeOfStyles {
  @scala.inline
  def apply[StylesType](theme: ThemeOfStyles[StylesType]): AnonThemeThemeOfStyles[StylesType] = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonThemeThemeOfStyles[StylesType]]
  }
  @scala.inline
  implicit class AnonThemeThemeOfStylesOps[Self[stylestype] <: AnonThemeThemeOfStyles[stylestype], StylesType] (val x: Self[StylesType]) extends AnyVal {
    @scala.inline
