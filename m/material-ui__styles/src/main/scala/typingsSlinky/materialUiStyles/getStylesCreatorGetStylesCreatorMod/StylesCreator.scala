...
object StylesCreator {
  ...
  @scala.inline
  implicit class StylesCreatorOps[Self <: StylesCreator[_, _, _], Theme, /* <: js.Object */ Props, /* <: java.lang.String */ ClassKey] (val x: Self with (StylesCreator[Theme, Props, ClassKey])) extends AnyVal {
    @scala.inline
