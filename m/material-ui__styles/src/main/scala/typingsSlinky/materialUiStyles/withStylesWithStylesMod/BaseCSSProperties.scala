...
object BaseCSSProperties {
  ...
  implicit class BaseCSSPropertiesOps[Self <: BaseCSSProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `with@font-face`(value: JSSFontface | js.Array[JSSFontface]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@font-face")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `without@font-face`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@font-face")(js.undefined)
        ret
    }
    @scala.inline
