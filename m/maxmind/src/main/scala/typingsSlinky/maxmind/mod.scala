...
import typingsSlinky.maxmind.anon.Max
import typingsSlinky.mmdbLib.mod.default
...
object mod {
  ...
  object default {
    ...
    @js.native
    def open[T](filepath: String): js.Promise[typingsSlinky.mmdbLib.mod.default[T]] = js.native
    @JSImport("maxmind", "default.open")
    @js.native
    def open[T](filepath: String, opts: js.UndefOr[scala.Nothing], cb: Callback): js.Promise[typingsSlinky.mmdbLib.mod.default[T]] = js.native
    @JSImport("maxmind", "default.open")
    @js.native
    def open[T](filepath: String, opts: OpenOpts): js.Promise[typingsSlinky.mmdbLib.mod.default[T]] = js.native
    @JSImport("maxmind", "default.open")
    @js.native
    def open[T](filepath: String, opts: OpenOpts, cb: Callback): js.Promise[typingsSlinky.mmdbLib.mod.default[T]] = js.native
