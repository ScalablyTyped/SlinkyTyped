package typingsSlinky.maxmind.libReaderResponseMod
...
- typings.maxmind.libReaderResponseMod.Response because Already inherited */ trait IspResponse extends AsnResponse {
  val isp: String
