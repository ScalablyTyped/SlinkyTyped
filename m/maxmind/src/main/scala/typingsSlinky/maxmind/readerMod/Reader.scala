...
object Reader {
  @scala.inline
  def apply[/* <: typingsSlinky.maxmind.responseMod.Response */ T](
    db: js.Any,
    decoder: js.Any,
  ...
  @scala.inline
  implicit class ReaderOps[Self <: Reader[_], /* <: typingsSlinky.maxmind.responseMod.Response */ T] (val x: Self with Reader[T]) extends AnyVal {
    @scala.inline
