...
trait BuildStep extends StObject {
  ...
  var pullTiming: js.UndefOr[TimeSpan] = js.native
...
object BuildStep {
  ...
  @scala.inline
  implicit class BuildStepMutableBuilder[Self <: BuildStep] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPullTiming(value: TimeSpan): Self = StObject.set(x, "pullTiming", value.asInstanceOf[js.Any])
