...
import typingsSlinky.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.Build
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: Build): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Build): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
