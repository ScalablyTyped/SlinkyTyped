package typingsSlinky.maximMazurokGapiClientFirebaseml

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.gapiClient.gapi.client.Request
import typingsSlinky.maximMazurokGapiClientFirebaseml.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientFirebaseml.anon.Alt
import typingsSlinky.maximMazurokGapiClientFirebaseml.anon.Callback
  ...
  object client {
    ...
    object firebaseml {
      ...
      object ModelOperationMetadata {
        ...
        @scala.inline
        implicit class ModelOperationMetadataMutableBuilder[Self <: ModelOperationMetadata] (val x: Self) extends AnyVal {
          
          @scala.inline
          def setBasicOperationStatus(value: String): Self = StObject.set(x, "basicOperationStatus", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setBasicOperationStatusUndefined: Self = StObject.set(x, "basicOperationStatus", js.undefined)
      ...
      trait Operation extends StObject {
        ...
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientFirebaseml.maximMazurokGapiClientFirebasemlStrings.Operation with TopLevel[js.Any]
              ] = js.native
      ...
      trait Status extends StObject {
        ...
        var details: js.UndefOr[
                js.Array[
                  /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientFirebaseml.maximMazurokGapiClientFirebasemlStrings.Status with TopLevel[js.Any]
                ]
              ] = js.native
