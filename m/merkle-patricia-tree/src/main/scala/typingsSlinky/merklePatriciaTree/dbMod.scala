...
object dbMod {
  ...
  */
  ...
  object BatchDBOp {
    ...
    @scala.inline
    def DelBatch(key: Buffer, `type`: del): typingsSlinky.merklePatriciaTree.dbMod.DelBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.merklePatriciaTree.dbMod.DelBatch]
    }
    
    @scala.inline
    def PutBatch(key: Buffer, `type`: put, value: Buffer): typingsSlinky.merklePatriciaTree.dbMod.PutBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.merklePatriciaTree.dbMod.PutBatch]
    }
  }
