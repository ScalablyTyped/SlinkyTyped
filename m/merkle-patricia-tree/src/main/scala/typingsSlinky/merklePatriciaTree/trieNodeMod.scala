...
object trieNodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.merklePatriciaTree.trieNodeMod.BranchNode
    - typingsSlinky.merklePatriciaTree.trieNodeMod.ExtensionNode
    - typingsSlinky.merklePatriciaTree.trieNodeMod.LeafNode
  */
