...
object constantsMod {
  ...
  object strings {
    ...
    @JSImport("@material/grid-list/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/grid-list/constants", "strings.TILES_SELECTOR")
    @js.native
    ...
    @JSImport("@material/grid-list/constants", "strings.TILE_SELECTOR")
    @js.native
