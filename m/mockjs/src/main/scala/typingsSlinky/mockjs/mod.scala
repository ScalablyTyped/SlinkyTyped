...
import typingsSlinky.mockjs.mockjsStrings.lower
import typingsSlinky.mockjs.mockjsStrings.number
import typingsSlinky.mockjs.mockjsStrings.symbol
import typingsSlinky.mockjs.mockjsStrings.upper
...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.mockjs.mockjsStrings.http
    - typingsSlinky.mockjs.mockjsStrings.ftp
    - typingsSlinky.mockjs.mockjsStrings.gopher
    - typingsSlinky.mockjs.mockjsStrings.mailto
    - typingsSlinky.mockjs.mockjsStrings.mid
    - typingsSlinky.mockjs.mockjsStrings.cid
    - typingsSlinky.mockjs.mockjsStrings.news
    - typingsSlinky.mockjs.mockjsStrings.nntp
    - typingsSlinky.mockjs.mockjsStrings.prospero
    - typingsSlinky.mockjs.mockjsStrings.telnet
    - typingsSlinky.mockjs.mockjsStrings.rlogin
    - typingsSlinky.mockjs.mockjsStrings.tn3270
    - typingsSlinky.mockjs.mockjsStrings.wais
  */
  trait RandomWebProtocal extends StObject
  object RandomWebProtocal {
    
    @scala.inline
    def cid: typingsSlinky.mockjs.mockjsStrings.cid = "cid".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.cid]
    
    @scala.inline
    def ftp: typingsSlinky.mockjs.mockjsStrings.ftp = "ftp".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.ftp]
    
    @scala.inline
    def gopher: typingsSlinky.mockjs.mockjsStrings.gopher = "gopher".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.gopher]
    
    @scala.inline
    def http: typingsSlinky.mockjs.mockjsStrings.http = "http".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.http]
    
    @scala.inline
    def mailto: typingsSlinky.mockjs.mockjsStrings.mailto = "mailto".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.mailto]
    
    @scala.inline
    def mid: typingsSlinky.mockjs.mockjsStrings.mid = "mid".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.mid]
    
    @scala.inline
    def news: typingsSlinky.mockjs.mockjsStrings.news = "news".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.news]
    
    @scala.inline
    def nntp: typingsSlinky.mockjs.mockjsStrings.nntp = "nntp".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.nntp]
    
    @scala.inline
    def prospero: typingsSlinky.mockjs.mockjsStrings.prospero = "prospero".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.prospero]
    
    @scala.inline
    def rlogin: typingsSlinky.mockjs.mockjsStrings.rlogin = "rlogin".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.rlogin]
    
    @scala.inline
    def telnet: typingsSlinky.mockjs.mockjsStrings.telnet = "telnet".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.telnet]
    
    @scala.inline
    def tn3270: typingsSlinky.mockjs.mockjsStrings.tn3270 = "tn3270".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.tn3270]
    
    @scala.inline
    def wais: typingsSlinky.mockjs.mockjsStrings.wais = "wais".asInstanceOf[typingsSlinky.mockjs.mockjsStrings.wais]
  }
