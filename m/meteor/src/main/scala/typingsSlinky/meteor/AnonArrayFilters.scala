...
@js.native
trait AnonArrayFilters extends js.Object {
  var arrayFilters: js.UndefOr[js.Array[StringDictionary[_]]] = js.native
  var multi: js.UndefOr[Boolean] = js.native
  var upsert: js.UndefOr[Boolean] = js.native
}

object AnonArrayFilters {
  @scala.inline
  def apply(): AnonArrayFilters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonArrayFilters]
  }
  @scala.inline
  implicit class AnonArrayFiltersOps[Self <: AnonArrayFilters] (val x: Self) extends AnyVal {
    @scala.inline
