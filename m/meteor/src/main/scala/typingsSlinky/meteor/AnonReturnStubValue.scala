...
import typingsSlinky.meteor.meteorMod.Meteor.Error
...
trait AnonReturnStubValue[Result /* <: EJSONable | (js.Array[EJSONable | EJSONableProperty]) | EJSONableProperty */] extends js.Object {
  ...
  @JSName("wait")
  var wait_FAnonReturnStubValue: js.UndefOr[Boolean] = js.native
}

object AnonReturnStubValue {
  @scala.inline
  def apply[Result](): AnonReturnStubValue[Result] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonReturnStubValue[Result]]
  }
  @scala.inline
  implicit class AnonReturnStubValueOps[Self[result] <: AnonReturnStubValue[result], Result] (val x: Self[Result]) extends AnyVal {
    @scala.inline
