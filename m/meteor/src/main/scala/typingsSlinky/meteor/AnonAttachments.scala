...
trait AnonAttachments extends js.Object {
  ...
  var mailComposer: js.UndefOr[typingsSlinky.meteor.emailMod.MailComposer] = js.native
...
object AnonAttachments {
  ...
  implicit class AnonAttachmentsOps[Self <: AnonAttachments] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttachments(value: js.Array[js.Object]): Self = {
    ...
    @scala.inline
    def withMailComposer(value: typingsSlinky.meteor.emailMod.MailComposer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mailComposer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMailComposer: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mailComposer")(js.undefined)
        ret
    }
    @scala.inline
    def withReplyTo(value: String | js.Array[String]): Self = {
        val ret = this.duplicate
