...
object emailMod {
  ...
  object MailComposer {
    ...
    @js.native
    val ^ : typingsSlinky.meteor.emailMod.MailComposerStatic = js.native
    
    @scala.inline
    implicit class MailComposerMutableBuilder[Self <: typingsSlinky.meteor.emailMod.MailComposer] (val x: Self) extends AnyVal {
  ...
  object MailComposerOptions {
    ...
    def apply(
      ...
      keepBcc: Boolean
    ): typingsSlinky.meteor.emailMod.MailComposerOptions = {
      ...
      __obj.asInstanceOf[typingsSlinky.meteor.emailMod.MailComposerOptions]
    }
    
    @scala.inline
    implicit class MailComposerOptionsMutableBuilder[Self <: typingsSlinky.meteor.emailMod.MailComposerOptions] (val x: Self) extends AnyVal {
