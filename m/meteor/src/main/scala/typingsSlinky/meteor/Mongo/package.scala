...
package object Mongo {
  ...
  type Modifier[T] = T | typingsSlinky.meteor.AnonAddToSet[T]
  type OnlyArrays[T] = T
  type OnlyElementsOfArrays[T] = typingsSlinky.std.Partial[
    /* import warning: importer.ImportType#apply Failed type conversion: T[0] */ js.Any
  ]
  type OptionalId[TSchema] = (typingsSlinky.meteor.UnionOmit[TSchema, typingsSlinky.meteor.meteorStrings._id]) with typingsSlinky.meteor.AnonId
  ...
  type Query[T] = typingsSlinky.meteor.meteorStrings.Query with org.scalablytyped.runtime.TopLevel[js.Any] with typingsSlinky.meteor.AnonAnd with typingsSlinky.meteor.Mongo.Dictionary[_]
