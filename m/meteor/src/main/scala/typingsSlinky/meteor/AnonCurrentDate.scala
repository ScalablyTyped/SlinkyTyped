...
object AnonCurrentDate {
  @scala.inline
  def apply[T](): AnonCurrentDate[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCurrentDate[T]]
  }
  @scala.inline
  implicit class AnonCurrentDateOps[Self[t] <: AnonCurrentDate[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
