...
trait ITinytestAssertions extends js.Object {
  ...
  def length(obj: typingsSlinky.meteor.tinyDashTestMod.ILengthAble, expected_length: Double): Unit = js.native
  def length(obj: typingsSlinky.meteor.tinyDashTestMod.ILengthAble, expected_length: Double, msg: String): Unit = js.native
