...
package object Match {
  type Pattern = js.UndefOr[
    (typingsSlinky.std.StringConstructor with org.scalablytyped.runtime.Instantiable0[typingsSlinky.std.global.String]) | (typingsSlinky.std.NumberConstructor with org.scalablytyped.runtime.Instantiable0[typingsSlinky.std.global.Number]) | (typingsSlinky.std.BooleanConstructor with org.scalablytyped.runtime.Instantiable0[typingsSlinky.std.global.Boolean]) | (typingsSlinky.std.ObjectConstructor with org.scalablytyped.runtime.Instantiable0[typingsSlinky.std.global.Object]) | (typingsSlinky.std.FunctionConstructor with (org.scalablytyped.runtime.Instantiable1[/* args (repeated) */ java.lang.String, typingsSlinky.std.global.Function])) | (org.scalablytyped.runtime.Instantiable1[/* args (repeated) */ js.Any, js.Any]) | scala.Null | java.lang.String | scala.Double | scala.Boolean | (js.Array[
