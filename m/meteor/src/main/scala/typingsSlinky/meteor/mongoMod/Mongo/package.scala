...
package object Mongo {
  ...
  type Query[T] = typingsSlinky.meteor.meteorStrings.Query with org.scalablytyped.runtime.TopLevel[js.Any] with typingsSlinky.meteor.AnonAnd with typingsSlinky.meteor.mongoMod.Mongo.Dictionary[_]
