...
object renderWithData extends js.Object {
  def apply(templateOrView: typingsSlinky.meteor.blazeMod.Blaze.Template, data: js.Function, parentNode: Node): View = js.native
  def apply(
    templateOrView: typingsSlinky.meteor.blazeMod.Blaze.Template,
    data: js.Function,
    parentNode: Node,
    nextNode: Node
  ): View = js.native
  ...
  def apply(templateOrView: typingsSlinky.meteor.blazeMod.Blaze.Template, data: js.Object, parentNode: Node): View = js.native
  def apply(
    templateOrView: typingsSlinky.meteor.blazeMod.Blaze.Template,
    data: js.Object,
    parentNode: Node,
