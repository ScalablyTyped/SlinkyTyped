...
trait TemplateStatic
  extends Instantiable0[typingsSlinky.meteor.blazeMod.Blaze.Template]
     with Instantiable1[/* viewName */ String, typingsSlinky.meteor.blazeMod.Blaze.Template]
     with Instantiable2[
      /* viewName */ String, 
      /* renderFunction */ js.Function, 
      typingsSlinky.meteor.blazeMod.Blaze.Template
    ] {
