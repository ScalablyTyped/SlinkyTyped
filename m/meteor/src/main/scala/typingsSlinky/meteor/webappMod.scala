...
object webappMod {
  ...
  object WebApp {
    ...
    @js.native
    def httpServer: typingsSlinky.node.httpMod.Server = js.native
    @scala.inline
    def httpServer_=(x: typingsSlinky.node.httpMod.Server): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("httpServer")(x.asInstanceOf[js.Any])
