...
object OnResultReceived {
  @scala.inline
  def apply[/* <: typingsSlinky.meteor.EJSONable | (js.Array[typingsSlinky.meteor.EJSONable | typingsSlinky.meteor.EJSONableProperty]) | typingsSlinky.meteor.EJSONableProperty */ Result](): OnResultReceived[Result] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OnResultReceived[Result]]
  }
  @scala.inline
  implicit class OnResultReceivedOps[Self <: OnResultReceived[_], /* <: typingsSlinky.meteor.EJSONable | (js.Array[typingsSlinky.meteor.EJSONable | typingsSlinky.meteor.EJSONableProperty]) | typingsSlinky.meteor.EJSONableProperty */ Result] (val x: Self with OnResultReceived[Result]) extends AnyVal {
    @scala.inline
