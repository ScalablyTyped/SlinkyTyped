...
object OnResultReceived {
  @scala.inline
  def apply[Result](): OnResultReceived[Result] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OnResultReceived[Result]]
  }
  @scala.inline
  implicit class OnResultReceivedOps[Self[result] <: OnResultReceived[result], Result] (val x: Self[Result]) extends AnyVal {
    @scala.inline
