...
object AmbiguousErrorMessages {
  ...
  implicit class AmbiguousErrorMessagesOps[Self <: AmbiguousErrorMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultFieldSelector(value: StringDictionary[typingsSlinky.meteor.meteorNumbers.`0` | `1`]): Self = this.set("defaultFieldSelector", value.asInstanceOf[js.Any])
