...
trait AmbiguousErrorMessages extends StObject {
  ...
  var defaultFieldSelector: js.UndefOr[StringDictionary[typingsSlinky.meteor.meteorNumbers.`0` | `1`]] = js.native
...
object AmbiguousErrorMessages {
  ...
  implicit class AmbiguousErrorMessagesMutableBuilder[Self <: AmbiguousErrorMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultFieldSelector(value: StringDictionary[typingsSlinky.meteor.meteorNumbers.`0` | `1`]): Self = StObject.set(x, "defaultFieldSelector", value.asInstanceOf[js.Any])
