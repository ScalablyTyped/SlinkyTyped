...
object CurrentDate {
  ...
  @scala.inline
  implicit class CurrentDateOps[Self <: CurrentDate[_], T] (val x: Self with CurrentDate[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def set$max(value: (PartialMapTo[T, js.Date | Double]) with (Dictionary[js.Date | Double])): Self = this.set("$max", value.asInstanceOf[js.Any])
    @scala.inline
    def delete$max: Self = this.set("$max", js.undefined)
    @scala.inline
    def set$min(value: (PartialMapTo[T, js.Date | Double]) with (Dictionary[js.Date | Double])): Self = this.set("$min", value.asInstanceOf[js.Any])
    @scala.inline
