...
object Assets extends js.Object {
  ...
  def getBinary(assetPath: String): js.UndefOr[typingsSlinky.meteor.EJSON] = js.native
  def getBinary(assetPath: String, asyncCallback: js.Function): js.UndefOr[typingsSlinky.meteor.EJSON] = js.native
