...
@js.native
class ViewCls ()
  extends typingsSlinky.meteor.Blaze.View {
  ...
  /* CompleteClass */
  override var parentView: typingsSlinky.meteor.Blaze.View = js.native
  /* CompleteClass */
  override var renderCount: Double = js.native
  /* CompleteClass */
  override var template: typingsSlinky.meteor.Blaze.Template = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def templateInstance(): typingsSlinky.meteor.Blaze.TemplateInstance = js.native
}
