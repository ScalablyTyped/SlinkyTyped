...
@js.native
trait SearchAllAssignmentsResponse extends js.Object {
...
object SearchAllAssignmentsResponse {
  ...
  @scala.inline
  implicit class SearchAllAssignmentsResponseOps[Self <: SearchAllAssignmentsResponse] (val x: Self) extends AnyVal {
