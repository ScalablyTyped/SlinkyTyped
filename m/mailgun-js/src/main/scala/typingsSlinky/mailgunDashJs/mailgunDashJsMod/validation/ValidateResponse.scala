...
import typingsSlinky.mailgunDashJs.Anon_Displayname
import typingsSlinky.mailgunDashJs.mailgunDashJsStrings.false_
import typingsSlinky.mailgunDashJs.mailgunDashJsStrings.true_
import typingsSlinky.mailgunDashJs.mailgunDashJsStrings.unknown
