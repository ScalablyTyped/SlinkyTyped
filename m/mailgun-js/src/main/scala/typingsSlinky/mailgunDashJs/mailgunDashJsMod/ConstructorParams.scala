...
import typingsSlinky.mailgunDashJs.Anon_Interval
...
trait ConstructorParams extends js.Object {
  ...
  var testModeLogger: js.UndefOr[
    js.Function3[
      ...
      /* payload */ String, 
      /* form */ typingsSlinky.formDashData.formDashDataMod.^, 
      Unit
    ]
  ] = js.undefined
...
object ConstructorParams {
  ...
  def apply(
    ...
    testModeLogger: (/* httpOptions */ LoggerHttpOptions, /* payload */ String, /* form */ typingsSlinky.formDashData.formDashDataMod.^) => Unit = null,
