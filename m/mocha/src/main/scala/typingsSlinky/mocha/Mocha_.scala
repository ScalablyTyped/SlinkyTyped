...
trait Mocha_ extends js.Object {
  ...
  def reporter(reporter: typingsSlinky.mocha.Mocha.ReporterConstructor): this.type = js.native
  def reporter(reporter: typingsSlinky.mocha.Mocha.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
