...
trait SuiteConstants extends js.Object {
  ...
  val EVENT_ROOT_SUITE_RUN: typingsSlinky.mocha.mochaStrings.run
  val EVENT_SUITE_ADD_HOOK_AFTER_ALL: afterAll
  val EVENT_SUITE_ADD_HOOK_AFTER_EACH: typingsSlinky.mocha.mochaStrings.afterEach
  val EVENT_SUITE_ADD_HOOK_BEFORE_ALL: beforeAll
  val EVENT_SUITE_ADD_HOOK_BEFORE_EACH: typingsSlinky.mocha.mochaStrings.beforeEach
  val EVENT_SUITE_ADD_SUITE: typingsSlinky.mocha.mochaStrings.suite
  val EVENT_SUITE_ADD_TEST: typingsSlinky.mocha.mochaStrings.test
  val HOOK_TYPE_AFTER_ALL: afterAll
  val HOOK_TYPE_AFTER_EACH: typingsSlinky.mocha.mochaStrings.afterEach
  val HOOK_TYPE_BEFORE_ALL: beforeAll
  val HOOK_TYPE_BEFORE_EACH: typingsSlinky.mocha.mochaStrings.beforeEach
}
