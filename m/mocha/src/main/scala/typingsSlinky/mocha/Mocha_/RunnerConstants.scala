...
trait RunnerConstants extends js.Object {
  ...
  val EVENT_SUITE_BEGIN: typingsSlinky.mocha.mochaStrings.suite = js.native
  val EVENT_SUITE_END: `suite end` = js.native
  val EVENT_TEST_BEGIN: typingsSlinky.mocha.mochaStrings.test = js.native
...
object RunnerConstants {
  ...
  def apply(
    ...
    EVENT_RUN_END: end,
    EVENT_SUITE_BEGIN: typingsSlinky.mocha.mochaStrings.suite,
    EVENT_SUITE_END: `suite end`,
    EVENT_TEST_BEGIN: typingsSlinky.mocha.mochaStrings.test,
  ...
  implicit class RunnerConstantsOps[Self <: RunnerConstants] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEVENT_SUITE_BEGIN(value: typingsSlinky.mocha.mochaStrings.suite): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEVENT_TEST_BEGIN(value: typingsSlinky.mocha.mochaStrings.test): Self = {
        val ret = this.duplicate
