...
object MochaOptions {
  ...
  implicit class MochaOptionsOps[Self <: MochaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGrepRegExp(value: js.RegExp): Self = this.set("grep", value.asInstanceOf[js.Any])
    @scala.inline
    def setGrep(value: String | js.RegExp): Self = this.set("grep", value.asInstanceOf[js.Any])
    @scala.inline
