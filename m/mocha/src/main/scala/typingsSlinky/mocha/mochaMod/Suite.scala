...
class Suite protected ()
  extends typingsSlinky.mocha.Mocha.Suite {
...
object Suite extends js.Object {
  ...
  def create(parent: ISuite, title: String): typingsSlinky.mocha.Mocha.Suite = js.native
  /**
    ...
    */
  def create(parent: typingsSlinky.mocha.Mocha.Suite, title: String): typingsSlinky.mocha.Mocha.Suite = js.native
}
