package typingsSlinky.maximMazurokGapiClientFirebaserules.anon

import typingsSlinky.maximMazurokGapiClientFirebaserules.gapi.client.firebaserules.TestRulesetRequest
...
object Oauthtoken {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TestRulesetRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
