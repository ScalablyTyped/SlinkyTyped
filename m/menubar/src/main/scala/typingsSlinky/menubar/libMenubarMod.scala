...
import typingsSlinky.electron.electronMod.BrowserWindow
import typingsSlinky.electron.electronMod.Tray
import typingsSlinky.menubar.libTypesMod.Options
import typingsSlinky.menubar.menubarNumbers.`false`
...
@js.native
object libMenubarMod extends js.Object {
  @js.native
  class Menubar protected () extends EventEmitter {
    ...
    @JSName("getOption")
    def getOption_tray(key: typingsSlinky.menubar.menubarStrings.tray): Tray = js.native
    @JSName("getOption")
    ...
    @JSName("setOption")
    def setOption_icon(key: icon, value: NativeImage): Unit = js.native
    @JSName("setOption")
    ...
    @JSName("setOption")
    def setOption_tray(key: typingsSlinky.menubar.menubarStrings.tray, value: Tray): Unit = js.native
    /**
