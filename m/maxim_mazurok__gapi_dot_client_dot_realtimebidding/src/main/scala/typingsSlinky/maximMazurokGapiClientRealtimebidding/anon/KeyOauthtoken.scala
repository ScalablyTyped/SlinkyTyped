...
import typingsSlinky.maximMazurokGapiClientRealtimebidding.gapi.client.realtimebidding.UserList
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: UserList = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: UserList): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UserList): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
