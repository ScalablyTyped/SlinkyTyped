...
object ServiceClientOptions {
  ...
  implicit class ServiceClientOptionsOps[Self <: ServiceClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNoRetryPolicy(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noRetryPolicy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNoRetryPolicy: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("noRetryPolicy")(js.undefined)
        ret
    }
    @scala.inline
    def withRequestOptions(value: ClientRequestOptions): Self = {
        val ret = this.duplicate
