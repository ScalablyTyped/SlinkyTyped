...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.msRest.msRestStrings.GET
  - typingsSlinky.msRest.msRestStrings.PUT
  - typingsSlinky.msRest.msRestStrings.POST
  - typingsSlinky.msRest.msRestStrings.DELETE
  - typingsSlinky.msRest.msRestStrings.PATCH
  - typingsSlinky.msRest.msRestStrings.HEAD
  - typingsSlinky.msRest.msRestStrings.OPTIONS
  - typingsSlinky.msRest.msRestStrings.TRACE
*/
