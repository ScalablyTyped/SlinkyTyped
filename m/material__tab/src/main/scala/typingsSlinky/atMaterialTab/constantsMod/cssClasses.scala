package typingsSlinky.atMaterialTab.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atMaterialBase.foundationMod.MDCStrings
import typingsSlinky.atMaterialTab.atMaterialTabStrings.`mdc-tab--active`
import typingsSlinky.atMaterialTab.atMaterialTabStrings.`mdc-tab--animating-activate`
import typingsSlinky.atMaterialTab.atMaterialTabStrings.`mdc-tab--animating-deactivate`
