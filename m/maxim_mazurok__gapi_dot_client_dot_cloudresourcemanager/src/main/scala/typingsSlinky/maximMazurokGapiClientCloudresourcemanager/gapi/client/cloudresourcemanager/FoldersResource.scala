...
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Alt
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Callback
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Fields
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Key
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Name
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Oauthtoken
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.PrettyPrint
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.Resource
import typingsSlinky.maximMazurokGapiClientCloudresourcemanager.anon.UploadType
