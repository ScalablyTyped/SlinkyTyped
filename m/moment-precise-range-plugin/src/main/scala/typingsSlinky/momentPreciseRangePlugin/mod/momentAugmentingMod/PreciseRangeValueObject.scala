package typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod
...
object PreciseRangeValueObject {
  ...
  implicit class PreciseRangeValueObjectOps[Self <: PreciseRangeValueObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFirstDateWasLater(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("firstDateWasLater")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
