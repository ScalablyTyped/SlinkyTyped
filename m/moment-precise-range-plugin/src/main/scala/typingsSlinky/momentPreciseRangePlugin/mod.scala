...
import typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod.PreciseRangeValueObject
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    def preciseDiff_false(
      d1: typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment,
      d2: typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment,
    ...
    trait Moment extends StObject {
      ...
      def preciseDiff(d2: typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment): String = js.native
      @JSName("preciseDiff")
      def preciseDiff_false(
        d2: typingsSlinky.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment,
