...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/dialog/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/dialog/constants", "cssClasses.CLOSING")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "cssClasses.OPENING")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "cssClasses.STACKED")
    @js.native
  ...
  object numbers {
    ...
    @JSImport("@material/dialog/constants", "numbers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/dialog/constants", "numbers.DIALOG_ANIMATION_CLOSE_TIME_MS")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "numbers.DIALOG_ANIMATION_OPEN_TIME_MS")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/dialog/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/dialog/constants", "strings.ACTION_ATTRIBUTE")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.BUTTON_DEFAULT_ATTRIBUTE")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.BUTTON_SELECTOR")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.CLOSED_EVENT")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.CLOSE_ACTION")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.CLOSING_EVENT")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.CONTAINER_SELECTOR")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.CONTENT_SELECTOR")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.DESTROY_ACTION")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.INITIAL_FOCUS_ATTRIBUTE")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.OPENED_EVENT")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.OPENING_EVENT")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.SCRIM_SELECTOR")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.SUPPRESS_DEFAULT_PRESS_SELECTOR")
    @js.native
    ...
    @JSImport("@material/dialog/constants", "strings.SURFACE_SELECTOR")
    @js.native
