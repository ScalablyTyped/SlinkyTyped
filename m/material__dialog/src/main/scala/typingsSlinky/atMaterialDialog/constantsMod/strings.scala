package typingsSlinky.atMaterialDialog.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atMaterialBase.foundationMod.MDCStrings
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.MDCDialogColonaccept
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.MDCDialogColoncancel
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.`Dotmdc-dialog--open`
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.`Dotmdc-dialog__footer__button--accept`
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.`Dotmdc-dialog__surface`
