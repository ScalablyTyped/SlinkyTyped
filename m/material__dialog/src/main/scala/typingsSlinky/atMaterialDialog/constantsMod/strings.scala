...
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.`MDCDialog:accept`
import typingsSlinky.atMaterialDialog.atMaterialDialogStrings.`MDCDialog:cancel`
