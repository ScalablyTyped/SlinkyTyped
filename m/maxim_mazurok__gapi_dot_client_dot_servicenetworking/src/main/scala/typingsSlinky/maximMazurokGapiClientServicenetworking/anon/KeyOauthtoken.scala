...
import typingsSlinky.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.ValidateConsumerConfigRequest
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ValidateConsumerConfigRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: ValidateConsumerConfigRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ValidateConsumerConfigRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
