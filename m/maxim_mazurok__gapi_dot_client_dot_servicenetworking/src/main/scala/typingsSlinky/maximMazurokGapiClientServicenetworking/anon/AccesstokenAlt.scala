...
import typingsSlinky.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.AddSubnetworkRequest
...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: AddSubnetworkRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(parent: String, resource: AddSubnetworkRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AddSubnetworkRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
