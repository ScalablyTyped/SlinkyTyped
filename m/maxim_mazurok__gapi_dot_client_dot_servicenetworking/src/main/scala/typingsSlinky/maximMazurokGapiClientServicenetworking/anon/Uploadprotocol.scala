...
import typingsSlinky.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.UpdateConsumerConfigRequest
...
trait Uploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: UpdateConsumerConfigRequest = js.native
...
object Uploadprotocol {
  ...
  @scala.inline
  def apply(parent: String, resource: UpdateConsumerConfigRequest): Uploadprotocol = {
  ...
  implicit class UploadprotocolMutableBuilder[Self <: Uploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateConsumerConfigRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
