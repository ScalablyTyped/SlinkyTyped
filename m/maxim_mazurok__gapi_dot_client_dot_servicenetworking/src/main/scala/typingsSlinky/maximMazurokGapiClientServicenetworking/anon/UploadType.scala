...
import typingsSlinky.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.PeeredDnsDomain
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: PeeredDnsDomain = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(parent: String, resource: PeeredDnsDomain): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PeeredDnsDomain): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
