...
@js.native
trait AddSubnetworkRequest extends js.Object {
...
object AddSubnetworkRequest {
  ...
  @scala.inline
  implicit class AddSubnetworkRequestOps[Self <: AddSubnetworkRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecondaryIpRangeSpecsVarargs(value: SecondaryIpRangeSpec*): Self = this.set("secondaryIpRangeSpecs", js.Array(value :_*))
    
    @scala.inline
    def setSecondaryIpRangeSpecs(value: js.Array[SecondaryIpRangeSpec]): Self = this.set("secondaryIpRangeSpecs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSecondaryIpRangeSpecs: Self = this.set("secondaryIpRangeSpecs", js.undefined)
