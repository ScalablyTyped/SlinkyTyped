...
import typingsSlinky.maximMazurokGapiClientCalendar.gapi.client.calendar.Calendar
...
@js.native
trait CalendarIdFields extends StObject {
...
object CalendarIdFields {
  
  @scala.inline
  def apply(calendarId: String, resource: Calendar): CalendarIdFields = {
  ...
  @scala.inline
  implicit class CalendarIdFieldsMutableBuilder[Self <: CalendarIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Calendar): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
