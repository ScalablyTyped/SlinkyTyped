...
import typingsSlinky.maximMazurokGapiClientCalendar.anon.KeyMaxResults
import typingsSlinky.maximMazurokGapiClientCalendar.anon.SyncToken
...
trait SettingsResource extends js.Object {
  ...
  def get(request: typingsSlinky.maximMazurokGapiClientCalendar.anon.Setting): Request[Setting] = js.native
