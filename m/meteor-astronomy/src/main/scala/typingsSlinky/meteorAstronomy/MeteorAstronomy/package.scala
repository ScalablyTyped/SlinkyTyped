...
package object MeteorAstronomy {
  type Enum[T] = T with typingsSlinky.meteorAstronomy.AnonGetIdentifier
  ...
  {[ P in keyof meteor-astronomy.MeteorAstronomy.NonFunctionProperties<T> ]: meteor-astronomy.MeteorAstronomy.ModelField<T[P], T>}
    */ typingsSlinky.meteorAstronomy.meteorAstronomyStrings.Fields with T
  ...
  {[ P in keyof meteor-astronomy.MeteorAstronomy.FunctionProperties<T> ]: (this : T, args : ...any): any}
    */ typingsSlinky.meteorAstronomy.meteorAstronomyStrings.Helpers with js.Any
  type Model[T] = T with typingsSlinky.meteorAstronomy.AnonCopy[T]
  ...
  type TypeOptionsPrimitives = typingsSlinky.std.StringConstructor | typingsSlinky.std.DateConstructor | typingsSlinky.std.BooleanConstructor | typingsSlinky.std.ObjectConstructor | typingsSlinky.std.NumberConstructor
}
