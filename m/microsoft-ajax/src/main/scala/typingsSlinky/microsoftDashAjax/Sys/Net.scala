...
import typingsSlinky.microsoftDashAjax.Sys.Net.IWebRequestManager
import typingsSlinky.microsoftDashAjax.Sys.Net.NetworkRequestEventArgs
...
import typingsSlinky.microsoftDashAjax.Sys.Net.WebServiceError
