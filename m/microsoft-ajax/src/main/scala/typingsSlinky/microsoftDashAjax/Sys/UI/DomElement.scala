...
import typingsSlinky.microsoftDashAjax.Anon_Height
...
trait DomElement extends js.Object {
  ...
  /**
    ...
    */
  def getBounds(element: HTMLElement): Anon_Height = js.native
  /**
    * @param id
  ...
  def getElementById(id: java.lang.String, element: typingsSlinky.std.HTMLElement): HTMLElement = js.native
  /**
  ...
  /**
    ...
    */
  def removeCssClass(element: typingsSlinky.std.HTMLElement, className: java.lang.String): Unit = js.native
  /**
