...
object PageLoadedEventArgs {
  ...
  implicit class PageLoadedEventArgsOps[Self <: PageLoadedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_panelsCreated(value: () => js.Array[HTMLDivElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_panelsCreated")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_panelsUpdated(value: () => js.Array[HTMLDivElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_panelsUpdated")(js.Any.fromFunction0(value))
        ret
    }
  }
