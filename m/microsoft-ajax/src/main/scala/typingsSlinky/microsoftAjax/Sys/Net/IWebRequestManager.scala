...
object IWebRequestManager {
  ...
  implicit class IWebRequestManagerOps[Self <: IWebRequestManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd_completedRequest(value: js.Function2[/* sender */ WebRequestExecutor, /* eventArgs */ EventArgs, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("add_completedRequest")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAdd_invokingRequest(
      value: js.Function2[
          /* sender */ WebRequestExecutor, 
          /* networkRequestEventArgs */ NetworkRequestEventArgs, 
          Unit
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("add_invokingRequest")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withExecuteRequest(value: WebRequest => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeRequest")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet_defaultExecutorType(value: () => WebRequestExecutor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_defaultExecutorType")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_defaultTimeout(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_defaultTimeout")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemove_completedRequest(value: js.Function2[/* sender */ WebRequestExecutor, /* eventArgs */ EventArgs, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove_completedRequest")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemove_invokingRequest(
      value: js.Function2[
          /* sender */ WebRequestExecutor, 
          /* networkRequestEventArgs */ NetworkRequestEventArgs, 
          Unit
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove_invokingRequest")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSet_defaultExecutorType(value: WebRequestExecutor => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_defaultExecutorType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSet_defaultTimeout(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set_defaultTimeout")(js.Any.fromFunction1(value))
        ret
    }
  }
