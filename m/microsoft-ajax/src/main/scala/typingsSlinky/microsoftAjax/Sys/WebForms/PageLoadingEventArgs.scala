...
object PageLoadingEventArgs {
  ...
  implicit class PageLoadingEventArgsOps[Self <: PageLoadingEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet_panelsDeleting(value: () => js.Array[HTMLDivElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_panelsDeleting")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGet_panelsUpdating(value: () => js.Array[HTMLDivElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get_panelsUpdating")(js.Any.fromFunction0(value))
        ret
    }
  }
