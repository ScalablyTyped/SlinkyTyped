...
@js.native
class Res ()
  extends typingsSlinky.microsoftAjax.Sys.Res
object Res {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Sys.Res.argumentType")
  @js.native
  def argumentType: String = js.native
