...
class CultureInfo protected ()
  extends typingsSlinky.microsoftAjax.Sys.CultureInfo {
  //#region Constructors
  /**
...
object CultureInfo {
  ...
  @js.native
  def CurrentCulture: typingsSlinky.microsoftAjax.Sys.CultureInfo = js.native
  @scala.inline
  def CurrentCulture_=(x: typingsSlinky.microsoftAjax.Sys.CultureInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CurrentCulture")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def InvariantCulture: typingsSlinky.microsoftAjax.Sys.CultureInfo = js.native
  @scala.inline
  def InvariantCulture_=(x: typingsSlinky.microsoftAjax.Sys.CultureInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("InvariantCulture")(x.asInstanceOf[js.Any])
}
