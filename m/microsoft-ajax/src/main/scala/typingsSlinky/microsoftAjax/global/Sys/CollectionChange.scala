...
class CollectionChange protected ()
  extends typingsSlinky.microsoftAjax.Sys.CollectionChange {
  //#region Constructors
  /**
    ...
    */
  def this(
    action: typingsSlinky.microsoftAjax.Sys.NotifyCollectionChangedAction,
    newItems: js.Array[_],
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var action: typingsSlinky.microsoftAjax.Sys.NotifyCollectionChangedAction = js.native
  /**
