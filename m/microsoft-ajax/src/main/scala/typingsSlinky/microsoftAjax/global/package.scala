...
package object global {
  ...
  */
  ...
  def addHandler(
    ...
    handler: js.Function1[/* e */ typingsSlinky.microsoftAjax.Sys.UI.DomEvent, scala.Unit]
  ...
  */
  ...
  def addHandlers(
    element: org.scalajs.dom.raw.HTMLElement,
    events: org.scalablytyped.runtime.StringDictionary[js.Function1[/* e */ typingsSlinky.microsoftAjax.Sys.UI.DomEvent, scala.Unit]]
  ...
  */
  @scala.inline
  def clearHandlers(element: org.scalajs.dom.raw.HTMLElement): scala.Unit = js.Dynamic.global.applyDynamic("$clearHandlers")(element.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  */
  @scala.inline
  def create(`type`: typingsSlinky.microsoftAjax.Type): typingsSlinky.microsoftAjax.Sys.Component = js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.UndefOr[scala.Nothing],
    events: js.UndefOr[scala.Nothing],
    references: js.UndefOr[scala.Nothing],
    element: org.scalajs.dom.raw.HTMLElement
  ): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.UndefOr[scala.Nothing],
    events: js.UndefOr[scala.Nothing],
    references: js.Any
  ): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def create(`type`: typingsSlinky.microsoftAjax.Type, properties: js.UndefOr[scala.Nothing], events: js.Any): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def create(`type`: typingsSlinky.microsoftAjax.Type, properties: js.Any): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.Any,
  ...
  @scala.inline
  def create(`type`: typingsSlinky.microsoftAjax.Type, properties: js.Any, events: js.Any): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.Any,
  ...
  @scala.inline
  def create(`type`: typingsSlinky.microsoftAjax.Type, properties: js.Any, events: js.Any, references: js.Any): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def create(
    `type`: typingsSlinky.microsoftAjax.Type,
    properties: js.Any,
  ...
  */
  @scala.inline
  def find(id: java.lang.String): typingsSlinky.microsoftAjax.Sys.Component = js.Dynamic.global.applyDynamic("$find")(id.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def find(id: java.lang.String, parent: org.scalajs.dom.raw.HTMLElement): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$find")(id.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  @scala.inline
  def find(id: java.lang.String, parent: typingsSlinky.microsoftAjax.Sys.Component): typingsSlinky.microsoftAjax.Sys.Component = (js.Dynamic.global.applyDynamic("$find")(id.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.microsoftAjax.Sys.Component]
  ...
  */
  @scala.inline
  def get(id: java.lang.String): org.scalajs.dom.raw.HTMLElement = js.Dynamic.global.applyDynamic("$get")(id.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.raw.HTMLElement]
  @scala.inline
  def get(id: java.lang.String, element: org.scalajs.dom.raw.HTMLElement): org.scalajs.dom.raw.HTMLElement = (js.Dynamic.global.applyDynamic("$get")(id.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.raw.HTMLElement]
