...
@js.native
class Observer ()
  extends typingsSlinky.microsoftAjax.Sys.Observer
object Observer {
  ...
  @js.native
  def raiseCollectionChanged(target: js.Array[_], changes: typingsSlinky.microsoftAjax.Sys.CollectionChange): Unit = js.native
  ...
  @js.native
  def raiseEvent(target: js.Any, eventName: String, eventArgs: typingsSlinky.microsoftAjax.Sys.EventArgs): Unit = js.native
