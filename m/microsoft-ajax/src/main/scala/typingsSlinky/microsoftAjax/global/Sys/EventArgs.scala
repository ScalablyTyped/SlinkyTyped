...
object EventArgs {
  ...
  @js.native
  def Empty: typingsSlinky.microsoftAjax.Sys.EventArgs = js.native
  @scala.inline
  def Empty_=(x: typingsSlinky.microsoftAjax.Sys.EventArgs): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Empty")(x.asInstanceOf[js.Any])
}
