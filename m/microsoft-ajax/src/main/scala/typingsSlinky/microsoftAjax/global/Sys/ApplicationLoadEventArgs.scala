...
class ApplicationLoadEventArgs protected ()
  extends typingsSlinky.microsoftAjax.Sys.ApplicationLoadEventArgs {
  //#region Constructors
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get_components(): js.Array[typingsSlinky.microsoftAjax.Sys.Component] = js.native
  /**
