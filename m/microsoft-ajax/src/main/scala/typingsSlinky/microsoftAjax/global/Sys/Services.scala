...
object Services extends js.Object {
  ...
  class AuthenticationService ()
    extends typingsSlinky.microsoftAjax.Sys.Services.AuthenticationService
  ...
  //#region Constructors
  class ProfileGroup ()
    extends typingsSlinky.microsoftAjax.Sys.Services.ProfileGroup {
    /**
  ...
  class ProfileService ()
    extends typingsSlinky.microsoftAjax.Sys.Services.ProfileService
  ...
  @js.native
  class RoleService ()
    extends typingsSlinky.microsoftAjax.Sys.Services.RoleService
