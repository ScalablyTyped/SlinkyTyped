...
object Net extends js.Object {
  ...
  class IWebRequestManager ()
    ...
    override def add_completedRequest(
      handler: js.Function2[
          /* sender */ typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor, 
          /* eventArgs */ typingsSlinky.microsoftAjax.Sys.EventArgs, 
          Unit
        ]
    ): Unit = js.native
    /**
    ...
    override def add_invokingRequest(
      handler: js.Function2[
          /* sender */ typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor, 
          /* networkRequestEventArgs */ typingsSlinky.microsoftAjax.Sys.Net.NetworkRequestEventArgs, 
          Unit
        ]
    ): Unit = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def executeRequest(WebRequest: typingsSlinky.microsoftAjax.Sys.Net.WebRequest): Unit = js.native
    //#endregion
    //#region Properties
    /**
      ...
      */
    /* CompleteClass */
    override def get_defaultExecutorType(): typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def set_defaultExecutorType(value: typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor): Unit = js.native
    /**
      * Gets or sets the time-out for the default network executor.
      *
  ...
  class NetworkRequestEventArgs protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def get_webRequest(): typingsSlinky.microsoftAjax.Sys.Net.WebRequest = js.native
  }
  ...
  class WebRequest ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def completed(eventArgs: typingsSlinky.microsoftAjax.Sys.EventArgs): Unit = js.native
    /**
    ...
    /* CompleteClass */
    override def get_executor(): typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    override def set_executor(value: typingsSlinky.microsoftAjax.Sys.Net.WebRequestExecutor): Unit = js.native
    /* CompleteClass */
