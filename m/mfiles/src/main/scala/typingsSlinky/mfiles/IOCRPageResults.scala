...
object IOCRPageResults {
  ...
  @scala.inline
  implicit class IOCRPageResultsOps[Self <: IOCRPageResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => IOCRPageResult): Self = this.set("Item", js.Any.fromFunction1(value))
  }
}
