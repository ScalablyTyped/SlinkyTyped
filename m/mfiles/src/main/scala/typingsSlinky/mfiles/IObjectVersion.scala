...
object IObjectVersion {
  ...
  implicit class IObjectVersionOps[Self <: IObjectVersion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessedByMeUtc(value: js.Date): Self = this.set("AccessedByMeUtc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCheckedOutAtUtc(value: js.Date): Self = this.set("CheckedOutAtUtc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCreatedUtc(value: js.Date): Self = this.set("CreatedUtc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastModifiedUtc(value: js.Date): Self = this.set("LastModifiedUtc", value.asInstanceOf[js.Any])
