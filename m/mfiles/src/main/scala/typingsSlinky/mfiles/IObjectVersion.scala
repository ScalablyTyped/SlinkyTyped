...
object IObjectVersion {
  ...
  implicit class IObjectVersionMutableBuilder[Self <: IObjectVersion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessedByMeUtc(value: js.Date): Self = StObject.set(x, "AccessedByMeUtc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCheckedOutAtUtc(value: js.Date): Self = StObject.set(x, "CheckedOutAtUtc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCreatedUtc(value: js.Date): Self = StObject.set(x, "CreatedUtc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastModifiedUtc(value: js.Date): Self = StObject.set(x, "LastModifiedUtc", value.asInstanceOf[js.Any])
