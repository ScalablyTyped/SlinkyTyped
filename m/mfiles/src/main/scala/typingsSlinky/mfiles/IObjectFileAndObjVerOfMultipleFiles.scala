...
object IObjectFileAndObjVerOfMultipleFiles {
  ...
  implicit class IObjectFileAndObjVerOfMultipleFilesOps[Self <: IObjectFileAndObjVerOfMultipleFiles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: (Double, IObjectFileAndObjVer) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Add")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withClone(value: () => IObjectFileAndObjVerOfMultipleFiles): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItem(value: Double => IObjectFileAndObjVer): Self = {
        val ret = this.duplicate
