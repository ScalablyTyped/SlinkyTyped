...
object AnonFinallyOnError {
  @scala.inline
  def apply(): AnonFinallyOnError = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFinallyOnError]
  }
  @scala.inline
  implicit class AnonFinallyOnErrorOps[Self <: AnonFinallyOnError] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnSuccess(value: /* objectVersions */ IObjectVersions => Unit): Self = {
        val ret = this.duplicate
