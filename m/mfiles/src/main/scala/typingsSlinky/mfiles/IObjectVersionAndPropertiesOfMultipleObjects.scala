...
object IObjectVersionAndPropertiesOfMultipleObjects {
  ...
  implicit class IObjectVersionAndPropertiesOfMultipleObjectsOps[Self <: IObjectVersionAndPropertiesOfMultipleObjects] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: (Double, IObjectVersionAndProperties) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Add")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withClone(value: () => IObjectVersionAndPropertiesOfMultipleObjects): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItem(value: Double => IObjectVersionAndProperties): Self = {
        val ret = this.duplicate
