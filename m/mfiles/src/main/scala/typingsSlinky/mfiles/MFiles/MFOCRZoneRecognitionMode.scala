...
*/
trait MFOCRZoneRecognitionMode extends js.Object

object MFOCRZoneRecognitionMode {
  @scala.inline
  def AutoDetectZones: `2` = this.cast(2)
  @scala.inline
  def NoZoneRecognition: `0` = this.cast(0)
  @scala.inline
  def RecognizeSpecifiedZones: `1` = this.cast(1)
  @scala.inline
