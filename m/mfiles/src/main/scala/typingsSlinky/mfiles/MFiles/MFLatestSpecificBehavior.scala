...
*/
trait MFLatestSpecificBehavior extends js.Object
object MFLatestSpecificBehavior {
  
  @scala.inline
  def Automatic: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def Latest: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def Normal: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def Specific: `1` = 1.asInstanceOf[`1`]
}
