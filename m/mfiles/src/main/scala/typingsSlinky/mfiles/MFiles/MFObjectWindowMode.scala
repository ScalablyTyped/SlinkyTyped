...
*/
trait MFObjectWindowMode extends js.Object

object MFObjectWindowMode {
  @scala.inline
  def Edit: `3` = this.cast(3)
  @scala.inline
  def EditApplicationModal: `4` = this.cast(4)
  @scala.inline
  def Insert: `0` = this.cast(0)
  @scala.inline
  def InsertSaveAsType: `2` = this.cast(2)
  @scala.inline
  def InsertSourceFiles: `1` = this.cast(1)
  @scala.inline
