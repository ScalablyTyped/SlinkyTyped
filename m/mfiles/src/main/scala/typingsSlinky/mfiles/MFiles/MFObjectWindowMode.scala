...
object MFObjectWindowMode {
  ...
  @scala.inline
  def EditApplicationModal: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def Insert: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def InsertSaveAsType: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def InsertSourceFiles: `1` = 1.asInstanceOf[`1`]
}
