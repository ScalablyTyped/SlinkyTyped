...
object MFFileValueType {
  ...
  @scala.inline
  def ChangeTime: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def CreationTime: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def FileID: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def FileName: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def FileSize: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def HasFiles: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def LinkedToExtLoc: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def LinkedToExtLocID: `7` = 7.asInstanceOf[`7`]
}
