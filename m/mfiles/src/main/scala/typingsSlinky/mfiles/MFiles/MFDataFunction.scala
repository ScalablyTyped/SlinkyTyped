...
*/
trait MFDataFunction extends js.Object

object MFDataFunction {
  @scala.inline
  def Date: `4` = this.cast(4)
  @scala.inline
  def DaysFrom: `5` = this.cast(5)
  @scala.inline
  def DaysTo: `6` = this.cast(6)
  @scala.inline
  def InitialCharGroup: `9` = this.cast(9)
  @scala.inline
  def IntegerSegment: `7` = this.cast(7)
  @scala.inline
  def LeftChars: `8` = this.cast(8)
  @scala.inline
  def Month: `2` = this.cast(2)
  @scala.inline
  def NoOp: `0` = this.cast(0)
  @scala.inline
  def Year: `1` = this.cast(1)
  @scala.inline
  def YearAndMonth: `3` = this.cast(3)
  @scala.inline
