...
object ISetPropertiesParamsOfMultipleObjects {
  ...
  implicit class ISetPropertiesParamsOfMultipleObjectsOps[Self <: ISetPropertiesParamsOfMultipleObjects] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: (Double, ISetPropertiesParams) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Add")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withClone(value: () => ISetPropertiesParamsOfMultipleObjects): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItem(value: Double => ISetPropertiesParams): Self = {
        val ret = this.duplicate
