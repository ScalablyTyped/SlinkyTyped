...
object ActivityType {
  ...
  implicit class ActivityTypeOps[Self <: ActivityType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivityTypeVarargs(value: Double*): Self = this.set("activityType", js.Array(value :_*))
    
    @scala.inline
    def setActivityType(value: Double | js.Array[Double]): Self = this.set("activityType", value.asInstanceOf[js.Any])
