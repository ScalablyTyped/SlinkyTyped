...
object DataTypeName {
  ...
  @scala.inline
  implicit class DataTypeNameMutableBuilder[Self <: DataTypeName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataTypeName(value: String | js.Array[String]): Self = StObject.set(x, "dataTypeName", value.asInstanceOf[js.Any])
