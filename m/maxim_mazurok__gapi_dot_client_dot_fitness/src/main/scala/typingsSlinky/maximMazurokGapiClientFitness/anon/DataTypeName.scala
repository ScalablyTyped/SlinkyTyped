package typingsSlinky.maximMazurokGapiClientFitness.anon
...
@js.native
trait DataTypeName extends js.Object {
  ...
  var dataTypeName: js.UndefOr[String | js.Array[String]] = js.native
...
object DataTypeName {
  ...
  @scala.inline
  def apply(userId: String): DataTypeName = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataTypeName]
  }
  
  @scala.inline
  implicit class DataTypeNameOps[Self <: DataTypeName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataTypeName(value: String | js.Array[String]): Self = this.set("dataTypeName", value.asInstanceOf[js.Any])
