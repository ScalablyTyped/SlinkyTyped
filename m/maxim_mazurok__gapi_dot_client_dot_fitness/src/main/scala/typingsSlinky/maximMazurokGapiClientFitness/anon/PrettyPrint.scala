...
import typingsSlinky.maximMazurokGapiClientFitness.gapi.client.fitness.DataSource
...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: DataSource = js.native
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(dataSourceId: String, resource: DataSource, userId: String): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DataSource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
