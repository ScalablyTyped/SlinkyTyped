...
import typingsSlinky.atMaterialDrawer.atMaterialDrawerStrings.`MDCDrawer:closed`
import typingsSlinky.atMaterialDrawer.atMaterialDrawerStrings.`MDCDrawer:opened`
