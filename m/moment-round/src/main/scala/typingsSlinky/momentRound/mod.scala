package typingsSlinky.momentRound
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    trait Moment extends StObject {
      ...
      def ceil(precision: Double, key: String): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
      
      def floor(precision: Double, key: String): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
      
      def round(precision: Double, key: String): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
      @JSName("round")
      def round_ceil(precision: Double, key: String, direction: ceil): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
      @JSName("round")
      def round_floor(precision: Double, key: String, direction: floor): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
      @JSName("round")
      def round_round(precision: Double, key: String, direction: round): typingsSlinky.momentRound.mod.momentAugmentingMod.Moment = js.native
    }
  }
}
