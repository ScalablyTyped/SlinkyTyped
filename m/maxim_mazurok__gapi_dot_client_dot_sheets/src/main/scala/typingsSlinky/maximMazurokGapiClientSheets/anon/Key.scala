...
object Key {
  ...
  @scala.inline
  def apply(sheetId: Double, spreadsheetId: String): Key = {
    val __obj = js.Dynamic.literal(sheetId = sheetId.asInstanceOf[js.Any], spreadsheetId = spreadsheetId.asInstanceOf[js.Any])
