...
import typingsSlinky.materialNotchedOutline.mod.MDCNotchedOutline
import typingsSlinky.materialRipple.mod.MDCRipple
import typingsSlinky.materialRipple.mod.MDCRippleFoundation
...
import typingsSlinky.materialTextfield.foundationMod.default
...
object mod extends js.Object {
  @js.native
  class MDCTextField ()
    extends typingsSlinky.materialBase.componentMod.default[MDCTextFieldAdapter, default] {
    ...
    def initialize(
      ...
      helperTextFactory: js.UndefOr[
          js.Function1[
            /* el */ Element, 
            typingsSlinky.materialTextfield.helperTextMod.MDCTextFieldHelperText
          ]
        ],
      iconFactory: js.UndefOr[
          js.Function1[/* el */ Element, typingsSlinky.materialTextfield.iconMod.MDCTextFieldIcon]
        ],
  ...
  class MDCTextFieldHelperText ()
    extends typingsSlinky.materialTextfield.helperTextMod.MDCTextFieldHelperText
  
  @js.native
  class MDCTextFieldHelperTextFoundation ()
    extends typingsSlinky.materialTextfield.helperTextMod.MDCTextFieldHelperTextFoundation
  
  @js.native
  class MDCTextFieldIcon ()
    extends typingsSlinky.materialTextfield.iconMod.MDCTextFieldIcon
  
  @js.native
  class MDCTextFieldIconFoundation ()
    extends typingsSlinky.materialTextfield.iconMod.MDCTextFieldIconFoundation
