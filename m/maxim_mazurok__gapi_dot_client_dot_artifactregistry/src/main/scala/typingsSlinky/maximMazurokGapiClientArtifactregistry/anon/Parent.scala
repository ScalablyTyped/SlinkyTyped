package typingsSlinky.maximMazurokGapiClientArtifactregistry.anon

import typingsSlinky.maximMazurokGapiClientArtifactregistry.gapi.client.artifactregistry.Repository
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: Repository = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: Repository): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Repository): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
