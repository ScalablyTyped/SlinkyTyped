...
object Product {
  ...
  implicit class ProductOps[Self <: Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDestinationStatusesVarargs(value: DestinationStatus*): Self = this.set("destinationStatuses", js.Array(value :_*))
    
    @scala.inline
    def setDestinationStatuses(value: js.Array[DestinationStatus]): Self = this.set("destinationStatuses", value.asInstanceOf[js.Any])
