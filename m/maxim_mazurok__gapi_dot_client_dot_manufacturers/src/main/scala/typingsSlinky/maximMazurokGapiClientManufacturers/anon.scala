...
import typingsSlinky.maximMazurokGapiClientManufacturers.gapi.client.manufacturers.Attributes
...
object anon {
  ...
  object Fields {
    ...
    implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: Attributes): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
