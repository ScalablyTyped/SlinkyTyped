...
@js.native
trait GcsPath extends StObject {
...
object GcsPath {
  ...
  @scala.inline
  def apply(location: String, projectId: String): GcsPath = {
    val __obj = js.Dynamic.literal(location = location.asInstanceOf[js.Any], projectId = projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GcsPath]
  }
  
  @scala.inline
  implicit class GcsPathMutableBuilder[Self <: GcsPath] (val x: Self) extends AnyVal {
