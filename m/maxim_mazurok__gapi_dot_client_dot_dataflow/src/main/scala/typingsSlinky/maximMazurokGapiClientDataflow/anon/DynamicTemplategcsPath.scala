...
@js.native
trait DynamicTemplategcsPath extends js.Object {
...
object DynamicTemplategcsPath {
  ...
  @scala.inline
  def apply(location: String, projectId: String, resource: LaunchTemplateParameters): DynamicTemplategcsPath = {
  ...
  @scala.inline
  implicit class DynamicTemplategcsPathOps[Self <: DynamicTemplategcsPath] (val x: Self) extends AnyVal {
