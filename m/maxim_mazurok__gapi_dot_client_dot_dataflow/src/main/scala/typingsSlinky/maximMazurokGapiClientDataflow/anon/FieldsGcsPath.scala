...
@js.native
trait FieldsGcsPath extends StObject {
...
object FieldsGcsPath {
  
  @scala.inline
  def apply(projectId: String): FieldsGcsPath = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsGcsPath]
  }
  
  @scala.inline
  implicit class FieldsGcsPathMutableBuilder[Self <: FieldsGcsPath] (val x: Self) extends AnyVal {
