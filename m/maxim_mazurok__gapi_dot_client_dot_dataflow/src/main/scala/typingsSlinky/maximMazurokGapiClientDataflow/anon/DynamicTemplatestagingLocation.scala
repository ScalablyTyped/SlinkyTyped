...
@js.native
trait DynamicTemplatestagingLocation extends StObject {
...
object DynamicTemplatestagingLocation {
  
  @scala.inline
  def apply(location: String, projectId: String): DynamicTemplatestagingLocation = {
  ...
  @scala.inline
  implicit class DynamicTemplatestagingLocationMutableBuilder[Self <: DynamicTemplatestagingLocation] (val x: Self) extends AnyVal {
