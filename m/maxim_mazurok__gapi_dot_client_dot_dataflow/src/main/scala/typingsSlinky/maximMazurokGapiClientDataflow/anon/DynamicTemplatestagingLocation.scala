...
@js.native
trait DynamicTemplatestagingLocation extends js.Object {
...
object DynamicTemplatestagingLocation {
  ...
  @scala.inline
  implicit class DynamicTemplatestagingLocationOps[Self <: DynamicTemplatestagingLocation] (val x: Self) extends AnyVal {
