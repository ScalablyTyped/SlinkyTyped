...
@js.native
trait KeyLocation extends js.Object {
...
object KeyLocation {
  ...
  @scala.inline
  def apply(location: String, projectId: String): KeyLocation = {
  ...
  @scala.inline
  implicit class KeyLocationOps[Self <: KeyLocation] (val x: Self) extends AnyVal {
