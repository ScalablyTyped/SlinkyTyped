...
@js.native
trait CallbackDynamicTemplategcsPath extends StObject {
...
object CallbackDynamicTemplategcsPath {
  
  @scala.inline
  def apply(projectId: String): CallbackDynamicTemplategcsPath = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackDynamicTemplategcsPath]
  }
  
  @scala.inline
  implicit class CallbackDynamicTemplategcsPathMutableBuilder[Self <: CallbackDynamicTemplategcsPath] (val x: Self) extends AnyVal {
