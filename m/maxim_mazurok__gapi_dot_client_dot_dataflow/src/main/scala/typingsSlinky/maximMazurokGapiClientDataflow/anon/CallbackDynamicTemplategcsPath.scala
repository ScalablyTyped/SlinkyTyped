...
@js.native
trait CallbackDynamicTemplategcsPath extends js.Object {
...
object CallbackDynamicTemplategcsPath {
  ...
  @scala.inline
  implicit class CallbackDynamicTemplategcsPathOps[Self <: CallbackDynamicTemplategcsPath] (val x: Self) extends AnyVal {
