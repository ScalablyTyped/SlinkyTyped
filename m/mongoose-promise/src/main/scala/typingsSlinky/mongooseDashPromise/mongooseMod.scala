package typingsSlinky.mongooseDashPromise

import typingsSlinky.mongooseDashPromise.mongooseMod.MongoosePromise
import typingsSlinky.mpromise.mpromiseMod.^
