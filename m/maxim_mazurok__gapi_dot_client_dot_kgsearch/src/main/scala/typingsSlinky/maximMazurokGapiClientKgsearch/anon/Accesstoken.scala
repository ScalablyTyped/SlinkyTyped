package typingsSlinky.maximMazurokGapiClientKgsearch.anon
...
object Accesstoken {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLanguages(value: String | js.Array[String]): Self = this.set("languages", value.asInstanceOf[js.Any])
