package typingsSlinky.maximMazurokGapiClientTranslate.anon

import typingsSlinky.maximMazurokGapiClientTranslate.gapi.client.translate.BatchTranslateTextRequest
...
trait Oauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: BatchTranslateTextRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: BatchTranslateTextRequest): Oauthtoken = {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BatchTranslateTextRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
