...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectableFooterHTMLElement(value: HTMLElement): Self = this.set("selectableFooter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectableHeaderHTMLElement(value: HTMLElement): Self = this.set("selectableHeader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectionFooterHTMLElement(value: HTMLElement): Self = this.set("selectionFooter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectionHeaderHTMLElement(value: HTMLElement): Self = this.set("selectionHeader", value.asInstanceOf[js.Any])
