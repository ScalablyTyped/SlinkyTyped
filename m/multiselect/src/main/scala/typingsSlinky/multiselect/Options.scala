...
object Options {
  ...
  implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectableFooterHTMLElement(value: HTMLElement): Self = StObject.set(x, "selectableFooter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectableHeaderHTMLElement(value: HTMLElement): Self = StObject.set(x, "selectableHeader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectionFooterHTMLElement(value: HTMLElement): Self = StObject.set(x, "selectionFooter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectionHeaderHTMLElement(value: HTMLElement): Self = StObject.set(x, "selectionHeader", value.asInstanceOf[js.Any])
