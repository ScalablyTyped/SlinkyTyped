...
@js.native
trait ConnectorName extends js.Object {
...
object ConnectorName {
  ...
  @scala.inline
  def apply(name: String): ConnectorName = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ConnectorName]
  }
  
  @scala.inline
  implicit class ConnectorNameOps[Self <: ConnectorName] (val x: Self) extends AnyVal {
