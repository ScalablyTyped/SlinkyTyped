...
@js.native
trait ResetSearchApplicationRequest extends js.Object {
...
object ResetSearchApplicationRequest {
  ...
  @scala.inline
  implicit class ResetSearchApplicationRequestOps[Self <: ResetSearchApplicationRequest] (val x: Self) extends AnyVal {
