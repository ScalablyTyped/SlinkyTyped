...
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Brief
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Callback
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.ConnectorName
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.DebugOptionsenableDebugging
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Fields
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.GroupResourceName
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Key
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Oauthtoken
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.PrettyPrint
import typingsSlinky.maximMazurokGapiClientCloudsearch.anon.QuotaUser
...
trait ItemsResource extends js.Object {
  ...
  /**
    ...
    */
  def deleteQueueItems(request: typingsSlinky.maximMazurokGapiClientCloudsearch.anon.Name): Request[Operation] = js.native
