...
@js.native
trait SearchItemsByViewUrlResponse extends js.Object {
...
object SearchItemsByViewUrlResponse {
  ...
  @scala.inline
  implicit class SearchItemsByViewUrlResponseOps[Self <: SearchItemsByViewUrlResponse] (val x: Self) extends AnyVal {
