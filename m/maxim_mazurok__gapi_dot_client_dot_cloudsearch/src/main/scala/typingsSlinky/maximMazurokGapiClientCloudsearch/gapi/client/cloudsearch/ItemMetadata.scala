...
object ItemMetadata {
  ...
  implicit class ItemMetadataOps[Self <: ItemMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInteractions(value: js.Array[Interaction]): Self = this.set("interactions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSearchQualityMetadata(value: SearchQualityMetadata): Self = this.set("searchQualityMetadata", value.asInstanceOf[js.Any])
