package typingsSlinky.maximMazurokGapiClientSmartdevicemanagement
  ...
  object client {
    ...
    object smartdevicemanagement {
      ...
      trait GoogleHomeEnterpriseSdmV1Device extends StObject {
        ...
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientSmartdevicemanagement.maximMazurokGapiClientSmartdevicemanagementStrings.GoogleHomeEnterpriseSdmV1Device with TopLevel[js.Any]
              ] = js.native
      ...
      trait GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest extends StObject {
        ...
        var params: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientSmartdevicemanagement.maximMazurokGapiClientSmartdevicemanagementStrings.GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest with TopLevel[js.Any]
              ] = js.native
      }
      ...
      trait GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse extends StObject {
        ...
        var results: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientSmartdevicemanagement.maximMazurokGapiClientSmartdevicemanagementStrings.GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse with TopLevel[js.Any]
              ] = js.native
      }
      ...
      trait GoogleHomeEnterpriseSdmV1Room extends StObject {
        ...
        var traits: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientSmartdevicemanagement.maximMazurokGapiClientSmartdevicemanagementStrings.GoogleHomeEnterpriseSdmV1Room with TopLevel[js.Any]
              ] = js.native
      }
      ...
      trait GoogleHomeEnterpriseSdmV1Structure extends StObject {
        ...
        var traits: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientSmartdevicemanagement.maximMazurokGapiClientSmartdevicemanagementStrings.GoogleHomeEnterpriseSdmV1Structure with TopLevel[js.Any]
              ] = js.native
      }
