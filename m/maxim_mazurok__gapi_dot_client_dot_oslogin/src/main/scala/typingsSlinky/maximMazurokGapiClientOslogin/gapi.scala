...
import typingsSlinky.maximMazurokGapiClientOslogin.anon.Fields
import typingsSlinky.maximMazurokGapiClientOslogin.anon.Key
import typingsSlinky.maximMazurokGapiClientOslogin.anon.Oauthtoken
    ...
    object oslogin {
      ...
      trait LoginProfile extends StObject {
        ...
        {[ P in string ]: @maxim_mazurok/gapi.client.oslogin.gapi.client.oslogin.SshPublicKey}
          */ typingsSlinky.maximMazurokGapiClientOslogin.maximMazurokGapiClientOsloginStrings.LoginProfile with TopLevel[js.Any]
              ] = js.native
      }
      object LoginProfile {
