...
@js.native
trait MetricsFilterdeploymentId extends StObject {
...
object MetricsFilterdeploymentId {
  
  @scala.inline
  def apply(scriptId: String): MetricsFilterdeploymentId = {
    val __obj = js.Dynamic.literal(scriptId = scriptId.asInstanceOf[js.Any])
    __obj.asInstanceOf[MetricsFilterdeploymentId]
  }
  
  @scala.inline
  implicit class MetricsFilterdeploymentIdMutableBuilder[Self <: MetricsFilterdeploymentId] (val x: Self) extends AnyVal {
