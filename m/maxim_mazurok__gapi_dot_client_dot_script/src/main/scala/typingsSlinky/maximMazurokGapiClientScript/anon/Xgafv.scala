...
import typingsSlinky.maximMazurokGapiClientScript.gapi.client.script.ExecutionRequest
...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: ExecutionRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(resource: ExecutionRequest, scriptId: String): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ExecutionRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
