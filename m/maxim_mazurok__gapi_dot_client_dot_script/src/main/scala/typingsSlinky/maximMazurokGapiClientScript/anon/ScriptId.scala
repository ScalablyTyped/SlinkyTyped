...
@js.native
trait ScriptId extends StObject {
...
object ScriptId {
  ...
  @scala.inline
  def apply(scriptId: String): ScriptId = {
    val __obj = js.Dynamic.literal(scriptId = scriptId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ScriptId]
  }
  
  @scala.inline
  implicit class ScriptIdMutableBuilder[Self <: ScriptId] (val x: Self) extends AnyVal {
