...
object atMaterialListMod extends js.Object {
  ...
  class MDCList protected () extends js.Object {
    ...
    def getDefaultFoundation(): typingsSlinky.atMaterialList.foundationMod.MDCListFoundation = js.native
  ...
  class MDCListFoundation protected ()
    extends typingsSlinky.atMaterialList.foundationMod.MDCListFoundation {
