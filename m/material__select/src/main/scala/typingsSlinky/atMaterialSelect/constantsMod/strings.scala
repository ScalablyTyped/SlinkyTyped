package typingsSlinky.atMaterialSelect.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atMaterialBase.foundationMod.MDCStrings
import typingsSlinky.atMaterialSelect.atMaterialSelectStrings.MDCSelectColonchange
import typingsSlinky.atMaterialSelect.atMaterialSelectStrings.`Dotmdc-floating-label`
import typingsSlinky.atMaterialSelect.atMaterialSelectStrings.`Dotmdc-line-ripple`
import typingsSlinky.atMaterialSelect.atMaterialSelectStrings.`Dotmdc-select__native-control`
