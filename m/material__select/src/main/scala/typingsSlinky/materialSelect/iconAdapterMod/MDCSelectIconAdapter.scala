package typingsSlinky.materialSelect.iconAdapterMod
...
@js.native
trait MDCSelectIconAdapter extends js.Object {
...
object MDCSelectIconAdapter {
  ...
  @scala.inline
  implicit class MDCSelectIconAdapterOps[Self <: MDCSelectIconAdapter] (val x: Self) extends AnyVal {
