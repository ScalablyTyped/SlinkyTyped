package typingsSlinky.msDashRestDashAzure.libSubscriptionManagementSubscriptionClientMod

import typingsSlinky.msDashRest.msDashRestMod.ServiceClientCredentials
import typingsSlinky.msDashRest.msDashRestMod.ServiceClientOptions
import typingsSlinky.msDashRestDashAzure.libSubscriptionManagementOperationsMod.Subscriptions
import typingsSlinky.msDashRestDashAzure.libSubscriptionManagementOperationsMod.Tenants
