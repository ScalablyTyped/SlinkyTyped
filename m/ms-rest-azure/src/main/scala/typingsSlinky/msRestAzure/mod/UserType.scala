...
object UserType extends StObject {
  ...
  /* 1 */ val servicePrincipal: typingsSlinky.msRestAzure.mod.UserType.servicePrincipal with Double = js.native
  
  @js.native
  sealed trait user extends UserType
  /* 0 */ val user: typingsSlinky.msRestAzure.mod.UserType.user with Double = js.native
}
