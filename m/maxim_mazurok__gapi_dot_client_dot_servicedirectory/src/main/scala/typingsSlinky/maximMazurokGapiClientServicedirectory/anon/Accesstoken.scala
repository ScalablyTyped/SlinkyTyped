package typingsSlinky.maximMazurokGapiClientServicedirectory.anon

import typingsSlinky.maximMazurokGapiClientServicedirectory.gapi.client.servicedirectory.Endpoint
...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: Endpoint = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(parent: String, resource: Endpoint): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Endpoint): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
