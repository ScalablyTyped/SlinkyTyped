...
@js.native
trait InstanceGroupManagerAutoHealingPolicy extends js.Object {
...
object InstanceGroupManagerAutoHealingPolicy {
  ...
  @scala.inline
  implicit class InstanceGroupManagerAutoHealingPolicyOps[Self <: InstanceGroupManagerAutoHealingPolicy] (val x: Self) extends AnyVal {
