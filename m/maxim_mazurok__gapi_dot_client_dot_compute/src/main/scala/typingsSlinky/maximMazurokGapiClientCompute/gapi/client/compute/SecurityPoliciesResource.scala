...
import typingsSlinky.maximMazurokGapiClientCompute.anon.AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId
...
import typingsSlinky.maximMazurokGapiClientCompute.anon.PrettyPrintPriority
import typingsSlinky.maximMazurokGapiClientCompute.anon.Priority
...
trait SecurityPoliciesResource extends StObject {
  ...
  def addRule(request: typingsSlinky.maximMazurokGapiClientCompute.anon.SecurityPolicy): Request[Operation] = js.native
