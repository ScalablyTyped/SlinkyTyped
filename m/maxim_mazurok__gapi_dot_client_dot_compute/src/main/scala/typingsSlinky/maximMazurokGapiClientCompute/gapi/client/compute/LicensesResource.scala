...
import typingsSlinky.maximMazurokGapiClientCompute.anon.KeyLicense
...
import typingsSlinky.maximMazurokGapiClientCompute.anon.ProjectQuotaUserRequestIdResourceUserIp
...
trait LicensesResource extends js.Object {
  ...
  def delete(request: typingsSlinky.maximMazurokGapiClientCompute.anon.License): Request[Operation] = js.native
