...
@js.native
trait InterconnectAttachmentAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InterconnectAttachmentsScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.InterconnectAttachmentAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object InterconnectAttachmentAggregatedList {
  
  @scala.inline
  def apply(): InterconnectAttachmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InterconnectAttachmentAggregatedList]
  }
  
  @scala.inline
  implicit class InterconnectAttachmentAggregatedListMutableBuilder[Self <: InterconnectAttachmentAggregatedList] (val x: Self) extends AnyVal {
