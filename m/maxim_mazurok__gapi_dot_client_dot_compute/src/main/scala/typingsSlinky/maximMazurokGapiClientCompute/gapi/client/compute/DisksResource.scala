...
import typingsSlinky.maximMazurokGapiClientCompute.anon.AltDisk
import typingsSlinky.maximMazurokGapiClientCompute.anon.AltFieldsKey
import typingsSlinky.maximMazurokGapiClientCompute.anon.DiskFields
import typingsSlinky.maximMazurokGapiClientCompute.anon.Fields
import typingsSlinky.maximMazurokGapiClientCompute.anon.GuestFlush
...
import typingsSlinky.maximMazurokGapiClientCompute.anon.QuotaUserUserIp
import typingsSlinky.maximMazurokGapiClientCompute.anon.RequestIdSourceImage
import typingsSlinky.maximMazurokGapiClientCompute.anon.ResourceUserIp
import typingsSlinky.maximMazurokGapiClientCompute.anon.SourceImage
import typingsSlinky.maximMazurokGapiClientCompute.anon.UserIpZone
...
trait DisksResource extends StObject {
  ...
  def addResourcePolicies(request: typingsSlinky.maximMazurokGapiClientCompute.anon.Disk): Request[Operation] = js.native
