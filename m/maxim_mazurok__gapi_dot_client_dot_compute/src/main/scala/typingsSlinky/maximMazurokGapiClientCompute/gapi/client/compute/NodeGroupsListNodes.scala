...
object NodeGroupsListNodes {
  ...
  @scala.inline
  implicit class NodeGroupsListNodesMutableBuilder[Self <: NodeGroupsListNodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[NodeGroupNode]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: NodeGroupNode*): Self = StObject.set(x, "items", js.Array(value :_*))
