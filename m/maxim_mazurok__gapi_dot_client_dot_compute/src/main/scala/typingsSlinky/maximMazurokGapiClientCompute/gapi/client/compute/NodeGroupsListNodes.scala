...
@js.native
trait NodeGroupsListNodes extends js.Object {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of Node resources. */
  var items: js.UndefOr[js.Array[NodeGroupNode]] = js.native
...
object NodeGroupsListNodes {
  ...
  @scala.inline
  def apply(): NodeGroupsListNodes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupsListNodes]
  }
  
  @scala.inline
  implicit class NodeGroupsListNodesOps[Self <: NodeGroupsListNodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NodeGroupNode*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NodeGroupNode]): Self = this.set("items", value.asInstanceOf[js.Any])
