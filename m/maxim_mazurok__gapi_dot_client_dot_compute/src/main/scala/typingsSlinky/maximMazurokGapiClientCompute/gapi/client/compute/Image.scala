...
import typingsSlinky.maximMazurokGapiClientCompute.anon.ContainerType
...
trait Image extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.Image with TopLevel[js.Any]
  ] = js.native
