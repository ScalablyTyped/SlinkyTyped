...
@js.native
trait NodeGroupAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeGroupsScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.NodeGroupAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object NodeGroupAggregatedList {
  
  @scala.inline
  def apply(): NodeGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupAggregatedList]
  }
  
  @scala.inline
  implicit class NodeGroupAggregatedListMutableBuilder[Self <: NodeGroupAggregatedList] (val x: Self) extends AnyVal {
