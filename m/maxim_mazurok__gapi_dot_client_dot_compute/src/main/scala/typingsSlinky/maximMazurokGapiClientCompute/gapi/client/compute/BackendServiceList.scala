...
@js.native
trait BackendServiceList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of BackendService resources. */
  var items: js.UndefOr[js.Array[BackendService]] = js.native
...
object BackendServiceList {
  ...
  @scala.inline
  def apply(): BackendServiceList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackendServiceList]
  }
  
  @scala.inline
  implicit class BackendServiceListMutableBuilder[Self <: BackendServiceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[BackendService]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: BackendService*): Self = StObject.set(x, "items", js.Array(value :_*))
