...
object BackendServiceList {
  ...
  @scala.inline
  implicit class BackendServiceListOps[Self <: BackendServiceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: BackendService*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[BackendService]): Self = this.set("items", value.asInstanceOf[js.Any])
