...
@js.native
trait RegionInstanceGroupManagersApplyUpdatesRequest extends StObject {
...
object RegionInstanceGroupManagersApplyUpdatesRequest {
  ...
  @scala.inline
  implicit class RegionInstanceGroupManagersApplyUpdatesRequestMutableBuilder[Self <: RegionInstanceGroupManagersApplyUpdatesRequest] (val x: Self) extends AnyVal {
