...
@js.native
trait HttpHealthCheckList extends js.Object {
...
object HttpHealthCheckList {
  ...
  @scala.inline
  implicit class HttpHealthCheckListOps[Self <: HttpHealthCheckList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: HttpHealthCheck*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[HttpHealthCheck]): Self = this.set("items", value.asInstanceOf[js.Any])
