...
object VpnGateway {
  ...
  implicit class VpnGatewayOps[Self <: VpnGateway] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVpnInterfacesVarargs(value: VpnGatewayVpnGatewayInterface*): Self = this.set("vpnInterfaces", js.Array(value :_*))
    
    @scala.inline
    def setVpnInterfaces(value: js.Array[VpnGatewayVpnGatewayInterface]): Self = this.set("vpnInterfaces", value.asInstanceOf[js.Any])
