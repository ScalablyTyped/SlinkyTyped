...
@js.native
trait RegionInstanceGroupManagersListErrorsResponse extends js.Object {
...
object RegionInstanceGroupManagersListErrorsResponse {
  ...
  @scala.inline
  implicit class RegionInstanceGroupManagersListErrorsResponseOps[Self <: RegionInstanceGroupManagersListErrorsResponse] (val x: Self) extends AnyVal {
