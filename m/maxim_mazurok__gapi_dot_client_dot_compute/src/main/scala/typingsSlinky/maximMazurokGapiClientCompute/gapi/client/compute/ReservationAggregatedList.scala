...
@js.native
trait ReservationAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.ReservationsScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.ReservationAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object ReservationAggregatedList {
  
  @scala.inline
  def apply(): ReservationAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReservationAggregatedList]
  }
  
  @scala.inline
  implicit class ReservationAggregatedListMutableBuilder[Self <: ReservationAggregatedList] (val x: Self) extends AnyVal {
