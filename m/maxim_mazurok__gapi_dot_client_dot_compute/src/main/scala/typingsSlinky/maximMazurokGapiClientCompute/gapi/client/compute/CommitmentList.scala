...
object CommitmentList {
  ...
  @scala.inline
  implicit class CommitmentListMutableBuilder[Self <: CommitmentList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Commitment]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Commitment*): Self = StObject.set(x, "items", js.Array(value :_*))
