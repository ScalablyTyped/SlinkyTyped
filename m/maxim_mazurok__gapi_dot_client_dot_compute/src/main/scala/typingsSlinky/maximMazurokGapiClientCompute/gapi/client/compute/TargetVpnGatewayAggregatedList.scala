...
@js.native
trait TargetVpnGatewayAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetVpnGatewaysScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.TargetVpnGatewayAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object TargetVpnGatewayAggregatedList {
  ...
  @scala.inline
  implicit class TargetVpnGatewayAggregatedListMutableBuilder[Self <: TargetVpnGatewayAggregatedList] (val x: Self) extends AnyVal {
