...
object SecurityPolicy {
  ...
  @scala.inline
  implicit class SecurityPolicyMutableBuilder[Self <: SecurityPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRules(value: js.Array[SecurityPolicyRule]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
    
    @scala.inline
    def setRulesVarargs(value: SecurityPolicyRule*): Self = StObject.set(x, "rules", js.Array(value :_*))
