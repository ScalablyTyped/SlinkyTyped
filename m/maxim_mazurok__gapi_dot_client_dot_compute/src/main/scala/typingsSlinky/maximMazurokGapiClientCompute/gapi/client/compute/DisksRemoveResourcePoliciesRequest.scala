...
@js.native
trait DisksRemoveResourcePoliciesRequest extends js.Object {
...
object DisksRemoveResourcePoliciesRequest {
  ...
  @scala.inline
  implicit class DisksRemoveResourcePoliciesRequestOps[Self <: DisksRemoveResourcePoliciesRequest] (val x: Self) extends AnyVal {
