...
trait DiskTypeAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DiskTypesScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.DiskTypeAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object DiskTypeAggregatedList {
  ...
  @scala.inline
  implicit class DiskTypeAggregatedListMutableBuilder[Self <: DiskTypeAggregatedList] (val x: Self) extends AnyVal {
