...
@js.native
trait VpnGatewayAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnGatewaysScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.VpnGatewayAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object VpnGatewayAggregatedList {
  
  @scala.inline
  def apply(): VpnGatewayAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VpnGatewayAggregatedList]
  }
  
  @scala.inline
  implicit class VpnGatewayAggregatedListMutableBuilder[Self <: VpnGatewayAggregatedList] (val x: Self) extends AnyVal {
