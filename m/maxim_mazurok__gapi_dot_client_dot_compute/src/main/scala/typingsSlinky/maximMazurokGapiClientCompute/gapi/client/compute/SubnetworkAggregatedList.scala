...
@js.native
trait SubnetworkAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.SubnetworksScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.SubnetworkAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object SubnetworkAggregatedList {
  ...
  @scala.inline
  def apply(): SubnetworkAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SubnetworkAggregatedList]
  }
  
  @scala.inline
  implicit class SubnetworkAggregatedListMutableBuilder[Self <: SubnetworkAggregatedList] (val x: Self) extends AnyVal {
