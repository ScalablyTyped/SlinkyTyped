...
@js.native
trait ForwardingRuleAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.ForwardingRulesScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.ForwardingRuleAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object ForwardingRuleAggregatedList {
  ...
  @scala.inline
  def apply(): ForwardingRuleAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ForwardingRuleAggregatedList]
  }
  
  @scala.inline
  implicit class ForwardingRuleAggregatedListMutableBuilder[Self <: ForwardingRuleAggregatedList] (val x: Self) extends AnyVal {
