...
@js.native
trait DiskList extends js.Object {
...
object DiskList {
  ...
  @scala.inline
  implicit class DiskListOps[Self <: DiskList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Disk*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Disk]): Self = this.set("items", value.asInstanceOf[js.Any])
