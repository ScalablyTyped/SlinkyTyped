...
@js.native
trait DiskList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of Disk resources. */
  var items: js.UndefOr[js.Array[Disk]] = js.native
...
object DiskList {
  ...
  def apply(): DiskList = {
    ...
    __obj.asInstanceOf[DiskList]
  }
  
  @scala.inline
  implicit class DiskListMutableBuilder[Self <: DiskList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Disk]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Disk*): Self = StObject.set(x, "items", js.Array(value :_*))
