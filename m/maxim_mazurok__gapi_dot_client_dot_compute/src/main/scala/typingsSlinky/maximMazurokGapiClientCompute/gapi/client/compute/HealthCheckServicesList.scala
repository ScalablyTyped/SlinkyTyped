...
@js.native
trait HealthCheckServicesList extends js.Object {
...
object HealthCheckServicesList {
  ...
  @scala.inline
  implicit class HealthCheckServicesListOps[Self <: HealthCheckServicesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: HealthCheckService*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[HealthCheckService]): Self = this.set("items", value.asInstanceOf[js.Any])
