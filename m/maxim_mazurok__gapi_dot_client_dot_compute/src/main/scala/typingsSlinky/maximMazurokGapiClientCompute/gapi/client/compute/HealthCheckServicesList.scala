...
@js.native
trait HealthCheckServicesList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of HealthCheckService resources. */
  var items: js.UndefOr[js.Array[HealthCheckService]] = js.native
...
object HealthCheckServicesList {
  
  @scala.inline
  def apply(): HealthCheckServicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HealthCheckServicesList]
  }
  
  @scala.inline
  implicit class HealthCheckServicesListMutableBuilder[Self <: HealthCheckServicesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[HealthCheckService]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: HealthCheckService*): Self = StObject.set(x, "items", js.Array(value :_*))
