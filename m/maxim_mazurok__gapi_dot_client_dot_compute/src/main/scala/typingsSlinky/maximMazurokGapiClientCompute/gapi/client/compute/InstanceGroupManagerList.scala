...
@js.native
trait InstanceGroupManagerList extends StObject {
...
object InstanceGroupManagerList {
  ...
  @scala.inline
  implicit class InstanceGroupManagerListMutableBuilder[Self <: InstanceGroupManagerList] (val x: Self) extends AnyVal {
