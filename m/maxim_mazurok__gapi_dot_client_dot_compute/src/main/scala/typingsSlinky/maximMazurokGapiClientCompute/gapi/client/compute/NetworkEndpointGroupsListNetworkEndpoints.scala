...
@js.native
trait NetworkEndpointGroupsListNetworkEndpoints extends js.Object {
...
object NetworkEndpointGroupsListNetworkEndpoints {
  ...
  @scala.inline
  implicit class NetworkEndpointGroupsListNetworkEndpointsOps[Self <: NetworkEndpointGroupsListNetworkEndpoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NetworkEndpointWithHealthStatus*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NetworkEndpointWithHealthStatus]): Self = this.set("items", value.asInstanceOf[js.Any])
