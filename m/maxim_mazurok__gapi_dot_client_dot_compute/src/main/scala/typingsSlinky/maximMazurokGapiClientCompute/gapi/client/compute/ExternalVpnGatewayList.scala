...
@js.native
trait ExternalVpnGatewayList extends StObject {
...
object ExternalVpnGatewayList {
  ...
  @scala.inline
  implicit class ExternalVpnGatewayListMutableBuilder[Self <: ExternalVpnGatewayList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[ExternalVpnGateway]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: ExternalVpnGateway*): Self = StObject.set(x, "items", js.Array(value :_*))
