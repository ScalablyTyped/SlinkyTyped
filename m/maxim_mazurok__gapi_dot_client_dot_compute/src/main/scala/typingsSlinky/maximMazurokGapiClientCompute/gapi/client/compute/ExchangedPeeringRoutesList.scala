...
@js.native
trait ExchangedPeeringRoutesList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of ExchangedPeeringRoute resources. */
  var items: js.UndefOr[js.Array[ExchangedPeeringRoute]] = js.native
...
object ExchangedPeeringRoutesList {
  
  @scala.inline
  def apply(): ExchangedPeeringRoutesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExchangedPeeringRoutesList]
  }
  
  @scala.inline
  implicit class ExchangedPeeringRoutesListMutableBuilder[Self <: ExchangedPeeringRoutesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[ExchangedPeeringRoute]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: ExchangedPeeringRoute*): Self = StObject.set(x, "items", js.Array(value :_*))
