...
@js.native
trait ExchangedPeeringRoutesList extends js.Object {
...
object ExchangedPeeringRoutesList {
  ...
  @scala.inline
  implicit class ExchangedPeeringRoutesListOps[Self <: ExchangedPeeringRoutesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: ExchangedPeeringRoute*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[ExchangedPeeringRoute]): Self = this.set("items", value.asInstanceOf[js.Any])
