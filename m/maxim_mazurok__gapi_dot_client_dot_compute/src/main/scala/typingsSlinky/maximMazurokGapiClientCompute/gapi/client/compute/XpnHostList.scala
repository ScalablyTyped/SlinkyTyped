...
object XpnHostList {
  ...
  @scala.inline
  implicit class XpnHostListOps[Self <: XpnHostList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Project*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Project]): Self = this.set("items", value.asInstanceOf[js.Any])
