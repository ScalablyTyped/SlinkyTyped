...
@js.native
trait XpnHostList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** [Output Only] A list of shared VPC host project URLs. */
  var items: js.UndefOr[js.Array[Project]] = js.native
...
object XpnHostList {
  ...
  @scala.inline
  def apply(): XpnHostList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XpnHostList]
  }
  
  @scala.inline
  implicit class XpnHostListMutableBuilder[Self <: XpnHostList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Project]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Project*): Self = StObject.set(x, "items", js.Array(value :_*))
