...
@js.native
trait TargetPoolList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of TargetPool resources. */
  var items: js.UndefOr[js.Array[TargetPool]] = js.native
...
object TargetPoolList {
  
  @scala.inline
  def apply(): TargetPoolList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetPoolList]
  }
  
  @scala.inline
  implicit class TargetPoolListMutableBuilder[Self <: TargetPoolList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[TargetPool]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: TargetPool*): Self = StObject.set(x, "items", js.Array(value :_*))
