...
@js.native
trait TargetPoolList extends js.Object {
...
object TargetPoolList {
  ...
  @scala.inline
  implicit class TargetPoolListOps[Self <: TargetPoolList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: TargetPool*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[TargetPool]): Self = this.set("items", value.asInstanceOf[js.Any])
