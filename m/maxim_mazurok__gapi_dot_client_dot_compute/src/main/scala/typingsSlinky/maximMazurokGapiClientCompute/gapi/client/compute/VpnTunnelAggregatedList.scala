...
@js.native
trait VpnTunnelAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.VpnTunnelsScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.VpnTunnelAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object VpnTunnelAggregatedList {
  ...
  @scala.inline
  implicit class VpnTunnelAggregatedListMutableBuilder[Self <: VpnTunnelAggregatedList] (val x: Self) extends AnyVal {
