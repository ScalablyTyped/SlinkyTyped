...
import typingsSlinky.maximMazurokGapiClientCompute.anon.AltFieldsInstanceGroup
import typingsSlinky.maximMazurokGapiClientCompute.anon.Fields
import typingsSlinky.maximMazurokGapiClientCompute.anon.FieldsFilter
import typingsSlinky.maximMazurokGapiClientCompute.anon.FieldsInstanceGroup
import typingsSlinky.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupKey
import typingsSlinky.maximMazurokGapiClientCompute.anon.FilterInstanceGroup
...
trait InstanceGroupsResource extends js.Object {
  ...
  /**
    ...
    * information.
    */
  def addInstances(request: typingsSlinky.maximMazurokGapiClientCompute.anon.InstanceGroup): Request[Operation] = js.native
