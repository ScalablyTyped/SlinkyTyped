...
@js.native
trait GlobalNetworkEndpointGroupsAttachEndpointsRequest extends js.Object {
...
object GlobalNetworkEndpointGroupsAttachEndpointsRequest {
  ...
  @scala.inline
  implicit class GlobalNetworkEndpointGroupsAttachEndpointsRequestOps[Self <: GlobalNetworkEndpointGroupsAttachEndpointsRequest] (val x: Self) extends AnyVal {
