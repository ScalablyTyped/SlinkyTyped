...
@js.native
trait InstanceGroupManagerAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.InstanceGroupManagersScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.InstanceGroupManagerAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object InstanceGroupManagerAggregatedList {
  ...
  @scala.inline
  def apply(): InstanceGroupManagerAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupManagerAggregatedList]
  }
  
  @scala.inline
  implicit class InstanceGroupManagerAggregatedListMutableBuilder[Self <: InstanceGroupManagerAggregatedList] (val x: Self) extends AnyVal {
