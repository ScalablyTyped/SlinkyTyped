...
object InstanceTemplateList {
  ...
  @scala.inline
  implicit class InstanceTemplateListMutableBuilder[Self <: InstanceTemplateList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[InstanceTemplate]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: InstanceTemplate*): Self = StObject.set(x, "items", js.Array(value :_*))
