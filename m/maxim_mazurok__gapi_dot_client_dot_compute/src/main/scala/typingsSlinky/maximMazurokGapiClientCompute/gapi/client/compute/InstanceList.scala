...
object InstanceList {
  ...
  @scala.inline
  implicit class InstanceListMutableBuilder[Self <: InstanceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Instance]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Instance*): Self = StObject.set(x, "items", js.Array(value :_*))
