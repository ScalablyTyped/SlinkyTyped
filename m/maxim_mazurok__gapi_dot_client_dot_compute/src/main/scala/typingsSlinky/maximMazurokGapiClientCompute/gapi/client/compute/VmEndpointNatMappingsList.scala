...
object VmEndpointNatMappingsList {
  ...
  @scala.inline
  implicit class VmEndpointNatMappingsListMutableBuilder[Self <: VmEndpointNatMappingsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResult(value: js.Array[VmEndpointNatMappings]): Self = StObject.set(x, "result", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResultUndefined: Self = StObject.set(x, "result", js.undefined)
    
    @scala.inline
    def setResultVarargs(value: VmEndpointNatMappings*): Self = StObject.set(x, "result", js.Array(value :_*))
