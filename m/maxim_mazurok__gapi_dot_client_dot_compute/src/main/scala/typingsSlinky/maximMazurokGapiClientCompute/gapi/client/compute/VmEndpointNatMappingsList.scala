...
@js.native
trait VmEndpointNatMappingsList extends js.Object {
  ...
  var result: js.UndefOr[js.Array[VmEndpointNatMappings]] = js.native
...
object VmEndpointNatMappingsList {
  ...
  @scala.inline
  def apply(): VmEndpointNatMappingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VmEndpointNatMappingsList]
  }
  
  @scala.inline
  implicit class VmEndpointNatMappingsListOps[Self <: VmEndpointNatMappingsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResultVarargs(value: VmEndpointNatMappings*): Self = this.set("result", js.Array(value :_*))
    
    @scala.inline
    def setResult(value: js.Array[VmEndpointNatMappings]): Self = this.set("result", value.asInstanceOf[js.Any])
