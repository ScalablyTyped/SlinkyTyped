...
@js.native
trait NetworkEndpointGroupList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of NetworkEndpointGroup resources. */
  var items: js.UndefOr[js.Array[NetworkEndpointGroup]] = js.native
...
object NetworkEndpointGroupList {
  
  @scala.inline
  def apply(): NetworkEndpointGroupList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NetworkEndpointGroupList]
  }
  
  @scala.inline
  implicit class NetworkEndpointGroupListMutableBuilder[Self <: NetworkEndpointGroupList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[NetworkEndpointGroup]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: NetworkEndpointGroup*): Self = StObject.set(x, "items", js.Array(value :_*))
