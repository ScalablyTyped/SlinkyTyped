...
@js.native
trait NetworkEndpointGroupList extends js.Object {
...
object NetworkEndpointGroupList {
  ...
  @scala.inline
  implicit class NetworkEndpointGroupListOps[Self <: NetworkEndpointGroupList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NetworkEndpointGroup*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NetworkEndpointGroup]): Self = this.set("items", value.asInstanceOf[js.Any])
