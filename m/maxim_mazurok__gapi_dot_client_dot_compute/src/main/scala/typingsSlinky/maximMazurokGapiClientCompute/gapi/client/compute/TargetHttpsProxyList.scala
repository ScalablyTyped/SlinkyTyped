...
object TargetHttpsProxyList {
  ...
  @scala.inline
  implicit class TargetHttpsProxyListMutableBuilder[Self <: TargetHttpsProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[TargetHttpsProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: TargetHttpsProxy*): Self = StObject.set(x, "items", js.Array(value :_*))
