...
@js.native
trait AutoscalerAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AutoscalersScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.AutoscalerAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object AutoscalerAggregatedList {
  ...
  @scala.inline
  implicit class AutoscalerAggregatedListMutableBuilder[Self <: AutoscalerAggregatedList] (val x: Self) extends AnyVal {
