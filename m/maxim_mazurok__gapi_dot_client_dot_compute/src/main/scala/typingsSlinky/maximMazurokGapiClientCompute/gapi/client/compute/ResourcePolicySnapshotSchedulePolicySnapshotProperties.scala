...
trait ResourcePolicySnapshotSchedulePolicySnapshotProperties extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.ResourcePolicySnapshotSchedulePolicySnapshotProperties with TopLevel[js.Any]
  ] = js.native
