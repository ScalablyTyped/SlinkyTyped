...
object TargetSslProxyList {
  ...
  @scala.inline
  implicit class TargetSslProxyListOps[Self <: TargetSslProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: TargetSslProxy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[TargetSslProxy]): Self = this.set("items", value.asInstanceOf[js.Any])
