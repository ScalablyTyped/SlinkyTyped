...
@js.native
trait TargetSslProxyList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of TargetSslProxy resources. */
  var items: js.UndefOr[js.Array[TargetSslProxy]] = js.native
...
object TargetSslProxyList {
  ...
  @scala.inline
  def apply(): TargetSslProxyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetSslProxyList]
  }
  
  @scala.inline
  implicit class TargetSslProxyListMutableBuilder[Self <: TargetSslProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[TargetSslProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: TargetSslProxy*): Self = StObject.set(x, "items", js.Array(value :_*))
