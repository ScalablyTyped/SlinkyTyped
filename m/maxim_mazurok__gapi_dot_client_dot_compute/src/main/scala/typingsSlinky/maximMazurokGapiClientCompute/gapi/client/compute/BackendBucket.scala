...
object BackendBucket {
  ...
  @scala.inline
  implicit class BackendBucketOps[Self <: BackendBucket] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCdnPolicy(value: BackendBucketCdnPolicy): Self = this.set("cdnPolicy", value.asInstanceOf[js.Any])
