...
object LogConfigCounterOptions {
  ...
  implicit class LogConfigCounterOptionsOps[Self <: LogConfigCounterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomFieldsVarargs(value: LogConfigCounterOptionsCustomField*): Self = this.set("customFields", js.Array(value :_*))
    
    @scala.inline
    def setCustomFields(value: js.Array[LogConfigCounterOptionsCustomField]): Self = this.set("customFields", value.asInstanceOf[js.Any])
