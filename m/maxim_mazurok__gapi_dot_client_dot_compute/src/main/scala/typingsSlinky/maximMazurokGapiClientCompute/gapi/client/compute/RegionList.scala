...
object RegionList {
  ...
  @scala.inline
  implicit class RegionListMutableBuilder[Self <: RegionList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Region]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Region*): Self = StObject.set(x, "items", js.Array(value :_*))
