...
@js.native
trait AcceleratorTypeAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.AcceleratorTypesScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.AcceleratorTypeAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object AcceleratorTypeAggregatedList {
  
  @scala.inline
  def apply(): AcceleratorTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AcceleratorTypeAggregatedList]
  }
  
  @scala.inline
  implicit class AcceleratorTypeAggregatedListMutableBuilder[Self <: AcceleratorTypeAggregatedList] (val x: Self) extends AnyVal {
