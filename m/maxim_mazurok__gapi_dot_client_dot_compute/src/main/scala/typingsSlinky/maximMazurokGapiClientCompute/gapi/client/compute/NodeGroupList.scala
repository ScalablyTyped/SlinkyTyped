...
@js.native
trait NodeGroupList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of NodeGroup resources. */
  var items: js.UndefOr[js.Array[NodeGroup]] = js.native
...
object NodeGroupList {
  ...
  @scala.inline
  def apply(): NodeGroupList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupList]
  }
  
  @scala.inline
  implicit class NodeGroupListMutableBuilder[Self <: NodeGroupList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[NodeGroup]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: NodeGroup*): Self = StObject.set(x, "items", js.Array(value :_*))
