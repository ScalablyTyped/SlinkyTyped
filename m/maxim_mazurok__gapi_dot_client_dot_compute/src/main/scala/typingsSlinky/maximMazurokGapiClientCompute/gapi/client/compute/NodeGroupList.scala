...
@js.native
trait NodeGroupList extends js.Object {
...
object NodeGroupList {
  ...
  @scala.inline
  implicit class NodeGroupListOps[Self <: NodeGroupList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NodeGroup*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NodeGroup]): Self = this.set("items", value.asInstanceOf[js.Any])
