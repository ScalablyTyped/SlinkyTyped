...
trait MachineTypeList extends StObject {
  ...
  var items: js.UndefOr[js.Array[MachineType]] = js.native
...
object MachineTypeList {
  ...
  @scala.inline
  def apply(): MachineTypeList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MachineTypeList]
  }
  
  @scala.inline
  implicit class MachineTypeListMutableBuilder[Self <: MachineTypeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[MachineType]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: MachineType*): Self = StObject.set(x, "items", js.Array(value :_*))
