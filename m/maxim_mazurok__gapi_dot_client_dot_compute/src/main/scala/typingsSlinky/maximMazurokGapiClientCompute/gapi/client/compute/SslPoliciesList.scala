...
@js.native
trait SslPoliciesList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of SslPolicy resources. */
  var items: js.UndefOr[js.Array[SslPolicy]] = js.native
...
object SslPoliciesList {
  
  @scala.inline
  def apply(): SslPoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SslPoliciesList]
  }
  
  @scala.inline
  implicit class SslPoliciesListMutableBuilder[Self <: SslPoliciesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SslPolicy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SslPolicy*): Self = StObject.set(x, "items", js.Array(value :_*))
