...
@js.native
trait SslPoliciesList extends js.Object {
...
object SslPoliciesList {
  ...
  @scala.inline
  implicit class SslPoliciesListOps[Self <: SslPoliciesList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SslPolicy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SslPolicy]): Self = this.set("items", value.asInstanceOf[js.Any])
