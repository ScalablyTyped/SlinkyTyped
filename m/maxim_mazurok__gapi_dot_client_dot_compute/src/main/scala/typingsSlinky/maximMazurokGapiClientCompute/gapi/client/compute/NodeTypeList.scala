...
@js.native
trait NodeTypeList extends js.Object {
...
object NodeTypeList {
  ...
  @scala.inline
  implicit class NodeTypeListOps[Self <: NodeTypeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: NodeType*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[NodeType]): Self = this.set("items", value.asInstanceOf[js.Any])
