...
@js.native
trait NodeTypeList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of NodeType resources. */
  var items: js.UndefOr[js.Array[NodeType]] = js.native
...
object NodeTypeList {
  ...
  @scala.inline
  def apply(): NodeTypeList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeTypeList]
  }
  
  @scala.inline
  implicit class NodeTypeListMutableBuilder[Self <: NodeTypeList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[NodeType]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: NodeType*): Self = StObject.set(x, "items", js.Array(value :_*))
