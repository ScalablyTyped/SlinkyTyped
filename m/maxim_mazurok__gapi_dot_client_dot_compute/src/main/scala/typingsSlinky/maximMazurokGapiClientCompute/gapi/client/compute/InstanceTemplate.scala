...
object InstanceTemplate {
  ...
  implicit class InstanceTemplateOps[Self <: InstanceTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProperties(value: InstanceProperties): Self = this.set("properties", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceInstanceParams(value: SourceInstanceParams): Self = this.set("sourceInstanceParams", value.asInstanceOf[js.Any])
