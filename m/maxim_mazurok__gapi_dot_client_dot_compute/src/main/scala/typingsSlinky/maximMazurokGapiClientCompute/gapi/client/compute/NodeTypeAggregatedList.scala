...
@js.native
trait NodeTypeAggregatedList extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.NodeTypesScopedList}
    */ typingsSlinky.maximMazurokGapiClientCompute.maximMazurokGapiClientComputeStrings.NodeTypeAggregatedList with TopLevel[js.Any]
  ] = js.native
...
object NodeTypeAggregatedList {
  
  @scala.inline
  def apply(): NodeTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeTypeAggregatedList]
  }
  
  @scala.inline
  implicit class NodeTypeAggregatedListMutableBuilder[Self <: NodeTypeAggregatedList] (val x: Self) extends AnyVal {
