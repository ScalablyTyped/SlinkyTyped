...
@js.native
trait TargetGrpcProxyList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of TargetGrpcProxy resources. */
  var items: js.UndefOr[js.Array[TargetGrpcProxy]] = js.native
...
object TargetGrpcProxyList {
  
  @scala.inline
  def apply(): TargetGrpcProxyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetGrpcProxyList]
  }
  
  @scala.inline
  implicit class TargetGrpcProxyListMutableBuilder[Self <: TargetGrpcProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[TargetGrpcProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: TargetGrpcProxy*): Self = StObject.set(x, "items", js.Array(value :_*))
