...
@js.native
trait TargetGrpcProxyList extends js.Object {
...
object TargetGrpcProxyList {
  ...
  @scala.inline
  implicit class TargetGrpcProxyListOps[Self <: TargetGrpcProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: TargetGrpcProxy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[TargetGrpcProxy]): Self = this.set("items", value.asInstanceOf[js.Any])
