...
@js.native
trait NetworkList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  
  /** A list of Network resources. */
  var items: js.UndefOr[js.Array[Network]] = js.native
...
object NetworkList {
  ...
  @scala.inline
  def apply(): NetworkList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NetworkList]
  }
  
  @scala.inline
  implicit class NetworkListMutableBuilder[Self <: NetworkList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[Network]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: Network*): Self = StObject.set(x, "items", js.Array(value :_*))
