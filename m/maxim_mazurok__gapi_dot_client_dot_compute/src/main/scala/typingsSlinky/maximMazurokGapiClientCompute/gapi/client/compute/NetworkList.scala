...
object NetworkList {
  ...
  @scala.inline
  implicit class NetworkListOps[Self <: NetworkList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Network*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Network]): Self = this.set("items", value.asInstanceOf[js.Any])
