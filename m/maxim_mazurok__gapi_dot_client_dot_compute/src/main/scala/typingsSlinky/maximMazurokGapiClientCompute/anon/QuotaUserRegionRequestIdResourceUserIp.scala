...
object QuotaUserRegionRequestIdResourceUserIp {
  ...
  implicit class QuotaUserRegionRequestIdResourceUserIpOps[Self <: QuotaUserRegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = this.set("resource", value.asInstanceOf[js.Any])
