...
trait QuotaUserRegionRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager = js.native
...
object QuotaUserRegionRequestIdResourceUserIp {
  ...
  def apply(
    ...
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager
  ...
  implicit class QuotaUserRegionRequestIdResourceUserIpMutableBuilder[Self <: QuotaUserRegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
