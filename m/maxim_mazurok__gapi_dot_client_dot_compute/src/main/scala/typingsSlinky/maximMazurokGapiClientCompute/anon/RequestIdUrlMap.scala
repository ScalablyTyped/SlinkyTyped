...
@js.native
trait RequestIdUrlMap extends StObject {
...
object RequestIdUrlMap {
  
  @scala.inline
  def apply(project: String, urlMap: String): RequestIdUrlMap = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], urlMap = urlMap.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdUrlMap]
  }
  
  @scala.inline
  implicit class RequestIdUrlMapMutableBuilder[Self <: RequestIdUrlMap] (val x: Self) extends AnyVal {
