...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsListEndpointsRequest
...
trait FilterKey extends StObject {
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsListEndpointsRequest = js.native
...
object FilterKey {
  ...
  implicit class FilterKeyMutableBuilder[Self <: FilterKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworkEndpointGroupsListEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
