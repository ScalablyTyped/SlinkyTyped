...
@js.native
trait QueryPath extends js.Object {
...
object QueryPath {
  ...
  @scala.inline
  def apply(instance: String, project: String, zone: String): QueryPath = {
  ...
  @scala.inline
  implicit class QueryPathOps[Self <: QueryPath] (val x: Self) extends AnyVal {
