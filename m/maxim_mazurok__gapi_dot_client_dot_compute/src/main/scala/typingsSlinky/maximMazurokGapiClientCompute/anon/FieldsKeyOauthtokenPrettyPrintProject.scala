...
trait FieldsKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect = js.native
...
object FieldsKeyOauthtokenPrettyPrintProject {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect
  ): FieldsKeyOauthtokenPrettyPrintProject = {
  ...
  implicit class FieldsKeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
