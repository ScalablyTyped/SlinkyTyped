...
@js.native
trait RegionResource extends js.Object {
...
object RegionResource {
  ...
  @scala.inline
  def apply(project: String, region: String, resource: String): RegionResource = {
  ...
  @scala.inline
  implicit class RegionResourceOps[Self <: RegionResource] (val x: Self) extends AnyVal {
