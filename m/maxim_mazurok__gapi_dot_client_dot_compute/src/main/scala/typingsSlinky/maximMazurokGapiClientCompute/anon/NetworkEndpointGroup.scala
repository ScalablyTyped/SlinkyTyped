...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.GlobalNetworkEndpointGroupsAttachEndpointsRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait NetworkEndpointGroup extends js.Object {
  ...
  /** Request body */
  var resource: GlobalNetworkEndpointGroupsAttachEndpointsRequest = js.native
...
object NetworkEndpointGroup {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(networkEndpointGroup = networkEndpointGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[NetworkEndpointGroup]
  }
  
  @scala.inline
  implicit class NetworkEndpointGroupOps[Self <: NetworkEndpointGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GlobalNetworkEndpointGroupsAttachEndpointsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
