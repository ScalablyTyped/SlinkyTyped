...
@js.native
trait ForceCreate extends js.Object {
...
object ForceCreate {
  ...
  @scala.inline
  implicit class ForceCreateOps[Self <: ForceCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Image): Self = this.set("resource", value.asInstanceOf[js.Any])
