...
trait Instance extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig = js.native
...
object Instance {
  ...
  def apply(
    ...
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig,
    zone: String
  ): Instance = {
  ...
  implicit class InstanceMutableBuilder[Self <: Instance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
