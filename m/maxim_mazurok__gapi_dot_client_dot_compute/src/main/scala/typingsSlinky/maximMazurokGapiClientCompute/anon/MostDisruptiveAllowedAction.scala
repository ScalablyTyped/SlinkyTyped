...
@js.native
trait MostDisruptiveAllowedAction extends js.Object {
...
object MostDisruptiveAllowedAction {
  ...
  @scala.inline
  implicit class MostDisruptiveAllowedActionOps[Self <: MostDisruptiveAllowedAction] (val x: Self) extends AnyVal {
