...
@js.native
trait DeletionProtection extends js.Object {
...
object DeletionProtection {
  ...
  @scala.inline
  def apply(project: String, resource: String, zone: String): DeletionProtection = {
  ...
  @scala.inline
  implicit class DeletionProtectionOps[Self <: DeletionProtection] (val x: Self) extends AnyVal {
