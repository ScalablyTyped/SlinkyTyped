...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksRemoveResourcePoliciesRequest
...
@js.native
trait DiskFieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: RegionDisksRemoveResourcePoliciesRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object DiskFieldsKeyOauthtoken {
  
  @scala.inline
  def apply(disk: String, project: String, region: String, resource: RegionDisksRemoveResourcePoliciesRequest): DiskFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[DiskFieldsKeyOauthtoken]
  }
  
  @scala.inline
  implicit class DiskFieldsKeyOauthtokenMutableBuilder[Self <: DiskFieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksRemoveResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
