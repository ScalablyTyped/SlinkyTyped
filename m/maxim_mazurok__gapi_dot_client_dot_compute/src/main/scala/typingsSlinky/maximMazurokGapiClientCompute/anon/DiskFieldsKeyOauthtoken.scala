...
@js.native
trait DiskFieldsKeyOauthtoken extends js.Object {
...
object DiskFieldsKeyOauthtoken {
  ...
  @scala.inline
  implicit class DiskFieldsKeyOauthtokenOps[Self <: DiskFieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksRemoveResourcePoliciesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
