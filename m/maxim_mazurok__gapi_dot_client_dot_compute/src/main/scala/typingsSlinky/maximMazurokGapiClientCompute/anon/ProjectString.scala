...
trait ProjectString extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy = js.native
...
object ProjectString {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy
  ): ProjectString = {
  ...
  implicit class ProjectStringMutableBuilder[Self <: ProjectString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
