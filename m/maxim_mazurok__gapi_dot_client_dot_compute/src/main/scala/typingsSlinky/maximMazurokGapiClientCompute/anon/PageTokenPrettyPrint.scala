...
@js.native
trait PageTokenPrettyPrint extends StObject {
...
object PageTokenPrettyPrint {
  
  @scala.inline
  def apply(project: String, region: String, router: String): PageTokenPrettyPrint = {
  ...
  @scala.inline
  implicit class PageTokenPrettyPrintMutableBuilder[Self <: PageTokenPrettyPrint] (val x: Self) extends AnyVal {
