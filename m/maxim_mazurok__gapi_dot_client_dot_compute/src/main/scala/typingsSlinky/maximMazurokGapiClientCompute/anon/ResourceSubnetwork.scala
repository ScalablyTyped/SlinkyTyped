...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.SubnetworksExpandIpCidrRangeRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait ResourceSubnetwork extends js.Object {
  ...
  /** Request body */
  var resource: SubnetworksExpandIpCidrRangeRequest = js.native
...
object ResourceSubnetwork {
  ...
  @scala.inline
  def apply(project: String, region: String, resource: SubnetworksExpandIpCidrRangeRequest, subnetwork: String): ResourceSubnetwork = {
  ...
  @scala.inline
  implicit class ResourceSubnetworkOps[Self <: ResourceSubnetwork] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubnetworksExpandIpCidrRangeRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
