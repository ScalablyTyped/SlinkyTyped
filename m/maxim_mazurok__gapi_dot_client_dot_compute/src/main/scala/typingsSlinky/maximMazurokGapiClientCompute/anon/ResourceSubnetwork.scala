...
object ResourceSubnetwork {
  ...
  @scala.inline
  implicit class ResourceSubnetworkMutableBuilder[Self <: ResourceSubnetwork] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubnetworksExpandIpCidrRangeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
