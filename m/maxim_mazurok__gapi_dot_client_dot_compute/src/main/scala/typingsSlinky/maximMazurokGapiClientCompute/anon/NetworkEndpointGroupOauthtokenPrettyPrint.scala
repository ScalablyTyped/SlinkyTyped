...
@js.native
trait NetworkEndpointGroupOauthtokenPrettyPrint extends js.Object {
...
object NetworkEndpointGroupOauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(networkEndpointGroup: String, project: String, zone: String): NetworkEndpointGroupOauthtokenPrettyPrint = {
  ...
  @scala.inline
  implicit class NetworkEndpointGroupOauthtokenPrettyPrintOps[Self <: NetworkEndpointGroupOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
