...
@js.native
trait AltFieldsHealthCheck extends StObject {
...
object AltFieldsHealthCheck {
  
  @scala.inline
  def apply(healthCheck: String, project: String, region: String): AltFieldsHealthCheck = {
    ...
    __obj.asInstanceOf[AltFieldsHealthCheck]
  }
  
  @scala.inline
  implicit class AltFieldsHealthCheckMutableBuilder[Self <: AltFieldsHealthCheck] (val x: Self) extends AnyVal {
