...
object Interconnect {
  ...
  @scala.inline
  def apply(interconnect: String, project: String): Interconnect = {
    val __obj = js.Dynamic.literal(interconnect = interconnect.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
