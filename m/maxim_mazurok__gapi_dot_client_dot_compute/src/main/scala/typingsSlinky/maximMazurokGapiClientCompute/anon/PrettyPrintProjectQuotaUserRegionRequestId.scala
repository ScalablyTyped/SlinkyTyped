...
trait PrettyPrintProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService = js.native
...
object PrettyPrintProjectQuotaUserRegionRequestId {
  ...
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService
  ...
  implicit class PrettyPrintProjectQuotaUserRegionRequestIdMutableBuilder[Self <: PrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
