...
@js.native
trait ProjectQuotaUserResource extends js.Object {
...
object ProjectQuotaUserResource {
  ...
  @scala.inline
  implicit class ProjectQuotaUserResourceOps[Self <: ProjectQuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersDeletePerInstanceConfigsReq): Self = this.set("resource", value.asInstanceOf[js.Any])
