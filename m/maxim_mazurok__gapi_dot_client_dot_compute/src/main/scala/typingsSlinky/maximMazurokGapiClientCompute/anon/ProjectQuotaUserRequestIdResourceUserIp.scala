...
@js.native
trait ProjectQuotaUserRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.License = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object ProjectQuotaUserRequestIdResourceUserIp {
  
  @scala.inline
  def apply(project: String, resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.License): ProjectQuotaUserRequestIdResourceUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectQuotaUserRequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class ProjectQuotaUserRequestIdResourceUserIpMutableBuilder[Self <: ProjectQuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.License): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
