...
@js.native
trait ProjectQuotaUserRequestIdResourceUserIp extends js.Object {
...
object ProjectQuotaUserRequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRequestIdResourceUserIpOps[Self <: ProjectQuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.License): Self = this.set("resource", value.asInstanceOf[js.Any])
