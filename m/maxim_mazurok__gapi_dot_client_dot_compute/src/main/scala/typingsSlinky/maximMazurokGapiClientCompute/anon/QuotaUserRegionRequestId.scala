...
object QuotaUserRegionRequestId {
  ...
  implicit class QuotaUserRegionRequestIdOps[Self <: QuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.PacketMirroring): Self = this.set("resource", value.asInstanceOf[js.Any])
