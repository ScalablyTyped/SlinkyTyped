...
object AltFieldsKeyOauthtoken {
  ...
  implicit class AltFieldsKeyOauthtokenOps[Self <: AltFieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck): Self = this.set("resource", value.asInstanceOf[js.Any])
