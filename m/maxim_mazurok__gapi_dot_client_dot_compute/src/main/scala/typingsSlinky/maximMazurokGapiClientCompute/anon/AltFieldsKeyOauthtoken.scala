...
trait AltFieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck = js.native
...
object AltFieldsKeyOauthtoken {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck
  ): AltFieldsKeyOauthtoken = {
  ...
  implicit class AltFieldsKeyOauthtokenMutableBuilder[Self <: AltFieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
