...
trait VpnGateway extends StObject {
  ...
  var vpnGateway: String = js.native
}
object VpnGateway {
  
  @scala.inline
  def apply(project: String, region: String, vpnGateway: String): VpnGateway = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], vpnGateway = vpnGateway.asInstanceOf[js.Any])
