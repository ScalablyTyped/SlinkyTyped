...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.DisksAddResourcePoliciesRequest
...
trait Disk extends StObject {
  ...
  /** Request body */
  var resource: DisksAddResourcePoliciesRequest = js.native
...
object Disk {
  ...
  @scala.inline
  def apply(disk: String, project: String, resource: DisksAddResourcePoliciesRequest, zone: String): Disk = {
  ...
  implicit class DiskMutableBuilder[Self <: Disk] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisksAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
