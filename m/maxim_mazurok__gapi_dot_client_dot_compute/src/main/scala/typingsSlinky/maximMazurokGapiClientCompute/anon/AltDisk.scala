...
@js.native
trait AltDisk extends StObject {
...
object AltDisk {
  ...
  @scala.inline
  def apply(disk: String, project: String, zone: String): AltDisk = {
    ...
    __obj.asInstanceOf[AltDisk]
  }
  
  @scala.inline
  implicit class AltDiskMutableBuilder[Self <: AltDisk] (val x: Self) extends AnyVal {
