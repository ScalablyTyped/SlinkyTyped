...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetMinCpuPlatformRequest
...
@js.native
trait QuotaUserRequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetMinCpuPlatformRequest = js.native
...
object QuotaUserRequestIdResourceUserIp {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesSetMinCpuPlatformRequest, zone: String): QuotaUserRequestIdResourceUserIp = {
    ...
    __obj.asInstanceOf[QuotaUserRequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class QuotaUserRequestIdResourceUserIpMutableBuilder[Self <: QuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMinCpuPlatformRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
