...
@js.native
trait QuotaUserRequestIdResourceUserIp extends js.Object {
...
object QuotaUserRequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class QuotaUserRequestIdResourceUserIpOps[Self <: QuotaUserRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetMinCpuPlatformRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
