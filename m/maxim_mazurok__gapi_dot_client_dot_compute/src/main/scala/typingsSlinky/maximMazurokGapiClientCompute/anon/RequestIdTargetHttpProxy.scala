...
@js.native
trait RequestIdTargetHttpProxy extends StObject {
...
object RequestIdTargetHttpProxy {
  
  @scala.inline
  def apply(project: String, targetHttpProxy: String): RequestIdTargetHttpProxy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], targetHttpProxy = targetHttpProxy.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdTargetHttpProxy]
  }
  
  @scala.inline
  implicit class RequestIdTargetHttpProxyMutableBuilder[Self <: RequestIdTargetHttpProxy] (val x: Self) extends AnyVal {
