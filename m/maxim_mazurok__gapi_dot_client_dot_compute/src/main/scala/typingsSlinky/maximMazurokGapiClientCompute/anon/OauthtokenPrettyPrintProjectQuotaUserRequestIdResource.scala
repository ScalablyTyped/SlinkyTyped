...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRequestIdResource extends js.Object {
...
object OauthtokenPrettyPrintProjectQuotaUserRequestIdResource {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRequestIdResourceOps[Self <: OauthtokenPrettyPrintProjectQuotaUserRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DiskMoveRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
