...
trait InterconnectLocation extends StObject {
  ...
  var interconnectLocation: String = js.native
...
object InterconnectLocation {
  ...
  @scala.inline
  def apply(interconnectLocation: String, project: String): InterconnectLocation = {
    val __obj = js.Dynamic.literal(interconnectLocation = interconnectLocation.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
