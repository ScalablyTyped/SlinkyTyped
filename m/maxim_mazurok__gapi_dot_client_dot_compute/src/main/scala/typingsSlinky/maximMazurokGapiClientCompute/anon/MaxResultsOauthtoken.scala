...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsListXpnHostsRequest
...
trait MaxResultsOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ProjectsListXpnHostsRequest = js.native
...
object MaxResultsOauthtoken {
  ...
  @scala.inline
  def apply(project: String, resource: ProjectsListXpnHostsRequest): MaxResultsOauthtoken = {
  ...
  implicit class MaxResultsOauthtokenMutableBuilder[Self <: MaxResultsOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProjectsListXpnHostsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
