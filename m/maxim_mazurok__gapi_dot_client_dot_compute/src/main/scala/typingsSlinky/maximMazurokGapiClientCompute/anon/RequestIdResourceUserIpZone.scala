...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Scheduling
...
@js.native
trait RequestIdResourceUserIpZone extends StObject {
  ...
  /** Request body */
  var resource: Scheduling = js.native
...
object RequestIdResourceUserIpZone {
  
  @scala.inline
  def apply(instance: String, project: String, resource: Scheduling, zone: String): RequestIdResourceUserIpZone = {
    ...
    __obj.asInstanceOf[RequestIdResourceUserIpZone]
  }
  
  @scala.inline
  implicit class RequestIdResourceUserIpZoneMutableBuilder[Self <: RequestIdResourceUserIpZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Scheduling): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
