...
@js.native
trait RequestIdResourceUserIpZone extends js.Object {
...
object RequestIdResourceUserIpZone {
  ...
  @scala.inline
  implicit class RequestIdResourceUserIpZoneOps[Self <: RequestIdResourceUserIpZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Scheduling): Self = this.set("resource", value.asInstanceOf[js.Any])
