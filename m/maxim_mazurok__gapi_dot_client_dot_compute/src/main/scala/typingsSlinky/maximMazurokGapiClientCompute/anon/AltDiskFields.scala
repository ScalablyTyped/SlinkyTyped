...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksAddResourcePoliciesRequest
...
@js.native
trait AltDiskFields extends StObject {
  ...
  /** Request body */
  var resource: RegionDisksAddResourcePoliciesRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltDiskFields {
  
  @scala.inline
  def apply(disk: String, project: String, region: String, resource: RegionDisksAddResourcePoliciesRequest): AltDiskFields = {
    ...
    __obj.asInstanceOf[AltDiskFields]
  }
  
  @scala.inline
  implicit class AltDiskFieldsMutableBuilder[Self <: AltDiskFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
