...
@js.native
trait AltDiskFields extends js.Object {
...
object AltDiskFields {
  ...
  @scala.inline
  implicit class AltDiskFieldsOps[Self <: AltDiskFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionDisksAddResourcePoliciesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
