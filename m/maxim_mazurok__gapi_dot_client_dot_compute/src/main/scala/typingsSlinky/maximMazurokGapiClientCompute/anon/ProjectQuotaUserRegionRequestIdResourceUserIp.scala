...
object ProjectQuotaUserRegionRequestIdResourceUserIp {
  ...
  implicit class ProjectQuotaUserRegionRequestIdResourceUserIpOps[Self <: ProjectQuotaUserRegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint): Self = this.set("resource", value.asInstanceOf[js.Any])
