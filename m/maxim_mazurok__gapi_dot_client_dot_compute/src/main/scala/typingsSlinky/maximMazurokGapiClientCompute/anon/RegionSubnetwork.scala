...
@js.native
trait RegionSubnetwork extends StObject {
...
object RegionSubnetwork {
  
  @scala.inline
  def apply(project: String, region: String, subnetwork: String): RegionSubnetwork = {
    ...
    __obj.asInstanceOf[RegionSubnetwork]
  }
  
  @scala.inline
  implicit class RegionSubnetworkMutableBuilder[Self <: RegionSubnetwork] (val x: Self) extends AnyVal {
