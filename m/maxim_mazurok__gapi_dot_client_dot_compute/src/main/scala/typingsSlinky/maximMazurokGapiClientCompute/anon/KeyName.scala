...
object KeyName {
  ...
  @scala.inline
  def apply(backendBucket: String, keyName: String, project: String): KeyName = {
    val __obj = js.Dynamic.literal(backendBucket = backendBucket.asInstanceOf[js.Any], keyName = keyName.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
