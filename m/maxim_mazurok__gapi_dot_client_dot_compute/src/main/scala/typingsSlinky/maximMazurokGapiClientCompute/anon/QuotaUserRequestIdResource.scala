...
@js.native
trait QuotaUserRequestIdResource extends js.Object {
...
object QuotaUserRequestIdResource {
  ...
  @scala.inline
  implicit class QuotaUserRequestIdResourceOps[Self <: QuotaUserRequestIdResource] (val x: Self) extends AnyVal {
