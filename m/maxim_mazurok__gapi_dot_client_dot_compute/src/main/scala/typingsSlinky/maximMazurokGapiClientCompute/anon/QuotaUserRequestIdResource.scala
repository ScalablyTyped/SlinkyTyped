...
@js.native
trait QuotaUserRequestIdResource extends StObject {
...
object QuotaUserRequestIdResource {
  
  @scala.inline
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup
  ): QuotaUserRequestIdResource = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRequestIdResource]
  }
  
  @scala.inline
  implicit class QuotaUserRequestIdResourceMutableBuilder[Self <: QuotaUserRequestIdResource] (val x: Self) extends AnyVal {
