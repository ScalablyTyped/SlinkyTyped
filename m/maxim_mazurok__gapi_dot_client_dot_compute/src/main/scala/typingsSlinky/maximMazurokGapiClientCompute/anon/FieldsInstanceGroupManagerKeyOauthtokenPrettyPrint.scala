...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersCreateInstancesRequest
...
@js.native
trait FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint extends StObject {
  ...
  /**
    ...
    * original operation with the same request ID was received, and if so, will ignore the second request.
    *
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersCreateInstancesRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  def apply(
  ...
  ): FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit class FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintMutableBuilder[Self <: FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersCreateInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
