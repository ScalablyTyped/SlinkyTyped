...
@js.native
trait FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint extends js.Object {
...
object FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit class FieldsInstanceGroupManagerKeyOauthtokenPrettyPrintOps[Self <: FieldsInstanceGroupManagerKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersCreateInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
