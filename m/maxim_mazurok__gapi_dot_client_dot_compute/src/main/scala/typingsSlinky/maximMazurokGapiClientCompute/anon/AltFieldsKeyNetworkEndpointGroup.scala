...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsDetachEndpointsRequest
...
@js.native
trait AltFieldsKeyNetworkEndpointGroup extends StObject {
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsDetachEndpointsRequest = js.native
...
object AltFieldsKeyNetworkEndpointGroup {
  ...
  def apply(
    ...
    zone: String
  ): AltFieldsKeyNetworkEndpointGroup = {
    ...
    __obj.asInstanceOf[AltFieldsKeyNetworkEndpointGroup]
  }
  
  @scala.inline
  implicit class AltFieldsKeyNetworkEndpointGroupMutableBuilder[Self <: AltFieldsKeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworkEndpointGroupsDetachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
