...
@js.native
trait AltFieldsKeyNetworkEndpointGroup extends js.Object {
...
object AltFieldsKeyNetworkEndpointGroup {
  ...
  @scala.inline
  implicit class AltFieldsKeyNetworkEndpointGroupOps[Self <: AltFieldsKeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NetworkEndpointGroupsDetachEndpointsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
