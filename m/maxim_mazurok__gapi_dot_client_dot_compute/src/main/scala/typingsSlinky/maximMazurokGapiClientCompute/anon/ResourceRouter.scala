...
@js.native
trait ResourceRouter extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Router = js.native
...
object ResourceRouter {
  ...
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Router,
    router: String
  ): ResourceRouter = {
    ...
    __obj.asInstanceOf[ResourceRouter]
  }
  
  @scala.inline
  implicit class ResourceRouterMutableBuilder[Self <: ResourceRouter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Router): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
