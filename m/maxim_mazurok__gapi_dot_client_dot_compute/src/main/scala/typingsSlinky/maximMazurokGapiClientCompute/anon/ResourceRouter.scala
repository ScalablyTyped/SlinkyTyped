...
@js.native
trait ResourceRouter extends js.Object {
...
object ResourceRouter {
  ...
  @scala.inline
  implicit class ResourceRouterOps[Self <: ResourceRouter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Router): Self = this.set("resource", value.asInstanceOf[js.Any])
