...
@js.native
trait PrettyPrintProjectQuotaUserRegion extends StObject {
...
object PrettyPrintProjectQuotaUserRegion {
  ...
  def apply(
  ...
  ): PrettyPrintProjectQuotaUserRegion = {
    ...
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRegion]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionMutableBuilder[Self <: PrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
