...
@js.native
trait PrettyPrintProjectQuotaUserRegion extends js.Object {
...
object PrettyPrintProjectQuotaUserRegion {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRegionOps[Self <: PrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
