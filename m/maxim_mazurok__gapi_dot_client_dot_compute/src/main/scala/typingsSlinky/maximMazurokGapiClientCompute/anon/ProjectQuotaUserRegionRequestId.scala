...
trait ProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Commitment = js.native
...
object ProjectQuotaUserRegionRequestId {
  ...
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Commitment
  ...
  implicit class ProjectQuotaUserRegionRequestIdMutableBuilder[Self <: ProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Commitment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
