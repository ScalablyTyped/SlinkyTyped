...
@js.native
trait RegionRequestIdResourceUserIp extends js.Object {
...
object RegionRequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class RegionRequestIdResourceUserIpOps[Self <: RegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
