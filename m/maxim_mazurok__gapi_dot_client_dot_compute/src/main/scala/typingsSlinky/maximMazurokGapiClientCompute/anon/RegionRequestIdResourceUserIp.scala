...
@js.native
trait RegionRequestIdResourceUserIp extends StObject {
...
object RegionRequestIdResourceUserIp {
  
  @scala.inline
  def apply(project: String, region: String, resource: String): RegionRequestIdResourceUserIp = {
    ...
    __obj.asInstanceOf[RegionRequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class RegionRequestIdResourceUserIpMutableBuilder[Self <: RegionRequestIdResourceUserIp] (val x: Self) extends AnyVal {
