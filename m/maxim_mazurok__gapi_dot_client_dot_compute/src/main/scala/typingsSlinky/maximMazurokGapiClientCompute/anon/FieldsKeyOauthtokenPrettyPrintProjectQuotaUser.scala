...
@js.native
trait FieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends js.Object {
...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class FieldsKeyOauthtokenPrettyPrintProjectQuotaUserOps[Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProjectsDisableXpnResourceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
