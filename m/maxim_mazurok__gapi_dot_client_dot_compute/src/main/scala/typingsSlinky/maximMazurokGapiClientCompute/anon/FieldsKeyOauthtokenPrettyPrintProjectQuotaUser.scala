...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsDisableXpnResourceRequest
...
@js.native
trait FieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: ProjectsDisableXpnResourceRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  
  @scala.inline
  def apply(project: String, resource: ProjectsDisableXpnResourceRequest): FieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
  ...
  @scala.inline
  implicit class FieldsKeyOauthtokenPrettyPrintProjectQuotaUserMutableBuilder[Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProjectsDisableXpnResourceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
