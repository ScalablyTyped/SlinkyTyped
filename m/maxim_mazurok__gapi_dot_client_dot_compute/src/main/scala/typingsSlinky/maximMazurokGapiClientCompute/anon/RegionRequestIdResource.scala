...
@js.native
trait RegionRequestIdResource extends js.Object {
...
object RegionRequestIdResource {
  ...
  @scala.inline
  implicit class RegionRequestIdResourceOps[Self <: RegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = this.set("resource", value.asInstanceOf[js.Any])
