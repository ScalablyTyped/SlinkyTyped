...
@js.native
trait RegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object RegionRequestIdResource {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler
  ): RegionRequestIdResource = {
    ...
    __obj.asInstanceOf[RegionRequestIdResource]
  }
  
  @scala.inline
  implicit class RegionRequestIdResourceMutableBuilder[Self <: RegionRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
