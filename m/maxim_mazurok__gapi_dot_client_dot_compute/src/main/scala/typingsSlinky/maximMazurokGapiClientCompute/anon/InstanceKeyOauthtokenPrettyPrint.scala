...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Metadata
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait InstanceKeyOauthtokenPrettyPrint extends js.Object {
...
object InstanceKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: Metadata, zone: String): InstanceKeyOauthtokenPrettyPrint = {
  ...
  @scala.inline
  implicit class InstanceKeyOauthtokenPrettyPrintOps[Self <: InstanceKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
