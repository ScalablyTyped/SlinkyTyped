...
trait SourceInstanceTemplate extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Instance = js.native
...
object SourceInstanceTemplate {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Instance,
    zone: String
  ...
  implicit class SourceInstanceTemplateMutableBuilder[Self <: SourceInstanceTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Instance): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
