...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersSetTargetPoolsRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait OauthtokenPrettyPrintProjectQuotaUser extends js.Object {
  ...
  /** Request body */
  var resource: InstanceGroupManagersSetTargetPoolsRequest = js.native
...
object OauthtokenPrettyPrintProjectQuotaUser {
  ...
  def apply(
    ...
    zone: String
  ): OauthtokenPrettyPrintProjectQuotaUser = {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserOps[Self <: OauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersSetTargetPoolsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
