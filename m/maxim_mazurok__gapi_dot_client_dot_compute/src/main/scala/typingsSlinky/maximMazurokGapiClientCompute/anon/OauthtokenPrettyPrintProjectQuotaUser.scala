...
object OauthtokenPrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserMutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersSetTargetPoolsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
