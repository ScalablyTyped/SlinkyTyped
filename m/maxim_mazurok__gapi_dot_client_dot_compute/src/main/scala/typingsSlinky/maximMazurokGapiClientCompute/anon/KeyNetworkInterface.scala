...
object KeyNetworkInterface {
  ...
  implicit class KeyNetworkInterfaceOps[Self <: KeyNetworkInterface] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface): Self = this.set("resource", value.asInstanceOf[js.Any])
