...
trait KeyNetworkInterface extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface = js.native
...
object KeyNetworkInterface {
  ...
  def apply(
    ...
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface,
    zone: String
  ): KeyNetworkInterface = {
  ...
  implicit class KeyNetworkInterfaceMutableBuilder[Self <: KeyNetworkInterface] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
