...
@js.native
trait ProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object ProjectQuotaUserRegion {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate
  ): ProjectQuotaUserRegion = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRegion]
  }
  
  @scala.inline
  implicit class ProjectQuotaUserRegionMutableBuilder[Self <: ProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
