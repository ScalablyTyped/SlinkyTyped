...
@js.native
trait ProjectQuotaUserRegion extends js.Object {
...
object ProjectQuotaUserRegion {
  ...
  @scala.inline
  implicit class ProjectQuotaUserRegionOps[Self <: ProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate): Self = this.set("resource", value.asInstanceOf[js.Any])
