...
trait FieldsKeyOauthtoken extends js.Object {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway = js.native
...
object FieldsKeyOauthtoken {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway
  ): FieldsKeyOauthtoken = {
  ...
  implicit class FieldsKeyOauthtokenOps[Self <: FieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway): Self = this.set("resource", value.asInstanceOf[js.Any])
