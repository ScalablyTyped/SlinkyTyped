...
object FieldsKeyOauthtoken {
  ...
  implicit class FieldsKeyOauthtokenMutableBuilder[Self <: FieldsKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
