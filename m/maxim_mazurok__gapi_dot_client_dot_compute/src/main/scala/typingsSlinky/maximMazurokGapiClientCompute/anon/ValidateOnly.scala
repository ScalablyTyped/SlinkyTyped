...
trait ValidateOnly extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment = js.native
...
object ValidateOnly {
  ...
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment
  ): ValidateOnly = {
  ...
  implicit class ValidateOnlyMutableBuilder[Self <: ValidateOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
