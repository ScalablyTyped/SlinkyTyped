...
object ValidateOnly {
  ...
  implicit class ValidateOnlyOps[Self <: ValidateOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment): Self = this.set("resource", value.asInstanceOf[js.Any])
