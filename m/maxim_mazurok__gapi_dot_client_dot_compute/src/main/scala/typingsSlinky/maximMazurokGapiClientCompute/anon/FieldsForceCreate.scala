...
@js.native
trait FieldsForceCreate extends StObject {
...
object FieldsForceCreate {
  
  @scala.inline
  def apply(project: String): FieldsForceCreate = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsForceCreate]
  }
  
  @scala.inline
  implicit class FieldsForceCreateMutableBuilder[Self <: FieldsForceCreate] (val x: Self) extends AnyVal {
