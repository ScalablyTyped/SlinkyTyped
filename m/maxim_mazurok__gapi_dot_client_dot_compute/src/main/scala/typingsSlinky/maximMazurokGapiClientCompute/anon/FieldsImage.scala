...
@js.native
trait FieldsImage extends js.Object {
...
object FieldsImage {
  ...
  @scala.inline
  implicit class FieldsImageOps[Self <: FieldsImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DeprecationStatus): Self = this.set("resource", value.asInstanceOf[js.Any])
