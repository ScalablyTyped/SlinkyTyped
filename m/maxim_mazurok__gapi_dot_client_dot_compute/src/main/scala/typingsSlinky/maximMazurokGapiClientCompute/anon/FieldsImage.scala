...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.DeprecationStatus
...
@js.native
trait FieldsImage extends StObject {
  ...
  /** Request body */
  var resource: DeprecationStatus = js.native
...
object FieldsImage {
  ...
  @scala.inline
  def apply(image: String, project: String, resource: DeprecationStatus): FieldsImage = {
    val __obj = js.Dynamic.literal(image = image.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsImage]
  }
  
  @scala.inline
  implicit class FieldsImageMutableBuilder[Self <: FieldsImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DeprecationStatus): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
