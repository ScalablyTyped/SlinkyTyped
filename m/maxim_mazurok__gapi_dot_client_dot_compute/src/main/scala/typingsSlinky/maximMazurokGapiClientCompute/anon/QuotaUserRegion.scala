...
trait QuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule = js.native
...
object QuotaUserRegion {
  ...
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule
  ): QuotaUserRegion = {
  ...
  @scala.inline
  implicit class QuotaUserRegionMutableBuilder[Self <: QuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
