...
@js.native
trait InitialNodeCount extends js.Object {
...
object InitialNodeCount {
  ...
  @scala.inline
  implicit class InitialNodeCountOps[Self <: InitialNodeCount] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup): Self = this.set("resource", value.asInstanceOf[js.Any])
