...
@js.native
trait InitialNodeCount extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup = js.native
...
object InitialNodeCount {
  
  @scala.inline
  def apply(
    initialNodeCount: Double,
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup,
    zone: String
  ): InitialNodeCount = {
    val __obj = js.Dynamic.literal(initialNodeCount = initialNodeCount.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[InitialNodeCount]
  }
  
  @scala.inline
  implicit class InitialNodeCountMutableBuilder[Self <: InitialNodeCount] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
