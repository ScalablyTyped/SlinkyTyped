...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupsListInstancesRequest
...
trait OauthtokenOrderBy extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupsListInstancesRequest = js.native
...
object OauthtokenOrderBy {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(instanceGroup = instanceGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  implicit class OauthtokenOrderByMutableBuilder[Self <: OauthtokenOrderBy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupsListInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
