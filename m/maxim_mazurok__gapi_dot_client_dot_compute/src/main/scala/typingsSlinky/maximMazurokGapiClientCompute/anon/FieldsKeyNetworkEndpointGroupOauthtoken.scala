...
@js.native
trait FieldsKeyNetworkEndpointGroupOauthtoken extends StObject {
...
object FieldsKeyNetworkEndpointGroupOauthtoken {
  
  @scala.inline
  def apply(networkEndpointGroup: String, project: String, region: String): FieldsKeyNetworkEndpointGroupOauthtoken = {
    val __obj = js.Dynamic.literal(networkEndpointGroup = networkEndpointGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsKeyNetworkEndpointGroupOauthtoken]
  }
  
  @scala.inline
  implicit class FieldsKeyNetworkEndpointGroupOauthtokenMutableBuilder[Self <: FieldsKeyNetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
