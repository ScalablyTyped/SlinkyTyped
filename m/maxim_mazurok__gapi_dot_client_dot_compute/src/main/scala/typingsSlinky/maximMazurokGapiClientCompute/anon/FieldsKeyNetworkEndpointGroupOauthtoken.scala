...
@js.native
trait FieldsKeyNetworkEndpointGroupOauthtoken extends js.Object {
...
object FieldsKeyNetworkEndpointGroupOauthtoken {
  ...
  @scala.inline
  implicit class FieldsKeyNetworkEndpointGroupOauthtokenOps[Self <: FieldsKeyNetworkEndpointGroupOauthtoken] (val x: Self) extends AnyVal {
