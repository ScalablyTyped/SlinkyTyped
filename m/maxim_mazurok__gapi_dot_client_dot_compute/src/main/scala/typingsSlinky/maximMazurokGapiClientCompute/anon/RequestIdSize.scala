...
@js.native
trait RequestIdSize extends StObject {
...
object RequestIdSize {
  
  @scala.inline
  def apply(instanceGroupManager: String, project: String, region: String, size: Double): RequestIdSize = {
    ...
    __obj.asInstanceOf[RequestIdSize]
  }
  
  @scala.inline
  implicit class RequestIdSizeMutableBuilder[Self <: RequestIdSize] (val x: Self) extends AnyVal {
