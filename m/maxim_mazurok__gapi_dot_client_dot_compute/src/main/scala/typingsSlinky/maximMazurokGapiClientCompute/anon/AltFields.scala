...
@js.native
trait AltFields extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket = js.native
...
object AltFields {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket
  ): AltFields = {
  ...
  @scala.inline
  implicit class AltFieldsMutableBuilder[Self <: AltFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
