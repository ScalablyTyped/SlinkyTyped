...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsAddInstancesRequest
...
trait InstanceGroup extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsAddInstancesRequest = js.native
...
object InstanceGroup {
  ...
  @scala.inline
  def apply(instanceGroup: String, project: String, resource: InstanceGroupsAddInstancesRequest, zone: String): InstanceGroup = {
  ...
  implicit class InstanceGroupMutableBuilder[Self <: InstanceGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupsAddInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
