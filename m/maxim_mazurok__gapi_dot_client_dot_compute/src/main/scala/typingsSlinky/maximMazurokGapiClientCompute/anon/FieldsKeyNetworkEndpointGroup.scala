...
@js.native
trait FieldsKeyNetworkEndpointGroup extends StObject {
...
object FieldsKeyNetworkEndpointGroup {
  
  @scala.inline
  def apply(networkEndpointGroup: String, project: String): FieldsKeyNetworkEndpointGroup = {
    ...
    __obj.asInstanceOf[FieldsKeyNetworkEndpointGroup]
  }
  
  @scala.inline
  implicit class FieldsKeyNetworkEndpointGroupMutableBuilder[Self <: FieldsKeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
