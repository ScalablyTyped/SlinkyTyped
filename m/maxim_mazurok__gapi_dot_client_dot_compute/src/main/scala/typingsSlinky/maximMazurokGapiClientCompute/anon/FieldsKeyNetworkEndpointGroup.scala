...
@js.native
trait FieldsKeyNetworkEndpointGroup extends js.Object {
...
object FieldsKeyNetworkEndpointGroup {
  ...
  @scala.inline
  implicit class FieldsKeyNetworkEndpointGroupOps[Self <: FieldsKeyNetworkEndpointGroup] (val x: Self) extends AnyVal {
