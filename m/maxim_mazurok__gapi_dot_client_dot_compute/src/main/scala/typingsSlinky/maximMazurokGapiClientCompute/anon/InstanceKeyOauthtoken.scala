...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetLabelsRequest
...
@js.native
trait InstanceKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetLabelsRequest = js.native
...
object InstanceKeyOauthtoken {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesSetLabelsRequest, zone: String): InstanceKeyOauthtoken = {
    ...
    __obj.asInstanceOf[InstanceKeyOauthtoken]
  }
  
  @scala.inline
  implicit class InstanceKeyOauthtokenMutableBuilder[Self <: InstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetLabelsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
