...
@js.native
trait InstanceKeyOauthtoken extends js.Object {
...
object InstanceKeyOauthtoken {
  ...
  @scala.inline
  implicit class InstanceKeyOauthtokenOps[Self <: InstanceKeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesSetLabelsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
