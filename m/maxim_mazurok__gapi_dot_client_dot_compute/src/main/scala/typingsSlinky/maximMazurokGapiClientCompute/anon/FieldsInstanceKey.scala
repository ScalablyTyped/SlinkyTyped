...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstancesRemoveResourcePoliciesRequest
...
@js.native
trait FieldsInstanceKey extends StObject {
  ...
  /** Request body */
  var resource: InstancesRemoveResourcePoliciesRequest = js.native
...
object FieldsInstanceKey {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesRemoveResourcePoliciesRequest, zone: String): FieldsInstanceKey = {
    ...
    __obj.asInstanceOf[FieldsInstanceKey]
  }
  
  @scala.inline
  implicit class FieldsInstanceKeyMutableBuilder[Self <: FieldsInstanceKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesRemoveResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
