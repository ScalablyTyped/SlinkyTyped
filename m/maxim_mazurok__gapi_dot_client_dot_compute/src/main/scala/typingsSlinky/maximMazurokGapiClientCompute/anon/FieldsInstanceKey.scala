...
@js.native
trait FieldsInstanceKey extends js.Object {
...
object FieldsInstanceKey {
  ...
  @scala.inline
  implicit class FieldsInstanceKeyOps[Self <: FieldsInstanceKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesRemoveResourcePoliciesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
