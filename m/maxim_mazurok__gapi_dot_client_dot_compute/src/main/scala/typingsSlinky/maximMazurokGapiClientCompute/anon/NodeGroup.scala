...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsAddNodesRequest
...
trait NodeGroup extends StObject {
  ...
  /** Request body */
  var resource: NodeGroupsAddNodesRequest = js.native
...
object NodeGroup {
  ...
  @scala.inline
  def apply(nodeGroup: String, project: String, resource: NodeGroupsAddNodesRequest, zone: String): NodeGroup = {
    val __obj = js.Dynamic.literal(nodeGroup = nodeGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
  ...
  implicit class NodeGroupMutableBuilder[Self <: NodeGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NodeGroupsAddNodesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
