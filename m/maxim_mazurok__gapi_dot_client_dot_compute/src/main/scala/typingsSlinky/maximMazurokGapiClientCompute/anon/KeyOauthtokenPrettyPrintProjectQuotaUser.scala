...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstancesStartWithEncryptionKeyRequest
...
@js.native
trait KeyOauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: InstancesStartWithEncryptionKeyRequest = js.native
...
object KeyOauthtokenPrettyPrintProjectQuotaUser {
  
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesStartWithEncryptionKeyRequest, zone: String): KeyOauthtokenPrettyPrintProjectQuotaUser = {
    ...
    __obj.asInstanceOf[KeyOauthtokenPrettyPrintProjectQuotaUser]
  }
  
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectQuotaUserMutableBuilder[Self <: KeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesStartWithEncryptionKeyRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
