...
@js.native
trait KeyOauthtokenPrettyPrintProjectQuotaUser extends js.Object {
...
object KeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectQuotaUserOps[Self <: KeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesStartWithEncryptionKeyRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
