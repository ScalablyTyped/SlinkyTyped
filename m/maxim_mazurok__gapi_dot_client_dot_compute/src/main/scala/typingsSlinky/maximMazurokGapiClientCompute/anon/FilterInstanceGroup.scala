...
@js.native
trait FilterInstanceGroup extends StObject {
...
object FilterInstanceGroup {
  
  @scala.inline
  def apply(instanceGroup: String, project: String, zone: String): FilterInstanceGroup = {
    ...
    __obj.asInstanceOf[FilterInstanceGroup]
  }
  
  @scala.inline
  implicit class FilterInstanceGroupMutableBuilder[Self <: FilterInstanceGroup] (val x: Self) extends AnyVal {
