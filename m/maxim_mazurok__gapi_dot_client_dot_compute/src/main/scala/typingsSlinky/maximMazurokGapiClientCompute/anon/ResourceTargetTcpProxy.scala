...
trait ResourceTargetTcpProxy extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy = js.native
...
object ResourceTargetTcpProxy {
  ...
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy
  ...
  implicit class ResourceTargetTcpProxyMutableBuilder[Self <: ResourceTargetTcpProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
