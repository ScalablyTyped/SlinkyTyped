...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRequestId extends js.Object {
...
object OauthtokenPrettyPrintProjectQuotaUserRequestId {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRequestIdOps[Self <: OauthtokenPrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisplayDevice): Self = this.set("resource", value.asInstanceOf[js.Any])
