...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.DisplayDevice
...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: DisplayDevice = js.native
...
object OauthtokenPrettyPrintProjectQuotaUserRequestId {
  
  @scala.inline
  def apply(instance: String, project: String, resource: DisplayDevice, zone: String): OauthtokenPrettyPrintProjectQuotaUserRequestId = {
    ...
    __obj.asInstanceOf[OauthtokenPrettyPrintProjectQuotaUserRequestId]
  }
  
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRequestIdMutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUserRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisplayDevice): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
