...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRegionRequestId extends js.Object {
...
object OauthtokenPrettyPrintProjectQuotaUserRegionRequestId {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRegionRequestIdOps[Self <: OauthtokenPrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagerUpdateInstanceConfigReq): Self = this.set("resource", value.asInstanceOf[js.Any])
