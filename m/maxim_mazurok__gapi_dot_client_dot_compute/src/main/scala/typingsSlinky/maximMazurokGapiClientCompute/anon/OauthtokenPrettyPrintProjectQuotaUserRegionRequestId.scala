...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagerUpdateInstanceConfigReq
...
@js.native
trait OauthtokenPrettyPrintProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagerUpdateInstanceConfigReq = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object OauthtokenPrettyPrintProjectQuotaUserRegionRequestId {
  ...
  def apply(
  ...
  ): OauthtokenPrettyPrintProjectQuotaUserRegionRequestId = {
    ...
    __obj.asInstanceOf[OauthtokenPrettyPrintProjectQuotaUserRegionRequestId]
  }
  
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectQuotaUserRegionRequestIdMutableBuilder[Self <: OauthtokenPrettyPrintProjectQuotaUserRegionRequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagerUpdateInstanceConfigReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
