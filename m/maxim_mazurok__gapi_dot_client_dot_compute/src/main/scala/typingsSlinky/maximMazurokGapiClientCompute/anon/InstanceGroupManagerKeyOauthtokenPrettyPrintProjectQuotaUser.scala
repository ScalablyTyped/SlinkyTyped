...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersSetTemplateRequest
...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersSetTemplateRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  def apply(
  ...
  ): InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser = {
    ...
    __obj.asInstanceOf[InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser]
  }
  
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUserMutableBuilder[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersSetTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
