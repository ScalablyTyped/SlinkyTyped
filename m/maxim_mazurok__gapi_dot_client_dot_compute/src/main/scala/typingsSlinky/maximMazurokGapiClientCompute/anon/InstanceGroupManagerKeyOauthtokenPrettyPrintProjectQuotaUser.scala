...
@js.native
trait InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser extends js.Object {
...
object InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  @scala.inline
  implicit class InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUserOps[Self <: InstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersSetTemplateRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
