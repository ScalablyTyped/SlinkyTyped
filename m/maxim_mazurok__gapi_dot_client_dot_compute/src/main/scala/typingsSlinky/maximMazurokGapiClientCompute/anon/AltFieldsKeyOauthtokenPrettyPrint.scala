...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrint extends js.Object {
...
object AltFieldsKeyOauthtokenPrettyPrint {
  ...
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintOps[Self <: AltFieldsKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate): Self = this.set("resource", value.asInstanceOf[js.Any])
