...
@js.native
trait AltFieldsKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltFieldsKeyOauthtokenPrettyPrint {
  
  @scala.inline
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate
  ): AltFieldsKeyOauthtokenPrettyPrint = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltFieldsKeyOauthtokenPrettyPrint]
  }
  
  @scala.inline
  implicit class AltFieldsKeyOauthtokenPrettyPrintMutableBuilder[Self <: AltFieldsKeyOauthtokenPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
