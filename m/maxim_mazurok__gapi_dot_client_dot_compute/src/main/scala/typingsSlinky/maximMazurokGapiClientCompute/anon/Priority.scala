...
object Priority {
  ...
  @scala.inline
  def apply(project: String, securityPolicy: String): Priority = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], securityPolicy = securityPolicy.asInstanceOf[js.Any])
