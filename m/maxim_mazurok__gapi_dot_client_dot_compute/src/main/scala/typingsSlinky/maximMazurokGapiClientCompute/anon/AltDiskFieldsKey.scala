...
@js.native
trait AltDiskFieldsKey extends js.Object {
...
object AltDiskFieldsKey {
  ...
  @scala.inline
  implicit class AltDiskFieldsKeyOps[Self <: AltDiskFieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot): Self = this.set("resource", value.asInstanceOf[js.Any])
