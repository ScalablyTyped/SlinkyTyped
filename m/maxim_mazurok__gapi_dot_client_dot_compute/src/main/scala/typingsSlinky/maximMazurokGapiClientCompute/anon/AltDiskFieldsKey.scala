...
@js.native
trait AltDiskFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object AltDiskFieldsKey {
  ...
  def apply(
    ...
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot
  ): AltDiskFieldsKey = {
    ...
    __obj.asInstanceOf[AltDiskFieldsKey]
  }
  
  @scala.inline
  implicit class AltDiskFieldsKeyMutableBuilder[Self <: AltDiskFieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
