...
@js.native
trait RequestIdUserIp extends StObject {
...
object RequestIdUserIp {
  ...
  @scala.inline
  def apply(forwardingRule: String, project: String): RequestIdUserIp = {
  ...
  @scala.inline
  implicit class RequestIdUserIpMutableBuilder[Self <: RequestIdUserIp] (val x: Self) extends AnyVal {
