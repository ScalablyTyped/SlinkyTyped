...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsListInstancesRequest
...
@js.native
trait FieldsFilter extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsListInstancesRequest = js.native
...
object FieldsFilter {
  ...
  @scala.inline
  def apply(instanceGroup: String, project: String, resource: InstanceGroupsListInstancesRequest, zone: String): FieldsFilter = {
    val __obj = js.Dynamic.literal(instanceGroup = instanceGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsFilter]
  }
  
  @scala.inline
  implicit class FieldsFilterMutableBuilder[Self <: FieldsFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupsListInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
