...
@js.native
trait FieldsFilter extends js.Object {
...
object FieldsFilter {
  ...
  @scala.inline
  implicit class FieldsFilterOps[Self <: FieldsFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupsListInstancesRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
