...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersSetTargetPoolsRequest
...
@js.native
trait KeyOauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersSetTargetPoolsRequest = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object KeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  def apply(
  ...
  ): KeyOauthtokenPrettyPrintProjectQuotaUserRegion = {
    ...
    __obj.asInstanceOf[KeyOauthtokenPrettyPrintProjectQuotaUserRegion]
  }
  
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectQuotaUserRegionMutableBuilder[Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersSetTargetPoolsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
