...
@js.native
trait KeyOauthtokenPrettyPrintProjectQuotaUserRegion extends js.Object {
...
object KeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectQuotaUserRegionOps[Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRegion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RegionInstanceGroupManagersSetTargetPoolsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
