...
@js.native
trait AltFieldsInstanceGroupManagerKey extends js.Object {
...
object AltFieldsInstanceGroupManagerKey {
  ...
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyOps[Self <: AltFieldsInstanceGroupManagerKey] (val x: Self) extends AnyVal {
