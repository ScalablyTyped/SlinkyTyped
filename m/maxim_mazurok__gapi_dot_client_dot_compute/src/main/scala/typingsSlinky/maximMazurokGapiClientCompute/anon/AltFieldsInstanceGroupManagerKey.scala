...
@js.native
trait AltFieldsInstanceGroupManagerKey extends StObject {
...
object AltFieldsInstanceGroupManagerKey {
  ...
  def apply(
    ...
    zone: String
  ): AltFieldsInstanceGroupManagerKey = {
    ...
    __obj.asInstanceOf[AltFieldsInstanceGroupManagerKey]
  }
  
  @scala.inline
  implicit class AltFieldsInstanceGroupManagerKeyMutableBuilder[Self <: AltFieldsInstanceGroupManagerKey] (val x: Self) extends AnyVal {
