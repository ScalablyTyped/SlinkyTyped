...
@js.native
trait RequestIdResourceUserIp extends js.Object {
...
object RequestIdResourceUserIp {
  ...
  @scala.inline
  implicit class RequestIdResourceUserIpOps[Self <: RequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = this.set("resource", value.asInstanceOf[js.Any])
