...
@js.native
trait RequestIdResourceUserIp extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object RequestIdResourceUserIp {
  
  @scala.inline
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck
  ): RequestIdResourceUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdResourceUserIp]
  }
  
  @scala.inline
  implicit class RequestIdResourceUserIpMutableBuilder[Self <: RequestIdResourceUserIp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
