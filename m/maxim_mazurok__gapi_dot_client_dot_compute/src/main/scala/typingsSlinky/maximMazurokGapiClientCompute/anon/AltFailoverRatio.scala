...
@js.native
trait AltFailoverRatio extends StObject {
...
object AltFailoverRatio {
  
  @scala.inline
  def apply(project: String, region: String, targetPool: String): AltFailoverRatio = {
    ...
    __obj.asInstanceOf[AltFailoverRatio]
  }
  
  @scala.inline
  implicit class AltFailoverRatioMutableBuilder[Self <: AltFailoverRatio] (val x: Self) extends AnyVal {
