...
@js.native
trait RegionRequestIdUserIp extends StObject {
...
object RegionRequestIdUserIp {
  
  @scala.inline
  def apply(instanceGroupManager: String, project: String, region: String): RegionRequestIdUserIp = {
    ...
    __obj.asInstanceOf[RegionRequestIdUserIp]
  }
  
  @scala.inline
  implicit class RegionRequestIdUserIpMutableBuilder[Self <: RegionRequestIdUserIp] (val x: Self) extends AnyVal {
