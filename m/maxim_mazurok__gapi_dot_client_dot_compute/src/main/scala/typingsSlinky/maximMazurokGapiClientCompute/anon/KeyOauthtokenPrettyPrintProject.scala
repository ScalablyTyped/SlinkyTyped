...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersSetInstanceTemplateRequest
...
@js.native
trait KeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersSetInstanceTemplateRequest = js.native
...
object KeyOauthtokenPrettyPrintProject {
  ...
  def apply(
    ...
    zone: String
  ): KeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[KeyOauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectMutableBuilder[Self <: KeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersSetInstanceTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
