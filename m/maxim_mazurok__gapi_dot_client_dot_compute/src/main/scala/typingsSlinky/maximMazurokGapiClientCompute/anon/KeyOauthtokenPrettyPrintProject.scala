...
@js.native
trait KeyOauthtokenPrettyPrintProject extends js.Object {
...
object KeyOauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class KeyOauthtokenPrettyPrintProjectOps[Self <: KeyOauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstanceGroupManagersSetInstanceTemplateRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
