...
@js.native
trait PrettyPrintProjectQuotaUserRequestIdResource extends js.Object {
...
object PrettyPrintProjectQuotaUserRequestIdResource {
  ...
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdResourceOps[Self <: PrettyPrintProjectQuotaUserRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShieldedInstanceConfig): Self = this.set("resource", value.asInstanceOf[js.Any])
