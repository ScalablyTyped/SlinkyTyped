...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.ShieldedInstanceConfig
...
@js.native
trait PrettyPrintProjectQuotaUserRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: ShieldedInstanceConfig = js.native
...
object PrettyPrintProjectQuotaUserRequestIdResource {
  
  @scala.inline
  def apply(instance: String, project: String, resource: ShieldedInstanceConfig, zone: String): PrettyPrintProjectQuotaUserRequestIdResource = {
    ...
    __obj.asInstanceOf[PrettyPrintProjectQuotaUserRequestIdResource]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectQuotaUserRequestIdResourceMutableBuilder[Self <: PrettyPrintProjectQuotaUserRequestIdResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ShieldedInstanceConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
