...
@js.native
trait PrettyPrintProjectString extends js.Object {
...
object PrettyPrintProjectString {
  ...
  @scala.inline
  implicit class PrettyPrintProjectStringOps[Self <: PrettyPrintProjectString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): Self = this.set("resource", value.asInstanceOf[js.Any])
