...
@js.native
trait PrettyPrintProjectString extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object PrettyPrintProjectString {
  
  @scala.inline
  def apply(project: String, resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): PrettyPrintProjectString = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrettyPrintProjectString]
  }
  
  @scala.inline
  implicit class PrettyPrintProjectStringMutableBuilder[Self <: PrettyPrintProjectString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
