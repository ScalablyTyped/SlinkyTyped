...
@js.native
trait ResourceSourceImage extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Disk = js.native
...
object ResourceSourceImage {
  
  @scala.inline
  def apply(
    project: String,
    region: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Disk
  ): ResourceSourceImage = {
    ...
    __obj.asInstanceOf[ResourceSourceImage]
  }
  
  @scala.inline
  implicit class ResourceSourceImageMutableBuilder[Self <: ResourceSourceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Disk): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
