...
@js.native
trait ResourceSourceImage extends js.Object {
...
object ResourceSourceImage {
  ...
  @scala.inline
  implicit class ResourceSourceImageOps[Self <: ResourceSourceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Disk): Self = this.set("resource", value.asInstanceOf[js.Any])
