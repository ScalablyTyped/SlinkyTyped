...
@js.native
trait OauthtokenPrettyPrintProject extends StObject {
...
object OauthtokenPrettyPrintProject {
  
  @scala.inline
  def apply(
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.Firewall
  ): OauthtokenPrettyPrintProject = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[OauthtokenPrettyPrintProject]
  }
  
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectMutableBuilder[Self <: OauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
