...
@js.native
trait OauthtokenPrettyPrintProject extends js.Object {
...
object OauthtokenPrettyPrintProject {
  ...
  @scala.inline
  implicit class OauthtokenPrettyPrintProjectOps[Self <: OauthtokenPrettyPrintProject] (val x: Self) extends AnyVal {
