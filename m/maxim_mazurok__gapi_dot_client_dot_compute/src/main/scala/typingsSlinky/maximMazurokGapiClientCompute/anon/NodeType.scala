...
object NodeType {
  ...
  @scala.inline
  def apply(nodeType: String, project: String, zone: String): NodeType = {
    val __obj = js.Dynamic.literal(nodeType = nodeType.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
