...
@js.native
trait ForceAttach extends js.Object {
...
object ForceAttach {
  ...
  @scala.inline
  implicit class ForceAttachOps[Self <: ForceAttach] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AttachedDisk): Self = this.set("resource", value.asInstanceOf[js.Any])
