...
import typingsSlinky.maximMazurokGapiClientCompute.gapi.client.compute.TargetReference
...
@js.native
trait FailoverRatio extends StObject {
  ...
  /** Request body */
  var resource: TargetReference = js.native
...
object FailoverRatio {
  
  @scala.inline
  def apply(project: String, region: String, resource: TargetReference, targetPool: String): FailoverRatio = {
  ...
  @scala.inline
  implicit class FailoverRatioMutableBuilder[Self <: FailoverRatio] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TargetReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
