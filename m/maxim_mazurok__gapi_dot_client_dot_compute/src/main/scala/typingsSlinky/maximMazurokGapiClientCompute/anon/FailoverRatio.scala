...
@js.native
trait FailoverRatio extends js.Object {
...
object FailoverRatio {
  ...
  @scala.inline
  implicit class FailoverRatioOps[Self <: FailoverRatio] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TargetReference): Self = this.set("resource", value.asInstanceOf[js.Any])
