...
object Connection {
  ...
  def apply(
    ...
    getPublicKey: (String, js.Function2[/* err */ js.Error, /* publicKey */ js.Any, Unit]) => Unit,
  ...
  implicit class ConnectionMutableBuilder[Self <: Connection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetPublicKey(value: (String, js.Function2[/* err */ js.Error, /* publicKey */ js.Any, Unit]) => Unit): Self = StObject.set(x, "getPublicKey", js.Any.fromFunction2(value))
