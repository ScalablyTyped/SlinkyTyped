package typingsSlinky.maximMazurokGapiClientGames.anon
...
@js.native
trait IncludeRankType extends StObject {
...
object IncludeRankType {
  
  @scala.inline
  def apply(leaderboardId: String, playerId: String, timeSpan: String): IncludeRankType = {
  ...
  @scala.inline
  implicit class IncludeRankTypeMutableBuilder[Self <: IncludeRankType] (val x: Self) extends AnyVal {
