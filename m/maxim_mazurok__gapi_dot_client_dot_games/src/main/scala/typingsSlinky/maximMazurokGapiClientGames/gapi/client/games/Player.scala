...
import typingsSlinky.maximMazurokGapiClientGames.anon.FamilyName
...
object Player {
  ...
  implicit class PlayerMutableBuilder[Self <: Player] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExperienceInfo(value: PlayerExperienceInfo): Self = StObject.set(x, "experienceInfo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExperienceInfoUndefined: Self = StObject.set(x, "experienceInfo", js.undefined)
    
    @scala.inline
    def setFriendStatus(value: String): Self = StObject.set(x, "friendStatus", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFriendStatusUndefined: Self = StObject.set(x, "friendStatus", js.undefined)
