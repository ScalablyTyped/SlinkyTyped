...
import typingsSlinky.maximMazurokGapiClientGames.anon.IncludeRankType
import typingsSlinky.maximMazurokGapiClientGames.anon.PageToken
import typingsSlinky.maximMazurokGapiClientGames.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientGames.anon.Resource
import typingsSlinky.maximMazurokGapiClientGames.anon.ResultsAbove
import typingsSlinky.maximMazurokGapiClientGames.anon.Score
