...
import typingsSlinky.marko.srcCompilerConfigMod.Config
...
object srcCompilerMod extends js.Object {
  ...
  object taglibLoader extends js.Object {
    ...
    def clearCache(): Unit = js.native
    def createTaglib(filePath: String): typingsSlinky.marko.srcCompilerTaglibDashLoaderMod.Taglib = js.native
    def loadTag(tagProps: js.Any, filePath: String): ^ = js.native
    def loadTaglibFromFile(filePath: String): typingsSlinky.marko.srcCompilerTaglibDashLoaderMod.Taglib = js.native
    def loadTaglibFromProps(taglib: typingsSlinky.marko.srcCompilerTaglibDashLoaderMod.Taglib, taglibProps: js.Any): typingsSlinky.marko.srcCompilerTaglibDashLoaderMod.Taglib = js.native
  }
  ...
  object taglibLookup extends js.Object {
    @js.native
    class TaglibLookup ()
      extends typingsSlinky.marko.srcCompilerTaglibDashLookupTaglibLookupMod.default
    
    val registeredTaglibs: js.Array[default] = js.native
    def buildLookup(dirname: String): typingsSlinky.marko.srcCompilerTaglibDashLookupMod.TaglibLookup = js.native
    def clearCache(): Unit = js.native
