...
import typingsSlinky.marko.srcCompilerTaglibDashLoaderAttributeMod.default
...
trait Tag extends js.Object {
  ...
  var transformers: StringDictionary[typingsSlinky.marko.srcCompilerTaglibDashLoaderTransformerMod.default] = js.native
  ...
  def forEachTransformer(
    callback: js.Function1[
      /* transformer */ typingsSlinky.marko.srcCompilerTaglibDashLoaderTransformerMod.default, 
      Unit
    ]
  ): Unit = js.native
  def forEachTransformer(
  ...
  def setTaglib(taglib: typingsSlinky.marko.srcCompilerTaglibDashLoaderTaglibMod.default): Unit = js.native
}
