...
import typingsSlinky.marko.attributeMod.default
...
object tagMod {
  ...
  trait Tag extends StObject {
    ...
    def forEachTransformer(callback: js.Function1[/* transformer */ typingsSlinky.marko.transformerMod.default, Unit]): Unit = js.native
    def forEachTransformer(
      callback: js.Function1[/* transformer */ typingsSlinky.marko.transformerMod.default, Unit],
      thisObj: js.Any
    ): Unit = js.native
    ...
    def setTaglib(taglib: typingsSlinky.marko.taglibMod.default): Unit = js.native
    ...
    var transformers: StringDictionary[typingsSlinky.marko.transformerMod.default] = js.native
