...
object NumberConstructor {
  ...
  implicit class NumberConstructorOps[Self <: NumberConstructor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNEGATIVE_INFINITY(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NEGATIVE_INFINITY")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPOSITIVE_INFINITY(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("POSITIVE_INFINITY")(value.asInstanceOf[js.Any])
        ret
    }
  }
