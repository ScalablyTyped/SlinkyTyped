...
package object miniprogramWxs {
  ...
  /**
    ...
    */
  type Omit[T, K /* <: java.lang.String */] = typingsSlinky.miniprogramWxs.Pick[T, typingsSlinky.miniprogramWxs.Exclude[java.lang.String, K]]
  /**
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsSlinky.miniprogramWxs.miniprogramWxsStrings.Partial with T
  /**
    * From T, pick a set of properties whose keys are in the union K
    */
  type Pick[T, K /* <: java.lang.String */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in K ]: T[P]}
    */ typingsSlinky.miniprogramWxs.miniprogramWxsStrings.Pick with T
  ...
  {readonly [ P in keyof T ]: T[P]}
    */ typingsSlinky.miniprogramWxs.miniprogramWxsStrings.Readonly with T
  /**
    * Construct a type with a set of properties K of type T
    */
  type Record[K /* <: java.lang.String */, T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in K ]: T}
    */ typingsSlinky.miniprogramWxs.miniprogramWxsStrings.Record with js.Any
  /**
    * Make all properties in T required
    */
  type Required[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: -? T[P]}
    */ typingsSlinky.miniprogramWxs.miniprogramWxsStrings.Required with T
  /**
