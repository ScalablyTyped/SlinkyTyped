...
package object miniprogramDashWxs {
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsSlinky.miniprogramDashWxs.miniprogramDashWxsStrings.Partial with T
  /**
    * From T, pick a set of properties whose keys are in the union K
    */
  type Pick[T, K /* <: java.lang.String */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in K ]: T[P]}
    */ typingsSlinky.miniprogramDashWxs.miniprogramDashWxsStrings.Pick with T
  ...
  {readonly [ P in keyof T ]: T[P]}
    */ typingsSlinky.miniprogramDashWxs.miniprogramDashWxsStrings.Readonly with T
  /**
  ...
  {[ P in keyof T ]: -? T[P]}
    */ typingsSlinky.miniprogramDashWxs.miniprogramDashWxsStrings.Required with T
  /**
