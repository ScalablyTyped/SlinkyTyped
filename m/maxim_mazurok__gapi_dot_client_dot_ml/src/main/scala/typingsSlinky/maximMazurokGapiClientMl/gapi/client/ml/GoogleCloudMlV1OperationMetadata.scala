...
import typingsSlinky.maximMazurokGapiClientMl.maximMazurokGapiClientMlStrings.GoogleCloudMlV1__OperationMetadata
...
trait GoogleCloudMlV1OperationMetadata extends StObject {
  ...
  {[ P in string ]: string}
    */ GoogleCloudMlV1__OperationMetadata with TopLevel[js.Any]
  ] = js.native
