...
@js.native
trait GoogleCloudMlV1EncryptionConfig extends js.Object {
...
object GoogleCloudMlV1EncryptionConfig {
  ...
  @scala.inline
  implicit class GoogleCloudMlV1EncryptionConfigOps[Self <: GoogleCloudMlV1EncryptionConfig] (val x: Self) extends AnyVal {
