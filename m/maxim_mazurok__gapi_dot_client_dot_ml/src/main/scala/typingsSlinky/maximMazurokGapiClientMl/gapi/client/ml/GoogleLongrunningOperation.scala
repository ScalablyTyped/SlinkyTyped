...
import typingsSlinky.maximMazurokGapiClientMl.maximMazurokGapiClientMlStrings.GoogleLongrunning__Operation
...
trait GoogleLongrunningOperation extends StObject {
  ...
  {[ P in string ]: any}
    */ GoogleLongrunning__Operation with TopLevel[js.Any]
  ] = js.native
