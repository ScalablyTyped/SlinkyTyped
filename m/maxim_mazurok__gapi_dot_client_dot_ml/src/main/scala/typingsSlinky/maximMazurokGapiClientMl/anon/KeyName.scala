...
import typingsSlinky.maximMazurokGapiClientMl.gapi.client.ml.GoogleCloudMlV1Model
...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudMlV1Model = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudMlV1Model): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudMlV1Model): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
