...
import typingsSlinky.maximMazurokGapiClientMl.gapi.client.ml.GoogleCloudMlV1Job
...
trait Name extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudMlV1Job = js.native
...
object Name {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudMlV1Job): Name = {
  ...
  implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudMlV1Job): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
