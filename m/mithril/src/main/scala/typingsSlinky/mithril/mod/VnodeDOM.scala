...
object VnodeDOM {
  @scala.inline
  def apply[Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State](attrs: Attrs, dom: Element, state: State, tag: String | (ComponentTypes[Attrs, State])): VnodeDOM[Attrs, State] = {
  ...
  @scala.inline
  implicit class VnodeDOMOps[Self <: VnodeDOM[_, _], Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State] (val x: Self with (VnodeDOM[Attrs, State])) extends AnyVal {
    @scala.inline
