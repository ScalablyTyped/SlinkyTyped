...
object Component {
  @scala.inline
  def apply[Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State](view: Vnode[Attrs, State] => Children | Null | Unit): Component[Attrs, State] = {
    val __obj = js.Dynamic.literal(view = js.Any.fromFunction1(view))
    __obj.asInstanceOf[Component[Attrs, State]]
  }
  @scala.inline
  implicit class ComponentOps[Self <: Component[_, _], Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State] (val x: Self with (Component[Attrs, State])) extends AnyVal {
    @scala.inline
