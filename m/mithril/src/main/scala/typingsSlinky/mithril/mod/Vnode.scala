...
object Vnode {
  @scala.inline
  def apply[Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State](attrs: Attrs, state: State, tag: String | (ComponentTypes[Attrs, State])): Vnode[Attrs, State] = {
  ...
  @scala.inline
  implicit class VnodeOps[Self <: Vnode[_, _], Attrs, /* <: typingsSlinky.mithril.mod.Lifecycle[Attrs, State] */ State] (val x: Self with (Vnode[Attrs, State])) extends AnyVal {
    @scala.inline
