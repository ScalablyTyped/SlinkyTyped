...
import typingsSlinky.maximMazurokGapiClientPubsub.anon.AltCallback
import typingsSlinky.maximMazurokGapiClientPubsub.anon.CallbackFields
...
trait TopicsResource extends js.Object {
  ...
  def delete(request: typingsSlinky.maximMazurokGapiClientPubsub.anon.Topic): Request[js.Object] = js.native
  
  /** Gets the configuration of a topic. */
  def get(): Request[Topic] = js.native
  def get(request: typingsSlinky.maximMazurokGapiClientPubsub.anon.Topic): Request[Topic] = js.native
  ...
  def publish(request: typingsSlinky.maximMazurokGapiClientPubsub.anon.Topic, body: PublishRequest): Request[PublishResponse] = js.native
