...
import typingsSlinky.maximMazurokGapiClientPubsub.anon.AccesstokenAlt
...
import typingsSlinky.maximMazurokGapiClientPubsub.anon.PrettyPrint
import typingsSlinky.maximMazurokGapiClientPubsub.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientPubsub.anon.Resource
...
trait SubscriptionsResource extends StObject {
  ...
  /**
    ...
    */
  def modifyAckDeadline(request: typingsSlinky.maximMazurokGapiClientPubsub.anon.Subscription): Request[js.Object] = js.native
