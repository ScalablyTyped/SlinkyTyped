...
import typingsSlinky.maximMazurokGapiClientPubsub.gapi.client.pubsub.SeekRequest
...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: SeekRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(resource: SeekRequest, subscription: String): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SeekRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
