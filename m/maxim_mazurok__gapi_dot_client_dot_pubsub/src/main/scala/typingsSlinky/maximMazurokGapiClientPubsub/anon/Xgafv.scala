...
import typingsSlinky.maximMazurokGapiClientPubsub.gapi.client.pubsub.PullRequest
...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: PullRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(resource: PullRequest, subscription: String): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PullRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
