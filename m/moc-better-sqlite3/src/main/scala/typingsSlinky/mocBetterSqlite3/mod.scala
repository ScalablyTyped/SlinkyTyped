...
object mod extends Shortcut {
  ...
  object MocBetterSqlite3 {
    ...
    object ColumnDefinition {
      ...
      @scala.inline
      def apply(name: String): typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition = {
        val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition]
      }
      
      @scala.inline
      implicit class ColumnDefinitionMutableBuilder[Self <: typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition] (val x: Self) extends AnyVal {
    ...
    trait Database extends StObject {
      ...
      def prepare[BindParameters /* <: js.Array[_] | js.Object */](source: String): typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Statement[js.Array[BindParameters] | BindParameters] = js.native
      
      var readonly: Boolean = js.native
      
      def transaction[F /* <: VariableArgFunction */](fn: F): typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Transaction[F] = js.native
    }
    ...
    trait DatabaseConstructor
      extends Instantiable1[
              /* filename */ String, 
              typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Database
            ]
         with Instantiable2[
              /* filename */ String, 
              /* options */ Options, 
      ...
      def apply(filename: String): typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Database = js.native
      def apply(filename: String, options: Options): typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Database = js.native
    ...
    trait Statement[BindParameters /* <: js.Array[_] */] extends StObject {
      ...
      def columns(): js.Array[typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.ColumnDefinition] = js.native
      
      var database: typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Database = js.native
  ...
  type Transaction = typingsSlinky.mocBetterSqlite3.mod.MocBetterSqlite3.Transaction[VariableArgFunction]
