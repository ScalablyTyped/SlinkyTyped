...
@js.native
trait GoogleCloudAssuredworkloadsV1beta1Workload extends js.Object {
...
object GoogleCloudAssuredworkloadsV1beta1Workload {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1beta1WorkloadOps[Self <: GoogleCloudAssuredworkloadsV1beta1Workload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCjisSettings(value: GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings): Self = this.set("cjisSettings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCjisSettings: Self = this.set("cjisSettings", js.undefined)
    ...
    @scala.inline
    def setFedrampHighSettings(value: GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings): Self = this.set("fedrampHighSettings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFedrampHighSettings: Self = this.set("fedrampHighSettings", js.undefined)
    
    @scala.inline
    def setFedrampModerateSettings(value: GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings): Self = this.set("fedrampModerateSettings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFedrampModerateSettings: Self = this.set("fedrampModerateSettings", js.undefined)
    
    @scala.inline
    def setIl4Settings(value: GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings): Self = this.set("il4Settings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIl4Settings: Self = this.set("il4Settings", js.undefined)
    ...
    @scala.inline
    def setResourcesVarargs(value: GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo*): Self = this.set("resources", js.Array(value :_*))
    
    @scala.inline
    def setResources(value: js.Array[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo]): Self = this.set("resources", value.asInstanceOf[js.Any])
