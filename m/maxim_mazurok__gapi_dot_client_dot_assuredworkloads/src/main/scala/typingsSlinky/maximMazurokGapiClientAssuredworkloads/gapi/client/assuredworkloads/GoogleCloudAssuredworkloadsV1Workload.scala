...
trait GoogleCloudAssuredworkloadsV1Workload extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientAssuredworkloads.maximMazurokGapiClientAssuredworkloadsStrings.GoogleCloudAssuredworkloadsV1Workload with TopLevel[js.Any]
  ] = js.native
