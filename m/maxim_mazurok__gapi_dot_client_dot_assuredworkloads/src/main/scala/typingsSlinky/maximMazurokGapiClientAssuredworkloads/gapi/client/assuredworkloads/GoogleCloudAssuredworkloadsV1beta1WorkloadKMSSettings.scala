...
@js.native
trait GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings extends js.Object {
...
object GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettingsOps[Self <: GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings] (val x: Self) extends AnyVal {
