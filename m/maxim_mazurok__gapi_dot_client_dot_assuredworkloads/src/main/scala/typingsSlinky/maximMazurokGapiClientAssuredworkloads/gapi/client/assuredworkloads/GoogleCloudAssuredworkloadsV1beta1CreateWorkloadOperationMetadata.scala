...
@js.native
trait GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata extends js.Object {
...
object GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadataOps[Self <: GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata] (val x: Self) extends AnyVal {
