...
import typingsSlinky.markDotJs.markDotJsStrings.disabled
import typingsSlinky.markDotJs.markDotJsStrings.enabled
import typingsSlinky.markDotJs.markDotJsStrings.withSpaces
