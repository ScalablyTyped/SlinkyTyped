package typingsSlinky.materialDashUiDashDatatables.materialDashUiDashDatatablesMod

import typingsSlinky.materialDashUiDashDatatables.materialDashUiDashDatatablesStrings.filter
...
trait DataTableProps extends js.Object {
  ...
  var headerToolbarMode: typingsSlinky.materialDashUiDashDatatables.materialDashUiDashDatatablesStrings.default | filter | String
...
object DataTableProps {
  ...
  def apply(
    ...
    headerToolbarMode: typingsSlinky.materialDashUiDashDatatables.materialDashUiDashDatatablesStrings.default | filter | String,
    height: js.Any,
