...
object mod {
  ...
  type DataTable = ReactComponentClass[PartialDataTableProps]
  ...
  object DataTableProps {
    ...
    implicit class DataTablePropsMutableBuilder[Self <: DataTableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHeaderToolbarMode(value: typingsSlinky.materialUiDatatables.materialUiDatatablesStrings.default | filter | String): Self = StObject.set(x, "headerToolbarMode", value.asInstanceOf[js.Any])
