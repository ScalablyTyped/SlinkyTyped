...
object DataTableProps {
  ...
  implicit class DataTablePropsOps[Self <: DataTableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeaderToolbarMode(value: typingsSlinky.materialUiDatatables.materialUiDatatablesStrings.default | filter | String): Self = this.set("headerToolbarMode", value.asInstanceOf[js.Any])
    @scala.inline
