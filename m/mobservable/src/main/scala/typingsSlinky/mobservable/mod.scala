...
import typingsSlinky.mobservable.transformMod.ITransformer
...
object mod {
  ...
  @JSImport("mobservable", "makeReactive")
  @js.native
  def makeReactive(value: js.Date): IObservableValue[js.Date] = js.native
  @JSImport("mobservable", "makeReactive")
  @js.native
  def makeReactive(value: js.Function): IObservableValue[js.Function] = js.native
  @JSImport("mobservable", "makeReactive")
  @js.native
  def makeReactive(value: js.RegExp): IObservableValue[js.RegExp] = js.native
  @JSImport("mobservable", "makeReactive")
  @js.native
  ...
  @js.native
  def map[V](): typingsSlinky.mobservable.observablemapMod.ObservableMap[V] = js.native
  @JSImport("mobservable", "map")
  @js.native
  def map[V](initialValues: js.UndefOr[scala.Nothing], valueModifier: js.Function): typingsSlinky.mobservable.observablemapMod.ObservableMap[V] = js.native
  @JSImport("mobservable", "map")
  @js.native
  def map[V](initialValues: KeyValueMap[V]): typingsSlinky.mobservable.observablemapMod.ObservableMap[V] = js.native
  @JSImport("mobservable", "map")
  @js.native
  def map[V](initialValues: KeyValueMap[V], valueModifier: js.Function): typingsSlinky.mobservable.observablemapMod.ObservableMap[V] = js.native
