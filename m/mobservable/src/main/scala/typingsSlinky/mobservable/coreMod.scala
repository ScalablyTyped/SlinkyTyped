...
object coreMod {
  ...
  object ValueMode extends StObject {
    ...
    /* 3 */ val Flat: typingsSlinky.mobservable.coreMod.ValueMode.Flat with Double = js.native
    
    @js.native
    sealed trait Recursive extends ValueMode
    /* 0 */ val Recursive: typingsSlinky.mobservable.coreMod.ValueMode.Recursive with Double = js.native
    
    @js.native
    sealed trait Reference extends ValueMode
    /* 1 */ val Reference: typingsSlinky.mobservable.coreMod.ValueMode.Reference with Double = js.native
    
    @js.native
    sealed trait Structure extends ValueMode
    /* 2 */ val Structure: typingsSlinky.mobservable.coreMod.ValueMode.Structure with Double = js.native
  }
  ...
  object ValueType extends StObject {
    ...
    /* 3 */ val Array: typingsSlinky.mobservable.coreMod.ValueType.Array with Double = js.native
    
    @js.native
    sealed trait ComplexFunction extends ValueType
    /* 5 */ val ComplexFunction: typingsSlinky.mobservable.coreMod.ValueType.ComplexFunction with Double = js.native
    
    @js.native
    sealed trait ComplexObject extends ValueType
    /* 2 */ val ComplexObject: typingsSlinky.mobservable.coreMod.ValueType.ComplexObject with Double = js.native
    
    @js.native
    sealed trait PlainObject extends ValueType
    /* 1 */ val PlainObject: typingsSlinky.mobservable.coreMod.ValueType.PlainObject with Double = js.native
    
    @js.native
    sealed trait Reference extends ValueType
    /* 0 */ val Reference: typingsSlinky.mobservable.coreMod.ValueType.Reference with Double = js.native
    
    @js.native
    sealed trait ViewFunction extends ValueType
    /* 4 */ val ViewFunction: typingsSlinky.mobservable.coreMod.ValueType.ViewFunction with Double = js.native
  }
  ...
  @JSImport("mobservable/lib/core", "observable")
  @js.native
  def observable(value: js.Date): IObservableValue[js.Date] = js.native
  @JSImport("mobservable/lib/core", "observable")
  @js.native
  def observable(value: js.Function): IObservableValue[js.Function] = js.native
  @JSImport("mobservable/lib/core", "observable")
  @js.native
  def observable(value: js.RegExp): IObservableValue[js.RegExp] = js.native
  @JSImport("mobservable/lib/core", "observable")
  @js.native
