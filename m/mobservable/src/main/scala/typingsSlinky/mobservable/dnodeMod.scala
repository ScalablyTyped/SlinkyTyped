...
object dnodeMod {
  ...
  object NodeState extends StObject {
    ...
    /* 1 */ val PENDING: typingsSlinky.mobservable.dnodeMod.NodeState.PENDING with Double = js.native
    
    @js.native
    sealed trait READY extends NodeState
    /* 2 */ val READY: typingsSlinky.mobservable.dnodeMod.NodeState.READY with Double = js.native
    
    @js.native
    sealed trait STALE extends NodeState
    /* 0 */ val STALE: typingsSlinky.mobservable.dnodeMod.NodeState.STALE with Double = js.native
  }
