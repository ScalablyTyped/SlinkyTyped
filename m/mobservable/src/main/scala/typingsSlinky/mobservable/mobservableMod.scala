...
object mobservableMod extends js.Object {
  ...
  def makeReactive(target: js.Object, key: String, baseDescriptor: js.PropertyDescriptor): js.Any = js.native
  ...
  def makeReactive(value: Date): IObservableValue[js.Date] = js.native
  def makeReactive(value: RegExp): IObservableValue[js.RegExp] = js.native
  ...
  def map[V](): typingsSlinky.mobservable.libObservablemapMod.ObservableMap[V] = js.native
  def map[V](initialValues: KeyValueMap[V]): typingsSlinky.mobservable.libObservablemapMod.ObservableMap[V] = js.native
  def map[V](initialValues: KeyValueMap[V], valueModifier: js.Function): typingsSlinky.mobservable.libObservablemapMod.ObservableMap[V] = js.native
