...
/* Inlined mocha-sugar-free.mocha-sugar-free.Options & {  title  :string,   fn ? :mocha-sugar-free.mocha-sugar-free.SuiteFunc} */
@js.native
trait OptionstitlestringfnSuite
  ...
  /**
  		 * The test function.
  		 */
  var fn: js.UndefOr[(TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with SuiteFunc] = js.native
  /**
...
object OptionstitlestringfnSuite {
  @scala.inline
  def apply(): OptionstitlestringfnSuite = {
  ...
  implicit class OptionstitlestringfnSuiteOps[Self <: OptionstitlestringfnSuite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFn(value: (TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with SuiteFunc): Self = {
        val ret = this.duplicate
