...
/* Inlined mocha-sugar-free.mocha-sugar-free.Options & {  fn ? :mocha-sugar-free.mocha-sugar-free.HookFunc} */
@js.native
trait OptionsfnHookFunc
  ...
  /**
  		 * The test function.
  		 */
  var fn: js.UndefOr[(TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with HookFunc] = js.native
  /**
...
object OptionsfnHookFunc {
  @scala.inline
  def apply(): OptionsfnHookFunc = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OptionsfnHookFunc]
  }
  @scala.inline
  implicit class OptionsfnHookFuncOps[Self <: OptionsfnHookFunc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFn(value: (TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with HookFunc): Self = {
        val ret = this.duplicate
