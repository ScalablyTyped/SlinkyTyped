...
trait OptionsfnHookFunc
  ...
  /**
  		 * The test function.
  		 */
  var fn: js.UndefOr[(TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with HookFunc] = js.undefined
  /**
...
object OptionsfnHookFunc {
  ...
  def apply(
    ...
    fn: (TestCase | TestCaseWithDone | SuiteFunc | HookFunc) with HookFunc = null,
