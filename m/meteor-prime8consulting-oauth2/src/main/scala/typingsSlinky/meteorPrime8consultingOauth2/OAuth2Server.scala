...
object OAuth2Server {
  ...
  object OAuth2Server {
    ...
    def apply(
    ...
    ): typingsSlinky.meteorPrime8consultingOauth2.OAuth2Server.OAuth2Server = {
      ...
      __obj.asInstanceOf[typingsSlinky.meteorPrime8consultingOauth2.OAuth2Server.OAuth2Server]
    }
    
    @scala.inline
    implicit class OAuth2ServerMutableBuilder[Self <: typingsSlinky.meteorPrime8consultingOauth2.OAuth2Server.OAuth2Server] (val x: Self) extends AnyVal {
