package typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Query

import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.AttributeBase
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Collection
