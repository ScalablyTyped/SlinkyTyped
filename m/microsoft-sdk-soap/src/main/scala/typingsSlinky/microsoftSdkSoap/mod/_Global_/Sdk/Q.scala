...
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Query.FetchExpression
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Query.QueryByAttribute
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Query.QueryExpression
