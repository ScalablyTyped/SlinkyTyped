...
object LogicalOperator extends StObject {
  ...
  /* 1 */ val And: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Query.LogicalOperator.And with Double = js.native
  
  @js.native
  sealed trait Or extends LogicalOperator
  /* 0 */ val Or: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Query.LogicalOperator.Or with Double = js.native
}
