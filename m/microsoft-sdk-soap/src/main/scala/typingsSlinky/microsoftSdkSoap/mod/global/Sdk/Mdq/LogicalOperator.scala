...
object LogicalOperator extends StObject {
  ...
  /* 0 */ val And: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Mdq.LogicalOperator.And with Double = js.native
  
  @js.native
  sealed trait Or extends LogicalOperator
  /* 1 */ val Or: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Mdq.LogicalOperator.Or with Double = js.native
}
