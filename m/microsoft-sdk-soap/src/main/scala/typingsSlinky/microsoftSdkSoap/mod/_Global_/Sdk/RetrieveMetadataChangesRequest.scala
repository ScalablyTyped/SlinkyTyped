...
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Mdq.DeletedMetadataFilters
import typingsSlinky.microsoftSdkSoap.mod._Global_.Sdk.Mdq.EntityQueryExpression
