...
import typingsSlinky.microsoftSdkSoap.microsoftSdkSoapStrings.`None    OrganizationOwned`
import typingsSlinky.microsoftSdkSoap.microsoftSdkSoapStrings.`TeamOwned    UserOwned`
