...
trait OneToManyRelationshipMetadata extends js.Object {
  ...
  var AssociatedMenuConfiguration: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Mdq.AssociatedMenuConfiguration = js.native
  
  var CascadeConfiguration: typingsSlinky.microsoftSdkSoap.mod.global.Sdk.Mdq.CascadeConfiguration = js.native
