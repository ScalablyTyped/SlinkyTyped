...
import typingsSlinky.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapStrings.NoneBACKSLASHtOrganizationOwned
import typingsSlinky.microsoftDashSdkDashSoap.microsoftDashSdkDashSoapStrings.TeamOwnedBACKSLASHtUserOwned
