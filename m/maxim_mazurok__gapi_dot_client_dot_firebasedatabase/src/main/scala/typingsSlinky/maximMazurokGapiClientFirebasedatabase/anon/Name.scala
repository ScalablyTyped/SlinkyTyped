package typingsSlinky.maximMazurokGapiClientFirebasedatabase.anon
...
object Name {
  ...
  implicit class NameOps[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReenableDatabaseInstanceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
