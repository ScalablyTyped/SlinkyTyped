...
object mod {
  ...
  object DialogButtonOptions {
    ...
    implicit class DialogButtonOptionsMutableBuilder[Self <: DialogButtonOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndIconReactElement(value: ReactElement): Self = StObject.set(x, "endIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStartIconReactElement(value: ReactElement): Self = StObject.set(x, "startIcon", value.asInstanceOf[js.Any])
