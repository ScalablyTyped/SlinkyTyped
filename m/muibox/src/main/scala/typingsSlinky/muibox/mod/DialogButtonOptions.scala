...
object DialogButtonOptions {
  ...
  implicit class DialogButtonOptionsOps[Self <: DialogButtonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndIconReactElement(value: ReactElement): Self = this.set("endIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEndIcon(value: ReactElement): Self = this.set("endIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEndIcon: Self = this.set("endIcon", js.undefined)
    
    @scala.inline
    def setStartIconReactElement(value: ReactElement): Self = this.set("startIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStartIcon(value: ReactElement): Self = this.set("startIcon", value.asInstanceOf[js.Any])
