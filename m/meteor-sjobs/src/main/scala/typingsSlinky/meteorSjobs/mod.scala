package typingsSlinky.meteorSjobs

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.meteorSjobs.meteorSjobsBooleans.`false`
import typingsSlinky.meteorSjobs.meteorSjobsBooleans.`true`
...
object mod {
  ...
  trait HistoryItem extends StObject {
    ...
    var newDue: js.UndefOr[js.Date] = js.native
  ...
  object HistoryItem {
    ...
    @scala.inline
    def apply(date: js.Date, serverId: String): HistoryItem = {
    ...
    implicit class HistoryItemMutableBuilder[Self <: HistoryItem] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNewDue(value: js.Date): Self = StObject.set(x, "newDue", value.asInstanceOf[js.Any])
  ...
  object Job {
    ...
    implicit class JobMutableBuilder[Self <: Job] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDue(value: js.Date): Self = StObject.set(x, "due", value.asInstanceOf[js.Any])
  ...
  trait JobRunConfigObject extends StObject {
    ...
    var date: js.UndefOr[js.Function0[js.Date]] = js.native
  ...
  object JobRunConfigObject {
    ...
    implicit class JobRunConfigObjectMutableBuilder[Self <: JobRunConfigObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDate(value: () => js.Date): Self = StObject.set(x, "date", js.Any.fromFunction0(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.pending
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.success
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.failure
  */
  trait JobState extends StObject
  object JobState {
    
    @scala.inline
    def failure: typingsSlinky.meteorSjobs.meteorSjobsStrings.failure = "failure".asInstanceOf[typingsSlinky.meteorSjobs.meteorSjobsStrings.failure]
    
    @scala.inline
    def pending: typingsSlinky.meteorSjobs.meteorSjobsStrings.pending = "pending".asInstanceOf[typingsSlinky.meteorSjobs.meteorSjobsStrings.pending]
    
    @scala.inline
    def success: typingsSlinky.meteorSjobs.meteorSjobsStrings.success = "success".asInstanceOf[typingsSlinky.meteorSjobs.meteorSjobsStrings.success]
  }
  ...
  trait Options extends StObject {
    ...
    var getDate: js.UndefOr[js.Function0[js.Date]] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.success
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.failure
    - typingsSlinky.meteorSjobs.meteorSjobsStrings.Asterisk
  */
  trait State extends StObject
  object State {
    
    @scala.inline
    def Asterisk: typingsSlinky.meteorSjobs.meteorSjobsStrings.Asterisk = "*".asInstanceOf[typingsSlinky.meteorSjobs.meteorSjobsStrings.Asterisk]
