...
object NavLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mirrorx.mod.NavLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.mirrorx.mod.NavLink] = {
