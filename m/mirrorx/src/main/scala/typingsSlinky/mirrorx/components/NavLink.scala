...
import typingsSlinky.mirrorx.mirrorxMod.NavLinkProps
...
object NavLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mirrorx.mirrorxMod.NavLink] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.mirrorx.mirrorxMod.NavLink] = {
