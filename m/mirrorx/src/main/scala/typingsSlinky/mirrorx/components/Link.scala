...
import typingsSlinky.mirrorx.mirrorxMod.LinkProps
...
object Link
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mirrorx.mirrorxMod.Link] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.mirrorx.mirrorxMod.Link] = {
