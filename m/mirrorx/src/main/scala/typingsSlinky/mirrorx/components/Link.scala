...
import typingsSlinky.mirrorx.mod.LinkProps
...
object Link
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mirrorx.mod.Link] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.mirrorx.mod.Link] = {
