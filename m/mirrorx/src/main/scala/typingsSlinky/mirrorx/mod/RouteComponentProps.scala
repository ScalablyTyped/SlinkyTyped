...
{[ K in keyof Params ]:? string}
  */ typingsSlinky.mirrorx.mirrorxStrings.RouteComponentProps with js.Any */] extends js.Object {
...
object RouteComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    */ typingsSlinky.mirrorx.mirrorxStrings.RouteComponentProps with js.Any */](
