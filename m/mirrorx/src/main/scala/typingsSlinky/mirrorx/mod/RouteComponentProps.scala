...
object RouteComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.mirrorx.mirrorxStrings.RouteComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params](history: History[LocationState], location: Location[LocationState], `match`: `match`[Params]): RouteComponentProps[Params] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typingsSlinky.mirrorx.mirrorxStrings.RouteComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params] (val x: Self with RouteComponentProps[Params]) extends AnyVal {
    @scala.inline
