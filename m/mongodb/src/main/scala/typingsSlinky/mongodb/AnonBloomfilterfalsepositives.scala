...
@js.native
trait AnonBloomfilterfalsepositives extends js.Object {
...
object AnonBloomfilterfalsepositives {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBloomfilterfalsepositives]
  }
  @scala.inline
  implicit class AnonBloomfilterfalsepositivesOps[Self <: AnonBloomfilterfalsepositives] (val x: Self) extends AnyVal {
    @scala.inline
