...
object `2` {
  @scala.inline
  def apply[/* <: / * import warning: importer.ImportType#apply Failed type conversion: {  _id :any | undefined} * / js.Any */ TSchema](): `2`[TSchema] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`2`[TSchema]]
  }
  @scala.inline
  implicit class `2Ops`[Self <: `2`[_], /* <: / * import warning: importer.ImportType#apply Failed type conversion: {  _id :any | undefined} * / js.Any */ TSchema] (val x: Self with `2`[TSchema]) extends AnyVal {
    @scala.inline
