...
object AnonCaseSensitive {
  ...
  implicit class AnonCaseSensitiveOps[Self <: AnonCaseSensitive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with$diacraticSensitive(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$diacraticSensitive")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def without$diacraticSensitive: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("$diacraticSensitive")(js.undefined)
        ret
    }
    @scala.inline
