...
@js.native
class Timestamp ()
  extends typingsSlinky.bson.bsonMod.Timestamp
...
object Timestamp extends js.Object {
  ...
  /**
    ...
    */
  def fromBits(lowBits: scala.Double, highBits: scala.Double): typingsSlinky.bson.bsonMod.Timestamp = js.native
  /** Returns a Timestamp represented by the given (32-bit) integer value */
  def fromInt(value: scala.Double): typingsSlinky.bson.bsonMod.Timestamp = js.native
  /** Returns a Timestamp representing the given number value, provided that it is a finite number. */
  def fromNumber(value: scala.Double): typingsSlinky.bson.bsonMod.Timestamp = js.native
  /**
  ...
  def fromString(str: String, opt_radix: scala.Double): typingsSlinky.bson.bsonMod.Timestamp = js.native
}
