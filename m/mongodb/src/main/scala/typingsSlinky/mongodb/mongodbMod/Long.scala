...
@js.native
class Long ()
  extends typingsSlinky.bson.bsonMod.Long
...
object Long extends js.Object {
  ...
  /**
    ...
    */
  def fromBits(lowBits: scala.Double, highBits: scala.Double): typingsSlinky.bson.bsonMod.Long = js.native
  /** Returns a Long representing the given (32-bit) integer value. */
  def fromInt(i: scala.Double): typingsSlinky.bson.bsonMod.Long = js.native
  /** Returns a Long representing the given value, provided that it is a finite number. Otherwise, zero is returned. */
  def fromNumber(n: scala.Double): typingsSlinky.bson.bsonMod.Long = js.native
  /**
  ...
  def fromString(s: String, opt_radix: scala.Double): typingsSlinky.bson.bsonMod.Long = js.native
}
