...
import typingsSlinky.mongodb.Anon_End
import typingsSlinky.mongodb.Anon_EndRevision
...
class GridFSBucket protected () extends js.Object {
  ...
  def delete(id: typingsSlinky.bson.bsonMod.ObjectId): Unit = js.native
  def delete(id: typingsSlinky.bson.bsonMod.ObjectId, callback: GridFSBucketErrorCallback): Unit = js.native
  ...
  def openDownloadStream(id: typingsSlinky.bson.bsonMod.ObjectId): GridFSBucketReadStream = js.native
  def openDownloadStream(id: typingsSlinky.bson.bsonMod.ObjectId, options: Anon_End): GridFSBucketReadStream = js.native
  ...
  def rename(id: typingsSlinky.bson.bsonMod.ObjectId, filename: String): Unit = js.native
  def rename(id: typingsSlinky.bson.bsonMod.ObjectId, filename: String, callback: GridFSBucketErrorCallback): Unit = js.native
}
