...
package object mongodbMod {
  ...
  type BitwiseQuery = scala.Double | typingsSlinky.bson.bsonMod.Binary | js.Array[scala.Double]
  ...
  type GridFSBucketWriteStreamId = String | scala.Double | js.Object | typingsSlinky.bson.bsonMod.ObjectId
