...
/**
  ...
  */
class ObjectID ()
  extends typingsSlinky.bson.bsonMod.ObjectID {
  def this(id: String) = this()
  def this(id: scala.Double) = this()
  def this(id: typingsSlinky.bson.bsonMod.ObjectId) = this()
}
...
object ObjectID extends js.Object {
  ...
  /**
    ...
    * @return {ObjectId} return the created ObjectId
    */
  def createFromTime(time: scala.Double): typingsSlinky.bson.bsonMod.ObjectId = js.native
  /**
