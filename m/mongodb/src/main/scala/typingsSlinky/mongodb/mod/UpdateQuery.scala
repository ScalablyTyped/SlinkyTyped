...
trait UpdateQuery[TSchema] extends js.Object {
  ...
  @JSName("$currentDate")
  var $currentDate: js.UndefOr[OnlyFieldsOfType[TSchema, js.Date, `true` | Type]] = js.undefined
  @JSName("$inc")
...
object UpdateQuery {
  ...
  def apply[TSchema](
    ...
    $bit: StringDictionary[typingsSlinky.mongodb.mongodbStrings.UpdateQuery with TopLevel[js.Any]] = null,
    $currentDate: OnlyFieldsOfType[TSchema, js.Date, `true` | Type] = null,
