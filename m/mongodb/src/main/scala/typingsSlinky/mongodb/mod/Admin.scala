...
import typingsSlinky.mongodb.AnonMaxTimeMS
import typingsSlinky.mongodb.AnonNameOnly
import typingsSlinky.mongodb.AnonSessionClientSession
...
trait Admin extends js.Object {
  ...
  def buildInfo(options: AnonSessionClientSession): js.Promise[_] = js.native
  def buildInfo(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def command(command: js.Object, options: AnonMaxTimeMS): js.Promise[_] = js.native
  def command(command: js.Object, options: AnonMaxTimeMS, callback: MongoCallback[_]): Unit = js.native
  ...
  def listDatabases(options: AnonNameOnly): js.Promise[_] = js.native
  def listDatabases(options: AnonNameOnly, callback: MongoCallback[_]): Unit = js.native
  ...
  def ping(options: AnonSessionClientSession): js.Promise[_] = js.native
  def ping(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def replSetGetStatus(options: AnonSessionClientSession): js.Promise[_] = js.native
  def replSetGetStatus(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
  ...
  def serverStatus(options: AnonSessionClientSession): js.Promise[_] = js.native
  def serverStatus(options: AnonSessionClientSession, callback: MongoCallback[_]): Unit = js.native
