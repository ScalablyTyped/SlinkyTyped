...
trait Admin extends js.Object {
  ...
  def buildInfo(options: `0`): js.Promise[_] = js.native
  def buildInfo(options: `0`, callback: MongoCallback[_]): Unit = js.native
  ...
  def ping(options: `0`): js.Promise[_] = js.native
  def ping(options: `0`, callback: MongoCallback[_]): Unit = js.native
  ...
  def replSetGetStatus(options: `0`): js.Promise[_] = js.native
  def replSetGetStatus(options: `0`, callback: MongoCallback[_]): Unit = js.native
  ...
  def serverStatus(options: `0`): js.Promise[_] = js.native
  def serverStatus(options: `0`, callback: MongoCallback[_]): Unit = js.native
