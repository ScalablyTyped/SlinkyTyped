...
import typingsSlinky.mongodb.AnonEnd
import typingsSlinky.mongodb.AnonRevision
...
class GridFSBucket protected () extends js.Object {
  ...
  def openDownloadStream(id: typingsSlinky.bson.mod.ObjectId, options: AnonEnd): GridFSBucketReadStream = js.native
