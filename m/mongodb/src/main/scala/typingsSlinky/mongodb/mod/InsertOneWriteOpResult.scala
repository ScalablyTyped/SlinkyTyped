...
object InsertOneWriteOpResult {
  @scala.inline
  def apply[/* <: typingsSlinky.mongodb.anon.IdAny */ TSchema](
    connection: js.Any,
  ...
  @scala.inline
  implicit class InsertOneWriteOpResultOps[Self <: InsertOneWriteOpResult[_], /* <: typingsSlinky.mongodb.anon.IdAny */ TSchema] (val x: Self with InsertOneWriteOpResult[TSchema]) extends AnyVal {
    @scala.inline
