...
object ChangeEventBase {
  @scala.inline
  def apply[/* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema](_id: ResumeToken, clusterTime: typingsSlinky.bson.mod.Timestamp, ns: Coll): ChangeEventBase[TSchema] = {
  ...
  implicit class ChangeEventBaseOps[Self <: ChangeEventBase[_], /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */ TSchema] (val x: Self with ChangeEventBase[TSchema]) extends AnyVal {
    ...
    @scala.inline
    def setClusterTime(value: typingsSlinky.bson.mod.Timestamp): Self = this.set("clusterTime", value.asInstanceOf[js.Any])
    @scala.inline
