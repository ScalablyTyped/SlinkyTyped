...
object InsertWriteOpResult {
  ...
  @scala.inline
  implicit class InsertWriteOpResultOps[Self <: InsertWriteOpResult[_], /* <: typingsSlinky.mongodb.anon.IdAny */ TSchema] (val x: Self with InsertWriteOpResult[TSchema]) extends AnyVal {
    @scala.inline
