...
object QuerySelector {
  ...
  implicit class QuerySelectorOps[Self <: QuerySelector[_], T] (val x: Self with QuerySelector[T]) extends AnyVal {
    ...
    @scala.inline
    def set$notRegExp(value: js.RegExp): Self = this.set("$not", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$not(value: QuerySelector[T] | js.RegExp): Self = this.set("$not", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def set$regexRegExp(value: js.RegExp): Self = this.set("$regex", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$regex(value: js.RegExp | String): Self = this.set("$regex", value.asInstanceOf[js.Any])
