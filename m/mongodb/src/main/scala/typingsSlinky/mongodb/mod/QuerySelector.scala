...
object QuerySelector {
  ...
  implicit class QuerySelectorMutableBuilder[Self <: QuerySelector[_], T] (val x: Self with QuerySelector[T]) extends AnyVal {
    ...
    @scala.inline
    def set$not(value: QuerySelector[T] | js.RegExp): Self = StObject.set(x, "$not", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$notRegExp(value: js.RegExp): Self = StObject.set(x, "$not", value.asInstanceOf[js.Any])
