...
package object mod {
  ...
  {readonly [ key in mongodb.mongodb.KeysOfAType<TSchema, FieldType> ]:? AssignableType}
    */ typingsSlinky.mongodb.mongodbStrings.AcceptedFields with js.Any
  ...
  type FilterQuery[T] = typingsSlinky.mongodb.mongodbStrings.FilterQuery with T with typingsSlinky.mongodb.mod.RootQuerySelector[T]
  ...
  {readonly [ key in mongodb.mongodb.KeysOfOtherType<TSchema, FieldType> ]:? never}
    */ typingsSlinky.mongodb.mongodbStrings.NotAcceptedFields with js.Any
  ...
  type OptionalId[TSchema /* <: typingsSlinky.mongodb.AnonIdAny */] = typingsSlinky.mongodb.mod.WithId[TSchema] | ((typingsSlinky.mongodb.mod.EnhancedOmit[TSchema, typingsSlinky.mongodb.mongodbStrings._id]) with typingsSlinky.mongodb.AnonIdExtractIdType[TSchema])
  type PullAllOperator[TSchema] = typingsSlinky.mongodb.mongodbStrings.PullAllOperator with TSchema with (typingsSlinky.mongodb.mod.NotAcceptedFields[TSchema, js.Array[_]]) with org.scalablytyped.runtime.StringDictionary[js.Array[_]]
  type PullOperator[TSchema] = typingsSlinky.mongodb.mongodbStrings.PullOperator with js.Any with (typingsSlinky.mongodb.mod.NotAcceptedFields[TSchema, js.Array[_]]) with (org.scalablytyped.runtime.StringDictionary[typingsSlinky.mongodb.mod.QuerySelector[_] | js.Any])
  type PushOperator[TSchema] = typingsSlinky.mongodb.mongodbStrings.PushOperator with js.Any with (typingsSlinky.mongodb.mod.NotAcceptedFields[TSchema, js.Array[_]]) with (org.scalablytyped.runtime.StringDictionary[typingsSlinky.mongodb.mod.ArrayOperator[_] | js.Any])
  ...
  {readonly [ key in keyof TSchema ]:? TSchema[key]}
    */ typingsSlinky.mongodb.mongodbStrings.ReadonlyPartial with TSchema
  // we can search using alternative types in mongodb e.g.
  // string types can be searched using a regex in mongo
  // array types can be searched using their element type
  type RegExpForString[T] = T | js.RegExp
  type SetFields[TSchema] = typingsSlinky.mongodb.mongodbStrings.SetFields with js.Any with (typingsSlinky.mongodb.mod.NotAcceptedFields[TSchema, js.UndefOr[js.Array[_]]]) with (org.scalablytyped.runtime.StringDictionary[typingsSlinky.mongodb.mod.AddToSetOperators[_] | js.Any])
  type Unpacked[Type] = Type
  // this adds _id as a required property
  type WithId[TSchema] = (typingsSlinky.mongodb.mod.EnhancedOmit[TSchema, typingsSlinky.mongodb.mongodbStrings._id]) with typingsSlinky.mongodb.Anon2[TSchema]
