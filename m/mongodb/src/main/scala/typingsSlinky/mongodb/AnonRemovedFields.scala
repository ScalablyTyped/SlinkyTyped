...
object AnonRemovedFields {
  @scala.inline
  def apply[TSchema](removedFields: js.Array[/* keyof TSchema */ String], updatedFields: FieldUpdates[TSchema]): AnonRemovedFields[TSchema] = {
  ...
  @scala.inline
  implicit class AnonRemovedFieldsOps[Self[tschema] <: AnonRemovedFields[tschema], TSchema] (val x: Self[TSchema]) extends AnyVal {
    @scala.inline
