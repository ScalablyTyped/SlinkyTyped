...
object Directory {
  ...
  def apply(
    ...
    getCTime: () => js.Date,
    getGid: () => Double,
    getItem: String => typingsSlinky.mockFs.itemMod.^  | Null,
    getMTime: () => js.Date,
    getMode: () => Double,
    getStats: () => Stats,
    getUid: () => Double,
    list: () => js.Array[String],
    removeItem: String => typingsSlinky.mockFs.itemMod.^,
  ...
  implicit class DirectoryOps[Self <: Directory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetItem(value: String => typingsSlinky.mockFs.itemMod.^  | Null): Self = this.set("getItem", js.Any.fromFunction1(value))
    @scala.inline
    def setList(value: () => js.Array[String]): Self = this.set("list", js.Any.fromFunction0(value))
    @scala.inline
    def setRemoveItem(value: String => typingsSlinky.mockFs.itemMod.^): Self = this.set("removeItem", js.Any.fromFunction1(value))
  }
