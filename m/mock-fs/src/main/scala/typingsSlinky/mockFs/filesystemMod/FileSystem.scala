...
object FileSystem {
  ...
  implicit class FileSystemOps[Self <: FileSystem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetItem(value: String => typingsSlinky.mockFs.itemMod.^): Self = this.set("getItem", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetRoot(value: () => typingsSlinky.mockFs.directoryMod.^): Self = this.set("getRoot", js.Any.fromFunction0(value))
  }
}
