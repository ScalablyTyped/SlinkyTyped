...
object filesystemMod {
  ...
  @js.native
  def directory(): js.Function0[typingsSlinky.mockFs.directoryMod.^] = js.native
  @JSImport("mock-fs/lib/filesystem", "directory")
  @js.native
  def directory(config: DirectoryOptions): js.Function0[typingsSlinky.mockFs.directoryMod.^] = js.native
  ...
  object FileSystem {
    ...
    implicit class FileSystemMutableBuilder[Self <: FileSystem] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetItem(value: String => typingsSlinky.mockFs.itemMod.^): Self = StObject.set(x, "getItem", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetRoot(value: () => typingsSlinky.mockFs.directoryMod.^): Self = StObject.set(x, "getRoot", js.Any.fromFunction0(value))
    }
  }
