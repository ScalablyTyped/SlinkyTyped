...
class ^ () extends Directory {
  /**
    ...
    */
  /* CompleteClass */
  override def addItem[T /* <: typingsSlinky.mockDashFs.libItemMod.^ */](name: String, item: T): T = js.native
  ...
  /* CompleteClass */
  override def getItem(name: String): typingsSlinky.mockDashFs.libItemMod.^  | Null = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeItem(name: String): typingsSlinky.mockDashFs.libItemMod.^ = js.native
  /** Set access time. */
  /* CompleteClass */
