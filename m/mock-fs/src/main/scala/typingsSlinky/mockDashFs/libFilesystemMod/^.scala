...
class ^ () extends FileSystem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getItem(filepath: String): typingsSlinky.mockDashFs.libItemMod.^ = js.native
  /** Get the root directory. */
  /* CompleteClass */
  override def getRoot(): typingsSlinky.mockDashFs.libDirectoryMod.^ = js.native
}
