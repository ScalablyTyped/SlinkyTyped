...
trait FileSystem extends js.Object {
  /**
    ...
    */
  def getItem(filepath: String): typingsSlinky.mockDashFs.libItemMod.^
  /** Get the root directory. */
  def getRoot(): typingsSlinky.mockDashFs.libDirectoryMod.^
}

object FileSystem {
  @scala.inline
  def apply(
    getItem: String => typingsSlinky.mockDashFs.libItemMod.^,
    getRoot: () => typingsSlinky.mockDashFs.libDirectoryMod.^
  ): FileSystem = {
