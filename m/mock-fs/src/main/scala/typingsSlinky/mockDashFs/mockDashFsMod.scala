package typingsSlinky.mockDashFs

import typingsSlinky.mockDashFs.libDirectoryMod.^
import typingsSlinky.mockDashFs.libFilesystemMod.DirectoryItems
import typingsSlinky.mockDashFs.libFilesystemMod.DirectoryOptions
import typingsSlinky.mockDashFs.libFilesystemMod.FileOptions
import typingsSlinky.mockDashFs.libFilesystemMod.Options
import typingsSlinky.mockDashFs.libFilesystemMod.SymlinkOptions
...
@js.native
object mockDashFsMod extends js.Object {
  /**
  ...
  /**
    ...
    */
  def file(): js.Function0[typingsSlinky.mockDashFs.libFileMod.^] = js.native
  def file(config: FileOptions): js.Function0[typingsSlinky.mockDashFs.libFileMod.^] = js.native
  /**
  ...
  /**
    ...
    */
  def symlink(config: SymlinkOptions): js.Function0[typingsSlinky.mockDashFs.libSymlinkMod.^] = js.native
}
