...
import typingsSlinky.micromark.characterCodesMod.Code
...
object libSharedTypesMod {
  ...
  */
  ...
  object HtmlExtension {
    ...
    @scala.inline
    def EnterRecord(enter: Record[Type, js.Function0[Unit]]): typingsSlinky.micromark.anon.EnterRecord = {
      val __obj = js.Dynamic.literal(enter = enter.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.micromark.anon.EnterRecord]
    }
    
    @scala.inline
    def ExitRecord(exit: Record[Type, js.Function0[Unit]]): typingsSlinky.micromark.anon.ExitRecord = {
      val __obj = js.Dynamic.literal(exit = exit.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.micromark.anon.ExitRecord]
    }
  }
