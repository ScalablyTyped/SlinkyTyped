...
object anon {
  ...
  @js.native
  trait EnterRecord
    extends typingsSlinky.micromark.libSharedTypesMod.HtmlExtension {
    
    var enter: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]] = js.native
  }
  object EnterRecord {
    
    @scala.inline
    def apply(enter: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]]): EnterRecord = {
      val __obj = js.Dynamic.literal(enter = enter.asInstanceOf[js.Any])
    ...
    implicit class EnterRecordMutableBuilder[Self <: EnterRecord] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEnter(value: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]]): Self = StObject.set(x, "enter", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ExitRecord
    ...
    var exit: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]] = js.native
  }
  object ExitRecord {
    
    @scala.inline
    def apply(exit: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]]): ExitRecord = {
      val __obj = js.Dynamic.literal(exit = exit.asInstanceOf[js.Any])
    ...
    implicit class ExitRecordMutableBuilder[Self <: ExitRecord] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExit(value: Record[typingsSlinky.micromark.constantTypesMod.Type, js.Function0[Unit]]): Self = StObject.set(x, "exit", value.asInstanceOf[js.Any])
    }
  }
}
