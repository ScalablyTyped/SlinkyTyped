...
import typingsSlinky.atMaterialSlider.atMaterialSliderStrings.`DOTmdc-slider__track-marker:last-child`
import typingsSlinky.atMaterialSlider.atMaterialSliderStrings.`DOTmdc-slider__track`
import typingsSlinky.atMaterialSlider.atMaterialSliderStrings.`MDCSlider:change`
import typingsSlinky.atMaterialSlider.atMaterialSliderStrings.`MDCSlider:input`
