...
trait MongoBinaryDownloadUrl extends js.Object {
  ...
  def getDebianVersionString(os: Os): String
  def getDownloadUrl(): js.Promise[String]
  def getElementaryOSVersionString(os: Os): String
  def getFedoraVersionString(os: Os): String
  def getLegacyVersionString(os: Os): String
  def getLinuxOSVersionString(os: LinuxOs): String
  def getMintVersionString(os: Os): String
  def getRhelVersionString(os: Os): String
  def getSuseVersionString(os: Os): String
  def getUbuntuVersionString(os: LinuxOs): String
  def getos(): js.Promise[Os]
...
object MongoBinaryDownloadUrl {
  ...
  def apply(
    ...
    getDebianVersionString: Os => String,
    getDownloadUrl: () => js.Promise[String],
    getElementaryOSVersionString: Os => String,
    getFedoraVersionString: Os => String,
    getLegacyVersionString: Os => String,
    getLinuxOSVersionString: LinuxOs => String,
    getMintVersionString: Os => String,
    getRhelVersionString: Os => String,
    getSuseVersionString: Os => String,
