...
import typingsSlinky.mongodbDashMemoryDashServerDashCore.Anon_Name
...
trait MongoInstanceDataT extends js.Object {
  ...
  var dbName: String
  var dbPath: String
  var instance: typingsSlinky.mongodbDashMemoryDashServerDashCore.libUtilMongoInstanceMod.default
  var ip: String
  var port: Double
...
object MongoInstanceDataT {
  ...
  def apply(
    ...
    dbName: String,
    dbPath: String,
    instance: typingsSlinky.mongodbDashMemoryDashServerDashCore.libUtilMongoInstanceMod.default,
    ip: String,
    port: Double,
