...
trait Anon_NATIVECONTROLSELECTOR extends js.Object {
  var NATIVE_CONTROL_SELECTOR: String
  var RIPPLE_SURFACE_SELECTOR: String
}

object Anon_NATIVECONTROLSELECTOR {
  @scala.inline
  def apply(NATIVE_CONTROL_SELECTOR: String, RIPPLE_SURFACE_SELECTOR: String): Anon_NATIVECONTROLSELECTOR = {
    ...
    __obj.asInstanceOf[Anon_NATIVECONTROLSELECTOR]
  }
}
