...
@js.native
trait InstantiateWorkflowTemplateRequest extends js.Object {
  
  /** Optional. Map from parameter names to values that should be used for those parameters. Values may not exceed 1000 characters. */
  var parameters: js.UndefOr[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDataproc.maximMazurokGapiClientDataprocStrings.InstantiateWorkflowTemplateRequest with TopLevel[js.Any]
  ] = js.native
...
object InstantiateWorkflowTemplateRequest {
  ...
  @scala.inline
  implicit class InstantiateWorkflowTemplateRequestOps[Self <: InstantiateWorkflowTemplateRequest] (val x: Self) extends AnyVal {
