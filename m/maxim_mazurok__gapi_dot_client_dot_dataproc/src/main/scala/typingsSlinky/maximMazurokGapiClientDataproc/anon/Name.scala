...
import typingsSlinky.maximMazurokGapiClientDataproc.gapi.client.dataproc.AutoscalingPolicy
...
trait Name extends StObject {
  ...
  /** Request body */
  var resource: AutoscalingPolicy = js.native
...
object Name {
  ...
  @scala.inline
  def apply(name: String, resource: AutoscalingPolicy): Name = {
  ...
  implicit class NameMutableBuilder[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AutoscalingPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
