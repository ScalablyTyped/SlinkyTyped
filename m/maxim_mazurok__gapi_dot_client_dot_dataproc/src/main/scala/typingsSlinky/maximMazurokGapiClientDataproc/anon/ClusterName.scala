...
@js.native
trait ClusterName extends StObject {
...
object ClusterName {
  ...
  @scala.inline
  def apply(clusterName: String, projectId: String, region: String): ClusterName = {
  ...
  @scala.inline
  implicit class ClusterNameMutableBuilder[Self <: ClusterName] (val x: Self) extends AnyVal {
