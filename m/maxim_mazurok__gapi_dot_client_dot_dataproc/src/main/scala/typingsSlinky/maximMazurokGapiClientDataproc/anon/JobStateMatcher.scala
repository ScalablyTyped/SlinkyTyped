...
@js.native
trait JobStateMatcher extends StObject {
...
object JobStateMatcher {
  
  @scala.inline
  def apply(projectId: String, region: String): JobStateMatcher = {
  ...
  @scala.inline
  implicit class JobStateMatcherMutableBuilder[Self <: JobStateMatcher] (val x: Self) extends AnyVal {
