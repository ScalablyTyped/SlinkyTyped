...
import typingsSlinky.maximMazurokGapiClientDataproc.gapi.client.dataproc.WorkflowTemplate
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: WorkflowTemplate = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: WorkflowTemplate): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: WorkflowTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
