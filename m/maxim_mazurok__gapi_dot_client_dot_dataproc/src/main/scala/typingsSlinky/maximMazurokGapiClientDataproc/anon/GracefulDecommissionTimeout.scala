...
import typingsSlinky.maximMazurokGapiClientDataproc.gapi.client.dataproc.Cluster
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait GracefulDecommissionTimeout extends js.Object {
  ...
  /** Request body */
  var resource: Cluster = js.native
...
object GracefulDecommissionTimeout {
  ...
  @scala.inline
  implicit class GracefulDecommissionTimeoutOps[Self <: GracefulDecommissionTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Cluster): Self = this.set("resource", value.asInstanceOf[js.Any])
