...
import typingsSlinky.maximMazurokGapiClientDataproc.gapi.client.dataproc.InstantiateWorkflowTemplateRequest
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: InstantiateWorkflowTemplateRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(name: String, resource: InstantiateWorkflowTemplateRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstantiateWorkflowTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
