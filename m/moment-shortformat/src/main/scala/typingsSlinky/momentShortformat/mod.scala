package typingsSlinky.momentShortformat
  ...
  object momentAugmentingMod {
    ...
    trait Moment extends StObject {
      ...
      def short(
        ...
        now: typingsSlinky.momentShortformat.mod.momentAugmentingMod.Moment
      ): String = js.native
      def short(withoutPreOrSuffix: Boolean): String = js.native
      def short(withoutPreOrSuffix: Boolean, now: typingsSlinky.momentShortformat.mod.momentAugmentingMod.Moment): String = js.native
    }
  }
}
