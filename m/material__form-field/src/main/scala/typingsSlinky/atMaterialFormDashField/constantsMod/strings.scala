package typingsSlinky.atMaterialFormDashField.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atMaterialBase.foundationMod.MDCStrings
import typingsSlinky.atMaterialFormDashField.atMaterialFormDashFieldStrings.`Dotmdc-form-field Greaterthansign label`
