package typingsSlinky.maximMazurokGapiClientProdTtSasportal.global.gapi.client
...
object load extends js.Object {
  ...
  def apply(name: prod_tt_sasportal, version: v1alpha1): js.Thenable[Unit] = js.native
  def apply(name: prod_tt_sasportal, version: v1alpha1, callback: js.Function0[_]): Unit = js.native
}
