...
import typingsSlinky.minappEnv.minappEnvNumbers.`11025`
import typingsSlinky.minappEnv.minappEnvNumbers.`12000`
import typingsSlinky.minappEnv.minappEnvNumbers.`16000`
import typingsSlinky.minappEnv.minappEnvNumbers.`1`
import typingsSlinky.minappEnv.minappEnvNumbers.`22050`
import typingsSlinky.minappEnv.minappEnvNumbers.`24000`
import typingsSlinky.minappEnv.minappEnvNumbers.`2`
import typingsSlinky.minappEnv.minappEnvNumbers.`32000`
import typingsSlinky.minappEnv.minappEnvNumbers.`44100`
import typingsSlinky.minappEnv.minappEnvNumbers.`48000`
import typingsSlinky.minappEnv.minappEnvNumbers.`8000`
import typingsSlinky.minappEnv.minappEnvStrings.aac
...
import typingsSlinky.minappEnv.minappEnvStrings.mp3
...
object RecorderManagerStartOption {
  ...
  implicit class RecorderManagerStartOptionOps[Self <: RecorderManagerStartOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAudioSource(value: auto | buildInMic | headsetMic | mic | camcorder | voice_communication | voice_recognition): Self = {
    ...
    @scala.inline
    def withoutEncodeBitRate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("encodeBitRate")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNumberOfChannels(value: `1` | `2`): Self = {
        val ret = this.duplicate
