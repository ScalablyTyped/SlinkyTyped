...
object AppendFileOption {
  ...
  @scala.inline
  implicit class AppendFileOptionMutableBuilder[Self <: AppendFileOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFail(value: /* result */ AppendFileFailCallbackResult => Unit): Self = StObject.set(x, "fail", js.Any.fromFunction1(value))
