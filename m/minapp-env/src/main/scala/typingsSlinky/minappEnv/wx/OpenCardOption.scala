...
trait OpenCardOption extends StObject {
  ...
  /** 需要打开的卡券列表 */
  var cardList: OpenCardRequestInfo = js.native
...
object OpenCardOption {
  ...
  @scala.inline
  def apply(cardList: OpenCardRequestInfo): OpenCardOption = {
  ...
  implicit class OpenCardOptionMutableBuilder[Self <: OpenCardOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCardList(value: OpenCardRequestInfo): Self = StObject.set(x, "cardList", value.asInstanceOf[js.Any])
