...
object ChooseLocationOption {
  ...
  @scala.inline
  implicit class ChooseLocationOptionOps[Self <: ChooseLocationOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ ChooseLocationSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
