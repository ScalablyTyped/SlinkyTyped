...
object StopLocalServiceDiscoveryOption {
  ...
  @scala.inline
  implicit class StopLocalServiceDiscoveryOptionOps[Self <: StopLocalServiceDiscoveryOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFail(value: /* result */ StopLocalServiceDiscoveryFailCallbackResult => Unit): Self = this.set("fail", js.Any.fromFunction1(value))
    @scala.inline
