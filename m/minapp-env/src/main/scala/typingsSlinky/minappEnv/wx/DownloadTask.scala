...
object DownloadTask {
  ...
  implicit class DownloadTaskOps[Self <: DownloadTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOffHeadersReceived(value: DownloadTaskOffHeadersReceivedCallback => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offHeadersReceived")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOffProgressUpdate(value: DownloadTaskOffProgressUpdateCallback => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offProgressUpdate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnHeadersReceived(value: DownloadTaskOnHeadersReceivedCallback => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onHeadersReceived")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnProgressUpdate(value: DownloadTaskOnProgressUpdateCallback => Unit): Self = {
        val ret = this.duplicate
