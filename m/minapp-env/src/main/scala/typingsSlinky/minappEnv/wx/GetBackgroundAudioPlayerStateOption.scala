...
object GetBackgroundAudioPlayerStateOption {
  ...
  @scala.inline
  implicit class GetBackgroundAudioPlayerStateOptionMutableBuilder[Self <: GetBackgroundAudioPlayerStateOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetBackgroundAudioPlayerStateSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
