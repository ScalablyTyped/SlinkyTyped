...
@js.native
trait AddPhoneContactOption extends js.Object {
  ...
  var complete: js.UndefOr[AddPhoneContactCompleteCallback] = js.native
  
  /** 电子邮件 */
  var email: js.UndefOr[String] = js.native
  
  /** 接口调用失败的回调函数 */
  var fail: js.UndefOr[AddPhoneContactFailCallback] = js.native
  ...
  /** 接口调用成功的回调函数 */
  var success: js.UndefOr[AddPhoneContactSuccessCallback] = js.native
...
object AddPhoneContactOption {
  ...
  @scala.inline
  implicit class AddPhoneContactOptionOps[Self <: AddPhoneContactOption] (val x: Self) extends AnyVal {
