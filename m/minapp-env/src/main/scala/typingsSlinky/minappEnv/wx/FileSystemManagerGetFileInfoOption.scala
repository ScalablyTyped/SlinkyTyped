...
object FileSystemManagerGetFileInfoOption {
  ...
  implicit class FileSystemManagerGetFileInfoOptionOps[Self <: FileSystemManagerGetFileInfoOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFail(value: /* result */ GetFileInfoFailCallbackResult => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSuccess(value: /* result */ FileSystemManagerGetFileInfoSuccessCallbackResult => Unit): Self = {
        val ret = this.duplicate
