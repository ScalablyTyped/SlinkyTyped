...
object GetConnectedBluetoothDevicesOption {
  ...
  @scala.inline
  implicit class GetConnectedBluetoothDevicesOptionOps[Self <: GetConnectedBluetoothDevicesOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetConnectedBluetoothDevicesSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
