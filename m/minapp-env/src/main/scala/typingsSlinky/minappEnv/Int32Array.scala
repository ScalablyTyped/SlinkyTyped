...
/**
  ...
  */
@js.native
trait Int32Array extends /* index */ NumberDictionary[Double] {
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _]): Int32Array = js.native
  def filter(
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): Int32Array = js.native
  ...
  val toStringTag: typingsSlinky.minappEnv.minappEnvStrings.Int32Array = js.native
