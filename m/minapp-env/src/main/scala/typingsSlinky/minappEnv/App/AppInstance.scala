...
object AppInstance {
  @scala.inline
  def apply[/* <: typingsSlinky.minappEnv.IAnyObject */ T](): AppInstance[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AppInstance[T]]
  }
  @scala.inline
  implicit class AppInstanceOps[Self <: AppInstance[_], /* <: typingsSlinky.minappEnv.IAnyObject */ T] (val x: Self with AppInstance[T]) extends AnyVal {
    @scala.inline
