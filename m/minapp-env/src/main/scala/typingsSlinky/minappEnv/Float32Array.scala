...
trait Float32Array extends /* index */ NumberDictionary[Double] {
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): Float32Array = js.native
  ...
  val toStringTag: typingsSlinky.minappEnv.minappEnvStrings.Float32Array = js.native
