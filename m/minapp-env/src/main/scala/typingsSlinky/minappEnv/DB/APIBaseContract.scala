...
object APIBaseContract {
  @scala.inline
  def apply[PROMISE_RETURN, CALLBACK_RETURN, /* <: typingsSlinky.minappEnv.IAPIParam[_] */ PARAM, CONTEXT](
  ...
  @scala.inline
  implicit class APIBaseContractOps[Self <: APIBaseContract[_, _, _, _], PROMISE_RETURN, CALLBACK_RETURN, /* <: typingsSlinky.minappEnv.IAPIParam[_] */ PARAM, CONTEXT] (val x: Self with (APIBaseContract[PROMISE_RETURN, CALLBACK_RETURN, PARAM, CONTEXT])) extends AnyVal {
    @scala.inline
