...
object PageInstance {
  @scala.inline
  def apply[/* <: typingsSlinky.minappEnv.IAnyObject */ D, /* <: typingsSlinky.minappEnv.IAnyObject */ T](): PageInstance[D, T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstance[D, T]]
  }
  @scala.inline
  implicit class PageInstanceOps[Self <: PageInstance[_, _], /* <: typingsSlinky.minappEnv.IAnyObject */ D, /* <: typingsSlinky.minappEnv.IAnyObject */ T] (val x: Self with (PageInstance[D, T])) extends AnyVal {
    @scala.inline
