...
object PageInstanceBaseProps {
  @scala.inline
  def apply[/* <: typingsSlinky.minappEnv.IAnyObject */ D](): PageInstanceBaseProps[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstanceBaseProps[D]]
  }
  @scala.inline
  implicit class PageInstanceBasePropsOps[Self <: PageInstanceBaseProps[_], /* <: typingsSlinky.minappEnv.IAnyObject */ D] (val x: Self with PageInstanceBaseProps[D]) extends AnyVal {
    @scala.inline
