...
trait Uint32Array extends /* index */ NumberDictionary[Double] {
  ...
  val toStringTag: typingsSlinky.minappEnv.minappEnvStrings.Uint32Array = js.native
  /**
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, _]): Uint32Array = js.native
  def filter(
