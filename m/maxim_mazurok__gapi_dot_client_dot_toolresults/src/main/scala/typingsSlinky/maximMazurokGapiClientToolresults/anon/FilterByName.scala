...
@js.native
trait FilterByName extends StObject {
...
object FilterByName {
  ...
  @scala.inline
  def apply(projectId: String): FilterByName = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FilterByName]
  }
  
  @scala.inline
  implicit class FilterByNameMutableBuilder[Self <: FilterByName] (val x: Self) extends AnyVal {
