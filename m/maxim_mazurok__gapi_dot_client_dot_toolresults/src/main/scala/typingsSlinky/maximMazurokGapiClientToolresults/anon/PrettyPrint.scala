...
import typingsSlinky.maximMazurokGapiClientToolresults.gapi.client.toolresults.PerfSampleSeries
...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: PerfSampleSeries = js.native
...
object PrettyPrint {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: PerfSampleSeries): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
