...
@js.native
trait HistoryId extends StObject {
...
object HistoryId {
  ...
  @scala.inline
  def apply(executionId: String, historyId: String, projectId: String, stepId: String): HistoryId = {
    ...
    __obj.asInstanceOf[HistoryId]
  }
  
  @scala.inline
  implicit class HistoryIdMutableBuilder[Self <: HistoryId] (val x: Self) extends AnyVal {
