...
@js.native
trait EnvironmentDimensionValueEntry extends js.Object {
...
object EnvironmentDimensionValueEntry {
  ...
  @scala.inline
  implicit class EnvironmentDimensionValueEntryOps[Self <: EnvironmentDimensionValueEntry] (val x: Self) extends AnyVal {
