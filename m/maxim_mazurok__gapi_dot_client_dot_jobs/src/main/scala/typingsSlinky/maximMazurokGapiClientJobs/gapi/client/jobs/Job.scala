...
trait Job extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.jobs.gapi.client.jobs.CustomAttribute}
    */ typingsSlinky.maximMazurokGapiClientJobs.maximMazurokGapiClientJobsStrings.Job with TopLevel[js.Any]
  ] = js.native
...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompensationInfo(value: CompensationInfo): Self = this.set("compensationInfo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDerivedInfo(value: JobDerivedInfo): Self = this.set("derivedInfo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProcessingOptions(value: ProcessingOptions): Self = this.set("processingOptions", value.asInstanceOf[js.Any])
