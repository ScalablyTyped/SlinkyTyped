...
@js.native
trait JobQuery extends js.Object {
...
object JobQuery {
  ...
  @scala.inline
  implicit class JobQueryOps[Self <: JobQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommuteFilter(value: CommuteFilter): Self = this.set("commuteFilter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCompensationFilter(value: CompensationFilter): Self = this.set("compensationFilter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLocationFiltersVarargs(value: LocationFilter*): Self = this.set("locationFilters", js.Array(value :_*))
    
    @scala.inline
    def setLocationFilters(value: js.Array[LocationFilter]): Self = this.set("locationFilters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLocationFilters: Self = this.set("locationFilters", js.undefined)
    
    @scala.inline
    def setPublishTimeRange(value: TimestampRange): Self = this.set("publishTimeRange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQueryLanguageCode(value: String): Self = this.set("queryLanguageCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteQueryLanguageCode: Self = this.set("queryLanguageCode", js.undefined)
  }
}
