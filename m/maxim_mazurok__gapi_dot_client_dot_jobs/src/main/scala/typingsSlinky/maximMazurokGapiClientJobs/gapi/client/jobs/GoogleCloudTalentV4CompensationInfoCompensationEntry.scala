...
@js.native
trait GoogleCloudTalentV4CompensationInfoCompensationEntry extends js.Object {
  ...
  /** Compensation range. */
  var range: js.UndefOr[GoogleCloudTalentV4CompensationInfoCompensationRange] = js.native
...
object GoogleCloudTalentV4CompensationInfoCompensationEntry {
  ...
  @scala.inline
  implicit class GoogleCloudTalentV4CompensationInfoCompensationEntryOps[Self <: GoogleCloudTalentV4CompensationInfoCompensationEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRange(value: GoogleCloudTalentV4CompensationInfoCompensationRange): Self = this.set("range", value.asInstanceOf[js.Any])
