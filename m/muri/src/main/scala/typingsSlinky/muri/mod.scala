...
object mod {
  ...
  */
  ...
  object Host {
    ...
    @scala.inline
    def DefaultHost(host: String, port: Double): typingsSlinky.muri.mod.DefaultHost = {
      val __obj = js.Dynamic.literal(host = host.asInstanceOf[js.Any], port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.muri.mod.DefaultHost]
    }
    
    @scala.inline
    def SocketHost(ipc: String): typingsSlinky.muri.mod.SocketHost = {
      val __obj = js.Dynamic.literal(ipc = ipc.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.muri.mod.SocketHost]
    }
  }
