...
trait GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.managedidentities.gapi.client.managedidentities.MaintenancePolicy}
    */ typingsSlinky.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings with TopLevel[js.Any]
  ] = js.native
}
