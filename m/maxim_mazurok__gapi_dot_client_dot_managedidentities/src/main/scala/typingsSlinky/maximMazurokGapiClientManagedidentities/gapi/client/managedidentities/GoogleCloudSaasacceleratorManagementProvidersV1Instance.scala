...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientManagedidentities.maximMazurokGapiClientManagedidentitiesStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance with TopLevel[js.Any]
  ] = js.native
