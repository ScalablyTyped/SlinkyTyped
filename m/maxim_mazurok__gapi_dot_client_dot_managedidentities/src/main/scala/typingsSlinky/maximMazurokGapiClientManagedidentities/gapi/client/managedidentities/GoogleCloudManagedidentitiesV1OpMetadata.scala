...
@js.native
trait GoogleCloudManagedidentitiesV1OpMetadata extends StObject {
...
object GoogleCloudManagedidentitiesV1OpMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudManagedidentitiesV1OpMetadataMutableBuilder[Self <: GoogleCloudManagedidentitiesV1OpMetadata] (val x: Self) extends AnyVal {
