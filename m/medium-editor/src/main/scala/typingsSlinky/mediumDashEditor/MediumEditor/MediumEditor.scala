...
import typingsSlinky.mediumDashEditor.Anon_Major
...
Instantiable1[
      ...
      typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor
    ]
     with Instantiable2[
      /* elements */ elementType, 
      /* options */ CoreOptions, 
  ...
  // Selection Functions
  def checkSelection(): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
  ...
  // Static Function
  def getEditorFromElement(element: HTMLElement): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
  ...
  def off(
    ...
    useCapture: Boolean
  ): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def off(
    targets: NodeList,
    event: String,
    listener: EventListenerOrEventListenerObject,
  ...
  def subscribe(name: String, listener: js.Function2[/* data */ js.Any, /* editable */ HTMLElement, Unit]): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def trigger(name: String, data: js.Any, editable: HTMLElement): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
  def unsubscribe(name: String, listener: js.Function2[/* data */ js.Any, /* editable */ HTMLElement, Unit]): typingsSlinky.mediumDashEditor.MediumEditor.MediumEditor = js.native
}
