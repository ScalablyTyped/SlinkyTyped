package typingsSlinky.mediumEditor.mod

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.mediumEditor.MediumEditor.CoreOptions
import typingsSlinky.mediumEditor.MediumEditor.MediumEditor
...
@js.native
class ^ protected () extends MediumEditor {
...
@JSImport("medium-editor", JSImport.Namespace)
@js.native
object ^ extends TopLevel[MediumEditor]
