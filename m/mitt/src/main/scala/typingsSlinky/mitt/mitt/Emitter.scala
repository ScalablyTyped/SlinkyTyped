...
trait Emitter extends js.Object {
  ...
  def off(`type`: typingsSlinky.mitt.mittStrings.`*`, handler: WildcardHandler): Unit = js.native
  /**
  ...
  def on(`type`: typingsSlinky.mitt.mittStrings.`*`, handler: WildcardHandler): Unit = js.native
}
