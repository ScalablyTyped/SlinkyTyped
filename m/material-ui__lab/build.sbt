...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "material-ui__core" % "3.9.3-46c655",
  ...
  "org.scalablytyped.slinky" %%% "react-transition-group" % "4.2-dt-20200225Z-c22a7c",
