...
object RatingProps {
  ...
  implicit class RatingPropsOps[Self <: RatingProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconContainerComponentFunctionComponent(value: ReactComponentClass[IconContainerProps]): Self = this.set("IconContainerComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconContainerComponentComponentClass(value: ReactComponentClass[IconContainerProps]): Self = this.set("IconContainerComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconContainerComponent(value: ReactElement): Self = this.set("IconContainerComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEmptyIconReactElement(value: ReactElement): Self = this.set("emptyIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmptyIcon(value: ReactElement): Self = this.set("emptyIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEmptyIcon: Self = this.set("emptyIcon", js.undefined)
    
    @scala.inline
    def setEmptyLabelTextReactElement(value: ReactElement): Self = this.set("emptyLabelText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmptyLabelText(value: ReactElement): Self = this.set("emptyLabelText", value.asInstanceOf[js.Any])
