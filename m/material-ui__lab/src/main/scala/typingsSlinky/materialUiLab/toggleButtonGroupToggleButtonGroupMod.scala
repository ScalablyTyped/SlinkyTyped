...
import typingsSlinky.materialUiLab.anon.PartialClassNameMapToggle
...
object toggleButtonGroupToggleButtonGroupMod {
  
  @JSImport("@material-ui/lab/ToggleButtonGroup/ToggleButtonGroup", JSImport.Default)
  @js.native
  def default(props: ToggleButtonGroupProps): ReactElement = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiLab.materialUiLabStrings.root
    - typingsSlinky.materialUiLab.materialUiLabStrings.vertical
    - typingsSlinky.materialUiLab.materialUiLabStrings.grouped
    - typingsSlinky.materialUiLab.materialUiLabStrings.groupedHorizontal
    - typingsSlinky.materialUiLab.materialUiLabStrings.groupedVertical
  */
  trait ToggleButtonGroupClassKey extends StObject
  object ToggleButtonGroupClassKey {
    
    @scala.inline
    def grouped: typingsSlinky.materialUiLab.materialUiLabStrings.grouped = "grouped".asInstanceOf[typingsSlinky.materialUiLab.materialUiLabStrings.grouped]
    
    @scala.inline
    def groupedHorizontal: typingsSlinky.materialUiLab.materialUiLabStrings.groupedHorizontal = "groupedHorizontal".asInstanceOf[typingsSlinky.materialUiLab.materialUiLabStrings.groupedHorizontal]
    
    @scala.inline
    def groupedVertical: typingsSlinky.materialUiLab.materialUiLabStrings.groupedVertical = "groupedVertical".asInstanceOf[typingsSlinky.materialUiLab.materialUiLabStrings.groupedVertical]
    ...
    @scala.inline
    def vertical: typingsSlinky.materialUiLab.materialUiLabStrings.vertical = "vertical".asInstanceOf[typingsSlinky.materialUiLab.materialUiLabStrings.vertical]
  }
  ...
  @js.native
  trait ToggleButtonGroupProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapToggle] = js.native
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ SyntheticMouseEvent[HTMLElement], /* value */ js.Any, Unit]
      ] = js.native
  ...
  object ToggleButtonGroupProps {
    ...
    @scala.inline
    def apply(): ToggleButtonGroupProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ToggleButtonGroupProps]
    }
    
    @scala.inline
    implicit class ToggleButtonGroupPropsMutableBuilder[Self <: ToggleButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapToggle): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* value */ js.Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
