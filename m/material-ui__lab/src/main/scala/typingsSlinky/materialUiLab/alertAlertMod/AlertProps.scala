...
object AlertProps {
  ...
  implicit class AlertPropsOps[Self <: AlertProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIcon(value: ReactElement | `false`): Self = this.set("icon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClose(value: /* event */ SyntheticEvent[Event, Element] => Unit): Self = this.set("onClose", js.Any.fromFunction1(value))
