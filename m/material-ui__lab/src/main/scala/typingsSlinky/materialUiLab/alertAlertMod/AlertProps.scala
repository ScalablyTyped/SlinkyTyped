...
import typingsSlinky.materialUiLab.PartialClassNameMapAlertC
import typingsSlinky.materialUiLab.PartialRecordColorReactNo
...
trait AlertProps extends js.Object {
  ...
  /**
    ...
    */
  var icon: js.UndefOr[TagMod[Any] | `false`] = js.native
  /**
  ...
  /**
    ...
    */
  var onClose: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Event_, Element], Unit]] = js.native
...
object AlertProps {
  ...
  implicit class AlertPropsOps[Self <: AlertProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapAlertC): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIcon(value: TagMod[Any] | `false`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("icon")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withIconMapping(value: PartialRecordColorReactNo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iconMapping")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIconMapping: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("iconMapping")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnClose(value: /* event */ SyntheticEvent[Event_, Element] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSeverity(value: Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVariant(value: standard | filled | outlined): Self = {
        val ret = this.duplicate
