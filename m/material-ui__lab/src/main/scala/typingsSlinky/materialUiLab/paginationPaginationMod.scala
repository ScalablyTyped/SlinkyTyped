...
import typingsSlinky.materialUiLab.anon.PartialClassNameMapPagina
...
object paginationPaginationMod {
  ...
  */
  ...
  /* Inlined parent @material-ui/lab.@material-ui/lab/Pagination/usePagination.UsePaginationProps */
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLElement>, @material-ui/lab.@material-ui/lab/Pagination/Pagination.PaginationClassKey, 'children' | 'onChange'> */
  @js.native
  trait PaginationProps extends StObject {
    ...
    var classes: js.UndefOr[PartialClassNameMapPagina] = js.native
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapPagina): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
