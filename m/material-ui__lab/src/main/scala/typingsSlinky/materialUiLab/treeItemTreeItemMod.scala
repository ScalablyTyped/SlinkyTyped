  ...
  */
  ...
  object TreeItemProps {
    ...
    implicit class TreeItemPropsMutableBuilder[Self <: TreeItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCollapseIcon(value: ReactElement): Self = StObject.set(x, "collapseIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCollapseIconReactElement(value: ReactElement): Self = StObject.set(x, "collapseIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnIconClick(value: SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "onIconClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnLabelClick(value: SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "onLabelClick", js.Any.fromFunction1(value))
