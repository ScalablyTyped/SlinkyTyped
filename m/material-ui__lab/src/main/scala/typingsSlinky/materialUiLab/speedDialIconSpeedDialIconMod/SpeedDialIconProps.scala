package typingsSlinky.materialUiLab.speedDialIconSpeedDialIconMod
...
import typingsSlinky.materialUiLab.anon.PartialClassNameMapSpeedDIcon
...
object SpeedDialIconProps {
  ...
  @scala.inline
  implicit class SpeedDialIconPropsOps[Self <: SpeedDialIconProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSpeedDIcon): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
