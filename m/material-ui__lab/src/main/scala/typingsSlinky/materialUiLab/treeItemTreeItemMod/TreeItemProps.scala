...
trait TreeItemProps extends js.Object {
  ...
  /**
    ...
    */
  var collapseIcon: js.UndefOr[ReactElement] = js.native
  ...
  /**
    ...
    */
  var onIconClick: js.UndefOr[MouseEventHandler[Element]] = js.native
  ...
  /**
    ...
    */
  var onLabelClick: js.UndefOr[MouseEventHandler[Element]] = js.native
...
object TreeItemProps {
  ...
  implicit class TreeItemPropsOps[Self <: TreeItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTreeIt): Self = this.set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    
    @scala.inline
    def setCollapseIconReactElement(value: ReactElement): Self = this.set("collapseIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCollapseIcon(value: ReactElement): Self = this.set("collapseIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnIconClick(value: SyntheticMouseEvent[Element] => Unit): Self = this.set("onIconClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnIconClick: Self = this.set("onIconClick", js.undefined)
    ...
    @scala.inline
    def setOnLabelClick(value: SyntheticMouseEvent[Element] => Unit): Self = this.set("onLabelClick", js.Any.fromFunction1(value))
