...
trait TreeItemProps extends js.Object {
  ...
  /**
    ...
    */
  var collapseIcon: js.UndefOr[TagMod[Any]] = js.native
  ...
  /**
    ...
    */
  var endIcon: js.UndefOr[TagMod[Any]] = js.native
  /**
...
object TreeItemProps {
  ...
  implicit class TreeItemPropsOps[Self <: TreeItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransitionComponentFunctionComponent(
    ...
    @scala.inline
    def withTransitionComponentComponentClass(
      value: ReactComponentClass[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TransitionProps */ _
        ]
    ): Self = {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapTreeIt): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCollapseIconReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseIcon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCollapseIcon(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseIcon")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withEndIconReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endIcon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEndIcon(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endIcon")(value.asInstanceOf[js.Any])
        ret
    }
