...
object Alert {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapAlertC): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def icon(value: TagMod[Any] | `false`): this.type = set("icon", value.asInstanceOf[js.Any])
    @scala.inline
    def iconMapping(value: PartialRecordColorReactNo): this.type = set("iconMapping", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onClose(value: /* event */ SyntheticEvent[Event_, Element] => Unit): this.type = set("onClose", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def severity(value: Color): this.type = set("severity", value.asInstanceOf[js.Any])
    @scala.inline
