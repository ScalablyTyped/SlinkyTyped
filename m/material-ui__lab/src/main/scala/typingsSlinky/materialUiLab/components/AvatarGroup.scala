...
object AvatarGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapAvatar): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def spacing(value: small | medium | Double): this.type = set("spacing", value.asInstanceOf[js.Any])
    @scala.inline
