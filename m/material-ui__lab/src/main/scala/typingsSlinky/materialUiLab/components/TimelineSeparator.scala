...
object TimelineSeparator {
  ...
  def withProps(p: TimelineSeparatorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TimelineSeparator.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
