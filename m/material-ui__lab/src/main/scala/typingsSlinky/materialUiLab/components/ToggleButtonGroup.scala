...
object ToggleButtonGroup {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapToggle): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* value */ js.Any) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
