...
object Rating {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapRating): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ ChangeEvent[js.Object], /* value */ Double | Null) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def onChangeActive(value: (/* event */ ChangeEvent[js.Object], /* value */ Double) => Unit): this.type = set("onChangeActive", js.Any.fromFunction2(value))
