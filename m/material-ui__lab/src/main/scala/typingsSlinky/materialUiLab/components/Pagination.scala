...
object Pagination {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onChange(value: (/* event */ ChangeEvent[_], /* page */ Double) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def shape(value: round | rounded): this.type = set("shape", value.asInstanceOf[js.Any])
    @scala.inline
