...
import typingsSlinky.materialUiCore.PartialClassNameMapToolti
import typingsSlinky.materialUiCore.transitionMod.TransitionProps
import typingsSlinky.materialUiLab.PartialClassNameMapSpeedD
...
trait SpeedDialActionProps extends js.Object {
  ...
  /**
    ...
    */
  var tooltipTitle: js.UndefOr[TagMod[Any]] = js.native
...
object SpeedDialActionProps {
  ...
  implicit class SpeedDialActionPropsOps[Self <: SpeedDialActionProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTooltipClasses(value: PartialClassNameMapToolti): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TooltipClasses")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTooltipClasses: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TooltipClasses")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapSpeedD): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTooltipOpen(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipOpen")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTooltipTitleReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipTitle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTooltipTitle(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tooltipTitle")(value.asInstanceOf[js.Any])
        ret
    }
