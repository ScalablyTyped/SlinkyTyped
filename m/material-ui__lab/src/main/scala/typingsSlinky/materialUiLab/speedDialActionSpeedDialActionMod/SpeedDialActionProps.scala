package typingsSlinky.materialUiLab.speedDialActionSpeedDialActionMod
...
import typingsSlinky.materialUiLab.materialUiLabStrings.bottom
...
import typingsSlinky.materialUiLab.materialUiLabStrings.top
...
trait SpeedDialActionProps extends js.Object {
  ...
  /**
    ...
    */
  var TooltipClasses: js.UndefOr[PartialClassNameMapToolti] = js.native
  ...
  var classes: js.UndefOr[PartialClassNameMapSpeedD] = js.native
...
object SpeedDialActionProps {
  ...
  @scala.inline
  implicit class SpeedDialActionPropsOps[Self <: SpeedDialActionProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPopperProps(value: js.Object): Self = this.set("PopperProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePopperProps: Self = this.set("PopperProps", js.undefined)
    @scala.inline
    def setTooltipClasses(value: PartialClassNameMapToolti): Self = this.set("TooltipClasses", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTooltipClasses: Self = this.set("TooltipClasses", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSpeedD): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisableFocusListener(value: Boolean): Self = this.set("disableFocusListener", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableFocusListener: Self = this.set("disableFocusListener", js.undefined)
    @scala.inline
    def setDisableHoverListener(value: Boolean): Self = this.set("disableHoverListener", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableHoverListener: Self = this.set("disableHoverListener", js.undefined)
    @scala.inline
    def setDisableTouchListener(value: Boolean): Self = this.set("disableTouchListener", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableTouchListener: Self = this.set("disableTouchListener", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setEnterTouchDelay(value: Double): Self = this.set("enterTouchDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEnterTouchDelay: Self = this.set("enterTouchDelay", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setLeaveDelay(value: Double): Self = this.set("leaveDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLeaveDelay: Self = this.set("leaveDelay", js.undefined)
    @scala.inline
    def setLeaveTouchDelay(value: Double): Self = this.set("leaveTouchDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLeaveTouchDelay: Self = this.set("leaveTouchDelay", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setTooltipOpen(value: Boolean): Self = this.set("tooltipOpen", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTooltipOpen: Self = this.set("tooltipOpen", js.undefined)
    @scala.inline
    def setTooltipPlacement(
      value: `bottom-end` | `bottom-start` | bottom | `left-end` | `left-start` | left | `right-end` | `right-start` | right | `top-end` | `top-start` | top
    ): Self = this.set("tooltipPlacement", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTooltipPlacement: Self = this.set("tooltipPlacement", js.undefined)
    @scala.inline
    def setTooltipTitleReactElement(value: ReactElement): Self = this.set("tooltipTitle", value.asInstanceOf[js.Any])
    @scala.inline
    def setTooltipTitle(value: ReactElement): Self = this.set("tooltipTitle", value.asInstanceOf[js.Any])
    @scala.inline
