package typingsSlinky.materialUiLab.alertTitleAlertTitleMod
...
import typingsSlinky.materialUiLab.anon.PartialClassNameMapAlertT
...
object AlertTitleProps {
  ...
  implicit class AlertTitlePropsOps[Self <: AlertTitleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapAlertT): Self = {
        val ret = this.duplicate
