...
object TabListTypeMap {
  @scala.inline
  def apply[P, /* <: typingsSlinky.react.mod.ElementType[_] */ D](
  ...
  @scala.inline
  implicit class TabListTypeMapOps[Self <: TabListTypeMap[_, _], P, /* <: typingsSlinky.react.mod.ElementType[_] */ D] (val x: Self with (TabListTypeMap[P, D])) extends AnyVal {
    @scala.inline
