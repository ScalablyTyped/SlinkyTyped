package typingsSlinky.materialUiLab.toggleButtonGroupToggleButtonGroupMod
...
object ToggleButtonGroupProps {
  ...
  @scala.inline
  implicit class ToggleButtonGroupPropsOps[Self <: ToggleButtonGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapToggle): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* event */ SyntheticMouseEvent[HTMLElement], /* value */ js.Any) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
