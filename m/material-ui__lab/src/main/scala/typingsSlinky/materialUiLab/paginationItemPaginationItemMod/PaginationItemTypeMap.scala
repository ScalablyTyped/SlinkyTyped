...
object PaginationItemTypeMap {
  @scala.inline
  def apply[P, /* <: typingsSlinky.react.mod.ElementType[_] */ D](classKey: PaginationItemClassKey, defaultComponent: D, props: P with Color): PaginationItemTypeMap[P, D] = {
    val __obj = js.Dynamic.literal(classKey = classKey.asInstanceOf[js.Any], defaultComponent = defaultComponent.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any])
    __obj.asInstanceOf[PaginationItemTypeMap[P, D]]
  }
  @scala.inline
  implicit class PaginationItemTypeMapOps[Self <: PaginationItemTypeMap[_, _], P, /* <: typingsSlinky.react.mod.ElementType[_] */ D] (val x: Self with (PaginationItemTypeMap[P, D])) extends AnyVal {
    @scala.inline
