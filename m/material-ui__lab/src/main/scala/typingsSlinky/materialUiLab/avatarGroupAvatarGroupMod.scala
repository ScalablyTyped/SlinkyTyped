...
import typingsSlinky.materialUiLab.anon.PartialClassNameMapAvatar
...
object avatarGroupAvatarGroupMod {
  
  @JSImport("@material-ui/lab/AvatarGroup/AvatarGroup", JSImport.Default)
  @js.native
  def default(props: AvatarGroupProps): ReactElement = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiLab.materialUiLabStrings.root
    - typingsSlinky.materialUiLab.materialUiLabStrings.avatar
  */
  trait AvatarGroupClassKey extends StObject
  object AvatarGroupClassKey {
    
    @scala.inline
    def avatar: typingsSlinky.materialUiLab.materialUiLabStrings.avatar = "avatar".asInstanceOf[typingsSlinky.materialUiLab.materialUiLabStrings.avatar]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/lab.@material-ui/lab/AvatarGroup/AvatarGroup.AvatarGroupClassKey, never> */
  @js.native
  trait AvatarGroupProps extends StObject {
    ...
    /**
      ...
      */
    var spacing: js.UndefOr[small | medium | Double] = js.native
  ...
  object AvatarGroupProps {
    ...
    @scala.inline
    def apply(): AvatarGroupProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AvatarGroupProps]
    }
    
    @scala.inline
    implicit class AvatarGroupPropsMutableBuilder[Self <: AvatarGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpacing(value: small | medium | Double): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
