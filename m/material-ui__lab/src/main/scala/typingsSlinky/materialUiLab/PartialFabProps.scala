...
import typingsSlinky.materialUiLab.materialUiLabStrings.button
...
import typingsSlinky.materialUiLab.materialUiLabStrings.extended
...
import typingsSlinky.materialUiLab.materialUiLabStrings.reset
...
import typingsSlinky.materialUiLab.materialUiLabStrings.submit
...
object PartialFabProps {
  @scala.inline
  def apply(): PartialFabProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFabProps]
  }
  @scala.inline
  implicit class PartialFabPropsOps[Self <: PartialFabProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapFabCla): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withComponentFunctionComponent(value: ReactComponentClass[FabProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentComponentClass(value: ReactComponentClass[FabProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponent(value: ReactComponentClass[FabProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withVariant(value: round | extended): Self = {
        val ret = this.duplicate
