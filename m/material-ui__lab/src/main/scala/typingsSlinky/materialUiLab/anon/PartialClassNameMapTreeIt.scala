...
@js.native
trait PartialClassNameMapTreeIt extends StObject {
...
object PartialClassNameMapTreeIt {
  ...
  @scala.inline
  implicit class PartialClassNameMapTreeItMutableBuilder[Self <: PartialClassNameMapTreeIt] (val x: Self) extends AnyVal {
