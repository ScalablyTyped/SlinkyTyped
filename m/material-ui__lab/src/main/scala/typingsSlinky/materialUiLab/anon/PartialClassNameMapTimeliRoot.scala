...
@js.native
trait PartialClassNameMapTimeliRoot extends js.Object {
...
object PartialClassNameMapTimeliRoot {
  ...
  @scala.inline
  implicit class PartialClassNameMapTimeliRootOps[Self <: PartialClassNameMapTimeliRoot] (val x: Self) extends AnyVal {
