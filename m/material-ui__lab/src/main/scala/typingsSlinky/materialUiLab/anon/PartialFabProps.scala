...
trait PartialFabProps extends StObject {
  ...
  var color: js.UndefOr[typingsSlinky.materialUiCore.mod.PropTypes.Color] = js.native
...
object PartialFabProps {
  ...
  @scala.inline
  implicit class PartialFabPropsMutableBuilder[Self <: PartialFabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: typingsSlinky.materialUiCore.mod.PropTypes.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FabProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FabProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
