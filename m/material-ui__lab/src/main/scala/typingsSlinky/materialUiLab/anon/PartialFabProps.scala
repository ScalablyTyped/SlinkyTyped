...
object PartialFabProps {
  ...
  implicit class PartialFabPropsOps[Self <: PartialFabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: typingsSlinky.materialUiCore.mod.PropTypes.Color): Self = this.set("color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteColor: Self = this.set("color", js.undefined)
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FabProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FabProps]): Self = this.set("component", value.asInstanceOf[js.Any])
