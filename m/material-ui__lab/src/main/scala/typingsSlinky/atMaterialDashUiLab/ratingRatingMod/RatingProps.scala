package typingsSlinky.atMaterialDashUiLab.ratingRatingMod
...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapRatingClassKey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLSpanElement>, @material-ui/lab.@material-ui/lab/Rating/Rating.RatingClassKey, 'onChange'> */
trait RatingProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* value */ Double, Unit]] = js.undefined
...
object RatingProps {
  @scala.inline
  def apply(
    IconContainerComponent: ReactElement = null,
    about: String = null,
    ...
    getLabelText: /* value */ Double => String = null,
    ...
    onChange: (/* event */ ChangeEvent[js.Object], /* value */ Double) => Unit = null,
    onChangeActive: (/* event */ ChangeEvent[js.Object], /* value */ Double) => Unit = null,
