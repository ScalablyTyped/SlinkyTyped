...
trait PartialClassNameMapRatingClassKey extends js.Object {
...
object PartialClassNameMapRatingClassKey {
  @scala.inline
  def apply(
    decimal: String = null,
    ...
    iconEmpty: String = null,
    iconFilled: String = null,
    ...
    visuallyhidden: String = null
  ): PartialClassNameMapRatingClassKey = {
    ...
    if (iconActive != null) __obj.updateDynamic("iconActive")(iconActive.asInstanceOf[js.Any])
    if (iconEmpty != null) __obj.updateDynamic("iconEmpty")(iconEmpty.asInstanceOf[js.Any])
    if (iconFilled != null) __obj.updateDynamic("iconFilled")(iconFilled.asInstanceOf[js.Any])
    if (iconFocus != null) __obj.updateDynamic("iconFocus")(iconFocus.asInstanceOf[js.Any])
    if (iconHover != null) __obj.updateDynamic("iconHover")(iconHover.asInstanceOf[js.Any])
    if (label != null) __obj.updateDynamic("label")(label.asInstanceOf[js.Any])
    if (pristine != null) __obj.updateDynamic("pristine")(pristine.asInstanceOf[js.Any])
    ...
    if (visuallyhidden != null) __obj.updateDynamic("visuallyhidden")(visuallyhidden.asInstanceOf[js.Any])
    __obj.asInstanceOf[PartialClassNameMapRatingClassKey]
  }
}
