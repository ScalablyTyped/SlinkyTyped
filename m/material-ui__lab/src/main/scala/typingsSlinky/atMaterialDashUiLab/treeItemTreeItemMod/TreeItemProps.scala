package typingsSlinky.atMaterialDashUiLab.treeItemTreeItemMod
...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapTreeItemClassKey
...
trait TreeItemProps extends js.Object {
  ...
  /**
    ...
    */
  var collapseIcon: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  /**
    ...
    */
  var endIcon: js.UndefOr[TagMod[Any]] = js.undefined
  /**
...
object TreeItemProps {
  ...
  def apply(
    nodeId: String,
    TransitionComponent: ReactComponentClass[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TransitionProps */ _
    ] = null,
    about: String = null,
    ...
    classes: PartialClassNameMapTreeItemClassKey = null,
    collapseIcon: TagMod[Any] = null,
    color: String = null,
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLLIElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLLIElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLLIElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLLIElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLLIElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLLIElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLLIElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLLIElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLLIElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLLIElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLLIElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLLIElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLLIElement] => Unit = null,
    onLoad: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLLIElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLLIElement] => Unit = null,
    onPause: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLLIElement] => Unit = null,
    onProgress: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLLIElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLLIElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLLIElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLLIElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLLIElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLLIElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLLIElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLLIElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLLIElement] => Unit = null,
