package typingsSlinky.atMaterialDashUiLab.treeViewTreeViewMod
...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapTreeViewClassKey
...
trait TreeViewProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTreeViewClassKey] = js.undefined
  ...
  /**
    ...
    */
  var defaultCollapseIcon: js.UndefOr[TagMod[Any]] = js.undefined
  /**
    * The default icon displayed next to a end node. This is applied to all
    * tree nodes and can be overridden by the TreeItem `icon` prop.
    */
  var defaultEndIcon: js.UndefOr[TagMod[Any]] = js.undefined
  /**
    * The default icon used to expand the node.
    */
  var defaultExpandIcon: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var defaultParentIcon: js.UndefOr[TagMod[Any]] = js.undefined
...
object TreeViewProps {
  ...
  def apply(
    ...
    classes: PartialClassNameMapTreeViewClassKey = null,
    color: String = null,
    ...
    defaultCollapseIcon: TagMod[Any] = null,
    defaultEndIcon: TagMod[Any] = null,
    defaultExpandIcon: TagMod[Any] = null,
    defaultExpanded: js.Array[String] = null,
    defaultParentIcon: TagMod[Any] = null,
    ...
    if (defaultCollapseIcon != null) __obj.updateDynamic("defaultCollapseIcon")(defaultCollapseIcon.asInstanceOf[js.Any])
    if (defaultEndIcon != null) __obj.updateDynamic("defaultEndIcon")(defaultEndIcon.asInstanceOf[js.Any])
    if (defaultExpandIcon != null) __obj.updateDynamic("defaultExpandIcon")(defaultExpandIcon.asInstanceOf[js.Any])
    if (defaultExpanded != null) __obj.updateDynamic("defaultExpanded")(defaultExpanded.asInstanceOf[js.Any])
    if (defaultParentIcon != null) __obj.updateDynamic("defaultParentIcon")(defaultParentIcon.asInstanceOf[js.Any])
    ...
    if (onNodeToggle != null) __obj.updateDynamic("onNodeToggle")(js.Any.fromFunction2(onNodeToggle))
