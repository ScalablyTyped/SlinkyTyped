package typingsSlinky.atMaterialDashUiLab.toggleButtonGroupToggleButtonGroupMod
...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapToggleButtonGroupClassKey
...
object ToggleButtonGroupProps {
  ...
  def apply(
    ...
    onChange: (/* event */ SyntheticMouseEvent[HTMLElement], /* value */ js.Any) => Unit = null,
