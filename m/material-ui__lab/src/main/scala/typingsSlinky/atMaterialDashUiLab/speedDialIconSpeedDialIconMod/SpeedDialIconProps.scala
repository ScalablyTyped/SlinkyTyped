package typingsSlinky.atMaterialDashUiLab.speedDialIconSpeedDialIconMod
...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapSpeedDialIconClassKey
