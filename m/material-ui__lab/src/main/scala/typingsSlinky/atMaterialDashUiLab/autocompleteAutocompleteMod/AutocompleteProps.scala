...
import typingsSlinky.atMaterialDashUiLab.PartialClassNameMapAutocompleteClassKey
...
import typingsSlinky.atMaterialDashUiLab.useAutocompleteUseAutocompleteMod.FilterOptionsState
...
/* Inlined parent @material-ui/lab.@material-ui/lab/useAutocomplete.UseAutocompleteProps */
...
trait AutocompleteProps extends js.Object {
  /**
    ...
    */
  var ListboxComponent: js.UndefOr[ReactComponentClass[HTMLAttributes[HTMLElement]]] = js.undefined
  /**
    * The component used to render the body of the popup.
    */
  var PaperComponent: js.UndefOr[ReactComponentClass[HTMLAttributes[HTMLElement]]] = js.undefined
  /**
    * The component used to position the popup.
    */
  var PopperComponent: js.UndefOr[ReactComponentClass[PopperProps]] = js.undefined
  ...
  /**
    ...
    */
  var loadingText: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var noOptionsText: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  /**
    ...
    */
  var popupIcon: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  /**
    ...
    * @returns {ReactNode}
    */
  var renderGroup: js.UndefOr[js.Function1[/* params */ RenderGroupParams, TagMod[Any]]] = js.undefined
  /**
    ...
    * @returns {ReactNode}
    */
  var renderOption: js.UndefOr[js.Function2[/* option */ js.Any, /* state */ RenderOptionState, TagMod[Any]]] = js.undefined
  /**
    ...
    * @returns {ReactNode}
    */
  var renderTags: js.UndefOr[js.Function2[/* value */ js.Any, /* getTagProps */ GetTagProps, TagMod[Any]]] = js.undefined
  ...
  /**
    ...
    * @returns {ReactNode}
    */
  def renderInput(params: RenderInputParams): TagMod[Any]
}

object AutocompleteProps {
  @scala.inline
  def apply(
    renderInput: RenderInputParams => TagMod[Any],
    ListboxComponent: ReactComponentClass[HTMLAttributes[HTMLElement]] = null,
    PaperComponent: ReactComponentClass[HTMLAttributes[HTMLElement]] = null,
    PopperComponent: ReactComponentClass[PopperProps] = null,
    about: String = null,
    ...
    loadingText: TagMod[Any] = null,
    multiple: js.UndefOr[Boolean] = js.undefined,
    noOptionsText: TagMod[Any] = null,
    ...
    popupIcon: TagMod[Any] = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    renderGroup: /* params */ RenderGroupParams => TagMod[Any] = null,
    renderOption: (/* option */ js.Any, /* state */ RenderOptionState) => TagMod[Any] = null,
    renderTags: (/* value */ js.Any, /* getTagProps */ GetTagProps) => TagMod[Any] = null,
    ...
    if (noOptionsText != null) __obj.updateDynamic("noOptionsText")(noOptionsText.asInstanceOf[js.Any])
    ...
    if (openText != null) __obj.updateDynamic("openText")(openText.asInstanceOf[js.Any])
    ...
    if (renderGroup != null) __obj.updateDynamic("renderGroup")(js.Any.fromFunction1(renderGroup))
    if (renderOption != null) __obj.updateDynamic("renderOption")(js.Any.fromFunction2(renderOption))
    if (renderTags != null) __obj.updateDynamic("renderTags")(js.Any.fromFunction2(renderTags))
