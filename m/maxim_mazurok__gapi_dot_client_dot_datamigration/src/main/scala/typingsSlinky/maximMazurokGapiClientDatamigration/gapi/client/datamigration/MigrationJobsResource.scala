...
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.AccesstokenAlt
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.AltCallback
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Callback
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Fields
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Filter
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Key
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.MigrationJobId
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Oauthtoken
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Parent
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.PrettyPrint
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.RequestId
import typingsSlinky.maximMazurokGapiClientDatamigration.anon.Resource
...
trait MigrationJobsResource extends StObject {
  ...
  def generateSshScript(request: typingsSlinky.maximMazurokGapiClientDatamigration.anon.MigrationJob): Request[SshScript] = js.native
