...
@js.native
trait GoogleCloudClouddmsV1beta1OperationMetadata extends StObject {
...
object GoogleCloudClouddmsV1beta1OperationMetadata {
  
  @scala.inline
  def apply(): GoogleCloudClouddmsV1beta1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudClouddmsV1beta1OperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudClouddmsV1beta1OperationMetadataMutableBuilder[Self <: GoogleCloudClouddmsV1beta1OperationMetadata] (val x: Self) extends AnyVal {
