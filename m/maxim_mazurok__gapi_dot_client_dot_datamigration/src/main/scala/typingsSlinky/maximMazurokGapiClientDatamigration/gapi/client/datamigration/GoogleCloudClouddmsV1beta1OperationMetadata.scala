...
@js.native
trait GoogleCloudClouddmsV1beta1OperationMetadata extends js.Object {
...
object GoogleCloudClouddmsV1beta1OperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudClouddmsV1beta1OperationMetadataOps[Self <: GoogleCloudClouddmsV1beta1OperationMetadata] (val x: Self) extends AnyVal {
