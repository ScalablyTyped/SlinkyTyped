...
object RequestId {
  ...
  implicit class RequestIdOps[Self <: RequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob): Self = this.set("resource", value.asInstanceOf[js.Any])
