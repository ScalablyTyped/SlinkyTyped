...
trait RequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob = js.native
...
object RequestId {
  ...
  def apply(
    name: String,
    resource: typingsSlinky.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob
  ): RequestId = {
  ...
  implicit class RequestIdMutableBuilder[Self <: RequestId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
