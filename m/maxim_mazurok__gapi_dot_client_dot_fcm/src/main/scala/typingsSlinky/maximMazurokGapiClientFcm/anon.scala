...
import typingsSlinky.maximMazurokGapiClientFcm.gapi.client.fcm.SendMessageRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: SendMessageRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
