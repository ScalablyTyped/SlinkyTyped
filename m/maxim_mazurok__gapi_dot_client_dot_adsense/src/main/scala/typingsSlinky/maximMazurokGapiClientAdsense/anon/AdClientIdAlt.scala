...
@js.native
trait AdClientIdAlt extends StObject {
...
object AdClientIdAlt {
  
  @scala.inline
  def apply(adClientId: String, customChannelId: String): AdClientIdAlt = {
    ...
    __obj.asInstanceOf[AdClientIdAlt]
  }
  
  @scala.inline
  implicit class AdClientIdAltMutableBuilder[Self <: AdClientIdAlt] (val x: Self) extends AnyVal {
