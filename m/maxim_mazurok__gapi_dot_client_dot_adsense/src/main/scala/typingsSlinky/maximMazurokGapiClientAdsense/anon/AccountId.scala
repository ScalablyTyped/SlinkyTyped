...
trait AccountId extends StObject {
  ...
  var tagPartner: js.UndefOr[String] = js.native
...
object AccountId {
  ...
  @scala.inline
  def apply(accountId: String, adClientId: String): AccountId = {
  ...
  implicit class AccountIdMutableBuilder[Self <: AccountId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagPartner(value: String): Self = StObject.set(x, "tagPartner", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagPartnerUndefined: Self = StObject.set(x, "tagPartner", js.undefined)
