...
import typingsSlinky.mysql2.anon.Command
...
object mod {
  ...
  trait ConnectionOptions
    extends typingsSlinky.mysql2.connectionMod.ConnectionOptions {
    
    var Promise: js.UndefOr[js.Any] = js.native
    
    var authPlugins: js.UndefOr[StringDictionary[typingsSlinky.mysql2.mod.authPlugins]] = js.native
  ...
  trait PoolConnection
    extends typingsSlinky.mysql2.poolConnectionMod.^ {
