...
import typingsSlinky.mysql2.mysql2Strings.end
import typingsSlinky.mysql2.mysql2Strings.error
import typingsSlinky.mysql2.mysql2Strings.fields
import typingsSlinky.mysql2.mysql2Strings.result
...
object queryMod {
  ...
  @js.native
  trait Query
    extends typingsSlinky.mysql2.sequenceMod.^ {
