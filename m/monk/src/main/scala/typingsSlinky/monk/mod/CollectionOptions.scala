...
object CollectionOptions {
  ...
  implicit class CollectionOptionsOps[Self <: CollectionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMiddlewaresVarargs(value: TMiddleware*): Self = this.set("middlewares", js.Array(value :_*))
    
    @scala.inline
    def setMiddlewares(value: js.Array[TMiddleware]): Self = this.set("middlewares", value.asInstanceOf[js.Any])
