...
/* Inlined monk.monk.FindOptions & {  rawCursor :true} */
@js.native
trait FindOptionsrawCursortrue extends js.Object {
  ...
  var rawCursor: js.UndefOr[Boolean] with `true` = js.native
...
object FindOptionsrawCursortrue {
  
  @scala.inline
  def apply(rawCursor: js.UndefOr[Boolean] with `true`): FindOptionsrawCursortrue = {
    val __obj = js.Dynamic.literal(rawCursor = rawCursor.asInstanceOf[js.Any])
    __obj.asInstanceOf[FindOptionsrawCursortrue]
  }
  
  @scala.inline
  implicit class FindOptionsrawCursortrueOps[Self <: FindOptionsrawCursortrue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRawCursor(value: js.UndefOr[Boolean] with `true`): Self = this.set("rawCursor", value.asInstanceOf[js.Any])
