...
object MongoClientOptionscollect {
  ...
  implicit class MongoClientOptionscollectOps[Self <: MongoClientOptionscollect] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckServerIdentityFunction2(value: (/* host */ String, /* cert */ PeerCertificate) => js.UndefOr[js.Error]): Self = this.set("checkServerIdentity", js.Any.fromFunction2(value))
    
    @scala.inline
    def setCheckServerIdentity(
      value: Boolean | (js.Function2[/* host */ String, /* cert */ PeerCertificate, js.UndefOr[js.Error]])
    ): Self = this.set("checkServerIdentity", value.asInstanceOf[js.Any])
