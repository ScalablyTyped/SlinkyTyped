...
import typingsSlinky.mongodb.mod.BulkWriteOperation
import typingsSlinky.mongodb.mod.ClientSession
import typingsSlinky.mongodb.mod.CollStats
import typingsSlinky.mongodb.mod.CollationDocument
import typingsSlinky.mongodb.mod.CollectionAggregationOptions
import typingsSlinky.mongodb.mod.CollectionBulkWriteOptions
import typingsSlinky.mongodb.mod.CollectionCreateOptions
import typingsSlinky.mongodb.mod.CollectionMapFunction
import typingsSlinky.mongodb.mod.CollectionReduceFunction
import typingsSlinky.mongodb.mod.CommonOptions
import typingsSlinky.mongodb.mod.Cursor
...
import typingsSlinky.mongodb.mod.MapReduceOptions
import typingsSlinky.mongodb.mod.MongoCountPreferences
import typingsSlinky.mongodb.mod.MongoDistinctPreferences
...
import typingsSlinky.monk.anon.Collection
import typingsSlinky.monk.anon.Id
...
object mod {
  ...
  {[ key in keyof T ]:? 1 | -1}
    */ typingsSlinky.monk.monkStrings.CreateIndexInput with TopLevel[js.Any])
  ...
  trait DropIndexResult extends StObject {
    ...
    var ok: `1` | typingsSlinky.monk.monkNumbers.`0` = js.native
  }
  object DropIndexResult {
    
    @scala.inline
    def apply(nIndexesWas: Double, ok: `1` | typingsSlinky.monk.monkNumbers.`0`): DropIndexResult = {
    ...
    implicit class DropIndexResultMutableBuilder[Self <: DropIndexResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOk(value: `1` | typingsSlinky.monk.monkNumbers.`0`): Self = StObject.set(x, "ok", value.asInstanceOf[js.Any])
    }
  }
  ...
  object DropIndexesResult {
    ...
    @scala.inline
    def apply(nIndexesWas: Double, ok: `1` | typingsSlinky.monk.monkNumbers.`0`): DropIndexesResult = {
      val __obj = js.Dynamic.literal(nIndexesWas = nIndexesWas.asInstanceOf[js.Any], ok = ok.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.monk.monkBooleans.`true`
    - typingsSlinky.monk.monkStrings.`ns not found`
  */
  trait DropResult extends StObject
  object DropResult {
    
    @scala.inline
    def `ns not found`: typingsSlinky.monk.monkStrings.`ns not found` = ("ns not found").asInstanceOf[typingsSlinky.monk.monkStrings.`ns not found`]
    
    @scala.inline
    def `true`: typingsSlinky.monk.monkBooleans.`true` = true.asInstanceOf[typingsSlinky.monk.monkBooleans.`true`]
  }
