...
import typingsSlinky.monk.Anon_0
import typingsSlinky.monk.Anon_01
import typingsSlinky.monk.Anon_01AvgObjSize
import typingsSlinky.monk.Anon_01NNModified
import typingsSlinky.monk.Anon_Cursor
import typingsSlinky.monk.Anon_DeletedCount
import typingsSlinky.monk.monkNumbers.`-1`
import typingsSlinky.monk.monkNumbers.`1`
import typingsSlinky.monk.monkNumbers.`true`
import typingsSlinky.monk.monkStrings.`ns not found`
...
class ICollection[T] () extends js.Object {
  ...
  def dropIndex(
    fields: TFields,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ Anon_0, Unit]
  ): Unit = js.native
  @JSName("dropIndex")
  ...
  def dropIndexes(callback: js.Function2[/* err */ js.Error | Null, /* data */ Anon_01, Unit]): Unit = js.native
  @JSName("dropIndexes")
  ...
  def find[U](
    query: TQuery,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ js.Array[U] with Anon_Cursor[U], Unit]
  ): Unit = js.native
  ...
  def remove(
    query: TQuery,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ Anon_DeletedCount, Unit]
  ): Unit = js.native
  @JSName("remove")
  ...
  def stats(
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ Anon_01AvgObjSize, Unit]
  ): Unit = js.native
  @JSName("stats")
  ...
  def update(
    ...
    update: js.Object,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ Anon_01NNModified, Unit]
  ): Unit = js.native
  @JSName("update")
