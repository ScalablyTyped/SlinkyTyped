...
import typingsSlinky.maximMazurokGapiClientSlides.gapi.client.slides.BatchUpdatePresentationRequest
import typingsSlinky.maximMazurokGapiClientSlides.gapi.client.slides.Presentation
