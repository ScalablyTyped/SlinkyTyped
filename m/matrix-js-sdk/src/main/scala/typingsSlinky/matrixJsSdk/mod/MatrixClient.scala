...
import typingsSlinky.matrixJsSdk.anon.AllowJoin
import typingsSlinky.matrixJsSdk.anon.Avatarurl
import typingsSlinky.matrixJsSdk.anon.Body
import typingsSlinky.matrixJsSdk.anon.Callback
import typingsSlinky.matrixJsSdk.anon.DisablePresence
import typingsSlinky.matrixJsSdk.anon.InviteSignUrl
import typingsSlinky.matrixJsSdk.anon.Keys
import typingsSlinky.matrixJsSdk.anon.Limit
import typingsSlinky.matrixJsSdk.anon.Limited
import typingsSlinky.matrixJsSdk.anon.Longdescription
import typingsSlinky.matrixJsSdk.anon.Replacementroom
import typingsSlinky.matrixJsSdk.anon.Roomalias
import typingsSlinky.matrixJsSdk.anon.Statusmsg
import typingsSlinky.matrixJsSdk.anon.Term
...
class MatrixClient () extends EventEmitter {
  ...
  def publicRooms(options: typingsSlinky.matrixJsSdk.anon.Filter): js.Promise[Unit] = js.native
  def publicRooms(options: typingsSlinky.matrixJsSdk.anon.Filter, callback: js.Function1[/* repeated */ js.Any, _]): js.Promise[Unit] = js.native
