...
import typingsSlinky.matrixJsSdk.AnonAllowJoin
import typingsSlinky.matrixJsSdk.AnonAvatarurl
import typingsSlinky.matrixJsSdk.AnonBody
import typingsSlinky.matrixJsSdk.AnonCallback
import typingsSlinky.matrixJsSdk.AnonDisablePresence
import typingsSlinky.matrixJsSdk.AnonFilter
...
class MatrixClient () extends EventEmitter {
  ...
  def search(opts: AnonBody): js.Promise[Unit] = js.native
  def search(opts: AnonBody, callback: MatrixCallback): js.Promise[Unit] = js.native
