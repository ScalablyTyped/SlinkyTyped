...
object AnonCallback {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1(callback), includeFilename = includeFilename.asInstanceOf[js.Any], onlyContentUri = onlyContentUri.asInstanceOf[js.Any], progressHandler = js.Any.fromFunction1(progressHandler), rawResponse = rawResponse.asInstanceOf[js.Any])
