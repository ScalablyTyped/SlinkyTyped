...
object dehydrationMod {
  ...
  class DehydrationManager protected () extends StObject {
    ...
    def setDehydrationKey(key: js.typedarray.Uint8Array): js.Promise[Unit] = js.native
    def setDehydrationKey(key: js.typedarray.Uint8Array, keyInfo: js.UndefOr[scala.Nothing], deviceDisplayName: String): js.Promise[Unit] = js.native
    def setDehydrationKey(key: js.typedarray.Uint8Array, keyInfo: StringDictionary[js.Any]): js.Promise[Unit] = js.native
    def setDehydrationKey(key: js.typedarray.Uint8Array, keyInfo: StringDictionary[js.Any], deviceDisplayName: String): js.Promise[Unit] = js.native
