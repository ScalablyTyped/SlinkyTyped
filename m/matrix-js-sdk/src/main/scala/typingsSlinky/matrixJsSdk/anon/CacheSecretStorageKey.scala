...
object CacheSecretStorageKey {
  ...
  implicit class CacheSecretStorageKeyOps[Self <: CacheSecretStorageKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCacheSecretStorageKey(value: (/* keyId */ String, /* key */ js.typedarray.Uint8Array) => _): Self = this.set("cacheSecretStorageKey", js.Any.fromFunction2(value))
    ...
    ): Self = this.set("getCrossSigningKey", js.Any.fromFunction2(value))
    ...
    ): Self = this.set("getSecretStorageKey", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSaveCrossSigningKeys(value: /* keys */ Record[String, js.typedarray.Uint8Array] => _): Self = this.set("saveCrossSigningKeys", js.Any.fromFunction1(value))
