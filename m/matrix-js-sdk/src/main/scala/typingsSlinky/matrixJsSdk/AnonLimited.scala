...
trait AnonLimited extends js.Object {
  ...
  var results: js.Array[AnonDisplayname] = js.native
}

object AnonLimited {
  @scala.inline
  def apply(results: js.Array[AnonDisplayname]): AnonLimited = {
    val __obj = js.Dynamic.literal(results = results.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLimited]
  }
  @scala.inline
  implicit class AnonLimitedOps[Self <: AnonLimited] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withResults(value: js.Array[AnonDisplayname]): Self = {
