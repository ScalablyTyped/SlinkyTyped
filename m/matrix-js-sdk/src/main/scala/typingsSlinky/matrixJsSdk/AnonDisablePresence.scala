...
import typingsSlinky.matrixJsSdk.mod.Filter
...
object AnonDisablePresence {
  @scala.inline
  def apply(): AnonDisablePresence = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDisablePresence]
  }
  @scala.inline
  implicit class AnonDisablePresenceOps[Self <: AnonDisablePresence] (val x: Self) extends AnyVal {
    @scala.inline
