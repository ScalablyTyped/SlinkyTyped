...
@js.native
trait SecurityMarks extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientSecuritycenter.maximMazurokGapiClientSecuritycenterStrings.SecurityMarks with TopLevel[js.Any]
  ] = js.native
...
object SecurityMarks {
  ...
  @scala.inline
  implicit class SecurityMarksOps[Self <: SecurityMarks] (val x: Self) extends AnyVal {
