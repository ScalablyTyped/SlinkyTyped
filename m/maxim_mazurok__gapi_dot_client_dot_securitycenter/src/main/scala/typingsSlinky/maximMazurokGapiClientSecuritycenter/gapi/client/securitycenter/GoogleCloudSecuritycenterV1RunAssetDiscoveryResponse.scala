...
@js.native
trait GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse extends js.Object {
...
object GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse {
  ...
  @scala.inline
  implicit class GoogleCloudSecuritycenterV1RunAssetDiscoveryResponseOps[Self <: GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse] (val x: Self) extends AnyVal {
