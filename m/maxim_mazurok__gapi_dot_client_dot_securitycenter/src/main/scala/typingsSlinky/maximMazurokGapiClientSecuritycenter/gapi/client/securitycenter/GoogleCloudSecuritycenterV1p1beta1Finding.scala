...
object GoogleCloudSecuritycenterV1p1beta1Finding {
  ...
  @scala.inline
  implicit class GoogleCloudSecuritycenterV1p1beta1FindingMutableBuilder[Self <: GoogleCloudSecuritycenterV1p1beta1Finding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecurityMarks(value: GoogleCloudSecuritycenterV1p1beta1SecurityMarks): Self = StObject.set(x, "securityMarks", value.asInstanceOf[js.Any])
