...
import typingsSlinky.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.Finding
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: Finding = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(name: String, resource: Finding): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Finding): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
