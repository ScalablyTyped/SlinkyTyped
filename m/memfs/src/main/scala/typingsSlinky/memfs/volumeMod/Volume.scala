...
import typingsSlinky.memfs.anon.Bigint
import typingsSlinky.memfs.anon.`0`
import typingsSlinky.memfs.encodingMod.TDataOut
import typingsSlinky.memfs.nodeMod.File
...
class Volume () extends StObject {
  ...
  var StatWatcher: Instantiable0[typingsSlinky.memfs.volumeMod.StatWatcher] = js.native
  ...
  var props: typingsSlinky.memfs.anon.File = js.native
  ...
  def readdir(
    path: PathLike,
    options: String,
    callback: TCallback[js.Array[TDataOut | typingsSlinky.memfs.direntMod.default]]
  ): js.Any = js.native
  def readdir(
    path: PathLike,
  ...
  def readdirSync(path: PathLike): js.Array[TDataOut | typingsSlinky.memfs.direntMod.default] = js.native
  def readdirSync(path: PathLike, options: String): js.Array[TDataOut | typingsSlinky.memfs.direntMod.default] = js.native
  def readdirSync(path: PathLike, options: IReaddirOptions): js.Array[TDataOut | typingsSlinky.memfs.direntMod.default] = js.native
  ...
  def writeSync(fd: Double, buffer: js.typedarray.Uint8Array, offset: js.UndefOr[scala.Nothing], length: Double): Double = js.native
  def writeSync(
    fd: Double,
    buffer: js.typedarray.Uint8Array,
    offset: js.UndefOr[scala.Nothing],
