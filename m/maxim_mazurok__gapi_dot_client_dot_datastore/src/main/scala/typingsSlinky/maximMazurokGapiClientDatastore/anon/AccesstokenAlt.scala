...
import typingsSlinky.maximMazurokGapiClientDatastore.gapi.client.datastore.RunQueryRequest
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(projectId: String, resource: RunQueryRequest): AccesstokenAlt = {
