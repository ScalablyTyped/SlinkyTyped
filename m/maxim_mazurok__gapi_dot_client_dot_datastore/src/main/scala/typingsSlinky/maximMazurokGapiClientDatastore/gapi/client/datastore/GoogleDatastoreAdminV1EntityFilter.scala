...
@js.native
trait GoogleDatastoreAdminV1EntityFilter extends js.Object {
...
object GoogleDatastoreAdminV1EntityFilter {
  ...
  @scala.inline
  def apply(): GoogleDatastoreAdminV1EntityFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleDatastoreAdminV1EntityFilter]
  }
  
  @scala.inline
  implicit class GoogleDatastoreAdminV1EntityFilterOps[Self <: GoogleDatastoreAdminV1EntityFilter] (val x: Self) extends AnyVal {
