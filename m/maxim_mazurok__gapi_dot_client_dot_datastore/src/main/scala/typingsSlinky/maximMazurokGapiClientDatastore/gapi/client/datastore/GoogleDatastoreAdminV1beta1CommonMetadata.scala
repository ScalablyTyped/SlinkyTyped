...
trait GoogleDatastoreAdminV1beta1CommonMetadata extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDatastore.maximMazurokGapiClientDatastoreStrings.GoogleDatastoreAdminV1beta1CommonMetadata with TopLevel[js.Any]
  ] = js.native
...
object GoogleDatastoreAdminV1beta1CommonMetadata {
  ...
  @scala.inline
  implicit class GoogleDatastoreAdminV1beta1CommonMetadataMutableBuilder[Self <: GoogleDatastoreAdminV1beta1CommonMetadata] (val x: Self) extends AnyVal {
