...
@js.native
trait GoogleDatastoreAdminV1Progress extends js.Object {
...
object GoogleDatastoreAdminV1Progress {
  ...
  @scala.inline
  implicit class GoogleDatastoreAdminV1ProgressOps[Self <: GoogleDatastoreAdminV1Progress] (val x: Self) extends AnyVal {
