...
trait Value extends StObject {
  ...
  var entityValue: js.UndefOr[Entity] = js.native
  ...
  /** A key value. */
  var keyValue: js.UndefOr[Key] = js.native
...
object Value {
  ...
  implicit class ValueMutableBuilder[Self <: Value] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntityValue(value: Entity): Self = StObject.set(x, "entityValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKeyValue(value: Key): Self = StObject.set(x, "keyValue", value.asInstanceOf[js.Any])
