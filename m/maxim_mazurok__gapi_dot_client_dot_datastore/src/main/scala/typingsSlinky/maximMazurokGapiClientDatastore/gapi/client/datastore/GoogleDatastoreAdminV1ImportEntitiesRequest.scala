...
trait GoogleDatastoreAdminV1ImportEntitiesRequest extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDatastore.maximMazurokGapiClientDatastoreStrings.GoogleDatastoreAdminV1ImportEntitiesRequest with TopLevel[js.Any]
  ] = js.native
}
object GoogleDatastoreAdminV1ImportEntitiesRequest {
  ...
  @scala.inline
  implicit class GoogleDatastoreAdminV1ImportEntitiesRequestMutableBuilder[Self <: GoogleDatastoreAdminV1ImportEntitiesRequest] (val x: Self) extends AnyVal {
