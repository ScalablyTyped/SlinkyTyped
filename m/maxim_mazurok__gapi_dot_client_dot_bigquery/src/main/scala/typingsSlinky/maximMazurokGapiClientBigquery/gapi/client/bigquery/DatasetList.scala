...
object DatasetList {
  ...
  implicit class DatasetListOps[Self <: DatasetList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatasetsVarargs(value: typingsSlinky.maximMazurokGapiClientBigquery.anon.DatasetReference*): Self = this.set("datasets", js.Array(value :_*))
    
    @scala.inline
    def setDatasets(value: js.Array[typingsSlinky.maximMazurokGapiClientBigquery.anon.DatasetReference]): Self = this.set("datasets", value.asInstanceOf[js.Any])
