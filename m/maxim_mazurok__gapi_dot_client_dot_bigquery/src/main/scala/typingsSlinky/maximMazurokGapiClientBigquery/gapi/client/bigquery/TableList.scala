...
object TableList {
  ...
  implicit class TableListOps[Self <: TableList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTablesVarargs(value: typingsSlinky.maximMazurokGapiClientBigquery.anon.Clustering*): Self = this.set("tables", js.Array(value :_*))
    
    @scala.inline
    def setTables(value: js.Array[typingsSlinky.maximMazurokGapiClientBigquery.anon.Clustering]): Self = this.set("tables", value.asInstanceOf[js.Any])
