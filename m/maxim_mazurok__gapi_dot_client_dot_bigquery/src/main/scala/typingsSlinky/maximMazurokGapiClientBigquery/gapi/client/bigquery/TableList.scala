...
trait TableList extends StObject {
  ...
  var tables: js.UndefOr[js.Array[typingsSlinky.maximMazurokGapiClientBigquery.anon.Clustering]] = js.native
...
object TableList {
  ...
  implicit class TableListMutableBuilder[Self <: TableList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTables(value: js.Array[typingsSlinky.maximMazurokGapiClientBigquery.anon.Clustering]): Self = StObject.set(x, "tables", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTablesUndefined: Self = StObject.set(x, "tables", js.undefined)
    
    @scala.inline
    def setTablesVarargs(value: typingsSlinky.maximMazurokGapiClientBigquery.anon.Clustering*): Self = StObject.set(x, "tables", js.Array(value :_*))
