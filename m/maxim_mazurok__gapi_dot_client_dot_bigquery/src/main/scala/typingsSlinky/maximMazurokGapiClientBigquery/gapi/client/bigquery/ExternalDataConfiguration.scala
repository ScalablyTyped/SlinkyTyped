...
object ExternalDataConfiguration {
  ...
  implicit class ExternalDataConfigurationOps[Self <: ExternalDataConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHivePartitioningOptions(value: HivePartitioningOptions): Self = this.set("hivePartitioningOptions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHivePartitioningOptions: Self = this.set("hivePartitioningOptions", js.undefined)
