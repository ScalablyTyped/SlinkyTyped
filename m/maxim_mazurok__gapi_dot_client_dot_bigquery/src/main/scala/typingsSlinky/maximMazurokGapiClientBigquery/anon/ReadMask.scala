...
trait ReadMask extends StObject {
  ...
  var routineId: String = js.native
...
object ReadMask {
  ...
  @scala.inline
  def apply(datasetId: String, projectId: String, routineId: String): ReadMask = {
    val __obj = js.Dynamic.literal(datasetId = datasetId.asInstanceOf[js.Any], projectId = projectId.asInstanceOf[js.Any], routineId = routineId.asInstanceOf[js.Any])
