...
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobConfiguration
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobReference
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobStatistics
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobStatus
