...
object DatasetReference {
  ...
  implicit class DatasetReferenceOps[Self <: DatasetReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatasetReference(value: typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.DatasetReference): Self = this.set("datasetReference", value.asInstanceOf[js.Any])
