...
@js.native
trait SelectedFields extends StObject {
...
object SelectedFields {
  ...
  @scala.inline
  def apply(datasetId: String, projectId: String, tableId: String): SelectedFields = {
    ...
    __obj.asInstanceOf[SelectedFields]
  }
  
  @scala.inline
  implicit class SelectedFieldsMutableBuilder[Self <: SelectedFields] (val x: Self) extends AnyVal {
