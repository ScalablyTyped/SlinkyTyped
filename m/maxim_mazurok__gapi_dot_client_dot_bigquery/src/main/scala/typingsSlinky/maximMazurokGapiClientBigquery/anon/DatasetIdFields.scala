...
@js.native
trait DatasetIdFields extends js.Object {
...
object DatasetIdFields {
  ...
  @scala.inline
  def apply(datasetId: String, projectId: String, tableId: String): DatasetIdFields = {
  ...
  @scala.inline
  implicit class DatasetIdFieldsOps[Self <: DatasetIdFields] (val x: Self) extends AnyVal {
