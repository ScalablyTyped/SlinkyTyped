...
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.Dataset
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(datasetId: String, projectId: String, resource: Dataset): Oauthtoken = {
