...
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.RangePartitioning
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.TableReference
import typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.TimePartitioning
...
trait Clustering extends StObject {
  ...
  var clustering: js.UndefOr[typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.Clustering] = js.native
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientBigquery.maximMazurokGapiClientBigqueryStrings.Clustering with TopLevel[js.Any]
  ] = js.native
...
object Clustering {
  ...
  implicit class ClusteringMutableBuilder[Self <: Clustering] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClustering(value: typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.Clustering): Self = StObject.set(x, "clustering", value.asInstanceOf[js.Any])
