...
object Clustering {
  ...
  implicit class ClusteringOps[Self <: Clustering] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClustering(value: typingsSlinky.maximMazurokGapiClientBigquery.gapi.client.bigquery.Clustering): Self = this.set("clustering", value.asInstanceOf[js.Any])
