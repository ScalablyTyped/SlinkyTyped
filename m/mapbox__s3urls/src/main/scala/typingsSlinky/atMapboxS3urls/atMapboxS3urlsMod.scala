package typingsSlinky.atMapboxS3urls

import typingsSlinky.atMapboxS3urls.atMapboxS3urlsStrings.`bucket-in-host`
import typingsSlinky.atMapboxS3urls.atMapboxS3urlsStrings.`bucket-in-path`
import typingsSlinky.atMapboxS3urls.atMapboxS3urlsStrings.s3
