...
@js.native
trait InstanceName extends js.Object {
...
object InstanceName {
  ...
  @scala.inline
  def apply(instanceName: String): InstanceName = {
    val __obj = js.Dynamic.literal(instanceName = instanceName.asInstanceOf[js.Any])
    __obj.asInstanceOf[InstanceName]
  }
  
  @scala.inline
  implicit class InstanceNameOps[Self <: InstanceName] (val x: Self) extends AnyVal {
