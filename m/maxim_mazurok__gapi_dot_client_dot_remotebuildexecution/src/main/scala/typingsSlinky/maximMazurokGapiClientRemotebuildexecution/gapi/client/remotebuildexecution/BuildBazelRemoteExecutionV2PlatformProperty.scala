...
@js.native
trait BuildBazelRemoteExecutionV2PlatformProperty extends js.Object {
...
object BuildBazelRemoteExecutionV2PlatformProperty {
  ...
  @scala.inline
  implicit class BuildBazelRemoteExecutionV2PlatformPropertyOps[Self <: BuildBazelRemoteExecutionV2PlatformProperty] (val x: Self) extends AnyVal {
