...
@js.native
trait GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance extends js.Object {
...
object GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance {
  ...
  @scala.inline
  implicit class GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceOps[Self <: GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFeaturePolicy(value: GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy): Self = this.set("featurePolicy", value.asInstanceOf[js.Any])
