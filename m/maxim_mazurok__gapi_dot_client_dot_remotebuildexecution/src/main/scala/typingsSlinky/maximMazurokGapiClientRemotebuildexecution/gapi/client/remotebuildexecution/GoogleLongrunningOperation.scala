...
trait GoogleLongrunningOperation extends StObject {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientRemotebuildexecution.maximMazurokGapiClientRemotebuildexecutionStrings.GoogleLongrunningOperation with TopLevel[js.Any]
  ] = js.native
