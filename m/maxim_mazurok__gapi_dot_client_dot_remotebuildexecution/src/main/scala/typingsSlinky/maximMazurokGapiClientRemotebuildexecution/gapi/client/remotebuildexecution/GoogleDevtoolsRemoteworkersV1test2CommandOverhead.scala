...
@js.native
trait GoogleDevtoolsRemoteworkersV1test2CommandOverhead extends js.Object {
...
object GoogleDevtoolsRemoteworkersV1test2CommandOverhead {
  ...
  @scala.inline
  implicit class GoogleDevtoolsRemoteworkersV1test2CommandOverheadOps[Self <: GoogleDevtoolsRemoteworkersV1test2CommandOverhead] (val x: Self) extends AnyVal {
