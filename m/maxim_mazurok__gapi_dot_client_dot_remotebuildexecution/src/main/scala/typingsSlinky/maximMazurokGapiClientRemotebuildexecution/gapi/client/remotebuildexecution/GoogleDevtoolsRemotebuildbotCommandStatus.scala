...
@js.native
trait GoogleDevtoolsRemotebuildbotCommandStatus extends js.Object {
...
object GoogleDevtoolsRemotebuildbotCommandStatus {
  ...
  @scala.inline
  implicit class GoogleDevtoolsRemotebuildbotCommandStatusOps[Self <: GoogleDevtoolsRemotebuildbotCommandStatus] (val x: Self) extends AnyVal {
