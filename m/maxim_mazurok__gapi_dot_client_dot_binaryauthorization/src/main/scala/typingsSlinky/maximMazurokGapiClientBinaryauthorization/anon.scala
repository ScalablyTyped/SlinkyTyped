...
import typingsSlinky.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Policy
import typingsSlinky.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.ValidateAttestationOccurrenceRequest
