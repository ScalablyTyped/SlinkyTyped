...
trait FixedReverseHeap[T] extends js.Object {
  ...
  def consume(): js.Iterable[T] = js.native
...
object FixedReverseHeap {
  ...
  implicit class FixedReverseHeapOps[Self <: FixedReverseHeap[_], T] (val x: Self with FixedReverseHeap[T]) extends AnyVal {
    ...
    @scala.inline
    def setConsume(value: () => js.Iterable[T]): Self = this.set("consume", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setToArray(value: () => js.Iterable[T]): Self = this.set("toArray", js.Any.fromFunction0(value))
  }
}
