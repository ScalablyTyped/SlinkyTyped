...
@js.native
trait DevicePolicy extends js.Object {
  ...
  var osConstraints: js.UndefOr[js.Array[OsConstraint]] = js.native
...
object DevicePolicy {
  ...
  @scala.inline
  implicit class DevicePolicyOps[Self <: DevicePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOsConstraintsVarargs(value: OsConstraint*): Self = this.set("osConstraints", js.Array(value :_*))
    
    @scala.inline
    def setOsConstraints(value: js.Array[OsConstraint]): Self = this.set("osConstraints", value.asInstanceOf[js.Any])
