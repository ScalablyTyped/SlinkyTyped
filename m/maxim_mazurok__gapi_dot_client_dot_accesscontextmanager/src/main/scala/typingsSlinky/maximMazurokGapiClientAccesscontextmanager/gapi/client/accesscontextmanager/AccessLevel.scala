...
trait AccessLevel extends js.Object {
  ...
  var basic: js.UndefOr[BasicLevel] = js.native
  
  /** A `CustomLevel` written in the Common Expression Language. */
  var custom: js.UndefOr[CustomLevel] = js.native
...
object AccessLevel {
  ...
  @scala.inline
  implicit class AccessLevelOps[Self <: AccessLevel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBasic(value: BasicLevel): Self = this.set("basic", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBasic: Self = this.set("basic", js.undefined)
    
    @scala.inline
    def setCustom(value: CustomLevel): Self = this.set("custom", value.asInstanceOf[js.Any])
