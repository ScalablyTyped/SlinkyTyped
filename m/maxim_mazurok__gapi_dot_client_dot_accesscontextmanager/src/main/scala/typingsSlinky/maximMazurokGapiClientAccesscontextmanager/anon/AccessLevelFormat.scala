...
@js.native
trait AccessLevelFormat extends StObject {
...
object AccessLevelFormat {
  
  @scala.inline
  def apply(name: String): AccessLevelFormat = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccessLevelFormat]
  }
  
  @scala.inline
  implicit class AccessLevelFormatMutableBuilder[Self <: AccessLevelFormat] (val x: Self) extends AnyVal {
