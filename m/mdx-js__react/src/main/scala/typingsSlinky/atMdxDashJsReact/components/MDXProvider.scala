package typingsSlinky.atMdxDashJsReact.components

import org.scalablytyped.runtime.StringDictionary
import slinky.core.BuildingComponent
import slinky.core.ExternalComponentWithAttributesWithRefType
import slinky.web.html.`*`.tag
import typingsSlinky.atMdxDashJsReact.atMdxDashJsReactMod.MDXProviderComponentsProp
import typingsSlinky.atMdxDashJsReact.atMdxDashJsReactMod.MDXProviderProps
