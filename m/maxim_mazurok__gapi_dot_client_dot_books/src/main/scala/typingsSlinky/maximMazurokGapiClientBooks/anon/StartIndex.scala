...
trait StartIndex extends StObject {
  ...
  var volumeId: js.UndefOr[String | js.Array[String]] = js.native
}
object StartIndex {
  ...
  implicit class StartIndexMutableBuilder[Self <: StartIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVolumeId(value: String | js.Array[String]): Self = StObject.set(x, "volumeId", value.asInstanceOf[js.Any])
