...
@js.native
trait MaxAllowedMaturityRating extends StObject {
...
object MaxAllowedMaturityRating {
  ...
  @scala.inline
  implicit class MaxAllowedMaturityRatingMutableBuilder[Self <: MaxAllowedMaturityRating] (val x: Self) extends AnyVal {
