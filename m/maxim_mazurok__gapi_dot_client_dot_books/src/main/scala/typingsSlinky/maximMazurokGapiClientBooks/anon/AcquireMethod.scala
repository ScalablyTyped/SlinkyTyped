...
object AcquireMethod {
  ...
  @scala.inline
  implicit class AcquireMethodOps[Self <: AcquireMethod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcquireMethod(value: String | js.Array[String]): Self = this.set("acquireMethod", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProcessingState(value: String | js.Array[String]): Self = this.set("processingState", value.asInstanceOf[js.Any])
