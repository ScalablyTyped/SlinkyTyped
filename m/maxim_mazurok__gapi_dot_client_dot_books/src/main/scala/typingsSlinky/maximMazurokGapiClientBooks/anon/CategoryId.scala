...
trait CategoryId extends StObject {
  ...
  var categoryId: js.UndefOr[String | js.Array[String]] = js.native
...
object CategoryId {
  ...
  implicit class CategoryIdMutableBuilder[Self <: CategoryId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCategoryId(value: String | js.Array[String]): Self = StObject.set(x, "categoryId", value.asInstanceOf[js.Any])
