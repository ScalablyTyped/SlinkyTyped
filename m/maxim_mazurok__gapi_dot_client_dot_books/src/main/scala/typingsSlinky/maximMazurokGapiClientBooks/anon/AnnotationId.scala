...
@js.native
trait AnnotationId extends StObject {
...
object AnnotationId {
  ...
  @scala.inline
  def apply(annotationId: String, layerId: String, volumeId: String): AnnotationId = {
  ...
  @scala.inline
  implicit class AnnotationIdMutableBuilder[Self <: AnnotationId] (val x: Self) extends AnyVal {
