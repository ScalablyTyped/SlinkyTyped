...
import typingsSlinky.maximMazurokGapiClientBooks.anon.Issue
...
object Volumeseriesinfo {
  ...
  @scala.inline
  implicit class VolumeseriesinfoMutableBuilder[Self <: Volumeseriesinfo] (val x: Self) extends AnyVal {
