...
import typingsSlinky.muicss.libReactPanelMod.default
import typingsSlinky.muicss.reactMod.PanelProps
...
object Panel
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.muicss.libReactPanelMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
