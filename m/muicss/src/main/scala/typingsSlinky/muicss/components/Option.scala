...
import typingsSlinky.muicss.libReactOptionMod.default
...
object Option
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLOptionElement, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLOptionElement, Event] => Unit = null,
    prefix: String = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.option.tag.type, typingsSlinky.muicss.libReactOptionMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
