...
import typingsSlinky.muicss.reactMod.ColProps
...
object Col {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.muicss.reactMod.Col] {
    ...
    @scala.inline
    def `lg-offset`(value: Double): this.type = set("lg-offset", value.asInstanceOf[js.Any])
    
    @scala.inline
    def md(value: Double): this.type = set("md", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `md-offset`(value: Double): this.type = set("md-offset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `sm-offset`(value: Double): this.type = set("sm-offset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def xl(value: Double): this.type = set("xl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `xl-offset`(value: Double): this.type = set("xl-offset", value.asInstanceOf[js.Any])
    
    @scala.inline
    def xs(value: Double): this.type = set("xs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `xs-offset`(value: Double): this.type = set("xs-offset", value.asInstanceOf[js.Any])
  }
