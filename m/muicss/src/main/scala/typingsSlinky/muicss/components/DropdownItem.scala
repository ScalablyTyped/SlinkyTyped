...
import typingsSlinky.muicss.dropdownItemMod.default
import typingsSlinky.muicss.reactMod.DropdownItemProps
...
object DropdownItem
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.li.tag.type, typingsSlinky.muicss.dropdownItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
