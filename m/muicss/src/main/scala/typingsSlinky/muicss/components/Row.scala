...
object Row {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.muicss.reactMod.Row] {
    ...
    @scala.inline
    def lg(value: Double): this.type = set("lg", value.asInstanceOf[js.Any])
    
    @scala.inline
    def md(value: Double): this.type = set("md", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def sm(value: Double): this.type = set("sm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def xs(value: Double): this.type = set("xs", value.asInstanceOf[js.Any])
  }
