...
import typingsSlinky.muicss.libReactButtonMod.default
import typingsSlinky.muicss.reactMod.ButtonProps
...
object Button
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.button.tag.type, typingsSlinky.muicss.libReactButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
