...
object Textarea {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.muicss.reactMod.Textarea] {
    @scala.inline
    ...
    @scala.inline
    def floatingLabel(value: Boolean): this.type = set("floatingLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def form(value: String): this.type = set("form", value.asInstanceOf[js.Any])
    @scala.inline
    def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    @scala.inline
    def hint(value: String): this.type = set("hint", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onLabelClick(value: SyntheticMouseEvent[HTMLInputElement] => Unit): this.type = set("onLabelClick", js.Any.fromFunction1(value))
    @scala.inline
