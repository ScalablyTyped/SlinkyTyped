...
import typingsSlinky.muicss.reactMod.TabsProps
import typingsSlinky.muicss.tabsMod.default
...
object Tabs
  ...
  @JSImport("muicss/lib/react/tabs", JSImport.Default)
  @js.native
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.muicss.tabsMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
