...
object Dropdown {
  @JSImport("muicss/react", "Dropdown")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.muicss.reactMod.Dropdown] {
    @scala.inline
    def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    @scala.inline
    def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    @scala.inline
    def alignMenu(value: left | right): this.type = set("alignMenu", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onOutsideClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onOutsideClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def variant(value: String): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
