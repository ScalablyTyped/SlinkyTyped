...
import typingsSlinky.muicss.libReactDropdownMod.default
import typingsSlinky.muicss.muicssStrings.left
import typingsSlinky.muicss.muicssStrings.right
import typingsSlinky.muicss.reactMod.DropdownProps
...
object Dropdown
  ...
  def apply(
    ...
    onOutsideClick: SyntheticMouseEvent[HTMLDivElement] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.muicss.libReactDropdownMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
