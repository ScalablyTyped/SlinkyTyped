...
import typingsSlinky.muicss.libReactSelectMod.default
import typingsSlinky.muicss.reactMod.SelectProps
...
object Select
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.muicss.libReactSelectMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
