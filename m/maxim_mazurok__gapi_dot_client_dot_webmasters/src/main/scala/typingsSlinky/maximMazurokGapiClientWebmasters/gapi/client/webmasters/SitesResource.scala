package typingsSlinky.maximMazurokGapiClientWebmasters.gapi.client.webmasters

import typingsSlinky.gapiClient.gapi.client.Request
import typingsSlinky.maximMazurokGapiClientWebmasters.anon.Fields
import typingsSlinky.maximMazurokGapiClientWebmasters.anon.Oauthtoken
