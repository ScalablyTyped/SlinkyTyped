...
trait Config extends js.Object {
  ...
  /**
    * @default function() {}
    */
  var loaded: js.UndefOr[js.Function1[/* lib */ typingsSlinky.mixpanel.Mixpanel, Unit]] = js.native
...
object Config {
  ...
  implicit class ConfigOps[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLoaded(value: /* lib */ typingsSlinky.mixpanel.Mixpanel => Unit): Self = this.set("loaded", js.Any.fromFunction1(value))
