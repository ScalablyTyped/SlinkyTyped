...
import typingsSlinky.materialDashUi.__MaterialUI.propTypes.corners
...
object materialDashUiStrings {
  ...
  @js.native
  sealed trait bottom
    extends typingsSlinky.materialDashUi.__MaterialUI.propTypes.vertical
  ...
  sealed trait center
    extends tooltipHorizontal
       with typingsSlinky.materialDashUi.__MaterialUI.propTypes.vertical
  ...
  sealed trait left
    extends direction
       with typingsSlinky.materialDashUi.__MaterialUI.propTypes.horizontal
  ...
  @js.native
  sealed trait middle
    extends typingsSlinky.materialDashUi.__MaterialUI.propTypes.horizontal
