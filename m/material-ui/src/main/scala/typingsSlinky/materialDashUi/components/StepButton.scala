...
import typingsSlinky.materialDashUi.__MaterialUI.Stepper.StepButtonProps
...
object StepButton
  ...
  ): BuildingComponent[tag.type, typingsSlinky.materialDashUi.stepperMod.StepButton] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.materialDashUi.stepperMod.StepButton] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialDashUi.stepperMod.StepButton](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
