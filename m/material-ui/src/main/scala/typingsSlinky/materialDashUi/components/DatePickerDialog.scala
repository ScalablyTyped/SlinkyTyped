...
object DatePickerDialog
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.materialDashUi.datePickerDatePickerDialogMod.default].asInstanceOf[String | js.Object]
  def apply(
