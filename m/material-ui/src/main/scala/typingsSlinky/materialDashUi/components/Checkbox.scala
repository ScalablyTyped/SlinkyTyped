...
import typingsSlinky.materialDashUi.__MaterialUI.Switches.CheckboxProps
import typingsSlinky.materialDashUi.checkboxMod.default
...
object Checkbox
  ...
  def apply(
    ...
    onCheck: (/* event */ SyntheticMouseEvent[js.Object], /* checked */ Boolean) => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialDashUi.checkboxMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
