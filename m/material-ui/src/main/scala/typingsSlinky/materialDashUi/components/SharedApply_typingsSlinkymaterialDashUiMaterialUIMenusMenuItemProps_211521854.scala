...
import typingsSlinky.materialDashUi.__MaterialUI.Menus.MenuItemProps
...
abstract class SharedApply_typingsSlinkymaterialDashUiMaterialUIMenusMenuItemProps_211521854 (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onNestedListToggle: /* item */ typingsSlinky.materialDashUi.__MaterialUI.List.ListItem => Unit = null,
