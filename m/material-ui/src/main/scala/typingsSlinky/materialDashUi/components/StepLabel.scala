...
object StepLabel
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.materialDashUi.stepperMod.StepLabel] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialDashUi.stepperMod.StepLabel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
