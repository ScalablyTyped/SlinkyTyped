...
import typingsSlinky.materialDashUi.__MaterialUI.Switches.ToggleProps
...
import typingsSlinky.materialDashUi.toggleMod.default
...
object Toggle
  ...
  def apply(
    ...
    onToggle: (/* e */ SyntheticMouseEvent[js.Object], /* isInputChecked */ Boolean) => Unit = null,
    prefix: String = null,
    ...
    if (!js.isUndefined(defaultToggled)) __obj.updateDynamic("defaultToggled")(defaultToggled.asInstanceOf[js.Any])
    if (elementStyle != null) __obj.updateDynamic("elementStyle")(elementStyle.asInstanceOf[js.Any])
    ...
    if (thumbSwitchedStyle != null) __obj.updateDynamic("thumbSwitchedStyle")(thumbSwitchedStyle.asInstanceOf[js.Any])
    ...
    if (trackSwitchedStyle != null) __obj.updateDynamic("trackSwitchedStyle")(trackSwitchedStyle.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialDashUi.toggleMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
