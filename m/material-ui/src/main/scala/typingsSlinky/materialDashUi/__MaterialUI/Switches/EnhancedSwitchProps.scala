...
object EnhancedSwitchProps {
  ...
  def apply(
    ...
    onSwitch: (/* e */ SyntheticMouseEvent[js.Object], /* isInputChecked */ Boolean) => Unit = null,
    ...
    ref: LegacyRef[EnhancedSwitch] = null,
    ...
    if (!js.isUndefined(defaultSwitched)) __obj.updateDynamic("defaultSwitched")(defaultSwitched.asInstanceOf[js.Any])
