...
import typingsSlinky.materialDashUi.__MaterialUI.propTypes.cornersAndCenter
...
object IconButtonProps {
  ...
  def apply(
    ...
    if (hoveredStyle != null) __obj.updateDynamic("hoveredStyle")(hoveredStyle.asInstanceOf[js.Any])
    ...
    if (tooltipStyles != null) __obj.updateDynamic("tooltipStyles")(tooltipStyles.asInstanceOf[js.Any])
