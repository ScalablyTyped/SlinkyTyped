...
import typingsSlinky.materialUi.MaterialUI.Styles.zIndex
...
object zIndexMod {
  ...
  @JSImport("material-ui/styles/zIndex", JSImport.Namespace)
  @js.native
  ...
  @js.native
  def zIndex: typingsSlinky.materialUi.MaterialUI.Styles.zIndex = js.native
  @scala.inline
