...
object Toggle {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def elementStyle(value: CSSProperties): this.type = set("elementStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: ChangeEvent[js.Object] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def onToggle(value: (/* e */ SyntheticMouseEvent[js.Object], /* isInputChecked */ Boolean) => Unit): this.type = set("onToggle", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def thumbSwitchedStyle(value: CSSProperties): this.type = set("thumbSwitchedStyle", value.asInstanceOf[js.Any])
    @scala.inline
    def title(value: String): this.type = set("title", value.asInstanceOf[js.Any])
    @scala.inline
    def toggled(value: Boolean): this.type = set("toggled", value.asInstanceOf[js.Any])
    @scala.inline
    def trackStyle(value: CSSProperties): this.type = set("trackStyle", value.asInstanceOf[js.Any])
    @scala.inline
    def trackSwitchedStyle(value: CSSProperties): this.type = set("trackSwitchedStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def valueLink(value: ReactLink[Boolean]): this.type = set("valueLink", value.asInstanceOf[js.Any])
    @scala.inline
