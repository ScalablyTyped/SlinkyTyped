...
object AutoCompleteItem {
  ...
  implicit def make(companion: AutoCompleteItem.type): SharedBuilder_MenuItemProps1562558520 = new SharedBuilder_MenuItemProps1562558520(js.Array(this.component, js.Dictionary.empty))()
}
