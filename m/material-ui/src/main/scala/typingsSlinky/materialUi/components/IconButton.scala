...
object IconButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def hoveredStyle(value: CSSProperties): this.type = set("hoveredStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def tooltipStyles(value: CSSProperties): this.type = set("tooltipStyles", value.asInstanceOf[js.Any])
    @scala.inline
