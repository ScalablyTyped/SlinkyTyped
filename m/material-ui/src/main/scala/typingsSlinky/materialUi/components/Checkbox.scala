...
import typingsSlinky.materialUi.MaterialUI.Switches.CheckboxProps
import typingsSlinky.materialUi.materialUiMod.default
...
object Checkbox {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onCheck(value: (/* event */ SyntheticMouseEvent[js.Object], /* checked */ Boolean) => Unit): this.type = set("onCheck", js.Any.fromFunction2(value))
    @scala.inline
...
object CheckBox {
  ...
  def withProps(p: SvgIconProps): SharedBuilder_SvgIconProps_1073724525[typingsSlinky.materialUi.checkBoxMod.default] = new SharedBuilder_SvgIconProps_1073724525[typingsSlinky.materialUi.checkBoxMod.default](js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CheckBox.type): SharedBuilder_SvgIconProps_1073724525[typingsSlinky.materialUi.checkBoxMod.default] = new SharedBuilder_SvgIconProps_1073724525[typingsSlinky.materialUi.checkBoxMod.default](js.Array(this.component, js.Dictionary.empty))()
}
