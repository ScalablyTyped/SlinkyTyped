...
@scala.inline
class SharedBuilder_MenuItemProps1562558520 (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def onNestedListToggle(value: /* item */ typingsSlinky.materialUi.MaterialUI.List.ListItem => Unit): this.type = set("onNestedListToggle", js.Any.fromFunction1(value))
  @scala.inline
