...
abstract class SharedApply_MenuItemProps1113812973 (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, js.Object] {
  /* The following DOM/SVG props were specified: checked, className, contentEditable, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, href, id, lang, open, placeholder, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title, type */
  def apply(
    about: String = null,
    ...
    onNestedListToggle: /* item */ typingsSlinky.materialUi.MaterialUI.List.ListItem => Unit = null,
