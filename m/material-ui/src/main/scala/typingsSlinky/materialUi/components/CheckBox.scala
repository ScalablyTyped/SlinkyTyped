...
import typingsSlinky.materialUi.checkBoxMod.default
...
object CheckBox {
  ...
  implicit def make(companion: CheckBox.type): SharedBuilder_SvgIconProps_1073724525[default] = new SharedBuilder_SvgIconProps_1073724525[default](js.Array(this.component, js.Dictionary.empty))()
}
...
object Checkbox {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.materialUi.materialUiMod.default] {
    @scala.inline
