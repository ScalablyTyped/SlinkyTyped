...
object TextField
  ...
  /* The following DOM/SVG props were specified: autoComplete, autoFocus, className, disabled, id, name, placeholder, required, rows, style, title, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialUi.textFieldMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
