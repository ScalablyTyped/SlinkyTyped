...
import typingsSlinky.materialUi.MaterialUI.Switches.RadioButtonProps
import typingsSlinky.materialUi.radioButtonMod.default
...
object RadioButton
  ...
  def apply(
    ...
    onCheck: (SyntheticEvent[EventTarget with js.Object, Event_], /* selected */ String) => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialUi.radioButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
