...
import typingsSlinky.materialUi.flatButtonMod.default
...
object FlatButton
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, disabled, href, style, tabIndex, target, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialUi.flatButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
