...
import typingsSlinky.materialUi.floatingActionButtonMod.default
...
object FloatingActionButton
  ...
  typingsSlinky.materialUi.floatingActionButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
