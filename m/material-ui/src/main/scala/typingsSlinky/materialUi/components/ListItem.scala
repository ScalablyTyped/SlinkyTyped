...
import typingsSlinky.materialUi.listItemMod.default
...
object ListItem
  ...
  /* The following DOM/SVG props were specified: className, contentEditable, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, hidden, href, id, lang, open, placeholder, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title, type */
  def apply(
    about: String = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialUi.listItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
