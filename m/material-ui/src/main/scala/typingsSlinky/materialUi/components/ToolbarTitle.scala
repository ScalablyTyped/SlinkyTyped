...
object ToolbarTitle {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.materialUi.mod.ToolbarTitle] {
    @scala.inline
  ...
  def withProps(p: ToolbarTitleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ToolbarTitle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
