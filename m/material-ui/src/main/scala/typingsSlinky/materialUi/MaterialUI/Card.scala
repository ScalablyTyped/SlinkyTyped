...
object Card {
  ...
  type CardActions = ReactComponentClass[CardActionsProps]
  ...
  type CardExpandable = ReactComponentClass[CardExpandableProps]
  ...
  type CardMedia = ReactComponentClass[CardMediaProps]
  ...
  type CardText = ReactComponentClass[CardTextProps]
