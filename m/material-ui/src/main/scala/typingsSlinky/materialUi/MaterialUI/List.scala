...
object List {
  ...
  type List = ReactComponentClass[ListProps]
  
  type ListItem = ReactComponentClass[ListItemProps]
  ...
  object ListItemProps {
    ...
    implicit class ListItemPropsMutableBuilder[Self <: ListItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnNestedListToggle(value: ReactComponentClass[ListItemProps] => Unit): Self = StObject.set(x, "onNestedListToggle", js.Any.fromFunction1(value))
  ...
  object SelectableProps {
    ...
    implicit class SelectablePropsMutableBuilder[Self <: SelectableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (/* e */ SyntheticEvent[Event, js.Object], /* value */ js.Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
