...
object Switches {
  ...
  object CheckboxProps {
    ...
    implicit class CheckboxPropsMutableBuilder[Self <: CheckboxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnCheck(value: (/* event */ SyntheticMouseEvent[js.Object], /* checked */ Boolean) => Unit): Self = StObject.set(x, "onCheck", js.Any.fromFunction2(value))
  ...
  object EnhancedSwitchProps {
    ...
    implicit class EnhancedSwitchPropsMutableBuilder[Self <: EnhancedSwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSwitch(value: (/* e */ SyntheticMouseEvent[js.Object], /* isInputChecked */ Boolean) => Unit): Self = StObject.set(x, "onSwitch", js.Any.fromFunction2(value))
  ...
  object RadioButtonGroupProps {
    ...
    implicit class RadioButtonGroupPropsMutableBuilder[Self <: RadioButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: (SyntheticEvent[EventTarget with js.Object, Event], /* selected */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
  ...
  object RadioButtonProps {
    ...
    implicit class RadioButtonPropsMutableBuilder[Self <: RadioButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnCheck(value: (SyntheticEvent[EventTarget with js.Object, Event], /* selected */ String) => Unit): Self = StObject.set(x, "onCheck", js.Any.fromFunction2(value))
  ...
  object ToggleProps {
    ...
    implicit class TogglePropsMutableBuilder[Self <: ToggleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnToggle(value: (/* e */ SyntheticMouseEvent[js.Object], /* isInputChecked */ Boolean) => Unit): Self = StObject.set(x, "onToggle", js.Any.fromFunction2(value))
