...
object Popover {
  ...
  type PopoverAnimationDefault = ReactComponentClass[PopoverAnimationDefaultProps]
  ...
  type PopoverAnimationVertical = ReactComponentClass[PopoverAnimationVerticalProps]
  ...
  object PopoverProps {
    ...
    implicit class PopoverPropsMutableBuilder[Self <: PopoverProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAnchorElComponent(value: ReactComponentClass[js.Any]): Self = StObject.set(x, "anchorEl", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAnchorElElement(value: Element): Self = StObject.set(x, "anchorEl", value.asInstanceOf[js.Any])
