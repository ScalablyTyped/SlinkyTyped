...
object TimePickerProps {
  ...
  implicit class TimePickerPropsOps[Self <: TimePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultTime(value: js.Date): Self = this.set("defaultTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* e */ js.Any, /* time */ js.Date) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
