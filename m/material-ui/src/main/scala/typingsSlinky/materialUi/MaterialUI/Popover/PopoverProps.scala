...
object PopoverProps {
  ...
  implicit class PopoverPropsOps[Self <: PopoverProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnchorElElement(value: Element): Self = this.set("anchorEl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAnchorElComponent(value: ReactComponentClass[js.Any]): Self = this.set("anchorEl", value.asInstanceOf[js.Any])
