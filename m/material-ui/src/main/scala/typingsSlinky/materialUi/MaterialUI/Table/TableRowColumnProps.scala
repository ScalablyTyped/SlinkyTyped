...
object TableRowColumnProps {
  ...
  implicit class TableRowColumnPropsOps[Self <: TableRowColumnProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnHover(value: (/* e */ SyntheticMouseEvent[js.Object], /* column */ Double) => Unit): Self = this.set("onHover", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnHover: Self = this.set("onHover", js.undefined)
    
    @scala.inline
    def setOnHoverExit(value: (/* e */ SyntheticMouseEvent[js.Object], /* column */ Double) => Unit): Self = this.set("onHoverExit", js.Any.fromFunction2(value))
