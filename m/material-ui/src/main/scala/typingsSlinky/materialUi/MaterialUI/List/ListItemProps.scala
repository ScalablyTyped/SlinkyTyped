...
object ListItemProps {
  ...
  def apply(
    ...
    onNestedListToggle: ReactComponentClass[ListItemProps] => Unit = null,
    ...
    role: String = null,
    secondaryText: TagMod[Any] = null,
    secondaryTextLines: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(autoGenerateNestedIndicator)) __obj.updateDynamic("autoGenerateNestedIndicator")(autoGenerateNestedIndicator.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(initiallyOpen)) __obj.updateDynamic("initiallyOpen")(initiallyOpen.get.asInstanceOf[js.Any])
    if (inlist != null) __obj.updateDynamic("inlist")(inlist.asInstanceOf[js.Any])
    if (innerDivStyle != null) __obj.updateDynamic("innerDivStyle")(innerDivStyle.asInstanceOf[js.Any])
    if (inputMode != null) __obj.updateDynamic("inputMode")(inputMode.asInstanceOf[js.Any])
    if (!js.isUndefined(insetChildren)) __obj.updateDynamic("insetChildren")(insetChildren.get.asInstanceOf[js.Any])
    ...
    if (leftCheckbox != null) __obj.updateDynamic("leftCheckbox")(leftCheckbox.asInstanceOf[js.Any])
    if (leftIcon != null) __obj.updateDynamic("leftIcon")(leftIcon.asInstanceOf[js.Any])
    if (nestedItems != null) __obj.updateDynamic("nestedItems")(nestedItems.asInstanceOf[js.Any])
    if (!js.isUndefined(nestedLevel)) __obj.updateDynamic("nestedLevel")(nestedLevel.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(primaryTogglesNestedList)) __obj.updateDynamic("primaryTogglesNestedList")(primaryTogglesNestedList.get.asInstanceOf[js.Any])
    ...
    if (rightIconButton != null) __obj.updateDynamic("rightIconButton")(rightIconButton.asInstanceOf[js.Any])
    if (rightToggle != null) __obj.updateDynamic("rightToggle")(rightToggle.asInstanceOf[js.Any])
    if (role != null) __obj.updateDynamic("role")(role.asInstanceOf[js.Any])
    if (secondaryText != null) __obj.updateDynamic("secondaryText")(secondaryText.asInstanceOf[js.Any])
    if (!js.isUndefined(secondaryTextLines)) __obj.updateDynamic("secondaryTextLines")(secondaryTextLines.get.asInstanceOf[js.Any])
