...
- typingsSlinky.react.mod.Props because var conflicts: children. Inlined key, ref */ trait FontIconProps
...
object FontIconProps {
  ...
  implicit class FontIconPropsOps[Self <: FontIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[FontIcon]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
