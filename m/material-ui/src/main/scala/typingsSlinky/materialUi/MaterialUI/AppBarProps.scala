...
object AppBarProps {
  ...
  implicit class AppBarPropsMutableBuilder[Self <: AppBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLeftIconButtonClick(value: SyntheticMouseEvent[js.Object] => Unit): Self = StObject.set(x, "onLeftIconButtonClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnLeftIconButtonClickUndefined: Self = StObject.set(x, "onLeftIconButtonClick", js.undefined)
    
    @scala.inline
    def setOnRightIconButtonClick(value: SyntheticMouseEvent[js.Object] => Unit): Self = StObject.set(x, "onRightIconButtonClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnRightIconButtonClickUndefined: Self = StObject.set(x, "onRightIconButtonClick", js.undefined)
    
    @scala.inline
    def setOnTitleClick(value: SyntheticMouseEvent[js.Object] => Unit): Self = StObject.set(x, "onTitleClick", js.Any.fromFunction1(value))
