...
trait SliderProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* e */ SyntheticMouseEvent[js.Object], /* value */ Double, Unit]] = js.undefined
...
object SliderProps {
  ...
  implicit class SliderPropsOps[Self <: SliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxis(value: typingsSlinky.materialUi.materialUiStrings.x | `x-reverse` | y | `y-reverse`): Self = this.set("axis", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* e */ SyntheticMouseEvent[js.Object], /* value */ Double) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    @scala.inline
    def setOnDragStart(value: SyntheticMouseEvent[js.Object] => Unit): Self = this.set("onDragStart", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnDragStart: Self = this.set("onDragStart", js.undefined)
    @scala.inline
    def setOnDragStop(value: SyntheticMouseEvent[js.Object] => Unit): Self = this.set("onDragStop", js.Any.fromFunction1(value))
    @scala.inline
