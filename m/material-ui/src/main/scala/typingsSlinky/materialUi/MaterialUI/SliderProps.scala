...
object SliderProps {
  ...
  implicit class SliderPropsMutableBuilder[Self <: SliderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxis(value: typingsSlinky.materialUi.materialUiStrings.x | `x-reverse` | y | `y-reverse`): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* e */ SyntheticMouseEvent[js.Object], /* value */ Double) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    @scala.inline
    def setOnDragStart(value: SyntheticMouseEvent[js.Object] => Unit): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
    
    @scala.inline
    def setOnDragStop(value: SyntheticMouseEvent[js.Object] => Unit): Self = StObject.set(x, "onDragStop", js.Any.fromFunction1(value))
