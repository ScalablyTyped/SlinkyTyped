...
trait TableRowProps extends js.Object {
  ...
  /** @deprecated Instead, use event handler on Table */
  var onRowClick: js.UndefOr[js.Function2[/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, Unit]] = js.undefined
  /** @deprecated Instead, use event handler on Table */
  var onRowHover: js.UndefOr[js.Function2[/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, Unit]] = js.undefined
  /** @deprecated Instead, use event handler on Table */
  var onRowHoverExit: js.UndefOr[js.Function2[/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, Unit]] = js.undefined
...
object TableRowProps {
  ...
  implicit class TableRowPropsOps[Self <: TableRowProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCellClick(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, /* column */ Double) => Unit): Self = this.set("onCellClick", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCellClick: Self = this.set("onCellClick", js.undefined)
    @scala.inline
    def setOnCellHover(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, /* column */ Double) => Unit): Self = this.set("onCellHover", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCellHover: Self = this.set("onCellHover", js.undefined)
    @scala.inline
    def setOnCellHoverExit(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double, /* column */ Double) => Unit): Self = this.set("onCellHoverExit", js.Any.fromFunction3(value))
    @scala.inline
    def deleteOnCellHoverExit: Self = this.set("onCellHoverExit", js.undefined)
    @scala.inline
    def setOnRowClick(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double) => Unit): Self = this.set("onRowClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowClick: Self = this.set("onRowClick", js.undefined)
    @scala.inline
    def setOnRowHover(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double) => Unit): Self = this.set("onRowHover", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnRowHover: Self = this.set("onRowHover", js.undefined)
    @scala.inline
    def setOnRowHoverExit(value: (/* e */ SyntheticMouseEvent[js.Object], /* row */ Double) => Unit): Self = this.set("onRowHoverExit", js.Any.fromFunction2(value))
    @scala.inline
