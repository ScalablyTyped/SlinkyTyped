...
object TextFieldProps {
  ...
  implicit class TextFieldPropsMutableBuilder[Self <: TextFieldProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (SyntheticEvent[EventTarget with js.Object, Event], /* newValue */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnKeyPress(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = StObject.set(x, "onKeyPress", js.Any.fromFunction1(value))
