...
object TextFieldProps {
  ...
  implicit class TextFieldPropsOps[Self <: TextFieldProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (SyntheticEvent[EventTarget with js.Object, Event], /* newValue */ String) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnKeyPress(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onKeyPress", js.Any.fromFunction1(value))
