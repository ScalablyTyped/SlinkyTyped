...
object ToggleProps {
  ...
  def apply(
    ...
    ref: js.UndefOr[Null | LegacyRef[Toggle]] = js.undefined,
    ...
    if (!js.isUndefined(defaultToggled)) __obj.updateDynamic("defaultToggled")(defaultToggled.get.asInstanceOf[js.Any])
