...
object TableBodyProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(displayRowCheckbox)) __obj.updateDynamic("displayRowCheckbox")(displayRowCheckbox.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(preScanRows)) __obj.updateDynamic("preScanRows")(preScanRows.get.asInstanceOf[js.Any])
