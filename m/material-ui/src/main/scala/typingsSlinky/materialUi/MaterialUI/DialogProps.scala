...
- typingsSlinky.react.mod.Props because var conflicts: children. Inlined key, ref */ trait DialogProps
...
object DialogProps {
  ...
  implicit class DialogPropsOps[Self <: DialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[Dialog]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
