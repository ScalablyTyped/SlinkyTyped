...
import typingsSlinky.materialUi.MaterialUI.propTypes.corners
...
object materialUiStrings {
  ...
  @js.native
  sealed trait bottom
    extends typingsSlinky.materialUi.MaterialUI.propTypes.vertical
  ...
  sealed trait center
    extends tooltipHorizontal
       with typingsSlinky.materialUi.MaterialUI.propTypes.vertical
  ...
  sealed trait left
    extends direction
       with typingsSlinky.materialUi.MaterialUI.propTypes.horizontal
