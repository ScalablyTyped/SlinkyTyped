...
trait GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings extends StObject {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.memcache.gapi.client.memcache.MaintenancePolicy}
    */ typingsSlinky.maximMazurokGapiClientMemcache.maximMazurokGapiClientMemcacheStrings.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings with TopLevel[js.Any]
  ] = js.native
}
