...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientMemcache.maximMazurokGapiClientMemcacheStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance with TopLevel[js.Any]
  ] = js.native
