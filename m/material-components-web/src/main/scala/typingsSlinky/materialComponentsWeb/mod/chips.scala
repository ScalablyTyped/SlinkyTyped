...
object chips {
  ...
  class MDCChip protected ()
    ...
    def this(
      root: Element,
      foundation: typingsSlinky.materialChips.chipFoundationMod.MDCChipFoundation,
      args: js.Any*
    ) = this()
  }
  /* static members */
  ...
  class MDCChipSet protected ()
    ...
    def this(
      root: Element,
      foundation: typingsSlinky.materialChips.foundationMod.MDCChipSetFoundation,
      args: js.Any*
    ) = this()
  }
  /* static members */
  ...
  class MDCChipTrailingAction protected ()
    extends typingsSlinky.materialChips.mod.MDCChipTrailingAction {
    def this(root: Element, foundation: js.UndefOr[scala.Nothing], args: js.Any*) = this()
    def this(
      root: Element,
  ...
  class MDCChipTrailingActionFoundation ()
    extends typingsSlinky.materialChips.mod.MDCChipTrailingActionFoundation {
