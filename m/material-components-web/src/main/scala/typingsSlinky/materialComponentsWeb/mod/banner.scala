...
@JSImport("material-components-web", "banner")
@js.native
object banner extends js.Object {
  ...
  @js.native
  class MDCBanner ()
    extends typingsSlinky.materialBanner.mod.MDCBanner
  /* static members */
  @js.native
  ...
  class MDCBannerFoundation ()
    extends typingsSlinky.materialBanner.mod.MDCBannerFoundation {
