...
object dataTable extends js.Object {
  @js.native
  class MDCDataTable ()
    extends typingsSlinky.atMaterialDataDashTable.atMaterialDataDashTableMod.MDCDataTable
  
  @js.native
  class MDCDataTableFoundation ()
    extends typingsSlinky.atMaterialDataDashTable.atMaterialDataDashTableMod.MDCDataTableFoundation {
