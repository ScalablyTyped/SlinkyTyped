...
object chips extends js.Object {
  @js.native
  class MDCChip ()
    extends typingsSlinky.atMaterialChips.atMaterialChipsMod.MDCChip
  
  @js.native
  class MDCChipFoundation ()
    extends typingsSlinky.atMaterialChips.atMaterialChipsMod.MDCChipFoundation
  
  @js.native
  class MDCChipSet ()
    extends typingsSlinky.atMaterialChips.atMaterialChipsMod.MDCChipSet
  
  @js.native
  class MDCChipSetFoundation ()
    extends typingsSlinky.atMaterialChips.atMaterialChipsMod.MDCChipSetFoundation
