...
import typingsSlinky.atMaterialIconDashButton.Anon_ARIAPRESSED
import typingsSlinky.atMaterialIconDashButton.Anon_ICONBUTTONON
...
object iconButton extends js.Object {
  ...
  class MDCIconButtonToggle ()
    extends typingsSlinky.atMaterialIconDashButton.atMaterialIconDashButtonMod.MDCIconButtonToggle
  
  @js.native
  class MDCIconButtonToggleFoundation ()
    extends typingsSlinky.atMaterialIconDashButton.atMaterialIconDashButtonMod.MDCIconButtonToggleFoundation {
  ...
  object MDCIconButtonToggle extends js.Object {
    def attachTo(root: HTMLElement): typingsSlinky.atMaterialIconDashButton.componentMod.MDCIconButtonToggle = js.native
  }
