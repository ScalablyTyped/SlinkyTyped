...
trait LabelIds extends StObject {
  ...
  var labelIds: js.UndefOr[String | js.Array[String]] = js.native
...
object LabelIds {
  ...
  implicit class LabelIdsMutableBuilder[Self <: LabelIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelIds(value: String | js.Array[String]): Self = StObject.set(x, "labelIds", value.asInstanceOf[js.Any])
