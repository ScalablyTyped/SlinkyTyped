...
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer.anon.Advertiser
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer.anon.Contexts
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer.anon.Date
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer.anon.DetectedProviderIds
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer.anon.DisapprovalReasons
...
object Creative {
  ...
  implicit class CreativeOps[Self <: Creative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdTechnologyProviders(value: DetectedProviderIds): Self = this.set("adTechnologyProviders", value.asInstanceOf[js.Any])
