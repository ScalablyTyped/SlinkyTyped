package typingsSlinky.maximMazurokGapiClientWorkflows.anon

import typingsSlinky.maximMazurokGapiClientWorkflows.gapi.client.workflows.Workflow
...
object Key {
  ...
  @scala.inline
  def apply(name: String, resource: Workflow): Key = {
