...
trait IdentitytoolkitRelyingpartyCreateAuthUriRequest extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientIdentitytoolkit.maximMazurokGapiClientIdentitytoolkitStrings.IdentitytoolkitRelyingpartyCreateAuthUriRequest with TopLevel[js.Any]
  ] = js.native
