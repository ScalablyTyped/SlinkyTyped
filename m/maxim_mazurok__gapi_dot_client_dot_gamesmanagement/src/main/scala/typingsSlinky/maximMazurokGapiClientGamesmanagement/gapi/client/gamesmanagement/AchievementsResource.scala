...
import typingsSlinky.maximMazurokGapiClientGamesmanagement.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientGamesmanagement.anon.Alt
import typingsSlinky.maximMazurokGapiClientGamesmanagement.anon.Callback
