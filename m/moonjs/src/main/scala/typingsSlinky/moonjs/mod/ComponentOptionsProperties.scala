...
object ComponentOptionsProperties {
  @scala.inline
  def apply[/* <: java.lang.String */ Props, Data, Methods](): ComponentOptionsProperties[Props, Data, Methods] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentOptionsProperties[Props, Data, Methods]]
  }
  @scala.inline
  implicit class ComponentOptionsPropertiesOps[Self <: ComponentOptionsProperties[_, _, _], /* <: java.lang.String */ Props, Data, Methods] (val x: Self with (ComponentOptionsProperties[Props, Data, Methods])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setElHTMLElement(value: HTMLElement): Self = this.set("el", value.asInstanceOf[js.Any])
    @scala.inline
