...
@js.native
trait LookupMembershipNameResponse extends js.Object {
...
object LookupMembershipNameResponse {
  ...
  @scala.inline
  implicit class LookupMembershipNameResponseOps[Self <: LookupMembershipNameResponse] (val x: Self) extends AnyVal {
