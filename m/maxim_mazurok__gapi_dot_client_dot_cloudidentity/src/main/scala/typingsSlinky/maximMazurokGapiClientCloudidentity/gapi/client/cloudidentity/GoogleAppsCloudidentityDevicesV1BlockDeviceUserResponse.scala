...
@js.native
trait GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse extends js.Object {
...
object GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse {
  ...
  @scala.inline
  implicit class GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponseOps[Self <: GoogleAppsCloudidentityDevicesV1BlockDeviceUserResponse] (val x: Self) extends AnyVal {
