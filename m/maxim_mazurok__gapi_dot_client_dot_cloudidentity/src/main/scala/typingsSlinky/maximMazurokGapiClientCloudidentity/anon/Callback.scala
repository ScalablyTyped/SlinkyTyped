...
import typingsSlinky.maximMazurokGapiClientCloudidentity.gapi.client.cloudidentity.GoogleAppsCloudidentityDevicesV1ClientState
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: GoogleAppsCloudidentityDevicesV1ClientState = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleAppsCloudidentityDevicesV1ClientState): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleAppsCloudidentityDevicesV1ClientState): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
