...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/toolbar/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/toolbar/constants", "cssClasses.FIXED")
    @js.native
    def FIXED: String = js.native
    @scala.inline
    def FIXED_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FIXED")(x.asInstanceOf[js.Any])
    
    @JSImport("@material/toolbar/constants", "cssClasses.FIXED_AT_LAST_ROW")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "cssClasses.FIXED_LASTROW")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "cssClasses.FLEXIBLE_DEFAULT_BEHAVIOR")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "cssClasses.FLEXIBLE_MAX")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "cssClasses.FLEXIBLE_MIN")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "cssClasses.TOOLBAR_ROW_FLEXIBLE")
    @js.native
  ...
  object numbers {
    ...
    @JSImport("@material/toolbar/constants", "numbers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/toolbar/constants", "numbers.MAX_TITLE_SIZE")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "numbers.MIN_TITLE_SIZE")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "numbers.TOOLBAR_MOBILE_BREAKPOINT")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "numbers.TOOLBAR_ROW_HEIGHT")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "numbers.TOOLBAR_ROW_MOBILE_HEIGHT")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/toolbar/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/toolbar/constants", "strings.CHANGE_EVENT")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "strings.FIRST_ROW_SELECTOR")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "strings.ICON_SELECTOR")
    @js.native
    ...
    @JSImport("@material/toolbar/constants", "strings.TITLE_SELECTOR")
    @js.native
