  ...
  object momentAugmentingMod {
    ...
    */
    ...
    trait Moment extends StObject {
      ...
      def add(amount: String, unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def add(amount: Double, unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def endOf(unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDate(): Double = js.native
      def iDate(d: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDayOfYear(): Double = js.native
      def iDayOfYear(d: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDaysInMonth(): Double = js.native
      
      def iMonth(): Double = js.native
      def iMonth(m: String): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def iMonth(m: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iWeek(): Double = js.native
      def iWeek(d: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iWeekYear(): Double = js.native
      def iWeekYear(d: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iYear(): Double = js.native
      def iYear(y: Double): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def startOf(unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def subtract(amount: String, unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def subtract(amount: Double, unit: IUnitOfTime): typingsSlinky.momentHijri.mod.momentAugmentingMod.Moment = js.native
    }
  }
