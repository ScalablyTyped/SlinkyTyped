...
@js.native
trait BindDeviceToGatewayRequest extends js.Object {
...
object BindDeviceToGatewayRequest {
  ...
  @scala.inline
  implicit class BindDeviceToGatewayRequestOps[Self <: BindDeviceToGatewayRequest] (val x: Self) extends AnyVal {
