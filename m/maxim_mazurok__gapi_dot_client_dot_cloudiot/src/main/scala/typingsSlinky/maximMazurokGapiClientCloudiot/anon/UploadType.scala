...
import typingsSlinky.maximMazurokGapiClientCloudiot.gapi.client.cloudiot.DeviceRegistry
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: DeviceRegistry = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(parent: String, resource: DeviceRegistry): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DeviceRegistry): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
