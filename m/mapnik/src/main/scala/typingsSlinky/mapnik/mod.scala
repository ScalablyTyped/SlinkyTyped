...
import typingsSlinky.mapnik.anon.Areathreshold
import typingsSlinky.mapnik.anon.Callback
import typingsSlinky.mapnik.anon.Compression
import typingsSlinky.mapnik.anon.Filltype
import typingsSlinky.mapnik.anon.Imageformat
import typingsSlinky.mapnik.anon.Imagescaling
import typingsSlinky.mapnik.anon.Layer
import typingsSlinky.mapnik.anon.Upgrade
...
object mod extends js.Object {
  ...
  Instantiable2[/* x */ Double, /* y */ Double, js.Function0[Unit]] {
    ...
    def encode(`type`: String, callback: js.Function2[/* err */ js.Error, /* buffer */ Buffer, Unit]): Unit = js.native
  ...
  class Map protected () extends js.Object {
    ...
    def load(xml: String, callback: js.Function2[/* err */ js.Error, /* map */ this.type, Unit]): Unit = js.native
    def render(images: Image): Unit = js.native
    def render(images: Image, callback: js.Function2[/* err */ js.Error, /* map */ Image, Unit]): Unit = js.native
    def render(images: VectorTile): Unit = js.native
    def render(images: VectorTile, callback: js.Function2[/* err */ js.Error, /* map */ Image, Unit]): Unit = js.native
