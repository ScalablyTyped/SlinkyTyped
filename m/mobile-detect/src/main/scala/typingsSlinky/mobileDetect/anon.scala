...
object anon {
  ...
  object FullPattern {
    ...
    implicit class FullPatternMutableBuilder[Self <: FullPattern] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFullPattern(value: js.RegExp): Self = StObject.set(x, "fullPattern", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShortPattern(value: js.RegExp): Self = StObject.set(x, "shortPattern", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTabletPattern(value: js.RegExp): Self = StObject.set(x, "tabletPattern", value.asInstanceOf[js.Any])
    }
  }
