...
import typingsSlinky.meteorUniverseI18n.meteorUniverseI18nStrings.code
import typingsSlinky.meteorUniverseI18n.meteorUniverseI18nStrings.name
...
object mod {
  ...
  object i18n {
    ...
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: js.UndefOr[scala.Nothing], locale: js.UndefOr[scala.Nothing], reactjs: ReactInstance): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: js.UndefOr[scala.Nothing], locale: String): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(
      translator: js.UndefOr[scala.Nothing],
    ...
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: js.UndefOr[scala.Nothing], locale: String, reactjs: ReactInstance): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    ...
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: Translator, locale: js.UndefOr[scala.Nothing], reactjs: ReactInstance): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: Translator, locale: String): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
    def createComponent(translator: Translator, locale: String, reactjs: js.UndefOr[ReactInstance], `type`: js.Any): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
    @JSImport("meteor/universe:i18n", "i18n.createComponent")
    @js.native
  ...
  object ReactComponentProps {
    ...
    implicit class ReactComponentPropsMutableBuilder[Self <: ReactComponentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_props(value: HTMLAttributes[ReactComponentClass[js.Object]]): Self = StObject.set(x, "_props", value.asInstanceOf[js.Any])
