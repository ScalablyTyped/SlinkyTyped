package typingsSlinky.meteorDashUniverseDashI18n.`meteorUniverse:i18nMod`

import org.scalablytyped.runtime.Instantiable0
import slinky.core.ReactComponentClass
import typingsSlinky.meteorDashUniverseDashI18n.meteorDashUniverseDashI18nStrings.code
import typingsSlinky.meteorDashUniverseDashI18n.meteorDashUniverseDashI18nStrings.name
import typingsSlinky.meteorDashUniverseDashI18n.meteorDashUniverseDashI18nStrings.nativeNames
...
object i18n extends js.Object {
  ...
  // component functions
  def createComponent(): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
  def createComponent(translator: Translator): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
  def createComponent(translator: Translator, locale: String): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
  def createComponent(translator: Translator, locale: String, reactjs: ReactInstance): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
  def createComponent(translator: Translator, locale: String, reactjs: ReactInstance, `type`: js.Any): Instantiable0[ReactComponentClass[ReactComponentProps]] = js.native
  def createReactiveTranslator(namespace: String, locale: String): Instantiable0[ReactComponentClass[js.Object]] = js.native
