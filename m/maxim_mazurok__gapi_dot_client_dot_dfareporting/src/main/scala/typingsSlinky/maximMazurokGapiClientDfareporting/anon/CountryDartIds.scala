...
object CountryDartIds {
  ...
  implicit class CountryDartIdsOps[Self <: CountryDartIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCountryDartIds(value: String | js.Array[String]): Self = this.set("countryDartIds", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDartIds(value: String | js.Array[String]): Self = this.set("dartIds", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRegionDartIds(value: String | js.Array[String]): Self = this.set("regionDartIds", value.asInstanceOf[js.Any])
