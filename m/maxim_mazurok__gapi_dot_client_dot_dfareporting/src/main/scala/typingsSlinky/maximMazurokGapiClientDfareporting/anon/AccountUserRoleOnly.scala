...
@js.native
trait AccountUserRoleOnly extends StObject {
...
object AccountUserRoleOnly {
  
  @scala.inline
  def apply(profileId: String): AccountUserRoleOnly = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccountUserRoleOnly]
  }
  
  @scala.inline
  implicit class AccountUserRoleOnlyMutableBuilder[Self <: AccountUserRoleOnly] (val x: Self) extends AnyVal {
