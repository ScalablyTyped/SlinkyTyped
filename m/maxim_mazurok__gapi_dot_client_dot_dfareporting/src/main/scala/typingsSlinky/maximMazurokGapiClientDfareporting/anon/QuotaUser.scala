...
import typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Ad
...
object QuotaUser {
  ...
  @scala.inline
  def apply(id: String, profileId: String, resource: Ad): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Ad): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
