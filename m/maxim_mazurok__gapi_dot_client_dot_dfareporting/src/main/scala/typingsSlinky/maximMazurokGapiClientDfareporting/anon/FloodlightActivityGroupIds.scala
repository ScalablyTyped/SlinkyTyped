...
@js.native
trait FloodlightActivityGroupIds extends StObject {
...
object FloodlightActivityGroupIds {
  ...
  @scala.inline
  implicit class FloodlightActivityGroupIdsMutableBuilder[Self <: FloodlightActivityGroupIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFloodlightActivityGroupIds(value: String | js.Array[String]): Self = StObject.set(x, "floodlightActivityGroupIds", value.asInstanceOf[js.Any])
