...
@js.native
trait CallbackCampaignId extends js.Object {
...
object CallbackCampaignId {
  ...
  @scala.inline
  def apply(campaignId: String, profileId: String): CallbackCampaignId = {
  ...
  @scala.inline
  implicit class CallbackCampaignIdOps[Self <: CallbackCampaignId] (val x: Self) extends AnyVal {
