...
object Height {
  ...
  @scala.inline
  def apply(profileId: String): Height = {
  ...
  implicit class HeightMutableBuilder[Self <: Height] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIabStandard(value: Boolean): Self = StObject.set(x, "iabStandard", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIabStandardUndefined: Self = StObject.set(x, "iabStandard", js.undefined)
