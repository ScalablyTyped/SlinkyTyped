...
@js.native
trait FloodlightConfigurationId extends StObject {
...
object FloodlightConfigurationId {
  
  @scala.inline
  def apply(profileId: String): FloodlightConfigurationId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FloodlightConfigurationId]
  }
  
  @scala.inline
  implicit class FloodlightConfigurationIdMutableBuilder[Self <: FloodlightConfigurationId] (val x: Self) extends AnyVal {
