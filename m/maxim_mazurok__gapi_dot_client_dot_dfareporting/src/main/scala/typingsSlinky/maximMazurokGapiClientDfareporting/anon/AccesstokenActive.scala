...
@js.native
trait AccesstokenActive extends StObject {
...
object AccesstokenActive {
  
  @scala.inline
  def apply(advertiserId: String, profileId: String): AccesstokenActive = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccesstokenActive]
  }
  
  @scala.inline
  implicit class AccesstokenActiveMutableBuilder[Self <: AccesstokenActive] (val x: Self) extends AnyVal {
