...
@js.native
trait FieldsIds extends StObject {
...
object FieldsIds {
  ...
  @scala.inline
  def apply(profileId: String): FieldsIds = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsIds]
  }
  
  @scala.inline
  implicit class FieldsIdsMutableBuilder[Self <: FieldsIds] (val x: Self) extends AnyVal {
