...
object DateRange {
  ...
  implicit class DateRangeMutableBuilder[Self <: DateRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivities(value: typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Activities): Self = StObject.set(x, "activities", value.asInstanceOf[js.Any])
