...
trait DateRange extends js.Object {
  ...
  var activities: js.UndefOr[
    typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Activities
  ] = js.native
  
  /** Custom Rich Media Events group. */
  var customRichMediaEvents: js.UndefOr[
    typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.CustomRichMediaEvents
  ] = js.native
...
object DateRange {
  ...
  implicit class DateRangeOps[Self <: DateRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivities(value: typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Activities): Self = this.set("activities", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteActivities: Self = this.set("activities", js.undefined)
    
    @scala.inline
    def setCustomRichMediaEvents(
      value: typingsSlinky.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.CustomRichMediaEvents
    ): Self = this.set("customRichMediaEvents", value.asInstanceOf[js.Any])
