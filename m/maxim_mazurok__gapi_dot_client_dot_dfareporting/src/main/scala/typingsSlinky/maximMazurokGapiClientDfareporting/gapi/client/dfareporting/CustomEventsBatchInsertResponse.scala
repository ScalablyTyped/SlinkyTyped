...
@js.native
trait CustomEventsBatchInsertResponse extends js.Object {
...
object CustomEventsBatchInsertResponse {
  ...
  @scala.inline
  implicit class CustomEventsBatchInsertResponseOps[Self <: CustomEventsBatchInsertResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatusVarargs(value: CustomEventStatus*): Self = this.set("status", js.Array(value :_*))
    
    @scala.inline
    def setStatus(value: js.Array[CustomEventStatus]): Self = this.set("status", value.asInstanceOf[js.Any])
