...
import typingsSlinky.maximMazurokGapiClientDfareporting.anon.Active
import typingsSlinky.maximMazurokGapiClientDfareporting.anon.ActivityFilters
import typingsSlinky.maximMazurokGapiClientDfareporting.anon.Breakdown
import typingsSlinky.maximMazurokGapiClientDfareporting.anon.ConversionDimensions
import typingsSlinky.maximMazurokGapiClientDfareporting.anon.EmailOwner
...
trait Report extends StObject {
  ...
  var criteria: js.UndefOr[typingsSlinky.maximMazurokGapiClientDfareporting.anon.Activities] = js.native
  ...
  var floodlightCriteria: js.UndefOr[typingsSlinky.maximMazurokGapiClientDfareporting.anon.CustomRichMediaEvents] = js.native
  ...
  var reachCriteria: js.UndefOr[typingsSlinky.maximMazurokGapiClientDfareporting.anon.DateRange] = js.native
...
object Report {
  ...
  implicit class ReportMutableBuilder[Self <: Report] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.Activities): Self = StObject.set(x, "criteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFloodlightCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.CustomRichMediaEvents): Self = StObject.set(x, "floodlightCriteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReachCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.DateRange): Self = StObject.set(x, "reachCriteria", value.asInstanceOf[js.Any])
