...
object Report {
  ...
  implicit class ReportOps[Self <: Report] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.Activities): Self = this.set("criteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFloodlightCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.CustomRichMediaEvents): Self = this.set("floodlightCriteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReachCriteria(value: typingsSlinky.maximMazurokGapiClientDfareporting.anon.DateRange): Self = this.set("reachCriteria", value.asInstanceOf[js.Any])
