...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.UploadServiceAccountKeyRequest
...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: UploadServiceAccountKeyRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(name: String, resource: UploadServiceAccountKeyRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UploadServiceAccountKeyRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
