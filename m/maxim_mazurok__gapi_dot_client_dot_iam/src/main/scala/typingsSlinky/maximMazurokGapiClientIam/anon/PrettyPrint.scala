...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.Role
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(name: String, resource: Role): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Role): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
