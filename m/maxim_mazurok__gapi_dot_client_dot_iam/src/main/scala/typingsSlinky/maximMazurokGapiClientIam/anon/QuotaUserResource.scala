...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.ServiceAccount
...
trait QuotaUserResource extends StObject {
  ...
  /** Request body */
  var resource: ServiceAccount = js.native
...
object QuotaUserResource {
  ...
  @scala.inline
  def apply(name: String, resource: ServiceAccount): QuotaUserResource = {
  ...
  implicit class QuotaUserResourceMutableBuilder[Self <: QuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ServiceAccount): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
