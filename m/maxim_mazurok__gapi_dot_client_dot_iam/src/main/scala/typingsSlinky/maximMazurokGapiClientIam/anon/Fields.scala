...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.CreateRoleRequest
...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: CreateRoleRequest = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(parent: String, resource: CreateRoleRequest): Fields = {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateRoleRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
