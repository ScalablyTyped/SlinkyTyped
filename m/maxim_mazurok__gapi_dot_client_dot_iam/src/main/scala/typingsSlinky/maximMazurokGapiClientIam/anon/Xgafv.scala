...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.CreateServiceAccountKeyRequest
...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: CreateServiceAccountKeyRequest = js.native
...
object Xgafv {
  ...
  @scala.inline
  def apply(name: String, resource: CreateServiceAccountKeyRequest): Xgafv = {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CreateServiceAccountKeyRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
