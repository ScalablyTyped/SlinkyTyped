...
import typingsSlinky.maximMazurokGapiClientIam.gapi.client.iam.EnableServiceAccountRequest
...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: EnableServiceAccountRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(name: String, resource: EnableServiceAccountRequest): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: EnableServiceAccountRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
