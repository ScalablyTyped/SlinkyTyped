...
@js.native
trait PatchServiceAccountRequest extends js.Object {
...
object PatchServiceAccountRequest {
  ...
  @scala.inline
  implicit class PatchServiceAccountRequestOps[Self <: PatchServiceAccountRequest] (val x: Self) extends AnyVal {
