package typingsSlinky.maximMazurokGapiClientCloudasset.anon
...
object Key {
  ...
  implicit class KeyOps[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AnalyzeIamPolicyLongrunningRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
