...
@js.native
trait AssetNames extends js.Object {
...
object AssetNames {
  ...
  @scala.inline
  implicit class AssetNamesOps[Self <: AssetNames] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetNames(value: String | js.Array[String]): Self = this.set("assetNames", value.asInstanceOf[js.Any])
