...
@js.native
trait GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig extends js.Object {
...
object GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig {
  ...
  @scala.inline
  implicit class GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfigOps[Self <: GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVpcAccessibleServices(value: GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices): Self = this.set("vpcAccessibleServices", value.asInstanceOf[js.Any])
