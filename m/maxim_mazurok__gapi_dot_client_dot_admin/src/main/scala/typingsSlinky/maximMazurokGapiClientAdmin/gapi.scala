...
import typingsSlinky.maximMazurokGapiClientAdmin.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientAdmin.anon.ActorIpAddress
...
import typingsSlinky.maximMazurokGapiClientAdmin.anon.CustomerId
import typingsSlinky.maximMazurokGapiClientAdmin.anon.Date
import typingsSlinky.maximMazurokGapiClientAdmin.anon.DatetimeValue
import typingsSlinky.maximMazurokGapiClientAdmin.anon.EntityKey
import typingsSlinky.maximMazurokGapiClientAdmin.anon.Fields
  ...
  object client {
    ...
    object admin {
      ...
      trait Channel extends StObject {
        ...
        {[ P in string ]: string}
          */ typingsSlinky.maximMazurokGapiClientAdmin.maximMazurokGapiClientAdminStrings.Channel with TopLevel[js.Any]
              ] = js.native
