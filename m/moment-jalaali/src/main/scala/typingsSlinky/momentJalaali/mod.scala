...
import typingsSlinky.momentJalaali.mod.momentAugmentingMod.LoadPersianOptions
  ...
  object momentAugmentingMod {
    ...
    */
    ...
    trait Moment extends StObject {
      ...
      def add(amount: String, jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def add(amount: Double, jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def endOf(jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jDate(): Double = js.native
      def jDate(d: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jDayOfYear(): Double = js.native
      def jDayOfYear(d: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jMonth(): Double = js.native
      def jMonth(M: String): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def jMonth(M: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jWeek(): Double = js.native
      def jWeek(d: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jWeekYear(): Double = js.native
      def jWeekYear(d: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jYear(): Double = js.native
      def jYear(y: Double): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def startOf(jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def subtract(amount: String, jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def subtract(amount: Double, jUnitOfTime: JUnitOfTime): typingsSlinky.momentJalaali.mod.momentAugmentingMod.Moment = js.native
    }
  }
