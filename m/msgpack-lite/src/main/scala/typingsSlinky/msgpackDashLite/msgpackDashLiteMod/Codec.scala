package typingsSlinky.msgpackDashLite.msgpackDashLiteMod
...
object Codec {
  @scala.inline
  def apply(
    addExtPacker: (Double, Instantiable1[/* args (repeated) */ js.Any, js.Any], js.Function1[js.Any, Buffer | scala.scalajs.js.typedarray.Uint8Array]) => Unit,
    addExtUnpacker: (Double, js.Function1[/* data */ Buffer | scala.scalajs.js.typedarray.Uint8Array, js.Any]) => Unit
  ): Codec = {
