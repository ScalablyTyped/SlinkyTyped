...
trait PrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientDomains.gapi.client.domains.Registration = js.native
...
object PrettyPrint {
  ...
  def apply(
    name: String,
    resource: typingsSlinky.maximMazurokGapiClientDomains.gapi.client.domains.Registration
  ): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientDomains.gapi.client.domains.Registration): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
