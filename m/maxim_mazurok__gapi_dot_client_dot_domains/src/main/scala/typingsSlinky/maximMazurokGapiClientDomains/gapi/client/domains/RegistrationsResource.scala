...
import typingsSlinky.maximMazurokGapiClientDomains.anon.Callback
import typingsSlinky.maximMazurokGapiClientDomains.anon.DomainName
import typingsSlinky.maximMazurokGapiClientDomains.anon.Fields
import typingsSlinky.maximMazurokGapiClientDomains.anon.Filter
import typingsSlinky.maximMazurokGapiClientDomains.anon.Key
import typingsSlinky.maximMazurokGapiClientDomains.anon.Name
import typingsSlinky.maximMazurokGapiClientDomains.anon.Oauthtoken
import typingsSlinky.maximMazurokGapiClientDomains.anon.OptionsrequestedPolicyVersion
import typingsSlinky.maximMazurokGapiClientDomains.anon.Parent
import typingsSlinky.maximMazurokGapiClientDomains.anon.PrettyPrint
...
trait RegistrationsResource extends js.Object {
  ...
  def resetAuthorizationCode(request: typingsSlinky.maximMazurokGapiClientDomains.anon.Registration): Request[AuthorizationCode] = js.native
  ...
  def searchDomains(request: typingsSlinky.maximMazurokGapiClientDomains.anon.Location): Request[SearchDomainsResponse] = js.native
