...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.AppEdit
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: AppEdit = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(packageName: String, resource: AppEdit): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AppEdit): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
