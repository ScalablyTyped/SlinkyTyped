...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.AppDetails
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: AppDetails = js.native
...
object Callback {
  ...
  @scala.inline
  def apply(editId: String, packageName: String, resource: AppDetails): Callback = {
  ...
  implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AppDetails): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
