...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Track
...
object PrettyPrint {
  ...
  @scala.inline
  def apply(editId: String, packageName: String, resource: Track, track: String): PrettyPrint = {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Track): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
