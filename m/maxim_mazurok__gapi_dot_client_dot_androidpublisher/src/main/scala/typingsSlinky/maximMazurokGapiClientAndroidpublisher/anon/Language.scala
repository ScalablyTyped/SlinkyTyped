...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Listing
...
trait Language extends StObject {
  ...
  /** Request body */
  var resource: Listing = js.native
...
object Language {
  ...
  @scala.inline
  def apply(editId: String, language: String, packageName: String, resource: Listing): Language = {
  ...
  implicit class LanguageMutableBuilder[Self <: Language] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Listing): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
