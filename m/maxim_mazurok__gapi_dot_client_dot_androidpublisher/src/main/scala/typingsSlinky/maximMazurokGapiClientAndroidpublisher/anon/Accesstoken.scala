...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.ApksAddExternallyHostedRequest
...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: ApksAddExternallyHostedRequest = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(editId: String, packageName: String, resource: ApksAddExternallyHostedRequest): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ApksAddExternallyHostedRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
