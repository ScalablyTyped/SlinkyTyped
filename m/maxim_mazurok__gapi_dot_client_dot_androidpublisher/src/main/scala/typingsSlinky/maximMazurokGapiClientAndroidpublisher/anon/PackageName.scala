...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Testers
...
trait PackageName extends StObject {
  ...
  /** Request body */
  var resource: Testers = js.native
...
object PackageName {
  ...
  @scala.inline
  def apply(editId: String, packageName: String, resource: Testers, track: String): PackageName = {
  ...
  implicit class PackageNameMutableBuilder[Self <: PackageName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Testers): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
