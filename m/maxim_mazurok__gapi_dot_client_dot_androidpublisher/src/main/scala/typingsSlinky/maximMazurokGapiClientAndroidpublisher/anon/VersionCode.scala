...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Variant
...
trait VersionCode extends StObject {
  ...
  /** Request body */
  var resource: Variant = js.native
  ...
  var versionCode: String = js.native
}
object VersionCode {
  
  @scala.inline
  def apply(packageName: String, resource: Variant, versionCode: String): VersionCode = {
  ...
  implicit class VersionCodeMutableBuilder[Self <: VersionCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Variant): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
