...
@js.native
trait AutoConvertMissingPrices extends js.Object {
...
object AutoConvertMissingPrices {
  ...
  @scala.inline
  implicit class AutoConvertMissingPricesOps[Self <: AutoConvertMissingPrices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InAppProduct): Self = this.set("resource", value.asInstanceOf[js.Any])
