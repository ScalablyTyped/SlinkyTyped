...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.InAppProduct
...
@js.native
trait AutoConvertMissingPrices extends StObject {
  ...
  /** Request body */
  var resource: InAppProduct = js.native
...
object AutoConvertMissingPrices {
  
  @scala.inline
  def apply(packageName: String, resource: InAppProduct): AutoConvertMissingPrices = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AutoConvertMissingPrices]
  }
  
  @scala.inline
  implicit class AutoConvertMissingPricesMutableBuilder[Self <: AutoConvertMissingPrices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InAppProduct): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
