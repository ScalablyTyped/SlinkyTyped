...
@js.native
trait AckBundleInstallationWarning extends js.Object {
...
object AckBundleInstallationWarning {
  ...
  @scala.inline
  implicit class AckBundleInstallationWarningOps[Self <: AckBundleInstallationWarning] (val x: Self) extends AnyVal {
