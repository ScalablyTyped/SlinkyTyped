...
@js.native
trait AckBundleInstallationWarning extends StObject {
...
object AckBundleInstallationWarning {
  
  @scala.inline
  def apply(editId: String, packageName: String): AckBundleInstallationWarning = {
  ...
  @scala.inline
  implicit class AckBundleInstallationWarningMutableBuilder[Self <: AckBundleInstallationWarning] (val x: Self) extends AnyVal {
