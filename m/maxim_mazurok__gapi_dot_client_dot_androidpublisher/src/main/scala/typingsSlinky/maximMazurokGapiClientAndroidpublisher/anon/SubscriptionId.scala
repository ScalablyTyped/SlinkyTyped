...
@js.native
trait SubscriptionId extends js.Object {
...
object SubscriptionId {
  ...
  @scala.inline
  implicit class SubscriptionIdOps[Self <: SubscriptionId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubscriptionPurchasesAcknowledgeRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
