...
import typingsSlinky.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.SubscriptionPurchasesAcknowledgeRequest
...
@js.native
trait SubscriptionId extends StObject {
  ...
  /** Request body */
  var resource: SubscriptionPurchasesAcknowledgeRequest = js.native
...
object SubscriptionId {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SubscriptionId]
  }
  
  @scala.inline
  implicit class SubscriptionIdMutableBuilder[Self <: SubscriptionId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SubscriptionPurchasesAcknowledgeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
