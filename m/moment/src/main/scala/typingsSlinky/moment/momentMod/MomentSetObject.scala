...
object MomentSetObject {
  ...
  def apply(
    ...
    DDD: js.UndefOr[Double] = js.undefined,
    E: js.UndefOr[Double] = js.undefined,
    GG: js.UndefOr[Double] = js.undefined,
    ...
    dayOfYear: js.UndefOr[Double] = js.undefined,
    dayOfYears: js.UndefOr[Double] = js.undefined,
    ...
    isoWeek: js.UndefOr[Double] = js.undefined,
    isoWeekYear: js.UndefOr[Double] = js.undefined,
    isoWeekYears: js.UndefOr[Double] = js.undefined,
    isoWeekday: js.UndefOr[Double] = js.undefined,
    isoWeekdays: js.UndefOr[Double] = js.undefined,
    isoWeeks: js.UndefOr[Double] = js.undefined,
    m: js.UndefOr[Double] = js.undefined,
    ...
    weekYears: js.UndefOr[Double] = js.undefined,
    weekday: js.UndefOr[Double] = js.undefined,
    weekdays: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(DDD)) __obj.updateDynamic("DDD")(DDD.get.asInstanceOf[js.Any])
    if (!js.isUndefined(E)) __obj.updateDynamic("E")(E.get.asInstanceOf[js.Any])
    if (!js.isUndefined(GG)) __obj.updateDynamic("GG")(GG.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(dayOfYear)) __obj.updateDynamic("dayOfYear")(dayOfYear.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dayOfYears)) __obj.updateDynamic("dayOfYears")(dayOfYears.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isoWeek)) __obj.updateDynamic("isoWeek")(isoWeek.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isoWeekYear)) __obj.updateDynamic("isoWeekYear")(isoWeekYear.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isoWeekYears)) __obj.updateDynamic("isoWeekYears")(isoWeekYears.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isoWeekday)) __obj.updateDynamic("isoWeekday")(isoWeekday.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isoWeekdays)) __obj.updateDynamic("isoWeekdays")(isoWeekdays.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isoWeeks)) __obj.updateDynamic("isoWeeks")(isoWeeks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(m)) __obj.updateDynamic("m")(m.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(weekYears)) __obj.updateDynamic("weekYears")(weekYears.get.asInstanceOf[js.Any])
    if (!js.isUndefined(weekday)) __obj.updateDynamic("weekday")(weekday.get.asInstanceOf[js.Any])
    if (!js.isUndefined(weekdays)) __obj.updateDynamic("weekdays")(weekdays.get.asInstanceOf[js.Any])
