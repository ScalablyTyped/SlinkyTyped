...
object OperationResult {
  ...
  @scala.inline
  def failure: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.failure = this.cast("failure")
  @scala.inline
  def success: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.success = this.cast("success")
  @scala.inline
  def timeout: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.timeout = this.cast("timeout")
  @scala.inline
