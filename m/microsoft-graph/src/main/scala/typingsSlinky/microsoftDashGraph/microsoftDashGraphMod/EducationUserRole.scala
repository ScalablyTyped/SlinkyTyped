...
object EducationUserRole {
  ...
  @scala.inline
  def student: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.student = this.cast("student")
  @scala.inline
  def teacher: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.teacher = this.cast("teacher")
  @scala.inline
