...
object ScreenSharingRole {
  ...
  @scala.inline
  def sharer: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.sharer = this.cast("sharer")
  @scala.inline
  def viewer: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.viewer = this.cast("viewer")
}
