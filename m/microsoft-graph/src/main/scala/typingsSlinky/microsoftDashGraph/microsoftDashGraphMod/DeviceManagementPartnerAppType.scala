...
object DeviceManagementPartnerAppType {
  ...
  @scala.inline
  def multiTenantApp: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.multiTenantApp = this.cast("multiTenantApp")
  @scala.inline
  def singleTenantApp: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.singleTenantApp = this.cast("singleTenantApp")
  @scala.inline
