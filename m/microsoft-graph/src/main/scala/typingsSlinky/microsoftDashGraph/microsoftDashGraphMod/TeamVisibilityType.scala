...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftDashGraph.microsoftDashGraphStrings.public
  - typings.microsoftDashGraph.microsoftDashGraphStrings.hiddenMembership
...
object TeamVisibilityType {
  ...
  @scala.inline
  def hiddenMembership: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.hiddenMembership = this.cast("hiddenMembership")
  @scala.inline
  def `private`: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.`private` = this.cast("private")
  @scala.inline
  def public: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.public = this.cast("public")
  @scala.inline
