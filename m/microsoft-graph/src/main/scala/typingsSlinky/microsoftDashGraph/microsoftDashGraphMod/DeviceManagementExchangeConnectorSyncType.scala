...
object DeviceManagementExchangeConnectorSyncType {
  ...
  @scala.inline
  def deltaSync: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.deltaSync = this.cast("deltaSync")
  @scala.inline
  def fullSync: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.fullSync = this.cast("fullSync")
}
