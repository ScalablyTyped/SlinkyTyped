...
object BodyType {
  ...
  @scala.inline
  def html: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.html = this.cast("html")
  @scala.inline
  def text: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.text = this.cast("text")
}
