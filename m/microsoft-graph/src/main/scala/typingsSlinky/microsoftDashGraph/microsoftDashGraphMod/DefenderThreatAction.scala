...
object DefenderThreatAction {
  ...
  @scala.inline
  def block: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.block = this.cast("block")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def clean: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.clean = this.cast("clean")
  @scala.inline
  def deviceDefault: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.deviceDefault = this.cast("deviceDefault")
  @scala.inline
  def quarantine: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.quarantine = this.cast("quarantine")
  @scala.inline
  def remove: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.remove = this.cast("remove")
  @scala.inline
