...
import typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.running_
...
object DataPolicyOperationStatus {
  ...
  @scala.inline
  def complete: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.complete = this.cast("complete")
  @scala.inline
