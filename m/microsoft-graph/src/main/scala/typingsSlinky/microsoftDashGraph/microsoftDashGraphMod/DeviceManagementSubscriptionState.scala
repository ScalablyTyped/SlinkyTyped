...
object DeviceManagementSubscriptionState {
  ...
  @scala.inline
  def deleted: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.deleted = this.cast("deleted")
  @scala.inline
  def disabled: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.disabled = this.cast("disabled")
  @scala.inline
  def lockedOut: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.lockedOut = this.cast("lockedOut")
  @scala.inline
  def pending: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.pending = this.cast("pending")
  @scala.inline
  def warning: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.warning = this.cast("warning")
}
