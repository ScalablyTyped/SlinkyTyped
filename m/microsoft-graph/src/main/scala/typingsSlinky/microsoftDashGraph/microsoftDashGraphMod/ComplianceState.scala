...
import typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.noncompliant_
...
object ComplianceState {
  ...
  @scala.inline
  def configManager: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.configManager = this.cast("configManager")
  @scala.inline
  ...
  @scala.inline
  def inGracePeriod: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.inGracePeriod = this.cast("inGracePeriod")
  @scala.inline
