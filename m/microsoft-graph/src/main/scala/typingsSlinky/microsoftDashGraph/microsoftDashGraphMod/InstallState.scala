...
object InstallState {
  ...
  @scala.inline
  def installed: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.installed = this.cast("installed")
  @scala.inline
  def notApplicable: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.notApplicable = this.cast("notApplicable")
  @scala.inline
  def notInstalled: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.notInstalled = this.cast("notInstalled")
  @scala.inline
  def uninstallFailed: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.uninstallFailed = this.cast("uninstallFailed")
  @scala.inline
