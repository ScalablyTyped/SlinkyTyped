...
object GroupType {
  @scala.inline
  def azureAD: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.azureAD = this.cast("azureAD")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def unifiedGroups: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.unifiedGroups = this.cast("unifiedGroups")
  @scala.inline
