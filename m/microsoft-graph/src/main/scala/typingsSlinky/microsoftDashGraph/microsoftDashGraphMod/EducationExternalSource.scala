...
/* Rewritten from type alias, can be one of: 
  - typings.microsoftDashGraph.microsoftDashGraphStrings.sis
  - typings.microsoftDashGraph.microsoftDashGraphStrings.manual
...
object EducationExternalSource {
  ...
  @scala.inline
  def manual: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.manual = this.cast("manual")
  @scala.inline
  def sis: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.sis = this.cast("sis")
  @scala.inline
