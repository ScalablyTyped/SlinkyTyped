...
object WindowsDeviceType {
  ...
  @scala.inline
  def desktop: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.desktop = this.cast("desktop")
  @scala.inline
  def holographic: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.holographic = this.cast("holographic")
  @scala.inline
  def mobile: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.mobile = this.cast("mobile")
  @scala.inline
  def none: none_ = this.cast("none")
  @scala.inline
  def team: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.team = this.cast("team")
}
