...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.microsoftDashGraph.microsoftDashGraphStrings.rootedDevice
*/
...
object ManagedAppFlaggedReason {
  ...
  @scala.inline
  def rootedDevice: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.rootedDevice = this.cast("rootedDevice")
}
