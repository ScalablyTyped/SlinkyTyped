...
object DeviceManagementExchangeConnectorStatus {
  ...
  @scala.inline
  def connected: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.connected = this.cast("connected")
  @scala.inline
  def connectionPending: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.connectionPending = this.cast("connectionPending")
  @scala.inline
  def disconnected: typingsSlinky.microsoftDashGraph.microsoftDashGraphStrings.disconnected = this.cast("disconnected")
  @scala.inline
