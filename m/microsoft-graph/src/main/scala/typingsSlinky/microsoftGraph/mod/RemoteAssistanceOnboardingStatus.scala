...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.notOnboarded
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.onboarding
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.onboarded
*/
