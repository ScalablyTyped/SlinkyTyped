...
object WindowsInformationProtection {
  ...
  implicit class WindowsInformationProtectionOps[Self <: WindowsInformationProtection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataRecoveryCertificate(value: WindowsInformationProtectionDataRecoveryCertificate): Self = this.set("dataRecoveryCertificate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseDomain(value: String): Self = this.set("enterpriseDomain", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseIPRanges(value: js.Array[WindowsInformationProtectionIPRangeCollection]): Self = this.set("enterpriseIPRanges", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseInternalProxyServers(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("enterpriseInternalProxyServers", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseNetworkDomainNames(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("enterpriseNetworkDomainNames", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseProtectedDomainNames(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("enterpriseProtectedDomainNames", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseProxiedDomains(value: js.Array[WindowsInformationProtectionProxiedDomainCollection]): Self = this.set("enterpriseProxiedDomains", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEnterpriseProxyServers(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("enterpriseProxyServers", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExemptAppLockerFiles(value: js.Array[WindowsInformationProtectionAppLockerFile]): Self = this.set("exemptAppLockerFiles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExemptApps(value: js.Array[WindowsInformationProtectionApp]): Self = this.set("exemptApps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNeutralDomainResources(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("neutralDomainResources", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProtectedAppLockerFiles(value: js.Array[WindowsInformationProtectionAppLockerFile]): Self = this.set("protectedAppLockerFiles", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProtectedApps(value: js.Array[WindowsInformationProtectionApp]): Self = this.set("protectedApps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRightsManagementServicesTemplateId(value: String): Self = this.set("rightsManagementServicesTemplateId", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSmbAutoEncryptedFileExtensions(value: js.Array[WindowsInformationProtectionResourceCollection]): Self = this.set("smbAutoEncryptedFileExtensions", value.asInstanceOf[js.Any])
