...
object MessageRulePredicates {
  ...
  def apply(
    ...
    if (!js.isUndefined(isApprovalRequest)) __obj.updateDynamic("isApprovalRequest")(isApprovalRequest.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isAutomaticForward)) __obj.updateDynamic("isAutomaticForward")(isAutomaticForward.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isAutomaticReply)) __obj.updateDynamic("isAutomaticReply")(isAutomaticReply.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isEncrypted)) __obj.updateDynamic("isEncrypted")(isEncrypted.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isMeetingRequest)) __obj.updateDynamic("isMeetingRequest")(isMeetingRequest.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isMeetingResponse)) __obj.updateDynamic("isMeetingResponse")(isMeetingResponse.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNonDeliveryReport)) __obj.updateDynamic("isNonDeliveryReport")(isNonDeliveryReport.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isPermissionControlled)) __obj.updateDynamic("isPermissionControlled")(isPermissionControlled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isReadReceipt)) __obj.updateDynamic("isReadReceipt")(isReadReceipt.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isSigned)) __obj.updateDynamic("isSigned")(isSigned.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isVoicemail)) __obj.updateDynamic("isVoicemail")(isVoicemail.get.asInstanceOf[js.Any])
    if (messageActionFlag != null) __obj.updateDynamic("messageActionFlag")(messageActionFlag.asInstanceOf[js.Any])
    if (!js.isUndefined(notSentToMe)) __obj.updateDynamic("notSentToMe")(notSentToMe.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sentCcMe)) __obj.updateDynamic("sentCcMe")(sentCcMe.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sentOnlyToMe)) __obj.updateDynamic("sentOnlyToMe")(sentOnlyToMe.get.asInstanceOf[js.Any])
    if (sentToAddresses != null) __obj.updateDynamic("sentToAddresses")(sentToAddresses.asInstanceOf[js.Any])
    if (!js.isUndefined(sentToMe)) __obj.updateDynamic("sentToMe")(sentToMe.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sentToOrCcMe)) __obj.updateDynamic("sentToOrCcMe")(sentToOrCcMe.get.asInstanceOf[js.Any])
