...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.transientError
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.error
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.unknown_
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRequestSuccess
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRequestPending
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRequestFailed
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRequestTimedOut
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRenewalSuccess
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRenewalPending
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRenewalFailed
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.azureStorageUriRenewalTimedOut
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.commitFileSuccess
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.commitFilePending
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.commitFileFailed
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.commitFileTimedOut
*/
