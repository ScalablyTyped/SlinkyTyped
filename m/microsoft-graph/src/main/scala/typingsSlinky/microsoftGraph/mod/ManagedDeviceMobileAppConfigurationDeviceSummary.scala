...
object ManagedDeviceMobileAppConfigurationDeviceSummary {
  ...
  @scala.inline
  def apply(): ManagedDeviceMobileAppConfigurationDeviceSummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ManagedDeviceMobileAppConfigurationDeviceSummary]
  }
  
  @scala.inline
  implicit class ManagedDeviceMobileAppConfigurationDeviceSummaryMutableBuilder[Self <: ManagedDeviceMobileAppConfigurationDeviceSummary] (val x: Self) extends AnyVal {
