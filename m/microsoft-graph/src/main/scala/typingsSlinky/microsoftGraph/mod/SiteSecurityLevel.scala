...
object SiteSecurityLevel {
  ...
  @scala.inline
  def mediumLow: typingsSlinky.microsoftGraph.microsoftGraphStrings.mediumLow = "mediumLow".asInstanceOf[typingsSlinky.microsoftGraph.microsoftGraphStrings.mediumLow]
  @scala.inline
