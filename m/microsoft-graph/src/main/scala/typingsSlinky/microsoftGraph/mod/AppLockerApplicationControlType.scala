...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.enforceComponentsAndStoreApps
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.auditComponentsAndStoreApps
