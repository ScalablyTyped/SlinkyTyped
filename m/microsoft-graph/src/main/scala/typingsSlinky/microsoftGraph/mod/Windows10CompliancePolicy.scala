...
object Windows10CompliancePolicy {
  ...
  def apply(
    ...
    if (!js.isUndefined(passwordRequiredToUnlockFromIdle)) __obj.updateDynamic("passwordRequiredToUnlockFromIdle")(passwordRequiredToUnlockFromIdle.asInstanceOf[js.Any])
    if (passwordRequiredType != null) __obj.updateDynamic("passwordRequiredType")(passwordRequiredType.asInstanceOf[js.Any])
    if (!js.isUndefined(requireHealthyDeviceReport)) __obj.updateDynamic("requireHealthyDeviceReport")(requireHealthyDeviceReport.asInstanceOf[js.Any])
