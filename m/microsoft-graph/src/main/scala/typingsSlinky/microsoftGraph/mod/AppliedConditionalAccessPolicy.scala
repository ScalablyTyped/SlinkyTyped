...
object AppliedConditionalAccessPolicy {
  ...
  implicit class AppliedConditionalAccessPolicyOps[Self <: AppliedConditionalAccessPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnforcedGrantControls(value: js.Array[String]): Self = this.set("enforcedGrantControls", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEnforcedSessionControls(value: js.Array[String]): Self = this.set("enforcedSessionControls", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setResult(value: AppliedConditionalAccessPolicyResult): Self = this.set("result", value.asInstanceOf[js.Any])
    @scala.inline
