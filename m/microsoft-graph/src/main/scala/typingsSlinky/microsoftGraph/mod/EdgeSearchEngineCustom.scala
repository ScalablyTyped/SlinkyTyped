...
object EdgeSearchEngineCustom {
  ...
  implicit class EdgeSearchEngineCustomOps[Self <: EdgeSearchEngineCustom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEdgeSearchEngineOpenSearchXmlUrl(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("edgeSearchEngineOpenSearchXmlUrl")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEdgeSearchEngineOpenSearchXmlUrl: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("edgeSearchEngineOpenSearchXmlUrl")(js.undefined)
        ret
    }
  }
