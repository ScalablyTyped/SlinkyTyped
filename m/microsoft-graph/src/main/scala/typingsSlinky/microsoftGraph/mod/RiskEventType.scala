...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.unlikelyTravel
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.anonymizedIPAddress
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.maliciousIPAddress
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.unfamiliarFeatures
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.malwareInfectedIPAddress
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.suspiciousIPAddress
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.leakedCredentials
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.investigationsThreatIntelligence
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.generic
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.adminConfirmedUserCompromised
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.mcasImpossibleTravel
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.mcasSuspiciousInboxManipulationRules
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.investigationsThreatIntelligenceSigninLinked
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.maliciousIPAddressValidCredentialsBlockedIP
