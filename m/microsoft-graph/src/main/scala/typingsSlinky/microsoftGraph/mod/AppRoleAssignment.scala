...
trait AppRoleAssignment extends DirectoryObject {
  ...
  /**
    ...
    */
  var principalDisplayName: js.UndefOr[String] = js.native
  /**
  ...
  /**
    ...
    * support $filter.
    */
  var principalType: js.UndefOr[String] = js.native
...
object AppRoleAssignment {
  ...
  implicit class AppRoleAssignmentOps[Self <: AppRoleAssignment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrincipalDisplayName(value: String): Self = this.set("principalDisplayName", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPrincipalType(value: String): Self = this.set("principalType", value.asInstanceOf[js.Any])
    @scala.inline
