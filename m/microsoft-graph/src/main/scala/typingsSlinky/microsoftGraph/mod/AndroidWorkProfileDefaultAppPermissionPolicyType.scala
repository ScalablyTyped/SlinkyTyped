...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.prompt
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.autoGrant
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.autoDeny
*/
