...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.Unknown
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.OneDrive
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.OneDriveForBusiness
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.OnPremOneDriveForBusiness
*/
