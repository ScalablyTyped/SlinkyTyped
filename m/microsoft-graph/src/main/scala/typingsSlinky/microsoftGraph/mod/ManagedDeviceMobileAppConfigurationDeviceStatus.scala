...
object ManagedDeviceMobileAppConfigurationDeviceStatus {
  ...
  @scala.inline
  def apply(): ManagedDeviceMobileAppConfigurationDeviceStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ManagedDeviceMobileAppConfigurationDeviceStatus]
  }
  
  @scala.inline
  implicit class ManagedDeviceMobileAppConfigurationDeviceStatusMutableBuilder[Self <: ManagedDeviceMobileAppConfigurationDeviceStatus] (val x: Self) extends AnyVal {
