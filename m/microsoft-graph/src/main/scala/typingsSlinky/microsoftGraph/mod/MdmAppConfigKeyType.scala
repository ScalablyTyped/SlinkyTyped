...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.integerType
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.realType
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.booleanType
