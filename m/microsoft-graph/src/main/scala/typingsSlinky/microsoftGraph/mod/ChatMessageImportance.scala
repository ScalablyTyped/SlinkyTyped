...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.microsoftGraph.microsoftGraphStrings.urgent
...
object ChatMessageImportance {
  ...
  @scala.inline
  def urgent: typingsSlinky.microsoftGraph.microsoftGraphStrings.urgent = "urgent".asInstanceOf[typingsSlinky.microsoftGraph.microsoftGraphStrings.urgent]
}
