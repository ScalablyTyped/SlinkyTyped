...
import typingsSlinky.meteorDburlesCollectionHelpers.meteorDburlesCollectionHelpersStrings._meteor_dburles_collection_helpers_allowPartial
import typingsSlinky.meteorDburlesCollectionHelpers.meteorDburlesCollectionHelpersStrings._meteor_dburles_collection_helpers_brand
import typingsSlinky.meteorDburlesCollectionHelpers.meteorDburlesCollectionHelpersStrings._meteor_dburles_collection_helpers_flavor
...
object mod {
  ...
  */
  ...
  {[ K in keyof T ]: std.Exclude<meteor-dburles-collection-helpers.meteor/dburles:collection-helpers.RemoveHelperFlavorForVoid<T[K]>, meteor-dburles-collection-helpers.meteor/dburles:collection-helpers.HelperBrand | meteor-dburles-collection-helpers.meteor/dburles:collection-helpers.OptionalHelperBrand>}
    */ typingsSlinky.meteorDburlesCollectionHelpers.meteorDburlesCollectionHelpersStrings.RemoveHelperBrands with TopLevel[T]
  ...
  object _OptionalHelper {
    ...
    @scala.inline
    def HelperBrand(_meteor_dburles_collection_helpers_isBrandUnsupportedHelper: Brand): typingsSlinky.meteorDburlesCollectionHelpers.mod.HelperBrand = {
      val __obj = js.Dynamic.literal(_meteor_dburles_collection_helpers_isBrandUnsupportedHelper = _meteor_dburles_collection_helpers_isBrandUnsupportedHelper.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.meteorDburlesCollectionHelpers.mod.HelperBrand]
    }
    
    @scala.inline
    def OptionalHelperBrand(): typingsSlinky.meteorDburlesCollectionHelpers.mod.OptionalHelperBrand = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.meteorDburlesCollectionHelpers.mod.OptionalHelperBrand]
    }
  }
}
