...
import typingsSlinky.mapsjs.Anon_BackgroundColorStr
import typingsSlinky.mapsjs.Anon_Bleed
import typingsSlinky.mapsjs.Anon_BleedRatio
import typingsSlinky.mapsjs.Anon_BleedRatioGeometryFieldName
import typingsSlinky.mapsjs.Anon_Bounds
import typingsSlinky.mapsjs.Anon_Color
import typingsSlinky.mapsjs.Anon_Data
...
object tile extends js.Object {
  ...
  class descriptorLocal protected () extends js.Object {
    def this(options: Anon_BleedRatioGeometryFieldName) = this()
  }
  
  @js.native
  class descriptorMDNRestFeature protected () extends js.Object {
    def this(mapId: String, layerId: String) = this()
    def this(mapId: String, layerId: String, options: Anon_BleedRatio) = this()
    /**
  ...
  class descriptorMDNRestMap protected () extends js.Object {
    ...
    def this(mapId: String, options: Anon_BackgroundColorStr) = this()
    /**
    ...
    /**
    		 ...
    		 */
    def getLayerOutline(layerId: String): Anon_Color = js.native
    /**
  ...
  class layer protected () extends js.Object {
    ...
    /**
    		 ...
    		 */
    def compose(extentsMapUnits: envelope, extentsDeviceUnits: envelope): Anon_EndpointCollection = js.native
    /**
  ...
  class layerOptions protected () extends js.Object {
    def this(id: String, options: Anon_Descriptor) = this()
    /**
  ...
  class renderer () extends js.Object {
    def this(options: Anon_Bleed) = this()
    /**
  ...
  class requestorBing () extends requestor {
    def this(options: Anon_DataFormat) = this()
    /**
  ...
  class requestorLocal () extends requestor {
    ...
    /** 
      ...
      * do a quick spatial check for complex polygons.
    		 ...
    		 */
    def getParsedData(): Anon_Bounds = js.native
    /** 
  ...
  class requestorMDNRest protected () extends requestor {
    ...
    def this(endpoint: String, options: Anon_DataFormat) = this()
    /**
  ...
  class requestorOpen protected () extends requestor {
    ...
    def this(endpoint: String, subdomains: js.Array[String], options: Anon_DataFormat) = this()
  }
