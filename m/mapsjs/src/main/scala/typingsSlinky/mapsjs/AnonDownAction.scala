...
object AnonDownAction {
  @scala.inline
  def apply(dragEnabled: Boolean, useElementInsteadOfNewGestureOverlay: Boolean): AnonDownAction = {
  ...
  @scala.inline
  implicit class AnonDownActionOps[Self <: AnonDownAction] (val x: Self) extends AnyVal {
    @scala.inline
