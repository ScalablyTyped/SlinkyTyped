...
trait beginDigitizeOptions extends js.Object {
  ...
  var geometryStyle: js.UndefOr[typingsSlinky.mapsjs.mod.geometryStyle] = js.undefined
  ...
  var styledGeometry: js.UndefOr[typingsSlinky.mapsjs.mod.styledGeometry] = js.undefined
...
object beginDigitizeOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(leavePath)) __obj.updateDynamic("leavePath")(leavePath.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(suppressNodeAdd)) __obj.updateDynamic("suppressNodeAdd")(suppressNodeAdd.get.asInstanceOf[js.Any])
