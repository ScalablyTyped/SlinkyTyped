...
@js.native
trait GoogleCloudVisionV1p4beta1BatchOperationMetadata extends js.Object {
...
object GoogleCloudVisionV1p4beta1BatchOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1BatchOperationMetadataOps[Self <: GoogleCloudVisionV1p4beta1BatchOperationMetadata] (val x: Self) extends AnyVal {
