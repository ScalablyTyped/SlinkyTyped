...
@js.native
trait GoogleCloudVisionV1p2beta1ProductKeyValue extends js.Object {
...
object GoogleCloudVisionV1p2beta1ProductKeyValue {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1ProductKeyValueOps[Self <: GoogleCloudVisionV1p2beta1ProductKeyValue] (val x: Self) extends AnyVal {
