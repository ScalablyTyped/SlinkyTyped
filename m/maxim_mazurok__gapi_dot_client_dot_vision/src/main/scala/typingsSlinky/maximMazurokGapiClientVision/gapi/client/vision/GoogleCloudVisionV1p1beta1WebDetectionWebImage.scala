...
@js.native
trait GoogleCloudVisionV1p1beta1WebDetectionWebImage extends js.Object {
...
object GoogleCloudVisionV1p1beta1WebDetectionWebImage {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1WebDetectionWebImageOps[Self <: GoogleCloudVisionV1p1beta1WebDetectionWebImage] (val x: Self) extends AnyVal {
