...
@js.native
trait GoogleCloudVisionV1p2beta1WebDetectionWebEntity extends js.Object {
...
object GoogleCloudVisionV1p2beta1WebDetectionWebEntity {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1WebDetectionWebEntityOps[Self <: GoogleCloudVisionV1p2beta1WebDetectionWebEntity] (val x: Self) extends AnyVal {
