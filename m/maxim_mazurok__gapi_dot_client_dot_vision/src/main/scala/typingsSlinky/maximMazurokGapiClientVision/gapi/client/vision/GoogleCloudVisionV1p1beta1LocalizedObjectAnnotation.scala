...
object GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation]
  }
