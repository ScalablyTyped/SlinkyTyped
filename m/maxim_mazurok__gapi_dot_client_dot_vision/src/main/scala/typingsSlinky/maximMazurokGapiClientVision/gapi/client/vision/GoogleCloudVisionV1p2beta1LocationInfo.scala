...
@js.native
trait GoogleCloudVisionV1p2beta1LocationInfo extends js.Object {
...
object GoogleCloudVisionV1p2beta1LocationInfo {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1LocationInfoOps[Self <: GoogleCloudVisionV1p2beta1LocationInfo] (val x: Self) extends AnyVal {
