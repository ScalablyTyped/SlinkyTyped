...
object GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponseMutableBuilder[Self <: GoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setOutputConfig(value: GoogleCloudVisionV1p3beta1OutputConfig): Self = StObject.set(x, "outputConfig", value.asInstanceOf[js.Any])
