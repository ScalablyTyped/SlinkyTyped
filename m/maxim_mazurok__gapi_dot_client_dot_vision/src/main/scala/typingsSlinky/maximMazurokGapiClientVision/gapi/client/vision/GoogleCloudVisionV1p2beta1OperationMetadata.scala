...
@js.native
trait GoogleCloudVisionV1p2beta1OperationMetadata extends js.Object {
...
object GoogleCloudVisionV1p2beta1OperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1OperationMetadataOps[Self <: GoogleCloudVisionV1p2beta1OperationMetadata] (val x: Self) extends AnyVal {
