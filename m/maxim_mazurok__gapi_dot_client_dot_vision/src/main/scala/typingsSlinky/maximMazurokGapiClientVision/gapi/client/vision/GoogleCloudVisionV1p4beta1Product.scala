...
@js.native
trait GoogleCloudVisionV1p4beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1ProductKeyValue]] = js.native
}
object GoogleCloudVisionV1p4beta1Product {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1Product]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ProductMutableBuilder[Self <: GoogleCloudVisionV1p4beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabels(value: js.Array[GoogleCloudVisionV1p4beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    @scala.inline
    def setProductLabelsVarargs(value: GoogleCloudVisionV1p4beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
