...
@js.native
trait GoogleCloudVisionV1p4beta1Word extends StObject {
  ...
  var symbols: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1Symbol]] = js.native
}
object GoogleCloudVisionV1p4beta1Word {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1Word]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1WordMutableBuilder[Self <: GoogleCloudVisionV1p4beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbols(value: js.Array[GoogleCloudVisionV1p4beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    @scala.inline
    def setSymbolsVarargs(value: GoogleCloudVisionV1p4beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
