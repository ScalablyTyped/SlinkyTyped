...
@js.native
trait GoogleCloudVisionV1p3beta1BatchOperationMetadata extends StObject {
...
object GoogleCloudVisionV1p3beta1BatchOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1BatchOperationMetadataMutableBuilder[Self <: GoogleCloudVisionV1p3beta1BatchOperationMetadata] (val x: Self) extends AnyVal {
