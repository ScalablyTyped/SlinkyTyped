...
@js.native
trait GoogleCloudVisionV1p1beta1Property extends js.Object {
...
object GoogleCloudVisionV1p1beta1Property {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1Property = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1Property]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1PropertyOps[Self <: GoogleCloudVisionV1p1beta1Property] (val x: Self) extends AnyVal {
