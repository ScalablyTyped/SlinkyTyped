...
@js.native
trait GoogleCloudVisionV1p1beta1CropHint extends js.Object {
...
object GoogleCloudVisionV1p1beta1CropHint {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1CropHintOps[Self <: GoogleCloudVisionV1p1beta1CropHint] (val x: Self) extends AnyVal {
