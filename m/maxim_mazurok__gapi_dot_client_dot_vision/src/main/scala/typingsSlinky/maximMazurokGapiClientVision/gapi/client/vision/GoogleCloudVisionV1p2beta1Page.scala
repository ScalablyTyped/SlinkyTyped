...
object GoogleCloudVisionV1p2beta1Page {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1PageMutableBuilder[Self <: GoogleCloudVisionV1p2beta1Page] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBlocks(value: js.Array[GoogleCloudVisionV1p2beta1Block]): Self = StObject.set(x, "blocks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBlocksUndefined: Self = StObject.set(x, "blocks", js.undefined)
    
    @scala.inline
    def setBlocksVarargs(value: GoogleCloudVisionV1p2beta1Block*): Self = StObject.set(x, "blocks", js.Array(value :_*))
