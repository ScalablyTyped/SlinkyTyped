...
@js.native
trait GoogleCloudVisionV1p3beta1SafeSearchAnnotation extends js.Object {
...
object GoogleCloudVisionV1p3beta1SafeSearchAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1SafeSearchAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1SafeSearchAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1SafeSearchAnnotationOps[Self <: GoogleCloudVisionV1p3beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
