...
object GoogleCloudVisionV1p3beta1SafeSearchAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1SafeSearchAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p3beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
