...
@js.native
trait GoogleCloudVisionV1p3beta1Paragraph extends StObject {
  ...
  var words: js.UndefOr[js.Array[GoogleCloudVisionV1p3beta1Word]] = js.native
}
object GoogleCloudVisionV1p3beta1Paragraph {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p3beta1Paragraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1Paragraph]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1ParagraphMutableBuilder[Self <: GoogleCloudVisionV1p3beta1Paragraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVisionV1p3beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVisionV1p3beta1Word*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
