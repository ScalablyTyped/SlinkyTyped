...
@js.native
trait GoogleCloudVisionV1p2beta1EntityAnnotation extends StObject {
  ...
  /**
    ...
    */
  var locations: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1LocationInfo]] = js.native
  
  /** Opaque entity ID. Some IDs may be available in [Google Knowledge Graph Search API](https://developers.google.com/knowledge-graph/). */
  var mid: js.UndefOr[String] = js.native
  
  /** Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity. */
  var properties: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1Property]] = js.native
...
object GoogleCloudVisionV1p2beta1EntityAnnotation {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1EntityAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1EntityAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1EntityAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p2beta1EntityAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocations(value: js.Array[GoogleCloudVisionV1p2beta1LocationInfo]): Self = StObject.set(x, "locations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocationsUndefined: Self = StObject.set(x, "locations", js.undefined)
    
    @scala.inline
    def setLocationsVarargs(value: GoogleCloudVisionV1p2beta1LocationInfo*): Self = StObject.set(x, "locations", js.Array(value :_*))
    ...
    @scala.inline
    def setProperties(value: js.Array[GoogleCloudVisionV1p2beta1Property]): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPropertiesUndefined: Self = StObject.set(x, "properties", js.undefined)
    
    @scala.inline
    def setPropertiesVarargs(value: GoogleCloudVisionV1p2beta1Property*): Self = StObject.set(x, "properties", js.Array(value :_*))
