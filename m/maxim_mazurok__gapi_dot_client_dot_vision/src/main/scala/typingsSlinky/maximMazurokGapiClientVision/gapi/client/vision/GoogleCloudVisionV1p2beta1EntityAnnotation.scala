...
@js.native
trait GoogleCloudVisionV1p2beta1EntityAnnotation extends js.Object {
...
object GoogleCloudVisionV1p2beta1EntityAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1EntityAnnotationOps[Self <: GoogleCloudVisionV1p2beta1EntityAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocationsVarargs(value: GoogleCloudVisionV1p2beta1LocationInfo*): Self = this.set("locations", js.Array(value :_*))
    
    @scala.inline
    def setLocations(value: js.Array[GoogleCloudVisionV1p2beta1LocationInfo]): Self = this.set("locations", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPropertiesVarargs(value: GoogleCloudVisionV1p2beta1Property*): Self = this.set("properties", js.Array(value :_*))
    
    @scala.inline
    def setProperties(value: js.Array[GoogleCloudVisionV1p2beta1Property]): Self = this.set("properties", value.asInstanceOf[js.Any])
