...
object GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreakMutableBuilder[Self <: GoogleCloudVisionV1p3beta1TextAnnotationDetectedBreak] (val x: Self) extends AnyVal {
