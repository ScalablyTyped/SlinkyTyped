...
@js.native
trait GoogleCloudVisionV1p2beta1Block extends js.Object {
...
object GoogleCloudVisionV1p2beta1Block {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1BlockOps[Self <: GoogleCloudVisionV1p2beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphsVarargs(value: GoogleCloudVisionV1p2beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    
    @scala.inline
    def setParagraphs(value: js.Array[GoogleCloudVisionV1p2beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
