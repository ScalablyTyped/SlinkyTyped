...
@js.native
trait GoogleCloudVisionV1p2beta1ProductSearchResults extends StObject {
...
object GoogleCloudVisionV1p2beta1ProductSearchResults {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1ProductSearchResultsMutableBuilder[Self <: GoogleCloudVisionV1p2beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductGroupedResults(value: js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult]): Self = StObject.set(x, "productGroupedResults", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductGroupedResultsUndefined: Self = StObject.set(x, "productGroupedResults", js.undefined)
    
    @scala.inline
    def setProductGroupedResultsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value :_*))
