...
object GoogleCloudVisionV1p3beta1WebDetectionWebPage {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1WebDetectionWebPageMutableBuilder[Self <: GoogleCloudVisionV1p3beta1WebDetectionWebPage] (val x: Self) extends AnyVal {
