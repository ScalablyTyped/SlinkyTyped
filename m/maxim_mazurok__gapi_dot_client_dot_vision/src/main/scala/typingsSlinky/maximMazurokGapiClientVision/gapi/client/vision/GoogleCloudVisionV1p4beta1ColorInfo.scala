...
@js.native
trait GoogleCloudVisionV1p4beta1ColorInfo extends js.Object {
...
object GoogleCloudVisionV1p4beta1ColorInfo {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1ColorInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1ColorInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ColorInfoOps[Self <: GoogleCloudVisionV1p4beta1ColorInfo] (val x: Self) extends AnyVal {
