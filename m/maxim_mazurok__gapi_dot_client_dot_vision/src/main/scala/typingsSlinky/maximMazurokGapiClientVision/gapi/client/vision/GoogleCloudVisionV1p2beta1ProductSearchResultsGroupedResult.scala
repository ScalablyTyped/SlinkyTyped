...
@js.native
trait GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult extends js.Object {
...
object GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResultOps[Self <: GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingPoly(value: GoogleCloudVisionV1p2beta1BoundingPoly): Self = this.set("boundingPoly", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBoundingPoly: Self = this.set("boundingPoly", js.undefined)
    
    @scala.inline
    def setObjectAnnotationsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation*): Self = this.set("objectAnnotations", js.Array(value :_*))
    
    @scala.inline
    def setObjectAnnotations(value: js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation]): Self = this.set("objectAnnotations", value.asInstanceOf[js.Any])
