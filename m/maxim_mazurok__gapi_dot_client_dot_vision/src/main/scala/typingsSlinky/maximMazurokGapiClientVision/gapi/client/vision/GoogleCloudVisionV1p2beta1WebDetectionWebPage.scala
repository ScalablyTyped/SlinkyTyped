...
@js.native
trait GoogleCloudVisionV1p2beta1WebDetectionWebPage extends js.Object {
...
object GoogleCloudVisionV1p2beta1WebDetectionWebPage {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1WebDetectionWebPageOps[Self <: GoogleCloudVisionV1p2beta1WebDetectionWebPage] (val x: Self) extends AnyVal {
