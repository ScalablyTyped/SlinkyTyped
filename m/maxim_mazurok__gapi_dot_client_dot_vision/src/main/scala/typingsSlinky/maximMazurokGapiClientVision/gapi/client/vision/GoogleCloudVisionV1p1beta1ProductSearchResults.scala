...
@js.native
trait GoogleCloudVisionV1p1beta1ProductSearchResults extends js.Object {
...
object GoogleCloudVisionV1p1beta1ProductSearchResults {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1ProductSearchResults = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1ProductSearchResults]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1ProductSearchResultsOps[Self <: GoogleCloudVisionV1p1beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductGroupedResultsVarargs(value: GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult*): Self = this.set("productGroupedResults", js.Array(value :_*))
    
    @scala.inline
    def setProductGroupedResults(value: js.Array[GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult]): Self = this.set("productGroupedResults", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteProductGroupedResults: Self = this.set("productGroupedResults", js.undefined)
    
    @scala.inline
    def setResultsVarargs(value: GoogleCloudVisionV1p1beta1ProductSearchResultsResult*): Self = this.set("results", js.Array(value :_*))
    
    @scala.inline
    def setResults(value: js.Array[GoogleCloudVisionV1p1beta1ProductSearchResultsResult]): Self = this.set("results", value.asInstanceOf[js.Any])
