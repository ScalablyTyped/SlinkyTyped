...
@js.native
trait FaceAnnotation extends StObject {
...
object FaceAnnotation {
  ...
  @scala.inline
  implicit class FaceAnnotationMutableBuilder[Self <: FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarks(value: js.Array[Landmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
