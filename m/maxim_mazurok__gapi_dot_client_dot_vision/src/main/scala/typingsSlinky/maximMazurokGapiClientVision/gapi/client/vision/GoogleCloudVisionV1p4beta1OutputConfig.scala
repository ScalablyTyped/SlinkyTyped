...
@js.native
trait GoogleCloudVisionV1p4beta1OutputConfig extends js.Object {
...
object GoogleCloudVisionV1p4beta1OutputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1OutputConfigOps[Self <: GoogleCloudVisionV1p4beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: GoogleCloudVisionV1p4beta1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
