...
@js.native
trait GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak extends js.Object {
...
object GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakOps[Self <: GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak] (val x: Self) extends AnyVal {
