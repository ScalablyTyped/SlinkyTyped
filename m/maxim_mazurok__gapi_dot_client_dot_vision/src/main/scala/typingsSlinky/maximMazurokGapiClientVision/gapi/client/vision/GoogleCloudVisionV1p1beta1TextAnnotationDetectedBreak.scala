...
object GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreakMutableBuilder[Self <: GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak] (val x: Self) extends AnyVal {
