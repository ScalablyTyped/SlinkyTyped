...
@js.native
trait GoogleCloudVisionV1p2beta1InputConfig extends js.Object {
...
object GoogleCloudVisionV1p2beta1InputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1InputConfigOps[Self <: GoogleCloudVisionV1p2beta1InputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsSource(value: GoogleCloudVisionV1p2beta1GcsSource): Self = this.set("gcsSource", value.asInstanceOf[js.Any])
