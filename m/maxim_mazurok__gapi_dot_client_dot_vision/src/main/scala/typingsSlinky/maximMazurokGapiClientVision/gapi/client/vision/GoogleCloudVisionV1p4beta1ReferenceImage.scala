...
@js.native
trait GoogleCloudVisionV1p4beta1ReferenceImage extends js.Object {
...
object GoogleCloudVisionV1p4beta1ReferenceImage {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ReferenceImageOps[Self <: GoogleCloudVisionV1p4beta1ReferenceImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingPolysVarargs(value: GoogleCloudVisionV1p4beta1BoundingPoly*): Self = this.set("boundingPolys", js.Array(value :_*))
    
    @scala.inline
    def setBoundingPolys(value: js.Array[GoogleCloudVisionV1p4beta1BoundingPoly]): Self = this.set("boundingPolys", value.asInstanceOf[js.Any])
