...
@js.native
trait GoogleCloudVisionV1p4beta1ReferenceImage extends StObject {
  ...
  /**
    ...
    */
  var boundingPolys: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1BoundingPoly]] = js.native
...
object GoogleCloudVisionV1p4beta1ReferenceImage {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1ReferenceImage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1ReferenceImage]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ReferenceImageMutableBuilder[Self <: GoogleCloudVisionV1p4beta1ReferenceImage] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBoundingPolys(value: js.Array[GoogleCloudVisionV1p4beta1BoundingPoly]): Self = StObject.set(x, "boundingPolys", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundingPolysUndefined: Self = StObject.set(x, "boundingPolys", js.undefined)
    
    @scala.inline
    def setBoundingPolysVarargs(value: GoogleCloudVisionV1p4beta1BoundingPoly*): Self = StObject.set(x, "boundingPolys", js.Array(value :_*))
