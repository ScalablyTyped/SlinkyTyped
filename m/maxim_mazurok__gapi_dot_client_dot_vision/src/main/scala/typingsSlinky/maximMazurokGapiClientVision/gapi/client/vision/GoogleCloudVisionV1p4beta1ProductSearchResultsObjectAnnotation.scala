...
object GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p4beta1ProductSearchResultsObjectAnnotation] (val x: Self) extends AnyVal {
