...
object GoogleCloudVisionV1p1beta1InputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1InputConfigMutableBuilder[Self <: GoogleCloudVisionV1p1beta1InputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsSource(value: GoogleCloudVisionV1p1beta1GcsSource): Self = StObject.set(x, "gcsSource", value.asInstanceOf[js.Any])
