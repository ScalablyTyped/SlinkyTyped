...
@js.native
trait GoogleCloudVisionV1p1beta1InputConfig extends js.Object {
  ...
  var gcsSource: js.UndefOr[GoogleCloudVisionV1p1beta1GcsSource] = js.native
...
object GoogleCloudVisionV1p1beta1InputConfig {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1InputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1InputConfig]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1InputConfigOps[Self <: GoogleCloudVisionV1p1beta1InputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsSource(value: GoogleCloudVisionV1p1beta1GcsSource): Self = this.set("gcsSource", value.asInstanceOf[js.Any])
