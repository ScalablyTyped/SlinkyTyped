...
@js.native
trait GoogleCloudVisionV1p4beta1AnnotateFileResponse extends js.Object {
  ...
  var inputConfig: js.UndefOr[GoogleCloudVisionV1p4beta1InputConfig] = js.native
  
  /** Individual responses to images found within the file. This field will be empty if the `error` field is set. */
  var responses: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1AnnotateImageResponse]] = js.native
...
object GoogleCloudVisionV1p4beta1AnnotateFileResponse {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1AnnotateFileResponseOps[Self <: GoogleCloudVisionV1p4beta1AnnotateFileResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputConfig(value: GoogleCloudVisionV1p4beta1InputConfig): Self = this.set("inputConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInputConfig: Self = this.set("inputConfig", js.undefined)
    
    @scala.inline
    def setResponsesVarargs(value: GoogleCloudVisionV1p4beta1AnnotateImageResponse*): Self = this.set("responses", js.Array(value :_*))
    
    @scala.inline
    def setResponses(value: js.Array[GoogleCloudVisionV1p4beta1AnnotateImageResponse]): Self = this.set("responses", value.asInstanceOf[js.Any])
