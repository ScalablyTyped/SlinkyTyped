...
@js.native
trait GoogleCloudVisionV1p1beta1FaceAnnotation extends js.Object {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[GoogleCloudVisionV1p1beta1BoundingPoly] = js.native
  ...
  var landmarks: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1FaceAnnotationLandmark]] = js.native
...
object GoogleCloudVisionV1p1beta1FaceAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p1beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1FaceAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1FaceAnnotationOps[Self <: GoogleCloudVisionV1p1beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: GoogleCloudVisionV1p1beta1BoundingPoly): Self = this.set("fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVisionV1p1beta1FaceAnnotationLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVisionV1p1beta1FaceAnnotationLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
