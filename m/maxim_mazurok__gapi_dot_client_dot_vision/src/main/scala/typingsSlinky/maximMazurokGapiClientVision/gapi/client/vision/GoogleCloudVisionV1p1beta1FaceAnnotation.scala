...
object GoogleCloudVisionV1p1beta1FaceAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1FaceAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p1beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: GoogleCloudVisionV1p1beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVisionV1p1beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVisionV1p1beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
