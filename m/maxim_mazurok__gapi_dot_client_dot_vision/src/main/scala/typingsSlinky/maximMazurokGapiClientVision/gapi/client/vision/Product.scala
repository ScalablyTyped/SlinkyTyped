...
object Product {
  ...
  implicit class ProductOps[Self <: Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabelsVarargs(value: KeyValue*): Self = this.set("productLabels", js.Array(value :_*))
    
    @scala.inline
    def setProductLabels(value: js.Array[KeyValue]): Self = this.set("productLabels", value.asInstanceOf[js.Any])
