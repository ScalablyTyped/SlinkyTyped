...
@js.native
trait GoogleCloudVisionV1p2beta1FaceAnnotation extends js.Object {
...
object GoogleCloudVisionV1p2beta1FaceAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1FaceAnnotationOps[Self <: GoogleCloudVisionV1p2beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: GoogleCloudVisionV1p2beta1BoundingPoly): Self = this.set("fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVisionV1p2beta1FaceAnnotationLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
