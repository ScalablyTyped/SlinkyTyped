...
@js.native
trait GoogleCloudVisionV1p2beta1FaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[GoogleCloudVisionV1p2beta1BoundingPoly] = js.native
  ...
  var landmarks: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]] = js.native
...
object GoogleCloudVisionV1p2beta1FaceAnnotation {
  ...
  @scala.inline
  def apply(): GoogleCloudVisionV1p2beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1FaceAnnotation]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p2beta1FaceAnnotationMutableBuilder[Self <: GoogleCloudVisionV1p2beta1FaceAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFdBoundingPoly(value: GoogleCloudVisionV1p2beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVisionV1p2beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVisionV1p2beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
