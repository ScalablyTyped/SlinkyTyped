...
@js.native
trait GoogleCloudVisionV1p1beta1Word extends js.Object {
...
object GoogleCloudVisionV1p1beta1Word {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p1beta1WordOps[Self <: GoogleCloudVisionV1p1beta1Word] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSymbolsVarargs(value: GoogleCloudVisionV1p1beta1Symbol*): Self = this.set("symbols", js.Array(value :_*))
    
    @scala.inline
    def setSymbols(value: js.Array[GoogleCloudVisionV1p1beta1Symbol]): Self = this.set("symbols", value.asInstanceOf[js.Any])
