...
@js.native
trait GoogleCloudVisionV1p3beta1GcsSource extends js.Object {
...
object GoogleCloudVisionV1p3beta1GcsSource {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p3beta1GcsSourceOps[Self <: GoogleCloudVisionV1p3beta1GcsSource] (val x: Self) extends AnyVal {
