...
@js.native
trait GoogleCloudVisionV1p4beta1Symbol extends StObject {
...
object GoogleCloudVisionV1p4beta1Symbol {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1Symbol = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1Symbol]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1SymbolMutableBuilder[Self <: GoogleCloudVisionV1p4beta1Symbol] (val x: Self) extends AnyVal {
