...
@js.native
trait GoogleCloudVisionV1p4beta1Symbol extends js.Object {
...
object GoogleCloudVisionV1p4beta1Symbol {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1SymbolOps[Self <: GoogleCloudVisionV1p4beta1Symbol] (val x: Self) extends AnyVal {
