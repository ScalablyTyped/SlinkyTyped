...
@js.native
trait GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse extends js.Object {
...
object GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse {
  ...
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponseOps[Self <: GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse] (val x: Self) extends AnyVal {
