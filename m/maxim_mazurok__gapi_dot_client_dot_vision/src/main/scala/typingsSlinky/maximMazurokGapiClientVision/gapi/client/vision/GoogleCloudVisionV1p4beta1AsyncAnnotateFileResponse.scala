...
@js.native
trait GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse extends StObject {
  
  /** The output location and metadata from AsyncAnnotateFileRequest. */
  var outputConfig: js.UndefOr[GoogleCloudVisionV1p4beta1OutputConfig] = js.native
}
object GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse {
  
  @scala.inline
  def apply(): GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse]
  }
  
  @scala.inline
  implicit class GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponseMutableBuilder[Self <: GoogleCloudVisionV1p4beta1AsyncAnnotateFileResponse] (val x: Self) extends AnyVal {
