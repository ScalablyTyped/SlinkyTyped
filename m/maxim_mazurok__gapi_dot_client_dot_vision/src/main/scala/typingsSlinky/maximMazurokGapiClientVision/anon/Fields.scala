...
import typingsSlinky.maximMazurokGapiClientVision.gapi.client.vision.BatchAnnotateFilesRequest
...
trait Fields extends StObject {
  ...
  /** Request body */
  var resource: BatchAnnotateFilesRequest = js.native
...
object Fields {
  ...
  @scala.inline
  def apply(parent: String, resource: BatchAnnotateFilesRequest): Fields = {
  ...
  implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BatchAnnotateFilesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
