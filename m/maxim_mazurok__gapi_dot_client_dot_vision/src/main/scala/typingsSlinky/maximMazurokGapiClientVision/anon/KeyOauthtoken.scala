package typingsSlinky.maximMazurokGapiClientVision.anon

import typingsSlinky.maximMazurokGapiClientVision.gapi.client.vision.ImportProductSetsRequest
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ImportProductSetsRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: ImportProductSetsRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ImportProductSetsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
