...
object ReferenceImageId {
  ...
  @scala.inline
  implicit class ReferenceImageIdMutableBuilder[Self <: ReferenceImageId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReferenceImage): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
