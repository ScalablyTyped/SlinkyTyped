...
import typingsSlinky.maximMazurokGapiClientVision.gapi.client.vision.ReferenceImage
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait ReferenceImageId extends js.Object {
  ...
  /** Request body */
  var resource: ReferenceImage = js.native
...
object ReferenceImageId {
  ...
  @scala.inline
  def apply(parent: String, resource: ReferenceImage): ReferenceImageId = {
  ...
  @scala.inline
  implicit class ReferenceImageIdOps[Self <: ReferenceImageId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReferenceImage): Self = this.set("resource", value.asInstanceOf[js.Any])
