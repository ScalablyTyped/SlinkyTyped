...
import typingsSlinky.maximMazurokGapiClientVision.gapi.client.vision.AsyncBatchAnnotateFilesRequest
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: AsyncBatchAnnotateFilesRequest): Oauthtoken = {
