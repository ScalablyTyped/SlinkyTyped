...
trait GoogleCloudRecommenderV1RecommendationStateInfo extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1RecommendationStateInfo with TopLevel[js.Any]
  ] = js.native
}
