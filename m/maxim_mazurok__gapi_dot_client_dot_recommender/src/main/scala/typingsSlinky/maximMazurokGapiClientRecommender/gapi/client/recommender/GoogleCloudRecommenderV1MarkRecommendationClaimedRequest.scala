...
@js.native
trait GoogleCloudRecommenderV1MarkRecommendationClaimedRequest extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest with TopLevel[js.Any]
  ] = js.native
}
object GoogleCloudRecommenderV1MarkRecommendationClaimedRequest {
  ...
  @scala.inline
  implicit class GoogleCloudRecommenderV1MarkRecommendationClaimedRequestOps[Self <: GoogleCloudRecommenderV1MarkRecommendationClaimedRequest] (val x: Self) extends AnyVal {
