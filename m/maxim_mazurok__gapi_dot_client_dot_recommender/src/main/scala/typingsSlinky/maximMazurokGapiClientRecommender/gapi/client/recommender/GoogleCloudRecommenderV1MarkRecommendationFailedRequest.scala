...
trait GoogleCloudRecommenderV1MarkRecommendationFailedRequest extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1MarkRecommendationFailedRequest with TopLevel[js.Any]
  ] = js.native
}
