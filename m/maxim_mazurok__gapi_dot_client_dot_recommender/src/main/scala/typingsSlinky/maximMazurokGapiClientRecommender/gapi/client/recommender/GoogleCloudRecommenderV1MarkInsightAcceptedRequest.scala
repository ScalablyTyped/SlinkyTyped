...
trait GoogleCloudRecommenderV1MarkInsightAcceptedRequest extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1MarkInsightAcceptedRequest with TopLevel[js.Any]
  ] = js.native
}
