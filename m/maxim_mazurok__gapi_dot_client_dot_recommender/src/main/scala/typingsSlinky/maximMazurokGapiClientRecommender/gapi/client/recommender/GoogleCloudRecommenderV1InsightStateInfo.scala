...
trait GoogleCloudRecommenderV1InsightStateInfo extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientRecommender.maximMazurokGapiClientRecommenderStrings.GoogleCloudRecommenderV1InsightStateInfo with TopLevel[js.Any]
  ] = js.native
}
