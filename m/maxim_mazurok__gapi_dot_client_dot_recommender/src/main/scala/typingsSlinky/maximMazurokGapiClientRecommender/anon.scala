...
import typingsSlinky.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkInsightAcceptedRequest
import typingsSlinky.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest
