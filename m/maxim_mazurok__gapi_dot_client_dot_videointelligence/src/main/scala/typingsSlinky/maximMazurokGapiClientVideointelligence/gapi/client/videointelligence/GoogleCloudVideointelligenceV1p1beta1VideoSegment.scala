...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1VideoSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1VideoSegment {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p1beta1VideoSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1VideoSegment]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1VideoSegmentOps[Self <: GoogleCloudVideointelligenceV1p1beta1VideoSegment] (val x: Self) extends AnyVal {
