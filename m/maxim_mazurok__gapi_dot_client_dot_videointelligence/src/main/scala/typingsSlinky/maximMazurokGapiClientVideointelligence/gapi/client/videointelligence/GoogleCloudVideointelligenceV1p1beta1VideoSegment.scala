...
object GoogleCloudVideointelligenceV1p1beta1VideoSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1VideoSegmentMutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1VideoSegment] (val x: Self) extends AnyVal {
