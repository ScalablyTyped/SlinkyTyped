...
object GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternativeMutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVideointelligenceV1p2beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVideointelligenceV1p2beta1WordInfo*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
