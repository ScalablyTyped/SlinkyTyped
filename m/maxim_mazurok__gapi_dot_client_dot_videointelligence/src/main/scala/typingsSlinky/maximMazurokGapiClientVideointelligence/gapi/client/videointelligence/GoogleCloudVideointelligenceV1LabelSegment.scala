...
@js.native
trait GoogleCloudVideointelligenceV1LabelSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1LabelSegment {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1LabelSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1LabelSegment]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1LabelSegmentOps[Self <: GoogleCloudVideointelligenceV1LabelSegment] (val x: Self) extends AnyVal {
