...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1DetectedAttribute extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1DetectedAttribute {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1DetectedAttributeOps[Self <: GoogleCloudVideointelligenceV1p2beta1DetectedAttribute] (val x: Self) extends AnyVal {
