...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternativeOps[Self <: GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVideointelligenceV1p1beta1WordInfo*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVideointelligenceV1p1beta1WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
