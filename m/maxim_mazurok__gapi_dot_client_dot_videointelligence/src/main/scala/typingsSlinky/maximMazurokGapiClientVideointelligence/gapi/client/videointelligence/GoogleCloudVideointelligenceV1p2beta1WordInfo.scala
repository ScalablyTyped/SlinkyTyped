...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1WordInfo extends StObject {
...
object GoogleCloudVideointelligenceV1p2beta1WordInfo {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p2beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p2beta1WordInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1WordInfoMutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1WordInfo] (val x: Self) extends AnyVal {
