...
object GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBoxMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox] (val x: Self) extends AnyVal {
