...
object GoogleCloudVideointelligenceV1DetectedAttribute {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1DetectedAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1DetectedAttribute]
  }
