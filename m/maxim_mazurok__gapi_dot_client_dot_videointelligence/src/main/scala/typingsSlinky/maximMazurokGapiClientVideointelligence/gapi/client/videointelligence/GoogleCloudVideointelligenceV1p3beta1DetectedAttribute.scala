...
object GoogleCloudVideointelligenceV1p3beta1DetectedAttribute {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1DetectedAttributeMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1DetectedAttribute] (val x: Self) extends AnyVal {
