...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1DetectedAttribute extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1DetectedAttribute {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p3beta1DetectedAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1DetectedAttribute]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1DetectedAttributeOps[Self <: GoogleCloudVideointelligenceV1p3beta1DetectedAttribute] (val x: Self) extends AnyVal {
