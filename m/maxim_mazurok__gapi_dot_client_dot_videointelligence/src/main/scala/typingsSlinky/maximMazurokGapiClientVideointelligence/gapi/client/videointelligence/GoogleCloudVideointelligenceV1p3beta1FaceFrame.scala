...
object GoogleCloudVideointelligenceV1p3beta1FaceFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1FaceFrameMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1FaceFrame] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setNormalizedBoundingBoxes(value: js.Array[GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox]): Self = StObject.set(x, "normalizedBoundingBoxes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNormalizedBoundingBoxesUndefined: Self = StObject.set(x, "normalizedBoundingBoxes", js.undefined)
    
    @scala.inline
    def setNormalizedBoundingBoxesVarargs(value: GoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox*): Self = StObject.set(x, "normalizedBoundingBoxes", js.Array(value :_*))
