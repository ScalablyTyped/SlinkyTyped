...
@js.native
trait GoogleCloudVideointelligenceV1FaceFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1FaceFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1FaceFrameOps[Self <: GoogleCloudVideointelligenceV1FaceFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNormalizedBoundingBoxesVarargs(value: GoogleCloudVideointelligenceV1NormalizedBoundingBox*): Self = this.set("normalizedBoundingBoxes", js.Array(value :_*))
    
    @scala.inline
    def setNormalizedBoundingBoxes(value: js.Array[GoogleCloudVideointelligenceV1NormalizedBoundingBox]): Self = this.set("normalizedBoundingBoxes", value.asInstanceOf[js.Any])
