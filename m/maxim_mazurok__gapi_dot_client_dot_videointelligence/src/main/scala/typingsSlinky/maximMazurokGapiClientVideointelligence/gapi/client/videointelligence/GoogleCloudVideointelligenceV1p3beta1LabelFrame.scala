...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1LabelFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1LabelFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1LabelFrameOps[Self <: GoogleCloudVideointelligenceV1p3beta1LabelFrame] (val x: Self) extends AnyVal {
