...
object GoogleCloudVideointelligenceV1VideoAnnotationProgress {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1VideoAnnotationProgressMutableBuilder[Self <: GoogleCloudVideointelligenceV1VideoAnnotationProgress] (val x: Self) extends AnyVal {
