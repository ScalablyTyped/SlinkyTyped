...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1TimestampedObject extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1TimestampedObject {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1TimestampedObjectOps[Self <: GoogleCloudVideointelligenceV1p1beta1TimestampedObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributesVarargs(value: GoogleCloudVideointelligenceV1p1beta1DetectedAttribute*): Self = this.set("attributes", js.Array(value :_*))
    
    @scala.inline
    def setAttributes(value: js.Array[GoogleCloudVideointelligenceV1p1beta1DetectedAttribute]): Self = this.set("attributes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAttributes: Self = this.set("attributes", js.undefined)
    
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVideointelligenceV1p1beta1DetectedLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVideointelligenceV1p1beta1DetectedLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
