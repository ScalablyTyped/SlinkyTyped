...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1ExplicitContentFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1ExplicitContentFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1ExplicitContentFrameOps[Self <: GoogleCloudVideointelligenceV1p3beta1ExplicitContentFrame] (val x: Self) extends AnyVal {
