...
@js.native
trait GoogleCloudVideointelligenceV1WordInfo extends js.Object {
...
object GoogleCloudVideointelligenceV1WordInfo {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1WordInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1WordInfoOps[Self <: GoogleCloudVideointelligenceV1WordInfo] (val x: Self) extends AnyVal {
