...
object GoogleCloudVideointelligenceV1beta2AnnotateVideoResponse {
  ...
  implicit class GoogleCloudVideointelligenceV1beta2AnnotateVideoResponseOps[Self <: GoogleCloudVideointelligenceV1beta2AnnotateVideoResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnotationResultsVarargs(value: GoogleCloudVideointelligenceV1beta2VideoAnnotationResults*): Self = this.set("annotationResults", js.Array(value :_*))
    
    @scala.inline
    def setAnnotationResults(value: js.Array[GoogleCloudVideointelligenceV1beta2VideoAnnotationResults]): Self = this.set("annotationResults", value.asInstanceOf[js.Any])
