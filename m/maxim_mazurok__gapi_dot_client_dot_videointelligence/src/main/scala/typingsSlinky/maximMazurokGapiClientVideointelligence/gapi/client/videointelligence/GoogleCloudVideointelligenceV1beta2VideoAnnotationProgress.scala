...
object GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2VideoAnnotationProgressMutableBuilder[Self <: GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress] (val x: Self) extends AnyVal {
