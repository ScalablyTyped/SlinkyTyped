...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrameOps[Self <: GoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame] (val x: Self) extends AnyVal {
