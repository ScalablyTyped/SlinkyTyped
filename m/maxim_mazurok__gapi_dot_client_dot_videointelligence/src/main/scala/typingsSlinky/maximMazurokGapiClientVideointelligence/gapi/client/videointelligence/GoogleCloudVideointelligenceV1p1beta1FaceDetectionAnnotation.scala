...
object GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotationMutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation] (val x: Self) extends AnyVal {
