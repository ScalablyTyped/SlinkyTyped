...
object GoogleCloudVideointelligenceV1p1beta1LabelFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1LabelFrameMutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1LabelFrame] (val x: Self) extends AnyVal {
