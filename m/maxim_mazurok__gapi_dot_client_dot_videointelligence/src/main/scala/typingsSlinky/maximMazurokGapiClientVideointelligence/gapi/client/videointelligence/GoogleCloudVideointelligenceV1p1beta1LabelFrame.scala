...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1LabelFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1LabelFrame {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p1beta1LabelFrame = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1LabelFrame]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1LabelFrameOps[Self <: GoogleCloudVideointelligenceV1p1beta1LabelFrame] (val x: Self) extends AnyVal {
