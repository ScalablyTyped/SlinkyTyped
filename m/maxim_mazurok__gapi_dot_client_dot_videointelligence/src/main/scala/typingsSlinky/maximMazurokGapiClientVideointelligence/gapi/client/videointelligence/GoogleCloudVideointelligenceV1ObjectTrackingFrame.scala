...
@js.native
trait GoogleCloudVideointelligenceV1ObjectTrackingFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1ObjectTrackingFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1ObjectTrackingFrameOps[Self <: GoogleCloudVideointelligenceV1ObjectTrackingFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNormalizedBoundingBox(value: GoogleCloudVideointelligenceV1NormalizedBoundingBox): Self = this.set("normalizedBoundingBox", value.asInstanceOf[js.Any])
