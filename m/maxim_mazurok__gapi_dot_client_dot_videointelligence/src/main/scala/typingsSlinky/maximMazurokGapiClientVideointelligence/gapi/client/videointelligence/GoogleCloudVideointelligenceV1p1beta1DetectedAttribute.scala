...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1DetectedAttribute extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1DetectedAttribute {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1DetectedAttributeOps[Self <: GoogleCloudVideointelligenceV1p1beta1DetectedAttribute] (val x: Self) extends AnyVal {
