...
@js.native
trait GoogleCloudVideointelligenceV1TimestampedObject extends js.Object {
  
  /** Optional. The attributes of the object in the bounding box. */
  var attributes: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1DetectedAttribute]] = js.native
  
  /** Optional. The detected landmarks. */
  var landmarks: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1DetectedLandmark]] = js.native
...
object GoogleCloudVideointelligenceV1TimestampedObject {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1TimestampedObjectOps[Self <: GoogleCloudVideointelligenceV1TimestampedObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLandmarksVarargs(value: GoogleCloudVideointelligenceV1DetectedLandmark*): Self = this.set("landmarks", js.Array(value :_*))
    
    @scala.inline
    def setLandmarks(value: js.Array[GoogleCloudVideointelligenceV1DetectedLandmark]): Self = this.set("landmarks", value.asInstanceOf[js.Any])
