...
import typingsSlinky.maximMazurokGapiClientVideointelligence.maximMazurokGapiClientVideointelligenceStrings.GoogleLongrunning_Operation
...
trait GoogleLongrunningOperation extends StObject {
  ...
  {[ P in string ]: any}
    */ GoogleLongrunning_Operation with TopLevel[js.Any]
  ] = js.native
