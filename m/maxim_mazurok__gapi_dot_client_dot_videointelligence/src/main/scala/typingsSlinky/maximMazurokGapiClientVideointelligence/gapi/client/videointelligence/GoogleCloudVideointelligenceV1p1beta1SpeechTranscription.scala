...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1SpeechTranscription extends js.Object {
  ...
  /**
    ...
    */
  var alternatives: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]] = js.native
...
object GoogleCloudVideointelligenceV1p1beta1SpeechTranscription {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionOps[Self <: GoogleCloudVideointelligenceV1p1beta1SpeechTranscription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativesVarargs(value: GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative*): Self = this.set("alternatives", js.Array(value :_*))
    
    @scala.inline
    def setAlternatives(value: js.Array[GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]): Self = this.set("alternatives", value.asInstanceOf[js.Any])
