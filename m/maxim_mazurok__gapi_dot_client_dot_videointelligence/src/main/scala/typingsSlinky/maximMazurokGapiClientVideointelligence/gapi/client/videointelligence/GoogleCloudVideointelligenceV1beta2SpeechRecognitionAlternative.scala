...
@js.native
trait GoogleCloudVideointelligenceV1beta2SpeechRecognitionAlternative extends js.Object {
...
object GoogleCloudVideointelligenceV1beta2SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2SpeechRecognitionAlternativeOps[Self <: GoogleCloudVideointelligenceV1beta2SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVideointelligenceV1beta2WordInfo*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVideointelligenceV1beta2WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
