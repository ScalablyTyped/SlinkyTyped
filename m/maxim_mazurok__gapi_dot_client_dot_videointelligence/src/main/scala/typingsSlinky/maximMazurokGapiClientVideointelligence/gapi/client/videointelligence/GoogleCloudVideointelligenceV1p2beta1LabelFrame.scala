...
object GoogleCloudVideointelligenceV1p2beta1LabelFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1LabelFrameMutableBuilder[Self <: GoogleCloudVideointelligenceV1p2beta1LabelFrame] (val x: Self) extends AnyVal {
