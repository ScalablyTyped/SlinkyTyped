...
@js.native
trait GoogleCloudVideointelligenceV1FaceSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1FaceSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1FaceSegmentOps[Self <: GoogleCloudVideointelligenceV1FaceSegment] (val x: Self) extends AnyVal {
