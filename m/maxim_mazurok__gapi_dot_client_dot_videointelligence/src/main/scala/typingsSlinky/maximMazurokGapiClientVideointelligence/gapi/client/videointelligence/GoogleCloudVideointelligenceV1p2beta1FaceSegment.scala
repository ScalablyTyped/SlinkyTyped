...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1FaceSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1FaceSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1FaceSegmentOps[Self <: GoogleCloudVideointelligenceV1p2beta1FaceSegment] (val x: Self) extends AnyVal {
