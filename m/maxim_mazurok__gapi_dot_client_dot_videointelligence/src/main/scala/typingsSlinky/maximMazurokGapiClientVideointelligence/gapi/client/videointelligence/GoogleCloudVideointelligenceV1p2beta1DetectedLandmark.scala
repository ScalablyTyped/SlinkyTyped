...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1DetectedLandmark extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1DetectedLandmark {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1DetectedLandmarkOps[Self <: GoogleCloudVideointelligenceV1p2beta1DetectedLandmark] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoint(value: GoogleCloudVideointelligenceV1p2beta1NormalizedVertex): Self = this.set("point", value.asInstanceOf[js.Any])
