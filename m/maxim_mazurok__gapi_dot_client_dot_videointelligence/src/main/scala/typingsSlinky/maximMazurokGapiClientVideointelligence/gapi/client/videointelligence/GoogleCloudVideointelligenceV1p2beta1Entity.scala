...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1Entity extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1Entity {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1EntityOps[Self <: GoogleCloudVideointelligenceV1p2beta1Entity] (val x: Self) extends AnyVal {
