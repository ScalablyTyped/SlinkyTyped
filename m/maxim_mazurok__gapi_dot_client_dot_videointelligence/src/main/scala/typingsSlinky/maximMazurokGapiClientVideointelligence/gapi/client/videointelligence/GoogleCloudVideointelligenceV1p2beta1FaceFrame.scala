...
@js.native
trait GoogleCloudVideointelligenceV1p2beta1FaceFrame extends js.Object {
...
object GoogleCloudVideointelligenceV1p2beta1FaceFrame {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p2beta1FaceFrameOps[Self <: GoogleCloudVideointelligenceV1p2beta1FaceFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNormalizedBoundingBoxesVarargs(value: GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox*): Self = this.set("normalizedBoundingBoxes", js.Array(value :_*))
    
    @scala.inline
    def setNormalizedBoundingBoxes(value: js.Array[GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox]): Self = this.set("normalizedBoundingBoxes", value.asInstanceOf[js.Any])
