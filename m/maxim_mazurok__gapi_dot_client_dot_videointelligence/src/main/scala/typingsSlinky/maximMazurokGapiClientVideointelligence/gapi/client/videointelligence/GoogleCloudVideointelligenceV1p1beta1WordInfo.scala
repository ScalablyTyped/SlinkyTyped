...
@js.native
trait GoogleCloudVideointelligenceV1p1beta1WordInfo extends js.Object {
...
object GoogleCloudVideointelligenceV1p1beta1WordInfo {
  ...
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p1beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1WordInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1WordInfoOps[Self <: GoogleCloudVideointelligenceV1p1beta1WordInfo] (val x: Self) extends AnyVal {
