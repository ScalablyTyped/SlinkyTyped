...
object GoogleCloudVideointelligenceV1p1beta1WordInfo {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p1beta1WordInfoMutableBuilder[Self <: GoogleCloudVideointelligenceV1p1beta1WordInfo] (val x: Self) extends AnyVal {
