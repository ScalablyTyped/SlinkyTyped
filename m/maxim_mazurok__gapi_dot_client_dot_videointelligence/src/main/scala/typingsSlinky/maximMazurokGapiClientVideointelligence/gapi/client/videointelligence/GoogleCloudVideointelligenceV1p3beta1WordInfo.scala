...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1WordInfo extends StObject {
...
object GoogleCloudVideointelligenceV1p3beta1WordInfo {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p3beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1WordInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1WordInfoMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1WordInfo] (val x: Self) extends AnyVal {
