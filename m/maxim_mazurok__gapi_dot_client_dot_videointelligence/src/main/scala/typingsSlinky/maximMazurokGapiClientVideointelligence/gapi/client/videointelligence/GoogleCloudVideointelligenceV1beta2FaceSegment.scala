...
@js.native
trait GoogleCloudVideointelligenceV1beta2FaceSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1beta2FaceSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2FaceSegmentOps[Self <: GoogleCloudVideointelligenceV1beta2FaceSegment] (val x: Self) extends AnyVal {
