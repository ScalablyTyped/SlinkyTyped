...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress extends StObject {
...
object GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgressMutableBuilder[Self <: GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
