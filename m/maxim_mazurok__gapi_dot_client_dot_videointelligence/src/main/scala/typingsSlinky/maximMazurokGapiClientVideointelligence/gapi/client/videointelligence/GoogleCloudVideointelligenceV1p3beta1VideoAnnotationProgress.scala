...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgressOps[Self <: GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress] (val x: Self) extends AnyVal {
