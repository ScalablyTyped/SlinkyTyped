...
@js.native
trait GoogleCloudVideointelligenceV1beta2WordInfo extends js.Object {
...
object GoogleCloudVideointelligenceV1beta2WordInfo {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2WordInfoOps[Self <: GoogleCloudVideointelligenceV1beta2WordInfo] (val x: Self) extends AnyVal {
