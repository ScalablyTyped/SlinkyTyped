...
@js.native
trait GoogleCloudVideointelligenceV1beta2WordInfo extends StObject {
...
object GoogleCloudVideointelligenceV1beta2WordInfo {
  
  @scala.inline
  def apply(): GoogleCloudVideointelligenceV1beta2WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1beta2WordInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1beta2WordInfoMutableBuilder[Self <: GoogleCloudVideointelligenceV1beta2WordInfo] (val x: Self) extends AnyVal {
