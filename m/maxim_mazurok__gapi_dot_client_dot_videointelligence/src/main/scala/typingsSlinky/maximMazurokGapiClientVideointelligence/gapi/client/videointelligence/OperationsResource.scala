...
import typingsSlinky.maximMazurokGapiClientVideointelligence.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientVideointelligence.anon.Alt
import typingsSlinky.maximMazurokGapiClientVideointelligence.anon.Callback
...
trait OperationsResource extends StObject {
  ...
  def list(request: Callback): Request[GoogleLongrunningListOperationsResponse] = js.native
