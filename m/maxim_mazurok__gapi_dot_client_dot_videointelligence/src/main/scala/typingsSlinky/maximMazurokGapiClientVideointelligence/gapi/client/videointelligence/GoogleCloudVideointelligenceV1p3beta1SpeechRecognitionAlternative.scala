...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternativeOps[Self <: GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: GoogleCloudVideointelligenceV1p3beta1WordInfo*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[GoogleCloudVideointelligenceV1p3beta1WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
