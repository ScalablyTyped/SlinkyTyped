...
@js.native
trait GoogleCloudVideointelligenceV1p3beta1FaceSegment extends js.Object {
...
object GoogleCloudVideointelligenceV1p3beta1FaceSegment {
  ...
  @scala.inline
  implicit class GoogleCloudVideointelligenceV1p3beta1FaceSegmentOps[Self <: GoogleCloudVideointelligenceV1p3beta1FaceSegment] (val x: Self) extends AnyVal {
