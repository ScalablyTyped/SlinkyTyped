...
import typingsSlinky.atMaterialTabs.atMaterialTabsStrings.`Dotmdc-tab-bar-scroller__indicator--back`
import typingsSlinky.atMaterialTabs.atMaterialTabsStrings.`Dotmdc-tab-bar-scroller__indicator--forward`
import typingsSlinky.atMaterialTabs.atMaterialTabsStrings.`Dotmdc-tab-bar-scroller__scroll-frame__tabs`
import typingsSlinky.atMaterialTabs.atMaterialTabsStrings.`Dotmdc-tab-bar-scroller__scroll-frame`
import typingsSlinky.atMaterialTabs.atMaterialTabsStrings.`Dotmdc-tab`
