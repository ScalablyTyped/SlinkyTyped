...
trait MakeKeysRequiredPartialUs extends js.Object {
  ...
  var KYCLevel: js.UndefOr[typingsSlinky.mangopay2NodejsSdk.mod.user.KYCLevel] = js.undefined
  var LegalPersonType: typingsSlinky.mangopay2NodejsSdk.mod.user.LegalPersonType
