...
import typingsSlinky.mangopay2NodejsSdk.mod.AVSResult
import typingsSlinky.mangopay2NodejsSdk.mod.ColumnAndDirection
...
import typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.BankAccountType
import typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.DepositAccountType
import typingsSlinky.mangopay2NodejsSdk.mod.card.CardStatus
import typingsSlinky.mangopay2NodejsSdk.mod.card.CardValidity
import typingsSlinky.mangopay2NodejsSdk.mod.client.BusinessType
import typingsSlinky.mangopay2NodejsSdk.mod.client.PlatformType
import typingsSlinky.mangopay2NodejsSdk.mod.client.Sector
import typingsSlinky.mangopay2NodejsSdk.mod.dispute.DisputeReasonType
...
import typingsSlinky.mangopay2NodejsSdk.mod.payIn.PayInExecutionType
import typingsSlinky.mangopay2NodejsSdk.mod.payIn.PayInPaymentType
import typingsSlinky.mangopay2NodejsSdk.mod.refund.RefundReasonType
...
import typingsSlinky.mangopay2NodejsSdk.mod.user.RequiredUserLegalData
import typingsSlinky.mangopay2NodejsSdk.mod.user.RequiredUserNaturalData
import typingsSlinky.mangopay2NodejsSdk.mod.user.StaticKeys
import typingsSlinky.mangopay2NodejsSdk.mod.wallet.ClientFundsType
import typingsSlinky.mangopay2NodejsSdk.mod.wallet.FundsType
...
object mangopay2NodejsSdkStrings {
  ...
  @js.native
  sealed trait BCMC
    extends typingsSlinky.mangopay2NodejsSdk.mod.card.CardType
  ...
  sealed trait BUSINESS
    extends typingsSlinky.mangopay2NodejsSdk.mod.user.LegalPersonType
  ...
  sealed trait CREATED
    extends CardStatus
       with DisputeStatus
       with DocumentStatus
       with typingsSlinky.mangopay2NodejsSdk.mod.kycDocument.DocumentStatus
       with MandateStatus
  ...
  @js.native
  sealed trait LEGAL
    extends typingsSlinky.mangopay2NodejsSdk.mod.user.PersonType
  ...
  @js.native
  sealed trait LIGHT
    extends typingsSlinky.mangopay2NodejsSdk.mod.user.KYCLevel
