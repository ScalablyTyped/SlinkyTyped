...
class UserNatural protected ()
  ...
  /* CompleteClass */
  override var IncomeRange: typingsSlinky.mangopay2NodejsSdk.mod.user.IncomeRange = js.native
  /**
    * KYC Level (LIGHT or REGULAR)
    */
  /* CompleteClass */
  override var KYCLevel: typingsSlinky.mangopay2NodejsSdk.mod.user.KYCLevel = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PersonType: typingsSlinky.mangopay2NodejsSdk.mod.user.PersonType = js.native
  /* CompleteClass */
  @JSName("PersonType")
