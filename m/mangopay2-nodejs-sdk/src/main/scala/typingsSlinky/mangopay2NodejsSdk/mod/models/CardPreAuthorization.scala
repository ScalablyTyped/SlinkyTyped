...
import typingsSlinky.mangopay2NodejsSdk.mod.cardPreAuthorization.UpdateCardPreAuthorization
...
class CardPreAuthorization protected () extends CardPreAuthorizationData {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaymentStatus: typingsSlinky.mangopay2NodejsSdk.mod.PaymentStatus = js.native
  /**
    * The result code
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var SecureMode: typingsSlinky.mangopay2NodejsSdk.mod.SecureMode = js.native
  /**
