...
import typingsSlinky.mangopay2NodejsSdk.mod.payIn.BasePayInData
...
class PayIn protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ExecutionType: typingsSlinky.mangopay2NodejsSdk.mod.payIn.PayInExecutionType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaymentType: typingsSlinky.mangopay2NodejsSdk.mod.payIn.PayInPaymentType = js.native
  /**
    * The result code
    */
  /* CompleteClass */
