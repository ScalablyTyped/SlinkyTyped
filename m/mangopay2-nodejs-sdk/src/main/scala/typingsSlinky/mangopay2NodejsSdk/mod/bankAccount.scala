  ...
  */
  ...
  object CreationDetails {
    ...
    def CADetails(
      ...
      val __obj = js.Dynamic.literal(AccountNumber = AccountNumber.asInstanceOf[js.Any], BankName = BankName.asInstanceOf[js.Any], BranchCode = BranchCode.asInstanceOf[js.Any], InstitutionNumber = InstitutionNumber.asInstanceOf[js.Any], OwnerAddress = OwnerAddress.asInstanceOf[js.Any], OwnerName = OwnerName.asInstanceOf[js.Any], Type = Type.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.CADetails]
    }
    
    @scala.inline
    def GBDetails(AccountNumber: String, OwnerAddress: AddressType, OwnerName: String, SortCode: String, Type: GB): typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.GBDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.GBDetails]
    }
    
    @scala.inline
    def IBANDetails(IBAN: String, OwnerAddress: AddressType, OwnerName: String, Type: IBAN): typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.IBANDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.IBANDetails]
    }
    ...
    def OtherDetails(
      ...
      __obj.asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.OtherDetails]
    }
    
    @scala.inline
    def USDetails(ABA: String, AccountNumber: String, OwnerAddress: AddressType, OwnerName: String, Type: US): typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.USDetails = {
      ...
      __obj.asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mod.bankAccount.USDetails]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.CHECKING
    - typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.SAVINGS
  */
  trait DepositAccountType extends StObject
  object DepositAccountType {
    
    @scala.inline
    def CHECKING: typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.CHECKING = "CHECKING".asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.CHECKING]
    
    @scala.inline
    def SAVINGS: typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.SAVINGS = "SAVINGS".asInstanceOf[typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.SAVINGS]
  }
