...
class Dispute protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var DisputeReason: typingsSlinky.mangopay2NodejsSdk.mod.dispute.DisputeReason = js.native
  /**
    * The type of dispute
    */
  /* CompleteClass */
  override var DisputeType: typingsSlinky.mangopay2NodejsSdk.mod.dispute.DisputeType = js.native
  /**
