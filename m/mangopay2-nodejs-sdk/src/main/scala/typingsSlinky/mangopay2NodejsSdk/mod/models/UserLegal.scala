...
import typingsSlinky.mangopay2NodejsSdk.MakeKeysRequiredPartialUs
...
class UserLegal protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var LegalPersonType: typingsSlinky.mangopay2NodejsSdk.mod.user.LegalPersonType = js.native
  /**
