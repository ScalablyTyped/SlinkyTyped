...
import typingsSlinky.mangopay2NodejsSdk.anon.PartialClientData
...
class Client ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PlatformCategorization: typingsSlinky.mangopay2NodejsSdk.mod.client.PlatformCategorization = js.native
  /**
