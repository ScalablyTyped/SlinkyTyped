...
package object mandate {
  type MandateExecutionType = typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.WEB
  /**
    ...
    */
  type MandateStatus = typingsSlinky.mangopay2NodejsSdk.typesMod.ValueOf[typingsSlinky.mangopay2NodejsSdk.mod.IMandateStatus]
  type MandateType = typingsSlinky.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.DIRECT_DEBIT
}
