...
import typingsSlinky.maximMazurokGapiClientFirestore.gapi.client.firestore.RollbackRequest
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(database: String, resource: RollbackRequest): AccesstokenAlt = {
