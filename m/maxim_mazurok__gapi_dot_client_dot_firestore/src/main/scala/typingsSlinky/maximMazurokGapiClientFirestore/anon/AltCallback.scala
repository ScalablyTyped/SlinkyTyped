...
import typingsSlinky.maximMazurokGapiClientFirestore.gapi.client.firestore.RunQueryRequest
...
object AltCallback {
  ...
  @scala.inline
  def apply(parent: String, resource: RunQueryRequest): AltCallback = {
