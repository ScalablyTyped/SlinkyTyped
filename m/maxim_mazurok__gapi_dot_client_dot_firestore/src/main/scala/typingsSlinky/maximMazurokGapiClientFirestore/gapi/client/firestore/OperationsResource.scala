...
trait OperationsResource extends StObject {
  ...
  /**
    ...
    */
  def cancel(request: CallbackFields): Request[js.Object] = js.native
  ...
  def list(request: typingsSlinky.maximMazurokGapiClientFirestore.anon.Filter): Request[GoogleLongrunningListOperationsResponse] = js.native
}
