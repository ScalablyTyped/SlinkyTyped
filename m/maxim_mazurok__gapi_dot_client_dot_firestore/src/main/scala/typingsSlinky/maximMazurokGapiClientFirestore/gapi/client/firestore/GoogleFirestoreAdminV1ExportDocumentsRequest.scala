...
@js.native
trait GoogleFirestoreAdminV1ExportDocumentsRequest extends js.Object {
...
object GoogleFirestoreAdminV1ExportDocumentsRequest {
  ...
  @scala.inline
  def apply(): GoogleFirestoreAdminV1ExportDocumentsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleFirestoreAdminV1ExportDocumentsRequest]
  }
  
  @scala.inline
  implicit class GoogleFirestoreAdminV1ExportDocumentsRequestOps[Self <: GoogleFirestoreAdminV1ExportDocumentsRequest] (val x: Self) extends AnyVal {
