...
@js.native
trait GoogleFirestoreAdminV1ExportDocumentsMetadata extends js.Object {
...
object GoogleFirestoreAdminV1ExportDocumentsMetadata {
  ...
  @scala.inline
  implicit class GoogleFirestoreAdminV1ExportDocumentsMetadataOps[Self <: GoogleFirestoreAdminV1ExportDocumentsMetadata] (val x: Self) extends AnyVal {
