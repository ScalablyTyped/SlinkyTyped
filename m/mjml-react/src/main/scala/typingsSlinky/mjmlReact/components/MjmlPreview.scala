...
object MjmlPreview {
  ...
  implicit def make(companion: MjmlPreview.type): SharedBuilder_Children_486447409[typingsSlinky.mjmlReact.mod.MjmlPreview] = new SharedBuilder_Children_486447409[typingsSlinky.mjmlReact.mod.MjmlPreview](js.Array(this.component, js.Dictionary.empty))()
}
