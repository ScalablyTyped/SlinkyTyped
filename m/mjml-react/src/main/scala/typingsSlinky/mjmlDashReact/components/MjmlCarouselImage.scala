...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlCarouselImageProps
...
object MjmlCarouselImage
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlCarouselImage] {
