...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlBodyProps
...
object MjmlBody
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlBody] {
