...
object MjmlStyle
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlStyle] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlStyle](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
