...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlTableProps
...
object MjmlTable
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlTable] {
