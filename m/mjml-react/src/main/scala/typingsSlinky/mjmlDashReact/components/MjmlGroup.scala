...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlGroupProps
...
object MjmlGroup
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlGroup] {
