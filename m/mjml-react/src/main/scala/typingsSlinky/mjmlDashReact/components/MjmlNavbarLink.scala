...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlNavbarLinkProps
...
object MjmlNavbarLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlNavbarLink] {
