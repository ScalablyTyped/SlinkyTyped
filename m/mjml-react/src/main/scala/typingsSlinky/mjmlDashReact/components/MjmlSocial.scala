...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlSocialProps
...
object MjmlSocial
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlSocial] {
