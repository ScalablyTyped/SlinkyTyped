...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlNavbarProps
...
object MjmlNavbar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlNavbar] {
