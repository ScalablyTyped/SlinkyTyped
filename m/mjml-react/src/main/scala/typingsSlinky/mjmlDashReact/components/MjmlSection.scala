...
import typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlSectionProps
...
object MjmlSection
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.mjmlDashReact.mjmlDashReactMod.MjmlSection] {
