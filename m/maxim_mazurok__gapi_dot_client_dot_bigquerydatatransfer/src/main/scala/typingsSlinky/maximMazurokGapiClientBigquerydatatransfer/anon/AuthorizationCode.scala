...
import typingsSlinky.maximMazurokGapiClientBigquerydatatransfer.gapi.client.bigquerydatatransfer.TransferConfig
...
object AuthorizationCode {
  ...
  @scala.inline
  def apply(parent: String, resource: TransferConfig): AuthorizationCode = {
  ...
  implicit class AuthorizationCodeOps[Self <: AuthorizationCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TransferConfig): Self = this.set("resource", value.asInstanceOf[js.Any])
