...
@js.native
trait DataSourceIds extends StObject {
  ...
  var dataSourceIds: js.UndefOr[String | js.Array[String]] = js.native
...
object DataSourceIds {
  ...
  @scala.inline
  def apply(parent: String): DataSourceIds = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[DataSourceIds]
  }
  
  @scala.inline
  implicit class DataSourceIdsMutableBuilder[Self <: DataSourceIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourceIds(value: String | js.Array[String]): Self = StObject.set(x, "dataSourceIds", value.asInstanceOf[js.Any])
