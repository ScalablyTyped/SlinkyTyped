...
object DataSourceIds {
  ...
  @scala.inline
  implicit class DataSourceIdsOps[Self <: DataSourceIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourceIds(value: String | js.Array[String]): Self = this.set("dataSourceIds", value.asInstanceOf[js.Any])
