...
import typingsSlinky.maximMazurokGapiClientClassroom.anon.AccesstokenAlt
import typingsSlinky.maximMazurokGapiClientClassroom.anon.Alt
import typingsSlinky.maximMazurokGapiClientClassroom.anon.AltCallback
import typingsSlinky.maximMazurokGapiClientClassroom.anon.CourseWorkStates
