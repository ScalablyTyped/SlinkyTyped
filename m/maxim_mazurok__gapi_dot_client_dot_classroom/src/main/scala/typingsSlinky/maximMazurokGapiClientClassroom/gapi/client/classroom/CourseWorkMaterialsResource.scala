...
import typingsSlinky.maximMazurokGapiClientClassroom.anon.CallbackCourseId
import typingsSlinky.maximMazurokGapiClientClassroom.anon.CourseIdFields
import typingsSlinky.maximMazurokGapiClientClassroom.anon.CourseWorkMaterialStates
