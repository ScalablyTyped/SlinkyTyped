...
import typingsSlinky.maximMazurokGapiClientClassroom.anon.CourseWorkId
import typingsSlinky.maximMazurokGapiClientClassroom.anon.Late
import typingsSlinky.maximMazurokGapiClientClassroom.anon.PrettyPrint
import typingsSlinky.maximMazurokGapiClientClassroom.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientClassroom.anon.Resource
import typingsSlinky.maximMazurokGapiClientClassroom.anon.UpdateMask
import typingsSlinky.maximMazurokGapiClientClassroom.anon.UploadType
import typingsSlinky.maximMazurokGapiClientClassroom.anon.Uploadprotocol
