...
@js.native
trait RegistrationId extends StObject {
...
object RegistrationId {
  ...
  @scala.inline
  def apply(registrationId: String): RegistrationId = {
    val __obj = js.Dynamic.literal(registrationId = registrationId.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegistrationId]
  }
  
  @scala.inline
  implicit class RegistrationIdMutableBuilder[Self <: RegistrationId] (val x: Self) extends AnyVal {
