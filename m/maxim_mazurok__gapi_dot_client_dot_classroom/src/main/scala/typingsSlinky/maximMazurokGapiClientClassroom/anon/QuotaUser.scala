...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.StudentSubmission
...
object QuotaUser {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: StudentSubmission): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
