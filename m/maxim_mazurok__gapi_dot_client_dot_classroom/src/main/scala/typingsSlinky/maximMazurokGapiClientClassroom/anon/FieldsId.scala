...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.Topic
...
object FieldsId {
  ...
  @scala.inline
  def apply(courseId: String, id: String, resource: Topic): FieldsId = {
  ...
  implicit class FieldsIdMutableBuilder[Self <: FieldsId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Topic): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
