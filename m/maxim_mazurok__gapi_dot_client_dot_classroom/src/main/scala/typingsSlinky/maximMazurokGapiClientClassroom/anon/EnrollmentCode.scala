...
@js.native
trait EnrollmentCode extends js.Object {
...
object EnrollmentCode {
  ...
  @scala.inline
  implicit class EnrollmentCodeOps[Self <: EnrollmentCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Student): Self = this.set("resource", value.asInstanceOf[js.Any])
