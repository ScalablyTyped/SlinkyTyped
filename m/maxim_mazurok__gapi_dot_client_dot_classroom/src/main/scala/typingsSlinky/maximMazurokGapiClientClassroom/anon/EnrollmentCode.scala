...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.Student
...
@js.native
trait EnrollmentCode extends StObject {
  ...
  /** Request body */
  var resource: Student = js.native
...
object EnrollmentCode {
  
  @scala.inline
  def apply(courseId: String, resource: Student): EnrollmentCode = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[EnrollmentCode]
  }
  
  @scala.inline
  implicit class EnrollmentCodeMutableBuilder[Self <: EnrollmentCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Student): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
