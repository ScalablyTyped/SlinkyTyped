...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.ModifyCourseWorkAssigneesRequest
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(courseId: String, id: String, resource: ModifyCourseWorkAssigneesRequest): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ModifyCourseWorkAssigneesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
