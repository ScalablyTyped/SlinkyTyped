...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.CourseWorkMaterial
...
@js.native
trait CourseIdFields extends StObject {
  ...
  /** Request body */
  var resource: CourseWorkMaterial = js.native
...
object CourseIdFields {
  
  @scala.inline
  def apply(courseId: String, id: String, resource: CourseWorkMaterial): CourseIdFields = {
    ...
    __obj.asInstanceOf[CourseIdFields]
  }
  
  @scala.inline
  implicit class CourseIdFieldsMutableBuilder[Self <: CourseIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CourseWorkMaterial): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
