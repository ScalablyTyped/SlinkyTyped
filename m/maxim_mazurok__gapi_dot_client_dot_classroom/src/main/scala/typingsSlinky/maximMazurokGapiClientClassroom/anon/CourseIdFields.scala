...
@js.native
trait CourseIdFields extends js.Object {
...
object CourseIdFields {
  ...
  @scala.inline
  implicit class CourseIdFieldsOps[Self <: CourseIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CourseWorkMaterial): Self = this.set("resource", value.asInstanceOf[js.Any])
