...
trait CourseWorkMaterialStates extends StObject {
  ...
  var courseWorkMaterialStates: js.UndefOr[String | js.Array[String]] = js.native
  ...
  /**
    ...
    */
  var materialDriveId: js.UndefOr[String] = js.native
  ...
  var materialLink: js.UndefOr[String] = js.native
...
object CourseWorkMaterialStates {
  ...
  @scala.inline
  def apply(courseId: String): CourseWorkMaterialStates = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CourseWorkMaterialStates]
  }
  
  @scala.inline
  implicit class CourseWorkMaterialStatesMutableBuilder[Self <: CourseWorkMaterialStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCourseWorkMaterialStates(value: String | js.Array[String]): Self = StObject.set(x, "courseWorkMaterialStates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCourseWorkMaterialStatesUndefined: Self = StObject.set(x, "courseWorkMaterialStates", js.undefined)
    
    @scala.inline
    def setCourseWorkMaterialStatesVarargs(value: String*): Self = StObject.set(x, "courseWorkMaterialStates", js.Array(value :_*))
    ...
    @scala.inline
    def setMaterialDriveId(value: String): Self = StObject.set(x, "materialDriveId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaterialDriveIdUndefined: Self = StObject.set(x, "materialDriveId", js.undefined)
    
    @scala.inline
    def setMaterialLink(value: String): Self = StObject.set(x, "materialLink", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaterialLinkUndefined: Self = StObject.set(x, "materialLink", js.undefined)
