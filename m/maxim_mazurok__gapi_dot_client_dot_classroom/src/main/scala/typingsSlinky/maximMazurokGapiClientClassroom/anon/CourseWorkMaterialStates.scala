...
@js.native
trait CourseWorkMaterialStates extends js.Object {
...
object CourseWorkMaterialStates {
  ...
  @scala.inline
  implicit class CourseWorkMaterialStatesOps[Self <: CourseWorkMaterialStates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCourseWorkMaterialStatesVarargs(value: String*): Self = this.set("courseWorkMaterialStates", js.Array(value :_*))
    
    @scala.inline
    def setCourseWorkMaterialStates(value: String | js.Array[String]): Self = this.set("courseWorkMaterialStates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCourseWorkMaterialStates: Self = this.set("courseWorkMaterialStates", js.undefined)
    ...
    @scala.inline
    def setMaterialDriveId(value: String): Self = this.set("materialDriveId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaterialDriveId: Self = this.set("materialDriveId", js.undefined)
    
    @scala.inline
    def setMaterialLink(value: String): Self = this.set("materialLink", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaterialLink: Self = this.set("materialLink", js.undefined)
