...
@js.native
trait GuardianId extends StObject {
...
object GuardianId {
  ...
  @scala.inline
  def apply(guardianId: String, studentId: String): GuardianId = {
    val __obj = js.Dynamic.literal(guardianId = guardianId.asInstanceOf[js.Any], studentId = studentId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GuardianId]
  }
  
  @scala.inline
  implicit class GuardianIdMutableBuilder[Self <: GuardianId] (val x: Self) extends AnyVal {
