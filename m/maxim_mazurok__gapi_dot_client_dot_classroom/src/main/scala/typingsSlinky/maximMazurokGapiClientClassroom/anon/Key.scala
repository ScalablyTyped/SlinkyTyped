...
import typingsSlinky.maximMazurokGapiClientClassroom.gapi.client.classroom.Announcement
...
object Key {
  ...
  @scala.inline
  def apply(courseId: String, id: String, resource: Announcement): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Announcement): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
