...
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.Accesstoken
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.ByteSize
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.CorrectedQuery
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.DisplayName
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.FormattedSearchTime
...
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.NextPage
import typingsSlinky.maximMazurokGapiClientCustomsearch.anon.Template
    ...
    object customsearch {
      ...
      trait Search extends StObject {
        ...
        var context: js.UndefOr[
                /* import warning: importer.ImportType#apply c Unsupported type mapping: 
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientCustomsearch.maximMazurokGapiClientCustomsearchStrings.Search with TopLevel[js.Any]
              ] = js.native
