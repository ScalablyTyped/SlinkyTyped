...
import typingsSlinky.atMaterialIconDashToggle.atMaterialIconDashToggleStrings.`mdc-icon-toggle--disabled`
import typingsSlinky.atMaterialIconDashToggle.atMaterialIconDashToggleStrings.`mdc-icon-toggle`
