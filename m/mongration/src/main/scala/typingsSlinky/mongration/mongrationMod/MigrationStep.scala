package typingsSlinky.mongration.mongrationMod
...
object MigrationStep {
  ...
  def apply(
    id: String,
    up: (Db, js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit,
    down: (/* db */ Db, /* cb */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit = null
  ): MigrationStep = {
