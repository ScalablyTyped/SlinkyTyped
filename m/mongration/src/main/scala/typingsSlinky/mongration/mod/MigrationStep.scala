...
object MigrationStep {
  ...
  implicit class MigrationStepOps[Self <: MigrationStep] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUp(value: (Db, js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit): Self = this.set("up", js.Any.fromFunction2(value))
    
    @scala.inline
    def setDown(value: (/* db */ Db, /* cb */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit): Self = this.set("down", js.Any.fromFunction2(value))
