...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.mendixmodelsdk.mendixmodelsdkStrings.resuming
  - typingsSlinky.mendixmodelsdk.mendixmodelsdkStrings.provisioning
  - typingsSlinky.mendixmodelsdk.mendixmodelsdkStrings.started_
