...
- typingsSlinky.mendixmodelsdk.restMod.rest.IODataEntity because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsConsumedODataService, name, key */ @JSImport("mendixmodelsdk/dist/gen/rest", "rest.ODataEntity")
@js.native
