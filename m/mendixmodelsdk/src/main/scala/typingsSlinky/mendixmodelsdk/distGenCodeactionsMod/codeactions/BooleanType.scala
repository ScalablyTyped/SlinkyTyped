...
- typings.mendixmodelsdk.distGenCodeactionsMod.codeactions.IBooleanType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.BooleanType")
@js.native
