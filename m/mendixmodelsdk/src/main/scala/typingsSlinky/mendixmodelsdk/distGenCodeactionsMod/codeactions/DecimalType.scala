...
- typings.mendixmodelsdk.distGenCodeactionsMod.codeactions.IDecimalType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.DecimalType")
@js.native
