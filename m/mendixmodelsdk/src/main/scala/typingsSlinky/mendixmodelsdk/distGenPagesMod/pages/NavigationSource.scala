...
import typingsSlinky.mendixmodelsdk.distGenNavigationMod.navigation.INavigationProfile
import typingsSlinky.mendixmodelsdk.distGenNavigationMod.navigation.ProfileType
