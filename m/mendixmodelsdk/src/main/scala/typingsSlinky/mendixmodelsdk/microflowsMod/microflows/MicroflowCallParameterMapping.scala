...
@js.native
class MicroflowCallParameterMapping protected () extends Element[IModel] {
  def this(
    model: AbstractModel,
...
object MicroflowCallParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.MicroflowCallParameterMapping.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.MicroflowCallParameterMapping.createIn")
  @js.native
  def createIn(container: MicroflowCall): MicroflowCallParameterMapping = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.MicroflowCallParameterMapping.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.MicroflowCallParameterMapping.versionInfo")
  @js.native
