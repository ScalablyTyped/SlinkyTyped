...
object ShowHomePageAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ShowHomePageAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ShowHomePageAction.createIn")
  @js.native
  def createIn(container: ActionActivity): ShowHomePageAction = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ShowHomePageAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.ShowHomePageAction.versionInfo")
  @js.native
