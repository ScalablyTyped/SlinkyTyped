...
object BasicJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.BasicJavaActionParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.BasicJavaActionParameterValue.createIn")
  @js.native
  def createIn(container: JavaActionParameterMapping): BasicJavaActionParameterValue = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.BasicJavaActionParameterValue.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.BasicJavaActionParameterValue.versionInfo")
  @js.native
