...
class DataViewActionButton protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewActionButton {
  def this(
    model: AbstractModel,
...
object DataViewActionButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewActionButton = js.native
  /**
    * Creates and returns a new DataViewActionButton instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.ControlBar): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewActionButton = js.native
}
