...
object javascriptactions extends js.Object {
  ...
  class JavaScriptAction protected ()
    extends typingsSlinky.mendixmodelsdk.distGenJavascriptactionsMod.javascriptactions.JavaScriptAction {
    def this(
      model: AbstractModel,
  ...
  class JavaScriptActionParameter protected ()
    extends typingsSlinky.mendixmodelsdk.distGenJavascriptactionsMod.javascriptactions.JavaScriptActionParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NanoflowJavaScriptActionParameterType protected ()
    extends typingsSlinky.mendixmodelsdk.distGenJavascriptactionsMod.javascriptactions.NanoflowJavaScriptActionParameterType {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
