...
object projects extends js.Object {
  ...
  abstract class Document protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Document {
    def this(
      model: AbstractModel,
  ...
  class Folder protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Folder {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class FolderBase protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.FolderBase {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Module protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Module {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ModuleDocument protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.ModuleDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class OneTimeConversionMarker protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.OneTimeConversionMarker {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Project protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Project {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectConversion protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.ProjectConversion {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ProjectDocument protected ()
    extends typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.ProjectDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object Document extends js.Object {
    ...
    var versionInfo: typingsSlinky.mendixmodelsdk.distGenProjectsMod.StructureVersionInfo = js.native
  }
  ...
  object Folder extends js.Object {
    ...
    /**
      ...
      */
    def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Folder = js.native
  }
  ...
  object Module extends js.Object {
    ...
    /**
      ...
      */
    def createIn(container: IProject): typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.Module = js.native
  }
  ...
  object OneTimeConversionMarker extends js.Object {
    ...
    /**
      ...
      */
    def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.OneTimeConversionMarker = js.native
    /**
      * Creates and returns a new OneTimeConversionMarker instance in the SDK and on the server.
      ...
      */
    def createIn(container: typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.ProjectConversion): typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.OneTimeConversionMarker = js.native
  }
  ...
  object ProjectConversion extends js.Object {
    ...
    /**
      ...
      * Expects one argument, the IProject in which this unit is contained.
      */
    def createIn(container: IProject): typingsSlinky.mendixmodelsdk.distGenProjectsMod.projects.ProjectConversion = js.native
  }
