...
object texts extends js.Object {
  ...
  class SystemText protected ()
    extends typingsSlinky.mendixmodelsdk.distGenTextsMod.texts.SystemText {
    def this(
      model: AbstractModel,
  ...
  class SystemTextCollection protected ()
    extends typingsSlinky.mendixmodelsdk.distGenTextsMod.texts.SystemTextCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Text protected ()
    extends typingsSlinky.mendixmodelsdk.distGenTextsMod.texts.Text {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Translation protected ()
    extends typingsSlinky.mendixmodelsdk.distGenTextsMod.texts.Translation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
