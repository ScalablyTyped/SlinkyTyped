...
class NanoflowCall protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCall {
  def this(
    model: AbstractModel,
...
object NanoflowCall extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCall = js.native
  /**
    * Creates and returns a new NanoflowCall instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCallAction): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.NanoflowCall = js.native
}
