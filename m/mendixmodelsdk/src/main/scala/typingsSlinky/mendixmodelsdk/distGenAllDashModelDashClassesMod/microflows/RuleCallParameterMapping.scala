...
class RuleCallParameterMapping protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.RuleCallParameterMapping {
  def this(
    model: AbstractModel,
...
object RuleCallParameterMapping extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.RuleCallParameterMapping = js.native
  /**
    * Creates and returns a new RuleCallParameterMapping instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.RuleCall): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.RuleCallParameterMapping = js.native
}
