...
class Rule protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.Rule {
  def this(
    model: AbstractModel,
...
object Rule extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.Rule = js.native
}
