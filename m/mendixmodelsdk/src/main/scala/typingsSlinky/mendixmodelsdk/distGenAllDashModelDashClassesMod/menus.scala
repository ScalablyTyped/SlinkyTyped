...
object menus extends js.Object {
  ...
  class MenuDocument protected ()
    extends typingsSlinky.mendixmodelsdk.distGenMenusMod.menus.MenuDocument {
    def this(
      model: AbstractModel,
  ...
  class MenuItem protected ()
    extends typingsSlinky.mendixmodelsdk.distGenMenusMod.menus.MenuItem {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MenuItemCollection protected ()
    extends typingsSlinky.mendixmodelsdk.distGenMenusMod.menus.MenuItemCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class MenuItemContainer protected ()
    extends typingsSlinky.mendixmodelsdk.distGenMenusMod.menus.MenuItemContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
