...
class JavaScriptActionCallAction protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaScriptActionCallAction {
  def this(
    model: AbstractModel,
...
object JavaScriptActionCallAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaScriptActionCallAction = js.native
  /**
    * Creates and returns a new JavaScriptActionCallAction instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaScriptActionCallAction = js.native
}
