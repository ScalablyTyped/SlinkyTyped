...
class PageBreak protected ()
  extends typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.PageBreak {
  def this(
    model: AbstractModel,
...
object PageBreak extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.PageBreak = js.native
  /**
    * Creates and returns a new PageBreak instance in the SDK and on the server.
  ...
  ): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.PageBreak = js.native
  /**
    * Creates and returns a new PageBreak instance in the SDK and on the server.
    * The new PageBreak will be automatically stored in the 'widget' property
    * of the parent DropZone element passed as argument.
    */
  def createInDropZoneUnderWidget(container: typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DropZone): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.PageBreak = js.native
}
