...
class WidgetTranslation protected ()
  extends typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetTranslation {
  def this(
    model: AbstractModel,
...
object WidgetTranslation extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetTranslation = js.native
  /**
    * Creates and returns a new WidgetTranslation instance in the SDK and on the server.
    * The new WidgetTranslation will be automatically stored in the 'translations' property
    * of the parent WidgetValueType element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetValueType): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetTranslation = js.native
}
