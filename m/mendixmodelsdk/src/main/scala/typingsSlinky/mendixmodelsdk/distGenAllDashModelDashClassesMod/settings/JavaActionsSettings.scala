...
class JavaActionsSettings protected ()
  extends typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.JavaActionsSettings {
  def this(
    model: AbstractModel,
...
object JavaActionsSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.JavaActionsSettings = js.native
  /**
    * Creates and returns a new JavaActionsSettings instance in the SDK and on the server.
    ...
    *  6.9.0 to 7.23.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.ProjectSettings): typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.JavaActionsSettings = js.native
}
