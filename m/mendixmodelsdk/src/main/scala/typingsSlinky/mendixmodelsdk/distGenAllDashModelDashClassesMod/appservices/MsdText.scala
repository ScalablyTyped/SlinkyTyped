...
class MsdText protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.MsdText {
  def this(
    model: AbstractModel,
...
object MsdText extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.MsdText = js.native
  /**
    * Creates and returns a new MsdText instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.MsdEnumerationValue): typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.MsdText = js.native
}
