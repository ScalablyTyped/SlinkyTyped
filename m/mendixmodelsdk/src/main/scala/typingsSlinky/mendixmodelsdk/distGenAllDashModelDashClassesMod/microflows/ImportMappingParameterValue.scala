...
class ImportMappingParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ImportMappingParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingParameterValue = js.native
  /**
    * Creates and returns a new ImportMappingParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingParameterValue = js.native
  /**
    * Creates and returns a new ImportMappingParameterValue instance in the SDK and on the server.
    * The new ImportMappingParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingParameterValue = js.native
}
