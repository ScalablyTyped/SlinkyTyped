...
class Footer protected ()
  extends typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.Footer {
  def this(
    model: AbstractModel,
...
object Footer extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.Footer = js.native
  /**
    * Creates and returns a new Footer instance in the SDK and on the server.
  ...
  ): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.Footer = js.native
}
