...
class ConsumedODataService protected ()
  extends typingsSlinky.mendixmodelsdk.distGenRestMod.rest.ConsumedODataService {
  def this(
    model: AbstractModel,
...
object ConsumedODataService extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenRestMod.rest.ConsumedODataService = js.native
}
