...
class ProjectSettings protected ()
  extends typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.ProjectSettings {
  def this(
    model: AbstractModel,
...
object ProjectSettings extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IProject): typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.ProjectSettings = js.native
}
