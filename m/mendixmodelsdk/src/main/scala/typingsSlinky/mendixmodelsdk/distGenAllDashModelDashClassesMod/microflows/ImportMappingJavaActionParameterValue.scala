...
class ImportMappingJavaActionParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object ImportMappingJavaActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingJavaActionParameterValue = js.native
  /**
    * Creates and returns a new ImportMappingJavaActionParameterValue instance in the SDK and on the server.
    ...
    *  7.2.0 to 7.20.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingJavaActionParameterValue = js.native
}
