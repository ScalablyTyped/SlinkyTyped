...
object jsonstructures extends js.Object {
  ...
  class JsonElement protected ()
    extends typingsSlinky.mendixmodelsdk.distGenJsonstructuresMod.jsonstructures.JsonElement {
    def this(
      model: AbstractModel,
  ...
  class JsonStructure protected ()
    extends typingsSlinky.mendixmodelsdk.distGenJsonstructuresMod.jsonstructures.JsonStructure {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  object JsonElement extends js.Object {
    ...
    /**
      ...
      *  6.6.0 and higher
      */
    def createInElementUnderChildren(container: Element): typingsSlinky.mendixmodelsdk.distGenJsonstructuresMod.jsonstructures.JsonElement = js.native
    /**
      * Creates and returns a new JsonElement instance in the SDK and on the server.
