...
class EqualsToRuleInfo protected ()
  extends typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.EqualsToRuleInfo {
  def this(
    model: AbstractModel,
...
object EqualsToRuleInfo extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.EqualsToRuleInfo = js.native
  /**
    * Creates and returns a new EqualsToRuleInfo instance in the SDK and on the server.
    * The new EqualsToRuleInfo will be automatically stored in the 'ruleInfo' property
    * of the parent ValidationRule element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.ValidationRule): typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.EqualsToRuleInfo = js.native
}
