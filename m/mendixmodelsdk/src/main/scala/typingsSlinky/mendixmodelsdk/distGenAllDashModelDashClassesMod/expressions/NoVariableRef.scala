...
class NoVariableRef protected ()
  extends typingsSlinky.mendixmodelsdk.distGenExpressionsMod.expressions.NoVariableRef {
  def this(
    model: AbstractModel,
...
object NoVariableRef extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenExpressionsMod.expressions.NoVariableRef = js.native
  /**
    * Creates and returns a new NoVariableRef instance in the SDK and on the server.
    ...
    *  7.9.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenExpressionsMod.expressions.VariableRefExpression): typingsSlinky.mendixmodelsdk.distGenExpressionsMod.expressions.NoVariableRef = js.native
}
