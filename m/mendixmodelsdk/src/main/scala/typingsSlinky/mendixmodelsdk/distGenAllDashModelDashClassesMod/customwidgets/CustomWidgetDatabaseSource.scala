...
class CustomWidgetDatabaseSource protected ()
  extends typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetDatabaseSource {
  def this(
    model: AbstractModel,
...
object CustomWidgetDatabaseSource extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetDatabaseSource = js.native
  /**
    * Creates and returns a new CustomWidgetDatabaseSource instance in the SDK and on the server.
    ...
    *  8.5.0 and higher
    */
  def createInEntityWidgetUnderDataSource(container: EntityWidget): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetDatabaseSource = js.native
  /**
    * Creates and returns a new CustomWidgetDatabaseSource instance in the SDK and on the server.
    * The new CustomWidgetDatabaseSource will be automatically stored in the 'dataSource' property
    ...
    *  8.5.0 and higher
    */
  def createInWidgetValueUnderDataSource(container: typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetValue): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetDatabaseSource = js.native
}
