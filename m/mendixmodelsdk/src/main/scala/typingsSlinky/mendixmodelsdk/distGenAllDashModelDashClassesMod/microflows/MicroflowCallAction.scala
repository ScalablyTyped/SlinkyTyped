...
class MicroflowCallAction protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.MicroflowCallAction {
  def this(
    model: AbstractModel,
...
object MicroflowCallAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.MicroflowCallAction = js.native
  /**
    * Creates and returns a new MicroflowCallAction instance in the SDK and on the server.
    * The new MicroflowCallAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.MicroflowCallAction = js.native
}
