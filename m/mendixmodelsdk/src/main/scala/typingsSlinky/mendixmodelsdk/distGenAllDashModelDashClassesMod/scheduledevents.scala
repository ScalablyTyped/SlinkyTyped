...
object scheduledevents extends js.Object {
  @js.native
  class IntervalType ()
    extends typingsSlinky.mendixmodelsdk.distGenScheduledeventsMod.scheduledevents.IntervalType
  ...
  class ScheduledEvent protected ()
    extends typingsSlinky.mendixmodelsdk.distGenScheduledeventsMod.scheduledevents.ScheduledEvent {
    def this(
      model: AbstractModel,
  ...
  @js.native
  class TimeZoneEnum ()
    extends typingsSlinky.mendixmodelsdk.distGenScheduledeventsMod.scheduledevents.TimeZoneEnum
