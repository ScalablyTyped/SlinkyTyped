...
class ConsumedAppService protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.ConsumedAppService {
  def this(
    model: AbstractModel,
...
object ConsumedAppService extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenAppservicesMod.appservices.ConsumedAppService = js.native
}
