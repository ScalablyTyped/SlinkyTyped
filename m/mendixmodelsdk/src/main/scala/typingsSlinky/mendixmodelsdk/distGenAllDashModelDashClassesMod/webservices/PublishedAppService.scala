...
class PublishedAppService protected ()
  extends typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.PublishedAppService {
  def this(
    model: AbstractModel,
...
object PublishedAppService extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.PublishedAppService = js.native
}
