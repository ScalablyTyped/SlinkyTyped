...
class GridSortItem protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridSortItem {
  def this(
    model: AbstractModel,
...
object GridSortItem extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridSortItem = js.native
  /**
    * Creates and returns a new GridSortItem instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridSortBar): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridSortItem = js.native
}
