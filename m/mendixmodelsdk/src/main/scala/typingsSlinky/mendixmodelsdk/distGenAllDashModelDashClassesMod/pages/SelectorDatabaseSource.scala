...
class SelectorDatabaseSource protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SelectorDatabaseSource {
  def this(
    model: AbstractModel,
...
object SelectorDatabaseSource extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SelectorDatabaseSource = js.native
  /**
    * Creates and returns a new SelectorDatabaseSource instance in the SDK and on the server.
    ...
    *  6.1.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.AssociationWidget): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SelectorDatabaseSource = js.native
}
