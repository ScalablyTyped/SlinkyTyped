...
class BasicCodeActionParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.BasicCodeActionParameterValue {
  def this(
    model: AbstractModel,
...
object BasicCodeActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.BasicCodeActionParameterValue = js.native
  /**
    * Creates and returns a new BasicCodeActionParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.BasicCodeActionParameterValue = js.native
  /**
    * Creates and returns a new BasicCodeActionParameterValue instance in the SDK and on the server.
    * The new BasicCodeActionParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.BasicCodeActionParameterValue = js.native
}
