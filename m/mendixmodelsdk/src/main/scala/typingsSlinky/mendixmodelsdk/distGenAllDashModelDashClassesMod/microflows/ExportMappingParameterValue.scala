...
class ExportMappingParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ExportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ExportMappingParameterValue = js.native
  /**
    * Creates and returns a new ExportMappingParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ExportMappingParameterValue = js.native
  /**
    * Creates and returns a new ExportMappingParameterValue instance in the SDK and on the server.
    * The new ExportMappingParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ExportMappingParameterValue = js.native
}
