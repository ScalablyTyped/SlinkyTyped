...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationWidget")
@js.native
abstract class AssociationWidget protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.AssociationWidget {
  def this(
    model: AbstractModel,
