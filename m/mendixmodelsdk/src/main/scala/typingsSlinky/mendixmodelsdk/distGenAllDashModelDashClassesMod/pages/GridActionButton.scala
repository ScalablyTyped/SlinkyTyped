...
class GridActionButton protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridActionButton {
  def this(
    model: AbstractModel,
...
object GridActionButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridActionButton = js.native
  /**
    * Creates and returns a new GridActionButton instance in the SDK and on the server.
    * The new GridActionButton will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.ControlBar): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.GridActionButton = js.native
}
