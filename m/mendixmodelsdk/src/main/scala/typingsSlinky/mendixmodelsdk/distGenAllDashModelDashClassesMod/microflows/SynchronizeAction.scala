...
class SynchronizeAction protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.SynchronizeAction {
  def this(
    model: AbstractModel,
...
object SynchronizeAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.SynchronizeAction = js.native
  /**
    * Creates and returns a new SynchronizeAction instance in the SDK and on the server.
    ...
    *  7.22.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ActionActivity): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.SynchronizeAction = js.native
}
