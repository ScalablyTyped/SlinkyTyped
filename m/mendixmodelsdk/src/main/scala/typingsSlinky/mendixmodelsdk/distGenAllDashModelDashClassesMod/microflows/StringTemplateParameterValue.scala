...
class StringTemplateParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.StringTemplateParameterValue {
  def this(
    model: AbstractModel,
...
object StringTemplateParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.StringTemplateParameterValue = js.native
  /**
    * Creates and returns a new StringTemplateParameterValue instance in the SDK and on the server.
    ...
    *  8.4.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.StringTemplateParameterValue = js.native
  /**
    * Creates and returns a new StringTemplateParameterValue instance in the SDK and on the server.
    * The new StringTemplateParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.StringTemplateParameterValue = js.native
}
