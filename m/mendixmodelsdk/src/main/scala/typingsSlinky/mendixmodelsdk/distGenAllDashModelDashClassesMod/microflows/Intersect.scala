...
class Intersect protected ()
  extends typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.Intersect {
  def this(
    model: AbstractModel,
...
object Intersect extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.Intersect = js.native
  /**
    * Creates and returns a new Intersect instance in the SDK and on the server.
    * The new Intersect will be automatically stored in the 'operation' property
    * of the parent ListOperationAction element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ListOperationAction): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.Intersect = js.native
}
