...
class RetrievalQuery protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.RetrievalQuery {
  def this(
    model: AbstractModel,
...
object RetrievalQuery extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.RetrievalQuery = js.native
}
