...
class OnClickNothing protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.OnClickNothing {
  def this(
    model: AbstractModel,
...
object OnClickNothing extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.OnClickNothing = js.native
  /**
    * Creates and returns a new OnClickNothing instance in the SDK and on the server.
    ...
    *  6.0.0 to 7.17.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DynamicImageViewer): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.OnClickNothing = js.native
}
