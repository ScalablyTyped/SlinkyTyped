...
class DataViewSaveButton protected ()
  extends typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewSaveButton {
  def this(
    model: AbstractModel,
...
object DataViewSaveButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewSaveButton = js.native
  /**
    * Creates and returns a new DataViewSaveButton instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.ControlBar): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewSaveButton = js.native
}
