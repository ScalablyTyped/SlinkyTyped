...
class Language protected ()
  extends typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.Language {
  def this(
    model: AbstractModel,
...
object Language extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.Language = js.native
  /**
    * Creates and returns a new Language instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.LanguageSettings): typingsSlinky.mendixmodelsdk.distGenSettingsMod.settings.Language = js.native
}
