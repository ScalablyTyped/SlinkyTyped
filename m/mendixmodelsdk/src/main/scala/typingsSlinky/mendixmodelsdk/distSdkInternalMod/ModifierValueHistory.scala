...
import typingsSlinky.mendixmodelsdk.distSdkInternalVersionChecksMod.IModifierValueHistory
...
class ModifierValueHistory protected ()
  extends typingsSlinky.mendixmodelsdk.distSdkInternalVersionChecksMod.ModifierValueHistory {
