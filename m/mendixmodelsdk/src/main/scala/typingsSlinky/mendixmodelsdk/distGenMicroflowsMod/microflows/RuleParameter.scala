...
- typings.mendixmodelsdk.distGenMicroflowsMod.microflows.IRuleParameter because var conflicts: id, isLoaded, model, name, parameterType, structureTypeName, `type`, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/microflows", "microflows.RuleParameter")
@js.native
