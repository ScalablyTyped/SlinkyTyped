...
class HttpConfiguration protected () extends Element {
  ...
  /**
    ...
    */
  def newHttpMethod(): typingsSlinky.mendixmodelsdk.distGenServicesMod.services.HttpMethod = js.native
  def newHttpMethod(newValue: typingsSlinky.mendixmodelsdk.distGenServicesMod.services.HttpMethod): js.Any = js.native
