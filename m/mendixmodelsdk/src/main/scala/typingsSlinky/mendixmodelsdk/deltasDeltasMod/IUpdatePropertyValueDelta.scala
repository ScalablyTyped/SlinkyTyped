...
object IUpdatePropertyValueDelta {
  ...
  implicit class IUpdatePropertyValueDeltaOps[Self <: IUpdatePropertyValueDelta] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeltaType(value: UPDATE_PROPERTY_VALUE): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deltaType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMutator(value: Mutator): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mutator")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
