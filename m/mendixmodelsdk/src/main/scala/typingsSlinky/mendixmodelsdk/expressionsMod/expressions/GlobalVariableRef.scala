...
object GlobalVariableRef {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/expressions", "expressions.GlobalVariableRef.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/expressions", "expressions.GlobalVariableRef.createIn")
  @js.native
  def createIn(container: VariableRefExpression): GlobalVariableRef = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/expressions", "expressions.GlobalVariableRef.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/expressions", "expressions.GlobalVariableRef.versionInfo")
  @js.native
