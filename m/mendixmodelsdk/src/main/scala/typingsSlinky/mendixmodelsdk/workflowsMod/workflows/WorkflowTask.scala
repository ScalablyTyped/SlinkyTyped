...
- typingsSlinky.mendixmodelsdk.workflowsMod.workflows.IWorkflowTask because var conflicts: containerAsWorkflow, id, isLoaded, model, structureTypeName, unit. Inlined name, possibleOutcomes */ @JSImport("mendixmodelsdk/dist/gen/workflows", "workflows.WorkflowTask")
@js.native
