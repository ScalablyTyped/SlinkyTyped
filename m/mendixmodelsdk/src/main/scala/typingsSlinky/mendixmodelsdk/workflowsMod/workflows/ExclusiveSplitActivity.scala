...
- typingsSlinky.mendixmodelsdk.workflowsMod.workflows.IExclusiveSplitActivity because var conflicts: caption, containerAsFlow, id, isLoaded, model, structureTypeName, unit. Inlined outcomes */ @JSImport("mendixmodelsdk/dist/gen/workflows", "workflows.ExclusiveSplitActivity")
@js.native
