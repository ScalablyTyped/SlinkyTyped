...
- typingsSlinky.mendixmodelsdk.workflowsMod.workflows.IStartWorkflowActivity because var conflicts: containerAsWorkflow, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/workflows", "workflows.StartWorkflowActivity")
@js.native
