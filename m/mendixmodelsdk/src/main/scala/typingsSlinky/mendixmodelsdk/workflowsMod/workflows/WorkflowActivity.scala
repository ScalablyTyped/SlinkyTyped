...
- typingsSlinky.mendixmodelsdk.workflowsMod.workflows.IWorkflowActivity because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsWorkflow */ @JSImport("mendixmodelsdk/dist/gen/workflows", "workflows.WorkflowActivity")
@js.native
