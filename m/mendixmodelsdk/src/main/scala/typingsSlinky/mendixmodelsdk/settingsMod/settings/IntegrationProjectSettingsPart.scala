...
object IntegrationProjectSettingsPart {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.IntegrationProjectSettingsPart.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.IntegrationProjectSettingsPart.createIn")
  @js.native
  def createIn(container: ProjectSettings): IntegrationProjectSettingsPart = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.IntegrationProjectSettingsPart.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.IntegrationProjectSettingsPart.versionInfo")
  @js.native
