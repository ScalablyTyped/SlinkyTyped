...
object ConfigurationSettings {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.ConfigurationSettings.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/settings", "settings.ConfigurationSettings.createIn")
  @js.native
