...
- typings.mendixmodelsdk.distGenJavaactionsMod.javaactions.IBasicParameterType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined `type` */ @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.BasicParameterType")
@js.native
