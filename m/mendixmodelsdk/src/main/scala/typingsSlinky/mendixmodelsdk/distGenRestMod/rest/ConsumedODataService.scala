...
import typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.RemoteEntitySourceDocument
...
import typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.RequestProxyType
