...
- typingsSlinky.mendixmodelsdk.javaactionsMod.javaactions.IBasicParameterType because var conflicts: containerAsJavaActionParameter, id, isLoaded, model, structureTypeName, unit. Inlined `type` */ @JSImport("mendixmodelsdk/dist/gen/javaactions", "javaactions.BasicParameterType")
@js.native
