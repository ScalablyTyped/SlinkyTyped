...
@js.native
class ByIdReference[T /* <: typingsSlinky.mendixmodelsdk.elementsMod.AbstractElement */] protected ()
  ...
  /**
    ...
    */
  def this(owner: typingsSlinky.mendixmodelsdk.elementsMod.AbstractElement) = this()
}
