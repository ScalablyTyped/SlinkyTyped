...
object DatabaseSourceBase {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DatabaseSourceBase.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DatabaseSourceBase.versionInfo")
  @js.native
