...
- typingsSlinky.mendixmodelsdk.pagesMod.pages.IUserTaskTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/pages", "pages.UserTaskTemplateType")
@js.native
