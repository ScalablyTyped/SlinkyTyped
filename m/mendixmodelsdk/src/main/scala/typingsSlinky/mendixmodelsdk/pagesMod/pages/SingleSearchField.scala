...
object SingleSearchField {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.SingleSearchField.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.SingleSearchField.versionInfo")
  @js.native
