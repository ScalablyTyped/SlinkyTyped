...
- typingsSlinky.mendixmodelsdk.pagesMod.pages.ISelectPageTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/pages", "pages.SelectPageTemplateType")
@js.native
