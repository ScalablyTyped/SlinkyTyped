...
- typingsSlinky.mendixmodelsdk.pagesMod.pages.IEditPageTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/pages", "pages.EditPageTemplateType")
@js.native
