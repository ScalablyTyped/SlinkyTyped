...
object DataGridRemoveButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataGridRemoveButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataGridRemoveButton.createIn")
  @js.native
  def createIn(container: ControlBar): DataGridRemoveButton = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataGridRemoveButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataGridRemoveButton.versionInfo")
  @js.native
