...
- typingsSlinky.mendixmodelsdk.pagesMod.pages.ITemplateType because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsPageTemplate */ @JSImport("mendixmodelsdk/dist/gen/pages", "pages.TemplateType")
@js.native
