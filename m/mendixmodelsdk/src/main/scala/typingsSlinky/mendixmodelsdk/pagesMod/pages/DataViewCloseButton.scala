...
object DataViewCloseButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewCloseButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewCloseButton.createIn")
  @js.native
  def createIn(container: ControlBar): DataViewCloseButton = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewCloseButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.DataViewCloseButton.versionInfo")
  @js.native
