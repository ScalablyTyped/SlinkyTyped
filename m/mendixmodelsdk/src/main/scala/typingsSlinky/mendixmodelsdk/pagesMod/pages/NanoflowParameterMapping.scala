...
object NanoflowParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.NanoflowParameterMapping.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.NanoflowParameterMapping.createInCallNanoflowClientActionUnderParameterMappings")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/pages", "pages.NanoflowParameterMapping.createInNanoflowSourceUnderParameterMappings")
  @js.native
