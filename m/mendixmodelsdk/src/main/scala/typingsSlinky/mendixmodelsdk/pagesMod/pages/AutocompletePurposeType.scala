...
@js.native
class AutocompletePurposeType protected () extends AbstractEnum {
...
object AutocompletePurposeType {
  ...
  @js.native
  def CreditCardExpiration: AutocompletePurposeType = js.native
  ...
  @js.native
  def StreetAddress: AutocompletePurposeType = js.native
  ...
  @js.native
  def TelephoneLocal: AutocompletePurposeType = js.native
