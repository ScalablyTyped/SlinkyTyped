...
object PublishedResource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.PublishedResource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.PublishedResource.versionInfo")
  @js.native
