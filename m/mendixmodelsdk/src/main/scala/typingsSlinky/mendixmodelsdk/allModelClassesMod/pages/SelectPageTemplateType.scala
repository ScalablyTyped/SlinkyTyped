...
class SelectPageTemplateType protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.SelectPageTemplateType {
  def this(
    model: AbstractModel,
...
object SelectPageTemplateType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectPageTemplateType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectPageTemplateType.createIn")
  @js.native
