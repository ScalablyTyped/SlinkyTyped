...
class TypeParameter protected ()
  extends typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.TypeParameter = js.native
