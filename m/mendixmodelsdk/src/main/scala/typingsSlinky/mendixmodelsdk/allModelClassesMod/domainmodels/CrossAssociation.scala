...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.CrossAssociation")
@js.native
class CrossAssociation protected ()
  extends typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.CrossAssociation {
  def this(
    model: AbstractModel,
...
object CrossAssociation {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.CrossAssociation.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.CrossAssociation.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.CrossAssociation.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.CrossAssociation.versionInfo")
  @js.native
