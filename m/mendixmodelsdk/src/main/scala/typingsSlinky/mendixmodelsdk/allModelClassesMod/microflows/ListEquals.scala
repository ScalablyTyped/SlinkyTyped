...
class ListEquals protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ListEquals {
  def this(
    model: AbstractModel,
...
object ListEquals {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ListEquals.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ListEquals.createIn")
  @js.native
