...
class BreakEvent protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.BreakEvent {
  def this(
    model: AbstractModel,
...
object BreakEvent extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.BreakEvent = js.native
  ...
  /**
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.MicroflowObjectCollection): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.BreakEvent = js.native
