...
class ExportMappingParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ExportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExportMappingParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExportMappingParameterValue.createInJavaActionParameterMappingUnderParameterValue")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExportMappingParameterValue.createInJavaScriptActionParameterMappingUnderParameterValue")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExportMappingParameterValue.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExportMappingParameterValue.versionInfo")
  @js.native
