...
class SelectorXPathSource protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.SelectorXPathSource {
  def this(
    model: AbstractModel,
...
object SelectorXPathSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectorXPathSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectorXPathSource.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectorXPathSource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SelectorXPathSource.versionInfo")
  @js.native
