...
class InheritanceCase protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.InheritanceCase {
  def this(
    model: AbstractModel,
...
object InheritanceCase {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.InheritanceCase.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.InheritanceCase.createIn")
  @js.native
