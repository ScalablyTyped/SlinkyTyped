...
object DataMember {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.DataMember.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.DataMember.versionInfo")
  @js.native
