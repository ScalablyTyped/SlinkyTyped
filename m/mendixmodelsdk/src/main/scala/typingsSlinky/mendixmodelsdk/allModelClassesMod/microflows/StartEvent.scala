...
class StartEvent protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.StartEvent {
  def this(
    model: AbstractModel,
...
object StartEvent {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.StartEvent.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.StartEvent.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.StartEvent.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.StartEvent.versionInfo")
  @js.native
