...
class WidgetValidation protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.WidgetValidation {
  def this(
    model: AbstractModel,
...
object WidgetValidation {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.WidgetValidation.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.WidgetValidation.createInAttributeWidgetUnderValidation")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.WidgetValidation.createInReferenceSelectorUnderValidation")
  @js.native
