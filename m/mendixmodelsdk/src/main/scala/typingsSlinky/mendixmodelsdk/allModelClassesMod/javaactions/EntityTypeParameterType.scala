...
class EntityTypeParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.javaactionsMod.javaactions.EntityTypeParameterType {
  def this(
    model: AbstractModel,
...
object EntityTypeParameterType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.EntityTypeParameterType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.EntityTypeParameterType.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.EntityTypeParameterType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.EntityTypeParameterType.versionInfo")
  @js.native
