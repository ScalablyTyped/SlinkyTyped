...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridAddButton")
@js.native
class DataGridAddButton protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DataGridAddButton {
  def this(
    model: AbstractModel,
...
object DataGridAddButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridAddButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridAddButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridAddButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridAddButton.versionInfo")
  @js.native
