...
class EntityKey protected ()
  extends typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.EntityKey {
  def this(
    model: AbstractModel,
...
object EntityKey {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.EntityKey.create")
  @js.native
