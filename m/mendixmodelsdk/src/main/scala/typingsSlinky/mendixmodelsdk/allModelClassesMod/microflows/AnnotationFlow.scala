...
class AnnotationFlow protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.AnnotationFlow {
  def this(
    model: AbstractModel,
...
object AnnotationFlow {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.AnnotationFlow.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.AnnotationFlow.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.AnnotationFlow.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.AnnotationFlow.versionInfo")
  @js.native
