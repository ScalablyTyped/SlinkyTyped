...
class RuleSplitCondition protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.RuleSplitCondition {
  def this(
    model: AbstractModel,
...
object RuleSplitCondition {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.RuleSplitCondition.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.RuleSplitCondition.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.RuleSplitCondition.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.RuleSplitCondition.versionInfo")
  @js.native
