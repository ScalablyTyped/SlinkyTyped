...
class DropDownSearchField protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DropDownSearchField {
  def this(
    model: AbstractModel,
...
object DropDownSearchField {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DropDownSearchField.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DropDownSearchField.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DropDownSearchField.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DropDownSearchField.versionInfo")
  @js.native
