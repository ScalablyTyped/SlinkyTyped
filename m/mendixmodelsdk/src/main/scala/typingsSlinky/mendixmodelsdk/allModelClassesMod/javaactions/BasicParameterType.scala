...
class BasicParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.javaactionsMod.javaactions.BasicParameterType {
  def this(
    model: AbstractModel,
...
object BasicParameterType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.BasicParameterType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.BasicParameterType.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.BasicParameterType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.BasicParameterType.versionInfo")
  @js.native
