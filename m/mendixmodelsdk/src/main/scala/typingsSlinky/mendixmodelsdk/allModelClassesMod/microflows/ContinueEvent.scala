...
class ContinueEvent protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ContinueEvent {
  def this(
    model: AbstractModel,
...
object ContinueEvent {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ContinueEvent.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ContinueEvent.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ContinueEvent.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ContinueEvent.versionInfo")
  @js.native
