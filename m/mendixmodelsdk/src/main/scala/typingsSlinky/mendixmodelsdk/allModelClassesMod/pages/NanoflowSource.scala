...
class NanoflowSource protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.NanoflowSource {
  def this(
    model: AbstractModel,
...
object NanoflowSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.NanoflowSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.NanoflowSource.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.NanoflowSource.createInEntityWidgetUnderDataSource")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.NanoflowSource.createInWidgetValueUnderDataSource")
  @js.native
