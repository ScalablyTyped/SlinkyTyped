...
class DesignPropertyValue protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DesignPropertyValue {
  def this(
    model: AbstractModel,
...
object DesignPropertyValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DesignPropertyValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DesignPropertyValue.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DesignPropertyValue.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DesignPropertyValue.versionInfo")
  @js.native
