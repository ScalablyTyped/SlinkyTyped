...
class EntityTypeParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.EntityTypeParameterType {
  def this(
    model: AbstractModel,
...
object EntityTypeParameterType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "codeactions.EntityTypeParameterType.create")
  @js.native
