...
class AssociationDeleteBehavior protected ()
  extends typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationDeleteBehavior {
  def this(
    model: AbstractModel,
...
object AssociationDeleteBehavior {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.AssociationDeleteBehavior.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.AssociationDeleteBehavior.createIn")
  @js.native
