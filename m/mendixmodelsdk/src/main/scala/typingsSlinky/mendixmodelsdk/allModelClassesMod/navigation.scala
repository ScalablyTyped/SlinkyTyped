...
object navigation {
  ...
  class HomePage protected ()
    extends typingsSlinky.mendixmodelsdk.navigationMod.navigation.HomePage {
    def this(
      model: AbstractModel,
  ...
  class OfflineEntitySyncDownloadMode protected ()
    extends typingsSlinky.mendixmodelsdk.navigationMod.navigation.OfflineEntitySyncDownloadMode {
    def this(_name: String, lifeCycleInfo: ILifeCycle) = this()
  }
  ...
  class ProfileKind protected ()
    extends typingsSlinky.mendixmodelsdk.navigationMod.navigation.ProfileKind {
    def this(_name: String, lifeCycleInfo: ILifeCycle) = this()
  }
  object ProfileKind {
  ...
  class RoleBasedHomePage protected ()
    extends typingsSlinky.mendixmodelsdk.navigationMod.navigation.RoleBasedHomePage {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
