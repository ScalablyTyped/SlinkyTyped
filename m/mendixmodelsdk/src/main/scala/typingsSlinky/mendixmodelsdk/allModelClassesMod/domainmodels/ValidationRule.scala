...
class ValidationRule protected ()
  extends typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.ValidationRule {
  def this(
    model: AbstractModel,
...
object ValidationRule {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.ValidationRule.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.ValidationRule.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.ValidationRule.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.ValidationRule.versionInfo")
  @js.native
