...
object rest {
  ...
  class ODataRemoteAssociationSource protected ()
    extends typingsSlinky.mendixmodelsdk.restMod.rest.ODataRemoteAssociationSource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PublishedRestServiceOperation protected ()
    extends typingsSlinky.mendixmodelsdk.restMod.rest.PublishedRestServiceOperation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class RestOperationParameter protected ()
    extends typingsSlinky.mendixmodelsdk.restMod.rest.RestOperationParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
