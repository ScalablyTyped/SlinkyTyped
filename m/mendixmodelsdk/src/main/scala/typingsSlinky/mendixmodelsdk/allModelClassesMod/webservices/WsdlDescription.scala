...
class WsdlDescription protected ()
  extends typingsSlinky.mendixmodelsdk.webservicesMod.webservices.WsdlDescription {
  def this(
    model: AbstractModel,
...
object WsdlDescription {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.WsdlDescription.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.WsdlDescription.createInImportedWebServiceUnderWsdlDescription")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.WsdlDescription.createInMsdUnderWsdlDescription")
  @js.native
