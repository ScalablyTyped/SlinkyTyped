...
class ParameterizedEntityType protected ()
  extends typingsSlinky.mendixmodelsdk.javaactionsMod.javaactions.ParameterizedEntityType {
  def this(
    model: AbstractModel,
...
object ParameterizedEntityType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.createInJavaActionParameterUnderJavaType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.createInJavaActionUnderJavaReturnType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.createInListTypeUnderParameter")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ParameterizedEntityType.versionInfo")
  @js.native
