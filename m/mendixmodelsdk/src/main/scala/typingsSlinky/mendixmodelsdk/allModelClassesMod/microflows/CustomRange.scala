...
class CustomRange protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.CustomRange {
  def this(
    model: AbstractModel,
...
object CustomRange {
  ...
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.CustomRange = js.native
  ...
  @js.native
  def createInDatabaseRetrieveSourceUnderRange(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.DatabaseRetrieveSource): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.CustomRange = js.native
  ...
  @js.native
  def createInImportMappingCallUnderRange(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ImportMappingCall): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.CustomRange = js.native
