...
class TableRow protected ()
  extends typingsSlinky.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableRow {
  def this(
    model: AbstractModel,
...
object TableRow extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableRow = js.native
  /**
    * Creates and returns a new TableRow instance in the SDK and on the server.
    * The new TableRow will be automatically stored in the 'rows' property
    * of the parent Table element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.documenttemplatesMod.documenttemplates.Table): typingsSlinky.mendixmodelsdk.documenttemplatesMod.documenttemplates.TableRow = js.native
}
