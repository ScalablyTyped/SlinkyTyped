...
class ShowPageAction protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ShowPageAction {
  def this(
    model: AbstractModel,
...
object ShowPageAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowPageAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowPageAction.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowPageAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowPageAction.versionInfo")
  @js.native
