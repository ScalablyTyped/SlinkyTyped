...
class AssociationSource protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.AssociationSource {
  def this(
    model: AbstractModel,
...
object AssociationSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.createInEntityWidgetUnderDataSource")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.createInWidgetValueUnderDataSource")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.AssociationSource.versionInfo")
  @js.native
