...
class ODataEntity protected ()
  extends typingsSlinky.mendixmodelsdk.restMod.rest.ODataEntity {
  def this(
    model: AbstractModel,
...
object ODataEntity extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.restMod.rest.ODataEntity = js.native
  /**
    * Creates and returns a new ODataEntity instance in the SDK and on the server.
    ...
    *  7.18.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.restMod.rest.ConsumedODataService): typingsSlinky.mendixmodelsdk.restMod.rest.ODataEntity = js.native
}
