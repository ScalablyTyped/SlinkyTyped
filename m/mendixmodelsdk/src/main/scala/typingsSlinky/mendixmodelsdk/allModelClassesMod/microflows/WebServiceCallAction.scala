...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceCallAction")
@js.native
class WebServiceCallAction protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.WebServiceCallAction {
  def this(
    model: AbstractModel,
...
object WebServiceCallAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceCallAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceCallAction.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceCallAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceCallAction.versionInfo")
  @js.native
