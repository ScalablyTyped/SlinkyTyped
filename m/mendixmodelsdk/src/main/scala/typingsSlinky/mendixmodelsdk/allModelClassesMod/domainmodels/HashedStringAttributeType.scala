...
class HashedStringAttributeType protected ()
  extends typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.HashedStringAttributeType {
  def this(
    model: AbstractModel,
...
object HashedStringAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.HashedStringAttributeType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.HashedStringAttributeType.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.HashedStringAttributeType.createInAttributeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.HashedStringAttributeType.createInEntityKeyPartUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "domainmodels.HashedStringAttributeType.createInODataKeyPartUnderType")
  @js.native
