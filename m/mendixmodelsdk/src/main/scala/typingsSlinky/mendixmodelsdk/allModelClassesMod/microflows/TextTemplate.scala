...
class TextTemplate protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.TextTemplate {
  def this(
    model: AbstractModel,
...
object TextTemplate {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.TextTemplate.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.TextTemplate.createInPageSettingsUnderTitleOverride")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.TextTemplate.createInShowMessageActionUnderTemplate")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.TextTemplate.createInValidationFeedbackActionUnderFeedbackTemplate")
  @js.native
