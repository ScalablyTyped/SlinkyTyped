...
class DataViewActionButton protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DataViewActionButton {
  def this(
    model: AbstractModel,
...
object DataViewActionButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataViewActionButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataViewActionButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataViewActionButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataViewActionButton.versionInfo")
  @js.native
