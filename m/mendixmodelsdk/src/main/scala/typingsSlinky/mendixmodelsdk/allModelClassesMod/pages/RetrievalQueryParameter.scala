...
class RetrievalQueryParameter protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.RetrievalQueryParameter {
  def this(
    model: AbstractModel,
...
object RetrievalQueryParameter {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RetrievalQueryParameter.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.RetrievalQueryParameter.createIn")
  @js.native
