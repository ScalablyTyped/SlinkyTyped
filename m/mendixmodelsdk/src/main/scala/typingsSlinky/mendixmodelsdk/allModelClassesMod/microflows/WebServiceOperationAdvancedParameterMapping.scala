...
object WebServiceOperationAdvancedParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceOperationAdvancedParameterMapping.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceOperationAdvancedParameterMapping.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceOperationAdvancedParameterMapping.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.WebServiceOperationAdvancedParameterMapping.versionInfo")
  @js.native
