...
class ModelerSettings protected ()
  extends typingsSlinky.mendixmodelsdk.settingsMod.settings.ModelerSettings {
  def this(
    model: AbstractModel,
...
object ModelerSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.settingsMod.settings.ModelerSettings = js.native
  ...
  /**
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.settingsMod.settings.ProjectSettings): typingsSlinky.mendixmodelsdk.settingsMod.settings.ModelerSettings = js.native
