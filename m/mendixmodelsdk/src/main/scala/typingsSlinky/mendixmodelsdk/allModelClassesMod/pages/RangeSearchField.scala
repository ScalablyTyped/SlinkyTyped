...
class RangeSearchField protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.RangeSearchField {
  def this(
    model: AbstractModel,
...
object RangeSearchField extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.pagesMod.pages.RangeSearchField = js.native
  /**
    * Creates and returns a new RangeSearchField instance in the SDK and on the server.
    * The new RangeSearchField will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.pagesMod.pages.ControlBar): typingsSlinky.mendixmodelsdk.pagesMod.pages.RangeSearchField = js.native
}
