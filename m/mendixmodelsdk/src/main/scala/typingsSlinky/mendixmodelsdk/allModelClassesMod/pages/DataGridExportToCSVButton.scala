...
class DataGridExportToCSVButton protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DataGridExportToCSVButton {
  def this(
    model: AbstractModel,
...
object DataGridExportToCSVButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridExportToCSVButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridExportToCSVButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridExportToCSVButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DataGridExportToCSVButton.versionInfo")
  @js.native
