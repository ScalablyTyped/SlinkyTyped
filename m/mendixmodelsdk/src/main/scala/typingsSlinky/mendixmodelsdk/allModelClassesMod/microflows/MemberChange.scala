...
class MemberChange protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.MemberChange {
  def this(
    model: AbstractModel,
...
object MemberChange {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.MemberChange.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.MemberChange.createIn")
  @js.native
