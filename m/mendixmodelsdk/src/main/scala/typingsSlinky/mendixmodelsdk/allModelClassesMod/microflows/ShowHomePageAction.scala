...
class ShowHomePageAction protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ShowHomePageAction {
  def this(
    model: AbstractModel,
...
object ShowHomePageAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowHomePageAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowHomePageAction.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowHomePageAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ShowHomePageAction.versionInfo")
  @js.native
