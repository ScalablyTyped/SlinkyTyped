...
class NanoflowParameter protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.NanoflowParameter {
  def this(
    model: AbstractModel,
...
object NanoflowParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.NanoflowParameter = js.native
