...
class DropDownButtonItem protected ()
  extends typingsSlinky.mendixmodelsdk.pagesMod.pages.DropDownButtonItem {
  def this(
    model: AbstractModel,
...
object DropDownButtonItem {
  ...
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.pagesMod.pages.DropDownButtonItem = js.native
  ...
  @js.native
  def createIn(container: typingsSlinky.mendixmodelsdk.pagesMod.pages.DropDownButton): typingsSlinky.mendixmodelsdk.pagesMod.pages.DropDownButtonItem = js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.DropDownButtonItem.versionInfo")
  @js.native
