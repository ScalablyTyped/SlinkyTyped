...
class ImportMappingParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.javaactionsMod.javaactions.ImportMappingParameterType {
  def this(
    model: AbstractModel,
...
object ImportMappingParameterType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ImportMappingParameterType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "javaactions.ImportMappingParameterType.createIn")
  @js.native
