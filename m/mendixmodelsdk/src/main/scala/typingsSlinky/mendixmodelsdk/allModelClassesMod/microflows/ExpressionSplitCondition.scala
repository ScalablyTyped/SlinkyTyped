...
class ExpressionSplitCondition protected ()
  extends typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ExpressionSplitCondition {
  def this(
    model: AbstractModel,
...
object ExpressionSplitCondition {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExpressionSplitCondition.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExpressionSplitCondition.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExpressionSplitCondition.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.ExpressionSplitCondition.versionInfo")
  @js.native
