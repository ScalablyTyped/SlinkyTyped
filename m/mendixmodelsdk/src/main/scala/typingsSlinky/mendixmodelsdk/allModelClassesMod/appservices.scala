...
object appservices {
  ...
  class MsdEnumeration protected ()
    extends typingsSlinky.mendixmodelsdk.appservicesMod.appservices.MsdEnumeration {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MsdMicroflow protected ()
    extends typingsSlinky.mendixmodelsdk.appservicesMod.appservices.MsdMicroflow {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
