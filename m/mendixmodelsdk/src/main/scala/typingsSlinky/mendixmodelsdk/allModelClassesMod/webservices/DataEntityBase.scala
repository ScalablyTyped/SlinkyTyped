...
object DataEntityBase {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.DataEntityBase.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/all-model-classes", "webservices.DataEntityBase.versionInfo")
  @js.native
