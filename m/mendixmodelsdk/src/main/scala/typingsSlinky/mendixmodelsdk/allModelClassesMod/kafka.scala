...
object kafka extends js.Object {
  ...
  class ConsumedKafkaService protected ()
    extends typingsSlinky.mendixmodelsdk.kafkaMod.kafka.ConsumedKafkaService {
    def this(
      model: AbstractModel,
  ...
  class KafkaMappedValue protected ()
    extends typingsSlinky.mendixmodelsdk.kafkaMod.kafka.KafkaMappedValue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class KafkaRemoteEntitySource protected ()
    extends typingsSlinky.mendixmodelsdk.kafkaMod.kafka.KafkaRemoteEntitySource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
