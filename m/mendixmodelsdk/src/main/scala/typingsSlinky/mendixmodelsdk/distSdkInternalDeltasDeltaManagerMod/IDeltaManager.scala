package typingsSlinky.mendixmodelsdk.distSdkInternalDeltasDeltaManagerMod
...
import typingsSlinky.mendixmodelsdk.distSdkInternalDeltasTransactionManagerMod.Transaction
