...
class Version protected ()
  extends typingsSlinky.mendixmodelsdk.distSdkInternalMod.Version {
...
object Version extends js.Object {
  ...
  /**
    ...
    */
  def parse(versionString: String): typingsSlinky.mendixmodelsdk.distSdkInternalVersionChecksMod.Version = js.native
}
