...
class DataViewControlBar protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.DataViewControlBar {
  def this(
    model: AbstractModel,
...
object DataViewControlBar extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewControlBar = js.native
  /**
    * Creates and returns a new DataViewControlBar instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataView): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewControlBar = js.native
}
