...
class PublishedODataService protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.rest.PublishedODataService {
  def this(
    model: AbstractModel,
...
object PublishedODataService extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenRestMod.rest.PublishedODataService = js.native
}
