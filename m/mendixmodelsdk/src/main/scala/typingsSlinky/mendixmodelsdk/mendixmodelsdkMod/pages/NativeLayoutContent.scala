...
class NativeLayoutContent protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.NativeLayoutContent {
  def this(
...
object NativeLayoutContent extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.NativeLayoutContent = js.native
  /**
    * Creates and returns a new NativeLayoutContent instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.Layout): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.NativeLayoutContent = js.native
}
