...
class BasicParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.javaactions.BasicParameterType {
  def this(
    model: AbstractModel,
...
object BasicParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.BasicParameterType = js.native
  /**
    * Creates and returns a new BasicParameterType instance in the SDK and on the server.
    ...
    *  6.7.0 to 7.20.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.JavaActionParameter): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.BasicParameterType = js.native
}
