...
class PublishedRestServiceOperation protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.rest.PublishedRestServiceOperation {
  def this(
    model: AbstractModel,
...
object PublishedRestServiceOperation extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenRestMod.rest.PublishedRestServiceOperation = js.native
  /**
    * Creates and returns a new PublishedRestServiceOperation instance in the SDK and on the server.
    ...
    *  7.7.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenRestMod.rest.PublishedRestServiceResource): typingsSlinky.mendixmodelsdk.distGenRestMod.rest.PublishedRestServiceOperation = js.native
}
