...
class DataSetObjectConstraint protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.datasets.DataSetObjectConstraint {
  def this(
    model: AbstractModel,
...
object DataSetObjectConstraint extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetObjectConstraint = js.native
  /**
    * Creates and returns a new DataSetObjectConstraint instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetParameter): typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetObjectConstraint = js.native
}
