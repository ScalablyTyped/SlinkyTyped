...
class TypeParameter protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.javaactions.TypeParameter {
  def this(
...
object TypeParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.TypeParameter = js.native
  /**
    * Creates and returns a new TypeParameter instance in the SDK and on the server.
    ...
    *  6.6.0 to 7.20.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.JavaAction): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.TypeParameter = js.native
}
