...
class EntityTypeJavaActionParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.EntityTypeJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object EntityTypeJavaActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeJavaActionParameterValue instance in the SDK and on the server.
    ...
    *  6.8.0 to 7.20.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = js.native
}
