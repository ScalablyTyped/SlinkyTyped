...
object nativepages extends js.Object {
  ...
  class BottomBarItem protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.BottomBarItem {
    def this(
  ...
  class NativeLayout protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.NativeLayout {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativeLayoutCallArgument protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.NativeLayoutCallArgument {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePage protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.NativePage {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePageClientAction protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.NativePageClientAction {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePlaceholder protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.nativepages.NativePlaceholder {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
