...
class ExposedAssociation protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.messagedefinitions.ExposedAssociation {
  def this(
...
object ExposedAssociation extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedAssociation = js.native
  /**
    * Creates and returns a new ExposedAssociation instance in the SDK and on the server.
    ...
    *  7.6.0 and higher
    */
  def createInElementUnderChildren(container: typingsSlinky.mendixmodelsdk.distGenMappingsMod.mappings.Element): typingsSlinky.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedAssociation = js.native
  /**
    * Creates and returns a new ExposedAssociation instance in the SDK and on the server.
    ...
    *  7.6.0 and higher
    */
  def createInJsonStructureUnderElements(container: JsonStructure): typingsSlinky.mendixmodelsdk.distGenMessagedefinitionsMod.messagedefinitions.ExposedAssociation = js.native
}
