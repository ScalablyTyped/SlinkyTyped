...
class VersionedService protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.webservices.VersionedService {
  def this(
    model: AbstractModel,
...
object VersionedService extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.VersionedService = js.native
  /**
    * Creates and returns a new VersionedService instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.PublishedServiceBase): typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.VersionedService = js.native
}
