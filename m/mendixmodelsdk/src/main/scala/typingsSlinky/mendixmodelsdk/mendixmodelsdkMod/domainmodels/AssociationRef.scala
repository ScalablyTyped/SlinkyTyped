...
class AssociationRef protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.domainmodels.AssociationRef {
  def this(
    model: AbstractModel,
...
object AssociationRef extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDomainmodelsMod.domainmodels.AssociationRef = js.native
}
