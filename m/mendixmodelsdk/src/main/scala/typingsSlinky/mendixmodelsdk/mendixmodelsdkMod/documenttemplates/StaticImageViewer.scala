...
class StaticImageViewer protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.documenttemplates.StaticImageViewer {
  def this(
    model: AbstractModel,
...
object StaticImageViewer extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.StaticImageViewer = js.native
  /**
    * Creates and returns a new StaticImageViewer instance in the SDK and on the server.
  ...
  ): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.StaticImageViewer = js.native
  /**
    * Creates and returns a new StaticImageViewer instance in the SDK and on the server.
    * The new StaticImageViewer will be automatically stored in the 'widget' property
    * of the parent DropZone element passed as argument.
    */
  def createInDropZoneUnderWidget(container: typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DropZone): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.StaticImageViewer = js.native
}
