...
class EntityTypeCodeActionParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.EntityTypeCodeActionParameterValue {
  def this(
    model: AbstractModel,
...
object EntityTypeCodeActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeCodeActionParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeCodeActionParameterValue instance in the SDK and on the server.
    * The new EntityTypeCodeActionParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
}
