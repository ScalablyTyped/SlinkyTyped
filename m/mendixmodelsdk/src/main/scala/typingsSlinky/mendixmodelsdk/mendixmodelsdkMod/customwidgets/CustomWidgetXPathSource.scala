...
class CustomWidgetXPathSource protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.customwidgets.CustomWidgetXPathSource {
  def this(
    model: AbstractModel,
...
object CustomWidgetXPathSource extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetXPathSource = js.native
  /**
    * Creates and returns a new CustomWidgetXPathSource instance in the SDK and on the server.
    ...
    *  8.5.0 and higher
    */
  def createInEntityWidgetUnderDataSource(container: EntityWidget): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetXPathSource = js.native
  /**
    * Creates and returns a new CustomWidgetXPathSource instance in the SDK and on the server.
    * The new CustomWidgetXPathSource will be automatically stored in the 'dataSource' property
    ...
    *  8.5.0 and higher
    */
  def createInWidgetValueUnderDataSource(container: typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.WidgetValue): typingsSlinky.mendixmodelsdk.distGenCustomwidgetsMod.customwidgets.CustomWidgetXPathSource = js.native
}
