...
class LayoutGridRow protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.LayoutGridRow {
  def this(
    model: AbstractModel,
...
object LayoutGridRow extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutGridRow = js.native
  /**
    * Creates and returns a new LayoutGridRow instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutGrid): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutGridRow = js.native
}
