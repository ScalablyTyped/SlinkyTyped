...
class DesignPropertyValue protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.DesignPropertyValue {
  def this(
    model: AbstractModel,
...
object DesignPropertyValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DesignPropertyValue = js.native
  /**
    * Creates and returns a new DesignPropertyValue instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.Appearance): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DesignPropertyValue = js.native
}
