...
class MicroflowParameterMapping protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.MicroflowParameterMapping {
  def this(
    model: AbstractModel,
...
object MicroflowParameterMapping extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.MicroflowParameterMapping = js.native
  /**
    * Creates and returns a new MicroflowParameterMapping instance in the SDK and on the server.
    ...
    *  7.19.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.MicroflowSettings): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.MicroflowParameterMapping = js.native
}
