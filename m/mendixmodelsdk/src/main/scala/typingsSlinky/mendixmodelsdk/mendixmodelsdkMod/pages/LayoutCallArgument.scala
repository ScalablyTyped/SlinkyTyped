...
class LayoutCallArgument protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.LayoutCallArgument {
  def this(
...
object LayoutCallArgument extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutCallArgument = js.native
  /**
    * Creates and returns a new LayoutCallArgument instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutCall): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.LayoutCallArgument = js.native
}
