...
class FileDocumentExport protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.FileDocumentExport {
  def this(
    model: AbstractModel,
...
object FileDocumentExport extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.FileDocumentExport = js.native
  /**
    * Creates and returns a new FileDocumentExport instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ExportXmlAction): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.FileDocumentExport = js.native
}
