...
class DataViewCloseButton protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.DataViewCloseButton {
  def this(
    model: AbstractModel,
...
object DataViewCloseButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewCloseButton = js.native
  /**
    * Creates and returns a new DataViewCloseButton instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.ControlBar): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DataViewCloseButton = js.native
}
