...
class ImportMappingCall protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.ImportMappingCall {
  def this(
    model: AbstractModel,
...
object ImportMappingCall extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingCall = js.native
  /**
    * Creates and returns a new ImportMappingCall instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ResultHandling): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.ImportMappingCall = js.native
}
