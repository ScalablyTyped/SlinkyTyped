...
object enumerations extends js.Object {
  ...
  class Condition protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.enumerations.Condition {
    def this(
  ...
  class Enumeration protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.enumerations.Enumeration {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class EnumerationValue protected ()
    extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.enumerations.EnumerationValue {
    def this(
      model: typingsSlinky.mendixmodelsdk.distSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
