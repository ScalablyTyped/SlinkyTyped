...
class SnippetCall protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.SnippetCall {
  def this(
...
object SnippetCall extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SnippetCall = js.native
  /**
    * Creates and returns a new SnippetCall instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SnippetCallWidget): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.SnippetCall = js.native
}
