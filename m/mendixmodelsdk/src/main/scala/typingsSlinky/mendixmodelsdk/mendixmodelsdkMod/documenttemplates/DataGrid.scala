...
class DataGrid protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.documenttemplates.DataGrid {
  def this(
    model: AbstractModel,
...
object DataGrid extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGrid = js.native
  /**
    * Creates and returns a new DataGrid instance in the SDK and on the server.
  ...
  ): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGrid = js.native
  /**
    * Creates and returns a new DataGrid instance in the SDK and on the server.
    * The new DataGrid will be automatically stored in the 'widget' property
    * of the parent DropZone element passed as argument.
    */
  def createInDropZoneUnderWidget(container: typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DropZone): typingsSlinky.mendixmodelsdk.distGenDocumenttemplatesMod.documenttemplates.DataGrid = js.native
}
