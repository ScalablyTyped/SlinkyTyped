...
class EntityTypeParameterType protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.javaactions.EntityTypeParameterType {
  def this(
...
object EntityTypeParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.EntityTypeParameterType = js.native
  /**
    * Creates and returns a new EntityTypeParameterType instance in the SDK and on the server.
    ...
    *  6.7.0 to 7.20.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.JavaActionParameter): typingsSlinky.mendixmodelsdk.distGenJavaactionsMod.javaactions.EntityTypeParameterType = js.native
}
