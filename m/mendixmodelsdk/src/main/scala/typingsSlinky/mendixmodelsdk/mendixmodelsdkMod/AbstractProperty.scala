...
abstract class AbstractProperty[T, P] protected ()
  extends typingsSlinky.mendixmodelsdk.distSdkInternalPropertiesMod.AbstractProperty[T, P] {
  /**
  ...
  def this(
    ...
    parent: typingsSlinky.mendixmodelsdk.distSdkInternalStructuresMod.Structure,
    name: String,
    initialValue: T,
    moreArgs: js.Any*
  ) = this()
