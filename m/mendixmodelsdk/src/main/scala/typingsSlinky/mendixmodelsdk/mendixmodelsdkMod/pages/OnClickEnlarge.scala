...
class OnClickEnlarge protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.OnClickEnlarge {
  def this(
...
object OnClickEnlarge extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.OnClickEnlarge = js.native
  /**
    * Creates and returns a new OnClickEnlarge instance in the SDK and on the server.
    ...
    *  6.0.0 to 7.17.0
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.DynamicImageViewer): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.OnClickEnlarge = js.native
}
