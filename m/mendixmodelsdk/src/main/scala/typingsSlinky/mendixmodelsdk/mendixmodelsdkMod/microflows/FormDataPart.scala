...
class FormDataPart protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.FormDataPart {
  def this(
...
object FormDataPart extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataPart = js.native
  /**
    * Creates and returns a new FormDataPart instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataRequestHandling): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.FormDataPart = js.native
}
