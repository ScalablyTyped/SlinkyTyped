...
class DataSetConstraintAccess protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.datasets.DataSetConstraintAccess {
  def this(
    model: AbstractModel,
...
object DataSetConstraintAccess extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetConstraintAccess = js.native
  /**
    * Creates and returns a new DataSetConstraintAccess instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetParameterAccess): typingsSlinky.mendixmodelsdk.distGenDatasetsMod.datasets.DataSetConstraintAccess = js.native
}
