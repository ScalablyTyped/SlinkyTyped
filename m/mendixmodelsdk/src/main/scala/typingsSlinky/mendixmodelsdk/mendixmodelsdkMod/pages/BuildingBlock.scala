...
class BuildingBlock protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.pages.BuildingBlock {
  def this(
    model: AbstractModel,
...
object BuildingBlock extends js.Object {
  ...
  /**
    ...
    */
  def createIn(container: IFolderBase): typingsSlinky.mendixmodelsdk.distGenPagesMod.pages.BuildingBlock = js.native
}
