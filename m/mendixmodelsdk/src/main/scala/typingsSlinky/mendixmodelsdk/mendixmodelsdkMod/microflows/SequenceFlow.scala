...
class SequenceFlow protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.microflows.SequenceFlow {
  def this(
    model: AbstractModel,
...
object SequenceFlow extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow = js.native
  /**
    * Creates and returns a new SequenceFlow instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.MicroflowBase): typingsSlinky.mendixmodelsdk.distGenMicroflowsMod.microflows.SequenceFlow = js.native
}
