...
class SystemIdDataAttribute protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.webservices.SystemIdDataAttribute {
  def this(
...
object SystemIdDataAttribute extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.SystemIdDataAttribute = js.native
  /**
    * Creates and returns a new SystemIdDataAttribute instance in the SDK and on the server.
    ...
    *  6.7.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.DataEntityBase): typingsSlinky.mendixmodelsdk.distGenWebservicesMod.webservices.SystemIdDataAttribute = js.native
}
