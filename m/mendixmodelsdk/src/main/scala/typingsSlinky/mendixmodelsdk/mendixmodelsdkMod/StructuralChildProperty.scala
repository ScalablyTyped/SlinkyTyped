...
class StructuralChildProperty[T /* <: IStructuralUnit | IModelUnit */] protected ()
  extends typingsSlinky.mendixmodelsdk.distSdkInternalPropertiesMod.StructuralChildProperty[T] {
  def this(
    declaredOn: IStructureClass,
    parent: typingsSlinky.mendixmodelsdk.distSdkInternalUnitsMod.StructuralUnit,
    name: String
  ) = this()
  def this(
    declaredOn: IStructureClass,
