...
class BasicReportColumn protected ()
  extends typingsSlinky.mendixmodelsdk.distGenAllDashModelDashClassesMod.reports.BasicReportColumn {
  def this(
    model: AbstractModel,
...
object BasicReportColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.distGenReportsMod.reports.BasicReportColumn = js.native
  /**
    * Creates and returns a new BasicReportColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.distGenReportsMod.reports.BasicReport): typingsSlinky.mendixmodelsdk.distGenReportsMod.reports.BasicReportColumn = js.native
}
