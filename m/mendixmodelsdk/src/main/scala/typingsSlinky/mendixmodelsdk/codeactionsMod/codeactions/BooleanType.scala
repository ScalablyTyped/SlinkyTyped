...
- typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.IBooleanType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.BooleanType")
@js.native
