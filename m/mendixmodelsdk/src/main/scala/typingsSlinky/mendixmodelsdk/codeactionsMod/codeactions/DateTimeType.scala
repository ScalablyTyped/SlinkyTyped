...
- typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.IDateTimeType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.DateTimeType")
@js.native
...
object DateTimeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.DateTimeType.versionInfo")
  @js.native
