...
- typingsSlinky.mendixmodelsdk.codeactionsMod.codeactions.IIntegerType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.IntegerType")
@js.native
...
object IntegerType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.IntegerType.versionInfo")
  @js.native
