...
object scheduledeventsMod {
  ...
  object scheduledevents {
    ...
    - typingsSlinky.mendixmodelsdk.scheduledeventsMod.scheduledevents.IScheduledEvent because var conflicts: containerAsFolderBase, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/scheduledevents", "scheduledevents.ScheduledEvent")
    @js.native
