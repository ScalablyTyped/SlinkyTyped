...
/**
  ...
  */
@JSImport("mendixmodelsdk", "microflows.ChangeListAction")
@js.native
class ChangeListAction protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.ChangeListAction {
  def this(
    model: AbstractModel,
...
object ChangeListAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeListAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeListAction.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeListAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeListAction.versionInfo")
  @js.native
