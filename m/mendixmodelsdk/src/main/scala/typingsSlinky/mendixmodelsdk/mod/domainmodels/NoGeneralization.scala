...
object NoGeneralization {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.NoGeneralization.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.NoGeneralization.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.NoGeneralization.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.NoGeneralization.versionInfo")
  @js.native
