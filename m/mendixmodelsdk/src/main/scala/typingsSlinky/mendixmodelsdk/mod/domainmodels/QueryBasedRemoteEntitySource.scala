...
object QueryBasedRemoteEntitySource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.QueryBasedRemoteEntitySource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.QueryBasedRemoteEntitySource.versionInfo")
  @js.native
