...
class GridSelectAllButton protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.GridSelectAllButton {
  def this(
    model: AbstractModel,
...
object GridSelectAllButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSelectAllButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSelectAllButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSelectAllButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSelectAllButton.versionInfo")
  @js.native
