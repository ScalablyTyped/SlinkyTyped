...
class DesignPropertyValue protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.DesignPropertyValue {
  def this(
    model: AbstractModel,
...
object DesignPropertyValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DesignPropertyValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DesignPropertyValue.createIn")
  @js.native
