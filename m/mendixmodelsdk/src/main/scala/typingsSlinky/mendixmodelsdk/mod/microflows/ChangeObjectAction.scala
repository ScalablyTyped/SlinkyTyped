...
class ChangeObjectAction protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.ChangeObjectAction {
  def this(
    model: AbstractModel,
...
object ChangeObjectAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeObjectAction.create")
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ChangeObjectAction = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ChangeObjectAction.createIn")
  @js.native
  def createIn(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ChangeObjectAction = js.native
