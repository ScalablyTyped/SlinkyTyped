...
class Footer protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.documenttemplates.Footer {
  def this(
    model: AbstractModel,
...
object Footer {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Footer.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Footer.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Footer.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.Footer.versionInfo")
  @js.native
