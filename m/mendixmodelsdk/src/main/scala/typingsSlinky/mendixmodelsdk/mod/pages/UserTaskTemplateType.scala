...
class UserTaskTemplateType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.UserTaskTemplateType {
  def this(
    model: AbstractModel,
...
object UserTaskTemplateType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.UserTaskTemplateType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.UserTaskTemplateType.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.UserTaskTemplateType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.UserTaskTemplateType.versionInfo")
  @js.native
