...
object RangeRuleInfo {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.RangeRuleInfo.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.RangeRuleInfo.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.RangeRuleInfo.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.RangeRuleInfo.versionInfo")
  @js.native
