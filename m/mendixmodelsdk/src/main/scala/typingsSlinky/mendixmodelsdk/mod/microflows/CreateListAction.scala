...
class CreateListAction protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.CreateListAction {
  def this(
    model: AbstractModel,
...
object CreateListAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CreateListAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CreateListAction.createIn")
  @js.native
