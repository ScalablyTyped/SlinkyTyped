...
class AssociationRef protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.domainmodels.AssociationRef {
  def this(
    model: AbstractModel,
...
object AssociationRef {
  ...
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationRef = js.native
