...
class NanoflowCall protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.NanoflowCall {
  def this(
    model: AbstractModel,
...
object NanoflowCall {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCall.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCall.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCall.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCall.versionInfo")
  @js.native
