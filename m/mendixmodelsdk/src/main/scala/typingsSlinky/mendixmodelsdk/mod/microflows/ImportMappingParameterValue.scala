...
class ImportMappingParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.ImportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ImportMappingParameterValue {
  ...
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ImportMappingParameterValue = js.native
  ...
  @js.native
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.JavaActionParameterMapping): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ImportMappingParameterValue = js.native
  ...
  @js.native
  def createInJavaScriptActionParameterMappingUnderParameterValue(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.JavaScriptActionParameterMapping): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ImportMappingParameterValue = js.native
