...
class Filter protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.Filter {
  def this(
    model: AbstractModel,
...
object Filter {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Filter.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Filter.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Filter.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Filter.versionInfo")
  @js.native
