...
class MicroflowCallParameterMapping protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.MicroflowCallParameterMapping {
  def this(
    model: AbstractModel,
...
object MicroflowCallParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MicroflowCallParameterMapping.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MicroflowCallParameterMapping.createIn")
  @js.native
