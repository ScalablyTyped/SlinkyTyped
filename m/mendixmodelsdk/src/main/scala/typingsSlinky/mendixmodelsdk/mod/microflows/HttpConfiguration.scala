...
class HttpConfiguration protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.HttpConfiguration {
  def this(
    model: AbstractModel,
...
object HttpConfiguration {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.HttpConfiguration.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.HttpConfiguration.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.HttpConfiguration.createInConsumedODataServiceUnderHttpConfiguration")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.HttpConfiguration.createInRestCallActionUnderHttpConfiguration")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.HttpConfiguration.createInWebServiceCallActionUnderHttpConfiguration")
  @js.native
