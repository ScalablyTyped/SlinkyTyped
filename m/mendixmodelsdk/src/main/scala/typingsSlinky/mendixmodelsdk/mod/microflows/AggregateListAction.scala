...
class AggregateListAction protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.AggregateListAction {
  def this(
    model: AbstractModel,
...
object AggregateListAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.AggregateListAction = js.native
  ...
  /**
    ...
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsSlinky.mendixmodelsdk.microflowsMod.microflows.AggregateListAction = js.native
