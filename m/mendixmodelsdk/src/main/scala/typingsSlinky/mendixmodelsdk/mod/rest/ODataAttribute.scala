...
class ODataAttribute protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.rest.ODataAttribute {
  def this(
    model: AbstractModel,
...
object ODataAttribute extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.restMod.rest.ODataAttribute = js.native
  /**
    * Creates and returns a new ODataAttribute instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.restMod.rest.ODataEntity): typingsSlinky.mendixmodelsdk.restMod.rest.ODataAttribute = js.native
}
