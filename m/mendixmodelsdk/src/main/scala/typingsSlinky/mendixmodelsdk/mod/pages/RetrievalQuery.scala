...
class RetrievalQuery protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.RetrievalQuery {
  def this(
    model: AbstractModel,
...
object RetrievalQuery {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.RetrievalQuery.create")
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.pagesMod.pages.RetrievalQuery = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk", "pages.RetrievalQuery.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.RetrievalQuery.versionInfo")
  @js.native
