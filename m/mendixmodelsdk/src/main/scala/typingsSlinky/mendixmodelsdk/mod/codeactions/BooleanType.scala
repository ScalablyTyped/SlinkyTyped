...
class BooleanType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.codeactions.BooleanType {
  def this(
    model: AbstractModel,
...
object BooleanType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.BooleanType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.BooleanType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.BooleanType.createInCodeActionUnderActionReturnType")
  @js.native
