...
class DecimalType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.javaactions.DecimalType {
  def this(
    model: AbstractModel,
...
object DecimalType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.DecimalType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.DecimalType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.DecimalType.createInJavaActionParameterUnderJavaType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.DecimalType.createInJavaActionUnderJavaReturnType")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.DecimalType.versionInfo")
  @js.native
