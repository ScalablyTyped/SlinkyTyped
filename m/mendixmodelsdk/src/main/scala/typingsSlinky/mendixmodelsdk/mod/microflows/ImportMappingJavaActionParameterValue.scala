...
class ImportMappingJavaActionParameterValue protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.ImportMappingJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object ImportMappingJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ImportMappingJavaActionParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ImportMappingJavaActionParameterValue.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ImportMappingJavaActionParameterValue.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ImportMappingJavaActionParameterValue.versionInfo")
  @js.native
