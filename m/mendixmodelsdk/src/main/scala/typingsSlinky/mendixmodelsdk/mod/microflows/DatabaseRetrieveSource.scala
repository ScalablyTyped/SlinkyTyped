...
object DatabaseRetrieveSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.DatabaseRetrieveSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.DatabaseRetrieveSource.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.DatabaseRetrieveSource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.DatabaseRetrieveSource.versionInfo")
  @js.native
