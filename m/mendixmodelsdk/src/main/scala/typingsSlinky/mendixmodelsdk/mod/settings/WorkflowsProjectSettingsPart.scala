...
class WorkflowsProjectSettingsPart protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.settings.WorkflowsProjectSettingsPart {
  def this(
    model: AbstractModel,
...
object WorkflowsProjectSettingsPart {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "settings.WorkflowsProjectSettingsPart.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "settings.WorkflowsProjectSettingsPart.createIn")
  @js.native
