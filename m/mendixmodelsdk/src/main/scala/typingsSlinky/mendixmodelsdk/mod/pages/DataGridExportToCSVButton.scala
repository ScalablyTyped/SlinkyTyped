...
object DataGridExportToCSVButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataGridExportToCSVButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataGridExportToCSVButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataGridExportToCSVButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataGridExportToCSVButton.versionInfo")
  @js.native
