...
class Annotation protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.Annotation {
  def this(
    model: AbstractModel,
...
object Annotation {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Annotation.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.Annotation.createIn")
  @js.native
