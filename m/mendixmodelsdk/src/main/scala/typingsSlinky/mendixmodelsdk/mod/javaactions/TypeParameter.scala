...
class TypeParameter protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.javaactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.TypeParameter.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "javaactions.TypeParameter.createIn")
  @js.native
