...
object OfflineSchemaFetchInstruction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.OfflineSchemaFetchInstruction.create")
  @js.native
  def create(model: IModel): typingsSlinky.mendixmodelsdk.pagesMod.pages.OfflineSchemaFetchInstruction = js.native
  
  /* static member */
  @JSImport("mendixmodelsdk", "pages.OfflineSchemaFetchInstruction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.OfflineSchemaFetchInstruction.versionInfo")
  @js.native
