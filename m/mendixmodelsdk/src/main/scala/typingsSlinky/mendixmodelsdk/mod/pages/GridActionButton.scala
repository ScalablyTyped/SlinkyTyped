...
class GridActionButton protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.GridActionButton {
  def this(
    model: AbstractModel,
...
object GridActionButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridActionButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridActionButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridActionButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridActionButton.versionInfo")
  @js.native
