...
class DateTimeAttributeType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.domainmodels.DateTimeAttributeType {
  def this(
    model: AbstractModel,
...
object DateTimeAttributeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.DateTimeAttributeType.versionInfo")
  @js.native
