...
object FormDataRequestHandling {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FormDataRequestHandling.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FormDataRequestHandling.createInRestCallActionUnderRequestHandling")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FormDataRequestHandling.createInWebServiceCallActionUnderRequestBodyHandling")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.FormDataRequestHandling.createInWebServiceCallActionUnderRequestHeaderHandling")
  @js.native
