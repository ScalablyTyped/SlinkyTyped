...
class NanoflowCallAction protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.NanoflowCallAction {
  def this(
    model: AbstractModel,
...
object NanoflowCallAction {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCallAction.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCallAction.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCallAction.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.NanoflowCallAction.versionInfo")
  @js.native
