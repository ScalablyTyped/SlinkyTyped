...
class StringAttributeType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.domainmodels.StringAttributeType {
  def this(
    model: AbstractModel,
...
object StringAttributeType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.StringAttributeType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.StringAttributeType.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.StringAttributeType.createInAttributeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.StringAttributeType.createInEntityKeyPartUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.StringAttributeType.createInODataKeyPartUnderType")
  @js.native
