...
class RuleCall protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.RuleCall {
  def this(
    model: AbstractModel,
...
object RuleCall {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.RuleCall.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.RuleCall.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.RuleCall.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.RuleCall.versionInfo")
  @js.native
