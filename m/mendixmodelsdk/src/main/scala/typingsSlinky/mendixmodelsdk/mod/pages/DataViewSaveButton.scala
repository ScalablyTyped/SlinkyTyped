...
class DataViewSaveButton protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.DataViewSaveButton {
  def this(
    model: AbstractModel,
...
object DataViewSaveButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataViewSaveButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataViewSaveButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.DataViewSaveButton.versionInfo")
  @js.native
