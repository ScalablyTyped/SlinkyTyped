...
class ActionActivity protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.ActionActivity {
  def this(
    model: AbstractModel,
...
object ActionActivity {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ActionActivity.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ActionActivity.createIn")
  @js.native
