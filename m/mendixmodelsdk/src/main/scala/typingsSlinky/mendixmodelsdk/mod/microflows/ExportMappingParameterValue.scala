...
object ExportMappingParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ExportMappingParameterValue.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ExportMappingParameterValue.createInJavaActionParameterMappingUnderParameterValue")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.ExportMappingParameterValue.createInJavaScriptActionParameterMappingUnderParameterValue")
  @js.native
