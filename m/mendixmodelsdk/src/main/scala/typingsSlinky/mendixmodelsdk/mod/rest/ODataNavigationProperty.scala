...
class ODataNavigationProperty protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.rest.ODataNavigationProperty {
  def this(
    model: AbstractModel,
...
object ODataNavigationProperty extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.restMod.rest.ODataNavigationProperty = js.native
  /**
    * Creates and returns a new ODataNavigationProperty instance in the SDK and on the server.
    ...
    *  7.22.0 and higher
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.restMod.rest.ODataEntity): typingsSlinky.mendixmodelsdk.restMod.rest.ODataNavigationProperty = js.native
}
