...
class TemplateGridContents protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.TemplateGridContents {
  def this(
    model: AbstractModel,
...
object TemplateGridContents {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.TemplateGridContents.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.TemplateGridContents.createIn")
  @js.native
