...
object ProjectSettingsPart {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "settings.ProjectSettingsPart.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "settings.ProjectSettingsPart.versionInfo")
  @js.native
