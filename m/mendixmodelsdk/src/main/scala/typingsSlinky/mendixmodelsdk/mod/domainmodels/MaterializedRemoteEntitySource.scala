...
object MaterializedRemoteEntitySource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.MaterializedRemoteEntitySource.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "domainmodels.MaterializedRemoteEntitySource.versionInfo")
  @js.native
