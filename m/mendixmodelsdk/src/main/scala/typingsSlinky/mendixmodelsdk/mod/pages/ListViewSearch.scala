...
object ListViewSearch {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.ListViewSearch.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.ListViewSearch.createInListViewDatabaseSourceUnderSearch")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.ListViewSearch.createInListViewXPathSourceUnderSearch")
  @js.native
