...
class GridSearchButton protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.GridSearchButton {
  def this(
    model: AbstractModel,
...
object GridSearchButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSearchButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSearchButton.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSearchButton.createInControlBarUnderItems")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridSearchButton.createInGridControlBarUnderSearchButton")
  @js.native
