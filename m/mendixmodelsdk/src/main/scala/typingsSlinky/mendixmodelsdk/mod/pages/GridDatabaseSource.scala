...
class GridDatabaseSource protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.GridDatabaseSource {
  def this(
    model: AbstractModel,
...
object GridDatabaseSource {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridDatabaseSource.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridDatabaseSource.createIn")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridDatabaseSource.createInEntityWidgetUnderDataSource")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridDatabaseSource.createInWidgetValueUnderDataSource")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.GridDatabaseSource.versionInfo")
  @js.native
