...
object texts extends js.Object {
  ...
  class SystemText protected ()
    extends typingsSlinky.mendixmodelsdk.allModelClassesMod.texts.SystemText {
    def this(
  ...
  class SystemTextCollection protected ()
    extends typingsSlinky.mendixmodelsdk.allModelClassesMod.texts.SystemTextCollection {
    def this(
      model: typingsSlinky.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Text protected ()
    extends typingsSlinky.mendixmodelsdk.allModelClassesMod.texts.Text {
    def this(
      model: typingsSlinky.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Translation protected ()
    extends typingsSlinky.mendixmodelsdk.allModelClassesMod.texts.Translation {
    def this(
      model: typingsSlinky.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
