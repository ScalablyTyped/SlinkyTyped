...
class SelectButton protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.SelectButton {
  def this(
    model: AbstractModel,
...
object SelectButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.SelectButton.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.SelectButton.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.SelectButton.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.SelectButton.versionInfo")
  @js.native
