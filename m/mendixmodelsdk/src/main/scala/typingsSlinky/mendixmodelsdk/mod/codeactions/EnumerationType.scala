...
class EnumerationType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.codeactions.EnumerationType {
  def this(
    model: AbstractModel,
...
object EnumerationType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.EnumerationType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.EnumerationType.createInBasicParameterTypeUnderType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "codeactions.EnumerationType.createInCodeActionUnderActionReturnType")
  @js.native
