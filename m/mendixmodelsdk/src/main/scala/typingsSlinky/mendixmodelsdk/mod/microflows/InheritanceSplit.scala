...
class InheritanceSplit protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.microflows.InheritanceSplit {
  def this(
    model: AbstractModel,
...
object InheritanceSplit {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.InheritanceSplit.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.InheritanceSplit.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.InheritanceSplit.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.InheritanceSplit.versionInfo")
  @js.native
