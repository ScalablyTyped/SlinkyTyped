...
class RuntimeSettings protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.settings.RuntimeSettings {
  def this(
    model: AbstractModel,
...
object RuntimeSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsSlinky.mendixmodelsdk.settingsMod.settings.RuntimeSettings = js.native
  /**
    * Creates and returns a new RuntimeSettings instance in the SDK and on the server.
    * The new RuntimeSettings will be automatically stored in the 'settingsParts' property
    * of the parent ProjectSettings element passed as argument.
    */
  def createIn(container: typingsSlinky.mendixmodelsdk.settingsMod.settings.ProjectSettings): typingsSlinky.mendixmodelsdk.settingsMod.settings.RuntimeSettings = js.native
}
