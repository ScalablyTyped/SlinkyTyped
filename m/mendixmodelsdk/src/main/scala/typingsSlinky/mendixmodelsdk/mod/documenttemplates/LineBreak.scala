...
class LineBreak protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.documenttemplates.LineBreak {
  def this(
    model: AbstractModel,
...
object LineBreak {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.LineBreak.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.LineBreak.createInDocumentTemplateUnderToplevels")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "documenttemplates.LineBreak.createInDropZoneUnderWidget")
  @js.native
