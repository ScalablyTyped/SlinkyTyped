...
class WorkflowOverviewTemplateType protected ()
  extends typingsSlinky.mendixmodelsdk.allModelClassesMod.pages.WorkflowOverviewTemplateType {
  def this(
    model: AbstractModel,
...
object WorkflowOverviewTemplateType {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.WorkflowOverviewTemplateType.create")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("mendixmodelsdk", "pages.WorkflowOverviewTemplateType.createIn")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.WorkflowOverviewTemplateType.structureTypeName")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.WorkflowOverviewTemplateType.versionInfo")
  @js.native
