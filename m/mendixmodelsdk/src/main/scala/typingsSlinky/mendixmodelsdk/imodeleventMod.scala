...
object imodeleventMod {
  ...
  */
  ...
  object IModelEvent {
    ...
    @scala.inline
    def IDeltaEvent(deltas: js.Array[Delta], id: Double, `type`: deltas): typingsSlinky.mendixmodelsdk.imodeleventMod.IDeltaEvent = {
      val __obj = js.Dynamic.literal(deltas = deltas.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mendixmodelsdk.imodeleventMod.IDeltaEvent]
    }
    
    @scala.inline
    def IFileEvent(files: js.Array[String], id: Double, `type`: fileChanges): typingsSlinky.mendixmodelsdk.imodeleventMod.IFileEvent = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mendixmodelsdk.imodeleventMod.IFileEvent]
    }
  }
}
