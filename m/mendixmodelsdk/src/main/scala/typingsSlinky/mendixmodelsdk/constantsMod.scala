...
object constantsMod {
  ...
  object constants {
    ...
    - typingsSlinky.mendixmodelsdk.constantsMod.constants.IConstant because var conflicts: containerAsFolderBase, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/constants", "constants.Constant")
    @js.native
