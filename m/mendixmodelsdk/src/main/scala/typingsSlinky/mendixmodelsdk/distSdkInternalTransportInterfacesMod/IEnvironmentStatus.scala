...
/* Rewritten from type alias, can be one of: 
  - typings.mendixmodelsdk.Anon_AppType
  - typings.mendixmodelsdk.Anon_Cause
*/
...
object IEnvironmentStatus {
  ...
  @scala.inline
  def Anon_Cause(state: CannotFixAppState, `type`: fail, cause: String = null, message: String = null): IEnvironmentStatus = {
