...
- typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.IAssociationSource because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsAssociationBase */ @JSImport("mendixmodelsdk/dist/gen/domainmodels", "domainmodels.AssociationSource")
@js.native
