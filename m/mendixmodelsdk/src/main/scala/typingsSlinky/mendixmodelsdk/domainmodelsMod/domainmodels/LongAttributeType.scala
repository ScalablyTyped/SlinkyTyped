...
- typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.ILongAttributeType because var conflicts: containerAsAttribute, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/domainmodels", "domainmodels.LongAttributeType")
@js.native
