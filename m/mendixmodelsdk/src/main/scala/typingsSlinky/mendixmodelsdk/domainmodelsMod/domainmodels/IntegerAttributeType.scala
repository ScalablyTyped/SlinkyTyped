...
- typingsSlinky.mendixmodelsdk.domainmodelsMod.domainmodels.IIntegerAttributeType because var conflicts: containerAsAttribute, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/domainmodels", "domainmodels.IntegerAttributeType")
@js.native
