...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/checkbox/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_CHECKED_INDETERMINATE")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_CHECKED_UNCHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_INDETERMINATE_CHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_INDETERMINATE_UNCHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_UNCHECKED_CHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ANIM_UNCHECKED_INDETERMINATE")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.BACKGROUND")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.CHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.CHECKMARK")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.CHECKMARK_PATH")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.DISABLED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.INDETERMINATE")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.MIXEDMARK")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.NATIVE_CONTROL")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.ROOT")
    @js.native
    def ROOT: String = js.native
    @scala.inline
    def ROOT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ROOT")(x.asInstanceOf[js.Any])
    
    @JSImport("@material/checkbox/constants", "cssClasses.SELECTED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "cssClasses.UPGRADED")
    @js.native
  ...
  object numbers {
    ...
    @JSImport("@material/checkbox/constants", "numbers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/checkbox/constants", "numbers.ANIM_END_LATCH_MS")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/checkbox/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/checkbox/constants", "strings.ARIA_CHECKED_ATTR")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.ARIA_CHECKED_INDETERMINATE_VALUE")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.DATA_INDETERMINATE_ATTR")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.NATIVE_CONTROL_SELECTOR")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.TRANSITION_STATE_CHECKED")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.TRANSITION_STATE_INDETERMINATE")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.TRANSITION_STATE_INIT")
    @js.native
    ...
    @JSImport("@material/checkbox/constants", "strings.TRANSITION_STATE_UNCHECKED")
    @js.native
