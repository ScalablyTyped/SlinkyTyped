...
object ProjectorService {
  ...
  implicit class ProjectorServiceOps[Self <: ProjectorService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRenderNow(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renderNow")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withScheduleRender(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scheduleRender")(js.Any.fromFunction0(value))
        ret
    }
  }
