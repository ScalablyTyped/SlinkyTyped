...
object CalculationCache {
  ...
  @scala.inline
  implicit class CalculationCacheOps[Self[result] <: CalculationCache[result], Result] (val x: Self[Result]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withInvalidate(value: () => Unit): Self[Result] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("invalidate")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withResult(value: (js.Array[_], js.Function0[Result]) => Result): Self[Result] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("result")(js.Any.fromFunction2(value))
        ret
    }
  }
