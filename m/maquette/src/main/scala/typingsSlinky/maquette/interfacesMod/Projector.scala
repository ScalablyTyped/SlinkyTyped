...
object Projector {
  ...
  implicit class ProjectorOps[Self <: Projector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppend(value: (Element, js.Function0[VNode]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("append")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDetach(value: js.Function0[VNode] => Projection): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detach")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsertBefore(value: (Element, js.Function0[VNode]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertBefore")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withMerge(value: (Element, js.Function0[VNode]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("merge")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withReplace(value: (Element, js.Function0[VNode]) => Unit): Self = {
        val ret = this.duplicate
