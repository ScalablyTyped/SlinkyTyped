...
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.CallbackFields
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.FieldsKey
...
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.TagTemplateId
