...
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.Callback
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.EntryId
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.Fields
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.Key
import typingsSlinky.maximMazurokGapiClientDatacatalog.anon.Name
