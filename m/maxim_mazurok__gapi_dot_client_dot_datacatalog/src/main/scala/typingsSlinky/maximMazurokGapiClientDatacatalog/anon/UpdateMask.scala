...
import typingsSlinky.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1beta1EntryGroup
...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDatacatalogV1beta1EntryGroup = js.native
...
object UpdateMask {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDatacatalogV1beta1EntryGroup): UpdateMask = {
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1EntryGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
