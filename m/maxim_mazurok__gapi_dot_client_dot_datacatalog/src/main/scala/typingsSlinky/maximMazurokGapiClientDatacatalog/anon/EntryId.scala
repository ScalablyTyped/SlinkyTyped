...
@js.native
trait EntryId extends js.Object {
...
object EntryId {
  ...
  @scala.inline
  implicit class EntryIdOps[Self <: EntryId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1Entry): Self = this.set("resource", value.asInstanceOf[js.Any])
