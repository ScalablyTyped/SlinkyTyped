...
import typingsSlinky.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1beta1Entry
...
@js.native
trait EntryId extends StObject {
  ...
  var entryId: js.UndefOr[String] = js.native
  ...
  /** Request body */
  var resource: GoogleCloudDatacatalogV1beta1Entry = js.native
...
object EntryId {
  ...
  @scala.inline
  def apply(parent: String, resource: GoogleCloudDatacatalogV1beta1Entry): EntryId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[EntryId]
  }
  
  @scala.inline
  implicit class EntryIdMutableBuilder[Self <: EntryId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1Entry): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
