...
trait Xgafv extends StObject {
  ...
  /**
    ...
    */
  var tagTemplateFieldId: js.UndefOr[String] = js.native
...
object Xgafv {
  ...
  implicit class XgafvMutableBuilder[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagTemplateFieldId(value: String): Self = StObject.set(x, "tagTemplateFieldId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagTemplateFieldIdUndefined: Self = StObject.set(x, "tagTemplateFieldId", js.undefined)
