...
object Xgafv {
  ...
  implicit class XgafvOps[Self <: Xgafv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagTemplateFieldId(value: String): Self = this.set("tagTemplateFieldId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTagTemplateFieldId: Self = this.set("tagTemplateFieldId", js.undefined)
