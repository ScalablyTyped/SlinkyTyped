...
import typingsSlinky.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1beta1PolicyTag
...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDatacatalogV1beta1PolicyTag = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDatacatalogV1beta1PolicyTag): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDatacatalogV1beta1PolicyTag): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
