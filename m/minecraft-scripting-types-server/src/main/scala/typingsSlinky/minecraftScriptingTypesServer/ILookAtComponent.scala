...
object ILookAtComponent {
  ...
  implicit class ILookAtComponentOps[Self <: ILookAtComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLook_cooldown(value: Range): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("look_cooldown")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLook_event(value: MinecraftTrigger | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("look_event")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMAllowInvulnerable(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mAllowInvulnerable")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetTarget(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setTarget")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
