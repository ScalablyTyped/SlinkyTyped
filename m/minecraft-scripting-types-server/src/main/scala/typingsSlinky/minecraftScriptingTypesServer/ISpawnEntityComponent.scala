...
object ISpawnEntityComponent {
  ...
  implicit class ISpawnEntityComponentOps[Self <: ISpawnEntityComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMax_wait_time(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("max_wait_time")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMin_wait_time(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("min_wait_time")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNum_to_spawn(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("num_to_spawn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShould_leash(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("should_leash")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSingle_use(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("single_use")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSpawn_entity(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spawn_entity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSpawn_event(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spawn_event")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSpawn_item(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spawn_item")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSpawn_method(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spawn_method")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSpawn_sound(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("spawn_sound")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
