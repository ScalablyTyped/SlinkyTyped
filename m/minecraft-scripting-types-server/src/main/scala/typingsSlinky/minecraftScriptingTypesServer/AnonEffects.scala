...
trait AnonEffects extends js.Object {
  /**
    ...
    */
  var effects: js.Array[AnonAmplifier] = js.native
  /**
...
object AnonEffects {
  @scala.inline
  def apply(effects: js.Array[AnonAmplifier], heal_amount: Double, item: String): AnonEffects = {
  ...
  @scala.inline
  implicit class AnonEffectsOps[Self <: AnonEffects] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withEffects(value: js.Array[AnonAmplifier]): Self = {
