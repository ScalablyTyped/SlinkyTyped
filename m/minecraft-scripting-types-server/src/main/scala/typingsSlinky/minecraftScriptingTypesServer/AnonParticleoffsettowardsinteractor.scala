...
@js.native
trait AnonParticleoffsettowardsinteractor extends js.Object {
  /**
...
object AnonParticleoffsettowardsinteractor {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonParticleoffsettowardsinteractorOps[Self <: AnonParticleoffsettowardsinteractor] (val x: Self) extends AnyVal {
    @scala.inline
