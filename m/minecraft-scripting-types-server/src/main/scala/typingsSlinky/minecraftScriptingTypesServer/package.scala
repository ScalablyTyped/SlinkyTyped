...
package object minecraftScriptingTypesServer {
  type IArmorContainerComponent = js.Array[typingsSlinky.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IHandContainerComponent = js.Array[typingsSlinky.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IHotbarContainerComponent = js.Array[typingsSlinky.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IInventoryContainerComponent = js.Array[typingsSlinky.minecraftScriptingTypesShared.IItemStack]
}
