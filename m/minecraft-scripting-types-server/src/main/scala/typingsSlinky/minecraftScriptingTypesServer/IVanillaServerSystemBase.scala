...
import typingsSlinky.minecraftScriptingTypesServer.minecraftScriptingTypesServerBooleans.`true`
...
import typingsSlinky.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColondisplay_chat_event
...
import typingsSlinky.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonexecute_command
...
trait IVanillaServerSystemBase extends js.Object {
  ...
  def broadcastEvent_minecraftdisplaychatevent(eventIdentifier: minecraftColondisplay_chat_event, eventData: IEventData[IDisplayChatParameters]): Boolean | Null = js.native
  /**
    ...
    */
  @JSName("broadcastEvent")
  def broadcastEvent_minecraftexecutecommand(eventIdentifier: minecraftColonexecute_command, eventData: IEventData[IExecuteCommandParameters]): Boolean | Null = js.native
  /**
    ...
    */
  @JSName("broadcastEvent")
  def broadcastEvent_minecraftplaysound(eventIdentifier: minecraftColonplay_sound, eventData: IEventData[IPlaySoundParameters]): Boolean | Null = js.native
  /**
  ...
  def broadcastEvent_minecraftscriptloggerconfig(
    eventIdentifier: minecraftColonscript_logger_config,
  ...
  def broadcastEvent_minecraftspawnparticleattachedentity(
    eventIdentifier: minecraftColonspawn_particle_attached_entity,
  ...
  def createComponent_minecraftarmorcontainer(entity: IEntity, componentName: minecraftColonarmor_container): IComponent[IArmorContainerComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftattack(entity: IEntity, componentName: minecraftColonattack): IComponent[IAttackComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftcollisionbox(entity: IEntity, componentName: minecraftColoncollision_box): IComponent[ICollisionBoxComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftdamagesensor(entity: IEntity, componentName: minecraftColondamage_sensor): IComponent[IDamageSensorComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftequipment(entity: IEntity, componentName: minecraftColonequipment): IComponent[IEquipmentComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftequippable(entity: IEntity, componentName: minecraftColonequippable): IComponent[IEquippableComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftexplode(entity: IEntity, componentName: minecraftColonexplode): IComponent[IExplodeComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecrafthandcontainer(entity: IEntity, componentName: minecraftColonhand_container): IComponent[IHandContainerComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecrafthealable(entity: IEntity, componentName: minecraftColonhealable): IComponent[IHealableComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecrafthealth(entity: IEntity, componentName: minecraftColonhealth): IComponent[IHealthComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecrafthotbarcontainer(entity: IEntity, componentName: minecraftColonhotbar_container): IComponent[IHotbarContainerComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftinteract(entity: IEntity, componentName: minecraftColoninteract): IComponent[IInteractComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftinventory(entity: IEntity, componentName: minecraftColoninventory): IComponent[IInventoryComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftinventorycontainer(entity: IEntity, componentName: minecraftColoninventory_container): IComponent[IInventoryContainerComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftlookat(entity: IEntity, componentName: minecraftColonlookat): IComponent[ILookAtComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftnameable(entity: IEntity, componentName: minecraftColonnameable): IComponent[INameableComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftposition(entity: IEntity, componentName: minecraftColonposition): IComponent[IPositionComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftrotation(entity: IEntity, componentName: minecraftColonrotation): IComponent[IRotationComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftshooter(entity: IEntity, componentName: minecraftColonshooter): IComponent[IShooterComponent] | Null = js.native
  @JSName("createComponent")
  def createComponent_minecraftspawnentity(entity: IEntity, componentName: minecraftColonspawn_entity): IComponent[ISpawnEntityComponent] | Null = js.native
  @JSName("createComponent")
  ...
  def createEventData_minecraftdisplaychatevent(eventIdentifier: minecraftColondisplay_chat_event): IEventData[IDisplayChatParameters] | Null = js.native
  /**
    * This event is used to execute a slash command on the server with the World Owner permission level. The event data contains the slash command as a string. The slash command will be processed and will run after the event is sent.
    */
  @JSName("createEventData")
  def createEventData_minecraftexecutecommand(eventIdentifier: minecraftColonexecute_command): IEventData[IExecuteCommandParameters] | Null = js.native
  /**
    * This event is used to play a sound effect. Currently, sounds can only be played at a fixed position in the world. Global sounds and sounds played by an entity will be supported in a later update.
    */
  @JSName("createEventData")
  def createEventData_minecraftplaysound(eventIdentifier: minecraftColonplay_sound): IEventData[IPlaySoundParameters] | Null = js.native
  /**
    * This event is used to turn various levels of logging on and off for server scripts. Note that turning logging on/off is not limited to the script that broadcasted the event. It will affect ALL server scripts including those in other Behavior Packs that are applied to the world. See the Debugging section for more information on logging.
    */
  @JSName("createEventData")
  def createEventData_minecraftscriptloggerconfig(eventIdentifier: minecraftColonscript_logger_config): IEventData[IScriptLoggerConfigParameters] | Null = js.native
  /**
    * This event is used to create a particle effect that will follow an entity around. This particle effect is visible to all players. Any effect defined in a JSON file (both in your resource pack and in Minecraft) can be used here. MoLang variables defined in the JSON of the effect can then be used to control that effect by changing them in the entity to which it is attached.
    */
  @JSName("createEventData")
  def createEventData_minecraftspawnparticleattachedentity(eventIdentifier: minecraftColonspawn_particle_attached_entity): IEventData[ISpawnParticleAttachedEntityParameters] | Null = js.native
  /**
    * This event is used to create a static particle effect in the world. This particle effect is visible to all players. Any effect defined in a JSON file (both in your resource pack and in Minecraft) can be used here. Once the effect is spawned you won't be able to control it further.
    */
  @JSName("createEventData")
  ...
  /**
    ...
    */
  def getComponent[TComponent](entity: IEntity, componentIdentifier: MinecraftComponent): IComponent[TComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftarmorcontainer(entity: IEntity, componentName: minecraftColonarmor_container): IComponent[IArmorContainerComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftattack(entity: IEntity, componentName: minecraftColonattack): IComponent[IAttackComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftcollisionbox(entity: IEntity, componentName: minecraftColoncollision_box): IComponent[ICollisionBoxComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftdamagesensor(entity: IEntity, componentName: minecraftColondamage_sensor): IComponent[IDamageSensorComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftequipment(entity: IEntity, componentName: minecraftColonequipment): IComponent[IEquipmentComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftequippable(entity: IEntity, componentName: minecraftColonequippable): IComponent[IEquippableComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftexplode(entity: IEntity, componentName: minecraftColonexplode): IComponent[IExplodeComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecrafthandcontainer(entity: IEntity, componentName: minecraftColonhand_container): IComponent[IHandContainerComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecrafthealable(entity: IEntity, componentName: minecraftColonhealable): IComponent[IHealableComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecrafthealth(entity: IEntity, componentName: minecraftColonhealth): IComponent[IHealthComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecrafthotbarcontainer(entity: IEntity, componentName: minecraftColonhotbar_container): IComponent[IHotbarContainerComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftinteract(entity: IEntity, componentName: minecraftColoninteract): IComponent[IInteractComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftinventory(entity: IEntity, componentName: minecraftColoninventory): IComponent[IInventoryComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftinventorycontainer(entity: IEntity, componentName: minecraftColoninventory_container): IComponent[IInventoryContainerComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftlookat(entity: IEntity, componentName: minecraftColonlookat): IComponent[ILookAtComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftnameable(entity: IEntity, componentName: minecraftColonnameable): IComponent[INameableComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftposition(entity: IEntity, componentName: minecraftColonposition): IComponent[IPositionComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftrotation(entity: IEntity, componentName: minecraftColonrotation): IComponent[IRotationComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftshooter(entity: IEntity, componentName: minecraftColonshooter): IComponent[IShooterComponent] | Null = js.native
  @JSName("getComponent")
  def getComponent_minecraftspawnentity(entity: IEntity, componentName: minecraftColonspawn_entity): IComponent[ISpawnEntityComponent] | Null = js.native
  @JSName("getComponent")
  ...
  def listenForEvent_minecraftblockdestructionstarted(
    eventIdentifier: minecraftColonblock_destruction_started,
    callback: js.Function1[/* eventData */ IEventData[IBlockDestructionStartedEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftblockdestructionstopped(
    eventIdentifier: minecraftColonblock_destruction_stopped,
    callback: js.Function1[/* eventData */ IEventData[IBlockDestructionStoppedEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftblockinteractedwith(
    eventIdentifier: minecraftColonblock_interacted_with,
    callback: js.Function1[/* eventData */ IEventData[IBlockInteractedWithEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentityacquireditem(
    eventIdentifier: minecraftColonentity_acquired_item,
    callback: js.Function1[/* eventData */ IEventData[IEntityAcquiredItemEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitycarrieditemchanged(
    eventIdentifier: minecraftColonentity_carried_item_changed,
    callback: js.Function1[/* eventData */ IEventData[IEntityCarriedItemChangedEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitycreated(
    eventIdentifier: minecraftColonentity_created,
    callback: js.Function1[/* eventData */ IEventData[IEntityCreatedEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitydeath(
    eventIdentifier: minecraftColonentity_death,
    callback: js.Function1[/* eventData */ IEventData[IEntityDeathEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitydroppeditem(
    eventIdentifier: minecraftColonentity_dropped_item,
    callback: js.Function1[/* eventData */ IEventData[IEntityDroppedItemEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentityequippedarmor(
    eventIdentifier: minecraftColonentity_equipped_armor,
    callback: js.Function1[/* eventData */ IEventData[IEntityEquippedArmorEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitystartriding(
    eventIdentifier: minecraftColonentity_start_riding,
    callback: js.Function1[/* eventData */ IEventData[IEntityStartRidingEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitystopriding(
    eventIdentifier: minecraftColonentity_stop_riding,
    callback: js.Function1[/* eventData */ IEventData[IEntityStopRidingEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentitytick(
    eventIdentifier: minecraftColonentity_tick,
    callback: js.Function1[/* eventData */ IEventData[IEntityTickEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftentityuseitem(
    eventIdentifier: minecraftColonentity_use_item,
    callback: js.Function1[/* eventData */ IEventData[IEntityUseItemEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftpistonmovedblock(
    eventIdentifier: minecraftColonpiston_moved_block,
    callback: js.Function1[/* eventData */ IEventData[IPistonMovedBlockEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftplayerattackedentity(
    eventIdentifier: minecraftColonplayer_attacked_entity,
    callback: js.Function1[/* eventData */ IEventData[IPlayerAttackedEntityEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftplayerdestroyedblock(
    eventIdentifier: minecraftColonplayer_destroyed_block,
    callback: js.Function1[/* eventData */ IEventData[IPlayerDestroyedBlockEventData], Unit]
  ): Boolean | Null = js.native
  /**
  ...
  def listenForEvent_minecraftplayerplacedblock(
    eventIdentifier: minecraftColonplayer_placed_block,
    callback: js.Function1[/* eventData */ IEventData[IPlayerPlacedBlockEventData], Unit]
  ): Boolean | Null = js.native
  /**
    * This event is used to play a sound effect. Currently, sounds can only be played at a fixed position in the world. Global sounds and sounds played by an entity will be supported in a later update.
    */
  ...
  def listenForEvent_minecraftplaysound(
    eventIdentifier: minecraftColonplay_sound,
    callback: js.Function1[/* eventData */ IEventData[IPlaySoundEventData], Unit]
  ): Boolean | Null = js.native
  /**
