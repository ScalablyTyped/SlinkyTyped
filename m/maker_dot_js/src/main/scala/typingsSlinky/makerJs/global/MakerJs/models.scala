...
object models {
  ...
  class EllipticArc protected ()
    extends typingsSlinky.makerJs.MakerJs.models.EllipticArc {
    /**
  ...
  class Holes protected ()
    extends typingsSlinky.makerJs.MakerJs.models.Holes {
    /**
  ...
  class Oval protected ()
    extends typingsSlinky.makerJs.MakerJs.models.Oval {
    def this(width: Double, height: Double) = this()
  }
  ...
  class Polygon protected ()
    extends typingsSlinky.makerJs.MakerJs.models.Polygon {
  ...
  class Rectangle protected ()
    extends typingsSlinky.makerJs.MakerJs.models.Rectangle {
    /**
  ...
  class SCurve protected ()
    extends typingsSlinky.makerJs.MakerJs.models.SCurve {
    def this(width: Double, height: Double) = this()
  }
  ...
  class Square protected ()
    extends typingsSlinky.makerJs.MakerJs.models.Square {
