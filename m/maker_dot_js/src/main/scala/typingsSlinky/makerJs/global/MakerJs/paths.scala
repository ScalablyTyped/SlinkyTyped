...
object paths extends js.Object {
  ...
  @js.native
  class Arc protected ()
    extends typingsSlinky.makerJs.MakerJs.paths.Arc {
    /**
  ...
  class Chord protected ()
    extends typingsSlinky.makerJs.MakerJs.paths.Chord {
  ...
  class Circle protected ()
    extends typingsSlinky.makerJs.MakerJs.paths.Circle {
    /**
  ...
  class Line protected ()
    extends typingsSlinky.makerJs.MakerJs.paths.Line {
    /**
