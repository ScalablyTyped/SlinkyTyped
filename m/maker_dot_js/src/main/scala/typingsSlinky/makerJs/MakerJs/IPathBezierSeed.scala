...
object IPathBezierSeed {
  ...
  implicit class IPathBezierSeedOps[Self <: IPathBezierSeed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControls(value: js.Array[IPoint]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("controls")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withParentRange(value: IBezierRange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("parentRange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutParentRange: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("parentRange")(js.undefined)
        ret
    }
  }
