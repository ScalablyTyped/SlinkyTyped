...
package object MakerJs {
  ...
  type IChainCallback = js.Function3[
    /* chains */ js.Array[typingsSlinky.makerJs.MakerJs.IChain], 
    /* loose */ js.Array[typingsSlinky.makerJs.MakerJs.IWalkPath], 
  ...
  /**
    ...
    */
  type IMeasureMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.makerJs.MakerJs.IMeasure]
  /**
    * Model objects by id.
    */
  type IModelMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.makerJs.MakerJs.IModel]
  /**
    * Callback signature for model.walkPaths().
    */
  type IModelPathCallback = js.Function3[
    /* modelContext */ typingsSlinky.makerJs.MakerJs.IModel, 
    /* pathId */ java.lang.String, 
    /* pathContext */ typingsSlinky.makerJs.MakerJs.IPath, 
    scala.Unit
  ]
  /**
  ...
  type IPathFunctionMap = /**
    ...
    */
  org.scalablytyped.runtime.StringDictionary[js.Function1[/* pathValue */ typingsSlinky.makerJs.MakerJs.IPath, scala.Unit]]
  /**
    * Path objects by id.
    */
  type IPathMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.makerJs.MakerJs.IPath]
  /**
  ...
  org.scalablytyped.runtime.StringDictionary[
    js.Function4[
      /* id */ java.lang.String, 
      /* pathValue */ typingsSlinky.makerJs.MakerJs.IPath, 
      /* origin */ typingsSlinky.makerJs.MakerJs.IPoint, 
      /* layer */ java.lang.String, 
      scala.Unit
    ]
  ]
  ...
  /**
    ...
    */
  type IWalkModelCallback = js.Function1[/* context */ typingsSlinky.makerJs.MakerJs.IWalkModel, scala.Unit]
  /**
    * Callback signature for model.walk(), which may return false to halt any further walking.
    */
  type IWalkModelCancellableCallback = js.Function1[/* context */ typingsSlinky.makerJs.MakerJs.IWalkModel, scala.Boolean]
  /**
    * Callback for returning a boolean from an IWalkPath.
    */
  type IWalkPathBooleanCallback = js.Function1[/* context */ typingsSlinky.makerJs.MakerJs.IWalkPath, scala.Boolean]
  /**
    * Callback signature for path in model.walk().
    */
  type IWalkPathCallback = js.Function1[/* context */ typingsSlinky.makerJs.MakerJs.IWalkPath, scala.Unit]
}
