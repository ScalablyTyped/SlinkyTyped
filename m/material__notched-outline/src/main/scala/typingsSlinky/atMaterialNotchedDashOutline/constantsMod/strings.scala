...
import typingsSlinky.atMaterialNotchedDashOutline.atMaterialNotchedDashOutlineStrings.`Dotmdc-notched-outline__idle`
import typingsSlinky.atMaterialNotchedDashOutline.atMaterialNotchedDashOutlineStrings.`Dotmdc-notched-outline__path`
