...
object MomentSetObject {
  ...
  def apply(
    ...
    day: Int | Double = null,
    dayOfYear: Int | Double = null,
    dayOfYears: Int | Double = null,
    ...
    isoWeek: Int | Double = null,
    isoWeekYear: Int | Double = null,
    isoWeekYears: Int | Double = null,
    isoWeekday: Int | Double = null,
    isoWeekdays: Int | Double = null,
    isoWeeks: Int | Double = null,
    m: Int | Double = null,
    ...
    weekYears: Int | Double = null,
    weekday: Int | Double = null,
    weekdays: Int | Double = null,
    ...
    if (DDD != null) __obj.updateDynamic("DDD")(DDD.asInstanceOf[js.Any])
    if (E != null) __obj.updateDynamic("E")(E.asInstanceOf[js.Any])
    if (GG != null) __obj.updateDynamic("GG")(GG.asInstanceOf[js.Any])
    ...
    if (dayOfYear != null) __obj.updateDynamic("dayOfYear")(dayOfYear.asInstanceOf[js.Any])
    if (dayOfYears != null) __obj.updateDynamic("dayOfYears")(dayOfYears.asInstanceOf[js.Any])
    ...
    if (isoWeek != null) __obj.updateDynamic("isoWeek")(isoWeek.asInstanceOf[js.Any])
    if (isoWeekYear != null) __obj.updateDynamic("isoWeekYear")(isoWeekYear.asInstanceOf[js.Any])
    if (isoWeekYears != null) __obj.updateDynamic("isoWeekYears")(isoWeekYears.asInstanceOf[js.Any])
    if (isoWeekday != null) __obj.updateDynamic("isoWeekday")(isoWeekday.asInstanceOf[js.Any])
    if (isoWeekdays != null) __obj.updateDynamic("isoWeekdays")(isoWeekdays.asInstanceOf[js.Any])
    if (isoWeeks != null) __obj.updateDynamic("isoWeeks")(isoWeeks.asInstanceOf[js.Any])
    if (m != null) __obj.updateDynamic("m")(m.asInstanceOf[js.Any])
    ...
    if (weekYears != null) __obj.updateDynamic("weekYears")(weekYears.asInstanceOf[js.Any])
