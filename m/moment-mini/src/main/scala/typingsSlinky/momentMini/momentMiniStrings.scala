...
import typingsSlinky.momentMini.mod.LongDateFormatKey
import typingsSlinky.momentMini.mod.RelativeTimeKey
import typingsSlinky.momentMini.mod._CalendarKey
import typingsSlinky.momentMini.mod.unitOfTime.All
import typingsSlinky.momentMini.mod.unitOfTime.Base
import typingsSlinky.momentMini.mod.unitOfTime.Diff
import typingsSlinky.momentMini.mod.unitOfTime.DurationConstructor
import typingsSlinky.momentMini.mod.unitOfTime.MomentConstructor
...
object momentMiniStrings {
  ...
  sealed trait D
    extends All
       ...
       with StartOf
       with typingsSlinky.momentMini.mod.unitOfTime.date
  ...
  sealed trait Q
    extends All
       ...
       with DurationConstructor
       with StartOf
       with typingsSlinky.momentMini.mod.unitOfTime.quarter
  
  @js.native
  sealed trait W
    extends All
       with StartOf
       with typingsSlinky.momentMini.mod.unitOfTime.isoWeek
