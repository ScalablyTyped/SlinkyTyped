...
import typingsSlinky.momentMini.mod.unitOfTime.All
import typingsSlinky.momentMini.mod.unitOfTime.Diff
import typingsSlinky.momentMini.mod.unitOfTime.DurationConstructor
import typingsSlinky.momentMini.mod.unitOfTime.StartOf
import typingsSlinky.momentMini.momentMiniStrings.LeftparenthesisRightparenthesis
import typingsSlinky.momentMini.momentMiniStrings.`Leftparenthesis]`
...
trait Moment
  ...
  def calendar(time: js.UndefOr[MomentInput], formats: CalendarSpec): String = js.native
  ...
  def isBetween(
    a: MomentInput,
    b: MomentInput,
    granularity: js.UndefOr[scala.Nothing],
  ...
  def isBetween(
    ...
    b: MomentInput,
    granularity: js.UndefOr[scala.Nothing],
    inclusivity: `Leftparenthesis]`
  ): Boolean = js.native
  def isBetween(
    a: MomentInput,
    b: MomentInput,
    granularity: js.UndefOr[scala.Nothing],
    inclusivity: `[Rightparenthesis`
  ): Boolean = js.native
  def isBetween(a: MomentInput, b: MomentInput, granularity: js.UndefOr[scala.Nothing], inclusivity: `[]`): Boolean = js.native
