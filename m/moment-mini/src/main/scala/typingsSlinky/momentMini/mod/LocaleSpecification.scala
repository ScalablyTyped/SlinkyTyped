...
object LocaleSpecification {
  ...
  implicit class LocaleSpecificationOps[Self <: LocaleSpecification] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMeridiemParse(value: js.RegExp): Self = this.set("meridiemParse", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOrdinalParse(value: js.RegExp): Self = this.set("ordinalParse", value.asInstanceOf[js.Any])
    @scala.inline
