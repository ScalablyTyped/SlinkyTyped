...
object LocaleSpecification {
  ...
  implicit class LocaleSpecificationMutableBuilder[Self <: LocaleSpecification] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMeridiemParse(value: js.RegExp): Self = StObject.set(x, "meridiemParse", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOrdinalParse(value: js.RegExp): Self = StObject.set(x, "ordinalParse", value.asInstanceOf[js.Any])
