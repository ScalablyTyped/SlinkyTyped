...
import typingsSlinky.momentTimezone.mod.momentAugmentingMod.MomentTimezone
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    trait MomentTimezone extends StObject {
      ...
      def apply(date: String, format: typingsSlinky.moment.momentMod.MomentFormatSpecification, timezone: String): typingsSlinky.moment.momentMod.Moment = js.native
      ...
      def setDefault(): typingsSlinky.momentTimezone.mod.momentAugmentingMod.Moment = js.native
      def setDefault(timezone: String): typingsSlinky.momentTimezone.mod.momentAugmentingMod.Moment = js.native
