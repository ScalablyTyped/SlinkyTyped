...
trait Moment extends js.Object {
  ...
  def tz(timezone: String): typingsSlinky.moment.mod.Moment = js.native
  def tz(timezone: String, keepLocalTime: Boolean): typingsSlinky.moment.mod.Moment = js.native
