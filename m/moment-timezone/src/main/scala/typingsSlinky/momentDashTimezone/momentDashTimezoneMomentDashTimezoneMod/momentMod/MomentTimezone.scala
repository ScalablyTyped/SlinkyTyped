package typingsSlinky.momentDashTimezone.momentDashTimezoneMomentDashTimezoneMod.momentMod

import typingsSlinky.moment.momentMod.MomentFormatSpecification
import typingsSlinky.momentDashTimezone.Anon_Links
...
trait MomentTimezone extends js.Object {
  ...
  def apply(date: Date, timezone: String): typingsSlinky.moment.momentMod.Moment = js.native
