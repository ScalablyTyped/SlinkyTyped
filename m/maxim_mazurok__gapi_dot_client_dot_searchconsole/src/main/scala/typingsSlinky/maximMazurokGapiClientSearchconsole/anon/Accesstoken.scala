package typingsSlinky.maximMazurokGapiClientSearchconsole.anon

import typingsSlinky.maximMazurokGapiClientSearchconsole.gapi.client.searchconsole.SearchAnalyticsQueryRequest
...
object Accesstoken {
  ...
  implicit class AccesstokenOps[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SearchAnalyticsQueryRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
