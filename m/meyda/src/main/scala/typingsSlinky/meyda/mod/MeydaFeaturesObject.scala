...
object MeydaFeaturesObject {
  ...
  implicit class MeydaFeaturesObjectOps[Self <: MeydaFeaturesObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAmplitudeSpectrum(value: js.typedarray.Float32Array): Self = this.set("amplitudeSpectrum", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPowerSpectrum(value: js.typedarray.Float32Array): Self = this.set("powerSpectrum", value.asInstanceOf[js.Any])
    @scala.inline
