...
@js.native
trait DeviceMakeModelAssignedTargetingOptionDetails extends js.Object {
...
object DeviceMakeModelAssignedTargetingOptionDetails {
  ...
  @scala.inline
  implicit class DeviceMakeModelAssignedTargetingOptionDetailsOps[Self <: DeviceMakeModelAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
