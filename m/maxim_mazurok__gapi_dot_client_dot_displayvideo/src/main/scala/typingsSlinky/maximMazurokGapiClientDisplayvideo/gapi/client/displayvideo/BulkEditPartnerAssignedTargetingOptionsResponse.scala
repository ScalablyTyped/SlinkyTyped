...
@js.native
trait BulkEditPartnerAssignedTargetingOptionsResponse extends js.Object {
...
object BulkEditPartnerAssignedTargetingOptionsResponse {
  ...
  @scala.inline
  implicit class BulkEditPartnerAssignedTargetingOptionsResponseOps[Self <: BulkEditPartnerAssignedTargetingOptionsResponse] (val x: Self) extends AnyVal {
