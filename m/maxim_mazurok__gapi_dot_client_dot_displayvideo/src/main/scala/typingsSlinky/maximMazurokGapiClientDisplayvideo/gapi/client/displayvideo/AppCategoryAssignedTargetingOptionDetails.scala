...
@js.native
trait AppCategoryAssignedTargetingOptionDetails extends js.Object {
...
object AppCategoryAssignedTargetingOptionDetails {
  ...
  @scala.inline
  implicit class AppCategoryAssignedTargetingOptionDetailsOps[Self <: AppCategoryAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
