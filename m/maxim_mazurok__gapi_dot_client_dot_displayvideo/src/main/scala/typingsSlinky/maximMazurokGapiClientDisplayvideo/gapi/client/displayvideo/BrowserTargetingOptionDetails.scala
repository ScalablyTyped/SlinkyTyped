...
@js.native
trait BrowserTargetingOptionDetails extends js.Object {
...
object BrowserTargetingOptionDetails {
  ...
  @scala.inline
  implicit class BrowserTargetingOptionDetailsOps[Self <: BrowserTargetingOptionDetails] (val x: Self) extends AnyVal {
