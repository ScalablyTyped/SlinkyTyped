...
@js.native
trait LanguageTargetingOptionDetails extends js.Object {
...
object LanguageTargetingOptionDetails {
  ...
  @scala.inline
  implicit class LanguageTargetingOptionDetailsOps[Self <: LanguageTargetingOptionDetails] (val x: Self) extends AnyVal {
