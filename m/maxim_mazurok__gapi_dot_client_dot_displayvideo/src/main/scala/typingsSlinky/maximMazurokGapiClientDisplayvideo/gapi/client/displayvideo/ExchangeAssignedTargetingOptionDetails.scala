...
@js.native
trait ExchangeAssignedTargetingOptionDetails extends js.Object {
...
object ExchangeAssignedTargetingOptionDetails {
  ...
  @scala.inline
  implicit class ExchangeAssignedTargetingOptionDetailsOps[Self <: ExchangeAssignedTargetingOptionDetails] (val x: Self) extends AnyVal {
