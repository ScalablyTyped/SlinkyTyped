...
@js.native
trait CustomBiddingAlgorithmId extends StObject {
  ...
  var customBiddingAlgorithmId: String = js.native
...
object CustomBiddingAlgorithmId {
  ...
  @scala.inline
  def apply(customBiddingAlgorithmId: String): CustomBiddingAlgorithmId = {
  ...
  @scala.inline
  implicit class CustomBiddingAlgorithmIdMutableBuilder[Self <: CustomBiddingAlgorithmId] (val x: Self) extends AnyVal {
