...
@js.native
trait KeywordValue extends StObject {
  ...
  var keywordValue: String = js.native
...
object KeywordValue {
  ...
  @scala.inline
  def apply(advertiserId: String, keywordValue: String, negativeKeywordListId: String): KeywordValue = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], keywordValue = keywordValue.asInstanceOf[js.Any], negativeKeywordListId = negativeKeywordListId.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeywordValue]
  }
  
  @scala.inline
  implicit class KeywordValueMutableBuilder[Self <: KeywordValue] (val x: Self) extends AnyVal {
