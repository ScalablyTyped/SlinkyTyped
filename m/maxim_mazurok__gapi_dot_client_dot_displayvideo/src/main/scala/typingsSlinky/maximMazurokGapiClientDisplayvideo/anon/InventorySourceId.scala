...
@js.native
trait InventorySourceId extends StObject {
  ...
  var inventorySourceId: String = js.native
...
object InventorySourceId {
  ...
  @scala.inline
  def apply(inventorySourceId: String): InventorySourceId = {
    val __obj = js.Dynamic.literal(inventorySourceId = inventorySourceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InventorySourceId]
  }
  
  @scala.inline
  implicit class InventorySourceIdMutableBuilder[Self <: InventorySourceId] (val x: Self) extends AnyVal {
