...
@js.native
trait OauthtokenPartnerId extends js.Object {
...
object OauthtokenPartnerId {
  ...
  @scala.inline
  def apply(partnerId: String, targetingType: String): OauthtokenPartnerId = {
  ...
  @scala.inline
  implicit class OauthtokenPartnerIdOps[Self <: OauthtokenPartnerId] (val x: Self) extends AnyVal {
