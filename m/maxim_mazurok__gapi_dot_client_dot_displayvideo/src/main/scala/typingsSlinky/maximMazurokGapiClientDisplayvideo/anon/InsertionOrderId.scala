...
@js.native
trait InsertionOrderId extends StObject {
...
object InsertionOrderId {
  
  @scala.inline
  def apply(advertiserId: String, insertionOrderId: String): InsertionOrderId = {
    ...
    __obj.asInstanceOf[InsertionOrderId]
  }
  
  @scala.inline
  implicit class InsertionOrderIdMutableBuilder[Self <: InsertionOrderId] (val x: Self) extends AnyVal {
