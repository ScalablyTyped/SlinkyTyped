...
@js.native
trait LineItemId extends js.Object {
...
object LineItemId {
  ...
  @scala.inline
  implicit class LineItemIdOps[Self <: LineItemId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AssignedTargetingOption): Self = this.set("resource", value.asInstanceOf[js.Any])
