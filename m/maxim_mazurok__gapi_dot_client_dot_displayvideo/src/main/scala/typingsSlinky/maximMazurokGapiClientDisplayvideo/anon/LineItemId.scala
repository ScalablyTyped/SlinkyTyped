...
import typingsSlinky.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.AssignedTargetingOption
...
@js.native
trait LineItemId extends StObject {
  ...
  /** Request body */
  var resource: AssignedTargetingOption = js.native
...
object LineItemId {
  ...
  @scala.inline
  def apply(advertiserId: String, lineItemId: String, resource: AssignedTargetingOption, targetingType: String): LineItemId = {
  ...
  @scala.inline
  implicit class LineItemIdMutableBuilder[Self <: LineItemId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AssignedTargetingOption): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
