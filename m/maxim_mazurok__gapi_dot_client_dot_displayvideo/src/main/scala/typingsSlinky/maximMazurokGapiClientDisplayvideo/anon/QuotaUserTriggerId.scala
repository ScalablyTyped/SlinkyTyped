...
@js.native
trait QuotaUserTriggerId extends StObject {
...
object QuotaUserTriggerId {
  
  @scala.inline
  def apply(advertiserId: String, triggerId: String): QuotaUserTriggerId = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], triggerId = triggerId.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserTriggerId]
  }
  
  @scala.inline
  implicit class QuotaUserTriggerIdMutableBuilder[Self <: QuotaUserTriggerId] (val x: Self) extends AnyVal {
