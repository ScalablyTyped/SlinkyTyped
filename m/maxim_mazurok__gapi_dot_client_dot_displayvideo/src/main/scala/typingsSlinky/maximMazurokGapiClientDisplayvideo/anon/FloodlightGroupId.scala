...
@js.native
trait FloodlightGroupId extends StObject {
...
object FloodlightGroupId {
  
  @scala.inline
  def apply(floodlightGroupId: String): FloodlightGroupId = {
    val __obj = js.Dynamic.literal(floodlightGroupId = floodlightGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FloodlightGroupId]
  }
  
  @scala.inline
  implicit class FloodlightGroupIdMutableBuilder[Self <: FloodlightGroupId] (val x: Self) extends AnyVal {
