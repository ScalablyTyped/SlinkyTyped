...
@js.native
trait KeyLocationListId extends StObject {
...
object KeyLocationListId {
  
  @scala.inline
  def apply(advertiserId: String, locationListId: String): KeyLocationListId = {
  ...
  @scala.inline
  implicit class KeyLocationListIdMutableBuilder[Self <: KeyLocationListId] (val x: Self) extends AnyVal {
