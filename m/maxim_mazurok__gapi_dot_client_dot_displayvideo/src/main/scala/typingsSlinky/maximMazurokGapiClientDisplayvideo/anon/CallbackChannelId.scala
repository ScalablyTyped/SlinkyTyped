...
import typingsSlinky.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.Channel
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait CallbackChannelId extends js.Object {
...
object CallbackChannelId {
  ...
  @scala.inline
  def apply(channelId: String, partnerId: String, resource: Channel): CallbackChannelId = {
  ...
  @scala.inline
  implicit class CallbackChannelIdOps[Self <: CallbackChannelId] (val x: Self) extends AnyVal {
