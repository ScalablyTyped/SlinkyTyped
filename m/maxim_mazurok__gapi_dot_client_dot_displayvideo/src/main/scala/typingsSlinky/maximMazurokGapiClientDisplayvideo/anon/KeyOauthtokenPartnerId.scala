...
@js.native
trait KeyOauthtokenPartnerId extends StObject {
...
object KeyOauthtokenPartnerId {
  ...
  @scala.inline
  def apply(resource: InventorySourceGroup): KeyOauthtokenPartnerId = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyOauthtokenPartnerId]
  }
  
  @scala.inline
  implicit class KeyOauthtokenPartnerIdMutableBuilder[Self <: KeyOauthtokenPartnerId] (val x: Self) extends AnyVal {
