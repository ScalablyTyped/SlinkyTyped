...
@js.native
trait FirstAndThirdPartyAudienceId extends StObject {
  ...
  var firstAndThirdPartyAudienceId: String = js.native
...
object FirstAndThirdPartyAudienceId {
  
  @scala.inline
  def apply(firstAndThirdPartyAudienceId: String): FirstAndThirdPartyAudienceId = {
    val __obj = js.Dynamic.literal(firstAndThirdPartyAudienceId = firstAndThirdPartyAudienceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FirstAndThirdPartyAudienceId]
  }
  
  @scala.inline
  implicit class FirstAndThirdPartyAudienceIdMutableBuilder[Self <: FirstAndThirdPartyAudienceId] (val x: Self) extends AnyVal {
