...
@js.native
trait FirstAndThirdPartyAudienceId extends js.Object {
...
object FirstAndThirdPartyAudienceId {
  ...
  @scala.inline
  implicit class FirstAndThirdPartyAudienceIdOps[Self <: FirstAndThirdPartyAudienceId] (val x: Self) extends AnyVal {
