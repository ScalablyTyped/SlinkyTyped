...
@js.native
trait AssignedTargetingOptionIdCallback extends StObject {
...
object AssignedTargetingOptionIdCallback {
  
  @scala.inline
  def apply(assignedTargetingOptionId: String, partnerId: String, targetingType: String): AssignedTargetingOptionIdCallback = {
    ...
    __obj.asInstanceOf[AssignedTargetingOptionIdCallback]
  }
  
  @scala.inline
  implicit class AssignedTargetingOptionIdCallbackMutableBuilder[Self <: AssignedTargetingOptionIdCallback] (val x: Self) extends AnyVal {
