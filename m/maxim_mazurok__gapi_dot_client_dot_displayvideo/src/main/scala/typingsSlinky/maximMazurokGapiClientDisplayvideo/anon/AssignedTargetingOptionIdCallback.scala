...
@js.native
trait AssignedTargetingOptionIdCallback extends js.Object {
...
object AssignedTargetingOptionIdCallback {
  ...
  @scala.inline
  implicit class AssignedTargetingOptionIdCallbackOps[Self <: AssignedTargetingOptionIdCallback] (val x: Self) extends AnyVal {
