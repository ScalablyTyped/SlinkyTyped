...
@js.native
trait KeyNegativeKeywordListId extends StObject {
...
object KeyNegativeKeywordListId {
  
  @scala.inline
  def apply(advertiserId: String, negativeKeywordListId: String): KeyNegativeKeywordListId = {
    ...
    __obj.asInstanceOf[KeyNegativeKeywordListId]
  }
  
  @scala.inline
  implicit class KeyNegativeKeywordListIdMutableBuilder[Self <: KeyNegativeKeywordListId] (val x: Self) extends AnyVal {
