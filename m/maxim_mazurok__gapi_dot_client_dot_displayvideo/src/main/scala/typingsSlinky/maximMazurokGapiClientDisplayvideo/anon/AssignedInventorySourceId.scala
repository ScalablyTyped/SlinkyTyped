...
@js.native
trait AssignedInventorySourceId extends StObject {
  ...
  var assignedInventorySourceId: String = js.native
...
object AssignedInventorySourceId {
  
  @scala.inline
  def apply(assignedInventorySourceId: String, inventorySourceGroupId: String): AssignedInventorySourceId = {
    val __obj = js.Dynamic.literal(assignedInventorySourceId = assignedInventorySourceId.asInstanceOf[js.Any], inventorySourceGroupId = inventorySourceGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AssignedInventorySourceId]
  }
  
  @scala.inline
  implicit class AssignedInventorySourceIdMutableBuilder[Self <: AssignedInventorySourceId] (val x: Self) extends AnyVal {
