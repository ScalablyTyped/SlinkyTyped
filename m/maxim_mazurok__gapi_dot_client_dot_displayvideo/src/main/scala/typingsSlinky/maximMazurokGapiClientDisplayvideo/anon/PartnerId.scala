...
import typingsSlinky.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.Site
...
object PartnerId {
  ...
  @scala.inline
  def apply(advertiserId: String, channelId: String, resource: Site): PartnerId = {
