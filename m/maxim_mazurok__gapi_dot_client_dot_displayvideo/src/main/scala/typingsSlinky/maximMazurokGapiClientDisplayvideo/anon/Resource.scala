...
import typingsSlinky.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.BulkEditSitesRequest
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: BulkEditSitesRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(channelId: String, partnerId: String, resource: BulkEditSitesRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: BulkEditSitesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
