...
@js.native
trait TargetingType extends StObject {
...
object TargetingType {
  ...
  @scala.inline
  def apply(advertiserId: String, lineItemId: String, targetingType: String): TargetingType = {
  ...
  @scala.inline
  implicit class TargetingTypeMutableBuilder[Self <: TargetingType] (val x: Self) extends AnyVal {
