...
@js.native
trait StaticRouteConfig extends js.Object {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientTrafficdirector.maximMazurokGapiClientTrafficdirectorStrings.StaticRouteConfig with TopLevel[js.Any]
  ] = js.native
}
object StaticRouteConfig {
  ...
  @scala.inline
  implicit class StaticRouteConfigOps[Self <: StaticRouteConfig] (val x: Self) extends AnyVal {
