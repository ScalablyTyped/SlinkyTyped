...
import typingsSlinky.maximMazurokGapiClientFirebase.gapi.client.firebase.FinalizeDefaultLocationRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: FinalizeDefaultLocationRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: FinalizeDefaultLocationRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: FinalizeDefaultLocationRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
