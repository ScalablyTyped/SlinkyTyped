...
@js.native
trait AccountsUpdateLabelsResponse extends js.Object {
...
object AccountsUpdateLabelsResponse {
  ...
  @scala.inline
  implicit class AccountsUpdateLabelsResponseOps[Self <: AccountsUpdateLabelsResponse] (val x: Self) extends AnyVal {
