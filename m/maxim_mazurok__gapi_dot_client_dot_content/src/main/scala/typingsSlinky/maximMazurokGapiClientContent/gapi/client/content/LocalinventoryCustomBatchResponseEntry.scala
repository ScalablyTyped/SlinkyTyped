...
@js.native
trait LocalinventoryCustomBatchResponseEntry extends js.Object {
...
object LocalinventoryCustomBatchResponseEntry {
  ...
  @scala.inline
  implicit class LocalinventoryCustomBatchResponseEntryOps[Self <: LocalinventoryCustomBatchResponseEntry] (val x: Self) extends AnyVal {
