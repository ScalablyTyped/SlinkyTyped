...
object LiasettingsSetInventoryVerificationContactResponse {
  ...
  @scala.inline
  implicit class LiasettingsSetInventoryVerificationContactResponseOps[Self <: LiasettingsSetInventoryVerificationContactResponse] (val x: Self) extends AnyVal {
