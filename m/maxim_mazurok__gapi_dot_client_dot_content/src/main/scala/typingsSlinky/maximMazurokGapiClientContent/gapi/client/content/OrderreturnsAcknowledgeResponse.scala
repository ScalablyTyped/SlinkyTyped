...
@js.native
trait OrderreturnsAcknowledgeResponse extends js.Object {
...
object OrderreturnsAcknowledgeResponse {
  ...
  @scala.inline
  implicit class OrderreturnsAcknowledgeResponseOps[Self <: OrderreturnsAcknowledgeResponse] (val x: Self) extends AnyVal {
