...
@js.native
trait OrderreturnsProcessResponse extends js.Object {
...
object OrderreturnsProcessResponse {
  ...
  @scala.inline
  def apply(): OrderreturnsProcessResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrderreturnsProcessResponse]
  }
  
  @scala.inline
  implicit class OrderreturnsProcessResponseOps[Self <: OrderreturnsProcessResponse] (val x: Self) extends AnyVal {
