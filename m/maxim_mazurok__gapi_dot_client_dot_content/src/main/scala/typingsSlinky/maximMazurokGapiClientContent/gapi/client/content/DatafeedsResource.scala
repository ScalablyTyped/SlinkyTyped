...
import typingsSlinky.maximMazurokGapiClientContent.anon.CallbackDatafeedId
import typingsSlinky.maximMazurokGapiClientContent.anon.CallbackFields
import typingsSlinky.maximMazurokGapiClientContent.anon.DatafeedId
import typingsSlinky.maximMazurokGapiClientContent.anon.FieldsKey
