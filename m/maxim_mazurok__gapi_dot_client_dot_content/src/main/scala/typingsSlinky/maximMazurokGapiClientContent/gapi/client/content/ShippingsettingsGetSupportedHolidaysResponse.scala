...
object ShippingsettingsGetSupportedHolidaysResponse {
  ...
  implicit class ShippingsettingsGetSupportedHolidaysResponseOps[Self <: ShippingsettingsGetSupportedHolidaysResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHolidaysVarargs(value: HolidaysHoliday*): Self = this.set("holidays", js.Array(value :_*))
    
    @scala.inline
    def setHolidays(value: js.Array[HolidaysHoliday]): Self = this.set("holidays", value.asInstanceOf[js.Any])
