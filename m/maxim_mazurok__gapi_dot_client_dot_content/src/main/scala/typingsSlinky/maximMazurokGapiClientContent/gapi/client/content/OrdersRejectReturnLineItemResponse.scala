...
object OrdersRejectReturnLineItemResponse {
  ...
  @scala.inline
  def apply(): OrdersRejectReturnLineItemResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrdersRejectReturnLineItemResponse]
  }
  
  @scala.inline
  implicit class OrdersRejectReturnLineItemResponseMutableBuilder[Self <: OrdersRejectReturnLineItemResponse] (val x: Self) extends AnyVal {
