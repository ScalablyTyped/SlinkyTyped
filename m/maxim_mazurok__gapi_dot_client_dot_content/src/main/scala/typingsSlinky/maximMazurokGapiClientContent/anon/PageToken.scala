...
trait PageToken extends StObject {
  ...
  var destinations: js.UndefOr[String | js.Array[String]] = js.native
...
object PageToken {
  ...
  implicit class PageTokenMutableBuilder[Self <: PageToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDestinations(value: String | js.Array[String]): Self = StObject.set(x, "destinations", value.asInstanceOf[js.Any])
