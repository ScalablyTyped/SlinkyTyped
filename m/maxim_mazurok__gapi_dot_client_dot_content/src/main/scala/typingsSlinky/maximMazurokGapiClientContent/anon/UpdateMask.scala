...
import typingsSlinky.maximMazurokGapiClientContent.gapi.client.content.Region
...
object UpdateMask {
  ...
  @scala.inline
  def apply(merchantId: String, regionId: String, resource: Region): UpdateMask = {
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Region): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
