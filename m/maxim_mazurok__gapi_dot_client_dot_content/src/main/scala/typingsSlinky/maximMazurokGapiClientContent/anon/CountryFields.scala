...
@js.native
trait CountryFields extends StObject {
...
object CountryFields {
  
  @scala.inline
  def apply(merchantId: String): CountryFields = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CountryFields]
  }
  
  @scala.inline
  implicit class CountryFieldsMutableBuilder[Self <: CountryFields] (val x: Self) extends AnyVal {
