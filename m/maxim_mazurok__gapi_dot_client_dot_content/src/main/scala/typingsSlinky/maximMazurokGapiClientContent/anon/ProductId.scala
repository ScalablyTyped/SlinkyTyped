...
import typingsSlinky.maximMazurokGapiClientContent.gapi.client.content.LocalInventory
...
trait ProductId extends StObject {
  ...
  /** Request body */
  var resource: LocalInventory = js.native
...
object ProductId {
  ...
  @scala.inline
  def apply(merchantId: String, productId: String, resource: LocalInventory): ProductId = {
  ...
  implicit class ProductIdMutableBuilder[Self <: ProductId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LocalInventory): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
