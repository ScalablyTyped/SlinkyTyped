...
@js.native
trait FeedIdFields extends StObject {
...
object FeedIdFields {
  ...
  @scala.inline
  def apply(merchantId: String): FeedIdFields = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FeedIdFields]
  }
  
  @scala.inline
  implicit class FeedIdFieldsMutableBuilder[Self <: FeedIdFields] (val x: Self) extends AnyVal {
