...
@js.native
trait TransactionIds extends StObject {
  ...
  var transactionIds: js.UndefOr[String | js.Array[String]] = js.native
...
object TransactionIds {
  ...
  @scala.inline
  def apply(merchantId: String, settlementId: String): TransactionIds = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], settlementId = settlementId.asInstanceOf[js.Any])
    __obj.asInstanceOf[TransactionIds]
  }
  
  @scala.inline
  implicit class TransactionIdsMutableBuilder[Self <: TransactionIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransactionIds(value: String | js.Array[String]): Self = StObject.set(x, "transactionIds", value.asInstanceOf[js.Any])
