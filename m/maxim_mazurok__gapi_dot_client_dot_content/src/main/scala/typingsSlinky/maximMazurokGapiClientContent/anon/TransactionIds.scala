...
@js.native
trait TransactionIds extends js.Object {
...
object TransactionIds {
  ...
  @scala.inline
  implicit class TransactionIdsOps[Self <: TransactionIds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransactionIds(value: String | js.Array[String]): Self = this.set("transactionIds", value.asInstanceOf[js.Any])
