...
@js.native
trait DisbursementEndDate extends StObject {
...
object DisbursementEndDate {
  
  @scala.inline
  def apply(merchantId: String): DisbursementEndDate = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DisbursementEndDate]
  }
  
  @scala.inline
  implicit class DisbursementEndDateMutableBuilder[Self <: DisbursementEndDate] (val x: Self) extends AnyVal {
