...
@js.native
trait QuotaUserRegionId extends StObject {
...
object QuotaUserRegionId {
  
  @scala.inline
  def apply(merchantId: String): QuotaUserRegionId = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRegionId]
  }
  
  @scala.inline
  implicit class QuotaUserRegionIdMutableBuilder[Self <: QuotaUserRegionId] (val x: Self) extends AnyVal {
