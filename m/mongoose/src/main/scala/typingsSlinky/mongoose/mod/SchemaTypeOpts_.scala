...
object SchemaTypeOpts_ {
  ...
  implicit class SchemaTypeOpts_Ops[Self <: SchemaTypeOpts_[_], T] (val x: Self with SchemaTypeOpts_[T]) extends AnyVal {
    ...
    @scala.inline
    def setMatch(value: js.RegExp | (js.Tuple2[js.RegExp, String]) | js.Any): Self = this.set("match", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMatch: Self = this.set("match", js.undefined)
    @scala.inline
    def setMaxDate(value: js.Date): Self = this.set("max", value.asInstanceOf[js.Any])
    @scala.inline
    def setMax(value: Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any): Self = this.set("max", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMin(value: Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any): Self = this.set("min", value.asInstanceOf[js.Any])
    @scala.inline
