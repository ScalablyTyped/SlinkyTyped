...
import typingsSlinky.mongoose.TypeofArray
import typingsSlinky.mongoose.TypeofBoolean
import typingsSlinky.mongoose.TypeofBuffer
import typingsSlinky.mongoose.TypeofDate
import typingsSlinky.mongoose.TypeofDecimal128
import typingsSlinky.mongoose.TypeofDocumentArray
import typingsSlinky.mongoose.TypeofMixed
import typingsSlinky.mongoose.TypeofNumber
import typingsSlinky.mongoose.TypeofObjectId
import typingsSlinky.mongoose.TypeofString
