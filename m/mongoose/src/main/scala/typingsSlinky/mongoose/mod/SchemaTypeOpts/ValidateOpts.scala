...
object ValidateOpts {
  ...
  implicit class ValidateOptsOps[Self <: ValidateOpts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidatorRegExp(value: js.RegExp): Self = this.set("validator", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValidator(value: js.RegExp | ValidateFn[_]): Self = this.set("validator", value.asInstanceOf[js.Any])
