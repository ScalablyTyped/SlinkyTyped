...
/* Inlined {  rawResult  :true} & mongoose.mongoose.QueryFindOneAndUpdateOptions */
trait rawResulttrueQueryFindOneContext extends js.Object {
  /**
...
object rawResulttrueQueryFindOneContext {
  @scala.inline
  def apply(
    context: String = null,
  ...
  ): rawResulttrueQueryFindOneContext = {
    ...
    __obj.asInstanceOf[rawResulttrueQueryFindOneContext]
  }
}
