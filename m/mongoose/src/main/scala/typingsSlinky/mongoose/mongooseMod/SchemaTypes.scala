...
import typingsSlinky.mongoose.TypeofClassArray
import typingsSlinky.mongoose.TypeofClassBoolean
import typingsSlinky.mongoose.TypeofClassBuffer
import typingsSlinky.mongoose.TypeofClassDate
import typingsSlinky.mongoose.TypeofClassDecimal128
import typingsSlinky.mongoose.TypeofClassDocumentArray
import typingsSlinky.mongoose.TypeofClassMixed
import typingsSlinky.mongoose.TypeofClassNumber
import typingsSlinky.mongoose.TypeofClassObjectId
import typingsSlinky.mongoose.TypeofClassString
  ...
  object Embedded
    extends TopLevel[
          Instantiable3[
            ...
            typingsSlinky.mongoose.mongooseMod.Schema.Types.Embedded
          ]
        ]
  ...
  object Map
    extends TopLevel[
          Instantiable2[
            /* key */ String, 
            js.UndefOr[/* options */ js.Any], 
            typingsSlinky.mongoose.mongooseMod.Schema.Types.Map
          ]
        ]
