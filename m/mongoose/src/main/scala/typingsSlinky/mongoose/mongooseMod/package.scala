...
package object mongooseMod {
  ...
  type CastError = typingsSlinky.mongoose.mongooseMod.Error.CastError
  type ClientSession = typingsSlinky.mongodb.mongodbMod.ClientSession
  ...
  /*
    ...
    */
  type NativeBuffer = typingsSlinky.node.TypeofClassBuffer
