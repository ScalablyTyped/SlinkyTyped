...
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.AsyncPromiseValidationFn
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.AsyncPromiseValidationOpts
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.AsyncValidateOpts
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.DefaultFn
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.EnumOpts
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.IndexOpts
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.RequiredFn
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.ValidateFn
import typingsSlinky.mongoose.mongooseMod.SchemaTypeOpts.ValidateOpts
...
trait SchemaTypeOpts_[T]
  ...
  var `match`: js.UndefOr[js.RegExp | (js.Tuple2[js.RegExp, String]) | js.Any] = js.undefined
  /**
    * Date, Number only - Sets a maximum number validator.
    * Sets a maximum date validator.
    */
  var max: js.UndefOr[Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any] = js.undefined
  ...
  /**
    ...
    */
  var min: js.UndefOr[Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any] = js.undefined
...
object SchemaTypeOpts_ {
  ...
  def apply[T](
    ...
    `match`: js.RegExp | (js.Tuple2[js.RegExp, String]) | js.Any = null,
    max: Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any = null,
    maxlength: Double | (js.Tuple2[Double, String]) | js.Any = null,
    min: Double | (js.Tuple2[js.Date | Double, String]) | js.Date | js.Any = null,
    ...
    validate: js.RegExp | (js.Tuple2[AsyncPromiseValidationFn[T] | js.RegExp | ValidateFn[T], String]) | ValidateFn[T] | ValidateOpts | AsyncValidateOpts | AsyncPromiseValidationFn[T] | AsyncPromiseValidationOpts | (js.Array[
      ValidateOpts | AsyncValidateOpts | AsyncPromiseValidationFn[T] | AsyncPromiseValidationOpts
    ]) = null
  ): SchemaTypeOpts_[T] = {
