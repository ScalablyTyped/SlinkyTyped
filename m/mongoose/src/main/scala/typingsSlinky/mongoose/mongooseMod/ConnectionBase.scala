...
import typingsSlinky.mongodb.mongodbMod.CollectionCreateOptions
...
trait ConnectionBase extends EventEmitter {
  ...
  def createCollection[T](name: String): js.Promise[typingsSlinky.mongodb.mongodbMod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    cb: js.Function2[
      /* err */ js.Any, 
      /* collection */ typingsSlinky.mongodb.mongodbMod.Collection[T], 
      Unit
    ]
  ): js.Promise[Unit] = js.native
  def createCollection[T](name: String, options: CollectionCreateOptions): js.Promise[typingsSlinky.mongodb.mongodbMod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    options: CollectionCreateOptions,
    cb: js.Function2[
      /* err */ js.Any, 
      /* collection */ typingsSlinky.mongodb.mongodbMod.Collection[DefaultSchema], 
      Unit
    ]
  ): js.Promise[typingsSlinky.mongodb.mongodbMod.Collection[T]] = js.native
  /**
