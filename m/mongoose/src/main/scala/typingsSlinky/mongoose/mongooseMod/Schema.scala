...
import typingsSlinky.mongoose.Anon_AutoIndexId
...
trait Schema[T] extends EventEmitter {
  ...
  def index(fields: js.Any, options: Anon_Expires): this.type = js.native
  ...
  def pre[T /* <: Document | (Model[Document, js.Object]) | Query[_] | Aggregate[_] */](method: String, fn: HookSyncCallback[T]): this.type = js.native
  ...
  @JSName("pre")
  def pre_insertMany[T /* <: Model[Document, js.Object] */](method: insertMany, fn: HookSyncCallback[T]): this.type = js.native
  @JSName("pre")
  def pre_insertMany[T /* <: Model[Document, js.Object] */](method: insertMany, fn: HookSyncCallback[T], errorCb: HookErrorCallback): this.type = js.native
  @JSName("pre")
  def pre_insertMany[T /* <: Model[Document, js.Object] */](method: insertMany, parallel: Boolean, fn: HookAsyncCallback[T]): this.type = js.native
  @JSName("pre")
  def pre_insertMany[T /* <: Model[Document, js.Object] */](method: insertMany, parallel: Boolean, fn: HookAsyncCallback[T], errorCb: HookErrorCallback): this.type = js.native
  @JSName("pre")
  ...
  @JSName("set")
  def set_capped(key: capped): Boolean | Double | Anon_AutoIndexId = js.native
  @JSName("set")
  def set_capped(key: capped, value: Boolean): this.type = js.native
  @JSName("set")
  def set_capped(key: capped, value: Double): this.type = js.native
  @JSName("set")
  def set_capped(key: capped, value: Anon_AutoIndexId): this.type = js.native
  @JSName("set")
  ...
  @JSName("set")
  def set_safe(key: safe): Boolean | Anon_J = js.native
  @JSName("set")
  def set_safe(key: safe, value: Boolean): this.type = js.native
  @JSName("set")
  def set_safe(key: safe, value: Anon_J): this.type = js.native
  @JSName("set")
