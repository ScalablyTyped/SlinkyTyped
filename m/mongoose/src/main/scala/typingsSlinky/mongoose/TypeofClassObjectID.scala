...
@js.native
trait TypeofClassObjectID extends Instantiable0[ObjectID] {
...
trait TypeofClassObjectId
  extends Instantiable1[/* key */ String, typingsSlinky.mongoose.mongooseMod.Schema.Types.ObjectId]
     with Instantiable2[
      /* key */ String, 
      /* options */ js.Any, 
      typingsSlinky.mongoose.mongooseMod.Schema.Types.ObjectId
    ] {
