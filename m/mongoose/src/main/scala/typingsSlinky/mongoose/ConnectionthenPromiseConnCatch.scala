...
@js.native
trait ConnectionthenPromiseConnCatch extends js.Object {
  @JSName("catch")
  ...
  def createCollection[T](name: String): js.Promise[typingsSlinky.mongodb.mod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    cb: js.Function2[/* err */ js.Any, /* collection */ typingsSlinky.mongodb.mod.Collection[T], Unit]
  ): js.Promise[Unit] = js.native
  def createCollection[T](name: String, options: CollectionCreateOptions): js.Promise[typingsSlinky.mongodb.mod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    options: CollectionCreateOptions,
    cb: js.Function2[
      /* err */ js.Any, 
      /* collection */ typingsSlinky.mongodb.mod.Collection[DefaultSchema], 
      Unit
    ]
  ): js.Promise[typingsSlinky.mongodb.mod.Collection[T]] = js.native
  /**
  ...
  def openUri(uri: String, options: ConnectionOptions): ConnectionthenPromiseConnAddListener = js.native
  def openUri(
    uri: String,
    options: ConnectionOptions,
    callback: js.Function2[/* err */ js.Any, /* conn */ js.UndefOr[Connection_], Unit]
  ): ConnectionthenPromiseConnAddListener = js.native
  @JSName("openUri")
