...
import typingsSlinky.atMaterialMenu.atMaterialMenuStrings.`mdc-list-item--selected`
import typingsSlinky.atMaterialMenu.atMaterialMenuStrings.`mdc-menu--animating-closed`
import typingsSlinky.atMaterialMenu.atMaterialMenuStrings.`mdc-menu--animating-open`
import typingsSlinky.atMaterialMenu.atMaterialMenuStrings.`mdc-menu--open`
import typingsSlinky.atMaterialMenu.atMaterialMenuStrings.`mdc-menu`
