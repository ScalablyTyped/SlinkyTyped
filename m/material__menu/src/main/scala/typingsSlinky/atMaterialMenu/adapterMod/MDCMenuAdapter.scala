package typingsSlinky.atMaterialMenu.adapterMod

import org.scalajs.dom.raw.EventTarget
import typingsSlinky.atMaterialMenu.Anon_Bottom
import typingsSlinky.atMaterialMenu.Anon_BottomLeft
import typingsSlinky.atMaterialMenu.Anon_Height
import typingsSlinky.atMaterialMenu.Anon_Index
...
trait MDCMenuAdapter extends js.Object {
  ...
  def getAnchorDimensions(): Anon_Bottom
  ...
  def getInnerDimensions(): Anon_Height
  def getNumberOfItems(): Double
  def getWindowDimensions(): Anon_Height
  ...
  def notifySelected(evtData: Anon_Index): Unit
  ...
  def setPosition(position: Anon_BottomLeft): Unit
...
object MDCMenuAdapter {
  ...
  def apply(
    ...
    isRtl: () => Boolean,
    notifyCancel: () => Unit,
    notifySelected: Anon_Index => Unit,
    ...
    setPosition: Anon_BottomLeft => Unit,
