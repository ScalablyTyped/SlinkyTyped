...
import typingsSlinky.materialMenu.anon.Bottom
import typingsSlinky.materialMenu.anon.Height
import typingsSlinky.materialMenu.anon.Index
import typingsSlinky.materialMenu.anon.Left
...
trait MDCMenuAdapter extends js.Object {
  ...
  def getAnchorDimensions(): Bottom = js.native
  ...
  def getInnerDimensions(): Height = js.native
  def getNumberOfItems(): Double = js.native
  def getWindowDimensions(): Height = js.native
  ...
  def notifySelected(evtData: Index): Unit = js.native
  ...
  def setPosition(position: Left): Unit = js.native
...
object MDCMenuAdapter {
  ...
  implicit class MDCMenuAdapterOps[Self <: MDCMenuAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAnchorDimensions(value: () => Bottom): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetInnerDimensions(value: () => Height): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetWindowDimensions(value: () => Height): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNotifySelected(value: Index => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetPosition(value: Left => Unit): Self = {
        val ret = this.duplicate
