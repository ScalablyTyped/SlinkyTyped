...
@js.native
trait AltAppsId extends StObject {
...
object AltAppsId {
  ...
  @scala.inline
  def apply(appsId: String, servicesId: String): AltAppsId = {
    val __obj = js.Dynamic.literal(appsId = appsId.asInstanceOf[js.Any], servicesId = servicesId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltAppsId]
  }
  
  @scala.inline
  implicit class AltAppsIdMutableBuilder[Self <: AltAppsId] (val x: Self) extends AnyVal {
