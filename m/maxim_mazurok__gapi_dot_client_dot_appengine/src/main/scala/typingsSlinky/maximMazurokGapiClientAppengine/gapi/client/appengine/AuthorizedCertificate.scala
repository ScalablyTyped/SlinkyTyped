...
trait AuthorizedCertificate extends StObject {
  ...
  /**
    ...
    */
  var managedCertificate: js.UndefOr[ManagedCertificate] = js.native
...
object AuthorizedCertificate {
  ...
  @scala.inline
  implicit class AuthorizedCertificateMutableBuilder[Self <: AuthorizedCertificate] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCertificateRawData(value: CertificateRawData): Self = StObject.set(x, "certificateRawData", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setManagedCertificate(value: ManagedCertificate): Self = StObject.set(x, "managedCertificate", value.asInstanceOf[js.Any])
