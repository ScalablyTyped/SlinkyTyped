...
import typingsSlinky.matrixAppserviceBridge.anon.Conflict
import typingsSlinky.matrixAppserviceBridge.appServiceBotMod.AppServiceBot
...
object roomLinkValidatorMod {
  ...
  class RoomLinkValidator protected () extends StObject {
    /**
      ...
      */
    def this(config: typingsSlinky.matrixAppserviceBridge.anon.Rules, asBot: AppServiceBot) = this()
  ...
  object RoomLinkValidatorStatus extends StObject {
    ...
    /* 3 */ val ERROR: typingsSlinky.matrixAppserviceBridge.roomLinkValidatorMod.RoomLinkValidatorStatus.ERROR with Double = js.native
    
    @js.native
    sealed trait ERROR_CACHED extends RoomLinkValidatorStatus
    /* 2 */ val ERROR_CACHED: typingsSlinky.matrixAppserviceBridge.roomLinkValidatorMod.RoomLinkValidatorStatus.ERROR_CACHED with Double = js.native
    
    @js.native
    sealed trait ERROR_USER_CONFLICT extends RoomLinkValidatorStatus
    /* 1 */ val ERROR_USER_CONFLICT: typingsSlinky.matrixAppserviceBridge.roomLinkValidatorMod.RoomLinkValidatorStatus.ERROR_USER_CONFLICT with Double = js.native
    
    @js.native
    sealed trait PASSED extends RoomLinkValidatorStatus
    /* 0 */ val PASSED: typingsSlinky.matrixAppserviceBridge.roomLinkValidatorMod.RoomLinkValidatorStatus.PASSED with Double = js.native
  }
