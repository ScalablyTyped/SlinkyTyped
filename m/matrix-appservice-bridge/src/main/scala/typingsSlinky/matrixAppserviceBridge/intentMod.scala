...
import typingsSlinky.matrixAppserviceBridge.anon.EnsureClientSyncingCallback
import typingsSlinky.matrixAppserviceBridge.anon.Eventid
import typingsSlinky.matrixAppserviceBridge.anon.Roomid
import typingsSlinky.matrixAppserviceBridge.anon.Size
import typingsSlinky.matrixAppserviceBridge.anon.Statekey
import typingsSlinky.matrixAppserviceBridge.errorsMod.unstable.BridgeErrorReason
...
import typingsSlinky.matrixAppserviceBridge.membershipCacheMod.UserProfile
...
object intentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.matrixAppserviceBridge.matrixAppserviceBridgeStrings.avatar_url
    - typingsSlinky.matrixAppserviceBridge.matrixAppserviceBridgeStrings.displayname
    - scala.Null
  */
