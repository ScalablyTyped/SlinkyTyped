...
import typingsSlinky.matrixAppserviceBridge.configValidatorMod.Schema
...
class ConfigValidator protected ()
  extends typingsSlinky.matrixAppserviceBridge.configValidatorMod.ConfigValidator {
  /**
...
object ConfigValidator {
  ...
  @js.native
  def fromSchemaFile(filename: String): typingsSlinky.matrixAppserviceBridge.configValidatorMod.ConfigValidator = js.native
