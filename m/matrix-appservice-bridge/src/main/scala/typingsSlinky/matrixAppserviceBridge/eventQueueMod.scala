...
import typingsSlinky.matrixAppserviceBridge.anon.`0`
...
object eventQueueMod {
  ...
  class EventQueue protected () extends StObject {
    ...
    /* protected */ def consumeFn(error: js.Error, event: js.Any): Unit = js.native
  ...
  type ConsumeCallback = js.Function2[/* error */ js.Error | Null, /* event */ js.Any, Unit]
