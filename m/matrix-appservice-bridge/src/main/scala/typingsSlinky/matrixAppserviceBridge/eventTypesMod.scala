...
import typingsSlinky.matrixAppserviceBridge.anon.Currentlyactive
import typingsSlinky.matrixAppserviceBridge.anon.Mread
import typingsSlinky.matrixAppserviceBridge.anon.Userids
import typingsSlinky.matrixAppserviceBridge.matrixAppserviceBridgeStrings.mDotpresence
import typingsSlinky.matrixAppserviceBridge.matrixAppserviceBridgeStrings.mDotreceipt
import typingsSlinky.matrixAppserviceBridge.matrixAppserviceBridgeStrings.mDottyping
...
object eventTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.matrixAppserviceBridge.eventTypesMod.TypingEvent
    - typingsSlinky.matrixAppserviceBridge.eventTypesMod.ReadReceiptEvent
    - typingsSlinky.matrixAppserviceBridge.eventTypesMod.PresenceEvent
  */
  trait EphemeralEvent extends StObject
  object EphemeralEvent {
    
    @scala.inline
    def PresenceEvent(content: Currentlyactive, sender: String, `type`: mDotpresence): typingsSlinky.matrixAppserviceBridge.eventTypesMod.PresenceEvent = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.matrixAppserviceBridge.eventTypesMod.PresenceEvent]
    }
    
    @scala.inline
    def ReadReceiptEvent(content: StringDictionary[Mread], room_id: String, `type`: mDotreceipt): typingsSlinky.matrixAppserviceBridge.eventTypesMod.ReadReceiptEvent = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], room_id = room_id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.matrixAppserviceBridge.eventTypesMod.ReadReceiptEvent]
    }
    
    @scala.inline
    def TypingEvent(content: Userids, room_id: String, `type`: mDottyping): typingsSlinky.matrixAppserviceBridge.eventTypesMod.TypingEvent = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], room_id = room_id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.matrixAppserviceBridge.eventTypesMod.TypingEvent]
    }
  }
