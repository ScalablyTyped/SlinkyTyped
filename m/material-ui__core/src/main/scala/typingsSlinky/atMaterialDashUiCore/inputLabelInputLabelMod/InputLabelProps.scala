package typingsSlinky.atMaterialDashUiCore.inputLabelInputLabelMod
...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapFormLabelClassKey
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapInputLabelClassKey
...
import typingsSlinky.atMaterialDashUiCore.formLabelFormLabelMod.FormLabelBaseProps
...
trait InputLabelProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[FormLabelBaseProps]] = js.undefined
...
object InputLabelProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLLabelElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLLabelElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLLabelElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLLabelElement] => Unit = null,
