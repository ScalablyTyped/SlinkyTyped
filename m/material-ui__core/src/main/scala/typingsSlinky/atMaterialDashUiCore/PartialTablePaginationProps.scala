...
trait PartialTablePaginationProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[TablePaginationBaseProps]] = js.undefined
  ...
  var labelDisplayedRows: js.UndefOr[js.Function1[/* paginationInfo */ LabelDisplayedRowsArgs, TagMod[Any]]] = js.undefined
  var labelRowsPerPage: js.UndefOr[TagMod[Any]] = js.undefined
  ...
  var onChangeRowsPerPage: js.UndefOr[ChangeEventHandler[HTMLTextAreaElement | HTMLInputElement]] = js.undefined
...
object PartialTablePaginationProps {
  ...
  def apply(
    ...
    onChangePage: (/* event */ SyntheticMouseEvent[HTMLButtonElement] | Null, /* page */ Double) => Unit = null,
