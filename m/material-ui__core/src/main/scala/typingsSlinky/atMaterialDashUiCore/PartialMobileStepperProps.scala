...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.dots
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.progress
...
trait PartialMobileStepperProps extends js.Object {
  var LinearProgressProps: js.UndefOr[PartialLinearProgressProps] = js.undefined
  ...
  var backButton: js.UndefOr[ReactElement] = js.undefined
  ...
  var nextButton: js.UndefOr[ReactElement] = js.undefined
  ...
  var position: js.UndefOr[bottom | top | static] = js.undefined
  ...
  var variant: js.UndefOr[text | dots | progress] = js.undefined
...
object PartialMobileStepperProps {
  ...
  def apply(
    ...
    position: bottom | top | static = null,
    prefix: String = null,
    ...
    __obj.asInstanceOf[PartialMobileStepperProps]
  }
}
