...
trait PartialSnackbarContentProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapSnackbarContentClassKey] = js.undefined
...
object PartialSnackbarContentProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[PartialSnackbarContentProps]
  }
}
