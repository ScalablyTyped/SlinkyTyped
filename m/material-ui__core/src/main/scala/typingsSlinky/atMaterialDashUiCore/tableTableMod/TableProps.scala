package typingsSlinky.atMaterialDashUiCore.tableTableMod
...
trait TableProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[TableBaseProps]] = js.undefined
...
object TableProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLTableElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    ...
    onSeeked: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLTableElement] => Unit = null,
