package typingsSlinky.atMaterialDashUiCore.tabsTabScrollButtonMod
...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTabScrollButtonClassKey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/Tabs/TabScrollButton.TabScrollButtonClassKey, never> */
trait TabScrollButtonProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTabScrollButtonClassKey] = js.undefined
...
object TabScrollButtonProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabScrollButtonProps]
  }
}
