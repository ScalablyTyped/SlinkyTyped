...
trait OmitGridPropsStrippedProps extends js.Object {
...
object OmitGridPropsStrippedProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    __obj.asInstanceOf[OmitGridPropsStrippedProps]
  }
}
