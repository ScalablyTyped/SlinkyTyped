package typingsSlinky.atMaterialDashUiCore.expansionPanelSummaryExpansionPanelSummaryMod
...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapExpansionPanelSummaryClassKey
...
object ExpansionPanelSummaryProps {
  ...
  def apply(
    ...
    onChange: SyntheticEvent[Event, js.Object] => Unit = null,
