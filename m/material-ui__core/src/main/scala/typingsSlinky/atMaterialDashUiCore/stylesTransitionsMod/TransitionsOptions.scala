...
import typingsSlinky.atMaterialDashUiCore.PartialDuration
import typingsSlinky.atMaterialDashUiCore.PartialEasing
import typingsSlinky.atMaterialDashUiCore.Partialdurationnumberstringeasingstringdelaynumber
