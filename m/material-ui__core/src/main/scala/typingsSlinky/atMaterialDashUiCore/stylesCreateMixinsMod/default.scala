package typingsSlinky.atMaterialDashUiCore.stylesCreateMixinsMod
...
object default extends js.Object {
  def apply(breakpoints: Breakpoints, spacing: Spacing, mixins: MixinsOptions): Mixins = js.native
}
