...
import typingsSlinky.atMaterialDashUiCore.growGrowMod.GrowProps
import typingsSlinky.atMaterialDashUiCore.growMod.default
...
object Grow
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.growMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
