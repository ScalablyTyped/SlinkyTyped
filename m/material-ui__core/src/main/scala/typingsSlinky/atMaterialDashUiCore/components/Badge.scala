...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapBadgeClassKey
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.dot
...
import typingsSlinky.atMaterialDashUiCore.badgeBadgeMod.BadgeProps
import typingsSlinky.atMaterialDashUiCore.badgeMod.default
...
object Badge
  ...
  def apply(
    ...
    badgeContent: TagMod[Any] = null,
    classes: PartialClassNameMapBadgeClassKey = null,
    color: Color | error = null,
    component: ReactComponentClass[BadgeProps] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.atMaterialDashUiCore.badgeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
