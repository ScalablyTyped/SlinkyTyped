...
import typingsSlinky.atMaterialDashUiCore.iconIconMod.IconProps
import typingsSlinky.atMaterialDashUiCore.iconMod.default
...
object Icon
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.span.tag.type, typingsSlinky.atMaterialDashUiCore.iconMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
