...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTableClassKey
...
import typingsSlinky.atMaterialDashUiCore.tableMod.default
import typingsSlinky.atMaterialDashUiCore.tableTableMod.Padding
import typingsSlinky.atMaterialDashUiCore.tableTableMod.TableBaseProps
import typingsSlinky.atMaterialDashUiCore.tableTableMod.TableProps
...
object Table
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLTableElement, Event] => Unit = null,
  ...
  slinky.web.html.table.tag.type, 
  typingsSlinky.atMaterialDashUiCore.tableMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
