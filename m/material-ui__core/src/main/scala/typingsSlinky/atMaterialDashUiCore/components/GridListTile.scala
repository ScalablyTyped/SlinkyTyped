...
import typingsSlinky.atMaterialDashUiCore.gridListTileMod.default
...
object GridListTile
  ...
  slinky.web.html.li.tag.type, 
  typingsSlinky.atMaterialDashUiCore.gridListTileMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
