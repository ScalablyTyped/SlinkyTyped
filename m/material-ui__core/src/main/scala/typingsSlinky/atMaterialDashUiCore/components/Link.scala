...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapLinkClassKey
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTypographyClassKey
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreMod.PropTypes.Alignment
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.always
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.hover
...
import typingsSlinky.atMaterialDashUiCore.linkLinkMod.LinkProps
import typingsSlinky.atMaterialDashUiCore.linkMod.default
import typingsSlinky.atMaterialDashUiCore.typeinStylestring
import typingsSlinky.atMaterialDashUiCore.typographyTypographyMod.Style
...
object Link
  ...
  def apply(
    ...
    if (TypographyClasses != null) __obj.updateDynamic("TypographyClasses")(TypographyClasses.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.atMaterialDashUiCore.linkMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
