...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapButtonClassKey
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.contained
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.extendedFab
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.fab
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.flat
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.raised
...
import typingsSlinky.atMaterialDashUiCore.buttonButtonMod.ButtonProps
import typingsSlinky.atMaterialDashUiCore.buttonMod.default
...
object Button
  ...
  def apply(
    ...
    color: Color = null,
    component: ReactComponentClass[ButtonProps] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.buttonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
