...
import typingsSlinky.atMaterialDashUiCore.drawerDrawerMod.DrawerProps
import typingsSlinky.atMaterialDashUiCore.drawerMod.default
...
object Drawer
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.atMaterialDashUiCore.drawerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
