...
import typingsSlinky.atMaterialDashUiCore.switchMod.default
import typingsSlinky.atMaterialDashUiCore.switchSwitchMod.SwitchProps
...
object Switch
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.switchMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
