...
import typingsSlinky.atMaterialDashUiCore.chipChipMod.ChipProps
import typingsSlinky.atMaterialDashUiCore.chipMod.default
...
object Chip
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.atMaterialDashUiCore.chipMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
