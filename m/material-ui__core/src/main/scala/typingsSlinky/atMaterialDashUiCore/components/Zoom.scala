...
import typingsSlinky.atMaterialDashUiCore.zoomMod.default
import typingsSlinky.atMaterialDashUiCore.zoomZoomMod.ZoomProps
...
object Zoom
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.zoomMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
