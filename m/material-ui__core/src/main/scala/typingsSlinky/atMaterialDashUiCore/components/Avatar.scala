...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapAvatarClassKey
...
import typingsSlinky.atMaterialDashUiCore.avatarAvatarMod.AvatarProps
import typingsSlinky.atMaterialDashUiCore.avatarMod.default
import typingsSlinky.react.reactMod.CSSProperties
import typingsSlinky.react.reactMod.HtmlHTMLAttributes
...
object Avatar
  ...
  def apply(
    ...
    color: String = null,
    component: ReactComponentClass[AvatarProps] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.atMaterialDashUiCore.avatarMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
