...
import typingsSlinky.atMaterialDashUiCore.fadeFadeMod.FadeProps
import typingsSlinky.atMaterialDashUiCore.fadeMod.default
...
object Fade
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.fadeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
