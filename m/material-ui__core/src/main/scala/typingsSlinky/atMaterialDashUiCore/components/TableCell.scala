...
import typingsSlinky.atMaterialDashUiCore.tableCellTableCellMod.TableCellBaseProps
import typingsSlinky.atMaterialDashUiCore.tableCellTableCellMod.TableCellProps
...
object TableCell
  ...
  typingsSlinky.atMaterialDashUiCore.tableCellMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
