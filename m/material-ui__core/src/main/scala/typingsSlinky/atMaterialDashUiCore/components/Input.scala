...
import typingsSlinky.atMaterialDashUiCore.inputInputMod.InputProps
import typingsSlinky.atMaterialDashUiCore.inputMod.default
...
object Input
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.inputMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
