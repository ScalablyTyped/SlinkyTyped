...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapListClassKey
...
import typingsSlinky.atMaterialDashUiCore.listListMod.ListProps
import typingsSlinky.atMaterialDashUiCore.listMod.default
...
object List
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.atMaterialDashUiCore.listMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
