...
import typingsSlinky.atMaterialDashUiCore.Anon_Checked
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTabClassKey
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.primary
...
import typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.secondary
...
import typingsSlinky.atMaterialDashUiCore.tabMod.default
import typingsSlinky.atMaterialDashUiCore.tabTabMod.TabProps
...
object Tab
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.atMaterialDashUiCore.tabMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TabProps
}
