...
import typingsSlinky.atMaterialDashUiCore.formHelperTextMod.default
...
object FormHelperText
  ...
  slinky.web.html.p.tag.type, 
  typingsSlinky.atMaterialDashUiCore.formHelperTextMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
