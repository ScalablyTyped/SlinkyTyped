...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapCardClassKey
...
import typingsSlinky.atMaterialDashUiCore.cardCardMod.CardProps
import typingsSlinky.atMaterialDashUiCore.cardMod.default
...
object Card
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.atMaterialDashUiCore.cardMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
