...
import typingsSlinky.atMaterialDashUiCore.tablePaginationTablePaginationMod.LabelDisplayedRowsArgs
import typingsSlinky.atMaterialDashUiCore.tablePaginationTablePaginationMod.TablePaginationBaseProps
...
object TablePagination
  ...
  def apply(
    count: Double,
    onChangePage: (SyntheticMouseEvent[HTMLButtonElement] | Null, Double) => Unit,
    page: Double,
    rowsPerPage: Double,
    ...
    if (backIconButtonProps != null) __obj.updateDynamic("backIconButtonProps")(backIconButtonProps.asInstanceOf[js.Any])
    ...
    if (labelRowsPerPage != null) __obj.updateDynamic("labelRowsPerPage")(labelRowsPerPage.asInstanceOf[js.Any])
    if (nextIconButtonProps != null) __obj.updateDynamic("nextIconButtonProps")(nextIconButtonProps.asInstanceOf[js.Any])
