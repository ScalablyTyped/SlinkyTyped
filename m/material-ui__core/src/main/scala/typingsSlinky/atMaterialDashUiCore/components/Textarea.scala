...
import typingsSlinky.atMaterialDashUiCore.inputBaseTextareaMod.TextareaProps
import typingsSlinky.atMaterialDashUiCore.inputBaseTextareaMod.default
...
object Textarea
  ...
  typingsSlinky.atMaterialDashUiCore.inputBaseTextareaMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
