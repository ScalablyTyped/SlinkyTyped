...
import typingsSlinky.atMaterialDashUiCore.tabsTabScrollButtonMod.TabScrollButtonProps
import typingsSlinky.atMaterialDashUiCore.tabsTabScrollButtonMod.default
...
object TabScrollButton
  ...
  typingsSlinky.atMaterialDashUiCore.tabsTabScrollButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
