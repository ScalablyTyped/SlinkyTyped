...
import typingsSlinky.atMaterialDashUiCore.listItemMod.default
...
object ListItem
  ...
  typingsSlinky.atMaterialDashUiCore.listItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
