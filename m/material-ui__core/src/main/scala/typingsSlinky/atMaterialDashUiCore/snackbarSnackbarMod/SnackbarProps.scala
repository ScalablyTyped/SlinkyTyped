...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapSnackbarClassKey
import typingsSlinky.atMaterialDashUiCore.PartialClickAwayListenerProps
import typingsSlinky.atMaterialDashUiCore.PartialSnackbarContentProps
...
trait SnackbarProps extends js.Object {
  var ClickAwayListenerProps: js.UndefOr[PartialClickAwayListenerProps] = js.native
  var ContentProps: js.UndefOr[PartialSnackbarContentProps] = js.native
  var TransitionComponent: js.UndefOr[ReactComponentClass[TransitionProps]] = js.native
  var TransitionProps: js.UndefOr[typingsSlinky.atMaterialDashUiCore.transitionsTransitionMod.TransitionProps] = js.native
  ...
  var classes: js.UndefOr[PartialClassNameMapSnackbarClassKey] = js.native
...
object SnackbarProps {
  ...
  def apply(
    ...
    onClose: (/* event */ SyntheticEvent[Event, _], /* reason */ String) => Unit = null,
    ...
    resumeHideDuration: Int | Double = null,
    role: String = null,
    ...
    if (ClickAwayListenerProps != null) __obj.updateDynamic("ClickAwayListenerProps")(ClickAwayListenerProps.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(disableWindowBlurListener)) __obj.updateDynamic("disableWindowBlurListener")(disableWindowBlurListener.asInstanceOf[js.Any])
