...
trait SnackbarProps extends js.Object {
  ...
  var disableWindowBlurListener: js.UndefOr[Boolean] = js.undefined
  ...
  var onClose: js.UndefOr[js.Function2[/* event */ SyntheticEvent[Event, _], /* reason */ String, Unit]] = js.undefined
