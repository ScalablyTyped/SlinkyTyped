package typingsSlinky.atMaterialDashUiCore.iconIconMod
...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapIconClassKey
...
trait IconProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[IconProps]] = js.undefined
  ...
  var fontSize: js.UndefOr[
    inherit | typingsSlinky.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default | small | large
  ] = js.undefined
...
object IconProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLSpanElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLSpanElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLSpanElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLSpanElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLSpanElement] => Unit = null,
