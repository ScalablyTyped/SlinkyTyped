package typingsSlinky.atMaterialDashUiCore.stepperStepperMod
...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapStepperClasskey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Paper.PaperProps, @material-ui/core.@material-ui/core/Stepper/Stepper.StepperClasskey, never> */
trait StepperProps extends js.Object {
  ...
  var connector: js.UndefOr[ReactElement | TagMod[Any]] = js.undefined
...
object StepperProps {
  ...
  def apply(
    ...
    connector: ReactElement | TagMod[Any] = null,
    ...
    if (!js.isUndefined(nonLinear)) __obj.updateDynamic("nonLinear")(nonLinear.asInstanceOf[js.Any])
