...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTextareaClassKey
...
trait TextareaProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapTextareaClassKey] = js.undefined
  ...
  var textareaRef: js.UndefOr[Ref[_] | ReactRef[_]] = js.undefined
...
object TextareaProps {
  ...
  def apply(
    ...
    onSelect: SyntheticEvent[Event, HTMLTextAreaElement] => Unit = null,
    ...
    textareaRef: Ref[_] | ReactRef[_] = null,
    title: String = null,
    ...
    if (textareaRef != null) __obj.updateDynamic("textareaRef")(textareaRef.asInstanceOf[js.Any])
