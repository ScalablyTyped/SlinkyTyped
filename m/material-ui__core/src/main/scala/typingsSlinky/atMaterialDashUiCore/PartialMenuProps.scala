...
import typingsSlinky.atMaterialDashUiCore.popoverPopoverMod.PopoverActions
import typingsSlinky.atMaterialDashUiCore.popoverPopoverMod.PopoverOrigin
import typingsSlinky.atMaterialDashUiCore.popoverPopoverMod.PopoverPosition
import typingsSlinky.atMaterialDashUiCore.popoverPopoverMod.PopoverReference
...
trait PartialMenuProps extends js.Object {
  ...
  var ModalClasses: js.UndefOr[PartialClassNameMapModalClassKey] = js.native
  var PaperProps: js.UndefOr[PartialPaperProps] = js.native
  var PopoverClasses: js.UndefOr[PartialClassNameMapPopoverClassKey] = js.native
  ...
  var classes: js.UndefOr[PartialClassNameMapMenuClassKey] = js.native
  ...
  var transitionDuration: js.UndefOr[Double | Anon_Appear | auto] = js.native
...
object PartialMenuProps {
  ...
  def apply(
    ...
    onClose: SyntheticEvent[Event, js.Object] => Unit = null,
    ...
    if (!js.isUndefined(disableAutoFocusItem)) __obj.updateDynamic("disableAutoFocusItem")(disableAutoFocusItem.asInstanceOf[js.Any])
