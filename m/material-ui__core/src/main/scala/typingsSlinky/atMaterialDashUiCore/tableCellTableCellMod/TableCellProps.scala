...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapTableCellClassKey
...
trait TableCellProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[TableCellBaseProps]] = js.undefined
...
object TableCellProps {
  ...
  def apply(
    ...
    color: String = null,
    component: ReactComponentClass[TableCellBaseProps] = null,
    ...
    onAbort: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLTableHeaderCellElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLTableHeaderCellElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLTableHeaderCellElement] => Unit = null,
    onAuxClick: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onBeforeInput: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLTableHeaderCellElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLTableHeaderCellElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onLoad: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPause: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLTableHeaderCellElement] => Unit = null,
    onProgress: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLTableHeaderCellElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLTableHeaderCellElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLTableHeaderCellElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLTableHeaderCellElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLTableHeaderCellElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLTableHeaderCellElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLTableHeaderCellElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLTableHeaderCellElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLTableHeaderCellElement] => Unit = null,
