...
import typingsSlinky.atMaterialDashUiCore.PartialClassNameMapInputBaseClassKey
...
trait InputBaseProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapInputBaseClassKey] = js.undefined
