...
object dialogContentDialogContentMod extends Shortcut {
  
  @JSImport("@material-ui/core/DialogContent/DialogContent", JSImport.Default)
  @js.native
  val default: ReactComponentClass[DialogContentProps] = js.native
  ...
  type _To = ReactComponentClass[DialogContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `dialogContentDialogContentMod.foo` */
  override def _to: ReactComponentClass[DialogContentProps] = default
}
