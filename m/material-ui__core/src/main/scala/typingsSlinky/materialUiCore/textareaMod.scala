...
object textareaMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[TextareaProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.shadow
    - typingsSlinky.materialUiCore.materialUiCoreStrings.textarea
  */
  ...
  object TextareaClassKey {
    ...
    @scala.inline
    def shadow: typingsSlinky.materialUiCore.materialUiCoreStrings.shadow = "shadow".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.shadow]
    
    @scala.inline
    def textarea: typingsSlinky.materialUiCore.materialUiCoreStrings.textarea = "textarea".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.textarea]
  }
  ...
  object TextareaProps {
    ...
    implicit class TextareaPropsMutableBuilder[Self <: TextareaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTextareaRef(value: Ref[_] | ReactRef[_]): Self = StObject.set(x, "textareaRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTextareaRefRefObject(value: ReactRef[_]): Self = StObject.set(x, "textareaRef", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[TextareaProps]
  
  /* This means you don't have to write `default`, but can instead just say `textareaMod.foo` */
  override def _to: ReactComponentClass[TextareaProps] = default
}
