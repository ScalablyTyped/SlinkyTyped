...
object TableFooterProps {
  ...
  implicit class TableFooterPropsOps[Self <: TableFooterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTableF): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[TableFooterBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[TableFooterBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactType[TableFooterBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
