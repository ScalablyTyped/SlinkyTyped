...
object PartialClassNameMapTabsCl {
  ...
  implicit class PartialClassNameMapTabsClOps[Self <: PartialClassNameMapTabsCl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCentered(value: String): Self = {
    ...
    @scala.inline
    def withScrollButtons(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScrollButtonsAuto(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScrollable(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScroller(value: String): Self = {
        val ret = this.duplicate
