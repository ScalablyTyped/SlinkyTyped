...
object LinkProps {
  ...
  implicit class LinkPropsOps[Self <: LinkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[LinkProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[LinkProps]): Self = this.set("component", value.asInstanceOf[js.Any])
