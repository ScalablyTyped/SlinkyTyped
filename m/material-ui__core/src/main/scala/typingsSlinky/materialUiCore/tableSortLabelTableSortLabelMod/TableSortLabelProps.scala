package typingsSlinky.materialUiCore.tableSortLabelTableSortLabelMod
...
object TableSortLabelProps {
  ...
  implicit class TableSortLabelPropsOps[Self <: TableSortLabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconComponentFunctionComponent(value: ReactComponentClass[SvgIconProps]): Self = this.set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setIconComponentComponentClass(value: ReactComponentClass[SvgIconProps]): Self = this.set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setIconComponent(value: ReactComponentClass[SvgIconProps]): Self = this.set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
