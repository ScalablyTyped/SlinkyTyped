...
object swipeableDrawerSwipeableDrawerMod extends Shortcut {
  ...
  @js.native
  trait SwipeableDrawerProps extends StObject {
  ...
  object SwipeableDrawerProps {
    ...
    @scala.inline
    implicit class SwipeableDrawerPropsMutableBuilder[Self <: SwipeableDrawerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableBackdropTransition(value: Boolean): Self = StObject.set(x, "disableBackdropTransition", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableBackdropTransitionUndefined: Self = StObject.set(x, "disableBackdropTransition", js.undefined)
      
      @scala.inline
      def setDisableDiscovery(value: Boolean): Self = StObject.set(x, "disableDiscovery", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableDiscoveryUndefined: Self = StObject.set(x, "disableDiscovery", js.undefined)
      ...
      @scala.inline
      def setMinFlingVelocity(value: Double): Self = StObject.set(x, "minFlingVelocity", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMinFlingVelocityUndefined: Self = StObject.set(x, "minFlingVelocity", js.undefined)
      ...
      @scala.inline
      def setOnOpen(value: SyntheticEvent[Event, js.Object] => Unit): Self = StObject.set(x, "onOpen", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSwipeAreaProps(value: js.Object): Self = StObject.set(x, "SwipeAreaProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSwipeAreaPropsUndefined: Self = StObject.set(x, "SwipeAreaProps", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `swipeableDrawerSwipeableDrawerMod.foo` */
