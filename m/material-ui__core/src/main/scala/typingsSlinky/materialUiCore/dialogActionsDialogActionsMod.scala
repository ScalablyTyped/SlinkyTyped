...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapDialogAction
...
object dialogActionsDialogActionsMod extends Shortcut {
  
  @JSImport("@material-ui/core/DialogActions/DialogActions", JSImport.Default)
  @js.native
  val default: ReactComponentClass[DialogActionsProps] = js.native
  ...
  */
  ...
  object DialogActionsProps {
    ...
    implicit class DialogActionsPropsMutableBuilder[Self <: DialogActionsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapDialogAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[DialogActionsProps]
  
  /* This means you don't have to write `default`, but can instead just say `dialogActionsDialogActionsMod.foo` */
  override def _to: ReactComponentClass[DialogActionsProps] = default
}
