...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapCheckb
  ...
  */
  ...
  object CheckboxProps {
    ...
    implicit class CheckboxPropsMutableBuilder[Self <: CheckboxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: primary | secondary | typingsSlinky.materialUiCore.materialUiCoreStrings.default): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
