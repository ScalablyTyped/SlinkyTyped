package typingsSlinky.materialUiCore.iconIconMod
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLSpanElement>, @material-ui/core.@material-ui/core/Icon/Icon.IconClassKey, never> */
@js.native
...
object IconProps {
  ...
  implicit class IconPropsOps[Self <: IconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[IconProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[IconProps]): Self = this.set("component", value.asInstanceOf[js.Any])
