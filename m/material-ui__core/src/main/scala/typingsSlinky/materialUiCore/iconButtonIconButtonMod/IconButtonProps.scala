package typingsSlinky.materialUiCore.iconButtonIconButtonMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapIconBu
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/IconButton/IconButton.IconButtonClassKey, never> */
@js.native
trait IconButtonProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapIconBu] = js.native
...
object IconButtonProps {
  ...
  implicit class IconButtonPropsOps[Self <: IconButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapIconBu): Self = this.set("classes", value.asInstanceOf[js.Any])
