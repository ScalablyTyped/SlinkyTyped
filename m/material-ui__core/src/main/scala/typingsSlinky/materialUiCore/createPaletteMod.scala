...
object createPaletteMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.createPaletteMod.SimplePaletteColorOptions
    - typingsSlinky.materialUiCore.createPaletteMod.ColorPartial
  */
  trait PaletteColorOptions extends StObject
  object PaletteColorOptions {
    
    @scala.inline
    def ColorPartial(): typingsSlinky.materialUiCore.createPaletteMod.ColorPartial = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.materialUiCore.createPaletteMod.ColorPartial]
    }
    
    @scala.inline
    def SimplePaletteColorOptions(main: String): typingsSlinky.materialUiCore.createPaletteMod.SimplePaletteColorOptions = {
      val __obj = js.Dynamic.literal(main = main.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.materialUiCore.createPaletteMod.SimplePaletteColorOptions]
    }
  }
