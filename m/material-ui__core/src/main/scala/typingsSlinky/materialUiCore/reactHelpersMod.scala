...
import typingsSlinky.materialUiCore.anon.MuiName
...
object reactHelpersMod {
  ...
  @js.native
  def cloneChildrenWithClassName[T](children: ReactElement, className: String): js.Array[T] = js.native
  ...
  @JSImport("@material-ui/core/utils/reactHelpers", "setRef")
  @js.native
  def setRef[T](ref: ReactRef[T]): Unit = js.native
  @JSImport("@material-ui/core/utils/reactHelpers", "setRef")
  @js.native
  def setRef[T](ref: ReactRef[T], value: T): Unit = js.native
  
  type NamedMuiComponent = ReactComponentClass[js.Object] with MuiName
