...
object RootRefProps {
  ...
  implicit class RootRefPropsOps[Self <: RootRefProps[_], T] (val x: Self with RootRefProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setRootRefRefObject(value: ReactRef[T]): Self = this.set("rootRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRootRefFunction1(value: /* instance */ T | Null => Unit): Self = this.set("rootRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRootRef(value: (js.Function1[/* instance */ T | Null, Unit]) | ReactRef[T]): Self = this.set("rootRef", value.asInstanceOf[js.Any])
