...
object muiThemeProviderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MuiThemeProviderProps] = js.native
  ...
  type _To = ReactComponentClass[MuiThemeProviderProps]
  
  /* This means you don't have to write `default`, but can instead just say `muiThemeProviderMod.foo` */
  override def _to: ReactComponentClass[MuiThemeProviderProps] = default
}
