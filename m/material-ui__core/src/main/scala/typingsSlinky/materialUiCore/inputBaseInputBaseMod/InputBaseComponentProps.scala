...
object InputBaseComponentProps {
  ...
  /* arbitrary */ StringDictionary[js.Any] = null,
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onAnimationEnd: SyntheticAnimationEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onAnimationIteration: SyntheticAnimationEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onAnimationStart: SyntheticAnimationEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    ...
    onBlur: SyntheticFocusEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onClick: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCompositionEnd: SyntheticCompositionEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCompositionStart: SyntheticCompositionEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCompositionUpdate: SyntheticCompositionEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onContextMenu: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCopy: SyntheticClipboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onCut: SyntheticClipboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onDoubleClick: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onKeyPress: SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onLoad: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseDown: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseEnter: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseLeave: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseMove: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseOut: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseOver: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onMouseUp: SyntheticMouseEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPaste: SyntheticClipboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPause: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerCancel: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerDown: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerEnter: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerLeave: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerMove: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerOut: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerOver: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onPointerUp: SyntheticPointerEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onProgress: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with (HTMLInputElement | HTMLTextAreaElement), Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTouchCancel: SyntheticTouchEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTouchEnd: SyntheticTouchEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTouchMove: SyntheticTouchEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTouchStart: SyntheticTouchEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onTransitionEnd: SyntheticTransitionEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onVolumeChange: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLInputElement | HTMLTextAreaElement] => Unit = null,
    onWheel: SyntheticWheelEvent[HTMLInputElement | HTMLTextAreaElement] => Unit = null,
