...
object InputAdornmentProps {
  ...
  implicit class InputAdornmentPropsOps[Self <: InputAdornmentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[InputAdornmentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[InputAdornmentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
