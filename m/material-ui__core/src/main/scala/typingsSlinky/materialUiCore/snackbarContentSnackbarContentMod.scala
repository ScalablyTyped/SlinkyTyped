...
object snackbarContentSnackbarContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SnackbarContentProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.message
  ...
  */
  ...
  object SnackbarContentClassKey {
    ...
    @scala.inline
    def message: typingsSlinky.materialUiCore.materialUiCoreStrings.message = "message".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.message]
  ...
  type _To = ReactComponentClass[SnackbarContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `snackbarContentSnackbarContentMod.foo` */
  override def _to: ReactComponentClass[SnackbarContentProps] = default
}
