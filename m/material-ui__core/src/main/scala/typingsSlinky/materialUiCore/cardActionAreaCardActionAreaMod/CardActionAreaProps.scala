package typingsSlinky.materialUiCore.cardActionAreaCardActionAreaMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapCardAc
...
object CardActionAreaProps {
  @scala.inline
  def apply(): CardActionAreaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardActionAreaProps]
  }
  @scala.inline
  implicit class CardActionAreaPropsOps[Self <: CardActionAreaProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardAc): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
