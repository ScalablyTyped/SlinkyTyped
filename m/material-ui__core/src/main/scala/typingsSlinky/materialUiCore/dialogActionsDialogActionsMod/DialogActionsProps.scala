package typingsSlinky.materialUiCore.dialogActionsDialogActionsMod
...
object DialogActionsProps {
  ...
  implicit class DialogActionsPropsOps[Self <: DialogActionsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapDialogAction): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisableActionSpacing(value: Boolean): Self = {
        val ret = this.duplicate
