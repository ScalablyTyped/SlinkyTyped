...
object TableBodyProps {
  ...
  def apply(
    ...
    color: String = null,
    component: ReactComponentClass[TableBodyBaseProps] = null,
    ...
    lang: String = null,
    onAbort: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLTableSectionElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onEnded: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onError: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLTableSectionElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLTableSectionElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLTableSectionElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onPlay: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    ...
    onSeeked: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onSelect: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onStalled: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with HTMLTableSectionElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
    onWaiting: SyntheticEvent[Event, HTMLTableSectionElement] => Unit = null,
