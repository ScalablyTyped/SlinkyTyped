...
import typingsSlinky.materialUiCore.menuListMenuListMod.MenuListClassKey
...
object PartialMenuListPropsAbout {
  ...
  implicit class PartialMenuListPropsAboutOps[Self <: PartialMenuListPropsAbout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: Partial[ClassNameMap[MenuListClassKey]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnKeyDown(value: SyntheticEvent[Event_, SyntheticKeyboardEvent[_]] => Unit): Self = {
        val ret = this.duplicate
