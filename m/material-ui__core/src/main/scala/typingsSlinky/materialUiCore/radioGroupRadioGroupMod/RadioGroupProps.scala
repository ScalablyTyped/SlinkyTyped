package typingsSlinky.materialUiCore.radioGroupRadioGroupMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapRadioG
...
object RadioGroupProps {
  ...
  implicit class RadioGroupPropsOps[Self <: RadioGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapRadioG): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* value */ String) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
