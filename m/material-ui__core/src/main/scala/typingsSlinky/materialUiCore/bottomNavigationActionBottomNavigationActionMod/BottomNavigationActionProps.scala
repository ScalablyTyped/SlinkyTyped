...
object BottomNavigationActionProps {
  ...
  @scala.inline
  implicit class BottomNavigationActionPropsOps[Self <: BottomNavigationActionProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: SyntheticEvent[Event, _] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
