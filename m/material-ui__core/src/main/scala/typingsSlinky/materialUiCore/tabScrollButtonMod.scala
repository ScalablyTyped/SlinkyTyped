...
object tabScrollButtonMod extends Shortcut {
  
  @JSImport("@material-ui/core/Tabs/TabScrollButton", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TabScrollButtonProps] = js.native
  
  type TabScrollButtonClassKey = root
  ...
  object TabScrollButtonProps {
    ...
    implicit class TabScrollButtonPropsMutableBuilder[Self <: TabScrollButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTabScr): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[TabScrollButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `tabScrollButtonMod.foo` */
  override def _to: ReactComponentClass[TabScrollButtonProps] = default
}
