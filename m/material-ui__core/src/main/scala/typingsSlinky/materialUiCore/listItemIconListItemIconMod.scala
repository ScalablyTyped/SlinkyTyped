...
object listItemIconListItemIconMod extends Shortcut {
  
  @JSImport("@material-ui/core/ListItemIcon/ListItemIcon", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ListItemIconProps] = js.native
  ...
  type _To = ReactComponentClass[ListItemIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `listItemIconListItemIconMod.foo` */
  override def _to: ReactComponentClass[ListItemIconProps] = default
}
