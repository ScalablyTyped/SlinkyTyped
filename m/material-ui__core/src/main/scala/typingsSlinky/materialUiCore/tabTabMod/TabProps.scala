...
object TabProps {
  ...
  implicit class TabPropsOps[Self <: TabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapTabCla): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChange(value: (/* event */ ChangeEvent[Checked], /* value */ js.Any) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnClick(value: _ => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextColor(value: String | secondary | primary | inherit): Self = {
        val ret = this.duplicate
