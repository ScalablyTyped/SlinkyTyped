package typingsSlinky.materialUiCore.tabTabMod
...
import typingsSlinky.materialUiCore.anon.Checked
import typingsSlinky.materialUiCore.anon.PartialClassNameMapTabCla
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/Tab/Tab.TabClassKey, 'onChange'> */
@js.native
trait TabProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[Checked], /* value */ js.Any, Unit]] = js.native
...
object TabProps {
  ...
  implicit class TabPropsOps[Self <: TabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTabCla): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ButtonBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ButtonBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[Checked], /* value */ js.Any) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnChange: Self = this.set("onChange", js.undefined)
    @scala.inline
    def setOnClick(value: _ => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setTextColor(value: String | secondary | primary | inherit): Self = this.set("textColor", value.asInstanceOf[js.Any])
    @scala.inline
