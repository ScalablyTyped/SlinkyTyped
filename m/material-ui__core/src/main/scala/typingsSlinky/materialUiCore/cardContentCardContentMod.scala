...
object cardContentCardContentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CardContentProps] = js.native
  ...
  object CardContentProps {
    ...
    implicit class CardContentPropsMutableBuilder[Self <: CardContentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[CardContentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[CardContentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[CardContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `cardContentCardContentMod.foo` */
  override def _to: ReactComponentClass[CardContentProps] = default
}
