...
object TableCellProps {
  ...
  implicit class TableCellPropsOps[Self <: TableCellProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[TableCellBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[TableCellBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
