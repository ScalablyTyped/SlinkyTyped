...
@js.native
trait PartialDialogContentTextP extends js.Object {
...
object PartialDialogContentTextP {
  @scala.inline
  def apply(): PartialDialogContentTextP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogContentTextP]
  }
  @scala.inline
  implicit class PartialDialogContentTextPOps[Self <: PartialDialogContentTextP] (val x: Self) extends AnyVal {
    @scala.inline
