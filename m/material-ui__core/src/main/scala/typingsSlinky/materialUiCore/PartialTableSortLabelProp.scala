...
@js.native
trait PartialTableSortLabelProp extends js.Object {
  var IconComponent: js.UndefOr[ReactComponentClass[SvgIconProps]] = js.native
...
object PartialTableSortLabelProp {
  @scala.inline
  def apply(): PartialTableSortLabelProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTableSortLabelProp]
  }
  @scala.inline
  implicit class PartialTableSortLabelPropOps[Self <: PartialTableSortLabelProp] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withIconComponentFunctionComponent(value: ReactComponentClass[SvgIconProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IconComponent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIconComponentComponentClass(value: ReactComponentClass[SvgIconProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IconComponent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIconComponent(value: ReactComponentClass[SvgIconProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IconComponent")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapTableS): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHideSortIcon(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideSortIcon")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHideSortIcon: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideSortIcon")(js.undefined)
        ret
    }
    @scala.inline
