...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapMenuCl
import typingsSlinky.materialUiCore.anon.PartialClassNameMapModalC
import typingsSlinky.materialUiCore.anon.PartialClassNameMapPopove
import typingsSlinky.materialUiCore.anon.PartialMenuListProps
