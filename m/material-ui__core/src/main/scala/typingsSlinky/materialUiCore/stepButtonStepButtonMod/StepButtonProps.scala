package typingsSlinky.materialUiCore.stepButtonStepButtonMod
...
object StepButtonProps {
  ...
  implicit class StepButtonPropsOps[Self <: StepButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativeLabel(value: Boolean): Self = this.set("alternativeLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapStepBu): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIcon(value: StepButtonIcon): Self = this.set("icon", value.asInstanceOf[js.Any])
    @scala.inline
