...
object tableSortLabelTableSortLabelMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.iconDirectionDesc
    - typingsSlinky.materialUiCore.materialUiCoreStrings.iconDirectionAsc
  */
  ...
  @js.native
  trait TableSortLabelProps extends StObject {
  ...
  object TableSortLabelProps {
    ...
    @scala.inline
    def apply(): TableSortLabelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TableSortLabelProps]
    }
    
    @scala.inline
    implicit class TableSortLabelPropsMutableBuilder[Self <: TableSortLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTableS): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIconComponent(value: ReactComponentClass[SvgIconProps]): Self = StObject.set(x, "IconComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconComponentComponentClass(value: ReactComponentClass[SvgIconProps]): Self = StObject.set(x, "IconComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconComponentFunctionComponent(value: ReactComponentClass[SvgIconProps]): Self = StObject.set(x, "IconComponent", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[TableSortLabelProps]
  
  /* This means you don't have to write `default`, but can instead just say `tableSortLabelTableSortLabelMod.foo` */
  override def _to: ReactComponentClass[TableSortLabelProps] = default
}
