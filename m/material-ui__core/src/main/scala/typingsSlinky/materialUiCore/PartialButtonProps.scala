...
import typingsSlinky.materialUiCore.materialUiCoreStrings.contained
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.extendedFab
import typingsSlinky.materialUiCore.materialUiCoreStrings.fab
import typingsSlinky.materialUiCore.materialUiCoreStrings.flat
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.raised
...
trait PartialButtonProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[ButtonProps]] = js.native
...
object PartialButtonProps {
  ...
  implicit class PartialButtonPropsOps[Self <: PartialButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapButton): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withComponentFunctionComponent(value: ReactComponentClass[ButtonProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentComponentClass(value: ReactComponentClass[ButtonProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponent(value: ReactComponentClass[ButtonProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withVariant(value: text | flat | outlined | contained | raised | fab | extendedFab): Self = {
        val ret = this.duplicate
