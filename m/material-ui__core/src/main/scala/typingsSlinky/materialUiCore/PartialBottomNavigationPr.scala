...
@js.native
trait PartialBottomNavigationPr extends js.Object {
...
object PartialBottomNavigationPr {
  @scala.inline
  def apply(): PartialBottomNavigationPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationPr]
  }
  @scala.inline
  implicit class PartialBottomNavigationPrOps[Self <: PartialBottomNavigationPr] (val x: Self) extends AnyVal {
    @scala.inline
