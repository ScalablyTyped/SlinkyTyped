...
import typingsSlinky.materialUiCore.materialUiCoreStrings.dot
...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Badge.BadgeProps> */
@js.native
...
object PartialBadgeProps {
  ...
  implicit class PartialBadgePropsOps[Self <: PartialBadgeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBadgeContentReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapBadgeC): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withColor(value: Color | error): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withComponentFunctionComponent(value: ReactComponentClass[BadgeProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentComponentClass(value: ReactComponentClass[BadgeProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponent(value: ReactComponentClass[BadgeProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withVariant(value: standard | dot): Self = {
        val ret = this.duplicate
