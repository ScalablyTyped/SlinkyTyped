...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapStepIc
...
object stepIconStepIconMod extends Shortcut {
  
  @JSImport("@material-ui/core/StepIcon/StepIcon", JSImport.Default)
  @js.native
  val default: ReactComponentClass[StepIconProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.text
  ...
  */
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepIcon/StepIcon.StepIconClasskey, never> */
  @js.native
  trait StepIconProps extends StObject {
  ...
  object StepIconProps {
    ...
    @scala.inline
    def apply(): StepIconProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StepIconProps]
    }
    
    @scala.inline
    implicit class StepIconPropsMutableBuilder[Self <: StepIconProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapStepIc): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[StepIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `stepIconStepIconMod.foo` */
  override def _to: ReactComponentClass[StepIconProps] = default
}
