...
import typingsSlinky.materialUiCore.menuListMenuListMod.MenuListProps
...
trait PartialMenuPropsAccessKey extends js.Object {
  ...
  var BackdropProps: js.UndefOr[Partial[typingsSlinky.materialUiCore.backdropBackdropMod.BackdropProps]] = js.native
  var MenuListProps: js.UndefOr[Partial[typingsSlinky.materialUiCore.menuListMenuListMod.MenuListProps]] = js.native
  var ModalClasses: js.UndefOr[Partial[ClassNameMap[ModalClassKey]]] = js.native
  var PaperProps: js.UndefOr[Partial[typingsSlinky.materialUiCore.paperPaperMod.PaperProps]] = js.native
...
object PartialMenuPropsAccessKey {
  @scala.inline
  def apply(): PartialMenuPropsAccessKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuPropsAccessKey]
  }
  @scala.inline
  implicit class PartialMenuPropsAccessKeyOps[Self <: PartialMenuPropsAccessKey] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withBackdropProps(value: Partial[BackdropProps]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenuListProps(value: Partial[MenuListProps]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withModalClasses(value: Partial[ClassNameMap[ModalClassKey]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPaperProps(value: Partial[PaperProps]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPopoverClasses(value: Partial[ClassNameMap[PopoverClassKey]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClasses(value: Partial[ClassNameMap[MenuClassKey]]): Self = {
        val ret = this.duplicate
