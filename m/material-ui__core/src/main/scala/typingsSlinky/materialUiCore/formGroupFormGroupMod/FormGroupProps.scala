package typingsSlinky.materialUiCore.formGroupFormGroupMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapFormGr
...
object FormGroupProps {
  ...
  implicit class FormGroupPropsOps[Self <: FormGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapFormGr): Self = this.set("classes", value.asInstanceOf[js.Any])
