...
object hiddenJsMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[HiddenJsProps] = js.native
  ...
  type _To = ReactComponentClass[HiddenJsProps]
  
  /* This means you don't have to write `default`, but can instead just say `hiddenJsMod.foo` */
  override def _to: ReactComponentClass[HiddenJsProps] = default
}
