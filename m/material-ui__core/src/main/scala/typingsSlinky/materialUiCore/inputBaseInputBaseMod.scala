...
object inputBaseInputBaseMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.formControl
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.inputDisabled
    - typingsSlinky.materialUiCore.materialUiCoreStrings.inputMultiline
    - typingsSlinky.materialUiCore.materialUiCoreStrings.inputType
    - typingsSlinky.materialUiCore.materialUiCoreStrings.inputTypeSearch
  */
  ...
  object InputBaseClassKey {
    ...
    @scala.inline
    def formControl: typingsSlinky.materialUiCore.materialUiCoreStrings.formControl = "formControl".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.formControl]
    ...
    @scala.inline
    def inputDisabled: typingsSlinky.materialUiCore.materialUiCoreStrings.inputDisabled = "inputDisabled".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.inputDisabled]
    ...
    @scala.inline
    def inputType: typingsSlinky.materialUiCore.materialUiCoreStrings.inputType = "inputType".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.inputType]
    
    @scala.inline
    def inputTypeSearch: typingsSlinky.materialUiCore.materialUiCoreStrings.inputTypeSearch = "inputTypeSearch".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.inputTypeSearch]
  ...
  object InputBaseProps {
    ...
    implicit class InputBasePropsMutableBuilder[Self <: InputBaseProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapInputB): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `inputBaseInputBaseMod.foo` */
