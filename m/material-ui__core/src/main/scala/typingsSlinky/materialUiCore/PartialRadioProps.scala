...
object PartialRadioProps {
  @scala.inline
  def apply(): PartialRadioProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRadioProps]
  }
  @scala.inline
  implicit class PartialRadioPropsOps[Self <: PartialRadioProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapRadioC): Self = {
        val ret = this.duplicate
