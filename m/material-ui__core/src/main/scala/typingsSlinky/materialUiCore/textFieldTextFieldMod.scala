...
object textFieldTextFieldMod extends Shortcut {
  ...
  */
  ...
  object TextFieldProps {
    ...
    @scala.inline
    def FilledTextFieldProps(variant: filled): typingsSlinky.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = variant.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.materialUiCore.textFieldTextFieldMod.FilledTextFieldProps]
    }
    
    @scala.inline
    def OutlinedTextFieldProps(variant: outlined): typingsSlinky.materialUiCore.textFieldTextFieldMod.OutlinedTextFieldProps = {
      val __obj = js.Dynamic.literal(variant = variant.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.materialUiCore.textFieldTextFieldMod.OutlinedTextFieldProps]
    }
    
    @scala.inline
    def StandardTextFieldProps(): typingsSlinky.materialUiCore.textFieldTextFieldMod.StandardTextFieldProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.materialUiCore.textFieldTextFieldMod.StandardTextFieldProps]
    }
  }
