...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapFormCo
...
object formControlFormControlMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.marginNormal
  ...
  */
  ...
  object FormControlProps {
    ...
    implicit class FormControlPropsMutableBuilder[Self <: FormControlProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[FormControlProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[FormControlProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
