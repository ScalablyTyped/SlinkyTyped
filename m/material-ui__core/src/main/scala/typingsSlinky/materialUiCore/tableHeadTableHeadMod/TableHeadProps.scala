...
object TableHeadProps {
  ...
  implicit class TableHeadPropsOps[Self <: TableHeadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTableH): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[TableHeadBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[TableHeadBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactType[TableHeadBaseProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
