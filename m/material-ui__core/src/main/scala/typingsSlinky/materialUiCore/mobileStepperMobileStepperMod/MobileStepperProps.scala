...
object MobileStepperProps {
  ...
  implicit class MobileStepperPropsOps[Self <: MobileStepperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackButton(value: ReactElement): Self = {
    ...
    @scala.inline
    def withLinearProgressProps(value: PartialLinearProgressProp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LinearProgressProps")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLinearProgressProps: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LinearProgressProps")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapMobile): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPosition(value: bottom | top | static): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVariant(value: text | dots | progress): Self = {
        val ret = this.duplicate
