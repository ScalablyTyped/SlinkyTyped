package typingsSlinky.materialUiCore.mobileStepperMobileStepperMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapMobile
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.dots
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.progress
...
object MobileStepperProps {
  ...
  @scala.inline
  implicit class MobileStepperPropsOps[Self <: MobileStepperProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBackButton(value: ReactElement): Self = this.set("backButton", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLinearProgressProps(value: PartialLinearProgressProp): Self = this.set("LinearProgressProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLinearProgressProps: Self = this.set("LinearProgressProps", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapMobile): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPosition(value: bottom | top | static): Self = this.set("position", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: text | dots | progress): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
