...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapStepCl
...
object stepStepMod extends Shortcut {
  ...
  */
  trait StepClasskey extends StObject
  object StepClasskey {
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Step/Step.StepClasskey, never> */
  @js.native
  ...
  object StepProps {
    ...
    implicit class StepPropsMutableBuilder[Self <: StepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapStepCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setConnector(value: ReactElement): Self = StObject.set(x, "connector", value.asInstanceOf[js.Any])
