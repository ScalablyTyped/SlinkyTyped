...
@js.native
trait PartialExpansionPanelActi extends js.Object {
...
object PartialExpansionPanelActi {
  ...
  @scala.inline
  implicit class PartialExpansionPanelActiOps[Self <: PartialExpansionPanelActi] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapExpansAction): Self = {
        val ret = this.duplicate
