...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Step.StepProps> */
@js.native
trait PartialStepProps extends js.Object {
...
object PartialStepProps {
  ...
  @scala.inline
  implicit class PartialStepPropsOps[Self <: PartialStepProps] (val x: Self) extends AnyVal {
    @scala.inline
