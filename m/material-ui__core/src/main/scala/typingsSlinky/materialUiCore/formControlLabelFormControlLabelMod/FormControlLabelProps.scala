package typingsSlinky.materialUiCore.formControlLabelFormControlLabelMod
...
object FormControlLabelProps {
  ...
  @scala.inline
  implicit class FormControlLabelPropsOps[Self <: FormControlLabelProps] (val x: Self) extends AnyVal {
