...
object outlinedInputOutlinedInputMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[OutlinedInputProps] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.notchedOutline
  ...
  */
  ...
  object OutlinedInputClassKey {
    ...
    @scala.inline
    def notchedOutline: typingsSlinky.materialUiCore.materialUiCoreStrings.notchedOutline = "notchedOutline".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.notchedOutline]
  ...
  type _To = ReactComponentClass[OutlinedInputProps]
  
  /* This means you don't have to write `default`, but can instead just say `outlinedInputOutlinedInputMod.foo` */
  override def _to: ReactComponentClass[OutlinedInputProps] = default
}
