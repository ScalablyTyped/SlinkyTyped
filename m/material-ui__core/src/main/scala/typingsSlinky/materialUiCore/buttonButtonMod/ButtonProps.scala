...
object ButtonProps {
  ...
  implicit class ButtonPropsOps[Self <: ButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ButtonProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ButtonProps]): Self = this.set("component", value.asInstanceOf[js.Any])
