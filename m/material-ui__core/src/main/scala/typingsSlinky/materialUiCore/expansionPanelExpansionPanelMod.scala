...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapExpans
...
object expansionPanelExpansionPanelMod extends Shortcut {
  
  @JSImport("@material-ui/core/ExpansionPanel/ExpansionPanel", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ExpansionPanelProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.rounded
    - typingsSlinky.materialUiCore.materialUiCoreStrings.expanded
    - typingsSlinky.materialUiCore.materialUiCoreStrings.disabled
  */
  trait ExpansionPanelClassKey extends StObject
  object ExpansionPanelClassKey {
    ...
    @scala.inline
    def expanded: typingsSlinky.materialUiCore.materialUiCoreStrings.expanded = "expanded".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.expanded]
  ...
  @js.native
  trait ExpansionPanelProps extends StObject {
    
    var CollapseProps: js.UndefOr[PartialCollapseProps] = js.native
    ...
    var classes: js.UndefOr[PartialClassNameMapExpans] = js.native
    ...
    var onChange: js.UndefOr[js.Function2[/* event */ ChangeEvent[js.Object], /* expanded */ Boolean, Unit]] = js.native
  ...
  object ExpansionPanelProps {
    ...
    implicit class ExpansionPanelPropsMutableBuilder[Self <: ExpansionPanelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapExpans): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setCollapseProps(value: PartialCollapseProps): Self = StObject.set(x, "CollapseProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCollapsePropsUndefined: Self = StObject.set(x, "CollapseProps", js.undefined)
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[PaperProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[PaperProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
  ...
  type _To = ReactComponentClass[ExpansionPanelProps]
  
  /* This means you don't have to write `default`, but can instead just say `expansionPanelExpansionPanelMod.foo` */
  override def _to: ReactComponentClass[ExpansionPanelProps] = default
}
