...
object StepLabelProps {
  ...
  implicit class StepLabelPropsOps[Self <: StepLabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStepIconComponentFunctionComponent(value: ReactComponentClass[_]): Self = this.set("StepIconComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStepIconComponentComponentClass(value: ReactComponentClass[_]): Self = this.set("StepIconComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStepIconComponent(value: ReactType[_]): Self = this.set("StepIconComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStepIconComponent: Self = this.set("StepIconComponent", js.undefined)
    
    @scala.inline
    def setStepIconProps(value: PartialStepIconProps): Self = this.set("StepIconProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStepIconProps: Self = this.set("StepIconProps", js.undefined)
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapStepLa): Self = this.set("classes", value.asInstanceOf[js.Any])
