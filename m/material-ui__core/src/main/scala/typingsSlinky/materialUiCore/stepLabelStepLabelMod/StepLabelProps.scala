...
object StepLabelProps {
  ...
  def apply(
    ...
    icon: js.UndefOr[Null | StepButtonIcon] = js.undefined,
    id: String = null,
    inlist: js.Any = null,
    ...
    if (!js.isUndefined(alternativeLabel)) __obj.updateDynamic("alternativeLabel")(alternativeLabel.get.asInstanceOf[js.Any])
