package typingsSlinky.materialUiCore.appBarAppBarMod
...
object AppBarProps {
  ...
  implicit class AppBarPropsOps[Self <: AppBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapAppBar): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPosition(value: fixed | absolute | sticky | static | relative): Self = {
        val ret = this.duplicate
