...
object tableHeadTableHeadMod extends Shortcut {
  ...
  object TableHeadProps {
    ...
    implicit class TableHeadPropsMutableBuilder[Self <: TableHeadProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[TableHeadBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[TableHeadBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
