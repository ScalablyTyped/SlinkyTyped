package typingsSlinky.materialUiCore.cardCardMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapCardCl
...
object CardProps {
  ...
  implicit class CardPropsOps[Self <: CardProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCardCl): Self = this.set("classes", value.asInstanceOf[js.Any])
