...
object TooltipProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableFocusListener)) __obj.updateDynamic("disableFocusListener")(disableFocusListener.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableHoverListener)) __obj.updateDynamic("disableHoverListener")(disableHoverListener.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableTouchListener)) __obj.updateDynamic("disableTouchListener")(disableTouchListener.get.asInstanceOf[js.Any])
    if (!js.isUndefined(draggable)) __obj.updateDynamic("draggable")(draggable.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enterDelay)) __obj.updateDynamic("enterDelay")(enterDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enterTouchDelay)) __obj.updateDynamic("enterTouchDelay")(enterTouchDelay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(leaveDelay)) __obj.updateDynamic("leaveDelay")(leaveDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(leaveTouchDelay)) __obj.updateDynamic("leaveTouchDelay")(leaveTouchDelay.get.asInstanceOf[js.Any])
