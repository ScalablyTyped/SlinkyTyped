...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapBackdr
...
object backdropBackdropMod extends Shortcut {
  ...
  */
  ...
  object BackdropClassKey {
    ...
    @scala.inline
    def invisible: typingsSlinky.materialUiCore.materialUiCoreStrings.invisible = "invisible".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.invisible]
  ...
  object BackdropProps {
    ...
    @scala.inline
    def apply(open: Boolean): BackdropProps = {
    ...
    implicit class BackdropPropsMutableBuilder[Self <: BackdropProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapBackdr): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnClick(value: SyntheticEvent[Event, js.Object] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
