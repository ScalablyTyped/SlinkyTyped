...
/* Inlined @material-ui/core.@material-ui/core.Omit<@material-ui/core.@material-ui/core/Grid/Grid.GridProps, @material-ui/core.@material-ui/core/Grid/Grid.StrippedProps> */
@js.native
trait OmitGridPropsStrippedProp extends js.Object {
...
object OmitGridPropsStrippedProp {
  @scala.inline
  def apply(): OmitGridPropsStrippedProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitGridPropsStrippedProp]
  }
  @scala.inline
  implicit class OmitGridPropsStrippedPropOps[Self <: OmitGridPropsStrippedProp] (val x: Self) extends AnyVal {
    @scala.inline
