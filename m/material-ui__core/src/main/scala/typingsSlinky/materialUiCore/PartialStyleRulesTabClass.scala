...
object PartialStyleRulesTabClass {
  ...
  implicit class PartialStyleRulesTabClassOps[Self <: PartialStyleRulesTabClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelIcon(value: CSSProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabelWrapped(value: CSSProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextColorInherit(value: CSSProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextColorPrimary(value: CSSProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextColorSecondary(value: CSSProperties): Self = {
        val ret = this.duplicate
