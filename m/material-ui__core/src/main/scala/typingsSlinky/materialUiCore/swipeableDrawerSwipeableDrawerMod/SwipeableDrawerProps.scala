...
object SwipeableDrawerProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableBackdropTransition)) __obj.updateDynamic("disableBackdropTransition")(disableBackdropTransition.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableDiscovery)) __obj.updateDynamic("disableDiscovery")(disableDiscovery.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(minFlingVelocity)) __obj.updateDynamic("minFlingVelocity")(minFlingVelocity.get.asInstanceOf[js.Any])
