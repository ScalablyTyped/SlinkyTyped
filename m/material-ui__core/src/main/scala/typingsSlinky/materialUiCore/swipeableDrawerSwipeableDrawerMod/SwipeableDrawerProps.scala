...
object SwipeableDrawerProps {
  ...
  implicit class SwipeableDrawerPropsOps[Self <: SwipeableDrawerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnClose(value: SyntheticEvent[Event, js.Object] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onClose")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnOpen(value: SyntheticEvent[Event, js.Object] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnBackdropClick(value: SyntheticEvent[Event, js.Object] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnEscapeKeyDown(value: SyntheticEvent[Event, js.Object] => Unit): Self = {
        val ret = this.duplicate
