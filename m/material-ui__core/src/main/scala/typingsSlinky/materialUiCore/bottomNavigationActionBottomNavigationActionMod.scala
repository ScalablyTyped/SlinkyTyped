...
object bottomNavigationActionBottomNavigationActionMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.iconOnly
  ...
  */
  ...
  object BottomNavigationActionClassKey {
    ...
    @scala.inline
    def iconOnly: typingsSlinky.materialUiCore.materialUiCoreStrings.iconOnly = "iconOnly".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.iconOnly]
  ...
  object BottomNavigationActionProps {
    ...
    implicit class BottomNavigationActionPropsMutableBuilder[Self <: BottomNavigationActionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: SyntheticEvent[Event, _] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
  ...
  type _To = ReactComponentClass[BottomNavigationActionProps]
  
  /* This means you don't have to write `default`, but can instead just say `bottomNavigationActionBottomNavigationActionMod.foo` */
  override def _to: ReactComponentClass[BottomNavigationActionProps] = default
}
