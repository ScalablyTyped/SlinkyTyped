...
object CardContentProps {
  ...
  implicit class CardContentPropsOps[Self <: CardContentProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[CardContentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[CardContentProps]): Self = this.set("component", value.asInstanceOf[js.Any])
