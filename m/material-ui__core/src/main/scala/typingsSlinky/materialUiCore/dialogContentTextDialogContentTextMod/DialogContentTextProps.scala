package typingsSlinky.materialUiCore.dialogContentTextDialogContentTextMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapDialogRoot
...
object DialogContentTextProps {
  @scala.inline
  def apply(): DialogContentTextProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DialogContentTextProps]
  }
  @scala.inline
  implicit class DialogContentTextPropsOps[Self <: DialogContentTextProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setHeadlineMapping(value: typeinStylestring): Self = this.set("headlineMapping", value.asInstanceOf[js.Any])
    @scala.inline
