package typingsSlinky.materialUiCore.filledInputFilledInputMod
...
import typingsSlinky.materialUiCore.AnonDisabled
import typingsSlinky.materialUiCore.PartialClassNameMapFilled
...
@js.native
trait FilledInputProps extends js.Object {
...
object FilledInputProps {
  ...
  @scala.inline
  implicit class FilledInputPropsOps[Self <: FilledInputProps] (val x: Self) extends AnyVal {
    @scala.inline
