...
object FilledInputProps {
  ...
  def apply(
    ...
    inputRef: js.UndefOr[Null | Ref[_] | ReactRef[_]] = js.undefined,
    is: String = null,
    itemID: String = null,
    ...
    renderPrefix: /* state */ Disabled => TagMod[Any] = null,
    ...
    if (!js.isUndefined(disableUnderline)) __obj.updateDynamic("disableUnderline")(disableUnderline.get.asInstanceOf[js.Any])
