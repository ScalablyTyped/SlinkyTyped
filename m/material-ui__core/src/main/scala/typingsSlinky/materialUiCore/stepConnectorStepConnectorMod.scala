...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapStepCo
...
object stepConnectorStepConnectorMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.line
    - typingsSlinky.materialUiCore.materialUiCoreStrings.lineHorizontal
    - typingsSlinky.materialUiCore.materialUiCoreStrings.lineVertical
  */
