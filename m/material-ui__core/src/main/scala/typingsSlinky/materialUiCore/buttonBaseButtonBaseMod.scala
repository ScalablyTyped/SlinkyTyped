...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapButtonDisabled
...
object buttonBaseButtonBaseMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.focusVisible
  */
  ...
  @js.native
  trait ButtonBaseProps extends StObject {
  ...
  object ButtonBaseProps {
    ...
    @scala.inline
    implicit class ButtonBasePropsMutableBuilder[Self <: ButtonBaseProps] (val x: Self) extends AnyVal {
