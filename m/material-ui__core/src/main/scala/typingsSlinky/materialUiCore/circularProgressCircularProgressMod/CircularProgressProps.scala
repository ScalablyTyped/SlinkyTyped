package typingsSlinky.materialUiCore.circularProgressCircularProgressMod
...
object CircularProgressProps {
  ...
  implicit class CircularProgressPropsOps[Self <: CircularProgressProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapCircul): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withColor(value: primary | secondary | inherit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVariant(value: determinate | indeterminate | static): Self = {
        val ret = this.duplicate
