package typingsSlinky.materialUiCore.dialogDialogMod
...
object DialogProps {
  ...
  implicit class DialogPropsOps[Self <: DialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPaperComponentFunctionComponent(value: ReactComponentClass[PaperProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PaperComponent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPaperComponentComponentClass(value: ReactComponentClass[PaperProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PaperComponent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPaperComponent(value: ReactComponentClass[PaperProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PaperComponent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPaperComponent: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PaperComponent")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapDialog): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMaxWidth(value: xs | sm | md | lg | xl | `false`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScroll(value: body | paper): Self = {
        val ret = this.duplicate
