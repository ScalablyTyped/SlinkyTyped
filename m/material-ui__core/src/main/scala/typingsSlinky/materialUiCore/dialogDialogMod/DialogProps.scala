...
object DialogProps {
  ...
  implicit class DialogPropsOps[Self <: DialogProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaperComponentFunctionComponent(value: ReactComponentClass[PaperProps]): Self = this.set("PaperComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setPaperComponentComponentClass(value: ReactComponentClass[PaperProps]): Self = this.set("PaperComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setPaperComponent(value: ReactComponentClass[PaperProps]): Self = this.set("PaperComponent", value.asInstanceOf[js.Any])
    @scala.inline
