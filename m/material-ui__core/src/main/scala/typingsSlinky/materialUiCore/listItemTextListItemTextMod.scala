...
object listItemTextListItemTextMod extends Shortcut {
  
  @JSImport("@material-ui/core/ListItemText/ListItemText", JSImport.Default)
  @js.native
  val default: ReactComponentClass[ListItemTextProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.inset
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.textDense
  */
  ...
  object ListItemTextClassKey {
    ...
    @scala.inline
    def inset: typingsSlinky.materialUiCore.materialUiCoreStrings.inset = "inset".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.inset]
    ...
    @scala.inline
    def textDense: typingsSlinky.materialUiCore.materialUiCoreStrings.textDense = "textDense".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.textDense]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/ListItemText/ListItemText.ListItemTextClassKey, never> */
  @js.native
  ...
  object ListItemTextProps {
    ...
    implicit class ListItemTextPropsMutableBuilder[Self <: ListItemTextProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPrimary(value: ReactElement): Self = StObject.set(x, "primary", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryReactElement(value: ReactElement): Self = StObject.set(x, "primary", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "primaryTypographyProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSecondary(value: ReactElement): Self = StObject.set(x, "secondary", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSecondaryReactElement(value: ReactElement): Self = StObject.set(x, "secondary", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSecondaryTypographyProps(value: PartialTypographyProps): Self = StObject.set(x, "secondaryTypographyProps", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[ListItemTextProps]
  
  /* This means you don't have to write `default`, but can instead just say `listItemTextListItemTextMod.foo` */
  override def _to: ReactComponentClass[ListItemTextProps] = default
}
