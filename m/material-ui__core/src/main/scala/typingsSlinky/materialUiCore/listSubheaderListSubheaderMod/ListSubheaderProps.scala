...
object ListSubheaderProps {
  ...
  def apply(
    ...
    color: typingsSlinky.materialUiCore.materialUiCoreStrings.default | primary | inherit = null,
    component: ReactComponentClass[ListSubheaderProps] = null,
    ...
    if (!js.isUndefined(disableSticky)) __obj.updateDynamic("disableSticky")(disableSticky.get.asInstanceOf[js.Any])
