...
object ListSubheaderProps {
  ...
  implicit class ListSubheaderPropsOps[Self <: ListSubheaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapListSu): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: typingsSlinky.materialUiCore.materialUiCoreStrings.default | primary | inherit): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteColor: Self = this.set("color", js.undefined)
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ListSubheaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ListSubheaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactType[ListSubheaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisableSticky(value: Boolean): Self = this.set("disableSticky", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableSticky: Self = this.set("disableSticky", js.undefined)
    @scala.inline
