...
object mergeListContextMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[MergeWithListContextProps] = js.native
  ...
  type _To = ReactComponentClass[MergeWithListContextProps]
  
  /* This means you don't have to write `default`, but can instead just say `mergeListContextMod.foo` */
  override def _to: ReactComponentClass[MergeWithListContextProps] = default
}
