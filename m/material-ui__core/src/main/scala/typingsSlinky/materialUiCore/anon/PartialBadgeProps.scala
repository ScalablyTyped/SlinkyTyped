...
object PartialBadgeProps {
  ...
  implicit class PartialBadgePropsOps[Self <: PartialBadgeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBadgeContentReactElement(value: ReactElement): Self = this.set("badgeContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[BadgeProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[BadgeProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
