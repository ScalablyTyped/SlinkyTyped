...
@js.native
trait PartialInputLabelProps extends StObject {
...
object PartialInputLabelProps {
  ...
  @scala.inline
  def apply(): PartialInputLabelProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInputLabelProps]
  }
  
  @scala.inline
  implicit class PartialInputLabelPropsMutableBuilder[Self <: PartialInputLabelProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapInputL): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FormLabelBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FormLabelBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormLabelClasses(value: PartialClassNameMapFormLa): Self = StObject.set(x, "FormLabelClasses", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFormLabelClassesUndefined: Self = StObject.set(x, "FormLabelClasses", js.undefined)
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLLabelElement, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
