...
object PartialCardMediaProps {
  ...
  implicit class PartialCardMediaPropsMutableBuilder[Self <: PartialCardMediaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[CardMediaProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[CardMediaProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
