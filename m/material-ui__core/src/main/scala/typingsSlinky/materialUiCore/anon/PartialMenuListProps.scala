...
object PartialMenuListProps {
  ...
  implicit class PartialMenuListPropsOps[Self <: PartialMenuListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticEvent[Event, SyntheticKeyboardEvent[_]] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
