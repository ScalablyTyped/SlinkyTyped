...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/FormControlLabel.FormControlLabelProps> */
@js.native
trait PartialFormControlLabelPr extends StObject {
...
object PartialFormControlLabelPr {
  
  @scala.inline
  def apply(): PartialFormControlLabelPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormControlLabelPr]
  }
  
  @scala.inline
  implicit class PartialFormControlLabelPrMutableBuilder[Self <: PartialFormControlLabelPr] (val x: Self) extends AnyVal {
