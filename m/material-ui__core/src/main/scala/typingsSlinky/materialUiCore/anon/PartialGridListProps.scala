...
@js.native
trait PartialGridListProps extends js.Object {
...
object PartialGridListProps {
  ...
  @scala.inline
  implicit class PartialGridListPropsOps[Self <: PartialGridListProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapGridLi): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[GridListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[GridListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactType[GridListProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
