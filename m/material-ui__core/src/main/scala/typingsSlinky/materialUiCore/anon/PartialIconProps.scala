...
object PartialIconProps {
  ...
  implicit class PartialIconPropsMutableBuilder[Self <: PartialIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[IconProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[IconProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
