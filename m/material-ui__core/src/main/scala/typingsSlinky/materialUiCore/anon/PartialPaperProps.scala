...
@js.native
trait PartialPaperProps extends StObject {
...
object PartialPaperProps {
  ...
  @scala.inline
  def apply(): PartialPaperProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaperProps]
  }
  
  @scala.inline
  implicit class PartialPaperPropsMutableBuilder[Self <: PartialPaperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapPaperC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
