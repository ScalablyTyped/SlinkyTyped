...
object PartialChipProps {
  ...
  implicit class PartialChipPropsMutableBuilder[Self <: PartialChipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ChipProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ChipProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
