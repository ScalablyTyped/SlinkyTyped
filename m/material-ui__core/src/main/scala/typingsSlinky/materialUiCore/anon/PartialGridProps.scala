...
object PartialGridProps {
  ...
  implicit class PartialGridPropsMutableBuilder[Self <: PartialGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: String | ReactComponentClass[OmitGridPropsStrippedProp]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[OmitGridPropsStrippedProp]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[OmitGridPropsStrippedProp]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
