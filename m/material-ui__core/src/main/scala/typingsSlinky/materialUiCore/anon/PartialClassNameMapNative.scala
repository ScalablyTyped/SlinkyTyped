...
@js.native
trait PartialClassNameMapNative extends StObject {
...
object PartialClassNameMapNative {
  
  @scala.inline
  def apply(): PartialClassNameMapNative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClassNameMapNative]
  }
  
  @scala.inline
  implicit class PartialClassNameMapNativeMutableBuilder[Self <: PartialClassNameMapNative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectMenu(value: String): Self = StObject.set(x, "selectMenu", value.asInstanceOf[js.Any])
