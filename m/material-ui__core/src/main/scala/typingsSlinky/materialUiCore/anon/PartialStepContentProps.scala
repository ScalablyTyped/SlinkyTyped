...
object PartialStepContentProps {
  @scala.inline
  def apply(): PartialStepContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepContentProps]
  }
  @scala.inline
  implicit class PartialStepContentPropsOps[Self <: PartialStepContentProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapStepCoLast): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
