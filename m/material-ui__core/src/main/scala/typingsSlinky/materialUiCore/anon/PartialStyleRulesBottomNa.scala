...
object PartialStyleRulesBottomNa {
  ...
  @scala.inline
  implicit class PartialStyleRulesBottomNaMutableBuilder[Self <: PartialStyleRulesBottomNa] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setIconOnly(value: CSSProperties): Self = StObject.set(x, "iconOnly", value.asInstanceOf[js.Any])
