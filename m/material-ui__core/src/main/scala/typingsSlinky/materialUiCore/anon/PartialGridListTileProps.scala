...
object PartialGridListTileProps {
  ...
  implicit class PartialGridListTilePropsOps[Self <: PartialGridListTileProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[GridListTileProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[GridListTileProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
