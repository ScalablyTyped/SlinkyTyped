...
object PartialClassNameMapButton {
  ...
  implicit class PartialClassNameMapButtonOps[Self <: PartialClassNameMapButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContainedPrimary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withContainedSecondary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withExtendedFab(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFlatPrimary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFlatSecondary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRaisedPrimary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRaisedSecondary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextPrimary(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextSecondary(value: String): Self = {
        val ret = this.duplicate
