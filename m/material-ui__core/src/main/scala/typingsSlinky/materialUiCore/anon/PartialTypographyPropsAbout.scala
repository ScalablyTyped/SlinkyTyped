...
object PartialTypographyPropsAbout {
  ...
  {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
    */ typingsSlinky.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with TopLevel[js.Any] = null,
    ...
    if (!js.isUndefined(gutterBottom)) __obj.updateDynamic("gutterBottom")(gutterBottom.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(paragraph)) __obj.updateDynamic("paragraph")(paragraph.get.asInstanceOf[js.Any])
