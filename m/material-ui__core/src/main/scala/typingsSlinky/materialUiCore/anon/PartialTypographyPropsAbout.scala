...
import typingsSlinky.materialUiCore.materialUiCoreStrings.textPrimary
import typingsSlinky.materialUiCore.materialUiCoreStrings.textSecondary
...
trait PartialTypographyPropsAbout extends js.Object {
  ...
  {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
    */ typingsSlinky.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with TopLevel[js.Any]
  ] = js.native
...
object PartialTypographyPropsAbout {
  @scala.inline
  def apply(): PartialTypographyPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTypographyPropsAbout]
  }
  @scala.inline
  implicit class PartialTypographyPropsAboutOps[Self <: PartialTypographyPropsAbout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTypogr): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: Color | textPrimary | textSecondary | error): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteColor: Self = this.set("color", js.undefined)
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[TypographyProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[TypographyProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactType[TypographyProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGutterBottom(value: Boolean): Self = this.set("gutterBottom", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteGutterBottom: Self = this.set("gutterBottom", js.undefined)
    @scala.inline
    def setHeadlineMapping(
      value: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
      */ typingsSlinky.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with TopLevel[js.Any]
    ): Self = this.set("headlineMapping", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHeadlineMapping: Self = this.set("headlineMapping", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget with HTMLElement, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setVariant(value: Style | inherit): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
