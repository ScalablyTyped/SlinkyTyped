...
@js.native
trait PartialTypographyPropsAbout extends StObject {
...
object PartialTypographyPropsAbout {
  ...
  @scala.inline
  implicit class PartialTypographyPropsAboutMutableBuilder[Self <: PartialTypographyPropsAbout] (val x: Self) extends AnyVal {
    ...
    {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
      */ typingsSlinky.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with TopLevel[js.Any]
    ): Self = StObject.set(x, "headlineMapping", value.asInstanceOf[js.Any])
