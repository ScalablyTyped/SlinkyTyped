...
object PartialOutlinedInputProps {
  ...
  implicit class PartialOutlinedInputPropsOps[Self <: PartialOutlinedInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapOutlin): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNotched(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notched")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNotched: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notched")(js.undefined)
        ret
    }
    @scala.inline
