...
@js.native
trait PartialClassNameMapNotche extends StObject {
...
object PartialClassNameMapNotche {
  ...
  @scala.inline
  implicit class PartialClassNameMapNotcheMutableBuilder[Self <: PartialClassNameMapNotche] (val x: Self) extends AnyVal {
