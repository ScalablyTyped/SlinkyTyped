...
object PartialMenuPropsAccessKey {
  ...
  @scala.inline
  implicit class PartialMenuPropsAccessKeyMutableBuilder[Self <: PartialMenuPropsAccessKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackdropProps(value: Partial[BackdropProps]): Self = StObject.set(x, "BackdropProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[MenuClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMenuListProps(value: Partial[MenuListProps]): Self = StObject.set(x, "MenuListProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModalClasses(value: Partial[ClassNameMap[ModalClassKey]]): Self = StObject.set(x, "ModalClasses", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPaperProps(value: Partial[PaperProps]): Self = StObject.set(x, "PaperProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPopoverClasses(value: Partial[ClassNameMap[PopoverClassKey]]): Self = StObject.set(x, "PopoverClasses", value.asInstanceOf[js.Any])
