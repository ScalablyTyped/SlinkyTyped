...
object PartialMenuPropsAccessKey {
  ...
  implicit class PartialMenuPropsAccessKeyOps[Self <: PartialMenuPropsAccessKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackdropProps(value: Partial[BackdropProps]): Self = this.set("BackdropProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBackdropProps: Self = this.set("BackdropProps", js.undefined)
    @scala.inline
    def setMenuListProps(value: Partial[MenuListProps]): Self = this.set("MenuListProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMenuListProps: Self = this.set("MenuListProps", js.undefined)
    @scala.inline
    def setModalClasses(value: Partial[ClassNameMap[ModalClassKey]]): Self = this.set("ModalClasses", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteModalClasses: Self = this.set("ModalClasses", js.undefined)
    @scala.inline
    def setPaperProps(value: Partial[PaperProps]): Self = this.set("PaperProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePaperProps: Self = this.set("PaperProps", js.undefined)
    @scala.inline
    def setPopoverClasses(value: Partial[ClassNameMap[PopoverClassKey]]): Self = this.set("PopoverClasses", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: Partial[ClassNameMap[MenuClassKey]]): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
