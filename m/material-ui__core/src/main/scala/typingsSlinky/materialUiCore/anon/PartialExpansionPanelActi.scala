...
@js.native
trait PartialExpansionPanelActi extends StObject {
...
object PartialExpansionPanelActi {
  
  @scala.inline
  def apply(): PartialExpansionPanelActi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialExpansionPanelActi]
  }
  
  @scala.inline
  implicit class PartialExpansionPanelActiMutableBuilder[Self <: PartialExpansionPanelActi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapExpansAction): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
