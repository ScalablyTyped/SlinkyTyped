...
trait PartialAvatarProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[AvatarProps]] = js.native
...
object PartialAvatarProps {
  ...
  implicit class PartialAvatarPropsOps[Self <: PartialAvatarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapAvatar): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withComponentFunctionComponent(value: ReactComponentClass[AvatarProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentComponentClass(value: ReactComponentClass[AvatarProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponent(value: ReactComponentClass[AvatarProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withImgProps(value: HtmlHTMLAttributes[HTMLImageElement]): Self = {
        val ret = this.duplicate
