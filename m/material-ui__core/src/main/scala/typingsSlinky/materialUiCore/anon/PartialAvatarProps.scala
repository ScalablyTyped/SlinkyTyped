...
object PartialAvatarProps {
  ...
  implicit class PartialAvatarPropsOps[Self <: PartialAvatarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[AvatarProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[AvatarProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
