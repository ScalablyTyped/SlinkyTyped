...
@js.native
trait PartialDialogContentProps extends StObject {
...
object PartialDialogContentProps {
  ...
  @scala.inline
  implicit class PartialDialogContentPropsMutableBuilder[Self <: PartialDialogContentProps] (val x: Self) extends AnyVal {
