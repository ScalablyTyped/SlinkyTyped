...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/DialogContent.DialogContentProps> */
@js.native
trait PartialDialogContentProps extends js.Object {
...
object PartialDialogContentProps {
  @scala.inline
  def apply(): PartialDialogContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDialogContentProps]
  }
  @scala.inline
  implicit class PartialDialogContentPropsOps[Self <: PartialDialogContentProps] (val x: Self) extends AnyVal {
    @scala.inline
