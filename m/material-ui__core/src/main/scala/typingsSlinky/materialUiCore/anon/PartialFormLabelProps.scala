...
@js.native
trait PartialFormLabelProps extends StObject {
...
object PartialFormLabelProps {
  ...
  @scala.inline
  def apply(): PartialFormLabelProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialFormLabelProps]
  }
  
  @scala.inline
  implicit class PartialFormLabelPropsMutableBuilder[Self <: PartialFormLabelProps] (val x: Self) extends AnyVal {
