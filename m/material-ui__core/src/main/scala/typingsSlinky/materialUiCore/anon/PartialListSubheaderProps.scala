...
object PartialListSubheaderProps {
  ...
  implicit class PartialListSubheaderPropsMutableBuilder[Self <: PartialListSubheaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ListSubheaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ListSubheaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
