...
@js.native
trait PartialClassNameMapRadioC extends StObject {
...
object PartialClassNameMapRadioC {
  ...
  @scala.inline
  implicit class PartialClassNameMapRadioCMutableBuilder[Self <: PartialClassNameMapRadioC] (val x: Self) extends AnyVal {
