...
object PartialCardHeaderProps {
  ...
  implicit class PartialCardHeaderPropsOps[Self <: PartialCardHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[CardHeaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[CardHeaderProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubheaderTypographyProps(value: PartialTypographyPropsAbout): Self = this.set("subheaderTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleTypographyProps(value: PartialTypographyPropsAbout): Self = this.set("titleTypographyProps", value.asInstanceOf[js.Any])
