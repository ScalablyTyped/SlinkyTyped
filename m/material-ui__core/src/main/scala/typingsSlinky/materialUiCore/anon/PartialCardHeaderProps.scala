...
@js.native
trait PartialCardHeaderProps extends StObject {
...
object PartialCardHeaderProps {
  ...
  @scala.inline
  implicit class PartialCardHeaderPropsMutableBuilder[Self <: PartialCardHeaderProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[CardHeaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[CardHeaderProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubheaderReactElement(value: ReactElement): Self = StObject.set(x, "subheader", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubheaderTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "subheaderTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleTypographyProps(value: PartialTypographyPropsAbout): Self = StObject.set(x, "titleTypographyProps", value.asInstanceOf[js.Any])
