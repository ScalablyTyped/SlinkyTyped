...
object PartialTabProps {
  ...
  implicit class PartialTabPropsMutableBuilder[Self <: PartialTabProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTabCla): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: (/* event */ ChangeEvent[Checked], /* value */ js.Any) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    @scala.inline
    def setOnClick(value: _ => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTextColor(value: String | secondary | primary | inherit): Self = StObject.set(x, "textColor", value.asInstanceOf[js.Any])
