...
@js.native
trait PartialSnackbarProps extends StObject {
...
object PartialSnackbarProps {
  ...
  @scala.inline
  implicit class PartialSnackbarPropsMutableBuilder[Self <: PartialSnackbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnchorOrigin(value: SnackbarOrigin): Self = StObject.set(x, "anchorOrigin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSnackbAnchorOriginBottomCenter): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    @scala.inline
    def setClickAwayListenerProps(value: PartialClickAwayListenerP): Self = StObject.set(x, "ClickAwayListenerProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClickAwayListenerPropsUndefined: Self = StObject.set(x, "ClickAwayListenerProps", js.undefined)
    ...
    @scala.inline
    def setContentProps(value: PartialSnackbarContentPro): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisableWindowBlurListener(value: Boolean): Self = StObject.set(x, "disableWindowBlurListener", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisableWindowBlurListenerUndefined: Self = StObject.set(x, "disableWindowBlurListener", js.undefined)
    ...
    @scala.inline
    def setOnClose(value: (/* event */ SyntheticEvent[Event, _], /* reason */ String) => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setResumeHideDuration(value: Double): Self = StObject.set(x, "resumeHideDuration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResumeHideDurationUndefined: Self = StObject.set(x, "resumeHideDuration", js.undefined)
