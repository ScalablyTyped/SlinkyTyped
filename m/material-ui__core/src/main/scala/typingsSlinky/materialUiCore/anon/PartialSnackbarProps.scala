...
trait PartialSnackbarProps extends js.Object {
  ...
  var ClickAwayListenerProps: js.UndefOr[PartialClickAwayListenerP] = js.native
  
  var ContentProps: js.UndefOr[PartialSnackbarContentPro] = js.native
  ...
  var anchorOrigin: js.UndefOr[SnackbarOrigin] = js.native
  ...
  var classes: js.UndefOr[PartialClassNameMapSnackbAnchorOriginBottomCenter] = js.native
...
object PartialSnackbarProps {
  ...
  @scala.inline
  def apply(): PartialSnackbarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarProps]
  }
  
  @scala.inline
  implicit class PartialSnackbarPropsOps[Self <: PartialSnackbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClickAwayListenerProps(value: PartialClickAwayListenerP): Self = this.set("ClickAwayListenerProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClickAwayListenerProps: Self = this.set("ClickAwayListenerProps", js.undefined)
    
    @scala.inline
    def setContentProps(value: PartialSnackbarContentPro): Self = this.set("ContentProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteContentProps: Self = this.set("ContentProps", js.undefined)
    
    @scala.inline
    def setTransitionComponentFunctionComponent(value: ReactComponentClass[TransitionProps]): Self = this.set("TransitionComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransitionComponentComponentClass(value: ReactComponentClass[TransitionProps]): Self = this.set("TransitionComponent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransitionComponent(value: ReactComponentClass[TransitionProps]): Self = this.set("TransitionComponent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAnchorOrigin(value: SnackbarOrigin): Self = this.set("anchorOrigin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSnackbAnchorOriginBottomCenter): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisableWindowBlurListener(value: Boolean): Self = this.set("disableWindowBlurListener", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDisableWindowBlurListener: Self = this.set("disableWindowBlurListener", js.undefined)
    ...
    @scala.inline
    def setOnClose(value: (/* event */ SyntheticEvent[Event, _], /* reason */ String) => Unit): Self = this.set("onClose", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setResumeHideDuration(value: Double): Self = this.set("resumeHideDuration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteResumeHideDuration: Self = this.set("resumeHideDuration", js.undefined)
