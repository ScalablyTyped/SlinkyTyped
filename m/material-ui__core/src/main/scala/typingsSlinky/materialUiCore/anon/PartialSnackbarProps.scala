...
object PartialSnackbarProps {
  @scala.inline
  def apply(
    ClickAwayListenerProps: PartialClickAwayListenerP = null,
    ContentProps: PartialSnackbarContentPro = null,
    ...
    classes: PartialClassNameMapSnackbAnchorOriginBottomCenter = null,
    color: String = null,
    ...
    if (!js.isUndefined(disableWindowBlurListener)) __obj.updateDynamic("disableWindowBlurListener")(disableWindowBlurListener.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(resumeHideDuration)) __obj.updateDynamic("resumeHideDuration")(resumeHideDuration.get.asInstanceOf[js.Any])
