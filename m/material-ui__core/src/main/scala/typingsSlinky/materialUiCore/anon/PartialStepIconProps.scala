...
object PartialStepIconProps {
  ...
  @scala.inline
  implicit class PartialStepIconPropsOps[Self <: PartialStepIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapStepIc): Self = this.set("classes", value.asInstanceOf[js.Any])
