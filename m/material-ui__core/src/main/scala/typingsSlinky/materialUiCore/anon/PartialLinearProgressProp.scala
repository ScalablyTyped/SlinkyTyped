...
import typingsSlinky.materialUiCore.materialUiCoreStrings.buffer
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.query
...
@js.native
trait PartialLinearProgressProp extends js.Object {
...
object PartialLinearProgressProp {
  @scala.inline
  def apply(): PartialLinearProgressProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLinearProgressProp]
  }
  @scala.inline
  implicit class PartialLinearProgressPropOps[Self <: PartialLinearProgressProp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapLinear): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    @scala.inline
    def setColor(value: primary | secondary): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setValueBuffer(value: Double): Self = this.set("valueBuffer", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteValueBuffer: Self = this.set("valueBuffer", js.undefined)
    @scala.inline
    def setVariant(value: determinate | indeterminate | buffer | query): Self = this.set("variant", value.asInstanceOf[js.Any])
    @scala.inline
