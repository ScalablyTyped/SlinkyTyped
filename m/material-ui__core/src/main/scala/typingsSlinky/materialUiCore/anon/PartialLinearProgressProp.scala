...
object PartialLinearProgressProp {
  ...
  implicit class PartialLinearProgressPropOps[Self <: PartialLinearProgressProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapLinear): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withColor(value: primary | secondary): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValueBuffer(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("valueBuffer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutValueBuffer: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("valueBuffer")(js.undefined)
        ret
    }
    @scala.inline
    def withVariant(value: determinate | indeterminate | buffer | query): Self = {
        val ret = this.duplicate
