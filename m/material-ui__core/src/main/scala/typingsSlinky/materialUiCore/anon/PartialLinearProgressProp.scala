...
@js.native
trait PartialLinearProgressProp extends StObject {
...
object PartialLinearProgressProp {
  ...
  @scala.inline
  implicit class PartialLinearProgressPropMutableBuilder[Self <: PartialLinearProgressProp] (val x: Self) extends AnyVal {
