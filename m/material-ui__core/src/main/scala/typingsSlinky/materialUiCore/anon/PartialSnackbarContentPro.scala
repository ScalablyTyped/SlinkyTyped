...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/SnackbarContent.SnackbarContentProps> */
@js.native
trait PartialSnackbarContentPro extends js.Object {
...
object PartialSnackbarContentPro {
  @scala.inline
  def apply(): PartialSnackbarContentPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSnackbarContentPro]
  }
  @scala.inline
  implicit class PartialSnackbarContentProOps[Self <: PartialSnackbarContentPro] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapSnackb): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[PaperProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[PaperProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
