...
@js.native
trait PartialSnackbarContentPro extends StObject {
...
object PartialSnackbarContentPro {
  ...
  @scala.inline
  implicit class PartialSnackbarContentProMutableBuilder[Self <: PartialSnackbarContentPro] (val x: Self) extends AnyVal {
