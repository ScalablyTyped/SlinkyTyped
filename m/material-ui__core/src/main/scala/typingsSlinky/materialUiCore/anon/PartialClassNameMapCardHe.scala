...
@js.native
trait PartialClassNameMapCardHe extends StObject {
...
object PartialClassNameMapCardHe {
  ...
  @scala.inline
  implicit class PartialClassNameMapCardHeMutableBuilder[Self <: PartialClassNameMapCardHe] (val x: Self) extends AnyVal {
