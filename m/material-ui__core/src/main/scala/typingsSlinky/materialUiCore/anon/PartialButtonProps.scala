...
object PartialButtonProps {
  ...
  implicit class PartialButtonPropsMutableBuilder[Self <: PartialButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ButtonProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ButtonProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
