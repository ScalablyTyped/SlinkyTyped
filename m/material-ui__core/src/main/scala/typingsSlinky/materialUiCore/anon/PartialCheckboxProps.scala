...
object PartialCheckboxProps {
  ...
  implicit class PartialCheckboxPropsMutableBuilder[Self <: PartialCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCheckb): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ButtonBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ButtonBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIndeterminateIcon(value: ReactElement): Self = StObject.set(x, "indeterminateIcon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIndeterminateIconReactElement(value: ReactElement): Self = StObject.set(x, "indeterminateIcon", value.asInstanceOf[js.Any])
