...
trait PartialCheckboxProps extends js.Object {
  ...
  var indeterminateIcon: js.UndefOr[ReactElement] = js.native
...
object PartialCheckboxProps {
  ...
  implicit class PartialCheckboxPropsOps[Self <: PartialCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIndeterminateIcon(value: ReactElement): Self = this.set("indeterminateIcon", value.asInstanceOf[js.Any])
    @scala.inline
