...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Checkbox.CheckboxProps> */
@js.native
trait PartialCheckboxProps extends js.Object {
  ...
  var checkedIcon: js.UndefOr[TagMod[Any]] = js.native
  ...
  var indeterminateIcon: js.UndefOr[TagMod[Any]] = js.native
...
object PartialCheckboxProps {
  ...
  implicit class PartialCheckboxPropsOps[Self <: PartialCheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckedIconReactElement(value: ReactElement): Self = this.set("checkedIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapCheckb): Self = this.set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIndeterminateIconReactElement(value: ReactElement): Self = this.set("indeterminateIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def setIndeterminateIcon(value: TagMod[Any]): Self = this.set("indeterminateIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIndeterminateIcon: Self = this.set("indeterminateIcon", js.undefined)
    @scala.inline
