...
@js.native
trait PartialDialogContentTextP extends StObject {
...
object PartialDialogContentTextP {
  ...
  @scala.inline
  implicit class PartialDialogContentTextPMutableBuilder[Self <: PartialDialogContentTextP] (val x: Self) extends AnyVal {
