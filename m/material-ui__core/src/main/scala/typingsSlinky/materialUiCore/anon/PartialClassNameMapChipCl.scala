...
object PartialClassNameMapChipCl {
  ...
  implicit class PartialClassNameMapChipClOps[Self <: PartialClassNameMapChipCl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAvatarChildren(value: String): Self = this.set("avatarChildren", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAvatarChildren: Self = this.set("avatarChildren", js.undefined)
    @scala.inline
    def setAvatarPrimary(value: String): Self = this.set("avatarPrimary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAvatarPrimary: Self = this.set("avatarPrimary", js.undefined)
    @scala.inline
    def setAvatarSecondary(value: String): Self = this.set("avatarSecondary", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClickablePrimary(value: String): Self = this.set("clickablePrimary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClickablePrimary: Self = this.set("clickablePrimary", js.undefined)
    @scala.inline
    def setClickableSecondary(value: String): Self = this.set("clickableSecondary", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDeletablePrimary(value: String): Self = this.set("deletablePrimary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDeletablePrimary: Self = this.set("deletablePrimary", js.undefined)
    @scala.inline
    def setDeletableSecondary(value: String): Self = this.set("deletableSecondary", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDeleteIconOutlinedColorPrimary(value: String): Self = this.set("deleteIconOutlinedColorPrimary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDeleteIconOutlinedColorPrimary: Self = this.set("deleteIconOutlinedColorPrimary", js.undefined)
    @scala.inline
    def setDeleteIconOutlinedColorSecondary(value: String): Self = this.set("deleteIconOutlinedColorSecondary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDeleteIconOutlinedColorSecondary: Self = this.set("deleteIconOutlinedColorSecondary", js.undefined)
    @scala.inline
    def setDeleteIconPrimary(value: String): Self = this.set("deleteIconPrimary", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDeleteIconPrimary: Self = this.set("deleteIconPrimary", js.undefined)
    @scala.inline
    def setDeleteIconSecondary(value: String): Self = this.set("deleteIconSecondary", value.asInstanceOf[js.Any])
    @scala.inline
