...
object PartialExpansionPanelSumm {
  ...
  implicit class PartialExpansionPanelSummOps[Self <: PartialExpansionPanelSumm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIconButtonProps(value: PartialIconButtonProps): Self = {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapExpansContent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChange(value: SyntheticEvent[Event, js.Object] => Unit): Self = {
        val ret = this.duplicate
