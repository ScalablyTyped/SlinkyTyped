...
object PartialMenuItemProps {
  ...
  implicit class PartialMenuItemPropsOps[Self <: PartialMenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[MenuItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[MenuItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
