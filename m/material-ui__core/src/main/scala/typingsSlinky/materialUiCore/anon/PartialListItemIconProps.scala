...
@js.native
trait PartialListItemIconProps extends StObject {
...
object PartialListItemIconProps {
  ...
  @scala.inline
  def apply(): PartialListItemIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemIconProps]
  }
  
  @scala.inline
  implicit class PartialListItemIconPropsMutableBuilder[Self <: PartialListItemIconProps] (val x: Self) extends AnyVal {
