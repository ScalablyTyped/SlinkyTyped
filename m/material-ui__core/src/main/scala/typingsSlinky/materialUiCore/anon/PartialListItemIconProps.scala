...
object PartialListItemIconProps {
  ...
  @scala.inline
  implicit class PartialListItemIconPropsOps[Self <: PartialListItemIconProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapListItRoot): Self = {
        val ret = this.duplicate
