...
object PartialStepperProps {
  ...
  implicit class PartialStepperPropsOps[Self <: PartialStepperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapSteppe): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withConnectorReactElement(value: ReactElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("connector")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withConnector(value: ReactElement | TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("connector")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withNonLinear(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nonLinear")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNonLinear: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nonLinear")(js.undefined)
        ret
    }
    @scala.inline
