...
object tableFooterTableFooterMod extends Shortcut {
  ...
  object TableFooterProps {
    ...
    implicit class TableFooterPropsMutableBuilder[Self <: TableFooterProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[TableFooterBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[TableFooterBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
