package typingsSlinky.materialUiCore.snackbarContentSnackbarContentMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapSnackb
...
object SnackbarContentProps {
  ...
  @scala.inline
  implicit class SnackbarContentPropsOps[Self <: SnackbarContentProps] (val x: Self) extends AnyVal {
    @scala.inline
