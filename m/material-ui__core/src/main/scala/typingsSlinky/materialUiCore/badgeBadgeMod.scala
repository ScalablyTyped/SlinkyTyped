  ...
  */
  ...
  object BadgeProps {
    ...
    implicit class BadgePropsMutableBuilder[Self <: BadgeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBadgeContentReactElement(value: ReactElement): Self = StObject.set(x, "badgeContent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[BadgeProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[BadgeProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
