...
object inputAdornmentInputAdornmentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[InputAdornmentProps] = js.native
  ...
  */
  ...
  @js.native
  trait InputAdornmentProps extends StObject {
  ...
  object InputAdornmentProps {
    ...
    @scala.inline
    implicit class InputAdornmentPropsMutableBuilder[Self <: InputAdornmentProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[InputAdornmentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[InputAdornmentProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[InputAdornmentProps]
  
  /* This means you don't have to write `default`, but can instead just say `inputAdornmentInputAdornmentMod.foo` */
  override def _to: ReactComponentClass[InputAdornmentProps] = default
}
