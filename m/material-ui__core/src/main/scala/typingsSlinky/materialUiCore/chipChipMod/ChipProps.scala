...
import typingsSlinky.materialUiCore.PartialClassNameMapChipCl
...
trait ChipProps extends js.Object {
  ...
  var component: js.UndefOr[ReactComponentClass[ChipProps]] = js.native
...
object ChipProps {
  ...
  implicit class ChipPropsOps[Self <: ChipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapChipCl): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withComponentFunctionComponent(value: ReactComponentClass[ChipProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponentComponentClass(value: ReactComponentClass[ChipProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComponent(value: ReactComponentClass[ChipProps]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("component")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withDeleteIcon(value: ReactElement): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDelete(value: _ => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVariant(value: typingsSlinky.materialUiCore.materialUiCoreStrings.default | outlined): Self = {
        val ret = this.duplicate
