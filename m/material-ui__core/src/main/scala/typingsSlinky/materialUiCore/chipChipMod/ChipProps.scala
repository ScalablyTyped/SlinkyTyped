...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Chip/Chip.ChipClassKey, never> */
@js.native
trait ChipProps extends js.Object {
  ...
  var onDelete: js.UndefOr[EventHandler[_]] = js.native
  ...
  var variant: js.UndefOr[typingsSlinky.materialUiCore.materialUiCoreStrings.default | outlined] = js.native
...
object ChipProps {
  ...
  implicit class ChipPropsOps[Self <: ChipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapChipCl): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ChipProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ChipProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponent(value: ReactType[ChipProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeleteIcon(value: ReactElement): Self = this.set("deleteIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnDelete(value: _ => Unit): Self = this.set("onDelete", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setVariant(value: typingsSlinky.materialUiCore.materialUiCoreStrings.default | outlined): Self = this.set("variant", value.asInstanceOf[js.Any])
