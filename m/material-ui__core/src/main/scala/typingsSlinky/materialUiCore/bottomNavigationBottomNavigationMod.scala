...
object bottomNavigationBottomNavigationMod extends Shortcut {
  ...
  object BottomNavigationProps {
    ...
    implicit class BottomNavigationPropsMutableBuilder[Self <: BottomNavigationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[BottomNavigationProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[BottomNavigationProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
