...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapStepLa
...
object stepLabelStepLabelMod extends Shortcut {
  
  @JSImport("@material-ui/core/StepLabel/StepLabel", JSImport.Default)
  @js.native
  val default: ReactComponentClass[StepLabelProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.horizontal
    - typingsSlinky.materialUiCore.materialUiCoreStrings.vertical
    - typingsSlinky.materialUiCore.materialUiCoreStrings.active
    - typingsSlinky.materialUiCore.materialUiCoreStrings.completed
    - typingsSlinky.materialUiCore.materialUiCoreStrings.alternativeLabel
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.iconContainer
    - typingsSlinky.materialUiCore.materialUiCoreStrings.labelContainer
  */
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepLabel/StepLabel.StepLabelClasskey, never> */
  @js.native
  trait StepLabelProps extends StObject {
    
    var StepIconComponent: js.UndefOr[ReactType[_]] = js.native
    
    var StepIconProps: js.UndefOr[PartialStepIconProps] = js.native
  ...
  object StepLabelProps {
    ...
    implicit class StepLabelPropsMutableBuilder[Self <: StepLabelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapStepLa): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOptional(value: ReactElement): Self = StObject.set(x, "optional", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptionalReactElement(value: ReactElement): Self = StObject.set(x, "optional", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStepIconComponent(value: ReactType[_]): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepIconComponentComponentClass(value: ReactComponentClass[_]): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepIconComponentFunctionComponent(value: ReactComponentClass[_]): Self = StObject.set(x, "StepIconComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepIconComponentUndefined: Self = StObject.set(x, "StepIconComponent", js.undefined)
      
      @scala.inline
      def setStepIconProps(value: PartialStepIconProps): Self = StObject.set(x, "StepIconProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepIconPropsUndefined: Self = StObject.set(x, "StepIconProps", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `stepLabelStepLabelMod.foo` */
