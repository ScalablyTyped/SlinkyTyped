...
object GridProps {
  ...
  implicit class GridPropsOps[Self <: GridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[OmitGridPropsStrippedProp]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[OmitGridPropsStrippedProp]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponent(value: String | ReactComponentClass[OmitGridPropsStrippedProp]): Self = this.set("component", value.asInstanceOf[js.Any])
