...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapNative
...
object nativeSelectNativeSelectMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.selectMenu
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.outlined
  */
  ...
  object NativeSelectClassKey {
    ...
    @scala.inline
    def selectMenu: typingsSlinky.materialUiCore.materialUiCoreStrings.selectMenu = "selectMenu".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.selectMenu]
  }
  ...
  object NativeSelectProps {
    ...
    implicit class NativeSelectPropsMutableBuilder[Self <: NativeSelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapNative): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEndAdornmentReactElement(value: ReactElement): Self = StObject.set(x, "endAdornment", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInputComponentComponentClass(value: ReactComponentClass[InputBaseComponentProps]): Self = StObject.set(x, "inputComponent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInputComponentFunctionComponent(value: ReactComponentClass[InputBaseComponentProps]): Self = StObject.set(x, "inputComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInputRef(value: Ref[_] | ReactRef[_]): Self = StObject.set(x, "inputRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderPrefix(value: /* state */ Disabled => ReactElement): Self = StObject.set(x, "renderPrefix", js.Any.fromFunction1(value))
