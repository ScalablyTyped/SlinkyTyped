...
import typingsSlinky.materialUiCore.PartialClassNameMapAvatar
import typingsSlinky.materialUiCore.avatarAvatarMod.AvatarProps
import typingsSlinky.materialUiCore.avatarMod.default
...
object Avatar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def childrenClassName(value: String): this.type = set("childrenClassName", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[AvatarProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[AvatarProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[AvatarProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def imgProps(value: HtmlHTMLAttributes[HTMLImageElement]): this.type = set("imgProps", value.asInstanceOf[js.Any])
    @scala.inline
