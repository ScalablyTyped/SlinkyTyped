...
import typingsSlinky.materialUiCore.PartialClassNameMapTypogr
...
object Typography {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTypogr): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
