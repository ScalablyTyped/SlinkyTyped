...
import typingsSlinky.materialUiCore.PartialClassNameMapSelect
...
import typingsSlinky.materialUiCore.selectMod.default
...
object Select
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.selectMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
