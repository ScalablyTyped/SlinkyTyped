...
import typingsSlinky.materialUiCore.PartialClassNameMapIconBu
...
object IconButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapIconBu): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
