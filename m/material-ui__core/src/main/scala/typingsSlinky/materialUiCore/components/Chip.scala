...
object Chip {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapChipCl): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[ChipProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onDelete(value: _ => Unit): this.type = set("onDelete", js.Any.fromFunction1(value))
    @scala.inline
