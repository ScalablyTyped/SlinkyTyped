...
import typingsSlinky.materialUiCore.PartialClassNameMapCardAcAction
import typingsSlinky.materialUiCore.cardActionsCardActionsMod.CardActionsProps
import typingsSlinky.materialUiCore.cardActionsMod.default
...
object CardActions
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.cardActionsMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
