...
object CardActions {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapCardAcAction): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def disableActionSpacing(value: Boolean): this.type = set("disableActionSpacing", value.asInstanceOf[js.Any])
    @scala.inline
