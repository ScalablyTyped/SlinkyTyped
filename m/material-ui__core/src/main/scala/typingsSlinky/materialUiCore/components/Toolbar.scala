...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapToolba
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.regular
...
import typingsSlinky.materialUiCore.toolbarMod.default
...
object Toolbar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapToolba): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: regular | dense): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
