...
import typingsSlinky.materialUiCore.PartialClassNameMapGridLiImgFullHeight
import typingsSlinky.materialUiCore.gridListTileGridListTileMod.GridListTileProps
import typingsSlinky.materialUiCore.gridListTileMod.default
...
object GridListTile {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapGridLiImgFullHeight): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def cols(value: Double): this.type = set("cols", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[GridListTileProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[GridListTileProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[GridListTileProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: GridListTileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: GridListTile.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
