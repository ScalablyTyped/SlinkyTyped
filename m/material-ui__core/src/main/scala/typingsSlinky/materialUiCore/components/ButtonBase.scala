...
import typingsSlinky.materialUiCore.PartialClassNameMapButtonDisabled
...
import typingsSlinky.materialUiCore.buttonBaseMod.default
...
object ButtonBase {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapButtonDisabled): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ButtonBaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ButtonBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
