...
import typingsSlinky.materialUiCore.PartialClassNameMapAppBar
import typingsSlinky.materialUiCore.appBarAppBarMod.AppBarProps
import typingsSlinky.materialUiCore.appBarMod.default
...
object AppBar
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.appBarMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
