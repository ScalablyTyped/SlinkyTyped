...
import typingsSlinky.materialUiCore.AnonLeft
import typingsSlinky.materialUiCore.PartialClassNameMapTabInd
...
import typingsSlinky.materialUiCore.tabIndicatorMod.TabIndicatorProps
import typingsSlinky.materialUiCore.tabIndicatorMod.default
...
object TabIndicator {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTabInd): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: TabIndicatorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(color: secondary | primary | String, style: AnonLeft): Builder = {
    val __props = js.Dynamic.literal(color = color.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TabIndicatorProps]))
  }
}
