...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapOutlin
...
object OutlinedInput {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapOutlin): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(labelWidth: Double): Builder = {
    val __props = js.Dynamic.literal(labelWidth = labelWidth.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OutlinedInputProps]))
  }
}
