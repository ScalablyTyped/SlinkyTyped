...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapStepCoLast
...
object StepContent {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapStepCoLast): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def optional(value: Boolean): this.type = set("optional", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def transitionDuration(value: js.Any | auto): this.type = set("transitionDuration", value.asInstanceOf[js.Any])
