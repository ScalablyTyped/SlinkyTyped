...
object TextField {
  object FilledTextFieldProps {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def classes(value: PartialClassNameMapTextFi): this.type = set("classes", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def margin(value: Margin): this.type = set("margin", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def onBlur(value: _ => Unit): this.type = set("onBlur", js.Any.fromFunction1(value))
      @scala.inline
      ...
      @scala.inline
      def onChange(value: ChangeEvent[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
      @scala.inline
      ...
      @scala.inline
      def onFocus(value: _ => Unit): this.type = set("onFocus", js.Any.fromFunction1(value))
      @scala.inline
