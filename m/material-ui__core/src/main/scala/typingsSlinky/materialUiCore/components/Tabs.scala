...
object Tabs
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, download, draggable, form, hidden, href, id, lang, media, name, placeholder, rel, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title, type */
  def apply(
    value: js.Any,
