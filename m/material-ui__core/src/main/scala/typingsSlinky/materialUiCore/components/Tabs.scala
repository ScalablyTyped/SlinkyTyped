...
import typingsSlinky.materialUiCore.PartialClassNameMapTabsCl
import typingsSlinky.materialUiCore.PartialTabIndicatorProps
...
object Tabs {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def action(value: /* actions */ TabsActions => Unit): this.type = set("action", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTabsCl): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[TabsProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def indicatorColor(value: secondary | primary | String): this.type = set("indicatorColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def scrollButtons(value: auto | on | off): this.type = set("scrollButtons", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def textColor(value: secondary | primary | inherit | String): this.type = set("textColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: standard | scrollable | fullWidth): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
