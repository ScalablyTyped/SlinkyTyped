...
import typingsSlinky.materialUiCore.formLabelMod.default
...
object FormLabel
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.label.tag.type, typingsSlinky.materialUiCore.formLabelMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
