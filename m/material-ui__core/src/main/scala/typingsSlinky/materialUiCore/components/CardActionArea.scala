...
import typingsSlinky.materialUiCore.PartialClassNameMapCardAc
...
import typingsSlinky.materialUiCore.cardActionAreaCardActionAreaMod.CardActionAreaProps
import typingsSlinky.materialUiCore.cardActionAreaMod.default
...
object CardActionArea {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapCardAc): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: CardActionAreaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: CardActionArea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
