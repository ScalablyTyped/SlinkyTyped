...
object CardActionArea
  ...
  typingsSlinky.materialUiCore.cardActionAreaMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = CardActionAreaProps
}
