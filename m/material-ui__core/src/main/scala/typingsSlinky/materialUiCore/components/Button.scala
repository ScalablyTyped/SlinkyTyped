...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapButton
...
import typingsSlinky.materialUiCore.buttonMod.default
...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapButton): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: Color): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[ButtonProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[ButtonProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[ButtonProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: text | flat | outlined | contained | raised | fab | extendedFab): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
