...
import typingsSlinky.materialUiCore.textareaMod.TextareaProps
import typingsSlinky.materialUiCore.textareaMod.default
...
object Textarea
  ...
  typingsSlinky.materialUiCore.textareaMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
