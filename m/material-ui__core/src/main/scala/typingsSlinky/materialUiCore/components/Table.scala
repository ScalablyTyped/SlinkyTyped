...
object Table
  ...
  def apply(
    ...
    color: String = null,
    component: ReactComponentClass[TableBaseProps] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.table.tag.type, typingsSlinky.materialUiCore.tableMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
