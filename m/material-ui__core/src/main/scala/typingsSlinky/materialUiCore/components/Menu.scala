...
import typingsSlinky.materialUiCore.PartialClassNameMapMenuCl
import typingsSlinky.materialUiCore.PartialClassNameMapModalC
import typingsSlinky.materialUiCore.PartialClassNameMapPopove
import typingsSlinky.materialUiCore.PartialMenuListProps
...
object Menu {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def MenuListProps(value: PartialMenuListProps): this.type = set("MenuListProps", value.asInstanceOf[js.Any])
    @scala.inline
    def ModalClasses(value: PartialClassNameMapModalC): this.type = set("ModalClasses", value.asInstanceOf[js.Any])
    @scala.inline
    def PaperProps(value: PartialPaperProps): this.type = set("PaperProps", value.asInstanceOf[js.Any])
    @scala.inline
    def PopoverClasses(value: PartialClassNameMapPopove): this.type = set("PopoverClasses", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def classes(value: PartialClassNameMapMenuCl): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
