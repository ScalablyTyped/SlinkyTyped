...
import typingsSlinky.materialUiCore.PartialClassNameMapFabCla
...
import typingsSlinky.materialUiCore.fabMod.default
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.button
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.extended
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.medium
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.reset
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.submit
...
object Fab {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapFabCla): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: Color): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[FabProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[FabProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[FabProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: round | extended): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
    def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: FabProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
