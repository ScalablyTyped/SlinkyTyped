...
import typingsSlinky.materialUiCore.expansionPanelActionsMod.default
...
object ExpansionPanelActions
  ...
  typingsSlinky.materialUiCore.expansionPanelActionsMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
