...
import typingsSlinky.materialUiCore.PartialClassNameMapSwitch
...
object Switch
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, draggable, form, hidden, id, lang, name, placeholder, readOnly, required, spellCheck, style, suppressContentEditableWarning, tabIndex, title, type */
  def apply(
    ...
    color: primary | secondary | typingsSlinky.materialUiCore.materialUiCoreStrings.default = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.input.tag.type, typingsSlinky.materialUiCore.switchMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
