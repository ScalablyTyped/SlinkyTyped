...
import typingsSlinky.materialUiCore.dialogContentMod.default
...
object DialogContent
  ...
  typingsSlinky.materialUiCore.dialogContentMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
