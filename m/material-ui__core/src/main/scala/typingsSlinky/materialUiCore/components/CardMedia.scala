...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapCardMe
import typingsSlinky.materialUiCore.cardMediaCardMediaMod.CardMediaProps
import typingsSlinky.materialUiCore.cardMediaMod.default
...
object CardMedia {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapCardMe): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[CardMediaProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[CardMediaProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[CardMediaProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
