...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapSteppe
...
import typingsSlinky.materialUiCore.stepperMod.default
...
object Stepper {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapSteppe): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def nonLinear(value: Boolean): this.type = set("nonLinear", value.asInstanceOf[js.Any])
    @scala.inline
