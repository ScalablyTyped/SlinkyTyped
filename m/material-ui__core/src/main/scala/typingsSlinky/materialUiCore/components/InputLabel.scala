...
import typingsSlinky.materialUiCore.PartialClassNameMapFormLa
import typingsSlinky.materialUiCore.PartialClassNameMapInputL
...
object InputLabel
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.label.tag.type, typingsSlinky.materialUiCore.inputLabelMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
