...
import typingsSlinky.materialUiCore.PartialClassNameMapStepBu
...
object StepButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def alternativeLabel(value: Boolean): this.type = set("alternativeLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def classes(value: PartialClassNameMapStepBu): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def icon(value: StepButtonIcon): this.type = set("icon", value.asInstanceOf[js.Any])
    @scala.inline
