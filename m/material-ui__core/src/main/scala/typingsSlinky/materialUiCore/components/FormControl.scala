...
import typingsSlinky.materialUiCore.PartialClassNameMapFormCo
import typingsSlinky.materialUiCore.formControlFormControlMod.FormControlProps
import typingsSlinky.materialUiCore.formControlMod.default
...
object FormControl {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapFormCo): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
