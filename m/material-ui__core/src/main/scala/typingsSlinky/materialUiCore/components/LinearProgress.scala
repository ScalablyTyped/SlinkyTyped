...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapLinear
import typingsSlinky.materialUiCore.linearProgressLinearProgressMod.LinearProgressProps
import typingsSlinky.materialUiCore.linearProgressMod.default
...
object LinearProgress {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapLinear): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: primary | secondary): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def valueBuffer(value: Double): this.type = set("valueBuffer", value.asInstanceOf[js.Any])
    @scala.inline
    def variant(value: determinate | indeterminate | buffer | query): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
