...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapExpansRoot
import typingsSlinky.materialUiCore.expansionPanelDetailsExpansionPanelDetailsMod.ExpansionPanelDetailsProps
import typingsSlinky.materialUiCore.expansionPanelDetailsMod.default
...
object ExpansionPanelDetails {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapExpansRoot): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: ExpansionPanelDetailsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ExpansionPanelDetails.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
