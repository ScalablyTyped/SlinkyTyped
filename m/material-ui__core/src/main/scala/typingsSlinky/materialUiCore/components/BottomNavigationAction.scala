...
import typingsSlinky.materialUiCore.PartialClassNameMapBottomIconOnly
...
object BottomNavigationAction {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onClick(value: SyntheticEvent[Event_, _] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
