...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapBottomIconOnly
import typingsSlinky.materialUiCore.bottomNavigationActionBottomNavigationActionMod.BottomNavigationActionProps
import typingsSlinky.materialUiCore.bottomNavigationActionMod.default
...
object BottomNavigationAction {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapBottomIconOnly): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (/* event */ ChangeEvent[js.Object], /* value */ js.Any) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    def onClick(value: SyntheticEvent[Event, _] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: BottomNavigationActionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: BottomNavigationAction.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
