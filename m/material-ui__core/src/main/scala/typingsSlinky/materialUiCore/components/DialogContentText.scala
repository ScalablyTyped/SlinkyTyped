...
object DialogContentText
  ...
  typingsSlinky.materialUiCore.dialogContentTextMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = DialogContentTextProps
}
