...
import typingsSlinky.materialUiCore.dialogContentTextMod.default
...
object DialogContentText {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapDialogRoot): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: Color | textPrimary | textSecondary | error): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[TypographyProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[TypographyProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[TypographyProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def headlineMapping(value: typeinStylestring): this.type = set("headlineMapping", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: Style | inherit): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
    def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: DialogContentTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
