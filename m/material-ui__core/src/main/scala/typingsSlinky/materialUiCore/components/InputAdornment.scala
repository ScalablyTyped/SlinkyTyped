...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapInputA
import typingsSlinky.materialUiCore.inputAdornmentInputAdornmentMod.InputAdornmentProps
import typingsSlinky.materialUiCore.inputAdornmentMod.default
...
object InputAdornment {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapInputA): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[InputAdornmentProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def componentComponentClass(value: ReactComponentClass[InputAdornmentProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def component(value: ReactComponentClass[InputAdornmentProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: InputAdornmentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(position: start | end): Builder = {
    val __props = js.Dynamic.literal(position = position.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[InputAdornmentProps]))
  }
}
