...
object NativeSelect
  ...
  def apply(
    ...
    onFilled: () => Unit = null,
    onKeyDown: SyntheticKeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit = null,
    onKeyUp: SyntheticKeyboardEvent[HTMLTextAreaElement | HTMLInputElement] => Unit = null,
    ...
    renderPrefix: /* state */ AnonDisabled => TagMod[Any] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.nativeSelectMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
