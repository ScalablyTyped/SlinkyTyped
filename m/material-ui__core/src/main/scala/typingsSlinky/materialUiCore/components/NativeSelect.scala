...
import typingsSlinky.materialUiCore.PartialClassNameMapNative
...
import typingsSlinky.materialUiCore.nativeSelectMod.default
...
object NativeSelect {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapNative): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def disableUnderline(value: Boolean): this.type = set("disableUnderline", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def input(value: TagMod[Any]): this.type = set("input", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: NativeSelectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
