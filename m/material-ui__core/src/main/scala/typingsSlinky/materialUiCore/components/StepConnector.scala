...
import typingsSlinky.materialUiCore.PartialClassNameMapStepCo
...
import typingsSlinky.materialUiCore.stepConnectorMod.default
...
object StepConnector
  ...
  typingsSlinky.materialUiCore.stepConnectorMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
