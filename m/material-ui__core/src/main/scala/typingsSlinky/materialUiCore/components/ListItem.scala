...
object ListItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapListIt): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def component(value: ReactComponentClass[ListItemProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
