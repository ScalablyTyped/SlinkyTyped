...
import typingsSlinky.materialUiCore.PartialClassNameMapStepIc
...
import typingsSlinky.materialUiCore.stepIconMod.default
...
object StepIcon {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapStepIc): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
