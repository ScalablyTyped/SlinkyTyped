...
import typingsSlinky.materialUiCore.PartialClassNameMapTabScr
...
import typingsSlinky.materialUiCore.tabScrollButtonMod.TabScrollButtonProps
import typingsSlinky.materialUiCore.tabScrollButtonMod.default
...
object TabScrollButton {
  @JSImport("@material-ui/core/Tabs/TabScrollButton", JSImport.Default)
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTabScr): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: TabScrollButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TabScrollButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
