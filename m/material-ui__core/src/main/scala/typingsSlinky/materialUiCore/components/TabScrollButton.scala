...
object TabScrollButton
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, download, draggable, form, hidden, href, id, lang, media, name, placeholder, rel, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title, type, value */
  def apply(
  ...
  typingsSlinky.materialUiCore.tabScrollButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TabScrollButtonProps
}
