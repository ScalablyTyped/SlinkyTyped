...
import typingsSlinky.materialUiCore.snackbarContentMod.default
...
object SnackbarContent {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapSnackb): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: SnackbarContentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
