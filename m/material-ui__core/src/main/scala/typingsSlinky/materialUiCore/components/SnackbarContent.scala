...
object SnackbarContent
  ...
  def apply(
    ...
    classes: PartialClassNameMapSnackb = null,
    color: String = null,
  ...
  typingsSlinky.materialUiCore.snackbarContentMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
