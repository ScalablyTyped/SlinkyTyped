...
object NotchedOutline
  ...
  def apply(
    ...
    onBeforeInput: SyntheticEvent[EventTarget with HTMLFieldSetElement, Event_] => Unit = null,
    onReset: SyntheticEvent[EventTarget with HTMLFieldSetElement, Event_] => Unit = null,
