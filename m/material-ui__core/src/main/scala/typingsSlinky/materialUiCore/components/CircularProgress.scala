...
import typingsSlinky.materialUiCore.circularProgressMod.default
...
object CircularProgress {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapCircul): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: primary | secondary | inherit): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def variant(value: determinate | indeterminate | static): this.type = set("variant", value.asInstanceOf[js.Any])
    @scala.inline
