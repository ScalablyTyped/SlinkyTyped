...
import typingsSlinky.materialUiCore.PartialClassNameMapTableS
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.asc
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.desc
...
object TableSortLabel {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def IconComponentComponentClass(value: ReactComponentClass[SvgIconProps]): this.type = set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def IconComponent(value: ReactComponentClass[SvgIconProps]): this.type = set("IconComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTableS): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def hideSortIcon(value: Boolean): this.type = set("hideSortIcon", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: TableSortLabelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: TableSortLabel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
