...
import typingsSlinky.materialUiCore.PartialClassNameMapMenuLi
...
import typingsSlinky.materialUiCore.menuListMod.default
...
object MenuList
  ...
  def apply(
    ...
    onKeyDown: SyntheticEvent[Event_, SyntheticKeyboardEvent[_]] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.ul.tag.type, typingsSlinky.materialUiCore.menuListMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
