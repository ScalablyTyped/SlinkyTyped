...
import typingsSlinky.materialUiCore.PartialClassNameMapMenuIt
...
object MenuItem
  ...
  /* The following DOM/SVG props were specified: className, dangerouslySetInnerHTML, dir, draggable, hidden, id, lang, spellCheck, style, suppressContentEditableWarning, tabIndex, title */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.menuItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
