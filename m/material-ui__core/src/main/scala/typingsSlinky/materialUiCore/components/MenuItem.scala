...
object MenuItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapMenuIt): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[MenuItemProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
