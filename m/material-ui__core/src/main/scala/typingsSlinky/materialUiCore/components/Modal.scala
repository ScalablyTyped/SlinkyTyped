...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapModalC
...
object Modal {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapModalC): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onClose(value: SyntheticEvent[Event, js.Object] => Unit): this.type = set("onClose", js.Any.fromFunction1(value))
    @scala.inline
