...
import typingsSlinky.materialUiCore.PartialClassNameMapModalC
...
object Modal {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onClose(value: SyntheticEvent[Event_, js.Object] => Unit): this.type = set("onClose", js.Any.fromFunction1(value))
    @scala.inline
