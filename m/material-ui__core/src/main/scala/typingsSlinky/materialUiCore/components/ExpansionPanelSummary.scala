...
import typingsSlinky.materialUiCore.PartialClassNameMapExpansContent
...
object ExpansionPanelSummary {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[Event_, js.Object] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
