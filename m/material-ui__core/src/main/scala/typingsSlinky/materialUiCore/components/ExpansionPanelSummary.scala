...
object ExpansionPanelSummary
  ...
  def apply(
    ...
    onChange: SyntheticEvent[Event_, js.Object] => Unit = null,
  ...
  typingsSlinky.materialUiCore.expansionPanelSummaryMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
