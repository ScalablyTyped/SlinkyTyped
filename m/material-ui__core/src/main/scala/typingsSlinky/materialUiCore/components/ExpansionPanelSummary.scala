...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapExpansContent
...
object ExpansionPanelSummary {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapExpansContent): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: SyntheticEvent[Event, js.Object] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    @scala.inline
  ...
  def withProps(p: ExpansionPanelSummaryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ExpansionPanelSummary.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
