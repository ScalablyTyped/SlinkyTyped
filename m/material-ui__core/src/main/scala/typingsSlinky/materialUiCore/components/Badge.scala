...
import typingsSlinky.materialUiCore.PartialClassNameMapBadgeC
...
object Badge {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapBadgeC): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: Color | error): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[BadgeProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
