...
import typingsSlinky.materialUiCore.AnonChecked
import typingsSlinky.materialUiCore.PartialClassNameMapTabCla
...
import typingsSlinky.materialUiCore.tabMod.default
...
object Tab {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapTabCla): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (/* event */ ChangeEvent[AnonChecked], /* value */ js.Any) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    def onClick(value: _ => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def textColor(value: String | secondary | primary | inherit): this.type = set("textColor", value.asInstanceOf[js.Any])
    @scala.inline
