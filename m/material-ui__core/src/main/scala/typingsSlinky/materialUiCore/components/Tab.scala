...
object Tab
  ...
  /* The following DOM/SVG props were specified: autoFocus, className, dangerouslySetInnerHTML, defaultChecked, defaultValue, dir, disabled, download, draggable, form, hidden, href, id, lang, media, name, placeholder, rel, selected, spellCheck, style, suppressContentEditableWarning, tabIndex, target, title, type */
  def apply(
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.materialUiCore.tabMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TabProps
}
