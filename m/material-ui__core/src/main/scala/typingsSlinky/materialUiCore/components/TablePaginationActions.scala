...
import typingsSlinky.materialUiCore.tablePaginationActionsMod.default
...
object TablePaginationActions {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def backIconButtonProps(value: PartialIconButtonProps): this.type = set("backIconButtonProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def nextIconButtonProps(value: PartialIconButtonProps): this.type = set("nextIconButtonProps", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def apply(
    ...
    val __props = js.Dynamic.literal(count = count.asInstanceOf[js.Any], onChangePage = js.Any.fromFunction2(onChangePage), page = page.asInstanceOf[js.Any], rowsPerPage = rowsPerPage.asInstanceOf[js.Any])
