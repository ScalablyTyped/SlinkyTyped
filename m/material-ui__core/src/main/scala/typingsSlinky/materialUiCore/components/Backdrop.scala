...
import typingsSlinky.materialUiCore.PartialClassNameMapBackdr
import typingsSlinky.materialUiCore.backdropBackdropMod.BackdropProps
import typingsSlinky.materialUiCore.backdropMod.default
...
object Backdrop {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapBackdr): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onClick(value: SyntheticEvent[Event_, js.Object] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
    @scala.inline
