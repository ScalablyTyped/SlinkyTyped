...
import typingsSlinky.materialUiCore.dialogActionsMod.default
...
object DialogActions
  ...
  typingsSlinky.materialUiCore.dialogActionsMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
