...
import typingsSlinky.materialUiCore.PartialClassNameMapCardHe
...
import typingsSlinky.materialUiCore.cardHeaderMod.default
...
object CardHeader
  ...
  def apply(
    ...
    color: String = null,
    component: ReactComponentClass[CardHeaderProps] = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.materialUiCore.cardHeaderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
