...
object ExpansionPanel
  ...
  def apply(
    ...
    classes: PartialClassNameMapExpans = null,
    color: String = null,
    ...
    if (CollapseProps != null) __obj.updateDynamic("CollapseProps")(CollapseProps.asInstanceOf[js.Any])
  ...
  typingsSlinky.materialUiCore.expansionPanelMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
