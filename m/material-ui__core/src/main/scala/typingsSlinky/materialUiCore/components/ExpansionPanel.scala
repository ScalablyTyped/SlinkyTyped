...
import typingsSlinky.materialUiCore.expansionPanelMod.default
...
object ExpansionPanel {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def CollapseProps(value: PartialCollapseProps): this.type = set("CollapseProps", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def classes(value: PartialClassNameMapExpans): this.type = set("classes", value.asInstanceOf[js.Any])
    @scala.inline
    def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[PaperProps]): this.type = set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onChange(value: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit): this.type = set("onChange", js.Any.fromFunction2(value))
    @scala.inline
  ...
  def withProps(p: ExpansionPanelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: ExpansionPanel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
