...
object Icon {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def classes(value: PartialClassNameMapIconCl): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def componentFunctionComponent(value: ReactComponentClass[IconProps]): this.type = set("component", value.asInstanceOf[js.Any])
