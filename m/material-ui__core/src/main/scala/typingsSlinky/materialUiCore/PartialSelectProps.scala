...
trait PartialSelectProps extends js.Object {
  ...
  var input: js.UndefOr[TagMod[Any]] = js.native
...
object PartialSelectProps {
  ...
  @scala.inline
  implicit class PartialSelectPropsOps[Self <: PartialSelectProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMenuProps(value: PartialMenuPropsAbout): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapSelect): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInput(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("input")(value.asInstanceOf[js.Any])
        ret
    }
