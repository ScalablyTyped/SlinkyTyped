...
object hiddenCssMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[HiddenCssProps] = js.native
  ...
  type _To = ReactComponentClass[HiddenCssProps]
  
  /* This means you don't have to write `default`, but can instead just say `hiddenCssMod.foo` */
  override def _to: ReactComponentClass[HiddenCssProps] = default
}
