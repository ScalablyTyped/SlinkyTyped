package typingsSlinky.materialUiCore.listItemListItemMod
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps & react.react.LiHTMLAttributes<std.HTMLElement>, @material-ui/core.@material-ui/core/ListItem/ListItem.ListItemClassKey, 'component'> */
@js.native
...
object ListItemProps {
  ...
  implicit class ListItemPropsOps[Self <: ListItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerComponentFunctionComponent(value: ReactComponentClass[HTMLAttributes[HTMLDivElement]]): Self = this.set("ContainerComponent", value.asInstanceOf[js.Any])
    @scala.inline
    def setContainerComponentComponentClass(value: ReactComponentClass[HTMLAttributes[HTMLDivElement]]): Self = this.set("ContainerComponent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[ListItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[ListItemProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
