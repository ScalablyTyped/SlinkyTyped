...
object PartialMenuProps {
  ...
  implicit class PartialMenuPropsOps[Self <: PartialMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackdropProps(value: PartialBackdropProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenuListProps(value: PartialMenuListProps): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPaperProps(value: PartialPaperProps): Self = {
        val ret = this.duplicate
