...
import typingsSlinky.materialUiCore.anon.Classes
...
object withStylesMod {
  ...
  type WithStyles[T /* <: String | StyleRules[String] | StyleRulesCallback[String] */, IncludeTheme /* <: js.UndefOr[Boolean] */] = (js.Object | typingsSlinky.materialUiCore.anon.Theme) with Classes[T]
