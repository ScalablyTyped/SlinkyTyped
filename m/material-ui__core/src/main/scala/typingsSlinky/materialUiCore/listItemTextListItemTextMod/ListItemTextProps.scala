...
object ListItemTextProps {
  ...
  implicit class ListItemTextPropsOps[Self <: ListItemTextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryTypographyProps(value: PartialTypographyProps): Self = this.set("primaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSecondaryTypographyProps(value: PartialTypographyProps): Self = this.set("secondaryTypographyProps", value.asInstanceOf[js.Any])
