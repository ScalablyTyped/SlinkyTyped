...
@js.native
trait PartialExpansionPanelProp extends js.Object {
...
object PartialExpansionPanelProp {
  @scala.inline
  def apply(): PartialExpansionPanelProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialExpansionPanelProp]
  }
  @scala.inline
  implicit class PartialExpansionPanelPropOps[Self <: PartialExpansionPanelProp] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withCollapseProps(value: PartialCollapseProps): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CollapseProps")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCollapseProps: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CollapseProps")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapExpans): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChange(value: (/* event */ ChangeEvent[js.Object], /* expanded */ Boolean) => Unit): Self = {
        val ret = this.duplicate
