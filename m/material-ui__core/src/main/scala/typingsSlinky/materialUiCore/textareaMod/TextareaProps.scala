package typingsSlinky.materialUiCore.textareaMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapTextar
...
object TextareaProps {
  ...
  implicit class TextareaPropsOps[Self <: TextareaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapTextar): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChange(value: ChangeEvent[HTMLTextAreaElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextareaRefRefObject(value: ReactRef[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textareaRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextareaRefFunction1(value: /* instance */ _ | Null => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textareaRef")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTextareaRef(value: Ref[_] | ReactRef[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textareaRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTextareaRef: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textareaRef")(js.undefined)
        ret
    }
    @scala.inline
    def withTextareaRefNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("textareaRef")(null)
        ret
    }
    @scala.inline
