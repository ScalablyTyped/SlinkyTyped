...
object TextareaProps {
  ...
  def apply(
    ...
    textareaRef: js.UndefOr[Null | Ref[_] | ReactRef[_]] = js.undefined,
    title: String = null,
    ...
    if (!js.isUndefined(textareaRef)) __obj.updateDynamic("textareaRef")(textareaRef.asInstanceOf[js.Any])
