...
object TextareaProps {
  ...
  implicit class TextareaPropsOps[Self <: TextareaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTextar): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTextareaRefRefObject(value: ReactRef[_]): Self = this.set("textareaRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextareaRefFunction1(value: /* instance */ _ | Null => Unit): Self = this.set("textareaRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTextareaRef(value: Ref[_] | ReactRef[_]): Self = this.set("textareaRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTextareaRef: Self = this.set("textareaRef", js.undefined)
    
    @scala.inline
    def setTextareaRefNull: Self = this.set("textareaRef", null)
