...
object BaseTextFieldProps {
  ...
  implicit class BaseTextFieldPropsOps[Self <: BaseTextFieldProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormHelperTextProps(value: PartialFormHelperTextProp): Self = this.set("FormHelperTextProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFormHelperTextProps: Self = this.set("FormHelperTextProps", js.undefined)
    
    @scala.inline
    def setInputLabelProps(value: PartialInputLabelProps): Self = this.set("InputLabelProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInputLabelProps: Self = this.set("InputLabelProps", js.undefined)
    
    @scala.inline
    def setSelectProps(value: PartialSelectProps): Self = this.set("SelectProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSelectProps: Self = this.set("SelectProps", js.undefined)
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapTextFi): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FormControlProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FormControlProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputRef(value: Ref[_] | ReactRef[_]): Self = this.set("inputRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnChange(value: ChangeEvent[HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
