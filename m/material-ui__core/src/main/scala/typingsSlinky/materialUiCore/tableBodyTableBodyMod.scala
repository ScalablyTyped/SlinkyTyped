...
object tableBodyTableBodyMod extends Shortcut {
  ...
  type TableBodyBaseProps = HTMLAttributes[HTMLTableSectionElement]
  ...
  object TableBodyProps {
    ...
    implicit class TableBodyPropsMutableBuilder[Self <: TableBodyProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTableB): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[TableBodyBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[TableBodyBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[TableBodyBaseProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
