...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/BottomNavigationAction.BottomNavigationActionProps> */
@js.native
trait PartialBottomNavigationAc extends js.Object {
  ...
  var onClick: js.UndefOr[ReactEventHandler[_]] = js.native
...
object PartialBottomNavigationAc {
  @scala.inline
  def apply(): PartialBottomNavigationAc = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBottomNavigationAc]
  }
  @scala.inline
  implicit class PartialBottomNavigationAcOps[Self <: PartialBottomNavigationAc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withClasses(value: PartialClassNameMapBottomIconOnly): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnClick(value: SyntheticEvent[Event_, _] => Unit): Self = {
        val ret = this.duplicate
