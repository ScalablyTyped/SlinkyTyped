...
object switchBaseMod extends Shortcut {
  
  @JSImport("@material-ui/core/internal/SwitchBase", JSImport.Default)
  @js.native
  val default: ReactComponentClass[SwitchBaseProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.checked
  ...
  */
  ...
  @js.native
  trait SwitchBaseProps extends StObject {
  ...
  object SwitchBaseProps {
    ...
    @scala.inline
    def apply(): SwitchBaseProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SwitchBaseProps]
    }
    
    @scala.inline
    implicit class SwitchBasePropsMutableBuilder[Self <: SwitchBaseProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[SwitchBaseProps]
  
  /* This means you don't have to write `default`, but can instead just say `switchBaseMod.foo` */
  override def _to: ReactComponentClass[SwitchBaseProps] = default
}
