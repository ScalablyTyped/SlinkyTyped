...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapCardAcAction
...
object cardActionsCardActionsMod extends Shortcut {
  
  @JSImport("@material-ui/core/CardActions/CardActions", JSImport.Default)
  @js.native
  val default: ReactComponentClass[CardActionsProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.materialUiCore.materialUiCoreStrings.root
    - typingsSlinky.materialUiCore.materialUiCoreStrings.disableActionSpacing
    - typingsSlinky.materialUiCore.materialUiCoreStrings.action
  */
  ...
  object CardActionsClassKey {
    ...
    @scala.inline
    def disableActionSpacing: typingsSlinky.materialUiCore.materialUiCoreStrings.disableActionSpacing = "disableActionSpacing".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.disableActionSpacing]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/CardActions/CardActions.CardActionsClassKey, never> */
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cardActionsCardActionsMod.foo` */
