...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapLinkCl
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.always
...
import typingsSlinky.materialUiCore.materialUiCoreStrings.hover
...
object linkLinkMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.underlineNone
    - typingsSlinky.materialUiCore.materialUiCoreStrings.underlineHover
    - typingsSlinky.materialUiCore.materialUiCoreStrings.underlineAlways
  ...
  */
  ...
  object LinkProps {
    ...
    implicit class LinkPropsMutableBuilder[Self <: LinkProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapLinkCl): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setComponent(value: ReactType[LinkProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[LinkProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[LinkProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTypographyClasses(value: PartialClassNameMapTypogr): Self = StObject.set(x, "TypographyClasses", value.asInstanceOf[js.Any])
