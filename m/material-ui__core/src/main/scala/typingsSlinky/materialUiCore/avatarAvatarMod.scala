...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapAvatar
...
object avatarAvatarMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.colorDefault
    - typingsSlinky.materialUiCore.materialUiCoreStrings.img
  */
  ...
  object AvatarProps {
    ...
    implicit class AvatarPropsMutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[AvatarProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[AvatarProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
