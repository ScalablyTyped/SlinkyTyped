...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapMenuIt
...
object menuItemMenuItemMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.gutters
  ...
  */
  ...
  object MenuItemProps {
    ...
    implicit class MenuItemPropsMutableBuilder[Self <: MenuItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[MenuItemProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[MenuItemProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
