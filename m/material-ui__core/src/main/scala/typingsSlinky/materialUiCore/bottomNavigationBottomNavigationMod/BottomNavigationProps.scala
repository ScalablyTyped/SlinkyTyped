package typingsSlinky.materialUiCore.bottomNavigationBottomNavigationMod
...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapBottom
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/BottomNavigation/BottomNavigation.BottomNavigationClassKey, 'onChange'> */
@js.native
...
object BottomNavigationProps {
  ...
  implicit class BottomNavigationPropsOps[Self <: BottomNavigationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapBottom): Self = this.set("classes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[BottomNavigationProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[BottomNavigationProps]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponent(value: ReactType[BottomNavigationProps]): Self = this.set("component", value.asInstanceOf[js.Any])
