...
object listSubheaderListSubheaderMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ListSubheaderProps] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.materialUiCore.materialUiCoreStrings.sticky
  ...
  */
  ...
  object ListSubheaderClassKey {
    ...
    @scala.inline
    def sticky: typingsSlinky.materialUiCore.materialUiCoreStrings.sticky = "sticky".asInstanceOf[typingsSlinky.materialUiCore.materialUiCoreStrings.sticky]
  }
  ...
  object ListSubheaderProps {
    ...
    implicit class ListSubheaderPropsMutableBuilder[Self <: ListSubheaderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: typingsSlinky.materialUiCore.materialUiCoreStrings.default | primary | inherit): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[ListSubheaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `listSubheaderListSubheaderMod.foo` */
  override def _to: ReactComponentClass[ListSubheaderProps] = default
}
