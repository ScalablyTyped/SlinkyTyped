...
import typingsSlinky.materialUiCore.anon.PartialClassNameMapRadioC
...
trait RadioProps extends js.Object {
  ...
  var color: js.UndefOr[primary | secondary | typingsSlinky.materialUiCore.materialUiCoreStrings.default] = js.native
...
object RadioProps {
  ...
  implicit class RadioPropsOps[Self <: RadioProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: PartialClassNameMapRadioC): Self = this.set("classes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClasses: Self = this.set("classes", js.undefined)
    
    @scala.inline
    def setColor(value: primary | secondary | typingsSlinky.materialUiCore.materialUiCoreStrings.default): Self = this.set("color", value.asInstanceOf[js.Any])
