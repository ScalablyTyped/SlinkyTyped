...
import typingsSlinky.materialUiCore.anon.Left
import typingsSlinky.materialUiCore.anon.PartialClassNameMapTabInd
...
object tabIndicatorMod extends Shortcut {
  
  @JSImport("@material-ui/core/Tabs/TabIndicator", JSImport.Default)
  @js.native
  val default: ReactComponentClass[TabIndicatorProps] = js.native
  ...
  */
  trait TabIndicatorClassKey extends StObject
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/Tabs/TabIndicator.TabIndicatorClassKey, never> */
  @js.native
  trait TabIndicatorProps extends StObject {
  ...
  object TabIndicatorProps {
    ...
    @scala.inline
    def apply(color: secondary | primary | String, style: Left): TabIndicatorProps = {
    ...
    @scala.inline
    implicit class TabIndicatorPropsMutableBuilder[Self <: TabIndicatorProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClasses(value: PartialClassNameMapTabInd): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
      
      @scala.inline
      def setColor(value: secondary | primary | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[TabIndicatorProps]
  
  /* This means you don't have to write `default`, but can instead just say `tabIndicatorMod.foo` */
  override def _to: ReactComponentClass[TabIndicatorProps] = default
}
