...
trait RealtimeData extends StObject {
  ...
  var query: js.UndefOr[typingsSlinky.maximMazurokGapiClientAnalytics.anon.Filters] = js.native
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientAnalytics.maximMazurokGapiClientAnalyticsStrings.RealtimeData with TopLevel[js.Any]
  ] = js.native
}
object RealtimeData {
  ...
  implicit class RealtimeDataMutableBuilder[Self <: RealtimeData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuery(value: typingsSlinky.maximMazurokGapiClientAnalytics.anon.Filters): Self = StObject.set(x, "query", value.asInstanceOf[js.Any])
