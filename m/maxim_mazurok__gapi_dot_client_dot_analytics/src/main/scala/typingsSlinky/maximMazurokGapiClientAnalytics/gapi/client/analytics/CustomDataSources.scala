...
object CustomDataSources {
  ...
  implicit class CustomDataSourcesOps[Self <: CustomDataSources] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CustomDataSource*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[CustomDataSource]): Self = this.set("items", value.asInstanceOf[js.Any])
