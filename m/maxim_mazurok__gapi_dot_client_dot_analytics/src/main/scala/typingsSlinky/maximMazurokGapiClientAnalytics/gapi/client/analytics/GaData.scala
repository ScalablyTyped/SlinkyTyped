...
import typingsSlinky.maximMazurokGapiClientAnalytics.anon.Cols
...
trait GaData extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientAnalytics.maximMazurokGapiClientAnalyticsStrings.GaData with TopLevel[js.Any]
  ] = js.native
}
object GaData {
