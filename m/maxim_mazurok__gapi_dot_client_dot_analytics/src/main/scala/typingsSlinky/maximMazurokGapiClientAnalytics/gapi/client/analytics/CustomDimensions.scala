...
object CustomDimensions {
  ...
  @scala.inline
  implicit class CustomDimensionsOps[Self <: CustomDimensions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CustomDimension*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[CustomDimension]): Self = this.set("items", value.asInstanceOf[js.Any])
