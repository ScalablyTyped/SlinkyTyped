...
object RemarketingAudience {
  ...
  implicit class RemarketingAudienceOps[Self <: RemarketingAudience] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAudienceDefinition(value: typingsSlinky.maximMazurokGapiClientAnalytics.anon.IncludeConditions): Self = this.set("audienceDefinition", value.asInstanceOf[js.Any])
