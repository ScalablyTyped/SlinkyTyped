...
import typingsSlinky.maximMazurokGapiClientAnalytics.anon.ExcludeConditions
...
trait RemarketingAudience extends StObject {
  ...
  var audienceDefinition: js.UndefOr[typingsSlinky.maximMazurokGapiClientAnalytics.anon.IncludeConditions] = js.native
...
object RemarketingAudience {
  ...
  implicit class RemarketingAudienceMutableBuilder[Self <: RemarketingAudience] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAudienceDefinition(value: typingsSlinky.maximMazurokGapiClientAnalytics.anon.IncludeConditions): Self = StObject.set(x, "audienceDefinition", value.asInstanceOf[js.Any])
