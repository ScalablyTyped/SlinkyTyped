...
trait ExcludeConditions extends StObject {
  ...
  var includeConditions: js.UndefOr[
    typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.IncludeConditions
  ] = js.native
}
object ExcludeConditions {
  ...
  implicit class ExcludeConditionsMutableBuilder[Self <: ExcludeConditions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeConditions(value: typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.IncludeConditions): Self = StObject.set(x, "includeConditions", value.asInstanceOf[js.Any])
