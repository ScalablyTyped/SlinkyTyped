...
@js.native
trait UnsampledReportId extends js.Object {
...
object UnsampledReportId {
  ...
  @scala.inline
  def apply(accountId: String, profileId: String, unsampledReportId: String, webPropertyId: String): UnsampledReportId = {
  ...
  @scala.inline
  implicit class UnsampledReportIdOps[Self <: UnsampledReportId] (val x: Self) extends AnyVal {
