...
import typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.Filter
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(accountId: String, resource: Filter): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Filter): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
