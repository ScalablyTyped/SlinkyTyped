...
object AccountRef {
  ...
  implicit class AccountRefOps[Self <: AccountRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccountRef(value: typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.AccountRef): Self = this.set("accountRef", value.asInstanceOf[js.Any])
