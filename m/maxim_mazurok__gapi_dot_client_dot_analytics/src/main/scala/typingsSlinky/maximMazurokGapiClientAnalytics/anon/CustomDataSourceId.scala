...
import typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.AnalyticsDataimportDeleteUploadDataRequest
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait CustomDataSourceId extends js.Object {
  ...
  var customDataSourceId: String = js.native
  ...
  /** Request body */
  var resource: AnalyticsDataimportDeleteUploadDataRequest = js.native
...
object CustomDataSourceId {
  ...
  @scala.inline
  implicit class CustomDataSourceIdOps[Self <: CustomDataSourceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AnalyticsDataimportDeleteUploadDataRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
