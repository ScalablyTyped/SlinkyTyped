...
import typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.ProfileFilterLink
...
object PrettyPrintProfileId {
  ...
  @scala.inline
  def apply(accountId: String, profileId: String, resource: ProfileFilterLink, webPropertyId: String): PrettyPrintProfileId = {
  ...
  implicit class PrettyPrintProfileIdOps[Self <: PrettyPrintProfileId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ProfileFilterLink): Self = this.set("resource", value.asInstanceOf[js.Any])
