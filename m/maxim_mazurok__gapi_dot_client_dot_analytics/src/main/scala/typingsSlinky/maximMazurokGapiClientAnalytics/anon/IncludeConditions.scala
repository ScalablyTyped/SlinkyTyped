...
object IncludeConditions {
  ...
  implicit class IncludeConditionsOps[Self <: IncludeConditions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeConditions(value: typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.IncludeConditions): Self = this.set("includeConditions", value.asInstanceOf[js.Any])
