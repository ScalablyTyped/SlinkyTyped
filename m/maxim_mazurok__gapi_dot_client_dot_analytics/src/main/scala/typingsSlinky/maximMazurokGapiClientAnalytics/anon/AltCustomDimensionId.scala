...
@js.native
trait AltCustomDimensionId extends StObject {
...
object AltCustomDimensionId {
  
  @scala.inline
  def apply(accountId: String, customDimensionId: String, webPropertyId: String): AltCustomDimensionId = {
    ...
    __obj.asInstanceOf[AltCustomDimensionId]
  }
  
  @scala.inline
  implicit class AltCustomDimensionIdMutableBuilder[Self <: AltCustomDimensionId] (val x: Self) extends AnyVal {
