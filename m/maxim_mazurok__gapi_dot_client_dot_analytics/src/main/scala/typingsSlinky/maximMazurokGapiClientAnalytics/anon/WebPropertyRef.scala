...
object WebPropertyRef {
  ...
  implicit class WebPropertyRefOps[Self <: WebPropertyRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWebPropertyRef(value: typingsSlinky.maximMazurokGapiClientAnalytics.gapi.client.analytics.WebPropertyRef): Self = this.set("webPropertyRef", value.asInstanceOf[js.Any])
