...
@js.native
trait ProfileIdQuotaUser extends js.Object {
...
object ProfileIdQuotaUser {
  ...
  @scala.inline
  def apply(accountId: String, profileId: String, resource: Profile, webPropertyId: String): ProfileIdQuotaUser = {
  ...
  @scala.inline
  implicit class ProfileIdQuotaUserOps[Self <: ProfileIdQuotaUser] (val x: Self) extends AnyVal {
