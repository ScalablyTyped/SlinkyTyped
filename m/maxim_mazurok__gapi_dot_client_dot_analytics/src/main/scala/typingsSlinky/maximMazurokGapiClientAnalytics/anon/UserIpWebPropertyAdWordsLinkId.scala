...
@js.native
trait UserIpWebPropertyAdWordsLinkId extends js.Object {
...
object UserIpWebPropertyAdWordsLinkId {
  ...
  @scala.inline
  implicit class UserIpWebPropertyAdWordsLinkIdOps[Self <: UserIpWebPropertyAdWordsLinkId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: EntityAdWordsLink): Self = this.set("resource", value.asInstanceOf[js.Any])
