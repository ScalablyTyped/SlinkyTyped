...
@js.native
trait AltCustomDataSourceId extends StObject {
...
object AltCustomDataSourceId {
  
  @scala.inline
  def apply(accountId: String, customDataSourceId: String, webPropertyId: String): AltCustomDataSourceId = {
    ...
    __obj.asInstanceOf[AltCustomDataSourceId]
  }
  
  @scala.inline
  implicit class AltCustomDataSourceIdMutableBuilder[Self <: AltCustomDataSourceId] (val x: Self) extends AnyVal {
