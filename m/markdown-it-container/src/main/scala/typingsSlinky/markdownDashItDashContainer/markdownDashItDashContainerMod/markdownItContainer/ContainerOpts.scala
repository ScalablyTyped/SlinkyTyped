package typingsSlinky.markdownDashItDashContainer.markdownDashItDashContainerMod.markdownItContainer

import typingsSlinky.markdownDashIt.libTokenMod.^
...
object ContainerOpts {
  ...
  def apply(
    marker: String = null,
    render: (/* tokens */ js.Array[^], /* index */ Double, /* options */ js.Any, /* env */ js.Any, /* self */ typingsSlinky.markdownDashIt.libRendererMod.^) => Unit = null,
