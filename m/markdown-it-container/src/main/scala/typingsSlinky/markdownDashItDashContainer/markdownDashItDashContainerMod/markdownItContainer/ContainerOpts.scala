...
object ContainerOpts {
  ...
  def apply(
    marker: String = null,
    render: (/* tokens */ js.Array[typingsSlinky.markdownDashIt.libTokenMod.^], /* index */ Double, /* options */ js.Any, /* env */ js.Any, /* self */ typingsSlinky.markdownDashIt.libRendererMod.^) => Unit = null,
