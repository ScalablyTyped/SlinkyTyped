...
version := "4.9.1-131601"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.5",
  "org.scalablytyped.slinky" %%% "cheerio" % "v0.22.0-dt-20200708Z-7536ea",
  "org.scalablytyped.slinky" %%% "csstype" % "2.6.6-9fcfdc",
  "org.scalablytyped.slinky" %%% "enzyme" % "3.10-dt-20200515Z-32f02c",
  "org.scalablytyped.slinky" %%% "jss" % "10.3.0-4741e8",
  "org.scalablytyped.slinky" %%% "material-ui__core" % "3.9.3-5a6d2b",
