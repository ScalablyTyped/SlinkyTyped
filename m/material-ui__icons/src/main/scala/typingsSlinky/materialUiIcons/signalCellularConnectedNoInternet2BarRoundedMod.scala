...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet2BarRounded", JSImport.Namespace)
@js.native
object signalCellularConnectedNoInternet2BarRoundedMod extends js.Object {
  @js.native
