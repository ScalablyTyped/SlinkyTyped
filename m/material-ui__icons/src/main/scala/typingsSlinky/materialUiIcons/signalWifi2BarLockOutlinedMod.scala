...
object signalWifi2BarLockOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalWifi2BarLockOutlinedMod.foo` */
