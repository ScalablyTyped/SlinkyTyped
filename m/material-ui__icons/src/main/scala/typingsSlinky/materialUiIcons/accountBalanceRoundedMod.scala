...
object accountBalanceRoundedMod extends Shortcut {
  
  @JSImport("@material-ui/icons/AccountBalanceRounded", JSImport.Default)
  @js.native
  val default: ReactComponentClass[SvgIconProps] = js.native
  
  type _To = ReactComponentClass[SvgIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `accountBalanceRoundedMod.foo` */
