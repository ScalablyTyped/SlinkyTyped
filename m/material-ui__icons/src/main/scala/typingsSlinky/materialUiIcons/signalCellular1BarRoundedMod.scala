...
object signalCellular1BarRoundedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellular1BarRoundedMod.foo` */
