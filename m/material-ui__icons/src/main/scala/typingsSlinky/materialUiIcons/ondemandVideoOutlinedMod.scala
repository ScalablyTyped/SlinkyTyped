...
object ondemandVideoOutlinedMod extends Shortcut {
  
  @JSImport("@material-ui/icons/OndemandVideoOutlined", JSImport.Default)
  @js.native
  val default: ReactComponentClass[SvgIconProps] = js.native
  
  type _To = ReactComponentClass[SvgIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `ondemandVideoOutlinedMod.foo` */
