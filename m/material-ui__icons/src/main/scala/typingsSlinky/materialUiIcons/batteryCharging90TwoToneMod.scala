...
object batteryCharging90TwoToneMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryCharging90TwoToneMod.foo` */
