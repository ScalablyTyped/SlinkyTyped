...
object createSvgIconMod extends js.Object {
  def default(path: TagMod[Any], displayName: String): ReactComponentClass[SvgIconProps] with (Instantiable1[/* props */ SvgIconProps, typingsSlinky.materialUiCore.svgIconMod.default]) = js.native
}
