...
@JSImport("@material-ui/icons", "PauseCircleFilledTwoTone")
@js.native
class PauseCircleFilledTwoTone protected ()
...
@JSImport("@material-ui/icons", "PauseCircleFilledTwoTone")
@js.native
object PauseCircleFilledTwoTone extends TopLevel[SvgIconComponent]
