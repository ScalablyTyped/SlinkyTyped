...
@JSImport("@material-ui/icons", "AccessibilityNewOutlined")
@js.native
class AccessibilityNewOutlined protected ()
...
@JSImport("@material-ui/icons", "AccessibilityNewOutlined")
@js.native
object AccessibilityNewOutlined extends TopLevel[SvgIconComponent]
