...
@JSImport("@material-ui/icons", "BrightnessMediumTwoTone")
@js.native
class BrightnessMediumTwoTone protected ()
...
@JSImport("@material-ui/icons", "BrightnessMediumTwoTone")
@js.native
object BrightnessMediumTwoTone extends TopLevel[SvgIconComponent]
