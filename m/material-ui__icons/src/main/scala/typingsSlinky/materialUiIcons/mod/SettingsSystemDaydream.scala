...
@JSImport("@material-ui/icons", "SettingsSystemDaydream")
@js.native
class SettingsSystemDaydream protected ()
...
@JSImport("@material-ui/icons", "SettingsSystemDaydream")
@js.native
object SettingsSystemDaydream extends TopLevel[SvgIconComponent]
