...
@JSImport("@material-ui/icons", "AddCircleOutlineOutlined")
@js.native
class AddCircleOutlineOutlined protected ()
...
@JSImport("@material-ui/icons", "AddCircleOutlineOutlined")
@js.native
object AddCircleOutlineOutlined extends TopLevel[SvgIconComponent]
