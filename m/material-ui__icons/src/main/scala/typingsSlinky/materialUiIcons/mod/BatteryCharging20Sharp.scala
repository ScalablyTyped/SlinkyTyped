...
@JSImport("@material-ui/icons", "BatteryCharging20Sharp")
@js.native
class BatteryCharging20Sharp protected ()
...
@JSImport("@material-ui/icons", "BatteryCharging20Sharp")
@js.native
object BatteryCharging20Sharp extends TopLevel[SvgIconComponent]
