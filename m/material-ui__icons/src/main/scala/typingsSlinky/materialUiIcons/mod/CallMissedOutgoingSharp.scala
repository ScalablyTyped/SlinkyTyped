...
@JSImport("@material-ui/icons", "CallMissedOutgoingSharp")
@js.native
class CallMissedOutgoingSharp protected ()
...
@JSImport("@material-ui/icons", "CallMissedOutgoingSharp")
@js.native
object CallMissedOutgoingSharp extends TopLevel[SvgIconComponent]
