...
@JSImport("@material-ui/icons", "NotificationsNoneTwoTone")
@js.native
class NotificationsNoneTwoTone protected ()
...
@JSImport("@material-ui/icons", "NotificationsNoneTwoTone")
@js.native
object NotificationsNoneTwoTone extends TopLevel[SvgIconComponent]
