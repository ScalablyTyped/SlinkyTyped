...
@JSImport("@material-ui/icons", "InsertInvitationOutlined")
@js.native
class InsertInvitationOutlined protected ()
...
@JSImport("@material-ui/icons", "InsertInvitationOutlined")
@js.native
object InsertInvitationOutlined extends TopLevel[SvgIconComponent]
