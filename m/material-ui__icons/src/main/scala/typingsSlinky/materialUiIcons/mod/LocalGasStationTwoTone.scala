...
@JSImport("@material-ui/icons", "LocalGasStationTwoTone")
@js.native
class LocalGasStationTwoTone protected ()
...
@JSImport("@material-ui/icons", "LocalGasStationTwoTone")
@js.native
object LocalGasStationTwoTone extends TopLevel[SvgIconComponent]
