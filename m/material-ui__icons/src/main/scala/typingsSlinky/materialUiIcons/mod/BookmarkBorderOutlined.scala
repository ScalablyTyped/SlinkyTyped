...
@JSImport("@material-ui/icons", "BookmarkBorderOutlined")
@js.native
class BookmarkBorderOutlined protected ()
...
@JSImport("@material-ui/icons", "BookmarkBorderOutlined")
@js.native
object BookmarkBorderOutlined extends TopLevel[SvgIconComponent]
