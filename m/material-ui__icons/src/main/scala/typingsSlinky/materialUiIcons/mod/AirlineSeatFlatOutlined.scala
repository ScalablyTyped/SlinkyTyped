...
@JSImport("@material-ui/icons", "AirlineSeatFlatOutlined")
@js.native
class AirlineSeatFlatOutlined protected ()
...
@JSImport("@material-ui/icons", "AirlineSeatFlatOutlined")
@js.native
object AirlineSeatFlatOutlined extends TopLevel[SvgIconComponent]
