...
@JSImport("@material-ui/icons", "CenterFocusWeakOutlined")
@js.native
class CenterFocusWeakOutlined protected ()
...
@JSImport("@material-ui/icons", "CenterFocusWeakOutlined")
@js.native
object CenterFocusWeakOutlined extends TopLevel[SvgIconComponent]
