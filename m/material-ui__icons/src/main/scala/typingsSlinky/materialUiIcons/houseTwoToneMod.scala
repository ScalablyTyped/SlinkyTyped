...
object houseTwoToneMod extends Shortcut {
  
  @JSImport("@material-ui/icons/HouseTwoTone", JSImport.Default)
  @js.native
  val default: ReactComponentClass[SvgIconProps] = js.native
  
  type _To = ReactComponentClass[SvgIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `houseTwoToneMod.foo` */
