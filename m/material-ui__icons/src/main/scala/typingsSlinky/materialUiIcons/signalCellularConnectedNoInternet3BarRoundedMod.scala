...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet3BarRounded", JSImport.Namespace)
@js.native
object signalCellularConnectedNoInternet3BarRoundedMod extends js.Object {
  @js.native
