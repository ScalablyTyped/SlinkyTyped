...
object signalWifi3BarLockOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalWifi3BarLockOutlinedMod.foo` */
