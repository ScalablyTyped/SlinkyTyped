...
object exposureNeg1RoundedMod extends Shortcut {
  
  @JSImport("@material-ui/icons/ExposureNeg1Rounded", JSImport.Default)
  @js.native
  val default: ReactComponentClass[SvgIconProps] = js.native
  
  type _To = ReactComponentClass[SvgIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `exposureNeg1RoundedMod.foo` */
