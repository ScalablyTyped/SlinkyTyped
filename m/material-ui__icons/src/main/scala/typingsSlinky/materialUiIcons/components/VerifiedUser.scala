...
import typingsSlinky.materialUiIcons.verifiedUserMod.default
...
object VerifiedUser {
  ...
  implicit def make(companion: VerifiedUser.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
