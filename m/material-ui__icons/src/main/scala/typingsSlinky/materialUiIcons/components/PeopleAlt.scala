...
object PeopleAlt {
  ...
  @JSImport("@material-ui/icons", "PeopleAlt")
  @js.native
  ...
  implicit def make(companion: PeopleAlt.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
