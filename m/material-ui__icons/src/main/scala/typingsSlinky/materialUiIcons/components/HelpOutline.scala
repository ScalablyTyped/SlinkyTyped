...
import typingsSlinky.materialUiIcons.helpOutlineMod.default
...
object HelpOutline {
  ...
  implicit def make(companion: HelpOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
