...
import typingsSlinky.materialUiIcons.airlineSeatFlatAngledMod.default
...
object AirlineSeatFlatAngled {
  ...
  implicit def make(companion: AirlineSeatFlatAngled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
