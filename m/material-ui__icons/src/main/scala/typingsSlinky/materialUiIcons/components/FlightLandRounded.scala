...
object FlightLandRounded {
  @JSImport("@material-ui/icons", "FlightLandRounded")
  @js.native
  ...
  implicit def make(companion: FlightLandRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
