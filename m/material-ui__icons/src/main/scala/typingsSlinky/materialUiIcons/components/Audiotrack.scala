...
import typingsSlinky.materialUiIcons.audiotrackMod.default
...
object Audiotrack {
  ...
  implicit def make(companion: Audiotrack.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
