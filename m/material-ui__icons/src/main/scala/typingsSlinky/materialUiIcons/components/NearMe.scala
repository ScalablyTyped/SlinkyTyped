...
import typingsSlinky.materialUiIcons.nearMeMod.default
...
object NearMe {
  ...
  implicit def make(companion: NearMe.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
