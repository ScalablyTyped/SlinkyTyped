...
import typingsSlinky.materialUiIcons.childFriendlyMod.default
...
object ChildFriendly {
  ...
  implicit def make(companion: ChildFriendly.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
