...
object ReportProblemSharp {
  
  @JSImport("@material-ui/icons", "ReportProblemSharp")
  @js.native
  ...
  implicit def make(companion: ReportProblemSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
