...
import typingsSlinky.materialUiIcons.textRotateUpMod.default
...
object TextRotateUp {
  ...
  implicit def make(companion: TextRotateUp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
