...
object ChildFriendlyTwoTone {
  ...
  @JSImport("@material-ui/icons", "ChildFriendlyTwoTone")
  @js.native
  ...
  implicit def make(companion: ChildFriendlyTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
