...
import typingsSlinky.materialUiIcons.gpsNotFixedMod.default
...
object GpsNotFixed {
  ...
  implicit def make(companion: GpsNotFixed.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
