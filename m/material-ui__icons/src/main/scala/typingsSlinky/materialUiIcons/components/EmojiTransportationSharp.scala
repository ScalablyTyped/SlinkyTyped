...
object EmojiTransportationSharp {
  ...
  @JSImport("@material-ui/icons", "EmojiTransportationSharp")
  @js.native
  ...
  implicit def make(companion: EmojiTransportationSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
