...
object Brightness6 {
  @JSImport("@material-ui/icons", "Brightness6")
  @js.native
  ...
  implicit def make(companion: Brightness6.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
