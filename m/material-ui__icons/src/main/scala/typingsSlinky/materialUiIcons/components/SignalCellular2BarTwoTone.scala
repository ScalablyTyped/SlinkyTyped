...
object SignalCellular2BarTwoTone {
  ...
  implicit def make(companion: SignalCellular2BarTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
