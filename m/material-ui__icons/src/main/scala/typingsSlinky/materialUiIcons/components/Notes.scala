...
import typingsSlinky.materialUiIcons.notesMod.default
...
object Notes {
  ...
  implicit def make(companion: Notes.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
