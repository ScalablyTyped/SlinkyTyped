...
import typingsSlinky.materialUiIcons.wifiTetheringMod.default
...
object WifiTethering {
  ...
  implicit def make(companion: WifiTethering.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
