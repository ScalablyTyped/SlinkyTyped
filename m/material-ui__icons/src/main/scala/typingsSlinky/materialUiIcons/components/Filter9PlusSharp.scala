...
object Filter9PlusSharp {
  ...
  @JSImport("@material-ui/icons", "Filter9PlusSharp")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter9PlusSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
