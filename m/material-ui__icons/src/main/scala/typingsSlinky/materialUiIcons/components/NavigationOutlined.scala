...
object NavigationOutlined {
  ...
  @JSImport("@material-ui/icons", "NavigationOutlined")
  @js.native
  ...
  implicit def make(companion: NavigationOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
