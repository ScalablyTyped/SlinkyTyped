...
import typingsSlinky.materialUiIcons.headsetMod.default
...
object Headset {
  ...
  implicit def make(companion: Headset.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
