...
import typingsSlinky.materialUiIcons.textRotationDownMod.default
...
object TextRotationDown {
  ...
  implicit def make(companion: TextRotationDown.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
