...
import typingsSlinky.materialUiIcons.photoSizeSelectLargeMod.default
...
object PhotoSizeSelectLarge {
  ...
  implicit def make(companion: PhotoSizeSelectLarge.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
