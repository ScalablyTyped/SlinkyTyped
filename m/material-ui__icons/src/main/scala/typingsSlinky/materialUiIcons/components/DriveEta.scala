...
import typingsSlinky.materialUiIcons.driveEtaMod.default
...
object DriveEta {
  ...
  implicit def make(companion: DriveEta.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
