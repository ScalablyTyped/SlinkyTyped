...
import typingsSlinky.materialUiIcons.alarmOffSharpMod.default
...
object AlarmOffSharp {
  ...
  implicit def make(companion: AlarmOffSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
