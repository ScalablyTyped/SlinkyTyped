...
import typingsSlinky.materialUiIcons.avTimerMod.default
...
object AvTimer {
  ...
  implicit def make(companion: AvTimer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
