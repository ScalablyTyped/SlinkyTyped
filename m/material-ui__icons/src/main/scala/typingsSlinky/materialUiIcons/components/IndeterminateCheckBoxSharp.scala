...
object IndeterminateCheckBoxSharp {
  ...
  implicit def make(companion: IndeterminateCheckBoxSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
