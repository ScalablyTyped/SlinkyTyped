...
import typingsSlinky.materialUiIcons.panoramaHorizontalMod.default
...
object PanoramaHorizontal {
  ...
  implicit def make(companion: PanoramaHorizontal.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
