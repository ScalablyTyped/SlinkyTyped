...
import typingsSlinky.materialUiIcons.aspectRatioMod.default
...
object AspectRatio {
  ...
  implicit def make(companion: AspectRatio.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
