...
import typingsSlinky.materialUiIcons.playCircleFilledMod.default
...
object PlayCircleFilled {
  ...
  implicit def make(companion: PlayCircleFilled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
