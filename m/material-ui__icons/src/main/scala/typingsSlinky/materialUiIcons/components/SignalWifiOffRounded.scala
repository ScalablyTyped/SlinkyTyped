...
object SignalWifiOffRounded {
  @JSImport("@material-ui/icons", "SignalWifiOffRounded")
  @js.native
  ...
  implicit def make(companion: SignalWifiOffRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
