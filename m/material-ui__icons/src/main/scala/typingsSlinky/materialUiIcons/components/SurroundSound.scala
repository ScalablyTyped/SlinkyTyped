...
import typingsSlinky.materialUiIcons.surroundSoundMod.default
...
object SurroundSound {
  ...
  implicit def make(companion: SurroundSound.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
