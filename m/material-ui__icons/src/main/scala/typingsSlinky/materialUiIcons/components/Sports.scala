...
import typingsSlinky.materialUiIcons.sportsMod.default
...
object Sports {
  ...
  implicit def make(companion: Sports.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
