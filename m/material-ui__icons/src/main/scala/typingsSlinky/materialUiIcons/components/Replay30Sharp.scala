...
import typingsSlinky.materialUiIcons.replay30SharpMod.default
...
object Replay30Sharp {
  ...
  implicit def make(companion: Replay30Sharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
