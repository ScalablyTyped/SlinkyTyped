...
import typingsSlinky.materialUiIcons.labelImportantMod.default
...
object LabelImportant {
  ...
  implicit def make(companion: LabelImportant.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
