...
import typingsSlinky.materialUiIcons.euroMod.default
...
object Euro {
  ...
  implicit def make(companion: Euro.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
