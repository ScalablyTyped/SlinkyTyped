...
import typingsSlinky.materialUiIcons.keyboardVoiceMod.default
...
object KeyboardVoice {
  ...
  implicit def make(companion: KeyboardVoice.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
