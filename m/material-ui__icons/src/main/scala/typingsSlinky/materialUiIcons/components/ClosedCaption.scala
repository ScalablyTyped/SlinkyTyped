...
import typingsSlinky.materialUiIcons.closedCaptionMod.default
...
object ClosedCaption {
  ...
  implicit def make(companion: ClosedCaption.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
