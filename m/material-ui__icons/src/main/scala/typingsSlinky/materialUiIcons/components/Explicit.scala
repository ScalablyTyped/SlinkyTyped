...
import typingsSlinky.materialUiIcons.explicitMod.default
...
object Explicit {
  ...
  implicit def make(companion: Explicit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
