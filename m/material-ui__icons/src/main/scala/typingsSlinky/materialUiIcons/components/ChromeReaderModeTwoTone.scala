...
import typingsSlinky.materialUiIcons.chromeReaderModeTwoToneMod.default
...
object ChromeReaderModeTwoTone {
  ...
  implicit def make(companion: ChromeReaderModeTwoTone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
