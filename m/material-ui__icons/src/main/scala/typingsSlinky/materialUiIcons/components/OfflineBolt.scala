...
import typingsSlinky.materialUiIcons.offlineBoltMod.default
...
object OfflineBolt {
  ...
  implicit def make(companion: OfflineBolt.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
