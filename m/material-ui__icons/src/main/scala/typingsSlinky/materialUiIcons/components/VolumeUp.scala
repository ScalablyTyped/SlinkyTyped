...
import typingsSlinky.materialUiIcons.volumeUpMod.default
...
object VolumeUp {
  ...
  implicit def make(companion: VolumeUp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
