...
import typingsSlinky.materialUiIcons.castForEducationMod.default
...
object CastForEducation {
  ...
  implicit def make(companion: CastForEducation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
