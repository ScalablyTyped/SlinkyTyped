...
import typingsSlinky.materialUiIcons.castConnectedMod.default
...
object CastConnected {
  ...
  implicit def make(companion: CastConnected.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
