...
import typingsSlinky.materialUiIcons.fiberPinSharpMod.default
...
object FiberPinSharp {
  ...
  implicit def make(companion: FiberPinSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
