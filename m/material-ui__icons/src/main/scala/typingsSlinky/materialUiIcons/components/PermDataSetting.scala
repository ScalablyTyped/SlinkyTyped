...
import typingsSlinky.materialUiIcons.permDataSettingMod.default
...
object PermDataSetting {
  ...
  implicit def make(companion: PermDataSetting.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
