...
import typingsSlinky.materialUiIcons.storeMod.default
...
object Store {
  ...
  implicit def make(companion: Store.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
