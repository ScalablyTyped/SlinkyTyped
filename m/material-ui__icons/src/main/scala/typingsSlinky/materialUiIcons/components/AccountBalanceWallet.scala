...
import typingsSlinky.materialUiIcons.accountBalanceWalletMod.default
...
object AccountBalanceWallet {
  ...
  implicit def make(companion: AccountBalanceWallet.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
