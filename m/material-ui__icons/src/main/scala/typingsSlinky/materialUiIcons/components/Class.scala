...
import typingsSlinky.materialUiIcons.classMod.default
...
object Class {
  ...
  implicit def make(companion: Class.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
