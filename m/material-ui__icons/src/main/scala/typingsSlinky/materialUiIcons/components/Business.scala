...
import typingsSlinky.materialUiIcons.businessMod.default
...
object Business {
  ...
  implicit def make(companion: Business.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
