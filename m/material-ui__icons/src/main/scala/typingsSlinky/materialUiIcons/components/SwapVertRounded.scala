...
object SwapVertRounded {
  ...
  @JSImport("@material-ui/icons", "SwapVertRounded")
  @js.native
  ...
  implicit def make(companion: SwapVertRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
