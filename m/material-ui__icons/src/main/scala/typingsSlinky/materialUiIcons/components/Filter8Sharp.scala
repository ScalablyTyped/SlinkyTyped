...
object Filter8Sharp {
  @JSImport("@material-ui/icons/Filter8Sharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Filter8Sharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
