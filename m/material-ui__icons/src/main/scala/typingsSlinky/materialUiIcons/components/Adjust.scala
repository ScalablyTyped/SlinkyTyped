...
import typingsSlinky.materialUiIcons.adjustMod.default
...
object Adjust {
  ...
  implicit def make(companion: Adjust.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
