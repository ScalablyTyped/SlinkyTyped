...
import typingsSlinky.materialUiIcons.phoneMissedMod.default
...
object PhoneMissed {
  ...
  implicit def make(companion: PhoneMissed.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
