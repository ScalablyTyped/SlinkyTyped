...
object SettingsVoiceRounded {
  ...
  implicit def make(companion: SettingsVoiceRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
