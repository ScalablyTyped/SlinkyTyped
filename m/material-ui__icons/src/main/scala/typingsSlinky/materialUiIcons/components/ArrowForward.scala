...
import typingsSlinky.materialUiIcons.arrowForwardMod.default
...
object ArrowForward {
  ...
  implicit def make(companion: ArrowForward.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
