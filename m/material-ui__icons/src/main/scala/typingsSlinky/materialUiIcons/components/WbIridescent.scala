...
import typingsSlinky.materialUiIcons.wbIridescentMod.default
...
object WbIridescent {
  ...
  implicit def make(companion: WbIridescent.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
