...
object LaptopOutlined {
  @JSImport("@material-ui/icons", "LaptopOutlined")
  @js.native
  ...
  implicit def make(companion: LaptopOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
