...
import typingsSlinky.materialUiIcons.surroundSoundSharpMod.default
...
object SurroundSoundSharp {
  ...
  implicit def make(companion: SurroundSoundSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
