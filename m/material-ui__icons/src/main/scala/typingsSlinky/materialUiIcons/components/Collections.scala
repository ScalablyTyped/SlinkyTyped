...
import typingsSlinky.materialUiIcons.collectionsMod.default
...
object Collections {
  ...
  implicit def make(companion: Collections.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
