...
import typingsSlinky.materialUiIcons.artTrackMod.default
...
object ArtTrack {
  ...
  implicit def make(companion: ArtTrack.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
