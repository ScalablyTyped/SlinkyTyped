...
object PausePresentationOutlined {
  ...
  @JSImport("@material-ui/icons", "PausePresentationOutlined")
  @js.native
  ...
  implicit def make(companion: PausePresentationOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
