...
import typingsSlinky.materialUiIcons.wbIncandescentOutlinedMod.default
...
object WbIncandescentOutlined {
  ...
  implicit def make(companion: WbIncandescentOutlined.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
