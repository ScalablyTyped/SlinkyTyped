...
object Minimize {
  ...
  @JSImport("@material-ui/icons", "Minimize")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Minimize.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
