...
import typingsSlinky.materialUiIcons.wifiMod.default
...
object Wifi {
  ...
  implicit def make(companion: Wifi.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
