...
import typingsSlinky.materialUiIcons.hotTubSharpMod.default
...
object HotTubSharp {
  ...
  implicit def make(companion: HotTubSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
