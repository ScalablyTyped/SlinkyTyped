...
object HotTubSharp {
  @JSImport("@material-ui/icons", "HotTubSharp")
  @js.native
  ...
  implicit def make(companion: HotTubSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
