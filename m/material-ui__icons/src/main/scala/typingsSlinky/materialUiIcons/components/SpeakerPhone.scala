...
import typingsSlinky.materialUiIcons.speakerPhoneMod.default
...
object SpeakerPhone {
  ...
  implicit def make(companion: SpeakerPhone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
