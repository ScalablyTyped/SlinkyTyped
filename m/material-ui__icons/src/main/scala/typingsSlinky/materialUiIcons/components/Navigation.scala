...
import typingsSlinky.materialUiIcons.navigationMod.default
...
object Navigation {
  ...
  implicit def make(companion: Navigation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
