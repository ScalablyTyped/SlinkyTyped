...
import typingsSlinky.materialUiIcons.sentimentDissatisfiedMod.default
...
object SentimentDissatisfied {
  ...
  implicit def make(companion: SentimentDissatisfied.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
