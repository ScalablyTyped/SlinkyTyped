...
import typingsSlinky.materialUiIcons.notificationsNoneRoundedMod.default
...
object NotificationsNoneRounded {
  ...
  implicit def make(companion: NotificationsNoneRounded.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
