...
import typingsSlinky.materialUiIcons.toggleOnMod.default
...
object ToggleOn {
  ...
  implicit def make(companion: ToggleOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
