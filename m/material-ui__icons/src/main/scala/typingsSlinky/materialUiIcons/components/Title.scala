...
import typingsSlinky.materialUiIcons.titleMod.default
...
object Title {
  ...
  implicit def make(companion: Title.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
