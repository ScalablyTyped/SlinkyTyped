...
import typingsSlinky.materialUiIcons.fontDownloadMod.default
...
object FontDownload {
  ...
  implicit def make(companion: FontDownload.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
