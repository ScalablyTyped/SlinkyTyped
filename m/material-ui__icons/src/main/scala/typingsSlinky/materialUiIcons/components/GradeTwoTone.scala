...
object GradeTwoTone {
  ...
  @JSImport("@material-ui/icons", "GradeTwoTone")
  @js.native
  ...
  implicit def make(companion: GradeTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
