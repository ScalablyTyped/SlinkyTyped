...
object Filter1Outlined {
  @JSImport("@material-ui/icons/Filter1Outlined", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Filter1Outlined.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
