...
object RestoreFromTrash {
  ...
  @JSImport("@material-ui/icons", "RestoreFromTrash")
  @js.native
  ...
  implicit def make(companion: RestoreFromTrash.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
