...
object ModeCommentSharp {
  ...
  @JSImport("@material-ui/icons", "ModeCommentSharp")
  @js.native
  ...
  implicit def make(companion: ModeCommentSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
