...
object SportsHandballSharp {
  
  @JSImport("@material-ui/icons", "SportsHandballSharp")
  @js.native
  ...
  implicit def make(companion: SportsHandballSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
