...
import typingsSlinky.materialUiIcons.subdirectoryArrowRightMod.default
...
object SubdirectoryArrowRight {
  ...
  implicit def make(companion: SubdirectoryArrowRight.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
