...
import typingsSlinky.materialUiIcons.accessTimeMod.default
...
object AccessTime {
  ...
  implicit def make(companion: AccessTime.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
