...
object UnfoldLessRounded {
  ...
  @JSImport("@material-ui/icons", "UnfoldLessRounded")
  @js.native
  ...
  implicit def make(companion: UnfoldLessRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
