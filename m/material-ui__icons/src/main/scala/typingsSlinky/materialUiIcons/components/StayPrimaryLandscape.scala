...
import typingsSlinky.materialUiIcons.stayPrimaryLandscapeMod.default
...
object StayPrimaryLandscape {
  ...
  implicit def make(companion: StayPrimaryLandscape.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
