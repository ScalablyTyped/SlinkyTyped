...
import typingsSlinky.materialUiIcons.smokingRoomsMod.default
...
object SmokingRooms {
  ...
  implicit def make(companion: SmokingRooms.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
