...
import typingsSlinky.materialUiIcons.battery20Mod.default
...
object Battery20 {
  ...
  implicit def make(companion: Battery20.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
