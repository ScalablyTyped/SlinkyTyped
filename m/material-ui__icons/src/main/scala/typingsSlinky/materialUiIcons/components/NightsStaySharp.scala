...
object NightsStaySharp {
  @JSImport("@material-ui/icons/NightsStaySharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: NightsStaySharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
