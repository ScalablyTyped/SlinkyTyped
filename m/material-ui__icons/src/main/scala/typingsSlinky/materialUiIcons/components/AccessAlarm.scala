...
import typingsSlinky.materialUiIcons.accessAlarmMod.default
...
object AccessAlarm {
  ...
  implicit def make(companion: AccessAlarm.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
