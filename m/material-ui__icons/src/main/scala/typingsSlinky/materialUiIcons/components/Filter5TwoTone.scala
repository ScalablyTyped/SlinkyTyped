...
object Filter5TwoTone {
  @JSImport("@material-ui/icons/Filter5TwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Filter5TwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
