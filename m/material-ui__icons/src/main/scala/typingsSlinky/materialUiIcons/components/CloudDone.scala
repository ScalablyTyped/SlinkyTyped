...
import typingsSlinky.materialUiIcons.cloudDoneMod.default
...
object CloudDone {
  ...
  implicit def make(companion: CloudDone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
