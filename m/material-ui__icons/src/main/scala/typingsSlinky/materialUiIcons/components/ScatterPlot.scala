...
import typingsSlinky.materialUiIcons.scatterPlotMod.default
...
object ScatterPlot {
  ...
  implicit def make(companion: ScatterPlot.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
