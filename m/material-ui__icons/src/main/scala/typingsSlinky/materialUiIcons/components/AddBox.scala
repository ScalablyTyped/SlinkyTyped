...
import typingsSlinky.materialUiIcons.addBoxMod.default
...
object AddBox {
  ...
  implicit def make(companion: AddBox.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
