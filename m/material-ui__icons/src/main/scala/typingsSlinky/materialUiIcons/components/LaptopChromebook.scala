...
object LaptopChromebook {
  @JSImport("@material-ui/icons", "LaptopChromebook")
  @js.native
  ...
  implicit def make(companion: LaptopChromebook.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
