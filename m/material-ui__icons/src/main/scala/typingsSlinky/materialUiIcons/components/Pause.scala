...
import typingsSlinky.materialUiIcons.pauseMod.default
...
object Pause {
  ...
  implicit def make(companion: Pause.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
