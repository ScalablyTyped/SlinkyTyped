...
import typingsSlinky.materialUiIcons.chevronLeftMod.default
...
object ChevronLeft {
  ...
  implicit def make(companion: ChevronLeft.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
