...
import typingsSlinky.materialUiIcons.wbCloudyMod.default
...
object WbCloudy {
  ...
  implicit def make(companion: WbCloudy.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
