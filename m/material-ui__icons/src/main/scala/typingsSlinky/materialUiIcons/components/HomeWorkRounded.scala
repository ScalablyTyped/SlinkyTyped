...
object HomeWorkRounded {
  @JSImport("@material-ui/icons/HomeWorkRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: HomeWorkRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
