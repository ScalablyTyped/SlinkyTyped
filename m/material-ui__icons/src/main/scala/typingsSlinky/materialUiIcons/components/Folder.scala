...
import typingsSlinky.materialUiIcons.folderMod.default
...
object Folder {
  ...
  implicit def make(companion: Folder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
