...
object BatteryCharging80Rounded {
  ...
  implicit def make(companion: BatteryCharging80Rounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
