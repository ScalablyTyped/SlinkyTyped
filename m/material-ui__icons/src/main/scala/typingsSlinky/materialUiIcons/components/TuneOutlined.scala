...
object TuneOutlined {
  @JSImport("@material-ui/icons", "TuneOutlined")
  @js.native
  ...
  implicit def make(companion: TuneOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
