...
object SettingsPowerRounded {
  ...
  @JSImport("@material-ui/icons", "SettingsPowerRounded")
  @js.native
  ...
  implicit def make(companion: SettingsPowerRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
