...
import typingsSlinky.materialUiIcons.libraryMusicMod.default
...
object LibraryMusic {
  ...
  implicit def make(companion: LibraryMusic.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
