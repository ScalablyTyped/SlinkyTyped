...
import typingsSlinky.materialUiIcons.checkBoxMod.default
...
object CheckBox {
  ...
  implicit def make(companion: CheckBox.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
