...
import typingsSlinky.materialUiIcons.doneOutlineMod.default
...
object DoneOutline {
  ...
  implicit def make(companion: DoneOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
