...
object CallToActionTwoTone {
  @JSImport("@material-ui/icons/CallToActionTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CallToActionTwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
