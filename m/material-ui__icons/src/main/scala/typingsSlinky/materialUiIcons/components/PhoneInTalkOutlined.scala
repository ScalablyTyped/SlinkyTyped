...
object PhoneInTalkOutlined {
  ...
  @JSImport("@material-ui/icons", "PhoneInTalkOutlined")
  @js.native
  ...
  implicit def make(companion: PhoneInTalkOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
