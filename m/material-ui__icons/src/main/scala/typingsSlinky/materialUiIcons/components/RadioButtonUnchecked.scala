...
import typingsSlinky.materialUiIcons.radioButtonUncheckedMod.default
...
object RadioButtonUnchecked {
  ...
  implicit def make(companion: RadioButtonUnchecked.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
