...
object LocalPrintshopTwoTone {
  @JSImport("@material-ui/icons", "LocalPrintshopTwoTone")
  @js.native
  ...
  implicit def make(companion: LocalPrintshopTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
