...
object FunctionsSharp {
  @JSImport("@material-ui/icons", "FunctionsSharp")
  @js.native
  ...
  implicit def make(companion: FunctionsSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
