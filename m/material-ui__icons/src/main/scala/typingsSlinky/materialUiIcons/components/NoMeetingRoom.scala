...
import typingsSlinky.materialUiIcons.noMeetingRoomMod.default
...
object NoMeetingRoom {
  ...
  implicit def make(companion: NoMeetingRoom.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
