...
import typingsSlinky.materialUiIcons.shoppingBasketMod.default
...
object ShoppingBasket {
  ...
  implicit def make(companion: ShoppingBasket.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
