...
import typingsSlinky.materialUiIcons.thumbUpMod.default
...
object ThumbUp {
  ...
  implicit def make(companion: ThumbUp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
