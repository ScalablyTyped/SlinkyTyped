...
import typingsSlinky.materialUiIcons.scannerMod.default
...
object Scanner {
  ...
  implicit def make(companion: Scanner.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
