...
import typingsSlinky.materialUiIcons.timeToLeaveMod.default
...
object TimeToLeave {
  ...
  implicit def make(companion: TimeToLeave.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
