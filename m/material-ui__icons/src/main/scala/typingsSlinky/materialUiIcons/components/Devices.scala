...
import typingsSlinky.materialUiIcons.devicesMod.default
...
object Devices {
  ...
  implicit def make(companion: Devices.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
