...
import typingsSlinky.materialUiIcons.phoneInTalkMod.default
...
object PhoneInTalk {
  ...
  implicit def make(companion: PhoneInTalk.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
