...
import typingsSlinky.materialUiIcons.transferWithinAStationMod.default
...
object TransferWithinAStation {
  ...
  implicit def make(companion: TransferWithinAStation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
