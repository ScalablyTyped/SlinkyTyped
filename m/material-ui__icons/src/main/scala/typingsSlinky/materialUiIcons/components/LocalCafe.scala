...
import typingsSlinky.materialUiIcons.localCafeMod.default
...
object LocalCafe {
  ...
  implicit def make(companion: LocalCafe.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
