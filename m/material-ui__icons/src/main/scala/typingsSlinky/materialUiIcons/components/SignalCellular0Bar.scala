...
import typingsSlinky.materialUiIcons.signalCellular0BarMod.default
...
object SignalCellular0Bar {
  ...
  implicit def make(companion: SignalCellular0Bar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
