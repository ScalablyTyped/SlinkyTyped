...
import typingsSlinky.materialUiIcons.lineStyleMod.default
...
object LineStyle {
  ...
  implicit def make(companion: LineStyle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
