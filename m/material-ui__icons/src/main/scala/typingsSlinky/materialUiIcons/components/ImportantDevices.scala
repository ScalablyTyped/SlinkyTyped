...
import typingsSlinky.materialUiIcons.importantDevicesMod.default
...
object ImportantDevices {
  ...
  implicit def make(companion: ImportantDevices.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
