...
import typingsSlinky.materialUiIcons.contactPhoneMod.default
...
object ContactPhone {
  ...
  implicit def make(companion: ContactPhone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
