...
object CardGiftcardSharp {
  ...
  @JSImport("@material-ui/icons", "CardGiftcardSharp")
  @js.native
  ...
  implicit def make(companion: CardGiftcardSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
