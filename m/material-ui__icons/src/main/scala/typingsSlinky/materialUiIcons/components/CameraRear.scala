...
import typingsSlinky.materialUiIcons.cameraRearMod.default
...
object CameraRear {
  ...
  implicit def make(companion: CameraRear.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
