...
import typingsSlinky.materialUiIcons.developerBoardMod.default
...
object DeveloperBoard {
  ...
  implicit def make(companion: DeveloperBoard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
