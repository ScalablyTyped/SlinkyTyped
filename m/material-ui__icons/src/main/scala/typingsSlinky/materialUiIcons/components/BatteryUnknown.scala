...
import typingsSlinky.materialUiIcons.batteryUnknownMod.default
...
object BatteryUnknown {
  ...
  implicit def make(companion: BatteryUnknown.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
