...
import typingsSlinky.materialUiIcons.colorizeMod.default
...
object Colorize {
  ...
  implicit def make(companion: Colorize.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
