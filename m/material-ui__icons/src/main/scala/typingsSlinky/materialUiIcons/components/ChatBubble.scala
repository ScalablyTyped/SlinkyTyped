...
import typingsSlinky.materialUiIcons.chatBubbleMod.default
...
object ChatBubble {
  ...
  implicit def make(companion: ChatBubble.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
