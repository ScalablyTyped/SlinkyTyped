...
object EqualizerSharp {
  ...
  @JSImport("@material-ui/icons", "EqualizerSharp")
  @js.native
  ...
  implicit def make(companion: EqualizerSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
