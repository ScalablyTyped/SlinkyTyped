...
object LinkOff {
  @JSImport("@material-ui/icons", "LinkOff")
  @js.native
  ...
  implicit def make(companion: LinkOff.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
