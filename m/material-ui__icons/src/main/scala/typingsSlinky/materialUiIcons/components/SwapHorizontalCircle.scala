...
import typingsSlinky.materialUiIcons.swapHorizontalCircleMod.default
...
object SwapHorizontalCircle {
  ...
  implicit def make(companion: SwapHorizontalCircle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
