...
import typingsSlinky.materialUiIcons.viewHeadlineMod.default
...
object ViewHeadline {
  ...
  implicit def make(companion: ViewHeadline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
