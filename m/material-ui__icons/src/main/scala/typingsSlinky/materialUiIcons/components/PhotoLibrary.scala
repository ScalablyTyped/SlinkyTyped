...
import typingsSlinky.materialUiIcons.photoLibraryMod.default
...
object PhotoLibrary {
  ...
  implicit def make(companion: PhotoLibrary.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
