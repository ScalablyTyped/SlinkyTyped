...
import typingsSlinky.materialUiIcons.flipToBackMod.default
...
object FlipToBack {
  ...
  implicit def make(companion: FlipToBack.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
