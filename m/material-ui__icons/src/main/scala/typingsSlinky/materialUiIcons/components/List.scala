...
import typingsSlinky.materialUiIcons.listMod.default
...
object List {
  ...
  implicit def make(companion: List.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
