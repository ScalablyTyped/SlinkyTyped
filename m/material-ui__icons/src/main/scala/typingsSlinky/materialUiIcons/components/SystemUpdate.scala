...
import typingsSlinky.materialUiIcons.systemUpdateMod.default
...
object SystemUpdate {
  ...
  implicit def make(companion: SystemUpdate.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
