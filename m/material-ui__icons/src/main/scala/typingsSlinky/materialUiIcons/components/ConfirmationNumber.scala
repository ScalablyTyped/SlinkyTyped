...
import typingsSlinky.materialUiIcons.confirmationNumberMod.default
...
object ConfirmationNumber {
  ...
  implicit def make(companion: ConfirmationNumber.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
