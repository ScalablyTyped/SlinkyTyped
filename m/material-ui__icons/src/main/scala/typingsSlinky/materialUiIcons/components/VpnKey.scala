...
import typingsSlinky.materialUiIcons.vpnKeyMod.default
...
object VpnKey {
  ...
  implicit def make(companion: VpnKey.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
