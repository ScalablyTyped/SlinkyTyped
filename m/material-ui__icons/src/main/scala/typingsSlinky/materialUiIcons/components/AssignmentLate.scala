...
import typingsSlinky.materialUiIcons.assignmentLateMod.default
...
object AssignmentLate {
  ...
  implicit def make(companion: AssignmentLate.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
