...
object PhonelinkLockSharp {
  ...
  @JSImport("@material-ui/icons", "PhonelinkLockSharp")
  @js.native
  ...
  implicit def make(companion: PhonelinkLockSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
