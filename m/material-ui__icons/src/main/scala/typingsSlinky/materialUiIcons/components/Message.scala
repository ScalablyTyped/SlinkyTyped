...
import typingsSlinky.materialUiIcons.messageMod.default
...
object Message {
  ...
  implicit def make(companion: Message.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
