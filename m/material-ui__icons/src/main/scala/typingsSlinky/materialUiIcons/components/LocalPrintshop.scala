...
object LocalPrintshop {
  @JSImport("@material-ui/icons", "LocalPrintshop")
  @js.native
  ...
  implicit def make(companion: LocalPrintshop.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
