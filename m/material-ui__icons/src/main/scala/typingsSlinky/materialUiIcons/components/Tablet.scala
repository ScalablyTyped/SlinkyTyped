...
import typingsSlinky.materialUiIcons.tabletMod.default
...
object Tablet {
  ...
  implicit def make(companion: Tablet.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
