...
import typingsSlinky.materialUiIcons.liveHelpMod.default
...
object LiveHelp {
  ...
  implicit def make(companion: LiveHelp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
