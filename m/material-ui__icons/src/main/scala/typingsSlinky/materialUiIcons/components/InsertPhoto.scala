...
import typingsSlinky.materialUiIcons.insertPhotoMod.default
...
object InsertPhoto {
  ...
  implicit def make(companion: InsertPhoto.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
