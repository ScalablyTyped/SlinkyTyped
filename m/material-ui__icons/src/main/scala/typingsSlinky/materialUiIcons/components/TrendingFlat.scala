...
import typingsSlinky.materialUiIcons.trendingFlatMod.default
...
object TrendingFlat {
  ...
  implicit def make(companion: TrendingFlat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
