...
import typingsSlinky.materialUiIcons.visibilityMod.default
...
object Visibility {
  ...
  implicit def make(companion: Visibility.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
