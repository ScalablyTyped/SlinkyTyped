...
import typingsSlinky.materialUiIcons.unfoldMoreMod.default
...
object UnfoldMore {
  ...
  implicit def make(companion: UnfoldMore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
