...
object MessageRounded {
  @JSImport("@material-ui/icons", "MessageRounded")
  @js.native
  ...
  implicit def make(companion: MessageRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
