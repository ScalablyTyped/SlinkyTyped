...
import typingsSlinky.materialUiIcons.bubbleChartSharpMod.default
...
object BubbleChartSharp {
  ...
  implicit def make(companion: BubbleChartSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
