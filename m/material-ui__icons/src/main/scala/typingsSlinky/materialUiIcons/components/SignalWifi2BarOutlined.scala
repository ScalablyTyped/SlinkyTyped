...
object SignalWifi2BarOutlined {
  ...
  implicit def make(companion: SignalWifi2BarOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
