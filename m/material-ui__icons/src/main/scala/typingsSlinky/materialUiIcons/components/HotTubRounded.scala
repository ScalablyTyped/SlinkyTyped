...
object HotTubRounded {
  ...
  @JSImport("@material-ui/icons", "HotTubRounded")
  @js.native
  ...
  implicit def make(companion: HotTubRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
