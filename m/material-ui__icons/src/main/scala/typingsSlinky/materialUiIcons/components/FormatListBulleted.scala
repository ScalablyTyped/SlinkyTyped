...
import typingsSlinky.materialUiIcons.formatListBulletedMod.default
...
object FormatListBulleted {
  ...
  implicit def make(companion: FormatListBulleted.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
