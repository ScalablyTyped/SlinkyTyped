...
import typingsSlinky.materialUiIcons.speedMod.default
...
object Speed {
  ...
  implicit def make(companion: Speed.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
