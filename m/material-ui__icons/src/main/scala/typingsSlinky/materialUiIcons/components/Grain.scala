...
import typingsSlinky.materialUiIcons.grainMod.default
...
object Grain {
  ...
  implicit def make(companion: Grain.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
