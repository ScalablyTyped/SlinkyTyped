...
import typingsSlinky.materialUiIcons.dataUsageMod.default
...
object DataUsage {
  ...
  implicit def make(companion: DataUsage.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
