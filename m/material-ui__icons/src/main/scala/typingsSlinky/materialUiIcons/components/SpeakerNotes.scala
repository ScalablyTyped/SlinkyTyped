...
import typingsSlinky.materialUiIcons.speakerNotesMod.default
...
object SpeakerNotes {
  ...
  implicit def make(companion: SpeakerNotes.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
