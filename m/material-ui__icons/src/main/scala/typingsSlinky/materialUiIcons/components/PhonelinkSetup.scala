...
import typingsSlinky.materialUiIcons.phonelinkSetupMod.default
...
object PhonelinkSetup {
  ...
  implicit def make(companion: PhonelinkSetup.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
