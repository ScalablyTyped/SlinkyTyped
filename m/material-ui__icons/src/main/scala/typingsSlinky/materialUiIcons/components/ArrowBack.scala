...
import typingsSlinky.materialUiIcons.arrowBackMod.default
...
object ArrowBack {
  ...
  implicit def make(companion: ArrowBack.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
