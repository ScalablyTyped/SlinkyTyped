...
import typingsSlinky.materialUiIcons.blurOnMod.default
...
object BlurOn {
  ...
  implicit def make(companion: BlurOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
