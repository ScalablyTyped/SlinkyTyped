...
import typingsSlinky.materialUiIcons.wrapTextSharpMod.default
...
object WrapTextSharp {
  ...
  implicit def make(companion: WrapTextSharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
