...
object InvertColorsOffSharp {
  ...
  @JSImport("@material-ui/icons", "InvertColorsOffSharp")
  @js.native
  ...
  implicit def make(companion: InvertColorsOffSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
