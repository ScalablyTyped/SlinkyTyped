...
import typingsSlinky.materialUiIcons.settingsBluetoothMod.default
...
object SettingsBluetooth {
  ...
  implicit def make(companion: SettingsBluetooth.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
