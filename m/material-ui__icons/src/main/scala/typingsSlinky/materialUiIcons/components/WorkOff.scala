...
import typingsSlinky.materialUiIcons.workOffMod.default
...
object WorkOff {
  ...
  implicit def make(companion: WorkOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
