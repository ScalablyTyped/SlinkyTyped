...
import typingsSlinky.materialUiIcons.alarmAddMod.default
...
object AlarmAdd {
  ...
  implicit def make(companion: AlarmAdd.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
