...
import typingsSlinky.materialUiIcons.hdMod.default
...
object Hd {
  ...
  implicit def make(companion: Hd.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
