...
import typingsSlinky.materialUiIcons.arrowDropUpMod.default
...
object ArrowDropUp {
  ...
  implicit def make(companion: ArrowDropUp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
