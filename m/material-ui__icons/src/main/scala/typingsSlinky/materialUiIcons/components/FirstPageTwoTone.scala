...
object FirstPageTwoTone {
  @JSImport("@material-ui/icons/FirstPageTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FirstPageTwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
