...
import typingsSlinky.materialUiIcons.switchVideoMod.default
...
object SwitchVideo {
  ...
  implicit def make(companion: SwitchVideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
