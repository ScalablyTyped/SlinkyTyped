...
import typingsSlinky.materialUiIcons.monetizationOnMod.default
...
object MonetizationOn {
  ...
  implicit def make(companion: MonetizationOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
