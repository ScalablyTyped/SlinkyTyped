...
import typingsSlinky.materialUiIcons.saveMod.default
...
object Save {
  ...
  implicit def make(companion: Save.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
