...
object MonetizationOnTwoTone {
  @JSImport("@material-ui/icons", "MonetizationOnTwoTone")
  @js.native
  ...
  implicit def make(companion: MonetizationOnTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
