...
object PersonPinCircleSharp {
  @JSImport("@material-ui/icons", "PersonPinCircleSharp")
  @js.native
  ...
  implicit def make(companion: PersonPinCircleSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
