...
import typingsSlinky.materialUiIcons.permDeviceInformationMod.default
...
object PermDeviceInformation {
  ...
  implicit def make(companion: PermDeviceInformation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
