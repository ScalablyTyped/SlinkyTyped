...
object BatteryCharging90Outlined {
  ...
  implicit def make(companion: BatteryCharging90Outlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
