...
import typingsSlinky.materialUiIcons.musicOffMod.default
...
object MusicOff {
  ...
  implicit def make(companion: MusicOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
