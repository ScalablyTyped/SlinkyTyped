...
import typingsSlinky.materialUiIcons.closeMod.default
...
object Close {
  ...
  implicit def make(companion: Close.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
