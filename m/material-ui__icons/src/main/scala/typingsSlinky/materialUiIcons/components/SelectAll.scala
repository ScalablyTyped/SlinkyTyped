...
import typingsSlinky.materialUiIcons.selectAllMod.default
...
object SelectAll {
  ...
  implicit def make(companion: SelectAll.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
