...
import typingsSlinky.materialUiIcons.videogameAssetMod.default
...
object VideogameAsset {
  ...
  implicit def make(companion: VideogameAsset.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
