...
import typingsSlinky.materialUiIcons.swapVertMod.default
...
object SwapVert {
  ...
  implicit def make(companion: SwapVert.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
