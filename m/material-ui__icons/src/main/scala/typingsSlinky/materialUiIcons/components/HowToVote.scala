...
import typingsSlinky.materialUiIcons.howToVoteMod.default
...
object HowToVote {
  ...
  implicit def make(companion: HowToVote.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
