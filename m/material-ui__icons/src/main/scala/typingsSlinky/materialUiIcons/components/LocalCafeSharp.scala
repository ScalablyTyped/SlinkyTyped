...
object LocalCafeSharp {
  
  @JSImport("@material-ui/icons", "LocalCafeSharp")
  @js.native
  ...
  implicit def make(companion: LocalCafeSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
