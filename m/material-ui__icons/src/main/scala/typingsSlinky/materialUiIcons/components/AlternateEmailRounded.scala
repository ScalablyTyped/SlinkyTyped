...
object AlternateEmailRounded {
  ...
  implicit def make(companion: AlternateEmailRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
