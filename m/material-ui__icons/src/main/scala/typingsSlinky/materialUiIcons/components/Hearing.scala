...
import typingsSlinky.materialUiIcons.hearingMod.default
...
object Hearing {
  ...
  implicit def make(companion: Hearing.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
