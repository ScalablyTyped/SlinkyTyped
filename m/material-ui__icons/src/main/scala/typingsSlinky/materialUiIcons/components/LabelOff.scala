...
object LabelOff {
  @JSImport("@material-ui/icons", "LabelOff")
  @js.native
  ...
  implicit def make(companion: LabelOff.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
