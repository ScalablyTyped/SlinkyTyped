...
import typingsSlinky.materialUiIcons.localPostOfficeMod.default
...
object LocalPostOffice {
  ...
  implicit def make(companion: LocalPostOffice.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
