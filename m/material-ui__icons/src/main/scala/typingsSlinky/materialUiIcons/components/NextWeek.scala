...
import typingsSlinky.materialUiIcons.nextWeekMod.default
...
object NextWeek {
  ...
  implicit def make(companion: NextWeek.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
