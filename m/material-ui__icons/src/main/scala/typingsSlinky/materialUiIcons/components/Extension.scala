...
import typingsSlinky.materialUiIcons.extensionMod.default
...
object Extension {
  ...
  implicit def make(companion: Extension.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
