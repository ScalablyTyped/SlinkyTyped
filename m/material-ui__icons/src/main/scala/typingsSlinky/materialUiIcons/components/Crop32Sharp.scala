...
object Crop32Sharp {
  @JSImport("@material-ui/icons/Crop32Sharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Crop32Sharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
