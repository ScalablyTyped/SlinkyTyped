...
import typingsSlinky.materialUiIcons.motorcycleMod.default
...
object Motorcycle {
  ...
  implicit def make(companion: Motorcycle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
