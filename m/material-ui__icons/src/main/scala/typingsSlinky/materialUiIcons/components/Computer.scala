...
import typingsSlinky.materialUiIcons.computerMod.default
...
object Computer {
  ...
  implicit def make(companion: Computer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
