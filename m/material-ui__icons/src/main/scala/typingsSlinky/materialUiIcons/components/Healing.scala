...
import typingsSlinky.materialUiIcons.healingMod.default
...
object Healing {
  ...
  implicit def make(companion: Healing.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
