...
import typingsSlinky.materialUiIcons.brokenImageMod.default
...
object BrokenImage {
  ...
  implicit def make(companion: BrokenImage.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
