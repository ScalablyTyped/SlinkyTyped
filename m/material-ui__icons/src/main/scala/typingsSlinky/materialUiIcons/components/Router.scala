...
import typingsSlinky.materialUiIcons.routerMod.default
...
object Router {
  ...
  implicit def make(companion: Router.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
