...
import typingsSlinky.materialUiIcons.personAddDisabledMod.default
...
object PersonAddDisabled {
  ...
  implicit def make(companion: PersonAddDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
