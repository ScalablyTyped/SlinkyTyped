...
import typingsSlinky.materialUiIcons.arrowDownwardMod.default
...
object ArrowDownward {
  ...
  implicit def make(companion: ArrowDownward.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
