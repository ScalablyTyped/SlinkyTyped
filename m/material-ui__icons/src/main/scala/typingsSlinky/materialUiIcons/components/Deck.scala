...
import typingsSlinky.materialUiIcons.deckMod.default
...
object Deck {
  ...
  implicit def make(companion: Deck.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
