...
import typingsSlinky.materialUiIcons.compareMod.default
...
object Compare {
  ...
  implicit def make(companion: Compare.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
