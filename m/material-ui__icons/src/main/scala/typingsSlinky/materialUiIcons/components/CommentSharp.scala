...
object CommentSharp {
  @JSImport("@material-ui/icons", "CommentSharp")
  @js.native
  ...
  implicit def make(companion: CommentSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
