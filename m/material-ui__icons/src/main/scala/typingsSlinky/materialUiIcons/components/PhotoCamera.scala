...
import typingsSlinky.materialUiIcons.photoCameraMod.default
...
object PhotoCamera {
  ...
  implicit def make(companion: PhotoCamera.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
