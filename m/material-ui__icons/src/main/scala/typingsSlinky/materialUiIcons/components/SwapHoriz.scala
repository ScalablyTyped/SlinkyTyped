...
import typingsSlinky.materialUiIcons.swapHorizMod.default
...
object SwapHoriz {
  ...
  implicit def make(companion: SwapHoriz.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
