...
import typingsSlinky.materialUiIcons.reportMod.default
...
object Report {
  ...
  implicit def make(companion: Report.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
