...
import typingsSlinky.materialUiIcons.zoomInMod.default
...
object ZoomIn {
  ...
  implicit def make(companion: ZoomIn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
