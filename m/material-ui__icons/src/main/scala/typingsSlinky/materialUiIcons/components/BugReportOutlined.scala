...
object BugReportOutlined {
  @JSImport("@material-ui/icons", "BugReportOutlined")
  @js.native
  ...
  implicit def make(companion: BugReportOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
