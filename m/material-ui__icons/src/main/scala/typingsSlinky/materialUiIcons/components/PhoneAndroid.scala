...
import typingsSlinky.materialUiIcons.phoneAndroidMod.default
...
object PhoneAndroid {
  ...
  implicit def make(companion: PhoneAndroid.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
