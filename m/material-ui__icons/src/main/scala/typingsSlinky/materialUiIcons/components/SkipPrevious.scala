...
import typingsSlinky.materialUiIcons.skipPreviousMod.default
...
object SkipPrevious {
  ...
  implicit def make(companion: SkipPrevious.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
