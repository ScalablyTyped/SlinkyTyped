...
object ConfirmationNumberRounded {
  ...
  @JSImport("@material-ui/icons", "ConfirmationNumberRounded")
  @js.native
  ...
  implicit def make(companion: ConfirmationNumberRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
