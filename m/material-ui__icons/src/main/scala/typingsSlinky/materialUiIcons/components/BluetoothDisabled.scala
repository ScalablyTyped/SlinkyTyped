...
import typingsSlinky.materialUiIcons.bluetoothDisabledMod.default
...
object BluetoothDisabled {
  ...
  implicit def make(companion: BluetoothDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
