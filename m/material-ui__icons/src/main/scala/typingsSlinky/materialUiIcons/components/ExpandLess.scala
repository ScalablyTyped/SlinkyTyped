...
import typingsSlinky.materialUiIcons.expandLessMod.default
...
object ExpandLess {
  ...
  implicit def make(companion: ExpandLess.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
