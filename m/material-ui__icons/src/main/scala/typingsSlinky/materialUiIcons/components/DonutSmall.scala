...
import typingsSlinky.materialUiIcons.donutSmallMod.default
...
object DonutSmall {
  ...
  implicit def make(companion: DonutSmall.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
