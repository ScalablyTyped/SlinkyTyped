...
import typingsSlinky.materialUiIcons.settingsEthernetMod.default
...
object SettingsEthernet {
  ...
  implicit def make(companion: SettingsEthernet.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
