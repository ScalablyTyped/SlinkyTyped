...
import typingsSlinky.materialUiIcons.panoramaVerticalMod.default
...
object PanoramaVertical {
  ...
  implicit def make(companion: PanoramaVertical.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
