...
import typingsSlinky.materialUiIcons.trackChangesMod.default
...
object TrackChanges {
  ...
  implicit def make(companion: TrackChanges.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
