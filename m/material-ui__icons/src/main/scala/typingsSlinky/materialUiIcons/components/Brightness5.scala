...
import typingsSlinky.materialUiIcons.brightness5Mod.default
...
object Brightness5 {
  ...
  implicit def make(companion: Brightness5.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
