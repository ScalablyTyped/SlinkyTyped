...
import typingsSlinky.materialUiIcons.thumbUpAltMod.default
...
object ThumbUpAlt {
  ...
  implicit def make(companion: ThumbUpAlt.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
