...
import typingsSlinky.materialUiIcons.phoneLockedMod.default
...
object PhoneLocked {
  ...
  implicit def make(companion: PhoneLocked.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
