...
object LibraryAddCheckTwoTone {
  
  @JSImport("@material-ui/icons", "LibraryAddCheckTwoTone")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LibraryAddCheckTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
