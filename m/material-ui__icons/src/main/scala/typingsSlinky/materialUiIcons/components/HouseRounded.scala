...
object HouseRounded {
  ...
  @JSImport("@material-ui/icons", "HouseRounded")
  @js.native
  ...
  implicit def make(companion: HouseRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
