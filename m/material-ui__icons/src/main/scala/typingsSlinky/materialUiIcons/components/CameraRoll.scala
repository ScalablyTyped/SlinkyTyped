...
import typingsSlinky.materialUiIcons.cameraRollMod.default
...
object CameraRoll {
  ...
  implicit def make(companion: CameraRoll.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
