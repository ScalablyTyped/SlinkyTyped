...
import typingsSlinky.materialUiIcons.categoryMod.default
...
object Category {
  ...
  implicit def make(companion: Category.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
