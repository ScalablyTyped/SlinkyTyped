...
import typingsSlinky.materialUiIcons.httpsMod.default
...
object Https {
  ...
  implicit def make(companion: Https.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
