...
import typingsSlinky.materialUiIcons.inboxOutlinedMod.default
...
object InboxOutlined {
  ...
  implicit def make(companion: InboxOutlined.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
