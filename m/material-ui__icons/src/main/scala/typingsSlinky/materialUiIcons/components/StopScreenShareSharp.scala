...
object StopScreenShareSharp {
  
  @JSImport("@material-ui/icons", "StopScreenShareSharp")
  @js.native
  ...
  implicit def make(companion: StopScreenShareSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
