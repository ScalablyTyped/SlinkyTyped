...
object CopyrightRounded {
  @JSImport("@material-ui/icons/CopyrightRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CopyrightRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
