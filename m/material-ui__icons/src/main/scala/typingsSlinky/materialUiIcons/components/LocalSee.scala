...
import typingsSlinky.materialUiIcons.localSeeMod.default
...
object LocalSee {
  ...
  implicit def make(companion: LocalSee.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
