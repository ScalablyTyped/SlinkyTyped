...
import typingsSlinky.materialUiIcons.filterBAndWMod.default
...
object FilterBAndW {
  ...
  implicit def make(companion: FilterBAndW.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
