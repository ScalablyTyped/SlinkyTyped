...
import typingsSlinky.materialUiIcons.controlPointMod.default
...
object ControlPoint {
  ...
  implicit def make(companion: ControlPoint.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
