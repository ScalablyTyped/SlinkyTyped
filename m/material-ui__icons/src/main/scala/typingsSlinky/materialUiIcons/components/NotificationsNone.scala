...
import typingsSlinky.materialUiIcons.notificationsNoneMod.default
...
object NotificationsNone {
  ...
  implicit def make(companion: NotificationsNone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
