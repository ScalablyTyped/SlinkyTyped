...
import typingsSlinky.materialUiIcons.panoramaMod.default
...
object Panorama {
  ...
  implicit def make(companion: Panorama.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
