...
import typingsSlinky.materialUiIcons.sortByAlphaMod.default
...
object SortByAlpha {
  ...
  implicit def make(companion: SortByAlpha.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
