...
object PhoneDisabled {
  @JSImport("@material-ui/icons", "PhoneDisabled")
  @js.native
  ...
  implicit def make(companion: PhoneDisabled.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
