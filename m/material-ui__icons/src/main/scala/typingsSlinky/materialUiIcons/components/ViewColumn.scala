...
import typingsSlinky.materialUiIcons.viewColumnMod.default
...
object ViewColumn {
  ...
  implicit def make(companion: ViewColumn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
