...
import typingsSlinky.materialUiIcons.notificationsPausedMod.default
...
object NotificationsPaused {
  ...
  implicit def make(companion: NotificationsPaused.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
