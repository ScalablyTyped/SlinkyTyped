...
object WatchLater {
  ...
  @JSImport("@material-ui/icons", "WatchLater")
  @js.native
  ...
  implicit def make(companion: WatchLater.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
