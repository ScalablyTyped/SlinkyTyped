...
import typingsSlinky.materialUiIcons.albumMod.default
...
object Album {
  ...
  implicit def make(companion: Album.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
