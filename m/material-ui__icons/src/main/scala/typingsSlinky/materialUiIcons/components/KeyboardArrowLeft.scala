...
import typingsSlinky.materialUiIcons.keyboardArrowLeftMod.default
...
object KeyboardArrowLeft {
  ...
  implicit def make(companion: KeyboardArrowLeft.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
