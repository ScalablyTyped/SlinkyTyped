...
import typingsSlinky.materialUiIcons.notInterestedMod.default
...
object NotInterested {
  ...
  implicit def make(companion: NotInterested.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
