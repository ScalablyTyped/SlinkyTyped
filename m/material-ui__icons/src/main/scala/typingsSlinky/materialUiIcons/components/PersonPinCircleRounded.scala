...
object PersonPinCircleRounded {
  ...
  @JSImport("@material-ui/icons", "PersonPinCircleRounded")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PersonPinCircleRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
