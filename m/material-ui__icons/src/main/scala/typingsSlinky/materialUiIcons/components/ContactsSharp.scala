...
object ContactsSharp {
  
  @JSImport("@material-ui/icons", "ContactsSharp")
  @js.native
  ...
  implicit def make(companion: ContactsSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
