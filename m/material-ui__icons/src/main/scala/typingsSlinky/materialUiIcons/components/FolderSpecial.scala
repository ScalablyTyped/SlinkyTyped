...
import typingsSlinky.materialUiIcons.folderSpecialMod.default
...
object FolderSpecial {
  ...
  implicit def make(companion: FolderSpecial.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
