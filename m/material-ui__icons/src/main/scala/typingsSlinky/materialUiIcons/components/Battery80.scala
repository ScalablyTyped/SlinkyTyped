...
object Battery80 {
  ...
  @JSImport("@material-ui/icons", "Battery80")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Battery80.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
