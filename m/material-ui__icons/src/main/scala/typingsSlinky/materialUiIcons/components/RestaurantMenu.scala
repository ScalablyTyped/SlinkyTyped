...
import typingsSlinky.materialUiIcons.restaurantMenuMod.default
...
object RestaurantMenu {
  ...
  implicit def make(companion: RestaurantMenu.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
