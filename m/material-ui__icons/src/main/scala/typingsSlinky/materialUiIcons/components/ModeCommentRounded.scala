...
object ModeCommentRounded {
  @JSImport("@material-ui/icons/ModeCommentRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ModeCommentRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
