...
object BorderBottomSharp {
  @JSImport("@material-ui/icons", "BorderBottomSharp")
  @js.native
  ...
  implicit def make(companion: BorderBottomSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
