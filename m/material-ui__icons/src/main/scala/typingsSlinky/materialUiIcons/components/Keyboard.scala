...
import typingsSlinky.materialUiIcons.keyboardMod.default
...
object Keyboard {
  ...
  implicit def make(companion: Keyboard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
