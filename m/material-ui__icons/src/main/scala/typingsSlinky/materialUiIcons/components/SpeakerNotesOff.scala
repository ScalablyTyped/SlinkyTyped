...
object SpeakerNotesOff {
  @JSImport("@material-ui/icons", "SpeakerNotesOff")
  @js.native
  ...
  implicit def make(companion: SpeakerNotesOff.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
