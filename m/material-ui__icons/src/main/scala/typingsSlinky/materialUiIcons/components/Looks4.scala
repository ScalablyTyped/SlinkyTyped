...
import typingsSlinky.materialUiIcons.looks4Mod.default
...
object Looks4 {
  ...
  implicit def make(companion: Looks4.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
