...
object Looks4 {
  @JSImport("@material-ui/icons", "Looks4")
  @js.native
  ...
  implicit def make(companion: Looks4.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
