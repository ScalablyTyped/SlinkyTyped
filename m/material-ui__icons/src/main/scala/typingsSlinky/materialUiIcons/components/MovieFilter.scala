...
import typingsSlinky.materialUiIcons.movieFilterMod.default
...
object MovieFilter {
  ...
  implicit def make(companion: MovieFilter.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
