...
import typingsSlinky.materialUiIcons.starBorderMod.default
...
object StarBorder {
  ...
  implicit def make(companion: StarBorder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
