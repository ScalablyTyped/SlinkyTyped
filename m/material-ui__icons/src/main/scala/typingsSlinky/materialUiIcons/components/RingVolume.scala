...
import typingsSlinky.materialUiIcons.ringVolumeMod.default
...
object RingVolume {
  ...
  implicit def make(companion: RingVolume.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
