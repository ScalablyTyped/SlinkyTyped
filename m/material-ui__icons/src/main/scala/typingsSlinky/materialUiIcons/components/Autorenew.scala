...
import typingsSlinky.materialUiIcons.autorenewMod.default
...
object Autorenew {
  ...
  implicit def make(companion: Autorenew.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
