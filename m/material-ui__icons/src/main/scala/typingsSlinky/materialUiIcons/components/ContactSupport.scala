...
import typingsSlinky.materialUiIcons.contactSupportMod.default
...
object ContactSupport {
  ...
  implicit def make(companion: ContactSupport.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
