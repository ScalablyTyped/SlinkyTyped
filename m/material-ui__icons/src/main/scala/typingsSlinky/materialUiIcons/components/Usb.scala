...
import typingsSlinky.materialUiIcons.usbMod.default
...
object Usb {
  ...
  implicit def make(companion: Usb.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
