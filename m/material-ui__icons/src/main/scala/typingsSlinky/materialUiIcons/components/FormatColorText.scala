...
import typingsSlinky.materialUiIcons.formatColorTextMod.default
...
object FormatColorText {
  ...
  implicit def make(companion: FormatColorText.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
