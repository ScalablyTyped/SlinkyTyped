...
import typingsSlinky.materialUiIcons.airplayMod.default
...
object Airplay {
  ...
  implicit def make(companion: Airplay.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
