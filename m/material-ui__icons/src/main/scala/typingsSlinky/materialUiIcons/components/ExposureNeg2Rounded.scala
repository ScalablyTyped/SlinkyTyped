...
object ExposureNeg2Rounded {
  ...
  implicit def make(companion: ExposureNeg2Rounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
