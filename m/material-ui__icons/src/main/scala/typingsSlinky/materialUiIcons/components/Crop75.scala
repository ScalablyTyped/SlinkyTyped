...
import typingsSlinky.materialUiIcons.crop75Mod.default
...
object Crop75 {
  ...
  implicit def make(companion: Crop75.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
