...
import typingsSlinky.materialUiIcons.publicMod.default
...
object Public {
  ...
  implicit def make(companion: Public.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
