...
import typingsSlinky.materialUiIcons.noEncryptionMod.default
...
object NoEncryption {
  ...
  implicit def make(companion: NoEncryption.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
