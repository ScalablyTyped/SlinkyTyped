...
import typingsSlinky.materialUiIcons.tabMod.default
...
object Tab {
  ...
  implicit def make(companion: Tab.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
