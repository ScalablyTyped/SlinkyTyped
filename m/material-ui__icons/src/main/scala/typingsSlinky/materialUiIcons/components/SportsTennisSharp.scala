...
object SportsTennisSharp {
  ...
  @JSImport("@material-ui/icons", "SportsTennisSharp")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SportsTennisSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
