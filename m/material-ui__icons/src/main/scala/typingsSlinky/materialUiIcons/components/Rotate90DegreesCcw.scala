...
import typingsSlinky.materialUiIcons.rotate90DegreesCcwMod.default
...
object Rotate90DegreesCcw {
  ...
  implicit def make(companion: Rotate90DegreesCcw.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
