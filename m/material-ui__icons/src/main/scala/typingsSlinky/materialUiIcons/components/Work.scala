...
import typingsSlinky.materialUiIcons.workMod.default
...
object Work {
  ...
  implicit def make(companion: Work.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
