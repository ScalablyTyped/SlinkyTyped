...
import typingsSlinky.materialUiIcons.errorMod.default
...
object Error {
  ...
  implicit def make(companion: Error.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
