...
import typingsSlinky.materialUiIcons.keyboardTabMod.default
...
object KeyboardTab {
  ...
  implicit def make(companion: KeyboardTab.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
