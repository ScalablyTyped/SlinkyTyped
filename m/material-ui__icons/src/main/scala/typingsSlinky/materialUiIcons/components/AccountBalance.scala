...
import typingsSlinky.materialUiIcons.accountBalanceMod.default
...
object AccountBalance {
  ...
  implicit def make(companion: AccountBalance.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
