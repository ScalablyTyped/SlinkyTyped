...
import typingsSlinky.materialUiIcons.fiberSmartRecordMod.default
...
object FiberSmartRecord {
  ...
  implicit def make(companion: FiberSmartRecord.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
