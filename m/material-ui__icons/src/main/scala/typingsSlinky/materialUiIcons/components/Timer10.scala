...
import typingsSlinky.materialUiIcons.timer10Mod.default
...
object Timer10 {
  ...
  implicit def make(companion: Timer10.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
