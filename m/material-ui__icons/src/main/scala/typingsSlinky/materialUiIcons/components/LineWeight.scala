...
import typingsSlinky.materialUiIcons.lineWeightMod.default
...
object LineWeight {
  ...
  implicit def make(companion: LineWeight.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
