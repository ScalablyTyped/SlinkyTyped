...
import typingsSlinky.materialUiIcons.fitnessCenterMod.default
...
object FitnessCenter {
  ...
  implicit def make(companion: FitnessCenter.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
