...
import typingsSlinky.materialUiIcons.storeMallDirectoryMod.default
...
object StoreMallDirectory {
  ...
  implicit def make(companion: StoreMallDirectory.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
