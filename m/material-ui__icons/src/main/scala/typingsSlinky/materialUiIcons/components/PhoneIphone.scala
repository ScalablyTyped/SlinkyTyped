...
import typingsSlinky.materialUiIcons.phoneIphoneMod.default
...
object PhoneIphone {
  ...
  implicit def make(companion: PhoneIphone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
