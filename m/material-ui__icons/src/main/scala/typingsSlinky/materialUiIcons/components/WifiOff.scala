...
import typingsSlinky.materialUiIcons.wifiOffMod.default
...
object WifiOff {
  ...
  implicit def make(companion: WifiOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
