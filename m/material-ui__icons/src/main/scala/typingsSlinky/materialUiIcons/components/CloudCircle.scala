...
import typingsSlinky.materialUiIcons.cloudCircleMod.default
...
object CloudCircle {
  ...
  implicit def make(companion: CloudCircle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
