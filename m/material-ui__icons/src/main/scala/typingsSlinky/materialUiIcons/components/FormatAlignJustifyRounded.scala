...
object FormatAlignJustifyRounded {
  @JSImport("@material-ui/icons", "FormatAlignJustifyRounded")
  @js.native
  ...
  implicit def make(companion: FormatAlignJustifyRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
