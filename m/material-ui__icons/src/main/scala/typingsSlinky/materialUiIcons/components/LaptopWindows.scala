...
import typingsSlinky.materialUiIcons.laptopWindowsMod.default
...
object LaptopWindows {
  ...
  implicit def make(companion: LaptopWindows.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
