...
import typingsSlinky.materialUiIcons.gradeMod.default
...
object Grade {
  ...
  implicit def make(companion: Grade.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
