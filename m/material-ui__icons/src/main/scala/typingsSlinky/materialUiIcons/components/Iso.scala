...
import typingsSlinky.materialUiIcons.isoMod.default
...
object Iso {
  ...
  implicit def make(companion: Iso.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
