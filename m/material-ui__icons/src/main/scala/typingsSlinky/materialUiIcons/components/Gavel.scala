...
import typingsSlinky.materialUiIcons.gavelMod.default
...
object Gavel {
  ...
  implicit def make(companion: Gavel.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
