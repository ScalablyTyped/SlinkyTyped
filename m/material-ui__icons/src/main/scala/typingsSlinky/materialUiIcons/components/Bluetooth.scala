...
import typingsSlinky.materialUiIcons.bluetoothMod.default
...
object Bluetooth {
  ...
  implicit def make(companion: Bluetooth.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
