...
import typingsSlinky.materialUiIcons.archiveMod.default
...
object Archive {
  ...
  implicit def make(companion: Archive.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
