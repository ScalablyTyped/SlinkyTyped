...
import typingsSlinky.materialUiIcons.localPlayMod.default
...
object LocalPlay {
  ...
  implicit def make(companion: LocalPlay.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
