...
import typingsSlinky.materialUiIcons.arrowDropDownMod.default
...
object ArrowDropDown {
  ...
  implicit def make(companion: ArrowDropDown.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
