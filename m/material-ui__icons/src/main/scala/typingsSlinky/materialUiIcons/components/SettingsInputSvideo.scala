...
import typingsSlinky.materialUiIcons.settingsInputSvideoMod.default
...
object SettingsInputSvideo {
  ...
  implicit def make(companion: SettingsInputSvideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
