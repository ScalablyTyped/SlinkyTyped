...
import typingsSlinky.materialUiIcons.fiberDvrMod.default
...
object FiberDvr {
  ...
  implicit def make(companion: FiberDvr.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
