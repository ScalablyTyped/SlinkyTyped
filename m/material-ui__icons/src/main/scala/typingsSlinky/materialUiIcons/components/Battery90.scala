...
import typingsSlinky.materialUiIcons.battery90Mod.default
...
object Battery90 {
  ...
  implicit def make(companion: Battery90.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
