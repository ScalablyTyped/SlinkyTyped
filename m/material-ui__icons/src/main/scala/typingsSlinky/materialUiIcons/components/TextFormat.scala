...
import typingsSlinky.materialUiIcons.textFormatMod.default
...
object TextFormat {
  ...
  implicit def make(companion: TextFormat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
