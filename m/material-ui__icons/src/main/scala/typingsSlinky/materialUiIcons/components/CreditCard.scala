...
import typingsSlinky.materialUiIcons.creditCardMod.default
...
object CreditCard {
  ...
  implicit def make(companion: CreditCard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
