...
import typingsSlinky.materialUiIcons.borderLeftMod.default
...
object BorderLeft {
  ...
  implicit def make(companion: BorderLeft.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
