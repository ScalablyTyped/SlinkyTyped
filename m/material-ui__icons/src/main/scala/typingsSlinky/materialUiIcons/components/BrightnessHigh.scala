...
import typingsSlinky.materialUiIcons.brightnessHighMod.default
...
object BrightnessHigh {
  ...
  implicit def make(companion: BrightnessHigh.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
