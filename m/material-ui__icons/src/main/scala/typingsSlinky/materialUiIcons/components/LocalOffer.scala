...
import typingsSlinky.materialUiIcons.localOfferMod.default
...
object LocalOffer {
  ...
  implicit def make(companion: LocalOffer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
