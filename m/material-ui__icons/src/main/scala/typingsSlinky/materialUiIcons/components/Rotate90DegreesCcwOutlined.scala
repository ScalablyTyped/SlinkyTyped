...
object Rotate90DegreesCcwOutlined {
  ...
  implicit def make(companion: Rotate90DegreesCcwOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
