...
object SpeakerGroupRounded {
  
  @JSImport("@material-ui/icons", "SpeakerGroupRounded")
  @js.native
  ...
  implicit def make(companion: SpeakerGroupRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
