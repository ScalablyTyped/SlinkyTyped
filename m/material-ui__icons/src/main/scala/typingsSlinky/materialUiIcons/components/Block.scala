...
import typingsSlinky.materialUiIcons.blockMod.default
...
object Block {
  ...
  implicit def make(companion: Block.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
