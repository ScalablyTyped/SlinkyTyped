...
import typingsSlinky.materialUiIcons.houseMod.default
...
object House {
  ...
  implicit def make(companion: House.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
