...
import typingsSlinky.materialUiIcons.noSimMod.default
...
object NoSim {
  ...
  implicit def make(companion: NoSim.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
