...
import typingsSlinky.materialUiIcons.rateReviewMod.default
...
object RateReview {
  ...
  implicit def make(companion: RateReview.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
