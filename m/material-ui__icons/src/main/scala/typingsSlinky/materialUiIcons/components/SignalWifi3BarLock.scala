...
object SignalWifi3BarLock {
  ...
  @JSImport("@material-ui/icons", "SignalWifi3BarLock")
  @js.native
  ...
  implicit def make(companion: SignalWifi3BarLock.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
