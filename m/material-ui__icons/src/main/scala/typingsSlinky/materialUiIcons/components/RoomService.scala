...
import typingsSlinky.materialUiIcons.roomServiceMod.default
...
object RoomService {
  ...
  implicit def make(companion: RoomService.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
