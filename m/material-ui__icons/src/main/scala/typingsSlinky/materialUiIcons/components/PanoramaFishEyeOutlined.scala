...
object PanoramaFishEyeOutlined {
  ...
  @JSImport("@material-ui/icons", "PanoramaFishEyeOutlined")
  @js.native
  ...
  implicit def make(companion: PanoramaFishEyeOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
