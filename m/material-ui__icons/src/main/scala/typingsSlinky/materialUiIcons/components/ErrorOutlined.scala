...
object ErrorOutlined {
  ...
  @JSImport("@material-ui/icons", "ErrorOutlined")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ErrorOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
