...
object VerticalSplit {
  @JSImport("@material-ui/icons", "VerticalSplit")
  @js.native
  ...
  implicit def make(companion: VerticalSplit.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
