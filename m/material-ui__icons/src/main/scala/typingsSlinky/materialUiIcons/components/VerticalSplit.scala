...
import typingsSlinky.materialUiIcons.verticalSplitMod.default
...
object VerticalSplit {
  ...
  implicit def make(companion: VerticalSplit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
