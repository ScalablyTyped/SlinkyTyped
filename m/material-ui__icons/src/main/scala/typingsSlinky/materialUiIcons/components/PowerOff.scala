...
object PowerOff {
  @JSImport("@material-ui/icons", "PowerOff")
  @js.native
  ...
  implicit def make(companion: PowerOff.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
