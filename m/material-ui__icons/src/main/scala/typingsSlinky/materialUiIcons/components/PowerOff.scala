...
import typingsSlinky.materialUiIcons.powerOffMod.default
...
object PowerOff {
  ...
  implicit def make(companion: PowerOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
