...
object Looks6 {
  @JSImport("@material-ui/icons/Looks6", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Looks6.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
