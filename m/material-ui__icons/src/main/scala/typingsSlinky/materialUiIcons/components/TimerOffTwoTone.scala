...
object TimerOffTwoTone {
  @JSImport("@material-ui/icons/TimerOffTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TimerOffTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
