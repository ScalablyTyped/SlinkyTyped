...
import typingsSlinky.materialUiIcons.snoozeMod.default
...
object Snooze {
  ...
  implicit def make(companion: Snooze.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
