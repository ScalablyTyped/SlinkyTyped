...
object ExposureNeg1Sharp {
  ...
  implicit def make(companion: ExposureNeg1Sharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
