...
import typingsSlinky.materialUiIcons.exitToAppMod.default
...
object ExitToApp {
  ...
  implicit def make(companion: ExitToApp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
