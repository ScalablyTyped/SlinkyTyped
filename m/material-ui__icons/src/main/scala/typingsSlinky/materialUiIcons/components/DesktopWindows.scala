...
import typingsSlinky.materialUiIcons.desktopWindowsMod.default
...
object DesktopWindows {
  ...
  implicit def make(companion: DesktopWindows.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
