...
import typingsSlinky.materialUiIcons.cropRotateMod.default
...
object CropRotate {
  ...
  implicit def make(companion: CropRotate.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
