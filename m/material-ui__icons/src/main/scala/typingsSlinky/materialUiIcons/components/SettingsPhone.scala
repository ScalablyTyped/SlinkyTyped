...
import typingsSlinky.materialUiIcons.settingsPhoneMod.default
...
object SettingsPhone {
  ...
  implicit def make(companion: SettingsPhone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
