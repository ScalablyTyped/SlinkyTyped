...
import typingsSlinky.materialUiIcons.brandingWatermarkMod.default
...
object BrandingWatermark {
  ...
  implicit def make(companion: BrandingWatermark.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
