...
object Crop169Sharp {
  @JSImport("@material-ui/icons/Crop169Sharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Crop169Sharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
