...
import typingsSlinky.materialUiIcons.horizontalSplitMod.default
...
object HorizontalSplit {
  ...
  implicit def make(companion: HorizontalSplit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
