...
import typingsSlinky.materialUiIcons.navigateBeforeMod.default
...
object NavigateBefore {
  ...
  implicit def make(companion: NavigateBefore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
