...
object PlaylistAddCheck {
  @JSImport("@material-ui/icons", "PlaylistAddCheck")
  @js.native
  ...
  implicit def make(companion: PlaylistAddCheck.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
