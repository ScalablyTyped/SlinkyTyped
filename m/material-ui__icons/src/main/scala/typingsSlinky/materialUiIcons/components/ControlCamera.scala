...
object ControlCamera {
  @JSImport("@material-ui/icons", "ControlCamera")
  @js.native
  ...
  implicit def make(companion: ControlCamera.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
