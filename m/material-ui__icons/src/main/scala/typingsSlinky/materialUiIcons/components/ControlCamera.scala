...
import typingsSlinky.materialUiIcons.controlCameraMod.default
...
object ControlCamera {
  ...
  implicit def make(companion: ControlCamera.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
