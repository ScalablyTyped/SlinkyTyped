...
import typingsSlinky.materialUiIcons.dragIndicatorMod.default
...
object DragIndicator {
  ...
  implicit def make(companion: DragIndicator.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
