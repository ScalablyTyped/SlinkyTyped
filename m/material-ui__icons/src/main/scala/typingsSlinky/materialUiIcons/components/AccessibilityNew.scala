...
import typingsSlinky.materialUiIcons.accessibilityNewMod.default
...
object AccessibilityNew {
  ...
  implicit def make(companion: AccessibilityNew.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
