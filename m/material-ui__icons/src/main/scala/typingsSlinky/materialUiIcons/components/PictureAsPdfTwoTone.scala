...
object PictureAsPdfTwoTone {
  ...
  implicit def make(companion: PictureAsPdfTwoTone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
