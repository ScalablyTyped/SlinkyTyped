...
object GpsNotFixedSharp {
  @JSImport("@material-ui/icons", "GpsNotFixedSharp")
  @js.native
  ...
  implicit def make(companion: GpsNotFixedSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
