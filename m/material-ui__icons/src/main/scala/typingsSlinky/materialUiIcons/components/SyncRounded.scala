...
object SyncRounded {
  ...
  @JSImport("@material-ui/icons", "SyncRounded")
  @js.native
  ...
  implicit def make(companion: SyncRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
