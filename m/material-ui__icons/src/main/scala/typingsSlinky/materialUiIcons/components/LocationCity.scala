...
import typingsSlinky.materialUiIcons.locationCityMod.default
...
object LocationCity {
  ...
  implicit def make(companion: LocationCity.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
