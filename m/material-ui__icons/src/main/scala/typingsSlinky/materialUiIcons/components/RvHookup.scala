...
import typingsSlinky.materialUiIcons.rvHookupMod.default
...
object RvHookup {
  ...
  implicit def make(companion: RvHookup.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
