...
import typingsSlinky.materialUiIcons.turnedInNotMod.default
...
object TurnedInNot {
  ...
  implicit def make(companion: TurnedInNot.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
