...
import typingsSlinky.materialUiIcons.searchMod.default
...
object Search {
  ...
  implicit def make(companion: Search.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
