...
import typingsSlinky.materialUiIcons.phonelinkMod.default
...
object Phonelink {
  ...
  implicit def make(companion: Phonelink.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
