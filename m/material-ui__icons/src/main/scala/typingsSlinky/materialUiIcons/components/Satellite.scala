...
import typingsSlinky.materialUiIcons.satelliteMod.default
...
object Satellite {
  ...
  implicit def make(companion: Satellite.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
