...
import typingsSlinky.materialUiIcons.bookmarksMod.default
...
object Bookmarks {
  ...
  implicit def make(companion: Bookmarks.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
