...
import typingsSlinky.materialUiIcons.commentMod.default
...
object Comment {
  ...
  implicit def make(companion: Comment.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
