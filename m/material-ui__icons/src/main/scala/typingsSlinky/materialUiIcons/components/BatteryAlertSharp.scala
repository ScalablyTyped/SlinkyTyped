...
object BatteryAlertSharp {
  @JSImport("@material-ui/icons/BatteryAlertSharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: BatteryAlertSharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
