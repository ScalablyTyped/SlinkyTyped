...
import typingsSlinky.materialUiIcons.rotateLeftMod.default
...
object RotateLeft {
  ...
  implicit def make(companion: RotateLeft.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
