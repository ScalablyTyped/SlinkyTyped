...
import typingsSlinky.materialUiIcons.textRotateVerticalMod.default
...
object TextRotateVertical {
  ...
  implicit def make(companion: TextRotateVertical.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
