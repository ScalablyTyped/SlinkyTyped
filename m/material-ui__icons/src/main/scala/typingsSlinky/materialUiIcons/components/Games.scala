...
import typingsSlinky.materialUiIcons.gamesMod.default
...
object Games {
  ...
  implicit def make(companion: Games.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
