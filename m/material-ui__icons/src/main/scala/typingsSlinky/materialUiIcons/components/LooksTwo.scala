...
import typingsSlinky.materialUiIcons.looksTwoMod.default
...
object LooksTwo {
  ...
  implicit def make(companion: LooksTwo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
