...
import typingsSlinky.materialUiIcons.settingsBackupRestoreMod.default
...
object SettingsBackupRestore {
  ...
  implicit def make(companion: SettingsBackupRestore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
