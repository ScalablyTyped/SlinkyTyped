...
object Timer10Sharp {
  @JSImport("@material-ui/icons/Timer10Sharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Timer10Sharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
