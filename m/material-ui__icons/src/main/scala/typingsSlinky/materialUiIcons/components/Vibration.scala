...
import typingsSlinky.materialUiIcons.vibrationMod.default
...
object Vibration {
  ...
  implicit def make(companion: Vibration.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
