...
import typingsSlinky.materialUiIcons.accessibleMod.default
...
object Accessible {
  ...
  implicit def make(companion: Accessible.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
