...
import typingsSlinky.materialUiIcons.dragHandleMod.default
...
object DragHandle {
  ...
  implicit def make(companion: DragHandle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
