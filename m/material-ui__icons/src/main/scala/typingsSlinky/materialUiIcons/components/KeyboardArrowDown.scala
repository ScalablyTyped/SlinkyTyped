...
import typingsSlinky.materialUiIcons.keyboardArrowDownMod.default
...
object KeyboardArrowDown {
  ...
  implicit def make(companion: KeyboardArrowDown.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
