...
import typingsSlinky.materialUiIcons.imageMod.default
...
object Image {
  ...
  implicit def make(companion: Image.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
