...
import typingsSlinky.materialUiIcons.callMergeMod.default
...
object CallMerge {
  ...
  implicit def make(companion: CallMerge.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
