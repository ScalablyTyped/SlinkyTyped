...
object SpeedOutlined {
  ...
  @JSImport("@material-ui/icons", "SpeedOutlined")
  @js.native
  ...
  implicit def make(companion: SpeedOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
