...
object BluetoothAudioTwoTone {
  ...
  @JSImport("@material-ui/icons", "BluetoothAudioTwoTone")
  @js.native
  ...
  implicit def make(companion: BluetoothAudioTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
