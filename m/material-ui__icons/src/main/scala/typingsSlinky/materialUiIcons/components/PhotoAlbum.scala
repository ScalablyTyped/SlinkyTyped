...
import typingsSlinky.materialUiIcons.photoAlbumMod.default
...
object PhotoAlbum {
  ...
  implicit def make(companion: PhotoAlbum.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
