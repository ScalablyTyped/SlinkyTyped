...
object CropDinRounded {
  @JSImport("@material-ui/icons/CropDinRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CropDinRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
