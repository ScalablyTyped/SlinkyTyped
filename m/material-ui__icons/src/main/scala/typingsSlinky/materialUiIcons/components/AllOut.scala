...
import typingsSlinky.materialUiIcons.allOutMod.default
...
object AllOut {
  ...
  implicit def make(companion: AllOut.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
