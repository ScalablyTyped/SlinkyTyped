...
import typingsSlinky.materialUiIcons.personAddMod.default
...
object PersonAdd {
  ...
  implicit def make(companion: PersonAdd.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
