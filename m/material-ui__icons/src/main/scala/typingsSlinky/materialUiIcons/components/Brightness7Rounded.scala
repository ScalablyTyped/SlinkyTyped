...
object Brightness7Rounded {
  @JSImport("@material-ui/icons/Brightness7Rounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Brightness7Rounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
