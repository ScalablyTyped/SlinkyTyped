...
import typingsSlinky.materialUiIcons.airlineSeatIndividualSuiteMod.default
...
object AirlineSeatIndividualSuite {
  ...
  implicit def make(companion: AirlineSeatIndividualSuite.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
