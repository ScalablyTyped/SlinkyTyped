...
import typingsSlinky.materialUiIcons.newReleasesMod.default
...
object NewReleases {
  ...
  implicit def make(companion: NewReleases.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
