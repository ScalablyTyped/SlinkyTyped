...
import typingsSlinky.materialUiIcons.shopTwoMod.default
...
object ShopTwo {
  ...
  implicit def make(companion: ShopTwo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
