...
import typingsSlinky.materialUiIcons.deleteMod.default
...
object Delete {
  ...
  implicit def make(companion: Delete.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
