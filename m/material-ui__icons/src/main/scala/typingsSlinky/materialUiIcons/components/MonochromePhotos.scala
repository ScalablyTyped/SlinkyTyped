...
import typingsSlinky.materialUiIcons.monochromePhotosMod.default
...
object MonochromePhotos {
  ...
  implicit def make(companion: MonochromePhotos.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
