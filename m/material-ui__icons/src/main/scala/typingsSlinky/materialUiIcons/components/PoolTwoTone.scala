...
object PoolTwoTone {
  @JSImport("@material-ui/icons", "PoolTwoTone")
  @js.native
  ...
  implicit def make(companion: PoolTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
