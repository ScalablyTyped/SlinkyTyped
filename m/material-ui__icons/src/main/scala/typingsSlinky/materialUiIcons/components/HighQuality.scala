...
import typingsSlinky.materialUiIcons.highQualityMod.default
...
object HighQuality {
  ...
  implicit def make(companion: HighQuality.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
