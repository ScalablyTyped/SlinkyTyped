...
import typingsSlinky.materialUiIcons.deviceHubMod.default
...
object DeviceHub {
  ...
  implicit def make(companion: DeviceHub.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
