...
import typingsSlinky.materialUiIcons.restoreMod.default
...
object Restore {
  ...
  implicit def make(companion: Restore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
