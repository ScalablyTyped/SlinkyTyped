...
import typingsSlinky.materialUiIcons.formatAlignLeftMod.default
...
object FormatAlignLeft {
  ...
  implicit def make(companion: FormatAlignLeft.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
