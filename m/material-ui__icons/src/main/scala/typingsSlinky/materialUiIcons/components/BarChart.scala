...
import typingsSlinky.materialUiIcons.barChartMod.default
...
object BarChart {
  ...
  implicit def make(companion: BarChart.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
