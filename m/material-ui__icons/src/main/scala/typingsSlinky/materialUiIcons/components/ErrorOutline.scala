...
import typingsSlinky.materialUiIcons.errorOutlineMod.default
...
object ErrorOutline {
  ...
  implicit def make(companion: ErrorOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
