...
object DonutLargeSharp {
  ...
  @JSImport("@material-ui/icons", "DonutLargeSharp")
  @js.native
  ...
  implicit def make(companion: DonutLargeSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
