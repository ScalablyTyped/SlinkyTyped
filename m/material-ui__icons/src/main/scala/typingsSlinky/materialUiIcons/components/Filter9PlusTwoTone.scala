...
object Filter9PlusTwoTone {
  @JSImport("@material-ui/icons/Filter9PlusTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Filter9PlusTwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
