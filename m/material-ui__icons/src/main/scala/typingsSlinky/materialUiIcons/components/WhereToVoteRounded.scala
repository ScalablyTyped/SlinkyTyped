...
object WhereToVoteRounded {
  ...
  @JSImport("@material-ui/icons", "WhereToVoteRounded")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WhereToVoteRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
