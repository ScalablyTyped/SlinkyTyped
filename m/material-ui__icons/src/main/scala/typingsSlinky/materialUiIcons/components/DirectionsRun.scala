...
import typingsSlinky.materialUiIcons.directionsRunMod.default
...
object DirectionsRun {
  ...
  implicit def make(companion: DirectionsRun.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
