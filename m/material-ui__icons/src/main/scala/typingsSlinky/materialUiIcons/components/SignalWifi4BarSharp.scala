...
object SignalWifi4BarSharp {
  ...
  implicit def make(companion: SignalWifi4BarSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
