...
object FastForwardRounded {
  ...
  @JSImport("@material-ui/icons", "FastForwardRounded")
  @js.native
  ...
  implicit def make(companion: FastForwardRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
