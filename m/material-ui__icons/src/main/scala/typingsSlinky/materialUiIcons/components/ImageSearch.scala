...
import typingsSlinky.materialUiIcons.imageSearchMod.default
...
object ImageSearch {
  ...
  implicit def make(companion: ImageSearch.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
