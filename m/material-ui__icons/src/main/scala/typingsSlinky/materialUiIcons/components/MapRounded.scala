...
object MapRounded {
  ...
  @JSImport("@material-ui/icons", "MapRounded")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MapRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
