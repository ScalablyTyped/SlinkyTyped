...
import typingsSlinky.materialUiIcons.phoneForwardedMod.default
...
object PhoneForwarded {
  ...
  implicit def make(companion: PhoneForwarded.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
