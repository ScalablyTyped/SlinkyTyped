...
import typingsSlinky.materialUiIcons.callSplitMod.default
...
object CallSplit {
  ...
  implicit def make(companion: CallSplit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
