...
import typingsSlinky.materialUiIcons.contactMailMod.default
...
object ContactMail {
  ...
  implicit def make(companion: ContactMail.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
