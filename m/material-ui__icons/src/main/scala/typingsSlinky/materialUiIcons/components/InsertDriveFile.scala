...
import typingsSlinky.materialUiIcons.insertDriveFileMod.default
...
object InsertDriveFile {
  ...
  implicit def make(companion: InsertDriveFile.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
