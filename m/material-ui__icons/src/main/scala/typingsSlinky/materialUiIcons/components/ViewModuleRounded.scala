...
object ViewModuleRounded {
  ...
  @JSImport("@material-ui/icons", "ViewModuleRounded")
  @js.native
  ...
  implicit def make(companion: ViewModuleRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
