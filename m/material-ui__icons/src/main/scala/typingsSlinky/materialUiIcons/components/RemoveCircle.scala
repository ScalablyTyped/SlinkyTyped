...
import typingsSlinky.materialUiIcons.removeCircleMod.default
...
object RemoveCircle {
  ...
  implicit def make(companion: RemoveCircle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
