...
import typingsSlinky.materialUiIcons.signalWifi1BarLockMod.default
...
object SignalWifi1BarLock {
  ...
  implicit def make(companion: SignalWifi1BarLock.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
