...
object SignalWifi1BarLock {
  ...
  implicit def make(companion: SignalWifi1BarLock.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
