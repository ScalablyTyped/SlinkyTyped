...
import typingsSlinky.materialUiIcons.addAPhotoMod.default
...
object AddAPhoto {
  ...
  implicit def make(companion: AddAPhoto.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
