...
object Brightness5Sharp {
  @JSImport("@material-ui/icons/Brightness5Sharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Brightness5Sharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
