...
object FormatLineSpacingRounded {
  ...
  @JSImport("@material-ui/icons", "FormatLineSpacingRounded")
  @js.native
  ...
  implicit def make(companion: FormatLineSpacingRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
