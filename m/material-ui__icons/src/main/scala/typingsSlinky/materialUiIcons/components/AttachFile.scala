...
import typingsSlinky.materialUiIcons.attachFileMod.default
...
object AttachFile {
  ...
  implicit def make(companion: AttachFile.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
