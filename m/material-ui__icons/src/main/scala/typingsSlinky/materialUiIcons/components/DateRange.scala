...
import typingsSlinky.materialUiIcons.dateRangeMod.default
...
object DateRange {
  ...
  implicit def make(companion: DateRange.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
