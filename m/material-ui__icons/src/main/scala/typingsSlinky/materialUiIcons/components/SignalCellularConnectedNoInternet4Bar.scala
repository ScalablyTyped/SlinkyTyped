...
import typingsSlinky.materialUiIcons.signalCellularConnectedNoInternet4BarMod.default
...
object SignalCellularConnectedNoInternet4Bar {
  ...
  implicit def make(companion: SignalCellularConnectedNoInternet4Bar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
