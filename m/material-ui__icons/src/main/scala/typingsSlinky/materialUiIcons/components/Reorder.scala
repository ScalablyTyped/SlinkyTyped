...
import typingsSlinky.materialUiIcons.reorderMod.default
...
object Reorder {
  ...
  implicit def make(companion: Reorder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
