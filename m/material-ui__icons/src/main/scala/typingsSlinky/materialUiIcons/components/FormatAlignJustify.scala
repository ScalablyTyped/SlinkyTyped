...
import typingsSlinky.materialUiIcons.formatAlignJustifyMod.default
...
object FormatAlignJustify {
  ...
  implicit def make(companion: FormatAlignJustify.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
