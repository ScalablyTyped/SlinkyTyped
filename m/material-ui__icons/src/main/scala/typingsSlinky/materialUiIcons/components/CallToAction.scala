...
import typingsSlinky.materialUiIcons.callToActionMod.default
...
object CallToAction {
  ...
  implicit def make(companion: CallToAction.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
