...
import typingsSlinky.materialUiIcons.priorityHighMod.default
...
object PriorityHigh {
  ...
  implicit def make(companion: PriorityHigh.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
