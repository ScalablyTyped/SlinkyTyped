...
import typingsSlinky.materialUiIcons.filter2Mod.default
...
object Filter2 {
  ...
  implicit def make(companion: Filter2.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
