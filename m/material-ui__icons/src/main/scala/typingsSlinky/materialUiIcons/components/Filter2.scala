...
object Filter2 {
  @JSImport("@material-ui/icons", "Filter2")
  @js.native
  ...
  implicit def make(companion: Filter2.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
