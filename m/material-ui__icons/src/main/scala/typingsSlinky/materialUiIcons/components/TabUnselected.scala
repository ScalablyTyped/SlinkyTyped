...
import typingsSlinky.materialUiIcons.tabUnselectedMod.default
...
object TabUnselected {
  ...
  implicit def make(companion: TabUnselected.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
