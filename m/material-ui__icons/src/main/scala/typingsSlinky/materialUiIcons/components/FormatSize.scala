...
import typingsSlinky.materialUiIcons.formatSizeMod.default
...
object FormatSize {
  ...
  implicit def make(companion: FormatSize.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
