...
object FormatItalicOutlined {
  @JSImport("@material-ui/icons", "FormatItalicOutlined")
  @js.native
  ...
  implicit def make(companion: FormatItalicOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
