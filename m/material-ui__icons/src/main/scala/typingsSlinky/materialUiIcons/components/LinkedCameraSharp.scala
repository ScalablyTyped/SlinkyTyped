...
object LinkedCameraSharp {
  ...
  @JSImport("@material-ui/icons", "LinkedCameraSharp")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LinkedCameraSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
