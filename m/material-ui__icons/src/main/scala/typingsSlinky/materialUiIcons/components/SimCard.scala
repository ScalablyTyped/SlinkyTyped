...
import typingsSlinky.materialUiIcons.simCardMod.default
...
object SimCard {
  ...
  implicit def make(companion: SimCard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
