...
object Forward10Rounded {
  @JSImport("@material-ui/icons", "Forward10Rounded")
  @js.native
  ...
  implicit def make(companion: Forward10Rounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
