...
import typingsSlinky.materialUiIcons.notificationsActiveMod.default
...
object NotificationsActive {
  ...
  implicit def make(companion: NotificationsActive.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
