...
import typingsSlinky.materialUiIcons.signalWifi2BarLockMod.default
...
object SignalWifi2BarLock {
  ...
  implicit def make(companion: SignalWifi2BarLock.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
