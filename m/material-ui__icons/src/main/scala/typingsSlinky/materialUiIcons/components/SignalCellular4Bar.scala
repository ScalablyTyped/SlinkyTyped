...
object SignalCellular4Bar {
  @JSImport("@material-ui/icons", "SignalCellular4Bar")
  @js.native
  ...
  implicit def make(companion: SignalCellular4Bar.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
