...
import typingsSlinky.materialUiIcons.signalCellular4BarMod.default
...
object SignalCellular4Bar {
  ...
  implicit def make(companion: SignalCellular4Bar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
