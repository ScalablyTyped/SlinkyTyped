...
import typingsSlinky.materialUiIcons.roundedCornerMod.default
...
object RoundedCorner {
  ...
  implicit def make(companion: RoundedCorner.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
