...
import typingsSlinky.materialUiIcons.desktopMacMod.default
...
object DesktopMac {
  ...
  implicit def make(companion: DesktopMac.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
