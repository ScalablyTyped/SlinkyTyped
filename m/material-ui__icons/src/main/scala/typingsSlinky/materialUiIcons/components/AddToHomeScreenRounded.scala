...
object AddToHomeScreenRounded {
  ...
  @JSImport("@material-ui/icons", "AddToHomeScreenRounded")
  @js.native
  ...
  implicit def make(companion: AddToHomeScreenRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
