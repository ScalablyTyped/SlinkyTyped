...
import typingsSlinky.materialUiIcons.shoppingCartMod.default
...
object ShoppingCart {
  ...
  implicit def make(companion: ShoppingCart.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
