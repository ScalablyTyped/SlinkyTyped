...
import typingsSlinky.materialUiIcons.removeFromQueueMod.default
...
object RemoveFromQueue {
  ...
  implicit def make(companion: RemoveFromQueue.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
