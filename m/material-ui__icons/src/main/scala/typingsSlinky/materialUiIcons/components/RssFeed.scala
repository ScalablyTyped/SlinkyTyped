...
import typingsSlinky.materialUiIcons.rssFeedMod.default
...
object RssFeed {
  ...
  implicit def make(companion: RssFeed.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
