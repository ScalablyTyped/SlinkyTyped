...
import typingsSlinky.materialUiIcons.insertEmoticonMod.default
...
object InsertEmoticon {
  ...
  implicit def make(companion: InsertEmoticon.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
