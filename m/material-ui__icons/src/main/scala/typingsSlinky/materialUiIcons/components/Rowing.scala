...
import typingsSlinky.materialUiIcons.rowingMod.default
...
object Rowing {
  ...
  implicit def make(companion: Rowing.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
