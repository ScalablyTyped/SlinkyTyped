...
import typingsSlinky.materialUiIcons.arrowForwardIosMod.default
...
object ArrowForwardIos {
  ...
  implicit def make(companion: ArrowForwardIos.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
