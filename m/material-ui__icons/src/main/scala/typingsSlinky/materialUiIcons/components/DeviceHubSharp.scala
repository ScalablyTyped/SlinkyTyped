...
object DeviceHubSharp {
  ...
  @JSImport("@material-ui/icons", "DeviceHubSharp")
  @js.native
  ...
  implicit def make(companion: DeviceHubSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
