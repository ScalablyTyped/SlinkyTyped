...
import typingsSlinky.materialUiIcons.linearScaleMod.default
...
object LinearScale {
  ...
  implicit def make(companion: LinearScale.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
