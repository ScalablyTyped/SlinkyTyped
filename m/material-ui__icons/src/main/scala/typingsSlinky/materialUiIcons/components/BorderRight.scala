...
import typingsSlinky.materialUiIcons.borderRightMod.default
...
object BorderRight {
  ...
  implicit def make(companion: BorderRight.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
