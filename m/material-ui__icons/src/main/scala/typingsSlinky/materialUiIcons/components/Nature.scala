...
import typingsSlinky.materialUiIcons.natureMod.default
...
object Nature {
  ...
  implicit def make(companion: Nature.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
