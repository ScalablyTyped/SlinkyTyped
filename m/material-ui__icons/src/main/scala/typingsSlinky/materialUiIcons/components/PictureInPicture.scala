...
import typingsSlinky.materialUiIcons.pictureInPictureMod.default
...
object PictureInPicture {
  ...
  implicit def make(companion: PictureInPicture.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
