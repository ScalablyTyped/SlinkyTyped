...
import typingsSlinky.materialUiIcons.settingsInputCompositeMod.default
...
object SettingsInputComposite {
  ...
  implicit def make(companion: SettingsInputComposite.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
