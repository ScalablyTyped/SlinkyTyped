...
import typingsSlinky.materialUiIcons.mmsMod.default
...
object Mms {
  ...
  implicit def make(companion: Mms.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
