...
import typingsSlinky.materialUiIcons.directionsSubwayMod.default
...
object DirectionsSubway {
  ...
  implicit def make(companion: DirectionsSubway.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
