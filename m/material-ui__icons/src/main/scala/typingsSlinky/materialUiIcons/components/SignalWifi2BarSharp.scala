...
object SignalWifi2BarSharp {
  ...
  implicit def make(companion: SignalWifi2BarSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
