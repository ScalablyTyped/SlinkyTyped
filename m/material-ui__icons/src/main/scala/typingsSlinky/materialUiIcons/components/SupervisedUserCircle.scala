...
object SupervisedUserCircle {
  ...
  @JSImport("@material-ui/icons", "SupervisedUserCircle")
  @js.native
  ...
  implicit def make(companion: SupervisedUserCircle.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
