...
import typingsSlinky.materialUiIcons.supervisedUserCircleMod.default
...
object SupervisedUserCircle {
  ...
  implicit def make(companion: SupervisedUserCircle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
