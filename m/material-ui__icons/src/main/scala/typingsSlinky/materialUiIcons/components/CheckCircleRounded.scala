...
object CheckCircleRounded {
  @JSImport("@material-ui/icons/CheckCircleRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CheckCircleRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
