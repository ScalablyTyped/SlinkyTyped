...
import typingsSlinky.materialUiIcons.flashOffMod.default
...
object FlashOff {
  ...
  implicit def make(companion: FlashOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
