...
import typingsSlinky.materialUiIcons.slideshowMod.default
...
object Slideshow {
  ...
  implicit def make(companion: Slideshow.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
