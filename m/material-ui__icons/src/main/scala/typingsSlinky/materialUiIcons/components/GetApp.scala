...
import typingsSlinky.materialUiIcons.getAppMod.default
...
object GetApp {
  ...
  implicit def make(companion: GetApp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
