...
import typingsSlinky.materialUiIcons.editAttributesMod.default
...
object EditAttributes {
  ...
  implicit def make(companion: EditAttributes.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
