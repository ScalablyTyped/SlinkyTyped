...
import typingsSlinky.materialUiIcons.cardGiftcardMod.default
...
object CardGiftcard {
  ...
  implicit def make(companion: CardGiftcard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
