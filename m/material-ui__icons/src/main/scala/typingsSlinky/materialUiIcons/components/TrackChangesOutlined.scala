...
object TrackChangesOutlined {
  @JSImport("@material-ui/icons", "TrackChangesOutlined")
  @js.native
  ...
  implicit def make(companion: TrackChangesOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
