...
object CellWifiRounded {
  @JSImport("@material-ui/icons", "CellWifiRounded")
  @js.native
  ...
  implicit def make(companion: CellWifiRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
