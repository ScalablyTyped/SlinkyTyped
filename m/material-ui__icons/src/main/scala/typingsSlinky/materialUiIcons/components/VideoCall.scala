...
import typingsSlinky.materialUiIcons.videoCallMod.default
...
object VideoCall {
  ...
  implicit def make(companion: VideoCall.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
