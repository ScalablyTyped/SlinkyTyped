...
import typingsSlinky.materialUiIcons.directionsRailwayMod.default
...
object DirectionsRailway {
  ...
  implicit def make(companion: DirectionsRailway.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
