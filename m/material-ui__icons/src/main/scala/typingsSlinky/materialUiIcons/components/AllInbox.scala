...
import typingsSlinky.materialUiIcons.allInboxMod.default
...
object AllInbox {
  ...
  implicit def make(companion: AllInbox.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
