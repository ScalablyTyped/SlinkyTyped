...
import typingsSlinky.materialUiIcons.settingsOverscanMod.default
...
object SettingsOverscan {
  ...
  implicit def make(companion: SettingsOverscan.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
