...
object SettingsOverscan {
  ...
  @JSImport("@material-ui/icons", "SettingsOverscan")
  @js.native
  ...
  implicit def make(companion: SettingsOverscan.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
