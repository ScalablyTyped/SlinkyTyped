...
import typingsSlinky.materialUiIcons.calendarTodayMod.default
...
object CalendarToday {
  ...
  implicit def make(companion: CalendarToday.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
