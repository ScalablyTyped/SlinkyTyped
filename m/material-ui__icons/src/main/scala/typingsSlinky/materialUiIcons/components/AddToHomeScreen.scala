...
object AddToHomeScreen {
  ...
  @JSImport("@material-ui/icons", "AddToHomeScreen")
  @js.native
  ...
  implicit def make(companion: AddToHomeScreen.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
