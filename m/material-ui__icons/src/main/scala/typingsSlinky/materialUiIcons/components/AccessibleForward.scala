...
import typingsSlinky.materialUiIcons.accessibleForwardMod.default
...
object AccessibleForward {
  ...
  implicit def make(companion: AccessibleForward.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
