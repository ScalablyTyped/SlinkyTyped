...
import typingsSlinky.materialUiIcons.formatShapesMod.default
...
object FormatShapes {
  ...
  implicit def make(companion: FormatShapes.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
