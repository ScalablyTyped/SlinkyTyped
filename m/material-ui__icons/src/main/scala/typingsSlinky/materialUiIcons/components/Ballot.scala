...
import typingsSlinky.materialUiIcons.ballotMod.default
...
object Ballot {
  ...
  implicit def make(companion: Ballot.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
