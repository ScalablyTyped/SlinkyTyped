...
import typingsSlinky.materialUiIcons.whereToVoteMod.default
...
object WhereToVote {
  ...
  implicit def make(companion: WhereToVote.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
