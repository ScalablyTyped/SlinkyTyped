...
object WhereToVote {
  ...
  @JSImport("@material-ui/icons", "WhereToVote")
  @js.native
  ...
  implicit def make(companion: WhereToVote.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
