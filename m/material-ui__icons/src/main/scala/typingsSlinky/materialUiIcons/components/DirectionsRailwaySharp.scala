...
object DirectionsRailwaySharp {
  ...
  @JSImport("@material-ui/icons", "DirectionsRailwaySharp")
  @js.native
  ...
  implicit def make(companion: DirectionsRailwaySharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
