...
object PublishTwoTone {
  ...
  @JSImport("@material-ui/icons", "PublishTwoTone")
  @js.native
  ...
  implicit def make(companion: PublishTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
