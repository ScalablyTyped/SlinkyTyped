...
object MobileOff {
  ...
  @JSImport("@material-ui/icons", "MobileOff")
  @js.native
  ...
  implicit def make(companion: MobileOff.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
