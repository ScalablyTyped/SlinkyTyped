...
import typingsSlinky.materialUiIcons.offlinePinMod.default
...
object OfflinePin {
  ...
  implicit def make(companion: OfflinePin.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
