...
import typingsSlinky.materialUiIcons.formatUnderlinedMod.default
...
object FormatUnderlined {
  ...
  implicit def make(companion: FormatUnderlined.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
