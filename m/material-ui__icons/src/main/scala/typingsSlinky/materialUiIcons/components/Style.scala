...
import typingsSlinky.materialUiIcons.styleMod.default
...
object Style {
  ...
  implicit def make(companion: Style.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
