...
import typingsSlinky.materialUiIcons.cropPortraitMod.default
...
object CropPortrait {
  ...
  implicit def make(companion: CropPortrait.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
