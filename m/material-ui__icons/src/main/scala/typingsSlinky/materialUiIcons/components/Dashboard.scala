...
import typingsSlinky.materialUiIcons.dashboardMod.default
...
object Dashboard {
  ...
  implicit def make(companion: Dashboard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
