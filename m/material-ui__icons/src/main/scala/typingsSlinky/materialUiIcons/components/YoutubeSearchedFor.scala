...
import typingsSlinky.materialUiIcons.youtubeSearchedForMod.default
...
object YoutubeSearchedFor {
  ...
  implicit def make(companion: YoutubeSearchedFor.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
