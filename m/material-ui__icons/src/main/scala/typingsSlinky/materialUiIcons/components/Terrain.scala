...
import typingsSlinky.materialUiIcons.terrainMod.default
...
object Terrain {
  ...
  implicit def make(companion: Terrain.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
