...
object SignalWifi1BarSharp {
  ...
  implicit def make(companion: SignalWifi1BarSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
