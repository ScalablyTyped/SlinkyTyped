...
import typingsSlinky.materialUiIcons.repeatMod.default
...
object Repeat {
  ...
  implicit def make(companion: Repeat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
