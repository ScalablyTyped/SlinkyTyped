...
import typingsSlinky.materialUiIcons.moneyMod.default
...
object Money {
  ...
  implicit def make(companion: Money.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
