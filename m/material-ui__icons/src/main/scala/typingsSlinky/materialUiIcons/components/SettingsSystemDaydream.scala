...
import typingsSlinky.materialUiIcons.settingsSystemDaydreamMod.default
...
object SettingsSystemDaydream {
  ...
  implicit def make(companion: SettingsSystemDaydream.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
