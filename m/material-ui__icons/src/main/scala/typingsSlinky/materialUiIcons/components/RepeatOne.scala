...
object RepeatOne {
  @JSImport("@material-ui/icons", "RepeatOne")
  @js.native
  ...
  implicit def make(companion: RepeatOne.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
