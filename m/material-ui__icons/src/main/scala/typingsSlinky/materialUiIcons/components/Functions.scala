...
import typingsSlinky.materialUiIcons.functionsMod.default
...
object Functions {
  ...
  implicit def make(companion: Functions.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
