...
import typingsSlinky.materialUiIcons.adbMod.default
...
object Adb {
  ...
  implicit def make(companion: Adb.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
