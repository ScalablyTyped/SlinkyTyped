...
import typingsSlinky.materialUiIcons.slowMotionVideoMod.default
...
object SlowMotionVideo {
  ...
  implicit def make(companion: SlowMotionVideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
