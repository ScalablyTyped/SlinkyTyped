...
import typingsSlinky.materialUiIcons.gradientMod.default
...
object Gradient {
  ...
  implicit def make(companion: Gradient.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
