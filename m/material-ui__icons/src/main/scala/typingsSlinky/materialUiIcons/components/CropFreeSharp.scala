...
object CropFreeSharp {
  @JSImport("@material-ui/icons", "CropFreeSharp")
  @js.native
  ...
  implicit def make(companion: CropFreeSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
