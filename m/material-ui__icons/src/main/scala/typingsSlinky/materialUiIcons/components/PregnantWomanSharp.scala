...
object PregnantWomanSharp {
  ...
  implicit def make(companion: PregnantWomanSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
