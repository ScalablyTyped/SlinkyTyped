...
import typingsSlinky.materialUiIcons.smsFailedMod.default
...
object SmsFailed {
  ...
  implicit def make(companion: SmsFailed.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
