...
import typingsSlinky.materialUiIcons.playArrowMod.default
...
object PlayArrow {
  ...
  implicit def make(companion: PlayArrow.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
