...
import typingsSlinky.materialUiIcons.queryBuilderMod.default
...
object QueryBuilder {
  ...
  implicit def make(companion: QueryBuilder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
