...
import typingsSlinky.materialUiIcons.keyboardReturnMod.default
...
object KeyboardReturn {
  ...
  implicit def make(companion: KeyboardReturn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
