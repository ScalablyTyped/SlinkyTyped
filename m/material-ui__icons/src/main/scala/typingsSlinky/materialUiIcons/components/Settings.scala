...
import typingsSlinky.materialUiIcons.settingsMod.default
...
object Settings {
  ...
  implicit def make(companion: Settings.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
