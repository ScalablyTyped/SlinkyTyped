...
import typingsSlinky.materialUiIcons.gridOnMod.default
...
object GridOn {
  ...
  implicit def make(companion: GridOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
