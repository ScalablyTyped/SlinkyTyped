...
import typingsSlinky.materialUiIcons.callMod.default
...
object Call {
  ...
  implicit def make(companion: Call.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
