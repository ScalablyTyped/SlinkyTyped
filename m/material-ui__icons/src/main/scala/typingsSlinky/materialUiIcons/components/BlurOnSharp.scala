...
object BlurOnSharp {
  @JSImport("@material-ui/icons", "BlurOnSharp")
  @js.native
  ...
  implicit def make(companion: BlurOnSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
