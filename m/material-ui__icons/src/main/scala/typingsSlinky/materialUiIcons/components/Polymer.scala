...
import typingsSlinky.materialUiIcons.polymerMod.default
...
object Polymer {
  ...
  implicit def make(companion: Polymer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
