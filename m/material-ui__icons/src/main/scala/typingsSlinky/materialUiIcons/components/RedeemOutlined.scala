...
object RedeemOutlined {
  ...
  @JSImport("@material-ui/icons", "RedeemOutlined")
  @js.native
  ...
  implicit def make(companion: RedeemOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
