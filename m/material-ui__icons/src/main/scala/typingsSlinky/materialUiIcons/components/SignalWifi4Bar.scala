...
import typingsSlinky.materialUiIcons.signalWifi4BarMod.default
...
object SignalWifi4Bar {
  ...
  implicit def make(companion: SignalWifi4Bar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
