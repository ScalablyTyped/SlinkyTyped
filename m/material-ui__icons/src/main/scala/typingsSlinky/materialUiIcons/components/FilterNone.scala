...
import typingsSlinky.materialUiIcons.filterNoneMod.default
...
object FilterNone {
  ...
  implicit def make(companion: FilterNone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
