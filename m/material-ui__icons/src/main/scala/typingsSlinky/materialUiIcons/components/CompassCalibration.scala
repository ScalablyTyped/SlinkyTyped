...
import typingsSlinky.materialUiIcons.compassCalibrationMod.default
...
object CompassCalibration {
  ...
  implicit def make(companion: CompassCalibration.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
