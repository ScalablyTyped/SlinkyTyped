...
object TheatersTwoTone {
  @JSImport("@material-ui/icons", "TheatersTwoTone")
  @js.native
  ...
  implicit def make(companion: TheatersTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
