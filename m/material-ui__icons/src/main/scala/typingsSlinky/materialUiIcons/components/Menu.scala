...
import typingsSlinky.materialUiIcons.menuMod.default
...
object Menu {
  ...
  implicit def make(companion: Menu.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
