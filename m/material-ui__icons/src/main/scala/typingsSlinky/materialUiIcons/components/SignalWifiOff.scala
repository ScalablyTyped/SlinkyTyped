...
import typingsSlinky.materialUiIcons.signalWifiOffMod.default
...
object SignalWifiOff {
  ...
  implicit def make(companion: SignalWifiOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
