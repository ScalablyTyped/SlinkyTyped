...
import typingsSlinky.materialUiIcons.whatshotMod.default
...
object Whatshot {
  ...
  implicit def make(companion: Whatshot.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
