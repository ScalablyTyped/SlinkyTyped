...
object VoiceOverOffSharp {
  ...
  @JSImport("@material-ui/icons", "VoiceOverOffSharp")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: VoiceOverOffSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
