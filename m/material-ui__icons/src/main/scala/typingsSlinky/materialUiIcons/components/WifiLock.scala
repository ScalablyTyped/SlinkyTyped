...
import typingsSlinky.materialUiIcons.wifiLockMod.default
...
object WifiLock {
  ...
  implicit def make(companion: WifiLock.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
