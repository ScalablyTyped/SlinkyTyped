...
import typingsSlinky.materialUiIcons.featuredVideoMod.default
...
object FeaturedVideo {
  ...
  implicit def make(companion: FeaturedVideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
