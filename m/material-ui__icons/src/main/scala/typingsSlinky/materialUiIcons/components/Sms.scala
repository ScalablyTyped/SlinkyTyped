...
import typingsSlinky.materialUiIcons.smsMod.default
...
object Sms {
  ...
  implicit def make(companion: Sms.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
