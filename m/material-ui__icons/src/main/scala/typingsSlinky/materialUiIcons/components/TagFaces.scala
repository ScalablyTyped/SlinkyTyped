...
import typingsSlinky.materialUiIcons.tagFacesMod.default
...
object TagFaces {
  ...
  implicit def make(companion: TagFaces.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
