...
import typingsSlinky.materialUiIcons.localAtmMod.default
...
object LocalAtm {
  ...
  implicit def make(companion: LocalAtm.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
