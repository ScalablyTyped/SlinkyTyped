...
import typingsSlinky.materialUiIcons.blurCircularMod.default
...
object BlurCircular {
  ...
  implicit def make(companion: BlurCircular.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
