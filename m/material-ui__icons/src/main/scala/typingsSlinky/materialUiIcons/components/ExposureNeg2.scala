...
import typingsSlinky.materialUiIcons.exposureNeg2Mod.default
...
object ExposureNeg2 {
  ...
  implicit def make(companion: ExposureNeg2.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
