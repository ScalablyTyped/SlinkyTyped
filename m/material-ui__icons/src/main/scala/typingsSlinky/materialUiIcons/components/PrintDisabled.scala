...
import typingsSlinky.materialUiIcons.printDisabledMod.default
...
object PrintDisabled {
  ...
  implicit def make(companion: PrintDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
