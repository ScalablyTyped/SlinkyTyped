...
import typingsSlinky.materialUiIcons.flashAutoMod.default
...
object FlashAuto {
  ...
  implicit def make(companion: FlashAuto.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
