...
import typingsSlinky.materialUiIcons.fiberNewMod.default
...
object FiberNew {
  ...
  implicit def make(companion: FiberNew.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
