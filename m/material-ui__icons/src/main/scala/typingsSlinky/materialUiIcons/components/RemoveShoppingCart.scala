...
object RemoveShoppingCart {
  ...
  @JSImport("@material-ui/icons", "RemoveShoppingCart")
  @js.native
  ...
  implicit def make(companion: RemoveShoppingCart.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
