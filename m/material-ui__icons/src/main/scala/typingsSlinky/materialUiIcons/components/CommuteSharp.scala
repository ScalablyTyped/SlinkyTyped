...
object CommuteSharp {
  @JSImport("@material-ui/icons", "CommuteSharp")
  @js.native
  ...
  implicit def make(companion: CommuteSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
