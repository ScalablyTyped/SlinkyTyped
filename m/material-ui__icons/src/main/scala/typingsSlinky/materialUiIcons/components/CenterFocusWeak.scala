...
import typingsSlinky.materialUiIcons.centerFocusWeakMod.default
...
object CenterFocusWeak {
  ...
  implicit def make(companion: CenterFocusWeak.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
