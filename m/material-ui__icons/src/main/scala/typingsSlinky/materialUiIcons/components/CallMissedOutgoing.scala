...
import typingsSlinky.materialUiIcons.callMissedOutgoingMod.default
...
object CallMissedOutgoing {
  ...
  implicit def make(companion: CallMissedOutgoing.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
