...
import typingsSlinky.materialUiIcons.exposurePlus1Mod.default
...
object ExposurePlus1 {
  ...
  implicit def make(companion: ExposurePlus1.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
