...
import typingsSlinky.materialUiIcons.donutLargeMod.default
...
object DonutLarge {
  ...
  implicit def make(companion: DonutLarge.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
