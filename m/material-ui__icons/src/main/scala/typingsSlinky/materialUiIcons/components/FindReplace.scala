...
import typingsSlinky.materialUiIcons.findReplaceMod.default
...
object FindReplace {
  ...
  implicit def make(companion: FindReplace.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
