...
object PlaylistAddRounded {
  ...
  @JSImport("@material-ui/icons", "PlaylistAddRounded")
  @js.native
  ...
  implicit def make(companion: PlaylistAddRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
