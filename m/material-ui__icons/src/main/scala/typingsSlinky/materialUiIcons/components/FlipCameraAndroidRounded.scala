...
object FlipCameraAndroidRounded {
  @JSImport("@material-ui/icons", "FlipCameraAndroidRounded")
  @js.native
  ...
  implicit def make(companion: FlipCameraAndroidRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
