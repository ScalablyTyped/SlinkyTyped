...
import typingsSlinky.materialUiIcons.tvOffMod.default
...
object TvOff {
  ...
  implicit def make(companion: TvOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
