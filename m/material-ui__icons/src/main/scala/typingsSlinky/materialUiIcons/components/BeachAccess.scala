...
object BeachAccess {
  @JSImport("@material-ui/icons", "BeachAccess")
  @js.native
  ...
  implicit def make(companion: BeachAccess.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
