...
import typingsSlinky.materialUiIcons.childCareMod.default
...
object ChildCare {
  ...
  implicit def make(companion: ChildCare.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
