...
import typingsSlinky.materialUiIcons.enhancedEncryptionMod.default
...
object EnhancedEncryption {
  ...
  implicit def make(companion: EnhancedEncryption.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
