...
import typingsSlinky.materialUiIcons.launchMod.default
...
object Launch {
  ...
  implicit def make(companion: Launch.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
