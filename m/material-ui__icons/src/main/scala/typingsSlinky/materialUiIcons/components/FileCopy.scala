...
import typingsSlinky.materialUiIcons.fileCopyMod.default
...
object FileCopy {
  ...
  implicit def make(companion: FileCopy.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
