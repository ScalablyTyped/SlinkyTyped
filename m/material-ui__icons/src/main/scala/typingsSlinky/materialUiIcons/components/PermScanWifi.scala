...
import typingsSlinky.materialUiIcons.permScanWifiMod.default
...
object PermScanWifi {
  ...
  implicit def make(companion: PermScanWifi.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
