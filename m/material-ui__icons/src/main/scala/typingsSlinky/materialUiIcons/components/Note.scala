...
import typingsSlinky.materialUiIcons.noteMod.default
...
object Note {
  ...
  implicit def make(companion: Note.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
