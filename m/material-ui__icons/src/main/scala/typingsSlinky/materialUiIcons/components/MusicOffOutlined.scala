...
object MusicOffOutlined {
  ...
  @JSImport("@material-ui/icons", "MusicOffOutlined")
  @js.native
  ...
  implicit def make(companion: MusicOffOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
