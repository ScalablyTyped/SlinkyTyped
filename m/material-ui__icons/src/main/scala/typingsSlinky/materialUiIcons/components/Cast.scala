...
import typingsSlinky.materialUiIcons.castMod.default
...
object Cast {
  ...
  implicit def make(companion: Cast.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
