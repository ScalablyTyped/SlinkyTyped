...
import typingsSlinky.materialUiIcons.deleteOutlineMod.default
...
object DeleteOutline {
  ...
  implicit def make(companion: DeleteOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
