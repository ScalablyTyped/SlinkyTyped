...
import typingsSlinky.materialUiIcons.textFieldsMod.default
...
object TextFields {
  ...
  implicit def make(companion: TextFields.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
