...
object Filter4TwoTone {
  @JSImport("@material-ui/icons", "Filter4TwoTone")
  @js.native
  ...
  implicit def make(companion: Filter4TwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
