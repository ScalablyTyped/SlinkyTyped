...
import typingsSlinky.materialUiIcons.addAlarmMod.default
...
object AddAlarm {
  ...
  implicit def make(companion: AddAlarm.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
