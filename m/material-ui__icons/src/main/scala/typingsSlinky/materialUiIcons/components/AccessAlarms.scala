...
import typingsSlinky.materialUiIcons.accessAlarmsMod.default
...
object AccessAlarms {
  ...
  implicit def make(companion: AccessAlarms.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
