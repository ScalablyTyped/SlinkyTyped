...
import typingsSlinky.materialUiIcons.screenLockLandscapeMod.default
...
object ScreenLockLandscape {
  ...
  implicit def make(companion: ScreenLockLandscape.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
