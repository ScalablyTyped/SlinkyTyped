...
object ScreenLockLandscape {
  @JSImport("@material-ui/icons", "ScreenLockLandscape")
  @js.native
  ...
  implicit def make(companion: ScreenLockLandscape.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
