...
import typingsSlinky.materialUiIcons.casinoTwoToneMod.default
...
object CasinoTwoTone {
  ...
  implicit def make(companion: CasinoTwoTone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
