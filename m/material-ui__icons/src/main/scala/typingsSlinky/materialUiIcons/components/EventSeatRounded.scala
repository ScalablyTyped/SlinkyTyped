...
object EventSeatRounded {
  @JSImport("@material-ui/icons", "EventSeatRounded")
  @js.native
  ...
  implicit def make(companion: EventSeatRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
