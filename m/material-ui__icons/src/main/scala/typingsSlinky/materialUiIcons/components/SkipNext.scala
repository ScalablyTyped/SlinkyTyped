...
import typingsSlinky.materialUiIcons.skipNextMod.default
...
object SkipNext {
  ...
  implicit def make(companion: SkipNext.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
