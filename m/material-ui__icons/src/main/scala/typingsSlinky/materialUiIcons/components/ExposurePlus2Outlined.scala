...
object ExposurePlus2Outlined {
  ...
  implicit def make(companion: ExposurePlus2Outlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
