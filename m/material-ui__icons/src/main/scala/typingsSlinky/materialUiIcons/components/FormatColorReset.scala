...
import typingsSlinky.materialUiIcons.formatColorResetMod.default
...
object FormatColorReset {
  ...
  implicit def make(companion: FormatColorReset.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
