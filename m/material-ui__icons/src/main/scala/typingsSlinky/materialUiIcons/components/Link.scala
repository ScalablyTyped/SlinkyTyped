...
import typingsSlinky.materialUiIcons.linkMod.default
...
object Link {
  ...
  implicit def make(companion: Link.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
