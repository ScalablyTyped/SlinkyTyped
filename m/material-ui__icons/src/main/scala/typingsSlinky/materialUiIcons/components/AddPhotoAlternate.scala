...
import typingsSlinky.materialUiIcons.addPhotoAlternateMod.default
...
object AddPhotoAlternate {
  ...
  implicit def make(companion: AddPhotoAlternate.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
