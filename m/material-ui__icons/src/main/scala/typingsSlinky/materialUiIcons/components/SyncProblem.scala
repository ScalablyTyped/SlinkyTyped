...
import typingsSlinky.materialUiIcons.syncProblemMod.default
...
object SyncProblem {
  ...
  implicit def make(companion: SyncProblem.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
