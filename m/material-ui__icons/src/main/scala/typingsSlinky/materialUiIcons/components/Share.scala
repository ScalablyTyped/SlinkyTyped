...
import typingsSlinky.materialUiIcons.shareMod.default
...
object Share {
  ...
  implicit def make(companion: Share.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
