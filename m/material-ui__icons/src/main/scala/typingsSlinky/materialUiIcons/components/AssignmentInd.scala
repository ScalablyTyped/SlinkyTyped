...
import typingsSlinky.materialUiIcons.assignmentIndMod.default
...
object AssignmentInd {
  ...
  implicit def make(companion: AssignmentInd.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
