...
import typingsSlinky.materialUiIcons.movieMod.default
...
object Movie {
  ...
  implicit def make(companion: Movie.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
