...
object UnarchiveOutlined {
  ...
  @JSImport("@material-ui/icons", "UnarchiveOutlined")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UnarchiveOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
