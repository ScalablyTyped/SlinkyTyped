...
import typingsSlinky.materialUiIcons.bluetoothAudioMod.default
...
object BluetoothAudio {
  ...
  implicit def make(companion: BluetoothAudio.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
