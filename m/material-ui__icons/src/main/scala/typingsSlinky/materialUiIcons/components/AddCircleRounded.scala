...
object AddCircleRounded {
  @JSImport("@material-ui/icons/AddCircleRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AddCircleRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
