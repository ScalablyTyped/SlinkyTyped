...
object ChangeHistoryTwoTone {
  @JSImport("@material-ui/icons/ChangeHistoryTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ChangeHistoryTwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
