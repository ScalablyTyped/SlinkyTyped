...
import typingsSlinky.materialUiIcons.equalizerMod.default
...
object Equalizer {
  ...
  implicit def make(companion: Equalizer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
