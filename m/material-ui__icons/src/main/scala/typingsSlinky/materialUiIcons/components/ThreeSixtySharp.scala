...
object ThreeSixtySharp {
  @JSImport("@material-ui/icons/ThreeSixtySharp", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ThreeSixtySharp.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
