...
import typingsSlinky.materialUiIcons.replyAllMod.default
...
object ReplyAll {
  ...
  implicit def make(companion: ReplyAll.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
