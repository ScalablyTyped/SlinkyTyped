...
import typingsSlinky.materialUiIcons.textsmsMod.default
...
object Textsms {
  ...
  implicit def make(companion: Textsms.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
