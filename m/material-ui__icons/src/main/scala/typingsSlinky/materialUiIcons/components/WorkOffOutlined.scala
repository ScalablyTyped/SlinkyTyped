...
object WorkOffOutlined {
  
  @JSImport("@material-ui/icons", "WorkOffOutlined")
  @js.native
  ...
  implicit def make(companion: WorkOffOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
