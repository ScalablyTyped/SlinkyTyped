...
import typingsSlinky.materialUiIcons.airlineSeatReclineExtraMod.default
...
object AirlineSeatReclineExtra {
  ...
  implicit def make(companion: AirlineSeatReclineExtra.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
