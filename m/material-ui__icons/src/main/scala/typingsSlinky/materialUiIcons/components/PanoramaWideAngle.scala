...
import typingsSlinky.materialUiIcons.panoramaWideAngleMod.default
...
object PanoramaWideAngle {
  ...
  implicit def make(companion: PanoramaWideAngle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
