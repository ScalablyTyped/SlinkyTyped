...
object VolumeUpOutlined {
  @JSImport("@material-ui/icons/VolumeUpOutlined", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: VolumeUpOutlined.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
