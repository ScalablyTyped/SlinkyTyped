...
import typingsSlinky.materialUiIcons.shortTextMod.default
...
object ShortText {
  ...
  implicit def make(companion: ShortText.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
