...
import typingsSlinky.materialUiIcons.gestureMod.default
...
object Gesture {
  ...
  implicit def make(companion: Gesture.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
