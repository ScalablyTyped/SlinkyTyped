...
import typingsSlinky.materialUiIcons.listAltMod.default
...
object ListAlt {
  ...
  implicit def make(companion: ListAlt.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
