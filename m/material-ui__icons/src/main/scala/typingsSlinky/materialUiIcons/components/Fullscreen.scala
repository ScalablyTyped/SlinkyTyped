...
import typingsSlinky.materialUiIcons.fullscreenMod.default
...
object Fullscreen {
  ...
  implicit def make(companion: Fullscreen.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
