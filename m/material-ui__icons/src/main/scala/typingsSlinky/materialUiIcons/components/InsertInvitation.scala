...
object InsertInvitation {
  ...
  @JSImport("@material-ui/icons", "InsertInvitation")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: InsertInvitation.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
