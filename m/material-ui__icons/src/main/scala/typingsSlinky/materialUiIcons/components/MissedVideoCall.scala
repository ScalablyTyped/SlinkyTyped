...
import typingsSlinky.materialUiIcons.missedVideoCallMod.default
...
object MissedVideoCall {
  ...
  implicit def make(companion: MissedVideoCall.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
