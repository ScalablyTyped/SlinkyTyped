...
object MissedVideoCall {
  @JSImport("@material-ui/icons", "MissedVideoCall")
  @js.native
  ...
  implicit def make(companion: MissedVideoCall.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
