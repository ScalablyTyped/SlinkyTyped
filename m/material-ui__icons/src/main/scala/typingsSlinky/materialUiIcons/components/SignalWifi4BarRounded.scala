...
object SignalWifi4BarRounded {
  ...
  implicit def make(companion: SignalWifi4BarRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
