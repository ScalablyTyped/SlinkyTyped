...
object FilterDramaSharp {
  @JSImport("@material-ui/icons", "FilterDramaSharp")
  @js.native
  ...
  implicit def make(companion: FilterDramaSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
