...
import typingsSlinky.materialUiIcons.signalWifi4BarLockMod.default
...
object SignalWifi4BarLock {
  ...
  implicit def make(companion: SignalWifi4BarLock.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
