...
object SignalWifi4BarLock {
  ...
  implicit def make(companion: SignalWifi4BarLock.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
