...
import typingsSlinky.materialUiIcons.burstModeMod.default
...
object BurstMode {
  ...
  implicit def make(companion: BurstMode.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
