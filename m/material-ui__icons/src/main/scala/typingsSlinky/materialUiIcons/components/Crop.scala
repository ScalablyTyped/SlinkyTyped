...
import typingsSlinky.materialUiIcons.cropMod.default
...
object Crop {
  ...
  implicit def make(companion: Crop.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
