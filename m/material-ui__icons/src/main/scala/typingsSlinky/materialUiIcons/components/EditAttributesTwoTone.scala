...
object EditAttributesTwoTone {
  ...
  @JSImport("@material-ui/icons", "EditAttributesTwoTone")
  @js.native
  ...
  implicit def make(companion: EditAttributesTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
