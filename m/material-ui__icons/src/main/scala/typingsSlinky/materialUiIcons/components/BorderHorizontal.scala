...
import typingsSlinky.materialUiIcons.borderHorizontalMod.default
...
object BorderHorizontal {
  ...
  implicit def make(companion: BorderHorizontal.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
