...
import typingsSlinky.materialUiIcons.invertColorsOffMod.default
...
object InvertColorsOff {
  ...
  implicit def make(companion: InvertColorsOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
