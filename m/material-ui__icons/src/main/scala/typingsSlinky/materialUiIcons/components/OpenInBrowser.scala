...
import typingsSlinky.materialUiIcons.openInBrowserMod.default
...
object OpenInBrowser {
  ...
  implicit def make(companion: OpenInBrowser.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
