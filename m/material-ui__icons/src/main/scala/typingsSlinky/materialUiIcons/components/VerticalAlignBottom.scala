...
import typingsSlinky.materialUiIcons.verticalAlignBottomMod.default
...
object VerticalAlignBottom {
  ...
  implicit def make(companion: VerticalAlignBottom.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
