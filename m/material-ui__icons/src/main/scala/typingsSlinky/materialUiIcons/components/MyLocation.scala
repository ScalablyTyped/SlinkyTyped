...
import typingsSlinky.materialUiIcons.myLocationMod.default
...
object MyLocation {
  ...
  implicit def make(companion: MyLocation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
