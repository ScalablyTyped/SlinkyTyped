...
import typingsSlinky.materialUiIcons.formatListNumberedRtlMod.default
...
object FormatListNumberedRtl {
  ...
  implicit def make(companion: FormatListNumberedRtl.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
