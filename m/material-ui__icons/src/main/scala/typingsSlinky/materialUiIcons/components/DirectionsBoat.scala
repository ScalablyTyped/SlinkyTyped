...
import typingsSlinky.materialUiIcons.directionsBoatMod.default
...
object DirectionsBoat {
  ...
  implicit def make(companion: DirectionsBoat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
