...
import typingsSlinky.materialUiIcons.pagesMod.default
...
object Pages {
  ...
  implicit def make(companion: Pages.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
