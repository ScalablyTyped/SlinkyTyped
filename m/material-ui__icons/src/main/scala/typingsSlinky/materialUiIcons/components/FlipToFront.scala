...
import typingsSlinky.materialUiIcons.flipToFrontMod.default
...
object FlipToFront {
  ...
  implicit def make(companion: FlipToFront.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
