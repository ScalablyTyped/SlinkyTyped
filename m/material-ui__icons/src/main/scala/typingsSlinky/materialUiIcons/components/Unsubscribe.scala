...
import typingsSlinky.materialUiIcons.unsubscribeMod.default
...
object Unsubscribe {
  ...
  implicit def make(companion: Unsubscribe.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
