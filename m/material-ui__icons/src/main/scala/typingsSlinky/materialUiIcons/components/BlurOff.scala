...
import typingsSlinky.materialUiIcons.blurOffMod.default
...
object BlurOff {
  ...
  implicit def make(companion: BlurOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
