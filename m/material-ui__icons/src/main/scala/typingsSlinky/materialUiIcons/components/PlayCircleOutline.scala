...
import typingsSlinky.materialUiIcons.playCircleOutlineMod.default
...
object PlayCircleOutline {
  ...
  implicit def make(companion: PlayCircleOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
