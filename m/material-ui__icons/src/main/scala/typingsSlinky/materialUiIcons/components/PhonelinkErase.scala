...
import typingsSlinky.materialUiIcons.phonelinkEraseMod.default
...
object PhonelinkErase {
  ...
  implicit def make(companion: PhonelinkErase.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
