...
import typingsSlinky.materialUiIcons.expandMoreMod.default
...
object ExpandMore {
  ...
  implicit def make(companion: ExpandMore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
