...
import typingsSlinky.materialUiIcons.maximizeMod.default
...
object Maximize {
  ...
  implicit def make(companion: Maximize.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
