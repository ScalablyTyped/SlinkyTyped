...
import typingsSlinky.materialUiIcons.pauseOutlinedMod.default
...
object PauseOutlined {
  ...
  implicit def make(companion: PauseOutlined.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
