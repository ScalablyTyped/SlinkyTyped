...
import typingsSlinky.materialUiIcons.stayPrimaryPortraitMod.default
...
object StayPrimaryPortrait {
  ...
  implicit def make(companion: StayPrimaryPortrait.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
