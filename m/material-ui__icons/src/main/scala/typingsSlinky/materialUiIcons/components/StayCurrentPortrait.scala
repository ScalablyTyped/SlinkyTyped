...
import typingsSlinky.materialUiIcons.stayCurrentPortraitMod.default
...
object StayCurrentPortrait {
  ...
  implicit def make(companion: StayCurrentPortrait.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
