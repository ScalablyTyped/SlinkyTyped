...
object FavoriteTwoTone {
  @JSImport("@material-ui/icons", "FavoriteTwoTone")
  @js.native
  ...
  implicit def make(companion: FavoriteTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
