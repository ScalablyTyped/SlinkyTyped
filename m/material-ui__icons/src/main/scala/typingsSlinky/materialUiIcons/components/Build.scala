...
import typingsSlinky.materialUiIcons.buildMod.default
...
object Build {
  ...
  implicit def make(companion: Build.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
