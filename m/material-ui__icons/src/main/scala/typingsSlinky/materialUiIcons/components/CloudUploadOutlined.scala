...
object CloudUploadOutlined {
  @JSImport("@material-ui/icons", "CloudUploadOutlined")
  @js.native
  ...
  implicit def make(companion: CloudUploadOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
