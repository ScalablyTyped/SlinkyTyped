...
import typingsSlinky.materialUiIcons.blurLinearRoundedMod.default
...
object BlurLinearRounded {
  ...
  implicit def make(companion: BlurLinearRounded.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
