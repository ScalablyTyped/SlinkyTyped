...
import typingsSlinky.materialUiIcons.bluetoothConnectedMod.default
...
object BluetoothConnected {
  ...
  implicit def make(companion: BluetoothConnected.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
