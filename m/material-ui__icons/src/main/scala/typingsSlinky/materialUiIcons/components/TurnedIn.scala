...
import typingsSlinky.materialUiIcons.turnedInMod.default
...
object TurnedIn {
  ...
  implicit def make(companion: TurnedIn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
