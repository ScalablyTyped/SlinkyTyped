...
object AirlineSeatLegroomExtraSharp {
  ...
  implicit def make(companion: AirlineSeatLegroomExtraSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
