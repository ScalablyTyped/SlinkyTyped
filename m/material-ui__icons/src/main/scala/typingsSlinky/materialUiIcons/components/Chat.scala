...
import typingsSlinky.materialUiIcons.chatMod.default
...
object Chat {
  ...
  implicit def make(companion: Chat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
