...
object FilterTiltShift {
  ...
  @JSImport("@material-ui/icons", "FilterTiltShift")
  @js.native
  ...
  implicit def make(companion: FilterTiltShift.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
