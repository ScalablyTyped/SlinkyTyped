...
object BlurOffSharp {
  ...
  @JSImport("@material-ui/icons", "BlurOffSharp")
  @js.native
  ...
  implicit def make(companion: BlurOffSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
