...
import typingsSlinky.materialUiIcons.cameraMod.default
...
object Camera {
  ...
  implicit def make(companion: Camera.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
