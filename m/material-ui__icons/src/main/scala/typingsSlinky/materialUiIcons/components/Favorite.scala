...
import typingsSlinky.materialUiIcons.favoriteMod.default
...
object Favorite {
  ...
  implicit def make(companion: Favorite.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
