...
import typingsSlinky.materialUiIcons.pieChartMod.default
...
object PieChart {
  ...
  implicit def make(companion: PieChart.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
