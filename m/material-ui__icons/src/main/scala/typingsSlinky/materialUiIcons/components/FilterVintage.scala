...
object FilterVintage {
  ...
  @JSImport("@material-ui/icons", "FilterVintage")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FilterVintage.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
