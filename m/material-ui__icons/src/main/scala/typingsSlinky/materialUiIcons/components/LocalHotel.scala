...
import typingsSlinky.materialUiIcons.localHotelMod.default
...
object LocalHotel {
  ...
  implicit def make(companion: LocalHotel.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
