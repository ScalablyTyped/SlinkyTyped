...
import typingsSlinky.materialUiIcons.cloudUploadMod.default
...
object CloudUpload {
  ...
  implicit def make(companion: CloudUpload.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
