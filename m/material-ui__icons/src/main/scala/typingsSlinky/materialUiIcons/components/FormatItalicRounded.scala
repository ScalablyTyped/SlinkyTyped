...
object FormatItalicRounded {
  @JSImport("@material-ui/icons/FormatItalicRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FormatItalicRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
