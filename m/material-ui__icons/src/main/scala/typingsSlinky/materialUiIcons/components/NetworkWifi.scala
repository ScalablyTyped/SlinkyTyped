...
import typingsSlinky.materialUiIcons.networkWifiMod.default
...
object NetworkWifi {
  ...
  implicit def make(companion: NetworkWifi.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
