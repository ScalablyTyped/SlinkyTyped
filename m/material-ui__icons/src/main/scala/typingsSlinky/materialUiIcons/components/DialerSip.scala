...
import typingsSlinky.materialUiIcons.dialerSipMod.default
...
object DialerSip {
  ...
  implicit def make(companion: DialerSip.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
