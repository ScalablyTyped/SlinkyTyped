...
import typingsSlinky.materialUiIcons.locationDisabledMod.default
...
object LocationDisabled {
  ...
  implicit def make(companion: LocationDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
