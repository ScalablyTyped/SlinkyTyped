...
import typingsSlinky.materialUiIcons.markunreadMailboxMod.default
...
object MarkunreadMailbox {
  ...
  implicit def make(companion: MarkunreadMailbox.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
