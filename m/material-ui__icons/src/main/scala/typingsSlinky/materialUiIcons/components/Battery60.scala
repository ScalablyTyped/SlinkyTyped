...
import typingsSlinky.materialUiIcons.battery60Mod.default
...
object Battery60 {
  ...
  implicit def make(companion: Battery60.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
