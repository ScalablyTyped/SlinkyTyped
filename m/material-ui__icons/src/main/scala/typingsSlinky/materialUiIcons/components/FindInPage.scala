...
import typingsSlinky.materialUiIcons.findInPageMod.default
...
object FindInPage {
  ...
  implicit def make(companion: FindInPage.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
