...
object CropOriginal {
  ...
  @JSImport("@material-ui/icons", "CropOriginal")
  @js.native
  ...
  implicit def make(companion: CropOriginal.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
