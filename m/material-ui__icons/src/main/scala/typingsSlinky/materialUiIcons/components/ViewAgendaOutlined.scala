...
object ViewAgendaOutlined {
  @JSImport("@material-ui/icons/ViewAgendaOutlined", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: ViewAgendaOutlined.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
