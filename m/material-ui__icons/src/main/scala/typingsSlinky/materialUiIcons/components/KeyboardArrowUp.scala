...
import typingsSlinky.materialUiIcons.keyboardArrowUpMod.default
...
object KeyboardArrowUp {
  ...
  implicit def make(companion: KeyboardArrowUp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
