...
import typingsSlinky.materialUiIcons.multilineChartMod.default
...
object MultilineChart {
  ...
  implicit def make(companion: MultilineChart.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
