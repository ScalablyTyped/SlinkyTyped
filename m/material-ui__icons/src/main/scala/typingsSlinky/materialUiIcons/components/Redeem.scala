...
import typingsSlinky.materialUiIcons.redeemMod.default
...
object Redeem {
  ...
  implicit def make(companion: Redeem.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
