...
import typingsSlinky.materialUiIcons.panoramaFishEyeMod.default
...
object PanoramaFishEye {
  ...
  implicit def make(companion: PanoramaFishEye.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
