...
import typingsSlinky.materialUiIcons.thumbsUpDownMod.default
...
object ThumbsUpDown {
  ...
  implicit def make(companion: ThumbsUpDown.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
