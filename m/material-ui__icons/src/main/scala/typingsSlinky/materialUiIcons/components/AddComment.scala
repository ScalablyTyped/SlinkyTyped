...
import typingsSlinky.materialUiIcons.addCommentMod.default
...
object AddComment {
  ...
  implicit def make(companion: AddComment.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
