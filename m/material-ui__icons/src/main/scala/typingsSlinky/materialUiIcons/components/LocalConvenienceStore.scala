...
import typingsSlinky.materialUiIcons.localConvenienceStoreMod.default
...
object LocalConvenienceStore {
  ...
  implicit def make(companion: LocalConvenienceStore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
