...
import typingsSlinky.materialUiIcons.directionsBusMod.default
...
object DirectionsBus {
  ...
  implicit def make(companion: DirectionsBus.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
