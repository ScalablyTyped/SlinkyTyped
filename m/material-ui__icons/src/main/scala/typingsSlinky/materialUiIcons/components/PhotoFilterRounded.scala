...
object PhotoFilterRounded {
  ...
  @JSImport("@material-ui/icons", "PhotoFilterRounded")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PhotoFilterRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
