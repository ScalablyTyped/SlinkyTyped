...
import typingsSlinky.materialUiIcons.personOutlineMod.default
...
object PersonOutline {
  ...
  implicit def make(companion: PersonOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
