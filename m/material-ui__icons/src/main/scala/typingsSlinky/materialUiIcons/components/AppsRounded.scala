...
object AppsRounded {
  ...
  @JSImport("@material-ui/icons", "AppsRounded")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AppsRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
