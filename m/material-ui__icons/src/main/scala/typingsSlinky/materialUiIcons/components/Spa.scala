...
import typingsSlinky.materialUiIcons.spaMod.default
...
object Spa {
  ...
  implicit def make(companion: Spa.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
