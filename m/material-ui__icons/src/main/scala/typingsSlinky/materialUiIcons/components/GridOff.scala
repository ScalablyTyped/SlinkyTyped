...
import typingsSlinky.materialUiIcons.gridOffMod.default
...
object GridOff {
  ...
  implicit def make(companion: GridOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
