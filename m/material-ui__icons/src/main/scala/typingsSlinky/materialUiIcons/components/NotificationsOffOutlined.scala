...
object NotificationsOffOutlined {
  ...
  @JSImport("@material-ui/icons", "NotificationsOffOutlined")
  @js.native
  ...
  implicit def make(companion: NotificationsOffOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
