...
object WarningTwoTone {
  ...
  @JSImport("@material-ui/icons", "WarningTwoTone")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WarningTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
