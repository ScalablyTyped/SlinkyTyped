...
import typingsSlinky.materialUiIcons.notListedLocationMod.default
...
object NotListedLocation {
  ...
  implicit def make(companion: NotListedLocation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
