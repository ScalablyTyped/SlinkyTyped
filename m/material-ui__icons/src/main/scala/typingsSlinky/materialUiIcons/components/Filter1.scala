...
import typingsSlinky.materialUiIcons.filter1Mod.default
...
object Filter1 {
  ...
  implicit def make(companion: Filter1.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
