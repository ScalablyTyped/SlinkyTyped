...
import typingsSlinky.materialUiIcons.localPharmacyMod.default
...
object LocalPharmacy {
  ...
  implicit def make(companion: LocalPharmacy.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
