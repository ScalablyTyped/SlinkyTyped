...
import typingsSlinky.materialUiIcons.alarmOnMod.default
...
object AlarmOn {
  ...
  implicit def make(companion: AlarmOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
