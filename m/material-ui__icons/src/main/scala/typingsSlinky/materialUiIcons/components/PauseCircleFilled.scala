...
import typingsSlinky.materialUiIcons.pauseCircleFilledMod.default
...
object PauseCircleFilled {
  ...
  implicit def make(companion: PauseCircleFilled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
