...
import typingsSlinky.materialUiIcons.subwayMod.default
...
object Subway {
  ...
  implicit def make(companion: Subway.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
