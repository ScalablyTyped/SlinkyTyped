...
object LocalDining {
  @JSImport("@material-ui/icons", "LocalDining")
  @js.native
  ...
  implicit def make(companion: LocalDining.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
