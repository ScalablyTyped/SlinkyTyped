...
import typingsSlinky.materialUiIcons.airlineSeatLegroomNormalMod.default
...
object AirlineSeatLegroomNormal {
  ...
  implicit def make(companion: AirlineSeatLegroomNormal.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
