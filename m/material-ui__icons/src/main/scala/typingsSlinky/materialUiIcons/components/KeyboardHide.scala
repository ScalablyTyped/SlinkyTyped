...
import typingsSlinky.materialUiIcons.keyboardHideMod.default
...
object KeyboardHide {
  ...
  implicit def make(companion: KeyboardHide.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
