...
import typingsSlinky.materialUiIcons.draftsMod.default
...
object Drafts {
  ...
  implicit def make(companion: Drafts.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
