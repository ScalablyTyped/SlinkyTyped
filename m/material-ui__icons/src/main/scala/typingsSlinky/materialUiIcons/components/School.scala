...
import typingsSlinky.materialUiIcons.schoolMod.default
...
object School {
  ...
  implicit def make(companion: School.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
