...
import typingsSlinky.materialUiIcons.todayMod.default
...
object Today {
  ...
  implicit def make(companion: Today.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
