...
object PaymentOutlined {
  @JSImport("@material-ui/icons", "PaymentOutlined")
  @js.native
  ...
  implicit def make(companion: PaymentOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
