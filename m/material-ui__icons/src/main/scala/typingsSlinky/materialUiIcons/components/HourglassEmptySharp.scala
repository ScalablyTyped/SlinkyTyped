...
import typingsSlinky.materialUiIcons.hourglassEmptySharpMod.default
...
object HourglassEmptySharp {
  ...
  implicit def make(companion: HourglassEmptySharp.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
