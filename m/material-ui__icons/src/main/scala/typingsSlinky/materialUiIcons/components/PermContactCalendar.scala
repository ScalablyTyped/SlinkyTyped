...
import typingsSlinky.materialUiIcons.permContactCalendarMod.default
...
object PermContactCalendar {
  ...
  implicit def make(companion: PermContactCalendar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
