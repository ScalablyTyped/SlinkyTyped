...
import typingsSlinky.materialUiIcons.alternateEmailMod.default
...
object AlternateEmail {
  ...
  implicit def make(companion: AlternateEmail.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
