...
import typingsSlinky.materialUiIcons.airportShuttleMod.default
...
object AirportShuttle {
  ...
  implicit def make(companion: AirportShuttle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
