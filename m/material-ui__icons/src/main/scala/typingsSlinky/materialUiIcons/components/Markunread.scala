...
import typingsSlinky.materialUiIcons.markunreadMod.default
...
object Markunread {
  ...
  implicit def make(companion: Markunread.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
