...
import typingsSlinky.materialUiIcons.inputMod.default
...
object Input {
  ...
  implicit def make(companion: Input.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
