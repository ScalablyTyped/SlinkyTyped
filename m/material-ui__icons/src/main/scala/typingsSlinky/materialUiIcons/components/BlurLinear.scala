...
import typingsSlinky.materialUiIcons.blurLinearMod.default
...
object BlurLinear {
  ...
  implicit def make(companion: BlurLinear.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
