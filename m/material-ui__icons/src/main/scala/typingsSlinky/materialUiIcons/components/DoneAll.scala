...
import typingsSlinky.materialUiIcons.doneAllMod.default
...
object DoneAll {
  ...
  implicit def make(companion: DoneAll.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
