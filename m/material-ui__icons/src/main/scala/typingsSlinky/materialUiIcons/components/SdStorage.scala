...
import typingsSlinky.materialUiIcons.sdStorageMod.default
...
object SdStorage {
  ...
  implicit def make(companion: SdStorage.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
