...
import typingsSlinky.materialUiIcons.fastRewindMod.default
...
object FastRewind {
  ...
  implicit def make(companion: FastRewind.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
