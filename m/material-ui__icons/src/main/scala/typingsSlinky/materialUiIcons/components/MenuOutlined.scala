...
object MenuOutlined {
  ...
  @JSImport("@material-ui/icons", "MenuOutlined")
  @js.native
  ...
  implicit def make(companion: MenuOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
