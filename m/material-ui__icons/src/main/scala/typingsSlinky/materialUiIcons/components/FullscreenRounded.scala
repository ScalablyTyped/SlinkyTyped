...
object FullscreenRounded {
  @JSImport("@material-ui/icons", "FullscreenRounded")
  @js.native
  ...
  implicit def make(companion: FullscreenRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
