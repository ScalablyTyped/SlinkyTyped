...
object AssistantSharp {
  @JSImport("@material-ui/icons", "AssistantSharp")
  @js.native
  ...
  implicit def make(companion: AssistantSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
