...
import typingsSlinky.materialUiIcons.storageMod.default
...
object Storage {
  ...
  implicit def make(companion: Storage.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
