...
import typingsSlinky.materialUiIcons.locationOnMod.default
...
object LocationOn {
  ...
  implicit def make(companion: LocationOn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
