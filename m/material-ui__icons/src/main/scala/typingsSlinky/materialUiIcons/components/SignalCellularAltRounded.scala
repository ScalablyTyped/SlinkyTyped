...
object SignalCellularAltRounded {
  @JSImport("@material-ui/icons", "SignalCellularAltRounded")
  @js.native
  ...
  implicit def make(companion: SignalCellularAltRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
