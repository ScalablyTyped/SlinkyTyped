...
import typingsSlinky.materialUiIcons.wavesMod.default
...
object Waves {
  ...
  implicit def make(companion: Waves.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
