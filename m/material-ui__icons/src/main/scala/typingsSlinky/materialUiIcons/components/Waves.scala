...
object Waves {
  ...
  @JSImport("@material-ui/icons", "Waves")
  @js.native
  ...
  implicit def make(companion: Waves.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
