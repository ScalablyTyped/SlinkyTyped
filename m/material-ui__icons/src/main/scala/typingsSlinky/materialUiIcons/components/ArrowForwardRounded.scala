...
import typingsSlinky.materialUiIcons.arrowForwardRoundedMod.default
...
object ArrowForwardRounded {
  ...
  implicit def make(companion: ArrowForwardRounded.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
