...
object FlipCameraIosTwoTone {
  @JSImport("@material-ui/icons/FlipCameraIosTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FlipCameraIosTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
