...
object NfcRounded {
  ...
  @JSImport("@material-ui/icons", "NfcRounded")
  @js.native
  ...
  implicit def make(companion: NfcRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
