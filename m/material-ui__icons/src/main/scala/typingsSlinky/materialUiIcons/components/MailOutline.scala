...
import typingsSlinky.materialUiIcons.mailOutlineMod.default
...
object MailOutline {
  ...
  implicit def make(companion: MailOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
