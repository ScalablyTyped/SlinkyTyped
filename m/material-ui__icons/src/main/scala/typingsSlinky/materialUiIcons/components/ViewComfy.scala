...
import typingsSlinky.materialUiIcons.viewComfyMod.default
...
object ViewComfy {
  ...
  implicit def make(companion: ViewComfy.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
