...
import typingsSlinky.materialUiIcons.moreVertMod.default
...
object MoreVert {
  ...
  implicit def make(companion: MoreVert.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
