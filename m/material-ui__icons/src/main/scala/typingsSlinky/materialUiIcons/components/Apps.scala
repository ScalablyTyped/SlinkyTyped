...
import typingsSlinky.materialUiIcons.appsMod.default
...
object Apps {
  ...
  implicit def make(companion: Apps.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
