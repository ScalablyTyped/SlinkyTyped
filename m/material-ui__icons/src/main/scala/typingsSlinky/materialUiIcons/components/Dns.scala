...
object Dns {
  ...
  @JSImport("@material-ui/icons", "Dns")
  @js.native
  ...
  implicit def make(companion: Dns.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
