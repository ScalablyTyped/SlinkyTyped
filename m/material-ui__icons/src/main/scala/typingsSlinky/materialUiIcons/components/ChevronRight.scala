...
import typingsSlinky.materialUiIcons.chevronRightMod.default
...
object ChevronRight {
  ...
  implicit def make(companion: ChevronRight.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
