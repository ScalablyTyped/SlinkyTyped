...
import typingsSlinky.materialUiIcons.petsMod.default
...
object Pets {
  ...
  implicit def make(companion: Pets.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
