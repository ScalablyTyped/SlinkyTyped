...
object CloudDoneRounded {
  @JSImport("@material-ui/icons", "CloudDoneRounded")
  @js.native
  ...
  implicit def make(companion: CloudDoneRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
