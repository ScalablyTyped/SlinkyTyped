...
import typingsSlinky.materialUiIcons.bluetoothSearchingMod.default
...
object BluetoothSearching {
  ...
  implicit def make(companion: BluetoothSearching.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
