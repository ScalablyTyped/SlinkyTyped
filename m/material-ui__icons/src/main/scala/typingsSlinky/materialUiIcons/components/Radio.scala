...
import typingsSlinky.materialUiIcons.radioMod.default
...
object Radio {
  ...
  implicit def make(companion: Radio.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
