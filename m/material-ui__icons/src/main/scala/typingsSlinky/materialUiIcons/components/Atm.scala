...
import typingsSlinky.materialUiIcons.atmMod.default
...
object Atm {
  ...
  implicit def make(companion: Atm.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
