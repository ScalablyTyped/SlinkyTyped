...
object Brightness4TwoTone {
  @JSImport("@material-ui/icons/Brightness4TwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Brightness4TwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
