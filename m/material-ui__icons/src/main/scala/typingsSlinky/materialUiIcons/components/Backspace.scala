...
import typingsSlinky.materialUiIcons.backspaceMod.default
...
object Backspace {
  ...
  implicit def make(companion: Backspace.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
