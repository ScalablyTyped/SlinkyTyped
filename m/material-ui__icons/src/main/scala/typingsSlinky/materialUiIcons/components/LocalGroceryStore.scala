...
import typingsSlinky.materialUiIcons.localGroceryStoreMod.default
...
object LocalGroceryStore {
  ...
  implicit def make(companion: LocalGroceryStore.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
