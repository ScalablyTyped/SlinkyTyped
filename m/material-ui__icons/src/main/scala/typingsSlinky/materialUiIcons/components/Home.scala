...
import typingsSlinky.materialUiIcons.homeMod.default
...
object Home {
  ...
  implicit def make(companion: Home.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
