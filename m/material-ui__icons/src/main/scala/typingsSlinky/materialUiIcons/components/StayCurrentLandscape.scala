...
import typingsSlinky.materialUiIcons.stayCurrentLandscapeMod.default
...
object StayCurrentLandscape {
  ...
  implicit def make(companion: StayCurrentLandscape.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
