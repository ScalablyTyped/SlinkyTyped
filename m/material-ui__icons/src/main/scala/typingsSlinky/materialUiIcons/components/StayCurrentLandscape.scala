...
object StayCurrentLandscape {
  @JSImport("@material-ui/icons", "StayCurrentLandscape")
  @js.native
  ...
  implicit def make(companion: StayCurrentLandscape.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
