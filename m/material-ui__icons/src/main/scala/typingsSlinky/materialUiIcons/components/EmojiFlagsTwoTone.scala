...
object EmojiFlagsTwoTone {
  @JSImport("@material-ui/icons/EmojiFlagsTwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: EmojiFlagsTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
