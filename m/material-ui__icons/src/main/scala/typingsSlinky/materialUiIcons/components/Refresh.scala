...
import typingsSlinky.materialUiIcons.refreshMod.default
...
object Refresh {
  ...
  implicit def make(companion: Refresh.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
