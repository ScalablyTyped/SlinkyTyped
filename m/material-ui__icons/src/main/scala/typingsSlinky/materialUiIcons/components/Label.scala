...
import typingsSlinky.materialUiIcons.labelMod.default
...
object Label {
  ...
  implicit def make(companion: Label.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
