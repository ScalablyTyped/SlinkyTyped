...
import typingsSlinky.materialUiIcons.assignmentReturnMod.default
...
object AssignmentReturn {
  ...
  implicit def make(companion: AssignmentReturn.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
