...
import typingsSlinky.materialUiIcons.compareArrowsMod.default
...
object CompareArrows {
  ...
  implicit def make(companion: CompareArrows.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
