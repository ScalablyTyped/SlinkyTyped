...
import typingsSlinky.materialUiIcons.publishMod.default
...
object Publish {
  ...
  implicit def make(companion: Publish.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
