...
import typingsSlinky.materialUiIcons.kitchenMod.default
...
object Kitchen {
  ...
  implicit def make(companion: Kitchen.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
