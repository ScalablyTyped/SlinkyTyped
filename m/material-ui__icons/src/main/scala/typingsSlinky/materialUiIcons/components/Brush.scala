...
import typingsSlinky.materialUiIcons.brushMod.default
...
object Brush {
  ...
  implicit def make(companion: Brush.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
