...
object ExtensionOutlined {
  @JSImport("@material-ui/icons", "ExtensionOutlined")
  @js.native
  ...
  implicit def make(companion: ExtensionOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
