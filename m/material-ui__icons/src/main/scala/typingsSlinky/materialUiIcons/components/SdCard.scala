...
import typingsSlinky.materialUiIcons.sdCardMod.default
...
object SdCard {
  ...
  implicit def make(companion: SdCard.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
