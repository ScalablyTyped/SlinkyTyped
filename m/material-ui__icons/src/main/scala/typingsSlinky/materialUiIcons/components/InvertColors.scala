...
import typingsSlinky.materialUiIcons.invertColorsMod.default
...
object InvertColors {
  ...
  implicit def make(companion: InvertColors.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
