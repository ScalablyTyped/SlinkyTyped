...
object CropDin {
  @JSImport("@material-ui/icons", "CropDin")
  @js.native
  ...
  implicit def make(companion: CropDin.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
