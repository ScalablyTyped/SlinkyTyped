...
import typingsSlinky.materialUiIcons.formatItalicMod.default
...
object FormatItalic {
  ...
  implicit def make(companion: FormatItalic.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
