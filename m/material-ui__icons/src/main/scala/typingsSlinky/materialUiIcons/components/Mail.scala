...
import typingsSlinky.materialUiIcons.mailMod.default
...
object Mail {
  ...
  implicit def make(companion: Mail.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
