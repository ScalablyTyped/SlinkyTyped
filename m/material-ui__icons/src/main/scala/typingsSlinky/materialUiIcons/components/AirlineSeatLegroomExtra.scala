...
import typingsSlinky.materialUiIcons.airlineSeatLegroomExtraMod.default
...
object AirlineSeatLegroomExtra {
  ...
  implicit def make(companion: AirlineSeatLegroomExtra.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
