...
object LayersOutlined {
  @JSImport("@material-ui/icons/LayersOutlined", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LayersOutlined.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
