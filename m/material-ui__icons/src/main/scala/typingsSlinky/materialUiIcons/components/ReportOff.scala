...
import typingsSlinky.materialUiIcons.reportOffMod.default
...
object ReportOff {
  ...
  implicit def make(companion: ReportOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
