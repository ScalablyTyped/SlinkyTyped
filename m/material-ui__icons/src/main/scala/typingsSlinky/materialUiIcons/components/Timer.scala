...
import typingsSlinky.materialUiIcons.timerMod.default
...
object Timer {
  ...
  implicit def make(companion: Timer.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
