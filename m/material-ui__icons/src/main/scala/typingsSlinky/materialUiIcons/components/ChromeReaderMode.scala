...
import typingsSlinky.materialUiIcons.chromeReaderModeMod.default
...
object ChromeReaderMode {
  ...
  implicit def make(companion: ChromeReaderMode.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
