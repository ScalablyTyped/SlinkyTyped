...
object SettingsInputAntenna {
  ...
  @JSImport("@material-ui/icons", "SettingsInputAntenna")
  @js.native
  ...
  implicit def make(companion: SettingsInputAntenna.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
