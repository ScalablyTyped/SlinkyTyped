...
import typingsSlinky.materialUiIcons.settingsInputAntennaMod.default
...
object SettingsInputAntenna {
  ...
  implicit def make(companion: SettingsInputAntenna.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
