...
object ChatBubbleSharp {
  ...
  @JSImport("@material-ui/icons", "ChatBubbleSharp")
  @js.native
  ...
  implicit def make(companion: ChatBubbleSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
