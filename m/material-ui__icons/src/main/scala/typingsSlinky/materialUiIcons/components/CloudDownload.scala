...
import typingsSlinky.materialUiIcons.cloudDownloadMod.default
...
object CloudDownload {
  ...
  implicit def make(companion: CloudDownload.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
