...
import typingsSlinky.materialUiIcons.attachMoneyMod.default
...
object AttachMoney {
  ...
  implicit def make(companion: AttachMoney.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
