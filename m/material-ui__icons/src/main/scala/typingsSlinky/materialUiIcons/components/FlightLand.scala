...
import typingsSlinky.materialUiIcons.flightLandMod.default
...
object FlightLand {
  ...
  implicit def make(companion: FlightLand.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
