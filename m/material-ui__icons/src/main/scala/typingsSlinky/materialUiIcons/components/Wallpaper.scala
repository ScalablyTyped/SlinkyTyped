...
import typingsSlinky.materialUiIcons.wallpaperMod.default
...
object Wallpaper {
  ...
  implicit def make(companion: Wallpaper.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
