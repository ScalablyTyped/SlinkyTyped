...
object OutdoorGrillRounded {
  ...
  implicit def make(companion: OutdoorGrillRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
