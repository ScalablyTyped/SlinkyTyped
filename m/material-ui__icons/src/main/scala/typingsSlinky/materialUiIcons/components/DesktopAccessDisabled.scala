...
import typingsSlinky.materialUiIcons.desktopAccessDisabledMod.default
...
object DesktopAccessDisabled {
  ...
  implicit def make(companion: DesktopAccessDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
