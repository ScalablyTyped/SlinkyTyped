...
import typingsSlinky.materialUiIcons.swapVerticalCircleMod.default
...
object SwapVerticalCircle {
  ...
  implicit def make(companion: SwapVerticalCircle.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
