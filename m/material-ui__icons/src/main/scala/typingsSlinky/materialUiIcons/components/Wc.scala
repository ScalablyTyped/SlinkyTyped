...
import typingsSlinky.materialUiIcons.wcMod.default
...
object Wc {
  ...
  implicit def make(companion: Wc.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
