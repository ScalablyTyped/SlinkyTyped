...
object StrikethroughS {
  @JSImport("@material-ui/icons", "StrikethroughS")
  @js.native
  ...
  implicit def make(companion: StrikethroughS.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
