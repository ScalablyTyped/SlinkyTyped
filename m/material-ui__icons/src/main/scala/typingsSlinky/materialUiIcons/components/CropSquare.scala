...
import typingsSlinky.materialUiIcons.cropSquareMod.default
...
object CropSquare {
  ...
  implicit def make(companion: CropSquare.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
