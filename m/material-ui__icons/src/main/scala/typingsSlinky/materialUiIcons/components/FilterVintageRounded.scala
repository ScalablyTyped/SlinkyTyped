...
object FilterVintageRounded {
  @JSImport("@material-ui/icons/FilterVintageRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: FilterVintageRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
