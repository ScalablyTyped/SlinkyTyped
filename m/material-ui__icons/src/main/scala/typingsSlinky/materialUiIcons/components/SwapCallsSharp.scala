...
object SwapCallsSharp {
  @JSImport("@material-ui/icons", "SwapCallsSharp")
  @js.native
  ...
  implicit def make(companion: SwapCallsSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
