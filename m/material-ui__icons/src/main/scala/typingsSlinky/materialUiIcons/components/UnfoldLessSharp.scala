...
object UnfoldLessSharp {
  ...
  @JSImport("@material-ui/icons", "UnfoldLessSharp")
  @js.native
  ...
  implicit def make(companion: UnfoldLessSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
