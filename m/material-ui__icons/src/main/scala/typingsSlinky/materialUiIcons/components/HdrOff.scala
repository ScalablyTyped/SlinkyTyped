...
import typingsSlinky.materialUiIcons.hdrOffMod.default
...
object HdrOff {
  ...
  implicit def make(companion: HdrOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
