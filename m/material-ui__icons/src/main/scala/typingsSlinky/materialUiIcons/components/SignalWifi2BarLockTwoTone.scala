...
object SignalWifi2BarLockTwoTone {
  ...
  implicit def make(companion: SignalWifi2BarLockTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
