...
object SwapHorizRounded {
  @JSImport("@material-ui/icons/SwapHorizRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SwapHorizRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
