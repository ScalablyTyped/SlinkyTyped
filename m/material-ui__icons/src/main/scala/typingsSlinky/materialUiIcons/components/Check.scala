...
import typingsSlinky.materialUiIcons.checkMod.default
...
object Check {
  ...
  implicit def make(companion: Check.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
