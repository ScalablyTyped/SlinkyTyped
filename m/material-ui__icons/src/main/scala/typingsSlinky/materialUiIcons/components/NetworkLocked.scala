...
import typingsSlinky.materialUiIcons.networkLockedMod.default
...
object NetworkLocked {
  ...
  implicit def make(companion: NetworkLocked.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
