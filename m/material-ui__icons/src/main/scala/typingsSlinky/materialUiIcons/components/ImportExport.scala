...
import typingsSlinky.materialUiIcons.importExportMod.default
...
object ImportExport {
  ...
  implicit def make(companion: ImportExport.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
