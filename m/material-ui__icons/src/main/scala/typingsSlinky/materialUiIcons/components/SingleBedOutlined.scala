...
object SingleBedOutlined {
  ...
  @JSImport("@material-ui/icons", "SingleBedOutlined")
  @js.native
  ...
  implicit def make(companion: SingleBedOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
