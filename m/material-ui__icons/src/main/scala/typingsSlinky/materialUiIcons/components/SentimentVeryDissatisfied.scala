...
object SentimentVeryDissatisfied {
  ...
  @JSImport("@material-ui/icons", "SentimentVeryDissatisfied")
  @js.native
  ...
  implicit def make(companion: SentimentVeryDissatisfied.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
