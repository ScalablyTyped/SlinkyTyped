...
import typingsSlinky.materialUiIcons.sentimentVeryDissatisfiedMod.default
...
object SentimentVeryDissatisfied {
  ...
  implicit def make(companion: SentimentVeryDissatisfied.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
