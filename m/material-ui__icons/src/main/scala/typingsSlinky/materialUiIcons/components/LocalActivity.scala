...
import typingsSlinky.materialUiIcons.localActivityMod.default
...
object LocalActivity {
  ...
  implicit def make(companion: LocalActivity.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
