...
object Battery30Rounded {
  @JSImport("@material-ui/icons/Battery30Rounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Battery30Rounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
