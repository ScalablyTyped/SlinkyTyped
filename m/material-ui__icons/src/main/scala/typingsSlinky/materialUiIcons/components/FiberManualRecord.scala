...
object FiberManualRecord {
  ...
  @JSImport("@material-ui/icons", "FiberManualRecord")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FiberManualRecord.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
