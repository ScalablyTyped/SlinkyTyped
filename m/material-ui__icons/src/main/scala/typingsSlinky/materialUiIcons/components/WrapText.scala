...
import typingsSlinky.materialUiIcons.wrapTextMod.default
...
object WrapText {
  ...
  implicit def make(companion: WrapText.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
