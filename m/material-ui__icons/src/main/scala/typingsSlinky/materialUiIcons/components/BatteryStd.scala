...
import typingsSlinky.materialUiIcons.batteryStdMod.default
...
object BatteryStd {
  ...
  implicit def make(companion: BatteryStd.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
