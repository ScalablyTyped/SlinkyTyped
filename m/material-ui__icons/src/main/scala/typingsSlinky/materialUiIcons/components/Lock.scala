...
import typingsSlinky.materialUiIcons.lockMod.default
...
object Lock {
  ...
  implicit def make(companion: Lock.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
