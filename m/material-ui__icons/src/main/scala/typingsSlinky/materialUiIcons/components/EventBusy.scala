...
import typingsSlinky.materialUiIcons.eventBusyMod.default
...
object EventBusy {
  ...
  implicit def make(companion: EventBusy.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
