...
import typingsSlinky.materialUiIcons.timerOffMod.default
...
object TimerOff {
  ...
  implicit def make(companion: TimerOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
