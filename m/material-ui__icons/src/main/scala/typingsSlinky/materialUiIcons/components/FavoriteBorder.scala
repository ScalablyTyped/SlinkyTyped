...
import typingsSlinky.materialUiIcons.favoriteBorderMod.default
...
object FavoriteBorder {
  ...
  implicit def make(companion: FavoriteBorder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
