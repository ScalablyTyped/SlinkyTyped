...
import typingsSlinky.materialUiIcons.phoneMod.default
...
object Phone {
  ...
  implicit def make(companion: Phone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
