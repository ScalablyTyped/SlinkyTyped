...
import typingsSlinky.materialUiIcons.duoMod.default
...
object Duo {
  ...
  implicit def make(companion: Duo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
