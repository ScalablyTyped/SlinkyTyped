...
object BluetoothSharp {
  
  @JSImport("@material-ui/icons", "BluetoothSharp")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BluetoothSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
