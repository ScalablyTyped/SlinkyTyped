...
import typingsSlinky.materialUiIcons.screenShareMod.default
...
object ScreenShare {
  ...
  implicit def make(companion: ScreenShare.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
