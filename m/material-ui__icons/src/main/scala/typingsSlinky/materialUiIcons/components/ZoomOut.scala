...
import typingsSlinky.materialUiIcons.zoomOutMod.default
...
object ZoomOut {
  ...
  implicit def make(companion: ZoomOut.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
