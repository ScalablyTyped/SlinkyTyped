...
import typingsSlinky.materialUiIcons.localShippingMod.default
...
object LocalShipping {
  ...
  implicit def make(companion: LocalShipping.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
