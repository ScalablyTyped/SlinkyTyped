...
import typingsSlinky.materialUiIcons.layersClearMod.default
...
object LayersClear {
  ...
  implicit def make(companion: LayersClear.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
