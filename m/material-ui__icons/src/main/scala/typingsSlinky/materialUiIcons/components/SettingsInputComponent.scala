...
import typingsSlinky.materialUiIcons.settingsInputComponentMod.default
...
object SettingsInputComponent {
  ...
  implicit def make(companion: SettingsInputComponent.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
