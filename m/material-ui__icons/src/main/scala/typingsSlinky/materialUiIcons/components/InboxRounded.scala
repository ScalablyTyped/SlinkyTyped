...
object InboxRounded {
  @JSImport("@material-ui/icons/InboxRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: InboxRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
