...
import typingsSlinky.materialUiIcons.addMod.default
...
object Add {
  ...
  implicit def make(companion: Add.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
