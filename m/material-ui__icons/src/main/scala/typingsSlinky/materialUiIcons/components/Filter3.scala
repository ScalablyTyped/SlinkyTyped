...
import typingsSlinky.materialUiIcons.filter3Mod.default
...
object Filter3 {
  ...
  implicit def make(companion: Filter3.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
