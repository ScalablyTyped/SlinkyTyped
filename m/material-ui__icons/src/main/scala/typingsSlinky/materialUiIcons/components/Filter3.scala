...
object Filter3 {
  ...
  @JSImport("@material-ui/icons", "Filter3")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter3.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
