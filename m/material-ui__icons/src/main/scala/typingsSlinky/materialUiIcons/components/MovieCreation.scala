...
import typingsSlinky.materialUiIcons.movieCreationMod.default
...
object MovieCreation {
  ...
  implicit def make(companion: MovieCreation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
