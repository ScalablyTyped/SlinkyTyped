...
import typingsSlinky.materialUiIcons.lockOpenMod.default
...
object LockOpen {
  ...
  implicit def make(companion: LockOpen.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
