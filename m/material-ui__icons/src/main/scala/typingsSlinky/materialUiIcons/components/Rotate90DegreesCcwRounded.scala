...
object Rotate90DegreesCcwRounded {
  ...
  implicit def make(companion: Rotate90DegreesCcwRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
