...
import typingsSlinky.materialUiIcons.eventSeatMod.default
...
object EventSeat {
  ...
  implicit def make(companion: EventSeat.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
