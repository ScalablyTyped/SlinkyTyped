...
object FlashOnOutlined {
  @JSImport("@material-ui/icons", "FlashOnOutlined")
  @js.native
  ...
  implicit def make(companion: FlashOnOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
