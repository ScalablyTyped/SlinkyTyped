...
import typingsSlinky.materialUiIcons.folderOpenMod.default
...
object FolderOpen {
  ...
  implicit def make(companion: FolderOpen.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
