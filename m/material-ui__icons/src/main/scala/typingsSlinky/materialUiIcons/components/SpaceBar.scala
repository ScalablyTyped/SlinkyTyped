...
import typingsSlinky.materialUiIcons.spaceBarMod.default
...
object SpaceBar {
  ...
  implicit def make(companion: SpaceBar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
