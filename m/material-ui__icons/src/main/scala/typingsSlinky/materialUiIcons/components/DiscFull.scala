...
import typingsSlinky.materialUiIcons.discFullMod.default
...
object DiscFull {
  ...
  implicit def make(companion: DiscFull.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
