...
import typingsSlinky.materialUiIcons.tuneMod.default
...
object Tune {
  ...
  implicit def make(companion: Tune.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
