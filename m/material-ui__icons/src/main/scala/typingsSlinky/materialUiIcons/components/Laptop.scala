...
import typingsSlinky.materialUiIcons.laptopMod.default
...
object Laptop {
  ...
  implicit def make(companion: Laptop.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
