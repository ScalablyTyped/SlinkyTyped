...
import typingsSlinky.materialUiIcons.fullscreenExitMod.default
...
object FullscreenExit {
  ...
  implicit def make(companion: FullscreenExit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
