...
import typingsSlinky.materialUiIcons.threeDRotationMod.default
...
object ThreeDRotation {
  ...
  implicit def make(companion: ThreeDRotation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
