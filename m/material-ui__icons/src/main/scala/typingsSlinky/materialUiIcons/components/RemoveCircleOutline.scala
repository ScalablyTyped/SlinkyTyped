...
import typingsSlinky.materialUiIcons.removeCircleOutlineMod.default
...
object RemoveCircleOutline {
  ...
  implicit def make(companion: RemoveCircleOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
