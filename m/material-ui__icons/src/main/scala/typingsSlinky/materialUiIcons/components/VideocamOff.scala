...
import typingsSlinky.materialUiIcons.videocamOffMod.default
...
object VideocamOff {
  ...
  implicit def make(companion: VideocamOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
