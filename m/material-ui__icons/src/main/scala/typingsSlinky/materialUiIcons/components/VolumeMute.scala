...
import typingsSlinky.materialUiIcons.volumeMuteMod.default
...
object VolumeMute {
  ...
  implicit def make(companion: VolumeMute.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
