...
import typingsSlinky.materialUiIcons.laptopMacMod.default
...
object LaptopMac {
  ...
  implicit def make(companion: LaptopMac.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
