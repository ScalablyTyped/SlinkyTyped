...
import typingsSlinky.materialUiIcons.createNewFolderMod.default
...
object CreateNewFolder {
  ...
  implicit def make(companion: CreateNewFolder.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
