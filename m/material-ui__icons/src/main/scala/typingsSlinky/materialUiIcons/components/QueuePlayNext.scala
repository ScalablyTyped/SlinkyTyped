...
import typingsSlinky.materialUiIcons.queuePlayNextMod.default
...
object QueuePlayNext {
  ...
  implicit def make(companion: QueuePlayNext.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
