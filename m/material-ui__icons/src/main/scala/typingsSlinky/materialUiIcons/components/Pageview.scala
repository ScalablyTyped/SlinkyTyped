...
import typingsSlinky.materialUiIcons.pageviewMod.default
...
object Pageview {
  ...
  implicit def make(companion: Pageview.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
