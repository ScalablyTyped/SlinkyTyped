...
object MobileScreenShareOutlined {
  @JSImport("@material-ui/icons", "MobileScreenShareOutlined")
  @js.native
  ...
  implicit def make(companion: MobileScreenShareOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
