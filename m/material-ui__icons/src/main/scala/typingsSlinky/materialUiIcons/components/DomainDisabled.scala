...
import typingsSlinky.materialUiIcons.domainDisabledMod.default
...
object DomainDisabled {
  ...
  implicit def make(companion: DomainDisabled.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
