...
object SnoozeRounded {
  @JSImport("@material-ui/icons/SnoozeRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SnoozeRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
