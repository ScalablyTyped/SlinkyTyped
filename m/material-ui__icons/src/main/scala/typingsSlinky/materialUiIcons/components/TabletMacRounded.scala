...
object TabletMacRounded {
  @JSImport("@material-ui/icons", "TabletMacRounded")
  @js.native
  ...
  implicit def make(companion: TabletMacRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
