...
object Crop54TwoTone {
  @JSImport("@material-ui/icons/Crop54TwoTone", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Crop54TwoTone.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
