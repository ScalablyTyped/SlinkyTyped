...
import typingsSlinky.materialUiIcons.volumeOffMod.default
...
object VolumeOff {
  ...
  implicit def make(companion: VolumeOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
