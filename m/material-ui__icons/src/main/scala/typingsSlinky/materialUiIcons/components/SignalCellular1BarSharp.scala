...
object SignalCellular1BarSharp {
  ...
  implicit def make(companion: SignalCellular1BarSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
