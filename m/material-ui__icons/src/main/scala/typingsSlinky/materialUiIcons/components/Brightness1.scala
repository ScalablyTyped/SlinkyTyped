...
import typingsSlinky.materialUiIcons.brightness1Mod.default
...
object Brightness1 {
  ...
  implicit def make(companion: Brightness1.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
