...
object EmojiFoodBeverageRounded {
  ...
  @JSImport("@material-ui/icons", "EmojiFoodBeverageRounded")
  @js.native
  ...
  implicit def make(companion: EmojiFoodBeverageRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
