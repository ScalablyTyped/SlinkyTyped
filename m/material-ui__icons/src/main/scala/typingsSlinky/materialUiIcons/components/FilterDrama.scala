...
import typingsSlinky.materialUiIcons.filterDramaMod.default
...
object FilterDrama {
  ...
  implicit def make(companion: FilterDrama.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
