...
object FilterDrama {
  ...
  @JSImport("@material-ui/icons", "FilterDrama")
  @js.native
  ...
  implicit def make(companion: FilterDrama.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
