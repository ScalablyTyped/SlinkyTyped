...
import typingsSlinky.materialUiIcons.arrowBackIosMod.default
...
object ArrowBackIos {
  ...
  implicit def make(companion: ArrowBackIos.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
