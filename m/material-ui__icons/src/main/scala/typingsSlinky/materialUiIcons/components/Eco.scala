...
import typingsSlinky.materialUiIcons.ecoMod.default
...
object Eco {
  ...
  implicit def make(companion: Eco.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
