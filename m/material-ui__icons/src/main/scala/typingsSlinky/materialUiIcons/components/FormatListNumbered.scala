...
import typingsSlinky.materialUiIcons.formatListNumberedMod.default
...
object FormatListNumbered {
  ...
  implicit def make(companion: FormatListNumbered.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
