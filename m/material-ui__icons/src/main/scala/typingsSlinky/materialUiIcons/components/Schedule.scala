...
import typingsSlinky.materialUiIcons.scheduleMod.default
...
object Schedule {
  ...
  implicit def make(companion: Schedule.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
