...
object DoneRounded {
  @JSImport("@material-ui/icons/DoneRounded", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: DoneRounded.type): SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object] = new SharedBuilder_SvgIconProps144760471[LegacyRef[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
