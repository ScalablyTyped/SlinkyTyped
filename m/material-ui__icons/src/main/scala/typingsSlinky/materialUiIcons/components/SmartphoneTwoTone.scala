...
object SmartphoneTwoTone {
  @JSImport("@material-ui/icons", "SmartphoneTwoTone")
  @js.native
  ...
  implicit def make(companion: SmartphoneTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
