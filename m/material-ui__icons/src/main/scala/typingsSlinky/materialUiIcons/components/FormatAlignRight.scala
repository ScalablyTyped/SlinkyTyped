...
import typingsSlinky.materialUiIcons.formatAlignRightMod.default
...
object FormatAlignRight {
  ...
  implicit def make(companion: FormatAlignRight.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
