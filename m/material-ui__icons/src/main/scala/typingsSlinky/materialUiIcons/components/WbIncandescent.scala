...
object WbIncandescent {
  ...
  @JSImport("@material-ui/icons", "WbIncandescent")
  @js.native
  ...
  implicit def make(companion: WbIncandescent.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
