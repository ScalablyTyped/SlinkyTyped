...
import typingsSlinky.materialUiIcons.wbIncandescentMod.default
...
object WbIncandescent {
  ...
  implicit def make(companion: WbIncandescent.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
