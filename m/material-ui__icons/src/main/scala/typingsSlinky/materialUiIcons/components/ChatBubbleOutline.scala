...
import typingsSlinky.materialUiIcons.chatBubbleOutlineMod.default
...
object ChatBubbleOutline {
  ...
  implicit def make(companion: ChatBubbleOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
