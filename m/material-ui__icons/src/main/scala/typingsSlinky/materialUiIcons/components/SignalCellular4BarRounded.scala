...
object SignalCellular4BarRounded {
  ...
  implicit def make(companion: SignalCellular4BarRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
