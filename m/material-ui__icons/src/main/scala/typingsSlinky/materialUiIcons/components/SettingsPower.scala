...
import typingsSlinky.materialUiIcons.settingsPowerMod.default
...
object SettingsPower {
  ...
  implicit def make(companion: SettingsPower.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
