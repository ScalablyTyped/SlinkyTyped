...
import typingsSlinky.materialUiIcons.highlightOffMod.default
...
object HighlightOff {
  ...
  implicit def make(companion: HighlightOff.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
