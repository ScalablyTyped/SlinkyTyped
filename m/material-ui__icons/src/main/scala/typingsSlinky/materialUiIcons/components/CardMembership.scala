...
import typingsSlinky.materialUiIcons.cardMembershipMod.default
...
object CardMembership {
  ...
  implicit def make(companion: CardMembership.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
