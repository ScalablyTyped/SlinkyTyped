...
import typingsSlinky.materialUiIcons.unfoldLessMod.default
...
object UnfoldLess {
  ...
  implicit def make(companion: UnfoldLess.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
