...
import typingsSlinky.materialUiIcons.calendarViewDayMod.default
...
object CalendarViewDay {
  ...
  implicit def make(companion: CalendarViewDay.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
