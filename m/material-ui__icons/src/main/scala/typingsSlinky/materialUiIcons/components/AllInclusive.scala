...
import typingsSlinky.materialUiIcons.allInclusiveMod.default
...
object AllInclusive {
  ...
  implicit def make(companion: AllInclusive.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
