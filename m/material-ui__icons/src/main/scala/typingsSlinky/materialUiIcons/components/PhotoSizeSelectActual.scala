...
import typingsSlinky.materialUiIcons.photoSizeSelectActualMod.default
...
object PhotoSizeSelectActual {
  ...
  implicit def make(companion: PhotoSizeSelectActual.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
