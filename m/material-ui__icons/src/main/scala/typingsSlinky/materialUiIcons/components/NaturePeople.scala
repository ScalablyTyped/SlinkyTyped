...
import typingsSlinky.materialUiIcons.naturePeopleMod.default
...
object NaturePeople {
  ...
  implicit def make(companion: NaturePeople.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
