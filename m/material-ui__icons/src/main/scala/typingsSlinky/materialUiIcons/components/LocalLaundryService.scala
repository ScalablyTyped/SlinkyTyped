...
import typingsSlinky.materialUiIcons.localLaundryServiceMod.default
...
object LocalLaundryService {
  ...
  implicit def make(companion: LocalLaundryService.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
