...
import typingsSlinky.materialUiIcons.subscriptionsMod.default
...
object Subscriptions {
  ...
  implicit def make(companion: Subscriptions.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
