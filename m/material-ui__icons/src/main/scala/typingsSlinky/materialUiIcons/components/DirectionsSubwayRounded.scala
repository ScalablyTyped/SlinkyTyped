...
object DirectionsSubwayRounded {
  ...
  @JSImport("@material-ui/icons", "DirectionsSubwayRounded")
  @js.native
  ...
  implicit def make(companion: DirectionsSubwayRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
