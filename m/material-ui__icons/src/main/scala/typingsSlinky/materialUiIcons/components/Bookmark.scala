...
import typingsSlinky.materialUiIcons.bookmarkMod.default
...
object Bookmark {
  ...
  implicit def make(companion: Bookmark.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
