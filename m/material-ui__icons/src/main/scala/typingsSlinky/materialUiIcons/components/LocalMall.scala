...
import typingsSlinky.materialUiIcons.localMallMod.default
...
object LocalMall {
  ...
  implicit def make(companion: LocalMall.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
