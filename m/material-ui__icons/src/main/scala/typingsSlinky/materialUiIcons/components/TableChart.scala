...
import typingsSlinky.materialUiIcons.tableChartMod.default
...
object TableChart {
  ...
  implicit def make(companion: TableChart.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
