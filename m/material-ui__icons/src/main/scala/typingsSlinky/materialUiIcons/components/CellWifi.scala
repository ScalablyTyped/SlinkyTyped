...
import typingsSlinky.materialUiIcons.cellWifiMod.default
...
object CellWifi {
  ...
  implicit def make(companion: CellWifi.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
