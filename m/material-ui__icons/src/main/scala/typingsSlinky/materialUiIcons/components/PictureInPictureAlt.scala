...
import typingsSlinky.materialUiIcons.pictureInPictureAltMod.default
...
object PictureInPictureAlt {
  ...
  implicit def make(companion: PictureInPictureAlt.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
