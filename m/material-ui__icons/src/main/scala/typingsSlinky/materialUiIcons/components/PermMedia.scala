...
import typingsSlinky.materialUiIcons.permMediaMod.default
...
object PermMedia {
  ...
  implicit def make(companion: PermMedia.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
