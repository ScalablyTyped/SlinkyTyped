...
import typingsSlinky.materialUiIcons.powerInputMod.default
...
object PowerInput {
  ...
  implicit def make(companion: PowerInput.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
