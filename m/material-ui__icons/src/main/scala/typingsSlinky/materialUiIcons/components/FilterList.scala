...
import typingsSlinky.materialUiIcons.filterListMod.default
...
object FilterList {
  ...
  implicit def make(companion: FilterList.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
