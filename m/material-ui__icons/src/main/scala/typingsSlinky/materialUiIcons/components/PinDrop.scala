...
import typingsSlinky.materialUiIcons.pinDropMod.default
...
object PinDrop {
  ...
  implicit def make(companion: PinDrop.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
