...
import typingsSlinky.materialUiIcons.spellcheckMod.default
...
object Spellcheck {
  ...
  implicit def make(companion: Spellcheck.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
