...
import typingsSlinky.materialUiIcons.replay10Mod.default
...
object Replay10 {
  ...
  implicit def make(companion: Replay10.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
