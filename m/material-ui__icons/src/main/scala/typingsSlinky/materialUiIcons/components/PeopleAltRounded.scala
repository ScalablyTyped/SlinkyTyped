...
object PeopleAltRounded {
  ...
  @JSImport("@material-ui/icons", "PeopleAltRounded")
  @js.native
  ...
  implicit def make(companion: PeopleAltRounded.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
