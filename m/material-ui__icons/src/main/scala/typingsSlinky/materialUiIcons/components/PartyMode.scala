...
import typingsSlinky.materialUiIcons.partyModeMod.default
...
object PartyMode {
  ...
  implicit def make(companion: PartyMode.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
