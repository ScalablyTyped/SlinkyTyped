...
object SlowMotionVideoSharp {
  @JSImport("@material-ui/icons", "SlowMotionVideoSharp")
  @js.native
  ...
  implicit def make(companion: SlowMotionVideoSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
