...
object InboxTwoTone {
  ...
  @JSImport("@material-ui/icons", "InboxTwoTone")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: InboxTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
