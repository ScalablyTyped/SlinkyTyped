...
import typingsSlinky.materialUiIcons.peopleMod.default
...
object People {
  ...
  implicit def make(companion: People.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
