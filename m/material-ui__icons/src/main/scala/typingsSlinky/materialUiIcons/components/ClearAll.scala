...
import typingsSlinky.materialUiIcons.clearAllMod.default
...
object ClearAll {
  ...
  implicit def make(companion: ClearAll.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
