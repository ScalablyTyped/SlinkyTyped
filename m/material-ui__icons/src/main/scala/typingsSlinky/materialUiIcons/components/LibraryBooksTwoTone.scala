...
object LibraryBooksTwoTone {
  ...
  @JSImport("@material-ui/icons", "LibraryBooksTwoTone")
  @js.native
  ...
  implicit def make(companion: LibraryBooksTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
