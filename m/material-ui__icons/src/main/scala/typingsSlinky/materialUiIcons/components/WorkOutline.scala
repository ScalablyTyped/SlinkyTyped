...
import typingsSlinky.materialUiIcons.workOutlineMod.default
...
object WorkOutline {
  ...
  implicit def make(companion: WorkOutline.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
