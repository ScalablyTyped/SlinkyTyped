...
import typingsSlinky.materialUiIcons.forumMod.default
...
object Forum {
  ...
  implicit def make(companion: Forum.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
