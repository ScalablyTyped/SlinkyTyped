...
import typingsSlinky.materialUiIcons.cakeMod.default
...
object Cake {
  ...
  implicit def make(companion: Cake.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
