...
import typingsSlinky.materialUiIcons.signalWifi0BarMod.default
...
object SignalWifi0Bar {
  ...
  implicit def make(companion: SignalWifi0Bar.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
