...
import typingsSlinky.materialUiIcons.permPhoneMsgMod.default
...
object PermPhoneMsg {
  ...
  implicit def make(companion: PermPhoneMsg.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
