...
import typingsSlinky.materialUiIcons.musicVideoMod.default
...
object MusicVideo {
  ...
  implicit def make(companion: MusicVideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
