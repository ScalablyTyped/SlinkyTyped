...
import typingsSlinky.materialUiIcons.smartphoneMod.default
...
object Smartphone {
  ...
  implicit def make(companion: Smartphone.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
