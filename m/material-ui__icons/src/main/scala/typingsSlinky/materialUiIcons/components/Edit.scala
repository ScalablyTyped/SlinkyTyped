...
import typingsSlinky.materialUiIcons.editMod.default
...
object Edit {
  ...
  implicit def make(companion: Edit.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
