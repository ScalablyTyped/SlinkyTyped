...
object LocalCafeOutlined {
  ...
  @JSImport("@material-ui/icons", "LocalCafeOutlined")
  @js.native
  ...
  implicit def make(companion: LocalCafeOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
