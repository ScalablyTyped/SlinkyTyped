...
object ImageOutlined {
  ...
  @JSImport("@material-ui/icons", "ImageOutlined")
  @js.native
  ...
  implicit def make(companion: ImageOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
