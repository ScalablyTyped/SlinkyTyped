...
import typingsSlinky.materialUiIcons.viewModuleMod.default
...
object ViewModule {
  ...
  implicit def make(companion: ViewModule.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
