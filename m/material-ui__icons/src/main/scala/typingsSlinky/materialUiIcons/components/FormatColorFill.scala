...
import typingsSlinky.materialUiIcons.formatColorFillMod.default
...
object FormatColorFill {
  ...
  implicit def make(companion: FormatColorFill.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
