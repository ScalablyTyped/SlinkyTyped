...
object ToggleOffSharp {
  @JSImport("@material-ui/icons", "ToggleOffSharp")
  @js.native
  ...
  implicit def make(companion: ToggleOffSharp.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
