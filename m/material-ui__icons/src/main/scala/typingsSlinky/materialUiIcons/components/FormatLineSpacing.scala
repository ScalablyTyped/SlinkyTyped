...
import typingsSlinky.materialUiIcons.formatLineSpacingMod.default
...
object FormatLineSpacing {
  ...
  implicit def make(companion: FormatLineSpacing.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
