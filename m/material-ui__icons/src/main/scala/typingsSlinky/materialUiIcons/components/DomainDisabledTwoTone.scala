...
object DomainDisabledTwoTone {
  @JSImport("@material-ui/icons", "DomainDisabledTwoTone")
  @js.native
  ...
  implicit def make(companion: DomainDisabledTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
