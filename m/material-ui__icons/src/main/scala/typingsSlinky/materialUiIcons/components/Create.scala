...
import typingsSlinky.materialUiIcons.createMod.default
...
object Create {
  ...
  implicit def make(companion: Create.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
