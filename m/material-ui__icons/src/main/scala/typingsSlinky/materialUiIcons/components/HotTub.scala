...
import typingsSlinky.materialUiIcons.hotTubMod.default
...
object HotTub {
  ...
  implicit def make(companion: HotTub.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
