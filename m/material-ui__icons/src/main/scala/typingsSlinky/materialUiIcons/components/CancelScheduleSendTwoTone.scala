...
object CancelScheduleSendTwoTone {
  @JSImport("@material-ui/icons", "CancelScheduleSendTwoTone")
  @js.native
  ...
  implicit def make(companion: CancelScheduleSendTwoTone.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
