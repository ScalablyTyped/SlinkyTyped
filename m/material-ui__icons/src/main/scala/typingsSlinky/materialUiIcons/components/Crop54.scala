...
import typingsSlinky.materialUiIcons.crop54Mod.default
...
object Crop54 {
  ...
  implicit def make(companion: Crop54.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
