...
import typingsSlinky.materialUiIcons.personalVideoMod.default
...
object PersonalVideo {
  ...
  implicit def make(companion: PersonalVideo.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
