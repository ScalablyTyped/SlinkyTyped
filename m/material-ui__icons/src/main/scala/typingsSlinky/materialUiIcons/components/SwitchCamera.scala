...
import typingsSlinky.materialUiIcons.switchCameraMod.default
...
object SwitchCamera {
  ...
  implicit def make(companion: SwitchCamera.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
