...
import typingsSlinky.materialUiIcons.localGasStationMod.default
...
object LocalGasStation {
  ...
  implicit def make(companion: LocalGasStation.type): SharedBuilder_SvgIconProps_1164301990[default] = new SharedBuilder_SvgIconProps_1164301990[default](js.Array(this.component, js.Dictionary.empty))()
}
