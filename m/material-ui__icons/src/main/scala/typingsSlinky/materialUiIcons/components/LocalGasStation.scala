...
object LocalGasStation {
  @JSImport("@material-ui/icons", "LocalGasStation")
  @js.native
  ...
  implicit def make(companion: LocalGasStation.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
