...
object NotificationsNoneOutlined {
  @JSImport("@material-ui/icons", "NotificationsNoneOutlined")
  @js.native
  ...
  implicit def make(companion: NotificationsNoneOutlined.type): SharedBuilder_SvgIconProps144760471[SVGSVGElement] = new SharedBuilder_SvgIconProps144760471[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
