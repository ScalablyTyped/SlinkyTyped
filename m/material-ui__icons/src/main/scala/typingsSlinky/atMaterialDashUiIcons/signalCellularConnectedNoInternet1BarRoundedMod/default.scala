package typingsSlinky.atMaterialDashUiIcons.signalCellularConnectedNoInternet1BarRoundedMod
...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet1BarRounded", "default")
@js.native
