package typingsSlinky.atMaterialDashUiIcons.signalCellularConnectedNoInternet1BarSharpMod
...
@JSImport("@material-ui/icons/SignalCellularConnectedNoInternet1BarSharp", "default")
@js.native
