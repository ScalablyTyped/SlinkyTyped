...
@js.native
trait GoogleCloudHealthcareV1FhirGcsSource extends js.Object {
...
object GoogleCloudHealthcareV1FhirGcsSource {
  ...
  @scala.inline
  def apply(): GoogleCloudHealthcareV1FhirGcsSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudHealthcareV1FhirGcsSource]
  }
  
  @scala.inline
  implicit class GoogleCloudHealthcareV1FhirGcsSourceOps[Self <: GoogleCloudHealthcareV1FhirGcsSource] (val x: Self) extends AnyVal {
