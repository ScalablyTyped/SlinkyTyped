...
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.CallbackDatasetId
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.DatasetId
...
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.PageToken
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.QuotaUserResource
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.QuotaUserSourceDataset
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.Resource
import typingsSlinky.maximMazurokGapiClientHealthcare.anon.SourceDataset
