...
@js.native
trait DicomStoreId extends StObject {
...
object DicomStoreId {
  ...
  @scala.inline
  def apply(parent: String): DicomStoreId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[DicomStoreId]
  }
  
  @scala.inline
  implicit class DicomStoreIdMutableBuilder[Self <: DicomStoreId] (val x: Self) extends AnyVal {
