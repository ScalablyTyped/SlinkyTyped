...
trait AnchorOptions extends js.Object {
  var callback: js.UndefOr[
    js.Function2[
      /* token */ typingsSlinky.markdownDashIt.libTokenMod.^, 
  ...
  var renderPermalink: js.UndefOr[
    js.Function4[
      /* slug */ String, 
      /* opts */ this.type, 
      /* state */ typingsSlinky.markdownDashIt.libParserUnderscoreCoreMod.^, 
      /* idx */ Double, 
      Unit
    ]
  ] = js.undefined
...
object AnchorOptions {
  @scala.inline
  def apply(
    callback: (/* token */ typingsSlinky.markdownDashIt.libTokenMod.^, /* anchor_info */ AnchorInfo) => Unit = null,
    ...
    renderPermalink: (/* slug */ String, AnchorOptions, /* state */ typingsSlinky.markdownDashIt.libParserUnderscoreCoreMod.^, /* idx */ Double) => Unit = null,
