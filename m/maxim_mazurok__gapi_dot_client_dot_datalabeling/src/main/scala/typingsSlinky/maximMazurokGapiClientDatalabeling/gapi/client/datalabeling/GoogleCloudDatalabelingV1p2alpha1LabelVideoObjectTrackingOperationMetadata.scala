...
object GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectTrackingOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectTrackingOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1LabelVideoObjectTrackingOperationMetadata] (val x: Self) extends AnyVal {
