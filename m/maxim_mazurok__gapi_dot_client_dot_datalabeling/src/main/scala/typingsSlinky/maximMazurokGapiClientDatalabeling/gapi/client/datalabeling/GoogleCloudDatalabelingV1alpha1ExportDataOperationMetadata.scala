...
@js.native
trait GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadataOps[Self <: GoogleCloudDatalabelingV1alpha1ExportDataOperationMetadata] (val x: Self) extends AnyVal {
