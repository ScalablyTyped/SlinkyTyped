...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata] (val x: Self) extends AnyVal {
