...
object GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponse {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponseMutableBuilder[Self <: GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelStats(value: GoogleCloudDatalabelingV1p1alpha1LabelStats): Self = StObject.set(x, "labelStats", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelStatsUndefined: Self = StObject.set(x, "labelStats", js.undefined)
    
    @scala.inline
    def setOutputConfig(value: GoogleCloudDatalabelingV1p1alpha1OutputConfig): Self = StObject.set(x, "outputConfig", value.asInstanceOf[js.Any])
