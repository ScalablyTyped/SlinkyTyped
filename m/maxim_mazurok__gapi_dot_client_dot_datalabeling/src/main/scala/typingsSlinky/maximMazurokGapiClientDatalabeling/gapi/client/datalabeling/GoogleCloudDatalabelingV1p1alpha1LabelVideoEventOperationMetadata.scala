...
object GoogleCloudDatalabelingV1p1alpha1LabelVideoEventOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelVideoEventOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1p1alpha1LabelVideoEventOperationMetadata] (val x: Self) extends AnyVal {
