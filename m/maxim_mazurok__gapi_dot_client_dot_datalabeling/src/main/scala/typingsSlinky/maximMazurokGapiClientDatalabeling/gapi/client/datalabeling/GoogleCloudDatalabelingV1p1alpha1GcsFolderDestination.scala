...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1GcsFolderDestination extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1GcsFolderDestination {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1GcsFolderDestinationOps[Self <: GoogleCloudDatalabelingV1p1alpha1GcsFolderDestination] (val x: Self) extends AnyVal {
