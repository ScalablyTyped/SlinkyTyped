...
@js.native
trait GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadataOps[Self <: GoogleCloudDatalabelingV1beta1LabelImageBoundingPolyOperationMetadata] (val x: Self) extends AnyVal {
