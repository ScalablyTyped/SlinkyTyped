...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelVideoClassificationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelVideoClassificationOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelVideoClassificationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelVideoClassificationOperationMetadata] (val x: Self) extends AnyVal {
