...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelVideoObjectTrackingOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelVideoObjectTrackingOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelVideoObjectTrackingOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelVideoObjectTrackingOperationMetadata] (val x: Self) extends AnyVal {
