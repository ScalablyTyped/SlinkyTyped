...
trait GoogleCloudDatalabelingV1p1alpha1LabelStats extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDatalabeling.maximMazurokGapiClientDatalabelingStrings.GoogleCloudDatalabelingV1p1alpha1LabelStats with TopLevel[js.Any]
  ] = js.native
}
