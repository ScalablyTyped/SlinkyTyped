...
@js.native
trait GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1beta1LabelImageClassificationOperationMetadata] (val x: Self) extends AnyVal {
