...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelImageSegmentationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelImageSegmentationOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelImageSegmentationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelImageSegmentationOperationMetadata] (val x: Self) extends AnyVal {
