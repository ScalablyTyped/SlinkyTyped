...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelTextClassificationOperationMetadata] (val x: Self) extends AnyVal {
