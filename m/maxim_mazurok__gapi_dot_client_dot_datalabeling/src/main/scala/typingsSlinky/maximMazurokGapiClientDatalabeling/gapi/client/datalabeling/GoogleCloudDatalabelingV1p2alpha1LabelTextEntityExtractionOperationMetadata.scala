...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata] (val x: Self) extends AnyVal {
