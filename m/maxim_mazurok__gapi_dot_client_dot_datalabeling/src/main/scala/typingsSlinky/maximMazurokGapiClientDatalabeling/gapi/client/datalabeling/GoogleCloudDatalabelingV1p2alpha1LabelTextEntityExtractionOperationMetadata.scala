...
object GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1LabelTextEntityExtractionOperationMetadata] (val x: Self) extends AnyVal {
