...
object GoogleCloudDatalabelingV1alpha1GcsFolderDestination {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1GcsFolderDestinationMutableBuilder[Self <: GoogleCloudDatalabelingV1alpha1GcsFolderDestination] (val x: Self) extends AnyVal {
