...
trait GoogleCloudDatalabelingV1beta1LabelStats extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDatalabeling.maximMazurokGapiClientDatalabelingStrings.GoogleCloudDatalabelingV1beta1LabelStats with TopLevel[js.Any]
  ] = js.native
}
