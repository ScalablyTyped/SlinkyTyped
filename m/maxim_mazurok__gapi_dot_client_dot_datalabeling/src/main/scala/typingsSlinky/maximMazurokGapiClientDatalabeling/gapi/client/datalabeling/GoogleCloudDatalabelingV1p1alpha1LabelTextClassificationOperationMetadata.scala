...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1LabelTextClassificationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1LabelTextClassificationOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1LabelTextClassificationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1LabelTextClassificationOperationMetadata] (val x: Self) extends AnyVal {
