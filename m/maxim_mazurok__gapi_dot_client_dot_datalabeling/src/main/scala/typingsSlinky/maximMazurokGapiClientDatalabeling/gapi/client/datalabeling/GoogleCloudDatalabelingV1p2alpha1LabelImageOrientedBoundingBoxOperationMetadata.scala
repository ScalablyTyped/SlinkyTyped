...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadataOps[Self <: GoogleCloudDatalabelingV1p2alpha1LabelImageOrientedBoundingBoxOperationMetadata] (val x: Self) extends AnyVal {
