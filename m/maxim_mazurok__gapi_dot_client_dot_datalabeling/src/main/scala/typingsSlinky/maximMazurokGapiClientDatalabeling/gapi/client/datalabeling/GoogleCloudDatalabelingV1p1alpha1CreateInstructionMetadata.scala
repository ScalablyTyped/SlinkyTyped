...
@js.native
trait GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadataOps[Self <: GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata] (val x: Self) extends AnyVal {
