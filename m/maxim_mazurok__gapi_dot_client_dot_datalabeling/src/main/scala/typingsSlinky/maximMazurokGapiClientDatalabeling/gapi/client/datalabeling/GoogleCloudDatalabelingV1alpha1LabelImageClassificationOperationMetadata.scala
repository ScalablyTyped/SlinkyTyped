...
object GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadataMutableBuilder[Self <: GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata] (val x: Self) extends AnyVal {
