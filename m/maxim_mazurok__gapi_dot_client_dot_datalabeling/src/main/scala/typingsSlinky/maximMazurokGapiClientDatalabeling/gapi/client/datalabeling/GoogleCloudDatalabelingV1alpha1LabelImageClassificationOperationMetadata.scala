...
@js.native
trait GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadataOps[Self <: GoogleCloudDatalabelingV1alpha1LabelImageClassificationOperationMetadata] (val x: Self) extends AnyVal {
