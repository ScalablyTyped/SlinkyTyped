...
@js.native
trait GoogleCloudDatalabelingV1alpha1LabelStats extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1LabelStats {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1LabelStatsOps[Self <: GoogleCloudDatalabelingV1alpha1LabelStats] (val x: Self) extends AnyVal {
