...
@js.native
trait GoogleCloudDatalabelingV1alpha1OutputConfig extends js.Object {
...
object GoogleCloudDatalabelingV1alpha1OutputConfig {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1alpha1OutputConfigOps[Self <: GoogleCloudDatalabelingV1alpha1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: GoogleCloudDatalabelingV1alpha1GcsDestination): Self = this.set("gcsDestination", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGcsDestination: Self = this.set("gcsDestination", js.undefined)
    
    @scala.inline
    def setGcsFolderDestination(value: GoogleCloudDatalabelingV1alpha1GcsFolderDestination): Self = this.set("gcsFolderDestination", value.asInstanceOf[js.Any])
