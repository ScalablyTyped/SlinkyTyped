...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1GcsFolderDestinationOps[Self <: GoogleCloudDatalabelingV1p2alpha1GcsFolderDestination] (val x: Self) extends AnyVal {
