...
trait GoogleCloudDatalabelingV1p2alpha1LabelStats extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDatalabeling.maximMazurokGapiClientDatalabelingStrings.GoogleCloudDatalabelingV1p2alpha1LabelStats with TopLevel[js.Any]
  ] = js.native
}
