...
object GoogleCloudDatalabelingV1p2alpha1GcsDestination {
  ...
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1GcsDestinationMutableBuilder[Self <: GoogleCloudDatalabelingV1p2alpha1GcsDestination] (val x: Self) extends AnyVal {
