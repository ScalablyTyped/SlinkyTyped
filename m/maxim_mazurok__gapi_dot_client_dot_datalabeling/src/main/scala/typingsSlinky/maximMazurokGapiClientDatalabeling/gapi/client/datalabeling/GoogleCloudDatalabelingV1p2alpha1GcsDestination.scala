...
@js.native
trait GoogleCloudDatalabelingV1p2alpha1GcsDestination extends js.Object {
...
object GoogleCloudDatalabelingV1p2alpha1GcsDestination {
  ...
  @scala.inline
  def apply(): GoogleCloudDatalabelingV1p2alpha1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1GcsDestination]
  }
  
  @scala.inline
  implicit class GoogleCloudDatalabelingV1p2alpha1GcsDestinationOps[Self <: GoogleCloudDatalabelingV1p2alpha1GcsDestination] (val x: Self) extends AnyVal {
