package typingsSlinky.mpvScript.mp

import typingsSlinky.mpvScript.mpvScriptStrings.down
import typingsSlinky.mpvScript.mpvScriptStrings.press
import typingsSlinky.mpvScript.mpvScriptStrings.repeat
import typingsSlinky.mpvScript.mpvScriptStrings.up
