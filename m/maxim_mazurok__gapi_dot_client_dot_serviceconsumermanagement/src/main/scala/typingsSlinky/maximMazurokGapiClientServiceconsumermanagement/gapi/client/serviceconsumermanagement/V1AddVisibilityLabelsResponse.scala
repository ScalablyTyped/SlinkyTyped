...
@js.native
trait V1AddVisibilityLabelsResponse extends js.Object {
...
object V1AddVisibilityLabelsResponse {
  ...
  @scala.inline
  implicit class V1AddVisibilityLabelsResponseOps[Self <: V1AddVisibilityLabelsResponse] (val x: Self) extends AnyVal {
