...
trait TenantProjectConfig extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientServiceconsumermanagement.maximMazurokGapiClientServiceconsumermanagementStrings.TenantProjectConfig with TopLevel[js.Any]
  ] = js.native
