...
@js.native
trait SearchTenancyUnitsResponse extends js.Object {
...
object SearchTenancyUnitsResponse {
  ...
  @scala.inline
  implicit class SearchTenancyUnitsResponseOps[Self <: SearchTenancyUnitsResponse] (val x: Self) extends AnyVal {
