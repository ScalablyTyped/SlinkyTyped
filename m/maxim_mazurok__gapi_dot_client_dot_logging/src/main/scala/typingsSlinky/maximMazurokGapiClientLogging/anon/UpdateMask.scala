package typingsSlinky.maximMazurokGapiClientLogging.anon

import typingsSlinky.maximMazurokGapiClientLogging.gapi.client.logging.LogSink
...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: LogSink = js.native
...
object UpdateMask {
  ...
  @scala.inline
  def apply(resource: LogSink, sinkName: String): UpdateMask = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], sinkName = sinkName.asInstanceOf[js.Any])
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogSink): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
