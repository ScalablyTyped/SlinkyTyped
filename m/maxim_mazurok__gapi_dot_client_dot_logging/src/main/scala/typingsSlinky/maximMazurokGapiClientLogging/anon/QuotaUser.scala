...
import typingsSlinky.maximMazurokGapiClientLogging.gapi.client.logging.UndeleteBucketRequest
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: UndeleteBucketRequest = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(name: String, resource: UndeleteBucketRequest): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UndeleteBucketRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
