...
import typingsSlinky.maximMazurokGapiClientLogging.gapi.client.logging.LogView
...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: LogView = js.native
...
object Key {
  ...
  @scala.inline
  def apply(name: String, resource: LogView): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogView): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
