...
import typingsSlinky.maximMazurokGapiClientLogging.gapi.client.logging.CmekSettings
...
trait KeyName extends StObject {
  ...
  /** Request body */
  var resource: CmekSettings = js.native
...
object KeyName {
  ...
  @scala.inline
  def apply(name: String, resource: CmekSettings): KeyName = {
  ...
  implicit class KeyNameMutableBuilder[Self <: KeyName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CmekSettings): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
