...
import typingsSlinky.maximMazurokGapiClientLogging.gapi.client.logging.LogExclusion
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: LogExclusion = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: LogExclusion): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LogExclusion): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
