...
import typingsSlinky.maximMazurokGapiClientLogging.anon.SinkName
import typingsSlinky.maximMazurokGapiClientLogging.anon.UniqueWriterIdentity
import typingsSlinky.maximMazurokGapiClientLogging.anon.UpdateMask
import typingsSlinky.maximMazurokGapiClientLogging.anon.Uploadprotocol
import typingsSlinky.maximMazurokGapiClientLogging.anon.Xgafv
