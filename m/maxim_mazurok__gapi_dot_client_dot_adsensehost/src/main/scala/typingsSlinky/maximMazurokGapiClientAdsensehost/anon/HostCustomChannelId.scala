...
@js.native
trait HostCustomChannelId extends StObject {
  ...
  var hostCustomChannelId: js.UndefOr[String | js.Array[String]] = js.native
...
object HostCustomChannelId {
  ...
  @scala.inline
  implicit class HostCustomChannelIdMutableBuilder[Self <: HostCustomChannelId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHostCustomChannelId(value: String | js.Array[String]): Self = StObject.set(x, "hostCustomChannelId", value.asInstanceOf[js.Any])
