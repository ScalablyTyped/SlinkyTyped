...
object GeocoderControl {
  ...
  def apply(
    ...
    __obj.asInstanceOf[GeocoderControl]
  }
}
...
object geocoderControl extends js.Object {
  ...
  /**
  		 ...
  		 */
  def apply(id: String): GeocoderControl = js.native
  def apply(id: String, options: GeocoderControlOptions): GeocoderControl = js.native
}
