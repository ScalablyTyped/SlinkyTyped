...
trait MathJsChain extends js.Object {
  ...
  def derivative(variable: String, options: Anon_Simplify): MathJsChain = js.native
  /*************************************************************************
    * Algebra functions
    ************************************************************************/
  /**
  ...
  def derivative(variable: MathNode, options: Anon_Simplify): MathJsChain = js.native
  /**
  ...
  def simplify(rules: js.Array[Anon_LR | String | (js.Function1[/* node */ MathNode, MathNode])]): MathJsChain = js.native
  def simplify(
