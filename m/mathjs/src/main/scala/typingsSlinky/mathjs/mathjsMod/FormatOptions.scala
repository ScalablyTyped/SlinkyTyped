...
import typingsSlinky.mathjs.mathjsStrings.auto
import typingsSlinky.mathjs.mathjsStrings.engineering
import typingsSlinky.mathjs.mathjsStrings.exponential
import typingsSlinky.mathjs.mathjsStrings.fixed
