...
object PartialMathJsStatic {
  ...
  def apply(
    ...
    SQRT1_2: js.UndefOr[Double] = js.undefined,
    SQRT1_2Dependencies: FactoryFunctionMap = null,
    SQRT2: js.UndefOr[Double] = js.undefined,
    ...
    derivative: (/* expr */ MathNode | String, /* variable */ MathNode | String, /* options */ js.UndefOr[Simplify]) => MathNode = null,
    ...
    filter: (/* x */ Matrix | MathArray | js.Array[String], /* test */ (js.Function3[
      ...
      /* matrix */ Matrix | MathArray | js.Array[String], 
      Boolean
    ]) | js.RegExp) => Matrix | MathArray = null,
    ...
    if (!js.isUndefined(Infinity)) __obj.updateDynamic("Infinity")(Infinity.get.asInstanceOf[js.Any])
    if (InfinityDependencies != null) __obj.updateDynamic("InfinityDependencies")(InfinityDependencies.asInstanceOf[js.Any])
    if (!js.isUndefined(LN10)) __obj.updateDynamic("LN10")(LN10.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(LOG10E)) __obj.updateDynamic("LOG10E")(LOG10E.get.asInstanceOf[js.Any])
    if (LOG10EDependencies != null) __obj.updateDynamic("LOG10EDependencies")(LOG10EDependencies.asInstanceOf[js.Any])
    if (!js.isUndefined(LOG2E)) __obj.updateDynamic("LOG2E")(LOG2E.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(NaN)) __obj.updateDynamic("NaN")(NaN.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(SQRT1_2)) __obj.updateDynamic("SQRT1_2")(SQRT1_2.get.asInstanceOf[js.Any])
    if (SQRT1_2Dependencies != null) __obj.updateDynamic("SQRT1_2Dependencies")(SQRT1_2Dependencies.asInstanceOf[js.Any])
    if (!js.isUndefined(SQRT2)) __obj.updateDynamic("SQRT2")(SQRT2.get.asInstanceOf[js.Any])
