package typingsSlinky.markdownDashToDashJsx.markdownDashToDashJsxMod

import slinky.core.ReactComponentClass
import slinky.core.TagMod
import slinky.core.facade.ReactElement
import typingsSlinky.markdownDashToDashJsx.Anon_A
...
trait MarkdownOptions extends js.Object {
  ...
  var createElement: js.UndefOr[
    js.Function3[
      /* type */ ReactComponentClass[js.Object] | ReactComponentClass[js.Object] | String, 
  ...
  var overrides: js.UndefOr[Anon_A] = js.undefined
...
object MarkdownOptions {
  @scala.inline
  def apply(
    createElement: (/* type */ ReactComponentClass[js.Object] | ReactComponentClass[js.Object] | String, /* props */ js.UndefOr[(Attributes with js.Object) | Null], /* repeated */ TagMod[Any]) => ReactElement = null,
    forceBlock: js.UndefOr[Boolean] = js.undefined,
    forceInline: js.UndefOr[Boolean] = js.undefined,
    overrides: Anon_A = null,
