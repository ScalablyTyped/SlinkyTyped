...
object MarkdownToJsx {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def options(value: MarkdownOptions): this.type = set("options", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  implicit def make(companion: MarkdownToJsx.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
