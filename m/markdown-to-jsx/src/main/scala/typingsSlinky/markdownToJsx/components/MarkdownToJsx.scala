package typingsSlinky.markdownToJsx.components
...
import typingsSlinky.markdownToJsx.mod.MarkdownOptions
import typingsSlinky.markdownToJsx.mod.MarkdownProps
import typingsSlinky.markdownToJsx.mod.default
...
object MarkdownToJsx
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.markdownToJsx.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
