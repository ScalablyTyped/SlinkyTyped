...
object AnonComponent {
  @scala.inline
  def apply[P, S](component: String | ReactComponentClass[P]): AnonComponent[P, S] = {
    val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonComponent[P, S]]
  }
  @scala.inline
  implicit class AnonComponentOps[Self[p, s] <: AnonComponent[p, s], P, S] (val x: Self[P, S]) extends AnyVal {
    @scala.inline
