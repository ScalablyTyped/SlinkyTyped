...
import typingsSlinky.maximMazurokGapiClientServicemanagement.gapi.client.servicemanagement.Service
...
object Callback {
  ...
  @scala.inline
  def apply(resource: Service, serviceName: String): Callback = {
