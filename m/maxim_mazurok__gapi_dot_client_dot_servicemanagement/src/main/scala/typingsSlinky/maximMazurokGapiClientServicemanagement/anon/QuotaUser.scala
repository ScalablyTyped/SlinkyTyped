...
import typingsSlinky.maximMazurokGapiClientServicemanagement.gapi.client.servicemanagement.Rollout
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: Rollout = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(resource: Rollout, serviceName: String): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Rollout): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
