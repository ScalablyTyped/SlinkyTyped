...
@js.native
trait DurationDays extends js.Object {
...
object DurationDays {
  ...
  @scala.inline
  def apply(dynamicLink: String): DurationDays = {
    val __obj = js.Dynamic.literal(dynamicLink = dynamicLink.asInstanceOf[js.Any])
    __obj.asInstanceOf[DurationDays]
  }
  
  @scala.inline
  implicit class DurationDaysOps[Self <: DurationDays] (val x: Self) extends AnyVal {
