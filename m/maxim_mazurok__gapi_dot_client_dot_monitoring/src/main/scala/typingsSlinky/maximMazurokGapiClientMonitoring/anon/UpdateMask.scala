...
import typingsSlinky.maximMazurokGapiClientMonitoring.gapi.client.monitoring.NotificationChannel
...
trait UpdateMask extends StObject {
  ...
  /** Request body */
  var resource: NotificationChannel = js.native
...
object UpdateMask {
  ...
  @scala.inline
  def apply(name: String, resource: NotificationChannel): UpdateMask = {
  ...
  implicit class UpdateMaskMutableBuilder[Self <: UpdateMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: NotificationChannel): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
