...
import typingsSlinky.maximMazurokGapiClientMonitoring.gapi.client.monitoring.UptimeCheckConfig
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: UptimeCheckConfig = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: UptimeCheckConfig): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UptimeCheckConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
