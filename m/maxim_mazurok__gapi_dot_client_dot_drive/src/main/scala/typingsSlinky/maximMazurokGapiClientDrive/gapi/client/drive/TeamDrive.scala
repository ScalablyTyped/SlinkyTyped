...
import typingsSlinky.maximMazurokGapiClientDrive.anon.CanChangeCopyRequiresWriterPermissionRestriction
import typingsSlinky.maximMazurokGapiClientDrive.anon.CopyRequiresWriterPermission
...
object TeamDrive {
  ...
  implicit class TeamDriveMutableBuilder[Self <: TeamDrive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRestrictions(value: CopyRequiresWriterPermission): Self = StObject.set(x, "restrictions", value.asInstanceOf[js.Any])
