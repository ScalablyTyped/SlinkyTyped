...
import typingsSlinky.maximMazurokGapiClientDrive.gapi.client.drive.TeamDrive
...
object FieldsKey {
  ...
  @scala.inline
  def apply(requestId: String, resource: TeamDrive): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TeamDrive): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
