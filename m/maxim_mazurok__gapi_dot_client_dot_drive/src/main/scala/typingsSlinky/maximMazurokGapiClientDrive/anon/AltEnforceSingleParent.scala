...
@js.native
trait AltEnforceSingleParent extends StObject {
...
object AltEnforceSingleParent {
  
  @scala.inline
  def apply(): AltEnforceSingleParent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AltEnforceSingleParent]
  }
  
  @scala.inline
  implicit class AltEnforceSingleParentMutableBuilder[Self <: AltEnforceSingleParent] (val x: Self) extends AnyVal {
