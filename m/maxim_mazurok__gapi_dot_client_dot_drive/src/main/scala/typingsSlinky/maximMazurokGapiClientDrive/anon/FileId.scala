...
import typingsSlinky.maximMazurokGapiClientDrive.gapi.client.drive.Comment
...
trait FileId extends StObject {
  ...
  /** Request body */
  var resource: Comment = js.native
...
object FileId {
  ...
  @scala.inline
  def apply(fileId: String, resource: Comment): FileId = {
  ...
  implicit class FileIdMutableBuilder[Self <: FileId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Comment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
