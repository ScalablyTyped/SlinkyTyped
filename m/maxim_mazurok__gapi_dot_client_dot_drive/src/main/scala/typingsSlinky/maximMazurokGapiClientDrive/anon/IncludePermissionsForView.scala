...
@js.native
trait IncludePermissionsForView extends StObject {
...
object IncludePermissionsForView {
  ...
  @scala.inline
  def apply(resource: File): IncludePermissionsForView = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludePermissionsForView]
  }
  
  @scala.inline
  implicit class IncludePermissionsForViewMutableBuilder[Self <: IncludePermissionsForView] (val x: Self) extends AnyVal {
