...
import typingsSlinky.maximMazurokGapiClientDrive.gapi.client.drive.File
...
@js.native
trait EnforceSingleParent extends StObject {
...
object EnforceSingleParent {
  ...
  @scala.inline
  implicit class EnforceSingleParentMutableBuilder[Self <: EnforceSingleParent] (val x: Self) extends AnyVal {
