...
@js.native
trait GooglePrivacyDlpV2DeltaPresenceEstimationConfig extends js.Object {
...
object GooglePrivacyDlpV2DeltaPresenceEstimationConfig {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2DeltaPresenceEstimationConfigOps[Self <: GooglePrivacyDlpV2DeltaPresenceEstimationConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuxiliaryTablesVarargs(value: GooglePrivacyDlpV2StatisticalTable*): Self = this.set("auxiliaryTables", js.Array(value :_*))
    
    @scala.inline
    def setAuxiliaryTables(value: js.Array[GooglePrivacyDlpV2StatisticalTable]): Self = this.set("auxiliaryTables", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAuxiliaryTables: Self = this.set("auxiliaryTables", js.undefined)
    
    @scala.inline
    def setQuasiIdsVarargs(value: GooglePrivacyDlpV2QuasiId*): Self = this.set("quasiIds", js.Array(value :_*))
    
    @scala.inline
    def setQuasiIds(value: js.Array[GooglePrivacyDlpV2QuasiId]): Self = this.set("quasiIds", value.asInstanceOf[js.Any])
