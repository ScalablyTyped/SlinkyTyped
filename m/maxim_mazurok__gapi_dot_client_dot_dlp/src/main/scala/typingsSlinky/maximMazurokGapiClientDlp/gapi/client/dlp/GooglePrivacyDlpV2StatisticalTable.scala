...
object GooglePrivacyDlpV2StatisticalTable {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2StatisticalTableMutableBuilder[Self <: GooglePrivacyDlpV2StatisticalTable] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setQuasiIds(value: js.Array[GooglePrivacyDlpV2QuasiIdentifierField]): Self = StObject.set(x, "quasiIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setQuasiIdsUndefined: Self = StObject.set(x, "quasiIds", js.undefined)
    
    @scala.inline
    def setQuasiIdsVarargs(value: GooglePrivacyDlpV2QuasiIdentifierField*): Self = StObject.set(x, "quasiIds", js.Array(value :_*))
