...
@js.native
trait GooglePrivacyDlpV2StoredType extends js.Object {
...
object GooglePrivacyDlpV2StoredType {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2StoredTypeOps[Self <: GooglePrivacyDlpV2StoredType] (val x: Self) extends AnyVal {
