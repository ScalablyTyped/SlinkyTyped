...
@js.native
trait GooglePrivacyDlpV2KAnonymityHistogramBucket extends js.Object {
  ...
  var bucketValues: js.UndefOr[js.Array[GooglePrivacyDlpV2KAnonymityEquivalenceClass]] = js.native
...
object GooglePrivacyDlpV2KAnonymityHistogramBucket {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2KAnonymityHistogramBucketOps[Self <: GooglePrivacyDlpV2KAnonymityHistogramBucket] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBucketValuesVarargs(value: GooglePrivacyDlpV2KAnonymityEquivalenceClass*): Self = this.set("bucketValues", js.Array(value :_*))
    
    @scala.inline
    def setBucketValues(value: js.Array[GooglePrivacyDlpV2KAnonymityEquivalenceClass]): Self = this.set("bucketValues", value.asInstanceOf[js.Any])
