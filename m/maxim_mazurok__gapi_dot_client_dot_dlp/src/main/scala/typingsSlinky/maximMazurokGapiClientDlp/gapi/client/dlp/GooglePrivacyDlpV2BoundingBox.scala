...
@js.native
trait GooglePrivacyDlpV2BoundingBox extends js.Object {
...
object GooglePrivacyDlpV2BoundingBox {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2BoundingBoxOps[Self <: GooglePrivacyDlpV2BoundingBox] (val x: Self) extends AnyVal {
