...
@js.native
trait GooglePrivacyDlpV2HybridInspectDlpJobRequest extends js.Object {
...
object GooglePrivacyDlpV2HybridInspectDlpJobRequest {
  ...
  @scala.inline
  implicit class GooglePrivacyDlpV2HybridInspectDlpJobRequestOps[Self <: GooglePrivacyDlpV2HybridInspectDlpJobRequest] (val x: Self) extends AnyVal {
