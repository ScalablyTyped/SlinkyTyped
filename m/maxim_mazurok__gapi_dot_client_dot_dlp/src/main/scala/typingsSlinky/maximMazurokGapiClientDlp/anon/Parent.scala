...
import typingsSlinky.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateStoredInfoTypeRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateStoredInfoTypeRequest = js.native
...
object Parent {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2CreateStoredInfoTypeRequest): Parent = {
  ...
  implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CreateStoredInfoTypeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
