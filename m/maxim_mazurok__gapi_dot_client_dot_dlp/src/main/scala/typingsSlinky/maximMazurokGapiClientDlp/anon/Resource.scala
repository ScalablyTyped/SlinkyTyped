...
import typingsSlinky.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2DeidentifyContentRequest
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2DeidentifyContentRequest = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2DeidentifyContentRequest): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2DeidentifyContentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
