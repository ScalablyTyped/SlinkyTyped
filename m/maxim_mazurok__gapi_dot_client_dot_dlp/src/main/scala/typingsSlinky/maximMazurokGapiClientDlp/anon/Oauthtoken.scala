...
import typingsSlinky.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateInspectTemplateRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateInspectTemplateRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2CreateInspectTemplateRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2CreateInspectTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
