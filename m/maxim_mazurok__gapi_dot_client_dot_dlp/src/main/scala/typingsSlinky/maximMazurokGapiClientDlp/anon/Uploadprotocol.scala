...
import typingsSlinky.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2ReidentifyContentRequest
...
trait Uploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2ReidentifyContentRequest = js.native
...
object Uploadprotocol {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2ReidentifyContentRequest): Uploadprotocol = {
  ...
  implicit class UploadprotocolMutableBuilder[Self <: Uploadprotocol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2ReidentifyContentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
