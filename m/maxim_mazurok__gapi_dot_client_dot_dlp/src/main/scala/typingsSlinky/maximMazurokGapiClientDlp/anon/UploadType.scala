...
import typingsSlinky.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2InspectContentRequest
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2InspectContentRequest = js.native
...
object UploadType {
  ...
  @scala.inline
  def apply(parent: String, resource: GooglePrivacyDlpV2InspectContentRequest): UploadType = {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GooglePrivacyDlpV2InspectContentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
