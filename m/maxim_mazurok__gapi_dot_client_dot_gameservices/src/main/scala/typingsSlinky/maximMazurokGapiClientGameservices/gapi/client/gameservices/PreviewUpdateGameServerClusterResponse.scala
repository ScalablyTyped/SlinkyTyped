...
@js.native
trait PreviewUpdateGameServerClusterResponse extends js.Object {
...
object PreviewUpdateGameServerClusterResponse {
  ...
  @scala.inline
  implicit class PreviewUpdateGameServerClusterResponseOps[Self <: PreviewUpdateGameServerClusterResponse] (val x: Self) extends AnyVal {
