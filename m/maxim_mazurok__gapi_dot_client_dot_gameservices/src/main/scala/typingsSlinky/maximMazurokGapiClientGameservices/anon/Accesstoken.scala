...
import typingsSlinky.maximMazurokGapiClientGameservices.gapi.client.gameservices.GameServerConfig
...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: GameServerConfig = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(parent: String, resource: GameServerConfig): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GameServerConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
