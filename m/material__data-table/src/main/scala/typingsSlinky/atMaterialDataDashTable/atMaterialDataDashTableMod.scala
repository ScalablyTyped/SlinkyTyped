package typingsSlinky.atMaterialDataDashTable

import org.scalajs.dom.raw.Element
import typingsSlinky.atMaterialDataDashTable.adapterMod.MDCDataTableAdapter
...
object atMaterialDataDashTableMod extends js.Object {
  @js.native
  class MDCDataTable ()
    extends typingsSlinky.atMaterialDataDashTable.componentMod.MDCDataTable
  
  @js.native
  class MDCDataTableFoundation ()
    extends typingsSlinky.atMaterialDataDashTable.foundationMod.MDCDataTableFoundation {
  ...
  object MDCDataTable extends js.Object {
    def attachTo(root: Element): typingsSlinky.atMaterialDataDashTable.componentMod.MDCDataTable = js.native
  }
