...
import typingsSlinky.maximMazurokGapiClientReseller.gapi.client.reseller.Seats
...
object SubscriptionId {
  ...
  @scala.inline
  def apply(customerId: String, resource: Seats, subscriptionId: String): SubscriptionId = {
  ...
  implicit class SubscriptionIdMutableBuilder[Self <: SubscriptionId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Seats): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
