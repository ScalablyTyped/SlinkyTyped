...
import typingsSlinky.maximMazurokGapiClientReseller.gapi.client.reseller.ChangePlanRequest
...
object QuotaUser {
  ...
  implicit class QuotaUserOps[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ChangePlanRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
