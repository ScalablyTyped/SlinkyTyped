...
@js.native
trait DeletionType extends StObject {
  ...
  var deletionType: String = js.native
...
object DeletionType {
  ...
  @scala.inline
  def apply(customerId: String, deletionType: String, subscriptionId: String): DeletionType = {
    ...
    __obj.asInstanceOf[DeletionType]
  }
  
  @scala.inline
  implicit class DeletionTypeMutableBuilder[Self <: DeletionType] (val x: Self) extends AnyVal {
