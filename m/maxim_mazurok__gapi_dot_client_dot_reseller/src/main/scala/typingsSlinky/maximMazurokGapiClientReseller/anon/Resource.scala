...
import typingsSlinky.maximMazurokGapiClientReseller.gapi.client.reseller.RenewalSettings
...
trait Resource extends js.Object {
  ...
  /** Request body */
  var resource: RenewalSettings = js.native
...
object Resource {
  ...
  implicit class ResourceOps[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RenewalSettings): Self = this.set("resource", value.asInstanceOf[js.Any])
