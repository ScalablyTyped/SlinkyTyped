...
import typingsSlinky.maximMazurokGapiClientReseller.gapi.client.reseller.Customer
...
@js.native
trait CustomerAuthToken extends StObject {
  ...
  /** Request body */
  var resource: Customer = js.native
  
  /** Deprecated. Please use quotaUser instead. */
  var userIp: js.UndefOr[String] = js.native
}
object CustomerAuthToken {
  
  @scala.inline
  def apply(resource: Customer): CustomerAuthToken = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomerAuthToken]
  }
  
  @scala.inline
  implicit class CustomerAuthTokenMutableBuilder[Self <: CustomerAuthToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Customer): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
