...
@js.native
trait CustomerAuthToken extends js.Object {
...
object CustomerAuthToken {
  ...
  @scala.inline
  implicit class CustomerAuthTokenOps[Self <: CustomerAuthToken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Customer): Self = this.set("resource", value.asInstanceOf[js.Any])
