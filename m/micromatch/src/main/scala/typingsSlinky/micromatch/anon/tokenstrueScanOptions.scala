package typingsSlinky.micromatch.anon
...
trait tokenstrueScanOptions extends js.Object {
  ...
  /**
    ...
    * @default false
    */
  var tokens: js.UndefOr[`true` with Boolean] = js.native
  /**
...
object tokenstrueScanOptions {
  @scala.inline
  def apply(): tokenstrueScanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[tokenstrueScanOptions]
  }
  @scala.inline
  implicit class tokenstrueScanOptionsOps[Self <: tokenstrueScanOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTokens(value: `true` with Boolean): Self = {
        val ret = this.duplicate
