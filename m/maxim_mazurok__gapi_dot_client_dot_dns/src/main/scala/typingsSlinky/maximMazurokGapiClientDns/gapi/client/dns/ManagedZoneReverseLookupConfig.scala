...
@js.native
trait ManagedZoneReverseLookupConfig extends js.Object {
...
object ManagedZoneReverseLookupConfig {
  ...
  @scala.inline
  implicit class ManagedZoneReverseLookupConfigOps[Self <: ManagedZoneReverseLookupConfig] (val x: Self) extends AnyVal {
