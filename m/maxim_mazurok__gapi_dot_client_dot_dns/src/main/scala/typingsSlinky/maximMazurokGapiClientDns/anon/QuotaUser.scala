...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientDns.gapi.client.dns.Policy = js.native
...
object QuotaUser {
  ...
  @scala.inline
  def apply(project: String, resource: typingsSlinky.maximMazurokGapiClientDns.gapi.client.dns.Policy): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientDns.gapi.client.dns.Policy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
