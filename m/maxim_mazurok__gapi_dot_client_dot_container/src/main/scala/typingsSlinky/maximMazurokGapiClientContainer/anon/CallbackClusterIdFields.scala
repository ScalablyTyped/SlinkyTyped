...
@js.native
trait CallbackClusterIdFields extends js.Object {
...
object CallbackClusterIdFields {
  ...
  @scala.inline
  implicit class CallbackClusterIdFieldsOps[Self <: CallbackClusterIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetLegacyAbacRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
