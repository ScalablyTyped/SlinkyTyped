...
import typingsSlinky.maximMazurokGapiClientContainer.gapi.client.container.SetLegacyAbacRequest
...
@js.native
trait CallbackClusterIdFields extends StObject {
  ...
  /** Request body */
  var resource: SetLegacyAbacRequest = js.native
...
object CallbackClusterIdFields {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetLegacyAbacRequest, zone: String): CallbackClusterIdFields = {
    ...
    __obj.asInstanceOf[CallbackClusterIdFields]
  }
  
  @scala.inline
  implicit class CallbackClusterIdFieldsMutableBuilder[Self <: CallbackClusterIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetLegacyAbacRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
