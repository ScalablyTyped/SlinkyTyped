...
@js.native
trait AltCallbackClusterId extends StObject {
...
object AltCallbackClusterId {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, zone: String): AltCallbackClusterId = {
  ...
  @scala.inline
  implicit class AltCallbackClusterIdMutableBuilder[Self <: AltCallbackClusterId] (val x: Self) extends AnyVal {
