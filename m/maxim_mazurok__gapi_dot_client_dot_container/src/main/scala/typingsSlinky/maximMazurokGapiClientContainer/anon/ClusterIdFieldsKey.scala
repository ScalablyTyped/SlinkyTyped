...
import typingsSlinky.maximMazurokGapiClientContainer.gapi.client.container.SetLocationsRequest
...
@js.native
trait ClusterIdFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: SetLocationsRequest = js.native
...
object ClusterIdFieldsKey {
  
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetLocationsRequest, zone: String): ClusterIdFieldsKey = {
  ...
  @scala.inline
  implicit class ClusterIdFieldsKeyMutableBuilder[Self <: ClusterIdFieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetLocationsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
