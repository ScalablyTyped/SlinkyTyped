...
@js.native
trait ClusterIdFieldsKey extends js.Object {
...
object ClusterIdFieldsKey {
  ...
  @scala.inline
  implicit class ClusterIdFieldsKeyOps[Self <: ClusterIdFieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetLocationsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
