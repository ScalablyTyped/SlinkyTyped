...
import typingsSlinky.maximMazurokGapiClientContainer.gapi.client.container.SetMasterAuthRequest
...
trait QuotaUserResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: SetMasterAuthRequest = js.native
...
object QuotaUserResourceUploadType {
  ...
  @scala.inline
  def apply(clusterId: String, projectId: String, resource: SetMasterAuthRequest, zone: String): QuotaUserResourceUploadType = {
  ...
  implicit class QuotaUserResourceUploadTypeMutableBuilder[Self <: QuotaUserResourceUploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SetMasterAuthRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
