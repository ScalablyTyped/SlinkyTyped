...
@js.native
trait RollbackNodePoolUpgradeRequest extends js.Object {
...
object RollbackNodePoolUpgradeRequest {
  ...
  @scala.inline
  def apply(): RollbackNodePoolUpgradeRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RollbackNodePoolUpgradeRequest]
  }
  
  @scala.inline
  implicit class RollbackNodePoolUpgradeRequestOps[Self <: RollbackNodePoolUpgradeRequest] (val x: Self) extends AnyVal {
