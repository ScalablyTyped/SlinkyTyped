...
import typingsSlinky.atMaterialSnackbar.atMaterialSnackbarStrings.`MDCSnackbar:hide`
import typingsSlinky.atMaterialSnackbar.atMaterialSnackbarStrings.`MDCSnackbar:show`
