...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.node.httpMod.IncomingMessage */ Request, /* <: typingsSlinky.node.httpMod.ServerResponse */ Response](): Options[Request, Response] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[Request, Response]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _], /* <: typingsSlinky.node.httpMod.IncomingMessage */ Request, /* <: typingsSlinky.node.httpMod.ServerResponse */ Response] (val x: Self with (Options[Request, Response])) extends AnyVal {
    @scala.inline
