...
@js.native
trait MembershipsLevelListResponse extends js.Object {
...
object MembershipsLevelListResponse {
  ...
  @scala.inline
  implicit class MembershipsLevelListResponseOps[Self <: MembershipsLevelListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: MembershipsLevel*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[MembershipsLevel]): Self = this.set("items", value.asInstanceOf[js.Any])
