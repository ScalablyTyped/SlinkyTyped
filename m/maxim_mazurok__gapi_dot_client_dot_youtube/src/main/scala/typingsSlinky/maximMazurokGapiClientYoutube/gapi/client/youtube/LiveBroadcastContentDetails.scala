...
object LiveBroadcastContentDetails {
  ...
  implicit class LiveBroadcastContentDetailsOps[Self <: LiveBroadcastContentDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnableAutoStop(value: Boolean): Self = this.set("enableAutoStop", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEnableAutoStop: Self = this.set("enableAutoStop", js.undefined)
