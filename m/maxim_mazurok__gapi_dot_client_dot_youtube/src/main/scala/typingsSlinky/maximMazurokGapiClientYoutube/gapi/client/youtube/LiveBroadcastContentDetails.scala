...
trait LiveBroadcastContentDetails extends StObject {
  ...
  var enableAutoStop: js.UndefOr[Boolean] = js.native
...
object LiveBroadcastContentDetails {
  ...
  implicit class LiveBroadcastContentDetailsMutableBuilder[Self <: LiveBroadcastContentDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnableAutoStop(value: Boolean): Self = StObject.set(x, "enableAutoStop", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnableAutoStopUndefined: Self = StObject.set(x, "enableAutoStop", js.undefined)
