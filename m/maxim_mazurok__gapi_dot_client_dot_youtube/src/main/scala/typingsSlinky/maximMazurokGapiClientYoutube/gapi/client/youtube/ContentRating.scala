...
trait ContentRating extends StObject {
  ...
  var nmcRating: js.UndefOr[String] = js.native
...
object ContentRating {
  ...
  implicit class ContentRatingMutableBuilder[Self <: ContentRating] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNmcRating(value: String): Self = StObject.set(x, "nmcRating", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNmcRatingUndefined: Self = StObject.set(x, "nmcRating", js.undefined)
