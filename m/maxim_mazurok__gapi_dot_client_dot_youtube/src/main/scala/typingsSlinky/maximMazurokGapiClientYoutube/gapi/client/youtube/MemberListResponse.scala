...
@js.native
trait MemberListResponse extends js.Object {
...
object MemberListResponse {
  ...
  @scala.inline
  implicit class MemberListResponseOps[Self <: MemberListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Member*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Member]): Self = this.set("items", value.asInstanceOf[js.Any])
