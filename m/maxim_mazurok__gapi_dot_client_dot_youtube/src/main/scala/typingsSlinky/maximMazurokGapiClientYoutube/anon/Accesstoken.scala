...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.AbuseReport
...
trait Accesstoken extends StObject {
  ...
  /** Request body */
  var resource: AbuseReport = js.native
...
object Accesstoken {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: AbuseReport): Accesstoken = {
  ...
  implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: AbuseReport): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
