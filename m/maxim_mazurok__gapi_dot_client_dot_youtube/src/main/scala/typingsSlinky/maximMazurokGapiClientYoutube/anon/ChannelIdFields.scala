...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.InvideoBranding
...
@js.native
trait ChannelIdFields extends StObject {
  ...
  /** Request body */
  var resource: InvideoBranding = js.native
...
object ChannelIdFields {
  ...
  @scala.inline
  def apply(channelId: String, resource: InvideoBranding): ChannelIdFields = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChannelIdFields]
  }
  
  @scala.inline
  implicit class ChannelIdFieldsMutableBuilder[Self <: ChannelIdFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InvideoBranding): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
