...
@js.native
trait FieldsHl extends StObject {
...
object FieldsHl {
  ...
  @scala.inline
  def apply(part: String | js.Array[String]): FieldsHl = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsHl]
  }
  
  @scala.inline
  implicit class FieldsHlMutableBuilder[Self <: FieldsHl] (val x: Self) extends AnyVal {
