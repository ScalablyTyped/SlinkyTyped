...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.CommentThread
...
trait AltCallback extends StObject {
  ...
  /** Request body */
  var resource: CommentThread = js.native
...
object AltCallback {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: CommentThread): AltCallback = {
  ...
  implicit class AltCallbackMutableBuilder[Self <: AltCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CommentThread): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
