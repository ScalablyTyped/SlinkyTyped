...
@js.native
trait PartPrettyPrint extends js.Object {
...
object PartPrettyPrint {
  ...
  @scala.inline
  implicit class PartPrettyPrintOps[Self <: PartPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveChatModerator): Self = this.set("resource", value.asInstanceOf[js.Any])
