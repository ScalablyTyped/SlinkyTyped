...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveChatModerator
...
@js.native
trait PartPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: LiveChatModerator = js.native
...
object PartPrettyPrint {
  
  @scala.inline
  def apply(part: String | js.Array[String], resource: LiveChatModerator): PartPrettyPrint = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PartPrettyPrint]
  }
  
  @scala.inline
  implicit class PartPrettyPrintMutableBuilder[Self <: PartPrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveChatModerator): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
