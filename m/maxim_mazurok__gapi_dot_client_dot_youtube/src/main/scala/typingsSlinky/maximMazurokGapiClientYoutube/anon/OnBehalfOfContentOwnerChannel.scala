...
@js.native
trait OnBehalfOfContentOwnerChannel extends StObject {
...
object OnBehalfOfContentOwnerChannel {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: ChannelSection): OnBehalfOfContentOwnerChannel = {
  ...
  @scala.inline
  implicit class OnBehalfOfContentOwnerChannelMutableBuilder[Self <: OnBehalfOfContentOwnerChannel] (val x: Self) extends AnyVal {
