...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.TestItem
...
trait ResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: TestItem = js.native
...
object ResourceUploadType {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: TestItem): ResourceUploadType = {
  ...
  implicit class ResourceUploadTypeMutableBuilder[Self <: ResourceUploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TestItem): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
