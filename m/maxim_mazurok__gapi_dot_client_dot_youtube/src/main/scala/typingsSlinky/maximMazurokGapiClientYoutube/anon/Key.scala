...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.Caption
...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: Caption = js.native
...
object Key {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: Caption): Key = {
  ...
  implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Caption): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
