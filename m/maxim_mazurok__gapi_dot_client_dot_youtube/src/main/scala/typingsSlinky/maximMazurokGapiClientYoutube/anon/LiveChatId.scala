...
@js.native
trait LiveChatId extends StObject {
...
object LiveChatId {
  ...
  @scala.inline
  def apply(liveChatId: String, part: String | js.Array[String]): LiveChatId = {
  ...
  @scala.inline
  implicit class LiveChatIdMutableBuilder[Self <: LiveChatId] (val x: Self) extends AnyVal {
