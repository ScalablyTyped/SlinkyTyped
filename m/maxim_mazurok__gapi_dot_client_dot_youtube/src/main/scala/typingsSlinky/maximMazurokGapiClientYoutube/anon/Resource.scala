...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.ChannelSection
...
trait Resource extends StObject {
  ...
  /** Request body */
  var resource: ChannelSection = js.native
...
object Resource {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: ChannelSection): Resource = {
  ...
  implicit class ResourceMutableBuilder[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ChannelSection): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
