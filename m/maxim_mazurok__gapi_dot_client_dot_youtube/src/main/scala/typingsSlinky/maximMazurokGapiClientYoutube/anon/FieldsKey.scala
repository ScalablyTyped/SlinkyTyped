...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveBroadcast
...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: LiveBroadcast = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(part: String | js.Array[String], resource: LiveBroadcast): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveBroadcast): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
