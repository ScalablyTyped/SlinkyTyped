...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveStream
...
@js.native
trait OauthtokenOnBehalfOfContentOwner extends StObject {
  ...
  /** Request body */
  var resource: LiveStream = js.native
...
object OauthtokenOnBehalfOfContentOwner {
  
  @scala.inline
  def apply(part: String | js.Array[String], resource: LiveStream): OauthtokenOnBehalfOfContentOwner = {
  ...
  @scala.inline
  implicit class OauthtokenOnBehalfOfContentOwnerMutableBuilder[Self <: OauthtokenOnBehalfOfContentOwner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveStream): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
