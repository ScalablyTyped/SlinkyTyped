...
@js.native
trait OauthtokenOnBehalfOfContentOwner extends js.Object {
...
object OauthtokenOnBehalfOfContentOwner {
  ...
  @scala.inline
  implicit class OauthtokenOnBehalfOfContentOwnerOps[Self <: OauthtokenOnBehalfOfContentOwner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LiveStream): Self = this.set("resource", value.asInstanceOf[js.Any])
