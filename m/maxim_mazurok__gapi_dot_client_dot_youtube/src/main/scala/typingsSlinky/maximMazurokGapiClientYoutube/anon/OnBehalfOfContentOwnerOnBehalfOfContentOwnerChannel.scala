...
import typingsSlinky.maximMazurokGapiClientYoutube.gapi.client.youtube.Playlist
...
@js.native
trait OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel extends StObject {
...
object OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel {
  
  @scala.inline
  def apply(part: String | js.Array[String], resource: Playlist): OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel]
  }
  
  @scala.inline
  implicit class OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannelMutableBuilder[Self <: OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel] (val x: Self) extends AnyVal {
