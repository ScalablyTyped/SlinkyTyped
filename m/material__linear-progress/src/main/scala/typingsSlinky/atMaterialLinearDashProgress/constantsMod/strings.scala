...
import typingsSlinky.atMaterialLinearDashProgress.atMaterialLinearDashProgressStrings.`Dotmdc-linear-progress__buffer`
import typingsSlinky.atMaterialLinearDashProgress.atMaterialLinearDashProgressStrings.`Dotmdc-linear-progress__primary-bar`
