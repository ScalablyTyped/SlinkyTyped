...
object atMaterialLinearDashProgressStrings {
  ...
  @js.native
  sealed trait `mdc-linear-progress--indeterminate` extends js.Object
  ...
  @scala.inline
  def `mdc-linear-progress--indeterminate`: `mdc-linear-progress--indeterminate` = "mdc-linear-progress--indeterminate".asInstanceOf[`mdc-linear-progress--indeterminate`]
  @scala.inline
  def `mdc-linear-progress--reversed`: `mdc-linear-progress--reversed` = "mdc-linear-progress--reversed".asInstanceOf[`mdc-linear-progress--reversed`]
}
