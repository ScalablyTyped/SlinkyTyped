...
object CustomTheme {
  ...
  implicit class CustomThemeOps[Self <: CustomTheme] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPlaintextPath(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("plaintextPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPlaintextPath: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("plaintextPath")(js.undefined)
        ret
    }
  }
