...
object observablemapMod {
  ...
  */
  ...
  object IMapDidChange {
    ...
    @scala.inline
    def Name[K, V](name: K, newValue: V, `object`: ObservableMap[K, V], oldValue: V, `type`: update): typingsSlinky.mobx.anon.Name[K, V] = {
      ...
      __obj.asInstanceOf[typingsSlinky.mobx.anon.Name[K, V]]
    }
    
    @scala.inline
    def NewValue[K, V](name: K, newValue: V, `object`: ObservableMap[K, V], `type`: add): typingsSlinky.mobx.anon.NewValue[K, V] = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], newValue = newValue.asInstanceOf[js.Any])
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mobx.anon.NewValue[K, V]]
    }
    
    @scala.inline
    def Object[K, V](name: K, `object`: ObservableMap[K, V], oldValue: V, `type`: delete): typingsSlinky.mobx.anon.Object[K, V] = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], oldValue = oldValue.asInstanceOf[js.Any])
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mobx.anon.Object[K, V]]
    }
  }
