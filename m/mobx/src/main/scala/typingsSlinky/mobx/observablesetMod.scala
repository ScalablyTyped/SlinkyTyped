...
object observablesetMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.mobx.AnonNewValueObject[T]
    - typingsSlinky.mobx.AnonObjectOldValue[T]
  */
  trait ISetDidChange[T] extends js.Object
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.mobx.AnonOldValueType[T]
    - typingsSlinky.mobx.AnonNewValueObjectType[T]
  */
