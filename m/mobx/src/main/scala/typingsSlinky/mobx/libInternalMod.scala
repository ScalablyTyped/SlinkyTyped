...
object libInternalMod extends js.Object {
  ...
  /**
    ...
    */
  class Atom ()
    extends typingsSlinky.mobx.libCoreAtomMod.Atom {
    def this(name: String) = this()
  }
  
  @js.native
  class CaughtException protected ()
    extends typingsSlinky.mobx.libCoreDerivationMod.CaughtException {
    def this(cause: js.Any) = this()
  }
  
  @js.native
  class ComputedValue[T] protected ()
    extends typingsSlinky.mobx.libCoreComputedvalueMod.ComputedValue[T] {
    /**
  ...
  @js.native
  class MobXGlobals ()
    extends typingsSlinky.mobx.libCoreGlobalstateMod.MobXGlobals
  
  @js.native
  class ObservableMap[K, V] ()
    extends typingsSlinky.mobx.libTypesObservablemapMod.ObservableMap[K, V] {
  ...
  class ObservableObjectAdministration protected ()
    extends typingsSlinky.mobx.libTypesObservableobjectMod.ObservableObjectAdministration {
    def this(
      target: js.Any,
  ...
  class ObservableSet[T] ()
    extends typingsSlinky.mobx.libTypesObservablesetMod.ObservableSet[T] {
  ...
  class ObservableValue[T] protected ()
    extends typingsSlinky.mobx.libTypesObservablevalueMod.ObservableValue[T] {
  ...
  class Reaction protected ()
    extends typingsSlinky.mobx.libCoreReactionMod.Reaction {
  ...
  var globalState: typingsSlinky.mobx.libCoreGlobalstateMod.MobXGlobals = js.native
  ...
  def asObservableObject(target: js.Any): typingsSlinky.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  def asObservableObject(target: js.Any, name: PropertyKey): typingsSlinky.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  def asObservableObject(target: js.Any, name: PropertyKey, defaultEnhancer: IEnhancer[_]): typingsSlinky.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  ...
  object TraceMode extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.mobx.libCoreDerivationMod.TraceMode with Double] = js.native
  }
