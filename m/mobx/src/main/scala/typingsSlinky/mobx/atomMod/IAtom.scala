...
object IAtom {
  ...
  implicit class IAtomOps[Self <: IAtom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReportChanged(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reportChanged")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withReportObserved(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reportObserved")(js.Any.fromFunction0(value))
        ret
    }
  }
