...
import typingsSlinky.mobx.decoratorsMod.PropertyCreator
...
object internalMod {
  ...
  /**
    ...
    */
  class Atom ()
    extends typingsSlinky.mobx.atomMod.Atom {
  ...
  class CaughtException protected ()
    extends typingsSlinky.mobx.derivationMod.CaughtException {
  ...
  class ComputedValue[T] protected ()
    extends typingsSlinky.mobx.computedvalueMod.ComputedValue[T] {
    /**
  ...
  @js.native
  class MobXGlobals ()
    extends typingsSlinky.mobx.globalstateMod.MobXGlobals
  ...
  object TraceMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.mobx.derivationMod.TraceMode with Double] = js.native
    
    /* 2 */ val BREAK: typingsSlinky.mobx.derivationMod.TraceMode.BREAK with Double = js.native
    
    /* 1 */ val LOG: typingsSlinky.mobx.derivationMod.TraceMode.LOG with Double = js.native
    
    /* 0 */ val NONE: typingsSlinky.mobx.derivationMod.TraceMode.NONE with Double = js.native
  }
  ...
  @js.native
  def asObservableObject(target: js.Any): typingsSlinky.mobx.observableobjectMod.ObservableObjectAdministration = js.native
  @JSImport("mobx/lib/internal", "asObservableObject")
  @js.native
  def asObservableObject(target: js.Any, name: js.UndefOr[PropertyKey], defaultEnhancer: IEnhancer[_]): typingsSlinky.mobx.observableobjectMod.ObservableObjectAdministration = js.native
  @JSImport("mobx/lib/internal", "asObservableObject")
  @js.native
  def asObservableObject(target: js.Any, name: PropertyKey): typingsSlinky.mobx.observableobjectMod.ObservableObjectAdministration = js.native
  ...
  @js.native
  def getObservers(observable: IObservable): typingsSlinky.std.Set[IDerivation] = js.native
  ...
  @js.native
  def globalState: typingsSlinky.mobx.globalstateMod.MobXGlobals = js.native
  @scala.inline
  def globalState_=(x: typingsSlinky.mobx.globalstateMod.MobXGlobals): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalState")(x.asInstanceOf[js.Any])
  ...
  object observable {
    ...
    @JSImport("mobx/lib/internal", "observable")
    @js.native
    def apply[T](value: typingsSlinky.std.Set[T]): ObservableSet[T] = js.native
    @JSImport("mobx/lib/internal", "observable")
    @js.native
    def apply[T](value: typingsSlinky.std.Set[T], options: CreateObservableOptions): ObservableSet[T] = js.native
    @JSImport("mobx/lib/internal", "observable")
    @js.native
