...
import typingsSlinky.maximMazurokGapiClientStorage.anon.ProjectNumber
...
object BucketAccessControl {
  ...
  @scala.inline
  implicit class BucketAccessControlMutableBuilder[Self <: BucketAccessControl] (val x: Self) extends AnyVal {
