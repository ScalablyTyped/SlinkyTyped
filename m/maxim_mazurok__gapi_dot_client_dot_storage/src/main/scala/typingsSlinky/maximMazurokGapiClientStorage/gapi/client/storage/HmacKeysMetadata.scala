...
@js.native
trait HmacKeysMetadata extends js.Object {
...
object HmacKeysMetadata {
  ...
  @scala.inline
  implicit class HmacKeysMetadataOps[Self <: HmacKeysMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: HmacKeyMetadata*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[HmacKeyMetadata]): Self = this.set("items", value.asInstanceOf[js.Any])
