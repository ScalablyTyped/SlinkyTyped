...
import typingsSlinky.maximMazurokGapiClientStorage.anon.EncryptionAlgorithm
...
trait Object extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientStorage.maximMazurokGapiClientStorageStrings.Object with TopLevel[js.Any]
  ] = js.native
