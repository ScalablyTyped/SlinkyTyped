...
@js.native
trait IfGenerationMatchIfGenerationNotMatch extends js.Object {
...
object IfGenerationMatchIfGenerationNotMatch {
  ...
  @scala.inline
  implicit class IfGenerationMatchIfGenerationNotMatchOps[Self <: IfGenerationMatchIfGenerationNotMatch] (val x: Self) extends AnyVal {
