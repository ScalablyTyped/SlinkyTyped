...
@js.native
trait FieldsGeneration extends StObject {
...
object FieldsGeneration {
  
  @scala.inline
  def apply(bucket: String, `object`: String, resource: ObjectAccessControl): FieldsGeneration = {
  ...
  @scala.inline
  implicit class FieldsGenerationMutableBuilder[Self <: FieldsGeneration] (val x: Self) extends AnyVal {
