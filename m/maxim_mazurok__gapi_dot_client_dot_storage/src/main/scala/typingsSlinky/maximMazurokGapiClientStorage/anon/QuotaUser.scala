...
import typingsSlinky.maximMazurokGapiClientStorage.gapi.client.storage.Policy
...
object QuotaUser {
  ...
  @scala.inline
  def apply(bucket: String, resource: Policy): QuotaUser = {
  ...
  implicit class QuotaUserMutableBuilder[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Policy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
