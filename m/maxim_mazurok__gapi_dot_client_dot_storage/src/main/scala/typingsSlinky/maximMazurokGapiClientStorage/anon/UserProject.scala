...
@js.native
trait UserProject extends StObject {
...
object UserProject {
  ...
  @scala.inline
  def apply(bucket: String, resource: ObjectAccessControl): UserProject = {
  ...
  @scala.inline
  implicit class UserProjectMutableBuilder[Self <: UserProject] (val x: Self) extends AnyVal {
