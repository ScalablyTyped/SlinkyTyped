...
trait ContentEncoding extends StObject {
  ...
  var resource: typingsSlinky.maximMazurokGapiClientStorage.gapi.client.storage.Object = js.native
...
object ContentEncoding {
  ...
  @scala.inline
  def apply(bucket: String, resource: typingsSlinky.maximMazurokGapiClientStorage.gapi.client.storage.Object): ContentEncoding = {
  ...
  implicit class ContentEncodingMutableBuilder[Self <: ContentEncoding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: typingsSlinky.maximMazurokGapiClientStorage.gapi.client.storage.Object): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
