...
@js.native
trait DestinationObject extends StObject {
...
object DestinationObject {
  ...
  @scala.inline
  def apply(destinationBucket: String, destinationObject: String): DestinationObject = {
    ...
    __obj.asInstanceOf[DestinationObject]
  }
  
  @scala.inline
  implicit class DestinationObjectMutableBuilder[Self <: DestinationObject] (val x: Self) extends AnyVal {
