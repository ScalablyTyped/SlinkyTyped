...
@js.native
trait GenerationIfGenerationMatch extends StObject {
...
object GenerationIfGenerationMatch {
  
  @scala.inline
  def apply(bucket: String, `object`: String): GenerationIfGenerationMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenerationIfGenerationMatch]
  }
  
  @scala.inline
  implicit class GenerationIfGenerationMatchMutableBuilder[Self <: GenerationIfGenerationMatch] (val x: Self) extends AnyVal {
