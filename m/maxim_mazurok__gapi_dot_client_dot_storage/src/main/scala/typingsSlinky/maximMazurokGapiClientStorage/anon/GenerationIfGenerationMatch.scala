...
@js.native
trait GenerationIfGenerationMatch extends js.Object {
...
object GenerationIfGenerationMatch {
  ...
  @scala.inline
  implicit class GenerationIfGenerationMatchOps[Self <: GenerationIfGenerationMatch] (val x: Self) extends AnyVal {
