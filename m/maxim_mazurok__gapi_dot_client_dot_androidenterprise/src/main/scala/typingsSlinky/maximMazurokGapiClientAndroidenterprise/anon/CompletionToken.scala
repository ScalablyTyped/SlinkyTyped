...
@js.native
trait CompletionToken extends StObject {
...
object CompletionToken {
  ...
  @scala.inline
  def apply(): CompletionToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CompletionToken]
  }
  
  @scala.inline
  implicit class CompletionTokenMutableBuilder[Self <: CompletionToken] (val x: Self) extends AnyVal {
