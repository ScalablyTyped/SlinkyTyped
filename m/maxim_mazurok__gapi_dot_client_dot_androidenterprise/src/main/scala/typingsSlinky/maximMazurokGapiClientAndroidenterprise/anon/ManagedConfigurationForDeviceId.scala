...
@js.native
trait ManagedConfigurationForDeviceId extends StObject {
...
object ManagedConfigurationForDeviceId {
  ...
  @scala.inline
  def apply(deviceId: String, enterpriseId: String, managedConfigurationForDeviceId: String, userId: String): ManagedConfigurationForDeviceId = {
  ...
  @scala.inline
  implicit class ManagedConfigurationForDeviceIdMutableBuilder[Self <: ManagedConfigurationForDeviceId] (val x: Self) extends AnyVal {
