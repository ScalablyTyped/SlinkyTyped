package typingsSlinky.maximMazurokGapiClientYoutubeanalytics.anon

import typingsSlinky.maximMazurokGapiClientYoutubeanalytics.gapi.client.youtubeanalytics.GroupItem
...
object Alt {
  ...
  implicit class AltOps[Self <: Alt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GroupItem): Self = this.set("resource", value.asInstanceOf[js.Any])
