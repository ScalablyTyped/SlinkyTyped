      ...
      object MulterS3 {
        ...
        object File {
          ...
          def apply(
            ...
            storageClass: String,
            stream: Readable
          ): typingsSlinky.multerS3.mod.global.Express.MulterS3.File = {
            ...
            __obj.asInstanceOf[typingsSlinky.multerS3.mod.global.Express.MulterS3.File]
          }
          
          @scala.inline
          implicit class FileMutableBuilder[Self <: typingsSlinky.multerS3.mod.global.Express.MulterS3.File] (val x: Self) extends AnyVal {
