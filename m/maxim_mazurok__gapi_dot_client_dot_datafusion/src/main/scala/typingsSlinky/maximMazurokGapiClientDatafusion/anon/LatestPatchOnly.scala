package typingsSlinky.maximMazurokGapiClientDatafusion.anon
...
@js.native
trait LatestPatchOnly extends js.Object {
...
object LatestPatchOnly {
  ...
  @scala.inline
  implicit class LatestPatchOnlyOps[Self <: LatestPatchOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestPatchOnly(value: Boolean): Self = this.set("latestPatchOnly", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLatestPatchOnly: Self = this.set("latestPatchOnly", js.undefined)
