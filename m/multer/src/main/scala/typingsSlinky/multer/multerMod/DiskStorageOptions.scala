package typingsSlinky.multer.multerMod

import typingsSlinky.multer.multerMod._Global_.Express.Multer.File
import typingsSlinky.multer.multerMod._Global_.Express.Request
...
object DiskStorageOptions {
  ...
  def apply(
    ...
    filename: (/* req */ Request, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => Unit = null
  ): DiskStorageOptions = {
