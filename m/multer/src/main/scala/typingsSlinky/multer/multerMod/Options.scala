...
import typingsSlinky.multer.Anon_FieldNameSize
...
object Options {
  ...
  def apply(
    dest: String = null,
    fileFilter: (/* req */ Request, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* acceptFile */ Boolean, Unit]) => Unit = null,
