...
object ^ extends js.Object {
  ...
  {[ K in MappedObjectKeyType ]: MappedObjectValueType}
    */ typingsSlinky.mapObj.mapObjStrings.^  with TopLevel[js.Any] = js.native
  ...
  ): TargetObjectType with typingsSlinky.mapObj.mapObjStrings.^  with TopLevel[js.Any] = js.native
}
