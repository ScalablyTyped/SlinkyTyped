...
object ^ extends js.Object {
  ...
  {[ K in MappedObjectKeyType ]: MappedObjectValueType}
    */ typingsSlinky.mapDashObj.mapDashObjStrings.^  with js.Any = js.native
  ...
  ): TargetObjectType with typingsSlinky.mapDashObj.mapDashObjStrings.^  with js.Any = js.native
}
