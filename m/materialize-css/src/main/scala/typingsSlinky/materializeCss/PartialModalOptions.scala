...
object PartialModalOptions {
  ...
  implicit class PartialModalOptionsOps[Self <: PartialModalOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnCloseEnd(value: js.ThisFunction1[PartialModalOptions, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnCloseStart(value: js.ThisFunction1[PartialModalOptions, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpenEnd(value: js.ThisFunction1[PartialModalOptions, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpenStart(value: js.ThisFunction1[PartialModalOptions, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
