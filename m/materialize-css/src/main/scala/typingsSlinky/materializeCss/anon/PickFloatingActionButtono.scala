...
@js.native
trait PickFloatingActionButtono extends js.Object {
...
object PickFloatingActionButtono {
  @scala.inline
  def apply(): PickFloatingActionButtono = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickFloatingActionButtono]
  }
  @scala.inline
  implicit class PickFloatingActionButtonoOps[Self <: PickFloatingActionButtono] (val x: Self) extends AnyVal {
    @scala.inline
