...
object PartialChipsOptionsAutocompleteOptions {
  ...
  implicit class PartialChipsOptionsAutocompleteOptionsOps[Self <: PartialChipsOptionsAutocompleteOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChipAdd(value: js.ThisFunction2[/* this */ Chips, /* element */ Element, /* chip */ Element, Unit]): Self = this.set("onChipAdd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnChipAdd: Self = this.set("onChipAdd", js.undefined)
    @scala.inline
    def setOnChipDelete(value: js.ThisFunction2[/* this */ Chips, /* element */ Element, /* chip */ Element, Unit]): Self = this.set("onChipDelete", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnChipDelete: Self = this.set("onChipDelete", js.undefined)
    @scala.inline
    def setOnChipSelect(value: js.ThisFunction2[/* this */ Chips, /* element */ Element, /* chip */ Element, Unit]): Self = this.set("onChipSelect", value.asInstanceOf[js.Any])
    @scala.inline
