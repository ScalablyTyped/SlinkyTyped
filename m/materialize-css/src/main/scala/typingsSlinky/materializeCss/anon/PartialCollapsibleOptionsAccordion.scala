...
import typingsSlinky.materializeCss.M.Collapsible
...
object PartialCollapsibleOptionsAccordion {
  ...
  implicit class PartialCollapsibleOptionsAccordionOps[Self <: PartialCollapsibleOptionsAccordion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCloseEnd(value: js.ThisFunction1[/* this */ Collapsible, /* el */ Element, Unit]): Self = this.set("onCloseEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnCloseEnd: Self = this.set("onCloseEnd", js.undefined)
    @scala.inline
    def setOnCloseStart(value: js.ThisFunction1[/* this */ Collapsible, /* el */ Element, Unit]): Self = this.set("onCloseStart", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnCloseStart: Self = this.set("onCloseStart", js.undefined)
    @scala.inline
    def setOnOpenEnd(value: js.ThisFunction1[/* this */ Collapsible, /* el */ Element, Unit]): Self = this.set("onOpenEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnOpenEnd: Self = this.set("onOpenEnd", js.undefined)
    @scala.inline
    def setOnOpenStart(value: js.ThisFunction1[/* this */ Collapsible, /* el */ Element, Unit]): Self = this.set("onOpenStart", value.asInstanceOf[js.Any])
    @scala.inline
