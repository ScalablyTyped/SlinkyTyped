...
import typingsSlinky.materializeCss.M.Materialbox
...
object PartialMaterialboxOptionsInDuration {
  ...
  implicit class PartialMaterialboxOptionsInDurationOps[Self <: PartialMaterialboxOptionsInDuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnCloseEnd(value: js.ThisFunction1[/* this */ Materialbox, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnCloseStart(value: js.ThisFunction1[/* this */ Materialbox, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpenEnd(value: js.ThisFunction1[/* this */ Materialbox, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOpenStart(value: js.ThisFunction1[/* this */ Materialbox, /* el */ Element, Unit]): Self = {
        val ret = this.duplicate
