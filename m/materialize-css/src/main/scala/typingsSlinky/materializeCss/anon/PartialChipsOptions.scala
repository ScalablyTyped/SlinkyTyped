...
object PartialChipsOptions {
  ...
  implicit class PartialChipsOptionsOps[Self <: PartialChipsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnChipAdd(value: js.ThisFunction2[PartialChipsOptions, /* element */ Element, /* chip */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChipDelete(value: js.ThisFunction2[PartialChipsOptions, /* element */ Element, /* chip */ Element, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChipSelect(value: js.ThisFunction2[PartialChipsOptions, /* element */ Element, /* chip */ Element, Unit]): Self = {
        val ret = this.duplicate
