...
object PartialDatepickerOptions {
  ...
  implicit class PartialDatepickerOptionsMutableBuilder[Self <: PartialDatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableDayFn(value: /* day */ js.Date => Boolean): Self = StObject.set(x, "disableDayFn", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSelect(value: js.ThisFunction1[/* this */ Datepicker, /* selectedDate */ js.Date, Unit]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
    
    @scala.inline
    def setParse(value: (/* value */ String, /* format */ String) => js.Date): Self = StObject.set(x, "parse", js.Any.fromFunction2(value))
