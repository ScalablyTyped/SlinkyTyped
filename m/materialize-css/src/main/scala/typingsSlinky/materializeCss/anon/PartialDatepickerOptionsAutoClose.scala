...
import typingsSlinky.materializeCss.M.Datepicker
...
object PartialDatepickerOptionsAutoClose {
  ...
  implicit class PartialDatepickerOptionsAutoCloseOps[Self <: PartialDatepickerOptionsAutoClose] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableDayFn(value: /* day */ js.Date => Boolean): Self = this.set("disableDayFn", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnClose(value: js.ThisFunction0[/* this */ Datepicker, Unit]): Self = this.set("onClose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnClose: Self = this.set("onClose", js.undefined)
    
    @scala.inline
    def setOnDraw(value: js.ThisFunction0[/* this */ Datepicker, Unit]): Self = this.set("onDraw", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnDraw: Self = this.set("onDraw", js.undefined)
    
    @scala.inline
    def setOnOpen(value: js.ThisFunction0[/* this */ Datepicker, Unit]): Self = this.set("onOpen", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnOpen: Self = this.set("onOpen", js.undefined)
    
    @scala.inline
    def setOnSelect(value: js.ThisFunction1[/* this */ Datepicker, /* selectedDate */ js.Date, Unit]): Self = this.set("onSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOnSelect: Self = this.set("onSelect", js.undefined)
    
    @scala.inline
    def setParse(value: (/* value */ String, /* format */ String) => js.Date): Self = this.set("parse", js.Any.fromFunction2(value))
