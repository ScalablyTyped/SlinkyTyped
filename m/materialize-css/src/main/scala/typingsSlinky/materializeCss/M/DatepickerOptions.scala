...
object DatepickerOptions {
  ...
  implicit class DatepickerOptionsOps[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableDayFn(value: js.Date => Boolean): Self = this.set("disableDayFn", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnSelect(value: js.Date => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
    def setParse(value: (String, String) => js.Date): Self = this.set("parse", js.Any.fromFunction2(value))
    @scala.inline
