...
object Collapsible extends js.Object {
  ...
  /**
    * Init Collapsible
    */
  def init(els: typingsSlinky.std.Element): Collapsible = js.native
  def init(els: typingsSlinky.std.Element, options: Partial[CollapsibleOptions]): Collapsible = js.native
}
