...
object Timepicker extends js.Object {
  ...
  /**
    * Init Timepicker
    */
  def init(els: typingsSlinky.std.Element): Timepicker = js.native
  def init(els: typingsSlinky.std.Element, options: Partial[TimepickerOptions]): Timepicker = js.native
}
