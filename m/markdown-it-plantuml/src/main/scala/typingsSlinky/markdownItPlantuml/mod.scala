package typingsSlinky.markdownItPlantuml

import org.scalablytyped.runtime.Shortcut
import typingsSlinky.markdownIt.libMod.PluginWithOptions
import typingsSlinky.markdownIt.rendererMod.RenderRule
import typingsSlinky.markdownIt.rendererMod.Renderer
...
object mod extends Shortcut {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRender(
        value: (/* tokens */ js.Array[typingsSlinky.markdownIt.tokenMod.^], /* idx */ Double, /* options */ typingsSlinky.markdownIt.libMod.Options, /* env */ js.Any, /* self */ Renderer) => String
