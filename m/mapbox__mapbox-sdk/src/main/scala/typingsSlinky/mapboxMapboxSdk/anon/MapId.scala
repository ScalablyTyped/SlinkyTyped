...
object MapId {
  ...
  implicit class MapIdOps[Self <: MapId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTilesetName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tilesetName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTilesetName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tilesetName")(js.undefined)
        ret
    }
  }
