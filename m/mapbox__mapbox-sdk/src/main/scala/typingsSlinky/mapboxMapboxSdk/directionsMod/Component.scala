...
object Component {
  ...
  implicit class ComponentOps[Self <: Component] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAbbr_priority(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("abbr_priority")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAbbr_priority: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("abbr_priority")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withImageBaseURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageBaseURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutImageBaseURL: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageBaseURL")(js.undefined)
        ret
    }
  }
