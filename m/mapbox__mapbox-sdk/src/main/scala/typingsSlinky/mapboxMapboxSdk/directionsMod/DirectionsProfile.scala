...
object DirectionsProfile {
  ...
  @scala.inline
  def `driving-traffic`: typingsSlinky.mapboxMapboxSdk.mapboxMapboxSdkStrings.`driving-traffic` = "driving-traffic".asInstanceOf[typingsSlinky.mapboxMapboxSdk.mapboxMapboxSdkStrings.`driving-traffic`]
