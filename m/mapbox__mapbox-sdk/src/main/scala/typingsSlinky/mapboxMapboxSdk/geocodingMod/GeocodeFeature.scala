...
object GeocodeFeature {
  ...
  implicit class GeocodeFeatureOps[Self <: GeocodeFeature] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContext(value: js.Array[GeocodeFeature]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMatching_place_name(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("matching_place_name")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMatching_text(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("matching_text")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPlace_name(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("place_name")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPlace_type(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("place_type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProperties(value: GeocodeProperties): Self = {
        val ret = this.duplicate
