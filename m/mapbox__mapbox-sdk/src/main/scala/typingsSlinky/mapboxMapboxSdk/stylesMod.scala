...
object stylesMod {
  ...
  @JSImport("@mapbox/mapbox-sdk/services/styles", JSImport.Default)
  @js.native
  def default(config: typingsSlinky.mapboxMapboxSdk.mod.default): StylesService = js.native
  ...
  object StylesService {
    ...
    implicit class StylesServiceMutableBuilder[Self <: StylesService] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreateStyle(value: typingsSlinky.mapboxMapboxSdk.anon.Style => MapiRequest): Self = StObject.set(x, "createStyle", js.Any.fromFunction1(value))
      
      @scala.inline
      def setDeleteStyle(value: typingsSlinky.mapboxMapboxSdk.anon.Style => MapiRequest): Self = StObject.set(x, "deleteStyle", js.Any.fromFunction1(value))
