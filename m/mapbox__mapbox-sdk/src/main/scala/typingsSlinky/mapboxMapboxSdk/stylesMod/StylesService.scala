...
object StylesService {
  ...
  implicit class StylesServiceOps[Self <: StylesService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateStyle(value: typingsSlinky.mapboxMapboxSdk.anon.Style => MapiRequest): Self = this.set("createStyle", js.Any.fromFunction1(value))
    @scala.inline
    def setDeleteStyle(value: typingsSlinky.mapboxMapboxSdk.anon.Style => MapiRequest): Self = this.set("deleteStyle", js.Any.fromFunction1(value))
    @scala.inline
