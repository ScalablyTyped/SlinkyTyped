...
trait MUIDataTableOptions extends js.Object {
  ...
  var customSearchRender: js.UndefOr[
    js.Function4[
      ...
      /* hideSearch */ js.Any, 
      /* options */ js.Any, 
      ReactComponentClass[js.Object] | Element
    ]
  ] = js.undefined
  ...
  var renderExpandableRow: js.UndefOr[
    js.Function2[/* rowData */ js.Array[String], /* rowMeta */ Anon_DataIndexRowIndex, TagMod[Any]]
  ] = js.undefined
...
object MUIDataTableOptions {
  ...
  def apply(
    ...
    renderExpandableRow: (/* rowData */ js.Array[String], /* rowMeta */ Anon_DataIndexRowIndex) => TagMod[Any] = null,
