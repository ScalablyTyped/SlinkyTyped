...
trait DisplayData extends StObject {
  ...
  var displayData: typingsSlinky.muiDatatables.mod.DisplayData = js.native
}
object DisplayData {
  
  @scala.inline
  def apply(displayData: typingsSlinky.muiDatatables.mod.DisplayData): DisplayData = {
  ...
  implicit class DisplayDataMutableBuilder[Self <: DisplayData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisplayData(value: typingsSlinky.muiDatatables.mod.DisplayData): Self = StObject.set(x, "displayData", value.asInstanceOf[js.Any])
