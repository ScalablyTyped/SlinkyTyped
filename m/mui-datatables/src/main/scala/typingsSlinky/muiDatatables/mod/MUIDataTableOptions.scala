...
object MUIDataTableOptions {
  ...
  def apply(
    ...
    customFooter: (/* rowCount */ Double, /* page */ Double, /* rowsPerPage */ Double, /* changeRowsPerPage */ js.Function1[/* page */ String | Double, Unit], /* changePage */ js.Function1[/* newPage */ Double, Unit]) => TagMod[Any] = null,
    ...
    customToolbarSelect: (/* selectedRows */ Lookup, /* displayData */ js.Array[DataDataIndex], /* setSelectedRows */ js.Function1[/* rows */ js.Array[Double], Unit]) => TagMod[Any] = null,
    ...
    renderExpandableRow: (/* rowData */ js.Array[String], /* rowMeta */ RowIndex) => TagMod[Any] = null,
