...
object MUIDataTableColumnOptions {
  ...
  implicit class MUIDataTableColumnOptionsOps[Self <: MUIDataTableColumnOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomBodyRenderLite(value: (/* dataIndex */ Double, /* rowIndex */ Double) => String | ReactElement): Self = this.set("customBodyRenderLite", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setCustomHeadLabelRender(value: (/* dataIndex */ Double, /* rowIndex */ Double) => String | ReactElement): Self = this.set("customHeadLabelRender", js.Any.fromFunction2(value))
