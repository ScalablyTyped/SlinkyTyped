...
import typingsSlinky.muiDatatables.anon.DataAny
...
trait MUIDataTableColumnOptions extends StObject {
  ...
  /**
    ...
    */
  var customBodyRenderLite: js.UndefOr[
    js.Function2[/* dataIndex */ Double, /* rowIndex */ Double, String | ReactElement]
  ] = js.native
  ...
  /**
    ...
    */
  var customHeadLabelRender: js.UndefOr[
    js.Function2[/* dataIndex */ Double, /* rowIndex */ Double, String | ReactElement]
  ] = js.native
...
object MUIDataTableColumnOptions {
  ...
  implicit class MUIDataTableColumnOptionsMutableBuilder[Self <: MUIDataTableColumnOptions] (val x: Self) extends AnyVal {
    ...
    def setCustomBodyRender(
      value: (/* value */ js.Any, /* tableMeta */ MUIDataTableMeta, /* updateValue */ js.Function1[/* value */ String, Unit]) => String | ReactElement
    ): Self = StObject.set(x, "customBodyRender", js.Any.fromFunction3(value))
    
    @scala.inline
    def setCustomBodyRenderLite(value: (/* dataIndex */ Double, /* rowIndex */ Double) => String | ReactElement): Self = StObject.set(x, "customBodyRenderLite", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setCustomHeadLabelRender(value: (/* dataIndex */ Double, /* rowIndex */ Double) => String | ReactElement): Self = StObject.set(x, "customHeadLabelRender", js.Any.fromFunction2(value))
    ...
    def setCustomHeadRender(
      value: (/* columnMeta */ MUIDataTableCustomHeadRenderer, /* handleToggleColumn */ js.Function1[/* columnIndex */ Double, Unit], /* sortOrder */ MUISortOptions) => String | ReactElement
