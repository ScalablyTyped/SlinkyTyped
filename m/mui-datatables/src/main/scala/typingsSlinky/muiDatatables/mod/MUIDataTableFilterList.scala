...
object MUIDataTableFilterList {
  ...
  implicit class MUIDataTableFilterListMutableBuilder[Self <: MUIDataTableFilterList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnNames(value: js.Array[typingsSlinky.muiDatatables.anon.FilterType]): Self = StObject.set(x, "columnNames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColumnNamesUndefined: Self = StObject.set(x, "columnNames", js.undefined)
    
    @scala.inline
    def setColumnNamesVarargs(value: typingsSlinky.muiDatatables.anon.FilterType*): Self = StObject.set(x, "columnNames", js.Array(value :_*))
