...
object MUIDataTablePopover {
  ...
  implicit class MUIDataTablePopoverOps[Self <: MUIDataTablePopover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnchorElReactElement(value: ReactElement): Self = this.set("anchorEl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAnchorEl(value: ReactElement): Self = this.set("anchorEl", value.asInstanceOf[js.Any])
