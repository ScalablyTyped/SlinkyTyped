...
trait MUIDataTablePopover extends StObject {
  ...
  var anchorEl: js.UndefOr[ReactElement] = js.native
...
object MUIDataTablePopover {
  ...
  implicit class MUIDataTablePopoverMutableBuilder[Self <: MUIDataTablePopover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnchorEl(value: ReactElement): Self = StObject.set(x, "anchorEl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAnchorElReactElement(value: ReactElement): Self = StObject.set(x, "anchorEl", value.asInstanceOf[js.Any])
