...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.muiDatatables.muiDatatablesStrings.dropdown
  - typingsSlinky.muiDatatables.muiDatatablesStrings.checkbox
  - typingsSlinky.muiDatatables.muiDatatablesStrings.multiselect
