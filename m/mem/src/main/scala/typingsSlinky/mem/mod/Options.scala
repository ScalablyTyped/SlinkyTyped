...
object Options {
  ...
  @scala.inline
  def apply[ArgumentsType /* <: js.Array[_] */, CacheKeyType, ReturnType](): Options[ArgumentsType, CacheKeyType, ReturnType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[ArgumentsType, CacheKeyType, ReturnType]]
  }
  
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _, _], ArgumentsType /* <: js.Array[_] */, CacheKeyType, ReturnType] (val x: Self with (Options[ArgumentsType, CacheKeyType, ReturnType])) extends AnyVal {
