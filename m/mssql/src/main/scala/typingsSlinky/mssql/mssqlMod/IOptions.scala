package typingsSlinky.mssql.mssqlMod

import typingsSlinky.tedious.tediousMod.ColumnMetaData
import typingsSlinky.tedious.tediousMod.ConnectionOptions
import typingsSlinky.tedious.tediousMod.DebugOptions
...
object IOptions {
  ...
  def apply(
    ...
    connectionIsolationLevel: typingsSlinky.tedious.tediousMod.ISOLATION_LEVEL = null,
    ...
    isolationLevel: typingsSlinky.tedious.tediousMod.ISOLATION_LEVEL = null,
