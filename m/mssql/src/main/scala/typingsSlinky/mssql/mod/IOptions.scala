...
import typingsSlinky.tedious.mod.ColumnMetaData
import typingsSlinky.tedious.mod.ConnectionOptions
import typingsSlinky.tedious.mod.DebugOptions
...
object IOptions {
  ...
  def apply(
    ...
    connectionIsolationLevel: typingsSlinky.tedious.mod.ISOLATION_LEVEL = null,
    ...
    isolationLevel: typingsSlinky.tedious.mod.ISOLATION_LEVEL = null,
