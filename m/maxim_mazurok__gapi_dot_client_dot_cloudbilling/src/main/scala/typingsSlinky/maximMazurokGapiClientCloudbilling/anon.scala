...
import typingsSlinky.maximMazurokGapiClientCloudbilling.gapi.client.cloudbilling.ProjectBillingInfo
...
object anon {
  ...
  object Callback {
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: ProjectBillingInfo): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    implicit class FieldsMutableBuilder[Self <: Fields] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: BillingAccount): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    @scala.inline
    def apply(name: String, resource: BillingAccount): Name = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
