package typingsSlinky.mondaySdkJs.anon

import typingsSlinky.mondaySdkJs.mondaySdkJsStrings.error
import typingsSlinky.mondaySdkJs.mondaySdkJsStrings.info
import typingsSlinky.mondaySdkJs.mondaySdkJsStrings.success
