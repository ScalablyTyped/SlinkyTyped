...
import typingsSlinky.maximMazurokGapiClientServicecontrol.gapi.client.servicecontrol.CheckRequest
import typingsSlinky.maximMazurokGapiClientServicecontrol.gapi.client.servicecontrol.ReportRequest
