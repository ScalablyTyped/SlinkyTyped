...
object IEntityTickingArea {
  ...
  implicit class IEntityTickingAreaOps[Self <: IEntityTickingArea] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with__type__(value: entity_ticking_area): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("__type__")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEntity_ticking_area_id(value: Int64): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("entity_ticking_area_id")(value.asInstanceOf[js.Any])
        ret
    }
  }
