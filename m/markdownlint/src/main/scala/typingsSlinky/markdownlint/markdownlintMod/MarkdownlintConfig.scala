...
import typingsSlinky.markdownlint.Anon_Allowdifferentnesting
import typingsSlinky.markdownlint.Anon_Allowedelements
import typingsSlinky.markdownlint.Anon_Asterisk
import typingsSlinky.markdownlint.Anon_Atx
import typingsSlinky.markdownlint.Anon_Brspaces
import typingsSlinky.markdownlint.Anon_Codeblocks
import typingsSlinky.markdownlint.Anon_CodeblocksHeaders
import typingsSlinky.markdownlint.Anon_CodeblocksNames
import typingsSlinky.markdownlint.Anon_Frontmattertitle
import typingsSlinky.markdownlint.Anon_Indent
import typingsSlinky.markdownlint.Anon_Level
import typingsSlinky.markdownlint.Anon_Linesabove
import typingsSlinky.markdownlint.Anon_Maximum
import typingsSlinky.markdownlint.Anon_Olmulti
import typingsSlinky.markdownlint.Anon_One
import typingsSlinky.markdownlint.Anon_Punctuation
import typingsSlinky.markdownlint.Anon_Style
...
trait MarkdownlintConfig
  ...
  var `blanks-around-headings`: js.UndefOr[Boolean | Anon_Linesabove] = js.undefined
  var `blanks-around-lists`: js.UndefOr[Boolean] = js.undefined
  var `blanks-around_headers`: js.UndefOr[Boolean | Anon_Linesabove] = js.undefined
  ...
  /**
    ...
    * @see {"first-line-h1"}
    */
  var `first-header-h1`: js.UndefOr[Boolean | Anon_Level] = js.undefined
  /**
    * First heading should be a top level heading.
    * @deprecated
    * @see {"first-line-heading"}
    * @see {"first-line-h1"}
    */
  var `first-heading-h1`: js.UndefOr[Boolean | Anon_Level] = js.undefined
  var `first-line-h1`: js.UndefOr[Anon_Frontmattertitle] = js.undefined
  var `first-line-heading`: js.UndefOr[Anon_Frontmattertitle] = js.undefined
  /**
  ...
  /**
    ...
    * @default "consistent"
    */
  var `header-style`: js.UndefOr[Anon_Atx] = js.undefined
  /**
    * Heading levels should only increment by one level at a time.
    *
    * This rule is triggered when you skip heading levels in a markdown document.
  ...
  /**
    ...
    * @default "consistent"
    */
  var `heading-style`: js.UndefOr[Anon_Atx] = js.undefined
  var `hr-style`: js.UndefOr[Anon_Style] = js.undefined
  var `line-length`: js.UndefOr[Boolean | Anon_CodeblocksHeaders] = js.undefined
  /**
    * Inconsistent indentation for list items at the same level
    */
  var `list-indent`: js.UndefOr[Boolean] = js.undefined
  var `list-marker-space`: js.UndefOr[Boolean | Anon_Olmulti] = js.undefined
  ...
  var `no-duplicate-header`: js.UndefOr[Boolean | Anon_Allowdifferentnesting] = js.undefined
  var `no-duplicate-heading`: js.UndefOr[Boolean | Anon_Allowdifferentnesting] = js.undefined
  var `no-emphasis-as-header`: js.UndefOr[Boolean | Anon_Punctuation] = js.undefined
  var `no-emphasis-as-heading`: js.UndefOr[Boolean | Anon_Punctuation] = js.undefined
  var `no-empty-links`: js.UndefOr[Boolean] = js.undefined
  var `no-hard-tabs`: js.UndefOr[Boolean | Anon_Codeblocks] = js.undefined
  var `no-inline-html`: js.UndefOr[Boolean | Anon_Allowedelements] = js.undefined
  var `no-missing-space-atx`: js.UndefOr[Boolean] = js.undefined
  var `no-missing-space-closed-atx`: js.UndefOr[Boolean] = js.undefined
  var `no-multiple-blanks`: js.UndefOr[Boolean | Anon_Maximum] = js.undefined
  ...
  var `no-trailing-punctuation`: js.UndefOr[Boolean | Anon_Punctuation] = js.undefined
  var `no-trailing-spaces`: js.UndefOr[Boolean | Anon_Brspaces] = js.undefined
  var `ol-prefix`: js.UndefOr[Boolean | Anon_One] = js.undefined
  var `proper-names`: js.UndefOr[Anon_CodeblocksNames] = js.undefined
  ...
  var `single-h1`: js.UndefOr[Boolean | Anon_Frontmattertitle] = js.undefined
  var `single-title`: js.UndefOr[Boolean | Anon_Frontmattertitle] = js.undefined
  /**
    * This rule is triggered when list items are not indented by the configured number of spaces.
    * @default 2
    */
  var `ul-indent`: js.UndefOr[Boolean | Anon_Indent] = js.undefined
  /**
  ...
  /**
    ...
    * @default "consistent"
    */
  var `ul-style`: js.UndefOr[Anon_Asterisk] = js.undefined
}
...
object MarkdownlintConfig {
  ...
  def apply(
    ...
    `blanks-around-headings`: Boolean | Anon_Linesabove = null,
    `blanks-around-lists`: js.UndefOr[Boolean] = js.undefined,
    `blanks-around_headers`: Boolean | Anon_Linesabove = null,
    `commands-show-output`: js.UndefOr[Boolean] = js.undefined,
    default: js.UndefOr[Boolean] = js.undefined,
    `fenced-code-language`: js.UndefOr[Boolean] = js.undefined,
    `first-header-h1`: Boolean | Anon_Level = null,
    `first-heading-h1`: Boolean | Anon_Level = null,
    `first-line-h1`: Anon_Frontmattertitle = null,
    `first-line-heading`: Anon_Frontmattertitle = null,
    `header-increment`: js.UndefOr[Boolean] = js.undefined,
    `header-start-left`: js.UndefOr[Boolean] = js.undefined,
    `header-style`: Anon_Atx = null,
    `heading-increment`: js.UndefOr[Boolean] = js.undefined,
    `heading-start-left`: js.UndefOr[Boolean] = js.undefined,
    `heading-style`: Anon_Atx = null,
    `hr-style`: Anon_Style = null,
    `line-length`: Boolean | Anon_CodeblocksHeaders = null,
    `list-indent`: js.UndefOr[Boolean] = js.undefined,
    `list-marker-space`: Boolean | Anon_Olmulti = null,
    ...
    `no-duplicate-header`: Boolean | Anon_Allowdifferentnesting = null,
    `no-duplicate-heading`: Boolean | Anon_Allowdifferentnesting = null,
    `no-emphasis-as-header`: Boolean | Anon_Punctuation = null,
    `no-emphasis-as-heading`: Boolean | Anon_Punctuation = null,
    `no-empty-links`: js.UndefOr[Boolean] = js.undefined,
    `no-hard-tabs`: Boolean | Anon_Codeblocks = null,
    `no-inline-html`: Boolean | Anon_Allowedelements = null,
    `no-missing-space-atx`: js.UndefOr[Boolean] = js.undefined,
    `no-missing-space-closed-atx`: js.UndefOr[Boolean] = js.undefined,
    `no-multiple-blanks`: Boolean | Anon_Maximum = null,
    ...
    `no-trailing-punctuation`: Boolean | Anon_Punctuation = null,
    `no-trailing-spaces`: Boolean | Anon_Brspaces = null,
    `ol-prefix`: Boolean | Anon_One = null,
    `proper-names`: Anon_CodeblocksNames = null,
    `required-headers`: js.Array[String] = null,
    `required-headings`: js.Array[String] = null,
    `single-h1`: Boolean | Anon_Frontmattertitle = null,
    `single-title`: Boolean | Anon_Frontmattertitle = null,
    `ul-indent`: Boolean | Anon_Indent = null,
    `ul-start-left`: js.UndefOr[Boolean] = js.undefined,
    `ul-style`: Anon_Asterisk = null
  ): MarkdownlintConfig = {
