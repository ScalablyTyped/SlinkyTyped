package typingsSlinky.maximMazurokGapiClientLicensing

import typingsSlinky.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignment
import typingsSlinky.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignmentInsert
...
object anon {
  ...
  object Accesstoken {
    ...
    @scala.inline
    def apply(productId: String, skuId: String, userId: String): Accesstoken = {
  ...
  trait Alt extends StObject {
    ...
    /** Request body */
    var resource: LicenseAssignmentInsert = js.native
  ...
  object Alt {
    ...
    @scala.inline
    def apply(productId: String, resource: LicenseAssignmentInsert, skuId: String): Alt = {
    ...
    implicit class AltMutableBuilder[Self <: Alt] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: LicenseAssignmentInsert): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    implicit class KeyMutableBuilder[Self <: Key] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: LicenseAssignment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
