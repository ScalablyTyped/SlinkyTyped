package typingsSlinky.maximMazurokGapiClientLicensing.anon

import typingsSlinky.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignment
...
trait Key extends js.Object {
  ...
  /** Request body */
  var resource: LicenseAssignment = js.native
...
object Key {
  ...
  @scala.inline
  def apply(productId: String, resource: LicenseAssignment, skuId: String, userId: String): Key = {
  ...
  implicit class KeyOps[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: LicenseAssignment): Self = this.set("resource", value.asInstanceOf[js.Any])
