...
@js.native
trait MaxMembers extends StObject {
...
object MaxMembers {
  ...
  @scala.inline
  def apply(resourceName: String): MaxMembers = {
    val __obj = js.Dynamic.literal(resourceName = resourceName.asInstanceOf[js.Any])
    __obj.asInstanceOf[MaxMembers]
  }
  
  @scala.inline
  implicit class MaxMembersMutableBuilder[Self <: MaxMembers] (val x: Self) extends AnyVal {
