...
import typingsSlinky.maximMazurokGapiClientPeople.gapi.client.people.UpdateContactPhotoRequest
...
object UploadType {
  ...
  implicit class UploadTypeMutableBuilder[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateContactPhotoRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
