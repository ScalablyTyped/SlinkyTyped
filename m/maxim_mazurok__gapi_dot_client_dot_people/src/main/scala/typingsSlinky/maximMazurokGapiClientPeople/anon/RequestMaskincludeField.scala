...
@js.native
trait RequestMaskincludeField extends StObject {
...
object RequestMaskincludeField {
  ...
  @scala.inline
  implicit class RequestMaskincludeFieldMutableBuilder[Self <: RequestMaskincludeField] (val x: Self) extends AnyVal {
