...
import typingsSlinky.maximMazurokGapiClientPeople.gapi.client.people.UpdateContactGroupRequest
...
object PrettyPrint {
  ...
  implicit class PrettyPrintMutableBuilder[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateContactGroupRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
