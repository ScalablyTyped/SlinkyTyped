...
object IndentationRule {
  ...
  implicit class IndentationRuleOps[Self <: IndentationRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIndentNextLinePatternNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indentNextLinePattern")(null)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUnIndentedLinePatternNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unIndentedLinePattern")(null)
        ret
    }
  }
