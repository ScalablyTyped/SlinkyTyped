...
object AccessibilitySupport extends StObject {
  ...
  /* 1 */ val Disabled: typingsSlinky.monacoEditor.mod.editor.AccessibilitySupport.Disabled with Double = js.native
  
  @js.native
  sealed trait Enabled extends AccessibilitySupport
  /* 2 */ val Enabled: typingsSlinky.monacoEditor.mod.editor.AccessibilitySupport.Enabled with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.monacoEditor.mod.editor.AccessibilitySupport.Unknown with Double = js.native
}
