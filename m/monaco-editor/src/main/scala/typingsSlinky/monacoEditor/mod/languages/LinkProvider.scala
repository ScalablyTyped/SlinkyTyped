...
object LinkProvider {
  ...
  implicit class LinkProviderOps[Self <: LinkProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProvideLinks(value: (ITextModel, CancellationToken) => ProviderResult[ILinksList]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideLinks")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withResolveLink(value: (/* link */ ILink, /* token */ CancellationToken) => ProviderResult[ILink]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveLink")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutResolveLink: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveLink")(js.undefined)
        ret
    }
  }
