...
object EndOfLinePreference extends StObject {
  ...
  /* 2 */ val CRLF: typingsSlinky.monacoEditor.mod.editor.EndOfLinePreference.CRLF with Double = js.native
  ...
  /* 1 */ val LF: typingsSlinky.monacoEditor.mod.editor.EndOfLinePreference.LF with Double = js.native
  ...
  /* 0 */ val TextDefined: typingsSlinky.monacoEditor.mod.editor.EndOfLinePreference.TextDefined with Double = js.native
}
