...
object RenderMinimap extends StObject {
  ...
  /* 2 */ val Blocks: typingsSlinky.monacoEditor.mod.editor.RenderMinimap.Blocks with Double = js.native
  
  @js.native
  sealed trait None extends RenderMinimap
  /* 0 */ val None: typingsSlinky.monacoEditor.mod.editor.RenderMinimap.None with Double = js.native
  
  @js.native
  sealed trait Text extends RenderMinimap
  /* 1 */ val Text: typingsSlinky.monacoEditor.mod.editor.RenderMinimap.Text with Double = js.native
}
