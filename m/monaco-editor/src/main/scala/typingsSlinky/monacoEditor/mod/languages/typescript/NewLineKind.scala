...
object NewLineKind extends StObject {
  ...
  /* 0 */ val CarriageReturnLineFeed: typingsSlinky.monacoEditor.mod.languages.typescript.NewLineKind.CarriageReturnLineFeed with Double = js.native
  
  @js.native
  sealed trait LineFeed extends NewLineKind
  /* 1 */ val LineFeed: typingsSlinky.monacoEditor.mod.languages.typescript.NewLineKind.LineFeed with Double = js.native
}
