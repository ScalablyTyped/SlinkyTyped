...
object CommentRule {
  ...
  implicit class CommentRuleOps[Self <: CommentRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBlockCommentNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("blockComment")(null)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLineCommentNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineComment")(null)
        ret
    }
  }
