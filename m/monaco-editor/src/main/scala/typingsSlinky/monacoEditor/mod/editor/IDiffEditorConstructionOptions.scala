...
object IDiffEditorConstructionOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableSplitViewResizing)) __obj.updateDynamic("enableSplitViewResizing")(enableSplitViewResizing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ignoreTrimWhitespace)) __obj.updateDynamic("ignoreTrimWhitespace")(ignoreTrimWhitespace.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(originalEditable)) __obj.updateDynamic("originalEditable")(originalEditable.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(renderIndicators)) __obj.updateDynamic("renderIndicators")(renderIndicators.get.asInstanceOf[js.Any])
    if (renderLineHighlight != null) __obj.updateDynamic("renderLineHighlight")(renderLineHighlight.asInstanceOf[js.Any])
    if (!js.isUndefined(renderSideBySide)) __obj.updateDynamic("renderSideBySide")(renderSideBySide.get.asInstanceOf[js.Any])
