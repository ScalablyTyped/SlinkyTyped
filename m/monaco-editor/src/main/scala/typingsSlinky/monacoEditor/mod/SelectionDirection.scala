...
object SelectionDirection extends StObject {
  ...
  /* 0 */ val LTR: typingsSlinky.monacoEditor.mod.SelectionDirection.LTR with Double = js.native
  ...
  /* 1 */ val RTL: typingsSlinky.monacoEditor.mod.SelectionDirection.RTL with Double = js.native
}
