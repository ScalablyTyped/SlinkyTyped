...
trait OnEnterRule extends js.Object {
  ...
  /**
    ...
    */
  var oneLineAboveText: js.UndefOr[js.RegExp] = js.native
}
...
object OnEnterRule {
  ...
  implicit class OnEnterRuleOps[Self <: OnEnterRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOneLineAboveText(value: js.RegExp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("oneLineAboveText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOneLineAboveText: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("oneLineAboveText")(js.undefined)
        ret
    }
  }
