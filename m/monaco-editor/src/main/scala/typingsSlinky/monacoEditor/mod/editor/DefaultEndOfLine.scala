...
object DefaultEndOfLine extends StObject {
  ...
  /* 2 */ val CRLF: typingsSlinky.monacoEditor.mod.editor.DefaultEndOfLine.CRLF with Double = js.native
  ...
  /* 1 */ val LF: typingsSlinky.monacoEditor.mod.editor.DefaultEndOfLine.LF with Double = js.native
}
