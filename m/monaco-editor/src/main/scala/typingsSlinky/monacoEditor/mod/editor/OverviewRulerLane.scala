...
object OverviewRulerLane extends StObject {
  ...
  /* 2 */ val Center: typingsSlinky.monacoEditor.mod.editor.OverviewRulerLane.Center with Double = js.native
  
  @js.native
  sealed trait Full extends OverviewRulerLane
  /* 7 */ val Full: typingsSlinky.monacoEditor.mod.editor.OverviewRulerLane.Full with Double = js.native
  
  @js.native
  sealed trait Left extends OverviewRulerLane
  /* 1 */ val Left: typingsSlinky.monacoEditor.mod.editor.OverviewRulerLane.Left with Double = js.native
  
  @js.native
  sealed trait Right extends OverviewRulerLane
  /* 4 */ val Right: typingsSlinky.monacoEditor.mod.editor.OverviewRulerLane.Right with Double = js.native
}
