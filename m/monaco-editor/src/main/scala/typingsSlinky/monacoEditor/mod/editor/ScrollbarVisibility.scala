...
object ScrollbarVisibility extends StObject {
  ...
  /* 1 */ val Auto: typingsSlinky.monacoEditor.mod.editor.ScrollbarVisibility.Auto with Double = js.native
  
  @js.native
  sealed trait Hidden extends ScrollbarVisibility
  /* 2 */ val Hidden: typingsSlinky.monacoEditor.mod.editor.ScrollbarVisibility.Hidden with Double = js.native
  
  @js.native
  sealed trait Visible extends ScrollbarVisibility
  /* 3 */ val Visible: typingsSlinky.monacoEditor.mod.editor.ScrollbarVisibility.Visible with Double = js.native
}
