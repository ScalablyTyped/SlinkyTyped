...
object ScrollType extends StObject {
  ...
  /* 1 */ val Immediate: typingsSlinky.monacoEditor.mod.editor.ScrollType.Immediate with Double = js.native
  
  @js.native
  sealed trait Smooth extends ScrollType
  /* 0 */ val Smooth: typingsSlinky.monacoEditor.mod.editor.ScrollType.Smooth with Double = js.native
}
