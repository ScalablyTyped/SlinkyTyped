...
object DocumentHighlightKind extends StObject {
  ...
  /* 1 */ val Read: typingsSlinky.monacoEditor.mod.languages.DocumentHighlightKind.Read with Double = js.native
  ...
  /* 0 */ val Text: typingsSlinky.monacoEditor.mod.languages.DocumentHighlightKind.Text with Double = js.native
  ...
  /* 2 */ val Write: typingsSlinky.monacoEditor.mod.languages.DocumentHighlightKind.Write with Double = js.native
}
