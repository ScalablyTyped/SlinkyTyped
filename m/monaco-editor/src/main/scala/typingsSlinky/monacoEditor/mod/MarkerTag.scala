...
object MarkerTag extends StObject {
  ...
  /* 2 */ val Deprecated: typingsSlinky.monacoEditor.mod.MarkerTag.Deprecated with Double = js.native
  
  @js.native
  sealed trait Unnecessary extends MarkerTag
  /* 1 */ val Unnecessary: typingsSlinky.monacoEditor.mod.MarkerTag.Unnecessary with Double = js.native
}
