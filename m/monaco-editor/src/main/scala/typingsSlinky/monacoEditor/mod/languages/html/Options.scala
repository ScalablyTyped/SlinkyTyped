...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: HTMLFormatConfiguration): Self = this.set("format", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFormat: Self = this.set("format", js.undefined)
    
    @scala.inline
    def setSuggest(value: CompletionConfiguration): Self = this.set("suggest", value.asInstanceOf[js.Any])
