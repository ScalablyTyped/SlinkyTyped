...
object IEditorOption {
  @scala.inline
  def apply[/* <: typingsSlinky.monacoEditor.mod.editor.EditorOption */ K1, V](defaultValue: V, id: K1, name: String): IEditorOption[K1, V] = {
  ...
  @scala.inline
  implicit class IEditorOptionOps[Self <: IEditorOption[_, _], /* <: typingsSlinky.monacoEditor.mod.editor.EditorOption */ K1, V] (val x: Self with (IEditorOption[K1, V])) extends AnyVal {
    @scala.inline
