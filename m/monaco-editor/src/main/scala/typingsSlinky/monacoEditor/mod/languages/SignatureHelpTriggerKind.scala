...
object SignatureHelpTriggerKind extends StObject {
  ...
  /* 3 */ val ContentChange: typingsSlinky.monacoEditor.mod.languages.SignatureHelpTriggerKind.ContentChange with Double = js.native
  
  @js.native
  sealed trait Invoke extends SignatureHelpTriggerKind
  /* 1 */ val Invoke: typingsSlinky.monacoEditor.mod.languages.SignatureHelpTriggerKind.Invoke with Double = js.native
  
  @js.native
  sealed trait TriggerCharacter extends SignatureHelpTriggerKind
  /* 2 */ val TriggerCharacter: typingsSlinky.monacoEditor.mod.languages.SignatureHelpTriggerKind.TriggerCharacter with Double = js.native
}
