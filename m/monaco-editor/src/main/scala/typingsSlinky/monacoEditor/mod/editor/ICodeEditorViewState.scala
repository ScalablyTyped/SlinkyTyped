...
object ICodeEditorViewState {
  ...
  implicit class ICodeEditorViewStateOps[Self <: ICodeEditorViewState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContributionsState(value: StringDictionary[js.Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contributionsState")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCursorState(value: js.Array[ICursorState]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cursorState")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withViewState(value: IViewState): Self = {
        val ret = this.duplicate
