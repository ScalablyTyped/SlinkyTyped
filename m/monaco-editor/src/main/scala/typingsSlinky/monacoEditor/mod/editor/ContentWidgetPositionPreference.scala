...
object ContentWidgetPositionPreference extends StObject {
  ...
  /* 1 */ val ABOVE: typingsSlinky.monacoEditor.mod.editor.ContentWidgetPositionPreference.ABOVE with Double = js.native
  ...
  /* 2 */ val BELOW: typingsSlinky.monacoEditor.mod.editor.ContentWidgetPositionPreference.BELOW with Double = js.native
  ...
  /* 0 */ val EXACT: typingsSlinky.monacoEditor.mod.editor.ContentWidgetPositionPreference.EXACT with Double = js.native
}
