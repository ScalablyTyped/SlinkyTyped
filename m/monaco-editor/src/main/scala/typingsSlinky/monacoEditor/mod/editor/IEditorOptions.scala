...
import typingsSlinky.monacoEditor.monacoEditorStrings.`block-outline`
import typingsSlinky.monacoEditor.monacoEditorStrings.`inline`
import typingsSlinky.monacoEditor.monacoEditorStrings.`line-thin`
import typingsSlinky.monacoEditor.monacoEditorStrings.`underline-thin`
...
import typingsSlinky.monacoEditor.monacoEditorStrings.blink
import typingsSlinky.monacoEditor.monacoEditorStrings.block
...
import typingsSlinky.monacoEditor.monacoEditorStrings.brackets
import typingsSlinky.monacoEditor.monacoEditorStrings.copy
import typingsSlinky.monacoEditor.monacoEditorStrings.ctrlCmd
import typingsSlinky.monacoEditor.monacoEditorStrings.deepIndent
...
import typingsSlinky.monacoEditor.monacoEditorStrings.expand
...
import typingsSlinky.monacoEditor.monacoEditorStrings.indent
import typingsSlinky.monacoEditor.monacoEditorStrings.indentation
import typingsSlinky.monacoEditor.monacoEditorStrings.keep
...
import typingsSlinky.monacoEditor.monacoEditorStrings.smooth
import typingsSlinky.monacoEditor.monacoEditorStrings.solid
...
trait IEditorOptions extends StObject {
  ...
  /**
    ...
    * Defaults to false.
    */
  var peekWidgetDefaultFocus: js.UndefOr[tree | typingsSlinky.monacoEditor.monacoEditorStrings.editor] = js.native
...
object IEditorOptions {
  ...
  implicit class IEditorOptionsMutableBuilder[Self <: IEditorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPeekWidgetDefaultFocus(value: tree | typingsSlinky.monacoEditor.monacoEditorStrings.editor): Self = StObject.set(x, "peekWidgetDefaultFocus", value.asInstanceOf[js.Any])
