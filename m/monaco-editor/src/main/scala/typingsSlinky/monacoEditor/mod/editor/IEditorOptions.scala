...
object IEditorOptions {
  ...
  implicit class IEditorOptionsOps[Self <: IEditorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPeekWidgetDefaultFocus(value: tree | typingsSlinky.monacoEditor.monacoEditorStrings.editor): Self = this.set("peekWidgetDefaultFocus", value.asInstanceOf[js.Any])
