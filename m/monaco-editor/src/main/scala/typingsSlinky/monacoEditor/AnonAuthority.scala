...
object AnonAuthority {
  @scala.inline
  def apply(): AnonAuthority = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAuthority]
  }
  @scala.inline
  implicit class AnonAuthorityOps[Self <: AnonAuthority] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAuthorityNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("authority")(null)
        ret
    }
    @scala.inline
