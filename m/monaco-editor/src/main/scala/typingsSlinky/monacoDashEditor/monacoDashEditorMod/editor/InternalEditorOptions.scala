...
import typingsSlinky.monacoDashEditor.monacoDashEditorStrings.altKey
import typingsSlinky.monacoDashEditor.monacoDashEditorStrings.ctrlKey
import typingsSlinky.monacoDashEditor.monacoDashEditorStrings.metaKey
