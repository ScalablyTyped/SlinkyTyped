...
object NewLineKind extends js.Object {
  ...
  /* 0 */ val CarriageReturnLineFeed: typingsSlinky.monacoDashEditor.monacoDashEditorMod.languages.typescript.NewLineKind.CarriageReturnLineFeed with Double = js.native
  /* 1 */ val LineFeed: typingsSlinky.monacoDashEditor.monacoDashEditorMod.languages.typescript.NewLineKind.LineFeed with Double = js.native
  @JSBracketAccess
