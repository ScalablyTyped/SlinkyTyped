...
object EditorAutoClosingStrategy {
  @scala.inline
  def always: typingsSlinky.monacoDashEditor.monacoDashEditorStrings.always = this.cast("always")
  @scala.inline
  def beforeWhitespace: typingsSlinky.monacoDashEditor.monacoDashEditorStrings.beforeWhitespace = this.cast("beforeWhitespace")
  @scala.inline
