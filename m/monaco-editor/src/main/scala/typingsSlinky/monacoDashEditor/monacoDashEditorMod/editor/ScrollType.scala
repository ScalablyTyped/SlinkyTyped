...
object ScrollType extends js.Object {
  ...
  /* 1 */ val Immediate: typingsSlinky.monacoDashEditor.monacoDashEditorMod.editor.ScrollType.Immediate with Double = js.native
  /* 0 */ val Smooth: typingsSlinky.monacoDashEditor.monacoDashEditorMod.editor.ScrollType.Smooth with Double = js.native
  @JSBracketAccess
