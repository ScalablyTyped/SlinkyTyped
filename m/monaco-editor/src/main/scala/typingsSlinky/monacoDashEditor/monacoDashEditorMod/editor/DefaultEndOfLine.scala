...
object DefaultEndOfLine extends js.Object {
  ...
  /* 2 */ val CRLF: typingsSlinky.monacoDashEditor.monacoDashEditorMod.editor.DefaultEndOfLine.CRLF with Double = js.native
  /* 1 */ val LF: typingsSlinky.monacoDashEditor.monacoDashEditorMod.editor.DefaultEndOfLine.LF with Double = js.native
  @JSBracketAccess
