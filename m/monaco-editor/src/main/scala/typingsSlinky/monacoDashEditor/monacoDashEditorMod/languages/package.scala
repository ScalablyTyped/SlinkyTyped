...
package object languages {
  ...
  type IShortMonarchLanguageRule1 = js.Tuple2[js.RegExp, IMonarchLanguageAction]
  type IShortMonarchLanguageRule2 = js.Tuple3[js.RegExp, IMonarchLanguageAction, String]
