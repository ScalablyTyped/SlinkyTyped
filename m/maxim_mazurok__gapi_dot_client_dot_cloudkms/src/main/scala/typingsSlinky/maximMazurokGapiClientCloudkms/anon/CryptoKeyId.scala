...
import typingsSlinky.maximMazurokGapiClientCloudkms.gapi.client.cloudkms.CryptoKey
...
@js.native
trait CryptoKeyId extends StObject {
...
object CryptoKeyId {
  ...
  @scala.inline
  def apply(parent: String, resource: CryptoKey): CryptoKeyId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CryptoKeyId]
  }
  
  @scala.inline
  implicit class CryptoKeyIdMutableBuilder[Self <: CryptoKeyId] (val x: Self) extends AnyVal {
