...
object MustacheScanner {
  ...
  implicit class MustacheScannerOps[Self <: MustacheScanner] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScan(value: js.RegExp => String): Self = this.set("scan", js.Any.fromFunction1(value))
    
    @scala.inline
    def setScanUntil(value: js.RegExp => String): Self = this.set("scanUntil", js.Any.fromFunction1(value))
