...
import typingsSlinky.mustache.mustacheStrings.Ampersand
import typingsSlinky.mustache.mustacheStrings.Equalssign
import typingsSlinky.mustache.mustacheStrings.Exclamationmark
import typingsSlinky.mustache.mustacheStrings.Greaterthansign
import typingsSlinky.mustache.mustacheStrings.Numbersign
import typingsSlinky.mustache.mustacheStrings.name
import typingsSlinky.mustache.mustacheStrings.text
...
object mod extends Shortcut {
  ...
  object MustacheScanner {
    ...
    implicit class MustacheScannerMutableBuilder[Self <: MustacheScanner] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScan(value: js.RegExp => String): Self = StObject.set(x, "scan", js.Any.fromFunction1(value))
      
      @scala.inline
      def setScanUntil(value: js.RegExp => String): Self = StObject.set(x, "scanUntil", js.Any.fromFunction1(value))
