...
import typingsSlinky.maximMazurokGapiClientSpanner.gapi.client.spanner.ExecuteSqlRequest
...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: ExecuteSqlRequest = js.native
...
object AccesstokenAlt {
  ...
  @scala.inline
  def apply(resource: ExecuteSqlRequest, session: String): AccesstokenAlt = {
  ...
  implicit class AccesstokenAltMutableBuilder[Self <: AccesstokenAlt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ExecuteSqlRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
