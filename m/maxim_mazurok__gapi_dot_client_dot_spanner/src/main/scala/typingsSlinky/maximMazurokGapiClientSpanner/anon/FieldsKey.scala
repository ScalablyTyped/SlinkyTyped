...
import typingsSlinky.maximMazurokGapiClientSpanner.gapi.client.spanner.ReadRequest
...
trait FieldsKey extends StObject {
  ...
  /** Request body */
  var resource: ReadRequest = js.native
...
object FieldsKey {
  ...
  @scala.inline
  def apply(resource: ReadRequest, session: String): FieldsKey = {
  ...
  implicit class FieldsKeyMutableBuilder[Self <: FieldsKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: ReadRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
