...
import typingsSlinky.maximMazurokGapiClientSpanner.anon.AccesstokenAlt
import typingsSlinky.maximMazurokGapiClientSpanner.anon.AltCallback
import typingsSlinky.maximMazurokGapiClientSpanner.anon.CallbackFields
import typingsSlinky.maximMazurokGapiClientSpanner.anon.FieldsKey
import typingsSlinky.maximMazurokGapiClientSpanner.anon.Filter
import typingsSlinky.maximMazurokGapiClientSpanner.anon.KeyOauthtoken
import typingsSlinky.maximMazurokGapiClientSpanner.anon.QuotaUser
import typingsSlinky.maximMazurokGapiClientSpanner.anon.Resource
import typingsSlinky.maximMazurokGapiClientSpanner.anon.UploadType
import typingsSlinky.maximMazurokGapiClientSpanner.anon.Uploadprotocol
import typingsSlinky.maximMazurokGapiClientSpanner.anon.Xgafv
...
trait SessionsResource extends js.Object {
  ...
  def batchCreate(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Database): Request[BatchCreateSessionsResponse] = js.native
  ...
  def beginTransaction(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: BeginTransactionRequest): Request[Transaction] = js.native
  
  def commit(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: CommitRequest): Request[CommitResponse] = js.native
  /**
  ...
  def executeBatchDml(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteBatchDmlRequest): Request[ExecuteBatchDmlResponse] = js.native
  /**
  ...
  def executeSql(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteSqlRequest): Request[ResultSet] = js.native
  ...
  def executeStreamingSql(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteSqlRequest): Request[PartialResultSet] = js.native
  ...
  def partitionQuery(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: PartitionQueryRequest): Request[PartitionResponse] = js.native
  ...
  def partitionRead(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: PartitionReadRequest): Request[PartitionResponse] = js.native
  ...
  def read(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: ReadRequest): Request[ResultSet] = js.native
  ...
  def rollback(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: RollbackRequest): Request[js.Object] = js.native
  ...
  def streamingRead(request: typingsSlinky.maximMazurokGapiClientSpanner.anon.Session, body: ReadRequest): Request[PartialResultSet] = js.native
}
