package typingsSlinky.maximMazurokGapiClientDoubleclickbidmanager.anon
...
object Callback {
  ...
  implicit class CallbackOps[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UploadLineItemsRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
