...
import typingsSlinky.memFsEditor.AnonDefaults
import typingsSlinky.memFsEditor.AnonGlobOptions
import typingsSlinky.memFsEditor.AnonGlobOptionsIOptions
import typingsSlinky.memFsEditor.AnonSeparator
