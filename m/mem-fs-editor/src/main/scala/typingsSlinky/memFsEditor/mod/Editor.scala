...
import typingsSlinky.memFsEditor.anon.Defaults
import typingsSlinky.memFsEditor.anon.GlobOptions
import typingsSlinky.memFsEditor.anon.GlobOptionsIOptions
import typingsSlinky.memFsEditor.anon.Separator
