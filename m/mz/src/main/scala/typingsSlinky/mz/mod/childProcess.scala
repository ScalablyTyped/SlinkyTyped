...
object childProcess extends js.Object {
  ...
  def execFile(
    ...
    callback: js.Function3[js.Error | Null, Buffer | String, Buffer | String, Unit]
  ): ChildProcess = js.native
  def execFile(
    file: String,
    args: js.UndefOr[js.Array[String] | Null],
  ...
  def execFile(
    ...
    args: js.UndefOr[js.Array[String] | Null],
    options: ExecFileOptionsWithBufferEncoding,
    callback: js.Function3[js.Error | Null, /* stdout */ Buffer, /* stderr */ Buffer, Unit]
  ): ChildProcess = js.native
  def execFile(
    file: String,
    args: js.UndefOr[js.Array[String] | Null],
    options: ExecFileOptionsWithStringEncoding,
    callback: js.Function3[js.Error | Null, /* stdout */ String, /* stderr */ String, Unit]
  ): ChildProcess = js.native
  def execFile(
    file: String,
    args: js.UndefOr[js.Array[String] | Null],
