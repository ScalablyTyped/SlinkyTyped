...
object readlineMod {
  ...
  class Interface protected ()
    extends typingsSlinky.node.readlineMod.Interface {
    /**
    ...
    /**
      ...
      * @see https://nodejs.org/dist/latest-v10.x/docs/api/readline.html#readline_class_interface
      */
    protected def this(options: typingsSlinky.node.readlineMod.ReadLineOptions) = this()
    protected def this(input: ReadableStream, output: WritableStream) = this()
    protected def this(
      input: ReadableStream,
      output: js.UndefOr[scala.Nothing],
      completer: typingsSlinky.node.readlineMod.AsyncCompleter
    ) = this()
    protected def this(
      input: ReadableStream,
      output: js.UndefOr[scala.Nothing],
      completer: typingsSlinky.node.readlineMod.Completer
    ) = this()
    protected def this(
      input: ReadableStream,
    ...
    protected def this(input: ReadableStream, output: WritableStream, completer: typingsSlinky.node.readlineMod.Completer) = this()
    protected def this(
      input: ReadableStream,
      output: js.UndefOr[scala.Nothing],
  ...
  type Completer = AsyncCompleter | typingsSlinky.node.readlineMod.Completer
