...
trait DeletePolicy extends StObject {
  ...
  /** Request body */
  var resource: typingsSlinky.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment = js.native
...
object DeletePolicy {
  ...
  def apply(
    deployment: String,
    project: String,
    resource: typingsSlinky.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment
  ): DeletePolicy = {
  ...
  @scala.inline
  implicit class DeletePolicyMutableBuilder[Self <: DeletePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(
      value: typingsSlinky.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.Deployment
