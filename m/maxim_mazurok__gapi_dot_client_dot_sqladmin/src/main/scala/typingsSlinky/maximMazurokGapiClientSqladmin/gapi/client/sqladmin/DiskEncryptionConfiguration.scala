...
@js.native
trait DiskEncryptionConfiguration extends js.Object {
...
object DiskEncryptionConfiguration {
  ...
  @scala.inline
  implicit class DiskEncryptionConfigurationOps[Self <: DiskEncryptionConfiguration] (val x: Self) extends AnyVal {
