...
trait Operation extends js.Object {
  ...
  var backupContext: js.UndefOr[BackupContext] = js.native
...
object Operation {
  ...
  implicit class OperationOps[Self <: Operation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackupContext(value: BackupContext): Self = this.set("backupContext", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBackupContext: Self = this.set("backupContext", js.undefined)
