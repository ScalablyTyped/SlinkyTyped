...
import typingsSlinky.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.DatabaseInstance
...
object Xgafv {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: DatabaseInstance): Xgafv = {
