...
import typingsSlinky.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.InstancesCloneRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: InstancesCloneRequest = js.native
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: InstancesCloneRequest): Oauthtoken = {
  ...
  implicit class OauthtokenMutableBuilder[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: InstancesCloneRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
