...
import typingsSlinky.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.SslCertsInsertRequest
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: SslCertsInsertRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(instance: String, project: String, resource: SslCertsInsertRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: SslCertsInsertRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
