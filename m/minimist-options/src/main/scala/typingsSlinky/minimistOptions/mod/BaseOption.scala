...
object BaseOption {
  @scala.inline
  def apply[/* <: typingsSlinky.minimistOptions.mod.OptionType */ TypeOptionType, DefaultOptionType](): BaseOption[TypeOptionType, DefaultOptionType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BaseOption[TypeOptionType, DefaultOptionType]]
  }
  @scala.inline
  implicit class BaseOptionOps[Self <: BaseOption[_, _], /* <: typingsSlinky.minimistOptions.mod.OptionType */ TypeOptionType, DefaultOptionType] (val x: Self with (BaseOption[TypeOptionType, DefaultOptionType])) extends AnyVal {
    @scala.inline
