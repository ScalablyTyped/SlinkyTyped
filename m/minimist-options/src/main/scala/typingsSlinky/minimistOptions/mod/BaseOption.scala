...
object BaseOption {
  ...
  @scala.inline
  implicit class BaseOptionOps[Self <: BaseOption[_, _], TypeOptionType /* <: OptionType */, DefaultOptionType] (val x: Self with (BaseOption[TypeOptionType, DefaultOptionType])) extends AnyVal {
