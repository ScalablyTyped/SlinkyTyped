...
import typingsSlinky.mobxStateTree.anon.Actions
import typingsSlinky.mobxStateTree.snapshotProcessorMod.CustomOrOther
...
import typingsSlinky.mobxStateTree.typeMod.Instance
...
object modelMod {
  ...
  {[ k in keyof P ]: P[k]['CreationType']}
    */ typingsSlinky.mobxStateTree.mobxStateTreeStrings.ExtractCFromProps with TopLevel[P]
  ...
  type ModelCreationType[PC] = typingsSlinky.mobxStateTree.mobxStateTreeStrings.ModelCreationType with TopLevel[PC] with Partial[PC] with NonEmptyObject_
  ...
  type ModelInstanceTypeProps[P /* <: ModelProperties */] = typingsSlinky.mobxStateTree.mobxStateTreeStrings.ModelInstanceTypeProps with TopLevel[P] with NonEmptyObject_
  ...
  {[ K in keyof T ]: T[K] extends mobx-state-tree.mobx-state-tree/dist/core/type/type.IAnyType? T[K] : T[K] extends string? mobx-state-tree.mobx-state-tree/dist/core/type/type.IType<string | undefined, string, string> : T[K] extends number? mobx-state-tree.mobx-state-tree/dist/core/type/type.IType<number | undefined, number, number> : T[K] extends boolean? mobx-state-tree.mobx-state-tree/dist/core/type/type.IType<boolean | undefined, boolean, boolean> : T[K] extends std.Date? mobx-state-tree.mobx-state-tree/dist/core/type/type.IType<number | std.Date | undefined, number, std.Date> : never}
    */ typingsSlinky.mobxStateTree.mobxStateTreeStrings.ModelPropertiesDeclarationToProperties with TopLevel[js.Any]) | T
  
  type ModelSnapshotType[P /* <: ModelProperties */] = typingsSlinky.mobxStateTree.mobxStateTreeStrings.ModelSnapshotType with TopLevel[P] with NonEmptyObject_
