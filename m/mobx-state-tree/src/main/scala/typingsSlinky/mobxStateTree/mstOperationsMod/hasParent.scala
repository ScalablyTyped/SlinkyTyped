...
@js.native
object hasParent extends js.Object {
  
  def apply(target: IAnyStateTreeNode): Boolean = js.native
  def apply(target: IAnyStateTreeNode, depth: Double): Boolean = js.native
}
