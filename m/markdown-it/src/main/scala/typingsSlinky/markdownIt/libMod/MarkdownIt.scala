...
import typingsSlinky.markdownIt.AnonArrayReplaceAt
...
trait MarkdownIt extends js.Object {
  var block: typingsSlinky.markdownIt.parserBlockMod.^ = js.native
  var core: typingsSlinky.markdownIt.parserCoreMod.^ = js.native
  var helpers: js.Any = js.native
  var `inline`: typingsSlinky.markdownIt.parserInlineMod.^ = js.native
  var linkify: LinkifyIt = js.native
  var renderer: typingsSlinky.markdownIt.rendererMod.^ = js.native
