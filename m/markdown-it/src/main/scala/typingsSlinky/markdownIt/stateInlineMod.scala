...
object stateInlineMod {
  ...
  class ^ protected () extends StateInline {
    def this(src: String, md: MarkdownIt, env: js.Any, outTokens: js.Array[typingsSlinky.markdownIt.tokenMod.^]) = this()
  }
  ...
  object StateInline {
    ...
    implicit class StateInlineMutableBuilder[Self <: StateInline] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPushPending(value: () => typingsSlinky.markdownIt.tokenMod.^): Self = StObject.set(x, "pushPending", js.Any.fromFunction0(value))
