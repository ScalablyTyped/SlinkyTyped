...
object StateInline {
  ...
  implicit class StateInlineOps[Self <: StateInline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPush(value: (String, String, Nesting) => typingsSlinky.markdownIt.tokenMod.^): Self = this.set("push", js.Any.fromFunction3(value))
    
    @scala.inline
    def setPushPending(value: () => typingsSlinky.markdownIt.tokenMod.^): Self = this.set("pushPending", js.Any.fromFunction0(value))
