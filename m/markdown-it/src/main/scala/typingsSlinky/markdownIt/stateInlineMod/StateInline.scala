...
import typingsSlinky.markdownIt.AnonCanclose
import typingsSlinky.markdownIt.libMod.Delimiter
...
trait StateInline
  ...
  /**
    ...
    */
  def push(`type`: String, tag: String, nesting: Double): typingsSlinky.markdownIt.tokenMod.^ = js.native
  /** Flush pending text */
