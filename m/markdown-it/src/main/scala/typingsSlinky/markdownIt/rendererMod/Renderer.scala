...
object Renderer {
  ...
  implicit class RendererOps[Self <: Renderer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRender(value: (js.Array[typingsSlinky.markdownIt.tokenMod.^], Options, js.Any) => String): Self = this.set("render", js.Any.fromFunction3(value))
    @scala.inline
    def setRenderAttrs(value: typingsSlinky.markdownIt.tokenMod.^ => String): Self = this.set("renderAttrs", js.Any.fromFunction1(value))
    @scala.inline
    def setRenderInline(value: (js.Array[typingsSlinky.markdownIt.tokenMod.^], Options, js.Any) => String): Self = this.set("renderInline", js.Any.fromFunction3(value))
    @scala.inline
    def setRenderInlineAsText(value: (js.Array[typingsSlinky.markdownIt.tokenMod.^], Options, js.Any) => String): Self = this.set("renderInlineAsText", js.Any.fromFunction3(value))
    @scala.inline
    def setRenderToken(value: (js.Array[typingsSlinky.markdownIt.tokenMod.^], Double, Options) => String): Self = this.set("renderToken", js.Any.fromFunction3(value))
    @scala.inline
