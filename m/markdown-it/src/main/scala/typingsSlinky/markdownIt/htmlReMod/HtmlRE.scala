...
object HtmlRE {
  ...
  implicit class HtmlREOps[Self <: HtmlRE] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHTML_OPEN_CLOSE_TAG_RE(value: js.RegExp): Self = this.set("HTML_OPEN_CLOSE_TAG_RE", value.asInstanceOf[js.Any])
    @scala.inline
    def setHTML_TAG_RE(value: js.RegExp): Self = this.set("HTML_TAG_RE", value.asInstanceOf[js.Any])
  }
