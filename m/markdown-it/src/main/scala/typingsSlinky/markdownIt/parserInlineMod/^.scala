...
class ^ () extends ParserInline {
  ...
  /* CompleteClass */
  override def parse(src: String, md: MarkdownIt, env: js.Any, outTokens: js.Array[typingsSlinky.markdownIt.tokenMod.^]): Unit = js.native
  /* CompleteClass */
  override def skipToken(state: typingsSlinky.markdownIt.stateCoreMod.^): Unit = js.native
  /* CompleteClass */
  override def tokenize(state: typingsSlinky.markdownIt.stateCoreMod.^): Unit = js.native
}
