...
import typingsSlinky.linkifyDashIt.linkifyDashItMod.LinkifyIt
import typingsSlinky.markdownDashIt.Anon_ArrayReplaceAt
...
trait MarkdownIt extends js.Object {
  var block: typingsSlinky.markdownDashIt.libParserUnderscoreBlockMod.^ = js.native
  var core: typingsSlinky.markdownDashIt.libParserUnderscoreCoreMod.^ = js.native
  var helpers: js.Any = js.native
  var `inline`: typingsSlinky.markdownDashIt.libParserUnderscoreInlineMod.^ = js.native
  var linkify: LinkifyIt = js.native
  var renderer: typingsSlinky.markdownDashIt.libRendererMod.^ = js.native
  ...
  def parse(src: String, env: js.Any): js.Array[typingsSlinky.markdownDashIt.libTokenMod.^] = js.native
  def parseInline(src: String, env: js.Any): js.Array[typingsSlinky.markdownDashIt.libTokenMod.^] = js.native
