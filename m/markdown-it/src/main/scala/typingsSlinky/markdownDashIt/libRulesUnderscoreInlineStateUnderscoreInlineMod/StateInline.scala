package typingsSlinky.markdownDashIt.libRulesUnderscoreInlineStateUnderscoreInlineMod

import org.scalablytyped.runtime.NumberDictionary
import typingsSlinky.markdownDashIt.Anon_Canclose
import typingsSlinky.markdownDashIt.libMod.Delimiter
...
trait StateInline
  ...
  /**
    ...
    */
  def push(`type`: String, tag: String, nesting: Double): typingsSlinky.markdownDashIt.libTokenMod.^ = js.native
  /** Flush pending text */
  def pushPending(): typingsSlinky.markdownDashIt.libTokenMod.^ = js.native
  /**
