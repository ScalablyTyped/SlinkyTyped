package typingsSlinky.markdownDashIt.libRulesUnderscoreCoreStateUnderscoreCoreMod
...
class ^ protected () extends StateCore {
  ...
  /* CompleteClass */
  override var tokens: js.Array[typingsSlinky.markdownDashIt.libTokenMod.^] = js.native
}
