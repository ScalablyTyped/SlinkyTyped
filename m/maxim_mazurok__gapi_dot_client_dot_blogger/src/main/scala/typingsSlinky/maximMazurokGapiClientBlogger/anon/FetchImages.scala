...
@js.native
trait FetchImages extends StObject {
...
object FetchImages {
  ...
  @scala.inline
  def apply(blogId: String, resource: Post): FetchImages = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FetchImages]
  }
  
  @scala.inline
  implicit class FetchImagesMutableBuilder[Self <: FetchImages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Post): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
