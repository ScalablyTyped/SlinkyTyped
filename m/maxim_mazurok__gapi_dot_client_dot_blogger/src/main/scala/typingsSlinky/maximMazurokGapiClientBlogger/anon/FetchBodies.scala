...
@js.native
trait FetchBodies extends StObject {
...
object FetchBodies {
  ...
  @scala.inline
  def apply(blogId: String): FetchBodies = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FetchBodies]
  }
  
  @scala.inline
  implicit class FetchBodiesMutableBuilder[Self <: FetchBodies] (val x: Self) extends AnyVal {
