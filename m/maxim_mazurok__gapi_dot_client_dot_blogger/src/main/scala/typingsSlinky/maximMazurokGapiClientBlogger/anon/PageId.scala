...
import typingsSlinky.maximMazurokGapiClientBlogger.gapi.client.blogger.Page
...
object PageId {
  ...
  @scala.inline
  def apply(blogId: String, pageId: String, resource: Page): PageId = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any], pageId = pageId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  implicit class PageIdMutableBuilder[Self <: PageId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Page): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
