...
@js.native
trait PublishDate extends StObject {
...
object PublishDate {
  ...
  @scala.inline
  def apply(blogId: String, postId: String): PublishDate = {
  ...
  @scala.inline
  implicit class PublishDateMutableBuilder[Self <: PublishDate] (val x: Self) extends AnyVal {
