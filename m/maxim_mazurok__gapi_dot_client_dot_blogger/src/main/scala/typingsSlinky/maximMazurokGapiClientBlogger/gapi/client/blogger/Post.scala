...
import typingsSlinky.maximMazurokGapiClientBlogger.anon.Lat
import typingsSlinky.maximMazurokGapiClientBlogger.anon.TotalItems
import typingsSlinky.maximMazurokGapiClientBlogger.anon.Url
