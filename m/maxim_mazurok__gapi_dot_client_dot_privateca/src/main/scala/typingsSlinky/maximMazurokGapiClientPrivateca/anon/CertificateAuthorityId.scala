...
@js.native
trait CertificateAuthorityId extends js.Object {
...
object CertificateAuthorityId {
  ...
  @scala.inline
  implicit class CertificateAuthorityIdOps[Self <: CertificateAuthorityId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CertificateAuthority): Self = this.set("resource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteCertificateAuthorityId: Self = this.set("certificateAuthorityId", js.undefined)
