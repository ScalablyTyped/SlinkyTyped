package typingsSlinky.maximMazurokGapiClientPrivateca.anon

import typingsSlinky.maximMazurokGapiClientPrivateca.gapi.client.privateca.CertificateAuthority
...
@js.native
trait CertificateAuthorityId extends StObject {
  ...
  var certificateAuthorityId: js.UndefOr[String] = js.native
  ...
  /** Request body */
  var resource: CertificateAuthority = js.native
...
object CertificateAuthorityId {
  ...
  @scala.inline
  def apply(parent: String, resource: CertificateAuthority): CertificateAuthorityId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CertificateAuthorityId]
  }
  
  @scala.inline
  implicit class CertificateAuthorityIdMutableBuilder[Self <: CertificateAuthorityId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertificateAuthorityIdUndefined: Self = StObject.set(x, "certificateAuthorityId", js.undefined)
    ...
    @scala.inline
    def setResource(value: CertificateAuthority): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
