...
trait ReusableConfigsResource extends StObject {
  ...
  def get(request: Accesstoken): Request[ReusableConfig] = js.native
  ...
  def list(): Request[ListReusableConfigsResponse] = js.native
  def list(request: Callback): Request[ListReusableConfigsResponse] = js.native
