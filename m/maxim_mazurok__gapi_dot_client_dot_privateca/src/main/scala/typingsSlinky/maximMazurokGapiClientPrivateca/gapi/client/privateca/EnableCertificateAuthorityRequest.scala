...
@js.native
trait EnableCertificateAuthorityRequest extends js.Object {
...
object EnableCertificateAuthorityRequest {
  ...
  @scala.inline
  implicit class EnableCertificateAuthorityRequestOps[Self <: EnableCertificateAuthorityRequest] (val x: Self) extends AnyVal {
