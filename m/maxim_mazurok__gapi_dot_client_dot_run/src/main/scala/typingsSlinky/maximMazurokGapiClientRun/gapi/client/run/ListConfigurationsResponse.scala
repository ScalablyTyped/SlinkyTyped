...
object ListConfigurationsResponse {
  ...
  implicit class ListConfigurationsResponseOps[Self <: ListConfigurationsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Configuration*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[Configuration]): Self = this.set("items", value.asInstanceOf[js.Any])
