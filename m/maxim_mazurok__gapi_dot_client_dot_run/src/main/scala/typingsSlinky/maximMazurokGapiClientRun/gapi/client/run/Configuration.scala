...
object Configuration {
  ...
  implicit class ConfigurationOps[Self <: Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: ConfigurationSpec): Self = this.set("spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSpec: Self = this.set("spec", js.undefined)
    
    @scala.inline
    def setStatus(value: ConfigurationStatus): Self = this.set("status", value.asInstanceOf[js.Any])
