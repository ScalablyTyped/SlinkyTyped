...
import typingsSlinky.maximMazurokGapiClientRun.gapi.client.run.DomainMapping
import typingsSlinky.maximMazurokGapiClientRun.gapi.client.run.Service
...
object anon {
  ...
  object Fields {
    ...
    @scala.inline
    def apply(parent: String, resource: DomainMapping): Fields = {
  ...
  object Name {
    ...
    @scala.inline
    def apply(name: String, resource: Service): Name = {
