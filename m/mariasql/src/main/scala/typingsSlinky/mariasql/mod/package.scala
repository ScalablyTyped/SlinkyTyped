...
package object mod {
  ...
  type MariaCallBackInfo = js.Function1[/* result */ typingsSlinky.mariasql.mod.MariaInfo, scala.Unit]
  
  type MariaCallBackObject = js.Function1[/* result */ js.Object, scala.Unit]
  
  type MariaCallBackResult = js.Function1[/* result */ typingsSlinky.mariasql.mod.MariaResult, scala.Unit]
