...
import typingsSlinky.maximMazurokGapiClientDomainsrdap.anon.Callback
import typingsSlinky.maximMazurokGapiClientDomainsrdap.anon.Fields
import typingsSlinky.maximMazurokGapiClientDomainsrdap.anon.Key
import typingsSlinky.maximMazurokGapiClientDomainsrdap.anon.Oauthtoken
  ...
  object client {
    ...
    object domainsrdap {
      ...
      trait HttpBody extends StObject {
        ...
        {[ P in string ]: any}
          */ typingsSlinky.maximMazurokGapiClientDomainsrdap.maximMazurokGapiClientDomainsrdapStrings.HttpBody with TopLevel[js.Any]
                ]
              ] = js.native
      }
      object HttpBody {
