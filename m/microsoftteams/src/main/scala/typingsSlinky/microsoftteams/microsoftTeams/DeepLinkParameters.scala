...
object DeepLinkParameters {
  ...
  implicit class DeepLinkParametersOps[Self <: DeepLinkParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubEntityLabel(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subEntityLabel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSubEntityWebUrl(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subEntityWebUrl")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSubEntityWebUrl: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subEntityWebUrl")(js.undefined)
        ret
    }
  }
