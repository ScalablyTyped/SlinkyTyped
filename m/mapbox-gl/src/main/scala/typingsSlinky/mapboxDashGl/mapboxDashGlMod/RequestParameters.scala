...
import typingsSlinky.mapboxDashGl.mapboxDashGlStrings.GET
import typingsSlinky.mapboxDashGl.mapboxDashGlStrings.POST
import typingsSlinky.mapboxDashGl.mapboxDashGlStrings.PUT
import typingsSlinky.mapboxDashGl.mapboxDashGlStrings.`same-origin`
import typingsSlinky.mapboxDashGl.mapboxDashGlStrings.include
