...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.mapboxGl.mapboxGlStrings.center
  - typingsSlinky.mapboxGl.mapboxGlStrings.left
  - typingsSlinky.mapboxGl.mapboxGlStrings.right
  - typingsSlinky.mapboxGl.mapboxGlStrings.top
  - typingsSlinky.mapboxGl.mapboxGlStrings.bottom
  - typingsSlinky.mapboxGl.mapboxGlStrings.`top-left`
  - typingsSlinky.mapboxGl.mapboxGlStrings.`top-right`
  - typingsSlinky.mapboxGl.mapboxGlStrings.`bottom-left`
  - typingsSlinky.mapboxGl.mapboxGlStrings.`bottom-right`
*/
