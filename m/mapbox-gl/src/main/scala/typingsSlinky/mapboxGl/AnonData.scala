...
object AnonData {
  @scala.inline
  def apply(data: js.typedarray.Uint8Array | js.typedarray.Uint8ClampedArray, height: Double, width: Double): AnonData = {
  ...
  implicit class AnonDataOps[Self <: AnonData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: js.typedarray.Uint8Array | js.typedarray.Uint8ClampedArray): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("data")(value.asInstanceOf[js.Any])
        ret
    }
