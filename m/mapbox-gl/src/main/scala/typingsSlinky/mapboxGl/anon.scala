...
object anon {
  ...
  object Data {
    ...
    implicit class DataMutableBuilder[Self <: Data] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setData(value: js.typedarray.Uint8Array | js.typedarray.Uint8ClampedArray): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
  ...
  object FitBoundsOptions {
    ...
    implicit class FitBoundsOptionsMutableBuilder[Self <: FitBoundsOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFitBoundsOptions(value: typingsSlinky.mapboxGl.mod.FitBoundsOptions): Self = StObject.set(x, "fitBoundsOptions", value.asInstanceOf[js.Any])
