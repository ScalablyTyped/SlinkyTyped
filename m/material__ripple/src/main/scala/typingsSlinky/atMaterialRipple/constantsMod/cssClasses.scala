...
import typingsSlinky.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--background-focused`
import typingsSlinky.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--foreground-activation`
import typingsSlinky.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--foreground-deactivation`
import typingsSlinky.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded--unbounded`
import typingsSlinky.atMaterialRipple.atMaterialRippleStrings.`mdc-ripple-upgraded`
