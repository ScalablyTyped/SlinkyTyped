...
object mod {
  ...
  class MDCRipple protected ()
    extends typingsSlinky.materialRipple.componentMod.MDCRipple {
    def this(root: Element, foundation: js.UndefOr[scala.Nothing], args: js.Any*) = this()
    def this(
      root: Element,
      foundation: typingsSlinky.materialRipple.foundationMod.MDCRippleFoundation,
      args: js.Any*
    ) = this()
  }
  /* static members */
  ...
  class MDCRippleFoundation ()
    extends typingsSlinky.materialRipple.foundationMod.MDCRippleFoundation {
