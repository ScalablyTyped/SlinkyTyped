...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/ripple/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/ripple/constants", "cssClasses.BG_FOCUSED")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "cssClasses.FG_ACTIVATION")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "cssClasses.FG_DEACTIVATION")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "cssClasses.ROOT")
    @js.native
    def ROOT: String = js.native
    @scala.inline
    def ROOT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ROOT")(x.asInstanceOf[js.Any])
    
    @JSImport("@material/ripple/constants", "cssClasses.UNBOUNDED")
    @js.native
  ...
  object numbers {
    ...
    @JSImport("@material/ripple/constants", "numbers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/ripple/constants", "numbers.DEACTIVATION_TIMEOUT_MS")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "numbers.FG_DEACTIVATION_MS")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "numbers.INITIAL_ORIGIN_SCALE")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "numbers.PADDING")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "numbers.TAP_DELAY_MS")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/ripple/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/ripple/constants", "strings.VAR_FG_SCALE")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "strings.VAR_FG_SIZE")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "strings.VAR_FG_TRANSLATE_END")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "strings.VAR_FG_TRANSLATE_START")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "strings.VAR_LEFT")
    @js.native
    ...
    @JSImport("@material/ripple/constants", "strings.VAR_TOP")
    @js.native
