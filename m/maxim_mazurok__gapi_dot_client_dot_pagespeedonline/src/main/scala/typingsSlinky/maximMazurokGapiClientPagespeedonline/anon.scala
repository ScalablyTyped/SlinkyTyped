package typingsSlinky.maximMazurokGapiClientPagespeedonline
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    var captchaToken: js.UndefOr[String] = js.native
    
    /** A Lighthouse category to run; if none are given, only Performance category will be run */
    var category: js.UndefOr[String | js.Array[String]] = js.native
  ...
  object Accesstoken {
    ...
    implicit class AccesstokenMutableBuilder[Self <: Accesstoken] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCaptchaToken(value: String): Self = StObject.set(x, "captchaToken", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCaptchaTokenUndefined: Self = StObject.set(x, "captchaToken", js.undefined)
