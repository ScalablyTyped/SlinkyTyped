...
object PartialInTrackingOptions {
  ...
  implicit class PartialInTrackingOptionsOps[Self <: PartialInTrackingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutTrack_event_name: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("track_event_name")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withoutTrack_event_properties: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("track_event_properties")(js.undefined)
        ret
    }
  }
