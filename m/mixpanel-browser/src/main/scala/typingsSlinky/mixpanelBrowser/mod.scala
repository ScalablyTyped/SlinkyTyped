...
import typingsSlinky.mixpanelBrowser.anon.PartialConfig
import typingsSlinky.mixpanelBrowser.anon.PartialConfigApihost
import typingsSlinky.mixpanelBrowser.anon.PartialHasOptedInOutOptio
import typingsSlinky.mixpanelBrowser.anon.PartialInTrackingOptions
...
object mod extends Shortcut {
  ...
  */
  ...
  object Persistence {
    ...
    @scala.inline
    def cookie: typingsSlinky.mixpanelBrowser.mixpanelBrowserStrings.cookie = "cookie".asInstanceOf[typingsSlinky.mixpanelBrowser.mixpanelBrowserStrings.cookie]
    
    @scala.inline
    def localStorage: typingsSlinky.mixpanelBrowser.mixpanelBrowserStrings.localStorage = "localStorage".asInstanceOf[typingsSlinky.mixpanelBrowser.mixpanelBrowserStrings.localStorage]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.mixpanelBrowser.mod.VerboseResponse
    - typingsSlinky.mixpanelBrowser.mod.NormalResponse
  */
  ...
  */
  ...
  object VerboseResponse {
    ...
    @scala.inline
    def Error(error: Null, status: `1`): typingsSlinky.mixpanelBrowser.anon.Error = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mixpanelBrowser.anon.Error]
    }
    
    @scala.inline
    def Status(error: String, status: `0`): typingsSlinky.mixpanelBrowser.anon.Status = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.mixpanelBrowser.anon.Status]
    }
  }
