...
object PartialOutTrackingOptions {
  ...
  implicit class PartialOutTrackingOptionsOps[Self <: PartialOutTrackingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDelete_user(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete_user")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDelete_user: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("delete_user")(js.undefined)
        ret
    }
    @scala.inline
