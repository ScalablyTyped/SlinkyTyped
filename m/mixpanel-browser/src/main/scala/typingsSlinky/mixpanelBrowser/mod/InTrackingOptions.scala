...
object InTrackingOptions {
  ...
  implicit class InTrackingOptionsOps[Self <: InTrackingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTrack(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("track")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withTrack_event_name(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("track_event_name")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTrack_event_properties(value: Dict): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("track_event_properties")(value.asInstanceOf[js.Any])
        ret
    }
  }
