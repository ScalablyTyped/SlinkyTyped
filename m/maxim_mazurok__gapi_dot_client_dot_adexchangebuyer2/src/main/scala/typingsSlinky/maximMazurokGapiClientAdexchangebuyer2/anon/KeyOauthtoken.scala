...
import typingsSlinky.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.CompleteSetupRequest
...
trait KeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: CompleteSetupRequest = js.native
...
object KeyOauthtoken {
  ...
  @scala.inline
  def apply(accountId: String, proposalId: String, resource: CompleteSetupRequest): KeyOauthtoken = {
  ...
  implicit class KeyOauthtokenMutableBuilder[Self <: KeyOauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: CompleteSetupRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
