...
@js.native
trait FilterSetName extends StObject {
...
object FilterSetName {
  
  @scala.inline
  def apply(filterSetName: String): FilterSetName = {
    val __obj = js.Dynamic.literal(filterSetName = filterSetName.asInstanceOf[js.Any])
    __obj.asInstanceOf[FilterSetName]
  }
  
  @scala.inline
  implicit class FilterSetNameMutableBuilder[Self <: FilterSetName] (val x: Self) extends AnyVal {
