...
object DeliveryControl {
  ...
  implicit class DeliveryControlOps[Self <: DeliveryControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrequencyCapsVarargs(value: FrequencyCap*): Self = this.set("frequencyCaps", js.Array(value :_*))
    
    @scala.inline
    def setFrequencyCaps(value: js.Array[FrequencyCap]): Self = this.set("frequencyCaps", value.asInstanceOf[js.Any])
