package typingsSlinky.mqtt.typesLibClientDashOptionsMod
...
import typingsSlinky.mqtt.typesLibClientMod.MqttClient
import typingsSlinky.mqtt.typesLibStoreMod.Store
...
trait IClientOptions extends ISecureClientOptions {
  ...
  var servers: js.UndefOr[js.Array[Anon_Host]] = js.undefined
