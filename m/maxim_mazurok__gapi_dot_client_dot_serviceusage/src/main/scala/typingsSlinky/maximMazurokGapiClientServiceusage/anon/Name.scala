package typingsSlinky.maximMazurokGapiClientServiceusage.anon

import typingsSlinky.maximMazurokGapiClientServiceusage.gapi.client.serviceusage.DisableServiceRequest
...
object Name {
  ...
  implicit class NameOps[Self <: Name] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: DisableServiceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
