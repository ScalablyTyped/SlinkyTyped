package typingsSlinky.momentDashDurationDashFormat.momentDashDurationDashFormatMod
...
package object momentMod {
  ...
  {[ duration in moment-duration-format.moment-duration-format.moment.DurationToken ]: string}
    */ typingsSlinky.momentDashDurationDashFormat.momentDashDurationDashFormatStrings.DurationLabelDef with js.Any
  ...
  {[ template in moment-duration-format.moment-duration-format.moment.DurationTemplate ]: string}
    */ typingsSlinky.momentDashDurationDashFormat.momentDashDurationDashFormatStrings.DurationTimeDef with js.Any
