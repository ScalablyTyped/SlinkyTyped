...
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.Discriminant
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.Required
...
trait JsonSchema extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.JsonSchema}
    */ typingsSlinky.maximMazurokGapiClientDiscovery.maximMazurokGapiClientDiscoveryStrings.JsonSchema with TopLevel[js.Any]
  ] = js.native
