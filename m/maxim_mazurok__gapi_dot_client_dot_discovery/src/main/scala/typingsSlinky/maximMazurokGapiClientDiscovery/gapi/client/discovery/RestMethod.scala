package typingsSlinky.maximMazurokGapiClientDiscovery.gapi.client.discovery

import org.scalablytyped.runtime.TopLevel
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.Accept
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.ParameterName
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.`0`
...
trait RestMethod extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.JsonSchema}
    */ typingsSlinky.maximMazurokGapiClientDiscovery.maximMazurokGapiClientDiscoveryStrings.RestMethod with TopLevel[js.Any]
  ] = js.native
