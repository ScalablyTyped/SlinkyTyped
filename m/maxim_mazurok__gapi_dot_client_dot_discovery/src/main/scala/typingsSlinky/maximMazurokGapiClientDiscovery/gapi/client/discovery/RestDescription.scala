...
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.Oauth2
import typingsSlinky.maximMazurokGapiClientDiscovery.anon.X16
...
trait RestDescription extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestMethod}
    */ typingsSlinky.maximMazurokGapiClientDiscovery.maximMazurokGapiClientDiscoveryStrings.RestDescription with TopLevel[js.Any]
  ] = js.native
