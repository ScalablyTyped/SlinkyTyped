...
object chipConstantsMod {
  ...
  object Direction extends StObject {
    ...
    /* "left" */ val LEFT: typingsSlinky.materialChips.chipConstantsMod.Direction.LEFT with String = js.native
    
    @js.native
    sealed trait RIGHT extends Direction
    /* "right" */ val RIGHT: typingsSlinky.materialChips.chipConstantsMod.Direction.RIGHT with String = js.native
  }
  ...
  object EventSource extends StObject {
    ...
    /* "none" */ val NONE: typingsSlinky.materialChips.chipConstantsMod.EventSource.NONE with String = js.native
    
    @js.native
    sealed trait PRIMARY extends EventSource
    /* "primary" */ val PRIMARY: typingsSlinky.materialChips.chipConstantsMod.EventSource.PRIMARY with String = js.native
    
    @js.native
    sealed trait TRAILING extends EventSource
    /* "trailing" */ val TRAILING: typingsSlinky.materialChips.chipConstantsMod.EventSource.TRAILING with String = js.native
  }
