...
object constantsMod {
  ...
  object cssClasses {
    ...
    @JSImport("@material/chips/chip-set/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/chips/chip-set/constants", "cssClasses.CHOICE")
    @js.native
    def CHOICE: String = js.native
    @scala.inline
    def CHOICE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CHOICE")(x.asInstanceOf[js.Any])
    
    @JSImport("@material/chips/chip-set/constants", "cssClasses.FILTER")
    @js.native
  ...
  object strings {
    ...
    @JSImport("@material/chips/chip-set/constants", "strings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/chips/chip-set/constants", "strings.CHIP_SELECTOR")
    @js.native
