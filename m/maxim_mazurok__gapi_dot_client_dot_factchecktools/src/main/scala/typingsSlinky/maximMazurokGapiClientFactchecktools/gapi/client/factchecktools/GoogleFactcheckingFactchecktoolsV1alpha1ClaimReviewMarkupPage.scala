...
@js.native
trait GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage extends js.Object {
...
object GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage {
  ...
  @scala.inline
  implicit class GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPageOps[Self <: GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClaimReviewAuthor(value: GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewAuthor): Self = this.set("claimReviewAuthor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteClaimReviewAuthor: Self = this.set("claimReviewAuthor", js.undefined)
    
    @scala.inline
    def setClaimReviewMarkupsVarargs(value: GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup*): Self = this.set("claimReviewMarkups", js.Array(value :_*))
    
    @scala.inline
    def setClaimReviewMarkups(value: js.Array[GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup]): Self = this.set("claimReviewMarkups", value.asInstanceOf[js.Any])
