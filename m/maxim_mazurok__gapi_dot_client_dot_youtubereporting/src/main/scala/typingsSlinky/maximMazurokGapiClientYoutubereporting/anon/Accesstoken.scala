package typingsSlinky.maximMazurokGapiClientYoutubereporting.anon
...
object Accesstoken {
  ...
  @scala.inline
  def apply(jobId: String, reportId: String): Accesstoken = {
    val __obj = js.Dynamic.literal(jobId = jobId.asInstanceOf[js.Any], reportId = reportId.asInstanceOf[js.Any])
