...
trait DefaultReducer extends js.Object {
  ...
  def unset(state: js.Array[String], action: Action): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias mongorito.mongorito.Reducer<any> */ js.Object = js.native
}
