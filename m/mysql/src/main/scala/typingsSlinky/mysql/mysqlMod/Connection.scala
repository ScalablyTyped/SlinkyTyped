...
import typingsSlinky.mysql.mysqlStrings.authenticated
import typingsSlinky.mysql.mysqlStrings.connect
import typingsSlinky.mysql.mysqlStrings.connected
import typingsSlinky.mysql.mysqlStrings.disconnected
import typingsSlinky.mysql.mysqlStrings.drain
import typingsSlinky.mysql.mysqlStrings.end
import typingsSlinky.mysql.mysqlStrings.enqueue
