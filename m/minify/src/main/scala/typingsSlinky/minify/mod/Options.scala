package typingsSlinky.minify.mod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCss(value: typingsSlinky.cleanCss.mod.Options): Self = this.set("css", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCss: Self = this.set("css", js.undefined)
    
    @scala.inline
    def setHtml(value: typingsSlinky.htmlMinifierTerser.mod.Options): Self = this.set("html", value.asInstanceOf[js.Any])
