...
@js.native
trait KeyLanguageCode extends StObject {
...
object KeyLanguageCode {
  ...
  @scala.inline
  def apply(parent: String): KeyLanguageCode = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyLanguageCode]
  }
  
  @scala.inline
  implicit class KeyLanguageCodeMutableBuilder[Self <: KeyLanguageCode] (val x: Self) extends AnyVal {
