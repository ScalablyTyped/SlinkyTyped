...
import typingsSlinky.maximMazurokGapiClientDialogflow.gapi.client.dialogflow.GoogleCloudDialogflowV2DetectIntentRequest
...
trait Session extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDialogflowV2DetectIntentRequest = js.native
...
object Session {
  ...
  @scala.inline
  def apply(resource: GoogleCloudDialogflowV2DetectIntentRequest, session: String): Session = {
  ...
  implicit class SessionMutableBuilder[Self <: Session] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: GoogleCloudDialogflowV2DetectIntentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
