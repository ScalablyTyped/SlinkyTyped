...
import typingsSlinky.maximMazurokGapiClientDialogflow.gapi.client.dialogflow.GoogleCloudDialogflowV2Intent
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait LanguageCodeName extends js.Object {
...
object LanguageCodeName {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDialogflowV2Intent): LanguageCodeName = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[LanguageCodeName]
  }
  
  @scala.inline
  implicit class LanguageCodeNameOps[Self <: LanguageCodeName] (val x: Self) extends AnyVal {
