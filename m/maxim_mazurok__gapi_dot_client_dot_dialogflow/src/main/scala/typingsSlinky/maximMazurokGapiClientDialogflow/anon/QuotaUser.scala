...
import typingsSlinky.maximMazurokGapiClientDialogflow.gapi.client.dialogflow.GoogleCloudDialogflowV2EntityType
...
object QuotaUser {
  ...
  @scala.inline
  def apply(name: String, resource: GoogleCloudDialogflowV2EntityType): QuotaUser = {
