...
@js.native
trait IntentViewKey extends StObject {
...
object IntentViewKey {
  
  @scala.inline
  def apply(name: String): IntentViewKey = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[IntentViewKey]
  }
  
  @scala.inline
  implicit class IntentViewKeyMutableBuilder[Self <: IntentViewKey] (val x: Self) extends AnyVal {
