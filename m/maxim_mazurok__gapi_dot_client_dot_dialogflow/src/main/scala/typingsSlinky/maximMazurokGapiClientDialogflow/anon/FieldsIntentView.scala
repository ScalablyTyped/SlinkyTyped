...
@js.native
trait FieldsIntentView extends StObject {
...
object FieldsIntentView {
  
  @scala.inline
  def apply(parent: String): FieldsIntentView = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsIntentView]
  }
  
  @scala.inline
  implicit class FieldsIntentViewMutableBuilder[Self <: FieldsIntentView] (val x: Self) extends AnyVal {
