...
@js.native
trait GoogleCloudDialogflowV2beta1Sentiment extends js.Object {
...
object GoogleCloudDialogflowV2beta1Sentiment {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1SentimentOps[Self <: GoogleCloudDialogflowV2beta1Sentiment] (val x: Self) extends AnyVal {
