...
@js.native
trait GoogleCloudDialogflowV2SynthesizeSpeechConfig extends js.Object {
...
object GoogleCloudDialogflowV2SynthesizeSpeechConfig {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2SynthesizeSpeechConfigOps[Self <: GoogleCloudDialogflowV2SynthesizeSpeechConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVoice(value: GoogleCloudDialogflowV2VoiceSelectionParams): Self = this.set("voice", value.asInstanceOf[js.Any])
