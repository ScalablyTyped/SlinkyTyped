...
@js.native
trait GoogleCloudDialogflowV2beta1EntityType extends js.Object {
...
object GoogleCloudDialogflowV2beta1EntityType {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1EntityTypeOps[Self <: GoogleCloudDialogflowV2beta1EntityType] (val x: Self) extends AnyVal {
