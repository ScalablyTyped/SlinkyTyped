...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageListSelectItem extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageListSelectItem {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageListSelectItemOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageListSelectItem] (val x: Self) extends AnyVal {
