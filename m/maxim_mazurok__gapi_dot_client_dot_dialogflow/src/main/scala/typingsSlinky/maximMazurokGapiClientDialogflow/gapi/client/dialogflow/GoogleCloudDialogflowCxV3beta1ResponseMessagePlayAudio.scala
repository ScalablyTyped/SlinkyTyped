...
@js.native
trait GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudio extends js.Object {
...
object GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudio {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudioOps[Self <: GoogleCloudDialogflowCxV3beta1ResponseMessagePlayAudio] (val x: Self) extends AnyVal {
