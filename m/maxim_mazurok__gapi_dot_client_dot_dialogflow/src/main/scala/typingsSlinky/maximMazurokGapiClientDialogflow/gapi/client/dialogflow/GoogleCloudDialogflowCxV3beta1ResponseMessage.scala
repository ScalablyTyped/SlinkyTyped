...
trait GoogleCloudDialogflowCxV3beta1ResponseMessage extends StObject {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowCxV3beta1ResponseMessage with TopLevel[js.Any]
  ] = js.native
