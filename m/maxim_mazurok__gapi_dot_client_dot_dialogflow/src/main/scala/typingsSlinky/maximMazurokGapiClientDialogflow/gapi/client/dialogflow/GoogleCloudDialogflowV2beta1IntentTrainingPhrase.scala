...
@js.native
trait GoogleCloudDialogflowV2beta1IntentTrainingPhrase extends js.Object {
  ...
  /**
    ...
    */
  var parts: js.UndefOr[js.Array[GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart]] = js.native
...
object GoogleCloudDialogflowV2beta1IntentTrainingPhrase {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentTrainingPhraseOps[Self <: GoogleCloudDialogflowV2beta1IntentTrainingPhrase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPartsVarargs(value: GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart*): Self = this.set("parts", js.Array(value :_*))
    
    @scala.inline
    def setParts(value: js.Array[GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart]): Self = this.set("parts", value.asInstanceOf[js.Any])
