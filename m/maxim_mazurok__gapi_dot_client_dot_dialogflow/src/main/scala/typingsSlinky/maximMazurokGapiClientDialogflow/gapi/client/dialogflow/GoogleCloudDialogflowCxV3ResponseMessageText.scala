...
@js.native
trait GoogleCloudDialogflowCxV3ResponseMessageText extends js.Object {
...
object GoogleCloudDialogflowCxV3ResponseMessageText {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowCxV3ResponseMessageTextOps[Self <: GoogleCloudDialogflowCxV3ResponseMessageText] (val x: Self) extends AnyVal {
