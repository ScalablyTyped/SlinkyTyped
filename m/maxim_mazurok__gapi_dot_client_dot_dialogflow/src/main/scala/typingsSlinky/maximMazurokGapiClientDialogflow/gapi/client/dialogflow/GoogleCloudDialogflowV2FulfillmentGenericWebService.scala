...
trait GoogleCloudDialogflowV2FulfillmentGenericWebService extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2FulfillmentGenericWebService with TopLevel[js.Any]
  ] = js.native
