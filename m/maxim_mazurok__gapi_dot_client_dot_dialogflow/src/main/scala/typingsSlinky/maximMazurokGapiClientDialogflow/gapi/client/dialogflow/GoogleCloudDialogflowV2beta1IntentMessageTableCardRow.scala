...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageTableCardRow extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageTableCardRow {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageTableCardRowOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageTableCardRow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCellsVarargs(value: GoogleCloudDialogflowV2beta1IntentMessageTableCardCell*): Self = this.set("cells", js.Array(value :_*))
    
    @scala.inline
    def setCells(value: js.Array[GoogleCloudDialogflowV2beta1IntentMessageTableCardCell]): Self = this.set("cells", value.asInstanceOf[js.Any])
