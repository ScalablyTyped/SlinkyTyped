...
@js.native
trait GoogleCloudDialogflowV2VoiceSelectionParams extends js.Object {
...
object GoogleCloudDialogflowV2VoiceSelectionParams {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2VoiceSelectionParamsOps[Self <: GoogleCloudDialogflowV2VoiceSelectionParams] (val x: Self) extends AnyVal {
