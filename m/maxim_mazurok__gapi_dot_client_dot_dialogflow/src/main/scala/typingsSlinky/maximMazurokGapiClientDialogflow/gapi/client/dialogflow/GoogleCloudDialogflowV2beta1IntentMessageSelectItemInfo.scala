...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo {
  ...
  @scala.inline
  def apply(): GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo]
  }
  
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfoOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo] (val x: Self) extends AnyVal {
