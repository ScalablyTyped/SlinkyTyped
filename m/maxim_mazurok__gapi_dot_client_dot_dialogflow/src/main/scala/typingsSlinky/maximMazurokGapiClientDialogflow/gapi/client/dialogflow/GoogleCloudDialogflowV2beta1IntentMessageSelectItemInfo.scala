...
object GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfoMutableBuilder[Self <: GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo] (val x: Self) extends AnyVal {
