...
trait GoogleCloudDialogflowV2OriginalDetectIntentRequest extends StObject {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2OriginalDetectIntentRequest with TopLevel[js.Any]
  ] = js.native
