...
@js.native
trait GoogleCloudDialogflowV2ImportAgentRequest extends js.Object {
...
object GoogleCloudDialogflowV2ImportAgentRequest {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2ImportAgentRequestOps[Self <: GoogleCloudDialogflowV2ImportAgentRequest] (val x: Self) extends AnyVal {
