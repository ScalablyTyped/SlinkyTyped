...
@js.native
trait GoogleCloudDialogflowV2beta1Context extends js.Object {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientDialogflow.maximMazurokGapiClientDialogflowStrings.GoogleCloudDialogflowV2beta1Context with TopLevel[js.Any]
  ] = js.native
}
object GoogleCloudDialogflowV2beta1Context {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1ContextOps[Self <: GoogleCloudDialogflowV2beta1Context] (val x: Self) extends AnyVal {
