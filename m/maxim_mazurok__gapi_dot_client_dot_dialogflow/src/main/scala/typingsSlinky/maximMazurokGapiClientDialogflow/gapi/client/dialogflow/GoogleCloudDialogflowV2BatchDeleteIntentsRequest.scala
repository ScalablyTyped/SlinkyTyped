...
@js.native
trait GoogleCloudDialogflowV2BatchDeleteIntentsRequest extends js.Object {
...
object GoogleCloudDialogflowV2BatchDeleteIntentsRequest {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2BatchDeleteIntentsRequestOps[Self <: GoogleCloudDialogflowV2BatchDeleteIntentsRequest] (val x: Self) extends AnyVal {
