...
@js.native
trait GoogleCloudDialogflowV2TextInput extends js.Object {
...
object GoogleCloudDialogflowV2TextInput {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2TextInputOps[Self <: GoogleCloudDialogflowV2TextInput] (val x: Self) extends AnyVal {
