...
@js.native
trait GoogleCloudDialogflowV2beta1IntentMessageQuickReplies extends js.Object {
...
object GoogleCloudDialogflowV2beta1IntentMessageQuickReplies {
  ...
  @scala.inline
  implicit class GoogleCloudDialogflowV2beta1IntentMessageQuickRepliesOps[Self <: GoogleCloudDialogflowV2beta1IntentMessageQuickReplies] (val x: Self) extends AnyVal {
