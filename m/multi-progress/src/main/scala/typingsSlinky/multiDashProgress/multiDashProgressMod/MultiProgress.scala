...
import typingsSlinky.progress.progressMod.ProgressBarOptions
...
trait MultiProgress extends js.Object {
  ...
  /**
    * Add a new bar
    */
  def newBar(format: String, options: ProgressBarOptions): typingsSlinky.progress.progressMod.^ = js.native
  /**
    * Close all bars
    */
