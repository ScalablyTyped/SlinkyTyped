...
object Queue {
  ...
  implicit class QueueOps[Self <: Queue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProcess(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Process")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withPush(value: js.Array[_] => CallbackObject): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSuspend(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Suspend")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCall(value: () => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWait(value: js.Function => js.Function): Self = {
        val ret = this.duplicate
