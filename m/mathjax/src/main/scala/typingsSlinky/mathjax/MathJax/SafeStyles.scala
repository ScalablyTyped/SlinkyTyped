...
object SafeStyles {
  ...
  implicit class SafeStylesOps[Self <: SafeStyles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackgroundColor(value: Boolean): Self = {
    ...
    @scala.inline
    def withFontFamily(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontSize(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontStyle(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontWeight(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextShadow(value: Boolean): Self = {
        val ret = this.duplicate
