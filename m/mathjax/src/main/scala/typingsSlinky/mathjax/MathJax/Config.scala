...
object Config {
  ...
  def apply(
    ...
    if (!js.isUndefined(positionToHash)) __obj.updateDynamic("positionToHash")(positionToHash.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showMathMenuMSIE)) __obj.updateDynamic("showMathMenuMSIE")(showMathMenuMSIE.asInstanceOf[js.Any])
    if (!js.isUndefined(showProcessingMessages)) __obj.updateDynamic("showProcessingMessages")(showProcessingMessages.asInstanceOf[js.Any])
    if (!js.isUndefined(skipStartupTypeset)) __obj.updateDynamic("skipStartupTypeset")(skipStartupTypeset.asInstanceOf[js.Any])
