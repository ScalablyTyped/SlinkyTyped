...
trait Config extends js.Object {
  ...
  var FontWarnings: js.UndefOr[typingsSlinky.mathjax.MathJax.FontWarnings] = js.undefined
  var `HTML-CSS`: js.UndefOr[HTMLCSSOutputProcessor] = js.undefined
  var MMLorHTML: js.UndefOr[MMLorHTMLConfiguration] = js.undefined
  var MatchWebFonts: js.UndefOr[typingsSlinky.mathjax.MathJax.MatchWebFonts] = js.undefined
  var MathEvents: js.UndefOr[typingsSlinky.mathjax.MathJax.MathEvents] = js.undefined
  var MathML: js.UndefOr[MathMLInputProcessor] = js.undefined
  var MathMenu: js.UndefOr[typingsSlinky.mathjax.MathJax.MathMenu] = js.undefined
  var MathZoom: js.UndefOr[typingsSlinky.mathjax.MathJax.MathZoom] = js.undefined
  var NativeMML: js.UndefOr[NativeMMLOutputProcessor] = js.undefined
  var SVG: js.UndefOr[SVGOutputProcessor] = js.undefined
  var Safe: js.UndefOr[typingsSlinky.mathjax.MathJax.Safe] = js.undefined
...
object Config {
  ...
  def apply(
    ...
    if (CommonHTML != null) __obj.updateDynamic("CommonHTML")(CommonHTML.asInstanceOf[js.Any])
    if (FontWarnings != null) __obj.updateDynamic("FontWarnings")(FontWarnings.asInstanceOf[js.Any])
    if (`HTML-CSS` != null) __obj.updateDynamic("HTML-CSS")(`HTML-CSS`.asInstanceOf[js.Any])
    if (MMLorHTML != null) __obj.updateDynamic("MMLorHTML")(MMLorHTML.asInstanceOf[js.Any])
    if (MatchWebFonts != null) __obj.updateDynamic("MatchWebFonts")(MatchWebFonts.asInstanceOf[js.Any])
    if (MathEvents != null) __obj.updateDynamic("MathEvents")(MathEvents.asInstanceOf[js.Any])
    if (MathML != null) __obj.updateDynamic("MathML")(MathML.asInstanceOf[js.Any])
    if (MathMenu != null) __obj.updateDynamic("MathMenu")(MathMenu.asInstanceOf[js.Any])
    if (MathZoom != null) __obj.updateDynamic("MathZoom")(MathZoom.asInstanceOf[js.Any])
    if (NativeMML != null) __obj.updateDynamic("NativeMML")(NativeMML.asInstanceOf[js.Any])
    if (SVG != null) __obj.updateDynamic("SVG")(SVG.asInstanceOf[js.Any])
    if (Safe != null) __obj.updateDynamic("Safe")(Safe.asInstanceOf[js.Any])
    if (TeX != null) __obj.updateDynamic("TeX")(TeX.asInstanceOf[js.Any])
    if (asciimath2jax != null) __obj.updateDynamic("asciimath2jax")(asciimath2jax.asInstanceOf[js.Any])
    if (config != null) __obj.updateDynamic("config")(config.asInstanceOf[js.Any])
    if (delayStartupUntil != null) __obj.updateDynamic("delayStartupUntil")(delayStartupUntil.asInstanceOf[js.Any])
    if (displayAlign != null) __obj.updateDynamic("displayAlign")(displayAlign.asInstanceOf[js.Any])
    if (displayIndent != null) __obj.updateDynamic("displayIndent")(displayIndent.asInstanceOf[js.Any])
    if (elements != null) __obj.updateDynamic("elements")(elements.asInstanceOf[js.Any])
    if (errorSettings != null) __obj.updateDynamic("errorSettings")(errorSettings.asInstanceOf[js.Any])
    if (extensions != null) __obj.updateDynamic("extensions")(extensions.asInstanceOf[js.Any])
    if (jax != null) __obj.updateDynamic("jax")(jax.asInstanceOf[js.Any])
    if (jsMath2jax != null) __obj.updateDynamic("jsMath2jax")(jsMath2jax.asInstanceOf[js.Any])
    ...
    if (mml2jax != null) __obj.updateDynamic("mml2jax")(mml2jax.asInstanceOf[js.Any])
    if (!js.isUndefined(positionToHash)) __obj.updateDynamic("positionToHash")(positionToHash.get.asInstanceOf[js.Any])
    if (postJax != null) __obj.updateDynamic("postJax")(postJax.asInstanceOf[js.Any])
    if (preJax != null) __obj.updateDynamic("preJax")(preJax.asInstanceOf[js.Any])
    if (preRemoveClass != null) __obj.updateDynamic("preRemoveClass")(preRemoveClass.asInstanceOf[js.Any])
    if (!js.isUndefined(showMathMenu)) __obj.updateDynamic("showMathMenu")(showMathMenu.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showMathMenuMSIE)) __obj.updateDynamic("showMathMenuMSIE")(showMathMenuMSIE.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showProcessingMessages)) __obj.updateDynamic("showProcessingMessages")(showProcessingMessages.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skipStartupTypeset)) __obj.updateDynamic("skipStartupTypeset")(skipStartupTypeset.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`v1Dot0-compatible`)) __obj.updateDynamic("v1.0-compatible")(`v1Dot0-compatible`.get.asInstanceOf[js.Any])
