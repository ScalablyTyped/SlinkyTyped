...
object Register {
  ...
  implicit class RegisterOps[Self <: Register] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoadHook(value: (String, js.Function) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LoadHook")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withMessageHook(value: (String, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MessageHook")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withPreProcessor(value: js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PreProcessor")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStartupHook(value: (String, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartupHook")(js.Any.fromFunction2(value))
        ret
    }
  }
