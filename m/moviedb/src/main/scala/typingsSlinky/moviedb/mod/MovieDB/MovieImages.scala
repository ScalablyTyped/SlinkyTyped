...
object MovieImages {
  ...
  implicit class MovieImagesOps[Self <: MovieImages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackdrops(value: js.Array[MovieImage]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("backdrops")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPosters(value: js.Array[MovieImage]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("posters")(value.asInstanceOf[js.Any])
        ret
    }
  }
