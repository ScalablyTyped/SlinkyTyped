...
@js.native
trait ApigatewayLocation extends js.Object {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientApigateway.maximMazurokGapiClientApigatewayStrings.ApigatewayLocation with TopLevel[js.Any]
  ] = js.native
...
object ApigatewayLocation {
  ...
  @scala.inline
  implicit class ApigatewayLocationOps[Self <: ApigatewayLocation] (val x: Self) extends AnyVal {
