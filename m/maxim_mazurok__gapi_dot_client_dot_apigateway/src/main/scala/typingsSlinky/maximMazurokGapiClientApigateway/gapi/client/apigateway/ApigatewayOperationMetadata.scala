...
@js.native
trait ApigatewayOperationMetadata extends js.Object {
  ...
  var diagnostics: js.UndefOr[js.Array[ApigatewayOperationMetadataDiagnostic]] = js.native
...
object ApigatewayOperationMetadata {
  ...
  @scala.inline
  implicit class ApigatewayOperationMetadataOps[Self <: ApigatewayOperationMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDiagnosticsVarargs(value: ApigatewayOperationMetadataDiagnostic*): Self = this.set("diagnostics", js.Array(value :_*))
    
    @scala.inline
    def setDiagnostics(value: js.Array[ApigatewayOperationMetadataDiagnostic]): Self = this.set("diagnostics", value.asInstanceOf[js.Any])
