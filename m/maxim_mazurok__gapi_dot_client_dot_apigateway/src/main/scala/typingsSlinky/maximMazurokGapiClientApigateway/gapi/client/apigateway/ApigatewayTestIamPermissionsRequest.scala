...
@js.native
trait ApigatewayTestIamPermissionsRequest extends js.Object {
...
object ApigatewayTestIamPermissionsRequest {
  ...
  @scala.inline
  def apply(): ApigatewayTestIamPermissionsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ApigatewayTestIamPermissionsRequest]
  }
  
  @scala.inline
  implicit class ApigatewayTestIamPermissionsRequestOps[Self <: ApigatewayTestIamPermissionsRequest] (val x: Self) extends AnyVal {
