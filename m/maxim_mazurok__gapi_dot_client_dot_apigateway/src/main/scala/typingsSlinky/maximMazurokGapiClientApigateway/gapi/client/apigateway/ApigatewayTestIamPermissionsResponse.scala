...
@js.native
trait ApigatewayTestIamPermissionsResponse extends js.Object {
...
object ApigatewayTestIamPermissionsResponse {
  ...
  @scala.inline
  def apply(): ApigatewayTestIamPermissionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ApigatewayTestIamPermissionsResponse]
  }
  
  @scala.inline
  implicit class ApigatewayTestIamPermissionsResponseOps[Self <: ApigatewayTestIamPermissionsResponse] (val x: Self) extends AnyVal {
