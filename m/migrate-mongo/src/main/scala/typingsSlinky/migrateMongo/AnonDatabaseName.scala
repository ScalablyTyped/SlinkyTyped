...
trait AnonDatabaseName extends js.Object {
  ...
  var url: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<migrate-mongo.FnCallUriOptionsCallback>[0] */ js.Any = js.native
}
...
object AnonDatabaseName {
  ...
  @scala.inline
  implicit class AnonDatabaseNameOps[Self <: AnonDatabaseName] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withUrl(
      value: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<migrate-mongo.FnCallUriOptionsCallback>[0] */ js.Any
    ): Self = {
        val ret = this.duplicate
