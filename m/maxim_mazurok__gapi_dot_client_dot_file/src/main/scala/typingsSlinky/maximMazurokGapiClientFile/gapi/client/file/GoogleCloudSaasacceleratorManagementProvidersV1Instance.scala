...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends StObject {
  ...
  {[ P in string ]: string}
    */ typingsSlinky.maximMazurokGapiClientFile.maximMazurokGapiClientFileStrings.GoogleCloudSaasacceleratorManagementProvidersV1Instance with TopLevel[js.Any]
  ] = js.native
