...
trait GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings extends js.Object {
  ...
  {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.MaintenancePolicy}
    */ typingsSlinky.maximMazurokGapiClientFile.maximMazurokGapiClientFileStrings.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings with TopLevel[js.Any]
  ] = js.native
}
