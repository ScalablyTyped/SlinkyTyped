...
import typingsSlinky.maximMazurokGapiClientFile.gapi.client.file.RestoreInstanceRequest
...
object QuotaUser {
  ...
  implicit class QuotaUserOps[Self <: QuotaUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: RestoreInstanceRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
