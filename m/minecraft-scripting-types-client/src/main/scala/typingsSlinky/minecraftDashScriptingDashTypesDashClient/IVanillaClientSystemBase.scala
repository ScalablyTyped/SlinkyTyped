...
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientNumbers.`true`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:client_entered_world`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:display_chat_event`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:hit_result_changed`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:hit_result_continuous`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:load_ui`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:molang`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:pick_hit_result_changed`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:pick_hit_result_continuous`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:script_logger_config`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:send_ui_event`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:spawn_particle_attached_entity`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:spawn_particle_in_world`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:ui_event`
import typingsSlinky.minecraftDashScriptingDashTypesDashClient.minecraftDashScriptingDashTypesDashClientStrings.`minecraft:unload_ui`
