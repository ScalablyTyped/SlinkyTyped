...
@js.native
trait AnonAbsorbsinput extends js.Object {
  /**
...
object AnonAbsorbsinput {
  @scala.inline
  def apply(): AnonAbsorbsinput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAbsorbsinput]
  }
  @scala.inline
  implicit class AnonAbsorbsinputOps[Self <: AnonAbsorbsinput] (val x: Self) extends AnyVal {
    @scala.inline
