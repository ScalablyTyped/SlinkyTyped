...
import typingsSlinky.minecraftScriptingTypesClient.minecraftScriptingTypesClientBooleans.`false`
import typingsSlinky.minecraftScriptingTypesClient.minecraftScriptingTypesClientBooleans.`true`
import typingsSlinky.minecraftScriptingTypesShared.IBlock
