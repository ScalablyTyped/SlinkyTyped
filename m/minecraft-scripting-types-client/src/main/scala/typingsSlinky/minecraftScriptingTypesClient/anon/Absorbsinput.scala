...
object Absorbsinput {
  ...
  def apply(
    ...
    if (!js.isUndefined(absorbs_input)) __obj.updateDynamic("absorbs_input")(absorbs_input.get.asInstanceOf[js.Any])
    if (!js.isUndefined(always_accepts_input)) __obj.updateDynamic("always_accepts_input")(always_accepts_input.get.asInstanceOf[js.Any])
    if (!js.isUndefined(force_render_below)) __obj.updateDynamic("force_render_below")(force_render_below.get.asInstanceOf[js.Any])
    if (!js.isUndefined(is_showing_menu)) __obj.updateDynamic("is_showing_menu")(is_showing_menu.get.asInstanceOf[js.Any])
    if (!js.isUndefined(render_game_behind)) __obj.updateDynamic("render_game_behind")(render_game_behind.get.asInstanceOf[js.Any])
    if (!js.isUndefined(render_only_when_topmost)) __obj.updateDynamic("render_only_when_topmost")(render_only_when_topmost.get.asInstanceOf[js.Any])
    if (!js.isUndefined(should_steal_mouse)) __obj.updateDynamic("should_steal_mouse")(should_steal_mouse.get.asInstanceOf[js.Any])
