...
import typingsSlinky.minecraftScriptingTypesClient.minecraftScriptingTypesClientBooleans.`true`
...
import typingsSlinky.minecraftScriptingTypesClient.minecraftScriptingTypesClientStrings.minecraftColonmolang
...
import typingsSlinky.minecraftScriptingTypesShared.IQuery
...
trait IVanillaClientSystemBase extends StObject {
  ...
  /**
    ...
    */
  @JSName("broadcastEvent")
  def broadcastEvent_minecraftloadui(eventIdentifier: minecraftColonload_ui, eventData: IEventData[ILoadUIParameters]): Boolean | Null = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("broadcastEvent")
  def broadcastEvent_minecraftsenduievent(eventIdentifier: minecraftColonsend_ui_event, eventData: IEventData[ISendUIEventParameters]): Boolean | Null = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("createEventData")
  def createEventData_minecraftloadui(eventIdentifier: minecraftColonload_ui): IEventData[ILoadUIParameters] | Null = js.native
  /**
    * This event is used to turn various levels of logging on and off for client scripts. Note that turning logging on/off is not limited to the script that broadcasted the event. It will affect ALL client scripts including those in other Behavior Packs that are applied to the world. See the Debugging section for more information on logging.
    */
  @JSName("createEventData")
  ...
  /**
    ...
    */
  @JSName("createEventData")
  def createEventData_minecraftsenduievent(eventIdentifier: minecraftColonsend_ui_event): IEventData[ISendUIEventParameters] | Null = js.native
  /**
    * This event is used to create a particle effect that will follow an entity around. This particle effect is only visible to the specific player that is running the client script where you fired the event. Any effect defined in a JSON file (both in your resource pack and in Minecraft) can be used here. MoLang variables defined in the JSON of the effect can then be used to control that effect by changing them in the entity to which it is attached.
    */
  @JSName("createEventData")
  ...
  def listenForEvent_minecraftcliententeredworld(
    eventIdentifier: minecraftColonclient_entered_world,
  ...
  def listenForEvent_minecrafthitresultchanged(
    eventIdentifier: minecraftColonhit_result_changed,
  ...
  def listenForEvent_minecrafthitresultcontinuous(
    eventIdentifier: minecraftColonhit_result_continuous,
  ...
  def listenForEvent_minecraftpickhitresultchanged(
    eventIdentifier: minecraftColonpick_hit_result_changed,
  ...
  def listenForEvent_minecraftpickhitresultcontinuous(
    eventIdentifier: minecraftColonpick_hit_result_continuous,
