...
/* Inlined mongoose.mongoose.Query<mongodb.mongodb.FindAndModifyWriteOpResultObject<any>> & {} */
@js.native
trait QueryFindAndModifyWriteOpAll extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[FindAndModifyWriteOpResultObject[_]] = js.native
  /**
  ...
  /** Executes the query */
  def exec(): js.Promise[FindAndModifyWriteOpResultObject[_]] = js.native
  def exec(callback: js.Function2[/* err */ NativeError, /* res */ FindAndModifyWriteOpResultObject[_], Unit]): js.Promise[FindAndModifyWriteOpResultObject[_]] = js.native
  def exec(operation: String): js.Promise[FindAndModifyWriteOpResultObject[_]] = js.native
  def exec(
    operation: String,
    callback: js.Function2[/* err */ js.Any, /* res */ FindAndModifyWriteOpResultObject[_], Unit]
  ): js.Promise[FindAndModifyWriteOpResultObject[_]] = js.native
  def exec(operation: js.Function): js.Promise[FindAndModifyWriteOpResultObject[_]] = js.native
  def exec(
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ FindAndModifyWriteOpResultObject[_], TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ FindAndModifyWriteOpResultObject[_], TResult1 | js.Thenable[TResult1]]
  ): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ FindAndModifyWriteOpResultObject[_], TResult1 | js.Thenable[TResult1]],
