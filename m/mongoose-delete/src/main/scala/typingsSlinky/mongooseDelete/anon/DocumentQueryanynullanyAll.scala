...
/* Inlined mongoose.mongoose.DocumentQuery<any | null, any, {}> & {} */
@js.native
trait DocumentQueryanynullanyAll extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[_ | Null] = js.native
  /**
  ...
  /** Executes the query */
  def exec(): js.Promise[_ | Null] = js.native
  def exec(callback: js.Function2[/* err */ NativeError, /* res */ js.Any | Null, Unit]): js.Promise[_ | Null] = js.native
  def exec(operation: String): js.Promise[_ | Null] = js.native
  def exec(operation: String, callback: js.Function2[/* err */ js.Any, /* res */ js.Any | Null, Unit]): js.Promise[_ | Null] = js.native
  def exec(operation: js.Function): js.Promise[_ | Null] = js.native
  def exec(operation: js.Function, callback: js.Function2[/* err */ js.Any, /* res */ js.Any | Null, Unit]): js.Promise[_ | Null] = js.native
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ js.Any | Null, TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ js.Any | Null, TResult1 | js.Thenable[TResult1]]): js.Promise[TResult1 | TResult2] = js.native
  /** Executes this query and returns a promise */
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ js.Any | Null, TResult1 | js.Thenable[TResult1]],
