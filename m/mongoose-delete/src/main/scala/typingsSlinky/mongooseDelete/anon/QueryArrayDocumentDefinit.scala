...
/* Inlined mongoose.mongoose.Query<std.Array<mongoose.mongoose.DocumentDefinition<any>>> & {} */
@js.native
trait QueryArrayDocumentDefinit extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[js.Array[DocumentDefinition[_]]] = js.native
  /**
  ...
  /** Executes the query */
  def exec(): js.Promise[js.Array[DocumentDefinition[_]]] = js.native
  def exec(callback: js.Function2[/* err */ NativeError, /* res */ js.Array[DocumentDefinition[_]], Unit]): js.Promise[js.Array[DocumentDefinition[_]]] = js.native
  def exec(operation: String): js.Promise[js.Array[DocumentDefinition[_]]] = js.native
  def exec(
    operation: String,
    callback: js.Function2[/* err */ js.Any, /* res */ js.Array[DocumentDefinition[_]], Unit]
  ): js.Promise[js.Array[DocumentDefinition[_]]] = js.native
  def exec(operation: js.Function): js.Promise[js.Array[DocumentDefinition[_]]] = js.native
  def exec(
  ...
  def findOne(
    ...
    projection: js.Any,
    callback: js.Function2[/* err */ js.Any, /* res */ js.Array[DocumentDefinition[_]] | Null, Unit]
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ js.Array[DocumentDefinition[_]], TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
  ...
  /**
    ...
    */
  def orFail(): DocumentQuery[NonNullable[js.Array[DocumentDefinition[_]]], _, js.Object] = js.native
  def orFail(err: js.Function0[Error]): DocumentQuery[NonNullable[js.Array[DocumentDefinition[_]]], _, js.Object] = js.native
  def orFail(err: Error): DocumentQuery[NonNullable[js.Array[DocumentDefinition[_]]], _, js.Object] = js.native
