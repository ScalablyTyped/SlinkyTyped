...
@js.native
trait QueryFindAndModifyWriteOpAsyncIterator extends js.Object {
  ...
  def findOne(
    ...
    callback: js.Function2[
      /* err */ js.Any, 
      /* res */ (FindAndModifyWriteOpResultObject[_ | Null]) | Null, 
      Unit
    ]
  ...
  /**
    ...
    */
  def orFail(): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_ | Null]], _, js.Object] = js.native
  def orFail(err: js.Function0[Error]): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_ | Null]], _, js.Object] = js.native
  def orFail(err: Error): DocumentQuery[NonNullable[FindAndModifyWriteOpResultObject[_ | Null]], _, js.Object] = js.native
