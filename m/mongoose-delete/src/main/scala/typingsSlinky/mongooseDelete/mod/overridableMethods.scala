...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.count
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.countDocuments
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.find
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.findOne
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.findOneAndUpdate
  - typingsSlinky.mongooseDelete.mongooseDeleteStrings.update
*/
