...
/* Inlined mongoose.mongoose.DocumentQuery<any, any, {}> & {} */
@js.native
trait DocumentQueryanyanyAll extends js.Object {
  /** Executes this query and returns a promise */
  @JSName("then")
  var then_Original: FnCallOnfulfilledOnrejected[_] = js.native
  /**
  ...
  def exec(operation: String): js.Promise[_] = js.native
  def exec(operation: String, callback: js.Function2[/* err */ js.Any, /* res */ js.Any, Unit]): js.Promise[_] = js.native
  def exec(operation: js.Function): js.Promise[_] = js.native
  def exec(operation: js.Function, callback: js.Function2[/* err */ js.Any, /* res */ js.Any, Unit]): js.Promise[_] = js.native
  ...
  /**
    ...
    */
  def map[TRes](fn: js.Function1[/* res */ js.Any, TRes]): (DocumentQuery[TRes, _, js.Object]) with js.Object = js.native
