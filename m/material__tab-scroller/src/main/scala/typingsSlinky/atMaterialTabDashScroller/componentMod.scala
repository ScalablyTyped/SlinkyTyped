...
import typingsSlinky.atMaterialTabDashScroller.componentMod.MDCTabScroller
import typingsSlinky.atMaterialTabDashScroller.foundationMod.MDCTabScrollerFoundation
