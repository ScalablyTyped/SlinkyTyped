...
import typingsSlinky.maximMazurokGapiClientIap.gapi.client.iap.Brand
...
object Oauthtoken {
  ...
  @scala.inline
  def apply(parent: String, resource: Brand): Oauthtoken = {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: Brand): Self = this.set("resource", value.asInstanceOf[js.Any])
