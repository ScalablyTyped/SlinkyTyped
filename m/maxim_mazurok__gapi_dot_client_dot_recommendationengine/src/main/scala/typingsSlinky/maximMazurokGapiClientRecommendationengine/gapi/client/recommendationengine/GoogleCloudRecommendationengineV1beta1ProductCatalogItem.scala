...
trait GoogleCloudRecommendationengineV1beta1ProductCatalogItem extends StObject {
  ...
  {[ P in string ]: number}
    */ typingsSlinky.maximMazurokGapiClientRecommendationengine.maximMazurokGapiClientRecommendationengineStrings.GoogleCloudRecommendationengineV1beta1ProductCatalogItem with TopLevel[js.Any]
  ] = js.native
