...
trait GoogleLongrunningOperation extends js.Object {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientRecommendationengine.maximMazurokGapiClientRecommendationengineStrings.GoogleLongrunningOperation with TopLevel[js.Any]
  ] = js.native
