...
trait GoogleCloudRecommendationengineV1beta1PredictResponse extends StObject {
  ...
  {[ P in string ]: any}
    */ typingsSlinky.maximMazurokGapiClientRecommendationengine.maximMazurokGapiClientRecommendationengineStrings.GoogleCloudRecommendationengineV1beta1PredictResponse with TopLevel[js.Any]
  ] = js.native
