...
import typingsSlinky.mobxDashTask.libTaskMod.TaskFactory
...
object mobxDashTaskMod extends js.Object {
  ...
  def TaskGroup[A /* <: js.Array[_] */, R](tasks: js.Array[Task[A, R]]): typingsSlinky.mobxDashTask.libTaskDashGroupMod.TaskGroup[A, R] = js.native
}
