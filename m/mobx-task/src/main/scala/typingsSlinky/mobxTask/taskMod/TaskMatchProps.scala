...
object TaskMatchProps {
  @scala.inline
  def apply[T1, T2, T3, /* <: js.Array[_] */ A, R](): TaskMatchProps[T1, T2, T3, A, R] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TaskMatchProps[T1, T2, T3, A, R]]
  }
  @scala.inline
  implicit class TaskMatchPropsOps[Self <: TaskMatchProps[_, _, _, _, _], T1, T2, T3, /* <: js.Array[_] */ A, R] (val x: Self with (TaskMatchProps[T1, T2, T3, A, R])) extends AnyVal {
    @scala.inline
