...
object TaskMethods {
  ...
  @scala.inline
  implicit class TaskMethodsOps[Self <: TaskMethods[_, _], A /* <: js.Array[_] */, R] (val x: Self with (TaskMethods[A, R])) extends AnyVal {
    ...
    @scala.inline
    def setMatch(value: TaskMatchProps[js.Any, js.Any, js.Any, A, R] => js.Any): Self = this.set("match", js.Any.fromFunction1(value))
