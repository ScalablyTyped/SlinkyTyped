...
import typingsSlinky.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Subscription
...
object anon {
  ...
  trait Parent extends StObject {
    ...
    /** Request body */
    var resource: typingsSlinky.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic = js.native
  ...
  object Parent {
    ...
    def apply(
      parent: String,
      resource: typingsSlinky.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic
    ): Parent = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    implicit class ParentMutableBuilder[Self <: Parent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResource(value: typingsSlinky.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
