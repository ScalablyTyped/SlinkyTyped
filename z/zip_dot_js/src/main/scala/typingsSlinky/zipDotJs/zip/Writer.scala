package typingsSlinky.zipDotJs.zip
...
class Writer () extends js.Object {
  ...
  def writeUint8Array(array: scala.scalajs.js.typedarray.Uint8Array, callback: js.Function0[Unit]): Unit = js.native
  def writeUint8Array(
    array: scala.scalajs.js.typedarray.Uint8Array,
