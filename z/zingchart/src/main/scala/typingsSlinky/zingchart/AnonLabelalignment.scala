...
trait AnonLabelalignment extends js.Object {
  ...
  var label: js.UndefOr[AnonTextalpha] = js.native
  /**
...
object AnonLabelalignment {
  @scala.inline
  def apply(): AnonLabelalignment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLabelalignment]
  }
  @scala.inline
  implicit class AnonLabelalignmentOps[Self <: AnonLabelalignment] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: AnonTextalpha): Self = {
        val ret = this.duplicate
