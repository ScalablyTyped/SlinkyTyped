...
trait AnonBorderradiusbottomright extends js.Object {
  ...
  /**
    ...
    */
  var `margin-bottom-offset`: js.UndefOr[js.Any] = js.undefined
  /**
    * Sets the object's top margin. The plotarea object also accepts "dynamic" as value for the margin attribute, in which case it analy
    * zes the scale labels and change the plotarea size accordingly in order to fit all scale labels. "dynamic" | 10 | "5px" | "10 20" |
    *  "5px 10px 15px 20px" | ...
  ...
  /**
    ...
    */
  var `margin-left-offset`: js.UndefOr[js.Any] = js.undefined
  /**
    * Sets the object's top margin. The plotarea object also accepts "dynamic" as value for the margin attribute, in which case it analy
    * zes the scale labels and change the plotarea size accordingly in order to fit all scale labels. "dynamic" | 10 | "5px" | "10 20" |
    *  "5px 10px 15px 20px" | ...
  ...
  /**
    ...
    */
  var `margin-right-offset`: js.UndefOr[js.Any] = js.undefined
  /**
    * Sets the object's top margin. The plotarea object also accepts "dynamic" as value for the margin attribute, in which case it analy
    * zes the scale labels and change the plotarea size accordingly in order to fit all scale labels. "dynamic" | 10 | "5px" | "10 20" |
    *  "5px 10px 15px 20px" | ...
  ...
  /**
    ...
    */
  var `margin-top-offset`: js.UndefOr[js.Any] = js.undefined
  /**
...
object AnonBorderradiusbottomright {
  ...
  def apply(
    ...
    `margin-bottom-offset`: js.Any = null,
    `margin-left`: js.Any = null,
    `margin-left-offset`: js.Any = null,
    `margin-right`: js.Any = null,
    `margin-right-offset`: js.Any = null,
    `margin-top`: js.Any = null,
    `margin-top-offset`: js.Any = null,
    `mask-tolerance`: Int | Double = null,
    ...
    if (`margin-bottom-offset` != null) __obj.updateDynamic("margin-bottom-offset")(`margin-bottom-offset`.asInstanceOf[js.Any])
    if (`margin-left` != null) __obj.updateDynamic("margin-left")(`margin-left`.asInstanceOf[js.Any])
    if (`margin-left-offset` != null) __obj.updateDynamic("margin-left-offset")(`margin-left-offset`.asInstanceOf[js.Any])
    if (`margin-right` != null) __obj.updateDynamic("margin-right")(`margin-right`.asInstanceOf[js.Any])
    if (`margin-right-offset` != null) __obj.updateDynamic("margin-right-offset")(`margin-right-offset`.asInstanceOf[js.Any])
    if (`margin-top` != null) __obj.updateDynamic("margin-top")(`margin-top`.asInstanceOf[js.Any])
    if (`margin-top-offset` != null) __obj.updateDynamic("margin-top-offset")(`margin-top-offset`.asInstanceOf[js.Any])
    if (`mask-tolerance` != null) __obj.updateDynamic("mask-tolerance")(`mask-tolerance`.asInstanceOf[js.Any])
