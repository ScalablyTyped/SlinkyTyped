...
@js.native
trait AnonOffsetR extends js.Object {
  /**
...
object AnonOffsetR {
  @scala.inline
  def apply(): AnonOffsetR = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonOffsetR]
  }
  @scala.inline
  implicit class AnonOffsetROps[Self <: AnonOffsetR] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOffsetR(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offsetR")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOffsetR: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offsetR")(js.undefined)
        ret
    }
    @scala.inline
