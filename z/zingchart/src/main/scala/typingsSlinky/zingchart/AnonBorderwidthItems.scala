...
trait AnonBorderwidthItems extends js.Object {
  /**
  ...
  var items: js.UndefOr[js.Array[AnonBordercolorBorderwidth]] = js.undefined
  /**
...
object AnonBorderwidthItems {
  ...
  def apply(
    ...
    items: js.Array[AnonBordercolorBorderwidth] = null,
    `line-style`: String = null,
    size: Int | Double = null
  ): AnonBorderwidthItems = {
    ...
    __obj.asInstanceOf[AnonBorderwidthItems]
  }
}
