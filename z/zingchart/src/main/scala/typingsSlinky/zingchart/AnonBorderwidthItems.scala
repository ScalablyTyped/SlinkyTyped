...
trait AnonBorderwidthItems extends js.Object {
  ...
  var items: js.UndefOr[js.Array[AnonBordercolorBorderwidth]] = js.native
  /**
...
object AnonBorderwidthItems {
  @scala.inline
  def apply(): AnonBorderwidthItems = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBorderwidthItems]
  }
  @scala.inline
  implicit class AnonBorderwidthItemsOps[Self <: AnonBorderwidthItems] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[AnonBordercolorBorderwidth]): Self = {
        val ret = this.duplicate
