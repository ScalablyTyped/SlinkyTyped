...
trait AnonAlpha extends js.Object {
  ...
  var from: js.UndefOr[AnonHook] = js.native
  /**
  ...
  var to: js.UndefOr[AnonHook] = js.native
  /**
...
object AnonAlpha {
  ...
  implicit class AnonAlphaOps[Self <: AnonAlpha] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAspect(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFrom(value: AnonHook): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTo(value: AnonHook): Self = {
        val ret = this.duplicate
