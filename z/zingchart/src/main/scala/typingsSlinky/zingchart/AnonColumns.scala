...
object AnonColumns {
  ...
  def apply(
    ...
    if (!js.isUndefined(`horizontal-labels`)) __obj.updateDynamic("horizontal-labels")(`horizontal-labels`.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`separate-scales`)) __obj.updateDynamic("separate-scales")(`separate-scales`.asInstanceOf[js.Any])
    if (separator != null) __obj.updateDynamic("separator")(separator.asInstanceOf[js.Any])
    if (!js.isUndefined(`smart-scales`)) __obj.updateDynamic("smart-scales")(`smart-scales`.asInstanceOf[js.Any])
    if (!js.isUndefined(title)) __obj.updateDynamic("title")(title.asInstanceOf[js.Any])
    if (url != null) __obj.updateDynamic("url")(url.asInstanceOf[js.Any])
    if (!js.isUndefined(`vertical-labels`)) __obj.updateDynamic("vertical-labels")(`vertical-labels`.asInstanceOf[js.Any])
