...
trait series extends js.Object {
  ...
  /**
    ...
    */
  var `data-dragging`: js.UndefOr[Boolean] = js.native
  ...
  /**
    ...
    */
  var `preview-state`: js.UndefOr[js.Any] = js.native
...
object series {
  ...
  implicit class seriesOps[Self <: series] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Delay): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setData-dragging`(value: Boolean): Self = this.set("data-dragging", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deleteData-dragging`: Self = this.set("data-dragging", js.undefined)
    ...
    @scala.inline
    def setGoal(value: BordercolorBorderradius): Self = this.set("goal", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setHighlight-marker`(value: Borderwidth): Self = this.set("highlight-marker", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setPreview-state`(value: js.Any): Self = this.set("preview-state", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deletePreview-state`: Self = this.set("preview-state", js.undefined)
    ...
    @scala.inline
    def setTooltip(value: Calloutposition): Self = this.set("tooltip", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setTrend-down`(value: AlphaBackgroundcolor): Self = this.set("trend-down", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deleteTrend-down`: Self = this.set("trend-down", js.undefined)
    
    @scala.inline
    def `setTrend-equal`(value: AlphaBackgroundcolor): Self = this.set("trend-equal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deleteTrend-equal`: Self = this.set("trend-equal", js.undefined)
    
    @scala.inline
    def `setTrend-up`(value: AlphaBackgroundcolor): Self = this.set("trend-up", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deleteTrend-up`: Self = this.set("trend-up", js.undefined)
    ...
    @scala.inline
    def `setValue-box`(value: Rtlrighttoleft): Self = this.set("value-box", value.asInstanceOf[js.Any])
