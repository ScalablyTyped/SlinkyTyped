...
object series {
  ...
  def apply(
    ...
    if (`trend-down` != null) __obj.updateDynamic("trend-down")(`trend-down`.asInstanceOf[js.Any])
    if (`trend-equal` != null) __obj.updateDynamic("trend-equal")(`trend-equal`.asInstanceOf[js.Any])
    if (`trend-up` != null) __obj.updateDynamic("trend-up")(`trend-up`.asInstanceOf[js.Any])
