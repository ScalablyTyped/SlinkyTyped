...
trait AnonPreservezoom extends js.Object {
  ...
  var label: js.UndefOr[AnonBorderwidthFontcolor] = js.native
  /**
...
object AnonPreservezoom {
  @scala.inline
  def apply(): AnonPreservezoom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonPreservezoom]
  }
  @scala.inline
  implicit class AnonPreservezoomOps[Self <: AnonPreservezoom] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLabel(value: AnonBorderwidthFontcolor): Self = {
        val ret = this.duplicate
