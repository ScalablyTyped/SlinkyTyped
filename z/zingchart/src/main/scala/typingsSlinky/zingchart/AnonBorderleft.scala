...
object AnonBorderleft {
  @scala.inline
  def apply(): AnonBorderleft = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBorderleft]
  }
  @scala.inline
  implicit class AnonBorderleftOps[Self <: AnonBorderleft] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withShow-marker`(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show-marker")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutShow-marker`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show-marker")(js.undefined)
        ret
    }
    @scala.inline
