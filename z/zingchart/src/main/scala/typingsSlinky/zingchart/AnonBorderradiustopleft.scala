...
object AnonBorderradiustopleft {
  @scala.inline
  def apply(): AnonBorderradiustopleft = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBorderradiustopleft]
  }
  @scala.inline
  implicit class AnonBorderradiustopleftOps[Self <: AnonBorderradiustopleft] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withLock-rotation`(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lock-rotation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutLock-rotation`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lock-rotation")(js.undefined)
        ret
    }
    @scala.inline
