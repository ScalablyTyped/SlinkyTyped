...
@js.native
trait AnonBackgroundposition extends js.Object {
  /**
...
object AnonBackgroundposition {
  @scala.inline
  def apply(): AnonBackgroundposition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBackgroundposition]
  }
  @scala.inline
  implicit class AnonBackgroundpositionOps[Self <: AnonBackgroundposition] (val x: Self) extends AnyVal {
    @scala.inline
