...
object Hoverstate {
  ...
  implicit class HoverstateMutableBuilder[Self <: Hoverstate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setHover-state`(value: Linestyle): Self = StObject.set(x, "hover-state", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTooltip(value: Fontangle): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
