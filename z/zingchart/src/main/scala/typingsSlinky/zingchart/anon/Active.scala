...
trait Active extends js.Object {
  var active: js.UndefOr[AlphaNumber] = js.native
  /**
  ...
  var mask: js.UndefOr[AlphaNumber] = js.native
  /**
...
object Active {
  ...
  implicit class ActiveOps[Self <: Active] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActive(value: AlphaNumber): Self = {
    ...
    @scala.inline
    def withHandle(value: Borderright): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMask(value: AlphaNumber): Self = {
        val ret = this.duplicate
