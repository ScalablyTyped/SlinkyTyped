...
object Decimalsseparator {
  ...
  implicit class DecimalsseparatorOps[Self <: Decimalsseparator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGuide(value: Linesegmentsize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItem(value: Borderradiustopleft): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLabel(value: Borderradiustopleft): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMarkers(value: js.Array[Labelalignment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withMinor-guide`(value: LinecolorLinegapsize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withMinor-tick`(value: LinegapsizeLinesegmentsize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withRef-line`(value: LinecolorLinegapsize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTick(value: Shadowalpha): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTransform(value: Uniform): Self = {
        val ret = this.duplicate
