...
@js.native
trait Calloutposition extends StObject {
...
object Calloutposition {
  
  @scala.inline
  def apply(): Calloutposition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Calloutposition]
  }
  
  @scala.inline
  implicit class CalloutpositionMutableBuilder[Self <: Calloutposition] (val x: Self) extends AnyVal {
