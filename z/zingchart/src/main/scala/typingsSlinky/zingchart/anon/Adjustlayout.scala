...
object Adjustlayout {
  ...
  def apply(
    ...
    footer: Backgroundposition = null,
    `gradient-colors`: String = null,
    `gradient-stops`: String = null,
    header: Backgroundrepeat = null,
    height: js.Any = null,
    `highlight-plot`: js.UndefOr[Boolean] = js.undefined,
    icon: Linecolor = null,
    item: Borderleft = null,
    `item-off`: Borderbottom = null,
    layout: String = null,
    margin: js.Any = null,
    ...
    `page-off`: Filloffsetx = null,
    `page-on`: Filloffsetx = null,
    `page-status`: Bold = null,
    ...
    if (!js.isUndefined(`highlight-plot`)) __obj.updateDynamic("highlight-plot")(`highlight-plot`.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`reverse-series`)) __obj.updateDynamic("reverse-series")(`reverse-series`.get.asInstanceOf[js.Any])
