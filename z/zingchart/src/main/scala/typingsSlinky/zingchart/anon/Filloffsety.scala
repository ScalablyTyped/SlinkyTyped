...
@js.native
trait Filloffsety extends StObject {
...
object Filloffsety {
  ...
  @scala.inline
  def apply(): Filloffsety = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Filloffsety]
  }
  
  @scala.inline
  implicit class FilloffsetyMutableBuilder[Self <: Filloffsety] (val x: Self) extends AnyVal {
