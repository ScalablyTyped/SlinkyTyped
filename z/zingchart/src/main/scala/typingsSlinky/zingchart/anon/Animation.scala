...
object Animation {
  ...
  implicit class AnimationOps[Self <: Animation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnimation(value: `1`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGoal(value: Height): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withHighlight-marker`(value: Linewidth): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTrend(value: AlphaBackgroundcolor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withValue-box`(value: Callout): Self = {
        val ret = this.duplicate
