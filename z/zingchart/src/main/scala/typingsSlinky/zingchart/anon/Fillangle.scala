...
trait Fillangle extends js.Object {
  ...
  var `highlight-state`: js.UndefOr[Borderwidth] = js.undefined
  /**
...
object Fillangle {
  ...
  def apply(
    ...
    `highlight-state`: Borderwidth = null,
    ...
    if (!js.isUndefined(`show-line`)) __obj.updateDynamic("show-line")(`show-line`.get.asInstanceOf[js.Any])
