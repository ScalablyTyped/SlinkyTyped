...
@js.native
trait Fillangle extends StObject {
...
object Fillangle {
  ...
  @scala.inline
  implicit class FillangleMutableBuilder[Self <: Fillangle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setHighlight-state`(value: Borderwidth): Self = StObject.set(x, "highlight-state", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setShow-line`(value: Boolean): Self = StObject.set(x, "show-line", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setShow-lineUndefined`: Self = StObject.set(x, "show-line", js.undefined)
