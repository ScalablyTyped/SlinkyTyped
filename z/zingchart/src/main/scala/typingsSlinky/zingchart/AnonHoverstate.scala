...
trait AnonHoverstate extends js.Object {
  ...
  var `hover-state`: js.UndefOr[AnonLinestyle] = js.native
  /**
  ...
  var tooltip: js.UndefOr[AnonFontangle] = js.native
}

object AnonHoverstate {
  @scala.inline
  def apply(): AnonHoverstate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonHoverstate]
  }
  @scala.inline
  implicit class AnonHoverstateOps[Self <: AnonHoverstate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withHover-state`(value: AnonLinestyle): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTooltip(value: AnonFontangle): Self = {
        val ret = this.duplicate
