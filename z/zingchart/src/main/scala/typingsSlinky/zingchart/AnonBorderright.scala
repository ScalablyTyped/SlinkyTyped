...
@js.native
trait AnonBorderright extends js.Object {
  /**
...
object AnonBorderright {
  @scala.inline
  def apply(): AnonBorderright = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBorderright]
  }
  @scala.inline
  implicit class AnonBorderrightOps[Self <: AnonBorderright] (val x: Self) extends AnyVal {
    @scala.inline
