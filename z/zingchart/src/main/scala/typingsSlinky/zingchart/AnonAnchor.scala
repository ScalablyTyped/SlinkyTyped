...
trait AnonAnchor extends js.Object {
  ...
  var `callout-tip`: js.UndefOr[AnonBordercolor] = js.native
  /**
...
object AnonAnchor {
  ...
  implicit class AnonAnchorOps[Self <: AnonAnchor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `withCallout-tip`(value: AnonBordercolor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("callout-tip")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutCallout-tip`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("callout-tip")(js.undefined)
        ret
    }
    @scala.inline
