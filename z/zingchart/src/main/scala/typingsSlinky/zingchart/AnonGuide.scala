...
trait AnonGuide extends js.Object {
  ...
  var guide: js.UndefOr[AnonBackgroundcolorItems] = js.native
  ...
  var `ref-line`: js.UndefOr[AnonLinestyleLinewidth] = js.native
...
object AnonGuide {
  ...
  @scala.inline
  implicit class AnonGuideOps[Self <: AnonGuide] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGuide(value: AnonBackgroundcolorItems): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withRef-line`(value: AnonLinestyleLinewidth): Self = {
        val ret = this.duplicate
