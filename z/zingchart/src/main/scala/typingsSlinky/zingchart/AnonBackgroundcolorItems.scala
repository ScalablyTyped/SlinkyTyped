...
@js.native
trait AnonBackgroundcolorItems extends js.Object {
  /**
  ...
  var items: js.UndefOr[js.Array[AnonAlphaNumber]] = js.native
  /**
...
object AnonBackgroundcolorItems {
  @scala.inline
  def apply(): AnonBackgroundcolorItems = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBackgroundcolorItems]
  }
  @scala.inline
  implicit class AnonBackgroundcolorItemsOps[Self <: AnonBackgroundcolorItems] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItems(value: js.Array[AnonAlphaNumber]): Self = {
        val ret = this.duplicate
