...
@js.native
trait AnonGradientstops extends js.Object {
  /**
...
object AnonGradientstops {
  @scala.inline
  def apply(): AnonGradientstops = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonGradientstops]
  }
  @scala.inline
  implicit class AnonGradientstopsOps[Self <: AnonGradientstops] (val x: Self) extends AnyVal {
    @scala.inline
