...
object AnonAngle {
  ...
  implicit class AnonAngleOps[Self <: AnonAngle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTrue3d(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("true3d")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTrue3d: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("true3d")(js.undefined)
        ret
    }
    @scala.inline
    def `withX-angle`(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("x-angle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutX-angle`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("x-angle")(js.undefined)
        ret
    }
    @scala.inline
    def `withY-angle`(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("y-angle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutY-angle`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("y-angle")(js.undefined)
        ret
    }
    @scala.inline
    def `withZ-angle`(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("z-angle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutZ-angle`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("z-angle")(js.undefined)
        ret
    }
    @scala.inline
