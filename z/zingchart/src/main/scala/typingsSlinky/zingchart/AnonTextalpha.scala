...
@js.native
trait AnonTextalpha extends js.Object {
  /**
...
object AnonTextalpha {
  @scala.inline
  def apply(): AnonTextalpha = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonTextalpha]
  }
  @scala.inline
  implicit class AnonTextalphaOps[Self <: AnonTextalpha] (val x: Self) extends AnyVal {
    @scala.inline
