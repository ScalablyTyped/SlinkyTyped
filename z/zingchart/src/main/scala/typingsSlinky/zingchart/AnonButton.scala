...
trait AnonButton extends js.Object {
  var button: js.UndefOr[AnonClose] = js.native
  var items: js.UndefOr[js.Array[AnonFontcolor]] = js.native
  /**
...
object AnonButton {
  ...
  implicit class AnonButtonOps[Self <: AnonButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withButton(value: AnonClose): Self = {
    ...
    @scala.inline
    def withItems(value: js.Array[AnonFontcolor]): Self = {
        val ret = this.duplicate
