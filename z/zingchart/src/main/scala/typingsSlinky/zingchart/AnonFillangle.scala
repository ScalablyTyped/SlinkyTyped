...
trait AnonFillangle extends js.Object {
  ...
  var `highlight-state`: js.UndefOr[AnonBorderwidth] = js.native
  /**
...
object AnonFillangle {
  @scala.inline
  def apply(): AnonFillangle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFillangle]
  }
  @scala.inline
  implicit class AnonFillangleOps[Self <: AnonFillangle] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withHighlight-state`(value: AnonBorderwidth): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withShow-line`(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show-line")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `withoutShow-line`: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("show-line")(js.undefined)
        ret
    }
    @scala.inline
