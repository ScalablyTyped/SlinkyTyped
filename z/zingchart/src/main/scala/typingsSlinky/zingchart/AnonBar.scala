...
trait AnonBar extends js.Object {
  var bar: js.UndefOr[AnonBorderradius] = js.native
  var handle: js.UndefOr[AnonBorderradius] = js.native
}
...
object AnonBar {
  ...
  @scala.inline
  implicit class AnonBarOps[Self <: AnonBar] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBar(value: AnonBorderradius): Self = {
    ...
    @scala.inline
    def withHandle(value: AnonBorderradius): Self = {
        val ret = this.duplicate
