...
@js.native
trait AnonLinegapsizeLinesegmentsize extends js.Object {
  /**
...
object AnonLinegapsizeLinesegmentsize {
  @scala.inline
  def apply(): AnonLinegapsizeLinesegmentsize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonLinegapsizeLinesegmentsize]
  }
  @scala.inline
  implicit class AnonLinegapsizeLinesegmentsizeOps[Self <: AnonLinegapsizeLinesegmentsize] (val x: Self) extends AnyVal {
    @scala.inline
