...
@js.native
trait AnonCalloutheight extends js.Object {
  /**
...
object AnonCalloutheight {
  @scala.inline
  def apply(): AnonCalloutheight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCalloutheight]
  }
  @scala.inline
  implicit class AnonCalloutheightOps[Self <: AnonCalloutheight] (val x: Self) extends AnyVal {
    @scala.inline
