...
trait AnonCallout extends js.Object {
  ...
  var connector: js.UndefOr[AnonAlphaLinecolor] = js.native
  /**
  ...
  var joined: js.UndefOr[AnonPadding] = js.native
  /**
  ...
  var shared: js.UndefOr[AnonPadding] = js.native
  /**
...
object AnonCallout {
  @scala.inline
  def apply(): AnonCallout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCallout]
  }
  @scala.inline
  implicit class AnonCalloutOps[Self <: AnonCallout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withConnector(value: AnonAlphaLinecolor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withJoined(value: AnonPadding): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShared(value: AnonPadding): Self = {
        val ret = this.duplicate
