...
trait AnonExact extends js.Object {
  ...
  var marker: js.UndefOr[AnonBackgroundcolor] = js.native
  var `plot-label`: js.UndefOr[AnonBackgroundcolor1] = js.native
  /**
  ...
  var `scale-label`: js.UndefOr[AnonBackgroundcolor2] = js.native
  /**
...
object AnonExact {
  ...
  implicit class AnonExactOps[Self <: AnonExact] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMarker(value: AnonBackgroundcolor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withPlot-label`(value: AnonBackgroundcolor1): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withScale-label`(value: AnonBackgroundcolor2): Self = {
        val ret = this.duplicate
