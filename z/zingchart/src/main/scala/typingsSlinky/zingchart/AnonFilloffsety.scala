...
@js.native
trait AnonFilloffsety extends js.Object {
  /**
...
object AnonFilloffsety {
  @scala.inline
  def apply(): AnonFilloffsety = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFilloffsety]
  }
  @scala.inline
  implicit class AnonFilloffsetyOps[Self <: AnonFilloffsety] (val x: Self) extends AnyVal {
    @scala.inline
