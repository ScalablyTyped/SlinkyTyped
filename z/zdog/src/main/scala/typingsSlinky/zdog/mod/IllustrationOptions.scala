...
object IllustrationOptions {
  ...
  implicit class IllustrationOptionsMutableBuilder[Self <: IllustrationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElementHTMLCanvasElement(value: HTMLCanvasElement): Self = StObject.set(x, "element", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setElementSVGSVGElement(value: SVGSVGElement): Self = StObject.set(x, "element", value.asInstanceOf[js.Any])
