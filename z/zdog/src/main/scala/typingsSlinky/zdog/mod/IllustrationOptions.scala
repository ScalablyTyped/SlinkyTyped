...
object IllustrationOptions {
  ...
  implicit class IllustrationOptionsOps[Self <: IllustrationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElementSVGSVGElement(value: SVGSVGElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
    def setElementHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("element", value.asInstanceOf[js.Any])
    @scala.inline
