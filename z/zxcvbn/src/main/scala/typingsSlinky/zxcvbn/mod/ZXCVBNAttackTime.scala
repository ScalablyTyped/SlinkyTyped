...
object ZXCVBNAttackTime {
  ...
  implicit class ZXCVBNAttackTimeOps[Self <: ZXCVBNAttackTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOffline_fast_hashing_1e10_per_second(value: String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offline_fast_hashing_1e10_per_second")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOffline_slow_hashing_1e4_per_second(value: String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offline_slow_hashing_1e4_per_second")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnline_no_throttling_10_per_second(value: String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("online_no_throttling_10_per_second")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnline_throttling_100_per_hour(value: String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("online_throttling_100_per_hour")(value.asInstanceOf[js.Any])
        ret
    }
  }
