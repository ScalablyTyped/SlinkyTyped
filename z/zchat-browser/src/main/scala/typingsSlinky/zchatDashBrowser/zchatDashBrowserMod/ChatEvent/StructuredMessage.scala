...
import typingsSlinky.zchatDashBrowser.zchatDashBrowserStrings.LIST_TEMPLATE
...
import typingsSlinky.zchatDashBrowser.zchatDashBrowserStrings.QUICK_REPLIES
