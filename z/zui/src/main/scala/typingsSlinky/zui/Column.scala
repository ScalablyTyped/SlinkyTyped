...
object Column {
  ...
  implicit class ColumnOps[Self <: Column] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColClass(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("colClass")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutColClass: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("colClass")(js.undefined)
        ret
    }
    @scala.inline
