...
object DatetimepickerOptions {
  ...
  implicit class DatetimepickerOptionsOps[Self <: DatetimepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultDate(value: js.Date | String | js.Any): Self = this.set("defaultDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisabledDatesVarargs(value: (js.Date | String | js.Object)*): Self = this.set("disabledDates", js.Array(value :_*))
    @scala.inline
    def setDisabledDates(value: js.Array[js.Date | String | js.Object]): Self = this.set("disabledDates", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisabledDates: Self = this.set("disabledDates", js.undefined)
    @scala.inline
    def setEnabledDatesVarargs(value: (js.Date | String | js.Object)*): Self = this.set("enabledDates", js.Array(value :_*))
    @scala.inline
    def setEnabledDates(value: js.Array[js.Date | String | js.Object]): Self = this.set("enabledDates", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | js.Any): Self = this.set("maxDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMinDate(value: js.Date | String | js.Any): Self = this.set("minDate", value.asInstanceOf[js.Any])
    @scala.inline
