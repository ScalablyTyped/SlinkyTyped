...
object DatetimepickerOptions {
  ...
  implicit class DatetimepickerOptionsMutableBuilder[Self <: DatetimepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultDate(value: js.Date | String | js.Any): Self = StObject.set(x, "defaultDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDisabledDates(value: js.Array[js.Date | String | js.Object]): Self = StObject.set(x, "disabledDates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisabledDatesUndefined: Self = StObject.set(x, "disabledDates", js.undefined)
    
    @scala.inline
    def setDisabledDatesVarargs(value: (js.Date | String | js.Object)*): Self = StObject.set(x, "disabledDates", js.Array(value :_*))
    
    @scala.inline
    def setEnabledDates(value: js.Array[js.Date | String | js.Object]): Self = StObject.set(x, "enabledDates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnabledDatesUndefined: Self = StObject.set(x, "enabledDates", js.undefined)
    
    @scala.inline
    def setEnabledDatesVarargs(value: (js.Date | String | js.Object)*): Self = StObject.set(x, "enabledDates", js.Array(value :_*))
    ...
    @scala.inline
    def setMaxDate(value: js.Date | String | js.Any): Self = StObject.set(x, "maxDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinDate(value: js.Date | String | js.Any): Self = StObject.set(x, "minDate", value.asInstanceOf[js.Any])
