...
object UploaderOption {
  ...
  def apply(
    ...
    if (!js.isUndefined(browseByClickList)) __obj.updateDynamic("browseByClickList")(browseByClickList.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(deleteActionOnDone)) __obj.updateDynamic("deleteActionOnDone")(deleteActionOnDone.get.asInstanceOf[js.Any])
    if (deleteConfirm != null) __obj.updateDynamic("deleteConfirm")(deleteConfirm.asInstanceOf[js.Any])
    if (!js.isUndefined(dropPlaceholder)) __obj.updateDynamic("dropPlaceholder")(dropPlaceholder.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(previewImageIcon)) __obj.updateDynamic("previewImageIcon")(previewImageIcon.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(removeUploaded)) __obj.updateDynamic("removeUploaded")(removeUploaded.get.asInstanceOf[js.Any])
    if (!js.isUndefined(rename)) __obj.updateDynamic("rename")(rename.get.asInstanceOf[js.Any])
    if (!js.isUndefined(renameActionOnDone)) __obj.updateDynamic("renameActionOnDone")(renameActionOnDone.get.asInstanceOf[js.Any])
    if (!js.isUndefined(renameByClick)) __obj.updateDynamic("renameByClick")(renameByClick.get.asInstanceOf[js.Any])
    if (!js.isUndefined(renameExtension)) __obj.updateDynamic("renameExtension")(renameExtension.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sendFileId)) __obj.updateDynamic("sendFileId")(sendFileId.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sendFileName)) __obj.updateDynamic("sendFileName")(sendFileName.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(uploadedMessage)) __obj.updateDynamic("uploadedMessage")(uploadedMessage.get.asInstanceOf[js.Any])
