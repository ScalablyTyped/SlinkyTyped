package typingsSlinky.zenDashObservableDashTs.libZenObservableMod

import org.scalablytyped.runtime.Instantiable1
import typingsSlinky.std.ArrayLike
import typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.Subscription
...
trait Observable[T] extends js.Object {
  ...
  def flatMap[R](
    fn: js.Function1[
      /* value */ T, 
      typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.ObservableLike[R]
    ]
  ...
  def from[R](observable: typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.ObservableLike[R]): Observable[R] = js.native
  ...
  def subscribe(observerOrNext: typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.Observer[T]): Subscription = js.native
  def subscribe(
    observerOrNext: typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.Observer[T],
    error: js.Function1[/* error */ js.Any, Unit]
  ): Subscription = js.native
  def subscribe(
    observerOrNext: typingsSlinky.zenDashObservableDashTs.libTypesMod.ZenObservable.Observer[T],
