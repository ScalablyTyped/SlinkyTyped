package typingsSlinky.zipkinDashTransportDashHttp.zipkinDashTransportDashHttpMod

import typingsSlinky.zipkin.zipkinMod.Logger
import typingsSlinky.zipkin.zipkinMod.model.Span
import typingsSlinky.zipkinDashTransportDashHttp.Anon_Agent
...
class HttpLogger protected () extends Logger {
  /**
    ...
    */
  def this(options: Anon_Agent) = this()
  /* CompleteClass */
