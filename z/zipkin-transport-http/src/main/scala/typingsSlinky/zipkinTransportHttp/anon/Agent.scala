package typingsSlinky.zipkinTransportHttp.anon
...
trait Agent extends js.Object {
  var agent: js.UndefOr[
    typingsSlinky.zipkinTransportHttp.mod.Agent | (js.Function1[/* url */ URL_, typingsSlinky.zipkinTransportHttp.mod.Agent])
  ] = js.native
...
object Agent {
  ...
  implicit class AgentOps[Self <: Agent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAgentFunction1(value: /* url */ URL_ => typingsSlinky.zipkinTransportHttp.mod.Agent): Self = this.set("agent", js.Any.fromFunction1(value))
    @scala.inline
    def setAgent(
      value: typingsSlinky.zipkinTransportHttp.mod.Agent | (js.Function1[/* url */ URL_, typingsSlinky.zipkinTransportHttp.mod.Agent])
