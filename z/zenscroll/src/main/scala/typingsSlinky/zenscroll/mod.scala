...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = js.native
  ...
  object ZenScroll {
    ...
    trait zenscroll extends StObject {
      ...
      def createScroller(scrollContainer: HTMLElement): typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: js.UndefOr[scala.Nothing], edgeOffset: Double): typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: Double): typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: Double, edgeOffset: Double): typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = js.native
  ...
  type _To = typingsSlinky.zenscroll.mod.ZenScroll.zenscroll
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.zenscroll.mod.ZenScroll.zenscroll = ^
}
