...
object anon {
  ...
  object Error {
    ...
    implicit class ErrorMutableBuilder[Self <: Error] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpiredAuthError(value: Instantiable0[js.Error]): Self = StObject.set(x, "ExpiredAuthError", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHaltedError(value: Instantiable0[js.Error]): Self = StObject.set(x, "HaltedError", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefreshAuthError(value: Instantiable0[js.Error]): Self = StObject.set(x, "RefreshAuthError", value.asInstanceOf[js.Any])
    }
  }
