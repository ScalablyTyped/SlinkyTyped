...
object TextGroupOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.zfont.mod.zdogAugmentingMod.MultilineText */ T](font: Font): TextGroupOptions[T] = {
    val __obj = js.Dynamic.literal(font = font.asInstanceOf[js.Any])
    __obj.asInstanceOf[TextGroupOptions[T]]
  }
  @scala.inline
  implicit class TextGroupOptionsOps[Self <: TextGroupOptions[_], /* <: typingsSlinky.zfont.mod.zdogAugmentingMod.MultilineText */ T] (val x: Self with TextGroupOptions[T]) extends AnyVal {
    @scala.inline
