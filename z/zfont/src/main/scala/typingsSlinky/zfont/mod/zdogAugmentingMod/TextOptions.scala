...
object TextOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.zfont.mod.zdogAugmentingMod.MultilineText */ T](font: Font): TextOptions[T] = {
    val __obj = js.Dynamic.literal(font = font.asInstanceOf[js.Any])
    __obj.asInstanceOf[TextOptions[T]]
  }
  @scala.inline
  implicit class TextOptionsOps[Self <: TextOptions[_], /* <: typingsSlinky.zfont.mod.zdogAugmentingMod.MultilineText */ T] (val x: Self with TextOptions[T]) extends AnyVal {
    @scala.inline
