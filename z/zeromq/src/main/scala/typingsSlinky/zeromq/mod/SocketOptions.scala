...
object SocketOptions {
  ...
  implicit class SocketOptionsOps[Self <: SocketOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurve_publickey(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("curve_publickey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCurve_secretkey(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("curve_secretkey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCurve_server(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("curve_server")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCurve_serverkey(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("curve_serverkey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPlain_password(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("plain_password")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPlain_server(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("plain_server")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPlain_username(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("plain_username")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withZap_domain(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("zap_domain")(value.asInstanceOf[js.Any])
        ret
    }
  }
