...
import typingsSlinky.zumly.anon.Render
...
object mod {
  ...
  @js.native
  class ^ protected ()
    extends typingsSlinky.zumly.mod.zumly {
    /**
  ...
  object zumly {
    ...
    def apply(
      ...
      __obj.asInstanceOf[typingsSlinky.zumly.mod.zumly]
    }
    
    @scala.inline
    implicit class zumlyMutableBuilder[Self <: typingsSlinky.zumly.mod.zumly] (val x: Self) extends AnyVal {
