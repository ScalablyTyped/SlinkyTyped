...
import typingsSlinky.zipkin.mod.model.Span
...
object Logger {
  ...
  implicit class LoggerOps[Self <: Logger] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLogSpan(value: Span => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("logSpan")(js.Any.fromFunction1(value))
        ret
    }
  }
