...
object XB3Flags {
  ...
  implicit class XB3FlagsOps[Self <: XB3Flags] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setX-B3-Flags`(value: `1` | typingsSlinky.zipkin.zipkinStrings.`0`): Self = this.set("X-B3-Flags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setX-B3-Sampled`(value: `1` | typingsSlinky.zipkin.zipkinStrings.`0`): Self = this.set("X-B3-Sampled", value.asInstanceOf[js.Any])
