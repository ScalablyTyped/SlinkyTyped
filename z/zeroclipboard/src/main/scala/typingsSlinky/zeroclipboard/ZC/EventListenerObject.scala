...
object EventListenerObject {
  @scala.inline
  def apply[/* <: typingsSlinky.zeroclipboard.ZC.ZeroClipboardEvent */ T](handleEvent: T => Unit): EventListenerObject[T] = {
    val __obj = js.Dynamic.literal(handleEvent = js.Any.fromFunction1(handleEvent))
    __obj.asInstanceOf[EventListenerObject[T]]
  }
  @scala.inline
  implicit class EventListenerObjectOps[Self <: EventListenerObject[_], /* <: typingsSlinky.zeroclipboard.ZC.ZeroClipboardEvent */ T] (val x: Self with EventListenerObject[T]) extends AnyVal {
    @scala.inline
