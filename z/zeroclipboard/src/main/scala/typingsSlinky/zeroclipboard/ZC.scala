...
import typingsSlinky.zeroclipboard.zeroclipboardStrings.destroy
import typingsSlinky.zeroclipboard.zeroclipboardStrings.error
...
import typingsSlinky.zeroclipboard.zeroclipboardStrings.ready
