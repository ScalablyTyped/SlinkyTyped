...
object mod {
  ...
  */
  ...
  object _XmlDesc {
    ...
    @scala.inline
    def Attr(_attr: XmlAttrs): typingsSlinky.xml.anon.Attr = {
      val __obj = js.Dynamic.literal(_attr = _attr.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.xml.anon.Attr]
    }
    
    @scala.inline
    def AttrCdata(_attr: XmlAttrs, _cdata: String): typingsSlinky.xml.anon.AttrCdata = {
      val __obj = js.Dynamic.literal(_attr = _attr.asInstanceOf[js.Any], _cdata = _cdata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.xml.anon.AttrCdata]
    }
    
    @scala.inline
    def Cdata(_cdata: String): typingsSlinky.xml.anon.Cdata = {
      val __obj = js.Dynamic.literal(_cdata = _cdata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.xml.anon.Cdata]
    }
    
    @scala.inline
    def XmlDescArray(): typingsSlinky.xml.mod.XmlDescArray = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.xml.mod.XmlDescArray]
    }
  }
}
