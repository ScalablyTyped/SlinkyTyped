...
object ArchiveType extends StObject {
  ...
  /* 2 */ val baFO3: typingsSlinky.xelib.mod.ArchiveType.baFO3 with Double = js.native
  ...
  /* 4 */ val baFO4: typingsSlinky.xelib.mod.ArchiveType.baFO4 with Double = js.native
  ...
  /* 5 */ val baFO4dds: typingsSlinky.xelib.mod.ArchiveType.baFO4dds with Double = js.native
  ...
  /* 0 */ val baNone: typingsSlinky.xelib.mod.ArchiveType.baNone with Double = js.native
  ...
  /* 3 */ val baSSE: typingsSlinky.xelib.mod.ArchiveType.baSSE with Double = js.native
  ...
  /* 1 */ val baTES3: typingsSlinky.xelib.mod.ArchiveType.baTES3 with Double = js.native
}
