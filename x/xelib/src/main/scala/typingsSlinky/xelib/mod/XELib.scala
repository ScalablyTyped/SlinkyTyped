...
trait XELib extends StObject {
  ...
  /**
    ...
    */
  def DefType(id: ElementHandle): typingsSlinky.xelib.mod.DefType = js.native
  ...
  /**
    ...
    */
  def ElementType(id: ElementHandle): typingsSlinky.xelib.mod.ElementType = js.native
  ...
  {[ K in keyof P ]: xelib.xelib.Zeroable<xelib.xelib.ElementHandle>}
    */ typingsSlinky.xelib.xelibStrings.XELib with TopLevel[js.Any] = js.native
  ...
  /**
    ...
    */
  def SmashType(id: ElementHandle): typingsSlinky.xelib.mod.SmashType = js.native
  ...
  /**
    ...
    */
  def ValueType(id: ElementHandle): typingsSlinky.xelib.mod.ValueType = js.native
