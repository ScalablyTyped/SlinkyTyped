...
object LoaderState extends StObject {
  ...
  /* 1 */ val IsActive: typingsSlinky.xelib.mod.LoaderState.IsActive with Double = js.native
  ...
  /* 2 */ val IsDone: typingsSlinky.xelib.mod.LoaderState.IsDone with Double = js.native
  ...
  /* 3 */ val IsError: typingsSlinky.xelib.mod.LoaderState.IsError with Double = js.native
  ...
  /* 0 */ val IsInactive: typingsSlinky.xelib.mod.LoaderState.IsInactive with Double = js.native
}
