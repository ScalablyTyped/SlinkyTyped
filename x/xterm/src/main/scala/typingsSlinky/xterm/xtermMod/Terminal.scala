...
import typingsSlinky.xterm.Anon_Cols
import typingsSlinky.xterm.Anon_DomEvent
import typingsSlinky.xterm.Anon_End
...
import typingsSlinky.xterm.xtermStrings.colors
...
import typingsSlinky.xterm.xtermStrings.handler
...
import typingsSlinky.xterm.xtermStrings.screenKeys
...
import typingsSlinky.xterm.xtermStrings.useFlowControl
...
class Terminal () extends IDisposable {
  ...
  /**
    ...
    */
  @JSName("onKey")
  var onKey_Original: IEvent[Anon_DomEvent] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("onRender")
  var onRender_Original: IEvent[Anon_End] = js.native
  /**
  ...
  /**
    ...
    * @returns an `IDisposable` to stop listening.
    */
  def onKey(listener: js.Function1[/* e */ Anon_DomEvent, _]): IDisposable = js.native
  /**
    * Adds an event listener for when a line feed is added.
    * @returns an `IDisposable` to stop listening.
    */
  ...
  /**
    ...
    * @returns an `IDisposable` to stop listening.
    */
  def onRender(listener: js.Function1[/* e */ Anon_End, _]): IDisposable = js.native
  /**
    * Adds an event listener for when the terminal is resized. The event value
    * contains the new size.
    * @returns an `IDisposable` to stop listening.
