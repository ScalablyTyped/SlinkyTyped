...
import typingsSlinky.xmlDashJs.xmlDashJsStrings.`utf-8`
import typingsSlinky.xmlDashJs.xmlDashJsStrings.no
import typingsSlinky.xmlDashJs.xmlDashJsStrings.yes
