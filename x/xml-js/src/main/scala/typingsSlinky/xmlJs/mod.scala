...
import typingsSlinky.xmlJs.anon.`0`
import typingsSlinky.xmlJs.mod.Options.JS2XML
import typingsSlinky.xmlJs.mod.Options.XML2JS
import typingsSlinky.xmlJs.mod.Options.XML2JSON
...
object mod {
  ...
  object ElementCompact {
    ...
    implicit class ElementCompactMutableBuilder[Self <: ElementCompact] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_declaration(value: typingsSlinky.xmlJs.anon.Attributes): Self = StObject.set(x, "_declaration", value.asInstanceOf[js.Any])
