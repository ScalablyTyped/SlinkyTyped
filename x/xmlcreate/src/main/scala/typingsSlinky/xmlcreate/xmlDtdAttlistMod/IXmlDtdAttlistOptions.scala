package typingsSlinky.xmlcreate.xmlDtdAttlistMod
...
@js.native
trait IXmlDtdAttlistOptions extends js.Object {
...
object IXmlDtdAttlistOptions {
  ...
  @scala.inline
  implicit class IXmlDtdAttlistOptionsOps[Self <: IXmlDtdAttlistOptions] (val x: Self) extends AnyVal {
