...
object xmlAttributeMod extends js.Object {
  ...
  trait XmlAttribute
    ...
    /**
      ...
      */
    def charRef(char: String, hex: Boolean): typingsSlinky.xmlcreate.xmlCharRefMod.default = js.native
    def charRef(char: String, hex: Boolean, index: Double): typingsSlinky.xmlcreate.xmlCharRefMod.default = js.native
    /**
      ...
      * @returns The newly created XML declaration.
      */
    def entityRef(entity: String): typingsSlinky.xmlcreate.xmlEntityRefMod.default = js.native
    def entityRef(entity: String, index: Double): typingsSlinky.xmlcreate.xmlEntityRefMod.default = js.native
    /**
    ...
    /**
      ...
      * @returns The newly created XML declaration.
      */
    def text(text: String): typingsSlinky.xmlcreate.xmlAttributeTextMod.default = js.native
    def text(text: String, index: Double): typingsSlinky.xmlcreate.xmlAttributeTextMod.default = js.native
  }
