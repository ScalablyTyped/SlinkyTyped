...
import typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default
...
object xmlcreateMod extends js.Object {
  ...
  class XmlAttribute protected () extends default {
    def this(name: String, value: js.Array[typingsSlinky.xmlcreate.libNodesXmlNodeMod.default]) = this()
    /**
      ...
      *              permitted.
      */
    def this(name: String, value: typingsSlinky.xmlcreate.libNodesXmlNodeMod.default) = this()
  }
  
  @js.native
  class XmlAttributeText protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlAttributeTextMod.default {
    /**
  ...
  class XmlCdata protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlCdataMod.default {
    /**
  ...
  class XmlCharData protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlCharDataMod.default {
    /**
  ...
  class XmlCharRef protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlCharRefMod.default {
    /**
  ...
  class XmlComment protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlCommentMod.default {
    /**
  ...
  /**
    ...
    */
  class XmlDecl ()
    extends typingsSlinky.xmlcreate.libNodesXmlDeclMod.default {
    def this(options: IDeclarationOptions) = this()
  }
  
  @js.native
  class XmlDocument protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDocumentMod.default {
    /**
  ...
  class XmlDtd protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdMod.default {
    /**
  ...
  class XmlDtdAttlist protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdAttlistMod.default {
    /**
  ...
  class XmlDtdElement protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdElementMod.default {
    /**
  ...
  class XmlDtdEntity protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdEntityMod.default {
    /**
  ...
  class XmlDtdNotation protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdNotationMod.default {
    /**
  ...
  class XmlDtdParamEntityRef protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlDtdParamEntityRefMod.default {
    /**
  ...
  class XmlElement protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlElementMod.default {
    /**
  ...
  class XmlEntityRef protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlEntityRefMod.default {
    /**
  ...
  class XmlProcInst protected ()
    extends typingsSlinky.xmlcreate.libNodesXmlProcInstMod.default {
    /**
  ...
  def document(root: String): typingsSlinky.xmlcreate.libNodesXmlDocumentMod.default = js.native
}
