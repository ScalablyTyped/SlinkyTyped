...
import typingsSlinky.xmlcreate.libNodesXmlElementMod.XmlElement
...
object libNodesXmlElementMod extends js.Object {
  ...
  trait XmlElement
    ...
    /**
      ...
      */
    def attribute(name: String, value: String): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    def attribute(name: String, value: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    def attribute(name: String, value: js.Array[String | typingsSlinky.xmlcreate.libNodesXmlNodeMod.default]): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    def attribute(
      name: String,
      value: js.Array[String | typingsSlinky.xmlcreate.libNodesXmlNodeMod.default],
      index: Double
    ): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsSlinky.xmlcreate.libNodesXmlNodeMod.default): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsSlinky.xmlcreate.libNodesXmlNodeMod.default, index: Double): typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default = js.native
    /**
      ...
      *          instances of {@link XmlAttribute}.
      */
    def attributes(): js.Array[typingsSlinky.xmlcreate.libNodesXmlAttributeMod.default] = js.native
    /**
      ...
      */
    def cdata(content: String): typingsSlinky.xmlcreate.libNodesXmlCdataMod.default = js.native
    def cdata(content: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlCdataMod.default = js.native
    /**
      ...
      */
    def charData(charData: String): typingsSlinky.xmlcreate.libNodesXmlCharDataMod.default = js.native
    def charData(charData: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlCharDataMod.default = js.native
    /**
      ...
      */
    def charRef(char: String): typingsSlinky.xmlcreate.libNodesXmlCharRefMod.default = js.native
    def charRef(char: String, hex: Boolean): typingsSlinky.xmlcreate.libNodesXmlCharRefMod.default = js.native
    def charRef(char: String, hex: Boolean, index: Double): typingsSlinky.xmlcreate.libNodesXmlCharRefMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def entityRef(entity: String): typingsSlinky.xmlcreate.libNodesXmlEntityRefMod.default = js.native
    def entityRef(entity: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlEntityRefMod.default = js.native
    /**
