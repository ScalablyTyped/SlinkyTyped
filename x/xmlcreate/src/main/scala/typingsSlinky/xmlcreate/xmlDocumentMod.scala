...
object xmlDocumentMod extends js.Object {
  ...
  trait XmlDocument
    ...
    /**
      ...
      */
    def comment(content: String): typingsSlinky.xmlcreate.xmlCommentMod.default = js.native
    def comment(content: String, index: Double): typingsSlinky.xmlcreate.xmlCommentMod.default = js.native
    /**
      ...
      */
    def decl(): typingsSlinky.xmlcreate.xmlDeclMod.default = js.native
    def decl(options: IDeclarationOptions): typingsSlinky.xmlcreate.xmlDeclMod.default = js.native
    /**
      ...
      */
    def dtd(name: String): typingsSlinky.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String): typingsSlinky.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String, pubId: String): typingsSlinky.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String, pubId: String, index: Double): typingsSlinky.xmlcreate.xmlDtdMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def procInst(target: String): typingsSlinky.xmlcreate.xmlProcInstMod.default = js.native
    def procInst(target: String, content: String): typingsSlinky.xmlcreate.xmlProcInstMod.default = js.native
    def procInst(target: String, content: String, index: Double): typingsSlinky.xmlcreate.xmlProcInstMod.default = js.native
    /**
    ...
    /**
      ...
      * @returns The root element of this document.
      */
    def root(): typingsSlinky.xmlcreate.xmlElementMod.default = js.native
  }
