...
import typingsSlinky.xmlcreate.libNodesXmlDtdMod.XmlDtd
...
@js.native
object libNodesXmlDtdMod extends js.Object {
  @js.native
  trait XmlDtd
    ...
    /**
      ...
      */
    def attlist(text: String): typingsSlinky.xmlcreate.libNodesXmlDtdAttlistMod.default = js.native
    def attlist(text: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlDtdAttlistMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def element(text: String): typingsSlinky.xmlcreate.libNodesXmlDtdElementMod.default = js.native
    def element(text: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlDtdElementMod.default = js.native
    /**
      ...
      */
    def entity(text: String): typingsSlinky.xmlcreate.libNodesXmlDtdEntityMod.default = js.native
    def entity(text: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlDtdEntityMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def notation(text: String): typingsSlinky.xmlcreate.libNodesXmlDtdNotationMod.default = js.native
    def notation(text: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlDtdNotationMod.default = js.native
    /**
      ...
      */
    def paramEntityRef(entity: String): typingsSlinky.xmlcreate.libNodesXmlDtdParamEntityRefMod.default = js.native
    def paramEntityRef(entity: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlDtdParamEntityRefMod.default = js.native
    /**
