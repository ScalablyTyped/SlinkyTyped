...
object xmlElementMod extends js.Object {
  ...
  trait XmlElement
    ...
    /**
      ...
      */
    def attribute(name: String, value: String): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: String, index: Double): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: js.Array[String | typingsSlinky.xmlcreate.xmlNodeMod.default]): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: js.Array[String | typingsSlinky.xmlcreate.xmlNodeMod.default], index: Double): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsSlinky.xmlcreate.xmlNodeMod.default): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsSlinky.xmlcreate.xmlNodeMod.default, index: Double): typingsSlinky.xmlcreate.xmlAttributeMod.default = js.native
    /**
      ...
      *          instances of {@link XmlAttribute}.
      */
    def attributes(): js.Array[typingsSlinky.xmlcreate.xmlAttributeMod.default] = js.native
    /**
      ...
      */
    def cdata(content: String): typingsSlinky.xmlcreate.xmlCdataMod.default = js.native
    def cdata(content: String, index: Double): typingsSlinky.xmlcreate.xmlCdataMod.default = js.native
    /**
      ...
      */
    def charData(charData: String): typingsSlinky.xmlcreate.xmlCharDataMod.default = js.native
    def charData(charData: String, index: Double): typingsSlinky.xmlcreate.xmlCharDataMod.default = js.native
    /**
      ...
      */
    def charRef(char: String): typingsSlinky.xmlcreate.xmlCharRefMod.default = js.native
