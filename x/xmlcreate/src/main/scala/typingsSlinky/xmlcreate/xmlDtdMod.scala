...
object xmlDtdMod extends js.Object {
  ...
  trait XmlDtd
    ...
    /**
      ...
      */
    def attlist(text: String): typingsSlinky.xmlcreate.xmlDtdAttlistMod.default = js.native
    def attlist(text: String, index: Double): typingsSlinky.xmlcreate.xmlDtdAttlistMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def element(text: String): typingsSlinky.xmlcreate.xmlDtdElementMod.default = js.native
    def element(text: String, index: Double): typingsSlinky.xmlcreate.xmlDtdElementMod.default = js.native
    /**
      ...
      */
    def entity(text: String): typingsSlinky.xmlcreate.xmlDtdEntityMod.default = js.native
    def entity(text: String, index: Double): typingsSlinky.xmlcreate.xmlDtdEntityMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def notation(text: String): typingsSlinky.xmlcreate.xmlDtdNotationMod.default = js.native
    def notation(text: String, index: Double): typingsSlinky.xmlcreate.xmlDtdNotationMod.default = js.native
    /**
      ...
      */
    def paramEntityRef(entity: String): typingsSlinky.xmlcreate.xmlDtdParamEntityRefMod.default = js.native
    def paramEntityRef(entity: String, index: Double): typingsSlinky.xmlcreate.xmlDtdParamEntityRefMod.default = js.native
    /**
