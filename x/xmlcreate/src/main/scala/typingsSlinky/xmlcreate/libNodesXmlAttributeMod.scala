...
import typingsSlinky.xmlcreate.libNodesXmlAttributeMod.XmlAttribute
...
@js.native
object libNodesXmlAttributeMod extends js.Object {
  @js.native
  trait XmlAttribute
    ...
    /**
      ...
      * @returns The newly created XML declaration.
      */
    def text(text: String): typingsSlinky.xmlcreate.libNodesXmlAttributeTextMod.default = js.native
    def text(text: String, index: Double): typingsSlinky.xmlcreate.libNodesXmlAttributeTextMod.default = js.native
  }
