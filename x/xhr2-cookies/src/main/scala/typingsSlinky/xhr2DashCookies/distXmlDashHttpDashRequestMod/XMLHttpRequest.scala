package typingsSlinky.xhr2DashCookies.distXmlDashHttpDashRequestMod
...
import typingsSlinky.xhr2DashCookies.Anon_BaseUrl
import typingsSlinky.xhr2DashCookies.distXmlDashHttpDashRequestDashEventDashTargetMod.ProgressEventListener
import typingsSlinky.xhr2DashCookies.distXmlDashHttpDashRequestDashEventDashTargetMod.XMLHttpRequestEventTarget
import typingsSlinky.xhr2DashCookies.distXmlDashHttpDashRequestDashUploadMod.XMLHttpRequestUpload
...
object XMLHttpRequest extends js.Object {
  var DONE: Double = js.native
  var HEADERS_RECEIVED: Double = js.native
  var InvalidStateError: Instantiable0[typingsSlinky.xhr2DashCookies.distErrorsMod.InvalidStateError] = js.native
  var LOADING: Double = js.native
  var NetworkError: Instantiable0[typingsSlinky.xhr2DashCookies.distErrorsMod.NetworkError] = js.native
  var OPENED: Double = js.native
  var ProgressEvent: Instantiable1[
    /* type */ String, 
    typingsSlinky.xhr2DashCookies.distProgressDashEventMod.ProgressEvent
  ] = js.native
  var SecurityError: Instantiable0[typingsSlinky.xhr2DashCookies.distErrorsMod.SecurityError] = js.native
  var SyntaxError: Instantiable0[typingsSlinky.xhr2DashCookies.distErrorsMod.SyntaxError] = js.native
  var UNSENT: Double = js.native
  var XMLHttpRequestUpload: Instantiable0[
    typingsSlinky.xhr2DashCookies.distXmlDashHttpDashRequestDashUploadMod.XMLHttpRequestUpload
  ] = js.native
