...
object mod {
  ...
  @JSImport("xmlpoke", "CDataValue")
  @js.native
  def CDataValue: Instantiable1[/* value */ String, typingsSlinky.xmlpoke.XmlPoke.CDataValue] = js.native
  @scala.inline
  def CDataValue_=(x: Instantiable1[/* value */ String, typingsSlinky.xmlpoke.XmlPoke.CDataValue]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CDataValue")(x.asInstanceOf[js.Any])
