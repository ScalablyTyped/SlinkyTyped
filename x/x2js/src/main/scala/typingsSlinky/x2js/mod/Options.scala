...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDatetimeAccessFormPathsVarargs(value: (String | js.RegExp | (js.Function1[/* elementPath */ String, Boolean]))*): Self = this.set("datetimeAccessFormPaths", js.Array(value :_*))
    @scala.inline
    def setDatetimeAccessFormPaths(value: js.Array[String | js.RegExp | (js.Function1[/* elementPath */ String, Boolean])]): Self = this.set("datetimeAccessFormPaths", value.asInstanceOf[js.Any])
    @scala.inline
