package typingsSlinky.xast.mod

import typingsSlinky.xast.xastStrings.instruction
...
object Instruction {
  ...
  implicit class InstructionOps[Self <: Instruction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: instruction): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
