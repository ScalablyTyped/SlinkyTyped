...
import typingsSlinky.xadesjs.anon.Encoding
...
object XmlXades {
  ...
  @js.native
  def ElementNames: typingsSlinky.xadesjs.anon.AllDataObjectsTimeStamp = js.native
  @scala.inline
  def ElementNames_=(x: typingsSlinky.xadesjs.anon.AllDataObjectsTimeStamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ElementNames")(x.asInstanceOf[js.Any])
