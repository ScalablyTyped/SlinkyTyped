...
import typingsSlinky.xadesjs.buildTypesXmlCertificateUnderscoreValuesMod.CertificateValues
import typingsSlinky.xadesjs.buildTypesXmlCompleteUnderscoreCertificateUnderscoreRefsMod.CompleteCertificateRefs
import typingsSlinky.xadesjs.buildTypesXmlCompleteUnderscoreRevocationUnderscoreRefsMod.CompleteRevocationRefs
import typingsSlinky.xadesjs.buildTypesXmlRevocationUnderscoreValuesMod.RevocationValues
