...
object AnonInitial {
  ...
  @scala.inline
  implicit class AnonInitialOps[Self[tstateschema, tevent] <: AnonInitial[tstateschema, tevent], TStateSchema, TEvent] (val x: Self[TStateSchema, TEvent]) extends AnyVal {
    @scala.inline
