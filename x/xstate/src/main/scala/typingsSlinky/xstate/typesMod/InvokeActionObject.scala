...
object InvokeActionObject {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](activity: InvokeDefinition[TContext, TEvent], `type`: Start | Stop): InvokeActionObject[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class InvokeActionObjectOps[Self <: InvokeActionObject[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (InvokeActionObject[TContext, TEvent])) extends AnyVal {
    @scala.inline
