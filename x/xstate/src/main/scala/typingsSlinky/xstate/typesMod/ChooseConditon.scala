...
object ChooseConditon {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](actions: Actions[TContext, TEvent]): ChooseConditon[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(actions = actions.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChooseConditon[TContext, TEvent]]
  }
  @scala.inline
  implicit class ChooseConditonOps[Self <: ChooseConditon[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (ChooseConditon[TContext, TEvent])) extends AnyVal {
    @scala.inline
