...
object ParallelMachineConfig {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](): ParallelMachineConfig[TContext, TStateSchema, TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParallelMachineConfig[TContext, TStateSchema, TEvent]]
  }
  @scala.inline
  implicit class ParallelMachineConfigOps[Self <: ParallelMachineConfig[_, _, _], TContext, /* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (ParallelMachineConfig[TContext, TStateSchema, TEvent])) extends AnyVal {
    @scala.inline
