...
object HistoryStateNodeConfig {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](history: shallow | deep | `true`): HistoryStateNodeConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(history = history.asInstanceOf[js.Any])
    __obj.asInstanceOf[HistoryStateNodeConfig[TContext, TEvent]]
  }
  @scala.inline
  implicit class HistoryStateNodeConfigOps[Self <: HistoryStateNodeConfig[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (HistoryStateNodeConfig[TContext, TEvent])) extends AnyVal {
    @scala.inline
