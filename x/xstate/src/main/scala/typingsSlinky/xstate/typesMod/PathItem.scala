...
object PathItem {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](path: js.Array[Segment[TContext, TEvent]], state: State[TContext, TEvent, _, Context[TContext]]): PathItem[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class PathItemOps[Self <: PathItem[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (PathItem[TContext, TEvent])) extends AnyVal {
    @scala.inline
