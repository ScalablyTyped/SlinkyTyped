...
object GuardMeta {
  ...
  @scala.inline
  implicit class GuardMetaOps[Self <: GuardMeta[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (GuardMeta[TContext, TEvent])) extends AnyVal {
    @scala.inline
