...
object AnyAssignAction {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](assignment: js.Any, `type`: Assign): AnyAssignAction[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class AnyAssignActionOps[Self <: AnyAssignAction[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (AnyAssignAction[TContext, TEvent])) extends AnyVal {
    @scala.inline
