...
trait SendActionObject[TContext, TEvent /* <: EventObject */, TSentEvent /* <: EventObject */] extends SendAction[TContext, TEvent, TSentEvent] {
  var _event: typingsSlinky.xstate.typesMod.SCXML.Event[TSentEvent] = js.native
  @JSName("delay")
...
object SendActionObject {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: typingsSlinky.xstate.typesMod.EventObject */ TSentEvent](
    _event: typingsSlinky.xstate.typesMod.SCXML.Event[TSentEvent],
    event: TSentEvent,
    id: String | Double,
    `type`: String
  ...
  @scala.inline
  implicit class SendActionObjectOps[Self <: SendActionObject[_, _, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: typingsSlinky.xstate.typesMod.EventObject */ TSentEvent] (val x: Self with (SendActionObject[TContext, TEvent, TSentEvent])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def set_event(value: typingsSlinky.xstate.typesMod.SCXML.Event[TSentEvent]): Self = this.set("_event", value.asInstanceOf[js.Any])
    @scala.inline
