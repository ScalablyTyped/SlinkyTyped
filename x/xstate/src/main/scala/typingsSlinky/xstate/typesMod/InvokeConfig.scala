...
object InvokeConfig {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](src: String | (StateMachine[_, _, _, _]) | (InvokeCreator[TContext, TEvent, _])): InvokeConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(src = src.asInstanceOf[js.Any])
    __obj.asInstanceOf[InvokeConfig[TContext, TEvent]]
  }
  @scala.inline
  implicit class InvokeConfigOps[Self <: InvokeConfig[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (InvokeConfig[TContext, TEvent])) extends AnyVal {
    @scala.inline
