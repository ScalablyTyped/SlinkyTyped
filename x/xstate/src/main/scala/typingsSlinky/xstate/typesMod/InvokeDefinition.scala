...
object InvokeDefinition {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](id: String, src: String, `type`: String): InvokeDefinition[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class InvokeDefinitionOps[Self <: InvokeDefinition[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (InvokeDefinition[TContext, TEvent])) extends AnyVal {
    @scala.inline
