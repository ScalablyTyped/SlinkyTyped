...
package object typesMod {
  ...
  */
  ...
  type InvokeConfig[TContext, TEvent /* <: typingsSlinky.xstate.typesMod.EventObject */] = (typingsSlinky.xstate.anon.Data[TContext, TEvent]) | (typingsSlinky.xstate.typesMod.StateMachine[js.Any, js.Any, js.Any, js.Any])
