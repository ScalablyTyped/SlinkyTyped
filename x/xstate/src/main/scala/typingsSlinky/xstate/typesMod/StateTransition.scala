...
object StateTransition {
  ...
  @scala.inline
  implicit class StateTransitionOps[Self <: StateTransition[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (StateTransition[TContext, TEvent])) extends AnyVal {
    @scala.inline
