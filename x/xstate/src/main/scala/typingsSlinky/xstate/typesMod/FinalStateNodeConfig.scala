...
object FinalStateNodeConfig {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](`type`: `final`): FinalStateNodeConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FinalStateNodeConfig[TContext, TEvent]]
  }
  @scala.inline
  implicit class FinalStateNodeConfigOps[Self <: FinalStateNodeConfig[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (FinalStateNodeConfig[TContext, TEvent])) extends AnyVal {
    @scala.inline
