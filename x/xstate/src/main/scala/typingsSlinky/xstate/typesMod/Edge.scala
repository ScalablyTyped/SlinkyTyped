...
object Edge {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: / * import warning: importer.ImportType#apply Failed type conversion: TEvent['type'] * / js.Any */ TEventType](
  ...
  @scala.inline
  implicit class EdgeOps[Self <: Edge[_, _, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: / * import warning: importer.ImportType#apply Failed type conversion: TEvent['type'] * / js.Any */ TEventType] (val x: Self with (Edge[TContext, TEvent, TEventType])) extends AnyVal {
    @scala.inline
