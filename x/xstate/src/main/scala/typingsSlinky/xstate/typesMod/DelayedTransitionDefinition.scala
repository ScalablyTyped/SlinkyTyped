...
object DelayedTransitionDefinition {
  ...
  @scala.inline
  implicit class DelayedTransitionDefinitionOps[Self <: DelayedTransitionDefinition[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (DelayedTransitionDefinition[TContext, TEvent])) extends AnyVal {
    @scala.inline
