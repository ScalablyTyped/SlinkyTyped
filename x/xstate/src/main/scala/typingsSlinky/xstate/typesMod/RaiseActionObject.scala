...
object RaiseActionObject {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](_event: typingsSlinky.xstate.typesMod.SCXML.Event[TEvent], `type`: Raise): RaiseActionObject[TEvent] = {
    val __obj = js.Dynamic.literal(_event = _event.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[RaiseActionObject[TEvent]]
  }
  @scala.inline
  implicit class RaiseActionObjectOps[Self <: RaiseActionObject[_], /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with RaiseActionObject[TEvent]) extends AnyVal {
    @scala.inline
