...
object SendActionOptions {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](): SendActionOptions[TContext, TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SendActionOptions[TContext, TEvent]]
  }
  @scala.inline
  implicit class SendActionOptionsOps[Self <: SendActionOptions[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (SendActionOptions[TContext, TEvent])) extends AnyVal {
    @scala.inline
