...
object AssignAction {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](assignment: (Assigner[TContext, TEvent]) | (PropertyAssigner[TContext, TEvent]), `type`: Assign): AssignAction[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class AssignActionOps[Self <: AssignAction[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (AssignAction[TContext, TEvent])) extends AnyVal {
    @scala.inline
