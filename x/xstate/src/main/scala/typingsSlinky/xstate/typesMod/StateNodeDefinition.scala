...
object StateNodeDefinition {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](
  ...
  @scala.inline
  implicit class StateNodeDefinitionOps[Self <: StateNodeDefinition[_, _, _], TContext, /* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (StateNodeDefinition[TContext, TStateSchema, TEvent])) extends AnyVal {
    @scala.inline
