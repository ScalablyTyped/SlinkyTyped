...
object RaiseAction {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](
  ...
  @scala.inline
  implicit class RaiseActionOps[Self <: RaiseAction[_], /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with RaiseAction[TEvent]) extends AnyVal {
    @scala.inline
