...
object Event {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](DollarDollartype: scxml, data: TEvent, name: String, `type`: platform | internal | external): Event[TEvent] = {
  ...
  @scala.inline
  implicit class EventOps[Self <: Event[_], /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with Event[TEvent]) extends AnyVal {
    @scala.inline
