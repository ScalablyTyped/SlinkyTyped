...
object SCXML {
  ...
  object Event {
    ...
    @scala.inline
    def apply[TEvent /* <: EventObject */](DollarDollartype: scxml, data: TEvent, name: String, `type`: platform | internal | external): typingsSlinky.xstate.typesMod.SCXML.Event[TEvent] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("$$type")(DollarDollartype.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]]
    }
    
    @scala.inline
    implicit class EventMutableBuilder[Self <: typingsSlinky.xstate.typesMod.SCXML.Event[_], TEvent /* <: EventObject */] (val x: Self with typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]) extends AnyVal {
