...
object TransitionDefinition {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](
  ...
  @scala.inline
  implicit class TransitionDefinitionOps[Self <: TransitionDefinition[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (TransitionDefinition[TContext, TEvent])) extends AnyVal {
    @scala.inline
