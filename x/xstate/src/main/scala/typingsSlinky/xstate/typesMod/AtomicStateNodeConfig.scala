...
object AtomicStateNodeConfig {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](): AtomicStateNodeConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AtomicStateNodeConfig[TContext, TEvent]]
  }
  @scala.inline
  implicit class AtomicStateNodeConfigOps[Self <: AtomicStateNodeConfig[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (AtomicStateNodeConfig[TContext, TEvent])) extends AnyVal {
    @scala.inline
