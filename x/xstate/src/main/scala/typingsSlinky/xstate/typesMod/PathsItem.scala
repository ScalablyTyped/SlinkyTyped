...
object PathsItem {
  ...
  @scala.inline
  implicit class PathsItemOps[Self <: PathsItem[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (PathsItem[TContext, TEvent])) extends AnyVal {
    @scala.inline
