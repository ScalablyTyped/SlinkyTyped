...
object NodesAndEdges {
  ...
  @scala.inline
  implicit class NodesAndEdgesOps[Self <: NodesAndEdges[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (NodesAndEdges[TContext, TEvent])) extends AnyVal {
    @scala.inline
