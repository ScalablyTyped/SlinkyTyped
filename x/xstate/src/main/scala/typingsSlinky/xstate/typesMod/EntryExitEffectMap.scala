...
object EntryExitEffectMap {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](entry: js.Array[ActionObject[TContext, TEvent]], exit: js.Array[ActionObject[TContext, TEvent]]): EntryExitEffectMap[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class EntryExitEffectMapOps[Self <: EntryExitEffectMap[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (EntryExitEffectMap[TContext, TEvent])) extends AnyVal {
    @scala.inline
