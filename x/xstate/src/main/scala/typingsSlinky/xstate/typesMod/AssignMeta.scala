...
object AssignMeta {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](_event: typingsSlinky.xstate.typesMod.SCXML.Event[TEvent], action: AssignAction[TContext, TEvent]): AssignMeta[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class AssignMetaOps[Self <: AssignMeta[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (AssignMeta[TContext, TEvent])) extends AnyVal {
    @scala.inline
