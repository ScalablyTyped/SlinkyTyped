...
object MachineOptions {
  ...
  @scala.inline
  implicit class MachineOptionsOps[Self <: MachineOptions[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (MachineOptions[TContext, TEvent])) extends AnyVal {
    @scala.inline
