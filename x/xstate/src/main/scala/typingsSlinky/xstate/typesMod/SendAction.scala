...
object SendAction {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: typingsSlinky.xstate.typesMod.EventObject */ TSentEvent](event: TSentEvent | (SendExpr[TContext, TEvent, TSentEvent]), id: String | Double, `type`: String): SendAction[TContext, TEvent, TSentEvent] = {
  ...
  @scala.inline
  implicit class SendActionOps[Self <: SendAction[_, _, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent, /* <: typingsSlinky.xstate.typesMod.EventObject */ TSentEvent] (val x: Self with (SendAction[TContext, TEvent, TSentEvent])) extends AnyVal {
    @scala.inline
