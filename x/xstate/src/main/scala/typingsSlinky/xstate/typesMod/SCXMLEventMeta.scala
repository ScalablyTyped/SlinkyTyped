...
object SCXMLEventMeta {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](_event: typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]): SCXMLEventMeta[TEvent] = {
    val __obj = js.Dynamic.literal(_event = _event.asInstanceOf[js.Any])
    __obj.asInstanceOf[SCXMLEventMeta[TEvent]]
  }
  @scala.inline
  implicit class SCXMLEventMetaOps[Self <: SCXMLEventMeta[_], /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with SCXMLEventMeta[TEvent]) extends AnyVal {
    @scala.inline
