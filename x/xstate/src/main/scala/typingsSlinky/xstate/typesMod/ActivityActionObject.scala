...
object ActivityActionObject {
  @scala.inline
  def apply[TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](activity: ActivityDefinition[TContext, TEvent], `type`: Start | Stop): ActivityActionObject[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class ActivityActionObjectOps[Self <: ActivityActionObject[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (ActivityActionObject[TContext, TEvent])) extends AnyVal {
    @scala.inline
