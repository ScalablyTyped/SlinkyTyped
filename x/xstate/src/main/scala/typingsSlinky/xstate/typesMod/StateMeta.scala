...
object StateMeta {
  ...
  @scala.inline
  implicit class StateMetaOps[Self <: StateMeta[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (StateMeta[TContext, TEvent])) extends AnyVal {
    @scala.inline
