...
trait StateConfig[TContext, TEvent /* <: EventObject */] extends js.Object {
  ...
  var history: js.UndefOr[State[TContext, TEvent, _, Context[TContext]]] = js.undefined
...
object StateConfig {
  ...
  def apply[TContext, TEvent](
    ...
    history: State[TContext, TEvent, _, Context[TContext]] = null,
    historyValue: HistoryValue = null,
    meta: js.Any = null
  ): StateConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(_event = _event.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], configuration = configuration.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], transitions = transitions.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], _sessionid = _sessionid.asInstanceOf[js.Any])
