...
object ActionMap {
  ...
  @scala.inline
  implicit class ActionMapOps[Self <: ActionMap[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (ActionMap[TContext, TEvent])) extends AnyVal {
    @scala.inline
