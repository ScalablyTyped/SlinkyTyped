...
object ActionMeta {
  ...
  @scala.inline
  implicit class ActionMetaOps[Self <: ActionMeta[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (ActionMeta[TContext, TEvent])) extends AnyVal {
    @scala.inline
