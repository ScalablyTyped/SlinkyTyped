...
object Initial {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](
  ...
  @scala.inline
  implicit class InitialOps[Self <: Initial[_, _], /* <: typingsSlinky.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (Initial[TStateSchema, TEvent])) extends AnyVal {
    @scala.inline
