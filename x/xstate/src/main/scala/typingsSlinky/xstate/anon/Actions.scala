...
object Actions {
  ...
  @scala.inline
  implicit class ActionsOps[Self <: Actions[_, _], TContext, /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with (Actions[TContext, TEvent])) extends AnyVal {
    @scala.inline
