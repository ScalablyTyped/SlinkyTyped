...
object SequencePatternOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent](): SequencePatternOptions[TEvent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SequencePatternOptions[TEvent]]
  }
  @scala.inline
  implicit class SequencePatternOptionsOps[Self <: SequencePatternOptions[_], /* <: typingsSlinky.xstate.typesMod.EventObject */ TEvent] (val x: Self with SequencePatternOptions[TEvent]) extends AnyVal {
    @scala.inline
