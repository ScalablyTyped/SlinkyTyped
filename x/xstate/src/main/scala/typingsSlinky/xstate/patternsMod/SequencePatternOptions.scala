...
object SequencePatternOptions {
  ...
  @scala.inline
  implicit class SequencePatternOptionsOps[Self <: SequencePatternOptions[_], TEvent /* <: EventObject */] (val x: Self with SequencePatternOptions[TEvent]) extends AnyVal {
