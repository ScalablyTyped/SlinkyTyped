...
package object interpreterMod {
  ...
  type StateListener[TContext, TEvent /* <: typingsSlinky.xstate.typesMod.EventObject */, TTypestate /* <: typingsSlinky.xstate.typesMod.Typestate[TContext] */] = js.Function2[
    /* state */ typingsSlinky.xstate.stateMod.State[TContext, TEvent, js.Any, TTypestate], 
    /* event */ TEvent, 
    scala.Unit
  ]
}
