...
import typingsSlinky.xstate.libTypesMod.ActionTypes.Raise
...
object RaiseActionObject {
  @scala.inline
  def apply[TEvent /* <: EventObject */](_event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent], `type`: Raise): RaiseActionObject[TEvent] = {
