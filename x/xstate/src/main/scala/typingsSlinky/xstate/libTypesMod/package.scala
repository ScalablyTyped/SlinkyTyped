...
package object libTypesMod {
  ...
  import typingsSlinky.xstate.Anon_AutoForwardData
  import typingsSlinky.xstate.Anon_Delay
  import typingsSlinky.xstate.Anon_TypeString
  ...
  import typingsSlinky.xstate.xstateStrings.xstateDotguard
  ...
  */
  ...
  type InvokeCallback = js.Function2[/* callback */ Sender[js.Any], /* onReceive */ Receiver[EventObject], js.Any]
