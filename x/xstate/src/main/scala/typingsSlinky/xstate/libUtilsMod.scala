...
import typingsSlinky.xstate.libTypesMod.StateLike
...
import typingsSlinky.xstate.libTypesMod.TransitionConfigTargetShortcut
...
object libUtilsMod extends js.Object {
  ...
  def mapContext[TContext, TEvent /* <: EventObject */](
    ...
    context: TContext,
    _event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]
  ): js.Any = js.native
  def mapContext[TContext, TEvent /* <: EventObject */](
  ...
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent]): typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent], scxmlEvent: Partial[typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]]): typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]): typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](
    event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent],
    scxmlEvent: Partial[typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]]
  ): typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent] = js.native
