...
import typingsSlinky.xstate.libTypesMod.DelayedTransitionDefinition
...
import typingsSlinky.xstate.libTypesMod.InvokeDefinition
...
import typingsSlinky.xstate.libTypesMod.StateNodeDefinition
import typingsSlinky.xstate.libTypesMod.StateNodesConfig
...
import typingsSlinky.xstate.libTypesMod.TransitionDefinition
import typingsSlinky.xstate.libTypesMod.TransitionDefinitionMap
...
object libStateNodeMod extends js.Object {
  ...
  class StateNode[TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */, TState /* <: Typestate[TContext] */] protected () extends js.Object {
    ...
    def transition(state: js.UndefOr[scala.Nothing], event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TState] = js.native
    def transition(
      state: js.UndefOr[scala.Nothing],
      event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext
    ...
    def transition(state: String, event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TState] = js.native
    def transition(state: String, event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent], context: TContext): State[TContext, TEvent, TStateSchema, TState] = js.native
    ...
    def transition(state: State[TContext, TEvent, _, _], event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TState] = js.native
    def transition(
    ...
    def transition(state: StateValueMap, event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TState] = js.native
    def transition(
      state: StateValueMap,
      event: typingsSlinky.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext
