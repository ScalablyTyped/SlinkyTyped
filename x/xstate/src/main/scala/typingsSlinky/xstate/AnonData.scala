...
object AnonData {
  @scala.inline
  def apply[TContext, TEvent](src: String | (StateMachine[_, _, _, _]) | (InvokeCreator[TContext, TEvent, _])): AnonData[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(src = src.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonData[TContext, TEvent]]
  }
  @scala.inline
  implicit class AnonDataOps[Self[tcontext, tevent] <: AnonData[tcontext, tevent], TContext, TEvent] (val x: Self[TContext, TEvent]) extends AnyVal {
    @scala.inline
