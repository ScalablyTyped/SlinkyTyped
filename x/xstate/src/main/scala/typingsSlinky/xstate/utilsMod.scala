...
import typingsSlinky.xstate.typesMod.TransitionConfigTargetShortcut
...
object utilsMod extends js.Object {
  ...
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent]): typingsSlinky.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent], scxmlEvent: Partial[typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]]): typingsSlinky.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]): typingsSlinky.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](
    event: typingsSlinky.xstate.typesMod.SCXML.Event[TEvent],
    scxmlEvent: Partial[typingsSlinky.xstate.typesMod.SCXML.Event[TEvent]]
  ): typingsSlinky.xstate.typesMod.SCXML.Event[TEvent] = js.native
  ...
  def toTransitionConfigArray[TContext, TEvent /* <: EventObject */](
    ...
    (TransitionConfig[TContext, TEvent]) with typingsSlinky.xstate.anon.Event[TEvent]
  ] = js.native
  def toTransitionConfigArray[TContext, TEvent /* <: EventObject */](
    event: Asterisk,
    configLike: SingleOrArray[
