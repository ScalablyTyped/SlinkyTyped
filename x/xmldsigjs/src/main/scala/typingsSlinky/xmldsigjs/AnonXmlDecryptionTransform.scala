...
@js.native
trait AnonXmlDecryptionTransform extends js.Object {
...
object AnonXmlDecryptionTransform {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonXmlDecryptionTransform]
  }
  @scala.inline
  implicit class AnonXmlDecryptionTransformOps[Self <: AnonXmlDecryptionTransform] (val x: Self) extends AnyVal {
    @scala.inline
