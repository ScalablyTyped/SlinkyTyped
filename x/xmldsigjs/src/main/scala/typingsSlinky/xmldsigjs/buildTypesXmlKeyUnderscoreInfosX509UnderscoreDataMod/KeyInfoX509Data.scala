package typingsSlinky.xmldsigjs.buildTypesXmlKeyUnderscoreInfosX509UnderscoreDataMod
...
class KeyInfoX509Data () extends KeyInfoClause {
  ...
  /**
    ...
    */
  def CRL(): scala.scalajs.js.typedarray.Uint8Array | Null = js.native
  def CRL(value: scala.scalajs.js.typedarray.Uint8Array): js.Any = js.native
  @JSName("CRL")
  def CRL_Any(): js.Any = js.native
  /**
