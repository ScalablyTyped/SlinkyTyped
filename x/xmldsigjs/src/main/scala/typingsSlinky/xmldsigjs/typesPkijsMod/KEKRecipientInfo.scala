...
@JSImport("xmldsigjs/types/pkijs", "KEKRecipientInfo")
@js.native
class KEKRecipientInfo () extends js.Object {
  ...
  var preDefinedKEK: scala.scalajs.js.typedarray.ArrayBuffer = js.native
...
@JSImport("xmldsigjs/types/pkijs", "KEKRecipientInfo")
@js.native
object KEKRecipientInfo extends js.Object {
  /**
