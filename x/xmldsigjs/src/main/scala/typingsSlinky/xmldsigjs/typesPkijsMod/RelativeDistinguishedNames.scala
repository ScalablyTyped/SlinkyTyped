...
@JSImport("xmldsigjs/types/pkijs", "RelativeDistinguishedNames")
@js.native
class RelativeDistinguishedNames () extends js.Object {
...
@JSImport("xmldsigjs/types/pkijs", "RelativeDistinguishedNames")
@js.native
object RelativeDistinguishedNames extends js.Object {
  /**
