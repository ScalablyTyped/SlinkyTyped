...
import typingsSlinky.xmldsigjs.Anon_ContentEncryptionAlgorithm
import typingsSlinky.xmldsigjs.Anon_Password
...
class EncryptedData () extends js.Object {
  ...
  /**
    ...
    */
  def decrypt(parameters: Anon_Password): js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
  /**
    * Create a new CMS Encrypted Data content
    * @param {*} parameters Parameters neccessary for encryption
    * @returns {Promise}
    */
  def encrypt(parameters: Anon_ContentEncryptionAlgorithm): js.Thenable[scala.scalajs.js.typedarray.ArrayBuffer] = js.native
