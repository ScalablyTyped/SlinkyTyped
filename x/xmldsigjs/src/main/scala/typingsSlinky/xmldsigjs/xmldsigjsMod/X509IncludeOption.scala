...
object X509IncludeOption extends js.Object {
  ...
  /* 1 */ val EndCertOnly: typingsSlinky.xmldsigjs.xmldsigjsMod.X509IncludeOption.EndCertOnly with Double = js.native
  /* 2 */ val ExcludeRoot: typingsSlinky.xmldsigjs.xmldsigjsMod.X509IncludeOption.ExcludeRoot with Double = js.native
  /* 0 */ val None: typingsSlinky.xmldsigjs.xmldsigjsMod.X509IncludeOption.None with Double = js.native
  /* 3 */ val WholeChain: typingsSlinky.xmldsigjs.xmldsigjsMod.X509IncludeOption.WholeChain with Double = js.native
  @JSBracketAccess
