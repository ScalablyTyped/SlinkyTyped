...
class SignedInfo () extends XmlObject {
  ...
  var References: typingsSlinky.xmldsigjs.xmldsigjsMod.References = js.native
  /**
    * Gets or sets the name of the algorithm used for signature generation
    * and validation for the current SignedInfo object.
    */
  var SignatureMethod: typingsSlinky.xmldsigjs.xmldsigjsMod.SignatureMethod = js.native
}
