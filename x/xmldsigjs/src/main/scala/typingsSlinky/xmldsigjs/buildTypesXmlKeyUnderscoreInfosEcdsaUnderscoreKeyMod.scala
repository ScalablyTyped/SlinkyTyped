...
object buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod extends js.Object {
  ...
  class DomainParameters () extends XmlObject {
    var NamedCurve: typingsSlinky.xmldsigjs.buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod.NamedCurve = js.native
  }
  
  @js.native
  class EcdsaKeyValue () extends KeyInfoClause {
    var DomainParameters: typingsSlinky.xmldsigjs.buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod.DomainParameters = js.native
