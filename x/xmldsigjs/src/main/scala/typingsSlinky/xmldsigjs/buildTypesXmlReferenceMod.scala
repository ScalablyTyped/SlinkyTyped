...
object buildTypesXmlReferenceMod extends js.Object {
  ...
  class Reference () extends XmlObject {
    ...
    /**
      ...
      */
    var DigestMethod: typingsSlinky.xmldsigjs.buildTypesXmlDigestUnderscoreMethodMod.DigestMethod = js.native
    /**
    ...
    var Transforms: typingsSlinky.xmldsigjs.buildTypesXmlTransformUnderscoreCollectionMod.Transforms = js.native
    /**
