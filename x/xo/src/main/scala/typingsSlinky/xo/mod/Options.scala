...
/* Inlined {  esnext ? :boolean,   ignores ? :std.Array<string>,   nodeVersion ? :string | boolean,   prettier ? :boolean,   semicolon ? :boolean,   space ? :number | string} & xo.xo.CLIEngineOptions & xo.xo.ESLintConfig & xo.xo.ESLintOptions */
...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(esnext)) __obj.updateDynamic("esnext")(esnext.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(prettier)) __obj.updateDynamic("prettier")(prettier.asInstanceOf[js.Any])
