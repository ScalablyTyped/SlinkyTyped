...
import typingsSlinky.xregexp.Anon_Backref
import typingsSlinky.xregexp.Anon_BackrefRegex
...
object XRegExp extends js.Object {
  ...
  def matchChain(str: String, chain: js.Array[Anon_Backref | Anon_BackrefRegex | js.RegExp]): js.Array[String] = js.native
