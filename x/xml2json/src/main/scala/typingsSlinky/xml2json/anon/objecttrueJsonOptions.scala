...
import typingsSlinky.xml2json.xml2jsonBooleans.`true`
...
object objecttrueJsonOptions {
  ...
  @scala.inline
  implicit class objecttrueJsonOptionsOps[Self <: objecttrueJsonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObject(value: `true`): Self = this.set("object", value.asInstanceOf[js.Any])
