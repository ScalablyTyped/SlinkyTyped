...
object BoxProps {
  ...
  implicit class BoxPropsOps[Self <: BoxProps] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("col", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCol: Self = this.set("col", js.undefined)
    
    @scala.inline
    def setColor(value: js.Any | BreakpointObject[js.UndefOr[_]]): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGridArea(value: ResponsiveValue[String] | BreakpointObject[js.UndefOr[ResponsiveValue[String]]]): Self = this.set("gridArea", value.asInstanceOf[js.Any])
