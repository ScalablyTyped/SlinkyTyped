...
import typingsSlinky.xstyledStyledComponents.anon.ReadonlyStyleSheetManager
...
import typingsSlinky.xstyledSystem.mod.AliasKey
import typingsSlinky.xstyledSystem.mod.ResponsiveValue
...
object mod {
  ...
  object default {
    ...
    component: typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.`object`
    ...
    def apply(
      // unfortunately using a conditional type to validate that it can receive a `theme?: Theme`
    // causes tests to fail in TS 3.1
    component: typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.`var`
    ): ThemedStyledFunction[
  ...
  class ThemeProvider protected ()
    extends typingsSlinky.styledComponents.styledComponentsMod.ThemeProvider {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.xs
    - typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.sm
    - typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.md
    - typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.lg
    - typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.xl
  */
  ...
  {[ Key in keyof Props ]:? Props[Key] | @xstyled/styled-components.@xstyled/styled-components.BreakpointObject<Props[Key]>}
    */ typingsSlinky.xstyledStyledComponents.xstyledStyledComponentsStrings.WithBreakpointArgs with TopLevel[js.Any]
}
