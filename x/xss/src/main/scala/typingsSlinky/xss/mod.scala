...
import typingsSlinky.xss.anon.OnIgnoreTag
...
object mod {
  ...
  object global {
    ...
    object XSS {
      ...
      object ICSSFilter {
        ...
        @scala.inline
        def apply(process: String => String): typingsSlinky.xss.mod.global.XSS.ICSSFilter = {
          val __obj = js.Dynamic.literal(process = js.Any.fromFunction1(process))
          __obj.asInstanceOf[typingsSlinky.xss.mod.global.XSS.ICSSFilter]
        }
        
        @scala.inline
        implicit class ICSSFilterMutableBuilder[Self <: typingsSlinky.xss.mod.global.XSS.ICSSFilter] (val x: Self) extends AnyVal {
      ...
      trait IFilterXSSOptions extends StObject {
        ...
        var escapeHtml: js.UndefOr[typingsSlinky.xss.mod.global.XSS.EscapeHandler] = js.native
        
        var onIgnoreTag: js.UndefOr[typingsSlinky.xss.mod.global.XSS.OnTagHandler] = js.native
        
        var onIgnoreTagAttr: js.UndefOr[typingsSlinky.xss.mod.global.XSS.OnTagAttrHandler] = js.native
        
        var onTag: js.UndefOr[typingsSlinky.xss.mod.global.XSS.OnTagHandler] = js.native
        
        var onTagAttr: js.UndefOr[typingsSlinky.xss.mod.global.XSS.OnTagAttrHandler] = js.native
        
        var safeAttrValue: js.UndefOr[typingsSlinky.xss.mod.global.XSS.SafeAttrValueHandler] = js.native
        ...
        var whiteList: js.UndefOr[typingsSlinky.xss.mod.global.XSS.IWhiteList] = js.native
      }
      object IFilterXSSOptions {
        
        @scala.inline
        def apply(): typingsSlinky.xss.mod.global.XSS.IFilterXSSOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.xss.mod.global.XSS.IFilterXSSOptions]
        }
        
        @scala.inline
        implicit class IFilterXSSOptionsMutableBuilder[Self <: typingsSlinky.xss.mod.global.XSS.IFilterXSSOptions] (val x: Self) extends AnyVal {
          ...
          def setSafeAttrValue(
            value: (/* tag */ String, /* name */ String, /* value */ String, /* cssFilter */ typingsSlinky.xss.mod.global.XSS.ICSSFilter) => String
          ...
          @scala.inline
          def setWhiteList(value: typingsSlinky.xss.mod.global.XSS.IWhiteList): Self = StObject.set(x, "whiteList", value.asInstanceOf[js.Any])
      ...
      object IWhiteList {
        ...
        @scala.inline
        def apply(): typingsSlinky.xss.mod.global.XSS.IWhiteList = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsSlinky.xss.mod.global.XSS.IWhiteList]
        }
        
        @scala.inline
        implicit class IWhiteListMutableBuilder[Self <: typingsSlinky.xss.mod.global.XSS.IWhiteList] (val x: Self) extends AnyVal {
      ...
      type SafeAttrValueHandler = js.Function4[
            ...
            /* name */ String, 
            /* value */ String, 
            /* cssFilter */ typingsSlinky.xss.mod.global.XSS.ICSSFilter, 
            String
          ]
    }
  }
  ...
  type EscapeHandler = typingsSlinky.xss.mod.global.XSS.EscapeHandler
  
  type ICSSFilter = typingsSlinky.xss.mod.global.XSS.ICSSFilter
  
  type IFilterXSSOptions = typingsSlinky.xss.mod.global.XSS.IFilterXSSOptions
  
  type IWhiteList = typingsSlinky.xss.mod.global.XSS.IWhiteList
  
  type OnTagAttrHandler = typingsSlinky.xss.mod.global.XSS.OnTagAttrHandler
  
  type OnTagHandler = typingsSlinky.xss.mod.global.XSS.OnTagHandler
  
  type SafeAttrValueHandler = typingsSlinky.xss.mod.global.XSS.SafeAttrValueHandler
}
