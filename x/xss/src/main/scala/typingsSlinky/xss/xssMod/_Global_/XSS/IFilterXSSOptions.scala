...
trait IFilterXSSOptions extends js.Object {
  ...
  var escapeHtml: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.EscapeHandler] = js.undefined
  var onIgnoreTag: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.OnTagHandler] = js.undefined
  var onIgnoreTagAttr: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.OnTagAttrHandler] = js.undefined
  var onTag: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.OnTagHandler] = js.undefined
  var onTagAttr: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.OnTagAttrHandler] = js.undefined
  var safeAttrValue: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.SafeAttrValueHandler] = js.undefined
  ...
  var whiteList: js.UndefOr[typingsSlinky.xss.xssMod._Global_.XSS.IWhiteList] = js.undefined
}
...
object IFilterXSSOptions {
  ...
  def apply(
    ...
    safeAttrValue: (/* tag */ String, /* name */ String, /* value */ String, /* cssFilter */ typingsSlinky.xss.xssMod._Global_.XSS.ICSSFilter) => String = null,
    ...
    whiteList: typingsSlinky.xss.xssMod._Global_.XSS.IWhiteList = null
  ): IFilterXSSOptions = {
