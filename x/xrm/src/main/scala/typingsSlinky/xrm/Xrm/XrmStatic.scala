...
trait XrmStatic extends js.Object {
  /**
    ...
    */
  var Device: typingsSlinky.xrm.Xrm.Device
  /**
    ...
    */
  var Encoding: typingsSlinky.xrm.Xrm.Encoding
  /**
    ...
    */
  var Mobile: typingsSlinky.xrm.Xrm.Mobile
  /** Provides navigation-related methods.
    */
  var Navigation: typingsSlinky.xrm.Xrm.Navigation
  /**
    ...
    */
  var Page: typingsSlinky.xrm.Xrm.Page
  /**
    ...
    */
  var Panel: typingsSlinky.xrm.Xrm.Panel
  /**
    ...
    */
  var Utility: typingsSlinky.xrm.Xrm.Utility
  /**
    ...
    */
  var WebApi: typingsSlinky.xrm.Xrm.WebApi
}
