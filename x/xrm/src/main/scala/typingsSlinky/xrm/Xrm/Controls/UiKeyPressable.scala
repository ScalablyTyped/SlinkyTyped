...
object UiKeyPressable {
  ...
  implicit class UiKeyPressableOps[Self <: UiKeyPressable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddOnKeyPress(value: ContextSensitiveHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addOnKeyPress")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFireOnKeyPress(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fireOnKeyPress")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemoveOnKeyPress(value: ContextSensitiveHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeOnKeyPress")(js.Any.fromFunction1(value))
        ret
    }
  }
