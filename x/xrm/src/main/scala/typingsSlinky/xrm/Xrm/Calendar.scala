...
object Calendar {
  ...
  implicit class CalendarMutableBuilder[Self <: Calendar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxSupportedDateTime(value: js.Date): Self = StObject.set(x, "MaxSupportedDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinSupportedDateTime(value: js.Date): Self = StObject.set(x, "MinSupportedDateTime", value.asInstanceOf[js.Any])
