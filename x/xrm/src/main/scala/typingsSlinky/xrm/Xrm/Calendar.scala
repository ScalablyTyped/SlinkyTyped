...
object Calendar {
  ...
  implicit class CalendarOps[Self <: Calendar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxSupportedDateTime(value: js.Date): Self = this.set("MaxSupportedDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinSupportedDateTime(value: js.Date): Self = this.set("MinSupportedDateTime", value.asInstanceOf[js.Any])
    @scala.inline
