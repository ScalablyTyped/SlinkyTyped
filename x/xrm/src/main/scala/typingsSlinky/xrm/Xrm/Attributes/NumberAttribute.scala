...
object NumberAttribute {
  ...
  implicit class NumberAttributeOps[Self <: NumberAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControls(value: ItemCollection[NumberControl]): Self = {
    ...
    @scala.inline
    def withGetPrecision(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPrecision")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
