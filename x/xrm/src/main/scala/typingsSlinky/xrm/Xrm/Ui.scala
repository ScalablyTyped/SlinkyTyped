...
import typingsSlinky.xrm.Xrm.Controls.FormSelector
import typingsSlinky.xrm.Xrm.Controls.ProcessControl
import typingsSlinky.xrm.Xrm.Controls.QuickFormControl
import typingsSlinky.xrm.Xrm.Controls.Tab
import typingsSlinky.xrm.XrmEnum.FormType
...
trait Ui extends StObject {
  ...
  /**
    ...
    * @remarks This API does not exist with Microsoft Dynamics CRM for tablets.
    */
  var navigation: typingsSlinky.xrm.Xrm.Controls.Navigation = js.native
