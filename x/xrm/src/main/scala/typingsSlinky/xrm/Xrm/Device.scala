...
import typingsSlinky.xrm.Xrm.Device.CaptureFileResponse
import typingsSlinky.xrm.Xrm.Device.CaptureImageOptions
import typingsSlinky.xrm.Xrm.Device.GetCurrentPositionResponse
import typingsSlinky.xrm.Xrm.Device.PickFileOptions
