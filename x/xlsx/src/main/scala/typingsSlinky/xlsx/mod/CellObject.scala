...
object CellObject {
  ...
  implicit class CellObjectMutableBuilder[Self <: CellObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setV(value: String | Double | Boolean | js.Date): Self = StObject.set(x, "v", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVDate(value: js.Date): Self = StObject.set(x, "v", value.asInstanceOf[js.Any])
