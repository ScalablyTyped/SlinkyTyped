...
object CellObject {
  ...
  implicit class CellObjectOps[Self <: CellObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVDate(value: js.Date): Self = this.set("v", value.asInstanceOf[js.Any])
    @scala.inline
    def setV(value: String | Double | Boolean | js.Date): Self = this.set("v", value.asInstanceOf[js.Any])
    @scala.inline
