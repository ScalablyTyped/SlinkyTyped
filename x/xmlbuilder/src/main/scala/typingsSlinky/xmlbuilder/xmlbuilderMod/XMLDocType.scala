...
import typingsSlinky.xmlbuilder.Anon_NData
...
class XMLDocType () extends js.Object {
  ...
  def ent(name: String, value: Anon_NData): XMLDocType = js.native
  /**
  ...
  def entity(name: String, value: Anon_NData): XMLDocType = js.native
  ...
  def not(name: String, value: Anon_PubID): XMLDocType = js.native
  /**
    ...
    * @returns the DOCTYPE node
    */
  def notation(name: String, value: Anon_PubID): XMLDocType = js.native
  /**
  ...
  def pEntity(name: String, value: Anon_PubID): XMLDocType = js.native
  def pent(name: String, value: String): XMLDocType = js.native
  def pent(name: String, value: Anon_PubID): XMLDocType = js.native
  /**
