...
import typingsSlinky.vscodeLanguageserverTypes.vscodeLanguageserverTypesNumbers.`4`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.vscodeLanguageserverTypes.vscodeLanguageserverTypesNumbers.`4`
*/
trait DiagnosticSeverity extends js.Object
@JSImport("vscode-languageserver-types", "DiagnosticSeverity")
@js.native
