...
object ConnectionErrors extends StObject {
  ...
  /* 3 */ val AlreadyListening: typingsSlinky.vscodeJsonrpc.mod.ConnectionErrors.AlreadyListening with Double = js.native
  ...
  /* 1 */ val Closed: typingsSlinky.vscodeJsonrpc.mod.ConnectionErrors.Closed with Double = js.native
  ...
  /* 2 */ val Disposed: typingsSlinky.vscodeJsonrpc.mod.ConnectionErrors.Disposed with Double = js.native
}
