...
object SetTraceParams {
  ...
  @scala.inline
  implicit class SetTraceParamsOps[Self <: SetTraceParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: TraceValues): Self = this.set("value", value.asInstanceOf[js.Any])
  }
}
