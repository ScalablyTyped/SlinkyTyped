...
package object vscodeDashJsonrpcMod {
  ...
  type HandlerResult[R, E] = R | typingsSlinky.vscodeDashJsonrpc.libMessagesMod.ResponseError[E] | (Thenable[R | typingsSlinky.vscodeDashJsonrpc.libMessagesMod.ResponseError[E]])
