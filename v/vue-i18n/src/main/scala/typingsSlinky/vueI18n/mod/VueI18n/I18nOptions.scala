...
import typingsSlinky.vueI18n.mod.IVueI18n
...
object I18nOptions {
  ...
  implicit class I18nOptionsOps[Self <: I18nOptions] (val x: Self) extends AnyVal {
    ...
    def setComponentInstanceCreatedListener(
      value: (/* newVm */ typingsSlinky.vueI18n.mod.VueI18n with IVueI18n, /* rootVm */ typingsSlinky.vueI18n.mod.VueI18n with IVueI18n) => Unit
    ...
    @scala.inline
    def setSilentFallbackWarnRegExp(value: js.RegExp): Self = this.set("silentFallbackWarn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSilentFallbackWarn(value: Boolean | js.RegExp): Self = this.set("silentFallbackWarn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSilentFallbackWarn: Self = this.set("silentFallbackWarn", js.undefined)
    
    @scala.inline
    def setSilentTranslationWarnRegExp(value: js.RegExp): Self = this.set("silentTranslationWarn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSilentTranslationWarn(value: Boolean | js.RegExp): Self = this.set("silentTranslationWarn", value.asInstanceOf[js.Any])
