...
object default {
  ...
  @js.native
  def availabilities: typingsSlinky.vueI18n.mod.VueI18n.IntlAvailability = js.native
  @scala.inline
  def availabilities_=(x: typingsSlinky.vueI18n.mod.VueI18n.IntlAvailability): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("availabilities")(x.asInstanceOf[js.Any])
