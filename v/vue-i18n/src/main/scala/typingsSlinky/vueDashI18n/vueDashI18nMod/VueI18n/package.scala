...
package object VueI18n {
  ...
  type Choice = Double
  type DateTimeFormat = StringDictionary[typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.DateTimeFormatOptions]
  ...
  type DateTimeFormats = StringDictionary[typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.DateTimeFormat]
  type Locale = String
  ...
  */
  ...
  type LocaleMessages = StringDictionary[typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.LocaleMessageObject]
  ...
  type NumberFormat = StringDictionary[typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.NumberFormatOptions]
  /* Rewritten from type alias, can be one of: 
  ...
  */
  ...
  type NumberFormats = StringDictionary[typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.NumberFormat]
  type Path = String
  ...
  type TranslateResult = String | typingsSlinky.vueDashI18n.vueDashI18nMod.VueI18n.LocaleMessages
