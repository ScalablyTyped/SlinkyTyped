package typingsSlinky.vortexDashWebDashClient
...
object dds extends js.Object {
  ...
  class DataCache protected ()
    extends typingsSlinky.vortexDashWebDashClient.DDS.DataCache {
    /**
  ...
  class DataReader protected ()
    extends typingsSlinky.vortexDashWebDashClient.DDS.DataReader {
    /**
    		 ...
    		 */
    def this(runtime: Runtime, topic: typingsSlinky.vortexDashWebDashClient.DDS.Topic, qos: EntityQos) = this()
  }
  
  @js.native
  class DataWriter protected ()
    extends typingsSlinky.vortexDashWebDashClient.DDS.DataWriter {
    /**
  ...
  class Topic protected ()
    extends typingsSlinky.vortexDashWebDashClient.DDS.Topic {
    /**
