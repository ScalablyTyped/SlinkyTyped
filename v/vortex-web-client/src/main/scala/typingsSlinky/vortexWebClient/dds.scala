...
object dds extends js.Object {
  ...
  class DataReader protected ()
    ...
    /**
    		 ...
    		 */
    def this(runtime: Runtime_, topic: typingsSlinky.vortexWebClient.DDS_.Topic, qos: EntityQos) = this()
  }
  ...
  object DataCache
    extends TopLevel[
          Instantiable2[/* depth */ Double, /* cache */ js.Any, typingsSlinky.vortexWebClient.DDS_.DataCache]
        ]
  ...
  object DataReader
    extends TopLevel[
          Instantiable3[
            /* runtime */ Runtime_, 
            /* topic */ typingsSlinky.vortexWebClient.DDS_.Topic, 
            /* qos */ EntityQos, 
            typingsSlinky.vortexWebClient.DDS_.DataReader
          ]
        ]
  ...
  object DataWriter
    extends TopLevel[
          Instantiable3[
            ...
            /* topic */ typingsSlinky.vortexWebClient.DDS_.Topic, 
            /* qos */ EntityQos, 
            typingsSlinky.vortexWebClient.DDS_.DataWriter
          ]
        ]
  ...
  object Topic
    extends TopLevel[
          Instantiable5[
            ...
            typingsSlinky.vortexWebClient.DDS_.Topic
          ]
        ]
