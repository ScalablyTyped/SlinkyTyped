...
object vCard {
  ...
  implicit class vCardOps[Self <: vCard] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnniversary(value: js.Date): Self = this.set("anniversary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBirthday(value: js.Date): Self = this.set("birthday", value.asInstanceOf[js.Any])
