...
object TextDocument extends js.Object {
  def applyEdits(
    document: typingsSlinky.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.TextDocument,
    edits: js.Array[
  ...
  /**
    ...
    */
  def create(uri: String, languageId: String, version: Double, content: String): typingsSlinky.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.TextDocument = js.native
  /**
