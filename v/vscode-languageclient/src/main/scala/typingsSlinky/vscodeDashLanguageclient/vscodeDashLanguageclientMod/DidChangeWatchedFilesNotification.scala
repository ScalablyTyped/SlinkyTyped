...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.DidChangeWatchedFilesRegistrationOptions
...
object DidChangeWatchedFilesNotification extends js.Object {
  val `type`: typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[DidChangeWatchedFilesParams, DidChangeWatchedFilesRegistrationOptions] = js.native
}
