...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.TextDocumentChangeRegistrationOptions
...
object DidChangeTextDocumentNotification extends js.Object {
  val `type`: typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[DidChangeTextDocumentParams, TextDocumentChangeRegistrationOptions] = js.native
}
