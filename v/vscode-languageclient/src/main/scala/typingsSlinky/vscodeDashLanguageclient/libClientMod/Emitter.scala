...
import typingsSlinky.vscodeDashJsonrpc.libEventsMod.EmitterOptions
...
@js.native
class Emitter[T] ()
  extends typingsSlinky.vscodeDashLanguageserverDashProtocol.vscodeDashLanguageserverDashProtocolMod.Emitter[T] {
