...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.ClientCapabilities
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.DocumentSelector
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.InitializeParams
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.ServerCapabilities
...
trait DynamicFeature[T] extends js.Object {
  ...
  /**
    ...
    */
  var messages: typingsSlinky.vscodeDashJsonrpc.libMessagesMod.MessageType | js.Array[typingsSlinky.vscodeDashJsonrpc.libMessagesMod.MessageType] = js.native
  /**
  ...
  /**
    ...
    */
  def register(message: typingsSlinky.vscodeDashJsonrpc.libMessagesMod.MessageType, data: RegistrationData[T]): Unit = js.native
  /**
