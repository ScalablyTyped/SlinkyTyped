...
object Command extends js.Object {
  /**
    ...
    */
  def create(title: String, command: String, args: js.Any*): typingsSlinky.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.Command = js.native
  /**
