...
import typingsSlinky.vscode.vscodeMod.WorkspaceFolder
import typingsSlinky.vscodeDashLanguageclient.Anon_Code2Protocol
...
object LanguageClientOptions {
  ...
  def apply(
    ...
    initializationFailedHandler: /* error */ (typingsSlinky.vscodeDashLanguageserverDashProtocol.vscodeDashLanguageserverDashProtocolMod.ResponseError[
      typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.InitializeError
    ]) | js.Error | js.Any => Boolean = null,
