...
object anon {
  ...
  trait DocumentSelector extends StObject {
    ...
    var documentSelector: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector = js.native
  }
  object DocumentSelector {
    
    @scala.inline
    def apply(documentSelector: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector): DocumentSelector = {
    ...
    implicit class DocumentSelectorMutableBuilder[Self <: DocumentSelector] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDocumentSelector(value: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector): Self = StObject.set(x, "documentSelector", value.asInstanceOf[js.Any])
