...
object DocumentSelector {
  ...
  implicit class DocumentSelectorOps[Self <: DocumentSelector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocumentSelector(value: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector): Self = this.set("documentSelector", value.asInstanceOf[js.Any])
  }
