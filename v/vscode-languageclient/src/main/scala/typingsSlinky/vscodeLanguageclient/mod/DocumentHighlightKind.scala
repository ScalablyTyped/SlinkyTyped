...
object DocumentHighlightKind {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient", "DocumentHighlightKind.Read")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient", "DocumentHighlightKind.Text")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient", "DocumentHighlightKind.Write")
  @js.native
