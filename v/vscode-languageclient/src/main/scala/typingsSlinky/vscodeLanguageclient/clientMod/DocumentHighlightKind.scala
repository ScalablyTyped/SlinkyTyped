...
object DocumentHighlightKind {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "DocumentHighlightKind.Read")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "DocumentHighlightKind.Text")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "DocumentHighlightKind.Write")
  @js.native
