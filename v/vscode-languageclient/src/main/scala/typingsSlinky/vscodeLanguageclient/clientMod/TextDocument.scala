...
object TextDocument {
  ...
  @JSImport("vscode-languageclient/lib/client", "TextDocument.applyEdits")
  @js.native
  def applyEdits(
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "TextDocument.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "TextDocument.is")
  @js.native
