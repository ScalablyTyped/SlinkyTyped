...
object ProvideResolveFeature {
  ...
  @scala.inline
  implicit class ProvideResolveFeatureOps[Self <: ProvideResolveFeature[_, _], /* <: js.Function */ T1, /* <: js.Function */ T2] (val x: Self with (ProvideResolveFeature[T1, T2])) extends AnyVal {
    @scala.inline
