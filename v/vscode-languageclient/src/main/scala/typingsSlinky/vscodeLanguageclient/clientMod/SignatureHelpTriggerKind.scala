...
object SignatureHelpTriggerKind {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "SignatureHelpTriggerKind.ContentChange")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "SignatureHelpTriggerKind.Invoked")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "SignatureHelpTriggerKind.TriggerCharacter")
  @js.native
