...
import typingsSlinky.vscode.mod.FileSystemWatcher
...
object SynchronizeOptions {
  ...
  implicit class SynchronizeOptionsOps[Self <: SynchronizeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigurationSection(value: String | js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configurationSection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutConfigurationSection: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configurationSection")(js.undefined)
        ret
    }
    @scala.inline
    def withFileEvents(value: FileSystemWatcher | js.Array[FileSystemWatcher]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fileEvents")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFileEvents: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fileEvents")(js.undefined)
        ret
    }
  }
