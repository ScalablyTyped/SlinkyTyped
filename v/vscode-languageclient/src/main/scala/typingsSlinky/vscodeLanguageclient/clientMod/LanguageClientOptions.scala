...
trait LanguageClientOptions extends StObject {
  ...
  var documentSelector: js.UndefOr[
    typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector | js.Array[String]
  ] = js.native
...
object LanguageClientOptions {
  ...
  implicit class LanguageClientOptionsMutableBuilder[Self <: LanguageClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocumentSelector(value: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector | js.Array[String]): Self = StObject.set(x, "documentSelector", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDocumentSelectorUndefined: Self = StObject.set(x, "documentSelector", js.undefined)
    
    @scala.inline
    def setDocumentSelectorVarargs(value: (typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentFilter | String)*): Self = StObject.set(x, "documentSelector", js.Array(value :_*))
