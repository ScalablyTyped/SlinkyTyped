...
object LanguageClientOptions {
  ...
  implicit class LanguageClientOptionsOps[Self <: LanguageClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocumentSelectorVarargs(value: (typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentFilter | String)*): Self = this.set("documentSelector", js.Array(value :_*))
    @scala.inline
    def setDocumentSelector(value: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.DocumentSelector | js.Array[String]): Self = this.set("documentSelector", value.asInstanceOf[js.Any])
    @scala.inline
