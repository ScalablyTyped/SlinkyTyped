...
object WorkDoneProgressOptions {
  ...
  @JSImport("vscode-languageclient/lib/client", "WorkDoneProgressOptions.hasWorkDoneProgress")
  @js.native
  def hasWorkDoneProgress(value: js.Any): /* is vscode-languageserver-protocol.anon.WorkDoneProgress */ Boolean = js.native
  
  @JSImport("vscode-languageclient/lib/client", "WorkDoneProgressOptions.is")
  @js.native
