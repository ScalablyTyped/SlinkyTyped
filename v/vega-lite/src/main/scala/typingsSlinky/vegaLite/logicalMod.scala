...
object logicalMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.vegaLite.logicalMod.LogicalNot[T]
    - typingsSlinky.vegaLite.logicalMod.LogicalAnd[T]
    - typingsSlinky.vegaLite.logicalMod.LogicalOr[T]
    - T
  */
  ...
  object _LogicalComposition {
    ...
    @scala.inline
    def LogicalAnd[T](and: js.Array[LogicalComposition[T]]): typingsSlinky.vegaLite.logicalMod.LogicalAnd[T] = {
      val __obj = js.Dynamic.literal(and = and.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaLite.logicalMod.LogicalAnd[T]]
    }
    
    @scala.inline
    def LogicalNot[T](not: LogicalComposition[T]): typingsSlinky.vegaLite.logicalMod.LogicalNot[T] = {
      val __obj = js.Dynamic.literal(not = not.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaLite.logicalMod.LogicalNot[T]]
    }
    
    @scala.inline
    def LogicalOr[T](or: js.Array[LogicalComposition[T]]): typingsSlinky.vegaLite.logicalMod.LogicalOr[T] = {
      val __obj = js.Dynamic.literal(or = or.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaLite.logicalMod.LogicalOr[T]]
    }
  }
}
