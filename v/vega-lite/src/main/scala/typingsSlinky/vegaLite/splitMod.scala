...
object splitMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.vegaLite.vegaLiteStrings.scale
    - typingsSlinky.vegaLite.vegaLiteStrings.axis
    - typingsSlinky.vegaLite.vegaLiteStrings.legend
    - typingsSlinky.vegaLite.vegaLiteStrings._empty
  */
  trait SplitParentProperty extends StObject
  object SplitParentProperty {
    
    @scala.inline
    def _empty: typingsSlinky.vegaLite.vegaLiteStrings._empty = "".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings._empty]
    
    @scala.inline
    def axis: typingsSlinky.vegaLite.vegaLiteStrings.axis = "axis".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.axis]
    
    @scala.inline
    def legend: typingsSlinky.vegaLite.vegaLiteStrings.legend = "legend".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.legend]
    
    @scala.inline
    def scale: typingsSlinky.vegaLite.vegaLiteStrings.scale = "scale".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.scale]
  }
}
