...
import typingsSlinky.vegaTypings.transformMod.TimeUnitTransform
...
object timeunitMod {
  ...
  object TimeUnitNode {
    ...
    @js.native
    def makeFromTransform(parent: DataFlowNode, t: typingsSlinky.vegaLite.transformMod.TimeUnitTransform): TimeUnitNode = js.native
  }
