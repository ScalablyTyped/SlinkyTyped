...
import typingsSlinky.vegaLite.vegaLiteStrings.gradient
...
import typingsSlinky.vegaTypings.configMod.KeepSignal
import typingsSlinky.vegaTypings.configMod.LegendLayout
