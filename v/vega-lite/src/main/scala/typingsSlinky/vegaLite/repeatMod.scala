...
object repeatMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.vegaLite.repeatMod.NonLayerRepeatSpec
    - typingsSlinky.vegaLite.repeatMod.LayerRepeatSpec
  */
  trait RepeatSpec extends StObject
  object RepeatSpec {
    
    @scala.inline
    def LayerRepeatSpec(repeat: LayerRepeatMapping, spec: LayerSpec | UnitSpec): typingsSlinky.vegaLite.repeatMod.LayerRepeatSpec = {
      val __obj = js.Dynamic.literal(repeat = repeat.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaLite.repeatMod.LayerRepeatSpec]
    }
    ...
    def NonLayerRepeatSpec(
      ...
      val __obj = js.Dynamic.literal(repeat = repeat.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaLite.repeatMod.NonLayerRepeatSpec]
    }
  }
}
