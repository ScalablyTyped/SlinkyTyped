...
import typingsSlinky.vegaLite.vegaLiteStrings.ascending
...
import typingsSlinky.vegaLite.vegaLiteStrings.descending
...
trait Header extends StObject {
  ...
  var header: FormatType = js.native
  
  var sort: js.UndefOr[
    (js.Array[Boolean | DateTime | Double | String]) | ascending | descending | EncodingSortField[String]
  ] = js.native
...
object Header {
  ...
  @scala.inline
  def apply(header: FormatType): Header = {
  ...
  implicit class HeaderMutableBuilder[Self <: Header] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeader(value: FormatType): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSort(
      value: (js.Array[Boolean | DateTime | Double | String]) | ascending | descending | EncodingSortField[String]
