...
/* Inlined std.Partial<vega-lite.vega-lite/build/src/vega.schema.VgTitle> */
@js.native
trait PartialVgTitle extends StObject {
  ...
  var encode: js.UndefOr[TitleEncode | typingsSlinky.vegaTypings.encodeMod.Encode[TextEncodeEntry]] = js.native
...
object PartialVgTitle {
  
  @scala.inline
  def apply(): PartialVgTitle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialVgTitle]
  }
  
  @scala.inline
  implicit class PartialVgTitleMutableBuilder[Self <: PartialVgTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncode(value: TitleEncode | typingsSlinky.vegaTypings.encodeMod.Encode[TextEncodeEntry]): Self = StObject.set(x, "encode", value.asInstanceOf[js.Any])
