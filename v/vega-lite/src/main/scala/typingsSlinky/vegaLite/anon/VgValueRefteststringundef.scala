...
trait VgValueRefteststringundef extends StObject {
  ...
  var value: js.UndefOr[typingsSlinky.vegaLite.channeldefMod.Value[Null]] = js.native
}
object VgValueRefteststringundef {
  ...
  implicit class VgValueRefteststringundefMutableBuilder[Self <: VgValueRefteststringundef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: typingsSlinky.vegaLite.channeldefMod.Value[Null]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
