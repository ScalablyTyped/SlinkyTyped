...
trait Arc extends StObject {
  ...
  val arc: typingsSlinky.vegaLite.vegaLiteStrings.arc = js.native
  
  val area: typingsSlinky.vegaLite.vegaLiteStrings.area = js.native
  
  val bar: typingsSlinky.vegaLite.vegaLiteStrings.bar = js.native
  
  val circle: typingsSlinky.vegaLite.vegaLiteStrings.circle = js.native
  
  val geoshape: typingsSlinky.vegaLite.vegaLiteStrings.geoshape = js.native
  
  val image: typingsSlinky.vegaLite.vegaLiteStrings.image = js.native
  
  val line: typingsSlinky.vegaLite.vegaLiteStrings.line = js.native
  
  val point: typingsSlinky.vegaLite.vegaLiteStrings.point = js.native
  
  val rect: typingsSlinky.vegaLite.vegaLiteStrings.rect = js.native
  
  val rule: typingsSlinky.vegaLite.vegaLiteStrings.rule = js.native
  
  val square: typingsSlinky.vegaLite.vegaLiteStrings.square = js.native
  
  val text: typingsSlinky.vegaLite.vegaLiteStrings.text = js.native
  
  val tick: typingsSlinky.vegaLite.vegaLiteStrings.tick = js.native
  
  val trail: typingsSlinky.vegaLite.vegaLiteStrings.trail = js.native
}
object Arc {
