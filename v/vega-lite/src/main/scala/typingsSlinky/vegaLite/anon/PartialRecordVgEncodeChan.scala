...
@js.native
trait PartialRecordVgEncodeChan extends StObject {
...
object PartialRecordVgEncodeChan {
  
  @scala.inline
  def apply(): PartialRecordVgEncodeChan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordVgEncodeChan]
  }
  
  @scala.inline
  implicit class PartialRecordVgEncodeChanMutableBuilder[Self <: PartialRecordVgEncodeChan] (val x: Self) extends AnyVal {
