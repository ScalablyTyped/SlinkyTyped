...
object CornerRadiusBottomLeft {
  ...
  @scala.inline
  def apply(ariaRoleDescription: ValueScaleField, description: SignalRef | ValueString): CornerRadiusBottomLeft = {
  ...
  @scala.inline
  implicit class CornerRadiusBottomLeftMutableBuilder[Self <: CornerRadiusBottomLeft] (val x: Self) extends AnyVal {
