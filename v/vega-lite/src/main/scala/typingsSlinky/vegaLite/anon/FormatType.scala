...
trait FormatType extends StObject {
  ...
  var labelOrient: typingsSlinky.vegaTypings.encodeMod.Orient = js.native
  ...
  var titleOrient: typingsSlinky.vegaTypings.encodeMod.Orient = js.native
...
object FormatType {
  ...
  @scala.inline
  def apply(
    labelOrient: typingsSlinky.vegaTypings.encodeMod.Orient,
    titleOrient: typingsSlinky.vegaTypings.encodeMod.Orient
  ): FormatType = {
  ...
  implicit class FormatTypeMutableBuilder[Self <: FormatType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelOrient(value: typingsSlinky.vegaTypings.encodeMod.Orient): Self = StObject.set(x, "labelOrient", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleOrient(value: typingsSlinky.vegaTypings.encodeMod.Orient): Self = StObject.set(x, "titleOrient", value.asInstanceOf[js.Any])
