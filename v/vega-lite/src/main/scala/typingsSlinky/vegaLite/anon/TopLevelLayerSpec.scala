...
trait TopLevelLayerSpec extends _TopLevelSpec {
  ...
  /**
    ...
    */
  var encoding: js.UndefOr[SharedCompositeEncoding[typingsSlinky.vegaLite.channeldefMod.Field]] = js.native
...
object TopLevelLayerSpec {
  ...
  implicit class TopLevelLayerSpecMutableBuilder[Self <: TopLevelLayerSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncoding(value: SharedCompositeEncoding[typingsSlinky.vegaLite.channeldefMod.Field]): Self = StObject.set(x, "encoding", value.asInstanceOf[js.Any])
