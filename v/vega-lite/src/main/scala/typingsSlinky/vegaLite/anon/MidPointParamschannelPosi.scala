...
trait MidPointParamschannelPosi extends StObject {
  ...
  var channel: typingsSlinky.vegaLite.channelMod.Channel with (PositionChannel | PolarPositionChannel) = js.native
...
object MidPointParamschannelPosi {
  ...
  @scala.inline
  def apply(
    channel: typingsSlinky.vegaLite.channelMod.Channel with (PositionChannel | PolarPositionChannel),
  ...
  implicit class MidPointParamschannelPosiMutableBuilder[Self <: MidPointParamschannelPosi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannel(value: typingsSlinky.vegaLite.channelMod.Channel with (PositionChannel | PolarPositionChannel)): Self = StObject.set(x, "channel", value.asInstanceOf[js.Any])
