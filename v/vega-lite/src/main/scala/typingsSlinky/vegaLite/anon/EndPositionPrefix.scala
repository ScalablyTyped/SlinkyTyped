...
trait EndPositionPrefix[P /* <: PartsMixins[_] */] extends StObject {
  ...
  var extraEncoding: js.UndefOr[typingsSlinky.vegaLite.encodingMod.Encoding[String]] = js.native
...
object EndPositionPrefix {
  ...
  def apply[P /* <: PartsMixins[_] */](
    mark: Mark | (typingsSlinky.vegaLite.srcMarkMod.MarkDef[Mark, ExprRef | SignalRef]),
  ...
  implicit class EndPositionPrefixMutableBuilder[Self <: EndPositionPrefix[_], P /* <: PartsMixins[_] */] (val x: Self with EndPositionPrefix[P]) extends AnyVal {
    ...
    @scala.inline
    def setExtraEncoding(value: typingsSlinky.vegaLite.encodingMod.Encoding[String]): Self = StObject.set(x, "extraEncoding", value.asInstanceOf[js.Any])
