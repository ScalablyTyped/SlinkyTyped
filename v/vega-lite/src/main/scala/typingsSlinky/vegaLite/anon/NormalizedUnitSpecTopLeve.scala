...
trait NormalizedUnitSpecTopLeve extends StObject {
  ...
  /**
    ...
    */
  var encoding: js.UndefOr[typingsSlinky.vegaLite.encodingMod.Encoding[FieldName]] = js.native
  ...
  /**
    ...
    */
  var mark: Mark | (typingsSlinky.vegaLite.srcMarkMod.MarkDef[Mark, ExprRef | SignalRef]) = js.native
...
object NormalizedUnitSpecTopLeve {
  ...
  @scala.inline
  def apply(mark: Mark | (typingsSlinky.vegaLite.srcMarkMod.MarkDef[Mark, ExprRef | SignalRef])): NormalizedUnitSpecTopLeve = {
  ...
  implicit class NormalizedUnitSpecTopLeveMutableBuilder[Self <: NormalizedUnitSpecTopLeve] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncoding(value: typingsSlinky.vegaLite.encodingMod.Encoding[FieldName]): Self = StObject.set(x, "encoding", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMark(value: Mark | (typingsSlinky.vegaLite.srcMarkMod.MarkDef[Mark, ExprRef | SignalRef])): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
