...
/* Inlined vega-lite.vega-lite/build/src/mark.MarkConfig<ES> & vega-lite.vega-lite/build/src/mark.MarkDefMixins<ES> */
@js.native
trait OverlayMarkDef[ES /* <: ExprRef | SignalRef */] extends StObject {
...
object OverlayMarkDef {
  ...
  @scala.inline
  implicit class OverlayMarkDefMutableBuilder[Self <: OverlayMarkDef[_], ES /* <: ExprRef | SignalRef */] (val x: Self with OverlayMarkDef[ES]) extends AnyVal {
