...
import typingsSlinky.vegaLite.anon.Visual
import typingsSlinky.vegaLite.channelMod.SingleDefUnitChannel
import typingsSlinky.vegaLite.timeunitMod.TimeUnitNode
...
object projectMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.vegaLite.vegaLiteStrings.E
    - typingsSlinky.vegaLite.vegaLiteStrings.R
    - typingsSlinky.vegaLite.vegaLiteStrings.`R-RE`
  */
  trait TupleStoreType extends StObject
  object TupleStoreType {
    
    @scala.inline
    def E: typingsSlinky.vegaLite.vegaLiteStrings.E = "E".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.E]
    
    @scala.inline
    def R: typingsSlinky.vegaLite.vegaLiteStrings.R = "R".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.R]
    
    @scala.inline
    def `R-RE`: typingsSlinky.vegaLite.vegaLiteStrings.`R-RE` = "R-RE".asInstanceOf[typingsSlinky.vegaLite.vegaLiteStrings.`R-RE`]
  }
