...
import typingsSlinky.vegaLite.vegaLiteStrings.band
import typingsSlinky.vegaLite.vegaLiteStrings.borders
...
object errorbandMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.vegaLite.vegaLiteStrings.band
    - typingsSlinky.vegaLite.vegaLiteStrings.borders
  */
