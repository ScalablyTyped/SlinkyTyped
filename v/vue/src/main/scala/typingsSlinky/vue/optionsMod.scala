...
import typingsSlinky.vue.anon.Default
...
object optionsMod {
  ...
  {[ K in keyof T ]: (): T[K] | vue.vue/types/options.ComputedOptions<T[K]>}
    */ typingsSlinky.vue.vueStrings.Accessors with TopLevel[js.Any]
  ...
  object ComponentOptions {
    ...
    implicit class ComponentOptionsMutableBuilder[Self <: ComponentOptions[_, _, _, _, _, _], V /* <: Vue */, Data, Methods, Computed, PropsDef, Props] (val x: Self with (ComponentOptions[V, Data, Methods, Computed, PropsDef, Props])) extends AnyVal {
      ...
      @scala.inline
      def setErrorCaptured(value: (/* err */ js.Error, /* vm */ Vue, /* info */ String) => Boolean | Unit): Self = StObject.set(x, "errorCaptured", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setRenderError(value: (/* createElement */ CreateElement, /* err */ js.Error) => VNode): Self = StObject.set(x, "renderError", js.Any.fromFunction2(value))
  ...
  */
  ...
  {[ K in keyof T ]: vue.vue/types/options.PropValidator<T[K]>}
    */ typingsSlinky.vue.vueStrings.RecordPropsDefinition with TopLevel[T]
