...
import typingsSlinky.vue.Anon_Event
import typingsSlinky.vue.typesVnodeMod.VNode
import typingsSlinky.vue.typesVueMod.CreateElement
...
object ComponentOptions {
  ...
  def apply[V /* <: Vue */, Data, Methods, Computed, PropsDef, Props](
    ...
    errorCaptured: (/* err */ js.Error, /* vm */ Vue, /* info */ String) => Boolean | Unit = null,
    ...
    renderError: (/* createElement */ CreateElement, /* err */ js.Error) => VNode = null,
