...
object PropOptions {
  ...
  implicit class PropOptionsOps[Self[t] <: PropOptions[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withDefaultFunction0(value: () => js.UndefOr[T | Null]): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("default")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDefault(value: T | (js.Function0[js.UndefOr[T | Null]])): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: PropType[T]): Self[T] = {
        val ret = this.duplicate
