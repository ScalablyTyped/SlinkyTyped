...
package object optionsMod {
  ...
  {[ K in keyof T ]: (): T[K] | vue.vue/types/options.ComputedOptions<T[K]>}
    */ typingsSlinky.vue.vueStrings.Accessors with js.Any
  ...
  type AsyncComponentFactory[Data, Methods, Computed, Props] = js.Function0[typingsSlinky.vue.AnonComponent[Data, Methods, Computed, Props]]
  ...
  type InjectOptions = (org.scalablytyped.runtime.StringDictionary[typingsSlinky.vue.optionsMod.InjectKey | typingsSlinky.vue.AnonDefault]) | js.Array[java.lang.String]
  /* Rewritten from type alias, can be one of: 
    - js.Function0[T]
    - typingsSlinky.vue.AnonInstantiable[T]
    - typingsSlinky.vue.AnonInstantiableFunction
  */
  ...
  {[ K in keyof T ]: vue.vue/types/options.PropValidator<T[K]>}
    */ typingsSlinky.vue.vueStrings.RecordPropsDefinition with T
