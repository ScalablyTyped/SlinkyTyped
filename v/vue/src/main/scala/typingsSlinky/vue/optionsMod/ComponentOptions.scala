...
object ComponentOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.vue.vueMod.Vue */ V, Data, Methods, Computed, PropsDef, Props](): ComponentOptions[V, Data, Methods, Computed, PropsDef, Props] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentOptions[V, Data, Methods, Computed, PropsDef, Props]]
  }
  @scala.inline
  implicit class ComponentOptionsOps[Self <: ComponentOptions[_, _, _, _, _, _], /* <: typingsSlinky.vue.vueMod.Vue */ V, Data, Methods, Computed, PropsDef, Props] (val x: Self with (ComponentOptions[V, Data, Methods, Computed, PropsDef, Props])) extends AnyVal {
    @scala.inline
