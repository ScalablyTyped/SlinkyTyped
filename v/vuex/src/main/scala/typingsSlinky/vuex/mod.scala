...
object mod {
  ...
  object default {
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.ActionMethod}
      */ typingsSlinky.vuex.vuexStrings.mapActions with TopLevel[js.Any] = js.native
    @JSImport("vuex", "default.mapActions")
    @js.native
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.InlineMethod<Map[K]>}
      */ typingsSlinky.vuex.vuexStrings.mapActions with TopLevel[Map] = js.native
    @JSImport("vuex", "default.mapActions")
    @js.native
    def mapActions_Map_RecordStringThisFunction2CustomVueDispatchWildcardWildcard[Map /* <: Record[
        String, 
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.Computed}
      */ typingsSlinky.vuex.vuexStrings.mapGetters with TopLevel[js.Any] = js.native
    @JSImport("vuex", "default.mapGetters")
    @js.native
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.InlineMethod<Map[K]>}
      */ typingsSlinky.vuex.vuexStrings.mapMutations with TopLevel[Map] = js.native
    @JSImport("vuex", "default.mapMutations")
    @js.native
    ...
    {[ K in Key ]: vuex.vuex/types/helpers.MutationMethod}
      */ typingsSlinky.vuex.vuexStrings.mapMutations with TopLevel[js.Any] = js.native
    @JSImport("vuex", "default.mapMutations")
    @js.native
    def mapMutations[Map /* <: Record[
        String, 
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.Computed}
      */ typingsSlinky.vuex.vuexStrings.mapState with TopLevel[js.Any] = js.native
    @JSImport("vuex", "default.mapState")
    @js.native
    ...
    {[ K in keyof Map ]: vuex.vuex/types/helpers.InlineComputed<Map[K]>}
      */ typingsSlinky.vuex.vuexStrings.mapState with TopLevel[Map] = js.native
    @JSImport("vuex", "default.mapState")
    @js.native
  ...
  object ActionSubscribersObject {
    ...
    implicit class ActionSubscribersObjectMutableBuilder[Self <: ActionSubscribersObject[_, _], P, S] (val x: Self with (ActionSubscribersObject[P, S])) extends AnyVal {
      ...
      @scala.inline
      def setError(value: (P, S, /* error */ js.Error) => js.Any): Self = StObject.set(x, "error", js.Any.fromFunction3(value))
