...
object vuexStrings {
  ...
  @js.native
  sealed trait MapperForAction extends StObject
  @scala.inline
  def MapperForAction: MapperForAction = "MapperForAction".asInstanceOf[MapperForAction]
  
  @js.native
  sealed trait MapperForActionWithNamespace extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait MapperForMutation extends StObject
  @scala.inline
  def MapperForMutation: MapperForMutation = "MapperForMutation".asInstanceOf[MapperForMutation]
  
  @js.native
  sealed trait MapperForMutationWithNamespace extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait MapperForState extends StObject
  @scala.inline
  def MapperForState: MapperForState = "MapperForState".asInstanceOf[MapperForState]
  
  @js.native
  sealed trait MapperForStateWithNamespace extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait MapperWithNamespace extends StObject
  @scala.inline
  def MapperWithNamespace: MapperWithNamespace = "MapperWithNamespace".asInstanceOf[MapperWithNamespace]
  
  @js.native
  sealed trait NamespacedMappers extends StObject
  @scala.inline
  def NamespacedMappers: NamespacedMappers = "NamespacedMappers".asInstanceOf[NamespacedMappers]
  
  @js.native
  sealed trait mapActions extends StObject
  @scala.inline
  def mapActions: mapActions = "mapActions".asInstanceOf[mapActions]
  
  @js.native
  sealed trait mapGetters extends StObject
  @scala.inline
  def mapGetters: mapGetters = "mapGetters".asInstanceOf[mapGetters]
  
  @js.native
  sealed trait mapMutations extends StObject
  @scala.inline
  def mapMutations: mapMutations = "mapMutations".asInstanceOf[mapMutations]
  
  @js.native
  sealed trait mapState extends StObject
  @scala.inline
  def mapState: mapState = "mapState".asInstanceOf[mapState]
}
