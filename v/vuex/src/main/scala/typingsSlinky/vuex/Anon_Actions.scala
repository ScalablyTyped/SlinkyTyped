...
import typingsSlinky.vuex.vuexMod.ActionTree
import typingsSlinky.vuex.vuexMod.GetterTree
import typingsSlinky.vuex.vuexMod.ModuleTree
import typingsSlinky.vuex.vuexMod.MutationTree
