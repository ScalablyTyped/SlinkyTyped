...
object DocGenOptions {
  ...
  implicit class DocGenOptionsOps[Self <: DocGenOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddTemplateHandlersVarargs(value: typingsSlinky.vueDocgenApi.parseTemplateMod.Handler*): Self = this.set("addTemplateHandlers", js.Array(value :_*))
    
    @scala.inline
    def setAddTemplateHandlers(value: js.Array[typingsSlinky.vueDocgenApi.parseTemplateMod.Handler]): Self = this.set("addTemplateHandlers", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTemplateHandlersVarargs(value: typingsSlinky.vueDocgenApi.parseTemplateMod.Handler*): Self = this.set("templateHandlers", js.Array(value :_*))
    
    @scala.inline
    def setTemplateHandlers(value: js.Array[typingsSlinky.vueDocgenApi.parseTemplateMod.Handler]): Self = this.set("templateHandlers", value.asInstanceOf[js.Any])
