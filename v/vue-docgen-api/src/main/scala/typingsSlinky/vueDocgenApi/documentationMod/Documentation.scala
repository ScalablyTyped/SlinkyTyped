package typingsSlinky.vueDocgenApi.documentationMod
...
object Documentation {
  ...
  implicit class DocumentationOps[Self <: Documentation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentFullfilePath(value: String): Self = this.set("componentFullfilePath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataMap(value: js.Any): Self = this.set("dataMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDocsBlocks(value: js.Any): Self = this.set("docsBlocks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEventsMap(value: js.Any): Self = this.set("eventsMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGet(value: String => js.Any): Self = this.set("get", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetDescriptor(value: js.Any): Self = this.set("getDescriptor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGetEventDescriptor(value: String => EventDescriptor): Self = this.set("getEventDescriptor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetMethodDescriptor(value: String => MethodDescriptor): Self = this.set("getMethodDescriptor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetObjectFromDescriptor(value: js.Any): Self = this.set("getObjectFromDescriptor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGetPropDescriptor(value: String => PropDescriptor): Self = this.set("getPropDescriptor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetSlotDescriptor(value: String => SlotDescriptor): Self = this.set("getSlotDescriptor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMethodsMap(value: js.Any): Self = this.set("methodsMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginExtendsMixin(value: js.Any): Self = this.set("originExtendsMixin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPropsMap(value: js.Any): Self = this.set("propsMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSet(value: (String, js.Any) => Unit): Self = this.set("set", js.Any.fromFunction2(value))
    
    @scala.inline
    def setSetDocsBlocks(value: js.Array[String] => Unit): Self = this.set("setDocsBlocks", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetOrigin(value: Descriptor => Unit): Self = this.set("setOrigin", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSlotsMap(value: js.Any): Self = this.set("slotsMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setToObject(value: () => ComponentDoc): Self = this.set("toObject", js.Any.fromFunction0(value))
  }
}
