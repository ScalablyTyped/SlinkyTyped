...
package object victoryMod {
  ...
  import typingsSlinky.victory.Anon_XYNumber
  ...
  */
  ...
  /**
    * Data domain type
    */
  type DomainTuple = js.Tuple2[js.Date | Double, js.Date | Double]
  ...
  {[ K in keyof react.react.CSSProperties ]: victory.victory.StringOrNumberOrCallback}
    */ typingsSlinky.victory.victoryStrings.VictoryStyleObject with js.Any
}
