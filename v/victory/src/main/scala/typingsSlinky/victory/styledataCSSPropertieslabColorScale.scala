...
trait styledataCSSPropertieslabColorScale extends js.Object {
  ...
  var style: js.UndefOr[AnonFlyout] = js.native
  var width: Double = js.native
}

object styledataCSSPropertieslabColorScale {
  @scala.inline
  def apply(colorScale: js.Array[String], height: Double, width: Double): styledataCSSPropertieslabColorScale = {
  ...
  @scala.inline
  implicit class styledataCSSPropertieslabColorScaleOps[Self <: styledataCSSPropertieslabColorScale] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStyle(value: AnonFlyout): Self = {
        val ret = this.duplicate
