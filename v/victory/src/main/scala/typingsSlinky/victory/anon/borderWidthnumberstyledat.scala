...
object borderWidthnumberstyledat {
  @scala.inline
  def apply(colorScale: js.Array[String], height: Double, width: Double): borderWidthnumberstyledat = {
  ...
  @scala.inline
  implicit class borderWidthnumberstyledatOps[Self <: borderWidthnumberstyledat] (val x: Self) extends AnyVal {
    @scala.inline
