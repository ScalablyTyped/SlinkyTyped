...
object `1` {
  ...
  implicit class `1Ops`[Self <: `1`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setX(value: ScalePropType | D3Scale): Self = this.set("x", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteX: Self = this.set("x", js.undefined)
    @scala.inline
    def setY(value: ScalePropType | D3Scale): Self = this.set("y", value.asInstanceOf[js.Any])
    @scala.inline
