...
@js.native
trait styledataCSSPropertiesund extends js.Object {
...
object styledataCSSPropertiesund {
  ...
  @scala.inline
  def apply(colorScale: js.Array[String], height: Double, width: Double): styledataCSSPropertiesund = {
  ...
  @scala.inline
  implicit class styledataCSSPropertiesundOps[Self <: styledataCSSPropertiesund] (val x: Self) extends AnyVal {
