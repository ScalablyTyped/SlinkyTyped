...
@js.native
trait styleaxisCSSPropertiesund extends js.Object {
  var colorScale: js.Array[String] = js.native
  var height: Double = js.native
  var padding: js.UndefOr[Double] = js.native
  var style: js.UndefOr[Axis] = js.native
...
object styleaxisCSSPropertiesund {
  ...
  @scala.inline
  implicit class styleaxisCSSPropertiesundOps[Self <: styleaxisCSSPropertiesund] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStyle(value: Axis): Self = this.set("style", value.asInstanceOf[js.Any])
    @scala.inline
