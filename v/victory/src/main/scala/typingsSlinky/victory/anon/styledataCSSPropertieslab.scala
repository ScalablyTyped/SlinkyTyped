...
object styledataCSSPropertieslab {
  @scala.inline
  def apply(colorScale: js.Array[String], height: Double, width: Double): styledataCSSPropertieslab = {
  ...
  @scala.inline
  implicit class styledataCSSPropertieslabOps[Self <: styledataCSSPropertieslab] (val x: Self) extends AnyVal {
    @scala.inline
