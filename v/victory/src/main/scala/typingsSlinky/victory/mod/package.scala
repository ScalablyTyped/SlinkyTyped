...
package object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.victory.AnonXArray
    - typingsSlinky.victory.AnonYArray
    - typingsSlinky.victory.AnonXArrayYArray
  */
  ...
  */
  ...
  /**
    * Domain padding
    */
  type DomainPaddingPropType = scala.Double | typingsSlinky.victory.Anon0
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.victory.mod.DomainTuple
    - typingsSlinky.victory.AnonXDomainTuple
    - typingsSlinky.victory.AnonYDomainTuple
  */
