...
import typingsSlinky.victory.victoryMod.VictoryStackProps
...
object VictoryStack
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.victory.victoryMod.VictoryStack] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.victory.victoryMod.VictoryStack] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.victory.victoryMod.VictoryStack] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.victory.victoryMod.VictoryStack](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = VictoryStackProps
}
