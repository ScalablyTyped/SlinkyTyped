...
object mod {
  ...
  */
  ...
  object Sources {
    ...
    @scala.inline
    def OriginalSource(originalSource: String, source: String, sourceMap: Sourcemap): typingsSlinky.v8ToIstanbul.anon.OriginalSource = {
      ...
      __obj.asInstanceOf[typingsSlinky.v8ToIstanbul.anon.OriginalSource]
    }
    
    @scala.inline
    def Source(source: String): typingsSlinky.v8ToIstanbul.anon.Source = {
      val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.v8ToIstanbul.anon.Source]
    }
  }
