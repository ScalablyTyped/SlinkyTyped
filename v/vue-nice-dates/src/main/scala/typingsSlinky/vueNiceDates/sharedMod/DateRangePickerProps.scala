package typingsSlinky.vueNiceDates.sharedMod
...
trait DateRangePickerProps extends js.Object {
  ...
  var validator: StringDictionary[js.Function1[/* date */ js.Date, Boolean]] = js.native
}
object DateRangePickerProps {
  ...
  implicit class DateRangePickerPropsOps[Self <: DateRangePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidator(value: StringDictionary[js.Function1[/* date */ js.Date, Boolean]]): Self = this.set("validator", value.asInstanceOf[js.Any])
