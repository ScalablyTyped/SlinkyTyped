...
object HoveredDate {
  ...
  implicit class HoveredDateOps[Self <: HoveredDate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHoveredDate(value: js.Date): Self = this.set("hoveredDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHoveredDateNull: Self = this.set("hoveredDate", null)
    
    @scala.inline
    def setReceivedEndDateDate(value: js.Date): Self = this.set("receivedEndDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReceivedEndDate(value: String | js.Date): Self = this.set("receivedEndDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReceivedEndDateNull: Self = this.set("receivedEndDate", null)
    
    @scala.inline
    def setReceivedStartDateDate(value: js.Date): Self = this.set("receivedStartDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReceivedStartDate(value: String | js.Date): Self = this.set("receivedStartDate", value.asInstanceOf[js.Any])
