...
object GetGridType {
  ...
  implicit class GetGridTypeOps[Self <: GetGridType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandleMouseEnterDate(value: js.Date => Unit): Self = this.set("handleMouseEnterDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def setHandleMouseLeaveDates(value: () => Unit): Self = this.set("handleMouseLeaveDates", js.Any.fromFunction0(value))
    
    @scala.inline
    def setHandleNavigate(value: js.Date => Unit): Self = this.set("handleNavigate", js.Any.fromFunction1(value))
  }
}
