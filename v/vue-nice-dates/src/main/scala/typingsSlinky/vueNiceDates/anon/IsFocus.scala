...
trait IsFocus extends StObject {
  ...
  def date(newValue: js.Date): Unit = js.native
...
object IsFocus {
  ...
  @scala.inline
  def apply(date: js.Date => Unit, isFocus: Boolean => Unit): IsFocus = {
  ...
  implicit class IsFocusMutableBuilder[Self <: IsFocus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDate(value: js.Date => Unit): Self = StObject.set(x, "date", js.Any.fromFunction1(value))
