...
object IsEmailOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(allow_ip_domain)) __obj.updateDynamic("allow_ip_domain")(allow_ip_domain.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(domain_specific_validation)) __obj.updateDynamic("domain_specific_validation")(domain_specific_validation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignore_max_length)) __obj.updateDynamic("ignore_max_length")(ignore_max_length.get.asInstanceOf[js.Any])
    if (!js.isUndefined(require_display_name)) __obj.updateDynamic("require_display_name")(require_display_name.get.asInstanceOf[js.Any])
