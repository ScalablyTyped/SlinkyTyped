...
object IsURLOptions {
  ...
  implicit class IsURLOptionsMutableBuilder[Self <: IsURLOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHost_blacklist(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "host_blacklist", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHost_blacklistUndefined: Self = StObject.set(x, "host_blacklist", js.undefined)
    
    @scala.inline
    def setHost_blacklistVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "host_blacklist", js.Array(value :_*))
    
    @scala.inline
    def setHost_whitelist(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "host_whitelist", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHost_whitelistUndefined: Self = StObject.set(x, "host_whitelist", js.undefined)
    
    @scala.inline
    def setHost_whitelistVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "host_whitelist", js.Array(value :_*))
