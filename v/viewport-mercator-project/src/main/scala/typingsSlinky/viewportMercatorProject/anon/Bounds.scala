...
trait Bounds extends js.Object {
  ...
  var bounds: typingsSlinky.viewportMercatorProject.mod.Bounds = js.native
...
object Bounds {
  ...
  @scala.inline
  def apply(bounds: typingsSlinky.viewportMercatorProject.mod.Bounds, height: Double, width: Double): Bounds = {
  ...
  implicit class BoundsOps[Self <: Bounds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBounds(value: typingsSlinky.viewportMercatorProject.mod.Bounds): Self = this.set("bounds", value.asInstanceOf[js.Any])
