...
package object viewportDashMercatorDashProjectMod {
  import typingsSlinky.viewportDashMercatorDashProject.Anon_Bottom
  import typingsSlinky.viewportDashMercatorDashProject.Anon_Scale
  import typingsSlinky.viewportDashMercatorDashProject.Anon_Zoom
