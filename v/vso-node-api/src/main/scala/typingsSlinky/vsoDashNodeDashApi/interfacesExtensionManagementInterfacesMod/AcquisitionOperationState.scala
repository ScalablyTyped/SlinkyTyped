...
object AcquisitionOperationState extends js.Object {
  ...
  /* 1 */ val Allow: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.AcquisitionOperationState.Allow with Double = js.native
  /* 3 */ val Completed: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.AcquisitionOperationState.Completed with Double = js.native
  /* 0 */ val Disallow: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.AcquisitionOperationState.Disallow with Double = js.native
  @JSBracketAccess
