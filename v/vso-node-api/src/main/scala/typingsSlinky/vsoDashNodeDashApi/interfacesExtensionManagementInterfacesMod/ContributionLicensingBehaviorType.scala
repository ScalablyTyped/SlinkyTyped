...
object ContributionLicensingBehaviorType extends js.Object {
  ...
  /* 2 */ val AlwaysInclude: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.AlwaysInclude with Double = js.native
  /* 0 */ val OnlyIfLicensed: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfLicensed with Double = js.native
  /* 1 */ val OnlyIfUnlicensed: typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfUnlicensed with Double = js.native
  @JSBracketAccess
