...
object SourceProviderAvailability extends js.Object {
  ...
  /* 3 */ val All: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.SourceProviderAvailability.All with Double = js.native
  /* 1 */ val Hosted: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.SourceProviderAvailability.Hosted with Double = js.native
  /* 2 */ val OnPremises: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.SourceProviderAvailability.OnPremises with Double = js.native
  @JSBracketAccess
