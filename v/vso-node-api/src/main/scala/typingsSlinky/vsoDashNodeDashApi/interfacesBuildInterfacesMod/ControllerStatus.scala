...
object ControllerStatus extends js.Object {
  ...
  /* 1 */ val Available: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.ControllerStatus.Available with Double = js.native
  /* 2 */ val Offline: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.ControllerStatus.Offline with Double = js.native
  /* 0 */ val Unavailable: typingsSlinky.vsoDashNodeDashApi.interfacesBuildInterfacesMod.ControllerStatus.Unavailable with Double = js.native
  @JSBracketAccess
