...
object AuditAction extends js.Object {
  ...
  /* 1 */ val Add: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.AuditAction.Add with Double = js.native
  /* 3 */ val Delete: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.AuditAction.Delete with Double = js.native
  /* 2 */ val Update: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.AuditAction.Update with Double = js.native
  @JSBracketAccess
