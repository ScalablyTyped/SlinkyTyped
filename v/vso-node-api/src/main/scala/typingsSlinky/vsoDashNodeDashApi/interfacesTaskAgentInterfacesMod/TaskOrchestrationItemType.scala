...
object TaskOrchestrationItemType extends js.Object {
  ...
  /* 0 */ val Container: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.TaskOrchestrationItemType.Container with Double = js.native
  /* 1 */ val Job: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.TaskOrchestrationItemType.Job with Double = js.native
  @JSBracketAccess
