...
object VariableGroupActionFilter extends js.Object {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.VariableGroupActionFilter.Manage with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.VariableGroupActionFilter.None with Double = js.native
  /* 16 */ val Use: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.VariableGroupActionFilter.Use with Double = js.native
  @JSBracketAccess
