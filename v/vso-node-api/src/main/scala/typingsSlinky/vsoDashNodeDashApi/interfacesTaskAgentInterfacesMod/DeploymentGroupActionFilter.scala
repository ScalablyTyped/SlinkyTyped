...
object DeploymentGroupActionFilter extends js.Object {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.DeploymentGroupActionFilter.Manage with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.DeploymentGroupActionFilter.None with Double = js.native
  /* 16 */ val Use: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.DeploymentGroupActionFilter.Use with Double = js.native
  @JSBracketAccess
