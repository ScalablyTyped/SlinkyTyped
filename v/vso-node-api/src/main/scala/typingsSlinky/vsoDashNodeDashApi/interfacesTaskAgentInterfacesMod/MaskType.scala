...
object MaskType extends js.Object {
  ...
  /* 2 */ val Regex: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.MaskType.Regex with Double = js.native
  /* 1 */ val Variable: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.MaskType.Variable with Double = js.native
  @JSBracketAccess
