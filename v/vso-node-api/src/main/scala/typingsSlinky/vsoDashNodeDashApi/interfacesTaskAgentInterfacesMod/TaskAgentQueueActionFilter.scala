...
object TaskAgentQueueActionFilter extends js.Object {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.TaskAgentQueueActionFilter.Manage with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.TaskAgentQueueActionFilter.None with Double = js.native
  /* 16 */ val Use: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.TaskAgentQueueActionFilter.Use with Double = js.native
  @JSBracketAccess
