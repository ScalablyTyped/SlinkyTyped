...
object PlanGroupStatusFilter extends js.Object {
  ...
  /* 3 */ val All: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.PlanGroupStatusFilter.All with Double = js.native
  /* 2 */ val Queued: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.PlanGroupStatusFilter.Queued with Double = js.native
  /* 1 */ val Running: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.PlanGroupStatusFilter.Running with Double = js.native
  @JSBracketAccess
