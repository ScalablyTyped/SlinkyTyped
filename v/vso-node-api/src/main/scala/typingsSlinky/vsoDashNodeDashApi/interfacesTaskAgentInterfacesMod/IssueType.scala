...
object IssueType extends js.Object {
  ...
  /* 1 */ val Error: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.IssueType.Error with Double = js.native
  /* 2 */ val Warning: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.IssueType.Warning with Double = js.native
  @JSBracketAccess
