...
object DeploymentGroupExpands extends js.Object {
  ...
  /* 2 */ val Machines: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.DeploymentGroupExpands.Machines with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesTaskAgentInterfacesMod.DeploymentGroupExpands.None with Double = js.native
  @JSBracketAccess
