...
object WorkItemTypeClass extends js.Object {
  ...
  /* 2 */ val Custom: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeClass.Custom with Double = js.native
  /* 1 */ val Derived: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeClass.Derived with Double = js.native
  /* 0 */ val System: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeClass.System with Double = js.native
  @JSBracketAccess
