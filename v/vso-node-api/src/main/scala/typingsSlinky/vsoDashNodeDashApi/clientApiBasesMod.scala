...
import typingsSlinky.typedDashRestDashClient.httpClientMod.HttpClient
...
object clientApiBasesMod extends js.Object {
  ...
  class ClientApiBase protected () extends js.Object {
    ...
    def createRequestOptions(`type`: String): typingsSlinky.typedDashRestDashClient.restClientMod.IRequestOptions = js.native
    def createRequestOptions(`type`: String, apiVersion: String): typingsSlinky.typedDashRestDashClient.restClientMod.IRequestOptions = js.native
