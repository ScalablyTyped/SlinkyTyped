...
object AcquisitionOperationState extends js.Object {
  ...
  /* 1 */ val Allow: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Allow with Double = js.native
  /* 3 */ val Completed: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Completed with Double = js.native
  /* 0 */ val Disallow: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Disallow with Double = js.native
  @JSBracketAccess
