...
object ConcernCategory extends js.Object {
  ...
  /* 2 */ val Abusive: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.ConcernCategory.Abusive with Double = js.native
  /* 1 */ val General: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.ConcernCategory.General with Double = js.native
  /* 4 */ val Spam: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.ConcernCategory.Spam with Double = js.native
  @JSBracketAccess
