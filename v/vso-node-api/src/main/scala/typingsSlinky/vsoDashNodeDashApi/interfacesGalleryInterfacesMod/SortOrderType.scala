...
object SortOrderType extends js.Object {
  ...
  /* 1 */ val Ascending: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.SortOrderType.Ascending with Double = js.native
  /* 0 */ val Default: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.SortOrderType.Default with Double = js.native
  /* 2 */ val Descending: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.SortOrderType.Descending with Double = js.native
  @JSBracketAccess
