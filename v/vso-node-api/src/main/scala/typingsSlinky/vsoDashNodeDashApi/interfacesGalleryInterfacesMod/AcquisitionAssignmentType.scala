...
object AcquisitionAssignmentType extends js.Object {
  ...
  /* 2 */ val All: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.All with Double = js.native
  /* 1 */ val Me: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.Me with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.None with Double = js.native
  @JSBracketAccess
