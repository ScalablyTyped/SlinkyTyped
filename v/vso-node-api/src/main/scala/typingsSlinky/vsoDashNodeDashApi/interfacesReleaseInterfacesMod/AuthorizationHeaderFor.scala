...
object AuthorizationHeaderFor extends js.Object {
  ...
  /* 1 */ val OnBehalfOf: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.AuthorizationHeaderFor.OnBehalfOf with Double = js.native
  /* 0 */ val RevalidateApproverIdentity: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.AuthorizationHeaderFor.RevalidateApproverIdentity with Double = js.native
  @JSBracketAccess
