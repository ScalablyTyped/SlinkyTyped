...
object DeploymentAuthorizationOwner extends js.Object {
  ...
  /* 0 */ val Automatic: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.DeploymentAuthorizationOwner.Automatic with Double = js.native
  /* 1 */ val DeploymentSubmitter: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.DeploymentAuthorizationOwner.DeploymentSubmitter with Double = js.native
  /* 2 */ val FirstPreDeploymentApprover: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.DeploymentAuthorizationOwner.FirstPreDeploymentApprover with Double = js.native
  @JSBracketAccess
