...
object ConditionType extends js.Object {
  ...
  /* 4 */ val Artifact: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.ConditionType.Artifact with Double = js.native
  /* 2 */ val EnvironmentState: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.ConditionType.EnvironmentState with Double = js.native
  /* 1 */ val Event: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.ConditionType.Event with Double = js.native
  /* 0 */ val Undefined: typingsSlinky.vsoDashNodeDashApi.interfacesReleaseInterfacesMod.ConditionType.Undefined with Double = js.native
  @JSBracketAccess
