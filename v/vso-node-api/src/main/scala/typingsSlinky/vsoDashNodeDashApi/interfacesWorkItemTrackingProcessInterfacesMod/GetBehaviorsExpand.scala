...
object GetBehaviorsExpand extends js.Object {
  ...
  /* 1 */ val Fields: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingProcessInterfacesMod.GetBehaviorsExpand.Fields with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingProcessInterfacesMod.GetBehaviorsExpand.None with Double = js.native
  @JSBracketAccess
