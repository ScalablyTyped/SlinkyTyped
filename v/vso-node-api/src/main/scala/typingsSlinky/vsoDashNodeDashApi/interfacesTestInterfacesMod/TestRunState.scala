...
object TestRunState extends js.Object {
  ...
  /* 4 */ val Aborted: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.Aborted with Double = js.native
  /* 3 */ val Completed: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.Completed with Double = js.native
  /* 2 */ val InProgress: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.InProgress with Double = js.native
  /* 6 */ val NeedsInvestigation: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.NeedsInvestigation with Double = js.native
  /* 1 */ val NotStarted: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.NotStarted with Double = js.native
  /* 0 */ val Unspecified: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.Unspecified with Double = js.native
  /* 5 */ val Waiting: typingsSlinky.vsoDashNodeDashApi.interfacesTestInterfacesMod.TestRunState.Waiting with Double = js.native
  @JSBracketAccess
