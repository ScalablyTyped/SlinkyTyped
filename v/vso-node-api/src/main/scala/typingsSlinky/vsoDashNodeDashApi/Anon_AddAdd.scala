...
trait Anon_AddAdd extends js.Object {
  var addAdd: Double
  var addRename: Double
  var deleteEdit: Double
  var deleteRename: Double
  var directoryChild: Double
  var directoryFile: Double
  var editDelete: Double
  var editEdit: Double
  var fileDirectory: Double
  var none: Double
  var rename1to2: Double
  var rename2to1: Double
  var renameAdd: Double
  var renameDelete: Double
  var renameRename: Double
}
