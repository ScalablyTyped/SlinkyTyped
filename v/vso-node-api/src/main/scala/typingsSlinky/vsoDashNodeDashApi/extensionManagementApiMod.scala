...
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.AcquisitionOptions
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionAcquisitionRequest
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionAuthorization
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionDataCollection
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionDataCollectionQuery
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionRequestState
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.ExtensionState
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.InstalledExtension
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.InstalledExtensionQuery
import typingsSlinky.vsoDashNodeDashApi.interfacesExtensionManagementInterfacesMod.RequestedExtension
import typingsSlinky.vsoDashNodeDashApi.interfacesGalleryInterfacesMod.UserExtensionPolicy
