...
object WidgetScope extends js.Object {
  ...
  /* 0 */ val Collection_User: typingsSlinky.vsoDashNodeDashApi.interfacesDashboardInterfacesMod.WidgetScope.Collection_User with Double = js.native
  /* 1 */ val Project_Team: typingsSlinky.vsoDashNodeDashApi.interfacesDashboardInterfacesMod.WidgetScope.Project_Team with Double = js.native
  @JSBracketAccess
