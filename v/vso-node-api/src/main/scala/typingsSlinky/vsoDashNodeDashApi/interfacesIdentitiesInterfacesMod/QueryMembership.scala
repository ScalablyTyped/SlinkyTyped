...
object QueryMembership extends js.Object {
  ...
  /* 1 */ val Direct: typingsSlinky.vsoDashNodeDashApi.interfacesIdentitiesInterfacesMod.QueryMembership.Direct with Double = js.native
  /* 2 */ val Expanded: typingsSlinky.vsoDashNodeDashApi.interfacesIdentitiesInterfacesMod.QueryMembership.Expanded with Double = js.native
  /* 4 */ val ExpandedDown: typingsSlinky.vsoDashNodeDashApi.interfacesIdentitiesInterfacesMod.QueryMembership.ExpandedDown with Double = js.native
  /* 3 */ val ExpandedUp: typingsSlinky.vsoDashNodeDashApi.interfacesIdentitiesInterfacesMod.QueryMembership.ExpandedUp with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesIdentitiesInterfacesMod.QueryMembership.None with Double = js.native
  @JSBracketAccess
