...
object PullRequestAsyncStatus extends js.Object {
  ...
  /* 2 */ val Conflicts: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.Conflicts with Double = js.native
  /* 5 */ val Failure: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.Failure with Double = js.native
  /* 0 */ val NotSet: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.NotSet with Double = js.native
  /* 1 */ val Queued: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.Queued with Double = js.native
  /* 4 */ val RejectedByPolicy: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.RejectedByPolicy with Double = js.native
  /* 3 */ val Succeeded: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.PullRequestAsyncStatus.Succeeded with Double = js.native
  @JSBracketAccess
