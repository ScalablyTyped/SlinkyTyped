...
object GitRefUpdateStatus extends js.Object {
  ...
  /* 8 */ val CreateBranchPermissionRequired: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.CreateBranchPermissionRequired with Double = js.native
  /* 9 */ val CreateTagPermissionRequired: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.CreateTagPermissionRequired with Double = js.native
  /* 1 */ val ForcePushRequired: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.ForcePushRequired with Double = js.native
  /* 3 */ val InvalidRefName: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.InvalidRefName with Double = js.native
  /* 11 */ val Locked: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.Locked with Double = js.native
  /* 7 */ val ManageNotePermissionRequired: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.ManageNotePermissionRequired with Double = js.native
  /* 12 */ val RefNameConflict: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.RefNameConflict with Double = js.native
  /* 10 */ val RejectedByPlugin: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.RejectedByPlugin with Double = js.native
  /* 13 */ val RejectedByPolicy: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.RejectedByPolicy with Double = js.native
  /* 2 */ val StaleOldObjectId: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.StaleOldObjectId with Double = js.native
  /* 0 */ val Succeeded: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.Succeeded with Double = js.native
  /* 15 */ val SucceededCorruptRef: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.SucceededCorruptRef with Double = js.native
  /* 14 */ val SucceededNonExistentRef: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.SucceededNonExistentRef with Double = js.native
  /* 4 */ val Unprocessed: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.Unprocessed with Double = js.native
  /* 5 */ val UnresolvableToCommit: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.UnresolvableToCommit with Double = js.native
  /* 6 */ val WritePermissionRequired: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitRefUpdateStatus.WritePermissionRequired with Double = js.native
  @JSBracketAccess
