...
object RefFavoriteType extends js.Object {
  ...
  /* 1 */ val Folder: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.RefFavoriteType.Folder with Double = js.native
  /* 0 */ val Invalid: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.RefFavoriteType.Invalid with Double = js.native
  /* 2 */ val Ref: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.RefFavoriteType.Ref with Double = js.native
  @JSBracketAccess
