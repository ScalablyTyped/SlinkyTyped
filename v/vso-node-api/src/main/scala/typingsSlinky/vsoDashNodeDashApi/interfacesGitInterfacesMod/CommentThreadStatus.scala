...
object CommentThreadStatus extends js.Object {
  ...
  /* 1 */ val Active: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.Active with Double = js.native
  /* 5 */ val ByDesign: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.ByDesign with Double = js.native
  /* 4 */ val Closed: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.Closed with Double = js.native
  /* 2 */ val Fixed: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.Fixed with Double = js.native
  /* 6 */ val Pending: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.Pending with Double = js.native
  /* 0 */ val Unknown: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.Unknown with Double = js.native
  /* 3 */ val WontFix: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.CommentThreadStatus.WontFix with Double = js.native
  @JSBracketAccess
