...
object GitHistoryMode extends js.Object {
  ...
  /* 1 */ val FirstParent: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitHistoryMode.FirstParent with Double = js.native
  /* 2 */ val FullHistory: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitHistoryMode.FullHistory with Double = js.native
  /* 3 */ val FullHistorySimplifyMerges: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitHistoryMode.FullHistorySimplifyMerges with Double = js.native
  /* 0 */ val SimplifiedHistory: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.GitHistoryMode.SimplifiedHistory with Double = js.native
  @JSBracketAccess
