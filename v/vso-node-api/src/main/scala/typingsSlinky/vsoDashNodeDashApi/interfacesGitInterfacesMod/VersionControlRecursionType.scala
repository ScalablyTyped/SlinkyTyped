...
object VersionControlRecursionType extends js.Object {
  ...
  /* 120 */ val Full: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.VersionControlRecursionType.Full with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.VersionControlRecursionType.None with Double = js.native
  /* 1 */ val OneLevel: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.VersionControlRecursionType.OneLevel with Double = js.native
  /* 4 */ val OneLevelPlusNestedEmptyFolders: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.VersionControlRecursionType.OneLevelPlusNestedEmptyFolders with Double = js.native
  @JSBracketAccess
