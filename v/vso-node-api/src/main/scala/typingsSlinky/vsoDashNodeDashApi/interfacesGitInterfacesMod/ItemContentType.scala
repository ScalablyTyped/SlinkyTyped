...
object ItemContentType extends js.Object {
  ...
  /* 1 */ val Base64Encoded: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.ItemContentType.Base64Encoded with Double = js.native
  /* 0 */ val RawText: typingsSlinky.vsoDashNodeDashApi.interfacesGitInterfacesMod.ItemContentType.RawText with Double = js.native
  @JSBracketAccess
