...
object QueryResultType extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItem with Double
        ]
  
  /* 2 */ @js.native
  object WorkItemLink
    extends TopLevel[
          typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double
        ]
