...
object QueryResultType extends js.Object {
  ...
  /* 1 */ val WorkItem: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItem with Double = js.native
  /* 2 */ val WorkItemLink: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double = js.native
  @JSBracketAccess
