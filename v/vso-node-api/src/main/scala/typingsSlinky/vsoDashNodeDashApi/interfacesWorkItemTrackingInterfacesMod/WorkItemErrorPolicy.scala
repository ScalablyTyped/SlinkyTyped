...
object WorkItemErrorPolicy extends js.Object {
  ...
  /* 1 */ val Fail: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.WorkItemErrorPolicy.Fail with Double = js.native
  /* 2 */ val Omit: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.WorkItemErrorPolicy.Omit with Double = js.native
  @JSBracketAccess
