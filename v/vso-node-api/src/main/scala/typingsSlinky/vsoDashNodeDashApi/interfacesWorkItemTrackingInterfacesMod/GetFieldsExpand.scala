...
object GetFieldsExpand extends js.Object {
  ...
  /* 1 */ val ExtensionFields: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.GetFieldsExpand.ExtensionFields with Double = js.native
  /* 0 */ val None: typingsSlinky.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.GetFieldsExpand.None with Double = js.native
  @JSBracketAccess
