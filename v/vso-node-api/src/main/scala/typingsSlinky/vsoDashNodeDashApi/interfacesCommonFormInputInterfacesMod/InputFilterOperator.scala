...
object InputFilterOperator extends js.Object {
  ...
  /* 0 */ val Equals: typingsSlinky.vsoDashNodeDashApi.interfacesCommonFormInputInterfacesMod.InputFilterOperator.Equals with Double = js.native
  /* 1 */ val NotEquals: typingsSlinky.vsoDashNodeDashApi.interfacesCommonFormInputInterfacesMod.InputFilterOperator.NotEquals with Double = js.native
  @JSBracketAccess
