...
object ManualInterventionStatus extends StObject {
  ...
  /* 4 */ val Approved: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ManualInterventionStatus.Approved with Double = js.native
  ...
  /* 8 */ val Canceled: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ManualInterventionStatus.Canceled with Double = js.native
  ...
  /* 1 */ val Pending: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ManualInterventionStatus.Pending with Double = js.native
  ...
  /* 2 */ val Rejected: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ManualInterventionStatus.Rejected with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ManualInterventionStatus.Unknown with Double = js.native
}
