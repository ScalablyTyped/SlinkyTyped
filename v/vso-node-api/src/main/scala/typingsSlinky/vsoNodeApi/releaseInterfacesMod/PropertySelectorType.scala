...
object PropertySelectorType extends StObject {
  ...
  /* 1 */ val Exclusion: typingsSlinky.vsoNodeApi.releaseInterfacesMod.PropertySelectorType.Exclusion with Double = js.native
  
  @js.native
  sealed trait Inclusion extends PropertySelectorType
  /* 0 */ val Inclusion: typingsSlinky.vsoNodeApi.releaseInterfacesMod.PropertySelectorType.Inclusion with Double = js.native
}
