...
object ReleaseQueryOrder extends StObject {
  ...
  /* 1 */ val Ascending: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ReleaseQueryOrder.Ascending with Double = js.native
  
  @js.native
  sealed trait Descending extends ReleaseQueryOrder
  /* 0 */ val Descending: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ReleaseQueryOrder.Descending with Double = js.native
}
