...
object SenderType extends StObject {
  ...
  /* 2 */ val RequestingUser: typingsSlinky.vsoNodeApi.releaseInterfacesMod.SenderType.RequestingUser with Double = js.native
  
  @js.native
  sealed trait ServiceAccount extends SenderType
  /* 1 */ val ServiceAccount: typingsSlinky.vsoNodeApi.releaseInterfacesMod.SenderType.ServiceAccount with Double = js.native
}
