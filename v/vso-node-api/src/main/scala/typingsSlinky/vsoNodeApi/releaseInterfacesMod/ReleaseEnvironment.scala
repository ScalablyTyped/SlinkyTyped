...
object ReleaseEnvironment {
  ...
  implicit class ReleaseEnvironmentOps[Self <: ReleaseEnvironment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextScheduledUtcTime(value: js.Date): Self = this.set("nextScheduledUtcTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScheduledDeploymentTime(value: js.Date): Self = this.set("scheduledDeploymentTime", value.asInstanceOf[js.Any])
