...
object ApprovalFilters extends StObject {
  ...
  /* 7 */ val All: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ApprovalFilters.All with Double = js.native
  ...
  /* 4 */ val ApprovalSnapshots: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ApprovalFilters.ApprovalSnapshots with Double = js.native
  ...
  /* 2 */ val AutomatedApprovals: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ApprovalFilters.AutomatedApprovals with Double = js.native
  ...
  /* 1 */ val ManualApprovals: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ApprovalFilters.ManualApprovals with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ApprovalFilters.None with Double = js.native
}
