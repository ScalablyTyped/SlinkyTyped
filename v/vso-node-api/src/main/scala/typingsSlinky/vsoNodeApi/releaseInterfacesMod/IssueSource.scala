...
object IssueSource extends StObject {
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.releaseInterfacesMod.IssueSource.None with Double = js.native
  
  @js.native
  sealed trait System extends IssueSource
  /* 2 */ val System: typingsSlinky.vsoNodeApi.releaseInterfacesMod.IssueSource.System with Double = js.native
  
  @js.native
  sealed trait User extends IssueSource
  /* 1 */ val User: typingsSlinky.vsoNodeApi.releaseInterfacesMod.IssueSource.User with Double = js.native
}
