...
object PipelineProcessTypes extends StObject {
  ...
  /* 1 */ val Designer: typingsSlinky.vsoNodeApi.releaseInterfacesMod.PipelineProcessTypes.Designer with Double = js.native
  
  @js.native
  sealed trait Yaml extends PipelineProcessTypes
  /* 2 */ val Yaml: typingsSlinky.vsoNodeApi.releaseInterfacesMod.PipelineProcessTypes.Yaml with Double = js.native
}
