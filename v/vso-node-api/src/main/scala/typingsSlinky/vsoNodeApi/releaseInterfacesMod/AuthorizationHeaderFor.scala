...
object AuthorizationHeaderFor extends StObject {
  ...
  /* 1 */ val OnBehalfOf: typingsSlinky.vsoNodeApi.releaseInterfacesMod.AuthorizationHeaderFor.OnBehalfOf with Double = js.native
  
  @js.native
  sealed trait RevalidateApproverIdentity extends AuthorizationHeaderFor
  /* 0 */ val RevalidateApproverIdentity: typingsSlinky.vsoNodeApi.releaseInterfacesMod.AuthorizationHeaderFor.RevalidateApproverIdentity with Double = js.native
}
