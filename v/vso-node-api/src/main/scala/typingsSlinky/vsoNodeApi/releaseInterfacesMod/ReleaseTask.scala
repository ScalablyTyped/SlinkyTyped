...
object ReleaseTask {
  ...
  implicit class ReleaseTaskOps[Self <: ReleaseTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateEnded(value: js.Date): Self = this.set("dateEnded", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateStarted(value: js.Date): Self = this.set("dateStarted", value.asInstanceOf[js.Any])
