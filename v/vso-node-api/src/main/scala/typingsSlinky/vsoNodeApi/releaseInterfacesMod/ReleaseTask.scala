...
object ReleaseTask {
  ...
  implicit class ReleaseTaskMutableBuilder[Self <: ReleaseTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateEnded(value: js.Date): Self = StObject.set(x, "dateEnded", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateStarted(value: js.Date): Self = StObject.set(x, "dateStarted", value.asInstanceOf[js.Any])
