...
object ConditionType extends StObject {
  ...
  /* 4 */ val Artifact: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ConditionType.Artifact with Double = js.native
  ...
  /* 2 */ val EnvironmentState: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ConditionType.EnvironmentState with Double = js.native
  ...
  /* 1 */ val Event: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ConditionType.Event with Double = js.native
  ...
  /* 0 */ val Undefined: typingsSlinky.vsoNodeApi.releaseInterfacesMod.ConditionType.Undefined with Double = js.native
}
