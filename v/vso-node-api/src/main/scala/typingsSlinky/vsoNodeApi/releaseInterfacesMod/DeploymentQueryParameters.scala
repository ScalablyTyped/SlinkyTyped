...
object DeploymentQueryParameters {
  ...
  implicit class DeploymentQueryParametersMutableBuilder[Self <: DeploymentQueryParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxModifiedTime(value: js.Date): Self = StObject.set(x, "maxModifiedTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinModifiedTime(value: js.Date): Self = StObject.set(x, "minModifiedTime", value.asInstanceOf[js.Any])
