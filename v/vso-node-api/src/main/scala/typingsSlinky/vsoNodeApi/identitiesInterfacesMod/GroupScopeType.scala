...
object GroupScopeType extends StObject {
  ...
  /* 0 */ val Generic: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.GroupScopeType.Generic with Double = js.native
  
  @js.native
  sealed trait ServiceHost extends GroupScopeType
  /* 1 */ val ServiceHost: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.GroupScopeType.ServiceHost with Double = js.native
  
  @js.native
  sealed trait TeamProject extends GroupScopeType
  /* 2 */ val TeamProject: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.GroupScopeType.TeamProject with Double = js.native
}
