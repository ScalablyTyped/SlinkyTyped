...
object ReadIdentitiesOptions extends StObject {
  ...
  /* 1 */ val FilterIllegalMemberships: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.ReadIdentitiesOptions.FilterIllegalMemberships with Double = js.native
  
  @js.native
  sealed trait None extends ReadIdentitiesOptions
  /* 0 */ val None: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.ReadIdentitiesOptions.None with Double = js.native
}
