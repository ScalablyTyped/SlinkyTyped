...
object QueryMembership extends StObject {
  ...
  /* 1 */ val Direct: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.QueryMembership.Direct with Double = js.native
  ...
  /* 2 */ val Expanded: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.QueryMembership.Expanded with Double = js.native
  ...
  /* 4 */ val ExpandedDown: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.QueryMembership.ExpandedDown with Double = js.native
  ...
  /* 3 */ val ExpandedUp: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.QueryMembership.ExpandedUp with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.identitiesInterfacesMod.QueryMembership.None with Double = js.native
}
