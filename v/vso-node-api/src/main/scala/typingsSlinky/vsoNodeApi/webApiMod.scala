...
object webApiMod extends js.Object {
  ...
  class WebApi protected () extends js.Object {
    ...
    def getBuildApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IBuildApi] = js.native
    ...
    def getCoreApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ICoreApi] = js.native
    ...
    def getDashboardApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IDashboardApi] = js.native
    ...
    def getExtensionManagementApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IExtensionManagementApi] = js.native
    ...
    def getFeatureManagementApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IFeatureManagementApi] = js.native
    ...
    def getFileContainerApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IFileContainerApi] = js.native
    ...
    def getGitApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IGitApi] = js.native
    ...
    def getLocationsApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ILocationsApi] = js.native
    ...
    def getNotificationApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[INotificationApi] = js.native
    ...
    def getPolicyApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IPolicyApi] = js.native
    ...
    def getProfileApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IProfileApi] = js.native
    ...
    def getProjectAnalysisApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IProjectAnalysisApi] = js.native
    ...
    def getReleaseApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IReleaseApi] = js.native
    ...
    def getSecurityRolesApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ISecurityRolesApi] = js.native
    ...
    def getTaskAgentApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ITaskAgentApi] = js.native
    ...
    def getTaskApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ITaskApi] = js.native
    ...
    def getTestApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ITestApi] = js.native
    ...
    def getTfvcApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[ITfvcApi] = js.native
    ...
    def getWorkApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IWorkApi] = js.native
    ...
    def getWorkItemTrackingApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IWorkItemTrackingApi] = js.native
    ...
    def getWorkItemTrackingProcessApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IWorkItemTrackingProcessApi] = js.native
    ...
    def getWorkItemTrackingProcessDefinitionApi(serverUrl: js.UndefOr[scala.Nothing], handlers: js.Array[IRequestHandler]): js.Promise[IWorkItemTrackingProcessDefinitionsApi] = js.native
