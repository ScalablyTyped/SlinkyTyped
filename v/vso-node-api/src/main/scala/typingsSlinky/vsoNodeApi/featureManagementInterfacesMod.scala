...
import typingsSlinky.vsoNodeApi.anon.EnumValuesEnabled
...
object featureManagementInterfacesMod {
  ...
  object ContributedFeatureEnabledValue extends StObject {
    ...
    /* 0 */ val Disabled: typingsSlinky.vsoNodeApi.featureManagementInterfacesMod.ContributedFeatureEnabledValue.Disabled with Double = js.native
    ...
    /* 1 */ val Enabled: typingsSlinky.vsoNodeApi.featureManagementInterfacesMod.ContributedFeatureEnabledValue.Enabled with Double = js.native
    ...
    /* -1 */ val Undefined: typingsSlinky.vsoNodeApi.featureManagementInterfacesMod.ContributedFeatureEnabledValue.Undefined with Double = js.native
  }
