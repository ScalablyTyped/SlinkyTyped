...
object BuildPhaseStatus extends StObject {
  ...
  /* 1 */ val Failed: typingsSlinky.vsoNodeApi.buildInterfacesMod.BuildPhaseStatus.Failed with Double = js.native
  ...
  /* 2 */ val Succeeded: typingsSlinky.vsoNodeApi.buildInterfacesMod.BuildPhaseStatus.Succeeded with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.vsoNodeApi.buildInterfacesMod.BuildPhaseStatus.Unknown with Double = js.native
}
