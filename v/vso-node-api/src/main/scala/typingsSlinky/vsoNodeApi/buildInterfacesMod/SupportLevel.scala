...
object SupportLevel extends StObject {
  ...
  /* 2 */ val Required: typingsSlinky.vsoNodeApi.buildInterfacesMod.SupportLevel.Required with Double = js.native
  ...
  /* 1 */ val Supported: typingsSlinky.vsoNodeApi.buildInterfacesMod.SupportLevel.Supported with Double = js.native
  ...
  /* 0 */ val Unsupported: typingsSlinky.vsoNodeApi.buildInterfacesMod.SupportLevel.Unsupported with Double = js.native
}
