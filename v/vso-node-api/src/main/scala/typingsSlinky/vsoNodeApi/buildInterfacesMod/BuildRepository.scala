...
object BuildRepository {
  ...
  implicit class BuildRepositoryOps[Self <: BuildRepository] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheckoutSubmodules(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("checkoutSubmodules")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withClean(value: String): Self = {
        val ret = this.duplicate
