...
object DefinitionQuality extends StObject {
  ...
  /* 1 */ val Definition: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQuality.Definition with Double = js.native
  
  @js.native
  sealed trait Draft extends DefinitionQuality
  /* 2 */ val Draft: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQuality.Draft with Double = js.native
}
