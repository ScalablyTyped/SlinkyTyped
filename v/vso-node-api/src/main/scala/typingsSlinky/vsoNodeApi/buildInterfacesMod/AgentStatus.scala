...
object AgentStatus extends StObject {
  ...
  /* 1 */ val Available: typingsSlinky.vsoNodeApi.buildInterfacesMod.AgentStatus.Available with Double = js.native
  ...
  /* 2 */ val Offline: typingsSlinky.vsoNodeApi.buildInterfacesMod.AgentStatus.Offline with Double = js.native
  ...
  /* 0 */ val Unavailable: typingsSlinky.vsoNodeApi.buildInterfacesMod.AgentStatus.Unavailable with Double = js.native
}
