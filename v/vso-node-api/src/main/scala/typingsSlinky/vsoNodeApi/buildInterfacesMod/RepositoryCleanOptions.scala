...
object RepositoryCleanOptions extends StObject {
  ...
  /* 3 */ val AllBuildDir: typingsSlinky.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.AllBuildDir with Double = js.native
  
  @js.native
  sealed trait Source extends RepositoryCleanOptions
  /* 0 */ val Source: typingsSlinky.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.Source with Double = js.native
  
  @js.native
  sealed trait SourceAndOutputDir extends RepositoryCleanOptions
  /* 1 */ val SourceAndOutputDir: typingsSlinky.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.SourceAndOutputDir with Double = js.native
  ...
  /* 2 */ val SourceDir: typingsSlinky.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.SourceDir with Double = js.native
}
