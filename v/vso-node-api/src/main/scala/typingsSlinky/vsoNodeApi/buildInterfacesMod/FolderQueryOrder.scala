...
object FolderQueryOrder extends StObject {
  ...
  /* 1 */ val FolderAscending: typingsSlinky.vsoNodeApi.buildInterfacesMod.FolderQueryOrder.FolderAscending with Double = js.native
  ...
  /* 2 */ val FolderDescending: typingsSlinky.vsoNodeApi.buildInterfacesMod.FolderQueryOrder.FolderDescending with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.buildInterfacesMod.FolderQueryOrder.None with Double = js.native
}
