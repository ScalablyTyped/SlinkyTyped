...
object DeleteOptions extends StObject {
  ...
  /* 31 */ val All: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.All with Double = js.native
  ...
  /* 8 */ val Details: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.Details with Double = js.native
  ...
  /* 1 */ val DropLocation: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.DropLocation with Double = js.native
  ...
  /* 4 */ val Label: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.Label with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.None with Double = js.native
  ...
  /* 16 */ val Symbols: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.Symbols with Double = js.native
  ...
  /* 2 */ val TestResults: typingsSlinky.vsoNodeApi.buildInterfacesMod.DeleteOptions.TestResults with Double = js.native
}
