...
object WorkspaceMappingType extends StObject {
  ...
  /* 1 */ val Cloak: typingsSlinky.vsoNodeApi.buildInterfacesMod.WorkspaceMappingType.Cloak with Double = js.native
  ...
  /* 0 */ val Map: typingsSlinky.vsoNodeApi.buildInterfacesMod.WorkspaceMappingType.Map with Double = js.native
}
