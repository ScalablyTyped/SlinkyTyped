...
object QueueOptions extends StObject {
  ...
  /* 1 */ val DoNotRun: typingsSlinky.vsoNodeApi.buildInterfacesMod.QueueOptions.DoNotRun with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.buildInterfacesMod.QueueOptions.None with Double = js.native
}
