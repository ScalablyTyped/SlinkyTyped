...
object ValidationResult extends StObject {
  ...
  /* 2 */ val Error: typingsSlinky.vsoNodeApi.buildInterfacesMod.ValidationResult.Error with Double = js.native
  
  @js.native
  sealed trait OK extends ValidationResult
  /* 0 */ val OK: typingsSlinky.vsoNodeApi.buildInterfacesMod.ValidationResult.OK with Double = js.native
  
  @js.native
  sealed trait Warning extends ValidationResult
  /* 1 */ val Warning: typingsSlinky.vsoNodeApi.buildInterfacesMod.ValidationResult.Warning with Double = js.native
}
