...
object Build {
  ...
  implicit class BuildOps[Self <: Build] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFinishTime(value: js.Date): Self = this.set("finishTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setQueueTime(value: js.Date): Self = this.set("queueTime", value.asInstanceOf[js.Any])
    @scala.inline
