...
object ProcessTemplateType extends StObject {
  ...
  /* 0 */ val Custom: typingsSlinky.vsoNodeApi.buildInterfacesMod.ProcessTemplateType.Custom with Double = js.native
  ...
  /* 1 */ val Default: typingsSlinky.vsoNodeApi.buildInterfacesMod.ProcessTemplateType.Default with Double = js.native
  ...
  /* 2 */ val Upgrade: typingsSlinky.vsoNodeApi.buildInterfacesMod.ProcessTemplateType.Upgrade with Double = js.native
}
