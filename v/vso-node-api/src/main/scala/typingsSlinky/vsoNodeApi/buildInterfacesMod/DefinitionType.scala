...
object DefinitionType extends StObject {
  ...
  /* 2 */ val Build: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionType.Build with Double = js.native
  
  @js.native
  sealed trait Xaml extends DefinitionType
  /* 1 */ val Xaml: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionType.Xaml with Double = js.native
}
