...
object DefinitionQueryOrder extends StObject {
  ...
  /* 3 */ val DefinitionNameAscending: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQueryOrder.DefinitionNameAscending with Double = js.native
  ...
  /* 4 */ val DefinitionNameDescending: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQueryOrder.DefinitionNameDescending with Double = js.native
  ...
  /* 1 */ val LastModifiedAscending: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQueryOrder.LastModifiedAscending with Double = js.native
  ...
  /* 2 */ val LastModifiedDescending: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQueryOrder.LastModifiedDescending with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.buildInterfacesMod.DefinitionQueryOrder.None with Double = js.native
}
