...
object TestRunPublishContext extends StObject {
  ...
  /* 3 */ val All: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunPublishContext.All with Double = js.native
  ...
  /* 1 */ val Build: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunPublishContext.Build with Double = js.native
  ...
  /* 2 */ val Release: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunPublishContext.Release with Double = js.native
}
