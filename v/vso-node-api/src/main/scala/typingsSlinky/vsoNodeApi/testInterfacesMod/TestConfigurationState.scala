...
object TestConfigurationState extends StObject {
  ...
  /* 1 */ val Active: typingsSlinky.vsoNodeApi.testInterfacesMod.TestConfigurationState.Active with Double = js.native
  ...
  /* 2 */ val Inactive: typingsSlinky.vsoNodeApi.testInterfacesMod.TestConfigurationState.Inactive with Double = js.native
}
