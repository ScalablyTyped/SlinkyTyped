...
object TestResultsContextType extends StObject {
  ...
  /* 1 */ val Build: typingsSlinky.vsoNodeApi.testInterfacesMod.TestResultsContextType.Build with Double = js.native
  
  @js.native
  sealed trait Release extends TestResultsContextType
  /* 2 */ val Release: typingsSlinky.vsoNodeApi.testInterfacesMod.TestResultsContextType.Release with Double = js.native
}
