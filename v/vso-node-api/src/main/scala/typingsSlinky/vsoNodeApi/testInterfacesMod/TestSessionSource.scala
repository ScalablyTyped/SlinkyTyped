...
object TestSessionSource extends StObject {
  ...
  /* 2 */ val FeedbackDesktop: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.FeedbackDesktop with Double = js.native
  ...
  /* 4 */ val FeedbackWeb: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.FeedbackWeb with Double = js.native
  ...
  /* 6 */ val SessionInsightsForAll: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.SessionInsightsForAll with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.Unknown with Double = js.native
  ...
  /* 1 */ val XTDesktop: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.XTDesktop with Double = js.native
  ...
  /* 5 */ val XTDesktop2: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.XTDesktop2 with Double = js.native
  ...
  /* 3 */ val XTWeb: typingsSlinky.vsoNodeApi.testInterfacesMod.TestSessionSource.XTWeb with Double = js.native
}
