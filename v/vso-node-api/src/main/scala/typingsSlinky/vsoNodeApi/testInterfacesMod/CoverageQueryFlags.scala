...
object CoverageQueryFlags extends StObject {
  ...
  /* 4 */ val BlockData: typingsSlinky.vsoNodeApi.testInterfacesMod.CoverageQueryFlags.BlockData with Double = js.native
  ...
  /* 2 */ val Functions: typingsSlinky.vsoNodeApi.testInterfacesMod.CoverageQueryFlags.Functions with Double = js.native
  ...
  /* 1 */ val Modules: typingsSlinky.vsoNodeApi.testInterfacesMod.CoverageQueryFlags.Modules with Double = js.native
}
