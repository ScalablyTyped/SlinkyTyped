...
object TestRunState extends StObject {
  ...
  /* 4 */ val Aborted: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.Aborted with Double = js.native
  ...
  /* 3 */ val Completed: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.Completed with Double = js.native
  ...
  /* 2 */ val InProgress: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.InProgress with Double = js.native
  ...
  /* 6 */ val NeedsInvestigation: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.NeedsInvestigation with Double = js.native
  ...
  /* 1 */ val NotStarted: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.NotStarted with Double = js.native
  ...
  /* 0 */ val Unspecified: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.Unspecified with Double = js.native
  ...
  /* 5 */ val Waiting: typingsSlinky.vsoNodeApi.testInterfacesMod.TestRunState.Waiting with Double = js.native
}
