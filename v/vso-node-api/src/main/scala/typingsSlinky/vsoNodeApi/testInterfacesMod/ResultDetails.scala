...
object ResultDetails extends StObject {
  ...
  /* 1 */ val Iterations: typingsSlinky.vsoNodeApi.testInterfacesMod.ResultDetails.Iterations with Double = js.native
  
  @js.native
  sealed trait None extends ResultDetails
  /* 0 */ val None: typingsSlinky.vsoNodeApi.testInterfacesMod.ResultDetails.None with Double = js.native
  
  @js.native
  sealed trait WorkItems extends ResultDetails
  /* 2 */ val WorkItems: typingsSlinky.vsoNodeApi.testInterfacesMod.ResultDetails.WorkItems with Double = js.native
}
