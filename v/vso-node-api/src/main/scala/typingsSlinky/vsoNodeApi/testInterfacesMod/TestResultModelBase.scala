...
object TestResultModelBase {
  ...
  implicit class TestResultModelBaseOps[Self <: TestResultModelBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompletedDate(value: js.Date): Self = this.set("completedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartedDate(value: js.Date): Self = this.set("startedDate", value.asInstanceOf[js.Any])
  }
}
