...
import typingsSlinky.vsoNodeApi.anon.EnumValuesAccount
import typingsSlinky.vsoNodeApi.anon.EnumValuesAssigned
import typingsSlinky.vsoNodeApi.anon.EnumValuesContext
import typingsSlinky.vsoNodeApi.identitiesInterfacesMod.Identity
...
object locationsInterfacesMod {
  ...
  object InheritLevel extends StObject {
    ...
    /* 2 */ val Account: typingsSlinky.vsoNodeApi.locationsInterfacesMod.InheritLevel.Account with Double = js.native
    
    @js.native
    sealed trait All extends InheritLevel
    /* 7 */ val All: typingsSlinky.vsoNodeApi.locationsInterfacesMod.InheritLevel.All with Double = js.native
    
    @js.native
    sealed trait Collection extends InheritLevel
    /* 4 */ val Collection: typingsSlinky.vsoNodeApi.locationsInterfacesMod.InheritLevel.Collection with Double = js.native
    
    @js.native
    sealed trait Deployment extends InheritLevel
    /* 1 */ val Deployment: typingsSlinky.vsoNodeApi.locationsInterfacesMod.InheritLevel.Deployment with Double = js.native
    
    @js.native
    sealed trait None extends InheritLevel
    /* 0 */ val None: typingsSlinky.vsoNodeApi.locationsInterfacesMod.InheritLevel.None with Double = js.native
  }
  ...
  object RelativeToSetting extends StObject {
    ...
    /* 0 */ val Context: typingsSlinky.vsoNodeApi.locationsInterfacesMod.RelativeToSetting.Context with Double = js.native
    
    @js.native
    sealed trait FullyQualified extends RelativeToSetting
    /* 3 */ val FullyQualified: typingsSlinky.vsoNodeApi.locationsInterfacesMod.RelativeToSetting.FullyQualified with Double = js.native
    
    @js.native
    sealed trait WebApplication extends RelativeToSetting
    /* 2 */ val WebApplication: typingsSlinky.vsoNodeApi.locationsInterfacesMod.RelativeToSetting.WebApplication with Double = js.native
  }
  ...
  object ServiceStatus extends StObject {
    ...
    /* 1 */ val Active: typingsSlinky.vsoNodeApi.locationsInterfacesMod.ServiceStatus.Active with Double = js.native
    
    @js.native
    sealed trait Assigned extends ServiceStatus
    /* 0 */ val Assigned: typingsSlinky.vsoNodeApi.locationsInterfacesMod.ServiceStatus.Assigned with Double = js.native
    
    @js.native
    sealed trait Moving extends ServiceStatus
    /* 2 */ val Moving: typingsSlinky.vsoNodeApi.locationsInterfacesMod.ServiceStatus.Moving with Double = js.native
  }
  ...
  object ConnectionData {
    ...
    implicit class ConnectionDataMutableBuilder[Self <: ConnectionData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLastUserAccess(value: js.Date): Self = StObject.set(x, "lastUserAccess", value.asInstanceOf[js.Any])
