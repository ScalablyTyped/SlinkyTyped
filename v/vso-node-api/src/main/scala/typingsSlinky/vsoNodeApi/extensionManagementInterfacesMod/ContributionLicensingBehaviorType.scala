...
object ContributionLicensingBehaviorType extends StObject {
  ...
  /* 2 */ val AlwaysInclude: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.AlwaysInclude with Double = js.native
  ...
  /* 0 */ val OnlyIfLicensed: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfLicensed with Double = js.native
  ...
  /* 1 */ val OnlyIfUnlicensed: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfUnlicensed with Double = js.native
}
