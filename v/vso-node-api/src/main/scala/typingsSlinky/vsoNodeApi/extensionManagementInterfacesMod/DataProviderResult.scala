...
object DataProviderResult {
  ...
  implicit class DataProviderResultOps[Self <: DataProviderResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClientProviders(value: StringDictionary[ClientDataProviderQuery]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clientProviders")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withExceptions(value: StringDictionary[DataProviderExceptionDetails]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("exceptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResolvedProviders(value: js.Array[ResolvedDataProvider]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolvedProviders")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSharedData(value: StringDictionary[js.Any]): Self = {
        val ret = this.duplicate
