...
object AcquisitionOperationState extends StObject {
  ...
  /* 1 */ val Allow: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationState.Allow with Double = js.native
  ...
  /* 3 */ val Completed: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationState.Completed with Double = js.native
  ...
  /* 0 */ val Disallow: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationState.Disallow with Double = js.native
}
