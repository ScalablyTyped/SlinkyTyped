...
object AcquisitionAssignmentType extends StObject {
  ...
  /* 2 */ val All: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionAssignmentType.All with Double = js.native
  ...
  /* 1 */ val Me: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionAssignmentType.Me with Double = js.native
  
  @js.native
  sealed trait None extends AcquisitionAssignmentType
  /* 0 */ val None: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionAssignmentType.None with Double = js.native
}
