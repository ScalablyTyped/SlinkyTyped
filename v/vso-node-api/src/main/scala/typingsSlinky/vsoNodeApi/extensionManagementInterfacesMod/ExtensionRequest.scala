...
object ExtensionRequest {
  ...
  implicit class ExtensionRequestOps[Self <: ExtensionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestDate(value: js.Date): Self = this.set("requestDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResolveDate(value: js.Date): Self = this.set("resolveDate", value.asInstanceOf[js.Any])
