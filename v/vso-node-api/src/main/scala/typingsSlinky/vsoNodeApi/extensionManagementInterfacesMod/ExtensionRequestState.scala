...
object ExtensionRequestState extends StObject {
  ...
  /* 1 */ val Accepted: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ExtensionRequestState.Accepted with Double = js.native
  ...
  /* 0 */ val Open: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ExtensionRequestState.Open with Double = js.native
  ...
  /* 2 */ val Rejected: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.ExtensionRequestState.Rejected with Double = js.native
}
