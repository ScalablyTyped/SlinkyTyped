...
object AcquisitionOperationType extends StObject {
  ...
  /* 2 */ val Buy: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.Buy with Double = js.native
  ...
  /* 0 */ val Get: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.Get with Double = js.native
  ...
  /* 1 */ val Install: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.Install with Double = js.native
  ...
  /* 5 */ val None: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.None with Double = js.native
  ...
  /* 6 */ val PurchaseRequest: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.PurchaseRequest with Double = js.native
  ...
  /* 4 */ val Request: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.Request with Double = js.native
  ...
  /* 3 */ val Try: typingsSlinky.vsoNodeApi.extensionManagementInterfacesMod.AcquisitionOperationType.Try with Double = js.native
}
