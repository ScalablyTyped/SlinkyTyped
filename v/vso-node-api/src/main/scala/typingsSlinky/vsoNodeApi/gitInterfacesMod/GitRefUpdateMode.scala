...
object GitRefUpdateMode extends StObject {
  ...
  /* 1 */ val AllOrNone: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitRefUpdateMode.AllOrNone with Double = js.native
  ...
  /* 0 */ val BestEffort: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitRefUpdateMode.BestEffort with Double = js.native
}
