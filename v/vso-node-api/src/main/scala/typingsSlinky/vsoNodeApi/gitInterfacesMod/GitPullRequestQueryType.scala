...
object GitPullRequestQueryType extends StObject {
  ...
  /* 2 */ val Commit: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitPullRequestQueryType.Commit with Double = js.native
  ...
  /* 1 */ val LastMergeCommit: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitPullRequestQueryType.LastMergeCommit with Double = js.native
  ...
  /* 0 */ val NotSet: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitPullRequestQueryType.NotSet with Double = js.native
}
