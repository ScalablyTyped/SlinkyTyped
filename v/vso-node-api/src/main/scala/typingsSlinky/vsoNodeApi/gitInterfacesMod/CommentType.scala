...
object CommentType extends StObject {
  ...
  /* 2 */ val CodeChange: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentType.CodeChange with Double = js.native
  ...
  /* 3 */ val System: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentType.System with Double = js.native
  ...
  /* 1 */ val Text: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentType.Text with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentType.Unknown with Double = js.native
}
