...
object GitAsyncRefOperationFailureStatus extends StObject {
  ...
  /* 8 */ val AsyncOperationNotFound: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.AsyncOperationNotFound with Double = js.native
  ...
  /* 3 */ val CreateBranchPermissionRequired: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.CreateBranchPermissionRequired with Double = js.native
  ...
  /* 6 */ val GitObjectTooLarge: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.GitObjectTooLarge with Double = js.native
  ...
  /* 1 */ val InvalidRefName: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.InvalidRefName with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.None with Double = js.native
  ...
  /* 7 */ val OperationIndentityNotFound: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.OperationIndentityNotFound with Double = js.native
  ...
  /* 9 */ val Other: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.Other with Double = js.native
  ...
  /* 2 */ val RefNameConflict: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.RefNameConflict with Double = js.native
  ...
  /* 5 */ val TargetBranchDeleted: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.TargetBranchDeleted with Double = js.native
  ...
  /* 4 */ val WritePermissionRequired: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncRefOperationFailureStatus.WritePermissionRequired with Double = js.native
}
