...
object CommentThreadStatus extends StObject {
  ...
  /* 1 */ val Active: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.Active with Double = js.native
  ...
  /* 5 */ val ByDesign: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.ByDesign with Double = js.native
  ...
  /* 4 */ val Closed: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.Closed with Double = js.native
  ...
  /* 2 */ val Fixed: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.Fixed with Double = js.native
  ...
  /* 6 */ val Pending: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.Pending with Double = js.native
  ...
  /* 0 */ val Unknown: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.Unknown with Double = js.native
  ...
  /* 3 */ val WontFix: typingsSlinky.vsoNodeApi.gitInterfacesMod.CommentThreadStatus.WontFix with Double = js.native
}
