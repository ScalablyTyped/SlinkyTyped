...
object GitPullRequestCompletionOptions {
  ...
  implicit class GitPullRequestCompletionOptionsOps[Self <: GitPullRequestCompletionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBypassPolicy(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bypassPolicy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBypassReason(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bypassReason")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeleteSourceBranch(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteSourceBranch")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMergeCommitMessage(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mergeCommitMessage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSquashMerge(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("squashMerge")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTransitionWorkItems(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transitionWorkItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTriggeredByAutoComplete(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("triggeredByAutoComplete")(value.asInstanceOf[js.Any])
        ret
    }
  }
