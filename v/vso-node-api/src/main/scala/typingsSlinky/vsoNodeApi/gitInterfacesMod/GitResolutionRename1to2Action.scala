...
object GitResolutionRename1to2Action extends StObject {
  ...
  /* 3 */ val KeepBothFiles: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionRename1to2Action.KeepBothFiles with Double = js.native
  
  @js.native
  sealed trait KeepSourcePath extends GitResolutionRename1to2Action
  /* 1 */ val KeepSourcePath: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionRename1to2Action.KeepSourcePath with Double = js.native
  
  @js.native
  sealed trait KeepTargetPath extends GitResolutionRename1to2Action
  /* 2 */ val KeepTargetPath: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionRename1to2Action.KeepTargetPath with Double = js.native
  
  @js.native
  sealed trait Undecided extends GitResolutionRename1to2Action
  /* 0 */ val Undecided: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionRename1to2Action.Undecided with Double = js.native
}
