...
object GitResolutionWhichAction extends StObject {
  ...
  /* 1 */ val PickSourceAction: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionWhichAction.PickSourceAction with Double = js.native
  
  @js.native
  sealed trait PickTargetAction extends GitResolutionWhichAction
  /* 2 */ val PickTargetAction: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionWhichAction.PickTargetAction with Double = js.native
  
  @js.native
  sealed trait Undecided extends GitResolutionWhichAction
  /* 0 */ val Undecided: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionWhichAction.Undecided with Double = js.native
}
