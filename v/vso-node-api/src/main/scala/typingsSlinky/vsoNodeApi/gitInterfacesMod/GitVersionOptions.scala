...
object GitVersionOptions extends StObject {
  ...
  /* 2 */ val FirstParent: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionOptions.FirstParent with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionOptions.None with Double = js.native
  ...
  /* 1 */ val PreviousChange: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionOptions.PreviousChange with Double = js.native
}
