...
object GitHistoryMode extends StObject {
  ...
  /* 1 */ val FirstParent: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitHistoryMode.FirstParent with Double = js.native
  ...
  /* 2 */ val FullHistory: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitHistoryMode.FullHistory with Double = js.native
  ...
  /* 3 */ val FullHistorySimplifyMerges: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitHistoryMode.FullHistorySimplifyMerges with Double = js.native
  ...
  /* 0 */ val SimplifiedHistory: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitHistoryMode.SimplifiedHistory with Double = js.native
}
