...
object GitConflictRename1to2 {
  ...
  implicit class GitConflictRename1to2Ops[Self <: GitConflictRename1to2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResolution(value: GitResolutionRename1to2): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSourceNewPath(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceNewPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
