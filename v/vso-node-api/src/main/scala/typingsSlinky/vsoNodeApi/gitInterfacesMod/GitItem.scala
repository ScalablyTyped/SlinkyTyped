...
object GitItem {
  ...
  implicit class GitItemOps[Self <: GitItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLatestProcessedChange(value: GitCommitRef): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("latestProcessedChange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOriginalObjectId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("originalObjectId")(value.asInstanceOf[js.Any])
        ret
    }
  }
