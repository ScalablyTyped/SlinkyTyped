...
object PullRequestMergeFailureType extends StObject {
  ...
  /* 2 */ val CaseSensitive: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.CaseSensitive with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.None with Double = js.native
  ...
  /* 3 */ val ObjectTooLarge: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.ObjectTooLarge with Double = js.native
  ...
  /* 1 */ val Unknown: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.Unknown with Double = js.native
}
