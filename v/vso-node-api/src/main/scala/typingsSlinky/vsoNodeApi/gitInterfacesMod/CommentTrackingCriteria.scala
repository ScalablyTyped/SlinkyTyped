...
object CommentTrackingCriteria {
  ...
  implicit class CommentTrackingCriteriaOps[Self <: CommentTrackingCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFirstComparingIteration(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("firstComparingIteration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOrigFilePath(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("origFilePath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOrigLeftFileEnd(value: CommentPosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("origLeftFileEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOrigLeftFileStart(value: CommentPosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("origLeftFileStart")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOrigRightFileEnd(value: CommentPosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("origRightFileEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOrigRightFileStart(value: CommentPosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("origRightFileStart")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSecondComparingIteration(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("secondComparingIteration")(value.asInstanceOf[js.Any])
        ret
    }
  }
