...
object GitVersionType extends StObject {
  ...
  /* 0 */ val Branch: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionType.Branch with Double = js.native
  ...
  /* 2 */ val Commit: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionType.Commit with Double = js.native
  ...
  /* 1 */ val Tag: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitVersionType.Tag with Double = js.native
}
