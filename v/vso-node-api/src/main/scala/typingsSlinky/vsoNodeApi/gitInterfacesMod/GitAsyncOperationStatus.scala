...
object GitAsyncOperationStatus extends StObject {
  ...
  /* 5 */ val Abandoned: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncOperationStatus.Abandoned with Double = js.native
  ...
  /* 3 */ val Completed: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncOperationStatus.Completed with Double = js.native
  ...
  /* 4 */ val Failed: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncOperationStatus.Failed with Double = js.native
  ...
  /* 2 */ val InProgress: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncOperationStatus.InProgress with Double = js.native
  ...
  /* 1 */ val Queued: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitAsyncOperationStatus.Queued with Double = js.native
}
