...
object GitPullRequestCommentThread {
  ...
  implicit class GitPullRequestCommentThreadOps[Self <: GitPullRequestCommentThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPullRequestThreadContext(value: GitPullRequestCommentThreadContext): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pullRequestThreadContext")(value.asInstanceOf[js.Any])
        ret
    }
  }
