...
object GitResolutionStatus extends StObject {
  ...
  /* 1 */ val PartiallyResolved: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionStatus.PartiallyResolved with Double = js.native
  
  @js.native
  sealed trait Resolved extends GitResolutionStatus
  /* 2 */ val Resolved: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionStatus.Resolved with Double = js.native
  
  @js.native
  sealed trait Unresolved extends GitResolutionStatus
  /* 0 */ val Unresolved: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitResolutionStatus.Unresolved with Double = js.native
}
