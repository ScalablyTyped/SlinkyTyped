...
object GitPullRequestReviewFileType extends StObject {
  ...
  /* 1 */ val Attachment: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitPullRequestReviewFileType.Attachment with Double = js.native
  
  @js.native
  sealed trait ChangeEntry extends GitPullRequestReviewFileType
  /* 0 */ val ChangeEntry: typingsSlinky.vsoNodeApi.gitInterfacesMod.GitPullRequestReviewFileType.ChangeEntry with Double = js.native
}
