...
object GitPullRequest {
  ...
  implicit class GitPullRequestOps[Self <: GitPullRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClosedDate(value: js.Date): Self = this.set("closedDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCompletionQueueTime(value: js.Date): Self = this.set("completionQueueTime", value.asInstanceOf[js.Any])
    @scala.inline
