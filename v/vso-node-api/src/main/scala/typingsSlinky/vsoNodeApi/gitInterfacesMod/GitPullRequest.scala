...
object GitPullRequest {
  ...
  implicit class GitPullRequestMutableBuilder[Self <: GitPullRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClosedDate(value: js.Date): Self = StObject.set(x, "closedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCompletionQueueTime(value: js.Date): Self = StObject.set(x, "completionQueueTime", value.asInstanceOf[js.Any])
