...
object PullRequestAsyncStatus extends StObject {
  ...
  /* 2 */ val Conflicts: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.Conflicts with Double = js.native
  ...
  /* 5 */ val Failure: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.Failure with Double = js.native
  ...
  /* 0 */ val NotSet: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.NotSet with Double = js.native
  ...
  /* 1 */ val Queued: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.Queued with Double = js.native
  ...
  /* 4 */ val RejectedByPolicy: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.RejectedByPolicy with Double = js.native
  ...
  /* 3 */ val Succeeded: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestAsyncStatus.Succeeded with Double = js.native
}
