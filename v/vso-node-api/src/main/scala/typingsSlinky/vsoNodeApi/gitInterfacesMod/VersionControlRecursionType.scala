...
object VersionControlRecursionType extends StObject {
  ...
  /* 120 */ val Full: typingsSlinky.vsoNodeApi.gitInterfacesMod.VersionControlRecursionType.Full with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.gitInterfacesMod.VersionControlRecursionType.None with Double = js.native
  ...
  /* 1 */ val OneLevel: typingsSlinky.vsoNodeApi.gitInterfacesMod.VersionControlRecursionType.OneLevel with Double = js.native
  ...
  /* 4 */ val OneLevelPlusNestedEmptyFolders: typingsSlinky.vsoNodeApi.gitInterfacesMod.VersionControlRecursionType.OneLevelPlusNestedEmptyFolders with Double = js.native
}
