...
object PullRequestStatus extends StObject {
  ...
  /* 2 */ val Abandoned: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestStatus.Abandoned with Double = js.native
  ...
  /* 1 */ val Active: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestStatus.Active with Double = js.native
  ...
  /* 4 */ val All: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestStatus.All with Double = js.native
  ...
  /* 3 */ val Completed: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestStatus.Completed with Double = js.native
  ...
  /* 0 */ val NotSet: typingsSlinky.vsoNodeApi.gitInterfacesMod.PullRequestStatus.NotSet with Double = js.native
}
