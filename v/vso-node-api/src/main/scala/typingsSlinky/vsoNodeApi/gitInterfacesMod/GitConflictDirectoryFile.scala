...
object GitConflictDirectoryFile {
  ...
  @scala.inline
  implicit class GitConflictDirectoryFileOps[Self <: GitConflictDirectoryFile] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSourceTree(value: GitTreeRef): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sourceTree")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
