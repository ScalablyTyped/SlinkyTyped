...
object TreeStructureGroup extends StObject {
  ...
  /* 0 */ val Areas: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TreeStructureGroup.Areas with Double = js.native
  
  @js.native
  sealed trait Iterations extends TreeStructureGroup
  /* 1 */ val Iterations: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TreeStructureGroup.Iterations with Double = js.native
}
