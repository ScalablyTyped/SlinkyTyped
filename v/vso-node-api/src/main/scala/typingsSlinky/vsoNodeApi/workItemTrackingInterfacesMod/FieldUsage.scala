...
object FieldUsage extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.FieldUsage.WorkItem with Double
        ]
  ...
  object WorkItemLink
    extends TopLevel[
          typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.FieldUsage.WorkItemLink with Double
        ]
