...
object LinkQueryMode extends StObject {
  ...
  /* 3 */ val LinksOneHopDoesNotContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksOneHopDoesNotContain with Double = js.native
  ...
  /* 2 */ val LinksOneHopMayContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksOneHopMayContain with Double = js.native
  ...
  /* 1 */ val LinksOneHopMustContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksOneHopMustContain with Double = js.native
  
  @js.native
  sealed trait LinksRecursiveDoesNotContain extends LinkQueryMode
  /* 6 */ val LinksRecursiveDoesNotContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksRecursiveDoesNotContain with Double = js.native
  ...
  /* 5 */ val LinksRecursiveMayContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksRecursiveMayContain with Double = js.native
  
  @js.native
  sealed trait LinksRecursiveMustContain extends LinkQueryMode
  /* 4 */ val LinksRecursiveMustContain: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.LinksRecursiveMustContain with Double = js.native
  
  @js.native
  sealed trait WorkItems extends LinkQueryMode
  /* 0 */ val WorkItems: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkQueryMode.WorkItems with Double = js.native
}
