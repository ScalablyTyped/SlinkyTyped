...
object WorkItemTypeFieldsExpandLevel extends StObject {
  ...
  /* 3 */ val All: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemTypeFieldsExpandLevel.All with Double = js.native
  ...
  /* 1 */ val AllowedValues: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemTypeFieldsExpandLevel.AllowedValues with Double = js.native
  ...
  /* 2 */ val DependentFields: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemTypeFieldsExpandLevel.DependentFields with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemTypeFieldsExpandLevel.None with Double = js.native
}
