...
object TreeNodeStructureType extends StObject {
  ...
  /* 0 */ val Area: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TreeNodeStructureType.Area with Double = js.native
  ...
  /* 1 */ val Iteration: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TreeNodeStructureType.Iteration with Double = js.native
}
