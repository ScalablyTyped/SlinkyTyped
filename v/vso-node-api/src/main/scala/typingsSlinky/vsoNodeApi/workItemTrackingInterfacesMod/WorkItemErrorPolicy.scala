...
object WorkItemErrorPolicy extends StObject {
  ...
  /* 1 */ val Fail: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemErrorPolicy.Fail with Double = js.native
  
  @js.native
  sealed trait Omit extends WorkItemErrorPolicy
  /* 2 */ val Omit: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.WorkItemErrorPolicy.Omit with Double = js.native
}
