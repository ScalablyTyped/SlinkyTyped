...
object QueryRecursionOption extends StObject {
  ...
  /* 1 */ val ChildFirst: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryRecursionOption.ChildFirst with Double = js.native
  ...
  /* 0 */ val ParentFirst: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryRecursionOption.ParentFirst with Double = js.native
}
