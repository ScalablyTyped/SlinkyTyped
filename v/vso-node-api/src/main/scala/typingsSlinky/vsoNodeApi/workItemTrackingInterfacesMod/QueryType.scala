...
object QueryType extends StObject {
  ...
  /* 1 */ val Flat: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryType.Flat with Double = js.native
  ...
  /* 3 */ val OneHop: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryType.OneHop with Double = js.native
  ...
  /* 2 */ val Tree: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryType.Tree with Double = js.native
}
