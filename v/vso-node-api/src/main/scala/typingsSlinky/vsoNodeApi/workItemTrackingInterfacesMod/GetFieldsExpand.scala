...
object GetFieldsExpand extends StObject {
  ...
  /* 1 */ val ExtensionFields: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.GetFieldsExpand.ExtensionFields with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.GetFieldsExpand.None with Double = js.native
}
