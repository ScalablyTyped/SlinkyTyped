...
object ReportingRevisionsExpand extends StObject {
  ...
  /* 1 */ val Fields: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.ReportingRevisionsExpand.Fields with Double = js.native
  
  @js.native
  sealed trait None extends ReportingRevisionsExpand
  /* 0 */ val None: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.ReportingRevisionsExpand.None with Double = js.native
}
