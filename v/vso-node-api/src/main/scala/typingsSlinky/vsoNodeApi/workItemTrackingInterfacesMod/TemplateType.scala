...
object TemplateType extends StObject {
  ...
  /* 1 */ val GlobalWorkflow: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TemplateType.GlobalWorkflow with Double = js.native
  
  @js.native
  sealed trait WorkItemType extends TemplateType
  /* 0 */ val WorkItemType: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.TemplateType.WorkItemType with Double = js.native
}
