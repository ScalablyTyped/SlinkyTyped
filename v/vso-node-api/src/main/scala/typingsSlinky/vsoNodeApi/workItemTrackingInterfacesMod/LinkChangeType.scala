...
object LinkChangeType extends StObject {
  ...
  /* 0 */ val Create: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkChangeType.Create with Double = js.native
  
  @js.native
  sealed trait Remove extends LinkChangeType
  /* 1 */ val Remove: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.LinkChangeType.Remove with Double = js.native
}
