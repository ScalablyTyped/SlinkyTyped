...
object QueryResultType extends StObject {
  ...
  /* 1 */ val WorkItem: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItem with Double = js.native
  ...
  /* 2 */ val WorkItemLink: typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double = js.native
}
