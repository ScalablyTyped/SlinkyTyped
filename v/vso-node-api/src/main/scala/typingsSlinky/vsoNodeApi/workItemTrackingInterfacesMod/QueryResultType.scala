...
object QueryResultType extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItem with Double
        ]
  
  /* 2 */ @js.native
  object WorkItemLink
    extends TopLevel[
          typingsSlinky.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double
        ]
