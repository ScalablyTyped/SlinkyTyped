...
object WidgetScope extends StObject {
  ...
  /* 0 */ val Collection_User: typingsSlinky.vsoNodeApi.dashboardInterfacesMod.WidgetScope.Collection_User with Double = js.native
  
  @js.native
  sealed trait Project_Team extends WidgetScope
  /* 1 */ val Project_Team: typingsSlinky.vsoNodeApi.dashboardInterfacesMod.WidgetScope.Project_Team with Double = js.native
}
