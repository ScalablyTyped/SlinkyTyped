...
object DashboardScope extends StObject {
  ...
  /* 0 */ val Collection_User: typingsSlinky.vsoNodeApi.dashboardInterfacesMod.DashboardScope.Collection_User with Double = js.native
  
  @js.native
  sealed trait Project_Team extends DashboardScope
  /* 1 */ val Project_Team: typingsSlinky.vsoNodeApi.dashboardInterfacesMod.DashboardScope.Project_Team with Double = js.native
}
