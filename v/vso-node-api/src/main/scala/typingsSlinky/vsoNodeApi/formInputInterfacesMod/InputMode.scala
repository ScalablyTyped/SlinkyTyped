...
object InputMode extends StObject {
  ...
  /* 50 */ val CheckBox: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.CheckBox with Double = js.native
  ...
  /* 30 */ val Combo: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.Combo with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.None with Double = js.native
  ...
  /* 20 */ val PasswordBox: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.PasswordBox with Double = js.native
  ...
  /* 40 */ val RadioButtons: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.RadioButtons with Double = js.native
  ...
  /* 60 */ val TextArea: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.TextArea with Double = js.native
  ...
  /* 10 */ val TextBox: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputMode.TextBox with Double = js.native
}
