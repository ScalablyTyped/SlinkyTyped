...
object InputFilterOperator extends StObject {
  ...
  /* 0 */ val Equals: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputFilterOperator.Equals with Double = js.native
  
  @js.native
  sealed trait NotEquals extends InputFilterOperator
  /* 1 */ val NotEquals: typingsSlinky.vsoNodeApi.formInputInterfacesMod.InputFilterOperator.NotEquals with Double = js.native
}
