...
object BugsBehavior extends StObject {
  ...
  /* 1 */ val AsRequirements: typingsSlinky.vsoNodeApi.workInterfacesMod.BugsBehavior.AsRequirements with Double = js.native
  
  @js.native
  sealed trait AsTasks extends BugsBehavior
  /* 2 */ val AsTasks: typingsSlinky.vsoNodeApi.workInterfacesMod.BugsBehavior.AsTasks with Double = js.native
  
  @js.native
  sealed trait Off extends BugsBehavior
  /* 0 */ val Off: typingsSlinky.vsoNodeApi.workInterfacesMod.BugsBehavior.Off with Double = js.native
}
