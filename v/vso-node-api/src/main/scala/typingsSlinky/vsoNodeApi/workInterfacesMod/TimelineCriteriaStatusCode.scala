...
object TimelineCriteriaStatusCode extends StObject {
  ...
  /* 1 */ val InvalidFilterClause: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineCriteriaStatusCode.InvalidFilterClause with Double = js.native
  ...
  /* 0 */ val OK: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineCriteriaStatusCode.OK with Double = js.native
  ...
  /* 2 */ val Unknown: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineCriteriaStatusCode.Unknown with Double = js.native
}
