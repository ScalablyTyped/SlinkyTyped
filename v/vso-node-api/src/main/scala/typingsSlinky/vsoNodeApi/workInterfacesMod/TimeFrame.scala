...
object TimeFrame extends StObject {
  ...
  /* 1 */ val Current: typingsSlinky.vsoNodeApi.workInterfacesMod.TimeFrame.Current with Double = js.native
  
  @js.native
  sealed trait Future extends TimeFrame
  /* 2 */ val Future: typingsSlinky.vsoNodeApi.workInterfacesMod.TimeFrame.Future with Double = js.native
  
  @js.native
  sealed trait Past extends TimeFrame
  /* 0 */ val Past: typingsSlinky.vsoNodeApi.workInterfacesMod.TimeFrame.Past with Double = js.native
}
