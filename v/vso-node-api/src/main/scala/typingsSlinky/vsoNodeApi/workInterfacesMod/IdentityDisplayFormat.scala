...
object IdentityDisplayFormat extends StObject {
  ...
  /* 2 */ val AvatarAndFullName: typingsSlinky.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.AvatarAndFullName with Double = js.native
  ...
  /* 0 */ val AvatarOnly: typingsSlinky.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.AvatarOnly with Double = js.native
  ...
  /* 1 */ val FullName: typingsSlinky.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.FullName with Double = js.native
}
