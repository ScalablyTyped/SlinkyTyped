...
object TimelineTeamStatusCode extends StObject {
  ...
  /* 4 */ val BacklogInError: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.BacklogInError with Double = js.native
  ...
  /* 1 */ val DoesntExistOrAccessDenied: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.DoesntExistOrAccessDenied with Double = js.native
  ...
  /* 3 */ val MaxTeamFieldsExceeded: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.MaxTeamFieldsExceeded with Double = js.native
  ...
  /* 2 */ val MaxTeamsExceeded: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.MaxTeamsExceeded with Double = js.native
  ...
  /* 5 */ val MissingTeamFieldValue: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.MissingTeamFieldValue with Double = js.native
  ...
  /* 6 */ val NoIterationsExist: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.NoIterationsExist with Double = js.native
  ...
  /* 0 */ val OK: typingsSlinky.vsoNodeApi.workInterfacesMod.TimelineTeamStatusCode.OK with Double = js.native
}
