...
object BoardColumnType extends StObject {
  ...
  /* 1 */ val InProgress: typingsSlinky.vsoNodeApi.workInterfacesMod.BoardColumnType.InProgress with Double = js.native
  
  @js.native
  sealed trait Incoming extends BoardColumnType
  /* 0 */ val Incoming: typingsSlinky.vsoNodeApi.workInterfacesMod.BoardColumnType.Incoming with Double = js.native
  
  @js.native
  sealed trait Outgoing extends BoardColumnType
  /* 2 */ val Outgoing: typingsSlinky.vsoNodeApi.workInterfacesMod.BoardColumnType.Outgoing with Double = js.native
}
