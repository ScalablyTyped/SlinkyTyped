...
object SourceControlTypes extends StObject {
  ...
  /* 2 */ val Git: typingsSlinky.vsoNodeApi.coreInterfacesMod.SourceControlTypes.Git with Double = js.native
  
  @js.native
  sealed trait Tfvc extends SourceControlTypes
  /* 1 */ val Tfvc: typingsSlinky.vsoNodeApi.coreInterfacesMod.SourceControlTypes.Tfvc with Double = js.native
}
