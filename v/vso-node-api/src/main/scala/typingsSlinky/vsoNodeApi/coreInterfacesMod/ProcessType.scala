...
object ProcessType extends StObject {
  ...
  /* 1 */ val Custom: typingsSlinky.vsoNodeApi.coreInterfacesMod.ProcessType.Custom with Double = js.native
  
  @js.native
  sealed trait Inherited extends ProcessType
  /* 2 */ val Inherited: typingsSlinky.vsoNodeApi.coreInterfacesMod.ProcessType.Inherited with Double = js.native
  
  @js.native
  sealed trait System extends ProcessType
  /* 0 */ val System: typingsSlinky.vsoNodeApi.coreInterfacesMod.ProcessType.System with Double = js.native
}
