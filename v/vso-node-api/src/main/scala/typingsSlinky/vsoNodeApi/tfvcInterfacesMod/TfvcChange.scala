...
object TfvcChange {
  ...
  implicit class TfvcChangeOps[Self <: TfvcChange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMergeSources(value: js.Array[TfvcMergeSource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mergeSources")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPendingVersion(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pendingVersion")(value.asInstanceOf[js.Any])
        ret
    }
  }
