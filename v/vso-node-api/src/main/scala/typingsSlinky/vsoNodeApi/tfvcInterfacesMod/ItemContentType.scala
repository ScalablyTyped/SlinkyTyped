...
object ItemContentType extends StObject {
  ...
  /* 1 */ val Base64Encoded: typingsSlinky.vsoNodeApi.tfvcInterfacesMod.ItemContentType.Base64Encoded with Double = js.native
  
  @js.native
  sealed trait RawText extends ItemContentType
  /* 0 */ val RawText: typingsSlinky.vsoNodeApi.tfvcInterfacesMod.ItemContentType.RawText with Double = js.native
}
