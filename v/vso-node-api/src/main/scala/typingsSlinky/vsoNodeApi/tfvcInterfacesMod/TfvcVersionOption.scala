...
object TfvcVersionOption extends StObject {
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.tfvcInterfacesMod.TfvcVersionOption.None with Double = js.native
  
  @js.native
  sealed trait Previous extends TfvcVersionOption
  /* 1 */ val Previous: typingsSlinky.vsoNodeApi.tfvcInterfacesMod.TfvcVersionOption.Previous with Double = js.native
  
  @js.native
  sealed trait UseRename extends TfvcVersionOption
  /* 2 */ val UseRename: typingsSlinky.vsoNodeApi.tfvcInterfacesMod.TfvcVersionOption.UseRename with Double = js.native
}
