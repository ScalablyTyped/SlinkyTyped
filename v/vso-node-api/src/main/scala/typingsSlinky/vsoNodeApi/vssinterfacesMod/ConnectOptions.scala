...
object ConnectOptions extends StObject {
  ...
  /* 4 */ val IncludeInheritedDefinitionsOnly: typingsSlinky.vsoNodeApi.vssinterfacesMod.ConnectOptions.IncludeInheritedDefinitionsOnly with Double = js.native
  ...
  /* 2 */ val IncludeLastUserAccess: typingsSlinky.vsoNodeApi.vssinterfacesMod.ConnectOptions.IncludeLastUserAccess with Double = js.native
  ...
  /* 8 */ val IncludeNonInheritedDefinitionsOnly: typingsSlinky.vsoNodeApi.vssinterfacesMod.ConnectOptions.IncludeNonInheritedDefinitionsOnly with Double = js.native
  ...
  /* 1 */ val IncludeServices: typingsSlinky.vsoNodeApi.vssinterfacesMod.ConnectOptions.IncludeServices with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.vssinterfacesMod.ConnectOptions.None with Double = js.native
}
