...
import typingsSlinky.vsoNodeApi.anon.EnumValuesCancelledFailed
...
object operationsInterfacesMod {
  ...
  object OperationStatus extends StObject {
    ...
    /* 3 */ val Cancelled: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.Cancelled with Double = js.native
    ...
    /* 5 */ val Failed: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.Failed with Double = js.native
    ...
    /* 2 */ val InProgress: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.InProgress with Double = js.native
    ...
    /* 0 */ val NotSet: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.NotSet with Double = js.native
    ...
    /* 1 */ val Queued: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.Queued with Double = js.native
    ...
    /* 4 */ val Succeeded: typingsSlinky.vsoNodeApi.operationsInterfacesMod.OperationStatus.Succeeded with Double = js.native
  }
