...
object PublisherFlags extends StObject {
  ...
  /* 1 */ val Disabled: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherFlags.Disabled with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherFlags.None with Double = js.native
  ...
  /* 3 */ val ServiceFlags: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherFlags.ServiceFlags with Double = js.native
  ...
  /* 1073741824 */ val UnChanged: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherFlags.UnChanged with Double = js.native
  ...
  /* 2 */ val Verified: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherFlags.Verified with Double = js.native
}
