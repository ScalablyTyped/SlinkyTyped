...
object ReviewFilterOptions extends StObject {
  ...
  /* 1 */ val FilterEmptyReviews: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewFilterOptions.FilterEmptyReviews with Double = js.native
  ...
  /* 2 */ val FilterEmptyUserNames: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewFilterOptions.FilterEmptyUserNames with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewFilterOptions.None with Double = js.native
}
