...
object QnAItemStatus extends StObject {
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.None with Double = js.native
  ...
  /* 2 */ val PublisherCreated: typingsSlinky.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.PublisherCreated with Double = js.native
  ...
  /* 1 */ val UserEditable: typingsSlinky.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.UserEditable with Double = js.native
}
