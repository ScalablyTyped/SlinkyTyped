...
object SortOrderType extends StObject {
  ...
  /* 1 */ val Ascending: typingsSlinky.vsoNodeApi.galleryInterfacesMod.SortOrderType.Ascending with Double = js.native
  ...
  /* 0 */ val Default: typingsSlinky.vsoNodeApi.galleryInterfacesMod.SortOrderType.Default with Double = js.native
  ...
  /* 2 */ val Descending: typingsSlinky.vsoNodeApi.galleryInterfacesMod.SortOrderType.Descending with Double = js.native
}
