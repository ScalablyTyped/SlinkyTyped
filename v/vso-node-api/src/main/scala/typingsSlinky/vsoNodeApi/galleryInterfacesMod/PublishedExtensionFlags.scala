...
object PublishedExtensionFlags extends StObject {
  ...
  /* 2 */ val BuiltIn: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.BuiltIn with Double = js.native
  ...
  /* 1 */ val Disabled: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Disabled with Double = js.native
  ...
  /* 16384 */ val Locked: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Locked with Double = js.native
  ...
  /* 512 */ val MultiVersion: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.MultiVersion with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.None with Double = js.native
  ...
  /* 16 */ val Paid: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Paid with Double = js.native
  ...
  /* 2048 */ val Preview: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Preview with Double = js.native
  ...
  /* 256 */ val Public: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Public with Double = js.native
  ...
  /* 1024 */ val System: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.System with Double = js.native
  ...
  /* 8192 */ val Trial: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Trial with Double = js.native
  ...
  /* 8 */ val Trusted: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Trusted with Double = js.native
  ...
  /* 4096 */ val Unpublished: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Unpublished with Double = js.native
  ...
  /* 4 */ val Validated: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublishedExtensionFlags.Validated with Double = js.native
}
