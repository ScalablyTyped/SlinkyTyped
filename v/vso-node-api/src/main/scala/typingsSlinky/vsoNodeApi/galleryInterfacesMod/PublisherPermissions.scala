...
object PublisherPermissions extends StObject {
  ...
  /* 16 */ val Admin: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.Admin with Double = js.native
  ...
  /* 4 */ val CreatePublisher: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.CreatePublisher with Double = js.native
  ...
  /* 128 */ val DeleteExtension: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.DeleteExtension with Double = js.native
  ...
  /* 2048 */ val DeletePublisher: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.DeletePublisher with Double = js.native
  ...
  /* 256 */ val EditSettings: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.EditSettings with Double = js.native
  ...
  /* 1024 */ val ManagePermissions: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.ManagePermissions with Double = js.native
  ...
  /* 64 */ val PrivateRead: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.PrivateRead with Double = js.native
  ...
  /* 8 */ val PublishExtension: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.PublishExtension with Double = js.native
  ...
  /* 1 */ val Read: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.Read with Double = js.native
  ...
  /* 32 */ val TrustedPartner: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.TrustedPartner with Double = js.native
  ...
  /* 2 */ val UpdateExtension: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.UpdateExtension with Double = js.native
  ...
  /* 512 */ val ViewPermissions: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherPermissions.ViewPermissions with Double = js.native
}
