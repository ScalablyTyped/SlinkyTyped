...
object ReviewsResult {
  ...
  implicit class ReviewsResultOps[Self <: ReviewsResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHasMoreReviews(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasMoreReviews")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTotalReviewCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("totalReviewCount")(value.asInstanceOf[js.Any])
        ret
    }
  }
