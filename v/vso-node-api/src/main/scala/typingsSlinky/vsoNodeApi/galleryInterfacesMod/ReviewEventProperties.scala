...
object ReviewEventProperties {
  ...
  implicit class ReviewEventPropertiesOps[Self <: ReviewEventProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplyDate(value: js.Date): Self = this.set("replyDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReviewDate(value: js.Date): Self = this.set("reviewDate", value.asInstanceOf[js.Any])
