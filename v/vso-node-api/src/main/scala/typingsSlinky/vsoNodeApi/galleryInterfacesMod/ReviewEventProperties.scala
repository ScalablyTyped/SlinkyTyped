...
object ReviewEventProperties {
  ...
  implicit class ReviewEventPropertiesMutableBuilder[Self <: ReviewEventProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplyDate(value: js.Date): Self = StObject.set(x, "replyDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReviewDate(value: js.Date): Self = StObject.set(x, "reviewDate", value.asInstanceOf[js.Any])
