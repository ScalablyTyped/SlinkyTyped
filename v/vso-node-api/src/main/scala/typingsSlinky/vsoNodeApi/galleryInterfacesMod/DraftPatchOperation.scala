...
object DraftPatchOperation extends StObject {
  ...
  /* 2 */ val Cancel: typingsSlinky.vsoNodeApi.galleryInterfacesMod.DraftPatchOperation.Cancel with Double = js.native
  
  @js.native
  sealed trait Publish extends DraftPatchOperation
  /* 1 */ val Publish: typingsSlinky.vsoNodeApi.galleryInterfacesMod.DraftPatchOperation.Publish with Double = js.native
}
