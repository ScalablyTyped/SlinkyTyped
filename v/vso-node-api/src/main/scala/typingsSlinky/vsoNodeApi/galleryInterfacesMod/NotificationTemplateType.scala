...
object NotificationTemplateType extends StObject {
  ...
  /* 3 */ val CustomerContactNotification: typingsSlinky.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.CustomerContactNotification with Double = js.native
  ...
  /* 4 */ val PublisherMemberUpdateNotification: typingsSlinky.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.PublisherMemberUpdateNotification with Double = js.native
  ...
  /* 2 */ val QnaNotification: typingsSlinky.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.QnaNotification with Double = js.native
  ...
  /* 1 */ val ReviewNotification: typingsSlinky.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.ReviewNotification with Double = js.native
}
