...
object ReviewEventOperation extends StObject {
  ...
  /* 1 */ val Create: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewEventOperation.Create with Double = js.native
  
  @js.native
  sealed trait Delete extends ReviewEventOperation
  /* 3 */ val Delete: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewEventOperation.Delete with Double = js.native
  
  @js.native
  sealed trait Update extends ReviewEventOperation
  /* 2 */ val Update: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewEventOperation.Update with Double = js.native
}
