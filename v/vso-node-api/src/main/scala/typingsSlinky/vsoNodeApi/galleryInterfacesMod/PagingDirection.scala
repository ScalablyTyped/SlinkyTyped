...
object PagingDirection extends StObject {
  ...
  /* 1 */ val Backward: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PagingDirection.Backward with Double = js.native
  ...
  /* 2 */ val Forward: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PagingDirection.Forward with Double = js.native
}
