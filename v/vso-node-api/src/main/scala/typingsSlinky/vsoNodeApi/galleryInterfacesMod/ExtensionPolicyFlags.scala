...
object ExtensionPolicyFlags extends StObject {
  ...
  /* 31 */ val All: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.All with Double = js.native
  ...
  /* 16 */ val FirstParty: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.FirstParty with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.None with Double = js.native
  ...
  /* 4 */ val Preview: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.Preview with Double = js.native
  ...
  /* 1 */ val Private: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.Private with Double = js.native
  ...
  /* 2 */ val Public: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.Public with Double = js.native
  ...
  /* 8 */ val Released: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ExtensionPolicyFlags.Released with Double = js.native
}
