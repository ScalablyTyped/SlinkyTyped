...
object PublisherQueryFlags extends StObject {
  ...
  /* 2 */ val IncludeEmailAddress: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherQueryFlags.IncludeEmailAddress with Double = js.native
  ...
  /* 1 */ val IncludeExtensions: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherQueryFlags.IncludeExtensions with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.galleryInterfacesMod.PublisherQueryFlags.None with Double = js.native
}
