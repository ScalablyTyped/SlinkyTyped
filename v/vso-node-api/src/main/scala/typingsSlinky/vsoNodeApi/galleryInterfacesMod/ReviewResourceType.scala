...
object ReviewResourceType extends StObject {
  ...
  /* 3 */ val AdminReply: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewResourceType.AdminReply with Double = js.native
  
  @js.native
  sealed trait PublisherReply extends ReviewResourceType
  /* 2 */ val PublisherReply: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewResourceType.PublisherReply with Double = js.native
  
  @js.native
  sealed trait Review extends ReviewResourceType
  /* 1 */ val Review: typingsSlinky.vsoNodeApi.galleryInterfacesMod.ReviewResourceType.Review with Double = js.native
}
