...
object fileContainerInterfacesMod {
  ...
  object ContainerItemStatus extends StObject {
    ...
    /* 1 */ val Created: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerItemStatus.Created with Double = js.native
    ...
    /* 2 */ val PendingUpload: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerItemStatus.PendingUpload with Double = js.native
  }
  ...
  object ContainerItemType extends StObject {
    ...
    /* 0 */ val Any: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerItemType.Any with Double = js.native
    ...
    /* 2 */ val File: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerItemType.File with Double = js.native
    ...
    /* 1 */ val Folder: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerItemType.Folder with Double = js.native
  }
  ...
  object ContainerOptions extends StObject {
    ...
    /* 0 */ val None: typingsSlinky.vsoNodeApi.fileContainerInterfacesMod.ContainerOptions.None with Double = js.native
  }
  ...
  object FileContainerItem {
    ...
    implicit class FileContainerItemMutableBuilder[Self <: FileContainerItem] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDateLastModified(value: js.Date): Self = StObject.set(x, "dateLastModified", value.asInstanceOf[js.Any])
