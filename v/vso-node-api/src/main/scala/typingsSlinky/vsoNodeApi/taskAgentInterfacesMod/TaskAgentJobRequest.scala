...
object TaskAgentJobRequest {
  ...
  implicit class TaskAgentJobRequestOps[Self <: TaskAgentJobRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssignTime(value: js.Date): Self = this.set("assignTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setReceiveTime(value: js.Date): Self = this.set("receiveTime", value.asInstanceOf[js.Any])
    @scala.inline
