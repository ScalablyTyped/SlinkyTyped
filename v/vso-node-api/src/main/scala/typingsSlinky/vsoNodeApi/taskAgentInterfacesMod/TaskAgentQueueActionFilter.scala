...
object TaskAgentQueueActionFilter extends StObject {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskAgentQueueActionFilter.Manage with Double = js.native
  
  @js.native
  sealed trait None extends TaskAgentQueueActionFilter
  /* 0 */ val None: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskAgentQueueActionFilter.None with Double = js.native
  
  @js.native
  sealed trait Use extends TaskAgentQueueActionFilter
  /* 16 */ val Use: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskAgentQueueActionFilter.Use with Double = js.native
}
