...
object PlanGroupStatusFilter extends StObject {
  ...
  /* 3 */ val All: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.PlanGroupStatusFilter.All with Double = js.native
  
  @js.native
  sealed trait Queued extends PlanGroupStatusFilter
  /* 2 */ val Queued: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.PlanGroupStatusFilter.Queued with Double = js.native
  
  @js.native
  sealed trait Running extends PlanGroupStatusFilter
  /* 1 */ val Running: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.PlanGroupStatusFilter.Running with Double = js.native
}
