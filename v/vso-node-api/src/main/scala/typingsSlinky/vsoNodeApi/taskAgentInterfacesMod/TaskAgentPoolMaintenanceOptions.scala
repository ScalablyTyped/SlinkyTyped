...
object TaskAgentPoolMaintenanceOptions {
  ...
  implicit class TaskAgentPoolMaintenanceOptionsOps[Self <: TaskAgentPoolMaintenanceOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWorkingDirectoryExpirationInDays(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("workingDirectoryExpirationInDays")(value.asInstanceOf[js.Any])
        ret
    }
  }
