...
object AadLoginPromptOption extends StObject {
  ...
  /* 3 */ val FreshLogin: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.FreshLogin with Double = js.native
  ...
  /* 1 */ val Login: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.Login with Double = js.native
  ...
  /* 0 */ val NoOption: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.NoOption with Double = js.native
  ...
  /* 2 */ val SelectAccount: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.SelectAccount with Double = js.native
}
