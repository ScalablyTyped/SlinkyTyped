...
object TaskAgentStatus extends StObject {
  ...
  /* 1 */ val Offline: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskAgentStatus.Offline with Double = js.native
  
  @js.native
  sealed trait Online extends TaskAgentStatus
  /* 2 */ val Online: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskAgentStatus.Online with Double = js.native
}
