...
object TaskOrchestrationItemType extends StObject {
  ...
  /* 0 */ val Container: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskOrchestrationItemType.Container with Double = js.native
  
  @js.native
  sealed trait Job extends TaskOrchestrationItemType
  /* 1 */ val Job: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.TaskOrchestrationItemType.Job with Double = js.native
}
