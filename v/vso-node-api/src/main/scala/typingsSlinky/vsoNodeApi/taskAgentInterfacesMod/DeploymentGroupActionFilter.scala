...
object DeploymentGroupActionFilter extends StObject {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.DeploymentGroupActionFilter.Manage with Double = js.native
  
  @js.native
  sealed trait None extends DeploymentGroupActionFilter
  /* 0 */ val None: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.DeploymentGroupActionFilter.None with Double = js.native
  
  @js.native
  sealed trait Use extends DeploymentGroupActionFilter
  /* 16 */ val Use: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.DeploymentGroupActionFilter.Use with Double = js.native
}
