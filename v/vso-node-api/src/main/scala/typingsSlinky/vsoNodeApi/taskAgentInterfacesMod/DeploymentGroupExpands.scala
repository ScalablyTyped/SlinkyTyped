...
object DeploymentGroupExpands extends StObject {
  ...
  /* 2 */ val Machines: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.DeploymentGroupExpands.Machines with Double = js.native
  
  @js.native
  sealed trait None extends DeploymentGroupExpands
  /* 0 */ val None: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.DeploymentGroupExpands.None with Double = js.native
}
