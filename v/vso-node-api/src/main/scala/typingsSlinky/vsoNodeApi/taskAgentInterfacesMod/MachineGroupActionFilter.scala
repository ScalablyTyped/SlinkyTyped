...
object MachineGroupActionFilter extends StObject {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.MachineGroupActionFilter.Manage with Double = js.native
  
  @js.native
  sealed trait None extends MachineGroupActionFilter
  /* 0 */ val None: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.MachineGroupActionFilter.None with Double = js.native
  
  @js.native
  sealed trait Use extends MachineGroupActionFilter
  /* 16 */ val Use: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.MachineGroupActionFilter.Use with Double = js.native
}
