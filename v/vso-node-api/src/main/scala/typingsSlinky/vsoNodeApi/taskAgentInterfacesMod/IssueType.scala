...
object IssueType extends StObject {
  ...
  /* 1 */ val Error: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.IssueType.Error with Double = js.native
  
  @js.native
  sealed trait Warning extends IssueType
  /* 2 */ val Warning: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.IssueType.Warning with Double = js.native
}
