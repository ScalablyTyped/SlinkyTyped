...
object SecureFileActionFilter extends StObject {
  ...
  /* 2 */ val Manage: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.SecureFileActionFilter.Manage with Double = js.native
  
  @js.native
  sealed trait None extends SecureFileActionFilter
  /* 0 */ val None: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.SecureFileActionFilter.None with Double = js.native
  
  @js.native
  sealed trait Use extends SecureFileActionFilter
  /* 16 */ val Use: typingsSlinky.vsoNodeApi.taskAgentInterfacesMod.SecureFileActionFilter.Use with Double = js.native
}
