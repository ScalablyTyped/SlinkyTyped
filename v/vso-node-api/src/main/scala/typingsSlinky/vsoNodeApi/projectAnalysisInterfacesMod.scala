...
import typingsSlinky.vsoNodeApi.anon.EnumValuesHourly
import typingsSlinky.vsoNodeApi.anon.EnumValuesPreliminary
...
object projectAnalysisInterfacesMod {
  ...
  object AggregationType extends StObject {
    ...
    /* 1 */ val Daily: typingsSlinky.vsoNodeApi.projectAnalysisInterfacesMod.AggregationType.Daily with Double = js.native
    
    @js.native
    sealed trait Hourly extends AggregationType
    /* 0 */ val Hourly: typingsSlinky.vsoNodeApi.projectAnalysisInterfacesMod.AggregationType.Hourly with Double = js.native
  }
  ...
  object ResultPhase extends StObject {
    ...
    /* 1 */ val Full: typingsSlinky.vsoNodeApi.projectAnalysisInterfacesMod.ResultPhase.Full with Double = js.native
    
    @js.native
    sealed trait Preliminary extends ResultPhase
    /* 0 */ val Preliminary: typingsSlinky.vsoNodeApi.projectAnalysisInterfacesMod.ResultPhase.Preliminary with Double = js.native
  }
