...
object SubscriptionFlags extends StObject {
  ...
  /* 4 */ val CanOptOut: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionFlags.CanOptOut with Double = js.native
  ...
  /* 2 */ val ContributedSubscription: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionFlags.ContributedSubscription with Double = js.native
  ...
  /* 1 */ val GroupSubscription: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionFlags.GroupSubscription with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionFlags.None with Double = js.native
  ...
  /* 8 */ val TeamSubscription: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionFlags.TeamSubscription with Double = js.native
}
