...
object SubscriptionPermissions extends StObject {
  ...
  /* 4 */ val Delete: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionPermissions.Delete with Double = js.native
  ...
  /* 2 */ val Edit: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionPermissions.Edit with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionPermissions.None with Double = js.native
  ...
  /* 1 */ val View: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionPermissions.View with Double = js.native
}
