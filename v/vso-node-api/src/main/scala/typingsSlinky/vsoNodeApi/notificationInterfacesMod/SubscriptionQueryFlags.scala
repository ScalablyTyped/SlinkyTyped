...
object SubscriptionQueryFlags extends StObject {
  ...
  /* 16 */ val AlwaysReturnBasicInformation: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.AlwaysReturnBasicInformation with Double = js.native
  ...
  /* 4 */ val IncludeDeletedSubscriptions: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeDeletedSubscriptions with Double = js.native
  ...
  /* 8 */ val IncludeFilterDetails: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeFilterDetails with Double = js.native
  ...
  /* 2 */ val IncludeInvalidSubscriptions: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeInvalidSubscriptions with Double = js.native
  
  @js.native
  sealed trait None extends SubscriptionQueryFlags
  /* 0 */ val None: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.None with Double = js.native
}
