...
object EventPublisherQueryFlags extends StObject {
  ...
  /* 2 */ val IncludeRemoteServices: typingsSlinky.vsoNodeApi.notificationInterfacesMod.EventPublisherQueryFlags.IncludeRemoteServices with Double = js.native
  
  @js.native
  sealed trait None extends EventPublisherQueryFlags
  /* 0 */ val None: typingsSlinky.vsoNodeApi.notificationInterfacesMod.EventPublisherQueryFlags.None with Double = js.native
}
