...
object NotificationEventPublisher {
  ...
  implicit class NotificationEventPublisherOps[Self <: NotificationEventPublisher] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubscriptionManagementInfo(value: SubscriptionManagement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subscriptionManagementInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
