...
object SubscriptionTemplateQueryFlags extends StObject {
  ...
  /* 22 */ val IncludeEventTypeInformation: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionTemplateQueryFlags.IncludeEventTypeInformation with Double = js.native
  ...
  /* 2 */ val IncludeGroup: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionTemplateQueryFlags.IncludeGroup with Double = js.native
  ...
  /* 1 */ val IncludeUser: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionTemplateQueryFlags.IncludeUser with Double = js.native
  ...
  /* 4 */ val IncludeUserAndGroup: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionTemplateQueryFlags.IncludeUserAndGroup with Double = js.native
  
  @js.native
  sealed trait None extends SubscriptionTemplateQueryFlags
  /* 0 */ val None: typingsSlinky.vsoNodeApi.notificationInterfacesMod.SubscriptionTemplateQueryFlags.None with Double = js.native
}
