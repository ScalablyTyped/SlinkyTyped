...
object GetBehaviorsExpand extends StObject {
  ...
  /* 1 */ val Fields: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.GetBehaviorsExpand.Fields with Double = js.native
  
  @js.native
  sealed trait None extends GetBehaviorsExpand
  /* 0 */ val None: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.GetBehaviorsExpand.None with Double = js.native
}
