...
object GetProcessExpandLevel extends StObject {
  ...
  /* 0 */ val None: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.GetProcessExpandLevel.None with Double = js.native
  
  @js.native
  sealed trait Projects extends GetProcessExpandLevel
  /* 1 */ val Projects: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.GetProcessExpandLevel.Projects with Double = js.native
}
