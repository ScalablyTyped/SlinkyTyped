...
object WorkItemTypeClass extends StObject {
  ...
  /* 2 */ val Custom: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.WorkItemTypeClass.Custom with Double = js.native
  
  @js.native
  sealed trait Derived extends WorkItemTypeClass
  /* 1 */ val Derived: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.WorkItemTypeClass.Derived with Double = js.native
  
  @js.native
  sealed trait System extends WorkItemTypeClass
  /* 0 */ val System: typingsSlinky.vsoNodeApi.workItemTrackingProcessInterfacesMod.WorkItemTypeClass.System with Double = js.native
}
