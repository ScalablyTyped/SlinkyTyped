...
import typingsSlinky.vsoNodeApi.anon.EnumValuesAssignedInherited
...
object securityRolesInterfacesMod {
  ...
  object RoleAccess extends StObject {
    ...
    /* 1 */ val Assigned: typingsSlinky.vsoNodeApi.securityRolesInterfacesMod.RoleAccess.Assigned with Double = js.native
    ...
    /* 2 */ val Inherited: typingsSlinky.vsoNodeApi.securityRolesInterfacesMod.RoleAccess.Inherited with Double = js.native
  }
