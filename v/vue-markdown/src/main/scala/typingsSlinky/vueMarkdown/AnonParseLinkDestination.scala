...
object AnonParseLinkDestination {
  ...
  @scala.inline
  implicit class AnonParseLinkDestinationOps[Self <: AnonParseLinkDestination] (val x: Self) extends AnyVal {
    @scala.inline
