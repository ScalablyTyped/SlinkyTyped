...
object Emailfuzzy {
  ...
  implicit class EmailfuzzyMutableBuilder[Self <: Emailfuzzy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEmail_fuzzy(value: js.RegExp): Self = StObject.set(x, "email_fuzzy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHost_fuzzy_test(value: js.RegExp): Self = StObject.set(x, "host_fuzzy_test", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLink_fuzzy(value: js.RegExp): Self = StObject.set(x, "link_fuzzy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLink_no_ip_fuzzy(value: js.RegExp): Self = StObject.set(x, "link_no_ip_fuzzy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPretest(value: js.RegExp): Self = StObject.set(x, "pretest", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSchema_search(value: js.RegExp): Self = StObject.set(x, "schema_search", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSchema_test(value: js.RegExp): Self = StObject.set(x, "schema_test", value.asInstanceOf[js.Any])
