...
object Emailfuzzy {
  ...
  implicit class EmailfuzzyOps[Self <: Emailfuzzy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEmail_fuzzy(value: js.RegExp): Self = this.set("email_fuzzy", value.asInstanceOf[js.Any])
    @scala.inline
    def setHost_fuzzy_test(value: js.RegExp): Self = this.set("host_fuzzy_test", value.asInstanceOf[js.Any])
    @scala.inline
    def setLink_fuzzy(value: js.RegExp): Self = this.set("link_fuzzy", value.asInstanceOf[js.Any])
    @scala.inline
    def setLink_no_ip_fuzzy(value: js.RegExp): Self = this.set("link_no_ip_fuzzy", value.asInstanceOf[js.Any])
    @scala.inline
    def setPretest(value: js.RegExp): Self = this.set("pretest", value.asInstanceOf[js.Any])
    @scala.inline
    def setSchema_search(value: js.RegExp): Self = this.set("schema_search", value.asInstanceOf[js.Any])
    @scala.inline
    def setSchema_test(value: js.RegExp): Self = this.set("schema_test", value.asInstanceOf[js.Any])
    @scala.inline
