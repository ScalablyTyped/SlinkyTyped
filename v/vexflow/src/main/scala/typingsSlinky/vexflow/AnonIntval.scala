...
@js.native
trait AnonIntval extends js.Object {
...
object AnonIntval {
  @scala.inline
  def apply(int_val: Double, root_index: Double): AnonIntval = {
    val __obj = js.Dynamic.literal(int_val = int_val.asInstanceOf[js.Any], root_index = root_index.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIntval]
  }
  @scala.inline
  implicit class AnonIntvalOps[Self <: AnonIntval] (val x: Self) extends AnyVal {
    @scala.inline
