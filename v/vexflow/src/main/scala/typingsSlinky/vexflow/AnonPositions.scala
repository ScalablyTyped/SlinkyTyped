...
trait AnonPositions extends js.Object {
  ...
  var positions: js.Array[AnonFret] = js.native
...
object AnonPositions {
  @scala.inline
  def apply(duration: String, positions: js.Array[AnonFret]): AnonPositions = {
  ...
  implicit class AnonPositionsOps[Self <: AnonPositions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPositions(value: js.Array[AnonFret]): Self = {
        val ret = this.duplicate
