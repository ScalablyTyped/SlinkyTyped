...
object Beam extends js.Object {
  ...
  def generateBeams(notes: js.Array[typingsSlinky.vexflow.Vex.Flow.StemmableNote], config: Anon_Beammiddleonly): js.Array[typingsSlinky.vexflow.Vex.Flow.Beam] = js.native
