...
import typingsSlinky.vexflow.Anon_Firstindices
...
object TabSlide extends js.Object {
  ...
  def createSlideDown(notes: Anon_Firstindices): typingsSlinky.vexflow.Vex.Flow.TabSlide = js.native
  def createSlideUp(notes: Anon_Firstindices): typingsSlinky.vexflow.Vex.Flow.TabSlide = js.native
}
