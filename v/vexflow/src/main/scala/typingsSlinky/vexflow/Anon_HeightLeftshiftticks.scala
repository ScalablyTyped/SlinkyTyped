...
trait Anon_HeightLeftshiftticks extends js.Object {
  var height: Double
...
object Anon_HeightLeftshiftticks {
  @scala.inline
  def apply(height: Double, left_shift_ticks: Double, right_shift_ticks: Double, y_shift: Double): Anon_HeightLeftshiftticks = {
