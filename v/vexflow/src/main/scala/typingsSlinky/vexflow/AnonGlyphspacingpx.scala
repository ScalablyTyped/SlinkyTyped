...
@js.native
trait AnonGlyphspacingpx extends js.Object {
...
object AnonGlyphspacingpx {
  @scala.inline
  def apply(): AnonGlyphspacingpx = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonGlyphspacingpx]
  }
  @scala.inline
  implicit class AnonGlyphspacingpxOps[Self <: AnonGlyphspacingpx] (val x: Self) extends AnyVal {
    @scala.inline
