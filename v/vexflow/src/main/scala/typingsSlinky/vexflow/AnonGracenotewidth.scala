...
@js.native
trait AnonGracenotewidth extends js.Object {
...
object AnonGracenotewidth {
  @scala.inline
  def apply(code: String, gracenote_width: Double, shift_down: Double, shift_right: Double, width: Double): AnonGracenotewidth = {
    ...
    __obj.asInstanceOf[AnonGracenotewidth]
  }
  @scala.inline
  implicit class AnonGracenotewidthOps[Self <: AnonGracenotewidth] (val x: Self) extends AnyVal {
    @scala.inline
