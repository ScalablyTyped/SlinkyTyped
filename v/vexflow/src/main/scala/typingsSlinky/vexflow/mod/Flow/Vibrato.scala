...
@js.native
class Vibrato ()
  extends typingsSlinky.vexflow.Vex.Flow.Vibrato {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def setHarsh(harsh: Boolean): typingsSlinky.vexflow.Vex.Flow.Vibrato = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def setVibratoWidth(width: Double): typingsSlinky.vexflow.Vex.Flow.Vibrato = js.native
  /* CompleteClass */
...
object Vibrato extends js.Object {
  ...
  def format(
    vibratos: js.Array[typingsSlinky.vexflow.Vex.Flow.Vibrato],
    state: Leftshift,
    context: typingsSlinky.vexflow.Vex.Flow.ModifierContext
  ): Boolean = js.native
}
