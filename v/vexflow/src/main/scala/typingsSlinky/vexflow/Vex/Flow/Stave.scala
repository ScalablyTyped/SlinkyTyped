...
import typingsSlinky.vexflow.anon.Glyphspacingpx
...
trait Stave extends js.Object {
  ...
  def setText(text: String, position: typingsSlinky.vexflow.Vex.Flow.Modifier.Position, options: Justification): Stave = js.native
