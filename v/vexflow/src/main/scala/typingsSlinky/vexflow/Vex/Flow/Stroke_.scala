...
@js.native
trait Stroke_ extends Modifier {
...
object Stroke_ {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Stroke_]
  }
  @scala.inline
  implicit class Stroke_Ops[Self <: Stroke_] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAddEndNote(value: Note => Stroke): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addEndNote")(js.Any.fromFunction1(value))
        ret
    }
  }
