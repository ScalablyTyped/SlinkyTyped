...
object TabTie {
  ...
  implicit class TabTieOps[Self <: TabTie] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateHammeron(value: Firstindices => TabTie): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createHammeron")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreatePulloff(value: Firstindices => TabTie): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPulloff")(js.Any.fromFunction1(value))
        ret
    }
  }
