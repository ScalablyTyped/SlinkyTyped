...
object Firstnote {
  ...
  implicit class FirstnoteOps[Self <: Firstnote] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirst_note(value: typingsSlinky.vexflow.Vex.Flow.Note): Self = this.set("first_note", value.asInstanceOf[js.Any])
    @scala.inline
    def setLast_note(value: typingsSlinky.vexflow.Vex.Flow.Note): Self = this.set("last_note", value.asInstanceOf[js.Any])
  }
