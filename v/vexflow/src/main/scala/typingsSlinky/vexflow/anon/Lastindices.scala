...
trait Lastindices extends js.Object {
  ...
  var first_note: js.UndefOr[typingsSlinky.vexflow.Vex.Flow.Note] = js.undefined
  var last_indices: js.UndefOr[js.Array[Double]] = js.undefined
  var last_note: js.UndefOr[typingsSlinky.vexflow.Vex.Flow.Note] = js.undefined
}
...
object Lastindices {
  ...
  def apply(
    ...
    first_note: typingsSlinky.vexflow.Vex.Flow.Note = null,
    last_indices: js.Array[Double] = null,
    last_note: typingsSlinky.vexflow.Vex.Flow.Note = null
  ): Lastindices = {
