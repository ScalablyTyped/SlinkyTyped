...
object Position {
  ...
  implicit class PositionOps[Self <: Position] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStart(value: typingsSlinky.vexflow.Vex.Flow.Note): Self = this.set("start", value.asInstanceOf[js.Any])
    @scala.inline
    def setStop(value: typingsSlinky.vexflow.Vex.Flow.Note): Self = this.set("stop", value.asInstanceOf[js.Any])
    @scala.inline
    def setPosition(value: typingsSlinky.vexflow.Vex.Flow.TextBracket.Positions): Self = this.set("position", value.asInstanceOf[js.Any])
    @scala.inline
