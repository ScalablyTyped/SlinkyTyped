...
trait Justification extends js.Object {
  var justification: js.UndefOr[typingsSlinky.vexflow.Vex.Flow.TextNote.Justification] = js.undefined
...
object Justification {
  @scala.inline
  def apply(
    justification: typingsSlinky.vexflow.Vex.Flow.TextNote.Justification = null,
