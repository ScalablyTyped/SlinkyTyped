...
object mod {
  ...
  @js.native
  class ^ ()
    extends typingsSlinky.vaultAuthAws.mod.vaultAuthAws {
  ...
  object vaultAuthAws {
    ...
    @scala.inline
    def apply(authenticate: () => js.Promise[_], getOptions: Creds => Options): typingsSlinky.vaultAuthAws.mod.vaultAuthAws = {
      val __obj = js.Dynamic.literal(authenticate = js.Any.fromFunction0(authenticate), getOptions = js.Any.fromFunction1(getOptions))
      __obj.asInstanceOf[typingsSlinky.vaultAuthAws.mod.vaultAuthAws]
    }
    
    @scala.inline
    implicit class vaultAuthAwsMutableBuilder[Self <: typingsSlinky.vaultAuthAws.mod.vaultAuthAws] (val x: Self) extends AnyVal {
