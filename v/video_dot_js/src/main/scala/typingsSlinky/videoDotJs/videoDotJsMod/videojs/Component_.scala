...
import typingsSlinky.videoDotJs.videoDotJsMod.videojs.Component.DimensionObject
import typingsSlinky.videoDotJs.videoDotJsMod.videojs.Component.GenericCallback
import typingsSlinky.videoDotJs.videoDotJsMod.videojs.Dom.Predicate
import typingsSlinky.videoDotJs.videoDotJsStrings.height
import typingsSlinky.videoDotJs.videoDotJsStrings.width
...
trait Component_ extends EventedMixin {
  ...
  @JSName("$$")
  def $$(selector: String, context: typingsSlinky.std.Element): NodeList = js.native
  /**
