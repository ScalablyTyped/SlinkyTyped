...
class CustomControlSpacerCls protected ()
  extends typingsSlinky.videoDotJs.videoDotJsMod.videojs.CustomControlSpacer {
  /**
  ...
  def this(player: typingsSlinky.videoDotJs.videoDotJsMod.videojs.Player, options: ComponentOptions) = this()
  def this(
