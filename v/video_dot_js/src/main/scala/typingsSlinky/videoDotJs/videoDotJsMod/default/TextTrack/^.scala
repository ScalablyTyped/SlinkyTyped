package typingsSlinky.videoDotJs.videoDotJsMod.default.TextTrack
...
@js.native
class ^ protected ()
  extends typingsSlinky.videoDotJs.videoDotJsMod.videojs.TextTrack {
  /**
...
Instantiable1[
        ...
        typingsSlinky.videoDotJs.videoDotJsMod.videojs.TextTrack
      ]
    ]
