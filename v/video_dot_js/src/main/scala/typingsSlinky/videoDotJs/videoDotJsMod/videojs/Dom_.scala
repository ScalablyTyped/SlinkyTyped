...
import typingsSlinky.videoDotJs.videoDotJsMod.videojs.Dom.Coordinates
import typingsSlinky.videoDotJs.videoDotJsMod.videojs.Dom.Predicate
import typingsSlinky.videoDotJs.videoDotJsStrings.canvas
import typingsSlinky.videoDotJs.videoDotJsStrings.form
import typingsSlinky.videoDotJs.videoDotJsStrings.img
import typingsSlinky.videoDotJs.videoDotJsStrings.input
import typingsSlinky.videoDotJs.videoDotJsStrings.option
import typingsSlinky.videoDotJs.videoDotJsStrings.select
import typingsSlinky.videoDotJs.videoDotJsStrings.textarea
...
trait Dom_ extends js.Object {
  ...
  /**
    ...
    */
  def isSingleLeftClick(event: typingsSlinky.videoDotJs.videoDotJsMod.videojs.EventTarget.Event): Boolean = js.native
  /**
