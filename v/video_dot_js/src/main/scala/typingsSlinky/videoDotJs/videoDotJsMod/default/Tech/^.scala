package typingsSlinky.videoDotJs.videoDotJsMod.default.Tech
...
/**
  ...
  */
class ^ ()
  extends typingsSlinky.videoDotJs.videoDotJsMod.videojs.Tech {
...
object ^
  ...
  *        Callback function to call when the `HTML5` Tech is ready.
  */
Instantiable0[typingsSlinky.videoDotJs.videoDotJsMod.videojs.Tech]) with (Instantiable1[/* options */ js.Any, typingsSlinky.videoDotJs.videoDotJsMod.videojs.Tech]) with (Instantiable2[
        /* options */ js.Any, 
        /* ready */ ReadyCallback, 
        typingsSlinky.videoDotJs.videoDotJsMod.videojs.Tech
      ])
    ] {
  /**
  ...
  /**
    ...
    */
  def getTech(name: String): js.UndefOr[typingsSlinky.videoDotJs.videoDotJsMod.videojs.Tech] = js.native
  /**
