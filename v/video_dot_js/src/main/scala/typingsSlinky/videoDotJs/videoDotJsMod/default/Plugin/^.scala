package typingsSlinky.videoDotJs.videoDotJsMod.default.Plugin
...
@js.native
class ^ protected ()
  extends typingsSlinky.videoDotJs.videoDotJsMod.videojs.Plugin {
  /**
...
Instantiable1[/* player */ Player, typingsSlinky.videoDotJs.videoDotJsMod.videojs.Plugin]
  ...
  /**
    ...
    */
  def getPlugins(): StringDictionary[typingsSlinky.videoDotJs.videoDotJsMod.videojs.Plugin] = js.native
  def getPlugins(names: js.Array[String]): StringDictionary[typingsSlinky.videoDotJs.videoDotJsMod.videojs.Plugin] = js.native
  /**
