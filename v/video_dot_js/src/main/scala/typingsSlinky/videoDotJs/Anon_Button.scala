...
Instantiable1[/* player */ Player, Component]
  ...
  @JSName("getComponent")
  def getComponent_Component(name: typingsSlinky.videoDotJs.videoDotJsStrings.Component): /* import warning: importer.ImportType#apply Failed type conversion: typeof Component */ js.Any = js.native
  @JSName("getComponent")
  ...
  @JSName("getComponent")
  def getComponent_Player(name: typingsSlinky.videoDotJs.videoDotJsStrings.Player): /* import warning: importer.ImportType#apply Failed type conversion: typeof Player */ js.Any = js.native
  @JSName("getComponent")
