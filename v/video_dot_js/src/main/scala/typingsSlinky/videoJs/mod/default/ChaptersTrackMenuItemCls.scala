...
import typingsSlinky.videoJs.mod.videojs.ChaptersTrackMenuItem
...
@JSImport("video.js", "default.ChaptersTrackMenuItem")
@js.native
class ChaptersTrackMenuItemCls protected () extends ChaptersTrackMenuItem {
  ...
  def this(player: typingsSlinky.videoJs.mod.videojs.Player, options: ChaptersTrackMenuItemOptions) = this()
}
