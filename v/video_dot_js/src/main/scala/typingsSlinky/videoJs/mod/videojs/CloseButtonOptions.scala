...
object CloseButtonOptions {
  ...
  implicit class CloseButtonOptionsOps[Self <: CloseButtonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControlText(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("controlText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutControlText: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("controlText")(js.undefined)
        ret
    }
  }
