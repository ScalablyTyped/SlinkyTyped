...
import typingsSlinky.videoJs.mod.videojs.ChaptersButton
...
@JSImport("video.js", "default.ChaptersButton")
@js.native
class ChaptersButtonCls protected () extends ChaptersButton {
  /**
