...
import typingsSlinky.videoJs.mod.videojs.SeekBar
...
@JSImport("video.js", "default.SeekBar")
@js.native
class SeekBarCls protected () extends SeekBar {
  ...
  def this(player: typingsSlinky.videoJs.mod.videojs.Player, options: SliderOptions) = this()
}
