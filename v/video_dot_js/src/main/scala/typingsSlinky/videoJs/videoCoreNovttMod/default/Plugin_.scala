...
import typingsSlinky.videoJs.anon.TypeofPlugin
...
object Plugin_ {
  ...
  class ^ protected () extends Plugin {
    ...
    def this(player: typingsSlinky.videoJs.mod.videojs.Player, options: js.Any) = this()
  }
  ...
  /**
    ...
    *
    */
  @JSImport("video.js/dist/alt/video.core.novtt", "default.Plugin.BASE_PLUGIN_NAME")
  @js.native
  ...
  def registerPlugin[T, K](
    name: String,
    plugin: js.ThisFunction1[/* this */ typingsSlinky.videoJs.mod.videojs.Player, /* repeated */ K, T]
