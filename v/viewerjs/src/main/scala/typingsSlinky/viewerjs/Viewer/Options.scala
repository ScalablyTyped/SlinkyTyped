...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHidden(value: /* event */ CustomEvent => Unit): Self = this.set("hidden", js.Any.fromFunction1(value))
    @scala.inline
    def deleteHidden: Self = this.set("hidden", js.undefined)
    @scala.inline
    def setHide(value: /* event */ CustomEvent => Unit): Self = this.set("hide", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setShow(value: /* event */ CustomEvent => Unit): Self = this.set("show", js.Any.fromFunction1(value))
    @scala.inline
    def deleteShow: Self = this.set("show", js.undefined)
    @scala.inline
    def setShown(value: /* event */ CustomEvent => Unit): Self = this.set("shown", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setView(value: /* event */ CustomEvent => Unit): Self = this.set("view", js.Any.fromFunction1(value))
    @scala.inline
    def deleteView: Self = this.set("view", js.undefined)
    @scala.inline
    def setViewed(value: /* event */ CustomEvent => Unit): Self = this.set("viewed", js.Any.fromFunction1(value))
    @scala.inline
