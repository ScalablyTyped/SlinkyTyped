package typingsSlinky.vinyl.vinylMod
...
import typingsSlinky.vinyl.Anon_ContentsDeep
import typingsSlinky.vinyl.Anon_End
...
trait File
  ...
  def clone(opts: Anon_ContentsDeep): this.type = js.native
  /**
  ...
  def pipe[T /* <: WritableStream */](stream: T, opts: Anon_End): T = js.native
}
