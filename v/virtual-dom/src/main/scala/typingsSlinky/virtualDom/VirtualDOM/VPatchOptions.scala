...
object VPatchOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Element */ T](): VPatchOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VPatchOptions[T]]
  }
  @scala.inline
  implicit class VPatchOptionsOps[Self <: VPatchOptions[_], /* <: typingsSlinky.std.Element */ T] (val x: Self with VPatchOptions[T]) extends AnyVal {
    @scala.inline
