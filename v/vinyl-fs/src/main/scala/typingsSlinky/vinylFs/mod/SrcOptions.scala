...
object SrcOptions {
  ...
  implicit class SrcOptionsOps[Self <: SrcOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSinceDate(value: js.Date): Self = this.set("since", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSince(value: js.Date | Double): Self = this.set("since", value.asInstanceOf[js.Any])
