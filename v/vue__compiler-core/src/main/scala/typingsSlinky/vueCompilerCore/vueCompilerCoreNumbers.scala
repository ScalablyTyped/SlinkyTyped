...
import typingsSlinky.vueCompilerCore.mod.ElementTypes
import typingsSlinky.vueCompilerCore.mod.ErrorCodes
import typingsSlinky.vueCompilerCore.mod.NodeTypes
import typingsSlinky.vueCompilerCore.mod.TextModes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object vueCompilerCoreNumbers {
  
  @js.native
  sealed trait `0`
    extends ElementTypes
       with ErrorCodes
       with NodeTypes
       with TextModes
  @scala.inline
  ...
  @js.native
  sealed trait `27` extends ErrorCodes
  @scala.inline
  def `27`: `27` = 27.asInstanceOf[`27`]
  
  @js.native
  sealed trait `28` extends ErrorCodes
  @scala.inline
  def `28`: `28` = 28.asInstanceOf[`28`]
  
  @js.native
  sealed trait `29` extends ErrorCodes
  @scala.inline
