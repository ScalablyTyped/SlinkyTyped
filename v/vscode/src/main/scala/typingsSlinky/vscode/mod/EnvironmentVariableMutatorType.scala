...
object EnvironmentVariableMutatorType extends StObject {
  ...
  /* 2 */ val Append: typingsSlinky.vscode.mod.EnvironmentVariableMutatorType.Append with Double = js.native
  ...
  /* 3 */ val Prepend: typingsSlinky.vscode.mod.EnvironmentVariableMutatorType.Prepend with Double = js.native
  ...
  /* 1 */ val Replace: typingsSlinky.vscode.mod.EnvironmentVariableMutatorType.Replace with Double = js.native
}
