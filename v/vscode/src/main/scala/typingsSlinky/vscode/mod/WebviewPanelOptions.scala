...
object WebviewPanelOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableFindWidget)) __obj.updateDynamic("enableFindWidget")(enableFindWidget.get.asInstanceOf[js.Any])
    if (!js.isUndefined(retainContextWhenHidden)) __obj.updateDynamic("retainContextWhenHidden")(retainContextWhenHidden.get.asInstanceOf[js.Any])
