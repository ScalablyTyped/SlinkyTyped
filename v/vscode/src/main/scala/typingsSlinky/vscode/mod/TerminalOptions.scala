...
object TerminalOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(hideFromUser)) __obj.updateDynamic("hideFromUser")(hideFromUser.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(strictEnv)) __obj.updateDynamic("strictEnv")(strictEnv.get.asInstanceOf[js.Any])
