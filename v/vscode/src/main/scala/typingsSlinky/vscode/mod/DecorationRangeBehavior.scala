...
object DecorationRangeBehavior extends StObject {
  ...
  /* 1 */ val ClosedClosed: typingsSlinky.vscode.mod.DecorationRangeBehavior.ClosedClosed with Double = js.native
  ...
  /* 3 */ val ClosedOpen: typingsSlinky.vscode.mod.DecorationRangeBehavior.ClosedOpen with Double = js.native
  ...
  /* 2 */ val OpenClosed: typingsSlinky.vscode.mod.DecorationRangeBehavior.OpenClosed with Double = js.native
  ...
  /* 0 */ val OpenOpen: typingsSlinky.vscode.mod.DecorationRangeBehavior.OpenOpen with Double = js.native
}
