...
object IndentAction extends StObject {
  ...
  /* 1 */ val Indent: typingsSlinky.vscode.mod.IndentAction.Indent with Double = js.native
  ...
  /* 2 */ val IndentOutdent: typingsSlinky.vscode.mod.IndentAction.IndentOutdent with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vscode.mod.IndentAction.None with Double = js.native
  ...
  /* 3 */ val Outdent: typingsSlinky.vscode.mod.IndentAction.Outdent with Double = js.native
}
