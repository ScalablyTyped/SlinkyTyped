...
object CallHierarchyProvider {
  ...
  implicit class CallHierarchyProviderOps[Self <: CallHierarchyProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPrepareCallHierarchy(
      value: (TextDocument, Position, CancellationToken) => ProviderResult[CallHierarchyItem | js.Array[CallHierarchyItem]]
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("prepareCallHierarchy")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withProvideCallHierarchyIncomingCalls(
      value: (CallHierarchyItem, CancellationToken) => ProviderResult[js.Array[CallHierarchyIncomingCall]]
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideCallHierarchyIncomingCalls")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withProvideCallHierarchyOutgoingCalls(
      value: (CallHierarchyItem, CancellationToken) => ProviderResult[js.Array[CallHierarchyOutgoingCall]]
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideCallHierarchyOutgoingCalls")(js.Any.fromFunction2(value))
        ret
    }
  }
