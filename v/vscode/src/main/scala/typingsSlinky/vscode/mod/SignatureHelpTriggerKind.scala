...
object SignatureHelpTriggerKind extends StObject {
  ...
  /* 3 */ val ContentChange: typingsSlinky.vscode.mod.SignatureHelpTriggerKind.ContentChange with Double = js.native
  ...
  /* 1 */ val Invoke: typingsSlinky.vscode.mod.SignatureHelpTriggerKind.Invoke with Double = js.native
  ...
  /* 2 */ val TriggerCharacter: typingsSlinky.vscode.mod.SignatureHelpTriggerKind.TriggerCharacter with Double = js.native
}
