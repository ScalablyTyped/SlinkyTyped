...
object ShellQuoting extends StObject {
  ...
  /* 1 */ val Escape: typingsSlinky.vscode.mod.ShellQuoting.Escape with Double = js.native
  ...
  /* 2 */ val Strong: typingsSlinky.vscode.mod.ShellQuoting.Strong with Double = js.native
  ...
  /* 3 */ val Weak: typingsSlinky.vscode.mod.ShellQuoting.Weak with Double = js.native
}
