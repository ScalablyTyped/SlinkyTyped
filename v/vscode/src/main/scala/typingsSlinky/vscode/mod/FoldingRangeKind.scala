...
object FoldingRangeKind extends StObject {
  ...
  /* 1 */ val Comment: typingsSlinky.vscode.mod.FoldingRangeKind.Comment with Double = js.native
  ...
  /* 2 */ val Imports: typingsSlinky.vscode.mod.FoldingRangeKind.Imports with Double = js.native
  ...
  /* 3 */ val Region: typingsSlinky.vscode.mod.FoldingRangeKind.Region with Double = js.native
}
