...
object TextEditorRevealType extends StObject {
  ...
  /* 3 */ val AtTop: typingsSlinky.vscode.mod.TextEditorRevealType.AtTop with Double = js.native
  ...
  /* 0 */ val Default: typingsSlinky.vscode.mod.TextEditorRevealType.Default with Double = js.native
  ...
  /* 1 */ val InCenter: typingsSlinky.vscode.mod.TextEditorRevealType.InCenter with Double = js.native
  ...
  /* 2 */ val InCenterIfOutsideViewport: typingsSlinky.vscode.mod.TextEditorRevealType.InCenterIfOutsideViewport with Double = js.native
}
