...
object DiagnosticSeverity extends StObject {
  ...
  /* 0 */ val Error: typingsSlinky.vscode.mod.DiagnosticSeverity.Error with Double = js.native
  ...
  /* 3 */ val Hint: typingsSlinky.vscode.mod.DiagnosticSeverity.Hint with Double = js.native
  ...
  /* 2 */ val Information: typingsSlinky.vscode.mod.DiagnosticSeverity.Information with Double = js.native
  ...
  /* 1 */ val Warning: typingsSlinky.vscode.mod.DiagnosticSeverity.Warning with Double = js.native
}
