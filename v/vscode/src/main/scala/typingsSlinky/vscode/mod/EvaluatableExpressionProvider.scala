...
object EvaluatableExpressionProvider {
  ...
  implicit class EvaluatableExpressionProviderOps[Self <: EvaluatableExpressionProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProvideEvaluatableExpression(value: (TextDocument, Position, CancellationToken) => ProviderResult[EvaluatableExpression]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideEvaluatableExpression")(js.Any.fromFunction3(value))
        ret
    }
  }
