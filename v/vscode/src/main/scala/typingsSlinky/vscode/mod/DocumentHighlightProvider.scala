...
object DocumentHighlightProvider {
  ...
  implicit class DocumentHighlightProviderOps[Self <: DocumentHighlightProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProvideDocumentHighlights(value: (TextDocument, Position, CancellationToken) => ProviderResult[js.Array[DocumentHighlight]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideDocumentHighlights")(js.Any.fromFunction3(value))
        ret
    }
  }
