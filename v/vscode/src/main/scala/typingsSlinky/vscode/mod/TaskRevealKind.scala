...
object TaskRevealKind extends StObject {
  ...
  /* 1 */ val Always: typingsSlinky.vscode.mod.TaskRevealKind.Always with Double = js.native
  ...
  /* 3 */ val Never: typingsSlinky.vscode.mod.TaskRevealKind.Never with Double = js.native
  ...
  /* 2 */ val Silent: typingsSlinky.vscode.mod.TaskRevealKind.Silent with Double = js.native
}
