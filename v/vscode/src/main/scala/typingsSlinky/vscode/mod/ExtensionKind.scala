...
object ExtensionKind extends StObject {
  ...
  /* 1 */ val UI: typingsSlinky.vscode.mod.ExtensionKind.UI with Double = js.native
  ...
  /* 2 */ val Workspace: typingsSlinky.vscode.mod.ExtensionKind.Workspace with Double = js.native
}
