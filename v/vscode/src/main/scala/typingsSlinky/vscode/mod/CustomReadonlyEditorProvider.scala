...
object CustomReadonlyEditorProvider {
  ...
  @scala.inline
  implicit class CustomReadonlyEditorProviderOps[Self <: CustomReadonlyEditorProvider[_], /* <: typingsSlinky.vscode.mod.CustomDocument */ T] (val x: Self with CustomReadonlyEditorProvider[T]) extends AnyVal {
    @scala.inline
