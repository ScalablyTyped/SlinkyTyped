...
object CodeLensProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.CodeLens */ T](provideCodeLenses: (TextDocument, CancellationToken) => ProviderResult[js.Array[T]]): CodeLensProvider[T] = {
  ...
  @scala.inline
  implicit class CodeLensProviderOps[Self <: CodeLensProvider[_], /* <: typingsSlinky.vscode.mod.CodeLens */ T] (val x: Self with CodeLensProvider[T]) extends AnyVal {
    @scala.inline
