...
object OpenDialogOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(canSelectFiles)) __obj.updateDynamic("canSelectFiles")(canSelectFiles.get.asInstanceOf[js.Any])
    if (!js.isUndefined(canSelectFolders)) __obj.updateDynamic("canSelectFolders")(canSelectFolders.get.asInstanceOf[js.Any])
