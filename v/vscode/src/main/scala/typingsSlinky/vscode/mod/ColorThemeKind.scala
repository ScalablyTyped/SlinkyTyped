...
object ColorThemeKind extends StObject {
  ...
  /* 2 */ val Dark: typingsSlinky.vscode.mod.ColorThemeKind.Dark with Double = js.native
  
  @js.native
  sealed trait HighContrast extends ColorThemeKind
  /* 3 */ val HighContrast: typingsSlinky.vscode.mod.ColorThemeKind.HighContrast with Double = js.native
  
  @js.native
  sealed trait Light extends ColorThemeKind
  /* 1 */ val Light: typingsSlinky.vscode.mod.ColorThemeKind.Light with Double = js.native
}
