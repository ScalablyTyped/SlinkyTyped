...
object CustomTextEditorProvider {
  ...
  implicit class CustomTextEditorProviderOps[Self <: CustomTextEditorProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResolveCustomTextEditor(value: (TextDocument, WebviewPanel, CancellationToken) => Thenable[Unit] | Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveCustomTextEditor")(js.Any.fromFunction3(value))
        ret
    }
  }
