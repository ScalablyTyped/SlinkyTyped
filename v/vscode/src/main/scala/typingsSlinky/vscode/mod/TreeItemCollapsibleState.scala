...
object TreeItemCollapsibleState extends StObject {
  ...
  /* 1 */ val Collapsed: typingsSlinky.vscode.mod.TreeItemCollapsibleState.Collapsed with Double = js.native
  ...
  /* 2 */ val Expanded: typingsSlinky.vscode.mod.TreeItemCollapsibleState.Expanded with Double = js.native
  ...
  /* 0 */ val None: typingsSlinky.vscode.mod.TreeItemCollapsibleState.None with Double = js.native
}
