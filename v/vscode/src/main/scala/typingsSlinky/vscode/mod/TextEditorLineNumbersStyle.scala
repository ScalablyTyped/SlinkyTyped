...
object TextEditorLineNumbersStyle extends StObject {
  ...
  /* 0 */ val Off: typingsSlinky.vscode.mod.TextEditorLineNumbersStyle.Off with Double = js.native
  ...
  /* 1 */ val On: typingsSlinky.vscode.mod.TextEditorLineNumbersStyle.On with Double = js.native
  ...
  /* 2 */ val Relative: typingsSlinky.vscode.mod.TextEditorLineNumbersStyle.Relative with Double = js.native
}
