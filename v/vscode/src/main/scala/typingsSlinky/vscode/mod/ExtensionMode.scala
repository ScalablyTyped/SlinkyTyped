...
object ExtensionMode extends StObject {
  ...
  /* 2 */ val Development: typingsSlinky.vscode.mod.ExtensionMode.Development with Double = js.native
  ...
  /* 1 */ val Production: typingsSlinky.vscode.mod.ExtensionMode.Production with Double = js.native
  ...
  /* 3 */ val Test: typingsSlinky.vscode.mod.ExtensionMode.Test with Double = js.native
}
