...
object CodeActionProviderMetadata {
  ...
  implicit class CodeActionProviderMetadataOps[Self <: CodeActionProviderMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocumentationVarargs(value: typingsSlinky.vscode.anon.Command*): Self = this.set("documentation", js.Array(value :_*))
    
    @scala.inline
    def setDocumentation(value: js.Array[typingsSlinky.vscode.anon.Command]): Self = this.set("documentation", value.asInstanceOf[js.Any])
