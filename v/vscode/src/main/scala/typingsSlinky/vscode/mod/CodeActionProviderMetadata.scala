...
trait CodeActionProviderMetadata extends StObject {
  ...
  /**
    ...
    */
  val documentation: js.UndefOr[js.Array[typingsSlinky.vscode.anon.Command]] = js.native
...
object CodeActionProviderMetadata {
  ...
  implicit class CodeActionProviderMetadataMutableBuilder[Self <: CodeActionProviderMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDocumentation(value: js.Array[typingsSlinky.vscode.anon.Command]): Self = StObject.set(x, "documentation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDocumentationUndefined: Self = StObject.set(x, "documentation", js.undefined)
    
    @scala.inline
    def setDocumentationVarargs(value: typingsSlinky.vscode.anon.Command*): Self = StObject.set(x, "documentation", js.Array(value :_*))
