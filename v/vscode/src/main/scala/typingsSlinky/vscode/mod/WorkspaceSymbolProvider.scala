...
object WorkspaceSymbolProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.SymbolInformation */ T](provideWorkspaceSymbols: (String, CancellationToken) => ProviderResult[js.Array[T]]): WorkspaceSymbolProvider[T] = {
  ...
  @scala.inline
  implicit class WorkspaceSymbolProviderOps[Self <: WorkspaceSymbolProvider[_], /* <: typingsSlinky.vscode.mod.SymbolInformation */ T] (val x: Self with WorkspaceSymbolProvider[T]) extends AnyVal {
    @scala.inline
