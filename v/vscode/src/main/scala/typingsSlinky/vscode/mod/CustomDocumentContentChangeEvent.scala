...
object CustomDocumentContentChangeEvent {
  ...
  @scala.inline
  implicit class CustomDocumentContentChangeEventOps[Self <: CustomDocumentContentChangeEvent[_], T /* <: CustomDocument */] (val x: Self with CustomDocumentContentChangeEvent[T]) extends AnyVal {
