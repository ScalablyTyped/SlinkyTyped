...
object CustomDocumentContentChangeEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.CustomDocument */ T](document: T): CustomDocumentContentChangeEvent[T] = {
    val __obj = js.Dynamic.literal(document = document.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomDocumentContentChangeEvent[T]]
  }
  @scala.inline
  implicit class CustomDocumentContentChangeEventOps[Self <: CustomDocumentContentChangeEvent[_], /* <: typingsSlinky.vscode.mod.CustomDocument */ T] (val x: Self with CustomDocumentContentChangeEvent[T]) extends AnyVal {
    @scala.inline
