...
object TextDocumentSaveReason extends StObject {
  ...
  /* 2 */ val AfterDelay: typingsSlinky.vscode.mod.TextDocumentSaveReason.AfterDelay with Double = js.native
  ...
  /* 3 */ val FocusOut: typingsSlinky.vscode.mod.TextDocumentSaveReason.FocusOut with Double = js.native
  ...
  /* 1 */ val Manual: typingsSlinky.vscode.mod.TextDocumentSaveReason.Manual with Double = js.native
}
