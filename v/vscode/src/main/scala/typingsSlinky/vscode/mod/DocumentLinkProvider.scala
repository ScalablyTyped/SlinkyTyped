...
object DocumentLinkProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.DocumentLink */ T](provideDocumentLinks: (TextDocument, CancellationToken) => ProviderResult[js.Array[T]]): DocumentLinkProvider[T] = {
  ...
  @scala.inline
  implicit class DocumentLinkProviderOps[Self <: DocumentLinkProvider[_], /* <: typingsSlinky.vscode.mod.DocumentLink */ T] (val x: Self with DocumentLinkProvider[T]) extends AnyVal {
    @scala.inline
