...
object CompletionTriggerKind extends StObject {
  ...
  /* 0 */ val Invoke: typingsSlinky.vscode.mod.CompletionTriggerKind.Invoke with Double = js.native
  ...
  /* 1 */ val TriggerCharacter: typingsSlinky.vscode.mod.CompletionTriggerKind.TriggerCharacter with Double = js.native
  ...
  /* 2 */ val TriggerForIncompleteCompletions: typingsSlinky.vscode.mod.CompletionTriggerKind.TriggerForIncompleteCompletions with Double = js.native
}
