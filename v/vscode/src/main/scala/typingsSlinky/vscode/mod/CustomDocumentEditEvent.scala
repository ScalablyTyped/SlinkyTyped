...
object CustomDocumentEditEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.CustomDocument */ T](document: T, redo: () => Thenable[Unit] | Unit, undo: () => Thenable[Unit] | Unit): CustomDocumentEditEvent[T] = {
  ...
  @scala.inline
  implicit class CustomDocumentEditEventOps[Self <: CustomDocumentEditEvent[_], /* <: typingsSlinky.vscode.mod.CustomDocument */ T] (val x: Self with CustomDocumentEditEvent[T]) extends AnyVal {
    @scala.inline
