...
object FileChangeType extends StObject {
  ...
  /* 1 */ val Changed: typingsSlinky.vscode.mod.FileChangeType.Changed with Double = js.native
  ...
  /* 2 */ val Created: typingsSlinky.vscode.mod.FileChangeType.Created with Double = js.native
  ...
  /* 3 */ val Deleted: typingsSlinky.vscode.mod.FileChangeType.Deleted with Double = js.native
}
