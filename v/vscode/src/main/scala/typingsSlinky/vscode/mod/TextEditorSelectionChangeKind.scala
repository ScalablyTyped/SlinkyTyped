...
object TextEditorSelectionChangeKind extends StObject {
  ...
  /* 3 */ val Command: typingsSlinky.vscode.mod.TextEditorSelectionChangeKind.Command with Double = js.native
  ...
  /* 1 */ val Keyboard: typingsSlinky.vscode.mod.TextEditorSelectionChangeKind.Keyboard with Double = js.native
  ...
  /* 2 */ val Mouse: typingsSlinky.vscode.mod.TextEditorSelectionChangeKind.Mouse with Double = js.native
}
