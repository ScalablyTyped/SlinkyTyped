...
object TaskScope extends StObject {
  ...
  /* 1 */ val Global: typingsSlinky.vscode.mod.TaskScope.Global with Double = js.native
  ...
  /* 2 */ val Workspace: typingsSlinky.vscode.mod.TaskScope.Workspace with Double = js.native
}
