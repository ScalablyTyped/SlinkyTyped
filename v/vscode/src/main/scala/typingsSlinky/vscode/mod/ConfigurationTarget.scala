...
object ConfigurationTarget extends StObject {
  ...
  /* 1 */ val Global: typingsSlinky.vscode.mod.ConfigurationTarget.Global with Double = js.native
  ...
  /* 2 */ val Workspace: typingsSlinky.vscode.mod.ConfigurationTarget.Workspace with Double = js.native
  ...
  /* 3 */ val WorkspaceFolder: typingsSlinky.vscode.mod.ConfigurationTarget.WorkspaceFolder with Double = js.native
}
