...
object DocumentSemanticTokensProvider {
  ...
  def apply(
    ...
    onDidChangeSemanticTokens: (/* listener */ js.Function1[Unit, js.Any], /* thisArgs */ js.UndefOr[js.Any], /* disposables */ js.UndefOr[js.Array[Disposable]]) => Disposable = null,
    ...
    if (onDidChangeSemanticTokens != null) __obj.updateDynamic("onDidChangeSemanticTokens")(js.Any.fromFunction3(onDidChangeSemanticTokens))
