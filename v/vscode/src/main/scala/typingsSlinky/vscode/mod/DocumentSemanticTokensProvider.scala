...
object DocumentSemanticTokensProvider {
  ...
  implicit class DocumentSemanticTokensProviderOps[Self <: DocumentSemanticTokensProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProvideDocumentSemanticTokens(value: (TextDocument, CancellationToken) => ProviderResult[SemanticTokens]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideDocumentSemanticTokens")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withOnDidChangeSemanticTokens(
      value: (/* listener */ js.Function1[Unit, js.Any], /* thisArgs */ js.UndefOr[js.Any], /* disposables */ js.UndefOr[js.Array[Disposable]]) => Disposable
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onDidChangeSemanticTokens")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withoutOnDidChangeSemanticTokens: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onDidChangeSemanticTokens")(js.undefined)
        ret
    }
    @scala.inline
    def withProvideDocumentSemanticTokensEdits(
      value: (/* document */ TextDocument, /* previousResultId */ String, /* token */ CancellationToken) => ProviderResult[SemanticTokens | SemanticTokensEdits]
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideDocumentSemanticTokensEdits")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withoutProvideDocumentSemanticTokensEdits: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("provideDocumentSemanticTokensEdits")(js.undefined)
        ret
    }
  }
