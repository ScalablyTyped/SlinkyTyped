...
object CommentMode extends StObject {
  ...
  /* 0 */ val Editing: typingsSlinky.vscode.mod.CommentMode.Editing with Double = js.native
  ...
  /* 1 */ val Preview: typingsSlinky.vscode.mod.CommentMode.Preview with Double = js.native
}
