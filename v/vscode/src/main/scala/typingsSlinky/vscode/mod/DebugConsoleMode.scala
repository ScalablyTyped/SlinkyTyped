...
object DebugConsoleMode extends StObject {
  ...
  /* 1 */ val MergeWithParent: typingsSlinky.vscode.mod.DebugConsoleMode.MergeWithParent with Double = js.native
  ...
  /* 0 */ val Separate: typingsSlinky.vscode.mod.DebugConsoleMode.Separate with Double = js.native
}
