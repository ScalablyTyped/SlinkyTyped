...
object CommentThreadCollapsibleState extends StObject {
  ...
  /* 0 */ val Collapsed: typingsSlinky.vscode.mod.CommentThreadCollapsibleState.Collapsed with Double = js.native
  ...
  /* 1 */ val Expanded: typingsSlinky.vscode.mod.CommentThreadCollapsibleState.Expanded with Double = js.native
}
