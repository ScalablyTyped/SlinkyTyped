...
object CompletionItemProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.CompletionItem */ T](
  ...
  @scala.inline
  implicit class CompletionItemProviderOps[Self <: CompletionItemProvider[_], /* <: typingsSlinky.vscode.mod.CompletionItem */ T] (val x: Self with CompletionItemProvider[T]) extends AnyVal {
    @scala.inline
