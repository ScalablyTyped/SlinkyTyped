...
object DebugConfigurationProviderTriggerKind extends StObject {
  ...
  /* 2 */ val Dynamic: typingsSlinky.vscode.mod.DebugConfigurationProviderTriggerKind.Dynamic with Double = js.native
  ...
  /* 1 */ val Initial: typingsSlinky.vscode.mod.DebugConfigurationProviderTriggerKind.Initial with Double = js.native
}
