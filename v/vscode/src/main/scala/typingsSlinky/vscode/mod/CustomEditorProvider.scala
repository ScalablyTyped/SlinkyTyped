...
object CustomEditorProvider {
  @scala.inline
  def apply[/* <: typingsSlinky.vscode.mod.CustomDocument */ T](
  ...
  @scala.inline
  implicit class CustomEditorProviderOps[Self <: CustomEditorProvider[_], /* <: typingsSlinky.vscode.mod.CustomDocument */ T] (val x: Self with CustomEditorProvider[T]) extends AnyVal {
    @scala.inline
