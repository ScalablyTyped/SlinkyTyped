...
import typingsSlinky.vscode.Anon_Create
import typingsSlinky.vscode.Anon_Excludes
import typingsSlinky.vscode.Anon_Overwrite
import typingsSlinky.vscode.Anon_Recursive
...
trait FileSystemProvider extends js.Object {
  ...
  /**
  		 ...
  		 * @throws [`NoPermissions`](#FileSystemError.NoPermissions) when permissions aren't sufficient.
  		 */
  def writeFile(uri: Uri, content: scala.scalajs.js.typedarray.Uint8Array, options: Anon_Create): Unit | Thenable[Unit] = js.native
}
