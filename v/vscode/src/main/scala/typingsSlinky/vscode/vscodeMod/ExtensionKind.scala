...
object ExtensionKind extends js.Object {
  ...
  /* 1 */ val UI: typingsSlinky.vscode.vscodeMod.ExtensionKind.UI with Double = js.native
  /* 2 */ val Workspace: typingsSlinky.vscode.vscodeMod.ExtensionKind.Workspace with Double = js.native
  @JSBracketAccess
