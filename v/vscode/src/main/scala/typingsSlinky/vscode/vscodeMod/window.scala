...
import typingsSlinky.vscode.Anon_CanPickMany
import typingsSlinky.vscode.Anon_Increment
import typingsSlinky.vscode.Anon_PreserveFocus
...
object window extends js.Object {
  ...
  def createWebviewPanel(viewType: String, title: String, showOptions: Anon_PreserveFocus): WebviewPanel = js.native
  def createWebviewPanel(
    viewType: String,
    title: String,
    showOptions: Anon_PreserveFocus,
  ...
  def showQuickPick(items: js.Array[String], options: (QuickPickOptions with Anon_CanPickMany) | QuickPickOptions): Thenable[js.UndefOr[js.Array[String]]] = js.native
  def showQuickPick(
    items: js.Array[String],
    options: (QuickPickOptions with Anon_CanPickMany) | QuickPickOptions,
  ...
  @JSName("showQuickPick")
  def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: js.Array[T], options: (QuickPickOptions with Anon_CanPickMany) | QuickPickOptions): Thenable[js.UndefOr[js.Array[T]]] = js.native
  @JSName("showQuickPick")
  ...
  @JSName("showQuickPick")
  def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: Thenable[js.Array[T]], options: (QuickPickOptions with Anon_CanPickMany) | QuickPickOptions): Thenable[js.UndefOr[js.Array[T]]] = js.native
  @JSName("showQuickPick")
  def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](
  ...
  def withProgress[R](
    ...
    task: js.Function2[/* progress */ Progress[Anon_Increment], /* token */ CancellationToken, Thenable[R]]
