...
import typingsSlinky.vscode.Anon_Character
import typingsSlinky.vscode.Anon_CharacterDelta
...
class Position protected () extends js.Object {
  ...
  /**
  		 ...
  		 */
  def translate(change: Anon_CharacterDelta): Position = js.native
  ...
  /**
  		 ...
  		 * is not changing anything.
  		 */
  def `with`(change: Anon_Character): Position = js.native
