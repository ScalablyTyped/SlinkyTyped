...
object FileChangeType extends js.Object {
  ...
  /* 1 */ val Changed: typingsSlinky.vscode.vscodeMod.FileChangeType.Changed with Double = js.native
  /* 2 */ val Created: typingsSlinky.vscode.vscodeMod.FileChangeType.Created with Double = js.native
  /* 3 */ val Deleted: typingsSlinky.vscode.vscodeMod.FileChangeType.Deleted with Double = js.native
  @JSBracketAccess
