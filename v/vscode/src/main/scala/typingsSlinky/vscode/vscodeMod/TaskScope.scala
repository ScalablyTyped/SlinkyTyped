...
object TaskScope extends js.Object {
  ...
  /* 1 */ val Global: typingsSlinky.vscode.vscodeMod.TaskScope.Global with Double = js.native
  /* 2 */ val Workspace: typingsSlinky.vscode.vscodeMod.TaskScope.Workspace with Double = js.native
  @JSBracketAccess
