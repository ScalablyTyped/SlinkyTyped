...
object CompletionItemKind extends js.Object {
  ...
  /* 15 */ @js.native
  object Color
    extends TopLevel[typingsSlinky.vscode.vscodeMod.CompletionItemKind.Color with Double]
  ...
  /* 22 */ @js.native
  object Event
    extends TopLevel[typingsSlinky.vscode.vscodeMod.CompletionItemKind.Event with Double]
