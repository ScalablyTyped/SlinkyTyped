...
object CommentMode extends js.Object {
  ...
  /* 0 */ val Editing: typingsSlinky.vscode.vscodeMod.CommentMode.Editing with Double = js.native
  /* 1 */ val Preview: typingsSlinky.vscode.vscodeMod.CommentMode.Preview with Double = js.native
  @JSBracketAccess
