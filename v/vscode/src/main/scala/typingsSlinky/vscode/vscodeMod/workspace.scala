...
import typingsSlinky.vscode.Anon_Content
import typingsSlinky.vscode.Anon_IsCaseSensitive
import typingsSlinky.vscode.Anon_Name
...
object workspace extends js.Object {
  ...
  def openTextDocument(options: Anon_Content): Thenable[TextDocument] = js.native
  ...
  def registerFileSystemProvider(scheme: String, provider: FileSystemProvider, options: Anon_IsCaseSensitive): Disposable = js.native
  ...
  def updateWorkspaceFolders(start: Double, deleteCount: Double, workspaceFoldersToAdd: Anon_Name*): Boolean = js.native
  def updateWorkspaceFolders(start: Double, workspaceFoldersToAdd: Anon_Name*): Boolean = js.native
}
