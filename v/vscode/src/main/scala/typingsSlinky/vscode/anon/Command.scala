...
import typingsSlinky.vscode.mod.CodeActionKind
...
trait Command extends StObject {
  ...
  /**
    ...
    */
  val command: typingsSlinky.vscode.mod.Command = js.native
...
object Command {
  ...
  @scala.inline
  def apply(command: typingsSlinky.vscode.mod.Command, kind: CodeActionKind): Command = {
  ...
  implicit class CommandMutableBuilder[Self <: Command] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommand(value: typingsSlinky.vscode.mod.Command): Self = StObject.set(x, "command", value.asInstanceOf[js.Any])
