...
object uuidMod {
  ...
  @JSImport("vscode-languageserver/lib/utils/uuid", "empty")
  @js.native
  val empty: UUID = js.native
  
  @JSImport("vscode-languageserver/lib/utils/uuid", "generateUuid")
  @js.native
  def generateUuid(): String = js.native
  
  @JSImport("vscode-languageserver/lib/utils/uuid", "isUUID")
  @js.native
  def isUUID(value: String): Boolean = js.native
  
  @JSImport("vscode-languageserver/lib/utils/uuid", "parse")
  @js.native
  def parse(value: String): UUID = js.native
  
  @JSImport("vscode-languageserver/lib/utils/uuid", "v4")
  @js.native
