...
trait TextDocumentWillSaveEvent[T] extends StObject {
  ...
  /**
    ...
    */
  var reason: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.TextDocumentSaveReason = js.native
}
object TextDocumentWillSaveEvent {
  
  @scala.inline
  def apply[T](document: T, reason: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.TextDocumentSaveReason): TextDocumentWillSaveEvent[T] = {
  ...
  implicit class TextDocumentWillSaveEventMutableBuilder[Self <: TextDocumentWillSaveEvent[_], T] (val x: Self with TextDocumentWillSaveEvent[T]) extends AnyVal {
    ...
    @scala.inline
    def setReason(value: typingsSlinky.vscodeLanguageserverProtocol.protocolMod.TextDocumentSaveReason): Self = StObject.set(x, "reason", value.asInstanceOf[js.Any])
  }
}
