...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.TextDocumentSaveRegistrationOptions
...
object DidSaveTextDocumentNotification extends js.Object {
  val `type`: typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[DidSaveTextDocumentParams, TextDocumentSaveRegistrationOptions] = js.native
}
