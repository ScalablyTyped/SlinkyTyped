...
import typingsSlinky.vscodeDashLanguageserver.vscodeDashLanguageserverStrings.features
...
object Features {
  ...
  def apply[PConsole, PTracer, PTelemetry, PClient, PWindow, PWorkspace](
    ...
    tracer: /* Base */ Instantiable0[typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.Tracer] => Instantiable0[typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.Tracer with PTracer] = null,
