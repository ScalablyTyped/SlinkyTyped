...
trait RangeError extends Error {
  ...
  @JSName("name")
  var name_RangeError: typingsSlinky.vimeoPlayer.vimeoPlayerStrings.RangeError = js.native
}
object RangeError {
  ...
  implicit class RangeErrorMutableBuilder[Self <: RangeError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.vimeoPlayer.vimeoPlayerStrings.RangeError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
  }
}
