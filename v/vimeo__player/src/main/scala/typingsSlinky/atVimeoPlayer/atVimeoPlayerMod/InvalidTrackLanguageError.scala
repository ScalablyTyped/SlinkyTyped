...
trait InvalidTrackLanguageError extends Error {
  @JSName("name")
  var name_InvalidTrackLanguageError: typingsSlinky.atVimeoPlayer.atVimeoPlayerStrings.InvalidTrackLanguageError
}
...
object InvalidTrackLanguageError {
  ...
  def apply(
    message: String,
    method: String,
    name: typingsSlinky.atVimeoPlayer.atVimeoPlayerStrings.InvalidTrackLanguageError
