...
object anon {
  ...
  object AppendToBody {
    ...
    implicit class AppendToBodyMutableBuilder[Self <: AppendToBody] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisabledDate(value: /* date */ js.Date => Boolean): Self = StObject.set(x, "disabledDate", js.Any.fromFunction1(value))
      
      @scala.inline
      def setDisabledDateUndefined: Self = StObject.set(x, "disabledDate", js.undefined)
      
      @scala.inline
      def setDisabledTime(value: /* date */ js.Date => Boolean): Self = StObject.set(x, "disabledTime", js.Any.fromFunction1(value))
