...
object AppendToBody {
  ...
  implicit class AppendToBodyOps[Self <: AppendToBody] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledDate(value: /* date */ js.Date => Boolean): Self = this.set("disabledDate", js.Any.fromFunction1(value))
    @scala.inline
    def deleteDisabledDate: Self = this.set("disabledDate", js.undefined)
    @scala.inline
    def setDisabledTime(value: /* date */ js.Date => Boolean): Self = this.set("disabledTime", js.Any.fromFunction1(value))
    @scala.inline
