...
import typingsSlinky.vue2DashDatepicker.vue2DashDatepickerMod.Datepicker.TimeSelectOptions
...
trait Anon_AppendToBody extends js.Object {
  ...
  var disabledDays: js.UndefOr[
    (js.Array[Double | String]) | (js.Function1[/* date */ js.Date, js.Array[js.Date]])
  ] = js.undefined
  ...
  var notAfter: js.UndefOr[String | js.Date] = js.undefined
  var notBefore: js.UndefOr[String | js.Date] = js.undefined
...
object Anon_AppendToBody {
  ...
  def apply(
    ...
    disabledDays: (js.Array[Double | String]) | (js.Function1[/* date */ js.Date, js.Array[js.Date]]) = null,
    ...
    notAfter: String | js.Date = null,
    notBefore: String | js.Date = null,
