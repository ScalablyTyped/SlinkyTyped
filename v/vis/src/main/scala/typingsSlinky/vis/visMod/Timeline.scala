...
import typingsSlinky.vis.Anon_Animation
import typingsSlinky.vis.Anon_Groups
import typingsSlinky.vis.Anon_Max
...
class Timeline protected () extends js.Object {
  ...
  /**
    ...
    */
  def getItemRange(): Anon_Max = js.native
  /**
  ...
  def setSelection(ids: js.Array[IdType], options: Anon_Animation): Unit = js.native
  /**
  ...
  def setSelection(ids: IdType, options: Anon_Animation): Unit = js.native
