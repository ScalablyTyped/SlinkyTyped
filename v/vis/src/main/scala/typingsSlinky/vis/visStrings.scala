...
import typingsSlinky.vis.mod.DirectionType
import typingsSlinky.vis.mod.EasingFunction
import typingsSlinky.vis.mod.Graph2dBarChartAlign
import typingsSlinky.vis.mod.Graph2dDrawPointsStyle
import typingsSlinky.vis.mod.Graph2dStyleType
import typingsSlinky.vis.mod.LegendPositionType
import typingsSlinky.vis.mod.NetworkEvents
import typingsSlinky.vis.mod.ParametrizationInterpolationType
import typingsSlinky.vis.mod.RightLeftEnumType
import typingsSlinky.vis.mod.TimelineAlignType
import typingsSlinky.vis.mod.TimelineEventPropertiesResultWhatType
import typingsSlinky.vis.mod.TimelineEvents
import typingsSlinky.vis.mod.TimelineItemType
import typingsSlinky.vis.mod.TimelineTimeAxisScaleType
import typingsSlinky.vis.mod.TopBottomEnumType
