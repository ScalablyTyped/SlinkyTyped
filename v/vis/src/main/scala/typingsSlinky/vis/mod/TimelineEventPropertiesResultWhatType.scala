...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.vis.visStrings.item
  - typingsSlinky.vis.visStrings.background
  - typingsSlinky.vis.visStrings.axis
  - typingsSlinky.vis.visStrings.`group-label`
  - typingsSlinky.vis.visStrings.`custom-time`
  - typingsSlinky.vis.visStrings.`current-time`
*/
