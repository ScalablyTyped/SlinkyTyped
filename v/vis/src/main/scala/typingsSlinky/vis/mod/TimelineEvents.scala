...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.vis.visStrings.currentTimeTick
  - typingsSlinky.vis.visStrings.click
  - typingsSlinky.vis.visStrings.contextmenu
  - typingsSlinky.vis.visStrings.doubleClick
  - typingsSlinky.vis.visStrings.drop
  - typingsSlinky.vis.visStrings.mouseOver
  - typingsSlinky.vis.visStrings.mouseDown
  - typingsSlinky.vis.visStrings.mouseUp
  - typingsSlinky.vis.visStrings.mouseMove
  - typingsSlinky.vis.visStrings.groupDragged
  - typingsSlinky.vis.visStrings.changed
  - typingsSlinky.vis.visStrings.rangechange
  - typingsSlinky.vis.visStrings.rangechanged
  - typingsSlinky.vis.visStrings.select
  - typingsSlinky.vis.visStrings.itemover
  - typingsSlinky.vis.visStrings.itemout
  - typingsSlinky.vis.visStrings.timechange
  - typingsSlinky.vis.visStrings.timechanged
*/
