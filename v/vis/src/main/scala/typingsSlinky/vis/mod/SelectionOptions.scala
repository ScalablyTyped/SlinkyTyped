...
object SelectionOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(highlightEdges)) __obj.updateDynamic("highlightEdges")(highlightEdges.get.asInstanceOf[js.Any])
    if (!js.isUndefined(unselectAll)) __obj.updateDynamic("unselectAll")(unselectAll.get.asInstanceOf[js.Any])
