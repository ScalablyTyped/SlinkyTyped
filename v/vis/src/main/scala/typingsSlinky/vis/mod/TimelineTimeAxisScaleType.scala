...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.vis.visStrings.millisecond
  - typingsSlinky.vis.visStrings.second
  - typingsSlinky.vis.visStrings.minute
  - typingsSlinky.vis.visStrings.hour
  - typingsSlinky.vis.visStrings.weekday
  - typingsSlinky.vis.visStrings.day
  - typingsSlinky.vis.visStrings.week
  - typingsSlinky.vis.visStrings.month
  - typingsSlinky.vis.visStrings.year
*/
