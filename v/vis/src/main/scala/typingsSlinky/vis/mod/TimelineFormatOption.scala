...
object TimelineFormatOption {
  ...
  implicit class TimelineFormatOptionOps[Self <: TimelineFormatOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMajorLabelsFunction3(value: (/* date */ js.Date, /* scale */ String, /* step */ Double) => String): Self = this.set("majorLabels", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setMinorLabelsFunction3(value: (/* date */ js.Date, /* scale */ String, /* step */ Double) => String): Self = this.set("minorLabels", js.Any.fromFunction3(value))
    @scala.inline
