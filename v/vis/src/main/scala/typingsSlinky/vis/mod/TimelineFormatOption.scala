...
object TimelineFormatOption {
  ...
  implicit class TimelineFormatOptionMutableBuilder[Self <: TimelineFormatOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMajorLabelsFunction3(value: (/* date */ js.Date, /* scale */ String, /* step */ Double) => String): Self = StObject.set(x, "majorLabels", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setMinorLabelsFunction3(value: (/* date */ js.Date, /* scale */ String, /* step */ Double) => String): Self = StObject.set(x, "minorLabels", js.Any.fromFunction3(value))
