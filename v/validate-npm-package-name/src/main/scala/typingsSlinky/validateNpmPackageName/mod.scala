...
object mod {
  ...
  @js.native
  def scopedPackagePattern: js.RegExp = js.native
  @scala.inline
  def scopedPackagePattern_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("scopedPackagePattern")(x.asInstanceOf[js.Any])
