...
import typingsSlinky.vegaDashTypings.typesRuntimeDataflowMod.Changeset
import typingsSlinky.vegaDashTypings.typesRuntimeMod.Loader
import typingsSlinky.vegaDashTypings.typesRuntimeMod.LoaderOptions
import typingsSlinky.vegaDashTypings.typesRuntimeMod.Runtime
import typingsSlinky.vegaDashTypings.typesRuntimeMod.TypeInference
import typingsSlinky.vegaDashTypings.typesRuntimeRendererMod.RenderModule
...
import typingsSlinky.vegaDashTypings.typesSpecDataMod.Format
import typingsSlinky.vegaDashTypings.typesSpecMod.Spec
import typingsSlinky.vegaDashUtil.vegaDashUtilMod.AccessorFn
import typingsSlinky.vegaDashUtil.vegaDashUtilMod.FastMap
import typingsSlinky.vegaDashUtil.vegaDashUtilMod.Fn
import typingsSlinky.vegaDashUtil.vegaDashUtilMod.LoggerInterface
import typingsSlinky.vegaDashUtil.vegaDashUtilMod.Order
...
object vegaMod extends js.Object {
  @js.native
  class Bounds ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeSceneMod.Bounds
  
  @js.native
  class CanvasHandler ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeRendererMod.Handler
  ...
  @js.native
  class Operator ()
    extends typingsSlinky.vegaDashTypings.vegaDashTypingsMod.Operator {
  ...
  class Renderer protected ()
    extends typingsSlinky.vegaDashTypings.vegaDashTypingsMod.Renderer {
    def this(loader: Loader) = this()
  }
  
  @js.native
  class Transform ()
    extends typingsSlinky.vegaDashTypings.vegaDashTypingsMod.Transform {
    def this(init: js.Any) = this()
  ...
  class View protected ()
    extends typingsSlinky.vegaDashTypings.vegaDashTypingsMod.View {
  ...
  def projection(`type`: String, projection: js.Any): typingsSlinky.vegaDashTypings.typesRuntimeMod.View = js.native
  ...
  @js.native
  object transforms
    extends /* name */ StringDictionary[typingsSlinky.vegaDashTypings.typesRuntimeDataflowMod.Transform]
