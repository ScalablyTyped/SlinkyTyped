...
object mod {
  ...
  @js.native
  class Bounds ()
    extends typingsSlinky.vegaTypings.mod.Bounds
  
  @JSImport("vega", "CanvasHandler")
  @js.native
  class CanvasHandler ()
    extends typingsSlinky.vegaTypings.mod.CanvasHandler
  ...
  @js.native
  class Handler ()
    extends typingsSlinky.vegaTypings.mod.Handler
  ...
  @js.native
  class Operator ()
    extends typingsSlinky.vegaTypings.mod.Operator {
  ...
  class Renderer protected ()
    extends typingsSlinky.vegaTypings.mod.Renderer {
  ...
  @js.native
  class Transform ()
    extends typingsSlinky.vegaTypings.mod.Transform {
    def this(init: js.Any) = this()
  ...
  class View protected ()
    extends typingsSlinky.vegaTypings.mod.View {
