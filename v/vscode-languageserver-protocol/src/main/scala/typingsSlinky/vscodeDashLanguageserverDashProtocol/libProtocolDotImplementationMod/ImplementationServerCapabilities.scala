package typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolDotImplementationMod

import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.StaticRegistrationOptions
