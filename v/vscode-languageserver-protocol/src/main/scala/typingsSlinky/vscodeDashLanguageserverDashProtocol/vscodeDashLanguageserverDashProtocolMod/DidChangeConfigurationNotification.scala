...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.DidChangeConfigurationRegistrationOptions
...
object DidChangeConfigurationNotification extends js.Object {
  val `type`: typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[DidChangeConfigurationParams, DidChangeConfigurationRegistrationOptions] = js.native
}
