...
object TextDocumentItem extends js.Object {
  /**
    ...
    */
  def create(uri: String, languageId: String, version: Double, text: String): typingsSlinky.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.TextDocumentItem = js.native
  /**
