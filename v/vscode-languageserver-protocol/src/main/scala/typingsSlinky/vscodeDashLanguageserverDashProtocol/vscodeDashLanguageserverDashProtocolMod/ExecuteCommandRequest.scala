...
import typingsSlinky.vscodeDashLanguageserverDashProtocol.libProtocolMod.ExecuteCommandRegistrationOptions
...
object ExecuteCommandRequest extends js.Object {
  val `type`: typingsSlinky.vscodeDashJsonrpc.vscodeDashJsonrpcMod.RequestType[ExecuteCommandParams, js.Any, Unit, ExecuteCommandRegistrationOptions] = js.native
}
