...
object Color extends js.Object {
  /**
    ...
    */
  def create(red: Double, green: Double, blue: Double, alpha: Double): typingsSlinky.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.Color = js.native
  /**
