...
object AnonHierarchicalDocumentSymbolSupport {
  @scala.inline
  def apply(): AnonHierarchicalDocumentSymbolSupport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonHierarchicalDocumentSymbolSupport]
  }
  @scala.inline
  implicit class AnonHierarchicalDocumentSymbolSupportOps[Self <: AnonHierarchicalDocumentSymbolSupport] (val x: Self) extends AnyVal {
    @scala.inline
