...
object messagesMod {
  ...
  - typingsSlinky.vscodeJsonrpc.mod.ProgressType because Inheritance from two classes. Inlined __ */ @JSImport("vscode-languageserver-protocol/lib/messages", "ProtocolRequestType")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsSlinky.vscodeJsonrpc.mod.ProgressType because Inheritance from two classes. Inlined __ */ @JSImport("vscode-languageserver-protocol/lib/messages", "ProtocolRequestType0")
  @js.native
