...
object protocolFoldingRangeMod {
  ...
  object FoldingRangeKind extends StObject {
    ...
    /* "comment" */ val Comment: typingsSlinky.vscodeLanguageserverProtocol.protocolFoldingRangeMod.FoldingRangeKind.Comment with String = js.native
    ...
    /* "imports" */ val Imports: typingsSlinky.vscodeLanguageserverProtocol.protocolFoldingRangeMod.FoldingRangeKind.Imports with String = js.native
    ...
    /* "region" */ val Region: typingsSlinky.vscodeLanguageserverProtocol.protocolFoldingRangeMod.FoldingRangeKind.Region with String = js.native
  }
