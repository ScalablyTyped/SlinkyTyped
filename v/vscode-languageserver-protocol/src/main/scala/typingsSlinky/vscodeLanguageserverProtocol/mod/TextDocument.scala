...
object TextDocument {
  ...
  @JSImport("vscode-languageserver-protocol", "TextDocument.applyEdits")
  @js.native
  def applyEdits(
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "TextDocument.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "TextDocument.is")
  @js.native
