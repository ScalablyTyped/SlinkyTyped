...
import typingsSlinky.vscodeLanguageserverProtocol.protocolColorProviderMod.DocumentColorClientCapabilities
import typingsSlinky.vscodeLanguageserverProtocol.protocolDeclarationMod.DeclarationClientCapabilities
import typingsSlinky.vscodeLanguageserverProtocol.protocolFoldingRangeMod.FoldingRangeClientCapabilities
import typingsSlinky.vscodeLanguageserverProtocol.protocolImplementationMod.ImplementationClientCapabilities
import typingsSlinky.vscodeLanguageserverProtocol.protocolSelectionRangeMod.SelectionRangeClientCapabilities
import typingsSlinky.vscodeLanguageserverProtocol.protocolTypeDefinitionMod.TypeDefinitionClientCapabilities
