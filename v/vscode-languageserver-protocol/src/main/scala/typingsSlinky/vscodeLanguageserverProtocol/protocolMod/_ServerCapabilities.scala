...
trait _ServerCapabilities extends js.Object {
  ...
  /**
    ...
    */
  var documentOnTypeFormattingProvider: js.UndefOr[FirstTriggerCharacter] = js.undefined
  /**
...
object _ServerCapabilities {
  ...
  def apply(
    ...
    documentOnTypeFormattingProvider: FirstTriggerCharacter = null,
    ...
    if (!js.isUndefined(definitionProvider)) __obj.updateDynamic("definitionProvider")(definitionProvider.get.asInstanceOf[js.Any])
    if (!js.isUndefined(documentFormattingProvider)) __obj.updateDynamic("documentFormattingProvider")(documentFormattingProvider.get.asInstanceOf[js.Any])
    if (!js.isUndefined(documentHighlightProvider)) __obj.updateDynamic("documentHighlightProvider")(documentHighlightProvider.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(documentRangeFormattingProvider)) __obj.updateDynamic("documentRangeFormattingProvider")(documentRangeFormattingProvider.get.asInstanceOf[js.Any])
    if (!js.isUndefined(documentSymbolProvider)) __obj.updateDynamic("documentSymbolProvider")(documentSymbolProvider.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hoverProvider)) __obj.updateDynamic("hoverProvider")(hoverProvider.get.asInstanceOf[js.Any])
    if (!js.isUndefined(referencesProvider)) __obj.updateDynamic("referencesProvider")(referencesProvider.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(workspaceSymbolProvider)) __obj.updateDynamic("workspaceSymbolProvider")(workspaceSymbolProvider.get.asInstanceOf[js.Any])
