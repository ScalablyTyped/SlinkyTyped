...
trait WorkspaceClientCapabilities extends js.Object {
  ...
  /**
    ...
    */
  var didChangeConfiguration: js.UndefOr[DynamicRegistration] = js.undefined
  /**
    * Capabilities specific to the `workspace/didChangeWatchedFiles` notification.
    */
  var didChangeWatchedFiles: js.UndefOr[DynamicRegistration] = js.undefined
  /**
    * Capabilities specific to the `workspace/executeCommand` request.
    */
  var executeCommand: js.UndefOr[DynamicRegistration] = js.undefined
  /**
    * Capabilities specific to the `workspace/symbol` request.
    */
  var symbol: js.UndefOr[SymbolKind] = js.undefined
  /**
    * Capabilities specific to `WorkspaceEdit`s
    */
  var workspaceEdit: js.UndefOr[DocumentChanges] = js.undefined
}
...
object WorkspaceClientCapabilities {
  ...
  def apply(
    ...
    didChangeConfiguration: DynamicRegistration = null,
    didChangeWatchedFiles: DynamicRegistration = null,
    executeCommand: DynamicRegistration = null,
    symbol: SymbolKind = null,
    workspaceEdit: DocumentChanges = null
