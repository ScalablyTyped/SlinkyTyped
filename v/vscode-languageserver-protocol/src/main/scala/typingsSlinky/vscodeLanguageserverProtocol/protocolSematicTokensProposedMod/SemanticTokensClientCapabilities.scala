...
trait SemanticTokensClientCapabilities extends StObject {
  ...
  /**
    ...
    */
  var textDocument: js.UndefOr[typingsSlinky.vscodeLanguageserverProtocol.anon.SemanticTokens] = js.native
}
object SemanticTokensClientCapabilities {
  ...
  implicit class SemanticTokensClientCapabilitiesMutableBuilder[Self <: SemanticTokensClientCapabilities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextDocument(value: typingsSlinky.vscodeLanguageserverProtocol.anon.SemanticTokens): Self = StObject.set(x, "textDocument", value.asInstanceOf[js.Any])
