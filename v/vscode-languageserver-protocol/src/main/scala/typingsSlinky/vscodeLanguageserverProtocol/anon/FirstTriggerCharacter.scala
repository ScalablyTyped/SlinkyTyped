...
object FirstTriggerCharacter {
  @scala.inline
  def apply(firstTriggerCharacter: String): FirstTriggerCharacter = {
  ...
  @scala.inline
  implicit class FirstTriggerCharacterOps[Self <: FirstTriggerCharacter] (val x: Self) extends AnyVal {
    @scala.inline
