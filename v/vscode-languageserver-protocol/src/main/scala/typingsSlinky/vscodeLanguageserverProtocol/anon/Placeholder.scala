...
object Placeholder {
  @scala.inline
  def apply(placeholder: String, range: typingsSlinky.vscodeLanguageserverTypes.mod.Range): Placeholder = {
  ...
  implicit class PlaceholderOps[Self <: Placeholder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRange(value: typingsSlinky.vscodeLanguageserverTypes.mod.Range): Self = this.set("range", value.asInstanceOf[js.Any])
  }
