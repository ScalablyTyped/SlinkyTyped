...
object utilsMod extends js.Object {
  ...
  def rotateByAngle(position: AnonY): typingsSlinky.vanillaSwipe.rotateByAngleMod.Value = js.native
  def rotateByAngle(position: AnonY, angle: Double): typingsSlinky.vanillaSwipe.rotateByAngleMod.Value = js.native
}
