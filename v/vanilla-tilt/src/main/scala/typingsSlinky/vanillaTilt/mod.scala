package typingsSlinky.vanillaTilt
...
object mod {
  ...
  object TiltOptions {
    ...
    implicit class TiltOptionsMutableBuilder[Self <: TiltOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAxis(value: typingsSlinky.vanillaTilt.vanillaTiltStrings.x | y): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
