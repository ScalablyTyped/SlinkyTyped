package typingsSlinky.vanillaDashTilt.vanillaDashTiltMod
...
object default extends js.Object {
  def init(elements: js.Array[typingsSlinky.std.HTMLElement]): Unit = js.native
  def init(elements: js.Array[typingsSlinky.std.HTMLElement], settings: TiltOptions): Unit = js.native
  /**
    ...
    */
  def init(elements: typingsSlinky.std.HTMLElement): Unit = js.native
  def init(elements: typingsSlinky.std.HTMLElement, settings: TiltOptions): Unit = js.native
}
