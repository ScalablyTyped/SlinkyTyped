...
object VueConstructor {
  @scala.inline
  def apply[/* <: typingsSlinky.vuexI18n.mod.vueTypesVueAugmentingMod.Vue */ V](i18n: Ii18n): VueConstructor[V] = {
    val __obj = js.Dynamic.literal(i18n = i18n.asInstanceOf[js.Any])
    __obj.asInstanceOf[VueConstructor[V]]
  }
  @scala.inline
  implicit class VueConstructorOps[Self <: VueConstructor[_], /* <: typingsSlinky.vuexI18n.mod.vueTypesVueAugmentingMod.Vue */ V] (val x: Self with VueConstructor[V]) extends AnyVal {
    @scala.inline
