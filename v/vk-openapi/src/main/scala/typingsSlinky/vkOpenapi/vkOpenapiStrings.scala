...
import typingsSlinky.vkOpenapi.vk.OpenAPI.Observer.ObserverEvent
import typingsSlinky.vkOpenapi.vk.OpenAPI.Retargeting.ProductEvent
import typingsSlinky.vkOpenapi.vk.OpenAPI.Widgets.OnCanNotWriteReason
import typingsSlinky.vkOpenapi.vk.OpenAPI.Widgets.RecommendedSort
import typingsSlinky.vkOpenapi.vk.OpenAPI.Widgets.RecommendedTarget
...
object vkOpenapiStrings {
  ...
  @js.native
  sealed trait blank extends RecommendedTarget
  @scala.inline
  ...
  @js.native
  sealed trait cant_write extends OnCanNotWriteReason
  @scala.inline
  def cant_write: cant_write = "cant_write".asInstanceOf[cant_write]
  
  @js.native
  sealed trait complete_registration extends GoalEvent
  @scala.inline
  ...
  @js.native
  sealed trait contact extends GoalEvent
  @scala.inline
  def contact: contact = "contact".asInstanceOf[contact]
  
  @js.native
  sealed trait conversion extends GoalEvent
  @scala.inline
  def conversion: conversion = "conversion".asInstanceOf[conversion]
  
  @js.native
  sealed trait customize_product extends GoalEvent
  @scala.inline
  ...
  @js.native
  sealed trait no_access extends OnCanNotWriteReason
  @scala.inline
  ...
  @js.native
  sealed trait offline extends OnCanNotWriteReason
  @scala.inline
  def offline: offline = "offline".asInstanceOf[offline]
  
  @js.native
  sealed trait page_view extends GoalEvent
  @scala.inline
  def page_view: page_view = "page_view".asInstanceOf[page_view]
  
  @js.native
  sealed trait parent extends RecommendedTarget
  @scala.inline
  ...
  @js.native
  sealed trait widgetsDotallowMessagesFromCommunityDotallowed extends ObserverEvent
  @scala.inline
  ...
  @js.native
  sealed trait widgetsDotallowMessagesFromCommunityDotdenied extends ObserverEvent
  @scala.inline
  ...
  @js.native
  sealed trait widgetsDotcommentsDotdelete_comment extends ObserverEvent
  @scala.inline
  ...
  @js.native
  sealed trait widgetsDotcommentsDotnew_comment extends ObserverEvent
  @scala.inline
