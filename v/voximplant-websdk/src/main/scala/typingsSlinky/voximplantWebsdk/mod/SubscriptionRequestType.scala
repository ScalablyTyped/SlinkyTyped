...
object SubscriptionRequestType extends StObject {
  ...
  /* 0 */ val Subscribe: typingsSlinky.voximplantWebsdk.mod.SubscriptionRequestType.Subscribe with Double = js.native
  ...
  /* 1 */ val Unsubscribe: typingsSlinky.voximplantWebsdk.mod.SubscriptionRequestType.Unsubscribe with Double = js.native
}
