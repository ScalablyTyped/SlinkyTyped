...
object IMErrorType extends StObject {
  ...
  /* 1 */ val Error: typingsSlinky.voximplantWebsdk.mod.IMErrorType.Error with Double = js.native
  
  @js.native
  sealed trait RemoteFunctionError extends IMErrorType
  /* 0 */ val RemoteFunctionError: typingsSlinky.voximplantWebsdk.mod.IMErrorType.RemoteFunctionError with Double = js.native
  
  @js.native
  sealed trait RosterError extends IMErrorType
  /* 2 */ val RosterError: typingsSlinky.voximplantWebsdk.mod.IMErrorType.RosterError with Double = js.native
}
