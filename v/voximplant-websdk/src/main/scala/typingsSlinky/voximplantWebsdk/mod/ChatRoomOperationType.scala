...
object ChatRoomOperationType extends StObject {
  ...
  /* 0 */ val Ban: typingsSlinky.voximplantWebsdk.mod.ChatRoomOperationType.Ban with Double = js.native
  ...
  /* 1 */ val Unban: typingsSlinky.voximplantWebsdk.mod.ChatRoomOperationType.Unban with Double = js.native
}
