...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.vegaTypings.vegaTypingsStrings.`top-left`
  - typingsSlinky.vegaTypings.vegaTypingsStrings.`top-right`
  - typingsSlinky.vegaTypings.vegaTypingsStrings.`bottom-left`
  - typingsSlinky.vegaTypings.vegaTypingsStrings.`bottom-right`
*/
trait LegendOrient extends js.Object
object LegendOrient {
