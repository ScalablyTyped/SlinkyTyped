...
import typingsSlinky.vegaTypings.anon.Fill
...
import typingsSlinky.vegaTypings.vegaTypingsStrings.`axis-label`
import typingsSlinky.vegaTypings.vegaTypingsStrings.`legend-label`
import typingsSlinky.vegaTypings.vegaTypingsStrings.`legend-symbol`
...
object runtimeMod {
  ...
  @js.native
  class CanvasHandler ()
    extends typingsSlinky.vegaTypings.rendererMod.CanvasHandler
  ...
  @js.native
  class Operator ()
    extends typingsSlinky.vegaTypings.dataflowMod.Operator {
  ...
  class Renderer protected ()
    extends typingsSlinky.vegaTypings.rendererMod.Renderer {
  ...
  @js.native
  class Transform ()
    extends typingsSlinky.vegaTypings.dataflowMod.Transform {
    def this(init: js.Any) = this()
