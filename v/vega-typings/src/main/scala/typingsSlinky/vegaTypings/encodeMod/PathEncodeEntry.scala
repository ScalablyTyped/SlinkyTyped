...
object PathEncodeEntry {
  ...
  implicit class PathEncodeEntryOps[Self <: PathEncodeEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPath(value: ProductionRule[StringValueRef]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScaleX(value: ProductionRule[NumericValueRef]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScaleY(value: ProductionRule[NumericValueRef]): Self = {
        val ret = this.duplicate
