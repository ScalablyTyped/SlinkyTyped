...
object Background {
  ...
  implicit class BackgroundOps[Self <: Background] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackground(value: typingsSlinky.vegaTypings.colorMod.Color): Self = this.set("background", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBackground: Self = this.set("background", js.undefined)
    @scala.inline
    def setBindElement(value: Element): Self = this.set("bind", value.asInstanceOf[js.Any])
    @scala.inline
