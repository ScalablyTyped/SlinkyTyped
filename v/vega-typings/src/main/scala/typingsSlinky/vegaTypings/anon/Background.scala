...
import typingsSlinky.vegaTypings.runtimeMod.LocaleFormatters
...
trait Background extends StObject {
  ...
  var background: js.UndefOr[typingsSlinky.vegaTypings.colorMod.Color] = js.native
...
object Background {
  ...
  implicit class BackgroundMutableBuilder[Self <: Background] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackground(value: typingsSlinky.vegaTypings.colorMod.Color): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBindElement(value: Element): Self = StObject.set(x, "bind", value.asInstanceOf[js.Any])
