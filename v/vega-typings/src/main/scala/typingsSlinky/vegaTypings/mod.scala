...
object mod {
  ...
  @js.native
  class Bounds ()
    extends typingsSlinky.vegaTypings.runtimeMod.Bounds
  
  @JSImport("vega-typings", "CanvasHandler")
  @js.native
  class CanvasHandler ()
    extends typingsSlinky.vegaTypings.runtimeMod.CanvasHandler
  ...
  @js.native
  class Handler ()
    extends typingsSlinky.vegaTypings.runtimeMod.Handler
