...
object bindMod {
  ...
  */
  ...
  object Binding {
    ...
    @scala.inline
    def BindCheckbox(input: checkbox): typingsSlinky.vegaTypings.bindMod.BindCheckbox = {
      val __obj = js.Dynamic.literal(input = input.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaTypings.bindMod.BindCheckbox]
    }
    
    @scala.inline
    def BindRadioSelect(input: radio | select, options: js.Array[_]): typingsSlinky.vegaTypings.bindMod.BindRadioSelect = {
      val __obj = js.Dynamic.literal(input = input.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaTypings.bindMod.BindRadioSelect]
    }
    
    @scala.inline
    def BindRange(input: range): typingsSlinky.vegaTypings.bindMod.BindRange = {
      val __obj = js.Dynamic.literal(input = input.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.vegaTypings.bindMod.BindRange]
    }
    
    @scala.inline
    def InputBinding(): typingsSlinky.vegaTypings.bindMod.InputBinding = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.vegaTypings.bindMod.InputBinding]
    }
  }
