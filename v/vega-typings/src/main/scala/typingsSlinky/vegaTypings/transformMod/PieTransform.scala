...
object PieTransform {
  ...
  implicit class PieTransformOps[Self <: PieTransform] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndAngle(value: Double | SignalRef): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSort(value: Boolean | SignalRef): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartAngle(value: Double | SignalRef): Self = {
        val ret = this.duplicate
