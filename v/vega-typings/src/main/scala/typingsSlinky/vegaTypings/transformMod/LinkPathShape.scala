...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.vegaTypings.vegaTypingsStrings.curve
  - typingsSlinky.vegaTypings.vegaTypingsStrings.diagonal
  - typingsSlinky.vegaTypings.vegaTypingsStrings.orthogonal
*/
