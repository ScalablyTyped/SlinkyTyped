...
package object typesSpecTransformMod {
  import typingsSlinky.vegaDashTypings.Anon_Bandwidth
  import typingsSlinky.vegaDashTypings.Anon_CountNice
  import typingsSlinky.vegaDashTypings.Anon_Thresholds
