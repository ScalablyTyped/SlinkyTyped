...
package object typesSpecEncodeMod {
  ...
  import typingsSlinky.vegaDashTypings.Anon_Exponent
  import typingsSlinky.vegaDashTypings.Anon_Test
  import typingsSlinky.vegaDashTypings.typesSpecColorMod.Color
  import typingsSlinky.vegaDashTypings.typesSpecTitleMod.TitleAnchor
