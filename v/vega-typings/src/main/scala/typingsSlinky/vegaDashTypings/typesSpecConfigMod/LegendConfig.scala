package typingsSlinky.vegaDashTypings.typesSpecConfigMod

import typingsSlinky.vegaDashTypings.typesSpecAxisMod.LabelOverlap
import typingsSlinky.vegaDashTypings.typesSpecAxisMod.TickCount
import typingsSlinky.vegaDashTypings.typesSpecColorMod.Color
import typingsSlinky.vegaDashTypings.typesSpecEncodeMod.Orientation
import typingsSlinky.vegaDashTypings.typesSpecLayoutMod.LayoutAlign
import typingsSlinky.vegaDashTypings.typesSpecLegendMod.BaseLegend
import typingsSlinky.vegaDashTypings.typesSpecLegendMod.LegendOrient
import typingsSlinky.vegaDashTypings.typesSpecSignalMod.SignalRef
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.AlignValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.AnchorValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.ColorValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.DashArrayValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.FontStyleValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.FontWeightValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.NumberValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.OrientValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.StringValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.SymbolShapeValue
import typingsSlinky.vegaDashTypings.typesSpecValuesMod.TextBaselineValue
