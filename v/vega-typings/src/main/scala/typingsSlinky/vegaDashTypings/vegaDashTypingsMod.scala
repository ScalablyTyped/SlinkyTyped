...
object vegaDashTypingsMod extends js.Object {
  ...
  @js.native
  class Operator ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeMod.Operator {
  ...
  class Renderer protected ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeMod.Renderer {
    def this(loader: Loader) = this()
  }
  
  @js.native
  class Transform ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeMod.Transform {
    def this(init: js.Any) = this()
  ...
  class View protected ()
    extends typingsSlinky.vegaDashTypings.typesRuntimeMod.View {
