...
import typingsSlinky.vastDashClient.vastDashClientStrings.ERRORMESSAGE
import typingsSlinky.vastDashClient.vastDashClientStrings.extensions
import typingsSlinky.vastDashClient.vastDashClientStrings.system
