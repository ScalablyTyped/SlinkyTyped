...
object mod extends Shortcut {
  ...
  trait VNDB_ extends StObject {
    ...
    /**
      ...
      */
    def start(): js.Promise[typingsSlinky.vndb.mod.vndb] = js.native
    def start(host: js.UndefOr[scala.Nothing], port: Double): js.Promise[typingsSlinky.vndb.mod.vndb] = js.native
    def start(host: String): js.Promise[typingsSlinky.vndb.mod.vndb] = js.native
    def start(host: String, port: Double): js.Promise[typingsSlinky.vndb.mod.vndb] = js.native
  }
  ...
  object vndb {
    ...
    @scala.inline
    def apply(end: () => js.Promise[Unit], socket: TLSSocket, write: String => js.Promise[String]): typingsSlinky.vndb.mod.vndb = {
      ...
      __obj.asInstanceOf[typingsSlinky.vndb.mod.vndb]
    }
    
    @scala.inline
    implicit class vndbMutableBuilder[Self <: typingsSlinky.vndb.mod.vndb] (val x: Self) extends AnyVal {
