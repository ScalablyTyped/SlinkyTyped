...
import typingsSlinky.vueComponentCompilerUtils.anon.PostTransformNode
...
object srcsetMod {
  ...
  @JSImport("@vue/component-compiler-utils/dist/templateCompilerModules/srcset", JSImport.Default)
  @js.native
