...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "postcss" % "7.0.18-bc8652",
  ...
  "org.scalablytyped.slinky" %%% "vue-template-compiler" % "2.6.11-8ab5fd",
  "org.scalablytyped.slinky" %%% "vue__component-compiler-utils" % "3.1.1-7a1c1b",
