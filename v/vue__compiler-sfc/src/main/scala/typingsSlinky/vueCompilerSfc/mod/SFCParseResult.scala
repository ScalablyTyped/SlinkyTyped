...
object SFCParseResult {
  ...
  implicit class SFCParseResultOps[Self <: SFCParseResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorsVarargs(value: (CompilerError | js.SyntaxError)*): Self = this.set("errors", js.Array(value :_*))
    
    @scala.inline
    def setErrors(value: js.Array[CompilerError | js.SyntaxError]): Self = this.set("errors", value.asInstanceOf[js.Any])
  }
}
