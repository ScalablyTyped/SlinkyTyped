package typingsSlinky.vueDashMoment.vueDashMomentMod
...
import typingsSlinky.vueDashMoment.vueDashMomentMod.VueMomentPlugin.Options
import typingsSlinky.vueDashMoment.vueDashMomentMod.VueMomentPlugin.VueStatic
