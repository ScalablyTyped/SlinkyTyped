...
import typingsSlinky.waterline.waterlineStrings.text
...
trait TextAttribute extends js.Object {
  ...
  var `type`: js.UndefOr[String] with text = js.native
...
object TextAttribute {
  ...
  @scala.inline
  def apply(`type`: js.UndefOr[String] with text): TextAttribute = {
  ...
  @scala.inline
  implicit class TextAttributeOps[Self <: TextAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with text): Self = this.set("type", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefaultsToFunction0(value: () => String): Self = this.set("defaultsTo", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDefaultsTo(value: String | DefaultsToFn[String]): Self = this.set("defaultsTo", value.asInstanceOf[js.Any])
