...
@js.native
trait ManyToManyAttribute extends Attribute {
  ...
  @JSName("equals")
  var equals_FManyToManyAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object ManyToManyAttribute {
  ...
  implicit class ManyToManyAttributeOps[Self <: ManyToManyAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDominant(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dominant")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDominant: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dominant")(js.undefined)
        ret
    }
    @scala.inline
