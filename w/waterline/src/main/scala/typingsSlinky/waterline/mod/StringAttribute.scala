...
trait StringAttribute extends _Attribute {
  ...
  @JSName("equals")
  var equals_FStringAttribute: js.UndefOr[AttributeValidation[_]] = js.undefined
  ...
  var `type`: js.UndefOr[String with string] = js.undefined
