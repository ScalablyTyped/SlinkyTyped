...
@js.native
trait DatetimeAttribute extends Attribute {
  ...
  @JSName("equals")
  var equals_FDatetimeAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object DatetimeAttribute {
  ...
  implicit class DatetimeAttributeOps[Self <: DatetimeAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnum(value: js.Array[js.Date]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: String with datetime): Self = {
        val ret = this.duplicate
