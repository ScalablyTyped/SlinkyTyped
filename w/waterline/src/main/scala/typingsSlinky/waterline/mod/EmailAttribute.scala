...
trait EmailAttribute extends _Attribute {
  ...
  var `type`: js.UndefOr[String] with email = js.native
...
object EmailAttribute {
  ...
  @scala.inline
  def apply(`type`: js.UndefOr[String] with email): EmailAttribute = {
  ...
  @scala.inline
  implicit class EmailAttributeOps[Self <: EmailAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with email): Self = this.set("type", value.asInstanceOf[js.Any])
