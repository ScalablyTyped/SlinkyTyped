...
/* Inlined waterline.waterline.BaseAttribute<number> & {  type :'number',   autoIncrement :boolean | undefined} */
@js.native
trait NumberAttribute extends _Attribute {
  ...
  var `type`: js.UndefOr[String] with number = js.native
...
object NumberAttribute {
  ...
  @scala.inline
  def apply(`type`: js.UndefOr[String] with number): NumberAttribute = {
  ...
  implicit class NumberAttributeMutableBuilder[Self <: NumberAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with number): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
