...
/* Inlined waterline.waterline.BaseAttribute<number> & {  type  :'integer',   autoIncrement ? :boolean} */
@js.native
trait IntegerAttribute extends _Attribute {
  ...
  @JSName("equals")
  var equals_FIntegerAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object IntegerAttribute {
  ...
  implicit class IntegerAttributeOps[Self <: IntegerAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultsToFunction0(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultsTo")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDefaultsTo(value: Double | DefaultsToFn[Double]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: String with integer): Self = {
        val ret = this.duplicate
