...
object BooleanAttribute {
  ...
  implicit class BooleanAttributeOps[Self <: BooleanAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with boolean): Self = this.set("type", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefaultsToFunction0(value: () => Boolean): Self = this.set("defaultsTo", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDefaultsTo(value: Boolean | DefaultsToFn[Boolean]): Self = this.set("defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultsTo: Self = this.set("defaultsTo", js.undefined)
    
    @scala.inline
    def setEnumVarargs(value: Boolean*): Self = this.set("enum", js.Array(value :_*))
    
    @scala.inline
    def setEnum(value: js.Array[Boolean]): Self = this.set("enum", value.asInstanceOf[js.Any])
