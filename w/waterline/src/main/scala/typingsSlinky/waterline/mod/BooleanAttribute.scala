...
@js.native
trait BooleanAttribute extends Attribute {
  ...
  @JSName("equals")
  var equals_FBooleanAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object BooleanAttribute {
  ...
  implicit class BooleanAttributeOps[Self <: BooleanAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultsToFunction0(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultsTo")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDefaultsTo(value: Boolean | DefaultsToFn[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnum(value: js.Array[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: String with boolean): Self = {
        val ret = this.duplicate
