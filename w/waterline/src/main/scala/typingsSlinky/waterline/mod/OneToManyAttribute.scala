...
@js.native
trait OneToManyAttribute extends Attribute {
  ...
  @JSName("equals")
  var equals_FOneToManyAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object OneToManyAttribute {
  ...
  @scala.inline
  implicit class OneToManyAttributeOps[Self <: OneToManyAttribute] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDefaultsToFunction0(value: () => _): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defaultsTo")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDefaultsTo(value: js.Any | DefaultsToFn[_]): Self = {
        val ret = this.duplicate
