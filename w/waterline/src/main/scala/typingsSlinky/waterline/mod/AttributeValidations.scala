...
object AttributeValidations {
  ...
  implicit class AttributeValidationsMutableBuilder[Self <: AttributeValidations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsAfter(value: AttributeValidation[js.Date]): Self = StObject.set(x, "isAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsAfterDate(value: js.Date): Self = StObject.set(x, "isAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsAfterFunction0(value: () => js.Date): Self = StObject.set(x, "isAfter", js.Any.fromFunction0(value))
    
    @scala.inline
    def setIsAfterFunction1(value: /* cb */ js.Function1[js.Date, js.Any] => Unit): Self = StObject.set(x, "isAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIsAfterUndefined: Self = StObject.set(x, "isAfter", js.undefined)
    
    @scala.inline
    def setIsBefore(value: AttributeValidation[js.Date]): Self = StObject.set(x, "isBefore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsBeforeDate(value: js.Date): Self = StObject.set(x, "isBefore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsBeforeFunction0(value: () => js.Date): Self = StObject.set(x, "isBefore", js.Any.fromFunction0(value))
    
    @scala.inline
    def setIsBeforeFunction1(value: /* cb */ js.Function1[js.Date, js.Any] => Unit): Self = StObject.set(x, "isBefore", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRegex(value: AttributeValidation[js.RegExp]): Self = StObject.set(x, "regex", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRegexFunction0(value: () => js.RegExp): Self = StObject.set(x, "regex", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRegexFunction1(value: /* cb */ js.Function1[js.RegExp, js.Any] => Unit): Self = StObject.set(x, "regex", js.Any.fromFunction1(value))
