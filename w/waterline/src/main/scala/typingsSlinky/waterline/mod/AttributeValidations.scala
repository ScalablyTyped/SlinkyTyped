...
trait AttributeValidations extends js.Object {
  ...
  @JSName("equals")
  var equals_FAttributeValidations: js.UndefOr[AttributeValidation[_]] = js.native
  ...
  var required: js.UndefOr[AttributeValidation[Boolean]] = js.native
...
object AttributeValidations {
  ...
  implicit class AttributeValidationsOps[Self <: AttributeValidations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequiredFunction1(value: /* cb */ js.Function1[Boolean, js.Any] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("required")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRequiredFunction0(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("required")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRequired(value: AttributeValidation[Boolean]): Self = {
        val ret = this.duplicate
