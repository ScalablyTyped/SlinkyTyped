...
@js.native
trait BinaryAttribute extends Attribute {
  ...
  @JSName("equals")
  var equals_FBinaryAttribute: js.UndefOr[AttributeValidation[_]] = js.native
...
object BinaryAttribute {
  ...
  implicit class BinaryAttributeOps[Self <: BinaryAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: String with binary): Self = {
        val ret = this.duplicate
