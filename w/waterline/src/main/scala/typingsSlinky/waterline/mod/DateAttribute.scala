...
object DateAttribute {
  ...
  implicit class DateAttributeOps[Self <: DateAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with date): Self = this.set("type", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefaultsToDate(value: js.Date): Self = this.set("defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultsToFunction0(value: () => js.Date): Self = this.set("defaultsTo", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDefaultsTo(value: js.Date | DefaultsToFn[js.Date]): Self = this.set("defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultsTo: Self = this.set("defaultsTo", js.undefined)
    
    @scala.inline
    def setEnumVarargs(value: js.Date*): Self = this.set("enum", js.Array(value :_*))
    
    @scala.inline
    def setEnum(value: js.Array[js.Date]): Self = this.set("enum", value.asInstanceOf[js.Any])
