...
trait DateAttribute extends _Attribute {
  ...
  var defaultsTo: js.UndefOr[js.Date | DefaultsToFn[js.Date]] = js.native
  
  var enum: js.UndefOr[js.Array[js.Date]] = js.native
  ...
  var `type`: js.UndefOr[String] with date = js.native
...
object DateAttribute {
  ...
  @scala.inline
  def apply(`type`: js.UndefOr[String] with date): DateAttribute = {
  ...
  implicit class DateAttributeMutableBuilder[Self <: DateAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultsTo(value: js.Date | DefaultsToFn[js.Date]): Self = StObject.set(x, "defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultsToDate(value: js.Date): Self = StObject.set(x, "defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultsToFunction0(value: () => js.Date): Self = StObject.set(x, "defaultsTo", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDefaultsToUndefined: Self = StObject.set(x, "defaultsTo", js.undefined)
    
    @scala.inline
    def setEnum(value: js.Array[js.Date]): Self = StObject.set(x, "enum", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnumUndefined: Self = StObject.set(x, "enum", js.undefined)
    
    @scala.inline
    def setEnumVarargs(value: js.Date*): Self = StObject.set(x, "enum", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with date): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
