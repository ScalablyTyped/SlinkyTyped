...
import typingsSlinky.weixinApp.anon.X
...
object TouchEvent {
  @scala.inline
  def apply[/* <: typingsSlinky.weixinApp.wx.TouchEventType */ T](
  ...
  @scala.inline
  implicit class TouchEventOps[Self <: TouchEvent[_], /* <: typingsSlinky.weixinApp.wx.TouchEventType */ T] (val x: Self with TouchEvent[T]) extends AnyVal {
    @scala.inline
