...
object BackgroundAudioManager {
  ...
  implicit class BackgroundAudioManagerOps[Self <: BackgroundAudioManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnNext(value: js.Function1[/* res */ ErrCodeResponse, Unit] => Unit): Self = this.set("onNext", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnPrev(value: js.Function1[/* res */ ErrCodeResponse, Unit] => Unit): Self = this.set("onPrev", js.Any.fromFunction1(value))
    @scala.inline
