...
trait WriteBLECharacteristicValue_
  ...
  @JSName("complete")
  var complete_WriteBLECharacteristicValue_ : js.UndefOr[js.Function0[Unit]] = js.native
  /**
  		 * 蓝牙设备 id，参考 device 对象
  		 */
  var deviceId: String = js.native
  @JSName("fail")
  var fail_WriteBLECharacteristicValue_ : js.UndefOr[js.Function0[Unit]] = js.native
  /**
  		 * 蓝牙特征值对应服务的 uuid
  		 */
  ...
  @JSName("success")
  def success_MWriteBLECharacteristicValue_(res: ErrMsgResponse): Unit = js.native
}
...
object WriteBLECharacteristicValue_ {
  ...
  @scala.inline
  implicit class WriteBLECharacteristicValue_Ops[Self <: WriteBLECharacteristicValue_] (val x: Self) extends AnyVal {
    @scala.inline
