...
object PaymentSignType {
  @scala.inline
  def `HMAC-SHA256`: typingsSlinky.weixinApp.weixinAppStrings.`HMAC-SHA256` = this.cast("HMAC-SHA256")
  @scala.inline
  def MD5: typingsSlinky.weixinApp.weixinAppStrings.MD5 = this.cast("MD5")
  @scala.inline
