...
import typingsSlinky.weixinApp.AnonAuthMode
...
trait StartSoterAuthenticationOptions
  ...
  @JSName("success")
  var success_StartSoterAuthenticationOptions: js.UndefOr[js.Function1[/* res */ AnonAuthMode, Unit]] = js.native
}
...
object StartSoterAuthenticationOptions {
  ...
  implicit class StartSoterAuthenticationOptionsOps[Self <: StartSoterAuthenticationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonAuthMode => Unit): Self = {
        val ret = this.duplicate
