...
import typingsSlinky.weixinApp.anon.characteristicsArrayuuids
...
object GetBLEDeviceCharacteristicsOptions {
  ...
  implicit class GetBLEDeviceCharacteristicsOptionsOps[Self <: GetBLEDeviceCharacteristicsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: characteristicsArrayuuids => Unit): Self = this.set("success", js.Any.fromFunction1(value))
  }
