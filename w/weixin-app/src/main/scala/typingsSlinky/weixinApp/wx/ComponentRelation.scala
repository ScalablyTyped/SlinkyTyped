...
import typingsSlinky.weixinApp.weixinAppStrings.ancestor
import typingsSlinky.weixinApp.weixinAppStrings.child
import typingsSlinky.weixinApp.weixinAppStrings.descendant
import typingsSlinky.weixinApp.weixinAppStrings.parent
...
object ComponentRelation {
  ...
  implicit class ComponentRelationOps[Self <: ComponentRelation[_, _], D, P] (val x: Self with (ComponentRelation[D, P])) extends AnyVal {
    ...
    @scala.inline
    def setLinkChanged(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = this.set("linkChanged", js.Any.fromFunction1(value))
    @scala.inline
    def deleteLinkChanged: Self = this.set("linkChanged", js.undefined)
    @scala.inline
    def setLinked(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = this.set("linked", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setUnlinked(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = this.set("unlinked", js.Any.fromFunction1(value))
    @scala.inline
