...
import typingsSlinky.weixinApp.AnonHasUpdate
...
trait UpdateManager extends js.Object {
  ...
  callback: js.Function1[/* result */ AnonHasUpdate, Unit]): Unit = js.native
  /** 监听小程序更新失败事件。小程序有新版本，客户端主动触发下载（无需开发者触发），下载失败（可能是网络原因等）后回调 */
  def onUpdateFailed(/** 小程序更新失败事件的回调函数 */
  callback: js.Function1[/* res */ AnonErrMsg, Unit]): Unit = js.native
...
object UpdateManager {
  ...
  def apply(
    applyUpdate: () => Unit,
    onCheckForUpdate: js.Function1[/* result */ AnonHasUpdate, Unit] => Unit,
    onUpdateFailed: js.Function1[/* res */ AnonErrMsg, Unit] => Unit,
  ...
  implicit class UpdateManagerOps[Self <: UpdateManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnCheckForUpdate(value: js.Function1[/* result */ AnonHasUpdate, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onCheckForUpdate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnUpdateFailed(value: js.Function1[/* res */ AnonErrMsg, Unit] => Unit): Self = {
        val ret = this.duplicate
