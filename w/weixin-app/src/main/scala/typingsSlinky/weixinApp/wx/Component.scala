...
trait Component[D, P, B /* <: js.Array[(Behavior[js.Object, js.Object, js.Object]) | String] */] extends StObject {
  ...
  /**
    * 组件数据，包括内部数据和属性值
    */
  var data: D with UnboxBehaviorsData[B] with typingsSlinky.weixinApp.weixinAppStrings.Component with TopLevel[js.Any] = js.native
  ...
  /**
    ...
    */
  var properties: D with UnboxBehaviorsData[B] with typingsSlinky.weixinApp.weixinAppStrings.Component with TopLevel[js.Any] = js.native
  ...
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
    */ typingsSlinky.weixinApp.weixinAppStrings.Component with TopLevel[js.Any]
  ): Unit = js.native
  def setData(
    data: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
