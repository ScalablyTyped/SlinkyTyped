...
object ComponentOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.weixinApp.wx.Component[Data, Props, Behaviors] */ Instance, Data, Methods, Props, /* <: js.Array[
  (typingsSlinky.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | java.lang.String] */ Behaviors](): ComponentOptions[Instance, Data, Methods, Props, Behaviors] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentOptions[Instance, Data, Methods, Props, Behaviors]]
  }
  @scala.inline
  implicit class ComponentOptionsOps[Self <: ComponentOptions[_, _, _, _, _], /* <: typingsSlinky.weixinApp.wx.Component[Data, Props, Behaviors] */ Instance, Data, Methods, Props, /* <: js.Array[
  (typingsSlinky.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | java.lang.String] */ Behaviors] (val x: Self with (ComponentOptions[Instance, Data, Methods, Props, Behaviors])) extends AnyVal {
    @scala.inline
