...
import typingsSlinky.weixinApp.weixinAppStrings.center
import typingsSlinky.weixinApp.weixinAppStrings.left
import typingsSlinky.weixinApp.weixinAppStrings.right
