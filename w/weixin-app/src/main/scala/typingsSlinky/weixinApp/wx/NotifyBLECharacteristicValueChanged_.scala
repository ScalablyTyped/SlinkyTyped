...
trait NotifyBLECharacteristicValueChanged_
  ...
  @JSName("success")
  def success_MNotifyBLECharacteristicValueChanged_(res: ErrMsgResponse): Unit = js.native
}
...
object NotifyBLECharacteristicValueChanged_ {
  ...
  @scala.inline
  implicit class NotifyBLECharacteristicValueChanged_Ops[Self <: NotifyBLECharacteristicValueChanged_] (val x: Self) extends AnyVal {
    @scala.inline
