...
import typingsSlinky.weixinApp.wx.CameraDevice
import typingsSlinky.weixinApp.wx.EventType
import typingsSlinky.weixinApp.wx.ImageSizeType
import typingsSlinky.weixinApp.wx.ImageSourceType
import typingsSlinky.weixinApp.wx.LineCapType
import typingsSlinky.weixinApp.wx.LineJoinType
import typingsSlinky.weixinApp.wx.PaymentSignType
import typingsSlinky.weixinApp.wx.Scope
import typingsSlinky.weixinApp.wx.TimingFunction
import typingsSlinky.weixinApp.wx.TouchEventType
import typingsSlinky.weixinApp.wx.TransitionEventType
import typingsSlinky.weixinApp.wx.VideoSourceType
import typingsSlinky.weixinApp.wx.networkType
import typingsSlinky.weixinApp.wx.scanType
...
object weixinAppStrings {
  ...
  @js.native
  sealed trait `HMAC-SHA256` extends PaymentSignType
  ...
  @js.native
  sealed trait facial extends AuthModes
  
  @js.native
  sealed trait fingerPrint extends AuthModes
  ...
  @js.native
  sealed trait ppt extends js.Object
  ...
  @js.native
  sealed trait speech extends AuthModes
