...
object Behavior extends js.Object {
  /**
    ...
    */
  def apply[D, M, P, B /* <: js.Array[(typingsSlinky.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | String] */](): typingsSlinky.weixinApp.wx.Behavior[
    D with UnboxBehaviorsData[B], 
    P with UnboxBehaviorsProps[B], 
    M with UnboxBehaviorsMethods[B]
  ] = js.native
  def apply[D, M, P, B /* <: js.Array[(typingsSlinky.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | String] */](
    options: ThisTypedComponentOptionsWithRecordProps[typingsSlinky.weixinApp.wx.Component[D, P, B], D, M, P, B]
  ): typingsSlinky.weixinApp.wx.Behavior[
    D with UnboxBehaviorsData[B], 
    P with UnboxBehaviorsProps[B], 
    M with UnboxBehaviorsMethods[B]
  ] = js.native
