...
import typingsSlinky.weixinDashApp.Anon_Bubbles
...
/**
	 ...
	 */
@js.native
trait Component[D, P, B /* <: js.Array[
(typingsSlinky.weixinDashApp.wx.Behavior[js.Object, js.Object, js.Object]) | String] */] extends js.Object {
  /**
  		 * 组件数据，包括内部数据和属性值
  		 */
  var data: D with UnboxBehaviorsData[B] with typingsSlinky.weixinDashApp.weixinDashAppStrings.Component with js.Any = js.native
  /**
  		 * 节点dataset
  		 */
  ...
  /**
  		 ...
  		 */
  var properties: D with UnboxBehaviorsData[B] with typingsSlinky.weixinDashApp.weixinDashAppStrings.Component with js.Any = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def getRelationNodes(relationKey: String): js.Array[ComponentRelation[_, _]] = js.native
  /**
  		 * 检查组件是否具有 behavior
  ...
  /**
  		 ...
  		 */
  def selectAllComponents(selector: String): js.Array[typingsSlinky.weixinDashApp.wx.Component[_, _, js.Array[js.Any]]] = js.native
  /**
  		 * 使用选择器选择组件实例节点
  		 * 返回匹配到的第一个组件实例对象
  		 */
  def selectComponent(selector: String): typingsSlinky.weixinDashApp.wx.Component[_, _, js.Array[js.Any]] = js.native
  /**
  ...
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
    */ typingsSlinky.weixinDashApp.weixinDashAppStrings.Component with js.Any
  ): Unit = js.native
  def setData(
    data: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof D ]:? string | number | boolean | symbol | object | null | std.Array<any>}
