...
package object wx {
  ...
  import typingsSlinky.weixinDashApp.Anon_Args
  import typingsSlinky.weixinDashApp.Anon_Cursor
  import typingsSlinky.weixinDashApp.Anon_Name
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.form
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.input
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.scroll
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.tap
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.touchcancel
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.touchend
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.touchforcechange
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.touchmove
  import typingsSlinky.weixinDashApp.weixinDashAppStrings.touchstart
  ...
  {[ K in keyof T ]: weixin-app.wx.PropValidator<T[K]>}
    */ typingsSlinky.weixinDashApp.weixinDashAppStrings.RecordPropsDefinition with T
