...
object scanType {
  @scala.inline
  def barCode: typingsSlinky.weixinDashApp.weixinDashAppStrings.barCode = this.cast("barCode")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def qrCode: typingsSlinky.weixinDashApp.weixinDashAppStrings.qrCode = this.cast("qrCode")
}
