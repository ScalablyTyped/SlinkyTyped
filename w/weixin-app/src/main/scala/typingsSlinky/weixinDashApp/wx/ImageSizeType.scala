...
object ImageSizeType {
  ...
  @scala.inline
  def compressed: typingsSlinky.weixinDashApp.weixinDashAppStrings.compressed = this.cast("compressed")
  @scala.inline
  def original: typingsSlinky.weixinDashApp.weixinDashAppStrings.original = this.cast("original")
}
