...
object CameraDevice {
  @scala.inline
  def back: typingsSlinky.weixinDashApp.weixinDashAppStrings.back = this.cast("back")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def front: typingsSlinky.weixinDashApp.weixinDashAppStrings.front = this.cast("front")
}
