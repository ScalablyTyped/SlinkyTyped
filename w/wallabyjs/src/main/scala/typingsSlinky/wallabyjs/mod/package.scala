package typingsSlinky.wallabyjs
...
package object mod {
  ...
  type IWallabyProcessor = org.scalablytyped.runtime.StringDictionary[js.Function1[/* file */ typingsSlinky.wallabyjs.mod.IWallabyFile, scala.Unit]]
}
