...
object SequenceTypeDescription {
  ...
  @scala.inline
  implicit class SequenceTypeDescriptionOps[Self <: SequenceTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeneric(value: sequence): Self = this.set("generic", value.asInstanceOf[js.Any])
  }
}
