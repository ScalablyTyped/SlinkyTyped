...
import typingsSlinky.webpack.mod.ExternalsElement
...
trait Config
  ...
  var plugins: Plugins[this.type, typingsSlinky.webpack.mod.Plugin] = js.native
  ...
  def plugin(name: String): Plugin[this.type, typingsSlinky.webpack.mod.Plugin] = js.native
