...
import typingsSlinky.webpackDashChain.webpackDashChainStrings.multiple
import typingsSlinky.webpackDashChain.webpackDashChainStrings.single
...
class Optimization ()
  ...
  def minimizer(name: String): Plugin[this.type, typingsSlinky.webpack.webpackMod.Plugin] = js.native
