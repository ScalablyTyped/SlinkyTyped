...
import typingsSlinky.webpack.webpackMod.ExternalsElement
import typingsSlinky.webpack.webpackMod.Options.Stats
import typingsSlinky.webpack.webpackMod.Options.WatchOptions
import typingsSlinky.webpackDashChain.webpackDashChainStrings.development
import typingsSlinky.webpackDashChain.webpackDashChainStrings.none
import typingsSlinky.webpackDashChain.webpackDashChainStrings.production
...
@js.native
trait Config
  extends typingsSlinky.webpackDashChain.webpackDashChainMod.__Config.TypedChainedMap[Unit, js.Any] {
  ...
  var plugins: Plugins[this.type, typingsSlinky.webpack.webpackMod.Plugin] = js.native
  ...
  def plugin(name: String): Plugin[this.type, typingsSlinky.webpack.webpackMod.Plugin] = js.native
