...
import typingsSlinky.wixAnimations.mod.Direction
...
object wixAnimationsStrings {
  
  @js.native
  sealed trait default
    extends Sequence
       with typingsSlinky.wixAnimations.srcMod.Sequence
  @scala.inline
  ...
  sealed trait bottom
    extends Direction
       with typingsSlinky.wixAnimations.srcMod.Direction
  @scala.inline
  ...
  sealed trait large
    extends Timing
       with typingsSlinky.wixAnimations.srcMod.Timing
  @scala.inline
