package typingsSlinky.wojtekmajReactDatetimerangePicker.mod

import typingsSlinky.reactCalendar.anon.CalendarTilePropertiesact
import typingsSlinky.reactCalendar.anon.Date
import typingsSlinky.reactCalendar.mod.CalendarTileProperties
import typingsSlinky.reactCalendar.mod.CalendarType
import typingsSlinky.reactCalendar.mod.ClickWeekNumberCallback
import typingsSlinky.reactCalendar.mod.DateCallback
import typingsSlinky.reactCalendar.mod.Detail
import typingsSlinky.reactCalendar.mod.FormatterCallback
import typingsSlinky.reactCalendar.mod.ViewCallback
import typingsSlinky.reactCalendar.mod.ViewCallbackProperties
import typingsSlinky.wojtekmajReactDatetimerangePicker.wojtekmajReactDatetimerangePickerStrings.end
import typingsSlinky.wojtekmajReactDatetimerangePicker.wojtekmajReactDatetimerangePickerStrings.range
import typingsSlinky.wojtekmajReactDatetimerangePicker.wojtekmajReactDatetimerangePickerStrings.start
...
object DateTimeRangePickerCalendarProps {
  ...
  implicit class DateTimeRangePickerCalendarPropsOps[Self <: DateTimeRangePickerCalendarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultActiveStartDate(value: js.Date): Self = this.set("defaultActiveStartDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefaultValueDate(value: js.Date): Self = this.set("defaultValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultValue(value: js.Date | js.Array[js.Date]): Self = this.set("defaultValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatLongDate(value: (/* locale */ String, /* date */ js.Date) => String): Self = this.set("formatLongDate", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteFormatLongDate: Self = this.set("formatLongDate", js.undefined)
    
    @scala.inline
    def setFormatMonth(value: (/* locale */ String, /* date */ js.Date) => String): Self = this.set("formatMonth", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteFormatMonth: Self = this.set("formatMonth", js.undefined)
    
    @scala.inline
    def setFormatMonthYear(value: (/* locale */ String, /* date */ js.Date) => String): Self = this.set("formatMonthYear", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteFormatMonthYear: Self = this.set("formatMonthYear", js.undefined)
    
    @scala.inline
    def setFormatShortWeekday(value: (/* locale */ String, /* date */ js.Date) => String): Self = this.set("formatShortWeekday", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteFormatShortWeekday: Self = this.set("formatShortWeekday", js.undefined)
    
    @scala.inline
    def setFormatYear(value: (/* locale */ String, /* date */ js.Date) => String): Self = this.set("formatYear", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnClickDay(value: /* date */ js.Date => Unit): Self = this.set("onClickDay", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnClickDay: Self = this.set("onClickDay", js.undefined)
    
    @scala.inline
    def setOnClickDecade(value: /* date */ js.Date => Unit): Self = this.set("onClickDecade", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnClickDecade: Self = this.set("onClickDecade", js.undefined)
    
    @scala.inline
    def setOnClickMonth(value: /* date */ js.Date => Unit): Self = this.set("onClickMonth", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnClickMonth: Self = this.set("onClickMonth", js.undefined)
    
    @scala.inline
    def setOnClickWeekNumber(value: (/* weekNumber */ Double, /* date */ js.Date) => Unit): Self = this.set("onClickWeekNumber", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnClickWeekNumber: Self = this.set("onClickWeekNumber", js.undefined)
    
    @scala.inline
    def setOnClickYear(value: /* date */ js.Date => Unit): Self = this.set("onClickYear", js.Any.fromFunction1(value))
