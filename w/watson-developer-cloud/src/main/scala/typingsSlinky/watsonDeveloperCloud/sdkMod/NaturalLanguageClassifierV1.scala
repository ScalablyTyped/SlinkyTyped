...
import typingsSlinky.watsonDeveloperCloud.naturalLanguageClassifierV1GeneratedMod.Options
import typingsSlinky.watsonDeveloperCloud.naturalLanguageClassifierV1GeneratedMod.^
