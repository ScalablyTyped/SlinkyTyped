...
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.Options
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.^
...
object CompareComplyV1 {
  ...
  object GetFeedbackConstants {
    ...
    object Model extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[
            typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.GetFeedbackConstants.Model with String
          ] = js.native
  ...
  object UpdateBatchConstants {
    ...
    object Action extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[
            typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Action with String
          ] = js.native
      
      /* "cancel" */ val CANCEL: typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Action.CANCEL with String = js.native
      
      /* "rescan" */ val RESCAN: typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Action.RESCAN with String = js.native
    }
    ...
    object Model extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[
            typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Model with String
          ] = js.native
      
      /* "contracts" */ val CONTRACTS: typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Model.CONTRACTS with String = js.native
      
      /* "tables" */ val TABLES: typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Model.TABLES with String = js.native
    }
  }
}
