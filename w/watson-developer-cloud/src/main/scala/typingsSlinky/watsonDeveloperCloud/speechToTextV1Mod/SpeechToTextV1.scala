...
trait SpeechToTextV1
  extends typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.^ {
  ...
  /**
    ...
    */
  def recognizeUsingWebSocket(params: js.Any): typingsSlinky.watsonDeveloperCloud.recognizeStreamMod.^ = js.native
  /**
