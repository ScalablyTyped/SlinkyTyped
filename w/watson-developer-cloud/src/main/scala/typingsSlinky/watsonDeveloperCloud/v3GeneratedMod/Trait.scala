...
object Trait {
  ...
  implicit class TraitOps[Self <: Trait] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChildren(value: js.Array[Trait]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRaw_score(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("raw_score")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRaw_score: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("raw_score")(js.undefined)
        ret
    }
    @scala.inline
    def withSignificant(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("significant")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSignificant: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("significant")(js.undefined)
        ret
    }
  }
