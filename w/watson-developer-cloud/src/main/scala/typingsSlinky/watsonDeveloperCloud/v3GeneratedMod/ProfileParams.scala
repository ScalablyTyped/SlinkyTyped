...
import typingsSlinky.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.AcceptLanguage
import typingsSlinky.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.ContentLanguage
import typingsSlinky.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.ContentType
