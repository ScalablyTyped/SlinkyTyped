...
object ResetAcousticModelParams {
  ...
  @scala.inline
  def apply(customization_id: String): ResetAcousticModelParams = {
  ...
  @scala.inline
  implicit class ResetAcousticModelParamsMutableBuilder[Self <: ResetAcousticModelParams] (val x: Self) extends AnyVal {
