...
import typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.AddGrammarConstants.ContentType
...
object AddGrammarParams {
  ...
  implicit class AddGrammarParamsOps[Self <: AddGrammarParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGrammar_file(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("grammar_file")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
