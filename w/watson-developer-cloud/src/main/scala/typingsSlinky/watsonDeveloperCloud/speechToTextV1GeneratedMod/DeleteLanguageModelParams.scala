...
@js.native
trait DeleteLanguageModelParams extends StObject {
...
object DeleteLanguageModelParams {
  
  @scala.inline
  def apply(customization_id: String): DeleteLanguageModelParams = {
  ...
  @scala.inline
  implicit class DeleteLanguageModelParamsMutableBuilder[Self <: DeleteLanguageModelParams] (val x: Self) extends AnyVal {
