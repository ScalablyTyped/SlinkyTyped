...
object Events extends StObject {
  ...
  /* "recognitions.completed" */ val RECOGNITIONS_COMPLETED: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events.RECOGNITIONS_COMPLETED with String = js.native
  
  @js.native
  sealed trait RECOGNITIONS_COMPLETED_WITH_RESULTS extends Events
  /* "recognitions.completed_with_results" */ val RECOGNITIONS_COMPLETED_WITH_RESULTS: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events.RECOGNITIONS_COMPLETED_WITH_RESULTS with String = js.native
  
  @js.native
  sealed trait RECOGNITIONS_FAILED extends Events
  /* "recognitions.failed" */ val RECOGNITIONS_FAILED: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events.RECOGNITIONS_FAILED with String = js.native
  
  @js.native
  sealed trait RECOGNITIONS_STARTED extends Events
  /* "recognitions.started" */ val RECOGNITIONS_STARTED: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events.RECOGNITIONS_STARTED with String = js.native
}
