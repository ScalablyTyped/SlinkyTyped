...
object SpeechRecognitionResults {
  ...
  implicit class SpeechRecognitionResultsOps[Self <: SpeechRecognitionResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResult_index(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("result_index")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResult_index: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("result_index")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSpeaker_labels(value: js.Array[SpeakerLabelsResult]): Self = {
        val ret = this.duplicate
