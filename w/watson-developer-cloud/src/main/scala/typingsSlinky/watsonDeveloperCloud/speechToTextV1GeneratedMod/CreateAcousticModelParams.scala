...
import typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateAcousticModelConstants.BaseModelName
...
object CreateAcousticModelParams {
  ...
  @scala.inline
  implicit class CreateAcousticModelParamsMutableBuilder[Self <: CreateAcousticModelParams] (val x: Self) extends AnyVal {
