...
object ListWordsConstants {
  ...
  object Sort extends StObject {
    ...
    /* "alphabetical" */ val ALPHABETICAL: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.Sort.ALPHABETICAL with String = js.native
    
    @js.native
    sealed trait COUNT extends Sort
    /* "count" */ val COUNT: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.Sort.COUNT with String = js.native
  }
  ...
  object WordType extends StObject {
    ...
    /* "all" */ val ALL: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.WordType.ALL with String = js.native
    
    @js.native
    sealed trait CORPORA extends WordType
    /* "corpora" */ val CORPORA: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.WordType.CORPORA with String = js.native
    
    @js.native
    sealed trait GRAMMARS extends WordType
    /* "grammars" */ val GRAMMARS: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.WordType.GRAMMARS with String = js.native
    
    @js.native
    sealed trait USER extends WordType
    /* "user" */ val USER: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.ListWordsConstants.WordType.USER with String = js.native
  }
}
