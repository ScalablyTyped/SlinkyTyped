...
object AddGrammarConstants {
  ...
  object ContentType extends StObject {
    ...
    /* "application/srgs" */ val APPLICATION_SRGS: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.AddGrammarConstants.ContentType.APPLICATION_SRGS with String = js.native
    
    @js.native
    sealed trait APPLICATION_SRGS_XML extends ContentType
    /* "application/srgs+xml" */ val APPLICATION_SRGS_XML: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.AddGrammarConstants.ContentType.APPLICATION_SRGS_XML with String = js.native
  }
}
