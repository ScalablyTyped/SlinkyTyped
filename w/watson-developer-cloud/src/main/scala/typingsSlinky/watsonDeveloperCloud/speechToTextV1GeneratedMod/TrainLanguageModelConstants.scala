...
object TrainLanguageModelConstants {
  ...
  object WordTypeToAdd extends StObject {
    ...
    /* "all" */ val ALL: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.TrainLanguageModelConstants.WordTypeToAdd.ALL with String = js.native
    
    @js.native
    sealed trait USER extends WordTypeToAdd
    /* "user" */ val USER: typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.TrainLanguageModelConstants.WordTypeToAdd.USER with String = js.native
  }
}
