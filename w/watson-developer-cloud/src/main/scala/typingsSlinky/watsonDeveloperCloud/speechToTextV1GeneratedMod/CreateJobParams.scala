...
import typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.ContentType
import typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events
import typingsSlinky.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Model
...
object CreateJobParams {
  ...
  implicit class CreateJobParamsOps[Self <: CreateJobParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutCallback_url: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("callback_url")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withEvents(value: Events | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withResults_ttl(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("results_ttl")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResults_ttl: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("results_ttl")(js.undefined)
        ret
    }
    @scala.inline
