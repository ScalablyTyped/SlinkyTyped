...
object GetAudioParams {
  ...
  @scala.inline
  def apply(audio_name: String, customization_id: String): GetAudioParams = {
  ...
  @scala.inline
  implicit class GetAudioParamsMutableBuilder[Self <: GetAudioParams] (val x: Self) extends AnyVal {
