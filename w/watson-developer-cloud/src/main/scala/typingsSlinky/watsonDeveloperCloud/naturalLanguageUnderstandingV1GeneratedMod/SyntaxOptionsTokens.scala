...
object SyntaxOptionsTokens {
  ...
  def apply(lemma: js.UndefOr[Boolean] = js.undefined, part_of_speech: js.UndefOr[Boolean] = js.undefined): SyntaxOptionsTokens = {
    ...
    if (!js.isUndefined(lemma)) __obj.updateDynamic("lemma")(lemma.get.asInstanceOf[js.Any])
    if (!js.isUndefined(part_of_speech)) __obj.updateDynamic("part_of_speech")(part_of_speech.get.asInstanceOf[js.Any])
