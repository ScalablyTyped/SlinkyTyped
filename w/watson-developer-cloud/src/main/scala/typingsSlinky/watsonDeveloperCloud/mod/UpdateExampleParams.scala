...
object UpdateExampleParams {
  ...
  implicit class UpdateExampleParamsOps[Self <: UpdateExampleParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNew_mentions(value: js.Array[Mention]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_mentions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNew_mentions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_mentions")(js.undefined)
        ret
    }
    @scala.inline
    def withNew_text(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_text")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNew_text: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_text")(js.undefined)
        ret
    }
    @scala.inline
