...
import typingsSlinky.watsonDeveloperCloud.mod.ListCounterexamplesConstants.Sort
...
object ListCounterexamplesParams {
  ...
  @scala.inline
  implicit class ListCounterexamplesParamsOps[Self <: ListCounterexamplesParams] (val x: Self) extends AnyVal {
    @scala.inline
