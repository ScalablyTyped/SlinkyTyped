...
object UpdateSynonymParams {
  ...
  implicit class UpdateSynonymParamsOps[Self <: UpdateSynonymParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNew_synonym(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_synonym")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNew_synonym: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("new_synonym")(js.undefined)
        ret
    }
    @scala.inline
