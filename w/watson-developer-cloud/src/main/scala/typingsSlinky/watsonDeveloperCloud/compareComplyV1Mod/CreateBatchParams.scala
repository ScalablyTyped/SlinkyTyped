...
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.CreateBatchConstants.Function
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.CreateBatchConstants.Model
...
object CreateBatchParams {
  ...
  implicit class CreateBatchParamsOps[Self <: CreateBatchParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_function(value: Function | String): Self = {
    ...
    @scala.inline
    def withInput_credentials_file(value: ReadableStream | FileObject | Buffer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("input_credentials_file")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOutput_credentials_file(value: ReadableStream | FileObject | Buffer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("output_credentials_file")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
