...
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.ExtractTablesConstants.FileContentType
import typingsSlinky.watsonDeveloperCloud.compareComplyV1Mod.ExtractTablesConstants.Model
