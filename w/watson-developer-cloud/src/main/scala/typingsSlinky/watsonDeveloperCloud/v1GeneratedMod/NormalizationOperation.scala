...
object NormalizationOperation {
  ...
  implicit class NormalizationOperationOps[Self <: NormalizationOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutDestination_field: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("destination_field")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withoutSource_field: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("source_field")(js.undefined)
        ret
    }
  }
