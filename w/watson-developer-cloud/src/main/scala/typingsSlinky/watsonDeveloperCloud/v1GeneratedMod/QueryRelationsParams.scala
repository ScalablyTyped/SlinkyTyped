...
object QueryRelationsParams {
  ...
  def apply(
    ...
    evidence_count: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(evidence_count)) __obj.updateDynamic("evidence_count")(evidence_count.get.asInstanceOf[js.Any])
