...
@js.native
trait GetTokenizationDictionaryStatusParams extends StObject {
...
object GetTokenizationDictionaryStatusParams {
  ...
  @scala.inline
  implicit class GetTokenizationDictionaryStatusParamsMutableBuilder[Self <: GetTokenizationDictionaryStatusParams] (val x: Self) extends AnyVal {
