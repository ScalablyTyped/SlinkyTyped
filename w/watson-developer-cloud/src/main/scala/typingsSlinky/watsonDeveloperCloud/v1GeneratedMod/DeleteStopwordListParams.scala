...
@js.native
trait DeleteStopwordListParams extends StObject {
...
object DeleteStopwordListParams {
  
  @scala.inline
  def apply(collection_id: String, environment_id: String): DeleteStopwordListParams = {
    ...
    __obj.asInstanceOf[DeleteStopwordListParams]
  }
  
  @scala.inline
  implicit class DeleteStopwordListParamsMutableBuilder[Self <: DeleteStopwordListParams] (val x: Self) extends AnyVal {
