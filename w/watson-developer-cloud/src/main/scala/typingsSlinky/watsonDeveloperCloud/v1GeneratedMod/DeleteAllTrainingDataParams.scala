...
@js.native
trait DeleteAllTrainingDataParams extends StObject {
...
object DeleteAllTrainingDataParams {
  ...
  @scala.inline
  implicit class DeleteAllTrainingDataParamsMutableBuilder[Self <: DeleteAllTrainingDataParams] (val x: Self) extends AnyVal {
