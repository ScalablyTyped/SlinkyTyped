...
object QueryNoticesParams {
  ...
  @scala.inline
  implicit class QueryNoticesParamsOps[Self <: QueryNoticesParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPassages_fieldsVarargs(value: String*): Self = this.set("passages_fields", js.Array(value :_*))
    @scala.inline
    def setPassages_fields(value: js.Array[String]): Self = this.set("passages_fields", value.asInstanceOf[js.Any])
    @scala.inline
