...
trait QueryNoticesParams extends StObject {
  ...
  var passages_fields: js.UndefOr[js.Array[String]] = js.native
...
object QueryNoticesParams {
  ...
  @scala.inline
  def apply(collection_id: String, environment_id: String): QueryNoticesParams = {
  ...
  @scala.inline
  implicit class QueryNoticesParamsMutableBuilder[Self <: QueryNoticesParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPassages_fields(value: js.Array[String]): Self = StObject.set(x, "passages_fields", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPassages_fieldsUndefined: Self = StObject.set(x, "passages_fields", js.undefined)
    
    @scala.inline
    def setPassages_fieldsVarargs(value: String*): Self = StObject.set(x, "passages_fields", js.Array(value :_*))
