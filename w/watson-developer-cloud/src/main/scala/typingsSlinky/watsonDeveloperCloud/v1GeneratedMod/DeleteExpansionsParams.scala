...
@js.native
trait DeleteExpansionsParams extends StObject {
...
object DeleteExpansionsParams {
  
  @scala.inline
  def apply(collection_id: String, environment_id: String): DeleteExpansionsParams = {
    ...
    __obj.asInstanceOf[DeleteExpansionsParams]
  }
  
  @scala.inline
  implicit class DeleteExpansionsParamsMutableBuilder[Self <: DeleteExpansionsParams] (val x: Self) extends AnyVal {
