...
object ListTrainingDataParams {
  ...
  @scala.inline
  def apply(collection_id: String, environment_id: String): ListTrainingDataParams = {
  ...
  @scala.inline
  implicit class ListTrainingDataParamsMutableBuilder[Self <: ListTrainingDataParams] (val x: Self) extends AnyVal {
