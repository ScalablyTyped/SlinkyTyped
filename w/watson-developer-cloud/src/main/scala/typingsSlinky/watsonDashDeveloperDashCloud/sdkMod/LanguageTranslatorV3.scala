...
import typingsSlinky.watsonDashDeveloperDashCloud.languageDashTranslatorV3Mod.Options
import typingsSlinky.watsonDashDeveloperDashCloud.languageDashTranslatorV3Mod.^
