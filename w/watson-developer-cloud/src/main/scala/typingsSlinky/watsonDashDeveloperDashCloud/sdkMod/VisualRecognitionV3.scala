...
import typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.Options
import typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.^
...
object VisualRecognitionV3 extends js.Object {
  ...
  object ClassifyConstants extends js.Object {
    ...
    object AcceptLanguage extends js.Object {
      /* "ar" */ val AR: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.AR with String = js.native
      /* "de" */ val DE: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.DE with String = js.native
      /* "en" */ val EN: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.EN with String = js.native
      /* "es" */ val ES: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.ES with String = js.native
      /* "fr" */ val FR: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.FR with String = js.native
      /* "it" */ val IT: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.IT with String = js.native
      /* "ja" */ val JA: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.JA with String = js.native
      /* "ko" */ val KO: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.KO with String = js.native
      /* "pt-br" */ val PT_BR: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.PT_BR with String = js.native
      /* "zh-cn" */ val ZH_CN: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.ZH_CN with String = js.native
      /* "zh-tw" */ val ZH_TW: typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage.ZH_TW with String = js.native
      @JSBracketAccess
      def apply(value: String): js.UndefOr[
            typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.ClassifyConstants.AcceptLanguage with String
          ] = js.native
    }
  ...
  object DetectFacesConstants extends js.Object {
    ...
    object AcceptLanguage extends js.Object {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[
            typingsSlinky.watsonDashDeveloperDashCloud.visualDashRecognitionV3DashGeneratedMod.DetectFacesConstants.AcceptLanguage with String
          ] = js.native
    }
