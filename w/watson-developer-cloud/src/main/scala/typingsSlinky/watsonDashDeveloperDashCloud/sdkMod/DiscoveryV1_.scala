...
import typingsSlinky.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.Options
import typingsSlinky.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.^
