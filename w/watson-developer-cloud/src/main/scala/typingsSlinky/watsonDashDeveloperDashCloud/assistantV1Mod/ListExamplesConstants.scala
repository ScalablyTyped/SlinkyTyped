...
object ListExamplesConstants extends js.Object {
  ...
  object Sort extends js.Object {
    ...
    /* "text" */ val TEXT: typingsSlinky.watsonDashDeveloperDashCloud.assistantV1Mod.ListExamplesConstants.Sort.TEXT with String = js.native
    /* "updated" */ val UPDATED: typingsSlinky.watsonDashDeveloperDashCloud.assistantV1Mod.ListExamplesConstants.Sort.UPDATED with String = js.native
    @JSBracketAccess
