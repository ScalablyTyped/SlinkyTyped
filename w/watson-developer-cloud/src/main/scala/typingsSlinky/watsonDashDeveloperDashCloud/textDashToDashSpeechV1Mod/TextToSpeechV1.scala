...
trait TextToSpeechV1
  extends typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.^ {
  /**
  ...
  /**
    ...
    */
  def synthesizeUsingWebSocket(params: js.Any): typingsSlinky.watsonDashDeveloperDashCloud.libSynthesizeDashStreamMod.^ = js.native
}
