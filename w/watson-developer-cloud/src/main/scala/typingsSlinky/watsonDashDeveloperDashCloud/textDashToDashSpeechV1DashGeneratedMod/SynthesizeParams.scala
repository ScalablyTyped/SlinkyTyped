package typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod

import typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.SynthesizeConstants.Accept
...
trait SynthesizeParams extends js.Object {
  ...
  var voice: js.UndefOr[
    typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.SynthesizeConstants.Voice | String
  ] = js.undefined
}
...
object SynthesizeParams {
  ...
  def apply(
    ...
    voice: typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.SynthesizeConstants.Voice | String = null
  ): SynthesizeParams = {
