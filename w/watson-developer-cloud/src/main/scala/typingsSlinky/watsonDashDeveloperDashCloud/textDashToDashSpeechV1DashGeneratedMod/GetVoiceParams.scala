...
trait GetVoiceParams extends js.Object {
  ...
  var voice: typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetVoiceConstants.Voice | String
}

object GetVoiceParams {
  @scala.inline
  def apply(
    voice: typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetVoiceConstants.Voice | String,
