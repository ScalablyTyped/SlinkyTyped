...
import typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Format
...
trait GetPronunciationParams extends js.Object {
  ...
  var voice: js.UndefOr[
    typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Voice | String
  ] = js.undefined
}
...
object GetPronunciationParams {
  ...
  def apply(
    ...
    voice: typingsSlinky.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Voice | String = null
