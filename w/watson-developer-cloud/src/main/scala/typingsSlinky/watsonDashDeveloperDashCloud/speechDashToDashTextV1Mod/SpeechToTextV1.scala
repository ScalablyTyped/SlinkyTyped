package typingsSlinky.watsonDashDeveloperDashCloud.speechDashToDashTextV1Mod
...
trait SpeechToTextV1
  extends typingsSlinky.watsonDashDeveloperDashCloud.speechDashToDashTextV1DashGeneratedMod.^ {
  ...
  /**
    ...
    */
  def recognizeUsingWebSocket(params: js.Any): typingsSlinky.watsonDashDeveloperDashCloud.libRecognizeDashStreamMod.^ = js.native
  /**
