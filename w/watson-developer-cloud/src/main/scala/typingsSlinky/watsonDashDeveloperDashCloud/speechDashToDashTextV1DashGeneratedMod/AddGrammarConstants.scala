...
import typingsSlinky.watsonDashDeveloperDashCloud.speechDashToDashTextV1DashGeneratedMod.AddGrammarConstants.ContentType
...
object AddGrammarConstants extends js.Object {
  ...
  object ContentType extends js.Object {
    ...
    /* "application/srgs" */ val APPLICATION_SRGS: typingsSlinky.watsonDashDeveloperDashCloud.speechDashToDashTextV1DashGeneratedMod.AddGrammarConstants.ContentType.APPLICATION_SRGS with String = js.native
    /* "application/srgs+xml" */ val APPLICATION_SRGS_XML: typingsSlinky.watsonDashDeveloperDashCloud.speechDashToDashTextV1DashGeneratedMod.AddGrammarConstants.ContentType.APPLICATION_SRGS_XML with String = js.native
    @JSBracketAccess
