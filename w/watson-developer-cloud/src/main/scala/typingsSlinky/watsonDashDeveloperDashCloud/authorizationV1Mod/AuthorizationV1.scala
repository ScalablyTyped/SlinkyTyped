package typingsSlinky.watsonDashDeveloperDashCloud.authorizationV1Mod

import typingsSlinky.ibmDashCloudDashSdkDashCore.ibmDashCloudDashSdkDashCoreMod.BaseService
