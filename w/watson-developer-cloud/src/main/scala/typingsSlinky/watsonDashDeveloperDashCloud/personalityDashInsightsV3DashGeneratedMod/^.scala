package typingsSlinky.watsonDashDeveloperDashCloud.personalityDashInsightsV3DashGeneratedMod
...
/**
  ...
  */
@JSImport("watson-developer-cloud/personality-insights/v3-generated", JSImport.Namespace)
@js.native
class ^ protected () extends PersonalityInsightsV3 {
  /**
