...
class Solver protected ()
  extends typingsSlinky.webcola.distSrcVpscMod.Solver {
  def this(
    vs: js.Array[typingsSlinky.webcola.distSrcVpscMod.Variable],
    cs: js.Array[typingsSlinky.webcola.distSrcVpscMod.Constraint]
  ) = this()
}
