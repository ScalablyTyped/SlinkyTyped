...
import typingsSlinky.webcola.Anon_X
import typingsSlinky.webcola.distSrcLayoutMod.Group
import typingsSlinky.webcola.distSrcLayoutMod.Link
import typingsSlinky.webcola.distSrcLayoutMod.Node
...
@js.native
class Layout ()
  extends typingsSlinky.webcola.distSrcLayoutMod.Layout
