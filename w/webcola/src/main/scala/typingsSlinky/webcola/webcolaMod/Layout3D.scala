...
class Layout3D protected ()
  extends typingsSlinky.webcola.distSrcLayout3dMod.Layout3D {
  def this(
    nodes: js.Array[typingsSlinky.webcola.distSrcLayout3dMod.Node3D],
    links: js.Array[typingsSlinky.webcola.distSrcLayout3dMod.Link3D]
  ) = this()
  def this(
    nodes: js.Array[typingsSlinky.webcola.distSrcLayout3dMod.Node3D],
    links: js.Array[typingsSlinky.webcola.distSrcLayout3dMod.Link3D],
