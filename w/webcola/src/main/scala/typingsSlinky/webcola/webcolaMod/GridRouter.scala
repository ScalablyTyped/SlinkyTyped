...
import typingsSlinky.webcola.distSrcGridrouterMod.NodeAccessor
...
class GridRouter[Node] protected ()
  extends typingsSlinky.webcola.distSrcGridrouterMod.GridRouter[Node] {
...
object GridRouter extends js.Object {
  ...
  def angleBetween2Lines(
    line1: js.Array[typingsSlinky.webcola.distSrcGeomMod.Point],
    line2: js.Array[typingsSlinky.webcola.distSrcGeomMod.Point]
  ): Double = js.native
  def getRoutePath(
    route: js.Array[js.Array[typingsSlinky.webcola.distSrcGeomMod.Point]],
    cornerradius: Double,
    arrowwidth: Double,
    arrowheight: Double
  ): Anon_Arrowpath = js.native
  def getSegmentSets(routes: js.Any, x: js.Any, y: js.Any): js.Array[_] = js.native
  def makeSegments(path: js.Array[typingsSlinky.webcola.distSrcGeomMod.Point]): js.Array[js.Array[typingsSlinky.webcola.distSrcGeomMod.Point]] = js.native
  def nudgeSegments(
    routes: js.Any,
    x: String,
    y: String,
