...
object geomMod extends js.Object {
  ...
  class TangentVisibilityGraph protected () extends js.Object {
    ...
    def this(P: js.Array[js.Array[TVGPoint]], g0: AnonE) = this()
  ...
  def LLtangentPolyPolyC(V: js.Array[Point], W: js.Array[Point]): AnonT1 = js.native
  @JSName("LRtangent_PolyPolyC")
  def LRtangentPolyPolyC(V: js.Array[Point], W: js.Array[Point]): AnonT1 = js.native
  @JSName("RLtangent_PolyPolyC")
  def RLtangentPolyPolyC(V: js.Array[Point], W: js.Array[Point]): AnonT1 = js.native
  @JSName("RRtangent_PolyPolyC")
  def RRtangentPolyPolyC(V: js.Array[Point], W: js.Array[Point]): AnonT1 = js.native
