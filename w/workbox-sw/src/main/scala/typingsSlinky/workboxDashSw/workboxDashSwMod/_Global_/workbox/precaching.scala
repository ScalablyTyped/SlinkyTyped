...
object precaching extends js.Object {
  ...
  class PrecacheController ()
    extends typingsSlinky.workboxDashPrecaching.workboxDashPrecachingMod.PrecacheController
  
  var PrecacheController: js.Any | Instantiable0[typingsSlinky.workboxDashPrecaching.workboxDashPrecachingMod.PrecacheController] = js.native
