...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "web3-bzz" % "1.2.6-0af15a",
  ...
  "org.scalablytyped.slinky" %%% "web3-eth" % "1.2.6-7607ae",
  ...
  "org.scalablytyped.slinky" %%% "web3-shh" % "1.2.6-50e55c",
