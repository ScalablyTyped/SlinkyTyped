...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(errorsAsWarnings)) __obj.updateDynamic("errorsAsWarnings")(errorsAsWarnings.get.asInstanceOf[js.Any])
    if (!js.isUndefined(forceIsolatedModules)) __obj.updateDynamic("forceIsolatedModules")(forceIsolatedModules.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(transpileOnly)) __obj.updateDynamic("transpileOnly")(transpileOnly.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useBabel)) __obj.updateDynamic("useBabel")(useBabel.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useCache)) __obj.updateDynamic("useCache")(useCache.get.asInstanceOf[js.Any])
    if (!js.isUndefined(usePrecompiledFiles)) __obj.updateDynamic("usePrecompiledFiles")(usePrecompiledFiles.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useTranspileModule)) __obj.updateDynamic("useTranspileModule")(useTranspileModule.get.asInstanceOf[js.Any])
