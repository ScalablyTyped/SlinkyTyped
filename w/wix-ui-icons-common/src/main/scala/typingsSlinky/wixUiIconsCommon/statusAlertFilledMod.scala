...
object statusAlertFilledMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[StatusAlertFilledProps] = js.native
  
  @js.native
  trait StatusAlertFilledProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[StatusAlertFilledProps]
  
  /* This means you don't have to write `default`, but can instead just say `statusAlertFilledMod.foo` */
  override def _to: ReactComponentClass[StatusAlertFilledProps] = default
}
