package typingsSlinky.wixUiIconsCommon.chevronRightLargeMod
...
object ChevronRightLargeProps {
  ...
  @scala.inline
  implicit class ChevronRightLargePropsOps[Self <: ChevronRightLargeProps] (val x: Self) extends AnyVal {
