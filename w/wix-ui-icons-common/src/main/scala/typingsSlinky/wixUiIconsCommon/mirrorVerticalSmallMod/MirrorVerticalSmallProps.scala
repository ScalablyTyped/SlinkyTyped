package typingsSlinky.wixUiIconsCommon.mirrorVerticalSmallMod
...
object MirrorVerticalSmallProps {
  ...
  @scala.inline
  implicit class MirrorVerticalSmallPropsOps[Self <: MirrorVerticalSmallProps] (val x: Self) extends AnyVal {
