package typingsSlinky.wixUiIconsCommon.pauseFilledSmallMod
...
object PauseFilledSmallProps {
  ...
  @scala.inline
  implicit class PauseFilledSmallPropsOps[Self <: PauseFilledSmallProps] (val x: Self) extends AnyVal {
