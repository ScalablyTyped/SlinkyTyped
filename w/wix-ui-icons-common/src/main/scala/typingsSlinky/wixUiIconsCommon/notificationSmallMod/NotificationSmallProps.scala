package typingsSlinky.wixUiIconsCommon.notificationSmallMod
...
object NotificationSmallProps {
  ...
  @scala.inline
  implicit class NotificationSmallPropsOps[Self <: NotificationSmallProps] (val x: Self) extends AnyVal {
