package typingsSlinky.wixUiIconsCommon.squareRatioSmallMod
...
object SquareRatioSmallProps {
  ...
  @scala.inline
  implicit class SquareRatioSmallPropsOps[Self <: SquareRatioSmallProps] (val x: Self) extends AnyVal {
