package typingsSlinky.wixUiIconsCommon.distributeHorizontallyMod
...
object DistributeHorizontallyProps {
  ...
  @scala.inline
  implicit class DistributeHorizontallyPropsOps[Self <: DistributeHorizontallyProps] (val x: Self) extends AnyVal {
