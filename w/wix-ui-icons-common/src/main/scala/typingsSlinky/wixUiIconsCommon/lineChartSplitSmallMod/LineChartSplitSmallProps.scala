package typingsSlinky.wixUiIconsCommon.lineChartSplitSmallMod
...
object LineChartSplitSmallProps {
  ...
  @scala.inline
  implicit class LineChartSplitSmallPropsOps[Self <: LineChartSplitSmallProps] (val x: Self) extends AnyVal {
