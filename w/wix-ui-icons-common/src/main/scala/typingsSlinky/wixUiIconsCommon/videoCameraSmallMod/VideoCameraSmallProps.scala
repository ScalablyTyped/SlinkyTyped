package typingsSlinky.wixUiIconsCommon.videoCameraSmallMod
...
object VideoCameraSmallProps {
  ...
  @scala.inline
  implicit class VideoCameraSmallPropsOps[Self <: VideoCameraSmallProps] (val x: Self) extends AnyVal {
