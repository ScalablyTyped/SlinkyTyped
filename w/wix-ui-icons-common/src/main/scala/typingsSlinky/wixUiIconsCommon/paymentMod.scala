...
object paymentMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[PaymentProps] = js.native
  ...
  type _To = ReactComponentClass[PaymentProps]
  
  /* This means you don't have to write `default`, but can instead just say `paymentMod.foo` */
  override def _to: ReactComponentClass[PaymentProps] = default
}
