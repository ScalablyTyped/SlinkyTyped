package typingsSlinky.wixUiIconsCommon.automationsFilledSmallMod
...
object AutomationsFilledSmallProps {
  ...
  @scala.inline
  implicit class AutomationsFilledSmallPropsOps[Self <: AutomationsFilledSmallProps] (val x: Self) extends AnyVal {
