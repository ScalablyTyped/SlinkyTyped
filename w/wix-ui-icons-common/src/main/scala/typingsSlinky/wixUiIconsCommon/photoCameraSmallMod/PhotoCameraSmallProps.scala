package typingsSlinky.wixUiIconsCommon.photoCameraSmallMod
...
object PhotoCameraSmallProps {
  ...
  @scala.inline
  implicit class PhotoCameraSmallPropsOps[Self <: PhotoCameraSmallProps] (val x: Self) extends AnyVal {
