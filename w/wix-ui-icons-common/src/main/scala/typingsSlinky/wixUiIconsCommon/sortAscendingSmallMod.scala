...
object sortAscendingSmallMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SortAscendingSmallProps] = js.native
  
  @js.native
  trait SortAscendingSmallProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[SortAscendingSmallProps]
  
  /* This means you don't have to write `default`, but can instead just say `sortAscendingSmallMod.foo` */
  override def _to: ReactComponentClass[SortAscendingSmallProps] = default
}
