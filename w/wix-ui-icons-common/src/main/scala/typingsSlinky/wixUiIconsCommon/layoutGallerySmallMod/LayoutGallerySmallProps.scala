package typingsSlinky.wixUiIconsCommon.layoutGallerySmallMod
...
object LayoutGallerySmallProps {
  ...
  @scala.inline
  implicit class LayoutGallerySmallPropsOps[Self <: LayoutGallerySmallProps] (val x: Self) extends AnyVal {
