...
object refreshSmallMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[RefreshSmallProps] = js.native
  
  @js.native
  trait RefreshSmallProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[RefreshSmallProps]
  
  /* This means you don't have to write `default`, but can instead just say `refreshSmallMod.foo` */
  override def _to: ReactComponentClass[RefreshSmallProps] = default
}
