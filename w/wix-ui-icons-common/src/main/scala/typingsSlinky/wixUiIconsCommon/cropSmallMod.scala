...
object cropSmallMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CropSmallProps] = js.native
  
  @js.native
  trait CropSmallProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[CropSmallProps]
  
  /* This means you don't have to write `default`, but can instead just say `cropSmallMod.foo` */
  override def _to: ReactComponentClass[CropSmallProps] = default
}
