package typingsSlinky.wixUiIconsCommon.sizeAndRatioSmallMod
...
object SizeAndRatioSmallProps {
  ...
  @scala.inline
  implicit class SizeAndRatioSmallPropsOps[Self <: SizeAndRatioSmallProps] (val x: Self) extends AnyVal {
