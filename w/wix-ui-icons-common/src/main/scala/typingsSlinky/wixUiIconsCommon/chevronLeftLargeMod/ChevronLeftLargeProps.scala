package typingsSlinky.wixUiIconsCommon.chevronLeftLargeMod
...
object ChevronLeftLargeProps {
  ...
  @scala.inline
  implicit class ChevronLeftLargePropsOps[Self <: ChevronLeftLargeProps] (val x: Self) extends AnyVal {
