package typingsSlinky.wixUiIconsCommon.dateCheckedSmallMod
...
object DateCheckedSmallProps {
  ...
  @scala.inline
  implicit class DateCheckedSmallPropsOps[Self <: DateCheckedSmallProps] (val x: Self) extends AnyVal {
