package typingsSlinky.wixUiIconsCommon.circleLargeSmallMod
...
object CircleLargeSmallProps {
  ...
  @scala.inline
  implicit class CircleLargeSmallPropsOps[Self <: CircleLargeSmallProps] (val x: Self) extends AnyVal {
