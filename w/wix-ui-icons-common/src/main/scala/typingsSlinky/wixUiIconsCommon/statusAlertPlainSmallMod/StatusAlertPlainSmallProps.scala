package typingsSlinky.wixUiIconsCommon.statusAlertPlainSmallMod
...
object StatusAlertPlainSmallProps {
  ...
  @scala.inline
  implicit class StatusAlertPlainSmallPropsOps[Self <: StatusAlertPlainSmallProps] (val x: Self) extends AnyVal {
