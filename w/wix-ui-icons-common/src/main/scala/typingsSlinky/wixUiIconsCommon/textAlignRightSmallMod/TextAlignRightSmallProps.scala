package typingsSlinky.wixUiIconsCommon.textAlignRightSmallMod
...
object TextAlignRightSmallProps {
  ...
  @scala.inline
  implicit class TextAlignRightSmallPropsOps[Self <: TextAlignRightSmallProps] (val x: Self) extends AnyVal {
