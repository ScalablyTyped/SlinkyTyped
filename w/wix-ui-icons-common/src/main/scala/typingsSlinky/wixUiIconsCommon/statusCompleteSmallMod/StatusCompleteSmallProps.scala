package typingsSlinky.wixUiIconsCommon.statusCompleteSmallMod
...
object StatusCompleteSmallProps {
  ...
  @scala.inline
  implicit class StatusCompleteSmallPropsOps[Self <: StatusCompleteSmallProps] (val x: Self) extends AnyVal {
