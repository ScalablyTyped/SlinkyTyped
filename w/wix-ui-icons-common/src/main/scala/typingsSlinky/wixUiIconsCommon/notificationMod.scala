...
object notificationMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[NotificationProps] = js.native
  ...
  type _To = ReactComponentClass[NotificationProps]
  
  /* This means you don't have to write `default`, but can instead just say `notificationMod.foo` */
  override def _to: ReactComponentClass[NotificationProps] = default
}
