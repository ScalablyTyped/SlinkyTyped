package typingsSlinky.wixUiIconsCommon.statusStopFilledSmallMod
...
object StatusStopFilledSmallProps {
  ...
  @scala.inline
  implicit class StatusStopFilledSmallPropsOps[Self <: StatusStopFilledSmallProps] (val x: Self) extends AnyVal {
