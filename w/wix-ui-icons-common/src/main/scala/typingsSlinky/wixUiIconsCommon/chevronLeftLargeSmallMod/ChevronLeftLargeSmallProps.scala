package typingsSlinky.wixUiIconsCommon.chevronLeftLargeSmallMod
...
object ChevronLeftLargeSmallProps {
  ...
  @scala.inline
  implicit class ChevronLeftLargeSmallPropsOps[Self <: ChevronLeftLargeSmallProps] (val x: Self) extends AnyVal {
