...
object userLeaveMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[UserLeaveProps] = js.native
  ...
  type _To = ReactComponentClass[UserLeaveProps]
  
  /* This means you don't have to write `default`, but can instead just say `userLeaveMod.foo` */
  override def _to: ReactComponentClass[UserLeaveProps] = default
}
