package typingsSlinky.wixUiIconsCommon.horizontalRatioCheckedMod
...
object HorizontalRatioCheckedProps {
  ...
  @scala.inline
  implicit class HorizontalRatioCheckedPropsOps[Self <: HorizontalRatioCheckedProps] (val x: Self) extends AnyVal {
