package typingsSlinky.wixUiIconsCommon.textAlignLeftSmallMod
...
object TextAlignLeftSmallProps {
  ...
  @scala.inline
  implicit class TextAlignLeftSmallPropsOps[Self <: TextAlignLeftSmallProps] (val x: Self) extends AnyVal {
