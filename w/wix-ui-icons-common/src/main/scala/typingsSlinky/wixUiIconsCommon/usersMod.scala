...
object usersMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[UsersProps] = js.native
  
  @js.native
  trait UsersProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[UsersProps]
  
  /* This means you don't have to write `default`, but can instead just say `usersMod.foo` */
  override def _to: ReactComponentClass[UsersProps] = default
}
