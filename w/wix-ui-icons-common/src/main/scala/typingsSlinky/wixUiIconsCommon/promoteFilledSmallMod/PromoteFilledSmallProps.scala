package typingsSlinky.wixUiIconsCommon.promoteFilledSmallMod
...
object PromoteFilledSmallProps {
  ...
  @scala.inline
  implicit class PromoteFilledSmallPropsOps[Self <: PromoteFilledSmallProps] (val x: Self) extends AnyVal {
