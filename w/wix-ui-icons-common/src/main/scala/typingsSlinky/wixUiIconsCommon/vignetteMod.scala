...
object vignetteMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[VignetteProps] = js.native
  ...
  type _To = ReactComponentClass[VignetteProps]
  
  /* This means you don't have to write `default`, but can instead just say `vignetteMod.foo` */
  override def _to: ReactComponentClass[VignetteProps] = default
}
