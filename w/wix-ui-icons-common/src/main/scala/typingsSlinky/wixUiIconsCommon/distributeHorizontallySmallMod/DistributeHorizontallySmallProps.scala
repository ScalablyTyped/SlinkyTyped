package typingsSlinky.wixUiIconsCommon.distributeHorizontallySmallMod
...
object DistributeHorizontallySmallProps {
  ...
  @scala.inline
  implicit class DistributeHorizontallySmallPropsOps[Self <: DistributeHorizontallySmallProps] (val x: Self) extends AnyVal {
