package typingsSlinky.wixUiIconsCommon.sortDescendingSmallMod
...
object SortDescendingSmallProps {
  ...
  @scala.inline
  implicit class SortDescendingSmallPropsOps[Self <: SortDescendingSmallProps] (val x: Self) extends AnyVal {
