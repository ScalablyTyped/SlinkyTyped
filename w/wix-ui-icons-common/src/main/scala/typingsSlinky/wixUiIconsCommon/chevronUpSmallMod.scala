...
object chevronUpSmallMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ChevronUpSmallProps] = js.native
  ...
  object ChevronUpSmallProps {
    ...
    @scala.inline
    def apply(): ChevronUpSmallProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ChevronUpSmallProps]
    }
    
    @scala.inline
    implicit class ChevronUpSmallPropsMutableBuilder[Self <: ChevronUpSmallProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[ChevronUpSmallProps]
  
  /* This means you don't have to write `default`, but can instead just say `chevronUpSmallMod.foo` */
  override def _to: ReactComponentClass[ChevronUpSmallProps] = default
}
