package typingsSlinky.wixUiIconsCommon.layoutListWithPanelSmallMod
...
object LayoutListWithPanelSmallProps {
  ...
  @scala.inline
  implicit class LayoutListWithPanelSmallPropsOps[Self <: LayoutListWithPanelSmallProps] (val x: Self) extends AnyVal {
