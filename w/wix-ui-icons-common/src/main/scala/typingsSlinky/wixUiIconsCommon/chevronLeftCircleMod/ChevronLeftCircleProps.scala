package typingsSlinky.wixUiIconsCommon.chevronLeftCircleMod
...
object ChevronLeftCircleProps {
  ...
  @scala.inline
  implicit class ChevronLeftCirclePropsOps[Self <: ChevronLeftCircleProps] (val x: Self) extends AnyVal {
