...
object highlightsSmallMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[HighlightsSmallProps] = js.native
  
  @js.native
  trait HighlightsSmallProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[HighlightsSmallProps]
  
  /* This means you don't have to write `default`, but can instead just say `highlightsSmallMod.foo` */
  override def _to: ReactComponentClass[HighlightsSmallProps] = default
}
