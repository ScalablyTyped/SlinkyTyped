package typingsSlinky.wixUiIconsCommon.uploadExportSmallMod
...
object UploadExportSmallProps {
  ...
  @scala.inline
  implicit class UploadExportSmallPropsOps[Self <: UploadExportSmallProps] (val x: Self) extends AnyVal {
