...
object emailSendMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[EmailSendProps] = js.native
  
  @js.native
  trait EmailSendProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[EmailSendProps]
  
  /* This means you don't have to write `default`, but can instead just say `emailSendMod.foo` */
  override def _to: ReactComponentClass[EmailSendProps] = default
}
