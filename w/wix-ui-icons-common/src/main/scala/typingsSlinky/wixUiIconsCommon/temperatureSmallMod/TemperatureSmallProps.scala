package typingsSlinky.wixUiIconsCommon.temperatureSmallMod
...
object TemperatureSmallProps {
  ...
  @scala.inline
  implicit class TemperatureSmallPropsOps[Self <: TemperatureSmallProps] (val x: Self) extends AnyVal {
