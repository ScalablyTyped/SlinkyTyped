package typingsSlinky.wixUiIconsCommon.verticalRatioCheckedSmallMod
...
object VerticalRatioCheckedSmallProps {
  ...
  @scala.inline
  implicit class VerticalRatioCheckedSmallPropsOps[Self <: VerticalRatioCheckedSmallProps] (val x: Self) extends AnyVal {
