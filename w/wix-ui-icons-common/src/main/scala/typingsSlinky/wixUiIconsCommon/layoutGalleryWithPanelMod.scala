...
object layoutGalleryWithPanelMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[LayoutGalleryWithPanelProps] = js.native
  ...
  object LayoutGalleryWithPanelProps {
    ...
    @scala.inline
    implicit class LayoutGalleryWithPanelPropsMutableBuilder[Self <: LayoutGalleryWithPanelProps] (val x: Self) extends AnyVal {
  ...
  type _To = ReactComponentClass[LayoutGalleryWithPanelProps]
  
  /* This means you don't have to write `default`, but can instead just say `layoutGalleryWithPanelMod.foo` */
  override def _to: ReactComponentClass[LayoutGalleryWithPanelProps] = default
}
