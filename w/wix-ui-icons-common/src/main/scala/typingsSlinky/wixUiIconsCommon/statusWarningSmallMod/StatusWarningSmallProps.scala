package typingsSlinky.wixUiIconsCommon.statusWarningSmallMod
...
object StatusWarningSmallProps {
  ...
  @scala.inline
  implicit class StatusWarningSmallPropsOps[Self <: StatusWarningSmallProps] (val x: Self) extends AnyVal {
