package typingsSlinky.wixUiIconsCommon.thumbsUpFilledSmallMod
...
object ThumbsUpFilledSmallProps {
  ...
  @scala.inline
  implicit class ThumbsUpFilledSmallPropsOps[Self <: ThumbsUpFilledSmallProps] (val x: Self) extends AnyVal {
