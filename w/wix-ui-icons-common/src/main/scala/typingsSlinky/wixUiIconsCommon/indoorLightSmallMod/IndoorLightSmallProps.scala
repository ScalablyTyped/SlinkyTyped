package typingsSlinky.wixUiIconsCommon.indoorLightSmallMod
...
object IndoorLightSmallProps {
  ...
  @scala.inline
  implicit class IndoorLightSmallPropsOps[Self <: IndoorLightSmallProps] (val x: Self) extends AnyVal {
