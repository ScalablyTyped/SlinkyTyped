...
object textAreaNumberedListMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[TextAreaNumberedListProps] = js.native
  ...
  type _To = ReactComponentClass[TextAreaNumberedListProps]
  
  /* This means you don't have to write `default`, but can instead just say `textAreaNumberedListMod.foo` */
  override def _to: ReactComponentClass[TextAreaNumberedListProps] = default
}
