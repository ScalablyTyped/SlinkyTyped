...
object ChatDisabed {
  ...
  def withProps(p: ChatDisabedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChatDisabed.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
