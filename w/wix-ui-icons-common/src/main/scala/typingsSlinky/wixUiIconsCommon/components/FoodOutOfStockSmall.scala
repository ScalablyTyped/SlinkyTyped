...
object FoodOutOfStockSmall {
  ...
  implicit def make(companion: FoodOutOfStockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FoodOutOfStockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
