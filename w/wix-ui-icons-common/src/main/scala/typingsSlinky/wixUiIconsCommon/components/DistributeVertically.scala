...
object DistributeVertically {
  ...
  def withProps(p: DistributeVerticallyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DistributeVertically.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
