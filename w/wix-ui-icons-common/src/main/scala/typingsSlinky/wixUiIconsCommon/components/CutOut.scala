...
object CutOut {
  ...
  @JSImport("wix-ui-icons-common/CutOut", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CutOut.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CutOutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
