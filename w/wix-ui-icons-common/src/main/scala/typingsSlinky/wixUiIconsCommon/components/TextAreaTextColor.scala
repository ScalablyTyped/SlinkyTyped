...
import typingsSlinky.wixUiIconsCommon.textAreaTextColorMod.TextAreaTextColorProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaTextColor {
  ...
  implicit def make(companion: TextAreaTextColor.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaTextColorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
