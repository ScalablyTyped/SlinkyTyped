...
object LinkSmall {
  ...
  def withProps(p: LinkSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LinkSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
