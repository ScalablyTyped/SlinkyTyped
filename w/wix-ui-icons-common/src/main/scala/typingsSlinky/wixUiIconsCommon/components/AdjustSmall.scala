...
object AdjustSmall {
  ...
  implicit def make(companion: AdjustSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdjustSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
