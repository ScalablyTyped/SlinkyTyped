...
object Public {
  ...
  implicit def make(companion: Public.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PublicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
