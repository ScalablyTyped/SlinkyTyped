...
object Music {
  ...
  def withProps(p: MusicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Music.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
