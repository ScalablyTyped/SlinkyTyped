...
object LockLockedSmall {
  ...
  implicit def make(companion: LockLockedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockLockedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
