...
object Play {
  ...
  implicit def make(companion: Play.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
