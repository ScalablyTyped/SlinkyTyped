...
import typingsSlinky.wixUiIconsCommon.dragAndDropLockedLargeMod.DragAndDropLockedLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DragAndDropLockedLarge {
  ...
  implicit def make(companion: DragAndDropLockedLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DragAndDropLockedLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
