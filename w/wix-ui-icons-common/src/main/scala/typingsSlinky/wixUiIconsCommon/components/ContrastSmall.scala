...
object ContrastSmall {
  ...
  def withProps(p: ContrastSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ContrastSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
