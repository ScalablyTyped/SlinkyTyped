...
object CropRotateSmall {
  ...
  implicit def make(companion: CropRotateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CropRotateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
