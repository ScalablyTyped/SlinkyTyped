...
object SiteMoveSmall {
  ...
  implicit def make(companion: SiteMoveSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteMoveSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
