...
object UserLeave {
  ...
  implicit def make(companion: UserLeave.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserLeaveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
