...
object ExcludeSmall {
  ...
  def withProps(p: ExcludeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ExcludeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
