...
object SiteSearch {
  ...
  def withProps(p: SiteSearchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SiteSearch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
