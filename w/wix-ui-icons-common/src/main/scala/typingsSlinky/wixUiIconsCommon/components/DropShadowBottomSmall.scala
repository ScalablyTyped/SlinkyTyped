...
object DropShadowBottomSmall {
  ...
  implicit def make(companion: DropShadowBottomSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropShadowBottomSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
