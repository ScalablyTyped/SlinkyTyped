...
object LineChartSmall {
  ...
  implicit def make(companion: LineChartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LineChartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
