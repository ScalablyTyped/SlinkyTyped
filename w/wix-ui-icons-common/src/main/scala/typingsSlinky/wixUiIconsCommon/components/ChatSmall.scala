...
object ChatSmall {
  ...
  implicit def make(companion: ChatSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChatSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
