...
object FlagFilled {
  ...
  def withProps(p: FlagFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: FlagFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
