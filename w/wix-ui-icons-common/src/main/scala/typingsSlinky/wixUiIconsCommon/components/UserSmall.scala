...
object UserSmall {
  ...
  implicit def make(companion: UserSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
