...
object SortAZSmall {
  ...
  def withProps(p: SortAZSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SortAZSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
