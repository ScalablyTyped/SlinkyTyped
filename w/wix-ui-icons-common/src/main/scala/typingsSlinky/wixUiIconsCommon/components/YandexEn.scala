...
object YandexEn {
  ...
  @JSImport("wix-ui-icons-common/YandexEn", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: YandexEn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: YandexEnProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
