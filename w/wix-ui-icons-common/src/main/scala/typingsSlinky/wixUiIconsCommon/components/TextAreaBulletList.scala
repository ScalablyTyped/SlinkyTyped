...
import typingsSlinky.wixUiIconsCommon.textAreaBulletListMod.TextAreaBulletListProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaBulletList {
  ...
  implicit def make(companion: TextAreaBulletList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaBulletListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
