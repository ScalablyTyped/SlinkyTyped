...
object TextAreaBold {
  ...
  implicit def make(companion: TextAreaBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
