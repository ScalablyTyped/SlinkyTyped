...
object StatusCompletetFilled {
  ...
  def withProps(p: StatusCompletetFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: StatusCompletetFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
