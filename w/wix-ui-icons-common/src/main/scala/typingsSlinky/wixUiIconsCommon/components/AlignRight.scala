...
object AlignRight {
  ...
  implicit def make(companion: AlignRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
