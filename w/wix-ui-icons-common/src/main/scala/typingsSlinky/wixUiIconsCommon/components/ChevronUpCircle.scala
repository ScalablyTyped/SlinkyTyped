...
object ChevronUpCircle {
  ...
  implicit def make(companion: ChevronUpCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
