...
object Users {
  ...
  def withProps(p: UsersProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Users.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
