...
import typingsSlinky.wixUiIconsCommon.textAreaLinkMod.TextAreaLinkProps
...
object TextAreaLink {
  ...
  implicit def make(companion: TextAreaLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
