...
object TShirt {
  ...
  @JSImport("wix-ui-icons-common/TShirt", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TShirt.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TShirtProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
