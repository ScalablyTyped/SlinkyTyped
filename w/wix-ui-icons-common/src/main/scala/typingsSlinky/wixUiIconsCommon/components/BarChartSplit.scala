...
object BarChartSplit {
  ...
  def withProps(p: BarChartSplitProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: BarChartSplit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
