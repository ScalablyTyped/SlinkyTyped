...
object DocumentExpire {
  ...
  implicit def make(companion: DocumentExpire.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocumentExpireProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
