...
object MapSmall {
  ...
  def withProps(p: MapSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: MapSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
