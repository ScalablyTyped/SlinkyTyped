...
object UnlinkSmall {
  ...
  implicit def make(companion: UnlinkSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlinkSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
