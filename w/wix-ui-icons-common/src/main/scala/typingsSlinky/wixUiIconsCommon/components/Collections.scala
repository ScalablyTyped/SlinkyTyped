...
object Collections {
  ...
  implicit def make(companion: Collections.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CollectionsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
