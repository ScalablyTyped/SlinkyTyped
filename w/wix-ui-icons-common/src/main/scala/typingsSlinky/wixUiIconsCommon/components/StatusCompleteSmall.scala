...
object StatusCompleteSmall {
  ...
  implicit def make(companion: StatusCompleteSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusCompleteSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
