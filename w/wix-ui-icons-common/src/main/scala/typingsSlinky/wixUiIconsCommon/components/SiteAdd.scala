...
object SiteAdd {
  ...
  @JSImport("wix-ui-icons-common/SiteAdd", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: SiteAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
