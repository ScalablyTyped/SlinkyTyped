...
import typingsSlinky.wixUiIconsCommon.circleLoaderCheckSmallMod.CircleLoaderCheckSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CircleLoaderCheckSmall {
  ...
  implicit def make(companion: CircleLoaderCheckSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CircleLoaderCheckSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
