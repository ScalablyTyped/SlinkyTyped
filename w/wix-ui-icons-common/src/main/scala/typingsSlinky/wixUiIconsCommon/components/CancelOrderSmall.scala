...
object CancelOrderSmall {
  ...
  implicit def make(companion: CancelOrderSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CancelOrderSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
