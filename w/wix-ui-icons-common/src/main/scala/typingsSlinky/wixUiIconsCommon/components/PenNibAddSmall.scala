...
object PenNibAddSmall {
  ...
  implicit def make(companion: PenNibAddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PenNibAddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
