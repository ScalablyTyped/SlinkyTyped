...
object RefreshSmall {
  ...
  implicit def make(companion: RefreshSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RefreshSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
