...
object RefundSmall {
  ...
  implicit def make(companion: RefundSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RefundSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
