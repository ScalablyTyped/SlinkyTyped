...
import typingsSlinky.wixUiIconsCommon.addItemMediumMod.AddItemMediumProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AddItemMedium {
  ...
  implicit def make(companion: AddItemMedium.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddItemMediumProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
