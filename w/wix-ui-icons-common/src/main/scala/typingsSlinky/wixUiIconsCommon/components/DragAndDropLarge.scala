...
import typingsSlinky.wixUiIconsCommon.dragAndDropLargeMod.DragAndDropLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DragAndDropLarge {
  ...
  implicit def make(companion: DragAndDropLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DragAndDropLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
