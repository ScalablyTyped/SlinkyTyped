...
object StatusAlertFilled {
  ...
  implicit def make(companion: StatusAlertFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusAlertFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
