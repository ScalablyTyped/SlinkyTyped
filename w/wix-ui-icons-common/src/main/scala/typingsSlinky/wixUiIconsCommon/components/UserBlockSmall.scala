...
object UserBlockSmall {
  ...
  def withProps(p: UserBlockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: UserBlockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
