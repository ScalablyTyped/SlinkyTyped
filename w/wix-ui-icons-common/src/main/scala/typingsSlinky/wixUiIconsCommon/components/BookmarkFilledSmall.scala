...
object BookmarkFilledSmall {
  ...
  implicit def make(companion: BookmarkFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookmarkFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
