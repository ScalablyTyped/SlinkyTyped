...
object ChevronDown {
  ...
  def withProps(p: ChevronDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
