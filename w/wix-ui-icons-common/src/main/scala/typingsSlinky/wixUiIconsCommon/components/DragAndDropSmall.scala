...
import typingsSlinky.wixUiIconsCommon.dragAndDropSmallMod.DragAndDropSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DragAndDropSmall {
  ...
  implicit def make(companion: DragAndDropSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DragAndDropSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
