...
object ChevronRightLarge {
  ...
  implicit def make(companion: ChevronRightLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
