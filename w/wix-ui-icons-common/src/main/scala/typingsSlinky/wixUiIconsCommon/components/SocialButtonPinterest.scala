...
object SocialButtonPinterest {
  ...
  implicit def make(companion: SocialButtonPinterest.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonPinterestProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
