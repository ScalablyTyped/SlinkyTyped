...
object AlignTop {
  ...
  @JSImport("wix-ui-icons-common/AlignTop", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: AlignTop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignTopProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
