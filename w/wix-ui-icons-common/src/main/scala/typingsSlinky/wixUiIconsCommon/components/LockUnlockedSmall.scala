...
object LockUnlockedSmall {
  ...
  def withProps(p: LockUnlockedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LockUnlockedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
