...
object ObjectsSmall {
  ...
  def withProps(p: ObjectsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ObjectsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
