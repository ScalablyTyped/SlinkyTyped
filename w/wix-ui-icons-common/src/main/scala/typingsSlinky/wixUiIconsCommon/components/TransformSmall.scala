...
object TransformSmall {
  ...
  implicit def make(companion: TransformSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransformSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
