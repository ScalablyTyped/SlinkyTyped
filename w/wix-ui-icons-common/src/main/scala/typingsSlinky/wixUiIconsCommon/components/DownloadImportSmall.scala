...
object DownloadImportSmall {
  ...
  def withProps(p: DownloadImportSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DownloadImportSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
