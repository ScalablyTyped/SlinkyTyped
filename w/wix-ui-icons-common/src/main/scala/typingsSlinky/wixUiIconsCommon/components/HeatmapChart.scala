...
object HeatmapChart {
  ...
  def withProps(p: HeatmapChartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HeatmapChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
