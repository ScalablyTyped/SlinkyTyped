...
object Forward {
  ...
  @JSImport("wix-ui-icons-common/Forward", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Forward.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ForwardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
