...
object ChevronRightCircleSmall {
  ...
  implicit def make(companion: ChevronRightCircleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightCircleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
