...
object HeartFilled {
  ...
  def withProps(p: HeartFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HeartFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
