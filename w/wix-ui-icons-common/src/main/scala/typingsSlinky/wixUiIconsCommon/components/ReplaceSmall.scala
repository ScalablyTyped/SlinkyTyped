...
object ReplaceSmall {
  ...
  implicit def make(companion: ReplaceSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReplaceSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
