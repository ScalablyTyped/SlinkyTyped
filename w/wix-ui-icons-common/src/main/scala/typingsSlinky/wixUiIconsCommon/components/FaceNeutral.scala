...
object FaceNeutral {
  ...
  def withProps(p: FaceNeutralProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: FaceNeutral.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
