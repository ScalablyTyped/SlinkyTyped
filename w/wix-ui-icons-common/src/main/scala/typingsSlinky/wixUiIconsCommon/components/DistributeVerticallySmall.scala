...
object DistributeVerticallySmall {
  ...
  def withProps(p: DistributeVerticallySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DistributeVerticallySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
