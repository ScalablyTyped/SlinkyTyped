...
object ChevronDownLarge {
  ...
  implicit def make(companion: ChevronDownLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronDownLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
