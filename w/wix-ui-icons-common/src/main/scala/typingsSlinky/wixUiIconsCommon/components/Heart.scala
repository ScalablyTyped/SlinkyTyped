...
object Heart {
  ...
  def withProps(p: HeartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Heart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
