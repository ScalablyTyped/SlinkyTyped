...
object Twitter {
  ...
  @JSImport("wix-ui-icons-common/Twitter", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Twitter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TwitterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
