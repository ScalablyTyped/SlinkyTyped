...
import typingsSlinky.wixUiIconsCommon.textAreaAlignLeftMod.TextAreaAlignLeftProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaAlignLeft {
  ...
  implicit def make(companion: TextAreaAlignLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaAlignLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
