...
object Smile {
  ...
  @JSImport("wix-ui-icons-common/Smile", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Smile.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
