...
object RectangleLarge {
  ...
  implicit def make(companion: RectangleLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RectangleLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
