...
object ChevronLeftLarge {
  ...
  implicit def make(companion: ChevronLeftLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
