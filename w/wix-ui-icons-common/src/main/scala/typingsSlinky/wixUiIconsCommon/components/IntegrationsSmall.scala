...
object IntegrationsSmall {
  ...
  def withProps(p: IntegrationsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: IntegrationsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
