...
object Transfer {
  ...
  @JSImport("wix-ui-icons-common/Transfer", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Transfer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
