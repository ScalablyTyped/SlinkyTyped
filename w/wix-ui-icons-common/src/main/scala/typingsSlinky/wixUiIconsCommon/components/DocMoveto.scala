...
object DocMoveto {
  ...
  implicit def make(companion: DocMoveto.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocMovetoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
