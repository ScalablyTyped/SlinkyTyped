...
object RotateRightSmall {
  ...
  implicit def make(companion: RotateRightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RotateRightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
