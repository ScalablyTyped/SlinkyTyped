...
object Location {
  ...
  def withProps(p: LocationProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Location.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
