...
object BingSmall {
  ...
  def withProps(p: BingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: BingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
