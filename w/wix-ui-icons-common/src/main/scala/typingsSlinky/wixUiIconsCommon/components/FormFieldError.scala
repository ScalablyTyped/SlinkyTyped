...
import typingsSlinky.wixUiIconsCommon.formFieldErrorMod.FormFieldErrorProps
...
object FormFieldError {
  ...
  implicit def make(companion: FormFieldError.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldErrorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
