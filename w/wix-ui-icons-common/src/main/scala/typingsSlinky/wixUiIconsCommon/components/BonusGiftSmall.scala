...
object BonusGiftSmall {
  ...
  implicit def make(companion: BonusGiftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BonusGiftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
