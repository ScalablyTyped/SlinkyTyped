...
object WixChatSmall {
  ...
  implicit def make(companion: WixChatSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixChatSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
