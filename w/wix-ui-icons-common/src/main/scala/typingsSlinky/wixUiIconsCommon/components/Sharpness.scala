...
object Sharpness {
  ...
  def withProps(p: SharpnessProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Sharpness.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
