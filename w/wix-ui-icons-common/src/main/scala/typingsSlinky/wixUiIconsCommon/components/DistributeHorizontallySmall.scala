...
object DistributeHorizontallySmall {
  ...
  implicit def make(companion: DistributeHorizontallySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeHorizontallySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
