...
object LinkedIn {
  ...
  @JSImport("wix-ui-icons-common/LinkedIn", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: LinkedIn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LinkedInProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
