...
object Exposure {
  ...
  def withProps(p: ExposureProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Exposure.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
