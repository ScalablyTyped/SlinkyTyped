...
object IntersectSmall {
  ...
  def withProps(p: IntersectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: IntersectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
