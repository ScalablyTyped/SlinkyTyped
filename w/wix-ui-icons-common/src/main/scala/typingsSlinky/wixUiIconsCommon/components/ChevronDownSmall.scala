...
object ChevronDownSmall {
  ...
  def withProps(p: ChevronDownSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronDownSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
