...
object ConfirmSmall {
  ...
  def withProps(p: ConfirmSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ConfirmSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
