...
object ChevronRight {
  ...
  implicit def make(companion: ChevronRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
