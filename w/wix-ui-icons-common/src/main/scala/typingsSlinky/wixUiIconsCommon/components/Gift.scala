...
object Gift {
  ...
  @JSImport("wix-ui-icons-common/Gift", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Gift.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GiftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
