...
object ThumbsUpSmall {
  ...
  def withProps(p: ThumbsUpSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ThumbsUpSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
