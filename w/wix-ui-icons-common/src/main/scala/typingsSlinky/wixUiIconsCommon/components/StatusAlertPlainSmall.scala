...
object StatusAlertPlainSmall {
  ...
  implicit def make(companion: StatusAlertPlainSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusAlertPlainSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
