...
object VisibleSmall {
  ...
  def withProps(p: VisibleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: VisibleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
