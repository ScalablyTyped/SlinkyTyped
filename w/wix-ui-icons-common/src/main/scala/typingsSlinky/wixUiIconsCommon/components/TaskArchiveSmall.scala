...
object TaskArchiveSmall {
  ...
  implicit def make(companion: TaskArchiveSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaskArchiveSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
