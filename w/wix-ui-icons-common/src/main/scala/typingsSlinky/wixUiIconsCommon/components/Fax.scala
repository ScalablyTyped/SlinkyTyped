...
object Fax {
  ...
  @JSImport("wix-ui-icons-common/Fax", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Fax.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
