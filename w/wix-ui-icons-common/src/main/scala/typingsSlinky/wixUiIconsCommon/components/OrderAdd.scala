...
object OrderAdd {
  ...
  @JSImport("wix-ui-icons-common/OrderAdd", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: OrderAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OrderAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
