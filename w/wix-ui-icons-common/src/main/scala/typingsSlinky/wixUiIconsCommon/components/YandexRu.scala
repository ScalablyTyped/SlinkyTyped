...
object YandexRu {
  ...
  implicit def make(companion: YandexRu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: YandexRuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
