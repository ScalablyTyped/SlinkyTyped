...
import typingsSlinky.wixUiIconsCommon.checkboxCheckedMod.CheckboxCheckedProps
...
object CheckboxChecked {
  ...
  implicit def make(companion: CheckboxChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
