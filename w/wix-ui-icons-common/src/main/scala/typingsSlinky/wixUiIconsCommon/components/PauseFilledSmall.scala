...
object PauseFilledSmall {
  ...
  def withProps(p: PauseFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: PauseFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
