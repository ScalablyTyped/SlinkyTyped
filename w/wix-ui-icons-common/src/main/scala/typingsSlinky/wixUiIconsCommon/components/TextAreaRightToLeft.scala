...
import typingsSlinky.wixUiIconsCommon.textAreaRightToLeftMod.TextAreaRightToLeftProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaRightToLeft {
  ...
  implicit def make(companion: TextAreaRightToLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaRightToLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
