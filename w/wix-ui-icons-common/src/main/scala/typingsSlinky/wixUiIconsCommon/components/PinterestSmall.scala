...
object PinterestSmall {
  ...
  implicit def make(companion: PinterestSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinterestSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
