...
import typingsSlinky.wixUiIconsCommon.formFieldErrorSmallMod.FormFieldErrorSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FormFieldErrorSmall {
  ...
  implicit def make(companion: FormFieldErrorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldErrorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
