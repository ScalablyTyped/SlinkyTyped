...
object PlayFilledSmall {
  ...
  implicit def make(companion: PlayFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
