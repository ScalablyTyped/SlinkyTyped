...
object TextAlignLeftSmall {
  ...
  implicit def make(companion: TextAlignLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAlignLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
