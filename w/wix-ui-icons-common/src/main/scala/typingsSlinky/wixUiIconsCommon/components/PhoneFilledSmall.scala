...
object PhoneFilledSmall {
  ...
  def withProps(p: PhoneFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: PhoneFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
