...
object Article {
  ...
  def withProps(p: ArticleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Article.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
