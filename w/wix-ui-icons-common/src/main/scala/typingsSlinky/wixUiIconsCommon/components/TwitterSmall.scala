...
object TwitterSmall {
  ...
  def withProps(p: TwitterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: TwitterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
