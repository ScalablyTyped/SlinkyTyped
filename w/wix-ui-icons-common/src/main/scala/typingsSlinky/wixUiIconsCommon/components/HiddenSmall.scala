...
object HiddenSmall {
  ...
  def withProps(p: HiddenSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HiddenSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
