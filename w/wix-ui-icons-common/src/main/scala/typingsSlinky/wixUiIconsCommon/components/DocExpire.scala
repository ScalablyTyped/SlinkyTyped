...
object DocExpire {
  ...
  def withProps(p: DocExpireProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DocExpire.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
