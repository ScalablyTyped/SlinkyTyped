...
object Languages {
  ...
  implicit def make(companion: Languages.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LanguagesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
