...
object CancelOrder {
  ...
  def withProps(p: CancelOrderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CancelOrder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
