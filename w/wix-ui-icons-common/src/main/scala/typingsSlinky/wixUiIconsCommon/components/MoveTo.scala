...
object MoveTo {
  ...
  def withProps(p: MoveToProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: MoveTo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
