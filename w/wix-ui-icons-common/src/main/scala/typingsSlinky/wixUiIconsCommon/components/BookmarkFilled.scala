...
object BookmarkFilled {
  ...
  def withProps(p: BookmarkFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: BookmarkFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
