...
object EmailAlertSmall {
  ...
  implicit def make(companion: EmailAlertSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailAlertSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
