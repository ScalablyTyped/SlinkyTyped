...
object VolumeSmall {
  ...
  implicit def make(companion: VolumeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VolumeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
