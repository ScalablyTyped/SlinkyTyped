...
object NotificationSmall {
  ...
  implicit def make(companion: NotificationSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
