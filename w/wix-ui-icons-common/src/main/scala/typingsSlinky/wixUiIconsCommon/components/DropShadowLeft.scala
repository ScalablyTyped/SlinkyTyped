...
object DropShadowLeft {
  ...
  def withProps(p: DropShadowLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DropShadowLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
