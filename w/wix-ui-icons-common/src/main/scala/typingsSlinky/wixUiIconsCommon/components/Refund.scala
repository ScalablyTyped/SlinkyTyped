...
object Refund {
  ...
  @JSImport("wix-ui-icons-common/Refund", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Refund.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RefundProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
