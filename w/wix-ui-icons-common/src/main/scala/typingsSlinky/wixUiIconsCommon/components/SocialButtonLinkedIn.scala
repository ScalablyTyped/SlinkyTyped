...
import typingsSlinky.wixUiIconsCommon.socialButtonLinkedInMod.SocialButtonLinkedInProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SocialButtonLinkedIn {
  ...
  implicit def make(companion: SocialButtonLinkedIn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonLinkedInProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
