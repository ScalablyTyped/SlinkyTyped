...
object Attachment {
  ...
  def withProps(p: AttachmentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Attachment.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
