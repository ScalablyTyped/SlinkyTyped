...
object ChevronRightSmall {
  ...
  def withProps(p: ChevronRightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronRightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
