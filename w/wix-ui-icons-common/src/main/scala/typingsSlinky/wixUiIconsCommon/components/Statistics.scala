...
object Statistics {
  ...
  implicit def make(companion: Statistics.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatisticsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
