...
object SentenceCase {
  ...
  implicit def make(companion: SentenceCase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SentenceCaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
