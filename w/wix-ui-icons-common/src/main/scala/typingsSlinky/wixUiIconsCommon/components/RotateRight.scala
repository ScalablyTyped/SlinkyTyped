...
object RotateRight {
  ...
  def withProps(p: RotateRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: RotateRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
