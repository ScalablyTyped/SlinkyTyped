...
import typingsSlinky.wixUiIconsCommon.closeLargeMod.CloseLargeProps
...
object CloseLarge {
  ...
  implicit def make(companion: CloseLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloseLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
