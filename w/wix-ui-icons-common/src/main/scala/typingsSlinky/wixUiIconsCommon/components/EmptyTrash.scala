...
object EmptyTrash {
  ...
  implicit def make(companion: EmptyTrash.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmptyTrashProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
