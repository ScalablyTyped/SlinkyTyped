...
object Shadows {
  ...
  implicit def make(companion: Shadows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShadowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
