...
import typingsSlinky.wixUiIconsCommon.starLargeMod.StarLargeProps
...
object StarLarge {
  ...
  implicit def make(companion: StarLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StarLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
