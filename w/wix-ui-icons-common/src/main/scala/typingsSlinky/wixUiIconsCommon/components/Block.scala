...
object Block {
  ...
  @JSImport("wix-ui-icons-common/Block", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Block.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
