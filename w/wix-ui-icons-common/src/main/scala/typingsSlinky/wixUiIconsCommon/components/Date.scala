...
object Date {
  ...
  @JSImport("wix-ui-icons-common/Date", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Date.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
