...
import typingsSlinky.wixUiIconsCommon.textAreaAlignJustifyMod.TextAreaAlignJustifyProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaAlignJustify {
  ...
  implicit def make(companion: TextAreaAlignJustify.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaAlignJustifyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
