...
object ChevronUp {
  ...
  def withProps(p: ChevronUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
