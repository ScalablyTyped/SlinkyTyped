...
import typingsSlinky.wixUiIconsCommon.textAreaLeftToRightMod.TextAreaLeftToRightProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaLeftToRight {
  ...
  implicit def make(companion: TextAreaLeftToRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaLeftToRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
