...
object StatusStopSmall {
  ...
  implicit def make(companion: StatusStopSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusStopSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
