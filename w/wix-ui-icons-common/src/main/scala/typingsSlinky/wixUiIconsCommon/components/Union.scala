...
object Union {
  ...
  @JSImport("wix-ui-icons-common/Union", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Union.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
