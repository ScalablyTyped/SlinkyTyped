...
object AddMedia {
  ...
  implicit def make(companion: AddMedia.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddMediaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
