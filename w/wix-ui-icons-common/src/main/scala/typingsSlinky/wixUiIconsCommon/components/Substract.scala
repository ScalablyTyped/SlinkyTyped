...
object Substract {
  ...
  implicit def make(companion: Substract.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SubstractProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
