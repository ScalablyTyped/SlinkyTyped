...
object DropShadowRight {
  ...
  def withProps(p: DropShadowRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DropShadowRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
