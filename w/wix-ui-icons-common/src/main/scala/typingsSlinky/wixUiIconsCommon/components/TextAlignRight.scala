...
object TextAlignRight {
  ...
  implicit def make(companion: TextAlignRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAlignRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
