...
object PremiumSmall {
  ...
  implicit def make(companion: PremiumSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PremiumSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
