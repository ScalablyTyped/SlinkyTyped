...
object ChatReply {
  ...
  def withProps(p: ChatReplyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChatReply.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
