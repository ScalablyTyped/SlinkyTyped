...
object LineChartSplitSmall {
  ...
  def withProps(p: LineChartSplitSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LineChartSplitSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
