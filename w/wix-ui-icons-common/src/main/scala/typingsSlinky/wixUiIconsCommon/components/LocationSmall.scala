...
object LocationSmall {
  ...
  implicit def make(companion: LocationSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LocationSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
