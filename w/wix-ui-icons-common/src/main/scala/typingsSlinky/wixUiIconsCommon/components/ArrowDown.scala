...
object ArrowDown {
  ...
  implicit def make(companion: ArrowDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
