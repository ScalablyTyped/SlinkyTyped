...
import typingsSlinky.wixUiIconsCommon.textAreaAlignCenterMod.TextAreaAlignCenterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaAlignCenter {
  ...
  implicit def make(companion: TextAreaAlignCenter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaAlignCenterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
