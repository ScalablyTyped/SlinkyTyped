...
object StatusStop {
  ...
  def withProps(p: StatusStopProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: StatusStop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
