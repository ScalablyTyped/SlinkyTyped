...
object GoogleSmall {
  ...
  implicit def make(companion: GoogleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GoogleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
