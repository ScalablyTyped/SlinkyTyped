...
object DismissSmall {
  ...
  def withProps(p: DismissSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DismissSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
