...
object CodeSmall {
  ...
  implicit def make(companion: CodeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
