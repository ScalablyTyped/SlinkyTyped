...
object Whatsapp {
  ...
  implicit def make(companion: Whatsapp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WhatsappProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
