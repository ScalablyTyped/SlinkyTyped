...
object ArrowLeftSmall {
  ...
  implicit def make(companion: ArrowLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
