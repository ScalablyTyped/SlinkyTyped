...
object DateCheckedSmall {
  ...
  def withProps(p: DateCheckedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DateCheckedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
