...
object SquareRatioCheckedSmall {
  ...
  implicit def make(companion: SquareRatioCheckedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareRatioCheckedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
