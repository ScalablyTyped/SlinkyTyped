...
object StatisticsSmall {
  ...
  implicit def make(companion: StatisticsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatisticsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
