...
object TemperatureSmall {
  ...
  implicit def make(companion: TemperatureSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TemperatureSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
