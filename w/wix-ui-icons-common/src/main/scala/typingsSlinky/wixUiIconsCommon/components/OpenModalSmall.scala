...
object OpenModalSmall {
  ...
  implicit def make(companion: OpenModalSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OpenModalSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
