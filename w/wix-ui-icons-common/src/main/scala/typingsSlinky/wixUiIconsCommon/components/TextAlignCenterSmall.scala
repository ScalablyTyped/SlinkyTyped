...
object TextAlignCenterSmall {
  ...
  implicit def make(companion: TextAlignCenterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAlignCenterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
