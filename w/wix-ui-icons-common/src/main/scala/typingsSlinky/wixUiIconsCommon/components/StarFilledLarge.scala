...
import typingsSlinky.wixUiIconsCommon.starFilledLargeMod.StarFilledLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object StarFilledLarge {
  ...
  implicit def make(companion: StarFilledLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StarFilledLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
