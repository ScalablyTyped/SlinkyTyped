...
object Minus {
  ...
  def withProps(p: MinusProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: Minus.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
