...
object FoodInStock {
  ...
  def withProps(p: FoodInStockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: FoodInStock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
