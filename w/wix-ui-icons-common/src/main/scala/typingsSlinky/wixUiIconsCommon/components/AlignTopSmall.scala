...
object AlignTopSmall {
  ...
  implicit def make(companion: AlignTopSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignTopSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
