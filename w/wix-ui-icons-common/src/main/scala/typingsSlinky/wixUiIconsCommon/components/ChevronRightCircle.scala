...
object ChevronRightCircle {
  ...
  def withProps(p: ChevronRightCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronRightCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
