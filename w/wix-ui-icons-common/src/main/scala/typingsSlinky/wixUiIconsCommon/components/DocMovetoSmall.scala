...
object DocMovetoSmall {
  ...
  def withProps(p: DocMovetoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DocMovetoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
