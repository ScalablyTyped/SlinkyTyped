...
object LayoutListWithPanelSmall {
  ...
  def withProps(p: LayoutListWithPanelSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LayoutListWithPanelSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
