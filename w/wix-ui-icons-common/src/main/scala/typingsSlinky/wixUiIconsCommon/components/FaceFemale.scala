...
object FaceFemale {
  ...
  implicit def make(companion: FaceFemale.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceFemaleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
