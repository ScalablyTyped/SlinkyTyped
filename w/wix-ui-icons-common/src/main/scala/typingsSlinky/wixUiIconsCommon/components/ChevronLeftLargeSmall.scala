...
object ChevronLeftLargeSmall {
  ...
  implicit def make(companion: ChevronLeftLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
