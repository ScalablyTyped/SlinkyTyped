...
object HorizontalRatioSmall {
  ...
  implicit def make(companion: HorizontalRatioSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalRatioSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
