...
object Edit {
  ...
  @JSImport("wix-ui-icons-common/Edit", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Edit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
