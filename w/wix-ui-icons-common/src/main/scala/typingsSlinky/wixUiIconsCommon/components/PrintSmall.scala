...
object PrintSmall {
  ...
  implicit def make(companion: PrintSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PrintSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
