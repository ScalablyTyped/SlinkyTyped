...
object UserJoin {
  ...
  def withProps(p: UserJoinProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: UserJoin.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
