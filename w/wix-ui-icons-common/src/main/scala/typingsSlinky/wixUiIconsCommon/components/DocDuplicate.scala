...
object DocDuplicate {
  ...
  def withProps(p: DocDuplicateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DocDuplicate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
