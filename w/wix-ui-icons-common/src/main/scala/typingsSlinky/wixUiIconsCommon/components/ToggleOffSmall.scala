...
import typingsSlinky.wixUiIconsCommon.toggleOffSmallMod.ToggleOffSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ToggleOffSmall {
  ...
  implicit def make(companion: ToggleOffSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToggleOffSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
