...
import typingsSlinky.wixUiIconsCommon.faceNeutral30Mod.FaceNeutral30Props
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FaceNeutral30 {
  ...
  implicit def make(companion: FaceNeutral30.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceNeutral30Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
