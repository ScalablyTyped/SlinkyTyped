...
object AlignCenterVerticallySmall {
  ...
  implicit def make(companion: AlignCenterVerticallySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterVerticallySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
