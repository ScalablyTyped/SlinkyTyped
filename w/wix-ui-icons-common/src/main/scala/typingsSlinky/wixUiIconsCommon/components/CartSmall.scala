...
object CartSmall {
  ...
  def withProps(p: CartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
