...
object StatusStopFilled {
  ...
  implicit def make(companion: StatusStopFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusStopFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
