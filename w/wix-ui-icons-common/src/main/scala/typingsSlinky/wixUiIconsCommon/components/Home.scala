...
object Home {
  ...
  implicit def make(companion: Home.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HomeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
