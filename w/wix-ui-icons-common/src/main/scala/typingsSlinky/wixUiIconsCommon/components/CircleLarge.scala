...
object CircleLarge {
  ...
  def withProps(p: CircleLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CircleLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
