...
object Attachement {
  ...
  implicit def make(companion: Attachement.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AttachementProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
