...
object SoundOffSmall {
  ...
  implicit def make(companion: SoundOffSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundOffSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
