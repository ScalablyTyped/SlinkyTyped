...
object SettingsSmall {
  ...
  def withProps(p: SettingsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SettingsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
