...
object DistributeHorizontally {
  ...
  implicit def make(companion: DistributeHorizontally.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeHorizontallyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
