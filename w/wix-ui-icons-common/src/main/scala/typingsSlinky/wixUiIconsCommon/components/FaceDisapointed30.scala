...
import typingsSlinky.wixUiIconsCommon.faceDisapointed30Mod.FaceDisapointed30Props
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FaceDisapointed30 {
  ...
  implicit def make(companion: FaceDisapointed30.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceDisapointed30Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
