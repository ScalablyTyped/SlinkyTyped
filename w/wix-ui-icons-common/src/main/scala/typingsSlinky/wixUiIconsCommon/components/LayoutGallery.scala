...
object LayoutGallery {
  ...
  implicit def make(companion: LayoutGallery.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutGalleryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
