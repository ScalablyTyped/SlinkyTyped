...
object RevertSmall {
  ...
  def withProps(p: RevertSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: RevertSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
