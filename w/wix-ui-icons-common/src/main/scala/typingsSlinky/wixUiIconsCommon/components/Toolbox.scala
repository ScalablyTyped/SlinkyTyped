...
object Toolbox {
  ...
  implicit def make(companion: Toolbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToolboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
