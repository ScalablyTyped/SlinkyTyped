...
object ShadowsSmall {
  ...
  implicit def make(companion: ShadowsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShadowsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
