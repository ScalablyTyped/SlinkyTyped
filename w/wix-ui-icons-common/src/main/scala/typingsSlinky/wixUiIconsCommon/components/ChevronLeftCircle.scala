...
object ChevronLeftCircle {
  ...
  def withProps(p: ChevronLeftCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronLeftCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
