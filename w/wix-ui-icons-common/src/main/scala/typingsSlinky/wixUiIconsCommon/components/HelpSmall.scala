...
object HelpSmall {
  ...
  def withProps(p: HelpSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HelpSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
