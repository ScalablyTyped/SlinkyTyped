...
import typingsSlinky.wixUiIconsCommon.socialButtonInstagramMod.SocialButtonInstagramProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SocialButtonInstagram {
  ...
  implicit def make(companion: SocialButtonInstagram.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonInstagramProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
