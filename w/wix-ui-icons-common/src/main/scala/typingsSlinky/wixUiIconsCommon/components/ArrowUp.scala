...
object ArrowUp {
  ...
  def withProps(p: ArrowUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ArrowUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
