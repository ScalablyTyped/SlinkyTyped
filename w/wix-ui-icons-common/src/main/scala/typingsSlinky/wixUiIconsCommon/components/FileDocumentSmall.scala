...
object FileDocumentSmall {
  ...
  implicit def make(companion: FileDocumentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileDocumentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
