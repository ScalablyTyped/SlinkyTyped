...
object VideoCamera {
  ...
  def withProps(p: VideoCameraProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: VideoCamera.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
