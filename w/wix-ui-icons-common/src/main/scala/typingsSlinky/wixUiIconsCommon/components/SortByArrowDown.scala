...
import typingsSlinky.wixUiIconsCommon.sortByArrowDownMod.SortByArrowDownProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SortByArrowDown {
  ...
  implicit def make(companion: SortByArrowDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortByArrowDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
