...
object AddChannel {
  ...
  implicit def make(companion: AddChannel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddChannelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
