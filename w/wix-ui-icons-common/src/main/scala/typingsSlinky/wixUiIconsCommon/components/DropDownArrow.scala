...
import typingsSlinky.wixUiIconsCommon.dropDownArrowMod.DropDownArrowProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DropDownArrow {
  ...
  implicit def make(companion: DropDownArrow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropDownArrowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
