...
object SiteSmall {
  ...
  implicit def make(companion: SiteSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
