...
import typingsSlinky.wixUiIconsCommon.formFieldSpinnerUpMod.FormFieldSpinnerUpProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FormFieldSpinnerUp {
  ...
  implicit def make(companion: FormFieldSpinnerUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldSpinnerUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
