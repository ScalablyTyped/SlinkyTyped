...
object Compose {
  ...
  implicit def make(companion: Compose.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ComposeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
