...
import typingsSlinky.wixUiIconsCommon.faceGrining30Mod.FaceGrining30Props
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FaceGrining30 {
  ...
  implicit def make(companion: FaceGrining30.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceGrining30Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
