...
object WixMarketplaceSmall {
  ...
  def withProps(p: WixMarketplaceSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: WixMarketplaceSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
