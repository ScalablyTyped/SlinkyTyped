...
object IndoorLightSmall {
  ...
  implicit def make(companion: IndoorLightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IndoorLightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
