...
object Integrations {
  ...
  implicit def make(companion: Integrations.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IntegrationsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
