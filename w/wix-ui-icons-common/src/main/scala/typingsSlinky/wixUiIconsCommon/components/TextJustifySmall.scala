...
object TextJustifySmall {
  ...
  implicit def make(companion: TextJustifySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextJustifySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
