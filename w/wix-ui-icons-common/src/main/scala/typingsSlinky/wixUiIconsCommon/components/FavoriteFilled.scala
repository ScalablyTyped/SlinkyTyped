...
object FavoriteFilled {
  ...
  implicit def make(companion: FavoriteFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FavoriteFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
