...
import typingsSlinky.wixUiIconsCommon.formFieldErrorFilledMod.FormFieldErrorFilledProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FormFieldErrorFilled {
  ...
  implicit def make(companion: FormFieldErrorFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldErrorFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
