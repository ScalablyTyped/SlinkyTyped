...
object SortDescending {
  ...
  def withProps(p: SortDescendingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SortDescending.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
