...
object NewFolder {
  ...
  def withProps(p: NewFolderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: NewFolder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
