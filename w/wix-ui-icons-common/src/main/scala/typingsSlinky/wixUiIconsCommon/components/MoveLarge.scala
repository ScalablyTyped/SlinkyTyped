...
object MoveLarge {
  ...
  implicit def make(companion: MoveLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
