...
object TextAlignLeft {
  ...
  def withProps(p: TextAlignLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: TextAlignLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
