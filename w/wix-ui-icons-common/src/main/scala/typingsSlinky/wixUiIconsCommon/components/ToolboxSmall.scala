...
object ToolboxSmall {
  ...
  implicit def make(companion: ToolboxSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToolboxSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
