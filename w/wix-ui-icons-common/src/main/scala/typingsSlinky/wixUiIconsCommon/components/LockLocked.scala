...
object LockLocked {
  ...
  implicit def make(companion: LockLocked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockLockedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
