...
object Coupon {
  ...
  implicit def make(companion: Coupon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CouponProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
