...
object FoodInStockSmall {
  ...
  implicit def make(companion: FoodInStockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FoodInStockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
