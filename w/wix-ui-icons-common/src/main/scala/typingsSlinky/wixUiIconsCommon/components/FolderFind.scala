...
object FolderFind {
  ...
  def withProps(p: FolderFindProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: FolderFind.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
