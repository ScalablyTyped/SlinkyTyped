...
object PinSmall {
  ...
  @JSImport("wix-ui-icons-common/PinSmall", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: PinSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
