...
object SizeAndRatioSmall {
  ...
  def withProps(p: SizeAndRatioSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SizeAndRatioSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
