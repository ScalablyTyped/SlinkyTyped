...
object UserBlock {
  ...
  def withProps(p: UserBlockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: UserBlock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
