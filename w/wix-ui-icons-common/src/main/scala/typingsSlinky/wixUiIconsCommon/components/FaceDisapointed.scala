...
object FaceDisapointed {
  ...
  implicit def make(companion: FaceDisapointed.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceDisapointedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
