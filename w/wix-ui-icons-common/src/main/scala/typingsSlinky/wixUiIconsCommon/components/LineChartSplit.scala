...
object LineChartSplit {
  ...
  implicit def make(companion: LineChartSplit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LineChartSplitProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
