...
object UpperCase {
  ...
  implicit def make(companion: UpperCase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UpperCaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
