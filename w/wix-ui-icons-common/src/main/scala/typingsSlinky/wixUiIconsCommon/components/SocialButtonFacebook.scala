...
import typingsSlinky.wixUiIconsCommon.socialButtonFacebookMod.SocialButtonFacebookProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SocialButtonFacebook {
  ...
  implicit def make(companion: SocialButtonFacebook.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonFacebookProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
