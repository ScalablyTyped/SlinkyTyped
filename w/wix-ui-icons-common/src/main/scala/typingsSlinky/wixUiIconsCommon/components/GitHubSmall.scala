...
object GitHubSmall {
  ...
  implicit def make(companion: GitHubSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GitHubSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
