...
object Add {
  ...
  @JSImport("wix-ui-icons-common/Add", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Add.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
