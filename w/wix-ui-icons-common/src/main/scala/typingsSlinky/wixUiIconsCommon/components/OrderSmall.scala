...
object OrderSmall {
  ...
  implicit def make(companion: OrderSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OrderSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
