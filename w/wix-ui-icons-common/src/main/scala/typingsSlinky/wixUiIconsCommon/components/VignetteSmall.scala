...
object VignetteSmall {
  ...
  implicit def make(companion: VignetteSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VignetteSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
