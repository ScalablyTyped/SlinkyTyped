...
object FaceSmiling {
  ...
  implicit def make(companion: FaceSmiling.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceSmilingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
