...
object LanguagesSmall {
  ...
  def withProps(p: LanguagesSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: LanguagesSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
