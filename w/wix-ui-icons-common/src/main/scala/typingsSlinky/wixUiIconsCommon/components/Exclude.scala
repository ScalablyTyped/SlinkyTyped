...
object Exclude {
  ...
  @JSImport("wix-ui-icons-common/Exclude", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Exclude.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExcludeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
