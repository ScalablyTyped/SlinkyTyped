...
object CropSmall {
  ...
  implicit def make(companion: CropSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CropSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
