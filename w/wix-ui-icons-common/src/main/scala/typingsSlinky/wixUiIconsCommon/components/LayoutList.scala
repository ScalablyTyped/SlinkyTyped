...
object LayoutList {
  ...
  implicit def make(companion: LayoutList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
