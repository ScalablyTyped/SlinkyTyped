...
object WixForms {
  ...
  @JSImport("wix-ui-icons-common/WixForms", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: WixForms.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixFormsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
