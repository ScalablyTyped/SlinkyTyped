...
import typingsSlinky.wixUiIconsCommon.textAreaNumberedListMod.TextAreaNumberedListProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaNumberedList {
  ...
  implicit def make(companion: TextAreaNumberedList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaNumberedListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
