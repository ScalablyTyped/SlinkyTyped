...
object AppMarketSmall {
  ...
  implicit def make(companion: AppMarketSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppMarketSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
