...
object Pin {
  ...
  @JSImport("wix-ui-icons-common/Pin", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Pin.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
