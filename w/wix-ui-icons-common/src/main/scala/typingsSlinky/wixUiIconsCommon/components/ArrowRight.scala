...
object ArrowRight {
  ...
  implicit def make(companion: ArrowRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
