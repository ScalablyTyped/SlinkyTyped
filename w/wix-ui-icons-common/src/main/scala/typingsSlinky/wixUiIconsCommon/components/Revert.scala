...
object Revert {
  ...
  @JSImport("wix-ui-icons-common/Revert", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Revert.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RevertProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
