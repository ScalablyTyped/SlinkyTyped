...
object DistributeGlobeSmall {
  ...
  implicit def make(companion: DistributeGlobeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeGlobeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
