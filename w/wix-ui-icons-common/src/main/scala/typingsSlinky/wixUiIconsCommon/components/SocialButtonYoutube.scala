...
object SocialButtonYoutube {
  ...
  implicit def make(companion: SocialButtonYoutube.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonYoutubeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
