...
object ChevronDownCircle {
  ...
  def withProps(p: ChevronDownCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ChevronDownCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
