...
object CircleSmallFilled {
  ...
  def withProps(p: CircleSmallFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CircleSmallFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
