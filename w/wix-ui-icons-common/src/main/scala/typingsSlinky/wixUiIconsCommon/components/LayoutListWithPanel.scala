...
object LayoutListWithPanel {
  ...
  implicit def make(companion: LayoutListWithPanel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutListWithPanelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
