...
object HeartSmall {
  ...
  def withProps(p: HeartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: HeartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
