...
object More {
  ...
  @JSImport("wix-ui-icons-common/More", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: More.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoreProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
