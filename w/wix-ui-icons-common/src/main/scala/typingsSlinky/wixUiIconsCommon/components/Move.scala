...
object Move {
  ...
  implicit def make(companion: Move.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
