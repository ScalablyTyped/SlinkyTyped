...
object ChevronLeftCircleSmall {
  ...
  implicit def make(companion: ChevronLeftCircleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftCircleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
