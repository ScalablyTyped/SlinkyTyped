...
object PublicSmall {
  ...
  def withProps(p: PublicSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: PublicSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
