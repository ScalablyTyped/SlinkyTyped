...
object EditSmall {
  ...
  implicit def make(companion: EditSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
