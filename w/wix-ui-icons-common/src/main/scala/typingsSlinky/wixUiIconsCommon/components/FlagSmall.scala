...
object FlagSmall {
  ...
  implicit def make(companion: FlagSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
