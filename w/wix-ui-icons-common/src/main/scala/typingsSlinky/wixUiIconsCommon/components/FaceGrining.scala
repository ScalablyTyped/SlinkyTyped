...
object FaceGrining {
  ...
  implicit def make(companion: FaceGrining.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceGriningProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
