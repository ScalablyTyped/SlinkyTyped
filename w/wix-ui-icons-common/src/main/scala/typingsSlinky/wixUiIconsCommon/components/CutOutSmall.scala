...
object CutOutSmall {
  ...
  implicit def make(companion: CutOutSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CutOutSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
