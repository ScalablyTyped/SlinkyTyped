...
object ForwardSmall {
  ...
  def withProps(p: ForwardSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ForwardSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
