...
object Refresh {
  ...
  @JSImport("wix-ui-icons-common/Refresh", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Refresh.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RefreshProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
