...
object WixChat {
  ...
  def withProps(p: WixChatProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: WixChat.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
