...
object DateAddSmall {
  ...
  implicit def make(companion: DateAddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateAddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
