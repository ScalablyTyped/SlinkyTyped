...
object GiftSmall {
  ...
  def withProps(p: GiftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: GiftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
