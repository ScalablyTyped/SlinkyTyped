...
import typingsSlinky.wixUiIconsCommon.addItemSmallMod.AddItemSmallProps
...
object AddItemSmall {
  ...
  implicit def make(companion: AddItemSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddItemSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
