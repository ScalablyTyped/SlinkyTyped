...
object Phone {
  ...
  implicit def make(companion: Phone.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PhoneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
