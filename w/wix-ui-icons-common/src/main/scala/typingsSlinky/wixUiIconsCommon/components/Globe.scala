...
object Globe {
  ...
  @JSImport("wix-ui-icons-common/Globe", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Globe.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GlobeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
