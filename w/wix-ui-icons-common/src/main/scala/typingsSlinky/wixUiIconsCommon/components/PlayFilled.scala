...
object PlayFilled {
  ...
  implicit def make(companion: PlayFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
