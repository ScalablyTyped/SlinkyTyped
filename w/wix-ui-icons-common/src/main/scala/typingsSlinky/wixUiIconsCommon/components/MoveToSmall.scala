...
object MoveToSmall {
  ...
  def withProps(p: MoveToSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: MoveToSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
