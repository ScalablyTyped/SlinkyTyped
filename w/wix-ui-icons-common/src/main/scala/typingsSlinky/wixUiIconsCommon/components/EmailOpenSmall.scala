...
object EmailOpenSmall {
  ...
  implicit def make(companion: EmailOpenSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailOpenSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
