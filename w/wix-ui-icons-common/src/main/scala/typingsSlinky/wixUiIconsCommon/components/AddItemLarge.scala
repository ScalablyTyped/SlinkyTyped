...
import typingsSlinky.wixUiIconsCommon.addItemLargeMod.AddItemLargeProps
...
object AddItemLarge {
  ...
  implicit def make(companion: AddItemLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddItemLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
