...
object InfoCircle {
  ...
  def withProps(p: InfoCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: InfoCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
