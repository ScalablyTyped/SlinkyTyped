...
object SiteDuplicate {
  ...
  implicit def make(companion: SiteDuplicate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteDuplicateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
