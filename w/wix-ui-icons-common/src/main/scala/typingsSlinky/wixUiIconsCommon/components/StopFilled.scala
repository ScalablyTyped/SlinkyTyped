...
object StopFilled {
  ...
  def withProps(p: StopFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: StopFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
