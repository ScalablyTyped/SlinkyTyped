...
object AddSmall {
  ...
  implicit def make(companion: AddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
