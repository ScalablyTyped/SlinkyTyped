...
object BonusGift {
  ...
  def withProps(p: BonusGiftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: BonusGift.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
