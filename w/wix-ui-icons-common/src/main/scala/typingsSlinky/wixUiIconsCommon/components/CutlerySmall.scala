...
object CutlerySmall {
  ...
  def withProps(p: CutlerySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CutlerySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
