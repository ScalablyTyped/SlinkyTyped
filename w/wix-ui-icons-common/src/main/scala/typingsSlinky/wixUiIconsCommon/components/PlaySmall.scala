...
object PlaySmall {
  ...
  implicit def make(companion: PlaySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlaySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
