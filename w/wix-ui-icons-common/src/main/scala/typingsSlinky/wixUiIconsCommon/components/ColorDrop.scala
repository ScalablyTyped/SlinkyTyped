...
object ColorDrop {
  ...
  implicit def make(companion: ColorDrop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorDropProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
