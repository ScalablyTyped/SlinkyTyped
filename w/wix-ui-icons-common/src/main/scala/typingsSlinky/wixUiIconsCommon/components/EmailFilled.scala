...
object EmailFilled {
  ...
  def withProps(p: EmailFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: EmailFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
