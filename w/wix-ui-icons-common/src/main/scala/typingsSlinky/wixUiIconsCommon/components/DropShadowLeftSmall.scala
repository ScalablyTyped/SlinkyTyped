...
object DropShadowLeftSmall {
  ...
  def withProps(p: DropShadowLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: DropShadowLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
