...
object LayoutGalleryWithPanel {
  ...
  implicit def make(companion: LayoutGalleryWithPanel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutGalleryWithPanelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
