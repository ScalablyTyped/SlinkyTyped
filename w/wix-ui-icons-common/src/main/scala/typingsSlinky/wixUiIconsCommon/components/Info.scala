...
object Info {
  ...
  @JSImport("wix-ui-icons-common/Info", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Info.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InfoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
