...
object Check {
  ...
  @JSImport("wix-ui-icons-common/Check", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Check.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
