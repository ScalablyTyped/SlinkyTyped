...
import typingsSlinky.wixUiIconsCommon.socialButtonTwitterMod.SocialButtonTwitterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SocialButtonTwitter {
  ...
  implicit def make(companion: SocialButtonTwitter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialButtonTwitterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
