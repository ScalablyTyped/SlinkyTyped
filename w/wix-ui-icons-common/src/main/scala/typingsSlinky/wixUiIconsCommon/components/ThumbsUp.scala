...
object ThumbsUp {
  ...
  def withProps(p: ThumbsUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: ThumbsUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
