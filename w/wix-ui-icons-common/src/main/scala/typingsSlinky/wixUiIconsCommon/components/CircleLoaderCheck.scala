...
import typingsSlinky.wixUiIconsCommon.circleLoaderCheckMod.CircleLoaderCheckProps
...
object CircleLoaderCheck {
  ...
  implicit def make(companion: CircleLoaderCheck.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CircleLoaderCheckProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
