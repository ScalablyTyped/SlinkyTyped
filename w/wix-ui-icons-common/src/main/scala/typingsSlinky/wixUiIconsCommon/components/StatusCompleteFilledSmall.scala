...
object StatusCompleteFilledSmall {
  ...
  implicit def make(companion: StatusCompleteFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusCompleteFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
