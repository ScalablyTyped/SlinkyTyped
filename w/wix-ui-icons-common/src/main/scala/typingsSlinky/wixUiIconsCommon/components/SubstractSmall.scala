...
object SubstractSmall {
  ...
  def withProps(p: SubstractSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: SubstractSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
