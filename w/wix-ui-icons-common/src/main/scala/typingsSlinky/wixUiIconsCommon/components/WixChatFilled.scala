...
object WixChatFilled {
  ...
  implicit def make(companion: WixChatFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixChatFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
