...
object AppMarket {
  ...
  implicit def make(companion: AppMarket.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppMarketProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
