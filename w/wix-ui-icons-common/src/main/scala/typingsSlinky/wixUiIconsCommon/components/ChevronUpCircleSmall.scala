...
object ChevronUpCircleSmall {
  ...
  implicit def make(companion: ChevronUpCircleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpCircleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
