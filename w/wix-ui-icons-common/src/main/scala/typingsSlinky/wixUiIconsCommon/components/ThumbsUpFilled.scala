...
object ThumbsUpFilled {
  ...
  implicit def make(companion: ThumbsUpFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbsUpFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
