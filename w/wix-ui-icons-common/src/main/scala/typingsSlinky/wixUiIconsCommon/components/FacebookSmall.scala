...
object FacebookSmall {
  ...
  implicit def make(companion: FacebookSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FacebookSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
