...
import typingsSlinky.wixUiIconsCommon.toggleOffMod.ToggleOffProps
...
object ToggleOff {
  ...
  implicit def make(companion: ToggleOff.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToggleOffProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
