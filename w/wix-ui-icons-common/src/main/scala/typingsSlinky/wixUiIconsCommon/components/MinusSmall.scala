...
object MinusSmall {
  ...
  implicit def make(companion: MinusSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinusSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
