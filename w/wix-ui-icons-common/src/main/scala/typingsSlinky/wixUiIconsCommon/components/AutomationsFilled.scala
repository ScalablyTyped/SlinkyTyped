...
object AutomationsFilled {
  ...
  implicit def make(companion: AutomationsFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AutomationsFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
