...
object CircleLargeSmall {
  ...
  def withProps(p: CircleLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: CircleLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
