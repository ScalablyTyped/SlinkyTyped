...
object User {
  ...
  def withProps(p: UserProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  implicit def make(companion: User.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
