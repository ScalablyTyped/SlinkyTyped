...
object MusicSmall {
  ...
  implicit def make(companion: MusicSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MusicSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
