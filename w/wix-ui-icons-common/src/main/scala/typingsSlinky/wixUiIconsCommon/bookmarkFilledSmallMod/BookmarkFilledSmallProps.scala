package typingsSlinky.wixUiIconsCommon.bookmarkFilledSmallMod
...
object BookmarkFilledSmallProps {
  ...
  @scala.inline
  implicit class BookmarkFilledSmallPropsOps[Self <: BookmarkFilledSmallProps] (val x: Self) extends AnyVal {
