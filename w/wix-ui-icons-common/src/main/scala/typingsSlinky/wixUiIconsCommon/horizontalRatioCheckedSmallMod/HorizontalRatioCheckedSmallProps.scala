package typingsSlinky.wixUiIconsCommon.horizontalRatioCheckedSmallMod
...
object HorizontalRatioCheckedSmallProps {
  ...
  @scala.inline
  implicit class HorizontalRatioCheckedSmallPropsOps[Self <: HorizontalRatioCheckedSmallProps] (val x: Self) extends AnyVal {
