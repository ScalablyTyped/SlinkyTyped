package typingsSlinky.wixUiIconsCommon.automationsFilledMod
...
object AutomationsFilledProps {
  ...
  @scala.inline
  implicit class AutomationsFilledPropsOps[Self <: AutomationsFilledProps] (val x: Self) extends AnyVal {
