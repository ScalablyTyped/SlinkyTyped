...
object chatReplyMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[ChatReplyProps] = js.native
  
  @js.native
  trait ChatReplyProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[ChatReplyProps]
  
  /* This means you don't have to write `default`, but can instead just say `chatReplyMod.foo` */
  override def _to: ReactComponentClass[ChatReplyProps] = default
}
