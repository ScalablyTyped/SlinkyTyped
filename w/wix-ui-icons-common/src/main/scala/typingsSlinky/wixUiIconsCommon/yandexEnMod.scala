...
object yandexEnMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[YandexEnProps] = js.native
  
  @js.native
  trait YandexEnProps extends SVGAttributes[SVGElement] {
  ...
  type _To = ReactComponentClass[YandexEnProps]
  
  /* This means you don't have to write `default`, but can instead just say `yandexEnMod.foo` */
  override def _to: ReactComponentClass[YandexEnProps] = default
}
