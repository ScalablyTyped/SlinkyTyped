...
object foodInStockMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FoodInStockProps] = js.native
  ...
  type _To = ReactComponentClass[FoodInStockProps]
  
  /* This means you don't have to write `default`, but can instead just say `foodInStockMod.foo` */
  override def _to: ReactComponentClass[FoodInStockProps] = default
}
