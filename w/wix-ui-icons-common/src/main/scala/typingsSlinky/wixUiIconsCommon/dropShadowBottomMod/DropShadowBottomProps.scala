package typingsSlinky.wixUiIconsCommon.dropShadowBottomMod
...
object DropShadowBottomProps {
  ...
  @scala.inline
  implicit class DropShadowBottomPropsOps[Self <: DropShadowBottomProps] (val x: Self) extends AnyVal {
