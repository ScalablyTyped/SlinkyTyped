package typingsSlinky.wixUiIconsCommon.dateAndTimeSmallMod
...
object DateAndTimeSmallProps {
  ...
  @scala.inline
  implicit class DateAndTimeSmallPropsOps[Self <: DateAndTimeSmallProps] (val x: Self) extends AnyVal {
