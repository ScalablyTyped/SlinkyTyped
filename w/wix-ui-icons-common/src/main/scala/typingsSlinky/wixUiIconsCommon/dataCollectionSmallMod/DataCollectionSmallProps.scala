package typingsSlinky.wixUiIconsCommon.dataCollectionSmallMod
...
object DataCollectionSmallProps {
  ...
  @scala.inline
  implicit class DataCollectionSmallPropsOps[Self <: DataCollectionSmallProps] (val x: Self) extends AnyVal {
