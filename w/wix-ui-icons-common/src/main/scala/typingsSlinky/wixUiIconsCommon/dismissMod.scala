...
object dismissMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[DismissProps] = js.native
  ...
  type _To = ReactComponentClass[DismissProps]
  
  /* This means you don't have to write `default`, but can instead just say `dismissMod.foo` */
  override def _to: ReactComponentClass[DismissProps] = default
}
