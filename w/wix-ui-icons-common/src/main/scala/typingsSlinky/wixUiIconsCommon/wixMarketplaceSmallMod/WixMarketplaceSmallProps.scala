package typingsSlinky.wixUiIconsCommon.wixMarketplaceSmallMod
...
object WixMarketplaceSmallProps {
  ...
  @scala.inline
  implicit class WixMarketplaceSmallPropsOps[Self <: WixMarketplaceSmallProps] (val x: Self) extends AnyVal {
