...
import typingsSlinky.winstonDailyRotateFile.winstonDailyRotateFileStrings.filename
import typingsSlinky.winstonDailyRotateFile.winstonDailyRotateFileStrings.stream
  ...
  object winstonLibWinstonTransportsAugmentingMod {
    ...
    trait Transports extends StObject {
      ...
      var DailyRotateFile: Instantiable1[
            ...
            typingsSlinky.winstonDailyRotateFile.mod.DailyRotateFile
          ] = js.native
      
      var DailyRotateFileTransportOptions: typingsSlinky.winstonDailyRotateFile.mod.DailyRotateFileTransportOptions = js.native
    }
    object Transports {
