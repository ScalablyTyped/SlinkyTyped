...
trait Anon_ContentHash extends js.Object {
  var contentHash: js.Any
  var hash: js.Any
  var name: js.Any
}

object Anon_ContentHash {
  @scala.inline
  def apply(contentHash: js.Any, hash: js.Any, name: js.Any): Anon_ContentHash = {
    ...
    __obj.asInstanceOf[Anon_ContentHash]
  }
}
