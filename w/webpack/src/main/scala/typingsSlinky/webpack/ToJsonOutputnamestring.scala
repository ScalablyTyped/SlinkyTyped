...
@js.native
trait ToJsonOutputnamestring extends js.Object {
  ...
  var children: js.UndefOr[js.Array[ToJsonOutput with AnonName]] = js.native
...
object ToJsonOutputnamestring {
  @scala.inline
  def apply(_showErrors: Boolean, _showWarnings: Boolean, errors: js.Array[String], warnings: js.Array[String]): ToJsonOutputnamestring = {
    ...
    __obj.asInstanceOf[ToJsonOutputnamestring]
  }
  @scala.inline
  implicit class ToJsonOutputnamestringOps[Self <: ToJsonOutputnamestring] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withChildren(value: js.Array[ToJsonOutput with AnonName]): Self = {
        val ret = this.duplicate
