...
object DefinePlugin extends js.Object {
  ...
  class RuntimeValue protected () extends js.Object {
    def this(fn: js.Function1[/* hasModule */ typingsSlinky.webpack.anon.Module, CodeValuePrimitive]) = this()
    def this(
      fn: js.Function1[/* hasModule */ typingsSlinky.webpack.anon.Module, CodeValuePrimitive],
      fileDependencies: js.Array[String]
    ) = this()
    def exec(parser: Parser): CodeValuePrimitive = js.native
  }
  
  def runtimeValue(fn: js.Function1[/* hasModule */ typingsSlinky.webpack.anon.Module, CodeValuePrimitive]): RuntimeValue = js.native
  def runtimeValue(
    fn: js.Function1[/* hasModule */ typingsSlinky.webpack.anon.Module, CodeValuePrimitive],
    fileDependencies: js.Array[String]
