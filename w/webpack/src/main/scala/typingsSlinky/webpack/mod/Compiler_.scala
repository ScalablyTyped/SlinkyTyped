...
import typingsSlinky.webpack.mod.compilation.CompilerHooks
...
class Compiler_ ()
  ...
  @JSName("apply")
  override def apply(plugins: ((js.ThisFunction0[/* this */ this.type, _]) | typingsSlinky.tapable.mod.Tapable.Plugin)*): Unit = js.native
  /**
    * @deprecated Tapable.apply is deprecated. Call apply on the plugin directly instead
  ...
  /* InferMemberOverrides */
  override def watch(watchOptions: typingsSlinky.webpack.mod.ICompiler.WatchOptions, handler: Handler): Watching = js.native
}
...
object Compiler_ extends js.Object {
  ...
  class Watching protected ()
    extends typingsSlinky.webpack.mod.Watching {
    def this(
      compiler: Compiler_,
  ...
  object Watching extends js.Object {
    type Handler = typingsSlinky.webpack.mod.ICompiler.Handler
    type WatchOptions = typingsSlinky.webpack.mod.ICompiler.WatchOptions
  }
