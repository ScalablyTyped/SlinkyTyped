...
trait Optimization extends js.Object {
  ...
  var minimizer: js.UndefOr[js.Array[Plugin | typingsSlinky.tapable.mod.Tapable.Plugin]] = js.undefined
...
object Optimization {
  ...
  def apply(
    ...
    minimizer: js.Array[Plugin | typingsSlinky.tapable.mod.Tapable.Plugin] = null,
