...
import typingsSlinky.webpack.mod.Stats.ChunkGroup
...
trait ToJsonOutputnamestringAssetsByChunkName extends js.Object {
  ...
  var children: js.UndefOr[js.Array[ToJsonOutputnamestringAssets]] = js.undefined
...
object ToJsonOutputnamestringAssetsByChunkName {
  @scala.inline
  def apply(
    _showErrors: Boolean,
    ...
    children: js.Array[ToJsonOutputnamestringAssets] = null,
    ...
    version: String = null
  ): ToJsonOutputnamestringAssetsByChunkName = {
    ...
    __obj.asInstanceOf[ToJsonOutputnamestringAssetsByChunkName]
  }
}
