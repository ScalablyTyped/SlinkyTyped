...
import typingsSlinky.webpack.anon.AggregateTimeout
import typingsSlinky.webpack.anon.Debug
...
import typingsSlinky.webpack.webpackStrings.`errors-only`
import typingsSlinky.webpack.webpackStrings.`errors-warnings`
import typingsSlinky.webpack.webpackStrings.`node-webkit`
import typingsSlinky.webpack.webpackStrings.detailed
import typingsSlinky.webpack.webpackStrings.development
import typingsSlinky.webpack.webpackStrings.minimal
import typingsSlinky.webpack.webpackStrings.node
import typingsSlinky.webpack.webpackStrings.none
import typingsSlinky.webpack.webpackStrings.normal
...
object WebpackOptions {
  ...
  implicit class WebpackOptionsMutableBuilder[Self <: WebpackOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExternalsRegExp(value: js.RegExp): Self = StObject.set(x, "externals", value.asInstanceOf[js.Any])
