...
object RuleSetRule {
  ...
  implicit class RuleSetRuleMutableBuilder[Self <: RuleSetRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompilerRegExp(value: js.RegExp): Self = StObject.set(x, "compiler", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIssuerRegExp(value: js.RegExp): Self = StObject.set(x, "issuer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRealResourceRegExp(value: js.RegExp): Self = StObject.set(x, "realResource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResourceQueryRegExp(value: js.RegExp): Self = StObject.set(x, "resourceQuery", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceQueryUndefined: Self = StObject.set(x, "resourceQuery", js.undefined)
    
    @scala.inline
    def setResourceRegExp(value: js.RegExp): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
