...
object RuleSetRule {
  ...
  implicit class RuleSetRuleOps[Self <: RuleSetRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompilerRegExp(value: js.RegExp): Self = this.set("compiler", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIssuerRegExp(value: js.RegExp): Self = this.set("issuer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRealResourceRegExp(value: js.RegExp): Self = this.set("realResource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResourceRegExp(value: js.RegExp): Self = this.set("resource", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResourceQueryRegExp(value: js.RegExp): Self = this.set("resourceQuery", value.asInstanceOf[js.Any])
