...
import typingsSlinky.webpack.anon.Bold
...
object StatsOptions {
  ...
  implicit class StatsOptionsMutableBuilder[Self <: StatsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludeAssetsRegExp(value: js.RegExp): Self = StObject.set(x, "excludeAssets", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExcludeModulesRegExp(value: js.RegExp): Self = StObject.set(x, "excludeModules", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLoggingDebugRegExp(value: js.RegExp): Self = StObject.set(x, "loggingDebug", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWarningsFilterRegExp(value: js.RegExp): Self = StObject.set(x, "warningsFilter", value.asInstanceOf[js.Any])
