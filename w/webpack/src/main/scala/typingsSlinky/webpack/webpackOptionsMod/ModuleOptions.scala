...
object ModuleOptions {
  ...
  implicit class ModuleOptionsOps[Self <: ModuleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExprContextRegExpRegExp(value: js.RegExp): Self = this.set("exprContextRegExp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExprContextRegExp(value: Boolean | js.RegExp): Self = this.set("exprContextRegExp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNoParseVarargs(value: (js.RegExp | String)*): Self = this.set("noParse", js.Array(value :_*))
    
    @scala.inline
    def setNoParseRegExp(value: js.RegExp): Self = this.set("noParse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoParse(value: (js.Array[js.RegExp | String]) | js.RegExp | js.Function | String): Self = this.set("noParse", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnknownContextRegExpRegExp(value: js.RegExp): Self = this.set("unknownContextRegExp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUnknownContextRegExp(value: Boolean | js.RegExp): Self = this.set("unknownContextRegExp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWrappedContextRegExp(value: js.RegExp): Self = this.set("wrappedContextRegExp", value.asInstanceOf[js.Any])
