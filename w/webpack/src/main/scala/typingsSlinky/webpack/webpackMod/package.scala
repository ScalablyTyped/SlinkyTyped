...
package object webpackMod {
  ...
  import typingsSlinky.webpack.webpackMod.optimize.UglifyJsPlugin.CommentFilter
  ...
  {[ P in webpack.webpack.LibraryTarget ]: string}
    */ typingsSlinky.webpack.webpackStrings.AuxiliaryCommentObject with js.Any
  ...
  type EvalSourceMapDevToolPluginOptions = typingsSlinky.webpack.webpackMod.EvalSourceMapDevToolPlugin.Options
  type ExternalsElement = String | js.RegExp | ExternalsObjectElement | ExternalsFunctionElement
  ...
  */
  type RuleSetCondition = _RuleSetCondition | (js.Function1[/* path */ String, Boolean]) | js.RegExp | String
  ...
  type SourceMapDevToolPluginOptions = typingsSlinky.webpack.webpackMod.SourceMapDevToolPlugin.Options
  type Stats = Stats_
  ...
  type UglifyPluginOptions = typingsSlinky.webpack.webpackMod.optimize.UglifyJsPlugin.Options
  /** @deprecated use webpack.Options.WatchOptions */
  type WatchOptions = typingsSlinky.webpack.webpackMod.Options.WatchOptions
}
