...
import typingsSlinky.tapable.tapableMod.SyncBailHook
import typingsSlinky.tapable.tapableMod.Tapable
import typingsSlinky.tapable.tapableMod.Tapable.CallbackFunction
import typingsSlinky.webpack.webpackMod.ICompiler.Handler
import typingsSlinky.webpack.webpackMod.Stats.ToJsonOptions
import typingsSlinky.webpack.webpackMod.Stats.ToStringOptions
import typingsSlinky.webpack.webpackMod.compilation.Compilation
import typingsSlinky.webpack.webpackMod.compilation.CompilerHooks
...
class Compiler ()
  ...
  @JSName("apply")
  override def apply(
    plugins: ((js.ThisFunction0[/* this */ this.type, _]) | typingsSlinky.tapable.tapableMod.Tapable.Plugin)*
  ): Unit = js.native
  /**
    * @deprecated Tapable.apply is deprecated. Call apply on the plugin directly instead
  ...
  /* InferMemberOverrides */
  override def watch(watchOptions: typingsSlinky.webpack.webpackMod.ICompiler.WatchOptions, handler: Handler): Watching = js.native
}
...
object Compiler extends js.Object {
  ...
  class Watching protected () extends js.Object {
    def this(
      compiler: Compiler,
      watchOptions: typingsSlinky.webpack.webpackMod.Compiler.Watching.WatchOptions,
      handler: typingsSlinky.webpack.webpackMod.Compiler.Watching.Handler
    ) = this()
  ...
  object Watching extends js.Object {
    type Handler = typingsSlinky.webpack.webpackMod.ICompiler.Handler
...
object compiler extends js.Object {
  ...
  type CompilerCallback = typingsSlinky.webpack.webpackMod.Compiler.Handler
  ...
  type WatchOptions = typingsSlinky.webpack.webpackMod.Compiler.WatchOptions
  /** @deprecated use webpack.Compiler.Watching */
  type Watching = typingsSlinky.webpack.webpackMod.Compiler.Watching
}
