...
import typingsSlinky.webpack.Anon_ChunkOverhead
import typingsSlinky.webpack.Anon_ContentHash
import typingsSlinky.webpack.Anon_Hash
...
class Chunk () extends js.Object {
  ...
  var _modules: SortableSet[typingsSlinky.webpack.webpackMod.compilation.Module] = js.native
  var chunkReason: js.UndefOr[String] = js.native
  var contentHash: js.Object = js.native
  var debugId: Double = js.native
  var entryModule: js.UndefOr[typingsSlinky.webpack.webpackMod.compilation.Module] = js.native
  ...
  var modulesIterable: SortableSet[typingsSlinky.webpack.webpackMod.compilation.Module] = js.native
  ...
  def addModule(module: typingsSlinky.webpack.webpackMod.compilation.Module): Boolean = js.native
  ...
  def containsModule(module: typingsSlinky.webpack.webpackMod.compilation.Module): Boolean = js.native
  ...
  def getModules(): js.Array[typingsSlinky.webpack.webpackMod.compilation.Module] = js.native
  ...
  def hasModuleInGraph(
    filterFn: js.Function1[/* module */ typingsSlinky.webpack.webpackMod.compilation.Module, Boolean],
  ...
  def moveModule(module: typingsSlinky.webpack.webpackMod.compilation.Module, otherChunk: Chunk): Unit = js.native
  def remove(): Unit = js.native
  def remove(reason: String): Unit = js.native
  def removeGroup(chunkGroup: ChunkGroup): Boolean = js.native
  def removeModule(module: typingsSlinky.webpack.webpackMod.compilation.Module): Boolean = js.native
  def setModules(modules: js.Array[typingsSlinky.webpack.webpackMod.compilation.Module]): Unit = js.native
  def size(): Double = js.native
  def size(options: Anon_ChunkOverhead): Double = js.native
  def sortItems(): Unit = js.native
  def sortModules(
    sortByFn: js.Function2[
      /* module1 */ typingsSlinky.webpack.webpackMod.compilation.Module, 
      /* module2 */ typingsSlinky.webpack.webpackMod.compilation.Module, 
      `-1` | `0` | `1`
    ]
  ): Unit = js.native
