...
object ContextRegExp {
  ...
  implicit class ContextRegExpOps[Self <: ContextRegExp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContextRegExp(value: js.RegExp): Self = this.set("contextRegExp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteContextRegExp: Self = this.set("contextRegExp", js.undefined)
    
    @scala.inline
    def setResourceRegExp(value: js.RegExp): Self = this.set("resourceRegExp", value.asInstanceOf[js.Any])
