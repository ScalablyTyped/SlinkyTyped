...
object Registry {
  ...
  implicit class RegistryOps[Self <: Registry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClear(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clear")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreate(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDestroy(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("destroy")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withErase(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("erase")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGet(value: (String, js.Function2[/* err */ js.Error, /* result */ RegistryItem, Unit]) => Registry): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKeyExists(value: js.Function2[/* err */ js.Error, /* exists */ Boolean, Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("keyExists")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withKeys(value: js.Function2[/* err */ js.Error, /* result */ js.Array[Registry], Unit] => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("keys")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withParent(value: Registry): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRemove(value: (String, js.Function1[/* err */ js.Error, Unit]) => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSet(value: (String, String, String, js.Function1[/* err */ js.Error, Unit]) => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("set")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withValueExists(value: (String, js.Function2[/* err */ js.Error, /* exists */ Boolean, Unit]) => Registry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("valueExists")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withValues(value: js.Function2[/* err */ js.Error, /* result */ js.Array[RegistryItem], Unit] => Registry): Self = {
        val ret = this.duplicate
