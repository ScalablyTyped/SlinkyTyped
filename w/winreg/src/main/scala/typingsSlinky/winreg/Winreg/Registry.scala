...
object Registry {
  ...
  implicit class RegistryOps[Self <: Registry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClear(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = this.set("clear", js.Any.fromFunction1(value))
    @scala.inline
    def setCreate(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = this.set("create", js.Any.fromFunction1(value))
    @scala.inline
    def setDestroy(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = this.set("destroy", js.Any.fromFunction1(value))
    @scala.inline
    def setErase(value: js.Function1[/* err */ js.Error, Unit] => Registry): Self = this.set("erase", js.Any.fromFunction1(value))
    @scala.inline
    def setGet(value: (String, js.Function2[/* err */ js.Error, /* result */ RegistryItem, Unit]) => Registry): Self = this.set("get", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setKeyExists(value: js.Function2[/* err */ js.Error, /* exists */ Boolean, Unit] => Registry): Self = this.set("keyExists", js.Any.fromFunction1(value))
    @scala.inline
    def setKeys(value: js.Function2[/* err */ js.Error, /* result */ js.Array[Registry], Unit] => Registry): Self = this.set("keys", js.Any.fromFunction1(value))
    @scala.inline
    def setParent(value: Registry): Self = this.set("parent", value.asInstanceOf[js.Any])
    @scala.inline
    def setPath(value: String): Self = this.set("path", value.asInstanceOf[js.Any])
    @scala.inline
    def setRemove(value: (String, js.Function1[/* err */ js.Error, Unit]) => Registry): Self = this.set("remove", js.Any.fromFunction2(value))
    @scala.inline
    def setSet(value: (String, String, String, js.Function1[/* err */ js.Error, Unit]) => Registry): Self = this.set("set", js.Any.fromFunction4(value))
    @scala.inline
    def setValueExists(value: (String, js.Function2[/* err */ js.Error, /* exists */ Boolean, Unit]) => Registry): Self = this.set("valueExists", js.Any.fromFunction2(value))
    @scala.inline
    def setValues(value: js.Function2[/* err */ js.Error, /* result */ js.Array[RegistryItem], Unit] => Registry): Self = this.set("values", js.Any.fromFunction1(value))
  }
