...
trait WebPageTest extends StObject {
  ...
  def getLocations(callback: Callback[typingsSlinky.webpagetest.anon.Response]): Unit = js.native
  def getLocations(options: Options with RequestOptions, callback: Callback[typingsSlinky.webpagetest.anon.Response]): Unit = js.native
