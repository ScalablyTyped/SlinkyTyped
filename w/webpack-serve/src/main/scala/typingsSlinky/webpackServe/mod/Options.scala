...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDevMiddleware(value: typingsSlinky.webpackDevMiddleware.mod.Options): Self = this.set("devMiddleware", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHotClient(value: typingsSlinky.webpackHotClient.mod.Options | Boolean): Self = this.set("hotClient", value.asInstanceOf[js.Any])
    @scala.inline
