...
trait OnOptions extends js.Object {
  ...
  var listening: js.UndefOr[js.Function1[/* args */ typingsSlinky.webpackServe.anon.Options, Unit]] = js.undefined
}
...
object OnOptions {
  ...
  def apply(
    ...
    listening: /* args */ typingsSlinky.webpackServe.anon.Options => Unit = null
  ): OnOptions = {
