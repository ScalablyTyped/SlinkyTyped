package typingsSlinky.webshotNode.anon

import typingsSlinky.webshotNode.webshotNodeStrings.all
import typingsSlinky.webshotNode.webshotNodeStrings.window
