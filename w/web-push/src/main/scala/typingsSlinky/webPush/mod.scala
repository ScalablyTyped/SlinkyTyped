...
import typingsSlinky.webPush.anon.RequestDetailsbodyBuffer
...
object mod {
  ...
  @JSImport("web-push", "generateRequestDetails")
  @js.native
  def generateRequestDetails(subscription: PushSubscription, payload: js.UndefOr[scala.Nothing], options: RequestOptions): RequestDetails = js.native
  @JSImport("web-push", "generateRequestDetails")
  @js.native
  ...
  @JSImport("web-push", "generateRequestDetails")
  @js.native
  def generateRequestDetails_RequestDetailsbodynull(subscription: PushSubscription): RequestDetailsbodynull = js.native
  @JSImport("web-push", "generateRequestDetails")
  @js.native
  def generateRequestDetails_RequestDetailsbodynull(subscription: PushSubscription, payload: js.UndefOr[scala.Nothing], options: RequestOptions): RequestDetailsbodynull = js.native
  ...
  */
  ...
  object ContentEncoding {
    ...
    @scala.inline
    def aes128gcm: typingsSlinky.webPush.webPushStrings.aes128gcm = "aes128gcm".asInstanceOf[typingsSlinky.webPush.webPushStrings.aes128gcm]
    
    @scala.inline
    def aesgcm: typingsSlinky.webPush.webPushStrings.aesgcm = "aesgcm".asInstanceOf[typingsSlinky.webPush.webPushStrings.aesgcm]
  }
