...
object GmeCommon {
  ...
  */
  ...
  object DefObject {
    ...
    @scala.inline
    def DefAssetObject(`type`: asset): typingsSlinky.webgme.GmeCommon.DefAssetObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.webgme.GmeCommon.DefAssetObject]
    }
    
    @scala.inline
    def DefBoolObject(`type`: boolean): typingsSlinky.webgme.GmeCommon.DefBoolObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.webgme.GmeCommon.DefBoolObject]
    }
    
    @scala.inline
    def DefFloatObject(`type`: float): typingsSlinky.webgme.GmeCommon.DefFloatObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.webgme.GmeCommon.DefFloatObject]
    }
    
    @scala.inline
    def DefIntegerObject(`type`: integer): typingsSlinky.webgme.GmeCommon.DefIntegerObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.webgme.GmeCommon.DefIntegerObject]
    }
    
    @scala.inline
    def DefStringObject(`type`: string): typingsSlinky.webgme.GmeCommon.DefStringObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.webgme.GmeCommon.DefStringObject]
    }
  }
  ...
  /**
    ...
    */
  type LoadObject = CommitObject | typingsSlinky.webgme.Core.DataObject
  ...
  object MetaRules {
    ...
    implicit class MetaRulesMutableBuilder[Self <: MetaRules] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConstraints(value: Dictionary[typingsSlinky.webgme.Core.Constraint]): Self = StObject.set(x, "constraints", value.asInstanceOf[js.Any])
