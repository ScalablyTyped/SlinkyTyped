...
object OptionsWithHeader {
  ...
  implicit class OptionsWithHeaderOps[Self <: OptionsWithHeader] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFLOATING_TITLE(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FLOATING_TITLE")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHEADER_TITLE(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HEADER_TITLE")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNO_SCROLLING(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NO_SCROLLING")(value.asInstanceOf[js.Any])
        ret
    }
  }
