...
import typingsSlinky.webgme.GmeCommon.Promisable
import typingsSlinky.webgme.GmeCommon.ResultCallback
import typingsSlinky.webgme.GmeConfig.ConfigItem
...
object GmePlugin {
  ...
  trait PluginBase extends StObject {
    ...
    def configure(config: typingsSlinky.webgme.GmeConfig.GmeConfig): Unit = js.native
    
    var core: typingsSlinky.webgme.GmeClasses.Core = js.native
    ...
    def getCurrentConfig(): typingsSlinky.webgme.GmeConfig.GmeConfig = js.native
    
    def getDefaultConfig(): typingsSlinky.webgme.GmeConfig.GmeConfig = js.native
    ...
    def initialize(logger: GmeLogger, blobClient: BlobClient, gmeConfig: typingsSlinky.webgme.GmeConfig.GmeConfig): Unit = js.native
    ...
    def setCurrentConfig(newConfig: typingsSlinky.webgme.GmeConfig.GmeConfig): Unit = js.native
