...
object Toolbar {
  ...
  object Toolbar {
    ...
    def apply(
      ...
      refresh: () => Unit
    ): typingsSlinky.webgme.Toolbar.Toolbar = {
      ...
      __obj.asInstanceOf[typingsSlinky.webgme.Toolbar.Toolbar]
    }
    
    @scala.inline
    implicit class ToolbarMutableBuilder[Self <: typingsSlinky.webgme.Toolbar.Toolbar] (val x: Self) extends AnyVal {
