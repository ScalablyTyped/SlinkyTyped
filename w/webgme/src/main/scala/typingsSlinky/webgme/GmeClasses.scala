...
import typingsSlinky.webgme.GmeCommon.ProjectStart
...
import typingsSlinky.webgme.GmeStorage.CommitHashCallback
...
object GmeClasses {
  ...
  trait Project extends StObject {
    ...
    /**
      ...
      */
    def createTag(tagName: String, commitHash: CommitHash): js.Promise[typingsSlinky.webgme.GmeStorage.ErrorOnlyCallback] = js.native
    /**
      * Creates a new tag pointing to the provided commit hash.
      */
    def createTag(
      ...
      callback: typingsSlinky.webgme.GmeStorage.ErrorOnlyCallback
    ): Unit = js.native
    ...
    /**
      ...
      */
    def deleteTag(tagName: String, callback: typingsSlinky.webgme.GmeStorage.ErrorOnlyCallback): Unit = js.native
    /**
      * Deletes the given tag.
      */
    ...
    /** 
      ...
      */
    def loadPaths(rootKey: String, paths: js.Array[String]): js.Promise[typingsSlinky.webgme.GmeStorage.ErrorOnlyCallback] = js.native
    /** 
      * Collects the objects from the server and pre-loads 
      * them into the cache making the load of multiple objects faster.
      * 
