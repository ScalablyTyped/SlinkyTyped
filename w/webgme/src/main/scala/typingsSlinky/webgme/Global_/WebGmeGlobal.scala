...
trait WebGmeGlobal extends js.Object {
  ...
  var KeyboardManager: js.UndefOr[typingsSlinky.webgme.Global_.KeyboardManager] = js.undefined
  ...
  var State: js.UndefOr[typingsSlinky.webgme.Global_.State] = js.undefined
