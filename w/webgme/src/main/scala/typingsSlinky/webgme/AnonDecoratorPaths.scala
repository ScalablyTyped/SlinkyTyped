...
@js.native
trait AnonDecoratorPaths extends js.Object {
  /**
  ...
  /**
    ...
    * 
    */
  var layout: AnonDefault = js.native
  /**
...
object AnonDecoratorPaths {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonDecoratorPaths]
  }
  @scala.inline
  implicit class AnonDecoratorPathsOps[Self <: AnonDecoratorPaths] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLayout(value: AnonDefault): Self = {
        val ret = this.duplicate
