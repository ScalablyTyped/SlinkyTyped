...
import typingsSlinky.webgme.Core.GmePersisted
import typingsSlinky.webgme.Core.MixinViolation
import typingsSlinky.webgme.Core.Node
import typingsSlinky.webgme.Core.RelationRule
import typingsSlinky.webgme.GmeCommon.DefObject
import typingsSlinky.webgme.GmeCommon.Dictionary
import typingsSlinky.webgme.GmeCommon.ErrorOnlyCallback
import typingsSlinky.webgme.GmeCommon.InAttr
import typingsSlinky.webgme.GmeCommon.MetaInfo
import typingsSlinky.webgme.GmeCommon.MetaRules
...
import typingsSlinky.webgme.GmeCommon.OutPath
...
import typingsSlinky.webgme.GmeCommon.VoidFn
...
trait Core extends js.Object {
  ...
  /**
    ...
    */
  def loadByPath(startNode: Node, relativePath: Path): js.Promise[typingsSlinky.webgme.GmeCommon.DataObject] = js.native
  /**
    * From the given starting node, it loads the path 
    * given as a series of relative ids (separated by '/') and returns the node it finds at the ends of the path. 
    * If there is no node, the function will return null.
  ...
  def loadByPath(
    startNode: Node,
    relativePath: Path,
    callback: ResultCallback[typingsSlinky.webgme.GmeCommon.DataObject]
  ): Unit = js.native
  ...
  /**
    ...
    * @param relativeId the relative id of the child in question.
    */
  def loadChild(parent: Node, relativeId: String): js.Promise[js.Array[typingsSlinky.webgme.GmeCommon.DataObject]] = js.native
  /**
    * Loads the child of the given parent pointed by the relative id. 
    * Behind the scenes, it means that it actually loads the 
    * data pointed by a hash stored inside the parent under 
  ...
  def loadChild(
    parent: Node,
    relativeId: String,
    callback: ResultCallback[js.Array[typingsSlinky.webgme.GmeCommon.DataObject]]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def loadChildren(parent: Node): js.Promise[js.Array[typingsSlinky.webgme.GmeCommon.DataObject]] = js.native
  /**
    * Loads all the children of the given parent. 
    * As it first checks the already reserved relative ids of the parent, 
    * it only loads the already existing children (so no on-demand empty node creation).
    ...
    * @see https://github.com/webgme/webgme/wiki/GME-Core-API#containment-methods
    */
  def loadChildren(parent: Node, callback: ResultCallback[js.Array[typingsSlinky.webgme.GmeCommon.DataObject]]): Unit = js.native
  ...
  /**
    ...
    */
  def loadCollection(target: Node, pointerName: Name): js.Promise[js.Array[typingsSlinky.webgme.GmeCommon.DataObject]] = js.native
  /**
    * Loads all the source nodes that has such a pointer and its target is the given node.
    * @param target the container node in question.
    * @param pointerName 
  ...
  def setChildMeta(node: Node, child: Node, min: js.UndefOr[scala.Nothing], max: Double): js.UndefOr[js.Error] = js.native
  ...
  def setChildrenMetaLimits(node: Node, min: js.UndefOr[scala.Nothing], max: Double): js.UndefOr[js.Error] = js.native
  ...
  def setPointerMetaLimits(node: Node, memberPath: String, min: js.UndefOr[scala.Nothing], max: Double): js.UndefOr[js.Error] = js.native
  ...
  def setPointerMetaTarget(node: Node, name: Name, target: Node, min: js.UndefOr[scala.Nothing], max: Double): js.UndefOr[js.Error] = js.native
