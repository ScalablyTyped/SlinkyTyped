...
object GmePanel {
  ...
  object Logger {
    ...
    def apply(
      ...
      createWithGmeConfig: (String, typingsSlinky.webgme.GmeConfig.GmeConfig) => Logger
    ): Logger = {
    ...
    implicit class LoggerMutableBuilder[Self <: Logger] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreateWithGmeConfig(value: (String, typingsSlinky.webgme.GmeConfig.GmeConfig) => Logger): Self = StObject.set(x, "createWithGmeConfig", js.Any.fromFunction2(value))
    }
  }
