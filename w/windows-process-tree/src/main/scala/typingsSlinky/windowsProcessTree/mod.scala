package typingsSlinky.windowsProcessTree
...
object mod {
  ...
  object ProcessDataFlag extends StObject {
    ...
    /* 2 */ val CommandLine: typingsSlinky.windowsProcessTree.mod.ProcessDataFlag.CommandLine with Double = js.native
    
    @js.native
    sealed trait Memory extends ProcessDataFlag
    /* 1 */ val Memory: typingsSlinky.windowsProcessTree.mod.ProcessDataFlag.Memory with Double = js.native
    
    @js.native
    sealed trait None extends ProcessDataFlag
    /* 0 */ val None: typingsSlinky.windowsProcessTree.mod.ProcessDataFlag.None with Double = js.native
  }
