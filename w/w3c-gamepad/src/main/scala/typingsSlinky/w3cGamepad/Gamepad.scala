...
object Gamepad {
  ...
  object Gamepad {
    ...
    def apply(
      ...
      mapping: String,
      timestamp: Double
    ): typingsSlinky.w3cGamepad.Gamepad.Gamepad = {
      ...
      __obj.asInstanceOf[typingsSlinky.w3cGamepad.Gamepad.Gamepad]
    }
    
    @scala.inline
    implicit class GamepadMutableBuilder[Self <: typingsSlinky.w3cGamepad.Gamepad.Gamepad] (val x: Self) extends AnyVal {
  ...
  trait GamepadEvent extends Event {
    ...
    /**
      ...
      * @readonly
      */
    var gamepad: typingsSlinky.w3cGamepad.Gamepad.Gamepad = js.native
  }
  
  @js.native
  trait GamepadList
    extends /* index */ NumberDictionary[typingsSlinky.w3cGamepad.Gamepad.Gamepad] {
