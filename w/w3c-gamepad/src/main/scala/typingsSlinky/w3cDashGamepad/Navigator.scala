package typingsSlinky.w3cDashGamepad

import typingsSlinky.w3cDashGamepad.Gamepad.GamepadList
...
trait Navigator extends js.Object {
  /**
    ...
    * @readonly
    */
  def getGamepads(): js.Array[typingsSlinky.w3cDashGamepad.Gamepad.Gamepad]
...
object Navigator {
  @scala.inline
  def apply(
    getGamepads: () => js.Array[typingsSlinky.w3cDashGamepad.Gamepad.Gamepad],
