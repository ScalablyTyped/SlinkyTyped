...
object VRLayer {
  @scala.inline
  def apply(
    leftBounds: js.UndefOr[Null | js.Array[Double] | js.typedarray.Float32Array] = js.undefined,
    rightBounds: js.UndefOr[Null | js.Array[Double] | js.typedarray.Float32Array] = js.undefined,
