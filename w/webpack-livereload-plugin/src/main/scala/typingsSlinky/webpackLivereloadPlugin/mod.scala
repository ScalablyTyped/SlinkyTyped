package typingsSlinky.webpackLivereloadPlugin
...
object mod {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var ignore: js.UndefOr[js.RegExp | js.Array[js.RegExp] | Null] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIgnore(value: js.RegExp | js.Array[js.RegExp]): Self = StObject.set(x, "ignore", value.asInstanceOf[js.Any])
