...
object CSSMathNegate {
  ...
  @scala.inline
  implicit class CSSMathNegateOps[Self <: CSSMathNegate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setValue(value: CSSNumericValue): Self = this.set("value", value.asInstanceOf[js.Any])
  }
