...
object EmailMailboxAutoReplyMessageResponseKind extends js.Object {
  ...
  /* 0 */ val html: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxAutoReplyMessageResponseKind.html with Double = js.native
  /* 1 */ val plainText: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxAutoReplyMessageResponseKind.plainText with Double = js.native
  @JSBracketAccess
