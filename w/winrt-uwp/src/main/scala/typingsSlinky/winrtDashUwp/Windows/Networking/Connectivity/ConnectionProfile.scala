...
abstract class ConnectionProfile () extends js.Object {
  ...
  /**
    ...
    */
  def getAttributedNetworkUsageAsync(startTime: js.Date, endTime: js.Date, states: NetworkUsageStates): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
  /**
  ...
  /**
    ...
    */
  def getConnectivityIntervalsAsync(startTime: js.Date, endTime: js.Date, states: NetworkUsageStates): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
  /**
