...
import typingsSlinky.winrtDashUwp.Anon_ItemsReturnValueIPlayReadySecureStopServiceRequest
...
abstract class PlayReadySecureStopIterator () extends js.Object {
  ...
  /**
    ...
    */
  def getMany(): Anon_ItemsReturnValueIPlayReadySecureStopServiceRequest = js.native
  /**
