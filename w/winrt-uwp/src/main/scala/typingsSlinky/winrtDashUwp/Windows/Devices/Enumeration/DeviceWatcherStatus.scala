...
object DeviceWatcherStatus extends js.Object {
  ...
  /* 5 */ val aborted: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.aborted with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.created with Double = js.native
  /* 2 */ val enumerationCompleted: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.enumerationCompleted with Double = js.native
  /* 1 */ val started: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.started with Double = js.native
  /* 4 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.stopped with Double = js.native
  /* 3 */ val stopping: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus.stopping with Double = js.native
  @JSBracketAccess
