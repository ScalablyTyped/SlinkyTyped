...
object ActivitySensorReadingConfidence extends js.Object {
  ...
  /* 0 */ val high: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.ActivitySensorReadingConfidence.high with Double = js.native
  /* 1 */ val low: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.ActivitySensorReadingConfidence.low with Double = js.native
  @JSBracketAccess
