...
object PhotoImportStage extends js.Object {
  ...
  /* 3 */ val deletingImportedItemsFromSource: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportStage.deletingImportedItemsFromSource with Double = js.native
  /* 1 */ val findingItems: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportStage.findingItems with Double = js.native
  /* 2 */ val importingItems: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportStage.importingItems with Double = js.native
  /* 0 */ val notStarted: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportStage.notStarted with Double = js.native
  @JSBracketAccess
