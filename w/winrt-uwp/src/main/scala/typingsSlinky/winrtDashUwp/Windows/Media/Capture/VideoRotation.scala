...
object VideoRotation extends js.Object {
  ...
  /* 2 */ val clockwise180Degrees: typingsSlinky.winrtDashUwp.Windows.Media.Capture.VideoRotation.clockwise180Degrees with Double = js.native
  /* 3 */ val clockwise270Degrees: typingsSlinky.winrtDashUwp.Windows.Media.Capture.VideoRotation.clockwise270Degrees with Double = js.native
  /* 1 */ val clockwise90Degrees: typingsSlinky.winrtDashUwp.Windows.Media.Capture.VideoRotation.clockwise90Degrees with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Media.Capture.VideoRotation.none with Double = js.native
  @JSBracketAccess
