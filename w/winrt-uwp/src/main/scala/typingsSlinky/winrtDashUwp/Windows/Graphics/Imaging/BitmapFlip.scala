...
object BitmapFlip extends js.Object {
  ...
  /* 1 */ val horizontal: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapFlip.horizontal with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapFlip.none with Double = js.native
  /* 2 */ val vertical: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapFlip.vertical with Double = js.native
  @JSBracketAccess
