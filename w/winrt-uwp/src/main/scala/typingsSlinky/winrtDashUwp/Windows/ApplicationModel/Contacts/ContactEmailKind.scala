...
object ContactEmailKind extends js.Object {
  ...
  /* 2 */ val other: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactEmailKind.other with Double = js.native
  /* 0 */ val personal: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactEmailKind.personal with Double = js.native
  /* 1 */ val work: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactEmailKind.work with Double = js.native
  @JSBracketAccess
