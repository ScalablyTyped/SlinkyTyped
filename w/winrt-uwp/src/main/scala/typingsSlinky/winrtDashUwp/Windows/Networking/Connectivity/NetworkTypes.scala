...
object NetworkTypes extends js.Object {
  ...
  /* 1 */ val internet: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkTypes.internet with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkTypes.none with Double = js.native
  /* 2 */ val privateNetwork: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkTypes.privateNetwork with Double = js.native
  @JSBracketAccess
