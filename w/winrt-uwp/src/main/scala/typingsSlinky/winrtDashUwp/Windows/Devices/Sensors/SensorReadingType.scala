...
object SensorReadingType extends js.Object {
  ...
  /* 0 */ val absolute: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SensorReadingType.absolute with Double = js.native
  /* 1 */ val relative: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SensorReadingType.relative with Double = js.native
  @JSBracketAccess
