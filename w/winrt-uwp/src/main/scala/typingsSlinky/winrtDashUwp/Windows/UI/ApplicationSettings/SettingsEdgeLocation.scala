...
object SettingsEdgeLocation extends js.Object {
  ...
  /* 1 */ val left: typingsSlinky.winrtDashUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation.left with Double = js.native
  /* 0 */ val right: typingsSlinky.winrtDashUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation.right with Double = js.native
  @JSBracketAccess
