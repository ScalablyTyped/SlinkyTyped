...
object AdvancedPhotoMode extends js.Object {
  ...
  /* 0 */ val auto: typingsSlinky.winrtDashUwp.Windows.Media.Devices.AdvancedPhotoMode.auto with Double = js.native
  /* 2 */ val hdr: typingsSlinky.winrtDashUwp.Windows.Media.Devices.AdvancedPhotoMode.hdr with Double = js.native
  /* 1 */ val standard: typingsSlinky.winrtDashUwp.Windows.Media.Devices.AdvancedPhotoMode.standard with Double = js.native
  @JSBracketAccess
