...
object VirtualKeyModifiers extends js.Object {
  ...
  /* 1 */ val control: typingsSlinky.winrtDashUwp.Windows.System.VirtualKeyModifiers.control with Double = js.native
  /* 2 */ val menu: typingsSlinky.winrtDashUwp.Windows.System.VirtualKeyModifiers.menu with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.System.VirtualKeyModifiers.none with Double = js.native
  /* 3 */ val shift: typingsSlinky.winrtDashUwp.Windows.System.VirtualKeyModifiers.shift with Double = js.native
  /* 4 */ val windows: typingsSlinky.winrtDashUwp.Windows.System.VirtualKeyModifiers.windows with Double = js.native
  @JSBracketAccess
