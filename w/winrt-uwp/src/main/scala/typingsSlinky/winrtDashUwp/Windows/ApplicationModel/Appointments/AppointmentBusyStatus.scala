...
object AppointmentBusyStatus extends js.Object {
  ...
  /* 0 */ val busy: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus.busy with Double = js.native
  /* 2 */ val free: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus.free with Double = js.native
  /* 3 */ val outOfOffice: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus.outOfOffice with Double = js.native
  /* 1 */ val tentative: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus.tentative with Double = js.native
  /* 4 */ val workingElsewhere: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus.workingElsewhere with Double = js.native
  @JSBracketAccess
