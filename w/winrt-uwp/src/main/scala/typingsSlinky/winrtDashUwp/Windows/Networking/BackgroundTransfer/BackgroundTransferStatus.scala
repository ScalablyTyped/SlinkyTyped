...
object BackgroundTransferStatus extends js.Object {
  ...
  /* 6 */ val canceled: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.canceled with Double = js.native
  /* 5 */ val completed: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.completed with Double = js.native
  /* 7 */ val error: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.error with Double = js.native
  /* 0 */ val idle: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.idle with Double = js.native
  /* 2 */ val pausedByApplication: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedByApplication with Double = js.native
  /* 3 */ val pausedCostedNetwork: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedCostedNetwork with Double = js.native
  /* 4 */ val pausedNoNetwork: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedNoNetwork with Double = js.native
  /* 8 */ val pausedSystemPolicy: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedSystemPolicy with Double = js.native
  /* 1 */ val running: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.running with Double = js.native
  @JSBracketAccess
