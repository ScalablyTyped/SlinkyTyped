...
object Print3DWorkflowStatus extends js.Object {
  ...
  /* 0 */ val abandoned: typingsSlinky.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.abandoned with Double = js.native
  /* 1 */ val canceled: typingsSlinky.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.canceled with Double = js.native
  /* 2 */ val failed: typingsSlinky.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.failed with Double = js.native
  /* 3 */ val slicing: typingsSlinky.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.slicing with Double = js.native
  /* 4 */ val submitted: typingsSlinky.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.submitted with Double = js.native
  @JSBracketAccess
