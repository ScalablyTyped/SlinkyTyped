...
object AlternateNormalizationFormat extends js.Object {
  ...
  /* 2 */ val currency: typingsSlinky.winrtDashUwp.Windows.Data.Text.AlternateNormalizationFormat.currency with Double = js.native
  /* 3 */ val date: typingsSlinky.winrtDashUwp.Windows.Data.Text.AlternateNormalizationFormat.date with Double = js.native
  /* 0 */ val notNormalized: typingsSlinky.winrtDashUwp.Windows.Data.Text.AlternateNormalizationFormat.notNormalized with Double = js.native
  /* 1 */ val number: typingsSlinky.winrtDashUwp.Windows.Data.Text.AlternateNormalizationFormat.number with Double = js.native
  /* 4 */ val time: typingsSlinky.winrtDashUwp.Windows.Data.Text.AlternateNormalizationFormat.time with Double = js.native
  @JSBracketAccess
