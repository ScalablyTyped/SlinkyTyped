...
object PhotoImportSubfolderCreationMode extends js.Object {
  ...
  /* 2 */ val createSubfoldersFromExifDate: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSubfolderCreationMode.createSubfoldersFromExifDate with Double = js.native
  /* 1 */ val createSubfoldersFromFileDate: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSubfolderCreationMode.createSubfoldersFromFileDate with Double = js.native
  /* 0 */ val doNotCreateSubfolders: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSubfolderCreationMode.doNotCreateSubfolders with Double = js.native
  /* 3 */ val keepOriginalFolderStructure: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSubfolderCreationMode.keepOriginalFolderStructure with Double = js.native
  @JSBracketAccess
