...
object MediaCapturePauseBehavior extends js.Object {
  ...
  /* 1 */ val releaseHardwareResources: typingsSlinky.winrtDashUwp.Windows.Media.Devices.MediaCapturePauseBehavior.releaseHardwareResources with Double = js.native
  /* 0 */ val retainHardwareResources: typingsSlinky.winrtDashUwp.Windows.Media.Devices.MediaCapturePauseBehavior.retainHardwareResources with Double = js.native
  @JSBracketAccess
