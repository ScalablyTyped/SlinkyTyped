...
object LinkType extends js.Object {
  ...
  /* 5 */ val autoLink: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.autoLink with Double = js.native
  /* 6 */ val autoLinkEmail: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.autoLinkEmail with Double = js.native
  /* 8 */ val autoLinkPath: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.autoLinkPath with Double = js.native
  /* 7 */ val autoLinkPhone: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.autoLinkPhone with Double = js.native
  /* 2 */ val clientLink: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.clientLink with Double = js.native
  /* 4 */ val friendlyLinkAddress: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.friendlyLinkAddress with Double = js.native
  /* 3 */ val friendlyLinkName: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.friendlyLinkName with Double = js.native
  /* 1 */ val notALink: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.notALink with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.LinkType.undefined with Double = js.native
  @JSBracketAccess
