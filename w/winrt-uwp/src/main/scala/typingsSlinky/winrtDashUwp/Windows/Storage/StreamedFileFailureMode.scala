...
object StreamedFileFailureMode extends js.Object {
  ...
  /* 1 */ val currentlyUnavailable: typingsSlinky.winrtDashUwp.Windows.Storage.StreamedFileFailureMode.currentlyUnavailable with Double = js.native
  /* 0 */ val failed: typingsSlinky.winrtDashUwp.Windows.Storage.StreamedFileFailureMode.failed with Double = js.native
  /* 2 */ val incomplete: typingsSlinky.winrtDashUwp.Windows.Storage.StreamedFileFailureMode.incomplete with Double = js.native
  @JSBracketAccess
