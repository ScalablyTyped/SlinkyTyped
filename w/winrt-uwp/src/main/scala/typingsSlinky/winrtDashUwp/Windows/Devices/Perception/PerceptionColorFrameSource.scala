...
import typingsSlinky.winrtDashUwp.Anon_Result
...
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.Core.CameraIntrinsics
import typingsSlinky.winrtDashUwp.Windows.WinRTEvent
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.activechanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.availablechanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.cameraintrinsicschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.propertieschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.videoprofilechanged
