...
object AudioEncodingQuality extends js.Object {
  ...
  /* 0 */ val auto: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.AudioEncodingQuality.auto with Double = js.native
  /* 1 */ val high: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.AudioEncodingQuality.high with Double = js.native
  /* 3 */ val low: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.AudioEncodingQuality.low with Double = js.native
  /* 2 */ val medium: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.AudioEncodingQuality.medium with Double = js.native
  @JSBracketAccess
