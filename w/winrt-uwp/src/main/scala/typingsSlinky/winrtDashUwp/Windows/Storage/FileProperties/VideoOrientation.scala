...
object VideoOrientation extends js.Object {
  ...
  /* 0 */ val normal: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.VideoOrientation.normal with Double = js.native
  /* 2 */ val rotate180: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.VideoOrientation.rotate180 with Double = js.native
  /* 3 */ val rotate270: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.VideoOrientation.rotate270 with Double = js.native
  /* 1 */ val rotate90: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.VideoOrientation.rotate90 with Double = js.native
  @JSBracketAccess
