...
import typingsSlinky.winrtDashUwp.Anon_LanguageRangeWithQualityHeaderValue
...
object HttpLanguageRangeWithQualityHeaderValue extends js.Object {
  ...
  /**
    ...
    */
  def tryParse(input: String): Anon_LanguageRangeWithQualityHeaderValue = js.native
}
