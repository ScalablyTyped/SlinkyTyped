...
object TimedTextScrollMode extends js.Object {
  ...
  /* 0 */ val popon: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextScrollMode.popon with Double = js.native
  /* 1 */ val rollup: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextScrollMode.rollup with Double = js.native
  @JSBracketAccess
