...
object PosPrinterColorCapabilities extends js.Object {
  ...
  /* 2 */ val custom1: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom1 with Double = js.native
  /* 3 */ val custom2: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom2 with Double = js.native
  /* 4 */ val custom3: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom3 with Double = js.native
  /* 5 */ val custom4: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom4 with Double = js.native
  /* 6 */ val custom5: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom5 with Double = js.native
  /* 7 */ val custom6: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.custom6 with Double = js.native
  /* 8 */ val cyan: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.cyan with Double = js.native
  /* 11 */ val full: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.full with Double = js.native
  /* 9 */ val magenta: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.magenta with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.none with Double = js.native
  /* 1 */ val primary: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.primary with Double = js.native
  /* 10 */ val yellow: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities.yellow with Double = js.native
  @JSBracketAccess
