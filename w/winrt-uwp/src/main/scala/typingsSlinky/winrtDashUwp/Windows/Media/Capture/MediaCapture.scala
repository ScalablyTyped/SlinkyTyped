...
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.AudioDeviceController
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.CameraStreamState
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.MediaCapturePauseBehavior
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.VideoDeviceController
...
import typingsSlinky.winrtDashUwp.Windows.Media.IMediaExtension
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.IMediaEncodingProperties
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.ImageEncodingProperties
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaEncodingProfile
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaPropertySet
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.camerastreamstatechanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.failed
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.focuschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.photoconfirmationcaptured
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.recordlimitationexceeded
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.thermalstatuschanged
