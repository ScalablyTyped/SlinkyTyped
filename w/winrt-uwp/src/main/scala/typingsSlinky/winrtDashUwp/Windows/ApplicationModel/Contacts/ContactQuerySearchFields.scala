...
object ContactQuerySearchFields extends js.Object {
  ...
  /* 4 */ val all: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields.all with Double = js.native
  /* 2 */ val email: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields.email with Double = js.native
  /* 1 */ val name: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields.name with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields.none with Double = js.native
  /* 3 */ val phone: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields.phone with Double = js.native
  @JSBracketAccess
