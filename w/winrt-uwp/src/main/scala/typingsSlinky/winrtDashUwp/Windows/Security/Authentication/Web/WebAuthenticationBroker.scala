...
object WebAuthenticationBroker extends js.Object {
  ...
  /**
    ...
    */
  def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri): IPromiseWithIAsyncOperation[WebAuthenticationResult] = js.native
  /**
    ...
    * @return The way to query the status and get the results of the authentication operation. If you are getting an invalid parameter error, the most common cause is that you are not using HTTPS for the requestUri parameter.
    */
  def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri, callbackUri: Uri): IPromiseWithIAsyncOperation[WebAuthenticationResult] = js.native
  /**
    ...
    * @return The way to query the status and get the results of the authentication operation. If you are getting an invalid parameter error, the most common cause is that you are not using HTTPS for the requestUri parameter.
    */
  def authenticateSilentlyAsync(requestUri: Uri): IPromiseWithIAsyncOperation[WebAuthenticationResult] = js.native
  /**
    ...
    * @return The way to query the status and get the results of the authentication operation. If you are getting an invalid parameter error, the most common cause is that you are not using HTTPS for the requestUri parameter.
    */
  def authenticateSilentlyAsync(requestUri: Uri, options: WebAuthenticationOptions): IPromiseWithIAsyncOperation[WebAuthenticationResult] = js.native
  /**
