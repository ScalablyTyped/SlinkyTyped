...
object MarkerAlignment extends js.Object {
  ...
  /* 2 */ val center: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerAlignment.center with Double = js.native
  /* 1 */ val left: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerAlignment.left with Double = js.native
  /* 3 */ val right: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerAlignment.right with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerAlignment.undefined with Double = js.native
  @JSBracketAccess
