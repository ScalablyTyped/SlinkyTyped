...
object MediaPlayerAudioDeviceType extends js.Object {
  ...
  /* 2 */ val communications: typingsSlinky.winrtDashUwp.Windows.Media.Playback.MediaPlayerAudioDeviceType.communications with Double = js.native
  /* 0 */ val console: typingsSlinky.winrtDashUwp.Windows.Media.Playback.MediaPlayerAudioDeviceType.console with Double = js.native
  /* 1 */ val multimedia: typingsSlinky.winrtDashUwp.Windows.Media.Playback.MediaPlayerAudioDeviceType.multimedia with Double = js.native
  @JSBracketAccess
