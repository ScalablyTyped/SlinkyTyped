package typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking
...
object PenTipShape extends js.Object {
  ...
  /* 0 */ val circle: typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking.PenTipShape.circle with Double = js.native
  /* 1 */ val rectangle: typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking.PenTipShape.rectangle with Double = js.native
  @JSBracketAccess
