...
object BackgroundTransferPriority extends js.Object {
  ...
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.default with Double = js.native
  /* 1 */ val high: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.high with Double = js.native
  @JSBracketAccess
