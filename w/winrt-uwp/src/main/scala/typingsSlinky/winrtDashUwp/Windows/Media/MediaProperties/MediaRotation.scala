...
object MediaRotation extends js.Object {
  ...
  /* 2 */ val clockwise180Degrees: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation.clockwise180Degrees with Double = js.native
  /* 3 */ val clockwise270Degrees: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation.clockwise270Degrees with Double = js.native
  /* 1 */ val clockwise90Degrees: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation.clockwise90Degrees with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation.none with Double = js.native
  @JSBracketAccess
