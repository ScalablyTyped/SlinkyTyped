...
object PosPrinterAlignment extends js.Object {
  ...
  /* 1 */ val center: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterAlignment.center with Double = js.native
  /* 0 */ val left: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterAlignment.left with Double = js.native
  /* 2 */ val right: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterAlignment.right with Double = js.native
  @JSBracketAccess
