...
object CellularClass extends js.Object {
  ...
  /* 2 */ val cdma: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.CellularClass.cdma with Double = js.native
  /* 1 */ val gsm: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.CellularClass.gsm with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.CellularClass.none with Double = js.native
  @JSBracketAccess
