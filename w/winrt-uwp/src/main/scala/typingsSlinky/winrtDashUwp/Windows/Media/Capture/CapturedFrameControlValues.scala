...
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.CaptureSceneMode
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.MediaCaptureFocusState
