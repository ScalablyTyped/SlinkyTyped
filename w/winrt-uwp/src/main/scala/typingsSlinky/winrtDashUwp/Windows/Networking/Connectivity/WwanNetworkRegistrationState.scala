...
object WwanNetworkRegistrationState extends js.Object {
  ...
  /* 6 */ val denied: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.denied with Double = js.native
  /* 1 */ val deregistered: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.deregistered with Double = js.native
  /* 3 */ val home: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.home with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.none with Double = js.native
  /* 5 */ val partner: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.partner with Double = js.native
  /* 4 */ val roaming: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.roaming with Double = js.native
  /* 2 */ val searching: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.WwanNetworkRegistrationState.searching with Double = js.native
  @JSBracketAccess
