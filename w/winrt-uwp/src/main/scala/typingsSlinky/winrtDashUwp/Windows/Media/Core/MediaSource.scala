...
import typingsSlinky.winrtDashUwp.Windows.Foundation.Collections.IObservableVector
...
import typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSource
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.openoperationcompleted
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.statechanged
