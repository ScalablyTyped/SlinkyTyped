...
object ChatItemKind extends js.Object {
  ...
  /* 1 */ val conversation: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatItemKind.conversation with Double = js.native
  /* 0 */ val message: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatItemKind.message with Double = js.native
  @JSBracketAccess
