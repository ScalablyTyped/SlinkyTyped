...
object VpnDomainNameType extends js.Object {
  ...
  /* 1 */ val fullyQualified: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnDomainNameType.fullyQualified with Double = js.native
  /* 2 */ val reserved: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnDomainNameType.reserved with Double = js.native
  /* 0 */ val suffix: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnDomainNameType.suffix with Double = js.native
  @JSBracketAccess
