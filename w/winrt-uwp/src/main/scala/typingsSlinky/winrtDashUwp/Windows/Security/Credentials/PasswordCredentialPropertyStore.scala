...
import typingsSlinky.winrtDashUwp.Windows.Foundation.Collections.IMapChangedEventArgs
import typingsSlinky.winrtDashUwp.Windows.Foundation.Collections.IObservableMap
import typingsSlinky.winrtDashUwp.Windows.Foundation.Collections.MapChangedEventHandler
import typingsSlinky.winrtDashUwp.Windows.Foundation.EventHandler
import typingsSlinky.winrtDashUwp.Windows.WinRTEvent
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.mapchanged
