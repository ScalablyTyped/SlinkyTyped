...
object MobileBroadbandRadioState extends js.Object {
  ...
  /* 0 */ val off: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState.off with Double = js.native
  /* 1 */ val on: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState.on with Double = js.native
  @JSBracketAccess
