...
object GeoshapeType extends js.Object {
  ...
  /* 3 */ val geoboundingBox: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.GeoshapeType.geoboundingBox with Double = js.native
  /* 1 */ val geocircle: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.GeoshapeType.geocircle with Double = js.native
  /* 2 */ val geopath: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.GeoshapeType.geopath with Double = js.native
  /* 0 */ val geopoint: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.GeoshapeType.geopoint with Double = js.native
  @JSBracketAccess
