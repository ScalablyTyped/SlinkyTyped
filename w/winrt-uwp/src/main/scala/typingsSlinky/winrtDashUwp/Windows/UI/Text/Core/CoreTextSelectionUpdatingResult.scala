...
object CoreTextSelectionUpdatingResult extends js.Object {
  ...
  /* 1 */ val failed: typingsSlinky.winrtDashUwp.Windows.UI.Text.Core.CoreTextSelectionUpdatingResult.failed with Double = js.native
  /* 0 */ val succeeded: typingsSlinky.winrtDashUwp.Windows.UI.Text.Core.CoreTextSelectionUpdatingResult.succeeded with Double = js.native
  @JSBracketAccess
