...
object CausalitySource extends js.Object {
  ...
  /* 0 */ val application: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalitySource.application with Double = js.native
  /* 1 */ val library: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalitySource.library with Double = js.native
  /* 2 */ val system: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalitySource.system with Double = js.native
  @JSBracketAccess
