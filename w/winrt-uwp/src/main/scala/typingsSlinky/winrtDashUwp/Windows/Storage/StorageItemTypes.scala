...
object StorageItemTypes extends js.Object {
  ...
  /* 1 */ val file: typingsSlinky.winrtDashUwp.Windows.Storage.StorageItemTypes.file with Double = js.native
  /* 2 */ val folder: typingsSlinky.winrtDashUwp.Windows.Storage.StorageItemTypes.folder with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Storage.StorageItemTypes.none with Double = js.native
  @JSBracketAccess
