...
object TetheringOperationalState extends js.Object {
  ...
  /* 3 */ val inTransition: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.TetheringOperationalState.inTransition with Double = js.native
  /* 2 */ val off: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.TetheringOperationalState.off with Double = js.native
  /* 1 */ val on: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.TetheringOperationalState.on with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.TetheringOperationalState.unknown with Double = js.native
  @JSBracketAccess
