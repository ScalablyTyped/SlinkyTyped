...
object ContactSelectionMode extends js.Object {
  ...
  /* 0 */ val contacts: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode.contacts with Double = js.native
  /* 1 */ val fields: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode.fields with Double = js.native
  @JSBracketAccess
