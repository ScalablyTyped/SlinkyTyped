...
import typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherStatus
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.sourceadded
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.sourceremoved
