...
object HoldingState extends js.Object {
  ...
  /* 2 */ val canceled: typingsSlinky.winrtDashUwp.Windows.UI.Input.HoldingState.canceled with Double = js.native
  /* 1 */ val completed: typingsSlinky.winrtDashUwp.Windows.UI.Input.HoldingState.completed with Double = js.native
  /* 0 */ val started: typingsSlinky.winrtDashUwp.Windows.UI.Input.HoldingState.started with Double = js.native
  @JSBracketAccess
