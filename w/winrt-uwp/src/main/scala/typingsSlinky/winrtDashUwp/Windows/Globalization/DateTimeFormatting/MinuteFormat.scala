...
object MinuteFormat extends js.Object {
  ...
  /* 1 */ val default: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MinuteFormat.default with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MinuteFormat.none with Double = js.native
  @JSBracketAccess
