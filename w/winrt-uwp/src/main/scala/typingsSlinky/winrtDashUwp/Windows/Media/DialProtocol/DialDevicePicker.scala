...
import typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DevicePickerAppearance
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.dialdevicepickerdismissed
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.dialdeviceselected
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.disconnectbuttonclicked
