...
object WalletSummaryViewPosition extends js.Object {
  ...
  /* 1 */ val field1: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition.field1 with Double = js.native
  /* 2 */ val field2: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition.field2 with Double = js.native
  /* 0 */ val hidden: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition.hidden with Double = js.native
  @JSBracketAccess
