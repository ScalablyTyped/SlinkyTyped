...
object Print3DTaskCompletion extends js.Object {
  ...
  /* 0 */ val abandoned: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.abandoned with Double = js.native
  /* 1 */ val canceled: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.canceled with Double = js.native
  /* 2 */ val failed: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.failed with Double = js.native
  /* 3 */ val slicing: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.slicing with Double = js.native
  /* 4 */ val submitted: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.submitted with Double = js.native
  @JSBracketAccess
