...
object PowerlineFrequency extends js.Object {
  ...
  /* 0 */ val disabled: typingsSlinky.winrtDashUwp.Windows.Media.Capture.PowerlineFrequency.disabled with Double = js.native
  /* 1 */ val fiftyHertz: typingsSlinky.winrtDashUwp.Windows.Media.Capture.PowerlineFrequency.fiftyHertz with Double = js.native
  /* 2 */ val sixtyHertz: typingsSlinky.winrtDashUwp.Windows.Media.Capture.PowerlineFrequency.sixtyHertz with Double = js.native
  @JSBracketAccess
