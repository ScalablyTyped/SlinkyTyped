...
object ImageScannerAutoCroppingMode extends js.Object {
  ...
  /* 0 */ val disabled: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.disabled with Double = js.native
  /* 2 */ val multipleRegion: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.multipleRegion with Double = js.native
  /* 1 */ val singleRegion: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.singleRegion with Double = js.native
  @JSBracketAccess
