package typingsSlinky.winrtDashUwp.Windows.Web.Http.Headers

import typingsSlinky.std.Array
import typingsSlinky.winrtDashUwp.Anon_Index
import typingsSlinky.winrtDashUwp.Anon_ItemsReturnValueHttpProductInfoHeaderValue
...
abstract class HttpProductInfoHeaderValueCollection () extends Array[HttpProductInfoHeaderValue] {
  ...
  /**
    ...
    */
  def getMany(startIndex: Double): Anon_ItemsReturnValueHttpProductInfoHeaderValue = js.native
  /**
  ...
  def indexOf(value: HttpProductInfoHeaderValue, extra: js.Any*): Anon_Index = js.native
  /**
    ...
    */
  @JSName("indexOf")
  def indexOf_Anon_Index(value: HttpProductInfoHeaderValue): Anon_Index = js.native
  /**
