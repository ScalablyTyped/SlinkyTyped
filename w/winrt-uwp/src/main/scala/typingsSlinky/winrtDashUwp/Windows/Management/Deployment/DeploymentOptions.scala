...
object DeploymentOptions extends js.Object {
  ...
  /* 2 */ val developmentMode: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.DeploymentOptions.developmentMode with Double = js.native
  /* 1 */ val forceApplicationShutdown: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.DeploymentOptions.forceApplicationShutdown with Double = js.native
  /* 4 */ val forceTargetApplicationShutdown: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.DeploymentOptions.forceTargetApplicationShutdown with Double = js.native
  /* 3 */ val installAllResources: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.DeploymentOptions.installAllResources with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.DeploymentOptions.none with Double = js.native
  @JSBracketAccess
