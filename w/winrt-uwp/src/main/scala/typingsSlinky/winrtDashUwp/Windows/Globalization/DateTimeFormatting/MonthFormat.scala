...
object MonthFormat extends js.Object {
  ...
  /* 2 */ val abbreviated: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MonthFormat.abbreviated with Double = js.native
  /* 1 */ val default: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MonthFormat.default with Double = js.native
  /* 3 */ val full: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MonthFormat.full with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MonthFormat.none with Double = js.native
  /* 4 */ val numeric: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MonthFormat.numeric with Double = js.native
  @JSBracketAccess
