...
object SerialError extends js.Object {
  ...
  /* 1 */ val bufferOverrun: typingsSlinky.winrtDashUwp.Windows.Devices.SerialCommunication.SerialError.bufferOverrun with Double = js.native
  /* 0 */ val frame: typingsSlinky.winrtDashUwp.Windows.Devices.SerialCommunication.SerialError.frame with Double = js.native
  /* 2 */ val receiveFull: typingsSlinky.winrtDashUwp.Windows.Devices.SerialCommunication.SerialError.receiveFull with Double = js.native
  /* 3 */ val receiveParity: typingsSlinky.winrtDashUwp.Windows.Devices.SerialCommunication.SerialError.receiveParity with Double = js.native
  /* 4 */ val transmitFull: typingsSlinky.winrtDashUwp.Windows.Devices.SerialCommunication.SerialError.transmitFull with Double = js.native
  @JSBracketAccess
