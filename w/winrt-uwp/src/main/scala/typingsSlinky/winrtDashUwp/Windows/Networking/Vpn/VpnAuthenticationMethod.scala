...
object VpnAuthenticationMethod extends js.Object {
  ...
  /* 2 */ val certificate: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnAuthenticationMethod.certificate with Double = js.native
  /* 1 */ val eap: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnAuthenticationMethod.eap with Double = js.native
  /* 0 */ val mschapv2: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnAuthenticationMethod.mschapv2 with Double = js.native
  /* 3 */ val presharedKey: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnAuthenticationMethod.presharedKey with Double = js.native
  @JSBracketAccess
