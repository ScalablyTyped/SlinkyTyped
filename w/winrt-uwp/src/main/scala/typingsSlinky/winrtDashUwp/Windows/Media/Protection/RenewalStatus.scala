...
object RenewalStatus extends js.Object {
  ...
  /* 3 */ val appComponentsMayNeedUpdating: typingsSlinky.winrtDashUwp.Windows.Media.Protection.RenewalStatus.appComponentsMayNeedUpdating with Double = js.native
  /* 4 */ val noComponentsFound: typingsSlinky.winrtDashUwp.Windows.Media.Protection.RenewalStatus.noComponentsFound with Double = js.native
  /* 0 */ val notStarted: typingsSlinky.winrtDashUwp.Windows.Media.Protection.RenewalStatus.notStarted with Double = js.native
  /* 1 */ val updatesInProgress: typingsSlinky.winrtDashUwp.Windows.Media.Protection.RenewalStatus.updatesInProgress with Double = js.native
  /* 2 */ val userCancelled: typingsSlinky.winrtDashUwp.Windows.Media.Protection.RenewalStatus.userCancelled with Double = js.native
  @JSBracketAccess
