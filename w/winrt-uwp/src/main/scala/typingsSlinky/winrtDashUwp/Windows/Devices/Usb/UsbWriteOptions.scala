...
object UsbWriteOptions extends js.Object {
  ...
  /* 1 */ val autoClearStall: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbWriteOptions.autoClearStall with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbWriteOptions.none with Double = js.native
  /* 2 */ val shortPacketTerminate: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbWriteOptions.shortPacketTerminate with Double = js.native
  @JSBracketAccess
