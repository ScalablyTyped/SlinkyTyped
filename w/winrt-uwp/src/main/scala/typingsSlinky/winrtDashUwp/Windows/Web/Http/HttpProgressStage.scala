...
object HttpProgressStage extends js.Object {
  ...
  /* 3 */ val connectingToServer: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.connectingToServer with Double = js.native
  /* 1 */ val detectingProxy: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.detectingProxy with Double = js.native
  /* 4 */ val negotiatingSsl: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.negotiatingSsl with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.none with Double = js.native
  /* 9 */ val receivingContent: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.receivingContent with Double = js.native
  /* 8 */ val receivingHeaders: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.receivingHeaders with Double = js.native
  /* 2 */ val resolvingName: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.resolvingName with Double = js.native
  /* 6 */ val sendingContent: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.sendingContent with Double = js.native
  /* 5 */ val sendingHeaders: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.sendingHeaders with Double = js.native
  /* 7 */ val waitingForResponse: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpProgressStage.waitingForResponse with Double = js.native
  @JSBracketAccess
