...
object EmailMailboxSmimeSigningAlgorithm extends js.Object {
  ...
  /* 0 */ val any: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm.any with Double = js.native
  /* 2 */ val md5: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm.md5 with Double = js.native
  /* 1 */ val sha1: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm.sha1 with Double = js.native
  @JSBracketAccess
