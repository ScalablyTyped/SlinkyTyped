...
object WiFiDirectServiceAdvertisementStatus extends js.Object {
  ...
  /* 3 */ val aborted: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.aborted with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.created with Double = js.native
  /* 1 */ val started: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.started with Double = js.native
  /* 2 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.stopped with Double = js.native
  @JSBracketAccess
