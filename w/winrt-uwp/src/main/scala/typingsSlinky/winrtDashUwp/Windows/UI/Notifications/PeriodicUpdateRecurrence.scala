...
object PeriodicUpdateRecurrence extends js.Object {
  ...
  /* 4 */ val daily: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.PeriodicUpdateRecurrence.daily with Double = js.native
  /* 0 */ val halfHour: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.PeriodicUpdateRecurrence.halfHour with Double = js.native
  /* 1 */ val hour: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.PeriodicUpdateRecurrence.hour with Double = js.native
  /* 2 */ val sixHours: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.PeriodicUpdateRecurrence.sixHours with Double = js.native
  /* 3 */ val twelveHours: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.PeriodicUpdateRecurrence.twelveHours with Double = js.native
  @JSBracketAccess
