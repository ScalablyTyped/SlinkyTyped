...
object ApplicationViewOrientation extends js.Object {
  ...
  /* 0 */ val landscape: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewOrientation.landscape with Double = js.native
  /* 1 */ val portrait: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewOrientation.portrait with Double = js.native
  @JSBracketAccess
