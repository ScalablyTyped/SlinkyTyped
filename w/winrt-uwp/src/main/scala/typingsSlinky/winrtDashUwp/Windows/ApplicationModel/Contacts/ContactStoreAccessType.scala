...
object ContactStoreAccessType extends js.Object {
  ...
  /* 1 */ val allContactsReadOnly: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactStoreAccessType.allContactsReadOnly with Double = js.native
  /* 2 */ val allContactsReadWrite: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactStoreAccessType.allContactsReadWrite with Double = js.native
  /* 0 */ val appContactsReadWrite: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactStoreAccessType.appContactsReadWrite with Double = js.native
  @JSBracketAccess
