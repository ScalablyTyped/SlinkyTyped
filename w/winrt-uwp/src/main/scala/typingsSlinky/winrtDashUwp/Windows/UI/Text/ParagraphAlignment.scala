...
object ParagraphAlignment extends js.Object {
  ...
  /* 2 */ val center: typingsSlinky.winrtDashUwp.Windows.UI.Text.ParagraphAlignment.center with Double = js.native
  /* 4 */ val justify: typingsSlinky.winrtDashUwp.Windows.UI.Text.ParagraphAlignment.justify with Double = js.native
  /* 1 */ val left: typingsSlinky.winrtDashUwp.Windows.UI.Text.ParagraphAlignment.left with Double = js.native
  /* 3 */ val right: typingsSlinky.winrtDashUwp.Windows.UI.Text.ParagraphAlignment.right with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.ParagraphAlignment.undefined with Double = js.native
  @JSBracketAccess
