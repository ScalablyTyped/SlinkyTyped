...
import typingsSlinky.winrtDashUwp.Windows.Media.Core.AudioStreamDescriptor
import typingsSlinky.winrtDashUwp.Windows.Media.Core.IMediaStreamDescriptor
import typingsSlinky.winrtDashUwp.Windows.Media.Core.MediaStreamSample
import typingsSlinky.winrtDashUwp.Windows.Media.Core.VideoStreamDescriptor
