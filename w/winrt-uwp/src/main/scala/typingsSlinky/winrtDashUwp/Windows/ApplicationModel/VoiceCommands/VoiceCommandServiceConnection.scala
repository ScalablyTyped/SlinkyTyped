...
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.AppService.AppServiceTriggerDetails
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.voicecommandcompleted
