...
object AllJoynTrafficType extends js.Object {
  ...
  /* 1 */ val messages: typingsSlinky.winrtDashUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.messages with Double = js.native
  /* 3 */ val rawReliable: typingsSlinky.winrtDashUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.rawReliable with Double = js.native
  /* 2 */ val rawUnreliable: typingsSlinky.winrtDashUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.rawUnreliable with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.unknown with Double = js.native
  @JSBracketAccess
