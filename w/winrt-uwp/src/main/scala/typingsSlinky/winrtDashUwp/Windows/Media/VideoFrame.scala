...
import typingsSlinky.winrtDashUwp.Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface
import typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapAlphaMode
import typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat
