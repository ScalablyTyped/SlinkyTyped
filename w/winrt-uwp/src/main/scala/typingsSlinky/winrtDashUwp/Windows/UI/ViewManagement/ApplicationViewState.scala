...
object ApplicationViewState extends js.Object {
  ...
  /* 1 */ val filled: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewState.filled with Double = js.native
  /* 0 */ val fullScreenLandscape: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewState.fullScreenLandscape with Double = js.native
  /* 3 */ val fullScreenPortrait: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewState.fullScreenPortrait with Double = js.native
  /* 2 */ val snapped: typingsSlinky.winrtDashUwp.Windows.UI.ViewManagement.ApplicationViewState.snapped with Double = js.native
  @JSBracketAccess
