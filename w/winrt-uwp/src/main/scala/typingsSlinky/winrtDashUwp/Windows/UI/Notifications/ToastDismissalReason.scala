...
object ToastDismissalReason extends js.Object {
  ...
  /* 1 */ val applicationHidden: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastDismissalReason.applicationHidden with Double = js.native
  /* 2 */ val timedOut: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastDismissalReason.timedOut with Double = js.native
  /* 0 */ val userCanceled: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastDismissalReason.userCanceled with Double = js.native
  @JSBracketAccess
