...
object MobileBroadbandDeviceType extends js.Object {
  ...
  /* 1 */ val embedded: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType.embedded with Double = js.native
  /* 3 */ val remote: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType.remote with Double = js.native
  /* 2 */ val removable: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType.removable with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType.unknown with Double = js.native
  @JSBracketAccess
