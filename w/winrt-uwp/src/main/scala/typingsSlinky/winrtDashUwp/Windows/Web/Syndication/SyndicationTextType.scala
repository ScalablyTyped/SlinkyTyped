...
object SyndicationTextType extends js.Object {
  ...
  /* 1 */ val html: typingsSlinky.winrtDashUwp.Windows.Web.Syndication.SyndicationTextType.html with Double = js.native
  /* 0 */ val text: typingsSlinky.winrtDashUwp.Windows.Web.Syndication.SyndicationTextType.text with Double = js.native
  /* 2 */ val xhtml: typingsSlinky.winrtDashUwp.Windows.Web.Syndication.SyndicationTextType.xhtml with Double = js.native
  @JSBracketAccess
