...
object HdrVideoMode extends js.Object {
  ...
  /* 2 */ val auto: typingsSlinky.winrtDashUwp.Windows.Media.Devices.HdrVideoMode.auto with Double = js.native
  /* 0 */ val off: typingsSlinky.winrtDashUwp.Windows.Media.Devices.HdrVideoMode.off with Double = js.native
  /* 1 */ val on: typingsSlinky.winrtDashUwp.Windows.Media.Devices.HdrVideoMode.on with Double = js.native
  @JSBracketAccess
