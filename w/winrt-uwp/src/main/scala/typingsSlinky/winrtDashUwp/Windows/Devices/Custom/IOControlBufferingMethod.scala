...
object IOControlBufferingMethod extends js.Object {
  ...
  /* 0 */ val buffered: typingsSlinky.winrtDashUwp.Windows.Devices.Custom.IOControlBufferingMethod.buffered with Double = js.native
  /* 1 */ val directInput: typingsSlinky.winrtDashUwp.Windows.Devices.Custom.IOControlBufferingMethod.directInput with Double = js.native
  /* 2 */ val directOutput: typingsSlinky.winrtDashUwp.Windows.Devices.Custom.IOControlBufferingMethod.directOutput with Double = js.native
  /* 3 */ val neither: typingsSlinky.winrtDashUwp.Windows.Devices.Custom.IOControlBufferingMethod.neither with Double = js.native
  @JSBracketAccess
