...
object ContactDateKind extends js.Object {
  ...
  /* 1 */ val anniversary: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactDateKind.anniversary with Double = js.native
  /* 0 */ val birthday: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactDateKind.birthday with Double = js.native
  /* 2 */ val other: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactDateKind.other with Double = js.native
  @JSBracketAccess
