...
object HttpCacheWriteBehavior extends js.Object {
  ...
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior.default with Double = js.native
  /* 1 */ val noCache: typingsSlinky.winrtDashUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior.noCache with Double = js.native
  @JSBracketAccess
