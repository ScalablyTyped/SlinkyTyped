...
object WiFiDirectPairingProcedure extends js.Object {
  ...
  /* 0 */ val groupOwnerNegotiation: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure.groupOwnerNegotiation with Double = js.native
  /* 1 */ val invitation: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure.invitation with Double = js.native
  @JSBracketAccess
