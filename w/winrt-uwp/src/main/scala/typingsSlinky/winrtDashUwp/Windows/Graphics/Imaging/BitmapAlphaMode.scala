...
object BitmapAlphaMode extends js.Object {
  ...
  /* 2 */ val ignore: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapAlphaMode.ignore with Double = js.native
  /* 0 */ val premultiplied: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapAlphaMode.premultiplied with Double = js.native
  /* 1 */ val straight: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapAlphaMode.straight with Double = js.native
  @JSBracketAccess
