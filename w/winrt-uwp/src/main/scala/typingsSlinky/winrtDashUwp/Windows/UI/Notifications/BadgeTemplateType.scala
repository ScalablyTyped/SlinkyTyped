package typingsSlinky.winrtDashUwp.Windows.UI.Notifications
...
object BadgeTemplateType extends js.Object {
  ...
  /* 0 */ val badgeGlyph: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.BadgeTemplateType.badgeGlyph with Double = js.native
  /* 1 */ val badgeNumber: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.BadgeTemplateType.badgeNumber with Double = js.native
  @JSBracketAccess
