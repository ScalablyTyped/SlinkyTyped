...
object CreationCollisionOption extends js.Object {
  ...
  /* 2 */ val failIfExists: typingsSlinky.winrtDashUwp.Windows.Storage.CreationCollisionOption.failIfExists with Double = js.native
  /* 0 */ val generateUniqueName: typingsSlinky.winrtDashUwp.Windows.Storage.CreationCollisionOption.generateUniqueName with Double = js.native
  /* 3 */ val openIfExists: typingsSlinky.winrtDashUwp.Windows.Storage.CreationCollisionOption.openIfExists with Double = js.native
  /* 1 */ val replaceExisting: typingsSlinky.winrtDashUwp.Windows.Storage.CreationCollisionOption.replaceExisting with Double = js.native
  @JSBracketAccess
