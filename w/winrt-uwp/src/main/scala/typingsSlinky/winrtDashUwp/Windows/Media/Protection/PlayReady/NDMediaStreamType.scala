...
object NDMediaStreamType extends js.Object {
  ...
  /* 0 */ val audio: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDMediaStreamType.audio with Double = js.native
  /* 1 */ val video: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDMediaStreamType.video with Double = js.native
  @JSBracketAccess
