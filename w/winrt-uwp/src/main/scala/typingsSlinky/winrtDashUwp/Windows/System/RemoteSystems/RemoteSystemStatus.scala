...
object RemoteSystemStatus extends js.Object {
  ...
  /* 2 */ val available: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatus.available with Double = js.native
  /* 1 */ val discoveringAvailability: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatus.discoveringAvailability with Double = js.native
  /* 0 */ val unavailable: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatus.unavailable with Double = js.native
  /* 3 */ val unknown: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatus.unknown with Double = js.native
  @JSBracketAccess
