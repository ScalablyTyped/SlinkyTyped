...
object CommonFolderQuery extends js.Object {
  ...
  /* 0 */ val defaultQuery: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.defaultQuery with Double = js.native
  /* 4 */ val groupByAlbum: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByAlbum with Double = js.native
  /* 5 */ val groupByAlbumArtist: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByAlbumArtist with Double = js.native
  /* 3 */ val groupByArtist: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByArtist with Double = js.native
  /* 11 */ val groupByAuthor: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByAuthor with Double = js.native
  /* 6 */ val groupByComposer: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByComposer with Double = js.native
  /* 7 */ val groupByGenre: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByGenre with Double = js.native
  /* 2 */ val groupByMonth: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByMonth with Double = js.native
  /* 8 */ val groupByPublishedYear: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByPublishedYear with Double = js.native
  /* 9 */ val groupByRating: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByRating with Double = js.native
  /* 10 */ val groupByTag: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByTag with Double = js.native
  /* 12 */ val groupByType: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByType with Double = js.native
  /* 1 */ val groupByYear: typingsSlinky.winrtDashUwp.Windows.Storage.Search.CommonFolderQuery.groupByYear with Double = js.native
  @JSBracketAccess
