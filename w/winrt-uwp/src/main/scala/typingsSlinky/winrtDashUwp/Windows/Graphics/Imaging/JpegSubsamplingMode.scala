...
object JpegSubsamplingMode extends js.Object {
  ...
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.default with Double = js.native
  /* 1 */ val y4Cb2Cr0: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb2Cr0 with Double = js.native
  /* 2 */ val y4Cb2Cr2: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb2Cr2 with Double = js.native
  /* 3 */ val y4Cb4Cr4: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb4Cr4 with Double = js.native
  @JSBracketAccess
