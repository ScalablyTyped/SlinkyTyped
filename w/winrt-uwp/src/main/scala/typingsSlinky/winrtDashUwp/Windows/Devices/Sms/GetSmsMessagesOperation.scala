...
import typingsSlinky.winrtDashUwp.Windows.Foundation.AsyncOperationProgressHandler
import typingsSlinky.winrtDashUwp.Windows.Foundation.AsyncOperationWithProgressCompletedHandler
...
import typingsSlinky.winrtDashUwp.Windows.Foundation.IAsyncOperationWithProgress
