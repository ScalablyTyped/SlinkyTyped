...
object KeyCredentialAttestationStatus extends js.Object {
  ...
  /* 2 */ val notSupported: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.KeyCredentialAttestationStatus.notSupported with Double = js.native
  /* 0 */ val success: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.KeyCredentialAttestationStatus.success with Double = js.native
  /* 3 */ val temporaryFailure: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.KeyCredentialAttestationStatus.temporaryFailure with Double = js.native
  /* 1 */ val unknownError: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.KeyCredentialAttestationStatus.unknownError with Double = js.native
  @JSBracketAccess
