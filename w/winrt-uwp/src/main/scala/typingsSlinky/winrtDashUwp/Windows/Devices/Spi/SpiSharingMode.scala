...
object SpiSharingMode extends js.Object {
  ...
  /* 0 */ val exclusive: typingsSlinky.winrtDashUwp.Windows.Devices.Spi.SpiSharingMode.exclusive with Double = js.native
  /* 1 */ val shared: typingsSlinky.winrtDashUwp.Windows.Devices.Spi.SpiSharingMode.shared with Double = js.native
  @JSBracketAccess
