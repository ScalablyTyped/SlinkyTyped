...
object WiFiDirectAdvertisementPublisherStatus extends js.Object {
  ...
  /* 3 */ val aborted: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.aborted with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.created with Double = js.native
  /* 1 */ val started: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.started with Double = js.native
  /* 2 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.stopped with Double = js.native
  @JSBracketAccess
