...
object TextGetOptions extends js.Object {
  ...
  /* 1 */ val adjustCrlf: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.adjustCrlf with Double = js.native
  /* 4 */ val allowFinalEop: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.allowFinalEop with Double = js.native
  /* 7 */ val formatRtf: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.formatRtf with Double = js.native
  /* 6 */ val includeNumbering: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.includeNumbering with Double = js.native
  /* 5 */ val noHidden: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.noHidden with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.none with Double = js.native
  /* 2 */ val useCrlf: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.useCrlf with Double = js.native
  /* 3 */ val useObjectText: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextGetOptions.useObjectText with Double = js.native
  @JSBracketAccess
