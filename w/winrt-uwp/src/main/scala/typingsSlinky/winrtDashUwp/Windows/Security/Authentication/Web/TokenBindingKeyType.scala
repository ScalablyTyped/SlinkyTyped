...
object TokenBindingKeyType extends js.Object {
  ...
  /* 1 */ val ecdsaP256: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.ecdsaP256 with Double = js.native
  /* 0 */ val rsa2048: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.rsa2048 with Double = js.native
  @JSBracketAccess
