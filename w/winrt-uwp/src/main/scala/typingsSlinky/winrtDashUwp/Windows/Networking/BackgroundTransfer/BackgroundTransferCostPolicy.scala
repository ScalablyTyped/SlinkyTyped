...
object BackgroundTransferCostPolicy extends js.Object {
  ...
  /* 2 */ val always: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.always with Double = js.native
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.default with Double = js.native
  /* 1 */ val unrestrictedOnly: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.unrestrictedOnly with Double = js.native
  @JSBracketAccess
