...
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaMirroringOptions
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation
