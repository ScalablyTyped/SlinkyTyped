...
object PhoneCallHistoryEntryMedia extends js.Object {
  ...
  /* 0 */ val audio: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.audio with Double = js.native
  /* 1 */ val video: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.video with Double = js.native
  @JSBracketAccess
