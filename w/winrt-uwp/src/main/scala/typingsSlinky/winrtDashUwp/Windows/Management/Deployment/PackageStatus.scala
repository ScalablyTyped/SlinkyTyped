...
object PackageStatus extends js.Object {
  ...
  /* 4 */ val disabled: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageStatus.disabled with Double = js.native
  /* 1 */ val licenseIssue: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageStatus.licenseIssue with Double = js.native
  /* 2 */ val modified: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageStatus.modified with Double = js.native
  /* 0 */ val ok: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageStatus.ok with Double = js.native
  /* 3 */ val tampered: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageStatus.tampered with Double = js.native
  @JSBracketAccess
