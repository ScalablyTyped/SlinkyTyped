...
object MediaMirroringOptions extends js.Object {
  ...
  /* 1 */ val horizontal: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaMirroringOptions.horizontal with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaMirroringOptions.none with Double = js.native
  /* 2 */ val vertical: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.MediaMirroringOptions.vertical with Double = js.native
  @JSBracketAccess
