...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.quantumprocessed
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.quantumstarted
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.unrecoverableerroroccurred
