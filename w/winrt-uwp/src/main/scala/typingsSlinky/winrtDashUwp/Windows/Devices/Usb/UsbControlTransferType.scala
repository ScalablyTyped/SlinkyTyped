...
object UsbControlTransferType extends js.Object {
  ...
  /* 1 */ val `class`: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbControlTransferType.`class` with Double = js.native
  /* 0 */ val standard: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbControlTransferType.standard with Double = js.native
  /* 2 */ val vendor: typingsSlinky.winrtDashUwp.Windows.Devices.Usb.UsbControlTransferType.vendor with Double = js.native
  @JSBracketAccess
