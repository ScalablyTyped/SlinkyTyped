...
object AppMemoryUsageLevel extends js.Object {
  ...
  /* 2 */ val high: typingsSlinky.winrtDashUwp.Windows.System.AppMemoryUsageLevel.high with Double = js.native
  /* 0 */ val low: typingsSlinky.winrtDashUwp.Windows.System.AppMemoryUsageLevel.low with Double = js.native
  /* 1 */ val medium: typingsSlinky.winrtDashUwp.Windows.System.AppMemoryUsageLevel.medium with Double = js.native
  @JSBracketAccess
