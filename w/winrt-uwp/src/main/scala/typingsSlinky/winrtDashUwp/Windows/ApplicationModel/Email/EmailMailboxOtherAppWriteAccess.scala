...
object EmailMailboxOtherAppWriteAccess extends js.Object {
  ...
  /* 1 */ val limited: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxOtherAppWriteAccess.limited with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxOtherAppWriteAccess.none with Double = js.native
  @JSBracketAccess
