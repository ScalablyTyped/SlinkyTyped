...
object AppCaptureVideoEncodingBitrateMode extends js.Object {
  ...
  /* 0 */ val custom: typingsSlinky.winrtDashUwp.Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode.custom with Double = js.native
  /* 1 */ val high: typingsSlinky.winrtDashUwp.Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode.high with Double = js.native
  /* 2 */ val standard: typingsSlinky.winrtDashUwp.Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode.standard with Double = js.native
  @JSBracketAccess
