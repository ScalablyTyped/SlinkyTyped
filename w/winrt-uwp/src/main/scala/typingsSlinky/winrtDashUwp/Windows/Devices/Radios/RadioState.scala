...
object RadioState extends js.Object {
  ...
  /* 3 */ val disabled: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioState.disabled with Double = js.native
  /* 2 */ val off: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioState.off with Double = js.native
  /* 1 */ val on: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioState.on with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioState.unknown with Double = js.native
  @JSBracketAccess
