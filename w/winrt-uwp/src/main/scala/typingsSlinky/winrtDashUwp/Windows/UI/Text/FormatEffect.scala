...
object FormatEffect extends js.Object {
  ...
  /* 0 */ val off: typingsSlinky.winrtDashUwp.Windows.UI.Text.FormatEffect.off with Double = js.native
  /* 1 */ val on: typingsSlinky.winrtDashUwp.Windows.UI.Text.FormatEffect.on with Double = js.native
  /* 2 */ val toggle: typingsSlinky.winrtDashUwp.Windows.UI.Text.FormatEffect.toggle with Double = js.native
  /* 3 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.FormatEffect.undefined with Double = js.native
  @JSBracketAccess
