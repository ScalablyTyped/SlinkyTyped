...
object VideoEncodingQuality extends js.Object {
  ...
  /* 0 */ val auto: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.auto with Double = js.native
  /* 1 */ val hd1080p: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.hd1080p with Double = js.native
  /* 2 */ val hd720p: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.hd720p with Double = js.native
  /* 4 */ val ntsc: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.ntsc with Double = js.native
  /* 5 */ val pal: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.pal with Double = js.native
  /* 7 */ val qvga: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.qvga with Double = js.native
  /* 6 */ val vga: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.vga with Double = js.native
  /* 3 */ val wvga: typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.VideoEncodingQuality.wvga with Double = js.native
  @JSBracketAccess
