...
object DialAppStopResult extends js.Object {
  ...
  /* 3 */ val networkFailure: typingsSlinky.winrtDashUwp.Windows.Media.DialProtocol.DialAppStopResult.networkFailure with Double = js.native
  /* 2 */ val operationNotSupported: typingsSlinky.winrtDashUwp.Windows.Media.DialProtocol.DialAppStopResult.operationNotSupported with Double = js.native
  /* 1 */ val stopFailed: typingsSlinky.winrtDashUwp.Windows.Media.DialProtocol.DialAppStopResult.stopFailed with Double = js.native
  /* 0 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Media.DialProtocol.DialAppStopResult.stopped with Double = js.native
  @JSBracketAccess
