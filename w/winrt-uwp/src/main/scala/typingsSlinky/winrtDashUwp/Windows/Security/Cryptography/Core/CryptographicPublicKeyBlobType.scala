...
object CryptographicPublicKeyBlobType extends js.Object {
  ...
  /* 4 */ val bcryptEccFullPublicKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPublicKeyBlobType.bcryptEccFullPublicKey with Double = js.native
  /* 2 */ val bcryptPublicKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPublicKeyBlobType.bcryptPublicKey with Double = js.native
  /* 3 */ val capi1PublicKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPublicKeyBlobType.capi1PublicKey with Double = js.native
  /* 1 */ val pkcs1RsaPublicKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPublicKeyBlobType.pkcs1RsaPublicKey with Double = js.native
  /* 0 */ val x509SubjectPublicKeyInfo: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPublicKeyBlobType.x509SubjectPublicKeyInfo with Double = js.native
  @JSBracketAccess
