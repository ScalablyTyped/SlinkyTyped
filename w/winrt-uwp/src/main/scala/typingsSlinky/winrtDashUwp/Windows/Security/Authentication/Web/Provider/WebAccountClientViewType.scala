...
object WebAccountClientViewType extends js.Object {
  ...
  /* 1 */ val idAndProperties: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType.idAndProperties with Double = js.native
  /* 0 */ val idOnly: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType.idOnly with Double = js.native
  @JSBracketAccess
