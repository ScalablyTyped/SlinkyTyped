...
object TimedTextWeight extends js.Object {
  ...
  /* 1 */ val bold: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWeight.bold with Double = js.native
  /* 0 */ val normal: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWeight.normal with Double = js.native
  @JSBracketAccess
