...
object DateStackOption extends js.Object {
  ...
  /* 2 */ val month: typingsSlinky.winrtDashUwp.Windows.Storage.Search.DateStackOption.month with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Storage.Search.DateStackOption.none with Double = js.native
  /* 1 */ val year: typingsSlinky.winrtDashUwp.Windows.Storage.Search.DateStackOption.year with Double = js.native
  @JSBracketAccess
