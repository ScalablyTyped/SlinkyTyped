...
import typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.TokenBindingKeyType
import typingsSlinky.winrtDashUwp.Windows.Security.Credentials.WebAccount
import typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicKey
