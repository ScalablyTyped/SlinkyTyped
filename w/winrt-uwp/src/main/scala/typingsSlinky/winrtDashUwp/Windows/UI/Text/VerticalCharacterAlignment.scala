...
object VerticalCharacterAlignment extends js.Object {
  ...
  /* 1 */ val baseline: typingsSlinky.winrtDashUwp.Windows.UI.Text.VerticalCharacterAlignment.baseline with Double = js.native
  /* 2 */ val bottom: typingsSlinky.winrtDashUwp.Windows.UI.Text.VerticalCharacterAlignment.bottom with Double = js.native
  /* 0 */ val top: typingsSlinky.winrtDashUwp.Windows.UI.Text.VerticalCharacterAlignment.top with Double = js.native
  @JSBracketAccess
