...
object HostNameType extends js.Object {
  ...
  /* 3 */ val bluetooth: typingsSlinky.winrtDashUwp.Windows.Networking.HostNameType.bluetooth with Double = js.native
  /* 0 */ val domainName: typingsSlinky.winrtDashUwp.Windows.Networking.HostNameType.domainName with Double = js.native
  /* 1 */ val ipv4: typingsSlinky.winrtDashUwp.Windows.Networking.HostNameType.ipv4 with Double = js.native
  /* 2 */ val ipv6: typingsSlinky.winrtDashUwp.Windows.Networking.HostNameType.ipv6 with Double = js.native
  @JSBracketAccess
