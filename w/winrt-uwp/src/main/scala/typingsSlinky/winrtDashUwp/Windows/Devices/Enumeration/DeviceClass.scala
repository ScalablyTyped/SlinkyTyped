...
object DeviceClass extends js.Object {
  ...
  /* 0 */ val all: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.all with Double = js.native
  /* 1 */ val audioCapture: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.audioCapture with Double = js.native
  /* 2 */ val audioRender: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.audioRender with Double = js.native
  /* 5 */ val imageScanner: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.imageScanner with Double = js.native
  /* 6 */ val location: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.location with Double = js.native
  /* 3 */ val portableStorageDevice: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.portableStorageDevice with Double = js.native
  /* 4 */ val videoCapture: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceClass.videoCapture with Double = js.native
  @JSBracketAccess
