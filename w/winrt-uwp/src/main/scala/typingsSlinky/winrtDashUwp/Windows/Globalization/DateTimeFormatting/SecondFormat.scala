...
object SecondFormat extends js.Object {
  ...
  /* 1 */ val default: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.SecondFormat.default with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.SecondFormat.none with Double = js.native
  @JSBracketAccess
