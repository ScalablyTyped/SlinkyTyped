...
object GpioPinValue extends js.Object {
  ...
  /* 1 */ val high: typingsSlinky.winrtDashUwp.Windows.Devices.Gpio.GpioPinValue.high with Double = js.native
  /* 0 */ val low: typingsSlinky.winrtDashUwp.Windows.Devices.Gpio.GpioPinValue.low with Double = js.native
  @JSBracketAccess
