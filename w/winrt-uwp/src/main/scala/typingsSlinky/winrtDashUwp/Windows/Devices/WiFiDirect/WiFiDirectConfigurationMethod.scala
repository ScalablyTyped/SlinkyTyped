...
object WiFiDirectConfigurationMethod extends js.Object {
  ...
  /* 1 */ val displayPin: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.displayPin with Double = js.native
  /* 0 */ val providePin: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.providePin with Double = js.native
  /* 2 */ val pushButton: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.pushButton with Double = js.native
  @JSBracketAccess
