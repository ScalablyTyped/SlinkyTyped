...
object VpnNativeProtocolType extends js.Object {
  ...
  /* 2 */ val ipsecIkev2: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnNativeProtocolType.ipsecIkev2 with Double = js.native
  /* 1 */ val l2tp: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnNativeProtocolType.l2tp with Double = js.native
  /* 0 */ val pptp: typingsSlinky.winrtDashUwp.Windows.Networking.Vpn.VpnNativeProtocolType.pptp with Double = js.native
  @JSBracketAccess
