...
object CausalityTraceLevel extends js.Object {
  ...
  /* 1 */ val important: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.important with Double = js.native
  /* 0 */ val required: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.required with Double = js.native
  /* 2 */ val verbose: typingsSlinky.winrtDashUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.verbose with Double = js.native
  @JSBracketAccess
