package typingsSlinky.winrtDashUwp.Windows.Networking.Proximity
...
object PeerWatcherStatus extends js.Object {
  ...
  /* 5 */ val aborted: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.aborted with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.created with Double = js.native
  /* 2 */ val enumerationCompleted: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.enumerationCompleted with Double = js.native
  /* 1 */ val started: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.started with Double = js.native
  /* 4 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.stopped with Double = js.native
  /* 3 */ val stopping: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerWatcherStatus.stopping with Double = js.native
  @JSBracketAccess
