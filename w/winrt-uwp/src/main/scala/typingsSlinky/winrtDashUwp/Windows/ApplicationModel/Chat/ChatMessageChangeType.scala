...
object ChatMessageChangeType extends js.Object {
  ...
  /* 3 */ val changeTrackingLost: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatMessageChangeType.changeTrackingLost with Double = js.native
  /* 0 */ val messageCreated: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatMessageChangeType.messageCreated with Double = js.native
  /* 2 */ val messageDeleted: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatMessageChangeType.messageDeleted with Double = js.native
  /* 1 */ val messageModified: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatMessageChangeType.messageModified with Double = js.native
  @JSBracketAccess
