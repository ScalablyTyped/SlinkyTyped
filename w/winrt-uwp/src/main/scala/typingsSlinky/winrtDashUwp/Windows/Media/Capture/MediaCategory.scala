...
object MediaCategory extends js.Object {
  ...
  /* 1 */ val communications: typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaCategory.communications with Double = js.native
  /* 3 */ val gameChat: typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaCategory.gameChat with Double = js.native
  /* 2 */ val media: typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaCategory.media with Double = js.native
  /* 0 */ val other: typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaCategory.other with Double = js.native
  /* 4 */ val speech: typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaCategory.speech with Double = js.native
  @JSBracketAccess
