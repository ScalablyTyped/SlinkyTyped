...
object YearFormat extends js.Object {
  ...
  /* 2 */ val abbreviated: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.YearFormat.abbreviated with Double = js.native
  /* 1 */ val default: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.YearFormat.default with Double = js.native
  /* 3 */ val full: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.YearFormat.full with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.YearFormat.none with Double = js.native
  @JSBracketAccess
