...
import typingsSlinky.winrtDashUwp.Windows.Web.Http.Filters.IHttpFilter
import typingsSlinky.winrtDashUwp.Windows.Web.Http.Headers.HttpRequestHeaderCollection
