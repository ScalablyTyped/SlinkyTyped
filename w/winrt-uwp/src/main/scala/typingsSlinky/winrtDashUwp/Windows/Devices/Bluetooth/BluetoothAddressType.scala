...
object BluetoothAddressType extends js.Object {
  ...
  /* 0 */ val public: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothAddressType.public with Double = js.native
  /* 1 */ val random: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothAddressType.random with Double = js.native
  @JSBracketAccess
