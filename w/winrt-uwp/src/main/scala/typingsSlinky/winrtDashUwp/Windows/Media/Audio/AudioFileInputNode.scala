...
import typingsSlinky.winrtDashUwp.Windows.Media.Effects.IAudioEffectDefinition
import typingsSlinky.winrtDashUwp.Windows.Media.MediaProperties.AudioEncodingProperties
import typingsSlinky.winrtDashUwp.Windows.Storage.StorageFile
import typingsSlinky.winrtDashUwp.Windows.WinRTEvent
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.filecompleted
...
abstract class AudioFileInputNode () extends js.Object {
  ...
  var onfilecompleted_Original: TypedEventHandler[AudioFileInputNode, _] = js.native
  ...
  def addEventListener_filecompleted(`type`: filecompleted, listener: TypedEventHandler[AudioFileInputNode, _]): Unit = js.native
  /**
  ...
  /** Notifies of completion of the file associated with the audio file input node. */
  def onfilecompleted(ev: js.Any with WinRTEvent[AudioFileInputNode]): Unit = js.native
  def removeEventListener(`type`: String, listener: EventHandler[_]): Unit = js.native
  @JSName("removeEventListener")
  def removeEventListener_filecompleted(`type`: filecompleted, listener: TypedEventHandler[AudioFileInputNode, _]): Unit = js.native
  /**
