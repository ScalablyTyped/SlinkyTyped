...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.cueentered
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.cueexited
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.trackfailed
