...
object InstallOptions extends js.Object {
  ...
  /* 1 */ val deleteExpired: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.InstallOptions.deleteExpired with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.InstallOptions.none with Double = js.native
  @JSBracketAccess
