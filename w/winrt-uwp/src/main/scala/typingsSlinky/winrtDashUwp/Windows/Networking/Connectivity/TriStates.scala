...
object TriStates extends js.Object {
  ...
  /* 0 */ val doNotCare: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.TriStates.doNotCare with Double = js.native
  /* 1 */ val no: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.TriStates.no with Double = js.native
  /* 2 */ val yes: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.TriStates.yes with Double = js.native
  @JSBracketAccess
