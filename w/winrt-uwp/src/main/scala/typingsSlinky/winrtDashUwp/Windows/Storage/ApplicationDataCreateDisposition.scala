...
object ApplicationDataCreateDisposition extends js.Object {
  ...
  /* 0 */ val always: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataCreateDisposition.always with Double = js.native
  /* 1 */ val existing: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataCreateDisposition.existing with Double = js.native
  @JSBracketAccess
