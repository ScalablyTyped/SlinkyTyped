...
object MarkerStyle extends js.Object {
  ...
  /* 5 */ val minus: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.minus with Double = js.native
  /* 6 */ val noNumber: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.noNumber with Double = js.native
  /* 2 */ val parentheses: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.parentheses with Double = js.native
  /* 1 */ val parenthesis: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.parenthesis with Double = js.native
  /* 3 */ val period: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.period with Double = js.native
  /* 4 */ val plain: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.plain with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.MarkerStyle.undefined with Double = js.native
  @JSBracketAccess
