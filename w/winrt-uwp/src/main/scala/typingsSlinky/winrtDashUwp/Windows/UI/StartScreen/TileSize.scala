...
object TileSize extends js.Object {
  ...
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.default with Double = js.native
  /* 3 */ val square150x150: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square150x150 with Double = js.native
  /* 1 */ val square30x30: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square30x30 with Double = js.native
  /* 5 */ val square310x310: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square310x310 with Double = js.native
  /* 7 */ val square44x44: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square44x44 with Double = js.native
  /* 2 */ val square70x70: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square70x70 with Double = js.native
  /* 6 */ val square71x71: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.square71x71 with Double = js.native
  /* 4 */ val wide310x150: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.TileSize.wide310x150 with Double = js.native
  @JSBracketAccess
