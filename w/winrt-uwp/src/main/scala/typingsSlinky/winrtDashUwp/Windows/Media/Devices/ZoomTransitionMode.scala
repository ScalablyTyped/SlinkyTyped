...
object ZoomTransitionMode extends js.Object {
  ...
  /* 0 */ val auto: typingsSlinky.winrtDashUwp.Windows.Media.Devices.ZoomTransitionMode.auto with Double = js.native
  /* 1 */ val direct: typingsSlinky.winrtDashUwp.Windows.Media.Devices.ZoomTransitionMode.direct with Double = js.native
  /* 2 */ val smooth: typingsSlinky.winrtDashUwp.Windows.Media.Devices.ZoomTransitionMode.smooth with Double = js.native
  @JSBracketAccess
