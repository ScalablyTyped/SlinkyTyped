...
object JumpListSystemGroupKind extends js.Object {
  ...
  /* 1 */ val frequent: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.frequent with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.none with Double = js.native
  /* 2 */ val recent: typingsSlinky.winrtDashUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.recent with Double = js.native
  @JSBracketAccess
