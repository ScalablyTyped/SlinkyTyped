package typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls
...
object PhoneCallHistoryEntryQueryDesiredMedia extends js.Object {
  ...
  /* 3 */ val all: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.all with Double = js.native
  /* 1 */ val audio: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.audio with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.none with Double = js.native
  /* 2 */ val video: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.video with Double = js.native
  @JSBracketAccess
