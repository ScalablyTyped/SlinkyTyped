...
object GeofenceState extends js.Object {
  ...
  /* 1 */ val entered: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.entered with Double = js.native
  /* 2 */ val exited: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.exited with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.none with Double = js.native
  /* 3 */ val removed: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.removed with Double = js.native
  @JSBracketAccess
