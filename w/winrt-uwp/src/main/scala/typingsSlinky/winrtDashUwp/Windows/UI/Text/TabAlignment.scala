...
object TabAlignment extends js.Object {
  ...
  /* 4 */ val bar: typingsSlinky.winrtDashUwp.Windows.UI.Text.TabAlignment.bar with Double = js.native
  /* 1 */ val center: typingsSlinky.winrtDashUwp.Windows.UI.Text.TabAlignment.center with Double = js.native
  /* 3 */ val decimal: typingsSlinky.winrtDashUwp.Windows.UI.Text.TabAlignment.decimal with Double = js.native
  /* 0 */ val left: typingsSlinky.winrtDashUwp.Windows.UI.Text.TabAlignment.left with Double = js.native
  /* 2 */ val right: typingsSlinky.winrtDashUwp.Windows.UI.Text.TabAlignment.right with Double = js.native
  @JSBracketAccess
