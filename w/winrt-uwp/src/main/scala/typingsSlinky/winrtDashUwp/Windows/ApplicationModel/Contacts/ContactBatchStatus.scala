...
object ContactBatchStatus extends js.Object {
  ...
  /* 1 */ val serverSearchSyncManagerError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactBatchStatus.serverSearchSyncManagerError with Double = js.native
  /* 2 */ val serverSearchUnknownError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactBatchStatus.serverSearchUnknownError with Double = js.native
  /* 0 */ val success: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactBatchStatus.success with Double = js.native
  @JSBracketAccess
