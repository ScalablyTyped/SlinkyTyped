...
object AccountPictureKind extends js.Object {
  ...
  /* 1 */ val largeImage: typingsSlinky.winrtDashUwp.Windows.System.UserProfile.AccountPictureKind.largeImage with Double = js.native
  /* 0 */ val smallImage: typingsSlinky.winrtDashUwp.Windows.System.UserProfile.AccountPictureKind.smallImage with Double = js.native
  /* 2 */ val video: typingsSlinky.winrtDashUwp.Windows.System.UserProfile.AccountPictureKind.video with Double = js.native
  @JSBracketAccess
