...
object DayFormat extends js.Object {
  ...
  /* 1 */ val default: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.DayFormat.default with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Globalization.DateTimeFormatting.DayFormat.none with Double = js.native
  @JSBracketAccess
