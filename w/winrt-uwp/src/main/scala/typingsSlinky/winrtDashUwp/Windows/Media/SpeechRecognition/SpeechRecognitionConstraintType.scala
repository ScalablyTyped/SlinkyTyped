...
object SpeechRecognitionConstraintType extends js.Object {
  ...
  /* 2 */ val grammar: typingsSlinky.winrtDashUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.grammar with Double = js.native
  /* 1 */ val list: typingsSlinky.winrtDashUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.list with Double = js.native
  /* 0 */ val topic: typingsSlinky.winrtDashUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.topic with Double = js.native
  /* 3 */ val voiceCommandDefinition: typingsSlinky.winrtDashUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.voiceCommandDefinition with Double = js.native
  @JSBracketAccess
