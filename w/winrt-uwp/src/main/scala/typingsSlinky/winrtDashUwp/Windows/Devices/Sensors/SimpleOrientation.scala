...
object SimpleOrientation extends js.Object {
  ...
  /* 5 */ val facedown: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.facedown with Double = js.native
  /* 4 */ val faceup: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.faceup with Double = js.native
  /* 0 */ val notRotated: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.notRotated with Double = js.native
  /* 2 */ val rotated180DegreesCounterclockwise: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated180DegreesCounterclockwise with Double = js.native
  /* 3 */ val rotated270DegreesCounterclockwise: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated270DegreesCounterclockwise with Double = js.native
  /* 1 */ val rotated90DegreesCounterclockwise: typingsSlinky.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated90DegreesCounterclockwise with Double = js.native
  @JSBracketAccess
