...
object CameraCaptureUIPhotoFormat extends js.Object {
  ...
  /* 0 */ val jpeg: typingsSlinky.winrtDashUwp.Windows.Media.Capture.CameraCaptureUIPhotoFormat.jpeg with Double = js.native
  /* 2 */ val jpegXR: typingsSlinky.winrtDashUwp.Windows.Media.Capture.CameraCaptureUIPhotoFormat.jpegXR with Double = js.native
  /* 1 */ val png: typingsSlinky.winrtDashUwp.Windows.Media.Capture.CameraCaptureUIPhotoFormat.png with Double = js.native
  @JSBracketAccess
