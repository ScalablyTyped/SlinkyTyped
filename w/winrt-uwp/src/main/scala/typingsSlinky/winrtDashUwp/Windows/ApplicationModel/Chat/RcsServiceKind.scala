...
object RcsServiceKind extends js.Object {
  ...
  /* 3 */ val capability: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.RcsServiceKind.capability with Double = js.native
  /* 0 */ val chat: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.RcsServiceKind.chat with Double = js.native
  /* 2 */ val fileTransfer: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.RcsServiceKind.fileTransfer with Double = js.native
  /* 1 */ val groupChat: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.RcsServiceKind.groupChat with Double = js.native
  @JSBracketAccess
