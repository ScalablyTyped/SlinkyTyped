...
object MagneticStripeReaderAuthenticationProtocol extends js.Object {
  ...
  /* 1 */ val challengeResponse: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationProtocol.challengeResponse with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationProtocol.none with Double = js.native
  @JSBracketAccess
