...
object BitmapPixelFormat extends js.Object {
  ...
  /* 5 */ val bgra8: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.bgra8 with Double = js.native
  /* 3 */ val gray16: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.gray16 with Double = js.native
  /* 4 */ val gray8: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.gray8 with Double = js.native
  /* 6 */ val nv12: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.nv12 with Double = js.native
  /* 1 */ val rgba16: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.rgba16 with Double = js.native
  /* 2 */ val rgba8: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.rgba8 with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.unknown with Double = js.native
  /* 7 */ val yuy2: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapPixelFormat.yuy2 with Double = js.native
  @JSBracketAccess
