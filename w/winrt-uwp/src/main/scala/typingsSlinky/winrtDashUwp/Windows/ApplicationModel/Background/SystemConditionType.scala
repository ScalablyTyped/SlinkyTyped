...
object SystemConditionType extends js.Object {
  ...
  /* 8 */ val backgroundWorkCostNotHigh: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.backgroundWorkCostNotHigh with Double = js.native
  /* 7 */ val freeNetworkAvailable: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.freeNetworkAvailable with Double = js.native
  /* 3 */ val internetAvailable: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.internetAvailable with Double = js.native
  /* 4 */ val internetNotAvailable: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.internetNotAvailable with Double = js.native
  /* 0 */ val invalid: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.invalid with Double = js.native
  /* 5 */ val sessionConnected: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.sessionConnected with Double = js.native
  /* 6 */ val sessionDisconnected: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.sessionDisconnected with Double = js.native
  /* 2 */ val userNotPresent: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.userNotPresent with Double = js.native
  /* 1 */ val userPresent: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemConditionType.userPresent with Double = js.native
  @JSBracketAccess
