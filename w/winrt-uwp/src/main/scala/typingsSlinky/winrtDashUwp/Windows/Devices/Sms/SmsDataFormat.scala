...
object SmsDataFormat extends js.Object {
  ...
  /* 3 */ val cdmaDeliver: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDataFormat.cdmaDeliver with Double = js.native
  /* 1 */ val cdmaSubmit: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDataFormat.cdmaSubmit with Double = js.native
  /* 4 */ val gsmDeliver: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDataFormat.gsmDeliver with Double = js.native
  /* 2 */ val gsmSubmit: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDataFormat.gsmSubmit with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDataFormat.unknown with Double = js.native
  @JSBracketAccess
