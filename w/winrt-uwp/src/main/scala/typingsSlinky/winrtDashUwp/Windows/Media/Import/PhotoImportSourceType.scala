...
object PhotoImportSourceType extends js.Object {
  ...
  /* 6 */ val audioRecorder: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.audioRecorder with Double = js.native
  /* 1 */ val camera: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.camera with Double = js.native
  /* 0 */ val generic: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.generic with Double = js.native
  /* 2 */ val mediaPlayer: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.mediaPlayer with Double = js.native
  /* 5 */ val personalInfoManager: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.personalInfoManager with Double = js.native
  /* 3 */ val phone: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.phone with Double = js.native
  /* 4 */ val video: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportSourceType.video with Double = js.native
  @JSBracketAccess
