...
object BluetoothCacheMode extends js.Object {
  ...
  /* 0 */ val cached: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothCacheMode.cached with Double = js.native
  /* 1 */ val uncached: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothCacheMode.uncached with Double = js.native
  @JSBracketAccess
