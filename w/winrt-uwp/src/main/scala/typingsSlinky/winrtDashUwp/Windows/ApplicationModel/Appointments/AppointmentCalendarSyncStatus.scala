...
object AppointmentCalendarSyncStatus extends js.Object {
  ...
  /* 3 */ val authenticationError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.authenticationError with Double = js.native
  /* 0 */ val idle: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.idle with Double = js.native
  /* 6 */ val manualAccountRemovalRequired: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.manualAccountRemovalRequired with Double = js.native
  /* 4 */ val policyError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.policyError with Double = js.native
  /* 1 */ val syncing: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.syncing with Double = js.native
  /* 5 */ val unknownError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.unknownError with Double = js.native
  /* 2 */ val upToDate: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.upToDate with Double = js.native
  @JSBracketAccess
