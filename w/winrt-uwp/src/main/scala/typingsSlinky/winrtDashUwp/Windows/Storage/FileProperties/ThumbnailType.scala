...
object ThumbnailType extends js.Object {
  ...
  /* 1 */ val icon: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.ThumbnailType.icon with Double = js.native
  /* 0 */ val image: typingsSlinky.winrtDashUwp.Windows.Storage.FileProperties.ThumbnailType.image with Double = js.native
  @JSBracketAccess
