...
object MobileBroadbandAccountWatcherStatus extends js.Object {
  ...
  /* 4 */ val aborted: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccountWatcherStatus.aborted with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccountWatcherStatus.created with Double = js.native
  /* 2 */ val enumerationCompleted: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccountWatcherStatus.enumerationCompleted with Double = js.native
  /* 1 */ val started: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccountWatcherStatus.started with Double = js.native
  /* 3 */ val stopped: typingsSlinky.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccountWatcherStatus.stopped with Double = js.native
  @JSBracketAccess
