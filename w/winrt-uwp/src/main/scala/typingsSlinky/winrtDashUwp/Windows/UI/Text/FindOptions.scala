...
object FindOptions extends js.Object {
  ...
  /* 2 */ val `case`: typingsSlinky.winrtDashUwp.Windows.UI.Text.FindOptions.`case` with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.UI.Text.FindOptions.none with Double = js.native
  /* 1 */ val word: typingsSlinky.winrtDashUwp.Windows.UI.Text.FindOptions.word with Double = js.native
  @JSBracketAccess
