...
object RemoteSystemStatusType extends js.Object {
  ...
  /* 0 */ val any: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatusType.any with Double = js.native
  /* 1 */ val available: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemStatusType.available with Double = js.native
  @JSBracketAccess
