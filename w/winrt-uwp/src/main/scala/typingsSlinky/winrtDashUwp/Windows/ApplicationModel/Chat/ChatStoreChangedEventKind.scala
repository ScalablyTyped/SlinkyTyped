...
object ChatStoreChangedEventKind extends js.Object {
  ...
  /* 6 */ val conversationDeleted: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.conversationDeleted with Double = js.native
  /* 5 */ val conversationModified: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.conversationModified with Double = js.native
  /* 7 */ val conversationTransportDeleted: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.conversationTransportDeleted with Double = js.native
  /* 2 */ val messageCreated: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.messageCreated with Double = js.native
  /* 4 */ val messageDeleted: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.messageDeleted with Double = js.native
  /* 3 */ val messageModified: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.messageModified with Double = js.native
  /* 0 */ val notificationsMissed: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.notificationsMissed with Double = js.native
  /* 1 */ val storeModified: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind.storeModified with Double = js.native
  @JSBracketAccess
