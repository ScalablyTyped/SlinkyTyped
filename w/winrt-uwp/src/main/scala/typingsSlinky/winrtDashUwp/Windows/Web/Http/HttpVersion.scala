...
object HttpVersion extends js.Object {
  ...
  /* 1 */ val http10: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpVersion.http10 with Double = js.native
  /* 2 */ val http11: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpVersion.http11 with Double = js.native
  /* 3 */ val http20: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpVersion.http20 with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpVersion.none with Double = js.native
  @JSBracketAccess
