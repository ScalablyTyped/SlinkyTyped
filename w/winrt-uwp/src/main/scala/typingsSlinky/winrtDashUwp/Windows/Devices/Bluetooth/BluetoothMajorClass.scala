...
object BluetoothMajorClass extends js.Object {
  ...
  /* 4 */ val audioVideo: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.audioVideo with Double = js.native
  /* 1 */ val computer: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.computer with Double = js.native
  /* 9 */ val health: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.health with Double = js.native
  /* 6 */ val imaging: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.imaging with Double = js.native
  /* 0 */ val miscellaneous: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.miscellaneous with Double = js.native
  /* 3 */ val networkAccessPoint: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.networkAccessPoint with Double = js.native
  /* 5 */ val peripheral: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.peripheral with Double = js.native
  /* 2 */ val phone: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.phone with Double = js.native
  /* 8 */ val toy: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.toy with Double = js.native
  /* 7 */ val wearable: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothMajorClass.wearable with Double = js.native
  @JSBracketAccess
