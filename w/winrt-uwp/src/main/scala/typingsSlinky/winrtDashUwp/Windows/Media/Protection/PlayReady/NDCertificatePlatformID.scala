...
object NDCertificatePlatformID extends js.Object {
  ...
  /* 9 */ val androidOnARM: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.androidOnARM with Double = js.native
  /* 4 */ val iOSOnARM: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.iOSOnARM with Double = js.native
  /* 1 */ val osx: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.osx with Double = js.native
  /* 0 */ val windows: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windows with Double = js.native
  /* 3 */ val windowsMobile7: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsMobile7 with Double = js.native
  /* 2 */ val windowsOnARM: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsOnARM with Double = js.native
  /* 10 */ val windowsPhone81OnARM: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsPhone81OnARM with Double = js.native
  /* 11 */ val windowsPhone81OnX86: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsPhone81OnX86 with Double = js.native
  /* 6 */ val windowsPhone8OnARM: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsPhone8OnARM with Double = js.native
  /* 7 */ val windowsPhone8OnX86: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.windowsPhone8OnX86 with Double = js.native
  /* 5 */ val xboxOnPPC: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.xboxOnPPC with Double = js.native
  /* 8 */ val xboxOne: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificatePlatformID.xboxOne with Double = js.native
  @JSBracketAccess
