...
object SelectionOptions extends js.Object {
  ...
  /* 3 */ val active: typingsSlinky.winrtDashUwp.Windows.UI.Text.SelectionOptions.active with Double = js.native
  /* 1 */ val atEndOfLine: typingsSlinky.winrtDashUwp.Windows.UI.Text.SelectionOptions.atEndOfLine with Double = js.native
  /* 2 */ val overtype: typingsSlinky.winrtDashUwp.Windows.UI.Text.SelectionOptions.overtype with Double = js.native
  /* 4 */ val replace: typingsSlinky.winrtDashUwp.Windows.UI.Text.SelectionOptions.replace with Double = js.native
  /* 0 */ val startActive: typingsSlinky.winrtDashUwp.Windows.UI.Text.SelectionOptions.startActive with Double = js.native
  @JSBracketAccess
