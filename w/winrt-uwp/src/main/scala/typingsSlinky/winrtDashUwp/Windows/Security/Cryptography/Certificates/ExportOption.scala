...
object ExportOption extends js.Object {
  ...
  /* 1 */ val exportable: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.ExportOption.exportable with Double = js.native
  /* 0 */ val notExportable: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.ExportOption.notExportable with Double = js.native
  @JSBracketAccess
