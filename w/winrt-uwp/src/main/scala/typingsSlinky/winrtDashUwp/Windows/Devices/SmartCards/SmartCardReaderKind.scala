...
object SmartCardReaderKind extends js.Object {
  ...
  /* 0 */ val any: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardReaderKind.any with Double = js.native
  /* 1 */ val generic: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardReaderKind.generic with Double = js.native
  /* 3 */ val nfc: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardReaderKind.nfc with Double = js.native
  /* 2 */ val tpm: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardReaderKind.tpm with Double = js.native
  /* 4 */ val uicc: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardReaderKind.uicc with Double = js.native
  @JSBracketAccess
