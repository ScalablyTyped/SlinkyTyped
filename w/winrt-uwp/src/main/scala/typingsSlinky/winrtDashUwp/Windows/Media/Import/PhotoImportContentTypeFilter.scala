...
object PhotoImportContentTypeFilter extends js.Object {
  ...
  /* 2 */ val imagesAndVideos: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportContentTypeFilter.imagesAndVideos with Double = js.native
  /* 0 */ val onlyImages: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportContentTypeFilter.onlyImages with Double = js.native
  /* 1 */ val onlyVideos: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportContentTypeFilter.onlyVideos with Double = js.native
  @JSBracketAccess
