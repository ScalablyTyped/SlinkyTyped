...
object ContactChangeType extends js.Object {
  ...
  /* 3 */ val changeTrackingLost: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactChangeType.changeTrackingLost with Double = js.native
  /* 0 */ val created: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactChangeType.created with Double = js.native
  /* 2 */ val deleted: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactChangeType.deleted with Double = js.native
  /* 1 */ val modified: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactChangeType.modified with Double = js.native
  @JSBracketAccess
