...
object ThreadingModel extends js.Object {
  ...
  /* 2 */ val both: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.ThreadingModel.both with Double = js.native
  /* 3 */ val invalidThreading: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.ThreadingModel.invalidThreading with Double = js.native
  /* 1 */ val mta: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.ThreadingModel.mta with Double = js.native
  /* 0 */ val sta: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.ThreadingModel.sta with Double = js.native
  @JSBracketAccess
