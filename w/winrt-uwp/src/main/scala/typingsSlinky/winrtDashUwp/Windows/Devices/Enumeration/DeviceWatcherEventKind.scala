...
object DeviceWatcherEventKind extends js.Object {
  ...
  /* 0 */ val add: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherEventKind.add with Double = js.native
  /* 2 */ val remove: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherEventKind.remove with Double = js.native
  /* 1 */ val update: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceWatcherEventKind.update with Double = js.native
  @JSBracketAccess
