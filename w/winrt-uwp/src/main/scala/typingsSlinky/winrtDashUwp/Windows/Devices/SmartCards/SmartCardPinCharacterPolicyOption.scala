...
object SmartCardPinCharacterPolicyOption extends js.Object {
  ...
  /* 0 */ val allow: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.allow with Double = js.native
  /* 2 */ val disallow: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.disallow with Double = js.native
  /* 1 */ val requireAtLeastOne: typingsSlinky.winrtDashUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.requireAtLeastOne with Double = js.native
  @JSBracketAccess
