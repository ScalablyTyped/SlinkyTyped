...
import typingsSlinky.winrtDashUwp.Windows.Foundation.Size
import typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintMediaSize
import typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintOrientation
