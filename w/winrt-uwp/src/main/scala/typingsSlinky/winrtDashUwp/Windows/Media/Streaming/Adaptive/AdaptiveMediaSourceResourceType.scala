...
object AdaptiveMediaSourceResourceType extends js.Object {
  ...
  /* 1 */ val initializationSegment: typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.initializationSegment with Double = js.native
  /* 4 */ val initializationVector: typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.initializationVector with Double = js.native
  /* 3 */ val key: typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.key with Double = js.native
  /* 0 */ val manifest: typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.manifest with Double = js.native
  /* 2 */ val mediaSegment: typingsSlinky.winrtDashUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.mediaSegment with Double = js.native
  @JSBracketAccess
