...
object PackageState extends js.Object {
  ...
  /* 1 */ val licenseInvalid: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageState.licenseInvalid with Double = js.native
  /* 2 */ val modified: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageState.modified with Double = js.native
  /* 0 */ val normal: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageState.normal with Double = js.native
  /* 3 */ val tampered: typingsSlinky.winrtDashUwp.Windows.Management.Deployment.PackageState.tampered with Double = js.native
  @JSBracketAccess
