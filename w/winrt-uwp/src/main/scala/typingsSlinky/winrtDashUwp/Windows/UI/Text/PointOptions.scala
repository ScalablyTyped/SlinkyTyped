...
object PointOptions extends js.Object {
  ...
  /* 4 */ val allowOffClient: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.allowOffClient with Double = js.native
  /* 3 */ val clientCoordinates: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.clientCoordinates with Double = js.native
  /* 1 */ val includeInset: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.includeInset with Double = js.native
  /* 6 */ val noHorizontalScroll: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.noHorizontalScroll with Double = js.native
  /* 7 */ val noVerticalScroll: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.noVerticalScroll with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.none with Double = js.native
  /* 2 */ val start: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.start with Double = js.native
  /* 5 */ val transform: typingsSlinky.winrtDashUwp.Windows.UI.Text.PointOptions.transform with Double = js.native
  @JSBracketAccess
