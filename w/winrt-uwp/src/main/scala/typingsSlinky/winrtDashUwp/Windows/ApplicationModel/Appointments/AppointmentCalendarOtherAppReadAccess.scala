...
object AppointmentCalendarOtherAppReadAccess extends js.Object {
  ...
  /* 2 */ val full: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarOtherAppReadAccess.full with Double = js.native
  /* 1 */ val limited: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarOtherAppReadAccess.limited with Double = js.native
  /* 0 */ val systemOnly: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
