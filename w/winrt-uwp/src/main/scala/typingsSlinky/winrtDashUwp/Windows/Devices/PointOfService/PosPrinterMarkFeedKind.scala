...
object PosPrinterMarkFeedKind extends js.Object {
  ...
  /* 2 */ val toCurrentTopOfForm: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedKind.toCurrentTopOfForm with Double = js.native
  /* 1 */ val toCutter: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedKind.toCutter with Double = js.native
  /* 3 */ val toNextTopOfForm: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedKind.toNextTopOfForm with Double = js.native
  /* 0 */ val toTakeUp: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedKind.toTakeUp with Double = js.native
  @JSBracketAccess
