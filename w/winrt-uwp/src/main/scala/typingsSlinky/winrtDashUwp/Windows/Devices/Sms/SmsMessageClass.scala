...
object SmsMessageClass extends js.Object {
  ...
  /* 1 */ val class0: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageClass.class0 with Double = js.native
  /* 2 */ val class1: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageClass.class1 with Double = js.native
  /* 3 */ val class2: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageClass.class2 with Double = js.native
  /* 4 */ val class3: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageClass.class3 with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageClass.none with Double = js.native
  @JSBracketAccess
