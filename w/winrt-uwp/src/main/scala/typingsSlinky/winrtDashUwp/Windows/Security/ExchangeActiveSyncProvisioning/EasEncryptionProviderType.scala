...
object EasEncryptionProviderType extends js.Object {
  ...
  /* 0 */ val notEvaluated: typingsSlinky.winrtDashUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasEncryptionProviderType.notEvaluated with Double = js.native
  /* 2 */ val otherEncryption: typingsSlinky.winrtDashUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasEncryptionProviderType.otherEncryption with Double = js.native
  /* 1 */ val windowsEncryption: typingsSlinky.winrtDashUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasEncryptionProviderType.windowsEncryption with Double = js.native
  @JSBracketAccess
