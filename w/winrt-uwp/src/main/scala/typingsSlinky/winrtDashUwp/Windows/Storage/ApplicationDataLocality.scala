...
object ApplicationDataLocality extends js.Object {
  ...
  /* 0 */ val local: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataLocality.local with Double = js.native
  /* 3 */ val localCache: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataLocality.localCache with Double = js.native
  /* 1 */ val roaming: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataLocality.roaming with Double = js.native
  /* 2 */ val temporary: typingsSlinky.winrtDashUwp.Windows.Storage.ApplicationDataLocality.temporary with Double = js.native
  @JSBracketAccess
