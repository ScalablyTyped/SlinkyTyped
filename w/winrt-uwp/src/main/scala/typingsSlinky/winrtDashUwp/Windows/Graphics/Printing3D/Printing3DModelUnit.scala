...
object Printing3DModelUnit extends js.Object {
  ...
  /* 3 */ val centimeter: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.centimeter with Double = js.native
  /* 5 */ val foot: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.foot with Double = js.native
  /* 4 */ val inch: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.inch with Double = js.native
  /* 0 */ val meter: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.meter with Double = js.native
  /* 1 */ val micron: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.micron with Double = js.native
  /* 2 */ val millimeter: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.millimeter with Double = js.native
  @JSBracketAccess
