...
object DomainConnectivityLevel extends js.Object {
  ...
  /* 2 */ val authenticated: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.DomainConnectivityLevel.authenticated with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.DomainConnectivityLevel.none with Double = js.native
  /* 1 */ val unauthenticated: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.DomainConnectivityLevel.unauthenticated with Double = js.native
  @JSBracketAccess
