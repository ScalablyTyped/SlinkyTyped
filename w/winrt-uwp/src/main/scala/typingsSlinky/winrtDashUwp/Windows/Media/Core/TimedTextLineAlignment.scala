...
object TimedTextLineAlignment extends js.Object {
  ...
  /* 2 */ val center: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextLineAlignment.center with Double = js.native
  /* 1 */ val end: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextLineAlignment.end with Double = js.native
  /* 0 */ val start: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextLineAlignment.start with Double = js.native
  @JSBracketAccess
