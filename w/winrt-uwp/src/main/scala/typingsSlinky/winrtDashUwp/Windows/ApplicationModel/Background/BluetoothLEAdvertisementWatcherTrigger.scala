...
import typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFilter
import typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.BluetoothSignalStrengthFilter
