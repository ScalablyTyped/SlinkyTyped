...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.allphotoscaptured
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.optionalreferencephotocaptured
