...
object PhoneCallHistoryEntryOtherAppReadAccess extends js.Object {
  ...
  /* 0 */ val full: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.full with Double = js.native
  /* 1 */ val systemOnly: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
