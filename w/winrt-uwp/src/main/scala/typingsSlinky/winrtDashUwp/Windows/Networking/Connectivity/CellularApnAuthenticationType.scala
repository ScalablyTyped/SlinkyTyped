...
object CellularApnAuthenticationType extends js.Object {
  ...
  /* 2 */ val chap: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.CellularApnAuthenticationType.chap with Double = js.native
  /* 3 */ val mschapv2: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.CellularApnAuthenticationType.mschapv2 with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.CellularApnAuthenticationType.none with Double = js.native
  /* 1 */ val pap: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.CellularApnAuthenticationType.pap with Double = js.native
  @JSBracketAccess
