...
import typingsSlinky.winrtDashUwp.Windows.Foundation.IPromiseWithIAsyncActionWithProgress
...
import typingsSlinky.winrtDashUwp.Windows.UI.Input.PointerPoint
