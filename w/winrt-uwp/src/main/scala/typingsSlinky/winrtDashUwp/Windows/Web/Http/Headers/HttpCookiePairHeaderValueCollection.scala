...
import typingsSlinky.winrtDashUwp.Anon_ItemsReturnValueHttpCookiePairHeaderValue
...
abstract class HttpCookiePairHeaderValueCollection () extends Array[HttpCookiePairHeaderValue] {
  ...
  /**
    ...
    */
  def getMany(startIndex: Double): Anon_ItemsReturnValueHttpCookiePairHeaderValue = js.native
  /**
  ...
  def indexOf(value: HttpCookiePairHeaderValue, extra: js.Any*): Anon_Index = js.native
  /**
    ...
    */
  @JSName("indexOf")
  def indexOf_Anon_Index(value: HttpCookiePairHeaderValue): Anon_Index = js.native
  /**
