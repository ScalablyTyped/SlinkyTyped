...
object SmsDeviceStatus extends js.Object {
  ...
  /* 3 */ val badSim: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.badSim with Double = js.native
  /* 7 */ val deviceBlocked: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceBlocked with Double = js.native
  /* 4 */ val deviceFailure: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceFailure with Double = js.native
  /* 6 */ val deviceLocked: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceLocked with Double = js.native
  /* 0 */ val off: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.off with Double = js.native
  /* 1 */ val ready: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.ready with Double = js.native
  /* 2 */ val simNotInserted: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.simNotInserted with Double = js.native
  /* 5 */ val subscriptionNotActivated: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsDeviceStatus.subscriptionNotActivated with Double = js.native
  @JSBracketAccess
