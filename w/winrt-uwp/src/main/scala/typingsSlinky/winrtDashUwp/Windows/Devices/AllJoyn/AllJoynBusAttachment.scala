...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.authenticationcomplete
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.credentialsrequested
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.credentialsverificationrequested
