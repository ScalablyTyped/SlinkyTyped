...
object WiFiDirectError extends js.Object {
  ...
  /* 1 */ val radioNotAvailable: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectError.radioNotAvailable with Double = js.native
  /* 2 */ val resourceInUse: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectError.resourceInUse with Double = js.native
  /* 0 */ val success: typingsSlinky.winrtDashUwp.Windows.Devices.WiFiDirect.WiFiDirectError.success with Double = js.native
  @JSBracketAccess
