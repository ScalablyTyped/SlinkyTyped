...
object PrintColorMode extends js.Object {
  ...
  /* 3 */ val color: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.color with Double = js.native
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.default with Double = js.native
  /* 4 */ val grayscale: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.grayscale with Double = js.native
  /* 5 */ val monochrome: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.monochrome with Double = js.native
  /* 1 */ val notAvailable: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.notAvailable with Double = js.native
  /* 2 */ val printerCustom: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintColorMode.printerCustom with Double = js.native
  @JSBracketAccess
