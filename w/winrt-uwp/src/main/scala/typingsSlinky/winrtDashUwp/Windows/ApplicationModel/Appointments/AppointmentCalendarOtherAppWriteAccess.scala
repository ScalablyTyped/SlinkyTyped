...
object AppointmentCalendarOtherAppWriteAccess extends js.Object {
  ...
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarOtherAppWriteAccess.none with Double = js.native
  /* 1 */ val systemOnly: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarOtherAppWriteAccess.systemOnly with Double = js.native
  @JSBracketAccess
