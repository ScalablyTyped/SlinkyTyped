...
import typingsSlinky.winrtDashUwp.Anon_ReturnValueValueBoolean
...
import typingsSlinky.winrtDashUwp.Windows.Media.Capture.MediaStreamType
import typingsSlinky.winrtDashUwp.Windows.Media.Capture.PowerlineFrequency
import typingsSlinky.winrtDashUwp.Windows.Media.Devices.Core.VariablePhotoSequenceController
