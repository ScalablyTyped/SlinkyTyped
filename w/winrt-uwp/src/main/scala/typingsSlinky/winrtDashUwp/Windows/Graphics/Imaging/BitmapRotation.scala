...
object BitmapRotation extends js.Object {
  ...
  /* 2 */ val clockwise180Degrees: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise180Degrees with Double = js.native
  /* 3 */ val clockwise270Degrees: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise270Degrees with Double = js.native
  /* 1 */ val clockwise90Degrees: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise90Degrees with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapRotation.none with Double = js.native
  @JSBracketAccess
