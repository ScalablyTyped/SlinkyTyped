...
object PosPrinterRotation extends js.Object {
  ...
  /* 2 */ val left90: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterRotation.left90 with Double = js.native
  /* 0 */ val normal: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterRotation.normal with Double = js.native
  /* 1 */ val right90: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterRotation.right90 with Double = js.native
  /* 3 */ val rotate180: typingsSlinky.winrtDashUwp.Windows.Devices.PointOfService.PosPrinterRotation.rotate180 with Double = js.native
  @JSBracketAccess
