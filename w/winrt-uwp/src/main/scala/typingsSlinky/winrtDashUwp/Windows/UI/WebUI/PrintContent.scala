...
object PrintContent extends js.Object {
  ...
  /* 0 */ val allPages: typingsSlinky.winrtDashUwp.Windows.UI.WebUI.PrintContent.allPages with Double = js.native
  /* 1 */ val currentPage: typingsSlinky.winrtDashUwp.Windows.UI.WebUI.PrintContent.currentPage with Double = js.native
  /* 3 */ val currentSelection: typingsSlinky.winrtDashUwp.Windows.UI.WebUI.PrintContent.currentSelection with Double = js.native
  /* 2 */ val customPageRange: typingsSlinky.winrtDashUwp.Windows.UI.WebUI.PrintContent.customPageRange with Double = js.native
  @JSBracketAccess
