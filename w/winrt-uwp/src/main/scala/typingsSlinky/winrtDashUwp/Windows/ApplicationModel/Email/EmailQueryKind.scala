...
object EmailQueryKind extends js.Object {
  ...
  /* 0 */ val all: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.all with Double = js.native
  /* 2 */ val flagged: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.flagged with Double = js.native
  /* 1 */ val important: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.important with Double = js.native
  /* 4 */ val read: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.read with Double = js.native
  /* 3 */ val unread: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.unread with Double = js.native
  /* 5 */ val unseen: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQueryKind.unseen with Double = js.native
  @JSBracketAccess
