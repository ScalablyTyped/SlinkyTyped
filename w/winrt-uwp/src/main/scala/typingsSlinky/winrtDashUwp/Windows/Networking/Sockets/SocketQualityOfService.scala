...
object SocketQualityOfService extends js.Object {
  ...
  /* 1 */ val lowLatency: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketQualityOfService.lowLatency with Double = js.native
  /* 0 */ val normal: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketQualityOfService.normal with Double = js.native
  @JSBracketAccess
