...
object ProductPurchaseStatus extends js.Object {
  ...
  /* 1 */ val alreadyPurchased: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.ProductPurchaseStatus.alreadyPurchased with Double = js.native
  /* 2 */ val notFulfilled: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.ProductPurchaseStatus.notFulfilled with Double = js.native
  /* 3 */ val notPurchased: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.ProductPurchaseStatus.notPurchased with Double = js.native
  /* 0 */ val succeeded: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.ProductPurchaseStatus.succeeded with Double = js.native
  @JSBracketAccess
