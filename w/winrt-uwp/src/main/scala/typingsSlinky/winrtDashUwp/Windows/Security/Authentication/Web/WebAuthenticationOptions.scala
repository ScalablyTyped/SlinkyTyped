...
object WebAuthenticationOptions extends js.Object {
  ...
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.none with Double = js.native
  /* 1 */ val silentMode: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.silentMode with Double = js.native
  /* 4 */ val useCorporateNetwork: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useCorporateNetwork with Double = js.native
  /* 3 */ val useHttpPost: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useHttpPost with Double = js.native
  /* 2 */ val useTitle: typingsSlinky.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useTitle with Double = js.native
  @JSBracketAccess
