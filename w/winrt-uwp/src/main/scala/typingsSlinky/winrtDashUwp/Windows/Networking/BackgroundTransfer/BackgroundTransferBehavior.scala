package typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer
...
object BackgroundTransferBehavior extends js.Object {
  ...
  /* 0 */ val parallel: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior.parallel with Double = js.native
  /* 1 */ val serialized: typingsSlinky.winrtDashUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior.serialized with Double = js.native
  @JSBracketAccess
