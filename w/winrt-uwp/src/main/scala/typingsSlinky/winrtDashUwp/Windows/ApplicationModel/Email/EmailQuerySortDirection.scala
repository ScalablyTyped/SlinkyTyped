...
object EmailQuerySortDirection extends js.Object {
  ...
  /* 1 */ val ascending: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQuerySortDirection.ascending with Double = js.native
  /* 0 */ val descending: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailQuerySortDirection.descending with Double = js.native
  @JSBracketAccess
