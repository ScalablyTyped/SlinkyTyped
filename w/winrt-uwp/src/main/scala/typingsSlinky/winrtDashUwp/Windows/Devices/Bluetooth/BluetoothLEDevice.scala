...
import typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDeviceService
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.connectionstatuschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.gattserviceschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.namechanged
