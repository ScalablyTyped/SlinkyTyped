...
object MarshalingType extends js.Object {
  ...
  /* 1 */ val agile: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.MarshalingType.agile with Double = js.native
  /* 3 */ val invalidMarshaling: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.MarshalingType.invalidMarshaling with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.MarshalingType.none with Double = js.native
  /* 2 */ val standard: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.MarshalingType.standard with Double = js.native
  @JSBracketAccess
