...
object Printing3DTextureEdgeBehavior extends js.Object {
  ...
  /* 3 */ val clamp: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.clamp with Double = js.native
  /* 2 */ val mirror: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.mirror with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.none with Double = js.native
  /* 1 */ val wrap: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.wrap with Double = js.native
  @JSBracketAccess
