...
import typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Background.RfcommInboundConnectionInformation
import typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Background.RfcommOutboundConnectionInformation
