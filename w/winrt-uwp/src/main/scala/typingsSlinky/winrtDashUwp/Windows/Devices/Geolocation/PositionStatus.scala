...
object PositionStatus extends js.Object {
  ...
  /* 3 */ val disabled: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.disabled with Double = js.native
  /* 1 */ val initializing: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.initializing with Double = js.native
  /* 2 */ val noData: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.noData with Double = js.native
  /* 5 */ val notAvailable: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.notAvailable with Double = js.native
  /* 4 */ val notInitialized: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.notInitialized with Double = js.native
  /* 0 */ val ready: typingsSlinky.winrtDashUwp.Windows.Devices.Geolocation.PositionStatus.ready with Double = js.native
  @JSBracketAccess
