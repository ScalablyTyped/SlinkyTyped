...
object FaceDetectionMode extends js.Object {
  ...
  /* 1 */ val balanced: typingsSlinky.winrtDashUwp.Windows.Media.Core.FaceDetectionMode.balanced with Double = js.native
  /* 0 */ val highPerformance: typingsSlinky.winrtDashUwp.Windows.Media.Core.FaceDetectionMode.highPerformance with Double = js.native
  /* 2 */ val highQuality: typingsSlinky.winrtDashUwp.Windows.Media.Core.FaceDetectionMode.highQuality with Double = js.native
  @JSBracketAccess
