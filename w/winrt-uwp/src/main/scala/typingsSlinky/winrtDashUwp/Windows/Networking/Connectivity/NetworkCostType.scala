...
object NetworkCostType extends js.Object {
  ...
  /* 2 */ val fixed: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkCostType.fixed with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkCostType.unknown with Double = js.native
  /* 1 */ val unrestricted: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkCostType.unrestricted with Double = js.native
  /* 3 */ val variable: typingsSlinky.winrtDashUwp.Windows.Networking.Connectivity.NetworkCostType.variable with Double = js.native
  @JSBracketAccess
