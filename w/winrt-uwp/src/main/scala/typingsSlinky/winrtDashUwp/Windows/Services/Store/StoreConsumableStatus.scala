...
object StoreConsumableStatus extends js.Object {
  ...
  /* 1 */ val insufficentQuantity: typingsSlinky.winrtDashUwp.Windows.Services.Store.StoreConsumableStatus.insufficentQuantity with Double = js.native
  /* 2 */ val networkError: typingsSlinky.winrtDashUwp.Windows.Services.Store.StoreConsumableStatus.networkError with Double = js.native
  /* 3 */ val serverError: typingsSlinky.winrtDashUwp.Windows.Services.Store.StoreConsumableStatus.serverError with Double = js.native
  /* 0 */ val succeeded: typingsSlinky.winrtDashUwp.Windows.Services.Store.StoreConsumableStatus.succeeded with Double = js.native
  @JSBracketAccess
