...
object Printing3DMeshVerificationMode extends js.Object {
  ...
  /* 1 */ val findAllErrors: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode.findAllErrors with Double = js.native
  /* 0 */ val findFirstError: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode.findFirstError with Double = js.native
  @JSBracketAccess
