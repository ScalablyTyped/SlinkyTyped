...
object PhotoImportImportMode extends js.Object {
  ...
  /* 2 */ val ignoreSiblings: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportImportMode.ignoreSiblings with Double = js.native
  /* 1 */ val ignoreSidecars: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportImportMode.ignoreSidecars with Double = js.native
  /* 3 */ val ignoreSidecarsAndSiblings: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportImportMode.ignoreSidecarsAndSiblings with Double = js.native
  /* 0 */ val importEverything: typingsSlinky.winrtDashUwp.Windows.Media.Import.PhotoImportImportMode.importEverything with Double = js.native
  @JSBracketAccess
