...
object WebAccountState extends js.Object {
  ...
  /* 1 */ val connected: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.WebAccountState.connected with Double = js.native
  /* 2 */ val error: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.WebAccountState.error with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Security.Credentials.WebAccountState.none with Double = js.native
  @JSBracketAccess
