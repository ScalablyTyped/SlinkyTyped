...
object EmailMailboxSyncStatus extends js.Object {
  ...
  /* 3 */ val authenticationError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.authenticationError with Double = js.native
  /* 0 */ val idle: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.idle with Double = js.native
  /* 6 */ val manualAccountRemovalRequired: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.manualAccountRemovalRequired with Double = js.native
  /* 4 */ val policyError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.policyError with Double = js.native
  /* 1 */ val syncing: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.syncing with Double = js.native
  /* 5 */ val unknownError: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.unknownError with Double = js.native
  /* 2 */ val upToDate: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailMailboxSyncStatus.upToDate with Double = js.native
  @JSBracketAccess
