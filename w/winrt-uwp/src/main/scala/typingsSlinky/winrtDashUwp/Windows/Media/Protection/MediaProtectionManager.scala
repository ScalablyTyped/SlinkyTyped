...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.componentloadfailed
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.rebootneeded
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.servicerequested
