...
object LineSpacingRule extends js.Object {
  ...
  /* 4 */ val atLeast: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.atLeast with Double = js.native
  /* 3 */ val double: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.double with Double = js.native
  /* 5 */ val exactly: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.exactly with Double = js.native
  /* 6 */ val multiple: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.multiple with Double = js.native
  /* 2 */ val oneAndHalf: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.oneAndHalf with Double = js.native
  /* 7 */ val percent: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.percent with Double = js.native
  /* 1 */ val single: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.single with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.LineSpacingRule.undefined with Double = js.native
  @JSBracketAccess
