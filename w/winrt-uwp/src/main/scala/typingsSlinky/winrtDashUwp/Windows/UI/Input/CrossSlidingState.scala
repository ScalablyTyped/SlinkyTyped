...
object CrossSlidingState extends js.Object {
  ...
  /* 6 */ val completed: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.completed with Double = js.native
  /* 1 */ val dragging: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.dragging with Double = js.native
  /* 5 */ val rearranging: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.rearranging with Double = js.native
  /* 3 */ val selectSpeedBumping: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.selectSpeedBumping with Double = js.native
  /* 2 */ val selecting: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.selecting with Double = js.native
  /* 4 */ val speedBumping: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.speedBumping with Double = js.native
  /* 0 */ val started: typingsSlinky.winrtDashUwp.Windows.UI.Input.CrossSlidingState.started with Double = js.native
  @JSBracketAccess
