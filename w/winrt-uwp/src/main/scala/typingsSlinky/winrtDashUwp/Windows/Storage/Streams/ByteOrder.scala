...
object ByteOrder extends js.Object {
  ...
  /* 1 */ val bigEndian: typingsSlinky.winrtDashUwp.Windows.Storage.Streams.ByteOrder.bigEndian with Double = js.native
  /* 0 */ val littleEndian: typingsSlinky.winrtDashUwp.Windows.Storage.Streams.ByteOrder.littleEndian with Double = js.native
  @JSBracketAccess
