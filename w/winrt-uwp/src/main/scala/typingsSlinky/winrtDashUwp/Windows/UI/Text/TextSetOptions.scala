...
object TextSetOptions extends js.Object {
  ...
  /* 6 */ val applyRtfDocumentDefaults: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.applyRtfDocumentDefaults with Double = js.native
  /* 4 */ val checkTextLimit: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.checkTextLimit with Double = js.native
  /* 5 */ val formatRtf: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.formatRtf with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.none with Double = js.native
  /* 3 */ val unhide: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.unhide with Double = js.native
  /* 1 */ val unicodeBidi: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.unicodeBidi with Double = js.native
  /* 2 */ val unlink: typingsSlinky.winrtDashUwp.Windows.UI.Text.TextSetOptions.unlink with Double = js.native
  @JSBracketAccess
