...
object PeerDiscoveryTypes extends js.Object {
  ...
  /* 1 */ val browse: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerDiscoveryTypes.browse with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerDiscoveryTypes.none with Double = js.native
  /* 2 */ val triggered: typingsSlinky.winrtDashUwp.Windows.Networking.Proximity.PeerDiscoveryTypes.triggered with Double = js.native
  @JSBracketAccess
