...
object NDProximityDetectionType extends js.Object {
  ...
  /* 1 */ val tcp: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDProximityDetectionType.tcp with Double = js.native
  /* 2 */ val transportAgnostic: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDProximityDetectionType.transportAgnostic with Double = js.native
  /* 0 */ val udp: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDProximityDetectionType.udp with Double = js.native
  @JSBracketAccess
