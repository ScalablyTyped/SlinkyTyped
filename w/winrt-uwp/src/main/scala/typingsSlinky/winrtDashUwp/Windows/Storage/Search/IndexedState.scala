...
object IndexedState extends js.Object {
  ...
  /* 3 */ val fullyIndexed: typingsSlinky.winrtDashUwp.Windows.Storage.Search.IndexedState.fullyIndexed with Double = js.native
  /* 1 */ val notIndexed: typingsSlinky.winrtDashUwp.Windows.Storage.Search.IndexedState.notIndexed with Double = js.native
  /* 2 */ val partiallyIndexed: typingsSlinky.winrtDashUwp.Windows.Storage.Search.IndexedState.partiallyIndexed with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Storage.Search.IndexedState.unknown with Double = js.native
  @JSBracketAccess
