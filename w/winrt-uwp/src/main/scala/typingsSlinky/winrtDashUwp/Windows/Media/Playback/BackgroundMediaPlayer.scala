...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.messagereceivedfrombackground
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.messagereceivedfromforeground
