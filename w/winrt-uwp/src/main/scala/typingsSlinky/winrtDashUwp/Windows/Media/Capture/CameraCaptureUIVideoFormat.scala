...
object CameraCaptureUIVideoFormat extends js.Object {
  ...
  /* 0 */ val mp4: typingsSlinky.winrtDashUwp.Windows.Media.Capture.CameraCaptureUIVideoFormat.mp4 with Double = js.native
  /* 1 */ val wmv: typingsSlinky.winrtDashUwp.Windows.Media.Capture.CameraCaptureUIVideoFormat.wmv with Double = js.native
  @JSBracketAccess
