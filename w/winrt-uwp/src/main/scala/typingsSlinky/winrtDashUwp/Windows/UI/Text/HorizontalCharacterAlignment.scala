...
object HorizontalCharacterAlignment extends js.Object {
  ...
  /* 2 */ val center: typingsSlinky.winrtDashUwp.Windows.UI.Text.HorizontalCharacterAlignment.center with Double = js.native
  /* 0 */ val left: typingsSlinky.winrtDashUwp.Windows.UI.Text.HorizontalCharacterAlignment.left with Double = js.native
  /* 1 */ val right: typingsSlinky.winrtDashUwp.Windows.UI.Text.HorizontalCharacterAlignment.right with Double = js.native
  @JSBracketAccess
