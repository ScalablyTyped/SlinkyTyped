...
import typingsSlinky.winrtDashUwp.Windows.Web.Http.HttpClient
import typingsSlinky.winrtDashUwp.Windows.WinRTEvent
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.downloadbitratechanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.downloadcompleted
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.downloadfailed
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.downloadrequested
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.playbackbitratechanged
