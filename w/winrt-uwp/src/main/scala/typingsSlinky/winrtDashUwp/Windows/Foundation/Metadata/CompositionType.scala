...
object CompositionType extends js.Object {
  ...
  /* 0 */ val `protected`: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.CompositionType.`protected` with Double = js.native
  /* 1 */ val public: typingsSlinky.winrtDashUwp.Windows.Foundation.Metadata.CompositionType.public with Double = js.native
  @JSBracketAccess
