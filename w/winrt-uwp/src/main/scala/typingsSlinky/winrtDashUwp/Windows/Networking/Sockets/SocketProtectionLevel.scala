...
object SocketProtectionLevel extends js.Object {
  ...
  /* 3 */ val bluetoothEncryptionAllowNullAuthentication: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.bluetoothEncryptionAllowNullAuthentication with Double = js.native
  /* 4 */ val bluetoothEncryptionWithAuthentication: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.bluetoothEncryptionWithAuthentication with Double = js.native
  /* 0 */ val plainSocket: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.plainSocket with Double = js.native
  /* 1 */ val ssl: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.ssl with Double = js.native
  /* 5 */ val ssl3AllowWeakEncryption: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.ssl3AllowWeakEncryption with Double = js.native
  /* 2 */ val sslAllowNullEncryption: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.sslAllowNullEncryption with Double = js.native
  /* 6 */ val tls10: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls10 with Double = js.native
  /* 7 */ val tls11: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls11 with Double = js.native
  /* 8 */ val tls12: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls12 with Double = js.native
  @JSBracketAccess
