...
object SocketMessageType extends js.Object {
  ...
  /* 0 */ val binary: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketMessageType.binary with Double = js.native
  /* 1 */ val utf8: typingsSlinky.winrtDashUwp.Windows.Networking.Sockets.SocketMessageType.utf8 with Double = js.native
  @JSBracketAccess
