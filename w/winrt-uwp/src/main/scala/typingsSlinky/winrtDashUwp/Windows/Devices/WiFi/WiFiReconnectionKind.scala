...
object WiFiReconnectionKind extends js.Object {
  ...
  /* 0 */ val automatic: typingsSlinky.winrtDashUwp.Windows.Devices.WiFi.WiFiReconnectionKind.automatic with Double = js.native
  /* 1 */ val manual: typingsSlinky.winrtDashUwp.Windows.Devices.WiFi.WiFiReconnectionKind.manual with Double = js.native
  @JSBracketAccess
