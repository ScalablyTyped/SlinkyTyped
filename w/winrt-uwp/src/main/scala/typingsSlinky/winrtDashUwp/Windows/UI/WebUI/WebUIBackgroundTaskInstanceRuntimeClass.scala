...
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskCanceledEventHandler
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskCancellationReason
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskDeferral
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskRegistration
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.IBackgroundTaskInstance
