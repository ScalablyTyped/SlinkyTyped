...
object ToastTemplateType extends js.Object {
  ...
  /* 0 */ val toastImageAndText01: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastImageAndText01 with Double = js.native
  /* 1 */ val toastImageAndText02: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastImageAndText02 with Double = js.native
  /* 2 */ val toastImageAndText03: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastImageAndText03 with Double = js.native
  /* 3 */ val toastImageAndText04: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastImageAndText04 with Double = js.native
  /* 4 */ val toastText01: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastText01 with Double = js.native
  /* 5 */ val toastText02: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastText02 with Double = js.native
  /* 6 */ val toastText03: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastText03 with Double = js.native
  /* 7 */ val toastText04: typingsSlinky.winrtDashUwp.Windows.UI.Notifications.ToastTemplateType.toastText04 with Double = js.native
  @JSBracketAccess
