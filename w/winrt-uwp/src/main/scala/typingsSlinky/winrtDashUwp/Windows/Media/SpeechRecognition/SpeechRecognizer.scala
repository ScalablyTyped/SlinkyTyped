...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.hypothesisgenerated
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.recognitionqualitydegrading
