...
import typingsSlinky.winrtDashUwp.Windows.ApplicationModel.DataTransfer.DataPackagePropertySet
...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.previewing
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.progressing
