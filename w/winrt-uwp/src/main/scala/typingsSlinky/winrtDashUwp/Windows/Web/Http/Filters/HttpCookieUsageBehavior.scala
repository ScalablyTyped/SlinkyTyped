...
object HttpCookieUsageBehavior extends js.Object {
  ...
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior.default with Double = js.native
  /* 1 */ val noCookies: typingsSlinky.winrtDashUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior.noCookies with Double = js.native
  @JSBracketAccess
