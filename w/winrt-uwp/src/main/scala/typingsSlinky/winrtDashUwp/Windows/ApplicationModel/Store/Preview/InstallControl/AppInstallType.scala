...
object AppInstallType extends js.Object {
  ...
  /* 0 */ val install: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallType.install with Double = js.native
  /* 2 */ val repair: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallType.repair with Double = js.native
  /* 1 */ val update: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallType.update with Double = js.native
  @JSBracketAccess
