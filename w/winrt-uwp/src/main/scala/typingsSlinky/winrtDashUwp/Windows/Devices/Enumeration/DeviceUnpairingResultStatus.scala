...
object DeviceUnpairingResultStatus extends js.Object {
  ...
  /* 3 */ val accessDenied: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceUnpairingResultStatus.accessDenied with Double = js.native
  /* 1 */ val alreadyUnpaired: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceUnpairingResultStatus.alreadyUnpaired with Double = js.native
  /* 4 */ val failed: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceUnpairingResultStatus.failed with Double = js.native
  /* 2 */ val operationAlreadyInProgress: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceUnpairingResultStatus.operationAlreadyInProgress with Double = js.native
  /* 0 */ val unpaired: typingsSlinky.winrtDashUwp.Windows.Devices.Enumeration.DeviceUnpairingResultStatus.unpaired with Double = js.native
  @JSBracketAccess
