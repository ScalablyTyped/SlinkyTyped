...
object CryptographicPrivateKeyBlobType extends js.Object {
  ...
  /* 4 */ val bcryptEccFullPrivateKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPrivateKeyBlobType.bcryptEccFullPrivateKey with Double = js.native
  /* 2 */ val bcryptPrivateKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPrivateKeyBlobType.bcryptPrivateKey with Double = js.native
  /* 3 */ val capi1PrivateKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPrivateKeyBlobType.capi1PrivateKey with Double = js.native
  /* 1 */ val pkcs1RsaPrivateKey: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPrivateKeyBlobType.pkcs1RsaPrivateKey with Double = js.native
  /* 0 */ val pkcs8RawPrivateKeyInfo: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Core.CryptographicPrivateKeyBlobType.pkcs8RawPrivateKeyInfo with Double = js.native
  @JSBracketAccess
