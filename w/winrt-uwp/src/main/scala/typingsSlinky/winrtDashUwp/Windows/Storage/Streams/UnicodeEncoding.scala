...
object UnicodeEncoding extends js.Object {
  ...
  /* 2 */ val utf16BE: typingsSlinky.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf16BE with Double = js.native
  /* 1 */ val utf16LE: typingsSlinky.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf16LE with Double = js.native
  /* 0 */ val utf8: typingsSlinky.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf8 with Double = js.native
  @JSBracketAccess
