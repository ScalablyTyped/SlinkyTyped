...
object ImageScannerFormat extends js.Object {
  ...
  /* 2 */ val deviceIndependentBitmap: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.deviceIndependentBitmap with Double = js.native
  /* 0 */ val jpeg: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.jpeg with Double = js.native
  /* 5 */ val openXps: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.openXps with Double = js.native
  /* 6 */ val pdf: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.pdf with Double = js.native
  /* 1 */ val png: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.png with Double = js.native
  /* 3 */ val tiff: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.tiff with Double = js.native
  /* 4 */ val xps: typingsSlinky.winrtDashUwp.Windows.Devices.Scanners.ImageScannerFormat.xps with Double = js.native
  @JSBracketAccess
