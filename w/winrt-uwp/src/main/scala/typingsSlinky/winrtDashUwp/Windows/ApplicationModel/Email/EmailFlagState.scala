...
object EmailFlagState extends js.Object {
  ...
  /* 3 */ val cleared: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailFlagState.cleared with Double = js.native
  /* 2 */ val completed: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailFlagState.completed with Double = js.native
  /* 1 */ val flagged: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailFlagState.flagged with Double = js.native
  /* 0 */ val unflagged: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Email.EmailFlagState.unflagged with Double = js.native
  @JSBracketAccess
