...
object RadioAccessStatus extends js.Object {
  ...
  /* 1 */ val allowed: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.allowed with Double = js.native
  /* 3 */ val deniedBySystem: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.deniedBySystem with Double = js.native
  /* 2 */ val deniedByUser: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.deniedByUser with Double = js.native
  /* 0 */ val unspecified: typingsSlinky.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
