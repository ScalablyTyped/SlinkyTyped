...
object AudioDeviceRole extends js.Object {
  ...
  /* 1 */ val communications: typingsSlinky.winrtDashUwp.Windows.Media.Devices.AudioDeviceRole.communications with Double = js.native
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.Media.Devices.AudioDeviceRole.default with Double = js.native
  @JSBracketAccess
