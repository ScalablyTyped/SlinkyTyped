...
object ContactCardHeaderKind extends js.Object {
  ...
  /* 1 */ val basic: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactCardHeaderKind.basic with Double = js.native
  /* 0 */ val default: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactCardHeaderKind.default with Double = js.native
  /* 2 */ val enterprise: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactCardHeaderKind.enterprise with Double = js.native
  @JSBracketAccess
