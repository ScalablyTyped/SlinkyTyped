...
object KeySize extends js.Object {
  ...
  /* 0 */ val invalid: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.KeySize.invalid with Double = js.native
  /* 1 */ val rsa2048: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.KeySize.rsa2048 with Double = js.native
  /* 2 */ val rsa4096: typingsSlinky.winrtDashUwp.Windows.Security.Cryptography.Certificates.KeySize.rsa4096 with Double = js.native
  @JSBracketAccess
