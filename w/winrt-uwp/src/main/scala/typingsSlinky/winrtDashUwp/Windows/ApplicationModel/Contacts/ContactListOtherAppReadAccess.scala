...
object ContactListOtherAppReadAccess extends js.Object {
  ...
  /* 2 */ val full: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactListOtherAppReadAccess.full with Double = js.native
  /* 1 */ val limited: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactListOtherAppReadAccess.limited with Double = js.native
  /* 0 */ val systemOnly: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactListOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
