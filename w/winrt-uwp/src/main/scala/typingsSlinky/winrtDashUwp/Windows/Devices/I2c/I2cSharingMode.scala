...
object I2cSharingMode extends js.Object {
  ...
  /* 0 */ val exclusive: typingsSlinky.winrtDashUwp.Windows.Devices.I2c.I2cSharingMode.exclusive with Double = js.native
  /* 1 */ val shared: typingsSlinky.winrtDashUwp.Windows.Devices.I2c.I2cSharingMode.shared with Double = js.native
  @JSBracketAccess
