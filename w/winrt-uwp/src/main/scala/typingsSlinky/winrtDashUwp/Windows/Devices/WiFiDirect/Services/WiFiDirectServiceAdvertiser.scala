...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.advertisementstatuschanged
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.autoacceptsessionconnected
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.sessionrequested
