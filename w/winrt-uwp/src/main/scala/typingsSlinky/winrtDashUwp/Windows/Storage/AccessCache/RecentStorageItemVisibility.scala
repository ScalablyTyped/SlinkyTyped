...
object RecentStorageItemVisibility extends js.Object {
  ...
  /* 1 */ val appAndSystem: typingsSlinky.winrtDashUwp.Windows.Storage.AccessCache.RecentStorageItemVisibility.appAndSystem with Double = js.native
  /* 0 */ val appOnly: typingsSlinky.winrtDashUwp.Windows.Storage.AccessCache.RecentStorageItemVisibility.appOnly with Double = js.native
  @JSBracketAccess
