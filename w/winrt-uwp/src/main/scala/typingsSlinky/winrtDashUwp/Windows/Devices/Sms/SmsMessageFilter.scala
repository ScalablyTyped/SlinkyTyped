...
object SmsMessageFilter extends js.Object {
  ...
  /* 0 */ val all: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageFilter.all with Double = js.native
  /* 4 */ val draft: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageFilter.draft with Double = js.native
  /* 2 */ val read: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageFilter.read with Double = js.native
  /* 3 */ val sent: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageFilter.sent with Double = js.native
  /* 1 */ val unread: typingsSlinky.winrtDashUwp.Windows.Devices.Sms.SmsMessageFilter.unread with Double = js.native
  @JSBracketAccess
