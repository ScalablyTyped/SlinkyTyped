...
object SystemTriggerType extends js.Object {
  ...
  /* 13 */ val backgroundWorkCostChange: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.backgroundWorkCostChange with Double = js.native
  /* 5 */ val controlChannelReset: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.controlChannelReset with Double = js.native
  /* 6 */ val internetAvailable: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.internetAvailable with Double = js.native
  /* 0 */ val invalid: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.invalid with Double = js.native
  /* 9 */ val lockScreenApplicationAdded: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.lockScreenApplicationAdded with Double = js.native
  /* 10 */ val lockScreenApplicationRemoved: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.lockScreenApplicationRemoved with Double = js.native
  /* 4 */ val networkStateChange: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.networkStateChange with Double = js.native
  /* 12 */ val onlineIdConnectedStateChange: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.onlineIdConnectedStateChange with Double = js.native
  /* 14 */ val powerStateChange: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.powerStateChange with Double = js.native
  /* 8 */ val servicingComplete: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.servicingComplete with Double = js.native
  /* 7 */ val sessionConnected: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.sessionConnected with Double = js.native
  /* 1 */ val smsReceived: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.smsReceived with Double = js.native
  /* 11 */ val timeZoneChange: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.timeZoneChange with Double = js.native
  /* 3 */ val userAway: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.userAway with Double = js.native
  /* 2 */ val userPresent: typingsSlinky.winrtDashUwp.Windows.ApplicationModel.Background.SystemTriggerType.userPresent with Double = js.native
  @JSBracketAccess
