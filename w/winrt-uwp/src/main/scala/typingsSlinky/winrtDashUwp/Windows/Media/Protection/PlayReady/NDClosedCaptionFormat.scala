...
object NDClosedCaptionFormat extends js.Object {
  ...
  /* 0 */ val atsc: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDClosedCaptionFormat.atsc with Double = js.native
  /* 1 */ val scte20: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDClosedCaptionFormat.scte20 with Double = js.native
  /* 2 */ val unknown: typingsSlinky.winrtDashUwp.Windows.Media.Protection.PlayReady.NDClosedCaptionFormat.unknown with Double = js.native
  @JSBracketAccess
