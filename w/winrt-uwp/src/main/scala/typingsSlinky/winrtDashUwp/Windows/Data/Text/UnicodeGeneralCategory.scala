package typingsSlinky.winrtDashUwp.Windows.Data.Text
...
object UnicodeGeneralCategory extends js.Object {
  ...
  /* 21 */ val closePunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.closePunctuation with Double = js.native
  /* 18 */ val connectorPunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.connectorPunctuation with Double = js.native
  /* 14 */ val control: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.control with Double = js.native
  /* 26 */ val currencySymbol: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.currencySymbol with Double = js.native
  /* 19 */ val dashPunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.dashPunctuation with Double = js.native
  /* 8 */ val decimalDigitNumber: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.decimalDigitNumber with Double = js.native
  /* 7 */ val enclosingMark: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.enclosingMark with Double = js.native
  /* 23 */ val finalQuotePunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.finalQuotePunctuation with Double = js.native
  /* 15 */ val format: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.format with Double = js.native
  /* 22 */ val initialQuotePunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.initialQuotePunctuation with Double = js.native
  /* 9 */ val letterNumber: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.letterNumber with Double = js.native
  /* 12 */ val lineSeparator: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.lineSeparator with Double = js.native
  /* 1 */ val lowercaseLetter: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.lowercaseLetter with Double = js.native
  /* 25 */ val mathSymbol: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.mathSymbol with Double = js.native
  /* 3 */ val modifierLetter: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.modifierLetter with Double = js.native
  /* 27 */ val modifierSymbol: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.modifierSymbol with Double = js.native
  /* 5 */ val nonspacingMark: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.nonspacingMark with Double = js.native
  /* 29 */ val notAssigned: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.notAssigned with Double = js.native
  /* 20 */ val openPunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.openPunctuation with Double = js.native
  /* 4 */ val otherLetter: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.otherLetter with Double = js.native
  /* 10 */ val otherNumber: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.otherNumber with Double = js.native
  /* 24 */ val otherPunctuation: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.otherPunctuation with Double = js.native
  /* 28 */ val otherSymbol: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.otherSymbol with Double = js.native
  /* 13 */ val paragraphSeparator: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.paragraphSeparator with Double = js.native
  /* 17 */ val privateUse: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.privateUse with Double = js.native
  /* 11 */ val spaceSeparator: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.spaceSeparator with Double = js.native
  /* 6 */ val spacingCombiningMark: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.spacingCombiningMark with Double = js.native
  /* 16 */ val surrogate: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.surrogate with Double = js.native
  /* 2 */ val titlecaseLetter: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.titlecaseLetter with Double = js.native
  /* 0 */ val uppercaseLetter: typingsSlinky.winrtDashUwp.Windows.Data.Text.UnicodeGeneralCategory.uppercaseLetter with Double = js.native
  @JSBracketAccess
