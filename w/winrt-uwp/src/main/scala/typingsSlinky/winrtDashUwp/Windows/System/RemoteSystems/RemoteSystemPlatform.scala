...
object RemoteSystemPlatform extends js.Object {
  ...
  /* 2 */ val android: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemPlatform.android with Double = js.native
  /* 3 */ val ios: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemPlatform.ios with Double = js.native
  /* 4 */ val linux: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemPlatform.linux with Double = js.native
  /* 0 */ val unknown: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemPlatform.unknown with Double = js.native
  /* 1 */ val windows: typingsSlinky.winrtDashUwp.Windows.System.RemoteSystems.RemoteSystemPlatform.windows with Double = js.native
  @JSBracketAccess
