...
object LaunchQuerySupportStatus extends js.Object {
  ...
  /* 1 */ val appNotInstalled: typingsSlinky.winrtDashUwp.Windows.System.LaunchQuerySupportStatus.appNotInstalled with Double = js.native
  /* 2 */ val appUnavailable: typingsSlinky.winrtDashUwp.Windows.System.LaunchQuerySupportStatus.appUnavailable with Double = js.native
  /* 0 */ val available: typingsSlinky.winrtDashUwp.Windows.System.LaunchQuerySupportStatus.available with Double = js.native
  /* 3 */ val notSupported: typingsSlinky.winrtDashUwp.Windows.System.LaunchQuerySupportStatus.notSupported with Double = js.native
  /* 4 */ val unknown: typingsSlinky.winrtDashUwp.Windows.System.LaunchQuerySupportStatus.unknown with Double = js.native
  @JSBracketAccess
