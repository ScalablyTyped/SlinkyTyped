...
object TimedTextWritingMode extends js.Object {
  ...
  /* 4 */ val leftRight: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.leftRight with Double = js.native
  /* 0 */ val leftRightTopBottom: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.leftRightTopBottom with Double = js.native
  /* 5 */ val rightLeft: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.rightLeft with Double = js.native
  /* 1 */ val rightLeftTopBottom: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.rightLeftTopBottom with Double = js.native
  /* 6 */ val topBottom: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.topBottom with Double = js.native
  /* 3 */ val topBottomLeftRight: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.topBottomLeftRight with Double = js.native
  /* 2 */ val topBottomRightLeft: typingsSlinky.winrtDashUwp.Windows.Media.Core.TimedTextWritingMode.topBottomRightLeft with Double = js.native
  @JSBracketAccess
