...
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.connectionrequested
import typingsSlinky.winrtDashUwp.winrtDashUwpStrings.triggeredconnectionstatechanged
