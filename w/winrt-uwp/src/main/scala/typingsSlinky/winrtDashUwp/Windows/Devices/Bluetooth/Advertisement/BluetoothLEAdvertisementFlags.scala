...
object BluetoothLEAdvertisementFlags extends js.Object {
  ...
  /* 3 */ val classicNotSupported: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.classicNotSupported with Double = js.native
  /* 4 */ val dualModeControllerCapable: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.dualModeControllerCapable with Double = js.native
  /* 5 */ val dualModeHostCapable: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.dualModeHostCapable with Double = js.native
  /* 2 */ val generalDiscoverableMode: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.generalDiscoverableMode with Double = js.native
  /* 1 */ val limitedDiscoverableMode: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.limitedDiscoverableMode with Double = js.native
  /* 0 */ val none: typingsSlinky.winrtDashUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.none with Double = js.native
  @JSBracketAccess
