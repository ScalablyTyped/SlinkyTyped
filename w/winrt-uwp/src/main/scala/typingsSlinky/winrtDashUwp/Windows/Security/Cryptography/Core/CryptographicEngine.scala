...
object CryptographicEngine extends js.Object {
  ...
  /**
    ...
    */
  def decryptAsync(key: CryptographicKey, data: IBuffer, iv: IBuffer): IPromiseWithIAsyncOperation[IBuffer] = js.native
  /**
  ...
  /**
    ...
    */
  def signAsync(key: CryptographicKey, data: IBuffer): IPromiseWithIAsyncOperation[IBuffer] = js.native
  /**
    ...
    */
  def signHashedData(key: CryptographicKey, data: IBuffer): IBuffer = js.native
  /**
    * Signs the hashed input data using the specified key.
    * @param key The key to use to sign the hash. This key must be an asymmetric key obtained from a PersistedKeyProvider or AsymmetricKeyAlgorithmProvider .
    * @param data The input data to sign. The data is a hashed value which can be obtained through incremental hash.
    ...
    */
  def signHashedDataAsync(key: CryptographicKey, data: IBuffer): IPromiseWithIAsyncOperation[IBuffer] = js.native
  /**
  ...
  /**
    ...
    */
  def verifySignatureWithHashInput(key: CryptographicKey, data: IBuffer, signature: IBuffer): Boolean = js.native
}
