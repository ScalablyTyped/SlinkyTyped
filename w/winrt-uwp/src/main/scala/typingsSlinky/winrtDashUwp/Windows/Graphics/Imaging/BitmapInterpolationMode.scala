...
object BitmapInterpolationMode extends js.Object {
  ...
  /* 2 */ val cubic: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.cubic with Double = js.native
  /* 3 */ val fant: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.fant with Double = js.native
  /* 1 */ val linear: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.linear with Double = js.native
  /* 0 */ val nearestNeighbor: typingsSlinky.winrtDashUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.nearestNeighbor with Double = js.native
  @JSBracketAccess
