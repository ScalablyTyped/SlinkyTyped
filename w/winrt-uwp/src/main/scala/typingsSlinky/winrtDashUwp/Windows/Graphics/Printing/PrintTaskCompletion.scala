...
object PrintTaskCompletion extends js.Object {
  ...
  /* 0 */ val abandoned: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintTaskCompletion.abandoned with Double = js.native
  /* 1 */ val canceled: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintTaskCompletion.canceled with Double = js.native
  /* 2 */ val failed: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintTaskCompletion.failed with Double = js.native
  /* 3 */ val submitted: typingsSlinky.winrtDashUwp.Windows.Graphics.Printing.PrintTaskCompletion.submitted with Double = js.native
  @JSBracketAccess
