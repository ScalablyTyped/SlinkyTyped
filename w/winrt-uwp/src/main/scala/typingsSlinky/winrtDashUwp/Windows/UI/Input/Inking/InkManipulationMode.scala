...
object InkManipulationMode extends js.Object {
  ...
  /* 1 */ val erasing: typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking.InkManipulationMode.erasing with Double = js.native
  /* 0 */ val inking: typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking.InkManipulationMode.inking with Double = js.native
  /* 2 */ val selecting: typingsSlinky.winrtDashUwp.Windows.UI.Input.Inking.InkManipulationMode.selecting with Double = js.native
  @JSBracketAccess
