...
object FontStretch extends js.Object {
  ...
  /* 3 */ val condensed: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.condensed with Double = js.native
  /* 7 */ val expanded: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.expanded with Double = js.native
  /* 2 */ val extraCondensed: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.extraCondensed with Double = js.native
  /* 8 */ val extraExpanded: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.extraExpanded with Double = js.native
  /* 5 */ val normal: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.normal with Double = js.native
  /* 4 */ val semiCondensed: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.semiCondensed with Double = js.native
  /* 6 */ val semiExpanded: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.semiExpanded with Double = js.native
  /* 1 */ val ultraCondensed: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.ultraCondensed with Double = js.native
  /* 9 */ val ultraExpanded: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.ultraExpanded with Double = js.native
  /* 0 */ val undefined: typingsSlinky.winrtDashUwp.Windows.UI.Text.FontStretch.undefined with Double = js.native
  @JSBracketAccess
