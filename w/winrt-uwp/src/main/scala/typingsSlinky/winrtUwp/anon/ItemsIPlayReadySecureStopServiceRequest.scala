...
object ItemsIPlayReadySecureStopServiceRequest {
  ...
  @scala.inline
  implicit class ItemsIPlayReadySecureStopServiceRequestOps[Self <: ItemsIPlayReadySecureStopServiceRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: IPlayReadySecureStopServiceRequest): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
