...
@js.native
trait ItemsHttpProductInfoHeaderValue extends js.Object {
...
object ItemsHttpProductInfoHeaderValue {
  ...
  @scala.inline
  implicit class ItemsHttpProductInfoHeaderValueOps[Self <: ItemsHttpProductInfoHeaderValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: HttpProductInfoHeaderValue): Self = this.set("items", value.asInstanceOf[js.Any])
