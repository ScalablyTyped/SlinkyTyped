...
object ItemsHttpChallengeHeaderValue {
  ...
  @scala.inline
  implicit class ItemsHttpChallengeHeaderValueOps[Self <: ItemsHttpChallengeHeaderValue] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: HttpChallengeHeaderValue): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
