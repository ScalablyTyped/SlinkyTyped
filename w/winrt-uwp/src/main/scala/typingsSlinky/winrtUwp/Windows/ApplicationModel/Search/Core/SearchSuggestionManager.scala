...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Search.LocalContentSuggestionSettings
...
import typingsSlinky.winrtUwp.winrtUwpStrings.requestingfocusonkeyboardinput
