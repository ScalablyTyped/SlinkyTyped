...
trait SpatialGestureRecognizer extends js.Object {
  var addEventListener: js.Any
   /* unmapped type */ var cancelPendingGestures: js.Any
   /* unmapped type */ var captureInteraction: js.Any
   /* unmapped type */ var gestureSettings: js.Any
   /* unmapped type */ var onholdcanceled: js.Any
   /* unmapped type */ var onholdcompleted: js.Any
   /* unmapped type */ var onholdstarted: js.Any
   /* unmapped type */ var onmanipulationcanceled: js.Any
   /* unmapped type */ var onmanipulationcompleted: js.Any
   /* unmapped type */ var onmanipulationstarted: js.Any
   /* unmapped type */ var onmanipulationupdated: js.Any
   /* unmapped type */ var onnavigationcanceled: js.Any
   /* unmapped type */ var onnavigationcompleted: js.Any
   /* unmapped type */ var onnavigationstarted: js.Any
   /* unmapped type */ var onnavigationupdated: js.Any
   /* unmapped type */ var onrecognitionended: js.Any
   /* unmapped type */ var onrecognitionstarted: js.Any
   /* unmapped type */ var ontapped: js.Any
   /* unmapped type */ var removeEventListener: js.Any
   /* unmapped type */ var trySetGestureSettings: js.Any
}
