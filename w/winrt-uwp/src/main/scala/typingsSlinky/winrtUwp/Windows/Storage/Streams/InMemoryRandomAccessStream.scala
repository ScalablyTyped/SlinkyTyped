...
@js.native
trait InMemoryRandomAccessStream extends js.Object {
...
object InMemoryRandomAccessStream {
  ...
  @scala.inline
  implicit class InMemoryRandomAccessStreamOps[Self <: InMemoryRandomAccessStream] (val x: Self) extends AnyVal {
