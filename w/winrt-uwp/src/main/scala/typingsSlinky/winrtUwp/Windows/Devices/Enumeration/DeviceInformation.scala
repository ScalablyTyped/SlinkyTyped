...
object DeviceInformation {
  ...
  implicit class DeviceInformationOps[Self <: DeviceInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetGlyphThumbnailAsync(value: () => IPromiseWithIAsyncOperation[DeviceThumbnail]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getGlyphThumbnailAsync")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetThumbnailAsync(value: () => IPromiseWithIAsyncOperation[DeviceThumbnail]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPairing(value: DeviceInformationPairing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pairing")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
