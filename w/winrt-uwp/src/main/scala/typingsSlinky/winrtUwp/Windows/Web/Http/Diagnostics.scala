...
import typingsSlinky.winrtUwp.winrtUwpStrings.requestresponsecompleted
import typingsSlinky.winrtUwp.winrtUwpStrings.requestsent
import typingsSlinky.winrtUwp.winrtUwpStrings.responsereceived
...
object Diagnostics {
  ...
  object HttpDiagnosticProviderRequestResponseTimestamps {
    ...
    implicit class HttpDiagnosticProviderRequestResponseTimestampsMutableBuilder[Self <: HttpDiagnosticProviderRequestResponseTimestamps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCacheCheckedTimestamp(value: js.Date): Self = StObject.set(x, "cacheCheckedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConnectionCompletedTimestamp(value: js.Date): Self = StObject.set(x, "connectionCompletedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConnectionInitiatedTimestamp(value: js.Date): Self = StObject.set(x, "connectionInitiatedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNameResolvedTimestamp(value: js.Date): Self = StObject.set(x, "nameResolvedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRequestCompletedTimestamp(value: js.Date): Self = StObject.set(x, "requestCompletedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRequestSentTimestamp(value: js.Date): Self = StObject.set(x, "requestSentTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResponseCompletedTimestamp(value: js.Date): Self = StObject.set(x, "responseCompletedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResponseReceivedTimestamp(value: js.Date): Self = StObject.set(x, "responseReceivedTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSslNegotiatedTimestamp(value: js.Date): Self = StObject.set(x, "sslNegotiatedTimestamp", value.asInstanceOf[js.Any])
    }
  }
