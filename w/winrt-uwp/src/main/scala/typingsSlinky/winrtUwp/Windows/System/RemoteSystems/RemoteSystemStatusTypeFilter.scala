...
object RemoteSystemStatusTypeFilter {
  ...
  implicit class RemoteSystemStatusTypeFilterOps[Self <: RemoteSystemStatusTypeFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoteSystemStatusType(value: RemoteSystemStatusType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remoteSystemStatusType")(value.asInstanceOf[js.Any])
        ret
    }
  }
