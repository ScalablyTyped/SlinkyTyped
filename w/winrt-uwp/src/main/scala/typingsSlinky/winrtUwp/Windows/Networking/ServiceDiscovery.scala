...
import typingsSlinky.winrtUwp.AnonItemsDnssdServiceInstance
  ...
  object Dnssd extends js.Object {
    ...
    abstract class DnssdServiceInstanceCollection () extends Array[DnssdServiceInstance] {
      ...
      /**
        ...
        */
      @JSName("indexOf")
      def indexOf_AnonIndex(value: DnssdServiceInstance): AnonIndex = js.native
    }
    ...
    object DnssdServiceWatcherStatus extends js.Object {
      ...
      object stopped
        extends TopLevel[
                  typingsSlinky.winrtUwp.Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceWatcherStatus.stopped with Double
                ]
