...
@js.native
trait PlayReadyDomainLeaveServiceRequest extends StObject {
...
object PlayReadyDomainLeaveServiceRequest {
  ...
  @scala.inline
  implicit class PlayReadyDomainLeaveServiceRequestMutableBuilder[Self <: PlayReadyDomainLeaveServiceRequest] (val x: Self) extends AnyVal {
