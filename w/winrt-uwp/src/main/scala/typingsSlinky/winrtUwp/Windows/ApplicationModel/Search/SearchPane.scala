...
import typingsSlinky.winrtUwp.winrtUwpStrings.querychanged
import typingsSlinky.winrtUwp.winrtUwpStrings.querysubmitted
import typingsSlinky.winrtUwp.winrtUwpStrings.resultsuggestionchosen
import typingsSlinky.winrtUwp.winrtUwpStrings.suggestionsrequested
import typingsSlinky.winrtUwp.winrtUwpStrings.visibilitychanged
