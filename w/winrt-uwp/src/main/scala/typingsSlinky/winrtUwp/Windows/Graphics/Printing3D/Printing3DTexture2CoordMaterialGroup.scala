...
object Printing3DTexture2CoordMaterialGroup {
  ...
  implicit class Printing3DTexture2CoordMaterialGroupOps[Self <: Printing3DTexture2CoordMaterialGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTexture2Coords(value: IVector[Printing3DTexture2CoordMaterial]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("texture2Coords")(value.asInstanceOf[js.Any])
        ret
    }
  }
