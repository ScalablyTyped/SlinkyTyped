...
@js.native
trait MidiTimingClockMessage extends js.Object {
...
object MidiTimingClockMessage {
  @scala.inline
  def apply(rawData: IBuffer, timestamp: Double, `type`: MidiMessageType): MidiTimingClockMessage = {
  ...
  @scala.inline
  implicit class MidiTimingClockMessageOps[Self <: MidiTimingClockMessage] (val x: Self) extends AnyVal {
    @scala.inline
