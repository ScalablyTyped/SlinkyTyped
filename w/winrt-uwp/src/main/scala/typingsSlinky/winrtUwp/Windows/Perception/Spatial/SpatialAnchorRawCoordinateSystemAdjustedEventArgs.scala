...
object SpatialAnchorRawCoordinateSystemAdjustedEventArgs {
  ...
  implicit class SpatialAnchorRawCoordinateSystemAdjustedEventArgsOps[Self <: SpatialAnchorRawCoordinateSystemAdjustedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOldRawCoordinateSystemToNewRawCoordinateSystemTransform(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("oldRawCoordinateSystemToNewRawCoordinateSystemTransform")(value.asInstanceOf[js.Any])
        ret
    }
  }
