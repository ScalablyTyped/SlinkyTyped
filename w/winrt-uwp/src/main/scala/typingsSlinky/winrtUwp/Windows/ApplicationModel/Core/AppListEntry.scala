package typingsSlinky.winrtUwp.Windows.ApplicationModel.Core

import typingsSlinky.winrtUwp.Windows.ApplicationModel.AppDisplayInfo
...
object AppListEntry {
  ...
  implicit class AppListEntryOps[Self <: AppListEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLaunchAsync(value: () => IPromiseWithIAsyncOperation[Boolean]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("launchAsync")(js.Any.fromFunction0(value))
        ret
    }
  }
