...
import typingsSlinky.winrtUwp.winrtUwpStrings.answerrequested
import typingsSlinky.winrtUwp.winrtUwpStrings.audiotransferrequested
import typingsSlinky.winrtUwp.winrtUwpStrings.dialrequested
