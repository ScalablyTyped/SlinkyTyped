...
object PerceptionFrame {
  ...
  implicit class PerceptionFrameOps[Self <: PerceptionFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFrameData(value: IMemoryBuffer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("frameData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProperties(value: ValueSet): Self = {
        val ret = this.duplicate
