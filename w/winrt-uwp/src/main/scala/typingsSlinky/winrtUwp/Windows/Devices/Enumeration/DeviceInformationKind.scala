...
object DeviceInformationKind extends js.Object {
  ...
  @js.native
  sealed trait associationEndpoint extends DeviceInformationKind
  ...
  @js.native
  sealed trait associationEndpointContainer extends DeviceInformationKind
  ...
  @js.native
  sealed trait associationEndpointService extends DeviceInformationKind
  ...
  @js.native
  sealed trait device extends DeviceInformationKind
  ...
  @js.native
  sealed trait deviceContainer extends DeviceInformationKind
  ...
  @js.native
  sealed trait deviceInterface extends DeviceInformationKind
  ...
  @js.native
  sealed trait deviceInterfaceClass extends DeviceInformationKind
