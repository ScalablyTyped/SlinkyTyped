...
object Appointment {
  ...
  implicit class AppointmentMutableBuilder[Self <: Appointment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginalStartTime(value: js.Date): Self = StObject.set(x, "originalStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReplyTime(value: js.Date): Self = StObject.set(x, "replyTime", value.asInstanceOf[js.Any])
