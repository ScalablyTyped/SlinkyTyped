...
object Appointment {
  ...
  implicit class AppointmentOps[Self <: Appointment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginalStartTime(value: js.Date): Self = this.set("originalStartTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setReplyTime(value: js.Date): Self = this.set("replyTime", value.asInstanceOf[js.Any])
    @scala.inline
