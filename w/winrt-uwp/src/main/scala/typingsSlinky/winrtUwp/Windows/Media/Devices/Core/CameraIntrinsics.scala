...
object CameraIntrinsics {
  ...
  implicit class CameraIntrinsicsOps[Self <: CameraIntrinsics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFocalLength(value: Vector2): Self = {
    ...
    @scala.inline
    def withPrincipalPoint(value: Vector2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("principalPoint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProjectManyOntoFrame(value: Vector3 => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("projectManyOntoFrame")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withProjectOntoFrame(value: Vector3 => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("projectOntoFrame")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRadialDistortion(value: Vector3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("radialDistortion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTangentialDistortion(value: Vector2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tangentialDistortion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUnprojectAtUnitDepth(value: Point => Vector2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unprojectAtUnitDepth")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUnprojectPixelsAtUnitDepth(value: Point => Vector2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unprojectPixelsAtUnitDepth")(js.Any.fromFunction1(value))
        ret
    }
  }
