...
object CameraCaptureUI {
  ...
  implicit class CameraCaptureUIOps[Self <: CameraCaptureUI] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCaptureFileAsync(value: CameraCaptureUIMode => IPromiseWithIAsyncOperation[StorageFile]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("captureFileAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPhotoSettings(value: CameraCaptureUIPhotoCaptureSettings): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("photoSettings")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVideoSettings(value: CameraCaptureUIVideoCaptureSettings): Self = {
        val ret = this.duplicate
