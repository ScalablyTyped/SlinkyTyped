...
trait TileFlyoutUpdater extends js.Object {
  var clear: js.Any
   /* unmapped type */ var setting: js.Any
   /* unmapped type */ var startPeriodicUpdate: js.Any
   /* unmapped type */ var stopPeriodicUpdate: js.Any
   /* unmapped type */ var update: js.Any
}
