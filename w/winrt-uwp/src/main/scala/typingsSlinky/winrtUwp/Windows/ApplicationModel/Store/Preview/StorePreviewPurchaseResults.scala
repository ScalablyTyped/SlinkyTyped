...
object StorePreviewPurchaseResults {
  ...
  implicit class StorePreviewPurchaseResultsOps[Self <: StorePreviewPurchaseResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProductPurchaseStatus(value: StorePreviewProductPurchaseStatus): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("productPurchaseStatus")(value.asInstanceOf[js.Any])
        ret
    }
  }
