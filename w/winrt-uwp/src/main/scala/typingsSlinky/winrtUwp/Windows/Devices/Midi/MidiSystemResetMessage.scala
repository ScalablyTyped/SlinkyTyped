...
@js.native
trait MidiSystemResetMessage extends StObject {
...
object MidiSystemResetMessage {
  ...
  @scala.inline
  implicit class MidiSystemResetMessageMutableBuilder[Self <: MidiSystemResetMessage] (val x: Self) extends AnyVal {
