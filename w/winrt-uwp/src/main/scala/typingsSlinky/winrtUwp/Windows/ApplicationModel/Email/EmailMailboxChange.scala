...
object EmailMailboxChange {
  ...
  implicit class EmailMailboxChangeOps[Self <: EmailMailboxChange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangeType(value: EmailMailboxChangeType): Self = {
    ...
    @scala.inline
    def withMailboxActions(value: IVector[EmailMailboxAction]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mailboxActions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
