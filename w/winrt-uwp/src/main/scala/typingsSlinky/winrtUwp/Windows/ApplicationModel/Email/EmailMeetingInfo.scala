...
object EmailMeetingInfo {
  ...
  implicit class EmailMeetingInfoOps[Self <: EmailMeetingInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppointmentOriginalStartTime(value: js.Date): Self = this.set("appointmentOriginalStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProposedStartTime(value: js.Date): Self = this.set("proposedStartTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRecurrence(value: AppointmentRecurrence): Self = this.set("recurrence", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRecurrenceStartTime(value: js.Date): Self = this.set("recurrenceStartTime", value.asInstanceOf[js.Any])
