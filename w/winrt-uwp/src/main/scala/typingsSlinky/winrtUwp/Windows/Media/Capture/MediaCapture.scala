...
import typingsSlinky.winrtUwp.Windows.Media.Capture.Core.VariablePhotoSequenceCapture
import typingsSlinky.winrtUwp.Windows.Media.Devices.AudioDeviceController
import typingsSlinky.winrtUwp.Windows.Media.Devices.CameraStreamState
...
import typingsSlinky.winrtUwp.Windows.Media.IMediaExtension
import typingsSlinky.winrtUwp.Windows.Media.MediaProperties.IMediaEncodingProperties
import typingsSlinky.winrtUwp.Windows.Media.MediaProperties.ImageEncodingProperties
import typingsSlinky.winrtUwp.Windows.Media.MediaProperties.MediaEncodingProfile
import typingsSlinky.winrtUwp.Windows.Media.MediaProperties.MediaPropertySet
...
import typingsSlinky.winrtUwp.winrtUwpStrings.camerastreamstatechanged
import typingsSlinky.winrtUwp.winrtUwpStrings.failed
import typingsSlinky.winrtUwp.winrtUwpStrings.focuschanged
