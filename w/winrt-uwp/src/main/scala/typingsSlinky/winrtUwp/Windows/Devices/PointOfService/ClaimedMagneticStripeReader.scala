...
import typingsSlinky.winrtUwp.winrtUwpStrings.aamvacarddatareceived
import typingsSlinky.winrtUwp.winrtUwpStrings.bankcarddatareceived
...
import typingsSlinky.winrtUwp.winrtUwpStrings.vendorspecificdatareceived
