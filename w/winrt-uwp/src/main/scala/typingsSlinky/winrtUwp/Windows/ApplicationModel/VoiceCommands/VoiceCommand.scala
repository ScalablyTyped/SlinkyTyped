...
object VoiceCommand {
  ...
  implicit class VoiceCommandOps[Self <: VoiceCommand] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSpeechRecognitionResult(value: SpeechRecognitionResult): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("speechRecognitionResult")(value.asInstanceOf[js.Any])
        ret
    }
  }
