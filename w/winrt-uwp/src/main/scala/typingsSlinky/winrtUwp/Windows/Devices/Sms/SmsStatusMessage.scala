...
object SmsStatusMessage {
  ...
  implicit class SmsStatusMessageOps[Self <: SmsStatusMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDischargeTime(value: js.Date): Self = this.set("dischargeTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setServiceCenterTimestamp(value: js.Date): Self = this.set("serviceCenterTimestamp", value.asInstanceOf[js.Any])
