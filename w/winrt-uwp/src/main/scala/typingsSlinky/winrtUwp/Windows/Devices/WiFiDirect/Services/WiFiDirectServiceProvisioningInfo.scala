...
object WiFiDirectServiceProvisioningInfo {
  ...
  implicit class WiFiDirectServiceProvisioningInfoOps[Self <: WiFiDirectServiceProvisioningInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsGroupFormationNeeded(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isGroupFormationNeeded")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSelectedConfigurationMethod(value: WiFiDirectServiceConfigurationMethod): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectedConfigurationMethod")(value.asInstanceOf[js.Any])
        ret
    }
  }
