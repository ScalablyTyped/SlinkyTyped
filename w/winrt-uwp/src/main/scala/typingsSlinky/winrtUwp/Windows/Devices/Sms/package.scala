...
package object Sms {
  ...
  type SmsDeviceStatusChangedEventHandler = js.Function1[
    /* ev */ typingsSlinky.winrtUwp.Windows.WinRTEvent[typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsDevice], 
    scala.Unit
  ]
  ...
  type SmsMessageReceivedEventHandler = js.Function1[
    /* ev */ typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsMessageReceivedEventArgs with typingsSlinky.winrtUwp.Windows.WinRTEvent[typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsDevice], 
    scala.Unit
  ]
}
