...
import typingsSlinky.winrtUwp.Windows.Media.SystemMediaTransportControls
...
import typingsSlinky.winrtUwp.winrtUwpStrings.bufferingended
import typingsSlinky.winrtUwp.winrtUwpStrings.bufferingstarted
import typingsSlinky.winrtUwp.winrtUwpStrings.currentstatechanged
import typingsSlinky.winrtUwp.winrtUwpStrings.mediaended
import typingsSlinky.winrtUwp.winrtUwpStrings.mediafailed
import typingsSlinky.winrtUwp.winrtUwpStrings.mediaopened
import typingsSlinky.winrtUwp.winrtUwpStrings.mediaplayerratechanged
