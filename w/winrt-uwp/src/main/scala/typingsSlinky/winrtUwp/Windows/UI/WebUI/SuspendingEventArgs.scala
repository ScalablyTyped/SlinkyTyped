...
object SuspendingEventArgs {
  ...
  implicit class SuspendingEventArgsMutableBuilder[Self <: SuspendingEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuspendingOperation(value: typingsSlinky.winrtUwp.Windows.ApplicationModel.SuspendingOperation): Self = StObject.set(x, "suspendingOperation", value.asInstanceOf[js.Any])
  }
}
