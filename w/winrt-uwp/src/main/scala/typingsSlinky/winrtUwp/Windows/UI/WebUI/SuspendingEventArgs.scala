...
object SuspendingEventArgs {
  ...
  implicit class SuspendingEventArgsOps[Self <: SuspendingEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuspendingOperation(value: typingsSlinky.winrtUwp.Windows.ApplicationModel.SuspendingOperation): Self = this.set("suspendingOperation", value.asInstanceOf[js.Any])
  }
}
