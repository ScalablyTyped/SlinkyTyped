...
object IPerceptionFrameProviderManager {
  ...
  implicit class IPerceptionFrameProviderManagerOps[Self <: IPerceptionFrameProviderManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetFrameProvider(value: PerceptionFrameProviderInfo => IPerceptionFrameProvider): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFrameProvider")(js.Any.fromFunction1(value))
        ret
    }
  }
