...
object Printing3DMultiplePropertyMaterialGroup {
  ...
  implicit class Printing3DMultiplePropertyMaterialGroupOps[Self <: Printing3DMultiplePropertyMaterialGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaterialGroupIndices(value: IVector[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("materialGroupIndices")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMultipleProperties(value: IVector[Printing3DMultiplePropertyMaterial]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multipleProperties")(value.asInstanceOf[js.Any])
        ret
    }
  }
