...
import typingsSlinky.winrtUwp.winrtUwpStrings.loggingenabled
...
class LoggingChannel protected () extends js.Object {
  ...
  /**
    ...
    */
  def this(name: String, options: LoggingChannelOptions) = this()
  /**
    ...
    */
  def this(name: String, options: LoggingChannelOptions, id: String) = this()
