...
object INDDownloadEngine {
  ...
  implicit class INDDownloadEngineOps[Self <: INDDownloadEngine] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBufferFullMaxThresholdInSamples(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bufferFullMaxThresholdInSamples")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBufferFullMinThresholdInSamples(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bufferFullMinThresholdInSamples")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNotifier(value: NDDownloadEngineNotifier): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOpen(value: (Uri, js.Array[Double]) => Unit): Self = {
        val ret = this.duplicate
