package typingsSlinky.winrtUwp.Windows.Devices.I2c.Provider
...
object II2cProvider {
  ...
  implicit class II2cProviderOps[Self <: II2cProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetControllersAsync(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getControllersAsync")(value.asInstanceOf[js.Any])
        ret
    }
  }
