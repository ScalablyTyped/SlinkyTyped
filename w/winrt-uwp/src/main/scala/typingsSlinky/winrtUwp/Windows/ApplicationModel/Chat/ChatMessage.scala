...
object ChatMessage {
  ...
  implicit class ChatMessageOps[Self <: ChatMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalTimestamp(value: js.Date): Self = this.set("localTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNetworkTimestamp(value: js.Date): Self = this.set("networkTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
