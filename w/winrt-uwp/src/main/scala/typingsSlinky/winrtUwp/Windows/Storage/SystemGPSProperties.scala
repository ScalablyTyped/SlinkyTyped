...
object SystemGPSProperties {
  ...
  implicit class SystemGPSPropertiesOps[Self <: SystemGPSProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLatitudeDecimal(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("latitudeDecimal")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLongitudeDecimal(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("longitudeDecimal")(value.asInstanceOf[js.Any])
        ret
    }
  }
