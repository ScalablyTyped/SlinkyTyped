...
object ContentRestrictionsBrowsePolicy {
  ...
  implicit class ContentRestrictionsBrowsePolicyOps[Self <: ContentRestrictionsBrowsePolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxBrowsableAgeRating(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxBrowsableAgeRating")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPreferredAgeRating(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preferredAgeRating")(value.asInstanceOf[js.Any])
        ret
    }
  }
