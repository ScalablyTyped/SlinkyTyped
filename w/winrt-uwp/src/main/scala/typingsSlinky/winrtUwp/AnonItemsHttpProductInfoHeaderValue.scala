...
trait AnonItemsHttpProductInfoHeaderValue extends js.Object {
  /** An array of HttpProductInfoHeaderValue items that start at startIndex in the HttpProductInfoHeaderValueCollection . */ var items: HttpProductInfoHeaderValue = js.native
...
object AnonItemsHttpProductInfoHeaderValue {
  ...
  @scala.inline
  implicit class AnonItemsHttpProductInfoHeaderValueOps[Self <: AnonItemsHttpProductInfoHeaderValue] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withItems(value: HttpProductInfoHeaderValue): Self = {
