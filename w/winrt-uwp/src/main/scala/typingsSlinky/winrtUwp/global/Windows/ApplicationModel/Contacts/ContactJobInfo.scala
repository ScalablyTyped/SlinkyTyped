...
class ContactJobInfo ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactJobInfo {
  ...
  /* CompleteClass */
  override var companyAddress: String = js.native
  ...
  /* CompleteClass */
  override var companyName: String = js.native
  ...
  /* CompleteClass */
  override var companyYomiName: String = js.native
