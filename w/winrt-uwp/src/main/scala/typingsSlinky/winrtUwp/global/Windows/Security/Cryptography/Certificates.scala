...
import typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ExportOption
import typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.InstallOptions
import typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.KeyProtectionLevel
...
object Certificates {
  ...
  object CertificateChainPolicy extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateChainPolicy with Double
      ] = js.native
    
    /* 0 */ val base: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateChainPolicy.base with Double = js.native
    
    /* 3 */ val microsoftRoot: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateChainPolicy.microsoftRoot with Double = js.native
    
    /* 2 */ val ntAuthentication: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateChainPolicy.ntAuthentication with Double = js.native
    
    /* 1 */ val ssl: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateChainPolicy.ssl with Double = js.native
  }
  ...
  object CertificateEnrollmentManager {
    ...
    @js.native
    def userCertificateEnrollmentManager: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.UserCertificateEnrollmentManager = js.native
    @scala.inline
    def userCertificateEnrollmentManager_=(
      x: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.UserCertificateEnrollmentManager
  ...
  object CertificateStores {
    ...
    @js.native
    def intermediateCertificationAuthorities: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateStore = js.native
    @scala.inline
    def intermediateCertificationAuthorities_=(x: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateStore): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("intermediateCertificationAuthorities")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def trustedRootCertificationAuthorities: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateStore = js.native
    @scala.inline
    def trustedRootCertificationAuthorities_=(x: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateStore): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("trustedRootCertificationAuthorities")(x.asInstanceOf[js.Any])
  }
  ...
  class ChainValidationParameters ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ChainValidationParameters
  ...
  object ExportOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ExportOption with Double
      ] = js.native
    
    /* 1 */ val exportable: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ExportOption.exportable with Double = js.native
    
    /* 0 */ val notExportable: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ExportOption.notExportable with Double = js.native
  }
  ...
  class PfxImportParameters ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.PfxImportParameters
  ...
  object SignatureValidationResult extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult with Double
      ] = js.native
    
    /* 2 */ val badMessage: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.badMessage with Double = js.native
    
    /* 1 */ val invalidParameter: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.invalidParameter with Double = js.native
    
    /* 3 */ val invalidSignature: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.invalidSignature with Double = js.native
    
    /* 4 */ val otherErrors: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.otherErrors with Double = js.native
    
    /* 0 */ val success: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.success with Double = js.native
  }
