...
abstract class SearchPaneSuggestionsRequest ()
  ...
  /* CompleteClass */
  override var searchSuggestionCollection: typingsSlinky.winrtUwp.Windows.ApplicationModel.Search.SearchSuggestionCollection = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Search.SearchPaneSuggestionsRequestDeferral = js.native
}
