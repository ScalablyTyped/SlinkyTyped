...
abstract class ReceiptPrinterCapabilities ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.ReceiptPrinterCapabilities {
  ...
  /* CompleteClass */
  override var cartridgeSensors: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterCartridgeSensors = js.native
  /** Gets the color cartridges that the receipt printer station can use to print in color. */
  /* CompleteClass */
  override var colorCartridgeCapabilities: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities = js.native
  ...
  /* CompleteClass */
  override var markFeedCapabilities: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedCapabilities = js.native
  /** Gets information about the capabilities of the receipt printer station to draw ruled lines. */
  /* CompleteClass */
  override var ruledLineCapabilities: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterRuledLineCapabilities = js.native
  /** Gets a list of the directions in which the receipt printer station can rotate a barcode when printing. */
  /* CompleteClass */
  override var supportedBarcodeRotations: IVectorView[typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterRotation] = js.native
  /** Gets a list of the directions in which the receipt printer station can rotate a bitmap when printing. */
  /* CompleteClass */
  override var supportedBitmapRotations: IVectorView[typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterRotation] = js.native
