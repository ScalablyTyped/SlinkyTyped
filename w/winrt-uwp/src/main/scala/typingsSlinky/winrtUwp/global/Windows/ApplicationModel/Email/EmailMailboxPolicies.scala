...
abstract class EmailMailboxPolicies ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxPolicies {
  ...
  /* CompleteClass */
  override var allowedSmimeEncryptionAlgorithmNegotiation: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation = js.native
  ...
  /* CompleteClass */
  override var requiredSmimeEncryptionAlgorithm: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeEncryptionAlgorithm = js.native
  /** Gets the required SMIME signing algorithm. */
  /* CompleteClass */
  override var requiredSmimeSigningAlgorithm: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm = js.native
}
