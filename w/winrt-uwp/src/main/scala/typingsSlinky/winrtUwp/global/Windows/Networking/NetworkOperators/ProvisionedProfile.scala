...
import typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.ProfileUsage
...
abstract class ProvisionedProfile ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.ProvisionedProfile {
  /**
