...
abstract class FileRevocationManager ()
  extends typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileRevocationManager
/* static members */
@JSGlobal("Windows.Security.EnterpriseData.FileRevocationManager")
@js.native
object FileRevocationManager extends js.Object {
  ...
  /**
    ...
    */
  def getStatusAsync(storageItem: IStorageItem): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus] = js.native
  ...
  /**
    ...
    */
  def protectAsync(storageItem: IStorageItem, enterpriseIdentity: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus] = js.native
