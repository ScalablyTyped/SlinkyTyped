...
abstract class FileProtectionInfo ()
  extends typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo {
  ...
  /* CompleteClass */
  override var status: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus = js.native
}
