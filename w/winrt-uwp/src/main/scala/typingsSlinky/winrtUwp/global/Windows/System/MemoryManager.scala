...
object MemoryManager {
  ...
  @js.native
  def appMemoryUsageLevel: typingsSlinky.winrtUwp.Windows.System.AppMemoryUsageLevel = js.native
  @scala.inline
  def appMemoryUsageLevel_=(x: typingsSlinky.winrtUwp.Windows.System.AppMemoryUsageLevel): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("appMemoryUsageLevel")(x.asInstanceOf[js.Any])
