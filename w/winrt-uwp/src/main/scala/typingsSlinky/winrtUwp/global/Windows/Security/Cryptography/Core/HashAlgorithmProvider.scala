...
abstract class HashAlgorithmProvider ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.HashAlgorithmProvider {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createHash(): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicHash = js.native
  /**
    * Hashes binary data.
...
object HashAlgorithmProvider extends js.Object {
  /**
    ...
    */
  def openAlgorithm(algorithm: String): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.HashAlgorithmProvider = js.native
}
