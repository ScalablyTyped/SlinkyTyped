...
class SmsFilterRule protected ()
  ...
  /**
    ...
    */
  def this(messageType: typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsMessageType) = this()
  ...
  /* CompleteClass */
  override var broadcastTypes: IVector[typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsBroadcastType] = js.native
