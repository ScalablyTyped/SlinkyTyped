...
import typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptor
...
class NDDownloadEngineNotifier ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDDownloadEngineNotifier {
  /**
