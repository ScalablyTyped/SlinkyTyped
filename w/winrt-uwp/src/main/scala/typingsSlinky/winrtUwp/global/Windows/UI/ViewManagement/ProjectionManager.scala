...
import typingsSlinky.winrtUwp.winrtUwpStrings.projectiondisplayavailablechanged
...
abstract class ProjectionManager ()
  extends typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ProjectionManager
