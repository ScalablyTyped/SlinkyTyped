...
abstract class NetworkOperatorNotificationEventDetails ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorNotificationEventDetails {
  ...
  /* CompleteClass */
  override var notificationType: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorEventMessageType = js.native
