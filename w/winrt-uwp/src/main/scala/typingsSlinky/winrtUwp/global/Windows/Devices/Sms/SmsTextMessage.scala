...
import typingsSlinky.winrtUwp.Windows.Devices.Sms.ISmsBinaryMessage
...
class SmsTextMessage ()
  ...
  /* CompleteClass */
  override var encoding: typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsEncoding = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def toBinaryMessages(format: typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsDataFormat): IVectorView[ISmsBinaryMessage] = js.native
}
...
object SmsTextMessage extends js.Object {
  /**
    ...
    */
  def fromBinaryData(format: typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsDataFormat, value: js.Array[Double]): typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsTextMessage = js.native
  /**
