...
abstract class KnownContactField ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.KnownContactField
object KnownContactField {
  ...
  @js.native
  def convertNameToType(name: String): typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType = js.native
  ...
  @js.native
  def convertTypeToName(`type`: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType): String = js.native
