...
import typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel
import typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus
...
object EnterpriseData {
  ...
  object EnforcementLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel with Double
      ] = js.native
    
    /* 3 */ val block: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.block with Double = js.native
    
    /* 0 */ val noProtection: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.noProtection with Double = js.native
    
    /* 2 */ val `override`: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.`override` with Double = js.native
    
    /* 1 */ val silent: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.silent with Double = js.native
  }
  ...
  object FileProtectionStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus with Double
      ] = js.native
    
    /* 10 */ val accessSuspended: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.accessSuspended with Double = js.native
    
    /* 9 */ val licenseExpired: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.licenseExpired with Double = js.native
    
    /* 7 */ val notProtectable: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.notProtectable with Double = js.native
    
    /* 4 */ val `protected`: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.`protected` with Double = js.native
    
    /* 5 */ val protectedByOtherUser: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedByOtherUser with Double = js.native
    
    /* 6 */ val protectedToOtherEnterprise: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedToOtherEnterprise with Double = js.native
    
    /* 8 */ val protectedToOtherIdentity: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedToOtherIdentity with Double = js.native
    
    /* 3 */ val revoked: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.revoked with Double = js.native
    
    /* 0 */ val undetermined: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.undetermined with Double = js.native
    
    /* 1 */ val unknown: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.unknown with Double = js.native
    
    /* 2 */ val unprotected: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.unprotected with Double = js.native
  }
  ...
  object ProtectedImportExportStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus with Double
      ] = js.native
    
    /* 7 */ val accessSuspended: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.accessSuspended with Double = js.native
    
    /* 6 */ val licenseExpired: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.licenseExpired with Double = js.native
    
    /* 4 */ val notRoamable: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.notRoamable with Double = js.native
    
    /* 0 */ val ok: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.ok with Double = js.native
    
    /* 5 */ val protectedToOtherIdentity: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.protectedToOtherIdentity with Double = js.native
    
    /* 3 */ val revoked: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.revoked with Double = js.native
    
    /* 1 */ val undetermined: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.undetermined with Double = js.native
    
    /* 2 */ val unprotected: typingsSlinky.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.unprotected with Double = js.native
  }
