...
class PhoneCallHistoryEntry ()
  ...
  /* CompleteClass */
  override var address: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryAddress = js.native
  ...
  /* CompleteClass */
  override var media: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia = js.native
  /** Gets or sets the level of access provided to other applications. */
  /* CompleteClass */
  override var otherAppReadAccess: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess = js.native
  ...
  /* CompleteClass */
  override var sourceIdKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind = js.native
