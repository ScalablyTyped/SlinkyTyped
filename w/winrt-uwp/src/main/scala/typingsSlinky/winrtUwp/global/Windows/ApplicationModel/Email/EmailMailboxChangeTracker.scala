...
abstract class EmailMailboxChangeTracker ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChangeReader = js.native
