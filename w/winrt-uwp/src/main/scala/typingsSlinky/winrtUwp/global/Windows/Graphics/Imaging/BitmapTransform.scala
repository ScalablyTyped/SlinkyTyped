...
class BitmapTransform ()
  ...
  /* CompleteClass */
  override var flip: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFlip = js.native
  /** Specifies the interpolation mode that is used to scale the bitmap. */
  /* CompleteClass */
  override var interpolationMode: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode = js.native
  /** Specifies the rotation operation that is used to transform the bitmap. */
  /* CompleteClass */
  override var rotation: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapRotation = js.native
