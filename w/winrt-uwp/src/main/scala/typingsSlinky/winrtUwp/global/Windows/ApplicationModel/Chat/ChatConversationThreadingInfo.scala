...
class ChatConversationThreadingInfo ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatConversationThreadingInfo {
  ...
  /* CompleteClass */
  override var kind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatConversationThreadingKind = js.native
