...
class HttpTransferCodingHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpTransferCodingHeaderValue {
  /**
...
object HttpTransferCodingHeaderValue extends js.Object {
  /**
    ...
    */
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpTransferCodingHeaderValue = js.native
  /**
