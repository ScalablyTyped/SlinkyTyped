...
import typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus
...
object Radios extends js.Object {
  ...
  abstract class Radio ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Radios.Radio
  ...
  object Radio extends js.Object {
    /**
      ...
      */
    def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Radios.Radio] = js.native
    /**
  ...
  object RadioAccessStatus extends js.Object {
    /* 1 */ val allowed: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus.allowed with Double = js.native
    /* 3 */ val deniedBySystem: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus.deniedBySystem with Double = js.native
    /* 2 */ val deniedByUser: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus.deniedByUser with Double = js.native
    /* 0 */ val unspecified: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus.unspecified with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioAccessStatus with Double] = js.native
  }
  
  /** Enumeration that represents the kinds of radio devices. */
  @js.native
  object RadioKind extends js.Object {
    /* 3 */ val bluetooth: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind.bluetooth with Double = js.native
    /* 4 */ val fm: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind.fm with Double = js.native
    /* 2 */ val mobileBroadband: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind.mobileBroadband with Double = js.native
    /* 0 */ val other: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind.other with Double = js.native
    /* 1 */ val wiFi: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind.wiFi with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioKind with Double] = js.native
  }
  
  /** Enumeration that describes possible radio states. */
  @js.native
  object RadioState extends js.Object {
    /* 3 */ val disabled: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioState.disabled with Double = js.native
    /* 2 */ val off: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioState.off with Double = js.native
    /* 1 */ val on: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioState.on with Double = js.native
    /* 0 */ val unknown: typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioState.unknown with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Radios.RadioState with Double] = js.native
  }
