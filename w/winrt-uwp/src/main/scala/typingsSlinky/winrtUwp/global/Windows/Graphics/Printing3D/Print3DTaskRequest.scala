...
import typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskSourceRequestedHandler
...
abstract class Print3DTaskRequest ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createTask(title: String, printerId: String, handler: Print3DTaskSourceRequestedHandler): typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Print3DTask = js.native
}
