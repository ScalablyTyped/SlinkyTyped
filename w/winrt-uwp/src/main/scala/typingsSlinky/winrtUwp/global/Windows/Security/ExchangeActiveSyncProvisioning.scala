...
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasDisallowConvenienceLogonResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasEncryptionProviderType
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasMaxInactivityTimeLockResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasMaxPasswordFailedAttemptsResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasMinPasswordComplexCharactersResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasMinPasswordLengthResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasPasswordExpirationResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasPasswordHistoryResult
import typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasRequireEncryptionResult
...
object ExchangeActiveSyncProvisioning extends js.Object {
  ...
  class EasClientSecurityPolicy ()
    ...
    override def applyAsync(): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasComplianceResults
      ] = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def checkCompliance(): typingsSlinky.winrtUwp.Windows.Security.ExchangeActiveSyncProvisioning.EasComplianceResults = js.native
  }
