...
abstract class NetworkOperatorTetheringManager ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringManager {
  ...
  /* CompleteClass */
  override var tetheringOperationalState: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.TetheringOperationalState = js.native
  /**
  ...
  override def configureAccessPointAsync(
    configuration: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringAccessPointConfiguration
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getCurrentAccessPointConfiguration(): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringAccessPointConfiguration = js.native
  /**
  ...
  override def getTetheringClients(): IVectorView[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringClient
  ] = js.native
  /**
  ...
  override def startTetheringAsync(): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringOperationResult
  ] = js.native
  /**
...
object NetworkOperatorTetheringManager extends js.Object {
  /**
    ...
    */
  def createFromConnectionProfile(profile: ConnectionProfile): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringManager = js.native
  /**
    ...
    */
  def createFromNetworkAccountId(networkAccountId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringManager = js.native
  /**
    ...
    */
  def getTetheringCapability(networkAccountId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.TetheringCapability = js.native
  /**
    ...
    */
  def getTetheringCapabilityFromConnectionProfile(profile: ConnectionProfile): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.TetheringCapability = js.native
}
