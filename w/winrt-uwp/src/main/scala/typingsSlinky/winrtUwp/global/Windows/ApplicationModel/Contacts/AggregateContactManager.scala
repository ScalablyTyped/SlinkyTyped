...
abstract class AggregateContactManager ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.AggregateContactManager {
  /**
    ...
    */
  /* CompleteClass */
  override def findRawContactsAsync(contact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
  /**
  ...
  override def tryLinkContactsAsync(
    primaryContact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact,
    secondaryContact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact
  ): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact] = js.native
  /**
  ...
  override def trySetPreferredSourceForPictureAsync(
    aggregateContact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact,
    rawContact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def unlinkRawContactAsync(contact: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact): IPromiseWithIAsyncAction = js.native
}
