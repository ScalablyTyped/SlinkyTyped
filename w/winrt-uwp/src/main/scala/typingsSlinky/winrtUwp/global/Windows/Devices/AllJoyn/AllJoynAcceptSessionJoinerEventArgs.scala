...
class AllJoynAcceptSessionJoinerEventArgs protected ()
  ...
  def this(
    uniqueName: String,
    sessionPort: Double,
    trafficType: typingsSlinky.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType,
    proximity: Double,
  ...
  /* CompleteClass */
  override var trafficType: typingsSlinky.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType = js.native
