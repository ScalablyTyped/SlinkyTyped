...
object Imaging {
  ...
  object BitmapAlphaMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode with Double] = js.native
    
    /* 2 */ val ignore: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.ignore with Double = js.native
    
    /* 0 */ val premultiplied: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.premultiplied with Double = js.native
    
    /* 1 */ val straight: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.straight with Double = js.native
  }
  ...
  abstract class BitmapEncoder ()
    extends typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder
  object BitmapEncoder {
    ...
    @js.native
    def createAsync(encoderId: String, stream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = js.native
    /**
    ...
    @JSGlobal("Windows.Graphics.Imaging.BitmapEncoder.createAsync")
    @js.native
    def createAsync(encoderId: String, stream: IRandomAccessStream, encodingOptions: IIterable[IKeyValuePair[_, _]]): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = js.native
    ...
    @js.native
    def createForInPlacePropertyEncodingAsync(bitmapDecoder: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = js.native
    ...
    def createForTranscodingAsync(
      ...
      bitmapDecoder: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder
    ): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = js.native
    ...
    @js.native
    def getEncoderInformationEnumerator(): IVectorView[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation] = js.native
  ...
  object BitmapFlip extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFlip with Double] = js.native
    
    /* 1 */ val horizontal: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.horizontal with Double = js.native
    
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.none with Double = js.native
    
    /* 2 */ val vertical: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.vertical with Double = js.native
  }
  ...
  abstract class BitmapFrame ()
    extends typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapFrame
  ...
  abstract class BitmapProperties ()
    extends typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapProperties
  ...
  class BitmapTypedValue protected ()
    extends typingsSlinky.winrtUwp.Windows.Graphics.Imaging.BitmapTypedValue {
    /**
  ...
  object ExifOrientationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode with Double] = js.native
    
    /* 0 */ val ignoreExifOrientation: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode.ignoreExifOrientation with Double = js.native
    
    /* 1 */ val respectExifOrientation: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode.respectExifOrientation with Double = js.native
  }
  ...
  object SoftwareBitmap {
    ...
    @js.native
    def convert(source: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap, format: BitmapPixelFormat): typingsSlinky.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = js.native
    /**
    ...
    @js.native
    def createCopyFromBuffer(source: IBuffer, format: BitmapPixelFormat, width: Double, height: Double): typingsSlinky.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = js.native
    /**
      * Creates a new SoftwareBitmap by performing a deep copy of the provided buffer. Modifications to the data in the new SoftwareBitmap will not effect the buffer from which it was created.
      * @param source The source buffer from which the copy will be created.
      * @param format The pixel format of the software bitmap.
    ...
    @JSGlobal("Windows.Graphics.Imaging.SoftwareBitmap.createCopyFromBuffer")
    @js.native
    def createCopyFromBuffer(source: IBuffer, format: BitmapPixelFormat, width: Double, height: Double, alpha: BitmapAlphaMode): typingsSlinky.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = js.native
    ...
    @JSGlobal("Windows.Graphics.Imaging.SoftwareBitmap.createCopyFromSurfaceAsync")
    @js.native
    def createCopyFromSurfaceAsync(surface: IDirect3DSurface, alpha: BitmapAlphaMode): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap] = js.native
  }
  ...
  object TiffCompressionMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode with Double] = js.native
    
    /* 0 */ val automatic: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.automatic with Double = js.native
    
    /* 2 */ val ccitt3: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.ccitt3 with Double = js.native
    
    /* 3 */ val ccitt4: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.ccitt4 with Double = js.native
    
    /* 4 */ val lzw: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.lzw with Double = js.native
    
    /* 7 */ val lzwhDifferencing: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.lzwhDifferencing with Double = js.native
    
    /* 1 */ val none: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.none with Double = js.native
    
    /* 5 */ val rle: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.rle with Double = js.native
    
    /* 6 */ val zip: typingsSlinky.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.zip with Double = js.native
  }
}
