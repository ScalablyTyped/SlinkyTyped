...
class AppointmentRecurrence ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrence {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var daysOfWeek: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentDaysOfWeek = js.native
  ...
  /* CompleteClass */
  override var recurrenceType: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.RecurrenceType = js.native
  ...
  /* CompleteClass */
  override var unit: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrenceUnit = js.native
  ...
  /* CompleteClass */
  override var until: js.Date = js.native
  ...
  /* CompleteClass */
  override var weekOfMonth: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentWeekOfMonth = js.native
}
