...
import typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.INDSendResult
...
class NDTCPMessenger protected ()
  ...
  override def sendProximityDetectionResponseAsync(
    pdType: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDProximityDetectionType,
