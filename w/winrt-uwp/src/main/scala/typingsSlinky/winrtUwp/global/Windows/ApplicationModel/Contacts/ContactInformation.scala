...
abstract class ContactInformation ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactInformation {
  /** A read-only list of the custom fields stored with the contact. */
  /* CompleteClass */
  override var customFields: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactField] = js.native
  /** A read-only list of email addresses stored with the contact. */
  /* CompleteClass */
  override var emails: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactField] = js.native
  /** A read-only list of instant messaging accounts stored with the contact. */
  /* CompleteClass */
  override var instantMessages: IVectorView[
    typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactInstantMessageField
  ] = js.native
  /** A read-only list of locations stored with the contact. */
  /* CompleteClass */
  override var locations: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactLocationField] = js.native
  /** The name of the contact. */
  /* CompleteClass */
  override var name: String = js.native
  /** A read-only list of phone numbers stored with the contact. */
  /* CompleteClass */
  override var phoneNumbers: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactField] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def queryCustomFields(customName: String): IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactField] = js.native
}
