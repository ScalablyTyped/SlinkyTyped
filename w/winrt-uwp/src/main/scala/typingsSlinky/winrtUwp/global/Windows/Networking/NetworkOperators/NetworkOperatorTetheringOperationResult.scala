...
abstract class NetworkOperatorTetheringOperationResult ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkOperatorTetheringOperationResult {
  ...
  /* CompleteClass */
  override var status: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.TetheringOperationStatus = js.native
}
