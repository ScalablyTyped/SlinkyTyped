...
object UssdSession {
  ...
  @js.native
  def createFromNetworkAccountId(networkAccountId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.UssdSession = js.native
  ...
  @js.native
  def createFromNetworkInterfaceId(networkInterfaceId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.UssdSession = js.native
}
