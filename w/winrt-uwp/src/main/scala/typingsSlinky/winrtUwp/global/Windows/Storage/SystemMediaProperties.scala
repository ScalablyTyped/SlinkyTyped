...
abstract class SystemMediaProperties ()
  extends typingsSlinky.winrtUwp.Windows.Storage.SystemMediaProperties {
  ...
  /* CompleteClass */
  override var producer: String = js.native
