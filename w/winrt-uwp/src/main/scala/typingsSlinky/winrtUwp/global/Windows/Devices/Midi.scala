...
import typingsSlinky.winrtUwp.Windows.Devices.Midi.IMidiOutPort
...
object Midi {
  ...
  class MidiActiveSensingMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiActiveSensingMessage
  ...
  class MidiContinueMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiContinueMessage
  ...
  class MidiControlChangeMessage protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiControlChangeMessage {
    /**
  ...
  class MidiNoteOffMessage protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiNoteOffMessage {
    /**
  ...
  class MidiNoteOnMessage protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiNoteOnMessage {
    /**
  ...
  abstract class MidiOutPort ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiOutPort
  object MidiOutPort {
  ...
  class MidiPitchBendChangeMessage protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiPitchBendChangeMessage {
    /**
  ...
  class MidiPolyphonicKeyPressureMessage protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiPolyphonicKeyPressureMessage {
    /**
  ...
  class MidiStartMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiStartMessage
  ...
  class MidiStopMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiStopMessage
  ...
  class MidiSystemResetMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiSystemResetMessage
  ...
  class MidiTimingClockMessage ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiTimingClockMessage
