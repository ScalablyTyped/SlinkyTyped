...
abstract class PedometerReadingChangedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Sensors.PedometerReadingChangedEventArgs {
  /** Gets the most recent pedometer reading. */
  /* CompleteClass */
  override var reading: typingsSlinky.winrtUwp.Windows.Devices.Sensors.PedometerReading = js.native
}
