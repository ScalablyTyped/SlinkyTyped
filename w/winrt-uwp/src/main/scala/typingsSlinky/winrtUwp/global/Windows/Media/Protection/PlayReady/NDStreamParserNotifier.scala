...
class NDStreamParserNotifier ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDStreamParserNotifier {
  /**
  ...
  override def onSampleParsed(
    streamID: Double,
    streamType: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDMediaStreamType,
    streamSample: MediaStreamSample,
    pts: Double,
    ccFormat: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDClosedCaptionFormat,
