...
import typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextPadding
import typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextPoint
import typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextSize
...
class TimedTextRegion ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextRegion {
  ...
  /* CompleteClass */
  override var displayAlignment: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextDisplayAlignment = js.native
  ...
  /* CompleteClass */
  override var scrollMode: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextScrollMode = js.native
  /** Gets or sets a value indicating whether text wraps when it reaches the edge of the TimedTextRegion . */
  /* CompleteClass */
  override var textWrapping: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextWrapping = js.native
  /** Gets or sets a value indicating the direction that text flows within the TimedTextRegion . */
  /* CompleteClass */
  override var writingMode: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextWritingMode = js.native
