...
abstract class OpticalImageStabilizationControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationControl {
  /** Gets or sets a value indicating the current optical image stabilization mode of the capture device. */
  /* CompleteClass */
  override var mode: typingsSlinky.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationMode = js.native
  ...
  /* CompleteClass */
  override var supportedModes: IVectorView[typingsSlinky.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationMode] = js.native
}
