...
abstract class GattDeviceService ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDeviceService {
  ...
  override var parentServices: IVectorView[
    typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDeviceService
  ] = js.native
  ...
  override def getAllCharacteristics(): IVectorView[
    typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic
  ] = js.native
  /**
