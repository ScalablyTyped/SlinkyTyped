...
abstract class PointerPointProperties ()
  extends typingsSlinky.winrtUwp.Windows.UI.Input.PointerPointProperties {
  ...
  /* CompleteClass */
  override var pointerUpdateKind: typingsSlinky.winrtUwp.Windows.UI.Input.PointerUpdateKind = js.native
