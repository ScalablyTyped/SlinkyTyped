...
abstract class SetVersionRequest ()
  extends typingsSlinky.winrtUwp.Windows.Storage.SetVersionRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.Storage.SetVersionDeferral = js.native
}
