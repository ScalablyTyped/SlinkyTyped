...
abstract class DeviceWatcherEvent ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceWatcherEvent {
  /** Gets the information for the device associated with the DeviceWatcherEvent . */
  /* CompleteClass */
  override var deviceInformation: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceInformation = js.native
  /** Gets updated information for a device updated by the DeviceWatcherEvent . */
  /* CompleteClass */
  override var deviceInformationUpdate: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceInformationUpdate = js.native
  /** Gets the type for the device indicated by the DeviceWatcherEvent . */
  /* CompleteClass */
  override var kind: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceWatcherEventKind = js.native
}
