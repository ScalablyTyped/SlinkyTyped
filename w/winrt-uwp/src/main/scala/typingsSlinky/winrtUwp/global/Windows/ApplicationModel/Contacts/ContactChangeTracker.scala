...
abstract class ContactChangeTracker ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangeReader = js.native
