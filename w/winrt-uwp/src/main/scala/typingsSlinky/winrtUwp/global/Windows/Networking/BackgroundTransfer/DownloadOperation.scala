...
import typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundDownloadProgress
...
abstract class DownloadOperation ()
  ...
  override def attachAsync(): IPromiseWithIAsyncOperationWithProgress[
    typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation, 
    typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation
  ] = js.native
  /**
