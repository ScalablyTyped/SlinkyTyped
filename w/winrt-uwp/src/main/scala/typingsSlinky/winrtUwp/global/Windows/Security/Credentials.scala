...
import typingsSlinky.winrtUwp.Windows.Security.Credentials.KeyCredentialCreationOption
...
import typingsSlinky.winrtUwp.Windows.Security.Credentials.WebAccountState
...
object Credentials {
  ...
  abstract class KeyCredential ()
    extends typingsSlinky.winrtUwp.Windows.Security.Credentials.KeyCredential
  ...
  object KeyCredentialManager {
    ...
    @js.native
    def requestCreateAsync(name: String, option: KeyCredentialCreationOption): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Security.Credentials.KeyCredentialRetrievalResult] = js.native
  }
  ...
  class PasswordCredentialPropertyStore ()
    extends typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredentialPropertyStore
