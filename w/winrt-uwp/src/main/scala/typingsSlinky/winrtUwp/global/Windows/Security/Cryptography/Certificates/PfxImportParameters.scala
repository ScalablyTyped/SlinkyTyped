...
class PfxImportParameters ()
  ...
  /* CompleteClass */
  override var installOptions: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.InstallOptions = js.native
  ...
  /* CompleteClass */
  override var readerName: String = js.native
}
