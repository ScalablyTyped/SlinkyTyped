...
abstract class MidiSynthesizer ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiSynthesizer {
...
object MidiSynthesizer extends js.Object {
  /**
    ...
    */
  def createAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiSynthesizer] = js.native
  /**
    ...
    */
  def createAsync(audioDevice: DeviceInformation): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiSynthesizer] = js.native
  /**
