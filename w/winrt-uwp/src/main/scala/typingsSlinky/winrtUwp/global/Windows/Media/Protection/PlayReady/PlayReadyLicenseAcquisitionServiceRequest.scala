...
class PlayReadyLicenseAcquisitionServiceRequest ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyLicenseAcquisitionServiceRequest {
  /** Gets or sets the custom data of the request challenge. */
  /* CompleteClass */
  override var challengeCustomData: String = js.native
  /** Gets or sets the current content header property. */
  /* CompleteClass */
  override var contentHeader: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader = js.native
