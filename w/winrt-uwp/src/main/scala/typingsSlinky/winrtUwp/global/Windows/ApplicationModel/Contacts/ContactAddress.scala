...
class ContactAddress ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAddress {
  ...
  /* CompleteClass */
  override var kind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAddressKind = js.native
