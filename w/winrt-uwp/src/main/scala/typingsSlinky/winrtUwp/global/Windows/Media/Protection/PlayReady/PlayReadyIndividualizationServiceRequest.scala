...
class PlayReadyIndividualizationServiceRequest ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyIndividualizationServiceRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def generateManualEnablingChallenge(): typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadySoapMessage = js.native
  /**
