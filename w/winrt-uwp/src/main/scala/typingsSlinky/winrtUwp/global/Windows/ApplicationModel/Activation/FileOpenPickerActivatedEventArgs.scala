...
import typingsSlinky.winrtUwp.Windows.Storage.Pickers.Provider.FileOpenPickerUI
...
abstract class FileOpenPickerActivatedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Activation.FileOpenPickerActivatedEventArgs {
