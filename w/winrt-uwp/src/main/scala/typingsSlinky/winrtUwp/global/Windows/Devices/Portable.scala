...
import typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType
...
object Portable extends js.Object {
  ...
  abstract class ServiceDevice ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDevice
  /* static members */
  @js.native
  ...
  object ServiceDeviceType extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType with Double] = js.native
    
    /* 0 */ val calendarService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.calendarService with Double = js.native
    
    /* 1 */ val contactsService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.contactsService with Double = js.native
    
    /* 2 */ val deviceStatusService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.deviceStatusService with Double = js.native
    
    /* 3 */ val notesService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.notesService with Double = js.native
    
    /* 4 */ val ringtonesService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.ringtonesService with Double = js.native
    
    /* 5 */ val smsService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.smsService with Double = js.native
    
    /* 6 */ val tasksService: typingsSlinky.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.tasksService with Double = js.native
  }
  ...
  abstract class StorageDevice ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Portable.StorageDevice
  /* static members */
  @js.native
