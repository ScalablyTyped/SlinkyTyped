...
abstract class ClaimedSlipPrinter ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.ClaimedSlipPrinter {
  ...
  /* CompleteClass */
  override var colorCartridge: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterColorCartridge = js.native
  ...
  /* CompleteClass */
  override var printSide: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterPrintSide = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def changePrintSide(printSide: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterPrintSide): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createJob(): typingsSlinky.winrtUwp.Windows.Devices.PointOfService.SlipPrintJob = js.native
  /**
