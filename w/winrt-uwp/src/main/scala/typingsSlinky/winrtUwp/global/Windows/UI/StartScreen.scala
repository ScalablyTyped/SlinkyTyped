...
import typingsSlinky.winrtUwp.Windows.UI.StartScreen.ForegroundText
import typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItemKind
import typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind
import typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions
import typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize
...
object StartScreen extends js.Object {
  ...
  abstract class JumpList ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpList {
    /** Gets the list of JumpListItem 's for the jump list. Items is of type IVector(JumpListItem) . */
    /* CompleteClass */
    override var items: IVector[typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItem] = js.native
  ...
  abstract class JumpListItem ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItem {
  ...
  class SecondaryTile ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.SecondaryTile {
    /**
  ...
  abstract class SecondaryTileVisualElements ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements {
  ...
  abstract class VisualElementsRequest ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.VisualElementsRequest {
    ...
    /* CompleteClass */
    override var alternateVisualElements: IVectorView[typingsSlinky.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements] = js.native
    ...
    /* CompleteClass */
    override var visualElements: typingsSlinky.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsSlinky.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestDeferral = js.native
  }
  ...
  abstract class VisualElementsRequestDeferral ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestDeferral {
  ...
  abstract class VisualElementsRequestedEventArgs ()
    extends typingsSlinky.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestedEventArgs {
    /** Gets the VisualElementsRequest object for the event. */
    /* CompleteClass */
    override var request: typingsSlinky.winrtUwp.Windows.UI.StartScreen.VisualElementsRequest = js.native
  }
  
  /** Specifies the color of the tile's foreground text. */
  @js.native
  object ForegroundText extends js.Object {
    /* 0 */ val dark: typingsSlinky.winrtUwp.Windows.UI.StartScreen.ForegroundText.dark with Double = js.native
    /* 1 */ val light: typingsSlinky.winrtUwp.Windows.UI.StartScreen.ForegroundText.light with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.UI.StartScreen.ForegroundText with Double] = js.native
  }
  ...
  object JumpList extends js.Object {
    ...
    /**
      ...
      */
    def loadCurrentAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpList] = js.native
  }
  ...
  object JumpListItem extends js.Object {
    /**
      ...
      */
    def createSeparator(): typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItem = js.native
    /**
      ...
      */
    def createWithArguments(args: String, displayName: String): typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItem = js.native
  }
  
  /** Specifies the kind of jump list item. */
  @js.native
  object JumpListItemKind extends js.Object {
    /* 0 */ val arguments: typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItemKind.arguments with Double = js.native
    /* 1 */ val separator: typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItemKind.separator with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListItemKind with Double] = js.native
  }
  
  /** Indicates the kind of system group used by an app's jump list. */
  @js.native
  object JumpListSystemGroupKind extends js.Object {
    /* 1 */ val frequent: typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.frequent with Double = js.native
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.none with Double = js.native
    /* 2 */ val recent: typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.recent with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind with Double
      ] = js.native
  }
  ...
  object TileOptions extends js.Object {
    /* 3 */ val copyOnDeployment: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions.copyOnDeployment with Double = js.native
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions.none with Double = js.native
    /* 1 */ val showNameOnLogo: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions.showNameOnLogo with Double = js.native
    /* 2 */ val showNameOnWideLogo: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions.showNameOnWideLogo with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileOptions with Double] = js.native
  }
  
  /** Specifies the size of tile to pin. Used by some secondary tile constructors. */
  @js.native
  object TileSize extends js.Object {
    /* 0 */ val default: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.default with Double = js.native
    /* 3 */ val square150x150: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square150x150 with Double = js.native
    /* 1 */ val square30x30: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square30x30 with Double = js.native
    /* 5 */ val square310x310: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square310x310 with Double = js.native
    /* 7 */ val square44x44: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square44x44 with Double = js.native
    /* 2 */ val square70x70: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square70x70 with Double = js.native
    /* 6 */ val square71x71: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.square71x71 with Double = js.native
    /* 4 */ val wide310x150: typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize.wide310x150 with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.UI.StartScreen.TileSize with Double] = js.native
  }
