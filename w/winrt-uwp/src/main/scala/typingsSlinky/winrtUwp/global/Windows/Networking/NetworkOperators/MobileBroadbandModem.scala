...
abstract class MobileBroadbandModem ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModem {
  /** Gets the MobileBroadbandAccount associated currently with the mobile broadband modem. */
  /* CompleteClass */
  override var currentAccount: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandAccount = js.native
  ...
  /* CompleteClass */
  override var deviceInformation: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceInformation = js.native
  /** Gets a list of the device services available for the mobile broadband modem. */
  /* CompleteClass */
  override var deviceServices: IVectorView[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceServiceInformation
  ] = js.native
  ...
  override def getCurrentConfigurationAsync(): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModemConfiguration
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getDeviceService(deviceServiceId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceService = js.native
  /**
...
object MobileBroadbandModem extends js.Object {
  /**
    ...
    */
  def fromId(deviceId: String): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModem = js.native
  /**
    * Determines the default mobile broadband modem.
    * @return The mobile broadband modem.
    */
  def getDefault(): typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModem = js.native
  /**
