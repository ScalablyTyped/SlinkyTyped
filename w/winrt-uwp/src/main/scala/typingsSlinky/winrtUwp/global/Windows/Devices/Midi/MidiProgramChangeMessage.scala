...
class MidiProgramChangeMessage protected ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiProgramChangeMessage {
  /**
  ...
  /* CompleteClass */
  override var program: Double = js.native
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiMessageType = js.native
}
