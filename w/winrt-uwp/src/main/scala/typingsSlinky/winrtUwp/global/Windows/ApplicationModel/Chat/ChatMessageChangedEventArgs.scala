...
abstract class ChatMessageChangedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangedEventArgs {
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangedDeferral = js.native
}
