...
class EmailAttachment ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailAttachment {
  /**
  ...
  /* CompleteClass */
  override var downloadState: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailAttachmentDownloadState = js.native
