...
abstract class ContactChangeReader ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangeReader {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def acceptChangesThrough(lastChangeToAccept: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChange): Unit = js.native
  /**
