...
abstract class MobileBroadbandModemConfiguration ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModemConfiguration {
  ...
  /* CompleteClass */
  override var uicc: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUicc = js.native
}
