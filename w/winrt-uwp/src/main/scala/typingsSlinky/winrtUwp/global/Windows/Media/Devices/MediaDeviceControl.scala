...
abstract class MediaDeviceControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.MediaDeviceControl {
  /** Gets the capabilities of the camera for this camera setting. */
  /* CompleteClass */
  override var capabilities: typingsSlinky.winrtUwp.Windows.Media.Devices.MediaDeviceControlCapabilities = js.native
  /**
