...
class HttpChallengeHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValue {
  /**
...
object HttpChallengeHeaderValue extends js.Object {
  /**
    ...
    */
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValue = js.native
  /**
