...
abstract class PersistedKeyProvider ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.PersistedKeyProvider
...
object PersistedKeyProvider extends js.Object {
  ...
  def openKeyPairFromCertificateAsync(
    ...
    padding: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicPadding
  ): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey] = js.native
  /**
  ...
  def openPublicKeyFromCertificate(
    ...
    hashAlgorithmName: String,
    padding: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicPadding
  ): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey = js.native
}
