...
object Resources {
  ...
  object Core {
    ...
    object ResourceManager {
      ...
      @js.native
      def current: typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceManager = js.native
      @scala.inline
      def current_=(x: typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceManager): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("current")(x.asInstanceOf[js.Any])
