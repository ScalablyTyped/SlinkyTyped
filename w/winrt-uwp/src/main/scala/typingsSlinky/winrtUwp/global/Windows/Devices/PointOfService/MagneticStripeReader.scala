...
abstract class MagneticStripeReader ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReader
object MagneticStripeReader {
  ...
  @js.native
  def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReader] = js.native
  ...
  @js.native
  def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReader] = js.native
