...
class HttpRequestMessage ()
  ...
  /* CompleteClass */
  override var method: typingsSlinky.winrtUwp.Windows.Web.Http.HttpMethod = js.native
  ...
  /* CompleteClass */
  override var transportInformation: typingsSlinky.winrtUwp.Windows.Web.Http.HttpTransportInformation = js.native
