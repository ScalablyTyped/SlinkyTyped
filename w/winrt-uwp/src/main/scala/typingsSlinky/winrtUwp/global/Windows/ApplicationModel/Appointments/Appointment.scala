...
class Appointment ()
  ...
  /* CompleteClass */
  override var busyStatus: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus = js.native
  ...
  /* CompleteClass */
  override var detailsKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentDetailsKind = js.native
  ...
  /* CompleteClass */
  override var invitees: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentInvitee] = js.native
  ...
  /* CompleteClass */
  override var organizer: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentOrganizer = js.native
  /** Gets the original starting time for a recurring appointment. */
  /* CompleteClass */
  override var originalStartTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var recurrence: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrence = js.native
  ...
  /* CompleteClass */
  override var replyTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var sensitivity: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentSensitivity = js.native
  ...
  /* CompleteClass */
  override var userResponse: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse = js.native
}
