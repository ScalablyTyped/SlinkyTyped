...
abstract class NetworkAdapter ()
  ...
  /* CompleteClass */
  override var networkItem: typingsSlinky.winrtUwp.Windows.Networking.Connectivity.NetworkItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getConnectedProfileAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Networking.Connectivity.ConnectionProfile] = js.native
}
