...
abstract class HtmlPrintDocumentSource ()
  extends typingsSlinky.winrtUwp.Windows.UI.WebUI.HtmlPrintDocumentSource {
  ...
  /* CompleteClass */
  override var content: typingsSlinky.winrtUwp.Windows.UI.WebUI.PrintContent = js.native
