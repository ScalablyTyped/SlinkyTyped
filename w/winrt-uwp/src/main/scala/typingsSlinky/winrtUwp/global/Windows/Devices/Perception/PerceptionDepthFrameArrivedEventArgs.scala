...
abstract class PerceptionDepthFrameArrivedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrameArrivedEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def tryOpenFrame(): typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame = js.native
}
