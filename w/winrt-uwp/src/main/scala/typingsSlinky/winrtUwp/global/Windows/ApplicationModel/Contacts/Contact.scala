...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.IContactField
...
class Contact ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact {
  /** Gets the contact addresses for a contact. */
  /* CompleteClass */
  override var addresses: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAddress] = js.native
  ...
  override var connectedServiceAccounts: IVector[
    typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactConnectedServiceAccount
  ] = js.native
  ...
  /* CompleteClass */
  override var displayPictureUserUpdateTime: js.Date = js.native
  /** Gets the email addresses for a contact. */
  /* CompleteClass */
  override var emails: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactEmail] = js.native
  ...
  /* CompleteClass */
  override var importantDates: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactDate] = js.native
  ...
  /* CompleteClass */
  override var jobInfo: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactJobInfo] = js.native
  ...
  /* CompleteClass */
  override var phones: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactPhone] = js.native
  ...
  /* CompleteClass */
  override var significantOthers: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactSignificantOther] = js.native
  ...
  /* CompleteClass */
  override var websites: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactWebsite] = js.native
