...
object SystemProperties extends js.Object {
  ...
  var audio: typingsSlinky.winrtUwp.Windows.Storage.SystemAudioProperties = js.native
  ...
  var gps: typingsSlinky.winrtUwp.Windows.Storage.SystemGPSProperties = js.native
  /** Gets an object that provides the indexing names of Windows file properties for System.Image. */
  var image: typingsSlinky.winrtUwp.Windows.Storage.SystemImageProperties = js.native
  ...
  var media: typingsSlinky.winrtUwp.Windows.Storage.SystemMediaProperties = js.native
  /** Gets an object that provides the indexing names of Windows file properties for System.Music. */
  var music: typingsSlinky.winrtUwp.Windows.Storage.SystemMusicProperties = js.native
  /** Gets an object that provides the indexing names of Windows file properties for System.Photo. */
  var photo: typingsSlinky.winrtUwp.Windows.Storage.SystemPhotoProperties = js.native
  ...
  var video: typingsSlinky.winrtUwp.Windows.Storage.SystemVideoProperties = js.native
}
