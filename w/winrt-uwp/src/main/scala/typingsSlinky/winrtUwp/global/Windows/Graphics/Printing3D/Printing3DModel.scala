...
class Printing3DModel ()
  extends typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DModel {
  ...
  /* CompleteClass */
  override var build: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent = js.native
  /** Gets all 3D Manufacturing Format (3MF) components used in the 3D model. */
  /* CompleteClass */
  override var components: IVector[typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent] = js.native
  /** Gets or sets the root material container for the 3D model. */
  /* CompleteClass */
  override var material: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DMaterial = js.native
  /** Gets all meshes used in the 3D model. */
  /* CompleteClass */
  override var meshes: IVector[typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DMesh] = js.native
  ...
  /* CompleteClass */
  override var textures: IVector[typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelTexture] = js.native
  /** Gets or sets the units of measure used in the 3D model. */
  /* CompleteClass */
  override var unit: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit = js.native
