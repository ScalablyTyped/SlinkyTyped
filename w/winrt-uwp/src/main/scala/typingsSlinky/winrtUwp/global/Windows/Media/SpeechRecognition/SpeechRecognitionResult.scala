...
import typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.ISpeechRecognitionConstraint
...
abstract class SpeechRecognitionResult ()
  ...
  /* CompleteClass */
  override var confidence: typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence = js.native
  ...
  /* CompleteClass */
  override var phraseStartTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var semanticInterpretation: typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionSemanticInterpretation = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAlternates(maxAlternates: Double): IVectorView[typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResult] = js.native
}
