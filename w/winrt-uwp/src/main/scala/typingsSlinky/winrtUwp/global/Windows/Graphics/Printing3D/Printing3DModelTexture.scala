...
class Printing3DModelTexture ()
  ...
  /* CompleteClass */
  override var textureResource: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureResource = js.native
  /** Get or sets a value that indicates how tiling should occur in the U axis in order to fill the overall requested area. */
  /* CompleteClass */
  override var tileStyleU: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior = js.native
  /** Gets or sets a value that indicates how tiling should occur in the V axis in order to fill the overall requested area. */
  /* CompleteClass */
  override var tileStyleV: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior = js.native
}
