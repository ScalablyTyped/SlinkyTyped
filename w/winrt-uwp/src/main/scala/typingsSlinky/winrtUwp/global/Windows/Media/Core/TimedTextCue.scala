...
class TimedTextCue ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextCue {
  /** Gets or sets the TimedTextRegion of the cue, which defines the style of the rendering area for the cue. */
  /* CompleteClass */
  override var cueRegion: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextRegion = js.native
  /** Gets or sets the TimedTextStyle of the cue, which defines the style of the rendered text. */
  /* CompleteClass */
  override var cueStyle: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextStyle = js.native
  ...
  /* CompleteClass */
  override var lines: IVector[typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextLine] = js.native
