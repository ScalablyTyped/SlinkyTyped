...
class ContactSignificantOther ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactSignificantOther {
  ...
  /* CompleteClass */
  override var relationship: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactRelationship = js.native
}
