...
abstract class MobileBroadbandNetwork ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandNetwork {
  ...
  /* CompleteClass */
  override var networkRegistrationState: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkRegistrationState = js.native
  ...
  /* CompleteClass */
  override var registeredDataClass: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.DataClasses = js.native
  ...
  /* CompleteClass */
  override var registrationUiccApps: IVectorView[
