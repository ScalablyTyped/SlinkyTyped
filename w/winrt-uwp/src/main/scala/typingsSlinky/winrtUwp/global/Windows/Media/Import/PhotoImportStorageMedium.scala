...
abstract class PhotoImportStorageMedium ()
  ...
  /* CompleteClass */
  override var storageMediumType: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportStorageMediumType = js.native
  /** Gets a value indicating the access modes supported by the storage medium. */
  /* CompleteClass */
  override var supportedAccessMode: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportAccessMode = js.native
