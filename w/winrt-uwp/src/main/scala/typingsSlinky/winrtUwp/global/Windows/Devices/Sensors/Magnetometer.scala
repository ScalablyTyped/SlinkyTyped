...
abstract class Magnetometer ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Sensors.Magnetometer
/* static members */
@JSGlobal("Windows.Devices.Sensors.Magnetometer")
@js.native
object Magnetometer extends js.Object {
  ...
  /**
    ...
    */
  def getDefault(): typingsSlinky.winrtUwp.Windows.Devices.Sensors.Magnetometer = js.native
}
