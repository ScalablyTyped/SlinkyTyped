...
abstract class HotspotCredentialsAuthenticationResult ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.HotspotCredentialsAuthenticationResult {
  ...
  /* CompleteClass */
  override var responseCode: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.HotspotAuthenticationResponseCode = js.native
}
