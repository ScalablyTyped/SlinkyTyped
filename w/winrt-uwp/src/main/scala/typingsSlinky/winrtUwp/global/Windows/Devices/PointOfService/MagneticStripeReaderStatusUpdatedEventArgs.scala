...
abstract class MagneticStripeReaderStatusUpdatedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderStatusUpdatedEventArgs {
  /** Gets the vendor specific error code. */
  /* CompleteClass */
  override var extendedStatus: Double = js.native
  /** Gets the status change information. */
  /* CompleteClass */
  override var status: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderStatus = js.native
}
