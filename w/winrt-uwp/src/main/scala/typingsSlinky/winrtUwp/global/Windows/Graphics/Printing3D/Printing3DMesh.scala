...
import typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferDescription
...
class Printing3DMesh ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def verifyAsync(value: typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationResult
  ] = js.native
}
