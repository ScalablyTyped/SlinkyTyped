...
abstract class PosPrinterCapabilities ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterCapabilities {
  ...
  /* CompleteClass */
  override var journal: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.JournalPrinterCapabilities = js.native
  /** Gets the power reporting capabilities of the point-of-service printer. */
  /* CompleteClass */
  override var powerReportingType: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.UnifiedPosPowerReportingType = js.native
  /** Gets the capabilities of the receipt station for the point-of-service printer. */
  /* CompleteClass */
  override var receipt: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.ReceiptPrinterCapabilities = js.native
  /** Gets the capabilities of the slip station for the point-of-service printer. */
  /* CompleteClass */
  override var slip: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.SlipPrinterCapabilities = js.native
}
