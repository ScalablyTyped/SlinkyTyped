...
import typingsSlinky.winrtUwp.Windows.Storage.Search.DateStackOption
import typingsSlinky.winrtUwp.Windows.Storage.Search.FolderDepth
import typingsSlinky.winrtUwp.Windows.Storage.Search.IndexerOption
...
object Search extends js.Object {
  ...
  abstract class StorageLibraryContentChangedTriggerDetails ()
    ...
    /* CompleteClass */
    override var folder: typingsSlinky.winrtUwp.Windows.Storage.StorageFolder = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def createModifiedSinceQuery(lastQueryTime: js.Date): typingsSlinky.winrtUwp.Windows.Storage.Search.StorageItemQueryResult = js.native
  }
