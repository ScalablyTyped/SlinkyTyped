...
abstract class ContactAnnotationList ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationList {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def deleteAnnotationAsync(annotation: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation): IPromiseWithIAsyncAction = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAnnotationAsync(annotationId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def trySaveAnnotationAsync(annotation: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation): IPromiseWithIAsyncOperation[Boolean] = js.native
}
