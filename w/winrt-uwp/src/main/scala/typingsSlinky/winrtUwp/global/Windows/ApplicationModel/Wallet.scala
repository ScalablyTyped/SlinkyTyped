...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletDetailViewPosition
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletItemKind
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletSummaryViewPosition
...
object Wallet extends js.Object {
  ...
  class WalletItem protected ()
    ...
    /* CompleteClass */
    override var barcode: typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletBarcode = js.native
    ...
    /* CompleteClass */
    override var displayProperties: IMap[
        String, 
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletItemCustomProperty
      ] = js.native
    ...
    /* CompleteClass */
    override var lastUpdated: js.Date = js.native
    ...
    /* CompleteClass */
    override var relevantDate: js.Date = js.native
    ...
    /* CompleteClass */
    override var relevantLocations: IMap[
        String, 
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletRelevantLocation
      ] = js.native
    /** Gets the transaction history collection of the wallet item. */
    /* CompleteClass */
    override var transactionHistory: IMap[String, typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletTransaction] = js.native
    /** Gets the collection of WalletVerb objects associated with the wallet item. */
    /* CompleteClass */
    override var verbs: IMap[String, typingsSlinky.winrtUwp.Windows.ApplicationModel.Wallet.WalletVerb] = js.native
  }
  ...
  class WalletTransaction ()
    ...
    /* CompleteClass */
    override var transactionDate: js.Date = js.native
  }
