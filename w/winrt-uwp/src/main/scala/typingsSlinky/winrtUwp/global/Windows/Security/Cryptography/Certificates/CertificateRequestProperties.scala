...
class CertificateRequestProperties ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CertificateRequestProperties {
  /** Gets or sets the CA exchange certificate that is used to encrypt a key attestation certificate request. */
  /* CompleteClass */
  override var attestationCredentialCertificate: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.Certificate = js.native
  ...
  /* CompleteClass */
  override var exportable: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ExportOption = js.native
  ...
  /* CompleteClass */
  override var keyProtectionLevel: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.KeyProtectionLevel = js.native
  ...
  /* CompleteClass */
  override var keyUsages: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.EnrollKeyUsages = js.native
