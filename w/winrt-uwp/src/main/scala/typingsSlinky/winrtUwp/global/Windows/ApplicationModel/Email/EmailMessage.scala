...
class EmailMessage ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessage {
  ...
  /* CompleteClass */
  override var attachments: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailAttachment] = js.native
  /** Gets the recipients BCC'd to the email message. */
  /* CompleteClass */
  override var bcc: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
  ...
  /* CompleteClass */
  override var cc: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
  ...
  /* CompleteClass */
  override var downloadState: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessageDownloadState = js.native
  ...
  /* CompleteClass */
  override var flagState: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailFlagState = js.native
  ...
  /* CompleteClass */
  override var importance: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailImportance = js.native
  ...
  /* CompleteClass */
  override var irmInfo: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailIrmInfo = js.native
  ...
  /* CompleteClass */
  override var lastResponseKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessageResponseKind = js.native
  ...
  /* CompleteClass */
  override var meetingInfo: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMeetingInfo = js.native
  ...
  /* CompleteClass */
  override var sender: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient = js.native
  /** Gets or sets the time an email was sent. */
  /* CompleteClass */
  override var sentTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var smimeKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessageSmimeKind = js.native
  /** Gets or sets the subject of the email message. */
  /* CompleteClass */
  override var subject: String = js.native
  /** Gets the direct recipients of the email message. */
  /* CompleteClass */
  override var to: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getBodyStream(`type`: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessageBodyKind): IRandomAccessStreamReference = js.native
  /**
  ...
  override def setBodyStream(
    `type`: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMessageBodyKind,
