...
import typingsSlinky.winrtUwp.anon.ContentCodingHeaderValue
...
class HttpContentCodingHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingHeaderValue {
  /**
...
object HttpContentCodingHeaderValue {
  ...
  @js.native
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingHeaderValue = js.native
