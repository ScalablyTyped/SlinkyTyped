...
abstract class RcsEndUserMessage ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessage {
  /** Gets the actions to which the user can respond. */
  /* CompleteClass */
  override var actions: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def sendResponseAsync(action: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction): IPromiseWithIAsyncAction = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def sendResponseWithPinAsync(action: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction, pin: String): IPromiseWithIAsyncAction = js.native
}
