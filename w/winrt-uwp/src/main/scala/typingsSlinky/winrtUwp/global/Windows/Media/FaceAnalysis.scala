...
object FaceAnalysis extends js.Object {
  ...
  abstract class FaceDetector ()
    extends typingsSlinky.winrtUwp.Windows.Media.FaceAnalysis.FaceDetector
  /* static members */
  @js.native
  object FaceDetector extends js.Object {
    ...
    /**
      ...
      */
    def createAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Media.FaceAnalysis.FaceDetector] = js.native
  ...
  object FaceTracker extends js.Object {
    ...
    /**
      ...
      */
    def createAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Media.FaceAnalysis.FaceTracker] = js.native
