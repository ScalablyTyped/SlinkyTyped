...
import typingsSlinky.winrtUwp.Windows.Globalization.NumberFormatting.CurrencyFormatterMode
import typingsSlinky.winrtUwp.Windows.Globalization.NumberFormatting.INumberRounder
import typingsSlinky.winrtUwp.Windows.Globalization.NumberFormatting.RoundingAlgorithm
