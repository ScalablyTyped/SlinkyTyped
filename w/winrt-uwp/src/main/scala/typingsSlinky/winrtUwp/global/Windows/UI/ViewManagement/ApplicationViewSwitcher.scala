...
object ApplicationViewSwitcher extends js.Object {
  ...
  def prepareForCustomAnimatedSwitchAsync(
    toViewId: Double,
    fromViewId: Double,
    options: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ApplicationViewSwitchingOptions
  ...
  def tryShowAsStandaloneAsync(
    viewId: Double,
    sizePreference: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ViewSizePreference
  ): IPromiseWithIAsyncOperation[Boolean] = js.native
  /**
    * Displays another window (app view) for the app on the screen, adjacent to the original window.
    * @param viewId The ID of the new window to display.
  ...
  def tryShowAsStandaloneAsync(
    ...
    sizePreference: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ViewSizePreference,
    anchorViewId: Double,
    anchorSizePreference: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ViewSizePreference
  ): IPromiseWithIAsyncOperation[Boolean] = js.native
}
