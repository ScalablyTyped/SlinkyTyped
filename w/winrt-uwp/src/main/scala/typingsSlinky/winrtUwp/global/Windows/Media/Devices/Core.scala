...
import typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode
...
object Core extends js.Object {
  ...
  abstract class FrameControlCapabilities ()
    ...
    /* CompleteClass */
    override var exposure: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameExposureCapabilities = js.native
    /** Gets the exposure compensation capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    override var exposureCompensation: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationCapabilities = js.native
    /** Gets the flash capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    override var flash: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameFlashCapabilities = js.native
    /** Gets the focus capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    override var focus: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameFocusCapabilities = js.native
    /** Gets the ISO speed capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    override var isoSpeed: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedCapabilities = js.native
  ...
  class FrameController ()
    ...
    /* CompleteClass */
    override var exposureCompensationControl: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationControl = js.native
    /** Gets the exposure settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    override var exposureControl: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameExposureControl = js.native
    /** Gets the flash settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    override var flashControl: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameFlashControl = js.native
    /** Gets the focus settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    override var focusControl: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameFocusControl = js.native
    /** Gets the ISO speed settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    override var isoSpeedControl: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedControl = js.native
  ...
  abstract class VariablePhotoSequenceController ()
    ...
    /* CompleteClass */
    override var desiredFrameControllers: IVector[typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameController] = js.native
    ...
    /* CompleteClass */
    override var frameCapabilities: typingsSlinky.winrtUwp.Windows.Media.Devices.Core.FrameControlCapabilities = js.native
