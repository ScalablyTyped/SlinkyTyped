...
import typingsSlinky.winrtUwp.anon.ContentDispositionHeaderValue
...
class HttpContentDispositionHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpContentDispositionHeaderValue {
  /**
...
object HttpContentDispositionHeaderValue extends js.Object {
  ...
  /**
    ...
    */
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpContentDispositionHeaderValue = js.native
