...
abstract class MediaStreamSourceSwitchStreamsRequest ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.MediaStreamSourceSwitchStreamsRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.Media.Core.MediaStreamSourceSwitchStreamsRequestDeferral = js.native
}
