...
import typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.INDCustomData
...
class NDLicenseFetchDescriptor protected ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDLicenseFetchDescriptor {
  /**
    ...
    */
  def this(
    contentIDType: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDContentIDType,
  ...
  /* CompleteClass */
  override var contentIDType: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.NDContentIDType = js.native
