...
object Profile {
  ...
  abstract class AnalyticsInfo ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.AnalyticsInfo
  object AnalyticsInfo {
    ...
    @js.native
    def versionInfo: typingsSlinky.winrtUwp.Windows.System.Profile.AnalyticsVersionInfo = js.native
    @scala.inline
    def versionInfo_=(x: typingsSlinky.winrtUwp.Windows.System.Profile.AnalyticsVersionInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("versionInfo")(x.asInstanceOf[js.Any])
  }
  ...
  abstract class AnalyticsVersionInfo ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.AnalyticsVersionInfo
  ...
  abstract class HardwareIdentification ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.HardwareIdentification
  object HardwareIdentification {
    ...
    @js.native
    def getPackageSpecificToken(nonce: IBuffer): typingsSlinky.winrtUwp.Windows.System.Profile.HardwareToken = js.native
  }
  ...
  abstract class HardwareToken ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.HardwareToken
  ...
  abstract class KnownRetailInfoProperties ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.KnownRetailInfoProperties
  ...
  abstract class PlatformDiagnosticsAndUsageDataSettings ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.PlatformDiagnosticsAndUsageDataSettings
  ...
  abstract class RetailInfo ()
    extends typingsSlinky.winrtUwp.Windows.System.Profile.RetailInfo
  object RetailInfo {
  ...
  object SystemManufacturers {
    ...
    abstract class SmbiosInformation ()
      extends typingsSlinky.winrtUwp.Windows.System.Profile.SystemManufacturers.SmbiosInformation
