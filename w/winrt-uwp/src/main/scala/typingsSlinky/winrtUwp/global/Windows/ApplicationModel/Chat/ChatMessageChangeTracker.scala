...
abstract class ChatMessageChangeTracker ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangeReader = js.native
