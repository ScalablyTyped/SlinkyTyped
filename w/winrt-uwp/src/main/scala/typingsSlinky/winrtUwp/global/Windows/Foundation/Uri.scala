...
class Uri protected ()
  ...
  /* CompleteClass */
  override var queryParsed: typingsSlinky.winrtUwp.Windows.Foundation.WwwFormUrlDecoder = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def combineUri(relativeUri: String): typingsSlinky.winrtUwp.Windows.Foundation.Uri = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(pUri: typingsSlinky.winrtUwp.Windows.Foundation.Uri): Boolean = js.native
}
