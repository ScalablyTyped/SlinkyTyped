...
abstract class ClaimedReceiptPrinter ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.ClaimedReceiptPrinter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createJob(): typingsSlinky.winrtUwp.Windows.Devices.PointOfService.ReceiptPrintJob = js.native
  /**
