...
import typingsSlinky.winrtUwp.Windows.Devices.Adc.AdcChannelMode
...
object Adc extends js.Object {
  ...
  abstract class AdcChannel ()
    ...
    /* CompleteClass */
    override var controller: typingsSlinky.winrtUwp.Windows.Devices.Adc.AdcController = js.native
  ...
  abstract class AdcController ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def openChannel(channelNumber: Double): typingsSlinky.winrtUwp.Windows.Devices.Adc.AdcChannel = js.native
  }
