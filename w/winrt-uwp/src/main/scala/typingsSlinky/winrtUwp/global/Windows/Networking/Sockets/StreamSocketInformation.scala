...
import typingsSlinky.winrtUwp.Windows.Networking.Sockets.RoundTripTimeStatistics
...
abstract class StreamSocketInformation ()
  ...
  /* CompleteClass */
  override var protectionLevel: typingsSlinky.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel = js.native
  ...
  /* CompleteClass */
  override var serverCertificateErrorSeverity: typingsSlinky.winrtUwp.Windows.Networking.Sockets.SocketSslErrorSeverity = js.native
