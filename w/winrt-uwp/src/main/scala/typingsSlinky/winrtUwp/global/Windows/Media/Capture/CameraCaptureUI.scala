...
class CameraCaptureUI ()
  extends typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUI {
  ...
  /* CompleteClass */
  override var photoSettings: typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIPhotoCaptureSettings = js.native
  ...
  /* CompleteClass */
  override var videoSettings: typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIVideoCaptureSettings = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def captureFileAsync(mode: typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIMode): IPromiseWithIAsyncOperation[StorageFile] = js.native
}
