...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.IBackgroundCondition
...
class BackgroundTaskBuilder ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundTaskBuilder {
  /** Indicates whether the background task will be canceled if at least one of its required conditions is no longer met. */
  /* CompleteClass */
  override var cancelOnConditionLoss: Boolean = js.native
  ...
  /* CompleteClass */
  override var isNetworkRequested: Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def register(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundTaskRegistration = js.native
  /**
