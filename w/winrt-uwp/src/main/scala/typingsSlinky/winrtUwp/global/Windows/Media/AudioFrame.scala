...
class AudioFrame protected ()
  extends typingsSlinky.winrtUwp.Windows.Media.AudioFrame {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def lockBuffer(mode: typingsSlinky.winrtUwp.Windows.Media.AudioBufferAccessMode): typingsSlinky.winrtUwp.Windows.Media.AudioBuffer = js.native
}
