...
abstract class PerceptionFrameSourcePropertyChangeResult ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionFrameSourcePropertyChangeResult {
  ...
  /* CompleteClass */
  override var status: typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionFrameSourcePropertyChangeStatus = js.native
}
