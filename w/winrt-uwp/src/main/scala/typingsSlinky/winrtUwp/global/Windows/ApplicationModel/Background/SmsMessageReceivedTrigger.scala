...
import typingsSlinky.winrtUwp.Windows.Devices.Sms.SmsFilterRules
...
class SmsMessageReceivedTrigger protected ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.SmsMessageReceivedTrigger {
  /**
