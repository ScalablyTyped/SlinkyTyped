...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceLayoutInfo
...
object Core extends js.Object {
  ...
  abstract class ResourceCandidate ()
    ...
    /* CompleteClass */
    override var qualifiers: IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceQualifier] = js.native
  ...
  abstract class ResourceManager ()
    ...
    /* CompleteClass */
    override var allResourceMaps: IMapView[String, typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceMap] = js.native
    ...
    /* CompleteClass */
    override var defaultContext: typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceContext = js.native
    /** Gets the ResourceMap that is associated with the main package of the currently running application. */
    /* CompleteClass */
    override var mainResourceMap: typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceMap = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def getAllNamedResourcesForPackage(packageName: String, resourceLayoutInfo: ResourceLayoutInfo): IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.NamedResource] = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def getAllSubtreesForPackage(packageName: String, resourceLayoutInfo: ResourceLayoutInfo): IVectorView[typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceMap] = js.native
    /**
  ...
  abstract class ResourceMapIterator ()
    ...
    /* CompleteClass */
    override var current: IKeyValuePair[
        String, 
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.NamedResource
      ] = js.native
  ...
  abstract class ResourceMapMapView ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def lookup(key: String): typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceMap = js.native
    /**
  ...
  abstract class ResourceMapMapViewIterator ()
    ...
    /* CompleteClass */
    override var current: IKeyValuePair[String, typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.Core.ResourceMap] = js.native
