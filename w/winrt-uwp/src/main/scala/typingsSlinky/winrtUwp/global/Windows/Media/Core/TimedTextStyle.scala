...
import typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextDouble
...
class TimedTextStyle ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextStyle {
  ...
  /* CompleteClass */
  override var flowDirection: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextFlowDirection = js.native
  ...
  /* CompleteClass */
  override var fontWeight: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextWeight = js.native
  ...
  /* CompleteClass */
  override var lineAlignment: typingsSlinky.winrtUwp.Windows.Media.Core.TimedTextLineAlignment = js.native
