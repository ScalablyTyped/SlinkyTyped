...
abstract class ApplicationView ()
  extends typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ApplicationView
/* static members */
@JSGlobal("Windows.UI.ViewManagement.ApplicationView")
@js.native
object ApplicationView extends js.Object {
  ...
  /**
    ...
    */
  def getForCurrentView(): typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ApplicationView = js.native
  ...
  var preferredLaunchWindowingMode: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ApplicationViewWindowingMode = js.native
  ...
  var value: typingsSlinky.winrtUwp.Windows.UI.ViewManagement.ApplicationViewState = js.native
}
