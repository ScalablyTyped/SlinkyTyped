...
abstract class ToastNotifier ()
  ...
  /* CompleteClass */
  override var setting: typingsSlinky.winrtUwp.Windows.UI.Notifications.NotificationSetting = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def addToSchedule(scheduledToast: typingsSlinky.winrtUwp.Windows.UI.Notifications.ScheduledToastNotification): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getScheduledToastNotifications(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Notifications.ScheduledToastNotification] = js.native
  /**
    * Removes the specified toast notification from the screen.
    * @param notification The object that specifies the toast to hide.
    */
  /* CompleteClass */
  override def hide(notification: typingsSlinky.winrtUwp.Windows.UI.Notifications.ToastNotification): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def removeFromSchedule(scheduledToast: typingsSlinky.winrtUwp.Windows.UI.Notifications.ScheduledToastNotification): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def show(notification: typingsSlinky.winrtUwp.Windows.UI.Notifications.ToastNotification): Unit = js.native
}
