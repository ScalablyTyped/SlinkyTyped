...
abstract class StoreProductPagedQueryResult ()
  ...
  /* CompleteClass */
  override var products: IMapView[String, typingsSlinky.winrtUwp.Windows.Services.Store.StoreProduct] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getNextAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Services.Store.StoreProductPagedQueryResult] = js.native
}
