...
class ContactAnnotation ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation {
  ...
  /* CompleteClass */
  override var supportedOperations: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationOperations = js.native
}
