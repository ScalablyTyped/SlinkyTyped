...
abstract class ZoomControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.ZoomControl {
  ...
  /* CompleteClass */
  override var supportedModes: IVectorView[typingsSlinky.winrtUwp.Windows.Media.Devices.ZoomTransitionMode] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def configure(settings: typingsSlinky.winrtUwp.Windows.Media.Devices.ZoomSettings): Unit = js.native
}
