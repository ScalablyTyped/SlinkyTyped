...
abstract class GattCharacteristicUuids ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicUuids
/* static members */
@JSGlobal("Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicUuids")
@js.native
object GattCharacteristicUuids extends js.Object {
  ...
  var dayDateTime: String = js.native
  ...
  var txPowerLevel: String = js.native
  
  /** Gets the Bluetooth SIG-defined UnreadAlertStatus characteristic UUID. */
  var unreadAlertStatus: String = js.native
}
