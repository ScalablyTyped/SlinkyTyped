...
abstract class MagneticStripeReaderAamvaCardDataReceivedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderAamvaCardDataReceivedEventArgs {
  ...
  /* CompleteClass */
  override var eyeColor: String = js.native
  ...
  /* CompleteClass */
  override var gender: String = js.native
  /** Gets the hair color from the swiped AAMVA card. */
  /* CompleteClass */
  override var hairColor: String = js.native
  ...
  /* CompleteClass */
  override var licenseNumber: String = js.native
  ...
  /* CompleteClass */
  override var restrictions: String = js.native
  ...
  /* CompleteClass */
  override var weight: String = js.native
}
