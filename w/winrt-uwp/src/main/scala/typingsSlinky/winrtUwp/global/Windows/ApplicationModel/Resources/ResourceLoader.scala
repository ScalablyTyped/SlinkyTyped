...
class ResourceLoader ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.ResourceLoader {
  /**
...
object ResourceLoader extends js.Object {
  /**
    ...
    */
  def getForCurrentView(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.ResourceLoader = js.native
  /**
    ...
    */
  def getForCurrentView(name: String): typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.ResourceLoader = js.native
  /**
    ...
    */
  def getForViewIndependentUse(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.ResourceLoader = js.native
  /**
    ...
    * @return A resource loader for the Resources subtree of the currently running app's main ResourceMap . This ResourceLoader uses a default context that's not associated with any view. You can't use this ResourceLoader to retrieve any resource that has resource candidates qualified for scale.
    */
  def getForViewIndependentUse(name: String): typingsSlinky.winrtUwp.Windows.ApplicationModel.Resources.ResourceLoader = js.native
  /**
