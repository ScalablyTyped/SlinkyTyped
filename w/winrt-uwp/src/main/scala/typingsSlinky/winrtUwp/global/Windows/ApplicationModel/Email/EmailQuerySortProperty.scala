...
object EmailQuerySortProperty extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortProperty with Double
  ] = js.native
  
  /* 0 */ val date: typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortProperty.date with Double = js.native
}
