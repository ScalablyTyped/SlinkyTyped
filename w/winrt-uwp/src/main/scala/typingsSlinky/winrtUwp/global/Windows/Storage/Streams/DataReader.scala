...
class DataReader protected ()
  ...
  /* CompleteClass */
  override var byteOrder: typingsSlinky.winrtUwp.Windows.Storage.Streams.ByteOrder = js.native
  /** Gets or sets the read options for the input stream. */
  /* CompleteClass */
  override var inputStreamOptions: typingsSlinky.winrtUwp.Windows.Storage.Streams.InputStreamOptions = js.native
  ...
  /* CompleteClass */
  override var unicodeEncoding: typingsSlinky.winrtUwp.Windows.Storage.Streams.UnicodeEncoding = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def loadAsync(count: Double): IPromiseWithOperation[_, typingsSlinky.winrtUwp.Windows.Storage.Streams.DataReaderLoadOperation] = js.native
  /**
