...
abstract class DevicePickerFilter ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DevicePickerFilter {
  ...
  /* CompleteClass */
  override var supportedDeviceClasses: IVector[typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceClass] = js.native
