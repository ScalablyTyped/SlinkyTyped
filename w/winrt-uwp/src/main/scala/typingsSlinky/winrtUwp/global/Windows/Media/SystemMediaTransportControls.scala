...
abstract class SystemMediaTransportControls ()
  extends typingsSlinky.winrtUwp.Windows.Media.SystemMediaTransportControls
object SystemMediaTransportControls {
  ...
  @js.native
  def getForCurrentView(): typingsSlinky.winrtUwp.Windows.Media.SystemMediaTransportControls = js.native
}
