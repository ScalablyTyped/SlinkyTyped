...
class ChatMessage ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessage {
  /** Gets a list of chat message attachments. */
  /* CompleteClass */
  override var attachments: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageAttachment] = js.native
  ...
  /* CompleteClass */
  override var localTimestamp: js.Date = js.native
  /** Gets or sets the type of the ChatMessage . */
  /* CompleteClass */
  override var messageKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageKind = js.native
  /** Gets or sets a value indicating the type of message operator, such as SMS, MMS, or RCS. */
  /* CompleteClass */
  override var messageOperatorKind: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageOperatorKind = js.native
  /** Gets the network timestamp of the message. */
  /* CompleteClass */
  override var networkTimestamp: js.Date = js.native
  /** Gets the list of send statuses for the message. */
  /* CompleteClass */
  override var recipientSendStatuses: IMapView[String, typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageStatus] = js.native
  ...
  /* CompleteClass */
  override var recipientsDeliveryInfos: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatRecipientDeliveryInfo] = js.native
  ...
  /* CompleteClass */
  override var threadingInfo: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatConversationThreadingInfo = js.native
