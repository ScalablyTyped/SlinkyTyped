...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType
import typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds
import typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess
import typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType
...
object UserDataAccounts extends js.Object {
  ...
  abstract class UserDataAccount ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount {
  ...
  abstract class UserDataAccountManager ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountManager
  
  /** Represents a data store that contains user accounts. */
  @js.native
  abstract class UserDataAccountStore ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore {
    /**
      ...
      */
    /* CompleteClass */
    override def createAccountAsync(userDisplayName: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount] = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getAccountAsync(id: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount] = js.native
  }
  ...
  object SystemAccess extends js.Object {
    ...
    class DeviceAccountConfiguration ()
      extends typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountConfiguration {
    ...
    abstract class UserDataAccountSystemAccessManager ()
      extends typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.UserDataAccountSystemAccessManager
    
    /** Defines the server types for syncing. */
    @js.native
    object DeviceAccountServerType extends js.Object {
      /* 0 */ val exchange: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.exchange with Double = js.native
      /* 2 */ val imap: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.imap with Double = js.native
      /* 1 */ val pop: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.pop with Double = js.native
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType with Double
          ] = js.native
    }
    ...
    object UserDataAccountSystemAccessManager extends js.Object {
      ...
      def addAndShowDeviceAccountsAsync(
        accounts: IIterable[
              typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountConfiguration
            ]
  ...
  object UserDataAccountContentKinds extends js.Object {
    /* 2 */ val appointment: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.appointment with Double = js.native
    /* 1 */ val contact: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.contact with Double = js.native
    /* 0 */ val email: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.email with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds with Double
      ] = js.native
  }
  ...
  object UserDataAccountManager extends js.Object {
    /**
      ...
      */
    def requestStoreAsync(storeAccessType: UserDataAccountStoreAccessType): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore
      ] = js.native
    /**
  ...
  object UserDataAccountOtherAppReadAccess extends js.Object {
    /* 1 */ val full: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess.full with Double = js.native
    /* 0 */ val systemOnly: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess.systemOnly with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess with Double
      ] = js.native
  }
  ...
  object UserDataAccountStoreAccessType extends js.Object {
    /* 0 */ val allAccountsReadOnly: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType.allAccountsReadOnly with Double = js.native
    /* 1 */ val appAccountsReadWrite: typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType.appAccountsReadWrite with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType with Double
      ] = js.native
  }
