...
class EmailMeetingInfo ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Email.EmailMeetingInfo {
  ...
  /* CompleteClass */
  override var appointmentOriginalStartTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var proposedStartTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var recurrenceStartTime: js.Date = js.native
