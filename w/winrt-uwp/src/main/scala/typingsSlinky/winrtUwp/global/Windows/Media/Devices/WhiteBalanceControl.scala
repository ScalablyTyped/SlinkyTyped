...
abstract class WhiteBalanceControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.WhiteBalanceControl {
  ...
  /* CompleteClass */
  override var preset: typingsSlinky.winrtUwp.Windows.Media.Devices.ColorTemperaturePreset = js.native
  /** Gets the step value. */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPresetAsync(preset: typingsSlinky.winrtUwp.Windows.Media.Devices.ColorTemperaturePreset): IPromiseWithIAsyncAction = js.native
  /**
