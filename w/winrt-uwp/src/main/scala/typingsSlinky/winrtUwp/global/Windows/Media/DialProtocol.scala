...
import typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult
import typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState
import typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult
...
object DialProtocol extends js.Object {
  ...
  abstract class DialApp ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialApp {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getAppStateAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStateDetails] = js.native
    /**
  ...
  abstract class DialAppStateDetails ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStateDetails {
  ...
  abstract class DialDevice ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevice {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDialApp(appName: String): typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialApp = js.native
  }
  ...
  class DialDevicePicker ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevicePicker
  ...
  abstract class DialDevicePickerFilter ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevicePickerFilter {
  ...
  abstract class DialDeviceSelectedEventArgs ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceSelectedEventArgs {
    /** Gets the DialDevice object that represents the remote device that has been selected by the user in a DialDevicePicker . */
    /* CompleteClass */
    override var selectedDialDevice: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevice = js.native
  }
  ...
  abstract class DialDisconnectButtonClickedEventArgs ()
    extends typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDisconnectButtonClickedEventArgs {
    /** Gets the DialDevice object that represents the remote device that the user wants to disconnect. */
    /* CompleteClass */
    override var device: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevice = js.native
  }
  
  /** The result of attempting to launch an app on a remote device. */
  @js.native
  object DialAppLaunchResult extends js.Object {
    /* 1 */ val failedToLaunch: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult.failedToLaunch with Double = js.native
    /* 0 */ val launched: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult.launched with Double = js.native
    /* 3 */ val networkFailure: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult.networkFailure with Double = js.native
    /* 2 */ val notFound: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult.notFound with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppLaunchResult with Double
      ] = js.native
  }
  ...
  object DialAppState extends js.Object {
    /* 3 */ val networkFailure: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState.networkFailure with Double = js.native
    /* 2 */ val running: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState.running with Double = js.native
    /* 1 */ val stopped: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState.stopped with Double = js.native
    /* 0 */ val unknown: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState.unknown with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppState with Double] = js.native
  }
  
  /** The result of attempting to stop an app from running on a remote device. */
  @js.native
  object DialAppStopResult extends js.Object {
    /* 3 */ val networkFailure: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult.networkFailure with Double = js.native
    /* 2 */ val operationNotSupported: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult.operationNotSupported with Double = js.native
    /* 1 */ val stopFailed: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult.stopFailed with Double = js.native
    /* 0 */ val stopped: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult.stopped with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialAppStopResult with Double] = js.native
  }
  ...
  object DialDevice extends js.Object {
    ...
    /**
      ...
      */
    def fromIdAsync(value: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDevice] = js.native
    /**
  ...
  object DialDeviceDisplayStatus extends js.Object {
    /* 2 */ val connected: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.connected with Double = js.native
    /* 1 */ val connecting: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.connecting with Double = js.native
    /* 4 */ val disconnected: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.disconnected with Double = js.native
    /* 3 */ val disconnecting: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.disconnecting with Double = js.native
    /* 5 */ val error: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.error with Double = js.native
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus.none with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Media.DialProtocol.DialDeviceDisplayStatus with Double
      ] = js.native
  }
