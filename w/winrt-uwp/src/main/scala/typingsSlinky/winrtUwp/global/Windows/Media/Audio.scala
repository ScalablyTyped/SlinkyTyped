...
object Audio {
  ...
  abstract class AudioFileInputNode ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.AudioFileInputNode
  ...
  abstract class AudioFileOutputNode ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.AudioFileOutputNode
  ...
  abstract class AudioFrameInputNode ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.AudioFrameInputNode
  ...
  abstract class AudioGraphConnection ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphConnection
  ...
  object AudioGraphCreationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus with Double] = js.native
    
    /* 1 */ val deviceNotAvailable: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.deviceNotAvailable with Double = js.native
    
    /* 2 */ val formatNotSupported: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.formatNotSupported with Double = js.native
    
    /* 0 */ val success: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.success with Double = js.native
    
    /* 3 */ val unknownFailure: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.unknownFailure with Double = js.native
  }
  ...
  object AudioGraphUnrecoverableError extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError with Double
      ] = js.native
    
    /* 1 */ val audioDeviceLost: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.audioDeviceLost with Double = js.native
    
    /* 2 */ val audioSessionDisconnected: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.audioSessionDisconnected with Double = js.native
    
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.none with Double = js.native
    
    /* 3 */ val unknownFailure: typingsSlinky.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.unknownFailure with Double = js.native
  }
  ...
  abstract class AudioSubmixNode ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.AudioSubmixNode
  ...
  class ReverbEffectDefinition protected ()
    extends typingsSlinky.winrtUwp.Windows.Media.Audio.ReverbEffectDefinition {
    /**
