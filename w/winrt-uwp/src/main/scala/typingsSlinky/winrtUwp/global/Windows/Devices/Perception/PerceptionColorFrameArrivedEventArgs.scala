...
abstract class PerceptionColorFrameArrivedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionColorFrameArrivedEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def tryOpenFrame(): typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionColorFrame = js.native
}
