...
object BackgroundWorkCost {
  ...
  @js.native
  def currentBackgroundWorkCost: typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundWorkCostValue = js.native
  @scala.inline
  def currentBackgroundWorkCost_=(x: typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundWorkCostValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("currentBackgroundWorkCost")(x.asInstanceOf[js.Any])
}
