...
abstract class CallControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.CallControl
...
object CallControl extends js.Object {
  /**
    ...
    */
  def fromId(deviceId: String): typingsSlinky.winrtUwp.Windows.Media.Devices.CallControl = js.native
  /**
    ...
    */
  def getDefault(): typingsSlinky.winrtUwp.Windows.Media.Devices.CallControl = js.native
}
