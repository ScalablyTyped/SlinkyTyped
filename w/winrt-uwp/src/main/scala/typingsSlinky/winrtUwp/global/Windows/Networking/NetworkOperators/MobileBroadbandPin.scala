...
abstract class MobileBroadbandPin ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPin {
  ...
  /* CompleteClass */
  override var format: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinFormat = js.native
  /** Gets the lock state for a mobile broadband PIN. */
  /* CompleteClass */
  override var lockState: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinLockState = js.native
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinType = js.native
  /**
  ...
  override def changeAsync(currentPin: String, newPin: String): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinOperationResult
  ] = js.native
  /**
