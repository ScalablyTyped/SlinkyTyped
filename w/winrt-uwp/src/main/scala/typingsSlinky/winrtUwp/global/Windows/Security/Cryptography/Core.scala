...
import typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.Capi1KdfTargetAlgorithm
import typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicPadding
...
object Core {
  ...
  abstract class CryptographicEngine ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicEngine
  object CryptographicEngine {
    ...
    @js.native
    def decrypt(
      key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey,
      data: IBuffer,
      iv: IBuffer
    ): IBuffer = js.native
    ...
    def deriveKeyMaterial(
      key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey,
      parameters: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.KeyDerivationParameters,
    ...
    def encryptAndAuthenticate(
      ...
      nonce: IBuffer,
      authenticatedData: IBuffer
    ): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.EncryptedAndAuthenticatedData = js.native
    ...
    @js.native
    def sign(key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey, data: IBuffer): IBuffer = js.native
    ...
    @js.native
    def signAsync(key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey, data: IBuffer): IPromiseWithIAsyncOperation[IBuffer] = js.native
    ...
    @js.native
    def signHashedData(key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey, data: IBuffer): IBuffer = js.native
    ...
    @js.native
    def signHashedDataAsync(key: typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey, data: IBuffer): IPromiseWithIAsyncOperation[IBuffer] = js.native
  ...
  abstract class CryptographicKey ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey
  ...
  abstract class KeyDerivationAlgorithmNames ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.KeyDerivationAlgorithmNames
  ...
  object KeyDerivationParameters {
    ...
    @js.native
    def buildForCapi1Kdf(capi1KdfTargetAlgorithm: Capi1KdfTargetAlgorithm): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.KeyDerivationParameters = js.native
  ...
  abstract class MacAlgorithmNames ()
    extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.MacAlgorithmNames
  ...
  object PersistedKeyProvider {
    ...
    @js.native
    def openKeyPairFromCertificateAsync(certificate: Certificate, hashAlgorithmName: String, padding: CryptographicPadding): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey] = js.native
    ...
    @js.native
    def openPublicKeyFromCertificate(certificate: Certificate, hashAlgorithmName: String, padding: CryptographicPadding): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.CryptographicKey = js.native
  }
