...
abstract class AsymmetricAlgorithmNames ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Core.AsymmetricAlgorithmNames
...
object AsymmetricAlgorithmNames extends js.Object {
  ...
  var ecdsaSha256: String = js.native
  /** Retrieves a string that contains "ECDSA_SHA384". */
  var ecdsaSha384: String = js.native
  /** Retrieves a string that contains "ECDSA_SHA512". */
  var ecdsaSha512: String = js.native
