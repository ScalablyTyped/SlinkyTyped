...
class PlayReadyContentHeader protected ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader {
  /**
  ...
  def this(
    ...
    contentEncryptionAlgorithm: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm,
    licenseAcquisitionUrl: Uri,
    licenseAcquisitionUserInterfaceUrl: Uri,
    customAttributes: String,
    domainServiceId: String
  ...
  /* CompleteClass */
  override var decryptorSetup: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyDecryptorSetup = js.native
  ...
  /* CompleteClass */
  override var encryptionType: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm = js.native
  /** Gets a new content header that contains any embedded license updates that were available. */
  /* CompleteClass */
  override var headerWithEmbeddedUpdates: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader = js.native
