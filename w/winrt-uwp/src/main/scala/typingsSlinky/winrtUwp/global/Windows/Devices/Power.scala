...
object Power {
  ...
  abstract class Battery ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Power.Battery
  object Battery {
    ...
    @js.native
    def aggregateBattery: typingsSlinky.winrtUwp.Windows.Devices.Power.Battery = js.native
    @scala.inline
    def aggregateBattery_=(x: typingsSlinky.winrtUwp.Windows.Devices.Power.Battery): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("aggregateBattery")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Power.Battery] = js.native
