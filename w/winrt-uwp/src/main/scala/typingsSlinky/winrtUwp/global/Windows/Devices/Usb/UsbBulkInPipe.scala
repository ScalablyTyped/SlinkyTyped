...
abstract class UsbBulkInPipe ()
  ...
  /* CompleteClass */
  override var endpointDescriptor: typingsSlinky.winrtUwp.Windows.Devices.Usb.UsbBulkInEndpointDescriptor = js.native
  ...
  /* CompleteClass */
  override var readOptions: typingsSlinky.winrtUwp.Windows.Devices.Usb.UsbReadOptions = js.native
  /**
