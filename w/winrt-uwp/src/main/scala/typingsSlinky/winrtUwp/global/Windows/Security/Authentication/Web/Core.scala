...
import typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType
import typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus
...
object Core extends js.Object {
  ...
  abstract class WebAuthenticationCoreManager ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebAuthenticationCoreManager
  
  /** Represents an error from a web account provider. */
  @js.native
  class WebProviderError protected ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError {
    /**
  ...
  class WebTokenRequest protected ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest {
    /**
  ...
  abstract class WebTokenRequestResult ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult {
    /** Gets the response data from the web token provider. */
    /* CompleteClass */
    override var responseData: IVectorView[typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenResponse] = js.native
    /** Gets the error returned by the web provider, if any. */
    /* CompleteClass */
    override var responseError: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError = js.native
  ...
  class WebTokenResponse ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenResponse {
    /**
    ...
    def this(
      ...
      error: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError
    ) = this()
    ...
    /* CompleteClass */
    override var providerError: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError = js.native
  ...
  object WebAuthenticationCoreManager extends js.Object {
    ...
    /**
      ...
      */
    def getTokenSilentlyAsync(request: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
      ] = js.native
    /**
    ...
    def getTokenSilentlyAsync(
      request: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest,
      webAccount: WebAccount
    ...
    /**
      ...
      */
    def requestTokenAsync(request: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
      ] = js.native
    /**
      * Requests a token from a web account provider asynchronously. If needed, the user may be prompted to enter their credentials.
  ...
  object WebTokenRequestPromptType extends js.Object {
    /* 0 */ val default: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType.default with Double = js.native
    /* 1 */ val forceAuthentication: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType.forceAuthentication with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType with Double
      ] = js.native
  }
  ...
  object WebTokenRequestStatus extends js.Object {
    /* 4 */ val accountProviderNotAvailable: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.accountProviderNotAvailable with Double = js.native
    /* 2 */ val accountSwitch: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.accountSwitch with Double = js.native
    /* 5 */ val providerError: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.providerError with Double = js.native
    /* 0 */ val success: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.success with Double = js.native
    /* 1 */ val userCancel: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.userCancel with Double = js.native
    /* 3 */ val userInteractionRequired: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.userInteractionRequired with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus with Double
      ] = js.native
  }
