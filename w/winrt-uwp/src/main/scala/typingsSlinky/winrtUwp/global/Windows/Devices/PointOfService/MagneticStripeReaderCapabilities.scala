...
abstract class MagneticStripeReaderCapabilities ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderCapabilities {
  /** Gets the authentication level supported by the device. */
  /* CompleteClass */
  override var authenticationLevel: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationLevel = js.native
