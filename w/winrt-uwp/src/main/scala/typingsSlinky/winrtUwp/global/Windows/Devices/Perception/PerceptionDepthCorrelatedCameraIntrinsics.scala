...
abstract class PerceptionDepthCorrelatedCameraIntrinsics ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionDepthCorrelatedCameraIntrinsics {
  /**
    ...
    */
  /* CompleteClass */
  override def unprojectAllPixelsAtCorrelatedDepthAsync(depthFrame: typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame): Results = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def unprojectRegionPixelsAtCorrelatedDepthAsync(region: Rect, depthFrame: typingsSlinky.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame): Results = js.native
}
