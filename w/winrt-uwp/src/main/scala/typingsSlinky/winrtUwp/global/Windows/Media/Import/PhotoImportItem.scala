...
abstract class PhotoImportItem ()
  ...
  /* CompleteClass */
  override var contentType: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportContentType = js.native
  ...
  /* CompleteClass */
  override var videoSegments: IVectorView[typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportVideoSegment] = js.native
}
