...
import typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget
import typingsSlinky.winrtUwp.Windows.UI.Input.Inking.PenTipShape
...
object Inking extends js.Object {
  ...
  abstract class InkRecognitionResult ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getStrokes(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke] = js.native
    /**
  ...
  class InkRecognizerContainer ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getRecognizers(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkRecognizer] = js.native
    /**
    ...
    override def recognizeAsync(
      strokeCollection: typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStrokeContainer,
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setDefaultRecognizer(recognizer: typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkRecognizer): Unit = js.native
  }
  ...
  abstract class InkStroke ()
    ...
    /* CompleteClass */
    override var drawingAttributes: typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkDrawingAttributes = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getInkPoints(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkPoint] = js.native
    /**
      * Gets the rendering segments of the stroke.
      * @return The collection of InkStrokeRenderingSegment objects.
      */
    /* CompleteClass */
    override def getRenderingSegments(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStrokeRenderingSegment] = js.native
  }
  ...
  class InkStrokeBuilder ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def appendToStroke(pointerPoint: typingsSlinky.winrtUwp.Windows.UI.Input.PointerPoint): typingsSlinky.winrtUwp.Windows.UI.Input.PointerPoint = js.native
    /**
      * Starts building the ink stroke.
      * @param pointerPoint The first point for the stroke.
      */
    /* CompleteClass */
    override def beginStroke(pointerPoint: typingsSlinky.winrtUwp.Windows.UI.Input.PointerPoint): Unit = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def createStroke(points: IIterable[Point]): typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    /**
    ...
    override def createStrokeFromInkPoints(
      inkPoints: IIterable[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkPoint],
      transform: Matrix3x2
    ): typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def endStroke(pointerPoint: typingsSlinky.winrtUwp.Windows.UI.Input.PointerPoint): typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def setDefaultDrawingAttributes(drawingAttributes: typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkDrawingAttributes): Unit = js.native
  }
  ...
  class InkStrokeContainer ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addStroke(stroke: typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke): Unit = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def addStrokes(strokes: IIterable[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkStroke]): Unit = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getRecognitionResults(): IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkRecognitionResult] = js.native
    /**
    ...
    override def updateRecognitionResults(
      recognitionResults: IVectorView[typingsSlinky.winrtUwp.Windows.UI.Input.Inking.InkRecognitionResult]
    ): Unit = js.native
  }
