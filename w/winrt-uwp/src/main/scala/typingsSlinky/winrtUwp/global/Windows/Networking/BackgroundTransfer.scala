...
object BackgroundTransfer {
  ...
  class BackgroundTransferCompletionGroup ()
    extends typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroup
  ...
  object BackgroundTransferCostPolicy extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy with Double
      ] = js.native
    
    /* 0 */ val default: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.default with Double = js.native
    
    /* 2 */ val always: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.always with Double = js.native
    
    /* 1 */ val unrestrictedOnly: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.unrestrictedOnly with Double = js.native
  }
  ...
  object BackgroundTransferPriority extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority with Double
      ] = js.native
    
    /* 0 */ val default: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.default with Double = js.native
    
    /* 1 */ val high: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.high with Double = js.native
  }
  ...
  class BackgroundUploader ()
    extends typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundUploader {
    /**
  ...
  object BackgroundUploader {
    ...
    @js.native
    def getCurrentUploadsForTransferGroupAsync(group: typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
    ...
    def requestUnconstrainedUploadsAsync(
      operations: IIterable[typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation]
    ): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult
      ] = js.native
  }
  ...
  object ContentPrefetcher {
    ...
    @scala.inline
    def lastSuccessfulPrefetchTime_=(x: js.Date): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("lastSuccessfulPrefetchTime")(x.asInstanceOf[js.Any])
  }
  ...
  abstract class DownloadOperation ()
    extends typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation
  ...
  abstract class UnconstrainedTransferRequestResult ()
    extends typingsSlinky.winrtUwp.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult
