...
object Ocr {
  ...
  object OcrEngine {
    ...
    @js.native
    def tryCreateFromLanguage(language: Language): typingsSlinky.winrtUwp.Windows.Media.Ocr.OcrEngine = js.native
    ...
    @js.native
    def tryCreateFromUserProfileLanguages(): typingsSlinky.winrtUwp.Windows.Media.Ocr.OcrEngine = js.native
  }
