...
abstract class CryptographicBuffer ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.CryptographicBuffer
object CryptographicBuffer {
  ...
  def convertBinaryToString(
    encoding: typingsSlinky.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding,
    buffer: IBuffer
  ): String = js.native
  ...
  @js.native
  def convertStringToBinary(value: String, encoding: typingsSlinky.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding): IBuffer = js.native
