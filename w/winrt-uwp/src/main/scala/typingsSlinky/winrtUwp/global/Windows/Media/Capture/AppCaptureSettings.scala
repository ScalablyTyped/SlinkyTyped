...
abstract class AppCaptureSettings ()
  extends typingsSlinky.winrtUwp.Windows.Media.Capture.AppCaptureSettings {
  /** Gets the alternate shortcut key settings. */
  /* CompleteClass */
  override var alternateShortcutKeys: typingsSlinky.winrtUwp.Windows.Media.Capture.AppCaptureAlternateShortcutKeys = js.native
  ...
  /* CompleteClass */
  override var historicalBufferLengthUnit: typingsSlinky.winrtUwp.Windows.Media.Capture.AppCaptureHistoricalBufferLengthUnit = js.native
  ...
  /* CompleteClass */
  override var videoEncodingBitrateMode: typingsSlinky.winrtUwp.Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode = js.native
  /** Gets or sets the video encoding resolution mode. */
  /* CompleteClass */
  override var videoEncodingResolutionMode: typingsSlinky.winrtUwp.Windows.Media.Capture.AppCaptureVideoEncodingResolutionMode = js.native
}
