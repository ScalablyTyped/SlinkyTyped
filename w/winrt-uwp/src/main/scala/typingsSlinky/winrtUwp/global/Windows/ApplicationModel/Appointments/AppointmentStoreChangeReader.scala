...
abstract class AppointmentStoreChangeReader ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStoreChangeReader {
  ...
  override def acceptChangesThrough(
    lastChangeToAccept: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStoreChange
  ): Unit = js.native
  /**
