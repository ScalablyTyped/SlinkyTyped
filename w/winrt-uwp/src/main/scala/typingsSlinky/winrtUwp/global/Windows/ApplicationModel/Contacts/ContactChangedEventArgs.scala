...
abstract class ContactChangedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangedEventArgs {
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangedDeferral = js.native
}
