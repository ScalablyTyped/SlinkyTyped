...
class HttpExpectationHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpExpectationHeaderValue {
  /**
...
object HttpExpectationHeaderValue {
  ...
  @js.native
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpExpectationHeaderValue = js.native
