...
import typingsSlinky.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem
...
import typingsSlinky.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus
...
object Geolocation {
  ...
  abstract class CivicAddress ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Geolocation.CivicAddress
  ...
  object GeoboundingBox {
    ...
    @JSGlobal("Windows.Devices.Geolocation.GeoboundingBox.tryCompute")
    @js.native
    def tryCompute(positions: IIterable[BasicGeoposition], altitudeRefSystem: AltitudeReferenceSystem): typingsSlinky.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox = js.native
    /**
  ...
  object Geofencing {
    ...
    object GeofenceMonitor {
      ...
      @js.native
      def current: typingsSlinky.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor = js.native
      @scala.inline
      def current_=(x: typingsSlinky.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("current")(x.asInstanceOf[js.Any])
    }
  ...
  object PositionAccuracy extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy with Double] = js.native
    
    /* 0 */ val default: typingsSlinky.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy.default with Double = js.native
    
    /* 1 */ val high: typingsSlinky.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy.high with Double = js.native
  }
  ...
  abstract class VenueData ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Geolocation.VenueData
}
