...
class ContactPicker ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactPicker {
  ...
  /* CompleteClass */
  override var desiredFieldsWithContactFieldType: IVector[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType] = js.native
  /** Controls whether the Contact Picker shows contacts as a complete entity or as a collection of fields. */
  /* CompleteClass */
  override var selectionMode: typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode = js.native
  /**
    * Launches the Contact Picker to select a single contact.
    * @return The operation that launches the Contact Picker.
    */
  /* CompleteClass */
  override def pickContactAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.Contact] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def pickSingleContactAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Contacts.ContactInformation] = js.native
}
