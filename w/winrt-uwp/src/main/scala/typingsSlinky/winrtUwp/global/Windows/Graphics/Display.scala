...
object Display {
  ...
  object DisplayInformation {
    ...
    @js.native
    def ondisplaycontentsinvalidated: TypedEventHandler[typingsSlinky.winrtUwp.Windows.Graphics.Display.DisplayInformation, js.Any] = js.native
    @scala.inline
    def ondisplaycontentsinvalidated_=(x: TypedEventHandler[typingsSlinky.winrtUwp.Windows.Graphics.Display.DisplayInformation, js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ondisplaycontentsinvalidated")(x.asInstanceOf[js.Any])
