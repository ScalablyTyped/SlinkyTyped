...
object GenericAttributeProfile {
  ...
  object GattClientCharacteristicConfigurationDescriptorValue extends StObject {
    ...
    /* 1 */ @JSName("notify")
    val notify_ : typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue.notify with Double = js.native
  }
  ...
  abstract class GattDescriptorUuids ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDescriptorUuids
  ...
  abstract class GattPresentationFormat ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattPresentationFormat
  ...
  abstract class GattPresentationFormatTypes ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattPresentationFormatTypes
  ...
  object GattWriteOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption with Double
      ] = js.native
    
    /* 0 */ val writeWithResponse: typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption.writeWithResponse with Double = js.native
    
    /* 1 */ val writeWithoutResponse: typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption.writeWithoutResponse with Double = js.native
  }
}
