...
abstract class MediaCaptureSettings ()
  extends typingsSlinky.winrtUwp.Windows.Media.Capture.MediaCaptureSettings {
  ...
  /* CompleteClass */
  override var videoDeviceCharacteristic: typingsSlinky.winrtUwp.Windows.Media.Capture.VideoDeviceCharacteristic = js.native
