...
abstract class PosPrinterStatus ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterStatus {
  ...
  /* CompleteClass */
  override var statusKind: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.PosPrinterStatusKind = js.native
}
