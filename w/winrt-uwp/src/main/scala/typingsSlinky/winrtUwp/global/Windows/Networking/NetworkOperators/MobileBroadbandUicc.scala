...
abstract class MobileBroadbandUicc ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUicc {
  ...
  override def getUiccAppsAsync(): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUiccAppsResult
  ] = js.native
}
