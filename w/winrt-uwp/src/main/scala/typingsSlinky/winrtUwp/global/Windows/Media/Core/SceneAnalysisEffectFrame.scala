...
abstract class SceneAnalysisEffectFrame ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.SceneAnalysisEffectFrame {
  ...
  /* CompleteClass */
  override var highDynamicRange: typingsSlinky.winrtUwp.Windows.Media.Core.HighDynamicRangeOutput = js.native
