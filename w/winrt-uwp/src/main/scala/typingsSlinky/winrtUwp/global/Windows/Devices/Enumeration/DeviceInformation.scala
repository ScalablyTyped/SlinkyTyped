...
abstract class DeviceInformation ()
  ...
  /* CompleteClass */
  override var enclosureLocation: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.EnclosureLocation = js.native
  ...
  /* CompleteClass */
  override var pairing: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceInformationPairing = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGlyphThumbnailAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceThumbnail] = js.native
  /**
    * Returns a thumbnail image for the device.
    * @return The object for managing the asynchronous operation that will return a DeviceThumbnail .
    */
  /* CompleteClass */
  override def getThumbnailAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceThumbnail] = js.native
  /**
    * Updates the properties of an existing DeviceInformation object.
    * @param updateInfo Indicates the properties to update.
    */
  /* CompleteClass */
  override def update(updateInfo: typingsSlinky.winrtUwp.Windows.Devices.Enumeration.DeviceInformationUpdate): Unit = js.native
}
