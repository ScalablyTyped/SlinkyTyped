...
object LocationTriggerType extends StObject {
  ...
  def apply(value: Double): js.UndefOr[
    typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.LocationTriggerType with Double
  ] = js.native
  
  /* 0 */ val geofence: typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.LocationTriggerType.geofence with Double = js.native
}
