...
class AppointmentInvitee ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentInvitee {
  ...
  /* CompleteClass */
  override var response: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse = js.native
  ...
  /* CompleteClass */
  override var role: typingsSlinky.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantRole = js.native
}
