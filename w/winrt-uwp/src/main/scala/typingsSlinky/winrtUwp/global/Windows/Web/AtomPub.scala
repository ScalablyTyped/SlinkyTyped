...
object AtomPub extends js.Object {
  ...
  class AtomPubClient ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def retrieveServiceDocumentAsync(uri: Uri): IPromiseWithIAsyncOperationWithProgress[typingsSlinky.winrtUwp.Windows.Web.AtomPub.ServiceDocument, RetrievalProgress] = js.native
    /**
  ...
  abstract class ServiceDocument ()
    ...
    /* CompleteClass */
    override var workspaces: IVectorView[typingsSlinky.winrtUwp.Windows.Web.AtomPub.Workspace] = js.native
    /**
      * Generates the DOM object that represents this element, and all the attributes and child elements including foreign markups.
      * @param format The format of the element. The only formats accepted by this method are Atom 1.0 and RSS 2.0.
      * @return The XML document.
  ...
  abstract class Workspace ()
    ...
    /* CompleteClass */
    override var collections: IVectorView[typingsSlinky.winrtUwp.Windows.Web.AtomPub.ResourceCollection] = js.native
    /** Gets the list of child elements within the element. */
    /* CompleteClass */
    override var elementExtensions: IVector[ISyndicationNode] = js.native
    /** Gets or sets the language of the element. This property represents the xml:lang attribute on the element. It may be inherited from an ancestor element. It must be valid according to XML 1.0. */
