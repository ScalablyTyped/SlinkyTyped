...
abstract class CalendarIdentifiers ()
  extends typingsSlinky.winrtUwp.Windows.Globalization.CalendarIdentifiers
object CalendarIdentifiers {
  ...
  @scala.inline
  def persian_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("persian")(x.asInstanceOf[js.Any])
