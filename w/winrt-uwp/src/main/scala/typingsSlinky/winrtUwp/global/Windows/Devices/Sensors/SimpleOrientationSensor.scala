...
abstract class SimpleOrientationSensor ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Sensors.SimpleOrientationSensor
/* static members */
@JSGlobal("Windows.Devices.Sensors.SimpleOrientationSensor")
@js.native
object SimpleOrientationSensor extends js.Object {
  ...
  /**
    ...
    */
  def getDefault(): typingsSlinky.winrtUwp.Windows.Devices.Sensors.SimpleOrientationSensor = js.native
}
