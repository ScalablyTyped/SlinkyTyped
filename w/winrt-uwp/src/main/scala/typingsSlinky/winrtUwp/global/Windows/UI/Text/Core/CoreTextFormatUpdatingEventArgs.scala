...
abstract class CoreTextFormatUpdatingEventArgs ()
  ...
  /* CompleteClass */
  override var reason: typingsSlinky.winrtUwp.Windows.UI.Text.Core.CoreTextFormatUpdatingReason = js.native
  ...
  /* CompleteClass */
  override var result: typingsSlinky.winrtUwp.Windows.UI.Text.Core.CoreTextFormatUpdatingResult = js.native
