...
abstract class MobileBroadbandDeviceInformation ()
  extends typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceInformation {
  ...
  /* CompleteClass */
  override var currentRadioState: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState = js.native
  ...
  /* CompleteClass */
  override var dataClasses: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.DataClasses = js.native
  ...
  /* CompleteClass */
  override var deviceType: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType = js.native
  ...
  /* CompleteClass */
  override var networkDeviceStatus: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.NetworkDeviceStatus = js.native
  /** Gets a MobileBroadbandPinManager object for the mobile broadband device. */
  /* CompleteClass */
  override var pinManager: typingsSlinky.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinManager = js.native
