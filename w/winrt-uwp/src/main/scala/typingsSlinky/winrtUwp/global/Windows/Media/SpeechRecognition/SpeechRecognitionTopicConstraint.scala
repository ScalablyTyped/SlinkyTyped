...
class SpeechRecognitionTopicConstraint protected ()
  ...
  /**
    ...
    */
  def this(
    scenario: typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario,
    topicHint: String
  ) = this()
  /**
  ...
  /* CompleteClass */
  override var scenario: typingsSlinky.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario = js.native
