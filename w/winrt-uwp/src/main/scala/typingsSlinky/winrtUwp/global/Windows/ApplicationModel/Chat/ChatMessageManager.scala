...
abstract class ChatMessageManager ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageManager
object ChatMessageManager {
  ...
  @js.native
  def getTransportAsync(transportId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageTransport] = js.native
  ...
  @js.native
  def requestStoreAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageStore] = js.native
  ...
  @js.native
  def showComposeSmsMessageAsync(message: typingsSlinky.winrtUwp.Windows.ApplicationModel.Chat.ChatMessage): IPromiseWithIAsyncAction = js.native
