...
import typingsSlinky.winrtUwp.Windows.Graphics.Printing.PrintTaskSourceRequestedHandler
...
abstract class PrintTaskRequest ()
  extends typingsSlinky.winrtUwp.Windows.Graphics.Printing.PrintTaskRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createPrintTask(title: String, handler: PrintTaskSourceRequestedHandler): typingsSlinky.winrtUwp.Windows.Graphics.Printing.PrintTask = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.Graphics.Printing.PrintTaskRequestedDeferral = js.native
}
