...
abstract class BackgroundExecutionManager ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundExecutionManager
...
object BackgroundExecutionManager extends js.Object {
  /**
    ...
    */
  def getAccessStatus(): typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus = js.native
  /**
    ...
    * @return One of the enumeration values that specify the app's capabilities on the lock screen.
    */
  def getAccessStatus(applicationId: String): typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus = js.native
  ...
  def requestAccessAsync(): IPromiseWithIAsyncOperation[
    typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus
  ] = js.native
  /**
    * Requests access for an app to run background tasks.
