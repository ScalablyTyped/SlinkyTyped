...
abstract class StreamedFileDataRequest ()
  extends typingsSlinky.winrtUwp.Windows.Storage.StreamedFileDataRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def failAndClose(failureMode: typingsSlinky.winrtUwp.Windows.Storage.StreamedFileFailureMode): Unit = js.native
  /**
