...
class PlaybackMediaMarkerSequence ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def first(): IIterator[typingsSlinky.winrtUwp.Windows.Media.Playback.PlaybackMediaMarker] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def insert(value: typingsSlinky.winrtUwp.Windows.Media.Playback.PlaybackMediaMarker): Unit = js.native
}
