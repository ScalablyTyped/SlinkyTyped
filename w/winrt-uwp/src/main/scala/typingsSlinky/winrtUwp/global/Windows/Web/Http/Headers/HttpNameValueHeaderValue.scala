...
import typingsSlinky.winrtUwp.anon.NameValueHeaderValue
...
class HttpNameValueHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpNameValueHeaderValue {
  /**
...
object HttpNameValueHeaderValue extends js.Object {
  ...
  /**
    ...
    */
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpNameValueHeaderValue = js.native
