...
object Core extends js.Object {
  ...
  abstract class VariablePhotoCapturedEventArgs ()
    extends typingsSlinky.winrtUwp.Windows.Media.Capture.Core.VariablePhotoCapturedEventArgs {
    ...
    /* CompleteClass */
    override var capturedFrameControlValues: typingsSlinky.winrtUwp.Windows.Media.Capture.CapturedFrameControlValues = js.native
  ...
  abstract class VariablePhotoSequenceCapture ()
    extends typingsSlinky.winrtUwp.Windows.Media.Capture.Core.VariablePhotoSequenceCapture
