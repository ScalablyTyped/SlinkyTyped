...
class PasswordVault ()
  extends typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordVault {
  /**
    * Adds a credential to the Credential Locker.
    * @param credential The credential to be added.
    */
  /* CompleteClass */
  override def add(credential: typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findAllByResource(resource: String): IVectorView[typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findAllByUserName(userName: String): IVectorView[typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential] = js.native
  /**
    * Removes a credential from the Credential Locker.
    * @param credential The credential to be removed.
    */
  /* CompleteClass */
  override def remove(credential: typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def retrieve(resource: String, userName: String): typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def retrieveAll(): IVectorView[typingsSlinky.winrtUwp.Windows.Security.Credentials.PasswordCredential] = js.native
}
