package typingsSlinky.winrtUwp.global.Windows.Security.Authentication
...
object OnlineId extends js.Object {
  ...
  class OnlineIdAuthenticator ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdAuthenticator
  ...
  abstract class OnlineIdServiceTicket ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicket {
    ...
    /* CompleteClass */
    override var request: typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest = js.native
    /** The ticket. */
    /* CompleteClass */
  ...
  class OnlineIdServiceTicketRequest protected ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest {
    /**
  ...
  abstract class SignOutUserOperation ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.SignOutUserOperation
  ...
  abstract class UserAuthenticationOperation ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.UserAuthenticationOperation
  
  /** Contains the ID, tickets, and other information associated with a user. */
  @js.native
  abstract class UserIdentity ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.UserIdentity {
    ...
    override var tickets: IVectorView[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicket
      ] = js.native
  }
  ...
  object CredentialPromptType extends js.Object {
    /* 2 */ val doNotPrompt: typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.doNotPrompt with Double = js.native
    /* 0 */ val promptIfNeeded: typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.promptIfNeeded with Double = js.native
    /* 1 */ val retypeCredentials: typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.retypeCredentials with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType with Double
      ] = js.native
  }
