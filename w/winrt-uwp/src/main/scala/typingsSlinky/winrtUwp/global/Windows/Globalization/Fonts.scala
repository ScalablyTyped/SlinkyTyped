...
object Fonts extends js.Object {
  ...
  abstract class LanguageFont ()
    extends typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont {
  ...
  class LanguageFontGroup protected ()
    extends typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFontGroup {
    /**
    ...
    /* CompleteClass */
    override var documentAlternate1Font: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended as an additional option for use in documents beyond the recommendations provided by DocumentHeadingFont , ModernDocumentFont and TraditionalDocumentFont . */
    /* CompleteClass */
    override var documentAlternate2Font: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for use in document headings. */
    /* CompleteClass */
    override var documentHeadingFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for displaying fixed-width characters. */
    /* CompleteClass */
    override var fixedWidthTextFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for typical document body text following modern style conventions. */
    /* CompleteClass */
    override var modernDocumentFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for typical document body text following traditional style conventions. */
    /* CompleteClass */
    override var traditionalDocumentFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    ...
    /* CompleteClass */
    override var uiCaptionFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    ...
    /* CompleteClass */
    override var uiHeadingFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    ...
    /* CompleteClass */
    override var uiNotificationHeadingFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for typical UI body text. */
    /* CompleteClass */
    override var uiTextFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
    /** Gets a font that is recommended for special UI elements set at sizes much larger than typical UI body text. */
    /* CompleteClass */
    override var uiTitleFont: typingsSlinky.winrtUwp.Windows.Globalization.Fonts.LanguageFont = js.native
  }
