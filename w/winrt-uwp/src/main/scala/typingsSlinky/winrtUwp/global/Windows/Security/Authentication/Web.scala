...
import typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions
...
object Web {
  ...
  object TokenBindingKeyType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType with Double
      ] = js.native
    
    /* 1 */ val ecdsaP256: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.ecdsaP256 with Double = js.native
    
    /* 0 */ val rsa2048: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.rsa2048 with Double = js.native
  }
  ...
  abstract class WebAuthenticationBroker ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationBroker
  object WebAuthenticationBroker {
    ...
    @js.native
    def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = js.native
    /**
    ...
    @JSGlobal("Windows.Security.Authentication.Web.WebAuthenticationBroker.authenticateAsync")
    @js.native
    def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri, callbackUri: Uri): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = js.native
    ...
    @js.native
    def authenticateSilentlyAsync(requestUri: Uri): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = js.native
    /**
    ...
    @JSGlobal("Windows.Security.Authentication.Web.WebAuthenticationBroker.authenticateSilentlyAsync")
    @js.native
    def authenticateSilentlyAsync(requestUri: Uri, options: WebAuthenticationOptions): IPromiseWithIAsyncOperation[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = js.native
  ...
  object WebAuthenticationOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions with Double
      ] = js.native
    
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.none with Double = js.native
    
    /* 1 */ val silentMode: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.silentMode with Double = js.native
    
    /* 4 */ val useCorporateNetwork: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useCorporateNetwork with Double = js.native
    
    /* 3 */ val useHttpPost: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useHttpPost with Double = js.native
    
    /* 2 */ val useTitle: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useTitle with Double = js.native
  }
  ...
  abstract class WebAuthenticationResult ()
    extends typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
  ...
  object WebAuthenticationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus with Double
      ] = js.native
    
    /* 2 */ val errorHttp: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.errorHttp with Double = js.native
    
    /* 0 */ val success: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.success with Double = js.native
    
    /* 1 */ val userCancel: typingsSlinky.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.userCancel with Double = js.native
  }
}
