...
import typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode
import typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode
import typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat
import typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerResolution
import typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource
...
object Scanners extends js.Object {
  ...
  abstract class ImageScanner ()
    ...
    /* CompleteClass */
    override var autoConfiguration: typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoConfiguration = js.native
    ...
    /* CompleteClass */
    override var feederConfiguration: typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerFeederConfiguration = js.native
    /** Gets and sets the scan settings of the Flatbed scan unit, like scan resolution and color mode. */
    /* CompleteClass */
    override var flatbedConfiguration: typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerFlatbedConfiguration = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def scanFilesToFolderAsync(scanSource: ImageScannerScanSource, storageFolder: StorageFolder): IPromiseWithIAsyncOperationWithProgress[typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerScanResult, Double] = js.native
    /**
      ...
      */
    /* CompleteClass */
    override def scanPreviewToStreamAsync(scanSource: ImageScannerScanSource, targetStream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Scanners.ImageScannerPreviewResult] = js.native
  }
