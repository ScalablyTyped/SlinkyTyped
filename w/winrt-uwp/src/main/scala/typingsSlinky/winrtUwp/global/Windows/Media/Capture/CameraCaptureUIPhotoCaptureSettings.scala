...
abstract class CameraCaptureUIPhotoCaptureSettings ()
  extends typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIPhotoCaptureSettings {
  ...
  /* CompleteClass */
  override var format: typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIPhotoFormat = js.native
  /** Determines the maximum resolution the user will be able to select. */
  /* CompleteClass */
  override var maxResolution: typingsSlinky.winrtUwp.Windows.Media.Capture.CameraCaptureUIMaxPhotoResolution = js.native
}
