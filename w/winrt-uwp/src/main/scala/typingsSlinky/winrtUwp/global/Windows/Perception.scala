...
object Perception {
  ...
  object People {
    ...
    abstract class HeadPose ()
      extends typingsSlinky.winrtUwp.Windows.Perception.People.HeadPose
  }
  ...
  abstract class PerceptionTimestampHelper ()
    extends typingsSlinky.winrtUwp.Windows.Perception.PerceptionTimestampHelper
  ...
  object Spatial {
    ...
    abstract class SpatialAnchorManager ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialAnchorManager
    ...
    abstract class SpatialAnchorTransferManager ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialAnchorTransferManager
    ...
    abstract class SpatialCoordinateSystem ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialCoordinateSystem
    ...
    abstract class SpatialLocation ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialLocation
    
    @JSGlobal("Windows.Perception.Spatial.SpatialLocator")
    @js.native
    abstract class SpatialLocator ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialLocator
    ...
    abstract class SpatialLocatorAttachedFrameOfReference ()
      extends typingsSlinky.winrtUwp.Windows.Perception.Spatial.SpatialLocatorAttachedFrameOfReference
