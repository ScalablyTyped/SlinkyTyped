...
class CmsAttachedSignature protected ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CmsAttachedSignature {
  /**
  ...
  /* CompleteClass */
  override var signers: IVectorView[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CmsSignerInfo] = js.native
  /**
    * Verifies the signature contained in the signed CMS message.
    * @return The result of the signature verification operation.
    */
  /* CompleteClass */
  override def verifySignature(): typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult = js.native
}
...
object CmsAttachedSignature extends js.Object {
  ...
  def generateSignatureAsync(
    data: IBuffer,
    signers: IIterable[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.CmsSignerInfo],
    certificates: IIterable[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.Certificate]
