...
class RegionOfInterest ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.RegionOfInterest {
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.winrtUwp.Windows.Media.Devices.RegionOfInterestType = js.native
