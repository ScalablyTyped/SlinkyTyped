...
class HostName protected ()
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.winrtUwp.Windows.Networking.HostNameType = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def isEqual(hostName: typingsSlinky.winrtUwp.Windows.Networking.HostName): Boolean = js.native
}
