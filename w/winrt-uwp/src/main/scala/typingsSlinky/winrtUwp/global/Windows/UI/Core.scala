...
import typingsSlinky.winrtUwp.Windows.UI.Core.AnimationMetrics.IPropertyAnimation
import typingsSlinky.winrtUwp.Windows.UI.Core.AnimationMetrics.PropertyAnimationType
