...
class SystemTrigger protected ()
  extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.SystemTrigger {
  /**
    ...
    */
  def this(
    triggerType: typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.SystemTriggerType,
    oneShot: Boolean
  ) = this()
  ...
  /* CompleteClass */
  override var triggerType: typingsSlinky.winrtUwp.Windows.ApplicationModel.Background.SystemTriggerType = js.native
}
