...
abstract class MidiInPort ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiInPort
/* static members */
@JSGlobal("Windows.Devices.Midi.MidiInPort")
@js.native
object MidiInPort extends js.Object {
  ...
  /**
    ...
    */
  def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Midi.MidiInPort] = js.native
