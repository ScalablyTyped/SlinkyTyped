...
import typingsSlinky.winrtUwp.Windows.Media.Casting.CastingConnectionErrorStatus
...
object Casting extends js.Object {
  ...
  abstract class CastingDevice ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def createCastingConnection(): typingsSlinky.winrtUwp.Windows.Media.Casting.CastingConnection = js.native
    /**
  ...
  abstract class CastingDevicePickerFilter ()
    ...
    /* CompleteClass */
    override var supportedCastingSources: IVector[typingsSlinky.winrtUwp.Windows.Media.Casting.CastingSource] = js.native
  ...
  abstract class CastingDeviceSelectedEventArgs ()
    ...
    /* CompleteClass */
    override var selectedCastingDevice: typingsSlinky.winrtUwp.Windows.Media.Casting.CastingDevice = js.native
  }
