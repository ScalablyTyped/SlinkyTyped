...
import typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode
import typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiSharingMode
...
object Spi extends js.Object {
  ...
  abstract class SpiBusInfo ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiBusInfo {
  ...
  class SpiConnectionSettings protected ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings {
    /**
  ...
  abstract class SpiController ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiController {
    /**
      ...
      */
    /* CompleteClass */
    override def getDevice(settings: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings): typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiDevice = js.native
  }
  
  /** Represents a device connected through the SPI bus. */
  @js.native
  abstract class SpiDevice ()
    extends typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiDevice {
    /** Gets the connection settings for the device. */
    /* CompleteClass */
    override var connectionSettings: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings = js.native
  ...
  object Provider extends js.Object {
    ...
    abstract class ProviderSpiConnectionSettings ()
      extends typingsSlinky.winrtUwp.Windows.Devices.Spi.Provider.ProviderSpiConnectionSettings {
      /* CompleteClass */
  ...
  object SpiController extends js.Object {
    ...
    /**
      ...
      */
    def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiController] = js.native
  }
  ...
  object SpiDevice extends js.Object {
    /**
      ...
      */
    def fromIdAsync(busId: String, settings: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiDevice] = js.native
    /**
      * Retrieves the info about a certain bus.
      * @param busId The id of the bus.
      * @return The bus info requested.
      */
    def getBusInfo(busId: String): typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiBusInfo = js.native
    /**
  ...
  object SpiMode extends js.Object {
    /* 0 */ val mode0: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode.mode0 with Double = js.native
    /* 1 */ val mode1: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode.mode1 with Double = js.native
    /* 2 */ val mode2: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode.mode2 with Double = js.native
    /* 3 */ val mode3: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode.mode3 with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiMode with Double] = js.native
  }
  
  /** Defines the sharing mode for the SPI bus. */
  @js.native
  object SpiSharingMode extends js.Object {
    /* 0 */ val exclusive: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiSharingMode.exclusive with Double = js.native
    /* 1 */ val shared: typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiSharingMode.shared with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.winrtUwp.Windows.Devices.Spi.SpiSharingMode with Double] = js.native
  }
