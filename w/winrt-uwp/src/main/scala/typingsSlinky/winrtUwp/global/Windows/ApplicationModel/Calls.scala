...
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind
import typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType
...
object Calls {
  ...
  abstract class LockScreenCallUI ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.LockScreenCallUI
  ...
  class PhoneCallHistoryEntry ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntry
  ...
  object PhoneCallHistoryEntryMedia extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia with Double
      ] = js.native
    
    /* 0 */ val audio: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.audio with Double = js.native
    
    /* 1 */ val video: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.video with Double = js.native
  }
  ...
  object PhoneCallHistoryEntryOtherAppReadAccess extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess with Double
      ] = js.native
    
    /* 0 */ val full: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.full with Double = js.native
    
    /* 1 */ val systemOnly: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.systemOnly with Double = js.native
  }
  ...
  object PhoneCallHistoryEntryQueryDesiredMedia extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia with Double
      ] = js.native
    
    /* 3 */ val all: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.all with Double = js.native
    
    /* 1 */ val audio: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.audio with Double = js.native
    
    /* 0 */ val none: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.none with Double = js.native
    
    /* 2 */ val video: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.video with Double = js.native
  }
  ...
  object PhoneCallHistoryEntryRawAddressKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind with Double
      ] = js.native
    
    /* 1 */ val custom: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind.custom with Double = js.native
    
    /* 0 */ val phoneNumber: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind.phoneNumber with Double = js.native
  }
  ...
  object PhoneCallHistoryManager {
    ...
    @js.native
    def requestStoreAsync(accessType: PhoneCallHistoryStoreAccessType): IPromiseWithIAsyncOperation[typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStore] = js.native
  }
  ...
  object PhoneCallHistorySourceIdKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind with Double
      ] = js.native
    
    /* 0 */ val cellularPhoneLineId: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind.cellularPhoneLineId with Double = js.native
    
    /* 1 */ val packageFamilyName: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind.packageFamilyName with Double = js.native
  }
  ...
  abstract class PhoneCallHistoryStore ()
    extends typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStore
  ...
  object PhoneCallHistoryStoreAccessType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType with Double
      ] = js.native
    
    /* 1 */ val allEntriesLimitedReadWrite: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.allEntriesLimitedReadWrite with Double = js.native
    
    /* 2 */ val allEntriesReadWrite: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.allEntriesReadWrite with Double = js.native
    
    /* 0 */ val appEntriesReadWrite: typingsSlinky.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.appEntriesReadWrite with Double = js.native
  }
}
