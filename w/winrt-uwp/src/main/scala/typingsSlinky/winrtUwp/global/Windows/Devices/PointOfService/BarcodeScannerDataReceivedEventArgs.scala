...
abstract class BarcodeScannerDataReceivedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.PointOfService.BarcodeScannerDataReceivedEventArgs {
  /** Gets the data from the DataReceived event. */
  /* CompleteClass */
  override var report: typingsSlinky.winrtUwp.Windows.Devices.PointOfService.BarcodeScannerReport = js.native
}
