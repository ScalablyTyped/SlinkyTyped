...
abstract class PhotoImportSource ()
  ...
  /* CompleteClass */
  override var connectionTransport: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportConnectionTransport = js.native
  /** Gets the current date and time on the device. */
  /* CompleteClass */
  override var dateTime: js.Date = js.native
  ...
  /* CompleteClass */
  override var powerSource: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportPowerSource = js.native
  ...
  /* CompleteClass */
  override var storageMedia: IVectorView[typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportStorageMedium] = js.native
  ...
  /* CompleteClass */
  override var `type`: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportSourceType = js.native
  /**
    * Creates a new photo import session.
    * @return The new PhotoImportSession object.
    */
  /* CompleteClass */
  override def createImportSession(): typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportSession = js.native
}
