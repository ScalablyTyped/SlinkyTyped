...
class ChainBuildingParameters ()
  extends typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.ChainBuildingParameters {
  ...
  /* CompleteClass */
  override var exclusiveTrustRoots: IVector[typingsSlinky.winrtUwp.Windows.Security.Cryptography.Certificates.Certificate] = js.native
  ...
  /* CompleteClass */
  override var validationTimestamp: js.Date = js.native
}
