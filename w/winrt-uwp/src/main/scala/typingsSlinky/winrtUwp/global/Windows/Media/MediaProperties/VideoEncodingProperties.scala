...
class VideoEncodingProperties ()
  ...
  /* CompleteClass */
  override var frameRate: typingsSlinky.winrtUwp.Windows.Media.MediaProperties.MediaRatio = js.native
  /** Gets or sets the video image height. */
  /* CompleteClass */
  override var height: Double = js.native
  /** Gets or sets the pixel aspect ratio. */
  /* CompleteClass */
  override var pixelAspectRatio: typingsSlinky.winrtUwp.Windows.Media.MediaProperties.MediaRatio = js.native
