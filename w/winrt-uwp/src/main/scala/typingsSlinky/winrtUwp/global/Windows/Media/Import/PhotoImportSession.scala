...
abstract class PhotoImportSession ()
  ...
  /* CompleteClass */
  override var source: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportSource = js.native
  /** Gets or sets a value indicating the method used for naming subfolders within the destination folder. */
  /* CompleteClass */
  override var subfolderCreationMode: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportSubfolderCreationMode = js.native
  ...
  override def findItemsAsync(
    contentTypeFilter: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportContentTypeFilter,
    itemSelectionMode: typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportItemSelectionMode
  ): IPromiseWithIAsyncOperationWithProgress[typingsSlinky.winrtUwp.Windows.Media.Import.PhotoImportFindItemsResult, Double] = js.native
}
