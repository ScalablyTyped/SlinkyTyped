...
abstract class KnownUserProperties ()
  extends typingsSlinky.winrtUwp.Windows.System.KnownUserProperties
object KnownUserProperties {
  ...
  @scala.inline
  def accountName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("accountName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def domainName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("domainName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def firstName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("firstName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def guestHost_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("guestHost")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def lastName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("lastName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def principalName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("principalName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def providerName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("providerName")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def sessionInitiationProtocolUri_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sessionInitiationProtocolUri")(x.asInstanceOf[js.Any])
}
