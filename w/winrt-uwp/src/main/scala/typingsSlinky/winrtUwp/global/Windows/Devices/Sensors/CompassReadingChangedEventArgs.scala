...
abstract class CompassReadingChangedEventArgs ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Sensors.CompassReadingChangedEventArgs {
  /** Gets the current compass reading. */
  /* CompleteClass */
  override var reading: typingsSlinky.winrtUwp.Windows.Devices.Sensors.CompassReading = js.native
}
