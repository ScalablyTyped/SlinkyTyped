...
import typingsSlinky.winrtUwp.anon.LanguageRangeWithQualityHeaderValue
...
class HttpLanguageRangeWithQualityHeaderValue protected ()
  extends typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue {
  /**
...
object HttpLanguageRangeWithQualityHeaderValue extends js.Object {
  /**
    ...
    */
  def parse(input: String): typingsSlinky.winrtUwp.Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue = js.native
  /**
