...
abstract class SystemMusicProperties ()
  extends typingsSlinky.winrtUwp.Windows.Storage.SystemMusicProperties {
  ...
  /* CompleteClass */
  override var trackNumber: String = js.native
}
