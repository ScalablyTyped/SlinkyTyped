...
abstract class IsoSpeedControl ()
  extends typingsSlinky.winrtUwp.Windows.Media.Devices.IsoSpeedControl {
  ...
  /* CompleteClass */
  override var preset: typingsSlinky.winrtUwp.Windows.Media.Devices.IsoSpeedPreset = js.native
  ...
  /* CompleteClass */
  override var supportedPresets: IVectorView[typingsSlinky.winrtUwp.Windows.Media.Devices.IsoSpeedPreset] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPresetAsync(preset: typingsSlinky.winrtUwp.Windows.Media.Devices.IsoSpeedPreset): IPromiseWithIAsyncAction = js.native
  /**
