...
abstract class MediaStreamSourceStartingRequest ()
  extends typingsSlinky.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsSlinky.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingRequestDeferral = js.native
  /**
