...
abstract class PlayReadyStatics ()
  extends typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyStatics
...
object PlayReadyStatics extends js.Object {
  ...
  def checkSupportedHardware(
    hwdrmFeature: typingsSlinky.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyHardwareDRMFeatures
  ): Boolean = js.native
}
