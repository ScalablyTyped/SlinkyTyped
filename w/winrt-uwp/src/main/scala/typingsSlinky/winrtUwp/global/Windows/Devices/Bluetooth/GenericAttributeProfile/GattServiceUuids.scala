...
abstract class GattServiceUuids ()
  extends typingsSlinky.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattServiceUuids
/* static members */
@JSGlobal("Windows.Devices.Bluetooth.GenericAttributeProfile.GattServiceUuids")
@js.native
object GattServiceUuids extends js.Object {
  ...
  var alertNotification: String = js.native
  ...
  var bloodPressure: String = js.native
