...
import typingsSlinky.winrtUwp.Windows.Security.Credentials.UI.AuthenticationProtocol
import typingsSlinky.winrtUwp.Windows.Security.Credentials.UI.CredentialSaveOption
