...
abstract class StoreSubscriptionInfo ()
  ...
  /* CompleteClass */
  override var billingPeriodUnit: typingsSlinky.winrtUwp.Windows.Services.Store.StoreDurationUnit = js.native
  ...
  /* CompleteClass */
  override var trialPeriodUnit: typingsSlinky.winrtUwp.Windows.Services.Store.StoreDurationUnit = js.native
}
