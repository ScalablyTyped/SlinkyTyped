...
class UsbControlRequestType ()
  ...
  /* CompleteClass */
  override var controlTransferType: typingsSlinky.winrtUwp.Windows.Devices.Usb.UsbControlTransferType = js.native
  ...
  /* CompleteClass */
  override var recipient: typingsSlinky.winrtUwp.Windows.Devices.Usb.UsbControlRecipient = js.native
}
