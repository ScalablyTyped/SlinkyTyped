...
object Transformer {
  ...
  implicit class TransformerOps[Self <: Transformer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddSource(value: (String, String) => Transformer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addSource")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGenerate(value: String => js.Promise[Unit]): Self = {
        val ret = this.duplicate
