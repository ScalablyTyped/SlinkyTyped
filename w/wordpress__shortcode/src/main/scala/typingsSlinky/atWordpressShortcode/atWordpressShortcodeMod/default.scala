...
import typingsSlinky.atWordpressShortcode.Anon_Clear
...
object default extends js.Object {
  @JSName("attrs")
  var attrs_Original: Anon_Clear = js.native
  @JSName("fromMatch")
  var fromMatch_Original: js.Function1[/* match */ RegExpMatchArray, Shortcode] = js.native
  @JSName("next")
  ...
  var replace_Original: js.Function3[
    /* tag */ String, 
    /* text */ String, 
    /* callback */ js.Function1[/* shortcode */ Shortcode, String], 
    String
  ] = js.native
