...
import typingsSlinky.wordpressShortcode.anon.Attrs
import typingsSlinky.wordpressShortcode.anon.Call
import typingsSlinky.wordpressShortcode.anon.Content
...
import typingsSlinky.wordpressShortcode.anon.Type
...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def regexp_=(x: js.Function1[/* tag */ String, js.RegExp]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("regexp")(x.asInstanceOf[js.Any])
