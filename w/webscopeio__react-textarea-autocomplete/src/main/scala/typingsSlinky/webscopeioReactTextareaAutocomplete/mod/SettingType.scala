...
object SettingType {
  ...
  @scala.inline
  implicit class SettingTypeOps[Self[titem] <: SettingType[titem], TItem] (val x: Self[TItem]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataProvider(value: /* token */ String => js.Promise[js.Array[TItem]] | js.Array[TItem]): Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataProvider")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAfterWhitespace(value: Boolean): Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("afterWhitespace")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAfterWhitespace: Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("afterWhitespace")(js.undefined)
        ret
    }
    @scala.inline
    def withAllowWhitespace(value: Boolean): Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowWhitespace")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAllowWhitespace: Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowWhitespace")(js.undefined)
        ret
    }
    @scala.inline
    def withOutput(value: (/* item */ TItem, /* trigger */ js.UndefOr[String]) => TextToReplaceType | String): Self[TItem] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("output")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutOutput: Self[TItem] = {
        val ret = this.duplicate
