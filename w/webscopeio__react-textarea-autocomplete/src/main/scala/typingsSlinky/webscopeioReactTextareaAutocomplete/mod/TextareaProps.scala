...
trait TextareaProps[TItem] extends TextareaHTMLAttributes[HTMLTextAreaElement] {
  ...
  /**
    ...
    */
  var loadingComponent: ReactComponentClass[js.Object]
  /**
...
object TextareaProps {
  ...
  def apply[TItem](
    ...
    minChar: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(minChar)) __obj.updateDynamic("minChar")(minChar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(minLength)) __obj.updateDynamic("minLength")(minLength.get.asInstanceOf[js.Any])
    if (!js.isUndefined(movePopupAsYouType)) __obj.updateDynamic("movePopupAsYouType")(movePopupAsYouType.get.asInstanceOf[js.Any])
