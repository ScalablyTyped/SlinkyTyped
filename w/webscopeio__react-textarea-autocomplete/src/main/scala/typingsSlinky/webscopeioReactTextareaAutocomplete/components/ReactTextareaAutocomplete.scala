...
object ReactTextareaAutocomplete {
  ...
  class Builder[/* <: java.lang.String | js.Object */ TItem] (val args: js.Array[js.Any])
    ...
    @scala.inline
    def closeOnClickOutside(value: Boolean): this.type = set("closeOnClickOutside", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def innerRef(value: /* ref */ HTMLTextAreaElement => Unit): this.type = set("innerRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def loaderClassName(value: String): this.type = set("loaderClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def loaderStyle(value: CSSProperties): this.type = set("loaderStyle", value.asInstanceOf[js.Any])
    @scala.inline
    def maxLength(value: Double): this.type = set("maxLength", value.asInstanceOf[js.Any])
    @scala.inline
    def minChar(value: Double): this.type = set("minChar", value.asInstanceOf[js.Any])
    @scala.inline
    def minLength(value: Double): this.type = set("minLength", value.asInstanceOf[js.Any])
    @scala.inline
    def movePopupAsYouType(value: Boolean): this.type = set("movePopupAsYouType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def onCaretPositionChange(value: /* pos */ Double => Unit): this.type = set("onCaretPositionChange", js.Any.fromFunction1(value))
    @scala.inline
