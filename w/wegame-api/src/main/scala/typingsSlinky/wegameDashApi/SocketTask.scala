...
import typingsSlinky.wegameDashApi.wx.types.SocketCloseParams
import typingsSlinky.wegameDashApi.wx.types.SocketErrorCallback
import typingsSlinky.wegameDashApi.wx.types.SocketMessageCallback
import typingsSlinky.wegameDashApi.wx.types.SocketOpenCallback
import typingsSlinky.wegameDashApi.wx.types.SocketSendParams
