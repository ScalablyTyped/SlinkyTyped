...
import typingsSlinky.wegameDashApi.wx.types.AccessfileParams
import typingsSlinky.wegameDashApi.wx.types.AppendfileParams
import typingsSlinky.wegameDashApi.wx.types.CallbacksWithType
import typingsSlinky.wegameDashApi.wx.types.CopyfileParams
import typingsSlinky.wegameDashApi.wx.types.FileContentEncoding
import typingsSlinky.wegameDashApi.wx.types.FileinfoParams
import typingsSlinky.wegameDashApi.wx.types.MkdirParams
import typingsSlinky.wegameDashApi.wx.types.ReaddirParams
import typingsSlinky.wegameDashApi.wx.types.ReadfileParams
import typingsSlinky.wegameDashApi.wx.types.RemovefileParams
import typingsSlinky.wegameDashApi.wx.types.RenameParams
import typingsSlinky.wegameDashApi.wx.types.RmdirParams
import typingsSlinky.wegameDashApi.wx.types.SavedfileList
import typingsSlinky.wegameDashApi.wx.types.SavefileParams
import typingsSlinky.wegameDashApi.wx.types.StatParams
import typingsSlinky.wegameDashApi.wx.types.UnlinkParams
import typingsSlinky.wegameDashApi.wx.types.UnzipParams
import typingsSlinky.wegameDashApi.wx.types.WritefileParams
...
class FileSystemManager () extends js.Object {
  ...
  def readFileSync(filePath: String, encoding: FileContentEncoding): String | scala.scalajs.js.typedarray.ArrayBuffer = js.native
  /**
    * 读取目录内文件列表
    */
