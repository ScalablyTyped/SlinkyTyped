...
import typingsSlinky.wegameDashApi.wegameDashApiStrings.done
import typingsSlinky.wegameDashApi.wegameDashApiStrings.go
import typingsSlinky.wegameDashApi.wegameDashApiStrings.next
import typingsSlinky.wegameDashApi.wegameDashApiStrings.search
import typingsSlinky.wegameDashApi.wegameDashApiStrings.send
