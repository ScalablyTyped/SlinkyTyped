...
import typingsSlinky.wegameDashApi.wegameDashApiStrings.album
import typingsSlinky.wegameDashApi.wegameDashApiStrings.camera
import typingsSlinky.wegameDashApi.wegameDashApiStrings.compressed
import typingsSlinky.wegameDashApi.wegameDashApiStrings.original
