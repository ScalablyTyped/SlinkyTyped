...
import typingsSlinky.wegameDashApi.Anon_Accept
import typingsSlinky.wegameDashApi.Anon_ErrCode
import typingsSlinky.wegameDashApi.Anon_TmplIds
import typingsSlinky.wegameDashApi.wx.types.CallbacksWithType2
