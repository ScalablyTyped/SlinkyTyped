...
object ButtonType {
  ...
  @scala.inline
  def image: typingsSlinky.wegameDashApi.wegameDashApiStrings.image = this.cast("image")
  @scala.inline
  def text: typingsSlinky.wegameDashApi.wegameDashApiStrings.text = this.cast("text")
}
