...
import typingsSlinky.wegameApi.wegameApiStrings.accept
import typingsSlinky.wegameApi.wegameApiStrings.ban
import typingsSlinky.wegameApi.wegameApiStrings.reject
