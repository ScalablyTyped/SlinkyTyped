...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.wegameApi.wegameApiStrings.green
  - typingsSlinky.wegameApi.wegameApiStrings.white
  - typingsSlinky.wegameApi.wegameApiStrings.dark
  - typingsSlinky.wegameApi.wegameApiStrings.light
*/
