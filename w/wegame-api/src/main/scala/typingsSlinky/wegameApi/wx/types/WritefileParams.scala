...
object WritefileParams {
  @scala.inline
  def apply(data: String | js.typedarray.ArrayBuffer, filePath: String): WritefileParams = {
  ...
  @scala.inline
  implicit class WritefileParamsOps[Self <: WritefileParams] (val x: Self) extends AnyVal {
    @scala.inline
