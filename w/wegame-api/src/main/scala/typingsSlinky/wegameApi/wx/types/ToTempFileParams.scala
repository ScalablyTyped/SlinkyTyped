...
object ToTempFileParams {
  ...
  @scala.inline
  implicit class ToTempFileParamsMutableBuilder[Self <: ToTempFileParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* res */ TempFilePath => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
