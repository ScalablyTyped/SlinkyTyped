...
import typingsSlinky.wegameApi.anon.AdUnitId
import typingsSlinky.wegameApi.anon.AdUnitIdStyle
import typingsSlinky.wegameApi.anon.Alpha
import typingsSlinky.wegameApi.anon.Altitude
import typingsSlinky.wegameApi.anon.AudioSources
import typingsSlinky.wegameApi.anon.AuthSetting
import typingsSlinky.wegameApi.anon.Autoplay
import typingsSlinky.wegameApi.anon.Bottom
...
import typingsSlinky.wegameApi.anon.CompleteFail
import typingsSlinky.wegameApi.anon.ConfirmHold
import typingsSlinky.wegameApi.anon.Count
import typingsSlinky.wegameApi.anon.Current
import typingsSlinky.wegameApi.anon.Direction
import typingsSlinky.wegameApi.anon.EnableDebug
import typingsSlinky.wegameApi.anon.ErrCodeErrMsg
import typingsSlinky.wegameApi.anon.ExtConfig
import typingsSlinky.wegameApi.anon.Fail
import typingsSlinky.wegameApi.anon.FailShareTicket
import typingsSlinky.wegameApi.anon.FailStyle
import typingsSlinky.wegameApi.anon.FailSuccess
import typingsSlinky.wegameApi.anon.FilePath
import typingsSlinky.wegameApi.anon.Icon
import typingsSlinky.wegameApi.anon.ImageUrl
import typingsSlinky.wegameApi.anon.ImageUrlId
import typingsSlinky.wegameApi.anon.IsConnected
import typingsSlinky.wegameApi.anon.ItemColor
import typingsSlinky.wegameApi.anon.Iv
import typingsSlinky.wegameApi.anon.KeyList
import typingsSlinky.wegameApi.anon.Level
import typingsSlinky.wegameApi.anon.List
import typingsSlinky.wegameApi.anon.Mask
import typingsSlinky.wegameApi.anon.Name
import typingsSlinky.wegameApi.anon.OpenIdList
import typingsSlinky.wegameApi.anon.Query
import typingsSlinky.wegameApi.anon.Scope
import typingsSlinky.wegameApi.anon.SendMessageImg
import typingsSlinky.wegameApi.anon.ShareMessageToFriendScene
import typingsSlinky.wegameApi.anon.ShareTicket
import typingsSlinky.wegameApi.anon.SizeType
import typingsSlinky.wegameApi.anon.Stack
import typingsSlinky.wegameApi.anon.Style
import typingsSlinky.wegameApi.anon.StyleSuccess
import typingsSlinky.wegameApi.anon.Success
import typingsSlinky.wegameApi.anon.Text
import typingsSlinky.wegameApi.anon.Title
import typingsSlinky.wegameApi.anon.TodayPlayedTime
import typingsSlinky.wegameApi.anon.Value
import typingsSlinky.wegameApi.anon.ValueString
import typingsSlinky.wegameApi.anon.WindowHeight
...
import typingsSlinky.wegameApi.anon.keyListArraystringCallbac
import typingsSlinky.wegameApi.anon.tmplIdsReadonlyArraystrin
import typingsSlinky.wegameApi.wx.types.AccelerometerParams
import typingsSlinky.wegameApi.wx.types.BatteryInfo
import typingsSlinky.wegameApi.wx.types.Callbacks
import typingsSlinky.wegameApi.wx.types.CallbacksWithType
import typingsSlinky.wegameApi.wx.types.ClipboardData
import typingsSlinky.wegameApi.wx.types.DownfileParams
import typingsSlinky.wegameApi.wx.types.GetStorageParams
import typingsSlinky.wegameApi.wx.types.Image
import typingsSlinky.wegameApi.wx.types.LaunchOption
import typingsSlinky.wegameApi.wx.types.LineHeightParams
import typingsSlinky.wegameApi.wx.types.NewUserInfoParam
import typingsSlinky.wegameApi.wx.types.OldUserInfoParam
import typingsSlinky.wegameApi.wx.types.RemoveStorageParams
import typingsSlinky.wegameApi.wx.types.RequestParams
import typingsSlinky.wegameApi.wx.types.SetClipboardDataParams
import typingsSlinky.wegameApi.wx.types.SetKeepScreenOnParams
import typingsSlinky.wegameApi.wx.types.SetScreenBrightnessParams
import typingsSlinky.wegameApi.wx.types.SetStorageParams
import typingsSlinky.wegameApi.wx.types.ShareOption
import typingsSlinky.wegameApi.wx.types.SocketCloseParams
import typingsSlinky.wegameApi.wx.types.SocketConnectParams
...
import typingsSlinky.wegameApi.wx.types.SystemInfo
import typingsSlinky.wegameApi.wx.types.TouchData
...
object wx extends js.Object {
  ...
  /**
    ...
    */
  def connectSocket(param: SocketConnectParams): typingsSlinky.wegameApi.SocketTask = js.native
  
  // --广告
  /**
    * 创建 banner 广告组件。请通过 wx.getSystemInfoSync() 返回对象的 SDKVersion 判断基础库版本号 >= 2.0.4 后再使用该 API。同时，开发者工具上暂不支持调试该 API，请直接在真机上进行调试。
    */
  def createBannerAd(param: AdUnitIdStyle): typingsSlinky.wegameApi.BannerAd = js.native
  ...
  /**
    ...
    */
  def createCanvas(): typingsSlinky.wegameApi.Canvas = js.native
  
  // --意见反馈
  /**
    * 用户点击后打开意见反馈页面的按钮
    */
  def createFeedbackButton(param: Text): typingsSlinky.wegameApi.FeedbackButton = js.native
  ...
  /**
    ...
    */
  def createGameClubButton(param: Icon): typingsSlinky.wegameApi.GameClubButton = js.native
  ...
  /**
    ...
    */
  def createInnerAudioContext(): typingsSlinky.wegameApi.InnerAudioContext = js.native
  
  /**
    * 创建插屏广告组件。请通过 wx.getSystemInfoSync() 返回对象的 SDKVersion 判断基础库版本号后再使用该 API。每次调用该方法创建插屏广告都会返回一个全新的实例（小程序端的插屏广告实例不允许跨页面使用）。
    */
  def createInterstitialAd(param: AdUnitId): typingsSlinky.wegameApi.InterstitialAd = js.native
  
  // --设置
  /**
    * 创建打开设置页面的按钮
    */
  def createOpenSettingButton(param: Text): typingsSlinky.wegameApi.OpenSettingButton = js.native
  
  /**
    * 创建激励视频广告组件。请通过 wx.getSystemInfoSync() 返回对象的 SDKVersion 判断基础库版本号 >= 2.0.4 后再使用该 API。同时，开发者工具上暂不支持调试该 API，请直接在真机上进行调试。
    */
  def createRewardedVideoAd(param: AdUnitId): typingsSlinky.wegameApi.RewardedVideoAd = js.native
  
  // --UDP通信
  /**
    * 创建一个 UDP Socket 实例
    */
  def createUDPSocket(): typingsSlinky.wegameApi.UDPSocket = js.native
  
  // --用户信息
  def createUserInfoButton(param: typingsSlinky.wegameApi.anon.Image): typingsSlinky.wegameApi.UserInfoButton = js.native
  
  // --视频
  def createVideo(param: Autoplay): typingsSlinky.wegameApi.Video = js.native
  
  // --Worker
  /**
    * 创建一个 Worker 线程，目前限制最多只能创建一个 Worker，创建下一个 Worker 前请调用 Worker.terminate
    */
  def createWorker(): typingsSlinky.wegameApi.WxWorker = js.native
  
  // --网络
  /**
    * 下载文件
    */
  def downloadFile(param: DownfileParams): typingsSlinky.wegameApi.DownloadTask = js.native
  ...
  // --文件系统
  def getFileSystemManager(): typingsSlinky.wegameApi.FileSystemManager = js.native
  ...
  /**
    ...
    * @param param 初始化时的参数
    */
  def getLogManager(): typingsSlinky.wegameApi.LogManager = js.native
  def getLogManager(param: `3`): typingsSlinky.wegameApi.LogManager = js.native
  ...
  /**
    * 获取开放数据域
    */
  def getOpenDataContext(): typingsSlinky.wegameApi.OpenDataContext = js.native
  
  // --性能
  /**
    * 获取性能管理器
    */
  def getPerformance(): typingsSlinky.wegameApi.WxPerformance = js.native
  ...
  // --录音
  def getRecorderManager(): typingsSlinky.wegameApi.RecorderManager = js.native
  ...
  /**
    ...
    */
  def getSharedCanvas(): typingsSlinky.wegameApi.Canvas = js.native
  ...
  // --更新
  def getUpdateManager(): typingsSlinky.wegameApi.UpdateManager = js.native
  ...
  /**
    * 触发分包加载，详见 分包加载
    */
  def loadSubpackage(param: Name): typingsSlinky.wegameApi.LoadSubpackageTask = js.native
  ...
  // --发起请求
  def request(param: RequestParams): typingsSlinky.wegameApi.RequestTask = js.native
  ...
  // --上传
  def uploadFile(param: Complete): typingsSlinky.wegameApi.UploadTask = js.native
