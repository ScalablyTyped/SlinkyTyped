...
trait AnonKeyList extends js.Object {
  ...
  var success: js.UndefOr[js.Function1[/* res */ AnonKVDataList, Unit]] = js.native
}
...
object AnonKeyList {
  ...
  @scala.inline
  implicit class AnonKeyListOps[Self <: AnonKeyList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonKVDataList => Unit): Self = {
        val ret = this.duplicate
