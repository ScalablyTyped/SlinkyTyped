...
object BuyQuantity {
  ...
  implicit class BuyQuantityMutableBuilder[Self <: BuyQuantity] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnv(value: typingsSlinky.wegameApi.wegameApiNumbers.`0` | typingsSlinky.wegameApi.wegameApiNumbers.`1`): Self = StObject.set(x, "env", value.asInstanceOf[js.Any])
