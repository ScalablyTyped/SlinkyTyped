...
object FailShareTicket {
  ...
  @scala.inline
  implicit class FailShareTicketOps[Self <: FailShareTicket] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* res */ EncryptedDataErrMsg => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
