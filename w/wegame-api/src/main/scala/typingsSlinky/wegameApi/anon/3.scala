...
object `3` {
  ...
  implicit class `3Ops`[Self <: `3`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevel(value: typingsSlinky.wegameApi.wegameApiNumbers.`0` | typingsSlinky.wegameApi.wegameApiNumbers.`1`): Self = this.set("level", value.asInstanceOf[js.Any])
