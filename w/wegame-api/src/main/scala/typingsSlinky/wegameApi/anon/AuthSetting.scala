...
trait AuthSetting extends StObject {
  ...
  var authSetting: typingsSlinky.wegameApi.wx.types.AuthSetting = js.native
}
object AuthSetting {
  ...
  implicit class AuthSettingMutableBuilder[Self <: AuthSetting] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthSetting(value: typingsSlinky.wegameApi.wx.types.AuthSetting): Self = StObject.set(x, "authSetting", value.asInstanceOf[js.Any])
  }
}
