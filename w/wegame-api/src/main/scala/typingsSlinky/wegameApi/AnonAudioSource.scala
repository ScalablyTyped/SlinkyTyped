...
import typingsSlinky.wegameApi.wegameApiNumbers.`2`
...
trait AnonAudioSource extends js.Object {
  ...
  /**
    * 录音通道数
    */
  var numberOfChannels: `1` | `2` = js.native
  /**
    * 采样率
    */
...
object AnonAudioSource {
  ...
  @scala.inline
  implicit class AnonAudioSourceOps[Self <: AnonAudioSource] (val x: Self) extends AnyVal {
    @scala.inline
