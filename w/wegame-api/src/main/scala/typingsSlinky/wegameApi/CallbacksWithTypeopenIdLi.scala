...
trait CallbacksWithTypeopenIdLi extends js.Object {
  ...
  /**
    * 静音设置
    */
  var muteConfig: js.UndefOr[AnonMuteEarphone] = js.native
  /**
    * 验证所需的随机字符串
    */
  ...
  var success: js.UndefOr[js.Function1[/* res */ AnonOpenIdList, Unit]] = js.native
  /**
    * 验证所需的时间戳
    */
...
object CallbacksWithTypeopenIdLi {
  ...
  implicit class CallbacksWithTypeopenIdLiOps[Self <: CallbacksWithTypeopenIdLi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMuteConfig(value: AnonMuteEarphone): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonOpenIdList => Unit): Self = {
        val ret = this.duplicate
