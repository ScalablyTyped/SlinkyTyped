...
trait AnonFailShareTicket extends js.Object {
  ...
  var success: js.UndefOr[js.Function1[/* res */ AnonEncryptedDataErrMsg, Unit]] = js.native
}

object AnonFailShareTicket {
  @scala.inline
  def apply(shareTicket: String): AnonFailShareTicket = {
    val __obj = js.Dynamic.literal(shareTicket = shareTicket.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFailShareTicket]
  }
  @scala.inline
  implicit class AnonFailShareTicketOps[Self <: AnonFailShareTicket] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonEncryptedDataErrMsg => Unit): Self = {
        val ret = this.duplicate
