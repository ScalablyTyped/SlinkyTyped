...
trait AnonTodayPlayedTime extends js.Object {
  ...
  var success: js.UndefOr[js.Function1[/* res */ AnonResult, Unit]] = js.native
  /**
    * 今天已经玩游戏的时间，单位：秒
    */
...
object AnonTodayPlayedTime {
  @scala.inline
  def apply(todayPlayedTime: Double): AnonTodayPlayedTime = {
    val __obj = js.Dynamic.literal(todayPlayedTime = todayPlayedTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonTodayPlayedTime]
  }
  @scala.inline
  implicit class AnonTodayPlayedTimeOps[Self <: AnonTodayPlayedTime] (val x: Self) extends AnyVal {
    @scala.inline
