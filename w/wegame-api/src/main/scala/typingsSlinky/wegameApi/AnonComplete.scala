...
trait AnonComplete extends js.Object {
  ...
  var success: js.UndefOr[js.Function1[/* res */ AnonDataStatusCode, Unit]] = js.native
  /**
    * 开发者服务器地址
    */
...
object AnonComplete {
  @scala.inline
  def apply(filePath: String, name: String, url: String): AnonComplete = {
  ...
  implicit class AnonCompleteOps[Self <: AnonComplete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonDataStatusCode => Unit): Self = {
        val ret = this.duplicate
