...
import typingsSlinky.wordpressEditPost.anon.AjaxUrl
import typingsSlinky.wordpressEditPost.anon.Color
import typingsSlinky.wordpressEditPost.anon.Css
import typingsSlinky.wordpressEditPost.anon.Description
import typingsSlinky.wordpressEditPost.anon.IsLocked
import typingsSlinky.wordpressEditPost.anon.Name
import typingsSlinky.wordpressEditPost.anon.OmitPropsname
import typingsSlinky.wordpressEditPost.anon.PartialEditorSettings
import typingsSlinky.wordpressEditPost.anon.Slug
...
object mod {
  ...
  @js.native
  val PluginBlockSettingsMenuItem: ReactComponentClass[Props] = js.native
  ...
  object PluginDocumentSettingPanel {
    ...
    @js.native
    def apply(
      props: typingsSlinky.wordpressEditPost.pluginDocumentSettingPanelMod.PluginDocumentSettingPanel.Props
  ...
  @js.native
  val PluginMoreMenuItem: ReactComponentClass[typingsSlinky.wordpressEditPost.pluginMoreMenuItemMod.PluginMoreMenuItem.Props] = js.native
  ...
  object PluginPostPublishPanel {
    ...
    @js.native
    def apply(props: typingsSlinky.wordpressEditPost.pluginPostPublishPanelMod.PluginPostPublishPanel.Props): ReactElement = js.native
    @JSImport("@wordpress/edit-post", "PluginPostPublishPanel")
    @js.native
    val ^ : js.Any = js.native
  ...
  object PluginPostStatusInfo {
    ...
    @js.native
    def apply(props: typingsSlinky.wordpressEditPost.pluginPostStatusInfoMod.PluginPostStatusInfo.Props): ReactElement = js.native
    @JSImport("@wordpress/edit-post", "PluginPostStatusInfo")
    @js.native
    val ^ : js.Any = js.native
  ...
  object PluginPrePublishPanel {
    ...
    @js.native
    def apply(props: typingsSlinky.wordpressEditPost.pluginPrePublishPanelMod.PluginPrePublishPanel.Props): ReactElement = js.native
    @JSImport("@wordpress/edit-post", "PluginPrePublishPanel")
    @js.native
    val ^ : js.Any = js.native
  ...
  @js.native
  val PluginSidebar: ReactComponentClass[typingsSlinky.wordpressEditPost.pluginSidebarMod.PluginSidebar.Props] = js.native
  
  @JSImport("@wordpress/edit-post", "PluginSidebarMoreMenuItem")
  @js.native
  val PluginSidebarMoreMenuItem: ReactComponentClass[
    typingsSlinky.wordpressEditPost.pluginSidebarMoreMenuItemMod.PluginSidebarMoreMenuItem.Props
  ] = js.native
  ...
  @js.native
  def reinitializeEditor(postType: String, postId: String, target: Element): Unit = js.native
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  ...
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(postType: String, postId: String, target: Element, settings: PartialEditorSettings): Unit = js.native
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(
    postType: String,
  ...
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(postType: String, postId: Double, target: Element): Unit = js.native
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(
    postType: String,
  ...
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(postType: String, postId: Double, target: Element, settings: PartialEditorSettings): Unit = js.native
  @JSImport("@wordpress/edit-post", "reinitializeEditor")
  @js.native
  def reinitializeEditor(
    postType: String,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.wordpressEditPost.wordpressEditPostStrings.text
    - typingsSlinky.wordpressEditPost.wordpressEditPostStrings.visual
  */
  trait EditorMode extends StObject
  object EditorMode {
    
    @scala.inline
    def text: typingsSlinky.wordpressEditPost.wordpressEditPostStrings.text = "text".asInstanceOf[typingsSlinky.wordpressEditPost.wordpressEditPostStrings.text]
    
    @scala.inline
    def visual: typingsSlinky.wordpressEditPost.wordpressEditPostStrings.visual = "visual".asInstanceOf[typingsSlinky.wordpressEditPost.wordpressEditPostStrings.visual]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.wordpressEditPost.wordpressEditPostStrings.advanced
    - typingsSlinky.wordpressEditPost.wordpressEditPostStrings.normal
    - typingsSlinky.wordpressEditPost.wordpressEditPostStrings.side
  */
  trait MetaboxLocation extends StObject
  object MetaboxLocation {
    
    @scala.inline
    def advanced: typingsSlinky.wordpressEditPost.wordpressEditPostStrings.advanced = "advanced".asInstanceOf[typingsSlinky.wordpressEditPost.wordpressEditPostStrings.advanced]
    
    @scala.inline
    def normal: typingsSlinky.wordpressEditPost.wordpressEditPostStrings.normal = "normal".asInstanceOf[typingsSlinky.wordpressEditPost.wordpressEditPostStrings.normal]
    
    @scala.inline
    def side: typingsSlinky.wordpressEditPost.wordpressEditPostStrings.side = "side".asInstanceOf[typingsSlinky.wordpressEditPost.wordpressEditPostStrings.side]
  }
}
