...
object PluginPostStatusInfoSlot {
  ...
  implicit def make(companion: PluginPostStatusInfoSlot.type): SharedBuilder_OmitPropsname_1548854944 = new SharedBuilder_OmitPropsname_1548854944(js.Array(this.component, js.Dictionary.empty))()
}
