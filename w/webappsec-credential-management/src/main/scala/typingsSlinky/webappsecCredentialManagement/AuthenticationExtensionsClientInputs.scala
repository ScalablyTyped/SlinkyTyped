...
object AuthenticationExtensionsClientInputs {
  ...
  implicit class AuthenticationExtensionsClientInputsOps[Self <: AuthenticationExtensionsClientInputs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthnSelVarargs(value: (js.typedarray.ArrayBufferView | js.typedarray.ArrayBuffer)*): Self = this.set("authnSel", js.Array(value :_*))
    @scala.inline
    def setAuthnSel(value: js.Array[js.typedarray.ArrayBufferView | js.typedarray.ArrayBuffer]): Self = this.set("authnSel", value.asInstanceOf[js.Any])
    @scala.inline
