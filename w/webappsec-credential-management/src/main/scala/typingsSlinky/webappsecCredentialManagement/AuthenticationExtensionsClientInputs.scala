...
object AuthenticationExtensionsClientInputs {
  ...
  implicit class AuthenticationExtensionsClientInputsMutableBuilder[Self <: AuthenticationExtensionsClientInputs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthnSel(value: js.Array[js.typedarray.ArrayBufferView | js.typedarray.ArrayBuffer]): Self = StObject.set(x, "authnSel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAuthnSelUndefined: Self = StObject.set(x, "authnSel", js.undefined)
    
    @scala.inline
    def setAuthnSelVarargs(value: (js.typedarray.ArrayBufferView | js.typedarray.ArrayBuffer)*): Self = StObject.set(x, "authnSel", js.Array(value :_*))
