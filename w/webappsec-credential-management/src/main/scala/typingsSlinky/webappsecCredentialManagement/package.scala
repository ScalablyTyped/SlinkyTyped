...
package object webappsecCredentialManagement {
  ...
  /**
    ...
    */
  type CredentialBodyType = org.scalajs.dom.raw.FormData | typingsSlinky.std.URLSearchParams
  
  /**
    * @see {@link https://www.w3.org/TR/2017/WD-credential-management-1-20170804/#dictdef-federatedcredentialinit}
    */
  type FederatedCredentialInit = typingsSlinky.webappsecCredentialManagement.FederatedCredentialData
  
  /**
    * @see {@link https://www.w3.org/TR/2017/WD-credential-management-1-20170804/#typedefdef-passwordcredentialinit}
    */
  type PasswordCredentialInit = typingsSlinky.webappsecCredentialManagement.PasswordCredentialData | org.scalajs.dom.raw.HTMLFormElement
}
