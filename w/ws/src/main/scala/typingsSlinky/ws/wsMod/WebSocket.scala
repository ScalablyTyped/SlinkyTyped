...
import typingsSlinky.ws.Anon_Binary
import typingsSlinky.ws.Anon_Code
import typingsSlinky.ws.Anon_Data
import typingsSlinky.ws.Anon_Error
import typingsSlinky.ws.Anon_Target
...
trait WebSocket extends EventEmitter {
  ...
  def send(data: js.Any, options: Anon_Binary, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
