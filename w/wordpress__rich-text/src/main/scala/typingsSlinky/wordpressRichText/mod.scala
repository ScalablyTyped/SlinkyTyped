...
import typingsSlinky.wordpressRichText.anon.MultilineTag
...
object mod {
  ...
  @JSImport("@wordpress/rich-text", "replace")
  @js.native
  def replace(value: Value, pattern: js.RegExp, replacement: String): Value = js.native
  @JSImport("@wordpress/rich-text", "replace")
  @js.native
  def replace(
    value: Value,
  ...
  object FormatConfiguration {
    ...
    implicit class FormatConfigurationMutableBuilder[Self <: FormatConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEdit(value: ReactComponentClass[FormatProps]): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
