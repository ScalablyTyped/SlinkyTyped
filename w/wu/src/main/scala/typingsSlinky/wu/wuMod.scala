...
import typingsSlinky.wu.wuMod.Consumer
import typingsSlinky.wu.wuMod.Filter
import typingsSlinky.wu.wuMod.WuIterable
...
object wuMod extends js.Object {
  ...
  trait WuIterable[T] extends IterableIterator[T] {
    ...
    def spreadMap(fn: js.Function1[/* repeated */ js.Any, T], iter: js.Iterable[js.Array[_]]): WuIterable[T] = js.native
  ...
  def apply[T](iterable: js.Iterable[T]): WuIterable[T] = js.native
  ...
  // only static
  def chain[T](iters: js.Iterable[T]*): WuIterable[T] = js.native
  def chunk[T](n: Double, iter: js.Iterable[T]): WuIterable[js.Array[T]] = js.native
  def concatMap[T, U](fn: js.Function1[/* t */ T, js.Iterable[U]], iter: js.Iterable[T]): WuIterable[U] = js.native
  ...
  def cycle[T](iter: js.Iterable[T]): WuIterable[T] = js.native
  def drop[T](n: Double, iter: js.Iterable[T]): WuIterable[T] = js.native
  def dropWhile[T](fn: Filter[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  def entries[T](obj: StringDictionary[T]): WuIterable[js.Tuple2[String, T]] = js.native
  def enumerate[T](iter: js.Iterable[T]): WuIterable[js.Tuple2[T, Double]] = js.native
  def every[T](fn: Filter[T], iter: js.Iterable[T]): Boolean = js.native
  def filter[T](fn: Filter[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  def find[T](fn: Filter[T], iter: js.Iterable[T]): js.UndefOr[T] = js.native
  ...
  def map[T, U](fn: js.Function1[/* t */ T, U], iter: js.Iterable[T]): WuIterable[U] = js.native
  // pluck<T>(attribute:string, iter: Iterable<{[attribute]: T}>): WuIterable<T>;
  ...
  def reject[T](fn: Filter[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  ...
  def some[T](fn: Filter[T], iter: js.Iterable[T]): Boolean = js.native
  ...
  def takeWhile[T](fn: Filter[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  ...
  def zip[T, U](iter2: js.Iterable[T], iter: js.Iterable[U]): WuIterable[js.Tuple2[T, U]] = js.native
  def zipLongest[T, U](iter2: js.Iterable[T], iter: js.Iterable[U]): WuIterable[js.Tuple2[T, U]] = js.native
