...
object mod {
  ...
  object AudioData {
    ...
    implicit class AudioDataMutableBuilder[Self <: AudioData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChannelData(value: js.Array[js.typedarray.Float32Array]): Self = StObject.set(x, "channelData", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChannelDataVarargs(value: js.typedarray.Float32Array*): Self = StObject.set(x, "channelData", js.Array(value :_*))
