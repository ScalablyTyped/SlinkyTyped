...
object RawHTML {
  ...
  @scala.inline
  def apply(children: String with js.UndefOr[ReactElement]): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[childrenstringPickDetaile]))
  }
  ...
  def withProps(p: childrenstringPickDetaile): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
