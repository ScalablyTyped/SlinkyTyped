package typingsSlinky.wordpressElement.anon
...
import typingsSlinky.wordpressElement.wordpressElementStrings.assertive
import typingsSlinky.wordpressElement.wordpressElementStrings.both
import typingsSlinky.wordpressElement.wordpressElementStrings.copy
import typingsSlinky.wordpressElement.wordpressElementStrings.date
import typingsSlinky.wordpressElement.wordpressElementStrings.decimal
import typingsSlinky.wordpressElement.wordpressElementStrings.descending
import typingsSlinky.wordpressElement.wordpressElementStrings.dialog
import typingsSlinky.wordpressElement.wordpressElementStrings.email
import typingsSlinky.wordpressElement.wordpressElementStrings.execute
import typingsSlinky.wordpressElement.wordpressElementStrings.grammar
import typingsSlinky.wordpressElement.wordpressElementStrings.grid
import typingsSlinky.wordpressElement.wordpressElementStrings.horizontal
import typingsSlinky.wordpressElement.wordpressElementStrings.inherit
import typingsSlinky.wordpressElement.wordpressElementStrings.link
import typingsSlinky.wordpressElement.wordpressElementStrings.list
import typingsSlinky.wordpressElement.wordpressElementStrings.listbox
import typingsSlinky.wordpressElement.wordpressElementStrings.location
import typingsSlinky.wordpressElement.wordpressElementStrings.menu
import typingsSlinky.wordpressElement.wordpressElementStrings.mixed
import typingsSlinky.wordpressElement.wordpressElementStrings.move
import typingsSlinky.wordpressElement.wordpressElementStrings.no
import typingsSlinky.wordpressElement.wordpressElementStrings.none
import typingsSlinky.wordpressElement.wordpressElementStrings.numeric
import typingsSlinky.wordpressElement.wordpressElementStrings.off
import typingsSlinky.wordpressElement.wordpressElementStrings.on
import typingsSlinky.wordpressElement.wordpressElementStrings.other
import typingsSlinky.wordpressElement.wordpressElementStrings.page
import typingsSlinky.wordpressElement.wordpressElementStrings.polite
import typingsSlinky.wordpressElement.wordpressElementStrings.popup
import typingsSlinky.wordpressElement.wordpressElementStrings.removals
import typingsSlinky.wordpressElement.wordpressElementStrings.search
import typingsSlinky.wordpressElement.wordpressElementStrings.spelling
import typingsSlinky.wordpressElement.wordpressElementStrings.step
import typingsSlinky.wordpressElement.wordpressElementStrings.tel
import typingsSlinky.wordpressElement.wordpressElementStrings.text
import typingsSlinky.wordpressElement.wordpressElementStrings.time
import typingsSlinky.wordpressElement.wordpressElementStrings.tree
import typingsSlinky.wordpressElement.wordpressElementStrings.url
import typingsSlinky.wordpressElement.wordpressElementStrings.vertical
import typingsSlinky.wordpressElement.wordpressElementStrings.yes
...
@js.native
trait childrenstringPickDetaile extends js.Object {
  ...
  var children: String with js.UndefOr[ReactElement] = js.native
...
object childrenstringPickDetaile {
  
  @scala.inline
  def apply(children: String with js.UndefOr[ReactElement]): childrenstringPickDetaile = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.asInstanceOf[childrenstringPickDetaile]
  }
  
  @scala.inline
  implicit class childrenstringPickDetaileOps[Self <: childrenstringPickDetaile] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: String with js.UndefOr[ReactElement]): Self = this.set("children", value.asInstanceOf[js.Any])
