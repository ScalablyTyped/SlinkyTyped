package typingsSlinky.watchpack
...
object mod {
  ...
  object WatcherOptions {
    ...
    implicit class WatcherOptionsMutableBuilder[Self <: WatcherOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIgnored(value: js.Array[String] | String | js.RegExp | (js.Function1[/* path */ String, Boolean])): Self = StObject.set(x, "ignored", value.asInstanceOf[js.Any])
