...
object GenerateSWConfig {
  ...
  implicit class GenerateSWConfigOps[Self <: GenerateSWConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNavigateFallbackAllowlistVarargs(value: js.RegExp*): Self = this.set("navigateFallbackAllowlist", js.Array(value :_*))
    
    @scala.inline
    def setNavigateFallbackAllowlist(value: js.Array[js.RegExp]): Self = this.set("navigateFallbackAllowlist", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNavigateFallbackAllowlist: Self = this.set("navigateFallbackAllowlist", js.undefined)
    
    @scala.inline
    def setNavigateFallbackDenylistVarargs(value: js.RegExp*): Self = this.set("navigateFallbackDenylist", js.Array(value :_*))
    
    @scala.inline
    def setNavigateFallbackDenylist(value: js.Array[js.RegExp]): Self = this.set("navigateFallbackDenylist", value.asInstanceOf[js.Any])
