...
object generateSwMod {
  ...
  object GenerateSWConfig {
    ...
    implicit class GenerateSWConfigMutableBuilder[Self <: GenerateSWConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNavigateFallbackAllowlist(value: js.Array[js.RegExp]): Self = StObject.set(x, "navigateFallbackAllowlist", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavigateFallbackAllowlistUndefined: Self = StObject.set(x, "navigateFallbackAllowlist", js.undefined)
      
      @scala.inline
      def setNavigateFallbackAllowlistVarargs(value: js.RegExp*): Self = StObject.set(x, "navigateFallbackAllowlist", js.Array(value :_*))
      
      @scala.inline
      def setNavigateFallbackDenylist(value: js.Array[js.RegExp]): Self = StObject.set(x, "navigateFallbackDenylist", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavigateFallbackDenylistUndefined: Self = StObject.set(x, "navigateFallbackDenylist", js.undefined)
      
      @scala.inline
      def setNavigateFallbackDenylistVarargs(value: js.RegExp*): Self = StObject.set(x, "navigateFallbackDenylist", js.Array(value :_*))
