package typingsSlinky.webpackMergeAndIncludeGlobally
...
package object mod {
  ...
  /**
    ...
    */
  type MergeIntoFile = typingsSlinky.webpack.mod.Plugin
  /**
    ...
    */
  type SourceDestinationMaps = js.Array[typingsSlinky.webpackMergeAndIncludeGlobally.anon.Dest]
}
