...
import typingsSlinky.webdriverManager.anon.TypeofBinary
import typingsSlinky.webdriverManager.binaryMod.BinaryMap
...
object filesMod {
  ...
  class DownloadedBinary protected ()
    extends typingsSlinky.webdriverManager.downloadedBinaryMod.DownloadedBinary {
  ...
  @js.native
  class Downloader ()
    extends typingsSlinky.webdriverManager.downloaderMod.Downloader
  /* static members */
  object Downloader {
  ...
  @js.native
  class FileManager ()
    extends typingsSlinky.webdriverManager.fileManagerMod.FileManager
  /* static members */
  object FileManager {
    ...
    @js.native
    def downloadedBinaries(outputDir: String): BinaryMap[typingsSlinky.webdriverManager.downloadedBinaryMod.DownloadedBinary] = js.native
    ...
    @js.native
    def downloadedVersions_[T /* <: Binary */](binary: T, osType: String, arch: String, existingFiles: js.Array[String]): typingsSlinky.webdriverManager.downloadedBinaryMod.DownloadedBinary = js.native
