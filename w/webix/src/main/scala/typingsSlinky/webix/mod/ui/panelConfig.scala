...
object panelConfig {
  ...
  @scala.inline
  implicit class panelConfigMutableBuilder[Self <: panelConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIcon(value: String | Boolean): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
