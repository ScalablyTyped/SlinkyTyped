...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.webix.webixStrings.onSearchIconClick
...
*/
trait searchEventName extends StObject
object searchEventName {
  ...
  @scala.inline
  def onSearchIconClick: typingsSlinky.webix.webixStrings.onSearchIconClick = "onSearchIconClick".asInstanceOf[typingsSlinky.webix.webixStrings.onSearchIconClick]
