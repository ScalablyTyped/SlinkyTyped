...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.webix.webixStrings.onAfterRangeChange
...
object rangechartEventName {
  ...
  @scala.inline
  def onAfterRangeChange: typingsSlinky.webix.webixStrings.onAfterRangeChange = "onAfterRangeChange".asInstanceOf[typingsSlinky.webix.webixStrings.onAfterRangeChange]
