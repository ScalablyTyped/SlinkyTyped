...
class treetable ()
  ...
  def copy(sid: String, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview): Double = js.native
  def copy(sid: String, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview, details: js.Any): Double = js.native
  def copy(sid: Double, tindex: Double): Double = js.native
  def copy(sid: Double, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview): Double = js.native
  def copy(sid: Double, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview, details: js.Any): Double = js.native
  ...
  def move(sid: String, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview): String | Double = js.native
  def move(sid: String, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview, details: js.Any): String | Double = js.native
  def move(sid: Double, tindex: Double): String | Double = js.native
  def move(sid: Double, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview): String | Double = js.native
  def move(sid: Double, tindex: Double, tobj: typingsSlinky.webix.webix.ui.baseview, details: js.Any): String | Double = js.native
