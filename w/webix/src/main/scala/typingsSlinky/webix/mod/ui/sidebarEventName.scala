...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.webix.webixStrings.onPartialRender
...
*/
trait sidebarEventName extends StObject
object sidebarEventName {
  ...
  @scala.inline
  def onPartialRender: typingsSlinky.webix.webixStrings.onPartialRender = "onPartialRender".asInstanceOf[typingsSlinky.webix.webixStrings.onPartialRender]
