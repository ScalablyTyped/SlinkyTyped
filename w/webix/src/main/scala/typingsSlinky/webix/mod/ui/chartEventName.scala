...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.webix.webixStrings.onLegendClick
...
object chartEventName {
  ...
  @scala.inline
  def onLegendClick: typingsSlinky.webix.webixStrings.onLegendClick = "onLegendClick".asInstanceOf[typingsSlinky.webix.webixStrings.onLegendClick]
