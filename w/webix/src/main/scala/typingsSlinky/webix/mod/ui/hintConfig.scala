...
trait hintConfig extends StObject {
  ...
  var nextButton: js.UndefOr[Boolean | String] = js.native
  
  var on: js.UndefOr[EventHash] = js.native
  
  var prevButton: js.UndefOr[Boolean | String] = js.native
  
  var stepTimeout: js.UndefOr[Double] = js.native
  
  var steps: js.UndefOr[js.Array[_]] = js.native
...
object hintConfig {
  ...
  @scala.inline
  def apply(): hintConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[hintConfig]
  }
  
  @scala.inline
  implicit class hintConfigMutableBuilder[Self <: hintConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextButton(value: Boolean | String): Self = StObject.set(x, "nextButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevButton(value: Boolean | String): Self = StObject.set(x, "prevButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSteps(value: js.Array[_]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStepsUndefined: Self = StObject.set(x, "steps", js.undefined)
    
    @scala.inline
    def setStepsVarargs(value: js.Any*): Self = StObject.set(x, "steps", js.Array(value :_*))
