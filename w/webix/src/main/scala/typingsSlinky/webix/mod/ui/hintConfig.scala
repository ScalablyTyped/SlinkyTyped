...
object hintConfig {
  ...
  @scala.inline
  implicit class hintConfigOps[Self <: hintConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextButton(value: Boolean | String): Self = this.set("nextButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrevButton(value: Boolean | String): Self = this.set("prevButton", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStepsVarargs(value: js.Any*): Self = this.set("steps", js.Array(value :_*))
    
    @scala.inline
    def setSteps(value: js.Array[_]): Self = this.set("steps", value.asInstanceOf[js.Any])
