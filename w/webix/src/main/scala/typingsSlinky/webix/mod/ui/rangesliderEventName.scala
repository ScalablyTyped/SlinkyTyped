...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.webix.webixStrings.onSliderDrag
...
object rangesliderEventName {
  ...
  @scala.inline
  def onSliderDrag: typingsSlinky.webix.webixStrings.onSliderDrag = "onSliderDrag".asInstanceOf[typingsSlinky.webix.webixStrings.onSliderDrag]
  @scala.inline
