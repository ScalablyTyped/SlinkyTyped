...
trait WebixFilter extends js.Object {
  ...
  def refresh(master: typingsSlinky.webix.webix.ui.baseview, node: HTMLElement, value: js.Any): Unit
  def render(master: typingsSlinky.webix.webix.ui.baseview, config: StringDictionary[js.Any]): String
