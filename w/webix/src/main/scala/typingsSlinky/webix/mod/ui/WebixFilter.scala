...
object WebixFilter {
  ...
  implicit class WebixFilterOps[Self <: WebixFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRefresh(value: (typingsSlinky.webix.webix.ui.baseview, HTMLElement, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("refresh")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRender(value: (typingsSlinky.webix.webix.ui.baseview, StringDictionary[js.Any]) => String): Self = {
        val ret = this.duplicate
