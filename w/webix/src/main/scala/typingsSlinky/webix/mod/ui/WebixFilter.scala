...
trait WebixFilter extends StObject {
  ...
  def refresh(master: typingsSlinky.webix.webix.ui.baseview, node: HTMLElement, value: js.Any): Unit = js.native
  
  def render(master: typingsSlinky.webix.webix.ui.baseview, config: StringDictionary[js.Any]): String = js.native
...
object WebixFilter {
  ...
  def apply(
    ...
    refresh: (typingsSlinky.webix.webix.ui.baseview, HTMLElement, js.Any) => Unit,
    render: (typingsSlinky.webix.webix.ui.baseview, StringDictionary[js.Any]) => String,
  ...
  implicit class WebixFilterMutableBuilder[Self <: WebixFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefresh(value: (typingsSlinky.webix.webix.ui.baseview, HTMLElement, js.Any) => Unit): Self = StObject.set(x, "refresh", js.Any.fromFunction3(value))
    
    @scala.inline
    def setRender(value: (typingsSlinky.webix.webix.ui.baseview, StringDictionary[js.Any]) => String): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
