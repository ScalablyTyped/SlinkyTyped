...
object WebixFilter {
  ...
  implicit class WebixFilterOps[Self <: WebixFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefresh(value: (typingsSlinky.webix.webix.ui.baseview, HTMLElement, js.Any) => Unit): Self = this.set("refresh", js.Any.fromFunction3(value))
    @scala.inline
    def setRender(value: (typingsSlinky.webix.webix.ui.baseview, StringDictionary[js.Any]) => String): Self = this.set("render", js.Any.fromFunction2(value))
    @scala.inline
