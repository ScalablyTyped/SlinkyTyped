...
object dataviewConfig {
  ...
  implicit class dataviewConfigOps[Self <: dataviewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSizeToContent(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sizeToContent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSizeToContent: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sizeToContent")(js.undefined)
        ret
    }
    @scala.inline
