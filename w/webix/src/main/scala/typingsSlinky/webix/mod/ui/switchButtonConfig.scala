...
object switchButtonConfig {
  ...
  @scala.inline
  implicit class switchButtonConfigMutableBuilder[Self <: switchButtonConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckValue(value: String): Self = StObject.set(x, "checkValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomCheckbox(value: Boolean): Self = StObject.set(x, "customCheckbox", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomCheckboxUndefined: Self = StObject.set(x, "customCheckbox", js.undefined)
    ...
    @scala.inline
    def setUncheckValue(value: String): Self = StObject.set(x, "uncheckValue", value.asInstanceOf[js.Any])
