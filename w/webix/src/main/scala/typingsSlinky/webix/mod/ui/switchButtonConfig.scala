...
object switchButtonConfig {
  ...
  implicit class switchButtonConfigOps[Self <: switchButtonConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckValue(value: String): Self = this.set("checkValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCheckValue: Self = this.set("checkValue", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setCustomCheckbox(value: Boolean): Self = this.set("customCheckbox", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomCheckbox: Self = this.set("customCheckbox", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setUncheckValue(value: String): Self = this.set("uncheckValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUncheckValue: Self = this.set("uncheckValue", js.undefined)
    @scala.inline
