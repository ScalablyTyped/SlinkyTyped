...
class richselect ()
  ...
  @JSName("$skin")
  var $skin_Original_richselect: WebixCallback = js.native
  @JSName("config")
  ...
  def attachEvent(`type`: richselectEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: richselectEventName, functor: WebixCallback, id: String): String | Double = js.native
