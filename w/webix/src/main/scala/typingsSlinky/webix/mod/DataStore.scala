...
trait DataStore extends js.Object {
  ...
  def getIndexRange(from: String, to: String): js.Array[_] = js.native
  def getIndexRange(from: String, to: Double): js.Array[_] = js.native
  def getIndexRange(from: Double, to: String): js.Array[_] = js.native
  ...
  def getRange(from: String, to: String): js.Array[_] = js.native
  def getRange(from: String, to: Double): js.Array[_] = js.native
