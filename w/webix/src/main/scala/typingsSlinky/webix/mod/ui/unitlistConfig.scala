...
object unitlistConfig {
  ...
  implicit class unitlistConfigOps[Self <: unitlistConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUniteBy(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("uniteBy")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutUniteBy: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("uniteBy")(js.undefined)
        ret
    }
    @scala.inline
