...
object datafilter extends js.Object {
  ...
  class textFilter () extends WebixFilter {
    ...
    /* CompleteClass */
    override def refresh(master: typingsSlinky.webix.webix.ui.baseview, node: HTMLElement, value: js.Any): Unit = js.native
    /* CompleteClass */
    override def render(master: typingsSlinky.webix.webix.ui.baseview, config: StringDictionary[js.Any]): String = js.native
    /* CompleteClass */
