...
class daterangepicker ()
  ...
  def attachEvent(`type`: daterangepickerEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: daterangepickerEventName, functor: WebixCallback, id: String): String | Double = js.native
