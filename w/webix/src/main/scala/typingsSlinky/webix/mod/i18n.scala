...
trait i18n extends StObject {
  ...
  def fullDateFormatStr(date: typingsSlinky.webix.mod.Date): String = js.native
...
object i18n {
  ...
  @JSImport("webix", "i18n")
  @js.native
  val ^ : typingsSlinky.webix.webix.i18n = js.native
  ...
  implicit class i18nMutableBuilder[Self <: i18n] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullDateFormatStr(value: typingsSlinky.webix.mod.Date => String): Self = StObject.set(x, "fullDateFormatStr", js.Any.fromFunction1(value))
