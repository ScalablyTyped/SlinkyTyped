...
import typingsSlinky.webix.webixMod.DataCollection
...
class kanban ()
  ...
  def getComments(): typingsSlinky.webix.webix.ui.baseview = js.native
  def getEditor(): typingsSlinky.webix.webix.ui.baseview = js.native
  ...
  def getMenu(): typingsSlinky.webix.webix.ui.baseview = js.native
  ...
  def getUserList(): typingsSlinky.webix.webix.ui.baseview = js.native
