...
object ajax extends js.Object {
  def apply(): typingsSlinky.webix.webix.Ajax | js.Promise[_] = js.native
  def apply(url: String): typingsSlinky.webix.webix.Ajax | js.Promise[_] = js.native
  def apply(url: String, params: js.Any): typingsSlinky.webix.webix.Ajax | js.Promise[_] = js.native
}
