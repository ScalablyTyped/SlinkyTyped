...
class pivot ()
  ...
  def addOperation(name: String, operation: WebixCallback, options: js.Any): Unit = js.native
  def addTotalOperation(name: String, operation: WebixCallback, options: js.Any): Unit = js.native
