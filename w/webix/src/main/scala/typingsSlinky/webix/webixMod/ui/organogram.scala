...
class organogram ()
  ...
  def attachEvent(`type`: organogramEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: organogramEventName, functor: WebixCallback, id: String): String | Double = js.native
