...
trait html extends js.Object {
  ...
  def pos(ev: org.scalajs.dom.raw.Event): js.Any = js.native
  def posRelative(ev: org.scalajs.dom.raw.Event): js.Any = js.native
  def preventEvent(ev: org.scalajs.dom.raw.Event): Boolean = js.native
  ...
  def stopEvent(ev: org.scalajs.dom.raw.Event): Boolean = js.native
...
@js.native
object html
  extends TopLevel[typingsSlinky.webix.webix.html]
