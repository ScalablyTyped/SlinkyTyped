...
trait radioConfig extends js.Object {
  ...
  var customRadio: js.UndefOr[Boolean] = js.undefined
...
object radioConfig {
  ...
  def apply(
    ...
    css: js.Any = null,
    customRadio: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(customRadio)) __obj.updateDynamic("customRadio")(customRadio.asInstanceOf[js.Any])
