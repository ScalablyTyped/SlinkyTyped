...
object multitextConfig {
  ...
  @scala.inline
  implicit class multitextConfigOps[Self <: multitextConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSubConfig(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subConfig")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSubConfig: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subConfig")(js.undefined)
        ret
    }
    @scala.inline
