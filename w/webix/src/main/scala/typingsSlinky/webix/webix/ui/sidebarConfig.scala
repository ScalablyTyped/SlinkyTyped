...
object sidebarConfig {
  ...
  implicit class sidebarConfigOps[Self <: sidebarConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveTitle(value: Boolean): Self = this.set("activeTitle", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteActiveTitle: Self = this.set("activeTitle", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setCollapsedWidth(value: Double): Self = this.set("collapsedWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMultipleOpen(value: Boolean): Self = this.set("multipleOpen", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMultipleOpen: Self = this.set("multipleOpen", js.undefined)
    @scala.inline
