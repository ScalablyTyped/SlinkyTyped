...
object radioConfig {
  ...
  implicit class radioConfigOps[Self <: radioConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCustomRadio(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("customRadio")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCustomRadio: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("customRadio")(js.undefined)
        ret
    }
    @scala.inline
