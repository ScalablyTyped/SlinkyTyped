...
object multicomboConfig {
  ...
  implicit class multicomboConfigOps[Self <: multicomboConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNewValues(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTagMode(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTagTemplate(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tagTemplate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
