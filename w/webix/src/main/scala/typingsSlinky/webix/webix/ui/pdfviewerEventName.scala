...
object pdfviewerEventName {
  ...
  @scala.inline
  def onDocumentReady: typingsSlinky.webix.webixStrings.onDocumentReady = this.cast("onDocumentReady")
  @scala.inline
  ...
  @scala.inline
  def onPageRender: typingsSlinky.webix.webixStrings.onPageRender = this.cast("onPageRender")
  @scala.inline
  def onScaleChange: typingsSlinky.webix.webixStrings.onScaleChange = this.cast("onScaleChange")
  @scala.inline
