...
trait htmlformConfig extends js.Object {
  ...
  var content: js.UndefOr[String | Double | HTMLElement] = js.native
...
object htmlformConfig {
  
  @scala.inline
  def apply(): htmlformConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[htmlformConfig]
  }
  
  @scala.inline
  implicit class htmlformConfigOps[Self <: htmlformConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentHTMLElement(value: HTMLElement): Self = this.set("content", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContent(value: String | Double | HTMLElement): Self = this.set("content", value.asInstanceOf[js.Any])
