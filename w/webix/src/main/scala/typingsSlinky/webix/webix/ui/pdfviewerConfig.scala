...
object pdfviewerConfig {
  ...
  implicit class pdfviewerConfigOps[Self <: pdfviewerConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDownloadName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("downloadName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDownloadName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("downloadName")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withScale(value: String | Double): Self = {
        val ret = this.duplicate
