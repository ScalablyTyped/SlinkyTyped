...
object multiviewConfig {
  ...
  @scala.inline
  implicit class multiviewConfigMutableBuilder[Self <: multiviewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFitBiggest(value: Boolean): Self = StObject.set(x, "fitBiggest", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFitBiggestUndefined: Self = StObject.set(x, "fitBiggest", js.undefined)
    ...
    @scala.inline
    def setKeepViews(value: Boolean): Self = StObject.set(x, "keepViews", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setKeepViewsUndefined: Self = StObject.set(x, "keepViews", js.undefined)
