...
object multiviewConfig {
  ...
  implicit class multiviewConfigOps[Self <: multiviewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFitBiggest(value: Boolean): Self = this.set("fitBiggest", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFitBiggest: Self = this.set("fitBiggest", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setKeepViews(value: Boolean): Self = this.set("keepViews", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteKeepViews: Self = this.set("keepViews", js.undefined)
    @scala.inline
