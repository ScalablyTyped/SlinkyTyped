...
trait multiviewConfig extends js.Object {
  ...
  var fitBiggest: js.UndefOr[Boolean] = js.native
  var gravity: js.UndefOr[Double] = js.native
  var height: js.UndefOr[Double] = js.native
  var hidden: js.UndefOr[Boolean] = js.native
  var id: js.UndefOr[String | Double] = js.native
  var keepViews: js.UndefOr[Boolean] = js.native
...
object multiviewConfig {
  @scala.inline
  def apply(): multiviewConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[multiviewConfig]
  }
  @scala.inline
  implicit class multiviewConfigOps[Self <: multiviewConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withFitBiggest(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fitBiggest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFitBiggest: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fitBiggest")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withKeepViews(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("keepViews")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutKeepViews: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("keepViews")(js.undefined)
        ret
    }
    @scala.inline
