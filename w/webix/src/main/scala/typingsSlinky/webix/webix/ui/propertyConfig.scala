...
object propertyConfig {
  ...
  @scala.inline
  implicit class propertyConfigMutableBuilder[Self <: propertyConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNameWidth(value: Double): Self = StObject.set(x, "nameWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNameWidthUndefined: Self = StObject.set(x, "nameWidth", js.undefined)
