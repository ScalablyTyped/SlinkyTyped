...
object treetableConfig {
  ...
  @scala.inline
  implicit class treetableConfigMutableBuilder[Self <: treetableConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubRowHeight(value: String | Double): Self = StObject.set(x, "subRowHeight", value.asInstanceOf[js.Any])
