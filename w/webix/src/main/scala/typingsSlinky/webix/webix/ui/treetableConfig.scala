...
trait treetableConfig extends js.Object {
  ...
  var subRowHeight: js.UndefOr[String | Double] = js.native
...
object treetableConfig {
  @scala.inline
  def apply(): treetableConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[treetableConfig]
  }
  @scala.inline
  implicit class treetableConfigOps[Self <: treetableConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSubRowHeight(value: String | Double): Self = {
        val ret = this.duplicate
