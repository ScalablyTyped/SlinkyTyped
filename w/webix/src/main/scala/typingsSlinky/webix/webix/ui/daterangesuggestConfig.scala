...
@js.native
trait daterangesuggestConfig extends StObject {
...
object daterangesuggestConfig {
  ...
  @scala.inline
  implicit class daterangesuggestConfigMutableBuilder[Self <: daterangesuggestConfig] (val x: Self) extends AnyVal {
