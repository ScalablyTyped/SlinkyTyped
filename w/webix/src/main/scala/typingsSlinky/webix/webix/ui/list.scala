...
trait list extends baseview {
  ...
  def attachEvent(`type`: listEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: listEventName, functor: WebixCallback, id: String): String | Double = js.native
