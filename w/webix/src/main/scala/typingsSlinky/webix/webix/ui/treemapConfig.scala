...
object treemapConfig {
  ...
  implicit class treemapConfigOps[Self <: treemapConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveItem(value: Boolean): Self = {
    ...
    @scala.inline
    def withSubRender(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subRender")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSubRender: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("subRender")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withValueFunction1(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("value")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withValue(value: String | WebixCallback): Self = {
        val ret = this.duplicate
