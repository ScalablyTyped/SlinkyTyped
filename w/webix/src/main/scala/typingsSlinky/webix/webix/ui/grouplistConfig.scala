...
@js.native
trait grouplistConfig extends StObject {
...
object grouplistConfig {
  ...
  @scala.inline
  implicit class grouplistConfigMutableBuilder[Self <: grouplistConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplateBack(value: String | WebixTemplate): Self = StObject.set(x, "templateBack", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTemplateBackFunction1(value: /* repeated */ js.Any => String): Self = StObject.set(x, "templateBack", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTemplateBackUndefined: Self = StObject.set(x, "templateBack", js.undefined)
    ...
    @scala.inline
    def setTemplateGroup(value: String | WebixCallback): Self = StObject.set(x, "templateGroup", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTemplateGroupFunction1(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "templateGroup", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTemplateGroupUndefined: Self = StObject.set(x, "templateGroup", js.undefined)
    
    @scala.inline
    def setTemplateItem(value: String | WebixCallback): Self = StObject.set(x, "templateItem", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTemplateItemFunction1(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "templateItem", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTemplateItemUndefined: Self = StObject.set(x, "templateItem", js.undefined)
