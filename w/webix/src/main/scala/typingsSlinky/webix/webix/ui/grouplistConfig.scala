...
object grouplistConfig {
  ...
  implicit class grouplistConfigOps[Self <: grouplistConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTemplateBackFunction1(value: /* repeated */ js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateBack")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTemplateBack(value: String | WebixTemplate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateBack")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTemplateBack: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateBack")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTemplateGroupFunction1(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateGroup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTemplateGroup(value: String | WebixCallback): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateGroup")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTemplateGroup: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateGroup")(js.undefined)
        ret
    }
    @scala.inline
    def withTemplateItemFunction1(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTemplateItem(value: String | WebixCallback): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateItem")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTemplateItem: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("templateItem")(js.undefined)
        ret
    }
    @scala.inline
