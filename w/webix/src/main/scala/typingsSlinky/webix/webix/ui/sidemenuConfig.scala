...
@js.native
trait sidemenuConfig extends StObject {
...
object sidemenuConfig {
  ...
  @scala.inline
  implicit class sidemenuConfigMutableBuilder[Self <: sidemenuConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setState(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "state", js.Any.fromFunction1(value))
