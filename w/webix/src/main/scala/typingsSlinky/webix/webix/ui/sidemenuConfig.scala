...
trait sidemenuConfig extends js.Object {
  ...
  var state: js.UndefOr[WebixCallback] = js.native
...
object sidemenuConfig {
  @scala.inline
  def apply(): sidemenuConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[sidemenuConfig]
  }
  @scala.inline
  implicit class sidemenuConfigOps[Self <: sidemenuConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withState(value: /* repeated */ js.Any => js.Any): Self = {
        val ret = this.duplicate
