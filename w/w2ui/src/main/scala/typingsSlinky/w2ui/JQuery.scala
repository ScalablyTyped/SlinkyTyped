...
object JQuery {
  ...
  implicit class JQueryOps[Self <: JQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withW2form(value: js.Object => W2Form): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2form")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2grid(value: js.Object => W2Grid): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2grid")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2layout(value: js.Object => W2Layout): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2layout")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2popup(value: js.Object => W2Popup): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2popup")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2sidebar(value: js.Object => W2Sidebar): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2sidebar")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2tabs(value: js.Object => W2Tabs): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2tabs")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withW2toolbar(value: js.Object => W2Toolbar): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("w2toolbar")(js.Any.fromFunction1(value))
        ret
    }
  }
