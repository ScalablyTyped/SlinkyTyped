...
object UploadTask {
  ...
  implicit class UploadTaskOps[Self <: UploadTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOffProgressUpdate(value: js.Function1[/* res */ OnProgressCallbackOptions, js.Object] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnProgressUpdate(value: js.Function1[/* res */ OnProgressCallbackOptions, js.Object] => Unit): Self = {
        val ret = this.duplicate
