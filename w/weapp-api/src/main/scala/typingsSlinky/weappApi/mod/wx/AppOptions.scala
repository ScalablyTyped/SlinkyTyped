...
object AppOptions {
  ...
  implicit class AppOptionsOps[Self <: AppOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnLaunch(value: /* options */ onLaunchOptions => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPageNotFound(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onPageNotFound")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withoutOnPageNotFound: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onPageNotFound")(js.undefined)
        ret
    }
    @scala.inline
    def withOnShow(value: /* options */ onShowOptions => Unit): Self = {
        val ret = this.duplicate
