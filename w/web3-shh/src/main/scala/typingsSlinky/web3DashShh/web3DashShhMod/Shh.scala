...
import typingsSlinky.web3DashShh.web3DashShhStrings.messages
...
class Shh () extends js.Object {
  ...
  var BatchRequest: Instantiable0[typingsSlinky.web3DashCore.web3DashCoreMod.BatchRequest] = js.native
