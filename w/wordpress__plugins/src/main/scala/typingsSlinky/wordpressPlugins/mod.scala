package typingsSlinky.wordpressPlugins
...
object mod {
  ...
  @js.native
  val PluginArea: ReactComponentClass[js.Object] = js.native
  ...
  @js.native
  def withPluginContext[CP, OP](mapContextToProps: js.Function2[/* context */ PluginContext, /* props */ OP, CP]): js.Function1[/* Component */ ReactComponentClass[CP with OP], ReactComponentClass[OP]] = js.native
  ...
  object PluginContext {
    ...
    implicit class PluginContextMutableBuilder[Self <: PluginContext] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcon(value: Icon | ReactComponentClass[js.Object]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
