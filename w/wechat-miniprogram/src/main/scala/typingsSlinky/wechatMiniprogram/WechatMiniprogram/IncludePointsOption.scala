...
trait IncludePointsOption extends js.Object {
  ...
  /** 要显示在可视区域内的坐标点列表 */
  var points: js.Array[MapPostion] = js.native
  /** 接口调用成功的回调函数 */
...
object IncludePointsOption {
  ...
  implicit class IncludePointsOptionOps[Self <: IncludePointsOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPointsVarargs(value: MapPostion*): Self = this.set("points", js.Array(value :_*))
    @scala.inline
    def setPoints(value: js.Array[MapPostion]): Self = this.set("points", value.asInstanceOf[js.Any])
    @scala.inline
