...
@js.native
trait OnVoIPChatMembersChangedCallbackResult extends js.Object {
  /** 错误码 */
...
object OnVoIPChatMembersChangedCallbackResult {
  ...
  @scala.inline
  implicit class OnVoIPChatMembersChangedCallbackResultOps[Self <: OnVoIPChatMembersChangedCallbackResult] (val x: Self) extends AnyVal {
    @scala.inline
