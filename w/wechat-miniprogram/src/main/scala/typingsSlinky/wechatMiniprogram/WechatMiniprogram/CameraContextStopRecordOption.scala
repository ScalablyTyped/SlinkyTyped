...
@js.native
trait CameraContextStopRecordOption extends js.Object {
...
object CameraContextStopRecordOption {
  ...
  @scala.inline
  implicit class CameraContextStopRecordOptionOps[Self <: CameraContextStopRecordOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ StopRecordSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
