...
@js.native
trait GetRotateOption extends js.Object {
...
object GetRotateOption {
  ...
  @scala.inline
  implicit class GetRotateOptionOps[Self <: GetRotateOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetRotateSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
