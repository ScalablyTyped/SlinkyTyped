...
/* Inlined wechat-miniprogram.WechatMiniprogram.Behavior.Options<wechat-miniprogram.WechatMiniprogram.IAnyObject, wechat-miniprogram.WechatMiniprogram.IAnyObject, wechat-miniprogram.WechatMiniprogram.IAnyObject> */
@js.native
trait TrivialOption extends js.Object {
  ...
  var methods: js.UndefOr[IAnyObject] = js.native
...
object TrivialOption {
  ...
  implicit class TrivialOptionOps[Self <: TrivialOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMethods(value: IAnyObject): Self = this.set("methods", value.asInstanceOf[js.Any])
