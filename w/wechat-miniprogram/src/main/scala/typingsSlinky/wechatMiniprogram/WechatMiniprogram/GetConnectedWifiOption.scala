...
object GetConnectedWifiOption {
  ...
  @scala.inline
  implicit class GetConnectedWifiOptionOps[Self <: GetConnectedWifiOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetConnectedWifiSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
