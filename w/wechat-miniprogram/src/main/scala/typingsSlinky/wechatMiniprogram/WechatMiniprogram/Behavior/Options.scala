...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.DataOption */ TData, /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.PropertyOption */ TProperty, /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.MethodOption */ TMethod](): Options[TData, TProperty, TMethod] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[TData, TProperty, TMethod]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _, _], /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.DataOption */ TData, /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.PropertyOption */ TProperty, /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Behavior.MethodOption */ TMethod] (val x: Self with (Options[TData, TProperty, TMethod])) extends AnyVal {
    @scala.inline
