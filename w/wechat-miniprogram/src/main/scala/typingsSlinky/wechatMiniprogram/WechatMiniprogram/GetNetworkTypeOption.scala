...
@js.native
trait GetNetworkTypeOption extends js.Object {
...
object GetNetworkTypeOption {
  ...
  @scala.inline
  implicit class GetNetworkTypeOptionOps[Self <: GetNetworkTypeOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetNetworkTypeSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
