...
@js.native
trait MakeBluetoothPairOption extends js.Object {
  ...
  /** pin 码 */
  var pin: js.UndefOr[js.typedarray.ArrayBuffer] = js.native
...
object MakeBluetoothPairOption {
  ...
  @scala.inline
  implicit class MakeBluetoothPairOptionOps[Self <: MakeBluetoothPairOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPin(value: js.typedarray.ArrayBuffer): Self = this.set("pin", value.asInstanceOf[js.Any])
