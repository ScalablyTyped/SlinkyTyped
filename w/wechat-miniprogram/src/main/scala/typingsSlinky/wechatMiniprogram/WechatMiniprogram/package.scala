...
package object WechatMiniprogram {
  ...
  type FileSystemManagerSaveFileSuccessCallback = js.Function1[
    /* result */ typingsSlinky.wechatMiniprogram.WechatMiniprogram.FileSystemManagerSaveFileSuccessCallbackResult, 
    scala.Unit
  ]
  /** 接口调用结束的回调函数（调用成功、失败都会执行） */
  ...
  type GetShareInfoSuccessCallback = js.Function1[
    /* result */ typingsSlinky.wechatMiniprogram.WechatMiniprogram.GetShareInfoSuccessCallbackResult, 
    scala.Unit
  ]
  /** 接口调用结束的回调函数（调用成功、失败都会执行） */
  ...
  type IsConnectedSuccessCallback = js.Function1[
    /* result */ typingsSlinky.wechatMiniprogram.WechatMiniprogram.IsConnectedSuccessCallbackResult, 
    scala.Unit
  ]
  /** 接口调用结束的回调函数（调用成功、失败都会执行） */
  ...
  type OnOnVoIPVideoMembersChangedCallback = js.Function1[
    /* result */ typingsSlinky.wechatMiniprogram.WechatMiniprogram.OnOnVoIPVideoMembersChangedCallbackResult, 
    scala.Unit
  ]
  ...
  type WxSaveFileSuccessCallback = js.Function1[
    /* result */ typingsSlinky.wechatMiniprogram.WechatMiniprogram.WxSaveFileSuccessCallbackResult, 
    scala.Unit
  ]
  /** 接口调用成功的回调函数 */
