...
object FullProperty {
  @scala.inline
  def apply[/* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Component.PropertyType */ T](`type`: T): FullProperty[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[FullProperty[T]]
  }
  @scala.inline
  implicit class FullPropertyOps[Self <: FullProperty[_], /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Component.PropertyType */ T] (val x: Self with FullProperty[T]) extends AnyVal {
    @scala.inline
