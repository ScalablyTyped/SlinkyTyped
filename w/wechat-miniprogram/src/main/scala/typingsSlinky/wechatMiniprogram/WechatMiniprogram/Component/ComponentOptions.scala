...
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`apply-shared`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`page-apply-shared`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`page-isolated`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`page-shared`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.isolated
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.shared
...
trait ComponentOptions extends StObject {
  ...
  /**
    ...
    */
  var pureDataPattern: js.UndefOr[js.RegExp] = js.native
...
object ComponentOptions {
  ...
  implicit class ComponentOptionsMutableBuilder[Self <: ComponentOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPureDataPattern(value: js.RegExp): Self = StObject.set(x, "pureDataPattern", value.asInstanceOf[js.Any])
