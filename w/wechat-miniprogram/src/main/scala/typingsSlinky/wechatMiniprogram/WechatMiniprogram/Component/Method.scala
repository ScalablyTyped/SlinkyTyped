...
object Method {
  @scala.inline
  def apply[/* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Component.MethodOption */ M](methods: M): Method[M] = {
    val __obj = js.Dynamic.literal(methods = methods.asInstanceOf[js.Any])
    __obj.asInstanceOf[Method[M]]
  }
  @scala.inline
  implicit class MethodOps[Self <: Method[_], /* <: typingsSlinky.wechatMiniprogram.WechatMiniprogram.Component.MethodOption */ M] (val x: Self with Method[M]) extends AnyVal {
    @scala.inline
