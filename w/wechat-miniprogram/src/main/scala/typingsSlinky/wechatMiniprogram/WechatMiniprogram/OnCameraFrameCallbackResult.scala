...
@js.native
trait OnCameraFrameCallbackResult extends js.Object {
...
object OnCameraFrameCallbackResult {
  ...
  @scala.inline
  implicit class OnCameraFrameCallbackResultOps[Self <: OnCameraFrameCallbackResult] (val x: Self) extends AnyVal {
    @scala.inline
