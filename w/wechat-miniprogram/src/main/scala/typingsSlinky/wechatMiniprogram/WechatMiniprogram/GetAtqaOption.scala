...
@js.native
trait GetAtqaOption extends js.Object {
...
object GetAtqaOption {
  ...
  @scala.inline
  implicit class GetAtqaOptionOps[Self <: GetAtqaOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetAtqaSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
