...
trait RequestSuccessCallbackResult extends js.Object {
  ...
  /** 开发者服务器返回的数据 */
  var data: String | IAnyObject | js.typedarray.ArrayBuffer = js.native
...
object RequestSuccessCallbackResult {
  ...
  def apply(
    ...
    data: String | IAnyObject | js.typedarray.ArrayBuffer,
    errMsg: String,
    header: IAnyObject,
  ...
  implicit class RequestSuccessCallbackResultOps[Self <: RequestSuccessCallbackResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: String | IAnyObject | js.typedarray.ArrayBuffer): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
