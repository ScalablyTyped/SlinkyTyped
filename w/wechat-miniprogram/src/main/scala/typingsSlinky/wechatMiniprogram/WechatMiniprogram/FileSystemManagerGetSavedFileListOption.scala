...
object FileSystemManagerGetSavedFileListOption {
  ...
  @scala.inline
  implicit class FileSystemManagerGetSavedFileListOptionOps[Self <: FileSystemManagerGetSavedFileListOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ FileSystemManagerGetSavedFileListSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
