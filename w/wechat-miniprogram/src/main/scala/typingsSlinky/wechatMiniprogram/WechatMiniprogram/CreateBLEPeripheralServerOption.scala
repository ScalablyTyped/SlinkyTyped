...
@js.native
trait CreateBLEPeripheralServerOption extends js.Object {
...
object CreateBLEPeripheralServerOption {
  ...
  @scala.inline
  implicit class CreateBLEPeripheralServerOptionOps[Self <: CreateBLEPeripheralServerOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ CreateBLEPeripheralServerSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
