...
@js.native
trait GetCenterLocationOption extends js.Object {
...
object GetCenterLocationOption {
  ...
  @scala.inline
  implicit class GetCenterLocationOptionOps[Self <: GetCenterLocationOption] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetCenterLocationSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
