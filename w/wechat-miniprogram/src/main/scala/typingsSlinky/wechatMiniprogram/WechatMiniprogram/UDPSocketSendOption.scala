...
object UDPSocketSendOption {
  ...
  @scala.inline
  def apply(address: String, message: String | js.typedarray.ArrayBuffer, port: Double): UDPSocketSendOption = {
  ...
  implicit class UDPSocketSendOptionOps[Self <: UDPSocketSendOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("message", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMessage(value: String | js.typedarray.ArrayBuffer): Self = this.set("message", value.asInstanceOf[js.Any])
