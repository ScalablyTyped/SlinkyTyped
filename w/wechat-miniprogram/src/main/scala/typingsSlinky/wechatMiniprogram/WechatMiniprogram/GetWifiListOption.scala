...
trait GetWifiListOption extends js.Object {
  ...
  var complete: js.UndefOr[GetWifiListCompleteCallback] = js.native
  
  /** 接口调用失败的回调函数 */
  var fail: js.UndefOr[GetWifiListFailCallback] = js.native
  
  /** 接口调用成功的回调函数 */
  var success: js.UndefOr[GetWifiListSuccessCallback] = js.native
}
object GetWifiListOption {
  ...
  @scala.inline
  implicit class GetWifiListOptionOps[Self <: GetWifiListOption] (val x: Self) extends AnyVal {
