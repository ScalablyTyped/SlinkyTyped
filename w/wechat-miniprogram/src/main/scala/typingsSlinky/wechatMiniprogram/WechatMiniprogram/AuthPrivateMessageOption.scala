...
@js.native
trait AuthPrivateMessageOption extends js.Object {
...
object AuthPrivateMessageOption {
  ...
  @scala.inline
  implicit class AuthPrivateMessageOptionOps[Self <: AuthPrivateMessageOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ AuthPrivateMessageSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
