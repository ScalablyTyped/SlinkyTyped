...
import typingsSlinky.wechatMiniprogram.anon.Cursor
import typingsSlinky.wechatMiniprogram.anon.Dataset
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.input
...
trait InputEvent extends Event {
  ...
  var detail: Cursor = js.native
  @JSName("type")
  var type_InputEvent: input = js.native
}
...
object InputEvent {
  ...
  implicit class InputEventOps[Self <: InputEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDetail(value: Cursor): Self = this.set("detail", value.asInstanceOf[js.Any])
    @scala.inline
