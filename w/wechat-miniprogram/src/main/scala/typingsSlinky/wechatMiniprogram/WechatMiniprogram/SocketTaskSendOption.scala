...
@js.native
trait SocketTaskSendOption extends js.Object {
...
object SocketTaskSendOption {
  ...
  @scala.inline
  def apply(data: String | js.typedarray.ArrayBuffer): SocketTaskSendOption = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    __obj.asInstanceOf[SocketTaskSendOption]
  }
  
  @scala.inline
  implicit class SocketTaskSendOptionOps[Self <: SocketTaskSendOption] (val x: Self) extends AnyVal {
