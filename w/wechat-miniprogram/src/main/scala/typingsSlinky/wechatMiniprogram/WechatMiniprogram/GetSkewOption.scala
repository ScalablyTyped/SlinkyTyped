...
@js.native
trait GetSkewOption extends js.Object {
...
object GetSkewOption {
  ...
  @scala.inline
  implicit class GetSkewOptionOps[Self <: GetSkewOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetSkewSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
