...
@js.native
trait Options[TData /* <: DataOption */, TProperty /* <: PropertyOption */, TMethod /* <: MethodOption */, TCustomInstanceProperty /* <: IAnyObject */, TIsPage /* <: Boolean */] extends js.Object {
...
object Options {
  ...
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _, _, _, _], TData /* <: DataOption */, TProperty /* <: PropertyOption */, TMethod /* <: MethodOption */, TCustomInstanceProperty /* <: IAnyObject */, TIsPage /* <: Boolean */] (val x: Self with (Options[TData, TProperty, TMethod, TCustomInstanceProperty, TIsPage])) extends AnyVal {
