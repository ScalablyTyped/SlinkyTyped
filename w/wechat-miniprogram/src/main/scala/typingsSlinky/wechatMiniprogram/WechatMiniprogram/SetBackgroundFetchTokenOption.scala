...
@js.native
trait SetBackgroundFetchTokenOption extends js.Object {
...
object SetBackgroundFetchTokenOption {
  ...
  @scala.inline
  implicit class SetBackgroundFetchTokenOptionOps[Self <: SetBackgroundFetchTokenOption] (val x: Self) extends AnyVal {
    @scala.inline
