...
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`ease-in-out`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`ease-in`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`ease-out`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`step-end`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.`step-start`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.ease
