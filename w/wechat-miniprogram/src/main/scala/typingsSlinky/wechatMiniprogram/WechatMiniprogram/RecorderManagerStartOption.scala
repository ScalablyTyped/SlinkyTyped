...
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`11025`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`12000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`16000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`1`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`22050`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`24000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`2`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`32000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`44100`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`48000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramNumbers.`8000`
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.PCM
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.aac
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.auto
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.buildInMic
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.camcorder
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.headsetMic
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.mic
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.mp3
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.voice_communication
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.voice_recognition
import typingsSlinky.wechatMiniprogram.wechatMiniprogramStrings.wav
...
object RecorderManagerStartOption {
  ...
  implicit class RecorderManagerStartOptionOps[Self <: RecorderManagerStartOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: mp3 | aac | wav | PCM): Self = this.set("format", value.asInstanceOf[js.Any])
    @scala.inline
