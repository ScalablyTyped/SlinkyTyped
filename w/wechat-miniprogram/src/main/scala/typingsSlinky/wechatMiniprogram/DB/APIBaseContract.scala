...
trait APIBaseContract[PROMISE_RETURN, CALLBACK_RETURN, PARAM /* <: IAPIParam[_] */, CONTEXT] extends js.Object {
  ...
  def run[T /* <: PARAM */](param: T): js.Promise[PROMISE_RETURN] = js.native
}

object APIBaseContract {
  @scala.inline
  def apply[PROMISE_RETURN, CALLBACK_RETURN, /* <: typingsSlinky.wechatMiniprogram.IAPIParam[_] */ PARAM, CONTEXT](
    getCallbackReturn: (PARAM, CONTEXT) => CALLBACK_RETURN,
    getContext: PARAM => CONTEXT,
    getFinalParam: (PARAM, CONTEXT) => js.Any,
    run: js.Any => js.Promise[PROMISE_RETURN]
  ...
  @scala.inline
  implicit class APIBaseContractOps[Self <: APIBaseContract[_, _, _, _], PROMISE_RETURN, CALLBACK_RETURN, /* <: typingsSlinky.wechatMiniprogram.IAPIParam[_] */ PARAM, CONTEXT] (val x: Self with (APIBaseContract[PROMISE_RETURN, CALLBACK_RETURN, PARAM, CONTEXT])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRun(value: js.Any => js.Promise[PROMISE_RETURN]): Self = this.set("run", js.Any.fromFunction1(value))
  }
