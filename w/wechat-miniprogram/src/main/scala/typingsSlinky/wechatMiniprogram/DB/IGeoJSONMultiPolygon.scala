...
object IGeoJSONMultiPolygon {
  ...
  @scala.inline
  implicit class IGeoJSONMultiPolygonOps[Self <: IGeoJSONMultiPolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoordinatesVarargs(value: (js.Array[js.Array[js.Tuple2[Double, Double]]])*): Self = this.set("coordinates", js.Array(value :_*))
    
    @scala.inline
    def setCoordinates(value: js.Array[js.Array[js.Array[js.Tuple2[Double, Double]]]]): Self = this.set("coordinates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setType(value: MultiPolygon): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
