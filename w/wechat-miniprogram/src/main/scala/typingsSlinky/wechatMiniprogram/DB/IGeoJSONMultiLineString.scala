...
object IGeoJSONMultiLineString {
  ...
  @scala.inline
  implicit class IGeoJSONMultiLineStringMutableBuilder[Self <: IGeoJSONMultiLineString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: MultiLineString): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
