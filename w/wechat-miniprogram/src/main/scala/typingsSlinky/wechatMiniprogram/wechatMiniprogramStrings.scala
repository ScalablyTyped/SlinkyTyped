...
import typingsSlinky.wechatMiniprogram.DB.DataType
import typingsSlinky.wechatMiniprogram.DB.QueueType
...
object wechatMiniprogramStrings {
  ...
  @scala.inline
  def OptionalInterface: OptionalInterface = "OptionalInterface".asInstanceOf[OptionalInterface]
  ...
  @scala.inline
  def PropertyOptionToData: PropertyOptionToData = "PropertyOptionToData".asInstanceOf[PropertyOptionToData]
  ...
  @scala.inline
  def `apply-shared`: `apply-shared` = "apply-shared".asInstanceOf[`apply-shared`]
  ...
  @scala.inline
  def `page-isolated`: `page-isolated` = "page-isolated".asInstanceOf[`page-isolated`]
  
  @scala.inline
  def `page-shared`: `page-shared` = "page-shared".asInstanceOf[`page-shared`]
  ...
  @js.native
  sealed trait `5g` extends js.Object
  ...
  @js.native
  sealed trait OptionalInterface extends js.Object
  ...
  @js.native
  sealed trait PropertyOptionToData extends js.Object
  ...
  @js.native
  sealed trait `apply-shared` extends js.Object
  ...
  @js.native
  sealed trait filePath extends js.Object
  ...
  @js.native
  sealed trait `page-isolated` extends js.Object
  
  @js.native
  sealed trait `page-shared` extends js.Object
