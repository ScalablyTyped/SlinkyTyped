...
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.IAddToFavoritesContent
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.IAddToFavoritesOption
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.ICustomShareContent
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.IPageScrollOption
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.IResizeOption
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.IShareAppMessageOption
import typingsSlinky.wechatMiniprogram.WechatMiniprogram.Page.ITabItemTapOption
...
trait PartialILifetime extends js.Object {
  ...
  var onLoad: js.UndefOr[js.Function1[/* query */ Record[String, js.UndefOr[String]], Unit]] = js.native
  
  var onPageScroll: js.UndefOr[js.Function1[/* options */ IPageScrollOption, Unit]] = js.native
  ...
  var onResize: js.UndefOr[js.Function1[/* options */ IResizeOption, Unit]] = js.native
  
  var onShareAppMessage: js.UndefOr[js.Function1[/* options */ IShareAppMessageOption, ICustomShareContent | Unit]] = js.native
  
  var onShow: js.UndefOr[js.Function0[Unit]] = js.native
  
  var onTabItemTap: js.UndefOr[js.Function1[/* options */ ITabItemTapOption, Unit]] = js.native
...
object PartialILifetime {
  ...
  implicit class PartialILifetimeOps[Self <: PartialILifetime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnLoad(value: /* query */ Record[String, js.UndefOr[String]] => Unit): Self = this.set("onLoad", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnLoad: Self = this.set("onLoad", js.undefined)
    
    @scala.inline
    def setOnPageScroll(value: /* options */ IPageScrollOption => Unit): Self = this.set("onPageScroll", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnResize(value: /* options */ IResizeOption => Unit): Self = this.set("onResize", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTabItemTap(value: /* options */ ITabItemTapOption => Unit): Self = this.set("onTabItemTap", js.Any.fromFunction1(value))
