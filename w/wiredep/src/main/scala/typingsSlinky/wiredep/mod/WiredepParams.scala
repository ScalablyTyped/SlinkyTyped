...
object WiredepParams {
  ...
  implicit class WiredepParamsOps[Self <: WiredepParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnorePathRegExp(value: js.RegExp): Self = this.set("ignorePath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIgnorePath(value: String | js.RegExp): Self = this.set("ignorePath", value.asInstanceOf[js.Any])
