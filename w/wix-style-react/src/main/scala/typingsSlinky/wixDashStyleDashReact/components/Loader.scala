...
import typingsSlinky.wixDashStyleDashReact.loaderMod.default
...
object Loader
  ...
  typingsSlinky.wixDashStyleDashReact.loaderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
