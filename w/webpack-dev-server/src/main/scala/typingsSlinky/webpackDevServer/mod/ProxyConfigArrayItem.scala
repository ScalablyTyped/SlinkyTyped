...
object ProxyConfigArrayItem {
  ...
  implicit class ProxyConfigArrayItemOps[Self <: ProxyConfigArrayItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContextFunction2(value: (/* pathname */ String, /* req */ IncomingMessage) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("context")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withContext(value: String | js.Array[String] | Filter): Self = {
        val ret = this.duplicate
