package typingsSlinky.websocket.websocketMod
...
import typingsSlinky.websocket.websocketStrings.drain
import typingsSlinky.websocket.websocketStrings.error
import typingsSlinky.websocket.websocketStrings.message
import typingsSlinky.websocket.websocketStrings.pause
import typingsSlinky.websocket.websocketStrings.ping
import typingsSlinky.websocket.websocketStrings.pong
import typingsSlinky.websocket.websocketStrings.resume
...
class connection protected () extends EventEmitter {
  ...
  @JSName("addListener")
  def addListener_frame(event: typingsSlinky.websocket.websocketStrings.frame, cb: js.Function1[/* frame */ frame, Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("on")
  def on_frame(event: typingsSlinky.websocket.websocketStrings.frame, cb: js.Function1[/* frame */ frame, Unit]): this.type = js.native
  // Events
  @JSName("on")
