...
object TypeQueryInterface {
  ...
  @scala.inline
  implicit class TypeQueryInterfaceOps[Self <: TypeQueryInterface] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMethod(value: typeQueryMethods): Self = this.set("method", value.asInstanceOf[js.Any])
    @scala.inline
