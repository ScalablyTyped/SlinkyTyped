...
import typingsSlinky.wordpressEditor.mod.PostSticky.^
...
object PostSticky {
  ...
  implicit def make(companion: PostSticky.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
