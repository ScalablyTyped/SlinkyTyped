...
import typingsSlinky.wordpressEditor.mod.PostTaxonomies.^
...
object PostTaxonomies {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def taxonomyWrapper(value: (/* content */ TagMod[Any], /* taxonomy */ Taxonomy[edit]) => ReactElement): this.type = set("taxonomyWrapper", js.Any.fromFunction2(value))
  }
