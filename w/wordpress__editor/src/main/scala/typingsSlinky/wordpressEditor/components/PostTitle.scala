...
import typingsSlinky.wordpressEditor.mod.PostTitle.^
...
object PostTitle {
  ...
  implicit def make(companion: PostTitle.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
