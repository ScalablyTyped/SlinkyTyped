...
object PostLastRevisionCheck {
  ...
  implicit def make(companion: PostLastRevisionCheck.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
