...
object UnsavedChangesWarning {
  ...
  implicit def make(companion: UnsavedChangesWarning.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
