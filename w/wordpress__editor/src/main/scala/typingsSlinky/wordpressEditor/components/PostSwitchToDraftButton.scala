...
import typingsSlinky.wordpressEditor.mod.PostSwitchToDraftButton.^
...
object PostSwitchToDraftButton {
  ...
  implicit def make(companion: PostSwitchToDraftButton.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
