...
import typingsSlinky.wordpressEditor.mod.PostTextEditor.^
...
object PostTextEditor {
  ...
  implicit def make(companion: PostTextEditor.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
