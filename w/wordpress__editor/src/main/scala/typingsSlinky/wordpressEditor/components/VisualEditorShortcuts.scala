...
object VisualEditorShortcuts {
  ...
  implicit def make(companion: VisualEditorShortcuts.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
