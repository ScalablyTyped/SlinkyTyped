...
object InnerBlocks {
  ...
  object ButtonBlockerAppender {
    @JSImport("@wordpress/editor", "InnerBlocks.ButtonBlockerAppender")
    @js.native
    object component extends js.Object
  ...
  object Content {
    @JSImport("@wordpress/editor", "InnerBlocks.Content")
    @js.native
    object component extends js.Object
  ...
  object DefaultBlockAppender {
    @JSImport("@wordpress/editor", "InnerBlocks.DefaultBlockAppender")
    @js.native
    object component extends js.Object
