...
import typingsSlinky.wordpressEditor.mod.WordCount.^
...
object WordCount {
  ...
  implicit def make(companion: WordCount.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
