...
import typingsSlinky.wordpressEditor.postPublishButtonMod.PostPublishButton.Props
  ...
  object PostPublishButton {
    ...
    */
    ...
    object Props {
      ...
      @scala.inline
      def SubmitProps(): typingsSlinky.wordpressEditor.postPublishButtonMod.PostPublishButton.SubmitProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.wordpressEditor.postPublishButtonMod.PostPublishButton.SubmitProps]
      }
      
      @scala.inline
      def ToggleProps(isToggle: `true`, onToggle: () => Unit): typingsSlinky.wordpressEditor.postPublishButtonMod.PostPublishButton.ToggleProps = {
        val __obj = js.Dynamic.literal(isToggle = isToggle.asInstanceOf[js.Any], onToggle = js.Any.fromFunction0(onToggle))
        __obj.asInstanceOf[typingsSlinky.wordpressEditor.postPublishButtonMod.PostPublishButton.ToggleProps]
      }
    }
