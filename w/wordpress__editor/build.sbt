...
version := "9.4-dt-20200925Z-51f813"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-autosize-textarea" % "7.1.0-5af307",
  ...
  "org.scalablytyped.slinky" %%% "wordpress__api-fetch" % "3.2-dt-20200925Z-b2f446",
  "org.scalablytyped.slinky" %%% "wordpress__block-editor" % "2.2-dt-20200925Z-53618c",
  "org.scalablytyped.slinky" %%% "wordpress__blocks" % "6.4-dt-20201013Z-f05b54",
  "org.scalablytyped.slinky" %%% "wordpress__components" % "9.8-dt-20201104Z-39439c",
  "org.scalablytyped.slinky" %%% "wordpress__core-data" % "2.4-dt-20200925Z-4f072a",
  "org.scalablytyped.slinky" %%% "wordpress__element" % "2.18.0-bc06fb",
  "org.scalablytyped.slinky" %%% "wordpress__media-utils" % "0.2-dt-20200925Z-d05c6d",
