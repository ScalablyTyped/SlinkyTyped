...
version := "9.4-dt-20200611Z-9ea8fa"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "wordpress__api-fetch" % "3.2-dt-20190726Z-ad828a",
  ...
  "org.scalablytyped.slinky" %%% "wordpress__core-data" % "2.4-dt-20200515Z-d117d0",
  "org.scalablytyped.slinky" %%% "wordpress__element" % "2.16.0-466dea",
  "org.scalablytyped.slinky" %%% "wordpress__media-utils" % "0.2-dt-20200611Z-bba9d2",
