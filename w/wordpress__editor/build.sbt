...
version := "9.4-dt-20200515Z-d5ce33"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "wordpress__api-fetch" % "3.2-dt-20190726Z-fbdd32",
  ...
  "org.scalablytyped.slinky" %%% "wordpress__core-data" % "2.4-dt-20200515Z-350fc5",
  "org.scalablytyped.slinky" %%% "wordpress__element" % "2.4-dt-20200427Z-e60d51",
  "org.scalablytyped.slinky" %%% "wordpress__media-utils" % "0.2-dt-20200515Z-f15f68",
