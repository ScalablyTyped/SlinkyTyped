package typingsSlinky.windowsDashScriptDashHost

import typingsSlinky.activexDashIwshruntimelibrary.IWshRuntimeLibrary.TextStreamReader
import typingsSlinky.activexDashIwshruntimelibrary.IWshRuntimeLibrary.TextStreamWriter
