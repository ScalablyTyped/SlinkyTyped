package typingsSlinky.windowsScriptHost

import typingsSlinky.activexIwshruntimelibrary.IWshRuntimeLibrary.TextStreamReader
import typingsSlinky.activexIwshruntimelibrary.IWshRuntimeLibrary.TextStreamWriter
