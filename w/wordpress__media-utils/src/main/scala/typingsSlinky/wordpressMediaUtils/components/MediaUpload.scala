package typingsSlinky.wordpressMediaUtils.components
...
object MediaUpload {
  ...
  @scala.inline
  def apply[/* <: scala.Boolean */ T](onSelect: /* value */ Dictk | js.Array[Dictk] => Unit, render: Open => ReactElement): Builder[T] = {
