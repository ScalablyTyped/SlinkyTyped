package typingsSlinky.wordpressBlockEditor.inserterMod.Inserter
...
trait Props extends js.Object {
  ...
  var renderToggle: js.UndefOr[js.Function1[/* props */ RenderProps, ReactElement]] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderToggle(value: /* props */ RenderProps => ReactElement): Self = this.set("renderToggle", js.Any.fromFunction1(value))
    @scala.inline
