...
import typingsSlinky.wordpressBlockEditor.anon.TypeofTextareaAutosize
...
object plainTextMod {
  ...
  object default extends Shortcut {
    ...
    @JSImport("@wordpress/block-editor/components/plain-text", JSImport.Default)
    @js.native
  ...
  object PlainText {
    ...
    /* Inlined parent std.Omit<react-autosize-textarea.react-autosize-textarea.default.Props, 'onChange'> */
    @js.native
    trait Props extends StObject {
      ...
      /**
        ...
        */
      var ref: js.UndefOr[Ref[TypeofTextareaAutosize]] = js.native
    ...
    object Props {
      ...
      implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setRef(value: Ref[TypeofTextareaAutosize]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setRefFunction1(value: /* instance */ TypeofTextareaAutosize | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
        
        @scala.inline
        def setRefNull: Self = StObject.set(x, "ref", null)
        
        @scala.inline
        def setRefRefObject(value: ReactRef[TypeofTextareaAutosize]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
