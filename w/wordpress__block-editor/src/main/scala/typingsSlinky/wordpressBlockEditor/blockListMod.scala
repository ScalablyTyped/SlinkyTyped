  ...
  object BlockList {
    ...
    trait Props extends StObject {
      ...
      /**
        ...
        */
      var renderAppender: js.UndefOr[js.Function0[ReactElement]] = js.native
    ...
    object Props {
      ...
      implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setRenderAppender(value: () => ReactElement): Self = StObject.set(x, "renderAppender", js.Any.fromFunction0(value))
