package typingsSlinky.wordpressBlockEditor.innerBlocksMod.InnerBlocks
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderAppenderFunctionComponent(value: ReactComponentClass[js.Object]): Self = this.set("renderAppender", value.asInstanceOf[js.Any])
    @scala.inline
    def setRenderAppenderComponentClass(value: ReactComponentClass[js.Object]): Self = this.set("renderAppender", value.asInstanceOf[js.Any])
    @scala.inline
    def setRenderAppender(value: ReactComponentClass[js.Object]): Self = this.set("renderAppender", value.asInstanceOf[js.Any])
    @scala.inline
