package typingsSlinky.wordpressBlockEditor.mediaUploadMod.MediaUpload
...
trait Props[T /* <: Boolean */] extends js.Object {
  ...
  /**
    ...
    */
  def render(props: Open): ReactElement = js.native
}

object Props {
  @scala.inline
  def apply[/* <: scala.Boolean */ T](onSelect: /* value */ Dictk | js.Array[Dictk] => Unit, render: Open => ReactElement): Props[T] = {
  ...
  implicit class PropsOps[Self <: Props[_], /* <: scala.Boolean */ T] (val x: Self with Props[T]) extends AnyVal {
    ...
    @scala.inline
    def setRender(value: Open => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
    @scala.inline
