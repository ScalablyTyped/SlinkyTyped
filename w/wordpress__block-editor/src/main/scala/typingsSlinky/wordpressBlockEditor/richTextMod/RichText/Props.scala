...
object Props {
  ...
  def apply[T](
    ...
    onBeforeInput: SyntheticEvent[EventTarget with T, Event] => Unit = null,
    ...
    onInvalid: SyntheticEvent[EventTarget with T, Event] => Unit = null,
    ...
    onReset: SyntheticEvent[EventTarget with T, Event] => Unit = null,
