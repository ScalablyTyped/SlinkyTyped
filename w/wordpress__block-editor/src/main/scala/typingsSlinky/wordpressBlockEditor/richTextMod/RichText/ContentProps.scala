...
object ContentProps {
  ...
  @scala.inline
  implicit class ContentPropsOps[Self <: ContentProps[_], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 119 */ js.Any */] (val x: Self with ContentProps[T]) extends AnyVal {
