package typingsSlinky.wordpressBlockEditor.mediaPlaceholderMod.MediaPlaceholder
...
trait Props[T /* <: Boolean */] extends js.Object {
  ...
  /** Undocumented. */
  var mediaPreview: js.UndefOr[ReactElement] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props[_], T /* <: Boolean */] (val x: Self with Props[T]) extends AnyVal {
    ...
    @scala.inline
    def setMediaPreview(value: ReactElement): Self = this.set("mediaPreview", value.asInstanceOf[js.Any])
