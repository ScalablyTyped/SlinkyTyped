...
import typingsSlinky.wordpressBlockEditor.mod.BlockToolbar.^
...
object BlockToolbar {
  ...
  implicit def make(companion: BlockToolbar.type): Default[tag.type, ^] = new Default[tag.type, ^](js.Array(this.component, js.Dictionary.empty))()
}
