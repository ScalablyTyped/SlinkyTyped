...
@scala.inline
class SharedBuilder_ContentProps1363536787[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def onBlur(value: SyntheticFocusEvent[input] => Unit): this.type = set("onBlur", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def onChange(value: SyntheticEvent[EventTarget with input, Event] => Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  @scala.inline
  def onClick(value: SyntheticMouseEvent[input] => Unit): this.type = set("onClick", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def onFocus(value: SyntheticFocusEvent[input] => Unit): this.type = set("onFocus", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def onKeyDown(value: SyntheticKeyboardEvent[input] => Unit): this.type = set("onKeyDown", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def tagName(value: input): this.type = set("tagName", value.asInstanceOf[js.Any])
  @scala.inline
