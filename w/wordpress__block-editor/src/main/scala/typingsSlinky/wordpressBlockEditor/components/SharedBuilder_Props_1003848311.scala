...
@scala.inline
class SharedBuilder_Props_1003848311[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def getAnchorRect(value: /* currentAnchorElement */ HTMLSpanElement | Null => js.UndefOr[DOMRect | ClientRect]): this.type = set("getAnchorRect", js.Any.fromFunction1(value))
  @scala.inline
  def headerTitle(value: String): this.type = set("headerTitle", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def onClickOutside(value: () => Unit): this.type = set("onClickOutside", js.Any.fromFunction0(value))
  @scala.inline
  ...
  @scala.inline
  def onFocusOutside(value: /* event */ SyntheticFocusEvent[Element] => Unit): this.type = set("onFocusOutside", js.Any.fromFunction1(value))
  @scala.inline
  ...
  @scala.inline
  def renderSettings(value: () => ReactElement): this.type = set("renderSettings", js.Any.fromFunction0(value))
  @scala.inline
