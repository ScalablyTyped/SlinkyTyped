...
@scala.inline
class SharedBuilder_ContentProps_1482840784[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def tagName(value: button): this.type = set("tagName", value.asInstanceOf[js.Any])
  @scala.inline
