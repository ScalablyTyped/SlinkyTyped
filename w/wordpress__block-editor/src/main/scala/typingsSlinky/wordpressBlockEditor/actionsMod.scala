...
import typingsSlinky.wordpressBlockEditor.anon.PartialEditorSettings
...
object actionsMod {
  ...
  @JSImport("@wordpress/block-editor/store/actions", "clearSelectedBlock")
  @js.native
  def clearSelectedBlock(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "enterFormattedText")
  @js.native
  def enterFormattedText(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "exitFormattedText")
  @js.native
  def exitFormattedText(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "hideInsertionPoint")
  @js.native
  def hideInsertionPoint(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "insertBlock")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "insertBlocks")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "insertDefaultBlock")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "mergeBlocks")
  @js.native
  def mergeBlocks(firstBlockClientId: String, secondBlockClientId: String): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "moveBlockToPosition")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "moveBlocksDown")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "moveBlocksUp")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "multiSelect")
  @js.native
  def multiSelect(start: String, end: String): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "receiveBlocks")
  @js.native
  def receiveBlocks(blocks: js.Array[BlockInstance[StringDictionary[_]]]): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "removeBlock")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "removeBlocks")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "replaceBlock")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "replaceBlocks")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "replaceInnerBlocks")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "resetBlocks")
  @js.native
  def resetBlocks(blocks: js.Array[BlockInstance[StringDictionary[_]]]): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "selectBlock")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "selectNextBlock")
  @js.native
  def selectNextBlock(clientId: String): IterableIterator[Unit] = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "selectPreviousBlock")
  @js.native
  def selectPreviousBlock(clientId: String): IterableIterator[Unit] = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "selectionChange")
  @js.native
  def selectionChange(clientId: String, attributeKey: String, startOffset: Double, endOffset: Double): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "setTemplateValidity")
  @js.native
  def setTemplateValidity(isValid: Boolean): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "showInsertionPoint")
  @js.native
  ...
  @JSImport("@wordpress/block-editor/store/actions", "startMultiSelect")
  @js.native
  def startMultiSelect(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "startTyping")
  @js.native
  def startTyping(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "stopMultiSelect")
  @js.native
  def stopMultiSelect(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "stopTyping")
  @js.native
  def stopTyping(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "synchronizeTemplate")
  @js.native
  def synchronizeTemplate(): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "toggleBlockMode")
  @js.native
  def toggleBlockMode(clientId: String): Unit = js.native
  
  @JSImport("@wordpress/block-editor/store/actions", "toggleSelection")
  @js.native
