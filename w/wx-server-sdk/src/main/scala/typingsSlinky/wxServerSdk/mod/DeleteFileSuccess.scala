...
object DeleteFileSuccess {
  ...
  implicit class DeleteFileSuccessOps[Self <: DeleteFileSuccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileListVarargs(value: Status*): Self = this.set("fileList", js.Array(value :_*))
    @scala.inline
    def setFileList(value: js.Array[Status]): Self = this.set("fileList", value.asInstanceOf[js.Any])
  }
