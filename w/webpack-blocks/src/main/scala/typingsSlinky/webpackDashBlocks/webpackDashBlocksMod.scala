...
import typingsSlinky.atWebpackDashBlocksAssets.atWebpackDashBlocksAssetsMod.css.CssOptions
import typingsSlinky.atWebpackDashBlocksAssets.atWebpackDashBlocksAssetsMod.css.FileOptions
import typingsSlinky.atWebpackDashBlocksAssets.atWebpackDashBlocksAssetsMod.css.ModuleOptions
...
import typingsSlinky.atWebpackDashBlocksCore.atWebpackDashBlocksCoreMod.MatchOptions
import typingsSlinky.atWebpackDashBlocksDevDashServer.atWebpackDashBlocksDevDashServerMod.Options
import typingsSlinky.atWebpackDashBlocksWebpack.atWebpackDashBlocksWebpackMod.ConstantOptions
import typingsSlinky.atWebpackDashBlocksWebpack.atWebpackDashBlocksWebpackMod.OptimizationOptions
import typingsSlinky.webpack.webpackMod.Configuration
import typingsSlinky.webpack.webpackMod.Entry
import typingsSlinky.webpack.webpackMod.Options.Devtool
import typingsSlinky.webpack.webpackMod.Options.Performance
import typingsSlinky.webpack.webpackMod.Output
import typingsSlinky.webpack.webpackMod.Plugin
import typingsSlinky.webpack.webpackMod.Resolve
...
object webpackDashBlocksMod extends js.Object {
  ...
  object babel extends js.Object {
    ...
    def apply(options: typingsSlinky.atWebpackDashBlocksBabel.atWebpackDashBlocksBabelMod.babel): js.Any = js.native
  }
  ...
  object postcss extends js.Object {
    def apply(): js.Any = js.native
    def apply(options: typingsSlinky.atWebpackDashBlocksPostcss.atWebpackDashBlocksPostcssMod.Options): js.Any = js.native
  }
  
  @js.native
  object sass extends js.Object {
    def apply(): js.Any = js.native
    def apply(options: typingsSlinky.atWebpackDashBlocksSass.atWebpackDashBlocksSassMod.Options): js.Any = js.native
  }
  
  @js.native
  object typescript extends js.Object {
    def apply(): js.Any = js.native
    def apply(options: typingsSlinky.atWebpackDashBlocksTypescript.atWebpackDashBlocksTypescriptMod.Options): js.Any = js.native
  }
  
  @js.native
  object uglify extends js.Object {
    def apply(): js.Any = js.native
    def apply(options: typingsSlinky.atWebpackDashBlocksUglify.atWebpackDashBlocksUglifyMod.Options): js.Any = js.native
  }
