...
import typingsSlinky.winston.winstonStrings.asc
import typingsSlinky.winston.winstonStrings.desc
...
object QueryOptions {
  ...
  implicit class QueryOptionsOps[Self <: QueryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUntil(value: js.Date): Self = this.set("until", value.asInstanceOf[js.Any])
