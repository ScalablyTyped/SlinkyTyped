...
object LoggerOptions {
  ...
  implicit class LoggerOptionsOps[Self <: LoggerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransports(value: js.Array[typingsSlinky.winstonTransport.mod.^] | typingsSlinky.winstonTransport.mod.^ ): Self = this.set("transports", value.asInstanceOf[js.Any])
    @scala.inline
