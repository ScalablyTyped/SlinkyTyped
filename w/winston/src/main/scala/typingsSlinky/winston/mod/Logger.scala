...
trait Logger
  ...
  def add(transport: typingsSlinky.winstonTransport.mod.^): Logger = js.native
  ...
  def query(
    ...
    callback: js.Function2[/* err */ js.Error, /* results */ js.Any, Unit]
  ): js.Any = js.native
  ...
  def remove(transport: typingsSlinky.winstonTransport.mod.^): Logger = js.native
