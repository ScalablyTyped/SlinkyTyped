...
import typingsSlinky.winston.configMod.Config
import typingsSlinky.winston.transportsMod.ConsoleTransportInstance
import typingsSlinky.winston.transportsMod.ConsoleTransportOptions
import typingsSlinky.winston.transportsMod.FileTransportInstance
import typingsSlinky.winston.transportsMod.FileTransportOptions
import typingsSlinky.winston.transportsMod.HttpTransportInstance
import typingsSlinky.winston.transportsMod.HttpTransportOptions
import typingsSlinky.winston.transportsMod.StreamTransportInstance
import typingsSlinky.winston.transportsMod.StreamTransportOptions
import typingsSlinky.winston.transportsMod.Transports
...
object mod {
  ...
  object Logform {
    ...
    @js.native
    class Colorizer ()
      extends typingsSlinky.logform.mod.Colorizer {
    ...
    @js.native
    class Format_ ()
      extends typingsSlinky.logform.mod.Format_ {
      def this(opts: js.Object) = this()
    }
  ...
  @js.native
  def add: js.Function1[/* transport */ typingsSlinky.winstonTransport.mod.^, Logger] = js.native
  ...
  @scala.inline
  def add_=(x: js.Function1[/* transport */ typingsSlinky.winstonTransport.mod.^, Logger]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("add")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def remove: js.Function1[/* transport */ typingsSlinky.winstonTransport.mod.^, Logger] = js.native
  @scala.inline
  def remove_=(x: js.Function1[/* transport */ typingsSlinky.winstonTransport.mod.^, Logger]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("remove")(x.asInstanceOf[js.Any])
  ...
  object LoggerOptions {
    ...
    implicit class LoggerOptionsMutableBuilder[Self <: LoggerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTransports(value: js.Array[typingsSlinky.winstonTransport.mod.^] | typingsSlinky.winstonTransport.mod.^): Self = StObject.set(x, "transports", value.asInstanceOf[js.Any])
