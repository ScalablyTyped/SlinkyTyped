...
trait Transports extends js.Object {
  ...
  var ConsoleTransportOptions: typingsSlinky.winston.libWinstonTransportsMod.ConsoleTransportOptions
  var File: FileTransportInstance
  var FileTransportOptions: typingsSlinky.winston.libWinstonTransportsMod.FileTransportOptions
  var Http: HttpTransportInstance
  var HttpTransportOptions: typingsSlinky.winston.libWinstonTransportsMod.HttpTransportOptions
  var Stream: StreamTransportInstance
  var StreamTransportOptions: typingsSlinky.winston.libWinstonTransportsMod.StreamTransportOptions
}
