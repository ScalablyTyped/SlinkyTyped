...
trait LoggerOptions extends js.Object {
  ...
  var transports: js.UndefOr[
    js.Array[typingsSlinky.winstonDashTransport.winstonDashTransportMod.^] | typingsSlinky.winstonDashTransport.winstonDashTransportMod.^ 
  ] = js.undefined
}
...
object LoggerOptions {
  ...
  def apply(
    ...
    transports: js.Array[typingsSlinky.winstonDashTransport.winstonDashTransportMod.^] | typingsSlinky.winstonDashTransport.winstonDashTransportMod.^  = null
  ): LoggerOptions = {
