...
import typingsSlinky.winston.libWinstonConfigMod.AbstractConfigSetLevels
...
trait Logger
  ...
  var transports: js.Array[typingsSlinky.winstonDashTransport.winstonDashTransportMod.^] = js.native
  @JSName("verbose")
  ...
  def add(transport: typingsSlinky.winstonDashTransport.winstonDashTransportMod.^): Logger = js.native
  ...
  def query(options: QueryOptions, callback: js.Function2[/* err */ js.Error, /* results */ js.Any, Unit]): js.Any = js.native
  def remove(transport: typingsSlinky.winstonDashTransport.winstonDashTransportMod.^): Logger = js.native
