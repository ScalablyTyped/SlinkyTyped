...
trait WebGL2RenderingContext
  ...
  def bindSampler(unit: Double): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindSampler(unit: Double, sampler: typingsSlinky.std.WebGLSampler): Unit = js.native
  def bindTransformFeedback(target: Double): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindTransformFeedback(target: Double, tf: typingsSlinky.std.WebGLTransformFeedback): Unit = js.native
  def bindVertexArray(): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindVertexArray(array: typingsSlinky.std.WebGLVertexArrayObject): Unit = js.native
  /* Framebuffer objects */
  def blitFramebuffer(
    srcX0: Double,
    srcY0: Double,
  ...
  def bufferData(
    target: Double,
    sizeOrData: Double | js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Int32Array | js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Uint8ClampedArray | js.typedarray.Float32Array | js.typedarray.Float64Array | js.typedarray.DataView | js.typedarray.ArrayBuffer | Null,
    usage: Double
  ): Unit = js.native
  // WebGL2:
  def bufferData(
    target: Double,
    srcData: js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Int32Array | js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Uint8ClampedArray | js.typedarray.Float32Array | js.typedarray.Float64Array | js.typedarray.DataView | js.typedarray.ArrayBuffer | Null,
    usage: Double,
    srcOffset: Double
  ): Unit = js.native
  def bufferData(
  ...
  def bufferSubData(
    ...
    srcData: js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Int32Array | js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Uint8ClampedArray | js.typedarray.Float32Array | js.typedarray.Float64Array | js.typedarray.DataView | js.typedarray.ArrayBuffer
  ): Unit = js.native
  ...
  def clientWaitSync(sync: typingsSlinky.std.WebGLSync, flags: Double, timeout: Double): Double = js.native
  ...
  def compressedTexImage2D(
    ...
    height: Double,
    border: Double,
    srcData: js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Int32Array | js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Uint8ClampedArray | js.typedarray.Float32Array | js.typedarray.Float64Array | js.typedarray.DataView
  ): Unit = js.native
  def compressedTexImage2D(
    target: Double,
    level: Double,
  ...
  /* Query Objects */
  def createQuery(): typingsSlinky.std.WebGLQuery | Null = js.native
  /* Sampler Objects */
  def createSampler(): typingsSlinky.std.WebGLSampler | Null = js.native
  /* Transform Feedback */
  def createTransformFeedback(): typingsSlinky.std.WebGLTransformFeedback | Null = js.native
  /* Vertex Array Objects */
  def createVertexArray(): typingsSlinky.std.WebGLVertexArrayObject | Null = js.native
  ...
  def deleteSampler(sampler: typingsSlinky.std.WebGLSampler): Unit = js.native
  def deleteSync(): Unit = js.native
   //[WebGLHandlesContextLoss]
  def deleteSync(sync: typingsSlinky.std.WebGLSync): Unit = js.native
  def deleteTransformFeedback(): Unit = js.native
  def deleteTransformFeedback(tf: typingsSlinky.std.WebGLTransformFeedback): Unit = js.native
  def deleteVertexArray(): Unit = js.native
  def deleteVertexArray(vertexArray: typingsSlinky.std.WebGLVertexArrayObject): Unit = js.native
  ...
  /* Sync objects */
  def fenceSync(condition: Double, flags: Double): typingsSlinky.std.WebGLSync | Null = js.native
  ...
  def getQuery(target: Double, pname: Double): typingsSlinky.std.WebGLQuery | Null = js.native
  def getQueryParameter(query: typingsSlinky.std.WebGLQuery, pname: Double): js.Any = js.native
  def getSamplerParameter(sampler: typingsSlinky.std.WebGLSampler, pname: Double): js.Any = js.native
  def getSyncParameter(sync: typingsSlinky.std.WebGLSync, pname: Double): js.Any = js.native
  ...
  def isQuery(query: typingsSlinky.std.WebGLQuery): Boolean = js.native
  def isSampler(): Boolean = js.native
  def isSampler(sampler: typingsSlinky.std.WebGLSampler): Boolean = js.native
  def isSync(): Boolean = js.native
  def isSync(sync: typingsSlinky.std.WebGLSync): Boolean = js.native
  def isTransformFeedback(): Boolean = js.native
  def isTransformFeedback(tf: typingsSlinky.std.WebGLTransformFeedback): Boolean = js.native
  def isVertexArray(): Boolean = js.native
  def isVertexArray(vertexArray: typingsSlinky.std.WebGLVertexArrayObject): Boolean = js.native
  ...
  def readPixels(
    ...
    format: Double,
    `type`: Double,
    dstData: js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Int32Array | js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Uint8ClampedArray | js.typedarray.Float32Array | js.typedarray.Float64Array | js.typedarray.DataView
  ): Unit = js.native
  def readPixels(
    x: Double,
    y: Double,
  ...
  def samplerParameterf(sampler: typingsSlinky.std.WebGLSampler, pname: Double, param: Double): Unit = js.native
  def samplerParameteri(sampler: typingsSlinky.std.WebGLSampler, pname: Double, param: Double): Unit = js.native
  def texImage2D(
    target: Double,
    level: Double,
    internalformat: Double,
  ...
  def waitSync(sync: typingsSlinky.std.WebGLSync, flags: Double, timeout: Double): Unit = js.native
}
