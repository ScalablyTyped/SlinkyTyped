...
import typingsSlinky.webdriverio.Anon_Duration
...
trait HookFunctions extends js.Object {
  ...
  var afterTest: js.UndefOr[
    js.Function3[/* test */ Test, /* context */ js.Any, /* result */ Anon_Duration, Unit]
  ] = js.undefined
...
object HookFunctions {
  ...
  def apply(
    ...
    afterCommand: (/* commandName */ String, /* args */ js.Array[_], /* result */ js.Any, /* error */ js.UndefOr[js.Error]) => Unit = null,
    afterHook: (/* test */ js.Any, /* context */ js.Any, /* result */ Anon_Duration, /* stepData */ js.UndefOr[js.Any], /* world */ js.UndefOr[js.Any]) => Unit = null,
    ...
    afterTest: (/* test */ Test, /* context */ js.Any, /* result */ Anon_Duration) => Unit = null,
