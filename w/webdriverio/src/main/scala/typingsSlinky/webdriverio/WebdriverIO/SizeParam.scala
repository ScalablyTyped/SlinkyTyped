...
object SizeParam {
  ...
  @scala.inline
  def height: typingsSlinky.webdriverio.webdriverioStrings.height = this.cast("height")
  @scala.inline
  def width: typingsSlinky.webdriverio.webdriverioStrings.width = this.cast("width")
}
