...
import typingsSlinky.webdriverio.WebdriverIO.Timeouts
...
trait BrowserAsync extends js.Object {
  ...
  var switchWindow_Original: js.Function1[
    /* args */ Parameters[js.Function1[/* urlOrTitleToMatch */ String | js.RegExp, Unit]], 
    js.Promise[ReturnType[js.Function1[/* urlOrTitleToMatch */ String | js.RegExp, Unit]]]
  ] = js.native
  @JSName("uploadFile")
  ...
  def switchWindow(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<BrowserPromise[K]> is not an array type */ args: Parameters[js.Function1[/* urlOrTitleToMatch */ String | js.RegExp, Unit]]
  ): js.Promise[ReturnType[js.Function1[/* urlOrTitleToMatch */ String | js.RegExp, Unit]]] = js.native
  def uploadFile(
