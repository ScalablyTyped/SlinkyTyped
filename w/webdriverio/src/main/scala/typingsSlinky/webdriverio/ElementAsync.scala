...
import typingsSlinky.webdriverio.WebdriverIO.AddValueOptions
import typingsSlinky.webdriverio.WebdriverIO.CSSProperty
import typingsSlinky.webdriverio.WebdriverIO.ClickOptions
import typingsSlinky.webdriverio.WebdriverIO.Element
import typingsSlinky.webdriverio.WebdriverIO.ElementArray
import typingsSlinky.webdriverio.WebdriverIO.LocationParam
import typingsSlinky.webdriverio.WebdriverIO.SizeParam
import typingsSlinky.webdriverio.WebdriverIO.WaitForOptions
...
trait ElementAsync extends js.Object {
  ...
  @JSName("$")
  def $(selector: String): js.Promise[typingsSlinky.webdriverio.WebdriverIOAsync.Element] = js.native
  @JSName("$")
  def $(selector: js.Function): js.Promise[typingsSlinky.webdriverio.WebdriverIOAsync.Element] = js.native
  @JSName("$$")
  def DollarDollar(selector: String): js.Promise[typingsSlinky.webdriverio.WebdriverIOAsync.ElementArray] = js.native
  @JSName("$$")
  def DollarDollar(selector: js.Function): js.Promise[typingsSlinky.webdriverio.WebdriverIOAsync.ElementArray] = js.native
  def addValue(
