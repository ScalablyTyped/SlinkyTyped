...
object WebdriverIO extends js.Object {
  ...
  - typingsSlinky.webdriver.WebDriver.BaseClient because var conflicts: capabilities, isAndroid, isIOS, isMobile, sessionId. Inlined requestedCapabilities */ @js.native
  trait BrowserObject
