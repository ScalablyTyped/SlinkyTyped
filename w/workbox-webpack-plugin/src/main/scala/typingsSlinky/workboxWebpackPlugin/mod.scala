  ...
  */
  ...
  object CommonOptions {
    ...
    implicit class CommonOptionsMutableBuilder[Self <: CommonOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTest(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "test", value.asInstanceOf[js.Any])
  ...
  object RuntimeCacheRule {
    ...
    implicit class RuntimeCacheRuleMutableBuilder[Self <: RuntimeCacheRule] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUrlPattern(value: String | js.RegExp): Self = StObject.set(x, "urlPattern", value.asInstanceOf[js.Any])
