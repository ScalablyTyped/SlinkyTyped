...
object ExtractCommentsObject {
  ...
  implicit class ExtractCommentsObjectOps[Self <: ExtractCommentsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConditionRegExp(value: js.RegExp): Self = this.set("condition", value.asInstanceOf[js.Any])
    @scala.inline
    def setCondition(value: Boolean | String | js.RegExp | ExtractCommentsFunction): Self = this.set("condition", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCondition: Self = this.set("condition", js.undefined)
    @scala.inline
    def setFilenameFunction1(value: /* file */ String => String): Self = this.set("filename", js.Any.fromFunction1(value))
    @scala.inline
    def setFilenameRegExp(value: js.RegExp): Self = this.set("filename", value.asInstanceOf[js.Any])
    @scala.inline
    def setFilename(value: js.RegExp | FileNameFunction): Self = this.set("filename", value.asInstanceOf[js.Any])
    @scala.inline
