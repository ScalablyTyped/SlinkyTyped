...
object mod {
  ...
  object ExtractCommentsObject {
    ...
    implicit class ExtractCommentsObjectMutableBuilder[Self <: ExtractCommentsObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCondition(value: Boolean | String | js.RegExp | ExtractCommentsFunction): Self = StObject.set(x, "condition", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilename(value: js.RegExp | FileNameFunction): Self = StObject.set(x, "filename", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFilenameFunction1(value: /* file */ String => String): Self = StObject.set(x, "filename", js.Any.fromFunction1(value))
      
      @scala.inline
      def setFilenameRegExp(value: js.RegExp): Self = StObject.set(x, "filename", value.asInstanceOf[js.Any])
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExtractComments(value: Boolean | String | js.RegExp | ExtractCommentsFunction): Self = StObject.set(x, "extractComments", value.asInstanceOf[js.Any])
