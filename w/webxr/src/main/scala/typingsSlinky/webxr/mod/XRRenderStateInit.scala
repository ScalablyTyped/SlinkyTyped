...
trait XRRenderStateInit extends XRRenderState {
  ...
  var layers: js.UndefOr[js.Array[EventTarget]] = js.native
}
object XRRenderStateInit {
  ...
  implicit class XRRenderStateInitMutableBuilder[Self <: XRRenderStateInit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayers(value: js.Array[EventTarget]): Self = StObject.set(x, "layers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLayersUndefined: Self = StObject.set(x, "layers", js.undefined)
    
    @scala.inline
    def setLayersVarargs(value: EventTarget*): Self = StObject.set(x, "layers", js.Array(value :_*))
  }
}
