...
object XRRenderStateInit {
  ...
  implicit class XRRenderStateInitOps[Self <: XRRenderStateInit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayersVarargs(value: EventTarget*): Self = this.set("layers", js.Array(value :_*))
    
    @scala.inline
    def setLayers(value: js.Array[EventTarget]): Self = this.set("layers", value.asInstanceOf[js.Any])
