...
trait XYFocusOptions extends js.Object {
  ...
  /**
    ...
    **/
  var historyRect: js.UndefOr[typingsSlinky.winjs.WinJS.UI.XYFocus.IRect] = js.undefined
  /**
  ...
  /**
    ...
    **/
  var referenceRect: js.UndefOr[typingsSlinky.winjs.WinJS.UI.XYFocus.IRect] = js.undefined
}
...
object XYFocusOptions {
  ...
  def apply(
    ...
    historyRect: typingsSlinky.winjs.WinJS.UI.XYFocus.IRect = null,
    referenceElement: HTMLElement = null,
    referenceRect: typingsSlinky.winjs.WinJS.UI.XYFocus.IRect = null
  ): XYFocusOptions = {
