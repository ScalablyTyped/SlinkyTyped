...
object Fragments extends js.Object {
  ...
  /**
    ...
    **/
  def cache(href: String): typingsSlinky.winjs.WinJS.Promise[_] = js.native
  /**
  ...
  /**
    ...
    **/
  def render(href: String): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def render(href: String, element: org.scalajs.dom.raw.HTMLElement): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    ...
    **/
  def renderCopy(href: String): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def renderCopy(href: String, target: org.scalajs.dom.raw.HTMLElement): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def renderCopy(href: HTMLElement): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def renderCopy(href: HTMLElement, target: org.scalajs.dom.raw.HTMLElement): typingsSlinky.winjs.WinJS.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
}
