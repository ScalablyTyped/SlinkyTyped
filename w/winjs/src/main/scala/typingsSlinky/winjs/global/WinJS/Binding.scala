...
object Binding {
  ...
  object List {
    ...
    /**
      ...
      **/
    /* static member */
    @JSGlobal("WinJS.Binding.List.supportedForProcessing")
    @js.native
  ...
  object Template {
    ...
    /**
      ...
      **/
    /* static member */
    @JSGlobal("WinJS.Binding.Template.isDeclarativeControlContainer")
    @js.native
    ...
    /**
      ...
      **/
    /* static member */
    @JSGlobal("WinJS.Binding.Template.supportedForProcessing")
    @js.native
    def supportedForProcessing: Boolean = js.native
    @scala.inline
    def supportedForProcessing_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("supportedForProcessing")(x.asInstanceOf[js.Any])
  ...
  object dynamicObservableMixin {
    ...
    @js.native
    def notify_(name: String, newValue: String, oldValue: String): typingsSlinky.winjs.WinJS.Promise[_] = js.native
  ...
  object observableMixin {
    ...
    @js.native
    def notify_(name: String, newValue: js.Any, oldValue: js.Any): typingsSlinky.winjs.WinJS.Promise[_] = js.native
