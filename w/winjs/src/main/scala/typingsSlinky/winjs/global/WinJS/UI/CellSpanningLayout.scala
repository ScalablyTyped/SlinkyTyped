...
import typingsSlinky.winjs.WinJS.UI.ILayoutSite2
...
class CellSpanningLayout ()
  extends typingsSlinky.winjs.WinJS.UI.CellSpanningLayout {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var groupHeaderPosition: typingsSlinky.winjs.WinJS.UI.HeaderPosition = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override var orientation: typingsSlinky.winjs.WinJS.UI.Orientation = js.native
