...
import typingsSlinky.winjs.anon.Empty
...
object Resources extends js.Object {
  ...
  /**
    ...
    **/
  def oncontextchanged(eventInfo: CustomEvent): Unit = js.native
  ...
  def processAll(rootElement: HTMLElement): typingsSlinky.winjs.WinJS.Promise[Unit] = js.native
