...
package object UI {
  ...
  ): typingsSlinky.winjs.WinJS.UI.IListGroupDataSource[T] = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("computeDataSourceGroups")(listDataSource.asInstanceOf[js.Any], groupKey.asInstanceOf[js.Any], groupData.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.winjs.WinJS.UI.IListGroupDataSource[T]]
  @scala.inline
  def computeDataSourceGroups[T](
    listDataSource: typingsSlinky.winjs.WinJS.UI.IListDataSource[T],
    groupKey: js.Function,
  ...
  /**
    ...
    **/
  @scala.inline
  def disableAnimations(): scala.Unit = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("disableAnimations")().asInstanceOf[scala.Unit]
  ...
  /**
    ...
    **/
  @scala.inline
  def enableAnimations(): scala.Unit = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("enableAnimations")().asInstanceOf[scala.Unit]
  ...
  /**
    ...
    **/
  @scala.inline
  def eventHandler(handler: js.Any): js.Any = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("eventHandler")(handler.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  ): typingsSlinky.winjs.WinJS.Promise[typingsSlinky.winjs.WinJS.UI.IItem[U]] = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("getItemsFromRanges")(dataSource.asInstanceOf[js.Any], ranges.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.winjs.WinJS.Promise[typingsSlinky.winjs.WinJS.UI.IItem[U]]]
  ...
  /**
    ...
    **/
  @scala.inline
  def isAnimationEnabled(): scala.Boolean = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("isAnimationEnabled")().asInstanceOf[scala.Boolean]
  
  /**
    * * This API supports the WinJS infrastructure and is not intended to be used directly from your code.
    **/
  @scala.inline
  def optionsParser(value: java.lang.String): js.Any = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  @scala.inline
  def optionsParser(value: java.lang.String, context: js.UndefOr[scala.Nothing], functionContext: js.Any): js.Any = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def optionsParser(value: java.lang.String, context: js.Any): js.Any = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def optionsParser(value: java.lang.String, context: js.Any, functionContext: js.Any): js.Any = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    **/
  @scala.inline
  def process(element: typingsSlinky.winjs.Element): typingsSlinky.winjs.WinJS.Promise[_] = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("process")(element.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.winjs.WinJS.Promise[_]]
  ...
  /**
    ...
    **/
  @scala.inline
  def processAll(): typingsSlinky.winjs.WinJS.Promise[_] = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")().asInstanceOf[typingsSlinky.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: js.UndefOr[scala.Nothing], skipRoot: scala.Boolean): typingsSlinky.winjs.WinJS.Promise[_] = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: typingsSlinky.winjs.Element): typingsSlinky.winjs.WinJS.Promise[_] = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: typingsSlinky.winjs.Element, skipRoot: scala.Boolean): typingsSlinky.winjs.WinJS.Promise[_] = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typingsSlinky.winjs.WinJS.Promise[_]]
  ...
  /**
    ...
    **/
  @scala.inline
  def scopedSelect(selector: java.lang.String, element: org.scalajs.dom.raw.HTMLElement): org.scalajs.dom.raw.HTMLElement = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("scopedSelect")(selector.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.raw.HTMLElement]
  ...
  /**
    ...
    **/
  @scala.inline
  def setOptions(control: js.Any): scala.Unit = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("setOptions")(control.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  @scala.inline
  def setOptions(control: js.Any, options: js.Any): scala.Unit = (typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("setOptions")(control.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  
  /**
    * This API supports the WinJS infrastructure and is not intended to be used directly from your code.
    **/
  @scala.inline
  def simpleItemRenderer(fn: js.Function): js.Function = typingsSlinky.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("simpleItemRenderer")(fn.asInstanceOf[js.Any]).asInstanceOf[js.Function]
}
