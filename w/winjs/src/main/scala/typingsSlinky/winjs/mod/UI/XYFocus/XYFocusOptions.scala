...
object XYFocusOptions {
  ...
  implicit class XYFocusOptionsOps[Self <: XYFocusOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHistoryRect(value: typingsSlinky.winjs.WinJS.UI.XYFocus.IRect): Self = this.set("historyRect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReferenceRect(value: typingsSlinky.winjs.WinJS.UI.XYFocus.IRect): Self = this.set("referenceRect", value.asInstanceOf[js.Any])
