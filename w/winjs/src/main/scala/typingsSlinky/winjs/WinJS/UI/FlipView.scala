...
trait FlipView[T] extends StObject {
  ...
  /**
    ...
    **/
  def onpagecompleted(eventInfo: CustomEvent): Unit = js.native
  
  /**
    * Raised when the FlipView flips to a page.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.source.
    **/
  def onpageselected(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onpagevisibilitychanged(eventInfo: CustomEvent): Unit = js.native
