...
object ILayout2 {
  ...
  implicit class ILayout2Ops[Self <: ILayout2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDragOver(value: (Double, Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dragOver")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withHitTest(value: (Double, Double) => js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLayout(value: (js.Any, js.Any, js.Any, js.Any) => js.Any): Self = {
        val ret = this.duplicate
