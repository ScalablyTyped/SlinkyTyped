...
object IZoomableView {
  ...
  @scala.inline
  implicit class IZoomableViewOps[Self[t] <: IZoomableView[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    def duplicate: Self[T] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[T]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self[T] with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self[T] with Other]
    @scala.inline
    def withBeginZoom(value: () => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("beginZoom")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withConfigureForZoom(value: (Boolean, Boolean, js.Function, Double) => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configureForZoom")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withEndZoom(value: Boolean => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endZoom")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetPanAxis(value: () => String): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPanAxis")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withHandlePointer(value: String => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handlePointer")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPositionItem(value: (T, IPosition) => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("positionItem")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSetCurrentItem(value: (Double, Double) => Unit): Self[T] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setCurrentItem")(js.Any.fromFunction2(value))
        ret
    }
  }
