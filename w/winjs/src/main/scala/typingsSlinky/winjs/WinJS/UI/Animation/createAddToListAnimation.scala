package typingsSlinky.winjs.WinJS.UI.Animation
...
@js.native
object createAddToListAnimation extends js.Object {
  //#region Functions
  /**
    ...
    **/
  def apply(added: js.Any, affected: js.Any): IAnimationMethodResponse = js.native
}
