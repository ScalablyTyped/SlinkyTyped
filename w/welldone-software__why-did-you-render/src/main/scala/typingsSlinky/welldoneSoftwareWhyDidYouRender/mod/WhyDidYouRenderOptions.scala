package typingsSlinky.welldoneSoftwareWhyDidYouRender.mod
...
object WhyDidYouRenderOptions {
  ...
  implicit class WhyDidYouRenderOptionsOps[Self <: WhyDidYouRenderOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludeVarargs(value: js.RegExp*): Self = this.set("exclude", js.Array(value :_*))
    @scala.inline
    def setExclude(value: js.Array[js.RegExp]): Self = this.set("exclude", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIncludeVarargs(value: js.RegExp*): Self = this.set("include", js.Array(value :_*))
    @scala.inline
    def setInclude(value: js.Array[js.RegExp]): Self = this.set("include", value.asInstanceOf[js.Any])
    @scala.inline
