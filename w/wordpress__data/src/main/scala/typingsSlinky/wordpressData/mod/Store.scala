...
object Store {
  @scala.inline
  def apply[S, /* <: typingsSlinky.redux.mod.AnyAction */ A](
    dispatch: A => A,
    getState: () => S,
  ...
  @scala.inline
  implicit class StoreOps[Self <: Store[_, _], S, /* <: typingsSlinky.redux.mod.AnyAction */ A] (val x: Self with (Store[S, A])) extends AnyVal {
    @scala.inline
