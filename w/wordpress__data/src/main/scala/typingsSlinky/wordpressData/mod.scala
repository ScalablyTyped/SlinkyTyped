...
import typingsSlinky.wordpressData.anon.FnCall
import typingsSlinky.wordpressData.anon.PartialDataRegistry
...
object mod {
  ...
  @js.native
  val RegistryConsumer: ReactComponentClass[ConsumerProps[DataRegistry]] = js.native
  
  @JSImport("@wordpress/data", "RegistryProvider")
  @js.native
  val RegistryProvider: ReactComponentClass[ProviderProps[DataRegistry]] = js.native
  ...
  @js.native
  def withRegistry[P](component: ReactComponentClass[P]): ReactComponentClass[P with Registry] = js.native
