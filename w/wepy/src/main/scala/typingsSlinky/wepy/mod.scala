...
import typingsSlinky.wepy.appMod.default
...
object mod {
  ...
  object default extends Shortcut {
    ...
    @js.native
    class app ()
      extends typingsSlinky.wepy.appMod.default
    ...
    class event protected ()
      extends typingsSlinky.wepy.eventMod.default {
    ...
    @js.native
    class mixin ()
      extends typingsSlinky.wepy.mixinMod.default
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("wepy", "default.page")
    @js.native
    class page ()
      extends typingsSlinky.wepy.pageMod.default
