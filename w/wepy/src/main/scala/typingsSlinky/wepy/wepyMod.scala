...
import typingsSlinky.wepy.wepyMod.App
import typingsSlinky.wepy.wepyMod.Component
import typingsSlinky.wepy.wepyMod.DefaultExport
import typingsSlinky.wepy.wepyMod.Event
import typingsSlinky.wepy.wepyMod.Mixin
import typingsSlinky.wepy.wepyMod.Page
import typingsSlinky.wepy.wxUnderscoreEnhancedMod.WxEnhances
...
object wepyMod extends js.Object {
  ...
  trait DefaultExport extends WxEnhances {
    ...
    @JSName("$createApp")
    def $createApp(appClass: AppConstructor, appConfig: AppConfig): typingsSlinky.wepy.appMod.default = js.native
    @JSName("$createPage")
    def $createPage(pageClass: PageConstructor, pagePath: String): typingsSlinky.wepy.pageMod.default = js.native
    @JSName("$createPage")
    def $createPage(pageClass: PageConstructor, pagePath: Boolean): typingsSlinky.wepy.pageMod.default = js.native
    @JSName("$extend")
