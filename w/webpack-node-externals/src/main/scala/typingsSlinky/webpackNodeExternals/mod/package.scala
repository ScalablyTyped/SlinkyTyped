package typingsSlinky.webpackNodeExternals
...
package object mod {
  ...
  type WhitelistOption = java.lang.String | js.RegExp | typingsSlinky.webpackNodeExternals.mod.WhitelistFunctionType
}
