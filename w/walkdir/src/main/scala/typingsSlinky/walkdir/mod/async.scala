...
import typingsSlinky.walkdir.WalkOptionsreturnobjectbo
import typingsSlinky.walkdir.WalkOptionsreturnobjectfa
import typingsSlinky.walkdir.WalkOptionsreturnobjecttr
