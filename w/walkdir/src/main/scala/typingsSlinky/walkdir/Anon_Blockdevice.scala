...
import typingsSlinky.walkdir.walkdirStrings.blockdevice
import typingsSlinky.walkdir.walkdirStrings.characterdevice
import typingsSlinky.walkdir.walkdirStrings.directory
import typingsSlinky.walkdir.walkdirStrings.empty
import typingsSlinky.walkdir.walkdirStrings.error
import typingsSlinky.walkdir.walkdirStrings.fail
import typingsSlinky.walkdir.walkdirStrings.fifo
import typingsSlinky.walkdir.walkdirStrings.file
import typingsSlinky.walkdir.walkdirStrings.link
import typingsSlinky.walkdir.walkdirStrings.path
import typingsSlinky.walkdir.walkdirStrings.socket
import typingsSlinky.walkdir.walkdirStrings.targetdirectory
...
trait Anon_Blockdevice extends js.Object {
  ...
  /**
    ...
    */
  @JSName("on")
  def on_error(event: error, listener: js.Function1[/* error */ js.Error, Unit]): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias walkdir.walkdir/walkdir.WalkEmitter */ js.Object = js.native
  /**
    *  emitted when there is an error from the filesystem reading as nested path.
    */
  @JSName("on")
  def on_fail(event: fail, listener: js.Function2[/* path */ String, /* error */ js.Error, Unit]): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias walkdir.walkdir/walkdir.WalkEmitter */ js.Object = js.native
  /**
    * found a fifo
    */
  @JSName("on")
