...
trait Anon_Blockdevice extends js.Object {
  ...
  /**
    ...
    */
  @JSName("on")
  def on_error(event: error, listener: js.Function1[/* error */ js.Error, Unit]): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias walkdir.walkdir/walkdir.WalkEmitter */ js.Object = js.native
  /**
    *  emitted when there is an error from the filesystem reading as nested path.
    */
  @JSName("on")
  def on_fail(event: fail, listener: js.Function2[/* path */ String, /* error */ js.Error, Unit]): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias walkdir.walkdir/walkdir.WalkEmitter */ js.Object = js.native
  /**
    * found a fifo
    */
  @JSName("on")
