...
import typingsSlinky.walkdir.walkdirBooleans.`true`
...
trait synctruereturnobjectfalse extends js.Object {
  ...
  /**
    ...
    */
  var return_object: js.UndefOr[`false` with Boolean] = js.native
  /**
    * make this syncronous. the same as calling walkdir.sync
    */
  var sync: js.UndefOr[`true` with Boolean] = js.native
  /**
...
object synctruereturnobjectfalse {
  @scala.inline
  def apply(): synctruereturnobjectfalse = {
  ...
  implicit class synctruereturnobjectfalseOps[Self <: synctruereturnobjectfalse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReturn_object(value: `false` with Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSync(value: `true` with Boolean): Self = {
        val ret = this.duplicate
