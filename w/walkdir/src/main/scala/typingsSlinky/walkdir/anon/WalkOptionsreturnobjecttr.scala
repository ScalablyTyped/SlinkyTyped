...
@js.native
trait WalkOptionsreturnobjecttr extends js.Object {
  /**
...
object WalkOptionsreturnobjecttr {
  ...
  @scala.inline
  implicit class WalkOptionsreturnobjecttrOps[Self <: WalkOptionsreturnobjecttr] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturn_object(value: js.UndefOr[Boolean] with `true`): Self = this.set("return_object", value.asInstanceOf[js.Any])
    @scala.inline
    def setFilter(
