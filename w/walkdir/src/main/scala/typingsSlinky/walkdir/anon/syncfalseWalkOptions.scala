...
trait syncfalseWalkOptions extends js.Object {
  ...
  /**
    ...
    */
  var sync: js.UndefOr[`false` with Boolean] = js.native
  /**
...
object syncfalseWalkOptions {
  @scala.inline
  def apply(): syncfalseWalkOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[syncfalseWalkOptions]
  }
  @scala.inline
  implicit class syncfalseWalkOptionsOps[Self <: syncfalseWalkOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withReturn_object(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSync(value: `false` with Boolean): Self = {
        val ret = this.duplicate
