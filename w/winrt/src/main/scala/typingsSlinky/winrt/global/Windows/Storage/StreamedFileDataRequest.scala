...
class StreamedFileDataRequest ()
  extends typingsSlinky.winrt.Windows.Storage.StreamedFileDataRequest {
  /* CompleteClass */
  override def close(): Unit = js.native
  /* CompleteClass */
  override def dispose(): Unit = js.native
  /* CompleteClass */
  override def failAndClose(failureMode: typingsSlinky.winrt.Windows.Storage.StreamedFileFailureMode): Unit = js.native
  /* CompleteClass */
