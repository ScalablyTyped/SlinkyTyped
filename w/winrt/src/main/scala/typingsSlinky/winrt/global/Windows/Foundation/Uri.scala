...
class Uri protected ()
  ...
  /* CompleteClass */
  override var queryParsed: typingsSlinky.winrt.Windows.Foundation.WwwFormUrlDecoder = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def combineUri(relativeUri: String): typingsSlinky.winrt.Windows.Foundation.Uri = js.native
  /* CompleteClass */
  override def equals(pUri: typingsSlinky.winrt.Windows.Foundation.Uri): Boolean = js.native
}
