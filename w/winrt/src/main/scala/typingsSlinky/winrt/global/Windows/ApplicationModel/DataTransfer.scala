...
object DataTransfer {
  ...
  class DataPackageView ()
    extends typingsSlinky.winrt.Windows.ApplicationModel.DataTransfer.DataPackageView
  
  @JSGlobal("Windows.ApplicationModel.DataTransfer.DataProviderDeferral")
  @js.native
  class DataProviderDeferral ()
    extends typingsSlinky.winrt.Windows.ApplicationModel.DataTransfer.DataProviderDeferral
  
  @JSGlobal("Windows.ApplicationModel.DataTransfer.DataProviderRequest")
  @js.native
  class DataProviderRequest ()
    extends typingsSlinky.winrt.Windows.ApplicationModel.DataTransfer.DataProviderRequest
  ...
  class DataRequestDeferral ()
    extends typingsSlinky.winrt.Windows.ApplicationModel.DataTransfer.DataRequestDeferral
  ...
  class TargetApplicationChosenEventArgs ()
    extends typingsSlinky.winrt.Windows.ApplicationModel.DataTransfer.TargetApplicationChosenEventArgs
}
