...
object WebUI {
  ...
  class ActivatedDeferral ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.ActivatedDeferral
  
  @JSGlobal("Windows.UI.WebUI.ActivatedOperation")
  @js.native
  class ActivatedOperation ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.ActivatedOperation
  
  @JSGlobal("Windows.UI.WebUI.SuspendingDeferral")
  @js.native
  class SuspendingDeferral ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.SuspendingDeferral
  
  @JSGlobal("Windows.UI.WebUI.SuspendingEventArgs")
  @js.native
  class SuspendingEventArgs ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.SuspendingEventArgs
  
  @JSGlobal("Windows.UI.WebUI.SuspendingOperation")
  @js.native
  class SuspendingOperation ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.SuspendingOperation
  
  @JSGlobal("Windows.UI.WebUI.WebUIApplication")
  @js.native
  class WebUIApplication ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.WebUIApplication
  /* static members */
  ...
  class WebUIDeviceActivatedEventArgs ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.WebUIDeviceActivatedEventArgs
  ...
  class WebUIProtocolActivatedEventArgs ()
    extends typingsSlinky.winrt.Windows.UI.WebUI.WebUIProtocolActivatedEventArgs
