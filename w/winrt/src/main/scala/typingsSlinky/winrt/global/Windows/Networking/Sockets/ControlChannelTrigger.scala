...
class ControlChannelTrigger protected ()
  ...
  def this(
    ...
    resourceRequestType: typingsSlinky.winrt.Windows.Networking.Sockets.ControlChannelTriggerResourceType
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def waitForPushEnabled(): typingsSlinky.winrt.Windows.Networking.Sockets.ControlChannelTriggerStatus = js.native
}
