...
object Core {
  ...
  object CoreApplication {
    ...
    @js.native
    def mainView: typingsSlinky.winrt.Windows.ApplicationModel.Core.CoreApplicationView = js.native
    @scala.inline
    def mainView_=(x: typingsSlinky.winrt.Windows.ApplicationModel.Core.CoreApplicationView): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("mainView")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def views: IVectorView[typingsSlinky.winrt.Windows.ApplicationModel.Core.CoreApplicationView] = js.native
    @scala.inline
    def views_=(x: IVectorView[typingsSlinky.winrt.Windows.ApplicationModel.Core.CoreApplicationView]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("views")(x.asInstanceOf[js.Any])
  }
