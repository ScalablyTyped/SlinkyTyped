...
object IScheduledTileNotificationFactory {
  ...
  implicit class IScheduledTileNotificationFactoryOps[Self <: IScheduledTileNotificationFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateScheduledTileNotification(value: (XmlDocument, js.Date) => ScheduledTileNotification): Self = this.set("createScheduledTileNotification", js.Any.fromFunction2(value))
  }
}
