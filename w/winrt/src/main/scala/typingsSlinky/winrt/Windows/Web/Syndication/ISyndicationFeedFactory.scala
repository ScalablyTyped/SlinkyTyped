...
object ISyndicationFeedFactory {
  ...
  implicit class ISyndicationFeedFactoryOps[Self <: ISyndicationFeedFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateSyndicationFeed(value: (String, String, Uri) => SyndicationFeed): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSyndicationFeed")(js.Any.fromFunction3(value))
        ret
    }
  }
