...
object AsyncStatus extends js.Object {
  ...
  /* 0 */ val canceled: typingsSlinky.winrt.Windows.Foundation.AsyncStatus.canceled with Double = js.native
  /* 1 */ val completed: typingsSlinky.winrt.Windows.Foundation.AsyncStatus.completed with Double = js.native
  /* 2 */ val error: typingsSlinky.winrt.Windows.Foundation.AsyncStatus.error with Double = js.native
  /* 3 */ val started: typingsSlinky.winrt.Windows.Foundation.AsyncStatus.started with Double = js.native
  @JSBracketAccess
