...
object PrintColorMode extends js.Object {
  ...
  /* 5 */ val monochrome: typingsSlinky.winrt.Windows.Graphics.Printing.PrintColorMode.monochrome with Double = js.native
  /* 1 */ val notAvailable: typingsSlinky.winrt.Windows.Graphics.Printing.PrintColorMode.notAvailable with Double = js.native
  /* 2 */ val printerCustom: typingsSlinky.winrt.Windows.Graphics.Printing.PrintColorMode.printerCustom with Double = js.native
  @JSBracketAccess
