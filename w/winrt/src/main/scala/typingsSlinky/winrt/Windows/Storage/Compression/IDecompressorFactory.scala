...
object IDecompressorFactory {
  ...
  implicit class IDecompressorFactoryOps[Self <: IDecompressorFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateDecompressor(value: IInputStream => Decompressor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createDecompressor")(js.Any.fromFunction1(value))
        ret
    }
  }
