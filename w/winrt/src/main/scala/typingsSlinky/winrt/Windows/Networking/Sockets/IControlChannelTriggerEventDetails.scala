...
object IControlChannelTriggerEventDetails {
  ...
  implicit class IControlChannelTriggerEventDetailsOps[Self <: IControlChannelTriggerEventDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControlChannelTrigger(value: ControlChannelTrigger): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("controlChannelTrigger")(value.asInstanceOf[js.Any])
        ret
    }
  }
