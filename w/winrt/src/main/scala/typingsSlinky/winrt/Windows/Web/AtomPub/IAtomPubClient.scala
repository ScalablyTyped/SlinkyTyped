...
import typingsSlinky.winrt.Windows.Web.Syndication.ISyndicationClient
...
object IAtomPubClient {
  ...
  implicit class IAtomPubClientOps[Self <: IAtomPubClient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeleteResourceAsync(value: Uri => IAsyncActionWithProgress[TransferProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteResourceAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDeleteResourceItemAsync(value: SyndicationItem => IAsyncActionWithProgress[TransferProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteResourceItemAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRetrieveMediaResourceAsync(value: Uri => IAsyncOperationWithProgress[IInputStream, RetrievalProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("retrieveMediaResourceAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRetrieveResourceAsync(value: Uri => IAsyncOperationWithProgress[SyndicationItem, RetrievalProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("retrieveResourceAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRetrieveServiceDocumentAsync(value: Uri => IAsyncOperationWithProgress[ServiceDocument, RetrievalProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("retrieveServiceDocumentAsync")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdateMediaResourceAsync(value: (Uri, String, IInputStream) => IAsyncActionWithProgress[TransferProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateMediaResourceAsync")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withUpdateResourceAsync(value: (Uri, SyndicationItem) => IAsyncActionWithProgress[TransferProgress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateResourceAsync")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUpdateResourceItemAsync(value: SyndicationItem => IAsyncActionWithProgress[TransferProgress]): Self = {
        val ret = this.duplicate
