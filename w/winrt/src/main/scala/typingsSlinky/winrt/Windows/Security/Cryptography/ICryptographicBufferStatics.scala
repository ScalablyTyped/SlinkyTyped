...
object ICryptographicBufferStatics {
  ...
  implicit class ICryptographicBufferStaticsOps[Self <: ICryptographicBufferStatics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopyToByteArray(value: IBuffer => js.typedarray.Uint8Array): Self = this.set("copyToByteArray", js.Any.fromFunction1(value))
    
    @scala.inline
    def setCreateFromByteArray(value: js.typedarray.Uint8Array => IBuffer): Self = this.set("createFromByteArray", js.Any.fromFunction1(value))
