...
object IResourceLoaderFactory {
  ...
  implicit class IResourceLoaderFactoryOps[Self <: IResourceLoaderFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateResourceLoaderByName(value: String => ResourceLoader): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createResourceLoaderByName")(js.Any.fromFunction1(value))
        ret
    }
  }
