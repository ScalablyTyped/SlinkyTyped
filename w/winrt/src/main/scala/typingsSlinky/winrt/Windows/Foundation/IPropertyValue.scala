...
trait IPropertyValue extends js.Object {
  ...
  def getDoubleArray(): scala.scalajs.js.typedarray.Float64Array
  def getGuid(): String
  def getGuidArray(): js.Array[String]
  def getInspectableArray(): js.Array[_]
  def getInt16(): Double
  def getInt16Array(): scala.scalajs.js.typedarray.Int16Array
  def getInt32(): Double
  def getInt32Array(): scala.scalajs.js.typedarray.Int32Array
  def getInt64(): Double
  ...
  def getSingleArray(): scala.scalajs.js.typedarray.Float32Array
  def getSize(): Size
  ...
  def getUInt16Array(): scala.scalajs.js.typedarray.Uint16Array
  def getUInt32(): Double
  def getUInt32Array(): scala.scalajs.js.typedarray.Uint32Array
  def getUInt64(): Double
  def getUInt64Array(): js.Array[Double]
  def getUInt8(): Double
  def getUInt8Array(): scala.scalajs.js.typedarray.Uint8Array
}
