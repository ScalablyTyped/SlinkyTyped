...
object IPropertyValue {
  ...
  implicit class IPropertyValueMutableBuilder[Self <: IPropertyValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetDateTime(value: () => js.Date): Self = StObject.set(x, "getDateTime", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetDateTimeArray(value: () => js.Array[js.Date]): Self = StObject.set(x, "getDateTimeArray", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetDouble(value: () => Double): Self = StObject.set(x, "getDouble", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetDoubleArray(value: () => js.typedarray.Float64Array): Self = StObject.set(x, "getDoubleArray", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetInt16Array(value: () => js.typedarray.Int16Array): Self = StObject.set(x, "getInt16Array", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetInt32(value: () => Double): Self = StObject.set(x, "getInt32", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetInt32Array(value: () => js.typedarray.Int32Array): Self = StObject.set(x, "getInt32Array", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetSingleArray(value: () => js.typedarray.Float32Array): Self = StObject.set(x, "getSingleArray", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetUInt16Array(value: () => js.typedarray.Uint16Array): Self = StObject.set(x, "getUInt16Array", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetUInt32(value: () => Double): Self = StObject.set(x, "getUInt32", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetUInt32Array(value: () => js.typedarray.Uint32Array): Self = StObject.set(x, "getUInt32Array", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetUInt8Array(value: () => js.typedarray.Uint8Array): Self = StObject.set(x, "getUInt8Array", js.Any.fromFunction0(value))
