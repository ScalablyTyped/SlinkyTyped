...
object IPropertyValue {
  ...
  implicit class IPropertyValueOps[Self <: IPropertyValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetDateTime(value: () => js.Date): Self = this.set("getDateTime", js.Any.fromFunction0(value))
    @scala.inline
    def setGetDateTimeArray(value: () => js.Array[js.Date]): Self = this.set("getDateTimeArray", js.Any.fromFunction0(value))
    @scala.inline
    def setGetDouble(value: () => Double): Self = this.set("getDouble", js.Any.fromFunction0(value))
    @scala.inline
    def setGetDoubleArray(value: () => js.typedarray.Float64Array): Self = this.set("getDoubleArray", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetInt16Array(value: () => js.typedarray.Int16Array): Self = this.set("getInt16Array", js.Any.fromFunction0(value))
    @scala.inline
    def setGetInt32(value: () => Double): Self = this.set("getInt32", js.Any.fromFunction0(value))
    @scala.inline
    def setGetInt32Array(value: () => js.typedarray.Int32Array): Self = this.set("getInt32Array", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetSingleArray(value: () => js.typedarray.Float32Array): Self = this.set("getSingleArray", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetUInt16Array(value: () => js.typedarray.Uint16Array): Self = this.set("getUInt16Array", js.Any.fromFunction0(value))
    @scala.inline
    def setGetUInt32(value: () => Double): Self = this.set("getUInt32", js.Any.fromFunction0(value))
    @scala.inline
    def setGetUInt32Array(value: () => js.typedarray.Uint32Array): Self = this.set("getUInt32Array", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setGetUInt8Array(value: () => js.typedarray.Uint8Array): Self = this.set("getUInt8Array", js.Any.fromFunction0(value))
    @scala.inline
