...
object IWindowActivatedEventArgs {
  ...
  implicit class IWindowActivatedEventArgsOps[Self <: IWindowActivatedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWindowActivationState(value: CoreWindowActivationState): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowActivationState")(value.asInstanceOf[js.Any])
        ret
    }
  }
