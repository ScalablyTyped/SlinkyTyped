...
object `8` {
  ...
  implicit class `8Ops`[Self <: `8`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: StorageFile*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[StorageFile]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
