...
import typingsSlinky.when.When._underscore.NodeFn0
import typingsSlinky.when.When._underscore.NodeFn1
import typingsSlinky.when.When._underscore.NodeFn2
import typingsSlinky.when.When._underscore.NodeFn3
import typingsSlinky.when.When._underscore.NodeFn4
import typingsSlinky.when.When._underscore.NodeFn5
