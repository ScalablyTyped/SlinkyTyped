...
object AnonBufferUsageReportingInterval {
  @scala.inline
  def apply(): AnonBufferUsageReportingInterval = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBufferUsageReportingInterval]
  }
  @scala.inline
  implicit class AnonBufferUsageReportingIntervalOps[Self <: AnonBufferUsageReportingInterval] (val x: Self) extends AnyVal {
    @scala.inline
