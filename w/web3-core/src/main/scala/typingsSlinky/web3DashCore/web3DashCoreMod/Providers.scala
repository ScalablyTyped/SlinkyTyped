...
trait Providers extends js.Object {
  var HttpProvider: Instantiable2[
    ...
    typingsSlinky.web3DashCore.web3DashCoreMod.HttpProvider
  ]
  var IpcProvider: Instantiable2[
    /* path */ String, 
    /* net */ js.Any, 
    typingsSlinky.web3DashCore.web3DashCoreMod.IpcProvider
  ]
  var WebsocketProvider: Instantiable2[
    /* host */ String, 
    js.UndefOr[/* options */ WebsocketProviderOptions], 
    typingsSlinky.web3DashCore.web3DashCoreMod.WebsocketProvider
  ]
}
