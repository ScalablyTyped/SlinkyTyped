...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.web3Core.web3CoreStrings.mainnet
  - typingsSlinky.web3Core.web3CoreStrings.goerli
  - typingsSlinky.web3Core.web3CoreStrings.kovan
  - typingsSlinky.web3Core.web3CoreStrings.rinkeby
  - typingsSlinky.web3Core.web3CoreStrings.ropsten
*/
