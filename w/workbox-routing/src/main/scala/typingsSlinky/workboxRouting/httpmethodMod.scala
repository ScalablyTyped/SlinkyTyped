...
object httpmethodMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.workboxRouting.workboxRoutingStrings.DELETE
    - typingsSlinky.workboxRouting.workboxRoutingStrings.GET
    - typingsSlinky.workboxRouting.workboxRoutingStrings.HEAD
    - typingsSlinky.workboxRouting.workboxRoutingStrings.PATCH
    - typingsSlinky.workboxRouting.workboxRoutingStrings.POST
    - typingsSlinky.workboxRouting.workboxRoutingStrings.PUT
  */
