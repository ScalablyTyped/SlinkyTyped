package typingsSlinky.wordpressCustomizeBrowser.controlConstructorMod

import org.scalablytyped.runtime.Instantiable0
import typingsSlinky.wordpressCustomizeBrowser.backgroundControlMod.BackgroundControl
import typingsSlinky.wordpressCustomizeBrowser.backgroundPositionControlMod.BackgroundPositionControl
import typingsSlinky.wordpressCustomizeBrowser.codeEditorControlMod.CodeEditorControl
import typingsSlinky.wordpressCustomizeBrowser.colorControlMod.ColorControl
import typingsSlinky.wordpressCustomizeBrowser.croppedImageControlMod.CroppedImageControl
import typingsSlinky.wordpressCustomizeBrowser.dateTimeControlMod.DateTimeControl
import typingsSlinky.wordpressCustomizeBrowser.headerControlMod.HeaderControl
import typingsSlinky.wordpressCustomizeBrowser.imageControlMod.ImageControl
import typingsSlinky.wordpressCustomizeBrowser.mediaControlMod.MediaControl
import typingsSlinky.wordpressCustomizeBrowser.siteIconControlMod.SiteIconControl
import typingsSlinky.wordpressCustomizeBrowser.themeControlMod.ThemeControl
import typingsSlinky.wordpressCustomizeBrowser.uploadControlMod.UploadControl
