...
import typingsSlinky.webpackBundleAnalyzer.webpackBundleAnalyzerStrings.json
      ...
      */
      ...
      object ToJsonOptionsObject {
        ...
        implicit class ToJsonOptionsObjectMutableBuilder[Self <: ToJsonOptionsObject] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setExcludeAssetsVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = StObject.set(x, "excludeAssets", js.Array(value :_*))
          ...
          @scala.inline
          def setExcludeModulesVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = StObject.set(x, "excludeModules", js.Array(value :_*))
          ...
          @scala.inline
          def setExcludeVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = StObject.set(x, "exclude", js.Array(value :_*))
          ...
          @scala.inline
          def setWarningsFilterVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "warningsFilter", js.Array(value :_*))
