package typingsSlinky.webpackBundleAnalyzer.mod.BundleAnalyzerPlugin.Stats
...
object ToJsonOptionsObject {
  ...
  implicit class ToJsonOptionsObjectOps[Self <: ToJsonOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludeVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = this.set("exclude", js.Array(value :_*))
    ...
    @scala.inline
    def setExcludeAssetsVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = this.set("excludeAssets", js.Array(value :_*))
    
    @scala.inline
    def setExcludeAssetsFunction1(value: /* assetName */ String => Boolean): Self = this.set("excludeAssets", js.Any.fromFunction1(value))
    
    @scala.inline
    def setExcludeAssetsRegExp(value: js.RegExp): Self = this.set("excludeAssets", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExcludeModulesVarargs(value: ((js.Function1[/* assetName */ String, Boolean]) | js.RegExp | String)*): Self = this.set("excludeModules", js.Array(value :_*))
    
    @scala.inline
    def setExcludeModulesFunction1(value: /* assetName */ String => Boolean): Self = this.set("excludeModules", js.Any.fromFunction1(value))
    
    @scala.inline
    def setExcludeModulesRegExp(value: js.RegExp): Self = this.set("excludeModules", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWarningsFilterVarargs(value: (String | js.RegExp)*): Self = this.set("warningsFilter", js.Array(value :_*))
    
    @scala.inline
    def setWarningsFilterFunction1(value: /* warning */ String => Boolean): Self = this.set("warningsFilter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setWarningsFilterRegExp(value: js.RegExp): Self = this.set("warningsFilter", value.asInstanceOf[js.Any])
