package typingsSlinky.wonderDotJs.distEs2015StructureViewMod

import org.scalajs.dom.raw.WebGLRenderingContext
import typingsSlinky.wonderDotJs.Anon_X
import typingsSlinky.wonderDotJs.Anon_XY
import typingsSlinky.wonderDotJs.distEs2015CoreDataMainDataMod.ContextConfigData
...
class ViewWebGL protected () extends IView {
  ...
  /* CompleteClass */
  override var offset: Anon_XY = js.native
  @JSName("offset")
  val offset_ViewWebGL: Anon_X = js.native
  /* CompleteClass */
