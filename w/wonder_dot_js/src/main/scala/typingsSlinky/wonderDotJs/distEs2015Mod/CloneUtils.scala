...
@js.native
class CloneUtils ()
  extends typingsSlinky.wonderDotJs.distEs2015DefinitionTypescriptDecoratorCloneMod.CloneUtils
...
object CloneUtils extends js.Object {
  ...
  def isNotClone(entityObject: typingsSlinky.wonderDotJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject): Boolean = js.native
  def markNotClone(entityObject: typingsSlinky.wonderDotJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject): Unit = js.native
}
