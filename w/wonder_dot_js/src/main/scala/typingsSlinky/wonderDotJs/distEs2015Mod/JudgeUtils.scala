...
@js.native
class JudgeUtils ()
  extends typingsSlinky.wonderDotJs.distEs2015UtilsJudgeUtilsMod.JudgeUtils
...
object JudgeUtils extends js.Object {
  ...
  def isComponenet(component: typingsSlinky.wonderDotJs.distEs2015CoreComponentMod.Component): Boolean = js.native
  ...
  def isSelf(
    self: typingsSlinky.wonderDotJs.distEs2015CoreEntityMod.Entity,
    entityObject: typingsSlinky.wonderDotJs.distEs2015CoreEntityMod.Entity
  ): Boolean = js.native
