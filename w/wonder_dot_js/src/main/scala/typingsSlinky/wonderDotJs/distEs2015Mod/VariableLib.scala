...
import typingsSlinky.wonderDotJs.distEs2015RendererShaderVariableVariableLibMod.ShaderVariable
...
@js.native
class VariableLib ()
  extends typingsSlinky.wonderDotJs.distEs2015RendererShaderVariableVariableLibMod.VariableLib
