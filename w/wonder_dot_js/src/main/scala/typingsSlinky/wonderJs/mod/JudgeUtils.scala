...
@js.native
class JudgeUtils ()
  extends typingsSlinky.wonderJs.judgeUtilsMod.JudgeUtils
...
object JudgeUtils extends js.Object {
  ...
  def isComponenet(component: typingsSlinky.wonderJs.componentMod.Component): Boolean = js.native
  ...
  def isSelf(
    self: typingsSlinky.wonderJs.entityMod.Entity,
    entityObject: typingsSlinky.wonderJs.entityMod.Entity
  ): Boolean = js.native
