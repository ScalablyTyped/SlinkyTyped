...
@js.native
class CloneUtils ()
  extends typingsSlinky.wonderJs.cloneMod.CloneUtils
...
object CloneUtils extends js.Object {
  ...
  def isNotClone(entityObject: typingsSlinky.wonderJs.entityObjectMod.EntityObject): Boolean = js.native
  def markNotClone(entityObject: typingsSlinky.wonderJs.entityObjectMod.EntityObject): Unit = js.native
}
