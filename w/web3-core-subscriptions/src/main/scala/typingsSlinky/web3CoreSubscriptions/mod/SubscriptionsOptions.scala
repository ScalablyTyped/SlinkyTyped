...
object SubscriptionsOptions {
  ...
  @scala.inline
  implicit class SubscriptionsOptionsOps[Self <: SubscriptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSubscriptions(value: SubscriptionsModel): Self = this.set("subscriptions", value.asInstanceOf[js.Any])
    @scala.inline
