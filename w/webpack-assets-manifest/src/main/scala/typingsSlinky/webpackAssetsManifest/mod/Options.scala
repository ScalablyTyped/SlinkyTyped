...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileExtRegexRegExp(value: js.RegExp): Self = this.set("fileExtRegex", value.asInstanceOf[js.Any])
    @scala.inline
    def setFileExtRegex(value: js.RegExp | `false`): Self = this.set("fileExtRegex", value.asInstanceOf[js.Any])
    @scala.inline
