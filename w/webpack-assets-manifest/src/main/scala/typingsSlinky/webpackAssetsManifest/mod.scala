...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileExtRegex(value: js.RegExp | `false`): Self = StObject.set(x, "fileExtRegex", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFileExtRegexNull: Self = StObject.set(x, "fileExtRegex", null)
      
      @scala.inline
      def setFileExtRegexRegExp(value: js.RegExp): Self = StObject.set(x, "fileExtRegex", value.asInstanceOf[js.Any])
