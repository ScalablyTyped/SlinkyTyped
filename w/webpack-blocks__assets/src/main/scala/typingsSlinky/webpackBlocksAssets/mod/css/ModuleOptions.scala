...
object ModuleOptions {
  ...
  implicit class ModuleOptionsOps[Self <: ModuleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalIdentRegExpRegExp(value: js.RegExp): Self = this.set("localIdentRegExp", value.asInstanceOf[js.Any])
    @scala.inline
    def setLocalIdentRegExp(value: String | js.RegExp): Self = this.set("localIdentRegExp", value.asInstanceOf[js.Any])
    @scala.inline
