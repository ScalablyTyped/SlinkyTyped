...
object RouteComponentProps {
  @scala.inline
  def apply[/* <: typingsSlinky.wouter.matcherMod.DefaultParams */ T](params: T): RouteComponentProps[T] = {
    val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any])
    __obj.asInstanceOf[RouteComponentProps[T]]
  }
  @scala.inline
  implicit class RouteComponentPropsOps[Self <: RouteComponentProps[_], /* <: typingsSlinky.wouter.matcherMod.DefaultParams */ T] (val x: Self with RouteComponentProps[T]) extends AnyVal {
    @scala.inline
