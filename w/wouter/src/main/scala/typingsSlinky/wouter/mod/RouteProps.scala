...
object RouteProps {
  @scala.inline
  def apply[/* <: typingsSlinky.wouter.matcherMod.DefaultParams */ T](): RouteProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RouteProps[T]]
  }
  @scala.inline
  implicit class RoutePropsOps[Self <: RouteProps[_], /* <: typingsSlinky.wouter.matcherMod.DefaultParams */ T] (val x: Self with RouteProps[T]) extends AnyVal {
    @scala.inline
