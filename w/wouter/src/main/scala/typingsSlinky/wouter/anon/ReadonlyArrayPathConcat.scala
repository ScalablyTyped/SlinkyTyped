...
import typingsSlinky.wouter.wouterNumbers.`1`
...
@js.native
trait ReadonlyArrayPathConcat extends js.Object {
...
object ReadonlyArrayPathConcat {
  ...
  @scala.inline
  implicit class ReadonlyArrayPathConcatOps[Self <: ReadonlyArrayPathConcat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopyWithin(value: (/* target */ Double, /* start */ Double) => ReadonlyArrayPathConcat): Self = this.set("copyWithin", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setFill(value: /* value */ Path => ReadonlyArrayPathConcat): Self = this.set("fill", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSort(value: () => ReadonlyArrayPathConcat): Self = this.set("sort", js.Any.fromFunction0(value))
