...
object RouteComponentProps {
  @scala.inline
  def apply[/* <: typingsSlinky.wouter.preactMatcherMod.DefaultParams */ T](params: T): RouteComponentProps[T] = {
    val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any])
    __obj.asInstanceOf[RouteComponentProps[T]]
  }
  @scala.inline
  implicit class RouteComponentPropsOps[Self <: RouteComponentProps[_], /* <: typingsSlinky.wouter.preactMatcherMod.DefaultParams */ T] (val x: Self with RouteComponentProps[T]) extends AnyVal {
    @scala.inline
