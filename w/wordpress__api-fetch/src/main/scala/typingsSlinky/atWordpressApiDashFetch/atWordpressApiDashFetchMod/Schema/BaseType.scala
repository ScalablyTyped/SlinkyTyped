...
import typingsSlinky.atWordpressApiDashFetch.Anon_Addnew
import typingsSlinky.atWordpressApiDashFetch.Anon_Author
import typingsSlinky.atWordpressApiDashFetch.Anon_Createposts
