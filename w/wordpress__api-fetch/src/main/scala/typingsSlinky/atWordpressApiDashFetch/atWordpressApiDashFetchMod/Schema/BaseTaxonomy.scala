...
import typingsSlinky.atWordpressApiDashFetch.Anon_Addnewitem
import typingsSlinky.atWordpressApiDashFetch.Anon_Assignterms
import typingsSlinky.atWordpressApiDashFetch.Anon_Href
import typingsSlinky.atWordpressApiDashFetch.Anon_Public
