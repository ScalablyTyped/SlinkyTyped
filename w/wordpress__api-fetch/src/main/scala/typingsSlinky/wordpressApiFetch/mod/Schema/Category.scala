...
object Category {
  @scala.inline
  def BaseCategory[/* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T](
  ...
  @scala.inline
  def PickBaseCategoryCategoryCount[/* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T](
    _links: Record[String, js.Array[Dictk]],
    count: Double,
    description: String,
    id: Double,
  ...
  @scala.inline
  def PickBaseCategoryCategory[/* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T](
    _links: Record[String, js.Array[Dictk]],
    id: Double,
    link: String,
    name: String,
