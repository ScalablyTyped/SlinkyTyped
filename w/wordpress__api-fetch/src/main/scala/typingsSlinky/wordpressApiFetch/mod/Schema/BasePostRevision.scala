...
object BasePostRevision {
  ...
  @scala.inline
  implicit class BasePostRevisionOps[Self <: BasePostRevision[_], /* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T] (val x: Self with BasePostRevision[T]) extends AnyVal {
    @scala.inline
