...
object BaseComment {
  @scala.inline
  def apply[/* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T](
  ...
  @scala.inline
  implicit class BaseCommentOps[Self <: BaseComment[_], /* <: typingsSlinky.wordpressApiFetch.mod.Schema.Context */ T] (val x: Self with BaseComment[T]) extends AnyVal {
    @scala.inline
