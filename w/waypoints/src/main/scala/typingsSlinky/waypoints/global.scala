...
import typingsSlinky.waypoints.anon.Adapter
...
object global {
  ...
  object Waypoint {
    ...
    @js.native
    def Adapter: typingsSlinky.waypoints.WaypointAdapter = js.native
    @scala.inline
    def Adapter_=(x: typingsSlinky.waypoints.WaypointAdapter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Adapter")(x.asInstanceOf[js.Any])
    ...
    object Context {
      ...
      @js.native
      def findByElement(element: HTMLElement): js.UndefOr[typingsSlinky.waypoints.WaypointContext] = js.native
    }
