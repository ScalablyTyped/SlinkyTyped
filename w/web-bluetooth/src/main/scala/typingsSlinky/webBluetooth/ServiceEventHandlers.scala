...
trait ServiceEventHandlers extends js.Object {
  def onserviceadded(ev: Event_): js.Any = js.native
  def onservicechanged(ev: Event_): js.Any = js.native
  def onserviceremoved(ev: Event_): js.Any = js.native
}
