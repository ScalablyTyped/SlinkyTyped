...
import typingsSlinky.wordpressComponents.mediaMod.CardMedia.Props
...
@JSImport("@wordpress/components/card/media", JSImport.Namespace)
@js.native
object mediaMod extends js.Object {
  
  @js.native
  object CardMedia extends js.Object {
