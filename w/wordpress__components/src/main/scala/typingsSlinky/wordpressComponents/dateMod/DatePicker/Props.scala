package typingsSlinky.wordpressComponents.dateMod.DatePicker
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsInvalidDate(value: /* date */ js.Date => Boolean): Self = this.set("isInvalidDate", js.Any.fromFunction1(value))
