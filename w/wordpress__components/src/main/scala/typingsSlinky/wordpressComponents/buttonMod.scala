  ...
  object Button {
    ...
    */
    ...
    object Props {
      ...
      @scala.inline
      def AnchorProps(): typingsSlinky.wordpressComponents.buttonMod.Button.AnchorProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.buttonMod.Button.AnchorProps]
      }
      
      @scala.inline
      def ButtonProps(): typingsSlinky.wordpressComponents.buttonMod.Button.ButtonProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.buttonMod.Button.ButtonProps]
      }
    }
  }
}
