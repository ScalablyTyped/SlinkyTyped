  ...
  object Dropdown {
    ...
    object Props {
      ...
      implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setHeaderTitle(value: ReactElement): Self = StObject.set(x, "headerTitle", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setHeaderTitleReactElement(value: ReactElement): Self = StObject.set(x, "headerTitle", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setRenderContent(value: RenderProps => ReactElement): Self = StObject.set(x, "renderContent", js.Any.fromFunction1(value))
        
        @scala.inline
        def setRenderToggle(value: RenderProps => ReactElement): Self = StObject.set(x, "renderToggle", js.Any.fromFunction1(value))
      }
    }
