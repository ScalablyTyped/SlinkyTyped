...
import typingsSlinky.wordpressComponents.mod.ClipboardButton.^
...
object ClipboardButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onCopy(value: () => Unit): this.type = set("onCopy", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def onFinishCopy(value: () => Unit): this.type = set("onFinishCopy", js.Any.fromFunction0(value))
    @scala.inline
