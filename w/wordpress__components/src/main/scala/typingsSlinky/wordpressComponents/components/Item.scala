...
object Item {
  ...
  implicit def make(companion: Item.type): SharedBuilder_Props_1179620027[HTMLDivElement] = new SharedBuilder_Props_1179620027[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
}
