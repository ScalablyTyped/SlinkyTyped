...
import typingsSlinky.wordpressComponents.mod.ExternalLink.^
...
object ExternalLink {
  ...
  def withProps(p: HTMLProps[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
