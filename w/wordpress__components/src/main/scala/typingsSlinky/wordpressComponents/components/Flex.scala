...
object Flex {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def align(value: AlignItemsProperty | top | bottom): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def isReversed(value: Boolean): this.type = set("isReversed", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def justify(value: JustifyContentProperty | left | right): this.type = set("justify", value.asInstanceOf[js.Any])
