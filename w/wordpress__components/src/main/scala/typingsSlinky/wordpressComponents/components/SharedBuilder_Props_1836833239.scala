...
@scala.inline
class SharedBuilder_Props_1836833239[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def cycle(value: Boolean): this.type = set("cycle", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def onNavigate(value: (/* nextIndex */ Double, /* focusedElement */ HTMLElement) => Unit): this.type = set("onNavigate", js.Any.fromFunction2(value))
  @scala.inline
  ...
  @scala.inline
  def orientation(
    value: typingsSlinky.wordpressComponents.wordpressComponentsStrings.vertical | typingsSlinky.wordpressComponents.wordpressComponentsStrings.horizontal | typingsSlinky.wordpressComponents.wordpressComponentsStrings.both
