...
import typingsSlinky.wordpressComponents.mod.Placeholder.^
...
object Placeholder {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def instructions(value: String): this.type = set("instructions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isColumnLayout(value: Boolean): this.type = set("isColumnLayout", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def preview(value: ReactElement): this.type = set("preview", value.asInstanceOf[js.Any])
    @scala.inline
