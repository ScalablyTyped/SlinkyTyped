...
import typingsSlinky.wordpressComponents.anon.Describedby
import typingsSlinky.wordpressComponents.mod.Modal.^
import typingsSlinky.wordpressComponents.modalMod.Modal.Props
...
object Modal {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def aria(value: Describedby): this.type = set("aria", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def closeButtonLabel(value: String): this.type = set("closeButtonLabel", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isDismissable(value: Boolean): this.type = set("isDismissable", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def shouldCloseOnClickOutside(value: Boolean): this.type = set("shouldCloseOnClickOutside", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(onRequestClose: () => Unit, title: String): Builder = {
    val __props = js.Dynamic.literal(onRequestClose = js.Any.fromFunction0(onRequestClose), title = title.asInstanceOf[js.Any])
