...
object IconButton {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def isBusy(value: Boolean): this.type = set("isBusy", value.asInstanceOf[js.Any])
    @scala.inline
    def isDefault(value: Boolean): this.type = set("isDefault", value.asInstanceOf[js.Any])
    @scala.inline
    def isDestructive(value: Boolean): this.type = set("isDestructive", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def isTertiary(value: Boolean): this.type = set("isTertiary", value.asInstanceOf[js.Any])
    @scala.inline
    def isToggled(value: Boolean): this.type = set("isToggled", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(icon: typingsSlinky.wordpressComponents.dashiconMod.Dashicon.Icon | ReactElement): Builder = {
