...
import typingsSlinky.wordpressComponents.footerMod.CardFooter.Props
...
/* The props of this component has an unsupported shape. You can use `set` manually to use it, but with no compiler support :/ . Couldn't find props for typingsSlinky.wordpressComponents.footerMod.CardFooter.Props[
...
object CardFooter {
  ...
  implicit def make(companion: CardFooter.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
