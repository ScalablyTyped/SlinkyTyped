...
import typingsSlinky.wordpressComponents.mod.RangeControl.^
...
object RangeControl {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def afterIcon(value: typingsSlinky.wordpressComponents.dashiconMod.Dashicon.Icon): this.type = set("afterIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def allowFullScreen(value: Boolean): this.type = set("allowFullScreen", value.asInstanceOf[js.Any])
    @scala.inline
    def allowReset(value: Boolean): this.type = set("allowReset", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def beforeIcon(value: typingsSlinky.wordpressComponents.dashiconMod.Dashicon.Icon): this.type = set("beforeIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def initialPosition(value: Double): this.type = set("initialPosition", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  @scala.inline
  def apply(onChange: js.UndefOr[Double] => Unit, value: Double): Builder = {
