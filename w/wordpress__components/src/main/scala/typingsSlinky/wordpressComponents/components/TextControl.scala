...
import typingsSlinky.wordpressComponents.mod.TextControl.^
import typingsSlinky.wordpressComponents.textControlMod.TextControl.Props
...
object TextControl {
  ...
  @scala.inline
  def apply(onChange: String => Unit, value: String | Double): Builder = {
