...
/* The props of this component has an unsupported shape. You can use `set` manually to use it, but with no compiler support :/ . Couldn't find props for typingsSlinky.wordpressComponents.mediaMod.CardMedia.Props[
...
object CardMedia {
  @JSImport("@wordpress/components", "CardMedia")
  @js.native
  ...
  implicit def make(companion: CardMedia.type): Default[tag.type, js.Object] = new Default[tag.type, js.Object](js.Array(this.component, js.Dictionary.empty))()
}
