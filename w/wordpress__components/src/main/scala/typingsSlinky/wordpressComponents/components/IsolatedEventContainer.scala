...
import typingsSlinky.wordpressComponents.mod.IsolatedEventContainer.^
...
object IsolatedEventContainer {
  ...
  def withProps(p: HTMLProps[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  implicit def make(companion: IsolatedEventContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
