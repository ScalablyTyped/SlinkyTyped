...
object autocompleteMod {
  ...
  object Autocomplete {
    ...
    */
    ...
    trait Completer[T] extends StObject {
      ...
      /**
        ...
        * @param option - a completer option.
        */
      def getOptionLabel(option: T): ReactElement = js.native
    ...
    object Completer {
      ...
      implicit class CompleterMutableBuilder[Self <: Completer[_], T] (val x: Self with Completer[T]) extends AnyVal {
        ...
        @scala.inline
        def setGetOptionLabel(value: T => ReactElement): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
    ...
    */
    type OptionCompletion = _OptionCompletion | ReactElement
    
    @js.native
    trait Props[T] extends StObject {
      
      def children(props: RenderProps): ReactElement | Null = js.native
    ...
    object Props {
      ...
      @scala.inline
      def apply[T](children: RenderProps => ReactElement | Null, completers: js.Array[Completer[T]]): Props[T] = {
      ...
      implicit class PropsMutableBuilder[Self <: Props[_], T] (val x: Self with Props[T]) extends AnyVal {
        ...
        @scala.inline
        def setChildren(value: RenderProps => ReactElement | Null): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    object _OptionCompletion {
      ...
      @scala.inline
      def Action(action: `insert-at-caret`): typingsSlinky.wordpressComponents.anon.Action = {
        val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.anon.Action]
      }
      
      @scala.inline
      def Value(action: replace, value: typingsSlinky.wordpressRichText.mod.Value): typingsSlinky.wordpressComponents.anon.Value = {
        val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.anon.Value]
      }
    }
  }
}
