package typingsSlinky.wordpressComponents.toolbarMod.Toolbar
...
/* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'controls' | 'label'> */
/* Inlined parent std.Partial<std.Pick<@wordpress/components.@wordpress/components/dropdown-menu.default.Props, 'icon' | 'label'>> */
@js.native
