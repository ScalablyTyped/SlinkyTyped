  ...
  object TabPanel {
    ...
    trait Props extends StObject {
      ...
      /**
        ...
        */
      def children(tab: Tab): ReactElement = js.native
    ...
    object Props {
      ...
      @scala.inline
      def apply(children: Tab => ReactElement, tabs: js.Array[Tab]): Props = {
      ...
      implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setChildren(value: Tab => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
