...
trait Props
  ...
  /**
    ...
    */
  var onFocusOutside: js.UndefOr[js.Function1[/* event */ SyntheticFocusEvent[Element], Unit]] = js.undefined
  /**
...
object Props {
  ...
  def apply(
    ...
    onClose: () => Unit = null,
    onFocusOutside: /* event */ SyntheticFocusEvent[Element] => Unit = null,
