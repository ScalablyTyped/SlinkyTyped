package typingsSlinky.wordpressComponents.popoverMod.Popover
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnchorRectClientRect(value: ClientRect): Self = this.set("anchorRect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnFocusOutside(value: /* event */ SyntheticFocusEvent[Element] => Unit): Self = this.set("onFocusOutside", js.Any.fromFunction1(value))
