  ...
  object FormFileUpload {
    ...
    */
    ...
    object Props {
      ...
      @scala.inline
      def IconButtonProps(onChange: ChangeEvent[HTMLInputElement] => Unit): typingsSlinky.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange))
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps]
      }
      
      @scala.inline
      def RenderProps(onChange: ChangeEvent[HTMLInputElement] => Unit, render: OpenFileDialog => ReactElement): typingsSlinky.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange), render = js.Any.fromFunction1(render))
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps]
      }
    }
    ...
    object RenderProps {
      ...
      implicit class RenderPropsMutableBuilder[Self <: RenderProps] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setRender(value: OpenFileDialog => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
      }
    }
  }
}
