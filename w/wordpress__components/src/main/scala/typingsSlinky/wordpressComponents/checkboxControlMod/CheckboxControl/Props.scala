package typingsSlinky.wordpressComponents.checkboxControlMod.CheckboxControl
...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  var heading: js.UndefOr[ReactElement] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeading(value: ReactElement): Self = this.set("heading", value.asInstanceOf[js.Any])
    @scala.inline
