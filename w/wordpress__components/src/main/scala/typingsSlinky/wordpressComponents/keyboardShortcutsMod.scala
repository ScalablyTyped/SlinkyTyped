  ...
  object KeyboardShortcuts {
    ...
    */
    ...
    object Props {
      ...
      @scala.inline
      def PropsWithChildren(shortcuts: Record[String, js.Function0[Unit]]): typingsSlinky.wordpressComponents.keyboardShortcutsMod.KeyboardShortcuts.PropsWithChildren = {
        val __obj = js.Dynamic.literal(shortcuts = shortcuts.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.keyboardShortcutsMod.KeyboardShortcuts.PropsWithChildren]
      }
      
      @scala.inline
      def PropsWithoutChildren(bindGlobal: `true`, shortcuts: Record[String, js.Function0[Unit]]): typingsSlinky.wordpressComponents.keyboardShortcutsMod.KeyboardShortcuts.PropsWithoutChildren = {
        val __obj = js.Dynamic.literal(bindGlobal = bindGlobal.asInstanceOf[js.Any], shortcuts = shortcuts.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.wordpressComponents.keyboardShortcutsMod.KeyboardShortcuts.PropsWithoutChildren]
      }
    }
