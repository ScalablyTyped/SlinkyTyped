package typingsSlinky.wordpressComponents.iconMod.Icon
...
object BaseProps {
  ...
  implicit class BasePropsOps[Self <: BaseProps[_], P] (val x: Self with BaseProps[P]) extends AnyVal {
    ...
    @scala.inline
    def setIconFunctionComponent(value: ReactComponentClass[P]): Self = this.set("icon", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconComponentClass(value: ReactComponentClass[P]): Self = this.set("icon", value.asInstanceOf[js.Any])
