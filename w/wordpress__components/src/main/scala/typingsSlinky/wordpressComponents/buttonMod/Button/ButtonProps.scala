...
- typingsSlinky.wordpressComponents.buttonMod.Button.BaseProps because var conflicts: className, disabled. Inlined isDefault, isPrimary, isSecondary, isTertiary, isDestructive, isLarge, isSmall, isToggled, isBusy, isLink */ @js.native
trait ButtonProps
