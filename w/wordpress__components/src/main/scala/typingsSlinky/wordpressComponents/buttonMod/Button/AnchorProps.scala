...
- typingsSlinky.wordpressComponents.buttonMod.Button.BaseProps because var conflicts: className, disabled. Inlined isDefault, isPrimary, isTertiary, isDestructive, isLarge, isSmall, isToggled, isBusy, isLink */ trait AnchorProps
