...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  var headerTitle: js.UndefOr[TagMod[Any]] = js.undefined
  /**
  ...
  def renderContent(props: RenderProps): ReactElement
  def renderToggle(props: RenderProps): ReactElement
}
