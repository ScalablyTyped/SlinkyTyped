...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  var headerTitle: js.UndefOr[ReactElement] = js.native
  ...
  def renderContent(props: RenderProps): ReactElement = js.native
  
  def renderToggle(props: RenderProps): ReactElement = js.native
}
object Props {
  
  @scala.inline
  def apply(renderContent: RenderProps => ReactElement, renderToggle: RenderProps => ReactElement): Props = {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderContent(value: RenderProps => ReactElement): Self = this.set("renderContent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderToggle(value: RenderProps => ReactElement): Self = this.set("renderToggle", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setHeaderTitle(value: ReactElement): Self = this.set("headerTitle", value.asInstanceOf[js.Any])
