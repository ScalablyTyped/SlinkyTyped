...
@js.native
trait OmitHTMLPropsHTMLSelectEl extends js.Object {
...
object OmitHTMLPropsHTMLSelectEl {
  ...
  @scala.inline
  def apply(): OmitHTMLPropsHTMLSelectEl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitHTMLPropsHTMLSelectEl]
  }
  
  @scala.inline
  implicit class OmitHTMLPropsHTMLSelectElOps[Self <: OmitHTMLPropsHTMLSelectEl] (val x: Self) extends AnyVal {
