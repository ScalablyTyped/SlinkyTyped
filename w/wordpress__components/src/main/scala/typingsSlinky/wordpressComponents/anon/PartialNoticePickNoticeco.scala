...
object PartialNoticePickNoticeco {
  ...
  implicit class PartialNoticePickNoticecoOps[Self <: PartialNoticePickNoticeco] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionsVarargs(value: typingsSlinky.wordpressComponents.noticeMod.Notice.Action*): Self = this.set("actions", js.Array(value :_*))
    
    @scala.inline
    def setActions(value: js.Array[typingsSlinky.wordpressComponents.noticeMod.Notice.Action]): Self = this.set("actions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setContent(value: js.UndefOr[ReactElement] with ReactElement): Self = this.set("content", value.asInstanceOf[js.Any])
