...
trait PartialNoticePickNoticeco extends js.Object {
  var actions: js.UndefOr[js.Array[typingsSlinky.wordpressComponents.noticeMod.Notice.Action]] = js.undefined
...
object PartialNoticePickNoticeco {
  @scala.inline
  def apply(
    actions: js.Array[typingsSlinky.wordpressComponents.noticeMod.Notice.Action] = null,
