...
trait PartialNoticePickNoticeco extends StObject {
  ...
  var actions: js.UndefOr[js.Array[typingsSlinky.wordpressComponents.noticeMod.Notice.Action]] = js.native
  
  var className: js.UndefOr[String] = js.native
  
  var content: js.UndefOr[ReactElement] with ReactElement = js.native
...
object PartialNoticePickNoticeco {
  ...
  implicit class PartialNoticePickNoticecoMutableBuilder[Self <: PartialNoticePickNoticeco] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActions(value: js.Array[typingsSlinky.wordpressComponents.noticeMod.Notice.Action]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionsUndefined: Self = StObject.set(x, "actions", js.undefined)
    
    @scala.inline
    def setActionsVarargs(value: typingsSlinky.wordpressComponents.noticeMod.Notice.Action*): Self = StObject.set(x, "actions", js.Array(value :_*))
    ...
    @scala.inline
    def setContent(value: js.UndefOr[ReactElement] with ReactElement): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
