...
object AsClassName {
  @scala.inline
  def apply[/* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 * / js.Any */ T](): AsClassName[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AsClassName[T]]
  }
  @scala.inline
  implicit class AsClassNameOps[Self <: AsClassName[_], /* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 * / js.Any */ T] (val x: Self with AsClassName[T]) extends AnyVal {
    @scala.inline
