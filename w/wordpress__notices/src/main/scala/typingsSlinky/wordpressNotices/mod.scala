...
object mod {
  ...
  */
  ...
  object Action {
    ...
    @scala.inline
    def CallbackAction(callback: () => Unit, label: String): typingsSlinky.wordpressNotices.mod.CallbackAction = {
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction0(callback), label = label.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.wordpressNotices.mod.CallbackAction]
    }
    
    @scala.inline
    def URLAction(label: String, url: String): typingsSlinky.wordpressNotices.mod.URLAction = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.wordpressNotices.mod.URLAction]
    }
  }
