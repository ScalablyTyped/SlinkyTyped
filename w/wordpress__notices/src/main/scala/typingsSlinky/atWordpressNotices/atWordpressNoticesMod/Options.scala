package typingsSlinky.atWordpressNotices.atWordpressNoticesMod

import typingsSlinky.atWordpressNotices.atWordpressNoticesStrings.default
import typingsSlinky.atWordpressNotices.atWordpressNoticesStrings.snackbar
