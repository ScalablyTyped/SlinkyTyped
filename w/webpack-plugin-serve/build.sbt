...
version := "1.2-dt-20201022Z-46e28a"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "koa-compress" % "v4.x-dt-20201002Z-fea5a2",
  "org.scalablytyped.slinky" %%% "koa-send" % "4.1-dt-20200226Z-c0d9c5",
  "org.scalablytyped.slinky" %%% "koa-static" % "4.0-dt-20200515Z-970c49",
