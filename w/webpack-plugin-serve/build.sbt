...
version := "0.10-dt-20190506Z-075a94"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "koa-compress" % "v2.x-dt-20190326Z-bba613",
  "org.scalablytyped.slinky" %%% "koa-send" % "4.1-dt-20190218Z-d6b65c",
  "org.scalablytyped.slinky" %%% "koa-static" % "4.0-dt-20190207Z-5b8461",
