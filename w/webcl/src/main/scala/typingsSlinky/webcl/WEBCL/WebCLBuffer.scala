...
object WebCLBuffer {
  ...
  implicit class WebCLBufferOps[Self <: WebCLBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateSubBuffer(value: (MemFlagsBits, Double, Double) => WebCLBuffer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSubBuffer")(js.Any.fromFunction3(value))
        ret
    }
  }
