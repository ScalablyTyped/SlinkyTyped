...
trait WebCL extends js.Object {
  ...
  def waitForEvents(eventWaitList: js.Array[typingsSlinky.webcl.WEBCL.WebCLEvent]): Unit = js.native
  def waitForEvents(eventWaitList: js.Array[typingsSlinky.webcl.WEBCL.WebCLEvent], whenFinished: WebCLCallback): Unit = js.native
}
