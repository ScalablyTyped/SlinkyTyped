...
object BlockEditProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](attributes: T, className: String, isSelected: Boolean, setAttributes: Partial[T] => Unit): BlockEditProps[T] = {
  ...
  @scala.inline
  implicit class BlockEditPropsOps[Self <: BlockEditProps[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with BlockEditProps[T]) extends AnyVal {
    @scala.inline
