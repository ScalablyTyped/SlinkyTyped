...
import typingsSlinky.wordpressBlocks.wordpressBlocksStrings.shortcode
...
object TransformShortcode {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](tag: String, `type`: shortcode): TransformShortcode[T] = {
    val __obj = js.Dynamic.literal(tag = tag.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[TransformShortcode[T]]
  }
  @scala.inline
  implicit class TransformShortcodeOps[Self <: TransformShortcode[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with TransformShortcode[T]) extends AnyVal {
    @scala.inline
