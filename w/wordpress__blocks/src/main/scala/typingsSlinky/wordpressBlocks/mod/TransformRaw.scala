...
import typingsSlinky.wordpressBlocks.wordpressBlocksStrings.raw
...
object TransformRaw {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](`type`: raw): TransformRaw[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[TransformRaw[T]]
  }
  @scala.inline
  implicit class TransformRawOps[Self <: TransformRaw[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with TransformRaw[T]) extends AnyVal {
    @scala.inline
