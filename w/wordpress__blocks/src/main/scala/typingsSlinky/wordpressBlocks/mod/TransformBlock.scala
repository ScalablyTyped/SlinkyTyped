...
import typingsSlinky.wordpressBlocks.wordpressBlocksStrings.block_
...
object TransformBlock {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](blocks: js.Array[String], transform: T => BlockInstance[Partial[T]], `type`: block_): TransformBlock[T] = {
  ...
  @scala.inline
  implicit class TransformBlockOps[Self <: TransformBlock[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with TransformBlock[T]) extends AnyVal {
    @scala.inline
