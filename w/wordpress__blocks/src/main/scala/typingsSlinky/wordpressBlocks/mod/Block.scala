...
object Block {
  ...
  implicit class BlockMutableBuilder[Self <: Block[_], T /* <: Record[String, _] */] (val x: Self with Block[T]) extends AnyVal {
    ...
    @scala.inline
    def setEdit(value: ReactComponentClass[BlockEditProps[T]]): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEditComponentClass(value: ReactComponentClass[BlockEditProps[T]]): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEditFunctionComponent(value: ReactComponentClass[BlockEditProps[T]]): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSave(value: ReactComponentClass[BlockSaveProps[T]]): Self = StObject.set(x, "save", value.asInstanceOf[js.Any])
