...
trait Block[T /* <: Record[String, _] */] extends js.Object {
  ...
  /**
    ...
    */
  val edit: js.UndefOr[ReactComponentClass[BlockEditProps[T]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val save: ReactComponentClass[BlockSaveProps[T]]
  /**
    * Block styles.
    *
...
object Block {
  ...
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.Block with TopLevel[js.Any],
    ...
    edit: ReactComponentClass[BlockEditProps[T]] = null,
