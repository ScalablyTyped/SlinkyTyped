...
import typingsSlinky.wordpressBlocks.anon.From
...
trait Block[T /* <: Record[String, _] */] extends js.Object {
  ...
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.Block with TopLevel[js.Any] = js.native
  /**
  ...
  /**
    ...
    */
  val edit: js.UndefOr[ReactComponentClass[BlockEditProps[T]]] = js.native
  /**
  ...
  /**
    ...
    */
  val save: ReactComponentClass[BlockSaveProps[T]] = js.native
  /**
    * Block styles.
    *
...
object Block {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](
    attributes: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.Block with TopLevel[js.Any],
    category: String,
  ...
  @scala.inline
  implicit class BlockOps[Self <: Block[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with Block[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEditFunctionComponent(value: ReactComponentClass[BlockEditProps[T]]): Self = this.set("edit", value.asInstanceOf[js.Any])
    @scala.inline
    def setEditComponentClass(value: ReactComponentClass[BlockEditProps[T]]): Self = this.set("edit", value.asInstanceOf[js.Any])
    @scala.inline
    def setEdit(value: ReactComponentClass[BlockEditProps[T]]): Self = this.set("edit", value.asInstanceOf[js.Any])
    @scala.inline
