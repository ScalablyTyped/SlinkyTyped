...
object BlockDeprecation {
  ...
  @scala.inline
  implicit class BlockDeprecationOps[Self <: BlockDeprecation[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with BlockDeprecation[T]) extends AnyVal {
    @scala.inline
