...
object BlockSaveProps {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](attributes: T): BlockSaveProps[T] = {
    val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any])
    __obj.asInstanceOf[BlockSaveProps[T]]
  }
  @scala.inline
  implicit class BlockSavePropsOps[Self <: BlockSaveProps[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with BlockSaveProps[T]) extends AnyVal {
    @scala.inline
