...
object BlockConfiguration {
  ...
  implicit class BlockConfigurationMutableBuilder[Self <: BlockConfiguration[_], T /* <: Record[String, _] */] (val x: Self with BlockConfiguration[T]) extends AnyVal {
    ...
    @scala.inline
    def setSaveComponentClass(value: ReactComponentClass[BlockSaveProps[T]]): Self = StObject.set(x, "save", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSaveFunctionComponent(value: ReactComponentClass[BlockSaveProps[T]]): Self = StObject.set(x, "save", value.asInstanceOf[js.Any])
