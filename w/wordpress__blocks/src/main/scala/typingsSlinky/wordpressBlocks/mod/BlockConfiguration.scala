...
trait BlockConfiguration[T /* <: Record[String, _] */] extends js.Object {
  ...
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.BlockConfiguration with TopLevel[js.Any]
  ]) with typingsSlinky.wordpressBlocks.wordpressBlocksStrings.BlockConfiguration with TopLevel[js.Any] = js.native
  ...
  var edit: js.UndefOr[ReactComponentClass[BlockEditProps[T]]] = js.native
  ...
  var save: js.UndefOr[ReactComponentClass[BlockSaveProps[T]]] = js.native
...
object BlockConfiguration {
  ...
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.BlockConfiguration with TopLevel[js.Any]
    ]) with typingsSlinky.wordpressBlocks.wordpressBlocksStrings.BlockConfiguration with TopLevel[js.Any],
  ...
  @scala.inline
  implicit class BlockConfigurationOps[Self <: BlockConfiguration[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with BlockConfiguration[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSaveFunctionComponent(value: ReactComponentClass[BlockSaveProps[T]]): Self = this.set("save", value.asInstanceOf[js.Any])
    @scala.inline
    def setSaveComponentClass(value: ReactComponentClass[BlockSaveProps[T]]): Self = this.set("save", value.asInstanceOf[js.Any])
    @scala.inline
