...
trait BlockConfiguration[T /* <: Record[String, _] */] extends js.Object {
  ...
  var edit: js.UndefOr[ReactComponentClass[BlockEditProps[T]]] = js.undefined
  ...
  var save: js.UndefOr[ReactComponentClass[BlockSaveProps[T]]] = js.undefined
...
object BlockConfiguration {
  ...
  {readonly [ k in keyof T ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? any : T[k]>}
    */ typingsSlinky.wordpressBlocks.wordpressBlocksStrings.BlockConfiguration with TopLevel[js.Any] = null,
    ...
    save: ReactComponentClass[BlockSaveProps[T]] = null,
