...
object registrationMod {
  ...
  @JSImport("@wordpress/blocks/api/registration", "getBlockSupport")
  @js.native
  ...
  @JSImport("@wordpress/blocks/api/registration", "getBlockType")
  @js.native
  ...
  @JSImport("@wordpress/blocks/api/registration", "getBlockTypes")
  @js.native
  def getBlockTypes(): js.Array[Block[_]] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "getChildBlockNames")
  @js.native
  def getChildBlockNames(blockName: String): js.Array[String] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "getDefaultBlockName")
  @js.native
  def getDefaultBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "getFreeformContentHandlerName")
  @js.native
  def getFreeformContentHandlerName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "getGroupingBlockName")
  @js.native
  def getGroupingBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "getUnregisteredTypeHandlerName")
  @js.native
  def getUnregisteredTypeHandlerName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "hasBlockSupport")
  @js.native
  ...
  @JSImport("@wordpress/blocks/api/registration", "hasChildBlocks")
  @js.native
  def hasChildBlocks(blockName: String): Boolean = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "hasChildBlocksWithInserterSupport")
  @js.native
  def hasChildBlocksWithInserterSupport(blockName: String): Boolean = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "isReusableBlock")
  @js.native
  ...
  @JSImport("@wordpress/blocks/api/registration", "registerBlockCollection")
  @js.native
  def registerBlockCollection(namespace: String, settings: Icon): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "registerBlockStyle")
  @js.native
  def registerBlockStyle(blockName: String, styleVariation: BlockStyle): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "registerBlockType")
  @js.native
  def registerBlockType[T /* <: Record[String, _] */](name: String, settings: BlockConfiguration[T]): js.UndefOr[Block[T]] = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "setDefaultBlockName")
  @js.native
  def setDefaultBlockName(name: String): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "setFreeformContentHandlerName")
  @js.native
  def setFreeformContentHandlerName(blockName: String): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "setGroupingBlockName")
  @js.native
  def setGroupingBlockName(name: String): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "setUnregisteredTypeHandlerName")
  @js.native
  def setUnregisteredTypeHandlerName(blockName: String): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "unregisterBlockStyle")
  @js.native
  def unregisterBlockStyle(blockName: String, styleVariationName: String): Unit = js.native
  
  @JSImport("@wordpress/blocks/api/registration", "unregisterBlockType")
  @js.native
