...
object From {
  @scala.inline
  def apply[/* <: typingsSlinky.std.Record[java.lang.String, _] */ T](): From[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[From[T]]
  }
  @scala.inline
  implicit class FromOps[Self <: From[_], /* <: typingsSlinky.std.Record[java.lang.String, _] */ T] (val x: Self with From[T]) extends AnyVal {
    @scala.inline
