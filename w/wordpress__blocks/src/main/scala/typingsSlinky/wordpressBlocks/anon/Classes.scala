...
import typingsSlinky.wordpressBlocks.mod.TransformRawSchema
...
trait Classes extends StObject {
  ...
  var classes: js.UndefOr[js.Array[String | js.RegExp]] = js.native
...
object Classes {
  ...
  implicit class ClassesMutableBuilder[Self <: Classes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClasses(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
