package typingsSlinky.wordpressDependencyExtractionWebpackPlugin.anon

import typingsSlinky.wordpressDependencyExtractionWebpackPlugin.mod.RequestToExternal
import typingsSlinky.wordpressDependencyExtractionWebpackPlugin.mod.RequestToHandle
