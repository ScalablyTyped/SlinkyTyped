package typingsSlinky.wordwrap.wordwrapMod
...
object Mode {
  ...
  @scala.inline
  def hard: typingsSlinky.wordwrap.wordwrapStrings.hard = this.cast("hard")
  @scala.inline
  def soft: typingsSlinky.wordwrap.wordwrapStrings.soft = this.cast("soft")
}
