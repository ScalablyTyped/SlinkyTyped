...
object ^ extends js.Object {
  ...
  var fromPromise: js.Function2[
    /* promise */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distCommonjsCoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distCommonjsStreamFromPromiseStreamMod.FromPromiseStream
  ] = js.native
  ...
  var interval: js.Function2[
    /* interval */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distCommonjsCoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distCommonjsStreamIntervalStreamMod.IntervalStream
  ] = js.native
  var intervalRequest: js.Function1[
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distCommonjsCoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distCommonjsStreamIntervalRequestStreamMod.IntervalRequestStream
  ] = js.native
  ...
  var timeout: js.Function2[
    /* time */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distCommonjsCoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distCommonjsStreamTimeoutStreamMod.TimeoutStream
  ] = js.native
}
