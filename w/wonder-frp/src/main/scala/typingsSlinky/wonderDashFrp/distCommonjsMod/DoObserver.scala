...
class DoObserver protected ()
  extends typingsSlinky.wonderDashFrp.distCommonjsObserverDoObserverMod.DoObserver {
...
object DoObserver extends js.Object {
  def create(currentObserver: IObserver, prevObserver: IObserver): typingsSlinky.wonderDashFrp.distCommonjsObserverDoObserverMod.DoObserver = js.native
}
