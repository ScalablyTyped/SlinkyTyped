...
class FilterWithStateStream ()
  extends typingsSlinky.wonderDashFrp.distEs2015StreamFilterWithStateStreamMod.FilterWithStateStream
...
object FilterWithStateStream extends js.Object {
  def create(
    ...
    thisArg: js.Any
  ): typingsSlinky.wonderDashFrp.distEs2015StreamFilterWithStateStreamMod.FilterWithStateStream = js.native
}
