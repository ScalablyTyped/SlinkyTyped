...
object ^ extends js.Object {
  ...
  var fromEvent: js.Function2[
    /* dom */ HTMLElement, 
    /* eventName */ String, 
    typingsSlinky.wonderDashFrp.distEs2015StreamFromEventPatternStreamMod.FromEventPatternStream
  ] = js.native
  ...
  var interval: js.Function2[
    /* interval */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distEs2015CoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distEs2015StreamIntervalStreamMod.IntervalStream
  ] = js.native
  var intervalRequest: js.Function1[
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distEs2015CoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distEs2015StreamIntervalRequestStreamMod.IntervalRequestStream
  ] = js.native
  ...
  var timeout: js.Function2[
    /* time */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderDashFrp.distEs2015CoreSchedulerMod.Scheduler], 
    typingsSlinky.wonderDashFrp.distEs2015StreamTimeoutStreamMod.TimeoutStream
  ] = js.native
}
