...
class FilterStream protected ()
  extends typingsSlinky.wonderDashFrp.distEs2015StreamFilterStreamMod.FilterStream {
  def this(
...
object FilterStream extends js.Object {
  def create(
    ...
    thisArg: js.Any
  ): typingsSlinky.wonderDashFrp.distEs2015StreamFilterStreamMod.FilterStream = js.native
}
