...
import typingsSlinky.wonderDashFrp.distEs2015TestingMockPromiseMod.MockPromise
...
import typingsSlinky.wonderDashFrp.distEs2015TestingTestStreamMod.TestStream
