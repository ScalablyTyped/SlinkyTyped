...
class AnonymousStream protected ()
  extends typingsSlinky.wonderFrp.streamAnonymousStreamMod.AnonymousStream {
...
object AnonymousStream extends js.Object {
  def create(subscribeFunc: js.Function): typingsSlinky.wonderFrp.streamAnonymousStreamMod.AnonymousStream = js.native
}
