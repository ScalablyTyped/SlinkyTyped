...
class FromEventPatternStream protected ()
  extends typingsSlinky.wonderFrp.streamFromEventPatternStreamMod.FromEventPatternStream {
...
object FromEventPatternStream extends js.Object {
  def create(addHandler: js.Function, removeHandler: js.Function): typingsSlinky.wonderFrp.streamFromEventPatternStreamMod.FromEventPatternStream = js.native
}
