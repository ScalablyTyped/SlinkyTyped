...
class TakeUntilObserver protected ()
  extends typingsSlinky.wonderFrp.observerTakeUntilObserverMod.TakeUntilObserver {
...
object TakeUntilObserver extends js.Object {
  def create(prevObserver: IObserver): typingsSlinky.wonderFrp.observerTakeUntilObserverMod.TakeUntilObserver = js.native
}
