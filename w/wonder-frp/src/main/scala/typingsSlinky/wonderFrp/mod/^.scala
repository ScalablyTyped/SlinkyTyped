...
object ^ extends js.Object {
  ...
  var defer: js.Function1[
    ...
    typingsSlinky.wonderFrp.deferStreamMod.DeferStream
  ] = js.native
  ...
  var fromEvent: js.Function2[
    /* dom */ HTMLElement, 
    /* eventName */ String, 
    typingsSlinky.wonderFrp.fromEventPatternStreamMod.FromEventPatternStream
  ] = js.native
  ...
  var fromNodeCallback: js.Function2[
    /* func */ js.Function, 
    /* context */ js.UndefOr[js.Any], 
    js.Function1[/* repeated */ js.Any, typingsSlinky.wonderFrp.anonymousStreamMod.AnonymousStream]
  ] = js.native
  ...
  var fromReadableStream: js.Function1[/* stream */ js.Any, typingsSlinky.wonderFrp.anonymousStreamMod.AnonymousStream] = js.native
  var fromStream: js.Function2[
    /* stream */ js.Any, 
    /* finishEventName */ js.UndefOr[String], 
    typingsSlinky.wonderFrp.anonymousStreamMod.AnonymousStream
  ] = js.native
  var fromTransformStream: js.Function1[/* stream */ js.Any, typingsSlinky.wonderFrp.anonymousStreamMod.AnonymousStream] = js.native
  var fromWritableStream: js.Function1[/* stream */ js.Any, typingsSlinky.wonderFrp.anonymousStreamMod.AnonymousStream] = js.native
  var interval: js.Function2[
    /* interval */ js.Any, 
    /* scheduler */ js.UndefOr[typingsSlinky.wonderFrp.schedulerMod.Scheduler], 
    typingsSlinky.wonderFrp.intervalStreamMod.IntervalStream
  ] = js.native
  var intervalRequest: js.Function1[
    /* scheduler */ js.UndefOr[typingsSlinky.wonderFrp.schedulerMod.Scheduler], 
    typingsSlinky.wonderFrp.intervalRequestStreamMod.IntervalRequestStream
  ] = js.native
