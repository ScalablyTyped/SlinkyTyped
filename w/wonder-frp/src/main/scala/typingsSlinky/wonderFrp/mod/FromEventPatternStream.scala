...
class FromEventPatternStream protected ()
  extends typingsSlinky.wonderFrp.fromEventPatternStreamMod.FromEventPatternStream {
...
object FromEventPatternStream extends js.Object {
  def create(addHandler: js.Function, removeHandler: js.Function): typingsSlinky.wonderFrp.fromEventPatternStreamMod.FromEventPatternStream = js.native
}
