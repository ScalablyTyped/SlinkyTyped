...
class FilterWithStateStream ()
  extends typingsSlinky.wonderFrp.filterWithStateStreamMod.FilterWithStateStream
...
object FilterWithStateStream extends js.Object {
  def create(
    ...
    thisArg: js.Any
  ): typingsSlinky.wonderFrp.filterWithStateStreamMod.FilterWithStateStream = js.native
}
