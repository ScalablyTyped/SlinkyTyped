...
import typingsSlinky.webDashAnimationsDashJs.webDashAnimationsDashJsStrings.cancel
import typingsSlinky.webDashAnimationsDashJs.webDashAnimationsDashJsStrings.finish
