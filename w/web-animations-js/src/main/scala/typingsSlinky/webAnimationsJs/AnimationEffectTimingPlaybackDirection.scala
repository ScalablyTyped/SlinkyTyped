...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.webAnimationsJs.webAnimationsJsStrings.normal
  - typingsSlinky.webAnimationsJs.webAnimationsJsStrings.reverse
  - typingsSlinky.webAnimationsJs.webAnimationsJsStrings.alternate
  - typingsSlinky.webAnimationsJs.webAnimationsJsStrings.`alternate-reverse`
*/
