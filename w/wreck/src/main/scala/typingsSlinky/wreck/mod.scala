...
import typingsSlinky.wreck.anon.Req
import typingsSlinky.wreck.anon.RequestOptionspayloadanyu
...
object mod extends Shortcut {
  ...
  type ResponseCallback = js.Function2[/* err */ js.UndefOr[typingsSlinky.boom.mod.^[js.Any]], /* details */ Req, Unit]
