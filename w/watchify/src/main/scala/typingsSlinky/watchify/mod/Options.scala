...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIgnoreWatchVarargs(value: (String | js.RegExp | (js.Function1[js.Any, Boolean]))*): Self = this.set("ignoreWatch", js.Array(value :_*))
    
    @scala.inline
    def setIgnoreWatchFunction1(value: /* repeated */ js.Any => Boolean): Self = this.set("ignoreWatch", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIgnoreWatchRegExp(value: js.RegExp): Self = this.set("ignoreWatch", value.asInstanceOf[js.Any])
