...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIgnoreWatchFunction1(value: /* repeated */ js.Any => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ignoreWatch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIgnoreWatchRegExp(value: js.RegExp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ignoreWatch")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIgnoreWatch(
      value: Boolean | String | js.RegExp | (js.Function1[/* repeated */ js.Any, Boolean]) | (js.Array[String | js.RegExp | (js.Function1[/* repeated */ _, Boolean])])
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ignoreWatch")(value.asInstanceOf[js.Any])
        ret
    ...
    @scala.inline
    def withoutIgnoreWatch: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ignoreWatch")(js.undefined)
        ret
    }
    @scala.inline
