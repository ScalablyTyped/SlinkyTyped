package typingsSlinky.watchify.watchifyMod
...
trait Options extends js.Object {
  ...
  var ignoreWatch: js.UndefOr[
    Boolean | String | js.RegExp | (js.Function1[/* repeated */ js.Any, Boolean]) | (js.Array[String | js.RegExp | (js.Function1[/* repeated */ _, Boolean])])
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    ignoreWatch: Boolean | String | js.RegExp | (js.Function1[/* repeated */ js.Any, Boolean]) | (js.Array[String | js.RegExp | (js.Function1[/* repeated */ _, Boolean])]) = null,
