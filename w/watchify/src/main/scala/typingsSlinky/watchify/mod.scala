...
object mod extends Shortcut {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIgnoreWatchRegExp(value: js.RegExp): Self = StObject.set(x, "ignoreWatch", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIgnoreWatchUndefined: Self = StObject.set(x, "ignoreWatch", js.undefined)
      
      @scala.inline
      def setIgnoreWatchVarargs(value: (String | js.RegExp | (js.Function1[js.Any, Boolean]))*): Self = StObject.set(x, "ignoreWatch", js.Array(value :_*))
