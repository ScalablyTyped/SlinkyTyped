...
package object mod {
  ...
  type HookMap[T /* <: js.Function1[/* repeated */ js.Any, _] */] = typingsSlinky.wordpressHooks.AnonCurrent[T] with (typingsSlinky.std.Record[java.lang.String, js.UndefOr[js.Array[typingsSlinky.wordpressHooks.mod.Hook[T]]]])
