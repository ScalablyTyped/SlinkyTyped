...
trait Instance extends EventEmitter {
  ...
  def add(torrent: typingsSlinky.parseDashTorrent.parseDashTorrentMod.Instance): Torrent = js.native
  def add(
    torrent: typingsSlinky.parseDashTorrent.parseDashTorrentMod.Instance,
    cb: js.Function1[/* torrent */ Torrent, _]
  ): Torrent = js.native
  def add(torrent: typingsSlinky.parseDashTorrent.parseDashTorrentMod.Instance, opts: TorrentOptions): Torrent = js.native
  def add(
    torrent: typingsSlinky.parseDashTorrent.parseDashTorrentMod.Instance,
    opts: TorrentOptions,
    cb: js.Function1[/* torrent */ Torrent, _]
