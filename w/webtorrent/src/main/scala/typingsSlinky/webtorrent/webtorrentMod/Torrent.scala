...
import typingsSlinky.bittorrentDashProtocol.bittorrentDashProtocolMod.Wire
...
trait Torrent extends EventEmitter {
  ...
  def addPeer(peer: typingsSlinky.simpleDashPeer.simpleDashPeerMod.Instance): Boolean = js.native
  ...
  def removePeer(peer: typingsSlinky.simpleDashPeer.simpleDashPeerMod.Instance): Unit = js.native
