...
import typingsSlinky.word.wordStrings.c
...
object typesMod {
  ...
  */
  ...
  object WJSParaElement {
    ...
    @scala.inline
    def WJSTable(r: js.Array[WJSTableRow], t: t): typingsSlinky.word.typesMod.WJSTable = {
      val __obj = js.Dynamic.literal(r = r.asInstanceOf[js.Any], t = t.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.word.typesMod.WJSTable]
    }
    
    @scala.inline
    def WJSTextRun(t: s, v: String): typingsSlinky.word.typesMod.WJSTextRun = {
      val __obj = js.Dynamic.literal(t = t.asInstanceOf[js.Any], v = v.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.word.typesMod.WJSTextRun]
    }
  }
