...
object mod {
  ...
  @scala.inline
  def defaultAmount_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultAmount")(x.asInstanceOf[js.Any])
  
  @JSImport("dinero.js", "defaultCurrency")
  @js.native
  def defaultCurrency: Currency = js.native
  @scala.inline
  def defaultCurrency_=(x: Currency): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultCurrency")(x.asInstanceOf[js.Any])
  
  @JSImport("dinero.js", "defaultPrecision")
  @js.native
  def defaultPrecision: Double = js.native
  @scala.inline
  def defaultPrecision_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultPrecision")(x.asInstanceOf[js.Any])
  
  @JSImport("dinero.js", "globalExchangeRatesApi")
  @js.native
  def globalExchangeRatesApi: ExchangeRatesApiOptions = js.native
  @scala.inline
  def globalExchangeRatesApi_=(x: ExchangeRatesApiOptions): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalExchangeRatesApi")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def globalFormatRoundingMode_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalFormatRoundingMode")(x.asInstanceOf[js.Any])
  
  @scala.inline
  def globalFormat_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalFormat")(x.asInstanceOf[js.Any])
  
  @JSImport("dinero.js", "globalLocale")
  @js.native
  def globalLocale: String = js.native
  @scala.inline
  def globalLocale_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("globalLocale")(x.asInstanceOf[js.Any])
  ...
  */
  ...
  object DineroObject {
    ...
    @scala.inline
    implicit class DineroObjectMutableBuilder[Self <: DineroObject] (val x: Self) extends AnyVal {
  ...
  object ExchangeRatesApiOptions {
    ...
    implicit class ExchangeRatesApiOptionsMutableBuilder[Self <: ExchangeRatesApiOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPropertyPathUndefined: Self = StObject.set(x, "propertyPath", js.undefined)
      
      @scala.inline
      def setRoundingMode(value: RoundingMode): Self = StObject.set(x, "roundingMode", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_ODD
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_EVEN
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_UP
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_DOWN
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_TOWARDS_ZERO
    - typingsSlinky.dineroJs.dineroJsStrings.HALF_AWAY_FROM_ZERO
  */
  trait RoundingMode extends StObject
  object RoundingMode {
    
    @scala.inline
    def HALF_AWAY_FROM_ZERO: typingsSlinky.dineroJs.dineroJsStrings.HALF_AWAY_FROM_ZERO = "HALF_AWAY_FROM_ZERO".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_AWAY_FROM_ZERO]
    
    @scala.inline
    def HALF_DOWN: typingsSlinky.dineroJs.dineroJsStrings.HALF_DOWN = "HALF_DOWN".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_DOWN]
    
    @scala.inline
    def HALF_EVEN: typingsSlinky.dineroJs.dineroJsStrings.HALF_EVEN = "HALF_EVEN".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_EVEN]
    
    @scala.inline
    def HALF_ODD: typingsSlinky.dineroJs.dineroJsStrings.HALF_ODD = "HALF_ODD".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_ODD]
    
    @scala.inline
    def HALF_TOWARDS_ZERO: typingsSlinky.dineroJs.dineroJsStrings.HALF_TOWARDS_ZERO = "HALF_TOWARDS_ZERO".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_TOWARDS_ZERO]
    
    @scala.inline
    def HALF_UP: typingsSlinky.dineroJs.dineroJsStrings.HALF_UP = "HALF_UP".asInstanceOf[typingsSlinky.dineroJs.dineroJsStrings.HALF_UP]
  }
}
