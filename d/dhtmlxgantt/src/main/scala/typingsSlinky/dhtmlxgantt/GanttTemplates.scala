...
trait GanttTemplates extends js.Object {
  ...
  /**
    ...
    */
  def date_grid(date: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def grid_row_class(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    */
  def histogram_cell_allocated(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): Unit = js.native
  ...
  /**
    ...
    * @param tasks tasks that are assigned to the specified resource and overlap start/end dates of the cell
    */
  def histogram_cell_capacity(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): Unit = js.native
  ...
  /**
    ...
    * @param tasks tasks that are assigned to the specified resource and overlap start/end dates of the cell
    */
  def histogram_cell_class(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): Unit = js.native
  ...
  /**
    ...
    * @param tasks tasks that are assigned to the specified resource and overlap start/end dates of the cell
    */
  def histogram_cell_label(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): Unit = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def leftside_text(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    */
  def lightbox_header(start_date: js.Date, end_date: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def progress_text(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def quick_info_class(start: js.Date, end: js.Date, task: js.Any): Unit = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def quick_info_content(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def quick_info_date(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def quick_info_title(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    */
  def resource_cell_class(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): String = js.native
  ...
  /**
    ...
    * @param tasks tasks that are assigned to specified resource and overlap start/end dates of the cell
    */
  def resource_cell_value(start_date: js.Date, end_date: js.Date, resource: js.Any, tasks: js.Array[_]): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def rightside_text(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param date the date of a cell
    */
  def task_cell_class(item: js.Any, date: js.Date): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def task_class(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def task_row_class(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def task_text(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def task_time(start: js.Date, end: js.Date, task: js.Any): String = js.native
  ...
  /**
    ...
    * @param task the task object
    */
  def tooltip_text(start: js.Date, end: js.Date, task: js.Any): String = js.native
