...
trait GanttStatic extends js.Object {
  ...
  /**
    ...
    * @param config the <a href="#configurationobjectproperties">configuration object</a> of a time span
    */
  def calculateEndDate(config: js.Any): js.Date = js.native
  /**
    * calculates the end date of a task
    * @param start the date when a task is scheduled to begin
  ...
  /**
    ...
    */
  def getClosestWorkTime(config: js.Any): js.Date = js.native
  ...
  def getTaskByTime(from: js.UndefOr[scala.Nothing], to: js.Date): js.Array[_] = js.native
  def getTaskByTime(from: js.Date): js.Array[_] = js.native
  def getTaskByTime(from: js.Date, to: js.Date): js.Array[_] = js.native
  ...
  /**
    ...
    */
  def getTaskPosition(task: js.Any, from: js.Date, to: js.Date): js.Any = js.native
  ...
  /**
    ...
    */
  def getWorkHours(date: js.Date): js.Array[_] = js.native
  ...
  def init(container: String, from: js.UndefOr[scala.Nothing], to: js.Date): Unit = js.native
  ...
  def init(container: HTMLElement, from: js.UndefOr[scala.Nothing], to: js.Date): Unit = js.native
