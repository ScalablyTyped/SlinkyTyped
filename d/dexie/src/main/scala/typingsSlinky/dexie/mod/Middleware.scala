...
import typingsSlinky.dexie.anon.Stack
...
object Middleware {
  @scala.inline
  def apply[/* <: typingsSlinky.dexie.anon.Stack */ TStack](
  ...
  @scala.inline
  implicit class MiddlewareOps[Self <: Middleware[_], /* <: typingsSlinky.dexie.anon.Stack */ TStack] (val x: Self with Middleware[TStack]) extends AnyVal {
    @scala.inline
