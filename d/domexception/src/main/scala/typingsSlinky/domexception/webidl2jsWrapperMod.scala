package typingsSlinky.domexception

import org.scalajs.dom.raw.DOMException
import typingsSlinky.domexception.domexceptionImplMod.implementation
...
object webidl2jsWrapperMod {
  ...
  @JSImport("domexception/webidl2js-wrapper", "convert")
  @js.native
  ...
  @JSImport("domexception/webidl2js-wrapper", "create")
  @js.native
  def create(globalObject: js.Object): DOMException = js.native
  @JSImport("domexception/webidl2js-wrapper", "create")
  @js.native
  def create(globalObject: js.Object, hasMessageName: js.UndefOr[scala.Nothing], privateData: js.Object): DOMException = js.native
  @JSImport("domexception/webidl2js-wrapper", "create")
  @js.native
  ...
  @JSImport("domexception/webidl2js-wrapper", "createImpl")
  @js.native
  def createImpl(globalObject: js.Object): implementation = js.native
  @JSImport("domexception/webidl2js-wrapper", "createImpl")
  @js.native
  def createImpl(globalObject: js.Object, hasMessageName: js.UndefOr[scala.Nothing], privateData: js.Object): implementation = js.native
  @JSImport("domexception/webidl2js-wrapper", "createImpl")
  @js.native
  ...
  @JSImport("domexception/webidl2js-wrapper", "install")
  @js.native
  def install(globalObject: js.Object): Unit = js.native
  
  @JSImport("domexception/webidl2js-wrapper", "is")
  @js.native
  def is(obj: js.Any): /* is std.DOMException */ Boolean = js.native
  
  @JSImport("domexception/webidl2js-wrapper", "isImpl")
  @js.native
  def isImpl(obj: js.Any): /* is domexception.domexception/lib/DOMException-impl.implementation */ Boolean = js.native
  
  @JSImport("domexception/webidl2js-wrapper", "setup")
  @js.native
  def setup[T /* <: DOMException */](obj: T, globalObject: js.Object): T = js.native
  @JSImport("domexception/webidl2js-wrapper", "setup")
  @js.native
  def setup[T /* <: DOMException */](obj: T, globalObject: js.Object, hasMessageName: js.UndefOr[scala.Nothing], privateData: js.Object): T = js.native
  @JSImport("domexception/webidl2js-wrapper", "setup")
  @js.native
