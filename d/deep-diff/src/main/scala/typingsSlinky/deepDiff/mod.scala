...
object mod {
  ...
  */
  ...
  object Diff_ {
    ...
    @scala.inline
    def DiffArray[LHS, RHS](index: Double, item: Diff_[LHS, RHS], kind: A): typingsSlinky.deepDiff.mod.DiffArray[LHS, RHS] = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.deepDiff.mod.DiffArray[LHS, RHS]]
    }
    
    @scala.inline
    def DiffDeleted[LHS](kind: D, lhs: LHS): typingsSlinky.deepDiff.mod.DiffDeleted[LHS] = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], lhs = lhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.deepDiff.mod.DiffDeleted[LHS]]
    }
    
    @scala.inline
    def DiffEdit[LHS, RHS](kind: E, lhs: LHS, rhs: RHS): typingsSlinky.deepDiff.mod.DiffEdit[LHS, RHS] = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], lhs = lhs.asInstanceOf[js.Any], rhs = rhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.deepDiff.mod.DiffEdit[LHS, RHS]]
    }
    
    @scala.inline
    def DiffNew[RHS](kind: N, rhs: RHS): typingsSlinky.deepDiff.mod.DiffNew[RHS] = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], rhs = rhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.deepDiff.mod.DiffNew[RHS]]
    }
  }
