...
import typingsSlinky.d3DashDrag.d3DashDragStrings.end
import typingsSlinky.d3DashDrag.d3DashDragStrings.mouse
import typingsSlinky.d3DashDrag.d3DashDragStrings.start
...
trait D3DragEvent[GElement /* <: Element */, Datum, Subject] extends js.Object {
  ...
  /**
    ...
    */
  var `type`: start | typingsSlinky.d3DashDrag.d3DashDragStrings.drag | end | String = js.native
  /**
