package typingsSlinky.dicer.dicerMod

import typingsSlinky.dicer.dicerStrings.close
import typingsSlinky.dicer.dicerStrings.data
import typingsSlinky.dicer.dicerStrings.end
import typingsSlinky.dicer.dicerStrings.error
import typingsSlinky.dicer.dicerStrings.header
import typingsSlinky.dicer.dicerStrings.readable
