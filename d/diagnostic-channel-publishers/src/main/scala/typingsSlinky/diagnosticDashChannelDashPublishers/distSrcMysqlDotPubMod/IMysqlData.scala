...
import typingsSlinky.diagnosticDashChannelDashPublishers.Anon_Connection
...
object IMysqlData {
  @scala.inline
  def apply(callbackArgs: IArguments, duration: Double, err: js.Error, query: Anon_Connection): IMysqlData = {
