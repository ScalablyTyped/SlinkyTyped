...
object SchedulerConfigOptions {
  ...
  implicit class SchedulerConfigOptionsOps[Self <: SchedulerConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAgenda_end(value: js.Date): Self = this.set("agenda_end", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAgenda_start(value: js.Date): Self = this.set("agenda_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLimit_end(value: js.Date): Self = this.set("limit_end", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLimit_start(value: js.Date): Self = this.set("limit_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMap_end(value: js.Date): Self = this.set("map_end", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMap_start(value: js.Date): Self = this.set("map_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNow_date(value: js.Date): Self = this.set("now_date", value.asInstanceOf[js.Any])
