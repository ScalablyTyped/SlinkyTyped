...
object SchedulerConfigOptions {
  ...
  implicit class SchedulerConfigOptionsMutableBuilder[Self <: SchedulerConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAgenda_end(value: js.Date): Self = StObject.set(x, "agenda_end", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAgenda_start(value: js.Date): Self = StObject.set(x, "agenda_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLimit_end(value: js.Date): Self = StObject.set(x, "limit_end", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLimit_start(value: js.Date): Self = StObject.set(x, "limit_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMap_end(value: js.Date): Self = StObject.set(x, "map_end", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMap_start(value: js.Date): Self = StObject.set(x, "map_start", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNow_date(value: js.Date): Self = StObject.set(x, "now_date", value.asInstanceOf[js.Any])
