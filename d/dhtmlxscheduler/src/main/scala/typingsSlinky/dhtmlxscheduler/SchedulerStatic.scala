...
trait SchedulerStatic extends js.Object {
  ...
  /**
  	...
  	*/
  def markCalendar(calendar: js.Any, date: js.Date, css: String): Unit = js.native
  /**
  ...
  /**
  	...
  	*/
  def unmarkCalendar(calendar: js.Any, date: js.Date, css: String): Unit = js.native
  ...
  /**
  	...
  	*/
  def updateCalendar(calendar: js.Any, new_date: js.Date): Unit = js.native
  /**
