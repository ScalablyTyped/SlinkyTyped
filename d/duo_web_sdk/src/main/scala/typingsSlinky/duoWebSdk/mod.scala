package typingsSlinky.duoWebSdk
...
object mod {
  ...
  @js.native
  def isDuoMessage(event: MessageEvent): Boolean = js.native
  ...
  object InitOptions {
    ...
    implicit class InitOptionsMutableBuilder[Self <: InitOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIframeContainerHTMLElement(value: HTMLElement): Self = StObject.set(x, "iframeContainer", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIframeContainerUndefined: Self = StObject.set(x, "iframeContainer", js.undefined)
      
      @scala.inline
      def setIframeHTMLIFrameElement(value: HTMLIFrameElement): Self = StObject.set(x, "iframe", value.asInstanceOf[js.Any])
