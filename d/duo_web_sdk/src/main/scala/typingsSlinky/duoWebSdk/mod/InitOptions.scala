...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIframeHTMLIFrameElement(value: HTMLIFrameElement): Self = this.set("iframe", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIframeContainerHTMLElement(value: HTMLElement): Self = this.set("iframeContainer", value.asInstanceOf[js.Any])
    @scala.inline
