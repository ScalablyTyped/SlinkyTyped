...
object AnonAreaComponent {
  @scala.inline
  def apply(): AnonAreaComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAreaComponent]
  }
  @scala.inline
  implicit class AnonAreaComponentOps[Self <: AnonAreaComponent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withComponent(value: dxPivotGridFieldChooser): Self = {
        val ret = this.duplicate
