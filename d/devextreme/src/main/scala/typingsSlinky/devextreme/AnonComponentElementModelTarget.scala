...
object AnonComponentElementModelTarget {
  @scala.inline
  def apply[T](): AnonComponentElementModelTarget[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentElementModelTarget[T]]
  }
  @scala.inline
  implicit class AnonComponentElementModelTargetOps[Self[t] <: AnonComponentElementModelTarget[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
