...
object AnonElementModel {
  @scala.inline
  def apply(): AnonElementModel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonElementModel]
  }
  @scala.inline
  implicit class AnonElementModelOps[Self <: AnonElementModel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withComponent(value: dxActionSheet): Self = {
        val ret = this.duplicate
