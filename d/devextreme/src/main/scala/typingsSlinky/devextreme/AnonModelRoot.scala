...
object AnonModelRoot {
  @scala.inline
  def apply(): AnonModelRoot = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonModelRoot]
  }
  @scala.inline
  implicit class AnonModelRootOps[Self <: AnonModelRoot] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withComponent(value: dxTreeMap): Self = {
    ...
    @scala.inline
    def withRoot(value: dxTreeMapNode): Self = {
        val ret = this.duplicate
