...
@js.native
trait AnonModel[T] extends js.Object {
...
object AnonModel {
  @scala.inline
  def apply[T](): AnonModel[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonModel[T]]
  }
  @scala.inline
  implicit class AnonModelOps[Self[t] <: AnonModel[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
