...
trait AnonCustomLoad extends js.Object {
  var customLoad: js.UndefOr[js.Function0[Promise[_] | JQueryPromise[_]]] = js.native
...
object AnonCustomLoad {
  @scala.inline
  def apply(): AnonCustomLoad = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCustomLoad]
  }
  @scala.inline
  implicit class AnonCustomLoadOps[Self <: AnonCustomLoad] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withCustomLoad(value: () => Promise[_] | JQueryPromise[_]): Self = {
