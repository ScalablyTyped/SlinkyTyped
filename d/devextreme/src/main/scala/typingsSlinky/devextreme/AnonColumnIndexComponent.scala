...
@js.native
trait AnonColumnIndexComponent extends js.Object {
...
object AnonColumnIndexComponent {
  @scala.inline
  def apply(): AnonColumnIndexComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonColumnIndexComponent]
  }
  @scala.inline
  implicit class AnonColumnIndexComponentOps[Self <: AnonColumnIndexComponent] (val x: Self) extends AnyVal {
    @scala.inline
