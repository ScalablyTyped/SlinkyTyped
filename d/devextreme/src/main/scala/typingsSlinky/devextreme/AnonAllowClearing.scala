...
object AnonAllowClearing {
  @scala.inline
  def apply(): AnonAllowClearing = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAllowClearing]
  }
  @scala.inline
  implicit class AnonAllowClearingOps[Self <: AnonAllowClearing] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataSourceFunction1(value: /* options */ AnonDataKey => js.Array[_] | DataSourceOptions | Store): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDataSource(
      value: js.Array[_] | DataSourceOptions | Store | (js.Function1[/* options */ AnonDataKey, js.Array[_] | DataSourceOptions | Store])
    ): Self = {
        val ret = this.duplicate
