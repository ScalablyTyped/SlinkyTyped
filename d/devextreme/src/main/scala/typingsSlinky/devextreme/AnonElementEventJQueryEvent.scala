...
object AnonElementEventJQueryEvent {
  @scala.inline
  def apply[T](): AnonElementEventJQueryEvent[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonElementEventJQueryEvent[T]]
  }
  @scala.inline
  implicit class AnonElementEventJQueryEventOps[Self[t] <: AnonElementEventJQueryEvent[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
