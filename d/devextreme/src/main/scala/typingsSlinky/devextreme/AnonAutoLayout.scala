...
trait AnonAutoLayout extends js.Object {
  var autoLayout: js.UndefOr[off | tree | layered | AnonOrientation] = js.native
...
object AnonAutoLayout {
  @scala.inline
  def apply(): AnonAutoLayout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAutoLayout]
  }
  @scala.inline
  implicit class AnonAutoLayoutOps[Self <: AnonAutoLayout] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAutoLayout(value: off | tree | layered | AnonOrientation): Self = {
