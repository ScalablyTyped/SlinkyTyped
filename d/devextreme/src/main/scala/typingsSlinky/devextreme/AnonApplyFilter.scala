...
trait AnonApplyFilter extends js.Object {
  ...
  var operationDescriptions: js.UndefOr[AnonBetween] = js.native
...
object AnonApplyFilter {
  @scala.inline
  def apply(): AnonApplyFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonApplyFilter]
  }
  @scala.inline
  implicit class AnonApplyFilterOps[Self <: AnonApplyFilter] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOperationDescriptions(value: AnonBetween): Self = {
        val ret = this.duplicate
