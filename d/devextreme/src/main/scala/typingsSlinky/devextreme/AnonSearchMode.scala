...
object AnonSearchMode {
  @scala.inline
  def apply(): AnonSearchMode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonSearchMode]
  }
  @scala.inline
  implicit class AnonSearchModeOps[Self <: AnonSearchMode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataSourceFunction1(value: /* options */ AnonDataSource => _): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dataSource")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDataSource(value: js.Array[_] | (js.Function1[/* options */ AnonDataSource, _]) | DataSourceOptions): Self = {
        val ret = this.duplicate
