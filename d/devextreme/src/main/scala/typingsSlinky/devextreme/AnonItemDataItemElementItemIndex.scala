...
@js.native
trait AnonItemDataItemElementItemIndex extends js.Object {
...
object AnonItemDataItemElementItemIndex {
  @scala.inline
  def apply(): AnonItemDataItemElementItemIndex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonItemDataItemElementItemIndex]
  }
  @scala.inline
  implicit class AnonItemDataItemElementItemIndexOps[Self <: AnonItemDataItemElementItemIndex] (val x: Self) extends AnyVal {
    @scala.inline
