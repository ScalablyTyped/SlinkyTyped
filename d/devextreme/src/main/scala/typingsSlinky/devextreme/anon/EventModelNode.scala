...
@js.native
trait EventModelNode extends js.Object {
...
object EventModelNode {
  ...
  @scala.inline
  def apply(): EventModelNode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EventModelNode]
  }
  
  @scala.inline
  implicit class EventModelNodeOps[Self <: EventModelNode] (val x: Self) extends AnyVal {
