...
trait BorderWidth extends StObject {
  ...
  var dataSource: js.UndefOr[
    js.Any | typingsSlinky.devextreme.mod.DevExpress.data.DataSource | DataSourceOptions | String | js.Array[_]
  ] = js.native
...
object BorderWidth {
  ...
  implicit class BorderWidthMutableBuilder[Self <: BorderWidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSource(
      value: js.Any | typingsSlinky.devextreme.mod.DevExpress.data.DataSource | DataSourceOptions | String | js.Array[_]
