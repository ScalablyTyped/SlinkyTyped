...
trait CustomizeTextFormat extends js.Object {
  var customizeText: js.UndefOr[js.Function1[/* markerValue */ ValueTextString, String]] = js.native
...
object CustomizeTextFormat {
  ...
  implicit class CustomizeTextFormatOps[Self <: CustomizeTextFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCustomizeText(value: /* markerValue */ ValueTextString => String): Self = {
