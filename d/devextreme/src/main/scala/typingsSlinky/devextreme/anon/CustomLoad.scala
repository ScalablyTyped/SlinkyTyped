...
trait CustomLoad extends js.Object {
  var customLoad: js.UndefOr[js.Function0[typingsSlinky.devextreme.mod.global.Promise[_] | JQueryPromise[_]]] = js.undefined
...
object CustomLoad {
  @scala.inline
  def apply(
    customLoad: () => typingsSlinky.devextreme.mod.global.Promise[_] | JQueryPromise[_] = null,
