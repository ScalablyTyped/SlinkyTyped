...
@js.native
trait DisplayValueOldValue extends StObject {
...
object DisplayValueOldValue {
  ...
  @scala.inline
  implicit class DisplayValueOldValueMutableBuilder[Self <: DisplayValueOldValue] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setColumn(value: DisplayValueOldValue): Self = StObject.set(x, "column", value.asInstanceOf[js.Any])
