...
trait ApplyChangesMode extends StObject {
  ...
  var layout: js.UndefOr[
    typingsSlinky.devextreme.devextremeNumbers.`0` | typingsSlinky.devextreme.devextremeNumbers.`1` | typingsSlinky.devextreme.devextremeNumbers.`2`
  ] = js.native
...
object ApplyChangesMode {
  ...
  implicit class ApplyChangesModeMutableBuilder[Self <: ApplyChangesMode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayout(
      value: typingsSlinky.devextreme.devextremeNumbers.`0` | typingsSlinky.devextreme.devextremeNumbers.`1` | typingsSlinky.devextreme.devextremeNumbers.`2`
