...
object AlignItemLabels {
  ...
  implicit class AlignItemLabelsMutableBuilder[Self <: AlignItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTabTemplateElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "tabTemplate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTemplateElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
