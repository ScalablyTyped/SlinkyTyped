...
object PreviousValueValue {
  ...
  implicit class PreviousValueValueMutableBuilder[Self <: PreviousValueValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousValue(value: js.Array[org.scalajs.dom.raw.File]): Self = StObject.set(x, "previousValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreviousValueUndefined: Self = StObject.set(x, "previousValue", js.undefined)
    
    @scala.inline
    def setPreviousValueVarargs(value: org.scalajs.dom.raw.File*): Self = StObject.set(x, "previousValue", js.Array(value :_*))
    
    @scala.inline
    def setValue(value: js.Array[org.scalajs.dom.raw.File]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
    
    @scala.inline
    def setValueVarargs(value: org.scalajs.dom.raw.File*): Self = StObject.set(x, "value", js.Array(value :_*))
  }
}
