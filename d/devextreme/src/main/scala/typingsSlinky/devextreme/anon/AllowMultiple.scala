...
object AllowMultiple {
  ...
  def apply(
    ...
    dataSource: String | js.Array[_] | typingsSlinky.devextreme.mod.DevExpress.data.DataSource | DataSourceOptions = null,
    ...
    if (!js.isUndefined(useColorAsDefault)) __obj.updateDynamic("useColorAsDefault")(useColorAsDefault.get.asInstanceOf[js.Any])
