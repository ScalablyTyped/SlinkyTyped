...
@js.native
trait AppointmentDataAppointmentElement extends StObject {
...
object AppointmentDataAppointmentElement {
  ...
  @scala.inline
  implicit class AppointmentDataAppointmentElementMutableBuilder[Self <: AppointmentDataAppointmentElement] (val x: Self) extends AnyVal {
