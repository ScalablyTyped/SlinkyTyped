...
object ArgumentFormat {
  ...
  implicit class ArgumentFormatOps[Self <: ArgumentFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgumentFormatFunction1(value: /* value */ Double | js.Date => String): Self = this.set("argumentFormat", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFont(value: typingsSlinky.devextreme.mod.DevExpress.viz.Font): Self = this.set("font", value.asInstanceOf[js.Any])
