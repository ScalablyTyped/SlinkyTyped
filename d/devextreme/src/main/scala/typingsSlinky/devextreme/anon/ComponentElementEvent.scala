...
@js.native
trait ComponentElementEvent extends StObject {
...
object ComponentElementEvent {
  ...
  @scala.inline
  implicit class ComponentElementEventMutableBuilder[Self <: ComponentElementEvent] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setComponent(value: dxHtmlEditor): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
