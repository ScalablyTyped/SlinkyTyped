...
@js.native
trait ElementEventItemData extends StObject {
...
object ElementEventItemData {
  
  @scala.inline
  def apply(): ElementEventItemData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementEventItemData]
  }
  
  @scala.inline
  implicit class ElementEventItemDataMutableBuilder[Self <: ElementEventItemData] (val x: Self) extends AnyVal {
