...
@js.native
trait CustomDataExpr extends js.Object {
...
object CustomDataExpr {
  ...
  @scala.inline
  implicit class CustomDataExprOps[Self <: CustomDataExpr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSource(value: js.Array[_] | typingsSlinky.devextreme.mod.DevExpress.data.DataSource | DataSourceOptions): Self = this.set("dataSource", value.asInstanceOf[js.Any])
