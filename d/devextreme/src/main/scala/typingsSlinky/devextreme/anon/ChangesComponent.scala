...
@js.native
trait ChangesComponent[T] extends js.Object {
...
object ChangesComponent {
  ...
  @scala.inline
  implicit class ChangesComponentOps[Self <: ChangesComponent[_], T] (val x: Self with ChangesComponent[T]) extends AnyVal {
