...
@js.native
trait ElementEventModelTarget extends StObject {
...
object ElementEventModelTarget {
  
  @scala.inline
  def apply(): ElementEventModelTarget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementEventModelTarget]
  }
  
  @scala.inline
  implicit class ElementEventModelTargetMutableBuilder[Self <: ElementEventModelTarget] (val x: Self) extends AnyVal {
