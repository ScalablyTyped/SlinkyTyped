...
@js.native
trait JQueryEventModelTarget extends js.Object {
...
object JQueryEventModelTarget {
  @scala.inline
  def apply(): JQueryEventModelTarget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[JQueryEventModelTarget]
  }
  @scala.inline
  implicit class JQueryEventModelTargetOps[Self <: JQueryEventModelTarget] (val x: Self) extends AnyVal {
    @scala.inline
