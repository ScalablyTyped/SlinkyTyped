...
object CurrentDeselectedItemKeys {
  ...
  implicit class CurrentDeselectedItemKeysMutableBuilder[Self <: CurrentDeselectedItemKeys] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectedItems(value: js.Array[typingsSlinky.devextreme.mod.DevExpress.fileManagement.FileSystemItem]): Self = StObject.set(x, "selectedItems", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectedItemsUndefined: Self = StObject.set(x, "selectedItems", js.undefined)
    
    @scala.inline
    def setSelectedItemsVarargs(value: typingsSlinky.devextreme.mod.DevExpress.fileManagement.FileSystemItem*): Self = StObject.set(x, "selectedItems", js.Array(value :_*))
  }
}
