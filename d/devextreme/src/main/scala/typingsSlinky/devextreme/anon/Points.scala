...
object Points {
  ...
  implicit class PointsMutableBuilder[Self <: Points] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: dxPieChart): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTarget(value: String | Double): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
