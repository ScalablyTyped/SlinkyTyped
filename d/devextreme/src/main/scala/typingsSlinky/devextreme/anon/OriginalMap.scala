...
@js.native
trait OriginalMap extends js.Object {
...
object OriginalMap {
  ...
  @scala.inline
  implicit class OriginalMapOps[Self <: OriginalMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginalMap(value: js.Any): Self = this.set("originalMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOriginalMap: Self = this.set("originalMap", js.undefined)
  }
}
