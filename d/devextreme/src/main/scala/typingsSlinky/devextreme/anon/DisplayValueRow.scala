...
@js.native
trait DisplayValueRow extends js.Object {
...
object DisplayValueRow {
  ...
  @scala.inline
  implicit class DisplayValueRowOps[Self <: DisplayValueRow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumn(value: DisplayValueRow): Self = this.set("column", value.asInstanceOf[js.Any])
