...
@js.native
trait DisplayValueRow extends StObject {
...
object DisplayValueRow {
  
  @scala.inline
  def apply(): DisplayValueRow = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisplayValueRow]
  }
  
  @scala.inline
  implicit class DisplayValueRowMutableBuilder[Self <: DisplayValueRow] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setColumn(value: DisplayValueRow): Self = StObject.set(x, "column", value.asInstanceOf[js.Any])
