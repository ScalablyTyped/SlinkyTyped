...
object CustomItem {
  ...
  implicit class CustomItemOps[Self <: CustomItem[_], T] (val x: Self with CustomItem[T]) extends AnyVal {
    ...
    @scala.inline
    def setCustomItem(value: String | js.Any | typingsSlinky.devextreme.mod.global.Promise[_] | JQueryPromise[_]): Self = this.set("customItem", value.asInstanceOf[js.Any])
