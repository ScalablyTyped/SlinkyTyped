...
object SearchTimeout {
  ...
  implicit class SearchTimeoutOps[Self <: SearchTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShowRelevantValues(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showRelevantValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutShowRelevantValues: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showRelevantValues")(js.undefined)
        ret
    }
    @scala.inline
