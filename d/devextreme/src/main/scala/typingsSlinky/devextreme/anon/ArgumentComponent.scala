...
@js.native
trait ArgumentComponent extends js.Object {
...
object ArgumentComponent {
  ...
  @scala.inline
  implicit class ArgumentComponentOps[Self <: ArgumentComponent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgument(value: js.Date | Double | String): Self = this.set("argument", value.asInstanceOf[js.Any])
