...
@js.native
trait ElementEventJQueryEventModel extends js.Object {
...
object ElementEventJQueryEventModel {
  @scala.inline
  def apply(): ElementEventJQueryEventModel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementEventJQueryEventModel]
  }
  @scala.inline
  implicit class ElementEventJQueryEventModelOps[Self <: ElementEventJQueryEventModel] (val x: Self) extends AnyVal {
    @scala.inline
