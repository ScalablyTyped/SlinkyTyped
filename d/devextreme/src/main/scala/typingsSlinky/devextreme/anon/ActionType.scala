...
object ActionType {
  ...
  implicit class ActionTypeOps[Self <: ActionType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRangeEndDate(value: js.Date): Self = this.set("rangeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def setRangeEnd(value: js.Date | Double): Self = this.set("rangeEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRangeEnd: Self = this.set("rangeEnd", js.undefined)
    @scala.inline
    def setRangeStartDate(value: js.Date): Self = this.set("rangeStart", value.asInstanceOf[js.Any])
    @scala.inline
    def setRangeStart(value: js.Date | Double): Self = this.set("rangeStart", value.asInstanceOf[js.Any])
    @scala.inline
