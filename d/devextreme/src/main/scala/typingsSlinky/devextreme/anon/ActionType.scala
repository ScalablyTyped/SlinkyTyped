...
object ActionType {
  ...
  implicit class ActionTypeMutableBuilder[Self <: ActionType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRangeEnd(value: js.Date | Double): Self = StObject.set(x, "rangeEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangeEndDate(value: js.Date): Self = StObject.set(x, "rangeEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangeEndUndefined: Self = StObject.set(x, "rangeEnd", js.undefined)
    
    @scala.inline
    def setRangeStart(value: js.Date | Double): Self = StObject.set(x, "rangeStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangeStartDate(value: js.Date): Self = StObject.set(x, "rangeStart", value.asInstanceOf[js.Any])
