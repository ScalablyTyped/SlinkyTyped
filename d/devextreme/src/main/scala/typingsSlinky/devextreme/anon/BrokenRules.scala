...
trait BrokenRules[T] extends js.Object {
  ...
  var promise: js.UndefOr[typingsSlinky.devextreme.mod.global.Promise[Unit] | JQueryPromise[Unit]] = js.undefined
}
...
object BrokenRules {
  ...
  def apply[T](
    ...
    newData: js.Any = null,
    oldData: js.Any = null,
    promise: typingsSlinky.devextreme.mod.global.Promise[Unit] | JQueryPromise[Unit] = null
  ): BrokenRules[T] = {
