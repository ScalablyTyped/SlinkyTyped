...
object BrokenRules {
  ...
  @scala.inline
  implicit class BrokenRulesOps[Self[t] <: BrokenRules[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPromise(value: typingsSlinky.devextreme.mod.global.Promise[Unit] | JQueryPromise[Unit]): Self[T] = {
        val ret = this.duplicate
