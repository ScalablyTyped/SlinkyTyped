...
import typingsSlinky.devextreme.mod.DevExpress.viz.dxVectorMapAnnotationConfig
...
object `33` {
  ...
  implicit class `33Ops`[Self <: `33`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTarget(value: MapLayerElement | dxVectorMapAnnotationConfig): Self = this.set("target", value.asInstanceOf[js.Any])
