...
@js.native
trait ItemData[T] extends js.Object {
...
object ItemData {
  ...
  @scala.inline
  implicit class ItemDataOps[Self[t] <: ItemData[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withItemElement(value: dxElement): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withItemIndex(value: Double): Self[T] = {
        val ret = this.duplicate
