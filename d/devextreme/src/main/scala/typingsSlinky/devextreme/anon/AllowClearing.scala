...
object AllowClearing {
  ...
  implicit class AllowClearingOps[Self <: AllowClearing] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourceFunction1(value: /* options */ DataKey => js.Array[_] | DataSourceOptions | Store): Self = this.set("dataSource", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setValueExpr(value: String): Self = this.set("valueExpr", value.asInstanceOf[js.Any])
