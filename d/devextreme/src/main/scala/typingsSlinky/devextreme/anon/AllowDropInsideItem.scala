...
object AllowDropInsideItem {
  ...
  implicit class AllowDropInsideItemMutableBuilder[Self <: AllowDropInsideItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundary(value: String | org.scalajs.dom.raw.Element | JQuery): Self = StObject.set(x, "boundary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundaryElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "boundary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundaryUndefined: Self = StObject.set(x, "boundary", js.undefined)
    
    @scala.inline
    def setContainer(value: String | org.scalajs.dom.raw.Element | JQuery): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContainerElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDragTemplateElement(value: org.scalajs.dom.raw.Element): Self = StObject.set(x, "dragTemplate", value.asInstanceOf[js.Any])
