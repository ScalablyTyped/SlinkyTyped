...
object AllowDropInsideItem {
  ...
  implicit class AllowDropInsideItemOps[Self <: AllowDropInsideItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundaryElement(value: org.scalajs.dom.raw.Element): Self = this.set("boundary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundary(value: String | org.scalajs.dom.raw.Element | JQuery): Self = this.set("boundary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBoundary: Self = this.set("boundary", js.undefined)
    
    @scala.inline
    def setContainerElement(value: org.scalajs.dom.raw.Element): Self = this.set("container", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContainer(value: String | org.scalajs.dom.raw.Element | JQuery): Self = this.set("container", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDragTemplateElement(value: org.scalajs.dom.raw.Element): Self = this.set("dragTemplate", value.asInstanceOf[js.Any])
