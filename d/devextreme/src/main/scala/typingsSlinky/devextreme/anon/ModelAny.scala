...
@js.native
trait ModelAny[T] extends js.Object {
...
object ModelAny {
  @scala.inline
  def apply[T](): ModelAny[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModelAny[T]]
  }
  @scala.inline
  implicit class ModelAnyOps[Self[t] <: ModelAny[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
