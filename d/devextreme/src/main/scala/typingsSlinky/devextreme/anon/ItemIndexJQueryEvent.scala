...
@js.native
trait ItemIndexJQueryEvent extends js.Object {
...
object ItemIndexJQueryEvent {
  @scala.inline
  def apply(): ItemIndexJQueryEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ItemIndexJQueryEvent]
  }
  @scala.inline
  implicit class ItemIndexJQueryEventOps[Self <: ItemIndexJQueryEvent] (val x: Self) extends AnyVal {
    @scala.inline
