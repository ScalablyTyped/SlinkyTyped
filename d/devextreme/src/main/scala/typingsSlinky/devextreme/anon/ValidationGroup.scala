...
@js.native
trait ValidationGroup extends js.Object {
...
object ValidationGroup {
  ...
  @scala.inline
  implicit class ValidationGroupOps[Self <: ValidationGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: dxButton): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValidationGroup(value: js.Any): Self = this.set("validationGroup", value.asInstanceOf[js.Any])
