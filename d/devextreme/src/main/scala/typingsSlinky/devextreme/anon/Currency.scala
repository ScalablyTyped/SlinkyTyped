...
object Currency {
  ...
  implicit class CurrencyOps[Self <: Currency] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatter(value: /* value */ Double | js.Date => String): Self = this.set("formatter", js.Any.fromFunction1(value))
    @scala.inline
    def deleteFormatter: Self = this.set("formatter", js.undefined)
    @scala.inline
    def setParser(value: /* value */ String => Double | js.Date): Self = this.set("parser", js.Any.fromFunction1(value))
    @scala.inline
