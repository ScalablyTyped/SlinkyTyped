...
@js.native
trait ColumnIndexComponent extends StObject {
...
object ColumnIndexComponent {
  
  @scala.inline
  def apply(): ColumnIndexComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnIndexComponent]
  }
  
  @scala.inline
  implicit class ColumnIndexComponentMutableBuilder[Self <: ColumnIndexComponent] (val x: Self) extends AnyVal {
