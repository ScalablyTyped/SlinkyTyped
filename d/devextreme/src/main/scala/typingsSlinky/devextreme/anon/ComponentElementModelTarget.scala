...
@js.native
trait ComponentElementModelTarget[T] extends js.Object {
...
object ComponentElementModelTarget {
  ...
  @scala.inline
  implicit class ComponentElementModelTargetOps[Self[t] <: ComponentElementModelTarget[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTarget(value: js.Any): Self[T] = {
        val ret = this.duplicate
