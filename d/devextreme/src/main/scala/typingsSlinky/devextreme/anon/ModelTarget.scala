...
@js.native
trait ModelTarget[T] extends js.Object {
...
object ModelTarget {
  ...
  @scala.inline
  def apply[T](): ModelTarget[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModelTarget[T]]
  }
  
  @scala.inline
  implicit class ModelTargetOps[Self <: ModelTarget[_], T] (val x: Self with ModelTarget[T]) extends AnyVal {
