...
object ColumnPath {
  ...
  implicit class ColumnPathOps[Self <: ColumnPath] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnPathVarargs(value: (String | Double | js.Date)*): Self = this.set("columnPath", js.Array(value :_*))
    @scala.inline
    def setColumnPath(value: js.Array[String | Double | js.Date]): Self = this.set("columnPath", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRowPathVarargs(value: (String | Double | js.Date)*): Self = this.set("rowPath", js.Array(value :_*))
    @scala.inline
    def setRowPath(value: js.Array[String | Double | js.Date]): Self = this.set("rowPath", value.asInstanceOf[js.Any])
    @scala.inline
