...
@js.native
trait AnonCancelColumn extends js.Object {
...
object AnonCancelColumn {
  @scala.inline
  def apply(): AnonCancelColumn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCancelColumn]
  }
  @scala.inline
  implicit class AnonCancelColumnOps[Self <: AnonCancelColumn] (val x: Self) extends AnyVal {
    @scala.inline
