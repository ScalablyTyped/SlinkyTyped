...
object AnonCancelComponentElementModel {
  @scala.inline
  def apply[T](): AnonCancelComponentElementModel[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCancelComponentElementModel[T]]
  }
  @scala.inline
  implicit class AnonCancelComponentElementModelOps[Self[t] <: AnonCancelComponentElementModel[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
