...
@js.native
trait AnonDropInsideItem extends js.Object {
...
object AnonDropInsideItem {
  @scala.inline
  def apply(): AnonDropInsideItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonDropInsideItem]
  }
  @scala.inline
  implicit class AnonDropInsideItemOps[Self <: AnonDropInsideItem] (val x: Self) extends AnyVal {
    @scala.inline
