...
@js.native
trait AnonJQueryEvent[T] extends js.Object {
...
object AnonJQueryEvent {
  @scala.inline
  def apply[T](): AnonJQueryEvent[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonJQueryEvent[T]]
  }
  @scala.inline
  implicit class AnonJQueryEventOps[Self[t] <: AnonJQueryEvent[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
