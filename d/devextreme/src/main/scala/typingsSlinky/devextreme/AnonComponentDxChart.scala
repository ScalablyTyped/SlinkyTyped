...
object AnonComponentDxChart {
  @scala.inline
  def apply(): AnonComponentDxChart = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentDxChart]
  }
  @scala.inline
  implicit class AnonComponentDxChartOps[Self <: AnonComponentDxChart] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTarget(value: chartSeriesObject): Self = {
        val ret = this.duplicate
