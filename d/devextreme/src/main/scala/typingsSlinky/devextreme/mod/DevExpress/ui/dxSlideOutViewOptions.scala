...
object dxSlideOutViewOptions {
  ...
  def apply(
    ...
    contentTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function1[/* contentElement */ dxElement, _]) = null,
    ...
    menuTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function1[/* menuElement */ dxElement, _]) = null,
