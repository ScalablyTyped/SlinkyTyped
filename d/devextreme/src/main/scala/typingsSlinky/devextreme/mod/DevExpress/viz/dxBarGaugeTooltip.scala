...
import typingsSlinky.devextreme.AnonIndex
...
trait dxBarGaugeTooltip extends BaseWidgetTooltip {
  ...
  var customizeTooltip: js.UndefOr[js.Function1[/* scaleValue */ AnonIndex, _]] = js.native
}
...
object dxBarGaugeTooltip {
  ...
  implicit class dxBarGaugeTooltipOps[Self <: dxBarGaugeTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentTemplateFunction2(value: (/* scaleValue */ AnonIndex, /* element */ dxElement) => String | Element | JQuery): Self = {
    ...
    def withContentTemplate(
      value: template | (js.Function2[/* scaleValue */ AnonIndex, /* element */ dxElement, String | Element | JQuery])
    ): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contentTemplate")(value.asInstanceOf[js.Any])
        ret
    ...
    @scala.inline
    def withCustomizeTooltip(value: /* scaleValue */ AnonIndex => _): Self = {
        val ret = this.duplicate
