...
import typingsSlinky.devextreme.anon.AutoUpdateParentTasks
import typingsSlinky.devextreme.anon.ColorExpr
import typingsSlinky.devextreme.anon.ComponentElementName
import typingsSlinky.devextreme.anon.EndExpr
import typingsSlinky.devextreme.anon.EventKey
import typingsSlinky.devextreme.anon.HiddenFields
import typingsSlinky.devextreme.anon.KeyExpr
import typingsSlinky.devextreme.anon.KeyModel
import typingsSlinky.devextreme.anon.ModelValues
import typingsSlinky.devextreme.anon.NewValues
import typingsSlinky.devextreme.anon.ResourceIdExpr
import typingsSlinky.devextreme.anon.SelectedRowKey
import typingsSlinky.devextreme.anon.TargetKey
...
trait dxGanttOptions extends WidgetOptions[dxGantt] {
  ...
  var taskTooltipContentTemplate: js.UndefOr[
    typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* container */ dxElement, /* task */ js.Any, _])
  ] = js.native
...
object dxGanttOptions {
  ...
  implicit class dxGanttOptionsOps[Self <: dxGanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTaskTooltipContentTemplateElement(value: Element): Self = this.set("taskTooltipContentTemplate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTaskTooltipContentTemplate(
      value: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* container */ dxElement, /* task */ js.Any, _])
