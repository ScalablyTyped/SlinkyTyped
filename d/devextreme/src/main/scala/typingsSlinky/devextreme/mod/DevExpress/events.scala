...
object events {
  ...
  @js.native
  trait dxEvent
    extends typingsSlinky.devextreme.mod.DevExpress.events.event {
  ...
  object dxEvent {
    ...
    def apply(
      ...
      __obj.asInstanceOf[typingsSlinky.devextreme.mod.DevExpress.events.dxEvent]
    }
    
    @scala.inline
    implicit class dxEventMutableBuilder[Self <: typingsSlinky.devextreme.mod.DevExpress.events.dxEvent] (val x: Self) extends AnyVal {
  ...
  */
  ...
  object event {
    ...
    @scala.inline
    def JQueryEventObject(): typingsSlinky.devextreme.mod.global.JQueryEventObject = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.devextreme.mod.global.JQueryEventObject]
    }
