...
object dxChartSeriesTypesFullStackedLineSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesFullStackedLineSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesFullStackedLineSeriesLabel = null,
  ...
  ): dxChartSeriesTypesFullStackedLineSeries = {
