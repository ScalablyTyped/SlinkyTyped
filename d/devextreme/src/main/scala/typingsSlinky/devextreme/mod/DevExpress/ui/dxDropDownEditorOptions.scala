...
import typingsSlinky.devextreme.anon.`2`
...
object dxDropDownEditorOptions {
  ...
  implicit class dxDropDownEditorOptionsOps[Self <: dxDropDownEditorOptions[_], T] (val x: Self with dxDropDownEditorOptions[T]) extends AnyVal {
    ...
    @scala.inline
    def setDropDownButtonTemplateElement(value: Element): Self = this.set("dropDownButtonTemplate", value.asInstanceOf[js.Any])
