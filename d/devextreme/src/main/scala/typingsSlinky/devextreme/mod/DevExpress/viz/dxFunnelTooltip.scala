...
trait dxFunnelTooltip extends BaseWidgetTooltip {
  ...
  var customizeTooltip: js.UndefOr[js.Function1[/* info */ Percent, _]] = js.undefined
}
...
object dxFunnelTooltip {
  ...
  def apply(
    ...
    contentTemplate: template | (js.Function2[/* info */ Percent, /* element */ dxElement, String | Element | JQuery]) = null,
    cornerRadius: js.UndefOr[Double] = js.undefined,
    customizeTooltip: /* info */ Percent => _ = null,
