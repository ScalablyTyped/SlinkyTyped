...
object ODataStoreOptions {
  ...
  def apply(
    ...
    keyType: String | Int32 | Int64 | typingsSlinky.devextreme.devextremeStrings.Guid | typingsSlinky.devextreme.devextremeStrings.Boolean | Single | Decimal | js.Any = null,
