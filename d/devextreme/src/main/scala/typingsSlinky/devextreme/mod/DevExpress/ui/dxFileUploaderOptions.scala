...
trait dxFileUploaderOptions extends EditorOptions[dxFileUploader] {
  ...
  var onUploadAborted: js.UndefOr[js.Function1[/* e */ typingsSlinky.devextreme.anon.File, _]] = js.undefined
  ...
  var onUploadStarted: js.UndefOr[js.Function1[/* e */ typingsSlinky.devextreme.anon.File, _]] = js.undefined
  /** @name dxFileUploader.Options.onUploaded */
  var onUploaded: js.UndefOr[js.Function1[/* e */ typingsSlinky.devextreme.anon.File, _]] = js.undefined
...
object dxFileUploaderOptions {
  ...
  def apply(
    ...
    onUploadAborted: /* e */ typingsSlinky.devextreme.anon.File => _ = null,
    onUploadError: /* e */ Request => _ = null,
    onUploadStarted: /* e */ typingsSlinky.devextreme.anon.File => _ = null,
    onUploaded: /* e */ typingsSlinky.devextreme.anon.File => _ = null,
