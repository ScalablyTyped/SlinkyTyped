...
import typingsSlinky.devextreme.anon.ComponentDxDeferRendering
...
trait dxDeferRenderingOptions extends WidgetOptions[dxDeferRendering] {
  ...
  var onRendered: js.UndefOr[js.Function1[/* e */ ComponentDxDeferRendering, _]] = js.native
  /** A function that is executed when the content is displayed and animation is completed. */
  var onShown: js.UndefOr[js.Function1[/* e */ ComponentDxDeferRendering, _]] = js.native
...
object dxDeferRenderingOptions {
  ...
  implicit class dxDeferRenderingOptionsOps[Self <: dxDeferRenderingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnRendered(value: /* e */ ComponentDxDeferRendering => _): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnShown(value: /* e */ ComponentDxDeferRendering => _): Self = {
        val ret = this.duplicate
