...
import typingsSlinky.devextreme.anon.ComponentDxTreeList
...
trait dxTreeListEditing extends GridBaseEditing {
  ...
  var allowAdding: js.UndefOr[Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])] = js.native
  /** Specifies whether a user can delete rows. It is called for each data row when defined as a function. */
  var allowDeleting: js.UndefOr[Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])] = js.native
  /** Specifies whether a user can update rows. It is called for each data row when defined as a function */
  var allowUpdating: js.UndefOr[Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])] = js.native
...
object dxTreeListEditing {
  ...
  implicit class dxTreeListEditingOps[Self <: dxTreeListEditing] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowAddingFunction1(value: /* options */ ComponentDxTreeList => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowAdding")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAllowAdding(value: Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAllowDeletingFunction1(value: /* options */ ComponentDxTreeList => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowDeleting")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAllowDeleting(value: Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withAllowUpdatingFunction1(value: /* options */ ComponentDxTreeList => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowUpdating")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAllowUpdating(value: Boolean | (js.Function1[/* options */ ComponentDxTreeList, Boolean])): Self = {
        val ret = this.duplicate
