...
object dxChartSeriesTypesFullStackedBarSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesFullStackedBarSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesFullStackedBarSeriesLabel = null,
  ...
  ): dxChartSeriesTypesFullStackedBarSeries = {
