...
object dxToastOptions {
  ...
  def apply(
    ...
    contentTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function1[/* contentElement */ dxElement, String | Element | JQuery]) = null,
    ...
    onInitialized: /* e */ typingsSlinky.devextreme.anon.Element[dxToast] => _ = null,
