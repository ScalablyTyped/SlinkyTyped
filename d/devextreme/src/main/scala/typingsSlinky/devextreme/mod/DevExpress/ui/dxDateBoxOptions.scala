...
object dxDateBoxOptions {
  ...
  implicit class dxDateBoxOptionsOps[Self <: dxDateBoxOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledDates(value: js.Array[js.Date] | (js.Function1[/* data */ ComponentDate, Boolean])): Self = this.set("disabledDates", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisabledDates: Self = this.set("disabledDates", js.undefined)
    @scala.inline
    def setDisplayFormatFunction1(value: /* value */ Double | js.Date => String): Self = this.set("displayFormat", js.Any.fromFunction1(value))
    @scala.inline
