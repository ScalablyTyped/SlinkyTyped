...
object dxChartSeriesTypesSplineAreaSeries {
  ...
  implicit class dxChartSeriesTypesSplineAreaSeriesOps[Self <: dxChartSeriesTypesSplineAreaSeries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAggregation(value: dxChartSeriesTypesSplineAreaSeriesAggregation): Self = {
    ...
    @scala.inline
    def withLabel(value: dxChartSeriesTypesSplineAreaSeriesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoint(value: dxChartSeriesTypesSplineAreaSeriesPoint): Self = {
        val ret = this.duplicate
