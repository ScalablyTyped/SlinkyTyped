...
trait dxCalendarOptions extends EditorOptions[dxCalendar] {
  ...
  var disabledDates: js.UndefOr[js.Array[js.Date] | (js.Function1[/* data */ View, Boolean])] = js.undefined
...
object dxCalendarOptions {
  ...
  def apply(
    ...
    cellTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function3[
      /* itemData */ Date, 
      /* itemIndex */ Double, 
      /* itemElement */ dxElement, 
      String | Element | JQuery
    ...
    disabledDates: js.Array[js.Date] | (js.Function1[/* data */ View, Boolean]) = null,
    ...
    onInitialized: /* e */ typingsSlinky.devextreme.anon.Element[dxCalendar] => _ = null,
