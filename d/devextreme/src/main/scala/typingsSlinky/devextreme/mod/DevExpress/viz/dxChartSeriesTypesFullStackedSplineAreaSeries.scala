...
object dxChartSeriesTypesFullStackedSplineAreaSeries {
  ...
  implicit class dxChartSeriesTypesFullStackedSplineAreaSeriesOps[Self <: dxChartSeriesTypesFullStackedSplineAreaSeries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAggregation(value: dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation): Self = {
    ...
    @scala.inline
    def withLabel(value: dxChartSeriesTypesFullStackedSplineAreaSeriesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoint(value: dxChartSeriesTypesFullStackedSplineAreaSeriesPoint): Self = {
        val ret = this.duplicate
