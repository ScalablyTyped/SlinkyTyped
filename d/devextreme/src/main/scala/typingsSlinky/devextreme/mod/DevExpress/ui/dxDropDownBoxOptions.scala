...
- typingsSlinky.devextreme.mod.DevExpress.ui.DataExpressionMixinOptions because var conflicts: value. Inlined dataSource, displayExpr, itemTemplate, items, valueExpr */ trait dxDropDownBoxOptions extends dxDropDownEditorOptions[dxDropDownBox] {
...
object dxDropDownBoxOptions {
  ...
  def apply(
    ...
    contentTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[
      /* templateData */ ComponentValue, 
      /* contentElement */ dxElement, 
      String | Element | JQuery
    ]) = null,
    ...
    fieldTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* value */ js.Any, /* fieldElement */ dxElement, String | Element | JQuery]) = null,
    ...
    onInitialized: /* e */ typingsSlinky.devextreme.anon.Element[dxDropDownBox] => _ = null,
