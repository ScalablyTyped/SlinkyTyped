...
object dxToolbarOptions {
  ...
  def apply(
    ...
    onContentReady: /* e */ AnonComponentElement[dxToolbar] => _ = null,
    onDisposing: /* e */ AnonModel[dxToolbar] => _ = null,
    onInitialized: /* e */ AnonElement[dxToolbar] => _ = null,
    onItemClick: (js.Function1[/* e */ AnonEvent[dxToolbar], _]) | String = null,
    onItemContextMenu: /* e */ AnonEvent[dxToolbar] => _ = null,
    onItemHold: /* e */ AnonItemData[dxToolbar] => _ = null,
    onItemRendered: /* e */ AnonItemElement[dxToolbar] => _ = null,
    onOptionChanged: /* e */ AnonName[dxToolbar] => _ = null,
    onSelectionChanged: /* e */ AnonAddedItems[dxToolbar] => _ = null,
