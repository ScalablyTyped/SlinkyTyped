...
object dxChartValueAxis {
  ...
  implicit class dxChartValueAxisOps[Self <: dxChartValueAxis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomPositionDate(value: js.Date): Self = this.set("customPosition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomPosition(value: Double | js.Date | String): Self = this.set("customPosition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVisualRangeVarargs(value: (Double | String | js.Date)*): Self = this.set("visualRange", js.Array(value :_*))
    
    @scala.inline
    def setVisualRange(value: VizRange | (js.Array[Double | String | js.Date])): Self = this.set("visualRange", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWholeRangeVarargs(value: (Double | String | js.Date)*): Self = this.set("wholeRange", js.Array(value :_*))
    
    @scala.inline
    def setWholeRange(value: VizRange | (js.Array[Double | String | js.Date])): Self = this.set("wholeRange", value.asInstanceOf[js.Any])
