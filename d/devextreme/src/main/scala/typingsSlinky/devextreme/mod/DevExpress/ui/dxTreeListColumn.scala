...
object dxTreeListColumn {
  ...
  def apply(
    ...
    caption: String = null,
    cellTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* cellElement */ dxElement, /* cellInfo */ DisplayValueOldValue, _]) = null,
    ...
    editCellTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* cellElement */ dxElement, /* cellInfo */ DisplayValueRow, _]) = null,
    ...
    format: format = null,
    headerCellTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[/* columnHeader */ dxElement, /* headerInfo */ ColumnColumnIndexComponent, _]) = null,
