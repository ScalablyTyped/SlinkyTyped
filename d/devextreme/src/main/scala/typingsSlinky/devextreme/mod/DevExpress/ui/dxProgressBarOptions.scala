...
object dxProgressBarOptions {
  ...
  def apply(
    ...
    max: Int | Double = null,
    min: Int | Double = null,
    onComplete: /* e */ AnonComponentElementEvent => _ = null,
    onContentReady: /* e */ AnonComponentElement[dxProgressBar] => _ = null,
    onDisposing: /* e */ AnonModel[dxProgressBar] => _ = null,
    onInitialized: /* e */ AnonElement[dxProgressBar] => _ = null,
    onOptionChanged: /* e */ AnonName[dxProgressBar] => _ = null,
    onValueChanged: /* e */ AnonJQueryEvent[dxProgressBar] => _ = null,
