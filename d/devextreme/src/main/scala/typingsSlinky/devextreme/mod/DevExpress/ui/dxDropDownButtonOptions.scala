...
object dxDropDownButtonOptions {
  ...
  def apply(
    ...
    dropDownContentTemplate: typingsSlinky.devextreme.mod.DevExpress.core.template | (js.Function2[
      /* data */ (js.Array[String | Double | _]) | DataSource, 
      /* contentElement */ dxElement, 
      String | Element | JQuery
    ]) = null,
    ...
    onInitialized: /* e */ typingsSlinky.devextreme.anon.Element[dxDropDownButton] => _ = null,
