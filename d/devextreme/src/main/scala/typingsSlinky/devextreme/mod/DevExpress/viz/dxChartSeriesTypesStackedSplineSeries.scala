...
object dxChartSeriesTypesStackedSplineSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesStackedSplineSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesStackedSplineSeriesLabel = null,
  ...
  ): dxChartSeriesTypesStackedSplineSeries = {
