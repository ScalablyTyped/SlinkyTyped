...
object dxPivotGridPivotGridCell {
  ...
  implicit class dxPivotGridPivotGridCellOps[Self <: dxPivotGridPivotGridCell] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathVarargs(value: (String | Double | js.Date)*): Self = this.set("path", js.Array(value :_*))
    
    @scala.inline
    def setPath(value: js.Array[String | Double | js.Date]): Self = this.set("path", value.asInstanceOf[js.Any])
