...
trait Query extends js.Object {
  ...
  /**
    * [descr:Query.max()]
    */
  def max(): (Promise[Double | js.Date]) with (JQueryPromise[Double | js.Date]) = js.native
  /**
    * [descr:Query.max(getter)]
    */
  def max(getter: js.Any): (Promise[Double | js.Date]) with (JQueryPromise[Double | js.Date]) = js.native
  
  /**
    * [descr:Query.min()]
    */
  def min(): (Promise[Double | js.Date]) with (JQueryPromise[Double | js.Date]) = js.native
  /**
    * [descr:Query.min(getter)]
    */
  def min(getter: js.Any): (Promise[Double | js.Date]) with (JQueryPromise[Double | js.Date]) = js.native
