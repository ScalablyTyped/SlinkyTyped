...
object dxChartSeriesTypesStackedAreaSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesStackedAreaSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesStackedAreaSeriesLabel = null,
    ...
    pane: String = null,
    point: dxChartSeriesTypesStackedAreaSeriesPoint = null,
  ...
  ): dxChartSeriesTypesStackedAreaSeries = {
