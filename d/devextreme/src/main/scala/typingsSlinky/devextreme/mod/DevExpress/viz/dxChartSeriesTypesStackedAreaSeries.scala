...
object dxChartSeriesTypesStackedAreaSeries {
  ...
  implicit class dxChartSeriesTypesStackedAreaSeriesOps[Self <: dxChartSeriesTypesStackedAreaSeries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAggregation(value: dxChartSeriesTypesStackedAreaSeriesAggregation): Self = {
    ...
    @scala.inline
    def withLabel(value: dxChartSeriesTypesStackedAreaSeriesLabel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoint(value: dxChartSeriesTypesStackedAreaSeriesPoint): Self = {
        val ret = this.duplicate
