...
@js.native
trait AnonJQueryEventModelTarget extends js.Object {
...
object AnonJQueryEventModelTarget {
  @scala.inline
  def apply(): AnonJQueryEventModelTarget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonJQueryEventModelTarget]
  }
  @scala.inline
  implicit class AnonJQueryEventModelTargetOps[Self <: AnonJQueryEventModelTarget] (val x: Self) extends AnyVal {
    @scala.inline
