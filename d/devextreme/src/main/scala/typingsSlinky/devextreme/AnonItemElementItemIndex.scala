...
trait AnonItemElementItemIndex[T] extends js.Object {
  ...
  var itemElement: js.UndefOr[js.Any] = js.native
...
object AnonItemElementItemIndex {
  @scala.inline
  def apply[T](): AnonItemElementItemIndex[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonItemElementItemIndex[T]]
  }
  @scala.inline
  implicit class AnonItemElementItemIndexOps[Self[t] <: AnonItemElementItemIndex[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
