...
object AnonComponentElementModel {
  @scala.inline
  def apply(): AnonComponentElementModel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentElementModel]
  }
  @scala.inline
  implicit class AnonComponentElementModelOps[Self <: AnonComponentElementModel] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withComponent(value: dxContextMenu): Self = {
