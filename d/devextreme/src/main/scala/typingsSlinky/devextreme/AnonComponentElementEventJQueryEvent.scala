...
object AnonComponentElementEventJQueryEvent {
  @scala.inline
  def apply(): AnonComponentElementEventJQueryEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentElementEventJQueryEvent]
  }
  @scala.inline
  implicit class AnonComponentElementEventJQueryEventOps[Self <: AnonComponentElementEventJQueryEvent] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withComponent(value: dxVectorMap): Self = {
    ...
    @scala.inline
    def withTarget(value: MapLayerElement): Self = {
        val ret = this.duplicate
