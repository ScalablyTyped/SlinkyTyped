...
object AnonComponentElementEventModel {
  @scala.inline
  def apply(): AnonComponentElementEventModel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentElementEventModel]
  }
  @scala.inline
  implicit class AnonComponentElementEventModelOps[Self <: AnonComponentElementEventModel] (val x: Self) extends AnyVal {
    @scala.inline
