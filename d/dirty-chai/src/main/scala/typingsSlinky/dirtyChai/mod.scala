package typingsSlinky.dirtyChai
  ...
  object global {
    ...
    object Chai {
      ...
      trait PromisedAssertion
        ...
        def ensure(`type`: String): typingsSlinky.chaiAsPromised.Chai.PromisedAssertion = js.native
        def ensure(`type`: String, message: String): typingsSlinky.chaiAsPromised.Chai.PromisedAssertion = js.native
        @JSName("ensure")
