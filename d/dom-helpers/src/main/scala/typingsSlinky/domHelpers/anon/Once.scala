...
object Once {
  @scala.inline
  def apply[/* <: / * keyof std.HTMLElementEventMap * / / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 92 * / js.Any */ K](): Once[K] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Once[K]]
  }
  @scala.inline
  implicit class OnceOps[Self <: Once[_], /* <: / * keyof std.HTMLElementEventMap * / / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 92 * / js.Any */ K] (val x: Self with Once[K]) extends AnyVal {
    @scala.inline
