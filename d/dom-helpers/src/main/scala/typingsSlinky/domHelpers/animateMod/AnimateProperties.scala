...
object AnimateProperties {
  ...
  def apply(
    ...
    __obj.updateDynamic("-khtml-line-break")(`-khtml-line-break`.asInstanceOf[js.Any])
    __obj.updateDynamic("-khtml-opacity")(`-khtml-opacity`.asInstanceOf[js.Any])
    __obj.updateDynamic("-khtml-user-select")(`-khtml-user-select`.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("-ms-text-autospace")(`-ms-text-autospace`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-text-combine-horizontal")(`-ms-text-combine-horizontal`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-text-overflow")(`-ms-text-overflow`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-touch-action")(`-ms-touch-action`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-touch-select")(`-ms-touch-select`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transform")(`-ms-transform`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transform-origin")(`-ms-transform-origin`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transition")(`-ms-transition`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transition-delay")(`-ms-transition-delay`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transition-duration")(`-ms-transition-duration`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transition-property")(`-ms-transition-property`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-transition-timing-function")(`-ms-transition-timing-function`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-user-select")(`-ms-user-select`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-word-break")(`-ms-word-break`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-wrap-flow")(`-ms-wrap-flow`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-wrap-margin")(`-ms-wrap-margin`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-wrap-through")(`-ms-wrap-through`.asInstanceOf[js.Any])
    __obj.updateDynamic("-ms-writing-mode")(`-ms-writing-mode`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation")(`-o-animation`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-delay")(`-o-animation-delay`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-direction")(`-o-animation-direction`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-duration")(`-o-animation-duration`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-fill-mode")(`-o-animation-fill-mode`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-iteration-count")(`-o-animation-iteration-count`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-name")(`-o-animation-name`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-play-state")(`-o-animation-play-state`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-animation-timing-function")(`-o-animation-timing-function`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-background-size")(`-o-background-size`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-border-image")(`-o-border-image`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-object-fit")(`-o-object-fit`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-object-position")(`-o-object-position`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-tab-size")(`-o-tab-size`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-text-overflow")(`-o-text-overflow`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transform")(`-o-transform`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transform-origin")(`-o-transform-origin`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transition")(`-o-transition`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transition-delay")(`-o-transition-delay`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transition-duration")(`-o-transition-duration`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transition-property")(`-o-transition-property`.asInstanceOf[js.Any])
    __obj.updateDynamic("-o-transition-timing-function")(`-o-transition-timing-function`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-align-content")(`-webkit-align-content`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-align-items")(`-webkit-align-items`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-align-self")(`-webkit-align-self`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation")(`-webkit-animation`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-delay")(`-webkit-animation-delay`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-direction")(`-webkit-animation-direction`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-duration")(`-webkit-animation-duration`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-fill-mode")(`-webkit-animation-fill-mode`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-iteration-count")(`-webkit-animation-iteration-count`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-name")(`-webkit-animation-name`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-play-state")(`-webkit-animation-play-state`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-animation-timing-function")(`-webkit-animation-timing-function`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-appearance")(`-webkit-appearance`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-backdrop-filter")(`-webkit-backdrop-filter`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-backface-visibility")(`-webkit-backface-visibility`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-background-clip")(`-webkit-background-clip`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-background-origin")(`-webkit-background-origin`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-background-size")(`-webkit-background-size`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-before")(`-webkit-border-before`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-before-color")(`-webkit-border-before-color`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-before-style")(`-webkit-border-before-style`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-before-width")(`-webkit-border-before-width`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-bottom-left-radius")(`-webkit-border-bottom-left-radius`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-bottom-right-radius")(`-webkit-border-bottom-right-radius`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-image")(`-webkit-border-image`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-image-slice")(`-webkit-border-image-slice`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-radius")(`-webkit-border-radius`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-top-left-radius")(`-webkit-border-top-left-radius`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-border-top-right-radius")(`-webkit-border-top-right-radius`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-align")(`-webkit-box-align`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-decoration-break")(`-webkit-box-decoration-break`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-direction")(`-webkit-box-direction`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-flex")(`-webkit-box-flex`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-flex-group")(`-webkit-box-flex-group`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-lines")(`-webkit-box-lines`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-ordinal-group")(`-webkit-box-ordinal-group`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-orient")(`-webkit-box-orient`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-pack")(`-webkit-box-pack`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-reflect")(`-webkit-box-reflect`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-shadow")(`-webkit-box-shadow`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-box-sizing")(`-webkit-box-sizing`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-clip-path")(`-webkit-clip-path`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-color-adjust")(`-webkit-color-adjust`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-count")(`-webkit-column-count`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-fill")(`-webkit-column-fill`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-gap")(`-webkit-column-gap`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-rule")(`-webkit-column-rule`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-rule-color")(`-webkit-column-rule-color`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-rule-style")(`-webkit-column-rule-style`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-rule-width")(`-webkit-column-rule-width`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-span")(`-webkit-column-span`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-column-width")(`-webkit-column-width`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-columns")(`-webkit-columns`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-filter")(`-webkit-filter`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-flex")(`-webkit-flex`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-flex-basis")(`-webkit-flex-basis`.asInstanceOf[js.Any])
    __obj.updateDynamic("-webkit-flex-direction")(`-webkit-flex-direction`.asInstanceOf[js.Any])
