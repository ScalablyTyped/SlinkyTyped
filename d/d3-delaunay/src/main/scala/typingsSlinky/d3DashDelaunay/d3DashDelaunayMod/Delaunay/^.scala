package typingsSlinky.d3DashDelaunay.d3DashDelaunayMod.Delaunay
...
object ^ extends js.Object {
  /**
    ...
    */
  def from(points: ArrayLike[Point]): typingsSlinky.d3DashDelaunay.d3DashDelaunayMod.Delaunay[Point] = js.native
  def from(points: Iterable[Point]): typingsSlinky.d3DashDelaunay.d3DashDelaunayMod.Delaunay[Point] = js.native
  /**
  ...
  ): typingsSlinky.d3DashDelaunay.d3DashDelaunayMod.Delaunay[P] = js.native
  def from[P](
    points: ArrayLike[P],
    getX: GetCoordinate[P, ArrayLike[P] | js.Iterable[P]],
    getY: GetCoordinate[P, ArrayLike[P] | js.Iterable[P]],
