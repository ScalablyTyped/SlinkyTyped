package typingsSlinky.d3Delaunay.mod
...
package object Delaunay {
  ...
  /**
    ...
    */
  type Polygon = js.Array[typingsSlinky.d3Delaunay.mod.Delaunay.Point]
  
  /**
    * A closed polygon [[x0, y0], [x1, y1], [x2, y2], [x0, y0]] representing a triangle.
    */
  type Triangle = js.Array[typingsSlinky.d3Delaunay.mod.Delaunay.Point]
}
