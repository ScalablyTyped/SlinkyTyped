...
object NavLink
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.dva.routerMod.NavLink[js.Any]] {
  ...
  def apply[S](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.NavLink[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.dva.routerMod.NavLink[js.Any]]]
  }
