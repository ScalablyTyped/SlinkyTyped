...
object Link
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.dva.routerMod.Link[js.Any]] {
  ...
  def apply[S](
  ...
  ): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.Link[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.a.tag.type, typingsSlinky.dva.routerMod.Link[js.Any]]]
  }
