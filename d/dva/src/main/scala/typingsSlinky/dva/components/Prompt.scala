...
object Prompt
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.dva.routerMod.Prompt] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.Prompt] = {
