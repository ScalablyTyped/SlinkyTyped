...
object BrowserRouter
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.dva.routerMod.BrowserRouter] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.BrowserRouter] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.BrowserRouter] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.dva.routerMod.BrowserRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
