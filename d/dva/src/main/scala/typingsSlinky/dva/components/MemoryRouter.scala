...
object MemoryRouter
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.dva.routerMod.MemoryRouter] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.MemoryRouter] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.dva.routerMod.MemoryRouter] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.dva.routerMod.MemoryRouter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
