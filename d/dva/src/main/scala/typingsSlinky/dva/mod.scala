...
import typingsSlinky.dva.anon.Type
...
object mod {
  ...
  object DvaOption {
    ...
    implicit class DvaOptionMutableBuilder[Self <: DvaOption] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnError(value: (/* e */ js.Error, /* dispatch */ Dispatch[_]) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction2(value))
  ...
  */
  ...
  type Router = js.Function1[/* api */ js.UndefOr[RouterAPI], ReactElement | js.Object]
