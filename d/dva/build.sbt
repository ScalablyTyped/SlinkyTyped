...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "react-router-dom" % "5.1-dt-20191125Z-3bf90a",
  "org.scalablytyped.slinky" %%% "react-router-redux" % "5.0-dt-20190822Z-ce0073",
