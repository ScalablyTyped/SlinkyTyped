package typingsSlinky.diff2html.highlightJsHelpersMod

import org.scalajs.dom.raw.Node
import typingsSlinky.diff2html.diff2htmlStrings.start
import typingsSlinky.diff2html.diff2htmlStrings.stop
