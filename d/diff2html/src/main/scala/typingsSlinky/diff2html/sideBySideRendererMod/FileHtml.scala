package typingsSlinky.diff2html.sideBySideRendererMod
...
@js.native
trait FileHtml extends js.Object {
...
object FileHtml {
  ...
  @scala.inline
  implicit class FileHtmlOps[Self <: FileHtml] (val x: Self) extends AnyVal {
