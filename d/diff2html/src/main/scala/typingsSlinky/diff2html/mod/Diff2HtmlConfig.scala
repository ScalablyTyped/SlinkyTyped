package typingsSlinky.diff2html.mod

import typingsSlinky.diff2html.diffParserMod.DiffParserConfig
import typingsSlinky.diff2html.hoganjsUtilsMod.HoganJsUtilsConfig
import typingsSlinky.diff2html.lineByLineRendererMod.LineByLineRendererConfig
...
- typingsSlinky.diff2html.renderUtilsMod.RenderConfig because Already inherited
- typingsSlinky.diff2html.sideBySideRendererMod.SideBySideRendererConfig because var conflicts: diffStyle, matchWordsThreshold, matching, matchingMaxComparisons, maxLineLengthHighlight, maxLineSizeInBlockForComparison, renderNothingWhenEmpty. Inlined  */ @js.native
