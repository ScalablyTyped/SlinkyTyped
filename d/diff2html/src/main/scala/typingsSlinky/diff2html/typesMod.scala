...
import typingsSlinky.diff2html.typesMod.LineType.DELETE
...
object typesMod {
  ...
  object LineType extends StObject {
    ...
    /* "context" */ val CONTEXT: typingsSlinky.diff2html.typesMod.LineType.CONTEXT with String = js.native
    
    @js.native
    sealed trait DELETE extends LineType
    /* "delete" */ val DELETE: typingsSlinky.diff2html.typesMod.LineType.DELETE with String = js.native
    
    @js.native
    sealed trait INSERT extends LineType
    /* "insert" */ val INSERT: typingsSlinky.diff2html.typesMod.LineType.INSERT with String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.diff2html.diff2htmlStrings.word
    - typingsSlinky.diff2html.diff2htmlStrings.char
  */
  trait DiffStyleType extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.diff2html.diff2htmlStrings.lines
    - typingsSlinky.diff2html.diff2htmlStrings.words
    - typingsSlinky.diff2html.diff2htmlStrings.none
  */
  trait LineMatchingType extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.diff2html.diff2htmlStrings.`line-by-line`
    - typingsSlinky.diff2html.diff2htmlStrings.`side-by-side`
  */
