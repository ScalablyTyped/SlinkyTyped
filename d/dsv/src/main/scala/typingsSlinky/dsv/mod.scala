...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : js.Function2[/* delimiter */ String, /* encoding */ js.UndefOr[String], Dsv] = js.native
  
  type _To = js.Function2[/* delimiter */ String, /* encoding */ js.UndefOr[String], Dsv]
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: js.Function2[/* delimiter */ String, /* encoding */ js.UndefOr[String], Dsv] = ^
