package typingsSlinky.detectPointer
...
object mod extends Shortcut {
  ...
  @js.native
  val default: typingsSlinky.detectPointer.mod.detectPointer = js.native
  
  type _To = typingsSlinky.detectPointer.mod.detectPointer
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.detectPointer.mod.detectPointer = default
  ...
  object detectPointer {
    ...
    def apply(
      ...
      none: Boolean,
      update: () => Unit
    ): typingsSlinky.detectPointer.mod.detectPointer = {
      ...
      __obj.asInstanceOf[typingsSlinky.detectPointer.mod.detectPointer]
    }
    
    @scala.inline
    implicit class detectPointerMutableBuilder[Self <: typingsSlinky.detectPointer.mod.detectPointer] (val x: Self) extends AnyVal {
