...
@js.native
trait Graphviz[GElement /* <: BaseType */, Datum, PElement /* <: BaseType */, PDatum] extends js.Object {
  /**
    ...
    */
  def active(): (Transition[GElement, Datum, PElement, PDatum]) | Null = js.native
  def active(name: String): (Transition[GElement, Datum, PElement, PDatum]) | Null = js.native
  ...
  /**
    ...
    */
  def drawnEdgeSelection(): Selection[GElement, Datum, PElement, PDatum] = js.native
  /**
    ...
    * {@link insertDrawnNode}.
    */
  def drawnNodeSelection(): Selection[GElement, Datum, PElement, PDatum] = js.native
  /**
  ...
  def resetZoom(transition: Transition[GElement, Datum, PElement, PDatum]): this.type = js.native
  /**
  ...
  def transition(name: js.Function0[(Transition[GElement, Datum, PElement, PDatum]) | String]): this.type = js.native
