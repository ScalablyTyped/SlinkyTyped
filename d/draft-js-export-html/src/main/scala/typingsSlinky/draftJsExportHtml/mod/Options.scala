package typingsSlinky.draftJsExportHtml.mod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlockStyleFn(value: /* block */ ContentBlock => js.UndefOr[RenderConfig]): Self = this.set("blockStyleFn", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteBlockStyleFn: Self = this.set("blockStyleFn", js.undefined)
    
    @scala.inline
    def setDefaultBlockTag(value: String): Self = this.set("defaultBlockTag", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultBlockTag: Self = this.set("defaultBlockTag", js.undefined)
