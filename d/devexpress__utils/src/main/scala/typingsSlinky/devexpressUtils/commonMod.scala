...
object commonMod {
  ...
  object SesType extends StObject {
    ...
    /* 1 */ val Add: typingsSlinky.devexpressUtils.commonMod.SesType.Add with Double = js.native
    
    @js.native
    sealed trait Common extends SesType
    /* 0 */ val Common: typingsSlinky.devexpressUtils.commonMod.SesType.Common with Double = js.native
    
    @js.native
    sealed trait Delete extends SesType
    /* -1 */ val Delete: typingsSlinky.devexpressUtils.commonMod.SesType.Delete with Double = js.native
  }
