...
object base64Mod {
  ...
  object Base64MimeType extends StObject {
    ...
    /* 4 */ val Docm: typingsSlinky.devexpressUtils.base64Mod.Base64MimeType.Docm with Double = js.native
    
    @js.native
    sealed trait OpenXml extends Base64MimeType
    /* 1 */ val OpenXml: typingsSlinky.devexpressUtils.base64Mod.Base64MimeType.OpenXml with Double = js.native
    
    @js.native
    sealed trait PlainText extends Base64MimeType
    /* 3 */ val PlainText: typingsSlinky.devexpressUtils.base64Mod.Base64MimeType.PlainText with Double = js.native
    
    @js.native
    sealed trait Rtf extends Base64MimeType
    /* 2 */ val Rtf: typingsSlinky.devexpressUtils.base64Mod.Base64MimeType.Rtf with Double = js.native
    
    @js.native
    sealed trait Unknown extends Base64MimeType
    /* 0 */ val Unknown: typingsSlinky.devexpressUtils.base64Mod.Base64MimeType.Unknown with Double = js.native
  }
  ...
  object Base64Utils {
    ...
    @scala.inline
    def dataUrl_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dataUrl")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def fromArrayBuffer(buffer: js.typedarray.ArrayBuffer): String = js.native
    ...
    @js.native
    def getUint8Array(base64: String): js.typedarray.Uint8Array = js.native
