...
object mod {
  ...
  object Browser {
    ...
    @scala.inline
    def AndroidChromeBrowser_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AndroidChromeBrowser")(x.asInstanceOf[js.Any])
    
    @JSImport("@devexpress/utils/lib/browser", "Browser.AndroidDefaultBrowser")
    @js.native
    def AndroidDefaultBrowser: Boolean = js.native
    @scala.inline
    def AndroidDefaultBrowser_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AndroidDefaultBrowser")(x.asInstanceOf[js.Any])
    
    @JSImport("@devexpress/utils/lib/browser", "Browser.AndroidMobilePlatform")
    @js.native
    def AndroidMobilePlatform: Boolean = js.native
    @scala.inline
    def AndroidMobilePlatform_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AndroidMobilePlatform")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def HardwareAcceleration_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("HardwareAcceleration")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def MacOSMobilePlatform_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MacOSMobilePlatform")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def MajorVersion_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MajorVersion")(x.asInstanceOf[js.Any])
    
    @JSImport("@devexpress/utils/lib/browser", "Browser.MobileUI")
    @js.native
    def MobileUI: Boolean = js.native
    @scala.inline
    def MobileUI_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MobileUI")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def PlaformMajorVersion_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PlaformMajorVersion")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def SamsungAndroidDevice_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SamsungAndroidDevice")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def UserAgent_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UserAgent")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def VirtualKeyboardSupported_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VirtualKeyboardSupported")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def WindowsPhonePlatform_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WindowsPhonePlatform")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def getIECompatibleVersionString_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getIECompatibleVersionString")(x.asInstanceOf[js.Any])
    
    @JSImport("@devexpress/utils/lib/browser", "Browser.getVersionFromMatches")
    @js.native
    def getVersionFromMatches: js.Any = js.native
    @scala.inline
    def getVersionFromMatches_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getVersionFromMatches")(x.asInstanceOf[js.Any])
    
    @JSImport("@devexpress/utils/lib/browser", "Browser.getVersionFromTrident")
    @js.native
    def getVersionFromTrident: js.Any = js.native
    @scala.inline
    def getVersionFromTrident_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getVersionFromTrident")(x.asInstanceOf[js.Any])
