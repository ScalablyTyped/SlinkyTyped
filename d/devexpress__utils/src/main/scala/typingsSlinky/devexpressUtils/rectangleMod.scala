...
import typingsSlinky.devexpressUtils.flagMod.Flag
...
import typingsSlinky.devexpressUtils.sizeMod.Size
...
import typingsSlinky.devexpressUtils.typesMod.SimpleConverter
...
object rectangleMod {
  ...
  object HitTestDeviation extends StObject {
    ...
    /* 2 */ val Bottom: typingsSlinky.devexpressUtils.rectangleMod.HitTestDeviation.Bottom with Double = js.native
    
    @js.native
    sealed trait Left extends HitTestDeviation
    /* 4 */ val Left: typingsSlinky.devexpressUtils.rectangleMod.HitTestDeviation.Left with Double = js.native
    
    @js.native
    sealed trait None extends HitTestDeviation
    /* 0 */ val None: typingsSlinky.devexpressUtils.rectangleMod.HitTestDeviation.None with Double = js.native
    
    @js.native
    sealed trait Right extends HitTestDeviation
    /* 8 */ val Right: typingsSlinky.devexpressUtils.rectangleMod.HitTestDeviation.Right with Double = js.native
    
    @js.native
    sealed trait Top extends HitTestDeviation
    /* 1 */ val Top: typingsSlinky.devexpressUtils.rectangleMod.HitTestDeviation.Top with Double = js.native
  }
