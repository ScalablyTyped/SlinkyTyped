...
import typingsSlinky.devexpressUtils.minMaxMod.ExtendedMax
import typingsSlinky.devexpressUtils.minMaxMod.ExtendedMin
import typingsSlinky.devexpressUtils.minMaxMod.ExtendedMinMax
import typingsSlinky.devexpressUtils.minMaxMod.MinMax
