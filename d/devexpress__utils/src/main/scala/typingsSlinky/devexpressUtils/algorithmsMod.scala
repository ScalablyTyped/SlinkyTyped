...
@JSImport("@devexpress/utils/lib/intervals/algorithms", JSImport.Namespace)
@js.native
object algorithmsMod extends js.Object {
  
  @js.native
  class IntervalAlgorithms () extends js.Object
  /* static members */
  @js.native
  object IntervalAlgorithms extends js.Object {
