...
object DeserializerOptions {
  ...
  implicit class DeserializerOptionsOps[Self <: DeserializerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetConstructor(value: String => js.Function0[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getConstructor")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetTypeId(value: js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTypeId")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReviver(value: (String, js.Any) => js.Any): Self = {
        val ret = this.duplicate
