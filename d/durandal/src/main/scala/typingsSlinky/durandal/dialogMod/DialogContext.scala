...
object DialogContext {
  ...
  implicit class DialogContextOps[Self <: DialogContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddHost(value: Dialog => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addHost")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCompositionComplete(value: (HTMLElement, HTMLElement, CompositionContext) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compositionComplete")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRemoveHost(value: Dialog => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeHost")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withBlockoutOpacity(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("blockoutOpacity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBlockoutOpacity: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("blockoutOpacity")(js.undefined)
        ret
    }
  }
