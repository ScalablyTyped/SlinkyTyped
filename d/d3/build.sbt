...
name := "d3"
version := "5.7-dt-20200515Z-6e86e4"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "d3-axis" % "1.0-dt-20200515Z-21d8e7",
  "org.scalablytyped.slinky" %%% "d3-brush" % "1.1-dt-20200605Z-b02656",
  ...
  "org.scalablytyped.slinky" %%% "d3-dispatch" % "1.0-dt-20200515Z-ceb973",
  "org.scalablytyped.slinky" %%% "d3-drag" % "1.2-dt-20200515Z-f6b7e5",
  ...
  "org.scalablytyped.slinky" %%% "d3-transition" % "1.1-dt-20200515Z-14bfae",
  "org.scalablytyped.slinky" %%% "d3-voronoi" % "1.1-dt-20200515Z-5ef091",
  "org.scalablytyped.slinky" %%% "d3-zoom" % "1.7-dt-20200515Z-526c00",
