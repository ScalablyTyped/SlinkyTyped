...
import typingsSlinky.dashjs.dashjsStrings.fragmentLoadingCompleted
...
trait FragmentLoadingCompletedEvent extends Event {
  ...
  var response: js.typedarray.ArrayBuffer = js.native
...
object FragmentLoadingCompletedEvent {
  ...
  def apply(
    ...
    response: js.typedarray.ArrayBuffer,
    sender: js.Object,
  ...
  implicit class FragmentLoadingCompletedEventMutableBuilder[Self <: FragmentLoadingCompletedEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponse(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
