...
object SupportedKeySystem {
  ...
  implicit class SupportedKeySystemOps[Self <: SupportedKeySystem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitData(value: js.typedarray.ArrayBuffer): Self = this.set("initData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setKs(value: KeySystem): Self = this.set("ks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCdmData(value: js.typedarray.ArrayBuffer): Self = this.set("cdmData", value.asInstanceOf[js.Any])
