...
import typingsSlinky.dashjs.dashjsStrings.InitializationSegment
import typingsSlinky.dashjs.dashjsStrings.MediaSegment
...
trait FragmentRequest extends StObject {
  ...
  var availabilityStartTime: js.Date = js.native
  ...
  var firstByteDate: js.Date = js.native
  ...
  var requestEndDate: js.Date | Null = js.native
  
  var requestStartDate: js.Date = js.native
...
object FragmentRequest {
  ...
  implicit class FragmentRequestMutableBuilder[Self <: FragmentRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAvailabilityStartTime(value: js.Date): Self = StObject.set(x, "availabilityStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFirstByteDate(value: js.Date): Self = StObject.set(x, "firstByteDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestEndDate(value: js.Date): Self = StObject.set(x, "requestEndDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequestEndDateNull: Self = StObject.set(x, "requestEndDate", null)
    
    @scala.inline
    def setRequestStartDate(value: js.Date): Self = StObject.set(x, "requestStartDate", value.asInstanceOf[js.Any])
