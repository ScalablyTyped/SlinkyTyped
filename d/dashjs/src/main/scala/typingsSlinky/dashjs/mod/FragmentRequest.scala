...
object FragmentRequest {
  ...
  implicit class FragmentRequestOps[Self <: FragmentRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAvailabilityStartTime(value: js.Date): Self = this.set("availabilityStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFirstByteDate(value: js.Date): Self = this.set("firstByteDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestStartDate(value: js.Date): Self = this.set("requestStartDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestEndDate(value: js.Date): Self = this.set("requestEndDate", value.asInstanceOf[js.Any])
