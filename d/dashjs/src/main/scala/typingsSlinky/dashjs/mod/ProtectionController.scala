...
object ProtectionController {
  ...
  implicit class ProtectionControllerOps[Self <: ProtectionController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateKeySession(value: (js.typedarray.ArrayBuffer, js.typedarray.Uint8Array) => Unit): Self = this.set("createKeySession", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetServerCertificate(value: js.typedarray.ArrayBuffer => Unit): Self = this.set("setServerCertificate", js.Any.fromFunction1(value))
