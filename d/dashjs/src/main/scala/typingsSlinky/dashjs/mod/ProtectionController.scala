...
trait ProtectionController extends StObject {
  ...
  def createKeySession(initData: js.typedarray.ArrayBuffer, cdmData: js.typedarray.Uint8Array): Unit = js.native
  ...
  def setServerCertificate(serverCertificate: js.typedarray.ArrayBuffer): Unit = js.native
...
object ProtectionController {
  ...
  def apply(
    ...
    createKeySession: (js.typedarray.ArrayBuffer, js.typedarray.Uint8Array) => Unit,
  ...
  implicit class ProtectionControllerMutableBuilder[Self <: ProtectionController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateKeySession(value: (js.typedarray.ArrayBuffer, js.typedarray.Uint8Array) => Unit): Self = StObject.set(x, "createKeySession", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetServerCertificate(value: js.typedarray.ArrayBuffer => Unit): Self = StObject.set(x, "setServerCertificate", js.Any.fromFunction1(value))
