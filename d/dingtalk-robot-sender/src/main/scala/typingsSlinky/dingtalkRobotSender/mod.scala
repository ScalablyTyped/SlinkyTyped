...
object mod {
  ...
  */
  ...
  object MessageType {
    ...
    @scala.inline
    def ActionCard(actionCard: BtnOrientation, msgtype: actionCard): typingsSlinky.dingtalkRobotSender.mod.Message.ActionCard = {
      val __obj = js.Dynamic.literal(actionCard = actionCard.asInstanceOf[js.Any], msgtype = msgtype.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dingtalkRobotSender.mod.Message.ActionCard]
    }
    
    @scala.inline
    def FeedCardItem(feedCard: MessageURL_, msgtype: feedCard): typingsSlinky.dingtalkRobotSender.mod.Message.FeedCardItem = {
      val __obj = js.Dynamic.literal(feedCard = feedCard.asInstanceOf[js.Any], msgtype = msgtype.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dingtalkRobotSender.mod.Message.FeedCardItem]
    }
    
    @scala.inline
    def Link(link: MessageUrl, msgtype: link): typingsSlinky.dingtalkRobotSender.mod.Message.Link = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any], msgtype = msgtype.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dingtalkRobotSender.mod.Message.Link]
    }
    
    @scala.inline
    def Markdown(markdown: IsAtAll, msgtype: markdown): typingsSlinky.dingtalkRobotSender.mod.Message.Markdown = {
      val __obj = js.Dynamic.literal(markdown = markdown.asInstanceOf[js.Any], msgtype = msgtype.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dingtalkRobotSender.mod.Message.Markdown]
    }
    
    @scala.inline
    def Text(msgtype: text, text: Content): typingsSlinky.dingtalkRobotSender.mod.Message.Text = {
      val __obj = js.Dynamic.literal(msgtype = msgtype.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dingtalkRobotSender.mod.Message.Text]
    }
  }
