...
object EnumDWT_CapBitOrder extends js.Object {
  ...
  /* 0 */ val TWBO_LSBFIRST: typingsSlinky.dwt.EnumDWT_CapBitOrder.TWBO_LSBFIRST with Double = js.native
  /* 1 */ val TWBO_MSBFIRST: typingsSlinky.dwt.EnumDWT_CapBitOrder.TWBO_MSBFIRST with Double = js.native
  @JSBracketAccess
