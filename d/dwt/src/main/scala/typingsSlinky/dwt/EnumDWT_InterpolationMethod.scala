...
object EnumDWT_InterpolationMethod extends js.Object {
  ...
  /* 5 */ val IM_BESTQUALITY: typingsSlinky.dwt.EnumDWT_InterpolationMethod.IM_BESTQUALITY with Double = js.native
  /* 3 */ val IM_BICUBIC: typingsSlinky.dwt.EnumDWT_InterpolationMethod.IM_BICUBIC with Double = js.native
  /* 2 */ val IM_BILINEAR: typingsSlinky.dwt.EnumDWT_InterpolationMethod.IM_BILINEAR with Double = js.native
  /* 1 */ val IM_NEARESTNEIGHBOUR: typingsSlinky.dwt.EnumDWT_InterpolationMethod.IM_NEARESTNEIGHBOUR with Double = js.native
  @JSBracketAccess
