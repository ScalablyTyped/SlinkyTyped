...
object EnumDWT_OCRProRecognitionModule extends js.Object {
  ...
  /* "AUTO" */ val OCRPM_AUTO: typingsSlinky.dwt.EnumDWT_OCRProRecognitionModule.OCRPM_AUTO with String = js.native
  /* "BALANCED" */ val OCRPM_BALANCED: typingsSlinky.dwt.EnumDWT_OCRProRecognitionModule.OCRPM_BALANCED with String = js.native
  /* "FASTEST" */ val OCRPM_FASTEST: typingsSlinky.dwt.EnumDWT_OCRProRecognitionModule.OCRPM_FASTEST with String = js.native
  /* "MOSTACCURATE" */ val OCRPM_MOSTACCURATE: typingsSlinky.dwt.EnumDWT_OCRProRecognitionModule.OCRPM_MOSTACCURATE with String = js.native
  @JSBracketAccess
