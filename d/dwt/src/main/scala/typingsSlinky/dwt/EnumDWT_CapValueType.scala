...
object EnumDWT_CapValueType extends js.Object {
  ...
  /* 6 */ val TWTY_BOOL: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_BOOL with Double = js.native
  /* 7 */ val TWTY_FIX32: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_FIX32 with Double = js.native
  /* 8 */ val TWTY_FRAME: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_FRAME with Double = js.native
  /* 1 */ val TWTY_INT16: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_INT16 with Double = js.native
  /* 2 */ val TWTY_INT32: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_INT32 with Double = js.native
  /* 0 */ val TWTY_INT8: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_INT8 with Double = js.native
  /* 11 */ val TWTY_STR128: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_STR128 with Double = js.native
  /* 12 */ val TWTY_STR255: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_STR255 with Double = js.native
  /* 9 */ val TWTY_STR32: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_STR32 with Double = js.native
  /* 10 */ val TWTY_STR64: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_STR64 with Double = js.native
  /* 4 */ val TWTY_UINT16: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_UINT16 with Double = js.native
  /* 3 */ val TWTY_UINT8: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_UINT8 with Double = js.native
  /* 5 */ val TWTY_int: typingsSlinky.dwt.EnumDWT_CapValueType.TWTY_int with Double = js.native
  @JSBracketAccess
