...
import typingsSlinky.dwt.dwtNumbers.`10`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait OnButtonClickSequence extends js.Object {
...
object OnButtonClickSequence {
  ...
  @scala.inline
  implicit class OnButtonClickSequenceOps[Self <: OnButtonClickSequence] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSequence(value: `10`): Self = this.set("sequence", value.asInstanceOf[js.Any])
