...
trait BChrome extends js.Object {
  var WSSession: Double
  var WSVersion: String
  var bChrome: Boolean
  var bEdge: Boolean
  var bFileSystem: Boolean
  var bFirefox: Boolean
  var bIE: Boolean
  var bLinux: Boolean
  var bMac: Boolean
  var bSafari: Boolean
  ...
  var bWin64: Boolean
  var basePath: String
  var iPluginLength: Double
  var isX64: Boolean
  var pathType: Double
  var strChromeVersion: String
  var strFirefoxVersion: String
  var strIEVersion: String
}
