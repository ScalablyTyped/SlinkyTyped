...
object EnumDWT_CapLightPath extends js.Object {
  ...
  /* 0 */ val TWLP_REFLECTIVE: typingsSlinky.dwt.EnumDWT_CapLightPath.TWLP_REFLECTIVE with Double = js.native
  /* 1 */ val TWLP_TRANSMISSIVE: typingsSlinky.dwt.EnumDWT_CapLightPath.TWLP_TRANSMISSIVE with Double = js.native
  @JSBracketAccess
