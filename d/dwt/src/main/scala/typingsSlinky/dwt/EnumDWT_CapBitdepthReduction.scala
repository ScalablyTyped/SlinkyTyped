...
object EnumDWT_CapBitdepthReduction extends js.Object {
  ...
  /* 2 */ val TWBR_CUSTHALFTONE: typingsSlinky.dwt.EnumDWT_CapBitdepthReduction.TWBR_CUSTHALFTONE with Double = js.native
  /* 3 */ val TWBR_DIFFUSION: typingsSlinky.dwt.EnumDWT_CapBitdepthReduction.TWBR_DIFFUSION with Double = js.native
  /* 1 */ val TWBR_HALFTONE: typingsSlinky.dwt.EnumDWT_CapBitdepthReduction.TWBR_HALFTONE with Double = js.native
  /* 0 */ val TWBR_THRESHOLD: typingsSlinky.dwt.EnumDWT_CapBitdepthReduction.TWBR_THRESHOLD with Double = js.native
  @JSBracketAccess
