...
object EnumDWT_CapFeederAlignment extends js.Object {
  ...
  /* 2 */ val TWFA_CENTER: typingsSlinky.dwt.EnumDWT_CapFeederAlignment.TWFA_CENTER with Double = js.native
  /* 1 */ val TWFA_LEFT: typingsSlinky.dwt.EnumDWT_CapFeederAlignment.TWFA_LEFT with Double = js.native
  /* 0 */ val TWFA_NONE: typingsSlinky.dwt.EnumDWT_CapFeederAlignment.TWFA_NONE with Double = js.native
  /* 3 */ val TWFA_RIGHT: typingsSlinky.dwt.EnumDWT_CapFeederAlignment.TWFA_RIGHT with Double = js.native
  @JSBracketAccess
