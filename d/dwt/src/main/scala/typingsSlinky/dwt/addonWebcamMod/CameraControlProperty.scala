package typingsSlinky.dwt.addonWebcamMod
...
@js.native
trait CameraControlProperty extends js.Object {
...
object CameraControlProperty {
  ...
  @scala.inline
  implicit class CameraControlPropertyOps[Self <: CameraControlProperty] (val x: Self) extends AnyVal {
