...
import typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextAction
import typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags
