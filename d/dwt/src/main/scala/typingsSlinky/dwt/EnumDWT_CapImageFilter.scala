...
object EnumDWT_CapImageFilter extends js.Object {
  ...
  /* 1 */ val TWIF_AUTO: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_AUTO with Double = js.native
  /* 3 */ val TWIF_BANDPASS: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_BANDPASS with Double = js.native
  /* 4 */ val TWIF_FINELINE: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_FINELINE with Double = js.native
  /* 4 */ val TWIF_HIGHPASS: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_HIGHPASS with Double = js.native
  /* 2 */ val TWIF_LOWPASS: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_LOWPASS with Double = js.native
  /* 0 */ val TWIF_NONE: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_NONE with Double = js.native
  /* 3 */ val TWIF_TEXT: typingsSlinky.dwt.EnumDWT_CapImageFilter.TWIF_TEXT with Double = js.native
  @JSBracketAccess
