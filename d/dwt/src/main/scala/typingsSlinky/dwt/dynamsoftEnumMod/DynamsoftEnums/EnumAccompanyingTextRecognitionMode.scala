...
object EnumAccompanyingTextRecognitionMode extends StObject {
  ...
  /* 1 */ val ATRM_GENERAL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumAccompanyingTextRecognitionMode.ATRM_GENERAL with Double = js.native
  
  @js.native
  sealed trait ATRM_SKIP extends EnumAccompanyingTextRecognitionMode
  /* 0 */ val ATRM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumAccompanyingTextRecognitionMode.ATRM_SKIP with Double = js.native
}
