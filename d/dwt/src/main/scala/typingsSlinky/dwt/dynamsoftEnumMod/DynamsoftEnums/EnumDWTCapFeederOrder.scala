...
object EnumDWTCapFeederOrder extends StObject {
  ...
  /* 0 */ val TWFO_FIRSTPAGEFIRST: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_FIRSTPAGEFIRST with Double = js.native
  
  /** The feeder starts with the top of the last page. */
  @js.native
  sealed trait TWFO_LASTPAGEFIRST extends EnumDWTCapFeederOrder
  /* 1 */ val TWFO_LASTPAGEFIRST: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_LASTPAGEFIRST with Double = js.native
}
