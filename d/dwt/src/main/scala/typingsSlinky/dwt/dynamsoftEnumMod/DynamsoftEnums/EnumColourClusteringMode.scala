...
object EnumColourClusteringMode extends StObject {
  ...
  /* 1 */ val CCM_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_AUTO with Double = js.native
  
  @js.native
  sealed trait CCM_GENERAL_HSV extends EnumColourClusteringMode
  /* 2 */ val CCM_GENERAL_HSV: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_GENERAL_HSV with Double = js.native
  
  @js.native
  sealed trait CCM_SKIP extends EnumColourClusteringMode
  /* 0 */ val CCM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_SKIP with Double = js.native
}
