...
object EnumDWTOCRFindTextFlags extends StObject {
  ...
  /* 4 */ val OCRFT_FUZZYMATCH: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_FUZZYMATCH with Double = js.native
  
  @js.native
  sealed trait OCRFT_MATCHCASE extends EnumDWTOCRFindTextFlags
  /* 2 */ val OCRFT_MATCHCASE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_MATCHCASE with Double = js.native
  
  @js.native
  sealed trait OCRFT_WHOLEWORD extends EnumDWTOCRFindTextFlags
  /* 1 */ val OCRFT_WHOLEWORD: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_WHOLEWORD with Double = js.native
}
