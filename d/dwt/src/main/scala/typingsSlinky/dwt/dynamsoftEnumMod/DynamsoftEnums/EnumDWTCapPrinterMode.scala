...
object EnumDWTCapPrinterMode extends StObject {
  ...
  /* 2 */ val TWPM_COMPOUNDSTRING: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_COMPOUNDSTRING with Double = js.native
  ...
  /* 1 */ val TWPM_MULTISTRING: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_MULTISTRING with Double = js.native
  ...
  /* 0 */ val TWPM_SINGLESTRING: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_SINGLESTRING with Double = js.native
}
