...
object EnumDWTOCRProType extends StObject {
  ...
  /* 0 */ val OCRDT_File: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRProType.OCRDT_File with Double = js.native
  
  @js.native
  sealed trait OCRDT_Index extends EnumDWTOCRProType
  /* 1 */ val OCRDT_Index: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRProType.OCRDT_Index with Double = js.native
}
