...
object EnumDWTCapBitdepthReduction extends StObject {
  ...
  /* 2 */ val TWBR_CUSTHALFTONE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitdepthReduction.TWBR_CUSTHALFTONE with Double = js.native
  
  @js.native
  sealed trait TWBR_DIFFUSION extends EnumDWTCapBitdepthReduction
  /* 3 */ val TWBR_DIFFUSION: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitdepthReduction.TWBR_DIFFUSION with Double = js.native
  
  @js.native
  sealed trait TWBR_HALFTONE extends EnumDWTCapBitdepthReduction
  /* 1 */ val TWBR_HALFTONE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitdepthReduction.TWBR_HALFTONE with Double = js.native
  
  @js.native
  sealed trait TWBR_THRESHOLD extends EnumDWTCapBitdepthReduction
  /* 0 */ val TWBR_THRESHOLD: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitdepthReduction.TWBR_THRESHOLD with Double = js.native
}
