...
object EnumDWTTransferMode extends StObject {
  ...
  /* 1 */ val TWSX_FILE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_FILE with Double = js.native
  
  /** Buffered Memory Mode Transfers. */
  @js.native
  sealed trait TWSX_MEMORY extends EnumDWTTransferMode
  /* 2 */ val TWSX_MEMORY: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_MEMORY with Double = js.native
  ...
  /* 0 */ val TWSX_NATIVE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_NATIVE with Double = js.native
}
