...
object EnumDWTMagType extends StObject {
  ...
  /* 2 */ val TWMD_INVALID: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_INVALID with Double = js.native
  
  /** Added 2.0  */
  @js.native
  sealed trait TWMD_MICR extends EnumDWTMagType
  /* 0 */ val TWMD_MICR: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_MICR with Double = js.native
  
  /** added 2.1   */
  @js.native
  sealed trait TWMD_RAW extends EnumDWTMagType
  /* 1 */ val TWMD_RAW: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_RAW with Double = js.native
}
