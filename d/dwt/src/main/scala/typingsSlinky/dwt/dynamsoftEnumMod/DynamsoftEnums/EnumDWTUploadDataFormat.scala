...
object EnumDWTUploadDataFormat extends StObject {
  ...
  /* 1 */ val Base64: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Base64 with Double = js.native
  
  @js.native
  sealed trait Binary extends EnumDWTUploadDataFormat
  /* 0 */ val Binary: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Binary with Double = js.native
}
