...
object EnumDWTBorderStyle extends StObject {
  ...
  /* 0 */ val TWBS_NONE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_NONE with Double = js.native
  
  /** 3D border.   */
  @js.native
  sealed trait TWBS_SINGLE3D extends EnumDWTBorderStyle
  /* 2 */ val TWBS_SINGLE3D: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_SINGLE3D with Double = js.native
  
  /** Flat border. */
  @js.native
  sealed trait TWBS_SINGLEFLAT extends EnumDWTBorderStyle
  /* 1 */ val TWBS_SINGLEFLAT: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_SINGLEFLAT with Double = js.native
}
