...
object EnumDeformationResistingMode extends StObject {
  ...
  /* 1 */ val DRM_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_AUTO with Double = js.native
  
  @js.native
  sealed trait DRM_GENERAL extends EnumDeformationResistingMode
  /* 2 */ val DRM_GENERAL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_GENERAL with Double = js.native
  
  @js.native
  sealed trait DRM_SKIP extends EnumDeformationResistingMode
  /* 0 */ val DRM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_SKIP with Double = js.native
}
