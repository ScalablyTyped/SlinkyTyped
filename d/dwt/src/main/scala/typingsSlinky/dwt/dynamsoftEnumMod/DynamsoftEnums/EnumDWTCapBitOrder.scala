...
object EnumDWTCapBitOrder extends StObject {
  ...
  /* 0 */ val TWBO_LSBFIRST: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitOrder.TWBO_LSBFIRST with Double = js.native
  ...
  /* 1 */ val TWBO_MSBFIRST: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapBitOrder.TWBO_MSBFIRST with Double = js.native
}
