...
object EnumDWTDUPLEX extends StObject {
  ...
  /* 1 */ val TWDX_1PASSDUPLEX: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDUPLEX.TWDX_1PASSDUPLEX with Double = js.native
  
  @js.native
  sealed trait TWDX_2PASSDUPLEX extends EnumDWTDUPLEX
  /* 2 */ val TWDX_2PASSDUPLEX: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDUPLEX.TWDX_2PASSDUPLEX with Double = js.native
  
  @js.native
  sealed trait TWDX_NONE extends EnumDWTDUPLEX
  /* 0 */ val TWDX_NONE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDUPLEX.TWDX_NONE with Double = js.native
}
