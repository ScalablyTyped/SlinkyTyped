...
object EnumDWTFitWindowType extends StObject {
  ...
  /* 0 */ val enumFitWindow: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindow with Double = js.native
  
  /** Fit the image to the height of the window */
  @js.native
  sealed trait enumFitWindowHeight extends EnumDWTFitWindowType
  /* 1 */ val enumFitWindowHeight: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindowHeight with Double = js.native
  
  /** Fit the image to the width of the window */
  @js.native
  sealed trait enumFitWindowWidth extends EnumDWTFitWindowType
  /* 2 */ val enumFitWindowWidth: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindowWidth with Double = js.native
}
