...
object EnumDWTPlatformType extends StObject {
  ...
  /* 2 */ val enumLinux: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumLinux with Double = js.native
  
  /// Fit the image to the height of the window
  @js.native
  sealed trait enumMac extends EnumDWTPlatformType
  /* 1 */ val enumMac: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumMac with Double = js.native
  
  /// Fit the image to the width and height of the window
  @js.native
  sealed trait enumWindow extends EnumDWTPlatformType
  /* 0 */ val enumWindow: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumWindow with Double = js.native
}
