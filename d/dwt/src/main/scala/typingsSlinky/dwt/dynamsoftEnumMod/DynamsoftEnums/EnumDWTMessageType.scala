...
object EnumDWTMessageType extends StObject {
  ...
  /* 1 */ val TWQC_GET: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMessageType.TWQC_GET with Double = js.native
  
  @js.native
  sealed trait TWQC_GETCURRENT extends EnumDWTMessageType
  /* 8 */ val TWQC_GETCURRENT: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMessageType.TWQC_GETCURRENT with Double = js.native
  
  @js.native
  sealed trait TWQC_GETDEFAULT extends EnumDWTMessageType
  /* 4 */ val TWQC_GETDEFAULT: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMessageType.TWQC_GETDEFAULT with Double = js.native
  
  @js.native
  sealed trait TWQC_RESET extends EnumDWTMessageType
  /* 16 */ val TWQC_RESET: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMessageType.TWQC_RESET with Double = js.native
  
  @js.native
  sealed trait TWQC_SET extends EnumDWTMessageType
  /* 2 */ val TWQC_SET: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTMessageType.TWQC_SET with Double = js.native
}
