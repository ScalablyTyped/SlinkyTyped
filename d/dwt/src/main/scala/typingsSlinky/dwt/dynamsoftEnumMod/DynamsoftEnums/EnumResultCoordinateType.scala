...
object EnumResultCoordinateType extends StObject {
  ...
  /* 2 */ val RCT_PERCENTAGE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumResultCoordinateType.RCT_PERCENTAGE with Double = js.native
  
  @js.native
  sealed trait RCT_PIXEL extends EnumResultCoordinateType
  /* 1 */ val RCT_PIXEL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumResultCoordinateType.RCT_PIXEL with Double = js.native
}
