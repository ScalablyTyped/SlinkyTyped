...
object EnumPDFReadingMode extends StObject {
  ...
  /* 2 */ val PDFRM_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_AUTO with Double = js.native
  
  @js.native
  sealed trait PDFRM_RASTER extends EnumPDFReadingMode
  /* 1 */ val PDFRM_RASTER: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_RASTER with Double = js.native
  
  @js.native
  sealed trait PDFRM_VECTOR extends EnumPDFReadingMode
  /* 4 */ val PDFRM_VECTOR: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_VECTOR with Double = js.native
}
