...
object EnumGrayscaleTransformationMode extends StObject {
  ...
  /* 1 */ val GTM_INVERTED: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_INVERTED with Double = js.native
  
  @js.native
  sealed trait GTM_ORIGINAL extends EnumGrayscaleTransformationMode
  /* 2 */ val GTM_ORIGINAL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_ORIGINAL with Double = js.native
  
  @js.native
  sealed trait GTM_SKIP extends EnumGrayscaleTransformationMode
  /* 0 */ val GTM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_SKIP with Double = js.native
}
