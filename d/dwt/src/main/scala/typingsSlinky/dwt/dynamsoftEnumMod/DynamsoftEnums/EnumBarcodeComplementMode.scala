...
object EnumBarcodeComplementMode extends StObject {
  ...
  /* 1 */ val BCM_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_AUTO with Double = js.native
  
  @js.native
  sealed trait BCM_GENERAL extends EnumBarcodeComplementMode
  /* 2 */ val BCM_GENERAL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_GENERAL with Double = js.native
  
  @js.native
  sealed trait BCM_SKIP extends EnumBarcodeComplementMode
  /* 0 */ val BCM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_SKIP with Double = js.native
}
