...
object EnumQRCodeErrorCorrectionLevel extends StObject {
  ...
  /* 0 */ val QRECL_ERROR_CORRECTION_H: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumQRCodeErrorCorrectionLevel.QRECL_ERROR_CORRECTION_H with Double = js.native
  
  @js.native
  sealed trait QRECL_ERROR_CORRECTION_L extends EnumQRCodeErrorCorrectionLevel
  /* 1 */ val QRECL_ERROR_CORRECTION_L: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumQRCodeErrorCorrectionLevel.QRECL_ERROR_CORRECTION_L with Double = js.native
  
  @js.native
  sealed trait QRECL_ERROR_CORRECTION_M extends EnumQRCodeErrorCorrectionLevel
  /* 2 */ val QRECL_ERROR_CORRECTION_M: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumQRCodeErrorCorrectionLevel.QRECL_ERROR_CORRECTION_M with Double = js.native
  
  @js.native
  sealed trait QRECL_ERROR_CORRECTION_Q extends EnumQRCodeErrorCorrectionLevel
  /* 3 */ val QRECL_ERROR_CORRECTION_Q: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumQRCodeErrorCorrectionLevel.QRECL_ERROR_CORRECTION_Q with Double = js.native
}
