...
object EnumDWTInterpolationMethod extends StObject {
  ...
  /* 5 */ val IM_BESTQUALITY: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTInterpolationMethod.IM_BESTQUALITY with Double = js.native
  
  @js.native
  sealed trait IM_BICUBIC extends EnumDWTInterpolationMethod
  /* 3 */ val IM_BICUBIC: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTInterpolationMethod.IM_BICUBIC with Double = js.native
  
  @js.native
  sealed trait IM_BILINEAR extends EnumDWTInterpolationMethod
  /* 2 */ val IM_BILINEAR: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTInterpolationMethod.IM_BILINEAR with Double = js.native
  
  @js.native
  sealed trait IM_NEARESTNEIGHBOUR extends EnumDWTInterpolationMethod
  /* 1 */ val IM_NEARESTNEIGHBOUR: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTInterpolationMethod.IM_NEARESTNEIGHBOUR with Double = js.native
}
