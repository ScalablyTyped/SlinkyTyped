...
object EnumIntermediateResultSavingMode extends StObject {
  ...
  /* 4 */ val IRSM_BOTH: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_BOTH with Double = js.native
  
  @js.native
  sealed trait IRSM_FILESYSTEM extends EnumIntermediateResultSavingMode
  /* 2 */ val IRSM_FILESYSTEM: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_FILESYSTEM with Double = js.native
  
  @js.native
  sealed trait IRSM_MEMORY extends EnumIntermediateResultSavingMode
  /* 1 */ val IRSM_MEMORY: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_MEMORY with Double = js.native
}
