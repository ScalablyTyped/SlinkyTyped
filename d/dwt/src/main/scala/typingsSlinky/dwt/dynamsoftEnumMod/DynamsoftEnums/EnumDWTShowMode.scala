...
object EnumDWTShowMode extends StObject {
  ...
  /* 0 */ val SW_ACTIVE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTShowMode.SW_ACTIVE with Double = js.native
  
  /** Close the latest opened editor window */
  @js.native
  sealed trait SW_CLOSE extends EnumDWTShowMode
  /* 3 */ val SW_CLOSE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTShowMode.SW_CLOSE with Double = js.native
  
  /** Check whether a window exists */
  @js.native
  sealed trait SW_IFLIVE extends EnumDWTShowMode
  /* 4 */ val SW_IFLIVE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTShowMode.SW_IFLIVE with Double = js.native
  
  /** Maximizes the window */
  @js.native
  sealed trait SW_MAX extends EnumDWTShowMode
  /* 1 */ val SW_MAX: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTShowMode.SW_MAX with Double = js.native
  
  /** Minimize the window */
  @js.native
  sealed trait SW_MIN extends EnumDWTShowMode
  /* 2 */ val SW_MIN: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTShowMode.SW_MIN with Double = js.native
}
