...
object EnumDWTCapPixelFlavor extends StObject {
  ...
  /* 0 */ val TWPF_CHOCOLATE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapPixelFlavor.TWPF_CHOCOLATE with Double = js.native
  ...
  /* 1 */ val TWPF_VANILLA: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapPixelFlavor.TWPF_VANILLA with Double = js.native
}
