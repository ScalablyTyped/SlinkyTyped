...
object EnumReturnType extends StObject {
  ...
  /* -1 */ val RT_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumReturnType.RT_AUTO with Double = js.native
  
  @js.native
  sealed trait RT_BASE64 extends EnumReturnType
  /* 2 */ val RT_BASE64: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumReturnType.RT_BASE64 with Double = js.native
  
  @js.native
  sealed trait RT_BINARY extends EnumReturnType
  /* 1 */ val RT_BINARY: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumReturnType.RT_BINARY with Double = js.native
}
