...
object EnumDWTCapFlipRotation extends StObject {
  ...
  /* 0 */ val TWFR_BOOK: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFlipRotation.TWFR_BOOK with Double = js.native
  ...
  /* 1 */ val TWFR_FANFOLD: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFlipRotation.TWFR_FANFOLD with Double = js.native
}
