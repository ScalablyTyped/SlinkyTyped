...
object EnumDWTCapNoiseFilter extends StObject {
  ...
  /* 1 */ val TWNF_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapNoiseFilter.TWNF_AUTO with Double = js.native
  
  @js.native
  sealed trait TWNF_LONEPIXEL extends EnumDWTCapNoiseFilter
  /* 2 */ val TWNF_LONEPIXEL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapNoiseFilter.TWNF_LONEPIXEL with Double = js.native
  
  @js.native
  sealed trait TWNF_MAJORITYRULE extends EnumDWTCapNoiseFilter
  /* 3 */ val TWNF_MAJORITYRULE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapNoiseFilter.TWNF_MAJORITYRULE with Double = js.native
  
  @js.native
  sealed trait TWNF_NONE extends EnumDWTCapNoiseFilter
  /* 0 */ val TWNF_NONE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapNoiseFilter.TWNF_NONE with Double = js.native
}
