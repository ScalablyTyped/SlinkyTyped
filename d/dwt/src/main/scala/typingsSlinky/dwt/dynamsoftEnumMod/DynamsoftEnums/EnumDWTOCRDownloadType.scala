...
object EnumDWTOCRDownloadType extends StObject {
  ...
  /* 0 */ val OCRDT_Dll: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRDownloadType.OCRDT_Dll with Double = js.native
  
  @js.native
  sealed trait OCRDT_LANGUAGE extends EnumDWTOCRDownloadType
  /* 1 */ val OCRDT_LANGUAGE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRDownloadType.OCRDT_LANGUAGE with Double = js.native
}
