...
object EnumDWTCameraControlProperty extends StObject {
  ...
  /* 4 */ val CCP_EXPOSURE: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_EXPOSURE with Double = js.native
  ...
  /* 6 */ val CCP_FOCUS: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_FOCUS with Double = js.native
  
  /** Specifies the camera's iris setting, in units of fstop* 10. */
  @js.native
  sealed trait CCP_IRIS extends EnumDWTCameraControlProperty
  /* 5 */ val CCP_IRIS: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_IRIS with Double = js.native
  ...
  /* 0 */ val CCP_PAN: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_PAN with Double = js.native
  ...
  /* 2 */ val CCP_ROLL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_ROLL with Double = js.native
  ...
  /* 1 */ val CCP_TILT: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_TILT with Double = js.native
  ...
  /* 3 */ val CCP_ZOOM: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_ZOOM with Double = js.native
}
