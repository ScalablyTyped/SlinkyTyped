...
object EnumDPMCodeReadingMode extends StObject {
  ...
  /* 1 */ val DPMCRM_AUTO: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_AUTO with Double = js.native
  
  @js.native
  sealed trait DPMCRM_GENERAL extends EnumDPMCodeReadingMode
  /* 2 */ val DPMCRM_GENERAL: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_GENERAL with Double = js.native
  
  @js.native
  sealed trait DPMCRM_SKIP extends EnumDPMCodeReadingMode
  /* 0 */ val DPMCRM_SKIP: typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_SKIP with Double = js.native
}
