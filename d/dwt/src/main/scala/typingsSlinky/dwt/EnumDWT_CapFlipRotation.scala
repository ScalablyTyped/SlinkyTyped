...
object EnumDWT_CapFlipRotation extends js.Object {
  ...
  /* 0 */ val TWFR_BOOK: typingsSlinky.dwt.EnumDWT_CapFlipRotation.TWFR_BOOK with Double = js.native
  /* 1 */ val TWFR_FANFOLD: typingsSlinky.dwt.EnumDWT_CapFlipRotation.TWFR_FANFOLD with Double = js.native
  @JSBracketAccess
