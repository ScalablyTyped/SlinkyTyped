...
import typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRLanguage
import typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCROutputFormat
import typingsSlinky.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRPageSetMode
