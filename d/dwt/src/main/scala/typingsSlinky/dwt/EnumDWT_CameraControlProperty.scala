...
object EnumDWT_CameraControlProperty extends js.Object {
  ...
  /* 4 */ val CCP_EXPOSURE: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_EXPOSURE with Double = js.native
  /* 6 */ val CCP_FOCUS: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_FOCUS with Double = js.native
  /* 5 */ val CCP_IRIS: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_IRIS with Double = js.native
  /* 0 */ val CCP_PAN: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_PAN with Double = js.native
  /* 2 */ val CCP_ROLL: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_ROLL with Double = js.native
  /* 1 */ val CCP_TILT: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_TILT with Double = js.native
  /* 3 */ val CCP_ZOOM: typingsSlinky.dwt.EnumDWT_CameraControlProperty.CCP_ZOOM with Double = js.native
  @JSBracketAccess
