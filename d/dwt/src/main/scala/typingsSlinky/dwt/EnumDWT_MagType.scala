...
object EnumDWT_MagType extends js.Object {
  ...
  /* 2 */ val TWMD_INVALID: typingsSlinky.dwt.EnumDWT_MagType.TWMD_INVALID with Double = js.native
  /* 0 */ val TWMD_MICR: typingsSlinky.dwt.EnumDWT_MagType.TWMD_MICR with Double = js.native
  /* 1 */ val TWMD_RAW: typingsSlinky.dwt.EnumDWT_MagType.TWMD_RAW with Double = js.native
  @JSBracketAccess
