...
object EnumDWT_OCRProType extends js.Object {
  ...
  /* 0 */ val OCRDT_File: typingsSlinky.dwt.EnumDWT_OCRProType.OCRDT_File with Double = js.native
  /* 1 */ val OCRDT_Index: typingsSlinky.dwt.EnumDWT_OCRProType.OCRDT_Index with Double = js.native
  @JSBracketAccess
