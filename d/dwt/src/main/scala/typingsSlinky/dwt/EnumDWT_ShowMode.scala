...
object EnumDWT_ShowMode extends js.Object {
  ...
  /* 0 */ val SW_ACTIVE: typingsSlinky.dwt.EnumDWT_ShowMode.SW_ACTIVE with Double = js.native
  /* 3 */ val SW_CLOSE: typingsSlinky.dwt.EnumDWT_ShowMode.SW_CLOSE with Double = js.native
  /* 4 */ val SW_IFLIVE: typingsSlinky.dwt.EnumDWT_ShowMode.SW_IFLIVE with Double = js.native
  /* 1 */ val SW_MAX: typingsSlinky.dwt.EnumDWT_ShowMode.SW_MAX with Double = js.native
  /* 2 */ val SW_MIN: typingsSlinky.dwt.EnumDWT_ShowMode.SW_MIN with Double = js.native
  @JSBracketAccess
