...
object EnumDWT_FileFormat extends js.Object {
  ...
  /* 2 */ val TWFF_BMP: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_BMP with Double = js.native
  /* 14 */ val TWFF_DEJAVU: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_DEJAVU with Double = js.native
  /* 9 */ val TWFF_EXIF: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_EXIF with Double = js.native
  /* 5 */ val TWFF_FPX: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_FPX with Double = js.native
  /* 4 */ val TWFF_JFIF: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_JFIF with Double = js.native
  /* 11 */ val TWFF_JP2: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_JP2 with Double = js.native
  /* 12 */ val TWFF_JPN: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_JPN with Double = js.native
  /* 13 */ val TWFF_JPX: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_JPX with Double = js.native
  /* 10 */ val TWFF_PDF: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_PDF with Double = js.native
  /* 15 */ val TWFF_PDFA: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_PDFA with Double = js.native
  /* 16 */ val TWFF_PDFA2: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_PDFA2 with Double = js.native
  /* 1 */ val TWFF_PICT: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_PICT with Double = js.native
  /* 7 */ val TWFF_PNG: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_PNG with Double = js.native
  /* 8 */ val TWFF_SPIFF: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_SPIFF with Double = js.native
  /* 0 */ val TWFF_TIFF: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_TIFF with Double = js.native
  /* 6 */ val TWFF_TIFFMULTI: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_TIFFMULTI with Double = js.native
  /* 3 */ val TWFF_XBM: typingsSlinky.dwt.EnumDWT_FileFormat.TWFF_XBM with Double = js.native
  @JSBracketAccess
