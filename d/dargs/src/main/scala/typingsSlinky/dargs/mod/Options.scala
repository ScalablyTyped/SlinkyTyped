...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcludesVarargs(value: (String | js.RegExp)*): Self = this.set("excludes", js.Array(value :_*))
    
    @scala.inline
    def setExcludes(value: js.Array[String | js.RegExp]): Self = this.set("excludes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIncludesVarargs(value: (String | js.RegExp)*): Self = this.set("includes", js.Array(value :_*))
    
    @scala.inline
    def setIncludes(value: js.Array[String | js.RegExp]): Self = this.set("includes", value.asInstanceOf[js.Any])
