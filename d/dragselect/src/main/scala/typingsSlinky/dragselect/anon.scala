...
object anon {
  ...
  object PartialareaHTMLElementSVG {
    ...
    implicit class PartialareaHTMLElementSVGMutableBuilder[Self <: PartialareaHTMLElementSVG] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAreaDocument(value: Document): Self = StObject.set(x, "area", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAreaHTMLElement(value: HTMLElement): Self = StObject.set(x, "area", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAreaSVGElement(value: SVGElement): Self = StObject.set(x, "area", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectablesHTMLElement(value: HTMLElement): Self = StObject.set(x, "selectables", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectablesSVGElement(value: SVGElement): Self = StObject.set(x, "selectables", value.asInstanceOf[js.Any])
