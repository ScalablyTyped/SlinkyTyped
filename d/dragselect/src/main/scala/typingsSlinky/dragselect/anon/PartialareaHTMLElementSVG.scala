...
object PartialareaHTMLElementSVG {
  ...
  implicit class PartialareaHTMLElementSVGOps[Self <: PartialareaHTMLElementSVG] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAreaDocument(value: Document): Self = this.set("area", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAreaSVGElement(value: SVGElement): Self = this.set("area", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAreaHTMLElement(value: HTMLElement): Self = this.set("area", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelectablesSVGElement(value: SVGElement): Self = this.set("selectables", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectablesHTMLElement(value: HTMLElement): Self = this.set("selectables", value.asInstanceOf[js.Any])
