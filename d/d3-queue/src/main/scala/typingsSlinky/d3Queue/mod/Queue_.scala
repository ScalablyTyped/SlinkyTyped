...
object Queue_ {
  ...
  implicit class Queue_Ops[Self <: Queue_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAbort(value: () => Queue_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("abort")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withAwait(value: js.Function2[/* error */ js.Any | Null, /* repeated */ js.Any, Unit] => Queue_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("await")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAwaitAll(
      value: js.Function2[/* error */ js.Any | Null, /* results */ js.UndefOr[js.Array[_]], Unit] => Queue_
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("awaitAll")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDefer(value: (js.Function1[/* repeated */ js.Any, Unit], /* repeated */ js.Any) => Queue_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defer")(js.Any.fromFunction2(value))
        ret
    }
  }
