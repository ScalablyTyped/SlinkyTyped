...
object mod extends Shortcut {
  ...
  @js.native
  val default: typingsSlinky.domToImage.mod.DomToImage = js.native
  ...
  @js.native
  val DomToImage: typingsSlinky.domToImage.mod.DomToImage = js.native
  ...
  object global {
    ...
    object DomToImage extends Shortcut {
      ...
      @JSGlobal("DomToImage")
      @js.native
      val ^ : typingsSlinky.domToImage.mod.global.DomToImage.DomToImage = js.native
      type DomToImage = DomToImage_
      
      type Options = Options_
      
      type _To = typingsSlinky.domToImage.mod.global.DomToImage.DomToImage
      
      /* This means you don't have to write `^`, but can instead just say `DomToImage.foo` */
      override def _to: typingsSlinky.domToImage.mod.global.DomToImage.DomToImage = ^
    }
  }
  
  type DomToImage_ = typingsSlinky.domToImage.mod.DomToImage
  ...
  type _To = typingsSlinky.domToImage.mod.DomToImage
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.domToImage.mod.DomToImage = default
}
