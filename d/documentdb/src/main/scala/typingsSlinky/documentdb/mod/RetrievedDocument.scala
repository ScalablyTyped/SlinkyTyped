...
- typingsSlinky.documentdb.mod.AbstractMeta because var conflicts: id. Inlined _self, _ts, _rid, _etag, _attachments */ trait RetrievedDocument extends NewDocument {
