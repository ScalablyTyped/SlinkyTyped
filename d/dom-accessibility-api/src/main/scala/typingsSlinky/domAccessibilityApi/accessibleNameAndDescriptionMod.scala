...
import typingsSlinky.domAccessibilityApi.domAccessibilityApiStrings.description
import typingsSlinky.domAccessibilityApi.domAccessibilityApiStrings.name
