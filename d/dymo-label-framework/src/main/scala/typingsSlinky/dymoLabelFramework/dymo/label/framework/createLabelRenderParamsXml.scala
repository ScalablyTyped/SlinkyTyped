...
@JSGlobal("dymo.label.framework.createLabelRenderParamsXml")
@js.native
object createLabelRenderParamsXml extends js.Object {
  /**
  	 ...
  	 */
  def apply(params: CreateLabelRenderParamsXmlParams): String = js.native
}
