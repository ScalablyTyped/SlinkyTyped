...
import typingsSlinky.dymoLabelFramework.anon.ErrorDetails
import typingsSlinky.dymoLabelFramework.dymo.label.framework.AddPrinterUriCallback
import typingsSlinky.dymoLabelFramework.dymo.label.framework.CreateLabelRenderParamsXmlParams
import typingsSlinky.dymoLabelFramework.dymo.label.framework.CreateLabelWriterPrintParamsXmlParams
import typingsSlinky.dymoLabelFramework.dymo.label.framework.CreateTapePrintParamsXmlParams
import typingsSlinky.dymoLabelFramework.dymo.label.framework.ILabel
import typingsSlinky.dymoLabelFramework.dymo.label.framework.ILabelSetRecord
import typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJob
import typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatusInfo
import typingsSlinky.dymoLabelFramework.dymo.label.framework.PrinterInfo
    ...
    object label extends js.Object {
      ...
      object framework extends js.Object {
        ...
        class LabelSetBuilder ()
          extends typingsSlinky.dymoLabelFramework.dymo.label.framework.LabelSetBuilder {
          /**
        ...
        object AddressBarcodePosition extends js.Object {
          /* 0 */ val AboveAddress: typingsSlinky.dymoLabelFramework.dymo.label.framework.AddressBarcodePosition.AboveAddress with Double = js.native
          /* 1 */ val BelowAddress: typingsSlinky.dymoLabelFramework.dymo.label.framework.AddressBarcodePosition.BelowAddress with Double = js.native
          /* 2 */ val Suppress: typingsSlinky.dymoLabelFramework.dymo.label.framework.AddressBarcodePosition.Suppress with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[
                    typingsSlinky.dymoLabelFramework.dymo.label.framework.AddressBarcodePosition with Double
                  ] = js.native
        }
        ...
        object FlowDirection extends js.Object {
          /* 0 */ val LeftToRight: typingsSlinky.dymoLabelFramework.dymo.label.framework.FlowDirection.LeftToRight with Double = js.native
          /* 1 */ val RightToLeft: typingsSlinky.dymoLabelFramework.dymo.label.framework.FlowDirection.RightToLeft with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[typingsSlinky.dymoLabelFramework.dymo.label.framework.FlowDirection with Double] = js.native
        }
        ...
        object LabelWriterPrintQuality extends js.Object {
          /* 2 */ val Auto: typingsSlinky.dymoLabelFramework.dymo.label.framework.LabelWriterPrintQuality.Auto with Double = js.native
          /* 1 */ val BarcodeAndGraphics: typingsSlinky.dymoLabelFramework.dymo.label.framework.LabelWriterPrintQuality.BarcodeAndGraphics with Double = js.native
          /* 0 */ val Text: typingsSlinky.dymoLabelFramework.dymo.label.framework.LabelWriterPrintQuality.Text with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[
                    typingsSlinky.dymoLabelFramework.dymo.label.framework.LabelWriterPrintQuality with Double
                  ] = js.native
        }
        ...
        object PrintJobStatus extends js.Object {
          /* 0 */ val Error: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.Error with Double = js.native
          /* 1 */ val Finished: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.Finished with Double = js.native
          /* 2 */ val InQueue: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.InQueue with Double = js.native
          /* 3 */ val InvalidJobId: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.InvalidJobId with Double = js.native
          /* 4 */ val NotSpooled: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.NotSpooled with Double = js.native
          /* 5 */ val PaperOut: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.PaperOut with Double = js.native
          /* 6 */ val PrinterBusy: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.PrinterBusy with Double = js.native
          /* 7 */ val Printing: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.Printing with Double = js.native
          /* 8 */ val ProcessingError: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.ProcessingError with Double = js.native
          /* 9 */ val Unknown: typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus.Unknown with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[typingsSlinky.dymoLabelFramework.dymo.label.framework.PrintJobStatus with Double] = js.native
        }
        ...
        object TapeAlignment extends js.Object {
          /* 0 */ val Center: typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeAlignment.Center with Double = js.native
          /* 1 */ val Left: typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeAlignment.Left with Double = js.native
          /* 2 */ val Right: typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeAlignment.Right with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeAlignment with Double] = js.native
        }
        ...
        object TapeCutMode extends js.Object {
          /* 0 */ val AutoCut: typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeCutMode.AutoCut with Double = js.native
          /* 1 */ val ChainMarks: typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeCutMode.ChainMarks with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[typingsSlinky.dymoLabelFramework.dymo.label.framework.TapeCutMode with Double] = js.native
        }
        ...
        object TwinTurboRoll extends js.Object {
          /* 2 */ val Auto: typingsSlinky.dymoLabelFramework.dymo.label.framework.TwinTurboRoll.Auto with Double = js.native
          /* 0 */ val Left: typingsSlinky.dymoLabelFramework.dymo.label.framework.TwinTurboRoll.Left with Double = js.native
          /* 1 */ val Right: typingsSlinky.dymoLabelFramework.dymo.label.framework.TwinTurboRoll.Right with Double = js.native
          @JSBracketAccess
          def apply(value: Double): js.UndefOr[typingsSlinky.dymoLabelFramework.dymo.label.framework.TwinTurboRoll with Double] = js.native
        }
