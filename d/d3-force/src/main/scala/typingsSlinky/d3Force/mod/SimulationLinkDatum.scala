...
object SimulationLinkDatum {
  @scala.inline
  def apply[/* <: typingsSlinky.d3Force.mod.SimulationNodeDatum */ NodeDatum](source: NodeDatum | String | Double, target: NodeDatum | String | Double): SimulationLinkDatum[NodeDatum] = {
    val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
    __obj.asInstanceOf[SimulationLinkDatum[NodeDatum]]
  }
  @scala.inline
  implicit class SimulationLinkDatumOps[Self <: SimulationLinkDatum[_], /* <: typingsSlinky.d3Force.mod.SimulationNodeDatum */ NodeDatum] (val x: Self with SimulationLinkDatum[NodeDatum]) extends AnyVal {
    @scala.inline
