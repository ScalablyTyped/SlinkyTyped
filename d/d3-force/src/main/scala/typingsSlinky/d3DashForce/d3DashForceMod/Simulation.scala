package typingsSlinky.d3DashForce.d3DashForceMod

import typingsSlinky.d3DashForce.d3DashForceStrings.end
import typingsSlinky.d3DashForce.d3DashForceStrings.tick
...
trait Simulation[NodeDatum /* <: SimulationNodeDatum */, LinkDatum /* <: js.UndefOr[SimulationLinkDatum[NodeDatum]] */] extends js.Object {
  ...
  def on(typenames: String): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], Unit]] = js.native
  ...
  @JSName("on")
  def on_end(typenames: end): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], Unit]] = js.native
  @JSName("on")
  def on_end(typenames: end, listener: js.ThisFunction0[/* this */ this.type, Unit]): this.type = js.native
  @JSName("on")
  def on_end_This(typenames: end): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_tick(typenames: tick): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], Unit]] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_tick_This(typenames: tick): this.type = js.native
  /**
