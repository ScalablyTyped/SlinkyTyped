...
object Dom {
  ...
  implicit class DomOps[Self <: Dom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetElementsByAttribute(value: String => js.Array[Node] | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getElementsByAttribute")(js.Any.fromFunction1(value))
        ret
    }
  }
