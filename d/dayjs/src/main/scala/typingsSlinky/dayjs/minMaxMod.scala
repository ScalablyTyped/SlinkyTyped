...
object minMaxMod extends Shortcut {
  
  @JSImport("dayjs/esm/plugin/minMax", JSImport.Namespace)
  @js.native
  val ^ : PluginFunc[js.Any] = js.native
  
  type _To = PluginFunc[js.Any]
  
  /* This means you don't have to write `^`, but can instead just say `minMaxMod.foo` */
