...
class Dayjs () extends js.Object {
  ...
  def dayOfYear(value: Double): typingsSlinky.dayjs.dayOfYearMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  def endOf(unit: ISOUnitType): typingsSlinky.dayjs.isoWeekMod.dayjsAugmentingMod.Dayjs = js.native
  def endOf(unit: OpUnitType): Dayjs = js.native
  def endOf(unit: QUnitType): typingsSlinky.dayjs.quarterOfYearMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  def isoWeekday(value: Double): typingsSlinky.dayjs.isoWeekMod.dayjsAugmentingMod.Dayjs = js.native
  def isoWeeksInYear(): Double = js.native
  def local(): typingsSlinky.dayjs.utcMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  def utc(): typingsSlinky.dayjs.utcMod.dayjsAugmentingMod.Dayjs = js.native
  def utcOffset(): Double = js.native
  def utcOffset(offset: Double): typingsSlinky.dayjs.utcMod.dayjsAugmentingMod.Dayjs = js.native
  def week(): Double = js.native
  def week(value: Double): typingsSlinky.dayjs.weekOfYearMod.dayjsAugmentingMod.Dayjs = js.native
  def weekYear(): Double = js.native
  def weekday(): Double = js.native
  def weekday(value: Double): typingsSlinky.dayjs.weekdayMod.dayjsAugmentingMod.Dayjs = js.native
