package typingsSlinky.dayjs.isoWeeksInYearMod.dayjsAugmentingMod
...
object Dayjs {
  ...
  implicit class DayjsOps[Self <: Dayjs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsoWeeksInYear(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isoWeeksInYear")(js.Any.fromFunction0(value))
        ret
    }
  }
