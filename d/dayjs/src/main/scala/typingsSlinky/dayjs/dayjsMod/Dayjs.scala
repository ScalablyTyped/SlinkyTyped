...
class Dayjs () extends js.Object {
  ...
  def add(value: Double, unit: QUnitType): typingsSlinky.dayjs.pluginQuarterOfYearMod.dayjsMod.Dayjs = js.native
  ...
  def endOf(unit: QUnitType): typingsSlinky.dayjs.pluginQuarterOfYearMod.dayjsMod.Dayjs = js.native
  ...
  def local(): typingsSlinky.dayjs.pluginUtcMod.dayjsMod.Dayjs = js.native
  ...
  def quarter(quarter: Double): typingsSlinky.dayjs.pluginQuarterOfYearMod.dayjsMod.Dayjs = js.native
  ...
  def startOf(unit: QUnitType): typingsSlinky.dayjs.pluginQuarterOfYearMod.dayjsMod.Dayjs = js.native
  def subtract(value: Double, unit: OpUnitType): Dayjs = js.native
  def subtract(value: Double, unit: QUnitType): typingsSlinky.dayjs.pluginQuarterOfYearMod.dayjsMod.Dayjs = js.native
  ...
  def utc(): typingsSlinky.dayjs.pluginUtcMod.dayjsMod.Dayjs = js.native
  def utcOffset(): Double = js.native
  def utcOffset(offset: Double): typingsSlinky.dayjs.pluginUtcMod.dayjsMod.Dayjs = js.native
  def week(): Double = js.native
  def week(value: Double): typingsSlinky.dayjs.pluginWeekOfYearMod.dayjsMod.Dayjs = js.native
  def weekYear(): Double = js.native
  def weekday(): Double = js.native
  def weekday(value: Double): typingsSlinky.dayjs.pluginWeekdayMod.dayjsMod.Dayjs = js.native
