...
class ^[P] protected () extends Delaunator[P] {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var coords: ArrayLike[Double] | js.typedarray.Float64Array = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var halfedges: js.typedarray.Int32Array = js.native
  /**
    * A Uint32Array array of indices that reference points on the convex hull of the input data, counter-clockwise.
    */
  /* CompleteClass */
  override var hull: js.typedarray.Uint32Array = js.native
  /**
    * A Uint32Array array of triangle vertex indices (each group of three numbers forms a triangle).
    * All triangles are directed counterclockwise.
    */
  /* CompleteClass */
  override var triangles: js.typedarray.Uint32Array = js.native
}
