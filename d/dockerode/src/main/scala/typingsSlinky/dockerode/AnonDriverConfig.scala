...
trait AnonDriverConfig extends js.Object {
  var DriverConfig: AnonName = js.native
...
object AnonDriverConfig {
  ...
  @scala.inline
  implicit class AnonDriverConfigOps[Self <: AnonDriverConfig] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withDriverConfig(value: AnonName): Self = {
