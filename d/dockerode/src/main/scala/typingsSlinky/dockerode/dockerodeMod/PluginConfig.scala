...
trait PluginConfig extends js.Object {
  var Args: typingsSlinky.dockerode.dockerodeMod.Args
  var Description: String
  var Documentation: String
  var Entrypoint: js.Array[String]
  var Env: js.Array[PluginEnv]
  var Interface: js.Any
  var Linux: typingsSlinky.dockerode.dockerodeMod.Linux
  var Mounts: js.Array[PluginMount]
  var Network: typingsSlinky.dockerode.dockerodeMod.Network
  var PropagatedMount: String
  var User: js.UndefOr[typingsSlinky.dockerode.dockerodeMod.User] = js.undefined
  var WorkDir: String
  var rootfs: js.Any
}
