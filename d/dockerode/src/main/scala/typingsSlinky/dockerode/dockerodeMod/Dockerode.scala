...
import typingsSlinky.dockerode.Anon_Volumes
...
trait Dockerode extends js.Object {
  ...
  def listVolumes(): js.Promise[Anon_Volumes] = js.native
  def listVolumes(callback: Callback[Anon_Volumes]): Unit = js.native
  def listVolumes(options: js.Object): js.Promise[Anon_Volumes] = js.native
  def listVolumes(options: js.Object, callback: Callback[Anon_Volumes]): Unit = js.native
