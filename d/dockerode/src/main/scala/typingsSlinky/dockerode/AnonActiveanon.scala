...
@js.native
trait AnonActiveanon extends js.Object {
...
object AnonActiveanon {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonActiveanon]
  }
  @scala.inline
  implicit class AnonActiveanonOps[Self <: AnonActiveanon] (val x: Self) extends AnyVal {
    @scala.inline
