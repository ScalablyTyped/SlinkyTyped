...
trait ContainerCreateOptions extends js.Object {
  ...
  var NetworkingConfig: js.UndefOr[typingsSlinky.dockerode.anon.EndpointsConfig] = js.undefined
...
object ContainerCreateOptions {
  ...
  def apply(
    ...
    NetworkingConfig: typingsSlinky.dockerode.anon.EndpointsConfig = null,
