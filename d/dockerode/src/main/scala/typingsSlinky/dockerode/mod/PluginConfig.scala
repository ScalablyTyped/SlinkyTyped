...
trait PluginConfig extends js.Object {
  var Args: typingsSlinky.dockerode.mod.Args
  var Description: String
  var Documentation: String
  var Entrypoint: js.Array[String]
  var Env: js.Array[PluginEnv]
  var Interface: js.Any
  var Linux: typingsSlinky.dockerode.mod.Linux
  var Mounts: js.Array[PluginMount]
  var Network: typingsSlinky.dockerode.mod.Network
  var PropagatedMount: String
  var User: js.UndefOr[typingsSlinky.dockerode.mod.User] = js.undefined
  var WorkDir: String
  var rootfs: js.Any
}
