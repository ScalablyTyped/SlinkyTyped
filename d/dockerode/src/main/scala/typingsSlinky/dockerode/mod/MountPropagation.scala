...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.dockerode.dockerodeStrings.`private`
  - typingsSlinky.dockerode.dockerodeStrings.rprivate
  - typingsSlinky.dockerode.dockerodeStrings.shared
  - typingsSlinky.dockerode.dockerodeStrings.rshared
  - typingsSlinky.dockerode.dockerodeStrings.slave
  - typingsSlinky.dockerode.dockerodeStrings.rslave
*/
