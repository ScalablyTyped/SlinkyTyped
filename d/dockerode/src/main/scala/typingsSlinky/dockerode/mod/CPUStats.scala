...
import typingsSlinky.dockerode.AnonPercpuusage
import typingsSlinky.dockerode.AnonPeriods
...
trait CPUStats extends js.Object {
  var cpu_usage: AnonPercpuusage = js.native
  var online_cpus: Double = js.native
  var system_cpu_usage: Double = js.native
  var throttling_data: AnonPeriods = js.native
}
...
object CPUStats {
  ...
  implicit class CPUStatsOps[Self <: CPUStats] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCpu_usage(value: AnonPercpuusage): Self = {
    ...
    @scala.inline
    def withThrottling_data(value: AnonPeriods): Self = {
        val ret = this.duplicate
