...
trait Spec extends Annotations {
  ...
  var CAConfig: js.UndefOr[typingsSlinky.dockerode.mod.CAConfig] = js.native
  
  var Dispatcher: js.UndefOr[DispatcherConfig] = js.native
  
  var EncryptionConfig: js.UndefOr[typingsSlinky.dockerode.mod.EncryptionConfig] = js.native
  
  var Orchestration: js.UndefOr[OrchestrationConfig] = js.native
  
  var Raft: RaftConfig = js.native
  
  var TaskDefaults: js.UndefOr[typingsSlinky.dockerode.mod.TaskDefaults] = js.native
}
object Spec {
