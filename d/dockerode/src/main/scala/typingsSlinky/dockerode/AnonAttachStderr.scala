...
object AnonAttachStderr {
  ...
  @scala.inline
  implicit class AnonAttachStderrOps[Self <: AnonAttachStderr] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnBuild(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OnBuild")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnBuild: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OnBuild")(js.undefined)
        ret
    }
  }
