...
trait EndpointsConfig extends js.Object {
  var EndpointsConfig: js.UndefOr[typingsSlinky.dockerode.mod.EndpointsConfig] = js.undefined
}

object EndpointsConfig {
  @scala.inline
  def apply(EndpointsConfig: typingsSlinky.dockerode.mod.EndpointsConfig = null): EndpointsConfig = {
