...
@js.native
trait AnonAttachStdin extends js.Object {
...
object AnonAttachStdin {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonAttachStdin]
  }
  @scala.inline
  implicit class AnonAttachStdinOps[Self <: AnonAttachStdin] (val x: Self) extends AnyVal {
    @scala.inline
