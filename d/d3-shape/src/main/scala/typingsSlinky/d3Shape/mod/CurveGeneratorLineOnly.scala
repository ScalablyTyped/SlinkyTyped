...
object CurveGeneratorLineOnly {
  ...
  implicit class CurveGeneratorLineOnlyOps[Self <: CurveGeneratorLineOnly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLineEnd(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineEnd")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLineStart(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lineStart")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withPoint(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("point")(js.Any.fromFunction2(value))
        ret
    }
  }
