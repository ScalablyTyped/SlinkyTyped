...
object CurveGenerator {
  ...
  implicit class CurveGeneratorOps[Self <: CurveGenerator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAreaEnd(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("areaEnd")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withAreaStart(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("areaStart")(js.Any.fromFunction0(value))
        ret
    }
  }
