...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Accessibility.AXPropertyName
import typingsSlinky.devtoolsProtocol.mod.Protocol.Accessibility.AXValueNativeSourceType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Accessibility.AXValueSourceType
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.InspectorIssueCode
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.MixedContentResolutionStatus
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.MixedContentResourceType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.SameSiteCookieExclusionReason
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.SameSiteCookieOperation
import typingsSlinky.devtoolsProtocol.mod.Protocol.Audits.SameSiteCookieWarningReason
import typingsSlinky.devtoolsProtocol.mod.Protocol.BackgroundService.ServiceName
import typingsSlinky.devtoolsProtocol.mod.Protocol.Browser.PermissionSetting
import typingsSlinky.devtoolsProtocol.mod.Protocol.Browser.PermissionType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Browser.WindowState
import typingsSlinky.devtoolsProtocol.mod.Protocol.CSS.CSSMediaSource
import typingsSlinky.devtoolsProtocol.mod.Protocol.CSS.StyleSheetOrigin
import typingsSlinky.devtoolsProtocol.mod.Protocol.CacheStorage.CachedResponseType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Console.ConsoleMessageLevel
import typingsSlinky.devtoolsProtocol.mod.Protocol.Console.ConsoleMessageSource
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.DOMDebugger.DOMBreakpointType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Debugger.BreakLocationType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Debugger.ContinueToLocationRequestTargetCallFrames
import typingsSlinky.devtoolsProtocol.mod.Protocol.Debugger.DebugSymbolsType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Debugger.PausedEventReason
import typingsSlinky.devtoolsProtocol.mod.Protocol.Debugger.ScopeType
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Emulation.VirtualTimePolicy
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.RequestStage
import typingsSlinky.devtoolsProtocol.mod.Protocol.HeadlessExperimental.ScreenshotParamsFormat
import typingsSlinky.devtoolsProtocol.mod.Protocol.IndexedDB.KeyPathType
import typingsSlinky.devtoolsProtocol.mod.Protocol.IndexedDB.KeyType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.DispatchKeyEventRequestType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.DispatchMouseEventRequestPointerType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.DispatchMouseEventRequestType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.DispatchTouchEventRequestType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.EmulateTouchFromMouseEventRequestType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.GestureSourceType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.MouseButton
import typingsSlinky.devtoolsProtocol.mod.Protocol.LayerTree.ScrollRectType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Log.LogEntryLevel
import typingsSlinky.devtoolsProtocol.mod.Protocol.Log.LogEntrySource
import typingsSlinky.devtoolsProtocol.mod.Protocol.Log.ViolationSettingName
import typingsSlinky.devtoolsProtocol.mod.Protocol.Media.PlayerErrorType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Media.PlayerMessageLevel
import typingsSlinky.devtoolsProtocol.mod.Protocol.Memory.PressureLevel
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.AuthChallengeResponseResponse
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.AuthChallengeSource
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.BlockedReason
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.CertificateTransparencyCompliance
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.ConnectionType
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.RequestReferrerPolicy
import typingsSlinky.devtoolsProtocol.mod.Protocol.Network.ResourcePriority
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Page.StartScreencastRequestFormat
import typingsSlinky.devtoolsProtocol.mod.Protocol.Page.TransitionType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Performance.EnableRequestTimeDomain
import typingsSlinky.devtoolsProtocol.mod.Protocol.Performance.SetTimeDomainRequestTimeDomain
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.ConsoleAPICalledEventType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.ObjectPreviewSubtype
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.ObjectPreviewType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.PropertyPreviewSubtype
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.PropertyPreviewType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.RemoteObjectSubtype
import typingsSlinky.devtoolsProtocol.mod.Protocol.Runtime.RemoteObjectType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Security.CertificateErrorAction
import typingsSlinky.devtoolsProtocol.mod.Protocol.Security.MixedContentType
import typingsSlinky.devtoolsProtocol.mod.Protocol.Security.SafetyTipStatus
import typingsSlinky.devtoolsProtocol.mod.Protocol.Security.SecurityState
import typingsSlinky.devtoolsProtocol.mod.Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus
import typingsSlinky.devtoolsProtocol.mod.Protocol.ServiceWorker.ServiceWorkerVersionStatus
import typingsSlinky.devtoolsProtocol.mod.Protocol.Storage.StorageType
import typingsSlinky.devtoolsProtocol.mod.Protocol.SystemInfo.ImageType
import typingsSlinky.devtoolsProtocol.mod.Protocol.SystemInfo.SubsamplingFormat
import typingsSlinky.devtoolsProtocol.mod.Protocol.Tracing.StartRequestTransferMode
import typingsSlinky.devtoolsProtocol.mod.Protocol.Tracing.StreamCompression
import typingsSlinky.devtoolsProtocol.mod.Protocol.Tracing.StreamFormat
import typingsSlinky.devtoolsProtocol.mod.Protocol.Tracing.TraceConfigRecordMode
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAudio.AutomationRate
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAudio.ChannelCountMode
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAudio.ChannelInterpretation
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAudio.ContextState
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAudio.ContextType
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAuthn.AuthenticatorProtocol
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAuthn.AuthenticatorTransport
...
object devtoolsProtocolStrings {
  ...
  sealed trait CancelAuth
    extends AuthChallengeResponseResponse
       with typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.AuthChallengeResponseResponse
  ...
  sealed trait Proxy
    extends AuthChallengeSource
       with typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.AuthChallengeSource
  ...
  sealed trait allow
    extends SetDownloadBehaviorRequestBehavior
       with typingsSlinky.devtoolsProtocol.mod.Protocol.Browser.SetDownloadBehaviorRequestBehavior
  
  @js.native
  sealed trait allowAndName
    extends typingsSlinky.devtoolsProtocol.mod.Protocol.Browser.SetDownloadBehaviorRequestBehavior
