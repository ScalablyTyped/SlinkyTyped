...
@js.native
trait GetMatchedStylesForNodeRequest extends js.Object {
...
object GetMatchedStylesForNodeRequest {
  ...
  @scala.inline
  implicit class GetMatchedStylesForNodeRequestOps[Self <: GetMatchedStylesForNodeRequest] (val x: Self) extends AnyVal {
