...
@js.native
trait GetInlineStylesForNodeRequest extends js.Object {
...
object GetInlineStylesForNodeRequest {
  ...
  @scala.inline
  implicit class GetInlineStylesForNodeRequestOps[Self <: GetInlineStylesForNodeRequest] (val x: Self) extends AnyVal {
    @scala.inline
