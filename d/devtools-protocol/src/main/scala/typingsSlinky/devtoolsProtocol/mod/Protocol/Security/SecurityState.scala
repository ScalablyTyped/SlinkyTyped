...
object SecurityState {
  ...
  @scala.inline
  def info: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.info = "info".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.info]
  
  @scala.inline
  def insecure: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.insecure = "insecure".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.insecure]
  
  @scala.inline
  def `insecure-broken`: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.`insecure-broken` = "insecure-broken".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.`insecure-broken`]
