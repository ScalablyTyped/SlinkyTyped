...
@js.native
trait GetPlatformFontsForNodeRequest extends js.Object {
...
object GetPlatformFontsForNodeRequest {
  ...
  @scala.inline
  implicit class GetPlatformFontsForNodeRequestOps[Self <: GetPlatformFontsForNodeRequest] (val x: Self) extends AnyVal {
