...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.SameSiteCookieIssue
...
object InspectorIssueCode {
  ...
  @scala.inline
  def MixedContentIssue: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.MixedContentIssue = "MixedContentIssue".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.MixedContentIssue]
  
  @scala.inline
  def SameSiteCookieIssue: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.SameSiteCookieIssue = "SameSiteCookieIssue".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.SameSiteCookieIssue]
}
