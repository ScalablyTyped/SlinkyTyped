...
@js.native
trait GetRelayoutBoundaryResponse extends js.Object {
  /**
...
object GetRelayoutBoundaryResponse {
  ...
  @scala.inline
  implicit class GetRelayoutBoundaryResponseOps[Self <: GetRelayoutBoundaryResponse] (val x: Self) extends AnyVal {
    @scala.inline
