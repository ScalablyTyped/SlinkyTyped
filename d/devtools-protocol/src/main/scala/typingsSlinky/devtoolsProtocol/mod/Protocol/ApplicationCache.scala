...
object ApplicationCache {
  ...
  object ApplicationCache {
    ...
    def apply(
      ...
      size: Double,
      updateTime: Double
    ): typingsSlinky.devtoolsProtocol.mod.Protocol.ApplicationCache.ApplicationCache = {
      ...
      __obj.asInstanceOf[typingsSlinky.devtoolsProtocol.mod.Protocol.ApplicationCache.ApplicationCache]
    }
    
    @scala.inline
    implicit class ApplicationCacheMutableBuilder[Self <: typingsSlinky.devtoolsProtocol.mod.Protocol.ApplicationCache.ApplicationCache] (val x: Self) extends AnyVal {
  ...
  object GetApplicationCacheForFrameResponse {
    ...
    implicit class GetApplicationCacheForFrameResponseMutableBuilder[Self <: GetApplicationCacheForFrameResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApplicationCache(value: typingsSlinky.devtoolsProtocol.mod.Protocol.ApplicationCache.ApplicationCache): Self = StObject.set(x, "applicationCache", value.asInstanceOf[js.Any])
    }
  }
