...
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.CSSAnimation
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.CSSTransition
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.WebAnimation
...
object Animation {
  ...
  def apply(
  ...
  ): typingsSlinky.devtoolsProtocol.mod.Protocol.Animation.Animation = {
    ...
    __obj.asInstanceOf[typingsSlinky.devtoolsProtocol.mod.Protocol.Animation.Animation]
  }
  
  @scala.inline
  implicit class AnimationMutableBuilder[Self <: typingsSlinky.devtoolsProtocol.mod.Protocol.Animation.Animation] (val x: Self) extends AnyVal {
