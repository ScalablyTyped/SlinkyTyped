...
@js.native
trait WebSocketFrameReceivedEvent extends js.Object {
  /**
    * Request identifier.
    */
...
object WebSocketFrameReceivedEvent {
  ...
  @scala.inline
  implicit class WebSocketFrameReceivedEventOps[Self <: WebSocketFrameReceivedEvent] (val x: Self) extends AnyVal {
    @scala.inline
