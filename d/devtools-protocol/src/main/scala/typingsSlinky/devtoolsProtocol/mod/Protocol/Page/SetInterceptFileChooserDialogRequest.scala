...
@js.native
trait SetInterceptFileChooserDialogRequest extends js.Object {
...
object SetInterceptFileChooserDialogRequest {
  ...
  @scala.inline
  implicit class SetInterceptFileChooserDialogRequestOps[Self <: SetInterceptFileChooserDialogRequest] (val x: Self) extends AnyVal {
