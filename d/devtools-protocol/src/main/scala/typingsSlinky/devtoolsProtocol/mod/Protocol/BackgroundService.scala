...
object BackgroundService {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.pushMessaging
  ...
  */
  ...
  object ServiceName {
    ...
    @scala.inline
    def pushMessaging: typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.pushMessaging = "pushMessaging".asInstanceOf[typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.pushMessaging]
  }
