...
@js.native
trait GetAllTimeSamplingProfileResponse extends js.Object {
...
object GetAllTimeSamplingProfileResponse {
  ...
  @scala.inline
  implicit class GetAllTimeSamplingProfileResponseOps[Self <: GetAllTimeSamplingProfileResponse] (val x: Self) extends AnyVal {
    @scala.inline
