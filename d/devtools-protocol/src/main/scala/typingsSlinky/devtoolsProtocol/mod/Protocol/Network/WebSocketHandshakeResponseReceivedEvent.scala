...
@js.native
trait WebSocketHandshakeResponseReceivedEvent extends js.Object {
  /**
    * Request identifier.
    */
...
object WebSocketHandshakeResponseReceivedEvent {
  ...
  @scala.inline
  implicit class WebSocketHandshakeResponseReceivedEventOps[Self <: WebSocketHandshakeResponseReceivedEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResponse(value: WebSocketResponse): Self = this.set("response", value.asInstanceOf[js.Any])
    @scala.inline
