package typingsSlinky.devtoolsProtocol.mod.Protocol.Schema
...
@js.native
trait GetDomainsResponse extends js.Object {
  /**
...
object GetDomainsResponse {
  ...
  @scala.inline
  implicit class GetDomainsResponseOps[Self <: GetDomainsResponse] (val x: Self) extends AnyVal {
    @scala.inline
