...
@js.native
trait SetCustomObjectFormatterEnabledRequest extends js.Object {
...
object SetCustomObjectFormatterEnabledRequest {
  ...
  @scala.inline
  implicit class SetCustomObjectFormatterEnabledRequestOps[Self <: SetCustomObjectFormatterEnabledRequest] (val x: Self) extends AnyVal {
