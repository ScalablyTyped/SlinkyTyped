...
@js.native
trait NodeParamDisconnectedEvent extends js.Object {
...
object NodeParamDisconnectedEvent {
  ...
  @scala.inline
  implicit class NodeParamDisconnectedEventOps[Self <: NodeParamDisconnectedEvent] (val x: Self) extends AnyVal {
