...
object `99` {
  ...
  implicit class `99Ops`[Self <: `99`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: DispatchMouseEventRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[DispatchMouseEventRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
