...
object `9` {
  ...
  implicit class `9Ops`[Self <: `9`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: js.UndefOr[StepIntoRequest]*): Self = this.set("paramsType", js.Array(value :_*))
    @scala.inline
    def setParamsType(value: js.Array[js.UndefOr[StepIntoRequest]]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
    @scala.inline
