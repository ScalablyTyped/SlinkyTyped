...
@js.native
trait ReturnTypeGetAllTimeSamplingProfileResponse extends js.Object {
...
object ReturnTypeGetAllTimeSamplingProfileResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetAllTimeSamplingProfileResponseOps[Self <: ReturnTypeGetAllTimeSamplingProfileResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetAllTimeSamplingProfileResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
