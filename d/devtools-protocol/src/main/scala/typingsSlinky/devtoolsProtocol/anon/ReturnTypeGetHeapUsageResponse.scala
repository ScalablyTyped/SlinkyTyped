...
@js.native
trait ReturnTypeGetHeapUsageResponse extends js.Object {
...
object ReturnTypeGetHeapUsageResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetHeapUsageResponseOps[Self <: ReturnTypeGetHeapUsageResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetHeapUsageResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
