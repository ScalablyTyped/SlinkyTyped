...
@js.native
trait ReturnTypeGetAllCookiesResponse extends js.Object {
...
object ReturnTypeGetAllCookiesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetAllCookiesResponseOps[Self <: ReturnTypeGetAllCookiesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetAllCookiesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
