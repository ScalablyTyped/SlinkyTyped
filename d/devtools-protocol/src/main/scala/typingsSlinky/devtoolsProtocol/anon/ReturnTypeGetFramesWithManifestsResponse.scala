...
@js.native
trait ReturnTypeGetFramesWithManifestsResponse extends js.Object {
...
object ReturnTypeGetFramesWithManifestsResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetFramesWithManifestsResponseOps[Self <: ReturnTypeGetFramesWithManifestsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetFramesWithManifestsResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
