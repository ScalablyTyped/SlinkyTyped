...
@js.native
trait ReturnTypeGetNodeStackTracesResponse extends js.Object {
...
object ReturnTypeGetNodeStackTracesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetNodeStackTracesResponseOps[Self <: ReturnTypeGetNodeStackTracesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: GetNodeStackTracesRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[GetNodeStackTracesRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReturnType(value: GetNodeStackTracesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
