...
@js.native
trait ReturnTypeTakeComputedStyleUpdatesResponse extends js.Object {
  
  var paramsType: js.Array[js.Any] = js.native
  
  var returnType: TakeComputedStyleUpdatesResponse = js.native
}
object ReturnTypeTakeComputedStyleUpdatesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeTakeComputedStyleUpdatesResponseOps[Self <: ReturnTypeTakeComputedStyleUpdatesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: TakeComputedStyleUpdatesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
