...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Input.DispatchTouchEventRequest
...
object `96` {
  ...
  @scala.inline
  def apply(paramsType: js.Array[DispatchTouchEventRequest], returnType: Unit): `96` = {
