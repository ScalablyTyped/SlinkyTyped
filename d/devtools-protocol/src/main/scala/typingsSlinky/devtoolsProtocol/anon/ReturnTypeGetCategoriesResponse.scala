...
@js.native
trait ReturnTypeGetCategoriesResponse extends js.Object {
...
object ReturnTypeGetCategoriesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetCategoriesResponseOps[Self <: ReturnTypeGetCategoriesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetCategoriesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
