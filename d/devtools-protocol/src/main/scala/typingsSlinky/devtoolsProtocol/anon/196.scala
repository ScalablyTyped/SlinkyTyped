...
object `196` {
  ...
  implicit class `196Ops`[Self <: `196`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: SetDiscoverTargetsRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[SetDiscoverTargetsRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
