...
@js.native
trait ReturnTypeGetTargetsResponse extends js.Object {
  
  var paramsType: js.Array[js.Any] = js.native
  
  var returnType: GetTargetsResponse = js.native
}
object ReturnTypeGetTargetsResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetTargetsResponseOps[Self <: ReturnTypeGetTargetsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetTargetsResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
