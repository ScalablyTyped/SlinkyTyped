...
object `33` {
  ...
  implicit class `33MutableBuilder`[Self <: `33`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsType(value: js.Array[SetPermissionRequest]): Self = StObject.set(x, "paramsType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParamsTypeVarargs(value: SetPermissionRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
