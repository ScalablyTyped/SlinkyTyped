...
@js.native
trait ParamsTypeReturnTypeGetCookiesResponse extends js.Object {
...
object ParamsTypeReturnTypeGetCookiesResponse {
  ...
  @scala.inline
  implicit class ParamsTypeReturnTypeGetCookiesResponseOps[Self <: ParamsTypeReturnTypeGetCookiesResponse] (val x: Self) extends AnyVal {
    @scala.inline
