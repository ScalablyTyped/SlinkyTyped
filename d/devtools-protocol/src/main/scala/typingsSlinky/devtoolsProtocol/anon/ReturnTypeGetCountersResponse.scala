...
@js.native
trait ReturnTypeGetCountersResponse extends js.Object {
  
  var paramsType: js.Array[js.Any] = js.native
  
  var returnType: GetCountersResponse = js.native
}
object ReturnTypeGetCountersResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetCountersResponseOps[Self <: ReturnTypeGetCountersResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetCountersResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
