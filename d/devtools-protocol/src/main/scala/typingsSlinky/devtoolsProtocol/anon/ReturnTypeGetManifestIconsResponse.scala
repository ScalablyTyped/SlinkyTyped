...
@js.native
trait ReturnTypeGetManifestIconsResponse extends js.Object {
...
object ReturnTypeGetManifestIconsResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetManifestIconsResponseOps[Self <: ReturnTypeGetManifestIconsResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetManifestIconsResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
