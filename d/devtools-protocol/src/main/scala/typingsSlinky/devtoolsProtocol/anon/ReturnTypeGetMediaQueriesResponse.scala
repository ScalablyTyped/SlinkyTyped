...
@js.native
trait ReturnTypeGetMediaQueriesResponse extends js.Object {
...
object ReturnTypeGetMediaQueriesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetMediaQueriesResponseOps[Self <: ReturnTypeGetMediaQueriesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetMediaQueriesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
