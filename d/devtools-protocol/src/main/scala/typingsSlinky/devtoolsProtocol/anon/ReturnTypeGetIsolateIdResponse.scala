...
@js.native
trait ReturnTypeGetIsolateIdResponse extends js.Object {
...
object ReturnTypeGetIsolateIdResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetIsolateIdResponseOps[Self <: ReturnTypeGetIsolateIdResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetIsolateIdResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
