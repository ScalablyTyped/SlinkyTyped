...
@js.native
trait ReturnTypeGetNavigationHistoryResponse extends js.Object {
...
object ReturnTypeGetNavigationHistoryResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetNavigationHistoryResponseOps[Self <: ReturnTypeGetNavigationHistoryResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetNavigationHistoryResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
