...
object `67` {
  ...
  implicit class `67MutableBuilder`[Self <: `67`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsType(value: js.Array[SetEventListenerBreakpointRequest]): Self = StObject.set(x, "paramsType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParamsTypeVarargs(value: SetEventListenerBreakpointRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
