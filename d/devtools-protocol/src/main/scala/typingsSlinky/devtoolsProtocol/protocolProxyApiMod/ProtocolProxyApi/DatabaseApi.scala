...
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.addDatabase
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Database.GetDatabaseTableNamesRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.Database.GetDatabaseTableNamesResponse
