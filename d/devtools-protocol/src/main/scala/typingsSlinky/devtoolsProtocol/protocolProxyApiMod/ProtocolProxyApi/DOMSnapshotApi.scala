...
import typingsSlinky.devtoolsProtocol.mod.Protocol.DOMSnapshot.CaptureSnapshotRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.DOMSnapshot.CaptureSnapshotResponse
