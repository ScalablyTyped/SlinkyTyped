...
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.authRequired
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.requestPaused
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.AuthRequiredEvent
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.ContinueRequestRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.ContinueWithAuthRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.EnableRequest
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.TakeResponseBodyAsStreamRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.Fetch.TakeResponseBodyAsStreamResponse
