...
import typingsSlinky.devtoolsProtocol.devtoolsProtocolStrings.virtualTimeBudgetExpired
import typingsSlinky.devtoolsProtocol.mod.Protocol.Emulation.CanEmulateResponse
...
import typingsSlinky.devtoolsProtocol.mod.Protocol.Emulation.SetScrollbarsHiddenRequest
