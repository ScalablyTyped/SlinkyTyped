...
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAuthn.GetCredentialRequest
import typingsSlinky.devtoolsProtocol.mod.Protocol.WebAuthn.GetCredentialResponse
