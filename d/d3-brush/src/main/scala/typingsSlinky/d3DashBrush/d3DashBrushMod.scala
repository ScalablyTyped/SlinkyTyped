...
object d3DashBrushMod extends js.Object {
  ...
  trait BrushBehavior[Datum] extends js.Object {
    ...
    /**
      ...
      */
    def move(group: Selection[typingsSlinky.std.SVGGElement, Datum, _, _]): Unit = js.native
    /**
      ...
      */
    def move(group: Selection[typingsSlinky.std.SVGGElement, Datum, _, _], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) selection
      ...
      */
    def move(
      group: Selection[typingsSlinky.std.SVGGElement, Datum, _, _],
      selection: ValueFn[typingsSlinky.std.SVGGElement, Datum, BrushSelection]
    ): Unit = js.native
    /**
      ...
      * for a y-brush, it must be defined as [y0, y1].
      */
    def move(group: TransitionLike[typingsSlinky.std.SVGGElement, Datum], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) transition
