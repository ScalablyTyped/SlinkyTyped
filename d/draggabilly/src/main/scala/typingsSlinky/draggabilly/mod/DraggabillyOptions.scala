...
object DraggabillyOptions {
  ...
  implicit class DraggabillyOptionsOps[Self <: DraggabillyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxis(value: typingsSlinky.draggabilly.draggabillyStrings.x | y): Self = this.set("axis", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAxis: Self = this.set("axis", js.undefined)
    
    @scala.inline
    def setContainmentElement(value: Element): Self = this.set("containment", value.asInstanceOf[js.Any])
