...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* renderProps */ RenderProps => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRender(value: /* renderProps */ RenderProps => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
