...
object VoidLiteral {
  ...
  @scala.inline
  implicit class VoidLiteralOps[Self <: VoidLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.doctrine.doctrineStrings.VoidLiteral): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
