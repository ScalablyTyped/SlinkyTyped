...
trait ParameterType extends Type_ {
  ...
  var `type`: typingsSlinky.doctrine.doctrineStrings.ParameterType = js.native
}
object ParameterType {
  ...
  implicit class ParameterTypeMutableBuilder[Self <: ParameterType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.doctrine.doctrineStrings.ParameterType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
