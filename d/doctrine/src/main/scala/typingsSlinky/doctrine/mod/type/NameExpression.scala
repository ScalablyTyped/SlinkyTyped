...
trait NameExpression extends Type_ {
  ...
  var `type`: typingsSlinky.doctrine.doctrineStrings.NameExpression = js.native
}
object NameExpression {
  ...
  implicit class NameExpressionMutableBuilder[Self <: NameExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.doctrine.doctrineStrings.NameExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
