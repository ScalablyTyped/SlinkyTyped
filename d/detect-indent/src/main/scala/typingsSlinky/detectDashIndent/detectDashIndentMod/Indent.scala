package typingsSlinky.detectDashIndent.detectDashIndentMod

import typingsSlinky.detectDashIndent.detectDashIndentStrings.space
import typingsSlinky.detectDashIndent.detectDashIndentStrings.tab
