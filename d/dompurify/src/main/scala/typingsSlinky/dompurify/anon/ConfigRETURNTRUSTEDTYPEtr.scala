...
object ConfigRETURNTRUSTEDTYPEtr {
  ...
  @scala.inline
  implicit class ConfigRETURNTRUSTEDTYPEtrOps[Self <: ConfigRETURNTRUSTEDTYPEtr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRETURN_TRUSTED_TYPE(value: js.UndefOr[Boolean] with `true`): Self = this.set("RETURN_TRUSTED_TYPE", value.asInstanceOf[js.Any])
