...
object ConfigRETURNDOMFRAGMENTfa {
  ...
  implicit class ConfigRETURNDOMFRAGMENTfaOps[Self <: ConfigRETURNDOMFRAGMENTfa] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRETURN_DOM(value: js.UndefOr[Boolean] with js.UndefOr[`false`]): Self = this.set("RETURN_DOM", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRETURN_DOM_FRAGMENT(value: js.UndefOr[Boolean] with js.UndefOr[`false`]): Self = this.set("RETURN_DOM_FRAGMENT", value.asInstanceOf[js.Any])
