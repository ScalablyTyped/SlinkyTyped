...
trait ConfigRETURNDOMFRAGMENTfa extends js.Object {
  ...
  var RETURN_DOM: js.UndefOr[Boolean with `false`] = js.undefined
  var RETURN_DOM_FRAGMENT: js.UndefOr[Boolean with `false`] = js.undefined
...
object ConfigRETURNDOMFRAGMENTfa {
  ...
  def apply(
    ...
    RETURN_DOM: js.UndefOr[Boolean with `false`] = js.undefined,
    RETURN_DOM_FRAGMENT: js.UndefOr[Boolean with `false`] = js.undefined,
