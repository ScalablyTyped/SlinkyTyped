...
/* Inlined dompurify.dompurify.Config & {  RETURN_DOM_FRAGMENT ? :false,   RETURN_DOM ? :false} */
@js.native
trait ConfigRETURNDOMFRAGMENTfa extends js.Object {
  ...
  var RETURN_DOM: js.UndefOr[Boolean with `false`] = js.native
  var RETURN_DOM_FRAGMENT: js.UndefOr[Boolean with `false`] = js.native
...
object ConfigRETURNDOMFRAGMENTfa {
  @scala.inline
  def apply(): ConfigRETURNDOMFRAGMENTfa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConfigRETURNDOMFRAGMENTfa]
  }
  @scala.inline
  implicit class ConfigRETURNDOMFRAGMENTfaOps[Self <: ConfigRETURNDOMFRAGMENTfa] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRETURN_DOM(value: Boolean with `false`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRETURN_DOM_FRAGMENT(value: Boolean with `false`): Self = {
        val ret = this.duplicate
