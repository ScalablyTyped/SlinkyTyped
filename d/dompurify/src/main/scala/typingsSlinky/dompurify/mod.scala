...
object mod extends Shortcut {
  ...
  object Config {
    ...
    implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setALLOWED_URI_REGEXP(value: js.RegExp): Self = StObject.set(x, "ALLOWED_URI_REGEXP", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object _HookEvent {
    ...
    def SanitizeAttributeHookEvent(
      ...
      val __obj = js.Dynamic.literal(allowedAttributes = allowedAttributes.asInstanceOf[js.Any], attrName = attrName.asInstanceOf[js.Any], attrValue = attrValue.asInstanceOf[js.Any], keepAttr = keepAttr.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dompurify.mod.SanitizeAttributeHookEvent]
    }
    
    @scala.inline
    def SanitizeElementHookEvent(allowedTags: StringDictionary[Boolean], tagName: String): typingsSlinky.dompurify.mod.SanitizeElementHookEvent = {
      val __obj = js.Dynamic.literal(allowedTags = allowedTags.asInstanceOf[js.Any], tagName = tagName.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.dompurify.mod.SanitizeElementHookEvent]
    }
  }
