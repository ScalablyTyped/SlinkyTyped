...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.dompurify.dompurifyStrings.beforeSanitizeElements
  - typingsSlinky.dompurify.dompurifyStrings.uponSanitizeElement
  - typingsSlinky.dompurify.dompurifyStrings.afterSanitizeElements
  - typingsSlinky.dompurify.dompurifyStrings.beforeSanitizeAttributes
  - typingsSlinky.dompurify.dompurifyStrings.uponSanitizeAttribute
  - typingsSlinky.dompurify.dompurifyStrings.afterSanitizeAttributes
  - typingsSlinky.dompurify.dompurifyStrings.beforeSanitizeShadowDOM
  - typingsSlinky.dompurify.dompurifyStrings.uponSanitizeShadowNode
  - typingsSlinky.dompurify.dompurifyStrings.afterSanitizeShadowDOM
*/
