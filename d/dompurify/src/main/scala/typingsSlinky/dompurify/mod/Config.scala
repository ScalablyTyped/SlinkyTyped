...
object Config {
  ...
  def apply(
    ...
    if (ADD_DATA_URI_TAGS != null) __obj.updateDynamic("ADD_DATA_URI_TAGS")(ADD_DATA_URI_TAGS.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ALLOW_DATA_ATTR)) __obj.updateDynamic("ALLOW_DATA_ATTR")(ALLOW_DATA_ATTR.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ALLOW_UNKNOWN_PROTOCOLS)) __obj.updateDynamic("ALLOW_UNKNOWN_PROTOCOLS")(ALLOW_UNKNOWN_PROTOCOLS.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(FORCE_BODY)) __obj.updateDynamic("FORCE_BODY")(FORCE_BODY.get.asInstanceOf[js.Any])
    if (!js.isUndefined(IN_PLACE)) __obj.updateDynamic("IN_PLACE")(IN_PLACE.get.asInstanceOf[js.Any])
    if (!js.isUndefined(KEEP_CONTENT)) __obj.updateDynamic("KEEP_CONTENT")(KEEP_CONTENT.get.asInstanceOf[js.Any])
    if (!js.isUndefined(RETURN_DOM)) __obj.updateDynamic("RETURN_DOM")(RETURN_DOM.get.asInstanceOf[js.Any])
    if (!js.isUndefined(RETURN_DOM_FRAGMENT)) __obj.updateDynamic("RETURN_DOM_FRAGMENT")(RETURN_DOM_FRAGMENT.get.asInstanceOf[js.Any])
    if (!js.isUndefined(RETURN_DOM_IMPORT)) __obj.updateDynamic("RETURN_DOM_IMPORT")(RETURN_DOM_IMPORT.get.asInstanceOf[js.Any])
    if (!js.isUndefined(RETURN_TRUSTED_TYPE)) __obj.updateDynamic("RETURN_TRUSTED_TYPE")(RETURN_TRUSTED_TYPE.get.asInstanceOf[js.Any])
    if (!js.isUndefined(SAFE_FOR_JQUERY)) __obj.updateDynamic("SAFE_FOR_JQUERY")(SAFE_FOR_JQUERY.get.asInstanceOf[js.Any])
    if (!js.isUndefined(SAFE_FOR_TEMPLATES)) __obj.updateDynamic("SAFE_FOR_TEMPLATES")(SAFE_FOR_TEMPLATES.get.asInstanceOf[js.Any])
    if (!js.isUndefined(SANITIZE_DOM)) __obj.updateDynamic("SANITIZE_DOM")(SANITIZE_DOM.get.asInstanceOf[js.Any])
    if (USE_PROFILES != null) __obj.updateDynamic("USE_PROFILES")(USE_PROFILES.asInstanceOf[js.Any])
    if (!js.isUndefined(WHOLE_DOCUMENT)) __obj.updateDynamic("WHOLE_DOCUMENT")(WHOLE_DOCUMENT.get.asInstanceOf[js.Any])
