...
object Config {
  ...
  implicit class ConfigOps[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setALLOWED_URI_REGEXP(value: js.RegExp): Self = this.set("ALLOWED_URI_REGEXP", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRETURN_DOM_FRAGMENT(value: Boolean): Self = this.set("RETURN_DOM_FRAGMENT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRETURN_DOM_FRAGMENT: Self = this.set("RETURN_DOM_FRAGMENT", js.undefined)
