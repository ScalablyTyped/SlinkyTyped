...
import typingsSlinky.dompurify.dompurifyBooleans.`true`
...
object ConfigRETURNDOMtrue {
  @scala.inline
  def apply(): ConfigRETURNDOMtrue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConfigRETURNDOMtrue]
  }
  @scala.inline
  implicit class ConfigRETURNDOMtrueOps[Self <: ConfigRETURNDOMtrue] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withRETURN_DOM(value: Boolean with `true`): Self = {
        val ret = this.duplicate
