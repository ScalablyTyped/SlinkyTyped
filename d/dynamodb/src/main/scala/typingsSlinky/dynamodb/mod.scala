...
import typingsSlinky.dynamodb.anon.ReadCapacity
import typingsSlinky.dynamodb.anon.TypeofModel
import typingsSlinky.dynamodb.callbackMod.Callback
import typingsSlinky.dynamodb.dynamoDBMod.DocumentClient
import typingsSlinky.dynamodb.dynamoDBMod.DynamoDB
import typingsSlinky.dynamodb.dynamoDBMod.DynamoDbSet
