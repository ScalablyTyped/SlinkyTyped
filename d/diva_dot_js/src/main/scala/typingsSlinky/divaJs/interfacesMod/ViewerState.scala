...
object ViewerState {
  ...
  implicit class ViewerStateOps[Self <: ViewerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderer(value: typingsSlinky.divaJs.rendererMod.default): Self = this.set("renderer", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setViewport(value: typingsSlinky.divaJs.viewportMod.default): Self = this.set("viewport", value.asInstanceOf[js.Any])
    @scala.inline
