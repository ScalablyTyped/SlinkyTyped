...
object SourceProvider {
  ...
  implicit class SourceProviderOps[Self <: SourceProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitlesVarargs(value: typingsSlinky.divaJs.anon.Dimensions*): Self = this.set("titles", js.Array(value :_*))
    @scala.inline
    def setTitles(value: js.Array[typingsSlinky.divaJs.anon.Dimensions]): Self = this.set("titles", value.asInstanceOf[js.Any])
    @scala.inline
