...
object interfacesMod {
  ...
  object SourceProvider {
    ...
    implicit class SourceProviderMutableBuilder[Self <: SourceProvider] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTitles(value: js.Array[typingsSlinky.divaJs.anon.Dimensions]): Self = StObject.set(x, "titles", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTitlesVarargs(value: typingsSlinky.divaJs.anon.Dimensions*): Self = StObject.set(x, "titles", js.Array(value :_*))
  ...
  object ViewerState {
    ...
    implicit class ViewerStateMutableBuilder[Self <: ViewerState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderer(value: typingsSlinky.divaJs.rendererMod.default): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setViewport(value: typingsSlinky.divaJs.viewportMod.default): Self = StObject.set(x, "viewport", value.asInstanceOf[js.Any])
