...
import typingsSlinky.divaDotJs.interfacesMod.ManifestData
import typingsSlinky.divaDotJs.interfacesMod.Page
...
@js.native
object imageDashManifestMod extends js.Object {
  @js.native
  trait ImageManifest extends js.Object {
    ...
    def etPageImageTiles(pageIndex: Double, zoomLevel: Double, tileDimensions: Dimensions): Anon_Cols = js.native
