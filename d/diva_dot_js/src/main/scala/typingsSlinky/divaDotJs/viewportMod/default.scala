package typingsSlinky.divaDotJs.viewportMod

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.divaDotJs.Anon_IntersectionTolerance
...
class default protected () extends Viewport {
  ...
  def this(outer: HTMLElement, options: Anon_IntersectionTolerance) = this()
  /* CompleteClass */
