...
import typingsSlinky.divaDotJs.Anon_Height
import typingsSlinky.divaDotJs.Anon_IncludePadding
import typingsSlinky.divaDotJs.Anon_Left
import typingsSlinky.divaDotJs.Anon_ObjectData
import typingsSlinky.divaDotJs.interfacesMod.Dimensions
import typingsSlinky.divaDotJs.interfacesMod.Options
import typingsSlinky.divaDotJs.interfacesMod.Settings
import typingsSlinky.divaDotJs.interfacesMod.State
import typingsSlinky.divaDotJs.interfacesMod.ViewerState
...
class Diva protected () extends js.Object {
  ...
  /**
    ...
    */
  def this(element: String, options: Partial[Options] with Anon_ObjectData) = this()
   // | Toolbar
  ...
  /**
    ...
    */
  def getCurrentPageDimensionsAtCurrentZoomLevel(): Anon_Height = js.native
  /**
  ...
  /**
    ...
    */
  def getCurrentPageOffset(): Anon_Left = js.native
  /**
  ...
  /**
    ...
    */
  def getPageOffset(pageIndex: Double): Anon_Left = js.native
  def getPageOffset(pageIndex: Double, options: Anon_IncludePadding): Anon_Left = js.native
  /**
