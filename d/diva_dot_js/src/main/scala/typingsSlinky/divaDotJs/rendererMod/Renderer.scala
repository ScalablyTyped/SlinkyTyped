package typingsSlinky.divaDotJs.rendererMod

import typingsSlinky.divaDotJs.interfacesMod.SourceProvider
import typingsSlinky.divaDotJs.interfacesMod.ViewportPosition
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Renderer extends js.Object {
  var layout: typingsSlinky.divaDotJs.documentDashLayoutMod.default | Null
  def adjust(): Unit
  def destroy(): Unit
...
object Renderer {
  ...
  def apply(
    ...
    layout: typingsSlinky.divaDotJs.documentDashLayoutMod.default = null
  ): Renderer = {
