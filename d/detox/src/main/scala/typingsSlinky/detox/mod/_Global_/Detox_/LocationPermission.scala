...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.detox.detoxStrings.always
  - typingsSlinky.detox.detoxStrings.inuse
  - typingsSlinky.detox.detoxStrings.never
  - typingsSlinky.detox.detoxStrings.unset
*/
