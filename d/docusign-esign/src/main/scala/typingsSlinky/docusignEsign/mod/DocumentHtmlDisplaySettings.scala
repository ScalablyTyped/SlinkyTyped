...
@js.native
trait DocumentHtmlDisplaySettings extends js.Object {
...
object DocumentHtmlDisplaySettings {
  ...
  @scala.inline
  implicit class DocumentHtmlDisplaySettingsOps[Self <: DocumentHtmlDisplaySettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCollapsibleSettings(value: DocumentHtmlCollapsibleDisplaySettings): Self = this.set("collapsibleSettings", value.asInstanceOf[js.Any])
