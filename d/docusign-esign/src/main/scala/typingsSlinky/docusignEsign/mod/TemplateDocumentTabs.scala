...
@js.native
trait TemplateDocumentTabs extends StObject {
...
object TemplateDocumentTabs {
  
  @scala.inline
  def apply(): TemplateDocumentTabs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TemplateDocumentTabs]
  }
  
  @scala.inline
  implicit class TemplateDocumentTabsMutableBuilder[Self <: TemplateDocumentTabs] (val x: Self) extends AnyVal {
