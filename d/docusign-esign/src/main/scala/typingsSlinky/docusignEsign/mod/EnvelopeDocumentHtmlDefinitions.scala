...
@js.native
trait EnvelopeDocumentHtmlDefinitions extends js.Object {
...
object EnvelopeDocumentHtmlDefinitions {
  ...
  @scala.inline
  implicit class EnvelopeDocumentHtmlDefinitionsOps[Self <: EnvelopeDocumentHtmlDefinitions] (val x: Self) extends AnyVal {
