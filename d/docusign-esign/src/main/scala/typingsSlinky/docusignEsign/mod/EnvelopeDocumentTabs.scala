...
@js.native
trait EnvelopeDocumentTabs extends js.Object {
...
object EnvelopeDocumentTabs {
  ...
  @scala.inline
  def apply(): EnvelopeDocumentTabs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EnvelopeDocumentTabs]
  }
  
  @scala.inline
  implicit class EnvelopeDocumentTabsOps[Self <: EnvelopeDocumentTabs] (val x: Self) extends AnyVal {
