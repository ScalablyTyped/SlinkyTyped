...
@js.native
trait SignerAttachment extends StObject {
...
object SignerAttachment {
  
  @scala.inline
  def apply(): SignerAttachment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SignerAttachment]
  }
  
  @scala.inline
  implicit class SignerAttachmentMutableBuilder[Self <: SignerAttachment] (val x: Self) extends AnyVal {
