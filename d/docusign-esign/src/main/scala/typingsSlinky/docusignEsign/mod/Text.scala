...
object Text {
  ...
  implicit class TextMutableBuilder[Self <: Text] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormulaMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "formulaMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFormulaMetadataUndefined: Self = StObject.set(x, "formulaMetadata", js.undefined)
    ...
    @scala.inline
    def setIsPaymentAmount(value: String): Self = StObject.set(x, "isPaymentAmount", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsPaymentAmountMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "isPaymentAmountMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsPaymentAmountMetadataUndefined: Self = StObject.set(x, "isPaymentAmountMetadata", js.undefined)
    
    @scala.inline
    def setIsPaymentAmountUndefined: Self = StObject.set(x, "isPaymentAmount", js.undefined)
