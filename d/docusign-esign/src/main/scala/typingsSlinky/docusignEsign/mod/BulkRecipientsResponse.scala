...
@js.native
trait BulkRecipientsResponse extends js.Object {
...
object BulkRecipientsResponse {
  ...
  @scala.inline
  def apply(): BulkRecipientsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BulkRecipientsResponse]
  }
  
  @scala.inline
  implicit class BulkRecipientsResponseOps[Self <: BulkRecipientsResponse] (val x: Self) extends AnyVal {
