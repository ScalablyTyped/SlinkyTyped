...
@js.native
trait TabAccountSettings extends js.Object {
...
object TabAccountSettings {
  ...
  @scala.inline
  def apply(): TabAccountSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TabAccountSettings]
  }
  
  @scala.inline
  implicit class TabAccountSettingsOps[Self <: TabAccountSettings] (val x: Self) extends AnyVal {
