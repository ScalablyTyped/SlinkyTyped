...
object EnvelopeTemplateResults {
  ...
  @scala.inline
  implicit class EnvelopeTemplateResultsMutableBuilder[Self <: EnvelopeTemplateResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnvelopeTemplates(value: js.Array[EnvelopeTemplate]): Self = StObject.set(x, "envelopeTemplates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnvelopeTemplatesUndefined: Self = StObject.set(x, "envelopeTemplates", js.undefined)
    
    @scala.inline
    def setEnvelopeTemplatesVarargs(value: EnvelopeTemplate*): Self = StObject.set(x, "envelopeTemplates", js.Array(value :_*))
