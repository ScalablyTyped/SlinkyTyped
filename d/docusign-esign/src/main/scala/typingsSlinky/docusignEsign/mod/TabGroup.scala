...
@js.native
trait TabGroup extends js.Object {
...
object TabGroup {
  ...
  @scala.inline
  implicit class TabGroupOps[Self <: TabGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupLabelMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("groupLabelMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGroupLabelMetadata: Self = this.set("groupLabelMetadata", js.undefined)
    
    @scala.inline
    def setGroupRule(value: String): Self = this.set("groupRule", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGroupRule: Self = this.set("groupRule", js.undefined)
    
    @scala.inline
    def setGroupRuleMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("groupRuleMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGroupRuleMetadata: Self = this.set("groupRuleMetadata", js.undefined)
    ...
    @scala.inline
    def setMaximumAllowed(value: String): Self = this.set("maximumAllowed", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaximumAllowed: Self = this.set("maximumAllowed", js.undefined)
    
    @scala.inline
    def setMaximumAllowedMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("maximumAllowedMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaximumAllowedMetadata: Self = this.set("maximumAllowedMetadata", js.undefined)
    ...
    @scala.inline
    def setMinimumRequired(value: String): Self = this.set("minimumRequired", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinimumRequired: Self = this.set("minimumRequired", js.undefined)
    
    @scala.inline
    def setMinimumRequiredMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("minimumRequiredMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinimumRequiredMetadata: Self = this.set("minimumRequiredMetadata", js.undefined)
    ...
    @scala.inline
    def setTabScope(value: String): Self = this.set("tabScope", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTabScope: Self = this.set("tabScope", js.undefined)
    
    @scala.inline
    def setTabScopeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("tabScopeMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTabScopeMetadata: Self = this.set("tabScopeMetadata", js.undefined)
