...
trait Draw extends StObject {
  ...
  var allowSignerUpload: js.UndefOr[String] = js.native
  ...
  var useBackgroundAsCanvas: js.UndefOr[String] = js.native
...
object Draw {
  ...
  implicit class DrawMutableBuilder[Self <: Draw] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowSignerUpload(value: String): Self = StObject.set(x, "allowSignerUpload", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAllowSignerUploadUndefined: Self = StObject.set(x, "allowSignerUpload", js.undefined)
    ...
    @scala.inline
    def setUseBackgroundAsCanvas(value: String): Self = StObject.set(x, "useBackgroundAsCanvas", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUseBackgroundAsCanvasUndefined: Self = StObject.set(x, "useBackgroundAsCanvas", js.undefined)
