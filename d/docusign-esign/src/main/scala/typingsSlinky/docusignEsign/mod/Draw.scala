...
object Draw {
  ...
  implicit class DrawOps[Self <: Draw] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowSignerUpload(value: String): Self = this.set("allowSignerUpload", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAllowSignerUpload: Self = this.set("allowSignerUpload", js.undefined)
    ...
    @scala.inline
    def setUseBackgroundAsCanvas(value: String): Self = this.set("useBackgroundAsCanvas", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUseBackgroundAsCanvas: Self = this.set("useBackgroundAsCanvas", js.undefined)
