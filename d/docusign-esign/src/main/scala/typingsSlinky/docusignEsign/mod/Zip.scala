...
object Zip {
  ...
  @scala.inline
  implicit class ZipOps[Self <: Zip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUseDash4(value: String): Self = this.set("useDash4", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUseDash4: Self = this.set("useDash4", js.undefined)
    
    @scala.inline
    def setUseDash4Metadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("useDash4Metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUseDash4Metadata: Self = this.set("useDash4Metadata", js.undefined)
