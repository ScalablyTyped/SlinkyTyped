...
object Zip {
  ...
  @scala.inline
  implicit class ZipMutableBuilder[Self <: Zip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUseDash4(value: String): Self = StObject.set(x, "useDash4", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUseDash4Metadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "useDash4Metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUseDash4MetadataUndefined: Self = StObject.set(x, "useDash4Metadata", js.undefined)
    
    @scala.inline
    def setUseDash4Undefined: Self = StObject.set(x, "useDash4", js.undefined)
