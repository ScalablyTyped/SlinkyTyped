...
object NotaryHost {
  ...
  @scala.inline
  implicit class NotaryHostMutableBuilder[Self <: NotaryHost] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHostRecipientId(value: String): Self = StObject.set(x, "hostRecipientId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHostRecipientIdUndefined: Self = StObject.set(x, "hostRecipientId", js.undefined)
