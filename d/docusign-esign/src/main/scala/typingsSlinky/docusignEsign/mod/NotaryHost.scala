...
@js.native
trait NotaryHost extends js.Object {
...
object NotaryHost {
  ...
  @scala.inline
  def apply(): NotaryHost = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NotaryHost]
  }
  
  @scala.inline
  implicit class NotaryHostOps[Self <: NotaryHost] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHostRecipientId(value: String): Self = this.set("hostRecipientId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHostRecipientId: Self = this.set("hostRecipientId", js.undefined)
