...
@js.native
trait EnvelopeCustomFields extends js.Object {
...
object EnvelopeCustomFields {
  ...
  @scala.inline
  def apply(): EnvelopeCustomFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EnvelopeCustomFields]
  }
  
  @scala.inline
  implicit class EnvelopeCustomFieldsOps[Self <: EnvelopeCustomFields] (val x: Self) extends AnyVal {
