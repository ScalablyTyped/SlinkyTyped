...
object Signer {
  ...
  implicit class SignerOps[Self <: Signer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsBulkRecipient(value: String): Self = this.set("isBulkRecipient", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsBulkRecipient: Self = this.set("isBulkRecipient", js.undefined)
    
    @scala.inline
    def setIsBulkRecipientMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("isBulkRecipientMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsBulkRecipientMetadata: Self = this.set("isBulkRecipientMetadata", js.undefined)
