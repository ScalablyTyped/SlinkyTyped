...
object BccEmailArchiveHistoryList {
  ...
  @scala.inline
  def apply(): BccEmailArchiveHistoryList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BccEmailArchiveHistoryList]
  }
  
  @scala.inline
  implicit class BccEmailArchiveHistoryListMutableBuilder[Self <: BccEmailArchiveHistoryList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBccEmailArchiveHistoryUndefined: Self = StObject.set(x, "bccEmailArchiveHistory", js.undefined)
