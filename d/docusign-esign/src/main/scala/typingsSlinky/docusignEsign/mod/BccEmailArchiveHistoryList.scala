...
@js.native
trait BccEmailArchiveHistoryList extends js.Object {
...
object BccEmailArchiveHistoryList {
  ...
  @scala.inline
  implicit class BccEmailArchiveHistoryListOps[Self <: BccEmailArchiveHistoryList] (val x: Self) extends AnyVal {
