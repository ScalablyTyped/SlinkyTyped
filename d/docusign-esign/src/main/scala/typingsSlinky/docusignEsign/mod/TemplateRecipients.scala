...
@js.native
trait TemplateRecipients extends js.Object {
  ...
  var intermediaries: js.UndefOr[
    js.Array[
      /* Contains information about an intermediary recipient. An intermediary is a recipient who can, but is not required to,
  ...
  var witnesses: js.UndefOr[
    js.Array[
      /* A complex type containing information about a witness recipient. Witnesses are recipients whose signatures affirm that the identified signers
    have signed the documents in the envelope. */ Witness
    ]
  ] = js.native
}
object TemplateRecipients {
  
  @scala.inline
  def apply(): TemplateRecipients = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TemplateRecipients]
  }
  
  @scala.inline
  implicit class TemplateRecipientsOps[Self <: TemplateRecipients] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertifiedDeliveriesVarargs(value: CertifiedDelivery*): Self = this.set("certifiedDeliveries", js.Array(value :_*))
    
    @scala.inline
    def setCertifiedDeliveries(value: js.Array[CertifiedDelivery]): Self = this.set("certifiedDeliveries", value.asInstanceOf[js.Any])
    ...
    def setIntermediariesVarargs(
      value: (/* Contains information about an intermediary recipient. An intermediary is a recipient who can, but is not required to,
      add name and email information for recipients at the same or subsequent level in the routing order, unless subsequent agents, editors or intermediaries are added. */ Intermediary)*
    ...
    def setWitnessesVarargs(
      value: (/* A complex type containing information about a witness recipient. Witnesses are recipients whose signatures affirm that the identified signers
      have signed the documents in the envelope. */ Witness)*
