...
object Recipients {
  ...
  implicit class RecipientsOps[Self <: Recipients] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIntermediariesVarargs(value: Intermediary*): Self = this.set("intermediaries", js.Array(value :_*))
    
    @scala.inline
    def setIntermediaries(value: js.Array[Intermediary]): Self = this.set("intermediaries", value.asInstanceOf[js.Any])
