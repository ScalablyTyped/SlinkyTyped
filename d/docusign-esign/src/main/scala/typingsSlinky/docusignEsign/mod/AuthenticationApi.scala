...
class AuthenticationApi protected () extends StObject {
  ...
  def login(optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[LoginInformation] = js.native
  ...
  def updatePassword(loginPart: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[Unit] = js.native
