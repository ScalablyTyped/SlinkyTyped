...
@js.native
trait AccountPasswordLockoutDurationType extends js.Object {
...
object AccountPasswordLockoutDurationType {
  ...
  @scala.inline
  implicit class AccountPasswordLockoutDurationTypeOps[Self <: AccountPasswordLockoutDurationType] (val x: Self) extends AnyVal {
