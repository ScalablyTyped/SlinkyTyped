...
@js.native
trait NotaryJournalList extends js.Object {
...
object NotaryJournalList {
  ...
  @scala.inline
  implicit class NotaryJournalListOps[Self <: NotaryJournalList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotaryJournalsVarargs(value: NotaryJournal*): Self = this.set("notaryJournals", js.Array(value :_*))
    
    @scala.inline
    def setNotaryJournals(value: js.Array[NotaryJournal]): Self = this.set("notaryJournals", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotaryJournals: Self = this.set("notaryJournals", js.undefined)
