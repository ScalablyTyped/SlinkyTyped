...
@js.native
trait NotaryJournalList extends StObject {
  ...
  var notaryJournals: js.UndefOr[js.Array[NotaryJournal]] = js.native
...
object NotaryJournalList {
  
  @scala.inline
  def apply(): NotaryJournalList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NotaryJournalList]
  }
  
  @scala.inline
  implicit class NotaryJournalListMutableBuilder[Self <: NotaryJournalList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotaryJournals(value: js.Array[NotaryJournal]): Self = StObject.set(x, "notaryJournals", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNotaryJournalsUndefined: Self = StObject.set(x, "notaryJournals", js.undefined)
    
    @scala.inline
    def setNotaryJournalsVarargs(value: NotaryJournal*): Self = StObject.set(x, "notaryJournals", js.Array(value :_*))
