...
@js.native
trait TemplateDocumentHtmlDefinitions extends js.Object {
...
object TemplateDocumentHtmlDefinitions {
  ...
  @scala.inline
  implicit class TemplateDocumentHtmlDefinitionsOps[Self <: TemplateDocumentHtmlDefinitions] (val x: Self) extends AnyVal {
