...
@js.native
class SigningGroupsApi protected () extends js.Object {
  def this(apiClient: ApiClient) = this()
  
  def createList(accountId: String): js.Promise[SigningGroupInformation] = js.native
  def createList(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  ...
  def deleteList(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  ...
  ): js.Promise[SigningGroupUsers] = js.native
  ...
  def list(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  ...
  def update(
    ...
    optsOrCallback: js.UndefOr[scala.Nothing],
    callback: js.Function0[Unit]
  ): js.Promise[SigningGroup] = js.native
  ...
  def updateList(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
