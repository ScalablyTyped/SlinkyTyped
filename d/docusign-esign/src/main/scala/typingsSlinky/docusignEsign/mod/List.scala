...
object List {
  ...
  implicit class ListOps[Self <: List] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListSelectedValue(value: String): Self = this.set("listSelectedValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteListSelectedValue: Self = this.set("listSelectedValue", js.undefined)
    
    @scala.inline
    def setListSelectedValueMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("listSelectedValueMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteListSelectedValueMetadata: Self = this.set("listSelectedValueMetadata", js.undefined)
