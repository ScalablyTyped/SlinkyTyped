...
trait List extends StObject {
  ...
  /**
    ...
    */
  var listSelectedValueMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.native
...
object List {
  ...
  implicit class ListMutableBuilder[Self <: List] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setListItems(value: js.Array[ListItem]): Self = StObject.set(x, "listItems", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListItemsUndefined: Self = StObject.set(x, "listItems", js.undefined)
    
    @scala.inline
    def setListItemsVarargs(value: ListItem*): Self = StObject.set(x, "listItems", js.Array(value :_*))
    
    @scala.inline
    def setListSelectedValue(value: String): Self = StObject.set(x, "listSelectedValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListSelectedValueMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "listSelectedValueMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListSelectedValueMetadataUndefined: Self = StObject.set(x, "listSelectedValueMetadata", js.undefined)
