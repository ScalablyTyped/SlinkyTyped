...
object ApplyPatchesOptions {
  ...
  implicit class ApplyPatchesOptionsOps[Self <: ApplyPatchesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoadFile(value: (ParsedDiff, js.Function2[/* err */ js.Any, /* data */ String, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadFile")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withPatched(value: (ParsedDiff, String, js.Function1[/* err */ js.Any, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("patched")(js.Any.fromFunction3(value))
        ret
    }
  }
