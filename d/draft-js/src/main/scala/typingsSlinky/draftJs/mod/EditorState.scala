...
class EditorState ()
  ...
  /* CompleteClass */
  override def getCurrentContent(): typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.ContentState = js.native
  /**
  ...
  /* CompleteClass */
  override def getNativelyRenderedContent(): typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.ContentState = js.native
  /* CompleteClass */
  override def getRedoStack(): Stack[typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.ContentState] = js.native
  /* CompleteClass */
  override def getSelection(): typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.SelectionState = js.native
  /* CompleteClass */
  override def getUndoStack(): Stack[typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.ContentState] = js.native
  /* CompleteClass */
