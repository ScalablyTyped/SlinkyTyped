...
@js.native
class ContentBlock ()
  extends typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.ContentBlock {
  /**
  ...
  override def findEntityRanges(
    filterFn: js.Function1[
      /* value */ typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.CharacterMetadata, 
      Boolean
    ],
  ...
  /* CompleteClass */
  override def getCharacterList(): List[typingsSlinky.draftJs.mod.Draft.Model.ImmutableData.CharacterMetadata] = js.native
  /* CompleteClass */
