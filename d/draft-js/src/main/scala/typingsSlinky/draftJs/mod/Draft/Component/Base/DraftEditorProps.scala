...
trait DraftEditorProps extends js.Object {
  ...
  var onBlur: js.UndefOr[js.Function1[SyntheticEvent[EventTarget with js.Object, Event], Unit]] = js.undefined
  ...
  var onFocus: js.UndefOr[js.Function1[SyntheticEvent[EventTarget with js.Object, Event], Unit]] = js.undefined
...
object DraftEditorProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(ariaExpanded)) __obj.updateDynamic("ariaExpanded")(ariaExpanded.get.asInstanceOf[js.Any])
    if (ariaLabel != null) __obj.updateDynamic("ariaLabel")(ariaLabel.asInstanceOf[js.Any])
    if (ariaLabelledBy != null) __obj.updateDynamic("ariaLabelledBy")(ariaLabelledBy.asInstanceOf[js.Any])
    if (!js.isUndefined(ariaMultiline)) __obj.updateDynamic("ariaMultiline")(ariaMultiline.get.asInstanceOf[js.Any])
