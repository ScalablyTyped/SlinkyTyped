...
object DraftEditorProps {
  ...
  implicit class DraftEditorPropsOps[Self <: DraftEditorProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandleReturn(value: (SyntheticKeyboardEvent[js.Object], /* editorState */ EditorState) => DraftHandleValue): Self = this.set("handleReturn", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteHandleReturn: Self = this.set("handleReturn", js.undefined)
    
    @scala.inline
    def setKeyBindingFn(value: SyntheticKeyboardEvent[js.Object] => EditorCommand | Null): Self = this.set("keyBindingFn", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteKeyBindingFn: Self = this.set("keyBindingFn", js.undefined)
    
    @scala.inline
    def setOnBlur(value: SyntheticEvent[EventTarget with js.Object, Event] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnBlur: Self = this.set("onBlur", js.undefined)
    
    @scala.inline
    def setOnDownArrow(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onDownArrow", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnDownArrow: Self = this.set("onDownArrow", js.undefined)
    
    @scala.inline
    def setOnEscape(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onEscape", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnEscape: Self = this.set("onEscape", js.undefined)
    
    @scala.inline
    def setOnFocus(value: SyntheticEvent[EventTarget with js.Object, Event] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnFocus: Self = this.set("onFocus", js.undefined)
    
    @scala.inline
    def setOnLeftArrow(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onLeftArrow", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnLeftArrow: Self = this.set("onLeftArrow", js.undefined)
    
    @scala.inline
    def setOnRightArrow(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onRightArrow", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnRightArrow: Self = this.set("onRightArrow", js.undefined)
    
    @scala.inline
    def setOnTab(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onTab", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnTab: Self = this.set("onTab", js.undefined)
    
    @scala.inline
    def setOnUpArrow(value: SyntheticKeyboardEvent[js.Object] => Unit): Self = this.set("onUpArrow", js.Any.fromFunction1(value))
