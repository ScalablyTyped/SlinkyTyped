...
object ImmutableData {
  ...
  object DraftBlockRenderConfig {
    ...
    implicit class DraftBlockRenderConfigMutableBuilder[Self <: DraftBlockRenderConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWrapper(value: ReactElement): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setWrapperReactElement(value: ReactElement): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.draftJs.draftJsStrings.`adjust-depth`
    - typingsSlinky.draftJs.draftJsStrings.`apply-entity`
    - typingsSlinky.draftJs.draftJsStrings.`backspace-character`
    - typingsSlinky.draftJs.draftJsStrings.`change-block-data`
    - typingsSlinky.draftJs.draftJsStrings.`change-block-type`
    - typingsSlinky.draftJs.draftJsStrings.`change-inline-style`
    - typingsSlinky.draftJs.draftJsStrings.`delete-character`
    - typingsSlinky.draftJs.draftJsStrings.`insert-characters`
    - typingsSlinky.draftJs.draftJsStrings.`insert-fragment`
    - typingsSlinky.draftJs.draftJsStrings.redo
    - typingsSlinky.draftJs.draftJsStrings.`remove-range`
    - typingsSlinky.draftJs.draftJsStrings.`spellcheck-change`
