...
class SelectionState ()
  extends typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.SelectionState {
  /* CompleteClass */
...
object SelectionState extends js.Object {
  def createEmpty(key: String): typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.SelectionState = js.native
}
