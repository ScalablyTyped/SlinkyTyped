...
object DraftHandleValue {
  ...
  @scala.inline
  def handled: typingsSlinky.draftDashJs.draftDashJsStrings.handled = this.cast("handled")
  @scala.inline
  def `not-handled`: typingsSlinky.draftDashJs.draftDashJsStrings.`not-handled` = this.cast("not-handled")
}
