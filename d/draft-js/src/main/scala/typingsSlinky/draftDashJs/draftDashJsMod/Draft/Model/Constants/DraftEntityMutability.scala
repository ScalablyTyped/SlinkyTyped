...
object DraftEntityMutability {
  @scala.inline
  def IMMUTABLE: typingsSlinky.draftDashJs.draftDashJsStrings.IMMUTABLE = this.cast("IMMUTABLE")
  @scala.inline
  def MUTABLE: typingsSlinky.draftDashJs.draftDashJsStrings.MUTABLE = this.cast("MUTABLE")
  @scala.inline
  def SEGMENTED: typingsSlinky.draftDashJs.draftDashJsStrings.SEGMENTED = this.cast("SEGMENTED")
  @scala.inline
