...
- Dropped {[ P in keyof any ]: / * import warning: DefaultedTypeArguments.enterTsTypeRef $anonfun#applyOrElse newTParams $anonfun next no default parameter for T * / any} */ trait EditorState extends js.Object {
  ...
  def getCurrentContent(): typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState
  /**
  ...
  def getNativelyRenderedContent(): typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState
  def getRedoStack(): Stack[typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState]
  def getSelection(): typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.SelectionState
  def getUndoStack(): Stack[typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState]
...
object EditorState {
  ...
  def apply(
    ...
    getCurrentContent: () => typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState,
    ...
    getNativelyRenderedContent: () => typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState,
    getRedoStack: () => Stack[typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState],
    getSelection: () => typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.SelectionState,
    getUndoStack: () => Stack[typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.ImmutableData.ContentState],
