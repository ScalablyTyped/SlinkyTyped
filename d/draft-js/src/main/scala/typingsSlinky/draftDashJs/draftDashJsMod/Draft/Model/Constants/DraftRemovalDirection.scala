...
object DraftRemovalDirection {
  @scala.inline
  def backward: typingsSlinky.draftDashJs.draftDashJsStrings.backward = this.cast("backward")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def forward: typingsSlinky.draftDashJs.draftDashJsStrings.forward = this.cast("forward")
}
