package typingsSlinky.draftDashJs.draftDashJsMod.Draft.Model.Constants
...
object DraftInsertionType {
  @scala.inline
  def after: typingsSlinky.draftDashJs.draftDashJsStrings.after = this.cast("after")
  @scala.inline
  def before: typingsSlinky.draftDashJs.draftDashJsStrings.before = this.cast("before")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def replace: typingsSlinky.draftDashJs.draftDashJsStrings.replace = this.cast("replace")
}
