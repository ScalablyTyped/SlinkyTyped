...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float64
...
/* Inlined distributions-poisson-quantile.distributions-poisson-quantile.Options & {  dtype ? :'float64'} */
@js.native
trait Optionsdtypefloat64 extends js.Object {
  ...
  var dtype: js.UndefOr[DataType with float64] = js.native
...
object Optionsdtypefloat64 {
  @scala.inline
  def apply(): Optionsdtypefloat64 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Optionsdtypefloat64]
  }
  @scala.inline
  implicit class Optionsdtypefloat64Ops[Self <: Optionsdtypefloat64] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDtype(value: DataType with float64): Self = {
        val ret = this.duplicate
