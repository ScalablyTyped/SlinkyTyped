...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint32
...
object Optionsdtypeuint32 {
  ...
  implicit class Optionsdtypeuint32Ops[Self <: Optionsdtypeuint32] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDtype(value: DataType with uint32): Self = {
        val ret = this.duplicate
