...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int8
...
trait Optionsdtypeint8 extends js.Object {
  ...
  var dtype: js.UndefOr[DataType with int8] = js.undefined
