...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int16
...
object Optionsdtypeint16 {
  ...
  @scala.inline
  implicit class Optionsdtypeint16Ops[Self <: Optionsdtypeint16] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDtype(value: js.UndefOr[DataType] with int16): Self = this.set("dtype", value.asInstanceOf[js.Any])
