...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int32
...
@js.native
trait Optionsdtypeint32 extends js.Object {
...
object Optionsdtypeint32 {
  ...
  @scala.inline
  implicit class Optionsdtypeint32Ops[Self <: Optionsdtypeint32] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDtype(value: js.UndefOr[DataType] with int32): Self = this.set("dtype", value.asInstanceOf[js.Any])
