...
@js.native
trait Optionsdtypeundefined extends js.Object {
...
object Optionsdtypeundefined {
  ...
  @scala.inline
  implicit class OptionsdtypeundefinedOps[Self <: Optionsdtypeundefined] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDtype(value: js.UndefOr[DataType] with js.UndefOr[scala.Nothing]): Self = this.set("dtype", value.asInstanceOf[js.Any])
