...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float32
...
object Optionsdtypefloat32 {
  ...
  implicit class Optionsdtypefloat32Ops[Self <: Optionsdtypefloat32] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDtype(value: DataType with float32): Self = {
        val ret = this.duplicate
