...
import typingsSlinky.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8_clamped
...
object Optionsdtypeuint8clamped {
  @scala.inline
  def apply(): Optionsdtypeuint8clamped = {
  ...
  implicit class Optionsdtypeuint8clampedOps[Self <: Optionsdtypeuint8clamped] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDtype(value: DataType with uint8_clamped): Self = {
        val ret = this.duplicate
