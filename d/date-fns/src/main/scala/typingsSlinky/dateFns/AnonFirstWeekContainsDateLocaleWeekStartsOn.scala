...
object AnonFirstWeekContainsDateLocaleWeekStartsOn {
  @scala.inline
  def apply(): AnonFirstWeekContainsDateLocaleWeekStartsOn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFirstWeekContainsDateLocaleWeekStartsOn]
  }
  @scala.inline
  implicit class AnonFirstWeekContainsDateLocaleWeekStartsOnOps[Self <: AnonFirstWeekContainsDateLocaleWeekStartsOn] (val x: Self) extends AnyVal {
    @scala.inline
