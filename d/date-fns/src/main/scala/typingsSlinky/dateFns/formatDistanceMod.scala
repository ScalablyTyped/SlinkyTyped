...
object formatDistanceMod {
  
  object default {
    
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    ...
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    def apply(date: js.Date, baseDate: Double, options: AddSuffix): String = js.native
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    def apply(date: js.Date, baseDate: Double, options: IncludeSeconds): String = js.native
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    def apply(date: Double, baseDate: js.Date): String = js.native
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    def apply(date: Double, baseDate: js.Date, options: AddSuffix): String = js.native
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
    def apply(date: Double, baseDate: js.Date, options: IncludeSeconds): String = js.native
    @JSImport("date-fns/esm/formatDistance", JSImport.Default)
    @js.native
