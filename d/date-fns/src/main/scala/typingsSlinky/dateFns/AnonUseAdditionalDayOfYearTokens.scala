...
object AnonUseAdditionalDayOfYearTokens {
  @scala.inline
  def apply(): AnonUseAdditionalDayOfYearTokens = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonUseAdditionalDayOfYearTokens]
  }
  @scala.inline
  implicit class AnonUseAdditionalDayOfYearTokensOps[Self <: AnonUseAdditionalDayOfYearTokens] (val x: Self) extends AnyVal {
    @scala.inline
