...
object AnonUseAdditionalDayOfYearTokensUseAdditionalWeekYearTokens {
  @scala.inline
  def apply(): AnonUseAdditionalDayOfYearTokensUseAdditionalWeekYearTokens = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonUseAdditionalDayOfYearTokensUseAdditionalWeekYearTokens]
  }
  @scala.inline
  implicit class AnonUseAdditionalDayOfYearTokensUseAdditionalWeekYearTokensOps[Self <: AnonUseAdditionalDayOfYearTokensUseAdditionalWeekYearTokens] (val x: Self) extends AnyVal {
    @scala.inline
