...
@js.native
trait AnonUseAdditionalWeekYearTokensWeekStartsOn extends js.Object {
...
object AnonUseAdditionalWeekYearTokensWeekStartsOn {
  @scala.inline
  def apply(): AnonUseAdditionalWeekYearTokensWeekStartsOn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonUseAdditionalWeekYearTokensWeekStartsOn]
  }
  @scala.inline
  implicit class AnonUseAdditionalWeekYearTokensWeekStartsOnOps[Self <: AnonUseAdditionalWeekYearTokensWeekStartsOn] (val x: Self) extends AnyVal {
    @scala.inline
