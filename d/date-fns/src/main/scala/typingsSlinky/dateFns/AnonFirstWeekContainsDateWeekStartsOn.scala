...
object AnonFirstWeekContainsDateWeekStartsOn {
  @scala.inline
  def apply(): AnonFirstWeekContainsDateWeekStartsOn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFirstWeekContainsDateWeekStartsOn]
  }
  @scala.inline
  implicit class AnonFirstWeekContainsDateWeekStartsOnOps[Self <: AnonFirstWeekContainsDateWeekStartsOn] (val x: Self) extends AnyVal {
    @scala.inline
