...
object AnonFirstWeekContainsDateLocale {
  @scala.inline
  def apply(): AnonFirstWeekContainsDateLocale = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonFirstWeekContainsDateLocale]
  }
  @scala.inline
  implicit class AnonFirstWeekContainsDateLocaleOps[Self <: AnonFirstWeekContainsDateLocale] (val x: Self) extends AnyVal {
    @scala.inline
