...
@js.native
trait LocaleLocale extends js.Object {
...
object LocaleLocale {
  @scala.inline
  def apply(): LocaleLocale = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LocaleLocale]
  }
  @scala.inline
  implicit class LocaleLocaleOps[Self <: LocaleLocale] (val x: Self) extends AnyVal {
    @scala.inline
