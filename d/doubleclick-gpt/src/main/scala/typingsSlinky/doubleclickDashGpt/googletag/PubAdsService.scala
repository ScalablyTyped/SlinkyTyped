...
import typingsSlinky.doubleclickDashGpt.Anon_ChangeCorrelator
import typingsSlinky.doubleclickDashGpt.Anon_RestrictDataProcessing
import typingsSlinky.doubleclickDashGpt.doubleclickDashGptNumbers.`0`
import typingsSlinky.doubleclickDashGpt.doubleclickDashGptNumbers.`1`
...
trait PubAdsService extends Service {
  ...
  def refresh(opt_slots: js.Array[Slot], opt_options: Anon_ChangeCorrelator): Unit = js.native
