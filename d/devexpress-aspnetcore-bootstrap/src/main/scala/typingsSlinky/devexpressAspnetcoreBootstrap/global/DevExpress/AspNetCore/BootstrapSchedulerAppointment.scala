...
class BootstrapSchedulerAppointment protected ()
  extends typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointment {
  protected def this(instance: js.Any) = this()
  /* CompleteClass */
  override val appointmentId: String = js.native
  /* CompleteClass */
  override val appointmentType: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointmentType = js.native
  /* CompleteClass */
  override val instance: js.Any = js.native
  /* CompleteClass */
  override val interval: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTimeInterval | Null = js.native
  /* CompleteClass */
  override val labelIndex: Double = js.native
  /* CompleteClass */
  override val resources: js.Array[String] = js.native
  /* CompleteClass */
  override val statusIndex: Double = js.native
  /* CompleteClass */
  override def addResource(resourceId: js.Object): Unit = js.native
  /* CompleteClass */
  override def getAllDay(): Boolean = js.native
  /* CompleteClass */
  override def getAppointmentType(): typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointmentType = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def getRecurrenceInfo(): typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerRecurrenceInfo | Null = js.native
  /* CompleteClass */
  override def getRecurrencePattern(): typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointment | Null = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def setAppointmentType(
    `type`: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointmentType
  ): Unit = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def setRecurrenceInfo(
    recurrenceInfo: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerRecurrenceInfo
  ): Unit = js.native
  /* CompleteClass */
