...
class BootstrapPopupWindow protected ()
  extends typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapPopupWindow {
  ...
  /* CompleteClass */
  override val popupControl: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapPopupControl | Null = js.native
  /* CompleteClass */
