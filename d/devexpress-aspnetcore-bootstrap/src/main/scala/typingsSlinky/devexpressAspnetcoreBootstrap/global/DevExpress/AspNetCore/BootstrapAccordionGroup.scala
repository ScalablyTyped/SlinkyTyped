...
class BootstrapAccordionGroup protected ()
  extends typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapAccordionGroup {
  ...
  /* CompleteClass */
  override val navBar: typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapAccordion | Null = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def getItem(index: Double): typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapAccordionItem | Null = js.native
  /* CompleteClass */
  override def getItemByName(name: String): typingsSlinky.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapAccordionItem | Null = js.native
  /* CompleteClass */
