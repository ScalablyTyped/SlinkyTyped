...
import typingsSlinky.digibyte.digibyteMod.Transaction.Input
import typingsSlinky.digibyte.digibyteMod.Transaction.Output
import typingsSlinky.digibyte.digibyteMod.Transaction.UnspentOutput
