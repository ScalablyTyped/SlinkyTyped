package typingsSlinky.dropzone
...
object mod {
  ...
  @scala.inline
  def blacklistedBrowsers_=(x: js.Array[js.RegExp]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("blacklistedBrowsers")(x.asInstanceOf[js.Any])
