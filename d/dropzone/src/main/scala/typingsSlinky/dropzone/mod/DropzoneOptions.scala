...
object DropzoneOptions {
  @scala.inline
  def apply(
    accept: (/* file */ DropzoneFile, /* done */ js.Function1[/* error */ js.UndefOr[String | js.Error], Unit]) => Unit = null,
    ...
    chunksUploaded: (/* file */ DropzoneFile, /* done */ js.Function1[/* error */ js.UndefOr[String | js.Error], Unit]) => Unit = null,
    ...
    error: (/* file */ DropzoneFile, /* message */ String | js.Error, /* xhr */ XMLHttpRequest) => Unit = null,
    errormultiple: (/* files */ js.Array[DropzoneFile], /* message */ String | js.Error, /* xhr */ XMLHttpRequest) => Unit = null,
    fallback: () => Unit = null,
