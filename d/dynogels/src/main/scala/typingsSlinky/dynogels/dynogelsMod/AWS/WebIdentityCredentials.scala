...
import typingsSlinky.awsDashSdk.libCredentialsWebUnderscoreIdentityUnderscoreCredentialsMod.WebIdentityCredentials.WebIdentityCredentialsOptions
...
class WebIdentityCredentials ()
  extends typingsSlinky.awsDashSdk.awsDashSdkMod.WebIdentityCredentials {
  /**
