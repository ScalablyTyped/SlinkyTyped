...
import typingsSlinky.awsDashSdk.libCredentialsEc2UnderscoreMetadataUnderscoreCredentialsMod.EC2MetadataCredentialsOptions
...
class EC2MetadataCredentials ()
  extends typingsSlinky.awsDashSdk.awsDashSdkMod.EC2MetadataCredentials {
