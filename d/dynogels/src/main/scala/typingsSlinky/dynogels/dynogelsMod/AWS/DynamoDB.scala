...
/**
  ...
  */
class DynamoDB ()
  extends typingsSlinky.awsDashSdk.awsDashSdkMod.DynamoDB {
...
object DynamoDB extends js.Object {
  @js.native
  class Converter ()
    extends typingsSlinky.awsDashSdk.awsDashSdkMod.DynamoDB.Converter
  ...
  class DocumentClient ()
    extends typingsSlinky.awsDashSdk.awsDashSdkMod.DynamoDB.DocumentClient {
