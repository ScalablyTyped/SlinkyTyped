...
trait Dockerfile extends ImageTemplate {
  ...
  /**
    ...
    */
  def getDirective(): typingsSlinky.dockerfileAst.parserDirectiveMod.ParserDirective | Null
  /**
    ...
    * @since 0.0.18
    */
  def getDirectives(): js.Array[typingsSlinky.dockerfileAst.parserDirectiveMod.ParserDirective]
  def getEscapeCharacter(): String
  def getInitialARGs(): js.Array[typingsSlinky.dockerfileAst.argMod.Arg]
  /**
...
object Dockerfile {
  ...
  def apply(
    ...
    getDirective: () => typingsSlinky.dockerfileAst.parserDirectiveMod.ParserDirective | Null,
    getDirectives: () => js.Array[typingsSlinky.dockerfileAst.parserDirectiveMod.ParserDirective],
    ...
    getInitialARGs: () => js.Array[typingsSlinky.dockerfileAst.argMod.Arg],
