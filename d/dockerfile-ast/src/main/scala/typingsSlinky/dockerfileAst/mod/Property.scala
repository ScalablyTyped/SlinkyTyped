...
class Property protected ()
  extends typingsSlinky.dockerfileAst.propertyMod.Property {
  def this(document: TextDocument, escapeChar: String, arg: typingsSlinky.dockerfileAst.argumentMod.Argument) = this()
  def this(
    document: TextDocument,
    escapeChar: String,
    arg: typingsSlinky.dockerfileAst.argumentMod.Argument,
    arg2: typingsSlinky.dockerfileAst.argumentMod.Argument
  ) = this()
}
