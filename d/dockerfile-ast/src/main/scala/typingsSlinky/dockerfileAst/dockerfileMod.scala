...
import typingsSlinky.dockerfileAst.imageTemplateMod.ImageTemplate
import typingsSlinky.dockerfileAst.instructionMod.Instruction
import typingsSlinky.dockerfileAst.parserDirectiveMod.ParserDirective
...
object dockerfileMod extends js.Object {
  ...
  class Dockerfile protected ()
    extends ImageTemplate
       with typingsSlinky.dockerfileAst.mod.Dockerfile {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getContainingImage(position: Position): typingsSlinky.dockerfileAst.mod.ImageTemplate | Null = js.native
    /**
