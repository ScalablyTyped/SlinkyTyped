...
object anon {
  ...
  object Element {
    ...
    implicit class ElementMutableBuilder[Self <: Element] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEmpty(value: ReactElement): Self = StObject.set(x, "empty", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEmptyReactElement(value: ReactElement): Self = StObject.set(x, "empty", value.asInstanceOf[js.Any])
