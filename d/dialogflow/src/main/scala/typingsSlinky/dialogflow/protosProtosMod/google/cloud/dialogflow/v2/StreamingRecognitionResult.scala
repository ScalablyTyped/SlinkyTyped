...
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType
...
object StreamingRecognitionResult extends js.Object {
  ...
  object MessageType extends js.Object {
    ...
    /* 2 */ val END_OF_SINGLE_UTTERANCE: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.END_OF_SINGLE_UTTERANCE with Double = js.native
    /* 0 */ val MESSAGE_TYPE_UNSPECIFIED: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.MESSAGE_TYPE_UNSPECIFIED with Double = js.native
    /* 1 */ val TRANSCRIPT: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.TRANSCRIPT with Double = js.native
    @JSBracketAccess
