...
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier
import typingsSlinky.protobufjs.protobufjsMod.IConversionOptions
import typingsSlinky.protobufjs.protobufjsMod.Reader
import typingsSlinky.protobufjs.protobufjsMod.Writer
...
object Agent extends js.Object {
  ...
  object ApiVersion extends js.Object {
    ...
    /* 0 */ val API_VERSION_UNSPECIFIED: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_UNSPECIFIED with Double = js.native
    /* 1 */ val API_VERSION_V1: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V1 with Double = js.native
    /* 2 */ val API_VERSION_V2: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V2 with Double = js.native
    /* 3 */ val API_VERSION_V2_BETA_1: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V2_BETA_1 with Double = js.native
    @JSBracketAccess
  ...
  object MatchMode extends js.Object {
    ...
    /* 1 */ val MATCH_MODE_HYBRID: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_HYBRID with Double = js.native
    /* 2 */ val MATCH_MODE_ML_ONLY: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_ML_ONLY with Double = js.native
    /* 0 */ val MATCH_MODE_UNSPECIFIED: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_UNSPECIFIED with Double = js.native
    @JSBracketAccess
  ...
  object Tier extends js.Object {
    ...
    /* 2 */ val TIER_ENTERPRISE: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_ENTERPRISE with Double = js.native
    /* 3 */ val TIER_ENTERPRISE_PLUS: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_ENTERPRISE_PLUS with Double = js.native
    /* 1 */ val TIER_STANDARD: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_STANDARD with Double = js.native
    /* 0 */ val TIER_UNSPECIFIED: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_UNSPECIFIED with Double = js.native
    @JSBracketAccess
