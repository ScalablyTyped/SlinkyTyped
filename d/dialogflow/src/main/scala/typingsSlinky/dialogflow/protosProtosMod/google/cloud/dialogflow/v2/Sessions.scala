...
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.DetectIntentCallback
import typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.StreamingDetectIntentCallback
