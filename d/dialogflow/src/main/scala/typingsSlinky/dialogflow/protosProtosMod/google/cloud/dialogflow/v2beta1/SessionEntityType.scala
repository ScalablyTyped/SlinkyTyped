...
object SessionEntityType extends js.Object {
  ...
  object EntityOverrideMode extends js.Object {
    ...
    /* 1 */ val ENTITY_OVERRIDE_MODE_OVERRIDE: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_OVERRIDE with Double = js.native
    /* 2 */ val ENTITY_OVERRIDE_MODE_SUPPLEMENT: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_SUPPLEMENT with Double = js.native
    /* 0 */ val ENTITY_OVERRIDE_MODE_UNSPECIFIED: typingsSlinky.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_UNSPECIFIED with Double = js.native
    @JSBracketAccess
