...
object ^ extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  def create(properties: ICarouselSelect): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  def decode(reader: js.typedarray.Uint8Array): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  /**
  ...
  /**
    ...
    * @returns CarouselSelect
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect = js.native
  /**
    ...
    */
  def toObject(
    message: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect
