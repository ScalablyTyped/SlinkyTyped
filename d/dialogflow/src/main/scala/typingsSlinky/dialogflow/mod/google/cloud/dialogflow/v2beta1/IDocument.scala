...
trait IDocument extends StObject {
  ...
  /** Document rawContent */
  var rawContent: js.UndefOr[js.typedarray.Uint8Array | String | Null] = js.native
}
object IDocument {
  ...
  implicit class IDocumentMutableBuilder[Self <: IDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRawContent(value: js.typedarray.Uint8Array | String): Self = StObject.set(x, "rawContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRawContentNull: Self = StObject.set(x, "rawContent", null)
    
    @scala.inline
    def setRawContentUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "rawContent", value.asInstanceOf[js.Any])
