...
import typingsSlinky.dialogflow.mod.google.protobuf.IFieldDescriptorProto
...
object ^ extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.dialogflow.mod.google.protobuf.FieldDescriptorProto = js.native
  def create(properties: IFieldDescriptorProto): typingsSlinky.dialogflow.mod.google.protobuf.FieldDescriptorProto = js.native
  /**
  ...
  /**
    ...
    * @returns FieldDescriptorProto
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.dialogflow.mod.google.protobuf.FieldDescriptorProto = js.native
  /**
    ...
    */
  def toObject(message: typingsSlinky.dialogflow.mod.google.protobuf.FieldDescriptorProto): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsSlinky.dialogflow.mod.google.protobuf.FieldDescriptorProto,
