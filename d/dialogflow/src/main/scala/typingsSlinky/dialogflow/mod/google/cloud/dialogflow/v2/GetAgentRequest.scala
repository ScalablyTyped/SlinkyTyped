...
object GetAgentRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): GetAgentRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.GetAgentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetAgentRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetAgentRequest = js.native
  /**
