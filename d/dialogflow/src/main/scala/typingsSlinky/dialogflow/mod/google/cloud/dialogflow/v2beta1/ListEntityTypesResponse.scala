...
object ListEntityTypesResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListEntityTypesResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListEntityTypesResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListEntityTypesResponse = js.native
  /**
