...
object ^ extends js.Object {
  ...
  def decode(reader: Uint8Array): typingsSlinky.dialogflow.mod.google.protobuf.DescriptorProto = js.native
  def decode(reader: Uint8Array, length: Double): typingsSlinky.dialogflow.mod.google.protobuf.DescriptorProto = js.native
  /**
  ...
  def decodeDelimited(reader: Uint8Array): typingsSlinky.dialogflow.mod.google.protobuf.DescriptorProto = js.native
  /**
