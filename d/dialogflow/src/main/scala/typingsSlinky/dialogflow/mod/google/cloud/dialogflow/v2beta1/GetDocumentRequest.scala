...
object GetDocumentRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GetDocumentRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetDocumentRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetDocumentRequest = js.native
  /**
