...
object SessionEntityType {
  ...
  object EntityOverrideMode extends StObject {
    ...
    /* 1 */ val ENTITY_OVERRIDE_MODE_OVERRIDE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_OVERRIDE with Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_SUPPLEMENT extends EntityOverrideMode
    /* 2 */ val ENTITY_OVERRIDE_MODE_SUPPLEMENT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_SUPPLEMENT with Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_UNSPECIFIED extends EntityOverrideMode
    /* 0 */ val ENTITY_OVERRIDE_MODE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_UNSPECIFIED with Double = js.native
  }
