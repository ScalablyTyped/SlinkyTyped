...
object UpdateDocumentRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): UpdateDocumentRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.UpdateDocumentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): UpdateDocumentRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): UpdateDocumentRequest = js.native
  /**
