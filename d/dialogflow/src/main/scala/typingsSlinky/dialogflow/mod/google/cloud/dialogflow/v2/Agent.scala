...
object Agent {
  ...
  object ApiVersion extends StObject {
    ...
    /* 0 */ val API_VERSION_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.ApiVersion.API_VERSION_UNSPECIFIED with Double = js.native
    
    @js.native
    sealed trait API_VERSION_V1 extends ApiVersion
    /* 1 */ val API_VERSION_V1: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.ApiVersion.API_VERSION_V1 with Double = js.native
    
    @js.native
    sealed trait API_VERSION_V2 extends ApiVersion
    /* 2 */ val API_VERSION_V2: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.ApiVersion.API_VERSION_V2 with Double = js.native
    
    @js.native
    sealed trait API_VERSION_V2_BETA_1 extends ApiVersion
    /* 3 */ val API_VERSION_V2_BETA_1: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.ApiVersion.API_VERSION_V2_BETA_1 with Double = js.native
  }
  ...
  object MatchMode extends StObject {
    ...
    /* 1 */ val MATCH_MODE_HYBRID: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.MatchMode.MATCH_MODE_HYBRID with Double = js.native
    
    @js.native
    sealed trait MATCH_MODE_ML_ONLY extends MatchMode
    /* 2 */ val MATCH_MODE_ML_ONLY: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.MatchMode.MATCH_MODE_ML_ONLY with Double = js.native
    
    @js.native
    sealed trait MATCH_MODE_UNSPECIFIED extends MatchMode
    /* 0 */ val MATCH_MODE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.MatchMode.MATCH_MODE_UNSPECIFIED with Double = js.native
  }
  ...
  object Tier extends StObject {
    ...
    /* 2 */ val TIER_ENTERPRISE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.Tier.TIER_ENTERPRISE with Double = js.native
    
    @js.native
    sealed trait TIER_ENTERPRISE_PLUS extends Tier
    /* 3 */ val TIER_ENTERPRISE_PLUS: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.Tier.TIER_ENTERPRISE_PLUS with Double = js.native
    
    @js.native
    sealed trait TIER_STANDARD extends Tier
    /* 1 */ val TIER_STANDARD: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.Tier.TIER_STANDARD with Double = js.native
    
    @js.native
    sealed trait TIER_UNSPECIFIED extends Tier
    /* 0 */ val TIER_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Agent.Tier.TIER_UNSPECIFIED with Double = js.native
  }
