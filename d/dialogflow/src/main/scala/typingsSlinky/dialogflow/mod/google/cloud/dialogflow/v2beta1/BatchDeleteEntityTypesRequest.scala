...
object BatchDeleteEntityTypesRequest {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.create")
  @js.native
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): BatchDeleteEntityTypesRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): BatchDeleteEntityTypesRequest = js.native
  /**
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): BatchDeleteEntityTypesRequest = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.BatchDeleteEntityTypesRequest.verify")
  @js.native
