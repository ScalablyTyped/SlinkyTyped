package typingsSlinky.dialogflow.mod.google

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.raw.History
import typingsSlinky.dialogflow.dialogflowStrings.custom
import typingsSlinky.dialogflow.dialogflowStrings.delete
import typingsSlinky.dialogflow.dialogflowStrings.get
import typingsSlinky.dialogflow.dialogflowStrings.patch
import typingsSlinky.dialogflow.dialogflowStrings.post
import typingsSlinky.dialogflow.dialogflowStrings.put
...
object api {
  ...
  object FieldBehavior extends StObject {
    ...
    /* 0 */ val FIELD_BEHAVIOR_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.FIELD_BEHAVIOR_UNSPECIFIED with Double = js.native
    
    @js.native
    sealed trait IMMUTABLE extends FieldBehavior
    /* 5 */ val IMMUTABLE: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.IMMUTABLE with Double = js.native
    
    @js.native
    sealed trait INPUT_ONLY extends FieldBehavior
    /* 4 */ val INPUT_ONLY: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.INPUT_ONLY with Double = js.native
    
    @js.native
    sealed trait OPTIONAL extends FieldBehavior
    /* 1 */ val OPTIONAL: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.OPTIONAL with Double = js.native
    
    @js.native
    sealed trait OUTPUT_ONLY extends FieldBehavior
    /* 3 */ val OUTPUT_ONLY: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.OUTPUT_ONLY with Double = js.native
    
    @js.native
    sealed trait REQUIRED extends FieldBehavior
    /* 2 */ val REQUIRED: typingsSlinky.dialogflow.mod.google.api.FieldBehavior.REQUIRED with Double = js.native
  }
  ...
  object ResourceDescriptor {
    ...
    object History extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History with Double] = js.native
      
      @js.native
      sealed trait FUTURE_MULTI_PATTERN
        extends typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History
      /* 2 */ val FUTURE_MULTI_PATTERN: typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History.FUTURE_MULTI_PATTERN with Double = js.native
      
      @js.native
      sealed trait HISTORY_UNSPECIFIED
        extends typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History
      /* 0 */ val HISTORY_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History.HISTORY_UNSPECIFIED with Double = js.native
      
      @js.native
      sealed trait ORIGINALLY_SINGLE_PATTERN
        extends typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History
      /* 1 */ val ORIGINALLY_SINGLE_PATTERN: typingsSlinky.dialogflow.mod.google.api.ResourceDescriptor.History.ORIGINALLY_SINGLE_PATTERN with Double = js.native
    }
  ...
  object IResourceDescriptor {
    ...
    implicit class IResourceDescriptorMutableBuilder[Self <: IResourceDescriptor] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHistoryHistory(value: History): Self = StObject.set(x, "history", value.asInstanceOf[js.Any])
