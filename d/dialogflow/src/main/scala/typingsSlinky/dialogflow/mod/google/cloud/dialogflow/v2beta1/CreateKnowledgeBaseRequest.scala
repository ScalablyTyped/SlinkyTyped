...
object CreateKnowledgeBaseRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): CreateKnowledgeBaseRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.CreateKnowledgeBaseRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): CreateKnowledgeBaseRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): CreateKnowledgeBaseRequest = js.native
  /**
