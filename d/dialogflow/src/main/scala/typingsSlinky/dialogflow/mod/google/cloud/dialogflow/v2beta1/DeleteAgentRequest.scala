...
object DeleteAgentRequest {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.create")
  @js.native
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DeleteAgentRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteAgentRequest = js.native
  /**
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteAgentRequest = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAgentRequest.verify")
  @js.native
