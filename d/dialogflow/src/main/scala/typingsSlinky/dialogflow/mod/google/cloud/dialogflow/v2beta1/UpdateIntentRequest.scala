...
object UpdateIntentRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): UpdateIntentRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.UpdateIntentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): UpdateIntentRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): UpdateIntentRequest = js.native
  /**
