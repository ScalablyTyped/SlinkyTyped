...
object GetSessionEntityTypeRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GetSessionEntityTypeRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetSessionEntityTypeRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetSessionEntityTypeRequest = js.native
  /**
