...
object SearchAgentsResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): SearchAgentsResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SearchAgentsResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): SearchAgentsResponse = js.native
  /**
