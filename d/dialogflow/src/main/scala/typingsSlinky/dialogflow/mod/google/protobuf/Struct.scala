...
object Struct extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Struct = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Struct = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Struct = js.native
  /**
