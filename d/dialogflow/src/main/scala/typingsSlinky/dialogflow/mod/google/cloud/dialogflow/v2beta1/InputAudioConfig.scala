...
object InputAudioConfig {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.create")
  @js.native
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): InputAudioConfig = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): InputAudioConfig = js.native
  /**
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): InputAudioConfig = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.InputAudioConfig.verify")
  @js.native
