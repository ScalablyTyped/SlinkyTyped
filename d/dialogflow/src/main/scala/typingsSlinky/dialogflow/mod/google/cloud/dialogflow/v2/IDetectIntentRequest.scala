...
trait IDetectIntentRequest extends StObject {
  ...
  var inputAudio: js.UndefOr[js.typedarray.Uint8Array | String | Null] = js.native
...
object IDetectIntentRequest {
  ...
  implicit class IDetectIntentRequestMutableBuilder[Self <: IDetectIntentRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputAudio(value: js.typedarray.Uint8Array | String): Self = StObject.set(x, "inputAudio", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInputAudioNull: Self = StObject.set(x, "inputAudio", null)
    
    @scala.inline
    def setInputAudioUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "inputAudio", value.asInstanceOf[js.Any])
