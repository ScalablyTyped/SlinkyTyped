...
object UpdateKnowledgeBaseRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): UpdateKnowledgeBaseRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.UpdateKnowledgeBaseRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): UpdateKnowledgeBaseRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): UpdateKnowledgeBaseRequest = js.native
  /**
