...
object ListValue {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListValue = js.native
  @JSImport("dialogflow/protos/protos", "google.protobuf.ListValue.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListValue = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListValue = js.native
  /**
