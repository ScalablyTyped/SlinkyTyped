...
object ValidationError {
  ...
  object Severity extends StObject {
    ...
    /* 4 */ val CRITICAL: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.CRITICAL with Double = js.native
    
    @js.native
    sealed trait ERROR extends Severity
    /* 3 */ val ERROR: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.ERROR with Double = js.native
    
    @js.native
    sealed trait INFO extends Severity
    /* 1 */ val INFO: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.INFO with Double = js.native
    
    @js.native
    sealed trait SEVERITY_UNSPECIFIED extends Severity
    /* 0 */ val SEVERITY_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.SEVERITY_UNSPECIFIED with Double = js.native
    
    @js.native
    sealed trait WARNING extends Severity
    /* 2 */ val WARNING: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.WARNING with Double = js.native
  }
