...
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.CreateDocumentCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.DeleteDocumentCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.GetDocumentCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.ListDocumentsCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.ReloadDocumentCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.Documents.UpdateDocumentCallback
...
object Documents {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.Documents.create")
  @js.native
  def create(rpcImpl: RPCImpl): Documents = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.Documents.create")
  @js.native
  def create(rpcImpl: RPCImpl, requestDelimited: js.UndefOr[scala.Nothing], responseDelimited: Boolean): Documents = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.Documents.create")
  @js.native
