...
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Sessions.DetectIntentCallback
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.Sessions.StreamingDetectIntentCallback
