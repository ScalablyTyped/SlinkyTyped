...
object DeleteIntentRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DeleteIntentRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.DeleteIntentRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteIntentRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteIntentRequest = js.native
  /**
