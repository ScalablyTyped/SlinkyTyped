...
class DetectIntentRequest () extends IDetectIntentRequest {
  ...
  @JSName("inputAudio")
  var inputAudio_DetectIntentRequest: js.typedarray.Uint8Array = js.native
...
object DetectIntentRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DetectIntentRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DetectIntentRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DetectIntentRequest = js.native
  /**
