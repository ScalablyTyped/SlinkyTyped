...
object GcsSource {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): GcsSource = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.GcsSource.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GcsSource = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): GcsSource = js.native
  /**
