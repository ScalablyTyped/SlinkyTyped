...
object SynthesizeSpeechConfig {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.create")
  @js.native
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): SynthesizeSpeechConfig = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SynthesizeSpeechConfig = js.native
  /**
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): SynthesizeSpeechConfig = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.SynthesizeSpeechConfig.verify")
  @js.native
