...
object Text extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Text = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Text = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Text = js.native
  /**
