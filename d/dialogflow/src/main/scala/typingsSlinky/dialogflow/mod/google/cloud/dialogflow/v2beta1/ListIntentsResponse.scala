...
object ListIntentsResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListIntentsResponse = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.ListIntentsResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListIntentsResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListIntentsResponse = js.native
  /**
