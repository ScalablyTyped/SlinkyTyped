...
class EntityType () extends IEntityType {
  ...
  var autoExpansionMode_EntityType: AutoExpansionMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.AutoExpansionMode * / any */ String) = js.native
  ...
  /** EntityType kind. */
  @JSName("kind")
  var kind_EntityType: Kind | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.Kind * / any */ String) = js.native
...
object EntityType {
  ...
  object AutoExpansionMode extends StObject {
    ...
    /* 1 */ val AUTO_EXPANSION_MODE_DEFAULT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT with Double = js.native
    
    @js.native
    sealed trait AUTO_EXPANSION_MODE_UNSPECIFIED extends AutoExpansionMode
    /* 0 */ val AUTO_EXPANSION_MODE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_UNSPECIFIED with Double = js.native
  }
  ...
  object Entity {
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.create")
    @js.native
    ...
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.decode")
    @js.native
    ...
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.decodeDelimited")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.encode")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.encodeDelimited")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.fromObject")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.toObject")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.Entity.verify")
    @js.native
  ...
  object Kind extends StObject {
    ...
    /* 2 */ val KIND_LIST: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_LIST with Double = js.native
    
    @js.native
    sealed trait KIND_MAP extends Kind
    /* 1 */ val KIND_MAP: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_MAP with Double = js.native
    
    @js.native
    sealed trait KIND_REGEXP extends Kind
    /* 3 */ val KIND_REGEXP: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_REGEXP with Double = js.native
    
    @js.native
    sealed trait KIND_UNSPECIFIED extends Kind
    /* 0 */ val KIND_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_UNSPECIFIED with Double = js.native
  }
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.create")
  @js.native
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array): EntityType = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): EntityType = js.native
  /**
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.decodeDelimited")
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): EntityType = js.native
  /**
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.fromObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.toObject")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2.EntityType.verify")
  @js.native
  def verify(message: StringDictionary[js.Any]): String | Null = js.native
