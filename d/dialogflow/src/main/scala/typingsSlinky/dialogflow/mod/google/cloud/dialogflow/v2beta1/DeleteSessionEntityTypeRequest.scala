...
object DeleteSessionEntityTypeRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): DeleteSessionEntityTypeRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteSessionEntityTypeRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteSessionEntityTypeRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteSessionEntityTypeRequest = js.native
  /**
