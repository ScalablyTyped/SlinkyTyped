...
object DeleteDocumentRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DeleteDocumentRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DeleteDocumentRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DeleteDocumentRequest = js.native
  /**
