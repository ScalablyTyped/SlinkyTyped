...
object OutputAudioConfig extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): OutputAudioConfig = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): OutputAudioConfig = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): OutputAudioConfig = js.native
  /**
