...
object ListKnowledgeBasesResponse extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ListKnowledgeBasesResponse = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListKnowledgeBasesResponse = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListKnowledgeBasesResponse = js.native
  /**
