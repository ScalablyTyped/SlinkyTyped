...
object MethodOptions {
  ...
  object IdempotencyLevel extends StObject {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typingsSlinky.dialogflow.mod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN with Double = js.native
    
    @js.native
    sealed trait IDEMPOTENT extends IdempotencyLevel
    /* 2 */ val IDEMPOTENT: typingsSlinky.dialogflow.mod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENT with Double = js.native
    
    @js.native
    sealed trait NO_SIDE_EFFECTS extends IdempotencyLevel
    /* 1 */ val NO_SIDE_EFFECTS: typingsSlinky.dialogflow.mod.google.protobuf.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS with Double = js.native
  }
