...
object CreateSessionEntityTypeRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): CreateSessionEntityTypeRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): CreateSessionEntityTypeRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): CreateSessionEntityTypeRequest = js.native
  /**
