...
object ListSessionEntityTypesResponse {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ListSessionEntityTypesResponse = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.ListSessionEntityTypesResponse.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ListSessionEntityTypesResponse = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ListSessionEntityTypesResponse = js.native
  /**
