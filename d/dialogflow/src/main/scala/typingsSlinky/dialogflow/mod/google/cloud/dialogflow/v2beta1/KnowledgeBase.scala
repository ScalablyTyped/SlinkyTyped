...
object KnowledgeBase {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): KnowledgeBase = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.KnowledgeBase.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): KnowledgeBase = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): KnowledgeBase = js.native
  /**
