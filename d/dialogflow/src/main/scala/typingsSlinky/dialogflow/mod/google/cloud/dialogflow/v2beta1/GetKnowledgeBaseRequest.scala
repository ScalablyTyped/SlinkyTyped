...
object GetKnowledgeBaseRequest {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): GetKnowledgeBaseRequest = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.GetKnowledgeBaseRequest.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetKnowledgeBaseRequest = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetKnowledgeBaseRequest = js.native
  /**
