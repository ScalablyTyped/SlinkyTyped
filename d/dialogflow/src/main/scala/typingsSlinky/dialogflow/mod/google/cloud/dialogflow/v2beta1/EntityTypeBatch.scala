...
object EntityTypeBatch extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): EntityTypeBatch = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): EntityTypeBatch = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): EntityTypeBatch = js.native
  /**
