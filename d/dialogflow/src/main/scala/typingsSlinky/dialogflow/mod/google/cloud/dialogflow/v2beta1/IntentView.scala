...
object IntentView extends StObject {
  ...
  /* 1 */ val INTENT_VIEW_FULL: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.IntentView.INTENT_VIEW_FULL with Double = js.native
  
  @js.native
  sealed trait INTENT_VIEW_UNSPECIFIED extends IntentView
  /* 0 */ val INTENT_VIEW_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.IntentView.INTENT_VIEW_UNSPECIFIED with Double = js.native
}
