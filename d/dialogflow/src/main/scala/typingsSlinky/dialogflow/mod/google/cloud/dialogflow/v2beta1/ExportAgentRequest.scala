...
object ExportAgentRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): ExportAgentRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ExportAgentRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): ExportAgentRequest = js.native
  /**
