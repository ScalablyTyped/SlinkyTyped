...
object GetContextRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): GetContextRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GetContextRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): GetContextRequest = js.native
  /**
