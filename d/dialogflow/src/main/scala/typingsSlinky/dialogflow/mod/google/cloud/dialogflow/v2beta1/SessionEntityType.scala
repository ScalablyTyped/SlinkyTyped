...
import typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode
...
object SessionEntityType {
  ...
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode")
  @js.native
  object EntityOverrideMode extends StObject {
    ...
    /* 1 */ val ENTITY_OVERRIDE_MODE_OVERRIDE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_OVERRIDE with Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_SUPPLEMENT extends EntityOverrideMode
    /* 2 */ val ENTITY_OVERRIDE_MODE_SUPPLEMENT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_SUPPLEMENT with Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_UNSPECIFIED extends EntityOverrideMode
    /* 0 */ val ENTITY_OVERRIDE_MODE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_UNSPECIFIED with Double = js.native
  }
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): SessionEntityType = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.SessionEntityType.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SessionEntityType = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): SessionEntityType = js.native
  /**
