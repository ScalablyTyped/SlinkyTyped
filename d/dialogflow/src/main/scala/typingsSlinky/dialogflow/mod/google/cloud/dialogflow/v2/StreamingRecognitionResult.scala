...
object StreamingRecognitionResult {
  ...
  object MessageType extends StObject {
    ...
    /* 2 */ val END_OF_SINGLE_UTTERANCE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.END_OF_SINGLE_UTTERANCE with Double = js.native
    
    @js.native
    sealed trait MESSAGE_TYPE_UNSPECIFIED extends MessageType
    /* 0 */ val MESSAGE_TYPE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.MESSAGE_TYPE_UNSPECIFIED with Double = js.native
    
    @js.native
    sealed trait TRANSCRIPT extends MessageType
    /* 1 */ val TRANSCRIPT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2.StreamingRecognitionResult.MessageType.TRANSCRIPT with Double = js.native
  }
