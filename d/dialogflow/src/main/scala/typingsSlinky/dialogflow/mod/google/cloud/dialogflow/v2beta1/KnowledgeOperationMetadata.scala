...
object KnowledgeOperationMetadata {
  ...
  object State extends StObject {
    ...
    /* 3 */ val DONE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.DONE with Double = js.native
    
    @js.native
    sealed trait PENDING extends State
    /* 1 */ val PENDING: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.PENDING with Double = js.native
    
    @js.native
    sealed trait RUNNING extends State
    /* 2 */ val RUNNING: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.RUNNING with Double = js.native
    
    @js.native
    sealed trait STATE_UNSPECIFIED extends State
    /* 0 */ val STATE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.STATE_UNSPECIFIED with Double = js.native
  }
