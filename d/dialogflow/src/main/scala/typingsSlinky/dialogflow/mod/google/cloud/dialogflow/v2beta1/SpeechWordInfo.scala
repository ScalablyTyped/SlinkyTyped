...
object SpeechWordInfo extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): SpeechWordInfo = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SpeechWordInfo = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): SpeechWordInfo = js.native
  /**
