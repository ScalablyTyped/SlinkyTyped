...
object SentimentAnalysisRequestConfig extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): SentimentAnalysisRequestConfig = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SentimentAnalysisRequestConfig = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): SentimentAnalysisRequestConfig = js.native
  /**
