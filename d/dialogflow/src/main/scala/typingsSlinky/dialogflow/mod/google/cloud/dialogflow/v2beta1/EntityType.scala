...
object EntityType {
  ...
  object AutoExpansionMode extends StObject {
    ...
    /* 1 */ val AUTO_EXPANSION_MODE_DEFAULT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT with Double = js.native
    
    @js.native
    sealed trait AUTO_EXPANSION_MODE_UNSPECIFIED extends AutoExpansionMode
    /* 0 */ val AUTO_EXPANSION_MODE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_UNSPECIFIED with Double = js.native
  }
  ...
  object Kind extends StObject {
    ...
    /* 2 */ val KIND_LIST: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_LIST with Double = js.native
    
    @js.native
    sealed trait KIND_MAP extends Kind
    /* 1 */ val KIND_MAP: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_MAP with Double = js.native
    
    @js.native
    sealed trait KIND_REGEXP extends Kind
    /* 3 */ val KIND_REGEXP: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_REGEXP with Double = js.native
    
    @js.native
    sealed trait KIND_UNSPECIFIED extends Kind
    /* 0 */ val KIND_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_UNSPECIFIED with Double = js.native
  }
