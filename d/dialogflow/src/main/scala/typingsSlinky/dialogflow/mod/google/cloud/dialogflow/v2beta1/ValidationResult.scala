...
object ValidationResult {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): ValidationResult = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.ValidationResult.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): ValidationResult = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): ValidationResult = js.native
  /**
