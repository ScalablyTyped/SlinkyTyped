...
object IUninterpretedOption {
  ...
  implicit class IUninterpretedOptionMutableBuilder[Self <: IUninterpretedOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStringValue(value: js.typedarray.Uint8Array | String): Self = StObject.set(x, "stringValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStringValueNull: Self = StObject.set(x, "stringValue", null)
    
    @scala.inline
    def setStringValueUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "stringValue", value.asInstanceOf[js.Any])
