...
object TextInput extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): TextInput = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TextInput = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): TextInput = js.native
  /**
