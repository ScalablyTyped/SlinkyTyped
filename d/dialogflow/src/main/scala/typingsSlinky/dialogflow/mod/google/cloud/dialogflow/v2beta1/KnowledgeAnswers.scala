...
object KnowledgeAnswers {
  ...
  object Answer {
    ...
    object MatchConfidenceLevel extends StObject {
      ...
      /* 3 */ val HIGH: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.HIGH with Double = js.native
      
      @js.native
      sealed trait LOW extends MatchConfidenceLevel
      /* 1 */ val LOW: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.LOW with Double = js.native
      
      @js.native
      sealed trait MATCH_CONFIDENCE_LEVEL_UNSPECIFIED extends MatchConfidenceLevel
      /* 0 */ val MATCH_CONFIDENCE_LEVEL_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.MATCH_CONFIDENCE_LEVEL_UNSPECIFIED with Double = js.native
      
      @js.native
      sealed trait MEDIUM extends MatchConfidenceLevel
      /* 2 */ val MEDIUM: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.MEDIUM with Double = js.native
    }
    ...
    @js.native
    def decode(reader: js.typedarray.Uint8Array): Answer = js.native
    @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.decode")
    @js.native
    def decode(reader: js.typedarray.Uint8Array, length: Double): Answer = js.native
    /**
    ...
    @js.native
    def decodeDelimited(reader: js.typedarray.Uint8Array): Answer = js.native
    /**
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): KnowledgeAnswers = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.KnowledgeAnswers.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): KnowledgeAnswers = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): KnowledgeAnswers = js.native
  /**
