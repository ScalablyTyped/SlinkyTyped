...
object CreateDocumentRequest extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): CreateDocumentRequest = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): CreateDocumentRequest = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): CreateDocumentRequest = js.native
  /**
