...
object Sentiment extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Sentiment = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Sentiment = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Sentiment = js.native
  /**
