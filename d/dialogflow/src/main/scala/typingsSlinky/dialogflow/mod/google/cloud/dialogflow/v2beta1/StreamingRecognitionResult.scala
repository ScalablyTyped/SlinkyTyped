...
object StreamingRecognitionResult {
  ...
  object MessageType extends StObject {
    ...
    /* 2 */ val END_OF_SINGLE_UTTERANCE: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.END_OF_SINGLE_UTTERANCE with Double = js.native
    
    @js.native
    sealed trait MESSAGE_TYPE_UNSPECIFIED extends MessageType
    /* 0 */ val MESSAGE_TYPE_UNSPECIFIED: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.MESSAGE_TYPE_UNSPECIFIED with Double = js.native
    
    @js.native
    sealed trait TRANSCRIPT extends MessageType
    /* 1 */ val TRANSCRIPT: typingsSlinky.dialogflow.mod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.TRANSCRIPT with Double = js.native
  }
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): StreamingRecognitionResult = js.native
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): StreamingRecognitionResult = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): StreamingRecognitionResult = js.native
  /**
