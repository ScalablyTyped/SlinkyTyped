...
object ExtendedGeometryCollection {
  ...
  @scala.inline
  implicit class ExtendedGeometryCollectionOps[Self <: ExtendedGeometryCollection[_], GeometryType /* <: GeoGeometryObjects */] (val x: Self with ExtendedGeometryCollection[GeometryType]) extends AnyVal {
