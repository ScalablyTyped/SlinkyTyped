...
object ExtendedFeature {
  @scala.inline
  def apply[/* <: typingsSlinky.d3Geo.mod.GeoGeometryObjects | scala.Null */ GeometryType, /* <: typingsSlinky.geojson.mod.GeoJsonProperties */ Properties](geometry: GeometryType, properties: Properties, `type`: GeoJsonTypes): ExtendedFeature[GeometryType, Properties] = {
    val __obj = js.Dynamic.literal(geometry = geometry.asInstanceOf[js.Any], properties = properties.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExtendedFeature[GeometryType, Properties]]
  }
  @scala.inline
  implicit class ExtendedFeatureOps[Self <: ExtendedFeature[_, _], /* <: typingsSlinky.d3Geo.mod.GeoGeometryObjects | scala.Null */ GeometryType, /* <: typingsSlinky.geojson.mod.GeoJsonProperties */ Properties] (val x: Self with (ExtendedFeature[GeometryType, Properties])) extends AnyVal {
    @scala.inline
