...
object mod {
  ...
  @JSImport("date-and-time", "format")
  @js.native
  def format(dateObj: js.Date, formatString: js.Array[String]): String = js.native
  @JSImport("date-and-time", "format")
  @js.native
  def format(dateObj: js.Date, formatString: js.Array[String], utc: Boolean): String = js.native
  ...
  @js.native
  def parse(dateString: String, formatter: String): js.Date = js.native
  @JSImport("date-and-time", "parse")
  @js.native
  def parse(dateString: String, formatter: String, utc: Boolean): js.Date = js.native
  @JSImport("date-and-time", "parse")
  @js.native
  def parse(dateString: String, formatter: js.Array[String]): js.Date = js.native
  @JSImport("date-and-time", "parse")
  @js.native
  def parse(dateString: String, formatter: js.Array[String], utc: Boolean): js.Date = js.native
  ...
  @js.native
  def subtract(date1: js.Date, date2: js.Date): SubtractResult = js.native
