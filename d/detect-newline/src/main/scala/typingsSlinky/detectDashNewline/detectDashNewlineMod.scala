...
import typingsSlinky.detectDashNewline.detectDashNewlineStrings.CarriagereturnLinefeed
import typingsSlinky.detectDashNewline.detectDashNewlineStrings.Linefeed
