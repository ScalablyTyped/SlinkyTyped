package typingsSlinky.detectDashNewline

import typingsSlinky.detectDashNewline.detectDashNewlineStrings.BACKSLASHn
import typingsSlinky.detectDashNewline.detectDashNewlineStrings.BACKSLASHrBACKSLASHn
