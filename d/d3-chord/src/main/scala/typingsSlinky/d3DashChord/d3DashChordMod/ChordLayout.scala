package typingsSlinky.d3DashChord.d3DashChordMod
...
trait ChordLayout extends js.Object {
  ...
  /**
    ...
    */
  @JSName("sortChords")
  def sortChords_This(): this.type = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("sortGroups")
  def sortGroups_This(): this.type = js.native
  /**
  ...
  def sortSubgroups_This(): this.type = js.native
}
