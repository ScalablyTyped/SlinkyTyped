...
object IErrorCodes {
  ...
  implicit class IErrorCodesOps[Self <: IErrorCodes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInternalServerError(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InternalServerError")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPreconditionFailed(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PreconditionFailed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRequestEntityTooLarge(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RequestEntityTooLarge")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRetryWith(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RetryWith")(value.asInstanceOf[js.Any])
        ret
    }
  }
