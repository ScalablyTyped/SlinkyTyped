...
import typingsSlinky.d3DashZoom.d3DashZoomStrings.end
import typingsSlinky.d3DashZoom.d3DashZoomStrings.start
...
trait D3ZoomEvent[ZoomRefElement /* <: Element */, Datum] extends js.Object {
  ...
  /**
    ...
    */
  var `type`: start | typingsSlinky.d3DashZoom.d3DashZoomStrings.zoom | end | String = js.native
  /**
