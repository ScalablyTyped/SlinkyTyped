...
trait ValidationErrorConfiguration extends js.Object {
  ...
  var postFormatter: js.UndefOr[typingsSlinky.develarSchemaUtils.validateMod.PostFormatter] = js.native
}
...
object ValidationErrorConfiguration {
  ...
  implicit class ValidationErrorConfigurationOps[Self <: ValidationErrorConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPostFormatter(value: (/* formattedError */ String, /* error */ ErrorObjectchildrenArrayE) => String): Self = this.set("postFormatter", js.Any.fromFunction2(value))
    @scala.inline
