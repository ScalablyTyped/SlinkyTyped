...
object validateMod {
  ...
  object default {
    ...
    @js.native
    def apply(schema: typingsSlinky.jsonSchema.mod.JSONSchema4, options: js.Any): Unit = js.native
    @JSImport("@develar/schema-utils/declarations/validate", JSImport.Default)
    @js.native
    def apply(
      schema: typingsSlinky.jsonSchema.mod.JSONSchema4,
      options: js.Any,
      configuration: ValidationErrorConfiguration
    ): Unit = js.native
    @JSImport("@develar/schema-utils/declarations/validate", JSImport.Default)
    @js.native
    def apply(schema: typingsSlinky.jsonSchema.mod.JSONSchema6, options: js.Any): Unit = js.native
    @JSImport("@develar/schema-utils/declarations/validate", JSImport.Default)
    @js.native
    def apply(
    ...
    @JSImport("@develar/schema-utils/declarations/validate", JSImport.Default)
    @js.native
    def apply(schema: typingsSlinky.jsonSchema.mod.JSONSchema7, options: js.Any): Unit = js.native
    @JSImport("@develar/schema-utils/declarations/validate", JSImport.Default)
    @js.native
    def apply(
  ...
  trait SchemaUtilErrorObject extends StObject {
    ...
    var children: js.UndefOr[js.Array[typingsSlinky.ajv.mod.ErrorObject]] = js.native
  ...
  object SchemaUtilErrorObject {
    ...
    implicit class SchemaUtilErrorObjectMutableBuilder[Self <: SchemaUtilErrorObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: js.Array[typingsSlinky.ajv.mod.ErrorObject]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setChildrenVarargs(value: typingsSlinky.ajv.mod.ErrorObject*): Self = StObject.set(x, "children", js.Array(value :_*))
