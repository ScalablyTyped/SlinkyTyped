...
object SchemaUtilErrorObject {
  ...
  implicit class SchemaUtilErrorObjectOps[Self <: SchemaUtilErrorObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: typingsSlinky.ajv.mod.ErrorObject*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: js.Array[typingsSlinky.ajv.mod.ErrorObject]): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
