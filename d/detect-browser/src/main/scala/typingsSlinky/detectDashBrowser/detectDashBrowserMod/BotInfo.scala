...
@js.native
class BotInfo ()
  extends DetectedInfo[typingsSlinky.detectDashBrowser.detectDashBrowserStrings.bot, Null, Null] {
  val bot: `true` = js.native
  /* CompleteClass */
  override val name: typingsSlinky.detectDashBrowser.detectDashBrowserStrings.bot = js.native
  /* CompleteClass */
