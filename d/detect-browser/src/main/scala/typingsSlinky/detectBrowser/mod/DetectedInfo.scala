...
object DetectedInfo {
  @scala.inline
  def apply[/* <: typingsSlinky.detectBrowser.mod.DetectedInfoType */ T, /* <: java.lang.String */ N, O, V](name: N, os: O, `type`: T, version: V): DetectedInfo[T, N, O, V] = {
  ...
  @scala.inline
  implicit class DetectedInfoOps[Self <: DetectedInfo[_, _, _, _], /* <: typingsSlinky.detectBrowser.mod.DetectedInfoType */ T, /* <: java.lang.String */ N, O, V] (val x: Self with (DetectedInfo[T, N, O, V])) extends AnyVal {
    @scala.inline
