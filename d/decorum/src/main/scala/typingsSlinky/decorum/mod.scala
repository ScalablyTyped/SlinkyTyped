...
object mod {
  ...
  object EmailValidator {
    ...
    @scala.inline
    def EmailRegex_=(x: js.RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EmailRegex")(x.asInstanceOf[js.Any])
  }
  ...
  @js.native
  def Pattern(regex: js.RegExp): PropertyDecorator = js.native
  @JSImport("decorum", "Pattern")
  @js.native
  def Pattern(regex: js.RegExp, message: String): PropertyDecorator = js.native
  @JSImport("decorum", "Pattern")
  @js.native
  def Pattern(regex: js.RegExp, message: MessageHandler[PatternValidator]): PropertyDecorator = js.native
