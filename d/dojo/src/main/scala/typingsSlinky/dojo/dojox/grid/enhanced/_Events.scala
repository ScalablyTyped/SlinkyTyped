package typingsSlinky.dojo.dojox.grid.enhanced
...
@js.native
class _Events protected () extends js.Object {
  ...
  /**
    ...
    */
  def dokeyup(e: Event): Unit = js.native
  /**
    *
    * @param e
    */
  ...
  /**
    ...
    */
  def onCellMouseUp(e: Event): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def onSelectedRegionContextMenu(e: Event): Unit = js.native
}
