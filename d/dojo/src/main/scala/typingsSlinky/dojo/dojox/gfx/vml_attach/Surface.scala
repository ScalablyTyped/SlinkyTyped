package typingsSlinky.dojo.dojox.gfx.vml_attach
...
/**
  ...
  *
  */
@JSGlobal("dojox.gfx.vml_attach.Surface")
@js.native
class Surface () extends js.Object {
  ...
  /**
    ...
    * @param surface
    */
  def onLoad(surface: typingsSlinky.dojo.dojox.gfx.shape.Surface): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def remove(shape: typingsSlinky.dojo.dojox.gfx.shape.Shape, silently: Boolean): js.Function = js.native
  /**
