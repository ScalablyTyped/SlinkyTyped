package typingsSlinky.dojo.dojox.editor.plugins.Breadcrumb
...
import typingsSlinky.dojo.dojoStrings.menuTitle
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.Breadcrumb._BreadcrumbMenuTitle")
@js.native
class BreadcrumbMenuTitle () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_BreadcrumbMenuTitle: String = js.native
  /**
