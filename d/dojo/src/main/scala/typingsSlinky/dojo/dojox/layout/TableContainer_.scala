...
import typingsSlinky.dojo.dojoStrings.customClass
import typingsSlinky.dojo.dojoStrings.labelWidth
import typingsSlinky.dojo.dojoStrings.orientation
import typingsSlinky.dojo.dojoStrings.showLabels
import typingsSlinky.dojo.dojoStrings.spacing
