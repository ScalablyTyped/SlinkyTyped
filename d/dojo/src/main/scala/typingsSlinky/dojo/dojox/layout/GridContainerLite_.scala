...
import typingsSlinky.dojo.dijit.layout.LayoutWidget
import typingsSlinky.dojo.dojoStrings.ChildWidgetProperties
import typingsSlinky.dojo.dojoStrings.acceptTypes
import typingsSlinky.dojo.dojoStrings.attachScope
import typingsSlinky.dojo.dojoStrings.autoRefresh
import typingsSlinky.dojo.dojoStrings.colWidths
import typingsSlinky.dojo.dojoStrings.doLayout
import typingsSlinky.dojo.dojoStrings.dragHandleClass
import typingsSlinky.dojo.dojoStrings.isAutoOrganized
import typingsSlinky.dojo.dojoStrings.nbZones
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.layout.GridContainerLite")
@js.native
