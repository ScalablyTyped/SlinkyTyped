...
import typingsSlinky.dojo.dojoStrings.containerSize
import typingsSlinky.dojo.dojoStrings.direction
...
@js.native
class _ScrollBarBase () extends _WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style__ScrollBarBase: String = js.native
  /**
