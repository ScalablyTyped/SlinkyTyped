...
import typingsSlinky.dojo.dojoStrings.colors
import typingsSlinky.dojo.dojoStrings.slotClasses
import typingsSlinky.dojo.dojoStrings.slotOrder
import typingsSlinky.dojo.dojoStrings.slotProps
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile._PickerBase")
@js.native
