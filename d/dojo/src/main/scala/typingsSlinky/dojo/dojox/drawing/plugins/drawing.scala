package typingsSlinky.dojo.dojox.drawing.plugins
...
import typingsSlinky.dojo.dojoStrings.cellClass
import typingsSlinky.dojo.dojoStrings.cssStateNodes
import typingsSlinky.dojo.dojoStrings.defaultTimeout
import typingsSlinky.dojo.dojoStrings.hovering
import typingsSlinky.dojo.dojoStrings.paletteClass
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.showPreview
...
import typingsSlinky.dojo.dojoStrings.timeoutChangeRate
...
object drawing extends js.Object {
  ...
  - typingsSlinky.dojo.dijit.CssStateMixin because Inheritance from two classes. Inlined 
  - typingsSlinky.dojo.dijit.AttachMixin because Inheritance from two classes. Inlined 
  - typingsSlinky.dojo.dijit.PaletteMixin because Inheritance from two classes. Inlined active, cellClass, cssStateNodes, defaultTimeout, dyeClass, hovering, tabIndex, timeoutChangeRate, value, focus, postCreate, onChange
  - typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @js.native
