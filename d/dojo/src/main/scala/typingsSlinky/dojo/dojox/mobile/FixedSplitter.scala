...
import typingsSlinky.dojo.dojoStrings.screenSizeAware
import typingsSlinky.dojo.dojoStrings.screenSizeAwareClass
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.variablePane
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.FixedSplitter")
@js.native
