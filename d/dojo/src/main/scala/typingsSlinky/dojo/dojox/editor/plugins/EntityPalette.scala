...
import typingsSlinky.dojo.dojoStrings.showCode
import typingsSlinky.dojo.dojoStrings.showEntityName
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.EntityPalette")
@js.native
