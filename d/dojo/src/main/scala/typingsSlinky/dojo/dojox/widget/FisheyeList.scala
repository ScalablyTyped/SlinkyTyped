...
import typingsSlinky.dojo.dojoStrings.EDGE
import typingsSlinky.dojo.dojoStrings.attachEdge
import typingsSlinky.dojo.dojoStrings.attachScope
import typingsSlinky.dojo.dojoStrings.conservativeTrigger
import typingsSlinky.dojo.dojoStrings.effectUnits
import typingsSlinky.dojo.dojoStrings.imgNode
import typingsSlinky.dojo.dojoStrings.isFixed
import typingsSlinky.dojo.dojoStrings.itemHeight
import typingsSlinky.dojo.dojoStrings.itemMaxHeight
import typingsSlinky.dojo.dojoStrings.itemMaxWidth
import typingsSlinky.dojo.dojoStrings.itemPadding
import typingsSlinky.dojo.dojoStrings.itemWidth
import typingsSlinky.dojo.dojoStrings.labelEdge
import typingsSlinky.dojo.dojoStrings.orientation
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.snarfChildDomOutput
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.FisheyeList")
@js.native
