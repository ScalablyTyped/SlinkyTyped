...
import typingsSlinky.dojo.dojoStrings.checkClass
import typingsSlinky.dojo.dojoStrings.checked
import typingsSlinky.dojo.dojoStrings.deleteIcon
import typingsSlinky.dojo.dojoStrings.header
import typingsSlinky.dojo.dojoStrings.noArrow
import typingsSlinky.dojo.dojoStrings.progStyle
import typingsSlinky.dojo.dojoStrings.rightIcon
import typingsSlinky.dojo.dojoStrings.rightIcon2
import typingsSlinky.dojo.dojoStrings.rightIcon2Title
import typingsSlinky.dojo.dojoStrings.rightIconTitle
import typingsSlinky.dojo.dojoStrings.rightText
