...
import typingsSlinky.dojo.dojoStrings.icon1
import typingsSlinky.dojo.dojoStrings.icon2
import typingsSlinky.dojo.dojoStrings.iconPos1
import typingsSlinky.dojo.dojoStrings.iconPos2
