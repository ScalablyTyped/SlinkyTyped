...
import typingsSlinky.dojo.dojox.form.uploader.Base
...
- typingsSlinky.dojo.dijit.AttachMixin because Already inherited
- typingsSlinky.dojo.dijit.FocusMixin because Already inherited
- typingsSlinky.dojo.dijit.OnDijitClickMixin because Already inherited
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Already inherited
- typingsSlinky.dojo.dijit.Widget because Already inherited
- typingsSlinky.dojo.dijit.form.ButtonMixin because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.form.FormWidget because Inheritance from two classes. Inlined create
- typingsSlinky.dojo.dojox.form.uploader.Flash because Inheritance from two classes. Inlined deferredUploading, devMode, isDebug, preventCache, serverTimeout, skipServerCheck, swfPath, flashReset, getFlashFileList, onFileChange, onFileProgress, onLoad, onReady
- typingsSlinky.dojo.dojox.form.uploader.IFrame because Inheritance from two classes. Inlined uploadIFrame
- typingsSlinky.dojo.dojox.form.uploader._HTML5 because Inheritance from two classes. Inlined errMsg, uploadType, addDropTarget, createXhr, upload
