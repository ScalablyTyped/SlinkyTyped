package typingsSlinky.dojo.dojox.geo.openlayers._base
...
/**
  ...
  */
@JSGlobal("dojox.geo.openlayers._base.TouchInteractionSupport")
@js.native
class TouchInteractionSupport protected () extends js.Object {
  def this(map: typingsSlinky.dojo.dojox.geo.openlayers.Map) = this()
}
