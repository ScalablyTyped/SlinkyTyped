...
- typingsSlinky.dojo.dojox.mvc.atBindingMixin because Inheritance from two classes. Inlined `data-mvc-bindings`, dataBindAttr, mixin */ @JSGlobal("dojox.mvc._Controller")
@js.native
