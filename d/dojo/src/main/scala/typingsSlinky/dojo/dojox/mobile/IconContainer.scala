...
import typingsSlinky.dojo.dojoStrings.defaultIcon
...
import typingsSlinky.dojo.dojoStrings.iconItemPaneClass
import typingsSlinky.dojo.dojoStrings.iconItemPaneContainerClass
import typingsSlinky.dojo.dojoStrings.iconItemPaneContainerProps
import typingsSlinky.dojo.dojoStrings.iconItemPaneProps
import typingsSlinky.dojo.dojoStrings.iconPos
import typingsSlinky.dojo.dojoStrings.label
import typingsSlinky.dojo.dojoStrings.pressedIconOpacity
import typingsSlinky.dojo.dojoStrings.single
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.IconContainer")
@js.native
