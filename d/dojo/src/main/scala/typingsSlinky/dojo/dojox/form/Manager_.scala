...
- typingsSlinky.dojo.dojox.form.manager.ValueMixin because Inheritance from two classes. Inlined elementValue, gatherFormValues, setFormValues
- typingsSlinky.dojo.dojox.form.manager.FormMixin because Inheritance from two classes. Inlined accept, `accept-charset`, action, encType, method, name, target, reset, submit, validate, onReset, onSubmit
- typingsSlinky.dojo.dojox.form.manager.NodeMixin because Inheritance from two classes. Inlined formNodeValue, formNodeValue, formNodeValue, inspectFormNodes, registerNode, registerNode, registerNodeDescendants, registerNodeDescendants, unregisterNode, unregisterNodeDescendants, unregisterNodeDescendants
...
- typingsSlinky.dojo.dijit.AttachMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, buildRendering, destroyRendering
- typingsSlinky.dojo.dijit.WidgetsInTemplateMixin because Inheritance from two classes. Inlined contextRequire, widgetsInTemplate, startup */ @JSGlobal("dojox.form.Manager")
@js.native
