...
- typingsSlinky.dojo.dojox.data.util.JsonQuery because Inheritance from two classes. Inlined jsonQueryPagination, useFullIdInQueries, clientSideFetch, fetch, isUpdateable, matchesQuery, querySuperSet */ @JSGlobal("dojox.data.JsonQueryRestStore")
@js.native
