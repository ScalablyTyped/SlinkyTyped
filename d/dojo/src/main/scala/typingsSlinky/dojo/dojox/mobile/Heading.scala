...
import typingsSlinky.dojo.dojoStrings.busy
...
import typingsSlinky.dojo.dojoStrings.progStyle
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.Heading")
@js.native
