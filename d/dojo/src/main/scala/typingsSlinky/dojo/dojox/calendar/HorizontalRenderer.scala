...
import typingsSlinky.dojo.dojoStrings.arrowPadding
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calendar.HorizontalRenderer")
@js.native
class HorizontalRenderer () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_HorizontalRenderer: String = js.native
  /**
