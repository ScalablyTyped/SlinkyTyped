...
import typingsSlinky.dojo.dojoStrings.parseOnLoad
import typingsSlinky.dojo.dojoStrings.prog
...
- typingsSlinky.dojo.dojox.mobile.ExecScriptMixin because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dojox.mobile.ContentPaneMixin because Inheritance from two classes. Inlined content, executeScripts, href, `lazy`, parseOnLoad, prog, errorHandler, execScript, load, loadHandler, onLoad */ @JSGlobal("dojox.mobile.ContentPane")
@js.native
