...
/**
  ...
  */
@js.native
trait silverlightAttach extends js.Object {
  /**
    *
    */
...
object silverlightAttach {
  ...
  def apply(
    ...
    __obj.asInstanceOf[silverlightAttach]
  }
  @scala.inline
  implicit class silverlightAttachOps[Self <: silverlightAttach] (val x: Self) extends AnyVal {
    @scala.inline
