...
/**
  ...
  */
@JSGlobal("dojox.geo.openlayers.GeometryFeature")
@js.native
class GeometryFeature protected () extends Feature {
  ...
  /**
    ...
    */
  def createShape(s: Surface, g: Geometry): js.Any = js.native
  /**
