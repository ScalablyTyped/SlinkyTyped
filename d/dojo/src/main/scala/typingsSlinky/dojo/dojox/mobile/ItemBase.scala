...
import typingsSlinky.dojo.dojoStrings.back
import typingsSlinky.dojo.dojoStrings.callback
import typingsSlinky.dojo.dojoStrings.clickable
import typingsSlinky.dojo.dojoStrings.href
import typingsSlinky.dojo.dojoStrings.hrefTarget
import typingsSlinky.dojo.dojoStrings.icon
import typingsSlinky.dojo.dojoStrings.iconPos
import typingsSlinky.dojo.dojoStrings.label
import typingsSlinky.dojo.dojoStrings.moveTo
import typingsSlinky.dojo.dojoStrings.paramsToInherit
import typingsSlinky.dojo.dojoStrings.scene
...
import typingsSlinky.dojo.dojoStrings.toggle
import typingsSlinky.dojo.dojoStrings.transitionDir
import typingsSlinky.dojo.dojoStrings.transitionOptions
import typingsSlinky.dojo.dojoStrings.url
import typingsSlinky.dojo.dojoStrings.urlTarget
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile._ItemBase")
@js.native
class ItemBase () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_ItemBase: String = js.native
  /**
  ...
  /**
    ...
    * @param e
    */
  def defaultClickAction(e: Event_): Unit = js.native
  /**
  ...
  @JSName("get")
  def get_transition(property: typingsSlinky.dojo.dojoStrings.transition): String = js.native
  @JSName("get")
  ...
  /**
    ...
    * @param e
    */
  def handleSelection(e: Event_): Unit = js.native
  /**
  ...
  /**
    ...
    * @param e
    */
  def makeTransition(e: Event_): Unit = js.native
  /**
  ...
  @JSName("set")
  def set_transition(property: typingsSlinky.dojo.dojoStrings.transition, value: String): Unit = js.native
  @JSName("set")
  ...
  /**
    ...
    * @param e
    */
  def userClickAction(e: Event_): Unit = js.native
  @JSName("watch")
  def watch_alt(
    property: alt,
  ...
  @JSName("watch")
  def watch_paramsToInherit(
    property: paramsToInherit,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
      /* oldValue */ js.UndefOr[String], 
      /* newValue */ js.UndefOr[String], 
  ...
  def watch_transition(
    property: typingsSlinky.dojo.dojoStrings.transition,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
      /* oldValue */ js.UndefOr[String], 
      /* newValue */ js.UndefOr[String], 
  ...
  @JSName("watch")
  def watch_transitionDir(
    property: transitionDir,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
