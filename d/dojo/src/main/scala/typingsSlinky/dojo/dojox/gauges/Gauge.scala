...
import typingsSlinky.dojo.dojoStrings.background
import typingsSlinky.dojo.dojoStrings.defaultColors
...
import typingsSlinky.dojo.dojoStrings.surface
import typingsSlinky.dojo.dojoStrings.useRangeStyles
import typingsSlinky.dojo.dojoStrings.useTooltip
