...
import typingsSlinky.dojo.dojoStrings.hourSize
import typingsSlinky.dojo.dojoStrings.maxHours
import typingsSlinky.dojo.dojoStrings.minColumnWidth
import typingsSlinky.dojo.dojoStrings.minHours
import typingsSlinky.dojo.dojoStrings.percentOverlap
import typingsSlinky.dojo.dojoStrings.renderData
import typingsSlinky.dojo.dojoStrings.rowHeaderFirstLabelOffset
import typingsSlinky.dojo.dojoStrings.rowHeaderGridSlotDuration
import typingsSlinky.dojo.dojoStrings.rowHeaderLabelOffset
import typingsSlinky.dojo.dojoStrings.rowHeaderLabelSlotDuration
import typingsSlinky.dojo.dojoStrings.rowHeaderTimePattern
import typingsSlinky.dojo.dojoStrings.scrollBarRTLPosition
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.showTimeIndicator
import typingsSlinky.dojo.dojoStrings.startDate
import typingsSlinky.dojo.dojoStrings.startTimeOfDay
import typingsSlinky.dojo.dojoStrings.styleGridCellFunc
import typingsSlinky.dojo.dojoStrings.subColumns
import typingsSlinky.dojo.dojoStrings.templatePath
import typingsSlinky.dojo.dojoStrings.templateString
import typingsSlinky.dojo.dojoStrings.timeIndicatorRefreshInterval
import typingsSlinky.dojo.dojoStrings.timeSlotDuration
