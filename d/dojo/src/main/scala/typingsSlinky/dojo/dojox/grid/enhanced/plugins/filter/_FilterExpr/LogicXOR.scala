package typingsSlinky.dojo.dojox.grid.enhanced.plugins.filter._FilterExpr
...
/**
  ...
  *
  */
@JSGlobal("dojox.grid.enhanced.plugins.filter._FilterExpr.LogicXOR")
@js.native
class LogicXOR () extends js.Object {
  /**
