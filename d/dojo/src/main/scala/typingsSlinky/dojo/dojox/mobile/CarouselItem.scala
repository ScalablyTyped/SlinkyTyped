...
import typingsSlinky.dojo.dojoStrings.footerText
import typingsSlinky.dojo.dojoStrings.headerText
import typingsSlinky.dojo.dojoStrings.src
...
- typingsSlinky.dojo.dijit.Contained because Inheritance from two classes. Inlined getIndexInParent, getNextSibling, getPreviousSibling */ @JSGlobal("dojox.mobile.CarouselItem")
@js.native
class CarouselItem () extends WidgetBase {
