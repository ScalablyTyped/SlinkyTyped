...
import typingsSlinky.dojo.dojoStrings.allDayAttr
import typingsSlinky.dojo.dojoStrings.allowResizeLessThan24H
import typingsSlinky.dojo.dojoStrings.allowStartEndSwap
import typingsSlinky.dojo.dojoStrings.allowSubColumnMove
import typingsSlinky.dojo.dojoStrings.autoScroll
...
import typingsSlinky.dojo.dojoStrings.decodeDate
import typingsSlinky.dojo.dojoStrings.displayedItemsInvalidated
import typingsSlinky.dojo.dojoStrings.doubleTapDelay
import typingsSlinky.dojo.dojoStrings.editable
import typingsSlinky.dojo.dojoStrings.encodeDate
import typingsSlinky.dojo.dojoStrings.endTimeAttr
import typingsSlinky.dojo.dojoStrings.formatItemTimeFunc
import typingsSlinky.dojo.dojoStrings.hoveredItem
import typingsSlinky.dojo.dojoStrings.invalidRendering
import typingsSlinky.dojo.dojoStrings.invalidatingProperties
import typingsSlinky.dojo.dojoStrings.itemToRenderer
import typingsSlinky.dojo.dojoStrings.itemToRendererKindFunc
import typingsSlinky.dojo.dojoStrings.layoutPriorityFunction
import typingsSlinky.dojo.dojoStrings.liveLayout
import typingsSlinky.dojo.dojoStrings.minDurationSteps
import typingsSlinky.dojo.dojoStrings.minDurationUnit
import typingsSlinky.dojo.dojoStrings.moveEnabled
import typingsSlinky.dojo.dojoStrings.query
import typingsSlinky.dojo.dojoStrings.queryOptions
import typingsSlinky.dojo.dojoStrings.rendererList
import typingsSlinky.dojo.dojoStrings.rendererPool
import typingsSlinky.dojo.dojoStrings.resizeCursor
import typingsSlinky.dojo.dojoStrings.resizeEnabled
import typingsSlinky.dojo.dojoStrings.scrollMethod
import typingsSlinky.dojo.dojoStrings.scrollable
import typingsSlinky.dojo.dojoStrings.selectedItem
import typingsSlinky.dojo.dojoStrings.selectedItems
import typingsSlinky.dojo.dojoStrings.selectionMode
import typingsSlinky.dojo.dojoStrings.snapSteps
import typingsSlinky.dojo.dojoStrings.snapUnit
import typingsSlinky.dojo.dojoStrings.startTimeAttr
import typingsSlinky.dojo.dojoStrings.stayInView
import typingsSlinky.dojo.dojoStrings.store
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.subColumnAttr
import typingsSlinky.dojo.dojoStrings.summaryAttr
import typingsSlinky.dojo.dojoStrings.viewKind
...
class ViewBase protected () extends WidgetBase {
  ...
  /**
    ...
    */
  def computeProjectionOnDate(renderData: js.Object, refDate: js.Date, date: js.Array[js.Date], max: Double): js.Any = js.native
  /**
    ...
    */
  def computeRangeOverlap(
    renderData: js.Object,
    start1: js.Date,
    end1: js.Date,
    start2: js.Date,
    end2: js.Date,
  ...
  /**
    ...
    */
  def createItemFunc(view: ViewBase, d: js.Date, e: MouseEvent): Unit = js.native
  ...
  /**
    ...
    */
  def ensureVisibility(start: js.Date, end: js.Date, margin: Double, visibilityTarget: String, duration: Double): Unit = js.native
  /**
    ...
    */
  def floorDate(date: js.Date, unit: String, steps: Double, reuse: Boolean): js.Any = js.native
  /**
    ...
    * @param reuse Whether use the specified instance or create a new one. Default is false.
    */
  def floorToDay(date: js.Date, reuse: Boolean): js.Any = js.native
  /**
    ...
    * @param reuse Whether use the specified instance or create a new one. Default is false.
    */
  def floorToMonth(date: js.Date, reuse: Boolean): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def getSubColumn(e: Event_, x: Double, y: Double, touchIndex: Double): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param touchIndex If parameter 'e' is not null and a touch event, the index of the touch to use.
    */
  def getTime(e: Event_, x: Double, y: Double, touchIndex: Double): js.Any = js.native
  /**
    ...
    */
  def getWeekNumberLabel(date: js.Date): js.Any = js.native
  @JSName("get")
  ...
  /**
    ...
    */
  def isSameDay(date1: js.Date, date2: js.Date): js.Any = js.native
  /**
    * Tests if the specified date represents the starts of day.
    *
    * @param d The date to test.
    */
  def isStartOfDay(d: js.Date): js.Any = js.native
  /**
    * Returns whether the specified date is in the current day.
    *
    * @param date The date to test.
    */
  def isToday(date: js.Date): js.Any = js.native
  /**
    ...
    * @param date The date to test.
    */
  def isWeekEnd(date: js.Date): js.Any = js.native
  /**
