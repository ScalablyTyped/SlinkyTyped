...
- typings.dojo.dojox.widget._CalendarYear because Inheritance from two classes. Inlined parent */ @JSGlobal("dojox.widget.YearlyCalendar")
@js.native
class YearlyCalendar () extends _CalendarBase {
  /**
    *
    */
