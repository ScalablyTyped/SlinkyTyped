...
class Map protected () extends js.Object {
  ...
  /**
    ...
    */
  def addLayer(layer: typingsSlinky.dojo.dojox.geo.openlayers.Layer): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def layerIndex(layer: typingsSlinky.dojo.dojox.geo.openlayers.Layer, index: Double): js.Any = js.native
  /**
    * Remove the specified layer from the map.
    *
    * @param layer The layer to remove from the map.
    */
  def removeLayer(layer: typingsSlinky.dojo.dojox.geo.openlayers.Layer): Unit = js.native
  /**
    * Set the base layer type, replacing the existing base layer
    *
    * @param type base layer type
    */
  def setBaseLayerType(`type`: typingsSlinky.dojo.dojox.geo.openlayers.Layer): js.Any = js.native
  /**
