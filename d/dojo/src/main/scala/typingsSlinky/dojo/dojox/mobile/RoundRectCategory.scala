...
- typingsSlinky.dojo.dijit.Contained because Inheritance from two classes. Inlined getIndexInParent, getNextSibling, getPreviousSibling */ @JSGlobal("dojox.mobile.RoundRectCategory")
@js.native
class RoundRectCategory () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_RoundRectCategory: String = js.native
  /**
