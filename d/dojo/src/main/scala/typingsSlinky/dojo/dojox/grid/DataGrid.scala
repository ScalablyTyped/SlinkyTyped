...
import typingsSlinky.dojo.dojoStrings.fetchText
import typingsSlinky.dojo.dojoStrings.items
import typingsSlinky.dojo.dojoStrings.keepSelection
import typingsSlinky.dojo.dojoStrings.query
import typingsSlinky.dojo.dojoStrings.queryOptions
import typingsSlinky.dojo.dojoStrings.sortFields
import typingsSlinky.dojo.dojoStrings.store
import typingsSlinky.dojo.dojoStrings.updateDelay
