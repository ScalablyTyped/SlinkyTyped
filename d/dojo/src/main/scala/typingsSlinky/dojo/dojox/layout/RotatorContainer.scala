...
import typingsSlinky.dojo.dojoStrings.autoStart
import typingsSlinky.dojo.dojoStrings.contextRequire
import typingsSlinky.dojo.dojoStrings.cycles
import typingsSlinky.dojo.dojoStrings.pagerClass
import typingsSlinky.dojo.dojoStrings.pagerId
import typingsSlinky.dojo.dojoStrings.pauseOnManualChange
import typingsSlinky.dojo.dojoStrings.reverse
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.showTabs
import typingsSlinky.dojo.dojoStrings.suspendOnHover
import typingsSlinky.dojo.dojoStrings.templatePath
import typingsSlinky.dojo.dojoStrings.templateString
import typingsSlinky.dojo.dojoStrings.transition
import typingsSlinky.dojo.dojoStrings.transitionDelay
import typingsSlinky.dojo.dojoStrings.transitionDuration
...
- typingsSlinky.dojo.dijit.Templated because Inheritance from two classes. Inlined attachScope, contextRequire, searchContainerNode, templatePath, templateString, widgetsInTemplate, buildRendering, destroyRendering, startup, getCachedTemplate */ @JSGlobal("dojox.layout.RotatorContainer")
@js.native
