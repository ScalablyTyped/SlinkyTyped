...
/**
  ...
  */
@JSGlobal("dojox.geo.openlayers.Layer")
@js.native
class Layer protected () extends js.Object {
  ...
  /**
    ...
    */
  def addFeature(f: js.Array[Feature]): Unit = js.native
  /**
    * Add a feature or an array of features to the layer.
    *
    * @param f The Feature or array of features to add.
    */
  def addFeature(f: Feature): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeFeature(f: js.Array[Feature]): Unit = js.native
  /**
    * Removes a feature or an array of features from the layer.
    *
    * @param f The Feature or array of features to remove.
    */
  def removeFeature(f: Feature): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def renderFeature(f: Feature): Unit = js.native
}
