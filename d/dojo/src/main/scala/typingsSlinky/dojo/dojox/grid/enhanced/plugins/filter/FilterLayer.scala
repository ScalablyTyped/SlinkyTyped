...
import typingsSlinky.dojo.dojox.grid.enhanced.plugins._StoreLayer._StoreLayer
...
/**
  ...
  *
  */
trait FilterLayer extends js.Object {
  /**
    *
    */
...
@js.native
object FilterLayer extends js.Object {
  /**
  ...
  class ClientSideFilterLayer protected () extends js.Object {
    ...
    /**
      ...
      * @param filter               Optional
      */
    def filterDef(filter: _ConditionExpr): js.Any = js.native
    /**
      *
      * @param store
      */
  ...
  class ServerSideFilterLayer protected () extends js.Object {
    ...
    /**
      ...
      * @param error
      */
    def onCommandError(error: js.Error): Unit = js.native
    /**
