...
import typingsSlinky.dojo.dojoStrings.footerFormat
...
import typingsSlinky.dojo.dojoStrings.useFx
...
class _CalendarBase () extends _WidgetBase {
  ...
  /**
    ...
    * @param locale               Optional
    */
  def isDisabledDate(date: js.Date, locale: String): js.Any = js.native
  /**
  ...
  @JSName("watch")
  def watch_footerFormat(
    property: footerFormat,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
