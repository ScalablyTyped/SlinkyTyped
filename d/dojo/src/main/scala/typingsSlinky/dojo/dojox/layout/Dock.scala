...
import typingsSlinky.dojo.dojoStrings.autoPosition
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.layout.Dock")
@js.native
class Dock () extends WidgetBase {
  ...
  /**
    *
    */
  var autoPosition: Boolean = js.native
  /**
    *
    */
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Dock: String = js.native
  /**
  ...
  /**
    ...
    * @param refNode
    */
  def addNode(refNode: js.Any): js.Any = js.native
  /**
  ...
  @JSName("get")
  def get_autoPosition(property: autoPosition): Boolean = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_autoPosition(property: autoPosition, value: Boolean): Unit = js.native
  @JSName("set")
