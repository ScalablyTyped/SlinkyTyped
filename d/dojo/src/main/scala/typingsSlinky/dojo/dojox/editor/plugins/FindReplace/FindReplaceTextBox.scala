package typingsSlinky.dojo.dojox.editor.plugins.FindReplace
...
import typingsSlinky.dojo.dojoStrings.textId
import typingsSlinky.dojo.dojoStrings.toolTip
import typingsSlinky.dojo.dojoStrings.widget
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.FindReplace._FindReplaceTextBox")
@js.native
class FindReplaceTextBox () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_FindReplaceTextBox: String = js.native
  /**
