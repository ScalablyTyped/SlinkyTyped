package typingsSlinky.dojo.dojox.editor.plugins.CollapsibleToolbar
...
import typingsSlinky.dojo.dojoStrings.buttonClass
...
import typingsSlinky.dojo.dojoStrings.textClass
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.CollapsibleToolbar._CollapsibleToolbarButton")
@js.native
class CollapsibleToolbarButton () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_CollapsibleToolbarButton: String = js.native
  /**
