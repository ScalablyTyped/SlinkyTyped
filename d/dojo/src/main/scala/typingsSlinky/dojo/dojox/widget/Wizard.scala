...
import typingsSlinky.dojo.dojoStrings.cancelButtonLabel
import typingsSlinky.dojo.dojoStrings.cancelFunction
import typingsSlinky.dojo.dojoStrings.contextRequire
import typingsSlinky.dojo.dojoStrings.doneButtonLabel
import typingsSlinky.dojo.dojoStrings.hideDisabled
import typingsSlinky.dojo.dojoStrings.nextButtonLabel
import typingsSlinky.dojo.dojoStrings.previousButtonLabel
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Wizard")
@js.native
