...
trait matrix extends js.Object {
  ...
  /**
    ...
    */
  def cameraTranslate(a: js.Object, b: Double, c: Double): js.Any = js.native
  /**
    * forms a translation matrix
    * The resulting matrix is used to translate (move) points by specified offsets.
    *
  ...
  /**
    ...
    */
  def clone(matrix: js.Object): js.Any = js.native
  /**
    * inverts a 2D matrix
    *
    * @param matrix a 3D matrix object to be applied
    */
  def invert(matrix: js.Object): js.Any = js.native
  /**
    * combines matrices by multiplying them sequentially in the given order
    *
    * @param matrix a 3D matrix object to be applied
    */
  def multiply(matrix: js.Object): js.Any = js.native
  /**
    ...
    */
  def multiplyPoint(matrix: js.Object, a: js.Object, b: Double, c: Double): js.Any = js.native
  /**
    * applies a matrix to a point
    *
    * @param matrix a 3D matrix object to be applied
    ...
    * @param c               Optionala z coordinate of a point
    */
  def multiplyPoint(matrix: js.Object, a: Double, b: Double, c: Double): js.Any = js.native
  /**
    ...
    */
  def normalize(matrix: js.Object): js.Any = js.native
  /**
    * applies a matrix to a point
    *
    * @param matrix a 3D matrix object to be applied
    ...
    * @param c               Optionala z coordinate of a point
    */
  def project(matrix: js.Object, a: Double, b: Double, c: Double): js.Any = js.native
  /**
    * applies a matrix to a point
    *
    * @param matrix a 3D matrix object to be applied
    ...
    * @param c               Optionala z coordinate of a point
    */
  def project(matrix: js.Object, a: Point, b: Double, c: Double): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def scale(a: js.Object, b: Double, c: Double): js.Any = js.native
  /**
    * forms a scaling matrix
    * The resulting matrix is used to scale (magnify) points by specified offsets.
    *
  ...
  /**
    ...
    * @param c               Optionala z coordinate value
    */
  def translate(a: js.Object, b: Double, c: Double): js.Any = js.native
  /**
    * forms a translation matrix
    * The resulting matrix is used to translate (move) points by specified offsets.
    *
...
object matrix extends js.Object {
  /**
    ...
    */
  @js.native
  class Matrix3D protected () extends js.Object {
