...
import typingsSlinky.dojo.dojoStrings.deferredUploading
import typingsSlinky.dojo.dojoStrings.devMode
import typingsSlinky.dojo.dojoStrings.disabled
import typingsSlinky.dojo.dojoStrings.errMsg
import typingsSlinky.dojo.dojoStrings.flashFieldName
import typingsSlinky.dojo.dojoStrings.focusedClass
import typingsSlinky.dojo.dojoStrings.force
import typingsSlinky.dojo.dojoStrings.hovering
import typingsSlinky.dojo.dojoStrings.iconClass
import typingsSlinky.dojo.dojoStrings.intermediateChanges
import typingsSlinky.dojo.dojoStrings.isDebug
import typingsSlinky.dojo.dojoStrings.label
import typingsSlinky.dojo.dojoStrings.multiple
import typingsSlinky.dojo.dojoStrings.name
import typingsSlinky.dojo.dojoStrings.preventCache
import typingsSlinky.dojo.dojoStrings.scrollOnFocus
import typingsSlinky.dojo.dojoStrings.serverTimeout
import typingsSlinky.dojo.dojoStrings.showInput
import typingsSlinky.dojo.dojoStrings.showLabel
import typingsSlinky.dojo.dojoStrings.skipServerCheck
import typingsSlinky.dojo.dojoStrings.swfPath
import typingsSlinky.dojo.dojoStrings.tabIndex
import typingsSlinky.dojo.dojoStrings.uploadOnSelect
import typingsSlinky.dojo.dojoStrings.uploadType
import typingsSlinky.dojo.dojoStrings.url
import typingsSlinky.dojo.dojoStrings.value
import typingsSlinky.dojo.dojox.form.uploader._Base
...
- typings.dojo.dijit._AttachMixin because Already inherited
- typings.dojo.dijit._FocusMixin because Already inherited
- typings.dojo.dijit._OnDijitClickMixin because Already inherited
...
- typings.dojo.dijit._TemplatedMixin because Already inherited
- typings.dojo.dijit._Widget because Already inherited
- typings.dojo.dijit.form._ButtonMixin because Inheritance from two classes. Inlined 
- typings.dojo.dijit.form._FormWidget because Inheritance from two classes. Inlined create
- typings.dojo.dojox.form.uploader._Flash because Inheritance from two classes. Inlined deferredUploading, devMode, isDebug, preventCache, serverTimeout, skipServerCheck, swfPath, flashReset, getFlashFileList, onFileChange, onFileProgress, onLoad, onReady
- typings.dojo.dojox.form.uploader._IFrame because Inheritance from two classes. Inlined uploadIFrame
