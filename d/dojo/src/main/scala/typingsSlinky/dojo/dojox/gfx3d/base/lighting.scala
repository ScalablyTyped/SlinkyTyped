...
trait lighting extends js.Object {
  ...
  /**
    ...
    * @param b
    */
  def add(a: js.Any, b: js.Any): Object
  /**
    *
    * @param a
    * @param b
    */
  def addColor(a: js.Any, b: js.Any): Object
  /**
    *
    */
  def black(): Object
  ...
  /**
    ...
    * @param b
    */
  def multiplyColor(a: js.Any, b: js.Any): Object
  /**
    *
    * @param v
    */
  ...
  /**
    ...
    * @param c
    */
  def saturateColor(c: js.Any): Object
  /**
    *
    * @param s
    * @param v
    */
  def scale(s: js.Any, v: js.Any): Object
  /**
    *
    * @param s
    * @param c
    */
  def scaleColor(s: js.Any, c: js.Any): Object
  /**
    *
    * @param normal
    * @param v
  ...
  /**
    ...
    * @param c
    */
  def toStdColor(c: js.Any): Object
  /**
    *
    */
  def white(): Object
