...
class GeometryFeature protected ()
  ...
  def this(geometry: typingsSlinky.dojo.dojox.geo.openlayers.Geometry) = this()
  /**
    ...
    */
  def createShape(s: Surface, g: typingsSlinky.dojo.dojox.geo.openlayers.Geometry): js.Any = js.native
  /**
  ...
  def render(g: typingsSlinky.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a geometry collection.
    *
    * @param g               OptionalThe geometry to render.
    */
  def renderCollection(g: typingsSlinky.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a line string geometry.
    *
    * @param g               OptionalThe geometry to render.
    */
  def renderLineString(g: typingsSlinky.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a point geometry.
    *
    * @param g               OptionalThe geometry to render, or the current instance geometry if not specified.
    */
  def renderPoint(g: typingsSlinky.dojo.dojox.geo.openlayers.Point): Unit = js.native
  /**
