...
import typingsSlinky.dojo.dojoStrings.headerClass
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.useHeader
...
@js.native
class CalendarView () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_CalendarView: String = js.native
  /**
    *
    */
