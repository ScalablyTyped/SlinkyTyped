package typingsSlinky.dojo.dojox.editor.plugins.SpellCheck
...
- typingsSlinky.dojo.dijit.Templated because Inheritance from two classes. Inlined attachScope, contextRequire, searchContainerNode, templatePath, templateString, widgetsInTemplate, buildRendering, destroyRendering, startup, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.SpellCheck._SpellCheckControl")
@js.native
