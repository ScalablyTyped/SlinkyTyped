...
package object mobile {
  type Accordion = typingsSlinky.dojo.dojox.mobile.Accordion_
  type Carousel = typingsSlinky.dojo.dojox.mobile.Carousel_
  /**
  ...
  type ListItem = typingsSlinky.dojo.dojox.mobile.ListItem_
  /**
  ...
  type i18n = typingsSlinky.dojo.dojox.mobile.i18n_
  /**
  ...
  type viewRegistry = typingsSlinky.dojo.dojox.mobile.viewRegistry_
}
