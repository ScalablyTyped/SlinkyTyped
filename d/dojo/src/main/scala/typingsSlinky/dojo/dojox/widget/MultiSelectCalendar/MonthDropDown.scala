package typingsSlinky.dojo.dojox.widget.MultiSelectCalendar
...
import typingsSlinky.dojo.dojoStrings.months
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.MultiSelectCalendar._MonthDropDown")
@js.native
