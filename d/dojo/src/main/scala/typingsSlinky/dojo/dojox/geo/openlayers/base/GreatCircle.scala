...
trait GreatCircle extends js.Object {
  ...
  def toGeometryFeature(
    p1: typingsSlinky.dojo.dojox.geo.openlayers.Point,
    p2: typingsSlinky.dojo.dojox.geo.openlayers.Point,
    increment: Double
  ): js.Any = js.native
  /**
...
object GreatCircle {
  ...
  def apply(
    ...
    RAD2DEG: Double,
    TOLERANCE: Double,
    toGeometryFeature: (typingsSlinky.dojo.dojox.geo.openlayers.Point, typingsSlinky.dojo.dojox.geo.openlayers.Point, Double) => js.Any,
    toLineString: (typingsSlinky.dojo.dojox.geo.openlayers.Point, typingsSlinky.dojo.dojox.geo.openlayers.Point, Double) => js.Any,
    toPointArray: (typingsSlinky.dojo.dojox.geo.openlayers.Point, typingsSlinky.dojo.dojox.geo.openlayers.Point, Double) => js.Array[_]
  ): GreatCircle = {
  ...
  implicit class GreatCircleOps[Self <: GreatCircle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withToGeometryFeature(
      value: (typingsSlinky.dojo.dojox.geo.openlayers.Point, typingsSlinky.dojo.dojox.geo.openlayers.Point, Double) => js.Any
    ): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withToPointArray(
      value: (typingsSlinky.dojo.dojox.geo.openlayers.Point, typingsSlinky.dojo.dojox.geo.openlayers.Point, Double) => js.Array[_]
    ): Self = {
        val ret = this.duplicate
