...
import typingsSlinky.dojo.dojoStrings.displayedValue
import typingsSlinky.dojo.dojoStrings.intermediateChanges
import typingsSlinky.dojo.dojoStrings.lowercase
import typingsSlinky.dojo.dojoStrings.maxLength
import typingsSlinky.dojo.dojoStrings.name
import typingsSlinky.dojo.dojoStrings.placeHolder
import typingsSlinky.dojo.dojoStrings.propercase
import typingsSlinky.dojo.dojoStrings.readOnly
import typingsSlinky.dojo.dojoStrings.scrollOnFocus
import typingsSlinky.dojo.dojoStrings.selectOnClick
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.tabIndex
import typingsSlinky.dojo.dojoStrings.trim
import typingsSlinky.dojo.dojoStrings.uppercase
...
- typingsSlinky.dojo.dijit.form.TextBoxMixin because Inheritance from two classes. Inlined displayedValue, lowercase, maxLength, placeHolder, propercase, selectOnClick, trim, uppercase, filter, format, parse, selectInputText, onInput
- typingsSlinky.dojo.dijit.form.FormValueMixin because Inheritance from two classes. Inlined alt, `aria-label`, disabled, intermediateChanges, name, readOnly, scrollOnFocus, tabIndex, `type`, value, compare, create, destroy, focus, isFocusable, postCreate, reset, undo, onChange */ @JSGlobal("dojox.mobile.TextBox")
@js.native
