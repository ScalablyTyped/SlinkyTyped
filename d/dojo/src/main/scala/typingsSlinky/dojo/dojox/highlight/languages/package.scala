package typingsSlinky.dojo.dojox.highlight
...
package object languages {
  type cpp = typingsSlinky.dojo.dojox.highlight.languages.cpp_
  type css = typingsSlinky.dojo.dojox.highlight.languages.css_
  type delphi = typingsSlinky.dojo.dojox.highlight.languages.delphi_
  ...
  type xml = typingsSlinky.dojo.dojox.highlight.languages.xml_
  type xquery = typingsSlinky.dojo.dojox.highlight.languages.xquery_
}
