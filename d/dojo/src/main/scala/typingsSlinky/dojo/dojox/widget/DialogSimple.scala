...
import typingsSlinky.dojo.dojoStrings.draggable
import typingsSlinky.dojo.dojoStrings.duration
import typingsSlinky.dojo.dojoStrings.hovering
import typingsSlinky.dojo.dojoStrings.maxRatio
import typingsSlinky.dojo.dojoStrings.open
import typingsSlinky.dojo.dojoStrings.refocus
...
import typingsSlinky.dojo.dojox.layout.ContentPane
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.DialogSimple")
@js.native
