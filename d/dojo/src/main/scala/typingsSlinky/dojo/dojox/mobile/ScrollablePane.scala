...
import typingsSlinky.dojo.dojoStrings.dirLock
import typingsSlinky.dojo.dojoStrings.disableFlashScrollBar
import typingsSlinky.dojo.dojoStrings.fadeScrollBar
import typingsSlinky.dojo.dojoStrings.fixedFooter
import typingsSlinky.dojo.dojoStrings.fixedFooterHeight
import typingsSlinky.dojo.dojoStrings.fixedHeader
import typingsSlinky.dojo.dojoStrings.fixedHeaderHeight
import typingsSlinky.dojo.dojoStrings.height
import typingsSlinky.dojo.dojoStrings.isLocalFooter
import typingsSlinky.dojo.dojoStrings.propagatable
import typingsSlinky.dojo.dojoStrings.radius
import typingsSlinky.dojo.dojoStrings.roundCornerMask
import typingsSlinky.dojo.dojoStrings.scrollBar
import typingsSlinky.dojo.dojoStrings.scrollDir
import typingsSlinky.dojo.dojoStrings.scrollType
import typingsSlinky.dojo.dojoStrings.scrollableParams
...
class ScrollablePane () extends Pane {
  ...
  /**
    ...
    *
    */
  var roundCornerMask: Boolean = js.native
  /**
  ...
  /**
    ...
    *
    */
  def createRoundMask(): Unit = js.native
  /**
  ...
  @JSName("get")
  def get_roundCornerMask(property: roundCornerMask): Boolean = js.native
  @JSName("get")
  ...
  def isTopLevel(e: js.Any): Boolean = js.native
  /**
  ...
  @JSName("set")
  def set_roundCornerMask(property: roundCornerMask, value: Boolean): Unit = js.native
  @JSName("set")
