...
import typingsSlinky.dojo.dojoStrings.defaultType
import typingsSlinky.dojo.dojoStrings.duration
import typingsSlinky.dojo.dojoStrings.messageTopic
import typingsSlinky.dojo.dojoStrings.messageTypes
import typingsSlinky.dojo.dojoStrings.positionDirection
import typingsSlinky.dojo.dojoStrings.positionDirectionTypes
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.separator
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Toaster")
@js.native
class Toaster () extends WidgetBase {
  ...
  /**
    ...
    * @param e
    */
  def onSelect(e: Event_): Unit = js.native
  /**
