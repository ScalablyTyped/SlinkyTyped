...
- typingsSlinky.dojo.dijit.form.ExpandingTextAreaMixin because Inheritance from two classes. Inlined postCreate, resize, startup */ @JSGlobal("dojox.mobile.ExpandingTextArea")
@js.native
