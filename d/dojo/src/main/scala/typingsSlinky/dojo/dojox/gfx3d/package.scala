...
package object gfx3d {
  type base = typingsSlinky.dojo.dojox.gfx3d.base_
  /**
  ...
  type gradient = js.Function7[
    /* model */ typingsSlinky.dojo.dojox.gfx3d.lighting.Model, 
    /* material */ js.Object, 
    /* center */ js.Object, 
    /* radius */ scala.Double, 
    /* from */ scala.Double, 
  ...
  type lighting = typingsSlinky.dojo.dojox.gfx3d.lighting_
  type scheduler = typingsSlinky.dojo.dojox.gfx3d.scheduler_
}
