...
import typingsSlinky.dojo.dojoStrings.centerIndicator
import typingsSlinky.dojo.dojoStrings.duration
import typingsSlinky.dojo.dojoStrings.imageText
...
import typingsSlinky.dojo.dojoStrings.target
import typingsSlinky.dojo.dojoStrings.templatePath
import typingsSlinky.dojo.dojoStrings.templateString
import typingsSlinky.dojo.dojoStrings.text
import typingsSlinky.dojo.dojoStrings.zIndex
...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Standby")
@js.native
class Standby () extends _Widget {
  ...
  @JSName("get")
  def get_color(property: typingsSlinky.dojo.dojoStrings.color): String = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_color(property: typingsSlinky.dojo.dojoStrings.color, value: String): Unit = js.native
  @JSName("set")
