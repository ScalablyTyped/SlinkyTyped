...
class Layer protected () extends js.Object {
  ...
  /**
    ...
    */
  def addFeature(f: js.Array[typingsSlinky.dojo.dojox.geo.openlayers.Feature]): Unit = js.native
  /**
    * Add a feature or an array of features to the layer.
    *
    * @param f The Feature or array of features to add.
    */
  def addFeature(f: typingsSlinky.dojo.dojox.geo.openlayers.Feature): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeFeature(f: js.Array[typingsSlinky.dojo.dojox.geo.openlayers.Feature]): Unit = js.native
  /**
    * Removes a feature or an array of features from the layer.
    *
    * @param f The Feature or array of features to remove.
    */
  def removeFeature(f: typingsSlinky.dojo.dojox.geo.openlayers.Feature): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def renderFeature(f: typingsSlinky.dojo.dojox.geo.openlayers.Feature): Unit = js.native
}
