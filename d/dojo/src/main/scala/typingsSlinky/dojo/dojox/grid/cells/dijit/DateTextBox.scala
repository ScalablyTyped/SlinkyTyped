package typingsSlinky.dojo.dojox.grid.cells.dijit

import typingsSlinky.dojo.dojox.grid.cells.base
...
/**
  ...
  * @param inCell
  */
@JSGlobal("dojox.grid.cells.dijit.DateTextBox")
@js.native
class DateTextBox protected () extends base {
