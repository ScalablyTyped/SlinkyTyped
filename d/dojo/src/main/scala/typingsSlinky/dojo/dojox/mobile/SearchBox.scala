...
import typingsSlinky.dojo.dojoStrings.incremental
...
- typingsSlinky.dojo.dijit.form.SearchMixin because Inheritance from two classes. Inlined fetchProperties, ignoreCase, pageSize, query, queryExpr, searchAttr, searchDelay, store, postMixInProperties, onSearch */ @JSGlobal("dojox.mobile.SearchBox")
@js.native
