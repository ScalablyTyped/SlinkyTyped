...
import typingsSlinky.dojo.dojoStrings.headerFilename
import typingsSlinky.dojo.dojoStrings.headerFilesize
import typingsSlinky.dojo.dojoStrings.headerIndex
import typingsSlinky.dojo.dojoStrings.headerType
import typingsSlinky.dojo.dojoStrings.rowAmt
import typingsSlinky.dojo.dojoStrings.uploaderId
...
class FileList () extends Base {
  ...
  @JSName("get")
  def get_uploader(property: typingsSlinky.dojo.dojoStrings.uploader): js.Object = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_uploader(property: typingsSlinky.dojo.dojoStrings.uploader, value: js.Object): Unit = js.native
  @JSName("set")
  ...
  @JSName("watch")
  def watch_uploader(
    property: typingsSlinky.dojo.dojoStrings.uploader,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
