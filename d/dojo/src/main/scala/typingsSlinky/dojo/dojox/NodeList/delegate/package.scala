package typingsSlinky.dojo.dojox.NodeList
...
package object delegate {
  /**
    ...
    * @param args
    */
  type addClassFx = js.Function2[/* cssClass */ js.Any, /* args */ js.Any, typingsSlinky.dojo.AnonType]
  /**
  ...
  /**
    ...
    * @param args
    */
  type removeClassFx = js.Function2[/* cssClass */ js.Any, /* args */ js.Any, typingsSlinky.dojo.AnonType]
  /**
  ...
  /**
    ...
    * @param args
    */
  type toggleClassFx = js.Function3[
    /* cssClass */ js.Any, 
    /* force */ js.Any, 
    /* args */ js.Any, 
    typingsSlinky.dojo.AnonType
  ]
  /**
