package typingsSlinky.dojo.dojox.grid.enhanced.plugins.filter.FilterExpr
...
/**
  ...
  *
  */
@JSGlobal("dojox.grid.enhanced.plugins.filter._FilterExpr.LargerThanOrEqualTo")
@js.native
class LargerThanOrEqualTo () extends js.Object {
  /**
