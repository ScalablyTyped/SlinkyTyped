...
import typingsSlinky.dojo.dojoStrings.animation
import typingsSlinky.dojo.dojoStrings.duration
import typingsSlinky.dojo.dojoStrings.fixedHeight
import typingsSlinky.dojo.dojoStrings.iconBase
import typingsSlinky.dojo.dojoStrings.iconPos
import typingsSlinky.dojo.dojoStrings.roundRect
import typingsSlinky.dojo.dojoStrings.singleOpen
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.Accordion")
@js.native
