...
/**
  ...
  * @param rawNode
  */
@JSGlobal("dojox.gfx.vml_attach.Polyline")
@js.native
class Polyline protected () extends js.Object {
  def this(rawNode: js.Any) = this()
  /**
    *
    */
  ...
  /**
    ...
    */
  def setShape(points: js.Array[_], closed: Boolean): js.Any = js.native
  /**
    * sets a polyline/polygon shape object (VML)
    *
    * @param points a polyline/polygon shape object, or an array of points
    * @param closed               Optionalif true, close the polyline explicitly
    */
  def setShape(points: js.Object, closed: Boolean): js.Any = js.native
  /**
