...
import typingsSlinky.dojo.dojoStrings.cellMargin
import typingsSlinky.dojo.dojoStrings.cellSize
import typingsSlinky.dojo.dojoStrings.children
import typingsSlinky.dojo.dojoStrings.cols
import typingsSlinky.dojo.dojoStrings.delay
import typingsSlinky.dojo.dojoStrings.easing
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.image.Badge")
@js.native
