...
import typingsSlinky.dojo.dojoStrings.labelGap
import typingsSlinky.dojo.dojoStrings.labelPosition
import typingsSlinky.dojo.dojoStrings.scaler
import typingsSlinky.dojo.dojoStrings.tickStroke
