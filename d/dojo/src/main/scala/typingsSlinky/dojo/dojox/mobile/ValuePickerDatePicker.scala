...
import typingsSlinky.dojo.dojoStrings.dayMinusBtnLabel
import typingsSlinky.dojo.dojoStrings.dayMinusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.dayPattern
import typingsSlinky.dojo.dojoStrings.dayPlusBtnLabel
import typingsSlinky.dojo.dojoStrings.dayPlusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.monthMinusBtnLabel
import typingsSlinky.dojo.dojoStrings.monthMinusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.monthPattern
import typingsSlinky.dojo.dojoStrings.monthPlusBtnLabel
import typingsSlinky.dojo.dojoStrings.monthPlusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.readOnly
import typingsSlinky.dojo.dojoStrings.value
import typingsSlinky.dojo.dojoStrings.yearMinusBtnLabel
import typingsSlinky.dojo.dojoStrings.yearMinusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.yearPattern
import typingsSlinky.dojo.dojoStrings.yearPlusBtnLabel
import typingsSlinky.dojo.dojoStrings.yearPlusBtnLabelRef
...
- typingsSlinky.dojo.dojox.mobile.DatePickerMixin because Inheritance from two classes. Inlined dayPattern, monthPattern, value, yearPattern, initSlots, reorderSlots, reset, onDaySet, onMonthSet, onYearSet */ @JSGlobal("dojox.mobile.ValuePickerDatePicker")
@js.native
