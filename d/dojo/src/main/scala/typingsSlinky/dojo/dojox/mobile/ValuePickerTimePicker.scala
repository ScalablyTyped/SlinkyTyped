...
import typingsSlinky.dojo.dojoStrings.hourPlusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.is24h
import typingsSlinky.dojo.dojoStrings.minuteMinusBtnLabel
import typingsSlinky.dojo.dojoStrings.minuteMinusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.minutePlusBtnLabel
import typingsSlinky.dojo.dojoStrings.minutePlusBtnLabelRef
import typingsSlinky.dojo.dojoStrings.readOnly
import typingsSlinky.dojo.dojoStrings.values12
...
- typingsSlinky.dojo.dojox.mobile.TimePickerMixin because Inheritance from two classes. Inlined date, reset */ @JSGlobal("dojox.mobile.ValuePickerTimePicker")
@js.native
