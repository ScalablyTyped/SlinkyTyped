...
import typingsSlinky.dojo.dojoStrings.majorTicksLabelPlacement
import typingsSlinky.dojo.dojoStrings.minorTicksColor
import typingsSlinky.dojo.dojoStrings.minorTicksInterval
import typingsSlinky.dojo.dojoStrings.needleColor
import typingsSlinky.dojo.dojoStrings.noChange
import typingsSlinky.dojo.dojoStrings.scalePrecision
import typingsSlinky.dojo.dojoStrings.textIndicatorColor
import typingsSlinky.dojo.dojoStrings.textIndicatorFont
import typingsSlinky.dojo.dojoStrings.textIndicatorPrecision
import typingsSlinky.dojo.dojoStrings.textIndicatorVisible
