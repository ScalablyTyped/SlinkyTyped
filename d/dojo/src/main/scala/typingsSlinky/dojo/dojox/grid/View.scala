...
import typingsSlinky.dojo.dojoStrings.classTag
import typingsSlinky.dojo.dojoStrings.defaultWidth
import typingsSlinky.dojo.dojoStrings.firstScroll
import typingsSlinky.dojo.dojoStrings.lastTop
import typingsSlinky.dojo.dojoStrings.marginBottom
import typingsSlinky.dojo.dojoStrings.rowPad
...
import typingsSlinky.dojo.dojoStrings.viewWidth
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.grid._View")
@js.native
