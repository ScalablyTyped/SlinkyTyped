...
import typingsSlinky.dojo.dojoStrings.shadowOffset
import typingsSlinky.dojo.dojoStrings.shadowPng
import typingsSlinky.dojo.dojoStrings.shadowThickness
...
class Shadow () extends _Widget {
  ...
  @JSName("set")
  def set_style(property: typingsSlinky.dojo.dojoStrings.style, value: String): Unit = js.native
  @JSName("watch")
  def watch_animate(
    property: animate,
