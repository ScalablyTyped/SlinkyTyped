...
object Bind extends js.Object {
  ...
  @js.native
  class Generate ()
    extends typingsSlinky.dojo.dojox.mvc._Container {
    def this(params: js.Object) = this()
    def this(params: js.Object, srcNodeRef: HTMLElement) = this()
    /**
  ...
  class ModelRefController ()
    extends typingsSlinky.dojo.dojox.mvc._Controller {
    /**
      * The data model.
      *
      */
  ...
  class _Controller () extends Stateful {
    ...
    def postscript(params: js.Object, srcNodeRef: typingsSlinky.std.HTMLElement): js.Any = js.native
    /**
