...
import typingsSlinky.dojo.dojoStrings.activeResize
import typingsSlinky.dojo.dojoStrings.activeResizeClass
import typingsSlinky.dojo.dojoStrings.animateDuration
import typingsSlinky.dojo.dojoStrings.animateMethod
import typingsSlinky.dojo.dojoStrings.animateSizing
import typingsSlinky.dojo.dojoStrings.attachScope
import typingsSlinky.dojo.dojoStrings.constrainMax
import typingsSlinky.dojo.dojoStrings.endTopic
import typingsSlinky.dojo.dojoStrings.fixedAspect
import typingsSlinky.dojo.dojoStrings.intermediateChanges
import typingsSlinky.dojo.dojoStrings.maxHeight
import typingsSlinky.dojo.dojoStrings.maxWidth
import typingsSlinky.dojo.dojoStrings.minHeight
import typingsSlinky.dojo.dojoStrings.minWidth
import typingsSlinky.dojo.dojoStrings.resizeAxis
import typingsSlinky.dojo.dojoStrings.searchContainerNode
import typingsSlinky.dojo.dojoStrings.startTopic
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.targetContainer
import typingsSlinky.dojo.dojoStrings.targetId
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.layout.ResizeHandle")
@js.native
