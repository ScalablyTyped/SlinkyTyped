...
import typingsSlinky.dojo.dojoStrings.durationIn
import typingsSlinky.dojo.dojoStrings.durationOut
import typingsSlinky.dojo.dojoStrings.properties
import typingsSlinky.dojo.dojoStrings.style
import typingsSlinky.dojo.dojoStrings.units
