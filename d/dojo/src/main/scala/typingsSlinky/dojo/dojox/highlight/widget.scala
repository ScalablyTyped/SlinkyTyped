...
import typingsSlinky.dojo.dojoStrings.listType
import typingsSlinky.dojo.dojoStrings.range
...
object widget extends js.Object {
  ...
  - typingsSlinky.dojo.dijit.Templated because Inheritance from two classes. Inlined attachScope, contextRequire, searchContainerNode, templatePath, templateString, widgetsInTemplate, buildRendering, destroyRendering, startup, getCachedTemplate */ @js.native
