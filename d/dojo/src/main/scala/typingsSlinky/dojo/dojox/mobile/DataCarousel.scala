...
- typingsSlinky.dojo.dojox.mobile.DataMixin because Inheritance from two classes. Inlined query, queryOptions, store, refresh, setQuery, setQuery, setStore, setStore */ @JSGlobal("dojox.mobile.DataCarousel")
@js.native
