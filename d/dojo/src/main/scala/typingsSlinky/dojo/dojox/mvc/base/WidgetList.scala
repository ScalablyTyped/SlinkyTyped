...
import typingsSlinky.dojo.dojoStrings.`data-mvc-child-type`
import typingsSlinky.dojo.dojoStrings.childBindings
import typingsSlinky.dojo.dojoStrings.childClz
import typingsSlinky.dojo.dojoStrings.childMixins
import typingsSlinky.dojo.dojoStrings.childParams
import typingsSlinky.dojo.dojoStrings.childType
import typingsSlinky.dojo.dojoStrings.children
import typingsSlinky.dojo.dojoStrings.partialRebuild
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mvc._base.WidgetList")
@js.native
