...
import typingsSlinky.dojo.dojoStrings.datePart
import typingsSlinky.dojo.dojoStrings.displayedYears
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget._CalendarMonthYearView")
@js.native
class CalendarMonthYearView () extends CalendarView {
  ...
  /**
    ...
    * @param evt
    */
  def onCancel(evt: js.Any): Boolean = js.native
  /**
    * Handles clicks on month names
    *
    * @param evt
    */
  def onClick(evt: js.Any): Boolean = js.native
  /**
    *
    * @param evt
    */
  def onOk(evt: js.Any): Boolean = js.native
  @JSName("set")
