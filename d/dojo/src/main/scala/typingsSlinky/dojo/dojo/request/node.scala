...
trait node extends js.Object {
  ...
  def apply(url: String, options: typingsSlinky.dojo.dojo.request.node.__Options): Unit = js.native
  /**
  ...
  def del(url: String, options: typingsSlinky.dojo.dojo.request.node.__BaseOptions): __Promise = js.native
  /**
  ...
  def get(url: String, options: typingsSlinky.dojo.dojo.request.node.__BaseOptions): __Promise = js.native
  /**
  ...
  def post(url: String, options: typingsSlinky.dojo.dojo.request.node.__BaseOptions): __Promise = js.native
  /**
  ...
  def put(url: String, options: typingsSlinky.dojo.dojo.request.node.__BaseOptions): __Promise = js.native
}
