...
/**
  ...
  *
  */
@JSGlobal("dojo._base.kernel.__XhrArgs")
@js.native
class XhrArgs () extends js.Object {
  ...
  /**
    ...
    */
  def error(response: js.Object, ioArgs: typingsSlinky.dojo.dojo.main.IoCallbackArgs): Unit = js.native
  /**
    * This function will
    ...
    * @param ioArgs Provides additional information about the request.
    */
  def handle(loadOrError: String, response: js.Object, ioArgs: typingsSlinky.dojo.dojo.main.IoCallbackArgs): Unit = js.native
  /**
    ...
    * @param ioArgs Provides additional information about the request.
    */
  def load(response: js.Object, ioArgs: typingsSlinky.dojo.dojo.main.IoCallbackArgs): Unit = js.native
}
