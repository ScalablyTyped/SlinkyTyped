...
@js.native
class Moveable protected () extends Evented {
  ...
  /**
    ...
    * @param e
    */
  def onDragDetected(e: Event): Unit = js.native
  /**
    ...
    * @param e
    */
  def onFirstMove(mover: Mover, e: Event): Unit = js.native
  /**
  ...
  /**
    ...
    * @param e
    */
  def onMove(mover: Mover, leftTop: js.Object, e: Event): Unit = js.native
  /**
...
@JSGlobal("dojo.dnd.Moveable")
@js.native
object Moveable extends js.Object {
  /**
    ...
    */
  @js.native
  class __MoveableArgs () extends js.Object {
    /**
