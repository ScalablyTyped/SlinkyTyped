...
trait script_ extends js.Object {
  ...
  def apply(url: String, options: typingsSlinky.dojo.dojo.request.script.Options): Unit = js.native
  /**
  ...
  def get(url: String, options: typingsSlinky.dojo.dojo.request.script.BaseOptions): Promise = js.native
}
