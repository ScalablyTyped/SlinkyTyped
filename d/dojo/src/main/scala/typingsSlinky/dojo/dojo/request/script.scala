...
trait script extends js.Object {
  ...
  def apply(url: String, options: typingsSlinky.dojo.dojo.request.script.__Options): Unit = js.native
  /**
  ...
  def get(url: String, options: typingsSlinky.dojo.dojo.request.script.__BaseOptions): __Promise = js.native
}
