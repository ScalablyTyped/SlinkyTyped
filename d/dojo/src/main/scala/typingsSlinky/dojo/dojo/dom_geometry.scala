...
import typingsSlinky.dojo.Anon_H
...
/**
  ...
  */
@js.native
trait dom_geometry extends js.Object {
  /**
    *
    */
  ...
  /**
    ...
    */
  def position(node: String): Anon_H = js.native
  def position(node: String, includeScroll: Boolean): Anon_H = js.native
  /**
    * Gets the position and size of the passed element relative to
    * the viewport (if includeScroll==false), or relative to the
    * document root (if includeScroll==true).
    ...
    * @param includeScroll               Optional
    */
  def position(node: typingsSlinky.std.HTMLElement): Anon_H = js.native
  def position(node: typingsSlinky.std.HTMLElement, includeScroll: Boolean): Anon_H = js.native
  /**
