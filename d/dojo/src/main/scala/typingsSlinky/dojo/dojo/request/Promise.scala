...
@js.native
class Promise ()
  extends typingsSlinky.dojo.dojo.promise.Promise[js.Any] {
  /**
  ...
  def `then`(callback: js.Function): typingsSlinky.dojo.dojo.promise.Promise[_] = js.native
  def `then`(callback: js.Function, errback: js.Function): typingsSlinky.dojo.dojo.promise.Promise[_] = js.native
  def `then`(callback: js.Function, errback: js.Function, progback: js.Function): typingsSlinky.dojo.dojo.promise.Promise[_] = js.native
}
