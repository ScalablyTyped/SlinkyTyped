...
package object dojo {
  type NodeList = typingsSlinky.dojo.dojo.NodeList_
  /**
  ...
  type currency = typingsSlinky.dojo.dojo.currency_
  type date = typingsSlinky.dojo.dojo.date_
  type domProp = typingsSlinky.dojo.dojo.domProp_
  type gears = typingsSlinky.dojo.dojo.gears_
  /**
  ...
  type html = typingsSlinky.dojo.dojo.html_
  type i18n = typingsSlinky.dojo.dojo.i18n_
  type main = typingsSlinky.dojo.dojo.main_
  type number = typingsSlinky.dojo.dojo.number_
  /**
  ...
  type request = typingsSlinky.dojo.dojo.request_
  type robot = typingsSlinky.dojo.dojo.robot_
  type robotx = typingsSlinky.dojo.dojo.robotx_
  /**
    ...
    *
    */
  type router = typingsSlinky.dojo.dojo.router.RouterBase
  /**
  ...
  type when = js.Function4[
    /* value */ js.Any | typingsSlinky.dojo.dojo.promise.Promise[js.Any], 
    /* callback */ typingsSlinky.dojo.dojo.promise.Callback[js.Any, js.Any], 
    /* errback */ js.UndefOr[js.Any], 
    /* progback */ js.UndefOr[js.Any], 
    js.Any | typingsSlinky.dojo.dojo.promise.Promise[js.Any]
  ]
}
