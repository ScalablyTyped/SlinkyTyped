...
trait html extends js.Object {
  ...
  /**
    ...
    * @param params               OptionalOptional flags/properties to configure the content-setting. See dojo/html/_ContentSetter
    */
  def set(node: HTMLElement, cont: typingsSlinky.dojo.dojo._base.NodeList): js.Any = js.native
  def set(node: HTMLElement, cont: typingsSlinky.dojo.dojo._base.NodeList, params: js.Object): js.Any = js.native
  /**
    * inserts (replaces) the given content into the given node. dojo/dom-construct.place(cont, node, "only")
    * may be a better choice for simple HTML insertion.
    * Unless you need to use the params capabilities of this method, you should use
