...
trait lang extends js.Object {
  ...
  /**
    ...
    */
  def getObject(name: String): js.Any = js.native
  def getObject(name: String, create: Boolean): js.Any = js.native
  ...
  /**
    ...
    */
  def hitch(scope: js.Object, method: String, args: js.Any*): js.Any = js.native
  /**
    * Returns a function that will only ever execute in the a given scope.
    * This allows for easy use of object member functions
    * in callbacks and other places in which the "this" keyword may
    ...
    * @param method A function to be hitched to scope, or the name of the method inscope to be hitched.
    */
  def hitch(scope: js.Object, method: js.Function1[/* repeated */ js.Any, _], args: js.Any*): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def mixin[T](dest: T): T = js.native
  def mixin[T](dest: js.Object, sources: js.Object*): T = js.native
  def mixin[T, U](dest: T, source: U): T with U = js.native
  def mixin[T, U, V](dest: T, source1: U, source2: V): T with U with V = js.native
  def mixin[T, U, V, W](dest: T, source1: U, source2: V, source3: W): T with U with V with W = js.native
  /**
  ...
  /**
    ...
    */
  def replace(tmpl: String, map: js.Function): String = js.native
  def replace(tmpl: String, map: js.Function, pattern: js.RegExp): String = js.native
  /**
    * Performs parameterized substitutions on a string. Throws an
    * exception if any parameter is unmatched.
    *
    ...
    * @param pattern               OptionalOptional regular expression objects that overrides the default pattern.Must be global and match one item. The default is: /{([^}]+)}/g,which matches patterns like that: "{xxx}", where "xxx" is any sequenceof characters, which doesn't include "}".
    */
  def replace(tmpl: String, map: js.Object): String = js.native
  def replace(tmpl: String, map: js.Object, pattern: js.RegExp): String = js.native
  /**
    ...
    */
  def setObject(name: String, value: js.Any): js.Any = js.native
