...
trait iframe_ extends js.Object {
  ...
  def apply(url: String, options: typingsSlinky.dojo.dojo.request.iframe.Options): Unit = js.native
  /**
    *
    * @param name
    * @param onloadstr
  ...
  def get(url: String, options: typingsSlinky.dojo.dojo.request.iframe.BaseOptions): Promise = js.native
  /**
  ...
  def post(url: String, options: typingsSlinky.dojo.dojo.request.iframe.BaseOptions): Promise = js.native
  /**
    *
    * @param _iframe
    * @param src
