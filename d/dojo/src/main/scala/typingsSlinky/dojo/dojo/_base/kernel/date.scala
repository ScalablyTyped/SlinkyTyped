...
trait date extends js.Object {
  ...
  /**
    ...
    */
  def add(date: js.Date, interval: String, amount: Double): js.Any = js.native
  /**
    ...
    */
  def compare(date1: js.Date): Double = js.native
  def compare(date1: js.Date, date2: js.Date): Double = js.native
  def compare(date1: js.Date, date2: js.Date, portion: String): Double = js.native
  /**
    ...
    */
  def difference(date1: js.Date): js.Any = js.native
  def difference(date1: js.Date, date2: js.Date): js.Any = js.native
  def difference(date1: js.Date, date2: js.Date, interval: String): js.Any = js.native
  /**
    * Returns the number of days in the month used by dateObject
    *
    * @param dateObject
    */
  def getDaysInMonth(dateObject: js.Date): Double = js.native
  /**
    ...
    */
  def getTimezoneName(dateObject: js.Date): js.Any = js.native
  /**
    ...
    * @param dateObject
    */
  def isLeapYear(dateObject: js.Date): Boolean = js.native
}
