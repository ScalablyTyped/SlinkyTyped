...
trait script extends js.Object {
  /**
    ...
    * @param frameDocument
    */
  def attach(id: js.Any, url: js.Any, frameDocument: js.Any): Unit = js.native
  /**
  ...
  /**
    ...
    * @param frameDocument
    */
  def remove(id: js.Any, frameDocument: js.Any): Unit = js.native
}
...
object script {
  ...
  implicit class scriptOps[Self <: script] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttach(value: (js.Any, js.Any, js.Any) => Unit): Self = {
