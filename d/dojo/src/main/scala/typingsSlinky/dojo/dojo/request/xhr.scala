...
trait xhr extends js.Object {
  ...
  def apply(url: String, options: typingsSlinky.dojo.dojo.request.xhr.__Options): __Promise = js.native
  /**
  ...
  def del(url: String, options: typingsSlinky.dojo.dojo.request.xhr.__BaseOptions): __Promise = js.native
  /**
  ...
  def get(url: String, options: typingsSlinky.dojo.dojo.request.xhr.__BaseOptions): __Promise = js.native
  /**
  ...
  def post(url: String, options: typingsSlinky.dojo.dojo.request.xhr.__BaseOptions): __Promise = js.native
  /**
  ...
  def put(url: String, options: typingsSlinky.dojo.dojo.request.xhr.__BaseOptions): __Promise = js.native
}
