...
import typingsSlinky.dojo.dijit._editor.plugins.LinkDialog
...
object linkDialogMod
  ...
  @js.native
  class ImgLinkDialog ()
    extends typingsSlinky.dojo.dijit._editor.plugins.LinkDialog.ImgLinkDialog {
