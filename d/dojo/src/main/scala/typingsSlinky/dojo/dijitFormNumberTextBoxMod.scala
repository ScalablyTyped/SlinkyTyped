...
import typingsSlinky.dojo.dijit.form.NumberTextBox
...
object dijitFormNumberTextBoxMod
  ...
  @js.native
  class Mixin ()
    extends typingsSlinky.dojo.dijit.form.NumberTextBox.Mixin
  ...
  @js.native
  class __Constraints ()
    extends typingsSlinky.dojo.dijit.form.NumberTextBox.__Constraints
