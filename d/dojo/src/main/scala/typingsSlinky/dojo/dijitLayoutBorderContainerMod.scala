...
import typingsSlinky.dojo.dijit.layout.BorderContainer
...
object dijitLayoutBorderContainerMod
  ...
  @js.native
  class _Gutter ()
    extends typingsSlinky.dojo.dijit.layout.BorderContainer._Gutter {
  ...
  @js.native
  class _Splitter ()
    extends typingsSlinky.dojo.dijit.layout.BorderContainer._Splitter
