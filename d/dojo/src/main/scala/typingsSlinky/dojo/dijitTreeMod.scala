...
@JSImport("dijit/Tree", JSImport.Namespace)
@js.native
object dijitTreeMod
  extends TopLevel[
      TypeofTree with (Instantiable2[js.UndefOr[/* params */ js.Object], js.UndefOr[/* srcNodeRef */ HTMLElement], Tree])
    ] {
  /**
  ...
  @js.native
  class _TreeNode ()
    extends typingsSlinky.dojo.dijit.Tree._TreeNode {
