...
@JSImport("dojo/store/api/Store", JSImport.Namespace)
@js.native
object storeApiStoreMod extends TopLevel[TypeofStore with Instantiable0[Store]] {
  /**
  ...
  @js.native
  class PutDirectives ()
    extends typingsSlinky.dojo.dojo.store.api.Store.PutDirectives
  ...
  @js.native
  class QueryOptions ()
    extends typingsSlinky.dojo.dojo.store.api.Store.QueryOptions
  ...
  @js.native
  class QueryResults ()
    extends typingsSlinky.dojo.dojo.store.api.Store.QueryResults
  ...
  class SortInformation ()
    extends typingsSlinky.dojo.dojo.store.api.Store.SortInformation
  ...
  @js.native
  class Transaction ()
    extends typingsSlinky.dojo.dojo.store.api.Store.Transaction
