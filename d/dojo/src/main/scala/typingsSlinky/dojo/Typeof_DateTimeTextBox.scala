...
import typingsSlinky.dojo.dijit.form._DateTimeTextBox.__Constraints
...
trait Typeof_DateTimeTextBox extends js.Object {
  /**
    ...
    * 
    */
  var __Constraints: Instantiable0[typingsSlinky.dojo.dijit.form._DateTimeTextBox.__Constraints]
}
