...
import typingsSlinky.dojo.dojoStrings.autoComplete
import typingsSlinky.dojo.dojoStrings.autoWidth
import typingsSlinky.dojo.dojoStrings.dropDown
import typingsSlinky.dojo.dojoStrings.dropDownPosition
import typingsSlinky.dojo.dojoStrings.fetchProperties
import typingsSlinky.dojo.dojoStrings.forceWidth
import typingsSlinky.dojo.dojoStrings.hasDownArrow
import typingsSlinky.dojo.dojoStrings.highlightMatch
import typingsSlinky.dojo.dojoStrings.ignoreCase
import typingsSlinky.dojo.dojoStrings.item
import typingsSlinky.dojo.dojoStrings.labelAttr
import typingsSlinky.dojo.dojoStrings.labelType
import typingsSlinky.dojo.dojoStrings.maxHeight
import typingsSlinky.dojo.dojoStrings.pageSize
import typingsSlinky.dojo.dojoStrings.query
import typingsSlinky.dojo.dojoStrings.queryExpr
import typingsSlinky.dojo.dojoStrings.searchAttr
import typingsSlinky.dojo.dojoStrings.searchDelay
...
/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/form/FilteringSelect.html
  *
...
- typingsSlinky.dojo.dijit.form.AutoCompleterMixin because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.form.ComboBoxMixin because Inheritance from two classes. Inlined autoComplete, autoWidth, dropDown, dropDownPosition, fetchProperties, forceWidth, hasDownArrow, highlightMatch, ignoreCase, item, labelAttr, labelType, maxHeight, pageSize, query, queryExpr, searchAttr, searchDelay, store, buildRendering, closeDropDown, closeDropDown, destroy, doHighlight, dropDownClass, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, postMixInProperties, reset, toggleDropDown, onSearch */ @JSGlobal("dijit.form.FilteringSelect")
@js.native
class FilteringSelect () extends MappedTextBox {
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FilteringSelect: String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MFilteringSelect(): Boolean = js.native
  /**
