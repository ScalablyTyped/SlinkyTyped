package typingsSlinky.dojo.dijit._editor.plugins.FontChoice
...
import typingsSlinky.dojo.dojoStrings.comboClass
import typingsSlinky.dojo.dojoStrings.command
import typingsSlinky.dojo.dojoStrings.label
import typingsSlinky.dojo.dojoStrings.plainText
...
import typingsSlinky.dojo.dojoStrings.values
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit._editor.plugins.FontChoice._FontSizeDropDown")
@js.native
class FontSizeDropDown () extends Widget {
  ...
  var contextRequire_FFontSizeDropDown: js.Function = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("style")
  var style_FontSizeDropDown: String = js.native
  /**
