...
- typingsSlinky.dojo.dijit.form.ComboBoxMenuMixin because Inheritance from two classes. Inlined clearResultList, createOptions, getHighlightedOption, highlightFirstOption, highlightLastOption, postMixInProperties, onChange, onClick, onPage
- typingsSlinky.dojo.dijit.form.ListMouseMixin because Inheritance from two classes. Inlined selected, postCreate, selectFirstNode, selectLastNode, selectNextNode, selectPreviousNode
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.form._ComboBoxMenu")
@js.native
