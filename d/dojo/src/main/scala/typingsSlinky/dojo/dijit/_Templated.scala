...
- typings.dojo.dijit._WidgetsInTemplateMixin because Inheritance from two classes. Inlined contextRequire, widgetsInTemplate, startup */ @JSGlobal("dijit._Templated")
@js.native
class _Templated () extends _TemplatedMixin {
  /**
