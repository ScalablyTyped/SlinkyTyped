package typingsSlinky.dojo.dijit._editor._Plugin
...
/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/_editor/_Plugin.registry.html
  *
  * 
  */
...
object registry {
  @scala.inline
  def apply(
    LocalImage: js.Any => js.Any,
    bold: js.Any => js.Any,
    colorTableCell: js.Any => Unit,
    copy: js.Any => js.Any,
    createLink: () => Unit,
    cut: js.Any => js.Any,
    delete: js.Any => js.Any,
    deleteTableColumn: js.Any => js.Any,
    deleteTableRow: js.Any => js.Any,
    foreColor: () => Unit,
    fullScreen: js.Any => Unit,
    fullscreen: js.Any => Unit,
    hiliteColor: () => Unit,
    indent: js.Any => js.Any,
    insertHorizontalRule: js.Any => js.Any,
    insertImage: () => Unit,
    insertOrderedList: js.Any => js.Any,
    insertTable: js.Any => Unit,
    insertTableColumnAfter: js.Any => js.Any,
    insertTableColumnBefore: js.Any => js.Any,
    insertTableRowAfter: js.Any => js.Any,
    insertTableRowBefore: js.Any => js.Any,
    insertUnorderedList: js.Any => js.Any,
    italic: js.Any => js.Any,
    justifyCenter: js.Any => js.Any,
    justifyFull: js.Any => js.Any,
    justifyLeft: js.Any => js.Any,
    justifyRight: js.Any => js.Any,
    localImage: js.Any => js.Any,
    localimage: js.Any => js.Any,
    modifyTable: js.Any => Unit,
    newPage: js.Any => Unit,
    newpage: js.Any => Unit,
    outdent: js.Any => js.Any,
    paste: js.Any => js.Any,
    print: () => Unit,
    redo: js.Any => js.Any,
    removeFormat: js.Any => js.Any,
    selectAll: js.Any => js.Any,
    strikethrough: js.Any => js.Any,
    subscript: js.Any => js.Any,
    superscript: js.Any => js.Any,
    tabIndent: () => Unit,
    tableContextMenu: js.Any => Unit,
    toggleDir: () => Unit,
    underline: js.Any => js.Any,
    undo: js.Any => js.Any,
    unlink: js.Any => js.Any,
