...
- typingsSlinky.dojo.dijit.form.TextBoxMixin because Inheritance from two classes. Inlined displayedValue, lowercase, maxLength, placeHolder, propercase, selectOnClick, trim, uppercase, filter, format, parse, postCreate, reset, selectInputText, onInput */ @JSGlobal("dijit.form.TextBox")
@js.native
