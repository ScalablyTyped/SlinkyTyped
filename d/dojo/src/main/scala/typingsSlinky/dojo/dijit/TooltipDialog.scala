...
import typingsSlinky.dojo.dojoStrings.autofocus_
...
- typingsSlinky.dojo.dijit.DialogMixin because Inheritance from two classes. Inlined execute, onCancel, onExecute
- typingsSlinky.dojo.dijit.form.FormMixin because Inheritance from two classes. Inlined state, connectChildren, destroy, disconnectChildren, getValues, reset, setValues, startup, validate, onValidStateChange
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.TooltipDialog")
@js.native
