...
import typingsSlinky.dojo.dojoStrings.dndType
import typingsSlinky.dojo.dojoStrings.hovering
import typingsSlinky.dojo.dojoStrings.observer
import typingsSlinky.dojo.dojoStrings.slideFrom
...
class Calendar () extends CalendarLite {
  ...
  /**
    ...
    * @param date             
    */
  def onValueSelected(date: js.Date): Unit = js.native
  /**
