...
- typings.dojo.dijit._Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dijit._KeyNavContainer")
@js.native
class _KeyNavContainer () extends _KeyNavMixin {
  /**
    * 
    * @param widget             
  ...
  def childSelector_M_KeyNavContainer(node: HTMLElement): js.Any = js.native
  /**
