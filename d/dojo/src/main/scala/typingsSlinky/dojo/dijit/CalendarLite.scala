...
import typingsSlinky.dojo.dojoStrings.currentFocus
import typingsSlinky.dojo.dojoStrings.datePackage
import typingsSlinky.dojo.dojoStrings.dateTemplateString
import typingsSlinky.dojo.dojoStrings.dayWidth
import typingsSlinky.dojo.dojoStrings.dowTemplateString
...
import typingsSlinky.dojo.dojoStrings.weekTemplateString
...
class CalendarLite () extends _WidgetBase {
  ...
  /**
    ...
    */
  def getClassForDate(dateObject: js.Date): String = js.native
