...
import typingsSlinky.dojo.dojo.keys
import typingsSlinky.dojo.dojoStrings.activated
import typingsSlinky.dojo.dojoStrings.active
import typingsSlinky.dojo.dojoStrings.attachScope
import typingsSlinky.dojo.dojoStrings.autoFocus
...
import typingsSlinky.dojo.dojoStrings.parentMenu
import typingsSlinky.dojo.dojoStrings.passivePopupDelay
import typingsSlinky.dojo.dojoStrings.popupDelay
...
- typingsSlinky.dojo.dijit.Container because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.KeyNavMixin because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.AttachMixin because Inheritance from two classes. Inlined 
- typingsSlinky.dojo.dijit.CssStateMixin because Inheritance from two classes. Inlined active, cssStateNodes, hovering
- typingsSlinky.dojo.dijit.KeyNavContainer because Inheritance from two classes. Inlined focusedChild, multiCharSearchDuration, tabIndex, addChild, addChild, childSelector, connectKeyNavHandlers, focus, focusChild, focusFirstChild, focusLastChild, focusNext, focusPrev, getIndexOfChild, hasChildren, postCreate, removeChild, removeChild, startup, startupKeyNavChildren, onKeyboardSearch
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit._MenuBase")
@js.native
class MenuBase () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_MenuBase: String = js.native
  /**
  ...
  /**
    ...
    * @param numMatches             
    */
  def onKeyboardSearch(item: MenuItem, evt: Event_, searchString: String, numMatches: Double): Unit = js.native
  /**
  ...
  @JSName("watch")
  def watch_passivePopupDelay(
    property: passivePopupDelay,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
      /* oldValue */ js.UndefOr[Double], 
      /* newValue */ js.UndefOr[Double], 
