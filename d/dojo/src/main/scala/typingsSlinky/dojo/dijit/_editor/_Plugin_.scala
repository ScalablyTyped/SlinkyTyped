...
import typingsSlinky.dojo.dijit.Destroyable
import typingsSlinky.dojo.dijit.Editor
import typingsSlinky.dojo.dijit.Toolbar
...
@js.native
class _Plugin_ () extends Destroyable {
