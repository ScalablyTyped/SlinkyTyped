...
import typingsSlinky.dojo.dojoStrings.dropDownDefaultValue
...
import typingsSlinky.dojo.dojoStrings.popupClass
...
- typingsSlinky.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined autoWidth, dropDown, dropDownPosition, forceWidth, maxHeight, buildRendering, closeDropDown, destroy, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, toggleDropDown */ @JSGlobal("dijit.form._DateTimeTextBox")
@js.native
class DateTimeTextBox_ () extends RangeBoundTextBox {
  ...
  /**
    ...
    * 
    */
  var dropDownDefaultValue: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("value")
  var value_DateTimeTextBox_ : js.Date = js.native
  /**
  ...
  /**
    ...
    * @param val2             
    */
  def compare(val1: js.Date, val2: js.Date): js.Any = js.native
  /**
    ...
    */
  def format(value: js.Date, constraints: js.Object): js.Any = js.native
  @JSName("get")
  ...
  @JSName("get")
  def get_dropDownDefaultValue(property: dropDownDefaultValue): js.Date = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_dropDownDefaultValue(property: dropDownDefaultValue, value: js.Date): Unit = js.native
  @JSName("set")
