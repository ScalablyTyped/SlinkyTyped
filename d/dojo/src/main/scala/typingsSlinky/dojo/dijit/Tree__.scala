...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate
- typingsSlinky.dojo.dijit.KeyNavMixin because Inheritance from two classes. Inlined childSelector, focusedChild, multiCharSearchDuration, tabIndex, focus, focusChild, focusFirstChild, focusLastChild, postCreate, onKeyboardSearch */ @JSGlobal("dijit.Tree")
@js.native
