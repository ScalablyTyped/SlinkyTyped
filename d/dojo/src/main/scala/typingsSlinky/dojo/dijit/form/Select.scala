...
import typingsSlinky.dojo.dijit.DropDownMenu
...
import typingsSlinky.dojo.dojoStrings.emptyLabel
...
import typingsSlinky.dojo.dojoStrings.message
import typingsSlinky.dojo.dojoStrings.multiCharSearchDuration
import typingsSlinky.dojo.dojoStrings.required
import typingsSlinky.dojo.dojoStrings.state
import typingsSlinky.dojo.dojoStrings.tooltipPosition
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/form/Select.html
  *
  * 
...
- typings.dojo.dijit._HasDropDown because Inheritance from two classes. Inlined autoWidth, dropDown, dropDownPosition, forceWidth, maxHeight, buildRendering, closeDropDown, destroy, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, toggleDropDown */ @JSGlobal("dijit.form.Select")
@js.native
class Select () extends _FormSelectWidget {
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MSelect(isFocused: Boolean): Boolean = js.native
  /**
