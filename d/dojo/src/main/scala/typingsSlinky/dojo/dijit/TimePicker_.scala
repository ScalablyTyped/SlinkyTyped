...
import typingsSlinky.dojo.dojoStrings.clickableIncrement
import typingsSlinky.dojo.dojoStrings.constraints
import typingsSlinky.dojo.dojoStrings.filterString
...
import typingsSlinky.dojo.dojoStrings.visibleIncrement
...
- typingsSlinky.dojo.dijit.form.ListMouseMixin because Inheritance from two classes. Inlined selected, postCreate, selectFirstNode, selectLastNode, selectNextNode, selectPreviousNode */ @JSGlobal("dijit._TimePicker")
@js.native
