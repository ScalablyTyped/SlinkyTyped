...
/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/form/TimeTextBox.html
  *
...
class TimeTextBox () extends _DateTimeTextBox {
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MTimeTextBox(isFocused: Boolean): js.Any = js.native
  /**
    ...
    */
  @JSName("pattern")
  def pattern_MTimeTextBox(options: js.Object): js.Any = js.native
  /**
    * 
    */
  @JSName("popupClass")
  def popupClass_MTimeTextBox(): Unit = js.native
}
