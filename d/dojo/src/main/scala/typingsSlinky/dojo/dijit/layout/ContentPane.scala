...
import typingsSlinky.dojo.dojoStrings.extractContent
import typingsSlinky.dojo.dojoStrings.href
import typingsSlinky.dojo.dojoStrings.ioArgs
...
import typingsSlinky.dojo.dojoStrings.parserScope
import typingsSlinky.dojo.dojoStrings.preload
...
class ContentPane () extends Widget {
  ...
  /**
    ...
    * @param error             
    */
  def onContentError(error: js.Error): Unit = js.native
  /**
  ...
  /**
    ...
    * @param error             
    */
  def onDownloadError(error: js.Error): js.Any = js.native
  /**
