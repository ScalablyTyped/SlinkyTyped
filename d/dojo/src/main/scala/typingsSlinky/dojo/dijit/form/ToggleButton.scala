...
- typingsSlinky.dojo.dijit.form.ToggleButtonMixin because Inheritance from two classes. Inlined checked, postCreate, reset */ @JSGlobal("dijit.form.ToggleButton")
@js.native
