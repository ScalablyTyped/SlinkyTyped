...
import typingsSlinky.dojo.dojoStrings.indeterminate
...
import typingsSlinky.dojo.dojoStrings.places
import typingsSlinky.dojo.dojoStrings.progress
...
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.ProgressBar")
@js.native
