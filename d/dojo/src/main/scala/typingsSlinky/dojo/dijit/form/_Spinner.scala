...
import typingsSlinky.dojo.dojoStrings.largeDelta
import typingsSlinky.dojo.dojoStrings.minimumTimeout
import typingsSlinky.dojo.dojoStrings.smallDelta
...
class _Spinner () extends RangeBoundTextBox {
  ...
  /**
    ...
    */
  @JSName("value")
  var value__Spinner: String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_M_Spinner(isFocused: Boolean): js.Any = js.native
  @JSName("set")
