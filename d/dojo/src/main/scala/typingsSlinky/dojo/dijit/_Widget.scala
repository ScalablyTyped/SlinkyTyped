...
- typings.dojo.dijit._OnDijitClickMixin because Inheritance from two classes. Inlined a11yclick, connect */ @JSGlobal("dijit._Widget")
@js.native
class _Widget () extends _WidgetBase {
