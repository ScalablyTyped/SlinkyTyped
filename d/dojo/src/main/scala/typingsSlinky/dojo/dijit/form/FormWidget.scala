...
- typingsSlinky.dojo.dijit.form.FormWidgetMixin because Inheritance from two classes. Inlined alt, `aria-label`, disabled, intermediateChanges, name, scrollOnFocus, tabIndex, `type`, value, compare, create, destroy, focus, isFocusable, onChange
- typingsSlinky.dojo.dijit.CssStateMixin because Inheritance from two classes. Inlined active, cssStateNodes, hovering
- typingsSlinky.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.form._FormWidget")
@js.native
