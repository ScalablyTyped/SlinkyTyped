...
import typingsSlinky.dojo.dijit.Calendar
...
object dijitCalendarMod
  ...
  class _MonthDropDown ()
    extends typingsSlinky.dojo.dijit.Calendar._MonthDropDown {
  ...
  class _MonthDropDownButton ()
    extends typingsSlinky.dojo.dijit.Calendar._MonthDropDownButton {
    def this(params: js.Object) = this()
    def this(params: js.Object, srcNodeRef: org.scalajs.dom.raw.HTMLElement) = this()
  }
