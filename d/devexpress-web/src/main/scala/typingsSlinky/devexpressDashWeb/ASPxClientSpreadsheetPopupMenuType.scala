...
object ASPxClientSpreadsheetPopupMenuType extends js.Object {
  ...
  /* 8 */ val AutoFilter: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.AutoFilter with Double = js.native
  /* 7 */ val Cell: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.Cell with Double = js.native
  /* 5 */ val Chart: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.Chart with Double = js.native
  /* 0 */ val ColumnHeading: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.ColumnHeading with Double = js.native
  /* 4 */ val Picture: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.Picture with Double = js.native
  /* 9 */ val PivotTable: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.PivotTable with Double = js.native
  /* 10 */ val PivotTableAutoFilter: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.PivotTableAutoFilter with Double = js.native
  /* 1 */ val RowHeading: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.RowHeading with Double = js.native
  /* 3 */ val SheetTab: typingsSlinky.devexpressDashWeb.ASPxClientSpreadsheetPopupMenuType.SheetTab with Double = js.native
  @JSBracketAccess
