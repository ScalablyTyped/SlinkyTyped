...
object DocumentFormat extends js.Object {
  ...
  /* 10 */ val Doc: typingsSlinky.devexpressDashWeb.DocumentFormat.Doc with Double = js.native
  /* 3 */ val Html: typingsSlinky.devexpressDashWeb.DocumentFormat.Html with Double = js.native
  /* 5 */ val Mht: typingsSlinky.devexpressDashWeb.DocumentFormat.Mht with Double = js.native
  /* 7 */ val OpenDocument: typingsSlinky.devexpressDashWeb.DocumentFormat.OpenDocument with Double = js.native
  /* 4 */ val OpenXml: typingsSlinky.devexpressDashWeb.DocumentFormat.OpenXml with Double = js.native
  /* 1 */ val PlainText: typingsSlinky.devexpressDashWeb.DocumentFormat.PlainText with Double = js.native
  /* 2 */ val Rtf: typingsSlinky.devexpressDashWeb.DocumentFormat.Rtf with Double = js.native
  /* 0 */ val Undefined: typingsSlinky.devexpressDashWeb.DocumentFormat.Undefined with Double = js.native
  /* 6 */ val WordML: typingsSlinky.devexpressDashWeb.DocumentFormat.WordML with Double = js.native
  /* 9 */ val ePub: typingsSlinky.devexpressDashWeb.DocumentFormat.ePub with Double = js.native
  @JSBracketAccess
