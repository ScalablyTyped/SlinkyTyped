...
object ParagraphFirstLineIndent extends js.Object {
  ...
  /* 2 */ val Hanging: typingsSlinky.devexpressDashWeb.ParagraphFirstLineIndent.Hanging with Double = js.native
  /* 1 */ val Indented: typingsSlinky.devexpressDashWeb.ParagraphFirstLineIndent.Indented with Double = js.native
  /* 0 */ val None: typingsSlinky.devexpressDashWeb.ParagraphFirstLineIndent.None with Double = js.native
  @JSBracketAccess
