...
object Orientation extends js.Object {
  ...
  /* 0 */ val Landscape: typingsSlinky.devexpressDashWeb.Orientation.Landscape with Double = js.native
  /* 1 */ val Portrait: typingsSlinky.devexpressDashWeb.Orientation.Portrait with Double = js.native
  @JSBracketAccess
