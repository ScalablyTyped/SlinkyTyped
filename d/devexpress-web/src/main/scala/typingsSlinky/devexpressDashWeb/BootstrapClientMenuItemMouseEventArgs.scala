...
@js.native
class BootstrapClientMenuItemMouseEventArgs protected () extends BootstrapClientMenuItemEventArgs {
  /**
    ...
    */
  def this(item: BootstrapClientMenuItem, htmlElement: js.Any) = this()
}
