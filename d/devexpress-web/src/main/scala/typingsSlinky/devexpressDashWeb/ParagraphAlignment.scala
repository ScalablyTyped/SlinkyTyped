...
object ParagraphAlignment extends js.Object {
  ...
  /* 2 */ val Center: typingsSlinky.devexpressDashWeb.ParagraphAlignment.Center with Double = js.native
  /* 3 */ val Justify: typingsSlinky.devexpressDashWeb.ParagraphAlignment.Justify with Double = js.native
  /* 0 */ val Left: typingsSlinky.devexpressDashWeb.ParagraphAlignment.Left with Double = js.native
  /* 1 */ val Right: typingsSlinky.devexpressDashWeb.ParagraphAlignment.Right with Double = js.native
  @JSBracketAccess
