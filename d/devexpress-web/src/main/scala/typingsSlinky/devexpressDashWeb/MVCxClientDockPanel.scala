...
/**
  ...
  */
@JSGlobal("MVCxClientDockPanel")
@js.native
class MVCxClientDockPanel () extends ASPxClientDockPanel {
  /**
...
@JSGlobal("MVCxClientDockPanel")
@js.native
object MVCxClientDockPanel extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): MVCxClientDockPanel = js.native
}
