...
object ChangeFontFormattingCommand {
  ...
  implicit class ChangeFontFormattingCommandOps[Self <: ChangeFontFormattingCommand] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExecute(value: FontFormattingSettings => Boolean): Self = this.set("execute", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetState(value: () => CommandState[FontFormattingSettings]): Self = this.set("getState", js.Any.fromFunction0(value))
  }
}
