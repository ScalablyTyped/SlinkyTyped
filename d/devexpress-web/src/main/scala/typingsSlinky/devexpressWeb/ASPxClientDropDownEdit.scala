...
object ASPxClientDropDownEdit {
  ...
  implicit class ASPxClientDropDownEditOps[Self <: ASPxClientDropDownEdit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDropDownCommandButtonClick(value: ASPxClientEvent[ASPxClientDropDownCommandEventHandler[ASPxClientDropDownEdit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DropDownCommandButtonClick")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetKeyValue(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetKeyValue")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetKeyValue(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetKeyValue")(js.Any.fromFunction1(value))
        ret
    }
  }
