...
object ASPxClientSpellChecker {
  ...
  implicit class ASPxClientSpellCheckerOps[Self <: ASPxClientSpellChecker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAfterCheck(value: ASPxClientEvent[ASPxClientAfterCheckEventHandler[ASPxClientSpellChecker]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AfterCheck")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBeforeCheck(value: ASPxClientEvent[ASPxClientBeforeCheckEventHandler[ASPxClientSpellChecker]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BeforeCheck")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withCheckCompleteFormShowing(value: ASPxClientEvent[ASPxClientCancelEventHandler[ASPxClientSpellChecker]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckCompleteFormShowing")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCheckElement(value: js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckElement")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCheckElementById(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckElementById")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCheckElementsInContainer(value: js.Any => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckElementsInContainer")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCheckElementsInContainerById(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckElementsInContainerById")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWordChanged(value: ASPxClientEvent[ASPxClientWordChangedEventHandler[ASPxClientSpellChecker]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("WordChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
