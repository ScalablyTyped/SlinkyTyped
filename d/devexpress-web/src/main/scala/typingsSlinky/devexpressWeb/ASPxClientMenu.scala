...
object ASPxClientMenu {
  ...
  implicit class ASPxClientMenuOps[Self <: ASPxClientMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetOrientation(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetOrientation")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withToggleSideMenu(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ToggleSideMenu")(js.Any.fromFunction0(value))
        ret
    }
  }
