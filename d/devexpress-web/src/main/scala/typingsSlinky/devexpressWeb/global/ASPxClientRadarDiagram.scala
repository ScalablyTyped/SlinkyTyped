...
class ASPxClientRadarDiagram ()
  extends typingsSlinky.devexpressWeb.ASPxClientRadarDiagram {
  /**
    * Gets the X-axis.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def DiagramToPoint(argument: js.Any, value: js.Any): typingsSlinky.devexpressWeb.ASPxClientControlCoordinates = js.native
  /**
