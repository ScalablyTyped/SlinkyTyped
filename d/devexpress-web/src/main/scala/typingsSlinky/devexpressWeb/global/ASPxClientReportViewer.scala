...
class ASPxClientReportViewer ()
  extends typingsSlinky.devexpressWeb.ASPxClientReportViewer
object ASPxClientReportViewer {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientReportViewer.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientReportViewer = js.native
}
