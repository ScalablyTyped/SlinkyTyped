...
class ASPxClientDiagram ()
  ...
  override var BeginCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientDiagram]
  ] = js.native
  /**
  ...
  override var CallbackError: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsSlinky.devexpressWeb.ASPxClientDiagram]
  ] = js.native
  /**
    * Fires when the diagram's data is changed.
    */
  /* CompleteClass */
  override var DiagramChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientDiagram]] = js.native
  /**
    * Occurs on the client side after a callback's server-side processing has been completed.
    */
  /* CompleteClass */
  override var EndCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEndCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientDiagram]] = js.native
  /**
