...
@js.native
class ASPxClientDocumentViewer ()
  extends typingsSlinky.devexpressWeb.ASPxClientDocumentViewer
object ASPxClientDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientDocumentViewer.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientDocumentViewer = js.native
}
