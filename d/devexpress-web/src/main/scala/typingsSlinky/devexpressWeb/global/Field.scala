...
@js.native
class Field ()
  extends typingsSlinky.devexpressWeb.Field {
  /**
    * Gets the text buffer interval occupied by the field code element.
    */
  /* CompleteClass */
  override val codeInterval: typingsSlinky.devexpressWeb.Interval = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val resultInterval: typingsSlinky.devexpressWeb.Interval = js.native
  /**
