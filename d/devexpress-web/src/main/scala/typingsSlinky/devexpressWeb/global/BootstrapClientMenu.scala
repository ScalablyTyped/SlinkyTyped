...
import typingsSlinky.devexpressWeb.ASPxClientMenuItemClickEventHandler
import typingsSlinky.devexpressWeb.ASPxClientMenuItemEventHandler
import typingsSlinky.devexpressWeb.ASPxClientMenuItemMouseEventHandler
...
@js.native
class BootstrapClientMenu ()
  extends typingsSlinky.devexpressWeb.BootstrapClientMenu {
  /**
    * Occurs on the client side when a submenu closes.
    */
  /* CompleteClass */
  override var CloseUp: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemEventHandler[typingsSlinky.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ItemClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientMenuItemClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientMenuBase]
  ] = js.native
  /**
    * Occurs on the client side when the mouse cursor moves outside a menu item.
    */
  /* CompleteClass */
  override var ItemMouseOut: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientMenuItemMouseEventHandler[typingsSlinky.devexpressWeb.ASPxClientMenuBase]
  ] = js.native
  /**
    * Occurs on the client side when the mouse cursor is moved into a menu item.
    */
  /* CompleteClass */
  override var ItemMouseOver: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientMenuItemMouseEventHandler[typingsSlinky.devexpressWeb.ASPxClientMenuBase]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PopUp: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemEventHandler[typingsSlinky.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientMenuItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRootItem(): typingsSlinky.devexpressWeb.ASPxClientMenuItem = js.native
  /**
    * Returns the selected item within the menu control.
    */
  /* CompleteClass */
  override def GetSelectedItem(): typingsSlinky.devexpressWeb.ASPxClientMenuItem = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typingsSlinky.devexpressWeb.ASPxClientMenuItem): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typingsSlinky.devexpressWeb.BootstrapClientMenuItem): Unit = js.native
  /**
    * Specifies whether a control is displayed.
