...
class ASPxClientImage ()
  extends typingsSlinky.devexpressWeb.ASPxClientImage
object ASPxClientImage {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientImage.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientImage = js.native
}
