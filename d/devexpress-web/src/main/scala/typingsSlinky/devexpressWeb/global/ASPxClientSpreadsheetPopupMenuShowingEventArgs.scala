...
class ASPxClientSpreadsheetPopupMenuShowingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuShowingEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var menuItems: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection = js.native
  /**
    * Gets the currently displayed context menu's type.
    */
  /* CompleteClass */
  override var menuType: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuType = js.native
}
