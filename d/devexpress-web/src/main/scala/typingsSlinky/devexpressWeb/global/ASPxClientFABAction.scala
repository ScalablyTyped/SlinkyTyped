...
@js.native
class ASPxClientFABAction ()
  extends typingsSlinky.devexpressWeb.ASPxClientFABAction {
  /**
    * Gets the FAB action item. Specifies the FAB action item.
    * @param index Specifies the item's index in the collection.
    */
  /* CompleteClass */
  override def GetActionItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientFABActionItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetActionItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientFABActionItem = js.native
  /**
