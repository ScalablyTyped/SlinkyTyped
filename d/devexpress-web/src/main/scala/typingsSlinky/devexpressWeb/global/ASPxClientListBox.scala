...
@js.native
class ASPxClientListBox ()
  extends typingsSlinky.devexpressWeb.ASPxClientListBox
object ASPxClientListBox {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientListBox.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientListBox = js.native
}
