...
class ASPxClientPanelBase ()
  extends typingsSlinky.devexpressWeb.ASPxClientPanelBase
object ASPxClientPanelBase {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientPanelBase.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientPanelBase = js.native
}
