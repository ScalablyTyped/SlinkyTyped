...
class BootstrapClientMenuItem ()
  extends typingsSlinky.devexpressWeb.BootstrapClientMenuItem {
  /**
  ...
  /* CompleteClass */
  @JSName("parent")
  override var parent_BootstrapClientMenuItem: typingsSlinky.devexpressWeb.BootstrapClientMenuItem = js.native
  /**
