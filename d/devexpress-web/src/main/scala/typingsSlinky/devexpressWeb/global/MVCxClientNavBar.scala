...
class MVCxClientNavBar ()
  extends typingsSlinky.devexpressWeb.MVCxClientNavBar {
  /**
  ...
  override var BeginCallback_MVCxClientNavBar: typingsSlinky.devexpressWeb.ASPxClientEvent[
    MVCxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.MVCxClientNavBar]
  ] = js.native
  /**
...
object MVCxClientNavBar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientNavBar = js.native
}
