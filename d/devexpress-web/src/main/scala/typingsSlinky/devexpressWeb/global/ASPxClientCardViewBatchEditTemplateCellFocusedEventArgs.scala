...
class ASPxClientCardViewBatchEditTemplateCellFocusedEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientCardViewBatchEditTemplateCellFocusedEventArgs {
  /**
    ...
    */
  def this(column: typingsSlinky.devexpressWeb.ASPxClientCardViewColumn) = this()
  /**
    * Gets the currently processed column.
    */
  /* CompleteClass */
  override var column: typingsSlinky.devexpressWeb.ASPxClientCardViewColumn = js.native
  /**
