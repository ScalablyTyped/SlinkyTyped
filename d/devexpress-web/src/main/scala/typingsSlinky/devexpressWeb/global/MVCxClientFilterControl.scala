...
import typingsSlinky.devexpressWeb.ASPxClientFilterAppliedEventHandler
...
class MVCxClientFilterControl ()
  extends typingsSlinky.devexpressWeb.MVCxClientFilterControl {
  /**
    * Occurs after a new filter expression has been applied.
    */
  /* CompleteClass */
  override var Applied: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientFilterAppliedEventHandler[typingsSlinky.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  /**
  ...
  override var BeginCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  /**
  ...
  override var CallbackError: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsSlinky.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  /**
  ...
  override var EndCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEditor(editorIndex: Double): typingsSlinky.devexpressWeb.ASPxClientEditBase = js.native
  /**
...
object MVCxClientFilterControl extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientFilterControl = js.native
}
