...
class ASPxClientLayoutItem ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var formLayout: typingsSlinky.devexpressWeb.ASPxClientFormLayout = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.devexpressWeb.ASPxClientLayoutItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientLayoutItem = js.native
  /**
