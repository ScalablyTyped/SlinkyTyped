...
class ChangeFloatingObjectRelativePositionCommand ()
  extends typingsSlinky.devexpressWeb.ChangeFloatingObjectRelativePositionCommand {
  /**
    ...
    */
  /* CompleteClass */
  override def execute(settings: typingsSlinky.devexpressWeb.FloatingObjectRelativePositionSettings): Boolean = js.native
  /**
    * Gets information about the command's state.
    */
  /* CompleteClass */
  override def getState(): typingsSlinky.devexpressWeb.CommandState[typingsSlinky.devexpressWeb.FloatingObjectRelativePositionSettings] = js.native
}
