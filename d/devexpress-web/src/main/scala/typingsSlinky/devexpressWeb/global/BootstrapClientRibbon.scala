...
import typingsSlinky.devexpressWeb.ASPxClientRibbonCommandExecutedEventHandler
import typingsSlinky.devexpressWeb.ASPxClientRibbonDialogBoxLauncherClickedEventHandler
import typingsSlinky.devexpressWeb.ASPxClientRibbonMinimizationStateEventHandler
import typingsSlinky.devexpressWeb.ASPxClientRibbonTabEventHandler
...
class BootstrapClientRibbon ()
  extends typingsSlinky.devexpressWeb.BootstrapClientRibbon {
  /**
    * Fires on the client side after the active tab has been changed within a ribbon control.
    */
  /* CompleteClass */
  override var ActiveTabChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientRibbonTabEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]] = js.native
  /**
    * Occurs after an end-user executes an action on a ribbon item.
    */
  /* CompleteClass */
  override var CommandExecuted: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientRibbonCommandExecutedEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]
  ] = js.native
  /**
    * Fires on the client side after a dialog box launcher has been clicked.
    */
  /* CompleteClass */
  override var DialogBoxLauncherClicked: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientRibbonDialogBoxLauncherClickedEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]
  ] = js.native
  /**
    * Occurs when the file tab is clicked.
    */
  /* CompleteClass */
  override var FileTabClicked: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var KeyTipsClosedOnEscape: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]] = js.native
  /**
    * Occurs on the client side when the ribbon minimization state is changed by end-user actions.
    */
  /* CompleteClass */
  override var MinimizationStateChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientRibbonMinimizationStateEventHandler[typingsSlinky.devexpressWeb.ASPxClientRibbon]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetActiveTab(): typingsSlinky.devexpressWeb.ASPxClientRibbonTab = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientRibbonItem = js.native
  /**
  ...
  /* CompleteClass */
  override def GetQuickAccessToolbarItem(name: String): typingsSlinky.devexpressWeb.ASPxClientRibbonItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetTab(index: Double): typingsSlinky.devexpressWeb.ASPxClientRibbonTab = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetTabByName(name: String): typingsSlinky.devexpressWeb.ASPxClientRibbonTab = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetActiveTab(tab: typingsSlinky.devexpressWeb.ASPxClientRibbonTab): Unit = js.native
  /**
