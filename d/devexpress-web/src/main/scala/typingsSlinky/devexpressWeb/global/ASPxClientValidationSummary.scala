...
import typingsSlinky.devexpressWeb.ASPxClientValidationSummaryVisibilityChangedEventHandler
...
class ASPxClientValidationSummary ()
  extends typingsSlinky.devexpressWeb.ASPxClientValidationSummary {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var VisibilityChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientValidationSummaryVisibilityChangedEventHandler[typingsSlinky.devexpressWeb.ASPxClientValidationSummary]
  ] = js.native
  /**
