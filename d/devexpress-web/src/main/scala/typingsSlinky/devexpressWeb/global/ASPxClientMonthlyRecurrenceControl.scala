...
/**
  ...
  */
@JSGlobal("ASPxClientMonthlyRecurrenceControl")
@js.native
class ASPxClientMonthlyRecurrenceControl ()
  extends typingsSlinky.devexpressWeb.ASPxClientMonthlyRecurrenceControl {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def CreateValueAccessor(): typingsSlinky.devexpressWeb.DefaultRecurrenceRuleValuesAccessor = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Update(recurrenceInfo: typingsSlinky.devexpressWeb.ASPxClientRecurrenceInfo): Unit = js.native
}
