...
class ASPxClientRibbon ()
  extends typingsSlinky.devexpressWeb.ASPxClientRibbon
object ASPxClientRibbon {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientRibbon.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientRibbon = js.native
}
