...
class ASPxClientDiagramCoordinates ()
  extends typingsSlinky.devexpressWeb.ASPxClientDiagramCoordinates {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var dateTimeArgument: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var pane: typingsSlinky.devexpressWeb.ASPxClientXYDiagramPane = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetAxisValue(axis: typingsSlinky.devexpressWeb.ASPxClientAxisBase): typingsSlinky.devexpressWeb.ASPxClientAxisValue = js.native
  /**
