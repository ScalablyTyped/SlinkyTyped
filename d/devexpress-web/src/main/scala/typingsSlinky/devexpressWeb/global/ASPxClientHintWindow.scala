...
class ASPxClientHintWindow ()
  extends typingsSlinky.devexpressWeb.ASPxClientHintWindow {
  /**
    ...
    */
  /* CompleteClass */
  override def SetContent(html: js.Any, options: typingsSlinky.devexpressWeb.ASPxClientHintOptions): Unit = js.native
  /**
