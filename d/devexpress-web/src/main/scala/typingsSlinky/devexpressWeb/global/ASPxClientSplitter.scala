...
import typingsSlinky.devexpressWeb.ASPxClientSplitterPaneCancelEventHandler
import typingsSlinky.devexpressWeb.ASPxClientSplitterPaneEventHandler
...
class ASPxClientSplitter ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaneCollapsed: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    * Fires before a pane is collapsed.
    */
  /* CompleteClass */
  override var PaneCollapsing: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    * Fires after a specific web page has been loaded into a pane.
    */
  /* CompleteClass */
  override var PaneContentUrlLoaded: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneExpanded: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneExpanding: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneResizeCompleted: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneResized: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneResizing: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPane(index: Double): typingsSlinky.devexpressWeb.ASPxClientSplitterPane = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetPaneByName(name: String): typingsSlinky.devexpressWeb.ASPxClientSplitterPane = js.native
  /**
