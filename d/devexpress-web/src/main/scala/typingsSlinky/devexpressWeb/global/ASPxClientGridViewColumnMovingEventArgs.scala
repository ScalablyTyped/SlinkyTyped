...
class ASPxClientGridViewColumnMovingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGridViewColumnMovingEventArgs {
  /**
    ...
    */
  def this(
    sourceColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn,
    destinationColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn,
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var destinationColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var sourceColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn = js.native
}
