...
class ASPxClientWebDocumentViewer ()
  extends typingsSlinky.devexpressWeb.ASPxClientWebDocumentViewer
object ASPxClientWebDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientWebDocumentViewer.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientWebDocumentViewer = js.native
}
