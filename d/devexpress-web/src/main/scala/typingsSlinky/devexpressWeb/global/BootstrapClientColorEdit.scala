...
class BootstrapClientColorEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientColorEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ColorChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientColorEdit]
  ] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientColorEdit: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientColorEdit]
  ] = js.native
  /**
