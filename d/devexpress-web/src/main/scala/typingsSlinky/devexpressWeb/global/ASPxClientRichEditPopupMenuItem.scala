...
class ASPxClientRichEditPopupMenuItem ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSubItems(): typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection = js.native
}
