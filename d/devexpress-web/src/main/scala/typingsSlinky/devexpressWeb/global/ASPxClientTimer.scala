...
class ASPxClientTimer ()
  extends typingsSlinky.devexpressWeb.ASPxClientTimer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Tick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientTimer]
  ] = js.native
  /**
...
object ASPxClientTimer extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientTimer = js.native
}
