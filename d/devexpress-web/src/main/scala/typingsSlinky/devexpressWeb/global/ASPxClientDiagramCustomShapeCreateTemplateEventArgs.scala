...
class ASPxClientDiagramCustomShapeCreateTemplateEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientDiagramCustomShapeCreateTemplateEventArgs {
  /**
    ...
    */
  def this(container: js.Any, item: typingsSlinky.devexpressWeb.DiagramShape) = this()
}
