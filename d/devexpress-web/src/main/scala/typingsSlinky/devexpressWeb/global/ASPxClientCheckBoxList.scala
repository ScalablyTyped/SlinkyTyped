...
import typingsSlinky.devexpressWeb.ASPxClientListEditItemSelectedChangedEventHandler
...
class ASPxClientCheckBoxList ()
  extends typingsSlinky.devexpressWeb.ASPxClientCheckBoxList {
  /**
  ...
  override var SelectedIndexChanged_ASPxClientCheckBoxList: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientListEditItemSelectedChangedEventHandler[typingsSlinky.devexpressWeb.ASPxClientCheckBoxList]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSelectedItems(): js.Array[typingsSlinky.devexpressWeb.ASPxClientListEditItem] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SelectItems(items: js.Array[typingsSlinky.devexpressWeb.ASPxClientListEditItem]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def UnselectItems(items: js.Array[typingsSlinky.devexpressWeb.ASPxClientListEditItem]): Unit = js.native
  /**
...
object ASPxClientCheckBoxList extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCheckBoxList = js.native
}
