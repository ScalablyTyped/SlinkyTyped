...
class ChangeCustomNumberingListCommand ()
  extends typingsSlinky.devexpressWeb.ChangeCustomNumberingListCommand {
  /**
  ...
  override def execute(
    ...
    listLevelSettings: js.Array[typingsSlinky.devexpressWeb.ListLevelSettings]
  ): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getState(abstractNumberingListIndex: Double): typingsSlinky.devexpressWeb.CommandState[js.Array[typingsSlinky.devexpressWeb.ListLevelSettings]] = js.native
}
