...
class ASPxClientRibbonDialogBoxLauncherClickedEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientRibbonDialogBoxLauncherClickedEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var group: typingsSlinky.devexpressWeb.ASPxClientRibbonGroup = js.native
  /**
