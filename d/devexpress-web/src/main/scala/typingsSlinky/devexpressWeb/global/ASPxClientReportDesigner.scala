...
class ASPxClientReportDesigner ()
  extends typingsSlinky.devexpressWeb.ASPxClientReportDesigner
object ASPxClientReportDesigner {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientReportDesigner.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientReportDesigner = js.native
}
