...
import typingsSlinky.devexpressWeb.ASPxClientRatingControlItemClickEventHandler
import typingsSlinky.devexpressWeb.ASPxClientRatingControlItemMouseEventHandler
...
class ASPxClientRatingControl ()
  extends typingsSlinky.devexpressWeb.ASPxClientRatingControl {
  /**
  ...
  override var ItemClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientRatingControlItemClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientRatingControl]
  ] = js.native
  /**
  ...
  override var ItemMouseOut: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientRatingControlItemMouseEventHandler[typingsSlinky.devexpressWeb.ASPxClientRatingControl]
  ] = js.native
  /**
...
object ASPxClientRatingControl extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientRatingControl = js.native
}
