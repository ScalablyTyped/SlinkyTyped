...
class ASPxClientTimeEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientTimeEdit {
  /**
  ...
  override var DateChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientTimeEdit]
  ] = js.native
  /**
...
object ASPxClientTimeEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientTimeEdit = js.native
}
