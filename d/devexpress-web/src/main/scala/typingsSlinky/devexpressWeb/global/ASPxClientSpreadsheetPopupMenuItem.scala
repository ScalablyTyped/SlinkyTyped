...
@js.native
class ASPxClientSpreadsheetPopupMenuItem ()
  extends typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSubItems(): typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection = js.native
}
