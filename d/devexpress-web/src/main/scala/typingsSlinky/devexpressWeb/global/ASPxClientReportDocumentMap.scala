...
/**
  ...
  */
@JSGlobal("ASPxClientReportDocumentMap")
@js.native
class ASPxClientReportDocumentMap ()
  extends typingsSlinky.devexpressWeb.ASPxClientReportDocumentMap {
  /**
    * Occurs after the content of the Document Viewer's document map is updated.
    */
  /* CompleteClass */
  override var ContentChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientReportDocumentMap]] = js.native
  /**
