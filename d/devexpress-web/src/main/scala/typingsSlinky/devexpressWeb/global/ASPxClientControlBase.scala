...
class ASPxClientControlBase ()
  extends typingsSlinky.devexpressWeb.ASPxClientControlBase
object ASPxClientControlBase {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientControlBase.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientControlBase = js.native
}
