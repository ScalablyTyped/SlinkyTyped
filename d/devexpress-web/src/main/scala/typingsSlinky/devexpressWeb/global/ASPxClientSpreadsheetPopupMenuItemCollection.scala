...
class ASPxClientSpreadsheetPopupMenuItemCollection ()
  extends typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection {
  /**
    ...
    */
  /* CompleteClass */
  override def Add(item: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Get(index: Double): typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetByName(name: String): typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Insert(index: Double, item: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem): Unit = js.native
  /**
