...
class ChangeFontFormattingCommand ()
  extends typingsSlinky.devexpressWeb.ChangeFontFormattingCommand {
  /**
    ...
    */
  /* CompleteClass */
  override def execute(settings: typingsSlinky.devexpressWeb.FontFormattingSettings): Boolean = js.native
  /**
    * Gets information about the command's state.
    */
  /* CompleteClass */
  override def getState(): typingsSlinky.devexpressWeb.CommandState[typingsSlinky.devexpressWeb.FontFormattingSettings] = js.native
}
