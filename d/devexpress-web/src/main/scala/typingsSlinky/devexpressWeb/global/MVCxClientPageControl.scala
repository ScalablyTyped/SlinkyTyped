...
@js.native
class MVCxClientPageControl ()
  extends typingsSlinky.devexpressWeb.MVCxClientPageControl {
  /**
...
object MVCxClientPageControl extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientPageControl = js.native
}
