...
class ASPxClientNavBarItemEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientNavBarItemEventArgs {
  /**
  ...
  def this(
    ...
    item: typingsSlinky.devexpressWeb.ASPxClientNavBarItem,
    htmlElement: js.Any,
    htmlEvent: js.Any
  ) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var item: typingsSlinky.devexpressWeb.ASPxClientNavBarItem = js.native
  /**
