...
class ASPxClientReportToolbar ()
  extends typingsSlinky.devexpressWeb.ASPxClientReportToolbar {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemTemplateControl(name: String): typingsSlinky.devexpressWeb.ASPxClientControl = js.native
  /**
...
object ASPxClientReportToolbar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientReportToolbar = js.native
}
