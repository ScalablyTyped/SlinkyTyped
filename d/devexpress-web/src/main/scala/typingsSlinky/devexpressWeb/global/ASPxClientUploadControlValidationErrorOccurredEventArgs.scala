...
class ASPxClientUploadControlValidationErrorOccurredEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientUploadControlValidationErrorOccurredEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var invalidFiles: js.Array[typingsSlinky.devexpressWeb.ASPxClientUploadControlInvalidFileInfo] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var validationSettings: typingsSlinky.devexpressWeb.ASPxClientUploadControlValidationSettings = js.native
}
