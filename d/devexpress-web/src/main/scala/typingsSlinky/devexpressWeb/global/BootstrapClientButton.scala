...
import typingsSlinky.devexpressWeb.ASPxClientButtonClickEventHandler
...
@js.native
class BootstrapClientButton ()
  extends typingsSlinky.devexpressWeb.BootstrapClientButton {
  /**
  ...
  override var CheckedChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientButton]
  ] = js.native
  /**
    * Occurs on the client side after a button is clicked.
    */
  /* CompleteClass */
  override var Click: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientButtonClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientButton]] = js.native
  /**
    * Fires on the client side when the button receives input focus.
    */
  /* CompleteClass */
  override var GotFocus: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientButton]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var LostFocus: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientButton]] = js.native
  /**
