...
class ASPxClientGridBatchEditSummaryDisplayTextEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGridBatchEditSummaryDisplayTextEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var summaryType: typingsSlinky.devexpressWeb.ASPxClientSummaryItemType = js.native
  /**
