...
import typingsSlinky.devexpressWeb.ASPxClientDashboardItemRequestUnderlyingDataCompleted
...
class ASPxClientDashboardItemClickEventArgs ()
  extends typingsSlinky.devexpressWeb.ASPxClientDashboardItemClickEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetAxisPoint(axisName: String): typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPoint = js.native
  /**
    * Gets the dashboard item's client data.
    */
  /* CompleteClass */
  override def GetData(): typingsSlinky.devexpressWeb.ASPxClientDashboardItemData = js.native
  /**
    * Gets deltas corresponding to the clicked visual element.
    */
  /* CompleteClass */
  override def GetDeltas(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataDelta] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetDimensions(axisName: String): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataDimension] = js.native
  /**
    * Gets measures corresponding to the clicked visual element.
    */
  /* CompleteClass */
  override def GetMeasures(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataMeasure] = js.native
  /**
