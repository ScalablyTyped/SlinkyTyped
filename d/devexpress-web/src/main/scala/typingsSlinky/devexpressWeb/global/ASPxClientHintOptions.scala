...
import typingsSlinky.devexpressWeb.ASPxClientHintHidingEventHandler
...
class ASPxClientHintOptions ()
  extends typingsSlinky.devexpressWeb.ASPxClientHintOptions {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var onHiding: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientHintHidingEventHandler] = js.native
  /**
    * A handler for the ASPxClientHint.Showing event.
    */
  /* CompleteClass */
  override var onShowing: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientHintShowingEventHandler] = js.native
  /**
