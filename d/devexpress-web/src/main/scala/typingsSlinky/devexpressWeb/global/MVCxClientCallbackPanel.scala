...
@js.native
class MVCxClientCallbackPanel ()
  extends typingsSlinky.devexpressWeb.MVCxClientCallbackPanel {
  /**
    * Occurs when the expanded panel is closed.
    */
  /* CompleteClass */
  override var Collapsed: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientPanel]] = js.native
  /**
    * Occurs when an end-user opens the expand panel.
    */
  /* CompleteClass */
  override var Expanded: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientPanel]] = js.native
  /**
...
object MVCxClientCallbackPanel extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientCallbackPanel = js.native
}
