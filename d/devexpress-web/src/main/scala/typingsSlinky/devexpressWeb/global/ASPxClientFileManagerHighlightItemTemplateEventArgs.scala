...
class ASPxClientFileManagerHighlightItemTemplateEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientFileManagerHighlightItemTemplateEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var templateElement: String = js.native
}
