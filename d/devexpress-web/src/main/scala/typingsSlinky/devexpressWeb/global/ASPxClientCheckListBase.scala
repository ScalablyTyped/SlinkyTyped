...
class ASPxClientCheckListBase ()
  extends typingsSlinky.devexpressWeb.ASPxClientCheckListBase {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var SelectedIndexChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientListEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientListEditItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSelectedItem(): typingsSlinky.devexpressWeb.ASPxClientListEditItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typingsSlinky.devexpressWeb.ASPxClientListEditItem): Unit = js.native
  /**
