...
class BootstrapClientAccordionItem ()
  extends typingsSlinky.devexpressWeb.BootstrapClientAccordionItem {
  /**
  ...
  /* CompleteClass */
  @JSName("group")
  override var group_BootstrapClientAccordionItem: typingsSlinky.devexpressWeb.BootstrapClientAccordionGroup = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("navBar")
  override var navBar_BootstrapClientAccordionItem: typingsSlinky.devexpressWeb.BootstrapClientAccordion = js.native
  /**
