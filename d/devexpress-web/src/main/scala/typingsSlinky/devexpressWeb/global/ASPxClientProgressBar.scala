...
class ASPxClientProgressBar ()
  extends typingsSlinky.devexpressWeb.ASPxClientProgressBar
object ASPxClientProgressBar {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientProgressBar.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientProgressBar = js.native
}
