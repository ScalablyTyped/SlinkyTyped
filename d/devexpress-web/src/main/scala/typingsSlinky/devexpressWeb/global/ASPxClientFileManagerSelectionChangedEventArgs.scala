...
class ASPxClientFileManagerSelectionChangedEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientFileManagerSelectionChangedEventArgs {
  /**
    ...
    */
  def this(
    item: typingsSlinky.devexpressWeb.ASPxClientFileManagerItem,
    name: String,
    fullName: String,
    isSelected: Boolean
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var item: typingsSlinky.devexpressWeb.ASPxClientFileManagerItem = js.native
  /**
