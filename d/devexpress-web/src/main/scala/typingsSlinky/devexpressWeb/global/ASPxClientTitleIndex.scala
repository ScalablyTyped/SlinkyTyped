...
import typingsSlinky.devexpressWeb.ASPxClientTitleIndexItemEventHandler
...
class ASPxClientTitleIndex ()
  extends typingsSlinky.devexpressWeb.ASPxClientTitleIndex {
  /**
    * Occurs when a callback for server-side processing is initiated.
    */
  /* CompleteClass */
  override var BeginCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientTitleIndex]
  ] = js.native
  /**
  ...
  override var CallbackError: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsSlinky.devexpressWeb.ASPxClientTitleIndex]
  ] = js.native
  /**
  ...
  override var EndCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientTitleIndex]
  ] = js.native
  /**
  ...
  override var ItemClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientTitleIndexItemEventHandler[typingsSlinky.devexpressWeb.ASPxClientTitleIndex]
  ] = js.native
  /**
...
object ASPxClientTitleIndex extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientTitleIndex = js.native
}
