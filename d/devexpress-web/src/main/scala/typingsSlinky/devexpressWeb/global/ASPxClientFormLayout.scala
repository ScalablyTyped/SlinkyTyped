...
class ASPxClientFormLayout ()
  extends typingsSlinky.devexpressWeb.ASPxClientFormLayout
object ASPxClientFormLayout {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientFormLayout.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientFormLayout = js.native
}
