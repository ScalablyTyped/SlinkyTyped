...
@js.native
class ASPxClientCardViewBatchEditChangesSavingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientCardViewBatchEditChangesSavingEventArgs {
  /**
