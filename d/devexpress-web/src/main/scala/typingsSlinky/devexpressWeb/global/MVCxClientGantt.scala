...
class MVCxClientGantt ()
  extends typingsSlinky.devexpressWeb.ASPxClientGantt {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetTaskTitlePosition(position: typingsSlinky.devexpressWeb.ASPxClientGanttTaskTitlePosition): Unit = js.native
  /**
    * Specifies the view type.
    * @param viewType The control's view type.
    */
  /* CompleteClass */
  override def SetViewType(viewType: typingsSlinky.devexpressWeb.ASPxClientGanttViewType): Unit = js.native
  /**
    * Specifies whether a control is displayed.
...
object MVCxClientGantt extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientGantt = js.native
}
