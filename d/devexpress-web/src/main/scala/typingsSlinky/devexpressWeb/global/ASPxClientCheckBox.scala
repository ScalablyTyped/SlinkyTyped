...
class ASPxClientCheckBox ()
  extends typingsSlinky.devexpressWeb.ASPxClientCheckBox {
  /**
  ...
  override var CheckedChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientCheckBox]
  ] = js.native
  /**
...
object ASPxClientCheckBox extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
}
