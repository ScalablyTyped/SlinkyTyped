...
class ASPxClientChartPrintOptions ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetCustomPaperHeight(customPaperHeight: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetCustomPaperName(customPaperName: String): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetCustomPaperWidth(customPaperWidth: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetLandscape(landscape: Boolean): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetMarginBottom(marginBottom: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetMarginLeft(marginLeft: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetMarginRight(marginRight: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetMarginTop(marginTop: Double): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetPaperKind(paperKind: String): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetPrintCrosshair(printCrosshair: Boolean): Unit = js.native
  /**
    * Sets the size mode used to print a chart.
    * @param sizeMode A System.String object, specifying the name of the size mode.
    */
  /* CompleteClass */
  override def SetSizeMode(sizeMode: String): Unit = js.native
}
