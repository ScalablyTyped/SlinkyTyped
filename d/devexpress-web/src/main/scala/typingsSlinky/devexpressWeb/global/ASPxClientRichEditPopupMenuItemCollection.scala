...
class ASPxClientRichEditPopupMenuItemCollection ()
  extends typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection {
  /**
    ...
    */
  /* CompleteClass */
  override def Add(item: typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Get(index: Double): typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetByName(name: String): typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Insert(index: Double, item: typingsSlinky.devexpressWeb.ASPxClientRichEditPopupMenuItem): Unit = js.native
  /**
