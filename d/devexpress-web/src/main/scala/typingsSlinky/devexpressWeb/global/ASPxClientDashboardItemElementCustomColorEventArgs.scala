...
class ASPxClientDashboardItemElementCustomColorEventArgs ()
  extends typingsSlinky.devexpressWeb.ASPxClientDashboardItemElementCustomColorEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetTargetElement(): typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple = js.native
  /**
