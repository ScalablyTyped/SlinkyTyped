...
class ListLevelSettings ()
  extends typingsSlinky.devexpressWeb.ListLevelSettings {
  /**
    * Gets or sets the paragraph text alignment within numbered list levels.
    */
  /* CompleteClass */
  override var alignment: typingsSlinky.devexpressWeb.ListLevelNumberAlignment = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var firstLineIndentType: typingsSlinky.devexpressWeb.ParagraphFirstLineIndent = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var format: typingsSlinky.devexpressWeb.ListLevelFormat = js.native
  /**
