...
@js.native
class ASPxClientHtmlEditorVideoDialog ()
  extends typingsSlinky.devexpressWeb.ASPxClientHtmlEditorVideoDialog {
  /**
    * Provides access to the client object of the "Auto play" check box in the Html Editor's Video dialog.
    */
  /* CompleteClass */
  override def GetAutoPlayCheckBox(): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetLoopCheckBox(): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetMediaFileSelector(): typingsSlinky.devexpressWeb.ASPxClientMediaFileSelector = js.native
  /**
    * Provides access to the client object of the "More options" check box in the Html Editor's Audio/Video/Flash/Image dialogs.
    */
  /* CompleteClass */
  override def GetMoreOptionsCheckBox(): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPositionComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
    * Provides access to the client object of the "Poster URL" text box in the Html Editor's Video dialog.
    */
  /* CompleteClass */
  override def GetPosterTextBox(): typingsSlinky.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Preload mode" combo box in the Html Editor's Video dialog.
    */
  /* CompleteClass */
  override def GetPreloadModeComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetWidthSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
}
