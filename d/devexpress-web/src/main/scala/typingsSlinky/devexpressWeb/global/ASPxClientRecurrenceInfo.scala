...
class ASPxClientRecurrenceInfo ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRecurrenceType(): typingsSlinky.devexpressWeb.ASPxClientRecurrenceType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceType(`type`: typingsSlinky.devexpressWeb.ASPxClientRecurrenceType): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetWeekDays(weekDays: typingsSlinky.devexpressWeb.ASPxClientWeekDays): Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def SetWeekOfMonth(weekOfMonth: typingsSlinky.devexpressWeb.ASPxClientWeekOfMonth): Unit = js.native
}
