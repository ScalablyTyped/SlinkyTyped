...
class ASPxClientRecurrenceTypeEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientRecurrenceTypeEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceType(recurrenceType: typingsSlinky.devexpressWeb.ASPxClientRecurrenceType): Unit = js.native
  /**
