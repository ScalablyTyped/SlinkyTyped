...
class ASPxClientFileManagerToolbarItem ()
  extends typingsSlinky.devexpressWeb.ASPxClientFileManagerToolbarItem {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var menu: typingsSlinky.devexpressWeb.ASPxClientMenuBase = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.devexpressWeb.ASPxClientMenuItem = js.native
  /**
