...
class ASPxClientAppointmentDeletingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientAppointmentDeletingEventArgs {
  /**
    ...
    */
  def this(appointments: js.Array[typingsSlinky.devexpressWeb.ASPxClientAppointment]) = this()
  /**
