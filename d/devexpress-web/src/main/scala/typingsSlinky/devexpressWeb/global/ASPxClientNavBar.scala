...
class ASPxClientNavBar ()
  extends typingsSlinky.devexpressWeb.ASPxClientNavBar
object ASPxClientNavBar {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientNavBar.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientNavBar = js.native
}
