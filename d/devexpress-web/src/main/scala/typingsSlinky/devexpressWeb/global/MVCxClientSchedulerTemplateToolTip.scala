...
class MVCxClientSchedulerTemplateToolTip ()
  extends typingsSlinky.devexpressWeb.MVCxClientSchedulerTemplateToolTip {
  /**
    * Gets the tooltip type.
    */
  /* CompleteClass */
  override var `type`: typingsSlinky.devexpressWeb.MVCxSchedulerToolTipType = js.native
  /**
