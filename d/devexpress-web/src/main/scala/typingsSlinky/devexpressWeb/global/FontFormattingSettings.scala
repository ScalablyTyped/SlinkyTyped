...
class FontFormattingSettings ()
  extends typingsSlinky.devexpressWeb.FontFormattingSettings {
  /**
    * Gets or sets a value indicating whether all characters are capital letters.
    */
  /* CompleteClass */
  override var allCaps: Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var foreColor: String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var script: typingsSlinky.devexpressWeb.CharacterFormattingScript = js.native
  /**
