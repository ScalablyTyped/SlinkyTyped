...
class ASPxClientGlobalCallbackErrorEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGlobalCallbackErrorEventArgs {
  /**
    ...
    */
  def this(control: typingsSlinky.devexpressWeb.ASPxClientControl, message: String) = this()
}
