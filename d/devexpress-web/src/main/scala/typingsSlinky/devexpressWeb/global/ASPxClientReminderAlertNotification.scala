...
class ASPxClientReminderAlertNotification ()
  extends typingsSlinky.devexpressWeb.ASPxClientReminderAlertNotification {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var reminder: typingsSlinky.devexpressWeb.ASPxClientReminder = js.native
  /**
    * Gets the appointment associated with the reminder.
    */
  /* CompleteClass */
  override def GetAppointment(): typingsSlinky.devexpressWeb.ASPxClientAppointment = js.native
  /**
    * Gets the triggered reminder.
    */
  /* CompleteClass */
  override def GetReminder(): typingsSlinky.devexpressWeb.ASPxClientReminder = js.native
  /**
