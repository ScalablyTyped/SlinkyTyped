...
class MVCxClientCalendar ()
  extends typingsSlinky.devexpressWeb.MVCxClientCalendar {
  /**
  ...
  override var BeginCallback_MVCxClientCalendar: typingsSlinky.devexpressWeb.ASPxClientEvent[
    MVCxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.MVCxClientCalendar]
  ] = js.native
  /**
...
object MVCxClientCalendar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientCalendar = js.native
}
