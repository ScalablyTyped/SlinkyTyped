...
class ASPxClientFloatingActionButtonContextChangingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientFloatingActionButtonContextChangingEventArgs {
  /**
    ...
    */
  def this(action: typingsSlinky.devexpressWeb.ASPxClientFABAction) = this()
}
