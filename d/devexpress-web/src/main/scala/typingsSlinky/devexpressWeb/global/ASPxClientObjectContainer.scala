...
import typingsSlinky.devexpressWeb.ASPxClientFlashScriptCommandEventHandler
...
class ASPxClientObjectContainer ()
  extends typingsSlinky.devexpressWeb.ASPxClientObjectContainer {
  /**
    * Occurs on the client side when the FSCommand action is called within the associated flash object's action script.
    */
  /* CompleteClass */
  override var FlashScriptCommand: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientFlashScriptCommandEventHandler[typingsSlinky.devexpressWeb.ASPxClientObjectContainer]
  ] = js.native
  /**
...
object ASPxClientObjectContainer extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientObjectContainer = js.native
}
