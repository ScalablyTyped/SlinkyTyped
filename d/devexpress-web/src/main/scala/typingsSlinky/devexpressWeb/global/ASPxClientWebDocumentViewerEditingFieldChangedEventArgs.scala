...
class ASPxClientWebDocumentViewerEditingFieldChangedEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientWebDocumentViewerEditingFieldChangedEventArgs {
  /**
    ...
    */
  def this(
    field: typingsSlinky.devexpressWeb.ASPxClientWebDocumentViewerEditingField,
    oldValue: js.Any,
    newValue: js.Any
  ) = this()
  /**
    ...
    */
  /* CompleteClass */
  override var Field: typingsSlinky.devexpressWeb.ASPxClientWebDocumentViewerEditingField = js.native
  /**
