...
class ASPxClientHint ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Hiding: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientHintHidingEventHandler] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Showing: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientHintShowingEventHandler] = js.native
  /**
