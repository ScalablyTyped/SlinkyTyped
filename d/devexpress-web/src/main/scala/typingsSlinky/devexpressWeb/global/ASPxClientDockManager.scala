...
class ASPxClientDockManager ()
  extends typingsSlinky.devexpressWeb.ASPxClientDockManager
object ASPxClientDockManager {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientDockManager.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientDockManager = js.native
}
