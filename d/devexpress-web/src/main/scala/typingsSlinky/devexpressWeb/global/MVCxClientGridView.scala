...
import typingsSlinky.devexpressWeb.ASPxClientGridBatchEditSummaryDisplayTextEventHandler
import typingsSlinky.devexpressWeb.ASPxClientGridToolbarItemClickEventHandler
...
@js.native
class MVCxClientGridView ()
  extends typingsSlinky.devexpressWeb.MVCxClientGridView {
  /**
    * Fires when a user changes the summary item value.
    */
  /* CompleteClass */
  override var BatchEditSummaryDisplayText: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientGridBatchEditSummaryDisplayTextEventHandler[typingsSlinky.devexpressWeb.ASPxClientGridBase]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ToolbarItemClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientGridToolbarItemClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientGridBase]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetToolbar(index: Double): typingsSlinky.devexpressWeb.ASPxClientMenu = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetToolbarByName(name: String): typingsSlinky.devexpressWeb.ASPxClientMenu = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
...
object MVCxClientGridView extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientGridView = js.native
}
