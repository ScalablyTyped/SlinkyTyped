...
class ASPxClientDashboardParameter ()
  extends typingsSlinky.devexpressWeb.ASPxClientDashboardParameter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValues(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardParameterValue] = js.native
  /**
