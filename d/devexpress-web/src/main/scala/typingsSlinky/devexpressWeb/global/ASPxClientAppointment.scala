...
class ASPxClientAppointment ()
  extends typingsSlinky.devexpressWeb.ASPxClientAppointment {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var appointmentType: typingsSlinky.devexpressWeb.ASPxAppointmentType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var labelIndex: Double = js.native
  /**
    * Gets resources associated with the appointment.
    */
  /* CompleteClass */
  override var resources: js.Array[String] = js.native
  /**
    * Gets the status index.
    */
  /* CompleteClass */
  override var statusIndex: Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetAppointmentType(): typingsSlinky.devexpressWeb.ASPxAppointmentType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRecurrenceInfo(): typingsSlinky.devexpressWeb.ASPxClientRecurrenceInfo = js.native
  /**
    * Gets the appointment that is the Appointment.RecurrencePattern for the current appointment.
    */
  /* CompleteClass */
  override def GetRecurrencePattern(): typingsSlinky.devexpressWeb.ASPxClientAppointment = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetAppointmentType(`type`: typingsSlinky.devexpressWeb.ASPxAppointmentType): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceInfo(recurrenceInfo: typingsSlinky.devexpressWeb.ASPxClientRecurrenceInfo): Unit = js.native
  /**
