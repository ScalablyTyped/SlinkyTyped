...
class ASPxClientRecurrenceRangeControl ()
  extends typingsSlinky.devexpressWeb.ASPxClientRecurrenceRangeControl {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRange(): typingsSlinky.devexpressWeb.ASPxClientRecurrenceRange = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRange(range: typingsSlinky.devexpressWeb.ASPxClientRecurrenceRange): Unit = js.native
  /**
    * Specifies whether a control is displayed.
