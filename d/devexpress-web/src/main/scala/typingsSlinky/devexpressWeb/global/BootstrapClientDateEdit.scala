...
import typingsSlinky.devexpressWeb.ASPxClientParseDateEventHandler
...
class BootstrapClientDateEdit ()
  extends typingsSlinky.devexpressWeb.BootstrapClientDateEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var CalendarCellClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCellClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
    * Allows you to disable the calendar's days.
    */
  /* CompleteClass */
  override var CalendarCustomDisabledDate: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCustomDisabledDateEventHandler[typingsSlinky.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var DateChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ParseDate: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientParseDateEventHandler[typingsSlinky.devexpressWeb.ASPxClientDateEdit]] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientDateEdit: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCalendar(): typingsSlinky.devexpressWeb.ASPxClientCalendar = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetTimeEdit(): typingsSlinky.devexpressWeb.ASPxClientTimeEdit = js.native
  /**
