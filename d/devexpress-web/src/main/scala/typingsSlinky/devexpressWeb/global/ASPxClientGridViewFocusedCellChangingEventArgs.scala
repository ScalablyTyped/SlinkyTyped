...
class ASPxClientGridViewFocusedCellChangingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGridViewFocusedCellChangingEventArgs {
  /**
    ...
    */
  def this(cellInfo: typingsSlinky.devexpressWeb.ASPxClientGridViewCellInfo) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var cellInfo: typingsSlinky.devexpressWeb.ASPxClientGridViewCellInfo = js.native
}
