...
class ASPxClientCrosshairOptions ()
  extends typingsSlinky.devexpressWeb.ASPxClientCrosshairOptions {
  /**
    * Gets the color of a crosshair argument line.
    */
  /* CompleteClass */
  override var argumentLineColor: String = js.native
  /**
