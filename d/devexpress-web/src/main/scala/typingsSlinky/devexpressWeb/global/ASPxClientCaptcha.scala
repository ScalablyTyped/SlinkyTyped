...
class ASPxClientCaptcha ()
  extends typingsSlinky.devexpressWeb.ASPxClientCaptcha
object ASPxClientCaptcha {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientCaptcha.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCaptcha = js.native
}
