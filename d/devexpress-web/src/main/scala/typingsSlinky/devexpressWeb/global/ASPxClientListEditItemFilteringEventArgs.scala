...
class ASPxClientListEditItemFilteringEventArgs ()
  extends typingsSlinky.devexpressWeb.ASPxClientListEditItemFilteringEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var item: typingsSlinky.devexpressWeb.ASPxClientListEditItem = js.native
}
