...
import typingsSlinky.devexpressWeb.ASPxClientButtonEditClickEventHandler
import typingsSlinky.devexpressWeb.ASPxClientCancelEventHandler
import typingsSlinky.devexpressWeb.ASPxClientDropDownCommandEventHandler
import typingsSlinky.devexpressWeb.ASPxClientEditKeyEventHandler
import typingsSlinky.devexpressWeb.ASPxClientEditValidationEventHandler
import typingsSlinky.devexpressWeb.ASPxClientEventHandler
import typingsSlinky.devexpressWeb.ASPxClientProcessingModeEventHandler
...
class ASPxClientDropDownEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientDropDownEdit {
  /**
    * Occurs on the client side after an editor button is clicked.
    */
  /* CompleteClass */
  override var ButtonClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientButtonEditClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientButtonEditBase]
  ] = js.native
  /**
    * Occurs on the client side when the <strong>drop down window</strong> is closed.
    */
  /* CompleteClass */
  override var CloseUp: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientDropDownEditBase]] = js.native
  /**
    * Occurs on the client-side when the <strong>drop down window</strong> is opened by the dropdown button click.
    */
  /* CompleteClass */
  override var DropDown: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientDropDownEditBase]] = js.native
  /**
    * Allows you to handle a click on 'Ok' and 'Cancel' buttons in the drop-down window.
    */
  /* CompleteClass */
  override var DropDownCommandButtonClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientDropDownCommandEventHandler[typingsSlinky.devexpressWeb.ASPxClientDropDownEdit]
  ] = js.native
  /**
    * Fires on the client side when the editor receives input focus.
    */
  /* CompleteClass */
  override var GotFocus: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var KeyDown: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Occurs on the client-side when an end-user presses and releases a key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyPress: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Occurs on the client-side when an end-user releases a pressed key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyUp: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Fires on the client side when the editor loses input focus.
    */
  /* CompleteClass */
  override var LostFocus: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientEdit]] = js.native
  /**
    * Occurs on the client side before the <strong>drop down window</strong> is closed and allows you to cancel the operation.
    */
  /* CompleteClass */
  override var QueryCloseUp: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientDropDownEditBase]
  ] = js.native
  /**
    * Fires on the client side when the editor's text is changed and focus moves out of the editor by end-user interactions.
    */
  /* CompleteClass */
  override var TextChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientTextEdit]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var UserInput: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsSlinky.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Allows you to specify whether the value entered into the editor is valid, and whether the editor is allowed to lose focus.
    */
  /* CompleteClass */
  override var Validation: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditValidationEventHandler[typingsSlinky.devexpressWeb.ASPxClientEdit]] = js.native
  /**
    * Fires after the editor's value has been changed by end-user interactions.
    */
  /* CompleteClass */
  override var ValueChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientEdit]] = js.native
  /**
...
object ASPxClientDropDownEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientDropDownEdit = js.native
}
