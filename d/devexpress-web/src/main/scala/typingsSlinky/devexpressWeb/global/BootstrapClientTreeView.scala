...
class BootstrapClientTreeView ()
  extends typingsSlinky.devexpressWeb.BootstrapClientTreeView {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedNode(node: typingsSlinky.devexpressWeb.BootstrapClientTreeViewNode): Unit = js.native
  /**
    * Specifies whether a control is displayed.
