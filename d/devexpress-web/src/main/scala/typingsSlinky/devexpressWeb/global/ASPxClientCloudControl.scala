...
import typingsSlinky.devexpressWeb.ASPxClientCloudControlItemEventHandler
...
@js.native
class ASPxClientCloudControl ()
  extends typingsSlinky.devexpressWeb.ASPxClientCloudControl {
  /**
  ...
  override var ItemClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCloudControlItemEventHandler[typingsSlinky.devexpressWeb.ASPxClientCloudControl]
  ] = js.native
  /**
...
object ASPxClientCloudControl extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCloudControl = js.native
}
