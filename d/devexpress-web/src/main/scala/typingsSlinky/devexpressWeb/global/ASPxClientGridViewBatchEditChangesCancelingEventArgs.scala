...
@js.native
class ASPxClientGridViewBatchEditChangesCancelingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGridViewBatchEditChangesCancelingEventArgs {
  /**
