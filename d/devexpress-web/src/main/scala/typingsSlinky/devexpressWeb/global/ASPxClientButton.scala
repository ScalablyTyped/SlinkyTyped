...
class ASPxClientButton ()
  extends typingsSlinky.devexpressWeb.ASPxClientButton
object ASPxClientButton {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientButton.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientButton = js.native
}
