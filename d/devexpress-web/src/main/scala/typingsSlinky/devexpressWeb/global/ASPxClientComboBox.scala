...
class ASPxClientComboBox ()
  extends typingsSlinky.devexpressWeb.ASPxClientComboBox
object ASPxClientComboBox {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientComboBox.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
}
