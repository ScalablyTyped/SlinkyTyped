...
class ASPxClientCallbackPanel ()
  extends typingsSlinky.devexpressWeb.ASPxClientCallbackPanel
object ASPxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientCallbackPanel.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCallbackPanel = js.native
}
