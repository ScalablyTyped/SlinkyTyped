...
class ASPxClientToolTipBase ()
  extends typingsSlinky.devexpressWeb.ASPxClientToolTipBase {
  /**
    ...
    */
  /* CompleteClass */
  override def CalculatePosition(bounds: js.Any): typingsSlinky.devexpressWeb.ASPxClientPoint = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def ConvertIntervalToString(interval: typingsSlinky.devexpressWeb.ASPxClientTimeInterval): String = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def FinalizeUpdate(toolTipData: typingsSlinky.devexpressWeb.ASPxClientSchedulerToolTipData): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Update(toolTipData: typingsSlinky.devexpressWeb.ASPxClientSchedulerToolTipData): Unit = js.native
}
