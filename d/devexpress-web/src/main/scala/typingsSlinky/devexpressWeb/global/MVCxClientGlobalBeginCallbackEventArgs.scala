...
class MVCxClientGlobalBeginCallbackEventArgs protected ()
  extends typingsSlinky.devexpressWeb.MVCxClientGlobalBeginCallbackEventArgs {
  /**
    ...
    */
  def this(control: typingsSlinky.devexpressWeb.ASPxClientControl, command: String) = this()
}
