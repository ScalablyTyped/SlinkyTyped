...
class ASPxClientLoadingPanel ()
  extends typingsSlinky.devexpressWeb.ASPxClientLoadingPanel {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def ShowAtPos(x: Double, y: Double): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def ShowInElementByID(id: String): Unit = js.native
}
...
object ASPxClientLoadingPanel extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientLoadingPanel = js.native
}
