...
@js.native
class ASPxClientQueryBuilder ()
  extends typingsSlinky.devexpressWeb.ASPxClientQueryBuilder
object ASPxClientQueryBuilder {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientQueryBuilder.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientQueryBuilder = js.native
}
