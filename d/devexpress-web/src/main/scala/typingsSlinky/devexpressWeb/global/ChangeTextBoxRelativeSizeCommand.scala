...
class ChangeTextBoxRelativeSizeCommand ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def execute(settings: typingsSlinky.devexpressWeb.TextBoxRelativeSizeSettings): Boolean = js.native
  /**
    * Gets information about the command's state.
    */
  /* CompleteClass */
  override def getState(): typingsSlinky.devexpressWeb.CommandState[typingsSlinky.devexpressWeb.TextBoxRelativeSizeSettings] = js.native
}
