...
class BootstrapClientAccordionGroup ()
  extends typingsSlinky.devexpressWeb.BootstrapClientAccordionGroup {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var navBar: typingsSlinky.devexpressWeb.ASPxClientNavBar = js.native
  /**
    * Gets the BootstrapClientAccordion object to which the current group belongs.
    */
  /* CompleteClass */
  @JSName("navBar")
  override var navBar_BootstrapClientAccordionGroup: typingsSlinky.devexpressWeb.BootstrapClientAccordion = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsSlinky.devexpressWeb.ASPxClientNavBarItem = js.native
  /**
