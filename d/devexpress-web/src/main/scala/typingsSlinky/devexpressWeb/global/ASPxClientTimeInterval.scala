...
class ASPxClientTimeInterval protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Contains(interval: typingsSlinky.devexpressWeb.ASPxClientTimeInterval): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def Equals(interval: typingsSlinky.devexpressWeb.ASPxClientTimeInterval): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def IntersectsWith(interval: typingsSlinky.devexpressWeb.ASPxClientTimeInterval): Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def IntersectsWithExcludingBounds(interval: typingsSlinky.devexpressWeb.ASPxClientTimeInterval): Boolean = js.native
  /**
