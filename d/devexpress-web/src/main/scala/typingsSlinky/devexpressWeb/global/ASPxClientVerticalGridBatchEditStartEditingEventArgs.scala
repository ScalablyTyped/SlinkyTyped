...
class ASPxClientVerticalGridBatchEditStartEditingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientVerticalGridBatchEditStartEditingEventArgs {
  /**
  ...
  def this(
    visibleIndex: Double,
    focusedRow: typingsSlinky.devexpressWeb.ASPxClientVerticalGridRow,
    recordValues: js.Any
  ) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var focusedRow: typingsSlinky.devexpressWeb.ASPxClientVerticalGridRow = js.native
  /**
