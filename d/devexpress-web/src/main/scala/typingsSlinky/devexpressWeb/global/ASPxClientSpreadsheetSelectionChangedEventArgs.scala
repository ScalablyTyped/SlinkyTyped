...
class ASPxClientSpreadsheetSelectionChangedEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientSpreadsheetSelectionChangedEventArgs {
  /**
    ...
    */
  def this(selection: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetSelection) = this()
  /**
    * Gets an object that determines the currently selected region within the Spreadsheet.
    */
  /* CompleteClass */
  override var selection: typingsSlinky.devexpressWeb.ASPxClientSpreadsheetSelection = js.native
}
