...
class ASPxClientDashboardItemVisualInteractivityEventArgs ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetDefaultSelection(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetDefaultSelection(values: js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple]): Unit = js.native
  /**
