...
class BootstrapClientAccordionItemEventArgs protected ()
  extends typingsSlinky.devexpressWeb.BootstrapClientAccordionItemEventArgs {
  /**
  ...
  def this(
    ...
    item: typingsSlinky.devexpressWeb.BootstrapClientAccordionItem,
    htmlElement: js.Any,
    htmlEvent: js.Any
  ) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var item: typingsSlinky.devexpressWeb.BootstrapClientAccordionItem = js.native
  /**
