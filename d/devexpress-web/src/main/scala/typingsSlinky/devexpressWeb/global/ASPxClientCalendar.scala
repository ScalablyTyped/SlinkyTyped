...
import typingsSlinky.devexpressWeb.ASPxClientCalendarCellClickEventHandler
import typingsSlinky.devexpressWeb.ASPxClientCalendarCustomDisabledDateEventHandler
...
class ASPxClientCalendar ()
  extends typingsSlinky.devexpressWeb.ASPxClientCalendar {
  /**
    * Occurs when a callback for server-side processing is initiated.
    */
  /* CompleteClass */
  override var BeginCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
  ...
  override var CallbackError: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
    * Occurs when an end user clicks a date cell.
    */
  /* CompleteClass */
  override var CellClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCellClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
    * Allows you to disable the calendar's days.
    */
  /* CompleteClass */
  override var CustomDisabledDate: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCustomDisabledDateEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
  ...
  override var EndCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var KeyDown: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]] = js.native
  /**
    * Occurs on the client-side when an end-user presses and releases a key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyPress: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]] = js.native
  /**
    * Occurs on the client-side when an end-user releases a pressed key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyUp: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var SelectionChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var VisibleMonthChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
...
object ASPxClientCalendar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientCalendar = js.native
}
