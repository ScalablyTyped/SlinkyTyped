...
class ASPxClientReportParametersPanel ()
  extends typingsSlinky.devexpressWeb.ASPxClientReportParametersPanel {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def AssignParameters(parametersInfo: js.Array[typingsSlinky.devexpressWeb.ASPxClientReportParameterInfo]): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEditorByParameterName(parameterName: String): typingsSlinky.devexpressWeb.ASPxClientControl = js.native
  /**
