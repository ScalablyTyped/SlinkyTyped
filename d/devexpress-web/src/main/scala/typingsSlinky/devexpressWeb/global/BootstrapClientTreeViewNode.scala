...
class BootstrapClientTreeViewNode ()
  extends typingsSlinky.devexpressWeb.BootstrapClientTreeViewNode {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.devexpressWeb.ASPxClientTreeViewNode = js.native
  /**
    * Gets the current node's parent node.
    */
  /* CompleteClass */
  @JSName("parent")
  override var parent_BootstrapClientTreeViewNode: typingsSlinky.devexpressWeb.BootstrapClientTreeViewNode = js.native
  /**
    * Gets the client representation of the ASPxTreeView control to which the current node belongs.
    */
  /* CompleteClass */
  override var treeView: typingsSlinky.devexpressWeb.ASPxClientTreeView = js.native
  /**
    * Gets the BootstrapClientTreeView object to which the current node belongs.
    */
  /* CompleteClass */
  @JSName("treeView")
  override var treeView_BootstrapClientTreeViewNode: typingsSlinky.devexpressWeb.BootstrapClientTreeView = js.native
  /**
