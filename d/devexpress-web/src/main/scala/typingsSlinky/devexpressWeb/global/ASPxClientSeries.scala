...
class ASPxClientSeries ()
  extends typingsSlinky.devexpressWeb.ASPxClientSeries {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var crosshairValueItems: js.Array[typingsSlinky.devexpressWeb.ASPxClientCrosshairValueItem] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var fibonacciIndicators: js.Array[typingsSlinky.devexpressWeb.ASPxClientFibonacciIndicator] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var indicators: js.Array[typingsSlinky.devexpressWeb.ASPxClientIndicator] = js.native
  /**
    * Gets the settings of series labels.
    */
  /* CompleteClass */
  override var label: typingsSlinky.devexpressWeb.ASPxClientSeriesLabel = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var points: js.Array[typingsSlinky.devexpressWeb.ASPxClientSeriesPoint] = js.native
  /** @deprecated This property is now obsolete. Use the indicators property instead. */
  /**
    * Provides access to the collection of regression lines.
    */
  /* CompleteClass */
  override var regressionLines: js.Array[typingsSlinky.devexpressWeb.ASPxClientRegressionLine] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var titles: js.Array[typingsSlinky.devexpressWeb.ASPxClientSeriesTitle] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var trendLines: js.Array[typingsSlinky.devexpressWeb.ASPxClientTrendLine] = js.native
  /**
