...
import typingsSlinky.devexpressWeb.ASPxClientAfterCheckEventHandler
import typingsSlinky.devexpressWeb.ASPxClientBeforeCheckEventHandler
import typingsSlinky.devexpressWeb.ASPxClientCancelEventHandler
import typingsSlinky.devexpressWeb.ASPxClientEventHandler
import typingsSlinky.devexpressWeb.ASPxClientWordChangedEventHandler
...
class ASPxClientSpellChecker ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var AfterCheck: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientAfterCheckEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpellChecker]
  ] = js.native
  /**
    * Client-side event that occurs before the spell check starts.
    */
  /* CompleteClass */
  override var BeforeCheck: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeforeCheckEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpellChecker]
  ] = js.native
  /**
    * Client-side event that occurs before a message box informing about process completion is shown.
    */
  /* CompleteClass */
  override var CheckCompleteFormShowing: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpellChecker]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var WordChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientWordChangedEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpellChecker]
  ] = js.native
  /**
