...
class ASPxClientHtmlEditorInsertTableDialog ()
  extends typingsSlinky.devexpressWeb.ASPxClientHtmlEditorInsertTableDialog {
  /**
    * Provides access to the client object of the "Accessibility" check box related to the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetAccessibilityCheckBox(): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
  /**
    * Provides access to the client object of the "Alignment" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetAlignmentComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCaptionTextBox(): typingsSlinky.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Cell padding" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetCellPaddingSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Cell spacing" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetCellSpacingSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Columns" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetColumnCountSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Equal column widths" check box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetEqualWidthCheckBox(): typingsSlinky.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeadersComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
    * Provides access to the client object of the "Height" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetHeightTypeComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightValueSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightValueTypeComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRowCountSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Summary" text box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetSummaryTextBox(): typingsSlinky.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Width" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetWidthTypeComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetWidthValueSpinEdit(): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetWidthValueTypeComboBox(): typingsSlinky.devexpressWeb.ASPxClientComboBox = js.native
}
