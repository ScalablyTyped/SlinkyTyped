...
class ASPxClientWebChartControlHotTrackEventArgs protected ()
  ...
  def this(
    ...
    additionalHitObject: typingsSlinky.devexpressWeb.ASPxClientWebChartElement,
    hitInfo: typingsSlinky.devexpressWeb.ASPxClientWebChartHitInfo,
    htmlElement: js.Any,
    x: Double,
    y: Double
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var additionalHitObject: typingsSlinky.devexpressWeb.ASPxClientWebChartElement = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var hitInfo: typingsSlinky.devexpressWeb.ASPxClientWebChartHitInfo = js.native
  /**
    * Provides access on the client side to the chart element, for which the event was raised.
    */
  /* CompleteClass */
  override var hitObject: typingsSlinky.devexpressWeb.ASPxClientWebChartElement = js.native
  /**
