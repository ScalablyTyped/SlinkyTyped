...
import typingsSlinky.devexpressWeb.ASPxClientTabControlTabCancelEventHandler
import typingsSlinky.devexpressWeb.ASPxClientTabControlTabClickEventHandler
import typingsSlinky.devexpressWeb.ASPxClientTabControlTabEventHandler
...
@js.native
class BootstrapClientSpreadsheetTabControl ()
  extends typingsSlinky.devexpressWeb.BootstrapClientTabControl {
  /**
    * Fires on the client side after the active tab has been changed within a tab control.
    */
  /* CompleteClass */
  override var ActiveTabChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientTabControlTabEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
    * Fires on the client side before the active tab is changed within a tab control.
    */
  /* CompleteClass */
  override var ActiveTabChanging: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientTabControlTabCancelEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
  ...
  override var BeginCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
  ...
  override var CallbackError: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
  ...
  override var EndCallback: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var TabClick: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientTabControlTabClickEventHandler[typingsSlinky.devexpressWeb.ASPxClientTabControlBase]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetActiveTab(): typingsSlinky.devexpressWeb.ASPxClientTab = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetTab(index: Double): typingsSlinky.devexpressWeb.ASPxClientTab = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetTabByName(name: String): typingsSlinky.devexpressWeb.ASPxClientTab = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetActiveTab(tab: typingsSlinky.devexpressWeb.ASPxClientTab): Unit = js.native
  /**
    * Makes the specified tab active within the Tab Control on the client side.
    * @param tab A BootstrapClientTab object specifying the tab to select.
    */
  /* CompleteClass */
  override def SetActiveTab(tab: typingsSlinky.devexpressWeb.BootstrapClientTab): Unit = js.native
  /**
