...
@js.native
class ASPxClientSpinEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientSpinEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var NumberChanged: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpinEdit]
  ] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientSpinEditBase: typingsSlinky.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsSlinky.devexpressWeb.ASPxClientSpinEditBase]
  ] = js.native
  /**
...
object ASPxClientSpinEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientSpinEdit = js.native
}
