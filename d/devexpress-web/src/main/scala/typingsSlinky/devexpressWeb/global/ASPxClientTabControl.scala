...
class ASPxClientTabControl ()
  extends typingsSlinky.devexpressWeb.ASPxClientTabControlBase
object ASPxClientTabControl {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ASPxClientTabControl.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientTabControl = js.native
}
