...
class ASPxClientWeekDaysCheckEdit ()
  extends typingsSlinky.devexpressWeb.ASPxClientWeekDaysCheckEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValue(): typingsSlinky.devexpressWeb.ASPxClientWeekDays = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetValue(value: typingsSlinky.devexpressWeb.ASPxClientWeekDays): Unit = js.native
  /**
    * Specifies whether a control is displayed.
