...
class ASPxClientGridViewBatchEditStartEditingEventArgs protected ()
  extends typingsSlinky.devexpressWeb.ASPxClientGridViewBatchEditStartEditingEventArgs {
  /**
  ...
  def this(
    visibleIndex: Double,
    focusedColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn,
    rowValues: js.Any,
    key: js.Any
  ) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var focusedColumn: typingsSlinky.devexpressWeb.ASPxClientGridViewColumn = js.native
  /**
    * Gets the row's key.
    */
  /* CompleteClass */
