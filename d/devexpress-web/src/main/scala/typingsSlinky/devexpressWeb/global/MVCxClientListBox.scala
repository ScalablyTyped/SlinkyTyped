...
@js.native
class MVCxClientListBox ()
  extends typingsSlinky.devexpressWeb.MVCxClientListBox
object MVCxClientListBox {
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("MVCxClientListBox.Cast")
  @js.native
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.MVCxClientListBox = js.native
}
