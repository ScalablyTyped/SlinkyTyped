...
import typingsSlinky.devexpressWeb.ASPxClientEditEventHandler
...
class ASPxClientHyperLink ()
  extends typingsSlinky.devexpressWeb.ASPxClientHyperLink {
  /**
    * Occurs on the client side after an end-user clicks within a static editor.
    */
  /* CompleteClass */
  override var Click: typingsSlinky.devexpressWeb.ASPxClientEvent[ASPxClientEditEventHandler[typingsSlinky.devexpressWeb.ASPxClientStaticEdit]] = js.native
  /**
...
object ASPxClientHyperLink extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typingsSlinky.devexpressWeb.ASPxClientHyperLink = js.native
}
