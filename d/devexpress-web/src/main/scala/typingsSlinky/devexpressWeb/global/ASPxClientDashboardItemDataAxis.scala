...
class ASPxClientDashboardItemDataAxis ()
  extends typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxis {
  /**
    * Gets the dimensions used to create a hierarchy of axis points belonging to the current axis.
    */
  /* CompleteClass */
  override def GetDimensions(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataDimension] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetPointByUniqueValues(uniqueValues: js.Array[_]): typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPoint = js.native
  /**
    * Returns axis points corresponding to values of the last-level dimension.
    */
  /* CompleteClass */
  override def GetPoints(): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPoint] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetPointsByDimension(dimensionId: String): js.Array[typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPoint] = js.native
  /**
    * Gets the root axis point belonging to the current ASPxClientDashboardItemDataAxis.
    */
  /* CompleteClass */
  override def GetRootPoint(): typingsSlinky.devexpressWeb.ASPxClientDashboardItemDataAxisPoint = js.native
}
