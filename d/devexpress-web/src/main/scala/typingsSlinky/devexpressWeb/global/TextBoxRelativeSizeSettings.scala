...
class TextBoxRelativeSizeSettings ()
  extends typingsSlinky.devexpressWeb.TextBoxRelativeSizeSettings {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var relativeHeightType: typingsSlinky.devexpressWeb.FloatingObjectRelativeHeightType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var relativeWidthType: typingsSlinky.devexpressWeb.FloatingObjectRelativeWidthType = js.native
}
