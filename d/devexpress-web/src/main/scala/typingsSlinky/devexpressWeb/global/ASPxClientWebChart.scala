...
class ASPxClientWebChart ()
  extends typingsSlinky.devexpressWeb.ASPxClientWebChart {
  /**
    * Provides access to the chart's collection of annotations.
    */
  /* CompleteClass */
  override var annotations: js.Array[typingsSlinky.devexpressWeb.ASPxClientAnnotation] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var chartControl: typingsSlinky.devexpressWeb.ASPxClientWebChartControl = js.native
  /**
    * Gets the settings for a crosshair cursor concerning its position and appearance on a diagram.
    */
  /* CompleteClass */
  override var crosshairOptions: typingsSlinky.devexpressWeb.ASPxClientCrosshairOptions = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var diagram: typingsSlinky.devexpressWeb.ASPxClientWebChartElement = js.native
  /**
    * Gets the chart's legend and provides access to its settings.
    */
  /* CompleteClass */
  override var legend: typingsSlinky.devexpressWeb.ASPxClientLegend = js.native
  /**
    * Returns the collection of legends.
    */
  /* CompleteClass */
  override var legends: js.Array[typingsSlinky.devexpressWeb.ASPxClientLegend] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var series: js.Array[typingsSlinky.devexpressWeb.ASPxClientSeries] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var titles: js.Array[typingsSlinky.devexpressWeb.ASPxClientChartTitle] = js.native
  /**
    * Returns the tooltip controller that shows tooltips for chart elements.
    */
  /* CompleteClass */
  override var toolTipController: typingsSlinky.devexpressWeb.ASPxClientToolTipController = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var toolTipPosition: typingsSlinky.devexpressWeb.ASPxClientToolTipPosition = js.native
}
