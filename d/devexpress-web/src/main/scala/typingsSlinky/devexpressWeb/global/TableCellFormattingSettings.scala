...
@js.native
class TableCellFormattingSettings ()
  extends typingsSlinky.devexpressWeb.TableCellFormattingSettings {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var marginsSameAsTable: Boolean = js.native
  /**
    * Sspecifies whether text is wrapped in a table cell.
    */
  /* CompleteClass */
  override var noWrap: Boolean = js.native
  /**
    * Gets or sets a table cell's preferred width.
    */
  /* CompleteClass */
  override var preferredWidth: typingsSlinky.devexpressWeb.TableWidthUnit = js.native
  /**
    * Gets or sets the vertical alignment of a table cell's content.
    */
  /* CompleteClass */
  override var verticalAlignment: typingsSlinky.devexpressWeb.TableCellVerticalAlignment = js.native
}
