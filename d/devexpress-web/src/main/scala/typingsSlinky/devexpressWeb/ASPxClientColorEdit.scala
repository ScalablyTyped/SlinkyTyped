...
object ASPxClientColorEdit {
  ...
  implicit class ASPxClientColorEditOps[Self <: ASPxClientColorEdit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColorChanged(value: ASPxClientEvent[ASPxClientProcessingModeEventHandler[ASPxClientColorEdit]]): Self = {
    ...
    @scala.inline
    def withIsAutomaticColorSelected(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsAutomaticColorSelected")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTextChanged(value: ASPxClientEvent[ASPxClientProcessingModeEventHandler[ASPxClientColorEdit]]): Self = {
        val ret = this.duplicate
