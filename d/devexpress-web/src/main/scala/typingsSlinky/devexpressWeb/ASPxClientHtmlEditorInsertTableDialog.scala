...
object ASPxClientHtmlEditorInsertTableDialog {
  ...
  implicit class ASPxClientHtmlEditorInsertTableDialogOps[Self <: ASPxClientHtmlEditorInsertTableDialog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetColumnCountSpinEdit(value: () => ASPxClientSpinEdit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetColumnCountSpinEdit")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetEqualWidthCheckBox(value: () => ASPxClientCheckBox): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetEqualWidthCheckBox")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRowCountSpinEdit(value: () => ASPxClientSpinEdit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetRowCountSpinEdit")(js.Any.fromFunction0(value))
        ret
    }
  }
