...
object ASPxClientSpinEdit {
  ...
  implicit class ASPxClientSpinEditOps[Self <: ASPxClientSpinEdit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumberChanged(value: ASPxClientEvent[ASPxClientProcessingModeEventHandler[ASPxClientSpinEdit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NumberChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSetMaxValue(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetMaxValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetMinValue(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetMinValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetNumber(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetNumber")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
