...
object ASPxClientCloudControl {
  ...
  @scala.inline
  implicit class ASPxClientCloudControlOps[Self <: ASPxClientCloudControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemClick(value: ASPxClientEvent[ASPxClientCloudControlItemEventHandler[ASPxClientCloudControl]]): Self = this.set("ItemClick", value.asInstanceOf[js.Any])
  }
}
