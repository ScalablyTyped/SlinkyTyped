...
object ASPxClientRichEditPopupMenuItem {
  ...
  implicit class ASPxClientRichEditPopupMenuItemOps[Self <: ASPxClientRichEditPopupMenuItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetItem(value: Double => ASPxClientRichEditPopupMenuItem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetItemByName(value: String => ASPxClientRichEditPopupMenuItem): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetSubItems(value: () => ASPxClientRichEditPopupMenuItemCollection): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withParent(value: ASPxClientRichEditPopupMenuItem): Self = {
        val ret = this.duplicate
