...
object ASPxClientReminder {
  ...
  implicit class ASPxClientReminderOps[Self <: ASPxClientReminder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetAlertTime(value: () => js.Date): Self = this.set("GetAlertTime", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetTimeBeforeStart(value: () => js.Date): Self = this.set("GetTimeBeforeStart", js.Any.fromFunction0(value))
