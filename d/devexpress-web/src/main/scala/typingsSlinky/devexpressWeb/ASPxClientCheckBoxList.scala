...
object ASPxClientCheckBoxList {
  ...
  implicit class ASPxClientCheckBoxListOps[Self <: ASPxClientCheckBoxList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetSelectedIndices(value: () => js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetSelectedIndices")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetSelectedItems(value: () => js.Array[ASPxClientListEditItem]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetSelectedItems")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetSelectedValues(value: () => js.Array[_]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelectIndices(value: js.Array[Double] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SelectIndices")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectItems(value: js.Array[ASPxClientListEditItem] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SelectItems")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectValues(value: js.Array[_] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SelectValues")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectedIndexChanged(value: ASPxClientEvent[ASPxClientListEditItemSelectedChangedEventHandler[ASPxClientCheckBoxList]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUnselectIndices(value: js.Array[Double] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UnselectIndices")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUnselectItems(value: js.Array[ASPxClientListEditItem] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UnselectItems")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUnselectValues(value: js.Array[_] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UnselectValues")(js.Any.fromFunction1(value))
        ret
    }
  }
