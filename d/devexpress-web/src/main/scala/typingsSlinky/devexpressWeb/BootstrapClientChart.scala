...
object BootstrapClientChart {
  ...
  implicit class BootstrapClientChartOps[Self <: BootstrapClientChart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withZoomEnd(value: ASPxClientEvent[BootstrapClientChartZoomEndEventHandler[BootstrapClientChart]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ZoomEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withZoomStart(value: ASPxClientEvent[BootstrapClientChartZoomStartEventHandler[BootstrapClientChart]]): Self = {
        val ret = this.duplicate
