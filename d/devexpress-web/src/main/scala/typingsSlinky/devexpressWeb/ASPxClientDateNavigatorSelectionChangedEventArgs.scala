...
object ASPxClientDateNavigatorSelectionChangedEventArgs {
  ...
  implicit class ASPxClientDateNavigatorSelectionChangedEventArgsOps[Self <: ASPxClientDateNavigatorSelectionChangedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectedDatesVarargs(value: js.Date*): Self = this.set("selectedDates", js.Array(value :_*))
    
    @scala.inline
    def setSelectedDates(value: js.Array[js.Date]): Self = this.set("selectedDates", value.asInstanceOf[js.Any])
  }
}
