...
object ASPxClientDropDownEditBase {
  ...
  implicit class ASPxClientDropDownEditBaseOps[Self <: ASPxClientDropDownEditBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdjustDropDownWindow(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AdjustDropDownWindow")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCloseUp(value: ASPxClientEvent[ASPxClientEventHandler[ASPxClientDropDownEditBase]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CloseUp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDropDown(value: ASPxClientEvent[ASPxClientEventHandler[ASPxClientDropDownEditBase]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DropDown")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHideDropDown(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HideDropDown")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withQueryCloseUp(value: ASPxClientEvent[ASPxClientCancelEventHandler[ASPxClientDropDownEditBase]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("QueryCloseUp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withShowDropDown(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ShowDropDown")(js.Any.fromFunction0(value))
        ret
    }
  }
