...
object ASPxClientGridBase {
  ...
  implicit class ASPxClientGridBaseOps[Self <: ASPxClientGridBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBatchEditSummaryDisplayText(value: ASPxClientEvent[ASPxClientGridBatchEditSummaryDisplayTextEventHandler[ASPxClientGridBase]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BatchEditSummaryDisplayText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetToolbar(value: Double => ASPxClientMenu): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetToolbar")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetToolbarByName(value: String => ASPxClientMenu): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetToolbarByName")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withToolbarItemClick(value: ASPxClientEvent[ASPxClientGridToolbarItemClickEventHandler[ASPxClientGridBase]]): Self = {
        val ret = this.duplicate
