...
object ASPxClientReportToolbar {
  ...
  @scala.inline
  implicit class ASPxClientReportToolbarOps[Self <: ASPxClientReportToolbar] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withGetItemTemplateControl(value: String => ASPxClientControl): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetItemTemplateControl")(js.Any.fromFunction1(value))
        ret
    }
  }
