...
object BootstrapClientRibbon {
  ...
  implicit class BootstrapClientRibbonOps[Self <: BootstrapClientRibbon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetQuickAccessToolbarItem(value: String => ASPxClientRibbonItem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetQuickAccessToolbarItem")(js.Any.fromFunction1(value))
        ret
    }
  }
