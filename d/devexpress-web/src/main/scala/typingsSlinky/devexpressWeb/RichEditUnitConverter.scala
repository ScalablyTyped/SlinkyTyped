...
trait RichEditUnitConverter extends js.Object {
  /**
    ...
    */
  def centimetersToTwips(value: Double): Double
  /**
    ...
    */
  def inchesToTwips(value: Double): Double
  /**
