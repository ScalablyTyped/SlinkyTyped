...
object ASPxClientRecurrenceRangeControl {
  ...
  implicit class ASPxClientRecurrenceRangeControlOps[Self <: ASPxClientRecurrenceRangeControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetEndDate(value: () => js.Date): Self = this.set("GetEndDate", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setSetEndDate(value: js.Date => Unit): Self = this.set("SetEndDate", js.Any.fromFunction1(value))
    @scala.inline
