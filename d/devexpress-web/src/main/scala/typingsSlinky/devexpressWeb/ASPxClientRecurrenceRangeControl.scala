...
object ASPxClientRecurrenceRangeControl {
  ...
  implicit class ASPxClientRecurrenceRangeControlMutableBuilder[Self <: ASPxClientRecurrenceRangeControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetEndDate(value: () => js.Date): Self = StObject.set(x, "GetEndDate", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetEndDate(value: js.Date => Unit): Self = StObject.set(x, "SetEndDate", js.Any.fromFunction1(value))
