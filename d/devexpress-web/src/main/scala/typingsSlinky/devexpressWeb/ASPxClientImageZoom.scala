...
object ASPxClientImageZoom {
  ...
  implicit class ASPxClientImageZoomOps[Self <: ASPxClientImageZoom] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetImageProperties(value: (String, String, String, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetImageProperties")(js.Any.fromFunction5(value))
        ret
    }
  }
