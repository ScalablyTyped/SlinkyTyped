...
object ASPxClientHtmlEditorPlaceholderDialog {
  ...
  implicit class ASPxClientHtmlEditorPlaceholderDialogOps[Self <: ASPxClientHtmlEditorPlaceholderDialog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetPlaceholderNameListBox(value: () => ASPxClientListBox): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetPlaceholderNameListBox")(js.Any.fromFunction0(value))
        ret
    }
  }
