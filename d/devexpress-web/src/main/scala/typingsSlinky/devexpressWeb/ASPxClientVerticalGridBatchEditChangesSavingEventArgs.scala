...
object ASPxClientVerticalGridBatchEditChangesSavingEventArgs {
  ...
  @scala.inline
  implicit class ASPxClientVerticalGridBatchEditChangesSavingEventArgsOps[Self <: ASPxClientVerticalGridBatchEditChangesSavingEventArgs] (val x: Self) extends AnyVal {
