...
object ASPxClientListEdit {
  ...
  implicit class ASPxClientListEditOps[Self <: ASPxClientListEdit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetSelectedItem(value: () => ASPxClientListEditItem): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GetSelectedItem")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSelectedIndexChanged(value: ASPxClientEvent[ASPxClientProcessingModeEventHandler[ASPxClientListEdit]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSetSelectedItem(value: ASPxClientListEditItem => Unit): Self = {
        val ret = this.duplicate
