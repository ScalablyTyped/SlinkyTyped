...
object ASPxClientCalendar {
  ...
  implicit class ASPxClientCalendarOps[Self <: ASPxClientCalendar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeselectDate(value: js.Date => Unit): Self = this.set("DeselectDate", js.Any.fromFunction1(value))
    @scala.inline
    def setDeselectRange(value: (js.Date, js.Date) => Unit): Self = this.set("DeselectRange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setGetSelectedDate(value: () => js.Date): Self = this.set("GetSelectedDate", js.Any.fromFunction0(value))
    @scala.inline
    def setGetSelectedDates(value: () => js.Array[js.Date]): Self = this.set("GetSelectedDates", js.Any.fromFunction0(value))
    @scala.inline
    def setGetVisibleDate(value: () => js.Date): Self = this.set("GetVisibleDate", js.Any.fromFunction0(value))
    @scala.inline
    def setIsDateSelected(value: js.Date => Boolean): Self = this.set("IsDateSelected", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSelectDate(value: js.Date => Unit): Self = this.set("SelectDate", js.Any.fromFunction1(value))
    @scala.inline
    def setSelectRange(value: (js.Date, js.Date) => Unit): Self = this.set("SelectRange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setSetSelectedDate(value: js.Date => Unit): Self = this.set("SetSelectedDate", js.Any.fromFunction1(value))
    @scala.inline
    def setSetVisibleDate(value: js.Date => Unit): Self = this.set("SetVisibleDate", js.Any.fromFunction1(value))
    @scala.inline
