...
object Presence {
  ...
  implicit class PresenceOps[Self <: Presence] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndTimestampDate(value: js.Date): Self = this.set("endTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEndTimestamp(value: Double | js.Date): Self = this.set("endTimestamp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartTimestampDate(value: js.Date): Self = this.set("startTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStartTimestamp(value: Double | js.Date): Self = this.set("startTimestamp", value.asInstanceOf[js.Any])
