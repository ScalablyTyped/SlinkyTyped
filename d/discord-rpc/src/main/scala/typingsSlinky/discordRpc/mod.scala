...
import typingsSlinky.discordRpc.anon.Avatar
import typingsSlinky.discordRpc.anon.Capacity
import typingsSlinky.discordRpc.anon.Code
import typingsSlinky.discordRpc.anon.Description
import typingsSlinky.discordRpc.anon.Device
import typingsSlinky.discordRpc.anon.Force
import typingsSlinky.discordRpc.anon.Id
import typingsSlinky.discordRpc.anon.Left
import typingsSlinky.discordRpc.anon.Name
import typingsSlinky.discordRpc.anon.Timeout
...
import typingsSlinky.discordRpc.discordRpcStrings.connected
import typingsSlinky.discordRpc.discordRpcStrings.ipc
import typingsSlinky.discordRpc.discordRpcStrings.ready
...
object mod {
  ...
  object Presence {
    ...
    implicit class PresenceMutableBuilder[Self <: Presence] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndTimestamp(value: Double | js.Date): Self = StObject.set(x, "endTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEndTimestampDate(value: js.Date): Self = StObject.set(x, "endTimestamp", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStartTimestamp(value: Double | js.Date): Self = StObject.set(x, "startTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStartTimestampDate(value: js.Date): Self = StObject.set(x, "startTimestamp", value.asInstanceOf[js.Any])
