package typingsSlinky.doubleDashEndedDashQueue.doubleDashEndedDashQueueMod
...
object ^
  ...
  */
Instantiable0[Deque[js.Object]]) with ( // tslint:disable-line:no-unnecessary-generics
/**
