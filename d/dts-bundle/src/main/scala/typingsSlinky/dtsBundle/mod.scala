package typingsSlinky.dtsBundle
...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExclude(value: js.RegExp | (js.Function2[/* file */ String, /* external */ Boolean, Boolean])): Self = StObject.set(x, "exclude", value.asInstanceOf[js.Any])
