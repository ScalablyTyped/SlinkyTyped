package typingsSlinky.dotnetDepsParser.projectAssetsJsonParserMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.dotnetDepsParser.anon.Dependencies
import typingsSlinky.dotnetDepsParser.anon.Restore
