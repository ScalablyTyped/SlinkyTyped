...
trait BlurButton extends js.Object {
  var blurButton: typingsSlinky.downshift.mod.StateChangeTypes.blurButton
  var blurInput: typingsSlinky.downshift.mod.StateChangeTypes.blurInput
  var changeInput: typingsSlinky.downshift.mod.StateChangeTypes.changeInput
  var clickButton: typingsSlinky.downshift.mod.StateChangeTypes.clickButton
  var clickItem: typingsSlinky.downshift.mod.StateChangeTypes.clickItem
  var controlledPropUpdatedSelectedItem: typingsSlinky.downshift.mod.StateChangeTypes.controlledPropUpdatedSelectedItem
  var itemMouseEnter: typingsSlinky.downshift.mod.StateChangeTypes.itemMouseEnter
  var keyDownArrowDown: typingsSlinky.downshift.mod.StateChangeTypes.keyDownArrowDown
  var keyDownArrowUp: typingsSlinky.downshift.mod.StateChangeTypes.keyDownArrowUp
  var keyDownEnter: typingsSlinky.downshift.mod.StateChangeTypes.keyDownEnter
  var keyDownEscape: typingsSlinky.downshift.mod.StateChangeTypes.keyDownEscape
  var keyDownSpaceButton: typingsSlinky.downshift.mod.StateChangeTypes.keyDownSpaceButton
  var mouseUp: typingsSlinky.downshift.mod.StateChangeTypes.mouseUp
  var touchEnd: typingsSlinky.downshift.mod.StateChangeTypes.touchEnd
  var unknown: typingsSlinky.downshift.mod.StateChangeTypes.unknown
}
