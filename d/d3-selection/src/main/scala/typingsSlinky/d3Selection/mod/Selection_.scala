...
import typingsSlinky.d3Selection.d3SelectionStrings.important
...
trait Selection_[GElement /* <: BaseType */, Datum, PElement /* <: BaseType */, PDatum] extends js.Object {
  /**
    ...
    */
  def append[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */](`type`: K): Selection_[
  ...
  /**
    ...
    */
  def insert[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */](`type`: K): Selection_[
    /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.ElementTagNameMap[K] */ js.Any, 
    Datum, 
    PElement, 
    PDatum
  ] = js.native
  def insert[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */](`type`: K, before: String): Selection_[
    /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.ElementTagNameMap[K] */ js.Any, 
    Datum, 
    PElement, 
    PDatum
  ] = js.native
  def insert[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */](`type`: K, before: ValueFn[GElement, Datum, BaseType]): Selection_[
    /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.ElementTagNameMap[K] */ js.Any, 
    Datum, 
    PElement, 
    PDatum
  ...
  /**
    ...
    */
  def join[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */, OldDatum](enter: K): Selection_[
    GElement | (/* import warning: importer.ImportType#apply Failed type conversion: d3-selection.ElementTagNameMap[K] */ js.Any), 
    Datum, 
    PElement, 
    PDatum
  ] = js.native
  def join[K /* <: /* keyof d3-selection.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */, OldDatum](
    enter: K,
    update: js.Function1[
