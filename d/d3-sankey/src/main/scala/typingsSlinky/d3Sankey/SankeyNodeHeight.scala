...
trait SankeyNodeHeight extends js.Object {
  /**
  ...
  /**
    ...
    */
  var sourceLinks: js.UndefOr[js.Array[SankeyLinkIndex]] = js.undefined
  /**
    * Array of incoming links which have this node as their target.
    * This property is calculated internally by the Sankey layout generator.
    */
  var targetLinks: js.UndefOr[js.Array[SankeyLinkIndex]] = js.undefined
  /**
...
object SankeyNodeHeight {
  @scala.inline
  def apply(
    depth: Int | Double = null,
    height: Int | Double = null,
    index: Int | Double = null,
    sourceLinks: js.Array[SankeyLinkIndex] = null,
    targetLinks: js.Array[SankeyLinkIndex] = null,
    ...
    __obj.asInstanceOf[SankeyNodeHeight]
  }
}
