...
object anon {
  ...
  object SankeyLink {
    ...
    implicit class SankeyLinkMutableBuilder[Self <: SankeyLink] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSource(value: Double | String | (typingsSlinky.d3Sankey.mod.SankeyNode[js.Object, js.Object])): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTarget(value: Double | String | (typingsSlinky.d3Sankey.mod.SankeyNode[js.Object, js.Object])): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object SankeyNodeDepth {
    ...
    implicit class SankeyNodeDepthMutableBuilder[Self <: SankeyNodeDepth] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSourceLinks(value: js.Array[typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object]]): Self = StObject.set(x, "sourceLinks", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSourceLinksUndefined: Self = StObject.set(x, "sourceLinks", js.undefined)
      
      @scala.inline
      def setSourceLinksVarargs(value: (typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object])*): Self = StObject.set(x, "sourceLinks", js.Array(value :_*))
      
      @scala.inline
      def setTargetLinks(value: js.Array[typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object]]): Self = StObject.set(x, "targetLinks", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTargetLinksUndefined: Self = StObject.set(x, "targetLinks", js.undefined)
      
      @scala.inline
      def setTargetLinksVarargs(value: (typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object])*): Self = StObject.set(x, "targetLinks", js.Array(value :_*))
