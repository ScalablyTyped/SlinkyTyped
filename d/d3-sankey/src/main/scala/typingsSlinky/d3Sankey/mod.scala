...
object mod {
  ...
  @js.native
  def sankeyCenter(node: typingsSlinky.d3Sankey.anon.SankeyNode, n: Double): Double = js.native
  
  @JSImport("d3-sankey", "sankeyJustify")
  @js.native
  def sankeyJustify(node: typingsSlinky.d3Sankey.anon.SankeyNode, n: Double): Double = js.native
  
  @JSImport("d3-sankey", "sankeyLeft")
  @js.native
  def sankeyLeft(node: typingsSlinky.d3Sankey.anon.SankeyNode, n: Double): Double = js.native
  ...
  @js.native
  def sankeyRight(node: typingsSlinky.d3Sankey.anon.SankeyNode, n: Double): Double = js.native
