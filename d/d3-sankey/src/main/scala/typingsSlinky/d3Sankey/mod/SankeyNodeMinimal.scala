...
object SankeyNodeMinimal {
  @scala.inline
  def apply[/* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L](): SankeyNodeMinimal[N, L] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SankeyNodeMinimal[N, L]]
  }
  @scala.inline
  implicit class SankeyNodeMinimalOps[Self <: SankeyNodeMinimal[_, _], /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L] (val x: Self with (SankeyNodeMinimal[N, L])) extends AnyVal {
    @scala.inline
