...
object SankeyLinkMinimal {
  @scala.inline
  def apply[/* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L](
  ...
  @scala.inline
  implicit class SankeyLinkMinimalOps[Self <: SankeyLinkMinimal[_, _], /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L] (val x: Self with (SankeyLinkMinimal[N, L])) extends AnyVal {
    @scala.inline
