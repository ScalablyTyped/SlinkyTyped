...
object SankeyGraph {
  @scala.inline
  def apply[/* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L](links: js.Array[SankeyLink[N, L]], nodes: js.Array[SankeyNode[N, L]]): SankeyGraph[N, L] = {
  ...
  @scala.inline
  implicit class SankeyGraphOps[Self <: SankeyGraph[_, _], /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ N, /* <: typingsSlinky.d3Sankey.mod.SankeyExtraProperties */ L] (val x: Self with (SankeyGraph[N, L])) extends AnyVal {
    @scala.inline
