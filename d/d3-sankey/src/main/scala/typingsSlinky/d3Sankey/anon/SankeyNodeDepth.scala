...
object SankeyNodeDepth {
  ...
  implicit class SankeyNodeDepthOps[Self <: SankeyNodeDepth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSourceLinksVarargs(value: (typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object])*): Self = this.set("sourceLinks", js.Array(value :_*))
    
    @scala.inline
    def setSourceLinks(value: js.Array[typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object]]): Self = this.set("sourceLinks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSourceLinks: Self = this.set("sourceLinks", js.undefined)
    
    @scala.inline
    def setTargetLinksVarargs(value: (typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object])*): Self = this.set("targetLinks", js.Array(value :_*))
    
    @scala.inline
    def setTargetLinks(value: js.Array[typingsSlinky.d3Sankey.mod.SankeyLink[js.Object, js.Object]]): Self = this.set("targetLinks", value.asInstanceOf[js.Any])
