...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilter(value: (/* file */ String, /* regex */ js.RegExp) => String): Self = StObject.set(x, "filter", js.Any.fromFunction2(value))
      
      @scala.inline
      def setFilterUndefined: Self = StObject.set(x, "filter", js.undefined)
      
      @scala.inline
      def setJunkRegex(value: js.RegExp): Self = StObject.set(x, "junkRegex", value.asInstanceOf[js.Any])
