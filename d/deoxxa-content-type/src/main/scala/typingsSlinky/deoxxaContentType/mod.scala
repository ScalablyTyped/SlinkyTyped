package typingsSlinky.deoxxaContentType

import org.scalablytyped.runtime.Shortcut
import typingsSlinky.deoxxaContentType.ContentType.MediaType
import typingsSlinky.deoxxaContentType.ContentType.MediaTypeStatic
