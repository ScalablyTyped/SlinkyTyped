...
object Http_ {
  ...
  implicit class Http_Ops[Self <: Http_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlacklistVarargs(value: (String | js.RegExp | (js.Function1[/* url */ String, Boolean]))*): Self = this.set("blacklist", js.Array(value :_*))
    ...
    @scala.inline
    def setWhitelistVarargs(value: (String | js.RegExp | (js.Function1[/* url */ String, Boolean]))*): Self = this.set("whitelist", js.Array(value :_*))
