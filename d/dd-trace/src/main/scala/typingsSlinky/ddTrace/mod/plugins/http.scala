...
import typingsSlinky.ddTrace.anon.`2`
...
- typingsSlinky.ddTrace.mod.plugins.Instrumentation because Already inherited
- typingsSlinky.ddTrace.mod.plugins.Http_ because Already inherited
- typingsSlinky.ddTrace.mod.plugins.HttpServer because var conflicts: analytics, blacklist, enabled, headers, hooks, service, validateStatus, whitelist. Inlined middleware */ @js.native
