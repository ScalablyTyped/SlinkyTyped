...
object SamplingRule {
  ...
  implicit class SamplingRuleOps[Self <: SamplingRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceRegExp(value: js.RegExp): Self = this.set("service", value.asInstanceOf[js.Any])
    @scala.inline
    def setService(value: String | js.RegExp): Self = this.set("service", value.asInstanceOf[js.Any])
    @scala.inline
