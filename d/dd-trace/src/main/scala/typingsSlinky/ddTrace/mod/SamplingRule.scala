...
trait SamplingRule extends StObject {
  ...
  /**
    ...
    */
  var service: js.UndefOr[String | js.RegExp] = js.native
}
object SamplingRule {
  ...
  implicit class SamplingRuleMutableBuilder[Self <: SamplingRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setService(value: String | js.RegExp): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setServiceRegExp(value: js.RegExp): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
