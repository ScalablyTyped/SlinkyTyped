...
object B3 {
  ...
  implicit class B3Ops[Self <: B3] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDistributedTracingOriginWhitelistVarargs(value: (String | js.RegExp)*): Self = this.set("distributedTracingOriginWhitelist", js.Array(value :_*))
    
    @scala.inline
    def setDistributedTracingOriginWhitelist(value: js.Array[String | js.RegExp]): Self = this.set("distributedTracingOriginWhitelist", value.asInstanceOf[js.Any])
