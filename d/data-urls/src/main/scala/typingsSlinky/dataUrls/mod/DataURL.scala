package typingsSlinky.dataUrls.mod
...
trait DataURL extends js.Object {
  ...
  var mimeType: typingsSlinky.whatwgMimetype.mod.^ = js.native
}
object DataURL {
  
  @scala.inline
  def apply(body: Buffer, mimeType: typingsSlinky.whatwgMimetype.mod.^): DataURL = {
  ...
  implicit class DataURLOps[Self <: DataURL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMimeType(value: typingsSlinky.whatwgMimetype.mod.^): Self = this.set("mimeType", value.asInstanceOf[js.Any])
  }
}
