...
object RepeatMode {
  @scala.inline
  def `0`: typingsSlinky.deezerDashSdk.deezerDashSdkNumbers.`0` = this.cast(0)
  @scala.inline
  def `1`: typingsSlinky.deezerDashSdk.deezerDashSdkNumbers.`1` = this.cast(1)
  @scala.inline
  def `2`: typingsSlinky.deezerDashSdk.deezerDashSdkNumbers.`2` = this.cast(2)
  @scala.inline
