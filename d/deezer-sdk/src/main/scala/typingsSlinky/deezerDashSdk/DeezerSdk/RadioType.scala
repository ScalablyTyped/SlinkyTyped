...
object RadioType {
  @scala.inline
  def artist: typingsSlinky.deezerDashSdk.deezerDashSdkStrings.artist = this.cast("artist")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def radio: typingsSlinky.deezerDashSdk.deezerDashSdkStrings.radio = this.cast("radio")
  @scala.inline
  def user: typingsSlinky.deezerDashSdk.deezerDashSdkStrings.user = this.cast("user")
}
