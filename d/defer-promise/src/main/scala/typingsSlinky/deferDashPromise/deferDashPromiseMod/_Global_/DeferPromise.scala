package typingsSlinky.deferDashPromise.deferDashPromiseMod._Global_

import typingsSlinky.deferDashPromise.deferDashPromiseMod._Global_.DeferPromise.Deferred
