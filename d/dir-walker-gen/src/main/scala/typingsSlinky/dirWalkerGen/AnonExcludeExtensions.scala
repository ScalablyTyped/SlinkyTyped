package typingsSlinky.dirWalkerGen
...
object AnonExcludeExtensions {
  @scala.inline
  def apply(folders: js.Array[String]): AnonExcludeExtensions = {
    val __obj = js.Dynamic.literal(folders = folders.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonExcludeExtensions]
  }
  @scala.inline
  implicit class AnonExcludeExtensionsOps[Self <: AnonExcludeExtensions] (val x: Self) extends AnyVal {
    @scala.inline
