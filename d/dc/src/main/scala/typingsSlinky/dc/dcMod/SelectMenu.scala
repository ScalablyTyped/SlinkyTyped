...
import typingsSlinky.dc.Anon_Key
...
trait SelectMenu extends BaseMixin[SelectMenu] {
  ...
  var filterDisplayed_Original: IGetSet[js.Function2[/* a */ Anon_Key, /* index */ Double, Boolean], SelectMenu] = js.native
  @JSName("multiple")
  ...
  def filterDisplayed(): js.Function2[/* a */ Anon_Key, /* index */ Double, Boolean] = js.native
  def filterDisplayed(t: js.Function2[/* a */ Anon_Key, /* index */ Double, Boolean]): SelectMenu = js.native
