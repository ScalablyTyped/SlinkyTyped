...
object mod {
  ...
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
  def apply(date: js.Date, mask: js.UndefOr[scala.Nothing], utc: js.UndefOr[scala.Nothing], gmt: Boolean): String = js.native
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
  def apply(date: js.Date, mask: js.UndefOr[scala.Nothing], utc: Boolean): String = js.native
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
  def apply(date: js.Date, mask: js.UndefOr[scala.Nothing], utc: Boolean, gmt: Boolean): String = js.native
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
  def apply(date: js.Date, mask: String): String = js.native
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
  def apply(date: js.Date, mask: String, utc: js.UndefOr[scala.Nothing], gmt: Boolean): String = js.native
  @JSImport("dateformat", JSImport.Namespace)
  @js.native
