...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileVarargs(value: (js.Array[Double | js.Date | Null])*): Self = this.set("file", js.Array(value :_*))
    ...
    @scala.inline
    def setLabelsDivHTMLElement(value: HTMLElement): Self = this.set("labelsDiv", value.asInstanceOf[js.Any])
