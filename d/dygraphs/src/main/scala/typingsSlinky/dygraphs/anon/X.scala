...
import typingsSlinky.dygraphs.dygraphs.PerAxisOptions
...
object X {
  ...
  implicit class XOps[Self <: X] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withX(value: PerAxisOptions): Self = {
    ...
    @scala.inline
    def withY(value: PerAxisOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withY2(value: PerAxisOptions): Self = {
        val ret = this.duplicate
