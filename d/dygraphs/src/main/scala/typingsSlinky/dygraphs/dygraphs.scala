...
object dygraphs {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.dygraphs.dygraphsStrings.x
    - typingsSlinky.dygraphs.dygraphsStrings.y
    - typingsSlinky.dygraphs.dygraphsStrings.y2
  */
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileVarargs(value: (js.Array[Double | js.Date | Null])*): Self = StObject.set(x, "file", js.Array(value :_*))
      ...
      @scala.inline
      def setLabelsDivHTMLElement(value: HTMLElement): Self = StObject.set(x, "labelsDiv", value.asInstanceOf[js.Any])
