...
object AnonBackgroundColor {
  ...
  implicit class AnonBackgroundColorOps[Self <: AnonBackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFadeInSpeed(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fadeInSpeed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFadeInSpeed: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fadeInSpeed")(js.undefined)
        ret
    }
    @scala.inline
