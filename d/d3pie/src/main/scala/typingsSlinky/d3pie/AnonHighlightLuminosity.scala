...
trait AnonHighlightLuminosity extends js.Object {
  ...
  var load: js.UndefOr[AnonEffect] = js.native
  var pullOutSegmentOnClick: js.UndefOr[AnonSize] = js.native
}

object AnonHighlightLuminosity {
  @scala.inline
  def apply(): AnonHighlightLuminosity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonHighlightLuminosity]
  }
  @scala.inline
  implicit class AnonHighlightLuminosityOps[Self <: AnonHighlightLuminosity] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLoad(value: AnonEffect): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPullOutSegmentOnClick(value: AnonSize): Self = {
        val ret = this.duplicate
