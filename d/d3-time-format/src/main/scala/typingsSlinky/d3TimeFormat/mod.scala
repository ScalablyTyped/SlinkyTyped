...
object mod {
  ...
  object TimeLocaleObject {
    ...
    implicit class TimeLocaleObjectMutableBuilder[Self <: TimeLocaleObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormat(value: String => js.Function1[/* date */ js.Date, String]): Self = StObject.set(x, "format", js.Any.fromFunction1(value))
      
      @scala.inline
      def setParse(value: String => js.Function1[/* dateString */ String, js.Date | Null]): Self = StObject.set(x, "parse", js.Any.fromFunction1(value))
      
      @scala.inline
      def setUtcFormat(value: String => js.Function1[/* date */ js.Date, String]): Self = StObject.set(x, "utcFormat", js.Any.fromFunction1(value))
      
      @scala.inline
      def setUtcParse(value: String => js.Function1[/* dateString */ String, js.Date | Null]): Self = StObject.set(x, "utcParse", js.Any.fromFunction1(value))
    }
  }
}
