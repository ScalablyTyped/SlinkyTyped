...
object Inputs {
  ...
  implicit class InputsMutableBuilder[Self <: Inputs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaginationLinkTargetElement(value: Element): Self = StObject.set(x, "paginationLinkTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPerPageTargetElement(value: Element): Self = StObject.set(x, "perPageTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSearchTargetElement(value: Element): Self = StObject.set(x, "searchTarget", value.asInstanceOf[js.Any])
