...
object Inputs {
  ...
  implicit class InputsOps[Self <: Inputs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPaginationLinkTargetElement(value: Element): Self = this.set("paginationLinkTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPerPageTargetElement(value: Element): Self = this.set("perPageTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSearchTargetElement(value: Element): Self = this.set("searchTarget", value.asInstanceOf[js.Any])
