...
object mod {
  ...
  @scala.inline
  def names_=(x: js.Array[js.RegExp]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("names")(x.asInstanceOf[js.Any])
  
  @JSImport("debug", "skips")
  @js.native
  def skips: js.Array[js.RegExp] = js.native
  @scala.inline
  def skips_=(x: js.Array[js.RegExp]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("skips")(x.asInstanceOf[js.Any])
