...
trait ChartTooltipCallback extends StObject {
  ...
  var labelColor: js.UndefOr[
    js.Function2[
      ...
      /* chart */ typingsSlinky.chartJs.mod.Chart, 
...
object ChartTooltipCallback {
  ...
  implicit class ChartTooltipCallbackMutableBuilder[Self <: ChartTooltipCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelColor(
      value: (/* tooltipItem */ ChartTooltipItem, /* chart */ typingsSlinky.chartJs.mod.Chart) => ChartTooltipLabelColor
    ...
    @scala.inline
    def setLabelTextColor(value: (/* tooltipItem */ ChartTooltipItem, /* chart */ typingsSlinky.chartJs.mod.Chart) => String): Self = StObject.set(x, "labelTextColor", js.Any.fromFunction2(value))
