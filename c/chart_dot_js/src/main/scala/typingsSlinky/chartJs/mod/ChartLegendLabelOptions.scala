...
trait ChartLegendLabelOptions extends StObject {
  ...
  var generateLabels: js.UndefOr[
    js.Function1[/* chart */ typingsSlinky.chartJs.mod.Chart, js.Array[ChartLegendLabelItem]]
  ] = js.native
...
object ChartLegendLabelOptions {
  ...
  implicit class ChartLegendLabelOptionsMutableBuilder[Self <: ChartLegendLabelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGenerateLabels(value: /* chart */ typingsSlinky.chartJs.mod.Chart => js.Array[ChartLegendLabelItem]): Self = StObject.set(x, "generateLabels", js.Any.fromFunction1(value))
