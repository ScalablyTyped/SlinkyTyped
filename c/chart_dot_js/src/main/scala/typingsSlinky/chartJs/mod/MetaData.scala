...
trait MetaData extends StObject {
  ...
  var _chart: typingsSlinky.chartJs.mod.Chart = js.native
...
object MetaData {
  ...
  @scala.inline
  def apply(
    _chart: typingsSlinky.chartJs.mod.Chart,
  ...
  implicit class MetaDataMutableBuilder[Self <: MetaData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_chart(value: typingsSlinky.chartJs.mod.Chart): Self = StObject.set(x, "_chart", value.asInstanceOf[js.Any])
