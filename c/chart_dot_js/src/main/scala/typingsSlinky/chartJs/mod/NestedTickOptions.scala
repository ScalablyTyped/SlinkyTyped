...
object NestedTickOptions {
  ...
  implicit class NestedTickOptionsMutableBuilder[Self <: NestedTickOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackdropColorCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "backdropColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackdropColorCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "backdropColor", value.asInstanceOf[js.Any])
