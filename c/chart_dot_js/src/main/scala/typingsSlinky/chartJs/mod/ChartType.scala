...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.chartJs.chartJsStrings.bar
  - typingsSlinky.chartJs.chartJsStrings.horizontalBar
  - typingsSlinky.chartJs.chartJsStrings.radar
  - typingsSlinky.chartJs.chartJsStrings.doughnut
  - typingsSlinky.chartJs.chartJsStrings.polarArea
  - typingsSlinky.chartJs.chartJsStrings.bubble
  - typingsSlinky.chartJs.chartJsStrings.pie
  - typingsSlinky.chartJs.chartJsStrings.scatter
*/
