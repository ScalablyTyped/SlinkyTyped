...
object ChartPoint {
  ...
  implicit class ChartPointOps[Self <: ChartPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTDate(value: js.Date): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("t")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withT(value: Double | String | js.Date | Moment): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("t")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withX(value: Double | String | js.Date | Moment): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("x")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withY(value: Double | String | js.Date | Moment): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("y")(value.asInstanceOf[js.Any])
        ret
    }
