...
object ChartTooltipOptions {
  ...
  implicit class ChartTooltipOptionsOps[Self <: ChartTooltipOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBodyFontColorCanvasGradient(value: CanvasGradient): Self = this.set("bodyFontColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFooterFontColorCanvasGradient(value: CanvasGradient): Self = this.set("footerFontColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitleFontColorCanvasGradient(value: CanvasGradient): Self = this.set("titleFontColor", value.asInstanceOf[js.Any])
    @scala.inline
