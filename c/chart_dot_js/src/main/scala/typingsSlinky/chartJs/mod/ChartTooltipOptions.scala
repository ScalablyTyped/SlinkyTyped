...
object ChartTooltipOptions {
  ...
  implicit class ChartTooltipOptionsMutableBuilder[Self <: ChartTooltipOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAxis(value: typingsSlinky.chartJs.chartJsStrings.x | y | xy): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBodyFontColorCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "bodyFontColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBodyFontColorCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "bodyFontColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFooterFontColorCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "footerFontColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFooterFontColorCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "footerFontColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleFontColorCanvasGradient(value: CanvasGradient): Self = StObject.set(x, "titleFontColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTitleFontColorCanvasPattern(value: CanvasPattern): Self = StObject.set(x, "titleFontColor", value.asInstanceOf[js.Any])
