...
object ChartElementsOptions {
  ...
  implicit class ChartElementsOptionsOps[Self <: ChartElementsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArc(value: ChartArcOptions): Self = {
    ...
    @scala.inline
    def withLine(value: ChartLineOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoint(value: ChartPointOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRectangle(value: ChartRectangleOptions): Self = {
        val ret = this.duplicate
