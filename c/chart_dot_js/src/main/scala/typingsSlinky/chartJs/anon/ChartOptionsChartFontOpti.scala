...
object ChartOptionsChartFontOpti {
  ...
  def apply(
    ...
    legendCallback: /* chart */ typingsSlinky.chartJs.mod.Chart => String = null,
    ...
    onResize: js.ThisFunction1[/* this */ typingsSlinky.chartJs.mod.Chart, /* newSize */ ChartSize, Unit] = null,
