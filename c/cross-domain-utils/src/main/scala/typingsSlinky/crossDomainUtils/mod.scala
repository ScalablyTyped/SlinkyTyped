...
import typingsSlinky.crossDomainUtils.anon.Cancel
...
import typingsSlinky.crossDomainUtils.typesMod.CrossDomainWindowType
import typingsSlinky.crossDomainUtils.typesMod.DomainMatcher
import typingsSlinky.crossDomainUtils.typesMod.SameDomainWindowType
