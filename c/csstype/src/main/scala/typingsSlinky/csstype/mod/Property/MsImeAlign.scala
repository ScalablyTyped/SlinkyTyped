...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.after
...
object MsImeAlign {
  ...
  @scala.inline
  def after: typingsSlinky.csstype.csstypeStrings.after = "after".asInstanceOf[typingsSlinky.csstype.csstypeStrings.after]
  @scala.inline
