...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait PlaceSelfProperty extends js.Object

object PlaceSelfProperty {
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: Globals): PlaceSelfProperty = value.asInstanceOf[PlaceSelfProperty]
  @scala.inline
  implicit def apply(value: SelfPosition): PlaceSelfProperty = value.asInstanceOf[PlaceSelfProperty]
  @scala.inline
  implicit def apply(value: String): PlaceSelfProperty = value.asInstanceOf[PlaceSelfProperty]
}
