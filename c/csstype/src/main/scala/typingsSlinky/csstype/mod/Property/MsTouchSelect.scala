...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.grippers
...
*/
trait MsTouchSelect extends js.Object
...
object MsTouchSelect {
  ...
  @scala.inline
  def grippers: typingsSlinky.csstype.csstypeStrings.grippers = "grippers".asInstanceOf[typingsSlinky.csstype.csstypeStrings.grippers]
  @scala.inline
