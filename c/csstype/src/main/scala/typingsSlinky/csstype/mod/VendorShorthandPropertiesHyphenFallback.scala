...
trait VendorShorthandPropertiesHyphenFallback[TLength, TTime] extends js.Object {
  var `-moz-animation`: js.UndefOr[Animation[TTime] | js.Array[js.UndefOr[Animation[TTime]]]] = js.undefined
  var `-moz-border-image`: js.UndefOr[BorderImage | js.Array[js.UndefOr[BorderImage]]] = js.undefined
  var `-moz-column-rule`: js.UndefOr[ColumnRule[TLength] | js.Array[js.UndefOr[ColumnRule[TLength]]]] = js.undefined
  var `-moz-columns`: js.UndefOr[Columns[TLength] | js.Array[js.UndefOr[Columns[TLength]]]] = js.undefined
  var `-moz-transition`: js.UndefOr[Transition[TTime] | js.Array[js.UndefOr[Transition[TTime]]]] = js.undefined
  var `-ms-content-zoom-limit`: js.UndefOr[MsContentZoomLimit | js.Array[js.UndefOr[MsContentZoomLimit]]] = js.undefined
  var `-ms-content-zoom-snap`: js.UndefOr[MsContentZoomSnap | js.Array[js.UndefOr[MsContentZoomSnap]]] = js.undefined
  var `-ms-flex`: js.UndefOr[Flex[TLength] | js.Array[js.UndefOr[Flex[TLength]]]] = js.undefined
  var `-ms-scroll-limit`: js.UndefOr[MsScrollLimit | js.Array[js.UndefOr[MsScrollLimit]]] = js.undefined
  var `-ms-scroll-snap-x`: js.UndefOr[MsScrollSnapX | js.Array[js.UndefOr[MsScrollSnapX]]] = js.undefined
  var `-ms-scroll-snap-y`: js.UndefOr[MsScrollSnapY | js.Array[js.UndefOr[MsScrollSnapY]]] = js.undefined
  var `-ms-transition`: js.UndefOr[Transition[TTime] | js.Array[js.UndefOr[Transition[TTime]]]] = js.undefined
  var `-webkit-animation`: js.UndefOr[Animation[TTime] | js.Array[js.UndefOr[Animation[TTime]]]] = js.undefined
  var `-webkit-border-before`: js.UndefOr[WebkitBorderBefore[TLength] | js.Array[js.UndefOr[WebkitBorderBefore[TLength]]]] = js.undefined
  var `-webkit-border-image`: js.UndefOr[BorderImage | js.Array[js.UndefOr[BorderImage]]] = js.undefined
  var `-webkit-border-radius`: js.UndefOr[BorderRadius[TLength] | js.Array[js.UndefOr[BorderRadius[TLength]]]] = js.undefined
  var `-webkit-column-rule`: js.UndefOr[ColumnRule[TLength] | js.Array[js.UndefOr[ColumnRule[TLength]]]] = js.undefined
  var `-webkit-columns`: js.UndefOr[Columns[TLength] | js.Array[js.UndefOr[Columns[TLength]]]] = js.undefined
  var `-webkit-flex`: js.UndefOr[Flex[TLength] | js.Array[js.UndefOr[Flex[TLength]]]] = js.undefined
  var `-webkit-flex-flow`: js.UndefOr[FlexFlow | js.Array[js.UndefOr[FlexFlow]]] = js.undefined
  var `-webkit-mask`: js.UndefOr[WebkitMask[TLength] | js.Array[js.UndefOr[WebkitMask[TLength]]]] = js.undefined
  var `-webkit-text-emphasis`: js.UndefOr[TextEmphasis | js.Array[js.UndefOr[TextEmphasis]]] = js.undefined
  var `-webkit-text-stroke`: js.UndefOr[WebkitTextStroke[TLength] | js.Array[js.UndefOr[WebkitTextStroke[TLength]]]] = js.undefined
  var `-webkit-transition`: js.UndefOr[Transition[TTime] | js.Array[js.UndefOr[Transition[TTime]]]] = js.undefined
}
