...
object ObsoletePropertiesHyphenFallback {
  ...
  implicit class ObsoletePropertiesHyphenFallbackOps[Self <: ObsoletePropertiesHyphenFallback[_], TLength] (val x: Self with ObsoletePropertiesHyphenFallback[TLength]) extends AnyVal {
    ...
    @scala.inline
    def `set-khtml-opacityVarargs`(value: GlobalsNumber*): Self = this.set("-khtml-opacity", js.Array(value :_*))
    @scala.inline
    ...
    @scala.inline
    def `set-moz-opacityVarargs`(value: GlobalsNumber*): Self = this.set("-moz-opacity", js.Array(value :_*))
    @scala.inline
