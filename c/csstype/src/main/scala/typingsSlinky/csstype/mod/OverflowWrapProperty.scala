...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.anywhere
...
object OverflowWrapProperty {
  ...
  @scala.inline
  def anywhere: typingsSlinky.csstype.csstypeStrings.anywhere = "anywhere".asInstanceOf[typingsSlinky.csstype.csstypeStrings.anywhere]
