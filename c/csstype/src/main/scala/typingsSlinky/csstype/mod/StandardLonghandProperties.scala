...
object StandardLonghandProperties {
  ...
  implicit class StandardLonghandPropertiesOps[Self <: StandardLonghandProperties[_], TLength] (val x: Self with StandardLonghandProperties[TLength]) extends AnyVal {
    ...
    @scala.inline
    def setOffsetPosition(value: OffsetPositionProperty[TLength]): Self = this.set("offsetPosition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setShapeImageThreshold(value: GlobalsNumber): Self = this.set("shapeImageThreshold", value.asInstanceOf[js.Any])
    @scala.inline
