...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`ideograph-alpha`
  - typingsSlinky.csstype.csstypeStrings.`ideograph-numeric`
  - typingsSlinky.csstype.csstypeStrings.`ideograph-parenthesis`
  - typingsSlinky.csstype.csstypeStrings.`ideograph-space`
...
*/
trait MsTextAutospace extends js.Object
