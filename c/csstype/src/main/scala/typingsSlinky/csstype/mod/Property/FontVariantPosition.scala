...
*/
trait FontVariantPosition extends js.Object
...
object FontVariantPosition {
  ...
  @scala.inline
  def sub: typingsSlinky.csstype.csstypeStrings.sub = "sub".asInstanceOf[typingsSlinky.csstype.csstypeStrings.sub]
  @scala.inline
  def `super`: typingsSlinky.csstype.csstypeStrings.`super` = "super".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`super`]
  @scala.inline
