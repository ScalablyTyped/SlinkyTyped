...
trait FontFaceHyphenFallback[TLength, TTime] extends js.Object {
  ...
  var `font-display`: js.UndefOr[FontDisplay | js.Array[js.UndefOr[FontDisplay]]] = js.undefined
  var `font-family`: js.UndefOr[String | js.Array[js.UndefOr[String]]] = js.undefined
  var `font-feature-settings`: js.UndefOr[FontFeatureSettings | js.Array[js.UndefOr[FontFeatureSettings]]] = js.undefined
  ...
  var `font-variation-settings`: js.UndefOr[FontVariationSettings | js.Array[js.UndefOr[FontVariationSettings]]] = js.undefined
  var `font-weight`: js.UndefOr[FontWeight | js.Array[js.UndefOr[FontWeight]]] = js.undefined
  var src: js.UndefOr[String | js.Array[js.UndefOr[String]]] = js.undefined
  var `unicode-range`: js.UndefOr[String | js.Array[js.UndefOr[String]]] = js.undefined
}
