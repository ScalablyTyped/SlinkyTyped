...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.disabled
  - typingsSlinky.csstype.csstypeStrings.enabled
...
*/
trait MozUserInputProperty extends js.Object
...
object MozUserInputProperty {
  ...
  @scala.inline
  def disabled: typingsSlinky.csstype.csstypeStrings.disabled = "disabled".asInstanceOf[typingsSlinky.csstype.csstypeStrings.disabled]
  @scala.inline
  def enabled: typingsSlinky.csstype.csstypeStrings.enabled = "enabled".asInstanceOf[typingsSlinky.csstype.csstypeStrings.enabled]
  @scala.inline
