...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`ruby-base`
  - typingsSlinky.csstype.csstypeStrings.`ruby-base-container`
  - typingsSlinky.csstype.csstypeStrings.`ruby-text`
  - typingsSlinky.csstype.csstypeStrings.`ruby-text-container`
  - typingsSlinky.csstype.csstypeStrings.`table-caption`
  - typingsSlinky.csstype.csstypeStrings.`table-cell`
  - typingsSlinky.csstype.csstypeStrings.`table-column`
  - typingsSlinky.csstype.csstypeStrings.`table-column-group`
  - typingsSlinky.csstype.csstypeStrings.`table-footer-group`
  - typingsSlinky.csstype.csstypeStrings.`table-header-group`
  - typingsSlinky.csstype.csstypeStrings.`table-row`
  - typingsSlinky.csstype.csstypeStrings.`table-row-group`
*/
trait DisplayInternal extends _Display
