...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`vertical-to-horizontal`
...
object MsScrollTranslation {
  ...
  @scala.inline
  def `vertical-to-horizontal`: typingsSlinky.csstype.csstypeStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`vertical-to-horizontal`]
}
