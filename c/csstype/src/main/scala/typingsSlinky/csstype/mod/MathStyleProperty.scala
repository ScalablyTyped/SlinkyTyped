...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.compact
...
object MathStyleProperty {
  ...
  @scala.inline
  def compact: typingsSlinky.csstype.csstypeStrings.compact = "compact".asInstanceOf[typingsSlinky.csstype.csstypeStrings.compact]
