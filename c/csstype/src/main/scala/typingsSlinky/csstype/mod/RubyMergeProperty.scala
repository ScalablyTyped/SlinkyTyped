...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.collapse
  - typingsSlinky.csstype.csstypeStrings.separate
...
*/
trait RubyMergeProperty extends StObject
object RubyMergeProperty {
  ...
  @scala.inline
  def separate: typingsSlinky.csstype.csstypeStrings.separate = "separate".asInstanceOf[typingsSlinky.csstype.csstypeStrings.separate]
