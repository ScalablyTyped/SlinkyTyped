...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.manual
...
*/
trait Hyphens extends js.Object
object Hyphens {
  ...
  @scala.inline
  def manual: typingsSlinky.csstype.csstypeStrings.manual = "manual".asInstanceOf[typingsSlinky.csstype.csstypeStrings.manual]
