...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`block-axis`
  - typingsSlinky.csstype.csstypeStrings.horizontal
  - typingsSlinky.csstype.csstypeStrings.inherit
  - typingsSlinky.csstype.csstypeStrings.`inline-axis`
  - typingsSlinky.csstype.csstypeStrings.vertical
