...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`-ms-flexbox`
  - typingsSlinky.csstype.csstypeStrings.`-ms-grid`
  - typingsSlinky.csstype.csstypeStrings.`-webkit-flex`
  - typingsSlinky.csstype.csstypeStrings.flex
  - typingsSlinky.csstype.csstypeStrings.flow
  - typingsSlinky.csstype.csstypeStrings.`flow-root`
  - typingsSlinky.csstype.csstypeStrings.grid
