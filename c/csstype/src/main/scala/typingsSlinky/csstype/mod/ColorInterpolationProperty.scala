...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.linearRGB
  - typingsSlinky.csstype.csstypeStrings.sRGB
...
object ColorInterpolationProperty {
  ...
  @scala.inline
  def linearRGB: typingsSlinky.csstype.csstypeStrings.linearRGB = "linearRGB".asInstanceOf[typingsSlinky.csstype.csstypeStrings.linearRGB]
  
  @scala.inline
  def revert: typingsSlinky.csstype.csstypeStrings.revert = "revert".asInstanceOf[typingsSlinky.csstype.csstypeStrings.revert]
  
  @scala.inline
  def sRGB: typingsSlinky.csstype.csstypeStrings.sRGB = "sRGB".asInstanceOf[typingsSlinky.csstype.csstypeStrings.sRGB]
