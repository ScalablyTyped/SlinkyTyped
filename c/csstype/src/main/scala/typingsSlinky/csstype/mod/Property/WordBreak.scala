...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`break-all`
  - typingsSlinky.csstype.csstypeStrings.`break-word`
  - typingsSlinky.csstype.csstypeStrings.`keep-all`
...
*/
trait WordBreak extends js.Object
...
object WordBreak {
  ...
  @scala.inline
  def `break-all`: typingsSlinky.csstype.csstypeStrings.`break-all` = "break-all".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`break-all`]
  @scala.inline
  ...
  @scala.inline
  def `keep-all`: typingsSlinky.csstype.csstypeStrings.`keep-all` = "keep-all".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`keep-all`]
  @scala.inline
