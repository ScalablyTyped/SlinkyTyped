...
trait VendorLonghandPropertiesFallback[TLength] extends StObject {
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var MozOsxFontSmoothing: js.UndefOr[FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]] = js.native
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitFontSmoothing: js.UndefOr[FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]] = js.native
  ...
  /**
    ...
    * **Initial value**: `over`
    */
  var WebkitRubyPosition: js.UndefOr[RubyPositionProperty | js.Array[RubyPositionProperty]] = js.native
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var msGridColumns: js.UndefOr[MsGridColumnsProperty[TLength] | js.Array[MsGridColumnsProperty[TLength]]] = js.native
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var msGridRows: js.UndefOr[MsGridRowsProperty[TLength] | js.Array[MsGridRowsProperty[TLength]]] = js.native
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msJustifySelf: js.UndefOr[JustifySelfProperty | js.Array[JustifySelfProperty]] = js.native
...
object VendorLonghandPropertiesFallback {
  ...
  implicit class VendorLonghandPropertiesFallbackMutableBuilder[Self <: VendorLonghandPropertiesFallback[_], TLength] (val x: Self with VendorLonghandPropertiesFallback[TLength]) extends AnyVal {
    ...
    @scala.inline
    def setMozOsxFontSmoothing(value: FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]): Self = StObject.set(x, "MozOsxFontSmoothing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMozOsxFontSmoothingUndefined: Self = StObject.set(x, "MozOsxFontSmoothing", js.undefined)
    
    @scala.inline
    def setMozOsxFontSmoothingVarargs(value: FontSmoothProperty[TLength]*): Self = StObject.set(x, "MozOsxFontSmoothing", js.Array(value :_*))
    ...
    @scala.inline
    def setMsGridColumns(value: MsGridColumnsProperty[TLength] | js.Array[MsGridColumnsProperty[TLength]]): Self = StObject.set(x, "msGridColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMsGridColumnsUndefined: Self = StObject.set(x, "msGridColumns", js.undefined)
    
    @scala.inline
    def setMsGridColumnsVarargs(value: MsGridColumnsProperty[TLength]*): Self = StObject.set(x, "msGridColumns", js.Array(value :_*))
    
    @scala.inline
    def setMsGridRows(value: MsGridRowsProperty[TLength] | js.Array[MsGridRowsProperty[TLength]]): Self = StObject.set(x, "msGridRows", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMsGridRowsUndefined: Self = StObject.set(x, "msGridRows", js.undefined)
    
    @scala.inline
    def setMsGridRowsVarargs(value: MsGridRowsProperty[TLength]*): Self = StObject.set(x, "msGridRows", js.Array(value :_*))
    ...
    @scala.inline
    def setMsJustifySelf(value: JustifySelfProperty | js.Array[JustifySelfProperty]): Self = StObject.set(x, "msJustifySelf", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMsJustifySelfUndefined: Self = StObject.set(x, "msJustifySelf", js.undefined)
    
    @scala.inline
    def setMsJustifySelfVarargs(value: JustifySelfProperty*): Self = StObject.set(x, "msJustifySelf", js.Array(value :_*))
    ...
    @scala.inline
    def setWebkitFontSmoothing(value: FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]): Self = StObject.set(x, "WebkitFontSmoothing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWebkitFontSmoothingUndefined: Self = StObject.set(x, "WebkitFontSmoothing", js.undefined)
    
    @scala.inline
    def setWebkitFontSmoothingVarargs(value: FontSmoothProperty[TLength]*): Self = StObject.set(x, "WebkitFontSmoothing", js.Array(value :_*))
    ...
    @scala.inline
    def setWebkitRubyPosition(value: RubyPositionProperty | js.Array[RubyPositionProperty]): Self = StObject.set(x, "WebkitRubyPosition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWebkitRubyPositionUndefined: Self = StObject.set(x, "WebkitRubyPosition", js.undefined)
    
    @scala.inline
    def setWebkitRubyPositionVarargs(value: RubyPositionProperty*): Self = StObject.set(x, "WebkitRubyPosition", js.Array(value :_*))
