...
trait VendorLonghandPropertiesFallback[TLength] extends js.Object {
  ...
  /**
    ...
    */
  var WebkitColorAdjust: js.UndefOr[ColorAdjustProperty | js.Array[ColorAdjustProperty]] = js.undefined
  /**
    * The **`column-count`** CSS property breaks an element's content into the specified number of columns.
    *
    * **Initial value**: `auto`
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msGridColumns: js.UndefOr[GridAutoColumnsProperty[TLength] | js.Array[GridAutoColumnsProperty[TLength]]] = js.undefined
  /**
    * The **`grid-auto-rows`** CSS property specifies the size of an implicitly-created grid row track.
    *
    * **Initial value**: `auto`
    */
  var msGridRows: js.UndefOr[GridAutoRowsProperty[TLength] | js.Array[GridAutoRowsProperty[TLength]]] = js.undefined
  /**
...
object VendorLonghandPropertiesFallback {
  ...
  implicit class VendorLonghandPropertiesFallbackOps[Self <: VendorLonghandPropertiesFallback[_], TLength] (val x: Self with VendorLonghandPropertiesFallback[TLength]) extends AnyVal {
    ...
    @scala.inline
    def setWebkitColorAdjustVarargs(value: ColorAdjustProperty*): Self = this.set("WebkitColorAdjust", js.Array(value :_*))
    @scala.inline
    def setWebkitColorAdjust(value: ColorAdjustProperty | js.Array[ColorAdjustProperty]): Self = this.set("WebkitColorAdjust", value.asInstanceOf[js.Any])
    @scala.inline
