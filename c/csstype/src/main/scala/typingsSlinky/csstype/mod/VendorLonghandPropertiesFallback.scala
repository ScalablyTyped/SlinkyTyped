...
object VendorLonghandPropertiesFallback {
  ...
  implicit class VendorLonghandPropertiesFallbackOps[Self <: VendorLonghandPropertiesFallback[_], TLength] (val x: Self with VendorLonghandPropertiesFallback[TLength]) extends AnyVal {
    ...
    @scala.inline
    def setMozOsxFontSmoothingVarargs(value: FontSmoothProperty[TLength]*): Self = this.set("MozOsxFontSmoothing", js.Array(value :_*))
    
    @scala.inline
    def setMozOsxFontSmoothing(value: FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]): Self = this.set("MozOsxFontSmoothing", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWebkitFontSmoothingVarargs(value: FontSmoothProperty[TLength]*): Self = this.set("WebkitFontSmoothing", js.Array(value :_*))
    
    @scala.inline
    def setWebkitFontSmoothing(value: FontSmoothProperty[TLength] | js.Array[FontSmoothProperty[TLength]]): Self = this.set("WebkitFontSmoothing", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWebkitRubyPositionVarargs(value: RubyPositionProperty*): Self = this.set("WebkitRubyPosition", js.Array(value :_*))
    
    @scala.inline
    def setWebkitRubyPosition(value: RubyPositionProperty | js.Array[RubyPositionProperty]): Self = this.set("WebkitRubyPosition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMsGridColumnsVarargs(value: MsGridColumnsProperty[TLength]*): Self = this.set("msGridColumns", js.Array(value :_*))
    
    @scala.inline
    def setMsGridColumns(value: MsGridColumnsProperty[TLength] | js.Array[MsGridColumnsProperty[TLength]]): Self = this.set("msGridColumns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMsGridColumns: Self = this.set("msGridColumns", js.undefined)
    
    @scala.inline
    def setMsGridRowsVarargs(value: MsGridRowsProperty[TLength]*): Self = this.set("msGridRows", js.Array(value :_*))
    
    @scala.inline
    def setMsGridRows(value: MsGridRowsProperty[TLength] | js.Array[MsGridRowsProperty[TLength]]): Self = this.set("msGridRows", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMsJustifySelfVarargs(value: JustifySelfProperty*): Self = this.set("msJustifySelf", js.Array(value :_*))
    
    @scala.inline
    def setMsJustifySelf(value: JustifySelfProperty | js.Array[JustifySelfProperty]): Self = this.set("msJustifySelf", value.asInstanceOf[js.Any])
