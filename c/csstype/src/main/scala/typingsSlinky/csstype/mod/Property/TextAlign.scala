...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`match-parent`
...
object TextAlign {
  ...
  @scala.inline
  def `match-parent`: typingsSlinky.csstype.csstypeStrings.`match-parent` = "match-parent".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`match-parent`]
