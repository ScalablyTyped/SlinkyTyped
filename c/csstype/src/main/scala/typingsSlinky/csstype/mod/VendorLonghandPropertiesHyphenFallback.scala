...
trait VendorLonghandPropertiesHyphenFallback[TLength, TTime] extends js.Object {
  var `-moz-animation-delay`: js.UndefOr[AnimationDelay[TTime] | js.Array[js.UndefOr[AnimationDelay[TTime]]]] = js.undefined
  var `-moz-animation-direction`: js.UndefOr[AnimationDirection | js.Array[js.UndefOr[AnimationDirection]]] = js.undefined
  var `-moz-animation-duration`: js.UndefOr[AnimationDuration[TTime] | js.Array[js.UndefOr[AnimationDuration[TTime]]]] = js.undefined
  var `-moz-animation-fill-mode`: js.UndefOr[AnimationFillMode | js.Array[js.UndefOr[AnimationFillMode]]] = js.undefined
  var `-moz-animation-iteration-count`: js.UndefOr[AnimationIterationCount | js.Array[js.UndefOr[AnimationIterationCount]]] = js.undefined
  var `-moz-animation-name`: js.UndefOr[AnimationName | js.Array[js.UndefOr[AnimationName]]] = js.undefined
  var `-moz-animation-play-state`: js.UndefOr[AnimationPlayState | js.Array[js.UndefOr[AnimationPlayState]]] = js.undefined
  var `-moz-animation-timing-function`: js.UndefOr[AnimationTimingFunction | js.Array[js.UndefOr[AnimationTimingFunction]]] = js.undefined
  var `-moz-appearance`: js.UndefOr[MozAppearance | js.Array[js.UndefOr[MozAppearance]]] = js.undefined
  var `-moz-backface-visibility`: js.UndefOr[BackfaceVisibility | js.Array[js.UndefOr[BackfaceVisibility]]] = js.undefined
  var `-moz-border-bottom-colors`: js.UndefOr[MozBorderBottomColors | js.Array[js.UndefOr[MozBorderBottomColors]]] = js.undefined
  var `-moz-border-end-color`: js.UndefOr[BorderInlineEndColor | js.Array[js.UndefOr[BorderInlineEndColor]]] = js.undefined
  var `-moz-border-end-style`: js.UndefOr[BorderInlineEndStyle | js.Array[js.UndefOr[BorderInlineEndStyle]]] = js.undefined
  var `-moz-border-end-width`: js.UndefOr[
    BorderInlineEndWidth[TLength] | js.Array[js.UndefOr[BorderInlineEndWidth[TLength]]]
  ] = js.undefined
  var `-moz-border-left-colors`: js.UndefOr[MozBorderLeftColors | js.Array[js.UndefOr[MozBorderLeftColors]]] = js.undefined
  var `-moz-border-right-colors`: js.UndefOr[MozBorderRightColors | js.Array[js.UndefOr[MozBorderRightColors]]] = js.undefined
  var `-moz-border-start-color`: js.UndefOr[BorderInlineStartColor | js.Array[js.UndefOr[BorderInlineStartColor]]] = js.undefined
  var `-moz-border-start-style`: js.UndefOr[BorderInlineStartStyle | js.Array[js.UndefOr[BorderInlineStartStyle]]] = js.undefined
  var `-moz-border-top-colors`: js.UndefOr[MozBorderTopColors | js.Array[js.UndefOr[MozBorderTopColors]]] = js.undefined
  var `-moz-box-sizing`: js.UndefOr[BoxSizing | js.Array[js.UndefOr[BoxSizing]]] = js.undefined
  var `-moz-column-count`: js.UndefOr[ColumnCount | js.Array[js.UndefOr[ColumnCount]]] = js.undefined
  var `-moz-column-fill`: js.UndefOr[ColumnFill | js.Array[js.UndefOr[ColumnFill]]] = js.undefined
  var `-moz-column-gap`: js.UndefOr[ColumnGap[TLength] | js.Array[js.UndefOr[ColumnGap[TLength]]]] = js.undefined
  var `-moz-column-rule-color`: js.UndefOr[ColumnRuleColor | js.Array[js.UndefOr[ColumnRuleColor]]] = js.undefined
  var `-moz-column-rule-style`: js.UndefOr[ColumnRuleStyle | js.Array[js.UndefOr[ColumnRuleStyle]]] = js.undefined
  var `-moz-column-rule-width`: js.UndefOr[ColumnRuleWidth[TLength] | js.Array[js.UndefOr[ColumnRuleWidth[TLength]]]] = js.undefined
  var `-moz-column-width`: js.UndefOr[ColumnWidth[TLength] | js.Array[js.UndefOr[ColumnWidth[TLength]]]] = js.undefined
  var `-moz-context-properties`: js.UndefOr[MozContextProperties | js.Array[js.UndefOr[MozContextProperties]]] = js.undefined
  var `-moz-float-edge`: js.UndefOr[MozFloatEdge | js.Array[js.UndefOr[MozFloatEdge]]] = js.undefined
  var `-moz-font-feature-settings`: js.UndefOr[FontFeatureSettings | js.Array[js.UndefOr[FontFeatureSettings]]] = js.undefined
  var `-moz-font-language-override`: js.UndefOr[FontLanguageOverride | js.Array[js.UndefOr[FontLanguageOverride]]] = js.undefined
  var `-moz-force-broken-image-icon`: js.UndefOr[MozForceBrokenImageIcon | js.Array[js.UndefOr[MozForceBrokenImageIcon]]] = js.undefined
  var `-moz-hyphens`: js.UndefOr[Hyphens | js.Array[js.UndefOr[Hyphens]]] = js.undefined
  var `-moz-image-region`: js.UndefOr[MozImageRegion | js.Array[js.UndefOr[MozImageRegion]]] = js.undefined
  var `-moz-margin-end`: js.UndefOr[MarginInlineEnd[TLength] | js.Array[js.UndefOr[MarginInlineEnd[TLength]]]] = js.undefined
  var `-moz-margin-start`: js.UndefOr[MarginInlineStart[TLength] | js.Array[js.UndefOr[MarginInlineStart[TLength]]]] = js.undefined
  var `-moz-orient`: js.UndefOr[MozOrient | js.Array[js.UndefOr[MozOrient]]] = js.undefined
  ...
  var `-moz-padding-end`: js.UndefOr[PaddingInlineEnd[TLength] | js.Array[js.UndefOr[PaddingInlineEnd[TLength]]]] = js.undefined
  var `-moz-padding-start`: js.UndefOr[PaddingInlineStart[TLength] | js.Array[js.UndefOr[PaddingInlineStart[TLength]]]] = js.undefined
  var `-moz-perspective`: js.UndefOr[Perspective[TLength] | js.Array[js.UndefOr[Perspective[TLength]]]] = js.undefined
  var `-moz-perspective-origin`: js.UndefOr[PerspectiveOrigin[TLength] | js.Array[js.UndefOr[PerspectiveOrigin[TLength]]]] = js.undefined
  var `-moz-stack-sizing`: js.UndefOr[MozStackSizing | js.Array[js.UndefOr[MozStackSizing]]] = js.undefined
  var `-moz-tab-size`: js.UndefOr[TabSize[TLength] | js.Array[js.UndefOr[TabSize[TLength]]]] = js.undefined
  var `-moz-text-blink`: js.UndefOr[MozTextBlink | js.Array[js.UndefOr[MozTextBlink]]] = js.undefined
  var `-moz-text-size-adjust`: js.UndefOr[TextSizeAdjust | js.Array[js.UndefOr[TextSizeAdjust]]] = js.undefined
  var `-moz-transform-origin`: js.UndefOr[TransformOrigin[TLength] | js.Array[js.UndefOr[TransformOrigin[TLength]]]] = js.undefined
  var `-moz-transform-style`: js.UndefOr[TransformStyle | js.Array[js.UndefOr[TransformStyle]]] = js.undefined
  var `-moz-transition-delay`: js.UndefOr[TransitionDelay[TTime] | js.Array[js.UndefOr[TransitionDelay[TTime]]]] = js.undefined
  var `-moz-transition-duration`: js.UndefOr[TransitionDuration[TTime] | js.Array[js.UndefOr[TransitionDuration[TTime]]]] = js.undefined
  var `-moz-transition-property`: js.UndefOr[TransitionProperty | js.Array[js.UndefOr[TransitionProperty]]] = js.undefined
  var `-moz-transition-timing-function`: js.UndefOr[TransitionTimingFunction | js.Array[js.UndefOr[TransitionTimingFunction]]] = js.undefined
  var `-moz-user-focus`: js.UndefOr[MozUserFocus | js.Array[js.UndefOr[MozUserFocus]]] = js.undefined
  var `-moz-user-modify`: js.UndefOr[MozUserModify | js.Array[js.UndefOr[MozUserModify]]] = js.undefined
  var `-moz-user-select`: js.UndefOr[UserSelect | js.Array[js.UndefOr[UserSelect]]] = js.undefined
  var `-moz-window-dragging`: js.UndefOr[MozWindowDragging | js.Array[js.UndefOr[MozWindowDragging]]] = js.undefined
  var `-moz-window-shadow`: js.UndefOr[MozWindowShadow | js.Array[js.UndefOr[MozWindowShadow]]] = js.undefined
  var `-ms-accelerator`: js.UndefOr[MsAccelerator | js.Array[js.UndefOr[MsAccelerator]]] = js.undefined
  var `-ms-align-self`: js.UndefOr[AlignSelf | js.Array[js.UndefOr[AlignSelf]]] = js.undefined
  var `-ms-block-progression`: js.UndefOr[MsBlockProgression | js.Array[js.UndefOr[MsBlockProgression]]] = js.undefined
  var `-ms-content-zoom-chaining`: js.UndefOr[MsContentZoomChaining | js.Array[js.UndefOr[MsContentZoomChaining]]] = js.undefined
  var `-ms-content-zoom-limit-max`: js.UndefOr[MsContentZoomLimitMax | js.Array[js.UndefOr[MsContentZoomLimitMax]]] = js.undefined
  var `-ms-content-zoom-limit-min`: js.UndefOr[MsContentZoomLimitMin | js.Array[js.UndefOr[MsContentZoomLimitMin]]] = js.undefined
  var `-ms-content-zoom-snap-points`: js.UndefOr[MsContentZoomSnapPoints | js.Array[js.UndefOr[MsContentZoomSnapPoints]]] = js.undefined
  var `-ms-content-zoom-snap-type`: js.UndefOr[MsContentZoomSnapType | js.Array[js.UndefOr[MsContentZoomSnapType]]] = js.undefined
  var `-ms-content-zooming`: js.UndefOr[MsContentZooming | js.Array[js.UndefOr[MsContentZooming]]] = js.undefined
  var `-ms-filter`: js.UndefOr[MsFilter | js.Array[js.UndefOr[MsFilter]]] = js.undefined
  var `-ms-flex-direction`: js.UndefOr[FlexDirection | js.Array[js.UndefOr[FlexDirection]]] = js.undefined
  var `-ms-flex-positive`: js.UndefOr[FlexGrow | js.Array[js.UndefOr[FlexGrow]]] = js.undefined
  var `-ms-flow-from`: js.UndefOr[MsFlowFrom | js.Array[js.UndefOr[MsFlowFrom]]] = js.undefined
  var `-ms-flow-into`: js.UndefOr[MsFlowInto | js.Array[js.UndefOr[MsFlowInto]]] = js.undefined
  var `-ms-grid-columns`: js.UndefOr[GridAutoColumns[TLength] | js.Array[js.UndefOr[GridAutoColumns[TLength]]]] = js.undefined
  var `-ms-grid-rows`: js.UndefOr[GridAutoRows[TLength] | js.Array[js.UndefOr[GridAutoRows[TLength]]]] = js.undefined
  var `-ms-high-contrast-adjust`: js.UndefOr[MsHighContrastAdjust | js.Array[js.UndefOr[MsHighContrastAdjust]]] = js.undefined
  var `-ms-hyphenate-limit-chars`: js.UndefOr[MsHyphenateLimitChars | js.Array[js.UndefOr[MsHyphenateLimitChars]]] = js.undefined
  var `-ms-hyphenate-limit-lines`: js.UndefOr[MsHyphenateLimitLines | js.Array[js.UndefOr[MsHyphenateLimitLines]]] = js.undefined
  var `-ms-hyphenate-limit-zone`: js.UndefOr[
    MsHyphenateLimitZone[TLength] | js.Array[js.UndefOr[MsHyphenateLimitZone[TLength]]]
  ] = js.undefined
  var `-ms-hyphens`: js.UndefOr[Hyphens | js.Array[js.UndefOr[Hyphens]]] = js.undefined
  var `-ms-ime-align`: js.UndefOr[MsImeAlign | js.Array[js.UndefOr[MsImeAlign]]] = js.undefined
  var `-ms-line-break`: js.UndefOr[LineBreak | js.Array[js.UndefOr[LineBreak]]] = js.undefined
  var `-ms-order`: js.UndefOr[Order | js.Array[js.UndefOr[Order]]] = js.undefined
  var `-ms-overflow-style`: js.UndefOr[MsOverflowStyle | js.Array[js.UndefOr[MsOverflowStyle]]] = js.undefined
  var `-ms-overflow-x`: js.UndefOr[OverflowX | js.Array[js.UndefOr[OverflowX]]] = js.undefined
  var `-ms-overflow-y`: js.UndefOr[OverflowY | js.Array[js.UndefOr[OverflowY]]] = js.undefined
  var `-ms-scroll-chaining`: js.UndefOr[MsScrollChaining | js.Array[js.UndefOr[MsScrollChaining]]] = js.undefined
  var `-ms-scroll-limit-x-max`: js.UndefOr[MsScrollLimitXMax[TLength] | js.Array[js.UndefOr[MsScrollLimitXMax[TLength]]]] = js.undefined
  var `-ms-scroll-limit-x-min`: js.UndefOr[MsScrollLimitXMin[TLength] | js.Array[js.UndefOr[MsScrollLimitXMin[TLength]]]] = js.undefined
  var `-ms-scroll-limit-y-max`: js.UndefOr[MsScrollLimitYMax[TLength] | js.Array[js.UndefOr[MsScrollLimitYMax[TLength]]]] = js.undefined
  var `-ms-scroll-limit-y-min`: js.UndefOr[MsScrollLimitYMin[TLength] | js.Array[js.UndefOr[MsScrollLimitYMin[TLength]]]] = js.undefined
  var `-ms-scroll-rails`: js.UndefOr[MsScrollRails | js.Array[js.UndefOr[MsScrollRails]]] = js.undefined
  var `-ms-scroll-snap-points-x`: js.UndefOr[MsScrollSnapPointsX | js.Array[js.UndefOr[MsScrollSnapPointsX]]] = js.undefined
  var `-ms-scroll-snap-points-y`: js.UndefOr[MsScrollSnapPointsY | js.Array[js.UndefOr[MsScrollSnapPointsY]]] = js.undefined
  var `-ms-scroll-snap-type`: js.UndefOr[MsScrollSnapType | js.Array[js.UndefOr[MsScrollSnapType]]] = js.undefined
  var `-ms-scroll-translation`: js.UndefOr[MsScrollTranslation | js.Array[js.UndefOr[MsScrollTranslation]]] = js.undefined
  var `-ms-scrollbar-3dlight-color`: js.UndefOr[MsScrollbar3dlightColor | js.Array[js.UndefOr[MsScrollbar3dlightColor]]] = js.undefined
  var `-ms-scrollbar-arrow-color`: js.UndefOr[MsScrollbarArrowColor | js.Array[js.UndefOr[MsScrollbarArrowColor]]] = js.undefined
  var `-ms-scrollbar-base-color`: js.UndefOr[MsScrollbarBaseColor | js.Array[js.UndefOr[MsScrollbarBaseColor]]] = js.undefined
  var `-ms-scrollbar-darkshadow-color`: js.UndefOr[MsScrollbarDarkshadowColor | js.Array[js.UndefOr[MsScrollbarDarkshadowColor]]] = js.undefined
  var `-ms-scrollbar-face-color`: js.UndefOr[MsScrollbarFaceColor | js.Array[js.UndefOr[MsScrollbarFaceColor]]] = js.undefined
  var `-ms-scrollbar-highlight-color`: js.UndefOr[MsScrollbarHighlightColor | js.Array[js.UndefOr[MsScrollbarHighlightColor]]] = js.undefined
  var `-ms-scrollbar-shadow-color`: js.UndefOr[MsScrollbarShadowColor | js.Array[js.UndefOr[MsScrollbarShadowColor]]] = js.undefined
  var `-ms-text-autospace`: js.UndefOr[MsTextAutospace | js.Array[js.UndefOr[MsTextAutospace]]] = js.undefined
  var `-ms-text-combine-horizontal`: js.UndefOr[TextCombineUpright | js.Array[js.UndefOr[TextCombineUpright]]] = js.undefined
  var `-ms-text-overflow`: js.UndefOr[TextOverflow | js.Array[js.UndefOr[TextOverflow]]] = js.undefined
  var `-ms-touch-action`: js.UndefOr[TouchAction | js.Array[js.UndefOr[TouchAction]]] = js.undefined
  var `-ms-touch-select`: js.UndefOr[MsTouchSelect | js.Array[js.UndefOr[MsTouchSelect]]] = js.undefined
  var `-ms-transform`: js.UndefOr[Transform | js.Array[js.UndefOr[Transform]]] = js.undefined
  var `-ms-transform-origin`: js.UndefOr[TransformOrigin[TLength] | js.Array[js.UndefOr[TransformOrigin[TLength]]]] = js.undefined
  var `-ms-transition-delay`: js.UndefOr[TransitionDelay[TTime] | js.Array[js.UndefOr[TransitionDelay[TTime]]]] = js.undefined
  var `-ms-transition-duration`: js.UndefOr[TransitionDuration[TTime] | js.Array[js.UndefOr[TransitionDuration[TTime]]]] = js.undefined
  var `-ms-transition-property`: js.UndefOr[TransitionProperty | js.Array[js.UndefOr[TransitionProperty]]] = js.undefined
  var `-ms-transition-timing-function`: js.UndefOr[TransitionTimingFunction | js.Array[js.UndefOr[TransitionTimingFunction]]] = js.undefined
  var `-ms-user-select`: js.UndefOr[MsUserSelect | js.Array[js.UndefOr[MsUserSelect]]] = js.undefined
  var `-ms-word-break`: js.UndefOr[WordBreak | js.Array[js.UndefOr[WordBreak]]] = js.undefined
  var `-ms-wrap-flow`: js.UndefOr[MsWrapFlow | js.Array[js.UndefOr[MsWrapFlow]]] = js.undefined
  var `-ms-wrap-margin`: js.UndefOr[MsWrapMargin[TLength] | js.Array[js.UndefOr[MsWrapMargin[TLength]]]] = js.undefined
  var `-ms-wrap-through`: js.UndefOr[MsWrapThrough | js.Array[js.UndefOr[MsWrapThrough]]] = js.undefined
  var `-ms-writing-mode`: js.UndefOr[WritingMode | js.Array[js.UndefOr[WritingMode]]] = js.undefined
  var `-o-object-fit`: js.UndefOr[ObjectFit | js.Array[js.UndefOr[ObjectFit]]] = js.undefined
  var `-o-object-position`: js.UndefOr[ObjectPosition[TLength] | js.Array[js.UndefOr[ObjectPosition[TLength]]]] = js.undefined
  var `-o-tab-size`: js.UndefOr[TabSize[TLength] | js.Array[js.UndefOr[TabSize[TLength]]]] = js.undefined
  var `-o-text-overflow`: js.UndefOr[TextOverflow | js.Array[js.UndefOr[TextOverflow]]] = js.undefined
  var `-o-transform-origin`: js.UndefOr[TransformOrigin[TLength] | js.Array[js.UndefOr[TransformOrigin[TLength]]]] = js.undefined
  var `-webkit-align-content`: js.UndefOr[AlignContent | js.Array[js.UndefOr[AlignContent]]] = js.undefined
  var `-webkit-align-items`: js.UndefOr[AlignItems | js.Array[js.UndefOr[AlignItems]]] = js.undefined
  var `-webkit-align-self`: js.UndefOr[AlignSelf | js.Array[js.UndefOr[AlignSelf]]] = js.undefined
  var `-webkit-animation-delay`: js.UndefOr[AnimationDelay[TTime] | js.Array[js.UndefOr[AnimationDelay[TTime]]]] = js.undefined
  var `-webkit-animation-direction`: js.UndefOr[AnimationDirection | js.Array[js.UndefOr[AnimationDirection]]] = js.undefined
  var `-webkit-animation-duration`: js.UndefOr[AnimationDuration[TTime] | js.Array[js.UndefOr[AnimationDuration[TTime]]]] = js.undefined
  var `-webkit-animation-fill-mode`: js.UndefOr[AnimationFillMode | js.Array[js.UndefOr[AnimationFillMode]]] = js.undefined
  var `-webkit-animation-iteration-count`: js.UndefOr[AnimationIterationCount | js.Array[js.UndefOr[AnimationIterationCount]]] = js.undefined
  var `-webkit-animation-name`: js.UndefOr[AnimationName | js.Array[js.UndefOr[AnimationName]]] = js.undefined
  var `-webkit-animation-play-state`: js.UndefOr[AnimationPlayState | js.Array[js.UndefOr[AnimationPlayState]]] = js.undefined
  var `-webkit-animation-timing-function`: js.UndefOr[AnimationTimingFunction | js.Array[js.UndefOr[AnimationTimingFunction]]] = js.undefined
  var `-webkit-appearance`: js.UndefOr[WebkitAppearance | js.Array[js.UndefOr[WebkitAppearance]]] = js.undefined
  var `-webkit-backdrop-filter`: js.UndefOr[BackdropFilter | js.Array[js.UndefOr[BackdropFilter]]] = js.undefined
  var `-webkit-backface-visibility`: js.UndefOr[BackfaceVisibility | js.Array[js.UndefOr[BackfaceVisibility]]] = js.undefined
  var `-webkit-background-clip`: js.UndefOr[BackgroundClip | js.Array[js.UndefOr[BackgroundClip]]] = js.undefined
  var `-webkit-background-origin`: js.UndefOr[BackgroundOrigin | js.Array[js.UndefOr[BackgroundOrigin]]] = js.undefined
  var `-webkit-background-size`: js.UndefOr[BackgroundSize[TLength] | js.Array[js.UndefOr[BackgroundSize[TLength]]]] = js.undefined
  var `-webkit-border-before-color`: js.UndefOr[WebkitBorderBeforeColor | js.Array[js.UndefOr[WebkitBorderBeforeColor]]] = js.undefined
  var `-webkit-border-before-style`: js.UndefOr[WebkitBorderBeforeStyle | js.Array[js.UndefOr[WebkitBorderBeforeStyle]]] = js.undefined
  ...
  var `-webkit-border-image-slice`: js.UndefOr[BorderImageSlice | js.Array[js.UndefOr[BorderImageSlice]]] = js.undefined
  ...
  var `-webkit-box-decoration-break`: js.UndefOr[BoxDecorationBreak | js.Array[js.UndefOr[BoxDecorationBreak]]] = js.undefined
  var `-webkit-box-reflect`: js.UndefOr[WebkitBoxReflect[TLength] | js.Array[js.UndefOr[WebkitBoxReflect[TLength]]]] = js.undefined
  var `-webkit-box-shadow`: js.UndefOr[BoxShadow | js.Array[js.UndefOr[BoxShadow]]] = js.undefined
  var `-webkit-box-sizing`: js.UndefOr[BoxSizing | js.Array[js.UndefOr[BoxSizing]]] = js.undefined
  var `-webkit-clip-path`: js.UndefOr[ClipPath | js.Array[js.UndefOr[ClipPath]]] = js.undefined
  var `-webkit-column-count`: js.UndefOr[ColumnCount | js.Array[js.UndefOr[ColumnCount]]] = js.undefined
  var `-webkit-column-fill`: js.UndefOr[ColumnFill | js.Array[js.UndefOr[ColumnFill]]] = js.undefined
  var `-webkit-column-gap`: js.UndefOr[ColumnGap[TLength] | js.Array[js.UndefOr[ColumnGap[TLength]]]] = js.undefined
  var `-webkit-column-rule-color`: js.UndefOr[ColumnRuleColor | js.Array[js.UndefOr[ColumnRuleColor]]] = js.undefined
  var `-webkit-column-rule-style`: js.UndefOr[ColumnRuleStyle | js.Array[js.UndefOr[ColumnRuleStyle]]] = js.undefined
  var `-webkit-column-rule-width`: js.UndefOr[ColumnRuleWidth[TLength] | js.Array[js.UndefOr[ColumnRuleWidth[TLength]]]] = js.undefined
  var `-webkit-column-span`: js.UndefOr[ColumnSpan | js.Array[js.UndefOr[ColumnSpan]]] = js.undefined
  var `-webkit-column-width`: js.UndefOr[ColumnWidth[TLength] | js.Array[js.UndefOr[ColumnWidth[TLength]]]] = js.undefined
  var `-webkit-filter`: js.UndefOr[Filter | js.Array[js.UndefOr[Filter]]] = js.undefined
  var `-webkit-flex-basis`: js.UndefOr[FlexBasis[TLength] | js.Array[js.UndefOr[FlexBasis[TLength]]]] = js.undefined
  var `-webkit-flex-direction`: js.UndefOr[FlexDirection | js.Array[js.UndefOr[FlexDirection]]] = js.undefined
  var `-webkit-flex-grow`: js.UndefOr[FlexGrow | js.Array[js.UndefOr[FlexGrow]]] = js.undefined
  var `-webkit-flex-shrink`: js.UndefOr[FlexShrink | js.Array[js.UndefOr[FlexShrink]]] = js.undefined
  var `-webkit-flex-wrap`: js.UndefOr[FlexWrap | js.Array[js.UndefOr[FlexWrap]]] = js.undefined
  var `-webkit-font-feature-settings`: js.UndefOr[FontFeatureSettings | js.Array[js.UndefOr[FontFeatureSettings]]] = js.undefined
  var `-webkit-font-kerning`: js.UndefOr[FontKerning | js.Array[js.UndefOr[FontKerning]]] = js.undefined
  var `-webkit-font-variant-ligatures`: js.UndefOr[FontVariantLigatures | js.Array[js.UndefOr[FontVariantLigatures]]] = js.undefined
  var `-webkit-hyphens`: js.UndefOr[Hyphens | js.Array[js.UndefOr[Hyphens]]] = js.undefined
  var `-webkit-justify-content`: js.UndefOr[JustifyContent | js.Array[js.UndefOr[JustifyContent]]] = js.undefined
  var `-webkit-line-break`: js.UndefOr[LineBreak | js.Array[js.UndefOr[LineBreak]]] = js.undefined
  var `-webkit-line-clamp`: js.UndefOr[WebkitLineClamp | js.Array[js.UndefOr[WebkitLineClamp]]] = js.undefined
  var `-webkit-margin-end`: js.UndefOr[MarginInlineEnd[TLength] | js.Array[js.UndefOr[MarginInlineEnd[TLength]]]] = js.undefined
  var `-webkit-margin-start`: js.UndefOr[MarginInlineStart[TLength] | js.Array[js.UndefOr[MarginInlineStart[TLength]]]] = js.undefined
  var `-webkit-mask-attachment`: js.UndefOr[WebkitMaskAttachment | js.Array[js.UndefOr[WebkitMaskAttachment]]] = js.undefined
  var `-webkit-mask-clip`: js.UndefOr[WebkitMaskClip | js.Array[js.UndefOr[WebkitMaskClip]]] = js.undefined
  var `-webkit-mask-composite`: js.UndefOr[WebkitMaskComposite | js.Array[js.UndefOr[WebkitMaskComposite]]] = js.undefined
  var `-webkit-mask-image`: js.UndefOr[WebkitMaskImage | js.Array[js.UndefOr[WebkitMaskImage]]] = js.undefined
  var `-webkit-mask-origin`: js.UndefOr[WebkitMaskOrigin | js.Array[js.UndefOr[WebkitMaskOrigin]]] = js.undefined
  var `-webkit-mask-position`: js.UndefOr[WebkitMaskPosition[TLength] | js.Array[js.UndefOr[WebkitMaskPosition[TLength]]]] = js.undefined
  ...
  var `-webkit-mask-repeat`: js.UndefOr[WebkitMaskRepeat | js.Array[js.UndefOr[WebkitMaskRepeat]]] = js.undefined
  var `-webkit-mask-repeat-x`: js.UndefOr[WebkitMaskRepeatX | js.Array[js.UndefOr[WebkitMaskRepeatX]]] = js.undefined
  var `-webkit-mask-repeat-y`: js.UndefOr[WebkitMaskRepeatY | js.Array[js.UndefOr[WebkitMaskRepeatY]]] = js.undefined
  var `-webkit-mask-size`: js.UndefOr[WebkitMaskSize[TLength] | js.Array[js.UndefOr[WebkitMaskSize[TLength]]]] = js.undefined
  var `-webkit-max-inline-size`: js.UndefOr[MaxInlineSize[TLength] | js.Array[js.UndefOr[MaxInlineSize[TLength]]]] = js.undefined
  var `-webkit-order`: js.UndefOr[Order | js.Array[js.UndefOr[Order]]] = js.undefined
  var `-webkit-overflow-scrolling`: js.UndefOr[WebkitOverflowScrolling | js.Array[js.UndefOr[WebkitOverflowScrolling]]] = js.undefined
  var `-webkit-padding-end`: js.UndefOr[PaddingInlineEnd[TLength] | js.Array[js.UndefOr[PaddingInlineEnd[TLength]]]] = js.undefined
  var `-webkit-padding-start`: js.UndefOr[PaddingInlineStart[TLength] | js.Array[js.UndefOr[PaddingInlineStart[TLength]]]] = js.undefined
  var `-webkit-perspective`: js.UndefOr[Perspective[TLength] | js.Array[js.UndefOr[Perspective[TLength]]]] = js.undefined
  var `-webkit-perspective-origin`: js.UndefOr[PerspectiveOrigin[TLength] | js.Array[js.UndefOr[PerspectiveOrigin[TLength]]]] = js.undefined
  var `-webkit-print-color-adjust`: js.UndefOr[ColorAdjust | js.Array[js.UndefOr[ColorAdjust]]] = js.undefined
  var `-webkit-scroll-snap-type`: js.UndefOr[ScrollSnapType | js.Array[js.UndefOr[ScrollSnapType]]] = js.undefined
  var `-webkit-shape-margin`: js.UndefOr[ShapeMargin[TLength] | js.Array[js.UndefOr[ShapeMargin[TLength]]]] = js.undefined
  var `-webkit-tap-highlight-color`: js.UndefOr[WebkitTapHighlightColor | js.Array[js.UndefOr[WebkitTapHighlightColor]]] = js.undefined
  var `-webkit-text-combine`: js.UndefOr[TextCombineUpright | js.Array[js.UndefOr[TextCombineUpright]]] = js.undefined
  var `-webkit-text-decoration-color`: js.UndefOr[TextDecorationColor | js.Array[js.UndefOr[TextDecorationColor]]] = js.undefined
  var `-webkit-text-decoration-line`: js.UndefOr[TextDecorationLine | js.Array[js.UndefOr[TextDecorationLine]]] = js.undefined
  var `-webkit-text-decoration-skip`: js.UndefOr[TextDecorationSkip | js.Array[js.UndefOr[TextDecorationSkip]]] = js.undefined
  var `-webkit-text-decoration-style`: js.UndefOr[TextDecorationStyle | js.Array[js.UndefOr[TextDecorationStyle]]] = js.undefined
  var `-webkit-text-emphasis-color`: js.UndefOr[TextEmphasisColor | js.Array[js.UndefOr[TextEmphasisColor]]] = js.undefined
  var `-webkit-text-emphasis-position`: js.UndefOr[TextEmphasisPosition | js.Array[js.UndefOr[TextEmphasisPosition]]] = js.undefined
  var `-webkit-text-emphasis-style`: js.UndefOr[TextEmphasisStyle | js.Array[js.UndefOr[TextEmphasisStyle]]] = js.undefined
  var `-webkit-text-fill-color`: js.UndefOr[WebkitTextFillColor | js.Array[js.UndefOr[WebkitTextFillColor]]] = js.undefined
  var `-webkit-text-orientation`: js.UndefOr[TextOrientation | js.Array[js.UndefOr[TextOrientation]]] = js.undefined
  var `-webkit-text-size-adjust`: js.UndefOr[TextSizeAdjust | js.Array[js.UndefOr[TextSizeAdjust]]] = js.undefined
  var `-webkit-text-stroke-color`: js.UndefOr[WebkitTextStrokeColor | js.Array[js.UndefOr[WebkitTextStrokeColor]]] = js.undefined
  var `-webkit-text-stroke-width`: js.UndefOr[
    WebkitTextStrokeWidth[TLength] | js.Array[js.UndefOr[WebkitTextStrokeWidth[TLength]]]
  ] = js.undefined
  var `-webkit-text-underline-position`: js.UndefOr[TextUnderlinePosition | js.Array[js.UndefOr[TextUnderlinePosition]]] = js.undefined
  var `-webkit-touch-callout`: js.UndefOr[WebkitTouchCallout | js.Array[js.UndefOr[WebkitTouchCallout]]] = js.undefined
  var `-webkit-transform`: js.UndefOr[Transform | js.Array[js.UndefOr[Transform]]] = js.undefined
  var `-webkit-transform-origin`: js.UndefOr[TransformOrigin[TLength] | js.Array[js.UndefOr[TransformOrigin[TLength]]]] = js.undefined
  var `-webkit-transform-style`: js.UndefOr[TransformStyle | js.Array[js.UndefOr[TransformStyle]]] = js.undefined
  var `-webkit-transition-delay`: js.UndefOr[TransitionDelay[TTime] | js.Array[js.UndefOr[TransitionDelay[TTime]]]] = js.undefined
  var `-webkit-transition-duration`: js.UndefOr[TransitionDuration[TTime] | js.Array[js.UndefOr[TransitionDuration[TTime]]]] = js.undefined
  var `-webkit-transition-property`: js.UndefOr[TransitionProperty | js.Array[js.UndefOr[TransitionProperty]]] = js.undefined
  var `-webkit-transition-timing-function`: js.UndefOr[TransitionTimingFunction | js.Array[js.UndefOr[TransitionTimingFunction]]] = js.undefined
  var `-webkit-user-modify`: js.UndefOr[WebkitUserModify | js.Array[js.UndefOr[WebkitUserModify]]] = js.undefined
  var `-webkit-user-select`: js.UndefOr[UserSelect | js.Array[js.UndefOr[UserSelect]]] = js.undefined
  var `-webkit-writing-mode`: js.UndefOr[WritingMode | js.Array[js.UndefOr[WritingMode]]] = js.undefined
}
