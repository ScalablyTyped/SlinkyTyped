...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`break-word`
...
object WordWrap {
  ...
  @scala.inline
  def `break-word`: typingsSlinky.csstype.csstypeStrings.`break-word` = "break-word".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`break-word`]
  @scala.inline
