...
object SelfPosition {
  ...
  @scala.inline
  def `self-end`: typingsSlinky.csstype.csstypeStrings.`self-end` = this.cast("self-end")
  @scala.inline
  def `self-start`: typingsSlinky.csstype.csstypeStrings.`self-start` = this.cast("self-start")
  @scala.inline
