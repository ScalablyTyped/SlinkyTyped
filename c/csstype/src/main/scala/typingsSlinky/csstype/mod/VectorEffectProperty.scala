...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`non-scaling-stroke`
...
object VectorEffectProperty {
  ...
  @scala.inline
  def `non-scaling-stroke`: typingsSlinky.csstype.csstypeStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`non-scaling-stroke`]
