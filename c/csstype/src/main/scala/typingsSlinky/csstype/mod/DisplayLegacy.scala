...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`-ms-inline-flexbox`
  - typingsSlinky.csstype.csstypeStrings.`-ms-inline-grid`
  - typingsSlinky.csstype.csstypeStrings.`-webkit-inline-flex`
  - typingsSlinky.csstype.csstypeStrings.`inline-block`
  - typingsSlinky.csstype.csstypeStrings.`inline-flex`
  - typingsSlinky.csstype.csstypeStrings.`inline-grid`
