...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.mixed
  - typingsSlinky.csstype.csstypeStrings.sideways
  - typingsSlinky.csstype.csstypeStrings.upright
...
*/
trait TextOrientation extends js.Object
object TextOrientation {
  ...
  @scala.inline
  def mixed: typingsSlinky.csstype.csstypeStrings.mixed = "mixed".asInstanceOf[typingsSlinky.csstype.csstypeStrings.mixed]
  
  @scala.inline
  def revert: typingsSlinky.csstype.csstypeStrings.revert = "revert".asInstanceOf[typingsSlinky.csstype.csstypeStrings.revert]
  
  @scala.inline
  def sideways: typingsSlinky.csstype.csstypeStrings.sideways = "sideways".asInstanceOf[typingsSlinky.csstype.csstypeStrings.sideways]
  
  @scala.inline
  def unset: typingsSlinky.csstype.csstypeStrings.unset = "unset".asInstanceOf[typingsSlinky.csstype.csstypeStrings.unset]
  
  @scala.inline
  def upright: typingsSlinky.csstype.csstypeStrings.upright = "upright".asInstanceOf[typingsSlinky.csstype.csstypeStrings.upright]
}
