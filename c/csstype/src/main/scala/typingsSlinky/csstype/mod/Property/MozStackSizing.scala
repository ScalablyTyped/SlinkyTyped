...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`stretch-to-fit`
...
object MozStackSizing {
  ...
  @scala.inline
  def `stretch-to-fit`: typingsSlinky.csstype.csstypeStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`stretch-to-fit`]
