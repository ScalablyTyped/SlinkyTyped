...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`scale-down`
...
*/
trait ObjectFitProperty extends js.Object
object ObjectFitProperty {
  ...
  @scala.inline
  def cover: typingsSlinky.csstype.csstypeStrings.cover = "cover".asInstanceOf[typingsSlinky.csstype.csstypeStrings.cover]
  ...
  @scala.inline
  def `scale-down`: typingsSlinky.csstype.csstypeStrings.`scale-down` = "scale-down".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`scale-down`]
