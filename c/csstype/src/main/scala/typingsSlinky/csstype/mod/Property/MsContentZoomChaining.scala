...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.chained
...
*/
trait MsContentZoomChaining extends js.Object
...
object MsContentZoomChaining {
  ...
  @scala.inline
  def chained: typingsSlinky.csstype.csstypeStrings.chained = "chained".asInstanceOf[typingsSlinky.csstype.csstypeStrings.chained]
  @scala.inline
