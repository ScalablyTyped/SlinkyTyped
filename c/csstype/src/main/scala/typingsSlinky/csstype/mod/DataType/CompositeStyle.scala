...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.clear
  - typingsSlinky.csstype.csstypeStrings.copy
  - typingsSlinky.csstype.csstypeStrings.`destination-atop`
  - typingsSlinky.csstype.csstypeStrings.`destination-in`
  - typingsSlinky.csstype.csstypeStrings.`destination-out`
  - typingsSlinky.csstype.csstypeStrings.`destination-over`
  - typingsSlinky.csstype.csstypeStrings.`source-atop`
  - typingsSlinky.csstype.csstypeStrings.`source-in`
  - typingsSlinky.csstype.csstypeStrings.`source-out`
  - typingsSlinky.csstype.csstypeStrings.`source-over`
  - typingsSlinky.csstype.csstypeStrings.xor
*/
trait CompositeStyle extends _WebkitMaskComposite
