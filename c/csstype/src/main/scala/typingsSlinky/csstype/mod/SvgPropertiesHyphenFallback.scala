...
trait SvgPropertiesHyphenFallback[TLength, TTime] extends js.Object {
  ...
  var `clip-path`: js.UndefOr[ClipPath | js.Array[js.UndefOr[ClipPath]]] = js.native
  
  var `clip-rule`: js.UndefOr[ClipRule | js.Array[js.UndefOr[ClipRule]]] = js.native
  
  var color: js.UndefOr[Color | js.Array[js.UndefOr[Color]]] = js.native
  ...
  var cursor: js.UndefOr[Cursor | js.Array[js.UndefOr[Cursor]]] = js.native
  
  var direction: js.UndefOr[Direction | js.Array[js.UndefOr[Direction]]] = js.native
  
  var display: js.UndefOr[Display | js.Array[js.UndefOr[Display]]] = js.native
  ...
  var filter: js.UndefOr[Filter | js.Array[js.UndefOr[Filter]]] = js.native
  ...
  var `font-family`: js.UndefOr[FontFamily | js.Array[js.UndefOr[FontFamily]]] = js.native
  
  var `font-size`: js.UndefOr[FontSize[TLength] | js.Array[js.UndefOr[FontSize[TLength]]]] = js.native
  
  var `font-size-adjust`: js.UndefOr[FontSizeAdjust | js.Array[js.UndefOr[FontSizeAdjust]]] = js.native
  ...
  var `image-rendering`: js.UndefOr[ImageRendering | js.Array[js.UndefOr[ImageRendering]]] = js.native
  
  var `letter-spacing`: js.UndefOr[LetterSpacing[TLength] | js.Array[js.UndefOr[LetterSpacing[TLength]]]] = js.native
  
  var `lighting-color`: js.UndefOr[LightingColor | js.Array[js.UndefOr[LightingColor]]] = js.native
  
  var `line-height`: js.UndefOr[LineHeight[TLength] | js.Array[js.UndefOr[LineHeight[TLength]]]] = js.native
  ...
  var opacity: js.UndefOr[Opacity | js.Array[js.UndefOr[Opacity]]] = js.native
  
  var overflow: js.UndefOr[Overflow | js.Array[js.UndefOr[Overflow]]] = js.native
  
  var `paint-order`: js.UndefOr[PaintOrder | js.Array[js.UndefOr[PaintOrder]]] = js.native
  
  var `pointer-events`: js.UndefOr[PointerEvents | js.Array[js.UndefOr[PointerEvents]]] = js.native
  ...
  var `text-decoration`: js.UndefOr[TextDecoration[TLength] | js.Array[js.UndefOr[TextDecoration[TLength]]]] = js.native
  
  var `text-rendering`: js.UndefOr[TextRendering | js.Array[js.UndefOr[TextRendering]]] = js.native
  
  var `unicode-bidi`: js.UndefOr[UnicodeBidi | js.Array[js.UndefOr[UnicodeBidi]]] = js.native
  
  var `vector-effect`: js.UndefOr[VectorEffect | js.Array[js.UndefOr[VectorEffect]]] = js.native
  
  var visibility: js.UndefOr[Visibility | js.Array[js.UndefOr[Visibility]]] = js.native
  
  var `white-space`: js.UndefOr[WhiteSpace | js.Array[js.UndefOr[WhiteSpace]]] = js.native
  
  var `word-spacing`: js.UndefOr[WordSpacing[TLength] | js.Array[js.UndefOr[WordSpacing[TLength]]]] = js.native
  
  var `writing-mode`: js.UndefOr[WritingMode | js.Array[js.UndefOr[WritingMode]]] = js.native
}
