...
object SvgPropertiesHyphenFallback {
  @scala.inline
  def apply[TLength](): SvgPropertiesHyphenFallback[TLength] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SvgPropertiesHyphenFallback[TLength]]
  }
  @scala.inline
  implicit class SvgPropertiesHyphenFallbackOps[Self[tlength] <: SvgPropertiesHyphenFallback[tlength], TLength] (val x: Self[TLength]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withText-rendering`(value: TextRenderingProperty | js.Array[TextRenderingProperty]): Self[TLength] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withUnicode-bidi`(value: UnicodeBidiProperty | js.Array[UnicodeBidiProperty]): Self[TLength] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withWhite-space`(value: WhiteSpaceProperty | js.Array[WhiteSpaceProperty]): Self[TLength] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withWord-spacing`(value: WordSpacingProperty[TLength] | js.Array[WordSpacingProperty[TLength]]): Self[TLength] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withWriting-mode`(value: WritingModeProperty | js.Array[WritingModeProperty]): Self[TLength] = {
        val ret = this.duplicate
