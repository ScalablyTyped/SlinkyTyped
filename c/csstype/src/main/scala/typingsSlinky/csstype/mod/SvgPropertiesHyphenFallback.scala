...
object SvgPropertiesHyphenFallback {
  ...
  @scala.inline
  implicit class SvgPropertiesHyphenFallbackOps[Self <: SvgPropertiesHyphenFallback[_], TLength] (val x: Self with SvgPropertiesHyphenFallback[TLength]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOpacityVarargs(value: GlobalsNumber*): Self = this.set("opacity", js.Array(value :_*))
    @scala.inline
    def setOpacity(value: GlobalsNumber | js.Array[GlobalsNumber]): Self = this.set("opacity", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `setText-decorationVarargs`(value: TextDecorationProperty*): Self = this.set("text-decoration", js.Array(value :_*))
    @scala.inline
