...
@js.native
trait SvgPropertiesHyphenFallback[TLength] extends StObject {
...
object SvgPropertiesHyphenFallback {
  ...
  @scala.inline
  implicit class SvgPropertiesHyphenFallbackMutableBuilder[Self <: SvgPropertiesHyphenFallback[_], TLength] (val x: Self with SvgPropertiesHyphenFallback[TLength]) extends AnyVal {
