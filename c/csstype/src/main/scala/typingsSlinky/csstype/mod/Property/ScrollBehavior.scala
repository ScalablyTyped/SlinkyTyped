...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.smooth
...
object ScrollBehavior {
  ...
  @scala.inline
  def smooth: typingsSlinky.csstype.csstypeStrings.smooth = "smooth".asInstanceOf[typingsSlinky.csstype.csstypeStrings.smooth]
  @scala.inline
