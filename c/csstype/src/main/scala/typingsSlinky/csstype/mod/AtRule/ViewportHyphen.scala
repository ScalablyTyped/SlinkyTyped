...
trait ViewportHyphen[TLength, TTime] extends js.Object {
  var `-ms-height`: js.UndefOr[Height[TLength]] = js.undefined
  var `-ms-max-height`: js.UndefOr[MaxHeight[TLength]] = js.undefined
  var `-ms-max-width`: js.UndefOr[MaxWidth[TLength]] = js.undefined
  var `-ms-max-zoom`: js.UndefOr[MaxZoom] = js.undefined
  var `-ms-min-height`: js.UndefOr[MinHeight[TLength]] = js.undefined
  var `-ms-min-width`: js.UndefOr[MinWidth[TLength]] = js.undefined
  var `-ms-min-zoom`: js.UndefOr[MinZoom] = js.undefined
  var `-ms-orientation`: js.UndefOr[Orientation] = js.undefined
  var `-ms-user-zoom`: js.UndefOr[UserZoom] = js.undefined
  var `-ms-width`: js.UndefOr[Width[TLength]] = js.undefined
  var `-ms-zoom`: js.UndefOr[Zoom] = js.undefined
  var `-o-orientation`: js.UndefOr[Orientation] = js.undefined
