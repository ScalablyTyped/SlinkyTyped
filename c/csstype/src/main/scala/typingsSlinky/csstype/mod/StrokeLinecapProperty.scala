...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.butt
  - typingsSlinky.csstype.csstypeStrings.round
  - typingsSlinky.csstype.csstypeStrings.square
...
*/
trait StrokeLinecapProperty extends js.Object
...
object StrokeLinecapProperty {
  ...
  @scala.inline
  def butt: typingsSlinky.csstype.csstypeStrings.butt = "butt".asInstanceOf[typingsSlinky.csstype.csstypeStrings.butt]
  @scala.inline
  ...
  @scala.inline
  def square: typingsSlinky.csstype.csstypeStrings.square = "square".asInstanceOf[typingsSlinky.csstype.csstypeStrings.square]
  @scala.inline
