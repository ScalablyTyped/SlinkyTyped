...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`color-burn`
  - typingsSlinky.csstype.csstypeStrings.`color-dodge`
  - typingsSlinky.csstype.csstypeStrings.darken
  - typingsSlinky.csstype.csstypeStrings.difference
  - typingsSlinky.csstype.csstypeStrings.exclusion
  - typingsSlinky.csstype.csstypeStrings.`hard-light`
  - typingsSlinky.csstype.csstypeStrings.hue
  - typingsSlinky.csstype.csstypeStrings.lighten
  - typingsSlinky.csstype.csstypeStrings.luminosity
  - typingsSlinky.csstype.csstypeStrings.multiply
  - typingsSlinky.csstype.csstypeStrings.normal
  - typingsSlinky.csstype.csstypeStrings.overlay
  - typingsSlinky.csstype.csstypeStrings.saturation
