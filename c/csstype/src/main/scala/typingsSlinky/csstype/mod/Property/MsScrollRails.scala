...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.railed
...
*/
trait MsScrollRails extends js.Object
object MsScrollRails {
  ...
  @scala.inline
  def railed: typingsSlinky.csstype.csstypeStrings.railed = "railed".asInstanceOf[typingsSlinky.csstype.csstypeStrings.railed]
