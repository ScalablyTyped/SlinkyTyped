...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.maximum
...
object MsWrapFlow {
  ...
  @scala.inline
  def maximum: typingsSlinky.csstype.csstypeStrings.maximum = "maximum".asInstanceOf[typingsSlinky.csstype.csstypeStrings.maximum]
  @scala.inline
