...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.economy
  - typingsSlinky.csstype.csstypeStrings.exact
...
object ColorAdjustProperty {
  ...
  @scala.inline
  def economy: typingsSlinky.csstype.csstypeStrings.economy = "economy".asInstanceOf[typingsSlinky.csstype.csstypeStrings.economy]
  
  @scala.inline
  def exact: typingsSlinky.csstype.csstypeStrings.exact = "exact".asInstanceOf[typingsSlinky.csstype.csstypeStrings.exact]
