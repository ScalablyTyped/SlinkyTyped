...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.clone
  - typingsSlinky.csstype.csstypeStrings.slice
...
*/
trait BoxDecorationBreak extends js.Object
...
object BoxDecorationBreak {
  ...
  @scala.inline
  def slice: typingsSlinky.csstype.csstypeStrings.slice = "slice".asInstanceOf[typingsSlinky.csstype.csstypeStrings.slice]
  @scala.inline
