...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.single
...
object BoxLinesProperty {
  ...
  @scala.inline
  def multiple: typingsSlinky.csstype.csstypeStrings.multiple = "multiple".asInstanceOf[typingsSlinky.csstype.csstypeStrings.multiple]
  @scala.inline
  def revert: typingsSlinky.csstype.csstypeStrings.revert = "revert".asInstanceOf[typingsSlinky.csstype.csstypeStrings.revert]
  @scala.inline
  def single: typingsSlinky.csstype.csstypeStrings.single = "single".asInstanceOf[typingsSlinky.csstype.csstypeStrings.single]
  @scala.inline
