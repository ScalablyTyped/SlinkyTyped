...
import typingsSlinky.csstype.csstypeStrings.scrollbar_
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`-ms-autohiding-scrollbar`
  - typingsSlinky.csstype.csstypeStrings.auto
  - typingsSlinky.csstype.csstypeStrings.none
  - typingsSlinky.csstype.csstypeStrings.scrollbar_
...
*/
trait MsOverflowStyle extends js.Object
...
object MsOverflowStyle {
  ...
  @scala.inline
  def `-ms-autohiding-scrollbar`: typingsSlinky.csstype.csstypeStrings.`-ms-autohiding-scrollbar` = "-ms-autohiding-scrollbar".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`-ms-autohiding-scrollbar`]
  @scala.inline
