...
object TextRenderingProperty {
  ...
  @scala.inline
  def geometricPrecision: typingsSlinky.csstype.csstypeStrings.geometricPrecision = this.cast("geometricPrecision")
  @scala.inline
  ...
  @scala.inline
  def optimizeLegibility: typingsSlinky.csstype.csstypeStrings.optimizeLegibility = this.cast("optimizeLegibility")
  @scala.inline
