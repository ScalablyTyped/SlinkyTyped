...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.evenodd
  - typingsSlinky.csstype.csstypeStrings.nonzero
...
*/
trait FillRuleProperty extends js.Object
object FillRuleProperty {
  ...
  @scala.inline
  def evenodd: typingsSlinky.csstype.csstypeStrings.evenodd = "evenodd".asInstanceOf[typingsSlinky.csstype.csstypeStrings.evenodd]
  ...
  @scala.inline
  def nonzero: typingsSlinky.csstype.csstypeStrings.nonzero = "nonzero".asInstanceOf[typingsSlinky.csstype.csstypeStrings.nonzero]
