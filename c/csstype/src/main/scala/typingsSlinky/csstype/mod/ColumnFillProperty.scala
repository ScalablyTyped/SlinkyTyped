...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.balance
  - typingsSlinky.csstype.csstypeStrings.`balance-all`
...
object ColumnFillProperty {
  ...
  @scala.inline
  def balance: typingsSlinky.csstype.csstypeStrings.balance = "balance".asInstanceOf[typingsSlinky.csstype.csstypeStrings.balance]
  @scala.inline
  def `balance-all`: typingsSlinky.csstype.csstypeStrings.`balance-all` = "balance-all".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`balance-all`]
  @scala.inline
