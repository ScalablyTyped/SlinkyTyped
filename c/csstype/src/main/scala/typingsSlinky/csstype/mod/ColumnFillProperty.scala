...
object ColumnFillProperty {
  ...
  @scala.inline
  def balance: typingsSlinky.csstype.csstypeStrings.balance = this.cast("balance")
  @scala.inline
  def `balance-all`: typingsSlinky.csstype.csstypeStrings.`balance-all` = this.cast("balance-all")
  @scala.inline
