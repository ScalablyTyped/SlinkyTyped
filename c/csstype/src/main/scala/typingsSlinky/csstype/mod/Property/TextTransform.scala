...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.capitalize
  - typingsSlinky.csstype.csstypeStrings.`full-size-kana`
  - typingsSlinky.csstype.csstypeStrings.`full-width`
  - typingsSlinky.csstype.csstypeStrings.lowercase
  - typingsSlinky.csstype.csstypeStrings.none
  - typingsSlinky.csstype.csstypeStrings.uppercase
