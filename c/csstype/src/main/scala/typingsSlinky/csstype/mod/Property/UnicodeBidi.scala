...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`-moz-isolate`
  - typingsSlinky.csstype.csstypeStrings.`-moz-isolate-override`
  - typingsSlinky.csstype.csstypeStrings.`-moz-plaintext`
  - typingsSlinky.csstype.csstypeStrings.`-webkit-isolate`
  - typingsSlinky.csstype.csstypeStrings.`bidi-override`
  - typingsSlinky.csstype.csstypeStrings.embed
  - typingsSlinky.csstype.csstypeStrings.isolate
  - typingsSlinky.csstype.csstypeStrings.`isolate-override`
  - typingsSlinky.csstype.csstypeStrings.normal
  - typingsSlinky.csstype.csstypeStrings.plaintext
...
*/
trait UnicodeBidi extends js.Object
object UnicodeBidi {
