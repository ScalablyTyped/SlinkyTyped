...
object StandardLonghandPropertiesHyphenFallback {
  ...
  implicit class StandardLonghandPropertiesHyphenFallbackOps[Self <: StandardLonghandPropertiesHyphenFallback[_], TLength] (val x: Self with StandardLonghandPropertiesHyphenFallback[TLength]) extends AnyVal {
    ...
    @scala.inline
    def `setOffset-positionVarargs`(value: OffsetPositionProperty[TLength]*): Self = this.set("offset-position", js.Array(value :_*))
    @scala.inline
    def `setOffset-position`(value: OffsetPositionProperty[TLength] | js.Array[OffsetPositionProperty[TLength]]): Self = this.set("offset-position", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `setShape-image-thresholdVarargs`(value: GlobalsNumber*): Self = this.set("shape-image-threshold", js.Array(value :_*))
    @scala.inline
    def `setShape-image-threshold`(value: GlobalsNumber | js.Array[GlobalsNumber]): Self = this.set("shape-image-threshold", value.asInstanceOf[js.Any])
    @scala.inline
