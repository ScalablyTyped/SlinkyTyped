...
object ObsoletePropertiesFallback {
  ...
  @scala.inline
  implicit class ObsoletePropertiesFallbackMutableBuilder[Self <: ObsoletePropertiesFallback[_], TLength] (val x: Self with ObsoletePropertiesFallback[TLength]) extends AnyVal {
