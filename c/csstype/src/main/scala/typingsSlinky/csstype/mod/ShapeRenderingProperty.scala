...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.crispEdges
...
object ShapeRenderingProperty {
  ...
  @scala.inline
  def crispEdges: typingsSlinky.csstype.csstypeStrings.crispEdges = "crispEdges".asInstanceOf[typingsSlinky.csstype.csstypeStrings.crispEdges]
  @scala.inline
