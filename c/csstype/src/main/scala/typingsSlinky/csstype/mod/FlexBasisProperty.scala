...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.csstype.csstypeStrings.`-webkit-auto`
  ...
  - java.lang.String
*/
trait FlexBasisProperty[TLength] extends js.Object

object FlexBasisProperty {
  @scala.inline
  ...
  @scala.inline
  def `-webkit-auto`[TLength]: typingsSlinky.csstype.csstypeStrings.`-webkit-auto` = "-webkit-auto".asInstanceOf[typingsSlinky.csstype.csstypeStrings.`-webkit-auto`]
  @scala.inline
  ...
  @scala.inline
  implicit def apply[TLength](value: Globals): FlexBasisProperty[TLength] = value.asInstanceOf[FlexBasisProperty[TLength]]
  @scala.inline
  implicit def apply[TLength](value: String): FlexBasisProperty[TLength] = value.asInstanceOf[FlexBasisProperty[TLength]]
  @scala.inline
  implicit def apply[TLength](value: TLength): FlexBasisProperty[TLength] = value.asInstanceOf[FlexBasisProperty[TLength]]
}
