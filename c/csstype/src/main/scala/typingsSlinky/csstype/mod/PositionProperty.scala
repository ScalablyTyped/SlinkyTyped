...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.csstype.csstypeStrings.`-webkit-sticky`
  - typingsSlinky.csstype.csstypeStrings.absolute
  - typingsSlinky.csstype.csstypeStrings.fixed
  - typingsSlinky.csstype.csstypeStrings.relative
  - typingsSlinky.csstype.csstypeStrings.static
  - typingsSlinky.csstype.csstypeStrings.sticky
