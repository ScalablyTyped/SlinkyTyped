...
trait ViewportHyphenFallback[TLength, TTime] extends js.Object {
  var `-ms-height`: js.UndefOr[Height[TLength] | js.Array[js.UndefOr[Height[TLength]]]] = js.undefined
  var `-ms-max-height`: js.UndefOr[MaxHeight[TLength] | js.Array[js.UndefOr[MaxHeight[TLength]]]] = js.undefined
  var `-ms-max-width`: js.UndefOr[MaxWidth[TLength] | js.Array[js.UndefOr[MaxWidth[TLength]]]] = js.undefined
  var `-ms-max-zoom`: js.UndefOr[MaxZoom | js.Array[js.UndefOr[MaxZoom]]] = js.undefined
  var `-ms-min-height`: js.UndefOr[MinHeight[TLength] | js.Array[js.UndefOr[MinHeight[TLength]]]] = js.undefined
  var `-ms-min-width`: js.UndefOr[MinWidth[TLength] | js.Array[js.UndefOr[MinWidth[TLength]]]] = js.undefined
  var `-ms-min-zoom`: js.UndefOr[MinZoom | js.Array[js.UndefOr[MinZoom]]] = js.undefined
  var `-ms-orientation`: js.UndefOr[Orientation | js.Array[js.UndefOr[Orientation]]] = js.undefined
  var `-ms-user-zoom`: js.UndefOr[UserZoom | js.Array[js.UndefOr[UserZoom]]] = js.undefined
  var `-ms-width`: js.UndefOr[Width[TLength] | js.Array[js.UndefOr[Width[TLength]]]] = js.undefined
  var `-ms-zoom`: js.UndefOr[Zoom | js.Array[js.UndefOr[Zoom]]] = js.undefined
  var `-o-orientation`: js.UndefOr[Orientation | js.Array[js.UndefOr[Orientation]]] = js.undefined
  var height: js.UndefOr[Height[TLength] | js.Array[js.UndefOr[Height[TLength]]]] = js.undefined
  var `max-height`: js.UndefOr[MaxHeight[TLength] | js.Array[js.UndefOr[MaxHeight[TLength]]]] = js.undefined
  var `max-width`: js.UndefOr[MaxWidth[TLength] | js.Array[js.UndefOr[MaxWidth[TLength]]]] = js.undefined
  var `max-zoom`: js.UndefOr[MaxZoom | js.Array[js.UndefOr[MaxZoom]]] = js.undefined
  var `min-height`: js.UndefOr[MinHeight[TLength] | js.Array[js.UndefOr[MinHeight[TLength]]]] = js.undefined
  var `min-width`: js.UndefOr[MinWidth[TLength] | js.Array[js.UndefOr[MinWidth[TLength]]]] = js.undefined
  var `min-zoom`: js.UndefOr[MinZoom | js.Array[js.UndefOr[MinZoom]]] = js.undefined
  var orientation: js.UndefOr[Orientation | js.Array[js.UndefOr[Orientation]]] = js.undefined
  var `user-zoom`: js.UndefOr[UserZoom | js.Array[js.UndefOr[UserZoom]]] = js.undefined
  var width: js.UndefOr[Width[TLength] | js.Array[js.UndefOr[Width[TLength]]]] = js.undefined
  var zoom: js.UndefOr[Zoom | js.Array[js.UndefOr[Zoom]]] = js.undefined
}
