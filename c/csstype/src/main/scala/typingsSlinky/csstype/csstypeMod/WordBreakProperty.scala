...
object WordBreakProperty {
  ...
  @scala.inline
  def `break-all`: typingsSlinky.csstype.csstypeStrings.`break-all` = this.cast("break-all")
  @scala.inline
  ...
  @scala.inline
  def `keep-all`: typingsSlinky.csstype.csstypeStrings.`keep-all` = this.cast("keep-all")
  @scala.inline
