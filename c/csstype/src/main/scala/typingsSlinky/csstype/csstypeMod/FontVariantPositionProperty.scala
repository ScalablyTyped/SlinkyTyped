...
*/
trait FontVariantPositionProperty extends js.Object
...
object FontVariantPositionProperty {
  ...
  @scala.inline
  def sub: typingsSlinky.csstype.csstypeStrings.sub = this.cast("sub")
  @scala.inline
  def `super`: typingsSlinky.csstype.csstypeStrings.`super` = this.cast("super")
  @scala.inline
