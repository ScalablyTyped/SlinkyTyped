...
object Combokeys extends js.Object {
  ...
  trait CombokeysStatic
    extends Instantiable1[/* element */ Element, typingsSlinky.combokeys.Combokeys.Combokeys] {
    
    /**
      * all instances of Combokeys
      */
    var instances: js.Array[typingsSlinky.combokeys.Combokeys.Combokeys] = js.native
