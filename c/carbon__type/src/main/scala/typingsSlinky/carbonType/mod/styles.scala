...
import typingsSlinky.carbonType.anon.FontFamily
import typingsSlinky.carbonType.anon.FontFamilyFontSize
import typingsSlinky.carbonType.anon.FontSizeFontWeight
import typingsSlinky.carbonType.anon.FontStyle
import typingsSlinky.carbonType.anon.FontWeightLetterSpacing
import typingsSlinky.carbonType.anon.LetterSpacingLineHeight
import typingsSlinky.carbonType.anon.Lg
import typingsSlinky.carbonType.anon.Mediaminwidth42rem
import typingsSlinky.carbonType.anon.Mediaminwidth66rem
import typingsSlinky.carbonType.anon.Mediaminwidth82rem
import typingsSlinky.carbonType.anon.Mediaminwidth99rem
