...
object AnonMediaminwidth82rem {
  ...
  @scala.inline
  implicit class AnonMediaminwidth82remOps[Self <: AnonMediaminwidth82rem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 66remRightparenthesis`(value: AnonLetterSpacing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@media (min-width: 66rem)")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 82remRightparenthesis`(value: AnonLetterSpacing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@media (min-width: 82rem)")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 99remRightparenthesis`(value: AnonLetterSpacing): Self = {
        val ret = this.duplicate
