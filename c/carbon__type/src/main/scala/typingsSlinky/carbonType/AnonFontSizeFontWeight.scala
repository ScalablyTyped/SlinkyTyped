...
trait AnonFontSizeFontWeight extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 42remRightparenthesis`: AnonFontFamily = js.native
...
object AnonFontSizeFontWeight {
  ...
  @scala.inline
  implicit class AnonFontSizeFontWeightOps[Self <: AnonFontSizeFontWeight] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 42remRightparenthesis`(value: AnonFontFamily): Self = {
