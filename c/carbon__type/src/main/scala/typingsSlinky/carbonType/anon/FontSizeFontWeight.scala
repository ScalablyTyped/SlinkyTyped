...
object FontSizeFontWeight {
  ...
  implicit class FontSizeFontWeightOps[Self <: FontSizeFontWeight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 42remRightparenthesis`(value: FontFamily): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@media (min-width: 42rem)")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 66remRightparenthesis`(value: FontFamily): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@media (min-width: 66rem)")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 82remRightparenthesis`(value: FontFamily): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("@media (min-width: 82rem)")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def `with@media Leftparenthesismin-widthColon 99remRightparenthesis`(value: FontFamily): Self = {
        val ret = this.duplicate
