...
trait Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66remMediaminwidth82remMediaminwidth99rem extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 66remRightparenthesis`: Anon_FontSizeLineHeight
...
object Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66remMediaminwidth82remMediaminwidth99rem {
  @scala.inline
  def apply(
    `@media Leftparenthesismin-widthColon 42remRightparenthesis`: Anon_FontSizeLineHeight,
    `@media Leftparenthesismin-widthColon 66remRightparenthesis`: Anon_FontSizeLineHeight,
    ...
    lineHeight: String
  ): Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66remMediaminwidth82remMediaminwidth99rem = {
    ...
    __obj.asInstanceOf[Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66remMediaminwidth82remMediaminwidth99rem]
  }
}
