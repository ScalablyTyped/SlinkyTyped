...
import typingsSlinky.chromeDashApps.chrome.runtime.SocketTcpPermission
import typingsSlinky.chromeDashApps.chrome.runtime.SocketTcpServerPermission
import typingsSlinky.chromeDashApps.chrome.runtime.SocketUdpPermission
