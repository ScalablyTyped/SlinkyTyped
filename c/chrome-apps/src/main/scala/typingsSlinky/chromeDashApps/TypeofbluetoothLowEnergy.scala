...
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.Advertisement
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.Characteristic
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.Descriptor
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.INotification
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.IProperties
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.IResponse
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.Service
