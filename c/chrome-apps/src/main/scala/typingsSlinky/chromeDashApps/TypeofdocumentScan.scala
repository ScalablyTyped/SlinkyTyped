...
import typingsSlinky.chromeDashApps.chrome.documentScan.DocumentScanCallbackArg
import typingsSlinky.chromeDashApps.chrome.documentScan.DocumentScanOptions
