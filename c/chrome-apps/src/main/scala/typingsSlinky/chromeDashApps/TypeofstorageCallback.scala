...
import typingsSlinky.chromeDashApps.chrome.system.storage.StorageCapacityInfo
import typingsSlinky.chromeDashApps.chrome.system.storage.StorageUnitInfo
