...
import typingsSlinky.chromeDashApps.chrome.networking.config.NetworkInfo
import typingsSlinky.chromeDashApps.chrome.networking.config.NetworkInfoFilterHexSSID
import typingsSlinky.chromeDashApps.chrome.networking.config.NetworkInfoFilterSSID
