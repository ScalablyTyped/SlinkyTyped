...
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.CreateInfo
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.ListenOptions
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnAcceptErrorEvent
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnAcceptEvent
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnReceiveErrorEvent
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnReceiveEvent
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.SocketInfo
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.SocketProperties
