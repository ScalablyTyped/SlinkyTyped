...
import typingsSlinky.chromeDashApps.chrome.storage.LocalStorageArea
import typingsSlinky.chromeDashApps.chrome.storage.ManagedStorageArea
import typingsSlinky.chromeDashApps.chrome.storage.StorageAreas
import typingsSlinky.chromeDashApps.chrome.storage.StorageChange
import typingsSlinky.chromeDashApps.chrome.storage.SyncStorageArea
