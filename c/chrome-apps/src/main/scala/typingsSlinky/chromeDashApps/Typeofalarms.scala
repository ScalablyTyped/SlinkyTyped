...
import typingsSlinky.chromeDashApps.chrome.alarms.Alarm
import typingsSlinky.chromeDashApps.chrome.alarms.AlarmCreateInfo
import typingsSlinky.chromeDashApps.chrome.alarms.AlarmEvent
