...
import typingsSlinky.chromeDashApps.Anon_AUDIO
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.screen
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.tab
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.window
  ...
  def chooseDesktopMedia(
    sources: js.Array[
      ToStringLiteral[
        ...
        Exclude[
          String, 
          screen | window | tab | typingsSlinky.chromeDashApps.chromeDashAppsStrings.audio
        ]
      ]
    ],
