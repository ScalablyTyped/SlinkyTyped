package typingsSlinky.chromeDashApps.chrome.signedInDevices
...
object onDeviceInfoChange
  extends TopLevel[
      typingsSlinky.chromeDashApps.chrome.events.Event[js.Function1[/* devices */ js.Array[DeviceInfo], Unit]]
    ]
