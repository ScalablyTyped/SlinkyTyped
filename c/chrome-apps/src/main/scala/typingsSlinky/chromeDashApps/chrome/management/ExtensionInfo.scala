...
import typingsSlinky.chromeDashApps.Anon_ADMIN
import typingsSlinky.chromeDashApps.Anon_OPENASPINNEDTAB
...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.OPEN_FULL_SCREEN
