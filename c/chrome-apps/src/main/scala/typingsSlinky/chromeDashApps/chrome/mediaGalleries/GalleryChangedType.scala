...
object GalleryChangedType {
  ...
  @scala.inline
  def contents_changed: typingsSlinky.chromeDashApps.chromeDashAppsStrings.contents_changed = this.cast("contents_changed")
  @scala.inline
  def watch_dropped: typingsSlinky.chromeDashApps.chromeDashAppsStrings.watch_dropped = this.cast("watch_dropped")
}
