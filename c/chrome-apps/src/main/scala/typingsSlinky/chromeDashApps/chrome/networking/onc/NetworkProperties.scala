...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.Device
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.DevicePolicy
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.None
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.User
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.UserPolicy
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.getter
...
trait NetworkProperties[M /* <: ManagedObject */, IF /* <: InterfaceType */] extends NetworkConfigBase[M, IF, getter] {
  ...
  var ProxySettings: js.UndefOr[
    typingsSlinky.chromeDashApps.chrome.networking.onc.ProxySettings[unmanaged, String | ManagedDOMString, js.Array[String] | ManagedDOMStringList]
  ] = js.undefined
  /**
