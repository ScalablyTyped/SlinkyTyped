...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings._empty
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.`sim-pin`
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.`sim-puk`
