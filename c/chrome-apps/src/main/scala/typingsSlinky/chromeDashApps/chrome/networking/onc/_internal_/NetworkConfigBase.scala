package typingsSlinky.chromeDashApps.chrome.networking.onc._internal_

import typingsSlinky.chromeDashApps.Anon_Authentication
import typingsSlinky.chromeDashApps.Anon_SignalStrength
import typingsSlinky.chromeDashApps.Anon_Type
import typingsSlinky.chromeDashApps.chrome.integer
import typingsSlinky.chromeDashApps.chrome.networking.onc.CellularBase
import typingsSlinky.chromeDashApps.chrome.networking.onc.CellularProperties
import typingsSlinky.chromeDashApps.chrome.networking.onc.EthernetProperties
import typingsSlinky.chromeDashApps.chrome.networking.onc.IPConfigType
import typingsSlinky.chromeDashApps.chrome.networking.onc.InterfaceType
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedBoolean
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedDOMString
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedIPConfigType
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedLong
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedObject
import typingsSlinky.chromeDashApps.chrome.networking.onc.NetworkType
import typingsSlinky.chromeDashApps.chrome.networking.onc.VPNProperties
import typingsSlinky.chromeDashApps.chrome.networking.onc.WiFiProperties
import typingsSlinky.chromeDashApps.chrome.networking.onc.WiFiPropertiesBase
import typingsSlinky.chromeDashApps.chrome.networking.onc.WiMAXProperties
