...
object IPConfigType {
  @scala.inline
  def DHCP: typingsSlinky.chromeDashApps.chromeDashAppsStrings.DHCP = this.cast("DHCP")
  @scala.inline
  def Static: typingsSlinky.chromeDashApps.chromeDashAppsStrings.Static = this.cast("Static")
  @scala.inline
