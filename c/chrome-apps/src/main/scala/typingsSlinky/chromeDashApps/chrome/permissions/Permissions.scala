package typingsSlinky.chromeDashApps.chrome.permissions

import typingsSlinky.chromeDashApps.chrome.runtime.OptionalPermission
import typingsSlinky.chromeDashApps.chrome.runtime.UrlMatches
