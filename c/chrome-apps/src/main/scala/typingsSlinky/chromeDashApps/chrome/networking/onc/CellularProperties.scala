...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.CDMA
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.GSM
...
trait CellularProperties[M /* <: ManagedObject */] extends CellularBase {
  ...
  var PaymentPortal: js.UndefOr[
    typingsSlinky.chromeDashApps.chrome.networking.onc.PaymentPortal | PaymentPortalPost
  ] = js.undefined
