...
object JSONBasicTypes {
  ...
  @scala.inline
  def integer: typingsSlinky.chromeDashApps.chromeDashAppsStrings.integer = this.cast("integer")
  @scala.inline
  def number: typingsSlinky.chromeDashApps.chromeDashAppsStrings.number = this.cast("number")
  @scala.inline
  def string: typingsSlinky.chromeDashApps.chromeDashAppsStrings.string = this.cast("string")
}
