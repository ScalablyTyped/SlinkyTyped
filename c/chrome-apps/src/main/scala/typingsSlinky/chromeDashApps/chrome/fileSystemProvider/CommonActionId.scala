...
object CommonActionId extends js.Object {
  var OFFLINE_NOT_NECESSARY: typingsSlinky.chromeDashApps.chromeDashAppsStrings.OFFLINE_NOT_NECESSARY = js.native
  var SAVE_FOR_OFFLINE: typingsSlinky.chromeDashApps.chromeDashAppsStrings.SAVE_FOR_OFFLINE = js.native
  var SHARE: typingsSlinky.chromeDashApps.chromeDashAppsStrings.SHARE = js.native
}
