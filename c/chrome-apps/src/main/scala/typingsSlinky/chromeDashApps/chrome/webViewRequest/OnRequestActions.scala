...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.chromeDashApps.chrome.webViewRequest.CancelRequest
  ...
  - typings.chromeDashApps.chrome.webViewRequest.RedirectToTransparentImage
  - typings.chromeDashApps.chrome.webViewRequest.RedirectToEmptyDocument
