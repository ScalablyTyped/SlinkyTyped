...
import typingsSlinky.chromeDashApps.Anon_WIFI
...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.`WEP-PSK`
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.`WPA-EAP`
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.`WPA-PSK`
