...
trait Port extends js.Object {
  ...
  var onDisconnect: typingsSlinky.chromeDashApps.chrome.events.Event[js.Function1[/* port */ this.type, Unit]]
  /** An object which allows the addition and removal of listeners for a Chrome event. */
  var onMessage: typingsSlinky.chromeDashApps.chrome.events.Event[js.Function2[/* message */ _, /* port */ this.type, Unit]]
  /**
    * Optional.
...
object Port {
  ...
  def apply(
    disconnect: () => Unit,
    name: String,
    onDisconnect: typingsSlinky.chromeDashApps.chrome.events.Event[js.Function1[Port, Unit]],
    onMessage: typingsSlinky.chromeDashApps.chrome.events.Event[js.Function2[/* message */ _, Port, Unit]],
