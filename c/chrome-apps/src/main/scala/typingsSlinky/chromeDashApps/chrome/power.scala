...
import typingsSlinky.chromeDashApps.Anon_DISPLAY
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.display
...
object power extends js.Object {
  ...
  def requestKeepAwake(
    level: ToStringLiteral[
      Anon_DISPLAY, 
      String, 
      Exclude[String, typingsSlinky.chromeDashApps.chromeDashAppsStrings.system | display]
    ]
  ): Unit = js.native
  /**
    * @enum
  ...
  object Level extends js.Object {
    ...
    var SYSTEM: typingsSlinky.chromeDashApps.chromeDashAppsStrings.system = js.native
  }
