...
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.GalleryChangedEventArgs
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.GalleryWatchResult
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.MediaFileSystemMetadata
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.MediaFileSystemsOptions
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.Metadata
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.MetadataOptions
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.ScanProgressEventArgs
