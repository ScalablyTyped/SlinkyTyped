...
import typingsSlinky.chromeDashApps.chrome.fileSystem.ChooseDirectoryEntryOptions
import typingsSlinky.chromeDashApps.chrome.fileSystem.ChooseEntryOptionsBase
import typingsSlinky.chromeDashApps.chrome.fileSystem.ChooseFileEntryOptions
import typingsSlinky.chromeDashApps.chrome.fileSystem.ChooseMultipleFilesEntryOptions
import typingsSlinky.chromeDashApps.chrome.fileSystem.ChooseSaveFileEntryOptions
import typingsSlinky.chromeDashApps.chrome.fileSystem.FileEntryCallback
import typingsSlinky.chromeDashApps.chrome.fileSystem.Volume
