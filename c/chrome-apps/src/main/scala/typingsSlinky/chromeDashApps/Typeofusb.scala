...
import typingsSlinky.chromeDashApps.chrome.usb.ConfigDescriptor
import typingsSlinky.chromeDashApps.chrome.usb.ConnectionHandle
import typingsSlinky.chromeDashApps.chrome.usb.Device
import typingsSlinky.chromeDashApps.chrome.usb.DeviceEvent
import typingsSlinky.chromeDashApps.chrome.usb.GenericTransferInfo
import typingsSlinky.chromeDashApps.chrome.usb.InterfaceDescriptor
import typingsSlinky.chromeDashApps.chrome.usb.IsochronousTransferInfo
import typingsSlinky.chromeDashApps.chrome.usb.TransferInfo
import typingsSlinky.chromeDashApps.chrome.usb.TransferResultInfo
