...
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.basic
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.image
import typingsSlinky.chromeDashApps.chromeDashAppsStrings.list
...
object Anon_BASIC {
  @scala.inline
  def apply(BASIC: basic, IMAGE: image, LIST: list, PROGRESS: progress): Anon_BASIC = {
