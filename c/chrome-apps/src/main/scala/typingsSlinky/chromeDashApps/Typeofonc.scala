...
import typingsSlinky.chromeDashApps.chrome.networking.onc.CaptivePortalStatus
import typingsSlinky.chromeDashApps.chrome.networking.onc.DeviceStates
import typingsSlinky.chromeDashApps.chrome.networking.onc.Filter
import typingsSlinky.chromeDashApps.chrome.networking.onc.GlobalPolicy
import typingsSlinky.chromeDashApps.chrome.networking.onc.ManagedProperties
import typingsSlinky.chromeDashApps.chrome.networking.onc.NetworkConfigProperties
