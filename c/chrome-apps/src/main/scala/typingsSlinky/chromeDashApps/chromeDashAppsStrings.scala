...
import typingsSlinky.chromeDashApps.WebView.ContextType
import typingsSlinky.chromeDashApps.WebView.Events.DialogMessageType
import typingsSlinky.chromeDashApps.WebView.Events.ExitEventReason
import typingsSlinky.chromeDashApps.WebView.Events.LoadAbortReason
import typingsSlinky.chromeDashApps.WebView.Events.RequestedPermission
import typingsSlinky.chromeDashApps.WebView.Events.WindowOpenDisposition
import typingsSlinky.chromeDashApps.WebView.ZoomMode
import typingsSlinky.chromeDashApps.chrome.accessibilityFeatures.LevelOfControl
import typingsSlinky.chromeDashApps.chrome.accessibilityFeatures.Scope
import typingsSlinky.chromeDashApps.chrome.audio.DeviceType
import typingsSlinky.chromeDashApps.chrome.audio.StreamType
import typingsSlinky.chromeDashApps.chrome.bluetooth.DeviceFilterType
import typingsSlinky.chromeDashApps.chrome.bluetooth.DeviceVendorIdSource
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.AdvertisementType
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.CharacteristicProperties
import typingsSlinky.chromeDashApps.chrome.bluetoothLowEnergy.DescriptorPermissions
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnAcceptErrorCode
import typingsSlinky.chromeDashApps.chrome.bluetoothSocket.OnReceiveErrorCode
import typingsSlinky.chromeDashApps.chrome.certificateProvider.Hash
import typingsSlinky.chromeDashApps.chrome.clipboard.ImageType
import typingsSlinky.chromeDashApps.chrome.contextMenus.MediaType
...
import typingsSlinky.chromeDashApps.chrome.gcm.DisallowedKeys
import typingsSlinky.chromeDashApps.chrome.i18n.LanguageCode
import typingsSlinky.chromeDashApps.chrome.i18n.kLanguageInfoTable
import typingsSlinky.chromeDashApps.chrome.idle.IdleState
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.GalleryChangedType
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.Interactive
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.MetadataOptionsType
import typingsSlinky.chromeDashApps.chrome.mediaGalleries.ScanProgressType
import typingsSlinky.chromeDashApps.chrome.networking.onc.ActivationStateType
import typingsSlinky.chromeDashApps.chrome.networking.onc.CaptivePortalStatus
import typingsSlinky.chromeDashApps.chrome.networking.onc.ClientCertType
import typingsSlinky.chromeDashApps.chrome.networking.onc.ConnectionStateType
import typingsSlinky.chromeDashApps.chrome.networking.onc.DeviceState
import typingsSlinky.chromeDashApps.chrome.networking.onc.EthernetAuthenticationType
import typingsSlinky.chromeDashApps.chrome.networking.onc.IPConfigType
import typingsSlinky.chromeDashApps.chrome.networking.onc.IPConfigurationType
...
import typingsSlinky.chromeDashApps.chrome.networking.onc.ProxySettingsType
import typingsSlinky.chromeDashApps.chrome.networking.onc._internal_.ObjectFunction
import typingsSlinky.chromeDashApps.chrome.runtime.ChromeOSOnlyPermissions
import typingsSlinky.chromeDashApps.chrome.runtime.DevOnly
import typingsSlinky.chromeDashApps.chrome.runtime.JSONBasicTypes
import typingsSlinky.chromeDashApps.chrome.runtime.KioskOnlyPermissions
import typingsSlinky.chromeDashApps.chrome.runtime.NotAllowedAsOptionalPermissions
import typingsSlinky.chromeDashApps.chrome.runtime.Permission
import typingsSlinky.chromeDashApps.chrome.runtime.UndocumentedPermissions
import typingsSlinky.chromeDashApps.chrome.runtime.UrlMatches
import typingsSlinky.chromeDashApps.chrome.signedInDevices.OS
import typingsSlinky.chromeDashApps.chrome.storage.StorageAreas
import typingsSlinky.chromeDashApps.chrome.types.ChromeSettingScope
import typingsSlinky.chromeDashApps.chrome.wallpaper.WallpaperLayoutType
import typingsSlinky.chromeDashApps.chrome.webRequest.ResourceType
import typingsSlinky.chromeDashApps.chrome.webViewRequest.DeclarativeWebRequestActionsList
import typingsSlinky.chromeDashApps.chrome.webViewRequest.DeclarativeWebRequestEventList
import typingsSlinky.chromeDashApps.chrome.webViewRequest.Stage
...
object chromeDashAppsStrings {
  ...
  sealed trait audio
    extends KioskOnlyPermissions
       with ContextType
       with typingsSlinky.chromeDashApps.chrome.bluetooth.DeviceType
       with MediaType
  ...
  sealed trait carAudio
    extends typingsSlinky.chromeDashApps.chrome.bluetooth.DeviceType
  ...
  sealed trait controllable_by_this_extension
    extends LevelOfControl
       with typingsSlinky.chromeDashApps.chrome.types.LevelOfControl
  ...
  sealed trait desktop_or_laptop
    extends typingsSlinky.chromeDashApps.chrome.signedInDevices.DeviceType
  ...
  sealed trait phone
    extends typingsSlinky.chromeDashApps.chrome.bluetooth.DeviceType
       with typingsSlinky.chromeDashApps.chrome.signedInDevices.DeviceType
