...
import typingsSlinky.chromeApps.anon.DENIED
import typingsSlinky.chromeApps.anon.PartialNotificationOption
import typingsSlinky.chromeApps.chrome.ToStringLiteral
import typingsSlinky.chromeApps.chrome.integer
import typingsSlinky.chromeApps.chrome.notifications.NotificationOptions
...
object notifications extends js.Object {
  ...
  def getPermissionLevel(
    callback: js.Function1[
      /* level */ ToStringLiteral[
        DENIED, 
        /* keyof chrome-apps.anon.DENIED */ GRANTED | typingsSlinky.chromeApps.chromeAppsStrings.DENIED, 
        Exclude[
          /* keyof chrome-apps.anon.DENIED */ GRANTED | typingsSlinky.chromeApps.chromeAppsStrings.DENIED, 
          granted_ | denied_
        ]
  ...
  val onButtonClicked: typingsSlinky.chromeApps.chrome.events.Event[js.Function2[/* notificationId */ String, /* buttonIndex */ integer, Unit]] = js.native
  
  /** The user clicked in a non-button area of the notification. */
  val onClicked: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* notificationId */ String, Unit]] = js.native
  
  /** The notification closed, either by the system or by user action. */
  val onClosed: typingsSlinky.chromeApps.chrome.events.Event[js.Function2[/* notificationId */ String, /* byUser */ Boolean, Unit]] = js.native
  
  /**
    * The user changes the permission level.
    * @since Chrome 32.
    */
  val onPermissionLevelChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* level */ String, Unit]] = js.native
  ...
  /**
    ...
    */
  val onShowSettings: typingsSlinky.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
