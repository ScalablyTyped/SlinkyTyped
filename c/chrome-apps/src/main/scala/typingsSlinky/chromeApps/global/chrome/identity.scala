...
import typingsSlinky.chromeApps.chrome.identity.AccountInfo
import typingsSlinky.chromeApps.chrome.identity.TokenDetails
...
object identity {
  ...
  @js.native
  val onSignInChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function2[/* account */ AccountInfo, /* signedIn */ Boolean, Unit]] = js.native
