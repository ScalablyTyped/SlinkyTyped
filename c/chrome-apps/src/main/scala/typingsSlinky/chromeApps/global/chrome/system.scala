...
import typingsSlinky.chromeApps.anon.FAILURE
...
object system extends js.Object {
  ...
  object display extends js.Object {
    ...
    /**
      ...
      */
    val onDisplayChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
  ...
  object powerSource extends js.Object {
    ...
    /**
      ...
      */
    val onPowerChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* powerSourceInfo */ js.Array[PowerSourceInfo], Unit]] = js.native
    ...
    object PowerSourceType extends js.Object {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsSlinky.chromeApps.chrome.system.powerSource.PowerSourceType with String] = js.native
      
      /* "mains" */ val mains: typingsSlinky.chromeApps.chrome.system.powerSource.PowerSourceType.mains with String = js.native
      
      /* "unknown" */ val unknown: typingsSlinky.chromeApps.chrome.system.powerSource.PowerSourceType.unknown with String = js.native
      
      /* "usb" */ val usb: typingsSlinky.chromeApps.chrome.system.powerSource.PowerSourceType.usb with String = js.native
    }
  }
  ...
  object storage extends js.Object {
    ...
    def ejectDevice(
      ...
      callback: js.Function1[
          /* result */ ToStringLiteral[
            FAILURE, 
            /* keyof chrome-apps.anon.FAILURE */ SUCCESS | IN_USE | NO_SUCH_DEVICE | typingsSlinky.chromeApps.chromeAppsStrings.FAILURE, 
            Exclude[
              /* keyof chrome-apps.anon.FAILURE */ SUCCESS | IN_USE | NO_SUCH_DEVICE | typingsSlinky.chromeApps.chromeAppsStrings.FAILURE, 
    ...
    val onAttached: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* info */ StorageUnitInfo, Unit]] = js.native
    
    /** Fired when a removable storage is detached from the system. */
    val onDetached: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* id */ String, Unit]] = js.native
