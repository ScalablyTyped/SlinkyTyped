...
object app {
  ...
  object runtime {
    ...
    @js.native
    val onEmbedRequested: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* request */ EmbedRequest, Unit]] = js.native
    ...
    @js.native
    val onLaunched: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* launchData */ LaunchData, Unit]] = js.native
    ...
    @js.native
    val onRestarted: typingsSlinky.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
  }
