...
object mediaGalleries extends js.Object {
  /**
    ...
    * @since Chrome 38.
    */
  val onGalleryChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* args */ GalleryChangedEventArgs, Unit]] = js.native
  /**
    ...
    */
  val onScanProgress: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* args */ ScanProgressEventArgs, Unit]] = js.native
  /**
