...
object networking {
  ...
  object config {
    ...
    @js.native
    val onCaptivePortalDetected: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* networkInfo */ NetworkInfo, Unit]] = js.native
  ...
  object onc {
    ...
    @js.native
    val onDeviceStateListChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
    ...
    @js.native
    val onNetworkListChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
    ...
    @js.native
    val onNetworksChanged: typingsSlinky.chromeApps.chrome.events.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
    ...
    @js.native
    val onPortalDetectionCompleted: typingsSlinky.chromeApps.chrome.events.Event[js.Function2[/* networkGuid */ String, /* status */ CaptivePortalStatus, Unit]] = js.native
