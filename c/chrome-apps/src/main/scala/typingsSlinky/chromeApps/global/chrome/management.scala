...
object management {
  ...
  object LaunchType {
    ...
    @js.native
    def OPEN_AS_PINNED_TAB: typingsSlinky.chromeApps.chromeAppsStrings.OPEN_AS_PINNED_TAB = js.native
    @scala.inline
    ...
    @js.native
    def OPEN_AS_REGULAR_TAB: typingsSlinky.chromeApps.chromeAppsStrings.OPEN_AS_REGULAR_TAB = js.native
    @scala.inline
    ...
    @js.native
    def OPEN_AS_WINDOW: typingsSlinky.chromeApps.chromeAppsStrings.OPEN_AS_WINDOW = js.native
    @scala.inline
    ...
    @js.native
    def OPEN_FULL_SCREEN: typingsSlinky.chromeApps.chromeAppsStrings.OPEN_FULL_SCREEN = js.native
    @scala.inline
