...
import typingsSlinky.chromeApps.WebView.ContextType
import typingsSlinky.chromeApps.WebView.Events.DialogMessageType
import typingsSlinky.chromeApps.WebView.Events.ExitEventReason
import typingsSlinky.chromeApps.WebView.Events.LoadAbortReason
import typingsSlinky.chromeApps.WebView.Events.RequestedPermission
import typingsSlinky.chromeApps.WebView.Events.WindowOpenDisposition
import typingsSlinky.chromeApps.WebView.ZoomMode
import typingsSlinky.chromeApps.chrome.accessibilityFeatures.LevelOfControl
import typingsSlinky.chromeApps.chrome.accessibilityFeatures.Scope
import typingsSlinky.chromeApps.chrome.audio.DeviceType
import typingsSlinky.chromeApps.chrome.audio.StreamType
import typingsSlinky.chromeApps.chrome.bluetooth.DeviceFilterType
import typingsSlinky.chromeApps.chrome.bluetooth.DeviceVendorIdSource
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.AdvertisementType
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.CharacteristicProperties
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.DescriptorPermissions
import typingsSlinky.chromeApps.chrome.bluetoothSocket.OnAcceptErrorCode
import typingsSlinky.chromeApps.chrome.bluetoothSocket.OnReceiveErrorCode
import typingsSlinky.chromeApps.chrome.certificateProvider.Hash
import typingsSlinky.chromeApps.chrome.clipboard.ImageType
import typingsSlinky.chromeApps.chrome.contextMenus.MediaType
...
import typingsSlinky.chromeApps.chrome.gcm.DisallowedKeys
import typingsSlinky.chromeApps.chrome.i18n.LanguageCode
import typingsSlinky.chromeApps.chrome.i18n.kLanguageInfoTable
import typingsSlinky.chromeApps.chrome.idle.IdleState
import typingsSlinky.chromeApps.chrome.mediaGalleries.GalleryChangedType
import typingsSlinky.chromeApps.chrome.mediaGalleries.Interactive
import typingsSlinky.chromeApps.chrome.mediaGalleries.MetadataOptionsType
import typingsSlinky.chromeApps.chrome.mediaGalleries.ScanProgressType
import typingsSlinky.chromeApps.chrome.networking.onc.ActivationStateType
import typingsSlinky.chromeApps.chrome.networking.onc.CaptivePortalStatus
import typingsSlinky.chromeApps.chrome.networking.onc.ClientCertType
import typingsSlinky.chromeApps.chrome.networking.onc.ConnectionStateType
import typingsSlinky.chromeApps.chrome.networking.onc.DeviceState
import typingsSlinky.chromeApps.chrome.networking.onc.EthernetAuthenticationType
import typingsSlinky.chromeApps.chrome.networking.onc.IPConfigType
import typingsSlinky.chromeApps.chrome.networking.onc.IPConfigurationType
...
import typingsSlinky.chromeApps.chrome.networking.onc.ProxySettingsType
import typingsSlinky.chromeApps.chrome.networking.onc.internal.ObjectFunction
import typingsSlinky.chromeApps.chrome.runtime.ChromeOSOnlyPermissions
import typingsSlinky.chromeApps.chrome.runtime.DevOnly
import typingsSlinky.chromeApps.chrome.runtime.JSONBasicTypes
import typingsSlinky.chromeApps.chrome.runtime.KioskOnlyPermissions
import typingsSlinky.chromeApps.chrome.runtime.NotAllowedAsOptionalPermissions
...
import typingsSlinky.chromeApps.chrome.runtime.UndocumentedPermissions
import typingsSlinky.chromeApps.chrome.runtime.UrlMatches
import typingsSlinky.chromeApps.chrome.signedInDevices.OS
import typingsSlinky.chromeApps.chrome.storage.StorageAreas
import typingsSlinky.chromeApps.chrome.types.ChromeSettingScope
import typingsSlinky.chromeApps.chrome.wallpaper.WallpaperLayoutType
import typingsSlinky.chromeApps.chrome.webRequest.ResourceType
import typingsSlinky.chromeApps.chrome.webViewRequest.DeclarativeWebRequestActionsList
import typingsSlinky.chromeApps.chrome.webViewRequest.DeclarativeWebRequestEventList
import typingsSlinky.chromeApps.chrome.webViewRequest.Stage
...
object chromeAppsStrings {
  ...
  - typingsSlinky.chromeApps.chrome.runtime.Permission because Already inherited */ @js.native
  sealed trait audio
    extends KioskOnlyPermissions
       with ContextType
       with typingsSlinky.chromeApps.chrome.bluetooth.DeviceType
       with MediaType
       with OptionalPermission
  ...
  sealed trait carAudio
    extends typingsSlinky.chromeApps.chrome.bluetooth.DeviceType
  ...
  sealed trait controllable_by_this_extension
    extends LevelOfControl
       with typingsSlinky.chromeApps.chrome.types.LevelOfControl
  ...
  sealed trait desktop_or_laptop
    extends typingsSlinky.chromeApps.chrome.signedInDevices.DeviceType
  ...
  sealed trait phone
    extends typingsSlinky.chromeApps.chrome.bluetooth.DeviceType
       with typingsSlinky.chromeApps.chrome.signedInDevices.DeviceType
