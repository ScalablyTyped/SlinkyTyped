...
trait TypeofsyncFileSystem extends js.Object {
  val ConflictResolutionPolicy: AnonLASTWRITEWIN = js.native
  /**
    * @enum
    * 'synced'
    ...
    */
  val FileStatus: AnonCONFLICTING = js.native
  /**
    * @enum
    * 'initializing'
  ...
  /**
    ...
    * @see ServiceStatus
    */
  val onServiceStatusChanged: Event[js.Function1[/* detail */ AnonDescriptionState, Unit]] = js.native
  /**
  ...
  /**
    ...
    * @param callback
    */
  def getUsageAndQuota(fileSystem: FileSystem, callback: js.Function1[/* info */ AnonQuotaBytes, Unit]): Unit = js.native
  /**
