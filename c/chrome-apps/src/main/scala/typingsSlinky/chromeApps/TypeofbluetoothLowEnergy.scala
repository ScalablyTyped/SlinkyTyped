...
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.Advertisement
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.Characteristic
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.Descriptor
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.INotification
import typingsSlinky.chromeApps.chrome.bluetoothLowEnergy.IProperties
