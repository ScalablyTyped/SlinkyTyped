...
object AnonPERMISSIONSINCREASE {
  @scala.inline
  def apply(PERMISSIONS_INCREASE: permissions_increase_, UNKNOWN: unknown__): AnonPERMISSIONSINCREASE = {
  ...
  @scala.inline
  implicit class AnonPERMISSIONSINCREASEOps[Self <: AnonPERMISSIONSINCREASE] (val x: Self) extends AnyVal {
    @scala.inline
