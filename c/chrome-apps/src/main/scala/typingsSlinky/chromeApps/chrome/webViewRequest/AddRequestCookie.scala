...
trait AddRequestCookie extends OnRequestActions {
  ...
  val typeGuard: typingsSlinky.chromeApps.chromeAppsStrings.AddRequestCookie = js.native
}
object AddRequestCookie {
  
  @scala.inline
  def apply(instanceType: String, typeGuard: typingsSlinky.chromeApps.chromeAppsStrings.AddRequestCookie): AddRequestCookie = {
  ...
  implicit class AddRequestCookieMutableBuilder[Self <: AddRequestCookie] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeGuard(value: typingsSlinky.chromeApps.chromeAppsStrings.AddRequestCookie): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
