...
object sockets {
  ...
  object tcpServer {
    ...
    object SocketInfo {
      ...
      @scala.inline
      def apply(paused: Boolean, persistent: Boolean, socketId: integer): typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketInfo = {
        ...
        __obj.asInstanceOf[typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketInfo]
      }
      
      @scala.inline
      implicit class SocketInfoMutableBuilder[Self <: typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketInfo] (val x: Self) extends AnyVal {
    ...
    object SocketProperties {
      ...
      @scala.inline
      def apply(): typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketProperties = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketProperties]
      }
      
      @scala.inline
      implicit class SocketPropertiesMutableBuilder[Self <: typingsSlinky.chromeApps.chrome.sockets.tcpServer.SocketProperties] (val x: Self) extends AnyVal {
