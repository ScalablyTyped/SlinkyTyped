...
object app {
  ...
  trait CreateWindowOptions extends ContentBounds {
    ...
    var frame: js.UndefOr[
        none_ | typingsSlinky.chromeApps.chromeAppsStrings.chrome | FrameOptions | FrameOptionsChrome
      ] = js.native
  ...
  object CreateWindowOptions {
    ...
    implicit class CreateWindowOptionsMutableBuilder[Self <: CreateWindowOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFrame(
        value: none_ | typingsSlinky.chromeApps.chromeAppsStrings.chrome | FrameOptions | FrameOptionsChrome
  ...
  trait FrameOptionsChrome extends StObject {
    ...
    /**
      ...
      * -webkit-app-region: drag can be used to mark regions draggable. no-drag can be used to disable this style on nested elements.
      */
    var `type`: typingsSlinky.chromeApps.chromeAppsStrings.chrome = js.native
  }
  object FrameOptionsChrome {
    
    @scala.inline
    def apply(`type`: typingsSlinky.chromeApps.chromeAppsStrings.chrome): FrameOptionsChrome = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    implicit class FrameOptionsChromeMutableBuilder[Self <: FrameOptionsChrome] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: typingsSlinky.chromeApps.chromeAppsStrings.chrome): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
