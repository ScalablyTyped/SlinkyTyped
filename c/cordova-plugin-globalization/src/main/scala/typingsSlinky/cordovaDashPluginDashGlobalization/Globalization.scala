...
trait Globalization extends js.Object {
  ...
  def dateToString(
    date: js.Date,
    onSuccess: js.Function1[/* date */ Anon_Value, Unit],
  ...
  /**
    ...
    */
  def getDateNames(
    onSuccess: js.Function1[/* names */ Anon_ValueArray, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  def getDateNames(
    onSuccess: js.Function1[/* names */ Anon_ValueArray, Unit],
  ...
  def getFirstDayOfWeek(
    onSuccess: js.Function1[/* day */ Anon_ValueNumber, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  /**
    ...
    */
  def getLocaleName(
    onSuccess: js.Function1[/* locale */ Anon_Value, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  /**
  ...
  def getPreferredLanguage(
    onSuccess: js.Function1[/* language */ Anon_Value, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  /**
  ...
  def isDaylightSavingsTime(
    date: js.Date,
    onSuccess: js.Function1[/* result */ Anon_Dst, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  /**
  ...
  def nubmerToString(
    value: Double,
    onSuccess: js.Function1[/* result */ Anon_Value, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  def nubmerToString(
    value: Double,
  ...
  def stringToNumber(
    value: String,
    onSuccess: js.Function1[/* result */ Anon_ValueNumber, Unit],
    onError: js.Function1[/* error */ GlobalizationError, Unit]
  ): Unit = js.native
  def stringToNumber(
    value: String,
