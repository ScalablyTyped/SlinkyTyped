package typingsSlinky.columnify.columnifyMod
...
import typingsSlinky.columnify.columnifyStrings.maxWidth
import typingsSlinky.columnify.columnifyStrings.minWidth
