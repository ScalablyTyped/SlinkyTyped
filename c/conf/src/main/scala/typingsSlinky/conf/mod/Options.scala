...
trait Options[T] extends js.Object {
  ...
  /**
  		...
  		*/
  val encryptionKey: js.UndefOr[String | Buffer | TypedArray | js.typedarray.DataView] = js.undefined
  /**
...
object Options {
  ...
  def apply[T](
    ...
    encryptionKey: String | Buffer | TypedArray | js.typedarray.DataView = null,
  ...
  {[ P in keyof T ]: conf.conf.Schema}
    */ typingsSlinky.conf.confStrings.Options with TopLevel[js.Any] = null,
