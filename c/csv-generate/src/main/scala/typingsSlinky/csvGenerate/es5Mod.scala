...
object es5Mod {
  ...
  @JSImport("csv-generate/lib/es5", JSImport.Namespace)
  @js.native
  ...
  @JSImport("csv-generate/lib/es5", "Generator")
  @js.native
  ...
  type Callback = js.Function2[/* err */ js.UndefOr[js.Error], /* records */ js.UndefOr[js.Any], Unit]
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var end: js.UndefOr[Double | js.Date] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEnd(value: Double | js.Date): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
