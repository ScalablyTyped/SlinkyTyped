...
object DefineCommandResult {
  ...
  implicit class DefineCommandResultOps[Self <: DefineCommandResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefineEventStreamsToLoad(value: defineEventStreamsToLoadHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("defineEventStreamsToLoad")(js.Any.fromFunction1(value))
        ret
    }
  }
