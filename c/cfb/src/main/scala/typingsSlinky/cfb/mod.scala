...
import typingsSlinky.cfb.cfbStrings.mad
...
object mod {
  ...
  object CFBEntry {
    ...
    implicit class CFBEntryMutableBuilder[Self <: CFBEntry] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCt(value: js.Date): Self = StObject.set(x, "ct", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMt(value: js.Date): Self = StObject.set(x, "mt", value.asInstanceOf[js.Any])
  ...
  trait CFBWritingOptions extends CFBCommonOptions {
    ...
    /** Output file type */
    var fileType: js.UndefOr[typingsSlinky.cfb.cfbStrings.cfb | zip | mad] = js.native
  ...
  object CFBWritingOptions {
    ...
    implicit class CFBWritingOptionsMutableBuilder[Self <: CFBWritingOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileType(value: typingsSlinky.cfb.cfbStrings.cfb | zip | mad): Self = StObject.set(x, "fileType", value.asInstanceOf[js.Any])
