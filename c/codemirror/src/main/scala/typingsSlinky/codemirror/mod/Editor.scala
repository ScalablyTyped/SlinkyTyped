...
import typingsSlinky.codemirror.anon.Left
import typingsSlinky.codemirror.anon.Line
import typingsSlinky.codemirror.anon.Right
import typingsSlinky.codemirror.anon.To
import typingsSlinky.codemirror.anon.Top
...
import typingsSlinky.codemirror.codemirrorStrings.lineNumberFormatter
...
import typingsSlinky.codemirror.codemirrorStrings.onDragEvent
import typingsSlinky.codemirror.codemirrorStrings.onKeyEvent
...
trait Editor
  ...
  def getDoc(): typingsSlinky.codemirror.mod.Doc = js.native
  ...
  def off(
    eventName: String,
    handler: js.Function2[/* doc */ typingsSlinky.codemirror.mod.Doc, /* event */ js.Any, Unit]
  ): Unit = js.native
  ...
  def off_swapDoc(
    eventName: swapDoc,
    handler: js.Function2[/* instance */ this.type, /* oldDoc */ typingsSlinky.codemirror.mod.Doc, Unit]
  ): Unit = js.native
  @JSName("off")
  ...
  def swapDoc(doc: typingsSlinky.codemirror.mod.Doc): typingsSlinky.codemirror.mod.Doc = js.native
