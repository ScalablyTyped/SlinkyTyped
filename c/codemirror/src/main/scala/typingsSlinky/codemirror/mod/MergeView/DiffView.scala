...
object DiffView {
  ...
  implicit class DiffViewOps[Self <: DiffView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForceUpdate(value: () => js.Function1[/* mode */ String, Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("forceUpdate")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetShowDifferences(value: Boolean => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setShowDifferences")(js.Any.fromFunction1(value))
        ret
    }
  }
