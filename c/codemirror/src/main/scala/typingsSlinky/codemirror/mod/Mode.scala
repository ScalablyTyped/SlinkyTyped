...
trait Mode[T] extends StObject {
  ...
  var token: js.UndefOr[
    js.Function2[/* stream */ typingsSlinky.codemirror.mod.StringStream, /* state */ T, String | Null]
  ] = js.native
}
object Mode {
  ...
  implicit class ModeMutableBuilder[Self <: Mode[_], T] (val x: Self with Mode[T]) extends AnyVal {
    ...
    @scala.inline
    def setElectricinput(value: js.RegExp): Self = StObject.set(x, "electricinput", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setToken(value: (/* stream */ typingsSlinky.codemirror.mod.StringStream, /* state */ T) => String | Null): Self = StObject.set(x, "token", js.Any.fromFunction2(value))
