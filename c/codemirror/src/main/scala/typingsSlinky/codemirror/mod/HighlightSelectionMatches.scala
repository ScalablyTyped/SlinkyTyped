...
object HighlightSelectionMatches {
  ...
  implicit class HighlightSelectionMatchesOps[Self <: HighlightSelectionMatches] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShowTokenRegExp(value: js.RegExp): Self = this.set("showToken", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShowToken(value: Boolean | js.RegExp): Self = this.set("showToken", value.asInstanceOf[js.Any])
