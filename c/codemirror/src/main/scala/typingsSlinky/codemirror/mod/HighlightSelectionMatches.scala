...
object HighlightSelectionMatches {
  ...
  implicit class HighlightSelectionMatchesMutableBuilder[Self <: HighlightSelectionMatches] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShowToken(value: Boolean | js.RegExp): Self = StObject.set(x, "showToken", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShowTokenRegExp(value: js.RegExp): Self = StObject.set(x, "showToken", value.asInstanceOf[js.Any])
