...
import typingsSlinky.codemirror.Anon_AnchorHead
import typingsSlinky.codemirror.Anon_Bias
import typingsSlinky.codemirror.Anon_FromMode
import typingsSlinky.codemirror.Anon_InsertLeft
import typingsSlinky.codemirror.Anon_Redo
...
trait Doc extends js.Object {
  ...
  def historySize(): Anon_Redo = js.native
  ...
  def linkedDoc(options: Anon_FromMode): Doc = js.native
  ...
  def listSelections(): js.Array[Anon_AnchorHead] = js.native
  ...
  def setBookmark(pos: Position, options: Anon_InsertLeft): TextMarker = js.native
  ...
  def setSelection(anchor: Position, head: Position, options: Anon_Bias): Unit = js.native
  ...
  def setSelections(ranges: js.Array[Anon_AnchorHead]): Unit = js.native
  def setSelections(ranges: js.Array[Anon_AnchorHead], primary: Double): Unit = js.native
  def setSelections(ranges: js.Array[Anon_AnchorHead], primary: Double, options: Anon_Bias): Unit = js.native
