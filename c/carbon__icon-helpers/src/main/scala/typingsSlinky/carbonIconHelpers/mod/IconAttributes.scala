...
trait IconAttributes extends js.Object {
  var `aria-hidden`: js.UndefOr[Boolean] = js.native
  var `aria-label`: js.UndefOr[String] = js.native
  var `aria-labelledby`: js.UndefOr[String] = js.native
  var `class`: js.UndefOr[String] = js.native
  var focusable: js.UndefOr[`true` | `false`] = js.native
  var height: IconSize = js.native
  var id: js.UndefOr[String] = js.native
  var preserveAspectRatio: js.UndefOr[String | (`xMidYMid meet`)] = js.native
  var role: js.UndefOr[img] = js.native
  var style: js.UndefOr[String] = js.native
  var tabindex: js.UndefOr[String] = js.native
  var title: js.UndefOr[String] = js.native
  var viewBox: js.UndefOr[String] = js.native
  var width: IconSize = js.native
}

object IconAttributes {
  @scala.inline
  def apply(height: IconSize, width: IconSize): IconAttributes = {
    val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.asInstanceOf[IconAttributes]
  }
  @scala.inline
  implicit class IconAttributesOps[Self <: IconAttributes] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withHeight(value: IconSize): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("height")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWidth(value: IconSize): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFocusable(value: `true` | `false`): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPreserveAspectRatio(value: String | (`xMidYMid meet`)): Self = {
        val ret = this.duplicate
