...
trait Observablemessagestring extends js.Object {
  ...
  def listenTo(
    ...
    options: typingsSlinky.ckeditorCkeditor5Utils.AnonPriority
  ): Unit = js.native
  def off(event: String): Unit = js.native
  def off(event: String, callback: js.Function): Unit = js.native
  def on(event: String, callback: js.Function): Unit = js.native
  def on(event: String, callback: js.Function, options: typingsSlinky.ckeditorCkeditor5Utils.Anon0): Unit = js.native
  def once(event: String, callback: js.Function): Unit = js.native
  def once(event: String, callback: js.Function, options: typingsSlinky.ckeditorCkeditor5Utils.Anon0): Unit = js.native
