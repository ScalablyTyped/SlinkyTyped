...
object Pick {
  @scala.inline
  def apply[/* <: typingsSlinky.colorNamer.mod.Palette */ T](pick: js.Array[T]): Pick[T] = {
    val __obj = js.Dynamic.literal(pick = pick.asInstanceOf[js.Any])
    __obj.asInstanceOf[Pick[T]]
  }
  @scala.inline
  implicit class PickOps[Self <: Pick[_], /* <: typingsSlinky.colorNamer.mod.Palette */ T] (val x: Self with Pick[T]) extends AnyVal {
    @scala.inline
