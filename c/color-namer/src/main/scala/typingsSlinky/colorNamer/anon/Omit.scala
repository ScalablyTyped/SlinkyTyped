...
object Omit {
  @scala.inline
  def apply[/* <: typingsSlinky.colorNamer.mod.Palette */ T](omit: js.Array[T]): Omit[T] = {
    val __obj = js.Dynamic.literal(omit = omit.asInstanceOf[js.Any])
    __obj.asInstanceOf[Omit[T]]
  }
  @scala.inline
  implicit class OmitOps[Self <: Omit[_], /* <: typingsSlinky.colorNamer.mod.Palette */ T] (val x: Self with Omit[T]) extends AnyVal {
    @scala.inline
