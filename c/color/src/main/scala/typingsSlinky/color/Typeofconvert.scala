...
trait Typeofconvert extends js.Object {
  val ansi16: readonlychannels1readonlyAnsi256
  val ansi256: readonlychannels1readonly
  val apple: readonlychannels3readonlyGray
  val cmyk: readonlychannels4readonly
  val gray: readonlychannels1readonlyChannels
  val hcg: readonlychannels3readonlyAnsi256
  val hex: readonlychannels1readonlyAnsi16
  val hsl: readonlychannels3readonlyChannels
  val hsv: readonlychannels3readonlyCmyk
  val hwb: readonlychannels3readonlyHcg
  val keyword: readonlychannels1readonlyApple
  val lab: readonlychannels3readonlyHex
  val lch: readonlychannels3readonlyApple
  val rgb: readonlychannels3readonly
  val xyz: readonlychannels3readonlyAnsi16
}
