...
object QuerySortDirections extends StObject {
  ...
  /* "ASC" */ val QUERY_SORT_ASCENDING: typingsSlinky.clearbladejsNode.mod.QuerySortDirections.QUERY_SORT_ASCENDING with String = js.native
  
  @js.native
  sealed trait QUERY_SORT_DESCENDING extends QuerySortDirections
  /* "DESC" */ val QUERY_SORT_DESCENDING: typingsSlinky.clearbladejsNode.mod.QuerySortDirections.QUERY_SORT_DESCENDING with String = js.native
}
