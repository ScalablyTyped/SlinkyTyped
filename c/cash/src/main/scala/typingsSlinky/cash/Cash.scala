...
trait Cash extends js.Object {
  ...
  def add(selector: typingsSlinky.std.Element): Cash = js.native
  def add(selector: typingsSlinky.std.Element, context: Element): Cash = js.native
  /**
    * addClass
  ...
  /**
    ...
    */
  def after(selector: typingsSlinky.std.Element): Cash = js.native
  /**
    * append
  ...
  def append(content: typingsSlinky.std.Element): Cash = js.native
  /**
    * appendTo
  ...
  def appendTo(parent: typingsSlinky.std.Element): Cash = js.native
  /**
    * attr
  ...
  def before(selector: typingsSlinky.std.Element): Cash = js.native
  /**
    * children
  ...
  def insertAfter(selector: typingsSlinky.std.Element): Cash = js.native
  /**
    * insertBefore
  ...
  def insertBefore(selector: typingsSlinky.std.Element): Cash = js.native
  /**
    * is
  ...
  def not(selector: typingsSlinky.std.Element): Cash = js.native
  /**
    * off
  ...
  def prependTo(parent: typingsSlinky.std.Element): Cash = js.native
  /**
    * prev
