...
package object Bucket {
  /**
    ...
    */
  type DecoderFunction = js.Function1[/* doc */ typingsSlinky.couchbase.mod.Bucket.TranscoderDoc, js.Any]
  /**
    ...
    */
  type EncoderFunction = js.Function1[/* value */ js.Any, typingsSlinky.couchbase.mod.Bucket.TranscoderDoc]
  /**
  ...
  type FtsQueryCallback = js.Function3[
    /* error */ typingsSlinky.couchbase.mod.CouchbaseError | scala.Null, 
    /* rows */ js.Array[js.Any] | scala.Null, 
    /* meta */ typingsSlinky.couchbase.mod.Bucket.FtsQueryResponse.Meta, 
    scala.Unit
  ]
  type FtsQueryResponse = typingsSlinky.couchbase.mod.Bucket.FtsQueryResponse_
  /**
    * Multi-Get Callback.
  ...
  type N1qlQueryResponse = typingsSlinky.couchbase.mod.Bucket.N1qlQueryResponse_
  /**
  ...
  type ViewQueryResponse = typingsSlinky.couchbase.mod.Bucket.ViewQueryResponse_
}
