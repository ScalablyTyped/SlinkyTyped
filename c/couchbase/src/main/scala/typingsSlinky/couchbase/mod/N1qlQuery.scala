...
object N1qlQuery {
  ...
  object Consistency extends StObject {
    ...
    /* 0 */ val NOT_BOUND: typingsSlinky.couchbase.mod.N1qlQuery.Consistency.NOT_BOUND with Double = js.native
    ...
    /* 1 */ val REQUEST_PLUS: typingsSlinky.couchbase.mod.N1qlQuery.Consistency.REQUEST_PLUS with Double = js.native
    ...
    /* 2 */ val STATEMENT_PLUS: typingsSlinky.couchbase.mod.N1qlQuery.Consistency.STATEMENT_PLUS with Double = js.native
  }
