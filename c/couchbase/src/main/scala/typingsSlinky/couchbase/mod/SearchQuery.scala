...
import typingsSlinky.couchbase.mod.SearchQuery.Consistency
import typingsSlinky.couchbase.mod.SearchQuery.HighlightStyle
...
object SearchQuery {
  ...
  object Consistency extends StObject {
    ...
    /* 0 */ val NOT_BOUNDED: typingsSlinky.couchbase.mod.SearchQuery.Consistency.NOT_BOUNDED with Double = js.native
  }
  ...
  object HighlightStyle extends StObject {
    ...
    /* 2 */ val ANSI: typingsSlinky.couchbase.mod.SearchQuery.HighlightStyle.ANSI with Double = js.native
    ...
    /* 0 */ val DEFAULT: typingsSlinky.couchbase.mod.SearchQuery.HighlightStyle.DEFAULT with Double = js.native
    ...
    /* 1 */ val HTML: typingsSlinky.couchbase.mod.SearchQuery.HighlightStyle.HTML with Double = js.native
  }
