...
package object Bucket {
  import typingsSlinky.couchbase.couchbaseMod.Bucket.FtsQueryResponse.Meta
  import typingsSlinky.couchbase.couchbaseMod.CouchbaseError
  ...
  type N1qlQueryCallback = js.Function3[
    /* error */ CouchbaseError | Null, 
    /* rows */ js.Array[js.Any] | Null, 
    /* meta */ typingsSlinky.couchbase.couchbaseMod.Bucket.N1qlQueryResponse.Meta, 
    Unit
  ]
  ...
  type QueryCallback = js.Function3[
    /* error */ CouchbaseError | Null, 
    /* rows */ js.Array[js.Any] | Null, 
    /* meta */ typingsSlinky.couchbase.couchbaseMod.Bucket.ViewQueryResponse.Meta, 
    Unit
  ]
