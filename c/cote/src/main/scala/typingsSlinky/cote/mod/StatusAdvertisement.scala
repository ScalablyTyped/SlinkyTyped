...
- typingsSlinky.cote.mod.ResponderAdvertisement because var conflicts: key, name, namespace. Inlined respondsTo, subset */ trait StatusAdvertisement extends RequesterAdvertisement {
  /**
