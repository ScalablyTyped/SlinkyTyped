...
import typingsSlinky.contentfulManagement.anon.Title
...
@js.native
trait AssetFileProp extends js.Object {
...
object AssetFileProp {
  ...
  @scala.inline
  implicit class AssetFilePropOps[Self <: AssetFileProp] (val x: Self) extends AnyVal {
