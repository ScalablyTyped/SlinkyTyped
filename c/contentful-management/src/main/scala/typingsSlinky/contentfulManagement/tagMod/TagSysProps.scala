...
import typingsSlinky.contentfulManagement.anon.SysId
...
trait TagSysProps extends js.Object {
  ...
  var `type`: typingsSlinky.contentfulManagement.contentfulManagementStrings.Tag = js.native
...
object TagSysProps {
  ...
  def apply(
    ...
    environment: SysId,
    id: String,
    `type`: typingsSlinky.contentfulManagement.contentfulManagementStrings.Tag,
    updatedAt: String,
    version: Double
  ): TagSysProps = {
  ...
  implicit class TagSysPropsOps[Self <: TagSysProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.contentfulManagement.contentfulManagementStrings.Tag): Self = this.set("type", value.asInstanceOf[js.Any])
