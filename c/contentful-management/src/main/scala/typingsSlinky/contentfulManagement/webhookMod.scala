...
import typingsSlinky.contentfulManagement.contentfulManagementStrings.DELETE
import typingsSlinky.contentfulManagement.contentfulManagementStrings.GET
import typingsSlinky.contentfulManagement.contentfulManagementStrings.PATCH
import typingsSlinky.contentfulManagement.contentfulManagementStrings.POST
import typingsSlinky.contentfulManagement.contentfulManagementStrings.PUT
import typingsSlinky.contentfulManagement.contentfulManagementStrings.`applicationSlashjsonSemicolon charsetEqualssignutf-8`
import typingsSlinky.contentfulManagement.contentfulManagementStrings.`applicationSlashvndDotcontentfulDotmanagementDotv1PlussignjsonSemicolon charsetEqualssignutf-8`
import typingsSlinky.contentfulManagement.contentfulManagementStrings.`applicationSlashx-www-form-urlencodedSemicolon charsetEqualssignutf-8`
import typingsSlinky.contentfulManagement.contentfulManagementStrings.`applicationSlashx-www-form-urlencoded`
import typingsSlinky.contentfulManagement.contentfulManagementStrings.applicationSlashjson
import typingsSlinky.contentfulManagement.contentfulManagementStrings.applicationSlashvndDotcontentfulDotmanagementDotv1Plussignjson
import typingsSlinky.contentfulManagement.contentfulManagementStrings.sysDotcontentTypeDotsysDotid
import typingsSlinky.contentfulManagement.contentfulManagementStrings.sysDotenvironmentDotsysDotid
import typingsSlinky.contentfulManagement.contentfulManagementStrings.sysDotid
...
object webhookMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.contentfulManagement.webhookMod.EqualityConstraint
    - typingsSlinky.contentfulManagement.webhookMod.InConstraint
    - typingsSlinky.contentfulManagement.webhookMod.RegexpConstraint
    - typingsSlinky.contentfulManagement.webhookMod.NotConstraint
  */
  trait WebhookFilter extends StObject
  object WebhookFilter {
    
    @scala.inline
    def EqualityConstraint(equals_ : js.Tuple2[Doc, String]): typingsSlinky.contentfulManagement.webhookMod.EqualityConstraint = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("equals")(equals_.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.contentfulManagement.webhookMod.EqualityConstraint]
    }
    
    @scala.inline
    def InConstraint(in: js.Tuple2[Doc, Array[String]]): typingsSlinky.contentfulManagement.webhookMod.InConstraint = {
      val __obj = js.Dynamic.literal(in = in.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.contentfulManagement.webhookMod.InConstraint]
    }
    
    @scala.inline
    def NotConstraint(not: EqualityConstraint | InConstraint | RegexpConstraint): typingsSlinky.contentfulManagement.webhookMod.NotConstraint = {
      val __obj = js.Dynamic.literal(not = not.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.contentfulManagement.webhookMod.NotConstraint]
    }
    
    @scala.inline
    def RegexpConstraint(regexp: js.Tuple2[Doc, Pattern]): typingsSlinky.contentfulManagement.webhookMod.RegexpConstraint = {
      val __obj = js.Dynamic.literal(regexp = regexp.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.contentfulManagement.webhookMod.RegexpConstraint]
    }
  }
