package typingsSlinky.contentfulManagement.commonTypesMod
...
@js.native
trait MetaLinkProps extends js.Object {
...
object MetaLinkProps {
  ...
  @scala.inline
  implicit class MetaLinkPropsOps[Self <: MetaLinkProps] (val x: Self) extends AnyVal {
