...
@js.native
trait MetaSysPropsteamsysMetaLi extends js.Object {
...
object MetaSysPropsteamsysMetaLi {
  ...
  @scala.inline
  def apply(createdAt: String, id: String, team: Sys, `type`: String, updatedAt: String, version: Double): MetaSysPropsteamsysMetaLi = {
  ...
  @scala.inline
  implicit class MetaSysPropsteamsysMetaLiOps[Self <: MetaSysPropsteamsysMetaLi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTeam(value: Sys): Self = this.set("team", value.asInstanceOf[js.Any])
