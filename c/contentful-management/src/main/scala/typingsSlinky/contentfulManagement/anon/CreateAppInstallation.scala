...
import typingsSlinky.contentfulManagement.contentTypeMod.CreateContentTypeProps
...
import typingsSlinky.contentfulManagement.localeMod.CreateLocaleProps
...
import typingsSlinky.contentfulManagement.tagMod.Tag
...
trait CreateAppInstallation extends js.Object {
  ...
  /**
    ...
    * ```
    */
  def createContentType(data: CreateContentTypeProps): js.Promise[typingsSlinky.contentfulManagement.contentTypeMod.ContentType] = js.native
  ...
  /**
    ...
    * ```
    */
  def createContentTypeWithId(id: String, data: CreateContentTypeProps): js.Promise[typingsSlinky.contentfulManagement.contentTypeMod.ContentType] = js.native
  ...
  /**
    ...
    * ```
    */
  def getContentType(id: String): js.Promise[typingsSlinky.contentfulManagement.contentTypeMod.ContentType] = js.native
  ...
  def getContentTypeSnapshots(contentTypeId: String): js.Promise[
    Collection[
      Snapshot[typingsSlinky.contentfulManagement.contentTypeMod.ContentType], 
      SnapshotProps[typingsSlinky.contentfulManagement.contentTypeMod.ContentType]
    ]
  ] = js.native
  ...
  def getContentTypes(): js.Promise[
    Collection[typingsSlinky.contentfulManagement.contentTypeMod.ContentType, ContentTypeProps]
  ] = js.native
