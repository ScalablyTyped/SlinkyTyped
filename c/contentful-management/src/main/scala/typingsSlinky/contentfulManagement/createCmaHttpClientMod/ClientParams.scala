package typingsSlinky.contentfulManagement.createCmaHttpClientMod
...
object ClientParams {
  ...
  implicit class ClientParamsOps[Self <: ClientParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHttpsAgent(value: typingsSlinky.node.httpsMod.Agent): Self = this.set("httpsAgent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLogHandler(value: (/* level */ String, /* data */ js.Error | String) => Unit): Self = this.set("logHandler", js.Any.fromFunction2(value))
