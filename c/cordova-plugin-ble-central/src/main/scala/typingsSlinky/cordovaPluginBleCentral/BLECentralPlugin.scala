...
object BLECentralPlugin {
  ...
  object PeripheralData {
    ...
    implicit class PeripheralDataMutableBuilder[Self <: PeripheralData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdvertising(value: js.typedarray.ArrayBuffer | js.Any): Self = StObject.set(x, "advertising", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdvertisingArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "advertising", value.asInstanceOf[js.Any])
