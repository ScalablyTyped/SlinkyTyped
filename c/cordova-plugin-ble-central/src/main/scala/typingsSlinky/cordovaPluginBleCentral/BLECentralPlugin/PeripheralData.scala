...
object PeripheralData {
  ...
  implicit class PeripheralDataOps[Self <: PeripheralData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdvertisingArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("advertising", value.asInstanceOf[js.Any])
    @scala.inline
    def setAdvertising(value: js.typedarray.ArrayBuffer | js.Any): Self = this.set("advertising", value.asInstanceOf[js.Any])
    @scala.inline
