...
object AnonCallback {
  ...
  implicit class AnonCallbackOps[Self <: AnonCallback] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContinueButton(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("continueButton")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutContinueButton: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("continueButton")(js.undefined)
        ret
    }
    @scala.inline
