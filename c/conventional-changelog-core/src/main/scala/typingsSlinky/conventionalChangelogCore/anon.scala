...
import typingsSlinky.normalizePackageData.anon.Email
import typingsSlinky.normalizePackageData.anon.Type
import typingsSlinky.normalizePackageData.anon.Url
import typingsSlinky.normalizePackageData.mod.Person
