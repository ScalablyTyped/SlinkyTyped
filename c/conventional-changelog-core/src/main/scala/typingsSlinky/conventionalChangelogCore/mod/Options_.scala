...
@js.native
trait Options_[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsSlinky.conventionalChangelogWriter.mod.Context */] extends js.Object {
...
object Options_ {
  ...
  @scala.inline
  def apply[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsSlinky.conventionalChangelogWriter.mod.Context */](): Options_[TCommit, TContext] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options_[TCommit, TContext]]
  }
  
  @scala.inline
  implicit class Options_Ops[Self <: Options_[_, _], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsSlinky.conventionalChangelogWriter.mod.Context */] (val x: Self with (Options_[TCommit, TContext])) extends AnyVal {
