...
import typingsSlinky.collections.sortedSetMod.internal.SortedSet
  ...
  object internal {
    ...
    object AbstractSet {
      ...
      def apply(
        ...
        equals_ : /* repeated */ js.Any => js.Any,
