package typingsSlinky.cli.cliMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.cli.Anon_0
...
trait CLI extends js.Object {
  ...
  def parse(opts: StringDictionary[Anon_0]): js.Any = js.native
  def parse(opts: StringDictionary[Anon_0], commands: js.Array[String]): js.Any = js.native
  def parse(opts: StringDictionary[Anon_0], commands: StringDictionary[String]): js.Any = js.native
