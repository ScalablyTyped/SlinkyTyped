package typingsSlinky.changeCase

import typingsSlinky.noCase.mod.Options
...
object mod {
  ...
  @JSImport("change-case", "camelCase")
  @js.native
  ...
  @JSImport("change-case", "capitalCaseTransform")
  @js.native
  ...
  @JSImport("change-case", "paramCase")
  @js.native
  ...
  @JSImport("change-case", "pascalCase")
  @js.native
  ...
  @JSImport("change-case", "pascalCaseTransform")
  @js.native
  def pascalCaseTransform(input: String, index: Double): String = js.native
  
  @JSImport("change-case", "pascalCaseTransformMerge")
  @js.native
  ...
  @JSImport("change-case", "sentenceCaseTransform")
  @js.native
  def sentenceCaseTransform(input: String, index: Double): String = js.native
  
  @JSImport("change-case", "snakeCase")
  @js.native
