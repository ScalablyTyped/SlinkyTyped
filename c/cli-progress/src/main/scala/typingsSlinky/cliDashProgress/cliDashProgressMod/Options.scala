...
import typingsSlinky.cliDashProgress.cliDashProgressStrings.center
import typingsSlinky.cliDashProgress.cliDashProgressStrings.left
import typingsSlinky.cliDashProgress.cliDashProgressStrings.right
