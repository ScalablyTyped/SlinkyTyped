...
object ExtraContext {
  @scala.inline
  def apply[/* <: typingsSlinky.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol] */ T](commitGroups: js.Array[CommitGroup[T]], noteGroups: js.Array[NoteGroup]): ExtraContext[T] = {
  ...
  @scala.inline
  implicit class ExtraContextOps[Self <: ExtraContext[_], /* <: typingsSlinky.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol] */ T] (val x: Self with ExtraContext[T]) extends AnyVal {
    @scala.inline
