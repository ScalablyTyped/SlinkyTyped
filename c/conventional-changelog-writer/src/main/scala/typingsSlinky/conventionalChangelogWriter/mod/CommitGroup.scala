...
object CommitGroup {
  @scala.inline
  def apply[/* <: typingsSlinky.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol] */ T](commits: js.Array[TransformedCommit[T]], title: String | `false`): CommitGroup[T] = {
  ...
  @scala.inline
  implicit class CommitGroupOps[Self <: CommitGroup[_], /* <: typingsSlinky.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol] */ T] (val x: Self with CommitGroup[T]) extends AnyVal {
    @scala.inline
