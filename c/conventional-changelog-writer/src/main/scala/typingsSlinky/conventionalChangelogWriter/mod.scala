...
import typingsSlinky.conventionalChangelogWriter.anon.Raw
import typingsSlinky.conventionalChangelogWriter.conventionalChangelogWriterBooleans.`false`
import typingsSlinky.conventionalChangelogWriter.conventionalChangelogWriterStrings.raw
import typingsSlinky.conventionalChangelogWriter.mod.GeneratedContext.ExtraContext
import typingsSlinky.conventionalChangelogWriter.mod.Options.FinalizeContext
import typingsSlinky.conventionalChangelogWriter.mod.Options.GenerateOn
import typingsSlinky.conventionalChangelogWriter.mod.Options.Sort
...
object mod {
  ...
  {[ P in std.Exclude<keyof T, K> ]: T[P]}
    */ typingsSlinky.conventionalChangelogWriter.conventionalChangelogWriterStrings.Omit with TopLevel[T]
  ...
  trait Options[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: Context */] extends StObject {
    ...
    var transform: js.UndefOr[
        typingsSlinky.conventionalChangelogWriter.mod.Options.Transform[TCommit, TContext]
      ] = js.native
  }
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options[_, _], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: Context */] (val x: Self with (Options[TCommit, TContext])) extends AnyVal {
      ...
      @scala.inline
      def setTransform(value: typingsSlinky.conventionalChangelogWriter.mod.Options.Transform[TCommit, TContext]): Self = StObject.set(x, "transform", value.asInstanceOf[js.Any])
