...
object mod {
  ...
  type Id = String | typingsSlinky.catbox.anon.Id
  ...
  */
  ...
  object PolicyOptionVariants {
    ...
    @scala.inline
    def DecoratedPolicyOptions[T](): typingsSlinky.catbox.mod.DecoratedPolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.catbox.mod.DecoratedPolicyOptions[T]]
    }
    
    @scala.inline
    def PolicyOptions[T](): typingsSlinky.catbox.mod.PolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.catbox.mod.PolicyOptions[T]]
    }
  }
