...
object Arity {
  @scala.inline
  def apply[/* <: typingsSlinky.curriable.mod.Handler */ Fn](arity: Double, fn: Fn): Arity[Fn] = {
    val __obj = js.Dynamic.literal(arity = arity.asInstanceOf[js.Any], fn = fn.asInstanceOf[js.Any])
    __obj.asInstanceOf[Arity[Fn]]
  }
  @scala.inline
  implicit class ArityOps[Self <: Arity[_], /* <: typingsSlinky.curriable.mod.Handler */ Fn] (val x: Self with Arity[Fn]) extends AnyVal {
    @scala.inline
