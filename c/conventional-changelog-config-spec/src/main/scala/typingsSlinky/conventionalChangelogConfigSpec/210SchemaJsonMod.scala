package typingsSlinky.conventionalChangelogConfigSpec

import org.scalablytyped.runtime.Shortcut
import typingsSlinky.conventionalChangelogConfigSpec.`210SchemaJsonMod`.Config.Type
...
object `210SchemaJsonMod` extends Shortcut {
  ...
  trait Config extends StObject {
    ...
    /**
      ...
      * ["#"]
      */
    var issuePrefixes: js.UndefOr[js.Array[String]] = js.native
  ...
  object Config {
    ...
    implicit class ConfigMutableBuilder[Self <: Config] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIssuePrefixes(value: js.Array[String]): Self = StObject.set(x, "issuePrefixes", value.asInstanceOf[js.Any])
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.conventionalChangelogConfigSpec.`210SchemaJsonMod`.Config.Type.WithSection
      - typingsSlinky.conventionalChangelogConfigSpec.`210SchemaJsonMod`.Config.Type.WithHidden
    */
  ...
  /* This means you don't have to write `^`, but can instead just say ``210SchemaJsonMod`.foo` */
