...
object schemaJsonMod extends Shortcut {
  ...
  object Config {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.conventionalChangelogConfigSpec.schemaJsonMod.Config.Type.WithSection
      - typingsSlinky.conventionalChangelogConfigSpec.schemaJsonMod.Config.Type.WithHidden
    */
