package typingsSlinky.conventionalChangelogConfigSpec.`210SchemaJsonMod`
...
object Config_ {
  ...
  implicit class Config_Ops[Self <: Config_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIssuePrefixes(value: js.Array[String]): Self = this.set("issuePrefixes", value.asInstanceOf[js.Any])
    @scala.inline
