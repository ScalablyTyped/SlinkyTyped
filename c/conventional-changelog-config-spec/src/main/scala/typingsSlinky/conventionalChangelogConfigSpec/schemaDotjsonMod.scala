...
object schemaDotjsonMod extends Shortcut {
  ...
  object Config {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.conventionalChangelogConfigSpec.schemaDotjsonMod.Config.Type.WithSection
      - typingsSlinky.conventionalChangelogConfigSpec.schemaDotjsonMod.Config.Type.WithHidden
    */
