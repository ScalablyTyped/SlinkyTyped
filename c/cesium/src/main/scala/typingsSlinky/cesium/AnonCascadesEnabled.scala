...
trait AnonCascadesEnabled extends js.Object {
  ...
  var lightCamera: Camera = js.native
...
object AnonCascadesEnabled {
  @scala.inline
  def apply(lightCamera: Camera): AnonCascadesEnabled = {
    val __obj = js.Dynamic.literal(lightCamera = lightCamera.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCascadesEnabled]
  }
  @scala.inline
  implicit class AnonCascadesEnabledOps[Self <: AnonCascadesEnabled] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withLightCamera(value: Camera): Self = {
