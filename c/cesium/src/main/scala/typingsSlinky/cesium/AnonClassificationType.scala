...
@js.native
trait AnonClassificationType extends js.Object {
  ...
  var material: js.UndefOr[MaterialProperty | Color] = js.native
  var outline: js.UndefOr[Property | Boolean] = js.native
  var outlineColor: js.UndefOr[Property | Color] = js.native
...
object AnonClassificationType {
  @scala.inline
  def apply(): AnonClassificationType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonClassificationType]
  }
  @scala.inline
  implicit class AnonClassificationTypeOps[Self <: AnonClassificationType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMaterial(value: MaterialProperty | Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutlineColor(value: Property | Color): Self = {
        val ret = this.duplicate
