...
trait AnonChildTileMask extends js.Object {
  ...
  var credits: js.UndefOr[js.Array[Credit]] = js.native
...
object AnonChildTileMask {
  ...
  @scala.inline
  implicit class AnonChildTileMaskOps[Self <: AnonChildTileMask] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCredits(value: js.Array[Credit]): Self = {
        val ret = this.duplicate
