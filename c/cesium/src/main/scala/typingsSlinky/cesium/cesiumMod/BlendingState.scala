...
object BlendingState extends js.Object {
  ...
  /* 3 */ val ADDITIVE_BLEND: typingsSlinky.cesium.cesiumMod.BlendingState.ADDITIVE_BLEND with Double = js.native
  /* 1 */ val ALPHA_BLEND: typingsSlinky.cesium.cesiumMod.BlendingState.ALPHA_BLEND with Double = js.native
  /* 0 */ val DISABLED: typingsSlinky.cesium.cesiumMod.BlendingState.DISABLED with Double = js.native
  /* 2 */ val PRE_MULTIPLIED_ALPHA_BLEND: typingsSlinky.cesium.cesiumMod.BlendingState.PRE_MULTIPLIED_ALPHA_BLEND with Double = js.native
  @JSBracketAccess
