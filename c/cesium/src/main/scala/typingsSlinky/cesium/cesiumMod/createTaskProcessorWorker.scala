...
import typingsSlinky.cesium.cesiumMod.createTaskProcessorWorker.TaskProcessorWorkerFunction
import typingsSlinky.cesium.cesiumMod.createTaskProcessorWorker.WorkerFunction
