...
object ModelAnimationLoop extends js.Object {
  ...
  /* 2 */ val MIRRORED_REPEAT: typingsSlinky.cesium.cesiumMod.ModelAnimationLoop.MIRRORED_REPEAT with Double = js.native
  /* 0 */ val NONE: typingsSlinky.cesium.cesiumMod.ModelAnimationLoop.NONE with Double = js.native
  /* 1 */ val REPEAT: typingsSlinky.cesium.cesiumMod.ModelAnimationLoop.REPEAT with Double = js.native
  @JSBracketAccess
