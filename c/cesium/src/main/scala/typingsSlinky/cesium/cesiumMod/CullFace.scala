...
object CullFace extends js.Object {
  ...
  /* 1 */ val BACK: typingsSlinky.cesium.cesiumMod.CullFace.BACK with Double = js.native
  /* 0 */ val FRONT: typingsSlinky.cesium.cesiumMod.CullFace.FRONT with Double = js.native
  /* 2 */ val FRONT_AND_BACK: typingsSlinky.cesium.cesiumMod.CullFace.FRONT_AND_BACK with Double = js.native
  @JSBracketAccess
