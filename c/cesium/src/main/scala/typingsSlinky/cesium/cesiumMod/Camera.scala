...
import typingsSlinky.cesium.Anon_Cancel
import typingsSlinky.cesium.Anon_CancelComplete
import typingsSlinky.cesium.Anon_Convert
...
class Camera protected () extends js.Object {
  ...
  def flyTo(options: Anon_Cancel): Unit = js.native
  def flyToBoundingSphere(boundingSphere: BoundingSphere): Unit = js.native
  def flyToBoundingSphere(boundingSphere: BoundingSphere, options: Anon_CancelComplete): Unit = js.native
  ...
  def setView(options: Anon_Convert): Unit = js.native
