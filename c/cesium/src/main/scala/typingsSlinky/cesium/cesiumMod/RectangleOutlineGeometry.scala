...
import typingsSlinky.cesium.Anon_EllipsoidExtrudedHeightGranularityHeightRectangleRotation
...
class RectangleOutlineGeometry protected () extends Packable {
  def this(options: Anon_EllipsoidExtrudedHeightGranularityHeightRectangleRotation) = this()
}
