...
object BlendEquation extends js.Object {
  ...
  /* 0 */ val ADD: typingsSlinky.cesium.cesiumMod.BlendEquation.ADD with Double = js.native
  /* 2 */ val REVERSE_SUBTRACT: typingsSlinky.cesium.cesiumMod.BlendEquation.REVERSE_SUBTRACT with Double = js.native
  /* 1 */ val SUBTRACT: typingsSlinky.cesium.cesiumMod.BlendEquation.SUBTRACT with Double = js.native
  @JSBracketAccess
