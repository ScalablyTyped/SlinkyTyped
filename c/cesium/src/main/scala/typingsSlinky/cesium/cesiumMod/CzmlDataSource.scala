...
import typingsSlinky.cesium.Anon_SourceUri
...
class CzmlDataSource () extends DataSource {
  ...
  def load(czml: String, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
  def load(czml: js.Object): js.Promise[CzmlDataSource] = js.native
  def load(czml: js.Object, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
  def load(czml: Resource): js.Promise[CzmlDataSource] = js.native
  def load(czml: Resource, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
  def process(czml: String): js.Promise[CzmlDataSource] = js.native
  def process(czml: String, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
  def process(czml: js.Object): js.Promise[CzmlDataSource] = js.native
  def process(czml: js.Object, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
  def process(czml: Resource): js.Promise[CzmlDataSource] = js.native
  def process(czml: Resource, options: Anon_SourceUri): js.Promise[CzmlDataSource] = js.native
}
