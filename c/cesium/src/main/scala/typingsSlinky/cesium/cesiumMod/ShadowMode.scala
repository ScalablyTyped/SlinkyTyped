...
object ShadowMode extends js.Object {
  ...
  /* 0 */ val CAST_ONLY: typingsSlinky.cesium.cesiumMod.ShadowMode.CAST_ONLY with Double = js.native
  /* 1 */ val DISABLED: typingsSlinky.cesium.cesiumMod.ShadowMode.DISABLED with Double = js.native
  /* 2 */ val ENABLED: typingsSlinky.cesium.cesiumMod.ShadowMode.ENABLED with Double = js.native
  /* 3 */ val RECEIVE_ONLY: typingsSlinky.cesium.cesiumMod.ShadowMode.RECEIVE_ONLY with Double = js.native
  @JSBracketAccess
