...
trait ComponentDatatype extends js.Object {
  var componentDatatype: js.UndefOr[typingsSlinky.cesium.mod.ComponentDatatype] = js.undefined
...
object ComponentDatatype {
  @scala.inline
  def apply(
    componentDatatype: typingsSlinky.cesium.mod.ComponentDatatype = null,
