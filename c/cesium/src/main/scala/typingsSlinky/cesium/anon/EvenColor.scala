...
object EvenColor {
  ...
  implicit class EvenColorOps[Self <: EvenColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvenColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("evenColor", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEvenColor: Self = this.set("evenColor", js.undefined)
    @scala.inline
    def setOddColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("oddColor", value.asInstanceOf[js.Any])
    @scala.inline
