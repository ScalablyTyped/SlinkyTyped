...
object ClassificationType {
  ...
  implicit class ClassificationTypeOps[Self <: ClassificationType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHierarchy(value: Property | js.Array[Cartesian3] | typingsSlinky.cesium.mod.PolygonHierarchy): Self = this.set("hierarchy", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOutlineColor(value: Property | typingsSlinky.cesium.mod.Color): Self = this.set("outlineColor", value.asInstanceOf[js.Any])
    @scala.inline
