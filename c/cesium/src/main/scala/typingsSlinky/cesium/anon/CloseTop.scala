...
object CloseTop {
  ...
  @scala.inline
  implicit class CloseTopMutableBuilder[Self <: CloseTop] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCloseBottom(value: Property): Self = StObject.set(x, "closeBottom", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCloseBottomUndefined: Self = StObject.set(x, "closeBottom", js.undefined)
    
    @scala.inline
    def setCloseTop(value: Property): Self = StObject.set(x, "closeTop", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCloseTopUndefined: Self = StObject.set(x, "closeTop", js.undefined)
    
    @scala.inline
    def setCoordinates(value: Property): Self = StObject.set(x, "coordinates", value.asInstanceOf[js.Any])
