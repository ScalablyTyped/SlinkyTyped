...
object Articulations {
  ...
  implicit class ArticulationsOps[Self <: Articulations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: Property | typingsSlinky.cesium.mod.Color): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDistanceDisplayCondition(value: Property | typingsSlinky.cesium.mod.DistanceDisplayCondition): Self = this.set("distanceDisplayCondition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSilhouetteColor(value: Property | typingsSlinky.cesium.mod.Color): Self = this.set("silhouetteColor", value.asInstanceOf[js.Any])
