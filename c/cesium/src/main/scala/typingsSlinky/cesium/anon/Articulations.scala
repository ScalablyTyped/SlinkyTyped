...
object Articulations {
  ...
  implicit class ArticulationsOps[Self <: Articulations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColor(value: Property | typingsSlinky.cesium.mod.Color): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDistanceDisplayCondition(value: Property | typingsSlinky.cesium.mod.DistanceDisplayCondition): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSilhouetteColor(value: Property | typingsSlinky.cesium.mod.Color): Self = {
        val ret = this.duplicate
