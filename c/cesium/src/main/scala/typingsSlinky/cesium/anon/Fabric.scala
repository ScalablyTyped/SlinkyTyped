...
object Fabric {
  ...
  implicit class FabricOps[Self <: Fabric] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTranslucentFunction1(value: /* material */ typingsSlinky.cesium.mod.Material => Boolean): Self = this.set("translucent", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTranslucent(value: Boolean | (js.Function1[/* material */ typingsSlinky.cesium.mod.Material, Boolean])): Self = this.set("translucent", value.asInstanceOf[js.Any])
