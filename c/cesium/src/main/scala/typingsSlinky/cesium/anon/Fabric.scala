...
object Fabric {
  ...
  implicit class FabricMutableBuilder[Self <: Fabric] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTranslucent(value: Boolean | (js.Function1[/* material */ typingsSlinky.cesium.mod.Material, Boolean])): Self = StObject.set(x, "translucent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTranslucentFunction1(value: /* material */ typingsSlinky.cesium.mod.Material => Boolean): Self = StObject.set(x, "translucent", js.Any.fromFunction1(value))
