...
object ChildTileMask {
  ...
  implicit class ChildTileMaskOps[Self <: ChildTileMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreditsVarargs(value: typingsSlinky.cesium.mod.Credit*): Self = this.set("credits", js.Array(value :_*))
    @scala.inline
    def setCredits(value: js.Array[typingsSlinky.cesium.mod.Credit]): Self = this.set("credits", value.asInstanceOf[js.Any])
    @scala.inline
