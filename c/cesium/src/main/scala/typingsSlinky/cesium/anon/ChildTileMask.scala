...
object ChildTileMask {
  ...
  implicit class ChildTileMaskMutableBuilder[Self <: ChildTileMask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCredits(value: js.Array[typingsSlinky.cesium.mod.Credit]): Self = StObject.set(x, "credits", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreditsUndefined: Self = StObject.set(x, "credits", js.undefined)
    
    @scala.inline
    def setCreditsVarargs(value: typingsSlinky.cesium.mod.Credit*): Self = StObject.set(x, "credits", js.Array(value :_*))
