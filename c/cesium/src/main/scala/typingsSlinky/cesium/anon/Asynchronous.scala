...
trait Asynchronous extends js.Object {
  ...
  var credit: js.UndefOr[typingsSlinky.cesium.mod.Credit] = js.undefined
  var debugShowBoundingVolume: js.UndefOr[Boolean] = js.undefined
  var debugWireframe: js.UndefOr[Boolean] = js.undefined
  var dequantizeInShader: js.UndefOr[Boolean] = js.undefined
  var distanceDisplayCondition: js.UndefOr[typingsSlinky.cesium.mod.DistanceDisplayCondition] = js.undefined
  ...
  var scene: js.UndefOr[typingsSlinky.cesium.mod.Scene] = js.undefined
  var shadows: js.UndefOr[ShadowMode] = js.undefined
  var show: js.UndefOr[Boolean] = js.undefined
  var silhouetteColor: js.UndefOr[typingsSlinky.cesium.mod.Color] = js.undefined
...
object Asynchronous {
  ...
  def apply(
    ...
    credit: typingsSlinky.cesium.mod.Credit = null,
    ...
    distanceDisplayCondition: typingsSlinky.cesium.mod.DistanceDisplayCondition = null,
    ...
    scene: typingsSlinky.cesium.mod.Scene = null,
    shadows: ShadowMode = null,
    show: js.UndefOr[Boolean] = js.undefined,
    silhouetteColor: typingsSlinky.cesium.mod.Color = null,
