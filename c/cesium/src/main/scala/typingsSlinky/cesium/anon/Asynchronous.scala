...
trait Asynchronous extends StObject {
  ...
  var credit: js.UndefOr[typingsSlinky.cesium.mod.Credit] = js.native
...
object Asynchronous {
  ...
  implicit class AsynchronousMutableBuilder[Self <: Asynchronous] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCredit(value: typingsSlinky.cesium.mod.Credit): Self = StObject.set(x, "credit", value.asInstanceOf[js.Any])
