...
object BackgroundColor {
  ...
  implicit class BackgroundColorOps[Self <: BackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDistanceDisplayCondition(value: typingsSlinky.cesium.mod.DistanceDisplayCondition | Property): Self = this.set("distanceDisplayCondition", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFillColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("fillColor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOutlineColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("outlineColor", value.asInstanceOf[js.Any])
    @scala.inline
