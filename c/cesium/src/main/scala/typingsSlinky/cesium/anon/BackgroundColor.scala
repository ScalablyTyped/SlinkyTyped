...
import typingsSlinky.cesium.mod.LabelStyle
import typingsSlinky.cesium.mod.Property
import typingsSlinky.cesium.mod.VerticalOrigin
...
trait BackgroundColor extends StObject {
  ...
  var distanceDisplayCondition: js.UndefOr[typingsSlinky.cesium.mod.DistanceDisplayCondition | Property] = js.native
...
object BackgroundColor {
  ...
  implicit class BackgroundColorMutableBuilder[Self <: BackgroundColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDistanceDisplayCondition(value: typingsSlinky.cesium.mod.DistanceDisplayCondition | Property): Self = StObject.set(x, "distanceDisplayCondition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFillColor(value: typingsSlinky.cesium.mod.Color): Self = StObject.set(x, "fillColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOutlineColor(value: typingsSlinky.cesium.mod.Color): Self = StObject.set(x, "outlineColor", value.asInstanceOf[js.Any])
