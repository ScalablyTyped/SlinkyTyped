...
trait CanvasSize extends js.Object {
  ...
  var glowColor: js.UndefOr[typingsSlinky.cesium.mod.Color] = js.native
...
object CanvasSize {
  ...
  implicit class CanvasSizeOps[Self <: CanvasSize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGlowColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("glowColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTilingScheme(value: typingsSlinky.cesium.mod.TilingScheme): Self = this.set("tilingScheme", value.asInstanceOf[js.Any])
