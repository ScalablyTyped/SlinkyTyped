...
object DebugShowShadowVolume {
  ...
  implicit class DebugShowShadowVolumeOps[Self <: DebugShowShadowVolume] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppearance(value: typingsSlinky.cesium.mod.Appearance): Self = this.set("appearance", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setClassificationType(value: typingsSlinky.cesium.mod.ClassificationType): Self = this.set("classificationType", value.asInstanceOf[js.Any])
    @scala.inline
