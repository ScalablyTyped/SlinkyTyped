...
trait DebugShowShadowVolume extends js.Object {
  ...
  var appearance: js.UndefOr[typingsSlinky.cesium.mod.Appearance] = js.undefined
  var asynchronous: js.UndefOr[Boolean] = js.undefined
  var classificationType: js.UndefOr[typingsSlinky.cesium.mod.ClassificationType] = js.undefined
...
object DebugShowShadowVolume {
  ...
  def apply(
    ...
    appearance: typingsSlinky.cesium.mod.Appearance = null,
    asynchronous: js.UndefOr[Boolean] = js.undefined,
    classificationType: typingsSlinky.cesium.mod.ClassificationType = null,
