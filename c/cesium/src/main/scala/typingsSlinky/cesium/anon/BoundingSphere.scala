...
object BoundingSphere {
  ...
  implicit class BoundingSphereOps[Self <: BoundingSphere] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuantizedVertices(value: js.typedarray.Uint16Array): Self = this.set("quantizedVertices", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEncodedNormals(value: js.typedarray.Uint8Array): Self = this.set("encodedNormals", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEncodedNormals: Self = this.set("encodedNormals", js.undefined)
    @scala.inline
    def setWaterMask(value: js.typedarray.Uint8Array): Self = this.set("waterMask", value.asInstanceOf[js.Any])
    @scala.inline
