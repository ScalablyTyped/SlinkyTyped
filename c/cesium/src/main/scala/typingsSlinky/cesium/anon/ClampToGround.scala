...
object ClampToGround {
  ...
  implicit class ClampToGroundOps[Self <: ClampToGround] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFill(value: typingsSlinky.cesium.mod.Color): Self = this.set("fill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFill: Self = this.set("fill", js.undefined)
    
    @scala.inline
    def setMarkerColor(value: typingsSlinky.cesium.mod.Color): Self = this.set("markerColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStroke(value: typingsSlinky.cesium.mod.Color): Self = this.set("stroke", value.asInstanceOf[js.Any])
