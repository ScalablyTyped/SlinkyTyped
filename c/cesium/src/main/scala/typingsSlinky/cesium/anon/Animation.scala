...
object Animation {
  ...
  implicit class AnimationOps[Self <: Animation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreditContainerElement(value: Element): Self = this.set("creditContainer", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCreditViewportElement(value: Element): Self = this.set("creditViewport", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataSources(value: typingsSlinky.cesium.mod.DataSourceCollection): Self = this.set("dataSources", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFullscreenElementElement(value: Element): Self = this.set("fullscreenElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGlobe(value: typingsSlinky.cesium.mod.Globe | `false`): Self = this.set("globe", value.asInstanceOf[js.Any])
    @scala.inline
