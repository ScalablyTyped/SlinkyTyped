...
trait Animation extends StObject {
  ...
  var dataSources: js.UndefOr[typingsSlinky.cesium.mod.DataSourceCollection] = js.native
...
object Animation {
  ...
  implicit class AnimationMutableBuilder[Self <: Animation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreditContainerElement(value: Element): Self = StObject.set(x, "creditContainer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCreditViewportElement(value: Element): Self = StObject.set(x, "creditViewport", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreditViewportUndefined: Self = StObject.set(x, "creditViewport", js.undefined)
    
    @scala.inline
    def setDataSources(value: typingsSlinky.cesium.mod.DataSourceCollection): Self = StObject.set(x, "dataSources", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFullscreenElementElement(value: Element): Self = StObject.set(x, "fullscreenElement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGlobe(value: typingsSlinky.cesium.mod.Globe | `false`): Self = StObject.set(x, "globe", value.asInstanceOf[js.Any])
