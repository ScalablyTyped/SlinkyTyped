...
object ArcType {
  ...
  implicit class ArcTypeMutableBuilder[Self <: ArcType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColors(value: js.Array[typingsSlinky.cesium.mod.Color]): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColorsVarargs(value: typingsSlinky.cesium.mod.Color*): Self = StObject.set(x, "colors", js.Array(value :_*))
