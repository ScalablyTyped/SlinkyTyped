...
object ArcType {
  ...
  implicit class ArcTypeOps[Self <: ArcType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArcType(value: typingsSlinky.cesium.mod.ArcType): Self = this.set("arcType", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteArcType: Self = this.set("arcType", js.undefined)
    @scala.inline
    def setColorsVarargs(value: typingsSlinky.cesium.mod.Color*): Self = this.set("colors", js.Array(value :_*))
    @scala.inline
    def setColors(value: js.Array[typingsSlinky.cesium.mod.Color]): Self = this.set("colors", value.asInstanceOf[js.Any])
    @scala.inline
