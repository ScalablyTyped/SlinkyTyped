...
trait ArcType extends js.Object {
  var arcType: js.UndefOr[typingsSlinky.cesium.mod.ArcType] = js.undefined
  var colors: js.UndefOr[js.Array[typingsSlinky.cesium.mod.Color]] = js.undefined
...
object ArcType {
  ...
  def apply(
    ...
    arcType: typingsSlinky.cesium.mod.ArcType = null,
    colors: js.Array[typingsSlinky.cesium.mod.Color] = null,
