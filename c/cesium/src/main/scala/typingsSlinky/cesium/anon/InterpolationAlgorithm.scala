...
object InterpolationAlgorithm {
  ...
  implicit class InterpolationAlgorithmMutableBuilder[Self <: InterpolationAlgorithm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInterpolationAlgorithm(value: typingsSlinky.cesium.mod.InterpolationAlgorithm): Self = StObject.set(x, "interpolationAlgorithm", value.asInstanceOf[js.Any])
