...
trait EdgeColor extends StObject {
  ...
  var edgeColor: js.UndefOr[typingsSlinky.cesium.mod.Color] = js.native
...
object EdgeColor {
  ...
  implicit class EdgeColorMutableBuilder[Self <: EdgeColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEdgeColor(value: typingsSlinky.cesium.mod.Color): Self = StObject.set(x, "edgeColor", value.asInstanceOf[js.Any])
