...
trait ClearColor extends StObject {
  ...
  var clearColor: js.UndefOr[typingsSlinky.cesium.mod.Color] = js.native
...
object ClearColor {
  ...
  implicit class ClearColorMutableBuilder[Self <: ClearColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClearColor(value: typingsSlinky.cesium.mod.Color): Self = StObject.set(x, "clearColor", value.asInstanceOf[js.Any])
