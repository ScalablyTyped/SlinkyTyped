...
object AnonFirstInnerQuadrangle {
  @scala.inline
  def apply(points: js.Array[Quaternion], times: js.Array[Double]): AnonFirstInnerQuadrangle = {
  ...
  @scala.inline
  implicit class AnonFirstInnerQuadrangleOps[Self <: AnonFirstInnerQuadrangle] (val x: Self) extends AnyVal {
    @scala.inline
