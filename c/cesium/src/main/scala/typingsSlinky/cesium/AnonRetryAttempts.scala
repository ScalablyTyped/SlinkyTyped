...
@js.native
trait AnonRetryAttempts extends js.Object {
...
object AnonRetryAttempts {
  @scala.inline
  def apply(url: String): AnonRetryAttempts = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRetryAttempts]
  }
  @scala.inline
  implicit class AnonRetryAttemptsOps[Self <: AnonRetryAttempts] (val x: Self) extends AnyVal {
    @scala.inline
