...
@js.native
trait AnonClusterBillboards extends js.Object {
...
object AnonClusterBillboards {
  @scala.inline
  def apply(): AnonClusterBillboards = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonClusterBillboards]
  }
  @scala.inline
  implicit class AnonClusterBillboardsOps[Self <: AnonClusterBillboards] (val x: Self) extends AnyVal {
    @scala.inline
