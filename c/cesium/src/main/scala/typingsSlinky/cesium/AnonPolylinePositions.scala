...
object AnonPolylinePositions {
  @scala.inline
  def apply(polylinePositions: js.Array[Cartesian3], shapePositions: js.Array[Cartesian2]): AnonPolylinePositions = {
  ...
  @scala.inline
  implicit class AnonPolylinePositionsOps[Self <: AnonPolylinePositions] (val x: Self) extends AnyVal {
    @scala.inline
