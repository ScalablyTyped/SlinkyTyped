...
trait AnonPreferBlob extends js.Object {
  ...
  var preferBlob: js.UndefOr[Boolean] = js.native
...
object AnonPreferBlob {
  @scala.inline
  def apply(url: String): AnonPreferBlob = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonPreferBlob]
  }
  @scala.inline
  implicit class AnonPreferBlobOps[Self <: AnonPreferBlob] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withPreferBlob(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preferBlob")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPreferBlob: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("preferBlob")(js.undefined)
        ret
    }
    @scala.inline
