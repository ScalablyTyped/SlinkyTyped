...
@js.native
trait AnonComponentsPerAttribute extends js.Object {
...
object AnonComponentsPerAttribute {
  @scala.inline
  def apply(): AnonComponentsPerAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonComponentsPerAttribute]
  }
  @scala.inline
  implicit class AnonComponentsPerAttributeOps[Self <: AnonComponentsPerAttribute] (val x: Self) extends AnyVal {
    @scala.inline
