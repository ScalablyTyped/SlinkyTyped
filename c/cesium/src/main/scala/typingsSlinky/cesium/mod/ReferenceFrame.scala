...
object ReferenceFrame extends StObject {
  ...
  /* 0 */ val FIXED: typingsSlinky.cesium.mod.ReferenceFrame.FIXED with Double = js.native
  
  @js.native
  sealed trait INERTIAL extends ReferenceFrame
  /* 1 */ val INERTIAL: typingsSlinky.cesium.mod.ReferenceFrame.INERTIAL with Double = js.native
}
