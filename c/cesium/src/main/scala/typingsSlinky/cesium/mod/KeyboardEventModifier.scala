...
object KeyboardEventModifier extends StObject {
  ...
  /* 2 */ val ALT: typingsSlinky.cesium.mod.KeyboardEventModifier.ALT with Double = js.native
  
  @js.native
  sealed trait CTRL extends KeyboardEventModifier
  /* 1 */ val CTRL: typingsSlinky.cesium.mod.KeyboardEventModifier.CTRL with Double = js.native
  
  @js.native
  sealed trait SHIFT extends KeyboardEventModifier
  /* 0 */ val SHIFT: typingsSlinky.cesium.mod.KeyboardEventModifier.SHIFT with Double = js.native
}
