...
object Cesium3DTileColorBlendMode extends StObject {
  ...
  /* 0 */ val HIGHLIGHT: typingsSlinky.cesium.mod.Cesium3DTileColorBlendMode.HIGHLIGHT with Double = js.native
  
  @js.native
  sealed trait MIX extends Cesium3DTileColorBlendMode
  /* 2 */ val MIX: typingsSlinky.cesium.mod.Cesium3DTileColorBlendMode.MIX with Double = js.native
  
  @js.native
  sealed trait REPLACE extends Cesium3DTileColorBlendMode
  /* 1 */ val REPLACE: typingsSlinky.cesium.mod.Cesium3DTileColorBlendMode.REPLACE with Double = js.native
}
