...
object Intersect extends StObject {
  ...
  /* 2 */ val INSIDE: typingsSlinky.cesium.mod.Intersect.INSIDE with Double = js.native
  
  @js.native
  sealed trait INTERSECTING extends Intersect
  /* 1 */ val INTERSECTING: typingsSlinky.cesium.mod.Intersect.INTERSECTING with Double = js.native
  
  @js.native
  sealed trait OUTSIDE extends Intersect
  /* 0 */ val OUTSIDE: typingsSlinky.cesium.mod.Intersect.OUTSIDE with Double = js.native
}
