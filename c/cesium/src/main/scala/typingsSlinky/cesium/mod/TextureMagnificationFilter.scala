...
object TextureMagnificationFilter extends StObject {
  ...
  /* 0 */ val LINEAR: typingsSlinky.cesium.mod.TextureMagnificationFilter.LINEAR with Double = js.native
  
  @js.native
  sealed trait NEAREST extends TextureMagnificationFilter
  /* 1 */ val NEAREST: typingsSlinky.cesium.mod.TextureMagnificationFilter.NEAREST with Double = js.native
}
