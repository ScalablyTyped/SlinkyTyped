...
object Iso8601 extends StObject {
  ...
  /* 2 */ val MAXIMUM_INTERVAL: typingsSlinky.cesium.mod.Iso8601.MAXIMUM_INTERVAL with Double = js.native
  
  @js.native
  sealed trait MAXIMUM_VALUE extends Iso8601
  /* 1 */ val MAXIMUM_VALUE: typingsSlinky.cesium.mod.Iso8601.MAXIMUM_VALUE with Double = js.native
  
  @js.native
  sealed trait MINIMUM_VALUE extends Iso8601
  /* 0 */ val MINIMUM_VALUE: typingsSlinky.cesium.mod.Iso8601.MINIMUM_VALUE with Double = js.native
}
