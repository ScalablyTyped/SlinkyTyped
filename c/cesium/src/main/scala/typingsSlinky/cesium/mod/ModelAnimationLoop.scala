...
object ModelAnimationLoop extends StObject {
  ...
  /* 2 */ val MIRRORED_REPEAT: typingsSlinky.cesium.mod.ModelAnimationLoop.MIRRORED_REPEAT with Double = js.native
  
  @js.native
  sealed trait NONE extends ModelAnimationLoop
  /* 0 */ val NONE: typingsSlinky.cesium.mod.ModelAnimationLoop.NONE with Double = js.native
  
  @js.native
  sealed trait REPEAT extends ModelAnimationLoop
  /* 1 */ val REPEAT: typingsSlinky.cesium.mod.ModelAnimationLoop.REPEAT with Double = js.native
}
