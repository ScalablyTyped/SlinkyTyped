...
import typingsSlinky.cesium.anon.FaceForward
...
object MaterialAppearance {
  ...
  object MaterialSupport extends StObject {
    ...
    /* 2 */ val ALL: typingsSlinky.cesium.mod.MaterialAppearance.MaterialSupport.ALL with Double = js.native
    
    @js.native
    sealed trait BASIC extends MaterialSupport
    /* 0 */ val BASIC: typingsSlinky.cesium.mod.MaterialAppearance.MaterialSupport.BASIC with Double = js.native
    
    @js.native
    sealed trait TEXTURED extends MaterialSupport
    /* 1 */ val TEXTURED: typingsSlinky.cesium.mod.MaterialAppearance.MaterialSupport.TEXTURED with Double = js.native
  }
}
