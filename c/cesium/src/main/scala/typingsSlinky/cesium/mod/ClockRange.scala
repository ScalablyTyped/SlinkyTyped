...
object ClockRange extends StObject {
  ...
  /* 1 */ val CLAMPED: typingsSlinky.cesium.mod.ClockRange.CLAMPED with Double = js.native
  
  @js.native
  sealed trait LOOP_STOP extends ClockRange
  /* 2 */ val LOOP_STOP: typingsSlinky.cesium.mod.ClockRange.LOOP_STOP with Double = js.native
  
  @js.native
  sealed trait UNBOUNDED extends ClockRange
  /* 0 */ val UNBOUNDED: typingsSlinky.cesium.mod.ClockRange.UNBOUNDED with Double = js.native
}
