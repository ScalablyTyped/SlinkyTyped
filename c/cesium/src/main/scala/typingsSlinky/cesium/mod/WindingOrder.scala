...
object WindingOrder extends StObject {
  ...
  /* 0 */ val CLOCKWISE: typingsSlinky.cesium.mod.WindingOrder.CLOCKWISE with Double = js.native
  
  @js.native
  sealed trait COUNTER_CLOCKWISE extends WindingOrder
  /* 1 */ val COUNTER_CLOCKWISE: typingsSlinky.cesium.mod.WindingOrder.COUNTER_CLOCKWISE with Double = js.native
}
