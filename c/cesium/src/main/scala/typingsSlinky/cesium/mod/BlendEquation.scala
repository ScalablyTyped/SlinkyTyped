...
object BlendEquation extends StObject {
  ...
  /* 0 */ val ADD: typingsSlinky.cesium.mod.BlendEquation.ADD with Double = js.native
  
  @js.native
  sealed trait REVERSE_SUBTRACT extends BlendEquation
  /* 2 */ val REVERSE_SUBTRACT: typingsSlinky.cesium.mod.BlendEquation.REVERSE_SUBTRACT with Double = js.native
  
  @js.native
  sealed trait SUBTRACT extends BlendEquation
  /* 1 */ val SUBTRACT: typingsSlinky.cesium.mod.BlendEquation.SUBTRACT with Double = js.native
}
