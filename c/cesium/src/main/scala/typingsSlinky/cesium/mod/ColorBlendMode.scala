...
object ColorBlendMode extends StObject {
  ...
  /* 0 */ val HIGHLIGHT: typingsSlinky.cesium.mod.ColorBlendMode.HIGHLIGHT with Double = js.native
  
  @js.native
  sealed trait MIX extends ColorBlendMode
  /* 2 */ val MIX: typingsSlinky.cesium.mod.ColorBlendMode.MIX with Double = js.native
  
  @js.native
  sealed trait REPLACE extends ColorBlendMode
  /* 1 */ val REPLACE: typingsSlinky.cesium.mod.ColorBlendMode.REPLACE with Double = js.native
}
