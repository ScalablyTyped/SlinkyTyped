...
object SceneMode extends StObject {
  ...
  /* 1 */ val COLUMBUS_VIEW: typingsSlinky.cesium.mod.SceneMode.COLUMBUS_VIEW with Double = js.native
  
  @js.native
  sealed trait MORPHING extends SceneMode
  /* 0 */ val MORPHING: typingsSlinky.cesium.mod.SceneMode.MORPHING with Double = js.native
  
  @js.native
  sealed trait SCENE2D extends SceneMode
  /* 2 */ val SCENE2D: typingsSlinky.cesium.mod.SceneMode.SCENE2D with Double = js.native
  
  @js.native
  sealed trait SCENE3D extends SceneMode
  /* 3 */ val SCENE3D: typingsSlinky.cesium.mod.SceneMode.SCENE3D with Double = js.native
