...
object ArcType extends StObject {
  ...
  /* 1 */ val GEODESIC: typingsSlinky.cesium.mod.ArcType.GEODESIC with Double = js.native
  
  @js.native
  sealed trait NONE extends ArcType
  /* 0 */ val NONE: typingsSlinky.cesium.mod.ArcType.NONE with Double = js.native
  
  @js.native
  sealed trait RHUMB extends ArcType
  /* 2 */ val RHUMB: typingsSlinky.cesium.mod.ArcType.RHUMB with Double = js.native
}
