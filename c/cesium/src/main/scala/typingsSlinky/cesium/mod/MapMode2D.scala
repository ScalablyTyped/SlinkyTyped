...
object MapMode2D extends StObject {
  ...
  /* 0 */ val INFINITE_SCROLL: typingsSlinky.cesium.mod.MapMode2D.INFINITE_SCROLL with Double = js.native
  
  @js.native
  sealed trait ROTATE extends MapMode2D
  /* 1 */ val ROTATE: typingsSlinky.cesium.mod.MapMode2D.ROTATE with Double = js.native
}
