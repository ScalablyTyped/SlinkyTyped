...
object CornerType extends StObject {
  ...
  /* 2 */ val BEVELED: typingsSlinky.cesium.mod.CornerType.BEVELED with Double = js.native
  
  @js.native
  sealed trait MITERED extends CornerType
  /* 1 */ val MITERED: typingsSlinky.cesium.mod.CornerType.MITERED with Double = js.native
  
  @js.native
  sealed trait ROUNDED extends CornerType
  /* 0 */ val ROUNDED: typingsSlinky.cesium.mod.CornerType.ROUNDED with Double = js.native
}
