...
object Fullscreen extends StObject {
  ...
  /* 1 */ val changeEventName: typingsSlinky.cesium.mod.Fullscreen.changeEventName with Double = js.native
  
  @js.native
  sealed trait element extends Fullscreen
  /* 0 */ val element: typingsSlinky.cesium.mod.Fullscreen.element with Double = js.native
  
  @js.native
  sealed trait enabled extends Fullscreen
  /* 3 */ val enabled: typingsSlinky.cesium.mod.Fullscreen.enabled with Double = js.native
  
  @js.native
  sealed trait errorEventName extends Fullscreen
  /* 2 */ val errorEventName: typingsSlinky.cesium.mod.Fullscreen.errorEventName with Double = js.native
  
  def exitFullscreen(): js.UndefOr[scala.Nothing] = js.native
  
  @js.native
  sealed trait fullscreen extends Fullscreen
  /* 4 */ val fullscreen: typingsSlinky.cesium.mod.Fullscreen.fullscreen with Double = js.native
