...
object CullFace extends StObject {
  ...
  /* 1 */ val BACK: typingsSlinky.cesium.mod.CullFace.BACK with Double = js.native
  
  @js.native
  sealed trait FRONT extends CullFace
  /* 0 */ val FRONT: typingsSlinky.cesium.mod.CullFace.FRONT with Double = js.native
  
  @js.native
  sealed trait FRONT_AND_BACK extends CullFace
  /* 2 */ val FRONT_AND_BACK: typingsSlinky.cesium.mod.CullFace.FRONT_AND_BACK with Double = js.native
}
