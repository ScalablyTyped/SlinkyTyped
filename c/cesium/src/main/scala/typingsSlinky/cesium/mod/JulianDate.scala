...
object JulianDate extends js.Object {
  ...
  def fromDate(date: js.Date): JulianDate = js.native
  def fromDate(date: js.Date, result: JulianDate): JulianDate = js.native
  ...
  def toDate(julianDate: JulianDate): js.Date = js.native
