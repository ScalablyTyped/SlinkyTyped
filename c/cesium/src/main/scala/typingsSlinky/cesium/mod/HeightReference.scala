...
object HeightReference extends StObject {
  ...
  /* 0 */ val CLAMP_TO_GROUND: typingsSlinky.cesium.mod.HeightReference.CLAMP_TO_GROUND with Double = js.native
  
  @js.native
  sealed trait NONE extends HeightReference
  /* 1 */ val NONE: typingsSlinky.cesium.mod.HeightReference.NONE with Double = js.native
  
  @js.native
  sealed trait RELATIVE_TO_GROUND extends HeightReference
  /* 2 */ val RELATIVE_TO_GROUND: typingsSlinky.cesium.mod.HeightReference.RELATIVE_TO_GROUND with Double = js.native
}
