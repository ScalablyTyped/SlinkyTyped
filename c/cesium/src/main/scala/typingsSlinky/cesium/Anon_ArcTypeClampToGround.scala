...
trait Anon_ArcTypeClampToGround extends js.Object {
...
object Anon_ArcTypeClampToGround {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_ArcTypeClampToGround]
  }
}
