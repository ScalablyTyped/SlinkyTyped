...
@js.native
trait AnonCreditContainer extends js.Object {
...
object AnonCreditContainer {
  @scala.inline
  def apply(): AnonCreditContainer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonCreditContainer]
  }
  @scala.inline
  implicit class AnonCreditContainerOps[Self <: AnonCreditContainer] (val x: Self) extends AnyVal {
    @scala.inline
