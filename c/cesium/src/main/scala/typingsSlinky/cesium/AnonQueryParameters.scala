...
@js.native
trait AnonQueryParameters extends js.Object {
...
object AnonQueryParameters {
  @scala.inline
  def apply(url: String): AnonQueryParameters = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQueryParameters]
  }
  @scala.inline
  implicit class AnonQueryParametersOps[Self <: AnonQueryParameters] (val x: Self) extends AnyVal {
    @scala.inline
