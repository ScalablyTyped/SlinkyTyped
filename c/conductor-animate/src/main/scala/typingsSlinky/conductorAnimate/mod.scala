package typingsSlinky.conductorAnimate
...
object mod {
  ...
  object AnimatedProps {
    ...
    implicit class AnimatedPropsMutableBuilder[Self <: AnimatedProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: ReactElement | ReactNodeArray): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
  ...
  type Animations = StringDictionary[ReactComponentClass[js.Any]]
