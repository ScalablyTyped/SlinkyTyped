...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExclude(value: js.RegExp): Self = this.set("exclude", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInclude(value: js.RegExp): Self = this.set("include", value.asInstanceOf[js.Any])
