...
object PositionStickiness {
  ...
  @scala.inline
  def toNext: typingsSlinky.atCkeditorCkeditor5DashEngine.atCkeditorCkeditor5DashEngineStrings.toNext = this.cast("toNext")
  @scala.inline
  def toNone: typingsSlinky.atCkeditorCkeditor5DashEngine.atCkeditorCkeditor5DashEngineStrings.toNone = this.cast("toNone")
  @scala.inline
  def toPrevious: typingsSlinky.atCkeditorCkeditor5DashEngine.atCkeditorCkeditor5DashEngineStrings.toPrevious = this.cast("toPrevious")
}
