...
object TreeWalkerDirection {
  @scala.inline
  def backward: typingsSlinky.atCkeditorCkeditor5DashEngine.atCkeditorCkeditor5DashEngineStrings.backward = this.cast("backward")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def forward: typingsSlinky.atCkeditorCkeditor5DashEngine.atCkeditorCkeditor5DashEngineStrings.forward = this.cast("forward")
}
