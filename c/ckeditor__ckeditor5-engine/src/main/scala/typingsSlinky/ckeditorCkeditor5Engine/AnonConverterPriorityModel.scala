...
object AnonConverterPriorityModel {
  @scala.inline
  def apply(model: String | Element | js.Function, view: MatcherPattern): AnonConverterPriorityModel = {
    val __obj = js.Dynamic.literal(model = model.asInstanceOf[js.Any], view = view.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonConverterPriorityModel]
  }
  @scala.inline
  implicit class AnonConverterPriorityModelOps[Self <: AnonConverterPriorityModel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withViewFunction1(
      value: /* element */ typingsSlinky.ckeditorCkeditor5Engine.mod.view.Element => Null | AnonAttribute
    ): Self = {
        val ret = this.duplicate
