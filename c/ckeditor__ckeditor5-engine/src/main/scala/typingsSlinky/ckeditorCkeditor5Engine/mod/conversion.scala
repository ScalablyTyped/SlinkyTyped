...
object conversion {
  ...
  class ModelConsumable () extends StObject {
    ...
    def add(item: typingsSlinky.ckeditorCkeditor5Engine.mod.model.Range, `type`: String): Unit = js.native
    def add(item: Selection, `type`: String): Unit = js.native
    
    def consume(item: Item, `type`: String): Boolean = js.native
    def consume(item: typingsSlinky.ckeditorCkeditor5Engine.mod.model.Range, `type`: String): Boolean = js.native
    def consume(item: Selection, `type`: String): Boolean = js.native
    
    def revert(item: Item, `type`: String): Null | Boolean = js.native
    def revert(item: typingsSlinky.ckeditorCkeditor5Engine.mod.model.Range, `type`: String): Null | Boolean = js.native
    def revert(item: Selection, `type`: String): Null | Boolean = js.native
    
    def test(item: Item, `type`: String): Null | Boolean = js.native
    def test(item: typingsSlinky.ckeditorCkeditor5Engine.mod.model.Range, `type`: String): Null | Boolean = js.native
  ...
  @js.native
  def convertSelectionChange(model: typingsSlinky.ckeditorCkeditor5Engine.mod.model.Model, mapper: Mapper): js.Function = js.native
  ...
  object ConverterDefinition {
    ...
    implicit class ConverterDefinitionMutableBuilder[Self <: ConverterDefinition] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUpcastAlsoRegExp(value: js.RegExp): Self = StObject.set(x, "upcastAlso", value.asInstanceOf[js.Any])
