...
import typingsSlinky.ckeditorCkeditor5Engine.mod.model.PositionRelation
import typingsSlinky.ckeditorCkeditor5Engine.mod.model.PositionStickiness
import typingsSlinky.ckeditorCkeditor5Engine.mod.model.TreeWalkerValueType
import typingsSlinky.ckeditorCkeditor5Engine.mod.view.ChangeType
...
object ckeditorCkeditor5EngineStrings {
  ...
  sealed trait after
    extends PositionRelation
       with typingsSlinky.ckeditorCkeditor5Engine.mod.view.PositionRelation
  ...
  sealed trait different
    extends typingsSlinky.ckeditorCkeditor5Engine.mod.view.PositionRelation
  ...
  sealed trait elementEnd
    extends TreeWalkerValueType
       with typingsSlinky.ckeditorCkeditor5Engine.mod.view.TreeWalkerValueType
