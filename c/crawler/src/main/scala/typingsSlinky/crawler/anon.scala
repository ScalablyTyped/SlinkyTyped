package typingsSlinky.crawler

import typingsSlinky.crawler.mod.CrawlerRequestOptions
import typingsSlinky.crawler.mod.CrawlerRequestResponse
...
object anon {
  ...
  trait OmitCrawlerRequestOptions extends StObject {
    ...
    def callback(error: js.Error, response: CrawlerRequestResponse): Unit = js.native
  ...
  object OmitCrawlerRequestOptions {
    ...
    @scala.inline
    def apply(callback: (js.Error, CrawlerRequestResponse) => Unit): OmitCrawlerRequestOptions = {
    ...
    implicit class OmitCrawlerRequestOptionsMutableBuilder[Self <: OmitCrawlerRequestOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCallback(value: (js.Error, CrawlerRequestResponse) => Unit): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
