package typingsSlinky.cucumber.cucumberMod.pickle
...
trait Pickle extends js.Object {
  ...
  var name: String
  var steps: js.Array[typingsSlinky.cucumber.cucumberMod.pickle.Step]
  var tags: js.Array[typingsSlinky.cucumber.cucumberMod.pickle.Tag]
}
...
object Pickle {
  ...
  def apply(
    ...
    name: String,
    steps: js.Array[typingsSlinky.cucumber.cucumberMod.pickle.Step],
    tags: js.Array[typingsSlinky.cucumber.cucumberMod.pickle.Tag]
  ): Pickle = {
