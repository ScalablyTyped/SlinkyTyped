...
object pickle {
  ...
  trait Pickle extends StObject {
    ...
    var steps: js.Array[typingsSlinky.cucumber.mod.pickle.Step] = js.native
    
    var tags: js.Array[typingsSlinky.cucumber.mod.pickle.Tag] = js.native
  }
  object Pickle {
    ...
    def apply(
      ...
      name: String,
      steps: js.Array[typingsSlinky.cucumber.mod.pickle.Step],
      tags: js.Array[typingsSlinky.cucumber.mod.pickle.Tag]
    ): Pickle = {
    ...
    implicit class PickleMutableBuilder[Self <: Pickle] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSteps(value: js.Array[typingsSlinky.cucumber.mod.pickle.Step]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStepsVarargs(value: typingsSlinky.cucumber.mod.pickle.Step*): Self = StObject.set(x, "steps", js.Array(value :_*))
      
      @scala.inline
      def setTags(value: js.Array[typingsSlinky.cucumber.mod.pickle.Tag]): Self = StObject.set(x, "tags", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTagsVarargs(value: typingsSlinky.cucumber.mod.pickle.Tag*): Self = StObject.set(x, "tags", js.Array(value :_*))
    }
  }
  ...
  object Step {
    ...
    @scala.inline
    def apply(arguments: js.Array[Argument], locations: js.Array[Location], text: String): typingsSlinky.cucumber.mod.pickle.Step = {
      ...
      __obj.asInstanceOf[typingsSlinky.cucumber.mod.pickle.Step]
    }
    
    @scala.inline
    implicit class StepMutableBuilder[Self <: typingsSlinky.cucumber.mod.pickle.Step] (val x: Self) extends AnyVal {
  ...
  object Tag {
    ...
    @scala.inline
    def apply(location: Location, name: String): typingsSlinky.cucumber.mod.pickle.Tag = {
      val __obj = js.Dynamic.literal(location = location.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.cucumber.mod.pickle.Tag]
    }
    
    @scala.inline
    implicit class TagMutableBuilder[Self <: typingsSlinky.cucumber.mod.pickle.Tag] (val x: Self) extends AnyVal {
