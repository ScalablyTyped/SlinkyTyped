...
/* index */ NumberDictionary[CheerioElement] {
  ...
  def after(content: js.Array[typingsSlinky.std.Document], contents: js.Any*): Cheerio = js.native
  def after(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def after(content: typingsSlinky.std.Document, contents: js.Any*): Cheerio = js.native
  def append(content: String, contents: js.Any*): Cheerio = js.native
  def append(content: js.Array[typingsSlinky.std.Document], contents: js.Any*): Cheerio = js.native
  def append(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def append(content: typingsSlinky.std.Document, contents: js.Any*): Cheerio = js.native
  // Manipulation
  ...
  def before(content: js.Array[typingsSlinky.std.Document], contents: js.Any*): Cheerio = js.native
  def before(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def before(content: typingsSlinky.std.Document, contents: js.Any*): Cheerio = js.native
  ...
  def insertAfter(content: typingsSlinky.std.Document): Cheerio = js.native
  def insertBefore(content: String): Cheerio = js.native
  def insertBefore(content: Cheerio): Cheerio = js.native
  def insertBefore(content: typingsSlinky.std.Document): Cheerio = js.native
  ...
  def prepend(content: js.Array[typingsSlinky.std.Document], contents: js.Any*): Cheerio = js.native
  def prepend(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def prepend(content: typingsSlinky.std.Document, contents: js.Any*): Cheerio = js.native
  ...
  def wrap(content: typingsSlinky.std.Document): Cheerio = js.native
}
