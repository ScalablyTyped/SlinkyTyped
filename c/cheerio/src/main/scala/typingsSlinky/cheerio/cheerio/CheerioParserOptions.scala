package typingsSlinky.cheerio.cheerio
...
@js.native
trait CheerioParserOptions extends js.Object {
...
object CheerioParserOptions {
  ...
  @scala.inline
  implicit class CheerioParserOptionsOps[Self <: CheerioParserOptions] (val x: Self) extends AnyVal {
