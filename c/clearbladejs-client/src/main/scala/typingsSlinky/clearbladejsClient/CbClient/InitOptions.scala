...
object InitOptions {
  ...
  def apply(
    ...
    messagingAuthPort: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(messagingAuthPort)) __obj.updateDynamic("messagingAuthPort")(messagingAuthPort.get.asInstanceOf[js.Any])
