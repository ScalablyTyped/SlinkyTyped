...
object QuerySortDirections extends js.Object {
  ...
  /* "ASC" */ val QUERY_SORT_ASCENDING: typingsSlinky.clearbladejsDashClient.CbClient.QuerySortDirections.QUERY_SORT_ASCENDING with String = js.native
  /* "DESC" */ val QUERY_SORT_DESCENDING: typingsSlinky.clearbladejsDashClient.CbClient.QuerySortDirections.QUERY_SORT_DESCENDING with String = js.native
  @JSBracketAccess
