...
object StyleRules {
  ...
  implicit class StyleRulesOps[Self <: StyleRules] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withParsingErrors(value: js.Array[ParserError]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("parsingErrors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutParsingErrors: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("parsingErrors")(js.undefined)
        ret
    }
  }
