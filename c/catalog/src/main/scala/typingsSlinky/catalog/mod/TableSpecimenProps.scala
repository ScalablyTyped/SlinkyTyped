...
trait TableSpecimenProps extends js.Object {
  ...
  var rows: js.Array[StringDictionary[ReactElement]] = js.native
}
object TableSpecimenProps {
  
  @scala.inline
  def apply(rows: js.Array[StringDictionary[ReactElement]]): TableSpecimenProps = {
  ...
  implicit class TableSpecimenPropsOps[Self <: TableSpecimenProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRowsVarargs(value: StringDictionary[ReactElement]*): Self = this.set("rows", js.Array(value :_*))
    
    @scala.inline
    def setRows(value: js.Array[StringDictionary[ReactElement]]): Self = this.set("rows", value.asInstanceOf[js.Any])
