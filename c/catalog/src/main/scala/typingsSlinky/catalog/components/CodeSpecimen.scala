...
import typingsSlinky.catalog.catalogMod.CodeSpecimenProps
...
object CodeSpecimen
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.catalog.catalogMod.CodeSpecimen] {
