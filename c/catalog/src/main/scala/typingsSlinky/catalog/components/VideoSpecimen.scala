...
object VideoSpecimen
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.catalog.mod.VideoSpecimen] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.catalog.mod.VideoSpecimen] = {
  ...
  type Props = SpecimenProps with VideoSpecimenProps
}
