...
object mod {
  ...
  object Severity extends StObject {
    ...
    /* "Error" */ val Error: typingsSlinky.cyberblastLogger.mod.Severity.Error with String = js.native
    
    @js.native
    sealed trait Info extends Severity
    /* "Info" */ val Info: typingsSlinky.cyberblastLogger.mod.Severity.Info with String = js.native
    
    @js.native
    sealed trait Verbose extends Severity
    /* "Verbose" */ val Verbose: typingsSlinky.cyberblastLogger.mod.Severity.Verbose with String = js.native
    
    @js.native
    sealed trait Warning extends Severity
    /* "Warning" */ val Warning: typingsSlinky.cyberblastLogger.mod.Severity.Warning with String = js.native
  }
  ...
  object SeverityLevel extends StObject {
    ...
    /* 4 */ val Error: typingsSlinky.cyberblastLogger.mod.SeverityLevel.Error with Double = js.native
    
    @js.native
    sealed trait Info extends SeverityLevel
    /* 2 */ val Info: typingsSlinky.cyberblastLogger.mod.SeverityLevel.Info with Double = js.native
    
    @js.native
    sealed trait Verbose extends SeverityLevel
    /* 1 */ val Verbose: typingsSlinky.cyberblastLogger.mod.SeverityLevel.Verbose with Double = js.native
    
    @js.native
    sealed trait Warning extends SeverityLevel
    /* 3 */ val Warning: typingsSlinky.cyberblastLogger.mod.SeverityLevel.Warning with Double = js.native
  }
