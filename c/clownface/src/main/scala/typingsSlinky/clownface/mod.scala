...
object mod {
  ...
  trait AnyPointer[T /* <: AnyContext */, D /* <: DatasetCore[Quad, Quad] */] extends StObject {
    ...
    def list(): (js.Iterable[Iteratee[T, D]]) | Null = js.native
  ...
  trait NodeOptions extends StObject {
    ...
    var `type`: js.UndefOr[
        typingsSlinky.clownface.clownfaceStrings.BlankNode | typingsSlinky.clownface.clownfaceStrings.Literal | typingsSlinky.clownface.clownfaceStrings.NamedNode
      ] = js.native
  }
  object NodeOptions {
    ...
    implicit class NodeOptionsMutableBuilder[Self <: NodeOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(
        value: typingsSlinky.clownface.clownfaceStrings.BlankNode | typingsSlinky.clownface.clownfaceStrings.Literal | typingsSlinky.clownface.clownfaceStrings.NamedNode
