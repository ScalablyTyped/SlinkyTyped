...
object ClownfaceInitWithValue {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D](value: String): ClownfaceInitWithValue[D] = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClownfaceInitWithValue[D]]
  }
  @scala.inline
  implicit class ClownfaceInitWithValueOps[Self <: ClownfaceInitWithValue[_], /* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D] (val x: Self with ClownfaceInitWithValue[D]) extends AnyVal {
    @scala.inline
