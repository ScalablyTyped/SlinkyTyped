...
object ClownfaceInitWithValue {
  @scala.inline
  def apply[D](value: String): ClownfaceInitWithValue[D] = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClownfaceInitWithValue[D]]
  }
  @scala.inline
  implicit class ClownfaceInitWithValueOps[Self[d] <: ClownfaceInitWithValue[d], D] (val x: Self[D]) extends AnyVal {
    @scala.inline
    def duplicate: Self[D] = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self[D]]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self[D] with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self[D] with Other]
    @scala.inline
    def withValue(value: String): Self[D] = {
