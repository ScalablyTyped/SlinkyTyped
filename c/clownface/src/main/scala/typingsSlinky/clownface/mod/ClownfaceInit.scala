...
object ClownfaceInit {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D](): ClownfaceInit[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClownfaceInit[D]]
  }
  @scala.inline
  implicit class ClownfaceInitOps[Self <: ClownfaceInit[_], /* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D] (val x: Self with ClownfaceInit[D]) extends AnyVal {
    @scala.inline
