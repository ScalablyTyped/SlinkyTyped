...
object ClownfaceInitWithValues {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D](value: js.Array[String]): ClownfaceInitWithValues[D] = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClownfaceInitWithValues[D]]
  }
  @scala.inline
  implicit class ClownfaceInitWithValuesOps[Self <: ClownfaceInitWithValues[_], /* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D] (val x: Self with ClownfaceInitWithValues[D]) extends AnyVal {
    @scala.inline
