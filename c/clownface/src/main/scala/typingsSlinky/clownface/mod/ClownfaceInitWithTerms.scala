...
object ClownfaceInitWithTerms {
  ...
  @scala.inline
  implicit class ClownfaceInitWithTermsOps[Self <: ClownfaceInitWithTerms[_, _], T /* <: Term | js.Array[Term] */, D /* <: DatasetCore[Quad, Quad] */] (val x: Self with (ClownfaceInitWithTerms[T, D])) extends AnyVal {
