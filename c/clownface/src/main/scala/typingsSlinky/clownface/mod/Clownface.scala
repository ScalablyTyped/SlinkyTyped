...
trait Clownface[D /* <: DatasetCore[Quad, Quad] */, T /* <: Term */] extends js.Object {
  ...
  def node(values: SingleOrArray[Boolean | String | Double | Term | Null]): SafeClownface[D, Term] = js.native
  def node(values: SingleOrArray[Boolean | String | Double | Term | Null], options: NodeOptions): SafeClownface[D, Term] = js.native
  @JSName("node")
  def node_SingleContextClownface(value: SingleOrOneElementArray[Boolean | String | Double]): SingleContextClownface[D, Literal] = js.native
  @JSName("node")
  def node_SingleContextClownface(value: SingleOrOneElementArray[Boolean | String | Double], options: NodeOptions): SingleContextClownface[D, Literal] = js.native
  @JSName("node")
  ...
  @JSName("node")
  def node_X_Term_SingleContextClownface[X /* <: Term */](value: SingleOrOneElementArray[X]): SingleContextClownface[D, X] = js.native
  @JSName("node")
  def node_X_Term_SingleContextClownface[X /* <: Term */](value: SingleOrOneElementArray[X], options: NodeOptions): SingleContextClownface[D, X] = js.native
