...
object Context {
  @scala.inline
  def apply[/* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D, /* <: typingsSlinky.rdfJs.mod.Term */ T](dataset: D, term: T): Context[D, T] = {
  ...
  @scala.inline
  implicit class ContextOps[Self <: Context[_, _], /* <: typingsSlinky.rdfJs.mod.DatasetCore[typingsSlinky.rdfJs.mod.Quad, typingsSlinky.rdfJs.mod.Quad] */ D, /* <: typingsSlinky.rdfJs.mod.Term */ T] (val x: Self with (Context[D, T])) extends AnyVal {
    @scala.inline
