...
trait CloudflareAppsMethods extends js.Object {
  ...
  def querySelector[K /* <: /* keyof cloudflare-apps.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 */ js.Any */](selectors: K): (/* import warning: importer.ImportType#apply Failed type conversion: cloudflare-apps.ElementTagNameMap[K] */ js.Any) | Null = js.native
}
