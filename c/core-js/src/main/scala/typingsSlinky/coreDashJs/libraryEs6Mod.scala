...
@JSImport("core-js/library/es6", JSImport.Namespace)
@js.native
object libraryEs6Mod extends js.Object {
  @js.native
  class Map[K, V] ()
  ...
  object Array extends js.Object {
    def concat[T](array: ArrayLike[T], items: (typingsSlinky.coreDashJs.Array[T] | T)*): typingsSlinky.coreDashJs.Array[T] = js.native
    def copyWithin[T](array: ArrayLike[T], target: Double, start: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def copyWithin[T](array: ArrayLike[T], target: Double, start: Double, end: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    ...
    def every[T](
      ...
      callbackfn: js.Function3[
          /* value */ T, 
          /* index */ Double, 
          /* array */ typingsSlinky.coreDashJs.Array[T], 
          Boolean
        ]
    ): Boolean = js.native
    def every[T](
    ...
    def fill[T](array: ArrayLike[T], value: T): typingsSlinky.coreDashJs.Array[T] = js.native
    def fill[T](array: ArrayLike[T], value: T, start: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def fill[T](array: ArrayLike[T], value: T, start: Double, end: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    ): typingsSlinky.coreDashJs.Array[T] = js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    def find[T](
      ...
      predicate: js.Function3[
          /* value */ T, 
          /* index */ Double, 
          /* obj */ typingsSlinky.coreDashJs.Array[T], 
          Boolean
        ]
    ): T = js.native
    def find[T](
    ...
    def forEach[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreDashJs.Array[T], Unit]
    ): Unit = js.native
    def forEach[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreDashJs.Array[T], Unit],
    ...
    def from[T](arrayLike: ArrayLike[T]): typingsSlinky.coreDashJs.Array[T] = js.native
    def from[T](arrayLike: Iterable[T]): typingsSlinky.coreDashJs.Array[T] = js.native
    def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsSlinky.coreDashJs.Array[U] = js.native
    def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: js.Any): typingsSlinky.coreDashJs.Array[U] = js.native
    def from[T, U](arrayLike: Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsSlinky.coreDashJs.Array[U] = js.native
    def from[T, U](arrayLike: Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: js.Any): typingsSlinky.coreDashJs.Array[U] = js.native
    ...
    def map[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreDashJs.Array[T], U]
    ): typingsSlinky.coreDashJs.Array[U] = js.native
    def map[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreDashJs.Array[T], U],
      thisArg: js.Any
    ): typingsSlinky.coreDashJs.Array[U] = js.native
    def of[T](items: T*): typingsSlinky.coreDashJs.Array[T] = js.native
    ...
    def reverse[T](array: ArrayLike[T]): typingsSlinky.coreDashJs.Array[T] = js.native
    def shift[T](array: ArrayLike[T]): T = js.native
    def slice[T](array: ArrayLike[T]): typingsSlinky.coreDashJs.Array[T] = js.native
    def slice[T](array: ArrayLike[T], start: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def slice[T](array: ArrayLike[T], start: Double, end: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    def sort[T](array: ArrayLike[T]): typingsSlinky.coreDashJs.Array[T] = js.native
    def sort[T](array: ArrayLike[T], compareFn: js.Function2[/* a */ T, /* b */ T, Double]): typingsSlinky.coreDashJs.Array[T] = js.native
    def splice[T](array: ArrayLike[T], start: Double): typingsSlinky.coreDashJs.Array[T] = js.native
    def splice[T](array: ArrayLike[T], start: Double, deleteCount: Double, items: T*): typingsSlinky.coreDashJs.Array[T] = js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
          /* memo */ typingsSlinky.coreDashJs.Array[T], 
          /* value */ T, 
          /* index */ Double, 
          /* array */ typingsSlinky.coreDashJs.Array[T], 
          Unit
  ...
  object Date extends js.Object {
    def format(date: typingsSlinky.coreDashJs.Date, template: java.lang.String): java.lang.String = js.native
    def format(date: typingsSlinky.coreDashJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsSlinky.coreDashJs.Date, template: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsSlinky.coreDashJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def now(): Double = js.native
    def toISOString(date: typingsSlinky.coreDashJs.Date): java.lang.String = js.native
  }
  
  @js.native
  object Function extends js.Object {
    def bind(target: typingsSlinky.coreDashJs.Function, thisArg: js.Any, argArray: js.Any*): js.Any = js.native
    def part(target: typingsSlinky.coreDashJs.Function, args: js.Any*): js.Any = js.native
  }
