...
object Object extends js.Object {
  ...
  def entries(`object`: js.Any): typingsSlinky.coreDashJs.Array[_] = js.native
  ...
  def getOwnPropertyNames(o: js.Any): typingsSlinky.coreDashJs.Array[java.lang.String] = js.native
  def getOwnPropertySymbols(o: js.Any): typingsSlinky.coreDashJs.Array[js.Symbol] = js.native
  ...
  def keys(o: js.Any): typingsSlinky.coreDashJs.Array[java.lang.String] = js.native
  ...
  def values(`object`: js.Any): typingsSlinky.coreDashJs.Array[_] = js.native
}
