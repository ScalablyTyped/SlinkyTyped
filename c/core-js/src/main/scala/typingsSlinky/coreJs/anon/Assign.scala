...
import typingsSlinky.coreJs.Array
...
trait Assign extends js.Object {
  ...
  def classof(value: js.Any): String = js.native
  ...
  def getOwnPropertyNames(o: js.Any): Array[String] = js.native
  ...
  def keys(o: js.Any): Array[String] = js.native
