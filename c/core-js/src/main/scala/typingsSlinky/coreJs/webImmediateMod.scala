...
object webImmediateMod {
  
  object Array {
    
    @JSImport("core-js/web/immediate", "Array.concat")
    @js.native
    def concat[T](array: ArrayLike[T], items: (typingsSlinky.coreJs.Array[T] | T)*): typingsSlinky.coreJs.Array[T] = js.native
    
    @JSImport("core-js/web/immediate", "Array.copyWithin")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.entries")
    @js.native
    def entries[T](array: ArrayLike[T]): IterableIterator[js.Tuple2[Double, T]] = js.native
    
    @JSImport("core-js/web/immediate", "Array.every")
    @js.native
    def every[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/web/immediate", "Array.fill")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.filter")
    @js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/web/immediate", "Array.find")
    @js.native
    def find[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/web/immediate", "Array.findIndex")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.forEach")
    @js.native
    def forEach[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/web/immediate", "Array.from")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.includes")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.indexOf")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.isArray")
    @js.native
    def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Array.join")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.keys")
    @js.native
    def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
    
    @JSImport("core-js/web/immediate", "Array.lastIndexOf")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.map")
    @js.native
    def map[T, U](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/web/immediate", "Array.of")
    @js.native
    def of[T](items: T*): typingsSlinky.coreJs.Array[T] = js.native
    
    @JSImport("core-js/web/immediate", "Array.pop")
    @js.native
    def pop[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/web/immediate", "Array.push")
    @js.native
    def push[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/web/immediate", "Array.reduce")
    @js.native
    def reduce[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/web/immediate", "Array.reduceRight")
    @js.native
    def reduceRight[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/web/immediate", "Array.reverse")
    @js.native
    def reverse[T](array: ArrayLike[T]): typingsSlinky.coreJs.Array[T] = js.native
    
    @JSImport("core-js/web/immediate", "Array.shift")
    @js.native
    def shift[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/web/immediate", "Array.slice")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.some")
    @js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/web/immediate", "Array.sort")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.splice")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Array.turn")
    @js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/web/immediate", "Array.unshift")
    @js.native
    def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/web/immediate", "Array.values")
    @js.native
  ...
  object Date {
    ...
    @JSImport("core-js/web/immediate", "Date.format")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Date.formatUTC")
    @js.native
  ...
  object Math {
    ...
    @JSImport("core-js/web/immediate", "Math.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Math.trunc")
    @js.native
  ...
  object Number {
    ...
    @JSImport("core-js/web/immediate", "Number")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("core-js/web/immediate", "Number.EPSILON")
    @js.native
    def EPSILON: Double = js.native
    @scala.inline
    def EPSILON_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EPSILON")(x.asInstanceOf[js.Any])
    
    @JSImport("core-js/web/immediate", "Number.MAX_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Number.MIN_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Number.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.isFinite")
    @js.native
    def isFinite(number: Double): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Number.isInteger")
    @js.native
    def isInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Number.isNaN")
    @js.native
    def isNaN(number: Double): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Number.isSafeInteger")
    @js.native
    def isSafeInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Number.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.parseFloat")
    @js.native
    def parseFloat(string: java.lang.String): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.parseInt")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Number.random")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Number.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "Number.trunc")
    @js.native
    def trunc(x: Double): Double = js.native
  }
  ...
  object Object {
    ...
    @JSImport("core-js/web/immediate", "Object.assign")
    @js.native
    def assign(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("core-js/web/immediate", "Object.classof")
    @js.native
    def classof(value: js.Any): java.lang.String = js.native
    
    @JSImport("core-js/web/immediate", "Object.create")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Object.preventExtensions")
    @js.native
    def preventExtensions[T](o: T): T = js.native
    
    @JSImport("core-js/web/immediate", "Object.seal")
    @js.native
    def seal[T](o: T): T = js.native
    
    @JSImport("core-js/web/immediate", "Object.setPrototypeOf")
    @js.native
    def setPrototypeOf(o: js.Any, proto: js.Any): js.Any = js.native
    
    @JSImport("core-js/web/immediate", "Object.values")
    @js.native
    def values(`object`: js.Any): Array[_] = js.native
  }
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/web/immediate", "Promise")
  @js.native
  ...
  object Reflect {
    ...
    @JSImport("core-js/web/immediate", "Reflect.apply")
    @js.native
    def apply(target: Function, thisArgument: js.Any, argumentsList: ArrayLike[_]): js.Any = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.construct")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.defineMetadata")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Reflect.defineProperty")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.deleteMetadata")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Reflect.deleteProperty")
    @js.native
    def deleteProperty(target: js.Any, propertyKey: PropertyKey): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.get")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.getMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.getMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.getOwnMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.getOwnMetadataKeys")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Reflect.getOwnPropertyDescriptor")
    @js.native
    def getOwnPropertyDescriptor(target: js.Any, propertyKey: PropertyKey): js.PropertyDescriptor = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.getPrototypeOf")
    @js.native
    def getPrototypeOf(target: js.Any): js.Any = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.has")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.hasMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.hasOwnMetadata")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Reflect.isExtensible")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/web/immediate", "Reflect.metadata")
    @js.native
    def metadata(metadataKey: js.Any, metadataValue: js.Any): FnCall = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.ownKeys")
    @js.native
    def ownKeys(target: js.Any): Array[PropertyKey] = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.preventExtensions")
    @js.native
    def preventExtensions(target: js.Any): Boolean = js.native
    
    @JSImport("core-js/web/immediate", "Reflect.set")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "Reflect.setPrototypeOf")
    @js.native
  ...
  object RegExp {
    ...
    @JSImport("core-js/web/immediate", "RegExp.escape")
    @js.native
    def escape(str: java.lang.String): java.lang.String = js.native
  }
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/web/immediate", "Set")
  @js.native
  class Set[T] ()
  ...
  object String {
    ...
    @JSImport("core-js/web/immediate", "String.at")
    @js.native
    def at(text: java.lang.String, index: Double): java.lang.String = js.native
    
    @JSImport("core-js/web/immediate", "String.codePointAt")
    @js.native
    def codePointAt(text: java.lang.String, pos: Double): Double = js.native
    
    @JSImport("core-js/web/immediate", "String.endsWith")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "String.escapeHTML")
    @js.native
    def escapeHTML(text: java.lang.String): java.lang.String = js.native
    
    @JSImport("core-js/web/immediate", "String.fromCodePoint")
    @js.native
    def fromCodePoint(codePoints: Double*): java.lang.String = js.native
    
    @JSImport("core-js/web/immediate", "String.includes")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "String.padEnd")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "String.padStart")
    @js.native
    ...
    @JSImport("core-js/web/immediate", "String.unescapeHTML")
    @js.native
    def unescapeHTML(text: java.lang.String): java.lang.String = js.native
  }
  
  @JSImport("core-js/web/immediate", "Symbol")
  @js.native
  ...
  @JSImport("core-js/web/immediate", "setImmediate")
  @js.native
  def setImmediate(expression: js.Any, args: js.Any*): Double = js.native
  
  @JSImport("core-js/web/immediate", "setInterval")
  @js.native
  ...
  @JSImport("core-js/web/immediate", "setTimeout")
  @js.native
  ...
  @JSImport("core-js/web/immediate", "version")
  @js.native
  val version: java.lang.String = js.native
  
  @JSImport("core-js/web/immediate", "$for")
  @js.native
