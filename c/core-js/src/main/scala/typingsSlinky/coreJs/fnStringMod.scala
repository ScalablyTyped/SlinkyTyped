...
object fnStringMod {
  ...
  @JSImport("core-js/fn/string", "padEnd")
  @js.native
  ...
  @JSImport("core-js/fn/string", "padStart")
  @js.native
  ...
  @JSImport("core-js/fn/string", "unescapeHTML")
  @js.native
