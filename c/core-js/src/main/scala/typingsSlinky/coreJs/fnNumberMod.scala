...
object fnNumberMod {
  ...
  @JSImport("core-js/fn/number", "MIN_SAFE_INTEGER")
  @js.native
  ...
  @JSImport("core-js/fn/number", "random")
  @js.native
  ...
  @JSImport("core-js/fn/number", "sign")
  @js.native
  def sign(x: Double): Double = js.native
  
  @JSImport("core-js/fn/number", "sinh")
  @js.native
  def sinh(x: Double): Double = js.native
  
  @JSImport("core-js/fn/number", "tanh")
  @js.native
  def tanh(x: Double): Double = js.native
  
  @JSImport("core-js/fn/number", "trunc")
  @js.native
