...
object libraryEs7ArrayMod {
  ...
  @JSImport("core-js/library/es7/array", "concat")
  @js.native
  def concat[T](array: ArrayLike[T], items: (Array[T] | T)*): Array[T] = js.native
  
  @JSImport("core-js/library/es7/array", "copyWithin")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "entries")
  @js.native
  def entries[T](array: ArrayLike[T]): IterableIterator[js.Tuple2[Double, T]] = js.native
  
  @JSImport("core-js/library/es7/array", "every")
  @js.native
  def every[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "fill")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "filter")
  @js.native
  def filter[T](
    array: ArrayLike[T],
    callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Boolean]
  ...
  @JSImport("core-js/library/es7/array", "find")
  @js.native
  def find[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "findIndex")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "forEach")
  @js.native
  def forEach[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "from")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "includes")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "indexOf")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "isArray")
  @js.native
  def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
  
  @JSImport("core-js/library/es7/array", "join")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "keys")
  @js.native
  def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
  
  @JSImport("core-js/library/es7/array", "lastIndexOf")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "map")
  @js.native
  def map[T, U](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "of")
  @js.native
  def of[T](items: T*): Array[T] = js.native
  
  @JSImport("core-js/library/es7/array", "pop")
  @js.native
  def pop[T](array: ArrayLike[T]): T = js.native
  
  @JSImport("core-js/library/es7/array", "push")
  @js.native
  def push[T](array: ArrayLike[T], items: T*): Double = js.native
  
  @JSImport("core-js/library/es7/array", "reduce")
  @js.native
  def reduce[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "reduceRight")
  @js.native
  def reduceRight[T](
    array: ArrayLike[T],
    callbackfn: js.Function4[
  ...
  @JSImport("core-js/library/es7/array", "reverse")
  @js.native
  def reverse[T](array: ArrayLike[T]): Array[T] = js.native
  
  @JSImport("core-js/library/es7/array", "shift")
  @js.native
  def shift[T](array: ArrayLike[T]): T = js.native
  
  @JSImport("core-js/library/es7/array", "slice")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "some")
  @js.native
  def some[T](
    array: ArrayLike[T],
    callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Boolean]
  ...
  @JSImport("core-js/library/es7/array", "sort")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "splice")
  @js.native
  ...
  @JSImport("core-js/library/es7/array", "turn")
  @js.native
  def turn[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/library/es7/array", "unshift")
  @js.native
  def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
  
  @JSImport("core-js/library/es7/array", "values")
  @js.native
