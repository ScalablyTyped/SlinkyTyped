...
object fnArrayMod {
  ...
  @JSImport("core-js/fn/array", "concat")
  @js.native
  def concat[T](array: ArrayLike[T], items: (Array[T] | T)*): Array[T] = js.native
  
  @JSImport("core-js/fn/array", "copyWithin")
  @js.native
  ...
  @JSImport("core-js/fn/array", "fill")
  @js.native
  ...
  @JSImport("core-js/fn/array", "filter")
  @js.native
  def filter[T](
    array: ArrayLike[T],
    callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Boolean]
  ...
  @JSImport("core-js/fn/array", "find")
  @js.native
  def find[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/fn/array", "findIndex")
  @js.native
  ...
  @JSImport("core-js/fn/array", "forEach")
  @js.native
  def forEach[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/fn/array", "from")
  @js.native
  ...
  @JSImport("core-js/fn/array", "includes")
  @js.native
  ...
  @JSImport("core-js/fn/array", "indexOf")
  @js.native
  ...
  @JSImport("core-js/fn/array", "isArray")
  @js.native
  def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
  
  @JSImport("core-js/fn/array", "join")
  @js.native
  ...
  @JSImport("core-js/fn/array", "keys")
  @js.native
  def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
  
  @JSImport("core-js/fn/array", "lastIndexOf")
  @js.native
  ...
  @JSImport("core-js/fn/array", "reduceRight")
  @js.native
  def reduceRight[T](
    array: ArrayLike[T],
    callbackfn: js.Function4[
  ...
  @JSImport("core-js/fn/array", "reverse")
  @js.native
  def reverse[T](array: ArrayLike[T]): Array[T] = js.native
  
  @JSImport("core-js/fn/array", "shift")
  @js.native
  def shift[T](array: ArrayLike[T]): T = js.native
  
  @JSImport("core-js/fn/array", "slice")
  @js.native
  ...
  @JSImport("core-js/fn/array", "some")
  @js.native
  def some[T](
    array: ArrayLike[T],
    callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Boolean]
  ...
  @JSImport("core-js/fn/array", "sort")
  @js.native
  ...
  @JSImport("core-js/fn/array", "splice")
  @js.native
  ...
  @JSImport("core-js/fn/array", "turn")
  @js.native
  def turn[T](
    array: ArrayLike[T],
  ...
  @JSImport("core-js/fn/array", "unshift")
  @js.native
  def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
  
  @JSImport("core-js/fn/array", "values")
  @js.native
