...
object Object extends js.Object {
  ...
  def entries(`object`: js.Any): typingsSlinky.coreJs.Array[_] = js.native
  ...
  def getOwnPropertyNames(o: js.Any): typingsSlinky.coreJs.Array[java.lang.String] = js.native
  def getOwnPropertySymbols(o: js.Any): typingsSlinky.coreJs.Array[js.Symbol] = js.native
  ...
  def keys(o: js.Any): typingsSlinky.coreJs.Array[java.lang.String] = js.native
  ...
  def values(`object`: js.Any): typingsSlinky.coreJs.Array[_] = js.native
}
