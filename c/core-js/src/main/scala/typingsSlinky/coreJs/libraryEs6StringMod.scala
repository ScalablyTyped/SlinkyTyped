...
object libraryEs6StringMod {
  ...
  @JSImport("core-js/library/es6/string", "escapeHTML")
  @js.native
  def escapeHTML(text: java.lang.String): java.lang.String = js.native
  
  @JSImport("core-js/library/es6/string", "fromCodePoint")
  @js.native
  def fromCodePoint(codePoints: Double*): java.lang.String = js.native
  
  @JSImport("core-js/library/es6/string", "includes")
  @js.native
  ...
  @JSImport("core-js/library/es6/string", "padEnd")
  @js.native
  ...
  @JSImport("core-js/library/es6/string", "padStart")
  @js.native
  ...
  @JSImport("core-js/library/es6/string", "unescapeHTML")
  @js.native
