...
object jsMod {
  ...
  object Array {
    ...
    @JSImport("core-js/js", "Array.fill")
    @js.native
    ...
    @JSImport("core-js/js", "Array.filter")
    @js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/js", "Array.find")
    @js.native
    def find[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/js", "Array.findIndex")
    @js.native
    ...
    @JSImport("core-js/js", "Array.forEach")
    @js.native
    def forEach[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/js", "Array.from")
    @js.native
    ...
    @JSImport("core-js/js", "Array.includes")
    @js.native
    ...
    @JSImport("core-js/js", "Array.indexOf")
    @js.native
    ...
    @JSImport("core-js/js", "Array.isArray")
    @js.native
    def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
    
    @JSImport("core-js/js", "Array.join")
    @js.native
    ...
    @JSImport("core-js/js", "Array.keys")
    @js.native
    def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
    
    @JSImport("core-js/js", "Array.lastIndexOf")
    @js.native
    ...
    @JSImport("core-js/js", "Array.reduceRight")
    @js.native
    def reduceRight[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/js", "Array.some")
    @js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsSlinky.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/js", "Array.sort")
    @js.native
    ...
    @JSImport("core-js/js", "Array.splice")
    @js.native
    ...
    @JSImport("core-js/js", "Array.turn")
    @js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/js", "Array.unshift")
    @js.native
    def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/js", "Array.values")
    @js.native
  ...
  object Date {
    ...
    @JSImport("core-js/js", "Date.format")
    @js.native
    ...
    @JSImport("core-js/js", "Date.formatUTC")
    @js.native
  ...
  object Number {
    ...
    @JSImport("core-js/js", "Number")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("core-js/js", "Number.EPSILON")
    @js.native
    def EPSILON: Double = js.native
    @scala.inline
    def EPSILON_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EPSILON")(x.asInstanceOf[js.Any])
    
    @JSImport("core-js/js", "Number.MAX_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/js", "Number.MIN_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/js", "Number.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/js", "Number.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.isFinite")
    @js.native
    def isFinite(number: Double): Boolean = js.native
    
    @JSImport("core-js/js", "Number.isInteger")
    @js.native
    def isInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/js", "Number.isNaN")
    @js.native
    def isNaN(number: Double): Boolean = js.native
    
    @JSImport("core-js/js", "Number.isSafeInteger")
    @js.native
    def isSafeInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/js", "Number.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.parseFloat")
    @js.native
    def parseFloat(string: java.lang.String): Double = js.native
    
    @JSImport("core-js/js", "Number.parseInt")
    @js.native
    ...
    @JSImport("core-js/js", "Number.random")
    @js.native
    ...
    @JSImport("core-js/js", "Number.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/js", "Number.trunc")
    @js.native
    def trunc(x: Double): Double = js.native
  }
  ...
  object Object {
    ...
    @JSImport("core-js/js", "Object.assign")
    @js.native
    def assign(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("core-js/js", "Object.classof")
    @js.native
    def classof(value: js.Any): java.lang.String = js.native
    
    @JSImport("core-js/js", "Object.create")
    @js.native
    ...
    @JSImport("core-js/js", "Object.preventExtensions")
    @js.native
    def preventExtensions[T](o: T): T = js.native
    
    @JSImport("core-js/js", "Object.seal")
    @js.native
    def seal[T](o: T): T = js.native
    
    @JSImport("core-js/js", "Object.setPrototypeOf")
    @js.native
    def setPrototypeOf(o: js.Any, proto: js.Any): js.Any = js.native
    
    @JSImport("core-js/js", "Object.values")
    @js.native
    def values(`object`: js.Any): Array[_] = js.native
  }
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/js", "Promise")
  @js.native
  ...
  object Reflect {
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.defineMetadata")
    @js.native
    ...
    @JSImport("core-js/js", "Reflect.defineProperty")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.deleteMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.getMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.getMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.getOwnMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.getOwnMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.hasMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/js", "Reflect.hasOwnMetadata")
    @js.native
    ...
    @JSImport("core-js/js", "Reflect.isExtensible")
    @js.native
    ...
    @JSImport("core-js/js", "Reflect.setPrototypeOf")
    @js.native
  ...
  object String {
    ...
    @JSImport("core-js/js", "String.padEnd")
    @js.native
    ...
    @JSImport("core-js/js", "String.padStart")
    @js.native
    ...
    @JSImport("core-js/js", "String.unescapeHTML")
    @js.native
    def unescapeHTML(text: java.lang.String): java.lang.String = js.native
  }
  
  @JSImport("core-js/js", "Symbol")
  @js.native
  ...
  @JSImport("core-js/js", "setImmediate")
  @js.native
  def setImmediate(expression: js.Any, args: js.Any*): Double = js.native
  
  @JSImport("core-js/js", "setInterval")
  @js.native
  ...
  @JSImport("core-js/js", "setTimeout")
  @js.native
  ...
  @JSImport("core-js/js", "version")
  @js.native
  val version: java.lang.String = js.native
  
  @JSImport("core-js/js", "$for")
  @js.native
