...
object mod {
  ...
  object Array {
    ...
    @JSImport("core-js", "Array.findIndex")
    @js.native
    ...
    @JSImport("core-js", "Array.forEach")
    @js.native
    def forEach[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js", "Array.includes")
    @js.native
    ...
    @JSImport("core-js", "Array.indexOf")
    @js.native
    ...
    @JSImport("core-js", "Array.reduceRight")
    @js.native
    def reduceRight[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js", "Array.unshift")
    @js.native
    def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js", "Array.values")
    @js.native
  ...
  object Date {
    ...
    @JSImport("core-js", "Date.formatUTC")
    @js.native
  ...
  object Number {
    ...
    @JSImport("core-js", "Number.MIN_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js", "Number.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js", "Number.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js", "Number.isFinite")
    @js.native
    def isFinite(number: Double): Boolean = js.native
    
    @JSImport("core-js", "Number.isInteger")
    @js.native
    def isInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js", "Number.isNaN")
    @js.native
    def isNaN(number: Double): Boolean = js.native
    
    @JSImport("core-js", "Number.isSafeInteger")
    @js.native
    def isSafeInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js", "Number.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.parseFloat")
    @js.native
    def parseFloat(string: java.lang.String): Double = js.native
    
    @JSImport("core-js", "Number.parseInt")
    @js.native
    ...
    @JSImport("core-js", "Number.random")
    @js.native
    ...
    @JSImport("core-js", "Number.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js", "Number.trunc")
    @js.native
    def trunc(x: Double): Double = js.native
  }
  ...
  object Object {
    ...
    @JSImport("core-js", "Object.assign")
    @js.native
    def assign(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("core-js", "Object.classof")
    @js.native
    def classof(value: js.Any): java.lang.String = js.native
    
    @JSImport("core-js", "Object.create")
    @js.native
  ...
  object Reflect {
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.defineMetadata")
    @js.native
    ...
    @JSImport("core-js", "Reflect.defineProperty")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.deleteMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.getMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.getMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.getOwnMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.getOwnMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.hasMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js", "Reflect.hasOwnMetadata")
    @js.native
    ...
    @JSImport("core-js", "Reflect.isExtensible")
    @js.native
    ...
    @JSImport("core-js", "Reflect.setPrototypeOf")
    @js.native
  ...
  object String {
    ...
    @JSImport("core-js", "String.padEnd")
    @js.native
    ...
    @JSImport("core-js", "String.padStart")
    @js.native
    ...
    @JSImport("core-js", "String.unescapeHTML")
    @js.native
  ...
  @JSImport("core-js", "version")
  @js.native
  val version: java.lang.String = js.native
  
  @JSImport("core-js", "$for")
  @js.native
