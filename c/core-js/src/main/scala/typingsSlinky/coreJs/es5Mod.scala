...
object es5Mod {
  ...
  object Number {
    ...
    @JSImport("core-js/es5", "Number")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("core-js/es5", "Number.EPSILON")
    @js.native
    def EPSILON: Double = js.native
    @scala.inline
    def EPSILON_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EPSILON")(x.asInstanceOf[js.Any])
    
    @JSImport("core-js/es5", "Number.MAX_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/es5", "Number.MIN_SAFE_INTEGER")
    @js.native
