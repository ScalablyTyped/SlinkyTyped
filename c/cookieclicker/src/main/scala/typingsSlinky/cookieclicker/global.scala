...
import typingsSlinky.cookieclicker.Game.AchievementPool
import typingsSlinky.cookieclicker.Game.Art
import typingsSlinky.cookieclicker.Game.BankAchievementClass
import typingsSlinky.cookieclicker.Game.Buff
import typingsSlinky.cookieclicker.Game.ChoiceCosmetics
import typingsSlinky.cookieclicker.Game.CookieUpgrade
import typingsSlinky.cookieclicker.Game.CookieUpgradeParameter
import typingsSlinky.cookieclicker.Game.CpsAchievementClass
import typingsSlinky.cookieclicker.Game.DragonAura
import typingsSlinky.cookieclicker.Game.DragonLevel
import typingsSlinky.cookieclicker.Game.Effects
import typingsSlinky.cookieclicker.Game.FoolBuilding
import typingsSlinky.cookieclicker.Game.GrandmaSynergyClass
import typingsSlinky.cookieclicker.Game.HeavenlyUpgrade
import typingsSlinky.cookieclicker.Game.Icon
import typingsSlinky.cookieclicker.Game.Milk
import typingsSlinky.cookieclicker.Game.Mod
import typingsSlinky.cookieclicker.Game.Particle
import typingsSlinky.cookieclicker.Game.Prefs
import typingsSlinky.cookieclicker.Game.PseudoBoolean
import typingsSlinky.cookieclicker.Game.Season
import typingsSlinky.cookieclicker.Game.SelectorSwitchChoice
import typingsSlinky.cookieclicker.Game.ShimmerType
import typingsSlinky.cookieclicker.Game.SynergyUpgradeClass
import typingsSlinky.cookieclicker.Game.Tier
import typingsSlinky.cookieclicker.Game.TieredAchievementClass
import typingsSlinky.cookieclicker.Game.TieredUpgradeClass
import typingsSlinky.cookieclicker.Game.Tooltip
import typingsSlinky.cookieclicker.Game.TooltipOrigins
import typingsSlinky.cookieclicker.Game.UnlockRequirement
import typingsSlinky.cookieclicker.Game.Wrinkler
import typingsSlinky.cookieclicker.Game.WrinklerSave
import typingsSlinky.cookieclicker.anon.Bank
...
import typingsSlinky.cookieclicker.cookieclickerNumbers.`1`
import typingsSlinky.cookieclicker.cookieclickerNumbers.`2`
import typingsSlinky.cookieclicker.cookieclickerNumbers.`3`
import typingsSlinky.cookieclicker.cookieclickerNumbers.`4`
import typingsSlinky.cookieclicker.cookieclickerStrings.Farm
import typingsSlinky.cookieclicker.cookieclickerStrings.Temple
import typingsSlinky.cookieclicker.cookieclickerStrings.`Wizard tower`
import typingsSlinky.cookieclicker.cookieclickerStrings.altDraw
import typingsSlinky.cookieclicker.cookieclickerStrings.animate
import typingsSlinky.cookieclicker.cookieclickerStrings.ascend
import typingsSlinky.cookieclicker.cookieclickerStrings.askLumps
import typingsSlinky.cookieclicker.cookieclickerStrings.autosave
import typingsSlinky.cookieclicker.cookieclickerStrings.autoupdate
import typingsSlinky.cookieclicker.cookieclickerStrings.cookiesPerClick
import typingsSlinky.cookieclicker.cookieclickerStrings.cps
import typingsSlinky.cookieclicker.cookieclickerStrings.cursors
import typingsSlinky.cookieclicker.cookieclickerStrings.customGrandmas
import typingsSlinky.cookieclicker.cookieclickerStrings.extraButtons
import typingsSlinky.cookieclicker.cookieclickerStrings.fancy
import typingsSlinky.cookieclicker.cookieclickerStrings.filters
import typingsSlinky.cookieclicker.cookieclickerStrings.focus
import typingsSlinky.cookieclicker.cookieclickerStrings.format
import typingsSlinky.cookieclicker.cookieclickerStrings.milk
import typingsSlinky.cookieclicker.cookieclickerStrings.monospace
import typingsSlinky.cookieclicker.cookieclickerStrings.notifs
import typingsSlinky.cookieclicker.cookieclickerStrings.numbers
import typingsSlinky.cookieclicker.cookieclickerStrings.particles
import typingsSlinky.cookieclicker.cookieclickerStrings.popups
import typingsSlinky.cookieclicker.cookieclickerStrings.showBackupWarning
import typingsSlinky.cookieclicker.cookieclickerStrings.stats
import typingsSlinky.cookieclicker.cookieclickerStrings.store
import typingsSlinky.cookieclicker.cookieclickerStrings.ticker
import typingsSlinky.cookieclicker.cookieclickerStrings.timeout
import typingsSlinky.cookieclicker.cookieclickerStrings.warn
import typingsSlinky.cookieclicker.cookieclickerStrings.wobbly
import typingsSlinky.std.DOMRect
import typingsSlinky.std.InputEvent
...
object global {
  ...
  object Game {
    ...
    class Achievement protected ()
      extends typingsSlinky.cookieclicker.Game.Achievement {
      /**
    ...
    @js.native
    def Achievements: js.Array[typingsSlinky.cookieclicker.Game.Achievement] = js.native
    
    @JSGlobal("Game.AchievementsById")
    @js.native
    def AchievementsById: js.Array[typingsSlinky.cookieclicker.Game.Achievement] = js.native
    @scala.inline
    def AchievementsById_=(x: js.Array[typingsSlinky.cookieclicker.Game.Achievement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AchievementsById")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Achievements_=(x: js.Array[typingsSlinky.cookieclicker.Game.Achievement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Achievements")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def ClickProduct(what: typingsSlinky.cookieclicker.Game.GameObject): Unit = js.native
    ...
    class GameObject protected ()
      extends typingsSlinky.cookieclicker.Game.GameObject {
      /**
      ...
      def this(
        ...
        art: Art,
        price: Double,
        cps: js.Function1[/* me */ typingsSlinky.cookieclicker.Game.GameObject, Double],
        buyFunction: js.ThisFunction0[/* this */ typingsSlinky.cookieclicker.Game.GameObject, Unit]
      ) = this()
    }
    ...
    @js.native
    def GetTieredCpsMult(me: typingsSlinky.cookieclicker.Game.GameObject): Double = js.native
    ...
    @js.native
    def Loader: typingsSlinky.cookieclicker.Loader = js.native
    @scala.inline
    def Loader_=(x: typingsSlinky.cookieclicker.Loader): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Loader")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def MakeTiered(upgrade: typingsSlinky.cookieclicker.Game.Upgrade, tier: String, col: Double): Unit = js.native
    @JSGlobal("Game.MakeTiered")
    @js.native
    def MakeTiered(upgrade: typingsSlinky.cookieclicker.Game.Upgrade, tier: Double, col: Double): Unit = js.native
    ...
    @JSGlobal("Game.Milk")
    @js.native
    def Milk: typingsSlinky.cookieclicker.Game.Milk = js.native
    @scala.inline
    ...
    class Note protected ()
      extends typingsSlinky.cookieclicker.Game.Note {
    ...
    @JSGlobal("Game.Notes")
    @js.native
    def Notes: js.Array[typingsSlinky.cookieclicker.Game.Note] = js.native
    
    @JSGlobal("Game.NotesById")
    @js.native
    def NotesById: js.Array[typingsSlinky.cookieclicker.Game.Note] = js.native
    @scala.inline
    def NotesById_=(x: js.Array[typingsSlinky.cookieclicker.Game.Note]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NotesById")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Notes_=(x: js.Array[typingsSlinky.cookieclicker.Game.Note]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Notes")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def Objects: (Record[String, typingsSlinky.cookieclicker.Game.GameObject]) with Bank = js.native
    
    @JSGlobal("Game.ObjectsById")
    @js.native
    def ObjectsById: js.Array[typingsSlinky.cookieclicker.Game.GameObject] = js.native
    @scala.inline
    def ObjectsById_=(x: js.Array[typingsSlinky.cookieclicker.Game.GameObject]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ObjectsById")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Objects_=(x: (Record[String, typingsSlinky.cookieclicker.Game.GameObject]) with Bank): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Objects")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def ProductionAchievement(name: String, building: String, tier: Double): typingsSlinky.cookieclicker.Game.Achievement = js.native
    @JSGlobal("Game.ProductionAchievement")
    @js.native
    def ProductionAchievement(name: String, building: String, tier: Double, q: js.UndefOr[scala.Nothing], mult: Double): typingsSlinky.cookieclicker.Game.Achievement = js.native
    @JSGlobal("Game.ProductionAchievement")
    @js.native
    def ProductionAchievement(name: String, building: String, tier: Double, q: String): typingsSlinky.cookieclicker.Game.Achievement = js.native
    @JSGlobal("Game.ProductionAchievement")
    @js.native
    def ProductionAchievement(name: String, building: String, tier: Double, q: String, mult: Double): typingsSlinky.cookieclicker.Game.Achievement = js.native
    ...
    @js.native
    def PurchaseHeavenlyUpgrade(what: typingsSlinky.cookieclicker.Game.Upgrade): Unit = js.native
    
    @JSGlobal("Game.PutUpgradeInPermanentSlot")
    @js.native
    def PutUpgradeInPermanentSlot(upgrade: typingsSlinky.cookieclicker.Game.Upgrade, slot: Double): Unit = js.native
    ...
    @js.native
    def RequiresConfirmation(upgrade: typingsSlinky.cookieclicker.Game.Upgrade, prompt: String): Unit = js.native
    ...
    class Shimmer[N /* <: String */, C /* <: js.Object */] protected ()
      extends typingsSlinky.cookieclicker.Game.Shimmer[N, C] {
      /**
    ...
    @js.native
    def UnlockTiered(me: typingsSlinky.cookieclicker.Game.Upgrade): Unit = js.native
    ...
    class Upgrade protected ()
      extends typingsSlinky.cookieclicker.Game.Upgrade {
      /**
    ...
    @js.native
    def Upgrades: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.Upgrade]) = js.native
    
    @JSGlobal("Game.UpgradesById")
    @js.native
    def UpgradesById: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    @scala.inline
    def UpgradesById_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UpgradesById")(x.asInstanceOf[js.Any])
    ...
    object UpgradesByPool {
      ...
      @JSGlobal("Game.UpgradesByPool.")
      @js.native
      def _empty: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      @scala.inline
      def _empty_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.cookie")
      @js.native
      def cookie: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def cookie_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cookie")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.debug")
      @js.native
      def debug: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def debug_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("debug")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.prestige")
      @js.native
      def prestige: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      @JSGlobal("Game.UpgradesByPool.prestigeDecor")
      @js.native
      def prestigeDecor: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def prestigeDecor_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("prestigeDecor")(x.asInstanceOf[js.Any])
      
      @scala.inline
      def prestige_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("prestige")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.tech")
      @js.native
      def tech: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def tech_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("tech")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.toggle")
      @js.native
      def toggle: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def toggle_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("toggle")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Game.UpgradesByPool.unused")
      @js.native
      def unused: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      @scala.inline
      def unused_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("unused")(x.asInstanceOf[js.Any])
    }
    
    @JSGlobal("Game.UpgradesInStore")
    @js.native
    def UpgradesInStore: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    @scala.inline
    def UpgradesInStore_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UpgradesInStore")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Upgrades_=(
      x: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.Upgrade])
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Upgrades")(x.asInstanceOf[js.Any])
    ...
    class buffType protected ()
      extends typingsSlinky.cookieclicker.Game.buffType {
      def this(
        name: String,
        func: js.Function4[
                /* time */ Double, 
    ...
    @js.native
    def buffTypes: js.Array[typingsSlinky.cookieclicker.Game.buffType] = js.native
    
    @JSGlobal("Game.buffTypesByName")
    @js.native
    def buffTypesByName: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.buffType]) = js.native
    @scala.inline
    def buffTypesByName_=(
      x: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.buffType])
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("buffTypesByName")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def buffTypes_=(x: js.Array[typingsSlinky.cookieclicker.Game.buffType]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("buffTypes")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def cookieUpgrades: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    @scala.inline
    def cookieUpgrades_=(x: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cookieUpgrades")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def crate(
      me: typingsSlinky.cookieclicker.Game.Achievement,
    ...
    @js.native
    def crate(
      me: typingsSlinky.cookieclicker.Game.Upgrade,
      context: js.UndefOr[scala.Nothing],
      forceClickStr: String,
      id: String
    ): String = js.native
    ...
    @js.native
    def crateTooltip(me: typingsSlinky.cookieclicker.Game.Achievement): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip(me: typingsSlinky.cookieclicker.Game.Upgrade): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_ascend(me: typingsSlinky.cookieclicker.Game.Achievement, context: ascend): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_ascend(me: typingsSlinky.cookieclicker.Game.Upgrade, context: ascend): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_stats(me: typingsSlinky.cookieclicker.Game.Achievement, context: stats): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_stats(me: typingsSlinky.cookieclicker.Game.Upgrade, context: stats): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_store(me: typingsSlinky.cookieclicker.Game.Achievement, context: store): String = js.native
    @JSGlobal("Game.crateTooltip")
    @js.native
    def crateTooltip_store(me: typingsSlinky.cookieclicker.Game.Upgrade, context: store): String = js.native
    ...
    @JSGlobal("Game.crate")
    @js.native
    def crate_ascend(me: typingsSlinky.cookieclicker.Game.Upgrade, context: ascend, forceClickStr: String, id: String): String = js.native
    @JSGlobal("Game.crate")
    @js.native
    def crate_stats(
      me: typingsSlinky.cookieclicker.Game.Achievement,
    ...
    @JSGlobal("Game.crate")
    @js.native
    def crate_stats(me: typingsSlinky.cookieclicker.Game.Upgrade, context: stats, forceClickStr: String, id: String): String = js.native
    @JSGlobal("Game.crate")
    @js.native
    def crate_store(
      me: typingsSlinky.cookieclicker.Game.Achievement,
    ...
    @JSGlobal("Game.crate")
    @js.native
    def crate_store(me: typingsSlinky.cookieclicker.Game.Upgrade, context: store, forceClickStr: String, id: String): String = js.native
    ...
    def goldenCookieBuildingBuffs: Record[
        /* keyof std.Record<string, cookieclicker.Game.GameObject> & cookieclicker.anon.Bank */ Farm | Temple | (`Wizard tower`) | typingsSlinky.cookieclicker.cookieclickerStrings.Bank, 
    ...
    @js.native
    def isMinigameReady(me: typingsSlinky.cookieclicker.Game.GameObject): Unit = js.native
    ...
    @JSGlobal("Game.last")
    @js.native
    def last: typingsSlinky.cookieclicker.Game.GameObject | typingsSlinky.cookieclicker.Game.Upgrade | typingsSlinky.cookieclicker.Game.Achievement = js.native
    ...
    @scala.inline
    def last_=(
      x: typingsSlinky.cookieclicker.Game.GameObject | typingsSlinky.cookieclicker.Game.Upgrade | typingsSlinky.cookieclicker.Game.Achievement
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("last")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Game.listTinyOwnedUpgrades")
    @js.native
    def listTinyOwnedUpgrades(arr: js.Array[typingsSlinky.cookieclicker.Game.Upgrade]): String = js.native
    ...
    @js.native
    def scriptBindings: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.GameObject]) = js.native
    @scala.inline
    def scriptBindings_=(
      x: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.GameObject])
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("scriptBindings")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Game.scriptLoaded")
    @js.native
    def scriptLoaded(who: typingsSlinky.cookieclicker.Game.GameObject, script: String): Unit = js.native
    ...
    def shimmers: js.Array[
        typingsSlinky.cookieclicker.Game.Shimmer[/* keyof std.Record<string, cookieclicker.Game.ShimmerType> */ String, js.Object]
      ] = js.native
  ...
  @js.native
  class Loader ()
    extends typingsSlinky.cookieclicker.Loader
