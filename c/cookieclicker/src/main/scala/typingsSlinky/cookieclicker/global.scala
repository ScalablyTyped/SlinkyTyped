...
object global extends js.Object {
  ...
  object Game extends js.Object {
    ...
    var Achievements: js.Array[typingsSlinky.cookieclicker.Game.Achievement] = js.native
    
    var AchievementsById: js.Array[typingsSlinky.cookieclicker.Game.Achievement] = js.native
    ...
    var Loader: typingsSlinky.cookieclicker.Loader = js.native
    ...
    var Milk: typingsSlinky.cookieclicker.Game.Milk = js.native
    ...
    var Notes: js.Array[typingsSlinky.cookieclicker.Game.Note] = js.native
    
    var NotesById: js.Array[typingsSlinky.cookieclicker.Game.Note] = js.native
    ...
    var Objects: (Record[String, typingsSlinky.cookieclicker.Game.GameObject]) with Bank = js.native
    
    var ObjectsById: js.Array[typingsSlinky.cookieclicker.Game.GameObject] = js.native
    ...
    var Upgrades: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.Upgrade]) = js.native
    
    var UpgradesById: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    
    var UpgradesInStore: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    ...
    var buffTypes: js.Array[typingsSlinky.cookieclicker.Game.buffType] = js.native
    
    var buffTypesByName: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.buffType]) = js.native
    ...
    var cookieUpgrades: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    ...
    var last: typingsSlinky.cookieclicker.Game.GameObject | typingsSlinky.cookieclicker.Game.Upgrade | typingsSlinky.cookieclicker.Game.Achievement = js.native
    ...
    var scriptBindings: js.Array[js.UndefOr[scala.Nothing]] with (Record[String, typingsSlinky.cookieclicker.Game.GameObject]) = js.native
    ...
    object UpgradesByPool extends js.Object {
      ...
      @JSName("")
      var _empty: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var cookie: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var debug: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var prestige: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var prestigeDecor: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var tech: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var toggle: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
      
      var unused: js.Array[typingsSlinky.cookieclicker.Game.Upgrade] = js.native
    }
