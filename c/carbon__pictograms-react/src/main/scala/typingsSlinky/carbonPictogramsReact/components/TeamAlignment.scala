...
object TeamAlignment {
  
  @JSImport("@carbon/pictograms-react", "TeamAlignment")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TeamAlignment.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
