...
object Chart3D {
  ...
  @JSImport("@carbon/pictograms-react", "Chart3D")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Chart3D.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
