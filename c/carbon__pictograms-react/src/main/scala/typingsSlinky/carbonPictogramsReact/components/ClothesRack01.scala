...
object ClothesRack01 {
  
  @JSImport("@carbon/pictograms-react", "ClothesRack01")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ClothesRack01.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
