...
object Microorganisms {
  
  @JSImport("@carbon/pictograms-react", "Microorganisms")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Microorganisms.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
