...
object AugmentedReality {
  
  @JSImport("@carbon/pictograms-react", "AugmentedReality")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AugmentedReality.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
