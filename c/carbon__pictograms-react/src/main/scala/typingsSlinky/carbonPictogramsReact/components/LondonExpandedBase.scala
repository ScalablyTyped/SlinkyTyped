...
object LondonExpandedBase {
  
  @JSImport("@carbon/pictograms-react", "LondonExpandedBase")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LondonExpandedBase.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
