...
object GlobalAssetsAndRecovery01 {
  
  @JSImport("@carbon/pictograms-react", "GlobalAssetsAndRecovery01")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: GlobalAssetsAndRecovery01.type): SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes_989792279[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
