...
import typingsSlinky.cleanCss.anon.SourceMap
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.cleanCss.mod.MinifierOutput
    - typingsSlinky.cleanCss.mod.MinifierPromise
  */
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def OptionsOutput(): typingsSlinky.cleanCss.mod.OptionsOutput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.cleanCss.mod.OptionsOutput]
    }
    
    @scala.inline
    def OptionsPromise(returnPromise: `true`): typingsSlinky.cleanCss.mod.OptionsPromise = {
      val __obj = js.Dynamic.literal(returnPromise = returnPromise.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.cleanCss.mod.OptionsPromise]
    }
  }
  ...
  object OptionsBase {
    ...
    implicit class OptionsBaseMutableBuilder[Self <: OptionsBase] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInlineRequest(value: RequestOptions | typingsSlinky.node.httpsMod.RequestOptions): Self = StObject.set(x, "inlineRequest", value.asInstanceOf[js.Any])
