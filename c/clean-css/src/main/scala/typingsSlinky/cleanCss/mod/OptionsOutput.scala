...
/**
  ...
  */
/* Inlined clean-css.clean-css.OptionsBase & {  returnPromise ? :false} */
@js.native
...
object OptionsOutput {
  ...
  implicit class OptionsOutputOps[Self <: OptionsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReturnPromise(value: `false`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("returnPromise")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutReturnPromise: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("returnPromise")(js.undefined)
        ret
    }
    @scala.inline
