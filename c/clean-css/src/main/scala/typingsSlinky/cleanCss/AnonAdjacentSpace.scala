...
object AnonAdjacentSpace {
  @scala.inline
  def apply(mergeLimit: Double, mergeablePseudoElements: js.Array[String], multiplePseudoMerging: Boolean): AnonAdjacentSpace = {
  ...
  @scala.inline
  implicit class AnonAdjacentSpaceOps[Self <: AnonAdjacentSpace] (val x: Self) extends AnyVal {
    @scala.inline
