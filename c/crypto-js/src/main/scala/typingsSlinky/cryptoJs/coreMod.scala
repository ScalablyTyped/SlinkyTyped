...
object coreMod {
  ...
  @JSImport("crypto-js/core", "EvpKDF")
  @js.native
  ...
  @JSImport("crypto-js/core", "PBKDF2")
  @js.native
  ...
  @JSImport("crypto-js/core", "RC4")
  @js.native
  val RC4: CipherHelper = js.native
  
  @JSImport("crypto-js/core", "RC4Drop")
  @js.native
  val RC4Drop: CipherHelper = js.native
  
  @JSImport("crypto-js/core", "RIPEMD160")
  @js.native
  val RIPEMD160: HasherHelper = js.native
  
  @JSImport("crypto-js/core", "Rabbit")
  @js.native
  val Rabbit: CipherHelper = js.native
  
  @JSImport("crypto-js/core", "RabbitLegacy")
  @js.native
  val RabbitLegacy: CipherHelper = js.native
  
  @JSImport("crypto-js/core", "SHA1")
  @js.native
  val SHA1: HasherHelper = js.native
  
  @JSImport("crypto-js/core", "SHA224")
  @js.native
  ...
  @JSImport("crypto-js/core", "SHA3")
  @js.native
  val SHA3: HasherHelper = js.native
  
  @JSImport("crypto-js/core", "SHA384")
  @js.native
  val SHA384: HasherHelper = js.native
  
  @JSImport("crypto-js/core", "SHA512")
  @js.native
  val SHA512: HasherHelper = js.native
  
  @JSImport("crypto-js/core", "TripleDES")
  @js.native
  ...
  object algo {
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.AES")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.DES")
    @js.native
    ...
    object EvpKDF {
      ...
      /**
        ...
        */
      /* static member */
      @JSImport("crypto-js/core", "algo.EvpKDF.create")
      @js.native
    ...
    object HMAC {
      ...
      @JSImport("crypto-js/core", "algo.HMAC.create")
      @js.native
    ...
    /**
      * MD5 hash algorithm.
      */
    @JSImport("crypto-js/core", "algo.MD5")
    @js.native
    ...
    object PBKDF2 {
      ...
      /**
        ...
        */
      /* static member */
      @JSImport("crypto-js/core", "algo.PBKDF2.create")
      @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.RC4")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.RC4Drop")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.RIPEMD160")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.Rabbit")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.RabbitLegacy")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA1")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA224")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA256")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA3")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA384")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.SHA512")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "algo.TripleDES")
    @js.native
  ...
  object enc {
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Base64")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Hex")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Latin1")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Utf16")
    @js.native
    val Utf16: Encoder = js.native
    
    @JSImport("crypto-js/core", "enc.Utf16BE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Utf16LE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "enc.Utf8")
    @js.native
  ...
  object format {
    ...
    @JSImport("crypto-js/core", "format.Hex")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "format.OpenSSL")
    @js.native
  ...
  object kdf {
    ...
    object OpenSSL {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "kdf.OpenSSL.execute")
      @js.native
  ...
  object lib {
    ...
    object Base {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.Base.create")
      @js.native
      ...
      /**
        ...
        *     });
        */
      @JSImport("crypto-js/core", "lib.Base.extend")
      @js.native
      ...
      /**
        ...
        *     });
        */
      @JSImport("crypto-js/core", "lib.Base.mixIn")
      @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "lib.BlockCipherMode")
    @js.native
    val BlockCipherMode: js.Any = js.native
    
    @JSImport("crypto-js/core", "lib.BufferedBlockAlgorithm")
    @js.native
    ...
    object Cipher {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.Cipher._createHelper")
      @js.native
    ...
    object CipherParams {
      ...
      /**
        ...
        *     });
        */
      @JSImport("crypto-js/core", "lib.CipherParams.create")
      @js.native
    ...
    object Hasher {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.Hasher._createHelper")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.Hasher._createHmacHelper")
      @js.native
    ...
    object PasswordBasedCipher {
      ...
      @JSImport("crypto-js/core", "lib.PasswordBasedCipher.decrypt")
      @js.native
      ...
      @JSImport("crypto-js/core", "lib.PasswordBasedCipher.encrypt")
      @js.native
    ...
    object SerializableCipher {
      ...
      @JSImport("crypto-js/core", "lib.SerializableCipher.decrypt")
      @js.native
      def decrypt(
        cipher: CipherStatic,
        ciphertext: String,
      ...
      @JSImport("crypto-js/core", "lib.SerializableCipher.encrypt")
      @js.native
      def encrypt(
        cipher: CipherStatic,
        message: String,
      ...
      @JSImport("crypto-js/core", "lib.SerializableCipher._parse")
      @js.native
    ...
    object WordArray {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.WordArray.create")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "lib.WordArray.random")
      @js.native
  ...
  object mode {
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "mode.CBC")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "mode.CFB")
    @js.native
    ...
    /**
      * Counter block mode.
      */
    @JSImport("crypto-js/core", "mode.CTR")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "mode.CTRGladman")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "mode.ECB")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "mode.OFB")
    @js.native
  ...
  object pad {
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.AnsiX923")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.Iso10126")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.Iso97971")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.NoPadding")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.Pkcs7")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("crypto-js/core", "pad.ZeroPadding")
    @js.native
  ...
  object x64 {
    ...
    object Word {
      ...
      /**
        ...
        */
      @JSImport("crypto-js/core", "x64.Word.create")
      @js.native
    ...
    object WordArray {
      ...
      @JSImport("crypto-js/core", "x64.WordArray.create")
      @js.native
