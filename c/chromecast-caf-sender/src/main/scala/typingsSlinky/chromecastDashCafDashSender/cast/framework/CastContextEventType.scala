...
object CastContextEventType extends js.Object {
  ...
  /* "caststatechanged" */ val CAST_STATE_CHANGED: typingsSlinky.chromecastDashCafDashSender.cast.framework.CastContextEventType.CAST_STATE_CHANGED with String = js.native
  /* "sessionstatechanged" */ val SESSION_STATE_CHANGED: typingsSlinky.chromecastDashCafDashSender.cast.framework.CastContextEventType.SESSION_STATE_CHANGED with String = js.native
  @JSBracketAccess
