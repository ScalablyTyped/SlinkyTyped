...
object ActiveInputState extends js.Object {
  ...
  /* 0 */ val ACTIVE_INPUT_STATE_NO: typingsSlinky.chromecastDashCafDashSender.cast.framework.ActiveInputState.ACTIVE_INPUT_STATE_NO with Double = js.native
  /* -1 */ val ACTIVE_INPUT_STATE_UNKNOWN: typingsSlinky.chromecastDashCafDashSender.cast.framework.ActiveInputState.ACTIVE_INPUT_STATE_UNKNOWN with Double = js.native
  /* 1 */ val ACTIVE_INPUT_STATE_YES: typingsSlinky.chromecastDashCafDashSender.cast.framework.ActiveInputState.ACTIVE_INPUT_STATE_YES with Double = js.native
  @JSBracketAccess
