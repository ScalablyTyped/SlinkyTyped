...
import typingsSlinky.chromecastCafSender.cast.framework.SavedPlayerState
...
class RemotePlayer ()
  ...
  /* CompleteClass */
  override var controller: typingsSlinky.chromecastCafSender.cast.framework.RemotePlayerController | Null = js.native
  /* CompleteClass */
