...
object Utils_ {
  ...
  implicit class Utils_Ops[Self <: Utils_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEquals(value: (js.Any, js.Any) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("equals")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withFromJson(value: String => js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIsNumber(value: js.Any => Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIsString(value: js.Any => Boolean): Self = {
        val ret = this.duplicate
