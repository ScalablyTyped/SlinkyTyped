...
import typingsSlinky.classDashTransformer.classDashTransformerMod.TransformationType
...
import typingsSlinky.classDashTransformer.metadataExposeExcludeOptionsMod.ExcludeOptions
import typingsSlinky.classDashTransformer.metadataExposeExcludeOptionsMod.ExposeOptions
import typingsSlinky.classDashTransformer.metadataExposeExcludeOptionsMod.TransformOptions
import typingsSlinky.classDashTransformer.metadataExposeExcludeOptionsMod.TypeHelpOptions
import typingsSlinky.classDashTransformer.metadataExposeExcludeOptionsMod.TypeOptions
...
@js.native
object classDashTransformerMod extends js.Object {
  @js.native
  class ClassTransformer ()
    extends typingsSlinky.classDashTransformer.classTransformerMod.ClassTransformer
  ...
  def Transform(
    transformFn: js.Function3[
      /* value */ js.Any, 
      /* obj */ js.Any, 
      /* transformationType */ typingsSlinky.classDashTransformer.transformOperationExecutorMod.TransformationType, 
      _
    ]
  ...
  object TransformationType extends js.Object {
    ...
    /* 2 */ val CLASS_TO_CLASS: typingsSlinky.classDashTransformer.classDashTransformerMod.TransformationType.CLASS_TO_CLASS with Double = js.native
    /* 1 */ val CLASS_TO_PLAIN: typingsSlinky.classDashTransformer.classDashTransformerMod.TransformationType.CLASS_TO_PLAIN with Double = js.native
    /* 0 */ val PLAIN_TO_CLASS: typingsSlinky.classDashTransformer.classDashTransformerMod.TransformationType.PLAIN_TO_CLASS with Double = js.native
    @JSBracketAccess
