...
object mod {
  ...
  object TransformationType extends StObject {
    ...
    /* 2 */ val CLASS_TO_CLASS: typingsSlinky.classTransformer.mod.TransformationType.CLASS_TO_CLASS with Double = js.native
    
    @js.native
    sealed trait CLASS_TO_PLAIN extends TransformationType
    /* 1 */ val CLASS_TO_PLAIN: typingsSlinky.classTransformer.mod.TransformationType.CLASS_TO_PLAIN with Double = js.native
    
    @js.native
    sealed trait PLAIN_TO_CLASS extends TransformationType
    /* 0 */ val PLAIN_TO_CLASS: typingsSlinky.classTransformer.mod.TransformationType.PLAIN_TO_CLASS with Double = js.native
  }
