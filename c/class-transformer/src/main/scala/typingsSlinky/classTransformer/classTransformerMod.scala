...
object classTransformerMod extends js.Object {
  ...
  class ClassTransformer () extends js.Object {
    ...
    def plainToClassFromExist[T /* <: js.Object */, V](clsObject: T, plain: V): js.Array[T] = js.native
    def plainToClassFromExist[T /* <: js.Object */, V](clsObject: T, plain: V, options: ClassTransformOptions): js.Array[T] = js.native
    /**
    ...
    def plainToClassFromExist_T_ObjectV_ArrayWildcard_T[T /* <: js.Object */, V /* <: js.Array[_] */](clsObject: T, plain: V): T = js.native
    @JSName("plainToClassFromExist")
    def plainToClassFromExist_T_ObjectV_ArrayWildcard_T[T /* <: js.Object */, V /* <: js.Array[_] */](clsObject: T, plain: V, options: ClassTransformOptions): T = js.native
    @JSName("plainToClass")
