...
trait CorsOptions extends js.Object {
  ...
  var origin: js.UndefOr[Boolean | String | js.RegExp | (js.Array[String | js.RegExp]) | CustomOrigin] = js.undefined
...
object CorsOptions {
  ...
  def apply(
    ...
    origin: Boolean | String | js.RegExp | (js.Array[String | js.RegExp]) | CustomOrigin = null,
