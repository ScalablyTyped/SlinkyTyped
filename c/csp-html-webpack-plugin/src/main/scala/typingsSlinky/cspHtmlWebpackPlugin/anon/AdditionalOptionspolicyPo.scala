package typingsSlinky.cspHtmlWebpackPlugin.anon
...
import typingsSlinky.cspHtmlWebpackPlugin.mod.HtmlPluginData
import typingsSlinky.cspHtmlWebpackPlugin.mod.Policy
...
object AdditionalOptionspolicyPo {
  ...
  @scala.inline
  implicit class AdditionalOptionspolicyPoOps[Self <: AdditionalOptionspolicyPo] (val x: Self) extends AnyVal {
    @scala.inline
