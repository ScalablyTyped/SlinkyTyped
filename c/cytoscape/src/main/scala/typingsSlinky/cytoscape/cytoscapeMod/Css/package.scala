...
package object Css {
  ...
  */
  ...
  type PropertyValue[SingularType /* <: NodeSingular | EdgeSingular | typingsSlinky.cytoscape.cytoscapeMod.Css.Core */, Type] = Type | (MapperFunction[SingularType, Type])
  type PropertyValueCore[Type] = PropertyValue[typingsSlinky.cytoscape.cytoscapeMod.Css.Core, Type]
