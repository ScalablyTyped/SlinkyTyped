...
object Stylesheet {
  @scala.inline
  def StylesheetStyle(selector: String, style: Node | Edge | typingsSlinky.cytoscape.cytoscapeMod.Css.Core): Stylesheet = {
    val __obj = js.Dynamic.literal(selector = selector.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Stylesheet]
  }
  @scala.inline
  def StylesheetCSS(css: Node | Edge | typingsSlinky.cytoscape.cytoscapeMod.Css.Core, selector: String): Stylesheet = {
