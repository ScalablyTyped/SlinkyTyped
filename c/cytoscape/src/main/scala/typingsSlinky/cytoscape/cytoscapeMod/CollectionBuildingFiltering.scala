...
import typingsSlinky.cytoscape.Anon_Both
import typingsSlinky.cytoscape.Anon_Ele
...
trait CollectionBuildingFiltering[TIn, TOut] extends js.Object {
  ...
  def diff(selector: CollectionArgument): Anon_Both = js.native
  /**
    ...
    */
  def diff(selector: Selector): Anon_Both = js.native
  /**
    * Get a new collection, resulting from the collection without some specified elements.
    * http://js.cytoscape.org/#eles.difference
    */
  ...
  /**
    ...
    */
  def max[T](fn: js.Function3[/* ele */ TIn, /* i */ Double, /* eles */ CollectionArgument, T]): Anon_Ele[T] = js.native
  def max[T](fn: js.Function3[/* ele */ TIn, /* i */ Double, /* eles */ CollectionArgument, T], thisArg: js.Any): Anon_Ele[T] = js.native
  /**
  ...
  /**
    ...
    */
  def min[T](fn: js.Function3[/* ele */ TIn, /* i */ Double, /* eles */ CollectionArgument, T]): Anon_Ele[T] = js.native
  def min[T](fn: js.Function3[/* ele */ TIn, /* i */ Double, /* eles */ CollectionArgument, T], thisArg: js.Any): Anon_Ele[T] = js.native
