...
object Labels {
  ...
  @scala.inline
  implicit class LabelsOps[Self <: Labels[_], /* <: typingsSlinky.cytoscape.mod.NodeSingular | typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Labels[SingularType]) extends AnyVal {
    @scala.inline
