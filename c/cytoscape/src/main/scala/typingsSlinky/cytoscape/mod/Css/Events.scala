...
object Events {
  ...
  @scala.inline
  implicit class EventsOps[Self <: Events[_], /* <: typingsSlinky.cytoscape.mod.NodeSingular | typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Events[SingularType]) extends AnyVal {
    @scala.inline
