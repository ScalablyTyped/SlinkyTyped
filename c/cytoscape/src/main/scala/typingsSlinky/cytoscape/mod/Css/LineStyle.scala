...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.cytoscape.cytoscapeStrings.solid
  - typingsSlinky.cytoscape.cytoscapeStrings.dotted
  - typingsSlinky.cytoscape.cytoscapeStrings.dashed
  - typingsSlinky.cytoscape.cytoscapeStrings.double
*/
