...
object NodeCollectionMetadata {
  ...
  implicit class NodeCollectionMetadataOps[Self <: NodeCollectionMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxDegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxDegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMaxIndegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxIndegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMaxOutdegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxOutdegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMinDegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minDegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMinIndegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minIndegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMinOutdegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minOutdegree")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTotalDegree(value: Boolean => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("totalDegree")(js.Any.fromFunction1(value))
        ret
    }
  }
