...
object Visibility {
  @scala.inline
  def apply[/* <: typingsSlinky.cytoscape.mod.NodeSingular | typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType](
  ...
  @scala.inline
  implicit class VisibilityOps[Self <: Visibility[_], /* <: typingsSlinky.cytoscape.mod.NodeSingular | typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Visibility[SingularType]) extends AnyVal {
    @scala.inline
