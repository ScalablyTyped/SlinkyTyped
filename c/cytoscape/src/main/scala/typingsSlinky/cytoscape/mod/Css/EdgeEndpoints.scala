...
object EdgeEndpoints {
  @scala.inline
  def apply[/* <: typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType](
  ...
  @scala.inline
  implicit class EdgeEndpointsOps[Self <: EdgeEndpoints[_], /* <: typingsSlinky.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with EdgeEndpoints[SingularType]) extends AnyVal {
    @scala.inline
