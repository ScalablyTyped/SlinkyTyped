...
import typingsSlinky.cytoscape.mod.CollectionEventName
...
import typingsSlinky.cytoscape.mod.SelectionType
import typingsSlinky.cytoscape.mod.UserInputDeviceEventName
import typingsSlinky.cytoscape.mod.UserInputDeviceEventNameExt
...
object cytoscapeStrings {
  ...
  @js.native
  sealed trait base64uri extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait breadthfirst extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait clipped extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait concentric extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait cose extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait haystack extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `linear-gradient` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `node-position` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `radial-gradient` extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait `unbundled-bezier` extends StObject
  @scala.inline
