...
trait PseudoClassSelector
  ...
  @JSName("type")
  var type_PseudoClassSelector: typingsSlinky.cssTree.cssTreeStrings.PseudoClassSelector = js.native
}

object PseudoClassSelector {
  @scala.inline
  def apply(name: String, `type`: typingsSlinky.cssTree.cssTreeStrings.PseudoClassSelector): PseudoClassSelector = {
