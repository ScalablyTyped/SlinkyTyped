...
object WalkOptionsVisit {
  @scala.inline
  def apply[/* <: typingsSlinky.cssTree.mod.CssNode */ NodeType](
  ...
  @scala.inline
  implicit class WalkOptionsVisitOps[Self <: WalkOptionsVisit[_], /* <: typingsSlinky.cssTree.mod.CssNode */ NodeType] (val x: Self with WalkOptionsVisit[NodeType]) extends AnyVal {
    @scala.inline
