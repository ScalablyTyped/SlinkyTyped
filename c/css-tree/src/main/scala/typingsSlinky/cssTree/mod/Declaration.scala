...
trait Declaration
  ...
  @JSName("type")
  var type_Declaration: typingsSlinky.cssTree.cssTreeStrings.Declaration = js.native
...
object Declaration {
  ...
  implicit class DeclarationMutableBuilder[Self <: Declaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.cssTree.cssTreeStrings.Declaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
