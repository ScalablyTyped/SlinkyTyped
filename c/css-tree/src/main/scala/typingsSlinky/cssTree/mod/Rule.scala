...
trait Rule
  ...
  @JSName("type")
  var type_Rule: typingsSlinky.cssTree.cssTreeStrings.Rule = js.native
}
object Rule {
  
  @scala.inline
  def apply(block: Block, prelude: SelectorList | Raw, `type`: typingsSlinky.cssTree.cssTreeStrings.Rule): Rule = {
  ...
  implicit class RuleMutableBuilder[Self <: Rule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.cssTree.cssTreeStrings.Rule): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
