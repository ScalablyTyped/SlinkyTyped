...
trait ParenthesesPlain
  ...
  @JSName("type")
  var type_ParenthesesPlain: typingsSlinky.cssTree.cssTreeStrings.Parentheses = js.native
}
object ParenthesesPlain {
  
  @scala.inline
  def apply(children: js.Array[CssNodePlain], `type`: typingsSlinky.cssTree.cssTreeStrings.Parentheses): ParenthesesPlain = {
