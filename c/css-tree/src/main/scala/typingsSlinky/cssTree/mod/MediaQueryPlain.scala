...
trait MediaQueryPlain
  ...
  @JSName("type")
  var type_MediaQueryPlain: typingsSlinky.cssTree.cssTreeStrings.MediaQuery = js.native
}
object MediaQueryPlain {
  
  @scala.inline
  def apply(children: js.Array[CssNodePlain], `type`: typingsSlinky.cssTree.cssTreeStrings.MediaQuery): MediaQueryPlain = {
  ...
  implicit class MediaQueryPlainMutableBuilder[Self <: MediaQueryPlain] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.cssTree.cssTreeStrings.MediaQuery): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
