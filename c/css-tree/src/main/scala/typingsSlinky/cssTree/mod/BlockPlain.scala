...
trait BlockPlain
  ...
  @JSName("type")
  var type_BlockPlain: typingsSlinky.cssTree.cssTreeStrings.Block = js.native
}
object BlockPlain {
  
  @scala.inline
  def apply(children: js.Array[CssNodePlain], `type`: typingsSlinky.cssTree.cssTreeStrings.Block): BlockPlain = {
  ...
  implicit class BlockPlainOps[Self <: BlockPlain] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.cssTree.cssTreeStrings.Block): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
