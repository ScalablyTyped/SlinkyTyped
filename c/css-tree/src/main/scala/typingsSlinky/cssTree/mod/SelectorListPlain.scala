...
trait SelectorListPlain
  ...
  @JSName("type")
  var type_SelectorListPlain: typingsSlinky.cssTree.cssTreeStrings.SelectorList = js.native
}
object SelectorListPlain {
  
  @scala.inline
  def apply(children: js.Array[CssNodePlain], `type`: typingsSlinky.cssTree.cssTreeStrings.SelectorList): SelectorListPlain = {
  ...
  implicit class SelectorListPlainMutableBuilder[Self <: SelectorListPlain] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.cssTree.cssTreeStrings.SelectorList): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
