...
import typingsSlinky.csstype.csstypeMod.ObsoletePropertiesFallback
...
import typingsSlinky.csstype.csstypeMod.VendorLonghandPropertiesFallback
import typingsSlinky.csstype.csstypeMod.VendorShorthandPropertiesFallback
