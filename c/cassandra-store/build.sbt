...
version := "5.0-dt-20201109Z-717d34"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "cassandra-driver" % "4.6.0-b39540",
  ...
  "org.scalablytyped.slinky" %%% "express-session" % "1.17-dt-20201119Z-e42e36",
  "org.scalablytyped.slinky" %%% "long" % "4.0.0-dt-20201002Z-a267ab",
