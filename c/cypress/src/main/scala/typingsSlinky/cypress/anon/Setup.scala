...
@js.native
trait Setup[TTarget, TData] extends SpecialEventHook[TTarget, TData] {
  /**
...
object Setup {
  ...
  @scala.inline
  implicit class SetupOps[Self[ttarget, tdata] <: Setup[ttarget, tdata], TTarget, TData] (val x: Self[TTarget, TData]) extends AnyVal {
    @scala.inline
