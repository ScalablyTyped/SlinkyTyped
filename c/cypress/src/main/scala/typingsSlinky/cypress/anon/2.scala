...
@js.native
trait `2`[TTarget, TData] extends SpecialEventHook[TTarget, TData] {
  /**
...
object `2` {
  ...
  @scala.inline
  implicit class `2Ops`[Self[ttarget, tdata] <: `2`[ttarget, tdata], TTarget, TData] (val x: Self[TTarget, TData]) extends AnyVal {
    @scala.inline
