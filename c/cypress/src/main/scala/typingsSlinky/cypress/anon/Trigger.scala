...
@js.native
trait Trigger[TTarget, TData] extends SpecialEventHook[TTarget, TData] {
  /**
...
object Trigger {
  ...
  @scala.inline
  implicit class TriggerOps[Self[ttarget, tdata] <: Trigger[ttarget, tdata], TTarget, TData] (val x: Self[TTarget, TData]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTrigger(value: (Event, TData) => Unit | `false`): Self[TTarget, TData] = {
