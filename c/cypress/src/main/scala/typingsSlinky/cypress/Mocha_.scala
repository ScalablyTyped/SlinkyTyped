...
import typingsSlinky.cypress.Mocha.MochaInstanceOptions
...
class Mocha_ () extends js.Object {
  ...
  def reporter(reporter: typingsSlinky.cypress.Mocha.ReporterConstructor): this.type = js.native
  def reporter(reporter: typingsSlinky.cypress.Mocha.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
