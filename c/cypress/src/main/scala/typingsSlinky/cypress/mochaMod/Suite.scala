...
class Suite protected ()
  extends typingsSlinky.cypress.Mocha.Suite {
...
object Suite extends js.Object {
  ...
  def create(parent: ISuite, title: String): typingsSlinky.cypress.Mocha.Suite = js.native
  /**
    ...
    */
  def create(parent: typingsSlinky.cypress.Mocha.Suite, title: String): typingsSlinky.cypress.Mocha.Suite = js.native
}
