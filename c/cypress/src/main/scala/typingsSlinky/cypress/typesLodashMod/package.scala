...
package object typesLodashMod {
  import org.scalablytyped.runtime.NumberDictionary
  import org.scalablytyped.runtime.StringDictionary
  import typingsSlinky.cypress.GlobalPartial
  ...
  {[ P in keyof T ]:? (val : T[P]): boolean}
    */ typingsSlinky.cypress.cypressStrings.ConformsPredicateObject with T
  ...
  {[ P in keyof T ]:? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias cypress.cypress/types/lodash.PartialDeep<T[P]> * / object}
    */ typingsSlinky.cypress.cypressStrings.PartialDeep with js.Any
