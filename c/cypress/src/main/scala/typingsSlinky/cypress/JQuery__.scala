...
import typingsSlinky.cypress.JQuery_.Coordinates
import typingsSlinky.cypress.JQuery_.CoordinatesPartial
import typingsSlinky.cypress.JQuery_.Duration
import typingsSlinky.cypress.JQuery_.EffectsOptions
import typingsSlinky.cypress.JQuery_.NameValuePair
import typingsSlinky.cypress.JQuery_.Node
...
import typingsSlinky.cypress.JQuery_.TypeEventHandler
import typingsSlinky.cypress.JQuery_.TypeEventHandlers
...
trait JQuery__[TElement]
  ...
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event): this.type = js.native
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: typingsSlinky.cypress.JQuery_.Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
