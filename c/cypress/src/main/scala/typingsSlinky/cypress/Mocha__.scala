...
import typingsSlinky.cypress.Mocha_.MochaInstanceOptions
...
class Mocha__ () extends js.Object {
  ...
  def reporter(reporter: typingsSlinky.cypress.Mocha_.ReporterConstructor): this.type = js.native
  def reporter(reporter: typingsSlinky.cypress.Mocha_.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
