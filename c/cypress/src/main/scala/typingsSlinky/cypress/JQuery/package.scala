...
package object JQuery {
  ...
  import typingsSlinky.cypress.Anon_0
  import typingsSlinky.cypress.cypressStrings.get_
  import typingsSlinky.cypress.cypressStrings.left
  import typingsSlinky.cypress.cypressStrings.set
  import typingsSlinky.cypress.cypressStrings.top
  ...
  */
  ...
  {[ TType in keyof cypress.JQuery.TypeToTriggeredEventMap<TDelegateTarget, TData, TCurrentTarget, TTarget> ]:? cypress.JQuery.TypeEventHandler<TDelegateTarget, TData, TCurrentTarget, TTarget, TType> | false | object}
    */ typingsSlinky.cypress.cypressStrings._TypeEventHandlers with js.Any
  /**
