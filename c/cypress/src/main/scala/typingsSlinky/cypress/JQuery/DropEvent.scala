...
object DropEvent {
  ...
  @scala.inline
  implicit class DropEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DropEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: drop): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
