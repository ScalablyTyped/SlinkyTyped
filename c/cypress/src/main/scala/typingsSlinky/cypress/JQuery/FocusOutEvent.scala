...
object FocusOutEvent {
  ...
  @scala.inline
  implicit class FocusOutEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: FocusOutEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: focusout): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
