...
object DragExitEvent {
  ...
  @scala.inline
  implicit class DragExitEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragExitEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragexit): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
