...
object ResizeEvent {
  ...
  @scala.inline
  implicit class ResizeEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: ResizeEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: resize): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
