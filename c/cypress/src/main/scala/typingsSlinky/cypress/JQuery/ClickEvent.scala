...
object ClickEvent {
  ...
  @scala.inline
  implicit class ClickEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: ClickEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: click): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
