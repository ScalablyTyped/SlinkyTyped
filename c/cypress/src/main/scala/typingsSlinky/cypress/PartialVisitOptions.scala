...
trait PartialVisitOptions extends js.Object {
  ...
  var onBeforeLoad: js.UndefOr[js.Function1[/* win */ Window_, Unit]] = js.native
  var onLoad: js.UndefOr[js.Function1[/* win */ Window_, Unit]] = js.native
...
object PartialVisitOptions {
  ...
  implicit class PartialVisitOptionsOps[Self <: PartialVisitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnBeforeLoad(value: /* win */ Window_ => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnLoad(value: /* win */ Window_ => Unit): Self = {
        val ret = this.duplicate
