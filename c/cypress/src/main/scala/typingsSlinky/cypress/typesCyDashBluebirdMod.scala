...
object typesCyDashBluebirdMod extends js.Object {
  ...
  trait BluebirdStatic
    extends Instantiable1[
          ...
          typingsSlinky.cypress.typesBluebirdMod.^[js.Object]
        ] {
    /**
      ...
      */
    var AggregateError: Instantiable0[typingsSlinky.cypress.typesBluebirdMod.AggregateError] = js.native
    /**
      * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
      */
    var CancellationError: Instantiable0[typingsSlinky.cypress.typesBluebirdMod.CancellationError] = js.native
    /**
      * returned by `Bluebird.disposer()`.
      */
    var Disposer: Instantiable0[typingsSlinky.cypress.typesBluebirdMod.Disposer[js.Object]] = js.native
    /**
      ...
      */
    var OperationalError: Instantiable0[typingsSlinky.cypress.typesBluebirdMod.OperationalError] = js.native
    /**
      * Signals that an operation has timed out. Used as a custom cancellation reason in `.timeout`.
      */
    var TimeoutError: Instantiable0[typingsSlinky.cypress.typesBluebirdMod.TimeoutError] = js.native
    /**
