...
class Suite protected () extends EventEmitter {
  ...
  def addListener_postrequire(
    ...
    listener: js.Function3[
      ...
      /* file */ String, 
      /* mocha */ typingsSlinky.cypress.Mocha, 
      Unit
    ]
  ): this.type = js.native
  @JSName("addListener")
  ...
  def addListener_require(
    event: require,
    listener: js.Function3[/* module */ js.Any, /* file */ String, /* mocha */ typingsSlinky.cypress.Mocha, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_postrequire(name: `post-require`, context: MochaGlobals, file: String, mocha: typingsSlinky.cypress.Mocha): Boolean = js.native
  @JSName("emit")
  def emit_prerequire(name: `pre-require`, context: MochaGlobals, file: String, mocha: typingsSlinky.cypress.Mocha): Boolean = js.native
  @JSName("emit")
  def emit_require(name: require, module: js.Any, file: String, mocha: typingsSlinky.cypress.Mocha): Boolean = js.native
  @JSName("emit")
