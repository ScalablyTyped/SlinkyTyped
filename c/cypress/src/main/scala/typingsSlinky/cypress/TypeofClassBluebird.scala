...
import typingsSlinky.cypress.typesBluebirdMod.Bluebird
import typingsSlinky.cypress.typesBluebirdMod.ConcurrencyOption
import typingsSlinky.cypress.typesBluebirdMod.CoroutineOptions
import typingsSlinky.cypress.typesBluebirdMod.Disposer
import typingsSlinky.cypress.typesBluebirdMod.FromNodeOptions
import typingsSlinky.cypress.typesBluebirdMod.PromisifyAllOptions
import typingsSlinky.cypress.typesBluebirdMod.PromisifyOptions
import typingsSlinky.cypress.typesBluebirdMod.ResolvableProps
import typingsSlinky.cypress.typesBluebirdMod.Resolver
import typingsSlinky.cypress.typesLodashMod._Global_.Map
...
trait TypeofClassBluebird
  ...
  // array with values
  def all[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): Bluebird[js.Array[R]] = js.native
  def all[R](values: Iterable[js.Thenable[R] | R]): Bluebird[js.Array[R]] = js.native
  ...
  /**
    ...
    */
  def any[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): Bluebird[R] = js.native
  def any[R](values: Iterable[js.Thenable[R] | R]): Bluebird[R] = js.native
  ...
  /**
    ...
    */
  def each[R, U](
    values: js.Thenable[Iterable[js.Thenable[R] | R]],
  ...
  /**
    ...
    */
  def race[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): Bluebird[R] = js.native
  def race[R](values: Iterable[js.Thenable[R] | R]): Bluebird[R] = js.native
  /**
  ...
  /**
    ...
    * *The original array is not modified.*
    */
  def some[R](values: js.Thenable[Iterable[js.Thenable[R] | R]], count: Double): Bluebird[js.Array[R]] = js.native
  def some[R](values: Iterable[js.Thenable[R] | R], count: Double): Bluebird[js.Array[R]] = js.native
  /**
