...
import typingsSlinky.cypress.lodashMod.Comparator
...
trait LodashXorWith extends js.Object {
  def apply[T](comparator: Comparator[T]): LodashXorWith1x1[T] = js.native
  ...
  def apply[T](comparator: __): LodashXorWith1x2[T] = js.native
  def apply[T](comparator: __, arrays: js.UndefOr[scala.Nothing], arrays2: List[T]): LodashXorWith1x6[T] = js.native
  def apply[T](comparator: __, arrays: Null, arrays2: List[T]): LodashXorWith1x6[T] = js.native
  def apply[T](comparator: __, arrays: List[T]): LodashXorWith1x2[T] = js.native
