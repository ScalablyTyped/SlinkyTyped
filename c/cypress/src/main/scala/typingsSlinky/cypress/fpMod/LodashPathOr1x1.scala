...
trait LodashPathOr1x1[TDefault] extends js.Object {
  ...
  def apply[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ String */](path: TKey): LodashPathOr1x3[TObject, TKey, TDefault] = js.native
  ...
  def apply[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ String */](path: js.Array[TKey]): LodashPathOr1x3[TObject, TKey, TDefault] = js.native
