...
package object fpMod {
  ...
  type LodashAssignAllWith1x2 = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.AssignCustomizer, js.Any]
  ...
  type LodashAssignInAllWith1x2 = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.AssignCustomizer, js.Any]
  ...
  type LodashAssignInWith1x6[TObject, TSource] = js.Function1[
    /* customizer */ typingsSlinky.cypress.lodashMod.AssignCustomizer, 
  ...
  type LodashAt1x1 = js.Function1[
    /* object */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.List[js.Any] | typingsSlinky.cypress.lodashMod.Dictionary[js.Any] | typingsSlinky.cypress.lodashMod.NumericDictionary[js.Any] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashAt1x2[T] = js.Function1[/* props */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Array[T]]
  ...
  type LodashAt2x2[T] = js.Function1[
    /* props */ typingsSlinky.cypress.lodashMod.Many[/* keyof T */ java.lang.String], 
    js.Array[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ]
  ]
  ...
  type LodashBindAll1x2[T] = js.Function1[/* methodNames */ typingsSlinky.cypress.lodashMod.Many[java.lang.String], T]
  ...
  type LodashCastArray = js.Function1[/* value */ typingsSlinky.cypress.lodashMod.Many[js.Any], js.Array[js.Any]]
  type LodashCeil = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashChunk1x1 = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[js.Any] | scala.Null], 
  ...
  type LodashCloneDeepWith1x2[T] = js.Function1[
    /* customizer */ typingsSlinky.cypress.lodashMod.CloneDeepWithCustomizer[T], 
    js.Any
  ]
  ...
  type LodashCompact = js.Function1[
    /* array */ js.UndefOr[
      (typingsSlinky.cypress.lodashMod.List[
        js.UndefOr[
          js.Any | scala.Null | typingsSlinky.cypress.cypressBooleans.`false` | typingsSlinky.cypress.cypressStrings._empty | typingsSlinky.cypress.cypressNumbers.`0`
        ]
      ]) | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashConcat1x1[T] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.Many[T], js.Array[T]]
  type LodashConcat1x2[T] = js.Function1[/* array */ typingsSlinky.cypress.lodashMod.Many[T], js.Array[T]]
  type LodashCond = js.Function1[
    /* pairs */ js.Array[typingsSlinky.cypress.lodashMod.CondPair[js.Any, js.Any]], 
  ...
  type LodashConformsTo1x2[T] = js.Function1[
    /* source */ typingsSlinky.cypress.lodashMod.ConformsPredicateObject[T], 
    scala.Boolean
  ]
  ...
  type LodashContains1x1[T] = js.Function1[
    /* collection */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.List[T] | typingsSlinky.cypress.lodashMod.Dictionary[T] | typingsSlinky.cypress.lodashMod.NumericDictionary[T] | scala.Null
    ], 
    scala.Boolean
  ]
  type LodashContains1x2[T] = js.Function1[/* target */ T, scala.Boolean]
  type LodashCountBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | js.Object | scala.Null], 
    typingsSlinky.cypress.lodashMod.Dictionary[scala.Double]
  ]
  type LodashCountBy1x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], 
    typingsSlinky.cypress.lodashMod.Dictionary[scala.Double]
  ]
  type LodashCountBy2x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsSlinky.cypress.lodashMod.Dictionary[scala.Double]
  ]
  type LodashCreate = js.Function1[/* prototype */ js.Object, js.Object]
  type LodashCurryN1x2[T1, R] = js.Function1[/* arity */ scala.Double, typingsSlinky.cypress.lodashMod.CurriedFunction1[T1, R]]
  type LodashCurryN2x2[T1, T2, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.CurriedFunction2[T1, T2, R]
  ]
  type LodashCurryN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.CurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.CurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.CurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  ...
  type LodashCurryRightN1x2[T1, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.RightCurriedFunction1[T1, R]
  ]
  type LodashCurryRightN2x2[T1, T2, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.RightCurriedFunction2[T1, T2, R]
  ]
  type LodashCurryRightN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.RightCurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryRightN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.RightCurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryRightN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsSlinky.cypress.lodashMod.RightCurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  ...
  type LodashDebounce1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsSlinky.cypress.lodashMod.Cancelable
  ]
  type LodashDebounce1x2[T] = js.Function1[/* wait */ scala.Double, T with typingsSlinky.cypress.lodashMod.Cancelable]
  ...
  type LodashDifference1x1[T] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashDifference1x2[T] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDifferenceBy1x3[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashDifferenceBy1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashDifferenceBy1x6[T1, T2] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T1 | T2], 
    js.Array[T1]
  ]
  type LodashDifferenceWith1x3[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashDifferenceWith1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashDifferenceWith1x6[T1, T2] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator2[T1, T2], js.Array[T1]]
  ...
  type LodashDropRightWhile1x2[T] = js.Function1[/* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  type LodashDropWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDropWhile1x2[T] = js.Function1[/* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashEvery1x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueIterateeCustom[T, scala.Boolean], 
    scala.Boolean
  ]
  type LodashEvery2x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      scala.Boolean
    ], 
    scala.Boolean
  ...
  type LodashExtendAllWith1x2 = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.AssignCustomizer, js.Any]
  ...
  type LodashFill2x11[U] = js.Function1[/* value */ js.Any, typingsSlinky.cypress.lodashMod.List[js.Any | U]]
  type LodashFill2x13[T, U] = js.Function1[/* end */ scala.Double, typingsSlinky.cypress.lodashMod.List[T | U]]
  type LodashFill2x14[T, U] = js.Function1[/* start */ scala.Double, typingsSlinky.cypress.lodashMod.List[T | U]]
  type LodashFilter1x1[T, S] = js.Function1[
    /* collection */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[S]
  ]
  ...
  type LodashFindKey1x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
  ...
  type LodashFlatMap1x2[T] = js.Function1[
    /* iteratee */ js.Function1[/* value */ T, typingsSlinky.cypress.lodashMod.Many[js.Any]], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMap2x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      ...
      typingsSlinky.cypress.lodashMod.Many[js.Any]
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMapDeep1x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      /* value */ T, 
      typingsSlinky.cypress.lodashMod.ListOfRecursiveArraysOrValues[js.Any] | js.Any
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatten = js.Function1[
    /* array */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.List[typingsSlinky.cypress.lodashMod.Many[js.Any]] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashFlattenDeep = js.Function1[
    /* array */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.ListOfRecursiveArraysOrValues[js.Any] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashForEach2x2[T] = js.Function1[
    ...
    typingsSlinky.cypress.lodashMod.List[T]
  ]
  ...
  type LodashGet8x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashGet9x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashGetOr5x3[TDefault] = js.Function1[
    /* object */ js.UndefOr[typingsSlinky.cypress.lodashMod.NumericDictionary[js.Any] | scala.Null], 
    js.Any | TDefault
  ]
  ...
  type LodashGetOr6x5[TDefault] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, TDefault]
  type LodashGetOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGetOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashGetOr7x5 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  type LodashGetOr7x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGroupBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | js.Object | scala.Null], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Array[T]]
  ]
  ...
  type LodashGroupBy2x2[T] = js.Function1[
    ...
    typingsSlinky.cypress.lodashMod.Dictionary[
      js.Array[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
      ]
    ]
  ...
  type LodashHas1x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, scala.Boolean]
  type LodashHasIn1x1 = js.Function1[/* object */ js.Any, scala.Boolean]
  type LodashHasIn1x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, scala.Boolean]
  ...
  type LodashIntersection1x1[T] = js.Function1[/* arrays */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashIntersection1x2[T] = js.Function1[/* arrays2 */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashIntersectionBy1x3[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashIntersectionBy1x5[T1] = js.Function1[/* array */ typingsSlinky.cypress.lodashMod.List[T1] | scala.Null, js.Array[T1]]
  type LodashIntersectionBy1x6[T1, T2] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T1 | T2], 
    js.Array[T1]
  ]
  type LodashIntersectionWith1x3[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashIntersectionWith1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashIntersectionWith1x6[T1, T2] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator2[T1, T2], js.Array[T1]]
  type LodashInvert = js.Function1[
    /* object */ js.Object, 
    typingsSlinky.cypress.lodashMod.Dictionary[java.lang.String]
  ]
  type LodashInvertBy1x1[T] = js.Function1[
    /* object */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.List[T] | typingsSlinky.cypress.lodashMod.Dictionary[T] | typingsSlinky.cypress.lodashMod.NumericDictionary[T] | js.Object | scala.Null
    ], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvertBy1x2[T] = js.Function1[
    /* interatee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvertBy2x2[T] = js.Function1[
    /* interatee */ typingsSlinky.cypress.lodashMod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvoke1x1 = js.Function1[/* object */ js.Any, js.Any]
  type LodashInvoke1x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashInvokeArgs1x6 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashIsEqualWith1x6 = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.IsEqualCustomizer, scala.Boolean]
  ...
  type LodashIsMatchWith1x6 = js.Function1[
    /* customizer */ typingsSlinky.cypress.lodashMod.isMatchWithCustomizer, 
    scala.Boolean
  ]
  ...
  type LodashKeyBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | js.Object | scala.Null], 
    typingsSlinky.cypress.lodashMod.Dictionary[T]
  ]
  type LodashKeyBy1x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIterateeCustom[T, typingsSlinky.cypress.lodashMod.PropertyName], 
    typingsSlinky.cypress.lodashMod.Dictionary[T]
  ]
  type LodashKeyBy2x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
  ...
  type LodashLastIndexOfFrom1x5 = js.Function1[
    /* fromIndex */ typingsSlinky.cypress.cypressBooleans.`true` | scala.Double, 
    scala.Double
  ]
  ...
  type LodashMap1x1[T, TResult] = js.Function1[
    /* collection */ js.UndefOr[js.Array[T] | typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[TResult]
  ]
  ...
  type LodashMapKeys1x1 = js.Function1[
    /* object */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[js.Any] | scala.Null], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Any]
  ]
  type LodashMapKeys1x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[scala.Double], 
    typingsSlinky.cypress.lodashMod.Dictionary[T]
  ]
  ...
  type LodashMapKeys2x2[T] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[java.lang.String], 
    typingsSlinky.cypress.lodashMod.Dictionary[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ]
  ]
  type LodashMapValues1x1[T, TResult] = js.Function1[
    /* obj */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.Dictionary[T] | typingsSlinky.cypress.lodashMod.NumericDictionary[T] | scala.Null
    ], 
    typingsSlinky.cypress.lodashMod.Dictionary[TResult]
  ]
  type LodashMapValues2x1[T, TResult] = js.Function1[
    /* obj */ js.UndefOr[T | scala.Null], 
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: TResult}
    */ typingsSlinky.cypress.cypressStrings.LodashMapValues2x1 with org.scalablytyped.runtime.TopLevel[js.Any]
  ]
  ...
  type LodashMatchesProperty1x2 = js.Function1[
    /* path */ typingsSlinky.cypress.lodashMod.PropertyPath, 
    js.Function1[/* value */ js.Any, scala.Boolean]
  ]
  type LodashMax = js.Function1[
    /* collection */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[js.Any] | scala.Null], 
    js.UndefOr[js.Any]
  ]
  ...
  type LodashMaxBy1x2[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.UndefOr[T]]
  ...
  type LodashMeanBy1x2[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], scala.Double]
  type LodashMemoize = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsSlinky.cypress.lodashMod.MemoizedFunction
  ]
  ...
  type LodashMergeAllWith1x2 = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.MergeWithCustomizer, js.Any]
  ...
  type LodashMergeWith1x6[TObject, TSource] = js.Function1[
    /* customizer */ typingsSlinky.cypress.lodashMod.MergeWithCustomizer, 
    TObject with TSource
  ]
  ...
  type LodashMethodOf = js.Function1[
    /* object */ js.Object, 
    js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ]
  ...
  type LodashMinBy1x2[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.UndefOr[T]]
  ...
  type LodashNoConflict = js.Function0[typingsSlinky.cypress.anon.TypeofcypressTypesLodas]
  ...
  type LodashOmit1x2[T] = js.Function1[
    /* paths */ typingsSlinky.cypress.lodashMod.Many[typingsSlinky.cypress.lodashMod.PropertyName], 
    T
  ]
  type LodashOmit2x1[T, K /* <: /* keyof T */ java.lang.String */] = js.Function1[
    /* object */ js.UndefOr[T | scala.Null], 
    typingsSlinky.cypress.lodashMod.Omit[T, K]
  ]
  type LodashOmitBy1x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueKeyIteratee[T], 
    typingsSlinky.cypress.lodashMod.Dictionary[T]
  ]
  type LodashOmitBy2x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueKeyIteratee[T], 
    typingsSlinky.cypress.lodashMod.NumericDictionary[T]
  ]
  type LodashOmitBy3x2[T] = js.Function1[
    /* predicate */ typingsSlinky.cypress.lodashMod.ValueKeyIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsSlinky.cypress.lodashMod.PartialObject[T]
  ]
  ...
  type LodashOrderBy1x5[T] = js.Function1[
    /* orders */ typingsSlinky.cypress.lodashMod.Many[
      scala.Boolean | typingsSlinky.cypress.cypressStrings.asc | typingsSlinky.cypress.cypressStrings.desc
    ], 
    js.Array[T]
  ]
  type LodashOrderBy1x6[T] = js.Function1[
    /* iteratees */ typingsSlinky.cypress.lodashMod.Many[
      (js.Function1[/* value */ T, typingsSlinky.cypress.lodashMod.NotVoid]) | typingsSlinky.cypress.lodashMod.ValueIteratee[T]
    ], 
    js.Array[T]
  ]
  ...
  type LodashOrderBy3x6[T] = js.Function1[
    /* iteratees */ typingsSlinky.cypress.lodashMod.Many[
      (js.Function1[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
        typingsSlinky.cypress.lodashMod.NotVoid
      ]) | (typingsSlinky.cypress.lodashMod.ValueIteratee[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
      ])
    ], 
    js.Array[
  ...
  type LodashOver = js.Function1[
    /* iteratees */ typingsSlinky.cypress.lodashMod.Many[js.Function1[/* repeated */ js.Any, js.Any]], 
    js.Function1[/* repeated */ js.Any, js.Array[js.Any]]
  ]
  type LodashOverArgs1x1 = js.Function1[
    /* transforms */ typingsSlinky.cypress.lodashMod.Many[js.Function1[/* repeated */ js.Any, js.Any]], 
    js.Function1[/* repeated */ js.Any, js.Any]
  ]
  ...
  type LodashOverEvery = js.Function1[
    /* predicates */ typingsSlinky.cypress.lodashMod.Many[js.Function1[/* repeated */ js.Any, scala.Boolean]], 
  ...
  type LodashPartial19x2[T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, js.Any, js.Any, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartial1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], typingsSlinky.cypress.lodashMod.Function0[R]]
  type LodashPartial20x2[T1, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, js.Any, js.Any, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial21x2[T2, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, T2, js.Any, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial22x2[T1, T2, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, T2, js.Any, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartial23x2[T3, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, js.Any, T3, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial24x2[T1, T3, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, js.Any, T3, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartial25x2[T2, T3, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, T2, T3, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartial26x2[T1, T2, T3, T4] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, T2, T3, T4, js.Any], 
    typingsSlinky.cypress.lodashMod.Function0[js.Any]
  ]
  ...
  type LodashPartialRight10x2[T2, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[js.Any, T2, T3, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight11x2[T1, T2, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[T1, T2, T3, js.Any], 
    typingsSlinky.cypress.lodashMod.Function0[js.Any]
  ]
  type LodashPartialRight12x2[T1] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, js.Any, js.Any, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight13x2[T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, T2, js.Any, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight14x2[T1, T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, T2, js.Any, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight15x2[T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, js.Any, T3, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight16x2[T1, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, js.Any, T3, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight17x2[T2, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[js.Any, T2, T3, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight18x2[T1, T2, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function4[T1, T2, T3, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPartialRight1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], typingsSlinky.cypress.lodashMod.Function0[R]]
  type LodashPartialRight1x2[T1] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function1[T1, js.Any], 
    typingsSlinky.cypress.lodashMod.Function0[js.Any]
  ]
  ...
  type LodashPartialRight2x2[T1] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function2[T1, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight3x2[T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function2[js.Any, T2, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight4x2[T1, T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function2[T1, T2, js.Any], 
    typingsSlinky.cypress.lodashMod.Function0[js.Any]
  ]
  type LodashPartialRight5x2[T1] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[T1, js.Any, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight6x2[T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[js.Any, T2, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight7x2[T1, T2] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[T1, T2, js.Any, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight8x2[T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[js.Any, js.Any, T3, js.Any], 
    typingsSlinky.cypress.lodashMod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight9x2[T1, T3] = js.Function1[
    /* func */ typingsSlinky.cypress.lodashMod.Function3[T1, js.Any, T3, js.Any], 
    typingsSlinky.cypress.lodashMod.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPartition3x2[T] = js.Function1[
    /* callback */ typingsSlinky.cypress.lodashMod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    js.Tuple2[
      js.Array[
  ...
  type LodashPath8x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashPath9x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashPathOr6x5[TDefault] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, TDefault]
  type LodashPathOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPathOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPathOr7x5 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashPick2x1 = js.Function1[
    ...
    typingsSlinky.cypress.lodashMod.PartialDeep[js.Any]
  ]
  type LodashPick2x2[T] = js.Function1[
    /* props */ typingsSlinky.cypress.lodashMod.PropertyPath, 
  ...
  type LodashProp8x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashProp9x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashPropOr6x5[TDefault] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, TDefault]
  type LodashPropOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPropOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPropOr7x5 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashProperty8x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashProperty9x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  ...
  type LodashPropertyOf8x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashPropertyOf9x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  type LodashPull1x2[T] = js.Function1[/* values */ T, js.Array[T]]
  type LodashPull2x2[T] = js.Function1[/* values */ T, typingsSlinky.cypress.lodashMod.List[T]]
  type LodashPullAll1x2[T] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashPullAll2x2[T] = js.Function1[
    /* values */ typingsSlinky.cypress.lodashMod.List[T], 
    typingsSlinky.cypress.lodashMod.List[T]
  ]
  type LodashPullAllBy1x5[T] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashPullAllBy1x6[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashPullAllBy3x5[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashPullAllBy3x6[T1, T2] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T1 | T2], 
    js.Array[T1]
  ]
  type LodashPullAllBy4x5[T1, T2] = js.Function1[
    /* values */ typingsSlinky.cypress.lodashMod.List[T2], 
    typingsSlinky.cypress.lodashMod.List[T1]
  ]
  type LodashPullAllBy4x6[T1, T2] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T1 | T2], 
    typingsSlinky.cypress.lodashMod.List[T1]
  ]
  type LodashPullAllWith1x5[T] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashPullAllWith1x6[T] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator[T], js.Array[T]]
  type LodashPullAllWith2x5[T] = js.Function1[
    /* values */ typingsSlinky.cypress.lodashMod.List[T], 
    typingsSlinky.cypress.lodashMod.List[T]
  ]
  type LodashPullAllWith2x6[T] = js.Function1[
    /* comparator */ typingsSlinky.cypress.lodashMod.Comparator[T], 
    typingsSlinky.cypress.lodashMod.List[T]
  ]
  type LodashPullAllWith3x5[T1, T2] = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[T1]]
  type LodashPullAllWith3x6[T1, T2] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator2[T1, T2], js.Array[T1]]
  type LodashPullAllWith4x5[T1, T2] = js.Function1[
    /* values */ typingsSlinky.cypress.lodashMod.List[T2], 
    typingsSlinky.cypress.lodashMod.List[T1]
  ]
  type LodashPullAllWith4x6[T1, T2] = js.Function1[
    /* comparator */ typingsSlinky.cypress.lodashMod.Comparator2[T1, T2], 
    typingsSlinky.cypress.lodashMod.List[T1]
  ]
  type LodashPullAt1x2[T] = js.Function1[/* indexes */ typingsSlinky.cypress.lodashMod.Many[scala.Double], js.Array[T]]
  type LodashPullAt2x2[T] = js.Function1[
    /* indexes */ typingsSlinky.cypress.lodashMod.Many[scala.Double], 
    typingsSlinky.cypress.lodashMod.List[T]
  ]
  ...
  type LodashReduce1x6[T, TResult] = js.Function1[
    /* callback */ typingsSlinky.cypress.lodashMod.MemoIteratorCapped[T, TResult], 
    TResult
  ]
  ...
  type LodashReduce3x6[T, TResult] = js.Function1[
    /* callback */ typingsSlinky.cypress.lodashMod.MemoIteratorCapped[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ], 
    TResult
  ...
  type LodashReduceRight1x6[T, TResult] = js.Function1[
    /* callback */ typingsSlinky.cypress.lodashMod.MemoIteratorCappedRight[T, TResult], 
    TResult
  ]
  ...
  type LodashReduceRight3x6[T, TResult] = js.Function1[
    /* callback */ typingsSlinky.cypress.lodashMod.MemoIteratorCappedRight[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ], 
    TResult
  ...
  type LodashRemove1x1[T] = js.Function1[/* array */ typingsSlinky.cypress.lodashMod.List[T], js.Array[T]]
  type LodashRemove1x2[T] = js.Function1[/* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashReplace1x5 = js.Function1[
    /* replacement */ typingsSlinky.cypress.lodashMod.ReplaceFunction | java.lang.String, 
    java.lang.String
  ]
  ...
  type LodashResult1x2 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  type LodashReverse = js.Function1[
    /* array */ typingsSlinky.cypress.lodashMod.List[js.Any], 
    typingsSlinky.cypress.lodashMod.List[js.Any]
  ]
  type LodashRound = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashRunInContext = js.Function1[/* context */ js.Object, typingsSlinky.cypress.lodashMod.LoDashStatic]
  ...
  type LodashSet1x6[T] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, T]
  type LodashSet2x5 = js.Function1[/* value */ js.Any, js.Any]
  type LodashSet2x6 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  type LodashSetWith1x11[T] = js.Function1[/* value */ js.Any, T]
  type LodashSetWith1x13[T] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, T]
  type LodashSetWith1x14[T] = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.SetWithCustomizer[T], T]
  ...
  type LodashSortBy1x2[T] = js.Function1[
    /* iteratees */ typingsSlinky.cypress.lodashMod.Many[typingsSlinky.cypress.lodashMod.ValueIteratee[T]], 
    js.Array[T]
  ]
  ...
  type LodashSortedIndexBy1x6[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedLastIndexBy1x6[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedUniqBy1x2[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashStubFalse = js.Function0[typingsSlinky.cypress.cypressBooleans.`false`]
  type LodashStubObject = js.Function0[js.Any]
  type LodashStubString = js.Function0[java.lang.String]
  type LodashStubTrue = js.Function0[typingsSlinky.cypress.cypressBooleans.`true`]
  ...
  type LodashTakeRightWhile1x2[T] = js.Function1[/* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  type LodashTakeWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashTakeWhile1x2[T] = js.Function1[/* predicate */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  type LodashTap1x1[T] = js.Function1[/* value */ T, T]
  type LodashTap1x2[T] = js.Function1[/* interceptor */ js.Function1[/* value */ T, scala.Unit], T]
  type LodashTemplate = js.Function1[/* string */ java.lang.String, typingsSlinky.cypress.lodashMod.TemplateExecutor]
  type LodashThrottle1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsSlinky.cypress.lodashMod.Cancelable
  ]
  type LodashThrottle1x2[T] = js.Function1[/* wait */ scala.Double, T with typingsSlinky.cypress.lodashMod.Cancelable]
  ...
  type LodashTransform1x3[T, TResult] = js.Function1[
    /* object */ js.Array[T] | typingsSlinky.cypress.lodashMod.Dictionary[T], 
    js.Array[TResult]
  ]
  ...
  type LodashTransform1x6[T, TResult] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.MemoVoidIteratorCapped[T, js.Array[TResult]], 
    js.Array[TResult]
  ]
  ...
  type LodashTransform2x5[TResult] = js.Function1[
    /* accumulator */ typingsSlinky.cypress.lodashMod.Dictionary[TResult], 
    typingsSlinky.cypress.lodashMod.Dictionary[TResult]
  ]
  type LodashTransform2x6[T, TResult] = js.Function1[
    /* iteratee */ typingsSlinky.cypress.lodashMod.MemoVoidIteratorCapped[T, typingsSlinky.cypress.lodashMod.Dictionary[TResult]], 
    typingsSlinky.cypress.lodashMod.Dictionary[TResult]
  ]
  ...
  type LodashTruncate1x2 = js.Function1[/* options */ typingsSlinky.cypress.lodashMod.TruncateOptions, java.lang.String]
  ...
  type LodashUnion1x1[T] = js.Function1[
    /* arrays */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUnion1x2[T] = js.Function1[
    /* arrays2 */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  ...
  type LodashUnionBy1x5[T] = js.Function1[
    /* arrays1 */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUnionBy1x6[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashUnionWith1x6[T] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator[T], js.Array[T]]
  ...
  type LodashUniqBy1x2[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  type LodashUniqWith1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsSlinky.cypress.lodashMod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUniqWith1x2[T] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator[T], js.Array[T]]
  ...
  type LodashUnset1x2[T] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, T]
  type LodashUnzip = js.Function1[
    /* array */ js.UndefOr[
      js.Array[js.Array[js.Any]] | typingsSlinky.cypress.lodashMod.List[typingsSlinky.cypress.lodashMod.List[js.Any]] | scala.Null
    ], 
    js.Array[js.Array[js.Any]]
  ]
  type LodashUnzipWith1x1[T, TResult] = js.Function1[
    /* array */ js.UndefOr[
      typingsSlinky.cypress.lodashMod.List[typingsSlinky.cypress.lodashMod.List[T]] | scala.Null
    ], 
    js.Array[TResult]
  ]
  ...
  type LodashUpdate1x6 = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, js.Any]
  type LodashUpdateWith1x11[T] = js.Function1[/* updater */ js.Function1[/* oldValue */ js.Any, js.Any], T]
  type LodashUpdateWith1x13[T] = js.Function1[/* path */ typingsSlinky.cypress.lodashMod.PropertyPath, T]
  type LodashUpdateWith1x14[T] = js.Function1[/* customizer */ typingsSlinky.cypress.lodashMod.SetWithCustomizer[T], T]
  ...
  type LodashXorBy1x6[T] = js.Function1[/* iteratee */ typingsSlinky.cypress.lodashMod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashXorWith1x6[T] = js.Function1[/* comparator */ typingsSlinky.cypress.lodashMod.Comparator[T], js.Array[T]]
  type LodashZip1x1[T1] = js.Function1[
    /* arrays2 */ typingsSlinky.cypress.lodashMod.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[js.Any]]]
  ]
  type LodashZip1x2[T2] = js.Function1[
    /* arrays1 */ typingsSlinky.cypress.lodashMod.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[js.Any], js.UndefOr[T2]]]
  ]
  type LodashZipObject1x1 = js.Function1[
    /* values */ typingsSlinky.cypress.lodashMod.List[js.Any], 
    typingsSlinky.cypress.lodashMod.Dictionary[js.Any]
  ]
  type LodashZipObject1x2[T] = js.Function1[
    /* props */ typingsSlinky.cypress.lodashMod.List[typingsSlinky.cypress.lodashMod.PropertyName], 
    typingsSlinky.cypress.lodashMod.Dictionary[T]
  ]
  type LodashZipObjectDeep1x1 = js.Function1[/* values */ typingsSlinky.cypress.lodashMod.List[js.Any], js.Object]
  type LodashZipObjectDeep1x2 = js.Function1[
    /* paths */ typingsSlinky.cypress.lodashMod.List[typingsSlinky.cypress.lodashMod.PropertyPath], 
    js.Object
  ]
  type LodashZipWith1x3[T2, TResult] = js.Function1[/* arrays2 */ typingsSlinky.cypress.lodashMod.List[T2], js.Array[TResult]]
  type LodashZipWith1x5[T1, TResult] = js.Function1[/* arrays1 */ typingsSlinky.cypress.lodashMod.List[T1], js.Array[TResult]]
