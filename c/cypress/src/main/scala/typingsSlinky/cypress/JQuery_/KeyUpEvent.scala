...
object KeyUpEvent {
  ...
  @scala.inline
  implicit class KeyUpEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: KeyUpEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: keyup): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
