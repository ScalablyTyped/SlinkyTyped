...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.cypress.cypressStrings.timeout
  - typingsSlinky.cypress.cypressStrings.error
  - typingsSlinky.cypress.cypressStrings.abort
  - typingsSlinky.cypress.cypressStrings.parsererror
*/
