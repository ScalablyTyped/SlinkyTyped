...
object DragEndEvent {
  ...
  @scala.inline
  implicit class DragEndEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragEndEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragend): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
