...
object KeyDownEvent {
  ...
  @scala.inline
  implicit class KeyDownEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: KeyDownEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: keydown): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
