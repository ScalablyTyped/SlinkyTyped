...
object TouchEndEvent {
  ...
  @scala.inline
  implicit class TouchEndEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: TouchEndEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: touchend): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
