...
object TouchCancelEvent {
  ...
  @scala.inline
  implicit class TouchCancelEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: TouchCancelEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: touchcancel): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
