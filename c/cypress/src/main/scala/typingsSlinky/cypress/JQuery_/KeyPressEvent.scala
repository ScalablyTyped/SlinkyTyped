...
object KeyPressEvent {
  ...
  @scala.inline
  implicit class KeyPressEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: KeyPressEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: keypress): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
