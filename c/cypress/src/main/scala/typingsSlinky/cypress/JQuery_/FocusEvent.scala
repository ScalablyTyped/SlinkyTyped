...
object FocusEvent {
  ...
  @scala.inline
  implicit class FocusEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: FocusEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: focus): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
