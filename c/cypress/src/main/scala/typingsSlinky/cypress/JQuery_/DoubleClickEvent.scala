...
object DoubleClickEvent {
  ...
  @scala.inline
  implicit class DoubleClickEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DoubleClickEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dblclick): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
