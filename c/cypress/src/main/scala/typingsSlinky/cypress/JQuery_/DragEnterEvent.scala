...
object DragEnterEvent {
  ...
  @scala.inline
  implicit class DragEnterEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: DragEnterEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: dragenter): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
