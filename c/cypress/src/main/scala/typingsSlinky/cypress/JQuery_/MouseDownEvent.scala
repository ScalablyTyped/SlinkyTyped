...
object MouseDownEvent {
  ...
  @scala.inline
  implicit class MouseDownEventOps[Self[tdelegatetarget, tdata, tcurrenttarget, ttarget] <: MouseDownEvent[tdelegatetarget, tdata, tcurrenttarget, ttarget], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self[TDelegateTarget, TData, TCurrentTarget, TTarget]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: mousedown): Self[TDelegateTarget, TData, TCurrentTarget, TTarget] = {
