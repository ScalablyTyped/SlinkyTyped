...
import typingsSlinky.cypress.typesLodashMod.AnyKindOfDictionary
...
import typingsSlinky.cypress.typesLodashMod.CloneWithCustomizer
...
trait LoDashFp extends js.Object {
  ...
  {[ P in keyof T ]: any}
    */ typingsSlinky.cypress.cypressStrings.LoDashFp with js.Any = js.native
