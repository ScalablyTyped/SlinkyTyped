...
trait ChaiJQuery
  ...
  def after(
    func: js.Function2[
      /* index */ Double, 
      /* html */ String, 
      String | typingsSlinky.std.Element | JQuery_[HTMLElement]
    ]
  ...
  /**
    ...
    */
  def replaceWith(func: js.Function0[typingsSlinky.std.Element | JQuery_[HTMLElement]]): ChaiJQuery = js.native
