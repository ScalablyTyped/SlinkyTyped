...
package object Chai_ {
  type AssertStatic = typingsSlinky.cypress.Chai_.Assert
  ...
  js.Any, 
    typingsSlinky.cypress.Chai_.Message, 
    typingsSlinky.cypress.Chai_.Message, 
    js.Any, 
    js.UndefOr[js.Any], 
  ...
  type ChaiPlugin = js.Function2[
    /* chai */ typingsSlinky.cypress.Chai_.ChaiStatic, 
    /* utils */ typingsSlinky.cypress.Chai_.ChaiUtils, 
    scala.Unit
  ]
  type CloseTo = js.Function3[
    ...
    typingsSlinky.cypress.Chai_.Assertion
  ]
