package typingsSlinky.cypress.typesSinonMod
...
trait SinonFakeTimers extends js.Object {
  ...
  def Date(year: Double): js.Date = js.native
  def Date(year: Double, month: Double): js.Date = js.native
  def Date(year: Double, month: Double, day: Double): js.Date = js.native
  def Date(year: Double, month: Double, day: Double, hour: Double): js.Date = js.native
  def Date(year: Double, month: Double, day: Double, hour: Double, minute: Double): js.Date = js.native
  def Date(year: Double, month: Double, day: Double, hour: Double, minute: Double, second: Double): js.Date = js.native
  def Date(year: Double, month: Double, day: Double, hour: Double, minute: Double, second: Double, ms: Double): js.Date = js.native
