...
import typingsSlinky.cypress.cypressStrings.withArgs
...
trait SinonSpyAgent[A /* <: SinonSpy */] extends js.Object {
  ...
  /**
    ...
    */
  def withArgs(args: js.Any*): (Omit[A, typingsSlinky.cypress.cypressStrings.withArgs]) with Agent[A] = js.native
}
