package typingsSlinky.cleaveJs.components
...
import typingsSlinky.cleaveJs.propsMod.ChangeEvent
import typingsSlinky.cleaveJs.propsMod.Props
import typingsSlinky.cleaveJs.reactMod.^
...
object React {
  ...
  @scala.inline
  def apply(options: CleaveOptions): Builder = {
  ...
  object React {
    ...
    @scala.inline
    def apply(options: CleaveOptions): typingsSlinky.cleaveJs.components.React.React.Builder = {
      val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
      new typingsSlinky.cleaveJs.components.React.React.Builder(js.Array(this.component, __props.asInstanceOf[Props]))
    }
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def htmlRef(value: /* i */ js.Any => Unit): this.type = set("htmlRef", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def onInit(value: /* owner */ ReactInstance => Unit): this.type = set("onInit", js.Any.fromFunction1(value))
    ...
    def withProps(p: Props): typingsSlinky.cleaveJs.components.React.React.Builder = new typingsSlinky.cleaveJs.components.React.React.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
