...
import typingsSlinky.cleaveJs.mod.^
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object creditCardMod {
  
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.cleaveJs.cleaveJsStrings.amex
    - typingsSlinky.cleaveJs.cleaveJsStrings.dankort
    - typingsSlinky.cleaveJs.cleaveJsStrings.diners
    - typingsSlinky.cleaveJs.cleaveJsStrings.discover
    - typingsSlinky.cleaveJs.cleaveJsStrings.instapayment
    - typingsSlinky.cleaveJs.cleaveJsStrings.jcb
    - typingsSlinky.cleaveJs.cleaveJsStrings.maestro
    - typingsSlinky.cleaveJs.cleaveJsStrings.mastercard
    - typingsSlinky.cleaveJs.cleaveJsStrings.uatp
    - typingsSlinky.cleaveJs.cleaveJsStrings.unknown
    - typingsSlinky.cleaveJs.cleaveJsStrings.unionPay
    - typingsSlinky.cleaveJs.cleaveJsStrings.mir
    - typingsSlinky.cleaveJs.cleaveJsStrings.visa
  */
