...
import typingsSlinky.creativebulmaBulmaTagsinput.creativebulmaBulmaTagsinputStrings.text
import typingsSlinky.creativebulmaBulmaTagsinput.creativebulmaBulmaTagsinputStrings.value
