package typingsSlinky.cacheManagerIoredis
...
import typingsSlinky.cacheManager.mod.TtlFunction
import typingsSlinky.cacheManagerIoredis.cacheManagerIoredisNumbers.`1`
import typingsSlinky.cacheManagerIoredis.cacheManagerIoredisNumbers.`2`
import typingsSlinky.cacheManagerIoredis.cacheManagerIoredisStrings.master
import typingsSlinky.cacheManagerIoredis.cacheManagerIoredisStrings.redis
import typingsSlinky.cacheManagerIoredis.cacheManagerIoredisStrings.slave
...
import typingsSlinky.cacheManagerIoredis.mod.CacheManagerIORedis.RedisStoreConstructor
...
import typingsSlinky.ioredis.mod.AddressFromResponse
import typingsSlinky.ioredis.mod.Cluster
import typingsSlinky.ioredis.mod.ClusterNode
import typingsSlinky.ioredis.mod.NatMap
import typingsSlinky.ioredis.mod.PreferredSlaves
import typingsSlinky.ioredis.mod.Redis
import typingsSlinky.ioredis.mod.SecureContextOptions
...
object mod extends Shortcut {
  ...
  object CacheManagerIORedis {
    ...
    trait ClusterOptions extends StObject {
      ...
      var options: typingsSlinky.ioredis.mod.ClusterOptions = js.native
    }
    object ClusterOptions {
      
      @scala.inline
      def apply(nodes: js.Array[ClusterNode], options: typingsSlinky.ioredis.mod.ClusterOptions): ClusterOptions = {
      ...
      implicit class ClusterOptionsMutableBuilder[Self <: ClusterOptions] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setOptions(value: typingsSlinky.ioredis.mod.ClusterOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      }
    }
    ...
    object RedisStoreSingleNodeConfig {
      ...
      implicit class RedisStoreSingleNodeConfigMutableBuilder[Self <: RedisStoreSingleNodeConfig] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setReconnectOnError(value: /* error */ js.Error => Boolean | `1` | `2`): Self = StObject.set(x, "reconnectOnError", js.Any.fromFunction1(value))
