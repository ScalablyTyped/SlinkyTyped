...
trait AnonBaseFontSizeBreakpoints extends js.Object {
  ...
  var components: js.UndefOr[AnonSnackbar] = js.native
  var spacing: js.UndefOr[js.Object] = js.native
}

object AnonBaseFontSizeBreakpoints {
  @scala.inline
  def apply(): AnonBaseFontSizeBreakpoints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonBaseFontSizeBreakpoints]
  }
  @scala.inline
  implicit class AnonBaseFontSizeBreakpointsOps[Self <: AnonBaseFontSizeBreakpoints] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withComponents(value: AnonSnackbar): Self = {
        val ret = this.duplicate
