...
object CallbackFn {
  ...
  implicit class CallbackFnOps[Self <: CallbackFn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallbackFn(value: SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = this.set("callbackFn", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteCallbackFn: Self = this.set("callbackFn", js.undefined)
