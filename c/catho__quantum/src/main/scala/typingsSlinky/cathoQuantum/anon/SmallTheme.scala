...
trait SmallTheme extends js.Object {
  ...
  var theme: js.UndefOr[BaseFontSizeObject] = js.native
}
...
object SmallTheme {
  ...
  @scala.inline
  implicit class SmallThemeOps[Self <: SmallTheme] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTheme(value: BaseFontSizeObject): Self = {
        val ret = this.duplicate
