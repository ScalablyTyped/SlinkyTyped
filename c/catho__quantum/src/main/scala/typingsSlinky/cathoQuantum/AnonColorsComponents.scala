...
trait AnonColorsComponents extends js.Object {
  ...
  var components: js.UndefOr[AnonButton] = js.native
  var spacing: js.UndefOr[js.Object] = js.native
}

object AnonColorsComponents {
  @scala.inline
  def apply(): AnonColorsComponents = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonColorsComponents]
  }
  @scala.inline
  implicit class AnonColorsComponentsOps[Self <: AnonColorsComponents] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withComponents(value: AnonButton): Self = {
        val ret = this.duplicate
