...
@scala.inline
class SharedBuilder_ComponentType_410571564 (val args: js.Array[js.Any])
  extends AnyVal
     with StBuildingComponent[tag.type, scala.Nothing] {
  @scala.inline
  def Instantiable1(
    Instantiable1: org.scalablytyped.runtime.Instantiable1[AnonThemeAnonSpacingObject, ReactComponentClass[AnonThemeAnonSpacingObject]] = null
  ): this.type = {
  ...
  @scala.inline
  def Instantiable2(
    Instantiable2: org.scalablytyped.runtime.Instantiable2[
      AnonThemeAnonSpacingObject, 
      /* context */ js.Any, 
      ReactComponentClass[AnonThemeAnonSpacingObject]
    ] = null
  ): this.type = {
  ...
  @scala.inline
  def defaultProps(value: Partial[AnonThemeAnonSpacingObject]): this.type = set("defaultProps", value.asInstanceOf[js.Any])
  @scala.inline
  ...
  @scala.inline
  def getDerivedStateFromProps(value: (AnonThemeAnonSpacingObject, js.Object) => Partial[js.Object] | Null): this.type = set("getDerivedStateFromProps", js.Any.fromFunction2(value))
  @scala.inline
  def propTypes(value: WeakValidationMap[AnonThemeAnonSpacingObject]): this.type = set("propTypes", value.asInstanceOf[js.Any])
}
