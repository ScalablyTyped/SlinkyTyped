...
object CardDescription {
  object ComponentClass {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def Instantiable1(Instantiable1: org.scalablytyped.runtime.Instantiable1[Small, ReactComponentClass[Small]] = null): this.type = {
            if (Instantiable1 != null) js.Dynamic.global.Object.assign(args(1), Instantiable1)
            this
      }
      @scala.inline
      def Instantiable2(
        Instantiable2: org.scalablytyped.runtime.Instantiable2[Small, /* context */ js.Any, ReactComponentClass[Small]] = null
      ): this.type = {
      ...
      @scala.inline
      def defaultProps(value: Partial[Small]): this.type = set("defaultProps", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def getDerivedStateFromProps(value: (Small, js.Object) => Partial[js.Object] | Null): this.type = set("getDerivedStateFromProps", js.Any.fromFunction2(value))
      @scala.inline
      def propTypes(value: WeakValidationMap[Small]): this.type = set("propTypes", value.asInstanceOf[js.Any])
    }
    
    def withProps(p: ReactComponentClass[Small]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
