...
object Subscription {
  ...
  @js.native
  def cancel(config: Config, uuid: String, data: CancelSubscriptionParams): js.Promise[typingsSlinky.chartmogulNode.mod.Subscription.Subscription] = js.native
  ...
  object Subscription {
    ...
    def apply(
      ...
      plan_uuid: String,
      uuid: String
    ): typingsSlinky.chartmogulNode.mod.Subscription.Subscription = {
      ...
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.Subscription.Subscription]
    }
    
    @scala.inline
    implicit class SubscriptionMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.Subscription.Subscription] (val x: Self) extends AnyVal {
  ...
  object Subscriptions {
    ...
    implicit class SubscriptionsMutableBuilder[Self <: Subscriptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSubscriptions(value: js.Array[typingsSlinky.chartmogulNode.mod.Subscription.Subscription]): Self = StObject.set(x, "subscriptions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubscriptionsVarargs(value: typingsSlinky.chartmogulNode.mod.Subscription.Subscription*): Self = StObject.set(x, "subscriptions", js.Array(value :_*))
    }
  }
}
