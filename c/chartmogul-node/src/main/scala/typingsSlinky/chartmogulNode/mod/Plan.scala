...
object Plan {
  ...
  @js.native
  def create(config: Config, data: typingsSlinky.chartmogulNode.mod.Plan.Plan): js.Promise[typingsSlinky.chartmogulNode.mod.Plan.Plan] = js.native
  ...
  @js.native
  def modify(config: Config, uuid: String, data: typingsSlinky.chartmogulNode.mod.Plan.Plan): js.Promise[typingsSlinky.chartmogulNode.mod.Plan.Plan] = js.native
  
  @JSImport("chartmogul-node", "Plan.retrieve")
  @js.native
  def retrieve(config: Config, uuid: String): js.Promise[typingsSlinky.chartmogulNode.mod.Plan.Plan] = js.native
  ...
  object Plan {
    ...
    @scala.inline
    def apply(): typingsSlinky.chartmogulNode.mod.Plan.Plan = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.Plan.Plan]
    }
    
    @scala.inline
    implicit class PlanMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.Plan.Plan] (val x: Self) extends AnyVal {
  ...
  object Plans {
    ...
    implicit class PlansMutableBuilder[Self <: Plans] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPlans(value: js.Array[typingsSlinky.chartmogulNode.mod.Plan.Plan]): Self = StObject.set(x, "plans", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPlansVarargs(value: typingsSlinky.chartmogulNode.mod.Plan.Plan*): Self = StObject.set(x, "plans", js.Array(value :_*))
    }
  }
}
