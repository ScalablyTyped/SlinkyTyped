...
object Customer {
  ...
  @js.native
  def all(config: Config): js.Promise[Entries[typingsSlinky.chartmogulNode.mod.Customer.Customer]] = js.native
  @JSImport("chartmogul-node", "Customer.all")
  @js.native
  def all(config: Config, params: ListCustomersParams): js.Promise[Entries[typingsSlinky.chartmogulNode.mod.Customer.Customer]] = js.native
  ...
  @js.native
  def create(config: Config, data: NewCustomer): js.Promise[typingsSlinky.chartmogulNode.mod.Customer.Customer] = js.native
  ...
  @js.native
  def modify(config: Config, uuid: String, data: UpdateCustomer): js.Promise[typingsSlinky.chartmogulNode.mod.Customer.Customer] = js.native
  
  @JSImport("chartmogul-node", "Customer.retrieve")
  @js.native
  def retrieve(config: Config, uuid: String): js.Promise[typingsSlinky.chartmogulNode.mod.Customer.Customer] = js.native
  
  @JSImport("chartmogul-node", "Customer.search")
  @js.native
  def search(config: Config): js.Promise[Entries[typingsSlinky.chartmogulNode.mod.Customer.Customer]] = js.native
  @JSImport("chartmogul-node", "Customer.search")
  @js.native
  def search(config: Config, params: SearchCustomersParams): js.Promise[Entries[typingsSlinky.chartmogulNode.mod.Customer.Customer]] = js.native
  ...
  object Customer {
    ...
    @scala.inline
    def apply(): typingsSlinky.chartmogulNode.mod.Customer.Customer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.Customer.Customer]
    }
    
    @scala.inline
    implicit class CustomerMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.Customer.Customer] (val x: Self) extends AnyVal {
