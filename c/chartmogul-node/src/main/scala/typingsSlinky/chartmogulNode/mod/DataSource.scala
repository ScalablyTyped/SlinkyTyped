...
object DataSource {
  ...
  @js.native
  def create(config: Config, data: typingsSlinky.chartmogulNode.mod.DataSource.DataSource): js.Promise[typingsSlinky.chartmogulNode.mod.DataSource.DataSource] = js.native
  ...
  @js.native
  def retrieve(config: Config, uuid: String): js.Promise[typingsSlinky.chartmogulNode.mod.DataSource.DataSource] = js.native
  ...
  object DataSource {
    ...
    @scala.inline
    def apply(name: String): typingsSlinky.chartmogulNode.mod.DataSource.DataSource = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.DataSource.DataSource]
    }
    
    @scala.inline
    implicit class DataSourceMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.DataSource.DataSource] (val x: Self) extends AnyVal {
  ...
  object DataSources {
    ...
    implicit class DataSourcesMutableBuilder[Self <: DataSources] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setData_sources(value: js.Array[typingsSlinky.chartmogulNode.mod.DataSource.DataSource]): Self = StObject.set(x, "data_sources", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setData_sourcesVarargs(value: typingsSlinky.chartmogulNode.mod.DataSource.DataSource*): Self = StObject.set(x, "data_sources", js.Array(value :_*))
    }
  }
