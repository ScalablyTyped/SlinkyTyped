...
object Subscriptions {
  ...
  implicit class SubscriptionsOps[Self <: Subscriptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubscriptionsVarargs(value: typingsSlinky.chartmogulNode.mod.Subscription.Subscription*): Self = this.set("subscriptions", js.Array(value :_*))
    @scala.inline
    def setSubscriptions(value: js.Array[typingsSlinky.chartmogulNode.mod.Subscription.Subscription]): Self = this.set("subscriptions", value.asInstanceOf[js.Any])
    @scala.inline
