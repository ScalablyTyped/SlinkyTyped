...
object Invoices {
  ...
  implicit class InvoicesOps[Self <: Invoices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInvoicesVarargs(value: typingsSlinky.chartmogulNode.mod.Invoice.Invoice*): Self = this.set("invoices", js.Array(value :_*))
    
    @scala.inline
    def setInvoices(value: js.Array[typingsSlinky.chartmogulNode.mod.Invoice.Invoice]): Self = this.set("invoices", value.asInstanceOf[js.Any])
