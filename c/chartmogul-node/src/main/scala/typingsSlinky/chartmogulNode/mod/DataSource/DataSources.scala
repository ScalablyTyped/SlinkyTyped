...
object DataSources {
  ...
  implicit class DataSourcesOps[Self <: DataSources] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData_sourcesVarargs(value: typingsSlinky.chartmogulNode.mod.DataSource.DataSource*): Self = this.set("data_sources", js.Array(value :_*))
    @scala.inline
    def setData_sources(value: js.Array[typingsSlinky.chartmogulNode.mod.DataSource.DataSource]): Self = this.set("data_sources", value.asInstanceOf[js.Any])
  }
