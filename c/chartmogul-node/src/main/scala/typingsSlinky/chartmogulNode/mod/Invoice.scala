...
object Invoice {
  ...
  @js.native
  def create(config: Config, uuid: String, data: typingsSlinky.chartmogulNode.anon.Invoices): js.Promise[typingsSlinky.chartmogulNode.mod.Invoice.Invoice] = js.native
  ...
  @js.native
  def retrieve(config: Config, uuid: String): js.Promise[typingsSlinky.chartmogulNode.mod.Invoice.Invoice] = js.native
  ...
  trait Invoice extends StObject {
    ...
    var transactions: js.UndefOr[js.Array[typingsSlinky.chartmogulNode.mod.Invoice.Transaction]] = js.native
  ...
  object Invoice {
    ...
    @scala.inline
    def apply(): typingsSlinky.chartmogulNode.mod.Invoice.Invoice = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.Invoice.Invoice]
    }
    
    @scala.inline
    implicit class InvoiceMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.Invoice.Invoice] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTransactions(value: js.Array[typingsSlinky.chartmogulNode.mod.Invoice.Transaction]): Self = StObject.set(x, "transactions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTransactionsUndefined: Self = StObject.set(x, "transactions", js.undefined)
      
      @scala.inline
      def setTransactionsVarargs(value: typingsSlinky.chartmogulNode.mod.Invoice.Transaction*): Self = StObject.set(x, "transactions", js.Array(value :_*))
  ...
  object Invoices {
    ...
    implicit class InvoicesMutableBuilder[Self <: Invoices] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInvoices(value: js.Array[typingsSlinky.chartmogulNode.mod.Invoice.Invoice]): Self = StObject.set(x, "invoices", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInvoicesVarargs(value: typingsSlinky.chartmogulNode.mod.Invoice.Invoice*): Self = StObject.set(x, "invoices", js.Array(value :_*))
    }
  }
  ...
  object Transaction {
    ...
    @scala.inline
    def apply(): typingsSlinky.chartmogulNode.mod.Invoice.Transaction = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.chartmogulNode.mod.Invoice.Transaction]
    }
    
    @scala.inline
    implicit class TransactionMutableBuilder[Self <: typingsSlinky.chartmogulNode.mod.Invoice.Transaction] (val x: Self) extends AnyVal {
