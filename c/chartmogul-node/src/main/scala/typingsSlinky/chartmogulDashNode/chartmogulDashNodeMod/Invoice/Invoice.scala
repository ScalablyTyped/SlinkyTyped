...
trait Invoice extends js.Object {
  ...
  var transactions: js.UndefOr[
    js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Invoice.Transaction]
  ] = js.undefined
...
object Invoice {
  ...
  def apply(
    ...
    transactions: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Invoice.Transaction] = null,
    uuid: String = null
  ): Invoice = {
