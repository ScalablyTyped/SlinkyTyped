package typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Invoice
...
object LineItem {
  ...
  def apply(
    ...
    if (!js.isUndefined(prorated)) __obj.updateDynamic("prorated")(prorated.asInstanceOf[js.Any])
