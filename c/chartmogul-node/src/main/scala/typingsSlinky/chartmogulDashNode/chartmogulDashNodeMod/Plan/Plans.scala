...
import typingsSlinky.chartmogulDashNode.commonMod.Cursor
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Plans extends Cursor {
  var plans: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Plan.Plan]
}

object Plans {
  @scala.inline
  def apply(
    plans: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Plan.Plan],
