...
trait Subscriptions extends Cursor {
  ...
  var subscriptions: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Subscription.Subscription]
}

object Subscriptions {
  @scala.inline
  def apply(
    subscriptions: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Subscription.Subscription],
