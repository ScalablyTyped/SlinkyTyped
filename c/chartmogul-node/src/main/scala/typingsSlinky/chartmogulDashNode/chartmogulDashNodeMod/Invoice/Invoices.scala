...
trait Invoices extends Cursor {
  ...
  var invoices: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Invoice.Invoice]
}

object Invoices {
  @scala.inline
  def apply(
    invoices: js.Array[typingsSlinky.chartmogulDashNode.chartmogulDashNodeMod.Invoice.Invoice],
