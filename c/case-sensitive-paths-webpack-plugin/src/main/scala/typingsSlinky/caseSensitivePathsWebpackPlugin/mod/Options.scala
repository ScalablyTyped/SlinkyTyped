...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUseBeforeEmitHook(value: Boolean): Self = this.set("useBeforeEmitHook", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUseBeforeEmitHook: Self = this.set("useBeforeEmitHook", js.undefined)
  }
}
