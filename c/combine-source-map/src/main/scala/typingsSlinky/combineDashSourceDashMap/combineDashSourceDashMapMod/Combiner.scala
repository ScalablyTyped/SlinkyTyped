...
import typingsSlinky.combineDashSourceDashMap.Anon_Source
...
trait Combiner extends js.Object {
  ...
  /**
    ...
    */
  def addFile(opts: Anon_Source): Combiner = js.native
  def addFile(opts: Anon_Source, offset: Offset): Combiner = js.native
  /**
