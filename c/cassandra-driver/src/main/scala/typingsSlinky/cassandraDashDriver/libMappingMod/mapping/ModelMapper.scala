...
import typingsSlinky.cassandraDashDriver.Anon_Fields
...
trait ModelMapper[T] extends js.Object {
  ...
  def get(doc: StringDictionary[js.Any], docInfo: Anon_Fields): js.Promise[Null | T] = js.native
  def get(doc: StringDictionary[js.Any], docInfo: Anon_Fields, executionOptions: String): js.Promise[Null | T] = js.native
  def get(doc: StringDictionary[js.Any], docInfo: Anon_Fields, executionOptions: MappingExecutionOptions): js.Promise[Null | T] = js.native
