...
import typingsSlinky.cassandraDashDriver.libMappingMod.mapping.MappingOptions
import typingsSlinky.cassandraDashDriver.libMappingMod.mapping.q.QueryOperator
...
object mapping extends js.Object {
  ...
  class DefaultTableMappings ()
    extends typingsSlinky.cassandraDashDriver.libMappingMod.mapping.DefaultTableMappings
  
  @js.native
  class Mapper protected ()
    extends typingsSlinky.cassandraDashDriver.libMappingMod.mapping.Mapper {
  ...
  class UnderscoreCqlToCamelCaseMappings ()
    extends typingsSlinky.cassandraDashDriver.libMappingMod.mapping.UnderscoreCqlToCamelCaseMappings
