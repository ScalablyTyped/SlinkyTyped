...
object reconnection extends js.Object {
  ...
  class ConstantReconnectionPolicy protected ()
    extends typingsSlinky.cassandraDashDriver.libPoliciesMod.policies.reconnection.ConstantReconnectionPolicy {
    def this(delay: Double) = this()
  }
  
  @js.native
  class ExponentialReconnectionPolicy protected ()
    extends typingsSlinky.cassandraDashDriver.libPoliciesMod.policies.reconnection.ExponentialReconnectionPolicy {
