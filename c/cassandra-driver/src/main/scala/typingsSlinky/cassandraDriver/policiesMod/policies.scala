package typingsSlinky.cassandraDriver.policiesMod
  ...
  object reconnection {
    ...
    object ReconnectionPolicy {
      ...
      implicit class ReconnectionPolicyMutableBuilder[Self <: ReconnectionPolicy] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setNewSchedule(value: () => js.Iterator[Double]): Self = StObject.set(x, "newSchedule", js.Any.fromFunction0(value))
      }
    }
  }
