  ...
  object datastax {
    ...
    object graph {
      ...
      object t {
        ...
        @js.native
        val id: typingsSlinky.cassandraDriver.graphMod.graph.EnumValue = js.native
        
        @JSImport("cassandra-driver/lib/datastax", "datastax.graph.t.key")
        @js.native
        val key: typingsSlinky.cassandraDriver.graphMod.graph.EnumValue = js.native
        
        @JSImport("cassandra-driver/lib/datastax", "datastax.graph.t.label")
        @js.native
        val label: typingsSlinky.cassandraDriver.graphMod.graph.EnumValue = js.native
        
        @JSImport("cassandra-driver/lib/datastax", "datastax.graph.t.value")
        @js.native
        val value: typingsSlinky.cassandraDriver.graphMod.graph.EnumValue = js.native
      }
      ...
      object Edge {
        ...
        implicit class EdgeMutableBuilder[Self <: Edge] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setInV(value: typingsSlinky.cassandraDriver.graphMod.graph.Vertex): Self = StObject.set(x, "inV", value.asInstanceOf[js.Any])
          ...
          @scala.inline
          def setOutV(value: typingsSlinky.cassandraDriver.graphMod.graph.Vertex): Self = StObject.set(x, "outV", value.asInstanceOf[js.Any])
