...
trait Edge
  ...
  var inV: js.UndefOr[typingsSlinky.cassandraDriver.graphMod.graph.Vertex] = js.undefined
  var inVLabel: js.UndefOr[String] = js.undefined
  var outV: js.UndefOr[typingsSlinky.cassandraDriver.graphMod.graph.Vertex] = js.undefined
...
object Edge {
  ...
  def apply(
    id: js.Any,
    label: String,
    inV: typingsSlinky.cassandraDriver.graphMod.graph.Vertex = null,
    inVLabel: String = null,
    outV: typingsSlinky.cassandraDriver.graphMod.graph.Vertex = null,
