...
object Edge {
  ...
  implicit class EdgeOps[Self <: Edge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInV(value: typingsSlinky.cassandraDriver.graphMod.graph.Vertex): Self = this.set("inV", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOutV(value: typingsSlinky.cassandraDriver.graphMod.graph.Vertex): Self = this.set("outV", value.asInstanceOf[js.Any])
    @scala.inline
