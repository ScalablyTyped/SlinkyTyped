package typingsSlinky.cliDashBox.cliDashBoxMod

import typingsSlinky.cliDashBox.Anon_Fullscreen
import typingsSlinky.cliDashBox.Anon_Height
...
class Class protected () extends Box {
  ...
  /* CompleteClass */
  override var options: Anon_Fullscreen = js.native
  /* CompleteClass */
  override var settings: Anon_Height = js.native
  /* CompleteClass */
