...
object Height {
  @scala.inline
  def apply(height: Double, lines: js.Array[Offset], marks: typingsSlinky.cliBox.mod.Marks, width: Double): Height = {
  ...
  implicit class HeightOps[Self <: Height] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarks(value: typingsSlinky.cliBox.mod.Marks): Self = this.set("marks", value.asInstanceOf[js.Any])
    @scala.inline
