...
object config_ {
  ...
  implicit class config_Ops[Self <: config_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFillEmptyBlocksFunction1(value: /* element */ typingsSlinky.ckeditor.CKEDITOR.htmlParser.element => Boolean): Self = this.set("fillEmptyBlocks", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setProtectedSourceVarargs(value: js.RegExp*): Self = this.set("protectedSource", js.Array(value :_*))
    @scala.inline
    def setProtectedSource(value: js.Array[js.RegExp]): Self = this.set("protectedSource", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStylesheetParser_skipSelectors(value: js.RegExp): Self = this.set("stylesheetParser_skipSelectors", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteStylesheetParser_skipSelectors: Self = this.set("stylesheetParser_skipSelectors", js.undefined)
    @scala.inline
    def setStylesheetParser_validSelectors(value: js.RegExp): Self = this.set("stylesheetParser_validSelectors", value.asInstanceOf[js.Any])
    @scala.inline
