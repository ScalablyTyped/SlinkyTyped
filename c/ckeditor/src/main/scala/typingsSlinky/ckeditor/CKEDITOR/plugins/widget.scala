...
object widget {
  ...
  object nestedEditable {
    ...
    object definition {
      ...
      @scala.inline
      def apply(): typingsSlinky.ckeditor.CKEDITOR.plugins.widget.nestedEditable.definition = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.ckeditor.CKEDITOR.plugins.widget.nestedEditable.definition]
      }
      
      @scala.inline
      implicit class definitionMutableBuilder[Self <: typingsSlinky.ckeditor.CKEDITOR.plugins.widget.nestedEditable.definition] (val x: Self) extends AnyVal {
  ...
  trait repository extends event {
    ...
    def initOn(element: typingsSlinky.ckeditor.CKEDITOR.dom.element): widget = js.native
    def initOn(
      element: typingsSlinky.ckeditor.CKEDITOR.dom.element,
      widgetDef: js.UndefOr[scala.Nothing],
      startupData: StringDictionary[js.Any]
    ): widget = js.native
    def initOn(element: typingsSlinky.ckeditor.CKEDITOR.dom.element, widgetDef: String): widget = js.native
    def initOn(
      element: typingsSlinky.ckeditor.CKEDITOR.dom.element,
      widgetDef: String,
      startupData: StringDictionary[js.Any]
    ): widget = js.native
    def initOn(element: typingsSlinky.ckeditor.CKEDITOR.dom.element, widgetDef: definition): widget = js.native
    def initOn(
      element: typingsSlinky.ckeditor.CKEDITOR.dom.element,
    ...
    def initOnAll(container: typingsSlinky.ckeditor.CKEDITOR.dom.element): js.Array[widget] = js.native
