...
object vbox {
  ...
  implicit class vboxOps[Self <: vbox] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: typingsSlinky.ckeditor.CKEDITOR.ui.dialog.uiElement*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: js.Array[typingsSlinky.ckeditor.CKEDITOR.ui.dialog.uiElement]): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
