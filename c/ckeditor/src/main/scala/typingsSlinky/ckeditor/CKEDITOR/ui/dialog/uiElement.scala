...
object uiElement {
  ...
  implicit class uiElementOps[Self <: uiElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessKeyDown(value: (typingsSlinky.ckeditor.CKEDITOR.dialog, String) => Unit): Self = this.set("accessKeyDown", js.Any.fromFunction2(value))
    @scala.inline
    def setAccessKeyUp(value: (typingsSlinky.ckeditor.CKEDITOR.dialog, String) => Unit): Self = this.set("accessKeyUp", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setGetDialog(value: () => typingsSlinky.ckeditor.CKEDITOR.dialog): Self = this.set("getDialog", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setRegisterEvents(value: typingsSlinky.ckeditor.CKEDITOR.dialog.definition.uiElement => uiElement): Self = this.set("registerEvents", js.Any.fromFunction1(value))
    @scala.inline
