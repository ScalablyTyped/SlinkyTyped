...
trait uiElement extends js.Object {
  ...
  def accessKeyDown(dialog: typingsSlinky.ckeditor.CKEDITOR.dialog, key: String): Unit
  def accessKeyUp(dialog: typingsSlinky.ckeditor.CKEDITOR.dialog, key: String): Unit
  def disable(): Unit
  def enable(): Unit
  def focus(): js.UndefOr[uiElement]
  def getDialog(): typingsSlinky.ckeditor.CKEDITOR.dialog
  ...
  def registerEvents(definition: typingsSlinky.ckeditor.CKEDITOR.dialog.definition.uiElement): uiElement
