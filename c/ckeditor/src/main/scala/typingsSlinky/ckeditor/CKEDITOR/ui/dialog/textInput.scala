...
object textInput {
  ...
  implicit class textInputOps[Self <: textInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDirectionMarker(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDirectionMarker")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetDirectionMarker(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setDirectionMarker")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetValue(value: (String, Boolean) => textInput): Self = {
        val ret = this.duplicate
