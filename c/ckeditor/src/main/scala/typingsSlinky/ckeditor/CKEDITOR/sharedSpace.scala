...
object sharedSpace {
  ...
  implicit class sharedSpaceOps[Self <: sharedSpace] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBottomHTMLElement(value: HTMLElement): Self = this.set("bottom", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopHTMLElement(value: HTMLElement): Self = this.set("top", value.asInstanceOf[js.Any])
