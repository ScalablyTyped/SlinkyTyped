package typingsSlinky.ckeditor.CKEDITOR.plugins.pastefromword.lists
...
object numbering {
  ...
  implicit class numberingOps[Self <: numbering] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetStyle(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStyle")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withToNumber(value: (String, String) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toNumber")(js.Any.fromFunction2(value))
        ret
    }
  }
