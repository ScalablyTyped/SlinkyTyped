...
object ^ extends js.Object {
  ...
  var currentInstance: typingsSlinky.ckeditor.CKEDITOR.editor = js.native
  // Config options
  var disableAutoInline: Boolean = js.native
  var document: typingsSlinky.ckeditor.CKEDITOR.dom.document = js.native
  ...
  var stylesSet: typingsSlinky.ckeditor.CKEDITOR.resourceManager = js.native
