...
class notification protected ()
  ...
  /* CompleteClass */
  override val area: typingsSlinky.ckeditor.CKEDITOR.plugins.notification.area = js.native
  /* CompleteClass */
  override val duration: Double = js.native
  /* CompleteClass */
  override val editor: typingsSlinky.ckeditor.CKEDITOR.editor = js.native
  /* CompleteClass */
  override val element: typingsSlinky.ckeditor.CKEDITOR.dom.element = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val `type`: typingsSlinky.ckeditor.CKEDITOR.plugins.notification.`type` = js.native
  /* CompleteClass */
