...
import typingsSlinky.cordovaSqliteStorage.AnonItem
...
trait Results extends js.Object {
  ...
  var rows: AnonItem = js.native
  var rowsAffected: Double = js.native
}

object Results {
  @scala.inline
  def apply(rows: AnonItem, rowsAffected: Double): Results = {
  ...
  implicit class ResultsOps[Self <: Results] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRows(value: AnonItem): Self = {
