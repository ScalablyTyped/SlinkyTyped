...
import typingsSlinky.cacheableRequest.cacheableRequestStrings.error
import typingsSlinky.cacheableRequest.cacheableRequestStrings.request
import typingsSlinky.cacheableRequest.cacheableRequestStrings.response
...
object mod extends Shortcut {
  ...
  object CacheErrorCls {
    ...
    implicit class CacheErrorClsMutableBuilder[Self <: CacheErrorCls] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.cacheableRequest.cacheableRequestStrings.CacheError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
  ...
  object RequestErrorCls {
    ...
    implicit class RequestErrorClsMutableBuilder[Self <: RequestErrorCls] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.cacheableRequest.cacheableRequestStrings.RequestError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
