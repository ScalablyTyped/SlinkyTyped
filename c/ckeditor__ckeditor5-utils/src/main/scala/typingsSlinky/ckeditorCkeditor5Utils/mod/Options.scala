...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetClientRect(value: ClientRect): Self = this.set("target", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLimiterClientRect(value: ClientRect): Self = this.set("limiter", value.asInstanceOf[js.Any])
    @scala.inline
    def setLimiter(
      value: HTMLElement | Range | ClientRect | Rect | (js.Function0[HTMLElement | Range | ClientRect | Rect])
    ): Self = this.set("limiter", value.asInstanceOf[js.Any])
    @scala.inline
    def setLimiterRange(value: Range): Self = this.set("limiter", value.asInstanceOf[js.Any])
    @scala.inline
    def setLimiterHTMLElement(value: HTMLElement): Self = this.set("limiter", value.asInstanceOf[js.Any])
    @scala.inline
