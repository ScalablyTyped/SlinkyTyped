...
object Options {
  ...
  implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLimiterClientRect(value: ClientRect): Self = StObject.set(x, "limiter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLimiterFunction0(value: () => HTMLElement | Range | ClientRect | Rect): Self = StObject.set(x, "limiter", js.Any.fromFunction0(value))
    
    @scala.inline
    def setLimiterHTMLElement(value: HTMLElement): Self = StObject.set(x, "limiter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLimiterRange(value: Range): Self = StObject.set(x, "limiter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTargetClientRect(value: ClientRect): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
