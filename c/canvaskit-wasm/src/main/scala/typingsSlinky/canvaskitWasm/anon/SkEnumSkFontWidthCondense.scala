...
trait SkEnumSkFontWidthCondense extends js.Object {
  val Condensed: SkFontWidth
  val Expanded: SkFontWidth
  val ExtraCondensed: SkFontWidth
  val ExtraExpanded: SkFontWidth
  val Normal: SkFontWidth
  val SemiCondensed: SkFontWidth
  val SemiExpanded: SkFontWidth
  val UltraCondensed: SkFontWidth
  val UltraExpanded: SkFontWidth
  val values: js.Array[SkFontWidth]
}
