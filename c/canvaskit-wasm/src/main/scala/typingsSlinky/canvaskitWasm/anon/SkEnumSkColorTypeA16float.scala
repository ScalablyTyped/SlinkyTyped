...
trait SkEnumSkColorTypeA16float extends js.Object {
  val A16_float: SkColorType
  val A16_unorm: SkColorType
  val ARGB_4444: SkColorType
  val Alpha_8: SkColorType
  val BGRA_8888: SkColorType
  val Gray_8: SkColorType
  val R16G16B16A16_unorm: SkColorType
  val R16G16_float: SkColorType
  val R16G16_unorm: SkColorType
  val R8G8_unorm: SkColorType
  val RGBA_1010102: SkColorType
  val RGBA_8888: SkColorType
  val RGBA_F16: SkColorType
  val RGBA_F32: SkColorType
  val RGB_101010x: SkColorType
  val RGB_565: SkColorType
  val RGB_888x: SkColorType
  val values: js.Array[SkColorType]
}
