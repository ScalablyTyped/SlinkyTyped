...
object Particles {
  ...
  implicit class ParticlesOps[Self <: Particles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffectUniforms(value: () => js.typedarray.Float32Array): Self = this.set("effectUniforms", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setParticleUniforms(value: () => js.typedarray.Float32Array): Self = this.set("particleUniforms", js.Any.fromFunction0(value))
