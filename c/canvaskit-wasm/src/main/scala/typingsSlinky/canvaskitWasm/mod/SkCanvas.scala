...
trait SkCanvas extends EmbindObject[SkCanvas] {
  ...
  /**
    ...
    * @param marker
    */
  def findMarkedCTM(marker: String): js.typedarray.Float32Array | Null = js.native
  ...
  def readPixels(x: Double, y: Double, w: Double, h: Double, alphaType: AlphaType): js.typedarray.Uint8Array = js.native
  def readPixels(
    x: Double,
    y: Double,
    w: Double,
  ...
  def readPixels(x: Double, y: Double, w: Double, h: Double, alphaType: AlphaType, colorType: ColorType): js.typedarray.Uint8Array = js.native
  def readPixels(
    x: Double,
    y: Double,
    w: Double,
