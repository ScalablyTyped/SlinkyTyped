...
trait SkFont extends EmbindObject[SkFont] {
  ...
  def getGlyphBounds(glyphs: InputGlyphIDArray, paint: js.UndefOr[scala.Nothing], output: js.typedarray.Float32Array): js.typedarray.Float32Array = js.native
  ...
  def getGlyphBounds(glyphs: InputGlyphIDArray, paint: SkPaint): js.typedarray.Float32Array = js.native
  def getGlyphBounds(glyphs: InputGlyphIDArray, paint: SkPaint, output: js.typedarray.Float32Array): js.typedarray.Float32Array = js.native
  ...
  /**
    ...
    * @param output - if provided, the results will be copied into this array.
    */
  def getGlyphIDs(str: String): js.typedarray.Uint32Array = js.native
  def getGlyphIDs(str: String, numCodePoints: js.UndefOr[scala.Nothing], output: TypedArray): js.typedarray.Uint32Array = js.native
  def getGlyphIDs(str: String, numCodePoints: Double): js.typedarray.Uint32Array = js.native
  def getGlyphIDs(str: String, numCodePoints: Double, output: TypedArray): js.typedarray.Uint32Array = js.native
  ...
  def getGlyphWidths(glyphs: InputGlyphIDArray, paint: js.UndefOr[scala.Nothing], output: js.typedarray.Float32Array): js.typedarray.Float32Array = js.native
  ...
  def getGlyphWidths(glyphs: InputGlyphIDArray, paint: SkPaint): js.typedarray.Float32Array = js.native
  def getGlyphWidths(glyphs: InputGlyphIDArray, paint: SkPaint, output: js.typedarray.Float32Array): js.typedarray.Float32Array = js.native
