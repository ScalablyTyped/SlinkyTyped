...
trait CanvasKit extends StObject {
  ...
  def MakeAnimatedImageFromEncoded(bytes: js.typedarray.ArrayBuffer): SkAnimatedImage | Null = js.native
  /**
    ...
    * @param bytes
    */
  def MakeAnimatedImageFromEncoded(bytes: js.typedarray.Uint8Array): SkAnimatedImage | Null = js.native
  ...
  def MakeImageFromEncoded(bytes: js.typedarray.ArrayBuffer): SkImage | Null = js.native
  /**
    ...
    * @param bytes
    */
  def MakeImageFromEncoded(bytes: js.typedarray.Uint8Array): SkImage | Null = js.native
  ...
  /**
    ...
    */
  def MakePathFromOp(
    one: typingsSlinky.canvaskitWasm.mod.SkPath,
    two: typingsSlinky.canvaskitWasm.mod.SkPath,
    op: typingsSlinky.canvaskitWasm.mod.PathOp
  ): typingsSlinky.canvaskitWasm.mod.SkPath | Null = js.native
  ...
  /**
    ...
    * @param str
    */
  def MakePathFromSVGString(str: String): typingsSlinky.canvaskitWasm.mod.SkPath | Null = js.native
  ...
  def MakeSkPicture(bytes: js.typedarray.ArrayBuffer): SkPicture | Null = js.native
  /**
    * Returns an SkPicture which has been serialized previously to the given bytes.
    * @param bytes
    */
  def MakeSkPicture(bytes: js.typedarray.Uint8Array): SkPicture | Null = js.native
  ...
  /**
    ...
    */
  def MakeSkVertices(
    mode: typingsSlinky.canvaskitWasm.mod.VertexMode,
  ...
  val SkPaint: DefaultConstructor[typingsSlinky.canvaskitWasm.mod.SkPaint] = js.native
  
  val SkPath: SkPathConstructorAndFactory = js.native
  
  val SkPathEffect: SkPathEffectFactory = js.native
  
  val SkPictureRecorder: DefaultConstructor[typingsSlinky.canvaskitWasm.mod.SkPictureRecorder] = js.native
  ...
  /**
    ...
    * @param data
    */
  def getSkDataBytes(data: SkData): js.typedarray.Uint8Array = js.native
  ...
  def parseColorString(color: String, colorMap: js.Object): js.typedarray.Float32Array = js.native
