...
object Paragraph {
  ...
  implicit class ParagraphOps[Self <: Paragraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetRectsForPlaceholders(value: () => js.typedarray.Float32Array): Self = this.set("getRectsForPlaceholders", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetRectsForRange(value: (Double, Double, RectHeightStyle, RectWidthStyle) => js.typedarray.Float32Array): Self = this.set("getRectsForRange", js.Any.fromFunction4(value))
