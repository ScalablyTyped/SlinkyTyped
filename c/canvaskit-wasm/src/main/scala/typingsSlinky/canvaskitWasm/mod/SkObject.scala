...
object SkObject {
  @scala.inline
  def apply[/* <: typingsSlinky.canvaskitWasm.mod.SkObject[T] */ T](
    delete: () => Unit,
    deleteAfter: () => Unit,
  ...
  @scala.inline
  implicit class SkObjectOps[Self <: SkObject[_], /* <: typingsSlinky.canvaskitWasm.mod.SkObject[T] */ T] (val x: Self with SkObject[T]) extends AnyVal {
    @scala.inline
