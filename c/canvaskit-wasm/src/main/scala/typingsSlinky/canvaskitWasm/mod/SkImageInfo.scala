...
object SkImageInfo {
  ...
  implicit class SkImageInfoOps[Self <: SkImageInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlphaType(value: SkAlphaType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alphaType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withColorType(value: SkColorType): Self = {
        val ret = this.duplicate
