...
trait SkRuntimeEffect extends EmbindObject[SkRuntimeEffect] {
  ...
  /**
    ...
    * @param localMatrix
    */
  def makeShader(uniforms: js.typedarray.Float32Array): SkShader = js.native
  def makeShader(
    uniforms: js.typedarray.Float32Array,
    isOpaque: js.UndefOr[scala.Nothing],
    localMatrix: InputMatrix
  ): SkShader = js.native
  def makeShader(uniforms: js.typedarray.Float32Array, isOpaque: Boolean): SkShader = js.native
  def makeShader(uniforms: js.typedarray.Float32Array, isOpaque: Boolean, localMatrix: InputMatrix): SkShader = js.native
  ...
  /**
    ...
    * @param localMatrix
    */
  def makeShaderWithChildren(uniforms: js.typedarray.Float32Array): SkShader = js.native
  def makeShaderWithChildren(
    uniforms: js.typedarray.Float32Array,
    isOpaque: js.UndefOr[scala.Nothing],
    children: js.UndefOr[scala.Nothing],
  ...
  def makeShaderWithChildren(uniforms: js.typedarray.Float32Array, isOpaque: Boolean): SkShader = js.native
  def makeShaderWithChildren(
    uniforms: js.typedarray.Float32Array,
    isOpaque: Boolean,
    children: js.UndefOr[scala.Nothing],
  ...
  def makeShaderWithChildren(uniforms: js.typedarray.Float32Array, isOpaque: Boolean, children: js.Array[SkShader]): SkShader = js.native
  def makeShaderWithChildren(
    uniforms: js.typedarray.Float32Array,
    isOpaque: Boolean,
    children: js.Array[SkShader],
