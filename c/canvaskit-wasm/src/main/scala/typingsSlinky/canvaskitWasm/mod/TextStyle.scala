...
object TextStyle {
  ...
  implicit class TextStyleMutableBuilder[Self <: TextStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundColorFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColorFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDecorationColorFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "decorationColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setForegroundColorFloat32Array(value: js.typedarray.Float32Array): Self = StObject.set(x, "foregroundColor", value.asInstanceOf[js.Any])
