...
object TextStyle {
  ...
  implicit class TextStyleOps[Self <: TextStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackgroundColorFloat32Array(value: js.typedarray.Float32Array): Self = this.set("backgroundColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setColorFloat32Array(value: js.typedarray.Float32Array): Self = this.set("color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDecorationColorFloat32Array(value: js.typedarray.Float32Array): Self = this.set("decorationColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setForegroundColorFloat32Array(value: js.typedarray.Float32Array): Self = this.set("foregroundColor", value.asInstanceOf[js.Any])
