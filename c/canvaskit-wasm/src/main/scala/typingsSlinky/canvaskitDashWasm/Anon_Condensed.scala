...
import typingsSlinky.canvaskitDashWasm.canvaskitDashWasmMod.SkFontWidth
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Anon_Condensed extends js.Object {
  var Condensed: SkFontWidth
  var Expanded: SkFontWidth
  var ExtraCondensed: SkFontWidth
  var ExtraExpanded: SkFontWidth
  var Normal: SkFontWidth
  var SemiCondensed: SkFontWidth
  var SemiExpanded: SkFontWidth
  var UltraCondensed: SkFontWidth
  var UltraExpanded: SkFontWidth
}

object Anon_Condensed {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_Condensed]
  }
}
