...
import typingsSlinky.canvaskitDashWasm.canvaskitDashWasmMod.SkTileMode
...
object Anon_Clamp {
  @scala.inline
  def apply(Clamp: SkTileMode, Decal: SkTileMode, Mirror: SkTileMode, Repeat: SkTileMode): Anon_Clamp = {
