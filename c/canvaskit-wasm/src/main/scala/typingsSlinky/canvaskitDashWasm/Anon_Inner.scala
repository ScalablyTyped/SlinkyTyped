...
import typingsSlinky.canvaskitDashWasm.canvaskitDashWasmMod.SkBlurStyle
...
object Anon_Inner {
  @scala.inline
  def apply(Inner: SkBlurStyle, Normal: SkBlurStyle, Outer: SkBlurStyle, Solid: SkBlurStyle): Anon_Inner = {
