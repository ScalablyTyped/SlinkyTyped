package typingsSlinky.cliDashColor.cliDashColorMod
...
trait Format extends js.Object {
  ...
  var xtermSupported: Boolean = js.native
  @JSName("yellowBright")
  ...
  def bol(): String = js.native
  def bol(n: Double): String = js.native
  def bol(n: Double, erase: Boolean): String = js.native
  ...
  def moveTo(x: Double, y: Double): String = js.native
