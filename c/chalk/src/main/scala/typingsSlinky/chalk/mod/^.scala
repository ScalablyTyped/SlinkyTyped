...
object ^ extends js.Object {
  ...
  var BackgroundColor: typingsSlinky.chalk.mod.BackgroundColor = js.native
  
  var Color: typingsSlinky.chalk.mod.Color = js.native
  
  var ForegroundColor: typingsSlinky.chalk.mod.ForegroundColor = js.native
  ...
  var Modifiers: typingsSlinky.chalk.mod.Modifiers = js.native
