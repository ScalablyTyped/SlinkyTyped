...
object Abbr {
  @scala.inline
  def apply[/* <: typingsSlinky.convertUnits.mod.unit */ T](abbr: T, measure: measure, system: system, unit: Name): Abbr[T] = {
  ...
  @scala.inline
  implicit class AbbrOps[Self <: Abbr[_], /* <: typingsSlinky.convertUnits.mod.unit */ T] (val x: Self with Abbr[T]) extends AnyVal {
    @scala.inline
