...
object AnonMeasure {
  @scala.inline
  def apply[T](abbr: T, measure: measure, plural: String, singular: String, system: system): AnonMeasure[T] = {
  ...
  @scala.inline
  implicit class AnonMeasureOps[Self[t] <: AnonMeasure[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
