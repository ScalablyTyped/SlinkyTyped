...
import typingsSlinky.cordovaDashPluginDashCanvascamera.cordovaDashPluginDashCanvascameraStrings.back
import typingsSlinky.cordovaDashPluginDashCanvascamera.cordovaDashPluginDashCanvascameraStrings.front
