...
import typingsSlinky.cookieParser.cookieParserBooleans.`false`
...
object mod {
  ...
  {[ P in keyof T ]:? string | false}
    */ typingsSlinky.cookieParser.cookieParserStrings.signedCookies with TopLevel[js.Any] = js.native
  @JSImport("cookie-parser", "signedCookies")
  @js.native
