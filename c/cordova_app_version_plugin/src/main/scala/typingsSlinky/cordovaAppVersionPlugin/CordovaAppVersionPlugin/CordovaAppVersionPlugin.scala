package typingsSlinky.cordovaAppVersionPlugin.CordovaAppVersionPlugin
...
object CordovaAppVersionPlugin {
  ...
  @scala.inline
  implicit class CordovaAppVersionPluginOps[Self <: typingsSlinky.cordovaAppVersionPlugin.CordovaAppVersionPlugin.CordovaAppVersionPlugin] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withGetAppVersion(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAppVersion")(js.Any.fromFunction0(value))
        ret
    }
  }
