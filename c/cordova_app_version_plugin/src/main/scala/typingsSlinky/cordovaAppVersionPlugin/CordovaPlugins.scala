...
object CordovaPlugins {
  ...
  implicit class CordovaPluginsOps[Self <: CordovaPlugins] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVersion(value: typingsSlinky.cordovaAppVersionPlugin.CordovaAppVersionPlugin.CordovaAppVersionPlugin): Self = this.set("version", value.asInstanceOf[js.Any])
  }
