...
trait Typeoftypes extends js.Object {
  var BigNumber: Instantiable0[typingsSlinky.ethers.mod.ethers.utils.types.BigNumber]
  var HDNode: Instantiable0[typingsSlinky.ethers.mod.ethers.utils.types.HDNode]
  var Indexed: Instantiable0[typingsSlinky.ethers.mod.ethers.utils.types.Indexed]
  var MinimalProvider: Instantiable0[typingsSlinky.ethers.mod.ethers.utils.types.MinimalProvider]
  var Signer: Instantiable0[typingsSlinky.ethers.mod.ethers.utils.types.Signer]
}
