...
import typingsSlinky.contractProxyKit.contractProxyKitStrings.`4Dot0Dot0-betaDot3`
import typingsSlinky.contractProxyKit.contractProxyKitStrings.node
...
trait Typeofethers extends js.Object {
  ...
  var Interface: Instantiable1[/* abi */ js.Array[String | ParamType], typingsSlinky.ethers.mod.ethers.Interface]
  var SigningKey: Instantiable1[/* privateKey */ Arrayish, typingsSlinky.ethers.mod.ethers.SigningKey]
