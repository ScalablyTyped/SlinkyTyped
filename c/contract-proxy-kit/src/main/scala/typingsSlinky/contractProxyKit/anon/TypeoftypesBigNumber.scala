...
import typingsSlinky.ethers.mod.ethers.types.BigNumber
import typingsSlinky.ethers.mod.ethers.types.HDNode
import typingsSlinky.ethers.mod.ethers.types.Indexed
import typingsSlinky.ethers.mod.ethers.types.MinimalProvider
import typingsSlinky.ethers.mod.ethers.types.Signer
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait TypeoftypesBigNumber extends js.Object {
  var BigNumber: Instantiable0[typingsSlinky.ethers.mod.ethers.types.BigNumber] = js.native
  var HDNode: Instantiable0[typingsSlinky.ethers.mod.ethers.types.HDNode] = js.native
  var Indexed: Instantiable0[typingsSlinky.ethers.mod.ethers.types.Indexed] = js.native
  var MinimalProvider: Instantiable0[typingsSlinky.ethers.mod.ethers.types.MinimalProvider] = js.native
  var Signer: Instantiable0[typingsSlinky.ethers.mod.ethers.types.Signer] = js.native
}

object TypeoftypesBigNumber {
  @scala.inline
  def apply(
  ...
  @scala.inline
  implicit class TypeoftypesBigNumberOps[Self <: TypeoftypesBigNumber] (val x: Self) extends AnyVal {
    @scala.inline
