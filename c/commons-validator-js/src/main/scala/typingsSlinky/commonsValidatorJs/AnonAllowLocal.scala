...
object AnonAllowLocal {
  ...
  @scala.inline
  implicit class AnonAllowLocalOps[Self <: AnonAllowLocal] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withAllowTld(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("allowTld")(value.asInstanceOf[js.Any])
        ret
    }
  }
