...
import typingsSlinky.cssSelectorParser.anon.Name
import typingsSlinky.cssSelectorParser.anon.Operator
import typingsSlinky.cssSelectorParser.anon.Value
import typingsSlinky.cssSelectorParser.anon.ValueType
...
object selectorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.cssSelectorParser.cssSelectorParserStrings.string
    - typingsSlinky.cssSelectorParser.cssSelectorParserStrings.substitute
  */
  trait AttrValueType extends StObject
  object AttrValueType {
    
    @scala.inline
    def string: typingsSlinky.cssSelectorParser.cssSelectorParserStrings.string = "string".asInstanceOf[typingsSlinky.cssSelectorParser.cssSelectorParserStrings.string]
    
    @scala.inline
    def substitute: typingsSlinky.cssSelectorParser.cssSelectorParserStrings.substitute = "substitute".asInstanceOf[typingsSlinky.cssSelectorParser.cssSelectorParserStrings.substitute]
  }
  ...
  */
  ...
  object Selector {
    ...
    @scala.inline
    def RuleSet(rule: Rule, `type`: ruleSet): typingsSlinky.cssSelectorParser.selectorMod.RuleSet = {
      val __obj = js.Dynamic.literal(rule = rule.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.cssSelectorParser.selectorMod.RuleSet]
    }
    
    @scala.inline
    def Selectors(selectors: js.Array[RuleSet], `type`: selectors): typingsSlinky.cssSelectorParser.selectorMod.Selectors = {
      val __obj = js.Dynamic.literal(selectors = selectors.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.cssSelectorParser.selectorMod.Selectors]
    }
  }
  ...
  */
  ...
  object SelectorEntity {
    ...
    @scala.inline
    def Rule(attrs: js.Array[RuleAttr], pseudos: js.Array[RulePseudo], `type`: rule): typingsSlinky.cssSelectorParser.selectorMod.Rule = {
      val __obj = js.Dynamic.literal(attrs = attrs.asInstanceOf[js.Any], pseudos = pseudos.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.cssSelectorParser.selectorMod.Rule]
    }
