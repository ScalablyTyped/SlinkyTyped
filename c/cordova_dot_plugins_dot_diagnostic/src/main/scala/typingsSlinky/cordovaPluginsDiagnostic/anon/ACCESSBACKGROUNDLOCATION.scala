...
import typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.ACCESS_BACKGROUND_LOCATION
...
trait ACCESSBACKGROUNDLOCATION extends js.Object {
  var ACCESS_BACKGROUND_LOCATION: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.ACCESS_BACKGROUND_LOCATION
  var ACCESS_COARSE_LOCATION: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.ACCESS_COARSE_LOCATION
  var ACCESS_FINE_LOCATION: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.ACCESS_FINE_LOCATION
  var ADD_VOICEMAIL: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.ADD_VOICEMAIL
  var BODY_SENSORS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.BODY_SENSORS
  var CALL_PHONE: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.CALL_PHONE
  var CAMERA: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.CAMERA
  var GET_ACCOUNTS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.GET_ACCOUNTS
  var PROCESS_OUTGOING_CALLS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.PROCESS_OUTGOING_CALLS
  var READ_CALENDAR: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_CALENDAR
  var READ_CALL_LOG: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_CALL_LOG
  var READ_CONTACTS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_CONTACTS
  var READ_EXTERNAL_STORAGE: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_EXTERNAL_STORAGE
  var READ_PHONE_STATE: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_PHONE_STATE
  var READ_SMS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.READ_SMS
  var RECEIVE_MMS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.RECEIVE_MMS
  var RECEIVE_SMS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.RECEIVE_SMS
  var RECEIVE_WAP_PUSH: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.RECEIVE_WAP_PUSH
  var RECORD_AUDIO: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.RECORD_AUDIO
  var SEND_SMS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.SEND_SMS
  var USE_SIP: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.USE_SIP
  var WRITE_CALENDAR: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.WRITE_CALENDAR
  var WRITE_CALL_LOG: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.WRITE_CALL_LOG
  var WRITE_CONTACTS: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.WRITE_CONTACTS
  var WRITE_EXTERNAL_STORAGE: typingsSlinky.cordovaPluginsDiagnostic.cordovaPluginsDiagnosticStrings.WRITE_EXTERNAL_STORAGE
}
