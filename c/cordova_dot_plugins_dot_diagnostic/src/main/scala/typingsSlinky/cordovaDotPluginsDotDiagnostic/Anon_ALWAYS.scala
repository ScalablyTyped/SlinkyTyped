...
import typingsSlinky.cordovaDotPluginsDotDiagnostic.cordovaDotPluginsDotDiagnosticStrings.always
import typingsSlinky.cordovaDotPluginsDotDiagnostic.cordovaDotPluginsDotDiagnosticStrings.when_in_use
