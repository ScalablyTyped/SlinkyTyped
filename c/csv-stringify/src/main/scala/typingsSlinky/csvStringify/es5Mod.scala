...
object es5Mod {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var cast: js.UndefOr[typingsSlinky.csvStringify.anon.Boolean] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCast(value: typingsSlinky.csvStringify.anon.Boolean): Self = StObject.set(x, "cast", value.asInstanceOf[js.Any])
