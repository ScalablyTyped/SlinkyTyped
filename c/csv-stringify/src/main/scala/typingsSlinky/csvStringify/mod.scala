...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setQuoted_match(value: String | js.RegExp): Self = StObject.set(x, "quoted_match", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setQuoted_matchRegExp(value: js.RegExp): Self = StObject.set(x, "quoted_match", value.asInstanceOf[js.Any])
