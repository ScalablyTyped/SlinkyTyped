...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCast(value: Date): Self = this.set("cast", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQuoted_matchRegExp(value: js.RegExp): Self = this.set("quoted_match", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setQuoted_match(value: String | js.RegExp): Self = this.set("quoted_match", value.asInstanceOf[js.Any])
