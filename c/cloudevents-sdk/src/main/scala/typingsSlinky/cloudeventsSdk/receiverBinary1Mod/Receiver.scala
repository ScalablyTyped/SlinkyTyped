package typingsSlinky.cloudeventsSdk.receiverBinary1Mod

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.NumberDictionary
import typingsSlinky.cloudeventsSdk.anon.Dictx
import typingsSlinky.cloudeventsSdk.anon.Name
...
trait Receiver extends js.Object {
  ...
  var Spec: Instantiable0[typingsSlinky.cloudeventsSdk.spec1Mod.^] = js.native
  ...
  var spec: typingsSlinky.cloudeventsSdk.spec1Mod.^ = js.native
...
object Receiver {
  ...
  @scala.inline
  def apply(
    Spec: Instantiable0[typingsSlinky.cloudeventsSdk.spec1Mod.^],
    ...
    spec: typingsSlinky.cloudeventsSdk.spec1Mod.^,
    specversion: js.Any
  ): Receiver = {
  ...
  implicit class ReceiverOps[Self <: Receiver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: Instantiable0[typingsSlinky.cloudeventsSdk.spec1Mod.^]): Self = this.set("Spec", value.asInstanceOf[js.Any])
