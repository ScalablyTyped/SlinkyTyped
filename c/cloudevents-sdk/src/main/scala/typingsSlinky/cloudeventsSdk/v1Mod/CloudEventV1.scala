package typingsSlinky.cloudeventsSdk.v1Mod
...
- typingsSlinky.cloudeventsSdk.cloudeventMod.CE because Already inherited */ @js.native
...
object CloudEventV1 {
  ...
  @scala.inline
  implicit class CloudEventV1Ops[Self <: CloudEventV1] (val x: Self) extends AnyVal {
