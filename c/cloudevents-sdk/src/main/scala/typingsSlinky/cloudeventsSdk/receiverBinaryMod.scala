...
object receiverBinaryMod {
  ...
  trait BinaryHTTPReceiver extends StObject {
    ...
    var receiver: typingsSlinky.cloudeventsSdk.receiverBinary1Mod.^ | typingsSlinky.cloudeventsSdk.receiverBinary03Mod.^ = js.native
  }
  object BinaryHTTPReceiver {
    ...
    def apply(
      ...
      receiver: typingsSlinky.cloudeventsSdk.receiverBinary1Mod.^ | typingsSlinky.cloudeventsSdk.receiverBinary03Mod.^
    ): BinaryHTTPReceiver = {
    ...
    implicit class BinaryHTTPReceiverMutableBuilder[Self <: BinaryHTTPReceiver] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReceiver(
        value: typingsSlinky.cloudeventsSdk.receiverBinary1Mod.^ | typingsSlinky.cloudeventsSdk.receiverBinary03Mod.^
