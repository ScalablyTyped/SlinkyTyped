...
object validationErrorMod {
  ...
  object ValidationError {
    ...
    implicit class ValidationErrorMutableBuilder[Self <: ValidationError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setErrors(value: js.Array[typingsSlinky.ajv.mod.ErrorObject | String]): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setErrorsVarargs(value: (typingsSlinky.ajv.mod.ErrorObject | String)*): Self = StObject.set(x, "errors", js.Array(value :_*))
    }
  }
}
