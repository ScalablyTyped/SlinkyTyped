package typingsSlinky.cloudeventsSdk.receiverBinaryMod
...
object CloudEvent {
  ...
  implicit class CloudEventOps[Self <: CloudEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloudEvent(value: Instantiable1[/* event */ CE, typingsSlinky.cloudeventsSdk.cloudeventMod.CloudEvent]): Self = this.set("CloudEvent", value.asInstanceOf[js.Any])
  }
}
