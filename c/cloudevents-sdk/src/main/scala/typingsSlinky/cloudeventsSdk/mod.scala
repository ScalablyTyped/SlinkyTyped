...
import typingsSlinky.cloudeventsSdk.anon.TypeofHTTPEmitter
...
object mod {
  ...
  class CloudEvent protected ()
    extends typingsSlinky.cloudeventsSdk.cloudeventMod.CloudEvent {
    /**
  ...
  @JSImport("cloudevents-sdk", "CloudEvent")
  @js.native
  def CloudEvent: Instantiable1[/* event */ CE, typingsSlinky.cloudeventsSdk.cloudeventMod.CloudEvent] = js.native
  @scala.inline
  def CloudEvent_=(x: Instantiable1[/* event */ CE, typingsSlinky.cloudeventsSdk.cloudeventMod.CloudEvent]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CloudEvent")(x.asInstanceOf[js.Any])
  ...
  class HTTPEmitter protected ()
    extends typingsSlinky.cloudeventsSdk.httpEmitterMod.HTTPEmitter {
    /**
  ...
  /**
    ...
    */
  class HTTPReceiver ()
    extends typingsSlinky.cloudeventsSdk.httpReceiverMod.HTTPReceiver
  @JSImport("cloudevents-sdk", "HTTPReceiver")
  @js.native
  def HTTPReceiver: Instantiable0[typingsSlinky.cloudeventsSdk.httpReceiverMod.HTTPReceiver] = js.native
  @scala.inline
  def HTTPReceiver_=(x: Instantiable0[typingsSlinky.cloudeventsSdk.httpReceiverMod.HTTPReceiver]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("HTTPReceiver")(x.asInstanceOf[js.Any])
}
