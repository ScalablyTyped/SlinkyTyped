...
object global {
  ...
  class Base64Parser protected ()
    extends typingsSlinky.cloudeventsSdk.Base64Parser {
  ...
  class JSONParser protected ()
    extends typingsSlinky.cloudeventsSdk.JSONParser {
    def this(decorator: typingsSlinky.cloudeventsSdk.Base64Parser) = this()
  }
