...
object CrossFilter {
  ...
  object CrossFilter {
    ...
    def apply[T](
      ...
      size: () => Double
    ): typingsSlinky.crossfilter.CrossFilter.CrossFilter[T] = {
      ...
      __obj.asInstanceOf[typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]]
    }
    
    @scala.inline
    implicit class CrossFilterMutableBuilder[Self <: typingsSlinky.crossfilter.CrossFilter.CrossFilter[_], T] (val x: Self with typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]) extends AnyVal {
      
      @scala.inline
      def setAdd(value: js.Array[T] => typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]): Self = StObject.set(x, "add", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRemove(value: () => typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]): Self = StObject.set(x, "remove", js.Any.fromFunction0(value))
