...
object CrossFilter {
  ...
  @scala.inline
  implicit class CrossFilterOps[Self <: typingsSlinky.crossfilter.CrossFilter.CrossFilter[_], T] (val x: Self with typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAdd(value: js.Array[T] => typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]): Self = this.set("add", js.Any.fromFunction1(value))
    @scala.inline
    def setDimension(value: js.Function1[/* data */ T, js.Any] => Dimension[T, js.Any]): Self = this.set("dimension", js.Any.fromFunction1(value))
    @scala.inline
    def setRemove(value: () => typingsSlinky.crossfilter.CrossFilter.CrossFilter[T]): Self = this.set("remove", js.Any.fromFunction0(value))
    @scala.inline
