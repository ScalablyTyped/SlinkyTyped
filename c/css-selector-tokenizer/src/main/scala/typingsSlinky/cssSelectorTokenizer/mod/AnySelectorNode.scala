...
object AnySelectorNode {
  ...
  @scala.inline
  def SelectorNode(nodes: js.Array[SelectorNodeType], `type`: selector): typingsSlinky.cssSelectorTokenizer.mod.SelectorNode = {
    val __obj = js.Dynamic.literal(nodes = nodes.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.cssSelectorTokenizer.mod.SelectorNode]
  }
  
  @scala.inline
  def SelectorsNode(nodes: js.Array[SelectorNode], `type`: selectors): typingsSlinky.cssSelectorTokenizer.mod.SelectorsNode = {
    val __obj = js.Dynamic.literal(nodes = nodes.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.cssSelectorTokenizer.mod.SelectorsNode]
  }
