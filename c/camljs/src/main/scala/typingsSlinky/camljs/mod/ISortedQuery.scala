...
object ISortedQuery {
  ...
  implicit class ISortedQueryOps[Self <: ISortedQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withThenBy(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ThenBy")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withThenByDesc(value: String => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ThenByDesc")(js.Any.fromFunction1(value))
        ret
    }
  }
