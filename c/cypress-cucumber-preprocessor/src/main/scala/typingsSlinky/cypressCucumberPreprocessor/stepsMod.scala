...
object stepsMod {
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "And")
  @js.native
  def And(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "But")
  @js.native
  def But(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "Given")
  @js.native
  def Given(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "Then")
  @js.native
  def Then(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "When")
  @js.native
  def When(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  ...
  @JSImport("cypress-cucumber-preprocessor/steps", "defineStep")
  @js.native
  def defineStep(expression: js.RegExp, implementation: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
