package typingsSlinky.classDashValidator.validationValidationTypeOptionsMod

import typingsSlinky.classDashValidator.classDashValidatorNumbers.`false`
...
trait IsURLOptions extends js.Object {
  ...
  var host_blacklist: js.UndefOr[`false` | (js.Array[String | js.RegExp])] = js.undefined
  var host_whitelist: js.UndefOr[`false` | (js.Array[String | js.RegExp])] = js.undefined
...
object IsURLOptions {
  ...
  def apply(
    ...
    host_blacklist: `false` | (js.Array[String | js.RegExp]) = null,
    host_whitelist: `false` | (js.Array[String | js.RegExp]) = null,
