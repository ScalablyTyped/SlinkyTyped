...
object validationValidatorMod extends js.Object {
  ...
  class Validator () extends js.Object {
    ...
    def matches(value: String, pattern: js.RegExp, modifiers: String): Boolean = js.native
    /**
    ...
    /**
      ...
      */
    def maxDate(date: js.Date, maxDate: js.Date): Boolean = js.native
    /**
    ...
    /**
      ...
      */
    def minDate(date: js.Date, minDate: js.Date): Boolean = js.native
    /**
