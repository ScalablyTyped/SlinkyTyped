...
import typingsSlinky.classValidator.containerMod.UseContainerOptions
import typingsSlinky.classValidator.registerDecoratorMod.ValidationDecoratorOptions
...
import typingsSlinky.classValidator.validationTypeOptionsMod.IsNumberOptions
...
object mod extends js.Object {
  ...
  class MetadataStorage ()
    extends typingsSlinky.classValidator.metadataStorageMod.MetadataStorage
  
  @js.native
  class ValidationError ()
    extends typingsSlinky.classValidator.validationErrorMod.ValidationError
  
  @js.native
  class ValidationTypes ()
    extends typingsSlinky.classValidator.validationTypesMod.ValidationTypes
  
  @js.native
  class Validator ()
    extends typingsSlinky.classValidator.validatorMod.Validator
  ...
  def Matches(pattern: js.RegExp): js.Function = js.native
  def Matches(pattern: js.RegExp, modifiers: String): js.Function = js.native
  def Matches(pattern: js.RegExp, modifiers: String, validationOptions: ValidationOptions): js.Function = js.native
  def Matches(pattern: js.RegExp, validationOptions: ValidationOptions): js.Function = js.native
  ...
  def MaxDate(date: js.Date): js.Function2[/* object */ js.Object, /* propertyName */ String, Unit] = js.native
  def MaxDate(date: js.Date, validationOptions: ValidationOptions): js.Function2[/* object */ js.Object, /* propertyName */ String, Unit] = js.native
  ...
  def MinDate(date: js.Date): js.Function2[/* object */ js.Object, /* propertyName */ String, Unit] = js.native
  def MinDate(date: js.Date, validationOptions: ValidationOptions): js.Function2[/* object */ js.Object, /* propertyName */ String, Unit] = js.native
  ...
  def validate(`object`: js.Object): js.Promise[js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(`object`: js.Object, validatorOptions: ValidatorOptions): js.Promise[js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(schemaName: String, `object`: js.Object): js.Promise[js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(schemaName: String, `object`: js.Object, validatorOptions: ValidatorOptions): js.Promise[js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError]] = js.native
  ...
  def validateSync(`object`: js.Object): js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(`object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(schemaName: String, `object`: js.Object): js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(schemaName: String, `object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsSlinky.classValidator.validationErrorMod.ValidationError] = js.native
  /* static members */
  @js.native
