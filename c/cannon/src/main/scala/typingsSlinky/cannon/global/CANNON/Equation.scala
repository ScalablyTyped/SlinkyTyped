...
class Equation protected ()
  ...
  def this(bi: typingsSlinky.cannon.CANNON.Body, bj: typingsSlinky.cannon.CANNON.Body, minForce: Double) = this()
  def this(
    bi: typingsSlinky.cannon.CANNON.Body,
    bj: typingsSlinky.cannon.CANNON.Body,
    minForce: Double,
    maxForce: Double
  ) = this()
  /* CompleteClass */
