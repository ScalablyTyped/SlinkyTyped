...
object RotationalEquation {
  ...
  implicit class RotationalEquationOps[Self <: RotationalEquation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNixnj(value: Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nixnj")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNj(value: Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nj")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNjxni(value: Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("njxni")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRelForce(value: Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("relForce")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRelVel(value: Vec3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("relVel")(value.asInstanceOf[js.Any])
        ret
    }
  }
