...
import typingsSlinky.cassandraDashDriver.cassandraDashDriverMod.types.BigDecimal
import typingsSlinky.cassandraDashDriver.cassandraDashDriverMod.types.InetAddress
import typingsSlinky.cassandraDashDriver.cassandraDashDriverMod.types.LocalDate
import typingsSlinky.cassandraDashDriver.cassandraDashDriverMod.types.TimeUuid
import typingsSlinky.cassandraDashDriver.cassandraDashDriverMod.types.Uuid
...
trait FieldValueQueryBuilder[T] extends js.Object {
  ...
  def bigint[K /* <: String */](columnName: K): TypeMatchedValue[T, K, typingsSlinky.long.longMod.^, this.type]
  ...
  def counter[K /* <: String */](columnName: K): TypeMatchedValue[T, K, typingsSlinky.long.longMod.^, this.type]
  ...
  def double[K /* <: String */](columnName: K): TypeMatchedValue[T, K, typingsSlinky.long.longMod.^, this.type]
...
object FieldValueQueryBuilder {
  ...
  def apply[T](
    ...
    bigint: js.Any => TypeMatchedValue[T, js.Any, typingsSlinky.long.longMod.^, FieldValueQueryBuilder[T]],
    ...
    counter: js.Any => TypeMatchedValue[T, js.Any, typingsSlinky.long.longMod.^, FieldValueQueryBuilder[T]],
    ...
    double: js.Any => TypeMatchedValue[T, js.Any, typingsSlinky.long.longMod.^, FieldValueQueryBuilder[T]],
