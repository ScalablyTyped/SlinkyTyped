package typingsSlinky.chartjsPluginAnnotation
  ...
  */
  ...
  object AnnotationOptions {
    ...
    def BoxAnnotationOptions(
      ...
      __obj.asInstanceOf[typingsSlinky.chartjsPluginAnnotation.mod.BoxAnnotationOptions]
    }
    
    @scala.inline
    def LineAnnotationOptions(mode: horizontal | vertical, scaleID: String, `type`: line, value: ChartPointValue): typingsSlinky.chartjsPluginAnnotation.mod.LineAnnotationOptions = {
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.chartjsPluginAnnotation.mod.LineAnnotationOptions]
    }
  }
  ...
  object BoxAnnotationOptions {
    ...
    implicit class BoxAnnotationOptionsMutableBuilder[Self <: BoxAnnotationOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setXMaxDate(value: js.Date): Self = StObject.set(x, "xMax", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setXMin(value: ChartPointValue): Self = StObject.set(x, "xMin", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setXMinDate(value: js.Date): Self = StObject.set(x, "xMin", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setYMaxDate(value: js.Date): Self = StObject.set(x, "yMax", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setYMin(value: ChartPointValue): Self = StObject.set(x, "yMin", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setYMinDate(value: js.Date): Self = StObject.set(x, "yMin", value.asInstanceOf[js.Any])
