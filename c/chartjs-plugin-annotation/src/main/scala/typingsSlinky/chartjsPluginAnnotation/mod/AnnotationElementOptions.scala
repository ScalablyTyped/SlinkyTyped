...
object AnnotationElementOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.chartjsPluginAnnotation.mod.AnnotationOptions */ T](
  ...
  @scala.inline
  implicit class AnnotationElementOptionsOps[Self <: AnnotationElementOptions[_], /* <: typingsSlinky.chartjsPluginAnnotation.mod.AnnotationOptions */ T] (val x: Self with AnnotationElementOptions[T]) extends AnyVal {
    @scala.inline
