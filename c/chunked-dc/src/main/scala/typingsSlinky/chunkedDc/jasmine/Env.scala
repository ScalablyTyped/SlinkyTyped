...
object Env {
  ...
  implicit class EnvMutableBuilder[Self <: Env] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompareRegExps_(value: (js.RegExp, js.RegExp, js.Array[String], js.Array[String]) => Boolean): Self = StObject.set(x, "compareRegExps_", js.Any.fromFunction4(value))
