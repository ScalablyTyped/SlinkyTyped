...
object Standalone {
  ...
  implicit class StandaloneOps[Self <: Standalone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChunker(value: ChunkerStatic): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Chunker")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUnchunker(value: UnchunkerStatic): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Unchunker")(value.asInstanceOf[js.Any])
        ret
    }
  }
