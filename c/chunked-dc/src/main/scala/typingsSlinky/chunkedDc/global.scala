...
import typingsSlinky.chunkedDc.chunkedDc.Chunker
import typingsSlinky.chunkedDc.chunkedDc.Standalone
import typingsSlinky.chunkedDc.chunkedDc.Unchunker
import typingsSlinky.chunkedDc.jasmine.Any
import typingsSlinky.chunkedDc.jasmine.ArrayContaining
import typingsSlinky.chunkedDc.jasmine.Clock
import typingsSlinky.chunkedDc.jasmine.CustomEqualityTester
import typingsSlinky.chunkedDc.jasmine.CustomMatcherFactories
import typingsSlinky.chunkedDc.jasmine.Env
import typingsSlinky.chunkedDc.jasmine.HtmlReporter
import typingsSlinky.chunkedDc.jasmine.HtmlSpecFilter
import typingsSlinky.chunkedDc.jasmine.Matchers
import typingsSlinky.chunkedDc.jasmine.ObjectContaining
import typingsSlinky.chunkedDc.jasmine.Spy
...
object global {
  ...
  object jasmine {
    ...
    @js.native
    def HtmlReporter: typingsSlinky.chunkedDc.jasmine.HtmlReporter = js.native
    @scala.inline
    ...
    @js.native
    def HtmlSpecFilter: typingsSlinky.chunkedDc.jasmine.HtmlSpecFilter = js.native
    @scala.inline
    ...
    @JSGlobal("jasmine.stringMatching")
    @js.native
    def stringMatching(str: js.RegExp): Any = js.native
  }
