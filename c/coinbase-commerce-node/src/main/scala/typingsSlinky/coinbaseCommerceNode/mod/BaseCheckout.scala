...
object BaseCheckout {
  ...
  implicit class BaseCheckoutOps[Self <: BaseCheckout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequested_info(value: js.Array[email | name]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requested_info")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRequested_info: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("requested_info")(js.undefined)
        ret
    }
  }
