...
import typingsSlinky.coinbaseDashCommerceDashNode.coinbaseDashCommerceDashNodeStrings.email
import typingsSlinky.coinbaseDashCommerceDashNode.coinbaseDashCommerceDashNodeStrings.name
