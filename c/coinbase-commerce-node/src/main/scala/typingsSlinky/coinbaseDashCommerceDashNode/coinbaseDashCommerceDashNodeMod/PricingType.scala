...
object PricingType {
  ...
  @scala.inline
  def fixed_price: typingsSlinky.coinbaseDashCommerceDashNode.coinbaseDashCommerceDashNodeStrings.fixed_price = this.cast("fixed_price")
  @scala.inline
  def no_price: typingsSlinky.coinbaseDashCommerceDashNode.coinbaseDashCommerceDashNodeStrings.no_price = this.cast("no_price")
}
