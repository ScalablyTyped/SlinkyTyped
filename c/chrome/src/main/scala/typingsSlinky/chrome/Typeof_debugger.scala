...
import typingsSlinky.chrome.chrome._debugger.Debuggee
import typingsSlinky.chrome.chrome._debugger.DebuggerDetachedEvent
import typingsSlinky.chrome.chrome._debugger.DebuggerEventEvent
import typingsSlinky.chrome.chrome._debugger.TargetInfo
