...
object TypeoftabCapture {
  ...
  implicit class TypeoftabCaptureOps[Self <: TypeoftabCapture] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCapture(value: (CaptureOptions, js.Function1[/* stream */ MediaStream | Null, Unit]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("capture")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetCapturedTabs(value: js.Function1[/* result */ js.Array[CaptureInfo], Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCapturedTabs")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnStatusChanged(value: CaptureStatusChangedEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onStatusChanged")(value.asInstanceOf[js.Any])
        ret
    }
  }
