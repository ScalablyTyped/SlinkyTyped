...
trait DisplayPropertiesInfo extends js.Object {
  ...
  /**
    ...
    */
  var boundsOriginY: Double = js.native
  /**
...
object DisplayPropertiesInfo {
  @scala.inline
  def apply(boundsOriginY: Double): DisplayPropertiesInfo = {
