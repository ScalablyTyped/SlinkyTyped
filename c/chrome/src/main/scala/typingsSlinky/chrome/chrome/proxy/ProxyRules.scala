...
object ProxyRules {
  ...
  implicit class ProxyRulesOps[Self <: ProxyRules] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFallbackProxy(value: ProxyServer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProxyForFtp(value: ProxyServer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProxyForHttp(value: ProxyServer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withProxyForHttps(value: ProxyServer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSingleProxy(value: ProxyServer): Self = {
        val ret = this.duplicate
