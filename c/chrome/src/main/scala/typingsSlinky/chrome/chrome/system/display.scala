...
import typingsSlinky.chrome.chromeNumbers.`0`
import typingsSlinky.chrome.chromeNumbers.`180`
import typingsSlinky.chrome.chromeNumbers.`270`
import typingsSlinky.chrome.chromeNumbers.`90`
