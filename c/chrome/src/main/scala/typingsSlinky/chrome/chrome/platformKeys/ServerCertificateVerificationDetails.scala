...
trait ServerCertificateVerificationDetails extends js.Object {
  ...
  var serverCertificateChain: js.Array[scala.scalajs.js.typedarray.ArrayBuffer]
}

object ServerCertificateVerificationDetails {
  @scala.inline
  def apply(hostname: String, serverCertificateChain: js.Array[scala.scalajs.js.typedarray.ArrayBuffer]): ServerCertificateVerificationDetails = {
