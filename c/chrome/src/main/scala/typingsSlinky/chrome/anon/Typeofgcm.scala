...
object Typeofgcm {
  ...
  implicit class TypeofgcmOps[Self <: Typeofgcm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMAX_MESSAGE_SIZE(value: Double): Self = this.set("MAX_MESSAGE_SIZE", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnMessage(value: MessageReceptionEvent): Self = this.set("onMessage", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnMessagesDeleted(value: MessageDeletionEvent): Self = this.set("onMessagesDeleted", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnSendError(value: GcmErrorEvent): Self = this.set("onSendError", value.asInstanceOf[js.Any])
    @scala.inline
