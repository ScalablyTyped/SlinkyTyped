...
class MediaInfo protected ()
  ...
  /* CompleteClass */
  override var streamType: typingsSlinky.chrome.chrome.cast.media.StreamType = js.native
  /* CompleteClass */
  override var textTrackStyle: typingsSlinky.chrome.chrome.cast.media.TextTrackStyle = js.native
  /* CompleteClass */
  override var tracks: js.Array[typingsSlinky.chrome.chrome.cast.media.Track] = js.native
}
