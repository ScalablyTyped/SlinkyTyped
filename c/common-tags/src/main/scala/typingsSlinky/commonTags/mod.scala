...
import typingsSlinky.commonTags.commonTagsStrings._empty
import typingsSlinky.commonTags.commonTagsStrings.all
import typingsSlinky.commonTags.commonTagsStrings.end
import typingsSlinky.commonTags.commonTagsStrings.initial
import typingsSlinky.commonTags.commonTagsStrings.left
import typingsSlinky.commonTags.commonTagsStrings.right
import typingsSlinky.commonTags.commonTagsStrings.start
...
object mod {
  ...
  @JSImport("common-tags", "replaceResultTransformer")
  @js.native
  def replaceResultTransformer(replaceWhat: js.RegExp, replaceWith: String): TemplateTransformer[StringDictionary[_]] = js.native
  @JSImport("common-tags", "replaceResultTransformer")
  @js.native
  def replaceResultTransformer(
  ...
  @JSImport("common-tags", "replaceStringTransformer")
  @js.native
  def replaceStringTransformer(replaceWhat: js.RegExp, replaceWith: String): TemplateTransformer[StringDictionary[_]] = js.native
  @JSImport("common-tags", "replaceStringTransformer")
  @js.native
  def replaceStringTransformer(
    replaceWhat: js.RegExp,
  ...
  @JSImport("common-tags", "replaceSubstitutionTransformer")
  @js.native
  def replaceSubstitutionTransformer(replaceWhat: js.RegExp, replaceWith: String): TemplateTransformer[StringDictionary[_]] = js.native
  @JSImport("common-tags", "replaceSubstitutionTransformer")
  @js.native
  def replaceSubstitutionTransformer(
    replaceWhat: js.RegExp,
