...
trait AnonSpace extends js.Object {
  ...
  /**
    ...
    */
  var width: js.UndefOr[Double | AnonRatio] = js.native
  /**
...
object AnonSpace {
  ...
  @scala.inline
  implicit class AnonSpaceOps[Self <: AnonSpace] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWidth(value: Double | AnonRatio): Self = {
        val ret = this.duplicate
