...
import typingsSlinky.c3.mod.Padding
...
trait AnonColors extends js.Object {
  ...
  var lines: js.UndefOr[js.Array[AnonClass]] = js.native
  /**
    * Set the padding for the Stanford color scale.
    */
  var padding: js.UndefOr[Padding] = js.native
  /** Add regions to the chart. */
  var regions: js.UndefOr[js.Array[AnonOpacity]] = js.native
  /**
  ...
  var texts: js.UndefOr[js.Array[AnonContent]] = js.native
}
...
object AnonColors {
  ...
  implicit class AnonColorsOps[Self <: AnonColors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLines(value: js.Array[AnonClass]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRegions(value: js.Array[AnonOpacity]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withScaleWidth(value: scala.Nothing): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleWidth")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutScaleWidth: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("scaleWidth")(js.undefined)
        ret
    }
    @scala.inline
    def withTexts(value: js.Array[AnonContent]): Self = {
        val ret = this.duplicate
