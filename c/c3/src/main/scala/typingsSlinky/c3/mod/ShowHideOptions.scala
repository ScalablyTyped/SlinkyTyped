...
object ShowHideOptions {
  ...
  implicit class ShowHideOptionsOps[Self <: ShowHideOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWithLegend(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("withLegend")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWithLegend: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("withLegend")(js.undefined)
        ret
    }
  }
