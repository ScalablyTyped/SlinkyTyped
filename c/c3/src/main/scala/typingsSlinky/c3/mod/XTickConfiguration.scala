...
object XTickConfiguration {
  ...
  implicit class XTickConfigurationOps[Self <: XTickConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatFunction1(value: /* x */ Double | js.Date => String | Double): Self = this.set("format", js.Any.fromFunction1(value))
    
    @scala.inline
    def setFormat(value: String | (js.Function1[/* x */ Double | js.Date, String | Double])): Self = this.set("format", value.asInstanceOf[js.Any])
