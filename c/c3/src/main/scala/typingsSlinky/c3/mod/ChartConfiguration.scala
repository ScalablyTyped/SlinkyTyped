...
object ChartConfiguration {
  ...
  implicit class ChartConfigurationMutableBuilder[Self <: ChartConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBindtoHTMLElement(value: HTMLElement): Self = StObject.set(x, "bindto", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: typingsSlinky.c3.anon.Padding): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
