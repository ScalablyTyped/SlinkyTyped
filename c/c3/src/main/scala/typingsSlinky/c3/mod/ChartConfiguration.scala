...
object ChartConfiguration {
  ...
  implicit class ChartConfigurationOps[Self <: ChartConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBindtoHTMLElement(value: HTMLElement): Self = this.set("bindto", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitle(value: typingsSlinky.c3.anon.Padding): Self = this.set("title", value.asInstanceOf[js.Any])
    @scala.inline
