package typingsSlinky.connectHistoryApiFallback
...
object mod {
  ...
  object Rewrite {
    ...
    implicit class RewriteMutableBuilder[Self <: Rewrite] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTo(value: String | js.RegExp | RewriteTo): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setToFunction1(value: /* context */ Context => String): Self = StObject.set(x, "to", js.Any.fromFunction1(value))
      
      @scala.inline
      def setToRegExp(value: js.RegExp): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
    }
  }
