...
object RuntimeOptions {
  ...
  implicit class RuntimeOptionsOps[Self <: RuntimeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHighlightVarargs(value: js.Date*): Self = this.set("highlight", js.Array(value :_*))
    @scala.inline
    def setHighlight(value: js.Array[js.Date]): Self = this.set("highlight", value.asInstanceOf[js.Any])
    @scala.inline
