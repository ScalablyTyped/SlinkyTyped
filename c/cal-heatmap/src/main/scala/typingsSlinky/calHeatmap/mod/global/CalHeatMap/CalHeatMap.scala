...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typingsSlinky.calHeatmap.mod.global.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typingsSlinky.calHeatmap.mod.global.CalHeatMap.CalHeatMap = js.native
  /**
