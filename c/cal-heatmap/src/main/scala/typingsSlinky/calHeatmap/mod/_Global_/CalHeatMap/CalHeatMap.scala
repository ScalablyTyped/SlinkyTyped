...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typingsSlinky.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typingsSlinky.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  /**
