...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterLoadNextDomain(value: /* date */ js.Date => Unit): Self = this.set("afterLoadNextDomain", js.Any.fromFunction1(value))
    @scala.inline
    def deleteAfterLoadNextDomain: Self = this.set("afterLoadNextDomain", js.undefined)
    @scala.inline
    def setAfterLoadPreviousDomain(value: /* date */ js.Date => Unit): Self = this.set("afterLoadPreviousDomain", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setHighlightVarargs(value: (js.Any | js.Date | String)*): Self = this.set("highlight", js.Array(value :_*))
    @scala.inline
    def setHighlight(value: String | (js.Array[_ | js.Date | String])): Self = this.set("highlight", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setItemSelectorElement(value: Element): Self = this.set("itemSelector", value.asInstanceOf[js.Any])
    @scala.inline
    def setItemSelectorEventTarget(value: EventTarget): Self = this.set("itemSelector", value.asInstanceOf[js.Any])
    @scala.inline
    def setItemSelectorHTMLElement(value: HTMLElement): Self = this.set("itemSelector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNextSelectorHTMLElement(value: HTMLElement): Self = this.set("nextSelector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnClick(value: (/* date */ js.Date, /* value */ Double) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setPreviousSelectorHTMLElement(value: HTMLElement): Self = this.set("previousSelector", value.asInstanceOf[js.Any])
    @scala.inline
