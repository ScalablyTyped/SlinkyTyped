...
trait InitOptions extends js.Object {
  ...
  /**
    ...
    */
  var highlight: js.UndefOr[String | (js.Array[_ | js.Date | String])] = js.undefined
  // ================================================
  // i18n
  // ================================================
  /**
...
object InitOptions {
  ...
  def apply(
    ...
    afterLoadNextDomain: /* date */ js.Date => Unit = null,
    afterLoadPreviousDomain: /* date */ js.Date => Unit = null,
    ...
    highlight: String | (js.Array[_ | js.Date | String]) = null,
    ...
    onClick: (/* date */ js.Date, /* value */ Double) => Unit = null,
