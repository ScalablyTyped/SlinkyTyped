  ...
  object global {
    ...
    object CalHeatMap extends Shortcut {
      ...
      trait CalHeatMapStatic
        extends Instantiable0[typingsSlinky.calHeatmap.mod.global.CalHeatMap.CalHeatMap]
      ...
      object InitOptions {
        ...
        implicit class InitOptionsMutableBuilder[Self <: InitOptions] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setAfterLoadNextDomain(value: /* date */ js.Date => Unit): Self = StObject.set(x, "afterLoadNextDomain", js.Any.fromFunction1(value))
          
          @scala.inline
          def setAfterLoadNextDomainUndefined: Self = StObject.set(x, "afterLoadNextDomain", js.undefined)
          
          @scala.inline
          def setAfterLoadPreviousDomain(value: /* date */ js.Date => Unit): Self = StObject.set(x, "afterLoadPreviousDomain", js.Any.fromFunction1(value))
          ...
          @scala.inline
          def setHighlight(value: String | (js.Array[_ | js.Date | String])): Self = StObject.set(x, "highlight", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setHighlightUndefined: Self = StObject.set(x, "highlight", js.undefined)
          
          @scala.inline
          def setHighlightVarargs(value: (js.Any | js.Date | String)*): Self = StObject.set(x, "highlight", js.Array(value :_*))
          ...
          @scala.inline
          def setItemSelectorElement(value: Element): Self = StObject.set(x, "itemSelector", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setItemSelectorEventTarget(value: EventTarget): Self = StObject.set(x, "itemSelector", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setItemSelectorHTMLElement(value: HTMLElement): Self = StObject.set(x, "itemSelector", value.asInstanceOf[js.Any])
          ...
          @scala.inline
          def setNextSelectorHTMLElement(value: HTMLElement): Self = StObject.set(x, "nextSelector", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setNextSelectorUndefined: Self = StObject.set(x, "nextSelector", js.undefined)
          
          @scala.inline
          def setOnClick(value: (/* date */ js.Date, /* value */ Double) => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
          ...
          @scala.inline
          def setPreviousSelectorHTMLElement(value: HTMLElement): Self = StObject.set(x, "previousSelector", value.asInstanceOf[js.Any])
      ...
      object RuntimeOptions {
        ...
        implicit class RuntimeOptionsMutableBuilder[Self <: RuntimeOptions] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setHighlight(value: js.Array[js.Date]): Self = StObject.set(x, "highlight", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setHighlightVarargs(value: js.Date*): Self = StObject.set(x, "highlight", js.Array(value :_*))
