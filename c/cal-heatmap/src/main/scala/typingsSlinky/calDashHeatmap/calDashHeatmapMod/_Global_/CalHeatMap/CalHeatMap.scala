...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typingsSlinky.calDashHeatmap.calDashHeatmapMod._Global_.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typingsSlinky.calDashHeatmap.calDashHeatmapMod._Global_.CalHeatMap.CalHeatMap = js.native
  /**
