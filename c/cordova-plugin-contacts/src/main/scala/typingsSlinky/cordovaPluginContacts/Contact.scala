...
object Contact {
  ...
  implicit class ContactMutableBuilder[Self <: Contact] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRemove(value: (js.Function0[Unit], js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "remove", js.Any.fromFunction2(value))
    
    @scala.inline
    def setSave(value: (js.Function1[Contact, Unit], js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "save", js.Any.fromFunction2(value))
  }
}
