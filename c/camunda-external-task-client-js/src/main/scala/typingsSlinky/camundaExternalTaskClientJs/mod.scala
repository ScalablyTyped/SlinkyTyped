...
import typingsSlinky.camundaExternalTaskClientJs.anon.Error
import typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonsuccess
...
object mod {
  ...
  */
  ...
  object ErrorEvent {
    ...
    @scala.inline
    def completeColonerror: typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonerror = "complete:error".asInstanceOf[typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonerror]
    
    @scala.inline
    def pollColonerror: typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonerror = "poll:error".asInstanceOf[typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonerror]
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonsuccess
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonsuccess
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonsuccess
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonsuccess
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonsuccess
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.subscribe
    - typingsSlinky.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unsubscribe
  */
