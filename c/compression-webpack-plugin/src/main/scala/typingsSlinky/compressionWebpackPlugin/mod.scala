...
object mod {
  ...
  type AlgorithmCallback = js.Function2[/* error */ js.Error | Null, /* result */ js.typedarray.Uint8Array, Unit]
  ...
  */
  ...
  object ZlibOptions {
    ...
    implicit class ZlibOptionsMutableBuilder[Self <: ZlibOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCompressionOptions(value: typingsSlinky.node.zlibMod.ZlibOptions): Self = StObject.set(x, "compressionOptions", value.asInstanceOf[js.Any])
