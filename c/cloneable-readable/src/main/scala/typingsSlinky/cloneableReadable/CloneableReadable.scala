package typingsSlinky.cloneableReadable

import typingsSlinky.cloneableReadable.cloneableReadableStrings.close
import typingsSlinky.cloneableReadable.cloneableReadableStrings.data
import typingsSlinky.cloneableReadable.cloneableReadableStrings.end
import typingsSlinky.cloneableReadable.cloneableReadableStrings.error
import typingsSlinky.cloneableReadable.cloneableReadableStrings.pause
import typingsSlinky.cloneableReadable.cloneableReadableStrings.readable
import typingsSlinky.cloneableReadable.cloneableReadableStrings.resume
...
/* Inlined cloneable-readable.cloneable-readable.Cloneable<node.stream.Readable> */
@js.native
