...
object CordovaPlugins {
  ...
  implicit class CordovaPluginsOps[Self <: CordovaPlugins] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeviceName(value: typingsSlinky.cordovaPluginDeviceName.CordovaPluginDeviceName.CordovaPluginDeviceName): Self = this.set("deviceName", value.asInstanceOf[js.Any])
  }
}
