...
class SideNav protected ()
  extends typingsSlinky.carbonComponents.componentsMod.SideNav {
...
object SideNav {
  ...
  object options {
    ...
    @JSImport("carbon-components", "SideNav.options.classSideNavExpanded")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.classSideNavItemActive")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.classSideNavLinkCurrent")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.selectorInit")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.selectorSideNavItem")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.selectorSideNavLink")
    @js.native
    def selectorSideNavLink: String = js.native
    
    @JSImport("carbon-components", "SideNav.options.selectorSideNavLinkCurrent")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.selectorSideNavSubmenu")
    @js.native
    ...
    @JSImport("carbon-components", "SideNav.options.selectorSideNavToggle")
    @js.native
