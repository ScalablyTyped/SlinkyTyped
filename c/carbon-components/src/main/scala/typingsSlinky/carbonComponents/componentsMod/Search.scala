...
import typingsSlinky.carbonComponents.anon.ClassClearHidden
import typingsSlinky.carbonComponents.searchMod.default
...
@js.native
class Search protected () extends default {
