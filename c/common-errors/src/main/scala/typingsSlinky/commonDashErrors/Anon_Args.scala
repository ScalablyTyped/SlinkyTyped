package typingsSlinky.commonDashErrors

import typingsSlinky.commonDashErrors.commonDashErrorsMod.Error
import typingsSlinky.commonDashErrors.commonDashErrorsMod.GenerateMessageMethod
