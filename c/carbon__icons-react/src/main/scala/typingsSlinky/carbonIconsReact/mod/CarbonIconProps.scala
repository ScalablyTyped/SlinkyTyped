...
object CarbonIconProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event, SVGElement] => Unit = null,
    ...
    onBeforeInput: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    onBlur: SyntheticFocusEvent[SVGElement] => Unit = null,
    onCanPlay: SyntheticEvent[Event, SVGElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event, SVGElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event, SVGElement] => Unit = null,
    onEmptied: SyntheticEvent[Event, SVGElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event, SVGElement] => Unit = null,
    onEnded: SyntheticEvent[Event, SVGElement] => Unit = null,
    onError: SyntheticEvent[Event, SVGElement] => Unit = null,
    onFocus: SyntheticFocusEvent[SVGElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event, SVGElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event, SVGElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event, SVGElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event, SVGElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event, SVGElement] => Unit = null,
    onPlay: SyntheticEvent[Event, SVGElement] => Unit = null,
    onPlaying: SyntheticEvent[Event, SVGElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event, SVGElement] => Unit = null,
    onRateChange: SyntheticEvent[Event, SVGElement] => Unit = null,
    onReset: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    onScroll: SyntheticUIEvent[SVGElement] => Unit = null,
    onSeeked: SyntheticEvent[Event, SVGElement] => Unit = null,
    onSeeking: SyntheticEvent[Event, SVGElement] => Unit = null,
    onSelect: SyntheticEvent[Event, SVGElement] => Unit = null,
    onStalled: SyntheticEvent[Event, SVGElement] => Unit = null,
    onSubmit: SyntheticEvent[EventTarget with SVGElement, Event] => Unit = null,
    onSuspend: SyntheticEvent[Event, SVGElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event, SVGElement] => Unit = null,
