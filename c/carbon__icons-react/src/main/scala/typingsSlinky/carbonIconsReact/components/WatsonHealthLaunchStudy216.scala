...
object WatsonHealthLaunchStudy216 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthLaunchStudy_216")
  @js.native
  ...
  implicit def make(companion: WatsonHealthLaunchStudy216.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
