...
object Notebook32 {
  ...
  @JSImport("@carbon/icons-react", "Notebook32")
  @js.native
  ...
  implicit def make(companion: Notebook32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
