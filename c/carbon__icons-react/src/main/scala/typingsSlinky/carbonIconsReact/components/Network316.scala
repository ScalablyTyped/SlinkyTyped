...
object Network316 {
  ...
  @JSImport("@carbon/icons-react", "Network316")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network316.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
