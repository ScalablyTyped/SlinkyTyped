...
object CaretRight {
  ...
  @JSImport("@carbon/icons-react/lib/caret--right", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: CaretRight.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
