...
object Select0220 {
  ...
  @JSImport("@carbon/icons-react", "Select0220")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Select0220.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
