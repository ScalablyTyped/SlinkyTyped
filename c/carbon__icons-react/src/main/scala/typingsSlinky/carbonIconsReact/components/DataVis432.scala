...
object DataVis432 {
  ...
  @JSImport("@carbon/icons-react", "DataVis_432")
  @js.native
  ...
  implicit def make(companion: DataVis432.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
