...
object Script32 {
  ...
  @JSImport("@carbon/icons-react", "Script32")
  @js.native
  ...
  implicit def make(companion: Script32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
