...
object SatelliteRadar20 {
  
  @JSImport("@carbon/icons-react", "SatelliteRadar20")
  @js.native
  ...
  implicit def make(companion: SatelliteRadar20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
