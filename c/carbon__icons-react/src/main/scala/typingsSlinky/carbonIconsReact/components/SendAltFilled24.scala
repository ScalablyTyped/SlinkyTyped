...
object SendAltFilled24 {
  
  @JSImport("@carbon/icons-react", "SendAltFilled24")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SendAltFilled24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
