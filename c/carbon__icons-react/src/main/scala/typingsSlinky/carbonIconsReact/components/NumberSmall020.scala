...
object NumberSmall020 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_020")
  @js.native
  ...
  implicit def make(companion: NumberSmall020.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
