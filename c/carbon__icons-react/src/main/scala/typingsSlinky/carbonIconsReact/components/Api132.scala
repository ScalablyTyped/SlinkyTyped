...
object Api132 {
  ...
  @JSImport("@carbon/icons-react", "Api132")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Api132.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
