...
object Number920 {
  ...
  @JSImport("@carbon/icons-react", "Number_920")
  @js.native
  ...
  implicit def make(companion: Number920.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
