...
object AccessibilityColorFilled24 {
  
  @JSImport("@carbon/icons-react", "AccessibilityColorFilled24")
  @js.native
  ...
  implicit def make(companion: AccessibilityColorFilled24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
