...
object NumberSmall620 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_620")
  @js.native
  ...
  implicit def make(companion: NumberSmall620.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
