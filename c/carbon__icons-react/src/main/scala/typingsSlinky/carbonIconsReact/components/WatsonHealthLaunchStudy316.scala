...
object WatsonHealthLaunchStudy316 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthLaunchStudy_316")
  @js.native
  ...
  implicit def make(companion: WatsonHealthLaunchStudy316.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
