...
object Concept16 {
  ...
  @JSImport("@carbon/icons-react", "Concept16")
  @js.native
  ...
  implicit def make(companion: Concept16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
