...
object Classification16 {
  
  @JSImport("@carbon/icons-react", "Classification16")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Classification16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
