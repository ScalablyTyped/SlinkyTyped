...
object WatsonHealthSmoothing24 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthSmoothing24")
  @js.native
  ...
  implicit def make(companion: WatsonHealthSmoothing24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
