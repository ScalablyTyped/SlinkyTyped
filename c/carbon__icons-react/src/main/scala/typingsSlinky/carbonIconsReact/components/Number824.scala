...
object Number824 {
  ...
  @JSImport("@carbon/icons-react", "Number824")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number824.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
