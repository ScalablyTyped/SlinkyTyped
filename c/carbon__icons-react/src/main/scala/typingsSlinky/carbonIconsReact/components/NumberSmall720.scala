...
object NumberSmall720 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_720")
  @js.native
  ...
  implicit def make(companion: NumberSmall720.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
