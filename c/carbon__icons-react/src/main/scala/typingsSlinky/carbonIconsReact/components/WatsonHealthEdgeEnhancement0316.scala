...
object WatsonHealthEdgeEnhancement0316 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthEdgeEnhancement_0316")
  @js.native
  ...
  implicit def make(companion: WatsonHealthEdgeEnhancement0316.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
