...
object Flood32 {
  ...
  @JSImport("@carbon/icons-react", "Flood32")
  @js.native
  ...
  implicit def make(companion: Flood32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
