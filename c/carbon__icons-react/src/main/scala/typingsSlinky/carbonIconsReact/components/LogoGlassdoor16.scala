...
object LogoGlassdoor16 {
  
  @JSImport("@carbon/icons-react", "LogoGlassdoor16")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LogoGlassdoor16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
