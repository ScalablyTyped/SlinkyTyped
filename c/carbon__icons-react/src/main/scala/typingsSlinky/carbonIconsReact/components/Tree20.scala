...
object Tree20 {
  ...
  @JSImport("@carbon/icons-react", "Tree20")
  @js.native
  ...
  implicit def make(companion: Tree20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
