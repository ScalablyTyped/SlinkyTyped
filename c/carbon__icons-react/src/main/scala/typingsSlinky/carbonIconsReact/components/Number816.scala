...
object Number816 {
  ...
  @JSImport("@carbon/icons-react", "Number816")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number816.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
