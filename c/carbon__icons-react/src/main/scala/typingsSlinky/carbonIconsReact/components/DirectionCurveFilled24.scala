...
object DirectionCurveFilled24 {
  
  @JSImport("@carbon/icons-react", "DirectionCurveFilled24")
  @js.native
  ...
  implicit def make(companion: DirectionCurveFilled24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
