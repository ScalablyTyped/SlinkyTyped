...
object TextFill16 {
  ...
  @JSImport("@carbon/icons-react", "TextFill16")
  @js.native
  ...
  implicit def make(companion: TextFill16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
