...
object NumberSmall524 {
  
  @JSImport("@carbon/icons-react", "NumberSmall524")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall524.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
