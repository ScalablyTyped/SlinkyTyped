...
object Api124 {
  ...
  @JSImport("@carbon/icons-react", "Api124")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Api124.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
