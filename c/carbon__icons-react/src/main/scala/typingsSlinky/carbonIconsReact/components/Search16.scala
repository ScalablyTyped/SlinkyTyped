...
object Search16 {
  ...
  @JSImport("@carbon/icons-react", "Search16")
  @js.native
  ...
  implicit def make(companion: Search16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
