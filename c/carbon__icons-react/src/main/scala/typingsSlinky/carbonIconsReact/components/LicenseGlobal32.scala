...
object LicenseGlobal32 {
  
  @JSImport("@carbon/icons-react", "LicenseGlobal32")
  @js.native
  ...
  implicit def make(companion: LicenseGlobal32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
