...
object ChartClusterBar32 {
  
  @JSImport("@carbon/icons-react", "ChartClusterBar32")
  @js.native
  ...
  implicit def make(companion: ChartClusterBar32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
