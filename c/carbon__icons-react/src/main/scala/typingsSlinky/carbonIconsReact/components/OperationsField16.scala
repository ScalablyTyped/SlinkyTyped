...
object OperationsField16 {
  
  @JSImport("@carbon/icons-react", "OperationsField16")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: OperationsField16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
