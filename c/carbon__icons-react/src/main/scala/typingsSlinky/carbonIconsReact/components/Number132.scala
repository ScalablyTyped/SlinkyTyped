...
object Number132 {
  ...
  @JSImport("@carbon/icons-react", "Number132")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number132.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
