...
object Network324 {
  ...
  @JSImport("@carbon/icons-react", "Network_324")
  @js.native
  ...
  implicit def make(companion: Network324.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
