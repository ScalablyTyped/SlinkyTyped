...
object NumberSmall816 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_816")
  @js.native
  ...
  implicit def make(companion: NumberSmall816.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
