...
object DataRefineryReference20 {
  
  @JSImport("@carbon/icons-react", "DataRefineryReference20")
  @js.native
  ...
  implicit def make(companion: DataRefineryReference20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
