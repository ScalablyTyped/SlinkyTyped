...
object CloudFoundry116 {
  
  @JSImport("@carbon/icons-react", "CloudFoundry_116")
  @js.native
  ...
  implicit def make(companion: CloudFoundry116.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
