...
object DocumentSubtract24 {
  
  @JSImport("@carbon/icons-react", "DocumentSubtract24")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DocumentSubtract24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
