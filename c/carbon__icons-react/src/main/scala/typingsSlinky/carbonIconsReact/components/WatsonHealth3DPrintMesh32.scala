...
object WatsonHealth3DPrintMesh32 {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DPrintMesh32")
  @js.native
  ...
  implicit def make(companion: WatsonHealth3DPrintMesh32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
