...
object DirectionRight0220 {
  
  @JSImport("@carbon/icons-react", "DirectionRight0220")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DirectionRight0220.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
