...
object Thumbnail232 {
  ...
  @JSImport("@carbon/icons-react", "Thumbnail232")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Thumbnail232.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
