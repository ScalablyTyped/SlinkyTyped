...
object NumberSmall016 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_016")
  @js.native
  ...
  implicit def make(companion: NumberSmall016.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
