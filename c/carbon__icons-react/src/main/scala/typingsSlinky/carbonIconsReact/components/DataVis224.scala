...
object DataVis224 {
  ...
  @JSImport("@carbon/icons-react", "DataVis_224")
  @js.native
  ...
  implicit def make(companion: DataVis224.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
