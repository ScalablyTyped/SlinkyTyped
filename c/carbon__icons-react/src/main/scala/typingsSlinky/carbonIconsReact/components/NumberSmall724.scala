...
object NumberSmall724 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_724")
  @js.native
  ...
  implicit def make(companion: NumberSmall724.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
