...
object NumberSmall832 {
  
  @JSImport("@carbon/icons-react", "NumberSmall832")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall832.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
