...
object AlignBoxMiddleCenter16 {
  
  @JSImport("@carbon/icons-react", "AlignBoxMiddleCenter16")
  @js.native
  ...
  implicit def make(companion: AlignBoxMiddleCenter16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
