...
object Forward520 {
  ...
  @JSImport("@carbon/icons-react", "Forward_520")
  @js.native
  ...
  implicit def make(companion: Forward520.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
