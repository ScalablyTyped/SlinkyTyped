...
object AccumulationIce20 {
  
  @JSImport("@carbon/icons-react", "AccumulationIce20")
  @js.native
  ...
  implicit def make(companion: AccumulationIce20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
