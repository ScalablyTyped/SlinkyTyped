...
object Forward516 {
  ...
  @JSImport("@carbon/icons-react", "Forward_516")
  @js.native
  ...
  implicit def make(companion: Forward516.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
