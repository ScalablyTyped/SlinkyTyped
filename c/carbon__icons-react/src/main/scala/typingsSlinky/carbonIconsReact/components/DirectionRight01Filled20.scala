...
object DirectionRight01Filled20 {
  
  @JSImport("@carbon/icons-react", "DirectionRight_01Filled20")
  @js.native
  ...
  implicit def make(companion: DirectionRight01Filled20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
