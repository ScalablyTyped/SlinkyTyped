...
object Network216 {
  ...
  @JSImport("@carbon/icons-react", "Network216")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network216.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
