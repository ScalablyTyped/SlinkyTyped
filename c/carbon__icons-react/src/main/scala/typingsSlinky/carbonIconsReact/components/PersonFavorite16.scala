...
object PersonFavorite16 {
  
  @JSImport("@carbon/icons-react", "PersonFavorite16")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PersonFavorite16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
