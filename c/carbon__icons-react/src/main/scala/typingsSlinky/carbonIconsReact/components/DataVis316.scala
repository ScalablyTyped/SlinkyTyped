...
object DataVis316 {
  ...
  @JSImport("@carbon/icons-react", "DataVis_316")
  @js.native
  ...
  implicit def make(companion: DataVis316.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
