...
object Number424 {
  ...
  @JSImport("@carbon/icons-react", "Number424")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number424.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
