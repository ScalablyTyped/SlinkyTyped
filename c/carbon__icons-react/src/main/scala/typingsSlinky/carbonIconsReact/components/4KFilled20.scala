...
object `4KFilled20` {
  ...
  @JSImport("@carbon/icons-react", "4KFilled20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: `4KFilled20`.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
