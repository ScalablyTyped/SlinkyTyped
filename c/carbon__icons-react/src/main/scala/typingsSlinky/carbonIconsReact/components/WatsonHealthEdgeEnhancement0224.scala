...
object WatsonHealthEdgeEnhancement0224 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthEdgeEnhancement_0224")
  @js.native
  ...
  implicit def make(companion: WatsonHealthEdgeEnhancement0224.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
