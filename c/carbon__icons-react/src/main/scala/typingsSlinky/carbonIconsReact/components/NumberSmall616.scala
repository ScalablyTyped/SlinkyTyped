...
object NumberSmall616 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_616")
  @js.native
  ...
  implicit def make(companion: NumberSmall616.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
