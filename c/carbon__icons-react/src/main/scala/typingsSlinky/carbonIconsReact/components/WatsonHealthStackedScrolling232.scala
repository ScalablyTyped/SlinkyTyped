...
object WatsonHealthStackedScrolling232 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthStackedScrolling_232")
  @js.native
  ...
  implicit def make(companion: WatsonHealthStackedScrolling232.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
