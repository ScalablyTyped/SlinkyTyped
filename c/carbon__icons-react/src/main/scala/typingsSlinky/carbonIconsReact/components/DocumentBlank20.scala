...
object DocumentBlank20 {
  
  @JSImport("@carbon/icons-react", "DocumentBlank20")
  @js.native
  ...
  implicit def make(companion: DocumentBlank20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
