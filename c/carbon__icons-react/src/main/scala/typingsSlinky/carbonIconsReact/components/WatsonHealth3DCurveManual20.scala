...
object WatsonHealth3DCurveManual20 {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DCurveManual20")
  @js.native
  ...
  implicit def make(companion: WatsonHealth3DCurveManual20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
