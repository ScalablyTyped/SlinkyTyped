...
object NumberSmall716 {
  
  @JSImport("@carbon/icons-react", "NumberSmall716")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall716.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
