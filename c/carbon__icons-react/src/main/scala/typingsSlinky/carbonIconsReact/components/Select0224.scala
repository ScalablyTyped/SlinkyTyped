...
object Select0224 {
  ...
  @JSImport("@carbon/icons-react", "Select0224")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Select0224.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
