...
object CabinCareAlert24 {
  
  @JSImport("@carbon/icons-react", "CabinCareAlert24")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CabinCareAlert24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
