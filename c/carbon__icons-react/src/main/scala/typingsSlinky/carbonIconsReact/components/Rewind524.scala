...
object Rewind524 {
  ...
  @JSImport("@carbon/icons-react", "Rewind_524")
  @js.native
  ...
  implicit def make(companion: Rewind524.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
