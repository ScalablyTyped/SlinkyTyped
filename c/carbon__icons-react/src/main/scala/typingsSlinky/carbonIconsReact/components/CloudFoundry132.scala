...
object CloudFoundry132 {
  
  @JSImport("@carbon/icons-react", "CloudFoundry_132")
  @js.native
  ...
  implicit def make(companion: CloudFoundry132.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
