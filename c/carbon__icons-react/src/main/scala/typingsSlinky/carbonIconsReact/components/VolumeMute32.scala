...
object VolumeMute32 {
  ...
  @JSImport("@carbon/icons-react", "VolumeMute32")
  @js.native
  ...
  implicit def make(companion: VolumeMute32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
