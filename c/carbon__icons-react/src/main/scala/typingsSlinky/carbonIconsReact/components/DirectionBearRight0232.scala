...
object DirectionBearRight0232 {
  
  @JSImport("@carbon/icons-react", "DirectionBearRight_0232")
  @js.native
  ...
  implicit def make(companion: DirectionBearRight0232.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
