...
object NumberSmall924 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_924")
  @js.native
  ...
  implicit def make(companion: NumberSmall924.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
