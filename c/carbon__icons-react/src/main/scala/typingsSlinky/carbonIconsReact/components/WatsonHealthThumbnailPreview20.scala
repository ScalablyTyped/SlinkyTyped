...
object WatsonHealthThumbnailPreview20 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthThumbnailPreview20")
  @js.native
  ...
  implicit def make(companion: WatsonHealthThumbnailPreview20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
