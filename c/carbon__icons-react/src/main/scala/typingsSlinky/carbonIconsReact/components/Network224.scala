...
object Network224 {
  ...
  @JSImport("@carbon/icons-react", "Network224")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network224.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
