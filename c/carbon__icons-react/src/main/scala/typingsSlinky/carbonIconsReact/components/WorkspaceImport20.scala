...
object WorkspaceImport20 {
  
  @JSImport("@carbon/icons-react", "WorkspaceImport20")
  @js.native
  ...
  implicit def make(companion: WorkspaceImport20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
