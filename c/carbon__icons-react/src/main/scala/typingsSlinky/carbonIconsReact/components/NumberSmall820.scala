...
object NumberSmall820 {
  
  @JSImport("@carbon/icons-react", "NumberSmall820")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall820.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
