...
object DocumentSubtract20 {
  
  @JSImport("@carbon/icons-react", "DocumentSubtract20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DocumentSubtract20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
