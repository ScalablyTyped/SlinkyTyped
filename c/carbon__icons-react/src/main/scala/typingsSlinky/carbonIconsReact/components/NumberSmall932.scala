...
object NumberSmall932 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_932")
  @js.native
  ...
  implicit def make(companion: NumberSmall932.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
