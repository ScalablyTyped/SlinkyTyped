...
object WatsonHealthErase3D32 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthErase_3D32")
  @js.native
  ...
  implicit def make(companion: WatsonHealthErase3D32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
