...
object PillsAdd20 {
  ...
  @JSImport("@carbon/icons-react", "PillsAdd20")
  @js.native
  ...
  implicit def make(companion: PillsAdd20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
