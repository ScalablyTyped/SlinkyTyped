...
object DirectionRight0132 {
  
  @JSImport("@carbon/icons-react", "DirectionRight_0132")
  @js.native
  ...
  implicit def make(companion: DirectionRight0132.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
