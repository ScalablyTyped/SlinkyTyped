...
object DocumentExport16 {
  
  @JSImport("@carbon/icons-react", "DocumentExport16")
  @js.native
  ...
  implicit def make(companion: DocumentExport16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
