...
object Number332 {
  ...
  @JSImport("@carbon/icons-react", "Number_332")
  @js.native
  ...
  implicit def make(companion: Number332.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
