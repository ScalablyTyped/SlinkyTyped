...
object NumberSmall120 {
  
  @JSImport("@carbon/icons-react", "NumberSmall120")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall120.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
