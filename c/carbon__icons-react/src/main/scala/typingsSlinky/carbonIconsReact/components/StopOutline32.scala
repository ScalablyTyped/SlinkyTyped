...
object StopOutline32 {
  
  @JSImport("@carbon/icons-react", "StopOutline32")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: StopOutline32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
