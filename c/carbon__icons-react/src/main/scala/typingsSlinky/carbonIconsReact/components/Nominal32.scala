...
object Nominal32 {
  ...
  @JSImport("@carbon/icons-react", "Nominal32")
  @js.native
  ...
  implicit def make(companion: Nominal32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
