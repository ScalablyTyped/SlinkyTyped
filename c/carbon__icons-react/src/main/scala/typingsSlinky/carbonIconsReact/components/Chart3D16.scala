...
object Chart3D16 {
  ...
  @JSImport("@carbon/icons-react", "Chart_3D16")
  @js.native
  ...
  implicit def make(companion: Chart3D16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
