...
object WatsonHealthICa2D16 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthICa_2D16")
  @js.native
  ...
  implicit def make(companion: WatsonHealthICa2D16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
