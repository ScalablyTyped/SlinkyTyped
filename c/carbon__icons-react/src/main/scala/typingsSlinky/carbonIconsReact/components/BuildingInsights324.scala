...
object BuildingInsights324 {
  
  @JSImport("@carbon/icons-react", "BuildingInsights_324")
  @js.native
  ...
  implicit def make(companion: BuildingInsights324.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
