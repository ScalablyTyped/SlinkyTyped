...
object Construction20 {
  
  @JSImport("@carbon/icons-react", "Construction20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Construction20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
