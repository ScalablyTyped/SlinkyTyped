...
object UserCertification20 {
  
  @JSImport("@carbon/icons-react", "UserCertification20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UserCertification20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
