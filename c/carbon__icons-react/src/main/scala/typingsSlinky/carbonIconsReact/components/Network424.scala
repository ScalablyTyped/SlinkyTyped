...
object Network424 {
  ...
  @JSImport("@carbon/icons-react", "Network424")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network424.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
