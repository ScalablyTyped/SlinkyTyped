...
object LogoLinkedin24 {
  
  @JSImport("@carbon/icons-react", "LogoLinkedin24")
  @js.native
  ...
  implicit def make(companion: LogoLinkedin24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
