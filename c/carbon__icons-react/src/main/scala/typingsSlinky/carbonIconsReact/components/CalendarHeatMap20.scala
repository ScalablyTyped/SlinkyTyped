...
object CalendarHeatMap20 {
  
  @JSImport("@carbon/icons-react", "CalendarHeatMap20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CalendarHeatMap20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
