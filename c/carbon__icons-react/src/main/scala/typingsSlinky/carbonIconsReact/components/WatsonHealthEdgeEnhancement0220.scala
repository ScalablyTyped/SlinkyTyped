...
object WatsonHealthEdgeEnhancement0220 {
  ...
  implicit def make(companion: WatsonHealthEdgeEnhancement0220.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
