...
object WatsonHealthSpineLabel32 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthSpineLabel32")
  @js.native
  ...
  implicit def make(companion: WatsonHealthSpineLabel32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
