...
object NumberSmall024 {
  
  @JSImport("@carbon/icons-react", "NumberSmall024")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall024.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
