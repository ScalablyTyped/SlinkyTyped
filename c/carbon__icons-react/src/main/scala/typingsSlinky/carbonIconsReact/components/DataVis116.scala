...
object DataVis116 {
  ...
  @JSImport("@carbon/icons-react", "DataVis_116")
  @js.native
  ...
  implicit def make(companion: DataVis116.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
