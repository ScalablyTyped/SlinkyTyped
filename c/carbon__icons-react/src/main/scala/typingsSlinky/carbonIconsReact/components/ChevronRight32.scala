...
object ChevronRight32 {
  
  @JSImport("@carbon/icons-react", "ChevronRight32")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChevronRight32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
