...
object DirectionRight01Filled32 {
  
  @JSImport("@carbon/icons-react", "DirectionRight_01Filled32")
  @js.native
  ...
  implicit def make(companion: DirectionRight01Filled32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
