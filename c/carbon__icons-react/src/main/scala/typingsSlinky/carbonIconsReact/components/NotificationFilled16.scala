...
object NotificationFilled16 {
  
  @JSImport("@carbon/icons-react", "NotificationFilled16")
  @js.native
  ...
  implicit def make(companion: NotificationFilled16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
