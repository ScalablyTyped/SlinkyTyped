...
object ForecastLightning3032 {
  
  @JSImport("@carbon/icons-react", "ForecastLightning3032")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ForecastLightning3032.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
