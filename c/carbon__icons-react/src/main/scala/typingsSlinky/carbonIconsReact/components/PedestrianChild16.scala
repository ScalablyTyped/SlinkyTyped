...
object PedestrianChild16 {
  
  @JSImport("@carbon/icons-react", "PedestrianChild16")
  @js.native
  ...
  implicit def make(companion: PedestrianChild16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
