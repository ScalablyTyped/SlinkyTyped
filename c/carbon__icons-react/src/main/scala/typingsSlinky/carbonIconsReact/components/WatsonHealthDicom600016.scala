...
object WatsonHealthDicom600016 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthDicom_600016")
  @js.native
  ...
  implicit def make(companion: WatsonHealthDicom600016.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
