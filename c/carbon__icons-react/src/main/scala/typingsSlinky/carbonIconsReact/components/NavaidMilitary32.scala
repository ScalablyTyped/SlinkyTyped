...
object NavaidMilitary32 {
  
  @JSImport("@carbon/icons-react", "NavaidMilitary32")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NavaidMilitary32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
