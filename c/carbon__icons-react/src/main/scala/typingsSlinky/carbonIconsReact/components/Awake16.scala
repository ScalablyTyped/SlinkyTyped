...
object Awake16 {
  ...
  @JSImport("@carbon/icons-react", "Awake16")
  @js.native
  ...
  implicit def make(companion: Awake16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
