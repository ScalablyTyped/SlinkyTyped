...
object Tif24 {
  ...
  @JSImport("@carbon/icons-react", "Tif24")
  @js.native
  ...
  implicit def make(companion: Tif24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
