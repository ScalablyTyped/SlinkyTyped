...
object VideoAdd16 {
  ...
  @JSImport("@carbon/icons-react", "VideoAdd16")
  @js.native
  ...
  implicit def make(companion: VideoAdd16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
