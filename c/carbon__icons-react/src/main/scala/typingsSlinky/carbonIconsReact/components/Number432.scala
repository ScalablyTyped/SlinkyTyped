...
object Number432 {
  ...
  @JSImport("@carbon/icons-react", "Number432")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number432.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
