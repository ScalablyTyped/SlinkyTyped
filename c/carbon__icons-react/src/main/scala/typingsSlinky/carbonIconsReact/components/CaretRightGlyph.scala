...
object CaretRightGlyph {
  
  @JSImport("@carbon/icons-react", "CaretRightGlyph")
  @js.native
  ...
  implicit def make(companion: CaretRightGlyph.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
