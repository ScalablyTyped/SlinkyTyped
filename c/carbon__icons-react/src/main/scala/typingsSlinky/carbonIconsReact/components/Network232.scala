...
object Network232 {
  ...
  @JSImport("@carbon/icons-react", "Network232")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network232.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
