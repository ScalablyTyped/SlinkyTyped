...
object CaretUpGlyph {
  ...
  @JSImport("@carbon/icons-react", "CaretUpGlyph")
  @js.native
  ...
  implicit def make(companion: CaretUpGlyph.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
