...
object NumberSmall220 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_220")
  @js.native
  ...
  implicit def make(companion: NumberSmall220.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
