...
object ForecastHail3024 {
  
  @JSImport("@carbon/icons-react", "ForecastHail_3024")
  @js.native
  ...
  implicit def make(companion: ForecastHail3024.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
