...
object ChevronMini20 {
  
  @JSImport("@carbon/icons-react", "ChevronMini20")
  @js.native
  ...
  implicit def make(companion: ChevronMini20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
