...
object Bookmark24 {
  ...
  @JSImport("@carbon/icons-react", "Bookmark24")
  @js.native
  ...
  implicit def make(companion: Bookmark24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
