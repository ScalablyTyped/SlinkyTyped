...
object CaretLeftGlyph {
  
  @JSImport("@carbon/icons-react", "CaretLeftGlyph")
  @js.native
  ...
  implicit def make(companion: CaretLeftGlyph.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
