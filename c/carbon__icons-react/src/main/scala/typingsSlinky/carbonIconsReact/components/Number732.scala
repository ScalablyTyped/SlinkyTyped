...
object Number732 {
  ...
  @JSImport("@carbon/icons-react", "Number732")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number732.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
