...
object NumberSmall420 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_420")
  @js.native
  ...
  implicit def make(companion: NumberSmall420.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
