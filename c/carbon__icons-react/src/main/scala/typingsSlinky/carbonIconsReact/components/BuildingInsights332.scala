...
object BuildingInsights332 {
  
  @JSImport("@carbon/icons-react", "BuildingInsights_332")
  @js.native
  ...
  implicit def make(companion: BuildingInsights332.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
