...
object WatsonHealthLaunchStudy320 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthLaunchStudy_320")
  @js.native
  ...
  implicit def make(companion: WatsonHealthLaunchStudy320.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
