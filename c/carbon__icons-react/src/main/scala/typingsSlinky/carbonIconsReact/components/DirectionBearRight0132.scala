...
object DirectionBearRight0132 {
  
  @JSImport("@carbon/icons-react", "DirectionBearRight_0132")
  @js.native
  ...
  implicit def make(companion: DirectionBearRight0132.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
