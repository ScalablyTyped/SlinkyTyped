...
object Number416 {
  ...
  @JSImport("@carbon/icons-react", "Number_416")
  @js.native
  ...
  implicit def make(companion: Number416.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
