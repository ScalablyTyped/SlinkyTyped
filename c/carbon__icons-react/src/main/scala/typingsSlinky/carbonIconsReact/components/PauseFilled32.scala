...
object PauseFilled32 {
  
  @JSImport("@carbon/icons-react", "PauseFilled32")
  @js.native
  ...
  implicit def make(companion: PauseFilled32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
