...
object ChartComboStacked32 {
  
  @JSImport("@carbon/icons-react", "ChartComboStacked32")
  @js.native
  ...
  implicit def make(companion: ChartComboStacked32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
