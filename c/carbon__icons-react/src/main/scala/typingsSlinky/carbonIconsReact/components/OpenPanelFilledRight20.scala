...
object OpenPanelFilledRight20 {
  
  @JSImport("@carbon/icons-react", "OpenPanelFilledRight20")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: OpenPanelFilledRight20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
