...
object WatsonHealthPageScroll24 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthPageScroll24")
  @js.native
  ...
  implicit def make(companion: WatsonHealthPageScroll24.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
