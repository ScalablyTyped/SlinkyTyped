...
object WatsonHealth3DMprToggle16 {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DMprToggle16")
  @js.native
  ...
  implicit def make(companion: WatsonHealth3DMprToggle16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
