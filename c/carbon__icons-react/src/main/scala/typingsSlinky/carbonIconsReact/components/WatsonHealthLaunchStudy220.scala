...
object WatsonHealthLaunchStudy220 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthLaunchStudy_220")
  @js.native
  ...
  implicit def make(companion: WatsonHealthLaunchStudy220.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
