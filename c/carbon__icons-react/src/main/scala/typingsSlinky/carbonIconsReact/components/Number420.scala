...
object Number420 {
  ...
  @JSImport("@carbon/icons-react", "Number420")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number420.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
