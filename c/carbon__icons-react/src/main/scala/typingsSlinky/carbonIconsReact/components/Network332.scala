...
object Network332 {
  ...
  @JSImport("@carbon/icons-react", "Network_332")
  @js.native
  ...
  implicit def make(companion: Network332.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
