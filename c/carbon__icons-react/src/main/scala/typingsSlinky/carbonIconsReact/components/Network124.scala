...
object Network124 {
  ...
  @JSImport("@carbon/icons-react", "Network_124")
  @js.native
  ...
  implicit def make(companion: Network124.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
