...
object CheckboxIndeterminate20 {
  
  @JSImport("@carbon/icons-react", "CheckboxIndeterminate20")
  @js.native
  ...
  implicit def make(companion: CheckboxIndeterminate20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
