...
object Number232 {
  ...
  @JSImport("@carbon/icons-react", "Number_232")
  @js.native
  ...
  implicit def make(companion: Number232.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
