...
object DirectionBearRight0116 {
  
  @JSImport("@carbon/icons-react", "DirectionBearRight_0116")
  @js.native
  ...
  implicit def make(companion: DirectionBearRight0116.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
