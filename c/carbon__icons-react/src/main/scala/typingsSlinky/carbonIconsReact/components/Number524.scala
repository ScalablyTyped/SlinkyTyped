...
object Number524 {
  ...
  @JSImport("@carbon/icons-react", "Number_524")
  @js.native
  ...
  implicit def make(companion: Number524.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
