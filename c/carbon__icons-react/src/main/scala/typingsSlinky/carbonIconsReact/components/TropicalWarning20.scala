...
object TropicalWarning20 {
  
  @JSImport("@carbon/icons-react", "TropicalWarning20")
  @js.native
  ...
  implicit def make(companion: TropicalWarning20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
