...
object DataPlayer16 {
  ...
  @JSImport("@carbon/icons-react", "DataPlayer16")
  @js.native
  ...
  implicit def make(companion: DataPlayer16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
