...
object TrafficFlow16 {
  
  @JSImport("@carbon/icons-react", "TrafficFlow16")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TrafficFlow16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
