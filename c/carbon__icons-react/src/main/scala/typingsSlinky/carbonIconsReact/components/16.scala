...
object `16` {
  ...
  @JSImport("@carbon/icons-react/lib/HD/16", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: `16`.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
