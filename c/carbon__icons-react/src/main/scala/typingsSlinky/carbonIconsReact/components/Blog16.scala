...
object Blog16 {
  ...
  @JSImport("@carbon/icons-react", "Blog16")
  @js.native
  ...
  implicit def make(companion: Blog16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
