...
object WatsonHealthStackedScrolling120 {
  
  @JSImport("@carbon/icons-react", "WatsonHealthStackedScrolling_120")
  @js.native
  ...
  implicit def make(companion: WatsonHealthStackedScrolling120.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
