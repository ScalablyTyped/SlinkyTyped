...
object SkipBack32 {
  ...
  @JSImport("@carbon/icons-react", "SkipBack32")
  @js.native
  ...
  implicit def make(companion: SkipBack32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
