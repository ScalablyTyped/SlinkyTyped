...
object JumpLink32 {
  ...
  @JSImport("@carbon/icons-react", "JumpLink32")
  @js.native
  ...
  implicit def make(companion: JumpLink32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
