...
object Forward532 {
  ...
  @JSImport("@carbon/icons-react", "Forward_532")
  @js.native
  ...
  implicit def make(companion: Forward532.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
