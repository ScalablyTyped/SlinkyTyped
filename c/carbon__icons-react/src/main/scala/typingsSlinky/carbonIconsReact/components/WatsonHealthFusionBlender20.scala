...
object WatsonHealthFusionBlender20 {
  ...
  implicit def make(companion: WatsonHealthFusionBlender20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
