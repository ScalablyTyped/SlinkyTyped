...
object ListDropdown16 {
  
  @JSImport("@carbon/icons-react", "ListDropdown16")
  @js.native
  ...
  implicit def make(companion: ListDropdown16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
