...
object WatsonHealth3DICa32 {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DICa32")
  @js.native
  ...
  implicit def make(companion: WatsonHealth3DICa32.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
