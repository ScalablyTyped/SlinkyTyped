...
object ChevronUpGlyph {
  
  @JSImport("@carbon/icons-react", "ChevronUpGlyph")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChevronUpGlyph.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
