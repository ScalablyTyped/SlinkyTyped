...
object NumberSmall824 {
  
  @JSImport("@carbon/icons-react", "NumberSmall_824")
  @js.native
  ...
  implicit def make(companion: NumberSmall824.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
