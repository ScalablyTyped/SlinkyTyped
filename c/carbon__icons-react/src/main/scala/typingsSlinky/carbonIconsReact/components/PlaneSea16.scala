...
object PlaneSea16 {
  ...
  @JSImport("@carbon/icons-react", "PlaneSea16")
  @js.native
  ...
  implicit def make(companion: PlaneSea16.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
