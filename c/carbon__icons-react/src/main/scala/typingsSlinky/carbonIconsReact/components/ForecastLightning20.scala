...
object ForecastLightning20 {
  
  @JSImport("@carbon/icons-react", "ForecastLightning20")
  @js.native
  ...
  implicit def make(companion: ForecastLightning20.type): SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes1348591536[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
}
