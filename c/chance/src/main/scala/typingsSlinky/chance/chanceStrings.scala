...
import typingsSlinky.chance.Chance.LastNameNationalities
import typingsSlinky.chance.Chance._FalsyType
...
object chanceStrings {
  ...
  @js.native
  sealed trait armed_forces extends StObject
  @scala.inline
  def armed_forces: armed_forces = "armed_forces".asInstanceOf[armed_forces]
  
  @js.native
  sealed trait cc_types extends StObject
  @scala.inline
  def cc_types: cc_types = "cc_types".asInstanceOf[cc_types]
  
  @js.native
  sealed trait currency_types extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait firstNames extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait lastNames extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait us_states_and_dc extends StObject
  @scala.inline
