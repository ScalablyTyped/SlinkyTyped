package typingsSlinky.cssMinimizerWebpackPlugin
...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTest(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = StObject.set(x, "test", value.asInstanceOf[js.Any])
