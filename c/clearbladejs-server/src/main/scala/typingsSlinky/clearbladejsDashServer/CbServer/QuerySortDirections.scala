...
object QuerySortDirections extends js.Object {
  ...
  /* "ASC" */ val QUERY_SORT_ASCENDING: typingsSlinky.clearbladejsDashServer.CbServer.QuerySortDirections.QUERY_SORT_ASCENDING with String = js.native
  /* "DESC" */ val QUERY_SORT_DESCENDING: typingsSlinky.clearbladejsDashServer.CbServer.QuerySortDirections.QUERY_SORT_DESCENDING with String = js.native
  @JSBracketAccess
