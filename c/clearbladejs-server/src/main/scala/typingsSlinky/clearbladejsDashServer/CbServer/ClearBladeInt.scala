...
import typingsSlinky.clearbladejsDashServer.Anon_Request
...
trait ClearBladeInt extends js.Object {
  ...
  def Code(): typingsSlinky.clearbladejsDashServer.CbServer.Code = js.native
  def Collection(options: String): typingsSlinky.clearbladejsDashServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithCollection): typingsSlinky.clearbladejsDashServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithID): typingsSlinky.clearbladejsDashServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithName): typingsSlinky.clearbladejsDashServer.CbServer.Collection = js.native
  def Deployment(): typingsSlinky.clearbladejsDashServer.CbServer.Deployment = js.native
  def Device(): typingsSlinky.clearbladejsDashServer.CbServer.Device = js.native
  def Item(data: js.Object, options: String): typingsSlinky.clearbladejsDashServer.CbServer.Item = js.native
  def Item(data: js.Object, options: ItemOptions): typingsSlinky.clearbladejsDashServer.CbServer.Item = js.native
  def Messaging(options: MessagingOptions, callback: CbCallback): typingsSlinky.clearbladejsDashServer.CbServer.Messaging = js.native
