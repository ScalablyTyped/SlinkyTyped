...
trait AboutAsync extends js.Object {
  ...
  js.Promise[
    Unpacked[
      js.Function2[
        ...
        typingsSlinky.cadesplugin.CAdESCOM.Version
      ]
    ]
  ]) | (PromisifiedFunction[
    js.Function2[
  ...
  js.Promise[Unpacked[typingsSlinky.cadesplugin.CAdESCOM.Version]]) | PromisifiedFunction[typingsSlinky.cadesplugin.CAdESCOM.Version] = js.native
...
object AboutAsync {
  ...
  implicit class AboutAsyncOps[Self <: AboutAsync] (val x: Self) extends AnyVal {
    ...
    {[ K in keyof any ]: cadesplugin.CADES_Common.Unpacked<any[K]>}
      */ /* args */ typingsSlinky.cadesplugin.cadespluginStrings.PromisifiedFunction with TopLevel[js.Any]) | Double
