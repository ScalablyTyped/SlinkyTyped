...
trait CertificateAsync
  ...
  js.Promise[Unpacked[js.Function0[typingsSlinky.cadesplugin.CAPICOM.PublicKey]]]) | PromisifiedFunction[js.Function0[typingsSlinky.cadesplugin.CAPICOM.PublicKey]] = js.native
...
object CertificateAsync {
  ...
  implicit class CertificateAsyncOps[Self <: CertificateAsync] (val x: Self) extends AnyVal {
    ...
    def setExportFunction1(
      value: (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof any ]: cadesplugin.CADES_Common.Unpacked<any[K]>}
      */ /* args */ typingsSlinky.cadesplugin.cadespluginStrings.PromisifiedFunction with TopLevel[js.Any]) | (/* EncodingType */ ValuesOf[CAPICOM_ENCODING_TYPE]) => js.Promise[Unpacked[js.Any]] | String
    ...
    def setGetInfoFunction1(
      value: (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof any ]: cadesplugin.CADES_Common.Unpacked<any[K]>}
      */ /* args */ typingsSlinky.cadesplugin.cadespluginStrings.PromisifiedFunction with TopLevel[js.Any]) | (/* infoType */ CAPICOM_CERT_INFO_TYPE) => js.Promise[Unpacked[js.Any]] | String
