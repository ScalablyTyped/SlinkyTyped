...
import typingsSlinky.cadesplugin.cadespluginStrings.AddressBook
import typingsSlinky.cadesplugin.cadespluginStrings.Ca
import typingsSlinky.cadesplugin.cadespluginStrings.My
import typingsSlinky.cadesplugin.cadespluginStrings.Root
