package typingsSlinky.cloneDashRegexp.cloneDashRegexpMod
...
object ^ extends js.Object {
  ...
  ```
  */
  def apply(regexp: js.RegExp): js.RegExp = js.native
  def apply(regexp: js.RegExp, options: Options): js.RegExp = js.native
}
