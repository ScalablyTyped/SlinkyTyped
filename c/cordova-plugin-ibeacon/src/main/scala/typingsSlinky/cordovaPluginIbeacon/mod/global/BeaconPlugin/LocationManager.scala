...
trait LocationManager extends js.Object {
  var BeaconRegion: typingsSlinky.cordovaPluginIbeacon.mod.global.BeaconPlugin.BeaconRegion
  var Region: typingsSlinky.cordovaPluginIbeacon.mod.global.BeaconPlugin.Region
