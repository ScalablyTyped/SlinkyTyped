...
trait LocationManager extends js.Object {
  var BeaconRegion: typingsSlinky.cordovaPluginIbeacon.mod._Global_.BeaconPlugin.BeaconRegion = js.native
  var Region: typingsSlinky.cordovaPluginIbeacon.mod._Global_.BeaconPlugin.Region = js.native
