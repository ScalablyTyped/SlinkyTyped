...
trait LocationManager extends js.Object {
  var BeaconRegion: typingsSlinky.cordovaPluginIbeacon.mod._Global_.BeaconPlugin.BeaconRegion
  var Region: typingsSlinky.cordovaPluginIbeacon.mod._Global_.BeaconPlugin.Region
