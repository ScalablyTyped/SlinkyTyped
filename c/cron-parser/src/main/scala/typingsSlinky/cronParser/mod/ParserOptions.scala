...
object ParserOptions {
  ...
  implicit class ParserOptionsOps[Self <: ParserOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentDateDate(value: js.Date): Self = this.set("currentDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentDate(value: String | Double | js.Date): Self = this.set("currentDate", value.asInstanceOf[js.Any])
