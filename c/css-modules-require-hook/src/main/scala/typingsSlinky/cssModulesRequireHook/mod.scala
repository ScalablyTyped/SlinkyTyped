package typingsSlinky.cssModulesRequireHook
...
object mod extends Shortcut {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIgnore(value: String | js.RegExp | (js.Function1[/* filepath */ String, Boolean])): Self = StObject.set(x, "ignore", value.asInstanceOf[js.Any])
