...
object CronJobParameters {
  ...
  implicit class CronJobParametersOps[Self <: CronJobParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCronTimeDate(value: js.Date): Self = this.set("cronTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCronTime(value: String | js.Date | Moment): Self = this.set("cronTime", value.asInstanceOf[js.Any])
