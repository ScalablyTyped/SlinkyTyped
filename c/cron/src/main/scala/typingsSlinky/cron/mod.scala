...
object mod {
  ...
  class CronTime protected () extends StObject {
    ...
    def this(source: js.Date, zone: js.UndefOr[scala.Nothing], utcOffset: String) = this()
    def this(source: js.Date, zone: js.UndefOr[scala.Nothing], utcOffset: Double) = this()
  ...
  @JSImport("cron", "sendAt")
  @js.native
  def sendAt(cronTime: js.Date): Moment = js.native
  @JSImport("cron", "sendAt")
  @js.native
  ...
  @JSImport("cron", "time")
  @js.native
  def time(source: js.Date): CronTime = js.native
  @JSImport("cron", "time")
  @js.native
  def time(source: js.Date, zone: String): CronTime = js.native
  @JSImport("cron", "time")
  @js.native
  ...
  @JSImport("cron", "timeout")
  @js.native
  def timeout(cronTime: js.Date): Double = js.native
  @JSImport("cron", "timeout")
  @js.native
  ...
  object CronJobParameters {
    ...
    implicit class CronJobParametersMutableBuilder[Self <: CronJobParameters] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCronTime(value: String | js.Date | Moment): Self = StObject.set(x, "cronTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCronTimeDate(value: js.Date): Self = StObject.set(x, "cronTime", value.asInstanceOf[js.Any])
