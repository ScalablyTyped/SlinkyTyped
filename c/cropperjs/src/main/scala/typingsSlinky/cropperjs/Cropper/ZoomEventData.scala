...
object ZoomEventData {
  ...
  implicit class ZoomEventDataOps[Self <: ZoomEventData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginalEventPointerEvent(value: PointerEvent): Self = this.set("originalEvent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginalEventWheelEvent(value: WheelEvent): Self = this.set("originalEvent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginalEventTouchEvent(value: TouchEvent): Self = this.set("originalEvent", value.asInstanceOf[js.Any])
