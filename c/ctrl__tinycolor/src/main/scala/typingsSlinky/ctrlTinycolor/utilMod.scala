...
object utilMod {
  ...
  @JSImport("@ctrl/tinycolor/dist/util", "bound01")
  @js.native
  def bound01(n: js.Any, max: Double): Double = js.native
  
  @JSImport("@ctrl/tinycolor/dist/util", "boundAlpha")
  @js.native
  ...
  @JSImport("@ctrl/tinycolor/dist/util", "clamp01")
  @js.native
  def clamp01(`val`: Double): Double = js.native
  
  @JSImport("@ctrl/tinycolor/dist/util", "convertToPercentage")
  @js.native
  ...
  @JSImport("@ctrl/tinycolor/dist/util", "isOnePointZero")
  @js.native
  ...
  @JSImport("@ctrl/tinycolor/dist/util", "isPercentage")
  @js.native
  ...
  @JSImport("@ctrl/tinycolor/dist/util", "pad2")
  @js.native
