...
import typingsSlinky.ctrlTinycolor.anon.NumberifyHSL
import typingsSlinky.ctrlTinycolor.anon.NumberifyHSV
import typingsSlinky.ctrlTinycolor.anon.NumberifyRGB
