...
object interfacesMod {
  ...
  - typingsSlinky.ctrlTinycolor.distMod._ColorInput because Already inherited */ @js.native
  ...
  {[ P in keyof T ]: number}
    */ typingsSlinky.ctrlTinycolor.ctrlTinycolorStrings.Numberify with TopLevel[js.Any]
