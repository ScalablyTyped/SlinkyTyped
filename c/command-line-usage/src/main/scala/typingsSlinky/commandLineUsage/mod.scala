...
object mod {
  ...
  */
  ...
  object Section {
    ...
    @scala.inline
    def Content(): typingsSlinky.commandLineUsage.mod.Content = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.commandLineUsage.mod.Content]
    }
    
    @scala.inline
    def OptionList(): typingsSlinky.commandLineUsage.mod.OptionList = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.commandLineUsage.mod.OptionList]
    }
  }
}
