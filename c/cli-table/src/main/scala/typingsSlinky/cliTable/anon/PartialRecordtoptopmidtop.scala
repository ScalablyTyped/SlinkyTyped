package typingsSlinky.cliTable.anon
...
@js.native
trait PartialRecordtoptopmidtop extends js.Object {
...
object PartialRecordtoptopmidtop {
  ...
  @scala.inline
  implicit class PartialRecordtoptopmidtopOps[Self <: PartialRecordtoptopmidtop] (val x: Self) extends AnyVal {
