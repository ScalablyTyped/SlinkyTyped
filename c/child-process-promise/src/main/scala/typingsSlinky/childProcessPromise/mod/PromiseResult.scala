...
object PromiseResult {
  @scala.inline
  def apply[/* <: java.lang.String | typingsSlinky.node.Buffer */ Enc](childProcess: ChildProcess, stderr: Enc, stdout: Enc): PromiseResult[Enc] = {
  ...
  @scala.inline
  implicit class PromiseResultOps[Self <: PromiseResult[_], /* <: java.lang.String | typingsSlinky.node.Buffer */ Enc] (val x: Self with PromiseResult[Enc]) extends AnyVal {
    @scala.inline
