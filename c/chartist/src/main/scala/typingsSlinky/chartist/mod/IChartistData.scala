...
object IChartistData {
  ...
  implicit class IChartistDataMutableBuilder[Self <: IChartistData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabels(value: js.Array[js.Date | Double | String]): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelsUndefined: Self = StObject.set(x, "labels", js.undefined)
    
    @scala.inline
    def setLabelsVarargs(value: (js.Date | Double | String)*): Self = StObject.set(x, "labels", js.Array(value :_*))
