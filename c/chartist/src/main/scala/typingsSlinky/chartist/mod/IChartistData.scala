...
object IChartistData {
  ...
  implicit class IChartistDataOps[Self <: IChartistData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelsVarargs(value: (js.Date | Double | String)*): Self = this.set("labels", js.Array(value :_*))
    
    @scala.inline
    def setLabels(value: js.Array[js.Date | Double | String]): Self = this.set("labels", value.asInstanceOf[js.Any])
