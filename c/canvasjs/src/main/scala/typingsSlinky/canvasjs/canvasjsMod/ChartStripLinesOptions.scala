package typingsSlinky.canvasjs.canvasjsMod

import typingsSlinky.canvasjs.Anon_Axis
...
trait ChartStripLinesOptions extends js.Object {
  ...
  /**
    ...
    */
  var labelFormatter: js.UndefOr[js.Function1[/* e */ js.UndefOr[Anon_Axis], String]] = js.undefined
  /**
...
object ChartStripLinesOptions {
  ...
  def apply(
    ...
    labelFormatter: /* e */ js.UndefOr[Anon_Axis] => String = null,
