...
trait ChartLegendOptions extends js.Object {
  ...
  /**
    ...
    */
  var itemTextFormatter: js.UndefOr[js.Function1[/* e */ js.UndefOr[typingsSlinky.canvasjs.anon.Chart], String]] = js.undefined
  /**
...
object ChartLegendOptions {
  ...
  def apply(
    ...
    itemTextFormatter: /* e */ js.UndefOr[typingsSlinky.canvasjs.anon.Chart] => String = null,
