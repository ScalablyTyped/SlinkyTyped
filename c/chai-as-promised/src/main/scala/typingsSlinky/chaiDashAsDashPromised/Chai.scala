...
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedAssert
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedAssertion
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedCloseTo
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedDeep
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedEqual
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedInclude
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedInstanceOf
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedKeyFilter
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedKeys
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedLanguageChains
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedLength
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedMatch
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedMembers
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedNested
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedNumberComparer
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedNumericComparison
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedOrdered
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedOwnProperty
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedOwnPropertyDescriptor
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedProperty
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedPropertyChange
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedRespondTo
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedSatisfy
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedThrow
import typingsSlinky.chaiDashAsDashPromised.Chai.PromisedTypeComparison
...
object Chai extends js.Object {
  ...
  trait PromisedAssert extends js.Object {
    ...
    def `match`(exp: js.Any, re: js.RegExp): js.Thenable[Unit] = js.native
    def `match`(exp: js.Any, re: js.RegExp, msg: String): js.Thenable[Unit] = js.native
    ...
    def notMatch(exp: js.Any, re: js.RegExp): js.Thenable[Unit] = js.native
    def notMatch(exp: js.Any, re: js.RegExp, msg: String): js.Thenable[Unit] = js.native
