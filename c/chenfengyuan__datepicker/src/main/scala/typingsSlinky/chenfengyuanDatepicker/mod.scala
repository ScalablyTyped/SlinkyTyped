...
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerStrings.datepicker
...
object mod {
  ...
  object DatepickerOptions {
    ...
    implicit class DatepickerOptionsMutableBuilder[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilter(value: (/* date */ js.Date, /* view */ day | month | year) => js.UndefOr[Boolean]): Self = StObject.set(x, "filter", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setTriggerElement(value: Element): Self = StObject.set(x, "trigger", value.asInstanceOf[js.Any])
