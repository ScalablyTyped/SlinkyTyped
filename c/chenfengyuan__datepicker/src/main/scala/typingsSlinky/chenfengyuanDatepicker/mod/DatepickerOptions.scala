package typingsSlinky.chenfengyuanDatepicker.mod

import org.scalajs.dom.raw.Element
import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`0`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`1`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`2`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`3`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`4`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`5`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerNumbers.`6`
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerStrings.day
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerStrings.month
import typingsSlinky.chenfengyuanDatepicker.chenfengyuanDatepickerStrings.year
import typingsSlinky.chenfengyuanDatepicker.mod.global.JQuery
...
object DatepickerOptions {
  ...
  implicit class DatepickerOptionsOps[Self <: DatepickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndDate(value: js.Date | String): Self = this.set("endDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEndDate: Self = this.set("endDate", js.undefined)
    
    @scala.inline
    def setFilter(value: (/* date */ js.Date, /* view */ day | month | year) => js.UndefOr[Boolean]): Self = this.set("filter", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setStartDate(value: js.Date | String): Self = this.set("startDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTriggerElement(value: Element): Self = this.set("trigger", value.asInstanceOf[js.Any])
