...
import typingsSlinky.canvasDashGauges.CanvasGauges.AnimationRule
import typingsSlinky.canvasDashGauges.CanvasGauges.DrawEventCallback
import typingsSlinky.canvasDashGauges.CanvasGauges.EndEventCallback
import typingsSlinky.canvasDashGauges.CanvasGauges.LinearGaugeOptions
import typingsSlinky.canvasDashGauges.CanvasGauges.RadialGaugeOptions
...
object canvasDashGaugesMod extends js.Object {
  @js.native
  class Animation ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.Animation {
  ...
  abstract class BaseGauge protected ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.BaseGauge {
    def this(options: typingsSlinky.canvasDashGauges.CanvasGauges.GenericOptions) = this()
  }
  
  @js.native
  class DomObserver protected ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.DomObserver {
    def this(
      options: typingsSlinky.canvasDashGauges.CanvasGauges.GenericOptions,
      element: String,
      `type`: String
    ) = this()
  }
  ...
  class LinearGauge protected ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.LinearGauge {
    def this(options: LinearGaugeOptions) = this()
  }
  
  @js.native
  class RadialGauge protected ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.RadialGauge {
    def this(options: RadialGaugeOptions) = this()
  }
  
  @js.native
  class SmartCanvas protected ()
    extends typingsSlinky.canvasDashGauges.CanvasGauges.SmartCanvas {
  ...
  val GenericOptions: typingsSlinky.canvasDashGauges.CanvasGauges.GenericOptions = js.native
  /* static members */
  @js.native
  ...
  object BaseGauge extends js.Object {
    ...
    def initialize(`type`: String, options: typingsSlinky.canvasDashGauges.CanvasGauges.GenericOptions): js.Any = js.native
  }
  ...
  object SmartCanvas extends js.Object {
    var collection: js.Array[typingsSlinky.canvasDashGauges.CanvasGauges.SmartCanvas] = js.native
