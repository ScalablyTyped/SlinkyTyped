...
object RadialGaugeOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(needleCircleInner)) __obj.updateDynamic("needleCircleInner")(needleCircleInner.asInstanceOf[js.Any])
    if (!js.isUndefined(needleCircleOuter)) __obj.updateDynamic("needleCircleOuter")(needleCircleOuter.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useMinPath)) __obj.updateDynamic("useMinPath")(useMinPath.asInstanceOf[js.Any])
