...
object CanvasGauges {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.canvasGauges.canvasGaugesStrings.italic
    - typingsSlinky.canvasGauges.canvasGaugesStrings.oblique
  */
  ...
  */
  ...
  object GenericOptions {
    ...
    implicit class GenericOptionsMutableBuilder[Self <: GenericOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderToHTMLElement(value: HTMLElement): Self = StObject.set(x, "renderTo", value.asInstanceOf[js.Any])
