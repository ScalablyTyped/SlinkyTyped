package typingsSlinky.consul.consulMod.Agent

import typingsSlinky.consul.consulMod.Agent.Check.DeregisterOptions
import typingsSlinky.consul.consulMod.Agent.Check.FailOptions
import typingsSlinky.consul.consulMod.Agent.Check.ListOptions
import typingsSlinky.consul.consulMod.Agent.Check.PassOptions
import typingsSlinky.consul.consulMod.Agent.Check.RegisterOptions
import typingsSlinky.consul.consulMod.Agent.Check.WarnOptions
