...
import typingsSlinky.consul.consulMod.Health.ChecksOptions
import typingsSlinky.consul.consulMod.Health.NodeOptions
import typingsSlinky.consul.consulMod.Health.ServiceOptions
import typingsSlinky.consul.consulMod.Health.StateOptions
