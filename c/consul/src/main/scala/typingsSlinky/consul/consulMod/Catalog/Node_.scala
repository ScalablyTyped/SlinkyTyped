...
trait Node_ extends js.Object {
  ...
  /**
    * Lists the services provided by a node
    */
  def services[TData](opts: typingsSlinky.consul.consulMod.Catalog.Node.ServicesOptions): Thenable[TData] = js.native
  /**
    * Lists the services provided by a node
    */
  def services[TData](opts: typingsSlinky.consul.consulMod.Catalog.Node.ServicesOptions, callback: Callback[TData]): Unit = js.native
}
