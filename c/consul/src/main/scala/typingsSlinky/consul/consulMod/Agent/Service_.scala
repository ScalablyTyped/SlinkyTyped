...
import typingsSlinky.consul.consulMod.Agent.Service.DeregisterOptions
import typingsSlinky.consul.consulMod.Agent.Service.ListOptions
import typingsSlinky.consul.consulMod.Agent.Service.RegisterOptions
...
trait Service_ extends js.Object {
  ...
  /**
    ...
    */
  def maintenance[TData](opts: typingsSlinky.consul.consulMod.Agent.Service.MaintenanceOptions): Thenable[TData] = js.native
  /**
    * Manages node maintenance mode
    */
  def maintenance[TData](opts: typingsSlinky.consul.consulMod.Agent.Service.MaintenanceOptions, callback: Callback[TData]): Unit = js.native
  /**
