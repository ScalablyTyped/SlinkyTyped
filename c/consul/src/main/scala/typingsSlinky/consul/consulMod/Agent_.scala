...
import typingsSlinky.consul.consulMod.Agent.Check
import typingsSlinky.consul.consulMod.Agent.ChecksOptions
import typingsSlinky.consul.consulMod.Agent.ForceLeaveOptions
import typingsSlinky.consul.consulMod.Agent.JoinOptions
import typingsSlinky.consul.consulMod.Agent.MaintenanceOptions
import typingsSlinky.consul.consulMod.Agent.MembersOptions
import typingsSlinky.consul.consulMod.Agent.SelfOptions
import typingsSlinky.consul.consulMod.Agent.Service
import typingsSlinky.consul.consulMod.Agent.ServicesOptions
