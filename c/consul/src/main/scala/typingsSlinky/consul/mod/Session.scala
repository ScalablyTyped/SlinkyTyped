...
import typingsSlinky.consul.mod.Session.CreateOptions
import typingsSlinky.consul.mod.Session.DestroyOptions
import typingsSlinky.consul.mod.Session.GetOptions
import typingsSlinky.consul.mod.Session.InfoOptions
import typingsSlinky.consul.mod.Session.ListOptions
import typingsSlinky.consul.mod.Session.NodeOptions
import typingsSlinky.consul.mod.Session.RenewOptions
