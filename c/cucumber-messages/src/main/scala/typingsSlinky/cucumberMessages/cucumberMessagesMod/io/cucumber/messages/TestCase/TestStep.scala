...
object TestStep extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): TestStep = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestStep = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestStep = js.native
