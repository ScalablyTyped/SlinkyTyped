...
object TestCasePreparedStep {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): TestCasePreparedStep = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.TestCasePreparedStep.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestCasePreparedStep = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestCasePreparedStep = js.native
  /**
