...
object DataTable extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DataTable = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DataTable = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DataTable = js.native
