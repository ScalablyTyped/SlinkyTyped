...
object Comment extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Comment = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Comment = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Comment = js.native
