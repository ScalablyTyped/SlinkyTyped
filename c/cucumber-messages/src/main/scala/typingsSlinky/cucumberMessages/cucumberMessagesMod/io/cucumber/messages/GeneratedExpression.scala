...
object GeneratedExpression {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): GeneratedExpression = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.GeneratedExpression.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): GeneratedExpression = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): GeneratedExpression = js.native
  /**
