...
import typingsSlinky.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Media.Encoding
...
object Media extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Media = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Media = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Media = js.native
