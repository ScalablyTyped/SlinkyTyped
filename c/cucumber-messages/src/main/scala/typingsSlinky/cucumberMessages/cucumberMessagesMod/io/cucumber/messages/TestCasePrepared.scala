...
object TestCasePrepared extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): TestCasePrepared = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestCasePrepared = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestCasePrepared = js.native
