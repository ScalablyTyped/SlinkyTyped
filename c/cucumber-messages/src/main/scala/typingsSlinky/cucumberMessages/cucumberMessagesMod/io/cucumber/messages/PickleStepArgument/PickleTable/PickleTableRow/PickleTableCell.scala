...
object PickleTableCell extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): PickleTableCell = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PickleTableCell = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): PickleTableCell = js.native
