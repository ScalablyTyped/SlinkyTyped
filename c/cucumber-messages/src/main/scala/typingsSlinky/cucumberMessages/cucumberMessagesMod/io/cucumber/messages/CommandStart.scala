...
object CommandStart extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): CommandStart = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): CommandStart = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): CommandStart = js.native
