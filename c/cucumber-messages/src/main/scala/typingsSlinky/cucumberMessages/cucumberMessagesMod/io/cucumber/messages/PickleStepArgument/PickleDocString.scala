...
object PickleDocString extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): PickleDocString = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): PickleDocString = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): PickleDocString = js.native
