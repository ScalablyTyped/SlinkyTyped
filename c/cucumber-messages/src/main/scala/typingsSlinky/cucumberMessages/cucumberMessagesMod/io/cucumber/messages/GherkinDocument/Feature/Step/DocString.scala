...
object DocString extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): DocString = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): DocString = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): DocString = js.native
