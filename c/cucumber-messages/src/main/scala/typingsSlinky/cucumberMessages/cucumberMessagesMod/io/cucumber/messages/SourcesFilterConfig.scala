...
object SourcesFilterConfig {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): SourcesFilterConfig = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.SourcesFilterConfig.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): SourcesFilterConfig = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): SourcesFilterConfig = js.native
  /**
