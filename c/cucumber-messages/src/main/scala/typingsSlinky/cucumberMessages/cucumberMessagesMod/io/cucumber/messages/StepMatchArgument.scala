...
object StepMatchArgument {
  ...
  object Group {
    ...
    @js.native
    def decode(reader: js.typedarray.Uint8Array): Group = js.native
    @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.StepMatchArgument.Group.decode")
    @js.native
    def decode(reader: js.typedarray.Uint8Array, length: Double): Group = js.native
    /**
    ...
    @js.native
    def decodeDelimited(reader: js.typedarray.Uint8Array): Group = js.native
    /**
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): StepMatchArgument = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.StepMatchArgument.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): StepMatchArgument = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): StepMatchArgument = js.native
  /**
