...
object TestResult {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): TestResult = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.TestResult.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestResult = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestResult = js.native
  /**
