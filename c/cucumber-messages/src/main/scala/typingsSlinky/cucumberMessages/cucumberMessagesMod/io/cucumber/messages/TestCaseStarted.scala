...
object TestCaseStarted {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): TestCaseStarted = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.TestCaseStarted.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestCaseStarted = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestCaseStarted = js.native
  /**
