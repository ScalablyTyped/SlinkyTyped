...
object Platform extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Platform = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Platform = js.native
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Platform = js.native
