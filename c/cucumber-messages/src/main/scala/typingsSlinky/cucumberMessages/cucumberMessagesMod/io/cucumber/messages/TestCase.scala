...
object TestCase {
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): TestCase = js.native
  @JSImport("cucumber-messages/dist/src/cucumber-messages", "io.cucumber.messages.TestCase.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TestCase = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): TestCase = js.native
  /**
