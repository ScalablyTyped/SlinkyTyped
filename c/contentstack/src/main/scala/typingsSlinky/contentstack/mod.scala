package typingsSlinky.contentstack
...
object mod {
  ...
  class ContentType () extends StObject {
    ...
    def Assets(uid: String): typingsSlinky.contentstack.mod.Assets = js.native
    
    def Entry(uid: String): typingsSlinky.contentstack.mod.Entry = js.native
    
    def Query(): typingsSlinky.contentstack.mod.Query = js.native
  }
  ...
  class Stack protected () extends StObject {
    ...
    def ContentType(uid: String): typingsSlinky.contentstack.mod.ContentType = js.native
