...
import typingsSlinky.chromeLauncher.anon.FnCall
import typingsSlinky.chromeLauncher.anon.Typeoffs
import typingsSlinky.chromeLauncher.chromeLauncherStrings.error
import typingsSlinky.chromeLauncher.chromeLauncherStrings.info
import typingsSlinky.chromeLauncher.chromeLauncherStrings.silent
import typingsSlinky.chromeLauncher.chromeLauncherStrings.verbose
...
object chromeLauncherMod {
  ...
  object ModuleOverrides {
    ...
    implicit class ModuleOverridesMutableBuilder[Self <: ModuleOverrides] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRimraf(value: (/* path */ String, /* callback */ js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "rimraf", js.Any.fromFunction2(value))
  ...
  type RimrafModule = js.Function2[/* path */ String, /* callback */ js.Function1[/* error */ js.Error, Unit], Unit]
}
