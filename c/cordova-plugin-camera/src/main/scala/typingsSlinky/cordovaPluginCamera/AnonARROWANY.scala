...
@js.native
trait AnonARROWANY extends js.Object {
...
object AnonARROWANY {
  @scala.inline
  def apply(ARROW_ANY: Double, ARROW_DOWN: Double, ARROW_LEFT: Double, ARROW_RIGHT: Double, ARROW_UP: Double): AnonARROWANY = {
    ...
    __obj.asInstanceOf[AnonARROWANY]
  }
  @scala.inline
  implicit class AnonARROWANYOps[Self <: AnonARROWANY] (val x: Self) extends AnyVal {
    @scala.inline
