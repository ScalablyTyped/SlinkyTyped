...
import typingsSlinky.cacache.enMod.get.Options
import typingsSlinky.cacache.enMod.ls.Cache
import typingsSlinky.cacache.enMod.tmp.Callback
...
object cacacheMod extends js.Object {
  ...
  object put extends js.Object {
    ...
    def apply(cachePath: String, key: String, data: js.Any, opts: typingsSlinky.cacache.enMod.put.Options): js.Promise[String] = js.native
    /**
    ...
    def stream(cachePath: String, key: String, opts: typingsSlinky.cacache.enMod.put.Options): WritableStream = js.native
  }
  ...
  object tmp extends js.Object {
    ...
    def mkdir(cachePath: String, opts: typingsSlinky.cacache.enMod.tmp.Options): js.Promise[String] = js.native
    ...
    /**
      ...
      */
    def withTmp(cachePath: String, opts: typingsSlinky.cacache.enMod.tmp.Options, cb: Callback): Unit = js.native
  }
  
  @js.native
  object verify extends js.Object {
    def apply(cachePath: String): js.Promise[_] = js.native
    def apply(cachePath: String, opts: typingsSlinky.cacache.enMod.verify.Options): js.Promise[_] = js.native
    /**
      * Returns a Date representing the last time `cacache.verify` was run on
      * `cache`.
      */
    def lastRun(cachePath: String): js.Promise[js.Date] = js.native
  }
