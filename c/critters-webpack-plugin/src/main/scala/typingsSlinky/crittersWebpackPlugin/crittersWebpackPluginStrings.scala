...
import typingsSlinky.crittersWebpackPlugin.mod.Critters.KeyframeStrategy
import typingsSlinky.crittersWebpackPlugin.mod.Critters.LogLevel
import typingsSlinky.crittersWebpackPlugin.mod.Critters.PreloadStrategy
