...
object Form {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.calidation.mod.Form] {
    @scala.inline
    ...
    @scala.inline
    def onChange(
      value: (/* event */ ChangeEvent[HTMLFormElement]) | (SyntheticEvent[EventTarget with HTMLFormElement, Event_]) => Unit
    ...
    @scala.inline
    def onResetFunction1(value: SyntheticEvent[EventTarget with HTMLFormElement, Event_] => Unit): this.type = set("onReset", js.Any.fromFunction1(value))
    @scala.inline
