...
trait ValidationProps[T /* <: js.Object */] extends StObject {
  ...
  def children(context: ValidationContext[T]): ReactElement = js.native
...
object ValidationProps {
  ...
  @scala.inline
  def apply[T /* <: js.Object */](children: ValidationContext[T] => ReactElement, config: FieldsConfig[T]): ValidationProps[T] = {
