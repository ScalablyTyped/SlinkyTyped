...
object SubscriptionComponentOptions {
  ...
  @scala.inline
  implicit class SubscriptionComponentOptionsOps[Self[tdata, tvariables] <: SubscriptionComponentOptions[tdata, tvariables], TData, TVariables] (val x: Self[TData, TVariables]) extends AnyVal {
    @scala.inline
