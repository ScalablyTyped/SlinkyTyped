...
import typingsSlinky.azureMobileServicesClient.Microsoft.WindowsAzure.WindowsAzureStatic
...
object global {
  ...
  object WindowsAzure extends Shortcut {
    ...
    class MobileServiceClient protected ()
      extends typingsSlinky.azureMobileServicesClient.Microsoft.WindowsAzure.MobileServiceClient {
