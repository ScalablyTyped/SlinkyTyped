package typingsSlinky.atAntDashDesignReactDashNative.libDateDashPickerDashViewPropsTypeMod
...
import typingsSlinky.atAntDashDesignReactDashNative.libDateDashPickerPropsTypeMod.DatePickerPropsType
