...
trait ReadonlychildrenReactNodeReadonlydefault extends js.Object {
  val children: js.UndefOr[TagMod[Any] with js.Any] = js.undefined
...
object ReadonlychildrenReactNodeReadonlydefault {
  @scala.inline
  def apply(
    children: TagMod[Any] with js.Any = null,
  ...
  ): ReadonlychildrenReactNodeReadonlydefault = {
    ...
    __obj.asInstanceOf[ReadonlychildrenReactNodeReadonlydefault]
  }
}
