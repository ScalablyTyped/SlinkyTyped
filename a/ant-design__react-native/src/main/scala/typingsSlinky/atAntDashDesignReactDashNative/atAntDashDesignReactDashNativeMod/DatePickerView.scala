...
import typingsSlinky.atAntDashDesignReactDashNative.Anon_MinuteStep
import typingsSlinky.atAntDashDesignReactDashNative.libDateDashPickerDashViewMod.default
...
object DatePickerView extends js.Object {
  ...
  var defaultProps: Anon_MinuteStep = js.native
}
