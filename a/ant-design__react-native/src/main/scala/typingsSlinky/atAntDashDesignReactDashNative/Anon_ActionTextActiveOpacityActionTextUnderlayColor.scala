...
trait Anon_ActionTextActiveOpacityActionTextUnderlayColor extends js.Object {
...
object Anon_ActionTextActiveOpacityActionTextUnderlayColor {
  @scala.inline
  def apply(
    WrapComponent: View,
    ...
    triggerType: String
  ): Anon_ActionTextActiveOpacityActionTextUnderlayColor = {
    ...
    __obj.asInstanceOf[Anon_ActionTextActiveOpacityActionTextUnderlayColor]
  }
}
