package typingsSlinky.atAntDashDesignReactDashNative.libResultMod
...
import typingsSlinky.atAntDashDesignReactDashNative.libResultPropsTypeMod.ResultPropsType
