...
import typingsSlinky.atAntDashDesignReactDashNative.libDrawerPropsTypeMod.DrawerProps
...
trait DrawerNativeProps extends DrawerProps {
  ...
  var drawerRef: js.UndefOr[
    js.Function1[
      /* el */ typingsSlinky.atBang88ReactDashNativeDashDrawerDashLayout.atBang88ReactDashNativeDashDrawerDashLayoutMod.default | Null, 
      Unit
    ]
  ] = js.undefined
