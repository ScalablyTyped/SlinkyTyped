package typingsSlinky.atAntDashDesignReactDashNative.libDrawerMod
...
trait Drawer
  ...
  var drawer: typingsSlinky.atBang88ReactDashNativeDashDrawerDashLayout.atBang88ReactDashNativeDashDrawerDashLayoutMod.default | Null = js.native
