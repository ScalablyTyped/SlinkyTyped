...
@JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", JSImport.Namespace)
@js.native
object libDateDashPickerDatepickerLocaleZhUnderscoreCNMod extends js.Object {
  @js.native
