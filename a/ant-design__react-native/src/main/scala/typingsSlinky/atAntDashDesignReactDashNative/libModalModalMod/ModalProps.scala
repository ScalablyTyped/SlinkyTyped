...
import typingsSlinky.atAntDashDesignReactDashNative.libModalPropsTypeMod.ModalPropsType
import typingsSlinky.atAntDashDesignReactDashNative.libModalStyleMod.ModalStyle
