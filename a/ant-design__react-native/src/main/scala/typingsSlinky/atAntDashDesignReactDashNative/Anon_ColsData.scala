...
trait Anon_ColsData extends js.Object {
  var cols: Double
  var data: js.Array[scala.Nothing]
  var disabled: Boolean
}

object Anon_ColsData {
  @scala.inline
  def apply(cols: Double, data: js.Array[scala.Nothing], disabled: Boolean): Anon_ColsData = {
    ...
    __obj.asInstanceOf[Anon_ColsData]
  }
}
