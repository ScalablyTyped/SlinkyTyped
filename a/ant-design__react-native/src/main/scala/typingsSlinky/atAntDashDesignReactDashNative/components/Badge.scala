...
import typingsSlinky.atAntDashDesignReactDashNative.libBadgeMod.BadgeProps
import typingsSlinky.atAntDashDesignReactDashNative.libBadgeMod.default
...
object Badge
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libBadgeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
