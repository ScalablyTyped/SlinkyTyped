...
object Marquee
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libNoticeDashBarMarqueeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
