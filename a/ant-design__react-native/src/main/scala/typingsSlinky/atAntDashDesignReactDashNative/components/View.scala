...
import typingsSlinky.atAntDashDesignReactDashNative.libViewMod.default
...
object View
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libViewMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
