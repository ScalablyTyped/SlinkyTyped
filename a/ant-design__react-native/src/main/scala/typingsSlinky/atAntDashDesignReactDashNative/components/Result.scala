...
import typingsSlinky.atAntDashDesignReactDashNative.libResultMod.ResultNativeProps
import typingsSlinky.atAntDashDesignReactDashNative.libResultMod.default
import typingsSlinky.atAntDashDesignReactDashNative.libResultStyleMod.ResultStyle
...
object Result
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libResultMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
