...
import typingsSlinky.atAntDashDesignReactDashNative.libPickerNativePickerDotIosMod.default
...
import typingsSlinky.reactDashNative.reactDashNativeMod.PickerProps
...
import typingsSlinky.reactDashNative.reactDashNativeStrings.dialog
import typingsSlinky.reactDashNative.reactDashNativeStrings.dropdown
...
object NativePickerDotIos
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libPickerNativePickerDotIosMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
