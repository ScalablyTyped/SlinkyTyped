...
import typingsSlinky.atAntDashDesignReactDashNative.atAntDashDesignReactDashNativeStrings.xxs
import typingsSlinky.atAntDashDesignReactDashNative.libIconMod.IconNames
