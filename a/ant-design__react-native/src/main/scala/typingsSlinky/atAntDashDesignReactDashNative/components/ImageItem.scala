...
import typingsSlinky.atAntDashDesignReactDashNative.libImageDashPickerImageItemMod.ImageItemProps
import typingsSlinky.atAntDashDesignReactDashNative.libImageDashPickerImageItemMod.default
...
object ImageItem
  ...
  def apply(
    ...
    selectedMarker: typingsSlinky.react.reactMod._Global_.JSX.Element = null,
