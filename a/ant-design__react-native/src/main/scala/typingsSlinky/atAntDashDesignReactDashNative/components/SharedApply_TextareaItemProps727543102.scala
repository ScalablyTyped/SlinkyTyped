...
import typingsSlinky.atAntDashDesignReactDashNative.libTextareaDashItemMod.TextareaItemProps
...
abstract class SharedApply_TextareaItemProps727543102[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: autoFocus, disabled, name, onChange, onKeyPress, onScroll, onTouchCancel, onTouchEnd, onTouchMove, onTouchStart, placeholder, rows, spellCheck */
  def apply(
    ...
    onContentSizeChange: (/* e */ js.Any) | (/* e */ NativeSyntheticEvent[TextInputContentSizeChangeEventData]) => Unit = null,
    ...
    styles: PartialTextareaItemStyle = null,
    testID: String = null,
