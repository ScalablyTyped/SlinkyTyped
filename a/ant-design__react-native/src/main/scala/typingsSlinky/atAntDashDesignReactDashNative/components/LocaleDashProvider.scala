...
import typingsSlinky.atAntDashDesignReactDashNative.libLocaleDashProviderMod.LocaleProviderProps
import typingsSlinky.atAntDashDesignReactDashNative.libLocaleDashProviderMod.default
...
object LocaleDashProvider
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libLocaleDashProviderMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
