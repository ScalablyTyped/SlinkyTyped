...
import typingsSlinky.atAntDashDesignReactDashNative.libCardMod.CardNativeProps
import typingsSlinky.atAntDashDesignReactDashNative.libCardMod.default
...
object Card
  ...
  typingsSlinky.atAntDashDesignReactDashNative.libCardMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
