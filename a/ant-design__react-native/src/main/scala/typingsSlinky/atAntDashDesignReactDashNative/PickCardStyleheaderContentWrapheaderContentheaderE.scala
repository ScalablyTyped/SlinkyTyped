...
trait PickCardStyleheaderContentWrapheaderContentheaderE extends js.Object {
...
object PickCardStyleheaderContentWrapheaderContentheaderE {
  @scala.inline
  def apply(
  ...
  ): PickCardStyleheaderContentWrapheaderContentheaderE = {
    ...
    __obj.asInstanceOf[PickCardStyleheaderContentWrapheaderContentheaderE]
  }
}
