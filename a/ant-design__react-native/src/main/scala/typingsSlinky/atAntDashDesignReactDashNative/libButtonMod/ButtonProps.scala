package typingsSlinky.atAntDashDesignReactDashNative.libButtonMod
...
- typings.atAntDashDesignReactDashNative.libButtonPropsTypeMod.ButtonPropsType because var conflicts: disabled. Inlined `type`, size, loading */ trait ButtonProps
