...
@JSImport("@ant-design/react-native/lib/date-picker-view/locale/en_US", JSImport.Namespace)
@js.native
object libDateDashPickerDashViewLocaleEnUnderscoreUSMod extends js.Object {
  @js.native
