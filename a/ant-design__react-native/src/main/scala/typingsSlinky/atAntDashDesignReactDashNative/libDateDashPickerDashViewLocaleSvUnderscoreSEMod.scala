...
@JSImport("@ant-design/react-native/lib/date-picker-view/locale/sv_SE", JSImport.Namespace)
@js.native
object libDateDashPickerDashViewLocaleSvUnderscoreSEMod extends js.Object {
  @js.native
