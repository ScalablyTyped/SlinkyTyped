package typingsSlinky.atAntDashDesignReactDashNative.libInputDashItemMod
...
object TextInputProps {
  ...
  def apply(
    ...
    keyboardAppearance: typingsSlinky.atAntDashDesignReactDashNative.atAntDashDesignReactDashNativeStrings.default | light | dark = null,
