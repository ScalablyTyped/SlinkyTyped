...
import typingsSlinky.atAntDashDesignReactDashNative.Anon_ContainerDisabledStepTextColor
...
trait InputNumberProps extends js.Object {
  ...
  var styles: ReturnType[js.Function1[/* theme */ Theme, Anon_ContainerDisabledStepTextColor]]
...
object InputNumberProps {
  @scala.inline
  def apply(
    styles: ReturnType[js.Function1[/* theme */ Theme, Anon_ContainerDisabledStepTextColor]],
