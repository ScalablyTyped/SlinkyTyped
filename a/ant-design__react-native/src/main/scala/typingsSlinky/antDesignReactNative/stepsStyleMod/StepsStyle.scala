...
object StepsStyle {
  ...
  implicit class StepsStyleOps[Self <: StepsStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContent_s_h(value: ViewStyle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("content_s_h")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTail_default_s_h(value: ViewStyle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tail_default_s_h")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
