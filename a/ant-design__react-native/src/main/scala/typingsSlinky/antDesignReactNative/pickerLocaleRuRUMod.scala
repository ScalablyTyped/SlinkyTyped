...
object pickerLocaleRuRUMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/picker/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/picker/locale/ru_RU", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/picker/locale/ru_RU", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/picker/locale/ru_RU", "default.okText")
    @js.native
