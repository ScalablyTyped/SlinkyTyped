...
object inputItemLocaleEnUSMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/en_US", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/en_US", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/en_US", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/en_US", "default.confirmLabel")
    @js.native
