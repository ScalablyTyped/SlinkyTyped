...
import typingsSlinky.antDesignReactNative.antDesignReactNativeStrings.dialog
import typingsSlinky.antDesignReactNative.antDesignReactNativeStrings.dropdown
