...
object inputItemLocaleSvSeMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/sv_Se", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/sv_Se", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/sv_Se", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/sv_Se", "default.confirmLabel")
    @js.native
