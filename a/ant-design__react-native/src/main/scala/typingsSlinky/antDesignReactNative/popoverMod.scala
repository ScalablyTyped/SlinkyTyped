...
object popoverMod {
  ...
  object PopoverItem {
    ...
    @js.native
    def displayName: typingsSlinky.antDesignReactNative.antDesignReactNativeStrings.PopoverItem = js.native
    @scala.inline
    def displayName_=(x: typingsSlinky.antDesignReactNative.antDesignReactNativeStrings.PopoverItem): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  ...
  object PopoverProps {
    ...
    implicit class PopoverPropsMutableBuilder[Self <: PopoverProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderOverlayComponent(value: (/* node */ ReactElement, /* closePopover */ js.Function0[Unit]) => ReactElement): Self = StObject.set(x, "renderOverlayComponent", js.Any.fromFunction2(value))
