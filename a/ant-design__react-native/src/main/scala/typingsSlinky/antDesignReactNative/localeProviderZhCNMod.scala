...
object localeProviderZhCNMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.DatePicker")
    @js.native
    def DatePicker: DismissText = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.DatePickerView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.InputItem")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.ListView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.Modal")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.Pagination")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.Picker")
    @js.native
    def Picker: Extra = js.native
    @scala.inline
    def Picker_=(x: Extra): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Picker")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.SearchBar")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/zh_CN", "default.locale")
    @js.native
