...
object inputItemLocaleZhCNMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/zh_CN", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/zh_CN", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/zh_CN", "default.confirmLabel")
    @js.native
