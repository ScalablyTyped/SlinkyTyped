...
import typingsSlinky.antDesignReactNative.inputItemPropsTypeMod.InputItemPropsType
...
object InputItemProps {
  ...
  implicit class InputItemPropsOps[Self <: InputItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnErrorClick(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onErrorClick")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutOnErrorClick: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onErrorClick")(js.undefined)
        ret
    }
    @scala.inline
    def withOnExtraClick(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onExtraClick")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutOnExtraClick: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onExtraClick")(js.undefined)
        ret
    }
    @scala.inline
