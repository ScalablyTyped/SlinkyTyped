...
object datePickerLocalePtBRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/pt_BR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/pt_BR", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/pt_BR", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/pt_BR", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/pt_BR", "default.okText")
    @js.native
