...
import typingsSlinky.antDesignReactNative.textareaItemPropsTypeMod.TextAreaItemPropsType
...
object TextareaItemProps {
  ...
  implicit class TextareaItemPropsOps[Self <: TextareaItemProps] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("onContentSizeChange", js.Any.fromFunction1(value))
