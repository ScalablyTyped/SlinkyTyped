...
object InputItem
  ...
  /* The following DOM/SVG props were specified: autoFocus, disabled, name, placeholder, spellCheck */
  def apply(
  ...
  typingsSlinky.antDesignReactNative.inputItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
