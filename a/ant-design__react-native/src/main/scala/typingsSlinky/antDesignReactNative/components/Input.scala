...
import typingsSlinky.antDesignReactNative.inputMod.TextInputProps
import typingsSlinky.antDesignReactNative.inputMod.default
...
object Input
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignReactNative.inputMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
