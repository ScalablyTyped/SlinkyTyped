...
import typingsSlinky.antDesignReactNative.textareaItemMod.TextareaItemProps
import typingsSlinky.antDesignReactNative.textareaItemStyleMod.TextareaItemStyle
...
object TextareaItem {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.antDesignReactNative.mod.TextareaItem] {
    ...
    @scala.inline
    def styles(value: Partial[TextareaItemStyle]): this.type = set("styles", value.asInstanceOf[js.Any])
