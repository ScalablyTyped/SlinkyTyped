...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onPress(value: /* _ */ js.UndefOr[js.Any] => Unit): this.type = set("onPress", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def styles(value: Partial[ButtonStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
