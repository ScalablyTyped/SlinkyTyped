...
object searchBarMod {
  ...
  object SearchBarProps {
    ...
    implicit class SearchBarPropsMutableBuilder[Self <: SearchBarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyboardAppearance(value: typingsSlinky.antDesignReactNative.antDesignReactNativeStrings.default | light | dark): Self = StObject.set(x, "keyboardAppearance", value.asInstanceOf[js.Any])
