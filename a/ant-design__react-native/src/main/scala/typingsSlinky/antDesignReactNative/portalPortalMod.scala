...
object portalPortalMod {
  ...
  object default {
    ...
    @js.native
    class Host ()
      extends typingsSlinky.antDesignReactNative.portalHostMod.default
    /* static members */
    object Host {
    ...
    @js.native
    def add: js.Function1[/* e */ ReactElement, Double] = js.native
    @scala.inline
    def add_=(x: js.Function1[/* e */ ReactElement, Double]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("add")(x.asInstanceOf[js.Any])
  ...
  object Portal {
    ...
    /* was `typeof PortalHost` */
    type Host = typingsSlinky.antDesignReactNative.portalHostMod.default
  }
