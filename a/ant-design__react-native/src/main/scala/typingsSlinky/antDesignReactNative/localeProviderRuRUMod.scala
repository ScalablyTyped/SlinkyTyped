...
object localeProviderRuRUMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.DatePicker")
    @js.native
    def DatePicker: DismissText = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.DatePickerView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.InputItem")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.ListView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.Modal")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.Pagination")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.Picker")
    @js.native
    def Picker: Extra = js.native
    @scala.inline
    def Picker_=(x: Extra): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Picker")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.SearchBar")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/ru_RU", "default.locale")
    @js.native
