...
import typingsSlinky.antDesignReactNative.anon.ThemeStyles
...
object libStyleMod {
  ...
  @js.native
  def ThemeProvider(props: ThemeProviderProps): ReactElement = js.native
  ...
  trait WithThemeProps[T, S] extends StObject {
    ...
    def children(styles: T with StringDictionary[js.Any], theme: Theme): ReactElement = js.native
  ...
  object WithThemeProps {
    ...
    @scala.inline
    def apply[T, S](children: (T with StringDictionary[js.Any], Theme) => ReactElement, themeStyles: Theme => T): WithThemeProps[T, S] = {
    ...
    implicit class WithThemePropsMutableBuilder[Self <: WithThemeProps[_, _], T, S] (val x: Self with (WithThemeProps[T, S])) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (T with StringDictionary[js.Any], Theme) => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
