...
object AddTypename {
  ...
  def apply(
    ...
    operationIdsPath: js.UndefOr[Null | String] = js.undefined,
    ...
    if (!js.isUndefined(addTypename)) __obj.updateDynamic("addTypename")(addTypename.get.asInstanceOf[js.Any])
    if (customScalarsPrefix != null) __obj.updateDynamic("customScalarsPrefix")(customScalarsPrefix.asInstanceOf[js.Any])
    if (!js.isUndefined(generateOperationIds)) __obj.updateDynamic("generateOperationIds")(generateOperationIds.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mergeInFieldsFromFragmentSpreads)) __obj.updateDynamic("mergeInFieldsFromFragmentSpreads")(mergeInFieldsFromFragmentSpreads.get.asInstanceOf[js.Any])
    if (namespace != null) __obj.updateDynamic("namespace")(namespace.asInstanceOf[js.Any])
    if (!js.isUndefined(operationIdsPath)) __obj.updateDynamic("operationIdsPath")(operationIdsPath.asInstanceOf[js.Any])
    if (!js.isUndefined(passthroughCustomScalars)) __obj.updateDynamic("passthroughCustomScalars")(passthroughCustomScalars.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useFlowExactObjects)) __obj.updateDynamic("useFlowExactObjects")(useFlowExactObjects.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useFlowReadOnlyTypes)) __obj.updateDynamic("useFlowReadOnlyTypes")(useFlowReadOnlyTypes.get.asInstanceOf[js.Any])
