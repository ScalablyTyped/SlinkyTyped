...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.json
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.swift
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.`ts-legacy`
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.`typescript-legacy`
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.`flow-legacy`
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.scala_
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.flow
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.typescript
  - typingsSlinky.apolloCodegen.apolloCodegenStrings.ts
*/
