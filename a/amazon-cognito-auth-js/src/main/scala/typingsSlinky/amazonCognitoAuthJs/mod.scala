...
object mod {
  ...
  trait CognitoConstants extends StObject {
    ...
    var QUERYPARAMETERREGEX1: js.RegExp = js.native
    
    var QUERYPARAMETERREGEX2: js.RegExp = js.native
  ...
  object CognitoConstants {
    ...
    implicit class CognitoConstantsMutableBuilder[Self <: CognitoConstants] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHOSTNAMEREGEX(value: js.RegExp): Self = StObject.set(x, "HOSTNAMEREGEX", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setQUERYPARAMETERREGEX1(value: js.RegExp): Self = StObject.set(x, "QUERYPARAMETERREGEX1", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setQUERYPARAMETERREGEX2(value: js.RegExp): Self = StObject.set(x, "QUERYPARAMETERREGEX2", value.asInstanceOf[js.Any])
