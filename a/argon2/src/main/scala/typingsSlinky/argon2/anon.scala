...
object anon {
  ...
  object Optionsrawfalseundefined {
    ...
    @scala.inline
    implicit class OptionsrawfalseundefinedMutableBuilder[Self <: Optionsrawfalseundefined] (val x: Self) extends AnyVal {
  ...
  object Optionsrawtrue {
    ...
    @scala.inline
    implicit class OptionsrawtrueMutableBuilder[Self <: Optionsrawtrue] (val x: Self) extends AnyVal {
