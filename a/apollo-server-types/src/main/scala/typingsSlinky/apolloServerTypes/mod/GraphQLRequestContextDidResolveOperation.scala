...
/* Inlined apollo-server-types.apollo-server-types.GraphQLRequestContextValidationDidStart<TContext> & apollo-server-types.apollo-server-types.WithRequired<apollo-server-types.apollo-server-types.GraphQLRequestContext<TContext>, 'operation' | 'operationName'> */
@js.native
trait GraphQLRequestContextDidResolveOperation[TContext] extends js.Object {
...
object GraphQLRequestContextDidResolveOperation {
  @scala.inline
  def apply[TContext](
    ...
    val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], document = document.asInstanceOf[js.Any], logger = logger.asInstanceOf[js.Any], metrics = metrics.asInstanceOf[js.Any], operation = operation.asInstanceOf[js.Any], operationName = operationName.asInstanceOf[js.Any], queryHash = queryHash.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], schema = schema.asInstanceOf[js.Any], schemaHash = schemaHash.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphQLRequestContextDidResolveOperation[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestContextDidResolveOperationOps[Self <: GraphQLRequestContextDidResolveOperation[_], TContext] (val x: Self with GraphQLRequestContextDidResolveOperation[TContext]) extends AnyVal {
    @scala.inline
