...
object GraphQLRequestContextExecutionDidStart {
  ...
  @scala.inline
  implicit class GraphQLRequestContextExecutionDidStartOps[Self <: GraphQLRequestContextExecutionDidStart[_], TContext] (val x: Self with GraphQLRequestContextExecutionDidStart[TContext]) extends AnyVal {
