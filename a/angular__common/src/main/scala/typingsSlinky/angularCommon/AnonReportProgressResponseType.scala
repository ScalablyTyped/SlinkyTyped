...
object AnonReportProgressResponseType {
  @scala.inline
  def apply(observe: response, responseType: blob): AnonReportProgressResponseType = {
  ...
  @scala.inline
  implicit class AnonReportProgressResponseTypeOps[Self <: AnonReportProgressResponseType] (val x: Self) extends AnyVal {
    @scala.inline
