...
object svFIMod extends Shortcut {
  
  @JSImport("@angular/common/locales/extra/sv-FI", JSImport.Default)
  @js.native
  val default: js.Array[js.Array[String | js.Array[String]]] = js.native
  
  type _To = js.Array[js.Array[String | js.Array[String]]]
  
  /* This means you don't have to write `default`, but can instead just say `svFIMod.foo` */
