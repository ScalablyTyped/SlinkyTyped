...
object AnonReportProgressBooleanResponseType {
  @scala.inline
  def apply(): AnonReportProgressBooleanResponseType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonReportProgressBooleanResponseType]
  }
  @scala.inline
  implicit class AnonReportProgressBooleanResponseTypeOps[Self <: AnonReportProgressBooleanResponseType] (val x: Self) extends AnyVal {
    @scala.inline
