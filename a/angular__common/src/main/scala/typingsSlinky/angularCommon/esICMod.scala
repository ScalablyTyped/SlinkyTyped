...
object esICMod extends Shortcut {
  
  @JSImport("@angular/common/locales/es-IC", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esICMod.foo` */
