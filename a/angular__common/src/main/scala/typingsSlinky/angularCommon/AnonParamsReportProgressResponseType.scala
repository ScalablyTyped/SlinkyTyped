...
object AnonParamsReportProgressResponseType {
  @scala.inline
  def apply(responseType: arraybuffer): AnonParamsReportProgressResponseType = {
  ...
  @scala.inline
  implicit class AnonParamsReportProgressResponseTypeOps[Self <: AnonParamsReportProgressResponseType] (val x: Self) extends AnyVal {
    @scala.inline
