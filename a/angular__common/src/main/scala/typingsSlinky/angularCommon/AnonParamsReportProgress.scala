...
object AnonParamsReportProgress {
  @scala.inline
  def apply(observe: response, responseType: arraybuffer): AnonParamsReportProgress = {
  ...
  @scala.inline
  implicit class AnonParamsReportProgressOps[Self <: AnonParamsReportProgress] (val x: Self) extends AnyVal {
    @scala.inline
