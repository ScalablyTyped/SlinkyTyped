...
object TranslationWidth extends StObject {
  ...
  /* 1 */ val Abbreviated: typingsSlinky.angularCommon.mod.TranslationWidth.Abbreviated with Double = js.native
  
  /** 1 character for `en-US`. For example: 'S' */
  @js.native
  sealed trait Narrow extends TranslationWidth
  /* 0 */ val Narrow: typingsSlinky.angularCommon.mod.TranslationWidth.Narrow with Double = js.native
  
  /** 2 characters for `en-US`, For example: "Su" */
  @js.native
  sealed trait Short extends TranslationWidth
  /* 3 */ val Short: typingsSlinky.angularCommon.mod.TranslationWidth.Short with Double = js.native
  
  /** Full length for `en-US`. For example: "Sunday" */
  @js.native
  sealed trait Wide extends TranslationWidth
  /* 2 */ val Wide: typingsSlinky.angularCommon.mod.TranslationWidth.Wide with Double = js.native
}
