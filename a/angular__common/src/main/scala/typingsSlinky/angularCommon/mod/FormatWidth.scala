...
object FormatWidth extends StObject {
  ...
  /* 3 */ val Full: typingsSlinky.angularCommon.mod.FormatWidth.Full with Double = js.native
  ...
  /* 2 */ val Long: typingsSlinky.angularCommon.mod.FormatWidth.Long with Double = js.native
  ...
  /* 1 */ val Medium: typingsSlinky.angularCommon.mod.FormatWidth.Medium with Double = js.native
  ...
  /* 0 */ val Short: typingsSlinky.angularCommon.mod.FormatWidth.Short with Double = js.native
}
