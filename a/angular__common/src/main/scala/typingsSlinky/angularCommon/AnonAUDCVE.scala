...
object AnonAUDCVE {
  ...
  @scala.inline
  implicit class AnonAUDCVEOps[Self <: AnonAUDCVE] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCVE(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CVE")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
