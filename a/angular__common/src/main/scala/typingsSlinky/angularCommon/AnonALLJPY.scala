...
@js.native
trait AnonALLJPY extends js.Object {
...
object AnonALLJPY {
  @scala.inline
  def apply(ALL: js.Array[String], JPY: js.Array[String], THB: js.Array[String], USD: js.Array[String]): AnonALLJPY = {
    ...
    __obj.asInstanceOf[AnonALLJPY]
  }
  @scala.inline
  implicit class AnonALLJPYOps[Self <: AnonALLJPY] (val x: Self) extends AnyVal {
    @scala.inline
