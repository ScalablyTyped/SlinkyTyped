...
object AnonMDL {
  ...
  @scala.inline
  implicit class AnonMDLOps[Self <: AnonMDL] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMDL(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MDL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
