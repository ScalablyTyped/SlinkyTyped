...
object brMod extends Shortcut {
  
  @JSImport("@angular/common/locales/br", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `brMod.foo` */
