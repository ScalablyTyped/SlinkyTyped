...
object AnonGEL {
  ...
  implicit class AnonGELOps[Self <: AnonGEL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLBP(value: js.Array[js.UndefOr[String]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withXOF(value: js.Array[scala.Nothing]): Self = {
        val ret = this.duplicate
