...
import typingsSlinky.angularCommon.angularCommonBooleans.`false`
...
class HttpErrorResponse protected ()
  ...
  @JSName("name")
  val name_HttpErrorResponse: typingsSlinky.angularCommon.angularCommonStrings.HttpErrorResponse = js.native
  /**
