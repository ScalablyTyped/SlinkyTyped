...
@js.native
trait AnonGTQ extends js.Object {
  ...
  var GTQ: js.Array[String] = js.native
...
object AnonGTQ {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonGTQ]
  }
  @scala.inline
  implicit class AnonGTQOps[Self <: AnonGTQ] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withGTQ(value: js.Array[String]): Self = {
        val ret = this.duplicate
