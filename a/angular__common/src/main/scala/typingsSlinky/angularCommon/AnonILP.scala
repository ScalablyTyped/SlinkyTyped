...
@js.native
trait AnonILP extends js.Object {
...
object AnonILP {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonILP]
  }
  @scala.inline
  implicit class AnonILPOps[Self <: AnonILP] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withKMF(value: js.Array[String]): Self = {
        val ret = this.duplicate
