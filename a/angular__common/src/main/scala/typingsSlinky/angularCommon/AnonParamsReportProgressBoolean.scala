...
object AnonParamsReportProgressBoolean {
  @scala.inline
  def apply(observe: response): AnonParamsReportProgressBoolean = {
    val __obj = js.Dynamic.literal(observe = observe.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonParamsReportProgressBoolean]
  }
  @scala.inline
  implicit class AnonParamsReportProgressBooleanOps[Self <: AnonParamsReportProgressBoolean] (val x: Self) extends AnyVal {
    @scala.inline
