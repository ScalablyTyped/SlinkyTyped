...
@js.native
trait AnonAUDRON extends js.Object {
...
object AnonAUDRON {
  @scala.inline
  def apply(AUD: js.Array[String], RON: js.Array[js.UndefOr[String]], USD: js.Array[String]): AnonAUDRON = {
  ...
  @scala.inline
  implicit class AnonAUDRONOps[Self <: AnonAUDRON] (val x: Self) extends AnyVal {
    @scala.inline
