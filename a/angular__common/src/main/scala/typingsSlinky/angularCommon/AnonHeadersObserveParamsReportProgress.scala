...
@js.native
trait AnonHeadersObserveParamsReportProgress extends js.Object {
...
object AnonHeadersObserveParamsReportProgress {
  @scala.inline
  def apply(responseType: text): AnonHeadersObserveParamsReportProgress = {
    val __obj = js.Dynamic.literal(responseType = responseType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHeadersObserveParamsReportProgress]
  }
  @scala.inline
  implicit class AnonHeadersObserveParamsReportProgressOps[Self <: AnonHeadersObserveParamsReportProgress] (val x: Self) extends AnyVal {
    @scala.inline
