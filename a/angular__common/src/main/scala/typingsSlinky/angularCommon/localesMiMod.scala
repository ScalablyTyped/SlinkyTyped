...
object localesMiMod extends Shortcut {
  
  @JSImport("@angular/common/locales/mi", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesMiMod.foo` */
