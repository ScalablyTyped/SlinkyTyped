...
@js.native
trait AnonPYG extends js.Object {
  ...
  var PYG: js.Array[String] = js.native
...
object AnonPYG {
  ...
  implicit class AnonPYGOps[Self <: AnonPYG] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPYG(value: js.Array[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSSP(value: js.Array[js.UndefOr[String]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withVEF(value: js.Array[js.UndefOr[String]]): Self = {
        val ret = this.duplicate
