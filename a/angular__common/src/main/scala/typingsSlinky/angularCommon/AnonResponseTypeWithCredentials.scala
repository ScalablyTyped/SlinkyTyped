...
object AnonResponseTypeWithCredentials {
  @scala.inline
  def apply(observe: response, responseType: text): AnonResponseTypeWithCredentials = {
  ...
  @scala.inline
  implicit class AnonResponseTypeWithCredentialsOps[Self <: AnonResponseTypeWithCredentials] (val x: Self) extends AnyVal {
    @scala.inline
