...
@js.native
trait AnonXOF extends js.Object {
  ...
  var VEF: js.Array[String] = js.native
...
object AnonXOF {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonXOF]
  }
  @scala.inline
  implicit class AnonXOFOps[Self <: AnonXOF] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withVEF(value: js.Array[String]): Self = {
        val ret = this.duplicate
