...
object AnonHeadersObserveParamsReportProgressResponseTypeWithCredentials {
  @scala.inline
  def apply(observe: response, responseType: arraybuffer): AnonHeadersObserveParamsReportProgressResponseTypeWithCredentials = {
  ...
  @scala.inline
  implicit class AnonHeadersObserveParamsReportProgressResponseTypeWithCredentialsOps[Self <: AnonHeadersObserveParamsReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
    @scala.inline
