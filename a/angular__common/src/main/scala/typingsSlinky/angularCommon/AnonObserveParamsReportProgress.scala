...
object AnonObserveParamsReportProgress {
  @scala.inline
  def apply(): AnonObserveParamsReportProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonObserveParamsReportProgress]
  }
  @scala.inline
  implicit class AnonObserveParamsReportProgressOps[Self <: AnonObserveParamsReportProgress] (val x: Self) extends AnyVal {
    @scala.inline
