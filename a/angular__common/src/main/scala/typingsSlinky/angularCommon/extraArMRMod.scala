...
object extraArMRMod extends Shortcut {
  
  @JSImport("@angular/common/locales/extra/ar-MR", JSImport.Default)
  @js.native
  val default: js.Array[js.UndefOr[js.Array[js.Array[String]]]] = js.native
  
  type _To = js.Array[js.UndefOr[js.Array[js.Array[String]]]]
  
  /* This means you don't have to write `default`, but can instead just say `extraArMRMod.foo` */
