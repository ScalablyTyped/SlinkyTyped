...
object AnonReportProgressResponseTypeWithCredentials {
  @scala.inline
  def apply(responseType: blob): AnonReportProgressResponseTypeWithCredentials = {
  ...
  @scala.inline
  implicit class AnonReportProgressResponseTypeWithCredentialsOps[Self <: AnonReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
    @scala.inline
