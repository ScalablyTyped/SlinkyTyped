...
@js.native
trait AnonBGM extends js.Object {
  ...
  var EUR: js.Array[scala.Nothing] = js.native
...
object AnonBGM {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonBGM]
  }
  @scala.inline
  implicit class AnonBGMOps[Self <: AnonBGM] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withEUR(value: js.Array[scala.Nothing]): Self = {
        val ret = this.duplicate
