...
object BRL {
  ...
  @scala.inline
  implicit class BRLMutableBuilder[Self <: BRL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNAD(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "NAD", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNADVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "NAD", js.Array(value :_*))
    ...
    @scala.inline
    def setSGD(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "SGD", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSGDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SGD", js.Array(value :_*))
