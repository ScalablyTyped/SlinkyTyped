...
object MGA {
  ...
  @scala.inline
  implicit class MGAOps[Self <: MGA] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMGAVarargs(value: String*): Self = this.set("MGA", js.Array(value :_*))
    @scala.inline
    def setMGA(value: js.Array[String]): Self = this.set("MGA", value.asInstanceOf[js.Any])
    @scala.inline
