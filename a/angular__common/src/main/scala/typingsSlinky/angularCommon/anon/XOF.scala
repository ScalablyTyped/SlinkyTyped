...
object XOF {
  ...
  implicit class XOFOps[Self <: XOF] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVEFVarargs(value: String*): Self = this.set("VEF", js.Array(value :_*))
    @scala.inline
    def setVEF(value: js.Array[String]): Self = this.set("VEF", value.asInstanceOf[js.Any])
    @scala.inline
