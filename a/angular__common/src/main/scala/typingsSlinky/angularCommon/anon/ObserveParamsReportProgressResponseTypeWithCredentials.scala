...
object ObserveParamsReportProgressResponseTypeWithCredentials {
  ...
  @scala.inline
  implicit class ObserveParamsReportProgressResponseTypeWithCredentialsOps[Self <: ObserveParamsReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
