...
object ZMW {
  ...
  @scala.inline
  implicit class ZMWOps[Self <: ZMW] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setZMWVarargs(value: String*): Self = this.set("ZMW", js.Array(value :_*))
    @scala.inline
    def setZMW(value: js.Array[String]): Self = this.set("ZMW", value.asInstanceOf[js.Any])
  }
