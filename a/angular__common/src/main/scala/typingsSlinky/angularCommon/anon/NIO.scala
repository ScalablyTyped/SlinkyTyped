...
trait NIO extends js.Object {
  ...
  var NIO: js.Array[String] = js.native
...
object NIO {
  ...
  def apply(
    ...
    __obj.asInstanceOf[NIO]
  }
  @scala.inline
  implicit class NIOOps[Self <: NIO] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withNIO(value: js.Array[String]): Self = {
        val ret = this.duplicate
