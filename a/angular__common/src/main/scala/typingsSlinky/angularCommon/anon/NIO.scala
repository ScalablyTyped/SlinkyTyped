...
object NIO {
  ...
  @scala.inline
  implicit class NIOMutableBuilder[Self <: NIO] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNIO(value: js.Array[String]): Self = StObject.set(x, "NIO", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNIOVarargs(value: String*): Self = StObject.set(x, "NIO", js.Array(value :_*))
