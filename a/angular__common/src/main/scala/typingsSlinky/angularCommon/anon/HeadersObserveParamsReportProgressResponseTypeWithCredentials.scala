...
@js.native
trait HeadersObserveParamsReportProgressResponseTypeWithCredentials extends StObject {
...
object HeadersObserveParamsReportProgressResponseTypeWithCredentials {
  ...
  @scala.inline
  implicit class HeadersObserveParamsReportProgressResponseTypeWithCredentialsMutableBuilder[Self <: HeadersObserveParamsReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
