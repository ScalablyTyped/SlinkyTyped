...
object CUP {
  ...
  @scala.inline
  implicit class CUPMutableBuilder[Self <: CUP] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCUP(value: js.Array[String]): Self = StObject.set(x, "CUP", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCUPVarargs(value: String*): Self = StObject.set(x, "CUP", js.Array(value :_*))
