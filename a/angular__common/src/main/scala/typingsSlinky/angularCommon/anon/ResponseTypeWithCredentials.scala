...
@js.native
trait ResponseTypeWithCredentials extends StObject {
...
object ResponseTypeWithCredentials {
  ...
  @scala.inline
  implicit class ResponseTypeWithCredentialsMutableBuilder[Self <: ResponseTypeWithCredentials] (val x: Self) extends AnyVal {
