...
@js.native
trait JPYSBD extends js.Object {
...
object JPYSBD {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], FJD = FJD.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], SBD = SBD.asInstanceOf[js.Any], SRD = SRD.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], XPF = XPF.asInstanceOf[js.Any])
    __obj.asInstanceOf[JPYSBD]
  }
  @scala.inline
  implicit class JPYSBDOps[Self <: JPYSBD] (val x: Self) extends AnyVal {
    @scala.inline
