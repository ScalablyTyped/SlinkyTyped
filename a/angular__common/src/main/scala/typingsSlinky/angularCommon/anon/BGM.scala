...
object BGM {
  ...
  @scala.inline
  implicit class BGMMutableBuilder[Self <: BGM] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEUR(value: js.Array[scala.Nothing]): Self = StObject.set(x, "EUR", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEURVarargs(value: scala.Nothing*): Self = StObject.set(x, "EUR", js.Array(value :_*))
