...
object ReportProgressBooleanResponseType {
  @scala.inline
  def apply(): ReportProgressBooleanResponseType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReportProgressBooleanResponseType]
  }
  @scala.inline
  implicit class ReportProgressBooleanResponseTypeOps[Self <: ReportProgressBooleanResponseType] (val x: Self) extends AnyVal {
    @scala.inline
