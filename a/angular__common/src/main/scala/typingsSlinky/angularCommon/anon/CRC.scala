...
trait CRC extends js.Object {
  ...
  var CRC: js.Array[String] = js.native
...
object CRC {
  ...
  implicit class CRCOps[Self <: CRC] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCRC(value: js.Array[String]): Self = {
        val ret = this.duplicate
