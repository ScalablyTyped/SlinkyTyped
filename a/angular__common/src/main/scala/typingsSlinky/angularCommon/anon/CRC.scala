...
object CRC {
  ...
  implicit class CRCMutableBuilder[Self <: CRC] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCRC(value: js.Array[String]): Self = StObject.set(x, "CRC", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCRCVarargs(value: String*): Self = StObject.set(x, "CRC", js.Array(value :_*))
