...
object STN {
  ...
  @scala.inline
  implicit class STNMutableBuilder[Self <: STN] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSTN(value: js.Array[String]): Self = StObject.set(x, "STN", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSTNVarargs(value: String*): Self = StObject.set(x, "STN", js.Array(value :_*))
