...
trait VEF extends StObject {
  ...
  var VES: js.Array[String] = js.native
...
object VEF {
  ...
  implicit class VEFMutableBuilder[Self <: VEF] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVEF(value: js.Array[String]): Self = StObject.set(x, "VEF", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVEFVarargs(value: String*): Self = StObject.set(x, "VEF", js.Array(value :_*))
    
    @scala.inline
    def setVES(value: js.Array[String]): Self = StObject.set(x, "VES", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVESVarargs(value: String*): Self = StObject.set(x, "VES", js.Array(value :_*))
