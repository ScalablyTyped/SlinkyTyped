...
object VEF {
  ...
  @scala.inline
  implicit class VEFOps[Self <: VEF] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setVESVarargs(value: String*): Self = this.set("VES", js.Array(value :_*))
    @scala.inline
    def setVES(value: js.Array[String]): Self = this.set("VES", value.asInstanceOf[js.Any])
    @scala.inline
