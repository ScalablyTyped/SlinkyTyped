...
@js.native
trait ReportProgress extends StObject {
...
object ReportProgress {
  ...
  @scala.inline
  def apply(responseType: blob): ReportProgress = {
    val __obj = js.Dynamic.literal(responseType = responseType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReportProgress]
  }
  
  @scala.inline
  implicit class ReportProgressMutableBuilder[Self <: ReportProgress] (val x: Self) extends AnyVal {
