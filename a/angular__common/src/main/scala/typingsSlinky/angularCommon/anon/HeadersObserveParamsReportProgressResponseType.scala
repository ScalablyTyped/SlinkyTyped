...
object HeadersObserveParamsReportProgressResponseType {
  ...
  @scala.inline
  def apply(observe: events, responseType: text): HeadersObserveParamsReportProgressResponseType = {
  ...
  @scala.inline
  implicit class HeadersObserveParamsReportProgressResponseTypeMutableBuilder[Self <: HeadersObserveParamsReportProgressResponseType] (val x: Self) extends AnyVal {
