...
object HNL {
  ...
  def apply(
    ...
    __obj.asInstanceOf[HNL]
  }
  
  @scala.inline
  implicit class HNLMutableBuilder[Self <: HNL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHNL(value: js.Array[String]): Self = StObject.set(x, "HNL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHNLVarargs(value: String*): Self = StObject.set(x, "HNL", js.Array(value :_*))
