...
object HNL {
  ...
  @scala.inline
  implicit class HNLOps[Self <: HNL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHNLVarargs(value: String*): Self = this.set("HNL", js.Array(value :_*))
    
    @scala.inline
    def setHNL(value: js.Array[String]): Self = this.set("HNL", value.asInstanceOf[js.Any])
