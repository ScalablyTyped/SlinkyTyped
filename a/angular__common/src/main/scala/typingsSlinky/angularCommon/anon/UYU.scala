...
object UYU {
  ...
  @scala.inline
  implicit class UYUOps[Self <: UYU] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUYWVarargs(value: String*): Self = this.set("UYW", js.Array(value :_*))
    
    @scala.inline
    def setUYW(value: js.Array[String]): Self = this.set("UYW", value.asInstanceOf[js.Any])
