...
object AnonWithCredentialsBoolean {
  @scala.inline
  def apply(observe: response, responseType: text): AnonWithCredentialsBoolean = {
  ...
  @scala.inline
  implicit class AnonWithCredentialsBooleanOps[Self <: AnonWithCredentialsBoolean] (val x: Self) extends AnyVal {
    @scala.inline
