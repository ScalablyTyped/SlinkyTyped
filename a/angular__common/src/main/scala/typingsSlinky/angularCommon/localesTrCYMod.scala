...
object localesTrCYMod extends Shortcut {
  
  @JSImport("@angular/common/locales/tr-CY", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesTrCYMod.foo` */
