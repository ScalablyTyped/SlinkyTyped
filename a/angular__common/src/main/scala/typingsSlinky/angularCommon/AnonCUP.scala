...
@js.native
trait AnonCUP extends js.Object {
  ...
  var CUP: js.Array[String] = js.native
...
object AnonCUP {
  ...
  implicit class AnonCUPOps[Self <: AnonCUP] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCUP(value: js.Array[String]): Self = {
        val ret = this.duplicate
