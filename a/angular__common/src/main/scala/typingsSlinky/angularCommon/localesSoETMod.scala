...
object localesSoETMod extends Shortcut {
  
  @JSImport("@angular/common/locales/so-ET", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesSoETMod.foo` */
