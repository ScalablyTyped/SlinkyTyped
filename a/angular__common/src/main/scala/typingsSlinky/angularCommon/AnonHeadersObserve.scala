...
@js.native
trait AnonHeadersObserve extends js.Object {
...
object AnonHeadersObserve {
  @scala.inline
  def apply(observe: events, responseType: text): AnonHeadersObserve = {
    val __obj = js.Dynamic.literal(observe = observe.asInstanceOf[js.Any], responseType = responseType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHeadersObserve]
  }
  @scala.inline
  implicit class AnonHeadersObserveOps[Self <: AnonHeadersObserve] (val x: Self) extends AnyVal {
    @scala.inline
