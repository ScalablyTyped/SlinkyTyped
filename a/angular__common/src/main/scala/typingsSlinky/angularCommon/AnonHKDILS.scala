...
@js.native
trait AnonHKDILS extends js.Object {
...
object AnonHKDILS {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonHKDILS]
  }
  @scala.inline
  implicit class AnonHKDILSOps[Self <: AnonHKDILS] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withILS(value: js.Array[String]): Self = {
        val ret = this.duplicate
