...
trait Anon_MYR extends js.Object {
...
object Anon_MYR {
  @scala.inline
  def apply(MYR: js.Array[String], SGD: js.Array[String], THB: js.Array[String], TWD: js.Array[String]): Anon_MYR = {
