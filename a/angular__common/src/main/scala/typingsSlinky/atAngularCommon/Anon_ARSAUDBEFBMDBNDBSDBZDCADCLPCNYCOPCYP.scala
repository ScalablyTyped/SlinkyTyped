...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP]
  }
}
