...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP]
  }
}
