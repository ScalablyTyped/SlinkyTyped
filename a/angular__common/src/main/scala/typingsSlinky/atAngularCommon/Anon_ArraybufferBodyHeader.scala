...
trait Anon_ArraybufferBodyHeader extends js.Object {
...
object Anon_ArraybufferBodyHeader {
  @scala.inline
  def apply(
    observe: response,
    ...
    __obj.asInstanceOf[Anon_ArraybufferBodyHeader]
  }
}
