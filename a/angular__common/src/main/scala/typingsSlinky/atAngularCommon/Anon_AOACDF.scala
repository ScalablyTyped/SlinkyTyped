...
trait Anon_AOACDF extends js.Object {
...
object Anon_AOACDF {
  @scala.inline
  def apply(AOA: js.Array[String], CDF: js.Array[String], JPY: js.Array[String], USD: js.Array[String]): Anon_AOACDF = {
    ...
    __obj.asInstanceOf[Anon_AOACDF]
  }
}
