...
trait Anon_DJF extends js.Object {
...
object Anon_DJF {
  @scala.inline
  def apply(DJF: js.Array[String], JPY: js.Array[String], SOS: js.Array[String], USD: js.Array[String]): Anon_DJF = {
