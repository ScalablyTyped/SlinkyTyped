...
trait Anon_JPYKESUGX extends js.Object {
...
object Anon_JPYKESUGX {
  @scala.inline
  def apply(JPY: js.Array[String], KES: js.Array[String], UGX: js.Array[String], USD: js.Array[String]): Anon_JPYKESUGX = {
    ...
    __obj.asInstanceOf[Anon_JPYKESUGX]
  }
}
