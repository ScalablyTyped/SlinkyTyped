...
trait Anon_AUDBRLCADCNYEURGBPHKDILSINR extends js.Object {
...
object Anon_AUDBRLCADCNYEURGBPHKDILSINR {
  @scala.inline
  def apply(
  ...
  ): Anon_AUDBRLCADCNYEURGBPHKDILSINR = {
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYEURGBPHKDILSINR]
  }
}
