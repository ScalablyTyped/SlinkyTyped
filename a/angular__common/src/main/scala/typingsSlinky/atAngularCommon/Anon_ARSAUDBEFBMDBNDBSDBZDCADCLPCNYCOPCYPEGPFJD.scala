...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD]
  }
}
