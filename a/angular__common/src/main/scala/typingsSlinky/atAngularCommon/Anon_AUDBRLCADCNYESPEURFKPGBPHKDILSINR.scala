...
trait Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINR extends js.Object {
...
object Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINR {
  @scala.inline
  def apply(
  ...
  ): Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINR = {
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINR]
  }
}
