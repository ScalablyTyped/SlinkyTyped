...
trait Anon_JPYKESSOS extends js.Object {
...
object Anon_JPYKESSOS {
  @scala.inline
  def apply(JPY: js.Array[String], KES: js.Array[String], SOS: js.Array[String], USD: js.Array[String]): Anon_JPYKESSOS = {
    ...
    __obj.asInstanceOf[Anon_JPYKESSOS]
  }
}
