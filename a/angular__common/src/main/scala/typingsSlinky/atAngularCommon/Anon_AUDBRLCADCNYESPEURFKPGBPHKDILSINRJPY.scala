...
trait Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY extends js.Object {
...
object Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY {
  @scala.inline
  def apply(
  ...
  ): Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY = {
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY]
  }
}
