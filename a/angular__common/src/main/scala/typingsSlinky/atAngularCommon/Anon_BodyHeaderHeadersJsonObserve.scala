...
trait Anon_BodyHeaderHeadersJsonObserve extends js.Object {
...
object Anon_BodyHeaderHeadersJsonObserve {
  @scala.inline
  def apply(
    body: js.Any = null,
  ...
  ): Anon_BodyHeaderHeadersJsonObserve = {
    ...
    __obj.asInstanceOf[Anon_BodyHeaderHeadersJsonObserve]
  }
}
