...
trait Anon_BlobBodyHeaderHeaders extends js.Object {
...
object Anon_BlobBodyHeaderHeaders {
  @scala.inline
  def apply(
    responseType: blob,
    ...
    __obj.asInstanceOf[Anon_BlobBodyHeaderHeaders]
  }
}
