...
trait Anon_AUDBRLCADCNYEURGBPHKD extends js.Object {
...
object Anon_AUDBRLCADCNYEURGBPHKD {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYEURGBPHKD]
  }
}
