...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP]
  }
}
