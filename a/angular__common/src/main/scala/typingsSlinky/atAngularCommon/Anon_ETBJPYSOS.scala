...
trait Anon_ETBJPYSOS extends js.Object {
...
object Anon_ETBJPYSOS {
  @scala.inline
  def apply(ETB: js.Array[String], JPY: js.Array[String], SOS: js.Array[String], USD: js.Array[String]): Anon_ETBJPYSOS = {
    ...
    __obj.asInstanceOf[Anon_ETBJPYSOS]
  }
}
