...
trait Anon_AUDLVL extends js.Object {
...
object Anon_AUDLVL {
  @scala.inline
  def apply(AUD: js.Array[String], LVL: js.Array[String], THB: js.Array[String], TWD: js.Array[String]): Anon_AUDLVL = {
    ...
    __obj.asInstanceOf[Anon_AUDLVL]
  }
}
