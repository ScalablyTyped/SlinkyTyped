...
trait Anon_AEDARSAUDBBDBHDBMDBNDBSD extends js.Object {
...
object Anon_AEDARSAUDBBDBHDBMDBNDBSD {
  @scala.inline
  def apply(
    AED: js.Array[String],
    ...
    __obj.asInstanceOf[Anon_AEDARSAUDBBDBHDBMDBNDBSD]
  }
}
