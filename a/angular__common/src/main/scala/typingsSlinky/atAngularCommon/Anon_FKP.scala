...
trait Anon_FKP extends js.Object {
...
object Anon_FKP {
  @scala.inline
  def apply(FKP: js.Array[String], GBP: js.Array[String], JPY: js.Array[String], USD: js.Array[String]): Anon_FKP = {
