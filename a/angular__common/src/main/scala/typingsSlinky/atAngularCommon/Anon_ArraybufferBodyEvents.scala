...
trait Anon_ArraybufferBodyEvents extends js.Object {
...
object Anon_ArraybufferBodyEvents {
  @scala.inline
  def apply(
    observe: events,
    ...
    __obj.asInstanceOf[Anon_ArraybufferBodyEvents]
  }
}
