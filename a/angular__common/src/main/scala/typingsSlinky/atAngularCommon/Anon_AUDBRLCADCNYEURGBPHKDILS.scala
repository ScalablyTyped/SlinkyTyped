...
trait Anon_AUDBRLCADCNYEURGBPHKDILS extends js.Object {
...
object Anon_AUDBRLCADCNYEURGBPHKDILS {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYEURGBPHKDILS]
  }
}
