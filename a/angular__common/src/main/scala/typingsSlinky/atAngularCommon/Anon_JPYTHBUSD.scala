...
trait Anon_JPYTHBUSD extends js.Object {
...
object Anon_JPYTHBUSD {
  @scala.inline
  def apply(JPY: js.Array[String], THB: js.Array[String], USD: js.Array[String], UZS: js.Array[String]): Anon_JPYTHBUSD = {
    ...
    __obj.asInstanceOf[Anon_JPYTHBUSD]
  }
}
