...
trait Anon_AUDBRLCADCNYESPEURFKPGBP extends js.Object {
...
object Anon_AUDBRLCADCNYESPEURFKPGBP {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYESPEURFKPGBP]
  }
}
