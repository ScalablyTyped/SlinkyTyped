...
trait Anon_JPYKHR extends js.Object {
...
object Anon_JPYKHR {
  @scala.inline
  def apply(JPY: js.Array[String], KHR: js.Array[String], THB: js.Array[String], TWD: js.Array[String]): Anon_JPYKHR = {
    ...
    __obj.asInstanceOf[Anon_JPYKHR]
  }
}
