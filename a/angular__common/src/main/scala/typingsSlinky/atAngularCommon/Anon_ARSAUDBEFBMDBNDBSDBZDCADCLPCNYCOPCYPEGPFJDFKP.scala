...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKP = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKP]
  }
}
