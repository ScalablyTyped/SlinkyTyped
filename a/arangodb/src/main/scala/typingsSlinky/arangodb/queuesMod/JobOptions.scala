...
object JobOptions {
  ...
  implicit class JobOptionsOps[Self <: JobOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelayUntilDate(value: js.Date): Self = this.set("delayUntil", value.asInstanceOf[js.Any])
    @scala.inline
    def setDelayUntil(value: Double | js.Date): Self = this.set("delayUntil", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRepeatUntilDate(value: js.Date): Self = this.set("repeatUntil", value.asInstanceOf[js.Any])
    @scala.inline
    def setRepeatUntil(value: Double | js.Date): Self = this.set("repeatUntil", value.asInstanceOf[js.Any])
    @scala.inline
