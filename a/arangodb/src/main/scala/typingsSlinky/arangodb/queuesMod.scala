...
object queuesMod {
  ...
  object JobOptions {
    ...
    implicit class JobOptionsMutableBuilder[Self <: JobOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDelayUntil(value: Double | js.Date): Self = StObject.set(x, "delayUntil", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDelayUntilDate(value: js.Date): Self = StObject.set(x, "delayUntil", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRepeatUntil(value: Double | js.Date): Self = StObject.set(x, "repeatUntil", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRepeatUntilDate(value: js.Date): Self = StObject.set(x, "repeatUntil", value.asInstanceOf[js.Any])
