...
object AnonDeletion {
  ...
  @scala.inline
  implicit class AnonDeletionOps[Self <: AnonDeletion] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDeletion(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deletion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
