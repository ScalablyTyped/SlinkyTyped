...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.arangodb.arangodbStrings.continue
  - typingsSlinky.arangodb.arangodbStrings.`switching protocols`
  - typingsSlinky.arangodb.arangodbStrings.processing
  - typingsSlinky.arangodb.arangodbStrings.ok
  - typingsSlinky.arangodb.arangodbStrings.created
  - typingsSlinky.arangodb.arangodbStrings.accepted
  - typingsSlinky.arangodb.arangodbStrings.`non-authoritative information`
  - typingsSlinky.arangodb.arangodbStrings.`no content`
  - typingsSlinky.arangodb.arangodbStrings.`reset content`
  - typingsSlinky.arangodb.arangodbStrings.`partial content`
  - typingsSlinky.arangodb.arangodbStrings.`multi-status`
  - typingsSlinky.arangodb.arangodbStrings.`already reported`
  - typingsSlinky.arangodb.arangodbStrings.`im used`
  - typingsSlinky.arangodb.arangodbStrings.`multiple choices`
  - typingsSlinky.arangodb.arangodbStrings.`moved permanently`
  - typingsSlinky.arangodb.arangodbStrings.found
  - typingsSlinky.arangodb.arangodbStrings.`see other`
  - typingsSlinky.arangodb.arangodbStrings.`not modified`
  - typingsSlinky.arangodb.arangodbStrings.`use proxy`
  - typingsSlinky.arangodb.arangodbStrings.LeftparenthesisunusedRightparenthesis
  - typingsSlinky.arangodb.arangodbStrings.`temporary redirect`
  - typingsSlinky.arangodb.arangodbStrings.`permanent redirect`
  - typingsSlinky.arangodb.arangodbStrings.`bad request`
  - typingsSlinky.arangodb.arangodbStrings.unauthorized
  - typingsSlinky.arangodb.arangodbStrings.`payment required`
  - typingsSlinky.arangodb.arangodbStrings.forbidden
  - typingsSlinky.arangodb.arangodbStrings.`not found`
  - typingsSlinky.arangodb.arangodbStrings.`method not allowed`
  - typingsSlinky.arangodb.arangodbStrings.`not acceptable`
  - typingsSlinky.arangodb.arangodbStrings.`proxy authentication required`
  - typingsSlinky.arangodb.arangodbStrings.`request timeout`
  - typingsSlinky.arangodb.arangodbStrings.conflict
  - typingsSlinky.arangodb.arangodbStrings.gone
  - typingsSlinky.arangodb.arangodbStrings.`length required`
  - typingsSlinky.arangodb.arangodbStrings.`precondition failed`
  - typingsSlinky.arangodb.arangodbStrings.`payload too large`
  - typingsSlinky.arangodb.arangodbStrings.`uri too long`
  - typingsSlinky.arangodb.arangodbStrings.`unsupported media type`
  - typingsSlinky.arangodb.arangodbStrings.`range not satisfiable`
  - typingsSlinky.arangodb.arangodbStrings.`expectation failed`
  - typingsSlinky.arangodb.arangodbStrings.`iApostrophem a teapot`
  - typingsSlinky.arangodb.arangodbStrings.`misdirected request`
  - typingsSlinky.arangodb.arangodbStrings.`unprocessable entity`
  - typingsSlinky.arangodb.arangodbStrings.locked
  - typingsSlinky.arangodb.arangodbStrings.`failed dependency`
  - typingsSlinky.arangodb.arangodbStrings.`unordered collection`
  - typingsSlinky.arangodb.arangodbStrings.`upgrade required`
  - typingsSlinky.arangodb.arangodbStrings.`precondition required`
  - typingsSlinky.arangodb.arangodbStrings.`too many requests`
  - typingsSlinky.arangodb.arangodbStrings.`request header fields too large`
  - typingsSlinky.arangodb.arangodbStrings.`unavailable for legal reasons`
  - typingsSlinky.arangodb.arangodbStrings.`internal server error`
  - typingsSlinky.arangodb.arangodbStrings.`not implemented`
  - typingsSlinky.arangodb.arangodbStrings.`bad gateway`
  - typingsSlinky.arangodb.arangodbStrings.`service unavailable`
  - typingsSlinky.arangodb.arangodbStrings.`gateway timeout`
  - typingsSlinky.arangodb.arangodbStrings.`http version not supported`
  - typingsSlinky.arangodb.arangodbStrings.`variant also negotiates`
  - typingsSlinky.arangodb.arangodbStrings.`insufficient storage`
  - typingsSlinky.arangodb.arangodbStrings.`loop detected`
  - typingsSlinky.arangodb.arangodbStrings.`bandwidth limit exceeded`
