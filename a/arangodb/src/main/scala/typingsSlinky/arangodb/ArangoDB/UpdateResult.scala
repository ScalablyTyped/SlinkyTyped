...
object UpdateResult {
  @scala.inline
  def apply[/* <: js.Object */ T](_id: String, _key: String, _oldRev: String, _rev: String): UpdateResult[T] = {
  ...
  @scala.inline
  implicit class UpdateResultOps[Self <: UpdateResult[_], /* <: js.Object */ T] (val x: Self with UpdateResult[T]) extends AnyVal {
    @scala.inline
