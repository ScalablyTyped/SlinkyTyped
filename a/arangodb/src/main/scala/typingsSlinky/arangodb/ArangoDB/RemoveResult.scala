...
object RemoveResult {
  @scala.inline
  def apply[/* <: js.Object */ T](_id: String, _key: String, _rev: String): RemoveResult[T] = {
  ...
  @scala.inline
  implicit class RemoveResultOps[Self <: RemoveResult[_], /* <: js.Object */ T] (val x: Self with RemoveResult[T]) extends AnyVal {
    @scala.inline
