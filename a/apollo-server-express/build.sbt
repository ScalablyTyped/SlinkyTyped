...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo-server-core" % "2.9.15-9f00ad",
  ...
  "org.scalablytyped.slinky" %%% "cors" % "2.8-dt-20190819Z-a889fb",
  ...
  "org.scalablytyped.slinky" %%% "graphql-subscriptions" % "1.1.0-ab7bf6",
