...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo-server-core" % "2.11.0-ea64ce",
  ...
  "org.scalablytyped.slinky" %%% "cors" % "2.8-dt-20200225Z-a932c6",
  ...
  "org.scalablytyped.slinky" %%% "graphql-subscriptions" % "1.1.0-f98c6e",
