...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "apollo-server-core" % "2.11.0-99a131",
  ...
  "org.scalablytyped.slinky" %%% "cors" % "2.8-dt-20200225Z-e65d69",
  ...
  "org.scalablytyped.slinky" %%% "graphql-subscriptions" % "1.1.0-bfd60d",
