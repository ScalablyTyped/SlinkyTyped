...
object mergeInputType extends js.Object {
  ...
  def apply(node: InputObjectTypeDefinitionNode, existingNode: InputObjectTypeExtensionNode, config: Config): InputObjectTypeDefinitionNode | InputObjectTypeExtensionNode = js.native
  def apply(node: InputObjectTypeExtensionNode, existingNode: InputObjectTypeDefinitionNode): InputObjectTypeDefinitionNode | InputObjectTypeExtensionNode = js.native
  def apply(node: InputObjectTypeExtensionNode, existingNode: InputObjectTypeDefinitionNode, config: Config): InputObjectTypeDefinitionNode | InputObjectTypeExtensionNode = js.native
