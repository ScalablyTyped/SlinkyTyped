...
object Context {
  @scala.inline
  def apply[TData](remoteResult: ExecutionResult[TData]): Context[TData] = {
    val __obj = js.Dynamic.literal(remoteResult = remoteResult.asInstanceOf[js.Any])
    __obj.asInstanceOf[Context[TData]]
  }
  @scala.inline
  implicit class ContextOps[Self[tdata] <: Context[tdata], TData] (val x: Self[TData]) extends AnyVal {
    @scala.inline
