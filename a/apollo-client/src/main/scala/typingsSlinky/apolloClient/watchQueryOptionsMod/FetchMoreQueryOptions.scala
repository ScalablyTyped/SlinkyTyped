...
object FetchMoreQueryOptions {
  ...
  @scala.inline
  def apply[TVariables, K /* <: /* keyof TVariables */ String */](): FetchMoreQueryOptions[TVariables, K] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FetchMoreQueryOptions[TVariables, K]]
  }
  
  @scala.inline
  implicit class FetchMoreQueryOptionsOps[Self <: FetchMoreQueryOptions[_, _], TVariables, K /* <: /* keyof TVariables */ String */] (val x: Self with (FetchMoreQueryOptions[TVariables, K])) extends AnyVal {
