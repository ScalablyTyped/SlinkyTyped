...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorCallbacksVarargs(value: (js.Function1[/* error */ js.Error, js.Any])*): Self = this.set("errorCallbacks", js.Array(value :_*))
    
    @scala.inline
    def setErrorCallbacks(value: js.Array[js.Function1[/* error */ js.Error, _]]): Self = this.set("errorCallbacks", value.asInstanceOf[js.Any])
