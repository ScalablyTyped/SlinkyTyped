package typingsSlinky.azureDashSb.libModelsQueuemessageresultMod.Azure.ServiceBus.Results

import typingsSlinky.azureDashSb.azureDashSbMod.Azure.ServiceBus.BrokerProperties
