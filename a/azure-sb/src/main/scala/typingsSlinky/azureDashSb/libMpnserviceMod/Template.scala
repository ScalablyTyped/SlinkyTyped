package typingsSlinky.azureDashSb.libMpnserviceMod
...
/* Rewritten from type alias, can be one of: 
  - typings.azureDashSb.libMpnserviceMod.TileTemplate
  - typings.azureDashSb.libMpnserviceMod.FlipTileTemplate
  - typings.azureDashSb.libMpnserviceMod.ToastTemplate
*/
