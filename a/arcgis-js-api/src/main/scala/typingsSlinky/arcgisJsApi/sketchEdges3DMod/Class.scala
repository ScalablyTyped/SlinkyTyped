package typingsSlinky.arcgisJsApi.sketchEdges3DMod

import typingsSlinky.arcgisJsApi.esri.SketchEdges3D
import typingsSlinky.arcgisJsApi.esri.SketchEdges3DProperties
