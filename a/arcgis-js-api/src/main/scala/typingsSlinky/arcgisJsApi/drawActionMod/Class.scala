package typingsSlinky.arcgisJsApi.drawActionMod

import typingsSlinky.arcgisJsApi.esri.DrawAction
import typingsSlinky.arcgisJsApi.esri.DrawActionProperties
