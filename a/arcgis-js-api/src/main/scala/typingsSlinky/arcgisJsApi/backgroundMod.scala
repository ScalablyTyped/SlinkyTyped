...
import typingsSlinky.arcgisJsApi.esri.Background
import typingsSlinky.arcgisJsApi.esri.BackgroundConstructor
import typingsSlinky.arcgisJsApi.esri.BackgroundProperties
