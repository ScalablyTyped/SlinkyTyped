...
import typingsSlinky.arcgisJsApi.esri.ColorSizeSlider
import typingsSlinky.arcgisJsApi.esri.ColorSizeSliderConstructor
import typingsSlinky.arcgisJsApi.esri.ColorSizeSliderProperties
