package typingsSlinky.arcgisJsApi.mapNotesLayerMod

import typingsSlinky.arcgisJsApi.esri.MapNotesLayer
import typingsSlinky.arcgisJsApi.esri.MapNotesLayerProperties
