package typingsSlinky.arcgisJsApi.markerSymbolMod

import typingsSlinky.arcgisJsApi.esri.MarkerSymbol
import typingsSlinky.arcgisJsApi.esri.MarkerSymbolProperties
