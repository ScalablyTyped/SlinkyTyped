...
import typingsSlinky.arcgisJsApi.esri.SimpleLineSymbol
import typingsSlinky.arcgisJsApi.esri.SimpleLineSymbolConstructor
import typingsSlinky.arcgisJsApi.esri.SimpleLineSymbolProperties
