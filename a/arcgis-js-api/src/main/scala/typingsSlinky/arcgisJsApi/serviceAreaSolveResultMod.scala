...
import typingsSlinky.arcgisJsApi.esri.ServiceAreaSolveResult
import typingsSlinky.arcgisJsApi.esri.ServiceAreaSolveResultConstructor
import typingsSlinky.arcgisJsApi.esri.ServiceAreaSolveResultProperties
