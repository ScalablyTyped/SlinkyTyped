...
import typingsSlinky.arcgisJsApi.esri.VisualVariable
import typingsSlinky.arcgisJsApi.esri.VisualVariableConstructor
import typingsSlinky.arcgisJsApi.esri.VisualVariableProperties
