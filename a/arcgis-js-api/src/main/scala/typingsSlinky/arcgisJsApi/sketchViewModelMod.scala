...
import typingsSlinky.arcgisJsApi.esri.SketchViewModel
import typingsSlinky.arcgisJsApi.esri.SketchViewModelConstructor
import typingsSlinky.arcgisJsApi.esri.SketchViewModelProperties
