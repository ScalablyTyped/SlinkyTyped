...
import typingsSlinky.arcgisJsApi.esri.RasterInfo
import typingsSlinky.arcgisJsApi.esri.RasterInfoPixelSize
import typingsSlinky.arcgisJsApi.esri.RasterInfoProperties
import typingsSlinky.arcgisJsApi.esri.RasterInfoStatistics
