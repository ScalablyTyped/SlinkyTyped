package typingsSlinky.arcgisJsApi.anon
...
object Items {
  @scala.inline
  def apply[/* <: Base */ T, Base](): Items[T, Base] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Items[T, Base]]
  }
  @scala.inline
  implicit class ItemsOps[Self <: Items[_, _], /* <: Base */ T, Base] (val x: Self with (Items[T, Base])) extends AnyVal {
    @scala.inline
