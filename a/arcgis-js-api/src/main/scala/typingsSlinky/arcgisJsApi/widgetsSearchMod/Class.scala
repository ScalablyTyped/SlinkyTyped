package typingsSlinky.arcgisJsApi.widgetsSearchMod

import typingsSlinky.arcgisJsApi.esri.widgetsSearch
import typingsSlinky.arcgisJsApi.esri.widgetsSearchProperties
