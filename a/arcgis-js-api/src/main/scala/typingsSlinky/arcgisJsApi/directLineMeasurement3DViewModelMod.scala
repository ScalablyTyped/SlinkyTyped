...
import typingsSlinky.arcgisJsApi.esri.DirectLineMeasurement3DViewModel
import typingsSlinky.arcgisJsApi.esri.DirectLineMeasurement3DViewModelConstructor
import typingsSlinky.arcgisJsApi.esri.DirectLineMeasurement3DViewModelProperties
