...
trait CIMMarkerPlacementInsidePolygon
  ...
  @JSName("type")
  var type_CIMMarkerPlacementInsidePolygon: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementInsidePolygon = js.native
}
object CIMMarkerPlacementInsidePolygon {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementInsidePolygon): CIMMarkerPlacementInsidePolygon = {
  ...
  implicit class CIMMarkerPlacementInsidePolygonMutableBuilder[Self <: CIMMarkerPlacementInsidePolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementInsidePolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
