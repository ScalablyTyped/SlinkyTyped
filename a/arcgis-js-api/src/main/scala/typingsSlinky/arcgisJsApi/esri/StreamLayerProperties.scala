...
object StreamLayerProperties {
  ...
  def apply(
    ...
    maximumTrackPoints: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(maximumTrackPoints)) __obj.updateDynamic("maximumTrackPoints")(maximumTrackPoints.get.asInstanceOf[js.Any])
