...
@js.native
trait GeoJSONLayerLayerviewDestroyEvent extends js.Object {
...
object GeoJSONLayerLayerviewDestroyEvent {
  ...
  @scala.inline
  implicit class GeoJSONLayerLayerviewDestroyEventOps[Self <: GeoJSONLayerLayerviewDestroyEvent] (val x: Self) extends AnyVal {
    @scala.inline
