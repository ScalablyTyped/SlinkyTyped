...
trait PortalGroupProperties extends js.Object {
  /**
    ...
    */
  var access: js.UndefOr[`private` | typingsSlinky.arcgisJsApi.arcgisJsApiStrings.org | public] = js.undefined
  /**
...
object PortalGroupProperties {
  @scala.inline
  def apply(
    access: `private` | typingsSlinky.arcgisJsApi.arcgisJsApiStrings.org | public = null,
