...
object BuildingComponentSublayerCreatePopupTemplateOptions {
  ...
  @scala.inline
  implicit class BuildingComponentSublayerCreatePopupTemplateOptionsOps[Self <: BuildingComponentSublayerCreatePopupTemplateOptions] (val x: Self) extends AnyVal {
    @scala.inline
