...
@js.native
trait ColorSizeSliderThumbChangeEvent extends StObject {
...
object ColorSizeSliderThumbChangeEvent {
  ...
  @scala.inline
  implicit class ColorSizeSliderThumbChangeEventMutableBuilder[Self <: ColorSizeSliderThumbChangeEvent] (val x: Self) extends AnyVal {
