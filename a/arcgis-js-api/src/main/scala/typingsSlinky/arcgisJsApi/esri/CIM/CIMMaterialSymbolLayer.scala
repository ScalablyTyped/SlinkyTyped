...
trait CIMMaterialSymbolLayer
  ...
  @JSName("type")
  var type_CIMMaterialSymbolLayer: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialSymbolLayer = js.native
}
object CIMMaterialSymbolLayer {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialSymbolLayer): CIMMaterialSymbolLayer = {
  ...
  implicit class CIMMaterialSymbolLayerMutableBuilder[Self <: CIMMaterialSymbolLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialSymbolLayer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
