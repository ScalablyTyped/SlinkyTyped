...
trait opacityCreateVisualVariableParams extends Object {
  ...
  /**
    ...
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-smartMapping-renderers-opacity.html#createVisualVariable)
    */
  var legendOptions: js.UndefOr[opacityCreateVisualVariableParamsLegendOptions] = js.native
...
object opacityCreateVisualVariableParams {
  ...
  @scala.inline
  implicit class opacityCreateVisualVariableParamsOps[Self <: opacityCreateVisualVariableParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLegendOptions(value: opacityCreateVisualVariableParamsLegendOptions): Self = this.set("legendOptions", value.asInstanceOf[js.Any])
