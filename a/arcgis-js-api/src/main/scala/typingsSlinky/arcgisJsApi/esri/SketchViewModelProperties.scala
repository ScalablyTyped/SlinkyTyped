...
object SketchViewModelProperties {
  ...
  implicit class SketchViewModelPropertiesOps[Self <: SketchViewModelProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultCreateOptions(value: SketchViewModelDefaultCreateOptions): Self = {
    ...
    @scala.inline
    def withDefaultUpdateOptions(value: SketchViewModelDefaultUpdateOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPointSymbol(value: SimpleMarkerSymbolProperties | PointSymbol3DProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPolygonSymbol(value: SimpleFillSymbolProperties | PolygonSymbol3DProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPolylineSymbol(value: SimpleLineSymbolProperties | LineSymbol3DProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUpdateOnGraphicClick(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateOnGraphicClick")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutUpdateOnGraphicClick: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateOnGraphicClick")(js.undefined)
        ret
    }
    @scala.inline
