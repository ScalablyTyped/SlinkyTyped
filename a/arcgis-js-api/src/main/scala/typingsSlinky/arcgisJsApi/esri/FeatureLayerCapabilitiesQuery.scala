...
object FeatureLayerCapabilitiesQuery {
  ...
  implicit class FeatureLayerCapabilitiesQueryOps[Self <: FeatureLayerCapabilitiesQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxRecordCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxRecordCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportsCacheHint(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsCacheHint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
