...
object HeightModelInfoProperties {
  ...
  implicit class HeightModelInfoPropertiesOps[Self <: HeightModelInfoProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeightModel(value: `gravity-related-height` | ellipsoidal): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("heightModel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHeightModel: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("heightModel")(js.undefined)
        ret
    }
    @scala.inline
    def withHeightUnit(
    ...
    @scala.inline
    def withVertCRS(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vertCRS")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVertCRS: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vertCRS")(js.undefined)
        ret
    }
  }
