...
trait CIMObjectMarker3DLOD extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3DLOD = js.native
}
object CIMObjectMarker3DLOD {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3DLOD): CIMObjectMarker3DLOD = {
  ...
  implicit class CIMObjectMarker3DLODMutableBuilder[Self <: CIMObjectMarker3DLOD] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3DLOD): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
