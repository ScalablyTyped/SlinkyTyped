...
@js.native
trait ViewPointerUpEvent extends js.Object {
...
object ViewPointerUpEvent {
  ...
  @scala.inline
  implicit class ViewPointerUpEventOps[Self <: ViewPointerUpEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: `pointer-up`): Self = {
        val ret = this.duplicate
