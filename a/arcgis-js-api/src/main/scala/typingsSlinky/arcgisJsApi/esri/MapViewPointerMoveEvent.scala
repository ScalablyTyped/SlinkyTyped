...
@js.native
trait MapViewPointerMoveEvent extends StObject {
...
object MapViewPointerMoveEvent {
  ...
  @scala.inline
  implicit class MapViewPointerMoveEventMutableBuilder[Self <: MapViewPointerMoveEvent] (val x: Self) extends AnyVal {
