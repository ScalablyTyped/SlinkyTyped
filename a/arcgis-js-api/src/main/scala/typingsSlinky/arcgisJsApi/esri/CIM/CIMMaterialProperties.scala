...
trait CIMMaterialProperties extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialProperties = js.native
}
object CIMMaterialProperties {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialProperties): CIMMaterialProperties = {
  ...
  implicit class CIMMaterialPropertiesMutableBuilder[Self <: CIMMaterialProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMaterialProperties): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
