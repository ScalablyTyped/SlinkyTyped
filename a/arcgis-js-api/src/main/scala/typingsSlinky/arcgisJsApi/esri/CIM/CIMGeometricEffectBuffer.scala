...
trait CIMGeometricEffectBuffer
  ...
  @JSName("type")
  var type_CIMGeometricEffectBuffer: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectBuffer = js.native
}
object CIMGeometricEffectBuffer {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectBuffer): CIMGeometricEffectBuffer = {
  ...
  implicit class CIMGeometricEffectBufferMutableBuilder[Self <: CIMGeometricEffectBuffer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectBuffer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
