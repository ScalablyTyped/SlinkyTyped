...
trait CIMMarkerPlacementAtMeasuredUnits
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAtMeasuredUnits: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtMeasuredUnits = js.native
}
object CIMMarkerPlacementAtMeasuredUnits {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtMeasuredUnits): CIMMarkerPlacementAtMeasuredUnits = {
  ...
  implicit class CIMMarkerPlacementAtMeasuredUnitsMutableBuilder[Self <: CIMMarkerPlacementAtMeasuredUnits] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtMeasuredUnits): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
