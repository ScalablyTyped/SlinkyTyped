...
object univariateColorSizeCreateContinuousRendererParamsColorOptionsLegendOptions {
  ...
  @scala.inline
  implicit class univariateColorSizeCreateContinuousRendererParamsColorOptionsLegendOptionsOps[Self <: univariateColorSizeCreateContinuousRendererParamsColorOptionsLegendOptions] (val x: Self) extends AnyVal {
