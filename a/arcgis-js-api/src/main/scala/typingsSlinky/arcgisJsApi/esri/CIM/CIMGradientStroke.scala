...
trait CIMGradientStroke
  ...
  @JSName("type")
  var type_CIMGradientStroke: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientStroke = js.native
}
object CIMGradientStroke {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientStroke): CIMGradientStroke = {
  ...
  implicit class CIMGradientStrokeMutableBuilder[Self <: CIMGradientStroke] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientStroke): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
