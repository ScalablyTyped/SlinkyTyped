...
object MeshTextureProperties {
  ...
  implicit class MeshTexturePropertiesOps[Self <: MeshTextureProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataImageData(value: ImageData): Self = this.set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataHTMLImageElement(value: HTMLImageElement): Self = this.set("data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("data", value.asInstanceOf[js.Any])
