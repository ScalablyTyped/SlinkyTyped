...
trait CIMExpressionInfo extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMExpressionInfo = js.native
}
object CIMExpressionInfo {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMExpressionInfo): CIMExpressionInfo = {
  ...
  implicit class CIMExpressionInfoMutableBuilder[Self <: CIMExpressionInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMExpressionInfo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
