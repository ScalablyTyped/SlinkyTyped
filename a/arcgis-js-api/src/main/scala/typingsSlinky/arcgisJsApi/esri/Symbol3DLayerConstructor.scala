...
@js.native
trait Symbol3DLayerConstructor
  extends /**
  ...
  */
Instantiable0[Symbol3DLayer]
     with Instantiable1[/* properties */ Symbol3DLayerProperties, Symbol3DLayer] {
  
  def fromJSON(json: js.Any): Symbol3DLayer = js.native
}
