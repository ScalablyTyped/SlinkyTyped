...
trait CIMGeometricEffectLocalizerFeather
  ...
  @JSName("type")
  var type_CIMGeometricEffectLocalizerFeather: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectLocalizerFeather = js.native
...
object CIMGeometricEffectLocalizerFeather {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectLocalizerFeather): CIMGeometricEffectLocalizerFeather = {
  ...
  implicit class CIMGeometricEffectLocalizerFeatherMutableBuilder[Self <: CIMGeometricEffectLocalizerFeather] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectLocalizerFeather): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
