...
trait CIMMarkerGraphic extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerGraphic = js.native
}
object CIMMarkerGraphic {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerGraphic): CIMMarkerGraphic = {
  ...
  implicit class CIMMarkerGraphicMutableBuilder[Self <: CIMMarkerGraphic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerGraphic): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
