...
object AuthoringInfoField1 {
  ...
  implicit class AuthoringInfoField1Ops[Self <: AuthoringInfoField1] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClassBreakInfosVarargs(value: AuthoringInfoField1ClassBreakInfos*): Self = this.set("classBreakInfos", js.Array(value :_*))
    @scala.inline
    def setClassBreakInfos(value: js.Array[AuthoringInfoField1ClassBreakInfos]): Self = this.set("classBreakInfos", value.asInstanceOf[js.Any])
    @scala.inline
