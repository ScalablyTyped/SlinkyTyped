...
object AuthoringInfoField1 {
  ...
  @scala.inline
  implicit class AuthoringInfoField1MutableBuilder[Self <: AuthoringInfoField1] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setClassBreakInfos(value: js.Array[AuthoringInfoField1ClassBreakInfos]): Self = StObject.set(x, "classBreakInfos", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setClassBreakInfosUndefined: Self = StObject.set(x, "classBreakInfos", js.undefined)
    
    @scala.inline
    def setClassBreakInfosVarargs(value: AuthoringInfoField1ClassBreakInfos*): Self = StObject.set(x, "classBreakInfos", js.Array(value :_*))
