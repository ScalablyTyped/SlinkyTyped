...
object ZoomProperties {
  ...
  @scala.inline
  implicit class ZoomPropertiesOps[Self <: ZoomProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setViewModel(value: ZoomViewModelProperties): Self = this.set("viewModel", value.asInstanceOf[js.Any])
