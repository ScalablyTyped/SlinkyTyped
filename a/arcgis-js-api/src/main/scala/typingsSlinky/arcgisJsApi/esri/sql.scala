...
object sql {
  ...
  implicit class sqlOps[Self <: sql] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withParseWhereClause(value: (String, FieldsIndex) => js.Promise[WhereClause]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("parseWhereClause")(js.Any.fromFunction2(value))
        ret
    }
  }
