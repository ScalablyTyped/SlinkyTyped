...
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`search-clear`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`search-complete`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`search-start`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`select-result`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`suggest-complete`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`suggest-start`
...
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.searching
