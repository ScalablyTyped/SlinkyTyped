...
trait CIMMarkerPlacementAtExtremities
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAtExtremities: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities = js.native
}
object CIMMarkerPlacementAtExtremities {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities): CIMMarkerPlacementAtExtremities = {
  ...
  implicit class CIMMarkerPlacementAtExtremitiesMutableBuilder[Self <: CIMMarkerPlacementAtExtremities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
