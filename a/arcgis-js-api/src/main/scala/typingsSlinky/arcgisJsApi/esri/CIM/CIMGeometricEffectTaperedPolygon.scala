...
trait CIMGeometricEffectTaperedPolygon
  ...
  @JSName("type")
  var type_CIMGeometricEffectTaperedPolygon: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectTaperedPolygon = js.native
}
object CIMGeometricEffectTaperedPolygon {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectTaperedPolygon): CIMGeometricEffectTaperedPolygon = {
  ...
  implicit class CIMGeometricEffectTaperedPolygonMutableBuilder[Self <: CIMGeometricEffectTaperedPolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectTaperedPolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
