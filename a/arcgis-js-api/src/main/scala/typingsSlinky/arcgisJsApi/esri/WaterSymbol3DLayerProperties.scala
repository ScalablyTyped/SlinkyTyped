...
object WaterSymbol3DLayerProperties {
  ...
  implicit class WaterSymbol3DLayerPropertiesOps[Self <: WaterSymbol3DLayerProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWaterbodySize(value: small | medium | large): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waterbodySize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWaterbodySize: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waterbodySize")(js.undefined)
        ret
    }
    @scala.inline
    def withWaveDirection(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waveDirection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWaveDirection: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waveDirection")(js.undefined)
        ret
    }
    @scala.inline
    def withWaveStrength(value: calm | rippled | slight | moderate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waveStrength")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutWaveStrength: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("waveStrength")(js.undefined)
        ret
    }
  }
