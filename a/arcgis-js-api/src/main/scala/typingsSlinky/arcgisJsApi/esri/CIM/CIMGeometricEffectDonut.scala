...
trait CIMGeometricEffectDonut
  ...
  @JSName("type")
  var type_CIMGeometricEffectDonut: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDonut = js.native
...
object CIMGeometricEffectDonut {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDonut): CIMGeometricEffectDonut = {
  ...
  implicit class CIMGeometricEffectDonutMutableBuilder[Self <: CIMGeometricEffectDonut] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDonut): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
