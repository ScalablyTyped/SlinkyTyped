...
trait CIMGeometricEffectDashes
  ...
  @JSName("type")
  var type_CIMGeometricEffectDashes: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDashes = js.native
}
object CIMGeometricEffectDashes {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDashes): CIMGeometricEffectDashes = {
  ...
  implicit class CIMGeometricEffectDashesMutableBuilder[Self <: CIMGeometricEffectDashes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDashes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
