...
object MeshMaterialProperties {
  ...
  implicit class MeshMaterialPropertiesMutableBuilder[Self <: MeshMaterialProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColorTextureHTMLCanvasElement(value: HTMLCanvasElement): Self = StObject.set(x, "colorTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorTextureHTMLImageElement(value: HTMLImageElement): Self = StObject.set(x, "colorTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorTextureImageData(value: ImageData): Self = StObject.set(x, "colorTexture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNormalTextureHTMLCanvasElement(value: HTMLCanvasElement): Self = StObject.set(x, "normalTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNormalTextureHTMLImageElement(value: HTMLImageElement): Self = StObject.set(x, "normalTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNormalTextureImageData(value: ImageData): Self = StObject.set(x, "normalTexture", value.asInstanceOf[js.Any])
