...
object MeshProperties {
  ...
  implicit class MeshPropertiesOps[Self <: MeshProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComponents(value: js.Array[MeshComponentProperties]): Self = {
    ...
    @scala.inline
    def withVertexAttributes(value: MeshVertexAttributesProperties): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vertexAttributes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutVertexAttributes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("vertexAttributes")(js.undefined)
        ret
    }
  }
