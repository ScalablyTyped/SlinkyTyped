...
object PredominanceSchemeForPolyline {
  ...
  @scala.inline
  implicit class PredominanceSchemeForPolylineOps[Self <: PredominanceSchemeForPolyline] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSizeScheme(value: SizeSchemeForPolyline): Self = this.set("sizeScheme", value.asInstanceOf[js.Any])
    @scala.inline
