...
trait CIMPointSymbol
  ...
  @JSName("type")
  var type_CIMPointSymbol: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol = js.native
}
object CIMPointSymbol {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol): CIMPointSymbol = {
  ...
  implicit class CIMPointSymbolMutableBuilder[Self <: CIMPointSymbol] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
