...
object SpatialReferenceProperties {
  ...
  implicit class SpatialReferencePropertiesOps[Self <: SpatialReferenceProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImageCoordinateSystem(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageCoordinateSystem")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutImageCoordinateSystem: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageCoordinateSystem")(js.undefined)
        ret
    }
    @scala.inline
