...
object AreaMeasurement3DProperties {
  ...
  @scala.inline
  implicit class AreaMeasurement3DPropertiesOps[Self <: AreaMeasurement3DProperties] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setViewModel(value: AreaMeasurement3DViewModelProperties): Self = this.set("viewModel", value.asInstanceOf[js.Any])
    @scala.inline
