...
trait CIMSolidStroke
  ...
  @JSName("type")
  var type_CIMSolidStroke: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSolidStroke = js.native
}
object CIMSolidStroke {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSolidStroke): CIMSolidStroke = {
  ...
  implicit class CIMSolidStrokeMutableBuilder[Self <: CIMSolidStroke] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSolidStroke): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
