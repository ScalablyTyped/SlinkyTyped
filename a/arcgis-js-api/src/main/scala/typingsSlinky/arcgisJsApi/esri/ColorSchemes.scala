...
object ColorSchemes {
  ...
  implicit class ColorSchemesOps[Self <: ColorSchemes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryScheme(value: ColorScheme): Self = this.set("primaryScheme", value.asInstanceOf[js.Any])
    @scala.inline
    def setSecondarySchemesVarargs(value: ColorScheme*): Self = this.set("secondarySchemes", js.Array(value :_*))
    @scala.inline
    def setSecondarySchemes(value: js.Array[ColorScheme]): Self = this.set("secondarySchemes", value.asInstanceOf[js.Any])
  }
