...
object MeshMaterialMetallicRoughnessProperties {
  ...
  implicit class MeshMaterialMetallicRoughnessPropertiesOps[Self <: MeshMaterialMetallicRoughnessProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEmissiveTextureImageData(value: ImageData): Self = this.set("emissiveTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmissiveTextureHTMLImageElement(value: HTMLImageElement): Self = this.set("emissiveTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEmissiveTextureHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("emissiveTexture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMetallicRoughnessTextureImageData(value: ImageData): Self = this.set("metallicRoughnessTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetallicRoughnessTextureHTMLImageElement(value: HTMLImageElement): Self = this.set("metallicRoughnessTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetallicRoughnessTextureHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("metallicRoughnessTexture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOcclusionTextureImageData(value: ImageData): Self = this.set("occlusionTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOcclusionTextureHTMLImageElement(value: HTMLImageElement): Self = this.set("occlusionTexture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOcclusionTextureHTMLCanvasElement(value: HTMLCanvasElement): Self = this.set("occlusionTexture", value.asInstanceOf[js.Any])
