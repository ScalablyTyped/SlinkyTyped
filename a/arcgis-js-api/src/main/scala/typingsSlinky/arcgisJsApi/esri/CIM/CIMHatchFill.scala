...
trait CIMHatchFill
  ...
  @JSName("type")
  var type_CIMHatchFill: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMHatchFill = js.native
}
object CIMHatchFill {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMHatchFill): CIMHatchFill = {
  ...
  implicit class CIMHatchFillMutableBuilder[Self <: CIMHatchFill] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMHatchFill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
