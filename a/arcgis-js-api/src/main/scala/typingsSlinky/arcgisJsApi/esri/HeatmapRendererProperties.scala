...
object HeatmapRendererProperties {
  ...
  implicit class HeatmapRendererPropertiesOps[Self <: HeatmapRendererProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColorStops(value: js.Array[HeatmapColorStopProperties]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMaxPixelIntensity(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxPixelIntensity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMaxPixelIntensity: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maxPixelIntensity")(js.undefined)
        ret
    }
    @scala.inline
    def withMinPixelIntensity(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minPixelIntensity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMinPixelIntensity: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minPixelIntensity")(js.undefined)
        ret
    }
  }
