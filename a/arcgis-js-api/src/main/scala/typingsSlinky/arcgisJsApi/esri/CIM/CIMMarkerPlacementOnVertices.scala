...
trait CIMMarkerPlacementOnVertices
  ...
  @JSName("type")
  var type_CIMMarkerPlacementOnVertices: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementOnVertices = js.native
}
object CIMMarkerPlacementOnVertices {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementOnVertices): CIMMarkerPlacementOnVertices = {
  ...
  implicit class CIMMarkerPlacementOnVerticesMutableBuilder[Self <: CIMMarkerPlacementOnVertices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementOnVertices): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
