...
@js.native
trait SmartMappingSliderBaseThumbChangeEvent extends js.Object {
...
object SmartMappingSliderBaseThumbChangeEvent {
  ...
  @scala.inline
  implicit class SmartMappingSliderBaseThumbChangeEventOps[Self <: SmartMappingSliderBaseThumbChangeEvent] (val x: Self) extends AnyVal {
