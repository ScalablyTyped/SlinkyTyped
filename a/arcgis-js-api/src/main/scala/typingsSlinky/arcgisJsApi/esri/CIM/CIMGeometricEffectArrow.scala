...
trait CIMGeometricEffectArrow
  ...
  @JSName("type")
  var type_CIMGeometricEffectArrow: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectArrow = js.native
...
object CIMGeometricEffectArrow {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectArrow): CIMGeometricEffectArrow = {
  ...
  implicit class CIMGeometricEffectArrowMutableBuilder[Self <: CIMGeometricEffectArrow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectArrow): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
