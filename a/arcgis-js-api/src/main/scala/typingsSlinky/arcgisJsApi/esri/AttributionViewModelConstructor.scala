...
@js.native
trait AttributionViewModelConstructor
  extends /**
  ...
  */
Instantiable0[AttributionViewModel]
     with Instantiable1[/* properties */ AttributionViewModelProperties, AttributionViewModel]
