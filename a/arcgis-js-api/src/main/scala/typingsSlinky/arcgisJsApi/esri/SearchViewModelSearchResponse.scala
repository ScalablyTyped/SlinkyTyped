...
object SearchViewModelSearchResponse {
  ...
  @scala.inline
  implicit class SearchViewModelSearchResponseOps[Self <: SearchViewModelSearchResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResultsVarargs(value: SearchViewModelSearchResponseResults*): Self = this.set("results", js.Array(value :_*))
    @scala.inline
    def setResults(value: js.Array[SearchViewModelSearchResponseResults]): Self = this.set("results", value.asInstanceOf[js.Any])
    @scala.inline
