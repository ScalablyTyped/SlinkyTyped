...
object QueryQuantizationParameters {
  ...
  implicit class QueryQuantizationParametersOps[Self <: QueryQuantizationParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMode(value: view | edit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOriginPosition(value: `upper-left` | `lower-left`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("originPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOriginPosition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("originPosition")(js.undefined)
        ret
    }
    @scala.inline
