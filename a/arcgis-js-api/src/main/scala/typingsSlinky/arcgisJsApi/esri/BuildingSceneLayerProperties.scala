...
object BuildingSceneLayerProperties {
  ...
  implicit class BuildingSceneLayerPropertiesOps[Self <: BuildingSceneLayerProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveFilterId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeFilterId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutActiveFilterId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activeFilterId")(js.undefined)
        ret
    }
    @scala.inline
    def withElevationInfo(value: BuildingSceneLayerElevationInfo): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFilters(value: CollectionProperties[BuildingFilterProperties]): Self = {
        val ret = this.duplicate
