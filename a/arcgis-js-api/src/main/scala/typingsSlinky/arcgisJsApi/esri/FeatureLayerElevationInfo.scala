...
object FeatureLayerElevationInfo {
  ...
  @scala.inline
  implicit class FeatureLayerElevationInfoMutableBuilder[Self <: FeatureLayerElevationInfo] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFeatureExpressionInfo(value: FeatureLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
