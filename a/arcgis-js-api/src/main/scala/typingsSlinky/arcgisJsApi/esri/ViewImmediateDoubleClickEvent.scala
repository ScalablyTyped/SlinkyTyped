...
@js.native
trait ViewImmediateDoubleClickEvent extends js.Object {
...
object ViewImmediateDoubleClickEvent {
  ...
  @scala.inline
  implicit class ViewImmediateDoubleClickEventOps[Self <: ViewImmediateDoubleClickEvent] (val x: Self) extends AnyVal {
    @scala.inline
