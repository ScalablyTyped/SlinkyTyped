...
object GamepadSettingsProperties {
  ...
  implicit class GamepadSettingsPropertiesOps[Self <: GamepadSettingsProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnabledFocusMode(value: document | view | none): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enabledFocusMode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEnabledFocusMode: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enabledFocusMode")(js.undefined)
        ret
    }
  }
