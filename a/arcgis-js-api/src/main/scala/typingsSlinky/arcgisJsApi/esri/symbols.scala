...
object symbols extends js.Object {
  ...
  */
  ...
  type Font = typingsSlinky.arcgisJsApi.esri.Font
  
  type IconSymbol3DLayer = typingsSlinky.arcgisJsApi.esri.IconSymbol3DLayer
  
  type LabelSymbol3D = typingsSlinky.arcgisJsApi.esri.LabelSymbol3D
  ...
  type ObjectSymbol3DLayer = typingsSlinky.arcgisJsApi.esri.ObjectSymbol3DLayer
  
  type PathSymbol3DLayer = typingsSlinky.arcgisJsApi.esri.PathSymbol3DLayer
  
  type PictureFillSymbol = typingsSlinky.arcgisJsApi.esri.PictureFillSymbol
  
  type PictureMarkerSymbol = typingsSlinky.arcgisJsApi.esri.PictureMarkerSymbol
  
  type PointSymbol3D = typingsSlinky.arcgisJsApi.esri.PointSymbol3D
  
  type PolygonSymbol3D = typingsSlinky.arcgisJsApi.esri.PolygonSymbol3D
  
  type SimpleFillSymbol = typingsSlinky.arcgisJsApi.esri.SimpleFillSymbol
  ...
  type TextSymbol3DLayer = typingsSlinky.arcgisJsApi.esri.TextSymbol3DLayer
  
  type WaterSymbol3DLayer = typingsSlinky.arcgisJsApi.esri.WaterSymbol3DLayer
  
  type WebStyleSymbol = typingsSlinky.arcgisJsApi.esri.WebStyleSymbol
}
