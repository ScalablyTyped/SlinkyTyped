...
object LocationSchemes {
  ...
  implicit class LocationSchemesOps[Self <: LocationSchemes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryScheme(value: LocationScheme): Self = this.set("primaryScheme", value.asInstanceOf[js.Any])
    @scala.inline
    def setSecondarySchemesVarargs(value: LocationScheme*): Self = this.set("secondarySchemes", js.Array(value :_*))
    @scala.inline
    def setSecondarySchemes(value: js.Array[LocationScheme]): Self = this.set("secondarySchemes", value.asInstanceOf[js.Any])
  }
