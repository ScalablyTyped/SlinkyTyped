...
@js.native
trait OGCFeatureLayerLayerviewCreateEvent extends js.Object {
...
object OGCFeatureLayerLayerviewCreateEvent {
  ...
  @scala.inline
  implicit class OGCFeatureLayerLayerviewCreateEventOps[Self <: OGCFeatureLayerLayerviewCreateEvent] (val x: Self) extends AnyVal {
    @scala.inline
