...
@js.native
trait SceneViewImmediateDoubleClickEvent extends StObject {
...
object SceneViewImmediateDoubleClickEvent {
  ...
  @scala.inline
  implicit class SceneViewImmediateDoubleClickEventMutableBuilder[Self <: SceneViewImmediateDoubleClickEvent] (val x: Self) extends AnyVal {
