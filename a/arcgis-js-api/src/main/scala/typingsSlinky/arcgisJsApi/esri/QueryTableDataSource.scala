...
object QueryTableDataSource {
  ...
  implicit class QueryTableDataSourceOps[Self <: QueryTableDataSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGeometryType(value: point | multipoint | polyline | polygon | multipatch): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("geometryType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOidFields(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("oidFields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withType(value: `query-table`): Self = {
        val ret = this.duplicate
