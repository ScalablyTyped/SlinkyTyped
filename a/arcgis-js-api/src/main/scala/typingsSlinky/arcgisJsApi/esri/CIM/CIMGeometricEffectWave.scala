...
trait CIMGeometricEffectWave
  ...
  @JSName("type")
  var type_CIMGeometricEffectWave: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectWave = js.native
...
object CIMGeometricEffectWave {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectWave): CIMGeometricEffectWave = {
  ...
  implicit class CIMGeometricEffectWaveMutableBuilder[Self <: CIMGeometricEffectWave] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectWave): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
