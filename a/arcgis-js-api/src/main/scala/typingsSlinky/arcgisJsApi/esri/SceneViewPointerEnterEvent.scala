...
@js.native
trait SceneViewPointerEnterEvent extends StObject {
...
object SceneViewPointerEnterEvent {
  ...
  @scala.inline
  implicit class SceneViewPointerEnterEventMutableBuilder[Self <: SceneViewPointerEnterEvent] (val x: Self) extends AnyVal {
