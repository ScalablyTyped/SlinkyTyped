...
object scheduling {
  ...
  implicit class schedulingOps[Self <: scheduling] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddFrameTask(value: PhaseCallbacks => FrameTaskHandle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addFrameTask")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSchedule(value: js.Function => js.Any): Self = {
        val ret = this.duplicate
