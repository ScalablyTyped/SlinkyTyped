...
object EditFieldsInfo {
  ...
  implicit class EditFieldsInfoOps[Self <: EditFieldsInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreationDateField(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("creationDateField")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreatorField(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("creatorField")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEditDateField(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("editDateField")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEditorField(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("editorField")(value.asInstanceOf[js.Any])
        ret
    }
  }
