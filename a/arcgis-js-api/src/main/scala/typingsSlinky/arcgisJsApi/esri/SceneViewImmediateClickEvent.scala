...
@js.native
trait SceneViewImmediateClickEvent extends StObject {
...
object SceneViewImmediateClickEvent {
  ...
  @scala.inline
  implicit class SceneViewImmediateClickEventMutableBuilder[Self <: SceneViewImmediateClickEvent] (val x: Self) extends AnyVal {
