...
trait CIMGeometricEffectExtension
  ...
  @JSName("type")
  var type_CIMGeometricEffectExtension: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectExtension = js.native
}
object CIMGeometricEffectExtension {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectExtension): CIMGeometricEffectExtension = {
  ...
  implicit class CIMGeometricEffectExtensionMutableBuilder[Self <: CIMGeometricEffectExtension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectExtension): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
