...
import typingsSlinky.arcgisJsApi.AnonItems
import typingsSlinky.arcgisJsApi.IHandle
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`after-add`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`after-changes`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`after-remove`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`before-add`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`before-changes`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.`before-remove`
import typingsSlinky.arcgisJsApi.arcgisJsApiStrings.change
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsSlinky.arcgisJsApi.esri.Evented because Inheritance from two classes. Inlined emit, emit, hasEventListener, on, on */ @JSGlobal("__esri.Collection")
@js.native
