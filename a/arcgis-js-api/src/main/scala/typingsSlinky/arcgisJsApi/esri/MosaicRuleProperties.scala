...
object MosaicRuleProperties {
  ...
  implicit class MosaicRulePropertiesOps[Self <: MosaicRuleProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItemRenderingRule(value: RasterFunctionProperties): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("itemRenderingRule")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutItemRenderingRule: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("itemRenderingRule")(js.undefined)
        ret
    }
    @scala.inline
    def withLockRasterIds(value: js.Array[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lockRasterIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutLockRasterIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("lockRasterIds")(js.undefined)
        ret
    }
    @scala.inline
    def withMethod(value: none | center | nadir | viewpoint | attribute | `lock-raster` | northwest | seamline): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMultidimensionalDefinition(value: js.Array[DimensionalDefinitionProperties]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multidimensionalDefinition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMultidimensionalDefinition: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("multidimensionalDefinition")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOperation(value: first | last | min | max | mean | blend | sum): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSortValue(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sortValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSortValue: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sortValue")(js.undefined)
        ret
    }
    @scala.inline
    def withViewpoint(value: PointProperties): Self = {
        val ret = this.duplicate
