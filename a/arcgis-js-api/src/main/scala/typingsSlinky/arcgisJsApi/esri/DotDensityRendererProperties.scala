...
object DotDensityRendererProperties {
  ...
  implicit class DotDensityRendererPropertiesOps[Self <: DotDensityRendererProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttributes(value: js.Array[AttributeColorInfoProperties]): Self = {
    ...
    @scala.inline
    def withDotValue(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dotValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDotValue: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dotValue")(js.undefined)
        ret
    }
    @scala.inline
    def withLegendOptions(value: DotDensityRendererLegendOptions): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReferenceScale(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("referenceScale")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutReferenceScale: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("referenceScale")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withVisualVariables(value: js.Array[VisualVariableProperties]): Self = {
        val ret = this.duplicate
