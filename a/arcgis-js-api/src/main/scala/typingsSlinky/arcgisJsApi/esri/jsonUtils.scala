...
object jsonUtils {
  ...
  implicit class jsonUtilsOps[Self <: jsonUtils] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFromJSON(value: js.Any => Geometry_): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fromJSON")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetJsonType(value: Geometry_ => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getJsonType")(js.Any.fromFunction1(value))
        ret
    }
  }
