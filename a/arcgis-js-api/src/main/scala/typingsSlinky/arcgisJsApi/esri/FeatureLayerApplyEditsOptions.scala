...
object FeatureLayerApplyEditsOptions {
  ...
  implicit class FeatureLayerApplyEditsOptionsOps[Self <: FeatureLayerApplyEditsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGlobalIdUsed(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("globalIdUsed")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutGlobalIdUsed: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("globalIdUsed")(js.undefined)
        ret
    }
    @scala.inline
    def withRollbackOnFailureEnabled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rollbackOnFailureEnabled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRollbackOnFailureEnabled: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rollbackOnFailureEnabled")(js.undefined)
        ret
    }
  }
