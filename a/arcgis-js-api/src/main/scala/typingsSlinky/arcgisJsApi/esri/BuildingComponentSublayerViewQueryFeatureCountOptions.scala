...
@js.native
trait BuildingComponentSublayerViewQueryFeatureCountOptions extends Object {
...
object BuildingComponentSublayerViewQueryFeatureCountOptions {
  ...
  @scala.inline
  implicit class BuildingComponentSublayerViewQueryFeatureCountOptionsMutableBuilder[Self <: BuildingComponentSublayerViewQueryFeatureCountOptions] (val x: Self) extends AnyVal {
