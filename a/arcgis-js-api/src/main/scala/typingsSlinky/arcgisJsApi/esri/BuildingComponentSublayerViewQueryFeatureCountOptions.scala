...
object BuildingComponentSublayerViewQueryFeatureCountOptions {
  ...
  @scala.inline
  implicit class BuildingComponentSublayerViewQueryFeatureCountOptionsOps[Self <: BuildingComponentSublayerViewQueryFeatureCountOptions] (val x: Self) extends AnyVal {
