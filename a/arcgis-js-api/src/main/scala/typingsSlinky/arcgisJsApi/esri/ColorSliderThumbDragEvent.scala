...
@js.native
trait ColorSliderThumbDragEvent extends StObject {
...
object ColorSliderThumbDragEvent {
  ...
  @scala.inline
  implicit class ColorSliderThumbDragEventMutableBuilder[Self <: ColorSliderThumbDragEvent] (val x: Self) extends AnyVal {
