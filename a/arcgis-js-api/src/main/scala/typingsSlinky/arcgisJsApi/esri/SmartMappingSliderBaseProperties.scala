...
object SmartMappingSliderBaseProperties {
  ...
  implicit class SmartMappingSliderBasePropertiesOps[Self <: SmartMappingSliderBaseProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHistogramConfig(value: HistogramConfig): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("histogramConfig")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHistogramConfig: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("histogramConfig")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withZoomOptions(value: SmartMappingSliderBaseZoomOptions): Self = {
        val ret = this.duplicate
