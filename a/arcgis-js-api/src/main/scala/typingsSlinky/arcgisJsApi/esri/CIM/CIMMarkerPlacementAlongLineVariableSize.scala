...
trait CIMMarkerPlacementAlongLineVariableSize
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAlongLineVariableSize: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineVariableSize = js.native
...
object CIMMarkerPlacementAlongLineVariableSize {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineVariableSize): CIMMarkerPlacementAlongLineVariableSize = {
  ...
  implicit class CIMMarkerPlacementAlongLineVariableSizeMutableBuilder[Self <: CIMMarkerPlacementAlongLineVariableSize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineVariableSize): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
