...
@js.native
trait OpacitySliderThumbDragEvent extends StObject {
...
object OpacitySliderThumbDragEvent {
  ...
  @scala.inline
  implicit class OpacitySliderThumbDragEventMutableBuilder[Self <: OpacitySliderThumbDragEvent] (val x: Self) extends AnyVal {
