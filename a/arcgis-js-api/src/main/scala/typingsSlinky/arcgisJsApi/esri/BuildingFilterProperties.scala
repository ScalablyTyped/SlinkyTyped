...
object BuildingFilterProperties {
  ...
  implicit class BuildingFilterPropertiesOps[Self <: BuildingFilterProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFilterBlocks(value: CollectionProperties[BuildingFilterBlock]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterBlocks")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFilterBlocks: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("filterBlocks")(js.undefined)
        ret
    }
    @scala.inline
