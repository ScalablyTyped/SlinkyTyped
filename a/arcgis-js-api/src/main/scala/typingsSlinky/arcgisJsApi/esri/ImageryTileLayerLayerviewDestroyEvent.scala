...
@js.native
trait ImageryTileLayerLayerviewDestroyEvent extends js.Object {
...
object ImageryTileLayerLayerviewDestroyEvent {
  ...
  @scala.inline
  implicit class ImageryTileLayerLayerviewDestroyEventOps[Self <: ImageryTileLayerLayerviewDestroyEvent] (val x: Self) extends AnyVal {
