...
trait CIMGradientFill
  ...
  @JSName("type")
  var type_CIMGradientFill: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientFill = js.native
}
object CIMGradientFill {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientFill): CIMGradientFill = {
  ...
  implicit class CIMGradientFillMutableBuilder[Self <: CIMGradientFill] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGradientFill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
