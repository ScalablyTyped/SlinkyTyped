...
object MapViewPointerDownEvent {
  ...
  @scala.inline
  implicit class MapViewPointerDownEventOps[Self <: MapViewPointerDownEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: `pointer-down`): Self = this.set("type", value.asInstanceOf[js.Any])
