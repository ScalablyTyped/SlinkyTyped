...
@js.native
trait MapViewPointerDownEvent extends StObject {
  ...
  var `type`: `pointer-down` = js.native
...
object MapViewPointerDownEvent {
  ...
  @scala.inline
  implicit class MapViewPointerDownEventMutableBuilder[Self <: MapViewPointerDownEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: `pointer-down`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
