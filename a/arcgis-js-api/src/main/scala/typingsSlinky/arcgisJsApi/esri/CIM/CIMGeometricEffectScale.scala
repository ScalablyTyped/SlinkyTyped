...
trait CIMGeometricEffectScale
  ...
  @JSName("type")
  var type_CIMGeometricEffectScale: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectScale = js.native
}
object CIMGeometricEffectScale {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectScale): CIMGeometricEffectScale = {
  ...
  implicit class CIMGeometricEffectScaleMutableBuilder[Self <: CIMGeometricEffectScale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectScale): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
