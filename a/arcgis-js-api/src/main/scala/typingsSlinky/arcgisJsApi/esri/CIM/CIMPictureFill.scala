...
trait CIMPictureFill
  ...
  @JSName("type")
  var type_CIMPictureFill: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPictureFill = js.native
...
object CIMPictureFill {
  ...
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPictureFill): CIMPictureFill = {
  ...
  implicit class CIMPictureFillMutableBuilder[Self <: CIMPictureFill] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMPictureFill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
