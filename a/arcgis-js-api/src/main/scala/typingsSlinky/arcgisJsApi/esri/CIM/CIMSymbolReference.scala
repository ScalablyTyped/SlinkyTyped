...
trait CIMSymbolReference extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSymbolReference = js.native
}
object CIMSymbolReference {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSymbolReference): CIMSymbolReference = {
  ...
  implicit class CIMSymbolReferenceMutableBuilder[Self <: CIMSymbolReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMSymbolReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
