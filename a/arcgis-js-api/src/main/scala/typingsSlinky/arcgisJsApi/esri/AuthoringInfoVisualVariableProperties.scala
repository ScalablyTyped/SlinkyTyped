...
object AuthoringInfoVisualVariableProperties {
  ...
  def apply(
    ...
    `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.color | typingsSlinky.arcgisJsApi.arcgisJsApiStrings.size | typingsSlinky.arcgisJsApi.arcgisJsApiStrings.opacity = null,
