...
@js.native
trait BuildingSceneLayerConstructor
  extends /**
  ...
  */
Instantiable0[BuildingSceneLayer]
     with Instantiable1[/* properties */ BuildingSceneLayerProperties, BuildingSceneLayer] {
  
  def fromJSON(json: js.Any): BuildingSceneLayer = js.native
}
