...
trait CIMGeometricEffectEnclosingPolygon
  ...
  @JSName("type")
  var type_CIMGeometricEffectEnclosingPolygon: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectEnclosingPolygon = js.native
}
object CIMGeometricEffectEnclosingPolygon {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectEnclosingPolygon): CIMGeometricEffectEnclosingPolygon = {
  ...
  implicit class CIMGeometricEffectEnclosingPolygonMutableBuilder[Self <: CIMGeometricEffectEnclosingPolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectEnclosingPolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
