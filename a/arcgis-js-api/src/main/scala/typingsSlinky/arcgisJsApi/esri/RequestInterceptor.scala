...
object RequestInterceptor {
  ...
  implicit class RequestInterceptorOps[Self <: RequestInterceptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrlsVarargs(value: (String | js.RegExp)*): Self = this.set("urls", js.Array(value :_*))
    
    @scala.inline
    def setUrlsRegExp(value: js.RegExp): Self = this.set("urls", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUrls(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = this.set("urls", value.asInstanceOf[js.Any])
