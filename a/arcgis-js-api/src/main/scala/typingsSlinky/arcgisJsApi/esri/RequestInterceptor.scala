...
object RequestInterceptor {
  ...
  implicit class RequestInterceptorMutableBuilder[Self <: RequestInterceptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrls(value: String | js.RegExp | (js.Array[String | js.RegExp])): Self = StObject.set(x, "urls", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUrlsRegExp(value: js.RegExp): Self = StObject.set(x, "urls", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUrlsUndefined: Self = StObject.set(x, "urls", js.undefined)
    
    @scala.inline
    def setUrlsVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "urls", js.Array(value :_*))
  }
}
