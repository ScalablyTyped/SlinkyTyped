...
trait CIMShapeVertices extends StObject {
  ...
  var `type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMShapeVertices = js.native
}
object CIMShapeVertices {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMShapeVertices): CIMShapeVertices = {
  ...
  implicit class CIMShapeVerticesMutableBuilder[Self <: CIMShapeVertices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMShapeVertices): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
