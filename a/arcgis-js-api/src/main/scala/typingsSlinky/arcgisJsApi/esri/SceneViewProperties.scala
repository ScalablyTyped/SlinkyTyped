...
object SceneViewProperties {
  ...
  implicit class SceneViewPropertiesOps[Self <: SceneViewProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlphaCompositingEnabled(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alphaCompositingEnabled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAlphaCompositingEnabled: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alphaCompositingEnabled")(js.undefined)
        ret
    }
    @scala.inline
    def withCamera(value: CameraProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withConstraints(value: SceneViewConstraintsProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withEnvironment(value: SceneViewEnvironmentProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHighlightOptions(value: SceneViewHighlightOptionsProperties): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withQualityProfile(value: low | medium | high): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qualityProfile")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQualityProfile: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("qualityProfile")(js.undefined)
        ret
    }
    @scala.inline
