...
object SearchViewModelSearchResponseResults {
  ...
  @scala.inline
  implicit class SearchViewModelSearchResponseResultsOps[Self <: SearchViewModelSearchResponseResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResultsVarargs(value: SearchViewModelSearchResult*): Self = this.set("results", js.Array(value :_*))
    
    @scala.inline
    def setResults(value: js.Array[SearchViewModelSearchResult]): Self = this.set("results", value.asInstanceOf[js.Any])
