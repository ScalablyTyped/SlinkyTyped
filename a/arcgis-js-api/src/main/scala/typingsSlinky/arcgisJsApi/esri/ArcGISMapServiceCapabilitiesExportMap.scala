...
object ArcGISMapServiceCapabilitiesExportMap {
  ...
  implicit class ArcGISMapServiceCapabilitiesExportMapOps[Self <: ArcGISMapServiceCapabilitiesExportMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSupportsDynamicLayers(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsDynamicLayers")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportsModification(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsModification")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportsSublayerDefinitionExpression(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsSublayerDefinitionExpression")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportsSublayerVisibility(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsSublayerVisibility")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportsSublayersChanges(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsSublayersChanges")(value.asInstanceOf[js.Any])
        ret
    }
  }
