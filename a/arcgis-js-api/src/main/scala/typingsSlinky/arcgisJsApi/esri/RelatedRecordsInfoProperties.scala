...
object RelatedRecordsInfoProperties {
  ...
  implicit class RelatedRecordsInfoPropertiesOps[Self <: RelatedRecordsInfoProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOrderByFields(value: js.Array[RelatedRecordsInfoFieldOrderProperties]): Self = {
    ...
    @scala.inline
    def withShowRelatedRecords(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showRelatedRecords")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutShowRelatedRecords: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("showRelatedRecords")(js.undefined)
        ret
    }
  }
