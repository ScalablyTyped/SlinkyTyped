...
trait CIMGeometricEffectJog
  ...
  @JSName("type")
  var type_CIMGeometricEffectJog: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectJog = js.native
}
object CIMGeometricEffectJog {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectJog): CIMGeometricEffectJog = {
  ...
  implicit class CIMGeometricEffectJogMutableBuilder[Self <: CIMGeometricEffectJog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectJog): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
