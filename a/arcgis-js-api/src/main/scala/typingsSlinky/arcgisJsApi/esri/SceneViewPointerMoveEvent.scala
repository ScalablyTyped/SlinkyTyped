...
@js.native
trait SceneViewPointerMoveEvent extends StObject {
...
object SceneViewPointerMoveEvent {
  ...
  @scala.inline
  implicit class SceneViewPointerMoveEventMutableBuilder[Self <: SceneViewPointerMoveEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: `pointer-move`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
