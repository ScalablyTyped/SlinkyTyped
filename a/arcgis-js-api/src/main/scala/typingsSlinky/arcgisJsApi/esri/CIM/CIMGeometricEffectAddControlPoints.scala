...
trait CIMGeometricEffectAddControlPoints
  ...
  @JSName("type")
  var type_CIMGeometricEffectAddControlPoints: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectAddControlPoints = js.native
}
object CIMGeometricEffectAddControlPoints {
  
  @scala.inline
  def apply(`type`: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectAddControlPoints): CIMGeometricEffectAddControlPoints = {
  ...
  implicit class CIMGeometricEffectAddControlPointsMutableBuilder[Self <: CIMGeometricEffectAddControlPoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectAddControlPoints): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
