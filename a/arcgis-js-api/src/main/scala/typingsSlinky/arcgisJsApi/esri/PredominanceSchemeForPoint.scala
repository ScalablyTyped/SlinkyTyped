...
object PredominanceSchemeForPoint {
  ...
  implicit class PredominanceSchemeForPointOps[Self <: PredominanceSchemeForPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutline(value: PredominanceSchemeForPointOutline): Self = this.set("outline", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSizeScheme(value: SizeSchemeForPoint): Self = this.set("sizeScheme", value.asInstanceOf[js.Any])
