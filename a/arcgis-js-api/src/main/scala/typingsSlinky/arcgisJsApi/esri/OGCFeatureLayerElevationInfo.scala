...
object OGCFeatureLayerElevationInfo {
  ...
  @scala.inline
  implicit class OGCFeatureLayerElevationInfoMutableBuilder[Self <: OGCFeatureLayerElevationInfo] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFeatureExpressionInfo(value: OGCFeatureLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
