...
@js.native
trait WCSLayerLayerviewCreateEvent extends js.Object {
...
object WCSLayerLayerviewCreateEvent {
  ...
  @scala.inline
  implicit class WCSLayerLayerviewCreateEventOps[Self <: WCSLayerLayerviewCreateEvent] (val x: Self) extends AnyVal {
