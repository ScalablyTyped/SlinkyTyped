...
object RelationshipSchemeForPoint {
  ...
  implicit class RelationshipSchemeForPointOps[Self <: RelationshipSchemeForPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColorsForClassBreaks(value: js.Array[RelationshipSchemeForPointColorsForClassBreaks]): Self = {
    ...
    @scala.inline
    def withOutline(value: RelationshipSchemeForPointOutline): Self = {
        val ret = this.duplicate
