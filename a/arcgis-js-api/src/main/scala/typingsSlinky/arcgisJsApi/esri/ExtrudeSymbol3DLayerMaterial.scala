...
object ExtrudeSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.UndefOr[
      js.Function2[/* propertyName */ String, /* value */ js.Any, ExtrudeSymbol3DLayerMaterial]
    ]) with (js.UndefOr[js.Function1[/* props */ HashMap[_], ExtrudeSymbol3DLayerMaterial]])
  ...
  @scala.inline
  implicit class ExtrudeSymbol3DLayerMaterialMutableBuilder[Self <: ExtrudeSymbol3DLayerMaterial] (val x: Self) extends AnyVal {
