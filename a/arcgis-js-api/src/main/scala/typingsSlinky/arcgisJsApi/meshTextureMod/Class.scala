package typingsSlinky.arcgisJsApi.meshTextureMod

import typingsSlinky.arcgisJsApi.esri.MeshTexture
import typingsSlinky.arcgisJsApi.esri.MeshTextureProperties
