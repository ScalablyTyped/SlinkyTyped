...
import typingsSlinky.arcgisJsApi.esri.SlicePlane
import typingsSlinky.arcgisJsApi.esri.SlicePlaneConstructor
import typingsSlinky.arcgisJsApi.esri.SlicePlaneProperties
