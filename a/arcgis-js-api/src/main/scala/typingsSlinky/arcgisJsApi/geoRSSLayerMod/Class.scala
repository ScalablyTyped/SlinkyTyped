package typingsSlinky.arcgisJsApi.geoRSSLayerMod

import typingsSlinky.arcgisJsApi.esri.GeoRSSLayer
import typingsSlinky.arcgisJsApi.esri.GeoRSSLayerProperties
