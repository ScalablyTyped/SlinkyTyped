...
import typingsSlinky.arcgisJsApi.esri.SceneView
import typingsSlinky.arcgisJsApi.esri.SceneViewConstructor
import typingsSlinky.arcgisJsApi.esri.SceneViewProperties
