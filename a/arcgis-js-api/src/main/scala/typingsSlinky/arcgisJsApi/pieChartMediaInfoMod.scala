...
import typingsSlinky.arcgisJsApi.esri.PieChartMediaInfo
import typingsSlinky.arcgisJsApi.esri.PieChartMediaInfoConstructor
import typingsSlinky.arcgisJsApi.esri.PieChartMediaInfoProperties
