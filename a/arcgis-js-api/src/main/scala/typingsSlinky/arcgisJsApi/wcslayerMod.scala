...
import typingsSlinky.arcgisJsApi.esri.WCSLayer
import typingsSlinky.arcgisJsApi.esri.WCSLayerConstructor
import typingsSlinky.arcgisJsApi.esri.WCSLayerProperties
