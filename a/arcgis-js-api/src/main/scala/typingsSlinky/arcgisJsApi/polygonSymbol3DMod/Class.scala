package typingsSlinky.arcgisJsApi.polygonSymbol3DMod

import typingsSlinky.arcgisJsApi.esri.PolygonSymbol3D
import typingsSlinky.arcgisJsApi.esri.PolygonSymbol3DProperties
