...
import typingsSlinky.arcgisJsApi.esri.LineChartMediaInfo
import typingsSlinky.arcgisJsApi.esri.LineChartMediaInfoConstructor
import typingsSlinky.arcgisJsApi.esri.LineChartMediaInfoProperties
