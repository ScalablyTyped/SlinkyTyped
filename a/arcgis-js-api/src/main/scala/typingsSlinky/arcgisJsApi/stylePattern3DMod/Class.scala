package typingsSlinky.arcgisJsApi.stylePattern3DMod

import typingsSlinky.arcgisJsApi.esri.StylePattern3D
import typingsSlinky.arcgisJsApi.esri.StylePattern3DProperties
