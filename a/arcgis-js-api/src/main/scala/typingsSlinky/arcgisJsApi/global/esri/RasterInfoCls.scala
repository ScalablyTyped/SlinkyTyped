...
@js.native
class RasterInfoCls ()
  extends typingsSlinky.arcgisJsApi.esri.RasterInfo {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var attributeTable: typingsSlinky.arcgisJsApi.esri.FeatureSet = js.native
  /**
    * Raster band count.
    *
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var extent: typingsSlinky.arcgisJsApi.esri.Extent = js.native
  /**
