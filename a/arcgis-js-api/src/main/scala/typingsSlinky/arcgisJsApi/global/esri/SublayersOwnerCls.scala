...
class SublayersOwnerCls ()
  extends typingsSlinky.arcgisJsApi.esri.SublayersOwner {
  /**
    ...
    */
  /* CompleteClass */
  override def createServiceSublayers(): typingsSlinky.arcgisJsApi.esri.Collection[typingsSlinky.arcgisJsApi.esri.Sublayer] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findSublayerById(id: Double): typingsSlinky.arcgisJsApi.esri.Sublayer = js.native
}
