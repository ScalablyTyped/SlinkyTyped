...
class ViewStateCls ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val extent: typingsSlinky.arcgisJsApi.esri.Extent = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(state: typingsSlinky.arcgisJsApi.esri.ViewState): typingsSlinky.arcgisJsApi.esri.ViewState = js.native
  /**
