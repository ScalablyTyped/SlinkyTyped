...
import typingsSlinky.arcgisJsApi.esri.ClosestFacilityTaskProperties
...
/**
  ...
  */
class ClosestFacilityTaskCls ()
  extends typingsSlinky.arcgisJsApi.esri.ClosestFacilityTask {
