...
class ListItemPanelCls ()
  extends typingsSlinky.arcgisJsApi.esri.ListItemPanel {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var content: typingsSlinky.arcgisJsApi.esri.Widget_ | HTMLElement | String | js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var listItem: typingsSlinky.arcgisJsApi.esri.ListItem = js.native
  /**
