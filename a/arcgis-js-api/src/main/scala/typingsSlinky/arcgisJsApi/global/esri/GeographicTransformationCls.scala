...
class GeographicTransformationCls ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var steps: js.Array[typingsSlinky.arcgisJsApi.esri.GeographicTransformationStep] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getInverse(): typingsSlinky.arcgisJsApi.esri.GeographicTransformation = js.native
}
