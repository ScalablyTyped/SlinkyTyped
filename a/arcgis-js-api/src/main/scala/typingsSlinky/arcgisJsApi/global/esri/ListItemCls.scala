...
/**
  ...
  */
class ListItemCls ()
  extends typingsSlinky.arcgisJsApi.esri.ListItem {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var actionsSections: typingsSlinky.arcgisJsApi.esri.Collection[
    typingsSlinky.arcgisJsApi.esri.Collection[
      typingsSlinky.arcgisJsApi.esri.ActionButton | typingsSlinky.arcgisJsApi.esri.ActionToggle
    ]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var children: typingsSlinky.arcgisJsApi.esri.Collection[typingsSlinky.arcgisJsApi.esri.ListItem] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val error: typingsSlinky.arcgisJsApi.esri.Error = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var layer: typingsSlinky.arcgisJsApi.esri.Layer = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val layerView: typingsSlinky.arcgisJsApi.esri.LayerView = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var panel: typingsSlinky.arcgisJsApi.esri.ListItemPanel = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typingsSlinky.arcgisJsApi.esri.ListItem = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var view: typingsSlinky.arcgisJsApi.esri.MapView | typingsSlinky.arcgisJsApi.esri.SceneView = js.native
  /**
