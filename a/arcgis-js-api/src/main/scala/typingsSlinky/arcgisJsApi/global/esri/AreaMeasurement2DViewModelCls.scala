...
import typingsSlinky.arcgisJsApi.esri.AreaMeasurement2DViewModelMeasurement
import typingsSlinky.arcgisJsApi.esri.AreaMeasurement2DViewModelMeasurementLabel
...
class AreaMeasurement2DViewModelCls ()
  extends typingsSlinky.arcgisJsApi.esri.AreaMeasurement2DViewModel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var view: typingsSlinky.arcgisJsApi.esri.MapView = js.native
  /**
