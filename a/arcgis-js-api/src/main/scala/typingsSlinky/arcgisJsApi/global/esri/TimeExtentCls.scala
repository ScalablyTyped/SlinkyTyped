...
import typingsSlinky.arcgisJsApi.esri.TimeExtentProperties
...
/**
  ...
  */
class TimeExtentCls ()
  extends typingsSlinky.arcgisJsApi.esri.TimeExtent {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def intersection(timeExtent: typingsSlinky.arcgisJsApi.esri.TimeExtent): typingsSlinky.arcgisJsApi.esri.TimeExtent = js.native
  /**
