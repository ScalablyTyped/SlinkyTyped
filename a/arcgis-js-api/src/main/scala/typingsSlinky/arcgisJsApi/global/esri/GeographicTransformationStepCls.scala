...
class GeographicTransformationStepCls ()
  extends typingsSlinky.arcgisJsApi.esri.GeographicTransformationStep {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInverse(): typingsSlinky.arcgisJsApi.esri.GeographicTransformationStep = js.native
}
