...
import typingsSlinky.arcgisJsApi.esri.BuildingFilterBlock
...
class BuildingFilterCls ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var filterBlocks: typingsSlinky.arcgisJsApi.esri.Collection[BuildingFilterBlock] = js.native
  /**
