...
import typingsSlinky.arcgisJsApi.esri.ColumnChartMediaInfoProperties
...
class ColumnChartMediaInfoCls ()
  extends typingsSlinky.arcgisJsApi.esri.ColumnChartMediaInfo {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var value: typingsSlinky.arcgisJsApi.esri.ChartMediaInfoValue = js.native
  /**
