...
import typingsSlinky.arcgisJsApi.esri.FeatureLayerProperties
...
/**
  ...
  */
class FeatureLayerCls ()
  extends typingsSlinky.arcgisJsApi.esri.FeatureLayer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var timeExtent: typingsSlinky.arcgisJsApi.esri.TimeExtent = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var timeInfo: typingsSlinky.arcgisJsApi.esri.TimeInfo = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var timeOffset: typingsSlinky.arcgisJsApi.esri.TimeInterval = js.native
  /**
