...
class FeatureTableViewModelCls ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var fieldConfigs: js.Array[typingsSlinky.arcgisJsApi.esri.FieldColumnConfig] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var hiddenFields: typingsSlinky.arcgisJsApi.esri.Collection[String] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var layer: typingsSlinky.arcgisJsApi.esri.FeatureLayer = js.native
}
