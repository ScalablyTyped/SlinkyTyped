...
class FieldsIndexCls ()
  extends typingsSlinky.arcgisJsApi.esri.FieldsIndex {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var dateFields: js.Array[_ | typingsSlinky.arcgisJsApi.esri.Field] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def get(fieldName: String): typingsSlinky.arcgisJsApi.esri.Field = js.native
  /**
