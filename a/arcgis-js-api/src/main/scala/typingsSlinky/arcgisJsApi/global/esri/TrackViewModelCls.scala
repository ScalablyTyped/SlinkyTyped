...
import typingsSlinky.arcgisJsApi.esri.TrackViewModelProperties
...
class TrackViewModelCls ()
  extends typingsSlinky.arcgisJsApi.esri.TrackViewModel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var graphic: typingsSlinky.arcgisJsApi.esri.Graphic = js.native
  /**
