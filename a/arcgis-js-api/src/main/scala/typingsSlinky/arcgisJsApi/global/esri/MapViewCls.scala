...
import typingsSlinky.arcgisJsApi.esri.BreakpointsOwnerBreakpoints
import typingsSlinky.arcgisJsApi.esri.MapViewProperties
...
/**
  ...
  */
class MapViewCls ()
  extends typingsSlinky.arcgisJsApi.esri.MapView {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var popup: typingsSlinky.arcgisJsApi.esri.Popup = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ui: typingsSlinky.arcgisJsApi.esri.DefaultUI = js.native
  /**
