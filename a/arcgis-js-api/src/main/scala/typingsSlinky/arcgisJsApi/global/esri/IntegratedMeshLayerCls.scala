...
import typingsSlinky.arcgisJsApi.esri.IntegratedMeshLayerProperties
...
class IntegratedMeshLayerCls ()
  extends typingsSlinky.arcgisJsApi.esri.IntegratedMeshLayer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var spatialReference: typingsSlinky.arcgisJsApi.esri.SpatialReference = js.native
  /**
