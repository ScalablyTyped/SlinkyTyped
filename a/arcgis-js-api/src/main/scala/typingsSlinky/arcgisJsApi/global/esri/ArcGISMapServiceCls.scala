...
import typingsSlinky.arcgisJsApi.esri.ArcGISMapServiceCapabilities
import typingsSlinky.arcgisJsApi.esri.ArcGISMapServiceProperties
...
class ArcGISMapServiceCls ()
  extends typingsSlinky.arcgisJsApi.esri.ArcGISMapService {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var fullExtent: typingsSlinky.arcgisJsApi.esri.Extent = js.native
  /**
