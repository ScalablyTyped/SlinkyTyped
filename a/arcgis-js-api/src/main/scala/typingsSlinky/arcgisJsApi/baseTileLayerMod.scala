...
import typingsSlinky.arcgisJsApi.esri.BaseTileLayer
import typingsSlinky.arcgisJsApi.esri.BaseTileLayerConstructor
import typingsSlinky.arcgisJsApi.esri.BaseTileLayerProperties
