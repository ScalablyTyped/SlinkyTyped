...
import typingsSlinky.arcgisJsApi.esri.TileLayer
import typingsSlinky.arcgisJsApi.esri.TileLayerConstructor
import typingsSlinky.arcgisJsApi.esri.TileLayerProperties
