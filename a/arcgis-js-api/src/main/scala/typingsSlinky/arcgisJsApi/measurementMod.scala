...
import typingsSlinky.arcgisJsApi.esri.Measurement
import typingsSlinky.arcgisJsApi.esri.MeasurementConstructor
import typingsSlinky.arcgisJsApi.esri.MeasurementProperties
