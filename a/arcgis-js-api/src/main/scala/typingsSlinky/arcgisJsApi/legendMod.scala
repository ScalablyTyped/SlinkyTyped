...
import typingsSlinky.arcgisJsApi.esri.Legend
import typingsSlinky.arcgisJsApi.esri.LegendConstructor
import typingsSlinky.arcgisJsApi.esri.LegendProperties
