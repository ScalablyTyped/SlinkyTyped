...
import typingsSlinky.arcgisJsApi.esri.BasemapGallery
import typingsSlinky.arcgisJsApi.esri.BasemapGalleryConstructor
import typingsSlinky.arcgisJsApi.esri.BasemapGalleryProperties
