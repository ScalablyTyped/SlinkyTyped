...
import typingsSlinky.arcgisJsApi.esri.BaseLayerView2D
import typingsSlinky.arcgisJsApi.esri.BaseLayerView2DConstructor
import typingsSlinky.arcgisJsApi.esri.BaseLayerView2DProperties
