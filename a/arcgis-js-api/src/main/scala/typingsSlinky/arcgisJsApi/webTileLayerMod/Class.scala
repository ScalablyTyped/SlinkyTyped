package typingsSlinky.arcgisJsApi.webTileLayerMod

import typingsSlinky.arcgisJsApi.esri.PortalItem
import typingsSlinky.arcgisJsApi.esri.WebTileLayer
import typingsSlinky.arcgisJsApi.esri.WebTileLayerProperties
