package typingsSlinky.arcgisJsApi.streamLayerMod

import typingsSlinky.arcgisJsApi.esri.PortalItem
import typingsSlinky.arcgisJsApi.esri.StreamLayer
import typingsSlinky.arcgisJsApi.esri.StreamLayerProperties
import typingsSlinky.arcgisJsApi.esri.TimeExtent
import typingsSlinky.arcgisJsApi.esri.TimeInfo
