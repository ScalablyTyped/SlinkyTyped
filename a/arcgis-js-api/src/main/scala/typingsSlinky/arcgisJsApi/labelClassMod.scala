...
import typingsSlinky.arcgisJsApi.esri.LabelClass
import typingsSlinky.arcgisJsApi.esri.LabelClassConstructor
import typingsSlinky.arcgisJsApi.esri.LabelClassProperties
