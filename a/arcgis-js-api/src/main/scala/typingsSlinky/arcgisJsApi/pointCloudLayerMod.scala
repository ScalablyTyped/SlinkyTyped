...
import typingsSlinky.arcgisJsApi.esri.PointCloudLayer
import typingsSlinky.arcgisJsApi.esri.PointCloudLayerConstructor
import typingsSlinky.arcgisJsApi.esri.PointCloudLayerProperties
