...
import typingsSlinky.arcgisJsApi.esri.LocateViewModel
import typingsSlinky.arcgisJsApi.esri.LocateViewModelConstructor
import typingsSlinky.arcgisJsApi.esri.LocateViewModelProperties
