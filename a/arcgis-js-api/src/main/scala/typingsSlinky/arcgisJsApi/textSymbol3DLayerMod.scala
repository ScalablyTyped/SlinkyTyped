...
import typingsSlinky.arcgisJsApi.esri.TextSymbol3DLayer
import typingsSlinky.arcgisJsApi.esri.TextSymbol3DLayerConstructor
import typingsSlinky.arcgisJsApi.esri.TextSymbol3DLayerProperties
