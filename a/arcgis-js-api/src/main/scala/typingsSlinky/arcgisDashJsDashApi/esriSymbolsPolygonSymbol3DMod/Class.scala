package typingsSlinky.arcgisDashJsDashApi.esriSymbolsPolygonSymbol3DMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PolygonSymbol3D
import typingsSlinky.arcgisDashJsDashApi.__esri.PolygonSymbol3DProperties
