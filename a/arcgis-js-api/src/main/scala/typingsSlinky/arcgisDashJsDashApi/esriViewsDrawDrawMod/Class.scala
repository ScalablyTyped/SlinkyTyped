package typingsSlinky.arcgisDashJsDashApi.esriViewsDrawDrawMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Draw
import typingsSlinky.arcgisDashJsDashApi.__esri.DrawProperties
