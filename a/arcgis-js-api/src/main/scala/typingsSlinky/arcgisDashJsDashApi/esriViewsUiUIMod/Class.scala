package typingsSlinky.arcgisDashJsDashApi.esriViewsUiUIMod

import typingsSlinky.arcgisDashJsDashApi.__esri.UI
import typingsSlinky.arcgisDashJsDashApi.__esri.UIProperties
