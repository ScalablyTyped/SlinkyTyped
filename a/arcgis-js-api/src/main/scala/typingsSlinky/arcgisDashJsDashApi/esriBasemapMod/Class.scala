package typingsSlinky.arcgisDashJsDashApi.esriBasemapMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Basemap
import typingsSlinky.arcgisDashJsDashApi.__esri.BasemapProperties
