package typingsSlinky.arcgisDashJsDashApi.esriWidgetsHomeMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Home
import typingsSlinky.arcgisDashJsDashApi.__esri.HomeProperties
