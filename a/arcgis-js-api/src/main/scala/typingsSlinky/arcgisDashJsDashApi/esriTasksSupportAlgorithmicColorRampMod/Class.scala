package typingsSlinky.arcgisDashJsDashApi.esriTasksSupportAlgorithmicColorRampMod

import typingsSlinky.arcgisDashJsDashApi.__esri.AlgorithmicColorRamp
import typingsSlinky.arcgisDashJsDashApi.__esri.AlgorithmicColorRampProperties
