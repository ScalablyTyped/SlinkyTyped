package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportFeatureReductionSelectionMod

import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureReductionSelection
import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureReductionSelectionProperties
