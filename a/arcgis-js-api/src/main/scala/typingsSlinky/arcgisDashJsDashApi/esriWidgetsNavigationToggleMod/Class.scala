package typingsSlinky.arcgisDashJsDashApi.esriWidgetsNavigationToggleMod

import typingsSlinky.arcgisDashJsDashApi.__esri.NavigationToggle
import typingsSlinky.arcgisDashJsDashApi.__esri.NavigationToggleProperties
