package typingsSlinky.arcgisDashJsDashApi.esriWidgetsEditorWorkflowMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Workflow
import typingsSlinky.arcgisDashJsDashApi.__esri.WorkflowProperties
