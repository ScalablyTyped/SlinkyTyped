package typingsSlinky.arcgisDashJsDashApi.esriWidgetsCompassMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Compass
import typingsSlinky.arcgisDashJsDashApi.__esri.CompassProperties
