package typingsSlinky.arcgisDashJsDashApi.esriWidgetsSliceMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Slice
import typingsSlinky.arcgisDashJsDashApi.__esri.SliceProperties
