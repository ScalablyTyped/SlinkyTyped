package typingsSlinky.arcgisDashJsDashApi.esriLayersWMTSLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PortalItem
import typingsSlinky.arcgisDashJsDashApi.__esri.WMTSLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.WMTSLayerProperties
