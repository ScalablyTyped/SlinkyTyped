package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportRasterFunctionMod

import typingsSlinky.arcgisDashJsDashApi.__esri.RasterFunction
import typingsSlinky.arcgisDashJsDashApi.__esri.RasterFunctionProperties
