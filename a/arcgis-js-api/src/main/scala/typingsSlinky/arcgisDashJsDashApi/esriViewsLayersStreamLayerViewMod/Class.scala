package typingsSlinky.arcgisDashJsDashApi.esriViewsLayersStreamLayerViewMod

import typingsSlinky.arcgisDashJsDashApi.__esri.StreamLayerView
import typingsSlinky.arcgisDashJsDashApi.__esri.StreamLayerViewProperties
