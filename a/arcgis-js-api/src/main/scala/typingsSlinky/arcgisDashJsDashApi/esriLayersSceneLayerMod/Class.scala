package typingsSlinky.arcgisDashJsDashApi.esriLayersSceneLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PortalItem
import typingsSlinky.arcgisDashJsDashApi.__esri.SceneLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.SceneLayerProperties
