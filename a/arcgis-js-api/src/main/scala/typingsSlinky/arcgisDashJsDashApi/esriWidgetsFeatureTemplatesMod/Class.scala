package typingsSlinky.arcgisDashJsDashApi.esriWidgetsFeatureTemplatesMod

import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureTemplates
import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureTemplatesProperties
