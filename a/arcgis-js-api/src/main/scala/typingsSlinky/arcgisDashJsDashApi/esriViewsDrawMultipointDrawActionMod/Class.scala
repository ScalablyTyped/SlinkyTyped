package typingsSlinky.arcgisDashJsDashApi.esriViewsDrawMultipointDrawActionMod

import typingsSlinky.arcgisDashJsDashApi.__esri.MultipointDrawAction
import typingsSlinky.arcgisDashJsDashApi.__esri.MultipointDrawActionProperties
