package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportDimensionalDefinitionMod

import typingsSlinky.arcgisDashJsDashApi.__esri.DimensionalDefinition
import typingsSlinky.arcgisDashJsDashApi.__esri.DimensionalDefinitionProperties
