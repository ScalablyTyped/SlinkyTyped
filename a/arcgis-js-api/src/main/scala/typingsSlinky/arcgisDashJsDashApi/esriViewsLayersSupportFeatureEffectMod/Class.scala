package typingsSlinky.arcgisDashJsDashApi.esriViewsLayersSupportFeatureEffectMod

import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureEffect
import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureEffectProperties
