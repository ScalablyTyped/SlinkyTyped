package typingsSlinky.arcgisDashJsDashApi.esriRenderersVisualVariablesRotationVariableMod

import typingsSlinky.arcgisDashJsDashApi.__esri.RotationVariable
import typingsSlinky.arcgisDashJsDashApi.__esri.RotationVariableProperties
