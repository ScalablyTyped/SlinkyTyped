package typingsSlinky.arcgisDashJsDashApi.esriWidgetsZoomMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Zoom
import typingsSlinky.arcgisDashJsDashApi.__esri.ZoomProperties
