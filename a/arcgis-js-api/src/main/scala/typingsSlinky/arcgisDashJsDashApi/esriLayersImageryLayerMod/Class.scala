package typingsSlinky.arcgisDashJsDashApi.esriLayersImageryLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ImageryLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.ImageryLayerProperties
