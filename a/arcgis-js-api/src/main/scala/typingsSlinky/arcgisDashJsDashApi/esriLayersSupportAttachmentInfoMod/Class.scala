package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportAttachmentInfoMod

import typingsSlinky.arcgisDashJsDashApi.__esri.AttachmentInfo
import typingsSlinky.arcgisDashJsDashApi.__esri.AttachmentInfoProperties
