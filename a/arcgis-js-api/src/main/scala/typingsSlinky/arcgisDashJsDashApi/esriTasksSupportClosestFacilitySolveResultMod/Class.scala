package typingsSlinky.arcgisDashJsDashApi.esriTasksSupportClosestFacilitySolveResultMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ClosestFacilitySolveResult
import typingsSlinky.arcgisDashJsDashApi.__esri.ClosestFacilitySolveResultProperties
