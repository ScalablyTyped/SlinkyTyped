package typingsSlinky.arcgisDashJsDashApi.esriLayersGroupLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.GroupLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.GroupLayerProperties
