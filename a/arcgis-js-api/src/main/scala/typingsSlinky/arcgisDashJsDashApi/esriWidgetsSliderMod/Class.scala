package typingsSlinky.arcgisDashJsDashApi.esriWidgetsSliderMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Slider
import typingsSlinky.arcgisDashJsDashApi.__esri.SliderProperties
