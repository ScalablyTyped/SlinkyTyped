package typingsSlinky.arcgisDashJsDashApi.esriLayersMixinsPortalLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PortalItem
import typingsSlinky.arcgisDashJsDashApi.__esri.PortalLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.PortalLayerProperties
