package typingsSlinky.arcgisDashJsDashApi.esriTasksSupportQueryMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Query
import typingsSlinky.arcgisDashJsDashApi.__esri.QueryProperties
