...
trait NotificationTask extends Task {
  ...
  /**
    ...
    *
    */
  def getDatabaseTime(dataWorkspaceId: String): IPromise[js.Date] = js.native
  def getDatabaseTime(dataWorkspaceId: String, requestOptions: js.Any): IPromise[js.Date] = js.native
  /**
...
@js.native
object NotificationTask extends TopLevel[NotificationTaskConstructor]
