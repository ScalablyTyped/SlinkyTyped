...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`unique-value`
...
trait UniqueValueRenderer
  extends Renderer
     ...
     with typingsSlinky.arcgisDashJsDashApi.__esri.renderers.RendererWithVisualVariables {
  /**
