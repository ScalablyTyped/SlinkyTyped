...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`on-the-ground`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`relative-to-ground`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`relative-to-scene`
