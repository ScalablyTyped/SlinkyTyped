...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`locate-error`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.locate
