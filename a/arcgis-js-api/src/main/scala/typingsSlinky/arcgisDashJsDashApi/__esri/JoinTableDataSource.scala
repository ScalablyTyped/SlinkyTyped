...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`join-table`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`left-inner-join`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`left-outer-join`
