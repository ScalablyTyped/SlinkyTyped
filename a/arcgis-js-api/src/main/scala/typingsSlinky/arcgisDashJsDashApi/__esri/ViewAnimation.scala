...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`waiting-for-target`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.finished
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.running
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.stopped
