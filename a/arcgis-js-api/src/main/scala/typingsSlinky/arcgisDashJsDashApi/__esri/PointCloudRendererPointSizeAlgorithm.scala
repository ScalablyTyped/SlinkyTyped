...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`fixed-size`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.splat
