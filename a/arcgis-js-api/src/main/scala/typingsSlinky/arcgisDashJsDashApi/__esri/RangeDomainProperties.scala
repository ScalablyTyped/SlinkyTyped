...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`coded-value`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.inherited
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.range
