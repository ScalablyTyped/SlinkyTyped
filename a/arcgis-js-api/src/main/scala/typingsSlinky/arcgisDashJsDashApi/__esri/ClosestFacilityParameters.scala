...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`allow-backtrack`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`at-dead-ends-and-intersections`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`at-dead-ends-only`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`complete-no-events`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`decimal-degrees`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`from-facility`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`instructions-only`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`nautical-miles`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`no-backtrack`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`summary-only`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`to-facility`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`true-shape-with-measure`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`true-shape`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.points
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.straight
