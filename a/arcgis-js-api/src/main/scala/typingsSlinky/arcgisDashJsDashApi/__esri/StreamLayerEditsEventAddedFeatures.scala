...
trait StreamLayerEditsEventAddedFeatures extends Object {
  var objectId: Double
}

object StreamLayerEditsEventAddedFeatures {
  @scala.inline
  def apply(
  ...
  ): StreamLayerEditsEventAddedFeatures = {
    ...
    __obj.asInstanceOf[StreamLayerEditsEventAddedFeatures]
  }
}
