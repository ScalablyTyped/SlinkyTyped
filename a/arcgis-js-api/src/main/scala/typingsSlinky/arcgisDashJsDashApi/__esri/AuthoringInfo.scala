...
trait AuthoringInfo
  ...
  /**
    ...
    */
  var `type`: `class-breaks-size` | `class-breaks-color` | `classed-color` | `classed-size` | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.predominance | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.relationship | `univariate-color-size` = js.native
  /**
