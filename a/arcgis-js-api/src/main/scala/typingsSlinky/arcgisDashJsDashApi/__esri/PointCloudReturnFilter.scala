...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.firstOfMany
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.last
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.lastOfMany
