...
@js.native
trait CoordinateConversionConstructor
  extends /**
  ...
  */
Instantiable0[CoordinateConversion]
     with Instantiable1[/* properties */ CoordinateConversionProperties, CoordinateConversion]
