...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`data-received`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.connected
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.disconnected
