...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`cursor-update`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`draw-complete`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.undo
