...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`not-loaded`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.failed
...
trait WebScene
  ...
  /**
    ...
    * @default not-loaded
    */
  val loadStatus: `not-loaded` | loading | failed | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.loaded = js.native
  /**
