...
trait UI extends Accessor {
  ...
  def add(component: typingsSlinky.std.HTMLElement): Unit = js.native
  def add(component: typingsSlinky.std.HTMLElement, position: String): Unit = js.native
  def add(component: typingsSlinky.std.HTMLElement, position: UIAddPosition): Unit = js.native
  /**
  ...
  def move(component: typingsSlinky.std.HTMLElement): Unit = js.native
  def move(component: typingsSlinky.std.HTMLElement, position: String): Unit = js.native
  ...
  def remove(component: typingsSlinky.std.HTMLElement): Unit = js.native
}
