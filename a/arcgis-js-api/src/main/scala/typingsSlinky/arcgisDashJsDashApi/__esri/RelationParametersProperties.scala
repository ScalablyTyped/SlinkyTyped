...
trait RelationParametersProperties extends js.Object {
  ...
  var relation: js.UndefOr[
    cross | disjoint | in_ | `interior-intersection` | intersection | `line-coincidence` | `line-touch` | overlap | `point-touch` | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.relation | touch | within
  ] = js.undefined
  /**
