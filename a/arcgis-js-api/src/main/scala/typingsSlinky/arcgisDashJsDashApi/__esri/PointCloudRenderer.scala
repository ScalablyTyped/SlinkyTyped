...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`point-cloud-class-breaks`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`point-cloud-rgb`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`point-cloud-stretch`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`point-cloud-unique-value`
