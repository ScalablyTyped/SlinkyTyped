...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.blend
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.mask
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.opaque
