...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`token-change`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.destroy
