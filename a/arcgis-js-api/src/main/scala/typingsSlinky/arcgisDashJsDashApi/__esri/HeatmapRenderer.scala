...
trait HeatmapRenderer
  extends Renderer
     with typingsSlinky.arcgisDashJsDashApi.__esri.renderers.Renderer
  ...
  /**
    ...
    */
  @JSName("type")
  val type_HeatmapRenderer: typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.heatmap = js.native
}
