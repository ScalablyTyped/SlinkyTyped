...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`default-curve-extension`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`keep-end-attributes`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`no-end-attributes`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`no-extend-at-from`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`no-extend-at-to`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`relocate-ends`
