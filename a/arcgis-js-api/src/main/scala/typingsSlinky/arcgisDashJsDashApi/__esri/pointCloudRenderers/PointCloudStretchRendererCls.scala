...
import typingsSlinky.arcgisDashJsDashApi.__esri.PointCloudStretchRendererProperties
...
class PointCloudStretchRendererCls ()
  extends typingsSlinky.arcgisDashJsDashApi.__esri.PointCloudStretchRenderer {
