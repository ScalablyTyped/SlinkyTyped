...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`width-and-depth`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.width
...
trait SizeVariable extends VisualVariable {
  ...
  /**
    ...
    */
  @JSName("type")
  val type_SizeVariable: typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.size = js.native
  /**
