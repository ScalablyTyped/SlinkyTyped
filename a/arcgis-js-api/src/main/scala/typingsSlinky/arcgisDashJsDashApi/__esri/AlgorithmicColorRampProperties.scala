...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`cie-lab`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`lab-lch`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.hsv
