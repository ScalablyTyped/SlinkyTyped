...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`credential-create`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`dialog-create`
