...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`cumulative-from-end`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`cumulative-from-start`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`time-window`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.instant
