...
trait PortalQueryParams extends Accessor {
  ...
  /**
    ...
    */
  var sortField: title | uploaded | modified | username | created | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`type` | owner | `avg-rating` | `num-ratings` | `num-comments` | `num-views` = js.native
  /**
