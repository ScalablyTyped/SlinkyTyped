...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`rich-text`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`text-area`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`text-box`
