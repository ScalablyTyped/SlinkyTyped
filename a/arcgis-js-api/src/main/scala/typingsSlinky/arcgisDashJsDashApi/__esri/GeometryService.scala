...
trait GeometryService extends Task {
  ...
  /**
    ...
    *
    */
  def convexHull(geometries: js.Array[Geometry]): js.Promise[Geometry] = js.native
  def convexHull(geometries: js.Array[Geometry], requestOptions: js.Any): js.Promise[Geometry] = js.native
  /**
    ...
    *
    */
  def cut(geometries: js.Array[Geometry], cutter: Polyline): js.Promise[_] = js.native
  def cut(geometries: js.Array[Geometry], cutter: Polyline, requestOptions: js.Any): js.Promise[_] = js.native
  /**
    ...
    *
    */
  def densify(densifyParameters: DensifyParameters): js.Promise[js.Array[Geometry]] = js.native
  def densify(densifyParameters: DensifyParameters, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def difference(geometries: js.Array[Geometry], geometry: Geometry): js.Promise[Geometry] = js.native
  def difference(geometries: js.Array[Geometry], geometry: Geometry, requestOptions: js.Any): js.Promise[Geometry] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def generalize(params: GeneralizeParameters): js.Promise[js.Array[Geometry]] = js.native
  def generalize(params: GeneralizeParameters, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def intersect(geometries: js.Array[Geometry], intersector: Geometry): js.Promise[js.Array[Geometry]] = js.native
  def intersect(geometries: js.Array[Geometry], intersector: Geometry, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def offset(params: OffsetParameters): js.Promise[js.Array[Geometry]] = js.native
  def offset(params: OffsetParameters, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def project(params: ProjectParameters): js.Promise[js.Array[Geometry]] = js.native
  def project(params: ProjectParameters, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def reshape(targetGeometry: Geometry, reshaper: Geometry): js.Promise[Geometry] = js.native
  def reshape(targetGeometry: Geometry, reshaper: Geometry, requestOptions: js.Any): js.Promise[Geometry] = js.native
  /**
    ...
    *
    */
  def simplify(geometries: js.Array[Geometry]): js.Promise[js.Array[Geometry]] = js.native
  def simplify(geometries: js.Array[Geometry], requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def trimExtend(params: TrimExtendParameters): js.Promise[js.Array[Geometry]] = js.native
  def trimExtend(params: TrimExtendParameters, requestOptions: js.Any): js.Promise[js.Array[Geometry]] = js.native
  /**
  ...
  def union(geometries: js.Array[Geometry], requestOptions: js.Any): js.Promise[Geometry] = js.native
}
