...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`forward-down`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`forward-up`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.pan
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.zoom
