...
@js.native
trait BarChartMediaInfoConstructor
  extends /**
  ...
  */
Instantiable0[BarChartMediaInfo]
     with Instantiable1[/* properties */ BarChartMediaInfoProperties, BarChartMediaInfo] {
  def fromJSON(json: js.Any): BarChartMediaInfo = js.native
}
