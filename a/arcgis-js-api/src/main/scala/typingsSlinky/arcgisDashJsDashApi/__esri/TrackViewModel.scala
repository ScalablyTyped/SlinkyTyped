...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.waiting
...
trait TrackViewModel
  ...
  /**
    ...
    * @default disabled
    */
  val state: disabled | ready | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.tracking | waiting = js.native
  /**
