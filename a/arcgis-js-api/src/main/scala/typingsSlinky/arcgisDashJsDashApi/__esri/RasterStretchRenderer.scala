...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`histogram-equalization`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`min-max`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`percent-clip`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`raster-stretch`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.sigmoid
