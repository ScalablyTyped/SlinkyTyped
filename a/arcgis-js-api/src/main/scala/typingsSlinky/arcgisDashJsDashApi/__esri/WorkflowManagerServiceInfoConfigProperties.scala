...
object WorkflowManagerServiceInfoConfigProperties {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AOIOVERLAP = AOIOVERLAP.asInstanceOf[js.Any], AOISELECTIONCOLOR = AOISELECTIONCOLOR.asInstanceOf[js.Any], AUTOASSIGNJOB = AUTOASSIGNJOB.asInstanceOf[js.Any], AUTOCLOSEJOB = AUTOCLOSEJOB.asInstanceOf[js.Any], AUTOCOMMITWORKFLOW = AUTOCOMMITWORKFLOW.asInstanceOf[js.Any], AUTOSTATUSASSIGN = AUTOSTATUSASSIGN.asInstanceOf[js.Any], CONFIRMPROCEDURALCHECK = CONFIRMPROCEDURALCHECK.asInstanceOf[js.Any], DEFAULT_SENDER_EMAIL = DEFAULT_SENDER_EMAIL.asInstanceOf[js.Any], DEFAULT_SENDER_NAME = DEFAULT_SENDER_NAME.asInstanceOf[js.Any], HTML_SUPPORT = HTML_SUPPORT.asInstanceOf[js.Any], JOB_ID_START_VALUE = JOB_ID_START_VALUE.asInstanceOf[js.Any], PENDING_DAYS_USE_HOLDS = PENDING_DAYS_USE_HOLDS.asInstanceOf[js.Any], PROMPTSDEPWD = PROMPTSDEPWD.asInstanceOf[js.Any], REQUIREPROCEDURALCHECKSTART = REQUIREPROCEDURALCHECKSTART.asInstanceOf[js.Any], RESTRICT_AOI_OPTION = RESTRICT_AOI_OPTION.asInstanceOf[js.Any], SEND_SN_CUSTOM_POST = SEND_SN_CUSTOM_POST.asInstanceOf[js.Any], SHOW_PENDING_DAYS = SHOW_PENDING_DAYS.asInstanceOf[js.Any], SHOW_STEP_IDS = SHOW_STEP_IDS.asInstanceOf[js.Any], SHOW_STEP_PERCENT_COMPLETE = SHOW_STEP_PERCENT_COMPLETE.asInstanceOf[js.Any], SMTP_PASSWORD = SMTP_PASSWORD.asInstanceOf[js.Any], SMTP_PORT = SMTP_PORT.asInstanceOf[js.Any], SMTP_PROTOCOL = SMTP_PROTOCOL.asInstanceOf[js.Any], SMTP_SERVER = SMTP_SERVER.asInstanceOf[js.Any], SMTP_USERNAME = SMTP_USERNAME.asInstanceOf[js.Any], USER_STORE = USER_STORE.asInstanceOf[js.Any], USEUSERDOMAIN = USEUSERDOMAIN.asInstanceOf[js.Any], USE_STEP_STATUS = USE_STEP_STATUS.asInstanceOf[js.Any], WF_SEL_STEP_FILL_COLOR = WF_SEL_STEP_FILL_COLOR.asInstanceOf[js.Any], WF_SEL_STEP_OUTLINE_COLOR = WF_SEL_STEP_OUTLINE_COLOR.asInstanceOf[js.Any], WF_SEL_STEP_OUTLINE_WIDTH = WF_SEL_STEP_OUTLINE_WIDTH.asInstanceOf[js.Any], ZOOMTOAOI = ZOOMTOAOI.asInstanceOf[js.Any], constructor = constructor.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
