...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`interior-intersection`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`line-coincidence`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`line-touch`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`point-touch`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.in_
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.intersection
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.overlap
...
@js.native
trait RelationParameters extends Accessor {
  /**
    ...
    */
  var geometries1: js.Array[Geometry] = js.native
  /**
    ...
    */
  var geometries2: js.Array[Geometry] = js.native
  /**
    ...
    */
  var relation: cross | disjoint | in_ | `interior-intersection` | intersection | `line-coincidence` | `line-touch` | overlap | `point-touch` | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.relation | touch | within = js.native
  /**
