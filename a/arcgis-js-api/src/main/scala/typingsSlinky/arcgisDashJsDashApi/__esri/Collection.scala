...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`after-add`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`after-changes`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`after-remove`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`before-add`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`before-changes`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`before-remove`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.change
