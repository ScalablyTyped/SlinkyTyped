...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`avg-rating`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`num-comments`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`num-ratings`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`num-views`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.asc
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.created
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.desc
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.modified
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.owner
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.title
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.uploaded
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.username
...
trait PortalQueryParamsProperties extends js.Object {
  ...
  var sortField: js.UndefOr[
    title | uploaded | modified | username | created | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`type` | owner | `avg-rating` | `num-ratings` | `num-comments` | `num-views`
  ] = js.undefined
  /**
...
object PortalQueryParamsProperties {
  ...
  def apply(
    ...
    num: Int | Double = null,
    query: String = null,
    sortField: title | uploaded | modified | username | created | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`type` | owner | `avg-rating` | `num-ratings` | `num-comments` | `num-views` = null,
