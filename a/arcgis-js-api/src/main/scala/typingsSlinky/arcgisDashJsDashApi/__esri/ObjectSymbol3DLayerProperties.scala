...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.origin
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.relative
