...
trait PortalGroupProperties extends js.Object {
  ...
  var access: js.UndefOr[
    `private` | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.org | public
  ] = js.undefined
  /**
...
object PortalGroupProperties {
  @scala.inline
  def apply(
    access: `private` | typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.org | public = null,
