...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`open-street-map`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`web-tile`
