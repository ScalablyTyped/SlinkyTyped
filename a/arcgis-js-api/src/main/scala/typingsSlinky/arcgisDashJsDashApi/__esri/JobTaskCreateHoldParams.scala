...
object JobTaskCreateHoldParams {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(comments = comments.asInstanceOf[js.Any], constructor = constructor.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), holdTypeId = holdTypeId.asInstanceOf[js.Any], jobId = jobId.asInstanceOf[js.Any], propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable), user = user.asInstanceOf[js.Any])
