...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`max-change`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`value-change`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`values-change`
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.dragging
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.editing
