package typingsSlinky.arcgisDashJsDashApi.esriWebsceneBackgroundColorBackgroundMod

import typingsSlinky.arcgisDashJsDashApi.__esri.backgroundColorBackground
import typingsSlinky.arcgisDashJsDashApi.__esri.backgroundColorBackgroundProperties
