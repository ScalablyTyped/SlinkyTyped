package typingsSlinky.arcgisDashJsDashApi.esriWidgetsScaleBarMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ScaleBar
import typingsSlinky.arcgisDashJsDashApi.__esri.ScaleBarProperties
