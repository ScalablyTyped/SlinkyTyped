package typingsSlinky.arcgisDashJsDashApi.esriTasksServiceAreaTaskMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ServiceAreaTask
import typingsSlinky.arcgisDashJsDashApi.__esri.ServiceAreaTaskProperties
