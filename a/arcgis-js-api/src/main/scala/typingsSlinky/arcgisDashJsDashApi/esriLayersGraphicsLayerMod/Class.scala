package typingsSlinky.arcgisDashJsDashApi.esriLayersGraphicsLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.GraphicsLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.GraphicsLayerProperties
