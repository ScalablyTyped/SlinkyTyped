package typingsSlinky.arcgisDashJsDashApi.esriWidgetsDaylightMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Daylight
import typingsSlinky.arcgisDashJsDashApi.__esri.DaylightProperties
