package typingsSlinky.arcgisDashJsDashApi.esriRenderersMixinsVisualVariablesMixinMod

import typingsSlinky.arcgisDashJsDashApi.__esri.VisualVariable
import typingsSlinky.arcgisDashJsDashApi.__esri.VisualVariablesMixin
...
@js.native
class Class () extends VisualVariablesMixin {
  /**
