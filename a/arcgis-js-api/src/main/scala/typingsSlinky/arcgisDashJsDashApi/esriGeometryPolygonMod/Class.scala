package typingsSlinky.arcgisDashJsDashApi.esriGeometryPolygonMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Polygon
import typingsSlinky.arcgisDashJsDashApi.__esri.PolygonProperties
