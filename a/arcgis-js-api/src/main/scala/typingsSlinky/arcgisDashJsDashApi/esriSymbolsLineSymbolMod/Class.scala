package typingsSlinky.arcgisDashJsDashApi.esriSymbolsLineSymbolMod

import typingsSlinky.arcgisDashJsDashApi.__esri.LineSymbol
import typingsSlinky.arcgisDashJsDashApi.__esri.LineSymbolProperties
