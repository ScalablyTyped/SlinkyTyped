package typingsSlinky.arcgisDashJsDashApi.esriPointCloudRenderersMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PointCloudUniqueValueRendererProperties
...
class PointCloudUniqueValueRendererCls ()
  extends typingsSlinky.arcgisDashJsDashApi.__esri.PointCloudUniqueValueRenderer {
