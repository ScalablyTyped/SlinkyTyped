package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportRasterInfoMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Extent
import typingsSlinky.arcgisDashJsDashApi.__esri.FeatureSet
import typingsSlinky.arcgisDashJsDashApi.__esri.Point
import typingsSlinky.arcgisDashJsDashApi.__esri.RasterInfo
import typingsSlinky.arcgisDashJsDashApi.__esri.RasterInfoProperties
import typingsSlinky.arcgisDashJsDashApi.__esri.RasterInfoStatistics
import typingsSlinky.arcgisDashJsDashApi.__esri.SpatialReference
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`vector-magdir`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`vector-uv`
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.elevation
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.generic
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.processed
...
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.scientific
import typingsSlinky.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.thematic
