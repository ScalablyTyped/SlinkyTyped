package typingsSlinky.arcgisDashJsDashApi.esriWidgetsSearchMod

import typingsSlinky.arcgisDashJsDashApi.__esri.widgetsSearch
import typingsSlinky.arcgisDashJsDashApi.__esri.widgetsSearchProperties
