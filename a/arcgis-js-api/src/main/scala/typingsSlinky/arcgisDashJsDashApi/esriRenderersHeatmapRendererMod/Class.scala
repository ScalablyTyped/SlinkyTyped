package typingsSlinky.arcgisDashJsDashApi.esriRenderersHeatmapRendererMod

import typingsSlinky.arcgisDashJsDashApi.__esri.HeatmapRenderer
import typingsSlinky.arcgisDashJsDashApi.__esri.HeatmapRendererProperties
