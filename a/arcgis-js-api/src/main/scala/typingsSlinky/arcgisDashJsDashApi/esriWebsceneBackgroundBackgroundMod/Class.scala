package typingsSlinky.arcgisDashJsDashApi.esriWebsceneBackgroundBackgroundMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Background
import typingsSlinky.arcgisDashJsDashApi.__esri.BackgroundProperties
