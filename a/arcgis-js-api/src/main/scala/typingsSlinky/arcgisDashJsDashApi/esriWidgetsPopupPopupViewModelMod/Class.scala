package typingsSlinky.arcgisDashJsDashApi.esriWidgetsPopupPopupViewModelMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PopupViewModel
import typingsSlinky.arcgisDashJsDashApi.__esri.PopupViewModelProperties
