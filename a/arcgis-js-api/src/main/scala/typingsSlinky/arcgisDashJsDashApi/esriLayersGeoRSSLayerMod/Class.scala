package typingsSlinky.arcgisDashJsDashApi.esriLayersGeoRSSLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.GeoRSSLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.GeoRSSLayerProperties
