package typingsSlinky.arcgisDashJsDashApi.esriTasksGeoprocessorMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Geoprocessor
import typingsSlinky.arcgisDashJsDashApi.__esri.GeoprocessorProperties
