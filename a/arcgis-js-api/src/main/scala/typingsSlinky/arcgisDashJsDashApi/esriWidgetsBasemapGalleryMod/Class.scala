package typingsSlinky.arcgisDashJsDashApi.esriWidgetsBasemapGalleryMod

import typingsSlinky.arcgisDashJsDashApi.__esri.BasemapGallery
import typingsSlinky.arcgisDashJsDashApi.__esri.BasemapGalleryProperties
