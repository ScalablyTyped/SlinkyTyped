package typingsSlinky.arcgisDashJsDashApi.esriLayersMapNotesLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.MapNotesLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.MapNotesLayerProperties
