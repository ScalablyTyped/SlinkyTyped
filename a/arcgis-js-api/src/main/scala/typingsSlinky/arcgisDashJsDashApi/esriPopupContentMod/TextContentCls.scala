package typingsSlinky.arcgisDashJsDashApi.esriPopupContentMod

import typingsSlinky.arcgisDashJsDashApi.__esri.TextContentProperties
...
class TextContentCls ()
  extends typingsSlinky.arcgisDashJsDashApi.__esri.TextContent {
