package typingsSlinky.arcgisDashJsDashApi.esriTasksLocatorMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Locator
import typingsSlinky.arcgisDashJsDashApi.__esri.LocatorProperties
