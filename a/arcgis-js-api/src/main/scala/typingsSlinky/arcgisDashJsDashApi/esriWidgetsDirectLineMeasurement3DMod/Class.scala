...
import typingsSlinky.arcgisDashJsDashApi.__esri.DirectLineMeasurement3D
import typingsSlinky.arcgisDashJsDashApi.__esri.DirectLineMeasurement3DProperties
