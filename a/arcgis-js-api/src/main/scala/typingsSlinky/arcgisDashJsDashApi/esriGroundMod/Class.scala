package typingsSlinky.arcgisDashJsDashApi.esriGroundMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Ground
import typingsSlinky.arcgisDashJsDashApi.__esri.GroundProperties
