package typingsSlinky.arcgisDashJsDashApi.esriWidgetsEditorMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Editor
import typingsSlinky.arcgisDashJsDashApi.__esri.EditorProperties
