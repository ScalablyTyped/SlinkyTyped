package typingsSlinky.arcgisDashJsDashApi.esriWidgetsAttributionAttributionViewModelMod

import typingsSlinky.arcgisDashJsDashApi.__esri.AttributionViewModel
import typingsSlinky.arcgisDashJsDashApi.__esri.AttributionViewModelProperties
