package typingsSlinky.arcgisDashJsDashApi.esriWidgetsHistogramMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Histogram
import typingsSlinky.arcgisDashJsDashApi.__esri.HistogramProperties
