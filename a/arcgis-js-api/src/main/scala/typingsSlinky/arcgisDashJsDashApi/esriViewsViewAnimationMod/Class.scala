package typingsSlinky.arcgisDashJsDashApi.esriViewsViewAnimationMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ViewAnimation
import typingsSlinky.arcgisDashJsDashApi.__esri.ViewAnimationProperties
