package typingsSlinky.arcgisDashJsDashApi.esriTasksSupportColorRampMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ColorRamp
import typingsSlinky.arcgisDashJsDashApi.__esri.ColorRampProperties
