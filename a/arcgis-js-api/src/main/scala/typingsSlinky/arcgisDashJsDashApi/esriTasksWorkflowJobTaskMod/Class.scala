package typingsSlinky.arcgisDashJsDashApi.esriTasksWorkflowJobTaskMod

import typingsSlinky.arcgisDashJsDashApi.__esri.JobTask
import typingsSlinky.arcgisDashJsDashApi.__esri.JobTaskProperties
