package typingsSlinky.arcgisDashJsDashApi.esriWidgetsNavigationToggleNavigationToggleViewModelMod

import typingsSlinky.arcgisDashJsDashApi.__esri.NavigationToggleViewModel
import typingsSlinky.arcgisDashJsDashApi.__esri.NavigationToggleViewModelProperties
