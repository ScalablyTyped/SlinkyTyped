package typingsSlinky.arcgisDashJsDashApi.esriRenderersVisualVariablesColorVariableMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ColorVariable
import typingsSlinky.arcgisDashJsDashApi.__esri.ColorVariableProperties
