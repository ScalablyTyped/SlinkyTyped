package typingsSlinky.arcgisDashJsDashApi.esriWidgetsDirectionsMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Directions
import typingsSlinky.arcgisDashJsDashApi.__esri.DirectionsProperties
