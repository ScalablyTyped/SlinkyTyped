package typingsSlinky.arcgisDashJsDashApi.esriWidgetsAttributionMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Attribution
import typingsSlinky.arcgisDashJsDashApi.__esri.AttributionProperties
