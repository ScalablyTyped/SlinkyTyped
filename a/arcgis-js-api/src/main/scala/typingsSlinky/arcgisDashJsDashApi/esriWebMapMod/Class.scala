package typingsSlinky.arcgisDashJsDashApi.esriWebMapMod

import typingsSlinky.arcgisDashJsDashApi.__esri.WebMap
import typingsSlinky.arcgisDashJsDashApi.__esri.WebMapProperties
