package typingsSlinky.arcgisDashJsDashApi.esriSymbolsSimpleLineSymbolMod

import typingsSlinky.arcgisDashJsDashApi.__esri.SimpleLineSymbol
import typingsSlinky.arcgisDashJsDashApi.__esri.SimpleLineSymbolProperties
