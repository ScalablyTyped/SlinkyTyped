package typingsSlinky.arcgisDashJsDashApi.esriWidgetsBookmarksMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Bookmarks
import typingsSlinky.arcgisDashJsDashApi.__esri.BookmarksProperties
