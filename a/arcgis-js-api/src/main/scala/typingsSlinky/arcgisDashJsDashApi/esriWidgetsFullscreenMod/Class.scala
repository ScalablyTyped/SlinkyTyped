package typingsSlinky.arcgisDashJsDashApi.esriWidgetsFullscreenMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Fullscreen
import typingsSlinky.arcgisDashJsDashApi.__esri.FullscreenProperties
