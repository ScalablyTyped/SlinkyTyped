package typingsSlinky.arcgisDashJsDashApi.esriLayersGeoJSONLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.GeoJSONLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.GeoJSONLayerProperties
