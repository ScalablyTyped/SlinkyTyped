package typingsSlinky.arcgisDashJsDashApi.esriLayersBingMapsLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.BingMapsLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.BingMapsLayerProperties
