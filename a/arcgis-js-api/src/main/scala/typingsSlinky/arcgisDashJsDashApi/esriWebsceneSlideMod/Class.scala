package typingsSlinky.arcgisDashJsDashApi.esriWebsceneSlideMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Slide
import typingsSlinky.arcgisDashJsDashApi.__esri.SlideProperties
