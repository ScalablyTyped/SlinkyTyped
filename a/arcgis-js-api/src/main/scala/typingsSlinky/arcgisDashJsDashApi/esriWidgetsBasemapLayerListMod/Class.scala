package typingsSlinky.arcgisDashJsDashApi.esriWidgetsBasemapLayerListMod

import typingsSlinky.arcgisDashJsDashApi.__esri.BasemapLayerList
import typingsSlinky.arcgisDashJsDashApi.__esri.BasemapLayerListProperties
