package typingsSlinky.arcgisDashJsDashApi.esriTasksSupportServiceAreaSolveResultMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ServiceAreaSolveResult
import typingsSlinky.arcgisDashJsDashApi.__esri.ServiceAreaSolveResultProperties
