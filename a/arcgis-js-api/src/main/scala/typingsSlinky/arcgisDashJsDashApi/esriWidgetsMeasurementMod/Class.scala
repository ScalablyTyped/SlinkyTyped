package typingsSlinky.arcgisDashJsDashApi.esriWidgetsMeasurementMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Measurement
import typingsSlinky.arcgisDashJsDashApi.__esri.MeasurementProperties
