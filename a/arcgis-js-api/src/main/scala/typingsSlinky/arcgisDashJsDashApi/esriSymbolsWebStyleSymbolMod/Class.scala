package typingsSlinky.arcgisDashJsDashApi.esriSymbolsWebStyleSymbolMod

import typingsSlinky.arcgisDashJsDashApi.__esri.WebStyleSymbol
import typingsSlinky.arcgisDashJsDashApi.__esri.WebStyleSymbolProperties
