package typingsSlinky.arcgisDashJsDashApi.esriPortalPortalMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Portal
import typingsSlinky.arcgisDashJsDashApi.__esri.PortalProperties
