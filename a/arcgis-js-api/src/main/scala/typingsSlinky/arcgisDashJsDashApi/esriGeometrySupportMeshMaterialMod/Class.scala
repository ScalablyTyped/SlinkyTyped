package typingsSlinky.arcgisDashJsDashApi.esriGeometrySupportMeshMaterialMod

import typingsSlinky.arcgisDashJsDashApi.__esri.MeshMaterial
import typingsSlinky.arcgisDashJsDashApi.__esri.MeshMaterialProperties
