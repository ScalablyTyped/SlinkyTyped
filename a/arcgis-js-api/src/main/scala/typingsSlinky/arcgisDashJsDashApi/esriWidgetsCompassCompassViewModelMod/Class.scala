package typingsSlinky.arcgisDashJsDashApi.esriWidgetsCompassCompassViewModelMod

import typingsSlinky.arcgisDashJsDashApi.__esri.CompassViewModel
import typingsSlinky.arcgisDashJsDashApi.__esri.CompassViewModelProperties
