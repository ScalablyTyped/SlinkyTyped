package typingsSlinky.arcgisDashJsDashApi.esriRenderersVisualVariablesOpacityVariableMod

import typingsSlinky.arcgisDashJsDashApi.__esri.OpacityVariable
import typingsSlinky.arcgisDashJsDashApi.__esri.OpacityVariableProperties
