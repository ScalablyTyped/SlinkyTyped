package typingsSlinky.arcgisDashJsDashApi.esriGeometrySupportMeshTextureMod

import typingsSlinky.arcgisDashJsDashApi.__esri.MeshTexture
import typingsSlinky.arcgisDashJsDashApi.__esri.MeshTextureProperties
