package typingsSlinky.arcgisDashJsDashApi.esriWidgetsTimeSliderMod

import typingsSlinky.arcgisDashJsDashApi.__esri.TimeSlider
import typingsSlinky.arcgisDashJsDashApi.__esri.TimeSliderProperties
