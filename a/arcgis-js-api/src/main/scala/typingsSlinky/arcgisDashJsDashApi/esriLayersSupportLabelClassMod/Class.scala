package typingsSlinky.arcgisDashJsDashApi.esriLayersSupportLabelClassMod

import typingsSlinky.arcgisDashJsDashApi.__esri.LabelClass
import typingsSlinky.arcgisDashJsDashApi.__esri.LabelClassProperties
