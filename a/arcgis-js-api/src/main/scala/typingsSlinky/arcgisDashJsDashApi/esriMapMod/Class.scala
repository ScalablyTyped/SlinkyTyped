package typingsSlinky.arcgisDashJsDashApi.esriMapMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Map
import typingsSlinky.arcgisDashJsDashApi.__esri.MapProperties
