package typingsSlinky.arcgisDashJsDashApi.esriTasksClosestFacilityTaskMod

import typingsSlinky.arcgisDashJsDashApi.__esri.ClosestFacilityTask
import typingsSlinky.arcgisDashJsDashApi.__esri.ClosestFacilityTaskProperties
