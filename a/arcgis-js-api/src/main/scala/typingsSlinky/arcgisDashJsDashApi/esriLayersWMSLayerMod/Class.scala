package typingsSlinky.arcgisDashJsDashApi.esriLayersWMSLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.PortalItem
import typingsSlinky.arcgisDashJsDashApi.__esri.WMSLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.WMSLayerProperties
