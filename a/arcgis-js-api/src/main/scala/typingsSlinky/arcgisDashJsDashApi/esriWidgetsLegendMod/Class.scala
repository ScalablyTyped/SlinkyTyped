package typingsSlinky.arcgisDashJsDashApi.esriWidgetsLegendMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Legend
import typingsSlinky.arcgisDashJsDashApi.__esri.LegendProperties
