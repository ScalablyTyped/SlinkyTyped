package typingsSlinky.arcgisDashJsDashApi.esriTasksWorkflowWorkflowTaskMod

import typingsSlinky.arcgisDashJsDashApi.__esri.WorkflowTask
import typingsSlinky.arcgisDashJsDashApi.__esri.WorkflowTaskProperties
...
/**
  ...
  */
class Class () extends WorkflowTask {
