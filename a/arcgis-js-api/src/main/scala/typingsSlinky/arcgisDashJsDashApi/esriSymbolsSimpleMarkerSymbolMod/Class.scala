package typingsSlinky.arcgisDashJsDashApi.esriSymbolsSimpleMarkerSymbolMod

import typingsSlinky.arcgisDashJsDashApi.__esri.SimpleMarkerSymbol
import typingsSlinky.arcgisDashJsDashApi.__esri.SimpleMarkerSymbolProperties
