package typingsSlinky.arcgisDashJsDashApi.esriWidgetsSketchMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Sketch
import typingsSlinky.arcgisDashJsDashApi.__esri.SketchProperties
