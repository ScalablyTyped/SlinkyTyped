package typingsSlinky.arcgisDashJsDashApi.esriLayersBaseDynamicLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.BaseDynamicLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.BaseDynamicLayerProperties
