package typingsSlinky.arcgisDashJsDashApi.esriTasksIdentifyTaskMod

import typingsSlinky.arcgisDashJsDashApi.__esri.IdentifyTask
import typingsSlinky.arcgisDashJsDashApi.__esri.IdentifyTaskProperties
