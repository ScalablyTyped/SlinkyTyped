package typingsSlinky.arcgisDashJsDashApi.esriRenderersRendererMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Renderer
import typingsSlinky.arcgisDashJsDashApi.__esri.RendererProperties
