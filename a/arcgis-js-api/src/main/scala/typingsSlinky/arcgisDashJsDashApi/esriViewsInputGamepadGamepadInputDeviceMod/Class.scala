package typingsSlinky.arcgisDashJsDashApi.esriViewsInputGamepadGamepadInputDeviceMod

import typingsSlinky.arcgisDashJsDashApi.__esri.GamepadInputDevice
import typingsSlinky.arcgisDashJsDashApi.__esri.GamepadInputDeviceProperties
