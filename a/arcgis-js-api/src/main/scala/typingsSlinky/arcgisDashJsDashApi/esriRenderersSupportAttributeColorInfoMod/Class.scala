package typingsSlinky.arcgisDashJsDashApi.esriRenderersSupportAttributeColorInfoMod

import typingsSlinky.arcgisDashJsDashApi.__esri.AttributeColorInfo
import typingsSlinky.arcgisDashJsDashApi.__esri.AttributeColorInfoProperties
