package typingsSlinky.arcgisDashJsDashApi.esriLayersMapImageLayerMod

import typingsSlinky.arcgisDashJsDashApi.__esri.Collection
import typingsSlinky.arcgisDashJsDashApi.__esri.MapImageLayer
import typingsSlinky.arcgisDashJsDashApi.__esri.MapImageLayerProperties
