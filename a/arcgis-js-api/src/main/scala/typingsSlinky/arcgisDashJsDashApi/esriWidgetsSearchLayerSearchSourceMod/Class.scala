package typingsSlinky.arcgisDashJsDashApi.esriWidgetsSearchLayerSearchSourceMod

import typingsSlinky.arcgisDashJsDashApi.__esri.LayerSearchSource
import typingsSlinky.arcgisDashJsDashApi.__esri.LayerSearchSourceProperties
