...
@JSImport("@aws-sdk/client-xray-node/types/BatchGetTracesExceptionsUnion", JSImport.Namespace)
@js.native
object typesBatchGetTracesExceptionsUnionMod extends js.Object {
