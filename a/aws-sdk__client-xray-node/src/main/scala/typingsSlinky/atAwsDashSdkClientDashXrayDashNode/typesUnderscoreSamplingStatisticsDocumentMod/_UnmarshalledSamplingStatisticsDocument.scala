package typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreSamplingStatisticsDocumentMod
...
trait _UnmarshalledSamplingStatisticsDocument extends _SamplingStatisticsDocument {
  /**
    ...
    */
  @JSName("Timestamp")
  var Timestamp__UnmarshalledSamplingStatisticsDocument: js.Date
}
