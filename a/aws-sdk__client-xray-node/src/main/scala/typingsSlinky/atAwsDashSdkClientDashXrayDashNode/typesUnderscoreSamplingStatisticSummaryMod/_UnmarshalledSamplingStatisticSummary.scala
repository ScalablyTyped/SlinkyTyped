package typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreSamplingStatisticSummaryMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait _UnmarshalledSamplingStatisticSummary extends _SamplingStatisticSummary {
  /**
    * <p>The start time of the reporting window.</p>
    */
  @JSName("Timestamp")
  var Timestamp__UnmarshalledSamplingStatisticSummary: js.UndefOr[js.Date] = js.undefined
}

object _UnmarshalledSamplingStatisticSummary {
  @scala.inline
  def apply(
  ...
  ): _UnmarshalledSamplingStatisticSummary = {
    ...
    __obj.asInstanceOf[_UnmarshalledSamplingStatisticSummary]
  }
}
