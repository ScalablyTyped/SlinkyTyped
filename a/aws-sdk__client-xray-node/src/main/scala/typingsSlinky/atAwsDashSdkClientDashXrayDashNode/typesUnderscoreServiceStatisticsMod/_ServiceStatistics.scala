package typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreServiceStatisticsMod
...
trait _ServiceStatistics extends js.Object {
  /**
...
object _ServiceStatistics {
  ...
  def apply(
    ...
    __obj.asInstanceOf[_ServiceStatistics]
  }
}
