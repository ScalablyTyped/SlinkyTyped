...
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTelemetryRecordMod._TelemetryRecord
...
object typesPutTelemetryRecordsInputMod extends js.Object {
  ...
  trait PutTelemetryRecordsInput extends InputTypesUnion {
    ...
    /**
      * <p/>
      */
    var TelemetryRecords: js.Array[_TelemetryRecord] | js.Iterable[_TelemetryRecord] = js.native
  }
