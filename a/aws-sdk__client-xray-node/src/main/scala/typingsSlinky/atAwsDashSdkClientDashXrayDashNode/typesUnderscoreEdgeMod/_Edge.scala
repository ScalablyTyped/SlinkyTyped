...
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreAliasMod._Alias
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreEdgeStatisticsMod._EdgeStatistics
...
trait _Edge extends js.Object {
  /**
    ...
    */
  var Aliases: js.UndefOr[js.Array[_Alias] | js.Iterable[_Alias]] = js.undefined
  /**
...
object _Edge {
  @scala.inline
  def apply(
    Aliases: js.Array[_Alias] | js.Iterable[_Alias] = null,
