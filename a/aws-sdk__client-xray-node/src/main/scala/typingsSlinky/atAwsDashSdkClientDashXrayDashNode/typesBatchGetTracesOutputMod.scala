...
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTraceMod._UnmarshalledTrace
...
object typesBatchGetTracesOutputMod extends js.Object {
  ...
  trait BatchGetTracesOutput extends OutputTypesUnion {
    ...
    /**
      ...
      */
    var Traces: js.UndefOr[js.Array[_UnmarshalledTrace]] = js.native
    /**
