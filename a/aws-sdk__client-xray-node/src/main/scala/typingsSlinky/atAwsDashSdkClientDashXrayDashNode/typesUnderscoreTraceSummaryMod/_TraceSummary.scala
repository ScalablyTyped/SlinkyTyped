package typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTraceSummaryMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreHttpMod._Http
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreServiceIdMod._ServiceId
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTraceUserMod._TraceUser
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreValueWithServiceIdsMod._ValueWithServiceIds
...
trait _TraceSummary extends js.Object {
  ...
  var Annotations: js.UndefOr[
    (StringDictionary[js.Array[_ValueWithServiceIds] | js.Iterable[_ValueWithServiceIds]]) | (js.Iterable[
      js.Tuple2[String, js.Array[_ValueWithServiceIds] | js.Iterable[_ValueWithServiceIds]]
    ])
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Users: js.UndefOr[js.Array[_TraceUser] | js.Iterable[_TraceUser]] = js.undefined
}

object _TraceSummary {
  @scala.inline
  def apply(
    Annotations: (StringDictionary[js.Array[_ValueWithServiceIds] | js.Iterable[_ValueWithServiceIds]]) | (js.Iterable[
      js.Tuple2[String, js.Array[_ValueWithServiceIds] | js.Iterable[_ValueWithServiceIds]]
    ]) = null,
    ...
    ServiceIds: js.Array[_ServiceId] | js.Iterable[_ServiceId] = null,
    Users: js.Array[_TraceUser] | js.Iterable[_TraceUser] = null
  ): _TraceSummary = {
