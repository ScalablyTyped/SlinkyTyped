package typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTelemetryRecordMod

import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreBackendConnectionErrorsMod._UnmarshalledBackendConnectionErrors
...
trait _UnmarshalledTelemetryRecord extends _TelemetryRecord {
  ...
  /**
    ...
    */
  @JSName("Timestamp")
  var Timestamp__UnmarshalledTelemetryRecord: js.Date
}
