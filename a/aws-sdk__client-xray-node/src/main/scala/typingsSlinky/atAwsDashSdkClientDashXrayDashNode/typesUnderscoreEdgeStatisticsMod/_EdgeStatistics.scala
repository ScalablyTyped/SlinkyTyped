...
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreErrorStatisticsMod._ErrorStatistics
import typingsSlinky.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreFaultStatisticsMod._FaultStatistics
