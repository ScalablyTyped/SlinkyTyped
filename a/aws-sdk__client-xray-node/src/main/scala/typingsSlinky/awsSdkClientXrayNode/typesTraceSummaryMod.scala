...
object typesTraceSummaryMod {
  ...
  object TraceSummary {
    ...
    implicit class TraceSummaryMutableBuilder[Self <: TraceSummary] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUsers(value: js.Array[TraceUser] | js.Iterable[TraceUser]): Self = StObject.set(x, "Users", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUsersIterable(value: js.Iterable[TraceUser]): Self = StObject.set(x, "Users", value.asInstanceOf[js.Any])
