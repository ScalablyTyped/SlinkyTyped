...
object SamplingTargetDocument {
  ...
  implicit class SamplingTargetDocumentOps[Self <: SamplingTargetDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReservoirQuotaTTLDate(value: js.Date): Self = this.set("ReservoirQuotaTTL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReservoirQuotaTTL(value: js.Date | String | Double): Self = this.set("ReservoirQuotaTTL", value.asInstanceOf[js.Any])
