...
object SamplingRuleUpdate {
  ...
  implicit class SamplingRuleUpdateOps[Self <: SamplingRuleUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributesIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("Attributes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAttributes(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("Attributes", value.asInstanceOf[js.Any])
