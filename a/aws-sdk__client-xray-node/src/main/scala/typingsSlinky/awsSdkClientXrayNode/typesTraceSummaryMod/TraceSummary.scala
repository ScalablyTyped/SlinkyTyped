...
trait TraceSummary extends js.Object {
  ...
  /**
    ...
    */
  var Http: js.UndefOr[typingsSlinky.awsSdkClientXrayNode.typesHttpMod.Http] = js.undefined
  /**
...
object TraceSummary {
  @scala.inline
  def apply(
    Annotations: (StringDictionary[js.Array[ValueWithServiceIds] | js.Iterable[ValueWithServiceIds]]) | (js.Iterable[
      js.Tuple2[String, js.Array[ValueWithServiceIds] | js.Iterable[ValueWithServiceIds]]
    ]) = null,
    ...
    Users: js.Array[TraceUser] | js.Iterable[TraceUser] = null
  ): TraceSummary = {
