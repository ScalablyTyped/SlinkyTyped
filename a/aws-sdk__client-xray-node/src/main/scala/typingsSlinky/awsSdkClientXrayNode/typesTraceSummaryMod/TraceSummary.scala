...
object TraceSummary {
  ...
  implicit class TraceSummaryOps[Self <: TraceSummary] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsersIterable(value: js.Iterable[TraceUser]): Self = this.set("Users", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUsers(value: js.Array[TraceUser] | js.Iterable[TraceUser]): Self = this.set("Users", value.asInstanceOf[js.Any])
