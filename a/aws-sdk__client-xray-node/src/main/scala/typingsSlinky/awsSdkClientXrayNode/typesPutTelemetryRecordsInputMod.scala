...
object typesPutTelemetryRecordsInputMod {
  ...
  object PutTelemetryRecordsInput {
    ...
    implicit class PutTelemetryRecordsInputMutableBuilder[Self <: PutTelemetryRecordsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTelemetryRecords(value: js.Array[TelemetryRecord] | js.Iterable[TelemetryRecord]): Self = StObject.set(x, "TelemetryRecords", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTelemetryRecordsIterable(value: js.Iterable[TelemetryRecord]): Self = StObject.set(x, "TelemetryRecords", value.asInstanceOf[js.Any])
