package typingsSlinky.awsSdkClientXrayNode.typesCreateSamplingRuleInputMod
...
@js.native
trait CreateSamplingRuleInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var SamplingRule: typingsSlinky.awsSdkClientXrayNode.typesSamplingRuleMod.SamplingRule = js.native
}

object CreateSamplingRuleInput {
  @scala.inline
  def apply(SamplingRule: SamplingRule): CreateSamplingRuleInput = {
    val __obj = js.Dynamic.literal(SamplingRule = SamplingRule.asInstanceOf[js.Any])
    __obj.asInstanceOf[CreateSamplingRuleInput]
  }
  @scala.inline
  implicit class CreateSamplingRuleInputOps[Self <: CreateSamplingRuleInput] (val x: Self) extends AnyVal {
    @scala.inline
