...
@JSImport("@aws-sdk/client-xray-node/types/PutEncryptionConfigExceptionsUnion", JSImport.Namespace)
@js.native
object putEncryptionConfigExceptionsUnionMod extends js.Object {
