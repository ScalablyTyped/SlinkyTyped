...
object typesPutTraceSegmentsInputMod {
  ...
  object PutTraceSegmentsInput {
    ...
    @scala.inline
    implicit class PutTraceSegmentsInputMutableBuilder[Self <: PutTraceSegmentsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTraceSegmentDocuments(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "TraceSegmentDocuments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTraceSegmentDocumentsIterable(value: js.Iterable[String]): Self = StObject.set(x, "TraceSegmentDocuments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTraceSegmentDocumentsVarargs(value: String*): Self = StObject.set(x, "TraceSegmentDocuments", js.Array(value :_*))
    }
  }
}
