...
object Trace {
  ...
  implicit class TraceOps[Self <: Trace] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSegmentsIterable(value: js.Iterable[Segment]): Self = this.set("Segments", value.asInstanceOf[js.Any])
    @scala.inline
    def setSegments(value: js.Array[Segment] | js.Iterable[Segment]): Self = this.set("Segments", value.asInstanceOf[js.Any])
    @scala.inline
