...
object typesGetSamplingTargetsInputMod {
  ...
  object GetSamplingTargetsInput {
    ...
    implicit class GetSamplingTargetsInputMutableBuilder[Self <: GetSamplingTargetsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSamplingStatisticsDocuments(value: js.Array[SamplingStatisticsDocument] | js.Iterable[SamplingStatisticsDocument]): Self = StObject.set(x, "SamplingStatisticsDocuments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSamplingStatisticsDocumentsIterable(value: js.Iterable[SamplingStatisticsDocument]): Self = StObject.set(x, "SamplingStatisticsDocuments", value.asInstanceOf[js.Any])
