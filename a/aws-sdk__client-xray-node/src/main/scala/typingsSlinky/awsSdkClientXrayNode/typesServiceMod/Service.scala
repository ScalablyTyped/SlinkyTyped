...
object Service {
  ...
  implicit class ServiceOps[Self <: Service] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDurationHistogramIterable(value: js.Iterable[HistogramEntry]): Self = this.set("DurationHistogram", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDurationHistogram(value: js.Array[HistogramEntry] | js.Iterable[HistogramEntry]): Self = this.set("DurationHistogram", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEdgesIterable(value: js.Iterable[Edge]): Self = this.set("Edges", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEdges(value: js.Array[Edge] | js.Iterable[Edge]): Self = this.set("Edges", value.asInstanceOf[js.Any])
