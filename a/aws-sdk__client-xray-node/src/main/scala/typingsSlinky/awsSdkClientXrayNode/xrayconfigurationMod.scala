...
object xrayconfigurationMod {
  ...
  @js.native
  trait XRayConfiguration extends StObject {
  ...
  object XRayConfiguration {
    ...
    @scala.inline
    def apply(): XRayConfiguration = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[XRayConfiguration]
    }
    
    @scala.inline
    implicit class XRayConfigurationMutableBuilder[Self <: XRayConfiguration] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait XRayResolvableConfiguration extends XRayConfiguration {
  ...
  trait XRayResolvedConfiguration extends XRayConfiguration {
    ...
    @JSName("endpoint")
    def endpoint_MXRayResolvedConfiguration(): js.Promise[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.HttpEndpoint */ _
      ] = js.native
    @JSName("endpoint")
    ...
    @JSName("handler")
    def handler_MXRayResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output] = js.native
    @JSName("handler")
    ...
    def streamCollector_MXRayResolvedConfiguration(stream: js.Any): js.Promise[js.typedarray.Uint8Array] = js.native
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector = js.native
    
    @JSName("urlParser")
    def urlParser_MXRayResolvedConfiguration(url: String): Endpoint = js.native
    @JSName("urlParser")
