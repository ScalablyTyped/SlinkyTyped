...
object ServiceId {
  ...
  implicit class ServiceIdOps[Self <: ServiceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNamesIterable(value: js.Iterable[String]): Self = this.set("Names", value.asInstanceOf[js.Any])
    @scala.inline
    def setNames(value: js.Array[String] | js.Iterable[String]): Self = this.set("Names", value.asInstanceOf[js.Any])
    @scala.inline
