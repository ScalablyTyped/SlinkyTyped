...
trait EdgeStatistics extends js.Object {
  /**
    ...
    */
  var ErrorStatistics: js.UndefOr[typingsSlinky.awsSdkClientXrayNode.typesErrorStatisticsMod.ErrorStatistics] = js.undefined
  /**
    * <p>Information about requests that failed with a 5xx Server Error status code.</p>
    */
  var FaultStatistics: js.UndefOr[typingsSlinky.awsSdkClientXrayNode.typesFaultStatisticsMod.FaultStatistics] = js.undefined
  /**
