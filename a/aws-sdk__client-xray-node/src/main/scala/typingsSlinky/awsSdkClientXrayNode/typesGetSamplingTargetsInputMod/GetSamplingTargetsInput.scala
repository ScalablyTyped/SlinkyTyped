package typingsSlinky.awsSdkClientXrayNode.typesGetSamplingTargetsInputMod
...
object GetSamplingTargetsInput {
  ...
  @scala.inline
  implicit class GetSamplingTargetsInputOps[Self <: GetSamplingTargetsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSamplingStatisticsDocumentsIterable(value: js.Iterable[SamplingStatisticsDocument]): Self = this.set("SamplingStatisticsDocuments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSamplingStatisticsDocuments(value: js.Array[SamplingStatisticsDocument] | js.Iterable[SamplingStatisticsDocument]): Self = this.set("SamplingStatisticsDocuments", value.asInstanceOf[js.Any])
