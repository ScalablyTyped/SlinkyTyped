...
object GetSamplingTargetsInput {
  ...
  implicit class GetSamplingTargetsInputOps[Self <: GetSamplingTargetsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSamplingStatisticsDocumentsIterable(value: js.Iterable[SamplingStatisticsDocument]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SamplingStatisticsDocuments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSamplingStatisticsDocuments(value: js.Array[SamplingStatisticsDocument] | js.Iterable[SamplingStatisticsDocument]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SamplingStatisticsDocuments")(value.asInstanceOf[js.Any])
        ret
    }
