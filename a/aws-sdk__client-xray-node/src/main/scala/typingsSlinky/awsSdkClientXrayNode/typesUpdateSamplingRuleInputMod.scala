...
object typesUpdateSamplingRuleInputMod {
  ...
  trait UpdateSamplingRuleInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var SamplingRuleUpdate: typingsSlinky.awsSdkClientXrayNode.typesSamplingRuleUpdateMod.SamplingRuleUpdate = js.native
  }
  object UpdateSamplingRuleInput {
    
    @scala.inline
    def apply(SamplingRuleUpdate: SamplingRuleUpdate): UpdateSamplingRuleInput = {
    ...
    @scala.inline
    implicit class UpdateSamplingRuleInputMutableBuilder[Self <: UpdateSamplingRuleInput] (val x: Self) extends AnyVal {
