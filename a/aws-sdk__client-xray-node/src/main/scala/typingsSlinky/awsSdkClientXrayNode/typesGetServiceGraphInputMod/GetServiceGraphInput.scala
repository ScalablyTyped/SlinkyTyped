package typingsSlinky.awsSdkClientXrayNode.typesGetServiceGraphInputMod
...
object GetServiceGraphInput {
  ...
  @scala.inline
  def apply(EndTime: js.Date | String | Double, StartTime: js.Date | String | Double): GetServiceGraphInput = {
    val __obj = js.Dynamic.literal(EndTime = EndTime.asInstanceOf[js.Any], StartTime = StartTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetServiceGraphInput]
  }
  
  @scala.inline
  implicit class GetServiceGraphInputOps[Self <: GetServiceGraphInput] (val x: Self) extends AnyVal {
