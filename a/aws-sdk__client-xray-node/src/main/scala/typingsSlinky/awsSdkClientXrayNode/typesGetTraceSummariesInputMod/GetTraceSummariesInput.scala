package typingsSlinky.awsSdkClientXrayNode.typesGetTraceSummariesInputMod
...
object GetTraceSummariesInput {
  @scala.inline
  def apply(EndTime: js.Date | String | Double, StartTime: js.Date | String | Double): GetTraceSummariesInput = {
