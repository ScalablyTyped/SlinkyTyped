...
object PutTelemetryRecordsInput {
  ...
  implicit class PutTelemetryRecordsInputOps[Self <: PutTelemetryRecordsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTelemetryRecordsIterable(value: js.Iterable[TelemetryRecord]): Self = this.set("TelemetryRecords", value.asInstanceOf[js.Any])
    @scala.inline
    def setTelemetryRecords(value: js.Array[TelemetryRecord] | js.Iterable[TelemetryRecord]): Self = this.set("TelemetryRecords", value.asInstanceOf[js.Any])
    @scala.inline
