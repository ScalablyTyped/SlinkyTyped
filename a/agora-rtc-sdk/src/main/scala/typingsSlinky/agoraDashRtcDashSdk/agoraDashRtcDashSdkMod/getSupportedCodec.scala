...
import typingsSlinky.agoraDashRtcDashSdk.Anon_Audio
import typingsSlinky.agoraDashRtcDashSdk.Anon_Stream
...
object getSupportedCodec extends js.Object {
  /**
    ...
    * ```
    */
  def apply(): js.Promise[Anon_Audio] = js.native
  def apply(supportedCodecOptions: Anon_Stream): js.Promise[Anon_Audio] = js.native
}
