...
import typingsSlinky.agoraRtcSdk.agoraRtcSdkStrings.contain
import typingsSlinky.agoraRtcSdk.agoraRtcSdkStrings.cover
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait AnonFit extends js.Object {
  /**
    * Video display mode:
    *
...
object AnonFit {
  @scala.inline
  def apply(fit: cover | contain = null, muted: js.UndefOr[Boolean] = js.undefined): AnonFit = {
    val __obj = js.Dynamic.literal()
    if (fit != null) __obj.updateDynamic("fit")(fit.asInstanceOf[js.Any])
    if (!js.isUndefined(muted)) __obj.updateDynamic("muted")(muted.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFit]
  }
}
