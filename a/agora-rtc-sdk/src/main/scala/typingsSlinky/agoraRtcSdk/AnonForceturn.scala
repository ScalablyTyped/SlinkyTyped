...
object AnonForceturn {
  @scala.inline
  def apply(password: String, turnServerURL: String, udpport: String, username: String): AnonForceturn = {
  ...
  @scala.inline
  implicit class AnonForceturnOps[Self <: AnonForceturn] (val x: Self) extends AnyVal {
    @scala.inline
