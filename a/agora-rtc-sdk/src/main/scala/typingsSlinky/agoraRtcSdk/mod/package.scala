...
package object mod {
  ...
  /**
    ...
    */
  type LocalAudioStatsMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.agoraRtcSdk.mod.LocalAudioStats]
  ...
  /**
    ...
    */
  type LocalVideoStatsMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.agoraRtcSdk.mod.LocalVideoStats]
  ...
  /**
    ...
    */
  type RemoteAudioStatsMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.agoraRtcSdk.mod.RemoteAudioStats]
  ...
  /**
    ...
    */
  type RemoteVideoStatsMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.agoraRtcSdk.mod.RemoteVideoStats]
  ...
  /**
    ...
    */
  @scala.inline
  def VERSION: java.lang.String = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].selectDynamic("VERSION").asInstanceOf[java.lang.String]
  ...
  /**
    ...
    */
  @scala.inline
  def checkSystemRequirements(): scala.Boolean = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("checkSystemRequirements")().asInstanceOf[scala.Boolean]
  ...
  /**
    ...
    */
  @scala.inline
  def createClient(config: typingsSlinky.agoraRtcSdk.mod.ClientConfig): typingsSlinky.agoraRtcSdk.mod.Client = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createClient")(config.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.agoraRtcSdk.mod.Client]
  ...
  /**
    ...
    */
  @scala.inline
  def createStream(spec: typingsSlinky.agoraRtcSdk.mod.StreamSpec): typingsSlinky.agoraRtcSdk.mod.Stream = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createStream")(spec.asInstanceOf[js.Any]).asInstanceOf[typingsSlinky.agoraRtcSdk.mod.Stream]
  ...
  @scala.inline
  def getDevices(
    callback: js.Function1[/* devices */ js.Array[typingsSlinky.agoraRtcSdk.mod.MediaDeviceInfo], scala.Unit]
  ): scala.Unit = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getDevices")(callback.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  def getScreenSources(
    callback: js.Function1[
      /* sources */ js.Array[typingsSlinky.agoraRtcSdk.mod.DesktopCapturerSource], 
      scala.Unit
    ]
  ): scala.Unit = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getScreenSources")(callback.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def getSupportedCodec(): js.Promise[typingsSlinky.agoraRtcSdk.anon.Audio] = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getSupportedCodec")().asInstanceOf[js.Promise[typingsSlinky.agoraRtcSdk.anon.Audio]]
  @scala.inline
  def getSupportedCodec(supportedCodecOptions: typingsSlinky.agoraRtcSdk.anon.Stream): js.Promise[typingsSlinky.agoraRtcSdk.anon.Audio] = typingsSlinky.agoraRtcSdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getSupportedCodec")(supportedCodecOptions.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsSlinky.agoraRtcSdk.anon.Audio]]
}
