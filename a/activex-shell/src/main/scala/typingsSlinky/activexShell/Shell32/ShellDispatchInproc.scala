...
object ShellDispatchInproc {
  ...
  implicit class ShellDispatchInprocOps[Self <: ShellDispatchInproc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShell32DotShellDispatchInproc_typekey(value: ShellDispatchInproc): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Shell32.ShellDispatchInproc_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
