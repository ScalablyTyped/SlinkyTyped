...
import typingsSlinky.activexShell.activexShellNumbers.`1024`
import typingsSlinky.activexShell.activexShellNumbers.`128`
import typingsSlinky.activexShell.activexShellNumbers.`16`
import typingsSlinky.activexShell.activexShellNumbers.`2048`
import typingsSlinky.activexShell.activexShellNumbers.`256`
import typingsSlinky.activexShell.activexShellNumbers.`4096`
import typingsSlinky.activexShell.activexShellNumbers.`4`
import typingsSlinky.activexShell.activexShellNumbers.`512`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.activexShell.activexShellNumbers.`512`
  - typingsSlinky.activexShell.activexShellNumbers.`8192`
  - typingsSlinky.activexShell.activexShellNumbers.`2048`
  - typingsSlinky.activexShell.activexShellNumbers.`1024`
  - typingsSlinky.activexShell.activexShellNumbers.`4096`
