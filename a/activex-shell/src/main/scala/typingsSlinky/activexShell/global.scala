...
object global extends js.Object {
  ...
  object Shell32 extends js.Object {
    ...
    class FileSearchBand protected ()
      extends typingsSlinky.activexShell.Shell32.FileSearchBand
    
    /** Definition of interface Folder version 3 */
    @js.native
    class Folder3 protected ()
      extends typingsSlinky.activexShell.Shell32.Folder3
    
    /** Definition of interface FolderItemVerb */
    @js.native
    class FolderItemVerb protected ()
      extends typingsSlinky.activexShell.Shell32.FolderItemVerb {
      /** Get display name for item */
      /* CompleteClass */
      override val Name: String = js.native
      /* CompleteClass */
      @JSName("Shell32.FolderItemVerb_typekey")
      override var Shell32DotFolderItemVerb_typekey: typingsSlinky.activexShell.Shell32.FolderItemVerb = js.native
      /** Execute the verb */
      /* CompleteClass */
    ...
    class FolderItemVerbs protected ()
      extends typingsSlinky.activexShell.Shell32.FolderItemVerbs
    
    /** Definition of interface FolderItems3 */
    @js.native
    class FolderItems3 protected ()
      extends typingsSlinky.activexShell.Shell32.FolderItems3
    
    /** Shell Object Type Information */
    @js.native
    class Shell protected ()
      extends typingsSlinky.activexShell.Shell32.Shell
    
    /** ShellDispatch Load in Shell Context */
    @js.native
    class ShellDispatchInproc protected ()
      extends typingsSlinky.activexShell.Shell32.ShellDispatchInproc {
      /* CompleteClass */
      @JSName("Shell32.ShellDispatchInproc_typekey")
      override var Shell32DotShellDispatchInproc_typekey: typingsSlinky.activexShell.Shell32.ShellDispatchInproc = js.native
    }
    
    /** Shell Folder Item */
    @js.native
    class ShellFolderItem protected ()
      extends typingsSlinky.activexShell.Shell32.ShellFolderItem
    
    /** Shell Folder View Object */
    @js.native
    class ShellFolderView protected ()
      extends typingsSlinky.activexShell.Shell32.ShellFolderView
    ...
    class ShellFolderViewOC protected ()
      extends typingsSlinky.activexShell.Shell32.ShellFolderViewOC {
      /* CompleteClass */
      @JSName("Shell32.ShellFolderViewOC_typekey")
      override var Shell32DotShellFolderViewOC_typekey: typingsSlinky.activexShell.Shell32.ShellFolderViewOC = js.native
      /** Set the ShellFolderView object to monitor events of. */
      /* CompleteClass */
      override def SetFolderView(pdisp: typingsSlinky.activexShell.Shell32.ShellFolderView): Unit = js.native
    }
    
    /** Shell Link object */
    @js.native
    class ShellLinkObject protected ()
      extends typingsSlinky.activexShell.Shell32.ShellLinkObject
    
    @js.native
    class ShellWindows protected ()
      extends typingsSlinky.activexShell.Shell32.ShellWindows
