...
object inputItemLocaleRuRUMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/input-item/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/input-item/locale/ru_RU", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/input-item/locale/ru_RU", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/input-item/locale/ru_RU", "default.confirmLabel")
    @js.native
