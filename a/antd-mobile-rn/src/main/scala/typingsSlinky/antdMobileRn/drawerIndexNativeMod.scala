...
object drawerIndexNativeMod {
  ...
  trait Drawer
    ...
    var drawer: typingsSlinky.reactNativeDrawerLayout.mod.default | Null = js.native
  ...
  object DrawerNativeProps {
    ...
    implicit class DrawerNativePropsMutableBuilder[Self <: DrawerNativeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDrawerRef(value: /* el */ typingsSlinky.reactNativeDrawerLayout.mod.default | Null => Unit): Self = StObject.set(x, "drawerRef", js.Any.fromFunction1(value))
