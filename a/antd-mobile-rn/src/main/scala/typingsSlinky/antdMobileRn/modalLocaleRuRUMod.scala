...
object modalLocaleRuRUMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/modal/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/modal/locale/ru_RU", "default.buttonText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/modal/locale/ru_RU", "default.cancelText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/modal/locale/ru_RU", "default.okText")
    @js.native
