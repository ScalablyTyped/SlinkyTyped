...
object SwipeActionPropsType {
  ...
  implicit class SwipeActionPropsTypeOps[Self <: SwipeActionPropsType[_], T] (val x: Self with SwipeActionPropsType[T]) extends AnyVal {
    ...
    @scala.inline
    def setLeftVarargs(value: ClassName[T]*): Self = this.set("left", js.Array(value :_*))
    @scala.inline
    def setLeft(value: js.Array[ClassName[T]]): Self = this.set("left", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightVarargs(value: ClassName[T]*): Self = this.set("right", js.Array(value :_*))
    @scala.inline
    def setRight(value: js.Array[ClassName[T]]): Self = this.set("right", value.asInstanceOf[js.Any])
    @scala.inline
