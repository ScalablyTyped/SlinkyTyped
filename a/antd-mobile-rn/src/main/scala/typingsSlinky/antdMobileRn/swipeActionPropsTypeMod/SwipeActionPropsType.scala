...
trait SwipeActionPropsType[T] extends js.Object {
  ...
  var left: js.UndefOr[js.Array[AnonClassName[T]]] = js.native
  var onClose: js.UndefOr[js.Function0[Unit]] = js.native
  var onOpen: js.UndefOr[js.Function0[Unit]] = js.native
  var right: js.UndefOr[js.Array[AnonClassName[T]]] = js.native
...
object SwipeActionPropsType {
  ...
  implicit class SwipeActionPropsTypeOps[Self[t] <: SwipeActionPropsType[t], T] (val x: Self[T]) extends AnyVal {
    ...
    @scala.inline
    def withLeft(value: js.Array[AnonClassName[T]]): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRight(value: js.Array[AnonClassName[T]]): Self[T] = {
        val ret = this.duplicate
