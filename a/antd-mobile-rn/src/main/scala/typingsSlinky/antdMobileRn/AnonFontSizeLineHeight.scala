...
object AnonFontSizeLineHeight {
  @scala.inline
  def apply(color: String, fontSize: Double, lineHeight: Double, textAlign: String): AnonFontSizeLineHeight = {
  ...
  @scala.inline
  implicit class AnonFontSizeLineHeightOps[Self <: AnonFontSizeLineHeight] (val x: Self) extends AnyVal {
    @scala.inline
