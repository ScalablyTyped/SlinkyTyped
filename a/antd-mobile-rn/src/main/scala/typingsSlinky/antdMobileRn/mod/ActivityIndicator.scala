...
import typingsSlinky.antdMobileRn.activityIndicatorIndexNativeMod.default
import typingsSlinky.antdMobileRn.anon.Animating
...
object ActivityIndicator {
  ...
  @JSImport("antd-mobile-rn", "ActivityIndicator.defaultProps")
  @js.native
