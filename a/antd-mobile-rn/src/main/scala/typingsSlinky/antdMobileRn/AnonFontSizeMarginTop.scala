...
@js.native
trait AnonFontSizeMarginTop extends js.Object {
...
object AnonFontSizeMarginTop {
  @scala.inline
  def apply(color: String, fontSize: Double, marginTop: Double, textAlign: String): AnonFontSizeMarginTop = {
    ...
    __obj.asInstanceOf[AnonFontSizeMarginTop]
  }
  @scala.inline
  implicit class AnonFontSizeMarginTopOps[Self <: AnonFontSizeMarginTop] (val x: Self) extends AnyVal {
    @scala.inline
