...
object listPropsTypeMod {
  ...
  object ListPropsType {
    ...
    implicit class ListPropsTypeMutableBuilder[Self <: ListPropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: `false` | ReactElement | js.Array[ReactElement]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderFooter(value: js.Function0[ReactType[_]] | String | ReactElement): Self = StObject.set(x, "renderFooter", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRenderHeader(value: js.Function0[ReactType[_]] | String | ReactElement): Self = StObject.set(x, "renderHeader", value.asInstanceOf[js.Any])
