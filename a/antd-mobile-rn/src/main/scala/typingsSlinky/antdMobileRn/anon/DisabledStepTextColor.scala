...
trait DisabledStepTextColor extends js.Object {
  var container: Double with RegisteredStyleBrand
  var disabledStepTextColor: Double with RegisteredStyleBrand
  var highlightStepBorderColor: Double with RegisteredStyleBrand
  var highlightStepTextColor: Double with RegisteredStyleBrand
  var input: Double with RegisteredStyleBrand
  var stepDisabled: Double with RegisteredStyleBrand
  var stepText: Double with RegisteredStyleBrand
  var stepWrap: Double with RegisteredStyleBrand
}
