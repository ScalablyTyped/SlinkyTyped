package typingsSlinky.antdMobileRn.modalPropsTypeMod
...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.antdMobileRn.modalPropsTypeMod.Callback
  - js.Array[typingsSlinky.antdMobileRn.modalPropsTypeMod.Action[T]]
*/
