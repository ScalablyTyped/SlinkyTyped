...
trait AnonContainer extends js.Object {
  ...
  var defaultDisabledRaw: AnonBorderColor
  var defaultDisabledRawText: AnonColorString
  var defaultHighlight: AnonBorderColor
  var defaultHighlightText: AnonColorString
  var defaultRaw: AnonBorderColor
  var defaultRawText: AnonColorString
  var ghostDisabledRaw: AnonBorderColorString
  var ghostDisabledRawText: AnonColorString
  var ghostHighlight: AnonBorderColor
  var ghostHighlightText: AnonColorString
  var ghostRaw: AnonBorderColor
  var ghostRawText: AnonColorString
  var indicator: AnonMarginRight
  var largeRaw: AnonPaddingLeft
  var largeRawText: AnonFontSizeNumber
  var primaryDisabledRaw: AnonOpacity
  var primaryDisabledRawText: AnonColorString
  var primaryHighlight: AnonBorderColor
  var primaryHighlightText: AnonColorString
  var primaryRaw: AnonBorderColor
  var primaryRawText: AnonColorString
  var smallRaw: AnonPaddingLeft
  var smallRawText: AnonFontSizeNumber
  var warningDisabledRaw: AnonOpacity
  var warningDisabledRawText: AnonColorString
  var warningHighlight: AnonBorderColor
  var warningHighlightText: AnonColorString
  var warningRaw: AnonBorderColor
  var warningRawText: AnonColorString
  var wrapperStyle: AnonBorderWidth
}
