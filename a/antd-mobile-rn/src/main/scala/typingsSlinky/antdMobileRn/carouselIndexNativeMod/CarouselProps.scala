...
trait CarouselProps extends CarouselPropsType {
  ...
  var pagination: js.UndefOr[js.Function1[/* props */ PaginationProps, ReactElement]] = js.native
...
object CarouselProps {
  ...
  implicit class CarouselPropsOps[Self <: CarouselProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPagination(value: /* props */ PaginationProps => ReactElement): Self = this.set("pagination", js.Any.fromFunction1(value))
