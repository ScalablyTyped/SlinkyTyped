...
object localeRuRUMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/ru_RU", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/ru_RU", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/ru_RU", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/ru_RU", "default.okText")
    @js.native
