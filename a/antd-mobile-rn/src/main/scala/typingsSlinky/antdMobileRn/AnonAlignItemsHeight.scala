...
@js.native
trait AnonAlignItemsHeight extends js.Object {
  var alignItems: String = js.native
  var height: Double = js.native
  var justifyContent: String = js.native
}

object AnonAlignItemsHeight {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonAlignItemsHeightOps[Self <: AnonAlignItemsHeight] (val x: Self) extends AnyVal {
    @scala.inline
