...
@js.native
trait AnonPaddingRight extends js.Object {
...
object AnonPaddingRight {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonPaddingRight]
  }
  @scala.inline
  implicit class AnonPaddingRightOps[Self <: AnonPaddingRight] (val x: Self) extends AnyVal {
    @scala.inline
