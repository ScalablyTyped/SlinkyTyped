...
@js.native
trait AnonFontWeightPaddingBottom extends js.Object {
...
object AnonFontWeightPaddingBottom {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonFontWeightPaddingBottomOps[Self <: AnonFontWeightPaddingBottom] (val x: Self) extends AnyVal {
    @scala.inline
