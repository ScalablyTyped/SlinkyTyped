...
import typingsSlinky.antdMobileRn.abstractPickerMod.AbstractPickerProps
...
object Picker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdMobileRn.mod.Picker] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antdMobileRn.mod.Picker] = {
