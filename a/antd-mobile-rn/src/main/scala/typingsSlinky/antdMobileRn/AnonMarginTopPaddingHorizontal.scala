...
@js.native
trait AnonMarginTopPaddingHorizontal extends js.Object {
  var marginTop: Double = js.native
  var paddingHorizontal: Double = js.native
}

object AnonMarginTopPaddingHorizontal {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonMarginTopPaddingHorizontalOps[Self <: AnonMarginTopPaddingHorizontal] (val x: Self) extends AnyVal {
    @scala.inline
