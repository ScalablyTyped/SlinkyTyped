...
object localeEnUSMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/en_US", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/en_US", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/en_US", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/en_US", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/en_US", "default.okText")
    @js.native
