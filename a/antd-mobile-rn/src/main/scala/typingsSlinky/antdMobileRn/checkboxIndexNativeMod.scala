...
@JSImport("antd-mobile-rn/lib/checkbox/index.native", JSImport.Namespace)
@js.native
object checkboxIndexNativeMod extends js.Object {
  @js.native
  class default protected ()
    extends typingsSlinky.antdMobileRn.checkboxNativeMod.default {
