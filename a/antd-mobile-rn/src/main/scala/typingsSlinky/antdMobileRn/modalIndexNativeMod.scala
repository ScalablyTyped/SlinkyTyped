...
@JSImport("antd-mobile-rn/lib/modal/index.native", JSImport.Namespace)
@js.native
object modalIndexNativeMod extends js.Object {
  
  @js.native
  class default ()
    extends typingsSlinky.antdMobileRn.modalNativeMod.default
  /* static members */
  @js.native
