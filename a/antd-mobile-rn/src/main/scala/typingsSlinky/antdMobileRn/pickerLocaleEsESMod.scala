...
object pickerLocaleEsESMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/picker/locale/es_ES", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/picker/locale/es_ES", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/picker/locale/es_ES", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile-rn/lib/picker/locale/es_ES", "default.okText")
    @js.native
