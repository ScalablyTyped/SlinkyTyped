...
object inputItemIndexNativeMod {
  ...
  object InputItemProps {
    ...
    @scala.inline
    implicit class InputItemPropsMutableBuilder[Self <: InputItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnErrorClick(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnErrorClickUndefined: Self = StObject.set(x, "onErrorClick", js.undefined)
      
      @scala.inline
      def setOnExtraClick(value: SyntheticEvent[NodeHandle, NativeTouchEvent] => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnExtraClickUndefined: Self = StObject.set(x, "onExtraClick", js.undefined)
