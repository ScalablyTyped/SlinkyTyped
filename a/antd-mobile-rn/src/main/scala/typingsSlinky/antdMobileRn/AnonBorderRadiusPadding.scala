...
@js.native
trait AnonBorderRadiusPadding extends js.Object {
  var borderRadius: Double = js.native
  var padding: Double = js.native
}

object AnonBorderRadiusPadding {
  @scala.inline
  ...
  @scala.inline
  implicit class AnonBorderRadiusPaddingOps[Self <: AnonBorderRadiusPadding] (val x: Self) extends AnyVal {
    @scala.inline
