...
trait Anon_BorderBottomWidth extends js.Object {
  var borderBottomWidth: Double
  var borderColor: String
  var borderStyle: String
}

object Anon_BorderBottomWidth {
  @scala.inline
  def apply(borderBottomWidth: Double, borderColor: String, borderStyle: String): Anon_BorderBottomWidth = {
    ...
    __obj.asInstanceOf[Anon_BorderBottomWidth]
  }
}
