package typingsSlinky.antdDashMobileDashRn.libTextareaDashItemIndexDotNativeMod

import slinky.core.TagMod
import typingsSlinky.antdDashMobileDashRn.libTextareaDashItemPropsTypeMod.TextAreaItemPropsType
