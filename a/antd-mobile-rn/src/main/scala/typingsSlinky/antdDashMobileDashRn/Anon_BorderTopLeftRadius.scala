...
trait Anon_BorderTopLeftRadius extends js.Object {
  var borderTopLeftRadius: Double
  var borderTopRightRadius: Double
  var borderTopWidth: Double
}

object Anon_BorderTopLeftRadius {
  @scala.inline
  def apply(borderTopLeftRadius: Double, borderTopRightRadius: Double, borderTopWidth: Double): Anon_BorderTopLeftRadius = {
    ...
    __obj.asInstanceOf[Anon_BorderTopLeftRadius]
  }
}
