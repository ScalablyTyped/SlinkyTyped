...
import typingsSlinky.antdDashMobileDashRn.libCardCardFooterDotNativeMod.CardFooterProps
import typingsSlinky.antdDashMobileDashRn.libCardCardFooterDotNativeMod.default
