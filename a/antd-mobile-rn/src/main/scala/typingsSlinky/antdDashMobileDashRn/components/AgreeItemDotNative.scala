...
import typingsSlinky.antdDashMobileDashRn.libCheckboxAgreeItemDotNativeMod.AgreeItemNativeProps
import typingsSlinky.antdDashMobileDashRn.libCheckboxAgreeItemDotNativeMod.default
...
object AgreeItemDotNative
  ...
  typingsSlinky.antdDashMobileDashRn.libCheckboxAgreeItemDotNativeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
