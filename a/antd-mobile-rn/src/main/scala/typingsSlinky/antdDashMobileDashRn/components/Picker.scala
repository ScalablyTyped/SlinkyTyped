...
import typingsSlinky.antdDashMobileDashRn.libPickerAbstractPickerMod.AbstractPickerProps
...
object Picker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Picker] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Picker] = {
  ...
  type Props = AbstractPickerProps
}
