...
import typingsSlinky.antdDashMobileDashRn.libPopoverIndexDotNativeMod.PopoverProps
...
object Popover
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Popover] {
  ...
  def apply(
    ...
    renderOverlayComponent: /* values */ js.Any => typingsSlinky.react.reactMod._Global_.JSX.Element = null,
    style: StyleProp[ViewStyle] = null,
    triggerStyle: StyleProp[ViewStyle] = null,
    _overrides: StringDictionary[js.Any] = null
  ): BuildingComponent[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Popover] = {
