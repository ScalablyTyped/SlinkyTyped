...
import typingsSlinky.antdDashMobileDashRn.libCarouselIndexDotNativeMod.CarouselState
import typingsSlinky.antdDashMobileDashRn.libCarouselIndexDotNativeMod.PaginationProps
...
object Carousel
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Carousel] {
  ...
  def apply(
    ...
    onMomentumScrollEnd: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ CarouselState, /* carousel */ typingsSlinky.antdDashMobileDashRn.libCarouselIndexDotNativeMod.Carousel) => Unit = null,
    onScrollBeginDrag: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ CarouselState, /* carousel */ typingsSlinky.antdDashMobileDashRn.libCarouselIndexDotNativeMod.Carousel) => Unit = null,
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Carousel] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Carousel] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Carousel](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
