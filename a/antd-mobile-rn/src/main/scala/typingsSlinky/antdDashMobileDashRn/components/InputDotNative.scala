...
import typingsSlinky.antdDashMobileDashRn.libInputDashItemInputDotNativeMod.TextInputProps
import typingsSlinky.antdDashMobileDashRn.libInputDashItemInputDotNativeMod.default
...
object InputDotNative
  ...
  typingsSlinky.antdDashMobileDashRn.libInputDashItemInputDotNativeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
