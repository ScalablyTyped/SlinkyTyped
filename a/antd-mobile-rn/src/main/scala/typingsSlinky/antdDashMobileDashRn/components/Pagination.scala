...
import typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnStrings.button
import typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnStrings.number
import typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnStrings.pointer
import typingsSlinky.antdDashMobileDashRn.libPaginationIndexDotNativeMod.PaginationNativeProps
import typingsSlinky.antdDashMobileDashRn.libPaginationStyleIndexDotNativeMod.IPaginationStyle
...
object Pagination
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Pagination] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnMod.Pagination] = {
