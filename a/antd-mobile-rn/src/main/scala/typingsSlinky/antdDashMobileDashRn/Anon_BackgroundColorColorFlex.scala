...
trait Anon_BackgroundColorColorFlex extends js.Object {
...
object Anon_BackgroundColorColorFlex {
  @scala.inline
  def apply(backgroundColor: String, color: String, flex: Double, fontSize: Double, height: Double): Anon_BackgroundColorColorFlex = {
    ...
    __obj.asInstanceOf[Anon_BackgroundColorColorFlex]
  }
}
