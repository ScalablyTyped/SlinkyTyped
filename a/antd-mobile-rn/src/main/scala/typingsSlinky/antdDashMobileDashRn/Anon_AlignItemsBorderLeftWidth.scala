...
trait Anon_AlignItemsBorderLeftWidth extends js.Object {
...
object Anon_AlignItemsBorderLeftWidth {
  @scala.inline
  def apply(
    alignItems: String,
  ...
  ): Anon_AlignItemsBorderLeftWidth = {
    ...
    __obj.asInstanceOf[Anon_AlignItemsBorderLeftWidth]
  }
}
