package typingsSlinky.antdDashMobileDashRn.libDrawerIndexDotNativeMod
...
import typingsSlinky.antdDashMobileDashRn.libDrawerPropsTypeMod.DrawerProps
...
trait DrawerNativeProps extends DrawerProps {
  ...
  var drawerRef: js.UndefOr[
    js.Function1[
      /* el */ typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default | Null, 
      Unit
    ]
  ] = js.undefined
...
object DrawerNativeProps {
  ...
  def apply(
    ...
    drawerRef: /* el */ typingsSlinky.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default | Null => Unit = null,
