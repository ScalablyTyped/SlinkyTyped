...
trait Anon_AlignItemsBackgroundColorBottom extends js.Object {
...
object Anon_AlignItemsBackgroundColorBottom {
  @scala.inline
  def apply(
    alignItems: String,
    ...
    top: Double,
    zIndex: Double
  ): Anon_AlignItemsBackgroundColorBottom = {
    ...
    __obj.asInstanceOf[Anon_AlignItemsBackgroundColorBottom]
  }
}
