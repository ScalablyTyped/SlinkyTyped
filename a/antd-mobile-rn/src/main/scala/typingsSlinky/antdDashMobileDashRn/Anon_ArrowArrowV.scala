...
trait Anon_ArrowArrowV extends js.Object {
  ...
  var Brief: Anon_MinHeight
  var BriefText: Anon_ColorFontSizePaddingTop
  var Content: Anon_ColorFontSizeTextAlignVertical
  var Extra: Anon_ColorFontSizeTextAlignTextAlignVertical
...
object Anon_ArrowArrowV {
  ...
  def apply(
    ...
    Brief: Anon_MinHeight,
    BriefText: Anon_ColorFontSizePaddingTop,
    Content: Anon_ColorFontSizeTextAlignVertical,
    Extra: Anon_ColorFontSizeTextAlignTextAlignVertical,
    ...
    __obj.asInstanceOf[Anon_ArrowArrowV]
  }
}
