...
trait Anon_ColorFlex extends js.Object {
  var color: String
  var flex: Double
  var fontSize: Double
}

object Anon_ColorFlex {
  @scala.inline
  def apply(color: String, flex: Double, fontSize: Double): Anon_ColorFlex = {
    ...
    __obj.asInstanceOf[Anon_ColorFlex]
  }
}
