...
trait Anon_AlignItemsBackgroundColorFlexDirectionHeightPaddingLeft extends js.Object {
...
object Anon_AlignItemsBackgroundColorFlexDirectionHeightPaddingLeft {
  @scala.inline
  def apply(
    alignItems: String,
