package typingsSlinky.antdDashMobileDashRn.libCardCardHeaderDotNativeMod

import slinky.core.TagMod
import typingsSlinky.antdDashMobileDashRn.libCardPropsTypeMod.CardHeaderPropsType
