package typingsSlinky.antdDashMobileDashRn.libActivityDashIndicatorIndexDotNativeMod
...
import typingsSlinky.antdDashMobileDashRn.libActivityDashIndicatorPropsTypeMod.ActivityIndicatorPropTypes
