package typingsSlinky.antdDashMobileDashRn.libModalPromptContainerDotNativeMod
...
trait PropmptContainerProps extends js.Object {
  ...
  var `type`: js.UndefOr[
    typingsSlinky.antdDashMobileDashRn.antdDashMobileDashRnStrings.default | `login-password` | `secure-text`
  ] = js.undefined
}
