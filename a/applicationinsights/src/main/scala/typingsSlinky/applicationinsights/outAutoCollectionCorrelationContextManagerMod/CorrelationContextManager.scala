package typingsSlinky.applicationinsights.outAutoCollectionCorrelationContextManagerMod
...
object CorrelationContextManager extends js.Object {
  ...
  def generateContextObject(
    ...
    correlationContextHeader: String,
    traceparent: ^,
    tracestate: typingsSlinky.applicationinsights.outLibraryTracestateMod.^
  ): CorrelationContext = js.native
  /**
