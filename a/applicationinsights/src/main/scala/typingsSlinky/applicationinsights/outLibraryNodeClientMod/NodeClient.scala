package typingsSlinky.applicationinsights.outLibraryNodeClientMod

import typingsSlinky.applicationinsights.outDeclarationsContractsTelemetryTypesNodeHttpDependencyTelemetryMod.NodeHttpDependencyTelemetry
...
@js.native
trait NodeClient
  extends typingsSlinky.applicationinsights.outLibraryTelemetryClientMod.^ {
  /**
