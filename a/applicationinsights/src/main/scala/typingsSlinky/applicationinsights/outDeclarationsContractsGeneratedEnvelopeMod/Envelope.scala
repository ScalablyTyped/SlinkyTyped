package typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedEnvelopeMod
...
trait Envelope extends js.Object {
  /**
    * Telemetry data item.
    */
  var data: typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedBaseMod.^
  /**
...
object Envelope {
  @scala.inline
  def apply(
    data: typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedBaseMod.^,
    iKey: String,
    name: String,
    sampleRate: Double,
    seq: String,
