package typingsSlinky.applicationinsights.outLibraryUtilMod
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def canIncludeCorrelationHeader(client: typingsSlinky.applicationinsights.outLibraryTelemetryClientMod.^, requestUrl: String): Boolean = js.native
  /**
    * Using JSON.stringify, by default Errors do not serialize to something useful:
    * Simplify a generic Node Error into a simpler map for customDimensions
    * Custom errors can still implement toJSON to override this functionality
    */
  /* protected */ def extractError(err: js.Error): Anon_Code = js.native
  /**
