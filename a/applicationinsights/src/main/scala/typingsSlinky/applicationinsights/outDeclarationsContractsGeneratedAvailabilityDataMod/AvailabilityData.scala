package typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedAvailabilityDataMod
...
trait AvailabilityData
  extends typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedDomainMod.^ {
  /**
