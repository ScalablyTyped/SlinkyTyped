...
import typingsSlinky.applicationinsights.applicationinsightsMod.Configuration
import typingsSlinky.applicationinsights.applicationinsightsMod.DistributedTracingModes
import typingsSlinky.applicationinsights.outAutoCollectionNativePerformanceMod.IDisabledExtendedMetrics
