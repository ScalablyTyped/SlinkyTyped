package typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedExceptionDetailsMod
...
trait ExceptionDetails extends js.Object {
  ...
  /**
    ...
    */
  var parsedStack: js.Array[
    typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedStackFrameMod.^
  ]
  /**
