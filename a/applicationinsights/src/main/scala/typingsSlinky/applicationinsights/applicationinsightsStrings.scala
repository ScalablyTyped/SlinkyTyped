...
import typingsSlinky.applicationinsights.outDeclarationsConstantsMod.QuickPulseDocumentType
import typingsSlinky.applicationinsights.outDeclarationsConstantsMod.QuickPulseType
import typingsSlinky.applicationinsights.outDeclarationsContractsConstantsMod.ConnectionStringKey
import typingsSlinky.applicationinsights.outDeclarationsContractsTelemetryTypesTelemetryTypeMod.TelemetryTypeKeys
