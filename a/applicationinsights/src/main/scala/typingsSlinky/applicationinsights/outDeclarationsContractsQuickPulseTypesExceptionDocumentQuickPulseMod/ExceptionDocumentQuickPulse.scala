package typingsSlinky.applicationinsights.outDeclarationsContractsQuickPulseTypesExceptionDocumentQuickPulseMod

import typingsSlinky.applicationinsights.outDeclarationsContractsQuickPulseTypesDocumentQuickPulseMod.DocumentQuickPulse
import typingsSlinky.applicationinsights.outDeclarationsContractsQuickPulseTypesDocumentQuickPulseMod.IDocumentProperty
