package typingsSlinky.applicationinsights.outAutoCollectionHttpRequestParserMod
...
trait HttpRequestParser extends RequestParser {
  ...
  def getTraceparent(): typingsSlinky.applicationinsights.outLibraryTraceparentMod.^ = js.native
  def getTracestate(): typingsSlinky.applicationinsights.outLibraryTracestateMod.^ = js.native
