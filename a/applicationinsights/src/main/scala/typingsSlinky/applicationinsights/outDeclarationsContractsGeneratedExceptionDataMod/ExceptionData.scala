package typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedExceptionDataMod
...
trait ExceptionData
  ...
  var exceptions: js.Array[
    typingsSlinky.applicationinsights.outDeclarationsContractsGeneratedExceptionDetailsMod.^
  ] = js.native
  /**
