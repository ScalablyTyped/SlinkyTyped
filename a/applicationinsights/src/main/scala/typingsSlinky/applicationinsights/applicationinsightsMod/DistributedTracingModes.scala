...
object DistributedTracingModes extends js.Object {
  ...
  /* 0 */ val AI: typingsSlinky.applicationinsights.applicationinsightsMod.DistributedTracingModes.AI with Double = js.native
  /* 1 */ val AI_AND_W3C: typingsSlinky.applicationinsights.applicationinsightsMod.DistributedTracingModes.AI_AND_W3C with Double = js.native
  @JSBracketAccess
