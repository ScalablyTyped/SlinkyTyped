...
@JSImport("applicationinsights", "Contracts.RemoteDependencyDataConstants")
@js.native
class RemoteDependencyDataConstants ()
  extends typingsSlinky.applicationinsights.outDeclarationsContractsMod.RemoteDependencyDataConstants
