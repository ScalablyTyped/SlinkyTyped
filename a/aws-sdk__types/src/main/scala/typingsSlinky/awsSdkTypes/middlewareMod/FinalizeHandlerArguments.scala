...
object FinalizeHandlerArguments {
  ...
  @scala.inline
  implicit class FinalizeHandlerArgumentsOps[Self <: FinalizeHandlerArguments[_, _], Input /* <: js.Object */, Stream] (val x: Self with (FinalizeHandlerArguments[Input, Stream])) extends AnyVal {
