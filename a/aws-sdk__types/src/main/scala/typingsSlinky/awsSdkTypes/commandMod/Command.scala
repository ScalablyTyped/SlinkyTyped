...
object Command {
  ...
  @scala.inline
  implicit class CommandOps[Self <: Command[_, _, _, _, _, _], ClientInput /* <: CommandInput */, InputType /* <: ClientInput */, ClientOutput /* <: MetadataBearer */, OutputType /* <: ClientOutput */, ResolvedConfiguration, StreamType] (val x: Self with (Command[ClientInput, InputType, ClientOutput, OutputType, ResolvedConfiguration, StreamType])) extends AnyVal {
