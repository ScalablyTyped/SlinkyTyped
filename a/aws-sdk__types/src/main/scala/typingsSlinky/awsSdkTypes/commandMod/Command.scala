...
object Command {
  @scala.inline
  def apply[/* <: typingsSlinky.awsSdkTypes.commandMod.CommandInput */ ClientInput, /* <: ClientInput */ InputType, /* <: typingsSlinky.awsSdkTypes.responseMod.MetadataBearer */ ClientOutput, /* <: ClientOutput */ OutputType, ResolvedConfiguration, StreamType](
    input: InputType,
  ...
  @scala.inline
  implicit class CommandOps[Self <: Command[_, _, _, _, _, _], /* <: typingsSlinky.awsSdkTypes.commandMod.CommandInput */ ClientInput, /* <: ClientInput */ InputType, /* <: typingsSlinky.awsSdkTypes.responseMod.MetadataBearer */ ClientOutput, /* <: ClientOutput */ OutputType, ResolvedConfiguration, StreamType] (val x: Self with (Command[ClientInput, InputType, ClientOutput, OutputType, ResolvedConfiguration, StreamType])) extends AnyVal {
    @scala.inline
