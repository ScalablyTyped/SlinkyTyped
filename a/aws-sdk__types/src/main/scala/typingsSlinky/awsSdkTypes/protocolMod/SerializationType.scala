...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.blob
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.boolean
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.float
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.integer
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.list
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.map
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.string
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.structure
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.timestamp
*/
