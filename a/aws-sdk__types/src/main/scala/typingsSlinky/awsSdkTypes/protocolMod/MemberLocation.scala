...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.header
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.headers
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.uri
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.querystring
  - typingsSlinky.awsSdkTypes.awsSdkTypesStrings.statusCode
*/
