...
object ConfigurationPropertyDefinition {
  ...
  @scala.inline
  def apply[InputType, ResolvedType /* <: InputType */, ServiceConfiguration /* <: StringDictionary[js.Any] */, ResolvedConfiguration /* <: ServiceConfiguration */](): ConfigurationPropertyDefinition[InputType, ResolvedType, ServiceConfiguration, ResolvedConfiguration] = {
  ...
  @scala.inline
  implicit class ConfigurationPropertyDefinitionOps[Self <: ConfigurationPropertyDefinition[_, _, _, _], InputType, ResolvedType /* <: InputType */, ServiceConfiguration /* <: StringDictionary[js.Any] */, ResolvedConfiguration /* <: ServiceConfiguration */] (val x: Self with (ConfigurationPropertyDefinition[InputType, ResolvedType, ServiceConfiguration, ResolvedConfiguration])) extends AnyVal {
