...
import typingsSlinky.amqplib.propertiesMod.Options.DeleteQueue
  ...
  trait Channel extends EventEmitter {
    ...
    def assertExchange(
      ...
      callback: js.Function2[
          /* err */ js.Any, 
          /* ok */ typingsSlinky.amqplib.propertiesMod.Replies.AssertExchange, 
          Unit
        ]
    ): Unit = js.native
    ...
    def assertQueue(
      ...
      callback: js.Function2[
          /* err */ js.Any, 
          /* ok */ typingsSlinky.amqplib.propertiesMod.Replies.AssertQueue, 
          Unit
        ]
    ): Unit = js.native
    ...
    def consume(
      ...
      options: Consume,
      callback: js.Function2[/* err */ js.Any, /* ok */ typingsSlinky.amqplib.propertiesMod.Replies.Consume, Unit]
    ): Unit = js.native
    ...
    def deleteQueue(
      ...
      callback: js.Function2[
          /* err */ js.Any, 
          /* ok */ typingsSlinky.amqplib.propertiesMod.Replies.DeleteQueue, 
          Unit
        ]
    ): Unit = js.native
