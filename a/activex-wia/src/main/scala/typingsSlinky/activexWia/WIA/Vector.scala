...
trait Vector[TItem] extends js.Object {
  ...
  /**
    ...
    */
  def ImageFile(): typingsSlinky.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: js.UndefOr[scala.Nothing], Height: Double): typingsSlinky.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double): typingsSlinky.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double, Height: Double): typingsSlinky.activexWia.WIA.ImageFile = js.native
