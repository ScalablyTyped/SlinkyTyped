...
trait Vector[TItem] extends js.Object {
  ...
  /**
    ...
    */
  def ImageFile(): typingsSlinky.activexDashWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double): typingsSlinky.activexDashWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double, Height: Double): typingsSlinky.activexDashWia.WIA.ImageFile = js.native
  /** Returns the specified item in the vector by position */
