...
object ThreeDFormat {
  ...
  implicit class ThreeDFormatOps[Self <: ThreeDFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOfficeDotThreeDFormat_typekey(value: ThreeDFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Office.ThreeDFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
