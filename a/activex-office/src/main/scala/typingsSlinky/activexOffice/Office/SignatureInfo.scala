...
trait SignatureInfo extends js.Object {
  ...
  val CertificateVerificationResults: typingsSlinky.activexOffice.Office.CertificateVerificationResults
  val ContentVerificationResults: typingsSlinky.activexOffice.Office.ContentVerificationResults
  val Creator: Double
