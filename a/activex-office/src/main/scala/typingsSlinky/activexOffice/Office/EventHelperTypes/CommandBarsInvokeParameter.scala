...
@js.native
trait CommandBarsInvokeParameter extends js.Object {
...
object CommandBarsInvokeParameter {
  ...
  @scala.inline
  implicit class CommandBarsInvokeParameterOps[Self <: CommandBarsInvokeParameter] (val x: Self) extends AnyVal {
    @scala.inline
