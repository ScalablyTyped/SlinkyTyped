...
*/
trait MsoBlogImageType extends StObject
object MsoBlogImageType {
  
  @scala.inline
  def msoblogImageTypeGIF: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoblogImageTypeJPEG: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoblogImageTypePNG: `3` = 3.asInstanceOf[`3`]
}
