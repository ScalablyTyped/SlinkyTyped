...
object MsoAlertDefaultType {
  ...
  @scala.inline
  def msoAlertDefaultFifth: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def msoAlertDefaultFirst: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoAlertDefaultFourth: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoAlertDefaultSecond: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoAlertDefaultThird: `2` = 2.asInstanceOf[`2`]
}
