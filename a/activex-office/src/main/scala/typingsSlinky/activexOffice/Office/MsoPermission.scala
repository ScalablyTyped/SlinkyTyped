...
import typingsSlinky.activexOffice.activexOfficeNumbers.`127`
...
import typingsSlinky.activexOffice.activexOfficeNumbers.`64`
...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.activexOffice.activexOfficeNumbers.`127`
  ...
  - typingsSlinky.activexOffice.activexOfficeNumbers.`64`
