...
object PictureFormat {
  ...
  implicit class PictureFormatOps[Self <: PictureFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOfficeDotPictureFormat_typekey(value: PictureFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Office.PictureFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
