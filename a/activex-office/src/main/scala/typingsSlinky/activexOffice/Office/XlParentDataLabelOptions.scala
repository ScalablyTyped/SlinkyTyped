...
*/
trait XlParentDataLabelOptions extends js.Object
object XlParentDataLabelOptions {
  
  @scala.inline
  def xlParentDataLabelOptionsBanner: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def xlParentDataLabelOptionsNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def xlParentDataLabelOptionsOverlapping: `2` = 2.asInstanceOf[`2`]
}
