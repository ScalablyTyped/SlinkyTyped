...
object MsoAlertIconType {
  @scala.inline
  def msoAlertIconCritical: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def msoAlertIconInfo: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def msoAlertIconNoIcon: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def msoAlertIconQuery: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def msoAlertIconWarning: `3` = 3.asInstanceOf[`3`]
}
