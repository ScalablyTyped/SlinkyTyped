...
import typingsSlinky.activexOffice.activexOfficeNumbers.`-4128`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.activexOffice.activexOfficeNumbers.`-4170`
  - typingsSlinky.activexOffice.activexOfficeNumbers.`-4128`
