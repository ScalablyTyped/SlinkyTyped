...
*/
trait MsoAlignCmd extends js.Object

object MsoAlignCmd {
  @scala.inline
  def msoAlignBottoms: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def msoAlignCenters: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def msoAlignLefts: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def msoAlignMiddles: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def msoAlignRights: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def msoAlignTops: `3` = 3.asInstanceOf[`3`]
}
