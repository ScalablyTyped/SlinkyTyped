...
object MsoFilterComparison {
  ...
  @scala.inline
  def msoFilterComparisonContains: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def msoFilterComparisonEqual: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoFilterComparisonGreaterThan: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoFilterComparisonGreaterThanEqual: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def msoFilterComparisonIsBlank: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def msoFilterComparisonIsNotBlank: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def msoFilterComparisonLessThan: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoFilterComparisonLessThanEqual: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def msoFilterComparisonNotContains: `9` = 9.asInstanceOf[`9`]
  
  @scala.inline
  def msoFilterComparisonNotEqual: `1` = 1.asInstanceOf[`1`]
}
