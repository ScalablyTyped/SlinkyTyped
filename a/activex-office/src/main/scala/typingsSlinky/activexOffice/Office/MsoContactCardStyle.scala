...
*/
trait MsoContactCardStyle extends StObject
object MsoContactCardStyle {
  
  @scala.inline
  def msoContactCardFull: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoContactCardHover: `0` = 0.asInstanceOf[`0`]
}
