...
object LineFormat {
  ...
  implicit class LineFormatOps[Self <: LineFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOfficeDotLineFormat_typekey(value: LineFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Office.LineFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
