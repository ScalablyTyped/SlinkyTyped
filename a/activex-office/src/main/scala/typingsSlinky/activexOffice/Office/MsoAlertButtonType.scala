...
*/
trait MsoAlertButtonType extends StObject
object MsoAlertButtonType {
  
  @scala.inline
  def msoAlertButtonAbortRetryIgnore: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoAlertButtonOK: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoAlertButtonOKCancel: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoAlertButtonRetryCancel: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def msoAlertButtonYesAllNoCancel: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def msoAlertButtonYesNo: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def msoAlertButtonYesNoCancel: `3` = 3.asInstanceOf[`3`]
}
