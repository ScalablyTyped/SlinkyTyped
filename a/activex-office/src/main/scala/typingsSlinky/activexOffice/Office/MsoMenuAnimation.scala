...
*/
trait MsoMenuAnimation extends StObject
object MsoMenuAnimation {
  
  @scala.inline
  def msoMenuAnimationNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoMenuAnimationRandom: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoMenuAnimationSlide: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoMenuAnimationUnfold: `2` = 2.asInstanceOf[`2`]
}
