...
*/
trait MsoTextFontAlign extends js.Object

object MsoTextFontAlign {
  @scala.inline
  def msoFontAlignAuto: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def msoFontAlignBaseline: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def msoFontAlignBottom: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def msoFontAlignCenter: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def msoFontAlignMixed: `-2` = -2.asInstanceOf[`-2`]
  @scala.inline
  def msoFontAlignTop: `1` = 1.asInstanceOf[`1`]
}
