...
object MsoTextFontAlign {
  ...
  @scala.inline
  def msoFontAlignAuto: `0` = this.cast(0)
  @scala.inline
  def msoFontAlignBaseline: `3` = this.cast(3)
  @scala.inline
  def msoFontAlignBottom: `4` = this.cast(4)
  @scala.inline
  def msoFontAlignCenter: `2` = this.cast(2)
  @scala.inline
  def msoFontAlignMixed: `-2` = this.cast(-2)
  @scala.inline
  def msoFontAlignTop: `1` = this.cast(1)
}
