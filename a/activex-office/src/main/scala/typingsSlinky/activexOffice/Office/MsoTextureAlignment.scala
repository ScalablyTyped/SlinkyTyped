...
object MsoTextureAlignment {
  @scala.inline
  def msoTextureAlignmentMixed: `-2` = -2.asInstanceOf[`-2`]
  @scala.inline
  def msoTextureBottom: `7` = 7.asInstanceOf[`7`]
  @scala.inline
  def msoTextureBottomLeft: `6` = 6.asInstanceOf[`6`]
  @scala.inline
  def msoTextureBottomRight: `8` = 8.asInstanceOf[`8`]
  @scala.inline
  def msoTextureCenter: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def msoTextureLeft: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def msoTextureRight: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def msoTextureTop: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def msoTextureTopLeft: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def msoTextureTopRight: `2` = 2.asInstanceOf[`2`]
}
