...
object MsoLineFillType {
  ...
  @scala.inline
  def msoLineFillBackground: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def msoLineFillGradient: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoLineFillMixed: `-2` = -2.asInstanceOf[`-2`]
  
  @scala.inline
  def msoLineFillNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoLineFillPatterned: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoLineFillPicture: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def msoLineFillSolid: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoLineFillTextured: `4` = 4.asInstanceOf[`4`]
}
