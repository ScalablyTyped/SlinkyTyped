...
class LanguageSettings protected ()
  extends typingsSlinky.activexOffice.Office.LanguageSettings {
  /* CompleteClass */
  ...
  override var OfficeDotLanguageSettings_typekey: typingsSlinky.activexOffice.Office.LanguageSettings = js.native
  /* CompleteClass */
