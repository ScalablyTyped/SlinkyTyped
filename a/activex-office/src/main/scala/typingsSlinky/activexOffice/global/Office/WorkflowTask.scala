...
class WorkflowTask protected ()
  extends typingsSlinky.activexOffice.Office.WorkflowTask {
  /* CompleteClass */
  ...
  override var OfficeDotWorkflowTask_typekey: typingsSlinky.activexOffice.Office.WorkflowTask = js.native
  /* CompleteClass */
