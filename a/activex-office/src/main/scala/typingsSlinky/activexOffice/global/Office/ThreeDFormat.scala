...
class ThreeDFormat protected ()
  extends typingsSlinky.activexOffice.Office.ThreeDFormat {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ContourColor: typingsSlinky.activexOffice.Office.ColorFormat = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ExtrusionColor: typingsSlinky.activexOffice.Office.ColorFormat = js.native
  /* CompleteClass */
  ...
  override var OfficeDotThreeDFormat_typekey: typingsSlinky.activexOffice.Office.ThreeDFormat = js.native
  /* CompleteClass */
