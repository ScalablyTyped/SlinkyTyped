...
class COMAddIn protected ()
  extends typingsSlinky.activexOffice.Office.COMAddIn {
  /* CompleteClass */
  override val Application: js.Any = js.native
  /* CompleteClass */
  override var Connect: Boolean = js.native
  /* CompleteClass */
  ...
  override var OfficeDotCOMAddIn_typekey: typingsSlinky.activexOffice.Office.COMAddIn = js.native
  /* CompleteClass */
