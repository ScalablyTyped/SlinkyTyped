...
class DocumentLibraryVersion protected ()
  extends typingsSlinky.activexOffice.Office.DocumentLibraryVersion {
  /* CompleteClass */
  ...
  override var OfficeDotDocumentLibraryVersion_typekey: typingsSlinky.activexOffice.Office.DocumentLibraryVersion = js.native
  /* CompleteClass */
