...
class SharedWorkspaceTask protected ()
  extends typingsSlinky.activexOffice.Office.SharedWorkspaceTask {
  /* CompleteClass */
  ...
  override var OfficeDotSharedWorkspaceTask_typekey: typingsSlinky.activexOffice.Office.SharedWorkspaceTask = js.native
  /* CompleteClass */
