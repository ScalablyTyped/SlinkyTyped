...
class SharedWorkspaceLink protected ()
  extends typingsSlinky.activexOffice.Office.SharedWorkspaceLink {
  /* CompleteClass */
  ...
  override var OfficeDotSharedWorkspaceLink_typekey: typingsSlinky.activexOffice.Office.SharedWorkspaceLink = js.native
  /* CompleteClass */
