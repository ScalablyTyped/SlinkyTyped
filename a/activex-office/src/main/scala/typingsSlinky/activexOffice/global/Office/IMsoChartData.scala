...
class IMsoChartData protected ()
  extends typingsSlinky.activexOffice.Office.IMsoChartData {
  /* CompleteClass */
  override val IsLinked: Boolean = js.native
  /* CompleteClass */
  @JSName("Office.IMsoChartData_typekey")
  override var OfficeDotIMsoChartData_typekey: typingsSlinky.activexOffice.Office.IMsoChartData = js.native
  /* CompleteClass */
  override val Workbook: js.Any = js.native
  /* CompleteClass */
  override def Activate(): Unit = js.native
  /* CompleteClass */
  override def ActivateChartDataWindow(): Unit = js.native
  /* CompleteClass */
