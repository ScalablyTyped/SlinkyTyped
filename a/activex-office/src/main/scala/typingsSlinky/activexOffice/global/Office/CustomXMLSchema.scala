...
class CustomXMLSchema protected ()
  extends typingsSlinky.activexOffice.Office.CustomXMLSchema {
  /* CompleteClass */
  override val Application: js.Any = js.native
  /* CompleteClass */
  override val Creator: Double = js.native
  /* CompleteClass */
  override val Location: String = js.native
  /* CompleteClass */
  override val NamespaceURI: String = js.native
  /* CompleteClass */
  @JSName("Office.CustomXMLSchema_typekey")
  override var OfficeDotCustomXMLSchema_typekey: typingsSlinky.activexOffice.Office.CustomXMLSchema = js.native
  /* CompleteClass */
