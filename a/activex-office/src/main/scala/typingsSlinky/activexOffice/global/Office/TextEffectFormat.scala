...
class TextEffectFormat protected ()
  extends typingsSlinky.activexOffice.Office.TextEffectFormat {
  /* CompleteClass */
  ...
  override var OfficeDotTextEffectFormat_typekey: typingsSlinky.activexOffice.Office.TextEffectFormat = js.native
  /* CompleteClass */
