...
class BalloonCheckbox protected ()
  extends typingsSlinky.activexOffice.Office.BalloonCheckbox {
  /* CompleteClass */
  ...
  override var OfficeDotBalloonCheckbox_typekey: typingsSlinky.activexOffice.Office.BalloonCheckbox = js.native
  /* CompleteClass */
