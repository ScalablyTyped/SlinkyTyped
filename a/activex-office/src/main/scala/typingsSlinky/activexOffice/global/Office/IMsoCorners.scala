...
class IMsoCorners protected ()
  extends typingsSlinky.activexOffice.Office.IMsoCorners {
  /* CompleteClass */
  ...
  override var OfficeDotIMsoCorners_typekey: typingsSlinky.activexOffice.Office.IMsoCorners = js.native
  /* CompleteClass */
