...
class SmartArtColor protected ()
  extends typingsSlinky.activexOffice.Office.SmartArtColor {
  /* CompleteClass */
  ...
  override var OfficeDotSmartArtColor_typekey: typingsSlinky.activexOffice.Office.SmartArtColor = js.native
  /* CompleteClass */
