...
class CalloutFormat protected ()
  extends typingsSlinky.activexOffice.Office.CalloutFormat {
  /* CompleteClass */
  ...
  override var OfficeDotCalloutFormat_typekey: typingsSlinky.activexOffice.Office.CalloutFormat = js.native
  /* CompleteClass */
