...
class SignatureInfo protected () extends js.Object {
  ...
  val CertificateVerificationResults: typingsSlinky.activexDashOffice.Office.CertificateVerificationResults = js.native
  val ContentVerificationResults: typingsSlinky.activexDashOffice.Office.ContentVerificationResults = js.native
