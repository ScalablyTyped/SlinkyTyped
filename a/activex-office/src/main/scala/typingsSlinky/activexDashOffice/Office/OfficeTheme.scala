...
class OfficeTheme protected () extends js.Object {
  ...
  val ThemeEffectScheme: typingsSlinky.activexDashOffice.Office.ThemeEffectScheme = js.native
  val ThemeFontScheme: typingsSlinky.activexDashOffice.Office.ThemeFontScheme = js.native
