...
class Shape protected () extends js.Object {
  ...
  val ConnectorFormat: typingsSlinky.activexDashOffice.Office.ConnectorFormat = js.native
  val Creator: Double = js.native
  val Diagram: IMsoDiagram = js.native
  val DiagramNode: typingsSlinky.activexDashOffice.Office.DiagramNode = js.native
  ...
  val PictureFormat: typingsSlinky.activexDashOffice.Office.PictureFormat = js.native
  ...
  val TextFrame: typingsSlinky.activexDashOffice.Office.TextFrame = js.native
