...
object runtimeConfigNativeMod {
  ...
  object ClientDefaultValues {
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.apiVersion")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.defaultUserAgent")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.disableHostPrefix")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.logger")
    @js.native
    def logger: Logger = js.native
    @scala.inline
    def logger_=(x: Logger): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("logger")(x.asInstanceOf[js.Any])
    
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.maxAttempts")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.region")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.requestHandler")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.runtime")
    @js.native
    ...
    @JSImport("@aws-sdk/client-cognito-identity/types/runtimeConfig.native", "ClientDefaultValues.signingName")
    @js.native
