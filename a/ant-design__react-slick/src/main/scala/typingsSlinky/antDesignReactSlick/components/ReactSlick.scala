package typingsSlinky.antDesignReactSlick.components
...
import typingsSlinky.antDesignReactSlick.mod.default
...
object ReactSlick
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignReactSlick.mod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = Settings
}
