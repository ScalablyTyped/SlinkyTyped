...
object Settings {
  ...
  implicit class SettingsOps[Self <: Settings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomPaging(value: /* index */ Double => ReactElement): Self = this.set("customPaging", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setNextArrow(value: ReactElement): Self = this.set("nextArrow", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPrevArrow(value: ReactElement): Self = this.set("prevArrow", value.asInstanceOf[js.Any])
    @scala.inline
