...
object mod extends Shortcut {
  ...
  object angularTouchspin {
    ...
    type ITouchSpinConfig = typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions
    
    @js.native
    trait ITouchSpinConfigProvider extends StObject {
      
      def defaults(touchSpinOptions: typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions): Unit = js.native
    }
    object ITouchSpinConfigProvider {
      
      @scala.inline
      def apply(defaults: typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions => Unit): typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinConfigProvider = {
        val __obj = js.Dynamic.literal(defaults = js.Any.fromFunction1(defaults))
        __obj.asInstanceOf[typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinConfigProvider]
      }
      
      @scala.inline
      implicit class ITouchSpinConfigProviderMutableBuilder[Self <: typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinConfigProvider] (val x: Self) extends AnyVal {
        
        @scala.inline
        def setDefaults(value: typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions => Unit): Self = StObject.set(x, "defaults", js.Any.fromFunction1(value))
      }
    }
    ...
    object ITouchSpinOptions {
      ...
      @scala.inline
      def apply(): typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions]
      }
      
      @scala.inline
      implicit class ITouchSpinOptionsMutableBuilder[Self <: typingsSlinky.angularTouchspin.mod.angularTouchspin.ITouchSpinOptions] (val x: Self) extends AnyVal {
