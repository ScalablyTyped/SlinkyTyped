...
import typingsSlinky.antvGBase.anon.Matrix
import typingsSlinky.antvGBase.interfacesMod.ICanvas
import typingsSlinky.antvGBase.interfacesMod.IContainer
...
object elementMod {
  ...
  trait Element
    ...
    /**
      ...
      * @param  {GraphEvent}  eventObj 事件对象
      */
    def emitDelegation(`type`: String, eventObj: typingsSlinky.antvGBase.graphEventMod.default): Unit = js.native
