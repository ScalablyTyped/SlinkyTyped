...
import typingsSlinky.antvGBase.canvasMod.default
...
object mod extends js.Object {
  ...
  abstract class AbstractGroup ()
    extends typingsSlinky.antvGBase.groupMod.AbstractGroup
  
  @js.native
  abstract class AbstractShape protected ()
    extends typingsSlinky.antvGBase.shapeMod.default {
  ...
  class Event protected ()
    extends typingsSlinky.antvGBase.graphEventMod.default {
