...
import typingsSlinky.antvGBase.anon.Height
...
object shapeMod {
  ...
  - typingsSlinky.antvGBase.interfacesMod.IShape because var conflicts: cfg, destroyed. Inlined isHit, isClipShape */ @js.native
  trait AbstractShape
    extends typingsSlinky.antvGBase.elementMod.default {
