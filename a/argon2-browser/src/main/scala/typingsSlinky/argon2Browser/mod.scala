package typingsSlinky.argon2Browser
...
object mod {
  ...
  object ArgonType extends StObject {
    ...
    /* 0 */ val Argon2d: typingsSlinky.argon2Browser.mod.ArgonType.Argon2d with Double = js.native
    
    @js.native
    sealed trait Argon2i extends ArgonType
    /* 1 */ val Argon2i: typingsSlinky.argon2Browser.mod.ArgonType.Argon2i with Double = js.native
    
    @js.native
    sealed trait Argon2id extends ArgonType
    /* 2 */ val Argon2id: typingsSlinky.argon2Browser.mod.ArgonType.Argon2id with Double = js.native
  }
  ...
  object Argon2BrowserHashOptions {
    ...
    implicit class Argon2BrowserHashOptionsMutableBuilder[Self <: Argon2BrowserHashOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPass(value: String | js.typedarray.Uint8Array): Self = StObject.set(x, "pass", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPassUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "pass", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSalt(value: String | js.typedarray.Uint8Array): Self = StObject.set(x, "salt", value.asInstanceOf[js.Any])
  ...
  object Argon2VerifyOptions {
    ...
    implicit class Argon2VerifyOptionsMutableBuilder[Self <: Argon2VerifyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncoded(value: String | js.typedarray.Uint8Array): Self = StObject.set(x, "encoded", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncodedUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "encoded", value.asInstanceOf[js.Any])
