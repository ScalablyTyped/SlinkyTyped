...
object Argon2BrowserHashOptions {
  ...
  implicit class Argon2BrowserHashOptionsOps[Self <: Argon2BrowserHashOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPassUint8Array(value: js.typedarray.Uint8Array): Self = this.set("pass", value.asInstanceOf[js.Any])
    @scala.inline
    def setPass(value: String | js.typedarray.Uint8Array): Self = this.set("pass", value.asInstanceOf[js.Any])
    @scala.inline
    def setSaltUint8Array(value: js.typedarray.Uint8Array): Self = this.set("salt", value.asInstanceOf[js.Any])
    @scala.inline
    def setSalt(value: String | js.typedarray.Uint8Array): Self = this.set("salt", value.asInstanceOf[js.Any])
    @scala.inline
