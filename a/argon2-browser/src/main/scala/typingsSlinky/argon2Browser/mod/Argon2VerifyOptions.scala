...
object Argon2VerifyOptions {
  ...
  implicit class Argon2VerifyOptionsOps[Self <: Argon2VerifyOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncodedUint8Array(value: js.typedarray.Uint8Array): Self = this.set("encoded", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEncoded(value: String | js.typedarray.Uint8Array): Self = this.set("encoded", value.asInstanceOf[js.Any])
