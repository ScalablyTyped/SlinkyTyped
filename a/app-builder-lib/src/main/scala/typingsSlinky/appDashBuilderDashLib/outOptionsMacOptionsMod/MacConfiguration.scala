...
import typingsSlinky.appDashBuilderDashLib.appDashBuilderDashLibStrings.development
import typingsSlinky.appDashBuilderDashLib.appDashBuilderDashLibStrings.distribution
...
import typingsSlinky.appDashBuilderDashLib.outCoreMod.TargetConfiguration
