...
object CustomWindowsSignTaskConfiguration {
  ...
  implicit class CustomWindowsSignTaskConfigurationOps[Self <: CustomWindowsSignTaskConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComputeSignToolArgs(value: Boolean => js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("computeSignToolArgs")(js.Any.fromFunction1(value))
        ret
    }
  }
