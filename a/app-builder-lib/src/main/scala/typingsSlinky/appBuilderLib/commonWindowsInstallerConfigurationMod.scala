...
object commonWindowsInstallerConfigurationMod {
  ...
  object DesktopShortcutCreationPolicy extends StObject {
    ...
    /* 1 */ val ALWAYS: typingsSlinky.appBuilderLib.commonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.ALWAYS with Double = js.native
    
    @js.native
    sealed trait FRESH_INSTALL extends DesktopShortcutCreationPolicy
    /* 0 */ val FRESH_INSTALL: typingsSlinky.appBuilderLib.commonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.FRESH_INSTALL with Double = js.native
    
    @js.native
    sealed trait NEVER extends DesktopShortcutCreationPolicy
    /* 2 */ val NEVER: typingsSlinky.appBuilderLib.commonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.NEVER with Double = js.native
  }
