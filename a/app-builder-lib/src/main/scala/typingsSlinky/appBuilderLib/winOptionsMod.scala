...
object winOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.appBuilderLib.appBuilderLibStrings.asInvoker
    - typingsSlinky.appBuilderLib.appBuilderLibStrings.highestAvailable
    - typingsSlinky.appBuilderLib.appBuilderLibStrings.requireAdministrator
  */
