...
trait PartialSearchOptions extends js.Object {
  ...
  var needle: js.UndefOr[String | js.RegExp] = js.native
...
object PartialSearchOptions {
  ...
  implicit class PartialSearchOptionsOps[Self <: PartialSearchOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNeedleRegExp(value: js.RegExp): Self = this.set("needle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNeedle(value: String | js.RegExp): Self = this.set("needle", value.asInstanceOf[js.Any])
