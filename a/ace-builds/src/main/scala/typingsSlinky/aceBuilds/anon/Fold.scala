...
trait Fold extends StObject {
  ...
  var fold: typingsSlinky.aceBuilds.mod.Ace.Fold = js.native
...
object Fold {
  ...
  @scala.inline
  def apply(fold: typingsSlinky.aceBuilds.mod.Ace.Fold, kind: String): Fold = {
  ...
  implicit class FoldMutableBuilder[Self <: Fold] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFold(value: typingsSlinky.aceBuilds.mod.Ace.Fold): Self = StObject.set(x, "fold", value.asInstanceOf[js.Any])
