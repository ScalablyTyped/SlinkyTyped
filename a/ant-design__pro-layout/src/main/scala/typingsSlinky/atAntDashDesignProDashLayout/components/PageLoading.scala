...
import typingsSlinky.atAntDashDesignProDashLayout.Anon_Tip
...
object PageLoading
  ...
  def apply(tip: String = null, _overrides: StringDictionary[js.Any] = null): BuildingComponent[tag.type, js.Object] = {
