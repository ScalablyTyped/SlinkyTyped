...
import typingsSlinky.antDesignProLayout.anon.ColorWeak
...
object libSettingDrawerMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[SettingDrawerProps] = js.native
  ...
  object SettingItemProps {
    ...
    implicit class SettingItemPropsMutableBuilder[Self <: SettingItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisabledReason(value: ReactElement): Self = StObject.set(x, "disabledReason", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisabledReasonReactElement(value: ReactElement): Self = StObject.set(x, "disabledReason", value.asInstanceOf[js.Any])
  ...
  type _To = ReactComponentClass[SettingDrawerProps]
  
  /* This means you don't have to write `default`, but can instead just say `libSettingDrawerMod.foo` */
  override def _to: ReactComponentClass[SettingDrawerProps] = default
}
