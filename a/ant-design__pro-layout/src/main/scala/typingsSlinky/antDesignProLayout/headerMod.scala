...
object headerMod {
  ...
  object HeaderViewProps {
    ...
    implicit class HeaderViewPropsMutableBuilder[Self <: HeaderViewProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHeaderContentRender(value: WithFalse[js.Function1[HeaderViewProps, ReactElement]]): Self = StObject.set(x, "headerContentRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHeaderContentRenderFunction1(value: HeaderViewProps => ReactElement): Self = StObject.set(x, "headerContentRender", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setHeaderRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ ReactElement, ReactElement]]): Self = StObject.set(x, "headerRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHeaderRenderFunction2(value: (HeaderViewProps, /* defaultDom */ ReactElement) => ReactElement): Self = StObject.set(x, "headerRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setHeaderTitleRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ ReactElement, ReactElement]]): Self = StObject.set(x, "headerTitleRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHeaderTitleRenderFunction2(value: (HeaderViewProps, /* defaultDom */ ReactElement) => ReactElement): Self = StObject.set(x, "headerTitleRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setMenuRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ ReactElement, ReactElement]]): Self = StObject.set(x, "menuRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMenuRenderFunction2(value: (HeaderViewProps, /* defaultDom */ ReactElement) => ReactElement): Self = StObject.set(x, "menuRender", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRightContentRender(value: WithFalse[js.Function1[HeaderViewProps, ReactElement]]): Self = StObject.set(x, "rightContentRender", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRightContentRenderFunction1(value: HeaderViewProps => ReactElement): Self = StObject.set(x, "rightContentRender", js.Any.fromFunction1(value))
