...
object GlobalFooterProps {
  ...
  implicit class GlobalFooterPropsOps[Self <: GlobalFooterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopyrightReactElement(value: ReactElement): Self = this.set("copyright", value.asInstanceOf[js.Any])
    @scala.inline
    def setCopyright(value: ReactElement): Self = this.set("copyright", value.asInstanceOf[js.Any])
    @scala.inline
