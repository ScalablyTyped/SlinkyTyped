...
object Breadcrumb {
  ...
  implicit class BreadcrumbOps[Self <: Breadcrumb] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBreadcrumbMap(value: Map[String, typingsSlinky.umijsRouteUtils.typesMod.MenuDataItem]): Self = this.set("breadcrumbMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMenuDataVarargs(value: typingsSlinky.umijsRouteUtils.typesMod.MenuDataItem*): Self = this.set("menuData", js.Array(value :_*))
    
    @scala.inline
    def setMenuData(value: js.Array[typingsSlinky.umijsRouteUtils.typesMod.MenuDataItem]): Self = this.set("menuData", value.asInstanceOf[js.Any])
  }
}
