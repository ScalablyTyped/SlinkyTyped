...
object BreadcrumbRender {
  ...
  implicit class BreadcrumbRenderOps[Self <: BreadcrumbRender] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooterRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ ReactElement) => ReactElement): Self = this.set("footerRender", js.Any.fromFunction2(value))
    @scala.inline
    def setFooterRender(
      value: WithFalse[
          js.Function2[/* props */ HeaderViewProps, /* defaultDom */ ReactElement, ReactElement]
        ]
    ): Self = this.set("footerRender", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLogoFunction0(value: () => ReactElement): Self = this.set("logo", js.Any.fromFunction0(value))
    @scala.inline
    def setLogo(value: ReactElement | WithFalse[js.Function0[ReactElement]]): Self = this.set("logo", value.asInstanceOf[js.Any])
    @scala.inline
