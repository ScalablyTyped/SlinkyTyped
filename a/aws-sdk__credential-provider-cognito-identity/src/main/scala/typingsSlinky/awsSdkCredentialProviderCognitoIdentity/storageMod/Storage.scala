package typingsSlinky.awsSdkCredentialProviderCognitoIdentity.storageMod
...
object Storage {
  ...
  implicit class StorageOps[Self <: Storage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetItem(value: String => String | Null | (js.Promise[String | Null])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveItem(value: String => Unit | js.Promise[Unit]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetItem(value: (String, String) => Unit | js.Promise[Unit]): Self = {
        val ret = this.duplicate
