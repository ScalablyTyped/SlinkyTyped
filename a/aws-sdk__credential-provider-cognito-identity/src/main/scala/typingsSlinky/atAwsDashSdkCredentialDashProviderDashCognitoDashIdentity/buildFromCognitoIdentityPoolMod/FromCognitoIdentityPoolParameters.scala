package typingsSlinky.atAwsDashSdkCredentialDashProviderDashCognitoDashIdentity.buildFromCognitoIdentityPoolMod

import typingsSlinky.atAwsDashSdkClientDashCognitoDashIdentityDashBrowser.cognitoIdentityClientMod.CognitoIdentityClient
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashCognitoDashIdentity.buildCognitoProviderParametersMod.CognitoProviderParameters
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashCognitoDashIdentity.buildLoginsMod.Logins
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashCognitoDashIdentity.buildStorageMod.Storage
