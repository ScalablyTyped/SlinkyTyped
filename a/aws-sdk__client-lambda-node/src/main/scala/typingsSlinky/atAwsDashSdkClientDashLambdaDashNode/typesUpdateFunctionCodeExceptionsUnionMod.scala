...
@js.native
object typesUpdateFunctionCodeExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.atAwsDashSdkClientDashLambdaDashNode.typesCodeStorageExceededExceptionMod.CodeStorageExceededException
