...
@JSImport("@aws-sdk/client-lambda-node/types/GetEventSourceMappingExceptionsUnion", JSImport.Namespace)
@js.native
object typesGetEventSourceMappingExceptionsUnionMod extends js.Object {
