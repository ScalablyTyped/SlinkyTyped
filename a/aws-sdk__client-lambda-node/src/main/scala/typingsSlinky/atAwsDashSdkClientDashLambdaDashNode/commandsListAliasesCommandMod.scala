...
import typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesListAliasesInputMod.ListAliasesInput
import typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesListAliasesOutputMod.ListAliasesOutput
