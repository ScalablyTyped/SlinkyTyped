package typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesUnderscoreAliasConfigurationMod

import typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesUnderscoreAliasRoutingConfigurationMod._UnmarshalledAliasRoutingConfiguration
