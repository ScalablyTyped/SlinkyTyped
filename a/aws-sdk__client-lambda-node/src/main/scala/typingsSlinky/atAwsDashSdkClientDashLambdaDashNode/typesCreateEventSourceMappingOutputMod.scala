...
@JSImport("@aws-sdk/client-lambda-node/types/CreateEventSourceMappingOutput", JSImport.Namespace)
@js.native
object typesCreateEventSourceMappingOutputMod extends js.Object {
  @js.native
