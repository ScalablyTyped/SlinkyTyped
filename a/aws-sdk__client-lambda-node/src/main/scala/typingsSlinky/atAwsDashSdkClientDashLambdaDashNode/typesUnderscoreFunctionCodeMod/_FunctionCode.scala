package typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesUnderscoreFunctionCodeMod
...
object _FunctionCode {
  ...
  def apply(
    ...
    ZipFile: scala.scalajs.js.typedarray.ArrayBuffer | scala.scalajs.js.typedarray.ArrayBufferView | String = null
  ): _FunctionCode = {
