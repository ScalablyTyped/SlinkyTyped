package typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesUnderscoreEventSourceMappingConfigurationMod
...
trait _UnmarshalledEventSourceMappingConfiguration extends _EventSourceMappingConfiguration {
  /**
    ...
    */
  @JSName("LastModified")
  var LastModified__UnmarshalledEventSourceMappingConfiguration: js.UndefOr[js.Date] = js.undefined
}
