...
import typingsSlinky.atAwsDashSdkClientDashLambdaDashNode.typesUnderscoreEventSourceMappingConfigurationMod._UnmarshalledEventSourceMappingConfiguration
