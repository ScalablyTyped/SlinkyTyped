...
@js.native
object typesDeleteEventSourceMappingExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.atAwsDashSdkClientDashLambdaDashNode.typesResourceInUseExceptionMod.ResourceInUseException
  */
