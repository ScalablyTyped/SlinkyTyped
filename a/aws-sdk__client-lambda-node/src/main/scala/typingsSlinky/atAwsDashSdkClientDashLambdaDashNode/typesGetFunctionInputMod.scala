...
@JSImport("@aws-sdk/client-lambda-node/types/GetFunctionInput", JSImport.Namespace)
@js.native
object typesGetFunctionInputMod extends js.Object {
  @js.native
  trait GetFunctionInput extends _InputTypesUnion {
    /**
