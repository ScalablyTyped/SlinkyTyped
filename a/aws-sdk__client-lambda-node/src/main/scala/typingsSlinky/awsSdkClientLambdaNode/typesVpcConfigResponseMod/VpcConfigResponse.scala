...
object VpcConfigResponse {
  ...
  implicit class VpcConfigResponseOps[Self <: VpcConfigResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecurityGroupIdsIterable(value: js.Iterable[String]): Self = this.set("SecurityGroupIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSecurityGroupIds(value: js.Array[String] | js.Iterable[String]): Self = this.set("SecurityGroupIds", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubnetIdsIterable(value: js.Iterable[String]): Self = this.set("SubnetIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubnetIds(value: js.Array[String] | js.Iterable[String]): Self = this.set("SubnetIds", value.asInstanceOf[js.Any])
