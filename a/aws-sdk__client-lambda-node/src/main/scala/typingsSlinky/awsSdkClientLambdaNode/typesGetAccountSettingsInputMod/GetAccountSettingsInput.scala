package typingsSlinky.awsSdkClientLambdaNode.typesGetAccountSettingsInputMod
...
@js.native
trait GetAccountSettingsInput extends InputTypesUnion {
  /**
...
object GetAccountSettingsInput {
  ...
  @scala.inline
  implicit class GetAccountSettingsInputOps[Self <: GetAccountSettingsInput] (val x: Self) extends AnyVal {
    @scala.inline
