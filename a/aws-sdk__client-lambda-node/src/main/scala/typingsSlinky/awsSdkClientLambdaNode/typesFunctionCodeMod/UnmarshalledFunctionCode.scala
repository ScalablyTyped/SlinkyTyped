...
trait UnmarshalledFunctionCode extends FunctionCode {
  /**
    ...
    */
  @JSName("ZipFile")
  var ZipFile_UnmarshalledFunctionCode: js.UndefOr[scala.scalajs.js.typedarray.Uint8Array] = js.undefined
}
...
object UnmarshalledFunctionCode {
  ...
  def apply(
    ...
    ZipFile: scala.scalajs.js.typedarray.Uint8Array = null
