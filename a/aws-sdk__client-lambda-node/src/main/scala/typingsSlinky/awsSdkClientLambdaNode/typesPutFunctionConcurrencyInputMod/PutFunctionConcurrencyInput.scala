package typingsSlinky.awsSdkClientLambdaNode.typesPutFunctionConcurrencyInputMod
...
@js.native
trait PutFunctionConcurrencyInput extends _InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var ReservedConcurrentExecutions: Double = js.native
}
...
object PutFunctionConcurrencyInput {
  ...
  @scala.inline
  implicit class PutFunctionConcurrencyInputOps[Self <: PutFunctionConcurrencyInput] (val x: Self) extends AnyVal {
    @scala.inline
