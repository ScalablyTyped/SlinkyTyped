...
object typesUpdateFunctionCodeOutputMod {
  ...
  object UpdateFunctionCodeOutput {
    ...
    @scala.inline
    def apply($metadata: ResponseMetadata): UpdateFunctionCodeOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[UpdateFunctionCodeOutput]
    }
    
    @scala.inline
    implicit class UpdateFunctionCodeOutputMutableBuilder[Self <: UpdateFunctionCodeOutput] (val x: Self) extends AnyVal {
