...
object CreateEventSourceMappingInput {
  ...
  implicit class CreateEventSourceMappingInputOps[Self <: CreateEventSourceMappingInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStartingPosition(value: TRIM_HORIZON | LATEST | AT_TIMESTAMP | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStartingPositionTimestampDate(value: js.Date): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartingPositionTimestamp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStartingPositionTimestamp(value: js.Date | String | Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartingPositionTimestamp")(value.asInstanceOf[js.Any])
        ret
    }
