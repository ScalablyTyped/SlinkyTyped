...
@JSImport("@aws-sdk/client-lambda-node/types/DeleteEventSourceMappingOutput", JSImport.Namespace)
@js.native
object typesDeleteEventSourceMappingOutputMod extends js.Object {
  @js.native
