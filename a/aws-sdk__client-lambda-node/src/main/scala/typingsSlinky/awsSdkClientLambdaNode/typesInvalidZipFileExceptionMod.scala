...
object typesInvalidZipFileExceptionMod {
  ...
  trait InvalidZipFileException extends InvokeExceptionsUnion {
    ...
    var name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidZipFileException = js.native
  }
  object InvalidZipFileException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidZipFileException): InvalidZipFileException = {
    ...
    implicit class InvalidZipFileExceptionMutableBuilder[Self <: InvalidZipFileException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidZipFileException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
