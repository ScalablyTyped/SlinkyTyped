package typingsSlinky.awsSdkClientLambdaNode.typesGetFunctionConfigurationInputMod
...
@js.native
trait GetFunctionConfigurationInput extends InputTypesUnion {
  /**
...
object GetFunctionConfigurationInput {
  @scala.inline
  def apply(FunctionName: String): GetFunctionConfigurationInput = {
    val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetFunctionConfigurationInput]
  }
  @scala.inline
  implicit class GetFunctionConfigurationInputOps[Self <: GetFunctionConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
