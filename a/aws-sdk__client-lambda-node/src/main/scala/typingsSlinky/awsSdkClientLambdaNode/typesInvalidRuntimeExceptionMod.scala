...
object typesInvalidRuntimeExceptionMod {
  ...
  trait InvalidRuntimeException
    ...
    var name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidRuntimeException = js.native
  }
  object InvalidRuntimeException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidRuntimeException): InvalidRuntimeException = {
    ...
    implicit class InvalidRuntimeExceptionMutableBuilder[Self <: InvalidRuntimeException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidRuntimeException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
