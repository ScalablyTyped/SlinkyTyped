...
@JSImport("@aws-sdk/client-lambda-node/types/PutFunctionConcurrencyOutput", JSImport.Namespace)
@js.native
object typesPutFunctionConcurrencyOutputMod extends js.Object {
  @js.native
