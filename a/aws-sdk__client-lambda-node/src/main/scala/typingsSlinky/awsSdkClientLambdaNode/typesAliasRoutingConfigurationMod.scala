...
object typesAliasRoutingConfigurationMod {
  ...
  object AliasRoutingConfiguration {
    ...
    implicit class AliasRoutingConfigurationMutableBuilder[Self <: AliasRoutingConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdditionalVersionWeights(value: StringDictionary[Double] | (js.Iterable[js.Tuple2[String, Double]])): Self = StObject.set(x, "AdditionalVersionWeights", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdditionalVersionWeightsIterable(value: js.Iterable[js.Tuple2[String, Double]]): Self = StObject.set(x, "AdditionalVersionWeights", value.asInstanceOf[js.Any])
