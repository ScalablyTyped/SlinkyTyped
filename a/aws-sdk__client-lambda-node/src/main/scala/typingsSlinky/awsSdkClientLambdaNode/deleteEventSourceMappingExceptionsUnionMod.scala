...
object deleteEventSourceMappingExceptionsUnionMod {
  ...
  */
  ...
  object DeleteEventSourceMappingExceptionsUnion {
    ...
    @scala.inline
    def ResourceInUseException(name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.ResourceInUseException): typingsSlinky.awsSdkClientLambdaNode.typesResourceInUseExceptionMod.ResourceInUseException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientLambdaNode.typesResourceInUseExceptionMod.ResourceInUseException]
    }
