...
trait RequestTooLargeException extends InvokeExceptionsUnion {
  ...
  var name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.RequestTooLargeException = js.native
}
object RequestTooLargeException {
  
  @scala.inline
  def apply(name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.RequestTooLargeException): RequestTooLargeException = {
