...
object InvokeAsyncInput {
  ...
  @scala.inline
  implicit class InvokeAsyncInputOps[Self <: InvokeAsyncInput[_], StreamType] (val x: Self with InvokeAsyncInput[StreamType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setInvokeArgsArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("InvokeArgs", value.asInstanceOf[js.Any])
    @scala.inline
    def setInvokeArgsArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("InvokeArgs", value.asInstanceOf[js.Any])
    @scala.inline
    def setInvokeArgs(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String | StreamType): Self = this.set("InvokeArgs", value.asInstanceOf[js.Any])
    @scala.inline
