package typingsSlinky.awsSdkClientLambdaNode.createAliasExceptionsUnionMod
...
object CreateAliasExceptionsUnion {
  @scala.inline
  implicit def apply(value: InvalidParameterValueException): CreateAliasExceptionsUnion = value.asInstanceOf[CreateAliasExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceConflictException): CreateAliasExceptionsUnion = value.asInstanceOf[CreateAliasExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceNotFoundException): CreateAliasExceptionsUnion = value.asInstanceOf[CreateAliasExceptionsUnion]
  @scala.inline
  implicit def apply(value: ServiceException): CreateAliasExceptionsUnion = value.asInstanceOf[CreateAliasExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): CreateAliasExceptionsUnion = value.asInstanceOf[CreateAliasExceptionsUnion]
}
