...
object typesEc2throttledexceptionMod {
  ...
  object EC2ThrottledException {
    ...
    implicit class EC2ThrottledExceptionMutableBuilder[Self <: EC2ThrottledException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.EC2ThrottledException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
