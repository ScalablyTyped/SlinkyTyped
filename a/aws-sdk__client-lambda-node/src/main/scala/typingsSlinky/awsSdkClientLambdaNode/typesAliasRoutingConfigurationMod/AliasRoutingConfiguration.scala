...
object AliasRoutingConfiguration {
  ...
  implicit class AliasRoutingConfigurationOps[Self <: AliasRoutingConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdditionalVersionWeightsIterable(value: js.Iterable[js.Tuple2[String, Double]]): Self = this.set("AdditionalVersionWeights", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAdditionalVersionWeights(value: StringDictionary[Double] | (js.Iterable[js.Tuple2[String, Double]])): Self = this.set("AdditionalVersionWeights", value.asInstanceOf[js.Any])
