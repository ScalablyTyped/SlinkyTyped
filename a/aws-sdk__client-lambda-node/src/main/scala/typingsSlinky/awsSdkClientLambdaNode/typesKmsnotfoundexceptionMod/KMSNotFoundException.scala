...
object KMSNotFoundException {
  ...
  implicit class KMSNotFoundExceptionOps[Self <: KMSNotFoundException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.KMSNotFoundException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
