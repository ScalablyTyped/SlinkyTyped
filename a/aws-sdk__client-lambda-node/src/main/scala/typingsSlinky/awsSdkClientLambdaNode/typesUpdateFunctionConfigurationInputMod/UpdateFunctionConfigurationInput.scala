package typingsSlinky.awsSdkClientLambdaNode.typesUpdateFunctionConfigurationInputMod
...
trait UpdateFunctionConfigurationInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var Environment: js.UndefOr[typingsSlinky.awsSdkClientLambdaNode.typesEnvironmentMod.Environment] = js.undefined
  /**
  ...
  /**
    ...
    */
  var TracingConfig: js.UndefOr[typingsSlinky.awsSdkClientLambdaNode.typesTracingConfigMod.TracingConfig] = js.undefined
  /**
    * <p>Specify security groups and subnets in a VPC to which your Lambda function needs access.</p>
    */
  var VpcConfig: js.UndefOr[typingsSlinky.awsSdkClientLambdaNode.typesVpcConfigMod.VpcConfig] = js.undefined
}
