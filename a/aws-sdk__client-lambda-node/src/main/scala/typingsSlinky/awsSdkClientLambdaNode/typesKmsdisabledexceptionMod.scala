...
object typesKmsdisabledexceptionMod {
  ...
  trait KMSDisabledException extends InvokeExceptionsUnion {
    ...
    var name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.KMSDisabledException = js.native
  }
  object KMSDisabledException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.KMSDisabledException): KMSDisabledException = {
    ...
    implicit class KMSDisabledExceptionMutableBuilder[Self <: KMSDisabledException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.KMSDisabledException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
