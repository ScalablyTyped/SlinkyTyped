...
object typesCreateEventSourceMappingOutputMod {
  ...
  object CreateEventSourceMappingOutput {
    ...
    @scala.inline
    implicit class CreateEventSourceMappingOutputMutableBuilder[Self <: CreateEventSourceMappingOutput] (val x: Self) extends AnyVal {
