package typingsSlinky.awsSdkClientLambdaNode.typesDeleteEventSourceMappingOutputMod
...
@js.native
trait DeleteEventSourceMappingOutput extends OutputTypesUnion {
  /**
...
object DeleteEventSourceMappingOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata): DeleteEventSourceMappingOutput = {
    val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteEventSourceMappingOutput]
  }
  @scala.inline
  implicit class DeleteEventSourceMappingOutputOps[Self <: DeleteEventSourceMappingOutput] (val x: Self) extends AnyVal {
    @scala.inline
