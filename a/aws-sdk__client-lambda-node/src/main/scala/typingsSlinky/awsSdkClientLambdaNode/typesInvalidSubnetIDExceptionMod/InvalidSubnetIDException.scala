...
object InvalidSubnetIDException {
  ...
  implicit class InvalidSubnetIDExceptionOps[Self <: InvalidSubnetIDException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidSubnetIDException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
