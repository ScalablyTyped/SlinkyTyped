...
object typesCreateEventSourceMappingInputMod {
  ...
  object CreateEventSourceMappingInput {
    ...
    implicit class CreateEventSourceMappingInputMutableBuilder[Self <: CreateEventSourceMappingInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStartingPositionTimestamp(value: js.Date | String | Double): Self = StObject.set(x, "StartingPositionTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStartingPositionTimestampDate(value: js.Date): Self = StObject.set(x, "StartingPositionTimestamp", value.asInstanceOf[js.Any])
