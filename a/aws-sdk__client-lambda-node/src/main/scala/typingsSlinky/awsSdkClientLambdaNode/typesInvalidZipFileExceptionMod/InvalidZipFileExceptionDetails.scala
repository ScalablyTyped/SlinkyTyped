...
@js.native
trait InvalidZipFileExceptionDetails extends js.Object {
...
object InvalidZipFileExceptionDetails {
  ...
  @scala.inline
  implicit class InvalidZipFileExceptionDetailsOps[Self <: InvalidZipFileExceptionDetails] (val x: Self) extends AnyVal {
