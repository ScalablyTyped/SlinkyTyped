...
object GraphQLRequestExecutionListener {
  @scala.inline
  def apply[/* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext](): GraphQLRequestExecutionListener[TContext] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GraphQLRequestExecutionListener[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestExecutionListenerOps[Self <: GraphQLRequestExecutionListener[_], /* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext] (val x: Self with GraphQLRequestExecutionListener[TContext]) extends AnyVal {
    @scala.inline
