...
object ApolloServerPlugin {
  @scala.inline
  def apply[/* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext](): ApolloServerPlugin[TContext] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ApolloServerPlugin[TContext]]
  }
  @scala.inline
  implicit class ApolloServerPluginOps[Self <: ApolloServerPlugin[_], /* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext] (val x: Self with ApolloServerPlugin[TContext]) extends AnyVal {
    @scala.inline
