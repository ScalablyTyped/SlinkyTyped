...
object GraphQLRequestListener {
  @scala.inline
  def apply[/* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext](): GraphQLRequestListener[TContext] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GraphQLRequestListener[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestListenerOps[Self <: GraphQLRequestListener[_], /* <: typingsSlinky.apolloServerTypes.mod.BaseContext */ TContext] (val x: Self with GraphQLRequestListener[TContext]) extends AnyVal {
    @scala.inline
