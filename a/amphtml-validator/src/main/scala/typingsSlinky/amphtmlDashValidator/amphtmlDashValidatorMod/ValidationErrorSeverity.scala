...
object ValidationErrorSeverity {
  @scala.inline
  def ERROR: typingsSlinky.amphtmlDashValidator.amphtmlDashValidatorStrings.ERROR = this.cast("ERROR")
  @scala.inline
  def UNKNOWN_SEVERITY: typingsSlinky.amphtmlDashValidator.amphtmlDashValidatorStrings.UNKNOWN_SEVERITY = this.cast("UNKNOWN_SEVERITY")
  @scala.inline
  def WARNING: typingsSlinky.amphtmlDashValidator.amphtmlDashValidatorStrings.WARNING = this.cast("WARNING")
  @scala.inline
