...
trait StyleSheetStatic extends js.Object {
  ...
  {[ K in keyof T ]: aphrodite.aphrodite.StyleDeclarationValue}
    */ typingsSlinky.aphrodite.aphroditeStrings.StyleSheetStatic with TopLevel[js.Any] = js.native
...
object StyleSheetStatic {
  ...
  {[ K in keyof T ]: aphrodite.aphrodite.StyleDeclarationValue}
    */ typingsSlinky.aphrodite.aphroditeStrings.StyleSheetStatic with TopLevel[js.Any],
  ...
  implicit class StyleSheetStaticOps[Self <: StyleSheetStatic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExtend(value: js.Array[Extension] => Exports): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("extend")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRehydrate(value: js.Array[String] => Unit): Self = {
        val ret = this.duplicate
