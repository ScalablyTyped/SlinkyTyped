...
object CompoundOptions {
  ...
  implicit class CompoundOptionsOps[Self <: CompoundOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandlersVarargs(value: typingsSlinky.asymmetrikLeafletD3.mod.HexbinHoverHandler*): Self = this.set("handlers", js.Array(value :_*))
    @scala.inline
    def setHandlers(value: js.Array[typingsSlinky.asymmetrikLeafletD3.mod.HexbinHoverHandler]): Self = this.set("handlers", value.asInstanceOf[js.Any])
  }
