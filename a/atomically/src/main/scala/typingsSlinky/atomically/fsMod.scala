...
import typingsSlinky.atomically.anon.Fn1
import typingsSlinky.atomically.anon.Fn2
import typingsSlinky.atomically.anon.Fn3
import typingsSlinky.atomically.anon.Fn4
