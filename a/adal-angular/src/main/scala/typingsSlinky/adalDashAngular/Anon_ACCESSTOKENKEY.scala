...
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotaccessDottokenDotkey
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDoterror
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDoterrorDotdescription
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotexpirationDotkey
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotidtoken
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotloginDoterror
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotloginDotrequest
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotnonceDotidtoken
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotsessionDotstate
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotstateDotlogin
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotstateDotrenew
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDottokenDotkeys
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDottokenDotrenewDotstatus
import typingsSlinky.adalDashAngular.adalDashAngularStrings.adalDotusername
