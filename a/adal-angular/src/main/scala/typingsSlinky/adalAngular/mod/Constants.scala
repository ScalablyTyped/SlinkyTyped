...
import typingsSlinky.adalAngular.adalAngularStrings.Completed
import typingsSlinky.adalAngular.adalAngularStrings.Verticalline
import typingsSlinky.adalAngular.adalAngularStrings.`6000`
import typingsSlinky.adalAngular.adalAngularStrings.`In Progress`
import typingsSlinky.adalAngular.adalAngularStrings.access_token
import typingsSlinky.adalAngular.adalAngularStrings.error_description
