...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.ably.ablyStrings.PRESENCE_SUBSCRIBE
*/
...
object ChannelMode {
  ...
  @scala.inline
  def PRESENCE_SUBSCRIBE: typingsSlinky.ably.ablyStrings.PRESENCE_SUBSCRIBE = "PRESENCE_SUBSCRIBE".asInstanceOf[typingsSlinky.ably.ablyStrings.PRESENCE_SUBSCRIBE]
