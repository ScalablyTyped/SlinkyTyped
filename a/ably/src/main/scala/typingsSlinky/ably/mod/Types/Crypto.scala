...
object Crypto {
  ...
  implicit class CryptoOps[Self <: Crypto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGenerateRandomKey(value: js.Function2[/* error */ ErrorInfo, /* key */ String, Unit] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("generateRandomKey")(js.Any.fromFunction1(value))
        ret
    }
  }
