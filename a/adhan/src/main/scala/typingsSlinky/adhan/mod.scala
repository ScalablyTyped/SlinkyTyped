...
object mod {
  ...
  object HighLatitudeRule extends StObject {
    ...
    /* 0 */ val MiddleOfTheNight: typingsSlinky.adhan.mod.HighLatitudeRule.MiddleOfTheNight with Double = js.native
    
    @js.native
    sealed trait SeventhOfTheNight extends HighLatitudeRule
    /* 1 */ val SeventhOfTheNight: typingsSlinky.adhan.mod.HighLatitudeRule.SeventhOfTheNight with Double = js.native
    
    @js.native
    sealed trait TwilightAngle extends HighLatitudeRule
    /* 2 */ val TwilightAngle: typingsSlinky.adhan.mod.HighLatitudeRule.TwilightAngle with Double = js.native
  }
  ...
  object Madhab extends StObject {
    ...
    /* 0 */ val Hanafi: typingsSlinky.adhan.mod.Madhab.Hanafi with Double = js.native
    
    @js.native
    sealed trait Shafi extends Madhab
    /* 1 */ val Shafi: typingsSlinky.adhan.mod.Madhab.Shafi with Double = js.native
  }
  ...
  class PrayerTimes protected () extends StObject {
    def this(coordinates: Coordinates, date: js.Date, params: Parameter) = this()
  ...
  trait AdhanDate extends StObject {
    ...
    def formattedTime(prayerTime: js.Date, offset: js.UndefOr[scala.Nothing], style: TimeMode): String = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.adhan.adhanStrings.`12h`
    - typingsSlinky.adhan.adhanStrings.`24h`
  */
  trait TimeMode extends StObject
  object TimeMode {
    
    @scala.inline
    def `12h`: typingsSlinky.adhan.adhanStrings.`12h` = "12h".asInstanceOf[typingsSlinky.adhan.adhanStrings.`12h`]
    
    @scala.inline
    def `24h`: typingsSlinky.adhan.adhanStrings.`24h` = "24h".asInstanceOf[typingsSlinky.adhan.adhanStrings.`24h`]
  }
}
