...
class AnchorCls protected ()
  extends typingsSlinky.ace.AceAjax.Anchor {
  /**
    ...
    **/
  def this(doc: typingsSlinky.ace.AceAjax.Document, row: Double, column: Double) = this()
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getDocument(): typingsSlinky.ace.AceAjax.Document = js.native
  /**
