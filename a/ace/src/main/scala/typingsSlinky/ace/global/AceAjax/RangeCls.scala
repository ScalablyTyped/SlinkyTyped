...
class RangeCls protected ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def clipRows(firstRow: Double, lastRow: Double): typingsSlinky.ace.AceAjax.Range = js.native
  /**
    * Returns a range containing the starting and ending rows of the original range, but with a column value of `0`.
    **/
  /* CompleteClass */
  override def collapseRows(): typingsSlinky.ace.AceAjax.Range = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def comparePoint(p: typingsSlinky.ace.AceAjax.Range): Double = js.native
  /**
    * Compares `this` range (A) with another range (B).
    * @param range A range to compare with
    **/
  /* CompleteClass */
  override def compareRange(range: typingsSlinky.ace.AceAjax.Range): Double = js.native
  /**
    * Checks the row and column points with the row and column points of the calling range.
    * @param row A row point to compare with
    * @param column A column point to compare with
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def containsRange(range: typingsSlinky.ace.AceAjax.Range): Boolean = js.native
  /**
    ...
    **/
  /* CompleteClass */
  override def extend(row: Double, column: Double): typingsSlinky.ace.AceAjax.Range = js.native
  /**
    ...
    **/
  /* CompleteClass */
  override def fromPoints(start: typingsSlinky.ace.AceAjax.Range, end: typingsSlinky.ace.AceAjax.Range): typingsSlinky.ace.AceAjax.Range = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def intersects(range: typingsSlinky.ace.AceAjax.Range): Boolean = js.native
  /* CompleteClass */
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def isEqual(range: typingsSlinky.ace.AceAjax.Range): Unit = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def toScreenRange(session: IEditSession): typingsSlinky.ace.AceAjax.Range = js.native
}
