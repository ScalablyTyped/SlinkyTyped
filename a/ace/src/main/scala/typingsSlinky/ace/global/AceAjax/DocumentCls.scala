...
import typingsSlinky.ace.AceAjax.Delta
...
class DocumentCls ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getTextRange(range: typingsSlinky.ace.AceAjax.Range): String = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def remove(range: typingsSlinky.ace.AceAjax.Range): js.Any = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def replace(range: typingsSlinky.ace.AceAjax.Range, text: String): js.Any = js.native
  /**
