...
/**
  ...
  **/
class SearchCls ()
  extends typingsSlinky.ace.AceAjax.Search {
  /**
    * Searches for `options.needle`. If found, this method returns the [[Range `Range`]] where the text first occurs. If `options.backwards` is `true`, the search goes backwards in the session.
    * @param session The session to search with
    **/
  /* CompleteClass */
  override def find(session: IEditSession): typingsSlinky.ace.AceAjax.Range = js.native
  /**
    * Searches for all occurances `options.needle`. If found, this method returns an array of [[Range `Range`s]] where the text first occurs. If `options.backwards` is `true`, the search goes backwards in the session.
    * @param session The session to search with
    **/
  /* CompleteClass */
  override def findAll(session: IEditSession): js.Array[typingsSlinky.ace.AceAjax.Range] = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def set(options: js.Any): typingsSlinky.ace.AceAjax.Search = js.native
  /**
    * Sets the search options via the `options` parameter.
