...
import typingsSlinky.antvComponent.typesMod.DataMarkerAnnotationCfg
...
object dataMarkerMod {
  ...
  trait DataMarkerAnnotation
    extends typingsSlinky.antvComponent.groupComponentMod.default[DataMarkerAnnotationCfg] {
