...
import typingsSlinky.antvComponent.sliderSliderMod.TrendCfg
...
trait PartialSliderCfg extends StObject {
  ...
  var animateOption: js.UndefOr[typingsSlinky.antvComponent.typesMod.AnimateOption] = js.native
...
object PartialSliderCfg {
  ...
  implicit class PartialSliderCfgMutableBuilder[Self <: PartialSliderCfg] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimateOption(value: typingsSlinky.antvComponent.typesMod.AnimateOption): Self = StObject.set(x, "animateOption", value.asInstanceOf[js.Any])
