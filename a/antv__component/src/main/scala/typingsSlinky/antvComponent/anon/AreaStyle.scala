...
object AreaStyle {
  ...
  implicit class AreaStyleMutableBuilder[Self <: AreaStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAreaStyle(value: FillStringOpacityNumber): Self = StObject.set(x, "areaStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackgroundStyle(value: OpacityNumber): Self = StObject.set(x, "backgroundStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLineStyle(value: StrokeOpacity): Self = StObject.set(x, "lineStyle", value.asInstanceOf[js.Any])
