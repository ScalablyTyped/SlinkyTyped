...
@js.native
trait DefaultLength extends js.Object {
...
object DefaultLength {
  ...
  @scala.inline
  implicit class DefaultLengthOps[Self <: DefaultLength] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStyle(value: FillString): Self = this.set("style", value.asInstanceOf[js.Any])
