...
import typingsSlinky.antvComponent.anon.DisplayLength
import typingsSlinky.antvComponent.anon.DisplayStyle
import typingsSlinky.antvComponent.antvComponentStrings.downward
import typingsSlinky.antvComponent.antvComponentStrings.upward
