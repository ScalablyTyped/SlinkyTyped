package typingsSlinky.atAtlaskitLayer.components
...
import typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.BoundariesElementType
import typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.CSSPositionType
import typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.FlipPositionType
import typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.PositionType
import typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.default
...
object Layer
  ...
  typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = typingsSlinky.atAtlaskitLayer.atAtlaskitLayerMod.Props
}
