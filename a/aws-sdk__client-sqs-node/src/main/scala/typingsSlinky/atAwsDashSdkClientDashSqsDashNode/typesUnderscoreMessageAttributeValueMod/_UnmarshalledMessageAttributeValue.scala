...
trait _UnmarshalledMessageAttributeValue extends _MessageAttributeValue {
  ...
  var BinaryListValues__UnmarshalledMessageAttributeValue: js.UndefOr[js.Array[scala.scalajs.js.typedarray.Uint8Array]] = js.undefined
  /**
    * <p>Binary type attributes can store any binary data, such as compressed data, encrypted data, or images.</p>
    */
  @JSName("BinaryValue")
  var BinaryValue__UnmarshalledMessageAttributeValue: js.UndefOr[scala.scalajs.js.typedarray.Uint8Array] = js.undefined
  /**
    * <p>Not implemented. Reserved for future use.</p>
    */
