...
import typingsSlinky.atAwsDashSdkClientDashSqsDashNode.typesUnderscoreMessageAttributeValueMod._MessageAttributeValue
...
@JSImport("@aws-sdk/client-sqs-node/types/SendMessageInput", JSImport.Namespace)
@js.native
object typesSendMessageInputMod extends js.Object {
  @js.native
  trait SendMessageInput extends InputTypesUnion {
    ...
    var MessageAttributes: js.UndefOr[
        StringDictionary[_MessageAttributeValue] | (js.Iterable[js.Tuple2[String, _MessageAttributeValue]])
      ] = js.native
    /**
