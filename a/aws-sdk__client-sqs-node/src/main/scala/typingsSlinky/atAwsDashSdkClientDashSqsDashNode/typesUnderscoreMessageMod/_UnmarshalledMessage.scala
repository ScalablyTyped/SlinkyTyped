package typingsSlinky.atAwsDashSdkClientDashSqsDashNode.typesUnderscoreMessageMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atAwsDashSdkClientDashSqsDashNode.typesUnderscoreMessageAttributeValueMod._UnmarshalledMessageAttributeValue
...
trait _UnmarshalledMessage extends _Message {
  ...
  {[ key in 'SenderId' | 'SentTimestamp' | 'ApproximateReceiveCount' | 'ApproximateFirstReceiveTimestamp' | 'SequenceNumber' | 'MessageDeduplicationId' | 'MessageGroupId' | string ]: string}
    */ typingsSlinky.atAwsDashSdkClientDashSqsDashNode.atAwsDashSdkClientDashSqsDashNodeStrings._UnmarshalledMessage with js.Any
  ] = js.undefined
  /**
...
object _UnmarshalledMessage {
  ...
  {[ key in 'SenderId' | 'SentTimestamp' | 'ApproximateReceiveCount' | 'ApproximateFirstReceiveTimestamp' | 'SequenceNumber' | 'MessageDeduplicationId' | 'MessageGroupId' | string ]: string}
    */ typingsSlinky.atAwsDashSdkClientDashSqsDashNode.atAwsDashSdkClientDashSqsDashNodeStrings._UnmarshalledMessage with js.Any = null,
    Body: String = null,
