...
@JSImport("@aws-sdk/client-sqs-node/types/GetQueueAttributesInput", JSImport.Namespace)
@js.native
object typesGetQueueAttributesInputMod extends js.Object {
  @js.native
  trait GetQueueAttributesInput extends InputTypesUnion {
    /**
