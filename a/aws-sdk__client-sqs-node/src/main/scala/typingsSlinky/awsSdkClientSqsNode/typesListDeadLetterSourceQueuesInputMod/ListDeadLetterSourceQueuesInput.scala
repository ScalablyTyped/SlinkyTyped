package typingsSlinky.awsSdkClientSqsNode.typesListDeadLetterSourceQueuesInputMod
...
object ListDeadLetterSourceQueuesInput {
  @scala.inline
  def apply(QueueUrl: String): ListDeadLetterSourceQueuesInput = {
    val __obj = js.Dynamic.literal(QueueUrl = QueueUrl.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListDeadLetterSourceQueuesInput]
  }
  @scala.inline
  implicit class ListDeadLetterSourceQueuesInputOps[Self <: ListDeadLetterSourceQueuesInput] (val x: Self) extends AnyVal {
    @scala.inline
