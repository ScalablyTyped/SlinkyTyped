...
trait InvalidMessageContents extends SendMessageExceptionsUnion {
  ...
  var name: typingsSlinky.awsSdkClientSqsNode.awsSdkClientSqsNodeStrings.InvalidMessageContents = js.native
}
object InvalidMessageContents {
  
  @scala.inline
  def apply(name: typingsSlinky.awsSdkClientSqsNode.awsSdkClientSqsNodeStrings.InvalidMessageContents): InvalidMessageContents = {
  ...
  implicit class InvalidMessageContentsOps[Self <: InvalidMessageContents] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientSqsNode.awsSdkClientSqsNodeStrings.InvalidMessageContents): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
