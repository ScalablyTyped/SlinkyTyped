package typingsSlinky.awsSdkClientSqsNode.typesListQueueTagsInputMod
...
object ListQueueTagsInput {
  ...
  @scala.inline
  implicit class ListQueueTagsInputOps[Self <: ListQueueTagsInput] (val x: Self) extends AnyVal {
    @scala.inline
