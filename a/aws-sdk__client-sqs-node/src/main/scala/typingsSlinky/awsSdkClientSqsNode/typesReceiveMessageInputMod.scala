...
object typesReceiveMessageInputMod {
  ...
  object ReceiveMessageInput {
    ...
    @scala.inline
    implicit class ReceiveMessageInputMutableBuilder[Self <: ReceiveMessageInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaxNumberOfMessages(value: Double): Self = StObject.set(x, "MaxNumberOfMessages", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxNumberOfMessagesUndefined: Self = StObject.set(x, "MaxNumberOfMessages", js.undefined)
      
      @scala.inline
      def setMessageAttributeNames(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "MessageAttributeNames", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMessageAttributeNamesIterable(value: js.Iterable[String]): Self = StObject.set(x, "MessageAttributeNames", value.asInstanceOf[js.Any])
