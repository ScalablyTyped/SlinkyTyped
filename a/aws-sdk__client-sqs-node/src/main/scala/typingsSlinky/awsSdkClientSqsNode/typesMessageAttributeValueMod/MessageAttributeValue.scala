...
object MessageAttributeValue {
  ...
  implicit class MessageAttributeValueOps[Self <: MessageAttributeValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBinaryListValuesVarargs(value: (js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String)*): Self = this.set("BinaryListValues", js.Array(value :_*))
    @scala.inline
    def setBinaryListValuesIterable(value: js.Iterable[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String]): Self = this.set("BinaryListValues", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setBinaryValueArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("BinaryValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setBinaryValueArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("BinaryValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setBinaryValue(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = this.set("BinaryValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStringListValuesIterable(value: js.Iterable[String]): Self = this.set("StringListValues", value.asInstanceOf[js.Any])
    @scala.inline
    def setStringListValues(value: js.Array[String] | js.Iterable[String]): Self = this.set("StringListValues", value.asInstanceOf[js.Any])
    @scala.inline
