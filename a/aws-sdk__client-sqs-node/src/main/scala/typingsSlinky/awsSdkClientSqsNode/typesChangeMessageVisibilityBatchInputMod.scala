...
object typesChangeMessageVisibilityBatchInputMod {
  ...
  trait ChangeMessageVisibilityBatchInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Entries: js.Array[ChangeMessageVisibilityBatchRequestEntry] | js.Iterable[ChangeMessageVisibilityBatchRequestEntry] = js.native
  ...
  object ChangeMessageVisibilityBatchInput {
    ...
    @scala.inline
    implicit class ChangeMessageVisibilityBatchInputMutableBuilder[Self <: ChangeMessageVisibilityBatchInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEntriesIterable(value: js.Iterable[ChangeMessageVisibilityBatchRequestEntry]): Self = StObject.set(x, "Entries", value.asInstanceOf[js.Any])
