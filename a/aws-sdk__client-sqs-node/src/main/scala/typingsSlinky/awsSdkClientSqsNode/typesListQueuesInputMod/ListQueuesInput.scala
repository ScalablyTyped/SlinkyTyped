package typingsSlinky.awsSdkClientSqsNode.typesListQueuesInputMod
...
object ListQueuesInput {
  
  @scala.inline
  def apply(): ListQueuesInput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListQueuesInput]
  }
  
  @scala.inline
  implicit class ListQueuesInputOps[Self <: ListQueuesInput] (val x: Self) extends AnyVal {
