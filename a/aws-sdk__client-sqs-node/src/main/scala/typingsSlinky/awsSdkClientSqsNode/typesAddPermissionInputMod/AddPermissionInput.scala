...
object AddPermissionInput {
  ...
  implicit class AddPermissionInputOps[Self <: AddPermissionInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAWSAccountIdsIterable(value: js.Iterable[String]): Self = this.set("AWSAccountIds", value.asInstanceOf[js.Any])
    @scala.inline
    def setAWSAccountIds(value: js.Array[String] | js.Iterable[String]): Self = this.set("AWSAccountIds", value.asInstanceOf[js.Any])
    @scala.inline
    def setActionsVarargs(value: String*): Self = this.set("Actions", js.Array(value :_*))
    @scala.inline
    def setActionsIterable(value: js.Iterable[String]): Self = this.set("Actions", value.asInstanceOf[js.Any])
    @scala.inline
    def setActions(value: js.Array[String] | js.Iterable[String]): Self = this.set("Actions", value.asInstanceOf[js.Any])
    @scala.inline
