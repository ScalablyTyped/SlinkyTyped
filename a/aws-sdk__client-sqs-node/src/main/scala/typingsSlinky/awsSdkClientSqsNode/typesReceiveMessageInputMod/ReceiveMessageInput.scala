package typingsSlinky.awsSdkClientSqsNode.typesReceiveMessageInputMod
...
object ReceiveMessageInput {
  ...
  implicit class ReceiveMessageInputOps[Self <: ReceiveMessageInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessageAttributeNamesIterable(value: js.Iterable[String]): Self = this.set("MessageAttributeNames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMessageAttributeNames(value: js.Array[String] | js.Iterable[String]): Self = this.set("MessageAttributeNames", value.asInstanceOf[js.Any])
