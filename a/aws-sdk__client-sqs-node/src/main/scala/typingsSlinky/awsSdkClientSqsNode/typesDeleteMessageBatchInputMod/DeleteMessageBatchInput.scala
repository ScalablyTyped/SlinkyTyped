...
object DeleteMessageBatchInput {
  ...
  implicit class DeleteMessageBatchInputOps[Self <: DeleteMessageBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEntriesIterable(value: js.Iterable[DeleteMessageBatchRequestEntry]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Entries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEntries(value: js.Array[DeleteMessageBatchRequestEntry] | js.Iterable[DeleteMessageBatchRequestEntry]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Entries")(value.asInstanceOf[js.Any])
        ret
    }
