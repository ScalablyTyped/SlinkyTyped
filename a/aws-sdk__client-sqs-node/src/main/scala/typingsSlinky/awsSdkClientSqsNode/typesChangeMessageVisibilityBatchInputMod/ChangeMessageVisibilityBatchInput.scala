package typingsSlinky.awsSdkClientSqsNode.typesChangeMessageVisibilityBatchInputMod
...
object ChangeMessageVisibilityBatchInput {
  ...
  implicit class ChangeMessageVisibilityBatchInputOps[Self <: ChangeMessageVisibilityBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesIterable(value: js.Iterable[ChangeMessageVisibilityBatchRequestEntry]): Self = this.set("Entries", value.asInstanceOf[js.Any])
