package typingsSlinky.awsSdkClientSqsNode.typesChangeMessageVisibilityBatchOutputMod
...
object ChangeMessageVisibilityBatchOutput {
  ...
  implicit class ChangeMessageVisibilityBatchOutputOps[Self <: ChangeMessageVisibilityBatchOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccessful(value: js.Array[UnmarshalledChangeMessageVisibilityBatchResultEntry]): Self = {
        val ret = this.duplicate
