package typingsSlinky.awsSdkClientSqsNode.typesSendMessageBatchInputMod
...
object SendMessageBatchInput {
  ...
  implicit class SendMessageBatchInputOps[Self <: SendMessageBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesIterable(value: js.Iterable[SendMessageBatchRequestEntry]): Self = this.set("Entries", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEntries(value: js.Array[SendMessageBatchRequestEntry] | js.Iterable[SendMessageBatchRequestEntry]): Self = this.set("Entries", value.asInstanceOf[js.Any])
