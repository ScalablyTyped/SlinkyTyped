...
object SendMessageBatchInput {
  ...
  implicit class SendMessageBatchInputOps[Self <: SendMessageBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEntriesIterable(value: js.Iterable[SendMessageBatchRequestEntry]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Entries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEntries(value: js.Array[SendMessageBatchRequestEntry] | js.Iterable[SendMessageBatchRequestEntry]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Entries")(value.asInstanceOf[js.Any])
        ret
    }
