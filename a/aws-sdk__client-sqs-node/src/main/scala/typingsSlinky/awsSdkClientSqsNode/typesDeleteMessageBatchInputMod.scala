...
object typesDeleteMessageBatchInputMod {
  ...
  object DeleteMessageBatchInput {
    ...
    implicit class DeleteMessageBatchInputMutableBuilder[Self <: DeleteMessageBatchInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEntries(value: js.Array[DeleteMessageBatchRequestEntry] | js.Iterable[DeleteMessageBatchRequestEntry]): Self = StObject.set(x, "Entries", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEntriesIterable(value: js.Iterable[DeleteMessageBatchRequestEntry]): Self = StObject.set(x, "Entries", value.asInstanceOf[js.Any])
