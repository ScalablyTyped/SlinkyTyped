...
object typesMessageAttributeValueMod {
  ...
  object MessageAttributeValue {
    ...
    implicit class MessageAttributeValueMutableBuilder[Self <: MessageAttributeValue] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBinaryListValuesIterable(value: js.Iterable[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String]): Self = StObject.set(x, "BinaryListValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBinaryListValuesUndefined: Self = StObject.set(x, "BinaryListValues", js.undefined)
      
      @scala.inline
      def setBinaryListValuesVarargs(value: (js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String)*): Self = StObject.set(x, "BinaryListValues", js.Array(value :_*))
      
      @scala.inline
      def setBinaryValue(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = StObject.set(x, "BinaryValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBinaryValueArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "BinaryValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBinaryValueArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "BinaryValue", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStringListValues(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "StringListValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStringListValuesIterable(value: js.Iterable[String]): Self = StObject.set(x, "StringListValues", value.asInstanceOf[js.Any])
  ...
  object UnmarshalledMessageAttributeValue {
    ...
    implicit class UnmarshalledMessageAttributeValueMutableBuilder[Self <: UnmarshalledMessageAttributeValue] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBinaryListValues(value: js.Array[js.typedarray.Uint8Array]): Self = StObject.set(x, "BinaryListValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBinaryListValuesUndefined: Self = StObject.set(x, "BinaryListValues", js.undefined)
      
      @scala.inline
      def setBinaryListValuesVarargs(value: js.typedarray.Uint8Array*): Self = StObject.set(x, "BinaryListValues", js.Array(value :_*))
      
      @scala.inline
      def setBinaryValue(value: js.typedarray.Uint8Array): Self = StObject.set(x, "BinaryValue", value.asInstanceOf[js.Any])
