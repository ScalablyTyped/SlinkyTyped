package typingsSlinky.awsSdkClientSqsNode.typesChangeMessageVisibilityOutputMod
...
object ChangeMessageVisibilityOutput {
  ...
  @scala.inline
  implicit class ChangeMessageVisibilityOutputOps[Self <: ChangeMessageVisibilityOutput] (val x: Self) extends AnyVal {
    @scala.inline
