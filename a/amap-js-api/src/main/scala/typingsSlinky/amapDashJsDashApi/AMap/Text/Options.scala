package typingsSlinky.amapDashJsDashApi.AMap.Text
...
import typingsSlinky.amapDashJsDashApi.AMap.Marker.Anchor
import typingsSlinky.amapDashJsDashApi.AMap.Marker.Label
...
trait Options
  extends typingsSlinky.amapDashJsDashApi.AMap.Marker.Options[js.Any] {
  /**
    * 文本内容
    */
