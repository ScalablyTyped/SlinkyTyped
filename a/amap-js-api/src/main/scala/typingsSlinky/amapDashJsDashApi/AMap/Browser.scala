...
import typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.other
...
object Browser extends js.Object {
  ...
  /**
    ...
    */
  val plat: typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.android | typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.ios | typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.windows | typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.mac | other = js.native
  /**
    * 是否pointer设备
    */
