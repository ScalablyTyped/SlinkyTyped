...
import typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.Feature
import typingsSlinky.amapDashJsDashApi.amapDashJsDashApiStrings.FeatureCollection
