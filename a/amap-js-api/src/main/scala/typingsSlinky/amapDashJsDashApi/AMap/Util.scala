...
import typingsSlinky.amapDashJsDashApi.Anon_Timeout
...
object Util extends js.Object {
  ...
  def requestIdleCallback(callback: js.Function1[/* repeated */ js.Any, _], options: Anon_Timeout): Double = js.native
  /**
