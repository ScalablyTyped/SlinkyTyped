...
object TypeofTileLayer {
  ...
  implicit class TypeofTileLayerMutableBuilder[Self <: TypeofTileLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWMS(value: Instantiable1[/* options */ typingsSlinky.amapJsApi.AMap.TileLayer.WMS.Options, WMS]): Self = StObject.set(x, "WMS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWMTS(value: Instantiable1[/* options */ typingsSlinky.amapJsApi.AMap.TileLayer.WMTS.Options, WMTS]): Self = StObject.set(x, "WMTS", value.asInstanceOf[js.Any])
  }
}
