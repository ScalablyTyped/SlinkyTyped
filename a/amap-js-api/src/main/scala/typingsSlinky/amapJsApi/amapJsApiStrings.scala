...
import typingsSlinky.amapJsApi.AMap.LabelMarker.Anchor
import typingsSlinky.amapJsApi.AMap.LabelMarker.FontWeight
import typingsSlinky.amapJsApi.AMap.LabelMarker.TextDirection
import typingsSlinky.amapJsApi.AMap.Lang
import typingsSlinky.amapJsApi.AMap.Map.ViewMode
import typingsSlinky.amapJsApi.AMap.Marker.LabelDirection
...
import typingsSlinky.amapJsApi.AMap.Text.TextAlign
import typingsSlinky.amapJsApi.AMap.Text.VerticalAlign
...
object amapJsApiStrings {
  ...
  @js.native
  sealed trait bg
    extends typingsSlinky.amapJsApi.AMap.Map.Feature
  ...
  sealed trait `bottom-center`
    extends Anchor
       with typingsSlinky.amapJsApi.AMap.Marker.Anchor
       with typingsSlinky.amapJsApi.AMap.InfoWindow.Anchor
