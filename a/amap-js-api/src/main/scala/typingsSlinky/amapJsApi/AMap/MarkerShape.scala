...
object MarkerShape {
  ...
  */
  ...
  object Options {
    ...
    @scala.inline
    def CircleOptions(coords: js.Tuple3[Double, Double, Double], `type`: circle): typingsSlinky.amapJsApi.AMap.MarkerShape.CircleOptions = {
      val __obj = js.Dynamic.literal(coords = coords.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.amapJsApi.AMap.MarkerShape.CircleOptions]
    }
    
    @scala.inline
    def PolyOptions(coords: js.Array[Double], `type`: poly): typingsSlinky.amapJsApi.AMap.MarkerShape.PolyOptions = {
      val __obj = js.Dynamic.literal(coords = coords.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.amapJsApi.AMap.MarkerShape.PolyOptions]
    }
    
    @scala.inline
    def RectOptions(coords: js.Tuple4[Double, Double, Double, Double], `type`: rect): typingsSlinky.amapJsApi.AMap.MarkerShape.RectOptions = {
      val __obj = js.Dynamic.literal(coords = coords.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.amapJsApi.AMap.MarkerShape.RectOptions]
    }
  }
