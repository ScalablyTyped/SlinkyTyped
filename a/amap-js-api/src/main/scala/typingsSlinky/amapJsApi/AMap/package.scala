...
package object AMap {
  ...
  type Event_[N /* <: java.lang.String */, V] = typingsSlinky.amapJsApi.AnonType[N] with (typingsSlinky.amapJsApi.AnonValue[V] | js.Object | V)
  ...
  type MapsEvent[N /* <: java.lang.String */, I] = typingsSlinky.amapJsApi.AMap.Event_[N, typingsSlinky.amapJsApi.AnonLnglat[I]]
  type Marker[ExtraData] = typingsSlinky.amapJsApi.AMap.Marker_[ExtraData]
  type MarkerShape = typingsSlinky.amapJsApi.AMap.MarkerShape_
  ...
  type View2D = typingsSlinky.amapJsApi.AMap.View2D_
}
