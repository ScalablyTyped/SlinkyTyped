package typingsSlinky.amapJsApi.AMap.event
...
object addDomListener extends js.Object {
  /**
    ...
    * @param context 事件上下文
    */
  def apply[N /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 119 */ js.Any */, E /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 92 */ js.Any */, C](
