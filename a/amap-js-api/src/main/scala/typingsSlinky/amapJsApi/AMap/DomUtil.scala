...
import typingsSlinky.amapJsApi.AnonX
import typingsSlinky.amapJsApi.PartialCSSStyleDeclaratio
import typingsSlinky.amapJsApi.TypeofDomUtil
...
object DomUtil extends js.Object {
  ...
  def setCss(dom: js.Array[typingsSlinky.std.HTMLElement], style: PartialCSSStyleDeclaratio): TypeofDomUtil = js.native
  /**
    * 给DOM元素删除一组样式，Object同样式表
    * @param dom DOM元素
    * @param style 样式
    */
  def setCss(dom: typingsSlinky.std.HTMLElement, style: PartialCSSStyleDeclaratio): TypeofDomUtil = js.native
  /**
    * 给DOM元素设定一个透明度
    * @param dom DOM元素
