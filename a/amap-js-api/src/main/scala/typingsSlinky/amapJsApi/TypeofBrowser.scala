...
trait TypeofBrowser extends js.Object {
  ...
  /**
    ...
    */
  val plat: typingsSlinky.amapJsApi.amapJsApiStrings.android | typingsSlinky.amapJsApi.amapJsApiStrings.ios | typingsSlinky.amapJsApi.amapJsApiStrings.windows | typingsSlinky.amapJsApi.amapJsApiStrings.mac | other
  /**
    * 是否pointer设备
    */
  val pointer: Boolean
