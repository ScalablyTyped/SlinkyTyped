...
trait TypeofAMap extends js.Object {
  ...
  var LayerGroup: Instantiable1[
    ...
    typingsSlinky.amapJsApi.AMap.LayerGroup[js.Object]
  ] = js.native
  ...
  val MarkerShape: Instantiable1[
    /* options */ typingsSlinky.amapJsApi.AMap.MarkerShape.Options, 
    typingsSlinky.amapJsApi.AMap.MarkerShape
  ] = js.native
  val MassMarks: Instantiable2[
    /* data */ (js.Array[/* import warning: RewrittenClass.unapply cls was tparam D */ js.Any]) | String, 
    /* opts */ typingsSlinky.amapJsApi.AMap.MassMarks.Options, 
    typingsSlinky.amapJsApi.AMap.MassMarks[Data]
  ] = js.native
