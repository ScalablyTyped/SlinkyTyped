...
object event extends js.Object {
  ...
  /**
    ...
    * @param context 事件上下文
    */
  def addListener[I /* <: typingsSlinky.amapJsApi.AMap.EventEmitter */, C](
    // tslint:disable-next-line: no-unnecessary-generics
  instance: I,
    eventName: String,
  ...
  /**
    ...
    * @param context 事件上下文
    */
  def addListenerOnce[I /* <: typingsSlinky.amapJsApi.AMap.EventEmitter */, C](
    // tslint:disable-next-line: no-unnecessary-generics
  instance: I,
    eventName: String,
    handler: js.ThisFunction1[/* this */ C, /* event */ js.Any, Unit]
  ...
  /**
    ...
    * @param data 事件数据
    */
  def trigger(instance: typingsSlinky.amapJsApi.AMap.EventEmitter, eventName: String): Unit = js.native
  def trigger(instance: typingsSlinky.amapJsApi.AMap.EventEmitter, eventName: String, data: js.Any): Unit = js.native
}
