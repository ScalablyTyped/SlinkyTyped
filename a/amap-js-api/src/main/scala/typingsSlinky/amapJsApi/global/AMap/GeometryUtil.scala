...
object GeometryUtil {
  ...
  def triangulateShape(
    shape1: js.Array[typingsSlinky.amapJsApi.AMap.LngLat | typingsSlinky.amapJsApi.AMap.Pixel],
    shape2: js.Array[typingsSlinky.amapJsApi.AMap.LngLat | typingsSlinky.amapJsApi.AMap.Pixel]
