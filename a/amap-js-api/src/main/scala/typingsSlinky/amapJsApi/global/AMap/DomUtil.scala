...
import typingsSlinky.amapJsApi.anon.PartialCSSStyleDeclaratio
import typingsSlinky.amapJsApi.anon.TypeofDomUtil
...
object DomUtil extends js.Object {
  ...
  /**
    ...
    * @param dom DOM元素
    */
  def getViewport(dom: HTMLElement): typingsSlinky.amapJsApi.AMap.Size = js.native
  
  /**
    * 获取DOM元素距离窗口左上角的距离
    * @param dom DOM元素
    */
  def getViewportOffset(dom: HTMLElement): typingsSlinky.amapJsApi.AMap.Pixel = js.native
