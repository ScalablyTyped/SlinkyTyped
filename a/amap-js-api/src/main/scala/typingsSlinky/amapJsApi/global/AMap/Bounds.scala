...
/**
  ...
  */
class Bounds ()
  extends typingsSlinky.amapJsApi.AMap.Bounds {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNorthEast(): typingsSlinky.amapJsApi.AMap.LngLat = js.native
  /**
    * 获取西北角坐标
    */
  /* CompleteClass */
  override def getNorthWest(): typingsSlinky.amapJsApi.AMap.LngLat = js.native
  /**
    * 获取东南角坐标
    */
  /* CompleteClass */
  override def getSouthEast(): typingsSlinky.amapJsApi.AMap.LngLat = js.native
  /**
    * 获取西南角坐标
    */
  /* CompleteClass */
  override def getSouthWest(): typingsSlinky.amapJsApi.AMap.LngLat = js.native
}
