...
trait Scenic extends StObject {
  ...
  /**
    * @deprecated 景点类深度信息
    */
  var scenic: typingsSlinky.amapJsApiPlaceSearch.AMap.PlaceSearch.Scenic = js.native
}
object Scenic {
  
  @scala.inline
  def apply(deep_type: SCENIC, scenic: typingsSlinky.amapJsApiPlaceSearch.AMap.PlaceSearch.Scenic): Scenic = {
  ...
  implicit class ScenicMutableBuilder[Self <: Scenic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScenic(value: typingsSlinky.amapJsApiPlaceSearch.AMap.PlaceSearch.Scenic): Self = StObject.set(x, "scenic", value.asInstanceOf[js.Any])
  }
}
