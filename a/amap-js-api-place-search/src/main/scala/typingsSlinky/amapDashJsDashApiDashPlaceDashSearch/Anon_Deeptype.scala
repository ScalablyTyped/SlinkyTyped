...
import typingsSlinky.amapDashJsDashApiDashPlaceDashSearch.AMap.PlaceSearch.Scenic
import typingsSlinky.amapDashJsDashApiDashPlaceDashSearch.amapDashJsDashApiDashPlaceDashSearchStrings.SCENIC
