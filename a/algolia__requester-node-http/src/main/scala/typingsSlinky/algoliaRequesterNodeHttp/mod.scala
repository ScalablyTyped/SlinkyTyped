...
object mod {
  ...
  trait NodeHttpRequesterOptions extends StObject {
    ...
    var agent: js.UndefOr[Agent | typingsSlinky.node.httpMod.Agent] = js.native
    
    var httpAgent: js.UndefOr[typingsSlinky.node.httpMod.Agent] = js.native
  ...
  object NodeHttpRequesterOptions {
    ...
    implicit class NodeHttpRequesterOptionsMutableBuilder[Self <: NodeHttpRequesterOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAgent(value: Agent | typingsSlinky.node.httpMod.Agent): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAgentUndefined: Self = StObject.set(x, "agent", js.undefined)
      
      @scala.inline
      def setHttpAgent(value: typingsSlinky.node.httpMod.Agent): Self = StObject.set(x, "httpAgent", value.asInstanceOf[js.Any])
