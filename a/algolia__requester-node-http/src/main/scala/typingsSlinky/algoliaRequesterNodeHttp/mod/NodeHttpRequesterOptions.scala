package typingsSlinky.algoliaRequesterNodeHttp.mod
...
object NodeHttpRequesterOptions {
  ...
  implicit class NodeHttpRequesterOptionsOps[Self <: NodeHttpRequesterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAgent(value: Agent | typingsSlinky.node.httpMod.Agent): Self = this.set("agent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAgent: Self = this.set("agent", js.undefined)
    
    @scala.inline
    def setHttpAgent(value: typingsSlinky.node.httpMod.Agent): Self = this.set("httpAgent", value.asInstanceOf[js.Any])
