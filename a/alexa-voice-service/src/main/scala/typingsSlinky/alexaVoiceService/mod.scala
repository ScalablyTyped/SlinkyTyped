...
object mod {
  ...
  object EventTypes extends StObject {
    ...
    /* 2 */ val ERROR: typingsSlinky.alexaVoiceService.mod.EventTypes.ERROR with Double = js.native
    
    @js.native
    sealed trait LOG extends EventTypes
    /* 4 */ val LOG: typingsSlinky.alexaVoiceService.mod.EventTypes.LOG with Double = js.native
    
    @js.native
    sealed trait LOGIN extends EventTypes
    /* 5 */ val LOGIN: typingsSlinky.alexaVoiceService.mod.EventTypes.LOGIN with Double = js.native
    
    @js.native
    sealed trait LOGOUT extends EventTypes
    /* 6 */ val LOGOUT: typingsSlinky.alexaVoiceService.mod.EventTypes.LOGOUT with Double = js.native
    
    @js.native
    sealed trait RECORD_START extends EventTypes
    /* 1 */ val RECORD_START: typingsSlinky.alexaVoiceService.mod.EventTypes.RECORD_START with Double = js.native
    
    @js.native
    sealed trait RECORD_STOP extends EventTypes
    /* 0 */ val RECORD_STOP: typingsSlinky.alexaVoiceService.mod.EventTypes.RECORD_STOP with Double = js.native
    
    @js.native
    sealed trait REFRESH_TOKEN_SET extends EventTypes
    /* 8 */ val REFRESH_TOKEN_SET: typingsSlinky.alexaVoiceService.mod.EventTypes.REFRESH_TOKEN_SET with Double = js.native
    
    @js.native
    sealed trait TOKEN_INVALID extends EventTypes
    /* 3 */ val TOKEN_INVALID: typingsSlinky.alexaVoiceService.mod.EventTypes.TOKEN_INVALID with Double = js.native
    
    @js.native
    sealed trait TOKEN_SET extends EventTypes
    /* 7 */ val TOKEN_SET: typingsSlinky.alexaVoiceService.mod.EventTypes.TOKEN_SET with Double = js.native
  }
  ...
  class Player () extends StObject {
    ...
    def on(eventType: typingsSlinky.alexaVoiceService.mod.Player.EventTypes): Unit = js.native
    def on(eventType: typingsSlinky.alexaVoiceService.mod.Player.EventTypes, callback: js.Function0[Unit]): Unit = js.native
  }
  object Player {
    ...
    object EventTypes extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.alexaVoiceService.mod.Player.EventTypes with Double] = js.native
      
      @js.native
      sealed trait DEQUE
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 7 */ val DEQUE: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.DEQUE with Double = js.native
      
      @js.native
      sealed trait ENQUEUE
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 6 */ val ENQUEUE: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.ENQUEUE with Double = js.native
      
      @js.native
      sealed trait ERROR
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 1 */ val ERROR: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.ERROR with Double = js.native
      
      @js.native
      sealed trait LOG
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 0 */ val LOG: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.LOG with Double = js.native
      
      @js.native
      sealed trait PAUSE
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 4 */ val PAUSE: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.PAUSE with Double = js.native
      
      @js.native
      sealed trait PLAY
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 2 */ val PLAY: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.PLAY with Double = js.native
      
      @js.native
      sealed trait REPLAY
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 3 */ val REPLAY: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.REPLAY with Double = js.native
      
      @js.native
      sealed trait STOP
        extends typingsSlinky.alexaVoiceService.mod.Player.EventTypes
      /* 5 */ val STOP: typingsSlinky.alexaVoiceService.mod.Player.EventTypes.STOP with Double = js.native
    }
  }
