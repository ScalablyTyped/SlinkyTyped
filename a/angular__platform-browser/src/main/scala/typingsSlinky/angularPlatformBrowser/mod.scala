...
import typingsSlinky.angularCommon.mod.ɵDomAdapter
...
import typingsSlinky.angularCore.mod.ErrorHandler
import typingsSlinky.angularCore.mod.GetTestability
...
import typingsSlinky.angularCore.mod.NgProbeToken
