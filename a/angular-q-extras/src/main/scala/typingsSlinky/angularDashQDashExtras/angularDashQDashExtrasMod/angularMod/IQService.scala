package typingsSlinky.angularDashQDashExtras.angularDashQDashExtrasMod.angularMod
...
trait IQService extends js.Object {
  ...
  {[ K in keyof T ]: T[K] | angular.angular.IPromise<T[K]>}
    */ typingsSlinky.angularDashQDashExtras.angularDashQDashExtrasStrings.IQService with js.Any
  ): IPromise[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof T ]: angular-q-extras.angular-q-extras.angular.PromiseValue<T[K]>}
    */ typingsSlinky.angularDashQDashExtras.angularDashQDashExtrasStrings.IQService with T
  ] = js.native
