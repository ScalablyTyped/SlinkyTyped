...
object JobAttributes {
  @scala.inline
  def apply[/* <: typingsSlinky.agenda.mod.JobAttributesData */ T](
    _id: ObjectID_,
    data: T,
    disabled: Boolean,
    failCount: Double,
  ...
  @scala.inline
  implicit class JobAttributesOps[Self <: JobAttributes[_], /* <: typingsSlinky.agenda.mod.JobAttributesData */ T] (val x: Self with JobAttributes[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFailedAt(value: js.Date): Self = this.set("failedAt", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastFinishedAt(value: js.Date): Self = this.set("lastFinishedAt", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastModifiedBy(value: String): Self = this.set("lastModifiedBy", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastRunAt(value: js.Date): Self = this.set("lastRunAt", value.asInstanceOf[js.Any])
    @scala.inline
    def setLockedAt(value: js.Date): Self = this.set("lockedAt", value.asInstanceOf[js.Any])
    @scala.inline
    def setName(value: String): Self = this.set("name", value.asInstanceOf[js.Any])
    @scala.inline
    def setNextRunAt(value: js.Date): Self = this.set("nextRunAt", value.asInstanceOf[js.Any])
    @scala.inline
