...
object mod {
  ...
  object JobAttributes {
    ...
    implicit class JobAttributesMutableBuilder[Self <: JobAttributes[_], T /* <: JobAttributesData */] (val x: Self with JobAttributes[T]) extends AnyVal {
      ...
      @scala.inline
      def setFailedAt(value: js.Date): Self = StObject.set(x, "failedAt", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastFinishedAt(value: js.Date): Self = StObject.set(x, "lastFinishedAt", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastModifiedBy(value: String): Self = StObject.set(x, "lastModifiedBy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastRunAt(value: js.Date): Self = StObject.set(x, "lastRunAt", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLockedAt(value: js.Date): Self = StObject.set(x, "lockedAt", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNextRunAt(value: js.Date): Self = StObject.set(x, "nextRunAt", value.asInstanceOf[js.Any])
