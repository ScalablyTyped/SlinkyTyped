package typingsSlinky.atAwsDashSdkCredentialDashProviderDashImds.buildRemoteProviderImdsCredentialsMod
...
object fromImdsCredentials extends js.Object {
  def apply(creds: ImdsCredentials): Credentials = js.native
}
