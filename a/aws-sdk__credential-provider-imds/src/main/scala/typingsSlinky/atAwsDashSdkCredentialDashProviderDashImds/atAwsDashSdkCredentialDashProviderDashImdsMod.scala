...
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashImds.atAwsDashSdkCredentialDashProviderDashImdsStrings.AWS_CONTAINER_AUTHORIZATION_TOKEN
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashImds.atAwsDashSdkCredentialDashProviderDashImdsStrings.AWS_CONTAINER_CREDENTIALS_FULL_URI
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashImds.atAwsDashSdkCredentialDashProviderDashImdsStrings.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI
