...
import typingsSlinky.activexDashIwshruntimelibrary.IWshRuntimeLibrary.WshEnvironment
import typingsSlinky.activexDashIwshruntimelibrary.activexDashIwshruntimelibraryStrings.Item
