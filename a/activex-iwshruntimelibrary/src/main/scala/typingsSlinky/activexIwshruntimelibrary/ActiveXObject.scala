...
import typingsSlinky.activexIwshruntimelibrary.IWshRuntimeLibrary.WshEnvironment
import typingsSlinky.activexIwshruntimelibrary.activexIwshruntimelibraryStrings.Item
...
object ActiveXObject {
  ...
  implicit class ActiveXObjectOps[Self <: ActiveXObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSet(value: (WshEnvironment, Item, js.Array[String], String) => Unit): Self = {
