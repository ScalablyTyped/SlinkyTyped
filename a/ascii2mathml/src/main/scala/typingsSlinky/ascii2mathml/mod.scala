package typingsSlinky.ascii2mathml
...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsSlinky.ascii2mathml.mod.ascii2mathml = js.native
  ...
  type _To = typingsSlinky.ascii2mathml.mod.ascii2mathml
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.ascii2mathml.mod.ascii2mathml = ^
  ...
  trait ascii2mathml extends StObject {
    ...
    /**
      ...
      * @param options Options
      */
    def apply(options: Options): typingsSlinky.ascii2mathml.mod.ascii2mathml = js.native
  }
}
