...
import typingsSlinky.angularDashMeteor.Anon_Bind
import typingsSlinky.angularDashMeteor.Anon_Email
import typingsSlinky.angularDashMeteor.Anon_EmailPassword
import typingsSlinky.angularDashMeteor.Anon_Height
import typingsSlinky.angularDashMeteor.Anon_Id
import typingsSlinky.angularDashMeteor.Anon_Username
...
trait IMeteorService extends js.Object {
  ...
  /**
    ...
    */
  def autorun(scope: typingsSlinky.angular.angularMod.IScope, fn: Function): Unit = js.native
  /**
