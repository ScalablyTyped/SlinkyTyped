...
import typingsSlinky.atAwsDashSdkClientDashCognitoDashIdentityDashBrowser.typesUnderscoreCognitoIdentityProviderMod._CognitoIdentityProvider
...
object typesCreateIdentityPoolInputMod extends js.Object {
  ...
  trait CreateIdentityPoolInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var CognitoIdentityProviders: js.UndefOr[js.Array[_CognitoIdentityProvider] | js.Iterable[_CognitoIdentityProvider]] = js.native
    /**
