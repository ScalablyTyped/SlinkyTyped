...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/ListIdentityPoolsInput", JSImport.Namespace)
@js.native
object typesListIdentityPoolsInputMod extends js.Object {
  @js.native
