...
import typingsSlinky.atAwsDashSdkClientDashCognitoDashIdentityDashBrowser.typesUnderscoreRoleMappingMod._RoleMapping
...
object typesSetIdentityPoolRolesInputMod extends js.Object {
  ...
  trait SetIdentityPoolRolesInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var RoleMappings: js.UndefOr[StringDictionary[_RoleMapping] | (js.Iterable[js.Tuple2[String, _RoleMapping]])] = js.native
    /**
