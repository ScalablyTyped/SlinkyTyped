package typingsSlinky.atAwsDashSdkClientDashCognitoDashIdentityDashBrowser.typesUnderscoreCredentialsMod
...
trait _UnmarshalledCredentials extends _Credentials {
  /**
    ...
    */
  @JSName("Expiration")
  var Expiration__UnmarshalledCredentials: js.UndefOr[js.Date] = js.undefined
}
