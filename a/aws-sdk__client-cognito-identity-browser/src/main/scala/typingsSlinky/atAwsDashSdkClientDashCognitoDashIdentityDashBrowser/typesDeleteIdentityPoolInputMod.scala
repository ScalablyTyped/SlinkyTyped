...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/DeleteIdentityPoolInput", JSImport.Namespace)
@js.native
object typesDeleteIdentityPoolInputMod extends js.Object {
  @js.native
