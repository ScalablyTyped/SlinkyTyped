...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/DescribeIdentityInput", JSImport.Namespace)
@js.native
object typesDescribeIdentityInputMod extends js.Object {
  @js.native
  trait DescribeIdentityInput extends InputTypesUnion {
    /**
