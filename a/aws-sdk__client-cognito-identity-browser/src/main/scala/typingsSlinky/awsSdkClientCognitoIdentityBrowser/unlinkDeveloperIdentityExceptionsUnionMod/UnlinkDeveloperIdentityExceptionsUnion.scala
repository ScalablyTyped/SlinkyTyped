package typingsSlinky.awsSdkClientCognitoIdentityBrowser.unlinkDeveloperIdentityExceptionsUnionMod
...
object UnlinkDeveloperIdentityExceptionsUnion {
  @scala.inline
  implicit def apply(value: InternalErrorException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
  @scala.inline
  implicit def apply(value: InvalidParameterException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotAuthorizedException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceConflictException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceNotFoundException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): UnlinkDeveloperIdentityExceptionsUnion = value.asInstanceOf[UnlinkDeveloperIdentityExceptionsUnion]
}
