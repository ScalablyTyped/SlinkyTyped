package typingsSlinky.awsSdkClientCognitoIdentityBrowser.describeIdentityPoolExceptionsUnionMod
...
object DescribeIdentityPoolExceptionsUnion {
  @scala.inline
  implicit def apply(value: InternalErrorException): DescribeIdentityPoolExceptionsUnion = value.asInstanceOf[DescribeIdentityPoolExceptionsUnion]
  @scala.inline
  implicit def apply(value: InvalidParameterException): DescribeIdentityPoolExceptionsUnion = value.asInstanceOf[DescribeIdentityPoolExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotAuthorizedException): DescribeIdentityPoolExceptionsUnion = value.asInstanceOf[DescribeIdentityPoolExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceNotFoundException): DescribeIdentityPoolExceptionsUnion = value.asInstanceOf[DescribeIdentityPoolExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DescribeIdentityPoolExceptionsUnion = value.asInstanceOf[DescribeIdentityPoolExceptionsUnion]
}
