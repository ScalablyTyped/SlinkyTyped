...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/CreateIdentityPoolOutput", JSImport.Namespace)
@js.native
object typesCreateIdentityPoolOutputMod extends js.Object {
  @js.native
