...
trait ResourceNotFoundException
  ...
  @JSName("name")
  var name_ResourceNotFoundException: typingsSlinky.awsSdkClientCognitoIdentityBrowser.awsSdkClientCognitoIdentityBrowserStrings.ResourceNotFoundException
}
