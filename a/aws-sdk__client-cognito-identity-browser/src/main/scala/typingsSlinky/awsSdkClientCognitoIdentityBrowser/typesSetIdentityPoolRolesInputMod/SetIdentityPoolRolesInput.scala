...
object SetIdentityPoolRolesInput {
  ...
  def apply(
    ...
    Roles: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]),
    $abortSignal: AbortSignal = null,
    $httpOptions: BrowserHttpOptions = null,
    $maxRetries: js.UndefOr[Double] = js.undefined,
    RoleMappings: StringDictionary[RoleMapping] | (js.Iterable[js.Tuple2[String, RoleMapping]]) = null
