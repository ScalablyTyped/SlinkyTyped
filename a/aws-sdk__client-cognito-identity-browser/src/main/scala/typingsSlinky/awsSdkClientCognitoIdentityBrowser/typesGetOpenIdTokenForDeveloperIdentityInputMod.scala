...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/GetOpenIdTokenForDeveloperIdentityInput", JSImport.Namespace)
@js.native
object typesGetOpenIdTokenForDeveloperIdentityInputMod extends js.Object {
  @js.native
