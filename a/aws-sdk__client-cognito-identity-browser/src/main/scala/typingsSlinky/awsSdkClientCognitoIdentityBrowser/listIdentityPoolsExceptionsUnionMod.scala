...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/ListIdentityPoolsExceptionsUnion", JSImport.Namespace)
@js.native
object listIdentityPoolsExceptionsUnionMod extends js.Object {
