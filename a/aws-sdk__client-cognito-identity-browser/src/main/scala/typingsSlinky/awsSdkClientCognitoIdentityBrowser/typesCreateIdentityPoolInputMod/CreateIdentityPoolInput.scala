...
object CreateIdentityPoolInput {
  ...
  implicit class CreateIdentityPoolInputOps[Self <: CreateIdentityPoolInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCognitoIdentityProvidersIterable(value: js.Iterable[CognitoIdentityProvider]): Self = this.set("CognitoIdentityProviders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCognitoIdentityProviders(value: js.Array[CognitoIdentityProvider] | js.Iterable[CognitoIdentityProvider]): Self = this.set("CognitoIdentityProviders", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOpenIdConnectProviderARNsIterable(value: js.Iterable[String]): Self = this.set("OpenIdConnectProviderARNs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOpenIdConnectProviderARNs(value: js.Array[String] | js.Iterable[String]): Self = this.set("OpenIdConnectProviderARNs", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSamlProviderARNsIterable(value: js.Iterable[String]): Self = this.set("SamlProviderARNs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSamlProviderARNs(value: js.Array[String] | js.Iterable[String]): Self = this.set("SamlProviderARNs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSamlProviderARNs: Self = this.set("SamlProviderARNs", js.undefined)
    
    @scala.inline
    def setSupportedLoginProvidersIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("SupportedLoginProviders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSupportedLoginProviders(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("SupportedLoginProviders", value.asInstanceOf[js.Any])
