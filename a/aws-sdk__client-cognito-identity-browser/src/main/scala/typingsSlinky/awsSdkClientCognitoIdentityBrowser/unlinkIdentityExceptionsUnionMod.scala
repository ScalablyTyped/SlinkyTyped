...
object unlinkIdentityExceptionsUnionMod {
  ...
  */
  ...
  object UnlinkIdentityExceptionsUnion {
    ...
    def ExternalServiceException(
      ...
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCognitoIdentityBrowser.typesExternalServiceExceptionMod.ExternalServiceException]
    }
