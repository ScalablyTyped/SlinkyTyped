package typingsSlinky.awsSdkClientCognitoIdentityBrowser.typesUnlinkDeveloperIdentityOutputMod
...
object UnlinkDeveloperIdentityOutput {
  ...
  @scala.inline
  implicit class UnlinkDeveloperIdentityOutputOps[Self <: UnlinkDeveloperIdentityOutput] (val x: Self) extends AnyVal {
    @scala.inline
