package typingsSlinky.awsSdkClientCognitoIdentityBrowser.typesDescribeIdentityPoolOutputMod
...
object DescribeIdentityPoolOutput {
  ...
  def apply(
    ...
    CognitoIdentityProviders: js.Array[UnmarshalledCognitoIdentityProvider] = null,
