...
object RulesConfigurationType {
  ...
  implicit class RulesConfigurationTypeOps[Self <: RulesConfigurationType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRulesIterable(value: js.Iterable[MappingRule]): Self = this.set("Rules", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRules(value: js.Array[MappingRule] | js.Iterable[MappingRule]): Self = this.set("Rules", value.asInstanceOf[js.Any])
  }
}
