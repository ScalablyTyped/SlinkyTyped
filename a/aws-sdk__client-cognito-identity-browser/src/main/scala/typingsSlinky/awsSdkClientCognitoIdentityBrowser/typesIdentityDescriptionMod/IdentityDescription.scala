...
object IdentityDescription {
  ...
  implicit class IdentityDescriptionOps[Self <: IdentityDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastModifiedDateDate(value: js.Date): Self = this.set("LastModifiedDate", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastModifiedDate(value: js.Date | String | Double): Self = this.set("LastModifiedDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastModifiedDate: Self = this.set("LastModifiedDate", js.undefined)
    @scala.inline
    def setLoginsVarargs(value: String*): Self = this.set("Logins", js.Array(value :_*))
    @scala.inline
    def setLoginsIterable(value: js.Iterable[String]): Self = this.set("Logins", value.asInstanceOf[js.Any])
    @scala.inline
    def setLogins(value: js.Array[String] | js.Iterable[String]): Self = this.set("Logins", value.asInstanceOf[js.Any])
    @scala.inline
