...
object typesUnlinkIdentityInputMod {
  ...
  object UnlinkIdentityInput {
    ...
    implicit class UnlinkIdentityInputMutableBuilder[Self <: UnlinkIdentityInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLoginsToRemove(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "LoginsToRemove", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLoginsToRemoveIterable(value: js.Iterable[String]): Self = StObject.set(x, "LoginsToRemove", value.asInstanceOf[js.Any])
