...
object typesDeleteIdentitiesInputMod {
  ...
  object DeleteIdentitiesInput {
    ...
    implicit class DeleteIdentitiesInputMutableBuilder[Self <: DeleteIdentitiesInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIdentityIdsToDelete(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "IdentityIdsToDelete", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIdentityIdsToDeleteIterable(value: js.Iterable[String]): Self = StObject.set(x, "IdentityIdsToDelete", value.asInstanceOf[js.Any])
