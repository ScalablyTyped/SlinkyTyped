...
package object aa {
  type IFieldGroupStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function1[/* element */ typingsSlinky.angular.mod.IAugmentedJQueryStatic, scala.Unit]
  ]
  ...
  type ILabelStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* element */ typingsSlinky.angular.mod.IAugmentedJQueryStatic, 
  ...
  type IOnNavigateAwayStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* rootFormScope */ typingsSlinky.angular.mod.IScope, 
      /* rootForm */ typingsSlinky.angular.mod.IAugmentedJQueryStatic, 
      /* $injector */ typingsSlinky.angular.mod.auto.IInjectorService, 
      scala.Unit
    ]
  ]
  ...
  type IValMsgPlacementStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* formFieldElement */ typingsSlinky.angular.mod.IAugmentedJQueryStatic, 
