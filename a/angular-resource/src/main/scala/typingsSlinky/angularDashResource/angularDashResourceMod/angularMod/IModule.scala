package typingsSlinky.angularDashResource.angularDashResourceMod.angularMod

import typingsSlinky.angularDashResource.angularDashResourceMod.angularMod.resource.IResourceServiceFactoryFunction
