...
object mod extends Shortcut {
  ...
  object global {
    ...
    trait Array[T] extends StObject {
      ...
      /** The promise of the original server interaction that created this collection. */
      @JSName("$promise")
      var $promise: IPromise[typingsSlinky.angularResource.mod.global.Array[T]] = js.native
    ...
    object Array {
      ...
      @scala.inline
      def apply[T]($promise: IPromise[typingsSlinky.angularResource.mod.global.Array[T]], $resolved: Boolean): typingsSlinky.angularResource.mod.global.Array[T] = {
        val __obj = js.Dynamic.literal($promise = $promise.asInstanceOf[js.Any], $resolved = $resolved.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.angularResource.mod.global.Array[T]]
      }
      
      @scala.inline
      implicit class ArrayMutableBuilder[Self <: typingsSlinky.angularResource.mod.global.Array[_], T] (val x: Self with typingsSlinky.angularResource.mod.global.Array[T]) extends AnyVal {
        
        @scala.inline
        def set$promise(value: IPromise[typingsSlinky.angularResource.mod.global.Array[T]]): Self = StObject.set(x, "$promise", value.asInstanceOf[js.Any])
