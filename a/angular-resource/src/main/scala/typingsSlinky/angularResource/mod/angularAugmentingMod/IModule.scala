package typingsSlinky.angularResource.mod.angularAugmentingMod

import typingsSlinky.angularResource.mod.angularAugmentingMod.resource.IResourceServiceFactoryFunction
