...
trait Options extends js.Object {
  ...
  var onComment: js.UndefOr[
    (js.Function6[
      ...
      /* start */ Double, 
      /* end */ Double, 
      /* startLoc */ js.UndefOr[typingsSlinky.estree.estreeMod.Position], 
      /* endLoc */ js.UndefOr[typingsSlinky.estree.estreeMod.Position], 
      Unit
    ]) | js.Array[Comment]
  ] = js.undefined
  var onInsertedSemicolon: js.UndefOr[
    js.Function2[
      /* lastTokEnd */ Double, 
      /* lastTokEndLoc */ js.UndefOr[typingsSlinky.estree.estreeMod.Position], 
      Unit
    ]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    onInsertedSemicolon: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsSlinky.estree.estreeMod.Position]) => Unit = null,
    onToken: (js.Function1[/* token */ Token, _]) | js.Array[Token] = null,
    onTrailingComma: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsSlinky.estree.estreeMod.Position]) => Unit = null,
