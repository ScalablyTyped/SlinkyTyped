...
object Options {
  ...
  def apply(
    ...
    onInsertedSemicolon: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsSlinky.estree.mod.Position]) => Unit = null,
    onToken: (js.Function1[/* token */ Token, _]) | js.Array[Token] = null,
    onTrailingComma: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsSlinky.estree.mod.Position]) => Unit = null,
