...
import typingsSlinky.allocTypes.allocTypesBooleans.`false`
import typingsSlinky.allocTypes.allocTypesStrings.prototype
...
object mod {
  ...
  type Exclusive[T] = Remap[
    typingsSlinky.allocTypes.allocTypesStrings.Exclusive with TopLevel[T] with TopLevel[js.Any]
  ]
  ...
  {[ P in keyof @alloc/types.@alloc/types.Intersect<T> ]: T extends infer U? P extends keyof any? any[P] : never : never}
    */ typingsSlinky.allocTypes.allocTypesStrings.ObjectFromUnion with TopLevel[js.Any]
  ]
  ...
  type Partial[T] = js.Object with typingsSlinky.allocTypes.allocTypesStrings.Partial with TopLevel[T]
  
  type Pick[T, K /* <: /* keyof T */ String */] = js.Object with typingsSlinky.allocTypes.allocTypesStrings.Pick with TopLevel[T]
  
  type Remap[T] = js.Object with typingsSlinky.allocTypes.allocTypesStrings.Remap with TopLevel[T]
