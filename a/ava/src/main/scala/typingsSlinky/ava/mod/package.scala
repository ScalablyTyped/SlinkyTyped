...
package object mod {
  ...
  type CbMacro[Args /* <: js.Array[_] */, Context] = (typingsSlinky.ava.mod.UntitledCbMacro[Args, Context]) with typingsSlinky.ava.AnonTitle[Args]
  ...
  type Macro[Args /* <: js.Array[_] */, Context] = (typingsSlinky.ava.mod.UntitledMacro[Args, Context]) with typingsSlinky.ava.AnonTitle[Args]
