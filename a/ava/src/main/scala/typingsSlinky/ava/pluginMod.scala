  ...
  object SharedWorker {
    ...
    object Experimental {
      ...
      trait Protocol[Data] extends StObject {
        ...
        def ready(): typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data] = js.native
      ...
      object Protocol {
        ...
        def apply[Data](
          ...
          ready: () => typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data],
          subscribe: () => AsyncIterableIterator[ReceivedMessage[Data]],
          testWorkers: () => AsyncIterableIterator[TestWorker[Data]]
        ): typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data] = {
          ...
          __obj.asInstanceOf[typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data]]
        }
        
        @scala.inline
        implicit class ProtocolMutableBuilder[Self <: typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[_], Data] (val x: Self with typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data]) extends AnyVal {
          ...
          @scala.inline
          def setReady(value: () => typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data]): Self = StObject.set(x, "ready", js.Any.fromFunction0(value))
    ...
    trait FactoryOptions extends StObject {
      ...
      def negotiateProtocol_experimental[Data](supported: js.Array[experimental]): typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[Data] = js.native
    }
    object FactoryOptions {
      
      @scala.inline
      def apply(
        negotiateProtocol: js.Array[experimental] => typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[js.Any]
      ): FactoryOptions = {
      ...
      implicit class FactoryOptionsMutableBuilder[Self <: FactoryOptions] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setNegotiateProtocol(
          value: js.Array[experimental] => typingsSlinky.ava.pluginMod.SharedWorker.Experimental.Protocol[js.Any]
        ): Self = StObject.set(x, "negotiateProtocol", js.Any.fromFunction1(value))
      }
    }
