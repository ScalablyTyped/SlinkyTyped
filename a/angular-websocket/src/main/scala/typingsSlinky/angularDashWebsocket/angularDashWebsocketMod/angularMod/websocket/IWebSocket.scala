...
trait IWebSocket extends js.Object {
  ...
  var onMessageCallbacks: js.Array[
    typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocketMessageHandler
  ] = js.native
  /**
  ...
  var sendQueue: js.Array[
    typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocketQueueItem
  ] = js.native
  /**
    * WebSocket instance.
    */
  ...
  /**
    ...
    */
  def close(): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  def close(force: Boolean): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  /**
    ...
    * @returns this instance, for method chaining
    */
  def onClose(callback: js.Function1[/* event */ CloseEvent, Unit]): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  /**
    * Adds a callback to be executed each time a socket connection is closed for
    * this instance.
    *
    ...
    * @returns this instance, for method chaining
    */
  def onError(callback: js.Function1[/* event */ Event, Unit]): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  /**
    ...
    * @returns this instance, for method chaining
    */
  def onMessage(callback: js.Function1[/* event */ MessageEvent, Unit]): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  def onMessage(
    callback: js.Function1[/* event */ MessageEvent, Unit],
    options: typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocketMessageOptions
  ): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  /**
    ...
    * @returns this instance, for method chaining
    */
  def onOpen(callback: js.Function1[/* event */ Event, Unit]): typingsSlinky.angularDashWebsocket.angularDashWebsocketMod.angularMod.websocket.IWebSocket = js.native
  /**
