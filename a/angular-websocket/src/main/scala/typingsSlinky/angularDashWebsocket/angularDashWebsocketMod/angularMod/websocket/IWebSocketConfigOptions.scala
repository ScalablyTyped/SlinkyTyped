...
import typingsSlinky.angularDashWebsocket.angularDashWebsocketStrings.arraybuffer
import typingsSlinky.angularDashWebsocket.angularDashWebsocketStrings.blob
