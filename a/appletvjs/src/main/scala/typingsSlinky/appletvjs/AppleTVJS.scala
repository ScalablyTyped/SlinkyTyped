...
object AppleTVJS {
  ...
  trait MenuBarDocument extends StObject {
    ...
    /**
      ...
      * */
    def getDocument(menuItem: org.scalajs.dom.raw.Element): Document = js.native
    
    /**
      * Associates a document with a menu item.
      * */
    def setDocument(document: Document, menuItem: org.scalajs.dom.raw.Element): Unit = js.native
    
    /**
      * Sets the focus in a menu bar to the specified menu item.
      * */
    def setSelectedItem(menuItem: org.scalajs.dom.raw.Element): Unit = js.native
  }
  object MenuBarDocument {
    
    @scala.inline
    def apply(
      getDocument: org.scalajs.dom.raw.Element => Document,
      setDocument: (Document, org.scalajs.dom.raw.Element) => Unit,
      setSelectedItem: org.scalajs.dom.raw.Element => Unit
    ): MenuBarDocument = {
    ...
    implicit class MenuBarDocumentMutableBuilder[Self <: MenuBarDocument] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetDocument(value: org.scalajs.dom.raw.Element => Document): Self = StObject.set(x, "getDocument", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSetDocument(value: (Document, org.scalajs.dom.raw.Element) => Unit): Self = StObject.set(x, "setDocument", js.Any.fromFunction2(value))
      
      @scala.inline
      def setSetSelectedItem(value: org.scalajs.dom.raw.Element => Unit): Self = StObject.set(x, "setSelectedItem", js.Any.fromFunction1(value))
    }
  }
