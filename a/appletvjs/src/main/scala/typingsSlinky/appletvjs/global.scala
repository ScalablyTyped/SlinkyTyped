...
object global extends js.Object {
  ...
  object AppleTVJS extends js.Object {
    ...
    class HighlightGroup ()
      ...
      /* CompleteClass */
      override var hightlights: js.Array[typingsSlinky.appletvjs.AppleTVJS.Highlight] = js.native
    ...
    class MediaItem protected ()
      ...
      /* CompleteClass */
      override var highlightGroups: js.Array[typingsSlinky.appletvjs.AppleTVJS.HighlightGroup] = js.native
      /** An array of interstitial objects. */
      /* CompleteClass */
      override var interstitials: js.Array[typingsSlinky.appletvjs.AppleTVJS.Interstitial] = js.native
      /**
    ...
    class Playlist ()
      ...
      /* CompleteClass */
      override def item(index: Double): typingsSlinky.appletvjs.AppleTVJS.MediaItem = js.native
      /** Removes a media item from the end of a playlist. */
      /* CompleteClass */
      override def pop(): typingsSlinky.appletvjs.AppleTVJS.MediaItem = js.native
      /** Adds a media item to the end of a playlist. */
      /* CompleteClass */
      override def push(`object`: typingsSlinky.appletvjs.AppleTVJS.MediaItem): Unit = js.native
      /** Deletes the indicated array elements and replaces them with the specified elements. */
      /* CompleteClass */
      override def splice(index: Double, howManu: Double, `object`: typingsSlinky.appletvjs.AppleTVJS.MediaItem): js.Array[typingsSlinky.appletvjs.AppleTVJS.MediaItem] = js.native
    }
