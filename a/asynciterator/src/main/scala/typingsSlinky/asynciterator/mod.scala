...
import typingsSlinky.asynciterator.anon.End
import typingsSlinky.asynciterator.anon.MaxBufferSize
import typingsSlinky.asynciterator.taskschedulerMod.Task
...
object mod {
  ...
  @JSImport("asynciterator", "empty")
  @js.native
  def empty[T](): EmptyIterator[T] = js.native
  
  @JSImport("asynciterator", "fromArray")
  @js.native
  def fromArray[T](items: js.Iterable[T]): ArrayIterator[T] = js.native
  
  @JSImport("asynciterator", "getTaskScheduler")
  @js.native
  def getTaskScheduler(): TaskScheduler = js.native
  
  @JSImport("asynciterator", "range")
  @js.native
  ...
  @JSImport("asynciterator", "scheduleTask")
  @js.native
  def scheduleTask(task: Task): Unit = js.native
  
  @JSImport("asynciterator", "setTaskScheduler")
  @js.native
  def setTaskScheduler(scheduler: TaskScheduler): Unit = js.native
  
  @JSImport("asynciterator", "single")
  @js.native
  def single[T](item: T): SingletonIterator[T] = js.native
  
  @JSImport("asynciterator", "union")
  @js.native
  def union[T](sources: AsyncIteratorOrArray[AsyncIterator[T]]): UnionIterator[T] = js.native
  
  @JSImport("asynciterator", "wrap")
  @js.native
  def wrap[T](source: js.Promise[EventEmitter]): TransformIterator[T, T] = js.native
  @JSImport("asynciterator", "wrap")
  @js.native
  def wrap[T](source: js.Promise[EventEmitter], options: TransformIteratorOptions[T]): TransformIterator[T, T] = js.native
  @JSImport("asynciterator", "wrap")
  @js.native
  def wrap[T](source: EventEmitter): TransformIterator[T, T] = js.native
  @JSImport("asynciterator", "wrap")
  @js.native
  def wrap[T](source: EventEmitter, options: TransformIteratorOptions[T]): TransformIterator[T, T] = js.native
  ...
  @js.native
  /** Creates a new `AsyncIterator`. */
  trait InternalSource[T] extends StObject {
  ...
  object MultiTransformOptions {
    ...
    @scala.inline
    implicit class MultiTransformOptionsMutableBuilder[Self <: MultiTransformOptions[_, _], S, D] (val x: Self with (MultiTransformOptions[S, D])) extends AnyVal {
  ...
  object TransformIteratorOptions {
    ...
    @scala.inline
    implicit class TransformIteratorOptionsMutableBuilder[Self <: TransformIteratorOptions[_], S] (val x: Self with TransformIteratorOptions[S]) extends AnyVal {
  ...
  object TransformOptions {
    ...
    @scala.inline
    implicit class TransformOptionsMutableBuilder[Self <: TransformOptions[_, _], S, D] (val x: Self with (TransformOptions[S, D])) extends AnyVal {
