...
import typingsSlinky.awsDashLambda.awsDashLambdaMod.Artifact
import typingsSlinky.awsDashLambda.awsDashLambdaMod.Credentials
import typingsSlinky.awsDashLambda.awsDashLambdaMod.EncryptionKey
