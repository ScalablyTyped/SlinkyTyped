...
import typingsSlinky.awsDashLambda.Anon_Bucket
import typingsSlinky.awsDashLambda.Anon_PrincipalId
import typingsSlinky.awsDashLambda.Anon_SourceIPAddress
import typingsSlinky.awsDashLambda.Anon_Xamzid2
