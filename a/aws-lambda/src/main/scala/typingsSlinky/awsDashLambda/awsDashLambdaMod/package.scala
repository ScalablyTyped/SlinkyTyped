...
package object awsDashLambdaMod {
  ...
  import typingsSlinky.awsDashLambda.Anon_KeyValue
  import typingsSlinky.awsDashLambda.Anon_NotPrincipal
  import typingsSlinky.awsDashLambda.Anon_NotResource
  import typingsSlinky.awsDashLambda.Anon_OriginalValue
  import typingsSlinky.awsDashLambda.Anon_Principal
  import typingsSlinky.awsDashLambda.Anon_Resource
