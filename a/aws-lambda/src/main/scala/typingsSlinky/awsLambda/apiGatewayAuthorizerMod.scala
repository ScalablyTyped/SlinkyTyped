...
import typingsSlinky.awsLambda.anon.NotPrincipal
import typingsSlinky.awsLambda.anon.NotResource
import typingsSlinky.awsLambda.anon.Principal
import typingsSlinky.awsLambda.anon.Resource
...
object apiGatewayAuthorizerMod {
  ...
  */
  ...
  object APIGatewayAuthorizerEvent {
    ...
    def APIGatewayRequestAuthorizerEvent(
      ...
      __obj.asInstanceOf[typingsSlinky.awsLambda.apiGatewayAuthorizerMod.APIGatewayRequestAuthorizerEvent]
    }
    
    @scala.inline
    def APIGatewayTokenAuthorizerEvent(authorizationToken: String, methodArn: String, `type`: TOKEN): typingsSlinky.awsLambda.apiGatewayAuthorizerMod.APIGatewayTokenAuthorizerEvent = {
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.apiGatewayAuthorizerMod.APIGatewayTokenAuthorizerEvent]
    }
  }
  ...
  */
  ...
  object StatementAction {
    ...
    @scala.inline
    def `0`(Action: String | js.Array[String]): typingsSlinky.awsLambda.anon.`0` = {
      val __obj = js.Dynamic.literal(Action = Action.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.anon.`0`]
    }
    
    @scala.inline
    def NotAction(NotAction: String | js.Array[String]): typingsSlinky.awsLambda.anon.NotAction = {
      val __obj = js.Dynamic.literal(NotAction = NotAction.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.anon.NotAction]
    }
  }
