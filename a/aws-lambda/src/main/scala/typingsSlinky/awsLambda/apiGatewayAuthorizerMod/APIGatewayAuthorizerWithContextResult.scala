...
object APIGatewayAuthorizerWithContextResult {
  @scala.inline
  def apply[/* <: typingsSlinky.awsLambda.apiGatewayMod.APIGatewayAuthorizerResultContext */ TAuthorizerContext](context: TAuthorizerContext, policyDocument: PolicyDocument, principalId: String): APIGatewayAuthorizerWithContextResult[TAuthorizerContext] = {
  ...
  @scala.inline
  implicit class APIGatewayAuthorizerWithContextResultOps[Self <: APIGatewayAuthorizerWithContextResult[_], /* <: typingsSlinky.awsLambda.apiGatewayMod.APIGatewayAuthorizerResultContext */ TAuthorizerContext] (val x: Self with APIGatewayAuthorizerWithContextResult[TAuthorizerContext]) extends AnyVal {
    @scala.inline
