...
object EventBridgeEvent {
  ...
  @scala.inline
  implicit class EventBridgeEventOps[Self <: EventBridgeEvent[_, _], TDetailType /* <: String */, TDetail] (val x: Self with (EventBridgeEvent[TDetailType, TDetail])) extends AnyVal {
