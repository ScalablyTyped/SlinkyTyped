package typingsSlinky.awsLambda.preTokenGenerationMod

import typingsSlinky.awsLambda.anon.AwsSdkVersion
import typingsSlinky.awsLambda.anon.ClaimsOverrideDetails
import typingsSlinky.awsLambda.anon.GroupConfiguration
