...
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildCacheType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildEnvironmentComputeType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildEnvironmentPullCredentialsType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildEnvironmentType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildEnvironmentVariableType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildPhaseStatusType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildPhaseType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildSourceLocationType
import typingsSlinky.awsLambda.codebuildCloudwatchStateMod.CodeBuildStateType
