...
import typingsSlinky.awsLambda.anon.OriginalValue
...
import typingsSlinky.awsLambda.awsLambdaStrings.Voice_
...
object lexMod {
  ...
  */
  ...
  object LexDialogAction {
    ...
    @scala.inline
    def LexDialogActionClose(fulfillmentState: Fulfilled | Failed_, `type`: Close): typingsSlinky.awsLambda.lexMod.LexDialogActionClose = {
      val __obj = js.Dynamic.literal(fulfillmentState = fulfillmentState.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.lexMod.LexDialogActionClose]
    }
    
    @scala.inline
    def LexDialogActionConfirmIntent(intentName: String, slots: StringDictionary[String | Null], `type`: ConfirmIntent): typingsSlinky.awsLambda.lexMod.LexDialogActionConfirmIntent = {
      val __obj = js.Dynamic.literal(intentName = intentName.asInstanceOf[js.Any], slots = slots.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.lexMod.LexDialogActionConfirmIntent]
    }
    
    @scala.inline
    def LexDialogActionDelegate(slots: StringDictionary[String | Null], `type`: Delegate): typingsSlinky.awsLambda.lexMod.LexDialogActionDelegate = {
      val __obj = js.Dynamic.literal(slots = slots.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.lexMod.LexDialogActionDelegate]
    }
    
    @scala.inline
    def LexDialogActionElicitIntent(`type`: ElicitIntent): typingsSlinky.awsLambda.lexMod.LexDialogActionElicitIntent = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.lexMod.LexDialogActionElicitIntent]
    }
    ...
    def LexDialogActionElicitSlot(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsLambda.lexMod.LexDialogActionElicitSlot]
    }
  }
  ...
  trait LexGenericAttachment extends StObject {
    ...
    var buttons: js.Array[typingsSlinky.awsLambda.anon.Text] = js.native
  ...
  object LexGenericAttachment {
    ...
    def apply(
      ...
      buttons: js.Array[typingsSlinky.awsLambda.anon.Text],
      imageUrl: String,
      subTitle: String,
      title: String
    ...
    implicit class LexGenericAttachmentMutableBuilder[Self <: LexGenericAttachment] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setButtons(value: js.Array[typingsSlinky.awsLambda.anon.Text]): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonsVarargs(value: typingsSlinky.awsLambda.anon.Text*): Self = StObject.set(x, "buttons", js.Array(value :_*))
