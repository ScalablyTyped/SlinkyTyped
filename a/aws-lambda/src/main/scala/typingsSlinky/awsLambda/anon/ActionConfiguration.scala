...
trait ActionConfiguration extends StObject {
  ...
  var inputArtifacts: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact] = js.native
  
  var outputArtifacts: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact] = js.native
}
object ActionConfiguration {
  ...
  def apply(
    ...
    inputArtifacts: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact],
    outputArtifacts: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact]
  ): ActionConfiguration = {
  ...
  implicit class ActionConfigurationMutableBuilder[Self <: ActionConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputArtifacts(value: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact]): Self = StObject.set(x, "inputArtifacts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInputArtifactsVarargs(value: typingsSlinky.awsLambda.codepipelineMod.Artifact*): Self = StObject.set(x, "inputArtifacts", js.Array(value :_*))
    
    @scala.inline
    def setOutputArtifacts(value: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact]): Self = StObject.set(x, "outputArtifacts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOutputArtifactsVarargs(value: typingsSlinky.awsLambda.codepipelineMod.Artifact*): Self = StObject.set(x, "outputArtifacts", js.Array(value :_*))
  }
}
