...
object ActionConfiguration {
  ...
  implicit class ActionConfigurationOps[Self <: ActionConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputArtifactsVarargs(value: typingsSlinky.awsLambda.codepipelineMod.Artifact*): Self = this.set("inputArtifacts", js.Array(value :_*))
    @scala.inline
    def setInputArtifacts(value: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact]): Self = this.set("inputArtifacts", value.asInstanceOf[js.Any])
    @scala.inline
    def setOutputArtifactsVarargs(value: typingsSlinky.awsLambda.codepipelineMod.Artifact*): Self = this.set("outputArtifacts", js.Array(value :_*))
    @scala.inline
    def setOutputArtifacts(value: js.Array[typingsSlinky.awsLambda.codepipelineMod.Artifact]): Self = this.set("outputArtifacts", value.asInstanceOf[js.Any])
    @scala.inline
