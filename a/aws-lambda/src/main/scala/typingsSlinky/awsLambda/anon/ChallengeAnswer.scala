...
trait ChallengeAnswer extends js.Object {
  ...
  var session: js.UndefOr[js.Array[ChallengeMetadata]] = js.undefined
...
object ChallengeAnswer {
  ...
  def apply(
    ...
    session: js.Array[ChallengeMetadata] = null,
    ...
    if (!js.isUndefined(newDeviceUsed)) __obj.updateDynamic("newDeviceUsed")(newDeviceUsed.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(userNotFound)) __obj.updateDynamic("userNotFound")(userNotFound.get.asInstanceOf[js.Any])
