...
trait AnonChallengeAnswer extends js.Object {
  ...
  var session: js.UndefOr[js.Array[AnonChallengeMetadata]] = js.native
...
object AnonChallengeAnswer {
  @scala.inline
  def apply(userAttributes: StringDictionary[String]): AnonChallengeAnswer = {
    val __obj = js.Dynamic.literal(userAttributes = userAttributes.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonChallengeAnswer]
  }
  @scala.inline
  implicit class AnonChallengeAnswerOps[Self <: AnonChallengeAnswer] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withSession(value: js.Array[AnonChallengeMetadata]): Self = {
        val ret = this.duplicate
