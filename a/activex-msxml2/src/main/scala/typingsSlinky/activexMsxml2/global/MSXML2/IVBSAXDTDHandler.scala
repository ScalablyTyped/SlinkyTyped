...
class IVBSAXDTDHandler protected ()
  extends typingsSlinky.activexMsxml2.MSXML2.IVBSAXDTDHandler {
  /* CompleteClass */
  @JSName("MSXML2.IVBSAXDTDHandler_typekey")
  override var MSXML2DotIVBSAXDTDHandler_typekey: typingsSlinky.activexMsxml2.MSXML2.IVBSAXDTDHandler = js.native
