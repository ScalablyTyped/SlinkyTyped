...
class ISequentialStream protected ()
  extends typingsSlinky.activexMsxml2.MSXML2.ISequentialStream {
  /* CompleteClass */
  @JSName("MSXML2.ISequentialStream_typekey")
  override var MSXML2DotISequentialStream_typekey: typingsSlinky.activexMsxml2.MSXML2.ISequentialStream = js.native
  /* CompleteClass */
