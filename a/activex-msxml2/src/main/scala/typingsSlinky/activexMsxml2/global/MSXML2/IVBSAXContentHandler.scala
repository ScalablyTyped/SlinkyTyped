...
class IVBSAXContentHandler protected ()
  ...
  override var MSXML2DotIVBSAXContentHandler_typekey: typingsSlinky.activexMsxml2.MSXML2.IVBSAXContentHandler = js.native
  /** Receive an object for locating the origin of SAX document events. */
  /* CompleteClass */
  override val documentLocator: typingsSlinky.activexMsxml2.MSXML2.IVBSAXLocator = js.native
  ...
  override def startElement(
    ...
    strLocalName: String,
    strQName: String,
    oAttributes: typingsSlinky.activexMsxml2.MSXML2.IVBSAXAttributes
  ): Unit = js.native
