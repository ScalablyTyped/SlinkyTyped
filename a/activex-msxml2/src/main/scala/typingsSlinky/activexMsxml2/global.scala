...
object global {
  ...
  object MSXML2 {
    ...
    class DOMDocument60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.DOMDocument60
    
    /** W3C-DOM XML Document 6.0 (Free threaded) */
    @JSGlobal("MSXML2.FreeThreadedDOMDocument60")
    @js.native
    class FreeThreadedDOMDocument60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.FreeThreadedDOMDocument60
    ...
    class ISchemaItem protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.ISchemaItem
    ...
    class IVBSAXAttributes protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IVBSAXAttributes
    ...
    class IVBSAXEntityResolver protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IVBSAXEntityResolver
    
    /** IVBSAXErrorHandler interface */
    @JSGlobal("MSXML2.IVBSAXErrorHandler")
    @js.native
    class IVBSAXErrorHandler protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IVBSAXErrorHandler
    ...
    class IXMLDOMComment protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMComment
    
    @JSGlobal("MSXML2.IXMLDOMDocument")
    @js.native
    class IXMLDOMDocument protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMDocument
    
    @JSGlobal("MSXML2.IXMLDOMDocumentFragment")
    @js.native
    class IXMLDOMDocumentFragment protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMDocumentFragment
    ...
    class IXMLDOMEntityReference protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMEntityReference
    
    @JSGlobal("MSXML2.IXMLDOMImplementation")
    @js.native
    class IXMLDOMImplementation protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMImplementation
    
    /** Core DOM node interface */
    @JSGlobal("MSXML2.IXMLDOMNode")
    @js.native
    class IXMLDOMNode protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMNode
    
    /** structure for reporting parser errors */
    @JSGlobal("MSXML2.IXMLDOMParseError")
    @js.native
    class IXMLDOMParseError protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMParseError
    
    @JSGlobal("MSXML2.IXMLDOMProcessingInstruction")
    @js.native
    class IXMLDOMProcessingInstruction protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLDOMProcessingInstruction
    ...
    class IXMLHTTPRequest2Callback protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXMLHTTPRequest2Callback
    
    /** IXSLProcessor Interface */
    @JSGlobal("MSXML2.IXSLProcessor")
    @js.native
    class IXSLProcessor protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.IXSLProcessor
    
    /** Microsoft HTML Writer 6.0 */
    @JSGlobal("MSXML2.MXHTMLWriter60")
    @js.native
    class MXHTMLWriter60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.MXHTMLWriter60
    
    /** MX Namespace Manager 6.0 */
    @JSGlobal("MSXML2.MXNamespaceManager60")
    @js.native
    class MXNamespaceManager60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.MXNamespaceManager60
    ...
    class SAXAttributes60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.SAXAttributes60
    ...
    class XMLHTTP60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.XMLHTTP60
    
    /** XSL Stylesheet Cache 6.0 */
    @JSGlobal("MSXML2.XSLTemplate60")
    @js.native
    class XSLTemplate60 protected ()
      extends typingsSlinky.activexMsxml2.MSXML2.XSLTemplate60
  }
}
