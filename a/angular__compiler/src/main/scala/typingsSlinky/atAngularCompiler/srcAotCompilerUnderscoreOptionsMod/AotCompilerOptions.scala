package typingsSlinky.atAngularCompiler.srcAotCompilerUnderscoreOptionsMod

import typingsSlinky.atAngularCompiler.atAngularCompilerStrings.ngtsc
import typingsSlinky.atAngularCompiler.atAngularCompilerStrings.tsc
