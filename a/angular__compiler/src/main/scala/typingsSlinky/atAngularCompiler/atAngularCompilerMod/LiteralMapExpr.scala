...
import typingsSlinky.atAngularCompiler.srcOutputOutputUnderscoreAstMod.LiteralMapEntry
...
class LiteralMapExpr protected ()
  extends typingsSlinky.atAngularCompiler.publicUnderscoreApiMod.LiteralMapExpr {
