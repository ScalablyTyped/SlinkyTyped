...
class EmitterVisitorContext protected ()
  extends typingsSlinky.atAngularCompiler.publicUnderscoreApiMod.EmitterVisitorContext {
...
object EmitterVisitorContext extends js.Object {
  def createRoot(): typingsSlinky.atAngularCompiler.srcOutputAbstractUnderscoreEmitterMod.EmitterVisitorContext = js.native
}
