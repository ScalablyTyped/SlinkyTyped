...
@JSImport("@angular/compiler", "ProviderAstType")
@js.native
object ProviderAstType extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typingsSlinky.atAngularCompiler.srcTemplateUnderscoreParserTemplateUnderscoreAstMod.ProviderAstType with Double
  ] = js.native
}
