package typingsSlinky.atAngularCompiler.atAngularCompilerMod.core

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@angular/compiler", "core.MissingTranslationStrategy")
@js.native
object MissingTranslationStrategy extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typingsSlinky.atAngularCompiler.srcCoreMod.MissingTranslationStrategy with Double
  ] = js.native
}
