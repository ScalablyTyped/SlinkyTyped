...
class AotCompiler protected ()
  extends typingsSlinky.atAngularCompiler.publicUnderscoreApiMod.AotCompiler {
  def this(
    _config: typingsSlinky.atAngularCompiler.srcConfigMod.CompilerConfig,
    _options: AotCompilerOptions,
    _host: AotCompilerHost,
    reflector: typingsSlinky.atAngularCompiler.srcAotStaticUnderscoreReflectorMod.StaticReflector,
    ...
    _summaryResolver: typingsSlinky.atAngularCompiler.srcSummaryUnderscoreResolverMod.SummaryResolver[typingsSlinky.atAngularCompiler.srcAotStaticUnderscoreSymbolMod.StaticSymbol],
    _symbolResolver: typingsSlinky.atAngularCompiler.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver
  ) = this()
}
