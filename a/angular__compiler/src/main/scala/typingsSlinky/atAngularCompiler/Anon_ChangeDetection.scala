...
import typingsSlinky.atAngularCompiler.srcCompileUnderscoreMetadataMod.CompileQueryMetadata
...
import typingsSlinky.atAngularCompiler.srcCoreMod.ChangeDetectionStrategy
