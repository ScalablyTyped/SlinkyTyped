...
class TmplAstBoundAttribute protected () extends BoundAttribute {
  ...
  def this(
    ...
    unit: String,
    sourceSpan: typingsSlinky.atAngularCompiler.srcParseUnderscoreUtilMod.ParseSourceSpan,
    valueSpan: typingsSlinky.atAngularCompiler.srcParseUnderscoreUtilMod.ParseSourceSpan
  ) = this()
  def this(
    name: String,
    `type`: BindingType,
...
object TmplAstBoundAttribute extends js.Object {
  def fromBoundElementProperty(prop: typingsSlinky.atAngularCompiler.srcExpressionUnderscoreParserAstMod.BoundElementProperty): BoundAttribute = js.native
  def fromBoundElementProperty(
    prop: typingsSlinky.atAngularCompiler.srcExpressionUnderscoreParserAstMod.BoundElementProperty,
    i18n: typingsSlinky.atAngularCompiler.srcI18nI18nUnderscoreAstMod.AST
