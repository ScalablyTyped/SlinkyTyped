package typingsSlinky.atAngularCompiler.srcCompilerMod.core
...
object ViewEncapsulation extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.atAngularCompiler.srcCoreMod.ViewEncapsulation with Double] = js.native
}
