...
object srcRender3ViewI18nContextMod extends js.Object {
  ...
  class I18nContext protected () extends js.Object {
    ...
    var bindings: Set[typingsSlinky.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST] = js.native
    ...
    def appendBinding(binding: typingsSlinky.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST): Unit = js.native
