...
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CompilerFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.ParseSourceSpan
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3BaseMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3ComponentMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3DirectiveMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3InjectableMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3InjectorMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3NgModuleMetadataFacade
import typingsSlinky.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3PipeMetadataFacade
import typingsSlinky.atAngularCompiler.srcOutputOutputUnderscoreJitMod.JitEvaluator
