...
import typingsSlinky.atAngularCompiler.srcRender3R3UnderscoreAstMod.Icu
...
import typingsSlinky.atAngularCompiler.srcRender3R3UnderscoreAstMod.Text
...
class TemplateDefinitionBuilder protected ()
  ...
  def i18nAppendBindings(expressions: js.Array[typingsSlinky.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST]): Unit = js.native
