...
import typingsSlinky.atAngularCompiler.srcRender3R3UnderscoreModuleUnderscoreCompilerMod.R3NgModuleDef
import typingsSlinky.atAngularCompiler.srcRender3R3UnderscoreModuleUnderscoreCompilerMod.R3NgModuleMetadata
