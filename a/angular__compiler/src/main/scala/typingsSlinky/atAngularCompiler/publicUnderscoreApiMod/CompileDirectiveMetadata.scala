...
import typingsSlinky.atAngularCompiler.Anon_ChangeDetection
import typingsSlinky.atAngularCompiler.Anon_ChangeDetectionComponentFactory
...
class CompileDirectiveMetadata protected ()
  extends typingsSlinky.atAngularCompiler.srcCompilerMod.CompileDirectiveMetadata {
...
object CompileDirectiveMetadata extends js.Object {
  ...
  ): typingsSlinky.atAngularCompiler.srcCompileUnderscoreMetadataMod.CompileDirectiveMetadata = js.native
}
