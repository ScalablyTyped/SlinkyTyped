...
object Directive {
  @scala.inline
  def apply[/* <: typingsSlinky.angularCompiler.t2ApiMod.DirectiveMeta */ DirectiveT](directive: DirectiveT, node: Element | Template): Directive[DirectiveT] = {
  ...
  @scala.inline
  implicit class DirectiveOps[Self <: Directive[_], /* <: typingsSlinky.angularCompiler.t2ApiMod.DirectiveMeta */ DirectiveT] (val x: Self with Directive[DirectiveT]) extends AnyVal {
    @scala.inline
