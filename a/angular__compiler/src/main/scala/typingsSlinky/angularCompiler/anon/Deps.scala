...
trait Deps extends js.Object {
  ...
  var useClass: js.UndefOr[typingsSlinky.angularCompiler.coreMod.Type] = js.undefined
...
object Deps {
  ...
  implicit class DepsOps[Self <: Deps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUseClass(value: typingsSlinky.angularCompiler.coreMod.Type): Self = this.set("useClass", value.asInstanceOf[js.Any])
    @scala.inline
