...
object Args {
  ...
  implicit class ArgsMutableBuilder[Self <: Args] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgs(value: js.Array[typingsSlinky.angularCompiler.outputAstMod.Expression]): Self = StObject.set(x, "args", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setArgsVarargs(value: typingsSlinky.angularCompiler.outputAstMod.Expression*): Self = StObject.set(x, "args", js.Array(value :_*))
