...
trait Extractor extends StObject {
  ...
  var extractor: typingsSlinky.angularCompiler.extractorMod.Extractor = js.native
...
object Extractor {
  ...
  implicit class ExtractorMutableBuilder[Self <: Extractor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtractor(value: typingsSlinky.angularCompiler.extractorMod.Extractor): Self = StObject.set(x, "extractor", value.asInstanceOf[js.Any])
