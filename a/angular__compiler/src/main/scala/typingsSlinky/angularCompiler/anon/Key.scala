...
trait Key extends js.Object {
  var key: String
  var quoted: Boolean
  var value: typingsSlinky.angularCompiler.outputAstMod.Expression
}
...
object Key {
  ...
  implicit class KeyOps[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: typingsSlinky.angularCompiler.outputAstMod.Expression): Self = this.set("value", value.asInstanceOf[js.Any])
  }
