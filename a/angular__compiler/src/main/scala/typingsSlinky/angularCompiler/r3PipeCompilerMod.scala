...
import typingsSlinky.angularCompiler.anon.Expression
...
object r3PipeCompilerMod {
  ...
  trait R3PipeMetadata extends StObject {
    ...
    /**
      ...
      */
    var internalType: typingsSlinky.angularCompiler.outputAstMod.Expression = js.native
  ...
  object R3PipeMetadata {
    ...
    @scala.inline
    def apply(
      internalType: typingsSlinky.angularCompiler.outputAstMod.Expression,
      name: String,
      pipeName: String,
      pure: Boolean,
      `type`: R3Reference,
    ...
    implicit class R3PipeMetadataMutableBuilder[Self <: R3PipeMetadata] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInternalType(value: typingsSlinky.angularCompiler.outputAstMod.Expression): Self = StObject.set(x, "internalType", value.asInstanceOf[js.Any])
