...
object templatePreparserMod {
  ...
  object PreparsedElementType extends StObject {
    ...
    /* 0 */ val NG_CONTENT: typingsSlinky.angularCompiler.templatePreparserMod.PreparsedElementType.NG_CONTENT with Double = js.native
    
    @js.native
    sealed trait OTHER extends PreparsedElementType
    /* 4 */ val OTHER: typingsSlinky.angularCompiler.templatePreparserMod.PreparsedElementType.OTHER with Double = js.native
    
    @js.native
    sealed trait SCRIPT extends PreparsedElementType
    /* 3 */ val SCRIPT: typingsSlinky.angularCompiler.templatePreparserMod.PreparsedElementType.SCRIPT with Double = js.native
    
    @js.native
    sealed trait STYLE extends PreparsedElementType
    /* 1 */ val STYLE: typingsSlinky.angularCompiler.templatePreparserMod.PreparsedElementType.STYLE with Double = js.native
    
    @js.native
    sealed trait STYLESHEET extends PreparsedElementType
    /* 2 */ val STYLESHEET: typingsSlinky.angularCompiler.templatePreparserMod.PreparsedElementType.STYLESHEET with Double = js.native
  }
