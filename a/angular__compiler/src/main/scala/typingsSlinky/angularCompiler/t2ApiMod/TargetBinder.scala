...
object TargetBinder {
  @scala.inline
  def apply[/* <: typingsSlinky.angularCompiler.t2ApiMod.DirectiveMeta */ D](bind: Target => BoundTarget[D]): TargetBinder[D] = {
    val __obj = js.Dynamic.literal(bind = js.Any.fromFunction1(bind))
    __obj.asInstanceOf[TargetBinder[D]]
  }
  @scala.inline
  implicit class TargetBinderOps[Self <: TargetBinder[_], /* <: typingsSlinky.angularCompiler.t2ApiMod.DirectiveMeta */ D] (val x: Self with TargetBinder[D]) extends AnyVal {
    @scala.inline
