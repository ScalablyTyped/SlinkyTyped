...
object r3TemplateTransformMod {
  ...
  trait Render3ParseResult extends StObject {
    ...
    var nodes: js.Array[typingsSlinky.angularCompiler.r3AstMod.Node] = js.native
  ...
  object Render3ParseResult {
    ...
    def apply(
      ...
      nodes: js.Array[typingsSlinky.angularCompiler.r3AstMod.Node],
    ...
    implicit class Render3ParseResultMutableBuilder[Self <: Render3ParseResult] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNodes(value: js.Array[typingsSlinky.angularCompiler.r3AstMod.Node]): Self = StObject.set(x, "nodes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNodesVarargs(value: typingsSlinky.angularCompiler.r3AstMod.Node*): Self = StObject.set(x, "nodes", js.Array(value :_*))
