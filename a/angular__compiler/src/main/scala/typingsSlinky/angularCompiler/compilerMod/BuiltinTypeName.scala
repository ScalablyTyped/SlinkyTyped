...
@JSImport("@angular/compiler/compiler", "BuiltinTypeName")
@js.native
object BuiltinTypeName extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.angularCompiler.outputAstMod.BuiltinTypeName with Double] = js.native
}
