...
object core {
  ...
  @JSImport("@angular/compiler/compiler", "core.ChangeDetectionStrategy")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.NO_ERRORS_SCHEMA")
  @js.native
  val NO_ERRORS_SCHEMA: SchemaMetadata = js.native
  
  @JSImport("@angular/compiler/compiler", "core.SecurityContext")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.ViewEncapsulation")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.createComponent")
  @js.native
  val createComponent: MetadataFactory[Component] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createContentChild")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.createDirective")
  @js.native
  val createDirective: MetadataFactory[Directive] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createHost")
  @js.native
  val createHost: MetadataFactory[js.Any] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createHostBinding")
  @js.native
  val createHostBinding: MetadataFactory[HostBinding] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createHostListener")
  @js.native
  val createHostListener: MetadataFactory[HostListener] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createInject")
  @js.native
  val createInject: MetadataFactory[Inject] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createInjectable")
  @js.native
  val createInjectable: MetadataFactory[Injectable] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createInjectionToken")
  @js.native
  val createInjectionToken: MetadataFactory[js.Object] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createInput")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.createOutput")
  @js.native
  ...
  @JSImport("@angular/compiler/compiler", "core.createSelf")
  @js.native
  val createSelf: MetadataFactory[js.Any] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createSkipSelf")
  @js.native
  val createSkipSelf: MetadataFactory[js.Any] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createViewChild")
  @js.native
  val createViewChild: MetadataFactory[Query] = js.native
  
  @JSImport("@angular/compiler/compiler", "core.createViewChildren")
  @js.native
