...
@JSImport("@angular/compiler/public_api", "UnaryOperator")
@js.native
object UnaryOperator extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.angularCompiler.outputAstMod.UnaryOperator with Double] = js.native
