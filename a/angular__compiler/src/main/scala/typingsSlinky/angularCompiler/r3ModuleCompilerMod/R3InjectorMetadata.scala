...
object R3InjectorMetadata {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(imports = imports.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], deps = deps.asInstanceOf[js.Any], providers = providers.asInstanceOf[js.Any])
