...
import typingsSlinky.angularCompiler.astMod.ThisReceiver
import typingsSlinky.angularCompiler.astMod.Unary
...
object SimpleExpressionChecker {
  ...
  implicit class SimpleExpressionCheckerOps[Self <: SimpleExpressionChecker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVisitThisReceiver(value: (ThisReceiver, js.Any) => Unit): Self = this.set("visitThisReceiver", js.Any.fromFunction2(value))
    
    @scala.inline
    def setVisitUnary(value: (Unary, js.Any) => Unit): Self = this.set("visitUnary", js.Any.fromFunction2(value))
  }
}
