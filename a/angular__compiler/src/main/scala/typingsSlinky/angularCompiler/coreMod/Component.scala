...
trait Component extends Directive {
  ...
  var entryComponents: js.UndefOr[js.Array[typingsSlinky.angularCompiler.coreMod.Type | js.Array[_]]] = js.native
...
object Component {
  ...
  implicit class ComponentMutableBuilder[Self <: Component] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntryComponents(value: js.Array[typingsSlinky.angularCompiler.coreMod.Type | js.Array[_]]): Self = StObject.set(x, "entryComponents", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEntryComponentsUndefined: Self = StObject.set(x, "entryComponents", js.undefined)
    
    @scala.inline
    def setEntryComponentsVarargs(value: (typingsSlinky.angularCompiler.coreMod.Type | js.Array[js.Any])*): Self = StObject.set(x, "entryComponents", js.Array(value :_*))
