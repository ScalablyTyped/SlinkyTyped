...
trait ModuleWithProviders extends StObject {
  ...
  var ngModule: typingsSlinky.angularCompiler.coreMod.Type = js.native
...
object ModuleWithProviders {
  ...
  @scala.inline
  def apply(ngModule: typingsSlinky.angularCompiler.coreMod.Type): ModuleWithProviders = {
  ...
  implicit class ModuleWithProvidersMutableBuilder[Self <: ModuleWithProviders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNgModule(value: typingsSlinky.angularCompiler.coreMod.Type): Self = StObject.set(x, "ngModule", value.asInstanceOf[js.Any])
