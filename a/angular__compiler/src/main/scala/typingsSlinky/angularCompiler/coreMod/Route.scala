...
trait Route extends StObject {
  ...
  var loadChildren: js.UndefOr[String | typingsSlinky.angularCompiler.coreMod.Type | js.Any] = js.native
}
object Route {
  ...
  implicit class RouteMutableBuilder[Self <: Route] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLoadChildren(value: String | typingsSlinky.angularCompiler.coreMod.Type | js.Any): Self = StObject.set(x, "loadChildren", value.asInstanceOf[js.Any])
