...
object cssLexerMod {
  ...
  object CssLexerMode extends StObject {
    ...
    /* 0 */ val ALL: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.ALL with Double = js.native
    
    @js.native
    sealed trait ALL_TRACK_WS extends CssLexerMode
    /* 1 */ val ALL_TRACK_WS: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.ALL_TRACK_WS with Double = js.native
    
    @js.native
    sealed trait ATTRIBUTE_SELECTOR extends CssLexerMode
    /* 5 */ val ATTRIBUTE_SELECTOR: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.ATTRIBUTE_SELECTOR with Double = js.native
    
    @js.native
    sealed trait AT_RULE_QUERY extends CssLexerMode
    /* 6 */ val AT_RULE_QUERY: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.AT_RULE_QUERY with Double = js.native
    
    @js.native
    sealed trait BLOCK extends CssLexerMode
    /* 8 */ val BLOCK: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.BLOCK with Double = js.native
    
    @js.native
    sealed trait KEYFRAME_BLOCK extends CssLexerMode
    /* 9 */ val KEYFRAME_BLOCK: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.KEYFRAME_BLOCK with Double = js.native
    
    @js.native
    sealed trait MEDIA_QUERY extends CssLexerMode
    /* 7 */ val MEDIA_QUERY: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.MEDIA_QUERY with Double = js.native
    
    @js.native
    sealed trait PSEUDO_SELECTOR extends CssLexerMode
    /* 3 */ val PSEUDO_SELECTOR: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.PSEUDO_SELECTOR with Double = js.native
    
    @js.native
    sealed trait PSEUDO_SELECTOR_WITH_ARGUMENTS extends CssLexerMode
    /* 4 */ val PSEUDO_SELECTOR_WITH_ARGUMENTS: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.PSEUDO_SELECTOR_WITH_ARGUMENTS with Double = js.native
    
    @js.native
    sealed trait SELECTOR extends CssLexerMode
    /* 2 */ val SELECTOR: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.SELECTOR with Double = js.native
    
    @js.native
    sealed trait STYLE_BLOCK extends CssLexerMode
    /* 10 */ val STYLE_BLOCK: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.STYLE_BLOCK with Double = js.native
    
    @js.native
    sealed trait STYLE_CALC_FUNCTION extends CssLexerMode
    /* 13 */ val STYLE_CALC_FUNCTION: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.STYLE_CALC_FUNCTION with Double = js.native
    
    @js.native
    sealed trait STYLE_VALUE extends CssLexerMode
    /* 11 */ val STYLE_VALUE: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.STYLE_VALUE with Double = js.native
    
    @js.native
    sealed trait STYLE_VALUE_FUNCTION extends CssLexerMode
    /* 12 */ val STYLE_VALUE_FUNCTION: typingsSlinky.angularCompiler.cssLexerMod.CssLexerMode.STYLE_VALUE_FUNCTION with Double = js.native
  }
  ...
  object CssTokenType extends StObject {
    ...
    /* 6 */ val AtKeyword: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.AtKeyword with Double = js.native
    
    @js.native
    sealed trait Character extends CssTokenType
    /* 7 */ val Character: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Character with Double = js.native
    
    @js.native
    sealed trait Comment extends CssTokenType
    /* 2 */ val Comment: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Comment with Double = js.native
    
    @js.native
    sealed trait EOF extends CssTokenType
    /* 0 */ val EOF: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.EOF with Double = js.native
    
    @js.native
    sealed trait Identifier extends CssTokenType
    /* 3 */ val Identifier: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Identifier with Double = js.native
    
    @js.native
    sealed trait IdentifierOrNumber extends CssTokenType
    /* 5 */ val IdentifierOrNumber: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.IdentifierOrNumber with Double = js.native
    
    @js.native
    sealed trait Invalid extends CssTokenType
    /* 9 */ val Invalid: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Invalid with Double = js.native
    
    @js.native
    sealed trait Number extends CssTokenType
    /* 4 */ val Number: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Number with Double = js.native
    
    @js.native
    sealed trait String extends CssTokenType
    /* 1 */ val String: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.String with Double = js.native
    
    @js.native
    sealed trait Whitespace extends CssTokenType
    /* 8 */ val Whitespace: typingsSlinky.angularCompiler.cssLexerMod.CssTokenType.Whitespace with Double = js.native
  }
  ...
  @js.native
  def cssScannerError(token: CssToken, message: String): js.Error = js.native
  ...
  @js.native
  def getRawMessage(error: js.Error): String = js.native
  
  @JSImport("@angular/compiler/src/css_parser/css_lexer", "getToken")
  @js.native
  def getToken(error: js.Error): CssToken = js.native
