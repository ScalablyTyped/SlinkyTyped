...
object BoundStylingEntry {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(hasOverrideFlag = hasOverrideFlag.asInstanceOf[js.Any], sourceSpan = sourceSpan.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], unit = unit.asInstanceOf[js.Any])
