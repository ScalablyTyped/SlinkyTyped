...
object srcUtilMod {
  ...
  @js.native
  def getParseErrors(error: js.Error): js.Array[ParseError] = js.native
  ...
  @js.native
  def isSyntaxError(error: js.Error): Boolean = js.native
  ...
  @js.native
  def syntaxError(msg: String): js.Error = js.native
  @JSImport("@angular/compiler/src/util", "syntaxError")
  @js.native
  def syntaxError(msg: String, parseErrors: js.Array[ParseError]): js.Error = js.native
