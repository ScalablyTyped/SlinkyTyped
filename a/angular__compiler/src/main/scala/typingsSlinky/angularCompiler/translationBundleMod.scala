...
import typingsSlinky.angularCompiler.serializerMod.PlaceholderMapper
...
object translationBundleMod extends js.Object {
  ...
  class TranslationBundle protected () extends js.Object {
    ...
    def get(srcMsg: Message): js.Array[typingsSlinky.angularCompiler.mlParserAstMod.Node] = js.native
