...
@JSImport("@angular/compiler/src/compiler", "StmtModifier")
@js.native
object StmtModifier extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsSlinky.angularCompiler.outputAstMod.StmtModifier with Double] = js.native
}
