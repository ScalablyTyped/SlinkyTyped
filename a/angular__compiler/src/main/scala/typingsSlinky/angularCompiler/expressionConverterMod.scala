...
object expressionConverterMod {
  ...
  object BindingForm extends StObject {
    ...
    /* 2 */ val Expression: typingsSlinky.angularCompiler.expressionConverterMod.BindingForm.Expression with Double = js.native
    
    @js.native
    sealed trait General extends BindingForm
    /* 0 */ val General: typingsSlinky.angularCompiler.expressionConverterMod.BindingForm.General with Double = js.native
    
    @js.native
    sealed trait TrySimple extends BindingForm
    /* 1 */ val TrySimple: typingsSlinky.angularCompiler.expressionConverterMod.BindingForm.TrySimple with Double = js.native
  }
