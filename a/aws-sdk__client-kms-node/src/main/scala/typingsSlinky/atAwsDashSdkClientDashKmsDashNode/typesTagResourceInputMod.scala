...
import typingsSlinky.atAwsDashSdkClientDashKmsDashNode.typesUnderscoreTagMod._Tag
...
@JSImport("@aws-sdk/client-kms-node/types/TagResourceInput", JSImport.Namespace)
@js.native
object typesTagResourceInputMod extends js.Object {
  ...
  trait TagResourceInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Tags: js.Array[_Tag] | js.Iterable[_Tag] = js.native
  }
