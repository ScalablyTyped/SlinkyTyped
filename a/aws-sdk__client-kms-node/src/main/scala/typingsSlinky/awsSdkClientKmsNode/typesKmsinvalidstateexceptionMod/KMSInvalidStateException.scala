package typingsSlinky.awsSdkClientKmsNode.typesKmsinvalidstateexceptionMod
...
trait KMSInvalidStateException
  ...
  @JSName("name")
  var name_KMSInvalidStateException: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInvalidStateException = js.native
}
object KMSInvalidStateException {
  ...
  def apply(
    ...
    message: String,
    name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInvalidStateException
  ...
  implicit class KMSInvalidStateExceptionOps[Self <: KMSInvalidStateException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInvalidStateException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
