package typingsSlinky.awsSdkClientKmsNode.typesRetireGrantOutputMod
...
object RetireGrantOutput {
  ...
  @scala.inline
  implicit class RetireGrantOutputOps[Self <: RetireGrantOutput] (val x: Self) extends AnyVal {
