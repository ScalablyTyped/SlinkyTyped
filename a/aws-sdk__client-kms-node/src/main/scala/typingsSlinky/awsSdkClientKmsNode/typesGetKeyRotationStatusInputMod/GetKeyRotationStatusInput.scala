package typingsSlinky.awsSdkClientKmsNode.typesGetKeyRotationStatusInputMod
...
object GetKeyRotationStatusInput {
  ...
  @scala.inline
  implicit class GetKeyRotationStatusInputOps[Self <: GetKeyRotationStatusInput] (val x: Self) extends AnyVal {
    @scala.inline
