package typingsSlinky.awsSdkClientKmsNode.typesListResourceTagsInputMod
...
object ListResourceTagsInput {
  ...
  @scala.inline
  implicit class ListResourceTagsInputOps[Self <: ListResourceTagsInput] (val x: Self) extends AnyVal {
