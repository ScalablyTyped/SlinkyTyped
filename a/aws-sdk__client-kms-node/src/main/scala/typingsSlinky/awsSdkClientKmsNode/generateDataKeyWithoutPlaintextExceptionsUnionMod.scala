...
object generateDataKeyWithoutPlaintextExceptionsUnionMod {
  ...
  */
  trait GenerateDataKeyWithoutPlaintextExceptionsUnion extends StObject
  object GenerateDataKeyWithoutPlaintextExceptionsUnion {
    ...
    @scala.inline
    def DisabledException(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.DisabledException): typingsSlinky.awsSdkClientKmsNode.typesDisabledExceptionMod.DisabledException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientKmsNode.typesDisabledExceptionMod.DisabledException]
    }
    
    @scala.inline
    def InvalidGrantTokenException(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidGrantTokenException): typingsSlinky.awsSdkClientKmsNode.typesInvalidGrantTokenExceptionMod.InvalidGrantTokenException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientKmsNode.typesInvalidGrantTokenExceptionMod.InvalidGrantTokenException]
    }
    
    @scala.inline
    def InvalidKeyUsageException(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidKeyUsageException): typingsSlinky.awsSdkClientKmsNode.typesInvalidKeyUsageExceptionMod.InvalidKeyUsageException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientKmsNode.typesInvalidKeyUsageExceptionMod.InvalidKeyUsageException]
    }
    ...
    @scala.inline
    def KeyUnavailableException(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KeyUnavailableException): typingsSlinky.awsSdkClientKmsNode.typesKeyUnavailableExceptionMod.KeyUnavailableException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientKmsNode.typesKeyUnavailableExceptionMod.KeyUnavailableException]
    }
