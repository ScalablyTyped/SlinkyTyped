...
trait InvalidAliasNameException extends CreateAliasExceptionsUnion {
  ...
  var name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidAliasNameException = js.native
}
object InvalidAliasNameException {
  
  @scala.inline
  def apply(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidAliasNameException): InvalidAliasNameException = {
