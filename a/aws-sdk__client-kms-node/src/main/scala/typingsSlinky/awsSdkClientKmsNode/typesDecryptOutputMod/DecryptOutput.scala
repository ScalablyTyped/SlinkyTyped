package typingsSlinky.awsSdkClientKmsNode.typesDecryptOutputMod
...
object DecryptOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, KeyId: String = null, Plaintext: js.typedarray.Uint8Array = null): DecryptOutput = {
