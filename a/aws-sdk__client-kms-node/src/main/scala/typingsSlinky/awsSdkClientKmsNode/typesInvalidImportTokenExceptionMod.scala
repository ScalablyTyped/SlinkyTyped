...
object typesInvalidImportTokenExceptionMod {
  ...
  trait InvalidImportTokenException extends ImportKeyMaterialExceptionsUnion {
    ...
    var name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidImportTokenException = js.native
  }
  object InvalidImportTokenException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidImportTokenException): InvalidImportTokenException = {
    ...
    implicit class InvalidImportTokenExceptionMutableBuilder[Self <: InvalidImportTokenException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidImportTokenException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
