package typingsSlinky.awsSdkClientKmsNode.typesListRetirableGrantsInputMod
...
object ListRetirableGrantsInput {
  ...
  @scala.inline
  implicit class ListRetirableGrantsInputOps[Self <: ListRetirableGrantsInput] (val x: Self) extends AnyVal {
