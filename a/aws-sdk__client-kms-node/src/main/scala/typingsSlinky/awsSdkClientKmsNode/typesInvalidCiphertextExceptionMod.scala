...
object typesInvalidCiphertextExceptionMod {
  ...
  trait InvalidCiphertextException
    ...
    var name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidCiphertextException = js.native
  }
  object InvalidCiphertextException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidCiphertextException): InvalidCiphertextException = {
    ...
    implicit class InvalidCiphertextExceptionMutableBuilder[Self <: InvalidCiphertextException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.InvalidCiphertextException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
