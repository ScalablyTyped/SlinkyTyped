package typingsSlinky.awsSdkClientKmsNode.typesRevokeGrantOutputMod
...
object RevokeGrantOutput {
  ...
  @scala.inline
  implicit class RevokeGrantOutputOps[Self <: RevokeGrantOutput] (val x: Self) extends AnyVal {
    @scala.inline
