...
object KeyMetadata {
  ...
  implicit class KeyMetadataOps[Self <: KeyMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreationDateDate(value: js.Date): Self = this.set("CreationDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreationDate(value: js.Date | String | Double): Self = this.set("CreationDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCreationDate: Self = this.set("CreationDate", js.undefined)
    
    @scala.inline
    def setDeletionDateDate(value: js.Date): Self = this.set("DeletionDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDeletionDate(value: js.Date | String | Double): Self = this.set("DeletionDate", value.asInstanceOf[js.Any])
