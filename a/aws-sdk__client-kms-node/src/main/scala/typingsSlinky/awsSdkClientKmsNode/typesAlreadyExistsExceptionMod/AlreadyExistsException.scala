...
trait AlreadyExistsException extends CreateAliasExceptionsUnion {
  ...
  var name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.AlreadyExistsException = js.native
}
object AlreadyExistsException {
  
  @scala.inline
  def apply(name: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.AlreadyExistsException): AlreadyExistsException = {
  ...
  implicit class AlreadyExistsExceptionOps[Self <: AlreadyExistsException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.AlreadyExistsException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
