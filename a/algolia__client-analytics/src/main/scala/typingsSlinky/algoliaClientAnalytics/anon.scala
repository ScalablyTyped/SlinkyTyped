package typingsSlinky.algoliaClientAnalytics

import typingsSlinky.algoliaClientAnalytics.mod.AddABTestResponse
import typingsSlinky.algoliaClientAnalytics.mod.DeleteABTestResponse
import typingsSlinky.algoliaClientAnalytics.mod.GetABTestResponse
import typingsSlinky.algoliaClientAnalytics.mod.GetABTestsResponse
