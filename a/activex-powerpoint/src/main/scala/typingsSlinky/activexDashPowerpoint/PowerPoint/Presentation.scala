...
import typingsSlinky.activexDashOffice.Office.DocumentInspector
import typingsSlinky.activexDashOffice.Office.DocumentInspectors
import typingsSlinky.activexDashOffice.Office.DocumentLibraryVersion
import typingsSlinky.activexDashOffice.Office.DocumentLibraryVersions
import typingsSlinky.activexDashOffice.Office.MetaProperties
import typingsSlinky.activexDashOffice.Office.MetaProperty
import typingsSlinky.activexDashOffice.Office.MsoEncoding
import typingsSlinky.activexDashOffice.Office.MsoExtraInfoMethod
import typingsSlinky.activexDashOffice.Office.MsoFarEastLineBreakLanguageID
import typingsSlinky.activexDashOffice.Office.MsoLanguageID
import typingsSlinky.activexDashOffice.Office.MsoTriState
import typingsSlinky.activexDashOffice.Office.Permission
import typingsSlinky.activexDashOffice.Office.PolicyItem
import typingsSlinky.activexDashOffice.Office.ServerPolicy
import typingsSlinky.activexDashOffice.Office.Signature
import typingsSlinky.activexDashOffice.Office.SignatureSet
import typingsSlinky.activexDashOffice.Office.UserPermission
import typingsSlinky.activexDashOffice.Office.WorkflowTasks
import typingsSlinky.activexDashOffice.Office.WorkflowTemplates
...
class Presentation protected () extends js.Object {
  ...
  val Broadcast: typingsSlinky.activexDashPowerpoint.PowerPoint.Broadcast = js.native
  val BuiltInDocumentProperties: js.Any = js.native
  val Coauthoring: typingsSlinky.activexDashPowerpoint.PowerPoint.Coauthoring = js.native
  val ColorSchemes: typingsSlinky.activexDashPowerpoint.PowerPoint.ColorSchemes = js.native
  @JSName("CommandBars")
  ...
  val Designs: typingsSlinky.activexDashPowerpoint.PowerPoint.Designs = js.native
  ...
  val ExtraColors: typingsSlinky.activexDashPowerpoint.PowerPoint.ExtraColors = js.native
  ...
  val Fonts: typingsSlinky.activexDashPowerpoint.PowerPoint.Fonts = js.native
  val FullName: String = js.native
  var GridDistance: Double = js.native
  val HTMLProject: typingsSlinky.activexDashOffice.Office.HTMLProject = js.native
  ...
  val PageSetup: typingsSlinky.activexDashPowerpoint.PowerPoint.PageSetup = js.native
  ...
  val PrintOptions: typingsSlinky.activexDashPowerpoint.PowerPoint.PrintOptions = js.native
  val PublishObjects: typingsSlinky.activexDashPowerpoint.PowerPoint.PublishObjects = js.native
  val ReadOnly: MsoTriState = js.native
  var RemovePersonalInformation: MsoTriState = js.native
  val Research: typingsSlinky.activexDashPowerpoint.PowerPoint.Research = js.native
  var Saved: MsoTriState = js.native
  val SectionCount: Double = js.native
  val SectionProperties: typingsSlinky.activexDashPowerpoint.PowerPoint.SectionProperties = js.native
  @JSName("ServerPolicy")
  val ServerPolicy_Original: ServerPolicy = js.native
  val SharedWorkspace: typingsSlinky.activexDashOffice.Office.SharedWorkspace = js.native
  @JSName("Signatures")
  val Signatures_Original: SignatureSet = js.native
  val SlideMaster: Master = js.native
  val SlideShowSettings: typingsSlinky.activexDashPowerpoint.PowerPoint.SlideShowSettings = js.native
  val SlideShowWindow: typingsSlinky.activexDashPowerpoint.PowerPoint.SlideShowWindow = js.native
  val Slides: typingsSlinky.activexDashPowerpoint.PowerPoint.Slides = js.native
  var SnapToGrid: MsoTriState = js.native
  val Sync: typingsSlinky.activexDashOffice.Office.Sync = js.native
  val Tags: typingsSlinky.activexDashPowerpoint.PowerPoint.Tags = js.native
  ...
  val WebOptions: typingsSlinky.activexDashPowerpoint.PowerPoint.WebOptions = js.native
