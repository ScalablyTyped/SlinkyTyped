...
class Chart protected () extends js.Object {
  ...
  val BackWall: typingsSlinky.activexDashPowerpoint.PowerPoint.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typingsSlinky.activexDashPowerpoint.PowerPoint.ChartArea = js.native
  val ChartData: typingsSlinky.activexDashPowerpoint.PowerPoint.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typingsSlinky.activexDashPowerpoint.PowerPoint.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typingsSlinky.activexDashPowerpoint.PowerPoint.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typingsSlinky.activexDashPowerpoint.PowerPoint.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typingsSlinky.activexDashPowerpoint.PowerPoint.Floor = js.native
  ...
  val Legend: typingsSlinky.activexDashPowerpoint.PowerPoint.Legend = js.native
  val Line3DGroup: ChartGroup = js.native
  var Name: String = js.native
  val Parent: js.Any = js.native
  var Perspective: Double = js.native
  val Pie3DGroup: ChartGroup = js.native
  val PlotArea: typingsSlinky.activexDashPowerpoint.PowerPoint.PlotArea = js.native
  ...
  val SideWall: typingsSlinky.activexDashPowerpoint.PowerPoint.Walls = js.native
  var Subtype: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Title: String = js.native
  var Type: Double = js.native
  val Walls: typingsSlinky.activexDashPowerpoint.PowerPoint.Walls = js.native
