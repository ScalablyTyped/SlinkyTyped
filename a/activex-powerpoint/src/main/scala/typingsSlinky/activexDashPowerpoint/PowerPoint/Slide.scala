...
class Slide protected () extends js.Object {
  ...
  val Comments: typingsSlinky.activexDashPowerpoint.PowerPoint.Comments = js.native
  var CustomLayout: typingsSlinky.activexDashPowerpoint.PowerPoint.CustomLayout = js.native
  val CustomerData: typingsSlinky.activexDashPowerpoint.PowerPoint.CustomerData = js.native
  var Design: typingsSlinky.activexDashPowerpoint.PowerPoint.Design = js.native
  ...
  val Master: typingsSlinky.activexDashPowerpoint.PowerPoint.Master = js.native
