...
class Table protected () extends js.Object {
  ...
  val Columns: typingsSlinky.activexDashPowerpoint.PowerPoint.Columns = js.native
  ...
  val Rows: typingsSlinky.activexDashPowerpoint.PowerPoint.Rows = js.native
  ...
  def Cell(Row: Double, Column: Double): typingsSlinky.activexDashPowerpoint.PowerPoint.Cell = js.native
