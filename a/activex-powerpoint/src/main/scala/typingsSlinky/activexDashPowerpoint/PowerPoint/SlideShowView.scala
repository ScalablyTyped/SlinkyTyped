...
class SlideShowView protected () extends js.Object {
  ...
  val LastSlideViewed: typingsSlinky.activexDashPowerpoint.PowerPoint.Slide = js.native
  ...
  val Slide: typingsSlinky.activexDashPowerpoint.PowerPoint.Slide = js.native
  ...
  def Player(ShapeId: js.Any): typingsSlinky.activexDashPowerpoint.PowerPoint.Player = js.native
