...
class Tags protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.Tags {
  /* CompleteClass */
  ...
  override var PowerPointDotTags_typekey: typingsSlinky.activexPowerpoint.PowerPoint.Tags = js.native
  /* CompleteClass */
