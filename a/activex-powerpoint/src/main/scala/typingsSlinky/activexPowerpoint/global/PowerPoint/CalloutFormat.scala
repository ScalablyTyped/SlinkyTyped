...
class CalloutFormat protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.CalloutFormat {
  /* CompleteClass */
  ...
  override var PowerPointDotCalloutFormat_typekey: typingsSlinky.activexPowerpoint.PowerPoint.CalloutFormat = js.native
  /* CompleteClass */
