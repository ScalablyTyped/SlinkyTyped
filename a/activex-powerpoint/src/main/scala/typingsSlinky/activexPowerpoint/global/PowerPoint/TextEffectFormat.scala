...
class TextEffectFormat protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.TextEffectFormat {
  /* CompleteClass */
  ...
  override var PowerPointDotTextEffectFormat_typekey: typingsSlinky.activexPowerpoint.PowerPoint.TextEffectFormat = js.native
  /* CompleteClass */
