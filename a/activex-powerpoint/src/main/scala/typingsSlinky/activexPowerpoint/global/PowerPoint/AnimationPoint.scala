...
class AnimationPoint protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.AnimationPoint {
  /* CompleteClass */
  ...
  override var PowerPointDotAnimationPoint_typekey: typingsSlinky.activexPowerpoint.PowerPoint.AnimationPoint = js.native
  /* CompleteClass */
