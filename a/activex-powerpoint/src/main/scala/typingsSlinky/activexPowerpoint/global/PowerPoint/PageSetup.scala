...
class PageSetup protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.PageSetup {
  /* CompleteClass */
  ...
  override var PowerPointDotPageSetup_typekey: typingsSlinky.activexPowerpoint.PowerPoint.PageSetup = js.native
  /* CompleteClass */
