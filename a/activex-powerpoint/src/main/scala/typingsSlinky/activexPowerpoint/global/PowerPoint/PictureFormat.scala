...
class PictureFormat protected ()
  extends typingsSlinky.activexPowerpoint.PowerPoint.PictureFormat {
  /* CompleteClass */
  ...
  override var PowerPointDotPictureFormat_typekey: typingsSlinky.activexPowerpoint.PowerPoint.PictureFormat = js.native
  /* CompleteClass */
