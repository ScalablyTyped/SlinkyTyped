...
object ConnectorFormat {
  ...
  implicit class ConnectorFormatOps[Self <: ConnectorFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotConnectorFormat_typekey(value: ConnectorFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.ConnectorFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
