...
trait Effect extends js.Object {
  ...
  val EffectInformation: typingsSlinky.activexPowerpoint.PowerPoint.EffectInformation
  val EffectParameters: typingsSlinky.activexPowerpoint.PowerPoint.EffectParameters
  ...
  var Shape: typingsSlinky.activexPowerpoint.PowerPoint.Shape
