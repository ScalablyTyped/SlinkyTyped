...
*/
trait PpFixedFormatType extends js.Object
object PpFixedFormatType {
  
  @scala.inline
  def ppFixedFormatTypePDF: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def ppFixedFormatTypeXPS: `1` = 1.asInstanceOf[`1`]
}
