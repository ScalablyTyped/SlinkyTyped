...
object TextFrame2 {
  ...
  implicit class TextFrame2Ops[Self <: TextFrame2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotTextFrame2_typekey(value: TextFrame2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.TextFrame2_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
