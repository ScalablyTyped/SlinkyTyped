...
trait HiLoLines extends js.Object {
  ...
  var PowerPointDotHiLoLines_typekey: HiLoLines = js.native
...
object HiLoLines {
  ...
  implicit class HiLoLinesOps[Self <: HiLoLines] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotHiLoLines_typekey(value: HiLoLines): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.HiLoLines_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
