...
*/
trait PpProtectedViewCloseReason extends StObject
object PpProtectedViewCloseReason {
  
  @scala.inline
  def ppProtectedViewCloseEdit: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def ppProtectedViewCloseForced: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def ppProtectedViewCloseNormal: `0` = 0.asInstanceOf[`0`]
}
