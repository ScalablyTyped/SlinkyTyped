...
object CommandEffect {
  ...
  implicit class CommandEffectOps[Self <: CommandEffect] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotCommandEffect_typekey(value: CommandEffect): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.CommandEffect_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: MsoAnimCommandType): Self = {
        val ret = this.duplicate
