...
object ChartCharacters {
  ...
  implicit class ChartCharactersOps[Self <: ChartCharacters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotChartCharacters_typekey(value: ChartCharacters): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.ChartCharacters_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
