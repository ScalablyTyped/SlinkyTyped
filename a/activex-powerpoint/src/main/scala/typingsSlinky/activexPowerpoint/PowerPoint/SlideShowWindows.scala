...
object SlideShowWindows {
  ...
  implicit class SlideShowWindowsOps[Self <: SlideShowWindows] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => SlideShowWindow): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPowerPointDotSlideShowWindows_typekey(value: SlideShowWindows): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.SlideShowWindows_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
