...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typingsSlinky.activexPowerpoint.PowerPoint.DownBars = js.native
  val DropLines: typingsSlinky.activexPowerpoint.PowerPoint.DropLines = js.native
  ...
  val HiLoLines: typingsSlinky.activexPowerpoint.PowerPoint.HiLoLines = js.native
  ...
  val SeriesLines: typingsSlinky.activexPowerpoint.PowerPoint.SeriesLines = js.native
  ...
  val UpBars: typingsSlinky.activexPowerpoint.PowerPoint.UpBars = js.native
