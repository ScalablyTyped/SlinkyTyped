...
object ChartColorFormat {
  ...
  implicit class ChartColorFormatOps[Self <: ChartColorFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotChartColorFormat_typekey(value: ChartColorFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.ChartColorFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
