...
object DropLines {
  ...
  implicit class DropLinesOps[Self <: DropLines] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotDropLines_typekey(value: DropLines): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.DropLines_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
