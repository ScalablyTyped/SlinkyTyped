...
object Interior {
  ...
  implicit class InteriorOps[Self <: Interior] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotInterior_typekey(value: Interior): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.Interior_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
