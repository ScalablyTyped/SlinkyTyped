...
*/
trait PpPublishSourceType extends StObject
object PpPublishSourceType {
  
  @scala.inline
  def ppPublishAll: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def ppPublishNamedSlideShow: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def ppPublishSlideRange: `2` = 2.asInstanceOf[`2`]
}
