...
object CalloutFormat {
  ...
  implicit class CalloutFormatOps[Self <: CalloutFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotCalloutFormat_typekey(value: CalloutFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.CalloutFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
