...
object SeriesLines {
  ...
  implicit class SeriesLinesOps[Self <: SeriesLines] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPowerPointDotSeriesLines_typekey(value: SeriesLines): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.SeriesLines_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
