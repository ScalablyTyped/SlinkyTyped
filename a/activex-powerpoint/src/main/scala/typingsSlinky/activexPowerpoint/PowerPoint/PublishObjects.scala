...
object PublishObjects {
  ...
  implicit class PublishObjectsOps[Self <: PublishObjects] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => PublishObject): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPowerPointDotPublishObjects_typekey(value: PublishObjects): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PowerPoint.PublishObjects_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
