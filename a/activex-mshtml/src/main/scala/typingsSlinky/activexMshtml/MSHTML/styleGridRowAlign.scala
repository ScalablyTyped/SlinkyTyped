...
object styleGridRowAlign {
  ...
  @scala.inline
  def styleGridRowAlignCenter: `0` = this.cast(0)
  @scala.inline
  def styleGridRowAlignEnd: `1` = this.cast(1)
  @scala.inline
  def styleGridRowAlignNotSet: `4` = this.cast(4)
  @scala.inline
  def styleGridRowAlignStart: `2` = this.cast(2)
  @scala.inline
  def styleGridRowAlignStretch: `3` = this.cast(3)
  @scala.inline
  def styleGridRowAlign_Max: `2147483647` = this.cast(2147483647)
}
