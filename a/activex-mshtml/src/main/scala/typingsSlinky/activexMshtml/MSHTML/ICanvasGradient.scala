...
object ICanvasGradient {
  ...
  implicit class ICanvasGradientOps[Self <: ICanvasGradient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotICanvasGradient_typekey(value: ICanvasGradient): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.ICanvasGradient_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
