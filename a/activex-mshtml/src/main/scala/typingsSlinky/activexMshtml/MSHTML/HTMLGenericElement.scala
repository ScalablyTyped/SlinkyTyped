...
@js.native
trait HTMLGenericElement extends js.Object {
  ...
  @JSName("MSHTML.HTMLGenericElement_typekey")
  var MSHTMLDotHTMLGenericElement_typekey: HTMLGenericElement = js.native
  ...
  def namedRecordset(dataMember: String): js.Any = js.native
  def namedRecordset(dataMember: String, hierarchy: js.Any): js.Any = js.native
  ...
  val recordset: js.Any = js.native
