...
object sandboxAllow {
  ...
  @scala.inline
  def sandboxAllowForms: `3` = this.cast(3)
  @scala.inline
  def sandboxAllowPopups: `4` = this.cast(4)
  @scala.inline
  def sandboxAllowSameOrigin: `1` = this.cast(1)
  @scala.inline
  def sandboxAllowScripts: `0` = this.cast(0)
  @scala.inline
  def sandboxAllowTopNavigation: `2` = this.cast(2)
  @scala.inline
  def sandboxAllow_Max: `2147483647` = this.cast(2147483647)
}
