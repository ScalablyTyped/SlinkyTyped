...
object DOMCloseEvent {
  ...
  implicit class DOMCloseEventOps[Self <: DOMCloseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotDOMCloseEvent_typekey(value: DOMCloseEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.DOMCloseEvent_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
