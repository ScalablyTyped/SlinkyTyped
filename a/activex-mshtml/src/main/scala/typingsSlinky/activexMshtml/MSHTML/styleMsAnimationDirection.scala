...
*/
trait styleMsAnimationDirection extends js.Object

object styleMsAnimationDirection {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def styleMsAnimationDirectionAlternate: `1` = this.cast(1)
  @scala.inline
  def styleMsAnimationDirectionAlternateReverse: `3` = this.cast(3)
  @scala.inline
  def styleMsAnimationDirectionNormal: `0` = this.cast(0)
  @scala.inline
  def styleMsAnimationDirectionNotSet: `4` = this.cast(4)
  @scala.inline
  def styleMsAnimationDirectionReverse: `2` = this.cast(2)
  @scala.inline
  def styleMsAnimationDirection_Max: `2147483647` = this.cast(2147483647)
}
