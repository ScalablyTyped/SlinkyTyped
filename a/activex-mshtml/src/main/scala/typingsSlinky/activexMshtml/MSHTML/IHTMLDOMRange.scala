...
object IHTMLDOMRange {
  ...
  implicit class IHTMLDOMRangeOps[Self <: IHTMLDOMRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotIHTMLDOMRange_typekey(value: IHTMLDOMRange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.IHTMLDOMRange_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
