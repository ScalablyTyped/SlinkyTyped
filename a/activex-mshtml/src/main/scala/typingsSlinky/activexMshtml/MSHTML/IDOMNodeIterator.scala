...
object IDOMNodeIterator {
  ...
  implicit class IDOMNodeIteratorOps[Self <: IDOMNodeIterator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotIDOMNodeIterator_typekey(value: IDOMNodeIterator): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.IDOMNodeIterator_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
