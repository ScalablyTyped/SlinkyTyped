...
object SVGPathSegArcRel {
  ...
  implicit class SVGPathSegArcRelOps[Self <: SVGPathSegArcRel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGPathSegArcRel_typekey(value: SVGPathSegArcRel): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGPathSegArcRel_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
