...
object SVGClipPathElement {
  ...
  implicit class SVGClipPathElementOps[Self <: SVGClipPathElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGClipPathElement_typekey(value: SVGClipPathElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGClipPathElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withClipPathUnits(value: SVGAnimatedEnumeration): Self = {
        val ret = this.duplicate
