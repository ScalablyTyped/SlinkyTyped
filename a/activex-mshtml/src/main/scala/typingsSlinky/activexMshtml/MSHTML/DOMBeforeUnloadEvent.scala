...
object DOMBeforeUnloadEvent {
  ...
  implicit class DOMBeforeUnloadEventOps[Self <: DOMBeforeUnloadEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotDOMBeforeUnloadEvent_typekey(value: DOMBeforeUnloadEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.DOMBeforeUnloadEvent_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
