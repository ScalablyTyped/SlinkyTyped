...
object SVGGradientElement {
  ...
  implicit class SVGGradientElementOps[Self <: SVGGradientElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGGradientElement_typekey(value: SVGGradientElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGGradientElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
