...
@js.native
trait HTMLTable extends js.Object {
  ...
  @JSName("MSHTML.HTMLTable_typekey")
  var MSHTMLDotHTMLTable_typekey: HTMLTable = js.native
  ...
  val caption: IHTMLTableCaption = js.native
  
  var cellPadding: js.Any = js.native
  ...
  def createCaption(): IHTMLTableCaption = js.native
  
  def createControlRange(): js.Any = js.native
  
  def createTBody(): IHTMLTableSection = js.native
  
  def createTFoot(): js.Any = js.native
  
  def createTHead(): js.Any = js.native
  ...
  var dataPageSize: Double = js.native
  ...
  var ie9_caption: IHTMLTableCaption = js.native
  ...
  var ie9_tFoot: IHTMLTableSection = js.native
  
  var ie9_tHead: IHTMLTableSection = js.native
  ...
  val tFoot: IHTMLTableSection = js.native
  
  val tHead: IHTMLTableSection = js.native
