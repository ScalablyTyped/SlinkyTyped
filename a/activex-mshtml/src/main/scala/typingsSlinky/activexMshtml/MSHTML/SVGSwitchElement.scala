...
object SVGSwitchElement {
  ...
  implicit class SVGSwitchElementOps[Self <: SVGSwitchElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGSwitchElement_typekey(value: SVGSwitchElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGSwitchElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
