...
object DOMMSAnimationEvent {
  ...
  implicit class DOMMSAnimationEventOps[Self <: DOMMSAnimationEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotDOMMSAnimationEvent_typekey(value: DOMMSAnimationEvent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.DOMMSAnimationEvent_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withInitMSAnimationEvent(value: (String, Boolean, Boolean, String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initMSAnimationEvent")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
