...
object SVGPolylineElement {
  ...
  implicit class SVGPolylineElementOps[Self <: SVGPolylineElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGPolylineElement_typekey(value: SVGPolylineElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGPolylineElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
