...
*/
trait styleImeMode extends js.Object

object styleImeMode {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def styleImeModeActive: `1` = this.cast(1)
  @scala.inline
  def styleImeModeAuto: `0` = this.cast(0)
  @scala.inline
  def styleImeModeDisabled: `3` = this.cast(3)
  @scala.inline
  def styleImeModeInactive: `2` = this.cast(2)
  @scala.inline
  def styleImeModeNotSet: `4` = this.cast(4)
  @scala.inline
  def styleImeMode_Max: `2147483647` = this.cast(2147483647)
}
