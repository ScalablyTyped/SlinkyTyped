...
object SVGDefsElement {
  ...
  implicit class SVGDefsElementOps[Self <: SVGDefsElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGDefsElement_typekey(value: SVGDefsElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGDefsElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
