...
*/
trait _HTML_PAINT_DRAW_FLAGS extends StObject
object _HTML_PAINT_DRAW_FLAGS {
  
  @scala.inline
  def HTMLPAINT_DRAW_UPDATEREGION: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def HTMLPAINT_DRAW_USE_XFORM: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def HTML_PAINT_DRAW_FLAGS_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
