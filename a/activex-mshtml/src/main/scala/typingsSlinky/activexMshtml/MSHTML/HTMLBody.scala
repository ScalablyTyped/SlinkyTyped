...
@js.native
trait HTMLBody extends StObject {
  ...
  var bgProperties: String = js.native
  
  def blur(): Unit = js.native
  
  var bottomMargin: js.Any = js.native
  ...
  var ie8_background: String = js.native
  ...
  var topMargin: js.Any = js.native
