...
object styleWrapFlow {
  ...
  @scala.inline
  def styleWrapFlowAuto: `1` = this.cast(1)
  @scala.inline
  def styleWrapFlowBoth: `2` = this.cast(2)
  @scala.inline
  def styleWrapFlowClear: `5` = this.cast(5)
  @scala.inline
  def styleWrapFlowEnd: `4` = this.cast(4)
  @scala.inline
  def styleWrapFlowMaximum: `7` = this.cast(7)
  @scala.inline
  def styleWrapFlowMinimum: `6` = this.cast(6)
  @scala.inline
  def styleWrapFlowNotSet: `0` = this.cast(0)
  @scala.inline
  def styleWrapFlowStart: `3` = this.cast(3)
  @scala.inline
  def styleWrapFlow_Max: `2147483647` = this.cast(2147483647)
}
