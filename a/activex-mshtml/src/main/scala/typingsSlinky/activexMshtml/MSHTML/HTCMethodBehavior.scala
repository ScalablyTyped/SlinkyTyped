...
object HTCMethodBehavior {
  ...
  @scala.inline
  implicit class HTCMethodBehaviorMutableBuilder[Self <: HTCMethodBehavior] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setMSHTMLDotHTCMethodBehavior_typekey(value: HTCMethodBehavior): Self = StObject.set(x, "MSHTML.HTCMethodBehavior_typekey", value.asInstanceOf[js.Any])
  }
}
