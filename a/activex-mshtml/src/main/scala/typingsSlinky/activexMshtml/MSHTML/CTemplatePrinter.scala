...
object CTemplatePrinter {
  ...
  implicit class CTemplatePrinterOps[Self <: CTemplatePrinter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotCTemplatePrinter_typekey(value: CTemplatePrinter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.CTemplatePrinter_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
