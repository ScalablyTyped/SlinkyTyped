...
object SVGTSpanElement {
  ...
  @scala.inline
  implicit class SVGTSpanElementMutableBuilder[Self <: SVGTSpanElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotSVGTSpanElement_typekey(value: SVGTSpanElement): Self = StObject.set(x, "MSHTML.SVGTSpanElement_typekey", value.asInstanceOf[js.Any])
