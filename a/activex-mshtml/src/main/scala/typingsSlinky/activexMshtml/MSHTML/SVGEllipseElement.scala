...
object SVGEllipseElement {
  ...
  implicit class SVGEllipseElementOps[Self <: SVGEllipseElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSHTMLDotSVGEllipseElement_typekey(value: SVGEllipseElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSHTML.SVGEllipseElement_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
