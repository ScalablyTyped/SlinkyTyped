...
@js.native
trait SVGGElement extends StObject {
...
object SVGGElement {
  ...
  @scala.inline
  implicit class SVGGElementMutableBuilder[Self <: SVGGElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotSVGGElement_typekey(value: SVGGElement): Self = StObject.set(x, "MSHTML.SVGGElement_typekey", value.asInstanceOf[js.Any])
