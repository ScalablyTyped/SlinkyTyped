...
object styleWebkitBoxDirection {
  ...
  @scala.inline
  def styleWebkitBoxDirectionNormal: `0` = this.cast(0)
  @scala.inline
  def styleWebkitBoxDirectionNotSet: `2` = this.cast(2)
  @scala.inline
  def styleWebkitBoxDirectionReverse: `1` = this.cast(1)
  @scala.inline
  def styleWebkitBoxDirection_Max: `2147483647` = this.cast(2147483647)
}
