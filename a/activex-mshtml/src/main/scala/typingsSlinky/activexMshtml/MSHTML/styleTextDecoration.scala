...
*/
trait styleTextDecoration extends js.Object

object styleTextDecoration {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def styleTextDecorationBlink: `4` = this.cast(4)
  @scala.inline
  def styleTextDecorationLineThrough: `3` = this.cast(3)
  @scala.inline
  def styleTextDecorationNone: `0` = this.cast(0)
  @scala.inline
  def styleTextDecorationOverline: `2` = this.cast(2)
  @scala.inline
  def styleTextDecorationUnderline: `1` = this.cast(1)
  @scala.inline
  def styleTextDecoration_Max: `2147483647` = this.cast(2147483647)
}
