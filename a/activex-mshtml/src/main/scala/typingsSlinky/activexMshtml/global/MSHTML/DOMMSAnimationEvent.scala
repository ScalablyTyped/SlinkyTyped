...
class DOMMSAnimationEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMMSAnimationEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMMSAnimationEvent_typekey")
  override var MSHTMLDotDOMMSAnimationEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMMSAnimationEvent = js.native
  /* CompleteClass */
