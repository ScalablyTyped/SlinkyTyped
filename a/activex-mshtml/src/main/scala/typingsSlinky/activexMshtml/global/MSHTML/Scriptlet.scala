...
class Scriptlet protected ()
  extends typingsSlinky.activexMshtml.MSHTML.Scriptlet {
  /* CompleteClass */
  @JSName("MSHTML.Scriptlet_typekey")
  override var MSHTMLDotScriptlet_typekey: typingsSlinky.activexMshtml.MSHTML.Scriptlet = js.native
  /* CompleteClass */
  override var Scrollbar: Boolean = js.native
  /* CompleteClass */
  override var embed: Boolean = js.native
  /* CompleteClass */
