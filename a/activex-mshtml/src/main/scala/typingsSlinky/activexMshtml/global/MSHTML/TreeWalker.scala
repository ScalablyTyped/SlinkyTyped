...
class TreeWalker protected ()
  extends typingsSlinky.activexMshtml.MSHTML.TreeWalker {
  /* CompleteClass */
  @JSName("MSHTML.TreeWalker_typekey")
  override var MSHTMLDotTreeWalker_typekey: typingsSlinky.activexMshtml.MSHTML.TreeWalker = js.native
  /* CompleteClass */
  override var currentNode: js.Any = js.native
  /* CompleteClass */
