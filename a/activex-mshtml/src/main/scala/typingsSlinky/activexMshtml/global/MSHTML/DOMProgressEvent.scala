...
class DOMProgressEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMProgressEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMProgressEvent_typekey")
  override var MSHTMLDotDOMProgressEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMProgressEvent = js.native
  /* CompleteClass */
