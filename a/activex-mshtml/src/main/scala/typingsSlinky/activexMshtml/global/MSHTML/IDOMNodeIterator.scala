...
class IDOMNodeIterator protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IDOMNodeIterator {
  /* CompleteClass */
  @JSName("MSHTML.IDOMNodeIterator_typekey")
  override var MSHTMLDotIDOMNodeIterator_typekey: typingsSlinky.activexMshtml.MSHTML.IDOMNodeIterator = js.native
  /* CompleteClass */
