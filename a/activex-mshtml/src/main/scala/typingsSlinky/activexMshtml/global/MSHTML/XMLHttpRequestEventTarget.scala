...
class XMLHttpRequestEventTarget protected ()
  extends typingsSlinky.activexMshtml.MSHTML.XMLHttpRequestEventTarget {
  /* CompleteClass */
  @JSName("MSHTML.XMLHttpRequestEventTarget_typekey")
  override var MSHTMLDotXMLHttpRequestEventTarget_typekey: typingsSlinky.activexMshtml.MSHTML.XMLHttpRequestEventTarget = js.native
  /* CompleteClass */
  override def addEventListener(`type`: String, listener: js.Any, useCapture: Boolean): Unit = js.native
  /* CompleteClass */
  override def dispatchEvent(evt: typingsSlinky.activexMshtml.MSHTML.IDOMEvent): Boolean = js.native
  /* CompleteClass */
