...
@js.native
class WebGeocoordinates protected ()
  extends typingsSlinky.activexMshtml.MSHTML.WebGeocoordinates {
  /* CompleteClass */
  @JSName("MSHTML.WebGeocoordinates_typekey")
  override var MSHTMLDotWebGeocoordinates_typekey: typingsSlinky.activexMshtml.MSHTML.WebGeocoordinates = js.native
  /* CompleteClass */
