...
class IDOMTreeWalker protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IDOMTreeWalker {
  /* CompleteClass */
  @JSName("MSHTML.IDOMTreeWalker_typekey")
  override var MSHTMLDotIDOMTreeWalker_typekey: typingsSlinky.activexMshtml.MSHTML.IDOMTreeWalker = js.native
  /* CompleteClass */
