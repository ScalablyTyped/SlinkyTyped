...
class HTMLPopup protected ()
  extends typingsSlinky.activexMshtml.MSHTML.HTMLPopup {
  /* CompleteClass */
  @JSName("MSHTML.HTMLPopup_typekey")
  override var MSHTMLDotHTMLPopup_typekey: typingsSlinky.activexMshtml.MSHTML.HTMLPopup = js.native
  /* CompleteClass */
  override val constructor: js.Any = js.native
  /* CompleteClass */
  override val document: typingsSlinky.activexMshtml.MSHTML.IHTMLDocument = js.native
  /* CompleteClass */
