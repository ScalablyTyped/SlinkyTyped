...
class IHTMLSelection protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IHTMLSelection {
  /* CompleteClass */
  @JSName("MSHTML.IHTMLSelection_typekey")
  override var MSHTMLDotIHTMLSelection_typekey: typingsSlinky.activexMshtml.MSHTML.IHTMLSelection = js.native
  /* CompleteClass */
  override val anchorNode: typingsSlinky.activexMshtml.MSHTML.IHTMLDOMNode = js.native
  /* CompleteClass */
  override val anchorOffset: Double = js.native
  /* CompleteClass */
  override val focusNode: typingsSlinky.activexMshtml.MSHTML.IHTMLDOMNode = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def getRangeAt(index: Double): typingsSlinky.activexMshtml.MSHTML.IHTMLDOMRange = js.native
  /* CompleteClass */
