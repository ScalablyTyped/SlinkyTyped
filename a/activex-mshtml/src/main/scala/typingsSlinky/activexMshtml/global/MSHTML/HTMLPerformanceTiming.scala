...
class HTMLPerformanceTiming protected ()
  extends typingsSlinky.activexMshtml.MSHTML.HTMLPerformanceTiming {
  /* CompleteClass */
  @JSName("MSHTML.HTMLPerformanceTiming_typekey")
  override var MSHTMLDotHTMLPerformanceTiming_typekey: typingsSlinky.activexMshtml.MSHTML.HTMLPerformanceTiming = js.native
  /* CompleteClass */
