...
class CanvasRenderingContext2D protected ()
  extends typingsSlinky.activexMshtml.MSHTML.CanvasRenderingContext2D {
  /* CompleteClass */
  @JSName("MSHTML.CanvasRenderingContext2D_typekey")
  override var MSHTMLDotCanvasRenderingContext2D_typekey: typingsSlinky.activexMshtml.MSHTML.CanvasRenderingContext2D = js.native
  /* CompleteClass */
