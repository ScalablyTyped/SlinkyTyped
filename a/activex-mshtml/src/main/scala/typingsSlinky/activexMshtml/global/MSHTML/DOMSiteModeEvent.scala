...
@js.native
class DOMSiteModeEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMSiteModeEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMSiteModeEvent_typekey")
  override var MSHTMLDotDOMSiteModeEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMSiteModeEvent = js.native
  /* CompleteClass */
  override val actionURL: String = js.native
  /* CompleteClass */
  override val bubbles: Boolean = js.native
  /* CompleteClass */
  override val buttonID: Double = js.native
  /* CompleteClass */
