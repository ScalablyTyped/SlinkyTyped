...
class DOMMutationEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMMutationEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMMutationEvent_typekey")
  override var MSHTMLDotDOMMutationEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMMutationEvent = js.native
  /* CompleteClass */
