...
class IDOMProcessingInstruction protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IDOMProcessingInstruction {
  /* CompleteClass */
  @JSName("MSHTML.IDOMProcessingInstruction_typekey")
  override var MSHTMLDotIDOMProcessingInstruction_typekey: typingsSlinky.activexMshtml.MSHTML.IDOMProcessingInstruction = js.native
  /* CompleteClass */
