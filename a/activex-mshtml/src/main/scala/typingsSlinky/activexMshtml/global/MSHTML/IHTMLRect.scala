...
@js.native
class IHTMLRect protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IHTMLRect {
  /* CompleteClass */
  @JSName("MSHTML.IHTMLRect_typekey")
  override var MSHTMLDotIHTMLRect_typekey: typingsSlinky.activexMshtml.MSHTML.IHTMLRect = js.native
  /* CompleteClass */
