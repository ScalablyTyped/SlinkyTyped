...
class SVGTransform protected ()
  extends typingsSlinky.activexMshtml.MSHTML.SVGTransform {
  /* CompleteClass */
  @JSName("MSHTML.SVGTransform_typekey")
  override var MSHTMLDotSVGTransform_typekey: typingsSlinky.activexMshtml.MSHTML.SVGTransform = js.native
  /* CompleteClass */
  override var angle: Double = js.native
  /* CompleteClass */
  override var matrix: typingsSlinky.activexMshtml.MSHTML.SVGMatrix = js.native
  /* CompleteClass */
  override var `type`: Double = js.native
  /* CompleteClass */
  override def setMatrix(matrix: typingsSlinky.activexMshtml.MSHTML.SVGMatrix): Unit = js.native
  /* CompleteClass */
