...
class DOMMSTransitionEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMMSTransitionEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMMSTransitionEvent_typekey")
  override var MSHTMLDotDOMMSTransitionEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMMSTransitionEvent = js.native
  /* CompleteClass */
