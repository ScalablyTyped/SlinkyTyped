...
class CPrintManagerTemplatePrinter protected ()
  extends typingsSlinky.activexMshtml.MSHTML.CPrintManagerTemplatePrinter {
  /* CompleteClass */
  @JSName("MSHTML.CPrintManagerTemplatePrinter_typekey")
  override var MSHTMLDotCPrintManagerTemplatePrinter_typekey: typingsSlinky.activexMshtml.MSHTML.CPrintManagerTemplatePrinter = js.native
  /* CompleteClass */
