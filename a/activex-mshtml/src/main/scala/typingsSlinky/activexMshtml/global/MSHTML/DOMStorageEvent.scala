...
class DOMStorageEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMStorageEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMStorageEvent_typekey")
  override var MSHTMLDotDOMStorageEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMStorageEvent = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val storageArea: typingsSlinky.activexMshtml.MSHTML.IHTMLStorage = js.native
  /* CompleteClass */
  ...
  override def initStorageEvent(
    ...
    newValueArg: String,
    urlArg: String,
    storageAreaArg: typingsSlinky.activexMshtml.MSHTML.IHTMLStorage
  ): Unit = js.native
  /* CompleteClass */
