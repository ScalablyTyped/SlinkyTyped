...
class DOMBeforeUnloadEvent protected ()
  extends typingsSlinky.activexMshtml.MSHTML.DOMBeforeUnloadEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMBeforeUnloadEvent_typekey")
  override var MSHTMLDotDOMBeforeUnloadEvent_typekey: typingsSlinky.activexMshtml.MSHTML.DOMBeforeUnloadEvent = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var returnValue: js.Any = js.native
  /* CompleteClass */
