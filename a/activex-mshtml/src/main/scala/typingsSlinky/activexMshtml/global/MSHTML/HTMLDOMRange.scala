...
class HTMLDOMRange protected ()
  extends typingsSlinky.activexMshtml.MSHTML.HTMLDOMRange {
  /* CompleteClass */
  @JSName("MSHTML.HTMLDOMRange_typekey")
  override var MSHTMLDotHTMLDOMRange_typekey: typingsSlinky.activexMshtml.MSHTML.HTMLDOMRange = js.native
  /* CompleteClass */
