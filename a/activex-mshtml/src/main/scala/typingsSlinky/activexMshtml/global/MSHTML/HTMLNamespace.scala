...
class HTMLNamespace protected ()
  extends typingsSlinky.activexMshtml.MSHTML.HTMLNamespace {
  /* CompleteClass */
  @JSName("MSHTML.HTMLNamespace_typekey")
  override var MSHTMLDotHTMLNamespace_typekey: typingsSlinky.activexMshtml.MSHTML.HTMLNamespace = js.native
  /* CompleteClass */
  override val constructor: js.Any = js.native
  /* CompleteClass */
  override val name: String = js.native
  /* CompleteClass */
  override var onreadystatechange: js.Any = js.native
  /* CompleteClass */
