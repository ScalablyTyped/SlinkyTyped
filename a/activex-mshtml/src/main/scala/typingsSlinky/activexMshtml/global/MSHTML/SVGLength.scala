...
@js.native
class SVGLength protected ()
  extends typingsSlinky.activexMshtml.MSHTML.SVGLength {
  /* CompleteClass */
  @JSName("MSHTML.SVGLength_typekey")
  override var MSHTMLDotSVGLength_typekey: typingsSlinky.activexMshtml.MSHTML.SVGLength = js.native
  /* CompleteClass */
