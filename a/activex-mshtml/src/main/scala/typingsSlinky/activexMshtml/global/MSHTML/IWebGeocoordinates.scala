...
class IWebGeocoordinates protected ()
  extends typingsSlinky.activexMshtml.MSHTML.IWebGeocoordinates {
  /* CompleteClass */
  @JSName("MSHTML.IWebGeocoordinates_typekey")
  override var MSHTMLDotIWebGeocoordinates_typekey: typingsSlinky.activexMshtml.MSHTML.IWebGeocoordinates = js.native
  /* CompleteClass */
