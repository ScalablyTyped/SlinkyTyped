...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpose(value: typingsSlinky.avvio.anon.After): Self = StObject.set(x, "expose", value.asInstanceOf[js.Any])
  ...
  trait Server[I] extends StObject {
    ...
    def after(fn: js.Function1[/* err */ js.Error, Unit]): context[I] = js.native
    def after(fn: js.Function2[/* err */ js.Error, /* done */ js.Function, Unit]): context[I] = js.native
    def after(fn: js.Function3[/* err */ js.Error, /* context */ context[I], /* done */ js.Function, Unit]): context[I] = js.native
    @JSName("after")
    var after_Original: After[I, context[I]] = js.native
    
    def close(fn: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
    def close(fn: js.Function2[/* err */ js.Error, /* done */ js.Function, Unit]): Unit = js.native
    def close(fn: js.Function3[/* err */ js.Error, /* context */ context[I], /* done */ js.Function, Unit]): Unit = js.native
    @JSName("close")
    ...
    def ready(callback: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Unit = js.native
    def ready(callback: js.Function2[/* err */ js.Error, /* done */ js.Function, Unit]): Unit = js.native
    def ready(callback: js.Function3[/* err */ js.Error, /* context */ context[I], /* done */ js.Function, Unit]): Unit = js.native
    @JSName("ready")
