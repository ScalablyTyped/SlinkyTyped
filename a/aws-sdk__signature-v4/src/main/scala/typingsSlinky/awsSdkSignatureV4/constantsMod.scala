...
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Numbers.`50`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`AWS4-HMAC-SHA256`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`UNSIGNED-PAYLOAD`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Algorithm`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Credential`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Date`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Expires`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Security-Token`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-Signature`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`X-Amz-SignedHeaders`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.`x-amz-content-sha256`
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.authorization
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.aws4_request
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.date
import typingsSlinky.awsSdkSignatureV4.awsSdkSignatureV4Strings.host
