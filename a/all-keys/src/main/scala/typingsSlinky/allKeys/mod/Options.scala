...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(includeObjectPrototype)) __obj.updateDynamic("includeObjectPrototype")(includeObjectPrototype.get.asInstanceOf[js.Any])
    if (!js.isUndefined(includeSymbols)) __obj.updateDynamic("includeSymbols")(includeSymbols.get.asInstanceOf[js.Any])
