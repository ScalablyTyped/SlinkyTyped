...
object IEvent {
  ...
  implicit class IEventOps[Self <: IEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStartsAt(value: js.Date): Self = this.set("startsAt", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEndsAt(value: js.Date): Self = this.set("endsAt", value.asInstanceOf[js.Any])
    @scala.inline
