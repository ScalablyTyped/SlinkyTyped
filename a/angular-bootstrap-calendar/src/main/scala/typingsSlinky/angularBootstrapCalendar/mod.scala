    ...
    object calendar {
      ...
      object IEvent {
        ...
        implicit class IEventMutableBuilder[Self <: IEvent] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setEndsAt(value: js.Date): Self = StObject.set(x, "endsAt", value.asInstanceOf[js.Any])
          ...
          @scala.inline
          def setStartsAt(value: js.Date): Self = StObject.set(x, "startsAt", value.asInstanceOf[js.Any])
