...
object ^ extends js.Object {
  ...
  /**
  	...
  	```
  	*/
  def react[SelfType /* <: ReactComponentClass[js.Object] */](self: SelfType): SelfType = js.native
  def react[SelfType /* <: ReactComponentClass[js.Object] */](self: SelfType, options: Options): SelfType = js.native
}
