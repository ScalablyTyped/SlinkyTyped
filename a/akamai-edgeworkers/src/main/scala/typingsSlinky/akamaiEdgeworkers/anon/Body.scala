...
trait Body extends js.Object {
  ...
  var headers: js.UndefOr[typingsSlinky.akamaiEdgeworkers.createResponseMod.Headers] = js.native
...
object Body {
  ...
  implicit class BodyOps[Self <: Body] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeaders(value: typingsSlinky.akamaiEdgeworkers.createResponseMod.Headers): Self = this.set("headers", value.asInstanceOf[js.Any])
