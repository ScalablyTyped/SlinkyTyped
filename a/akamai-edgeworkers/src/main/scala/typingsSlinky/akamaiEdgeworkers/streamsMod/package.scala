...
package object streamsMod {
  ...
  type ReadableByteStreamControllerCallback = js.Function1[
    /* controller */ typingsSlinky.akamaiEdgeworkers.streamsMod.ReadableByteStreamController, 
    scala.Unit | js.Thenable[scala.Unit]
  ]
  
  type ReadableStreamDefaultControllerCallback[R] = js.Function1[
    /* controller */ typingsSlinky.akamaiEdgeworkers.streamsMod.ReadableStreamDefaultController[R], 
    scala.Unit | js.Thenable[scala.Unit]
  ]
  ...
  type WritableStreamDefaultControllerStartCallback = js.Function1[
    /* controller */ typingsSlinky.akamaiEdgeworkers.streamsMod.WritableStreamDefaultController, 
    scala.Unit | js.Thenable[scala.Unit]
  ]
