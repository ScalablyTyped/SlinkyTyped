...
import typingsSlinky.akamaiEdgeworkers.akamaiEdgeworkersStrings.byob
...
object anon {
  ...
  object Body {
    ...
    implicit class BodyMutableBuilder[Self <: Body] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHeaders(value: typingsSlinky.akamaiEdgeworkers.createResponseMod.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
