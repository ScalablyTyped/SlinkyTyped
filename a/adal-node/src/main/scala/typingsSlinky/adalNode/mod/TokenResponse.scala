...
object TokenResponse {
  ...
  implicit class TokenResponseOps[Self <: TokenResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpiresOnDate(value: js.Date): Self = this.set("expiresOn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpiresOn(value: js.Date | String): Self = this.set("expiresOn", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCreatedOnDate(value: js.Date): Self = this.set("createdOn", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreatedOn(value: js.Date | String): Self = this.set("createdOn", value.asInstanceOf[js.Any])
