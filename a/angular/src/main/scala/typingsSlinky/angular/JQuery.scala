...
trait JQuery extends js.Object {
  ...
  /**
    ...
    */
  def css(propertyName: String, value: js.Function2[/* index */ Double, /* value */ String, String | Double]): this.type = js.native
  ...
  /**
    ...
    */
  def html(func: js.Function2[/* index */ Double, /* oldhtml */ String, String]): this.type = js.native
  /**
    * Set the HTML contents of each element in the set of matched elements.
    *
  ...
  /**
    ...
    */
  def removeData(list: js.Array[String]): this.type = js.native
  /**
    * Remove a previously-stored piece of data.
    *
  ...
  /**
    ...
    */
  def text(func: js.Function2[/* index */ Double, /* text */ String, String]): this.type = js.native
  /**
    * Set the content of each element in the set of matched elements to the specified text.
    *
  ...
  /**
    ...
    */
  def `val`(func: js.Function2[/* index */ Double, /* value */ String, String]): this.type = js.native
  /**
    * Set the value of each element in the set of matched elements.
    *
