...
object IDirectivePrePost {
  @scala.inline
  def apply[/* <: typingsSlinky.angular.mod.IScope */ TScope, /* <: typingsSlinky.angular.JQLite */ TElement, /* <: typingsSlinky.angular.mod.IAttributes */ TAttributes, /* <: typingsSlinky.angular.mod.IDirectiveController */ TController](): IDirectivePrePost[TScope, TElement, TAttributes, TController] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDirectivePrePost[TScope, TElement, TAttributes, TController]]
  }
  @scala.inline
  implicit class IDirectivePrePostOps[Self <: IDirectivePrePost[_, _, _, _], /* <: typingsSlinky.angular.mod.IScope */ TScope, /* <: typingsSlinky.angular.JQLite */ TElement, /* <: typingsSlinky.angular.mod.IAttributes */ TAttributes, /* <: typingsSlinky.angular.mod.IDirectiveController */ TController] (val x: Self with (IDirectivePrePost[TScope, TElement, TAttributes, TController])) extends AnyVal {
    @scala.inline
