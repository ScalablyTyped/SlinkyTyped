...
object IDirective {
  @scala.inline
  def apply[/* <: typingsSlinky.angular.mod.IScope */ TScope, /* <: typingsSlinky.angular.JQLite */ TElement, /* <: typingsSlinky.angular.mod.IAttributes */ TAttributes, /* <: typingsSlinky.angular.mod.IDirectiveController */ TController](): IDirective[TScope, TElement, TAttributes, TController] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDirective[TScope, TElement, TAttributes, TController]]
  }
  @scala.inline
  implicit class IDirectiveOps[Self <: IDirective[_, _, _, _], /* <: typingsSlinky.angular.mod.IScope */ TScope, /* <: typingsSlinky.angular.JQLite */ TElement, /* <: typingsSlinky.angular.mod.IAttributes */ TAttributes, /* <: typingsSlinky.angular.mod.IDirectiveController */ TController] (val x: Self with (IDirective[TScope, TElement, TAttributes, TController])) extends AnyVal {
    @scala.inline
