...
object anon {
  ...
  trait Children extends StObject {
    ...
    def create(group: typingsSlinky.atlassianCrowdClient.groupMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.groupMod.^] = js.native
    
    def get(groupname: String): js.Promise[typingsSlinky.atlassianCrowdClient.groupMod.^] = js.native
    def get(groupname: String, withAttributes: Boolean): js.Promise[typingsSlinky.atlassianCrowdClient.groupMod.^] = js.native
    ...
    def update(groupname: String, group: typingsSlinky.atlassianCrowdClient.groupMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.groupMod.^] = js.native
  ...
  trait Create extends StObject {
    ...
    def create(username: String, password: String): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def create(username: String, password: String, validationFactors: js.UndefOr[scala.Nothing], duration: Double): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def create(
      username: String,
      password: String,
      validationFactors: typingsSlinky.atlassianCrowdClient.validationFactorsMod.^
    ): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def create(
      username: String,
      password: String,
      validationFactors: typingsSlinky.atlassianCrowdClient.validationFactorsMod.^,
    ...
    def createUnvalidated(username: String): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def createUnvalidated(username: String, validationFactors: js.UndefOr[scala.Nothing], duration: Double): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def createUnvalidated(username: String, validationFactors: typingsSlinky.atlassianCrowdClient.validationFactorsMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    ...
    def validate(token: String): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
    def validate(token: String, validationFactors: typingsSlinky.atlassianCrowdClient.validationFactorsMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.sessionMod.^] = js.native
  }
  ...
  trait Group extends StObject {
    ...
    def group(restriction: String): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(
      restriction: String,
      expand: js.UndefOr[scala.Nothing],
      startIndex: js.UndefOr[scala.Nothing],
      maxResults: Double
    ): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: js.UndefOr[scala.Nothing], startIndex: Double): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: js.UndefOr[scala.Nothing], startIndex: Double, maxResults: Double): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: Boolean): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: Boolean, startIndex: js.UndefOr[scala.Nothing], maxResults: Double): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: Boolean, startIndex: Double): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
    def group(restriction: String, expand: Boolean, startIndex: Double, maxResults: Double): js.Promise[js.Array[String | typingsSlinky.atlassianCrowdClient.groupMod.^]] = js.native
  ...
  trait List extends StObject {
    ...
    def list(username: String): js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^] = js.native
    
    var password: Reset = js.native
    
    def remove(username: String, attributename: String): js.Promise[Unit] = js.native
    
    def set(username: String, attributes: typingsSlinky.atlassianCrowdClient.attributesMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^] = js.native
  ...
  object List {
    ...
    @scala.inline
    def apply(
      list: String => js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^],
      password: Reset,
      remove: (String, String) => js.Promise[Unit],
      set: (String, typingsSlinky.atlassianCrowdClient.attributesMod.^) => js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^],
      username: Request
    ): List = {
    ...
    implicit class ListMutableBuilder[Self <: List] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setList(value: String => js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^]): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSet(
        value: (String, typingsSlinky.atlassianCrowdClient.attributesMod.^) => js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^]
  ...
  trait Remove extends StObject {
    ...
    def list(groupname: String): js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^] = js.native
    
    def remove(groupname: String, attributename: String): js.Promise[Unit] = js.native
    
    def set(groupname: String, attributes: typingsSlinky.atlassianCrowdClient.attributesMod.^): js.Promise[typingsSlinky.atlassianCrowdClient.attributesMod.^] = js.native
  }
  object Remove {
