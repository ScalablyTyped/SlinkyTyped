...
class WizHook protected ()
  extends typingsSlinky.activexAccess.Access.WizHook {
  /* CompleteClass */
  @JSName("Access.WizHook_typekey")
  override var AccessDotWizHook_typekey: typingsSlinky.activexAccess.Access.WizHook = js.native
  /* CompleteClass */
  ...
  override def OpenEmScript(
    pProperty: typingsSlinky.activexAccess.Access.AccessProperty,
    OpenMode: Double,
    Extra: Double,
    Version: Double
  ): Double = js.native
