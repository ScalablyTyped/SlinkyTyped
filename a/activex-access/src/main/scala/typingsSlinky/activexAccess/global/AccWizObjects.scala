package typingsSlinky.activexAccess.global
...
import typingsSlinky.activexAccess.AccWizObjects.WIZ_WIN32_FIND_DATA
...
object AccWizObjects extends js.Object {
  ...
  class FieldList protected ()
    extends typingsSlinky.activexAccess.AccWizObjects.FieldList {
    /* CompleteClass */
    @JSName("AccWizObjects.FieldList_typekey")
    override var AccWizObjectsDotFieldList_typekey: typingsSlinky.activexAccess.AccWizObjects.FieldList = js.native
    /* CompleteClass */
  ...
  class ImexGrid protected ()
    extends typingsSlinky.activexAccess.AccWizObjects.ImexGrid {
    /* CompleteClass */
    @JSName("AccWizObjects.ImexGrid_typekey")
    override var AccWizObjectsDotImexGrid_typekey: typingsSlinky.activexAccess.AccWizObjects.ImexGrid = js.native
    /* CompleteClass */
  ...
  class WizShellLinkA protected ()
    extends typingsSlinky.activexAccess.AccWizObjects.WizShellLinkA {
    /* CompleteClass */
    @JSName("AccWizObjects.WizShellLinkA_typekey")
    override var AccWizObjectsDotWizShellLinkA_typekey: typingsSlinky.activexAccess.AccWizObjects.WizShellLinkA = js.native
    /** GetArguments */
    /* CompleteClass */
