...
class WSParameter protected ()
  extends typingsSlinky.activexAccess.Access.WSParameter {
  /* CompleteClass */
  @JSName("Access.WSParameter_typekey")
  override var AccessDotWSParameter_typekey: typingsSlinky.activexAccess.Access.WSParameter = js.native
  /* CompleteClass */
