...
*/
trait AcSeparatorCharacters extends js.Object
object AcSeparatorCharacters {
  
  @scala.inline
  def acSeparatorCharactersComma: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def acSeparatorCharactersNewLine: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def acSeparatorCharactersSemiColon: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def acSeparatorCharactersSystemSeparator: `0` = 0.asInstanceOf[`0`]
}
