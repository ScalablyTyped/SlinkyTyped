...
import typingsSlinky.activexAccess.activexAccessNumbers.`12`
import typingsSlinky.activexAccess.activexAccessNumbers.`13`
...
trait Application extends js.Object {
  ...
  var AccessDotApplication_typekey: typingsSlinky.activexAccess.Access.Application = js.native
  ...
  val AutoCorrect: typingsSlinky.activexAccess.Access.AutoCorrect = js.native
  ...
  val CodeData: typingsSlinky.activexAccess.Access.CodeData = js.native
  
  def CodeDb(): Database = js.native
  
  val CodeProject: typingsSlinky.activexAccess.Access.CodeProject = js.native
  ...
  val CurrentData: typingsSlinky.activexAccess.Access.CurrentData = js.native
  ...
  val CurrentProject: typingsSlinky.activexAccess.Access.CurrentProject = js.native
  ...
  val DBEngine: typingsSlinky.activexDao.DAO.DBEngine = js.native
  ...
  val DefaultWebOptions: typingsSlinky.activexAccess.Access.DefaultWebOptions = js.native
  ...
  val DoCmd: typingsSlinky.activexAccess.Access.DoCmd = js.native
  ...
  def FileDialog(dialogType: MsoFileDialogType): typingsSlinky.activexOffice.Office.FileDialog = js.native
  ...
  val MacroError: typingsSlinky.activexAccess.Access.MacroError = js.native
  ...
  var Printer: typingsSlinky.activexAccess.Access.Printer = js.native
  ...
  val Screen: typingsSlinky.activexAccess.Access.Screen = js.native
  ...
  val WizHook: typingsSlinky.activexAccess.Access.WizHook = js.native
