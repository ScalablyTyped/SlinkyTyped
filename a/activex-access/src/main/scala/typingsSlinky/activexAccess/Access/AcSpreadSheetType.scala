...
object AcSpreadSheetType {
  @scala.inline
  def acSpreadsheetTypeExcel12: `9` = 9.asInstanceOf[`9`]
  @scala.inline
  def acSpreadsheetTypeExcel12Xml: `10` = 10.asInstanceOf[`10`]
  @scala.inline
  def acSpreadsheetTypeExcel3: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def acSpreadsheetTypeExcel4: `6` = 6.asInstanceOf[`6`]
  @scala.inline
  def acSpreadsheetTypeExcel5: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def acSpreadsheetTypeExcel7: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def acSpreadsheetTypeExcel8: `8` = 8.asInstanceOf[`8`]
  @scala.inline
  def acSpreadsheetTypeExcel9: `8` = 8.asInstanceOf[`8`]
  @scala.inline
  def acSpreadsheetTypeExcel97: `8` = 8.asInstanceOf[`8`]
  @scala.inline
  def acSpreadsheetTypeLotusWJ2: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def acSpreadsheetTypeLotusWK1: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def acSpreadsheetTypeLotusWK3: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def acSpreadsheetTypeLotusWK4: `7` = 7.asInstanceOf[`7`]
}
