...
trait TextBox extends StObject {
  ...
  var AsianLineBreak: Boolean = js.native
  ...
  var FELineBreak: Boolean = js.native
  ...
  var FuriganaControl: String = js.native
  ...
  var PostalAddress: String = js.native
  ...
  var RunningSum: Double = js.native
  ...
  var ShowDatePicker: Double = js.native
