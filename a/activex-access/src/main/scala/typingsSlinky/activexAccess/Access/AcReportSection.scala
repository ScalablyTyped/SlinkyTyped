...
*/
trait AcReportSection extends js.Object
object AcReportSection {
  
  @scala.inline
  def acDetail: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def acFooter: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def acGroupLevel1Footer: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def acGroupLevel1Header: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def acGroupLevel2Footer: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def acGroupLevel2Header: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def acHeader: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def acPageFooter: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def acPageHeader: `3` = 3.asInstanceOf[`3`]
}
