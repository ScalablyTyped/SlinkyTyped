...
object AcCurrentView {
  @scala.inline
  def acCurViewDatasheet: `2` = this.cast(2)
  @scala.inline
  def acCurViewDesign: `0` = this.cast(0)
  @scala.inline
  def acCurViewFormBrowse: `1` = this.cast(1)
  @scala.inline
  def acCurViewLayout: `7` = this.cast(7)
  @scala.inline
  def acCurViewPivotChart: `4` = this.cast(4)
  @scala.inline
  def acCurViewPivotTable: `3` = this.cast(3)
  @scala.inline
  def acCurViewPreview: `5` = this.cast(5)
  @scala.inline
  def acCurViewReportBrowse: `6` = this.cast(6)
  @scala.inline
