...
*/
trait AcVerticalAnchor extends StObject
object AcVerticalAnchor {
  
  @scala.inline
  def acVerticalAnchorBoth: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def acVerticalAnchorBottom: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def acVerticalAnchorTop: `0` = 0.asInstanceOf[`0`]
}
