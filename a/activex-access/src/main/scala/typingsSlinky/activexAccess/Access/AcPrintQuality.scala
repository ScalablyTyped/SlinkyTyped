...
*/
trait AcPrintQuality extends js.Object
object AcPrintQuality {
  
  @scala.inline
  def acDraft: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def acHigh: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def acLow: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def acMedium: `1` = 1.asInstanceOf[`1`]
}
