...
class Report protected () extends js.Object {
  ...
  var AccessDotReport_typekey: typingsSlinky.activexAccess.Access.Report = js.native
  ...
  def GroupLevel(Index: Double): typingsSlinky.activexAccess.Access.GroupLevel = js.native
  ...
  def Section(Index: AcReportSection): typingsSlinky.activexAccess.Access.Section = js.native
