...
class Report protected () extends js.Object {
  ...
  var AccessDotReport_typekey: typingsSlinky.activexDashAccess.Access.Report = js.native
  ...
  val Report: typingsSlinky.activexDashAccess.Access.Report = js.native
  ...
  def GroupLevel(Index: Double): typingsSlinky.activexDashAccess.Access.GroupLevel = js.native
  ...
  def Section(Index: AcReportSection): typingsSlinky.activexDashAccess.Access.Section = js.native
