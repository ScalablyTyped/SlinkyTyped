...
class CodeProject protected () extends js.Object {
  val AccessConnection: typingsSlinky.activexDashAdodb.ADODB.Connection = js.native
  ...
  val Connection: typingsSlinky.activexDashAdodb.ADODB.Connection = js.native
