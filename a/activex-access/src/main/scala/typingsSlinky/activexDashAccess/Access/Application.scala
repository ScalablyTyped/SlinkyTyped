...
import typingsSlinky.activexDashDao.DAO.Database
import typingsSlinky.activexDashDao.DAO.Workspace
...
class Application protected () extends js.Object {
  ...
  val AutoCorrect: typingsSlinky.activexDashAccess.Access.AutoCorrect = js.native
  ...
  val CodeData: typingsSlinky.activexDashAccess.Access.CodeData = js.native
  val CodeProject: typingsSlinky.activexDashAccess.Access.CodeProject = js.native
  @JSName("CommandBars")
  val CommandBars_Original: CommandBars = js.native
  val CurrentData: typingsSlinky.activexDashAccess.Access.CurrentData = js.native
  val CurrentObjectName: String = js.native
  val CurrentObjectType: AcObjectType = js.native
  val CurrentProject: typingsSlinky.activexDashAccess.Access.CurrentProject = js.native
  val DBEngine: typingsSlinky.activexDashDao.DAO.DBEngine = js.native
  @JSName("DataAccessPages")
  val DataAccessPages_Original: DataAccessPages = js.native
  val DefaultWebOptions: typingsSlinky.activexDashAccess.Access.DefaultWebOptions = js.native
  val DoCmd: typingsSlinky.activexDashAccess.Access.DoCmd = js.native
  ...
  val MacroError: typingsSlinky.activexDashAccess.Access.MacroError = js.native
  ...
  var Printer: typingsSlinky.activexDashAccess.Access.Printer = js.native
  @JSName("Printers")
  ...
  val Screen: typingsSlinky.activexDashAccess.Access.Screen = js.native
  ...
  val WizHook: typingsSlinky.activexDashAccess.Access.WizHook = js.native
  ...
  def FileDialog(dialogType: MsoFileDialogType): typingsSlinky.activexDashOffice.Office.FileDialog = js.native
  /**
