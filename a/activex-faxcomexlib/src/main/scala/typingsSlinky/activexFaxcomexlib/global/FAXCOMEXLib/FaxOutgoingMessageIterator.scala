...
class FaxOutgoingMessageIterator protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessageIterator {
  /** End of archive marker */
  /* CompleteClass */
  override val AtEOF: Boolean = js.native
  /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxOutgoingMessageIterator_typekey")
  override var FAXCOMEXLibDotFaxOutgoingMessageIterator_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessageIterator = js.native
  /** Current message */
  /* CompleteClass */
  override val Message: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingMessage = js.native
