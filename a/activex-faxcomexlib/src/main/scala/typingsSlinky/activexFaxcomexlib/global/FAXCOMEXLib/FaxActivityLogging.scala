...
class FaxActivityLogging protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxActivityLogging {
  /** Activity log database files path */
  /* CompleteClass */
  override var DatabasePath: String = js.native
  /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxActivityLogging_typekey")
  override var FAXCOMEXLibDotFaxActivityLogging_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxActivityLogging = js.native
