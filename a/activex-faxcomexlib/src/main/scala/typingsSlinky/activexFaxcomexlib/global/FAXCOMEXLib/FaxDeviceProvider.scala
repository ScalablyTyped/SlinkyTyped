...
class FaxDeviceProvider protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider {
  ...
  override var FAXCOMEXLibDotFaxDeviceProvider_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider = js.native
