...
class FaxInboundRoutingMethod protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxInboundRoutingMethod {
  ...
  override var FAXCOMEXLibDotFaxInboundRoutingMethod_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxInboundRoutingMethod = js.native
