...
class IFaxOutgoingJob protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob {
  ...
  override var FAXCOMEXLibDotIFaxOutgoingJob_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob = js.native
