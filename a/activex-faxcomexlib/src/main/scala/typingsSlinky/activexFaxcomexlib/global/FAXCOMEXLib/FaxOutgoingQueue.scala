...
class FaxOutgoingQueue protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingQueue {
  ...
  override var FAXCOMEXLibDotFaxOutgoingQueue_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingQueue = js.native
  /** Is the queue paused */
  /* CompleteClass */
