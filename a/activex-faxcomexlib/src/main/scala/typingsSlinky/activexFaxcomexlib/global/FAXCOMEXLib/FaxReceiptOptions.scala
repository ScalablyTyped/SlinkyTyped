...
class FaxReceiptOptions protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxReceiptOptions {
  ...
  override var FAXCOMEXLibDotFaxReceiptOptions_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxReceiptOptions = js.native
  /** SMTP password */
  /* CompleteClass */
