...
import typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FAX_DEVICE_RECEIVE_MODE_ENUM
...
class FaxDevice protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxDevice {
  ...
  override var FAXCOMEXLibDotFaxDevice_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxDevice = js.native
  /** Unique device ID */
  /* CompleteClass */
