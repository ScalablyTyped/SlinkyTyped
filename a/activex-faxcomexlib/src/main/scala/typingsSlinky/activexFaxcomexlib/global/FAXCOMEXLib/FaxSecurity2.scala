...
class FaxSecurity2 protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxSecurity2 {
  /** Security descriptor */
  /* CompleteClass */
  override var Descriptor: js.Any = js.native
  /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxSecurity2_typekey")
  override var FAXCOMEXLibDotFaxSecurity2_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxSecurity2 = js.native
