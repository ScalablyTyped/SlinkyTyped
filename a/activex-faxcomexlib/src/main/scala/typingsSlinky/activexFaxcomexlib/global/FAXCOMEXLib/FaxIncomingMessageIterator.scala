...
class FaxIncomingMessageIterator protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessageIterator {
  /** End of archive marker */
  /* CompleteClass */
  override val AtEOF: Boolean = js.native
  /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxIncomingMessageIterator_typekey")
  override var FAXCOMEXLibDotFaxIncomingMessageIterator_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessageIterator = js.native
  /** The current message */
  /* CompleteClass */
  override val Message: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.IFaxIncomingMessage = js.native
