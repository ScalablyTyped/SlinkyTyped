...
class FaxOutgoingMessage protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessage {
  /** Called Station ID */
  /* CompleteClass */
  ...
  override var FAXCOMEXLibDotFaxOutgoingMessage_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessage = js.native
  /** Has Cover page */
  /* CompleteClass */
