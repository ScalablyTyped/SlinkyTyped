...
class FaxConfiguration protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxConfiguration {
  ...
  override var FAXCOMEXLibDotFaxConfiguration_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxConfiguration = js.native
