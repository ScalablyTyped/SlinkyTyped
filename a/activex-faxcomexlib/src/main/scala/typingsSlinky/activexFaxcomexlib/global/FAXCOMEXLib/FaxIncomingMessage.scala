...
class FaxIncomingMessage protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessage {
  /** Called Station ID */
  /* CompleteClass */
  ...
  override var FAXCOMEXLibDotFaxIncomingMessage_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessage = js.native
  /** Has Cover page */
  /* CompleteClass */
