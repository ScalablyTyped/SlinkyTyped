...
import typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FAX_LOG_LEVEL_ENUM
...
class FaxEventLogging protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxEventLogging {
  /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxEventLogging_typekey")
  override var FAXCOMEXLibDotFaxEventLogging_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxEventLogging = js.native
