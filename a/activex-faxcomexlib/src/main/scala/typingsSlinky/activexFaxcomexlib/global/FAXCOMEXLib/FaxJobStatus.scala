...
import typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FAX_JOB_TYPE_ENUM
...
class FaxJobStatus protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus {
  ...
  override var FAXCOMEXLibDotFaxJobStatus_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus = js.native
  /** Job type */
  /* CompleteClass */
