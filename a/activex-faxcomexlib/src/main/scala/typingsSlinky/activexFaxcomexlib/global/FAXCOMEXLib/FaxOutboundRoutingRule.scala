...
class FaxOutboundRoutingRule protected ()
  extends typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutboundRoutingRule {
  /** Area code */
  /* CompleteClass */
  ...
  override var FAXCOMEXLibDotFaxOutboundRoutingRule_typekey: typingsSlinky.activexFaxcomexlib.FAXCOMEXLib.FaxOutboundRoutingRule = js.native
  /** Group name */
  /* CompleteClass */
