package typingsSlinky.angularDashHttpi.Httpi

import typingsSlinky.angular.angularMod.IHttpRequestConfigHeaders
import typingsSlinky.angular.angularMod.IHttpRequestTransformer
import typingsSlinky.angular.angularMod.IHttpResponseTransformer
