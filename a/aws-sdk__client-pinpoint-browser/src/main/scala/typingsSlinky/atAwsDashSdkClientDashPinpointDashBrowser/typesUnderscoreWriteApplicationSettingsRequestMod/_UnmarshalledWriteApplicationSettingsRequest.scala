package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreWriteApplicationSettingsRequestMod
...
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreQuietTimeMod._UnmarshalledQuietTime
