package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSimpleEmailMod

import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSimpleEmailPartMod._SimpleEmailPart
