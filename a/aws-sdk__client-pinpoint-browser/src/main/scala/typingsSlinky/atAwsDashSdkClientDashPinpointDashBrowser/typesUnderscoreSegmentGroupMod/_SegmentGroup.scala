package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentGroupMod

import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.atAwsDashSdkClientDashPinpointDashBrowserStrings.ALL
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.atAwsDashSdkClientDashPinpointDashBrowserStrings.ANY
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.atAwsDashSdkClientDashPinpointDashBrowserStrings.NONE
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentDimensionsMod._SegmentDimensions
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentReferenceMod._SegmentReference
...
trait _SegmentGroup extends js.Object {
  /**
    ...
    */
  var Dimensions: js.UndefOr[js.Array[_SegmentDimensions] | js.Iterable[_SegmentDimensions]] = js.undefined
  /**
    ...
    */
  var SourceSegments: js.UndefOr[js.Array[_SegmentReference] | js.Iterable[_SegmentReference]] = js.undefined
  /**
...
object _SegmentGroup {
  @scala.inline
  def apply(
    Dimensions: js.Array[_SegmentDimensions] | js.Iterable[_SegmentDimensions] = null,
    SourceSegments: js.Array[_SegmentReference] | js.Iterable[_SegmentReference] = null,
