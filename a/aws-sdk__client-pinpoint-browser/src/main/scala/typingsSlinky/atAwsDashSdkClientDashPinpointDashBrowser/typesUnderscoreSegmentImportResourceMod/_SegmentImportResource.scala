package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentImportResourceMod
...
object _SegmentImportResource {
  @scala.inline
  def apply(
    ChannelCounts: StringDictionary[Double] | (js.Iterable[js.Tuple2[String, Double]]) = null,
