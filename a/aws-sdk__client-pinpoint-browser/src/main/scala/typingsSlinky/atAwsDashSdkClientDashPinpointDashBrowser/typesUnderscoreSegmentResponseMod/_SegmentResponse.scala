package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentResponseMod

import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.atAwsDashSdkClientDashPinpointDashBrowserStrings.DIMENSIONAL
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.atAwsDashSdkClientDashPinpointDashBrowserStrings.IMPORT
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentDimensionsMod._SegmentDimensions
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentGroupListMod._SegmentGroupList
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentImportResourceMod._SegmentImportResource
