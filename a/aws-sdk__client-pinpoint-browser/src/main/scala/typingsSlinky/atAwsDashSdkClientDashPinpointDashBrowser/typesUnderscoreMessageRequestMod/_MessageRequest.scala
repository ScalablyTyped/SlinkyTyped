package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreMessageRequestMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreAddressConfigurationMod._AddressConfiguration
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreDirectMessageConfigurationMod._DirectMessageConfiguration
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreEndpointSendConfigurationMod._EndpointSendConfiguration
...
trait _MessageRequest extends js.Object {
  ...
  var Addresses: js.UndefOr[
    StringDictionary[_AddressConfiguration] | (js.Iterable[js.Tuple2[String, _AddressConfiguration]])
  ] = js.undefined
  /**
  ...
  var Endpoints: js.UndefOr[
    StringDictionary[_EndpointSendConfiguration] | (js.Iterable[js.Tuple2[String, _EndpointSendConfiguration]])
  ] = js.undefined
  /**
...
object _MessageRequest {
  @scala.inline
  def apply(
    Addresses: StringDictionary[_AddressConfiguration] | (js.Iterable[js.Tuple2[String, _AddressConfiguration]]) = null,
    Context: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]) = null,
    Endpoints: StringDictionary[_EndpointSendConfiguration] | (js.Iterable[js.Tuple2[String, _EndpointSendConfiguration]]) = null,
