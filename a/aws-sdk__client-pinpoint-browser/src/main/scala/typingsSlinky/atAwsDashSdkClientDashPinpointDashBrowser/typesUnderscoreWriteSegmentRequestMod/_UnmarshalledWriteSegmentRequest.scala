package typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreWriteSegmentRequestMod

import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentDimensionsMod._UnmarshalledSegmentDimensions
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSegmentGroupListMod._UnmarshalledSegmentGroupList
