...
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreItemResponseMod._ItemResponse
...
trait _EventsResponse extends js.Object {
  ...
  var Results: js.UndefOr[
    StringDictionary[_ItemResponse] | (js.Iterable[js.Tuple2[String, _ItemResponse]])
  ] = js.undefined
}

object _EventsResponse {
  @scala.inline
  def apply(Results: StringDictionary[_ItemResponse] | (js.Iterable[js.Tuple2[String, _ItemResponse]]) = null): _EventsResponse = {
