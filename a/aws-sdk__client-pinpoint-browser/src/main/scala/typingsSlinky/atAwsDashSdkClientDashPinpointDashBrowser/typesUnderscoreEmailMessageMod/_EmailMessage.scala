...
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreRawEmailMod._RawEmail
import typingsSlinky.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreSimpleEmailMod._SimpleEmail
