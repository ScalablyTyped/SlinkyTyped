...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetCampaignActivitiesInput", JSImport.Namespace)
@js.native
object typesGetCampaignActivitiesInputMod extends js.Object {
  @js.native
