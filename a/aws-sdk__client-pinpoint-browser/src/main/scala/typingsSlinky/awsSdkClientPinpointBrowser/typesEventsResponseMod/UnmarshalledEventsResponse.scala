...
import typingsSlinky.awsSdkClientPinpointBrowser.typesItemResponseMod.UnmarshalledItemResponse
...
object UnmarshalledEventsResponse {
  ...
  implicit class UnmarshalledEventsResponseOps[Self <: UnmarshalledEventsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResults(value: StringDictionary[UnmarshalledItemResponse]): Self = {
