package typingsSlinky.awsSdkClientPinpointBrowser.deleteApnsVoipChannelExceptionsUnionMod
...
object DeleteApnsVoipChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DeleteApnsVoipChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipChannelExceptionsUnion]
}
