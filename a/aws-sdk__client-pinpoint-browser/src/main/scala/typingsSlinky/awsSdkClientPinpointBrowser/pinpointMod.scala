...
import typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentVersionsOutputMod.GetSegmentVersionsOutput
...
import typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateSegmentInputMod.UpdateSegmentInput
