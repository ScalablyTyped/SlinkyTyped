...
object mapOfMapOfEndpointMessageResultMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/model/_MapOfMapOfEndpointMessageResult", "_MapOfMapOfEndpointMessageResult")
  @js.native
