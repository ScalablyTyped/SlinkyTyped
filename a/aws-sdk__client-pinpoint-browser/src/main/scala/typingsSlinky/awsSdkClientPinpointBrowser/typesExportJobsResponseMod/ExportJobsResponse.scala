...
object ExportJobsResponse {
  ...
  implicit class ExportJobsResponseOps[Self <: ExportJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[ExportJobResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
    def setItem(value: js.Array[ExportJobResponse] | js.Iterable[ExportJobResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
