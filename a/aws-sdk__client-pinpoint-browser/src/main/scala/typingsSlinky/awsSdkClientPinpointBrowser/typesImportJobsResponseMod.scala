...
object typesImportJobsResponseMod {
  ...
  object ImportJobsResponse {
    ...
    implicit class ImportJobsResponseMutableBuilder[Self <: ImportJobsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: js.Array[ImportJobResponse] | js.Iterable[ImportJobResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[ImportJobResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
