...
object SegmentDimensions {
  ...
  implicit class SegmentDimensionsOps[Self <: SegmentDimensions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributesIterable(value: js.Iterable[js.Tuple2[String, AttributeDimension]]): Self = this.set("Attributes", value.asInstanceOf[js.Any])
    @scala.inline
    def setAttributes(value: StringDictionary[AttributeDimension] | (js.Iterable[js.Tuple2[String, AttributeDimension]])): Self = this.set("Attributes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMetricsIterable(value: js.Iterable[js.Tuple2[String, MetricDimension]]): Self = this.set("Metrics", value.asInstanceOf[js.Any])
    @scala.inline
    def setMetrics(value: StringDictionary[MetricDimension] | (js.Iterable[js.Tuple2[String, MetricDimension]])): Self = this.set("Metrics", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMetrics: Self = this.set("Metrics", js.undefined)
    @scala.inline
    def setUserAttributesIterable(value: js.Iterable[js.Tuple2[String, AttributeDimension]]): Self = this.set("UserAttributes", value.asInstanceOf[js.Any])
    @scala.inline
    def setUserAttributes(value: StringDictionary[AttributeDimension] | (js.Iterable[js.Tuple2[String, AttributeDimension]])): Self = this.set("UserAttributes", value.asInstanceOf[js.Any])
    @scala.inline
