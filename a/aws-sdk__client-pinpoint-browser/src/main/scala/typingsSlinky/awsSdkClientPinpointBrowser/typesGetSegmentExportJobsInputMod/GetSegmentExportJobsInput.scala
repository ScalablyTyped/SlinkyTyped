package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentExportJobsInputMod
...
object GetSegmentExportJobsInput {
  ...
  @scala.inline
  implicit class GetSegmentExportJobsInputOps[Self <: GetSegmentExportJobsInput] (val x: Self) extends AnyVal {
