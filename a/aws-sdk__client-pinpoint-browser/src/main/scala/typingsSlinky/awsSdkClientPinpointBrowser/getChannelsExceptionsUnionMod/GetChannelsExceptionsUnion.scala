package typingsSlinky.awsSdkClientPinpointBrowser.getChannelsExceptionsUnionMod
...
*/
trait GetChannelsExceptionsUnion extends js.Object

object GetChannelsExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetChannelsExceptionsUnion = value.asInstanceOf[GetChannelsExceptionsUnion]
}
