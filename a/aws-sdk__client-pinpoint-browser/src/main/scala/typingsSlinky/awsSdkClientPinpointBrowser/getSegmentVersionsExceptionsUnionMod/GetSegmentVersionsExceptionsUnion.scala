package typingsSlinky.awsSdkClientPinpointBrowser.getSegmentVersionsExceptionsUnionMod
...
object GetSegmentVersionsExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetSegmentVersionsExceptionsUnion = value.asInstanceOf[GetSegmentVersionsExceptionsUnion]
}
