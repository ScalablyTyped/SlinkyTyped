package typingsSlinky.awsSdkClientPinpointBrowser.typesGetEmailChannelInputMod
...
object GetEmailChannelInput {
  ...
  @scala.inline
  implicit class GetEmailChannelInputOps[Self <: GetEmailChannelInput] (val x: Self) extends AnyVal {
