...
object typesUpdateApplicationSettingsInputMod {
  ...
  trait UpdateApplicationSettingsInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var WriteApplicationSettingsRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesWriteApplicationSettingsRequestMod.WriteApplicationSettingsRequest = js.native
  }
  object UpdateApplicationSettingsInput {
    ...
    @scala.inline
    implicit class UpdateApplicationSettingsInputMutableBuilder[Self <: UpdateApplicationSettingsInput] (val x: Self) extends AnyVal {
