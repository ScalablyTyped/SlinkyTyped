package typingsSlinky.awsSdkClientPinpointBrowser.typesRecencyDimensionMod
...
object RecencyDimension {
  ...
  implicit class RecencyDimensionOps[Self <: RecencyDimension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDuration(value: HR_24 | DAY_7 | DAY_14 | DAY_30 | String): Self = {
    ...
    @scala.inline
    def withRecencyType(value: ACTIVE | INACTIVE | String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RecencyType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRecencyType: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RecencyType")(js.undefined)
        ret
    }
  }
