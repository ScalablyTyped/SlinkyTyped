package typingsSlinky.awsSdkClientPinpointBrowser.typesGetApnsVoipSandboxChannelOutputMod
...
object GetApnsVoipSandboxChannelOutput {
  ...
  @scala.inline
  implicit class GetApnsVoipSandboxChannelOutputOps[Self <: GetApnsVoipSandboxChannelOutput] (val x: Self) extends AnyVal {
    @scala.inline
