package typingsSlinky.awsSdkClientPinpointBrowser.updateGcmChannelExceptionsUnionMod
...
object UpdateGcmChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): UpdateGcmChannelExceptionsUnion = value.asInstanceOf[UpdateGcmChannelExceptionsUnion]
}
