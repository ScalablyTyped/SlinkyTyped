...
object ExportJobResponse {
  ...
  implicit class ExportJobResponseOps[Self <: ExportJobResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFailuresIterable(value: js.Iterable[String]): Self = this.set("Failures", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFailures(value: js.Array[String] | js.Iterable[String]): Self = this.set("Failures", value.asInstanceOf[js.Any])
