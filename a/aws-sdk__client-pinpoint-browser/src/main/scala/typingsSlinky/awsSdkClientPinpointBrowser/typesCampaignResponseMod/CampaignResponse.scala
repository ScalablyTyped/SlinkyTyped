...
trait CampaignResponse extends js.Object {
  ...
  /**
    ...
    */
  var Schedule: js.UndefOr[typingsSlinky.awsSdkClientPinpointBrowser.typesScheduleMod.Schedule] = js.undefined
  /**
...
object CampaignResponse {
  @scala.inline
  def apply(
    AdditionalTreatments: js.Array[TreatmentResource] | js.Iterable[TreatmentResource] = null,
