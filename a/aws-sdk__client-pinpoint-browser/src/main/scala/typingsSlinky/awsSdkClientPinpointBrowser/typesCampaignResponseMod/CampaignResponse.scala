...
object CampaignResponse {
  ...
  implicit class CampaignResponseOps[Self <: CampaignResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdditionalTreatmentsIterable(value: js.Iterable[TreatmentResource]): Self = this.set("AdditionalTreatments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAdditionalTreatments(value: js.Array[TreatmentResource] | js.Iterable[TreatmentResource]): Self = this.set("AdditionalTreatments", value.asInstanceOf[js.Any])
