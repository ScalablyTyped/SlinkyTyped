package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentInputMod
...
object GetSegmentInput {
  ...
  @scala.inline
  implicit class GetSegmentInputOps[Self <: GetSegmentInput] (val x: Self) extends AnyVal {
    @scala.inline
