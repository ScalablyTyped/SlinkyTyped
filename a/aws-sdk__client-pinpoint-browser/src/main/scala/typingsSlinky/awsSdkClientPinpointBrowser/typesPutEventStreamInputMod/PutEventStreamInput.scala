package typingsSlinky.awsSdkClientPinpointBrowser.typesPutEventStreamInputMod
...
trait PutEventStreamInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var WriteEventStream: typingsSlinky.awsSdkClientPinpointBrowser.typesWriteEventStreamMod.WriteEventStream
}
