...
object typesCampaignsResponseMod {
  ...
  object CampaignsResponse {
    ...
    implicit class CampaignsResponseMutableBuilder[Self <: CampaignsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: js.Array[CampaignResponse] | js.Iterable[CampaignResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[CampaignResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
