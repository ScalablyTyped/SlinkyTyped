...
@JSImport("@aws-sdk/client-pinpoint-browser/types/UpdateEndpointsBatchExceptionsUnion", JSImport.Namespace)
@js.native
object updateEndpointsBatchExceptionsUnionMod extends js.Object {
