package typingsSlinky.awsSdkClientPinpointBrowser.typesPutEventsInputMod
...
object PutEventsInput {
  ...
  implicit class PutEventsInputOps[Self <: PutEventsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEventsRequest(value: EventsRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EventsRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
