...
import typingsSlinky.awsSdkClientPinpointBrowser.typesGpspointdimensionMod.GPSPointDimension
import typingsSlinky.awsSdkClientPinpointBrowser.typesSetDimensionMod.SetDimension
