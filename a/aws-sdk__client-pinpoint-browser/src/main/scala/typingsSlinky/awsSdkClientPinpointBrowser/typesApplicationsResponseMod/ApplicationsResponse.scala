...
object ApplicationsResponse {
  ...
  implicit class ApplicationsResponseOps[Self <: ApplicationsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[ApplicationResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
    def setItem(value: js.Array[ApplicationResponse] | js.Iterable[ApplicationResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
