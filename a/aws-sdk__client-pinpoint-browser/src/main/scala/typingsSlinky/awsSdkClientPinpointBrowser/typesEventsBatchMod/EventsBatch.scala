...
object EventsBatch {
  ...
  implicit class EventsBatchOps[Self <: EventsBatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventsIterable(value: js.Iterable[js.Tuple2[String, Event]]): Self = this.set("Events", value.asInstanceOf[js.Any])
    @scala.inline
    def setEvents(value: StringDictionary[Event] | (js.Iterable[js.Tuple2[String, Event]])): Self = this.set("Events", value.asInstanceOf[js.Any])
    @scala.inline
