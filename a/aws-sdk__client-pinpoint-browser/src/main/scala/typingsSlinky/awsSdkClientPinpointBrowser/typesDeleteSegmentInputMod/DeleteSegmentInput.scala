package typingsSlinky.awsSdkClientPinpointBrowser.typesDeleteSegmentInputMod
...
object DeleteSegmentInput {
  ...
  @scala.inline
  implicit class DeleteSegmentInputOps[Self <: DeleteSegmentInput] (val x: Self) extends AnyVal {
    @scala.inline
