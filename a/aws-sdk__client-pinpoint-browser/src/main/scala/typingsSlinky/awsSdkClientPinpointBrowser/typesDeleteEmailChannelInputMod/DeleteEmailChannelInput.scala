package typingsSlinky.awsSdkClientPinpointBrowser.typesDeleteEmailChannelInputMod
...
object DeleteEmailChannelInput {
  ...
  @scala.inline
  implicit class DeleteEmailChannelInputOps[Self <: DeleteEmailChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
