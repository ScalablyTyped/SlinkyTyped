...
object typesEndpointsResponseMod {
  ...
  object EndpointsResponse {
    ...
    implicit class EndpointsResponseMutableBuilder[Self <: EndpointsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: js.Array[EndpointResponse] | js.Iterable[EndpointResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[EndpointResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
