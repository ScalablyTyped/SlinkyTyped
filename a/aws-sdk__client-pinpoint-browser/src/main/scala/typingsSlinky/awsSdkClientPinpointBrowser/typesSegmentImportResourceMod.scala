...
object typesSegmentImportResourceMod {
  ...
  object SegmentImportResource {
    ...
    implicit class SegmentImportResourceMutableBuilder[Self <: SegmentImportResource] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChannelCounts(value: StringDictionary[Double] | (js.Iterable[js.Tuple2[String, Double]])): Self = StObject.set(x, "ChannelCounts", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChannelCountsIterable(value: js.Iterable[js.Tuple2[String, Double]]): Self = StObject.set(x, "ChannelCounts", value.asInstanceOf[js.Any])
