package typingsSlinky.awsSdkClientPinpointBrowser.removeAttributesExceptionsUnionMod
...
object RemoveAttributesExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): RemoveAttributesExceptionsUnion = value.asInstanceOf[RemoveAttributesExceptionsUnion]
}
