package typingsSlinky.awsSdkClientPinpointBrowser.getSmsChannelExceptionsUnionMod
...
*/
trait GetSmsChannelExceptionsUnion extends js.Object

object GetSmsChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetSmsChannelExceptionsUnion = value.asInstanceOf[GetSmsChannelExceptionsUnion]
}
