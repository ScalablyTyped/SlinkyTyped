package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateEndpointInputMod
...
object UpdateEndpointInput {
  ...
  implicit class UpdateEndpointInputOps[Self <: UpdateEndpointInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndpointRequest(value: EndpointRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EndpointRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
