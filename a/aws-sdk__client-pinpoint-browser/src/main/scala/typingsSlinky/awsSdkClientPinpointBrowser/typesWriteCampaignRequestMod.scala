...
import typingsSlinky.awsSdkClientPinpointBrowser.typesWriteTreatmentResourceMod.WriteTreatmentResource
...
object typesWriteCampaignRequestMod {
  ...
  trait WriteCampaignRequest extends StObject {
    ...
    /**
      * Treatments that are defined in addition to the default treatment.
      */
    var AdditionalTreatments: js.UndefOr[js.Array[WriteTreatmentResource] | js.Iterable[WriteTreatmentResource]] = js.native
  ...
  object WriteCampaignRequest {
    ...
    implicit class WriteCampaignRequestMutableBuilder[Self <: WriteCampaignRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdditionalTreatments(value: js.Array[WriteTreatmentResource] | js.Iterable[WriteTreatmentResource]): Self = StObject.set(x, "AdditionalTreatments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdditionalTreatmentsIterable(value: js.Iterable[WriteTreatmentResource]): Self = StObject.set(x, "AdditionalTreatments", value.asInstanceOf[js.Any])
