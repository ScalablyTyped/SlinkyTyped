package typingsSlinky.awsSdkClientPinpointBrowser.getEmailChannelExceptionsUnionMod
...
*/
trait GetEmailChannelExceptionsUnion extends js.Object

object GetEmailChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetEmailChannelExceptionsUnion = value.asInstanceOf[GetEmailChannelExceptionsUnion]
}
