package typingsSlinky.awsSdkClientPinpointBrowser.typesGetApplicationSettingsInputMod
...
object GetApplicationSettingsInput {
  ...
  @scala.inline
  implicit class GetApplicationSettingsInputOps[Self <: GetApplicationSettingsInput] (val x: Self) extends AnyVal {
