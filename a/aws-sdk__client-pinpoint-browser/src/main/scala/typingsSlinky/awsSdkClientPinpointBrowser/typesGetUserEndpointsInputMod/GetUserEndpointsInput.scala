package typingsSlinky.awsSdkClientPinpointBrowser.typesGetUserEndpointsInputMod
...
@js.native
trait GetUserEndpointsInput extends InputTypesUnion {
...
object GetUserEndpointsInput {
  ...
  @scala.inline
  implicit class GetUserEndpointsInputOps[Self <: GetUserEndpointsInput] (val x: Self) extends AnyVal {
