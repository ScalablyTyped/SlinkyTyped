...
object UpdateAttributesRequest {
  ...
  implicit class UpdateAttributesRequestOps[Self <: UpdateAttributesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBlacklistIterable(value: js.Iterable[String]): Self = this.set("Blacklist", value.asInstanceOf[js.Any])
    @scala.inline
    def setBlacklist(value: js.Array[String] | js.Iterable[String]): Self = this.set("Blacklist", value.asInstanceOf[js.Any])
    @scala.inline
