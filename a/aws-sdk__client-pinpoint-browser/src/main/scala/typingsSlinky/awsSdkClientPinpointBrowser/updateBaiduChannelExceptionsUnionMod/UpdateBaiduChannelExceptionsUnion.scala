package typingsSlinky.awsSdkClientPinpointBrowser.updateBaiduChannelExceptionsUnionMod
...
*/
trait UpdateBaiduChannelExceptionsUnion extends js.Object

object UpdateBaiduChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): UpdateBaiduChannelExceptionsUnion = value.asInstanceOf[UpdateBaiduChannelExceptionsUnion]
}
