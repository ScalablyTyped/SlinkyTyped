...
@JSImport("@aws-sdk/client-pinpoint-browser/types/CreateExportJobExceptionsUnion", JSImport.Namespace)
@js.native
object createExportJobExceptionsUnionMod extends js.Object {
