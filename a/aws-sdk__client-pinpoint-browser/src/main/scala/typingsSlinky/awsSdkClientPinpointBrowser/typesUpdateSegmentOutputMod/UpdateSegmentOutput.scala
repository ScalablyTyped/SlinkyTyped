package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateSegmentOutputMod
...
object UpdateSegmentOutput {
  ...
  @scala.inline
  implicit class UpdateSegmentOutputOps[Self <: UpdateSegmentOutput] (val x: Self) extends AnyVal {
    @scala.inline
