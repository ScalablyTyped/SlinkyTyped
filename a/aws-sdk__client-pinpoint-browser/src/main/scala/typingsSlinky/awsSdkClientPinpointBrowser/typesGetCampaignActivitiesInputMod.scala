...
object typesGetCampaignActivitiesInputMod {
  ...
  object GetCampaignActivitiesInput {
    ...
    @scala.inline
    implicit class GetCampaignActivitiesInputMutableBuilder[Self <: GetCampaignActivitiesInput] (val x: Self) extends AnyVal {
