...
object SegmentsResponse {
  ...
  implicit class SegmentsResponseOps[Self <: SegmentsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[SegmentResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
    def setItem(value: js.Array[SegmentResponse] | js.Iterable[SegmentResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
