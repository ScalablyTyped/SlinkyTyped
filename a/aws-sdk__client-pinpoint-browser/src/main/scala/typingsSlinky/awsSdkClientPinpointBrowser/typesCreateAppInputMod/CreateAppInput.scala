package typingsSlinky.awsSdkClientPinpointBrowser.typesCreateAppInputMod
...
trait CreateAppInput extends InputTypesUnion {
  ...
  /**
    * Application Request.
    */
  var CreateApplicationRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesCreateApplicationRequestMod.CreateApplicationRequest = js.native
}
object CreateAppInput {
  ...
  @scala.inline
  implicit class CreateAppInputOps[Self <: CreateAppInput] (val x: Self) extends AnyVal {
