...
import typingsSlinky.awsSdkClientPinpointBrowser.typesSegmentReferenceMod.SegmentReference
...
object typesSegmentGroupMod {
  ...
  object SegmentGroup {
    ...
    implicit class SegmentGroupMutableBuilder[Self <: SegmentGroup] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDimensions(value: js.Array[SegmentDimensions] | js.Iterable[SegmentDimensions]): Self = StObject.set(x, "Dimensions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDimensionsIterable(value: js.Iterable[SegmentDimensions]): Self = StObject.set(x, "Dimensions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSourceSegments(value: js.Array[SegmentReference] | js.Iterable[SegmentReference]): Self = StObject.set(x, "SourceSegments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSourceSegmentsIterable(value: js.Iterable[SegmentReference]): Self = StObject.set(x, "SourceSegments", value.asInstanceOf[js.Any])
