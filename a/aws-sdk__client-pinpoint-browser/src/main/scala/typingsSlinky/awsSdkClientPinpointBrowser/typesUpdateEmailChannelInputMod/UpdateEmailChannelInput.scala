package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateEmailChannelInputMod
...
trait UpdateEmailChannelInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var EmailChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesEmailChannelRequestMod.EmailChannelRequest = js.native
}
...
object UpdateEmailChannelInput {
  ...
  @scala.inline
  implicit class UpdateEmailChannelInputOps[Self <: UpdateEmailChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
