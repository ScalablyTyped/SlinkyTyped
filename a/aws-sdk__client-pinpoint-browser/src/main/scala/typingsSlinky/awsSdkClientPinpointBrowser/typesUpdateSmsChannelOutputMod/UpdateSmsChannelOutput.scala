package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateSmsChannelOutputMod
...
object UpdateSmsChannelOutput {
  ...
  @scala.inline
  implicit class UpdateSmsChannelOutputOps[Self <: UpdateSmsChannelOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSMSChannelResponse(value: UnmarshalledSMSChannelResponse): Self = this.set("SMSChannelResponse", value.asInstanceOf[js.Any])
  }
}
