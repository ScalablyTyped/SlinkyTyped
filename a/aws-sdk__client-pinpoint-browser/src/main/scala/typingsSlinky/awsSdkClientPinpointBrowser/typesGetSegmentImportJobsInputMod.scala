...
object typesGetSegmentImportJobsInputMod {
  ...
  object GetSegmentImportJobsInput {
    ...
    @scala.inline
    implicit class GetSegmentImportJobsInputMutableBuilder[Self <: GetSegmentImportJobsInput] (val x: Self) extends AnyVal {
