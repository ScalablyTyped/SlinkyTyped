package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateApnsChannelInputMod
...
trait UpdateApnsChannelInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var APNSChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesApnschannelrequestMod.APNSChannelRequest = js.native
  /**
...
object UpdateApnsChannelInput {
  ...
  @scala.inline
  implicit class UpdateApnsChannelInputOps[Self <: UpdateApnsChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
