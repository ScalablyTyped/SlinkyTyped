...
object ImportJobsResponse {
  ...
  implicit class ImportJobsResponseOps[Self <: ImportJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[ImportJobResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItem(value: js.Array[ImportJobResponse] | js.Iterable[ImportJobResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
