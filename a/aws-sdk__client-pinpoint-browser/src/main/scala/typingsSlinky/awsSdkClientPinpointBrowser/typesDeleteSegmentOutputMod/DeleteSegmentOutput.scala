package typingsSlinky.awsSdkClientPinpointBrowser.typesDeleteSegmentOutputMod
...
object DeleteSegmentOutput {
  ...
  @scala.inline
  implicit class DeleteSegmentOutputOps[Self <: DeleteSegmentOutput] (val x: Self) extends AnyVal {
    @scala.inline
