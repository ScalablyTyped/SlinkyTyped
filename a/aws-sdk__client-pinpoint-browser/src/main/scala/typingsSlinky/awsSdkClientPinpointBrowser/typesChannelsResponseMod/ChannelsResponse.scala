...
object ChannelsResponse {
  ...
  implicit class ChannelsResponseOps[Self <: ChannelsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannelsIterable(value: js.Iterable[js.Tuple2[String, ChannelResponse]]): Self = this.set("Channels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setChannels(value: StringDictionary[ChannelResponse] | (js.Iterable[js.Tuple2[String, ChannelResponse]])): Self = this.set("Channels", value.asInstanceOf[js.Any])
