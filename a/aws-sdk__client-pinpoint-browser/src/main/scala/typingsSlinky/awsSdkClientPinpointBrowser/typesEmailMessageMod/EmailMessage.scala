...
object EmailMessage {
  ...
  implicit class EmailMessageOps[Self <: EmailMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplyToAddressesIterable(value: js.Iterable[String]): Self = this.set("ReplyToAddresses", value.asInstanceOf[js.Any])
    @scala.inline
    def setReplyToAddresses(value: js.Array[String] | js.Iterable[String]): Self = this.set("ReplyToAddresses", value.asInstanceOf[js.Any])
    @scala.inline
