...
object BaiduMessage {
  ...
  implicit class BaiduMessageOps[Self <: BaiduMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("Data", value.asInstanceOf[js.Any])
    @scala.inline
    def setData(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("Data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSubstitutionsIterable(value: js.Iterable[js.Tuple2[String, js.Array[String] | js.Iterable[String]]]): Self = this.set("Substitutions", value.asInstanceOf[js.Any])
    @scala.inline
