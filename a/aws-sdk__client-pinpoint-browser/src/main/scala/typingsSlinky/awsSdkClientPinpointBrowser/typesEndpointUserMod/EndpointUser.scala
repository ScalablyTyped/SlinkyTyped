...
object EndpointUser {
  ...
  implicit class EndpointUserOps[Self <: EndpointUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUserAttributesIterable(value: js.Iterable[js.Tuple2[String, js.Array[String] | js.Iterable[String]]]): Self = this.set("UserAttributes", value.asInstanceOf[js.Any])
    @scala.inline
