package typingsSlinky.awsSdkClientPinpointBrowser.typesGetApnsVoipChannelInputMod
...
@js.native
trait GetApnsVoipChannelInput extends InputTypesUnion {
...
object GetApnsVoipChannelInput {
  ...
  @scala.inline
  implicit class GetApnsVoipChannelInputOps[Self <: GetApnsVoipChannelInput] (val x: Self) extends AnyVal {
