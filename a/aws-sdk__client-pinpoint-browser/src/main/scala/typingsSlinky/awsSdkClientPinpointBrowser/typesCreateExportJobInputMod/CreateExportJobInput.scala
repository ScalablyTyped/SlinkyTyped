package typingsSlinky.awsSdkClientPinpointBrowser.typesCreateExportJobInputMod
...
trait CreateExportJobInput extends InputTypesUnion {
  ...
  /**
    * Export job request.
    */
  var ExportJobRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesExportJobRequestMod.ExportJobRequest = js.native
}
