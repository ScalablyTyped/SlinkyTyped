...
object EndpointBatchRequest {
  ...
  implicit class EndpointBatchRequestOps[Self <: EndpointBatchRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[EndpointBatchItem]): Self = this.set("Item", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItem(value: js.Array[EndpointBatchItem] | js.Iterable[EndpointBatchItem]): Self = this.set("Item", value.asInstanceOf[js.Any])
