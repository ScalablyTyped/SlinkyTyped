package typingsSlinky.awsSdkClientPinpointBrowser.typesGetEventStreamInputMod
...
object GetEventStreamInput {
  ...
  @scala.inline
  implicit class GetEventStreamInputOps[Self <: GetEventStreamInput] (val x: Self) extends AnyVal {
    @scala.inline
