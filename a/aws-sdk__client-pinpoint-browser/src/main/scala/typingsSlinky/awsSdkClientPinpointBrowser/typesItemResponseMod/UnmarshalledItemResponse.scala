...
object UnmarshalledItemResponse {
  ...
  implicit class UnmarshalledItemResponseOps[Self <: UnmarshalledItemResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndpointItemResponse(value: UnmarshalledEndpointItemResponse): Self = {
    ...
    @scala.inline
    def withEventsItemResponse(value: StringDictionary[UnmarshalledEventItemResponse]): Self = {
        val ret = this.duplicate
