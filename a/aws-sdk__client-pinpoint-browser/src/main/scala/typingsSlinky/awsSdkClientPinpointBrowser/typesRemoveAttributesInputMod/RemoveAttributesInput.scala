package typingsSlinky.awsSdkClientPinpointBrowser.typesRemoveAttributesInputMod
...
trait RemoveAttributesInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var UpdateAttributesRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateAttributesRequestMod.UpdateAttributesRequest = js.native
}
...
object RemoveAttributesInput {
  ...
  implicit class RemoveAttributesInputOps[Self <: RemoveAttributesInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdateAttributesRequest(value: UpdateAttributesRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UpdateAttributesRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
