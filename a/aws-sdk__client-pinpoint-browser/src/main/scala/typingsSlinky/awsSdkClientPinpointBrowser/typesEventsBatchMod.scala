...
object typesEventsBatchMod {
  ...
  object EventsBatch {
    ...
    implicit class EventsBatchMutableBuilder[Self <: EventsBatch] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEvents(value: StringDictionary[Event] | (js.Iterable[js.Tuple2[String, Event]])): Self = StObject.set(x, "Events", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEventsIterable(value: js.Iterable[js.Tuple2[String, Event]]): Self = StObject.set(x, "Events", value.asInstanceOf[js.Any])
