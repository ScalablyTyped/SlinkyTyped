package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateSmsChannelInputMod
...
trait UpdateSmsChannelInput extends InputTypesUnion {
  ...
  /**
    * SMS Channel Request
    */
  var SMSChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesSmschannelrequestMod.SMSChannelRequest = js.native
}
