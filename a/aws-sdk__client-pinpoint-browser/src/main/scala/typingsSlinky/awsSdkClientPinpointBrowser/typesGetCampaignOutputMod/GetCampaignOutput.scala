package typingsSlinky.awsSdkClientPinpointBrowser.typesGetCampaignOutputMod
...
object GetCampaignOutput {
  ...
  @scala.inline
  implicit class GetCampaignOutputOps[Self <: GetCampaignOutput] (val x: Self) extends AnyVal {
