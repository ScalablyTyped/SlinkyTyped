...
object SegmentGroup {
  ...
  implicit class SegmentGroupOps[Self <: SegmentGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDimensionsIterable(value: js.Iterable[SegmentDimensions]): Self = this.set("Dimensions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDimensions(value: js.Array[SegmentDimensions] | js.Iterable[SegmentDimensions]): Self = this.set("Dimensions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceSegmentsIterable(value: js.Iterable[SegmentReference]): Self = this.set("SourceSegments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSourceSegments(value: js.Array[SegmentReference] | js.Iterable[SegmentReference]): Self = this.set("SourceSegments", value.asInstanceOf[js.Any])
