package typingsSlinky.awsSdkClientPinpointBrowser.typesGetCampaignActivitiesInputMod
...
object GetCampaignActivitiesInput {
  ...
  @scala.inline
  implicit class GetCampaignActivitiesInputOps[Self <: GetCampaignActivitiesInput] (val x: Self) extends AnyVal {
