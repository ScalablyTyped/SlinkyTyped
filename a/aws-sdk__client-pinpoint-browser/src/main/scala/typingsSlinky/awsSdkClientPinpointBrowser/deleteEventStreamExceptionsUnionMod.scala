...
@JSImport("@aws-sdk/client-pinpoint-browser/types/DeleteEventStreamExceptionsUnion", JSImport.Namespace)
@js.native
object deleteEventStreamExceptionsUnionMod extends js.Object {
