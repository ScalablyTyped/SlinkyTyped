...
object typesMessageRequestMod {
  ...
  object MessageRequest {
    ...
    implicit class MessageRequestMutableBuilder[Self <: MessageRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddressesIterable(value: js.Iterable[js.Tuple2[String, AddressConfiguration]]): Self = StObject.set(x, "Addresses", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEndpointsIterable(value: js.Iterable[js.Tuple2[String, EndpointSendConfiguration]]): Self = StObject.set(x, "Endpoints", value.asInstanceOf[js.Any])
