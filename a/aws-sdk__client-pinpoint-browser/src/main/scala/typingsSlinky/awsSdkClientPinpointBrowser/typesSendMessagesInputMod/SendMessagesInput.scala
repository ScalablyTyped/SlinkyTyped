package typingsSlinky.awsSdkClientPinpointBrowser.typesSendMessagesInputMod
...
trait SendMessagesInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var MessageRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesMessageRequestMod.MessageRequest = js.native
}
...
object SendMessagesInput {
  ...
  @scala.inline
  implicit class SendMessagesInputOps[Self <: SendMessagesInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withMessageRequest(value: MessageRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MessageRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
