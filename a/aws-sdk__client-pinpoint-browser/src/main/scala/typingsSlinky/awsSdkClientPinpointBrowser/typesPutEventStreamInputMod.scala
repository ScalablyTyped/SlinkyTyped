...
object typesPutEventStreamInputMod {
  ...
  trait PutEventStreamInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var WriteEventStream: typingsSlinky.awsSdkClientPinpointBrowser.typesWriteEventStreamMod.WriteEventStream = js.native
  }
  object PutEventStreamInput {
    ...
    @scala.inline
    implicit class PutEventStreamInputMutableBuilder[Self <: PutEventStreamInput] (val x: Self) extends AnyVal {
