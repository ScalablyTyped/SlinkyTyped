...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetSmsChannelExceptionsUnion", JSImport.Namespace)
@js.native
object getSmsChannelExceptionsUnionMod extends js.Object {
