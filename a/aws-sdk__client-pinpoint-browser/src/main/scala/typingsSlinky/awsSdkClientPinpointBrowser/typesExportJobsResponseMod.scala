...
object typesExportJobsResponseMod {
  ...
  object ExportJobsResponse {
    ...
    implicit class ExportJobsResponseMutableBuilder[Self <: ExportJobsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: js.Array[ExportJobResponse] | js.Iterable[ExportJobResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[ExportJobResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
