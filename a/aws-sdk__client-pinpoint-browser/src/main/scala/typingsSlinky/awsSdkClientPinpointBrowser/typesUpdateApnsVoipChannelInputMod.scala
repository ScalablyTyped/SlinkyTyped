...
object typesUpdateApnsVoipChannelInputMod {
  ...
  trait UpdateApnsVoipChannelInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var APNSVoipChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesApnsvoipchannelrequestMod.APNSVoipChannelRequest = js.native
  ...
  object UpdateApnsVoipChannelInput {
    ...
    @scala.inline
    def apply(APNSVoipChannelRequest: APNSVoipChannelRequest, ApplicationId: String): UpdateApnsVoipChannelInput = {
    ...
    @scala.inline
    implicit class UpdateApnsVoipChannelInputMutableBuilder[Self <: UpdateApnsVoipChannelInput] (val x: Self) extends AnyVal {
