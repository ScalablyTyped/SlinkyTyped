...
@JSImport("@aws-sdk/client-pinpoint-browser/types/DeleteCampaignExceptionsUnion", JSImport.Namespace)
@js.native
object deleteCampaignExceptionsUnionMod extends js.Object {
