package typingsSlinky.awsSdkClientPinpointBrowser.updateCampaignExceptionsUnionMod
...
object UpdateCampaignExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): UpdateCampaignExceptionsUnion = value.asInstanceOf[UpdateCampaignExceptionsUnion]
}
