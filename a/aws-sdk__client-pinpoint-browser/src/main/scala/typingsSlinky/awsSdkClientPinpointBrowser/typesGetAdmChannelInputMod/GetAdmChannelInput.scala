package typingsSlinky.awsSdkClientPinpointBrowser.typesGetAdmChannelInputMod
...
@js.native
trait GetAdmChannelInput extends InputTypesUnion {
  /**
...
object GetAdmChannelInput {
  ...
  @scala.inline
  implicit class GetAdmChannelInputOps[Self <: GetAdmChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
