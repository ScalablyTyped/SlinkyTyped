package typingsSlinky.awsSdkClientPinpointBrowser.getSegmentVersionExceptionsUnionMod
...
object GetSegmentVersionExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetSegmentVersionExceptionsUnion = value.asInstanceOf[GetSegmentVersionExceptionsUnion]
}
