...
object typesEndpointUserMod {
  ...
  object EndpointUser {
    ...
    implicit class EndpointUserMutableBuilder[Self <: EndpointUser] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUserAttributesIterable(value: js.Iterable[js.Tuple2[String, js.Array[String] | js.Iterable[String]]]): Self = StObject.set(x, "UserAttributes", value.asInstanceOf[js.Any])
