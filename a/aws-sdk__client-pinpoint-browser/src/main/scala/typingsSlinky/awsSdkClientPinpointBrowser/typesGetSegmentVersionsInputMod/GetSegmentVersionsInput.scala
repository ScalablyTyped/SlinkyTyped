package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentVersionsInputMod
...
object GetSegmentVersionsInput {
  ...
  @scala.inline
  def apply(ApplicationId: String, SegmentId: String): GetSegmentVersionsInput = {
  ...
  @scala.inline
  implicit class GetSegmentVersionsInputOps[Self <: GetSegmentVersionsInput] (val x: Self) extends AnyVal {
