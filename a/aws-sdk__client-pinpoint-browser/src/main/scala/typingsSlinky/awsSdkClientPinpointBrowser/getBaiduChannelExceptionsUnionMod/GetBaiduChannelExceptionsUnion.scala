package typingsSlinky.awsSdkClientPinpointBrowser.getBaiduChannelExceptionsUnionMod
...
*/
trait GetBaiduChannelExceptionsUnion extends js.Object

object GetBaiduChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetBaiduChannelExceptionsUnion = value.asInstanceOf[GetBaiduChannelExceptionsUnion]
}
