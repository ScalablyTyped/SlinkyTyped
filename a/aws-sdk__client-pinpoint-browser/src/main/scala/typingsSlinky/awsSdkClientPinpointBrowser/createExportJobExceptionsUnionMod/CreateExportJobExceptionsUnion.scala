package typingsSlinky.awsSdkClientPinpointBrowser.createExportJobExceptionsUnionMod
...
object CreateExportJobExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): CreateExportJobExceptionsUnion = value.asInstanceOf[CreateExportJobExceptionsUnion]
}
