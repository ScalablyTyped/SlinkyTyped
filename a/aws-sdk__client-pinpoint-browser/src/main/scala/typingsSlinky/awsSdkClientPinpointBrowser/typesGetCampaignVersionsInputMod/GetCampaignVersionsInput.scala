package typingsSlinky.awsSdkClientPinpointBrowser.typesGetCampaignVersionsInputMod
...
@js.native
trait GetCampaignVersionsInput extends InputTypesUnion {
  /**
...
object GetCampaignVersionsInput {
  @scala.inline
  def apply(ApplicationId: String, CampaignId: String): GetCampaignVersionsInput = {
  ...
  @scala.inline
  implicit class GetCampaignVersionsInputOps[Self <: GetCampaignVersionsInput] (val x: Self) extends AnyVal {
    @scala.inline
