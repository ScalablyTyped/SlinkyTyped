...
object typesApplicationsResponseMod {
  ...
  object ApplicationsResponse {
    ...
    implicit class ApplicationsResponseMutableBuilder[Self <: ApplicationsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: js.Array[ApplicationResponse] | js.Iterable[ApplicationResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[ApplicationResponse]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
