package typingsSlinky.awsSdkClientPinpointBrowser.getExportJobExceptionsUnionMod
...
*/
trait GetExportJobExceptionsUnion extends js.Object

object GetExportJobExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetExportJobExceptionsUnion = value.asInstanceOf[GetExportJobExceptionsUnion]
}
