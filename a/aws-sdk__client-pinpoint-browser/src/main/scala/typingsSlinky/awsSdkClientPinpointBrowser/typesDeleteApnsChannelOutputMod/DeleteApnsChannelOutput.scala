package typingsSlinky.awsSdkClientPinpointBrowser.typesDeleteApnsChannelOutputMod
...
object DeleteApnsChannelOutput {
  ...
  implicit class DeleteApnsChannelOutputOps[Self <: DeleteApnsChannelOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAPNSChannelResponse(value: UnmarshalledAPNSChannelResponse): Self = {
        val ret = this.duplicate
