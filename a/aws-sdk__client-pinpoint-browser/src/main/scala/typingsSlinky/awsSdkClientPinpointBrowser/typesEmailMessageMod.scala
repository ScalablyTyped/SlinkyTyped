...
object typesEmailMessageMod {
  ...
  object EmailMessage {
    ...
    implicit class EmailMessageMutableBuilder[Self <: EmailMessage] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReplyToAddresses(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "ReplyToAddresses", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReplyToAddressesIterable(value: js.Iterable[String]): Self = StObject.set(x, "ReplyToAddresses", value.asInstanceOf[js.Any])
