...
object MessageResponse {
  ...
  implicit class MessageResponseOps[Self <: MessageResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndpointResultIterable(value: js.Iterable[js.Tuple2[String, EndpointMessageResult]]): Self = this.set("EndpointResult", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResultIterable(value: js.Iterable[js.Tuple2[String, MessageResult]]): Self = this.set("Result", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResult(value: StringDictionary[MessageResult] | (js.Iterable[js.Tuple2[String, MessageResult]])): Self = this.set("Result", value.asInstanceOf[js.Any])
