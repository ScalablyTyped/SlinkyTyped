...
object MessageResponse {
  ...
  def apply(
    ...
    EndpointResult: StringDictionary[EndpointMessageResult] | (js.Iterable[js.Tuple2[String, EndpointMessageResult]]) = null,
    RequestId: String = null,
    Result: StringDictionary[MessageResult] | (js.Iterable[js.Tuple2[String, MessageResult]]) = null
  ): MessageResponse = {
