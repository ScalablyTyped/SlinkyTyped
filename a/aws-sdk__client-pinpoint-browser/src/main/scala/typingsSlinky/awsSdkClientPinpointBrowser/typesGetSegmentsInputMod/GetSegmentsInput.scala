package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentsInputMod
...
object GetSegmentsInput {
  ...
  @scala.inline
  def apply(ApplicationId: String): GetSegmentsInput = {
    val __obj = js.Dynamic.literal(ApplicationId = ApplicationId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetSegmentsInput]
  }
  
  @scala.inline
  implicit class GetSegmentsInputOps[Self <: GetSegmentsInput] (val x: Self) extends AnyVal {
