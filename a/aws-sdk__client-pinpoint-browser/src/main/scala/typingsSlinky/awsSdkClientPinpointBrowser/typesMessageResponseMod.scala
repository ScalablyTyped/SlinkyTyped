...
object typesMessageResponseMod {
  ...
  object MessageResponse {
    ...
    implicit class MessageResponseMutableBuilder[Self <: MessageResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndpointResultIterable(value: js.Iterable[js.Tuple2[String, EndpointMessageResult]]): Self = StObject.set(x, "EndpointResult", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setResult(value: StringDictionary[MessageResult] | (js.Iterable[js.Tuple2[String, MessageResult]])): Self = StObject.set(x, "Result", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResultIterable(value: js.Iterable[js.Tuple2[String, MessageResult]]): Self = StObject.set(x, "Result", value.asInstanceOf[js.Any])
