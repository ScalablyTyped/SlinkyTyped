package typingsSlinky.awsSdkClientPinpointBrowser.typesGetBaiduChannelInputMod
...
object GetBaiduChannelInput {
  ...
  @scala.inline
  implicit class GetBaiduChannelInputOps[Self <: GetBaiduChannelInput] (val x: Self) extends AnyVal {
