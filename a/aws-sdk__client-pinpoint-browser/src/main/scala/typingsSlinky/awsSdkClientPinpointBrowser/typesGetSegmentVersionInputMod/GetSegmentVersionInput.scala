package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSegmentVersionInputMod
...
@js.native
trait GetSegmentVersionInput extends InputTypesUnion {
  /**
...
object GetSegmentVersionInput {
  ...
  @scala.inline
  implicit class GetSegmentVersionInputOps[Self <: GetSegmentVersionInput] (val x: Self) extends AnyVal {
    @scala.inline
