...
object typesEventsResponseMod {
  ...
  object EventsResponse {
    ...
    implicit class EventsResponseMutableBuilder[Self <: EventsResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setResults(value: StringDictionary[ItemResponse] | (js.Iterable[js.Tuple2[String, ItemResponse]])): Self = StObject.set(x, "Results", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setResultsIterable(value: js.Iterable[js.Tuple2[String, ItemResponse]]): Self = StObject.set(x, "Results", value.asInstanceOf[js.Any])
