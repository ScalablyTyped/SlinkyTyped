...
object AttributesResource {
  ...
  implicit class AttributesResourceOps[Self <: AttributesResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributesIterable(value: js.Iterable[String]): Self = this.set("Attributes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAttributes(value: js.Array[String] | js.Iterable[String]): Self = this.set("Attributes", value.asInstanceOf[js.Any])
