...
object EndpointsResponse {
  ...
  implicit class EndpointsResponseOps[Self <: EndpointsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[EndpointResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
    def setItem(value: js.Array[EndpointResponse] | js.Iterable[EndpointResponse]): Self = this.set("Item", value.asInstanceOf[js.Any])
    @scala.inline
