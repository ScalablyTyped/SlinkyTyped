package typingsSlinky.awsSdkClientPinpointBrowser.deleteEmailChannelExceptionsUnionMod
...
object DeleteEmailChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DeleteEmailChannelExceptionsUnion = value.asInstanceOf[DeleteEmailChannelExceptionsUnion]
}
