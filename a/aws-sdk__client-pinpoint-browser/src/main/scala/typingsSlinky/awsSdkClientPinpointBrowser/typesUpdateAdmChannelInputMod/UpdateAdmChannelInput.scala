package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateAdmChannelInputMod
...
trait UpdateAdmChannelInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var ADMChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesAdmchannelrequestMod.ADMChannelRequest = js.native
  /**
...
object UpdateAdmChannelInput {
  ...
  @scala.inline
  implicit class UpdateAdmChannelInputOps[Self <: UpdateAdmChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
