...
object EventsRequest {
  ...
  implicit class EventsRequestOps[Self <: EventsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBatchItemIterable(value: js.Iterable[js.Tuple2[String, EventsBatch]]): Self = this.set("BatchItem", value.asInstanceOf[js.Any])
    @scala.inline
    def setBatchItem(value: StringDictionary[EventsBatch] | (js.Iterable[js.Tuple2[String, EventsBatch]])): Self = this.set("BatchItem", value.asInstanceOf[js.Any])
    @scala.inline
