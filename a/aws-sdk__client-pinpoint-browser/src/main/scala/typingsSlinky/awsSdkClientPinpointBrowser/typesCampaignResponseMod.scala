...
object typesCampaignResponseMod {
  ...
  object CampaignResponse {
    ...
    implicit class CampaignResponseMutableBuilder[Self <: CampaignResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdditionalTreatments(value: js.Array[TreatmentResource] | js.Iterable[TreatmentResource]): Self = StObject.set(x, "AdditionalTreatments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAdditionalTreatmentsIterable(value: js.Iterable[TreatmentResource]): Self = StObject.set(x, "AdditionalTreatments", value.asInstanceOf[js.Any])
