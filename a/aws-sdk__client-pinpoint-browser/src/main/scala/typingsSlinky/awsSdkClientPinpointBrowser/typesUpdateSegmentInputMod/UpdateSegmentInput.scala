package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateSegmentInputMod
...
trait UpdateSegmentInput extends InputTypesUnion {
  ...
  /**
    * Segment definition.
    */
  var WriteSegmentRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesWriteSegmentRequestMod.WriteSegmentRequest = js.native
}
...
object UpdateSegmentInput {
  ...
  @scala.inline
  implicit class UpdateSegmentInputOps[Self <: UpdateSegmentInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWriteSegmentRequest(value: WriteSegmentRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("WriteSegmentRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
