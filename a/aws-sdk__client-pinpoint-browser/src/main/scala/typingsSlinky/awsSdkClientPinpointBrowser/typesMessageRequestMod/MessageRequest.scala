...
object MessageRequest {
  @scala.inline
  def apply(
    Addresses: StringDictionary[AddressConfiguration] | (js.Iterable[js.Tuple2[String, AddressConfiguration]]) = null,
    Context: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]) = null,
    Endpoints: StringDictionary[EndpointSendConfiguration] | (js.Iterable[js.Tuple2[String, EndpointSendConfiguration]]) = null,
