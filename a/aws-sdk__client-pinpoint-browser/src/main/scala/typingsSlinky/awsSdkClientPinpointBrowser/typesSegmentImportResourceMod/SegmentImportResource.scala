...
object SegmentImportResource {
  ...
  implicit class SegmentImportResourceOps[Self <: SegmentImportResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannelCountsIterable(value: js.Iterable[js.Tuple2[String, Double]]): Self = this.set("ChannelCounts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setChannelCounts(value: StringDictionary[Double] | (js.Iterable[js.Tuple2[String, Double]])): Self = this.set("ChannelCounts", value.asInstanceOf[js.Any])
