package typingsSlinky.awsSdkClientPinpointBrowser.getCampaignActivitiesExceptionsUnionMod
...
object GetCampaignActivitiesExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetCampaignActivitiesExceptionsUnion = value.asInstanceOf[GetCampaignActivitiesExceptionsUnion]
}
