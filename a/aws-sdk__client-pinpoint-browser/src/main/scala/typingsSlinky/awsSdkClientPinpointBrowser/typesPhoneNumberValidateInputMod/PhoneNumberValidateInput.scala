package typingsSlinky.awsSdkClientPinpointBrowser.typesPhoneNumberValidateInputMod
...
@js.native
trait PhoneNumberValidateInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var NumberValidateRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesNumberValidateRequestMod.NumberValidateRequest = js.native
}
...
object PhoneNumberValidateInput {
  ...
  @scala.inline
  implicit class PhoneNumberValidateInputOps[Self <: PhoneNumberValidateInput] (val x: Self) extends AnyVal {
    @scala.inline
