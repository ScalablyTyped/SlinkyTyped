package typingsSlinky.awsSdkClientPinpointBrowser.typesDeleteEventStreamInputMod
...
object DeleteEventStreamInput {
  ...
  @scala.inline
  implicit class DeleteEventStreamInputOps[Self <: DeleteEventStreamInput] (val x: Self) extends AnyVal {
    @scala.inline
