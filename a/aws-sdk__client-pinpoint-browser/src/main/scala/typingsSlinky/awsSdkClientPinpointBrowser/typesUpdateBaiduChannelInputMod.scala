...
object typesUpdateBaiduChannelInputMod {
  ...
  trait UpdateBaiduChannelInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var BaiduChannelRequest: typingsSlinky.awsSdkClientPinpointBrowser.typesBaiduChannelRequestMod.BaiduChannelRequest = js.native
  }
  object UpdateBaiduChannelInput {
    ...
    @scala.inline
    implicit class UpdateBaiduChannelInputMutableBuilder[Self <: UpdateBaiduChannelInput] (val x: Self) extends AnyVal {
