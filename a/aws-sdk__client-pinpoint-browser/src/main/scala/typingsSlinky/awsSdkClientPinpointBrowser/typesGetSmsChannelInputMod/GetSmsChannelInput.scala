package typingsSlinky.awsSdkClientPinpointBrowser.typesGetSmsChannelInputMod
...
object GetSmsChannelInput {
  ...
  @scala.inline
  implicit class GetSmsChannelInputOps[Self <: GetSmsChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
