package typingsSlinky.awsSdkClientPinpointBrowser.createImportJobExceptionsUnionMod
...
*/
trait CreateImportJobExceptionsUnion extends js.Object

object CreateImportJobExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): CreateImportJobExceptionsUnion = value.asInstanceOf[CreateImportJobExceptionsUnion]
}
