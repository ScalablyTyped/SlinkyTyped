package typingsSlinky.awsSdkClientPinpointBrowser.typesGetImportJobsInputMod
...
@js.native
trait GetImportJobsInput extends InputTypesUnion {
  /**
...
object GetImportJobsInput {
  ...
  @scala.inline
  implicit class GetImportJobsInputOps[Self <: GetImportJobsInput] (val x: Self) extends AnyVal {
    @scala.inline
