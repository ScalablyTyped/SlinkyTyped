package typingsSlinky.awsSdkClientPinpointBrowser.typesUpdateEndpointsBatchOutputMod
...
object UpdateEndpointsBatchOutput {
  ...
  @scala.inline
  implicit class UpdateEndpointsBatchOutputOps[Self <: UpdateEndpointsBatchOutput] (val x: Self) extends AnyVal {
    @scala.inline
