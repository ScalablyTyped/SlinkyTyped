package typingsSlinky.awsSdkClientPinpointBrowser.deleteCampaignExceptionsUnionMod
...
object DeleteCampaignExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DeleteCampaignExceptionsUnion = value.asInstanceOf[DeleteCampaignExceptionsUnion]
}
