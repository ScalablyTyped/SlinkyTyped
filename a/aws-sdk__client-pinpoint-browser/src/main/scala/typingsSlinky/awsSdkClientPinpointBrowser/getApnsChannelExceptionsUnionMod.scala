...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetApnsChannelExceptionsUnion", JSImport.Namespace)
@js.native
object getApnsChannelExceptionsUnionMod extends js.Object {
