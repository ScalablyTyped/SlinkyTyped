...
object SegmentGroupList {
  ...
  implicit class SegmentGroupListOps[Self <: SegmentGroupList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupsIterable(value: js.Iterable[SegmentGroup]): Self = this.set("Groups", value.asInstanceOf[js.Any])
    @scala.inline
    def setGroups(value: js.Array[SegmentGroup] | js.Iterable[SegmentGroup]): Self = this.set("Groups", value.asInstanceOf[js.Any])
    @scala.inline
