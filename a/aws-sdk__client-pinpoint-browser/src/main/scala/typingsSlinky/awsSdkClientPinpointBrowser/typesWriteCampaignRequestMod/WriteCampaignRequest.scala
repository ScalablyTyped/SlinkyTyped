...
object WriteCampaignRequest {
  ...
  implicit class WriteCampaignRequestOps[Self <: WriteCampaignRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdditionalTreatmentsIterable(value: js.Iterable[WriteTreatmentResource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AdditionalTreatments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAdditionalTreatments(value: js.Array[WriteTreatmentResource] | js.Iterable[WriteTreatmentResource]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AdditionalTreatments")(value.asInstanceOf[js.Any])
        ret
    }
