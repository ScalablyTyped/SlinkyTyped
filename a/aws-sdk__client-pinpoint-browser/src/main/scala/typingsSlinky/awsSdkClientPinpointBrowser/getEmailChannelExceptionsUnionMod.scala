...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetEmailChannelExceptionsUnion", JSImport.Namespace)
@js.native
object getEmailChannelExceptionsUnionMod extends js.Object {
