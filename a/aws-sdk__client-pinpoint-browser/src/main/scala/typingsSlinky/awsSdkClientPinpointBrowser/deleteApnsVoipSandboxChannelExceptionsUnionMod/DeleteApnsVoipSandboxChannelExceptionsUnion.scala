package typingsSlinky.awsSdkClientPinpointBrowser.deleteApnsVoipSandboxChannelExceptionsUnionMod
...
object DeleteApnsVoipSandboxChannelExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DeleteApnsVoipSandboxChannelExceptionsUnion = value.asInstanceOf[DeleteApnsVoipSandboxChannelExceptionsUnion]
}
