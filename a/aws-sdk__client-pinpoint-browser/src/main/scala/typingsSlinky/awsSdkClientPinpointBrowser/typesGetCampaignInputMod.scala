...
object typesGetCampaignInputMod {
  
  @js.native
  trait GetCampaignInput extends InputTypesUnion {
  ...
  object GetCampaignInput {
    ...
    @scala.inline
    def apply(ApplicationId: String, CampaignId: String): GetCampaignInput = {
    ...
    @scala.inline
    implicit class GetCampaignInputMutableBuilder[Self <: GetCampaignInput] (val x: Self) extends AnyVal {
