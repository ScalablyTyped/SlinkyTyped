package typingsSlinky.awsSdkClientPinpointBrowser.getCampaignsExceptionsUnionMod
...
*/
trait GetCampaignsExceptionsUnion extends js.Object

object GetCampaignsExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): GetCampaignsExceptionsUnion = value.asInstanceOf[GetCampaignsExceptionsUnion]
}
