package typingsSlinky.awsSdkClientPinpointBrowser.deleteEndpointExceptionsUnionMod
...
object DeleteEndpointExceptionsUnion {
  @scala.inline
  implicit def apply(value: BadRequestException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
  @scala.inline
  implicit def apply(value: ForbiddenException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
  @scala.inline
  implicit def apply(value: InternalServerErrorException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
  @scala.inline
  implicit def apply(value: MethodNotAllowedException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
  @scala.inline
  implicit def apply(value: NotFoundException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
  @scala.inline
  implicit def apply(value: TooManyRequestsException): DeleteEndpointExceptionsUnion = value.asInstanceOf[DeleteEndpointExceptionsUnion]
}
