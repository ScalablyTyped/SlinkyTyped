...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppearance(value: typingsSlinky.atlaskitSingleSelect.atlaskitSingleSelectStrings.default | subtle): Self = this.set("appearance", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInvalidMessageReactElement(value: ReactElement): Self = this.set("invalidMessage", value.asInstanceOf[js.Any])
