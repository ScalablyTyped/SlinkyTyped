...
@js.native
trait ForceUpdate[TData, TVariables] extends js.Object {
...
object ForceUpdate {
  @scala.inline
  def apply[TData, TVariables](context: ApolloContextValue, forceUpdate: js.Any, options: QueryOptions[TData, TVariables]): ForceUpdate[TData, TVariables] = {
    ...
    __obj.asInstanceOf[ForceUpdate[TData, TVariables]]
  }
  @scala.inline
  implicit class ForceUpdateOps[Self[tdata, tvariables] <: ForceUpdate[tdata, tvariables], TData, TVariables] (val x: Self[TData, TVariables]) extends AnyVal {
    @scala.inline
