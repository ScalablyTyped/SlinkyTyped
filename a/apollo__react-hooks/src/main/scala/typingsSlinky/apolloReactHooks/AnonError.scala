...
object AnonError {
  @scala.inline
  def apply[TVariables, TData](loading: Boolean): AnonError[TVariables, TData] = {
    val __obj = js.Dynamic.literal(loading = loading.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonError[TVariables, TData]]
  }
  @scala.inline
  implicit class AnonErrorOps[Self[tvariables, tdata] <: AnonError[tvariables, tdata], TVariables, TData] (val x: Self[TVariables, TData]) extends AnyVal {
    @scala.inline
