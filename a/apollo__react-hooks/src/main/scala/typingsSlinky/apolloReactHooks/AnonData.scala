...
object AnonData {
  @scala.inline
  def apply[TVariables, TData](loading: Boolean): AnonData[TVariables, TData] = {
    val __obj = js.Dynamic.literal(loading = loading.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonData[TVariables, TData]]
  }
  @scala.inline
  implicit class AnonDataOps[Self[tvariables, tdata] <: AnonData[tvariables, tdata], TVariables, TData] (val x: Self[TVariables, TData]) extends AnyVal {
    @scala.inline
