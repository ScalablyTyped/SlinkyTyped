package typingsSlinky.atApolloReactDashHooks.libTypesMod
...
import typingsSlinky.atApolloReactDashCommon.libTypesTypesMod.QueryFunctionOptions
...
trait QueryOptions[TData, TVariables] extends QueryFunctionOptions[TData, TVariables] {
  var children: js.UndefOr[js.Function1[/* result */ QueryResult[TData, TVariables], TagMod[Any]]] = js.undefined
...
object QueryOptions {
  ...
  def apply[TData, TVariables](
    query: DocumentNode,
    children: /* result */ QueryResult[TData, TVariables] => TagMod[Any] = null,
