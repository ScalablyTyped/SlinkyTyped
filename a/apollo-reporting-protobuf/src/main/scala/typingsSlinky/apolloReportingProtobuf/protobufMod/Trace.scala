...
import typingsSlinky.apolloReportingProtobuf.apolloReportingProtobufStrings.fieldName
import typingsSlinky.apolloReportingProtobuf.apolloReportingProtobufStrings.flatten
import typingsSlinky.apolloReportingProtobuf.apolloReportingProtobufStrings.index
import typingsSlinky.apolloReportingProtobuf.apolloReportingProtobufStrings.parallel
import typingsSlinky.apolloReportingProtobuf.apolloReportingProtobufStrings.responseName
...
import typingsSlinky.apolloReportingProtobuf.protobufMod.Trace.HTTP.Method
...
object Trace {
  ...
  object HTTP {
    ...
    object Values {
      ...
      @js.native
      def decode(reader: js.typedarray.Uint8Array): Values = js.native
      @JSImport("apollo-reporting-protobuf/dist/protobuf", "Trace.HTTP.Values.decode")
      @js.native
      def decode(reader: js.typedarray.Uint8Array, length: Double): Values = js.native
      /**
      ...
      @js.native
      def decodeDelimited(reader: js.typedarray.Uint8Array): Values = js.native
      /**
  ...
  object QueryPlanNode {
    ...
    @js.native
    def decode(reader: js.typedarray.Uint8Array): QueryPlanNode = js.native
    @JSImport("apollo-reporting-protobuf/dist/protobuf", "Trace.QueryPlanNode.decode")
    @js.native
    def decode(reader: js.typedarray.Uint8Array, length: Double): QueryPlanNode = js.native
    /**
    ...
    @js.native
    def decodeDelimited(reader: js.typedarray.Uint8Array): QueryPlanNode = js.native
    /**
  ...
  @js.native
  def decode(reader: js.typedarray.Uint8Array): Trace = js.native
  @JSImport("apollo-reporting-protobuf/dist/protobuf", "Trace.decode")
  @js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Trace = js.native
  /**
  ...
  @js.native
  def decodeDelimited(reader: js.typedarray.Uint8Array): Trace = js.native
  /**
  ...
  trait IDetails extends StObject {
    ...
    /** Details deprecatedVariables */
    var deprecatedVariables: js.UndefOr[StringDictionary[js.typedarray.Uint8Array] | Null] = js.native
  ...
  object IDetails {
    ...
    implicit class IDetailsMutableBuilder[Self <: IDetails] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeprecatedVariables(value: StringDictionary[js.typedarray.Uint8Array]): Self = StObject.set(x, "deprecatedVariables", value.asInstanceOf[js.Any])
