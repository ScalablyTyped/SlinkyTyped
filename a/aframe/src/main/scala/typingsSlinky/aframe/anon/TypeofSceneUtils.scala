...
object TypeofSceneUtils {
  ...
  implicit class TypeofSceneUtilsMutableBuilder[Self <: TypeofSceneUtils] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateMultiMaterialObject(value: (Geometry, js.Array[typingsSlinky.three.materialMod.Material]) => Object3D): Self = StObject.set(x, "createMultiMaterialObject", js.Any.fromFunction2(value))
