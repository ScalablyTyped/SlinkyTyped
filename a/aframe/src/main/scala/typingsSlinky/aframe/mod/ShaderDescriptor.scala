...
object ShaderDescriptor {
  @scala.inline
  def apply[/* <: typingsSlinky.aframe.mod.Shader */ T](Shader: ShaderConstructor[T], schema: Schema_[js.Object]): ShaderDescriptor[T] = {
  ...
  @scala.inline
  implicit class ShaderDescriptorOps[Self <: ShaderDescriptor[_], /* <: typingsSlinky.aframe.mod.Shader */ T] (val x: Self with ShaderDescriptor[T]) extends AnyVal {
    @scala.inline
