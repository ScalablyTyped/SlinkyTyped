...
@js.native
class InstancedMesh[TGeometry /* <: typingsSlinky.three.geometryMod.Geometry | BufferGeometry */, TMaterial /* <: typingsSlinky.three.materialMod.Material | js.Array[typingsSlinky.three.materialMod.Material] */] protected ()
