...
object GeometryDescriptor {
  @scala.inline
  def apply[/* <: typingsSlinky.aframe.mod.Geometry[_] */ T](Geometry: GeometryConstructor[T], schema: Schema_[js.Object]): GeometryDescriptor[T] = {
  ...
  @scala.inline
  implicit class GeometryDescriptorOps[Self <: GeometryDescriptor[_], /* <: typingsSlinky.aframe.mod.Geometry[_] */ T] (val x: Self with GeometryDescriptor[T]) extends AnyVal {
    @scala.inline
