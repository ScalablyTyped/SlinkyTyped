...
object ComponentDescriptor {
  @scala.inline
  def apply[/* <: typingsSlinky.aframe.mod.Component[_, typingsSlinky.aframe.mod.System[_]] */ T](Component: ComponentConstructor[T]): ComponentDescriptor[T] = {
    val __obj = js.Dynamic.literal(Component = Component.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComponentDescriptor[T]]
  }
  @scala.inline
  implicit class ComponentDescriptorOps[Self <: ComponentDescriptor[_], /* <: typingsSlinky.aframe.mod.Component[_, typingsSlinky.aframe.mod.System[_]] */ T] (val x: Self with ComponentDescriptor[T]) extends AnyVal {
    @scala.inline
