...
object Atmosphere {
  ...
  object Atmosphere {
    ...
    @scala.inline
    def apply(): typingsSlinky.atmosphereJs.Atmosphere.Atmosphere = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.atmosphereJs.Atmosphere.Atmosphere]
    }
    
    @scala.inline
    implicit class AtmosphereMutableBuilder[Self <: typingsSlinky.atmosphereJs.Atmosphere.Atmosphere] (val x: Self) extends AnyVal {
