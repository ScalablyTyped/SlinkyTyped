...
trait Atmosphere extends js.Object {
  var AtmosphereRequest: js.UndefOr[typingsSlinky.atmosphereJs.Atmosphere_.AtmosphereRequest] = js.native
  /**
...
object Atmosphere {
  ...
  @scala.inline
  implicit class AtmosphereOps[Self <: Atmosphere] (val x: Self) extends AnyVal {
    @scala.inline
