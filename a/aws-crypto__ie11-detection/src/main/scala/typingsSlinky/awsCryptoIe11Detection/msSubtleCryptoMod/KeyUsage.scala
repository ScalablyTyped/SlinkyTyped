...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.awsCryptoIe11Detection.awsCryptoIe11DetectionStrings.deriveKey
  - typingsSlinky.awsCryptoIe11Detection.awsCryptoIe11DetectionStrings.deriveBits
