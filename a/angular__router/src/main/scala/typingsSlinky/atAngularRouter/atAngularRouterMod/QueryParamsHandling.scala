...
object QueryParamsHandling {
  @scala.inline
  def _empty: typingsSlinky.atAngularRouter.atAngularRouterStrings._empty = this.cast("")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def merge: typingsSlinky.atAngularRouter.atAngularRouterStrings.merge = this.cast("merge")
  @scala.inline
  def preserve: typingsSlinky.atAngularRouter.atAngularRouterStrings.preserve = this.cast("preserve")
}
