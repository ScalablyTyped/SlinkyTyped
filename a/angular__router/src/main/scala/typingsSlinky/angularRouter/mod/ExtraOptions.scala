...
object ExtraOptions {
  ...
  implicit class ExtraOptionsMutableBuilder[Self <: ExtraOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMalformedUriErrorHandler(value: (/* error */ js.URIError, /* urlSerializer */ UrlSerializer, /* url */ String) => UrlTree): Self = StObject.set(x, "malformedUriErrorHandler", js.Any.fromFunction3(value))
