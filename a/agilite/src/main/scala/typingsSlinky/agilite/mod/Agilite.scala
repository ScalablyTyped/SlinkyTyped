...
trait Agilite extends js.Object {
  var ApiKeys: typingsSlinky.agilite.mod.ApiKeys
  var BPM: typingsSlinky.agilite.mod.BPM
  var Connectors: typingsSlinky.agilite.mod.Connectors
  var DataMappings: typingsSlinky.agilite.mod.DataMappings
  var Files: typingsSlinky.agilite.mod.Files
  var Keywords: typingsSlinky.agilite.mod.Keywords
  var Numbering: typingsSlinky.agilite.mod.Numbering
  var Roles: typingsSlinky.agilite.mod.Roles
  var Templates: typingsSlinky.agilite.mod.Templates
  var TierStructures: typingsSlinky.agilite.mod.TierStructures
  var Utils: typingsSlinky.agilite.mod.Utils
  var appName: typingsSlinky.agilite.mod.appName
  var config: AgiliteConfig
  var reqType: typingsSlinky.agilite.mod.reqType
