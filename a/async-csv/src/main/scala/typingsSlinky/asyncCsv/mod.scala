  ...
  */
  ...
  trait CsvStringifyOptions extends StObject {
    ...
    /**
      ...
      */
    var cast: js.UndefOr[typingsSlinky.asyncCsv.anon.Boolean] = js.native
  ...
  object CsvStringifyOptions {
    ...
    implicit class CsvStringifyOptionsMutableBuilder[Self <: CsvStringifyOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCast(value: typingsSlinky.asyncCsv.anon.Boolean): Self = StObject.set(x, "cast", value.asInstanceOf[js.Any])
