package typingsSlinky.axiosCancel

import typingsSlinky.axios.mod.AxiosStatic
...
object mod {
  ...
  object axiosAugmentingMod {
    ...
    object AxiosStatic {
      ...
      @scala.inline
      def apply(cancel: String => Unit, cancelAll: () => Unit): typingsSlinky.axiosCancel.mod.axiosAugmentingMod.AxiosStatic = {
        val __obj = js.Dynamic.literal(cancel = js.Any.fromFunction1(cancel), cancelAll = js.Any.fromFunction0(cancelAll))
        __obj.asInstanceOf[typingsSlinky.axiosCancel.mod.axiosAugmentingMod.AxiosStatic]
      }
      
      @scala.inline
      implicit class AxiosStaticMutableBuilder[Self <: typingsSlinky.axiosCancel.mod.axiosAugmentingMod.AxiosStatic] (val x: Self) extends AnyVal {
