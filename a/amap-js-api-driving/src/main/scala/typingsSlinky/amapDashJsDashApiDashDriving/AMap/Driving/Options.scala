...
import typingsSlinky.amapDashJsDashApi.AMap.Map
import typingsSlinky.amapDashJsDashApiDashDriving.AMap.DrivingPolicy
import typingsSlinky.amapDashJsDashApiDashDriving.amapDashJsDashApiDashDrivingStrings.all
import typingsSlinky.amapDashJsDashApiDashDriving.amapDashJsDashApiDashDrivingStrings.base
...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(ferry)) __obj.updateDynamic("ferry")(ferry.asInstanceOf[js.Any])
