package typingsSlinky.amapJsApiDriving.AMap
...
import typingsSlinky.amapJsApiDriving.AMap.Driving.SearchOptions
import typingsSlinky.amapJsApiDriving.AMap.Driving.SearchPoint
import typingsSlinky.amapJsApiDriving.AMap.Driving.SearchResultBase
import typingsSlinky.amapJsApiDriving.AMap.Driving.SearchResultExt
...
import typingsSlinky.amapJsApiDriving.anon.Destination
...
object Driving {
  ...
  trait EventMap extends StObject {
    ...
    var error: Event_[typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.error, Info] = js.native
  }
  object EventMap {
  ...
  */
  ...
  object SearchResult {
    ...
    def SearchResultBase(
      ...
      __obj.asInstanceOf[typingsSlinky.amapJsApiDriving.AMap.Driving.SearchResultBase]
    }
    ...
    def SearchResultExt(
      ...
      __obj.asInstanceOf[typingsSlinky.amapJsApiDriving.AMap.Driving.SearchResultExt]
    }
  }
  ...
  */
  ...
  object SearchStatus {
    ...
    @scala.inline
    def complete: typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.complete = "complete".asInstanceOf[typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.complete]
    
    @scala.inline
    def error: typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.error = "error".asInstanceOf[typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.error]
    
    @scala.inline
    def no_data: typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.no_data = "no_data".asInstanceOf[typingsSlinky.amapJsApiDriving.amapJsApiDrivingStrings.no_data]
  }
