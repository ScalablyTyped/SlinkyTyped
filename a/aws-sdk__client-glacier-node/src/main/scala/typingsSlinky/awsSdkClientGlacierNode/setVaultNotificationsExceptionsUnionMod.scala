...
@JSImport("@aws-sdk/client-glacier-node/types/SetVaultNotificationsExceptionsUnion", JSImport.Namespace)
@js.native
object setVaultNotificationsExceptionsUnionMod extends js.Object {
