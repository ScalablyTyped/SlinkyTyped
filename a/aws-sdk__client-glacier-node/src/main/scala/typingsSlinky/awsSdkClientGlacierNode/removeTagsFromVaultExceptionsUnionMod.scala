...
@JSImport("@aws-sdk/client-glacier-node/types/RemoveTagsFromVaultExceptionsUnion", JSImport.Namespace)
@js.native
object removeTagsFromVaultExceptionsUnionMod extends js.Object {
