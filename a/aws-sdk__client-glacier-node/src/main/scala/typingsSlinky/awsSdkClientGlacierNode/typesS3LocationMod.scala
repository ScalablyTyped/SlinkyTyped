...
object typesS3LocationMod {
  ...
  object S3Location {
    ...
    implicit class S3LocationMutableBuilder[Self <: S3Location] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTagging(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = StObject.set(x, "Tagging", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTaggingIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = StObject.set(x, "Tagging", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTaggingUndefined: Self = StObject.set(x, "Tagging", js.undefined)
      
      @scala.inline
      def setUserMetadata(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = StObject.set(x, "UserMetadata", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUserMetadataIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = StObject.set(x, "UserMetadata", value.asInstanceOf[js.Any])
