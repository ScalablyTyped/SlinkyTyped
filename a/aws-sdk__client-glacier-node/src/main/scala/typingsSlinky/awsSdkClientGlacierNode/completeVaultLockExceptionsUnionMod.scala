...
@JSImport("@aws-sdk/client-glacier-node/types/CompleteVaultLockExceptionsUnion", JSImport.Namespace)
@js.native
object completeVaultLockExceptionsUnionMod extends js.Object {
