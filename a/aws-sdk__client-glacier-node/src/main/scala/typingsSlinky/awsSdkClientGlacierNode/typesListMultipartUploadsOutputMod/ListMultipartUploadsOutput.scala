package typingsSlinky.awsSdkClientGlacierNode.typesListMultipartUploadsOutputMod

import typingsSlinky.awsSdkClientGlacierNode.outputTypesUnionMod.OutputTypesUnion
import typingsSlinky.awsSdkClientGlacierNode.typesUploadListElementMod.UnmarshalledUploadListElement
...
@js.native
trait ListMultipartUploadsOutput extends OutputTypesUnion {
  /**
...
object ListMultipartUploadsOutput {
  ...
  implicit class ListMultipartUploadsOutputOps[Self <: ListMultipartUploadsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUploadsList(value: js.Array[UnmarshalledUploadListElement]): Self = {
        val ret = this.duplicate
