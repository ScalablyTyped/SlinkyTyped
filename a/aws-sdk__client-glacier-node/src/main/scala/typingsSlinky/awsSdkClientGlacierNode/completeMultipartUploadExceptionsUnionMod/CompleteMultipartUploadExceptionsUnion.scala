package typingsSlinky.awsSdkClientGlacierNode.completeMultipartUploadExceptionsUnionMod
...
*/
trait CompleteMultipartUploadExceptionsUnion extends js.Object

object CompleteMultipartUploadExceptionsUnion {
  @scala.inline
  implicit def apply(value: InvalidParameterValueException): CompleteMultipartUploadExceptionsUnion = value.asInstanceOf[CompleteMultipartUploadExceptionsUnion]
  @scala.inline
  implicit def apply(value: MissingParameterValueException): CompleteMultipartUploadExceptionsUnion = value.asInstanceOf[CompleteMultipartUploadExceptionsUnion]
  @scala.inline
  implicit def apply(value: ResourceNotFoundException): CompleteMultipartUploadExceptionsUnion = value.asInstanceOf[CompleteMultipartUploadExceptionsUnion]
  @scala.inline
  implicit def apply(value: ServiceUnavailableException): CompleteMultipartUploadExceptionsUnion = value.asInstanceOf[CompleteMultipartUploadExceptionsUnion]
}
