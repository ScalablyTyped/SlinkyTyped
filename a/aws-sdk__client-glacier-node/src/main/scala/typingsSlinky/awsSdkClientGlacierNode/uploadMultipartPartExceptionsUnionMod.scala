...
@JSImport("@aws-sdk/client-glacier-node/types/UploadMultipartPartExceptionsUnion", JSImport.Namespace)
@js.native
object uploadMultipartPartExceptionsUnionMod extends js.Object {
