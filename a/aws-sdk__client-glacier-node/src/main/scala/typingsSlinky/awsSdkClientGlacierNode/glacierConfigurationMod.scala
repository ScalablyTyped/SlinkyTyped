...
object glacierConfigurationMod {
  ...
  @js.native
  trait GlacierConfiguration extends StObject {
  ...
  object GlacierConfiguration {
    ...
    @scala.inline
    implicit class GlacierConfigurationMutableBuilder[Self <: GlacierConfiguration] (val x: Self) extends AnyVal {
