...
import typingsSlinky.awsSdkClientGlacierNode.typesJobParametersMod.JobParameters
...
@JSImport("@aws-sdk/client-glacier-node/types/InitiateJobInput", JSImport.Namespace)
@js.native
object typesInitiateJobInputMod extends js.Object {
  @js.native
