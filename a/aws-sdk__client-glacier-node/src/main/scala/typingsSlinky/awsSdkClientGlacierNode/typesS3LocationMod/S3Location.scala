...
object S3Location {
  ...
  implicit class S3LocationOps[Self <: S3Location] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessControlListIterable(value: js.Iterable[Grant]): Self = this.set("AccessControlList", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAccessControlList(value: js.Array[Grant] | js.Iterable[Grant]): Self = this.set("AccessControlList", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTaggingIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("Tagging", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagging(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("Tagging", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTagging: Self = this.set("Tagging", js.undefined)
    
    @scala.inline
    def setUserMetadataIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("UserMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUserMetadata(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("UserMetadata", value.asInstanceOf[js.Any])
