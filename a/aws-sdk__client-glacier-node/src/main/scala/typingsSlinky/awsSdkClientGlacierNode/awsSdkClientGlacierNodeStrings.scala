...
object awsSdkClientGlacierNodeStrings {
  ...
  @js.native
  sealed trait ArchiveRetrieval extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait InsufficientCapacityException extends StObject
  @scala.inline
  def InsufficientCapacityException: InsufficientCapacityException = "InsufficientCapacityException".asInstanceOf[InsufficientCapacityException]
  ...
  @js.native
  sealed trait InventoryRetrieval extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait MissingParameterValueException extends StObject
  @scala.inline
  def MissingParameterValueException: MissingParameterValueException = "MissingParameterValueException".asInstanceOf[MissingParameterValueException]
  ...
  @js.native
  sealed trait PolicyEnforcedException extends StObject
  @scala.inline
  def PolicyEnforcedException: PolicyEnforcedException = "PolicyEnforcedException".asInstanceOf[PolicyEnforcedException]
  ...
  @js.native
  sealed trait RequestTimeoutException extends StObject
  @scala.inline
  def RequestTimeoutException: RequestTimeoutException = "RequestTimeoutException".asInstanceOf[RequestTimeoutException]
  ...
  @js.native
  sealed trait ServiceUnavailableException extends StObject
  @scala.inline
  def ServiceUnavailableException: ServiceUnavailableException = "ServiceUnavailableException".asInstanceOf[ServiceUnavailableException]
