package typingsSlinky.awsSdkClientGlacierNode.typesCreateVaultInputMod
...
@js.native
trait CreateVaultInput extends InputTypesUnion {
  /**
...
object CreateVaultInput {
  ...
  @scala.inline
  implicit class CreateVaultInputOps[Self <: CreateVaultInput] (val x: Self) extends AnyVal {
    @scala.inline
