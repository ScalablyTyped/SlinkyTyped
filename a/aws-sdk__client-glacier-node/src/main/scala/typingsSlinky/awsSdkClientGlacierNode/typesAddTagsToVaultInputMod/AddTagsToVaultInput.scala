...
object AddTagsToVaultInput {
  ...
  @scala.inline
  def apply(accountId: String, vaultName: String): AddTagsToVaultInput = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], vaultName = vaultName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AddTagsToVaultInput]
  }
  
  @scala.inline
  implicit class AddTagsToVaultInputOps[Self <: AddTagsToVaultInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagsIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("Tags", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTags(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("Tags", value.asInstanceOf[js.Any])
