...
@JSImport("@aws-sdk/client-glacier-node/types/DeleteVaultAccessPolicyExceptionsUnion", JSImport.Namespace)
@js.native
object deleteVaultAccessPolicyExceptionsUnionMod extends js.Object {
