...
@JSImport("@aws-sdk/client-glacier-node/types/SetVaultAccessPolicyExceptionsUnion", JSImport.Namespace)
@js.native
object setVaultAccessPolicyExceptionsUnionMod extends js.Object {
