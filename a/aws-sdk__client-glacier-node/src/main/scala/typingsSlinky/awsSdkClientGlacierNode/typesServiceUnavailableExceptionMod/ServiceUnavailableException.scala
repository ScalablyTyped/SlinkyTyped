...
trait ServiceUnavailableException
  ...
  @JSName("name")
  var name_ServiceUnavailableException: typingsSlinky.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.ServiceUnavailableException = js.native
}
...
object ServiceUnavailableException {
  ...
  implicit class ServiceUnavailableExceptionOps[Self <: ServiceUnavailableException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(
      value: typingsSlinky.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.ServiceUnavailableException
