package typingsSlinky.awsSdkClientGlacierNode.typesInitiateVaultLockInputMod

import typingsSlinky.awsSdkClientGlacierNode.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientGlacierNode.typesVaultLockPolicyMod.VaultLockPolicy
...
@js.native
trait InitiateVaultLockInput extends InputTypesUnion {
  /**
...
object InitiateVaultLockInput {
  ...
  implicit class InitiateVaultLockInputOps[Self <: InitiateVaultLockInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPolicy(value: VaultLockPolicy): Self = {
        val ret = this.duplicate
