...
@JSImport("@aws-sdk/client-glacier-node/types/CompleteVaultLockInput", JSImport.Namespace)
@js.native
object typesCompleteVaultLockInputMod extends js.Object {
  @js.native
  trait CompleteVaultLockInput extends _InputTypesUnion {
    /**
