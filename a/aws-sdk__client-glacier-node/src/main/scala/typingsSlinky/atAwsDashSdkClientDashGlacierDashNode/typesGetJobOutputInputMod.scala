...
@JSImport("@aws-sdk/client-glacier-node/types/GetJobOutputInput", JSImport.Namespace)
@js.native
object typesGetJobOutputInputMod extends js.Object {
  @js.native
  trait GetJobOutputInput extends _InputTypesUnion {
    /**
