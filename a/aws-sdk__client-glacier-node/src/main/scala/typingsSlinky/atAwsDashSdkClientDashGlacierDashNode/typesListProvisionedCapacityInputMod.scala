...
@JSImport("@aws-sdk/client-glacier-node/types/ListProvisionedCapacityInput", JSImport.Namespace)
@js.native
object typesListProvisionedCapacityInputMod extends js.Object {
  @js.native
  trait ListProvisionedCapacityInput extends _InputTypesUnion {
    /**
