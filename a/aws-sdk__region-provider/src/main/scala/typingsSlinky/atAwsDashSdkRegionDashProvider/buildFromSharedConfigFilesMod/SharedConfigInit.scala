package typingsSlinky.atAwsDashSdkRegionDashProvider.buildFromSharedConfigFilesMod
...
trait SharedConfigInit
  extends typingsSlinky.atAwsDashSdkSharedDashIniDashFileDashLoader.atAwsDashSdkSharedDashIniDashFileDashLoaderMod.SharedConfigInit {
  /**
