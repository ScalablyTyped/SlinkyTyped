...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/namedTypes.namedTypes.TSType, 'type'> ]: ast-types.ast-types/gen/namedTypes.namedTypes.TSType[P]} */ trait TSAnyKeyword
  extends ASTNode
     ...
     with PrintableKind
     with TSTypeKind {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSAnyKeyword
}

@JSImport("ast-types/gen/namedTypes", "namedTypes.TSAnyKeyword")
@js.native
object TSAnyKeyword extends TopLevel[Type[TSAnyKeyword]]
