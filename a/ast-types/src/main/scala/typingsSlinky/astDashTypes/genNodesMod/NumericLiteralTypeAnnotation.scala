...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.FlowType, 'type'> ]: ast-types.ast-types/gen/nodes.FlowType[P]} */ trait NumericLiteralTypeAnnotation extends ASTNode {
  var raw: String
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.NumericLiteralTypeAnnotation
  var value: Double
}
...
object NumericLiteralTypeAnnotation {
  ...
  def apply(
    raw: String,
    `type`: typingsSlinky.astDashTypes.astDashTypesStrings.NumericLiteralTypeAnnotation,
    value: Double
