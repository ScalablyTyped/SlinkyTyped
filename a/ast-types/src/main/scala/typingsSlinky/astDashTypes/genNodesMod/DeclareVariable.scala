...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Statement, 'type'> ]: ast-types.ast-types/gen/nodes.Statement[P]} */ trait DeclareVariable extends ASTNode {
  ...
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.DeclareVariable
}

object DeclareVariable {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astDashTypes.astDashTypesStrings.DeclareVariable): DeclareVariable = {
