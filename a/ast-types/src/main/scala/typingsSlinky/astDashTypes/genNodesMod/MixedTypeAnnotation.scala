...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.FlowType, 'type'> ]: ast-types.ast-types/gen/nodes.FlowType[P]} */ trait MixedTypeAnnotation extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.MixedTypeAnnotation
}

object MixedTypeAnnotation {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.MixedTypeAnnotation): MixedTypeAnnotation = {
