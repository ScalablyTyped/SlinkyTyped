...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.TSType, 'type'> ]: ast-types.ast-types/gen/nodes.TSType[P]} */ trait TSUndefinedKeyword extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSUndefinedKeyword
}

object TSUndefinedKeyword {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSUndefinedKeyword): TSUndefinedKeyword = {
