...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.FlowType, 'type'> ]: ast-types.ast-types/gen/nodes.FlowType[P]} */ trait AnyTypeAnnotation extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.AnyTypeAnnotation
}

object AnyTypeAnnotation {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.AnyTypeAnnotation): AnyTypeAnnotation = {
