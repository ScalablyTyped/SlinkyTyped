...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.FlowType, 'type'> ]: ast-types.ast-types/gen/nodes.FlowType[P]} */ trait VoidTypeAnnotation extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.VoidTypeAnnotation
}

object VoidTypeAnnotation {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.VoidTypeAnnotation): VoidTypeAnnotation = {
