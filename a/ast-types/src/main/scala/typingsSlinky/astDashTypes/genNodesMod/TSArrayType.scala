...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.TSType, 'type'> ]: ast-types.ast-types/gen/nodes.TSType[P]} */ trait TSArrayType extends ASTNode {
  ...
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSArrayType
}

object TSArrayType {
  @scala.inline
  def apply(elementType: TSTypeKind, `type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSArrayType): TSArrayType = {
