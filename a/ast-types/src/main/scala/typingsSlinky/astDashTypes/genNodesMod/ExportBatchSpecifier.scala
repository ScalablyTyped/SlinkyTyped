...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Specifier, 'type'> ]: ast-types.ast-types/gen/nodes.Specifier[P]} */ trait ExportBatchSpecifier extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.ExportBatchSpecifier
}

object ExportBatchSpecifier {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.ExportBatchSpecifier): ExportBatchSpecifier = {
