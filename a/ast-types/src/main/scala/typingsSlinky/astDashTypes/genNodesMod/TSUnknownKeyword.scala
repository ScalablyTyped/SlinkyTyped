...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.TSType, 'type'> ]: ast-types.ast-types/gen/nodes.TSType[P]} */ trait TSUnknownKeyword extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSUnknownKeyword
}

object TSUnknownKeyword {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.TSUnknownKeyword): TSUnknownKeyword = {
