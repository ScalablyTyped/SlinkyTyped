...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.FlowType, 'type'> ]: ast-types.ast-types/gen/nodes.FlowType[P]} */ trait BooleanLiteralTypeAnnotation extends ASTNode {
  var raw: String
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.BooleanLiteralTypeAnnotation
  var value: Boolean
}
...
object BooleanLiteralTypeAnnotation {
  ...
  def apply(
    raw: String,
    `type`: typingsSlinky.astDashTypes.astDashTypesStrings.BooleanLiteralTypeAnnotation,
    value: Boolean
