...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Node, 'type'> ]: ast-types.ast-types/gen/nodes.Node[P]} */ trait ObjectTypeInternalSlot extends ASTNode {
  ...
  var static: Boolean
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.ObjectTypeInternalSlot
...
object ObjectTypeInternalSlot {
  ...
  def apply(
    ...
    optional: Boolean,
    static: Boolean,
    `type`: typingsSlinky.astDashTypes.astDashTypesStrings.ObjectTypeInternalSlot,
    value: FlowTypeKind
