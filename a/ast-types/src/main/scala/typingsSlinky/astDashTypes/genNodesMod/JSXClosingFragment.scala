...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Node, 'type'> ]: ast-types.ast-types/gen/nodes.Node[P]} */ trait JSXClosingFragment extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.JSXClosingFragment
}

object JSXClosingFragment {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.JSXClosingFragment): JSXClosingFragment = {
