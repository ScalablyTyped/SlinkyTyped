...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Pattern, 'type'> ]: ast-types.ast-types/gen/nodes.Pattern[P]} */ trait PrivateName extends ASTNode {
  ...
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.PrivateName
}

object PrivateName {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astDashTypes.astDashTypesStrings.PrivateName): PrivateName = {
