...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Node, 'type'> ]: ast-types.ast-types/gen/nodes.Node[P]} */ trait JSXOpeningFragment extends ASTNode {
  var `type`: typingsSlinky.astDashTypes.astDashTypesStrings.JSXOpeningFragment
}

object JSXOpeningFragment {
  @scala.inline
  def apply(`type`: typingsSlinky.astDashTypes.astDashTypesStrings.JSXOpeningFragment): JSXOpeningFragment = {
