...
object AnonCommentsElementType {
  @scala.inline
  def apply(elementType: TSTypeKind): AnonCommentsElementType = {
    val __obj = js.Dynamic.literal(elementType = elementType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsElementType]
  }
  @scala.inline
  implicit class AnonCommentsElementTypeOps[Self <: AnonCommentsElementType] (val x: Self) extends AnyVal {
    @scala.inline
