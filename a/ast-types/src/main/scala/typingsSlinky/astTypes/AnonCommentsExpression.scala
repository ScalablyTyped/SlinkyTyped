...
object AnonCommentsExpression {
  @scala.inline
  def apply(expression: IdentifierKind | TSQualifiedNameKind): AnonCommentsExpression = {
    val __obj = js.Dynamic.literal(expression = expression.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsExpression]
  }
  @scala.inline
  implicit class AnonCommentsExpressionOps[Self <: AnonCommentsExpression] (val x: Self) extends AnyVal {
    @scala.inline
