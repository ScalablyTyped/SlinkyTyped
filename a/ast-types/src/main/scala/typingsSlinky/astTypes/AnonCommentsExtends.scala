...
object AnonCommentsExtends {
  @scala.inline
  def apply(body: ObjectTypeAnnotationKind, `extends`: js.Array[InterfaceExtendsKind], id: IdentifierKind): AnonCommentsExtends = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.updateDynamic("extends")(`extends`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsExtends]
  }
  @scala.inline
  implicit class AnonCommentsExtendsOps[Self <: AnonCommentsExtends] (val x: Self) extends AnyVal {
    @scala.inline
