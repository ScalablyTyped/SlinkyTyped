...
@js.native
trait AnonRegexValue extends js.Object {
...
object AnonRegexValue {
  @scala.inline
  def apply(value: Boolean): AnonRegexValue = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRegexValue]
  }
  @scala.inline
  implicit class AnonRegexValueOps[Self <: AnonRegexValue] (val x: Self) extends AnyVal {
    @scala.inline
