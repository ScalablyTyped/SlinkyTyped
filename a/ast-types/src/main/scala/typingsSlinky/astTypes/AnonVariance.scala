...
object AnonVariance {
  @scala.inline
  def apply(key: LiteralKind | IdentifierKind, optional: Boolean, value: FlowTypeKind): AnonVariance = {
  ...
  @scala.inline
  implicit class AnonVarianceOps[Self <: AnonVariance] (val x: Self) extends AnyVal {
    @scala.inline
