...
object AnonDeclareExtends {
  @scala.inline
  def apply(body: TSInterfaceBodyKind, id: IdentifierKind | TSQualifiedNameKind): AnonDeclareExtends = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDeclareExtends]
  }
  @scala.inline
  implicit class AnonDeclareExtendsOps[Self <: AnonDeclareExtends] (val x: Self) extends AnyVal {
    @scala.inline
