...
object AnonArgumentCommentsLoc {
  @scala.inline
  def apply(argument: PatternKind): AnonArgumentCommentsLoc = {
    val __obj = js.Dynamic.literal(argument = argument.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonArgumentCommentsLoc]
  }
  @scala.inline
  implicit class AnonArgumentCommentsLocOps[Self <: AnonArgumentCommentsLoc] (val x: Self) extends AnyVal {
    @scala.inline
