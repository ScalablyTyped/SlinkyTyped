...
object AnonExpressionLoc {
  @scala.inline
  def apply(expression: ExpressionKind, typeAnnotation: TypeAnnotationKind): AnonExpressionLoc = {
    val __obj = js.Dynamic.literal(expression = expression.asInstanceOf[js.Any], typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonExpressionLoc]
  }
  @scala.inline
  implicit class AnonExpressionLocOps[Self <: AnonExpressionLoc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTypeAnnotation(value: TypeAnnotationKind): Self = {
        val ret = this.duplicate
