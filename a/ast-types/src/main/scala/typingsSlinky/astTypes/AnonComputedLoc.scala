...
object AnonComputedLoc {
  @scala.inline
  def apply(`object`: ExpressionKind, property: IdentifierKind | ExpressionKind): AnonComputedLoc = {
    val __obj = js.Dynamic.literal(property = property.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonComputedLoc]
  }
  @scala.inline
  implicit class AnonComputedLocOps[Self <: AnonComputedLoc] (val x: Self) extends AnyVal {
    @scala.inline
