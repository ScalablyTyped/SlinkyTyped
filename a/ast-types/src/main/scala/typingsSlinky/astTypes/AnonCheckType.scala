...
object AnonCheckType {
  @scala.inline
  def apply(checkType: TSTypeKind, extendsType: TSTypeKind, falseType: TSTypeKind, trueType: TSTypeKind): AnonCheckType = {
  ...
  @scala.inline
  implicit class AnonCheckTypeOps[Self <: AnonCheckType] (val x: Self) extends AnyVal {
    @scala.inline
