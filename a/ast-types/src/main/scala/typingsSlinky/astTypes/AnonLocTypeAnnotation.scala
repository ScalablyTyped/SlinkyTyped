...
object AnonLocTypeAnnotation {
  @scala.inline
  def apply(typeAnnotation: FlowTypeKind): AnonLocTypeAnnotation = {
    val __obj = js.Dynamic.literal(typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLocTypeAnnotation]
  }
  @scala.inline
  implicit class AnonLocTypeAnnotationOps[Self <: AnonLocTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
