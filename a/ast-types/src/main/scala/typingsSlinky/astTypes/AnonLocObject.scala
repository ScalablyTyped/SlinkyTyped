...
object AnonLocObject {
  @scala.inline
  def apply(`object`: IdentifierKind, property: MemberTypeAnnotationKind | GenericTypeAnnotationKind): AnonLocObject = {
    val __obj = js.Dynamic.literal(property = property.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLocObject]
  }
  @scala.inline
  implicit class AnonLocObjectOps[Self <: AnonLocObject] (val x: Self) extends AnyVal {
    @scala.inline
