...
object AnonExpressionExtra {
  @scala.inline
  def apply(expression: ExpressionKind, typeAnnotation: TSTypeKind): AnonExpressionExtra = {
    val __obj = js.Dynamic.literal(expression = expression.asInstanceOf[js.Any], typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonExpressionExtra]
  }
  @scala.inline
  implicit class AnonExpressionExtraOps[Self <: AnonExpressionExtra] (val x: Self) extends AnyVal {
    @scala.inline
