...
trait TypeParameterDeclaration extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TypeParameterDeclaration = js.native
}
...
object TypeParameterDeclaration {
  ...
  @scala.inline
  implicit class TypeParameterDeclarationOps[Self <: TypeParameterDeclaration] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TypeParameterDeclaration): Self = {
        val ret = this.duplicate
