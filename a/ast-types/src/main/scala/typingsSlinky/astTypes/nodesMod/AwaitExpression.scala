...
object AwaitExpression {
  @scala.inline
  def apply(all: Boolean, `type`: typingsSlinky.astTypes.astTypesStrings.AwaitExpression): AwaitExpression = {
  ...
  implicit class AwaitExpressionOps[Self <: AwaitExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.AwaitExpression): Self = {
        val ret = this.duplicate
