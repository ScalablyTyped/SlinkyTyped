...
object TSParameterProperty {
  ...
  @scala.inline
  implicit class TSParameterPropertyOps[Self <: TSParameterProperty] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSParameterProperty): Self = {
        val ret = this.duplicate
