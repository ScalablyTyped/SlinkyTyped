...
object Variance {
  @scala.inline
  def apply(kind: plus | minus, `type`: typingsSlinky.astTypes.astTypesStrings.Variance): Variance = {
  ...
  implicit class VarianceOps[Self <: Variance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKind(value: plus | minus): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("kind")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.Variance): Self = {
        val ret = this.duplicate
