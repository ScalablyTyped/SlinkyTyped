...
trait VariableDeclarator extends ASTNode {
  ...
  var init: ExpressionKind | Null = js.native
...
object VariableDeclarator {
  @scala.inline
  def apply(id: PatternKind, `type`: typingsSlinky.astTypes.astTypesStrings.VariableDeclarator): VariableDeclarator = {
  ...
  implicit class VariableDeclaratorOps[Self <: VariableDeclarator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withId(value: PatternKind): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.VariableDeclarator): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInit(value: ExpressionKind): Self = {
        val ret = this.duplicate
