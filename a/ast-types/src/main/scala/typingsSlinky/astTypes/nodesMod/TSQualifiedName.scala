...
object TSQualifiedName {
  ...
  @scala.inline
  implicit class TSQualifiedNameOps[Self <: TSQualifiedName] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSQualifiedName): Self = {
        val ret = this.duplicate
