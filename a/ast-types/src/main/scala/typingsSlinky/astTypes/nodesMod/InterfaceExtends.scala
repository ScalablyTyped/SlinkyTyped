...
object InterfaceExtends {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.InterfaceExtends): InterfaceExtends = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[InterfaceExtends]
  }
  @scala.inline
  implicit class InterfaceExtendsOps[Self <: InterfaceExtends] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.InterfaceExtends): Self = {
        val ret = this.duplicate
