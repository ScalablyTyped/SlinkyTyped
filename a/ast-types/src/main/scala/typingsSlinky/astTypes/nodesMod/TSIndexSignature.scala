...
object TSIndexSignature {
  ...
  @scala.inline
  implicit class TSIndexSignatureOps[Self <: TSIndexSignature] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSIndexSignature): Self = {
        val ret = this.duplicate
