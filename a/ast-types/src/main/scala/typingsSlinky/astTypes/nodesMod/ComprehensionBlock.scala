...
object ComprehensionBlock {
  ...
  @scala.inline
  implicit class ComprehensionBlockOps[Self <: ComprehensionBlock] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ComprehensionBlock): Self = {
        val ret = this.duplicate
