...
trait BooleanLiteralTypeAnnotation extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.BooleanLiteralTypeAnnotation = js.native
...
object BooleanLiteralTypeAnnotation {
  ...
  @scala.inline
  implicit class BooleanLiteralTypeAnnotationOps[Self <: BooleanLiteralTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.BooleanLiteralTypeAnnotation): Self = {
        val ret = this.duplicate
