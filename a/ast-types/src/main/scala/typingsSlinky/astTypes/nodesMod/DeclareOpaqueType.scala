...
object DeclareOpaqueType {
  ...
  @scala.inline
  implicit class DeclareOpaqueTypeOps[Self <: DeclareOpaqueType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.DeclareOpaqueType): Self = {
        val ret = this.duplicate
