...
@js.native
trait JSXOpeningFragment extends ASTNode {
...
object JSXOpeningFragment {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.JSXOpeningFragment): JSXOpeningFragment = {
  ...
  implicit class JSXOpeningFragmentOps[Self <: JSXOpeningFragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.JSXOpeningFragment): Self = {
