...
object OptionalMemberExpression {
  ...
  @scala.inline
  implicit class OptionalMemberExpressionOps[Self <: OptionalMemberExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.OptionalMemberExpression): Self = {
        val ret = this.duplicate
