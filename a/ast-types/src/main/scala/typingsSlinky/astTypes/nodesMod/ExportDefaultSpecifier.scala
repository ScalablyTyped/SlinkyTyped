...
object ExportDefaultSpecifier {
  @scala.inline
  def apply(exported: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.ExportDefaultSpecifier): ExportDefaultSpecifier = {
    val __obj = js.Dynamic.literal(exported = exported.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExportDefaultSpecifier]
  }
  @scala.inline
  implicit class ExportDefaultSpecifierOps[Self <: ExportDefaultSpecifier] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ExportDefaultSpecifier): Self = {
        val ret = this.duplicate
