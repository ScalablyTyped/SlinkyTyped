...
object TSConstructorType {
  ...
  @scala.inline
  implicit class TSConstructorTypeOps[Self <: TSConstructorType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSConstructorType): Self = {
        val ret = this.duplicate
