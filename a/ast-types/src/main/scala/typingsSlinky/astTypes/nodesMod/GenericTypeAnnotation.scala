...
object GenericTypeAnnotation {
  ...
  @scala.inline
  implicit class GenericTypeAnnotationOps[Self <: GenericTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.GenericTypeAnnotation): Self = {
        val ret = this.duplicate
