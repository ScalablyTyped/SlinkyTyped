...
object StringLiteral {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.StringLiteral, value: String): StringLiteral = {
  ...
  implicit class StringLiteralOps[Self <: StringLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.StringLiteral): Self = {
