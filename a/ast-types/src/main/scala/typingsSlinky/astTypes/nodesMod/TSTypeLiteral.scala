...
object TSTypeLiteral {
  ...
  @scala.inline
  implicit class TSTypeLiteralOps[Self <: TSTypeLiteral] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSTypeLiteral): Self = {
        val ret = this.duplicate
