...
@js.native
trait SpreadElement extends ASTNode {
...
object SpreadElement {
  @scala.inline
  def apply(argument: ExpressionKind, `type`: typingsSlinky.astTypes.astTypesStrings.SpreadElement): SpreadElement = {
  ...
  implicit class SpreadElementOps[Self <: SpreadElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.SpreadElement): Self = {
        val ret = this.duplicate
