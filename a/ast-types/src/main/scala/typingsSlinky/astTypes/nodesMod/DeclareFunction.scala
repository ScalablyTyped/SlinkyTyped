...
object DeclareFunction {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.DeclareFunction): DeclareFunction = {
  ...
  implicit class DeclareFunctionOps[Self <: DeclareFunction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.DeclareFunction): Self = {
        val ret = this.duplicate
