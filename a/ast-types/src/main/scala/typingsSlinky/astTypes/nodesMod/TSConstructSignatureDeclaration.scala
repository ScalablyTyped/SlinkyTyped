...
object TSConstructSignatureDeclaration {
  ...
  @scala.inline
  implicit class TSConstructSignatureDeclarationOps[Self <: TSConstructSignatureDeclaration] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSConstructSignatureDeclaration): Self = {
        val ret = this.duplicate
