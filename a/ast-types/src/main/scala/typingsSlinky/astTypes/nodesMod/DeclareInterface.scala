...
@js.native
trait DeclareInterface extends ASTNode {
...
object DeclareInterface {
  ...
  @scala.inline
  implicit class DeclareInterfaceOps[Self <: DeclareInterface] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.DeclareInterface): Self = {
        val ret = this.duplicate
