...
object ObjectTypeCallProperty {
  ...
  @scala.inline
  implicit class ObjectTypeCallPropertyOps[Self <: ObjectTypeCallProperty] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ObjectTypeCallProperty): Self = {
        val ret = this.duplicate
