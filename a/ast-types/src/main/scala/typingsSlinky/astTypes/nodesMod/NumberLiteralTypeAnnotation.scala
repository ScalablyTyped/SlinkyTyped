...
trait NumberLiteralTypeAnnotation extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.NumberLiteralTypeAnnotation = js.native
...
object NumberLiteralTypeAnnotation {
  ...
  @scala.inline
  implicit class NumberLiteralTypeAnnotationOps[Self <: NumberLiteralTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.NumberLiteralTypeAnnotation): Self = {
        val ret = this.duplicate
