...
object ClassImplements {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.ClassImplements): ClassImplements = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClassImplements]
  }
  @scala.inline
  implicit class ClassImplementsOps[Self <: ClassImplements] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ClassImplements): Self = {
        val ret = this.duplicate
