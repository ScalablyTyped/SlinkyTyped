...
object ExportAllDeclaration {
  @scala.inline
  def apply(source: LiteralKind, `type`: typingsSlinky.astTypes.astTypesStrings.ExportAllDeclaration): ExportAllDeclaration = {
  ...
  implicit class ExportAllDeclarationOps[Self <: ExportAllDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ExportAllDeclaration): Self = {
        val ret = this.duplicate
