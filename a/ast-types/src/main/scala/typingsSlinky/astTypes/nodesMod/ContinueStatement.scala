...
object ContinueStatement {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.ContinueStatement): ContinueStatement = {
  ...
  implicit class ContinueStatementOps[Self <: ContinueStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ContinueStatement): Self = {
