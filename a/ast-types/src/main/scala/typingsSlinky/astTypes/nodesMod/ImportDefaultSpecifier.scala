...
object ImportDefaultSpecifier {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.ImportDefaultSpecifier): ImportDefaultSpecifier = {
  ...
  implicit class ImportDefaultSpecifierOps[Self <: ImportDefaultSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ImportDefaultSpecifier): Self = {
