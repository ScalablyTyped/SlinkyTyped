...
trait TypeParameter extends ASTNode {
  var bound: TypeAnnotationKind | Null = js.native
...
object TypeParameter {
  @scala.inline
  def apply(name: String, `type`: typingsSlinky.astTypes.astTypesStrings.TypeParameter): TypeParameter = {
  ...
  implicit class TypeParameterOps[Self <: TypeParameter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TypeParameter): Self = {
        val ret = this.duplicate
