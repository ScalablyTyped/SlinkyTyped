...
trait NullLiteral extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.NullLiteral = js.native
  var value: Null = js.native
}

object NullLiteral {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.NullLiteral, value: Null): NullLiteral = {
  ...
  implicit class NullLiteralOps[Self <: NullLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.NullLiteral): Self = {
