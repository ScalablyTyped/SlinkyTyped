...
trait IntersectionTypeAnnotation extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.IntersectionTypeAnnotation = js.native
...
object IntersectionTypeAnnotation {
  ...
  @scala.inline
  implicit class IntersectionTypeAnnotationOps[Self <: IntersectionTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.IntersectionTypeAnnotation): Self = {
