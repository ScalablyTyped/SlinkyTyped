...
object TSImportEqualsDeclaration {
  ...
  @scala.inline
  implicit class TSImportEqualsDeclarationOps[Self <: TSImportEqualsDeclaration] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSImportEqualsDeclaration): Self = {
        val ret = this.duplicate
