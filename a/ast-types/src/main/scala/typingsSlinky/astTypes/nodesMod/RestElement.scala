...
object RestElement {
  @scala.inline
  def apply(argument: PatternKind, `type`: typingsSlinky.astTypes.astTypesStrings.RestElement): RestElement = {
  ...
  implicit class RestElementOps[Self <: RestElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.RestElement): Self = {
        val ret = this.duplicate
