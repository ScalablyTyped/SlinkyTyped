...
object TSFunctionType {
  ...
  @scala.inline
  implicit class TSFunctionTypeOps[Self <: TSFunctionType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSFunctionType): Self = {
        val ret = this.duplicate
