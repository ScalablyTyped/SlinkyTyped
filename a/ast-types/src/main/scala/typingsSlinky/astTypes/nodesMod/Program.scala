...
trait Program extends ASTNode {
  ...
  var directives: js.Array[DirectiveKind] = js.native
  var interpreter: InterpreterDirectiveKind | Null = js.native
...
object Program {
  ...
  implicit class ProgramOps[Self <: Program] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.Program): Self = {
        val ret = this.duplicate
