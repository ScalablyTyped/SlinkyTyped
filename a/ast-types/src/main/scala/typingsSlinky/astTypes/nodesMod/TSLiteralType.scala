...
object TSLiteralType {
  ...
  @scala.inline
  implicit class TSLiteralTypeOps[Self <: TSLiteralType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSLiteralType): Self = {
        val ret = this.duplicate
