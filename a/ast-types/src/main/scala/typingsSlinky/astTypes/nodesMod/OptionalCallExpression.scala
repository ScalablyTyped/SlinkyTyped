...
object OptionalCallExpression {
  ...
  @scala.inline
  implicit class OptionalCallExpressionOps[Self <: OptionalCallExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.OptionalCallExpression): Self = {
        val ret = this.duplicate
