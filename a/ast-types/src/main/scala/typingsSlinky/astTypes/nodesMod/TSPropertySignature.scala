...
object TSPropertySignature {
  ...
  @scala.inline
  implicit class TSPropertySignatureOps[Self <: TSPropertySignature] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSPropertySignature): Self = {
        val ret = this.duplicate
