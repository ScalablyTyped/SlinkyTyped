...
object JSXIdentifier {
  @scala.inline
  def apply(name: String, optional: Boolean, `type`: typingsSlinky.astTypes.astTypesStrings.JSXIdentifier): JSXIdentifier = {
  ...
  implicit class JSXIdentifierOps[Self <: JSXIdentifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.JSXIdentifier): Self = {
        val ret = this.duplicate
