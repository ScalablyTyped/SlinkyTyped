...
object TSExpressionWithTypeArguments {
  ...
  @scala.inline
  implicit class TSExpressionWithTypeArgumentsOps[Self <: TSExpressionWithTypeArguments] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TSExpressionWithTypeArguments): Self = {
        val ret = this.duplicate
