...
trait ImportSpecifier extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.ImportSpecifier = js.native
}

object ImportSpecifier {
  @scala.inline
  def apply(imported: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.ImportSpecifier): ImportSpecifier = {
  ...
  implicit class ImportSpecifierOps[Self <: ImportSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImported(value: IdentifierKind): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imported")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ImportSpecifier): Self = {
        val ret = this.duplicate
