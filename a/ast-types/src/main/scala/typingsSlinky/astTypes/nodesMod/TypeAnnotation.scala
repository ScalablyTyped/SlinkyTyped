...
trait TypeAnnotation extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TypeAnnotation = js.native
  var typeAnnotation: FlowTypeKind = js.native
}

object TypeAnnotation {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.TypeAnnotation, typeAnnotation: FlowTypeKind): TypeAnnotation = {
  ...
  implicit class TypeAnnotationOps[Self <: TypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.TypeAnnotation): Self = {
