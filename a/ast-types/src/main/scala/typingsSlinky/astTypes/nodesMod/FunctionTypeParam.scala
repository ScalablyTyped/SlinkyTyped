...
trait FunctionTypeParam extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.FunctionTypeParam = js.native
...
object FunctionTypeParam {
  ...
  implicit class FunctionTypeParamOps[Self <: FunctionTypeParam] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.FunctionTypeParam): Self = {
        val ret = this.duplicate
