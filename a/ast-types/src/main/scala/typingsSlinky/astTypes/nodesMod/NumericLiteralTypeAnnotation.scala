...
object NumericLiteralTypeAnnotation {
  ...
  @scala.inline
  implicit class NumericLiteralTypeAnnotationOps[Self <: NumericLiteralTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.NumericLiteralTypeAnnotation): Self = {
        val ret = this.duplicate
