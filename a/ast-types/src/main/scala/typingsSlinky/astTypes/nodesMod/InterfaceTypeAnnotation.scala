...
trait InterfaceTypeAnnotation extends ASTNode {
  ...
  var `extends`: js.Array[InterfaceExtendsKind] | Null = js.native
...
object InterfaceTypeAnnotation {
  ...
  @scala.inline
  implicit class InterfaceTypeAnnotationOps[Self <: InterfaceTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.InterfaceTypeAnnotation): Self = {
        val ret = this.duplicate
