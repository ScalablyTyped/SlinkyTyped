...
trait ReturnStatement extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.ReturnStatement = js.native
}

object ReturnStatement {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.ReturnStatement): ReturnStatement = {
  ...
  implicit class ReturnStatementOps[Self <: ReturnStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ReturnStatement): Self = {
