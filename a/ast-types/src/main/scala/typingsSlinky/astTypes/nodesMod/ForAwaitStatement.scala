...
@js.native
trait ForAwaitStatement extends ASTNode {
...
object ForAwaitStatement {
  ...
  @scala.inline
  implicit class ForAwaitStatementOps[Self <: ForAwaitStatement] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ForAwaitStatement): Self = {
        val ret = this.duplicate
