...
object DeclareVariable {
  @scala.inline
  def apply(id: IdentifierKind, `type`: typingsSlinky.astTypes.astTypesStrings.DeclareVariable): DeclareVariable = {
  ...
  implicit class DeclareVariableOps[Self <: DeclareVariable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.DeclareVariable): Self = {
        val ret = this.duplicate
