...
object File {
  @scala.inline
  def apply(program: ProgramKind, `type`: typingsSlinky.astTypes.astTypesStrings.File): File = {
  ...
  implicit class FileOps[Self <: File] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.File): Self = {
        val ret = this.duplicate
