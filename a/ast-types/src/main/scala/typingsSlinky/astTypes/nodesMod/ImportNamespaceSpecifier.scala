...
object ImportNamespaceSpecifier {
  @scala.inline
  def apply(`type`: typingsSlinky.astTypes.astTypesStrings.ImportNamespaceSpecifier): ImportNamespaceSpecifier = {
  ...
  implicit class ImportNamespaceSpecifierOps[Self <: ImportNamespaceSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ImportNamespaceSpecifier): Self = {
