...
object StringLiteralTypeAnnotation {
  ...
  @scala.inline
  implicit class StringLiteralTypeAnnotationOps[Self <: StringLiteralTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.StringLiteralTypeAnnotation): Self = {
        val ret = this.duplicate
