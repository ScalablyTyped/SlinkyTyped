...
@js.native
trait ThrowStatement extends ASTNode {
  var argument: ExpressionKind = js.native
  var comments: js.UndefOr[js.Array[CommentKind]] = js.native
  var loc: js.UndefOr[SourceLocationKind] = js.native
  var `type`: typingsSlinky.astTypes.astTypesStrings.ThrowStatement = js.native
}

object ThrowStatement {
  @scala.inline
  def apply(argument: ExpressionKind, `type`: typingsSlinky.astTypes.astTypesStrings.ThrowStatement): ThrowStatement = {
  ...
  implicit class ThrowStatementOps[Self <: ThrowStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ThrowStatement): Self = {
        val ret = this.duplicate
