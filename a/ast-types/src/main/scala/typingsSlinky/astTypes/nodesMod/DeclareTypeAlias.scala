...
object DeclareTypeAlias {
  ...
  @scala.inline
  implicit class DeclareTypeAliasOps[Self <: DeclareTypeAlias] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.DeclareTypeAlias): Self = {
        val ret = this.duplicate
