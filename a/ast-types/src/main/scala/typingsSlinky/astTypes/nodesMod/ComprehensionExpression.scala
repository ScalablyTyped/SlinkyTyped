...
object ComprehensionExpression {
  ...
  @scala.inline
  implicit class ComprehensionExpressionOps[Self <: ComprehensionExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ComprehensionExpression): Self = {
        val ret = this.duplicate
