...
trait MemberExpression extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.MemberExpression = js.native
}
...
object MemberExpression {
  ...
  implicit class MemberExpressionOps[Self <: MemberExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.MemberExpression): Self = {
        val ret = this.duplicate
