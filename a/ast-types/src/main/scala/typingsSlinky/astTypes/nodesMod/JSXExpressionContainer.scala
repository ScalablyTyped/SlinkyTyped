...
object JSXExpressionContainer {
  @scala.inline
  def apply(expression: ExpressionKind, `type`: typingsSlinky.astTypes.astTypesStrings.JSXExpressionContainer): JSXExpressionContainer = {
  ...
  implicit class JSXExpressionContainerOps[Self <: JSXExpressionContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.JSXExpressionContainer): Self = {
        val ret = this.duplicate
