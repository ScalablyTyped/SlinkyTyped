...
trait ParenthesizedExpression extends ASTNode {
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.ParenthesizedExpression = js.native
}

object ParenthesizedExpression {
  @scala.inline
  def apply(expression: ExpressionKind, `type`: typingsSlinky.astTypes.astTypesStrings.ParenthesizedExpression): ParenthesizedExpression = {
  ...
  implicit class ParenthesizedExpressionOps[Self <: ParenthesizedExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: typingsSlinky.astTypes.astTypesStrings.ParenthesizedExpression): Self = {
        val ret = this.duplicate
