...
object AnonBodyComments {
  @scala.inline
  def apply(body: StatementKind, left: VariableDeclarationKind | PatternKind, right: ExpressionKind): AnonBodyComments = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyComments]
  }
  @scala.inline
  implicit class AnonBodyCommentsOps[Self <: AnonBodyComments] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLeft(value: VariableDeclarationKind | PatternKind): Self = {
        val ret = this.duplicate
