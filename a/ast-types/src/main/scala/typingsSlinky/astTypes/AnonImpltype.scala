...
object AnonImpltype {
  @scala.inline
  def apply(id: IdentifierKind, impltype: FlowTypeKind, supertype: FlowTypeKind): AnonImpltype = {
  ...
  @scala.inline
  implicit class AnonImpltypeOps[Self <: AnonImpltype] (val x: Self) extends AnyVal {
    @scala.inline
