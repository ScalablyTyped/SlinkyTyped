...
object AnonBodyCommentsId {
  @scala.inline
  def apply(body: BlockStatementKind, id: IdentifierKind | LiteralKind): AnonBodyCommentsId = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyCommentsId]
  }
  @scala.inline
  implicit class AnonBodyCommentsIdOps[Self <: AnonBodyCommentsId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withId(value: IdentifierKind | LiteralKind): Self = {
        val ret = this.duplicate
