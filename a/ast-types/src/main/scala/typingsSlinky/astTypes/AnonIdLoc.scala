...
object AnonIdLoc {
  @scala.inline
  def apply(id: IdentifierKind | QualifiedTypeIdentifierKind): AnonIdLoc = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIdLoc]
  }
  @scala.inline
  implicit class AnonIdLocOps[Self <: AnonIdLoc] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withId(value: IdentifierKind | QualifiedTypeIdentifierKind): Self = {
