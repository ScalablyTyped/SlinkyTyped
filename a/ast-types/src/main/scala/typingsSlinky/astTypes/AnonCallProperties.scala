...
object AnonCallProperties {
  @scala.inline
  def apply(properties: js.Array[ObjectTypePropertyKind | ObjectTypeSpreadPropertyKind]): AnonCallProperties = {
    val __obj = js.Dynamic.literal(properties = properties.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCallProperties]
  }
  @scala.inline
  implicit class AnonCallPropertiesOps[Self <: AnonCallProperties] (val x: Self) extends AnyVal {
    @scala.inline
