...
object AnonGenerator {
  @scala.inline
  def apply(body: BlockStatementKind | ExpressionKind, params: js.Array[PatternKind]): AnonGenerator = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], params = params.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonGenerator]
  }
  @scala.inline
  implicit class AnonGeneratorOps[Self <: AnonGenerator] (val x: Self) extends AnyVal {
    @scala.inline
