...
trait Directive
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.Directive = js.native
...
object Directive {
  ...
  implicit class DirectiveMutableBuilder[Self <: Directive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.Directive): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
