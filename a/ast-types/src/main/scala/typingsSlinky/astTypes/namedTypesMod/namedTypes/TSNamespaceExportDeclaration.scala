...
trait TSNamespaceExportDeclaration
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSNamespaceExportDeclaration = js.native
}
object TSNamespaceExportDeclaration {
  ...
  implicit class TSNamespaceExportDeclarationMutableBuilder[Self <: TSNamespaceExportDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSNamespaceExportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
