...
trait ChainExpression
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.ChainExpression = js.native
}
object ChainExpression {
  ...
  implicit class ChainExpressionMutableBuilder[Self <: ChainExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ChainExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
