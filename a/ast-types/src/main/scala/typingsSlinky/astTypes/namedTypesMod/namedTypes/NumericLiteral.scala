...
object NumericLiteral {
  ...
  @js.native
  val ^ : Type[NumericLiteral] = js.native
  ...
  implicit class NumericLiteralMutableBuilder[Self <: NumericLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.NumericLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
