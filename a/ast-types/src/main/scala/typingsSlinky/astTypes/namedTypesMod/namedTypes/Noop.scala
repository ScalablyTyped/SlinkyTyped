...
trait Noop
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.Noop = js.native
}
object Noop {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.Noop")
  @js.native
  val ^ : Type[Noop] = js.native
  ...
  implicit class NoopMutableBuilder[Self <: Noop] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.Noop): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
