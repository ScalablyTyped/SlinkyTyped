...
object EnumDeclaration {
  ...
  @js.native
  val ^ : Type[EnumDeclaration] = js.native
  ...
  implicit class EnumDeclarationMutableBuilder[Self <: EnumDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.EnumDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
