...
trait TSConstructSignatureDeclaration
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSConstructSignatureDeclaration = js.native
...
object TSConstructSignatureDeclaration {
  ...
  @js.native
  val ^ : Type[TSConstructSignatureDeclaration] = js.native
  ...
  implicit class TSConstructSignatureDeclarationMutableBuilder[Self <: TSConstructSignatureDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSConstructSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
