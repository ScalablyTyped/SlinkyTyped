...
trait DeclareVariable
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.DeclareVariable = js.native
}
object DeclareVariable {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.DeclareVariable")
  @js.native
  val ^ : Type[DeclareVariable] = js.native
  ...
  implicit class DeclareVariableMutableBuilder[Self <: DeclareVariable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.DeclareVariable): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
