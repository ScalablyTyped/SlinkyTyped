...
trait NullableTypeAnnotation
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.NullableTypeAnnotation = js.native
...
object NullableTypeAnnotation {
  ...
  @scala.inline
  implicit class NullableTypeAnnotationMutableBuilder[Self <: NullableTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.NullableTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
