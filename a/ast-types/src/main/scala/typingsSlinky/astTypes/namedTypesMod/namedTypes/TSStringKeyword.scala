...
object TSStringKeyword {
  ...
  @js.native
  val ^ : Type[TSStringKeyword] = js.native
  ...
  implicit class TSStringKeywordMutableBuilder[Self <: TSStringKeyword] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSStringKeyword): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
