...
object ClassPrivateProperty {
  ...
  @scala.inline
  implicit class ClassPrivatePropertyMutableBuilder[Self <: ClassPrivateProperty] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ClassPrivateProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
