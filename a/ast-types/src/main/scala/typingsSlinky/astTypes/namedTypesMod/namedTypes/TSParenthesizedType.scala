...
trait TSParenthesizedType
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSParenthesizedType = js.native
...
object TSParenthesizedType {
  ...
  @js.native
  val ^ : Type[TSParenthesizedType] = js.native
  ...
  implicit class TSParenthesizedTypeMutableBuilder[Self <: TSParenthesizedType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSParenthesizedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
