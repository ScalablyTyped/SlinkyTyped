...
trait JSXSpreadChild
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.JSXSpreadChild = js.native
}
object JSXSpreadChild {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.JSXSpreadChild")
  @js.native
  val ^ : Type[JSXSpreadChild] = js.native
  ...
  implicit class JSXSpreadChildMutableBuilder[Self <: JSXSpreadChild] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.JSXSpreadChild): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
