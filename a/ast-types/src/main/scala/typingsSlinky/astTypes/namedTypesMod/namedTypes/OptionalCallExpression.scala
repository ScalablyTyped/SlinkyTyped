...
object OptionalCallExpression {
  ...
  @js.native
  val ^ : Type[OptionalCallExpression] = js.native
  
  @scala.inline
  implicit class OptionalCallExpressionMutableBuilder[Self <: OptionalCallExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.OptionalCallExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
