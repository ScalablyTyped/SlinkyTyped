...
object TSTypeAssertion {
  ...
  @js.native
  val ^ : Type[TSTypeAssertion] = js.native
  ...
  implicit class TSTypeAssertionMutableBuilder[Self <: TSTypeAssertion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSTypeAssertion): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
