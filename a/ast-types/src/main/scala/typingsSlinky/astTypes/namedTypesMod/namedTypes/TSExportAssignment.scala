...
trait TSExportAssignment
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSExportAssignment = js.native
}
object TSExportAssignment {
  ...
  implicit class TSExportAssignmentMutableBuilder[Self <: TSExportAssignment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSExportAssignment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
