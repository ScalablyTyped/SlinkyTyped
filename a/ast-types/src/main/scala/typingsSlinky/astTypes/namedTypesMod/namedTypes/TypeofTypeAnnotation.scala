...
object TypeofTypeAnnotation {
  ...
  @js.native
  val ^ : Type[TypeofTypeAnnotation] = js.native
  
  @scala.inline
  implicit class TypeofTypeAnnotationMutableBuilder[Self <: TypeofTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TypeofTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
