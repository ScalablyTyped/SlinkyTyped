...
trait UpdateExpression
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.UpdateExpression = js.native
}
object UpdateExpression {
  ...
  implicit class UpdateExpressionMutableBuilder[Self <: UpdateExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.UpdateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
