...
object ComprehensionBlock {
  ...
  @scala.inline
  implicit class ComprehensionBlockMutableBuilder[Self <: ComprehensionBlock] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ComprehensionBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
