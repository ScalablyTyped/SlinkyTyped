...
object SequenceExpression {
  ...
  @js.native
  val ^ : Type[SequenceExpression] = js.native
  ...
  implicit class SequenceExpressionMutableBuilder[Self <: SequenceExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.SequenceExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
