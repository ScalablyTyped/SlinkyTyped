...
object BooleanLiteral {
  ...
  @js.native
  val ^ : Type[BooleanLiteral] = js.native
  ...
  implicit class BooleanLiteralMutableBuilder[Self <: BooleanLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.BooleanLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
