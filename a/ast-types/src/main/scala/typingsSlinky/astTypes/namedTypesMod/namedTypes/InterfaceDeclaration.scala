...
trait InterfaceDeclaration
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.InterfaceDeclaration = js.native
...
object InterfaceDeclaration {
  ...
  @js.native
  val ^ : Type[InterfaceDeclaration] = js.native
  ...
  implicit class InterfaceDeclarationMutableBuilder[Self <: InterfaceDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.InterfaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
