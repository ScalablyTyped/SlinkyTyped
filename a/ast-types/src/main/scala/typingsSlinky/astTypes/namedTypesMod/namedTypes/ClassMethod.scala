...
object ClassMethod {
  ...
  @js.native
  val ^ : Type[ClassMethod] = js.native
  
  @scala.inline
  implicit class ClassMethodMutableBuilder[Self <: ClassMethod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ClassMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
