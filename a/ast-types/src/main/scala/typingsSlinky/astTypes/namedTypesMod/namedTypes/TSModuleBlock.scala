...
object TSModuleBlock {
  ...
  @js.native
  val ^ : Type[TSModuleBlock] = js.native
  ...
  implicit class TSModuleBlockMutableBuilder[Self <: TSModuleBlock] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSModuleBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
