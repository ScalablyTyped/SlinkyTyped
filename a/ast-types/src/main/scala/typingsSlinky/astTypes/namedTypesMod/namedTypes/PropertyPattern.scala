...
object PropertyPattern {
  ...
  @js.native
  val ^ : Type[PropertyPattern] = js.native
  
  @scala.inline
  implicit class PropertyPatternMutableBuilder[Self <: PropertyPattern] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.PropertyPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
