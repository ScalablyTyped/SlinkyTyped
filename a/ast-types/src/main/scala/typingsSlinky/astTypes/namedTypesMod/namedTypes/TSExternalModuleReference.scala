...
trait TSExternalModuleReference
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSExternalModuleReference = js.native
}
object TSExternalModuleReference {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.TSExternalModuleReference")
  @js.native
  val ^ : Type[TSExternalModuleReference] = js.native
  ...
  implicit class TSExternalModuleReferenceMutableBuilder[Self <: TSExternalModuleReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSExternalModuleReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
