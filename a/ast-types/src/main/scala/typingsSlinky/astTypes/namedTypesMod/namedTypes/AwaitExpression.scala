...
trait AwaitExpression
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.AwaitExpression = js.native
}
object AwaitExpression {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.AwaitExpression")
  @js.native
  val ^ : Type[AwaitExpression] = js.native
  ...
  implicit class AwaitExpressionMutableBuilder[Self <: AwaitExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.AwaitExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
