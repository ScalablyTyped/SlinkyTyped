...
object ExistentialTypeParam {
  ...
  @scala.inline
  implicit class ExistentialTypeParamMutableBuilder[Self <: ExistentialTypeParam] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ExistentialTypeParam): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
