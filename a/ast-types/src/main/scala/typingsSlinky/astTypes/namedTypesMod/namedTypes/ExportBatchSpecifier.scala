...
object ExportBatchSpecifier {
  ...
  @js.native
  val ^ : Type[ExportBatchSpecifier] = js.native
  
  @scala.inline
  implicit class ExportBatchSpecifierMutableBuilder[Self <: ExportBatchSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ExportBatchSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
