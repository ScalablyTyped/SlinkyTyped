...
object MemberTypeAnnotation {
  ...
  @scala.inline
  implicit class MemberTypeAnnotationMutableBuilder[Self <: MemberTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.MemberTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
