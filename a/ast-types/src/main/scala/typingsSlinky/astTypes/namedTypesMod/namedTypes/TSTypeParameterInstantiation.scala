...
trait TSTypeParameterInstantiation
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.TSTypeParameterInstantiation = js.native
}
object TSTypeParameterInstantiation {
  ...
  implicit class TSTypeParameterInstantiationMutableBuilder[Self <: TSTypeParameterInstantiation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSTypeParameterInstantiation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
