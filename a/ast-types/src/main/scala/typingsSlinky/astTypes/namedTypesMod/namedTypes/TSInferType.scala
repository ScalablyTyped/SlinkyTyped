...
object TSInferType {
  ...
  @js.native
  val ^ : Type[TSInferType] = js.native
  
  @scala.inline
  implicit class TSInferTypeMutableBuilder[Self <: TSInferType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.TSInferType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
