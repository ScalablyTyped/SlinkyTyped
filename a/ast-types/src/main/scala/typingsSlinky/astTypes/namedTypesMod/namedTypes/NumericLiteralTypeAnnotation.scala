...
object NumericLiteralTypeAnnotation {
  ...
  @js.native
  val ^ : Type[NumericLiteralTypeAnnotation] = js.native
  
  @scala.inline
  implicit class NumericLiteralTypeAnnotationMutableBuilder[Self <: NumericLiteralTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.NumericLiteralTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
