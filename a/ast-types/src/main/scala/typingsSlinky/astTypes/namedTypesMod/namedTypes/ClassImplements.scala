...
trait ClassImplements
  ...
  var `type`: typingsSlinky.astTypes.astTypesStrings.ClassImplements = js.native
...
object ClassImplements {
  ...
  implicit class ClassImplementsMutableBuilder[Self <: ClassImplements] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typingsSlinky.astTypes.astTypesStrings.ClassImplements): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
