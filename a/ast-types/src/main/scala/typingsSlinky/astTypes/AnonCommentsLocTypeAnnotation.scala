...
object AnonCommentsLocTypeAnnotation {
  @scala.inline
  def apply(typeAnnotation: TSTypeKind | TSTypeAnnotationKind): AnonCommentsLocTypeAnnotation = {
    val __obj = js.Dynamic.literal(typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsLocTypeAnnotation]
  }
  @scala.inline
  implicit class AnonCommentsLocTypeAnnotationOps[Self <: AnonCommentsLocTypeAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withTypeAnnotation(value: TSTypeKind | TSTypeAnnotationKind): Self = {
