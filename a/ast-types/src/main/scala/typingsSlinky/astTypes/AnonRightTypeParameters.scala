...
object AnonRightTypeParameters {
  @scala.inline
  def apply(id: IdentifierKind, right: FlowTypeKind): AnonRightTypeParameters = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonRightTypeParameters]
  }
  @scala.inline
  implicit class AnonRightTypeParametersOps[Self <: AnonRightTypeParameters] (val x: Self) extends AnyVal {
    @scala.inline
