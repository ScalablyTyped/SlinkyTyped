...
object IsExport {
  ...
  @scala.inline
  implicit class IsExportOps[Self <: IsExport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModuleReference(value: IdentifierKind | TSQualifiedNameKind | TSExternalModuleReferenceKind): Self = this.set("moduleReference", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteIsExport: Self = this.set("isExport", js.undefined)
