...
object CommentsLocValue {
  ...
  @scala.inline
  implicit class CommentsLocValueOps[Self <: CommentsLocValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: DirectiveLiteralKind): Self = this.set("value", value.asInstanceOf[js.Any])
