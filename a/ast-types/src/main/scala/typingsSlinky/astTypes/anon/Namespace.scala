...
object Namespace {
  ...
  implicit class NamespaceOps[Self <: Namespace] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: JSXIdentifierKind): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNamespace(value: JSXIdentifierKind): Self = this.set("namespace", value.asInstanceOf[js.Any])
