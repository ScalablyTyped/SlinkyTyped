...
object ArgumentFlowTypeKind {
  ...
  @scala.inline
  implicit class ArgumentFlowTypeKindOps[Self <: ArgumentFlowTypeKind] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgument(value: FlowTypeKind): Self = this.set("argument", value.asInstanceOf[js.Any])
