...
object CommentsLabel {
  ...
  @scala.inline
  def apply(): CommentsLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommentsLabel]
  }
  
  @scala.inline
  implicit class CommentsLabelOps[Self <: CommentsLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabel(value: IdentifierKind): Self = this.set("label", value.asInstanceOf[js.Any])
