...
object Array {
  ...
  implicit class ArrayOps[Self <: Array] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDate(value: Type[js.Date]): Self = this.set("Date", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRegExp(value: Type[js.RegExp]): Self = this.set("RegExp", value.asInstanceOf[js.Any])
