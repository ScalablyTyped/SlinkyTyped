...
object Left {
  ...
  @scala.inline
  def apply(body: StatementKind, left: VariableDeclarationKind | ExpressionKind, right: ExpressionKind): Left = {
  ...
  implicit class LeftOps[Self <: Left] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeft(value: VariableDeclarationKind | ExpressionKind): Self = this.set("left", value.asInstanceOf[js.Any])
