...
@js.native
trait TypeAnnotationTSTypeKind extends js.Object {
...
object TypeAnnotationTSTypeKind {
  @scala.inline
  def apply(typeAnnotation: TSTypeKind): TypeAnnotationTSTypeKind = {
    val __obj = js.Dynamic.literal(typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[TypeAnnotationTSTypeKind]
  }
  @scala.inline
  implicit class TypeAnnotationTSTypeKindOps[Self <: TypeAnnotationTSTypeKind] (val x: Self) extends AnyVal {
    @scala.inline
