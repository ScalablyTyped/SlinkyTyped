...
object LocObject {
  ...
  implicit class LocObjectOps[Self <: LocObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObject(value: IdentifierKind): Self = this.set("object", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProperty(value: MemberTypeAnnotationKind | GenericTypeAnnotationKind): Self = this.set("property", value.asInstanceOf[js.Any])
