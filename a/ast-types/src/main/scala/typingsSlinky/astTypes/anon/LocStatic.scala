...
@js.native
trait LocStatic extends js.Object {
...
object LocStatic {
  ...
  @scala.inline
  implicit class LocStaticOps[Self <: LocStatic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: FunctionTypeAnnotationKind): Self = this.set("value", value.asInstanceOf[js.Any])
