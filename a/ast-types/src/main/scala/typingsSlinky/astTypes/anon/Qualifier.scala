...
object Qualifier {
  ...
  implicit class QualifierOps[Self <: Qualifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArgument(value: StringLiteralKind): Self = this.set("argument", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQualifier(value: IdentifierKind | TSQualifiedNameKind): Self = this.set("qualifier", value.asInstanceOf[js.Any])
