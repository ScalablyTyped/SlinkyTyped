...
@js.native
trait RightTypeParameters extends js.Object {
...
object RightTypeParameters {
  ...
  @scala.inline
  implicit class RightTypeParametersOps[Self <: RightTypeParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRight(value: FlowTypeKind): Self = this.set("right", value.asInstanceOf[js.Any])
