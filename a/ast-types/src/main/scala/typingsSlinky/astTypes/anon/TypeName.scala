...
object TypeName {
  ...
  @scala.inline
  def apply(typeName: IdentifierKind | TSQualifiedNameKind): TypeName = {
    val __obj = js.Dynamic.literal(typeName = typeName.asInstanceOf[js.Any])
    __obj.asInstanceOf[TypeName]
  }
  
  @scala.inline
  implicit class TypeNameOps[Self <: TypeName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeName(value: IdentifierKind | TSQualifiedNameKind): Self = this.set("typeName", value.asInstanceOf[js.Any])
