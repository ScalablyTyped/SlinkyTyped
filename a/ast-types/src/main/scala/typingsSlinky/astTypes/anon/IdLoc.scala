...
object IdLoc {
  ...
  @scala.inline
  implicit class IdLocOps[Self <: IdLoc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setId(value: IdentifierKind | QualifiedTypeIdentifierKind): Self = this.set("id", value.asInstanceOf[js.Any])
