...
@js.native
trait ArgumentComments extends StObject {
...
object ArgumentComments {
  ...
  @scala.inline
  def apply(argument: ExpressionKind): ArgumentComments = {
    val __obj = js.Dynamic.literal(argument = argument.asInstanceOf[js.Any])
    __obj.asInstanceOf[ArgumentComments]
  }
  
  @scala.inline
  implicit class ArgumentCommentsMutableBuilder[Self <: ArgumentComments] (val x: Self) extends AnyVal {
