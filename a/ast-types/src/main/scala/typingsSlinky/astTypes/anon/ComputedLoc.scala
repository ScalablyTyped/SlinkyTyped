...
object ComputedLoc {
  @scala.inline
  def apply(`object`: ExpressionKind, property: IdentifierKind | ExpressionKind): ComputedLoc = {
    val __obj = js.Dynamic.literal(property = property.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComputedLoc]
  }
  @scala.inline
  implicit class ComputedLocOps[Self <: ComputedLoc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withProperty(value: IdentifierKind | ExpressionKind): Self = {
        val ret = this.duplicate
