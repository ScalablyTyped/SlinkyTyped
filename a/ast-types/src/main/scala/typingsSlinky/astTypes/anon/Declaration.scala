...
object Declaration {
  ...
  implicit class DeclarationOps[Self <: Declaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeclaration(value: DeclarationKind): Self = this.set("declaration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSpecifiersVarargs(value: ExportSpecifierKind*): Self = this.set("specifiers", js.Array(value :_*))
    
    @scala.inline
    def setSpecifiers(value: js.Array[ExportSpecifierKind]): Self = this.set("specifiers", value.asInstanceOf[js.Any])
