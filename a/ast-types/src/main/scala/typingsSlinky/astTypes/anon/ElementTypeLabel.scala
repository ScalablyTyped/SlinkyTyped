...
@js.native
trait ElementTypeLabel extends js.Object {
...
object ElementTypeLabel {
  ...
  @scala.inline
  implicit class ElementTypeLabelOps[Self <: ElementTypeLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setElementType(value: TSTypeKind): Self = this.set("elementType", value.asInstanceOf[js.Any])
