...
object CommentsExtra {
  ...
  @scala.inline
  implicit class CommentsExtraOps[Self <: CommentsExtra] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtra(value: RawString): Self = this.set("extra", value.asInstanceOf[js.Any])
