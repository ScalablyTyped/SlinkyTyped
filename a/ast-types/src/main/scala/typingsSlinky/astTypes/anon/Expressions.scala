...
@js.native
trait Expressions extends js.Object {
...
object Expressions {
  @scala.inline
  def apply(expressions: js.Array[ExpressionKind]): Expressions = {
    val __obj = js.Dynamic.literal(expressions = expressions.asInstanceOf[js.Any])
    __obj.asInstanceOf[Expressions]
  }
  @scala.inline
  implicit class ExpressionsOps[Self <: Expressions] (val x: Self) extends AnyVal {
    @scala.inline
