...
object AnonCommentsLeftLoc {
  @scala.inline
  def apply(left: IdentifierKind | TSQualifiedNameKind, right: IdentifierKind | TSQualifiedNameKind): AnonCommentsLeftLoc = {
    val __obj = js.Dynamic.literal(left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsLeftLoc]
  }
  @scala.inline
  implicit class AnonCommentsLeftLocOps[Self <: AnonCommentsLeftLoc] (val x: Self) extends AnyVal {
    @scala.inline
