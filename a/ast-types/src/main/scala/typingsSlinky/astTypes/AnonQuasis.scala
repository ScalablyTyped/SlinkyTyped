...
object AnonQuasis {
  @scala.inline
  def apply(expressions: js.Array[ExpressionKind], quasis: js.Array[TemplateElementKind]): AnonQuasis = {
    val __obj = js.Dynamic.literal(expressions = expressions.asInstanceOf[js.Any], quasis = quasis.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonQuasis]
  }
  @scala.inline
  implicit class AnonQuasisOps[Self <: AnonQuasis] (val x: Self) extends AnyVal {
    @scala.inline
