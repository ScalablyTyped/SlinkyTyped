...
object AnonAbstractAccess {
  @scala.inline
  def apply(body: BlockStatementKind, key: PrivateNameKind, params: js.Array[PatternKind]): AnonAbstractAccess = {
  ...
  @scala.inline
  implicit class AnonAbstractAccessOps[Self <: AnonAbstractAccess] (val x: Self) extends AnyVal {
    @scala.inline
