...
object AnonAlternateComments {
  @scala.inline
  def apply(alternate: ExpressionKind, consequent: ExpressionKind, test: ExpressionKind): AnonAlternateComments = {
    val __obj = js.Dynamic.literal(alternate = alternate.asInstanceOf[js.Any], consequent = consequent.asInstanceOf[js.Any], test = test.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAlternateComments]
  }
  @scala.inline
  implicit class AnonAlternateCommentsOps[Self <: AnonAlternateComments] (val x: Self) extends AnyVal {
    @scala.inline
