...
object AnonElements {
  @scala.inline
  def apply(elements: js.Array[ExpressionKind | SpreadElementKind | RestElementKind | Null]): AnonElements = {
  ...
  implicit class AnonElementsOps[Self <: AnonElements] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withElements(value: js.Array[ExpressionKind | SpreadElementKind | RestElementKind | Null]): Self = {
