...
object AnonCommentsDeclare {
  @scala.inline
  def apply(id: IdentifierKind, typeAnnotation: TSTypeKind): AnonCommentsDeclare = {
  ...
  @scala.inline
  implicit class AnonCommentsDeclareOps[Self <: AnonCommentsDeclare] (val x: Self) extends AnyVal {
    @scala.inline
