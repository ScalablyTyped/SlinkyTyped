...
object AnonLocName {
  @scala.inline
  def apply(name: JSXIdentifierKind | JSXNamespacedNameKind | JSXMemberExpressionKind): AnonLocName = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLocName]
  }
  @scala.inline
  implicit class AnonLocNameOps[Self <: AnonLocName] (val x: Self) extends AnyVal {
    @scala.inline
