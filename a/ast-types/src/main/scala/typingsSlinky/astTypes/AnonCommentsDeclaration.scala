...
object AnonCommentsDeclaration {
  @scala.inline
  def apply(declaration: DeclarationKind | ExpressionKind): AnonCommentsDeclaration = {
    val __obj = js.Dynamic.literal(declaration = declaration.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCommentsDeclaration]
  }
  @scala.inline
  implicit class AnonCommentsDeclarationOps[Self <: AnonCommentsDeclaration] (val x: Self) extends AnyVal {
    @scala.inline
