...
object AnonTypeAnnotationTSTypeKind {
  @scala.inline
  def apply(typeAnnotation: TSTypeKind): AnonTypeAnnotationTSTypeKind = {
    val __obj = js.Dynamic.literal(typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonTypeAnnotationTSTypeKind]
  }
  @scala.inline
  implicit class AnonTypeAnnotationTSTypeKindOps[Self <: AnonTypeAnnotationTSTypeKind] (val x: Self) extends AnyVal {
    @scala.inline
