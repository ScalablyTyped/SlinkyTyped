...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "antd" % "4.8.4-3e371f",
  "org.scalablytyped.slinky" %%% "antv__g2" % "3.5.15-874d52",
  "org.scalablytyped.slinky" %%% "bizcharts" % "3.5.9-ba8b00",
