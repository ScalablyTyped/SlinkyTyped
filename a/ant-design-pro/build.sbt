...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "antd" % "4.5.1-a1c672",
  "org.scalablytyped.slinky" %%% "antv__g2" % "3.5.15-2b551e",
  "org.scalablytyped.slinky" %%% "bizcharts" % "3.5.9-b29dec",
