...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "antd" % "4.0.4-a77974",
  "org.scalablytyped.slinky" %%% "antv__g2" % "3.5.9-cf73be",
  "org.scalablytyped.slinky" %%% "bizcharts" % "3.5.6-8b94ce",
