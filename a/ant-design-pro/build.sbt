...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "antd" % "4.2.4-177437",
  "org.scalablytyped.slinky" %%% "antv__g2" % "3.5.9-6fe08a",
  "org.scalablytyped.slinky" %%% "bizcharts" % "3.5.6-f3db40",
