...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "antd" % "4.8.5-d1d30d",
  "org.scalablytyped.slinky" %%% "antv__g2" % "3.5.15-a636a5",
  "org.scalablytyped.slinky" %%% "bizcharts" % "3.5.9-f48502",
