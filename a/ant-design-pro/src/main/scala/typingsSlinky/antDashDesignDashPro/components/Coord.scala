...
object Coord
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Coord] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Coord] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Coord] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Coord](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
