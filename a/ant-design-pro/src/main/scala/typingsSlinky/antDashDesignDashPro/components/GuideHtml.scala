...
import typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.Html
...
object GuideHtml
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Html] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.Html](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
