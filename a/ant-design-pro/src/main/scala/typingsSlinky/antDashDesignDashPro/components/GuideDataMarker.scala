...
import typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.DataMarker
...
object GuideDataMarker
  ...
  typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.DataMarker](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
