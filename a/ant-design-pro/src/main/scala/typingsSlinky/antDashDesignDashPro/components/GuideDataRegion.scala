...
import typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.DataRegion
...
object GuideDataRegion
  ...
  typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.DataRegion](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
