...
import typingsSlinky.antDashDesignDashPro.libNoticeIconMod.NoticeIconProps
import typingsSlinky.antDashDesignDashPro.libNoticeIconMod.default
...
object NoticeIcon
  ...
  typingsSlinky.antDashDesignDashPro.libNoticeIconMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
