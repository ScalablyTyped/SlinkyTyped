...
import typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.Region
import typingsSlinky.atAntvG2.atAntvG2Mod.Styles.background
import typingsSlinky.bizcharts.bizchartsMod.Guide.RegionProps
...
object GuideRegion
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Region] = new slinky.core.BuildingComponent[
  slinky.web.html.`*`.tag.type, 
  typingsSlinky.antDashDesignDashPro.libChartsBizchartsMod.Guide.Region](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
