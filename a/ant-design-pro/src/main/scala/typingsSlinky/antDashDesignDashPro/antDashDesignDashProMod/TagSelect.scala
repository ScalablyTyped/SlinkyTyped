package typingsSlinky.antDashDesignDashPro.antDashDesignDashProMod

import typingsSlinky.antDashDesignDashPro.TypeofClassTagSelectOption
...
@js.native
class TagSelect () extends default
