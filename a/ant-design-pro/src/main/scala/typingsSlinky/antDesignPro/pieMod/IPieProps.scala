...
trait IPieProps extends js.Object {
  ...
  var valueFormat: js.UndefOr[js.Function1[/* value */ String, String | ReactElement]] = js.native
}
...
object IPieProps {
  ...
  implicit class IPiePropsOps[Self <: IPieProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueFormat(value: /* value */ String => String | ReactElement): Self = this.set("valueFormat", js.Any.fromFunction1(value))
    @scala.inline
