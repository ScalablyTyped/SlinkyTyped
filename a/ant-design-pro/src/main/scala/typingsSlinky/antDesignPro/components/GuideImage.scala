...
import typingsSlinky.antDesignPro.bizchartsMod.Guide.Image
...
object GuideImage
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Image] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignPro.bizchartsMod.Guide.Image](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
