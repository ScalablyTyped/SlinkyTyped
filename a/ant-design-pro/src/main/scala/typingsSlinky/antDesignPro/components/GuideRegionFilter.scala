...
import typingsSlinky.antDesignPro.bizchartsMod.Guide.RegionFilter
...
object GuideRegionFilter
  ...
  typingsSlinky.antDesignPro.bizchartsMod.Guide.RegionFilter](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
