...
import typingsSlinky.antDesignPro.bizchartsMod.Guide.DataRegion
...
object GuideDataRegion
  ...
  typingsSlinky.antDesignPro.bizchartsMod.Guide.DataRegion](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
