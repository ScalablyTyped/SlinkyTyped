...
object Chart
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antDesignPro.bizchartsMod.Chart] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antDesignPro.bizchartsMod.Chart] = {
