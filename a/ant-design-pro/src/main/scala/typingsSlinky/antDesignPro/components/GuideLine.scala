...
object GuideLine
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Line] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignPro.bizchartsMod.Guide.Line](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
