...
import typingsSlinky.antDesignPro.bizchartsMod.Guide.Region
...
object GuideRegion
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, Region] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignPro.bizchartsMod.Guide.Region](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
