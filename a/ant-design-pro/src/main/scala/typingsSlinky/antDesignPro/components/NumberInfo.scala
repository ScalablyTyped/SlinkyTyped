...
object NumberInfo {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def subTitle(value: TagMod[Any] | String): this.type = set("subTitle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def total(value: TagMod[Any] | String): this.type = set("total", value.asInstanceOf[js.Any])
  }
