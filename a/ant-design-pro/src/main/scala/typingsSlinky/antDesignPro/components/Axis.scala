...
object Axis
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antDesignPro.bizchartsMod.Axis] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antDesignPro.bizchartsMod.Axis] = {
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, typingsSlinky.antDesignPro.bizchartsMod.Axis] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antDesignPro.bizchartsMod.Axis](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
