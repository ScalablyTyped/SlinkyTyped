...
object NumberInfoProps {
  ...
  implicit class NumberInfoPropsOps[Self <: NumberInfoProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubTitle(value: ReactElement | String): Self = this.set("subTitle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTotal(value: ReactElement | String): Self = this.set("total", value.asInstanceOf[js.Any])
    @scala.inline
