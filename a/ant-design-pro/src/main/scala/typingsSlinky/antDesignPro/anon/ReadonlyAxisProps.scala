...
trait ReadonlyAxisProps extends StObject {
  ...
  val line: js.UndefOr[typingsSlinky.antvG2.mod.Styles.line | Null] = js.native
  ...
  val subTickLine: js.UndefOr[typingsSlinky.antvG2.mod.Styles.tickLine] = js.native
  
  val tickLine: js.UndefOr[typingsSlinky.antvG2.mod.Styles.tickLine | Null] = js.native
