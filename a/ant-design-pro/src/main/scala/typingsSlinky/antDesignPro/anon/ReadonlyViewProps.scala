...
trait ReadonlyViewProps extends StObject {
  ...
  val end: js.UndefOr[typingsSlinky.bizcharts.anon.X] = js.native
  ...
  val start: js.UndefOr[typingsSlinky.bizcharts.anon.X] = js.native
}
object ReadonlyViewProps {
  ...
  implicit class ReadonlyViewPropsMutableBuilder[Self <: ReadonlyViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnd(value: typingsSlinky.bizcharts.anon.X): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStart(value: typingsSlinky.bizcharts.anon.X): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
