...
trait ReadonlyGeomProps extends StObject {
  ...
  val line: js.UndefOr[typingsSlinky.antvG2.mod.Styles.line | Boolean] = js.native
  ...
  val tooltip: js.UndefOr[
    Boolean | String | (js.Tuple2[String, js.Function1[/* repeated */ _, typingsSlinky.bizcharts.anon.Name]])
  ] = js.native
...
object ReadonlyGeomProps {
  ...
  implicit class ReadonlyGeomPropsMutableBuilder[Self <: ReadonlyGeomProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(
      value: Boolean | String | (js.Tuple2[String, js.Function1[/* repeated */ _, typingsSlinky.bizcharts.anon.Name]])
