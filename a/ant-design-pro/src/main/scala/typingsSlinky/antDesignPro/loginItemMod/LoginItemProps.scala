...
object LoginItemProps {
  ...
  implicit class LoginItemPropsOps[Self <: LoginItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonTextReactElement(value: ReactElement): Self = this.set("buttonText", value.asInstanceOf[js.Any])
    @scala.inline
    def setButtonText(value: ReactElement): Self = this.set("buttonText", value.asInstanceOf[js.Any])
    @scala.inline
