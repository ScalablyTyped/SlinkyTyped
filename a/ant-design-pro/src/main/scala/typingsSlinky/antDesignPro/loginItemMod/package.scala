...
package object loginItemMod {
  ...
  type LoginItem = slinky.core.ReactComponentClass[typingsSlinky.antDesignPro.loginItemMod.LoginItemProps]
  ...
  {[ K in keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof ItemMap * / any ]: react.react.FC<ant-design-pro.ant-design-pro/lib/Login/LoginItem.WrappedLoginItemProps>}
    */ typingsSlinky.antDesignPro.antDesignProStrings.LoginItemType with org.scalablytyped.runtime.TopLevel[js.Any]
}
