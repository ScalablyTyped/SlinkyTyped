...
object ICountDownProps {
  ...
  implicit class ICountDownPropsOps[Self <: ICountDownProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetDate(value: js.Date): Self = this.set("target", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTarget(value: js.Date | Double): Self = this.set("target", value.asInstanceOf[js.Any])
