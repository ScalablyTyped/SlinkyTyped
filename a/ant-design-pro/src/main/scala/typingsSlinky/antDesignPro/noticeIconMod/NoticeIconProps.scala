...
object NoticeIconProps {
  ...
  implicit class NoticeIconPropsOps[Self <: NoticeIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBellReactElement(value: ReactElement): Self = this.set("bell", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBell(value: ReactElement): Self = this.set("bell", value.asInstanceOf[js.Any])
