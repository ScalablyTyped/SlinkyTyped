...
object pieMod {
  ...
  object IPieProps {
    ...
    implicit class IPiePropsMutableBuilder[Self <: IPieProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValueFormat(value: /* value */ String => String | ReactElement): Self = StObject.set(x, "valueFormat", js.Any.fromFunction1(value))
  ...
  type Pie = ReactComponentClass[IPieProps]
}
