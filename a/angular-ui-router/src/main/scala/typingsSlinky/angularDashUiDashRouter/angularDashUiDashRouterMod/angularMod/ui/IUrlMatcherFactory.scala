...
trait IUrlMatcherFactory extends js.Object {
  ...
  /**
    ...
    */
  def compile(pattern: String): typingsSlinky.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.ui.IUrlMatcher = js.native
  /**
  ...
  /**
    ...
    */
  def `type`(name: String): typingsSlinky.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.ui.IType = js.native
  /**
  ...
  def `type`(
    name: String,
    definition: typingsSlinky.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.ui.IType
  ...
  def `type`(
    ...
    definitionFn: js.Function1[
      /* repeated */ js.Any, 
      typingsSlinky.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.ui.IType
    ]
  ): IUrlMatcherFactory = js.native
  def `type`(
    name: String,
