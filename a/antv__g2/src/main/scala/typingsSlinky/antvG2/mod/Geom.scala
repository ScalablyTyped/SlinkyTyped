...
import typingsSlinky.antvG2.anon.Dictkey
...
trait Geom extends js.Object {
  ...
  def select(open: Boolean, opt: typingsSlinky.antvG2.anon.Animate): this.type = js.native
  def select(opt: typingsSlinky.antvG2.anon.Animate): this.type = js.native
