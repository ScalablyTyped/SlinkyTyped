...
import typingsSlinky.antvG2.AnonAutoSetAxis
import typingsSlinky.antvG2.AnonBottom
import typingsSlinky.antvG2.AnonPadding
import typingsSlinky.antvG2.AnonX
import typingsSlinky.antvG2.PartialChartProps
...
class Chart protected () extends BashView {
  ...
  @JSName("get")
  def get_background(prop: background): typingsSlinky.antvG2.mod.Styles.background = js.native
  @JSName("get")
  ...
  @JSName("get")
  def get_plotBackground(prop: plotBackground): typingsSlinky.antvG2.mod.Styles.background = js.native
  @JSName("get")
