...
trait AnonAutoSetAxis extends js.Object {
  ...
  /**
    * 列标题
    */
  var colTitle: js.UndefOr[AnonOffsetY | Null] = js.native
  /**
    * 创建每个分面中的视图
    * @param view 视图对象
  ...
  /**
    * 行标题
    */
  var rowTitle: js.UndefOr[AnonOffsetX | Null] = js.native
  /**
    * 显示标题
    */
...
object AnonAutoSetAxis {
  @scala.inline
  def apply(): AnonAutoSetAxis = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonAutoSetAxis]
  }
  @scala.inline
  implicit class AnonAutoSetAxisOps[Self <: AnonAutoSetAxis] (val x: Self) extends AnyVal {
    @scala.inline
