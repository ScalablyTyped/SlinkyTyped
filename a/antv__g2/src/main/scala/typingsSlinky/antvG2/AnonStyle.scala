...
trait AnonStyle extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[rect | x | y | cross | typingsSlinky.antvG2.antvG2Strings.line] = js.undefined
}
...
object AnonStyle {
  ...
  def apply(
    ...
    `type`: rect | x | y | cross | typingsSlinky.antvG2.antvG2Strings.line = null
  ): AnonStyle = {
