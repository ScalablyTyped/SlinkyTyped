...
trait Anon_ParsePath extends js.Object {
  var parsePath: js.Any
  var parsePoint: js.Any
  var parsePoints: js.Any
}

object Anon_ParsePath {
  @scala.inline
  def apply(parsePath: js.Any, parsePoint: js.Any, parsePoints: js.Any): Anon_ParsePath = {
    ...
    __obj.asInstanceOf[Anon_ParsePath]
  }
}
