...
import typingsSlinky.atAntvG2.Anon_Animate
import typingsSlinky.atAntvG2.Anon_Key
...
trait Geom extends js.Object {
  ...
  def label(exe: String, opt: Anon_Key): this.type = js.native
  ...
  def select(open: Boolean, opt: Anon_Animate): this.type = js.native
  def select(opt: Anon_Animate): this.type = js.native
