...
import typingsSlinky.atAntvG2.atAntvG2Strings.polygon
...
trait AxisGrid extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[typingsSlinky.atAntvG2.atAntvG2Strings.line | polygon] = js.undefined
}
...
object AxisGrid {
  ...
  def apply(
    ...
    lineStyle: line = null,
    `type`: typingsSlinky.atAntvG2.atAntvG2Strings.line | polygon = null
  ): AxisGrid = {
