...
object Options {
  ...
  def apply(
    ...
    if (accountKey != null) __obj.updateDynamic("accountKey")(accountKey.asInstanceOf[js.Any])
    ...
    if (directoryUrl != null) __obj.updateDynamic("directoryUrl")(directoryUrl.asInstanceOf[js.Any])
