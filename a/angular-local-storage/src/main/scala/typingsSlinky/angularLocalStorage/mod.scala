      ...
      object storage {
        ...
        trait ILocalStorageService extends StObject {
          ...
          /**
            ...
            */
          var cookie: typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ICookie = js.native
        ...
        trait ILocalStorageServiceProvider extends IServiceProvider {
          ...
          /**
            ...
            * default: true
            */
          def setDefaultToCookie(shouldDefault: Boolean): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
          ...
          /**
            ...
            */
          def setNotify(setItem: Boolean, removeItem: Boolean): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
          ...
          /**
            ...
            */
          def setPrefix(prefix: String): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
          ...
          /**
            ...
            */
          def setStorageCookie(exp: Double, path: String, secure: Boolean): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
          ...
          /**
            ...
            * No default value
            */
          def setStorageCookieDomain(domain: String): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
          
          /**
            * Setter for the storageType
            * localstorage or sessionStorage. default: localStorage
            */
          def setStorageType(storageType: String): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = js.native
        }
        object ILocalStorageServiceProvider {
          ...
          def apply(
            $get: js.Any,
            setDefaultToCookie: Boolean => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider,
            setNotify: (Boolean, Boolean) => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider,
            setPrefix: String => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider,
            setStorageCookie: (Double, String, Boolean) => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider,
            setStorageCookieDomain: String => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider,
            setStorageType: String => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider
          ): typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider = {
            ...
            __obj.asInstanceOf[typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider]
          }
          
          @scala.inline
          implicit class ILocalStorageServiceProviderMutableBuilder[Self <: typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider] (val x: Self) extends AnyVal {
            
            @scala.inline
            def setSetDefaultToCookie(
              value: Boolean => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider
            ): Self = StObject.set(x, "setDefaultToCookie", js.Any.fromFunction1(value))
            
            @scala.inline
            def setSetNotify(
              value: (Boolean, Boolean) => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider
            ): Self = StObject.set(x, "setNotify", js.Any.fromFunction2(value))
            
            @scala.inline
            def setSetPrefix(
              value: String => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider
            ): Self = StObject.set(x, "setPrefix", js.Any.fromFunction1(value))
            
            @scala.inline
            def setSetStorageCookie(
              value: (Double, String, Boolean) => typingsSlinky.angularLocalStorage.mod.angularAugmentingMod.local.storage.ILocalStorageServiceProvider
