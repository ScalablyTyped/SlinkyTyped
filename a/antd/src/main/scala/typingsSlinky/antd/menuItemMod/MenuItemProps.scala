...
trait MenuItemProps extends js.Object {
  ...
  var onMouseEnter: js.UndefOr[js.Function1[/* e */ DomEvent, Unit]] = js.undefined
  var onMouseLeave: js.UndefOr[js.Function1[/* e */ DomEvent, Unit]] = js.undefined
...
object MenuItemProps {
  ...
  implicit class MenuItemPropsOps[Self <: MenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnMouseEnter(value: /* e */ DomEvent => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    @scala.inline
    def setOnMouseLeave(value: /* e */ DomEvent => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction1(value))
    @scala.inline
