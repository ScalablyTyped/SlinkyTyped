...
object UploadFile {
  ...
  implicit class UploadFileOps[Self <: UploadFile[_], T] (val x: Self with UploadFile[T]) extends AnyVal {
    ...
    @scala.inline
    def setOriginFileObjBlob(value: Blob): Self = this.set("originFileObj", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginFileObjFile(value: File): Self = this.set("originFileObj", value.asInstanceOf[js.Any])
