...
import typingsSlinky.antd.antdStrings.generateConfig
import typingsSlinky.antd.antdStrings.grammar
import typingsSlinky.antd.antdStrings.grid
import typingsSlinky.antd.antdStrings.hideHeader
...
import typingsSlinky.antd.antdStrings.locale
...
import typingsSlinky.antd.antdStrings.nextIcon
...
import typingsSlinky.antd.antdStrings.prevIcon
...
import typingsSlinky.antd.antdStrings.superNextIcon
import typingsSlinky.antd.antdStrings.superPrevIcon
...
object generatePickerMod {
  ...
  @js.native
  def default[DateType](generateConfig: GenerateConfig[DateType]): ReactComponentClass[PickerProps[DateType]] with MonthPicker[DateType] = js.native
  ...
  object Components {
    ...
    @js.native
    def button: js.Function1[/* props */ ButtonProps, ReactElement] = js.native
    @scala.inline
    def button_=(x: js.Function1[/* props */ ButtonProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("button")(x.asInstanceOf[js.Any])
    
    @JSImport("antd/lib/date-picker/generatePicker", "Components.rangeItem")
    @js.native
    def rangeItem: js.Function1[/* props */ TagProps, ReactElement] = js.native
    @scala.inline
    def rangeItem_=(x: js.Function1[/* props */ TagProps, ReactElement]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("rangeItem")(x.asInstanceOf[js.Any])
  }
  ...
  type InjectDefaultProps[Props] = (Omit[
    Props, 
    locale | generateConfig | prevIcon | nextIcon | superPrevIcon | superNextIcon | hideHeader | typingsSlinky.antd.antdStrings.components
  ]) with Bordered
  ...
  */
  ...
  object PickerProps {
    ...
    @scala.inline
    def PickerBaseProps[DateType](picker: Exclude[PickerMode, date | time]): typingsSlinky.antd.generatePickerMod.PickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.PickerBaseProps[DateType]]
    }
    
    @scala.inline
    def PickerDateProps[DateType](): typingsSlinky.antd.generatePickerMod.PickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.PickerDateProps[DateType]]
    }
    
    @scala.inline
    def PickerTimeProps[DateType](picker: time): typingsSlinky.antd.generatePickerMod.PickerTimeProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.PickerTimeProps[DateType]]
    }
  }
  ...
  */
  ...
  object RangePickerProps {
    ...
    @scala.inline
    def RangePickerBaseProps[DateType](picker: Exclude[PickerMode, date | time]): typingsSlinky.antd.generatePickerMod.RangePickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.RangePickerBaseProps[DateType]]
    }
    
    @scala.inline
    def RangePickerDateProps[DateType](): typingsSlinky.antd.generatePickerMod.RangePickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.RangePickerDateProps[DateType]]
    }
    
    @scala.inline
    def RangePickerTimeProps[DateType](picker: time): typingsSlinky.antd.generatePickerMod.RangePickerTimeProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generatePickerMod.RangePickerTimeProps[DateType]]
    }
  }
