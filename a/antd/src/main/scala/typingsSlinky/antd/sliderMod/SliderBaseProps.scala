...
trait SliderBaseProps extends js.Object {
  ...
  var tipFormatter: js.UndefOr[Null | (js.Function1[/* value */ js.UndefOr[Double], ReactElement])] = js.undefined
...
object SliderBaseProps {
  ...
  implicit class SliderBasePropsOps[Self <: SliderBaseProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTipFormatter(value: /* value */ js.UndefOr[Double] => ReactElement): Self = this.set("tipFormatter", js.Any.fromFunction1(value))
    @scala.inline
