...
object AnonItemUnit {
  @scala.inline
  def apply(itemUnit: String, itemsUnit: String, searchPlaceholder: String): AnonItemUnit = {
  ...
  @scala.inline
  implicit class AnonItemUnitOps[Self <: AnonItemUnit] (val x: Self) extends AnyVal {
    @scala.inline
