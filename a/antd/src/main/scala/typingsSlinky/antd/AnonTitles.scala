...
object AnonTitles {
  @scala.inline
  def apply(itemUnit: String, itemsUnit: String, searchPlaceholder: String, titles: js.Array[String]): AnonTitles = {
  ...
  @scala.inline
  implicit class AnonTitlesOps[Self <: AnonTitles] (val x: Self) extends AnyVal {
    @scala.inline
