...
object DatePicker {
  ...
  @JSImport("antd", "DatePicker.RangePicker")
  @js.native
  def RangePicker: ReactComponentClass[RangePickerProps[Moment]] = js.native
  @scala.inline
  def RangePicker_=(x: ReactComponentClass[RangePickerProps[Moment]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RangePicker")(x.asInstanceOf[js.Any])
