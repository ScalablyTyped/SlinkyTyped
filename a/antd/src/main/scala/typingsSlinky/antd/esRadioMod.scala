...
import typingsSlinky.antd.esRadioInterfaceMod.RadioGroupProps
...
object esRadioMod extends js.Object {
  @js.native
  class Button ()
    extends typingsSlinky.antd.esRadioRadioButtonMod.default
  
  @js.native
  class Group protected ()
    extends typingsSlinky.antd.esRadioGroupMod.default {
    def this(props: RadioGroupProps) = this()
  }
  
  @js.native
  class default ()
    extends typingsSlinky.antd.esRadioRadioMod.default
