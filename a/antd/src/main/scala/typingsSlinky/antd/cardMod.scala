...
object cardMod extends Shortcut {
  ...
  trait CardProps extends StObject {
    ...
    var tabBarExtraContent: js.UndefOr[ReactElement | Null] = js.native
  ...
  object CardProps {
    ...
    implicit class CardPropsMutableBuilder[Self <: CardProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCoverReactElement(value: ReactElement): Self = StObject.set(x, "cover", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTabBarExtraContentNull: Self = StObject.set(x, "tabBarExtraContent", null)
  ...
  */
  ...
  object CardTabListType {
    ...
    @scala.inline
    implicit class CardTabListTypeMutableBuilder[Self <: CardTabListType] (val x: Self) extends AnyVal {
