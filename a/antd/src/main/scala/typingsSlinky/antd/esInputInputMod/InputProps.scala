package typingsSlinky.antd.esInputInputMod
...
/* Inlined parent antd.antd/es/_util/type.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'size' | 'prefix'> */
