...
trait TimePickerProps extends js.Object {
  var addon: js.UndefOr[js.Function0[TagMod[Any]]] = js.native
...
object TimePickerProps {
  ...
  implicit class TimePickerPropsOps[Self <: TimePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddon(value: () => TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addon")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
