...
object TimeRangePickerProps {
  ...
  def apply(
    ...
    defaultValue: js.UndefOr[Null | RangeValue[Moment]] = js.undefined,
    ...
    onCalendarChange: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit = null,
    onChange: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit = null,
    ...
    onOk: /* dates */ RangeValue[Moment] => Unit = null,
    ...
    value: js.UndefOr[Null | RangeValue[Moment]] = js.undefined
