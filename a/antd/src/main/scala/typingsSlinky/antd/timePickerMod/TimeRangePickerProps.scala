...
object TimeRangePickerProps {
  ...
  @scala.inline
  implicit class TimeRangePickerPropsOps[Self <: TimeRangePickerProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDefaultPickerValue(value: js.Tuple2[Moment, Moment]): Self = this.set("defaultPickerValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDefaultPickerValue: Self = this.set("defaultPickerValue", js.undefined)
    @scala.inline
    def setDefaultValue(value: RangeValue[Moment]): Self = this.set("defaultValue", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisabledTime(value: (/* date */ EventValue[Moment], /* type */ start | end) => DisabledTimes): Self = this.set("disabledTime", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setOnCalendarChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit): Self = this.set("onCalendarChange", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnCalendarChange: Self = this.set("onCalendarChange", js.undefined)
    @scala.inline
    def setOnChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setOnOk(value: /* dates */ RangeValue[Moment] => Unit): Self = this.set("onOk", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnPanelChange(value: (/* values */ RangeValue[Moment], /* modes */ js.Tuple2[PanelMode, PanelMode]) => Unit): Self = this.set("onPanelChange", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setValue(value: RangeValue[Moment]): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
