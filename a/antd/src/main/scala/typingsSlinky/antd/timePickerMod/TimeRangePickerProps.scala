...
object TimeRangePickerProps {
  ...
  implicit class TimeRangePickerPropsOps[Self <: TimeRangePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPicker(value: time): Self = {
    ...
    @scala.inline
    def withAllowEmpty(value: js.Tuple2[Boolean, Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDefaultPickerValue(value: js.Tuple2[Moment, Moment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDefaultValue(value: RangeValue[Moment]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisabled(value: Boolean | (js.Tuple2[Boolean, Boolean])): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDisabledTime(value: (/* date */ EventValue[Moment], /* type */ start | end) => DisabledTimes): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMode(value: js.Tuple2[PanelMode, PanelMode]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnCalendarChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onCalendarChange")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withoutOnCalendarChange: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onCalendarChange")(js.undefined)
        ret
    }
    @scala.inline
    def withOnChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnOk(value: /* dates */ RangeValue[Moment] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPanelChange(value: (/* values */ RangeValue[Moment], /* modes */ js.Tuple2[PanelMode, PanelMode]) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlaceholder(value: js.Tuple2[String, String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withValue(value: RangeValue[Moment]): Self = {
        val ret = this.duplicate
