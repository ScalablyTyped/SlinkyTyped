...
object TimeRangePickerProps {
  ...
  implicit class TimeRangePickerPropsOps[Self <: TimeRangePickerProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateRender(value: (Moment, Moment, /* info */ RangeInfo) => ReactElement): Self = this.set("dateRender", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setDisabledTime(value: (/* date */ EventValue[Moment], /* type */ RangeType) => DisabledTimes): Self = this.set("disabledTime", js.Any.fromFunction2(value))
    @scala.inline
