...
object PickerTimeProps {
  ...
  @scala.inline
  implicit class PickerTimePropsOps[Self[datetype] <: PickerTimeProps[datetype], DateType] (val x: Self[DateType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withBordered(value: Boolean): Self[DateType] = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bordered")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBordered: Self[DateType] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSize(value: SizeType): Self[DateType] = {
        val ret = this.duplicate
