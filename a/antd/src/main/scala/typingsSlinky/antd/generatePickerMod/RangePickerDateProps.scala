...
object RangePickerDateProps {
  ...
  @scala.inline
  implicit class RangePickerDatePropsOps[Self[datetype] <: RangePickerDateProps[datetype], DateType] (val x: Self[DateType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withShowTime(value: Boolean | RangeShowTimeObject[DateType]): Self[DateType] = {
        val ret = this.duplicate
