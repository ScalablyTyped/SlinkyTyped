...
trait AutoCompleteProps extends js.Object {
  ...
  var placeholder: js.UndefOr[String | TagMod[Any]] = js.undefined
  ...
  var size: js.UndefOr[typingsSlinky.antd.antdStrings.default | large | small] = js.undefined
