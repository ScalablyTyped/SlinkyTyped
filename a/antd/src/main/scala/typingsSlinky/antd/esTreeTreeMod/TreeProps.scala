...
trait TreeProps extends js.Object {
  ...
  var filterTreeNode: js.UndefOr[js.Function1[ReactComponentClass[AntTreeNodeProps], Boolean]] = js.undefined
  var icon: js.UndefOr[(js.Function1[/* nodeProps */ AntdTreeNodeAttribute, TagMod[Any]]) | TagMod[Any]] = js.undefined
  /** 异步加载数据 */
  var loadData: js.UndefOr[js.Function1[ReactComponentClass[AntTreeNodeProps], js.Thenable[Unit]]] = js.undefined
  ...
  var onClick: js.UndefOr[
    js.Function2[
      ...
      ReactComponentClass[AntTreeNodeProps], 
      Unit
    ]
  ] = js.undefined
  /** 双击树节点触发 */
