...
trait Anon_PreviewFile extends js.Object {
...
object Anon_PreviewFile {
  @scala.inline
  def apply(previewFile: String, removeFile: String, uploadError: String, uploading: String): Anon_PreviewFile = {
    ...
    __obj.asInstanceOf[Anon_PreviewFile]
  }
}
