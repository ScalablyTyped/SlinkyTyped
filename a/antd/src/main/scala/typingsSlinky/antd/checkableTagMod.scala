...
object checkableTagMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CheckableTagProps] = js.native
  ...
  type _To = ReactComponentClass[CheckableTagProps]
  
  /* This means you don't have to write `default`, but can instead just say `checkableTagMod.foo` */
  override def _to: ReactComponentClass[CheckableTagProps] = default
}
