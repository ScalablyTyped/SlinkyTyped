...
object SiderProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(defaultCollapsed)) __obj.updateDynamic("defaultCollapsed")(defaultCollapsed.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(reverseArrow)) __obj.updateDynamic("reverseArrow")(reverseArrow.get.asInstanceOf[js.Any])
