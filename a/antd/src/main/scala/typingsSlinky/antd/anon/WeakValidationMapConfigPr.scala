...
trait WeakValidationMapConfigPr extends StObject {
  ...
  var locale: js.UndefOr[Validator[js.UndefOr[typingsSlinky.antd.localeProviderMod.Locale | Null]]] = js.native
...
object WeakValidationMapConfigPr {
  ...
  implicit class WeakValidationMapConfigPrMutableBuilder[Self <: WeakValidationMapConfigPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: Validator[js.UndefOr[typingsSlinky.antd.localeProviderMod.Locale | Null]]): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
