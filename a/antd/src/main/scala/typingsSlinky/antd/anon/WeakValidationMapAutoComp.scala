...
trait WeakValidationMapAutoComp extends js.Object {
  ...
  var animation: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  ...
  var autoClearSearchValue: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  var autoFocus: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  var backfill: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var choiceTransitionName: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var className: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var clearIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  var dataSource: js.UndefOr[Validator[js.UndefOr[js.Array[DataSourceItemType] | Null]]] = js.undefined
  var defaultActiveFirstOption: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var dropdownAlign: js.UndefOr[Validator[js.UndefOr[_ | Null]]] = js.undefined
  var dropdownClassName: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var dropdownMatchSelectWidth: js.UndefOr[Validator[js.UndefOr[Boolean | Double | Null]]] = js.undefined
  var dropdownRender: js.UndefOr[
    Validator[js.UndefOr[(js.Function1[/* menu */ ReactElement, ReactElement]) | Null]]
  ] = js.undefined
  var dropdownStyle: js.UndefOr[Validator[js.UndefOr[CSSProperties | Null]]] = js.undefined
  ...
  var getInputElement: js.UndefOr[Validator[js.UndefOr[js.Function0[ReactElement] | Null]]] = js.undefined
  var getPopupContainer: js.UndefOr[Validator[js.UndefOr[Null | RenderDOMFunc]]] = js.undefined
  var id: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var inputValue: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var internalProps: js.UndefOr[Validator[js.UndefOr[Mark[OptionsType] | Null]]] = js.undefined
  var key: js.UndefOr[Validator[js.UndefOr[Key | Null]]] = js.undefined
  var listHeight: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var listItemHeight: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var maxTagCount: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var maxTagPlaceholder: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function1[/* omittedValues */ js.Array[LabelValueType], ReactElement]) | Null | ReactElement
      ]
    ]
  ] = js.undefined
  var maxTagTextLength: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var menuItemSelectedIcon: js.UndefOr[Validator[js.UndefOr[Null | RenderNode]]] = js.undefined
  var notFoundContent: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  ...
  var onClear: js.UndefOr[Validator[js.UndefOr[Null | OnClear]]] = js.undefined
  ...
  var onDropdownVisibleChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* open */ Boolean, Unit]) | Null]]] = js.undefined
  var onFocus: js.UndefOr[Validator[js.UndefOr[FocusEventHandler[HTMLElement] | Null]]] = js.undefined
  var onInputKeyDown: js.UndefOr[Validator[js.UndefOr[KeyboardEventHandler[HTMLInputElement] | Null]]] = js.undefined
  ...
  var onPopupScroll: js.UndefOr[Validator[js.UndefOr[Null | UIEventHandler[HTMLDivElement]]]] = js.undefined
  var onSearch: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* value */ String, Unit]) | Null]]] = js.undefined
  ...
  var optionFilterProp: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var options: js.UndefOr[Validator[js.UndefOr[Null | OptionsType]]] = js.undefined
  var placeholder: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  var prefixCls: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[default[SelectValue]]]]] = js.undefined
  var removeIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  var searchValue: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  var showAction: js.UndefOr[Validator[js.UndefOr[(js.Array[focus | click]) | Null]]] = js.undefined
  var showArrow: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  var showSearch: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var tokenSeparators: js.UndefOr[Validator[js.UndefOr[js.Array[String] | Null]]] = js.undefined
...
object WeakValidationMapAutoComp {
  ...
  implicit class WeakValidationMapAutoCompOps[Self <: WeakValidationMapAutoComp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetInputElement(value: Validator[js.UndefOr[js.Function0[ReactElement] | Null]]): Self = this.set("getInputElement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNotFoundContent(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("notFoundContent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPlaceholder(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("placeholder", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRemoveIcon(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("removeIcon", value.asInstanceOf[js.Any])
    @scala.inline
