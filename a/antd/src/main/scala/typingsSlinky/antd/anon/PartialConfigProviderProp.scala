...
trait PartialConfigProviderProp extends StObject {
  ...
  var locale: js.UndefOr[typingsSlinky.antd.localeProviderMod.Locale] = js.native
...
object PartialConfigProviderProp {
  ...
  implicit class PartialConfigProviderPropMutableBuilder[Self <: PartialConfigProviderProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: typingsSlinky.antd.localeProviderMod.Locale): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
