...
@js.native
trait LangTimePickerLocale extends js.Object {
  var lang: BackToToday = js.native
  var timePickerLocale: PlaceholderString = js.native
}

object LangTimePickerLocale {
  @scala.inline
  def apply(lang: BackToToday, timePickerLocale: PlaceholderString): LangTimePickerLocale = {
    val __obj = js.Dynamic.literal(lang = lang.asInstanceOf[js.Any], timePickerLocale = timePickerLocale.asInstanceOf[js.Any])
    __obj.asInstanceOf[LangTimePickerLocale]
  }
  @scala.inline
  implicit class LangTimePickerLocaleOps[Self <: LangTimePickerLocale] (val x: Self) extends AnyVal {
    @scala.inline
