...
object PickPickPickerDatePropsMo {
  ...
  @scala.inline
  def apply(): PickPickPickerDatePropsMo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPickPickerDatePropsMo]
  }
  
  @scala.inline
  implicit class PickPickPickerDatePropsMoMutableBuilder[Self <: PickPickPickerDatePropsMo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMonthCellRender(value: (Moment, /* locale */ typingsSlinky.rcPicker.interfaceMod.Locale) => ReactElement): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
