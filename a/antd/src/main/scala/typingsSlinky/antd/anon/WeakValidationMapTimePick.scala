...
trait WeakValidationMapTimePick extends StObject {
  ...
  var addon: js.UndefOr[Validator[js.UndefOr[js.Function0[ReactElement] | Null]]] = js.native
...
object WeakValidationMapTimePick {
  ...
  implicit class WeakValidationMapTimePickMutableBuilder[Self <: WeakValidationMapTimePick] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddon(value: Validator[js.UndefOr[js.Function0[ReactElement] | Null]]): Self = StObject.set(x, "addon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPanelRender(value: Validator[js.UndefOr[(js.Function1[/* originPanel */ ReactElement, ReactElement]) | Null]]): Self = StObject.set(x, "panelRender", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | typingsSlinky.react.mod.Ref[_]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    @scala.inline
    def setRenderExtraFooter(value: Validator[js.UndefOr[(js.Function1[/* mode */ PanelMode, ReactElement]) | Null]]): Self = StObject.set(x, "renderExtraFooter", value.asInstanceOf[js.Any])
