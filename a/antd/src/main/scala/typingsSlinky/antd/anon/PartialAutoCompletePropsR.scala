...
trait PartialAutoCompletePropsR extends StObject {
  ...
  var internalProps: js.UndefOr[typingsSlinky.rcSelect.anon.Mark[OptionsType]] = js.native
...
object PartialAutoCompletePropsR {
  ...
  implicit class PartialAutoCompletePropsRMutableBuilder[Self <: PartialAutoCompletePropsR] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInternalProps(value: typingsSlinky.rcSelect.anon.Mark[OptionsType]): Self = StObject.set(x, "internalProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: typingsSlinky.react.mod.Ref[RefSelectProps]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
