...
trait WeakValidationMapModalPro extends StObject {
  ...
  var cancelText: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.native
  ...
  var closeIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.native
  ...
  var footer: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.native
  ...
  var onCancel: js.UndefOr[
    Validator[
      js.UndefOr[(js.Function1[/* e */ SyntheticMouseEvent[HTMLElement], Unit]) | Null]
    ]
  ] = js.native
  ...
  var title: js.UndefOr[Validator[js.UndefOr[Null | ReactElement | String]]] = js.native
...
object WeakValidationMapModalPro {
  ...
  implicit class WeakValidationMapModalProMutableBuilder[Self <: WeakValidationMapModalPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancelText(value: Validator[js.UndefOr[Null | ReactElement]]): Self = StObject.set(x, "cancelText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCloseIcon(value: Validator[js.UndefOr[Null | ReactElement]]): Self = StObject.set(x, "closeIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFooter(value: Validator[js.UndefOr[Null | ReactElement]]): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModalRender(value: Validator[js.UndefOr[(js.Function1[/* node */ ReactElement, ReactElement]) | Null]]): Self = StObject.set(x, "modalRender", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOkText(value: Validator[js.UndefOr[Null | ReactElement]]): Self = StObject.set(x, "okText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: Validator[js.UndefOr[Null | ReactElement | String]]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
