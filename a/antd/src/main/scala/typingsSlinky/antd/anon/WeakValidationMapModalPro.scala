...
trait WeakValidationMapModalPro extends js.Object {
  ...
  var cancelText: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  ...
  var closeIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  ...
  var footer: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
  ...
  var okText: js.UndefOr[Validator[js.UndefOr[Null | ReactElement]]] = js.undefined
...
object WeakValidationMapModalPro {
  ...
  implicit class WeakValidationMapModalProOps[Self <: WeakValidationMapModalPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCancelText(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("cancelText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCloseIcon(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("closeIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFooter(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("footer", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOkText(value: Validator[js.UndefOr[Null | ReactElement]]): Self = this.set("okText", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitle(value: Validator[js.UndefOr[Null | ReactElement | String]]): Self = this.set("title", value.asInstanceOf[js.Any])
    @scala.inline
