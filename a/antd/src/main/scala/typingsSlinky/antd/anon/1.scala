...
object `1` {
  ...
  implicit class `1Ops`[Self <: `1`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefRefObject(value: ReactRef[RefTreeSelectProps]): Self = this.set("ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ RefTreeSelectProps | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
