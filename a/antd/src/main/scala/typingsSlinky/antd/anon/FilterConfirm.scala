...
@js.native
trait FilterConfirm extends js.Object {
...
object FilterConfirm {
  ...
  def apply(
    ...
    __obj.asInstanceOf[FilterConfirm]
  }
  @scala.inline
  implicit class FilterConfirmOps[Self <: FilterConfirm] (val x: Self) extends AnyVal {
    @scala.inline
