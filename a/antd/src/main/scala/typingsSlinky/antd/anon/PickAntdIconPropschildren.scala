...
trait PickAntdIconPropschildren extends StObject {
  ...
  var ref: js.UndefOr[typingsSlinky.react.mod.Ref[HTMLSpanElement]] = js.native
...
object PickAntdIconPropschildren {
  ...
  implicit class PickAntdIconPropschildrenMutableBuilder[Self <: PickAntdIconPropschildren] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: typingsSlinky.react.mod.Ref[HTMLSpanElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
