...
@js.native
trait ItemsUnitNotFoundContent extends js.Object {
...
object ItemsUnitNotFoundContent {
  @scala.inline
  def apply(itemUnit: String, itemsUnit: String, searchPlaceholder: String, titles: js.Array[String]): ItemsUnitNotFoundContent = {
    ...
    __obj.asInstanceOf[ItemsUnitNotFoundContent]
  }
  @scala.inline
  implicit class ItemsUnitNotFoundContentOps[Self <: ItemsUnitNotFoundContent] (val x: Self) extends AnyVal {
    @scala.inline
