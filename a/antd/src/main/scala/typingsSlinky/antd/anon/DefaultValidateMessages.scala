...
object DefaultValidateMessages {
  ...
  implicit class DefaultValidateMessagesMutableBuilder[Self <: DefaultValidateMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultValidateMessages(value: typingsSlinky.rcFieldForm.interfaceMod.ValidateMessages): Self = StObject.set(x, "defaultValidateMessages", value.asInstanceOf[js.Any])
