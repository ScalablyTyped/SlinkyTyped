...
@js.native
trait PartialTimePickerPropsRef extends StObject {
...
object PartialTimePickerPropsRef {
  ...
  @scala.inline
  def apply(): PartialTimePickerPropsRef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTimePickerPropsRef]
  }
  
  @scala.inline
  implicit class PartialTimePickerPropsRefMutableBuilder[Self <: PartialTimePickerPropsRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: typingsSlinky.react.mod.Ref[_]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
