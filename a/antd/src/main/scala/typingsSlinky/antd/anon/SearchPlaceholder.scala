...
@js.native
trait SearchPlaceholder extends js.Object {
...
object SearchPlaceholder {
  @scala.inline
  def apply(itemUnit: String, itemsUnit: String, searchPlaceholder: String, titles: js.Array[String]): SearchPlaceholder = {
    ...
    __obj.asInstanceOf[SearchPlaceholder]
  }
  @scala.inline
  implicit class SearchPlaceholderOps[Self <: SearchPlaceholder] (val x: Self) extends AnyVal {
    @scala.inline
