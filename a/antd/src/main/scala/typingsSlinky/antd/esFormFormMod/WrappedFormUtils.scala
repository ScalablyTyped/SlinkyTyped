package typingsSlinky.antd.esFormFormMod
...
trait WrappedFormUtils[V] extends js.Object {
  def getFieldDecorator[T /* <: js.Object */](id: String): js.Function1[/* node */ TagMod[Any], TagMod[Any]] = js.native
  def getFieldDecorator[T /* <: js.Object */](id: String, options: GetFieldDecoratorOptions): js.Function1[/* node */ TagMod[Any], TagMod[Any]] = js.native
  /** 获取某个输入控件的 Error */
