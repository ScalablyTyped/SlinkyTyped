...
object AbstractCheckboxProps {
  ...
  @scala.inline
  implicit class AbstractCheckboxPropsOps[Self[t] <: AbstractCheckboxProps[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnChange(value: /* e */ T => Unit): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnClick(value: SyntheticMouseEvent[HTMLElement] => Unit): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnKeyDown(value: SyntheticKeyboardEvent[HTMLElement] => Unit): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnKeyPress(value: SyntheticKeyboardEvent[HTMLElement] => Unit): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnMouseEnter(value: SyntheticMouseEvent[HTMLElement] => Unit): Self[T] = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnMouseLeave(value: SyntheticMouseEvent[HTMLElement] => Unit): Self[T] = {
        val ret = this.duplicate
