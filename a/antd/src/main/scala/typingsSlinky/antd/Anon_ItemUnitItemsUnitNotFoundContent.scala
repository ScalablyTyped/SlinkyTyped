...
trait Anon_ItemUnitItemsUnitNotFoundContent extends js.Object {
  var itemUnit: String
...
object Anon_ItemUnitItemsUnitNotFoundContent {
  @scala.inline
  def apply(
    itemUnit: String,
    itemsUnit: String,
  ...
  ): Anon_ItemUnitItemsUnitNotFoundContent = {
    ...
    __obj.asInstanceOf[Anon_ItemUnitItemsUnitNotFoundContent]
  }
}
