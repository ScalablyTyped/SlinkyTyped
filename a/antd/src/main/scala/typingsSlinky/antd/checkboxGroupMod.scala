...
object checkboxGroupMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[CheckboxGroupProps] = js.native
  ...
  type _To = ReactComponentClass[CheckboxGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `checkboxGroupMod.foo` */
  override def _to: ReactComponentClass[CheckboxGroupProps] = default
}
