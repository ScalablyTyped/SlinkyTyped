...
import typingsSlinky.antd.anon.Locale
...
object generateCalendarMod {
  ...
  @js.native
  def default[DateType](generateConfig: GenerateConfig[DateType]): js.Function1[/* props */ CalendarProps[DateType], ReactElement] = js.native
  ...
  */
  ...
  object PickerPanelBaseProps {
    ...
    implicit class PickerPanelBasePropsMutableBuilder[Self <: PickerPanelBaseProps[_], DateType] (val x: Self with PickerPanelBaseProps[DateType]) extends AnyVal {
      ...
      @scala.inline
      def setMonthCellRender(value: (DateType, /* locale */ typingsSlinky.rcPicker.interfaceMod.Locale) => ReactElement): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
  ...
  */
  ...
  object PickerProps {
    ...
    @scala.inline
    def PickerPanelBaseProps[DateType](picker: Exclude[PickerMode, date | time]): typingsSlinky.antd.generateCalendarMod.PickerPanelBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generateCalendarMod.PickerPanelBaseProps[DateType]]
    }
    
    @scala.inline
    def PickerPanelDateProps[DateType](): typingsSlinky.antd.generateCalendarMod.PickerPanelDateProps[DateType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.antd.generateCalendarMod.PickerPanelDateProps[DateType]]
    }
    
    @scala.inline
    def PickerPanelTimeProps[DateType](picker: time): typingsSlinky.antd.generateCalendarMod.PickerPanelTimeProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.antd.generateCalendarMod.PickerPanelTimeProps[DateType]]
    }
  }
}
