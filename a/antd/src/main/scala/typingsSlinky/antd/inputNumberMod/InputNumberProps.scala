...
object InputNumberProps {
  ...
  implicit class InputNumberPropsOps[Self <: InputNumberProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFormatter(value: /* value */ js.UndefOr[Double | String] => String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPressEnter(value: SyntheticKeyboardEvent[HTMLInputElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withParser(value: /* displayValue */ js.UndefOr[String] => Double | String): Self = {
        val ret = this.duplicate
