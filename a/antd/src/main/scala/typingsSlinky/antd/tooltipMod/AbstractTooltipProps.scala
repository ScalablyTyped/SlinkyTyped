...
trait AbstractTooltipProps extends js.Object {
  ...
  var arrowContent: js.UndefOr[ReactElement] = js.undefined
...
object AbstractTooltipProps {
  ...
  implicit class AbstractTooltipPropsOps[Self <: AbstractTooltipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrowContentReactElement(value: ReactElement): Self = this.set("arrowContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setArrowContent(value: ReactElement): Self = this.set("arrowContent", value.asInstanceOf[js.Any])
    @scala.inline
