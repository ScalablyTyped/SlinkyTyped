...
trait InternalSelectProps[VT] extends js.Object {
  ...
  var defaultValue: js.UndefOr[VT] = js.undefined
  ...
  var value: js.UndefOr[VT] = js.undefined
...
object InternalSelectProps {
  ...
  implicit class InternalSelectPropsOps[Self <: InternalSelectProps[_], VT] (val x: Self with InternalSelectProps[VT]) extends AnyVal {
    ...
    @scala.inline
    def setGetInputElement(value: () => ReactElement): Self = this.set("getInputElement", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setMenuItemSelectedIconFunction1(value: /* props */ js.Any => ReactElement): Self = this.set("menuItemSelectedIcon", js.Any.fromFunction1(value))
    @scala.inline
