...
trait MonthPickerProps
  ...
  var monthCellContentRender: js.UndefOr[js.Function2[/* date */ Moment, /* locale */ js.Any, TagMod[Any]]] = js.undefined
}
...
object MonthPickerProps {
  ...
  def apply(
    ...
    locale: js.Any = null,
    monthCellContentRender: (/* date */ Moment, /* locale */ js.Any) => TagMod[Any] = null,
    name: String = null,
