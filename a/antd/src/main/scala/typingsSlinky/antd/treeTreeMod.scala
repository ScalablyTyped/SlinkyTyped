...
object treeTreeMod extends Shortcut {
  ...
  object TreeProps {
    ...
    implicit class TreePropsMutableBuilder[Self <: TreeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIcon(value: (js.Function1[/* nodeProps */ AntdTreeNodeAttribute, ReactElement]) | ReactElement): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIconFunction1(value: /* nodeProps */ AntdTreeNodeAttribute => ReactElement): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnClick(value: (/* e */ SyntheticMouseEvent[HTMLSpanElement], /* node */ EventDataNode) => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnDoubleClick(value: (/* e */ SyntheticMouseEvent[HTMLSpanElement], /* node */ EventDataNode) => Unit): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction2(value))
