...
object buttonButtonMod extends Shortcut {
  ...
  @js.native
  def convertLegacyProps(): ButtonProps = js.native
  @JSImport("antd/lib/button/button", "convertLegacyProps")
  @js.native
  def convertLegacyProps(`type`: LegacyButtonType): ButtonProps = js.native
  ...
  object AnchorButtonProps {
    ...
    @scala.inline
    implicit class AnchorButtonPropsMutableBuilder[Self <: AnchorButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHref(value: String with js.UndefOr[String]): Self = StObject.set(x, "href", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: SyntheticEvent[EventTarget, Event] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
  ...
  object BaseButtonProps {
    ...
    @scala.inline
    implicit class BaseButtonPropsMutableBuilder[Self <: BaseButtonProps] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.antd.antdStrings.submit
    - typingsSlinky.antd.antdStrings.button
    - typingsSlinky.antd.antdStrings.reset
  */
  ...
  */
  ...
  @js.native
  trait CompoundedComponent extends ForwardRefExoticComponent[ButtonProps with RefAttributes[HTMLElement]] {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.antd.buttonButtonMod.ButtonType
  ...
  */
  ...
  object NativeButtonProps {
    ...
    @scala.inline
    implicit class NativeButtonPropsMutableBuilder[Self <: NativeButtonProps] (val x: Self) extends AnyVal {
