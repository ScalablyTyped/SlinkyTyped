...
trait AnchorButtonProps extends js.Object {
  ...
  var href: String with js.UndefOr[String] = js.native
...
object AnchorButtonProps {
  ...
  @scala.inline
  implicit class AnchorButtonPropsOps[Self <: AnchorButtonProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: SyntheticEvent[EventTarget, Event] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
