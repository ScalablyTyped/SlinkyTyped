...
/* Inlined std.Omit<antd.antd/lib/table/interface.TableProps<T>, keyof antd.antd/lib/table/interface.WithStore> */
trait OmitTablePropsTkeyofWithStoreBodyStyle[T] extends js.Object {
  ...
  var expandIcon: js.UndefOr[js.Function1[/* props */ ExpandIconProps[T], TagMod[Any]]] = js.undefined
  ...
  var footer: js.UndefOr[js.Function1[/* currentPageData */ js.Array[T], TagMod[Any]]] = js.undefined
  ...
  var title: js.UndefOr[js.Function1[/* currentPageData */ js.Array[T], TagMod[Any]]] = js.undefined
  var useFixedHeader: js.UndefOr[Boolean] = js.undefined
}

object OmitTablePropsTkeyofWithStoreBodyStyle {
  @scala.inline
  def apply[T](
  ...
  ): OmitTablePropsTkeyofWithStoreBodyStyle[T] = {
    ...
    __obj.asInstanceOf[OmitTablePropsTkeyofWithStoreBodyStyle[T]]
  }
}
