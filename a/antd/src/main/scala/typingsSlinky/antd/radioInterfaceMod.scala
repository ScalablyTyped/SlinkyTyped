...
object radioInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.antd.antdStrings.outline
    - typingsSlinky.antd.antdStrings.solid
  */
  ...
  */
  ...
  object RadioGroupOptionType {
    ...
    @scala.inline
    def button: typingsSlinky.antd.antdStrings.button = "button".asInstanceOf[typingsSlinky.antd.antdStrings.button]
  }
