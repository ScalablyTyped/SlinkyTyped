...
object messageMod extends Shortcut {
  ...
  type ConfigContent = ReactElement | String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.antd.antdStrings.loading
  */
  ...
  object NoticeType {
    ...
    @scala.inline
    def loading: typingsSlinky.antd.antdStrings.loading = "loading".asInstanceOf[typingsSlinky.antd.antdStrings.loading]
