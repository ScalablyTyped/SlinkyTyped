...
import typingsSlinky.react.reactMod.ComponentElement
...
trait ScrollNumber
  ...
  def renderScrollNumber(hasGetPrefixCls: ConfigConsumerProps): (ComponentElement[_, ReactComponentClass[_]]) | ReactElement = js.native
}
