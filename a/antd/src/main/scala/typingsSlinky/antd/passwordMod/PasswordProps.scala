...
object PasswordProps {
  ...
  def apply(
    ...
    visibilityToggle: js.UndefOr[Boolean] = js.undefined,
    vocab: String = null,
    ...
    if (!js.isUndefined(visibilityToggle)) __obj.updateDynamic("visibilityToggle")(visibilityToggle.asInstanceOf[js.Any])
