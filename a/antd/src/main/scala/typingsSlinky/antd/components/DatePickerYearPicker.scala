...
object DatePickerYearPicker {
  ...
  implicit def make(companion: DatePickerYearPicker.type): SharedBuilder_PickPickPickerDatePropsMo1183398999 = new SharedBuilder_PickPickPickerDatePropsMo1183398999(js.Array(this.component, js.Dictionary.empty))()
}
