...
import typingsSlinky.antd.libUnderscoreUtilTransButtonMod.TransButtonProps
import typingsSlinky.antd.libUnderscoreUtilTransButtonMod.default
...
object TransButton
  ...
  typingsSlinky.antd.libUnderscoreUtilTransButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
