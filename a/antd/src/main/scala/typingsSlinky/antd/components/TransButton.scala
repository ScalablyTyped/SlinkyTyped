...
import typingsSlinky.antd.transButtonMod.TransButtonProps
import typingsSlinky.antd.transButtonMod.default
...
object TransButton
  ...
  def apply(
    ...
    onClick: /* e */ js.UndefOr[SyntheticMouseEvent[HTMLDivElement]] => Unit = null,
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antd.transButtonMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = TransButtonProps
}
