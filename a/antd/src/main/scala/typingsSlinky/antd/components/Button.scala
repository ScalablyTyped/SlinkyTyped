...
object Button {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def loading(value: Boolean | AnonDelay): this.type = set("loading", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def shape(value: ButtonShape): this.type = set("shape", value.asInstanceOf[js.Any])
    @scala.inline
