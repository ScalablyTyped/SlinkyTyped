...
object Tooltip {
  object TooltipPropsWithTitle {
    ...
    def withProps(p: typingsSlinky.antd.tooltipMod.TooltipPropsWithTitle): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    implicit def make(companion: TooltipPropsWithTitle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  }
  ...
  object TooltipPropsWithOverlay {
    ...
    def withProps(p: typingsSlinky.antd.tooltipMod.TooltipPropsWithOverlay): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    implicit def make(companion: TooltipPropsWithOverlay.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  }
