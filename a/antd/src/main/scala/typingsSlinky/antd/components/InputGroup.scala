...
object InputGroup {
  ...
  implicit def make(companion: InputGroup.type): SharedBuilder_GroupProps_418259250 = new SharedBuilder_GroupProps_418259250(js.Array(this.component, js.Dictionary.empty))()
}
