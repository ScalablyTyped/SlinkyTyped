...
import typingsSlinky.antd.libColMod.default
import typingsSlinky.antd.libGridColMod.ColProps
import typingsSlinky.antd.libGridColMod.ColSize
import typingsSlinky.antd.libGridColMod.ColSpanType
...
object Col
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antd.libColMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = ColProps
}
