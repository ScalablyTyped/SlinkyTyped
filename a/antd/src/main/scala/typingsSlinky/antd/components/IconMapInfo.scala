...
object IconMapInfo {
  ...
  implicit def make(companion: IconMapInfo.type): SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement] = new SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
}
