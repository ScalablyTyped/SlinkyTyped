...
object YearPicker {
  ...
  implicit def make(companion: YearPicker.type): SharedBuilder_PickPickPickerDatePropsMo1183398999 = new SharedBuilder_PickPickPickerDatePropsMo1183398999(js.Array(this.component, js.Dictionary.empty))()
}
