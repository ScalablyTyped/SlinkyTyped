...
object DatePicker {
  object PickerBaseProps {
    ...
    object QuarterPicker {
      ...
      implicit def make(companion: QuarterPicker.type): SharedBuilder_PickPickPickerTimePropsMo1966119181 = new SharedBuilder_PickPickPickerTimePropsMo1966119181(js.Array(this.component, js.Dictionary.empty))()
    }
