...
object DatePicker {
  object PickerBaseProps {
    ...
    object TimePicker {
      ...
      def withProps(p: PickPickPickerTimePropsMo): typingsSlinky.antd.components.DatePicker.PickerBaseProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerBaseProps.TimePicker.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
      implicit def make(companion: TimePicker.type): typingsSlinky.antd.components.DatePicker.PickerBaseProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerBaseProps.TimePicker.Builder(js.Array(this.component, js.Dictionary.empty))()
    }
    ...
    object WeekPicker {
      ...
      def withProps(p: PickPickPickerDatePropsMo): SharedBuilder_PickPickPickerDatePropsMo273792519 = new SharedBuilder_PickPickPickerDatePropsMo273792519(js.Array(this.component, p.asInstanceOf[js.Any]))
      implicit def make(companion: WeekPicker.type): SharedBuilder_PickPickPickerDatePropsMo273792519 = new SharedBuilder_PickPickPickerDatePropsMo273792519(js.Array(this.component, js.Dictionary.empty))()
    }
  ...
  object PickerDateProps {
    ...
    object TimePicker {
      ...
      def withProps(p: PickPickPickerTimePropsMo): typingsSlinky.antd.components.DatePicker.PickerDateProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerDateProps.TimePicker.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
      implicit def make(companion: TimePicker.type): typingsSlinky.antd.components.DatePicker.PickerDateProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerDateProps.TimePicker.Builder(js.Array(this.component, js.Dictionary.empty))()
    }
  ...
  object PickerTimeProps {
    ...
    object TimePicker {
      ...
      def withProps(p: PickPickPickerTimePropsMo): typingsSlinky.antd.components.DatePicker.PickerTimeProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerTimeProps.TimePicker.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
      implicit def make(companion: TimePicker.type): typingsSlinky.antd.components.DatePicker.PickerTimeProps.TimePicker.Builder = new typingsSlinky.antd.components.DatePicker.PickerTimeProps.TimePicker.Builder(js.Array(this.component, js.Dictionary.empty))()
    }
