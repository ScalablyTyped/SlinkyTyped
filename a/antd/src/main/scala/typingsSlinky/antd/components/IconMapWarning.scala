...
object IconMapWarning {
  ...
  implicit def make(companion: IconMapWarning.type): SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement] = new SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
}
