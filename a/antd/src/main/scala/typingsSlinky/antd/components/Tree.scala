...
import typingsSlinky.antd.libTreeMod.default
...
import typingsSlinky.antd.libTreeTreeMod.TreeProps
...
object Tree
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antd.libTreeMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
