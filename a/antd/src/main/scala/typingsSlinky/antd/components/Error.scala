...
object Error {
  ...
  implicit def make(companion: Error.type): SharedBuilder_PickAntdIconPropschildren_1258851850[HTMLSpanElement] = new SharedBuilder_PickAntdIconPropschildren_1258851850[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
