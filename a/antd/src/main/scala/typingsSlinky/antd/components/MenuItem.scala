...
object MenuItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onMouseEnter(value: /* e */ AnonDomEvent => Unit): this.type = set("onMouseEnter", js.Any.fromFunction1(value))
    @scala.inline
    def onMouseLeave(value: /* e */ AnonDomEvent => Unit): this.type = set("onMouseLeave", js.Any.fromFunction1(value))
    @scala.inline
