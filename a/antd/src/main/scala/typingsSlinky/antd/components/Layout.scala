...
import typingsSlinky.antd.layoutMod.default
...
object Layout
  ...
  def apply(
    ...
    if (!js.isUndefined(hasSider)) __obj.updateDynamic("hasSider")(hasSider.asInstanceOf[js.Any])
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antd.layoutMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
