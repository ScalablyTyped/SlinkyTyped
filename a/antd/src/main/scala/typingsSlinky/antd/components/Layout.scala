...
object Layout {
  ...
  object Sider {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def breakpoint(value: xs | sm | md | lg | xl | xxl): this.type = set("breakpoint", value.asInstanceOf[js.Any])
      @scala.inline
      def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
      @scala.inline
      def collapsed(value: Boolean): this.type = set("collapsed", value.asInstanceOf[js.Any])
      @scala.inline
      def collapsedWidth(value: Double | String): this.type = set("collapsedWidth", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def onBreakpoint(value: /* broken */ Boolean => Unit): this.type = set("onBreakpoint", js.Any.fromFunction1(value))
      @scala.inline
      ...
      @scala.inline
      def onCollapse(value: (/* collapsed */ Boolean, /* type */ CollapseType) => Unit): this.type = set("onCollapse", js.Any.fromFunction2(value))
      @scala.inline
      ...
      @scala.inline
      def reverseArrow(value: Boolean): this.type = set("reverseArrow", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def theme(value: SiderTheme): this.type = set("theme", value.asInstanceOf[js.Any])
      @scala.inline
      ...
      @scala.inline
      def zeroWidthTriggerStyle(value: CSSProperties): this.type = set("zeroWidthTriggerStyle", value.asInstanceOf[js.Any])
    }
    
    def withProps(p: SiderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    implicit def make(companion: Sider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  }
