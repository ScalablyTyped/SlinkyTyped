...
object Layout {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def hasSider(value: Boolean): this.type = set("hasSider", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: BasicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
