...
import typingsSlinky.antd.libInputTextAreaMod.TextAreaProps
...
abstract class SharedApply_TextAreaProps_343676828[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onPressEnter: SyntheticKeyboardEvent[HTMLTextAreaElement] => Unit = null,
