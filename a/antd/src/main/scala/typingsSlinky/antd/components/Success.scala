...
object Success {
  ...
  implicit def make(companion: Success.type): SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement] = new SharedBuilder_Pickanychildrensizeciteda1894765969[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
}
