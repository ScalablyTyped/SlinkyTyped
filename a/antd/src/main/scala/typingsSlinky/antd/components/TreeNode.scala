...
object TreeNode {
  ...
  implicit def make(companion: TreeNode.type): SharedBuilder_TreeNodeProps2057099065 = new SharedBuilder_TreeNodeProps2057099065(js.Array(this.component, js.Dictionary.empty))()
}
