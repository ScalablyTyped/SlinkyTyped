...
import typingsSlinky.antd.libDateDashPickerInterfaceMod.DatePickerMode
...
abstract class SharedApply_DatePickerProps_415338342[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  extends ExternalComponentWithAttributesWithRefType[tag.type, ComponentRef] {
  /* The following DOM/SVG props were specified: autoFocus, className, disabled, name, onBlur, onFocus, open, placeholder */
  def apply(
