...
object Warning {
  ...
  implicit def make(companion: Warning.type): SharedBuilder_PickAntdIconPropschildren_1258851850[HTMLSpanElement] = new SharedBuilder_PickAntdIconPropschildren_1258851850[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
}
