...
object Form {
  ...
  object Form {
    ...
    implicit def make[Values](companion: Form.type): SharedBuilder_FormItemProps1309695920[Values] = new SharedBuilder_FormItemProps1309695920[Values](js.Array(this.component, js.Dictionary.empty))()
  ...
  implicit def make[Values](companion: Form.type): SharedBuilder_ChildrenFormProps269883558[Values] = new SharedBuilder_ChildrenFormProps269883558[Values](js.Array(this.component, js.Dictionary.empty))()
