...
object Row {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def align(value: top | middle | bottom | stretch): this.type = set("align", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def justify(value: start | end | center | `space-around` | `space-between`): this.type = set("justify", value.asInstanceOf[js.Any])
    @scala.inline
