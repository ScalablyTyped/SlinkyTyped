...
import typingsSlinky.antd.libGridRowMod.Gutter
import typingsSlinky.antd.libGridRowMod.RowProps
import typingsSlinky.antd.libRowMod.default
...
object Row
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antd.libRowMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
  type Props = RowProps
}
