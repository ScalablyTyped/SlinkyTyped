...
@scala.inline
class SharedBuilder_PasswordPropsRefAttributes1788206810[R <: js.Object] (val args: js.Array[js.Any])
  extends AnyVal
  ...
  @scala.inline
  def visibilityToggle(value: Boolean): this.type = set("visibilityToggle", value.asInstanceOf[js.Any])
