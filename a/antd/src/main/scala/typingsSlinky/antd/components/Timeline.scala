...
import typingsSlinky.antd.libTimelineMod.default
import typingsSlinky.antd.libTimelineTimelineMod.TimelineProps
...
object Timeline
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antd.libTimelineMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
