...
import typingsSlinky.antd.esRadioMod.default
...
object Radio
  ...
  override val component: String | js.Object = js.constructorOf[typingsSlinky.antd.esRadioMod.default].asInstanceOf[String | js.Object]
  def apply(
