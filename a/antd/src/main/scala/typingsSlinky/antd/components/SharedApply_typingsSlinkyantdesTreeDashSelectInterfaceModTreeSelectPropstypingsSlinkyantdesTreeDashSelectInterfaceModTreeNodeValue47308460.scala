...
import typingsSlinky.antd.esTreeDashSelectInterfaceMod.TreeDataSimpleMode
...
abstract class SharedApply_typingsSlinkyantdesTreeDashSelectInterfaceModTreeSelectPropstypingsSlinkyantdesTreeDashSelectInterfaceModTreeNodeValue47308460[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
  ...
  def apply(
    ...
    onChange: (TreeNodeValue, /* label */ js.Any, /* extra */ js.Any) => Unit = null,
    ...
    treeData: js.Array[typingsSlinky.antd.esTreeDashSelectInterfaceMod.TreeNode] = null,
