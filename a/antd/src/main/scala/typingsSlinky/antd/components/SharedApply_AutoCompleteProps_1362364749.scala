...
import typingsSlinky.antd.libAutoDashCompleteMod.AutoCompleteProps
import typingsSlinky.antd.libAutoDashCompleteMod.DataSourceItemType
...
abstract class SharedApply_AutoCompleteProps_1362364749[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
