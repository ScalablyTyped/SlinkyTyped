...
object Search {
  ...
  implicit def make(companion: Search.type): SharedBuilder_SearchPropsRefAttributes1904739986[Ref[js.Any] with js.Object] = new SharedBuilder_SearchPropsRefAttributes1904739986[Ref[js.Any] with js.Object](js.Array(this.component, js.Dictionary.empty))()
}
