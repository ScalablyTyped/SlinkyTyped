...
object autoCompleteMod extends Shortcut {
  ...
  object AutoCompleteProps {
    ...
    implicit class AutoCompletePropsMutableBuilder[Self <: AutoCompleteProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetInputElement(value: () => ReactElement): Self = StObject.set(x, "getInputElement", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setMenuItemSelectedIconFunction1(value: /* props */ js.Any => ReactElement): Self = StObject.set(x, "menuItemSelectedIcon", js.Any.fromFunction1(value))
