...
object switchMod extends Shortcut {
  ...
  object SwitchProps {
    ...
    implicit class SwitchPropsMutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCheckedChildrenReactElement(value: ReactElement): Self = StObject.set(x, "checkedChildren", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUnCheckedChildrenReactElement(value: ReactElement): Self = StObject.set(x, "unCheckedChildren", value.asInstanceOf[js.Any])
