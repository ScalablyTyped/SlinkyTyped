...
object uploadInterfaceMod {
  ...
  object ShowUploadListInterface {
    ...
    implicit class ShowUploadListInterfaceMutableBuilder[Self <: ShowUploadListInterface] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDownloadIcon(value: ReactElement | (js.Function1[/* file */ UploadFile[_], ReactElement])): Self = StObject.set(x, "downloadIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDownloadIconFunction1(value: /* file */ UploadFile[_] => ReactElement): Self = StObject.set(x, "downloadIcon", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRemoveIcon(value: ReactElement | (js.Function1[/* file */ UploadFile[_], ReactElement])): Self = StObject.set(x, "removeIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRemoveIconFunction1(value: /* file */ UploadFile[_] => ReactElement): Self = StObject.set(x, "removeIcon", js.Any.fromFunction1(value))
  ...
  object UploadFile {
    ...
    implicit class UploadFileMutableBuilder[Self <: UploadFile[_], T] (val x: Self with UploadFile[T]) extends AnyVal {
      ...
      @scala.inline
      def setOriginFileObjBlob(value: Blob): Self = StObject.set(x, "originFileObj", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOriginFileObjFile(value: File): Self = StObject.set(x, "originFileObj", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object UploadListProps {
    ...
    implicit class UploadListPropsMutableBuilder[Self <: UploadListProps[_], T] (val x: Self with UploadListProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setAppendActionReactElement(value: ReactElement): Self = StObject.set(x, "appendAction", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setItemRender(
        value: (/* originNode */ ReactElement, /* file */ UploadFile[js.Any], /* fileList */ js.UndefOr[js.Array[UploadFile[T]]]) => ReactElement
