...
import typingsSlinky.antd.antdStrings.optional
...
object formFormMod {
  ...
  @js.native
  def default[Values](props: Children[Values] with FormProps[Values]): ReactElement = js.native
  
  @JSImport("antd/lib/form/Form", "List")
  @js.native
  val List: ReactComponentClass[ListProps] = js.native
  
  @JSImport("antd/lib/form/Form", "useForm")
  @js.native
  ...
  */
  ...
  trait FormProps[Values] extends StObject {
    ...
    var children: js.UndefOr[RenderProps | ReactElement] = js.native
    ...
    var scrollToFirstError: js.UndefOr[Boolean] = js.native
  ...
  object FormProps {
    ...
    implicit class FormPropsMutableBuilder[Self <: FormProps[_], Values] (val x: Self with FormProps[Values]) extends AnyVal {
      ...
      @scala.inline
      def setHideRequiredMark(value: Boolean): Self = StObject.set(x, "hideRequiredMark", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHideRequiredMarkUndefined: Self = StObject.set(x, "hideRequiredMark", js.undefined)
      ...
      @scala.inline
      def setScrollToFirstError(value: Boolean): Self = StObject.set(x, "scrollToFirstError", value.asInstanceOf[js.Any])
