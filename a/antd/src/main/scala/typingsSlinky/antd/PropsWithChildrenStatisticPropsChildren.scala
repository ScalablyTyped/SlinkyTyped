...
trait PropsWithChildrenStatisticPropsChildren extends js.Object {
...
object PropsWithChildrenStatisticPropsChildren {
  @scala.inline
  def apply(
  ...
  ): PropsWithChildrenStatisticPropsChildren = {
    ...
    __obj.asInstanceOf[PropsWithChildrenStatisticPropsChildren]
  }
}
