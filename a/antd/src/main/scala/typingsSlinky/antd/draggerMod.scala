...
import typingsSlinky.antd.uploadInterfaceMod.PreviewFileHandler
...
object draggerMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[DraggerProps] = js.native
  ...
  object DraggerProps {
    ...
    implicit class DraggerPropsMutableBuilder[Self <: DraggerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIconRender(value: (/* file */ UploadFile[_], /* listType */ js.UndefOr[UploadListType]) => ReactElement): Self = StObject.set(x, "iconRender", js.Any.fromFunction2(value))
  ...
  type _To = ReactComponentClass[DraggerProps]
  
  /* This means you don't have to write `default`, but can instead just say `draggerMod.foo` */
  override def _to: ReactComponentClass[DraggerProps] = default
}
