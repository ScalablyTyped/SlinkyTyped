...
@js.native
trait RadioGroupState extends js.Object {
  var prevPropValue: js.Any = js.native
...
object RadioGroupState {
  ...
  @scala.inline
  implicit class RadioGroupStateOps[Self <: RadioGroupState] (val x: Self) extends AnyVal {
    @scala.inline
