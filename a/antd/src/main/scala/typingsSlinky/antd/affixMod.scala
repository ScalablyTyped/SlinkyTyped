...
object affixMod {
  ...
  object AffixState {
    ...
    implicit class AffixStateMutableBuilder[Self <: AffixState] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPrevTargetHTMLElement(value: HTMLElement): Self = StObject.set(x, "prevTarget", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrevTargetNull: Self = StObject.set(x, "prevTarget", null)
      
      @scala.inline
      def setPrevTargetWindow(value: Window): Self = StObject.set(x, "prevTarget", value.asInstanceOf[js.Any])
