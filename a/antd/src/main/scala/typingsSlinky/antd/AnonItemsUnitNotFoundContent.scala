...
object AnonItemsUnitNotFoundContent {
  @scala.inline
  def apply(itemUnit: String, itemsUnit: String, searchPlaceholder: String, titles: js.Array[String]): AnonItemsUnitNotFoundContent = {
  ...
  @scala.inline
  implicit class AnonItemsUnitNotFoundContentOps[Self <: AnonItemsUnitNotFoundContent] (val x: Self) extends AnyVal {
    @scala.inline
