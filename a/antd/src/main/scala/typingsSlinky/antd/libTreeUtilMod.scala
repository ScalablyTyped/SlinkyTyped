...
object libTreeUtilMod extends js.Object {
  ...
  def convertDirectoryKeysToNodes(rootChildren: js.Array[ReactNode], keys: js.Array[String]): js.Array[ReactComponentClass[AntTreeNodeProps]] = js.native
  def convertDirectoryKeysToNodes(rootChildren: ReactNode, keys: js.Array[String]): js.Array[ReactComponentClass[AntTreeNodeProps]] = js.native
