...
trait Anon_EmptyTextFilterConfirm extends js.Object {
...
object Anon_EmptyTextFilterConfirm {
  @scala.inline
  def apply(
    emptyText: String,
    ...
    __obj.asInstanceOf[Anon_EmptyTextFilterConfirm]
  }
}
