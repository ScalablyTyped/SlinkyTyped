...
@js.native
trait AnonSelectAll extends js.Object {
...
object AnonSelectAll {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonSelectAll]
  }
  @scala.inline
  implicit class AnonSelectAllOps[Self <: AnonSelectAll] (val x: Self) extends AnyVal {
    @scala.inline
