...
trait Anon_FilterConfirmFilterResetFilterTitle extends js.Object {
...
object Anon_FilterConfirmFilterResetFilterTitle {
  @scala.inline
  def apply(
    ...
    selectInvert: String,
    sortTitle: String
  ): Anon_FilterConfirmFilterResetFilterTitle = {
    ...
    __obj.asInstanceOf[Anon_FilterConfirmFilterResetFilterTitle]
  }
}
