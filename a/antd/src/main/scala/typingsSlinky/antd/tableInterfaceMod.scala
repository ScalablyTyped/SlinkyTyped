...
object tableInterfaceMod {
  ...
  type ColumnTitle[RecordType] = ReactElement | (js.Function1[/* props */ ColumnTitleProps[RecordType], ReactElement])
  ...
  */
  ...
  object FilterDropdownProps {
    ...
    implicit class FilterDropdownPropsMutableBuilder[Self <: FilterDropdownProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectedKeys(value: js.Array[typingsSlinky.react.mod.Key]): Self = StObject.set(x, "selectedKeys", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectedKeysVarargs(value: typingsSlinky.react.mod.Key*): Self = StObject.set(x, "selectedKeys", js.Array(value :_*))
      
      @scala.inline
      def setSetSelectedKeys(value: js.Array[typingsSlinky.react.mod.Key] => Unit): Self = StObject.set(x, "setSelectedKeys", js.Any.fromFunction1(value))
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.antd.antdStrings.paginate
    - typingsSlinky.antd.antdStrings.sort
    - typingsSlinky.antd.antdStrings.filter
  */
  ...
  object TableLocale {
    ...
    implicit class TableLocaleMutableBuilder[Self <: TableLocale] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilterConfirmReactElement(value: ReactElement): Self = StObject.set(x, "filterConfirm", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilterEmptyTextReactElement(value: ReactElement): Self = StObject.set(x, "filterEmptyText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilterResetReactElement(value: ReactElement): Self = StObject.set(x, "filterReset", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectAllReactElement(value: ReactElement): Self = StObject.set(x, "selectAll", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectInvertReactElement(value: ReactElement): Self = StObject.set(x, "selectInvert", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectionAllReactElement(value: ReactElement): Self = StObject.set(x, "selectionAll", value.asInstanceOf[js.Any])
  ...
  */
  ...
  trait TableRowSelection[T] extends StObject {
    ...
    var columnTitle: js.UndefOr[String | ReactElement] = js.native
  ...
  object TableRowSelection {
    ...
    implicit class TableRowSelectionMutableBuilder[Self <: TableRowSelection[_], T] (val x: Self with TableRowSelection[T]) extends AnyVal {
      ...
      @scala.inline
      def setColumnTitle(value: String | ReactElement): Self = StObject.set(x, "columnTitle", value.asInstanceOf[js.Any])
