...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "rc-field-form" % "1.4.4-c342c0",
  ...
  "org.scalablytyped.slinky" %%% "rc-picker" % "1.6.4-ef52d3",
  ...
  "org.scalablytyped.slinky" %%% "rc-tree-select" % "4.0.1-e8caa3",
