...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "rc-field-form" % "1.5.1-051dd1",
  "org.scalablytyped.slinky" %%% "rc-mentions" % "1.4.0-af8f77",
  "org.scalablytyped.slinky" %%% "rc-menu" % "8.5.0-7c2878",
  "org.scalablytyped.slinky" %%% "rc-notification" % "4.4.0-d5cef9",
  "org.scalablytyped.slinky" %%% "rc-picker" % "1.10.7-eacda0",
  "org.scalablytyped.slinky" %%% "rc-select" % "v5.9.0-dt-20200515Z-0e6e81",
  "org.scalablytyped.slinky" %%% "rc-table" % "7.8.6-78b7fc",
  "org.scalablytyped.slinky" %%% "rc-tree" % "1.11-dt-20200515Z-5dbdba",
  "org.scalablytyped.slinky" %%% "rc-tree-select" % "4.0.3-289bae",
