...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "rc-field-form" % "1.8.0-b6c711",
  "org.scalablytyped.slinky" %%% "rc-mentions" % "1.4.0-345588",
  "org.scalablytyped.slinky" %%% "rc-menu" % "8.5.0-f307b3",
  "org.scalablytyped.slinky" %%% "rc-notification" % "4.4.0-0c247e",
  "org.scalablytyped.slinky" %%% "rc-picker" % "1.15.1-f41f2f",
  "org.scalablytyped.slinky" %%% "rc-select" % "11.1.0-532e49",
  "org.scalablytyped.slinky" %%% "rc-table" % "7.8.6-c29aa2",
  "org.scalablytyped.slinky" %%% "rc-tabs" % "11.5.6-e7890a",
  ...
  "org.scalablytyped.slinky" %%% "rc-tree-select" % "4.1.0-daef2d",
