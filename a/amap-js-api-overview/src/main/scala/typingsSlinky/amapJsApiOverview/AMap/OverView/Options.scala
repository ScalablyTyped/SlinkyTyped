...
object Options {
  @scala.inline
  def apply[/* <: typingsSlinky.amapJsApi.AMap.TileLayer */ L](): Options[L] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[L]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_], /* <: typingsSlinky.amapJsApi.AMap.TileLayer */ L] (val x: Self with Options[L]) extends AnyVal {
    @scala.inline
