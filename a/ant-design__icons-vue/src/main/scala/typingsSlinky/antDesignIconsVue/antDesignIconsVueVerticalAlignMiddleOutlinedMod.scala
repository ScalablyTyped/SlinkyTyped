...
object antDesignIconsVueVerticalAlignMiddleOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/VerticalAlignMiddleOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/VerticalAlignMiddleOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/VerticalAlignMiddleOutlined", "default.inheritAttrs")
    @js.native
