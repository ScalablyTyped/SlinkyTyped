...
object antDesignIconsVueGoldenFilledMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/GoldenFilled", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/GoldenFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/GoldenFilled", "default.inheritAttrs")
    @js.native
