...
object antDesignIconsVueFolderTwoToneMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/FolderTwoTone", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/FolderTwoTone", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/FolderTwoTone", "default.inheritAttrs")
    @js.native
