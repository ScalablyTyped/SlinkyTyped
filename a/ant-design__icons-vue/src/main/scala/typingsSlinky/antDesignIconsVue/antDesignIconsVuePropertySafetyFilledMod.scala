...
object antDesignIconsVuePropertySafetyFilledMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/PropertySafetyFilled", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/PropertySafetyFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/PropertySafetyFilled", "default.inheritAttrs")
    @js.native
