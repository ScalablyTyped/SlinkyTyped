...
object antDesignIconsVueLikeOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/LikeOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/LikeOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/LikeOutlined", "default.inheritAttrs")
    @js.native
