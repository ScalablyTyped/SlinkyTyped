...
object antDesignIconsVueGifOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/GifOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/GifOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/GifOutlined", "default.inheritAttrs")
    @js.native
