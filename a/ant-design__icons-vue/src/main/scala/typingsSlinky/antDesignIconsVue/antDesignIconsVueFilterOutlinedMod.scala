...
object antDesignIconsVueFilterOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/FilterOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/FilterOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/FilterOutlined", "default.inheritAttrs")
    @js.native
