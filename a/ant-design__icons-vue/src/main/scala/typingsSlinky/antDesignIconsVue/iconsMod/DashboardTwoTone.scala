...
object DashboardTwoTone {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "DashboardTwoTone.displayName")
  @js.native
  def displayName: String = js.native
  @scala.inline
  def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "DashboardTwoTone.inheritAttrs")
  @js.native
