...
object GithubOutlined {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "GithubOutlined.displayName")
  @js.native
  def displayName: String = js.native
  @scala.inline
  def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "GithubOutlined.inheritAttrs")
  @js.native
