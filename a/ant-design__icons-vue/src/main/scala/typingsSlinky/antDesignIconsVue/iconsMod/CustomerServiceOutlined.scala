...
object CustomerServiceOutlined {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "CustomerServiceOutlined.displayName")
  @js.native
  def displayName: String = js.native
  @scala.inline
  def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "CustomerServiceOutlined.inheritAttrs")
  @js.native
