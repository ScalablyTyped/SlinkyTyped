...
object DribbbleCircleFilled {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "DribbbleCircleFilled.displayName")
  @js.native
  def displayName: String = js.native
  @scala.inline
  def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "DribbbleCircleFilled.inheritAttrs")
  @js.native
