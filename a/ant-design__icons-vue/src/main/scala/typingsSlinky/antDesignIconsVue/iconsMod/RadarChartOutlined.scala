...
object RadarChartOutlined {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "RadarChartOutlined.displayName")
  @js.native
  def displayName: String = js.native
  @scala.inline
  def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "RadarChartOutlined.inheritAttrs")
  @js.native
