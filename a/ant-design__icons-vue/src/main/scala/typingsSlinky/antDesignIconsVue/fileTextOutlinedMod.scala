...
object fileTextOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/lib/icons/FileTextOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/lib/icons/FileTextOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/lib/icons/FileTextOutlined", "default.inheritAttrs")
    @js.native
