...
object antDesignIconsVueSettingFilledMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/SettingFilled", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/SettingFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/SettingFilled", "default.inheritAttrs")
    @js.native
