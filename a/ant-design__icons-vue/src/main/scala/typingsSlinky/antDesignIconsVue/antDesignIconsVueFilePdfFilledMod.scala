...
object antDesignIconsVueFilePdfFilledMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/FilePdfFilled", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/FilePdfFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/FilePdfFilled", "default.inheritAttrs")
    @js.native
