package typingsSlinky.activexInfopath.InfoPath.EventHelperTypes
...
@js.native
trait DataDOMInvokeParameter extends js.Object {
...
object DataDOMInvokeParameter {
  ...
  @scala.inline
  implicit class DataDOMInvokeParameterOps[Self <: DataDOMInvokeParameter] (val x: Self) extends AnyVal {
