...
class SharePointListAdapterRWObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.SharePointListAdapterRWObject {
  /* CompleteClass */
  override var ContentTypeId: String = js.native
  /* CompleteClass */
  @JSName("InfoPath.SharePointListAdapterRWObject_typekey")
  override var InfoPathDotSharePointListAdapterRWObject_typekey: typingsSlinky.activexInfopath.InfoPath.SharePointListAdapterRWObject = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var SiteUrl: String = js.native
  /* CompleteClass */
