...
class UserPermissionObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.UserPermissionObject {
  /* CompleteClass */
  override var ExpirationDate: js.Any = js.native
  /* CompleteClass */
  @JSName("InfoPath.UserPermissionObject_typekey")
  override var InfoPathDotUserPermissionObject_typekey: typingsSlinky.activexInfopath.InfoPath.UserPermissionObject = js.native
  /* CompleteClass */
