...
class BDCAdapterObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.BDCAdapterObject {
  /* CompleteClass */
  ...
  override var InfoPathDotBDCAdapterObject_typekey: typingsSlinky.activexInfopath.InfoPath.BDCAdapterObject = js.native
  /* CompleteClass */
