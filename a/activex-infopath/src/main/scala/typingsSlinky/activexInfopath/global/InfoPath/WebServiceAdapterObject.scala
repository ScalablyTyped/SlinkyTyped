...
class WebServiceAdapterObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.WebServiceAdapterObject {
  /* CompleteClass */
  override val ErrorsLocation: IXMLDOMNode = js.native
  /* CompleteClass */
  @JSName("InfoPath.WebServiceAdapterObject_typekey")
  override var InfoPathDotWebServiceAdapterObject_typekey: typingsSlinky.activexInfopath.InfoPath.WebServiceAdapterObject = js.native
  /* CompleteClass */
