...
class EmailAdapterObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.EmailAdapterObject {
  /* CompleteClass */
  ...
  override var InfoPathDotEmailAdapterObject_typekey: typingsSlinky.activexInfopath.InfoPath.EmailAdapterObject = js.native
  /* CompleteClass */
