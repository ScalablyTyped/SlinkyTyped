...
@js.native
class SharepointListAdapterObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.SharepointListAdapterObject {
  /* CompleteClass */
  @JSName("InfoPath.SharepointListAdapterObject_typekey")
  override var InfoPathDotSharepointListAdapterObject_typekey: typingsSlinky.activexInfopath.InfoPath.SharepointListAdapterObject = js.native
  /* CompleteClass */
  override val Name: String = js.native
  /* CompleteClass */
  override val QueryAllowed: Boolean = js.native
  /* CompleteClass */
  override val SiteUrl: String = js.native
  /* CompleteClass */
