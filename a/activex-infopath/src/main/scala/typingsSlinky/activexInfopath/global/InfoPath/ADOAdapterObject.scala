...
class ADOAdapterObject protected ()
  extends typingsSlinky.activexInfopath.InfoPath.ADOAdapterObject {
  /* CompleteClass */
  ...
  override var InfoPathDotADOAdapterObject_typekey: typingsSlinky.activexInfopath.InfoPath.ADOAdapterObject = js.native
  /* CompleteClass */
