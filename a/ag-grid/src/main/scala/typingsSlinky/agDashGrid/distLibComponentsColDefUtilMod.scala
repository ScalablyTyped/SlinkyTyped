...
@JSImport("ag-grid/dist/lib/components/colDefUtil", JSImport.Namespace)
@js.native
object distLibComponentsColDefUtilMod extends js.Object {
  @js.native
  class ColDefUtil () extends js.Object
  
  /* static members */
  @js.native
  object ColDefUtil extends js.Object {
    ...
    var FRAMEWORK_PROPERTIES: js.Array[String] = js.native
