...
object PromiseStatus extends js.Object {
  ...
  /* 0 */ val IN_PROGRESS: typingsSlinky.agDashGrid.distLibUtilsMod.PromiseStatus.IN_PROGRESS with Double = js.native
  /* 1 */ val RESOLVED: typingsSlinky.agDashGrid.distLibUtilsMod.PromiseStatus.RESOLVED with Double = js.native
  @JSBracketAccess
