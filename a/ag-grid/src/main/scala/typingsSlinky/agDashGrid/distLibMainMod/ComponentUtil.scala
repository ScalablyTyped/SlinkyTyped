...
@js.native
class ComponentUtil ()
  extends typingsSlinky.agDashGrid.distLibComponentsComponentUtilMod.ComponentUtil
...
object ComponentUtil extends js.Object {
  ...
  def processOnChange(
    ...
    api: typingsSlinky.agDashGrid.distLibGridApiMod.GridApi,
    columnApi: typingsSlinky.agDashGrid.distLibColumnControllerColumnApiMod.ColumnApi
  ): Unit = js.native
