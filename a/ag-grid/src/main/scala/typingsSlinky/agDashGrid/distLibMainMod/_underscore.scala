...
@js.native
class _underscore ()
  extends typingsSlinky.agDashGrid.distLibUtilsMod.Utils

@JSImport("ag-grid/dist/lib/main", "_")
@js.native
object _underscore
  extends Instantiable0[typingsSlinky.agDashGrid.distLibUtilsMod.Utils] {
  ...
  def sortRowNodesByOrder(
    rowNodes: js.Array[typingsSlinky.agDashGrid.distLibEntitiesRowNodeMod.RowNode],
  ...
  def traverseNodesWithKey(
    nodes: js.Array[typingsSlinky.agDashGrid.distLibEntitiesRowNodeMod.RowNode],
    callback: js.Function2[
      /* node */ typingsSlinky.agDashGrid.distLibEntitiesRowNodeMod.RowNode, 
      /* key */ String, 
      Unit
    ]
  ): Unit = js.native
