...
abstract class BaseComponentWrapper[F /* <: WrapableInterface */] () extends FrameworkComponentWrapper {
  ...
  def createWrapper(OriginalConstructor: Anon_Any_640158205): F = js.native
  def createWrapper(OriginalConstructor: Anon_Any_640158205, componentName: String): F = js.native
}
