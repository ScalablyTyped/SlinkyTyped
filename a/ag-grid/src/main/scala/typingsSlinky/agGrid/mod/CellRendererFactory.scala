...
@JSImport("ag-grid", "CellRendererFactory")
@js.native
...
object CellRendererFactory {
  ...
  @JSImport("ag-grid", "CellRendererFactory.ANIMATE_SHOW_CHANGE")
  @js.native
  ...
  @JSImport("ag-grid", "CellRendererFactory.ANIMATE_SLIDE")
  @js.native
  ...
  @JSImport("ag-grid", "CellRendererFactory.GROUP")
  @js.native
