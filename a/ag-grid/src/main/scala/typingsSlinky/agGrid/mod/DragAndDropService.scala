...
@JSImport("ag-grid", "DragAndDropService")
@js.native
...
object DragAndDropService {
  ...
  @JSImport("ag-grid", "DragAndDropService.GHOST_TEMPLATE")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_ADD")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_AGGREGATE")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_GROUP")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_LEFT")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_MOVE")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_NOT_ALLOWED")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_PINNED")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_PIVOT")
  @js.native
  ...
  @JSImport("ag-grid", "DragAndDropService.ICON_RIGHT")
  @js.native
