...
object Column {
  ...
  @JSImport("ag-grid", "Column.EVENT_FILTER_ACTIVE_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_FILTER_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_FIRST_RIGHT_PINNED_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_LAST_LEFT_PINNED_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_LEFT_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_MENU_VISIBLE_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_MOVING_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_PIVOT_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_ROW_GROUP_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_SORT_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_VALUE_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_VISIBLE_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.EVENT_WIDTH_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "Column.PINNED_LEFT")
  @js.native
  ...
  @JSImport("ag-grid", "Column.PINNED_RIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "Column.SORT_ASC")
  @js.native
  ...
  @JSImport("ag-grid", "Column.SORT_DESC")
  @js.native
