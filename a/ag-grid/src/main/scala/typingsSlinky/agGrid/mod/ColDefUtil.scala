...
@JSImport("ag-grid", "ColDefUtil")
@js.native
class ColDefUtil ()
  extends typingsSlinky.agGrid.colDefUtilMod.ColDefUtil
/* static members */
object ColDefUtil {
  ...
  @JSImport("ag-grid", "ColDefUtil.ALL_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.ARRAY_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.BOOLEAN_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.FRAMEWORK_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.FUNCTION_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.NUMBER_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.OBJECT_PROPERTIES")
  @js.native
  ...
  @JSImport("ag-grid", "ColDefUtil.STRING_PROPERTIES")
  @js.native
