...
@js.native
class RowNode ()
  extends typingsSlinky.agGrid.rowNodeMod.RowNode
/* static members */
object RowNode {
  ...
  @JSImport("ag-grid", "RowNode.EVENT_ALL_CHILDREN_COUNT_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_CELL_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_CHILD_INDEX_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_DATA_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_DRAGGING_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_EXPANDED_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_FIRST_CHILD_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_HEIGHT_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_LAST_CHILD_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_MOUSE_ENTER")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_MOUSE_LEAVE")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_ROW_INDEX_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_ROW_SELECTED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_SELECTABLE_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_TOP_CHANGED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNode.EVENT_UI_LEVEL_CHANGED")
  @js.native
