...
class GridOptionsWrapper ()
  extends typingsSlinky.agGrid.gridOptionsWrapperMod.GridOptionsWrapper
/* static members */
object GridOptionsWrapper {
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.MIN_COL_WIDTH")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_FLOATING_FILTERS_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_GRID_AUTO_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_GROUP_HEADER_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_GROUP_REMOVE_LOWEST_SINGLE_CHILDREN")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_GROUP_REMOVE_SINGLE_CHILDREN")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_HEADER_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_PIVOT_GROUP_HEADER_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_PIVOT_HEADER_HEIGHT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_POPUP_PARENT")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_SUPPRESS_CLIPBOARD_PASTE")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.PROP_SUPPRESS_ROW_DRAG")
  @js.native
  ...
  @JSImport("ag-grid", "GridOptionsWrapper.checkEventDeprecation")
  @js.native
