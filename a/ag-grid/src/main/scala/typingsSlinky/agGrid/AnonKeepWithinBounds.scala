...
object AnonKeepWithinBounds {
  @scala.inline
  def apply(column: Column, ePopup: HTMLElement, eventSource: HTMLElement, rowNode: RowNode, `type`: String): AnonKeepWithinBounds = {
  ...
  @scala.inline
  implicit class AnonKeepWithinBoundsOps[Self <: AnonKeepWithinBounds] (val x: Self) extends AnyVal {
    @scala.inline
