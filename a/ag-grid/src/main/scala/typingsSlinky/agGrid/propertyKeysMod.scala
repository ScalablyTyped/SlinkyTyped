...
object propertyKeysMod {
  
  @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys")
  @js.native
  class PropertyKeys () extends StObject
  /* static members */
  object PropertyKeys {
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.ALL_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.ARRAY_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.BOOLEAN_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.FRAMEWORK_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.FUNCTION_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.NUMBER_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.OBJECT_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/propertyKeys", "PropertyKeys.STRING_PROPERTIES")
    @js.native
