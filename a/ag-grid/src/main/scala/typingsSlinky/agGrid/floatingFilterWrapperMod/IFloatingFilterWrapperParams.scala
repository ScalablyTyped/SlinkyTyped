...
object IFloatingFilterWrapperParams {
  @scala.inline
  def apply[M, /* <: typingsSlinky.agGrid.floatingFilterMod.FloatingFilterChange */ F, /* <: typingsSlinky.agGrid.floatingFilterMod.IFloatingFilterParams[M, F] */ P](
    column: Column,
  ...
  @scala.inline
  implicit class IFloatingFilterWrapperParamsOps[Self <: IFloatingFilterWrapperParams[_, _, _], M, /* <: typingsSlinky.agGrid.floatingFilterMod.FloatingFilterChange */ F, /* <: typingsSlinky.agGrid.floatingFilterMod.IFloatingFilterParams[M, F] */ P] (val x: Self with (IFloatingFilterWrapperParams[M, F, P])) extends AnyVal {
    @scala.inline
