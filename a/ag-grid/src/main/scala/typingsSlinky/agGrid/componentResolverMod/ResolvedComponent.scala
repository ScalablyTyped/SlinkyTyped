...
object ResolvedComponent {
  ...
  @scala.inline
  implicit class ResolvedComponentOps[Self <: ResolvedComponent[_, _], /* <: typingsSlinky.agGrid.iComponentMod.IComponent[_] with B */ A, B] (val x: Self with (ResolvedComponent[A, B])) extends AnyVal {
    @scala.inline
