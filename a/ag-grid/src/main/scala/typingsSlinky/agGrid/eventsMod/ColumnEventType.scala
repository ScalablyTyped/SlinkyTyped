...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.agGrid.agGridStrings.sizeColumnsToFit
  - typingsSlinky.agGrid.agGridStrings.autosizeColumns
  - typingsSlinky.agGrid.agGridStrings.alignedGridChanged
  - typingsSlinky.agGrid.agGridStrings.filterChanged
  - typingsSlinky.agGrid.agGridStrings.filterDestroyed
  - typingsSlinky.agGrid.agGridStrings.gridOptionsChanged
  - typingsSlinky.agGrid.agGridStrings.gridInitializing
  - typingsSlinky.agGrid.agGridStrings.toolPanelDragAndDrop
  - typingsSlinky.agGrid.agGridStrings.toolPanelUi
  - typingsSlinky.agGrid.agGridStrings.uiColumnMoved
  - typingsSlinky.agGrid.agGridStrings.uiColumnResized
  - typingsSlinky.agGrid.agGridStrings.uiColumnDragged
  - typingsSlinky.agGrid.agGridStrings.uiColumnExpanded
  - typingsSlinky.agGrid.agGridStrings.uiColumnSorted
  - typingsSlinky.agGrid.agGridStrings.contextMenu
  - typingsSlinky.agGrid.agGridStrings.columnMenu
  - typingsSlinky.agGrid.agGridStrings.rowModelUpdated
  - typingsSlinky.agGrid.agGridStrings.api
*/
