package typingsSlinky.agGrid.iStatusBarMod
...
object IStatusBar {
  ...
  implicit class IStatusBarOps[Self <: IStatusBar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRegisterGridPanel(value: GridPanel => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerGridPanel")(js.Any.fromFunction1(value))
        ret
    }
  }
