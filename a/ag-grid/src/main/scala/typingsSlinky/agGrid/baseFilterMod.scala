...
import typingsSlinky.agGrid.textFilterMod.ITextFilterParams
...
object baseFilterMod {
  ...
  - typingsSlinky.agGrid.iFilterMod.IFilterComp because var conflicts: afterGuiAttached, destroy, init. Inlined  */ @JSImport("ag-grid/dist/lib/filter/baseFilter", "BaseFilter")
  @js.native
  ...
  object FilterConditionType extends StObject {
    ...
    /* 1 */ val CONDITION: typingsSlinky.agGrid.baseFilterMod.FilterConditionType.CONDITION with Double = js.native
    
    @js.native
    sealed trait MAIN extends FilterConditionType
    /* 0 */ val MAIN: typingsSlinky.agGrid.baseFilterMod.FilterConditionType.MAIN with Double = js.native
  }
