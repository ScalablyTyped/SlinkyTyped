...
object SerializedDateFilter {
  ...
  implicit class SerializedDateFilterOps[Self <: SerializedDateFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDateFrom(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dateFrom")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDateTo(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dateTo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
