...
object Column {
  ...
  implicit class ColumnMutableBuilder[Self <: Column] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMouseEventMouseEvent(value: MouseEvent): Self = StObject.set(x, "mouseEvent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMouseEventTouch(value: Touch): Self = StObject.set(x, "mouseEvent", value.asInstanceOf[js.Any])
