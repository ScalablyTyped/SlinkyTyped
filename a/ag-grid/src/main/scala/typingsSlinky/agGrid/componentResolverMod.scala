...
object componentResolverMod {
  ...
  object ComponentSource extends StObject {
    ...
    /* 0 */ val DEFAULT: typingsSlinky.agGrid.componentResolverMod.ComponentSource.DEFAULT with Double = js.native
    
    @js.native
    sealed trait HARDCODED extends ComponentSource
    /* 2 */ val HARDCODED: typingsSlinky.agGrid.componentResolverMod.ComponentSource.HARDCODED with Double = js.native
    
    @js.native
    sealed trait REGISTERED_BY_NAME extends ComponentSource
    /* 1 */ val REGISTERED_BY_NAME: typingsSlinky.agGrid.componentResolverMod.ComponentSource.REGISTERED_BY_NAME with Double = js.native
  }
  ...
  object ComponentType extends StObject {
    ...
    /* 0 */ val AG_GRID: typingsSlinky.agGrid.componentResolverMod.ComponentType.AG_GRID with Double = js.native
    
    @js.native
    sealed trait FRAMEWORK extends ComponentType
    /* 1 */ val FRAMEWORK: typingsSlinky.agGrid.componentResolverMod.ComponentType.FRAMEWORK with Double = js.native
  }
