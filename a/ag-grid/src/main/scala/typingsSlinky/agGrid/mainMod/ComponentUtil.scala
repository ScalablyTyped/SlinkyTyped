...
@js.native
class ComponentUtil ()
  extends typingsSlinky.agGrid.componentUtilMod.ComponentUtil
/* static members */
object ComponentUtil {
  ...
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.copyAttributesToGridOptions")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.getCallbackForEvent")
  @js.native
  def getCallbackForEvent(eventName: String): String = js.native
  
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.getEventCallbacks")
  @js.native
  def getEventCallbacks(): js.Array[String] = js.native
  
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.processOnChange")
  @js.native
  def processOnChange(
    changes: js.Any,
    gridOptions: GridOptions,
    api: typingsSlinky.agGrid.gridApiMod.GridApi,
    columnApi: typingsSlinky.agGrid.columnApiMod.ColumnApi
  ): Unit = js.native
  
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.toBoolean")
  @js.native
  def toBoolean(value: js.Any): Boolean = js.native
  
  @JSImport("ag-grid/dist/lib/main", "ComponentUtil.toNumber")
  @js.native
