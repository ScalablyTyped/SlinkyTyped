...
class RowComp protected ()
  extends typingsSlinky.agGrid.rowCompMod.RowComp {
  def this(
    parentScope: js.Any,
...
object RowComp {
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.DETAIL_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.DETAIL_CELL_RENDERER_COMP_NAME")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.DOM_DATA_KEY_RENDERED_ROW")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.FULL_WIDTH_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.GROUP_ROW_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.GROUP_ROW_RENDERER_COMP_NAME")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.LOADING_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid/dist/lib/main", "RowComp.LOADING_CELL_RENDERER_COMP_NAME")
  @js.native
