...
object utilsMod {
  ...
  object PromiseStatus extends StObject {
    ...
    /* 0 */ val IN_PROGRESS: typingsSlinky.agGrid.utilsMod.PromiseStatus.IN_PROGRESS with Double = js.native
    
    @js.native
    sealed trait RESOLVED extends PromiseStatus
    /* 1 */ val RESOLVED: typingsSlinky.agGrid.utilsMod.PromiseStatus.RESOLVED with Double = js.native
  }
