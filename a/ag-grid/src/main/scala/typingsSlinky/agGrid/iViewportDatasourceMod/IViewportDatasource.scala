package typingsSlinky.agGrid.iViewportDatasourceMod
...
object IViewportDatasource {
  ...
  implicit class IViewportDatasourceOps[Self <: IViewportDatasource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInit(value: IViewportDatasourceParams => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("init")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetViewportRange(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setViewportRange")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
