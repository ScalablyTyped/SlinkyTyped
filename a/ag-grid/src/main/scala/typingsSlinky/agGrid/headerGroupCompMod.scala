...
object headerGroupCompMod {
  ...
  - typingsSlinky.agGrid.headerGroupCompMod.IHeaderGroupComp because var conflicts: afterGuiAttached, destroy, init. Inlined  */ @JSImport("ag-grid/dist/lib/headerRendering/headerGroup/headerGroupComp", "HeaderGroupComp")
  @js.native
