...
import typingsSlinky.agGrid.exportParamsMod.ShouldRowBeSkippedParams
...
object ExcelExportParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(suppressTextAsCDATA)) __obj.updateDynamic("suppressTextAsCDATA")(suppressTextAsCDATA.asInstanceOf[js.Any])
