...
import typingsSlinky.accessibility.accessibilityBooleans.`true`
import typingsSlinky.accessibility.anon.Buttons
import typingsSlinky.accessibility.anon.CBackground
import typingsSlinky.accessibility.anon.Font
import typingsSlinky.accessibility.anon.Persistent
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var menu: js.UndefOr[typingsSlinky.accessibility.anon.Dimensions] = js.native
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMenu(value: typingsSlinky.accessibility.anon.Dimensions): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
