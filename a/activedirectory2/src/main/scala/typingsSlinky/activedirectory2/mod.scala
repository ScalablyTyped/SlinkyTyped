...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.activedirectory2.activedirectory2Strings.distinguishedName
    - typingsSlinky.activedirectory2.activedirectory2Strings.userPrincipalName
    - typingsSlinky.activedirectory2.activedirectory2Strings.sAMAccountName
    - typingsSlinky.activedirectory2.activedirectory2Strings.mail
    - typingsSlinky.activedirectory2.activedirectory2Strings.lockoutTime
    - typingsSlinky.activedirectory2.activedirectory2Strings.whenCreated
    - typingsSlinky.activedirectory2.activedirectory2Strings.pwdLastSet
    - typingsSlinky.activedirectory2.activedirectory2Strings.userAccountControl
    - typingsSlinky.activedirectory2.activedirectory2Strings.employeeID
    - typingsSlinky.activedirectory2.activedirectory2Strings.sn
    - typingsSlinky.activedirectory2.activedirectory2Strings.givenName
    - typingsSlinky.activedirectory2.activedirectory2Strings.initials
    - typingsSlinky.activedirectory2.activedirectory2Strings.cn
    - typingsSlinky.activedirectory2.activedirectory2Strings.displayName
    - typingsSlinky.activedirectory2.activedirectory2Strings.comment
    - typingsSlinky.activedirectory2.activedirectory2Strings.description
  */
