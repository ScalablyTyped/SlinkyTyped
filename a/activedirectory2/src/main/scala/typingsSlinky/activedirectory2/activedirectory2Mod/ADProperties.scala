package typingsSlinky.activedirectory2.activedirectory2Mod

import typingsSlinky.activedirectory2.Anon_Cn
import typingsSlinky.activedirectory2.Anon_Enabled
