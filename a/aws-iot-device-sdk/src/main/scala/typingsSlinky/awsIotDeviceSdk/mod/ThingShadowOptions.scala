...
object ThingShadowOptions {
  ...
  implicit class ThingShadowOptionsOps[Self <: ThingShadowOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperationTimeout(value: Double): Self = this.set("operationTimeout", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOperationTimeout: Self = this.set("operationTimeout", js.undefined)
  }
}
