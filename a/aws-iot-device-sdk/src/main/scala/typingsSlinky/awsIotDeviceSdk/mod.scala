...
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.delete
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.delta
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.error
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.foreignStateChange
...
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.rejected
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.status
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.timeout
import typingsSlinky.awsIotDeviceSdk.awsIotDeviceSdkStrings.update
...
import typingsSlinky.mqtt.clientMod.ISubscriptionGrant
