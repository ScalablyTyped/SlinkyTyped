...
package object oauthconfigMod {
  type AuthorizationCodeGrantConfig = typingsSlinky.authmosphere.oauthconfigMod.CredentialsConfig with typingsSlinky.authmosphere.oauthconfigMod.GrantConfigBase with typingsSlinky.authmosphere.AnonCode
  ...
  type RefreshGrantConfig = typingsSlinky.authmosphere.oauthconfigMod.CredentialsConfig with typingsSlinky.authmosphere.oauthconfigMod.GrantConfigBase with typingsSlinky.authmosphere.AnonRefreshToken
  type TokenCacheOAuthConfig = (typingsSlinky.authmosphere.oauthconfigMod.ClientCredentialsGrantConfig | typingsSlinky.authmosphere.oauthconfigMod.PasswordCredentialsGrantConfig) with typingsSlinky.authmosphere.AnonTokenInfoEndpoint
}
