...
package object libSrcTypesOAuthConfigMod {
  import typingsSlinky.authmosphere.Anon_Code
  import typingsSlinky.authmosphere.Anon_RefreshToken
  import typingsSlinky.authmosphere.Anon_TokenInfoEndpoint
