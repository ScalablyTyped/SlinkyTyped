...
import typingsSlinky.authmosphere.libSrcTypesGetTokenInfoMod.GetTokenInfo
import typingsSlinky.authmosphere.libSrcTypesLoggerMod.Logger
import typingsSlinky.authmosphere.libSrcTypesMockOptionsMod.MockOptions
import typingsSlinky.authmosphere.libSrcTypesOAuthConfigMod.OAuthConfig
...
import typingsSlinky.nock.nockMod.Scope
...
object authmosphereMod extends js.Object {
  ...
  class TokenCache protected ()
    extends typingsSlinky.authmosphere.libSrcTokenDashCacheMod.TokenCache {
    /**
      * @param tokenConfig
      * @param oauthConfig
      */
  ...
  val authenticationMiddleware: typingsSlinky.authmosphere.libSrcExpressDashToolingMod.authenticationMiddleware = js.native
  ...
  val requireScopesMiddleware: typingsSlinky.authmosphere.libSrcExpressDashToolingMod.requireScopesMiddleware = js.native
  /**
