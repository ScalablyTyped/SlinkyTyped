...
object EndValue {
  ...
  implicit class EndValueOps[Self <: EndValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndValue(value: js.Date): Self = this.set("endValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEndValue: Self = this.set("endValue", js.undefined)
    
    @scala.inline
    def setStartValue(value: js.Date): Self = this.set("startValue", value.asInstanceOf[js.Any])
