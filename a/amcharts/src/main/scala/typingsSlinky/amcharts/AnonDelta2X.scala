...
@js.native
trait AnonDelta2X extends js.Object {
...
object AnonDelta2X {
  @scala.inline
  def apply(chart: default, `type`: String): AnonDelta2X = {
    val __obj = js.Dynamic.literal(chart = chart.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDelta2X]
  }
  @scala.inline
  implicit class AnonDelta2XOps[Self <: AnonDelta2X] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTarget(value: AnonDelta2X): Self = {
        val ret = this.duplicate
