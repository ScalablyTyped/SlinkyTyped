...
object axisBaseMod {
  ...
  object AxisBase {
    ...
    implicit class AxisBaseMutableBuilder[Self <: AxisBase] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddGuide(value: typingsSlinky.amcharts.guideMod.default => Unit): Self = StObject.set(x, "addGuide", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setRemoveGuide(value: typingsSlinky.amcharts.guideMod.default => Unit): Self = StObject.set(x, "removeGuide", js.Any.fromFunction1(value))
