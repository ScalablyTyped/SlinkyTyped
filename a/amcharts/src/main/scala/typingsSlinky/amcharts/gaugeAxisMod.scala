...
object gaugeAxisMod {
  ...
  object GaugeAxis {
    ...
    implicit class GaugeAxisMutableBuilder[Self <: GaugeAxis] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBands(value: js.Array[typingsSlinky.amcharts.gaugeBandMod.default]): Self = StObject.set(x, "bands", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBandsVarargs(value: typingsSlinky.amcharts.gaugeBandMod.default*): Self = StObject.set(x, "bands", js.Array(value :_*))
