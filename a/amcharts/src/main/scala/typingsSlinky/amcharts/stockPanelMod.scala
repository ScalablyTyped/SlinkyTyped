...
object stockPanelMod extends js.Object {
  ...
  trait StockPanel extends AmSerialChart {
    ...
    /**
      ...
      */
    var drawOnAxis: typingsSlinky.amcharts.valueAxisMod.default = js.native
    /**
    ...
    var stockGraphs: js.Array[typingsSlinky.amcharts.stockGraphMod.default] = js.native
    /**
      * Stock chart legend.
      */
    var stockLegend: typingsSlinky.amcharts.stockLegendMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def addStockGraph(graph: typingsSlinky.amcharts.stockGraphMod.default): Unit = js.native
    /**
      * Removes graph from the panel.
      */
    def removeStockGraph(graph: typingsSlinky.amcharts.stockGraphMod.default): Unit = js.native
  }
