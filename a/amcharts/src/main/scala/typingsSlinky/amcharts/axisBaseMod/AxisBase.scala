...
object AxisBase {
  ...
  implicit class AxisBaseOps[Self <: AxisBase] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddGuide(value: typingsSlinky.amcharts.guideMod.default => Unit): Self = this.set("addGuide", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRemoveGuide(value: typingsSlinky.amcharts.guideMod.default => Unit): Self = this.set("removeGuide", js.Any.fromFunction1(value))
    @scala.inline
