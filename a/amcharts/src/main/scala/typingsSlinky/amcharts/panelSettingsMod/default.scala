...
class default () extends PanelsSettings {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var panEventsEnabled: Boolean = js.native
  /**
    * Gap between panels.
    * @default 8
    */
  /* CompleteClass */
  override var panelSpacing: Double = js.native
  /**
    * The opacity of plot area's border.
    */
  /* CompleteClass */
  override var plotAreaBorderAlpha: Double = js.native
  /**
    * The color of the plot area's border.
    */
  /* CompleteClass */
  override var plotAreaBorderColor: String = js.native
  /**
    * Opacity of plot area fill.
    */
  /* CompleteClass */
  override var plotAreaFillAlphas: Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var sequencedAnimation: Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var startAlpha: Double = js.native
  /**
    * Duration of the animation, in seconds.
    */
  /* CompleteClass */
  override var startDuration: Double = js.native
  /**
    * Possible values are: "linear", "<", ">" "<>", "elastic", "bounce".
    */
  /* CompleteClass */
  override var startEffect: String = js.native
  /**
