...
object Guide {
  ...
  implicit class GuideOps[Self <: Guide] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setToDate(value: js.Date): Self = this.set("toDate", value.asInstanceOf[js.Any])
    @scala.inline
    def setToValue(value: Double): Self = this.set("toValue", value.asInstanceOf[js.Any])
    @scala.inline
    def setValue(value: Double): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
    def setValueAxis(value: typingsSlinky.amcharts.valueAxisMod.default): Self = this.set("valueAxis", value.asInstanceOf[js.Any])
  }
