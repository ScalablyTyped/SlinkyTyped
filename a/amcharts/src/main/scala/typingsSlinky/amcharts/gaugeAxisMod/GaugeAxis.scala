...
object GaugeAxis {
  ...
  implicit class GaugeAxisOps[Self <: GaugeAxis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBandsVarargs(value: typingsSlinky.amcharts.gaugeBandMod.default*): Self = this.set("bands", js.Array(value :_*))
    @scala.inline
    def setBands(value: js.Array[typingsSlinky.amcharts.gaugeBandMod.default]): Self = this.set("bands", value.asInstanceOf[js.Any])
    @scala.inline
