...
object amRectangularChartMod extends js.Object {
  ...
  trait AmRectangularChart extends AmCoordinateChart {
    ...
    /**
      ...
      */
    def addChartCursor(cursor: typingsSlinky.amcharts.chartCursorMod.default): Unit = js.native
    
    /**
      * Adds a ChartScrollbar to a chart
      */
    def addChartScrollbar(scrollbar: typingsSlinky.amcharts.chartScrollbarMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def addTrendLine(trendLine: typingsSlinky.amcharts.trendLineMod.default): Unit = js.native
    ...
    /**
      * Cursor of a chart.
      */
    var chartCursor: typingsSlinky.amcharts.chartCursorMod.default = js.native
    
    /**
      * Chart scrollbar.
      */
    var chartScrollbar: typingsSlinky.amcharts.chartScrollbarMod.default = js.native
    ...
    /**
      ...
      */
    def removeTrendLine(trendLine: typingsSlinky.amcharts.trendLineMod.default): Unit = js.native
    ...
    /**
      ...
      */
    var trendLines: js.Array[typingsSlinky.amcharts.trendLineMod.default] = js.native
