...
import typingsSlinky.amcharts.valueAxisMod.default
...
@js.native
class Guide ()
  extends typingsSlinky.amcharts.guideMod.Guide {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var toDate: js.Date = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var valueAxis: default = js.native
}
