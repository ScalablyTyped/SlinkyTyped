...
object AnonChartDataItem {
  ...
  @scala.inline
  implicit class AnonChartDataItemOps[Self <: AnonChartDataItem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataItem(value: typingsSlinky.amcharts.sliceMod.default): Self = {
        val ret = this.duplicate
