...
object dataSetMod {
  ...
  object DataSet {
    ...
    implicit class DataSetMutableBuilder[Self <: DataSet] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStockEvents(value: js.Array[typingsSlinky.amcharts.stockEventMod.default]): Self = StObject.set(x, "stockEvents", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStockEventsVarargs(value: typingsSlinky.amcharts.stockEventMod.default*): Self = StObject.set(x, "stockEvents", js.Array(value :_*))
