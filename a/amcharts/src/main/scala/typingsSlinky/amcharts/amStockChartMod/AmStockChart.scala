...
object AmStockChart {
  ...
  implicit class AmStockChartOps[Self <: AmStockChart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddPanel(value: typingsSlinky.amcharts.stockPanelMod.default => Unit): Self = this.set("addPanel", js.Any.fromFunction1(value))
    @scala.inline
    def setAddPanelAt(value: (typingsSlinky.amcharts.stockPanelMod.default, Double) => Unit): Self = this.set("addPanelAt", js.Any.fromFunction2(value))
    @scala.inline
    def setAnimationPlayed(value: Boolean): Self = this.set("animationPlayed", value.asInstanceOf[js.Any])
    @scala.inline
    def setBalloon(value: typingsSlinky.amcharts.amBalloonMod.default): Self = this.set("balloon", value.asInstanceOf[js.Any])
    @scala.inline
    def setCategoryAxesSettings(value: typingsSlinky.amcharts.categoryAxesSettingsMod.default): Self = this.set("categoryAxesSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def setChartCreated(value: Boolean): Self = this.set("chartCreated", value.asInstanceOf[js.Any])
    @scala.inline
    def setChartCursorSettings(value: typingsSlinky.amcharts.chartCursorSettingsMod.default): Self = this.set("chartCursorSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def setChartScrollbarSettings(value: typingsSlinky.amcharts.chartScrollbarSettingsMod.default): Self = this.set("chartScrollbarSettings", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataSetSelector(value: typingsSlinky.amcharts.dataSetSelectorMod.default): Self = this.set("dataSetSelector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLegendSettings(value: typingsSlinky.amcharts.legendSettingsMod.default): Self = this.set("legendSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def setMainDataSet(value: typingsSlinky.amcharts.dataSetMod.default): Self = this.set("mainDataSet", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPanelsSettings(value: typingsSlinky.amcharts.panelSettingsMod.default): Self = this.set("panelsSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def setPeriodSelector(value: typingsSlinky.amcharts.periodSelectorMod.default): Self = this.set("periodSelector", value.asInstanceOf[js.Any])
    @scala.inline
    def setRemoveListener(value: (typingsSlinky.amcharts.amChartMod.default, String, js.Any) => Unit): Self = this.set("removeListener", js.Any.fromFunction3(value))
    @scala.inline
    def setRemovePanel(value: typingsSlinky.amcharts.stockPanelMod.default => Unit): Self = this.set("removePanel", js.Any.fromFunction1(value))
    @scala.inline
    def setScrollbarChart(value: typingsSlinky.amcharts.amSerialChartMod.default): Self = this.set("scrollbarChart", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setValueAxesSettings(value: typingsSlinky.amcharts.valueAxesSettingsMod.default): Self = this.set("valueAxesSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def setVersion(value: String): Self = this.set("version", value.asInstanceOf[js.Any])
    @scala.inline
    def setZoom(value: (js.Date, js.Date) => Unit): Self = this.set("zoom", js.Any.fromFunction2(value))
    @scala.inline
