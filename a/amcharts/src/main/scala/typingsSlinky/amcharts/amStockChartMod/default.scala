...
class default () extends AmStockChart {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var balloon: typingsSlinky.amcharts.amBalloonMod.default = js.native
  /**
    * Settings for category axes.
    */
  /* CompleteClass */
  override var categoryAxesSettings: typingsSlinky.amcharts.categoryAxesSettingsMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var chartCursorSettings: typingsSlinky.amcharts.chartCursorSettingsMod.default = js.native
  /**
    * Chart scrollbar settings.
    */
  /* CompleteClass */
  override var chartScrollbarSettings: typingsSlinky.amcharts.chartScrollbarSettingsMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var dataSetSelector: typingsSlinky.amcharts.dataSetSelectorMod.default = js.native
  /**
    * Array of DataSets.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var legendSettings: typingsSlinky.amcharts.legendSettingsMod.default = js.native
  /**
    * Data set selected as main.
    */
  /* CompleteClass */
  override var mainDataSet: typingsSlinky.amcharts.dataSetMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var panelsSettings: typingsSlinky.amcharts.panelSettingsMod.default = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var periodSelector: typingsSlinky.amcharts.periodSelectorMod.default = js.native
  /**
    * Scrollbar's chart object, get only.
    */
  /* CompleteClass */
  override var scrollbarChart: typingsSlinky.amcharts.amSerialChartMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var valueAxesSettings: typingsSlinky.amcharts.valueAxesSettingsMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addPanel(panel: typingsSlinky.amcharts.stockPanelMod.default): Unit = js.native
  /**
    * Adds panel to the stock chart at a specified index.
    * Requires stockChart.validateNow() method to be called after this action.
    */
  /* CompleteClass */
  override def addPanelAt(panel: typingsSlinky.amcharts.stockPanelMod.default, index: Double): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeListener(chart: typingsSlinky.amcharts.amChartMod.default, `type`: String, handler: js.Any): Unit = js.native
  /**
    * Removes panel from the stock chart. Requires stockChart.validateNow() method to be called after this action.
    */
  /* CompleteClass */
  override def removePanel(panel: typingsSlinky.amcharts.stockPanelMod.default): Unit = js.native
  /**
    * Shows event bullets.
    */
  /* CompleteClass */
