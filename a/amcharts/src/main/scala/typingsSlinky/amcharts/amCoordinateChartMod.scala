...
object amCoordinateChartMod extends js.Object {
  ...
  trait AmCoordinateChart
    ...
    /**
      ...
      */
    def addGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def addValueAxis(axis: typingsSlinky.amcharts.valueAxisMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def getGraphById(graphId: String): typingsSlinky.amcharts.amGraphMod.default = js.native
    
    /**
      * Returns value axis by id.
      */
    def getValueAxisById(axisId: String): typingsSlinky.amcharts.valueAxisMod.default = js.native
    ...
    /**
      ...
      */
    var graphs: js.Array[typingsSlinky.amcharts.amGraphMod.default] = js.native
    ...
    /**
      ...
      */
    var guides: js.Array[typingsSlinky.amcharts.guideMod.default] = js.native
    
    /**
      * Hide the graph (if it is visible).
      * Usually this method is called from the Legend, when you click on the legend marker.
      */
    def hideGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    
    /**
      * Hide value balloon of a graph.
      * Usually this method is called from the Legend, when you click on the legend text.
      */
    def hideGraphsBalloon(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    
    /**
      * Highlight the graph. Usually this method is called from the Legend, when you roll-over the legend entry.
      */
    def highlightGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    
    /**
      * Removes graph from the chart.
      */
    def removeGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    
    /**
      * Removes value axis from the chart.
      * When you remove value axis, all graphs assigned to this axis are also removed.
      */
    def removeValueAxis(axis: typingsSlinky.amcharts.valueAxisMod.default): Unit = js.native
    ...
    /**
      ...
      * Usually this method is called from the Legend, when you click on the legend marker.
      */
    def showGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    
    /**
      * Show value balloon of a graph.
      * Usually this method is called from the Legend, when you click on the legend text.
      */
    def showGraphsBalloon(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def unhighlightGraph(graph: typingsSlinky.amcharts.amGraphMod.default): Unit = js.native
