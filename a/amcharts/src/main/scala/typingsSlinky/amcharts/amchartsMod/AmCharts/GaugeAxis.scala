package typingsSlinky.amcharts.amchartsMod.AmCharts

import typingsSlinky.amcharts.gaugeBandMod.default
...
@js.native
class GaugeAxis ()
  extends typingsSlinky.amcharts.gaugeAxisMod.GaugeAxis {
  /**
    * Axis opacity.
    * @default 1
    */
