...
import typingsSlinky.amcharts.categoryAxisMod.default
...
class ChartScrollbar ()
  extends typingsSlinky.amcharts.chartScrollbarMod.ChartScrollbar {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var graph: typingsSlinky.amcharts.amGraphMod.default = js.native
  /**
