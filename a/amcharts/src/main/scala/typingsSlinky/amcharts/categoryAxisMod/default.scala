...
class default () extends CategoryAxis {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addGuide(guide: typingsSlinky.amcharts.guideMod.default): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def dateToCoordinate(date: js.Date): Unit = js.native
  /**
    * Removes guide from the axis.
    */
  /* CompleteClass */
  override def removeGuide(guide: typingsSlinky.amcharts.guideMod.default): Unit = js.native
  /**
