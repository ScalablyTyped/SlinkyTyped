package typingsSlinky.amcharts.gaugeArrowMod
...
object GaugeArrow {
  ...
  implicit class GaugeArrowOps[Self <: GaugeArrow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAxis(value: typingsSlinky.amcharts.gaugeAxisMod.default): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withClockWiseOnly(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clockWiseOnly")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNailAlpha(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nailAlpha")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNailBorderAlpha(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nailBorderAlpha")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNailBorderThickness(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nailBorderThickness")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNailRadius(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nailRadius")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
