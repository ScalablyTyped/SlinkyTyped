...
import typingsSlinky.amcharts.anon.Type
...
object amChartMod extends js.Object {
  ...
  trait AmChart extends js.Object {
    ...
    /**
      ...
      * }
      */
    var allLabels: js.Array[typingsSlinky.amcharts.labelMod.default] = js.native
    /**
    ...
    /**
      ...
      */
    var export: typingsSlinky.amcharts.exportSettingsMod.default = js.native
    /**
      * Font family. Verdana
      */
    ...
    /**
      * Legend of a chart.
      */
    var legend: typingsSlinky.amcharts.amLegendMod.default = js.native
    /**
    ...
    /**
      ...
      */
    var titles: js.Array[typingsSlinky.amcharts.titleMod.default] = js.native
    /**
    ...
    /**
      ...
      */
    def addLegend(legend: typingsSlinky.amcharts.amLegendMod.default): Unit = js.native
    def addLegend(legend: typingsSlinky.amcharts.amLegendMod.default, legendDivId: String): Unit = js.native
    /**
      * Adds a legend to the chart.
      * By default, you don't need to create div for your legend,
      * however if you want it to be positioned in some different way,
