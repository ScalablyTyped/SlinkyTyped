...
@JSImport("@aws-sdk/client-s3-node/types/DeleteBucketAnalyticsConfigurationInput", JSImport.Namespace)
@js.native
object typesDeleteBucketAnalyticsConfigurationInputMod extends js.Object {
  @js.native
