...
object typesDeleteBucketAnalyticsConfigurationInputMod {
  
  @js.native
  trait DeleteBucketAnalyticsConfigurationInput extends _InputTypesUnion {
  ...
  object DeleteBucketAnalyticsConfigurationInput {
    ...
    @scala.inline
    implicit class DeleteBucketAnalyticsConfigurationInputMutableBuilder[Self <: DeleteBucketAnalyticsConfigurationInput] (val x: Self) extends AnyVal {
