...
object LifecycleRule {
  ...
  implicit class LifecycleRuleOps[Self <: LifecycleRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNoncurrentVersionTransitionsIterable(value: js.Iterable[NoncurrentVersionTransition]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NoncurrentVersionTransitions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNoncurrentVersionTransitions(value: js.Array[NoncurrentVersionTransition] | js.Iterable[NoncurrentVersionTransition]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NoncurrentVersionTransitions")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withTransitionsIterable(value: js.Iterable[Transition]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Transitions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTransitions(value: js.Array[Transition] | js.Iterable[Transition]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Transitions")(value.asInstanceOf[js.Any])
        ret
    }
