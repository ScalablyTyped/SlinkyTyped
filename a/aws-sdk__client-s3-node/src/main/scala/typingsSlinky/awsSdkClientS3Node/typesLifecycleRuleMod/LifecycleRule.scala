...
import typingsSlinky.awsSdkClientS3Node.typesAbortIncompleteMultipartUploadMod.AbortIncompleteMultipartUpload
import typingsSlinky.awsSdkClientS3Node.typesLifecycleExpirationMod.LifecycleExpiration
import typingsSlinky.awsSdkClientS3Node.typesLifecycleRuleFilterMod.LifecycleRuleFilter
import typingsSlinky.awsSdkClientS3Node.typesNoncurrentVersionExpirationMod.NoncurrentVersionExpiration
import typingsSlinky.awsSdkClientS3Node.typesNoncurrentVersionTransitionMod.NoncurrentVersionTransition
import typingsSlinky.awsSdkClientS3Node.typesTransitionMod.Transition
...
trait LifecycleRule extends js.Object {
  ...
  var AbortIncompleteMultipartUpload: js.UndefOr[
    typingsSlinky.awsSdkClientS3Node.typesAbortIncompleteMultipartUploadMod.AbortIncompleteMultipartUpload
  ] = js.native
  ...
  var NoncurrentVersionExpiration: js.UndefOr[
    typingsSlinky.awsSdkClientS3Node.typesNoncurrentVersionExpirationMod.NoncurrentVersionExpiration
  ] = js.native
...
object LifecycleRule {
  ...
  implicit class LifecycleRuleOps[Self <: LifecycleRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNoncurrentVersionTransitionsIterable(value: js.Iterable[NoncurrentVersionTransition]): Self = this.set("NoncurrentVersionTransitions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNoncurrentVersionTransitions(value: js.Array[NoncurrentVersionTransition] | js.Iterable[NoncurrentVersionTransition]): Self = this.set("NoncurrentVersionTransitions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransitionsIterable(value: js.Iterable[Transition]): Self = this.set("Transitions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTransitions(value: js.Array[Transition] | js.Iterable[Transition]): Self = this.set("Transitions", value.asInstanceOf[js.Any])
