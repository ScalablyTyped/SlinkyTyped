...
object S3Location {
  ...
  implicit class S3LocationOps[Self <: S3Location] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUserMetadataIterable(value: js.Iterable[MetadataEntry]): Self = this.set("UserMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUserMetadata(value: js.Array[MetadataEntry] | js.Iterable[MetadataEntry]): Self = this.set("UserMetadata", value.asInstanceOf[js.Any])
