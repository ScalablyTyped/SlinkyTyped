...
object typesCompletedMultipartUploadMod {
  ...
  object CompletedMultipartUpload {
    ...
    implicit class CompletedMultipartUploadMutableBuilder[Self <: CompletedMultipartUpload] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParts(value: js.Array[CompletedPart] | js.Iterable[CompletedPart]): Self = StObject.set(x, "Parts", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPartsIterable(value: js.Iterable[CompletedPart]): Self = StObject.set(x, "Parts", value.asInstanceOf[js.Any])
