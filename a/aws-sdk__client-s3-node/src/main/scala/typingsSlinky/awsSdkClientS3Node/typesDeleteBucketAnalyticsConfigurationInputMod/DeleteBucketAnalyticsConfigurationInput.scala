package typingsSlinky.awsSdkClientS3Node.typesDeleteBucketAnalyticsConfigurationInputMod
...
@js.native
trait DeleteBucketAnalyticsConfigurationInput extends InputTypesUnion {
  /**
