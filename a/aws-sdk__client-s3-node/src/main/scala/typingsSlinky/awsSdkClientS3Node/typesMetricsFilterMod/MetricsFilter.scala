...
import typingsSlinky.awsSdkClientS3Node.typesMetricsAndOperatorMod.MetricsAndOperator
...
trait MetricsFilter extends js.Object {
  ...
  /**
    ...
    */
  var Tag: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesTagMod.Tag] = js.undefined
}
