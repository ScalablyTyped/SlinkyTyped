package typingsSlinky.awsSdkClientS3Node.typesDeleteBucketMetricsConfigurationInputMod
...
@js.native
trait DeleteBucketMetricsConfigurationInput extends InputTypesUnion {
  /**
