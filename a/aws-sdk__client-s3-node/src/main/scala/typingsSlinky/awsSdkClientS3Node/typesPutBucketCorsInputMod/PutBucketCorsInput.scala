package typingsSlinky.awsSdkClientS3Node.typesPutBucketCorsInputMod
...
trait PutBucketCorsInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var CORSConfiguration: typingsSlinky.awsSdkClientS3Node.typesCorsconfigurationMod.CORSConfiguration
  /**
    * _ContentMD5 shape
    */
