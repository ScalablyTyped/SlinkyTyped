...
object typesPutBucketMetricsConfigurationInputMod {
  ...
  trait PutBucketMetricsConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var MetricsConfiguration: typingsSlinky.awsSdkClientS3Node.typesMetricsConfigurationMod.MetricsConfiguration = js.native
  }
  object PutBucketMetricsConfigurationInput {
    ...
    @scala.inline
    implicit class PutBucketMetricsConfigurationInputMutableBuilder[Self <: PutBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
