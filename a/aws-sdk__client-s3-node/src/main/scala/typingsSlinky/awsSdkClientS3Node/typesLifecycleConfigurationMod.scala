...
object typesLifecycleConfigurationMod {
  ...
  object LifecycleConfiguration {
    ...
    implicit class LifecycleConfigurationMutableBuilder[Self <: LifecycleConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRules(value: js.Array[Rule] | js.Iterable[Rule]): Self = StObject.set(x, "Rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesIterable(value: js.Iterable[Rule]): Self = StObject.set(x, "Rules", value.asInstanceOf[js.Any])
