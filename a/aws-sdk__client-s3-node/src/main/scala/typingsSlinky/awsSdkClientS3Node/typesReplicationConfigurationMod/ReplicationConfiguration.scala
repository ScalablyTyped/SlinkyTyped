...
object ReplicationConfiguration {
  ...
  implicit class ReplicationConfigurationOps[Self <: ReplicationConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRulesIterable(value: js.Iterable[ReplicationRule]): Self = this.set("Rules", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRules(value: js.Array[ReplicationRule] | js.Iterable[ReplicationRule]): Self = this.set("Rules", value.asInstanceOf[js.Any])
  }
}
