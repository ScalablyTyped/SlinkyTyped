package typingsSlinky.awsSdkClientS3Node.typesPutBucketPolicyInputMod
...
@js.native
trait PutBucketPolicyInput extends InputTypesUnion {
  /**
...
object PutBucketPolicyInput {
  ...
  implicit class PutBucketPolicyInputOps[Self <: PutBucketPolicyInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfirmRemoveSelfBucketAccess(value: Boolean): Self = {
        val ret = this.duplicate
