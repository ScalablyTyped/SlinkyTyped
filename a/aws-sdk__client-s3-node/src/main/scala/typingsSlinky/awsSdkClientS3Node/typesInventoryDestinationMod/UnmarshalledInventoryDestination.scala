package typingsSlinky.awsSdkClientS3Node.typesInventoryDestinationMod

import typingsSlinky.awsSdkClientS3Node.typesInventoryS3BucketDestinationMod.UnmarshalledInventoryS3BucketDestination
...
object UnmarshalledInventoryDestination {
  ...
  implicit class UnmarshalledInventoryDestinationOps[Self <: UnmarshalledInventoryDestination] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withS3BucketDestination(value: UnmarshalledInventoryS3BucketDestination): Self = {
