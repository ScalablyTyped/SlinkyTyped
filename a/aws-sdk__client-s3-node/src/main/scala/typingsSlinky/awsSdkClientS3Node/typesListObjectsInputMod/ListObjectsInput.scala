package typingsSlinky.awsSdkClientS3Node.typesListObjectsInputMod
...
@js.native
trait ListObjectsInput extends InputTypesUnion {
  /**
...
object ListObjectsInput {
  ...
  @scala.inline
  implicit class ListObjectsInputOps[Self <: ListObjectsInput] (val x: Self) extends AnyVal {
    @scala.inline
