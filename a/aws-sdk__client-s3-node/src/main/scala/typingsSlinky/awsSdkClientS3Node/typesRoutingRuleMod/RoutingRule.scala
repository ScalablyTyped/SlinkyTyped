package typingsSlinky.awsSdkClientS3Node.typesRoutingRuleMod
...
trait RoutingRule extends js.Object {
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesConditionMod.Condition] = js.undefined
  /**
    ...
    */
  var Redirect: typingsSlinky.awsSdkClientS3Node.typesRedirectMod.Redirect
}
