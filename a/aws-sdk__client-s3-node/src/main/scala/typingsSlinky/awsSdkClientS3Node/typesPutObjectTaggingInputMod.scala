...
object typesPutObjectTaggingInputMod {
  ...
  trait PutObjectTaggingInput extends _InputTypesUnion {
    ...
    /**
      * _Tagging shape
      */
    var Tagging: typingsSlinky.awsSdkClientS3Node.typesTaggingMod.Tagging = js.native
  ...
  object PutObjectTaggingInput {
    ...
    @scala.inline
    implicit class PutObjectTaggingInputMutableBuilder[Self <: PutObjectTaggingInput] (val x: Self) extends AnyVal {
