...
@JSImport("@aws-sdk/client-s3-node/types/ListBucketInventoryConfigurationsInput", JSImport.Namespace)
@js.native
object typesListBucketInventoryConfigurationsInputMod extends js.Object {
  @js.native
