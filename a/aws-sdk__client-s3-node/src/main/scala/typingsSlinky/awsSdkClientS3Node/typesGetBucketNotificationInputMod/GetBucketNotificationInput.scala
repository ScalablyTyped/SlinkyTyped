package typingsSlinky.awsSdkClientS3Node.typesGetBucketNotificationInputMod
...
@js.native
trait GetBucketNotificationInput extends InputTypesUnion {
  /**
...
object GetBucketNotificationInput {
  ...
  @scala.inline
  implicit class GetBucketNotificationInputOps[Self <: GetBucketNotificationInput] (val x: Self) extends AnyVal {
    @scala.inline
