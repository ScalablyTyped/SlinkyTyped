package typingsSlinky.awsSdkClientS3Node.typesDeleteMod

import typingsSlinky.awsSdkClientS3Node.typesObjectIdentifierMod.ObjectIdentifier
...
object Delete {
  ...
  implicit class DeleteOps[Self <: Delete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObjectsIterable(value: js.Iterable[ObjectIdentifier]): Self = this.set("Objects", value.asInstanceOf[js.Any])
    @scala.inline
    def setObjects(value: js.Array[ObjectIdentifier] | js.Iterable[ObjectIdentifier]): Self = this.set("Objects", value.asInstanceOf[js.Any])
    @scala.inline
