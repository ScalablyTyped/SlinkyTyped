...
object typesObjectAlreadyInActiveTierErrorMod {
  ...
  trait ObjectAlreadyInActiveTierError extends StObject {
    ...
    var name: typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.ObjectAlreadyInActiveTierError = js.native
  }
  object ObjectAlreadyInActiveTierError {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.ObjectAlreadyInActiveTierError): ObjectAlreadyInActiveTierError = {
    ...
    implicit class ObjectAlreadyInActiveTierErrorMutableBuilder[Self <: ObjectAlreadyInActiveTierError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.ObjectAlreadyInActiveTierError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
