...
object S3KeyFilter {
  ...
  implicit class S3KeyFilterOps[Self <: S3KeyFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilterRulesIterable(value: js.Iterable[FilterRule]): Self = this.set("FilterRules", value.asInstanceOf[js.Any])
    @scala.inline
    def setFilterRules(value: js.Array[FilterRule] | js.Iterable[FilterRule]): Self = this.set("FilterRules", value.asInstanceOf[js.Any])
    @scala.inline
