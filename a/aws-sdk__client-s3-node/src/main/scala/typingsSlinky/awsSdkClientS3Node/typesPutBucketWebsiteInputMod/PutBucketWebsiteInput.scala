package typingsSlinky.awsSdkClientS3Node.typesPutBucketWebsiteInputMod
...
trait PutBucketWebsiteInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var WebsiteConfiguration: typingsSlinky.awsSdkClientS3Node.typesWebsiteConfigurationMod.WebsiteConfiguration = js.native
}
object PutBucketWebsiteInput {
  ...
  @scala.inline
  implicit class PutBucketWebsiteInputOps[Self <: PutBucketWebsiteInput] (val x: Self) extends AnyVal {
