package typingsSlinky.awsSdkClientS3Node.typesPutBucketAclInputMod
...
trait PutBucketAclInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var AccessControlPolicy: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesAccessControlPolicyMod.AccessControlPolicy] = js.undefined
  /**
    * _BucketName shape
    */
  var Bucket: String
