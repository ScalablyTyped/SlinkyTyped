package typingsSlinky.awsSdkClientS3Node.typesPutBucketNotificationConfigurationInputMod
...
@js.native
trait PutBucketNotificationConfigurationInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var NotificationConfiguration: typingsSlinky.awsSdkClientS3Node.typesNotificationConfigurationMod.NotificationConfiguration = js.native
}
...
object PutBucketNotificationConfigurationInput {
  ...
  @scala.inline
  implicit class PutBucketNotificationConfigurationInputOps[Self <: PutBucketNotificationConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
