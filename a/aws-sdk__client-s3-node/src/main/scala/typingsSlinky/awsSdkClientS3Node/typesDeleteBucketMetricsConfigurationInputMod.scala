...
object typesDeleteBucketMetricsConfigurationInputMod {
  ...
  object DeleteBucketMetricsConfigurationInput {
    ...
    @scala.inline
    implicit class DeleteBucketMetricsConfigurationInputMutableBuilder[Self <: DeleteBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
