package typingsSlinky.awsSdkClientS3Node.typesDeleteBucketReplicationInputMod
...
object DeleteBucketReplicationInput {
  ...
  @scala.inline
  implicit class DeleteBucketReplicationInputOps[Self <: DeleteBucketReplicationInput] (val x: Self) extends AnyVal {
    @scala.inline
