package typingsSlinky.awsSdkClientS3Node.typesGetBucketNotificationConfigurationInputMod
...
@js.native
trait GetBucketNotificationConfigurationInput extends InputTypesUnion {
  /**
...
object GetBucketNotificationConfigurationInput {
  @scala.inline
  def apply(Bucket: String): GetBucketNotificationConfigurationInput = {
    val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetBucketNotificationConfigurationInput]
  }
  @scala.inline
  implicit class GetBucketNotificationConfigurationInputOps[Self <: GetBucketNotificationConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
