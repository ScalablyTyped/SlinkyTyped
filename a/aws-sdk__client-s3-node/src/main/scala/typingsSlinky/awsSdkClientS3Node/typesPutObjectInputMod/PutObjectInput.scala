package typingsSlinky.awsSdkClientS3Node.typesPutObjectInputMod
...
object PutObjectInput {
  ...
  @scala.inline
  implicit class PutObjectInputOps[Self <: PutObjectInput[_], StreamType] (val x: Self with PutObjectInput[StreamType]) extends AnyVal {
    ...
    @scala.inline
    def setExpiresDate(value: js.Date): Self = this.set("Expires", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpires(value: js.Date | String | Double): Self = this.set("Expires", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMetadataIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("Metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetadata(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("Metadata", value.asInstanceOf[js.Any])
