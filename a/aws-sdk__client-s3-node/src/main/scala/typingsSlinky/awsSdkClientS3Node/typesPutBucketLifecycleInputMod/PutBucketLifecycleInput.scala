package typingsSlinky.awsSdkClientS3Node.typesPutBucketLifecycleInputMod

import typingsSlinky.awsSdkClientS3Node.inputTypesUnionMod._InputTypesUnion
import typingsSlinky.awsSdkClientS3Node.typesLifecycleConfigurationMod.LifecycleConfiguration
...
@js.native
trait PutBucketLifecycleInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var LifecycleConfiguration: js.UndefOr[
    typingsSlinky.awsSdkClientS3Node.typesLifecycleConfigurationMod.LifecycleConfiguration
  ] = js.native
}
object PutBucketLifecycleInput {
  ...
  @scala.inline
  implicit class PutBucketLifecycleInputOps[Self <: PutBucketLifecycleInput] (val x: Self) extends AnyVal {
