...
object ObjectAlreadyInActiveTierError {
  ...
  implicit class ObjectAlreadyInActiveTierErrorOps[Self <: ObjectAlreadyInActiveTierError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.ObjectAlreadyInActiveTierError): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
