package typingsSlinky.awsSdkClientS3Node.typesTaggingMod
...
object Tagging {
  ...
  implicit class TaggingOps[Self <: Tagging] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagSetIterable(value: js.Iterable[Tag]): Self = this.set("TagSet", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagSet(value: js.Array[Tag] | js.Iterable[Tag]): Self = this.set("TagSet", value.asInstanceOf[js.Any])
  }
}
