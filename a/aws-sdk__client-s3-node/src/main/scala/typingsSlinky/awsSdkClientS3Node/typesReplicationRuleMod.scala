...
import typingsSlinky.awsSdkClientS3Node.typesDeleteMarkerReplicationMod.DeleteMarkerReplication
import typingsSlinky.awsSdkClientS3Node.typesDeleteMarkerReplicationMod.UnmarshalledDeleteMarkerReplication
import typingsSlinky.awsSdkClientS3Node.typesDestinationMod.Destination
import typingsSlinky.awsSdkClientS3Node.typesDestinationMod.UnmarshalledDestination
import typingsSlinky.awsSdkClientS3Node.typesReplicationRuleFilterMod.ReplicationRuleFilter
import typingsSlinky.awsSdkClientS3Node.typesReplicationRuleFilterMod.UnmarshalledReplicationRuleFilter
import typingsSlinky.awsSdkClientS3Node.typesSourceSelectionCriteriaMod.SourceSelectionCriteria
import typingsSlinky.awsSdkClientS3Node.typesSourceSelectionCriteriaMod.UnmarshalledSourceSelectionCriteria
...
object typesReplicationRuleMod {
  ...
  trait ReplicationRule extends StObject {
    ...
    var DeleteMarkerReplication: js.UndefOr[
        typingsSlinky.awsSdkClientS3Node.typesDeleteMarkerReplicationMod.DeleteMarkerReplication
      ] = js.native
    
    /**
      * <p>Container for replication destination information.</p>
      */
    var Destination: typingsSlinky.awsSdkClientS3Node.typesDestinationMod.Destination = js.native
    ...
    var SourceSelectionCriteria: js.UndefOr[
        typingsSlinky.awsSdkClientS3Node.typesSourceSelectionCriteriaMod.SourceSelectionCriteria
      ] = js.native
