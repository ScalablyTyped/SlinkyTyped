...
trait DeleteObjectsInput extends _InputTypesUnion {
  ...
  /**
    * _Delete shape
    */
  var Delete: typingsSlinky.awsSdkClientS3Node.typesDeleteMod.Delete = js.native
  /**
...
object DeleteObjectsInput {
  @scala.inline
  def apply(Bucket: String, Delete: Delete): DeleteObjectsInput = {
  ...
  @scala.inline
  implicit class DeleteObjectsInputOps[Self <: DeleteObjectsInput] (val x: Self) extends AnyVal {
    @scala.inline
