package typingsSlinky.awsSdkClientS3Node.typesPutBucketLifecycleConfigurationInputMod

import typingsSlinky.awsSdkClientS3Node.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientS3Node.typesBucketLifecycleConfigurationMod.BucketLifecycleConfiguration
...
@js.native
trait PutBucketLifecycleConfigurationInput extends InputTypesUnion {
  /**
...
object PutBucketLifecycleConfigurationInput {
  @scala.inline
  def apply(Bucket: String): PutBucketLifecycleConfigurationInput = {
    val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[PutBucketLifecycleConfigurationInput]
  }
  @scala.inline
  implicit class PutBucketLifecycleConfigurationInputOps[Self <: PutBucketLifecycleConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
