...
import typingsSlinky.awsSdkClientS3Node.typesReplicationRuleAndOperatorMod.ReplicationRuleAndOperator
...
object ReplicationRuleFilter {
  ...
  implicit class ReplicationRuleFilterOps[Self <: ReplicationRuleFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnd(value: ReplicationRuleAndOperator): Self = {
