...
object UploadPartCopyInput {
  ...
  implicit class UploadPartCopyInputOps[Self <: UploadPartCopyInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set$copySourceServerSideEncryptionKeyArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("$copySourceServerSideEncryptionKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$copySourceServerSideEncryptionKeyArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("$copySourceServerSideEncryptionKey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def set$serverSideEncryptionKeyArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("$serverSideEncryptionKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$serverSideEncryptionKeyArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("$serverSideEncryptionKey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCopySourceIfModifiedSinceDate(value: js.Date): Self = this.set("CopySourceIfModifiedSince", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCopySourceIfModifiedSince(value: js.Date | String | Double): Self = this.set("CopySourceIfModifiedSince", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCopySourceIfUnmodifiedSinceDate(value: js.Date): Self = this.set("CopySourceIfUnmodifiedSince", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCopySourceIfUnmodifiedSince(value: js.Date | String | Double): Self = this.set("CopySourceIfUnmodifiedSince", value.asInstanceOf[js.Any])
