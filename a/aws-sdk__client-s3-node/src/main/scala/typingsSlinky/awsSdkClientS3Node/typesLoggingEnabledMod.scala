...
object typesLoggingEnabledMod {
  ...
  object LoggingEnabled {
    ...
    implicit class LoggingEnabledMutableBuilder[Self <: LoggingEnabled] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTargetGrants(value: js.Array[TargetGrant] | js.Iterable[TargetGrant]): Self = StObject.set(x, "TargetGrants", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTargetGrantsIterable(value: js.Iterable[TargetGrant]): Self = StObject.set(x, "TargetGrants", value.asInstanceOf[js.Any])
