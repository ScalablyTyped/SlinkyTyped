package typingsSlinky.awsSdkClientS3Node.typesPutBucketEncryptionInputMod
...
@js.native
trait PutBucketEncryptionInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var ServerSideEncryptionConfiguration: typingsSlinky.awsSdkClientS3Node.typesServerSideEncryptionConfigurationMod.ServerSideEncryptionConfiguration = js.native
}
...
object PutBucketEncryptionInput {
  ...
  @scala.inline
  implicit class PutBucketEncryptionInputOps[Self <: PutBucketEncryptionInput] (val x: Self) extends AnyVal {
    @scala.inline
