...
@JSImport("@aws-sdk/client-s3-node", "AbortMultipartUploadCommand")
@js.native
class AbortMultipartUploadCommand protected ()
  extends typingsSlinky.awsSdkClientS3Node.abortMultipartUploadCommandMod.AbortMultipartUploadCommand {
