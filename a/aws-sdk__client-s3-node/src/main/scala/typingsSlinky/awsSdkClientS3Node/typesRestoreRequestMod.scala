...
import typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.SELECT
import typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.Standard_
import typingsSlinky.awsSdkClientS3Node.typesGlacierJobParametersMod.GlacierJobParameters
import typingsSlinky.awsSdkClientS3Node.typesGlacierJobParametersMod.UnmarshalledGlacierJobParameters
import typingsSlinky.awsSdkClientS3Node.typesOutputLocationMod.OutputLocation
import typingsSlinky.awsSdkClientS3Node.typesOutputLocationMod.UnmarshalledOutputLocation
import typingsSlinky.awsSdkClientS3Node.typesSelectParametersMod.SelectParameters
import typingsSlinky.awsSdkClientS3Node.typesSelectParametersMod.UnmarshalledSelectParameters
...
object typesRestoreRequestMod {
  ...
  trait RestoreRequest extends StObject {
    ...
    var GlacierJobParameters: js.UndefOr[
        typingsSlinky.awsSdkClientS3Node.typesGlacierJobParametersMod.GlacierJobParameters
      ] = js.native
    
    /**
      * <p>Describes the location where the restore job's output is stored.</p>
      */
    var OutputLocation: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesOutputLocationMod.OutputLocation] = js.native
    
    /**
      * <p>Describes the parameters for Select job types.</p>
      */
    var SelectParameters: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesSelectParametersMod.SelectParameters] = js.native
