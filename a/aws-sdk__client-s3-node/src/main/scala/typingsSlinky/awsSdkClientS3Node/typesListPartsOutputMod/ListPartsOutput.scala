package typingsSlinky.awsSdkClientS3Node.typesListPartsOutputMod
...
import typingsSlinky.awsSdkClientS3Node.typesPartMod.UnmarshalledPart
...
object ListPartsOutput {
  ...
  implicit class ListPartsOutputOps[Self <: ListPartsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAbortDate(value: js.Date): Self = this.set("AbortDate", value.asInstanceOf[js.Any])
