...
object typesCorsruleMod {
  ...
  object CORSRule {
    ...
    implicit class CORSRuleMutableBuilder[Self <: CORSRule] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllowedHeaders(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "AllowedHeaders", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedHeadersIterable(value: js.Iterable[String]): Self = StObject.set(x, "AllowedHeaders", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setAllowedMethods(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "AllowedMethods", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedMethodsIterable(value: js.Iterable[String]): Self = StObject.set(x, "AllowedMethods", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedMethodsVarargs(value: String*): Self = StObject.set(x, "AllowedMethods", js.Array(value :_*))
      
      @scala.inline
      def setAllowedOrigins(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "AllowedOrigins", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedOriginsIterable(value: js.Iterable[String]): Self = StObject.set(x, "AllowedOrigins", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowedOriginsVarargs(value: String*): Self = StObject.set(x, "AllowedOrigins", js.Array(value :_*))
      
      @scala.inline
      def setExposeHeaders(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "ExposeHeaders", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExposeHeadersIterable(value: js.Iterable[String]): Self = StObject.set(x, "ExposeHeaders", value.asInstanceOf[js.Any])
