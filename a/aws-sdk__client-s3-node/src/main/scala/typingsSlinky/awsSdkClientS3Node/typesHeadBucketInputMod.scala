...
object typesHeadBucketInputMod {
  ...
  object HeadBucketInput {
    ...
    @scala.inline
    def apply(Bucket: String): HeadBucketInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[HeadBucketInput]
    }
    
    @scala.inline
    implicit class HeadBucketInputMutableBuilder[Self <: HeadBucketInput] (val x: Self) extends AnyVal {
