...
import typingsSlinky.awsSdkClientS3Node.typesTargetGrantMod.TargetGrant
...
object LoggingEnabled {
  ...
  implicit class LoggingEnabledOps[Self <: LoggingEnabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetGrantsIterable(value: js.Iterable[TargetGrant]): Self = this.set("TargetGrants", value.asInstanceOf[js.Any])
    @scala.inline
    def setTargetGrants(value: js.Array[TargetGrant] | js.Iterable[TargetGrant]): Self = this.set("TargetGrants", value.asInstanceOf[js.Any])
    @scala.inline
