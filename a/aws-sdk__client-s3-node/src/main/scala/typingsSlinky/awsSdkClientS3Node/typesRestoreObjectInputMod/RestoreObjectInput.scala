package typingsSlinky.awsSdkClientS3Node.typesRestoreObjectInputMod

import typingsSlinky.awsSdkClientS3Node.awsSdkClientS3NodeStrings.requester_
import typingsSlinky.awsSdkClientS3Node.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientS3Node.typesRestoreRequestMod.RestoreRequest
...
trait RestoreObjectInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RestoreRequest: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesRestoreRequestMod.RestoreRequest] = js.native
  /**
...
object RestoreObjectInput {
  ...
  implicit class RestoreObjectInputOps[Self <: RestoreObjectInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRestoreRequest(value: RestoreRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RestoreRequest")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRestoreRequest: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RestoreRequest")(js.undefined)
        ret
    }
    @scala.inline
