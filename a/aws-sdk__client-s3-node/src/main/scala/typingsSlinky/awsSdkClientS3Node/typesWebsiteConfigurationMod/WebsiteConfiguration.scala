...
trait WebsiteConfiguration extends js.Object {
  /**
    ...
    */
  var ErrorDocument: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesErrorDocumentMod.ErrorDocument] = js.native
  /**
    * _IndexDocument shape
    */
  var IndexDocument: js.UndefOr[typingsSlinky.awsSdkClientS3Node.typesIndexDocumentMod.IndexDocument] = js.native
  /**
...
object WebsiteConfiguration {
  ...
  implicit class WebsiteConfigurationOps[Self <: WebsiteConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRoutingRulesIterable(value: js.Iterable[RoutingRule]): Self = this.set("RoutingRules", value.asInstanceOf[js.Any])
    @scala.inline
    def setRoutingRules(value: js.Array[RoutingRule] | js.Iterable[RoutingRule]): Self = this.set("RoutingRules", value.asInstanceOf[js.Any])
    @scala.inline
