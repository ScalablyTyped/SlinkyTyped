...
object typesDeleteMod {
  ...
  object Delete {
    ...
    implicit class DeleteMutableBuilder[Self <: Delete] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setObjects(value: js.Array[ObjectIdentifier] | js.Iterable[ObjectIdentifier]): Self = StObject.set(x, "Objects", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setObjectsIterable(value: js.Iterable[ObjectIdentifier]): Self = StObject.set(x, "Objects", value.asInstanceOf[js.Any])
