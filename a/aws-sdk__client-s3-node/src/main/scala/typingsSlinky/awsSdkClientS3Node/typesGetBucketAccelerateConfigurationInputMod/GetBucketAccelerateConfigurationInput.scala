package typingsSlinky.awsSdkClientS3Node.typesGetBucketAccelerateConfigurationInputMod
...
@js.native
trait GetBucketAccelerateConfigurationInput extends InputTypesUnion {
  /**
