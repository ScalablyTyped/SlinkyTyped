package typingsSlinky.awsSdkClientS3Node.typesGetObjectAclInputMod
...
@js.native
trait GetObjectAclInput extends InputTypesUnion {
  /**
...
object GetObjectAclInput {
  ...
  @scala.inline
  implicit class GetObjectAclInputOps[Self <: GetObjectAclInput] (val x: Self) extends AnyVal {
    @scala.inline
