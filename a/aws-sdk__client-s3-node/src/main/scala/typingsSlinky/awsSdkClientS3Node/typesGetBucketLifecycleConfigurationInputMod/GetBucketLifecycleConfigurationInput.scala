package typingsSlinky.awsSdkClientS3Node.typesGetBucketLifecycleConfigurationInputMod
...
@js.native
trait GetBucketLifecycleConfigurationInput extends InputTypesUnion {
  /**
