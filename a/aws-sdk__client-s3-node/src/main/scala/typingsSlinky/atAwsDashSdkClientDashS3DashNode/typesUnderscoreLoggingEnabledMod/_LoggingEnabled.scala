...
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreTargetGrantMod._TargetGrant
...
trait _LoggingEnabled extends js.Object {
  ...
  /**
    * _TargetGrants shape
    */
  var TargetGrants: js.UndefOr[js.Array[_TargetGrant] | js.Iterable[_TargetGrant]] = js.undefined
  /**
...
object _LoggingEnabled {
  ...
  def apply(
    TargetBucket: String,
    TargetPrefix: String,
    TargetGrants: js.Array[_TargetGrant] | js.Iterable[_TargetGrant] = null
  ): _LoggingEnabled = {
