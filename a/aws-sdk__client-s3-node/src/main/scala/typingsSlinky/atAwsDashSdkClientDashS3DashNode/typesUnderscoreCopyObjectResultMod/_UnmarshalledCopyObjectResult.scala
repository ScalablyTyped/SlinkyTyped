...
trait _UnmarshalledCopyObjectResult extends _CopyObjectResult {
  /**
    ...
    */
  @JSName("LastModified")
  var LastModified__UnmarshalledCopyObjectResult: js.UndefOr[js.Date] = js.undefined
}

object _UnmarshalledCopyObjectResult {
  @scala.inline
  def apply(ETag: String = null, LastModified: js.Date = null): _UnmarshalledCopyObjectResult = {
