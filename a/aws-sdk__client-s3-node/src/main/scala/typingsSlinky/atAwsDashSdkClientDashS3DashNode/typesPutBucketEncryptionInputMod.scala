...
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreServerSideEncryptionConfigurationMod._ServerSideEncryptionConfiguration
...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketEncryptionInput", JSImport.Namespace)
@js.native
