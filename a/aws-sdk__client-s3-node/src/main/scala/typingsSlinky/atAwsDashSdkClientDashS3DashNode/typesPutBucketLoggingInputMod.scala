...
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreBucketLoggingStatusMod._BucketLoggingStatus
...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketLoggingInput", JSImport.Namespace)
@js.native
object typesPutBucketLoggingInputMod extends js.Object {
  ...
  trait PutBucketLoggingInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var BucketLoggingStatus: _BucketLoggingStatus = js.native
    /**
      * _ContentMD5 shape
      */
