package typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreLifecycleRuleMod
...
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreAbortIncompleteMultipartUploadMod._AbortIncompleteMultipartUpload
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreLifecycleExpirationMod._LifecycleExpiration
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreLifecycleRuleFilterMod._LifecycleRuleFilter
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreNoncurrentVersionExpirationMod._NoncurrentVersionExpiration
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreNoncurrentVersionTransitionMod._NoncurrentVersionTransition
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreTransitionMod._Transition
...
trait _LifecycleRule extends js.Object {
  ...
  var NoncurrentVersionTransitions: js.UndefOr[
    js.Array[_NoncurrentVersionTransition] | js.Iterable[_NoncurrentVersionTransition]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Transitions: js.UndefOr[js.Array[_Transition] | js.Iterable[_Transition]] = js.undefined
}
...
object _LifecycleRule {
  ...
  def apply(
    ...
    NoncurrentVersionTransitions: js.Array[_NoncurrentVersionTransition] | js.Iterable[_NoncurrentVersionTransition] = null,
    Prefix: String = null,
    Transitions: js.Array[_Transition] | js.Iterable[_Transition] = null
  ): _LifecycleRule = {
