package typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreDeleteMarkerEntryMod
...
trait _UnmarshalledDeleteMarkerEntry extends _DeleteMarkerEntry {
  /**
    ...
    */
  @JSName("LastModified")
  var LastModified__UnmarshalledDeleteMarkerEntry: js.UndefOr[js.Date] = js.undefined
  /**
    * _Owner shape
    */
  @JSName("Owner")
