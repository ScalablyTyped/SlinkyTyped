package typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreLifecycleExpirationMod
...
trait _UnmarshalledLifecycleExpiration extends _LifecycleExpiration {
  /**
    ...
    */
  @JSName("Date")
  var Date__UnmarshalledLifecycleExpiration: js.UndefOr[js.Date] = js.undefined
}
