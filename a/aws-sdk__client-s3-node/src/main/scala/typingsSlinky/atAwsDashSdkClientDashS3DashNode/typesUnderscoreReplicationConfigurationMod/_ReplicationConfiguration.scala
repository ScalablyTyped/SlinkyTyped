package typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreReplicationConfigurationMod

import typingsSlinky.atAwsDashSdkClientDashS3DashNode.typesUnderscoreReplicationRuleMod._ReplicationRule
...
trait _ReplicationConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var Rules: js.Array[_ReplicationRule] | js.Iterable[_ReplicationRule]
}

object _ReplicationConfiguration {
  @scala.inline
  def apply(Role: String, Rules: js.Array[_ReplicationRule] | js.Iterable[_ReplicationRule]): _ReplicationConfiguration = {
