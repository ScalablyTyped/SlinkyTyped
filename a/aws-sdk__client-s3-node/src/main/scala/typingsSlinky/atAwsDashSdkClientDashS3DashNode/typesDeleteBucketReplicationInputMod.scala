...
@JSImport("@aws-sdk/client-s3-node/types/DeleteBucketReplicationInput", JSImport.Namespace)
@js.native
object typesDeleteBucketReplicationInputMod extends js.Object {
  @js.native
  trait DeleteBucketReplicationInput extends _InputTypesUnion {
    /**
