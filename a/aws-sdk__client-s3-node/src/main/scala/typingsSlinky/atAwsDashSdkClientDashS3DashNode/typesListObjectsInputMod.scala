...
import typingsSlinky.atAwsDashSdkClientDashS3DashNode.atAwsDashSdkClientDashS3DashNodeStrings.url
...
@JSImport("@aws-sdk/client-s3-node/types/ListObjectsInput", JSImport.Namespace)
@js.native
object typesListObjectsInputMod extends js.Object {
  @js.native
  trait ListObjectsInput extends _InputTypesUnion {
    /**
