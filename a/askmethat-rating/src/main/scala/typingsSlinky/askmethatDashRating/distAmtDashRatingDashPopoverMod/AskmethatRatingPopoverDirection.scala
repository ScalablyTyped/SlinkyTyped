...
object AskmethatRatingPopoverDirection extends js.Object {
  ...
  /* 1 */ val bottom: typingsSlinky.askmethatDashRating.distAmtDashRatingDashPopoverMod.AskmethatRatingPopoverDirection.bottom with Double = js.native
  /* 0 */ val top: typingsSlinky.askmethatDashRating.distAmtDashRatingDashPopoverMod.AskmethatRatingPopoverDirection.top with Double = js.native
  @JSBracketAccess
