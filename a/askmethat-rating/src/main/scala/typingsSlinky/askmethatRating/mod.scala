...
object mod {
  ...
  object AskmethatRatingSteps extends StObject {
    ...
    /* 0 */ val DecimalStep: typingsSlinky.askmethatRating.mod.AskmethatRatingSteps.DecimalStep with Double = js.native
    ...
    /* 1 */ val HalfStep: typingsSlinky.askmethatRating.mod.AskmethatRatingSteps.HalfStep with Double = js.native
    ...
    /* 2 */ val OnePerOneStep: typingsSlinky.askmethatRating.mod.AskmethatRatingSteps.OnePerOneStep with Double = js.native
  }
