package typingsSlinky.askmethatRating
...
object amtRatingPopoverMod {
  ...
  object AskmethatRatingPopoverDirection extends StObject {
    ...
    /* 1 */ val bottom: typingsSlinky.askmethatRating.amtRatingPopoverMod.AskmethatRatingPopoverDirection.bottom with Double = js.native
    
    @js.native
    sealed trait top extends AskmethatRatingPopoverDirection
    /* 0 */ val top: typingsSlinky.askmethatRating.amtRatingPopoverMod.AskmethatRatingPopoverDirection.top with Double = js.native
  }
