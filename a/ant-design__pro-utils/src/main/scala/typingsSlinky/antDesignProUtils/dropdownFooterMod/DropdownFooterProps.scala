package typingsSlinky.antDesignProUtils.dropdownFooterMod
...
object DropdownFooterProps {
  ...
  implicit class DropdownFooterPropsOps[Self <: DropdownFooterProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClear(value: /* e */ SyntheticMouseEvent[Element] => Unit): Self = this.set("onClear", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnClear: Self = this.set("onClear", js.undefined)
    
    @scala.inline
    def setOnConfirm(value: /* e */ SyntheticMouseEvent[Element] => Unit): Self = this.set("onConfirm", js.Any.fromFunction1(value))
