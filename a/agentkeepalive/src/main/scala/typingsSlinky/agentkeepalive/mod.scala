package typingsSlinky.agentkeepalive
...
object mod {
  ...
  object Constants_ {
    ...
    implicit class Constants_MutableBuilder[Self <: Constants_] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCREATE_HTTPS_CONNECTION(value: js.Symbol): Self = StObject.set(x, "CREATE_HTTPS_CONNECTION", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCREATE_ID(value: js.Symbol): Self = StObject.set(x, "CREATE_ID", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCURRENT_ID(value: js.Symbol): Self = StObject.set(x, "CURRENT_ID", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setINIT_SOCKET(value: js.Symbol): Self = StObject.set(x, "INIT_SOCKET", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSOCKET_CREATED_TIME(value: js.Symbol): Self = StObject.set(x, "SOCKET_CREATED_TIME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSOCKET_NAME(value: js.Symbol): Self = StObject.set(x, "SOCKET_NAME", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSOCKET_REQUEST_COUNT(value: js.Symbol): Self = StObject.set(x, "SOCKET_REQUEST_COUNT", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSOCKET_REQUEST_FINISHED_COUNT(value: js.Symbol): Self = StObject.set(x, "SOCKET_REQUEST_FINISHED_COUNT", value.asInstanceOf[js.Any])
    }
  }
