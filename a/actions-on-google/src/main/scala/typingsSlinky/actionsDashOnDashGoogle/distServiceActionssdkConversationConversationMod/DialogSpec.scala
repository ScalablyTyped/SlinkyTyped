...
object DialogSpec {
  ...
  @scala.inline
  def typeDotgoogleapisDotcomSlashgoogleDotactionsDotv2DotLinkValueSpecDotLinkDialogSpec: typingsSlinky.actionsDashOnDashGoogle.actionsDashOnDashGoogleStrings.typeDotgoogleapisDotcomSlashgoogleDotactionsDotv2DotLinkValueSpecDotLinkDialogSpec = this.cast("type.googleapis.com/google.actions.v2.LinkValueSpec.LinkDialogSpec")
  @scala.inline
  def typeDotgoogleapisDotcomSlashgoogleDotactionsDotv2DotPlaceValueSpecDotPlaceDialogSpec: typingsSlinky.actionsDashOnDashGoogle.actionsDashOnDashGoogleStrings.typeDotgoogleapisDotcomSlashgoogleDotactionsDotv2DotPlaceValueSpecDotPlaceDialogSpec = this.cast("type.googleapis.com/google.actions.v2.PlaceValueSpec.PlaceDialogSpec")
}
