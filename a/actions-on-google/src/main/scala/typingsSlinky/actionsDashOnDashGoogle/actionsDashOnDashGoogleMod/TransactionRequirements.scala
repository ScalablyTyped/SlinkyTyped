package typingsSlinky.actionsDashOnDashGoogle.actionsDashOnDashGoogleMod
...
class TransactionRequirements ()
  extends typingsSlinky.actionsDashOnDashGoogle.distServiceActionssdkMod.TransactionRequirements {
