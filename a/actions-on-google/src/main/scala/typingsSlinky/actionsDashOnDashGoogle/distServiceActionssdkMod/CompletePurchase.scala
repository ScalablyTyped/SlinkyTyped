...
@JSImport("actions-on-google/dist/service/actionssdk", "CompletePurchase")
@js.native
/**
...
class CompletePurchase ()
  extends typingsSlinky.actionsDashOnDashGoogle.distServiceActionssdkConversationMod.CompletePurchase {
