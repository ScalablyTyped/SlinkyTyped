package typingsSlinky.actionsDashOnDashGoogle.distServiceActionssdkConversationResponseCardTableMod

import typingsSlinky.actionsDashOnDashGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2UiElementsTableCardColumnProperties
