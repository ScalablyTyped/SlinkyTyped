...
object HelperOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.actionsOnGoogle.conversationConversationMod.Intent */ TIntent, TValueSpec](intent: TIntent, `type`: InputValueSpec): HelperOptions[TIntent, TValueSpec] = {
  ...
  @scala.inline
  implicit class HelperOptionsOps[Self <: HelperOptions[_, _], /* <: typingsSlinky.actionsOnGoogle.conversationConversationMod.Intent */ TIntent, TValueSpec] (val x: Self with (HelperOptions[TIntent, TValueSpec])) extends AnyVal {
    @scala.inline
