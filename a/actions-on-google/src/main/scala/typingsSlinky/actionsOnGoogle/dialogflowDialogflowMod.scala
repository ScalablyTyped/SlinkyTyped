...
object dialogflowDialogflowMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent`
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent`
  */
  trait DefaultDialogflowIntent extends StObject
  object DefaultDialogflowIntent {
    
    @scala.inline
    def `Default Fallback Intent`: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent` = ("Default Fallback Intent").asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent`]
    
    @scala.inline
    def `Default Welcome Intent`: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent` = ("Default Welcome Intent").asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent`]
  }
