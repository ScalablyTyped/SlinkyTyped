...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.WEBHOOK_STATE_UNSPECIFIED
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.WEBHOOK_STATE_ENABLED
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING
*/
