...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_OK
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_ERROR
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_USER_CANCELLED
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_ALREADY_OWNED
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_ITEM_UNAVAILABLE
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.PURCHASE_STATUS_ITEM_CHANGE_REQUESTED
*/
