...
object GoogleActionsV2ExpectedIntent {
  ...
  implicit class GoogleActionsV2ExpectedIntentOps[Self <: GoogleActionsV2ExpectedIntent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInputValueData(value: ApiClientObjectMap[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("inputValueData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInputValueData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("inputValueData")(js.undefined)
        ret
    }
    @scala.inline
