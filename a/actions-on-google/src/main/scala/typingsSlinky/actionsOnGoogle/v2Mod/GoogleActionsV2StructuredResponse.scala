...
object GoogleActionsV2StructuredResponse {
  ...
  implicit class GoogleActionsV2StructuredResponseOps[Self <: GoogleActionsV2StructuredResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOrderUpdateV3(value: GoogleActionsOrdersV3OrderUpdate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("orderUpdateV3")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOrderUpdateV3: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("orderUpdateV3")(js.undefined)
        ret
    }
  }
