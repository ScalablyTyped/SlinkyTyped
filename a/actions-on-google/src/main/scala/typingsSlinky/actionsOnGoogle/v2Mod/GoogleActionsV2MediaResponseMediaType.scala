...
object GoogleActionsV2MediaResponseMediaType {
  @scala.inline
  def AUDIO: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.AUDIO = this.cast("AUDIO")
  @scala.inline
  def MEDIA_TYPE_UNSPECIFIED: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.MEDIA_TYPE_UNSPECIFIED = this.cast("MEDIA_TYPE_UNSPECIFIED")
  @scala.inline
