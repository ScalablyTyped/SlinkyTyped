...
object GoogleActionsV2UiElementsCarouselSelect {
  ...
  implicit class GoogleActionsV2UiElementsCarouselSelectOps[Self <: GoogleActionsV2UiElementsCarouselSelect] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImageDisplayOptions(value: GoogleActionsV2UiElementsCarouselSelectImageDisplayOptions): Self = {
    ...
    @scala.inline
    def withItems(value: js.Array[GoogleActionsV2UiElementsCarouselSelectCarouselItem]): Self = {
        val ret = this.duplicate
