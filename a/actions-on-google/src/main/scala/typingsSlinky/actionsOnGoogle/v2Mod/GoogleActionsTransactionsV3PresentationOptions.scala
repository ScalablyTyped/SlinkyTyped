...
object GoogleActionsTransactionsV3PresentationOptions {
  ...
  implicit class GoogleActionsTransactionsV3PresentationOptionsOps[Self <: GoogleActionsTransactionsV3PresentationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActionDisplayName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("actionDisplayName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutActionDisplayName: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("actionDisplayName")(js.undefined)
        ret
    }
  }
