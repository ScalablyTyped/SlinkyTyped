...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.IN_APP
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.SUBSCRIPTION
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.APP
*/
