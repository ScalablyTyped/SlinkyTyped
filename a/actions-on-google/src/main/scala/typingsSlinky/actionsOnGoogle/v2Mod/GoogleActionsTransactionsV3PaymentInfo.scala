...
object GoogleActionsTransactionsV3PaymentInfo {
  ...
  implicit class GoogleActionsTransactionsV3PaymentInfoOps[Self <: GoogleActionsTransactionsV3PaymentInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPaymentMethodProvenance(value: GoogleActionsTransactionsV3PaymentInfoPaymentMethodProvenance): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paymentMethodProvenance")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPaymentMethodProvenance: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("paymentMethodProvenance")(js.undefined)
        ret
    }
  }
