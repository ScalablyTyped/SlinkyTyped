...
import typingsSlinky.actionsOnGoogle.v2Mod.GoogleActionsV2Surface
...
object surfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotAUDIO_OUTPUT
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotSCREEN_OUTPUT
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotMEDIA_RESPONSE_AUDIO
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotWEB_BROWSER
    - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotINTERACTIVE_CANVAS
  */
  trait SurfaceCapability extends StObject
  object SurfaceCapability {
    
    @scala.inline
    def actionsDotcapabilityDotAUDIO_OUTPUT: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotAUDIO_OUTPUT = "actions.capability.AUDIO_OUTPUT".asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotAUDIO_OUTPUT]
    
    @scala.inline
    def actionsDotcapabilityDotINTERACTIVE_CANVAS: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotINTERACTIVE_CANVAS = "actions.capability.INTERACTIVE_CANVAS".asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotINTERACTIVE_CANVAS]
    
    @scala.inline
    def actionsDotcapabilityDotMEDIA_RESPONSE_AUDIO: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotMEDIA_RESPONSE_AUDIO = "actions.capability.MEDIA_RESPONSE_AUDIO".asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotMEDIA_RESPONSE_AUDIO]
    
    @scala.inline
    def actionsDotcapabilityDotSCREEN_OUTPUT: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotSCREEN_OUTPUT = "actions.capability.SCREEN_OUTPUT".asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotSCREEN_OUTPUT]
    
    @scala.inline
    def actionsDotcapabilityDotWEB_BROWSER: typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotWEB_BROWSER = "actions.capability.WEB_BROWSER".asInstanceOf[typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionsDotcapabilityDotWEB_BROWSER]
  }
}
