...
object HtmlResponseOptions {
  @scala.inline
  def apply[/* <: typingsSlinky.actionsOnGoogle.commonMod.JsonObject */ TData](): HtmlResponseOptions[TData] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HtmlResponseOptions[TData]]
  }
  @scala.inline
  implicit class HtmlResponseOptionsOps[Self <: HtmlResponseOptions[_], /* <: typingsSlinky.actionsOnGoogle.commonMod.JsonObject */ TData] (val x: Self with HtmlResponseOptions[TData]) extends AnyVal {
    @scala.inline
