...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionDotdevicesDotSYNC
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionDotdevicesDotQUERY
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionDotdevicesDotEXECUTE
  - typingsSlinky.actionsOnGoogle.actionsOnGoogleStrings.actionDotdevicesDotDISCONNECT
*/
