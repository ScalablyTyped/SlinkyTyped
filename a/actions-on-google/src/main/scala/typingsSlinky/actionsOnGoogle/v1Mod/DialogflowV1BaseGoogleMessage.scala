...
object DialogflowV1BaseGoogleMessage {
  @scala.inline
  def apply[/* <: java.lang.String */ TType](platform: google): DialogflowV1BaseGoogleMessage[TType] = {
    val __obj = js.Dynamic.literal(platform = platform.asInstanceOf[js.Any])
    __obj.asInstanceOf[DialogflowV1BaseGoogleMessage[TType]]
  }
  @scala.inline
  implicit class DialogflowV1BaseGoogleMessageOps[Self <: DialogflowV1BaseGoogleMessage[_], /* <: java.lang.String */ TType] (val x: Self with DialogflowV1BaseGoogleMessage[TType]) extends AnyVal {
    @scala.inline
