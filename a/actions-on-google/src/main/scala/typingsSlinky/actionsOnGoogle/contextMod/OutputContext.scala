...
object OutputContext {
  @scala.inline
  def apply[/* <: typingsSlinky.actionsOnGoogle.contextMod.Parameters */ TParameters](lifespan: Double): OutputContext[TParameters] = {
    val __obj = js.Dynamic.literal(lifespan = lifespan.asInstanceOf[js.Any])
    __obj.asInstanceOf[OutputContext[TParameters]]
  }
  @scala.inline
  implicit class OutputContextOps[Self <: OutputContext[_], /* <: typingsSlinky.actionsOnGoogle.contextMod.Parameters */ TParameters] (val x: Self with OutputContext[TParameters]) extends AnyVal {
    @scala.inline
