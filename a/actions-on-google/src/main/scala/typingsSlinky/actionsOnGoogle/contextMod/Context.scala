...
object Context {
  @scala.inline
  def apply[/* <: typingsSlinky.actionsOnGoogle.contextMod.Parameters */ TParameters](lifespan: Double, name: String, parameters: TParameters): Context[TParameters] = {
  ...
  @scala.inline
  implicit class ContextOps[Self <: Context[_], /* <: typingsSlinky.actionsOnGoogle.contextMod.Parameters */ TParameters] (val x: Self with Context[TParameters]) extends AnyVal {
    @scala.inline
