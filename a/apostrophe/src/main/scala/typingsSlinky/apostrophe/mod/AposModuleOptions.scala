...
trait AposModuleOptions[C] extends js.Object {
  ...
  var arrangeFields: js.UndefOr[js.Array[typingsSlinky.apostrophe.anon.Fields]] = js.undefined
...
object AposModuleOptions {
  ...
  def apply[C](
    ...
    arrangeFields: js.Array[typingsSlinky.apostrophe.anon.Fields] = null,
