...
object AposModuleOptions {
  ...
  implicit class AposModuleOptionsOps[Self <: AposModuleOptions[_], C] (val x: Self with AposModuleOptions[C]) extends AnyVal {
    ...
    @scala.inline
    def setArrangeFieldsVarargs(value: typingsSlinky.apostrophe.anon.Fields*): Self = this.set("arrangeFields", js.Array(value :_*))
    
    @scala.inline
    def setArrangeFields(value: js.Array[typingsSlinky.apostrophe.anon.Fields]): Self = this.set("arrangeFields", value.asInstanceOf[js.Any])
