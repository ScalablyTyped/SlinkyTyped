...
object apiModelMod {
  ...
  @JSImport("@aws-sdk/service-model/build/ApiModel", "isApiModel")
  @js.native
  def isApiModel(model: js.Any): /* is @aws-sdk/build-types.@aws-sdk/build-types/build/ApiModel.ApiModel */ Boolean = js.native
  
  @JSImport("@aws-sdk/service-model/build/ApiModel", "isServiceMetadata")
  @js.native
  ...
  @JSImport("@aws-sdk/service-model/build/ApiModel", "isSupportedProtocol")
  @js.native
  ...
  @JSImport("@aws-sdk/service-model/build/ApiModel", "isSupportedSignatureVersion")
  @js.native
