package typingsSlinky.analyticsDashNode.analyticsDashNodeMod.AnalyticsNode

import typingsSlinky.analyticsDashNode.Anon_AnonymousId
import typingsSlinky.analyticsDashNode.Anon_AnonymousIdCategory
import typingsSlinky.analyticsDashNode.Anon_AnonymousIdContext
import typingsSlinky.analyticsDashNode.Anon_AnonymousIdContextGroupId
import typingsSlinky.analyticsDashNode.Anon_AnonymousIdIntegrations
...
trait Analytics extends js.Object {
  ...
  def identify(message: Anon_AnonymousId, callback: js.Function2[/* err */ js.Error, /* data */ Data, Unit]): Analytics = js.native
  /* The page method lets you record page views on your website, along with
    optional extra information about the page being viewed. */
  def page(message: Anon_AnonymousIdCategory): Analytics = js.native
  def page(
    message: Anon_AnonymousIdCategory,
    callback: js.Function2[/* err */ js.Error, /* data */ Data, Unit]
  ): Analytics = js.native
  /* The track method lets you record the actions your users perform. */
  def track(message: Anon_AnonymousIdContext): Analytics = js.native
  def track(
    message: Anon_AnonymousIdContext,
    callback: js.Function2[/* err */ js.Error, /* data */ Data, Unit]
  ): Analytics = js.native
}
