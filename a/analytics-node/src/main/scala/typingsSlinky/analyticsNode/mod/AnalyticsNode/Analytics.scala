...
import typingsSlinky.analyticsNode.AnonCategory
import typingsSlinky.analyticsNode.AnonEvent
import typingsSlinky.analyticsNode.AnonGroupId
import typingsSlinky.analyticsNode.AnonIntegrations
import typingsSlinky.analyticsNode.AnonPreviousId
...
trait Analytics extends js.Object {
  ...
  def group(
    message: Identity with AnonGroupId,
    callback: js.Function2[/* err */ js.Error, /* data */ Data, Unit]
  ): Analytics = js.native
  ...
  def track(
    message: Identity with AnonEvent,
    callback: js.Function2[/* err */ js.Error, /* data */ Data, Unit]
  ): Analytics = js.native
}
