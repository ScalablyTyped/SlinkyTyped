...
import typingsSlinky.antvDataSet.hexjsonMod.Options
...
object connectorParamsMod {
  ...
  trait ConnectorParams extends StObject {
    ...
    var TopoJSON: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options] = js.native
    
    var csv: js.Tuple2[String, js.Object] = js.native
    
    var diagram: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options] = js.native
    
    var dsv: js.Tuple2[String, typingsSlinky.antvDataSet.dsvMod.Options] = js.native
    
    var geo: js.Tuple2[_, js.Object] = js.native
    
    var geojson: js.Tuple2[_, js.Object] = js.native
    
    var graph: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options] = js.native
    ...
    var hierarchy: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options] = js.native
    
    var topojson: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options] = js.native
    
    var tree: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options] = js.native
  ...
  object ConnectorParams {
    ...
    def apply(
      ...
      TopoJSON: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options],
      csv: js.Tuple2[String, js.Object],
      diagram: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options],
      dsv: js.Tuple2[String, typingsSlinky.antvDataSet.dsvMod.Options],
      geo: js.Tuple2[_, js.Object],
      geojson: js.Tuple2[_, js.Object],
      graph: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options],
      hex: js.Tuple2[js.Array[_], Options],
      `hex-json`: js.Tuple2[js.Array[_], Options],
      hexjson: js.Tuple2[js.Array[_], Options],
      hierarchy: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options],
      topojson: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options],
      tree: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options],
    ...
    implicit class ConnectorParamsMutableBuilder[Self <: ConnectorParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDiagram(value: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options]): Self = StObject.set(x, "diagram", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDsv(value: js.Tuple2[String, typingsSlinky.antvDataSet.dsvMod.Options]): Self = StObject.set(x, "dsv", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setGraph(value: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options]): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHierarchy(value: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options]): Self = StObject.set(x, "hierarchy", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTopoJSON(value: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options]): Self = StObject.set(x, "TopoJSON", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTree(value: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options]): Self = StObject.set(x, "tree", value.asInstanceOf[js.Any])
