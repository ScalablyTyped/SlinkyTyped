package typingsSlinky.antvDataSet.rectangleMod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBinWidth(value: js.Tuple2[Double, Double]): Self = this.set("binWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBinWidth: Self = this.set("binWidth", js.undefined)
    
    @scala.inline
    def setBins(value: js.Tuple2[Double, Double]): Self = this.set("bins", value.asInstanceOf[js.Any])
