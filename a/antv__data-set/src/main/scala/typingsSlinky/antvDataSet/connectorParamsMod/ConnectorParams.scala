package typingsSlinky.antvDataSet.connectorParamsMod
...
object ConnectorParams {
  ...
  implicit class ConnectorParamsOps[Self <: ConnectorParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTopoJSON(value: js.Tuple2[_, typingsSlinky.antvDataSet.topojsonMod.Options]): Self = this.set("TopoJSON", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCsv(value: js.Tuple2[String, js.Object]): Self = this.set("csv", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDiagram(value: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options]): Self = this.set("diagram", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDsv(value: js.Tuple2[String, typingsSlinky.antvDataSet.dsvMod.Options]): Self = this.set("dsv", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGeo(value: js.Tuple2[_, js.Object]): Self = this.set("geo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGraph(value: js.Tuple2[_, typingsSlinky.antvDataSet.graphMod.Options]): Self = this.set("graph", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setHierarchy(value: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options]): Self = this.set("hierarchy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTree(value: js.Tuple2[_, typingsSlinky.antvDataSet.connectorHierarchyMod.Options]): Self = this.set("tree", value.asInstanceOf[js.Any])
