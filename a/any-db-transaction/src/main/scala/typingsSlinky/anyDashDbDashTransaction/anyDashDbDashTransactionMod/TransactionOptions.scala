package typingsSlinky.anyDashDbDashTransaction.anyDashDbDashTransactionMod

import typingsSlinky.anyDashDb.anyDashDbMod.Adapter
...
object TransactionOptions {
  ...
  def apply(
    ...
    begin: String = null,
    callback: (/* error */ js.Error, /* transaction */ Transaction) => Unit = null,
    commit: String = null,
