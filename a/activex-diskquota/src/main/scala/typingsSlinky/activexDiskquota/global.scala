...
import typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.AccountStatusConstants
import typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.QuotaStateConstants
import typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.UserNameResolutionConstants
...
object global extends js.Object {
  ...
  object DiskQuotaTypeLibrary extends js.Object {
    ...
    class DIDiskQuotaUser protected ()
      extends typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser {
      ...
      override var DiskQuotaTypeLibraryDotDIDiskQuotaUser_typekey: typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
      /** User's display name */
      /* CompleteClass */
    ...
    class DiskQuotaControl protected ()
      extends typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DiskQuotaControl {
      ...
      override var DiskQuotaTypeLibraryDotDiskQuotaControl_typekey: typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DiskQuotaControl = js.native
      ...
      /* CompleteClass */
      override def AddUser(LogonName: String): typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
      /** Delete a user quota entry */
      /* CompleteClass */
      override def DeleteUser(pUser: typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser): Unit = js.native
      /** Find a user quota entry by Name */
      /* CompleteClass */
      override def FindUser(LogonName: String): typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
      /** Promote a user quota entry to the head of the name resolution queue */
      /* CompleteClass */
      override def GiveUserNameResolutionPriority(pUser: typingsSlinky.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser): Unit = js.native
