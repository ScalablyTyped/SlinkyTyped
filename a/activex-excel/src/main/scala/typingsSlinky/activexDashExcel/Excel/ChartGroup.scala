...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typingsSlinky.activexDashExcel.Excel.DownBars = js.native
  val DropLines: typingsSlinky.activexDashExcel.Excel.DropLines = js.native
  ...
  val HiLoLines: typingsSlinky.activexDashExcel.Excel.HiLoLines = js.native
  val Index: Double = js.native
  var Overlap: Double = js.native
  val Parent: js.Any = js.native
  val RadarAxisLabels: TickLabels = js.native
  var SecondPlotSize: Double = js.native
  val SeriesLines: typingsSlinky.activexDashExcel.Excel.SeriesLines = js.native
  ...
  val UpBars: typingsSlinky.activexDashExcel.Excel.UpBars = js.native
