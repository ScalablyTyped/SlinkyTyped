...
object XlTotalsCalculation {
  ...
  @scala.inline
  def xlTotalsCalculationAverage: `2` = this.cast(2)
  @scala.inline
  def xlTotalsCalculationCount: `3` = this.cast(3)
  @scala.inline
  def xlTotalsCalculationCountNums: `4` = this.cast(4)
  @scala.inline
  def xlTotalsCalculationCustom: `9` = this.cast(9)
  @scala.inline
  def xlTotalsCalculationMax: `6` = this.cast(6)
  @scala.inline
  def xlTotalsCalculationMin: `5` = this.cast(5)
  @scala.inline
  def xlTotalsCalculationNone: `0` = this.cast(0)
  @scala.inline
  def xlTotalsCalculationStdDev: `7` = this.cast(7)
  @scala.inline
  def xlTotalsCalculationSum: `1` = this.cast(1)
  @scala.inline
  def xlTotalsCalculationVar: `8` = this.cast(8)
}
