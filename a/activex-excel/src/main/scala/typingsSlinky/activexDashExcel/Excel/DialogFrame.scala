...
class DialogFrame protected () extends js.Object {
  ...
  def Characters(Start: js.Any): typingsSlinky.activexDashExcel.Excel.Characters = js.native
  def Characters(Start: js.Any, Length: js.Any): typingsSlinky.activexDashExcel.Excel.Characters = js.native
