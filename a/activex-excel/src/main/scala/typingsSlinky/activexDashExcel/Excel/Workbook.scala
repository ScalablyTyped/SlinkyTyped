...
import typingsSlinky.activexDashExcel.activexDashExcelStrings.Everyone
import typingsSlinky.activexDashExcel.activexDashExcelStrings.`Everyone but me`
import typingsSlinky.activexDashOffice.Office.ByteArray
...
class Workbook protected () extends js.Object {
  ...
  val BuiltinDocumentProperties_Original: DocumentProperties[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  ...
  val CustomDocumentProperties_Original: DocumentProperties[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  @JSName("CustomViews")
  ...
  val Mailer: typingsSlinky.activexDashExcel.Excel.Mailer = js.native
  @JSName("Modules")
  ...
  val Research: typingsSlinky.activexDashExcel.Excel.Research = js.native
  val RevisionNumber: Double = js.native
  val Routed: Boolean = js.native
  val RoutingSlip: typingsSlinky.activexDashExcel.Excel.RoutingSlip = js.native
  ...
  val SmartTagOptions: typingsSlinky.activexDashExcel.Excel.SmartTagOptions = js.native
  @JSName("Styles")
  ...
  val WebOptions: typingsSlinky.activexDashExcel.Excel.WebOptions = js.native
  @JSName("Windows")
  ...
  def BuiltinDocumentProperties(index: String): DocumentProperty[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  def BuiltinDocumentProperties(index: Double): DocumentProperty[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  ...
  def CustomDocumentProperties(index: String): DocumentProperty[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  def CustomDocumentProperties(index: Double): DocumentProperty[typingsSlinky.activexDashExcel.Excel.Application] = js.native
  ...
  def PivotCaches(): typingsSlinky.activexDashExcel.Excel.PivotCaches = js.native
