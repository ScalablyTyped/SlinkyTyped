...
class WorkbookConnection protected () extends js.Object {
  ...
  val ODBCConnection: typingsSlinky.activexDashExcel.Excel.ODBCConnection = js.native
  val OLEDBConnection: typingsSlinky.activexDashExcel.Excel.OLEDBConnection = js.native
