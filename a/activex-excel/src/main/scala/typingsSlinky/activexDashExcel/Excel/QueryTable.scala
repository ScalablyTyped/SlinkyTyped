...
class QueryTable protected () extends js.Object {
  ...
  val ListObject: typingsSlinky.activexDashExcel.Excel.ListObject = js.native
  ...
  var Recordset: typingsSlinky.activexDashDao.DAO.Recordset | typingsSlinky.activexDashAdodb.ADODB.Recordset = js.native
