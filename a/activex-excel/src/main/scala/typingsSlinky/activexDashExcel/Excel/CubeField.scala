...
class CubeField protected () extends js.Object {
  ...
  val PivotFields: typingsSlinky.activexDashExcel.Excel.PivotFields = js.native
  var Position: Double = js.native
  var ShowInFieldList: Boolean = js.native
  val TreeviewControl: typingsSlinky.activexDashExcel.Excel.TreeviewControl = js.native
