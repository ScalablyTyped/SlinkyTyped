...
class PivotTable protected () extends js.Object {
  ...
  def CalculatedFields(): typingsSlinky.activexDashExcel.Excel.CalculatedFields = js.native
  ...
  def PivotCache(): typingsSlinky.activexDashExcel.Excel.PivotCache = js.native
  def PivotFields(Indexes: SafeArray[Double | String]): typingsSlinky.activexDashExcel.Excel.PivotFields = js.native
