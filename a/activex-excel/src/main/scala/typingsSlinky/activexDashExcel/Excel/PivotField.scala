...
class PivotField protected () extends js.Object {
  ...
  val CubeField: typingsSlinky.activexDashExcel.Excel.CubeField = js.native
  ...
  def CalculatedItems(): typingsSlinky.activexDashExcel.Excel.CalculatedItems = js.native
  ...
  def PivotItems(Indexes: SafeArray[Double | String]): typingsSlinky.activexDashExcel.Excel.PivotItems = js.native
