...
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4172`
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4173`
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4174`
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4175`
...
/* Rewritten from type alias, can be one of: 
  - typings.activexDashExcel.activexDashExcelNumbers.`-4172`
  - typings.activexDashExcel.activexDashExcelNumbers.`-4174`
  ...
  - typings.activexDashExcel.activexDashExcelNumbers.`-4173`
  - typings.activexDashExcel.activexDashExcelNumbers.`-4175`
