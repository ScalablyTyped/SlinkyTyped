...
*/
trait XlSourceType extends js.Object

object XlSourceType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlSourceAutoFilter: `3` = this.cast(3)
  @scala.inline
  def xlSourceChart: `5` = this.cast(5)
  @scala.inline
  def xlSourcePivotTable: `6` = this.cast(6)
  @scala.inline
  def xlSourcePrintArea: `2` = this.cast(2)
  @scala.inline
  def xlSourceQuery: `7` = this.cast(7)
  @scala.inline
  def xlSourceRange: `4` = this.cast(4)
  @scala.inline
  def xlSourceSheet: `1` = this.cast(1)
  @scala.inline
  def xlSourceWorkbook: `0` = this.cast(0)
}
