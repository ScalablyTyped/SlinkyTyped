...
- typings.activexDashExcel.Excel.AddSheetResult because Already inherited */ @JSGlobal("Excel.Worksheet")
@js.native
class Worksheet protected () extends Sheet {
  val Application: typingsSlinky.activexDashExcel.Excel.Application = js.native
  val AutoFilter: typingsSlinky.activexDashExcel.Excel.AutoFilter = js.native
  ...
  val Outline: typingsSlinky.activexDashExcel.Excel.Outline = js.native
  ...
  val Protection: typingsSlinky.activexDashExcel.Excel.Protection = js.native
  ...
  val Sort: typingsSlinky.activexDashExcel.Excel.Sort = js.native
  ...
  def Scenarios(): typingsSlinky.activexDashExcel.Excel.Scenarios = js.native
  def Scenarios(Index: String): Scenario = js.native
  def Scenarios(Index: Double): Scenario = js.native
  def Scenarios(Index: SafeArray[Double | String]): typingsSlinky.activexDashExcel.Excel.Scenarios = js.native
