...
class Axis protected () extends js.Object {
  ...
  val AxisTitle: typingsSlinky.activexDashExcel.Excel.AxisTitle = js.native
  ...
  val DisplayUnitLabel: typingsSlinky.activexDashExcel.Excel.DisplayUnitLabel = js.native
  ...
  val TickLabels: typingsSlinky.activexDashExcel.Excel.TickLabels = js.native
