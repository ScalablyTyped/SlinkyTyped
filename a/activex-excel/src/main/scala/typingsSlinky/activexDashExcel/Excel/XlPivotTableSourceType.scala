...
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4148`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexDashExcel.activexDashExcelNumbers.`-4148`
  - typings.activexDashExcel.activexDashExcelNumbers.`4`
*/
trait XlPivotTableSourceType extends js.Object
