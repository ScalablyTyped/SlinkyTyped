...
trait Range extends js.Object {
  ...
  val Comment: typingsSlinky.activexDashExcel.Excel.Comment = js.native
  ...
  val DisplayFormat: typingsSlinky.activexDashExcel.Excel.DisplayFormat = js.native
  @JSName("EntireColumn")
  ...
  var Name: String | typingsSlinky.activexDashExcel.Excel.Name = js.native
  @JSName("Next")
  ...
  val Phonetic: typingsSlinky.activexDashExcel.Excel.Phonetic = js.native
  @JSName("Phonetics")
  ...
  val SoundNote: typingsSlinky.activexDashExcel.Excel.SoundNote = js.native
  @JSName("SparklineGroups")
  val SparklineGroups_Original: SparklineGroups = js.native
  var Style: typingsSlinky.activexDashExcel.Excel.Style = js.native
  ...
  val Validation: typingsSlinky.activexDashExcel.Excel.Validation = js.native
  ...
  val Worksheet: typingsSlinky.activexDashExcel.Excel.Worksheet = js.native
  ...
  def AddComment(): typingsSlinky.activexDashExcel.Excel.Comment = js.native
  def AddComment(Text: String): typingsSlinky.activexDashExcel.Excel.Comment = js.native
  ...
  def CopyFromRecordset(Data: typingsSlinky.activexDashDao.DAO.Recordset): Double = js.native
  def CopyFromRecordset(Data: typingsSlinky.activexDashDao.DAO.Recordset, MaxRows: Double): Double = js.native
  def CopyFromRecordset(Data: typingsSlinky.activexDashDao.DAO.Recordset, MaxRows: Double, MaxColumns: Double): Double = js.native
  /**
  ...
  def Phonetics(Index: Double): typingsSlinky.activexDashExcel.Excel.Phonetic = js.native
