package typingsSlinky.activexDashExcel.Excel.EventHelperTypes
...
trait Workbook_Invoke_Parameter extends js.Object {
...
object Workbook_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    __obj.asInstanceOf[Workbook_Invoke_Parameter]
  }
}
