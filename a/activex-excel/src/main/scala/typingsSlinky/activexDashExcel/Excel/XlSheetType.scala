...
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4109`
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4116`
import typingsSlinky.activexDashExcel.activexDashExcelNumbers.`-4167`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexDashExcel.activexDashExcelNumbers.`-4116`
