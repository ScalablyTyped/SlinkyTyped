...
*/
trait XlMSApplication extends js.Object

object XlMSApplication {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlMicrosoftAccess: `4` = this.cast(4)
  @scala.inline
  def xlMicrosoftFoxPro: `5` = this.cast(5)
  @scala.inline
  def xlMicrosoftMail: `3` = this.cast(3)
  @scala.inline
  def xlMicrosoftPowerPoint: `2` = this.cast(2)
  @scala.inline
  def xlMicrosoftProject: `6` = this.cast(6)
  @scala.inline
  def xlMicrosoftSchedulePlus: `7` = this.cast(7)
  @scala.inline
  def xlMicrosoftWord: `1` = this.cast(1)
}
