...
trait PivotTable extends js.Object {
  ...
  def CalculatedFields(): typingsSlinky.activexExcel.Excel.CalculatedFields = js.native
  ...
  def PivotCache(): typingsSlinky.activexExcel.Excel.PivotCache = js.native
  def PivotFields(Indexes: SafeArray[Double | String]): typingsSlinky.activexExcel.Excel.PivotFields = js.native
