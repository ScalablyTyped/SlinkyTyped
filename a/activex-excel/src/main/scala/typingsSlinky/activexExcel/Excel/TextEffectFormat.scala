...
object TextEffectFormat {
  ...
  implicit class TextEffectFormatOps[Self <: TextEffectFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcelDotTextEffectFormat_typekey(value: TextEffectFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Excel.TextEffectFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
