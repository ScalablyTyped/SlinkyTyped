...
trait Worksheet extends Sheet {
  ...
  val Outline: typingsSlinky.activexExcel.Excel.Outline = js.native
  ...
  def Scenarios(): typingsSlinky.activexExcel.Excel.Scenarios = js.native
  def Scenarios(Index: String): Scenario = js.native
  def Scenarios(Index: Double): Scenario = js.native
  def Scenarios(Index: SafeArray[Double | String]): typingsSlinky.activexExcel.Excel.Scenarios = js.native
