package typingsSlinky.activexExcel.Excel.EventHelperTypes
...
@js.native
trait OLEObjectInvokeParameter extends js.Object {
...
object OLEObjectInvokeParameter {
  ...
  @scala.inline
  implicit class OLEObjectInvokeParameterOps[Self <: OLEObjectInvokeParameter] (val x: Self) extends AnyVal {
