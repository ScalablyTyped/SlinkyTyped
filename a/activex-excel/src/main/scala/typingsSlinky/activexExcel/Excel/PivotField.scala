...
class PivotField protected () extends js.Object {
  ...
  val CubeField: typingsSlinky.activexExcel.Excel.CubeField = js.native
  ...
  def CalculatedItems(): typingsSlinky.activexExcel.Excel.CalculatedItems = js.native
  ...
  def PivotItems(Indexes: SafeArray[Double | String]): typingsSlinky.activexExcel.Excel.PivotItems = js.native
