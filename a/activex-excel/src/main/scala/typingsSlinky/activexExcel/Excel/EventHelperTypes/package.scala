...
package object EventHelperTypes {
  ...
  type ApplicationInvokeArgNames = js.Tuple8[
    ...
    typingsSlinky.activexExcel.activexExcelStrings.lcid, 
    typingsSlinky.activexExcel.activexExcelStrings.wFlags, 
    typingsSlinky.activexExcel.activexExcelStrings.pdispparams, 
    typingsSlinky.activexExcel.activexExcelStrings.pvarResult, 
