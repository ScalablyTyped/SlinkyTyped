...
*/
trait XlUpdateLinks extends StObject
object XlUpdateLinks {
  
  @scala.inline
  def xlUpdateLinksAlways: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlUpdateLinksNever: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlUpdateLinksUserSetting: `1` = 1.asInstanceOf[`1`]
}
