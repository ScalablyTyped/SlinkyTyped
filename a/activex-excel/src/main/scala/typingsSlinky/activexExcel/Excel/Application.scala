...
class Application protected () extends js.Object {
  ...
  val AutoCorrect: typingsSlinky.activexExcel.Excel.AutoCorrect = js.native
  var AutoFormatAsYouTypeReplaceHyperlinks: Boolean = js.native
  var AutoPercentEntry: Boolean = js.native
  val AutoRecover: typingsSlinky.activexExcel.Excel.AutoRecover = js.native
  ...
  val DefaultWebOptions: typingsSlinky.activexExcel.Excel.DefaultWebOptions = js.native
  ...
  val ErrorCheckingOptions: typingsSlinky.activexExcel.Excel.ErrorCheckingOptions = js.native
  ...
  var ExcelDotApplication_typekey: typingsSlinky.activexExcel.Excel.Application = js.native
  ...
  val MultiThreadedCalculation: typingsSlinky.activexExcel.Excel.MultiThreadedCalculation = js.native
  ...
  val Parent: typingsSlinky.activexExcel.Excel.Application = js.native
  ...
  val RTD: typingsSlinky.activexExcel.Excel.RTD = js.native
  ...
  val Speech: typingsSlinky.activexExcel.Excel.Speech = js.native
  val SpellingOptions: typingsSlinky.activexExcel.Excel.SpellingOptions = js.native
  ...
  val WorksheetFunction: typingsSlinky.activexExcel.Excel.WorksheetFunction = js.native
  @JSName("Worksheets")
