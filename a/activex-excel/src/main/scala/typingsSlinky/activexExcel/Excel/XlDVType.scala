...
*/
trait XlDVType extends StObject
object XlDVType {
  
  @scala.inline
  def xlValidateCustom: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def xlValidateDate: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def xlValidateDecimal: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlValidateInputOnly: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def xlValidateList: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlValidateTextLength: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def xlValidateTime: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def xlValidateWholeNumber: `1` = 1.asInstanceOf[`1`]
}
