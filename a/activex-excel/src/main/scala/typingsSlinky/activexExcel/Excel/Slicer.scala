...
trait Slicer extends js.Object {
  ...
  val Shape: typingsSlinky.activexExcel.Excel.Shape
  val SlicerCache: typingsSlinky.activexExcel.Excel.SlicerCache
  val SlicerCacheLevel: typingsSlinky.activexExcel.Excel.SlicerCacheLevel
  var Style: js.Any
  var Top: Double
  var Width: Double
  def Copy(): Unit
