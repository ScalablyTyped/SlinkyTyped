...
trait Axis extends js.Object {
  ...
  val AxisTitle: typingsSlinky.activexExcel.Excel.AxisTitle
  ...
  val DisplayUnitLabel: typingsSlinky.activexExcel.Excel.DisplayUnitLabel
  ...
  val TickLabels: typingsSlinky.activexExcel.Excel.TickLabels
