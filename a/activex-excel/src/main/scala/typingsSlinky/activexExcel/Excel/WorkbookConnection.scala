...
trait WorkbookConnection extends StObject {
  ...
  val ODBCConnection: typingsSlinky.activexExcel.Excel.ODBCConnection = js.native
  
  val OLEDBConnection: typingsSlinky.activexExcel.Excel.OLEDBConnection = js.native
