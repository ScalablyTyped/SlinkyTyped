...
*/
trait XlWebFormatting extends js.Object

object XlWebFormatting {
  @scala.inline
  def xlWebFormattingAll: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def xlWebFormattingNone: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def xlWebFormattingRTF: `2` = 2.asInstanceOf[`2`]
}
