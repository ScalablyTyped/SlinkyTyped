...
object ColorFormat {
  ...
  implicit class ColorFormatOps[Self <: ColorFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcelDotColorFormat_typekey(value: ColorFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Excel.ColorFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
