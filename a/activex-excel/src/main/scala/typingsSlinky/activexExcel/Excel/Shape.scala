...
class Shape protected () extends js.Object {
  ...
  val ControlFormat: typingsSlinky.activexExcel.Excel.ControlFormat = js.native
  ...
  val Hyperlink: typingsSlinky.activexExcel.Excel.Hyperlink = js.native
  val ID: Double = js.native
  var Left: Double = js.native
  val Line: LineFormat = js.native
  val LinkFormat: typingsSlinky.activexExcel.Excel.LinkFormat = js.native
  var LockAspectRatio: MsoTriState = js.native
  var Locked: Boolean = js.native
  var Name: String = js.native
  @JSName("Nodes")
  val Nodes_Original: ShapeNodes = js.native
  val OLEFormat: typingsSlinky.activexExcel.Excel.OLEFormat = js.native
