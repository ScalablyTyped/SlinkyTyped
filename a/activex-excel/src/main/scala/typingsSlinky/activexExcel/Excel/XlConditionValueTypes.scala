...
object XlConditionValueTypes {
  ...
  @scala.inline
  def xlConditionValueAutomaticMax: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def xlConditionValueAutomaticMin: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def xlConditionValueFormula: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def xlConditionValueHighestValue: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlConditionValueLowestValue: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def xlConditionValueNone: `-1` = -1.asInstanceOf[`-1`]
  
  @scala.inline
  def xlConditionValueNumber: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def xlConditionValuePercent: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlConditionValuePercentile: `5` = 5.asInstanceOf[`5`]
}
