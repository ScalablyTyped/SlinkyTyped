...
*/
trait XlArabicModes extends StObject
object XlArabicModes {
  
  @scala.inline
  def xlArabicBothStrict: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlArabicNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def xlArabicStrictAlefHamza: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def xlArabicStrictFinalYaa: `2` = 2.asInstanceOf[`2`]
}
