...
*/
trait XlSparklineRowCol extends StObject
object XlSparklineRowCol {
  
  @scala.inline
  def xlSparklineColumnsSquare: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlSparklineNonSquare: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def xlSparklineRowsSquare: `1` = 1.asInstanceOf[`1`]
}
