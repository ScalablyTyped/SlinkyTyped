...
*/
trait XlDVAlertStyle extends js.Object

object XlDVAlertStyle {
  @scala.inline
  def xlValidAlertInformation: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def xlValidAlertStop: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def xlValidAlertWarning: `2` = 2.asInstanceOf[`2`]
}
