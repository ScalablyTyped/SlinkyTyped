...
object CalloutFormat {
  ...
  implicit class CalloutFormatOps[Self <: CalloutFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcelDotCalloutFormat_typekey(value: CalloutFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Excel.CalloutFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
