...
object ShadowFormat {
  ...
  implicit class ShadowFormatOps[Self <: ShadowFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExcelDotShadowFormat_typekey(value: ShadowFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Excel.ShadowFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
