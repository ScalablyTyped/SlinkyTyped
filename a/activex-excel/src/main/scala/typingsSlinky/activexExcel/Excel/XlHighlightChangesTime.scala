...
*/
trait XlHighlightChangesTime extends js.Object

object XlHighlightChangesTime {
  @scala.inline
  def xlAllChanges: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def xlNotYetReviewed: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def xlSinceMyLastSave: `1` = 1.asInstanceOf[`1`]
}
