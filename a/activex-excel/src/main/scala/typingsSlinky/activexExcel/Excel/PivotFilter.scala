...
trait PivotFilter extends js.Object {
  ...
  val DataField: typingsSlinky.activexExcel.Excel.PivotField
  ...
  val MemberPropertyField: typingsSlinky.activexExcel.Excel.PivotField
  val Name: String
  var Order: Double
  val Parent: js.Any
  val PivotField: typingsSlinky.activexExcel.Excel.PivotField
  val Value1: js.Any
  val Value2: js.Any
  def Delete(): Unit
}
