...
import typingsSlinky.activexExcel.Excel.XlChartPictureType
...
class Walls protected ()
  extends typingsSlinky.activexExcel.Excel.Walls {
  /* CompleteClass */
  ...
  override var ExcelDotWalls_typekey: typingsSlinky.activexExcel.Excel.Walls = js.native
  /* CompleteClass */
