...
import typingsSlinky.activexExcel.Excel.XlActionType
...
class Action protected ()
  extends typingsSlinky.activexExcel.Excel.Action {
  /* CompleteClass */
  ...
  override var ExcelDotAction_typekey: typingsSlinky.activexExcel.Excel.Action = js.native
  /* CompleteClass */
