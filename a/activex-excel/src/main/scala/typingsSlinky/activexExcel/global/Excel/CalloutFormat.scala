...
class CalloutFormat protected ()
  extends typingsSlinky.activexExcel.Excel.CalloutFormat {
  /* CompleteClass */
  ...
  override var ExcelDotCalloutFormat_typekey: typingsSlinky.activexExcel.Excel.CalloutFormat = js.native
  /* CompleteClass */
