...
class ThreeDFormat protected ()
  extends typingsSlinky.activexExcel.Excel.ThreeDFormat {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ContourColor: typingsSlinky.activexExcel.Excel.ColorFormat = js.native
  /* CompleteClass */
  ...
  override var ExcelDotThreeDFormat_typekey: typingsSlinky.activexExcel.Excel.ThreeDFormat = js.native
  /* CompleteClass */
  override val ExtrusionColor: typingsSlinky.activexExcel.Excel.ColorFormat = js.native
  /* CompleteClass */
