...
class TextFrame2 protected ()
  extends typingsSlinky.activexExcel.Excel.TextFrame2 {
  /* CompleteClass */
  ...
  override var ExcelDotTextFrame2_typekey: typingsSlinky.activexExcel.Excel.TextFrame2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ThreeD: typingsSlinky.activexExcel.Excel.ThreeDFormat = js.native
  /* CompleteClass */
