...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.arcgisRestApi.arcgisRestApiStrings.esriSLSDashDot
  - typingsSlinky.arcgisRestApi.arcgisRestApiStrings.esriSLSDashDotDot
  - typingsSlinky.arcgisRestApi.arcgisRestApiStrings.esriSLSDot
  - typingsSlinky.arcgisRestApi.arcgisRestApiStrings.esriSLSNull
