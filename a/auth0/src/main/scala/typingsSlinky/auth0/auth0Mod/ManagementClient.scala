...
class ManagementClient[A, U] protected () extends js.Object {
  ...
  def blacklistToken(token: Token, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  def configureEmailProvider(data: Data): js.Promise[_] = js.native
  def configureEmailProvider(data: Data, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def deleteAllUsers(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def deleteEmailProvider(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def getActiveUsersCount(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  @JSName("getActiveUsersCount")
  def getActiveUsersCount_Unit(): Unit = js.native
  // Tokens
  def getBlacklistedTokens(): js.Promise[_] = js.native
  def getBlacklistedTokens(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def getDeviceCredentials(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  // Providers
  def getEmailProvider(): js.Promise[_] = js.native
  def getEmailProvider(cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  @JSName("getEmailProvider")
  def getEmailProvider_Unit(): Unit = js.native
  def getEmailTemplate(data: Data): js.Promise[_] = js.native
  def getEmailTemplate(data: Data, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def getLog(params: ObjectWithId, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  @JSName("getLog")
  ...
  def updateEmailProvider(params: js.Object, data: Data, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def updateEmailTemplate(params: js.Object, data: Data, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
  ...
  def updateTenantSettings(data: Data, cb: js.Function2[/* err */ js.Error, /* data */ js.Any, Unit]): Unit = js.native
