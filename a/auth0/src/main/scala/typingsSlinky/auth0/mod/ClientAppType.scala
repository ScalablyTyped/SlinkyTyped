...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.auth0.auth0Strings.native
  - typingsSlinky.auth0.auth0Strings.spa
  - typingsSlinky.auth0.auth0Strings.regular_web
  - typingsSlinky.auth0.auth0Strings.non_interactive
  - typingsSlinky.auth0.auth0Strings.rms
  - typingsSlinky.auth0.auth0Strings.box
  - typingsSlinky.auth0.auth0Strings.cloudbees
  - typingsSlinky.auth0.auth0Strings.concur
  - typingsSlinky.auth0.auth0Strings.dropbox
  - typingsSlinky.auth0.auth0Strings.mscrm
  - typingsSlinky.auth0.auth0Strings.echosign
  - typingsSlinky.auth0.auth0Strings.egnyte
  - typingsSlinky.auth0.auth0Strings.newrelic
  - typingsSlinky.auth0.auth0Strings.office365
  - typingsSlinky.auth0.auth0Strings.salesforce
  - typingsSlinky.auth0.auth0Strings.sentry
  - typingsSlinky.auth0.auth0Strings.sharepoint
  - typingsSlinky.auth0.auth0Strings.slack
  - typingsSlinky.auth0.auth0Strings.springcm
  - typingsSlinky.auth0.auth0Strings.zendesk
  - typingsSlinky.auth0.auth0Strings.zoom
*/
