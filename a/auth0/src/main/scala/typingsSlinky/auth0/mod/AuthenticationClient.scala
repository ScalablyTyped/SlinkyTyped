...
class AuthenticationClient protected () extends js.Object {
  ...
  def clientCredentialsGrant(
    ...
    cb: js.Function2[/* err */ js.Error, /* response */ js.Any, Unit]
  ): Unit = js.native
  ...
  def passwordGrant(options: PasswordGrantOptions, cb: js.Function2[/* err */ js.Error, /* response */ js.Any, Unit]): Unit = js.native
  ...
  def verifyEmailCode(data: VerifyOptions, cb: js.Function2[/* err */ js.Error, /* message */ String, Unit]): Unit = js.native
  def verifySMSCode(data: VerifyOptions): js.Promise[_] = js.native
  def verifySMSCode(data: VerifyOptions, cb: js.Function2[/* err */ js.Error, /* message */ String, Unit]): Unit = js.native
}
