...
import typingsSlinky.anyDashPromise.anyDashPromiseMod.Promise
import typingsSlinky.anyDashPromise.anyDashPromiseMod.Thenable
import typingsSlinky.anyDashPromise.anyDashPromiseMod.^
