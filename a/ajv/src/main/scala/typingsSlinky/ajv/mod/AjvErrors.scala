...
object AjvErrors {
  ...
  object MissingRefError {
    ...
    @scala.inline
    def apply(message: String, missingRef: String, missingSchema: String, name: String): typingsSlinky.ajv.mod.AjvErrors.MissingRefError = {
      ...
      __obj.asInstanceOf[typingsSlinky.ajv.mod.AjvErrors.MissingRefError]
    }
    
    @scala.inline
    implicit class MissingRefErrorMutableBuilder[Self <: typingsSlinky.ajv.mod.AjvErrors.MissingRefError] (val x: Self) extends AnyVal {
  ...
  object ValidationError {
    ...
    @scala.inline
    def apply(ajv: `true`, errors: js.Array[ErrorObject], message: String, name: String, validation: `true`): typingsSlinky.ajv.mod.AjvErrors.ValidationError = {
      ...
      __obj.asInstanceOf[typingsSlinky.ajv.mod.AjvErrors.ValidationError]
    }
    
    @scala.inline
    implicit class ValidationErrorMutableBuilder[Self <: typingsSlinky.ajv.mod.AjvErrors.ValidationError] (val x: Self) extends AnyVal {
