...
object MissingRefError {
  ...
  implicit class MissingRefErrorOps[Self <: MissingRefError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMissingRef(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("missingRef")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMissingSchema(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("missingSchema")(value.asInstanceOf[js.Any])
        ret
    }
  }
