...
trait OldContentControl extends StObject {
  ...
  val OldContentControl: typingsSlinky.activexWord.Word.ContentControl = js.native
}
object OldContentControl {
  
  @scala.inline
  def apply(InUndoRedo: Boolean, OldContentControl: typingsSlinky.activexWord.Word.ContentControl): OldContentControl = {
  ...
  implicit class OldContentControlMutableBuilder[Self <: OldContentControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOldContentControl(value: typingsSlinky.activexWord.Word.ContentControl): Self = StObject.set(x, "OldContentControl", value.asInstanceOf[js.Any])
  }
}
