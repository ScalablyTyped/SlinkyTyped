...
@js.native
trait SyncEventTypeMsoSyncEventType extends js.Object {
...
object SyncEventTypeMsoSyncEventType {
  ...
  @scala.inline
  implicit class SyncEventTypeMsoSyncEventTypeOps[Self <: SyncEventTypeMsoSyncEventType] (val x: Self) extends AnyVal {
    @scala.inline
