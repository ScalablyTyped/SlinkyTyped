...
class OLEControl protected ()
  extends typingsSlinky.activexWord.Word.OLEControl {
  /* CompleteClass */
  override var AltHTML: String = js.native
  /* CompleteClass */
  ...
  override var WordDotOLEControl_typekey: typingsSlinky.activexWord.Word.OLEControl = js.native
  /* CompleteClass */
