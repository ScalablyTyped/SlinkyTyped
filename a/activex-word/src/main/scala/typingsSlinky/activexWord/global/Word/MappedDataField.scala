...
class MappedDataField protected ()
  extends typingsSlinky.activexWord.Word.MappedDataField {
  /* CompleteClass */
  override val Application: typingsSlinky.activexWord.Word.Application = js.native
  /* CompleteClass */
  override val Creator: Double = js.native
  /* CompleteClass */
  override var DataFieldIndex: Double = js.native
  /* CompleteClass */
  ...
  override var WordDotMappedDataField_typekey: typingsSlinky.activexWord.Word.MappedDataField = js.native
}
