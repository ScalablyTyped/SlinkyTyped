...
class LineFormat protected ()
  ...
  /* CompleteClass */
  override val BackColor: typingsSlinky.activexWord.Word.ColorFormat = js.native
  /* CompleteClass */
  ...
  override var WordDotLineFormat_typekey: typingsSlinky.activexWord.Word.LineFormat = js.native
}
