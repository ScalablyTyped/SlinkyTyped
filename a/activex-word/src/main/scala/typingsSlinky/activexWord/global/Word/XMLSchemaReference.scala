...
class XMLSchemaReference protected ()
  extends typingsSlinky.activexWord.Word.XMLSchemaReference {
  /* CompleteClass */
  ...
  override var WordDotXMLSchemaReference_typekey: typingsSlinky.activexWord.Word.XMLSchemaReference = js.native
  /* CompleteClass */
