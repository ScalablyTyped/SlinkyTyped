...
class Bookmark protected ()
  extends typingsSlinky.activexWord.Word.Bookmark {
  /* CompleteClass */
  ...
  override var WordDotBookmark_typekey: typingsSlinky.activexWord.Word.Bookmark = js.native
  /* CompleteClass */
  override def Copy(Name: String): typingsSlinky.activexWord.Word.Bookmark = js.native
  /* CompleteClass */
