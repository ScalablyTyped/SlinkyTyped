...
class SmartTagRecognizer protected ()
  extends typingsSlinky.activexWord.Word.SmartTagRecognizer {
  /* CompleteClass */
  ...
  override var WordDotSmartTagRecognizer_typekey: typingsSlinky.activexWord.Word.SmartTagRecognizer = js.native
}
