...
class FootnoteOptions protected ()
  extends typingsSlinky.activexWord.Word.FootnoteOptions {
  /* CompleteClass */
  ...
  override var WordDotFootnoteOptions_typekey: typingsSlinky.activexWord.Word.FootnoteOptions = js.native
}
