...
class FirstLetterException protected ()
  extends typingsSlinky.activexWord.Word.FirstLetterException {
  /* CompleteClass */
  ...
  override var WordDotFirstLetterException_typekey: typingsSlinky.activexWord.Word.FirstLetterException = js.native
  /* CompleteClass */
