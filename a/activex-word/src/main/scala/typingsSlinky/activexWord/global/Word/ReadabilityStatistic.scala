...
class ReadabilityStatistic protected ()
  extends typingsSlinky.activexWord.Word.ReadabilityStatistic {
  /* CompleteClass */
  ...
  override var WordDotReadabilityStatistic_typekey: typingsSlinky.activexWord.Word.ReadabilityStatistic = js.native
}
