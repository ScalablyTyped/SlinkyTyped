...
class AutoCaptions protected ()
  extends typingsSlinky.activexWord.Word.AutoCaptions {
  /* CompleteClass */
  ...
  override var WordDotAutoCaptions_typekey: typingsSlinky.activexWord.Word.AutoCaptions = js.native
  /* CompleteClass */
  override def CancelAutoInsert(): Unit = js.native
  /* CompleteClass */
  override def Item(Index: js.Any): typingsSlinky.activexWord.Word.AutoCaption = js.native
}
