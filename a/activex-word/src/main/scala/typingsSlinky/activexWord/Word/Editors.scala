...
object Editors {
  ...
  implicit class EditorsOps[Self <: Editors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: js.Any => Editor): Self = {
    ...
    @scala.inline
    def withItem(value: js.Any => Editor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotEditors_typekey(value: Editors): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Editors_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
