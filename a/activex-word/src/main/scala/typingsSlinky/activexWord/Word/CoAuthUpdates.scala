...
object CoAuthUpdates {
  ...
  implicit class CoAuthUpdatesOps[Self <: CoAuthUpdates] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => CoAuthUpdate): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotCoAuthUpdates_typekey(value: CoAuthUpdates): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.CoAuthUpdates_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
