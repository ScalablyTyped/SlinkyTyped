...
object FileConverter {
  ...
  implicit class FileConverterOps[Self <: FileConverter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotFileConverter_typekey(value: FileConverter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.FileConverter_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
