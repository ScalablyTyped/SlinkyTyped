...
object ChartColorFormat {
  ...
  implicit class ChartColorFormatOps[Self <: ChartColorFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotChartColorFormat_typekey(value: ChartColorFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.ChartColorFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
