...
object EmailSignatureEntry {
  ...
  @scala.inline
  implicit class EmailSignatureEntryOps[Self <: EmailSignatureEntry] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withWordDotEmailSignatureEntry_typekey(value: EmailSignatureEntry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.EmailSignatureEntry_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
