...
object WdXMLNodeLevel {
  ...
  @scala.inline
  def wdXMLNodeLevelCell: `3` = this.cast(3)
  @scala.inline
  def wdXMLNodeLevelInline: `0` = this.cast(0)
  @scala.inline
  def wdXMLNodeLevelParagraph: `1` = this.cast(1)
  @scala.inline
  def wdXMLNodeLevelRow: `2` = this.cast(2)
}
