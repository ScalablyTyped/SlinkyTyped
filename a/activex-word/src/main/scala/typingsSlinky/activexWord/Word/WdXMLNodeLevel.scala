...
*/
trait WdXMLNodeLevel extends StObject
object WdXMLNodeLevel {
  
  @scala.inline
  def wdXMLNodeLevelCell: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def wdXMLNodeLevelInline: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def wdXMLNodeLevelParagraph: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def wdXMLNodeLevelRow: `2` = 2.asInstanceOf[`2`]
}
