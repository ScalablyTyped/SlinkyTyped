...
object Languages {
  ...
  implicit class LanguagesOps[Self <: Languages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Language): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotLanguages_typekey(value: Languages): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Languages_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
