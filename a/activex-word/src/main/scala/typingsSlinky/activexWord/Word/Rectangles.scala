...
object Rectangles {
  ...
  implicit class RectanglesOps[Self <: Rectangles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => Rectangle): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotRectangles_typekey(value: Rectangles): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Rectangles_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
