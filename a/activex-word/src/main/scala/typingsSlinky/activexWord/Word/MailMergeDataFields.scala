...
object MailMergeDataFields {
  ...
  implicit class MailMergeDataFieldsOps[Self <: MailMergeDataFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => MailMergeDataField): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotMailMergeDataFields_typekey(value: MailMergeDataFields): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.MailMergeDataFields_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
