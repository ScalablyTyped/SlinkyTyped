...
object MappedDataFields {
  ...
  implicit class MappedDataFieldsOps[Self <: MappedDataFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: WdMappedDataFields => MappedDataField): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotMappedDataFields_typekey(value: MappedDataFields): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.MappedDataFields_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
