...
object HeadingStyles {
  ...
  implicit class HeadingStylesOps[Self <: HeadingStyles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: (js.Any, Double) => HeadingStyle): Self = {
    ...
    @scala.inline
    def withItem(value: Double => HeadingStyle): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotHeadingStyles_typekey(value: HeadingStyles): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.HeadingStyles_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
