...
object ListLevels {
  ...
  implicit class ListLevelsOps[Self <: ListLevels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => ListLevel): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotListLevels_typekey(value: ListLevels): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.ListLevels_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
