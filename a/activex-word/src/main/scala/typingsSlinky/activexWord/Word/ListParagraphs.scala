...
object ListParagraphs {
  ...
  implicit class ListParagraphsOps[Self <: ListParagraphs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => Paragraph): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotListParagraphs_typekey(value: ListParagraphs): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.ListParagraphs_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
