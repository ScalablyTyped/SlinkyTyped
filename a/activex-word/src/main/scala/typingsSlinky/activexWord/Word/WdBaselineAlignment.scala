...
*/
trait WdBaselineAlignment extends js.Object

object WdBaselineAlignment {
  @scala.inline
  def wdBaselineAlignAuto: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def wdBaselineAlignBaseline: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def wdBaselineAlignCenter: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def wdBaselineAlignFarEast50: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def wdBaselineAlignTop: `0` = 0.asInstanceOf[`0`]
}
