...
trait Pane extends js.Object {
  ...
  val Pages: typingsSlinky.activexWord.Word.Pages = js.native
  ...
  val View: typingsSlinky.activexWord.Word.View = js.native
  
  @JSName("Word.Pane_typekey")
  var WordDotPane_typekey: Pane = js.native
  
  val Zooms: typingsSlinky.activexWord.Word.Zooms = js.native
}
