...
object MailMergeFieldNames {
  ...
  implicit class MailMergeFieldNamesOps[Self <: MailMergeFieldNames] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => MailMergeFieldName): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotMailMergeFieldNames_typekey(value: MailMergeFieldNames): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.MailMergeFieldNames_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
