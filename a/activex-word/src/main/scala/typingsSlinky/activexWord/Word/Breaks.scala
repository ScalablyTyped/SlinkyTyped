...
object Breaks {
  ...
  implicit class BreaksOps[Self <: Breaks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => Break): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotBreaks_typekey(value: Breaks): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Breaks_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
