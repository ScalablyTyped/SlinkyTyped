...
object Breaks {
  ...
  implicit class BreaksOps[Self <: Breaks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => Break): Self = this.set("Item", js.Any.fromFunction1(value))
    
    @scala.inline
    def setParent(value: js.Any): Self = this.set("Parent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordDotBreaks_typekey(value: Breaks): Self = this.set("Word.Breaks_typekey", value.asInstanceOf[js.Any])
  }
}
