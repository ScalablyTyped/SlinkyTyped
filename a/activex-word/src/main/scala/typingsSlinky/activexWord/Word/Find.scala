...
trait Find[TParent] extends js.Object {
  ...
  var Forward: Boolean
  val Found: Boolean
  val Frame: typingsSlinky.activexWord.Word.Frame
  ...
  var ParagraphFormat: typingsSlinky.activexWord.Word.ParagraphFormat
  val Parent: TParent
  val Replacement: typingsSlinky.activexWord.Word.Replacement
  var Style: js.Any
  var Text: String
