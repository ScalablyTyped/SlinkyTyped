...
trait ChartGroup extends js.Object {
  ...
  val DownBars: typingsSlinky.activexWord.Word.DownBars = js.native
  
  val DropLines: typingsSlinky.activexWord.Word.DropLines = js.native
  ...
  val HiLoLines: typingsSlinky.activexWord.Word.HiLoLines = js.native
  ...
  val SeriesLines: typingsSlinky.activexWord.Word.SeriesLines = js.native
  ...
  val UpBars: typingsSlinky.activexWord.Word.UpBars = js.native
