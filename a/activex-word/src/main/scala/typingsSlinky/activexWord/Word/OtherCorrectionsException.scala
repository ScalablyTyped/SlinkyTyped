...
object OtherCorrectionsException {
  ...
  implicit class OtherCorrectionsExceptionOps[Self <: OtherCorrectionsException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotOtherCorrectionsException_typekey(value: OtherCorrectionsException): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.OtherCorrectionsException_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
