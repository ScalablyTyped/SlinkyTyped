...
object ThreeDFormat {
  ...
  def apply(
    ...
    Visible: MsoTriState,
    WordDotThreeDFormat_typekey: ThreeDFormat,
    Z: Double
  ): ThreeDFormat = {
    ...
    __obj.updateDynamic("Word.ThreeDFormat_typekey")(WordDotThreeDFormat_typekey.asInstanceOf[js.Any])
  ...
  implicit class ThreeDFormatOps[Self <: ThreeDFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotThreeDFormat_typekey(value: ThreeDFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.ThreeDFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
