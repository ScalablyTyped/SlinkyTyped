...
object TablesOfAuthoritiesCategories {
  ...
  implicit class TablesOfAuthoritiesCategoriesOps[Self <: TablesOfAuthoritiesCategories] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => TableOfAuthoritiesCategory): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotTablesOfAuthoritiesCategories_typekey(value: TablesOfAuthoritiesCategories): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.TablesOfAuthoritiesCategories_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
