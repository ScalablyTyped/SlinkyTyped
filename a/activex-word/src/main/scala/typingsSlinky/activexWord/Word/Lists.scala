...
object Lists {
  ...
  implicit class ListsOps[Self <: Lists] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => List): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotLists_typekey(value: Lists): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Lists_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
