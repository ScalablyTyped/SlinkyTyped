...
object Categories {
  ...
  implicit class CategoriesOps[Self <: Categories] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Category): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotCategories_typekey(value: Categories): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Categories_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
