...
object TextEffectFormat {
  ...
  implicit class TextEffectFormatOps[Self <: TextEffectFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotTextEffectFormat_typekey(value: TextEffectFormat): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.TextEffectFormat_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
