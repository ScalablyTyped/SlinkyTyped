...
object OMathRecognizedFunction {
  ...
  implicit class OMathRecognizedFunctionOps[Self <: OMathRecognizedFunction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWordDotOMathRecognizedFunction_typekey(value: OMathRecognizedFunction): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.OMathRecognizedFunction_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
