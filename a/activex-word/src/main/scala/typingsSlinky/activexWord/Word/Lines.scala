...
object Lines {
  ...
  implicit class LinesOps[Self <: Lines] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: Double => Line): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotLines_typekey(value: Lines): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Lines_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
