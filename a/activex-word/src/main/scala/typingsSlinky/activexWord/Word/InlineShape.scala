...
trait InlineShape extends js.Object {
  ...
  val Chart: typingsSlinky.activexWord.Word.Chart
  val Creator: Double
  val EditID: Double
  val Field: typingsSlinky.activexWord.Word.Field
  val Fill: FillFormat
  val Glow: GlowFormat
  ...
  var Height: Double
  val HorizontalLineFormat: typingsSlinky.activexWord.Word.HorizontalLineFormat
  val Hyperlink: typingsSlinky.activexWord.Word.Hyperlink
  ...
  val Parent: js.Any
  var PictureFormat: typingsSlinky.activexWord.Word.PictureFormat
  val Range: typingsSlinky.activexWord.Word.Range
  val Reflection: ReflectionFormat
  var ScaleHeight: Double
  var ScaleWidth: Double
  val Script: typingsSlinky.activexOffice.Office.Script
  val Shadow: ShadowFormat
  val SmartArt: typingsSlinky.activexOffice.Office.SmartArt
