...
object TaskPanes {
  ...
  implicit class TaskPanesOps[Self <: TaskPanes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: WdTaskPanes => TaskPane): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotTaskPanes_typekey(value: TaskPanes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.TaskPanes_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
