...
trait FormField extends js.Object {
  ...
  val CheckBox: typingsSlinky.activexWord.Word.CheckBox
  val Creator: Double
  val DropDown: typingsSlinky.activexWord.Word.DropDown
  var Enabled: Boolean
  ...
  val TextInput: typingsSlinky.activexWord.Word.TextInput
