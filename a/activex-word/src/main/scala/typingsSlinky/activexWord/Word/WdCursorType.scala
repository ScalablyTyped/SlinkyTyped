...
object WdCursorType {
  @scala.inline
  def wdCursorIBeam: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def wdCursorNormal: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def wdCursorNorthwestArrow: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def wdCursorWait: `0` = 0.asInstanceOf[`0`]
}
