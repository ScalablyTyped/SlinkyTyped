...
object Reviewers {
  ...
  implicit class ReviewersOps[Self <: Reviewers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Reviewer): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withWordDotReviewers_typekey(value: Reviewers): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Reviewers_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
