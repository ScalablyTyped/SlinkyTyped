...
object Shading {
  ...
  implicit class ShadingOps[Self <: Shading] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBackgroundPatternColor(value: WdColor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BackgroundPatternColor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBackgroundPatternColorIndex(value: WdColorIndex): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BackgroundPatternColorIndex")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withForegroundPatternColor(value: WdColor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ForegroundPatternColor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withForegroundPatternColorIndex(value: WdColorIndex): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ForegroundPatternColorIndex")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTexture(value: WdTextureIndex): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Texture")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWordDotShading_typekey(value: Shading): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Word.Shading_typekey")(value.asInstanceOf[js.Any])
        ret
    }
  }
