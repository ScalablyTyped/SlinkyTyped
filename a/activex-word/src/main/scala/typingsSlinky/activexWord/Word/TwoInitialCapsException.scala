...
@js.native
trait TwoInitialCapsException extends js.Object {
...
object TwoInitialCapsException {
  ...
  @scala.inline
  implicit class TwoInitialCapsExceptionOps[Self <: TwoInitialCapsException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordDotTwoInitialCapsException_typekey(value: TwoInitialCapsException): Self = this.set("Word.TwoInitialCapsException_typekey", value.asInstanceOf[js.Any])
  }
}
