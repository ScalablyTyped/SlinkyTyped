...
object TwoInitialCapsException {
  ...
  @scala.inline
  implicit class TwoInitialCapsExceptionMutableBuilder[Self <: TwoInitialCapsException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordDotTwoInitialCapsException_typekey(value: TwoInitialCapsException): Self = StObject.set(x, "Word.TwoInitialCapsException_typekey", value.asInstanceOf[js.Any])
  }
}
