package typingsSlinky.activexDashWord.Word.EventHelperTypes
...
trait Application_Invoke_Parameter extends js.Object {
...
object Application_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    __obj.asInstanceOf[Application_Invoke_Parameter]
  }
}
