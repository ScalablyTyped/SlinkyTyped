...
import typingsSlinky.activexDashWord.SafeArray
...
class Application protected () extends js.Object {
  ...
  val Browser: typingsSlinky.activexDashWord.Word.Browser = js.native
  ...
  val EmailOptions: typingsSlinky.activexDashWord.Word.EmailOptions = js.native
  ...
  val MailMessage: typingsSlinky.activexDashWord.Word.MailMessage = js.native
  val MailSystem: WdMailSystem = js.native
  val MailingLabel: typingsSlinky.activexDashWord.Word.MailingLabel = js.native
  ...
  val OMathAutoCorrect: typingsSlinky.activexDashWord.Word.OMathAutoCorrect = js.native
  ...
  val PickerDialog: typingsSlinky.activexDashOffice.Office.PickerDialog = js.native
  ...
  val SmartTagTypes: typingsSlinky.activexDashWord.Word.SmartTagTypes = js.native
  ...
  val TaskPanes: typingsSlinky.activexDashWord.Word.TaskPanes = js.native
  ...
  val UndoRecord: typingsSlinky.activexDashWord.Word.UndoRecord = js.native
  ...
  var WordDotApplication_typekey: typingsSlinky.activexDashWord.Word.Application = js.native
  val XMLNamespaces: typingsSlinky.activexDashWord.Word.XMLNamespaces = js.native
  ...
  def DefaultWebOptions(): typingsSlinky.activexDashWord.Word.DefaultWebOptions = js.native
