...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typingsSlinky.activexDashWord.Word.DownBars = js.native
  val DropLines: typingsSlinky.activexDashWord.Word.DropLines = js.native
  ...
  val HiLoLines: typingsSlinky.activexDashWord.Word.HiLoLines = js.native
  val Index: Double = js.native
  var Overlap: Double = js.native
  val Parent: js.Any = js.native
  val RadarAxisLabels: TickLabels = js.native
  var SecondPlotSize: Double = js.native
  val SeriesLines: typingsSlinky.activexDashWord.Word.SeriesLines = js.native
  ...
  val UpBars: typingsSlinky.activexDashWord.Word.UpBars = js.native
