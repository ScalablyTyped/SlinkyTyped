...
class InlineShape protected () extends js.Object {
  ...
  val Field: typingsSlinky.activexDashWord.Word.Field = js.native
  ...
  val HorizontalLineFormat: typingsSlinky.activexDashWord.Word.HorizontalLineFormat = js.native
  ...
  var PictureFormat: typingsSlinky.activexDashWord.Word.PictureFormat = js.native
