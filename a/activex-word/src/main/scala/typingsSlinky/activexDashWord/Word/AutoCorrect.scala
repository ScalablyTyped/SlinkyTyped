...
class AutoCorrect protected () extends js.Object {
  ...
  val FirstLetterExceptions: typingsSlinky.activexDashWord.Word.FirstLetterExceptions = js.native
  var HangulAndAlphabetAutoAdd: Boolean = js.native
  val HangulAndAlphabetExceptions: typingsSlinky.activexDashWord.Word.HangulAndAlphabetExceptions = js.native
  var OtherCorrectionsAutoAdd: Boolean = js.native
  val OtherCorrectionsExceptions: typingsSlinky.activexDashWord.Word.OtherCorrectionsExceptions = js.native
  ...
  val TwoInitialCapsExceptions: typingsSlinky.activexDashWord.Word.TwoInitialCapsExceptions = js.native
