...
class ListFormat protected () extends js.Object {
  ...
  val List: typingsSlinky.activexDashWord.Word.List = js.native
  var ListLevelNumber: Double = js.native
  val ListPictureBullet: InlineShape = js.native
  val ListString: String = js.native
  val ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate = js.native
  ...
  def ApplyListTemplate(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplate(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplate(
    ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate,
  ...
  def ApplyListTemplateOld(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplateOld(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplateOld(
    ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate,
    ContinuePreviousList: js.Any,
    ApplyTo: js.Any
  ): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  ...
  def CanContinuePreviousList(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate): WdContinue = js.native
