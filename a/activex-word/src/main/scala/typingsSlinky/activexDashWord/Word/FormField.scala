...
class FormField protected () extends js.Object {
  ...
  val CheckBox: typingsSlinky.activexDashWord.Word.CheckBox = js.native
  val Creator: Double = js.native
  val DropDown: typingsSlinky.activexDashWord.Word.DropDown = js.native
  ...
  val TextInput: typingsSlinky.activexDashWord.Word.TextInput = js.native
