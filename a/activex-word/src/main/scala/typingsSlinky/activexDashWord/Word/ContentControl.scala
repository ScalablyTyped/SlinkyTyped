...
class ContentControl protected () extends js.Object {
  ...
  val XMLMapping: typingsSlinky.activexDashWord.Word.XMLMapping = js.native
  ...
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typingsSlinky.activexDashWord.Word.Range): Unit = js.native
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typingsSlinky.activexDashWord.Word.Range, Text: String): Unit = js.native
  /** @param string [Font=''] */
