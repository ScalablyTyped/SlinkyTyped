...
class Chart protected () extends js.Object {
  ...
  val BackWall: typingsSlinky.activexDashWord.Word.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typingsSlinky.activexDashWord.Word.ChartArea = js.native
  val ChartData: typingsSlinky.activexDashWord.Word.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typingsSlinky.activexDashWord.Word.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typingsSlinky.activexDashWord.Word.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typingsSlinky.activexDashWord.Word.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typingsSlinky.activexDashWord.Word.Floor = js.native
  ...
  val Legend: typingsSlinky.activexDashWord.Word.Legend = js.native
  ...
  val PlotArea: typingsSlinky.activexDashWord.Word.PlotArea = js.native
  ...
  val SideWall: typingsSlinky.activexDashWord.Word.Walls = js.native
  var SubType: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Type: Double = js.native
  val Walls: typingsSlinky.activexDashWord.Word.Walls = js.native
