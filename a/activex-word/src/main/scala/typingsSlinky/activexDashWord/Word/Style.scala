...
class Style protected () extends js.Object {
  ...
  val Frame: typingsSlinky.activexDashWord.Word.Frame = js.native
  ...
  def LinkToListTemplate(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate): Unit = js.native
  def LinkToListTemplate(ListTemplate: typingsSlinky.activexDashWord.Word.ListTemplate, ListLevelNumber: js.Any): Unit = js.native
}
