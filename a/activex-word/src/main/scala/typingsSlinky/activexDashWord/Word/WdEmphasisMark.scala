...
object WdEmphasisMark {
  ...
  @scala.inline
  def wdEmphasisMarkNone: `0` = this.cast(0)
  @scala.inline
  def wdEmphasisMarkOverComma: `2` = this.cast(2)
  @scala.inline
  def wdEmphasisMarkOverSolidCircle: `1` = this.cast(1)
  @scala.inline
  def wdEmphasisMarkOverWhiteCircle: `3` = this.cast(3)
  @scala.inline
  def wdEmphasisMarkUnderSolidCircle: `4` = this.cast(4)
}
