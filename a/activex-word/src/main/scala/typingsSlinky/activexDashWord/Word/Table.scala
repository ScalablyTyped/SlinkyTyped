...
class Table protected () extends js.Object {
  ...
  def Cell(Row: Double, Column: Double): typingsSlinky.activexDashWord.Word.Cell = js.native
  def ConvertToText(): typingsSlinky.activexDashWord.Word.Range = js.native
  def ConvertToText(Separator: js.Any): typingsSlinky.activexDashWord.Word.Range = js.native
  def ConvertToText(Separator: js.Any, NestedTables: js.Any): typingsSlinky.activexDashWord.Word.Range = js.native
  def ConvertToTextOld(): typingsSlinky.activexDashWord.Word.Range = js.native
  def ConvertToTextOld(Separator: js.Any): typingsSlinky.activexDashWord.Word.Range = js.native
