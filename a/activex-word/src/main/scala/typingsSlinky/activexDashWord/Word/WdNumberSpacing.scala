...
*/
trait WdNumberSpacing extends js.Object

object WdNumberSpacing {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def wdNumberSpacingDefault: `0` = this.cast(0)
  @scala.inline
  def wdNumberSpacingProportional: `1` = this.cast(1)
  @scala.inline
  def wdNumberSpacingTabular: `2` = this.cast(2)
}
