...
object typesDeleteBucketTaggingInputMod {
  ...
  object DeleteBucketTaggingInput {
    ...
    @scala.inline
    def apply(Bucket: String): DeleteBucketTaggingInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[DeleteBucketTaggingInput]
    }
    
    @scala.inline
    implicit class DeleteBucketTaggingInputMutableBuilder[Self <: DeleteBucketTaggingInput] (val x: Self) extends AnyVal {
