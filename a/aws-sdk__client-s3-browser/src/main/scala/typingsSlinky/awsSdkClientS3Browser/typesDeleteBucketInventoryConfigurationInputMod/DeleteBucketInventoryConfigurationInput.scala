package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketInventoryConfigurationInputMod
...
@js.native
trait DeleteBucketInventoryConfigurationInput extends InputTypesUnion {
  /**
