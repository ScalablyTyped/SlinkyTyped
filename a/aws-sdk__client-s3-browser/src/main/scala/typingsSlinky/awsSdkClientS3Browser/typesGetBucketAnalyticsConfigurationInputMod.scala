...
object typesGetBucketAnalyticsConfigurationInputMod {
  ...
  object GetBucketAnalyticsConfigurationInput {
    ...
    @scala.inline
    implicit class GetBucketAnalyticsConfigurationInputMutableBuilder[Self <: GetBucketAnalyticsConfigurationInput] (val x: Self) extends AnyVal {
