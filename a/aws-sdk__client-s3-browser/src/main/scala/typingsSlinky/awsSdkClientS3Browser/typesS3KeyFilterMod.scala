...
import typingsSlinky.awsSdkClientS3Browser.typesFilterRuleMod.FilterRule
import typingsSlinky.awsSdkClientS3Browser.typesFilterRuleMod.UnmarshalledFilterRule
...
object typesS3KeyFilterMod {
  ...
  object S3KeyFilter {
    ...
    implicit class S3KeyFilterMutableBuilder[Self <: S3KeyFilter] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFilterRules(value: js.Array[FilterRule] | js.Iterable[FilterRule]): Self = StObject.set(x, "FilterRules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFilterRulesIterable(value: js.Iterable[FilterRule]): Self = StObject.set(x, "FilterRules", value.asInstanceOf[js.Any])
