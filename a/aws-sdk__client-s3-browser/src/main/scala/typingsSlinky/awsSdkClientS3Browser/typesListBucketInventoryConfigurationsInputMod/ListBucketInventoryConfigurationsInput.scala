package typingsSlinky.awsSdkClientS3Browser.typesListBucketInventoryConfigurationsInputMod
...
@js.native
trait ListBucketInventoryConfigurationsInput extends InputTypesUnion {
  /**
...
object ListBucketInventoryConfigurationsInput {
  ...
  @scala.inline
  implicit class ListBucketInventoryConfigurationsInputOps[Self <: ListBucketInventoryConfigurationsInput] (val x: Self) extends AnyVal {
    @scala.inline
