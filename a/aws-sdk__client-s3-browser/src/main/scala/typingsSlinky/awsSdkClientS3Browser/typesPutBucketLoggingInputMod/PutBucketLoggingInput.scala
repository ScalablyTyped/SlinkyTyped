package typingsSlinky.awsSdkClientS3Browser.typesPutBucketLoggingInputMod
...
trait PutBucketLoggingInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var BucketLoggingStatus: typingsSlinky.awsSdkClientS3Browser.typesBucketLoggingStatusMod.BucketLoggingStatus = js.native
  /**
    * _ContentMD5 shape
    */
...
object PutBucketLoggingInput {
  ...
  @scala.inline
  implicit class PutBucketLoggingInputOps[Self <: PutBucketLoggingInput] (val x: Self) extends AnyVal {
    @scala.inline
