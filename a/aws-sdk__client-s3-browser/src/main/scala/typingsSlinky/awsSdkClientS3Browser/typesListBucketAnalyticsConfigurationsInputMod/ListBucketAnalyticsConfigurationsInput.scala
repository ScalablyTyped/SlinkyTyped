package typingsSlinky.awsSdkClientS3Browser.typesListBucketAnalyticsConfigurationsInputMod
...
@js.native
trait ListBucketAnalyticsConfigurationsInput extends InputTypesUnion {
  /**
...
object ListBucketAnalyticsConfigurationsInput {
  ...
  @scala.inline
  implicit class ListBucketAnalyticsConfigurationsInputOps[Self <: ListBucketAnalyticsConfigurationsInput] (val x: Self) extends AnyVal {
    @scala.inline
