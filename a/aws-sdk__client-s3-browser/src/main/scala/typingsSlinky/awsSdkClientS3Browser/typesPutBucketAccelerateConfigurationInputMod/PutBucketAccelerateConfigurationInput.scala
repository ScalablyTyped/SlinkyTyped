package typingsSlinky.awsSdkClientS3Browser.typesPutBucketAccelerateConfigurationInputMod
...
@js.native
trait PutBucketAccelerateConfigurationInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var AccelerateConfiguration: typingsSlinky.awsSdkClientS3Browser.typesAccelerateConfigurationMod.AccelerateConfiguration = js.native
  /**
