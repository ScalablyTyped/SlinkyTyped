...
object typesTaggingMod {
  ...
  object Tagging {
    ...
    implicit class TaggingMutableBuilder[Self <: Tagging] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTagSet(value: js.Array[Tag] | js.Iterable[Tag]): Self = StObject.set(x, "TagSet", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTagSetIterable(value: js.Iterable[Tag]): Self = StObject.set(x, "TagSet", value.asInstanceOf[js.Any])
