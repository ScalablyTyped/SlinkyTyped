package typingsSlinky.awsSdkClientS3Browser.typesPutBucketMetricsConfigurationInputMod
...
@js.native
trait PutBucketMetricsConfigurationInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var MetricsConfiguration: typingsSlinky.awsSdkClientS3Browser.typesMetricsConfigurationMod.MetricsConfiguration = js.native
}
...
object PutBucketMetricsConfigurationInput {
  ...
  @scala.inline
  implicit class PutBucketMetricsConfigurationInputOps[Self <: PutBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
