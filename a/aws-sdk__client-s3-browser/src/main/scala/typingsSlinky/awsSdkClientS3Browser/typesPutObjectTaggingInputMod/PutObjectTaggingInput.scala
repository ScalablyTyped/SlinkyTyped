package typingsSlinky.awsSdkClientS3Browser.typesPutObjectTaggingInputMod
...
trait PutObjectTaggingInput extends _InputTypesUnion {
  ...
  /**
    * _Tagging shape
    */
  var Tagging: typingsSlinky.awsSdkClientS3Browser.typesTaggingMod.Tagging = js.native
...
object PutObjectTaggingInput {
  ...
  @scala.inline
  implicit class PutObjectTaggingInputOps[Self <: PutObjectTaggingInput] (val x: Self) extends AnyVal {
