package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketInputMod
...
@js.native
trait DeleteBucketInput extends InputTypesUnion {
  /**
...
object DeleteBucketInput {
  ...
  @scala.inline
  implicit class DeleteBucketInputOps[Self <: DeleteBucketInput] (val x: Self) extends AnyVal {
    @scala.inline
