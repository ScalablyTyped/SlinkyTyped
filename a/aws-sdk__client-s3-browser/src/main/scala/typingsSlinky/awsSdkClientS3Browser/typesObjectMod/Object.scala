package typingsSlinky.awsSdkClientS3Browser.typesObjectMod
...
object Object {
  ...
  implicit class ObjectOps[Self <: Object] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStorageClass(value: STANDARD | REDUCED_REDUNDANCY | GLACIER | STANDARD_IA | ONEZONE_IA | String): Self = {
        val ret = this.duplicate
