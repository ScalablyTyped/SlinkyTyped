package typingsSlinky.awsSdkClientS3Browser.typesHeadObjectInputMod
...
object HeadObjectInput {
  ...
  implicit class HeadObjectInputOps[Self <: HeadObjectInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIfModifiedSinceDate(value: js.Date): Self = this.set("IfModifiedSince", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIfModifiedSince(value: js.Date | String | Double): Self = this.set("IfModifiedSince", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIfUnmodifiedSinceDate(value: js.Date): Self = this.set("IfUnmodifiedSince", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIfUnmodifiedSince(value: js.Date | String | Double): Self = this.set("IfUnmodifiedSince", value.asInstanceOf[js.Any])
