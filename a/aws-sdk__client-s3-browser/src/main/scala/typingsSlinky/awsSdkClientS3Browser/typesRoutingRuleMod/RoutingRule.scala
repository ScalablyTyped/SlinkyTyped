...
trait RoutingRule extends js.Object {
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsSdkClientS3Browser.typesConditionMod.Condition] = js.undefined
  /**
    ...
    */
  var Redirect: typingsSlinky.awsSdkClientS3Browser.typesRedirectMod.Redirect
}
