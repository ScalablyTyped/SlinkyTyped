...
import typingsSlinky.awsSdkClientS3Browser.typesConditionMod.UnmarshalledCondition
import typingsSlinky.awsSdkClientS3Browser.typesRedirectMod.UnmarshalledRedirect
...
object UnmarshalledRoutingRule {
  ...
  implicit class UnmarshalledRoutingRuleOps[Self <: UnmarshalledRoutingRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRedirect(value: UnmarshalledRedirect): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Redirect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCondition(value: UnmarshalledCondition): Self = {
        val ret = this.duplicate
