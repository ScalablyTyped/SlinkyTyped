package typingsSlinky.awsSdkClientS3Browser.typesGetBucketInventoryConfigurationInputMod
...
@js.native
trait GetBucketInventoryConfigurationInput extends InputTypesUnion {
  /**
