package typingsSlinky.awsSdkClientS3Browser.typesPutBucketReplicationInputMod
...
trait PutBucketReplicationInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var ReplicationConfiguration: typingsSlinky.awsSdkClientS3Browser.typesReplicationConfigurationMod.ReplicationConfiguration = js.native
}
object PutBucketReplicationInput {
  ...
  @scala.inline
  implicit class PutBucketReplicationInputOps[Self <: PutBucketReplicationInput] (val x: Self) extends AnyVal {
