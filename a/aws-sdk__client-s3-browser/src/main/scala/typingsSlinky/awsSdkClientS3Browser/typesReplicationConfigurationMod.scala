...
import typingsSlinky.awsSdkClientS3Browser.typesReplicationRuleMod.ReplicationRule
import typingsSlinky.awsSdkClientS3Browser.typesReplicationRuleMod.UnmarshalledReplicationRule
...
object typesReplicationConfigurationMod {
  ...
  object ReplicationConfiguration {
    ...
    implicit class ReplicationConfigurationMutableBuilder[Self <: ReplicationConfiguration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRules(value: js.Array[ReplicationRule] | js.Iterable[ReplicationRule]): Self = StObject.set(x, "Rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesIterable(value: js.Iterable[ReplicationRule]): Self = StObject.set(x, "Rules", value.asInstanceOf[js.Any])
