package typingsSlinky.awsSdkClientS3Browser.typesPutBucketRequestPaymentInputMod
...
trait PutBucketRequestPaymentInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestPaymentConfiguration: typingsSlinky.awsSdkClientS3Browser.typesRequestPaymentConfigurationMod.RequestPaymentConfiguration = js.native
}
...
object PutBucketRequestPaymentInput {
  ...
  implicit class PutBucketRequestPaymentInputOps[Self <: PutBucketRequestPaymentInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestPaymentConfiguration(value: RequestPaymentConfiguration): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RequestPaymentConfiguration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
