package typingsSlinky.awsSdkClientS3Browser.typesGetObjectTaggingInputMod
...
@js.native
trait GetObjectTaggingInput extends InputTypesUnion {
  /**
...
object GetObjectTaggingInput {
  ...
  @scala.inline
  implicit class GetObjectTaggingInputOps[Self <: GetObjectTaggingInput] (val x: Self) extends AnyVal {
    @scala.inline
