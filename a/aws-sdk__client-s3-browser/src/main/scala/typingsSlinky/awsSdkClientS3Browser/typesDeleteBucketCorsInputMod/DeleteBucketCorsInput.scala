package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketCorsInputMod
...
@js.native
trait DeleteBucketCorsInput extends InputTypesUnion {
  /**
...
object DeleteBucketCorsInput {
  ...
  @scala.inline
  implicit class DeleteBucketCorsInputOps[Self <: DeleteBucketCorsInput] (val x: Self) extends AnyVal {
    @scala.inline
