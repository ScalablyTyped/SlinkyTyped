package typingsSlinky.awsSdkClientS3Browser.typesSelectObjectContentInputMod
...
import typingsSlinky.awsSdkClientS3Browser.typesRequestProgressMod.RequestProgress
...
trait SelectObjectContentInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var InputSerialization: typingsSlinky.awsSdkClientS3Browser.typesInputSerializationMod.InputSerialization = js.native
  ...
  /**
    ...
    */
  var OutputSerialization: typingsSlinky.awsSdkClientS3Browser.typesOutputSerializationMod.OutputSerialization = js.native
  
  /**
    * <p>Specifies if periodic request progress information should be enabled.</p>
    */
  var RequestProgress: js.UndefOr[typingsSlinky.awsSdkClientS3Browser.typesRequestProgressMod.RequestProgress] = js.native
