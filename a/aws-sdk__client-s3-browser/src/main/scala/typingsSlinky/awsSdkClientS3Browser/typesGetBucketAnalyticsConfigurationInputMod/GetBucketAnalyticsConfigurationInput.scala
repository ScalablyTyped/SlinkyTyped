package typingsSlinky.awsSdkClientS3Browser.typesGetBucketAnalyticsConfigurationInputMod
...
@js.native
trait GetBucketAnalyticsConfigurationInput extends InputTypesUnion {
  /**
