...
object GetObjectInput {
  ...
  implicit class GetObjectInputOps[Self <: GetObjectInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponseExpiresDate(value: js.Date): Self = this.set("ResponseExpires", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResponseExpires(value: js.Date | String | Double): Self = this.set("ResponseExpires", value.asInstanceOf[js.Any])
