...
trait BucketAlreadyOwnedByYou
  ...
  @JSName("name")
  var name_BucketAlreadyOwnedByYou: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.BucketAlreadyOwnedByYou = js.native
}
...
object BucketAlreadyOwnedByYou {
  ...
  implicit class BucketAlreadyOwnedByYouOps[Self <: BucketAlreadyOwnedByYou] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.BucketAlreadyOwnedByYou): Self = this.set("name", value.asInstanceOf[js.Any])
  }
