...
import typingsSlinky.awsSdkClientS3Browser.typesInitiatorMod.Initiator
...
object typesMultipartUploadMod {
  ...
  trait MultipartUpload extends StObject {
    ...
    /**
      ...
      */
    var Initiator: js.UndefOr[typingsSlinky.awsSdkClientS3Browser.typesInitiatorMod.Initiator] = js.native
