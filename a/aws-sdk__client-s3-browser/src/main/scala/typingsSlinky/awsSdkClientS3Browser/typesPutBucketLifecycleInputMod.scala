...
import typingsSlinky.awsSdkClientS3Browser.typesLifecycleConfigurationMod.LifecycleConfiguration
...
object typesPutBucketLifecycleInputMod {
  ...
  trait PutBucketLifecycleInput extends _InputTypesUnion {
    ...
    var LifecycleConfiguration: js.UndefOr[
        typingsSlinky.awsSdkClientS3Browser.typesLifecycleConfigurationMod.LifecycleConfiguration
      ] = js.native
  }
  object PutBucketLifecycleInput {
    ...
    @scala.inline
    implicit class PutBucketLifecycleInputMutableBuilder[Self <: PutBucketLifecycleInput] (val x: Self) extends AnyVal {
