...
import typingsSlinky.awsSdkClientS3Browser.typesBucketLifecycleConfigurationMod.BucketLifecycleConfiguration
...
object typesPutBucketLifecycleConfigurationInputMod {
  ...
  object PutBucketLifecycleConfigurationInput {
    ...
    @scala.inline
    implicit class PutBucketLifecycleConfigurationInputMutableBuilder[Self <: PutBucketLifecycleConfigurationInput] (val x: Self) extends AnyVal {
