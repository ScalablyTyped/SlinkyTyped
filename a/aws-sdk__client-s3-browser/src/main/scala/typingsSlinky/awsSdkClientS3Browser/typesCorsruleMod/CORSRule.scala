...
object CORSRule {
  ...
  implicit class CORSRuleOps[Self <: CORSRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowedMethodsIterable(value: js.Iterable[String]): Self = this.set("AllowedMethods", value.asInstanceOf[js.Any])
    @scala.inline
    def setAllowedMethods(value: js.Array[String] | js.Iterable[String]): Self = this.set("AllowedMethods", value.asInstanceOf[js.Any])
    @scala.inline
    def setAllowedOriginsVarargs(value: String*): Self = this.set("AllowedOrigins", js.Array(value :_*))
    @scala.inline
    def setAllowedOriginsIterable(value: js.Iterable[String]): Self = this.set("AllowedOrigins", value.asInstanceOf[js.Any])
    @scala.inline
    def setAllowedOrigins(value: js.Array[String] | js.Iterable[String]): Self = this.set("AllowedOrigins", value.asInstanceOf[js.Any])
    @scala.inline
    def setAllowedHeadersVarargs(value: String*): Self = this.set("AllowedHeaders", js.Array(value :_*))
    @scala.inline
    def setAllowedHeadersIterable(value: js.Iterable[String]): Self = this.set("AllowedHeaders", value.asInstanceOf[js.Any])
    @scala.inline
    def setAllowedHeaders(value: js.Array[String] | js.Iterable[String]): Self = this.set("AllowedHeaders", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setExposeHeadersIterable(value: js.Iterable[String]): Self = this.set("ExposeHeaders", value.asInstanceOf[js.Any])
    @scala.inline
    def setExposeHeaders(value: js.Array[String] | js.Iterable[String]): Self = this.set("ExposeHeaders", value.asInstanceOf[js.Any])
    @scala.inline
