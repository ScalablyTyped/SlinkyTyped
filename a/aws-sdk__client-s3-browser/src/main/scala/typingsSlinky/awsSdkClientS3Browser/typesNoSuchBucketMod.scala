...
object typesNoSuchBucketMod {
  ...
  trait NoSuchBucket extends StObject {
    ...
    var name: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchBucket = js.native
  }
  object NoSuchBucket {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchBucket): NoSuchBucket = {
    ...
    implicit class NoSuchBucketMutableBuilder[Self <: NoSuchBucket] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchBucket): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
