...
import typingsSlinky.awsSdkClientS3Browser.typesAnalyticsS3BucketDestinationMod.AnalyticsS3BucketDestination
...
object AnalyticsExportDestination {
  ...
  implicit class AnalyticsExportDestinationOps[Self <: AnalyticsExportDestination] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withS3BucketDestination(value: AnalyticsS3BucketDestination): Self = {
