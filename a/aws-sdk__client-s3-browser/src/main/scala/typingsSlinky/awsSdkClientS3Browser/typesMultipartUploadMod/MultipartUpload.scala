...
object MultipartUpload {
  ...
  implicit class MultipartUploadOps[Self <: MultipartUpload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitiatedDate(value: js.Date): Self = this.set("Initiated", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitiated(value: js.Date | String | Double): Self = this.set("Initiated", value.asInstanceOf[js.Any])
