...
object typesListBucketInventoryConfigurationsInputMod {
  
  @js.native
  trait ListBucketInventoryConfigurationsInput extends _InputTypesUnion {
  ...
  object ListBucketInventoryConfigurationsInput {
    ...
    @scala.inline
    implicit class ListBucketInventoryConfigurationsInputMutableBuilder[Self <: ListBucketInventoryConfigurationsInput] (val x: Self) extends AnyVal {
