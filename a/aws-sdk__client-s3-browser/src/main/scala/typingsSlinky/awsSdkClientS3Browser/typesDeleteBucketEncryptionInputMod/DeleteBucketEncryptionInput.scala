package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketEncryptionInputMod
...
@js.native
trait DeleteBucketEncryptionInput extends InputTypesUnion {
  /**
...
object DeleteBucketEncryptionInput {
  ...
  @scala.inline
  implicit class DeleteBucketEncryptionInputOps[Self <: DeleteBucketEncryptionInput] (val x: Self) extends AnyVal {
    @scala.inline
