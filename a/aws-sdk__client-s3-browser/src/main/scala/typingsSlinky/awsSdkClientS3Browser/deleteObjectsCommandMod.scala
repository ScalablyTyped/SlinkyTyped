...
import typingsSlinky.awsSdkClientS3Browser.typesDeleteObjectsInputMod.DeleteObjectsInput
import typingsSlinky.awsSdkClientS3Browser.typesDeleteObjectsOutputMod.DeleteObjectsOutput
