package typingsSlinky.awsSdkClientS3Browser.typesPutBucketAnalyticsConfigurationInputMod
...
@js.native
trait PutBucketAnalyticsConfigurationInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var AnalyticsConfiguration: typingsSlinky.awsSdkClientS3Browser.typesAnalyticsConfigurationMod.AnalyticsConfiguration = js.native
  /**
