package typingsSlinky.awsSdkClientS3Browser.typesDeleteObjectInputMod
...
@js.native
trait DeleteObjectInput extends InputTypesUnion {
  /**
...
object DeleteObjectInput {
  ...
  @scala.inline
  implicit class DeleteObjectInputOps[Self <: DeleteObjectInput] (val x: Self) extends AnyVal {
    @scala.inline
