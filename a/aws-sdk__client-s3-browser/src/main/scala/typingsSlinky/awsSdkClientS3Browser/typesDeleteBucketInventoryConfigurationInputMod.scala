...
object typesDeleteBucketInventoryConfigurationInputMod {
  ...
  object DeleteBucketInventoryConfigurationInput {
    ...
    @scala.inline
    implicit class DeleteBucketInventoryConfigurationInputMutableBuilder[Self <: DeleteBucketInventoryConfigurationInput] (val x: Self) extends AnyVal {
