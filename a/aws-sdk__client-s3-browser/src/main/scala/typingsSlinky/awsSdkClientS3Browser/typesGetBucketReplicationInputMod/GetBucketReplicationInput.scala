package typingsSlinky.awsSdkClientS3Browser.typesGetBucketReplicationInputMod
...
object GetBucketReplicationInput {
  ...
  @scala.inline
  implicit class GetBucketReplicationInputOps[Self <: GetBucketReplicationInput] (val x: Self) extends AnyVal {
    @scala.inline
