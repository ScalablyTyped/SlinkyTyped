...
object typesPutBucketEncryptionInputMod {
  ...
  trait PutBucketEncryptionInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var ServerSideEncryptionConfiguration: typingsSlinky.awsSdkClientS3Browser.typesServerSideEncryptionConfigurationMod.ServerSideEncryptionConfiguration = js.native
  }
  object PutBucketEncryptionInput {
    ...
    @scala.inline
    implicit class PutBucketEncryptionInputMutableBuilder[Self <: PutBucketEncryptionInput] (val x: Self) extends AnyVal {
