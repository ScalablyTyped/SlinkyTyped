package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketLifecycleInputMod
...
@js.native
trait DeleteBucketLifecycleInput extends InputTypesUnion {
  /**
...
object DeleteBucketLifecycleInput {
  ...
  @scala.inline
  implicit class DeleteBucketLifecycleInputOps[Self <: DeleteBucketLifecycleInput] (val x: Self) extends AnyVal {
    @scala.inline
