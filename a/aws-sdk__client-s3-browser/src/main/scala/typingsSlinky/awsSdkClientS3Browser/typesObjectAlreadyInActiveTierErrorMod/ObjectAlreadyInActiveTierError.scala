...
trait ObjectAlreadyInActiveTierError extends ServiceException[ObjectAlreadyInActiveTierErrorDetails] {
  ...
  @JSName("name")
  var name_ObjectAlreadyInActiveTierError: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.ObjectAlreadyInActiveTierError = js.native
}
object ObjectAlreadyInActiveTierError {
  ...
  implicit class ObjectAlreadyInActiveTierErrorOps[Self <: ObjectAlreadyInActiveTierError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(
      value: typingsSlinky.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.ObjectAlreadyInActiveTierError
