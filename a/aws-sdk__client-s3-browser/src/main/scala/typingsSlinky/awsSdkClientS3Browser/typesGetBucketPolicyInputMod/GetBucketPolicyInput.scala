package typingsSlinky.awsSdkClientS3Browser.typesGetBucketPolicyInputMod
...
@js.native
trait GetBucketPolicyInput extends InputTypesUnion {
  /**
...
object GetBucketPolicyInput {
  ...
  @scala.inline
  implicit class GetBucketPolicyInputOps[Self <: GetBucketPolicyInput] (val x: Self) extends AnyVal {
    @scala.inline
