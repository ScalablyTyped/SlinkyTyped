package typingsSlinky.awsSdkClientS3Browser.typesInventoryDestinationMod

import typingsSlinky.awsSdkClientS3Browser.typesInventoryS3BucketDestinationMod.InventoryS3BucketDestination
...
object InventoryDestination {
  ...
  implicit class InventoryDestinationOps[Self <: InventoryDestination] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withS3BucketDestination(value: InventoryS3BucketDestination): Self = {
