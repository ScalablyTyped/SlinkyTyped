...
object typesDeleteBucketReplicationInputMod {
  ...
  object DeleteBucketReplicationInput {
    ...
    @scala.inline
    implicit class DeleteBucketReplicationInputMutableBuilder[Self <: DeleteBucketReplicationInput] (val x: Self) extends AnyVal {
