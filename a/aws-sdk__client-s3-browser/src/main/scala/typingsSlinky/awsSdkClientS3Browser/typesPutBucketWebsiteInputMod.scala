...
object typesPutBucketWebsiteInputMod {
  ...
  trait PutBucketWebsiteInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var WebsiteConfiguration: typingsSlinky.awsSdkClientS3Browser.typesWebsiteConfigurationMod.WebsiteConfiguration = js.native
  }
  object PutBucketWebsiteInput {
    ...
    @scala.inline
    implicit class PutBucketWebsiteInputMutableBuilder[Self <: PutBucketWebsiteInput] (val x: Self) extends AnyVal {
