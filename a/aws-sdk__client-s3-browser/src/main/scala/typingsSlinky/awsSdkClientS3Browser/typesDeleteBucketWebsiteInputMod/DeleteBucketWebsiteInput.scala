package typingsSlinky.awsSdkClientS3Browser.typesDeleteBucketWebsiteInputMod
...
@js.native
trait DeleteBucketWebsiteInput extends InputTypesUnion {
  /**
...
object DeleteBucketWebsiteInput {
  ...
  @scala.inline
  implicit class DeleteBucketWebsiteInputOps[Self <: DeleteBucketWebsiteInput] (val x: Self) extends AnyVal {
    @scala.inline
