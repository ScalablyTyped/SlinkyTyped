...
class ShellNameSpace protected ()
  extends typingsSlinky.activexShdocvw.SHDocVw.ShellNameSpace {
  /* CompleteClass */
  ...
  override var SHDocVwDotShellNameSpace_typekey: typingsSlinky.activexShdocvw.SHDocVw.ShellNameSpace = js.native
