...
class CScriptErrorList protected ()
  extends typingsSlinky.activexShdocvw.SHDocVw.CScriptErrorList {
  /* CompleteClass */
  @JSName("SHDocVw.CScriptErrorList_typekey")
  override var SHDocVwDotCScriptErrorList_typekey: typingsSlinky.activexShdocvw.SHDocVw.CScriptErrorList = js.native
  /* CompleteClass */
