...
@js.native
trait ShellBrowserWindowBeforeNavigate2Parameter extends js.Object {
...
object ShellBrowserWindowBeforeNavigate2Parameter {
  ...
  @scala.inline
  implicit class ShellBrowserWindowBeforeNavigate2ParameterOps[Self <: ShellBrowserWindowBeforeNavigate2Parameter] (val x: Self) extends AnyVal {
    @scala.inline
