...
@js.native
trait WebBrowserV1FrameBeforeNavigateParameter extends js.Object {
...
object WebBrowserV1FrameBeforeNavigateParameter {
  ...
  @scala.inline
  implicit class WebBrowserV1FrameBeforeNavigateParameterOps[Self <: WebBrowserV1FrameBeforeNavigateParameter] (val x: Self) extends AnyVal {
