...
import typingsSlinky.airbnbPropTypes.anon.Gt
...
object mod {
  ...
  @JSImport("airbnb-prop-types", "componentWithName")
  @js.native
  def componentWithName[T](name: js.RegExp): Requireable[T] = js.native
  @JSImport("airbnb-prop-types", "componentWithName")
  @js.native
  def componentWithName[T](name: js.RegExp, options: StripHOCs): Requireable[T] = js.native
