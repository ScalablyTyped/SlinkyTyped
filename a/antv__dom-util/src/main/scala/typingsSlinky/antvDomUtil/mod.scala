...
import typingsSlinky.antvDomUtil.anon.Remove
...
object mod {
  ...
  @JSImport("@antv/dom-util", "getOuterHeight")
  @js.native
  ...
  @JSImport("@antv/dom-util", "getOuterWidth")
  @js.native
  ...
  @JSImport("@antv/dom-util", "getRatio")
  @js.native
  def getRatio(): Double = js.native
  
  @JSImport("@antv/dom-util", "getStyle")
  @js.native
  ...
  @JSImport("@antv/dom-util", "getWidth")
  @js.native
  ...
  @JSImport("@antv/dom-util", "modifyCSS")
  @js.native
