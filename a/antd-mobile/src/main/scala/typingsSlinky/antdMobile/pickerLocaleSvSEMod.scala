...
object pickerLocaleSvSEMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/picker/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/picker/locale/sv_SE", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/picker/locale/sv_SE", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile/lib/picker/locale/sv_SE", "default.okText")
    @js.native
