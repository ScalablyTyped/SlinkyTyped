package typingsSlinky.antdMobile.rangePropsTypeMod
...
trait RangePropsType extends js.Object {
  ...
  var tipFormatter: js.UndefOr[js.Function1[/* value */ js.UndefOr[Double], TagMod[Any]]] = js.native
...
object RangePropsType {
  ...
  implicit class RangePropsTypeOps[Self <: RangePropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTipFormatter(value: /* value */ js.UndefOr[Double] => TagMod[Any]): Self = {
        val ret = this.duplicate
