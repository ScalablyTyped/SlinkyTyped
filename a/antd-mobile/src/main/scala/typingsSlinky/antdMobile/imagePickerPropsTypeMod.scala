...
object imagePickerPropsTypeMod {
  ...
  trait ImagePickerPropTypes extends StObject {
    ...
    var onAddImageClick: js.UndefOr[js.Function1[/* e */ SyntheticMouseEvent[Element], Unit]] = js.native
  ...
  object ImagePickerPropTypes {
    ...
    implicit class ImagePickerPropTypesMutableBuilder[Self <: ImagePickerPropTypes] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnAddImageClick(value: /* e */ SyntheticMouseEvent[Element] => Unit): Self = StObject.set(x, "onAddImageClick", js.Any.fromFunction1(value))
