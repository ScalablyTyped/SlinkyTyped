...
object customKeyboardMod {
  ...
  object KeyboardItemProps {
    ...
    implicit class KeyboardItemPropsMutableBuilder[Self <: KeyboardItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: (SyntheticMouseEvent[HTMLTableDataCellElement], String) => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setTdRefRefObject(value: ReactRef[HTMLTableDataCellElement]): Self = StObject.set(x, "tdRef", value.asInstanceOf[js.Any])
