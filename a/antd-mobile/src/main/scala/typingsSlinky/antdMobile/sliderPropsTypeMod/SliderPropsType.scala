package typingsSlinky.antdMobile.sliderPropsTypeMod
...
trait SliderPropsType extends js.Object {
  ...
  var tipFormatter: js.UndefOr[js.Function1[/* value */ js.UndefOr[String], ReactElement]] = js.native
...
object SliderPropsType {
  ...
  implicit class SliderPropsTypeOps[Self <: SliderPropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTipFormatter(value: /* value */ js.UndefOr[String] => ReactElement): Self = this.set("tipFormatter", js.Any.fromFunction1(value))
