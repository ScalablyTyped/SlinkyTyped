...
object inputItemLocaleZhCNMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/input-item/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/input-item/locale/zh_CN", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("antd-mobile/lib/input-item/locale/zh_CN", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("antd-mobile/lib/input-item/locale/zh_CN", "default.confirmLabel")
    @js.native
