...
import typingsSlinky.antdMobile.antdMobileStrings.bankCard
...
import typingsSlinky.antdMobile.antdMobileStrings.digit
...
import typingsSlinky.antdMobile.antdMobileStrings.money
...
import typingsSlinky.antdMobile.antdMobileStrings.password
import typingsSlinky.antdMobile.antdMobileStrings.phone
...
object InputItem {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def onErrorClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onErrorClick", js.Any.fromFunction1(value))
    @scala.inline
    def onExtraClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onExtraClick", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def prefixListCls(value: String): this.type = set("prefixListCls", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `type`(value: text | bankCard | phone | password | number | digit | money): this.type = set("type", value.asInstanceOf[js.Any])
    @scala.inline
