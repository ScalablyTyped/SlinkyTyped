...
object NavBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def mode(value: dark | light): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onLeftClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): this.type = set("onLeftClick", js.Any.fromFunction1(value))
