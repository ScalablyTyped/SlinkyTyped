...
import typingsSlinky.antdMobile.cardBodyMod.CardBodyProps
import typingsSlinky.antdMobile.cardBodyMod.default
...
object CardBody
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antdMobile.cardBodyMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
