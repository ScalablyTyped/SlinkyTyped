...
import typingsSlinky.antdMobile.inputItemPropsTypeMod.InputItemPropsType
...
object inputItemMod {
  ...
  object default {
    ...
    object contextTypes {
      ...
      @JSImport("antd-mobile/lib/input-item", "default.contextTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("antd-mobile/lib/input-item", "default.contextTypes.antLocale")
      @js.native
    ...
    object defaultProps {
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.clear")
      @js.native
      def clear: Boolean = js.native
      @scala.inline
      def clear_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("clear")(x.asInstanceOf[js.Any])
      
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.disabled")
      @js.native
      def disabled: Boolean = js.native
      
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.disabledKeys")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.editable")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.moneyKeyboardAlign")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.moneyKeyboardHeader")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onBlur")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onChange")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onErrorClick")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onExtraClick")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onFocus")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.onVirtualKeyboardConfirm")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.placeholder")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.prefixCls")
      @js.native
      def prefixCls: String = js.native
      @scala.inline
      def prefixCls_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("prefixCls")(x.asInstanceOf[js.Any])
      
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.prefixListCls")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.updatePlaceholder")
      @js.native
      ...
      @JSImport("antd-mobile/lib/input-item", "default.defaultProps.type")
      @js.native
  ...
  @js.native
  trait HTMLInputProps extends StObject {
  ...
  object HTMLInputProps {
    ...
    @scala.inline
    implicit class HTMLInputPropsMutableBuilder[Self <: HTMLInputProps] (val x: Self) extends AnyVal {
  ...
  object InputItemProps {
    ...
    implicit class InputItemPropsMutableBuilder[Self <: InputItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnErrorClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnExtraClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
