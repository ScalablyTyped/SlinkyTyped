...
object menuLocaleSvSEMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/menu/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/menu/locale/sv_SE", "default.cancelText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/menu/locale/sv_SE", "default.okText")
    @js.native
