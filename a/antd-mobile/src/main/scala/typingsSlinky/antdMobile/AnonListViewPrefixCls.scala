...
object AnonListViewPrefixCls {
  ...
  @scala.inline
  implicit class AnonListViewPrefixClsOps[Self <: AnonListViewPrefixCls] (val x: Self) extends AnyVal {
    @scala.inline
