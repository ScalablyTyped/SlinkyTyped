...
object pickerPropsTypeMod {
  ...
  trait PickerPropsType extends IPopupPickerProps {
    ...
    var format: js.UndefOr[
        js.Function1[/* values */ js.Array[ReactElement], String | js.Array[ReactElement]]
      ] = js.native
  ...
  object PickerPropsType {
    ...
    implicit class PickerPropsTypeMutableBuilder[Self <: PickerPropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormat(value: /* values */ js.Array[ReactElement] => String | js.Array[ReactElement]): Self = StObject.set(x, "format", js.Any.fromFunction1(value))
