...
object InputItemPropsType {
  ...
  implicit class InputItemPropsTypeOps[Self <: InputItemPropsType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMoneyKeyboardHeaderReactElement(value: ReactElement): Self = this.set("moneyKeyboardHeader", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMoneyKeyboardHeader(value: ReactElement): Self = this.set("moneyKeyboardHeader", value.asInstanceOf[js.Any])
