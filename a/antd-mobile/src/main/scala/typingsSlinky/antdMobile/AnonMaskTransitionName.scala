...
object AnonMaskTransitionName {
  ...
  @scala.inline
  implicit class AnonMaskTransitionNameOps[Self <: AnonMaskTransitionName] (val x: Self) extends AnyVal {
    @scala.inline
