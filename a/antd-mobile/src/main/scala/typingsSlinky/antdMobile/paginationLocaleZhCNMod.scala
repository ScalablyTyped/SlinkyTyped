...
object paginationLocaleZhCNMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/pagination/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/pagination/locale/zh_CN", "default.nextText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/pagination/locale/zh_CN", "default.prevText")
    @js.native
