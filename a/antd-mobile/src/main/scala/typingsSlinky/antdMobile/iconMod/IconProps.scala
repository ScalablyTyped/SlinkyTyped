...
object IconProps {
  ...
  implicit class IconPropsOps[Self <: IconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnStalled(value: SyntheticEvent[Event, SVGSVGElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnSubmit(value: SyntheticEvent[EventTarget with SVGSVGElement, Event] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnSuspend(value: SyntheticEvent[Event, SVGSVGElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnTimeUpdate(value: SyntheticEvent[Event, SVGSVGElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnVolumeChange(value: SyntheticEvent[Event, SVGSVGElement] => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnWaiting(value: SyntheticEvent[Event, SVGSVGElement] => Unit): Self = {
        val ret = this.duplicate
