...
object IconProps {
  ...
  implicit class IconPropsOps[Self <: IconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSize(value: xxs | xs | sm | md | lg): Self = this.set("size", value.asInstanceOf[js.Any])
