...
trait Cascade extends StObject {
  ...
  def format(values: js.Array[ReactElement]): String | js.Array[ReactElement] = js.native
...
object Cascade {
  ...
  def apply(
    cascade: Boolean,
    cols: Double,
    format: js.Array[ReactElement] => String | js.Array[ReactElement],
  ...
  implicit class CascadeMutableBuilder[Self <: Cascade] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: js.Array[ReactElement] => String | js.Array[ReactElement]): Self = StObject.set(x, "format", js.Any.fromFunction1(value))
