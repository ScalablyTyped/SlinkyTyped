...
object InputItemProps {
  ...
  implicit class InputItemPropsOps[Self <: InputItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnErrorClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = this.set("onErrorClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnErrorClick: Self = this.set("onErrorClick", js.undefined)
    @scala.inline
    def setOnExtraClick(value: SyntheticMouseEvent[HTMLDivElement] => Unit): Self = this.set("onExtraClick", js.Any.fromFunction1(value))
    @scala.inline
