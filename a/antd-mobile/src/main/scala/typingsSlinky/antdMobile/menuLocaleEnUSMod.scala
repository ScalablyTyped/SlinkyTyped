...
object menuLocaleEnUSMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/menu/locale/en_US", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/menu/locale/en_US", "default.cancelText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/menu/locale/en_US", "default.okText")
    @js.native
