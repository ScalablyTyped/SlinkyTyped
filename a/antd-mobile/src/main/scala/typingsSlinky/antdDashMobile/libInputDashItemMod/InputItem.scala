...
trait InputItem
  ...
  var inputRef: typingsSlinky.antdDashMobile.libInputDashItemInputMod.default | typingsSlinky.antdDashMobile.libInputDashItemCustomInputMod.default | Null = js.native
  def calcPos(
    prePos: Double,
    preCtrlVal: String,
    rawVal: String,
