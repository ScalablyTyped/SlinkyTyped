package typingsSlinky.antdDashMobile.libActivityDashIndicatorMod
...
import typingsSlinky.antdDashMobile.libActivityDashIndicatorPropsTypeMod.ActivityIndicatorPropTypes
