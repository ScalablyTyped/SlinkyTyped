package typingsSlinky.antdDashMobile.libNoticeDashBarMarqueeMod

import typingsSlinky.antdDashMobile.Anon_AnimatedWidth
...
trait Marquee
  ...
  @JSName("state")
  var state_Marquee: Anon_AnimatedWidth = js.native
