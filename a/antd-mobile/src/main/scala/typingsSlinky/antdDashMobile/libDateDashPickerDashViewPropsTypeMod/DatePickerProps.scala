package typingsSlinky.antdDashMobile.libDateDashPickerDashViewPropsTypeMod
...
import typingsSlinky.antdDashMobile.libDateDashPickerPropsTypeMod.DatePickerPropsType
