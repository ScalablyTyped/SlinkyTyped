...
trait Anon_ActivateText extends js.Object {
  var activateText: String
  var deactivateText: String
  var finishText: String
}

object Anon_ActivateText {
  @scala.inline
  def apply(activateText: String, deactivateText: String, finishText: String): Anon_ActivateText = {
    ...
    __obj.asInstanceOf[Anon_ActivateText]
  }
}
