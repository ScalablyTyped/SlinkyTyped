...
import typingsSlinky.antdDashMobile.libFlexFlexItemMod.FlexItemProps
import typingsSlinky.antdDashMobile.libFlexFlexItemMod.default
...
object FlexItem
  ...
  typingsSlinky.antdDashMobile.libFlexFlexItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
