...
object DefaultTabBar
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.antdDashMobile.libTabsMod.DefaultTabBar] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.antdDashMobile.libTabsMod.DefaultTabBar] = {
