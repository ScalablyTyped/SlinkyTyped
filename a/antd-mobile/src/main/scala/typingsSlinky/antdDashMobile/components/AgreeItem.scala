...
import typingsSlinky.antdDashMobile.libCheckboxAgreeItemMod.AgreeItemPropsType
import typingsSlinky.antdDashMobile.libCheckboxAgreeItemMod.default
...
object AgreeItem
  ...
  typingsSlinky.antdDashMobile.libCheckboxAgreeItemMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
