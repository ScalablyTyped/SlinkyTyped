...
import typingsSlinky.antdDashMobile.libGridMod.GridProps
import typingsSlinky.antdDashMobile.libGridMod.default
import typingsSlinky.antdDashMobile.libGridPropsTypeMod.DataItem
...
object Grid
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antdDashMobile.libGridMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
