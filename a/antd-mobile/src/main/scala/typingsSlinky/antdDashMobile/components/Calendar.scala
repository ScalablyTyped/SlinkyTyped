...
import typingsSlinky.antdDashMobile.libCalendarMod.default
import typingsSlinky.antdDashMobile.libCalendarPropsTypeMod.CalendarProps
...
object Calendar
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typingsSlinky.antdDashMobile.libCalendarMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
