...
import typingsSlinky.antdDashMobile.libCardCardBodyMod.CardBodyProps
import typingsSlinky.antdDashMobile.libCardCardBodyMod.default
...
object CardBody
  ...
  typingsSlinky.antdDashMobile.libCardCardBodyMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
