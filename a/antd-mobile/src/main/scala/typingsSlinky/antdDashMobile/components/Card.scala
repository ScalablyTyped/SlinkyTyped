...
import typingsSlinky.antdDashMobile.libCardMod.CardProps
import typingsSlinky.antdDashMobile.libCardMod.default
...
object Card
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.antdDashMobile.libCardMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
