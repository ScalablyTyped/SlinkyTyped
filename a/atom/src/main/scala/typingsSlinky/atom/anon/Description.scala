...
object Description {
  @scala.inline
  def apply[/* <: typingsSlinky.std.EventTarget */ TargetType](didDispatch: CommandEvent[TargetType] => Unit | js.Promise[Unit]): Description[TargetType] = {
    val __obj = js.Dynamic.literal(didDispatch = js.Any.fromFunction1(didDispatch))
    __obj.asInstanceOf[Description[TargetType]]
  }
  @scala.inline
  implicit class DescriptionOps[Self <: Description[_], /* <: typingsSlinky.std.EventTarget */ TargetType] (val x: Self with Description[TargetType]) extends AnyVal {
    @scala.inline
