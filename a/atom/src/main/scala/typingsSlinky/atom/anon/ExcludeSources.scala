...
trait ExcludeSources extends js.Object {
  ...
  var scope: js.UndefOr[js.Array[String] | typingsSlinky.atom.mod.ScopeDescriptor] = js.undefined
...
object ExcludeSources {
  ...
  def apply(
    ...
    scope: js.Array[String] | typingsSlinky.atom.mod.ScopeDescriptor = null,
