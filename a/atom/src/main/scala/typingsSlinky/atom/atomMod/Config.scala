...
trait Config extends js.Object {
  ...
  @JSName("get")
  def get_autocompleteplusconfirmCompletion(keyPath: `autocomplete-plusDotconfirmCompletion`, options: Anon_ExcludeSources): tab | enter | (`tab and enter`) | (`tab alwaysComma enter when suggestion explicitly selected`) = js.native
  @JSName("get")
  ...
  @JSName("get")
  def get_corefileSystemWatcher(keyPath: coreDotfileSystemWatcher, options: Anon_ExcludeSources): native | experimental | poll | atom = js.native
  @JSName("get")
  ...
  def set(keyPath: coreDotfileSystemWatcher, value: atom, options: Anon_ScopeSelector): Unit = js.native
