...
import typingsSlinky.atom.Anon_BackwardClipDirectionClosest
import typingsSlinky.atom.Anon_BackwardClipDirectionClosestExclusive
...
trait DisplayMarkerLayer extends js.Object {
  ...
  def markBufferPosition(bufferPosition: PointCompatible, options: Anon_ExclusiveInside): DisplayMarker = js.native
  /** Create a marker with the given buffer range. */
  def markBufferRange(range: RangeCompatible): DisplayMarker = js.native
  def markBufferRange(range: RangeCompatible, options: Anon_Exclusive): DisplayMarker = js.native
  /**
