...
import typingsSlinky.atom.Anon_Pane
...
trait WorkspaceCenter extends js.Object {
  ...
  def onDidAddPane(callback: js.Function1[/* event */ Anon_Pane, Unit]): Disposable
  ...
  def onDidDestroyPane(callback: js.Function1[/* event */ Anon_Pane, Unit]): Disposable
  ...
  def onWillDestroyPane(callback: js.Function1[/* event */ Anon_Pane, Unit]): Disposable
  /**
...
object WorkspaceCenter {
  ...
  def apply(
    ...
    onDidAddPane: js.Function1[/* event */ Anon_Pane, Unit] => Disposable,
    ...
    onDidDestroyPane: js.Function1[/* event */ Anon_Pane, Unit] => Disposable,
    ...
    onWillDestroyPane: js.Function1[/* event */ Anon_Pane, Unit] => Disposable,
