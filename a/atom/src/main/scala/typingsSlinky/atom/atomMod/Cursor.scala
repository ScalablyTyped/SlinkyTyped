...
import typingsSlinky.atom.Anon_Backwards
import typingsSlinky.atom.Anon_IncludeNewline
import typingsSlinky.atom.Anon_IncludeNonWordCharacters
import typingsSlinky.atom.Anon_IncludeNonWordCharactersBoolean
import typingsSlinky.atom.Anon_MoveToEndOfSelection
import typingsSlinky.atom.Anon_WordRegex
...
trait Cursor extends js.Object {
  ...
  def subwordRegExp(options: Anon_Backwards): js.RegExp = js.native
  /** Get the RegExp used by the cursor to determine what a "word" is. */
  def wordRegExp(): js.RegExp = js.native
  def wordRegExp(options: Anon_IncludeNonWordCharactersBoolean): js.RegExp = js.native
}
