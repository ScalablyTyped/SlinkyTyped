...
import typingsSlinky.atom.Anon_Exclusive
import typingsSlinky.atom.Anon_ExclusiveInside
import typingsSlinky.atom.Anon_GroupingInterval
import typingsSlinky.atom.Anon_History
import typingsSlinky.atom.Anon_MaintainHistoryPersistent
import typingsSlinky.atom.Anon_NewExtent
import typingsSlinky.atom.Anon_ShouldDestroyOnFileDelete
...
class TextBuffer () extends js.Object {
  def this(params: Anon_ShouldDestroyOnFileDelete) = this()
  ...
  def addMarkerLayer(options: Anon_MaintainHistoryPersistent): MarkerLayer = js.native
  ...
  def markPosition(position: PointCompatible, options: Anon_ExclusiveInside): Marker = js.native
  /** Create a marker with the given range in the default marker layer. */
  def markRange(range: RangeCompatible): Marker = js.native
  def markRange(range: RangeCompatible, properties: Anon_Exclusive): Marker = js.native
  /**
  ...
  def serialize(options: Anon_History): js.Object = js.native
  ...
  def transact[T](optionsOrInterval: Anon_GroupingInterval with HistoryTransactionOptions, fn: js.Function0[T]): T = js.native
  /** Batch multiple operations as a single undo/redo step. */
