...
import typingsSlinky.atom.Anon_Reloaded
...
trait HistoryManager extends js.Object {
  ...
  def onDidChangeProjects(callback: js.Function1[/* args */ Anon_Reloaded, Unit]): Disposable
}
...
object HistoryManager {
  ...
  def apply(
    ...
    onDidChangeProjects: js.Function1[/* args */ Anon_Reloaded, Unit] => Disposable
  ): HistoryManager = {
