...
/* key */ StringDictionary[js.Any] {
  ...
  /**
    ...
    */
  var `autocomplete-plus.suggestionListFollows`: Word | typingsSlinky.atom.atomStrings.Cursor
  ...
  /**
    ...
    */
  var `core.fileSystemWatcher`: native | experimental | poll | typingsSlinky.atom.atomStrings.atom
  /**
...
object ConfigValues {
  ...
  def apply(
    ...
    `autocomplete-plus.suggestionListFollows`: Word | typingsSlinky.atom.atomStrings.Cursor,
    ...
    `core.fileSystemWatcher`: native | experimental | poll | typingsSlinky.atom.atomStrings.atom,
