...
import typingsSlinky.atom.Anon_AllowPrevious
import typingsSlinky.atom.Anon_Autoscroll
import typingsSlinky.atom.Anon_BackwardClipDirectionClosestForward
import typingsSlinky.atom.Anon_BackwardClipDirectionClosestForwardInside
import typingsSlinky.atom.Anon_Cancel
import typingsSlinky.atom.Anon_Center
import typingsSlinky.atom.Anon_Inside
import typingsSlinky.atom.Anon_InsideInvalidate
import typingsSlinky.atom.Anon_MaintainHistory
import typingsSlinky.atom.Anon_Path
import typingsSlinky.atom.Anon_PreserveFolds
import typingsSlinky.atom.Anon_PreserveLeadingWhitespace
...
class TextEditor () extends js.Object {
  ...
  def addCursorAtBufferPosition(bufferPosition: PointCompatible, options: Anon_Autoscroll): Cursor = js.native
  ...
  def addMarkerLayer(options: Anon_MaintainHistory): DisplayMarkerLayer = js.native
  ...
  def addSelectionForBufferRange(bufferRange: RangeCompatible, options: Anon_PreserveFolds): Selection = js.native
  ...
  def addSelectionForScreenRange(screenRange: RangeCompatible, options: Anon_PreserveFolds): Selection = js.native
  ...
  def bufferPositionForScreenPosition(bufferPosition: PointCompatible, options: Anon_BackwardClipDirectionClosestForward): Point = js.native
  /**
  ...
  def clipScreenPosition(screenPosition: PointCompatible, options: Anon_BackwardClipDirectionClosestForward): Point = js.native
  /**
    *  Clip the start and end of the given range to valid positions on screen.
    *  See ::clipScreenPosition for more information.
    */
  def clipScreenRange(range: RangeCompatible): Range = js.native
  def clipScreenRange(range: RangeCompatible, options: Anon_BackwardClipDirectionClosestForward): Range = js.native
  ...
  def getWordUnderCursor(options: Anon_AllowPrevious): String = js.native
  /**
  ...
  def markBufferPosition(bufferPosition: PointCompatible, options: Anon_InsideInvalidate): DisplayMarker = js.native
  // Markers
  /**
  ...
  def markBufferRange(range: RangeCompatible, properties: Anon_Inside): DisplayMarker = js.native
  /**
  ...
  def markScreenPosition(screenPosition: PointCompatible, options: Anon_BackwardClipDirectionClosestForwardInside): DisplayMarker = js.native
  /**
  ...
  def markScreenRange(range: RangeCompatible, properties: Anon_Inside): DisplayMarker = js.native
  ...
  def onDidInsertText(callback: js.Function1[/* event */ Anon_Text, Unit]): Disposable = js.native
  ...
  def onDidSave(callback: js.Function1[/* event */ Anon_Path, Unit]): Disposable = js.native
  /**
  ...
  def onWillInsertText(callback: js.Function1[/* event */ Anon_Cancel, Unit]): Disposable = js.native
  ...
  def screenPositionForBufferPosition(bufferPosition: PointCompatible, options: Anon_BackwardClipDirectionClosestForward): Point = js.native
  ...
  def scrollToBufferPosition(bufferPosition: PointCompatible, options: Anon_Center): Unit = js.native
  ...
  def scrollToCursorPosition(options: Anon_Center): Unit = js.native
  /** Scrolls the editor to the given screen position. */
  def scrollToScreenPosition(screenPosition: PointCompatible): Unit = js.native
  def scrollToScreenPosition(screenPosition: PointCompatible, options: Anon_Center): Unit = js.native
  /**
  ...
  def setCursorBufferPosition(position: PointCompatible, options: Anon_Autoscroll): Unit = js.native
  /**
  ...
  def setCursorScreenPosition(position: PointCompatible, options: Anon_Autoscroll): Unit = js.native
  ...
  def setIndentationForBufferRow(bufferRow: Double, newLevel: Double, options: Anon_PreserveLeadingWhitespace): Unit = js.native
  /**
  ...
  def setSelectedBufferRange(bufferRange: RangeCompatible, options: Anon_PreserveFolds): Unit = js.native
  /**
  ...
  def setSelectedBufferRanges(bufferRanges: js.Array[RangeCompatible], options: Anon_PreserveFolds): Unit = js.native
  /**
  ...
  def setSelectedScreenRange(screenRange: RangeCompatible, options: Anon_ReversedBoolean): Unit = js.native
  /**
  ...
  def setSelectedScreenRanges(screenRanges: js.Array[RangeCompatible], options: Anon_ReversedBoolean): Unit = js.native
  ...
  def tokenForBufferPosition(pos: PointCompatible): Anon_Scopes = js.native
  /**
