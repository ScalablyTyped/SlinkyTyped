...
import typingsSlinky.atom.Anon_CopyActiveItem
import typingsSlinky.atom.Anon_Index
import typingsSlinky.atom.Anon_Pending
...
trait Pane extends js.Object {
  ...
  def activateItem(item: js.Object, options: Anon_Pending): Unit = js.native
  ...
  def addItem(item: js.Object, options: Anon_Index): js.Object = js.native
  ...
  def splitDown(params: Anon_CopyActiveItem): Pane = js.native
  // Splitting
  /** Create a new pane to the left of this pane. */
  def splitLeft(): Pane = js.native
  def splitLeft(params: Anon_CopyActiveItem): Pane = js.native
  /** Create a new pane to the right of this pane. */
  def splitRight(): Pane = js.native
  def splitRight(params: Anon_CopyActiveItem): Pane = js.native
  /** Creates a new pane above the receiver. */
  def splitUp(): Pane = js.native
  def splitUp(params: Anon_CopyActiveItem): Pane = js.native
}
