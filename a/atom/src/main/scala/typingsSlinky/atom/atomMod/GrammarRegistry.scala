...
object GrammarRegistry {
  ...
  def apply(
    ...
    loadGrammar: (String, js.Function2[/* error */ js.Error | Null, /* grammar */ js.UndefOr[Grammar], Unit]) => Unit,
    ...
    readGrammar: (String, js.Function2[/* error */ js.Error | Null, /* grammar */ js.UndefOr[Grammar], Unit]) => Unit,
