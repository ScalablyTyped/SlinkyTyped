...
object AnonDescription {
  @scala.inline
  def apply[TargetType](didDispatch: CommandEvent[TargetType] => Unit | js.Promise[Unit]): AnonDescription[TargetType] = {
    val __obj = js.Dynamic.literal(didDispatch = js.Any.fromFunction1(didDispatch))
    __obj.asInstanceOf[AnonDescription[TargetType]]
  }
  @scala.inline
  implicit class AnonDescriptionOps[Self[targettype] <: AnonDescription[targettype], TargetType] (val x: Self[TargetType]) extends AnyVal {
    @scala.inline
