...
import typingsSlinky.atom.anon.Added
import typingsSlinky.atom.anon.Ahead
import typingsSlinky.atom.anon.Heads
import typingsSlinky.atom.anon.NewLines
import typingsSlinky.atom.anon.RefreshOnWindowFocus
import typingsSlinky.atom.atomStrings.git
...
class GitRepository protected () extends js.Object {
  ...
  def this(path: String, options: typingsSlinky.atom.anon.Config) = this()
  // Checking Out
  /**
