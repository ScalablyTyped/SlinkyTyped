...
object TextEditorRegistry {
  ...
  implicit class TextEditorRegistryOps[Self <: TextEditorRegistry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: TextEditor => Disposable): Self = {
    ...
    @scala.inline
    def withClearGrammarOverride(value: TextEditor => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearGrammarOverride")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetGrammarOverride(value: TextEditor => String | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getGrammarOverride")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMaintainConfig(value: TextEditor => Disposable): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maintainConfig")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMaintainGrammar(value: TextEditor => Disposable): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maintainGrammar")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withObserve(value: js.Function1[/* editor */ TextEditor, Unit] => Disposable): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("observe")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemove(value: TextEditor => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetGrammarOverride(value: (TextEditor, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setGrammarOverride")(js.Any.fromFunction2(value))
        ret
    }
  }
