...
object WorkspaceCenter {
  ...
  implicit class WorkspaceCenterOps[Self <: WorkspaceCenter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDidAddPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = this.set("onDidAddPane", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnDidDestroyPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = this.set("onDidDestroyPane", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnWillDestroyPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = this.set("onWillDestroyPane", js.Any.fromFunction1(value))
