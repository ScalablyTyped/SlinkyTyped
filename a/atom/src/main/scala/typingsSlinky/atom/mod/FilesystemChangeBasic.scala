...
object FilesystemChangeBasic {
  @scala.inline
  def apply[/* <: typingsSlinky.atom.atomStrings.created | typingsSlinky.atom.atomStrings.modified | typingsSlinky.atom.atomStrings.deleted | typingsSlinky.atom.atomStrings.renamed */ Action](action: Action, path: String): FilesystemChangeBasic[Action] = {
  ...
  @scala.inline
  implicit class FilesystemChangeBasicOps[Self <: FilesystemChangeBasic[_], /* <: typingsSlinky.atom.atomStrings.created | typingsSlinky.atom.atomStrings.modified | typingsSlinky.atom.atomStrings.deleted | typingsSlinky.atom.atomStrings.renamed */ Action] (val x: Self with FilesystemChangeBasic[Action]) extends AnyVal {
    @scala.inline
