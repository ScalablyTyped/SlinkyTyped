...
object ReadonlyEditOptions {
  ...
  implicit class ReadonlyEditOptionsOps[Self <: ReadonlyEditOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBypassReadOnly(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bypassReadOnly")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutBypassReadOnly: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("bypassReadOnly")(js.undefined)
        ret
    }
  }
