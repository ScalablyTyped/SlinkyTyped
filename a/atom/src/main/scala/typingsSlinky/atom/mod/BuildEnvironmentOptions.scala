...
object BuildEnvironmentOptions {
  ...
  implicit class BuildEnvironmentOptionsOps[Self <: BuildEnvironmentOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApplicationDelegate(value: js.Object): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("applicationDelegate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutApplicationDelegate: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("applicationDelegate")(js.undefined)
        ret
    }
    @scala.inline
    def withConfigDirPath(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configDirPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutConfigDirPath: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configDirPath")(js.undefined)
        ret
    }
    @scala.inline
