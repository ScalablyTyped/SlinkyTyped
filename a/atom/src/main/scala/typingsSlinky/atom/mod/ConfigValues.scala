...
object ConfigValues {
  ...
  implicit class ConfigValuesMutableBuilder[Self <: ConfigValues] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setAutocomplete-plusDotsuggestionListFollows`(value: Word | typingsSlinky.atom.atomStrings.Cursor): Self = StObject.set(x, "autocomplete-plus.suggestionListFollows", value.asInstanceOf[js.Any])
