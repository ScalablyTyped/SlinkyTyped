...
object Dock {
  ...
  implicit class DockMutableBuilder[Self <: Dock] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDidAddPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = StObject.set(x, "onDidAddPane", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnDidDestroyPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = StObject.set(x, "onDidDestroyPane", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnWillDestroyPane(value: js.Function1[/* event */ typingsSlinky.atom.anon.Pane, Unit] => Disposable): Self = StObject.set(x, "onWillDestroyPane", js.Any.fromFunction1(value))
