...
object autocompletePlusMod {
  ...
  */
  ...
  object AnySuggestion {
    ...
    @scala.inline
    def SnippetSuggestion(snippet: String): typingsSlinky.atom.autocompletePlusMod.SnippetSuggestion = {
      val __obj = js.Dynamic.literal(snippet = snippet.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.atom.autocompletePlusMod.SnippetSuggestion]
    }
    
    @scala.inline
    def TextSuggestion(text: String): typingsSlinky.atom.autocompletePlusMod.TextSuggestion = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.atom.autocompletePlusMod.TextSuggestion]
    }
  }
