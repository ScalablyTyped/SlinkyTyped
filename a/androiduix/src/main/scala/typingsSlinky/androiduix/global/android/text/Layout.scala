...
abstract class Layout protected ()
  extends typingsSlinky.androiduix.android.text.Layout {
  def this(
    text: String,
...
object Layout {
  ...
  object Alignment extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.androiduix.android.text.Layout.Alignment with Double] = js.native
  ...
  @js.native
  def DIRS_ALL_LEFT_TO_RIGHT: typingsSlinky.androiduix.android.text.Layout.Directions = js.native
  @scala.inline
  def DIRS_ALL_LEFT_TO_RIGHT_=(x: typingsSlinky.androiduix.android.text.Layout.Directions): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DIRS_ALL_LEFT_TO_RIGHT")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("android.text.Layout.DIRS_ALL_RIGHT_TO_LEFT")
  @js.native
  def DIRS_ALL_RIGHT_TO_LEFT: typingsSlinky.androiduix.android.text.Layout.Directions = js.native
  @scala.inline
  def DIRS_ALL_RIGHT_TO_LEFT_=(x: typingsSlinky.androiduix.android.text.Layout.Directions): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DIRS_ALL_RIGHT_TO_LEFT")(x.asInstanceOf[js.Any])
  ...
  class Directions protected ()
    extends typingsSlinky.androiduix.android.text.Layout.Directions {
  ...
  class Ellipsizer protected ()
    extends typingsSlinky.androiduix.android.text.Layout.Ellipsizer {
  ...
  class SpannedEllipsizer protected ()
    extends typingsSlinky.androiduix.android.text.Layout.SpannedEllipsizer {
  ...
  class TabStops protected ()
    extends typingsSlinky.androiduix.android.text.Layout.TabStops {
  ...
  @js.native
  def getDesiredWidth(source: String, paint: typingsSlinky.androiduix.android.text.TextPaint): Double = js.native
  /* static member */
  @JSGlobal("android.text.Layout.getDesiredWidth")
  @js.native
  def getDesiredWidth(source: String, start: Double, end: Double, paint: typingsSlinky.androiduix.android.text.TextPaint): Double = js.native
  ...
  @js.native
  def getParagraphSpans[T](text: typingsSlinky.androiduix.android.text.Spanned, start: Double, end: Double, `type`: js.Any): js.Array[T] = js.native
  
  /* static member */
  @JSGlobal("android.text.Layout.measurePara")
  @js.native
  def measurePara(paint: typingsSlinky.androiduix.android.text.TextPaint, text: String, start: Double, end: Double): Double = js.native
