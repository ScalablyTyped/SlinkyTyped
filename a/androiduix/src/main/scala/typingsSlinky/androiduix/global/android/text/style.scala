...
object style {
  ...
  object CharacterStyle {
    ...
    class PassthroughCharacterStyle protected ()
      extends typingsSlinky.androiduix.android.text.style.CharacterStyle.PassthroughCharacterStyle {
      def this(cs: typingsSlinky.androiduix.android.text.style.CharacterStyle) = this()
    }
  ...
  object LeadingMarginSpan {
    ...
    class Standard protected ()
      extends typingsSlinky.androiduix.android.text.style.LeadingMarginSpan.Standard {
  ...
  object MetricAffectingSpan {
    ...
    class PassthroughMetricAffectingSpan protected ()
      extends typingsSlinky.androiduix.android.text.style.MetricAffectingSpan.PassthroughMetricAffectingSpan {
