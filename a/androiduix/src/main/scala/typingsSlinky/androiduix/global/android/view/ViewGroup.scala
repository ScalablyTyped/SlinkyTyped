...
object ViewGroup extends js.Object {
  ...
  class LayoutParams protected ()
    ...
    def this(src: typingsSlinky.androiduix.android.view.ViewGroup.LayoutParams) = this()
  ...
  class MarginLayoutParams protected ()
    extends typingsSlinky.androiduix.android.view.ViewGroup.MarginLayoutParams {
    def this(args: js.Any*) = this()
    def this(src: typingsSlinky.androiduix.android.view.ViewGroup.LayoutParams) = this()
    def this(src: typingsSlinky.androiduix.android.view.ViewGroup.MarginLayoutParams) = this()
    def this(context: Context, attrs: HTMLElement) = this()
    def this(width: Double, height: Double) = this()
  }
