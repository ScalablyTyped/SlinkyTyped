...
object app {
  ...
  class ActionBar protected ()
    extends typingsSlinky.androiduix.android.app.ActionBar {
  ...
  class ActionBarActivity ()
    extends typingsSlinky.androiduix.android.app.ActionBarActivity
  
  @JSGlobal("android.app.Activity")
  @js.native
  class Activity protected ()
    extends typingsSlinky.androiduix.android.app.Activity {
  ...
  class ActivityThread protected ()
    extends typingsSlinky.androiduix.android.app.ActivityThread {
    def this(androidUI: AndroidUI) = this()
  }
  ...
  @js.native
  class Application ()
    extends typingsSlinky.androiduix.android.app.Application
