...
object method extends js.Object {
  ...
  class AllCapsTransformationMethod ()
    extends typingsSlinky.androiduix.android.text.method.AllCapsTransformationMethod {
  ...
  class PasswordTransformationMethod ()
    extends typingsSlinky.androiduix.android.text.method.PasswordTransformationMethod
  /* static members */
  @js.native
  object PasswordTransformationMethod extends js.Object {
    
    def getInstance(): typingsSlinky.androiduix.android.text.method.PasswordTransformationMethod = js.native
  ...
  abstract class ReplacementTransformationMethod ()
    extends typingsSlinky.androiduix.android.text.method.ReplacementTransformationMethod
  @js.native
  object ReplacementTransformationMethod extends js.Object {
    
    @js.native
    class ReplacementCharSequence protected ()
      extends typingsSlinky.androiduix.android.text.method.ReplacementTransformationMethod.ReplacementCharSequence {
  ...
  class SingleLineTransformationMethod ()
    extends typingsSlinky.androiduix.android.text.method.SingleLineTransformationMethod
  /* static members */
  @js.native
  object SingleLineTransformationMethod extends js.Object {
    ...
    def getInstance(): typingsSlinky.androiduix.android.text.method.SingleLineTransformationMethod = js.native
