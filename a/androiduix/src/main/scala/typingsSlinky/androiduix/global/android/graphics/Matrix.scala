...
@js.native
class Matrix ()
  extends typingsSlinky.androiduix.android.graphics.Matrix {
  def this(src: typingsSlinky.androiduix.android.graphics.Matrix) = this()
...
object Matrix {
  ...
  @js.native
  def IDENTITY_MATRIX: typingsSlinky.androiduix.android.graphics.Matrix = js.native
  @scala.inline
  def IDENTITY_MATRIX_=(x: typingsSlinky.androiduix.android.graphics.Matrix): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IDENTITY_MATRIX")(x.asInstanceOf[js.Any])
  ...
  object ScaleToFit extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.androiduix.android.graphics.Matrix.ScaleToFit with Double] = js.native
