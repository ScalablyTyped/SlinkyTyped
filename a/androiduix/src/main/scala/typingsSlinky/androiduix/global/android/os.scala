...
object os {
  ...
  object MessageQueue {
    ...
    @js.native
    def messages: Set[typingsSlinky.androiduix.android.os.Message] = js.native
    @scala.inline
    def messages_=(x: Set[typingsSlinky.androiduix.android.os.Message]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("messages")(x.asInstanceOf[js.Any])
