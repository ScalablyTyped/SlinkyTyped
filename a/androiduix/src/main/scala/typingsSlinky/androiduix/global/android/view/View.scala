...
object View extends js.Object {
  ...
  class AttachInfo protected ()
    extends typingsSlinky.androiduix.android.view.View.AttachInfo {
    def this(mViewRootImpl: typingsSlinky.androiduix.android.view.ViewRootImpl, mHandler: Handler) = this()
  }
  
  @js.native
  class ListenerInfo ()
    extends typingsSlinky.androiduix.android.view.View.ListenerInfo
  
  @js.native
  class MeasureSpec ()
    extends typingsSlinky.androiduix.android.view.View.MeasureSpec
  
  @js.native
  class TransformationInfo ()
    extends typingsSlinky.androiduix.android.view.View.TransformationInfo
  ...
  def inflate(context: Context, xml: String): typingsSlinky.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: String, root: typingsSlinky.androiduix.android.view.ViewGroup): typingsSlinky.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement): typingsSlinky.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement, root: typingsSlinky.androiduix.android.view.ViewGroup): typingsSlinky.androiduix.android.view.View = js.native
  ...
  object AttachInfo extends js.Object {
    ...
    class InvalidateInfo ()
      extends typingsSlinky.androiduix.android.view.View.AttachInfo.InvalidateInfo
    ...
    object InvalidateInfo extends js.Object {
      ...
      def obtain(): typingsSlinky.androiduix.android.view.View.AttachInfo.InvalidateInfo = js.native
    }
  ...
  object OnClickListener extends js.Object {
    def fromFunction(func: js.Function1[/* v */ typingsSlinky.androiduix.android.view.View, Unit]): typingsSlinky.androiduix.android.view.View.OnClickListener = js.native
  }
  ...
  object OnFocusChangeListener extends js.Object {
    ...
    ): typingsSlinky.androiduix.android.view.View.OnFocusChangeListener = js.native
  }
  ...
  object OnGenericMotionListener extends js.Object {
    def fromFunction(
      func: js.Function2[
          ...
          /* event */ typingsSlinky.androiduix.android.view.MotionEvent, 
          Unit
        ]
    ): typingsSlinky.androiduix.android.view.View.OnGenericMotionListener = js.native
  }
  ...
  object OnKeyListener extends js.Object {
    def fromFunction(
      func: js.Function3[
          /* v */ typingsSlinky.androiduix.android.view.View, 
          /* keyCode */ Double, 
          /* event */ typingsSlinky.androiduix.android.view.KeyEvent, 
          Unit
        ]
    ): typingsSlinky.androiduix.android.view.View.OnKeyListener = js.native
  }
  
  @js.native
  object OnLongClickListener extends js.Object {
    def fromFunction(func: js.Function1[/* v */ typingsSlinky.androiduix.android.view.View, Boolean]): typingsSlinky.androiduix.android.view.View.OnLongClickListener = js.native
  }
  ...
  object OnTouchListener extends js.Object {
    ...
    ): typingsSlinky.androiduix.android.view.View.OnTouchListener = js.native
  }
