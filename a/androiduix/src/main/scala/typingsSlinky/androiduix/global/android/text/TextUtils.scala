...
import typingsSlinky.androiduix.android.text.TextUtils.EllipsizeCallback
...
@js.native
class TextUtils ()
  extends typingsSlinky.androiduix.android.text.TextUtils
/* static members */
@JSGlobal("android.text.TextUtils")
@js.native
object TextUtils extends js.Object {
  ...
  def removeEmptySpans[T](spans: js.Array[T], spanned: typingsSlinky.androiduix.android.text.Spanned, klass: js.Any): js.Array[T] = js.native
  ...
  object TruncateAt extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.androiduix.android.text.TextUtils.TruncateAt with Double] = js.native
