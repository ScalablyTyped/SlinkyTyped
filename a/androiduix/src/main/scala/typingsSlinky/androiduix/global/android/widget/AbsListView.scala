...
abstract class AbsListView protected ()
  extends typingsSlinky.androiduix.android.widget.AbsListView {
...
object AbsListView extends js.Object {
  ...
  class AdapterDataSetObserver protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.AdapterDataSetObserver {
    def this(arg: js.Any) = this()
  }
  
  @js.native
  class CheckForKeyLongPress protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.CheckForKeyLongPress {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  
  @js.native
  class CheckForLongPress protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.CheckForLongPress {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  
  @js.native
  class CheckForTap protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.CheckForTap {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  
  @js.native
  class FlingRunnable protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.FlingRunnable {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  /* static members */
  @js.native
  ...
  class LayoutParams protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.LayoutParams {
  ...
  class PerformClick protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.PerformClick {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  
  @js.native
  class PositionScroller protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.PositionScroller {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  /* static members */
  @js.native
  ...
  class RecycleBin protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.RecycleBin {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
  
  @js.native
  class WindowRunnnable protected ()
    extends typingsSlinky.androiduix.android.widget.AbsListView.WindowRunnnable {
    def this(arg: typingsSlinky.androiduix.android.widget.AbsListView) = this()
  }
}
