    ...
    object senab extends js.Object {
      ...
      object photoview extends js.Object {
        ...
        class GestureDetector ()
          extends typingsSlinky.androiduix.uk.co.senab.photoview.GestureDetector
        /* static members */
        @js.native
        ...
        class PhotoViewAttacher protected ()
          extends typingsSlinky.androiduix.uk.co.senab.photoview.PhotoViewAttacher {
        ...
        object PhotoViewAttacher extends js.Object {
          ...
          class AnimatedZoomRunnable protected ()
            extends typingsSlinky.androiduix.uk.co.senab.photoview.PhotoViewAttacher.AnimatedZoomRunnable {
            def this(
          ...
          class DefaultOnDoubleTapListener protected ()
            extends typingsSlinky.androiduix.uk.co.senab.photoview.PhotoViewAttacher.DefaultOnDoubleTapListener {
          ...
          class FlingRunnable protected ()
            extends typingsSlinky.androiduix.uk.co.senab.photoview.PhotoViewAttacher.FlingRunnable {
            def this(arg: typingsSlinky.androiduix.uk.co.senab.photoview.PhotoViewAttacher) = this()
          }
        }
      }
    }
