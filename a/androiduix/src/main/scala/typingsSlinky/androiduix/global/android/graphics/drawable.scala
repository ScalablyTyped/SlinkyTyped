...
object drawable {
  ...
  @js.native
  class ColorDrawable ()
    extends typingsSlinky.androiduix.android.graphics.drawable.ColorDrawable {
  ...
  class DrawableContainer ()
    extends typingsSlinky.androiduix.android.graphics.drawable.DrawableContainer
  object DrawableContainer {
    ...
    class DrawableContainerState protected ()
      extends typingsSlinky.androiduix.android.graphics.drawable.DrawableContainer.DrawableContainerState {
      def this(
        orig: typingsSlinky.androiduix.android.graphics.drawable.DrawableContainer.DrawableContainerState,
        owner: typingsSlinky.androiduix.android.graphics.drawable.DrawableContainer
      ) = this()
    }
  ...
  class InsetDrawable protected ()
    extends typingsSlinky.androiduix.android.graphics.drawable.InsetDrawable {
    def this(drawable: typingsSlinky.androiduix.android.graphics.drawable.Drawable, insetLeft: Double) = this()
    def this(
      drawable: typingsSlinky.androiduix.android.graphics.drawable.Drawable,
      insetLeft: Double,
      insetTop: Double
  ...
  object RotateDrawable {
    ...
    class RotateState protected ()
      ...
      def this(
        source: typingsSlinky.androiduix.android.graphics.drawable.RotateDrawable.RotateState,
  ...
  class ScrollBarDrawable ()
    extends typingsSlinky.androiduix.android.graphics.drawable.ScrollBarDrawable
  ...
  class StateListDrawable ()
    extends typingsSlinky.androiduix.android.graphics.drawable.StateListDrawable
}
