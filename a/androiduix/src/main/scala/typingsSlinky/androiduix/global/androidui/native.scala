...
object native {
  ...
  object NativeApi {
    ...
    @js.native
    def canvas: typingsSlinky.androiduix.androidui.native.NativeApi.CanvasApi = js.native
    @scala.inline
    def canvas_=(x: typingsSlinky.androiduix.androidui.native.NativeApi.CanvasApi): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("canvas")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def surface: typingsSlinky.androiduix.androidui.native.NativeApi.SurfaceApi = js.native
    @scala.inline
    def surface_=(x: typingsSlinky.androiduix.androidui.native.NativeApi.SurfaceApi): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("surface")(x.asInstanceOf[js.Any])
