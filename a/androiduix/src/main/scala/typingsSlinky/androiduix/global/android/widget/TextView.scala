...
object TextView extends js.Object {
  ...
  class ChangeWatcher protected ()
    extends typingsSlinky.androiduix.android.widget.TextView.ChangeWatcher {
    def this(arg: typingsSlinky.androiduix.android.widget.TextView) = this()
  }
  
  @js.native
  class Drawables ()
    extends typingsSlinky.androiduix.android.widget.TextView.Drawables {
    def this(context: js.Any) = this()
  }
  
  @js.native
  class Marquee protected ()
    extends typingsSlinky.androiduix.android.widget.TextView.Marquee {
    def this(v: typingsSlinky.androiduix.android.widget.TextView) = this()
  }
  ...
  object BufferType extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsSlinky.androiduix.android.widget.TextView.BufferType with Double] = js.native
  }
