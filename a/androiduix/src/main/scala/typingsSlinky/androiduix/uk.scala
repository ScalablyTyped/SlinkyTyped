      ...
      object photoview {
        ...
        object GestureDetector {
          ...
          def apply(
            ...
            mLastTouchX: Double,
            mLastTouchY: Double,
            mListener: typingsSlinky.androiduix.android.view.GestureDetector.OnGestureListener,
            mMinimumVelocity: Double,
            mScaleDetector: ScaleGestureDetector,
            mTouchSlop: Double,
            mVelocityTracker: js.Any,
            onTouchEvent: MotionEvent => Boolean,
            setOnGestureListener: typingsSlinky.androiduix.android.view.GestureDetector.OnGestureListener => Unit
          ): GestureDetector = {
          ...
          implicit class GestureDetectorMutableBuilder[Self <: GestureDetector] (val x: Self) extends AnyVal {
            ...
            @scala.inline
            def setMListener(value: typingsSlinky.androiduix.android.view.GestureDetector.OnGestureListener): Self = StObject.set(x, "mListener", value.asInstanceOf[js.Any])
            ...
            @scala.inline
            def setSetOnGestureListener(value: typingsSlinky.androiduix.android.view.GestureDetector.OnGestureListener => Unit): Self = StObject.set(x, "setOnGestureListener", js.Any.fromFunction1(value))
          }
          ...
          object OnGestureListener {
            ...
            def apply(
            ...
            ): typingsSlinky.androiduix.uk.co.senab.photoview.GestureDetector.OnGestureListener = {
              ...
              __obj.asInstanceOf[typingsSlinky.androiduix.uk.co.senab.photoview.GestureDetector.OnGestureListener]
            }
            
            @scala.inline
            implicit class OnGestureListenerMutableBuilder[Self <: typingsSlinky.androiduix.uk.co.senab.photoview.GestureDetector.OnGestureListener] (val x: Self) extends AnyVal {
