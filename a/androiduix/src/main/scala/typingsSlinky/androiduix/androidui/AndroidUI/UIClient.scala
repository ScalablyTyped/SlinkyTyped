...
object UIClient {
  ...
  implicit class UIClientOps[Self <: UIClient] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShouldShowAppClosed(value: /* androidUI */ typingsSlinky.androiduix.androidui.AndroidUI => _): Self = this.set("shouldShowAppClosed", js.Any.fromFunction1(value))
    @scala.inline
