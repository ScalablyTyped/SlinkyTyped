package typingsSlinky.androiduix.android.text.style.CharacterStyle
...
trait PassthroughCharacterStyle
  extends typingsSlinky.androiduix.android.text.style.CharacterStyle {
...
object PassthroughCharacterStyle {
  @scala.inline
  def apply(
    getUnderlying: () => typingsSlinky.androiduix.android.text.style.CharacterStyle,
    mStyle: js.Any,
    mType: js.Symbol,
  ...
  implicit class PassthroughCharacterStyleOps[Self <: PassthroughCharacterStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMStyle(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mStyle")(value.asInstanceOf[js.Any])
        ret
    }
  }
