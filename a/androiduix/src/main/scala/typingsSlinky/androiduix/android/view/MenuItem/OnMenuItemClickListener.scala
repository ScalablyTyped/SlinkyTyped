package typingsSlinky.androiduix.android.view.MenuItem
...
object OnMenuItemClickListener {
  ...
  implicit class OnMenuItemClickListenerOps[Self <: OnMenuItemClickListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnMenuItemClick(value: typingsSlinky.androiduix.android.view.MenuItem => Boolean): Self = this.set("onMenuItemClick", js.Any.fromFunction1(value))
  }
