...
object ListSelectorHider {
  ...
  implicit class ListSelectorHiderOps[Self <: ListSelectorHider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_ListPopupWindow_this(value: typingsSlinky.androiduix.android.widget.ListPopupWindow): Self = this.set("_ListPopupWindow_this", value.asInstanceOf[js.Any])
  }
}
