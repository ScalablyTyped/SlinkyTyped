...
object BufferType extends js.Object {
  ...
  /* 2 */ val EDITABLE: typingsSlinky.androiduix.android.widget.TextView.BufferType.EDITABLE with Double = js.native
  /* 0 */ val NORMAL: typingsSlinky.androiduix.android.widget.TextView.BufferType.NORMAL with Double = js.native
  /* 1 */ val SPANNABLE: typingsSlinky.androiduix.android.widget.TextView.BufferType.SPANNABLE with Double = js.native
  @JSBracketAccess
