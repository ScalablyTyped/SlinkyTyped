...
object WindowManager {
  ...
  def apply(
    ...
    updateWindowLayout: (Window, typingsSlinky.androiduix.android.view.ViewGroup.LayoutParams) => Unit
  ): WindowManager = {
  ...
  trait LayoutParams
    ...
    def copyFrom(o: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams): Double = js.native
  ...
  object LayoutParams {
    ...
    def apply(
      _attrBinder: js.Any,
      bottomMargin: Double,
      copyFrom: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams => Double,
      ...
      x: Double,
      y: Double
    ): typingsSlinky.androiduix.android.view.WindowManager.LayoutParams = {
      ...
      __obj.asInstanceOf[typingsSlinky.androiduix.android.view.WindowManager.LayoutParams]
    }
    
    @scala.inline
    implicit class LayoutParamsMutableBuilder[Self <: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCopyFrom(value: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams => Double): Self = StObject.set(x, "copyFrom", js.Any.fromFunction1(value))
  ...
  implicit class WindowManagerMutableBuilder[Self <: WindowManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUpdateWindowLayout(value: (Window, typingsSlinky.androiduix.android.view.ViewGroup.LayoutParams) => Unit): Self = StObject.set(x, "updateWindowLayout", js.Any.fromFunction2(value))
  }
}
