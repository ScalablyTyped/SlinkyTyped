...
object MyDataSetObserver {
  ...
  implicit class MyDataSetObserverOps[Self <: MyDataSetObserver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_ExpandableListConnector_this(value: typingsSlinky.androiduix.android.widget.ExpandableListConnector): Self = this.set("_ExpandableListConnector_this", value.asInstanceOf[js.Any])
  }
}
