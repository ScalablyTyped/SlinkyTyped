...
trait MyDataSetObserver extends DataSetObserver {
  var _ExpandableListConnector_this: typingsSlinky.androiduix.android.widget.ExpandableListConnector = js.native
}

object MyDataSetObserver {
  @scala.inline
  def apply(
    _ExpandableListConnector_this: typingsSlinky.androiduix.android.widget.ExpandableListConnector,
    onChanged: () => Unit,
    onInvalidated: () => Unit
  ): MyDataSetObserver = {
  ...
  implicit class MyDataSetObserverOps[Self <: MyDataSetObserver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_ExpandableListConnector_this(value: typingsSlinky.androiduix.android.widget.ExpandableListConnector): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_ExpandableListConnector_this")(value.asInstanceOf[js.Any])
        ret
    }
  }
