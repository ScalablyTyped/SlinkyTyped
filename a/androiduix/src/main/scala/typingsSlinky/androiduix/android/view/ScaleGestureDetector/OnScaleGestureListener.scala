...
trait OnScaleGestureListener extends js.Object {
  def onScale(detector: typingsSlinky.androiduix.android.view.ScaleGestureDetector): Boolean
  def onScaleBegin(detector: typingsSlinky.androiduix.android.view.ScaleGestureDetector): Boolean
  def onScaleEnd(detector: typingsSlinky.androiduix.android.view.ScaleGestureDetector): Unit
}
