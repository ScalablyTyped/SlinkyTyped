...
trait OnShowListener extends js.Object {
  ...
  def onShow(dialog: typingsSlinky.androiduix.android.content.DialogInterface): Unit = js.native
}
object OnShowListener {
  ...
  implicit class OnShowListenerOps[Self <: OnShowListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnShow(value: typingsSlinky.androiduix.android.content.DialogInterface => Unit): Self = this.set("onShow", js.Any.fromFunction1(value))
  }
}
