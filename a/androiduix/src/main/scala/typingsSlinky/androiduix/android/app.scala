...
object app {
  ...
  object AlertController {
    ...
    trait AlertParams extends StObject {
      ...
      var mNegativeButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener = js.native
      
      var mNegativeButtonText: String = js.native
      
      var mNeutralButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener = js.native
      ...
      var mOnClickListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener = js.native
      ...
      var mPositiveButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener = js.native
    ...
    object AlertParams {
      ...
      def apply(
        ...
        mLabelColumn: String,
        mMessage: String,
        mNegativeButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener,
        mNegativeButtonText: String,
        mNeutralButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener,
        mNeutralButtonText: String,
        mOnCancelListener: OnCancelListener,
        mOnCheckboxClickListener: OnMultiChoiceClickListener,
        mOnClickListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener,
        mOnDismissListener: OnDismissListener,
        mOnItemSelectedListener: OnItemSelectedListener,
        mOnKeyListener: OnKeyListener,
        mOnPrepareListViewListener: OnPrepareListViewListener,
        mPositiveButtonListener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener,
      ...
      implicit class AlertParamsMutableBuilder[Self <: AlertParams] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setMNegativeButtonListener(value: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Self = StObject.set(x, "mNegativeButtonListener", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setMNegativeButtonText(value: String): Self = StObject.set(x, "mNegativeButtonText", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setMNeutralButtonListener(value: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Self = StObject.set(x, "mNeutralButtonListener", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setMOnClickListener(value: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Self = StObject.set(x, "mOnClickListener", value.asInstanceOf[js.Any])
        ...
        @scala.inline
        def setMPositiveButtonListener(value: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Self = StObject.set(x, "mPositiveButtonListener", value.asInstanceOf[js.Any])
  ...
  object AlertDialog {
    ...
    trait Builder extends StObject {
      ...
      def setNegativeButton(text: String, listener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Builder = js.native
      
      def setNeutralButton(text: String, listener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Builder = js.native
      ...
      def setPositiveButton(text: String, listener: typingsSlinky.androiduix.android.content.DialogInterface.OnClickListener): Builder = js.native
