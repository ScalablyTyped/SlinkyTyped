...
object Window {
  ...
  trait Callback extends StObject {
    ...
    def onWindowAttributesChanged(attrs: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams): Unit = js.native
  ...
  object Callback {
    ...
    def apply(
      ...
      onWindowAttributesChanged: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams => Unit,
    ...
    implicit class CallbackMutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnWindowAttributesChanged(value: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams => Unit): Self = StObject.set(x, "onWindowAttributesChanged", js.Any.fromFunction1(value))
