...
object ^ extends js.Object {
  ...
  def inflate(context: Context, xml: String, root: ViewGroup): typingsSlinky.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement): typingsSlinky.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement, root: ViewGroup): typingsSlinky.androiduix.android.view.View = js.native
