...
trait Window_ extends js.Object {
  ...
  def getAttributes(): typingsSlinky.androiduix.android.view.WindowManager.LayoutParams = js.native
  ...
  def setAttributes(a: typingsSlinky.androiduix.android.view.WindowManager.LayoutParams): Unit = js.native
