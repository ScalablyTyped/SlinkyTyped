package typingsSlinky.androiduix.android.view.menu.MenuPopupHelper
...
trait MenuAdapter extends BaseAdapter {
  var _MenuPopupHelper_this: typingsSlinky.androiduix.android.view.menu.MenuPopupHelper = js.native
...
object MenuAdapter {
  @scala.inline
  def apply(
    _MenuPopupHelper_this: typingsSlinky.androiduix.android.view.menu.MenuPopupHelper,
  ...
  implicit class MenuAdapterOps[Self <: MenuAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with_MenuPopupHelper_this(value: typingsSlinky.androiduix.android.view.menu.MenuPopupHelper): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("_MenuPopupHelper_this")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMAdapterMenu(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mAdapterMenu")(value.asInstanceOf[js.Any])
        ret
    }
  }
