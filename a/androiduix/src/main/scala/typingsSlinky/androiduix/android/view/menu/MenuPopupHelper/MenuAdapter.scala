...
object MenuAdapter {
  ...
  implicit class MenuAdapterOps[Self <: MenuAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_MenuPopupHelper_this(value: typingsSlinky.androiduix.android.view.menu.MenuPopupHelper): Self = this.set("_MenuPopupHelper_this", value.asInstanceOf[js.Any])
    @scala.inline
