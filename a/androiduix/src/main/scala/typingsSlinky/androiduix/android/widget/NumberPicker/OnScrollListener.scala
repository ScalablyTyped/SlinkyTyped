...
object OnScrollListener {
  ...
  implicit class OnScrollListenerOps[Self <: OnScrollListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnScrollStateChange(value: (typingsSlinky.androiduix.android.widget.NumberPicker, Double) => Unit): Self = this.set("onScrollStateChange", js.Any.fromFunction2(value))
  }
}
