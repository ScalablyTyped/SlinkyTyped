...
object OnAttachStateChangeListener {
  ...
  implicit class OnAttachStateChangeListenerOps[Self <: OnAttachStateChangeListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnViewAttachedToWindow(value: typingsSlinky.androiduix.android.view.View => js.Any): Self = this.set("onViewAttachedToWindow", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnViewDetachedFromWindow(value: typingsSlinky.androiduix.android.view.View => js.Any): Self = this.set("onViewDetachedFromWindow", js.Any.fromFunction1(value))
  }
}
