...
object Authenticator {
  ...
  implicit class AuthenticatorOps[Self <: Authenticator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEstablishCredentials(value: () => typingsSlinky.bluebird.mod.^[Unit]): Self = this.set("establishCredentials", js.Any.fromFunction0(value))
    
    @scala.inline
    def setRefreshCredentials(value: () => typingsSlinky.bluebird.mod.^[Boolean]): Self = this.set("refreshCredentials", js.Any.fromFunction0(value))
  }
}
