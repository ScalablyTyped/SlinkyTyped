...
import typingsSlinky.asana.anon.CreateParamsworkspacenumb
...
trait Projects_ extends Resource {
  ...
  /**
    ...
    * @return
    */
  def create(data: CreateParamsworkspacenumb): typingsSlinky.bluebird.mod.^[Type] = js.native
  def create(data: CreateParamsworkspacenumb, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[Type] = js.native
  /**
