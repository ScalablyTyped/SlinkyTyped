...
object Events extends Shortcut {
  ...
  trait EventProject extends StObject {
    ...
    var followers: js.UndefOr[js.Array[typingsSlinky.asana.mod.resources.Resource]] = js.native
    ...
    var parent: js.UndefOr[typingsSlinky.asana.mod.resources.Resource] = js.native
    
    var projects: js.UndefOr[js.Array[typingsSlinky.asana.mod.resources.Resource]] = js.native
    
    var resource_subtype: String = js.native
    
    var resource_type: String = js.native
    
    var tags: js.UndefOr[js.Array[typingsSlinky.asana.mod.resources.Resource]] = js.native
    
    var workspace: js.UndefOr[typingsSlinky.asana.mod.resources.Resource] = js.native
  }
  ...
  trait EventStory extends StObject {
    ...
    var created_by: js.UndefOr[typingsSlinky.asana.mod.resources.Resource] = js.native
    ...
    var target: js.UndefOr[typingsSlinky.asana.mod.resources.Resource] = js.native
