...
object Projects extends Shortcut {
  ...
  trait Status extends StObject {
    ...
    var author: typingsSlinky.asana.mod.resources.Resource = js.native
  ...
  object Status {
    ...
    @scala.inline
    def apply(
      author: typingsSlinky.asana.mod.resources.Resource,
      color: String,
      html_text: String,
      modified_at: String,
      text: String
    ...
    implicit class StatusMutableBuilder[Self <: Status] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuthor(value: typingsSlinky.asana.mod.resources.Resource): Self = StObject.set(x, "author", value.asInstanceOf[js.Any])
  ...
  trait Type
    ...
    var followers: js.Array[typingsSlinky.asana.mod.resources.Resource] = js.native
    
    var members: js.Array[typingsSlinky.asana.mod.resources.Resource] = js.native
    ...
    var team: typingsSlinky.asana.mod.resources.Resource = js.native
    
    var workspace: typingsSlinky.asana.mod.resources.Resource = js.native
  }
