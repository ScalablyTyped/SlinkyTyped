...
class ClientCls protected ()
  extends typingsSlinky.asana.mod.Client {
  /**
    ...
    */
  def this(dispatcher: typingsSlinky.asana.mod.Dispatcher) = this()
  def this(dispatcher: typingsSlinky.asana.mod.Dispatcher, options: ClientOptions) = this()
}
