...
trait DispatcherStatic
  ...
  *     request to finish.
  */
Instantiable0[typingsSlinky.asana.mod.Dispatcher]
     with Instantiable1[/* options */ DispatcherOptions, typingsSlinky.asana.mod.Dispatcher] {
  ...
  /**
    ...
    * @return
    */
  def maybeReauthorize(): typingsSlinky.bluebird.mod.^[Boolean] = js.native
}
