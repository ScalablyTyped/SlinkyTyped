...
object Tasks extends Shortcut {
  ...
  trait Type
    ...
    var parent: typingsSlinky.asana.mod.resources.Resource = js.native
    
    var projects: js.Array[typingsSlinky.asana.mod.resources.Resource] = js.native
    
    var tags: js.Array[typingsSlinky.asana.mod.resources.Resource] = js.native
