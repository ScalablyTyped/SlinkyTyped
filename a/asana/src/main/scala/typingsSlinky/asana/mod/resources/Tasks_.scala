...
trait Tasks_ extends Resource {
  ...
  /**
    ...
    * @return
    */
  def create(data: CreateParamsworkspacestri): typingsSlinky.bluebird.mod.^[typingsSlinky.asana.mod.resources.Tasks.Type] = js.native
  def create(data: CreateParamsworkspacestri, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[typingsSlinky.asana.mod.resources.Tasks.Type] = js.native
  /**
    * * Creating a new task is as easy as POSTing to the `/tasks` endpoint
    * * with a data block containing the fields you'd like to set on the task.
    * * Any unspecified fields will take on default values.
