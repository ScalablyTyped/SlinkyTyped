...
trait Dispatcher extends js.Object {
  ...
  /**
    ...
    * @return
    */
  def authorize(): typingsSlinky.bluebird.mod.^[Unit] = js.native
  ...
  /**
    ...
    * @return
    */
  def delete(path: String): typingsSlinky.bluebird.mod.^[_] = js.native
  def delete(path: String, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @return
    */
  def dispatch(params: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def dispatch(params: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @return
    */
  def get(path: String): typingsSlinky.bluebird.mod.^[_] = js.native
  def get(path: String, query: js.UndefOr[scala.Nothing], dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def get(path: String, query: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def get(path: String, query: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @type {Function}
    */
  def handleUnauthorized(): Boolean | typingsSlinky.bluebird.mod.^[Boolean] = js.native
  ...
  /**
    ...
    * @return
    */
  def post(path: String, data: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def post(path: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  /**
    ...
    * @return
    */
  def put(path: String, data: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def put(path: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
