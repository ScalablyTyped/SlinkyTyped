...
class Webhooks protected () extends Resource {
  ...
  /**
    ...
    * @return
    */
  def create(resource: Double, target: String, data: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  def create(resource: Double, target: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.mod.^[_] = js.native
  /**
