...
@js.native
trait ResourceList[T /* <: typingsSlinky.asana.mod.resources.Resource */] extends StObject {
...
object ResourceList {
  ...
  @scala.inline
  def apply[T /* <: typingsSlinky.asana.mod.resources.Resource */](
  ...
  @scala.inline
  implicit class ResourceListMutableBuilder[Self <: ResourceList[_], T /* <: typingsSlinky.asana.mod.resources.Resource */] (val x: Self with ResourceList[T]) extends AnyVal {
    ...
    @scala.inline
    def setNextPage(value: () => typingsSlinky.bluebird.mod.^[ResourceList[T] | Null]): Self = StObject.set(x, "nextPage", js.Any.fromFunction0(value))
