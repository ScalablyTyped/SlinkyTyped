...
class OauthAuthenticatorCls protected () extends OauthAuthenticator {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def establishCredentials(): typingsSlinky.bluebird.mod.^[Unit] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def refreshCredentials(): typingsSlinky.bluebird.mod.^[Boolean] = js.native
}
