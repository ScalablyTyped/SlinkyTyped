...
import typingsSlinky.asana.asanaMod.Dispatcher
...
Instantiable1[/* dispatcher */ Dispatcher, Resource] {
  ...
  /**
    ...
    */
  def getCollection(dispatcher: js.Any, path: String): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getCollection(dispatcher: js.Any, path: String, query: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getCollection(dispatcher: js.Any, path: String, query: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def unwrap(promise: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
}
