...
trait DispatcherOptions extends js.Object {
  ...
  var handleUnauthorized: js.UndefOr[js.Function0[Boolean | typingsSlinky.bluebird.bluebirdMod.^[Boolean]]] = js.undefined
...
object DispatcherOptions {
  ...
  def apply(
    ...
    handleUnauthorized: () => Boolean | typingsSlinky.bluebird.bluebirdMod.^[Boolean] = null,
