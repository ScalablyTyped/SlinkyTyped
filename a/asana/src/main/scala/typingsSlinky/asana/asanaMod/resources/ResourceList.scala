...
import typingsSlinky.asana.Anon_AsanaBaseUrl
import typingsSlinky.asana.Anon_Data
...
trait ResourceList[T /* <: Resource */] extends js.Object {
  ...
  /**
    ...
    */
  def nextPage(): typingsSlinky.bluebird.bluebirdMod.^[ResourceList[T] | Null]
}
...
object ResourceList {
  ...
  def apply[T /* <: Resource */](
    ...
    data: js.Array[T],
    nextPage: () => typingsSlinky.bluebird.bluebirdMod.^[ResourceList[T] | Null]
  ): ResourceList[T] = {
