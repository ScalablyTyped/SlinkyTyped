package typingsSlinky.asana.asanaMod.auth
...
class OauthAuthenticatorCls protected () extends OauthAuthenticator {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def establishCredentials(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def refreshCredentials(): typingsSlinky.bluebird.bluebirdMod.^[Boolean] = js.native
}
