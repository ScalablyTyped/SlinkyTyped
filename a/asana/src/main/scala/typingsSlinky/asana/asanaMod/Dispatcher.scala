...
import typingsSlinky.asana.asanaMod.auth.Authenticator
...
trait Dispatcher extends js.Object {
  ...
  /**
    ...
    * @return
    */
  def authorize(): typingsSlinky.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    * @return
    */
  def delete(path: String): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def delete(path: String, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def dispatch(params: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def dispatch(params: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def get(path: String): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def get(path: String, query: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def get(path: String, query: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @type {Function}
    */
  def handleUnauthorized(): Boolean | typingsSlinky.bluebird.bluebirdMod.^[Boolean] = js.native
  /**
    ...
    * @return
    */
  def post(path: String, data: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def post(path: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def put(path: String, data: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def put(path: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
