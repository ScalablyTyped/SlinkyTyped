...
trait App extends js.Object {
  ...
  /**
    ...
    * @return
    */
  def accessTokenFromCode(code: String): typingsSlinky.bluebird.bluebirdMod.^[Credentials] = js.native
  def accessTokenFromCode(code: String, options: AsanaAuthorizeUrlOptions): typingsSlinky.bluebird.bluebirdMod.^[Credentials] = js.native
  /**
    ...
    * @return
    */
  def accessTokenFromRefreshToken(refreshToken: String, options: AsanaAuthorizeUrlOptions): typingsSlinky.bluebird.bluebirdMod.^[Credentials] = js.native
  /**
    * @param {Object} options  Overrides to the app's defaults
    * @option {String} asanaBaseUrl
    * @option {String} redirectUri
