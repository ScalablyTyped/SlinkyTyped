...
class Webhooks protected () extends Resource {
  ...
  /**
    ...
    * @return
    */
  def create(resource: Double, target: String, data: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def create(resource: Double, target: String, data: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def deleteById(webhook: String): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def deleteById(webhook: String, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def getAll(workspace: Double): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getAll(workspace: Double, params: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getAll(workspace: Double, params: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def getById(webhook: String): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getById(webhook: String, params: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
  def getById(webhook: String, params: js.Any, dispatchOptions: js.Any): typingsSlinky.bluebird.bluebirdMod.^[_] = js.native
}
