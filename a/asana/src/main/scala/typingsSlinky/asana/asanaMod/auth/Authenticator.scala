...
trait Authenticator extends js.Object {
  /**
    ...
    * @return
    */
  def establishCredentials(): typingsSlinky.bluebird.bluebirdMod.^[Unit]
  /**
    ...
    * @return
    */
  def refreshCredentials(): typingsSlinky.bluebird.bluebirdMod.^[Boolean]
}

object Authenticator {
  @scala.inline
  def apply(
    establishCredentials: () => typingsSlinky.bluebird.bluebirdMod.^[Unit],
    refreshCredentials: () => typingsSlinky.bluebird.bluebirdMod.^[Boolean]
  ): Authenticator = {
