...
import typingsSlinky.asana.asanaMod.resources.Events.Type
...
trait Events_ extends Resource {
  /**
    ...
    */
  def get(resourceId: String): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
  def get(resourceId: String, syncToken: String): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
  def get(resourceId: String, syncToken: String, params: Params): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
  def get(resourceId: Double): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
  def get(resourceId: Double, syncToken: String): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
  def get(resourceId: Double, syncToken: String, params: Params): typingsSlinky.bluebird.bluebirdMod.^[Type] = js.native
}
