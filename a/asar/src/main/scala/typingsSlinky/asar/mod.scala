...
import typingsSlinky.asar.anon.Stat
import typingsSlinky.asar.asarBooleans.`true`
...
object mod {
  ...
  */
  ...
  object Metadata {
    ...
    @scala.inline
    def DirectoryMetadata(files: StringDictionary[EntryMetadata], unpacked: Boolean): typingsSlinky.asar.mod.DirectoryMetadata = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.asar.mod.DirectoryMetadata]
    }
    
    @scala.inline
    def FileMetadata(unpacked: Boolean): typingsSlinky.asar.mod.FileMetadata = {
      val __obj = js.Dynamic.literal(unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.asar.mod.FileMetadata]
    }
    
    @scala.inline
    def LinkMetadata(link: String): typingsSlinky.asar.mod.LinkMetadata = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.asar.mod.LinkMetadata]
    }
  }
}
