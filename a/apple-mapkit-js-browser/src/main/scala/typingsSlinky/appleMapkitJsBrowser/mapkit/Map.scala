...
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`double-tap`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-end`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-start`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`long-press`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`map-type-change`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`region-change-end`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`region-change-start`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`scroll-end`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`scroll-start`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`single-tap`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`user-location-change`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`user-location-error`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`zoom-end`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`zoom-start`
import typingsSlinky.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.deselect
...
trait Map extends StObject {
  ...
  def addEventListener_deselect[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_dragging[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typingsSlinky.appleMapkitJsBrowser.anon.Coordinate, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
