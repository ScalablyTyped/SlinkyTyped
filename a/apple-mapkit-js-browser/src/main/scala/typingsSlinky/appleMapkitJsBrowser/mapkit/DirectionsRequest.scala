...
object DirectionsRequest {
  ...
  implicit class DirectionsRequestOps[Self <: DirectionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArrivalDate(value: js.Date): Self = this.set("arrivalDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteArrivalDate: Self = this.set("arrivalDate", js.undefined)
    
    @scala.inline
    def setDepartureDate(value: js.Date): Self = this.set("departureDate", value.asInstanceOf[js.Any])
