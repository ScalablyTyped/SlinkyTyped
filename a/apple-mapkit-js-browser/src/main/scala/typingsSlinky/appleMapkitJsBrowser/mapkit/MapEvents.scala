...
import typingsSlinky.appleMapkitJsBrowser.anon.AnnotationAnnotation
import typingsSlinky.appleMapkitJsBrowser.anon.Code
import typingsSlinky.appleMapkitJsBrowser.anon.Timestamp
...
trait MapEvents[T] extends StObject {
  ...
  var deselect: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation = js.native
  ...
  var dragging: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Coordinate = js.native
  ...
  // Annotation Events
  var select: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation = js.native
...
object MapEvents {
  ...
  @scala.inline
  def apply[T](
    deselect: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation,
    `double-tap`: EventBase[T],
    `drag-end`: EventBase[T] with AnnotationAnnotation,
    `drag-start`: EventBase[T] with AnnotationAnnotation,
    dragging: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Coordinate,
    ...
    select: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation,
  ...
  implicit class MapEventsMutableBuilder[Self <: MapEvents[_], T] (val x: Self with MapEvents[T]) extends AnyVal {
    ...
    @scala.inline
    def setDeselect(value: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation): Self = StObject.set(x, "deselect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDragging(value: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Coordinate): Self = StObject.set(x, "dragging", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSelect(value: EventBase[T] with typingsSlinky.appleMapkitJsBrowser.anon.Annotation): Self = StObject.set(x, "select", value.asInstanceOf[js.Any])
