...
object Circle {
  ...
  @scala.inline
  def apply(Circle: String, None: String, Rectangle: String): Circle = {
    val __obj = js.Dynamic.literal(Circle = Circle.asInstanceOf[js.Any], None = None.asInstanceOf[js.Any], Rectangle = Rectangle.asInstanceOf[js.Any])
