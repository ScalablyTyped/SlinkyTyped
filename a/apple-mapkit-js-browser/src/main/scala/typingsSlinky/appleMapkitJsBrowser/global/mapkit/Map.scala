...
import typingsSlinky.appleMapkitJsBrowser.anon.Adaptive
import typingsSlinky.appleMapkitJsBrowser.anon.Dark
import typingsSlinky.appleMapkitJsBrowser.anon.Hybrid
