...
import typingsSlinky.appleMapkitJsBrowser.mapkit.AnnotationConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.CameraZoomRangeConstructorOptions
...
import typingsSlinky.appleMapkitJsBrowser.mapkit.GeocoderConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.ImageAnnotationConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.ImportGeoJSONCallback
import typingsSlinky.appleMapkitJsBrowser.mapkit.InitializationEvent
import typingsSlinky.appleMapkitJsBrowser.mapkit.InitializationEventType
import typingsSlinky.appleMapkitJsBrowser.mapkit.ItemCollection
import typingsSlinky.appleMapkitJsBrowser.mapkit.MapConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.MapKitInitOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.MarkerAnnotationConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.PaddingConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory
import typingsSlinky.appleMapkitJsBrowser.mapkit.PointsOfInterestSearchOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.SearchConstructorOptions
import typingsSlinky.appleMapkitJsBrowser.mapkit.StyleConstructorOptions
...
object global {
  ...
  object mapkit {
    ...
    class Annotation protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Annotation {
      /**
    ...
    class BoundingRegion protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.BoundingRegion {
      /**
    ...
    class CameraZoomRange protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.CameraZoomRange {
    ...
    class CircleOverlay protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.CircleOverlay {
      /**
        ...
        * the circle.
        */
      def this(coordinate: typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate, radius: Double) = this()
      def this(
        coordinate: typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate,
        radius: Double,
    ...
    class Coordinate protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate {
      /**
    ...
    class CoordinateRegion protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.CoordinateRegion {
      /**
        ...
        */
      def this(
        center: typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate,
        span: typingsSlinky.appleMapkitJsBrowser.mapkit.CoordinateSpan
      ) = this()
    }
    ...
    class CoordinateSpan protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.CoordinateSpan {
      /**
    ...
    /**
      ...
      */
    class Geocoder ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Geocoder {
    ...
    /**
      ...
      */
    class LineGradient ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.LineGradient {
    ...
    @js.native
    class Map protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Map {
      /**
    ...
    class MapPoint protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.MapPoint {
      /**
    ...
    class MapRect protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.MapRect {
      /**
    ...
    class MapSize protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.MapSize {
      /**
    ...
    class MarkerAnnotation protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.MarkerAnnotation {
      /**
        * Creates a marker annotation at the coordinate location with provided options.
        *
        * @param coordinate The coordinate at which this annotation should appear.
        * @param options A hash of properties with which to initialize the annotation.
        */
      def this(coordinate: typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate) = this()
      def this(
        coordinate: typingsSlinky.appleMapkitJsBrowser.mapkit.Coordinate,
    ...
    abstract class Overlay ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Overlay
    ...
    /**
      ...
      */
    class Padding ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Padding {
    ...
    object PointOfInterestCategory extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory with Double] = js.native
      
      /* 3 */ val ATM: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.ATM with Double = js.native
      
      /* 0 */ val Airport: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Airport with Double = js.native
      
      /* 1 */ val AmusementPark: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.AmusementPark with Double = js.native
      
      /* 2 */ val Aquarium: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Aquarium with Double = js.native
      
      /* 4 */ val Bakery: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Bakery with Double = js.native
      
      /* 5 */ val Bank: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Bank with Double = js.native
      
      /* 6 */ val Beach: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Beach with Double = js.native
      
      /* 7 */ val Brewery: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Brewery with Double = js.native
      
      /* 8 */ val Cafe: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Cafe with Double = js.native
      
      /* 9 */ val Campground: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Campground with Double = js.native
      
      /* 10 */ val CarRental: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.CarRental with Double = js.native
      
      /* 11 */ val EVCharger: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.EVCharger with Double = js.native
      
      /* 12 */ val FireStation: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FireStation with Double = js.native
      
      /* 13 */ val FitnessCenter: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FitnessCenter with Double = js.native
      
      /* 14 */ val FoodMarket: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FoodMarket with Double = js.native
      
      /* 15 */ val GasStation: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.GasStation with Double = js.native
      
      /* 16 */ val Hospital: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Hospital with Double = js.native
      
      /* 17 */ val Hotel: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Hotel with Double = js.native
      
      /* 18 */ val Laundry: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Laundry with Double = js.native
      
      /* 19 */ val Library: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Library with Double = js.native
      
      /* 20 */ val Marina: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Marina with Double = js.native
      
      /* 21 */ val MovieTheater: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.MovieTheater with Double = js.native
      
      /* 22 */ val Museum: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Museum with Double = js.native
      
      /* 23 */ val NationalPark: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.NationalPark with Double = js.native
      
      /* 24 */ val Nightlife: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Nightlife with Double = js.native
      
      /* 25 */ val Park: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Park with Double = js.native
      
      /* 26 */ val Parking: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Parking with Double = js.native
      
      /* 27 */ val Pharmacy: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Pharmacy with Double = js.native
      
      /* 28 */ val Police: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Police with Double = js.native
      
      /* 29 */ val PostOffice: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.PostOffice with Double = js.native
      
      /* 30 */ val PublicTransport: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.PublicTransport with Double = js.native
      
      /* 31 */ val Restaurant: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Restaurant with Double = js.native
      
      /* 32 */ val Restroom: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Restroom with Double = js.native
      
      /* 33 */ val School: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.School with Double = js.native
      
      /* 34 */ val Stadium: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Stadium with Double = js.native
      
      /* 35 */ val Store: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Store with Double = js.native
      
      /* 36 */ val Theater: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Theater with Double = js.native
      
      /* 37 */ val University: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.University with Double = js.native
      
      /* 38 */ val Winery: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Winery with Double = js.native
      
      /* 39 */ val Zoo: typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Zoo with Double = js.native
    }
    ...
    object PointOfInterestFilter {
      ...
      @js.native
      def excluding(categoryList: js.Array[PointOfInterestCategory]): typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = js.native
      ...
      @js.native
      def including(categoryList: js.Array[PointOfInterestCategory]): typingsSlinky.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = js.native
    }
    ...
    class PointsOfInterestSearch ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.PointsOfInterestSearch {
    ...
    class PolygonOverlay protected ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.PolygonOverlay {
      /**
    ...
    /**
      ...
      */
    class Search ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Search {
    ...
    /**
      ...
      */
    class Style ()
      extends typingsSlinky.appleMapkitJsBrowser.mapkit.Style {
    ...
    @js.native
    def importGeoJSON(data: String): ItemCollection | js.Error = js.native
    @JSGlobal("mapkit.importGeoJSON")
    @js.native
    def importGeoJSON(data: String, callback: GeoJSONDelegate): ItemCollection | js.Error = js.native
    @JSGlobal("mapkit.importGeoJSON")
    @js.native
    def importGeoJSON(data: String, callback: ImportGeoJSONCallback): ItemCollection | js.Error = js.native
    @JSGlobal("mapkit.importGeoJSON")
    @js.native
    def importGeoJSON(data: js.Object): ItemCollection | js.Error = js.native
    @JSGlobal("mapkit.importGeoJSON")
    @js.native
    def importGeoJSON(data: js.Object, callback: GeoJSONDelegate): ItemCollection | js.Error = js.native
    @JSGlobal("mapkit.importGeoJSON")
    @js.native
    def importGeoJSON(data: js.Object, callback: ImportGeoJSONCallback): ItemCollection | js.Error = js.native
    ...
    @js.native
    val maps: js.Array[typingsSlinky.appleMapkitJsBrowser.mapkit.Map] = js.native
