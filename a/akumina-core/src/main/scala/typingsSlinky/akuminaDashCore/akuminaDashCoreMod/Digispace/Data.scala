...
import typingsSlinky.akuminaDashCore.interfacesIGetListRequestMod.IGetListRequest
import typingsSlinky.akuminaDashCore.interfacesISavePageWidgetRequestMod.ISavePageWidgetRequest
