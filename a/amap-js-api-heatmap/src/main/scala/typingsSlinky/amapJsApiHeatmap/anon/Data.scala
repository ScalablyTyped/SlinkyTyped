...
object Data {
  ...
  implicit class DataOps[Self <: Data] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataParser(value: /* data */ js.Any => DataSet): Self = this.set("dataParser", js.Any.fromFunction1(value))
    @scala.inline
    def deleteDataParser: Self = this.set("dataParser", js.undefined)
  }
