...
package object auth0DashJsMod {
  import typingsSlinky.auth0DashJs.Anon_State
  import typingsSlinky.auth0DashJs.auth0DashJsStrings.consent_required
  import typingsSlinky.auth0DashJs.auth0DashJsStrings.interaction_required
  import typingsSlinky.auth0DashJs.auth0DashJsStrings.login_required
