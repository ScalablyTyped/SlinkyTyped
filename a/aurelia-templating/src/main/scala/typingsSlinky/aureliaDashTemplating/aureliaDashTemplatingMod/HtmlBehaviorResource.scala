...
import typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.Binding
...
class HtmlBehaviorResource () extends js.Object {
  ...
  /**
    ...
    */
  def compile(compiler: ViewCompiler, resources: ViewResources, node: Node, instruction: BehaviorInstruction): Node = js.native
  def compile(
  ...
  /**
    ...
    */
  def register(registry: ViewResources): Unit = js.native
  def register(registry: ViewResources, name: String): Unit = js.native
}
