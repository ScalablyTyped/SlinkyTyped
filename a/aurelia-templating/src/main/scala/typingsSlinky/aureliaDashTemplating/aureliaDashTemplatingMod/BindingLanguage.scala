...
class BindingLanguage () extends js.Object {
  /**
    ...
    */
  def createAttributeInstruction(resources: ViewResources, element: Element, info: js.Object): BehaviorInstruction = js.native
  def createAttributeInstruction(resources: ViewResources, element: Element, info: js.Object, existingInstruction: js.Object): BehaviorInstruction = js.native
  /**
    ...
    */
  def createLetExpressions(resources: ViewResources, element: Element): js.Array[LetExpression] = js.native
  /**
    ...
    */
  def inspectAttribute(resources: ViewResources, elementName: String, attrName: String, attrValue: String): js.Object = js.native
  /**
    ...
    */
  def inspectTextContent(resources: ViewResources, value: String): js.Object = js.native
}
