package typingsSlinky.awsDashSdk.clientsStsMod
...
trait AssumeRoleWithSAMLResponse extends js.Object {
  /**
    ...
    */
  var AssumedRoleUser: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.AssumedRoleUser] = js.native
  /**
    *  The value of the Recipient attribute of the SubjectConfirmationData element of the SAML assertion. 
    */
  var Audience: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.Audience] = js.native
  /**
    ...
    */
  var Credentials: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.Credentials] = js.native
  /**
    * The value of the Issuer element of the SAML assertion.
    */
  var Issuer: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.Issuer] = js.native
  /**
    ...
    */
  var NameQualifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.NameQualifier] = js.native
  /**
  ...
  /**
    ...
    */
  var Subject: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.Subject] = js.native
  /**
    *  The format of the name ID, as defined by the Format attribute in the NameID element of the SAML assertion. Typical examples of the format are transient or persistent.   If the format includes the prefix urn:oasis:names:tc:SAML:2.0:nameid-format, that prefix is removed. For example, urn:oasis:names:tc:SAML:2.0:nameid-format:transient is returned as transient. If the format includes any other prefix, the format is returned with no modifications.
    */
  var SubjectType: js.UndefOr[typingsSlinky.awsDashSdk.clientsStsMod.SubjectType] = js.native
}
