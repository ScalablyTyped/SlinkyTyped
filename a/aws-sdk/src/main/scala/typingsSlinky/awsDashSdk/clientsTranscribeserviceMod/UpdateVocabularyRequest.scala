...
trait UpdateVocabularyRequest extends js.Object {
  /**
    ...
    */
  var LanguageCode: typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.LanguageCode = js.native
  /**
    * An array of strings containing the vocabulary entries.
    */
  var Phrases: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.Phrases] = js.native
  /**
  ...
  /**
    ...
    */
  var VocabularyName: typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.VocabularyName = js.native
}
