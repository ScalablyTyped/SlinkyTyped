...
trait ListVocabularyFiltersRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.MaxResults] = js.native
  /**
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.NextToken] = js.native
}
