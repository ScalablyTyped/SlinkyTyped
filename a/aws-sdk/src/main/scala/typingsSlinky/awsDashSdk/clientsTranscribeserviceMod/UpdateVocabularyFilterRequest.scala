...
trait UpdateVocabularyFilterRequest extends js.Object {
  ...
  /**
    ...
    */
  var VocabularyFilterName: typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.VocabularyFilterName = js.native
  /**
    ...
    */
  var Words: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.Words] = js.native
}
