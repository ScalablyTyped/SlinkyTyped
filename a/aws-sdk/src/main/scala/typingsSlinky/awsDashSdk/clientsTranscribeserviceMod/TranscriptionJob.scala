...
trait TranscriptionJob extends js.Object {
  ...
  /**
    ...
    */
  var JobExecutionSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.JobExecutionSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var Media: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.Media] = js.native
  /**
    * The format of the input media file.
    */
  var MediaFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.MediaFormat] = js.native
  /**
    * The sample rate, in Hertz, of the audio track in the input media file. 
    */
  var MediaSampleRateHertz: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.MediaSampleRateHertz] = js.native
  /**
    * Optional settings for the transcription job. Use these settings to turn on speaker recognition, to set the maximum number of speakers that should be identified and to specify a custom vocabulary to use when processing the transcription job.
    */
  var Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.Settings] = js.native
  /**
  ...
  /**
    ...
    */
  var Transcript: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.Transcript] = js.native
  /**
    * The name of the transcription job.
    */
  var TranscriptionJobName: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.TranscriptionJobName] = js.native
  /**
    * The status of the transcription job.
    */
  var TranscriptionJobStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranscribeserviceMod.TranscriptionJobStatus] = js.native
}
