...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.servicesInactive
import typingsSlinky.awsDashSdk.awsDashSdkStrings.servicesStable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.tasksRunning
import typingsSlinky.awsDashSdk.awsDashSdkStrings.tasksStopped
...
trait ECS extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_servicesInactive(state: servicesInactive, params: DescribeServicesRequest with Anon_Waiter): Request[DescribeServicesResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_servicesInactive(
    state: servicesInactive,
    params: DescribeServicesRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeServicesResponse, Unit]
  ): Request[DescribeServicesResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_servicesStable(state: servicesStable, params: DescribeServicesRequest with Anon_Waiter): Request[DescribeServicesResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_servicesStable(
    state: servicesStable,
    params: DescribeServicesRequest with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_tasksRunning(state: tasksRunning, params: DescribeTasksRequest with Anon_Waiter): Request[DescribeTasksResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_tasksRunning(
    state: tasksRunning,
    params: DescribeTasksRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeTasksResponse, Unit]
  ): Request[DescribeTasksResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_tasksStopped(state: tasksStopped, params: DescribeTasksRequest with Anon_Waiter): Request[DescribeTasksResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_tasksStopped(
    state: tasksStopped,
    params: DescribeTasksRequest with Anon_Waiter,
