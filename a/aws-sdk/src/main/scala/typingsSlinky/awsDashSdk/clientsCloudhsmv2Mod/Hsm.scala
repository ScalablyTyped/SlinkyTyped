...
trait Hsm extends js.Object {
  ...
  /**
    ...
    */
  var ClusterId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.ClusterId] = js.native
  /**
    * The identifier (ID) of the HSM's elastic network interface (ENI).
    */
  var EniId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.EniId] = js.native
  /**
  ...
  /**
    ...
    */
  var HsmId: typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.HsmId = js.native
  /**
    * The HSM's state.
    */
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.SubnetId] = js.native
}
