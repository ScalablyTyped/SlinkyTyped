...
trait Cluster extends js.Object {
  /**
    ...
    */
  var BackupPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.BackupPolicy] = js.native
  /**
    * Contains one or more certificates or a certificate signing request (CSR).
    */
  var Certificates: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.Certificates] = js.native
  /**
  ...
  /**
    ...
    */
  var HsmType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.HsmType] = js.native
  /**
    * Contains information about the HSMs in the cluster.
    */
  var Hsms: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.Hsms] = js.native
  /**
    * The default password for the cluster's Pre-Crypto Officer (PRECO) user.
    */
  var PreCoPassword: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.PreCoPassword] = js.native
  /**
    * The identifier (ID) of the cluster's security group.
    */
  var SecurityGroup: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.SecurityGroup] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.VpcId] = js.native
}
