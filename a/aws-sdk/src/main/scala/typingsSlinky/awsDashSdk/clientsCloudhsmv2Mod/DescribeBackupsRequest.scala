...
trait DescribeBackupsRequest extends js.Object {
  /**
    ...
    */
  var Filters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.Filters] = js.native
  /**
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmv2Mod.NextToken] = js.native
