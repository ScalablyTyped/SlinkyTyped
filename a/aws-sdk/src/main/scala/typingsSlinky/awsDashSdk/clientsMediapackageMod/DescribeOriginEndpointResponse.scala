package typingsSlinky.awsDashSdk.clientsMediapackageMod
...
trait DescribeOriginEndpointResponse extends js.Object {
  ...
  var CmafPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.CmafPackage] = js.native
  var DashPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.DashPackage] = js.native
  /**
    * A short text description of the OriginEndpoint.
    */
  var Description: js.UndefOr[__string] = js.native
  var HlsPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.HlsPackage] = js.native
  /**
  ...
  var MssPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.MssPackage] = js.native
  /**
    * Control whether origination of video is allowed for this OriginEndpoint. If set to ALLOW, the OriginEndpoint
  may by requested, pursuant to any other form of access control. If set to DENY, the OriginEndpoint may not be
  requested. This can be helpful for Live to VOD harvesting, or for temporarily disabling origination
    */
  var Origination: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.Origination] = js.native
  /**
    * Maximum duration (seconds) of content to retain for startover playback.
  If not specified, startover playback will be disabled for the OriginEndpoint.
    */
  var StartoverWindowSeconds: js.UndefOr[__integer] = js.native
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.Tags] = js.native
  /**
