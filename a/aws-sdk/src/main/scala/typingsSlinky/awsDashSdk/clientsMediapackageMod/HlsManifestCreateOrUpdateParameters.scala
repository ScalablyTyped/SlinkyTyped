...
trait HlsManifestCreateOrUpdateParameters extends js.Object {
  ...
  messages in the input source.
    */
  var AdMarkers: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.AdMarkers] = js.native
  var AdTriggers: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.AdTriggers] = js.native
  var AdsOnDeliveryRestrictions: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.AdsOnDeliveryRestrictions] = js.native
  /**
  ...
  entry will be included in the media playlist.
    */
  var PlaylistType: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackageMod.PlaylistType] = js.native
  /**
