...
trait Fleet extends js.Object {
  /**
    ...
    */
  var Arn: typingsSlinky.awsDashSdk.clientsAppstreamMod.Arn = js.native
  /**
    * The capacity status for the fleet.
    */
  var ComputeCapacityStatus: typingsSlinky.awsDashSdk.clientsAppstreamMod.ComputeCapacityStatus = js.native
  /**
  ...
  /**
    ...
    */
  var DomainJoinInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.DomainJoinInfo] = js.native
  /**
  ...
  /**
    * The fleet errors.
    */
  var FleetErrors: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.FleetErrors] = js.native
  /**
    * The fleet type.  ALWAYS_ON  Provides users with instant-on access to their apps. You are charged for all running instances in your fleet, even if no users are streaming apps.  ON_DEMAND  Provide users with access to applications after they connect, which takes one to two minutes. You are charged for instance streaming when users are connected and a small hourly fee for instances that are not streaming apps.  
    */
  var FleetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.FleetType] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.VpcConfig] = js.native
}
