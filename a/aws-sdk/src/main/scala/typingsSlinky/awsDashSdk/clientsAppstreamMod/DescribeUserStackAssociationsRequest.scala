...
trait DescribeUserStackAssociationsRequest extends js.Object {
  /**
    ...
    */
  var AuthenticationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.AuthenticationType] = js.native
  /**
    * The maximum size of each page of results.
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.MaxResults] = js.native
  /**
