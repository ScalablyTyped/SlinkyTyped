...
trait CreateFleetRequest extends js.Object {
  /**
    ...
    */
  var ComputeCapacity: typingsSlinky.awsDashSdk.clientsAppstreamMod.ComputeCapacity = js.native
  /**
    * The description to display.
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var DisplayName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.DisplayName] = js.native
  /**
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.Tags] = js.native
  /**
