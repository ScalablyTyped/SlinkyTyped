...
trait Stack extends js.Object {
  ...
  /**
    ...
    */
  var Arn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.Arn] = js.native
  /**
  ...
  /**
    ...
    */
  var EmbedHostDomains: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.EmbedHostDomains] = js.native
  /**
    * The URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed.
    */
  var FeedbackURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.FeedbackURL] = js.native
  /**
  ...
  /**
    ...
    */
  var RedirectURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.RedirectURL] = js.native
  /**
    * The errors for the stack.
    */
  var StackErrors: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.StackErrors] = js.native
  /**
