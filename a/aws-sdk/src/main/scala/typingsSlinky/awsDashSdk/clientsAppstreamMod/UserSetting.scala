...
trait UserSetting extends js.Object {
  /**
    ...
    */
  var Action: typingsSlinky.awsDashSdk.clientsAppstreamMod.Action = js.native
  /**
    * Indicates whether the action is enabled or disabled.
    */
  var Permission: typingsSlinky.awsDashSdk.clientsAppstreamMod.Permission = js.native
}
