...
trait ServiceAccountCredentials extends js.Object {
  /**
    ...
    */
  var AccountName: typingsSlinky.awsDashSdk.clientsAppstreamMod.AccountName = js.native
  /**
    * The password for the account.
    */
  var AccountPassword: typingsSlinky.awsDashSdk.clientsAppstreamMod.AccountPassword = js.native
}
