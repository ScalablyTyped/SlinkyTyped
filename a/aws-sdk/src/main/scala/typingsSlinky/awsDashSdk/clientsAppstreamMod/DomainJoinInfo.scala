...
trait DomainJoinInfo extends js.Object {
  /**
    ...
    */
  var DirectoryName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.DirectoryName] = js.native
  /**
    * The distinguished name of the organizational unit for computer accounts.
    */
  var OrganizationalUnitDistinguishedName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.OrganizationalUnitDistinguishedName] = js.native
}
