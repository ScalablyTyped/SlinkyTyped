...
trait UpdateImagePermissionsRequest extends js.Object {
  /**
    ...
    */
  var ImagePermissions: typingsSlinky.awsDashSdk.clientsAppstreamMod.ImagePermissions = js.native
  /**
    * The name of the private image.
    */
  var Name: typingsSlinky.awsDashSdk.clientsAppstreamMod.Name = js.native
  /**
