...
trait DescribeImagePermissionsResult extends js.Object {
  /**
    ...
    */
  var Name: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.Name] = js.native
  /**
  ...
  /**
    ...
    */
  var SharedImagePermissionsList: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.SharedImagePermissionsList] = js.native
}
