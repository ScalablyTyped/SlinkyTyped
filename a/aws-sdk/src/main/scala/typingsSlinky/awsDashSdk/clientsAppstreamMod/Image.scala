...
trait Image extends js.Object {
  /**
    ...
    */
  var Applications: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.Applications] = js.native
  /**
    * The version of the AppStream 2.0 agent to use for instances that are launched from this image. 
    */
  var AppstreamAgentVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.AppstreamAgentVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var ImagePermissions: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppstreamMod.ImagePermissions] = js.native
  /**
...
object Image {
  ...
  def apply(
    ...
    PublicBaseImageReleasedDate: js.Date = null,
