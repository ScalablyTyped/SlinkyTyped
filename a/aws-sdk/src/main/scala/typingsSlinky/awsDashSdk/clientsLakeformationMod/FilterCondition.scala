...
trait FilterCondition extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typingsSlinky.awsDashSdk.clientsLakeformationMod.ComparisonOperator] = js.native
  /**
  ...
  /**
    ...
    */
  var StringValueList: js.UndefOr[typingsSlinky.awsDashSdk.clientsLakeformationMod.StringValueList] = js.native
}
