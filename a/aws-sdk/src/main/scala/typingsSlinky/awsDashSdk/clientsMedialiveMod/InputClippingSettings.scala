...
trait InputClippingSettings extends js.Object {
  /**
    ...
    */
  var InputTimecodeSource: typingsSlinky.awsDashSdk.clientsMedialiveMod.InputTimecodeSource = js.native
  /**
    * Settings to identify the start of the clip.
    */
  var StartTimecode: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.StartTimecode] = js.native
  /**
    * Settings to identify the end of the clip.
    */
  var StopTimecode: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.StopTimecode] = js.native
}
