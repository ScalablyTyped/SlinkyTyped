...
trait ScheduleAction extends js.Object {
  /**
    ...
    */
  var ActionName: __string = js.native
  /**
    * Settings for this schedule action.
    */
  var ScheduleActionSettings: typingsSlinky.awsDashSdk.clientsMedialiveMod.ScheduleActionSettings = js.native
  /**
    * The time for the action to start in the channel.
    */
  var ScheduleActionStartSettings: typingsSlinky.awsDashSdk.clientsMedialiveMod.ScheduleActionStartSettings = js.native
}
