...
trait InputSettings extends js.Object {
  ...
  3) forced - filtering will be applied regardless of input type
    */
  var InputFilter: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.InputFilter] = js.native
  /**
    * Input settings.
    */
  var NetworkInputSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.NetworkInputSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var VideoSelector: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.VideoSelector] = js.native
}
