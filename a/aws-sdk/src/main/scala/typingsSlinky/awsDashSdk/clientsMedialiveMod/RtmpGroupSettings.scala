...
trait RtmpGroupSettings extends js.Object {
  /**
    ...
    */
  var AuthenticationScheme: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.AuthenticationScheme] = js.native
  /**
  ...
  /**
    ...
    */
  var CacheLength: js.UndefOr[__integerMin30] = js.native
  /**
