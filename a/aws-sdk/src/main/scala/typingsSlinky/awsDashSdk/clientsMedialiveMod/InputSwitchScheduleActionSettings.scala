...
trait InputSwitchScheduleActionSettings extends js.Object {
  /**
    ...
    */
  var InputAttachmentNameReference: __string = js.native
  /**
    * Settings to let you create a clip of the file input, in order to set up the input to ingest only a portion of the file.
    */
  var InputClippingSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.InputClippingSettings] = js.native
  /**
    * The value for the variable portion of the URL for the dynamic input, for this instance of the input. Each time you use the same dynamic input in an input switch action, you can provide a different value, in order to connect the input to a different content source.
    */
  var UrlPath: js.UndefOr[__listOf__string] = js.native
}
