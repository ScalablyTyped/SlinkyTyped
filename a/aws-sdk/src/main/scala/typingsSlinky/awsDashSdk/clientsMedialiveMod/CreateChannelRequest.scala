...
trait CreateChannelRequest extends js.Object {
  /**
    ...
    */
  var ChannelClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.ChannelClass] = js.native
  var Destinations: js.UndefOr[__listOfOutputDestination] = js.native
  var EncoderSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.EncoderSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var InputSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.InputSpecification] = js.native
  /**
    * The log level to write to CloudWatch Logs.
    */
  var LogLevel: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.LogLevel] = js.native
  /**
    * Name of channel.
    */
