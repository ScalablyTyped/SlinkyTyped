...
trait CaptionDestinationSettings extends js.Object {
  var AribDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.AribDestinationSettings] = js.native
  var BurnInDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.BurnInDestinationSettings] = js.native
  var DvbSubDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.DvbSubDestinationSettings] = js.native
  var EmbeddedDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.EmbeddedDestinationSettings] = js.native
  var EmbeddedPlusScte20DestinationSettings: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsMedialiveMod.EmbeddedPlusScte20DestinationSettings
  ] = js.native
  var RtmpCaptionInfoDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.RtmpCaptionInfoDestinationSettings] = js.native
  var Scte20PlusEmbeddedDestinationSettings: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsMedialiveMod.Scte20PlusEmbeddedDestinationSettings
  ] = js.native
  var Scte27DestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.Scte27DestinationSettings] = js.native
  var SmpteTtDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.SmpteTtDestinationSettings] = js.native
  var TeletextDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.TeletextDestinationSettings] = js.native
  var TtmlDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.TtmlDestinationSettings] = js.native
  var WebvttDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.WebvttDestinationSettings] = js.native
}
