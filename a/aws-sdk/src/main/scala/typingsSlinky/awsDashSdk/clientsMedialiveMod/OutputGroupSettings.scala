...
trait OutputGroupSettings extends js.Object {
  var ArchiveGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.ArchiveGroupSettings] = js.native
  var FrameCaptureGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.FrameCaptureGroupSettings] = js.native
  var HlsGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.HlsGroupSettings] = js.native
  var MediaPackageGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.MediaPackageGroupSettings] = js.native
  var MsSmoothGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.MsSmoothGroupSettings] = js.native
  var MultiplexGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.MultiplexGroupSettings] = js.native
  var RtmpGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.RtmpGroupSettings] = js.native
  var UdpGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.UdpGroupSettings] = js.native
}
