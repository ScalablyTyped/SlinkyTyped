...
trait M2tsSettings extends js.Object {
  ...
  /**
    ...
    */
  var DvbNitSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.DvbNitSettings] = js.native
  /**
    * Inserts DVB Service Description Table (SDT) at the specified table repetition interval.
    */
  var DvbSdtSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.DvbSdtSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var DvbTdtSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.DvbTdtSettings] = js.native
  /**
