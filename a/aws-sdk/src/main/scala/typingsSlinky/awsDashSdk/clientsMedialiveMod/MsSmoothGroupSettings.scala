...
trait MsSmoothGroupSettings extends js.Object {
  /**
    ...
    */
  var AcquisitionPointId: js.UndefOr[__string] = js.native
  /**
  ...
  Should only be specified if eventIdMode is set to useConfigured.
    */
  var EventId: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var FilecacheDuration: js.UndefOr[__integerMin0] = js.native
  /**
    * Length of mp4 fragments to generate (in seconds). Fragment length must be compatible with GOP size and framerate.
    */
  var FragmentLength: js.UndefOr[__integerMin1] = js.native
  /**
  ...
  /**
    ...
    */
  var RestartDelay: js.UndefOr[__integerMin0] = js.native
  /**
  ...
  /**
    ...
    */
  var SendDelayMs: js.UndefOr[__integerMin0Max10000] = js.native
  /**
  ...
  /**
    ...
    */
  var TimestampOffset: js.UndefOr[__string] = js.native
  /**
