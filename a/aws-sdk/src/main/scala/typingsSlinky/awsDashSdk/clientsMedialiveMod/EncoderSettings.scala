...
trait EncoderSettings extends js.Object {
  ...
  /**
    ...
    */
  var AvailBlanking: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.AvailBlanking] = js.native
  /**
    * Event-wide configuration settings for ad avail insertion.
    */
  var AvailConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.AvailConfiguration] = js.native
  /**
    * Settings for blackout slate.
    */
  var BlackoutSlate: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.BlackoutSlate] = js.native
  /**
  ...
  /**
    ...
    */
  var GlobalConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.GlobalConfiguration] = js.native
  /**
    * Nielsen configuration settings.
    */
  var NielsenConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMedialiveMod.NielsenConfiguration] = js.native
  var OutputGroups: __listOfOutputGroup = js.native
  /**
    * Contains settings used to acquire and adjust timecode information from inputs.
    */
  var TimecodeConfig: typingsSlinky.awsDashSdk.clientsMedialiveMod.TimecodeConfig = js.native
