...
trait Condition extends js.Object {
  /**
    ...
    */
  var ConditionKey: typingsSlinky.awsDashSdk.clientsBackupMod.ConditionKey = js.native
  /**
    * An operation, such as StringEquals, that is applied to a key-value pair used to filter resources in a selection.
    */
  var ConditionType: typingsSlinky.awsDashSdk.clientsBackupMod.ConditionType = js.native
  /**
    * The value in a key-value pair. For example, in "ec2:ResourceTag/Department": "accounting", "accounting" is the value.
    */
  var ConditionValue: typingsSlinky.awsDashSdk.clientsBackupMod.ConditionValue = js.native
}
