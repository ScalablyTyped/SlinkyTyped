...
trait SearchRequest extends js.Object {
  ...
  /**
    ...
    */
  var facet: js.UndefOr[Facet] = js.native
  /**
    ...
    */
  var filterQuery: js.UndefOr[FilterQuery] = js.native
  /**
  ...
  /**
    ...
    */
  var partial: js.UndefOr[Partial] = js.native
  /**
  ...
  /**
    ...
    */
  var queryParser: js.UndefOr[QueryParser] = js.native
  /**
    ...
    */
  var `return`: js.UndefOr[Return] = js.native
  /**
  ...
  /**
    ...
    */
  var sort: js.UndefOr[Sort] = js.native
  /**
  ...
  /**
    ...
    */
  var stats: js.UndefOr[Stat] = js.native
}
