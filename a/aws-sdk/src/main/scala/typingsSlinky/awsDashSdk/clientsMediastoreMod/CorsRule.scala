...
trait CorsRule extends js.Object {
  /**
    ...
    */
  var AllowedHeaders: typingsSlinky.awsDashSdk.clientsMediastoreMod.AllowedHeaders = js.native
  /**
    ...
    */
  var AllowedMethods: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediastoreMod.AllowedMethods] = js.native
  /**
    ...
    */
  var AllowedOrigins: typingsSlinky.awsDashSdk.clientsMediastoreMod.AllowedOrigins = js.native
  /**
    ...
    */
  var ExposeHeaders: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediastoreMod.ExposeHeaders] = js.native
  /**
    ...
    */
  var MaxAgeSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediastoreMod.MaxAgeSeconds] = js.native
}
