...
trait DescribeLunaClientRequest extends js.Object {
  /**
    ...
    */
  var CertificateFingerprint: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.CertificateFingerprint] = js.native
  /**
    * The ARN of the client.
    */
  var ClientArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.ClientArn] = js.native
}
