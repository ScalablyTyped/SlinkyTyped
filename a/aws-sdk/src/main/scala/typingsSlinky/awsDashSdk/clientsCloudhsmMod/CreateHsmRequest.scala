...
trait CreateHsmRequest extends js.Object {
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.ClientToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ExternalId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.ExternalId] = js.native
  /**
    * The ARN of an IAM role to enable the AWS CloudHSM service to allocate an ENI on your behalf.
    */
  var IamRoleArn: typingsSlinky.awsDashSdk.clientsCloudhsmMod.IamRoleArn = js.native
  /**
    * The SSH public key to install on the HSM.
    */
  var SshKey: typingsSlinky.awsDashSdk.clientsCloudhsmMod.SshKey = js.native
  /**
    * The identifier of the subnet in your VPC in which to place the HSM.
    */
  var SubnetId: typingsSlinky.awsDashSdk.clientsCloudhsmMod.SubnetId = js.native
  var SubscriptionType: typingsSlinky.awsDashSdk.clientsCloudhsmMod.SubscriptionType = js.native
  /**
