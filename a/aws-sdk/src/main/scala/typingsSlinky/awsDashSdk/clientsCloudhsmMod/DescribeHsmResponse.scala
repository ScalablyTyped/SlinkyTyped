...
trait DescribeHsmResponse extends js.Object {
  ...
  /**
    ...
    */
  var EniId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.EniId] = js.native
  /**
  ...
  /**
    * The ARN of the HSM.
    */
  var HsmArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.HsmArn] = js.native
  /**
    * The HSM model type.
    */
  ...
  /**
    ...
    */
  var IamRoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.IamRoleArn] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.SubnetId] = js.native
  /**
  ...
  var SubscriptionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.SubscriptionType] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.VpcId] = js.native
}
