...
trait DescribeHapgResponse extends js.Object {
  ...
  /**
    ...
    */
  var Label: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.Label] = js.native
  /**
  ...
  /**
    ...
    */
  var PartitionSerialList: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudhsmMod.PartitionSerialList] = js.native
  /**
