...
trait Activity extends js.Object {
  /**
    ...
    */
  var CommentMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkdocsMod.CommentMetadata] = js.native
  /**
  ...
  /**
    ...
    */
  var Participants: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkdocsMod.Participants] = js.native
  /**
    * The metadata of the resource involved in the user action.
    */
  var ResourceMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkdocsMod.ResourceMetadata] = js.native
  /**
