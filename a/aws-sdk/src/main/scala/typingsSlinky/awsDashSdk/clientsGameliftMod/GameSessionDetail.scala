...
trait GameSessionDetail extends js.Object {
  /**
    ...
    */
  var GameSession: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.GameSession] = js.native
  /**
    ...
    */
  var ProtectionPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.ProtectionPolicy] = js.native
}
