...
trait FleetAttributes extends js.Object {
  /**
    ...
    */
  var BuildArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.BuildArn] = js.native
  /**
    * A unique identifier for a build.
    */
  var BuildId: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.BuildId] = js.native
  /**
    * Indicates whether a TLS/SSL certificate was generated for the fleet. 
    */
  var CertificateConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.CertificateConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var FleetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.FleetId] = js.native
  /**
    * Indicates whether the fleet uses on-demand or spot instances. A spot instance in use may be interrupted with a two-minute notification.
    */
  var FleetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.FleetType] = js.native
  /**
  ...
  /**
    ...
    */
  var OperatingSystem: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.OperatingSystem] = js.native
  /**
    * Fleet policy to limit the number of game sessions an individual player can create over a span of time.
    */
  var ResourceCreationLimitPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.ResourceCreationLimitPolicy] = js.native
  /**
    *  The Amazon Resource Name (ARN) associated with the GameLift script resource that is deployed on instances in this fleet. In a GameLift script ARN, the resource ID matches the ScriptId value.
    */
  var ScriptArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.ScriptArn] = js.native
  /**
    * A unique identifier for a Realtime script.
    */
  var ScriptId: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.ScriptId] = js.native
  /**
