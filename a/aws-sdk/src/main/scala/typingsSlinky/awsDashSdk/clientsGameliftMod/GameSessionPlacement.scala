...
trait GameSessionPlacement extends js.Object {
  /**
    ...
    */
  var DnsName: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.DnsName] = js.native
  /**
  ...
  /**
    ...
    */
  var GameSessionData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.GameSessionData] = js.native
  /**
  ...
  /**
    ...
    */
  var GameSessionQueueName: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.GameSessionQueueName] = js.native
  /**
  ...
  /**
    ...
    */
  var IpAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.IpAddress] = js.native
  /**
    * Information on the matchmaking process for this game. Data is in JSON syntax, formatted as a string. It identifies the matchmaking configuration used to create the match, and contains data on all players assigned to the match, including player attributes and team assignments. For more details on matchmaker data, see Match Data.
    */
  var MatchmakerData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.MatchmakerData] = js.native
  /**
