...
trait UpdateAliasInput extends js.Object {
  /**
    ...
    */
  var AliasId: typingsSlinky.awsDashSdk.clientsGameliftMod.AliasId = js.native
  /**
  ...
  /**
    ...
    */
  var RoutingStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.RoutingStrategy] = js.native
}
