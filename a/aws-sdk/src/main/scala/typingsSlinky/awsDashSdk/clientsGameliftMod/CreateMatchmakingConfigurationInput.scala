...
trait CreateMatchmakingConfigurationInput extends js.Object {
  ...
  /**
    ...
    */
  var BackfillMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.BackfillMode] = js.native
  /**
    * Information to be added to all events related to this matchmaking configuration. 
    */
  var CustomEventData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.CustomEventData] = js.native
  /**
