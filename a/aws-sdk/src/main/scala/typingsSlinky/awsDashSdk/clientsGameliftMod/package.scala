...
package object clientsGameliftMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.AUTO_SCALING
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.INTERRUPTED
  ...
  */
  ...
  type ZipBlob = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  /* Rewritten from type alias, can be one of: 
