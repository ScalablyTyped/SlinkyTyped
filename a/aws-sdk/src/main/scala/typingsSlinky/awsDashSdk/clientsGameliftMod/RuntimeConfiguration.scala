...
trait RuntimeConfiguration extends js.Object {
  /**
    ...
    */
  var GameSessionActivationTimeoutSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.GameSessionActivationTimeoutSeconds] = js.native
  /**
    * The maximum number of game sessions with status ACTIVATING to allow on an instance simultaneously. This setting limits the amount of instance resources that can be used for new game activations at any one time.
    */
  var MaxConcurrentGameSessionActivations: js.UndefOr[typingsSlinky.awsDashSdk.clientsGameliftMod.MaxConcurrentGameSessionActivations] = js.native
  /**
