...
trait SourceDetail extends js.Object {
  /**
    ...
    */
  var EventSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.EventSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.MessageType] = js.native
}
