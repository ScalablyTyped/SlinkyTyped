...
trait ConfigurationAggregator extends js.Object {
  ...
  /**
    ...
    */
  var ConfigurationAggregatorArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConfigurationAggregatorArn] = js.native
  /**
    * The name of the aggregator.
    */
  var ConfigurationAggregatorName: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConfigurationAggregatorName] = js.native
  /**
  ...
  /**
    ...
    */
  var OrganizationAggregationSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.OrganizationAggregationSource] = js.native
}
