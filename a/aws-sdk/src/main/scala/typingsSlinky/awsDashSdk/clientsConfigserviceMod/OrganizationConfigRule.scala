...
trait OrganizationConfigRule extends js.Object {
  ...
  /**
    ...
    */
  var OrganizationConfigRuleName: typingsSlinky.awsDashSdk.clientsConfigserviceMod.OrganizationConfigRuleName = js.native
  /**
    * An OrganizationCustomRuleMetadata object.
    */
  var OrganizationCustomRuleMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.OrganizationCustomRuleMetadata] = js.native
  /**
    * An OrganizationManagedRuleMetadata object.
    */
  var OrganizationManagedRuleMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.OrganizationManagedRuleMetadata] = js.native
}
