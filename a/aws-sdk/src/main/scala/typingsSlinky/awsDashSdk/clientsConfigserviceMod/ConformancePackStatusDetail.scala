...
trait ConformancePackStatusDetail extends js.Object {
  /**
    ...
    */
  var ConformancePackArn: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackArn = js.native
  /**
    * ID of the conformance pack.
    */
  var ConformancePackId: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackId = js.native
  /**
    * Name of the conformance pack.
    */
  var ConformancePackName: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackName = js.native
  /**
    ...
    */
  var ConformancePackState: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackState = js.native
  /**
    * The reason of conformance pack creation failure.
    */
  var ConformancePackStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackStatusReason] = js.native
  /**
  ...
  /**
    ...
    */
  var StackArn: typingsSlinky.awsDashSdk.clientsConfigserviceMod.StackArn = js.native
}
