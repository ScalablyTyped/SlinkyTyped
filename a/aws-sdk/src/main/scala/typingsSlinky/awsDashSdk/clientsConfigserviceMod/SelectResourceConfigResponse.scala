...
trait SelectResourceConfigResponse extends js.Object {
  ...
  /**
    ...
    */
  var QueryInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.QueryInfo] = js.native
  /**
    * Returns the results for the SQL query.
    */
  var Results: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.Results] = js.native
}
