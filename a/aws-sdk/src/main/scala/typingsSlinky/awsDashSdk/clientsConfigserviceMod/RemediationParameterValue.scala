...
trait RemediationParameterValue extends js.Object {
  /**
    ...
    */
  var ResourceValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ResourceValue] = js.native
  /**
    * The value is static and does not change at run-time.
    */
  var StaticValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.StaticValue] = js.native
}
