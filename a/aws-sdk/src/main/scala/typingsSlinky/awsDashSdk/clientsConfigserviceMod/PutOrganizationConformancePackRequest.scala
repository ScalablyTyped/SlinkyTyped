...
trait PutOrganizationConformancePackRequest extends js.Object {
  /**
    ...
    */
  var ConformancePackInputParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConformancePackInputParameters] = js.native
  /**
    ...
    */
  var DeliveryS3Bucket: typingsSlinky.awsDashSdk.clientsConfigserviceMod.DeliveryS3Bucket = js.native
  /**
    * The prefix for the Amazon S3 bucket.
    */
  var DeliveryS3KeyPrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.DeliveryS3KeyPrefix] = js.native
  /**
    * A list of AWS accounts to be excluded from an organization conformance pack while deploying a conformance pack.
    */
  var ExcludedAccounts: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ExcludedAccounts] = js.native
  /**
    * Name of the organization conformance pack you want to create.
    */
  var OrganizationConformancePackName: typingsSlinky.awsDashSdk.clientsConfigserviceMod.OrganizationConformancePackName = js.native
  /**
    * A string containing full conformance pack template body. Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes.
    */
  var TemplateBody: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.TemplateBody] = js.native
  /**
    ...
    */
  var TemplateS3Uri: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.TemplateS3Uri] = js.native
}
