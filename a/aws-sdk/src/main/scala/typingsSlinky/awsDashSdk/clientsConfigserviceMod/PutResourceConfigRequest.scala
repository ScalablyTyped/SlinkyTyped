...
trait PutResourceConfigRequest extends js.Object {
  /**
    ...
    */
  var Configuration: typingsSlinky.awsDashSdk.clientsConfigserviceMod.Configuration = js.native
  /**
    * Unique identifier of the resource.
    */
  var ResourceId: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ResourceId = js.native
  /**
    * Name of the resource.
    */
  var ResourceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ResourceName] = js.native
  /**
  ...
  /**
    ...
    */
  var SchemaVersionId: typingsSlinky.awsDashSdk.clientsConfigserviceMod.SchemaVersionId = js.native
  /**
    * Tags associated with the resource.
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.Tags] = js.native
}
