...
trait GetAggregateComplianceDetailsByConfigRuleRequest extends js.Object {
  /**
    ...
    */
  var AccountId: typingsSlinky.awsDashSdk.clientsConfigserviceMod.AccountId = js.native
  /**
    * The source region from where the data is aggregated.
    */
  var AwsRegion: typingsSlinky.awsDashSdk.clientsConfigserviceMod.AwsRegion = js.native
  /**
    ...
    */
  var ComplianceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.ComplianceType] = js.native
  /**
    * The name of the AWS Config rule for which you want compliance information.
    */
  var ConfigRuleName: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConfigRuleName = js.native
  /**
    * The name of the configuration aggregator.
    */
  var ConfigurationAggregatorName: typingsSlinky.awsDashSdk.clientsConfigserviceMod.ConfigurationAggregatorName = js.native
  /**
    ...
    */
  var Limit: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.Limit] = js.native
  /**
    * The nextToken string returned on a previous page that you use to get the next page of results in a paginated response.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.NextToken] = js.native
}
