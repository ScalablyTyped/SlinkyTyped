...
trait Source extends js.Object {
  /**
    ...
    */
  var Owner: typingsSlinky.awsDashSdk.clientsConfigserviceMod.Owner = js.native
  /**
    * Provides the source and type of the event that causes AWS Config to evaluate your AWS resources.
    */
  var SourceDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsConfigserviceMod.SourceDetails] = js.native
  /**
