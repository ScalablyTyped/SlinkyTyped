...
trait RedshiftParameters extends js.Object {
  /**
    ...
    */
  var ClusterId: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.ClusterId] = js.native
  /**
    * Database.
    */
  ...
  /**
    ...
    */
  var Host: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.Host] = js.native
  /**
