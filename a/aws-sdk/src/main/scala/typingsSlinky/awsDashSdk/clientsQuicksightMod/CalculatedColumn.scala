...
trait CalculatedColumn extends js.Object {
  /**
    ...
    */
  var ColumnId: typingsSlinky.awsDashSdk.clientsQuicksightMod.ColumnId = js.native
  /**
    * Column name.
    */
  ...
  /**
    ...
    */
  var Expression: typingsSlinky.awsDashSdk.clientsQuicksightMod.Expression = js.native
}
