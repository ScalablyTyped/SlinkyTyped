...
trait DashboardPublishOptions extends js.Object {
  /**
    ...
    */
  var AdHocFilteringOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.AdHocFilteringOption] = js.native
  /**
    * Export to .csv option.
    */
  var ExportToCSVOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.ExportToCSVOption] = js.native
  /**
    * Sheet controls option.
    */
  var SheetControlsOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.SheetControlsOption] = js.native
}
