...
trait UploadSettings extends js.Object {
  ...
  /**
    ...
    */
  var Delimiter: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.Delimiter] = js.native
  /**
    * File format.
    */
  ...
  /**
    * Text qualifier.
    */
  var TextQualifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.TextQualifier] = js.native
}
