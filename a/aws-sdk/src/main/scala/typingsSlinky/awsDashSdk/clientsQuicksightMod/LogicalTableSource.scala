...
trait LogicalTableSource extends js.Object {
  /**
    ...
    */
  var JoinInstruction: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.JoinInstruction] = js.native
  /**
    * Physical table ID.
    */
  var PhysicalTableId: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.PhysicalTableId] = js.native
}
