...
trait TemplateAlias extends js.Object {
  /**
    ...
    */
  var AliasName: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.AliasName] = js.native
  /**
    * The Amazon Resource Name (ARN) of the template alias.
    */
  var Arn: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.Arn] = js.native
  /**
