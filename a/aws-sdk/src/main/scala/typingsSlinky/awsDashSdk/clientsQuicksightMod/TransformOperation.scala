...
trait TransformOperation extends js.Object {
  /**
    ...
    */
  var CastColumnTypeOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.CastColumnTypeOperation] = js.native
  /**
    * An operation that creates calculated columns. Columns created in one such operation form a lexical closure.
    */
  var CreateColumnsOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.CreateColumnsOperation] = js.native
  /**
    * An operation that filters rows based on some condition.
    */
  var FilterOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.FilterOperation] = js.native
  /**
    * An operation that projects columns. Operations that come after a projection can only refer to projected columns.
    */
  var ProjectOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.ProjectOperation] = js.native
  /**
    * An operation that renames a column.
    */
  var RenameColumnOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.RenameColumnOperation] = js.native
  /**
    * An operation that tags a column with additional information.
    */
  var TagColumnOperation: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.TagColumnOperation] = js.native
}
