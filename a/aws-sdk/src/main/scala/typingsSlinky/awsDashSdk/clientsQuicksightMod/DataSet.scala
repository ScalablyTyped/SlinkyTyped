...
trait DataSet extends js.Object {
  ...
  /**
    ...
    */
  var LogicalTableMap: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.LogicalTableMap] = js.native
  /**
  ...
  /**
    ...
    */
  var PhysicalTableMap: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.PhysicalTableMap] = js.native
  /**
    * The row-level security configuration for the dataset.
    */
  var RowLevelPermissionDataSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.RowLevelPermissionDataSet] = js.native
}
