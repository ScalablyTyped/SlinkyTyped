...
trait DataSetConfiguration extends js.Object {
  /**
    ...
    */
  var ColumnGroupSchemaList: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.ColumnGroupSchemaList] = js.native
  /**
    * Dataset schema.
    */
  var DataSetSchema: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.DataSetSchema] = js.native
  /**
    * Placeholder.
    */
