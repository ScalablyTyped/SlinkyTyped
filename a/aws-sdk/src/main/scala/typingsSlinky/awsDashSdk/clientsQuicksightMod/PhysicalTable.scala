...
trait PhysicalTable extends js.Object {
  /**
    ...
    */
  var CustomSql: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.CustomSql] = js.native
  /**
    * A physical table type for relational data sources.
    */
  var RelationalTable: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.RelationalTable] = js.native
  /**
    * A physical table type for as S3 data source.
    */
  var S3Source: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.S3Source] = js.native
}
