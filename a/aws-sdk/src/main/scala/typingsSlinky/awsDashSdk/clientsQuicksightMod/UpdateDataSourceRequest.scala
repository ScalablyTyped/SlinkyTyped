...
trait UpdateDataSourceRequest extends js.Object {
  ...
  /**
    ...
    */
  var DataSourceParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.DataSourceParameters] = js.native
  /**
  ...
  /**
    ...
    */
  var SslProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.SslProperties] = js.native
  /**
    * Use this parameter only when you want QuickSight to use a VPC connection when connecting to your underlying source.
    */
  var VpcConnectionProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.VpcConnectionProperties] = js.native
}
