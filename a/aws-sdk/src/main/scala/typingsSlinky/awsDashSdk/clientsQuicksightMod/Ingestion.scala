...
trait Ingestion extends js.Object {
  ...
  /**
    ...
    */
  var ErrorInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.ErrorInfo] = js.native
  /**
    * Ingestion ID.
    */
  var IngestionId: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.IngestionId] = js.native
  /**
  ...
  /**
    * Ingestion status.
    */
  var IngestionStatus: typingsSlinky.awsDashSdk.clientsQuicksightMod.IngestionStatus = js.native
  /**
    * The time that this ingestion took, measured in seconds.
    */
  var IngestionTimeInSeconds: js.UndefOr[long] = js.native
  var QueueInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.QueueInfo] = js.native
  /**
  ...
  var RowInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsQuicksightMod.RowInfo] = js.native
}
