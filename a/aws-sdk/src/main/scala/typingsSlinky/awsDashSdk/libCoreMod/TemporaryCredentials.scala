...
import typingsSlinky.awsDashSdk.libCredentialsTemporaryUnderscoreCredentialsMod.TemporaryCredentials.TemporaryCredentialsOptions
...
class TemporaryCredentials ()
  extends typingsSlinky.awsDashSdk.libCredentialsTemporaryUnderscoreCredentialsMod.TemporaryCredentials {
  /**
    * Creates a new temporary credentials object.
    * @param {Object} options - a map of options that are passed to the AWS.STS.assumeRole() or AWS.STS.getSessionToken() operations. If a RoleArn parameter is passed in, credentials will be based on the IAM role.
  ...
  def this(
    ...
    masterCredentials: typingsSlinky.awsDashSdk.libCredentialsMod.Credentials
  ) = this()
}
