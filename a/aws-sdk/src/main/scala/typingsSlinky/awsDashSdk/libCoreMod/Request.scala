...
class Request[D, E] protected ()
  extends typingsSlinky.awsDashSdk.libRequestMod.Request[D, E] {
  /**
    ...
    */
  def this(service: typingsSlinky.awsDashSdk.libServiceMod.Service, operation: String) = this()
  def this(service: typingsSlinky.awsDashSdk.libServiceMod.Service, operation: String, params: js.Any) = this()
}
