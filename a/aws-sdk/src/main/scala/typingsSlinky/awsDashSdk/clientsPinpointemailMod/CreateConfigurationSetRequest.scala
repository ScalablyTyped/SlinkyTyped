...
trait CreateConfigurationSetRequest extends js.Object {
  /**
    ...
    */
  var ConfigurationSetName: typingsSlinky.awsDashSdk.clientsPinpointemailMod.ConfigurationSetName = js.native
  /**
    * An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
    */
  var DeliveryOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.DeliveryOptions] = js.native
  /**
    * An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.ReputationOptions] = js.native
  /**
    * An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.SendingOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.TrackingOptions] = js.native
}
