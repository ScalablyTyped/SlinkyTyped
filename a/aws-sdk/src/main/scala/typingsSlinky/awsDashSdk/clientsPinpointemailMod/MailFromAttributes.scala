...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typingsSlinky.awsDashSdk.clientsPinpointemailMod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typingsSlinky.awsDashSdk.clientsPinpointemailMod.MailFromDomainStatus = js.native
}
