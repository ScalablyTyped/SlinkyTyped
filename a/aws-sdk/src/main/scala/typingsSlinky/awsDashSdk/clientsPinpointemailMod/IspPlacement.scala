...
trait IspPlacement extends js.Object {
  /**
    ...
    */
  var IspName: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.IspName] = js.native
  /**
    * An object that contains inbox placement metrics for a specific email provider.
    */
  var PlacementStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.PlacementStatistics] = js.native
}
