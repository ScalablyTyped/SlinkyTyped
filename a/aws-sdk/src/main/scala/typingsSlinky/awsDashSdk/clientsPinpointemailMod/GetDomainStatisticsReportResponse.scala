...
trait GetDomainStatisticsReportResponse extends js.Object {
  /**
    ...
    */
  var DailyVolumes: typingsSlinky.awsDashSdk.clientsPinpointemailMod.DailyVolumes = js.native
  /**
    * An object that contains deliverability metrics for the domain that you specified. The data in this object is a summary of all of the data that was collected from the StartDate to the EndDate.
    */
  var OverallVolume: typingsSlinky.awsDashSdk.clientsPinpointemailMod.OverallVolume = js.native
}
