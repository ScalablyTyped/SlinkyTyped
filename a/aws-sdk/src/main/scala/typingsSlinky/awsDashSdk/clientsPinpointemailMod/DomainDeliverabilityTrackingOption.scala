...
trait DomainDeliverabilityTrackingOption extends js.Object {
  /**
    ...
    */
  var Domain: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.Domain] = js.native
  /**
    * An object that contains information about the inbox placement data settings for the domain.
    */
  var InboxPlacementTrackingOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.InboxPlacementTrackingOption] = js.native
  /**
