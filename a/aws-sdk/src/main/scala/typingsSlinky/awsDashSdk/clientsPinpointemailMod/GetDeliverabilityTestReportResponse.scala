...
trait GetDeliverabilityTestReportResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestReport: typingsSlinky.awsDashSdk.clientsPinpointemailMod.DeliverabilityTestReport = js.native
  /**
    * An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.
    */
  var IspPlacements: typingsSlinky.awsDashSdk.clientsPinpointemailMod.IspPlacements = js.native
  /**
