...
trait DedicatedIp extends js.Object {
  /**
    ...
    */
  var Ip: typingsSlinky.awsDashSdk.clientsPinpointemailMod.Ip = js.native
  /**
    * The name of the dedicated IP pool that the IP address is associated with.
    */
  var PoolName: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.PoolName] = js.native
  /**
  ...
  /**
    ...
    */
  var WarmupStatus: typingsSlinky.awsDashSdk.clientsPinpointemailMod.WarmupStatus = js.native
}
