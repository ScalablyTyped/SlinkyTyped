...
trait EventDestination extends js.Object {
  /**
    ...
    */
  var CloudWatchDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.CloudWatchDestination] = js.native
  /**
    ...
    */
  var Enabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.Enabled] = js.native
  /**
    * An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.
    */
  var KinesisFirehoseDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.KinesisFirehoseDestination] = js.native
  /**
  ...
  /**
    ...
    */
  var PinpointDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.PinpointDestination] = js.native
  /**
    * An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
    */
  var SnsDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.SnsDestination] = js.native
}
