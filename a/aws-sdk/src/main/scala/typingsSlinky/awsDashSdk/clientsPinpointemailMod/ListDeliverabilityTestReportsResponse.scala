...
trait ListDeliverabilityTestReportsResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestReports: typingsSlinky.awsDashSdk.clientsPinpointemailMod.DeliverabilityTestReports = js.native
  /**
    * A token that indicates that there are additional predictive inbox placement tests to list. To view additional predictive inbox placement tests, issue another request to ListDeliverabilityTestReports, and pass this token in the NextToken parameter.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.NextToken] = js.native
}
