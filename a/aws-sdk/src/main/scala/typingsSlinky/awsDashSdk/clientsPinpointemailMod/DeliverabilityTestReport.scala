...
trait DeliverabilityTestReport extends js.Object {
  ...
  /**
    ...
    */
  var DeliverabilityTestStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.DeliverabilityTestStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ReportId: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.ReportId] = js.native
  /**
    * A name that helps you identify a predictive inbox placement test report.
    */
  var ReportName: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.ReportName] = js.native
  /**
