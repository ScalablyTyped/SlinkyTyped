...
trait SendEmailRequest extends js.Object {
  /**
    ...
    */
  var ConfigurationSetName: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.ConfigurationSetName] = js.native
  /**
  ...
  /**
    ...
    */
  var Destination: typingsSlinky.awsDashSdk.clientsPinpointemailMod.Destination = js.native
  /**
