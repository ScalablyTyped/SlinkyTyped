...
trait DailyVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointemailMod.VolumeStatistics] = js.native
}
