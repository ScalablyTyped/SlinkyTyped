...
trait Block extends js.Object {
  /**
    * The block index.
    */
  var BlockIndex: js.UndefOr[typingsSlinky.awsDashSdk.clientsEbsMod.BlockIndex] = js.native
  /**
    * The block token for the block index.
    */
  var BlockToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsEbsMod.BlockToken] = js.native
}
