...
trait FileSystemDescription extends js.Object {
  ...
  /**
    ...
    */
  var CreationToken: typingsSlinky.awsDashSdk.clientsEfsMod.CreationToken = js.native
  /**
    * A Boolean value that, if true, indicates that the file system is encrypted.
    */
  var Encrypted: js.UndefOr[typingsSlinky.awsDashSdk.clientsEfsMod.Encrypted] = js.native
  /**
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEfsMod.KmsKeyId] = js.native
  /**
    * The lifecycle phase of the file system.
    */
  var LifeCycleState: typingsSlinky.awsDashSdk.clientsEfsMod.LifeCycleState = js.native
  /**
  ...
  /**
    ...
    */
  var PerformanceMode: typingsSlinky.awsDashSdk.clientsEfsMod.PerformanceMode = js.native
  /**
    ...
    */
  var ProvisionedThroughputInMibps: js.UndefOr[typingsSlinky.awsDashSdk.clientsEfsMod.ProvisionedThroughputInMibps] = js.native
  /**
  ...
  /**
    ...
    */
  var ThroughputMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsEfsMod.ThroughputMode] = js.native
}
