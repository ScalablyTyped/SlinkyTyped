...
trait MountTargetDescription extends js.Object {
  ...
  /**
    ...
    */
  var MountTargetId: typingsSlinky.awsDashSdk.clientsEfsMod.MountTargetId = js.native
  /**
    * The ID of the network interface that Amazon EFS created when it created the mount target.
    */
  var NetworkInterfaceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEfsMod.NetworkInterfaceId] = js.native
  /**
