...
package object clientsKmsMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.RSA_2048
  ...
  */
  ...
  type CiphertextType = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  ...
  */
  ...
  type PlaintextType = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  type PolicyNameList = js.Array[PolicyNameType]
  type PolicyNameType = String
  type PolicyType = String
  type PrincipalIdType = String
  type PublicKeyType = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  /* Rewritten from type alias, can be one of: 
