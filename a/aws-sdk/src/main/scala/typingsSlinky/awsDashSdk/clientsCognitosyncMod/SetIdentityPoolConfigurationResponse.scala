...
trait SetIdentityPoolConfigurationResponse extends js.Object {
  /**
    ...
    */
  var CognitoStreams: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.CognitoStreams] = js.native
  /**
    * A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito.
    */
  var IdentityPoolId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.IdentityPoolId] = js.native
  /**
    * Options to apply to this identity pool for push synchronization.
    */
  var PushSync: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.PushSync] = js.native
}
