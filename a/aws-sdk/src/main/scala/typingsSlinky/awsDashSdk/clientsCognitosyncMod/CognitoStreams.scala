...
trait CognitoStreams extends js.Object {
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.StreamName] = js.native
  /**
    ...
    */
  var StreamingStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.StreamingStatus] = js.native
}
