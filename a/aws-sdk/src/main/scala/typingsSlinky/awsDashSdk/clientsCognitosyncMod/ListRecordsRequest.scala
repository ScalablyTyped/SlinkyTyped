...
trait ListRecordsRequest extends js.Object {
  /**
    ...
    */
  var DatasetName: typingsSlinky.awsDashSdk.clientsCognitosyncMod.DatasetName = js.native
  /**
    * A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique within a region.
    */
  var IdentityId: typingsSlinky.awsDashSdk.clientsCognitosyncMod.IdentityId = js.native
  /**
    * A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique within a region.
    */
  ...
  /**
    ...
    */
  var SyncSessionToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.SyncSessionToken] = js.native
}
