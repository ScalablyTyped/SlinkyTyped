...
trait UpdateRecordsRequest extends js.Object {
  /**
    ...
    */
  var ClientContext: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitosyncMod.ClientContext] = js.native
  /**
  ...
  /**
    ...
    */
  var SyncSessionToken: typingsSlinky.awsDashSdk.clientsCognitosyncMod.SyncSessionToken = js.native
}
