...
trait OutputDescription extends js.Object {
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.DestinationSchema] = js.native
  /**
    * Describes the Amazon Kinesis Firehose delivery stream configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputDescription
  ] = js.native
  /**
    * Describes Amazon Kinesis stream configured as the destination where output is written.
    */
  var KinesisStreamsOutputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputDescription
  ] = js.native
  /**
    * Describes the AWS Lambda function configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.LambdaOutputDescription] = js.native
  /**
