...
trait ApplicationDetail extends js.Object {
  ...
  /**
    ...
    */
  var ApplicationCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ApplicationCode] = js.native
  /**
    * Description of the application.
    */
  var ApplicationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ApplicationDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var ApplicationStatus: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ApplicationStatus = js.native
  /**
    * Provides the current application version.
    */
  var ApplicationVersionId: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ApplicationVersionId = js.native
  /**
    * Describes the CloudWatch log streams that are configured to receive application messages. For more information about using CloudWatch log streams with Amazon Kinesis Analytics applications, see Working with Amazon CloudWatch Logs. 
    */
  var CloudWatchLoggingOptionDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.CloudWatchLoggingOptionDescriptions
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var InputDescriptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputDescriptions] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputDescriptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.OutputDescriptions] = js.native
  /**
    * Describes reference data sources configured for the application. For more information, see Configuring Application Input. 
    */
  var ReferenceDataSourceDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ReferenceDataSourceDescriptions
  ] = js.native
}
