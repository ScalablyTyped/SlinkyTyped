...
trait SourceSchema extends js.Object {
  /**
    ...
    */
  var RecordColumns: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RecordColumns = js.native
  /**
    * Specifies the encoding of the records in the streaming source. For example, UTF-8.
    */
  var RecordEncoding: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RecordEncoding] = js.native
  /**
    * Specifies the format of the records on the streaming source.
    */
  var RecordFormat: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RecordFormat = js.native
}
