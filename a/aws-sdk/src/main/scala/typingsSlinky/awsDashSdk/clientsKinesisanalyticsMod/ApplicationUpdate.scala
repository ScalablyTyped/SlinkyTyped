...
trait ApplicationUpdate extends js.Object {
  ...
  /**
    ...
    */
  var CloudWatchLoggingOptionUpdates: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.CloudWatchLoggingOptionUpdates
  ] = js.native
  /**
    * Describes application input configuration updates.
    */
  var InputUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputUpdates] = js.native
  /**
    * Describes application output configuration updates.
    */
  var OutputUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.OutputUpdates] = js.native
  /**
    * Describes application reference data source updates.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ReferenceDataSourceUpdates] = js.native
}
