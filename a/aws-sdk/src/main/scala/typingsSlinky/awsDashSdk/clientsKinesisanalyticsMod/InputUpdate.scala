...
trait InputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var InputParallelismUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputParallelismUpdate] = js.native
  /**
    * Describes updates for an input processing configuration.
    */
  var InputProcessingConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputProcessingConfigurationUpdate
  ] = js.native
  /**
    * Describes the data format on the streaming source, and how record elements on the streaming source map to columns of the in-application stream that is created.
    */
  var InputSchemaUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputSchemaUpdate] = js.native
  /**
    * If an Amazon Kinesis Firehose delivery stream is the streaming source to be updated, provides an updated stream ARN and IAM role ARN.
    */
  var KinesisFirehoseInputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseInputUpdate] = js.native
  /**
    * If an Amazon Kinesis stream is the streaming source to be updated, provides an updated stream Amazon Resource Name (ARN) and IAM role ARN.
    */
  var KinesisStreamsInputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsInputUpdate] = js.native
  /**
