...
trait MappingParameters extends js.Object {
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.CSVMappingParameters] = js.native
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.JSONMappingParameters] = js.native
}
