...
trait DiscoverInputSchemaResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ParsedInputRecords] = js.native
  /**
    * Stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ProcessedInputRecords] = js.native
  /**
    * Raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RawInputRecords] = js.native
}
