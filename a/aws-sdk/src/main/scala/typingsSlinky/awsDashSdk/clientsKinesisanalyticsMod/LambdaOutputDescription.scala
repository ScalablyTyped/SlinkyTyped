...
trait LambdaOutputDescription extends js.Object {
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.ResourceARN] = js.native
  /**
    * ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination function.
    */
  var RoleARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RoleARN] = js.native
}
