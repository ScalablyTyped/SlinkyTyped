...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var InputParallelism: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputParallelism] = js.native
  /**
    * The description of the preprocessor that executes on records in this input before the application's code is run.
    */
  var InputProcessingConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputProcessingConfigurationDescription
  ] = js.native
  /**
  ...
  var InputStartingPositionConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputStartingPositionConfiguration
  ] = js.native
  /**
    * If an Amazon Kinesis Firehose delivery stream is configured as a streaming source, provides the delivery stream's ARN and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisFirehoseInputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseInputDescription
  ] = js.native
  /**
    * If an Amazon Kinesis stream is configured as streaming source, provides Amazon Kinesis stream's Amazon Resource Name (ARN) and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisStreamsInputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsInputDescription
  ] = js.native
  /**
