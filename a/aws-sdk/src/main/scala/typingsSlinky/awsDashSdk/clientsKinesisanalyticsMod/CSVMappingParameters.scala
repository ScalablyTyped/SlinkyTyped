...
trait CSVMappingParameters extends js.Object {
  /**
    ...
    */
  var RecordColumnDelimiter: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RecordColumnDelimiter = js.native
  /**
    * Row delimiter. For example, in a CSV format, '\n' is the typical row delimiter.
    */
  var RecordRowDelimiter: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.RecordRowDelimiter = js.native
}
