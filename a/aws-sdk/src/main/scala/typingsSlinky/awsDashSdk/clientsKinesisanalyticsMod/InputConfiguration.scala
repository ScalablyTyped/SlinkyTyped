...
trait InputConfiguration extends js.Object {
  /**
    ...
    */
  var Id: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.Id = js.native
  /**
    * Point at which you want the application to start processing records from the streaming source.
    */
  var InputStartingPositionConfiguration: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.InputStartingPositionConfiguration = js.native
}
