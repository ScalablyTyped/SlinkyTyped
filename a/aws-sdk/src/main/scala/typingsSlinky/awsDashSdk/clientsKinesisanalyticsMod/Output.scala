...
trait Output extends js.Object {
  /**
    ...
    */
  var DestinationSchema: typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.DestinationSchema = js.native
  /**
    * Identifies an Amazon Kinesis Firehose delivery stream as the destination.
    */
  var KinesisFirehoseOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutput] = js.native
  /**
    * Identifies an Amazon Kinesis stream as the destination.
    */
  var KinesisStreamsOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsOutput] = js.native
  /**
    * Identifies an AWS Lambda function as the destination.
    */
  var LambdaOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.LambdaOutput] = js.native
  /**
