...
trait OutputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputUpdate] = js.native
  /**
    * Describes an Amazon Kinesis stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputUpdate] = js.native
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsMod.LambdaOutputUpdate] = js.native
  /**
