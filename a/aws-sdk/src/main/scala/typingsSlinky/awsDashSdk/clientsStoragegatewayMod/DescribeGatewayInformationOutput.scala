...
trait DescribeGatewayInformationOutput extends js.Object {
  ...
  /**
    ...
    */
  var Ec2InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Ec2InstanceId] = js.native
  /**
    * The AWS Region where the Amazon EC2 instance is located.
    */
  var Ec2InstanceRegion: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Ec2InstanceRegion] = js.native
  ...
  /**
    ...
    */
  var GatewayNetworkInterfaces: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.GatewayNetworkInterfaces] = js.native
  /**
    * A value that indicates the operating state of the gateway.
    */
  var GatewayState: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.GatewayState] = js.native
  /**
  ...
  /**
    ...
    */
  var HostEnvironment: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.HostEnvironment] = js.native
  /**
    * The date on which the last software update was applied to the gateway. If the gateway has never been updated, this field does not return a value in the response.
    */
  var LastSoftwareUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.LastSoftwareUpdate] = js.native
  /**
    * The date on which an update to the gateway is available. This date is in the time zone of the gateway. If the gateway is not available for an update this field is not returned in the response.
    */
  var NextUpdateAvailabilityDate: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.NextUpdateAvailabilityDate] = js.native
  /**
