...
trait UpdateGatewayInformationInput extends js.Object {
  /**
    ...
    */
  var CloudWatchLogGroupARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.CloudWatchLogGroupARN] = js.native
  var GatewayARN: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.GatewayARN = js.native
  var GatewayName: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.GatewayName] = js.native
  /**
    * A value that indicates the time zone of the gateway.
    */
  var GatewayTimezone: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.GatewayTimezone] = js.native
}
