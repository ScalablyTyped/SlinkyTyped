...
trait TapeArchive extends js.Object {
  ...
  /**
    ...
    */
  var TapeARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.TapeARN] = js.native
  /**
    * The barcode that identifies the archived virtual tape.
    */
  var TapeBarcode: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.TapeBarcode] = js.native
  /**
