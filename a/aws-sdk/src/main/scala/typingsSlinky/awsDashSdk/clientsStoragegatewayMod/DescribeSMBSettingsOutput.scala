...
trait DescribeSMBSettingsOutput extends js.Object {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.DomainName] = js.native
  ...
  /**
    ...
    */
  var SMBSecurityStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.SMBSecurityStrategy] = js.native
}
