...
trait StorediSCSIVolume extends js.Object {
  ...
  var KMSKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.KMSKey] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetName: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.TargetName] = js.native
  /**
    * The Amazon Resource Name (ARN) of the storage volume.
    */
  var VolumeARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeARN] = js.native
  /**
    ...
    */
  var VolumeAttachmentStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeAttachmentStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeId: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeId] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeStatus] = js.native
  /**
    * One of the VolumeType enumeration values describing the type of the volume.
    */
  var VolumeType: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeType] = js.native
  /**
    ...
    */
  var VolumeUsedInBytes: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeUsedInBytes] = js.native
  /**
    * An VolumeiSCSIAttributes object that represents a collection of iSCSI attributes for one stored volume.
    */
  var VolumeiSCSIAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VolumeiSCSIAttributes] = js.native
}
