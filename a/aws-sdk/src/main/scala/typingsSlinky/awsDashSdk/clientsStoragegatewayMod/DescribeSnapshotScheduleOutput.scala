...
trait DescribeSnapshotScheduleOutput extends js.Object {
  /**
    ...
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Description] = js.native
  /**
    * The number of hours between snapshots.
    */
  var RecurrenceInHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.RecurrenceInHours] = js.native
  /**
