...
trait UpdateVTLDeviceTypeInput extends js.Object {
  /**
    ...
    */
  var DeviceType: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.DeviceType = js.native
  /**
    * The Amazon Resource Name (ARN) of the medium changer you want to select.
    */
  var VTLDeviceARN: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VTLDeviceARN = js.native
}
