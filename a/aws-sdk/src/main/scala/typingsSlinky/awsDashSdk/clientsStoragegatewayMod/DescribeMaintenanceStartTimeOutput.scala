...
trait DescribeMaintenanceStartTimeOutput extends js.Object {
  ...
  /**
    ...
    */
  var HourOfDay: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.HourOfDay] = js.native
  /**
    * The minute component of the maintenance start time represented as mm, where mm is the minute (0 to 59). The minute of the hour is in the time zone of the gateway.
    */
  var MinuteOfHour: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.MinuteOfHour] = js.native
  /**
