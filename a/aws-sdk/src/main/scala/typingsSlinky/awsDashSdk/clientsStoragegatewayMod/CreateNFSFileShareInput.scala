...
trait CreateNFSFileShareInput extends js.Object {
  ...
  /**
    ...
    */
  var ClientToken: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.ClientToken = js.native
  /**
  ...
  /**
    ...
    */
  var LocationARN: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.LocationARN = js.native
  /**
    * File share default values. Optional.
    */
  var NFSFileShareDefaults: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.NFSFileShareDefaults] = js.native
  /**
    * A value that sets the access control list permission for objects in the S3 bucket that a file gateway puts objects into. The default value is "private".
    */
  var ObjectACL: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.ObjectACL] = js.native
  /**
  ...
  /**
    ...
    */
  var Role: typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Role = js.native
  /**
    ...
    */
  var Squash: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Squash] = js.native
  /**
    * A list of up to 50 tags that can be assigned to the NFS file share. Each tag is a key-value pair.  Valid characters for key and value are letters, spaces, and numbers representable in UTF-8 format, and the following special characters: + - = . _ : / @. The maximum length of a tag's key is 128 characters, and the maximum length for a tag's value is 256. 
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Tags] = js.native
}
