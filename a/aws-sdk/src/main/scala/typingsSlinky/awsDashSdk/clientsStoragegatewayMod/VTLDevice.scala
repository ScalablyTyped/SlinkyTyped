...
trait VTLDevice extends js.Object {
  /**
    ...
    */
  var DeviceiSCSIAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.DeviceiSCSIAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var VTLDeviceProductIdentifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VTLDeviceProductIdentifier] = js.native
  /**
    * Specifies the type of device that the VTL device emulates.
    */
  var VTLDeviceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VTLDeviceType] = js.native
  /**
    * Specifies the vendor of the device that the VTL device object emulates.
    */
  var VTLDeviceVendor: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.VTLDeviceVendor] = js.native
}
