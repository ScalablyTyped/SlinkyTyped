...
trait DescribeTapeRecoveryPointsOutput extends js.Object {
  ...
  /**
    ...
    */
  var Marker: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.Marker] = js.native
  /**
    * An array of TapeRecoveryPointInfos that are available for the specified gateway.
    */
  var TapeRecoveryPointInfos: js.UndefOr[typingsSlinky.awsDashSdk.clientsStoragegatewayMod.TapeRecoveryPointInfos] = js.native
}
