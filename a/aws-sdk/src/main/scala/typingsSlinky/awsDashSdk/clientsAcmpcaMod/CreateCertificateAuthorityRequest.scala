...
trait CreateCertificateAuthorityRequest extends js.Object {
  /**
    ...
    */
  var CertificateAuthorityConfiguration: typingsSlinky.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityConfiguration = js.native
  /**
    * The type of the certificate authority.
    */
  var CertificateAuthorityType: typingsSlinky.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityType = js.native
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmpcaMod.IdempotencyToken] = js.native
  /**
    ...
    */
  var RevocationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmpcaMod.RevocationConfiguration] = js.native
  /**
