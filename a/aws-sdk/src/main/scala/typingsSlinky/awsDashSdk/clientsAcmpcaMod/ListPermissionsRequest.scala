...
trait ListPermissionsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmpcaMod.MaxResults] = js.native
  /**
    * When paginating results, use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextToken from the response you just received.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmpcaMod.NextToken] = js.native
}
