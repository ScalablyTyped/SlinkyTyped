...
trait CertificateAuthorityConfiguration extends js.Object {
  /**
    ...
    */
  var KeyAlgorithm: typingsSlinky.awsDashSdk.clientsAcmpcaMod.KeyAlgorithm = js.native
  /**
    * Name of the algorithm your private CA uses to sign certificate requests.
    */
  var SigningAlgorithm: typingsSlinky.awsDashSdk.clientsAcmpcaMod.SigningAlgorithm = js.native
  /**
