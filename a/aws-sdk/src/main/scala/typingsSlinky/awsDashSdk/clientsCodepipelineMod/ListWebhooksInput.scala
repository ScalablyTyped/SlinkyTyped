...
trait ListWebhooksInput extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodepipelineMod.MaxResults] = js.native
  /**
    * The token that was returned from the previous ListWebhooks call, which can be used to return the next set of webhooks in the list.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodepipelineMod.NextToken] = js.native
}
