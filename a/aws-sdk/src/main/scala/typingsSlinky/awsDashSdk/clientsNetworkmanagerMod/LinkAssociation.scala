package typingsSlinky.awsDashSdk.clientsNetworkmanagerMod
...
trait LinkAssociation extends js.Object {
  ...
  /**
    ...
    */
  var LinkAssociationState: js.UndefOr[typingsSlinky.awsDashSdk.clientsNetworkmanagerMod.LinkAssociationState] = js.native
  /**
    * The ID of the link.
    */
