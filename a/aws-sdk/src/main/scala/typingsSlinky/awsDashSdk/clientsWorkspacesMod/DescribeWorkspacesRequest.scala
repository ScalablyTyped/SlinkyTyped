...
trait DescribeWorkspacesRequest extends js.Object {
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.DirectoryId] = js.native
  /**
    * The maximum number of items to return.
    */
  var Limit: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.Limit] = js.native
  /**
  ...
  /**
    ...
    */
  var UserName: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.UserName] = js.native
  /**
