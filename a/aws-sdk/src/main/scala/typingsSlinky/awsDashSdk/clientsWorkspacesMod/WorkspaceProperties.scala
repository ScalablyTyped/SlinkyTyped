...
trait WorkspaceProperties extends js.Object {
  ...
  /**
    ...
    */
  var RootVolumeSizeGib: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.RootVolumeSizeGib] = js.native
  /**
    * The running mode. For more information, see Manage the WorkSpace Running Mode.
    */
  var RunningMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.RunningMode] = js.native
  /**
    * The time after a user logs off when WorkSpaces are automatically stopped. Configured in 60-minute intervals.
    */
  var RunningModeAutoStopTimeoutInMinutes: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsWorkspacesMod.RunningModeAutoStopTimeoutInMinutes
  ] = js.native
  /**
    * The size of the user storage.
    */
  var UserVolumeSizeGib: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.UserVolumeSizeGib] = js.native
}
