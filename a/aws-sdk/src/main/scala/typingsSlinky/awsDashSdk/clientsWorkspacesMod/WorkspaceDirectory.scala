...
trait WorkspaceDirectory extends js.Object {
  /**
    * The directory alias.
    */
  var Alias: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.Alias] = js.native
  /**
  ...
  /**
    ...
    */
  var DirectoryName: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.DirectoryName] = js.native
  /**
    * The directory type.
    */
  ...
  /**
    ...
    */
  var DnsIpAddresses: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.DnsIpAddresses] = js.native
  /**
  ...
  /**
    ...
    */
  var RegistrationCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.RegistrationCode] = js.native
  /**
    * The default self-service permissions for WorkSpaces in the directory.
    */
  var SelfservicePermissions: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.SelfservicePermissions] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.SubnetIds] = js.native
  /**
    ...
    */
  var Tenancy: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.Tenancy] = js.native
  /**
    * The devices and operating systems that users can use to access Workspaces.
    */
  var WorkspaceAccessProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.WorkspaceAccessProperties] = js.native
  /**
