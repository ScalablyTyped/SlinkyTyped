...
trait WorkspaceRequest extends js.Object {
  /**
    ...
    */
  var BundleId: typingsSlinky.awsDashSdk.clientsWorkspacesMod.BundleId = js.native
  /**
    * The identifier of the AWS Directory Service directory for the WorkSpace. You can use DescribeWorkspaceDirectories to list the available directories.
    */
  var DirectoryId: typingsSlinky.awsDashSdk.clientsWorkspacesMod.DirectoryId = js.native
  /**
  ...
  /**
    ...
    */
  var UserName: typingsSlinky.awsDashSdk.clientsWorkspacesMod.UserName = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeEncryptionKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.VolumeEncryptionKey] = js.native
  /**
    * The WorkSpace properties.
    */
  var WorkspaceProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.WorkspaceProperties] = js.native
}
