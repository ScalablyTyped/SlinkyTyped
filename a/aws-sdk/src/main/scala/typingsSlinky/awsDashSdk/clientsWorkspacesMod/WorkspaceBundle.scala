...
trait WorkspaceBundle extends js.Object {
  /**
    ...
    */
  var BundleId: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.BundleId] = js.native
  /**
    * The compute type. For more information, see Amazon WorkSpaces Bundles.
    */
  var ComputeType: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.ComputeType] = js.native
  /**
    * A description.
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var RootStorage: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.RootStorage] = js.native
  /**
    * The size of the user storage.
    */
  var UserStorage: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkspacesMod.UserStorage] = js.native
}
