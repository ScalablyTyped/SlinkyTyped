...
trait ReportDefinition extends js.Object {
  ...
  /**
    ...
    */
  var RefreshClosedReports: js.UndefOr[typingsSlinky.awsDashSdk.clientsCurMod.RefreshClosedReports] = js.native
  var ReportName: typingsSlinky.awsDashSdk.clientsCurMod.ReportName = js.native
  /**
    * Whether you want Amazon Web Services to overwrite the previous version of each report or to deliver the report in addition to the previous versions.
    */
  var ReportVersioning: js.UndefOr[typingsSlinky.awsDashSdk.clientsCurMod.ReportVersioning] = js.native
  var S3Bucket: typingsSlinky.awsDashSdk.clientsCurMod.S3Bucket = js.native
  var S3Prefix: typingsSlinky.awsDashSdk.clientsCurMod.S3Prefix = js.native
  var S3Region: AWSRegion = js.native
  var TimeUnit: typingsSlinky.awsDashSdk.clientsCurMod.TimeUnit = js.native
}
