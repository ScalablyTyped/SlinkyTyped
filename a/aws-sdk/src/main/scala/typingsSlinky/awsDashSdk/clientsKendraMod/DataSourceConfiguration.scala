...
trait DataSourceConfiguration extends js.Object {
  /**
    ...
    */
  var DatabaseConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.DatabaseConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var SharePointConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.SharePointConfiguration] = js.native
}
