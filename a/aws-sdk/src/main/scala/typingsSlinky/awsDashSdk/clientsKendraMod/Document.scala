...
trait Document extends js.Object {
  ...
  /**
    ...
    */
  var ContentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.ContentType] = js.native
  /**
    * A unique identifier of the document in the index.
    */
  var Id: DocumentId = js.native
  var S3Path: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.S3Path] = js.native
  /**
    * The title of the document.
    */
  var Title: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.Title] = js.native
}
