...
trait BatchPutDocumentResponseFailedDocument extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.ErrorCode] = js.native
  /**
    * A description of the reason why the document could not be indexed.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.ErrorMessage] = js.native
  /**
