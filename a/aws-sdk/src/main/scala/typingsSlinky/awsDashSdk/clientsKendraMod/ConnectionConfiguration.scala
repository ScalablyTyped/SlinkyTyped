...
trait ConnectionConfiguration extends js.Object {
  /**
    ...
    */
  var DatabaseHost: typingsSlinky.awsDashSdk.clientsKendraMod.DatabaseHost = js.native
  /**
    * The name of the database containing the document data.
    */
  var DatabaseName: typingsSlinky.awsDashSdk.clientsKendraMod.DatabaseName = js.native
  /**
    * The port that the database uses for connections.
    */
  var DatabasePort: typingsSlinky.awsDashSdk.clientsKendraMod.DatabasePort = js.native
  /**
    ...
    */
  var SecretArn: typingsSlinky.awsDashSdk.clientsKendraMod.SecretArn = js.native
  /**
    * The name of the table that contains the document data.
    */
  var TableName: typingsSlinky.awsDashSdk.clientsKendraMod.TableName = js.native
}
