...
trait S3DataSourceConfiguration extends js.Object {
  /**
    ...
    */
  var AccessControlListConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.AccessControlListConfiguration] = js.native
  /**
    * The name of the bucket that contains the documents.
    */
  var BucketName: S3BucketName = js.native
  var DocumentsMetadataConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.DocumentsMetadataConfiguration] = js.native
  /**
