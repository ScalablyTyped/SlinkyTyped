...
trait DataSourceToIndexFieldMapping extends js.Object {
  /**
    ...
    */
  var DataSourceFieldName: typingsSlinky.awsDashSdk.clientsKendraMod.DataSourceFieldName = js.native
  /**
  ...
  /**
    ...
    */
  var IndexFieldName: typingsSlinky.awsDashSdk.clientsKendraMod.IndexFieldName = js.native
}
