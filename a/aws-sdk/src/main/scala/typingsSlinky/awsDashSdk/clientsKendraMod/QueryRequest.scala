...
trait QueryRequest extends js.Object {
  /**
    ...
    */
  var AttributeFilter: js.UndefOr[typingsSlinky.awsDashSdk.clientsKendraMod.AttributeFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryText: typingsSlinky.awsDashSdk.clientsKendraMod.QueryText = js.native
  /**
