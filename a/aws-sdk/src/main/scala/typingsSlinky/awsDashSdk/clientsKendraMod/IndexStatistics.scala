...
trait IndexStatistics extends js.Object {
  /**
    ...
    */
  var FaqStatistics: typingsSlinky.awsDashSdk.clientsKendraMod.FaqStatistics = js.native
  /**
    * The number of text documents indexed.
    */
  var TextDocumentStatistics: typingsSlinky.awsDashSdk.clientsKendraMod.TextDocumentStatistics = js.native
}
