...
trait DescribeAffectedEntitiesForOrganizationRequest extends js.Object {
  /**
    ...
    */
  var locale: js.UndefOr[typingsSlinky.awsDashSdk.clientsHealthMod.locale] = js.native
  /**
    * The maximum number of items to return in one batch, between 10 and 100, inclusive.
    */
  var maxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsHealthMod.maxResults] = js.native
  /**
