...
trait AffectedEntity extends js.Object {
  ...
  /**
    ...
    */
  var entityArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsHealthMod.entityArn] = js.native
  /**
    * The URL of the affected entity.
    */
  var entityUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsHealthMod.entityUrl] = js.native
  /**
    * The ID of the affected entity.
    */
  var entityValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsHealthMod.entityValue] = js.native
  /**
