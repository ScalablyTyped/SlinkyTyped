...
trait SelectParameters extends js.Object {
  ...
  /**
    ...
    */
  var ExpressionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlacierMod.ExpressionType] = js.native
  /**
    * Describes the serialization format of the object.
    */
  var InputSerialization: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlacierMod.InputSerialization] = js.native
  /**
    * Describes how the results of the select job are serialized.
    */
  var OutputSerialization: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlacierMod.OutputSerialization] = js.native
}
