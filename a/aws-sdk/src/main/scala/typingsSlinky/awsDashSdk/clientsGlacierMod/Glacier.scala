...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.vaultExists
import typingsSlinky.awsDashSdk.awsDashSdkStrings.vaultNotExists
...
import typingsSlinky.awsDashSdk.libServicesGlacierMod.GlacierCustomizations
...
trait Glacier extends GlacierCustomizations {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_vaultExists(state: vaultExists, params: DescribeVaultInput with Anon_Waiter): Request[DescribeVaultOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_vaultExists(
    state: vaultExists,
    params: DescribeVaultInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeVaultOutput, Unit]
  ): Request[DescribeVaultOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_vaultNotExists(state: vaultNotExists, params: DescribeVaultInput with Anon_Waiter): Request[DescribeVaultOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_vaultNotExists(
    state: vaultNotExists,
    params: DescribeVaultInput with Anon_Waiter,
