...
trait Grant extends js.Object {
  /**
    * The grantee.
    */
  var Grantee: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlacierMod.Grantee] = js.native
  /**
    * Specifies the permission given to the grantee. 
    */
  var Permission: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlacierMod.Permission] = js.native
}
