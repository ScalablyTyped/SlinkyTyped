...
trait EventDestination extends js.Object {
  var CloudWatchLogsDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointsmsvoiceMod.CloudWatchLogsDestination] = js.native
  /**
    * Indicates whether or not the event destination is enabled. If the event destination is enabled, then Amazon Pinpoint sends response data to the specified event destination.
    */
  var Enabled: js.UndefOr[Boolean] = js.native
  var KinesisFirehoseDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointsmsvoiceMod.KinesisFirehoseDestination] = js.native
  var MatchingEventTypes: js.UndefOr[EventTypes] = js.native
  /**
    * A name that identifies the event destination configuration.
    */
  var Name: js.UndefOr[String] = js.native
  var SnsDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointsmsvoiceMod.SnsDestination] = js.native
}
