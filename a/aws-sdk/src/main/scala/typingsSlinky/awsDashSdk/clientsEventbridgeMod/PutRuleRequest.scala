...
trait PutRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var EventBusName: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.EventBusName] = js.native
  /**
    * The event pattern. For more information, see Event Patterns in the Amazon EventBridge User Guide.
    */
  var EventPattern: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.EventPattern] = js.native
  /**
  ...
  /**
    ...
    */
  var ScheduleExpression: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.ScheduleExpression] = js.native
  /**
