...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsSlinky.awsDashSdk.clientsEventbridgeMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsSlinky.awsDashSdk.clientsEventbridgeMod.Principal = js.native
  /**
