...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.NetworkConfiguration] = js.native
  /**
