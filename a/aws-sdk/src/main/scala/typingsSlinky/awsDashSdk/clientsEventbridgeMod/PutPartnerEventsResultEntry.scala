...
trait PutPartnerEventsResultEntry extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.ErrorCode] = js.native
  /**
    * The error message that explains why the event submission failed.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.ErrorMessage] = js.native
  /**
    * The ID of the event.
    */
  var EventId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEventbridgeMod.EventId] = js.native
}
