...
trait ResourceTagMapping extends js.Object {
  /**
    ...
    */
  var ComplianceDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.ComplianceDetails] = js.native
  /**
    * The ARN of the resource.
    */
  var ResourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.ResourceARN] = js.native
  /**
