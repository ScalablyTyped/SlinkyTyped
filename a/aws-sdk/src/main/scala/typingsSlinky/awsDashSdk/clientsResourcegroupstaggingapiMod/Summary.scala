...
trait Summary extends js.Object {
  /**
    ...
    */
  var LastUpdated: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.LastUpdated] = js.native
  /**
    * The count of noncompliant resources.
    */
  var NonCompliantResources: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.NonCompliantResources
  ] = js.native
  /**
    * The AWS Region that the summary applies to.
    */
  var Region: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.Region] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.TargetId] = js.native
  /**
    * Whether the target is an account, an OU, or the organization root.
    */
  var TargetIdType: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.TargetIdType] = js.native
}
