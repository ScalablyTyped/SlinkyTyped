...
trait DescribeReportCreationOutput extends js.Object {
  ...
  /**
    ...
    */
  var S3Location: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.S3Location] = js.native
  /**
    ...
    */
  var Status: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupstaggingapiMod.Status] = js.native
}
