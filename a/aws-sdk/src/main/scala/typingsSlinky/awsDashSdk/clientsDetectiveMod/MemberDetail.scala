...
trait MemberDetail extends js.Object {
  ...
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsDetectiveMod.EmailAddress] = js.native
  /**
    * The ARN of the behavior graph that the member account was invited to.
    */
  var GraphArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDetectiveMod.GraphArn] = js.native
  /**
