...
trait ListWebACLsRequest extends js.Object {
  ...
  /**
    ...
    */
  var NextMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.NextMarker] = js.native
  /**
    ...
    */
  var Scope: typingsSlinky.awsDashSdk.clientsWafv2Mod.Scope = js.native
}

object ListWebACLsRequest {
  @scala.inline
  def apply(Scope: Scope, Limit: Int | Double = null, NextMarker: NextMarker = null): ListWebACLsRequest = {
