...
trait GetWebACLResponse extends js.Object {
  /**
    ...
    */
  var LockToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.LockToken] = js.native
  /**
    * The Web ACL specification. You can modify the settings in this Web ACL and use it to update this Web ACL or create a new one.
    */
  var WebACL: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.WebACL] = js.native
}
