...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.TimeWindow] = js.native
}
