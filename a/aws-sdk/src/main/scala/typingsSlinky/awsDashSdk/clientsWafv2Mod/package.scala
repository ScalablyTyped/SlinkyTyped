...
package object clientsWafv2Mod {
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.IP
  ...
  */
  ...
  type RateBasedStatementAggregateKeyType = IP | String
  ...
  */
  ...
  type SearchString = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  type Size = Double
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsDashSdk.awsDashSdkStrings.`2019-07-29`
