...
trait FieldToMatch extends js.Object {
  /**
    ...
    */
  var AllQueryArguments: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.AllQueryArguments] = js.native
  /**
    ...
    */
  var Body: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.Body] = js.native
  /**
    * Inspect the HTTP method. The method indicates the type of operation that the request is asking the origin to perform. 
    */
  var Method: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.Method] = js.native
  /**
    * Inspect the query string. This is the part of a URL that appears after a ? character, if any.
    */
  var QueryString: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.QueryString] = js.native
  /**
    * Inspect a single header. Provide the name of the header to inspect, for example, User-Agent or Referer. This setting isn't case sensitive.
    */
  var SingleHeader: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.SingleHeader] = js.native
  /**
    * Inspect a single query argument. Provide the name of the query argument to inspect, such as UserName or SalesRegion. The name can be up to 30 characters long and isn't case sensitive. 
    */
  var SingleQueryArgument: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.SingleQueryArgument] = js.native
  /**
    * Inspect the request URI path. This is the part of a web request that identifies a resource, for example, /images/daily-ad.jpg.
    */
  var UriPath: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.UriPath] = js.native
}
