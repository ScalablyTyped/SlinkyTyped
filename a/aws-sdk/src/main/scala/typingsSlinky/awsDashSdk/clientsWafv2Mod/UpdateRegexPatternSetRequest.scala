...
trait UpdateRegexPatternSetRequest extends js.Object {
  ...
  /**
    ...
    */
  var LockToken: typingsSlinky.awsDashSdk.clientsWafv2Mod.LockToken = js.native
  /**
  ...
  /**
    * 
    */
  var RegularExpressionList: typingsSlinky.awsDashSdk.clientsWafv2Mod.RegularExpressionList = js.native
  /**
