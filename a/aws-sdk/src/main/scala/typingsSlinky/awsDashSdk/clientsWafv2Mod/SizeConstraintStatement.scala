package typingsSlinky.awsDashSdk.clientsWafv2Mod
...
trait SizeConstraintStatement extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typingsSlinky.awsDashSdk.clientsWafv2Mod.ComparisonOperator = js.native
  /**
    * The part of a web request that you want AWS WAF to inspect. For more information, see FieldToMatch. 
    */
  var FieldToMatch: typingsSlinky.awsDashSdk.clientsWafv2Mod.FieldToMatch = js.native
  /**
    * The size, in byte, to compare to the request part, after any transformations.
    */
  var Size: typingsSlinky.awsDashSdk.clientsWafv2Mod.Size = js.native
  /**
    ...
    */
  var TextTransformations: typingsSlinky.awsDashSdk.clientsWafv2Mod.TextTransformations = js.native
}
