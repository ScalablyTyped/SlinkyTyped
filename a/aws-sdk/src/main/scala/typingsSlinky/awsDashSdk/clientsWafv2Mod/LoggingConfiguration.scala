...
trait LoggingConfiguration extends js.Object {
  /**
    ...
    */
  var LogDestinationConfigs: typingsSlinky.awsDashSdk.clientsWafv2Mod.LogDestinationConfigs = js.native
  /**
    ...
    */
  var RedactedFields: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.RedactedFields] = js.native
  /**
    * The Amazon Resource Name (ARN) of the web ACL that you want to associate with LogDestinationConfigs.
    */
  var ResourceArn: typingsSlinky.awsDashSdk.clientsWafv2Mod.ResourceArn = js.native
}
