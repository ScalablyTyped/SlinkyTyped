...
trait Rule extends js.Object {
  ...
  /**
    ...
    */
  var OverrideAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafv2Mod.OverrideAction] = js.native
  /**
  ...
  /**
    ...
    */
  var Statement: typingsSlinky.awsDashSdk.clientsWafv2Mod.Statement = js.native
  /**
    * Defines and enables Amazon CloudWatch metrics and web request sample collection. 
    */
  var VisibilityConfig: typingsSlinky.awsDashSdk.clientsWafv2Mod.VisibilityConfig = js.native
}
