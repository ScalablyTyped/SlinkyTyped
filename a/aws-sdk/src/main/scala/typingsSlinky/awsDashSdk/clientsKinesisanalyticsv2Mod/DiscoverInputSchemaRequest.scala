...
trait DiscoverInputSchemaRequest extends js.Object {
  ...
  var InputProcessingConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputProcessingConfiguration
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ResourceARN] = js.native
  /**
    * Specify this parameter to discover a schema from data in an Amazon S3 object.
    */
  var S3Configuration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.S3Configuration] = js.native
  /**
