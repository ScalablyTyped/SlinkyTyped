...
trait VpcConfigurationDescription extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SecurityGroupIds = js.native
  /**
    * The array of Subnet IDs used by the VPC configuration.
    */
  var SubnetIds: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SubnetIds = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcId = js.native
}
