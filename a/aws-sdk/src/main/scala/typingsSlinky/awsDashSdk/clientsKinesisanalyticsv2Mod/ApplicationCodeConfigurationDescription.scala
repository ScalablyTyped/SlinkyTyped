...
trait ApplicationCodeConfigurationDescription extends js.Object {
  /**
    ...
    */
  var CodeContentDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CodeContentDescription] = js.native
  /**
    * Specifies whether the code content is in text or zip format.
    */
  var CodeContentType: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CodeContentType = js.native
}
