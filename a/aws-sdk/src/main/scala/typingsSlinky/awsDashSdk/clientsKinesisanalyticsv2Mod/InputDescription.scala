...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var InputParallelism: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputParallelism] = js.native
  /**
    * The description of the preprocessor that executes on records in this input before the application's code is run. 
    */
  var InputProcessingConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputProcessingConfigurationDescription
  ] = js.native
  /**
  ...
  var InputStartingPositionConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputStartingPositionConfiguration
  ] = js.native
  /**
    * If a Kinesis Data Firehose delivery stream is configured as a streaming source, provides the delivery stream's ARN. 
    */
  var KinesisFirehoseInputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseInputDescription
  ] = js.native
  /**
    * If a Kinesis data stream is configured as a streaming source, provides the Kinesis data stream's Amazon Resource Name (ARN). 
    */
  var KinesisStreamsInputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsInputDescription
  ] = js.native
  /**
