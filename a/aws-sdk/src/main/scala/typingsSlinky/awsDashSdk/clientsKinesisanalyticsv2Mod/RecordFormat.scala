...
trait RecordFormat extends js.Object {
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.MappingParameters] = js.native
  /**
    * The type of record format.
    */
  var RecordFormatType: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordFormatType = js.native
}
