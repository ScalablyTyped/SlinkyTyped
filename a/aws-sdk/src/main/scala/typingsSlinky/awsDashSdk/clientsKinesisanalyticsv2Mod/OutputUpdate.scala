...
trait OutputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutputUpdate
  ] = js.native
  /**
    * Describes a Kinesis data stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutputUpdate] = js.native
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.LambdaOutputUpdate] = js.native
  /**
