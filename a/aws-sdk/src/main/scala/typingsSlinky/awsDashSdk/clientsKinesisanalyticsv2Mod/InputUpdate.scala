...
trait InputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var InputParallelismUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputParallelismUpdate] = js.native
  /**
    * Describes updates to an InputProcessingConfiguration.
    */
  var InputProcessingConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputProcessingConfigurationUpdate
  ] = js.native
  /**
    * Describes the data format on the streaming source, and how record elements on the streaming source map to columns of the in-application stream that is created.
    */
  var InputSchemaUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputSchemaUpdate] = js.native
  /**
    * If a Kinesis Data Firehose delivery stream is the streaming source to be updated, provides an updated stream ARN.
    */
  var KinesisFirehoseInputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseInputUpdate] = js.native
  /**
    * If a Kinesis data stream is the streaming source to be updated, provides an updated stream Amazon Resource Name (ARN).
    */
  var KinesisStreamsInputUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsInputUpdate] = js.native
  /**
