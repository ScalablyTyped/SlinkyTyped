...
trait RunConfigurationUpdate extends js.Object {
  ...
  var ApplicationRestoreConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationRestoreConfiguration
  ] = js.native
  /**
    * Describes the starting parameters for an Apache Flink-based Kinesis Data Analytics application.
    */
  var FlinkRunConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FlinkRunConfiguration] = js.native
}
