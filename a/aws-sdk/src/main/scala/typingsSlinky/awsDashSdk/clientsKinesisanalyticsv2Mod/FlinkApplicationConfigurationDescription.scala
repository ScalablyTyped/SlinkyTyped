...
trait FlinkApplicationConfigurationDescription extends js.Object {
  ...
  var CheckpointConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointConfigurationDescription
  ] = js.native
  /**
    ...
    */
  var JobPlanDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.JobPlanDescription] = js.native
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.MonitoringConfigurationDescription
  ] = js.native
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismConfigurationDescription
  ] = js.native
}
