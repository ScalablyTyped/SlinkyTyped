...
trait SqlApplicationConfigurationDescription extends js.Object {
  /**
    ...
    */
  var InputDescriptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputDescriptions] = js.native
  /**
    * The array of OutputDescription objects describing the destination streams used by the application.
    */
  var OutputDescriptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.OutputDescriptions] = js.native
  /**
    * The array of ReferenceDataSourceDescription objects describing the reference data sources used by the application.
    */
  var ReferenceDataSourceDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSourceDescriptions
  ] = js.native
}
