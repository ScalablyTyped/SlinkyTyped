...
trait CodeContentDescription extends js.Object {
  /**
    ...
    */
  var CodeMD5: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CodeMD5] = js.native
  /**
    * The size in bytes of the application code. Can be used to validate zip-format code.
    */
  var CodeSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CodeSize] = js.native
  /**
    * The S3 bucket Amazon Resource Name (ARN), file key, and object version of the application code stored in Amazon S3.
    */
  var S3ApplicationCodeLocationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.S3ApplicationCodeLocationDescription
  ] = js.native
  /**
