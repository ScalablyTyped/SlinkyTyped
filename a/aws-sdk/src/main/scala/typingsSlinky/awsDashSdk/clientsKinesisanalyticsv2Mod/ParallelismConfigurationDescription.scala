...
trait ParallelismConfigurationDescription extends js.Object {
  ...
  /**
    ...
    */
  var Parallelism: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.Parallelism] = js.native
  /**
    * Describes the number of parallel tasks that a Java-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application.
    */
  var ParallelismPerKPU: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismPerKPU] = js.native
}
