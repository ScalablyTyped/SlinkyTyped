...
trait DiscoverInputSchemaResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ParsedInputRecords] = js.native
  /**
    * The stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ProcessedInputRecords] = js.native
  /**
    * The raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RawInputRecords] = js.native
}
