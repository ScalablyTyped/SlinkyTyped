...
trait ApplicationConfigurationDescription extends js.Object {
  ...
  var ApplicationCodeConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfigurationDescription
  ] = js.native
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfigurationDescription
  ] = js.native
  /**
    * Describes execution properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.EnvironmentPropertyDescriptions
  ] = js.native
  /**
    * The details about a Java-based Kinesis Data Analytics application.
    */
  var FlinkApplicationConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfigurationDescription
  ] = js.native
  /**
    * The details about the starting properties for a Kinesis Data Analytics application.
    */
  var RunConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RunConfigurationDescription
  ] = js.native
  /**
  ...
  var SqlApplicationConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfigurationDescription
  ] = js.native
  /**
    * The array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcConfigurationDescriptions
  ] = js.native
}
