...
trait KinesisStreamsInputDescription extends js.Object {
  /**
    ...
    */
  var ResourceARN: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ResourceARN = js.native
  /**
    ...
    */
  var RoleARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RoleARN] = js.native
}
