...
trait ApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var ApplicationCodeConfiguration: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfiguration = js.native
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfiguration
  ] = js.native
  /**
    * Describes execution properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.EnvironmentProperties] = js.native
  /**
    * The creation and update parameters for a Java-based Kinesis Data Analytics application.
    */
  var FlinkApplicationConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfiguration
  ] = js.native
  /**
    * The creation and update parameters for an SQL-based Kinesis Data Analytics application.
    */
  var SqlApplicationConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfiguration
  ] = js.native
  /**
    * The array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcConfigurations] = js.native
}
