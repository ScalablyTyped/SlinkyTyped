...
trait SourceSchema extends js.Object {
  /**
    ...
    */
  var RecordColumns: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordColumns = js.native
  /**
    * Specifies the encoding of the records in the streaming source. For example, UTF-8.
    */
  var RecordEncoding: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordEncoding] = js.native
  /**
    * Specifies the format of the records on the streaming source.
    */
  var RecordFormat: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordFormat = js.native
}
