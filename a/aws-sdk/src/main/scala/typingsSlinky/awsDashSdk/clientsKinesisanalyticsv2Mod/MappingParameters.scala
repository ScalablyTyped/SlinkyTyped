...
trait MappingParameters extends js.Object {
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CSVMappingParameters] = js.native
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.JSONMappingParameters] = js.native
}
