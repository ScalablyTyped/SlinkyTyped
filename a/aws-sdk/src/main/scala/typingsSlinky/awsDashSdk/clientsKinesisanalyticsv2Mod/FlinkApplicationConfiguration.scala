...
trait FlinkApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var CheckpointConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointConfiguration] = js.native
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.MonitoringConfiguration] = js.native
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismConfiguration] = js.native
}
