...
trait SqlApplicationConfigurationUpdate extends js.Object {
  /**
    ...
    */
  var InputUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.InputUpdates] = js.native
  /**
    * The array of OutputUpdate objects describing the new destination streams used by the application.
    */
  var OutputUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.OutputUpdates] = js.native
  /**
    * The array of ReferenceDataSourceUpdate objects describing the new reference data sources used by the application.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSourceUpdates] = js.native
}
