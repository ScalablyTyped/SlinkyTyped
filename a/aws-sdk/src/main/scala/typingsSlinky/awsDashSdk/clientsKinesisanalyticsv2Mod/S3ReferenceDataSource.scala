...
trait S3ReferenceDataSource extends js.Object {
  /**
    ...
    */
  var BucketARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.BucketARN] = js.native
  /**
    * The object key name containing the reference data.
    */
  var FileKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FileKey] = js.native
}
