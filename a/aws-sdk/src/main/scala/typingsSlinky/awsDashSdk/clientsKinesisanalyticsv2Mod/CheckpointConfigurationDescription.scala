...
trait CheckpointConfigurationDescription extends js.Object {
  /**
    ...
    */
  var CheckpointInterval: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointInterval] = js.native
  /**
  ...
  /**
    ...
    */
  var MinPauseBetweenCheckpoints: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.MinPauseBetweenCheckpoints] = js.native
}
