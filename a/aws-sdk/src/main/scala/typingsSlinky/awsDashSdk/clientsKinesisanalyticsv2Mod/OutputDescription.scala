...
trait OutputDescription extends js.Object {
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.DestinationSchema] = js.native
  /**
    * Describes the Kinesis Data Firehose delivery stream that is configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutputDescription
  ] = js.native
  /**
    * Describes the Kinesis data stream that is configured as the destination where output is written.
    */
  var KinesisStreamsOutputDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutputDescription
  ] = js.native
  /**
    * Describes the Lambda function that is configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.LambdaOutputDescription] = js.native
  /**
