...
trait ListApplicationSnapshotsResponse extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.NextToken] = js.native
  /**
    * A collection of objects containing information about the application snapshots.
    */
  var SnapshotSummaries: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SnapshotSummaries] = js.native
}
