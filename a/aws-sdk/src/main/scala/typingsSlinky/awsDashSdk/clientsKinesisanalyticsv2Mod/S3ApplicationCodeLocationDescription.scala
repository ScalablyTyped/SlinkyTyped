...
trait S3ApplicationCodeLocationDescription extends js.Object {
  /**
    ...
    */
  var BucketARN: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.BucketARN = js.native
  /**
    * The file key for the object containing the application code.
    */
  var FileKey: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FileKey = js.native
  /**
    * The version of the object containing the application code.
    */
  var ObjectVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ObjectVersion] = js.native
}
