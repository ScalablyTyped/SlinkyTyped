...
trait FlinkApplicationConfigurationUpdate extends js.Object {
  ...
  var CheckpointConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointConfigurationUpdate
  ] = js.native
  /**
  ...
  var MonitoringConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.MonitoringConfigurationUpdate
  ] = js.native
  /**
    * Describes updates to the parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismConfigurationUpdate
  ] = js.native
}
