...
trait UpdateApplicationRequest extends js.Object {
  /**
    ...
    */
  var ApplicationConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationConfigurationUpdate
  ] = js.native
  /**
  ...
  var CloudWatchLoggingOptionUpdates: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CloudWatchLoggingOptionUpdates
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var RunConfigurationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RunConfigurationUpdate] = js.native
  /**
