...
trait CSVMappingParameters extends js.Object {
  /**
    ...
    */
  var RecordColumnDelimiter: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordColumnDelimiter = js.native
  /**
    * The row delimiter. For example, in a CSV format, '\n' is the typical row delimiter.
    */
  var RecordRowDelimiter: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RecordRowDelimiter = js.native
}
