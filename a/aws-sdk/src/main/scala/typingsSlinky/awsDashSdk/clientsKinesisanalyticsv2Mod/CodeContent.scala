...
trait CodeContent extends js.Object {
  /**
    ...
    */
  var S3ContentLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.S3ContentLocation] = js.native
  /**
    * The text-format code for a Java-based Kinesis Data Analytics application.
    */
  var TextContent: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.TextContent] = js.native
  /**
    * The zip-format code for a Java-based Kinesis Data Analytics application.
    */
  var ZipFileContent: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ZipFileContent] = js.native
}
