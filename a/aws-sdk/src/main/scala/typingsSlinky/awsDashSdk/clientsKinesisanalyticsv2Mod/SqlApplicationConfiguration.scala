...
trait SqlApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var Inputs: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.Inputs] = js.native
  /**
    * The array of Output objects describing the destination streams used by the application.
    */
  var Outputs: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.Outputs] = js.native
  /**
    * The array of ReferenceDataSource objects describing the reference data sources used by the application.
    */
  var ReferenceDataSources: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSources] = js.native
}
