...
trait ApplicationConfigurationUpdate extends js.Object {
  ...
  var ApplicationCodeConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfigurationUpdate
  ] = js.native
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfigurationUpdate
  ] = js.native
  /**
    * Describes updates to the environment properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.EnvironmentPropertyUpdates] = js.native
  /**
  ...
  var FlinkApplicationConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfigurationUpdate
  ] = js.native
  /**
  ...
  var SqlApplicationConfigurationUpdate: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfigurationUpdate
  ] = js.native
  /**
    * Updates to the array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcConfigurationUpdates] = js.native
}
