...
trait Output extends js.Object {
  /**
    ...
    */
  var DestinationSchema: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.DestinationSchema = js.native
  /**
    * Identifies an Amazon Kinesis Data Firehose delivery stream as the destination.
    */
  var KinesisFirehoseOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutput] = js.native
  /**
    * Identifies an Amazon Kinesis data stream as the destination.
    */
  var KinesisStreamsOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutput] = js.native
  /**
    * Identifies an AWS Lambda function as the destination.
    */
  var LambdaOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.LambdaOutput] = js.native
  /**
