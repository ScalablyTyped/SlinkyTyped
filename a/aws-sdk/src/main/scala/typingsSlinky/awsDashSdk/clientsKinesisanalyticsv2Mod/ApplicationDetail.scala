...
trait ApplicationDetail extends js.Object {
  ...
  var ApplicationConfigurationDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationConfigurationDescription
  ] = js.native
  /**
    * The description of the application.
    */
  var ApplicationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var ApplicationStatus: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationStatus = js.native
  /**
    * Provides the current application version. Kinesis Data Analytics updates the ApplicationVersionId each time you update the application.
    */
  var ApplicationVersionId: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationVersionId = js.native
  /**
    * Describes the application Amazon CloudWatch logging options.
    */
  var CloudWatchLoggingOptionDescriptions: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.CloudWatchLoggingOptionDescriptions
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var RuntimeEnvironment: typingsSlinky.awsDashSdk.clientsKinesisanalyticsv2Mod.RuntimeEnvironment = js.native
  /**
