...
trait ListMultipartUploadsOutput extends js.Object {
  ...
  /**
    ...
    */
  var KeyMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.KeyMarker] = js.native
  /**
    * Maximum number of multipart uploads that could have been included in the response.
    */
  var MaxUploads: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MaxUploads] = js.native
  /**
    * When a list is truncated, this element specifies the value that should be used for the key-marker request parameter in a subsequent request.
    */
  var NextKeyMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.NextKeyMarker] = js.native
  /**
    * When a list is truncated, this element specifies the value that should be used for the upload-id-marker request parameter in a subsequent request.
    */
  var NextUploadIdMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.NextUploadIdMarker] = js.native
  /**
  ...
  /**
    ...
    */
  var UploadIdMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.UploadIdMarker] = js.native
  /**
