...
trait InventoryEncryption extends js.Object {
  /**
    ...
    */
  var SSEKMS: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSEKMS] = js.native
  /**
    * Specifies the use of SSE-S3 to encrypt delivered inventory reports.
    */
  var SSES3: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSES3] = js.native
}
