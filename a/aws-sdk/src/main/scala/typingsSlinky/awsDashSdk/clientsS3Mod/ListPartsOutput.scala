...
trait ListPartsOutput extends js.Object {
  ...
  /**
    ...
    */
  var AbortRuleId: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AbortRuleId] = js.native
  /**
  ...
  /**
    ...
    */
  var Initiator: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Initiator] = js.native
  /**
    *  Indicates whether the returned list of parts is truncated. A true value indicates that the list was truncated. A list can be truncated if the number of parts exceeds the limit returned in the MaxParts element.
    */
  var IsTruncated: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.IsTruncated] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxParts: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MaxParts] = js.native
  /**
    * When a list is truncated, this element specifies the last part in the list, as well as the value to use for the part-number-marker request parameter in a subsequent request.
    */
  var NextPartNumberMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.NextPartNumberMarker] = js.native
  /**
    *  Container element that identifies the object owner, after the object is created. If multipart upload is initiated by an IAM user, this element provides the parent account ID and display name.
    */
  var Owner: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Owner] = js.native
  /**
    * When a list is truncated, this element specifies the last part in the list, as well as the value to use for the part-number-marker request parameter in a subsequent request.
    */
  var PartNumberMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.PartNumberMarker] = js.native
  /**
    *  Container for elements related to a particular part. A response can contain zero or more Part elements.
    */
  var Parts: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Parts] = js.native
