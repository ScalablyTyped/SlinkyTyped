...
trait GetObjectOutput extends js.Object {
  /**
    ...
    */
  var AcceptRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AcceptRanges] = js.native
  /**
    * Object data.
    */
  var Body: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Body] = js.native
  /**
    * Specifies caching behavior along the request/reply chain.
    */
  var CacheControl: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CacheControl] = js.native
  /**
    * Specifies presentational information for the object.
    */
  var ContentDisposition: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentDisposition] = js.native
  /**
    * Specifies what content encodings have been applied to the object and thus what decoding mechanisms must be applied to obtain the media-type referenced by the Content-Type header field.
    */
  var ContentEncoding: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentEncoding] = js.native
  /**
    * The language the content is in.
    */
  var ContentLanguage: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentLanguage] = js.native
  /**
    * Size of the body in bytes.
    */
  var ContentLength: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentLength] = js.native
  /**
    * The portion of the object returned in the response.
    */
  var ContentRange: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentRange] = js.native
  /**
    * A standard MIME type describing the format of the object data.
    */
  var ContentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentType] = js.native
  /**
    * Specifies whether the object retrieved was (true) or was not (false) a Delete Marker. If false, this response header does not appear in the response.
    */
  var DeleteMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.DeleteMarker] = js.native
  /**
  ...
  /**
    ...
    */
  var Expiration: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Expiration] = js.native
  /**
  ...
  /**
    ...
    */
  var Metadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Metadata] = js.native
  /**
    * This is set to the number of metadata entries not returned in x-amz-meta headers. This can happen if you create metadata using an API like SOAP that supports more flexible metadata than the REST API. For example, using SOAP, you can create metadata whose values are not legal HTTP headers.
    */
  var MissingMeta: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MissingMeta] = js.native
  /**
    * Indicates whether this object has an active legal hold. This field is only returned if you have permission to view an object's legal hold status. 
    */
  var ObjectLockLegalHoldStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ObjectLockLegalHoldStatus] = js.native
  /**
    * The Object Lock mode currently in place for this object.
    */
  var ObjectLockMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ObjectLockMode] = js.native
  /**
  ...
  /**
    ...
    */
  var PartsCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.PartsCount] = js.native
  /**
    * Amazon S3 can return this if your request involves a bucket that is either a source or destination in a replication rule.
    */
  var ReplicationStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ReplicationStatus] = js.native
  var RequestCharged: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.RequestCharged] = js.native
  /**
    * Provides information about object restoration operation and expiration time of the restored object copy.
    */
  var Restore: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Restore] = js.native
  /**
    * If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
    */
  var SSECustomerAlgorithm: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSECustomerAlgorithm] = js.native
  /**
    * If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round-trip message integrity verification of the customer-provided encryption key.
    */
  var SSECustomerKeyMD5: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSECustomerKeyMD5] = js.native
  /**
    * If present, specifies the ID of the AWS Key Management Service (AWS KMS) symmetric customer managed customer master key (CMK) that was used for the object.
    */
  var SSEKMSKeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSEKMSKeyId] = js.native
  /**
    * The server-side encryption algorithm used when storing this object in Amazon S3 (for example, AES256, aws:kms).
    */
  var ServerSideEncryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ServerSideEncryption] = js.native
  /**
    ...
    */
  var StorageClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.StorageClass] = js.native
  /**
    * The number of tags, if any, on the object.
    */
  var TagCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.TagCount] = js.native
  /**
  ...
  /**
    ...
    */
  var WebsiteRedirectLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.WebsiteRedirectLocation] = js.native
}
