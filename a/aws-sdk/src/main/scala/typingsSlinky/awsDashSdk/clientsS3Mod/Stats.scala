...
trait Stats extends js.Object {
  /**
    ...
    */
  var BytesProcessed: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.BytesProcessed] = js.native
  /**
    * The total number of bytes of records payload data returned.
    */
  var BytesReturned: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.BytesReturned] = js.native
  /**
    * The total number of object bytes scanned.
    */
  var BytesScanned: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.BytesScanned] = js.native
}
