...
trait CSVInput extends js.Object {
  /**
    ...
    */
  var AllowQuotedRecordDelimiter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AllowQuotedRecordDelimiter] = js.native
  /**
    * A single character used to indicate that a row should be ignored when the character is present at the start of that row. You can specify any character to indicate a comment line.
    */
  var Comments: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Comments] = js.native
  /**
    * A single character used to separate individual fields in a record. You can specify an arbitrary delimiter.
    */
  var FieldDelimiter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.FieldDelimiter] = js.native
  /**
    ...
    */
  var FileHeaderInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.FileHeaderInfo] = js.native
  /**
    ...
    */
  var QuoteCharacter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.QuoteCharacter] = js.native
  /**
    * A single character used for escaping the quotation mark character inside an already escaped value. For example, the value """ a , b """ is parsed as " a , b ".
    */
  var QuoteEscapeCharacter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.QuoteEscapeCharacter] = js.native
  /**
