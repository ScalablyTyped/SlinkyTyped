...
trait CORSRule extends js.Object {
  /**
    ...
    */
  var AllowedHeaders: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AllowedHeaders] = js.native
  /**
    * An HTTP method that you allow the origin to execute. Valid values are GET, PUT, HEAD, POST, and DELETE.
    */
  var AllowedMethods: typingsSlinky.awsDashSdk.clientsS3Mod.AllowedMethods = js.native
  /**
    * One or more origins you want customers to be able to access the bucket from.
    */
  var AllowedOrigins: typingsSlinky.awsDashSdk.clientsS3Mod.AllowedOrigins = js.native
  /**
    * One or more headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript XMLHttpRequest object).
    */
  var ExposeHeaders: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ExposeHeaders] = js.native
  /**
    * The time in seconds that your browser is to cache the preflight response for the specified resource.
    */
  var MaxAgeSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MaxAgeSeconds] = js.native
}
