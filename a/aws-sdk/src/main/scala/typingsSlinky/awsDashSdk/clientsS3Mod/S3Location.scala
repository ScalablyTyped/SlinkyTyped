...
trait S3Location extends js.Object {
  ...
  /**
    ...
    */
  var BucketName: typingsSlinky.awsDashSdk.clientsS3Mod.BucketName = js.native
  /**
    * The canned ACL to apply to the restore results.
    */
  var CannedACL: js.UndefOr[ObjectCannedACL] = js.native
  var Encryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Encryption] = js.native
  /**
  ...
  /**
    ...
    */
  var Tagging: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Tagging] = js.native
  /**
    * A list of metadata to store with the restore results in S3.
    */
  var UserMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.UserMetadata] = js.native
}
