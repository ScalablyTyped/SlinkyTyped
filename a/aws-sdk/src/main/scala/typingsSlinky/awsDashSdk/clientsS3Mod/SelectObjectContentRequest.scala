...
trait SelectObjectContentRequest extends js.Object {
  ...
  /**
    ...
    */
  var Expression: typingsSlinky.awsDashSdk.clientsS3Mod.Expression = js.native
  /**
    * The type of the provided expression (for example, SQL).
    */
  var ExpressionType: typingsSlinky.awsDashSdk.clientsS3Mod.ExpressionType = js.native
  /**
    * Describes the format of the data in the object that is being queried.
    */
  var InputSerialization: typingsSlinky.awsDashSdk.clientsS3Mod.InputSerialization = js.native
  /**
    * The object key.
    */
  ...
  /**
    ...
    */
  var OutputSerialization: typingsSlinky.awsDashSdk.clientsS3Mod.OutputSerialization = js.native
  /**
    * Specifies if periodic request progress information should be enabled.
    */
  var RequestProgress: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.RequestProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var ScanRange: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ScanRange] = js.native
}
