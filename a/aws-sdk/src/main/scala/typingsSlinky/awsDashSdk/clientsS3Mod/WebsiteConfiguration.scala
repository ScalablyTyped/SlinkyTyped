...
trait WebsiteConfiguration extends js.Object {
  /**
    ...
    */
  var ErrorDocument: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ErrorDocument] = js.native
  /**
    * The name of the index document for the website.
    */
  var IndexDocument: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.IndexDocument] = js.native
  /**
    ...
    */
  var RedirectAllRequestsTo: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.RedirectAllRequestsTo] = js.native
  /**
    * Rules that define when a redirect is applied and the redirect behavior.
    */
  var RoutingRules: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.RoutingRules] = js.native
}
