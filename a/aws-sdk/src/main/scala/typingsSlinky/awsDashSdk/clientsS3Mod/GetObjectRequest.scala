...
trait GetObjectRequest extends js.Object {
  ...
  /**
    ...
    */
  var ResponseCacheControl: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ResponseCacheControl] = js.native
  /**
    * Sets the Content-Disposition header of the response
    */
  var ResponseContentDisposition: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ResponseContentDisposition] = js.native
  /**
    * Sets the Content-Encoding header of the response.
    */
  var ResponseContentEncoding: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ResponseContentEncoding] = js.native
  /**
    * Sets the Content-Language header of the response.
    */
  var ResponseContentLanguage: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ResponseContentLanguage] = js.native
  /**
    * Sets the Content-Type header of the response.
    */
  var ResponseContentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ResponseContentType] = js.native
  /**
