...
trait Destination extends js.Object {
  /**
    ...
    */
  var AccessControlTranslation: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AccessControlTranslation] = js.native
  /**
  ...
  /**
    ...
    */
  var EncryptionConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.EncryptionConfiguration] = js.native
  /**
    ...
    */
  var Metrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Metrics] = js.native
  /**
    *  A container specifying S3 Replication Time Control (S3 RTC), including whether S3 RTC is enabled and the time when all objects and operations on objects must be replicated. Must be specified together with a Metrics block. 
    */
  var ReplicationTime: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ReplicationTime] = js.native
  /**
