...
trait ListObjectsV2Request extends js.Object {
  ...
  /**
    ...
    */
  var Delimiter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Delimiter] = js.native
  /**
    * Encoding type used by Amazon S3 to encode object keys in the response.
    */
  var EncodingType: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.EncodingType] = js.native
  /**
    * The owner field is not present in listV2 by default, if you want to return owner field with each key in the result then set the fetch owner field to true.
    */
  var FetchOwner: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.FetchOwner] = js.native
  /**
    * Sets the maximum number of keys returned in the response. The response might contain fewer keys but will never contain more.
    */
  var MaxKeys: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MaxKeys] = js.native
  /**
    * Limits the response to keys that begin with the specified prefix.
    */
  var Prefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Prefix] = js.native
  /**
  ...
  /**
    ...
    */
  var StartAfter: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.StartAfter] = js.native
}
