...
trait Rule extends js.Object {
  var AbortIncompleteMultipartUpload: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.AbortIncompleteMultipartUpload] = js.native
  /**
  ...
  /**
    ...
    */
  var ID: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ID] = js.native
  var NoncurrentVersionExpiration: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.NoncurrentVersionExpiration] = js.native
  var NoncurrentVersionTransition: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.NoncurrentVersionTransition] = js.native
  /**
    * Object key prefix that identifies one or more objects to which this rule applies.
    */
  var Prefix: typingsSlinky.awsDashSdk.clientsS3Mod.Prefix = js.native
  /**
  ...
  /**
    ...
    */
  var Transition: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.Transition] = js.native
}
