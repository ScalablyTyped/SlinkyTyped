...
trait UploadPartCopyRequest extends js.Object {
  ...
  /**
    ...
    */
  var CopySource: typingsSlinky.awsDashSdk.clientsS3Mod.CopySource = js.native
  /**
    * Copies the object if its entity tag (ETag) matches the specified tag.
    */
  var CopySourceIfMatch: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceIfMatch] = js.native
  /**
  ...
  /**
    ...
    */
  var CopySourceIfNoneMatch: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceIfNoneMatch] = js.native
  /**
  ...
  /**
    ...
    */
  var CopySourceRange: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceRange] = js.native
  /**
    * Specifies the algorithm to use when decrypting the source object (for example, AES256).
    */
  var CopySourceSSECustomerAlgorithm: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceSSECustomerAlgorithm] = js.native
  /**
    * Specifies the customer-provided encryption key for Amazon S3 to use to decrypt the source object. The encryption key provided in this header must be one that was used when the source object was created.
    */
  var CopySourceSSECustomerKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceSSECustomerKey] = js.native
  /**
    * Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
    */
  var CopySourceSSECustomerKeyMD5: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.CopySourceSSECustomerKeyMD5] = js.native
  /**
