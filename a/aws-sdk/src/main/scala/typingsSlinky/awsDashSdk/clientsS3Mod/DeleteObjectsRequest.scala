...
trait DeleteObjectsRequest extends js.Object {
  ...
  /**
    ...
    */
  var BypassGovernanceRetention: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.BypassGovernanceRetention] = js.native
  /**
    * Container for the request.
    */
  var Delete: typingsSlinky.awsDashSdk.clientsS3Mod.Delete = js.native
  /**
    * The concatenation of the authentication device's serial number, a space, and the value that is displayed on your authentication device. Required to permanently delete a versioned object if versioning is configured with MFA delete enabled.
    */
  var MFA: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.MFA] = js.native
