...
trait LoggingEnabled extends js.Object {
  /**
    ...
    */
  var TargetBucket: typingsSlinky.awsDashSdk.clientsS3Mod.TargetBucket = js.native
  /**
    * Container for granting information.
    */
  var TargetGrants: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.TargetGrants] = js.native
  /**
    * A prefix for all log object keys. If you store log files from multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish which log files came from which bucket.
    */
  var TargetPrefix: typingsSlinky.awsDashSdk.clientsS3Mod.TargetPrefix = js.native
}
