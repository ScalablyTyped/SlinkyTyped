...
trait PutObjectRequest extends js.Object {
  ...
  /**
    ...
    */
  var ContentMD5: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.ContentMD5] = js.native
  /**
  ...
  /**
    ...
    */
  var GrantFullControl: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.GrantFullControl] = js.native
  /**
    * Allows grantee to read the object data and its metadata.
    */
  var GrantRead: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.GrantRead] = js.native
  /**
    * Allows grantee to read the object ACL.
    */
  var GrantReadACP: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.GrantReadACP] = js.native
  /**
    * Allows grantee to write the ACL for the applicable object.
    */
  var GrantWriteACP: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.GrantWriteACP] = js.native
  /**
  ...
  var RequestPayer: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.RequestPayer] = js.native
  /**
  ...
  /**
    ...
    */
  var SSECustomerKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSECustomerKey] = js.native
  /**
  ...
  /**
    ...
    */
  var SSEKMSEncryptionContext: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.SSEKMSEncryptionContext] = js.native
  /**
