...
trait StartChatContactResponse extends js.Object {
  /**
    ...
    */
  var ContactId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.ContactId] = js.native
  /**
    * The identifier for a chat participant. The participantId for a chat participant is the same throughout the chat lifecycle.
    */
  var ParticipantId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.ParticipantId] = js.native
  /**
    * The token used by the chat participant to call CreateParticipantConnection. The participant token is valid for the lifetime of a chat participant.
    */
  var ParticipantToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.ParticipantToken] = js.native
}
