...
trait PhoneNumberSummary extends js.Object {
  ...
  /**
    * The phone number.
    */
  var PhoneNumber: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.PhoneNumber] = js.native
  /**
    * The ISO country code.
    */
  var PhoneNumberCountryCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.PhoneNumberCountryCode] = js.native
  /**
    * The type of phone number.
    */
  var PhoneNumberType: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.PhoneNumberType] = js.native
}
