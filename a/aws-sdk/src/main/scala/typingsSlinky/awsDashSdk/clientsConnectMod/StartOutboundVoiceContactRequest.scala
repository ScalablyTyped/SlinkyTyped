...
trait StartOutboundVoiceContactRequest extends js.Object {
  /**
    ...
    */
  var Attributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Attributes] = js.native
  /**
    * A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. The token is valid for 7 days after creation. If a contact is already started, the contact ID is returned. If the contact is disconnected, a new contact is started.
    */
  var ClientToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.ClientToken] = js.native
  /**
    * The identifier of the contact flow for the outbound call.
    */
  var ContactFlowId: typingsSlinky.awsDashSdk.clientsConnectMod.ContactFlowId = js.native
  /**
  ...
  /**
    ...
    */
  var QueueId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.QueueId] = js.native
  /**
