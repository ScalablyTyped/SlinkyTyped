...
trait Threshold extends js.Object {
  /**
    ...
    */
  var Comparison: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Comparison] = js.native
  /**
    * The threshold value to compare.
    */
  var ThresholdValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.ThresholdValue] = js.native
}
