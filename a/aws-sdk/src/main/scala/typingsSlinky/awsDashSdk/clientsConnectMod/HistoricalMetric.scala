...
trait HistoricalMetric extends js.Object {
  ...
  /**
    ...
    */
  var Statistic: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Statistic] = js.native
  /**
    * The threshold for the metric, used with service level metrics.
    */
  var Threshold: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Threshold] = js.native
  /**
    * The unit for the metric.
    */
  var Unit: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Unit] = js.native
}
