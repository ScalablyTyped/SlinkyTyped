...
trait Filters extends js.Object {
  /**
    ...
    */
  var Channels: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Channels] = js.native
  /**
    * The queues to use to filter the metrics. You can specify up to 100 queues per request.
    */
  var Queues: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.Queues] = js.native
}
