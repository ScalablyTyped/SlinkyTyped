...
trait User extends js.Object {
  ...
  /**
    ...
    */
  var DirectoryUserId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.DirectoryUserId] = js.native
  /**
    * The identifier of the hierarchy group for the user.
    */
  var HierarchyGroupId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.HierarchyGroupId] = js.native
  /**
  ...
  /**
    ...
    */
  var RoutingProfileId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.RoutingProfileId] = js.native
  /**
    * The identifiers of the security profiles for the user.
    */
  var SecurityProfileIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.SecurityProfileIds] = js.native
  /**
    * The tags.
    */
