...
trait ListHoursOfOperationsResponse extends js.Object {
  /**
    ...
    */
  var HoursOfOperationSummaryList: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.HoursOfOperationSummaryList] = js.native
  /**
    * If there are additional results, this is the token for the next set of results.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.NextToken] = js.native
}
