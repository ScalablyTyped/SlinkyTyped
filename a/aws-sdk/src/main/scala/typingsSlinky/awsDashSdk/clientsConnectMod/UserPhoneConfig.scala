...
trait UserPhoneConfig extends js.Object {
  /**
    ...
    */
  var AfterContactWorkTimeLimit: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.AfterContactWorkTimeLimit] = js.native
  /**
    * The Auto accept setting.
    */
  var AutoAccept: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectMod.AutoAccept] = js.native
  /**
  ...
  /**
    * The phone type.
    */
  var PhoneType: typingsSlinky.awsDashSdk.clientsConnectMod.PhoneType = js.native
}
