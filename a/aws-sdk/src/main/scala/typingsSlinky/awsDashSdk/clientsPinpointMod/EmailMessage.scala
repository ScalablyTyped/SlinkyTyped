...
trait EmailMessage extends js.Object {
  ...
  /**
    ...
    */
  var RawEmail: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.RawEmail] = js.native
  /**
  ...
  /**
    ...
    */
  var SimpleEmail: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.SimpleEmail] = js.native
  /**
