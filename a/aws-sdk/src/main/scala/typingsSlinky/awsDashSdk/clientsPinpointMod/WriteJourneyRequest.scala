...
trait WriteJourneyRequest extends js.Object {
  ...
  /**
    ...
    */
  var LocalTime: js.UndefOr[__boolean] = js.native
  /**
  ...
  /**
    ...
    */
  var RefreshFrequency: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var StartActivity: js.UndefOr[__string] = js.native
  /**
    * The segment that defines which users are participants in the journey.
    */
  var StartCondition: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.StartCondition] = js.native
  /**
    ...
    */
  var State: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.State] = js.native
}
...
object WriteJourneyRequest {
  ...
  def apply(
    ...
    RefreshFrequency: __string = null,
    Schedule: JourneySchedule = null,
    StartActivity: __string = null,
