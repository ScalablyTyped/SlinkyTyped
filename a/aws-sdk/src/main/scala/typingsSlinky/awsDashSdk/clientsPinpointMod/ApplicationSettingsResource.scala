...
trait ApplicationSettingsResource extends js.Object {
  ...
  /**
    ...
    */
  var CampaignHook: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.CampaignHook] = js.native
  /**
  ...
  /**
    ...
    */
  var QuietTime: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.QuietTime] = js.native
}
