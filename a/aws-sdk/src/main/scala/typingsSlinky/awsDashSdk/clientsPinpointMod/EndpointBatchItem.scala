...
trait EndpointBatchItem extends js.Object {
  /**
    ...
    */
  var Address: js.UndefOr[__string] = js.native
  /**
    ...
    */
  var Attributes: js.UndefOr[MapOfListOf__string] = js.native
  /**
    * The channel to use when sending messages or push notifications to the endpoint.
    */
  var ChannelType: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.ChannelType] = js.native
  /**
  ...
  /**
    ...
    */
  var EffectiveDate: js.UndefOr[__string] = js.native
  /**
    ...
    */
  var EndpointStatus: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var OptOut: js.UndefOr[__string] = js.native
  /**
