...
trait NumberValidateResponse extends js.Object {
  /**
    ...
    */
  var Carrier: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var CleansedPhoneNumberE164: js.UndefOr[__string] = js.native
  /**
    * The cleansed phone number, in the format for the location where the phone number was originally registered.
    */
  var CleansedPhoneNumberNational: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var CountryCodeIso2: js.UndefOr[__string] = js.native
  /**
    * The numeric code for the country or region where the phone number was originally registered.
    */
  var CountryCodeNumeric: js.UndefOr[__string] = js.native
  /**
    * The name of the county where the phone number was originally registered.
    */
  var County: js.UndefOr[__string] = js.native
  /**
    * The two-character code, in ISO 3166-1 alpha-2 format, that was sent in the request body.
    */
  var OriginalCountryCodeIso2: js.UndefOr[__string] = js.native
  /**
    * The phone number that was sent in the request body.
    */
  var OriginalPhoneNumber: js.UndefOr[__string] = js.native
  /**
    * The description of the phone type. Valid values are: MOBILE, LANDLINE, VOIP,
    INVALID, PREPAID, and OTHER.
    */
  var PhoneType: js.UndefOr[__string] = js.native
  /**
    * The phone type, represented by an integer. Valid values are: 0 (mobile), 1 (landline), 2 (VoIP), 3 (invalid), 4 (other), and 5 (prepaid).
    */
  var PhoneTypeCode: js.UndefOr[__integer] = js.native
  /**
  ...
  /**
    ...
    */
  var ZipCode: js.UndefOr[__string] = js.native
}
