...
trait GCMMessage extends js.Object {
  /**
    ...
    */
  var Action: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.Action] = js.native
  /**
  ...
  /**
    ...
    */
  var CollapseKey: js.UndefOr[__string] = js.native
  /**
    * The JSON data payload to use for the push notification, if the notification is a silent push notification. This payload is added to the data.pinpoint.jsonBody object of the notification.
    */
  var Data: js.UndefOr[MapOf__string] = js.native
  /**
    * The icon image name of the asset saved in your app.
    */
  var IconReference: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var Priority: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var RestrictedPackageName: js.UndefOr[__string] = js.native
  /**
