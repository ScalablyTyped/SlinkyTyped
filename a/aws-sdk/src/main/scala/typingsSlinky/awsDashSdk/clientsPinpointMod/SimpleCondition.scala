...
trait SimpleCondition extends js.Object {
  /**
    ...
    */
  var EventCondition: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.EventCondition] = js.native
  /**
    * The segment that's associated with the activity.
    */
  var SegmentCondition: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.SegmentCondition] = js.native
  /**
    * The dimension settings for the segment that's associated with the activity.
    */
  var SegmentDimensions: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.SegmentDimensions] = js.native
}
