...
trait ConditionalSplitActivity extends js.Object {
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var FalseActivity: js.UndefOr[__string] = js.native
  /**
    * The unique identifier for the activity to perform if the conditions are met.
    */
  var TrueActivity: js.UndefOr[__string] = js.native
}
...
object ConditionalSplitActivity {
  ...
  def apply(
    ...
    FalseActivity: __string = null,
    TrueActivity: __string = null
