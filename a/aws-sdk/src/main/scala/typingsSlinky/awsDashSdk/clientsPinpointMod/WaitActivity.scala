...
trait WaitActivity extends js.Object {
  ...
  /**
    ...
    */
  var WaitTime: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.WaitTime] = js.native
}

object WaitActivity {
  @scala.inline
  def apply(NextActivity: __string = null, WaitTime: WaitTime = null): WaitActivity = {
