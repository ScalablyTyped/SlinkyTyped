...
trait CampaignHook extends js.Object {
  /**
    ...
    */
  var LambdaFunctionName: js.UndefOr[__string] = js.native
  /**
    * Specifies which Lambda mode to use when invoking the AWS Lambda function.
    */
  var Mode: js.UndefOr[typingsSlinky.awsDashSdk.clientsPinpointMod.Mode] = js.native
  /**
    *  The web URL that Amazon Pinpoint calls to invoke the AWS Lambda function over HTTPS.
    */
  var WebUrl: js.UndefOr[__string] = js.native
}
