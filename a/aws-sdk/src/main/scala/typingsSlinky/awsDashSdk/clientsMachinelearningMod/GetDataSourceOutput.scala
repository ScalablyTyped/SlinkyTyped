package typingsSlinky.awsDashSdk.clientsMachinelearningMod
...
trait GetDataSourceOutput extends js.Object {
  /**
    ...
    */
  var ComputeStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.ComputeStatistics] = js.native
  /**
  ...
  /**
    ...
    */
  var DataRearrangement: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.DataRearrangement] = js.native
  /**
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.Message] = js.native
  /**
  ...
  var RDSMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.RDSMetadata] = js.native
  var RedshiftMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.RedshiftMetadata] = js.native
  var RoleARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsMachinelearningMod.RoleARN] = js.native
  /**
