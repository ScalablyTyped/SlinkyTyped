...
trait StepScalingPolicyConfiguration extends js.Object {
  /**
    ...
    */
  var AdjustmentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.AdjustmentType] = js.native
  /**
    ...
    */
  var Cooldown: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.Cooldown] = js.native
  /**
    * The aggregation type for the CloudWatch metrics. Valid values are Minimum, Maximum, and Average. If the aggregation type is null, the value is treated as Average.
    */
  var MetricAggregationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.MetricAggregationType] = js.native
  /**
    ...
    */
  var MinAdjustmentMagnitude: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.MinAdjustmentMagnitude] = js.native
  /**
    * A set of adjustments that enable you to scale based on the size of the alarm breach.
    */
  var StepAdjustments: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.StepAdjustments] = js.native
}
