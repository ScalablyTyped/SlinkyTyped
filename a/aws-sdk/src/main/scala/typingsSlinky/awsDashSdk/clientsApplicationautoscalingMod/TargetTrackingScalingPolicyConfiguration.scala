...
trait TargetTrackingScalingPolicyConfiguration extends js.Object {
  ...
  var CustomizedMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.CustomizedMetricSpecification
  ] = js.native
  /**
    ...
    */
  var DisableScaleIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.DisableScaleIn] = js.native
  /**
    * A predefined metric. You can specify either a predefined metric or a customized metric.
    */
  var PredefinedMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.PredefinedMetricSpecification
  ] = js.native
  /**
