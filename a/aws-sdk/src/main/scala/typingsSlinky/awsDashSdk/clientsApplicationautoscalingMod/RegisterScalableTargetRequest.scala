...
trait RegisterScalableTargetRequest extends js.Object {
  ...
  /**
    ...
    */
  var ScalableDimension: typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.ScalableDimension = js.native
  /**
  ...
  /**
    ...
    */
  var SuspendedState: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.SuspendedState] = js.native
}
