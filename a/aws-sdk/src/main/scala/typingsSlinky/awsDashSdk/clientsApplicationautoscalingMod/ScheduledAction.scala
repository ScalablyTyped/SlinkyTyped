...
trait ScheduledAction extends js.Object {
  ...
  /**
    ...
    */
  var ScalableDimension: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.ScalableDimension] = js.native
  /**
    * The new minimum and maximum capacity. You can set both values or just one. During the scheduled time, if the current capacity is below the minimum capacity, Application Auto Scaling scales out to the minimum capacity. If the current capacity is above the maximum capacity, Application Auto Scaling scales in to the maximum capacity.
    */
  var ScalableTargetAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.ScalableTargetAction] = js.native
  /**
  ...
  /**
    ...
    */
  var ScheduledActionName: typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.ScheduledActionName = js.native
  /**
    ...
    */
  var ServiceNamespace: typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.ServiceNamespace = js.native
  /**
