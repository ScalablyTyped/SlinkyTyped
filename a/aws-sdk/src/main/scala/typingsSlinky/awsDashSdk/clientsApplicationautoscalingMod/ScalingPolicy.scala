...
trait ScalingPolicy extends js.Object {
  ...
  /**
    ...
    */
  var PolicyName: typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.PolicyName = js.native
  /**
    * The scaling policy type.
    */
  var PolicyType: typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.PolicyType = js.native
  /**
  ...
  var StepScalingPolicyConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.StepScalingPolicyConfiguration
  ] = js.native
  /**
    * A target tracking scaling policy.
    */
  var TargetTrackingScalingPolicyConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsApplicationautoscalingMod.TargetTrackingScalingPolicyConfiguration
  ] = js.native
}
