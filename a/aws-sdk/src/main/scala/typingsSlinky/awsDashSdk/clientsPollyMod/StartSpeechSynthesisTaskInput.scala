...
trait StartSpeechSynthesisTaskInput extends js.Object {
  ...
  /**
    ...
    */
  var OutputFormat: typingsSlinky.awsDashSdk.clientsPollyMod.OutputFormat = js.native
  /**
    * Amazon S3 bucket name to which the output file will be saved.
    */
  var OutputS3BucketName: typingsSlinky.awsDashSdk.clientsPollyMod.OutputS3BucketName = js.native
  /**
    * The Amazon S3 key prefix for the output speech file.
    */
  var OutputS3KeyPrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.OutputS3KeyPrefix] = js.native
  /**
  ...
  /**
    ...
    */
  var Text: typingsSlinky.awsDashSdk.clientsPollyMod.Text = js.native
  /**
  ...
  /**
    ...
    */
  var VoiceId: typingsSlinky.awsDashSdk.clientsPollyMod.VoiceId = js.native
}
