...
trait ListSpeechSynthesisTasksOutput extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.NextToken] = js.native
  /**
    * List of SynthesisTask objects that provides information from the specified task in the list request, including output format, creation time, task status, and so on.
    */
  var SynthesisTasks: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.SynthesisTasks] = js.native
}
