...
trait Voice extends js.Object {
  ...
  /**
    * Gender of the voice.
    */
  var Gender: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.Gender] = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageName: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.LanguageName] = js.native
  /**
