package typingsSlinky.awsDashSdk.clientsPollyMod
...
trait GetLexiconOutput extends js.Object {
  /**
    ...
    */
  var Lexicon: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.Lexicon] = js.native
  /**
    * Metadata of the lexicon, including phonetic alphabetic used, language code, lexicon ARN, number of lexemes defined in the lexicon, and size of lexicon in bytes.
    */
  var LexiconAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.LexiconAttributes] = js.native
}
