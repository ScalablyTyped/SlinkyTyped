...
trait SynthesisTask extends js.Object {
  ...
  /**
    ...
    */
  var Engine: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.Engine] = js.native
  /**
    ...
    */
  var LanguageCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.LanguageCode] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.OutputFormat] = js.native
  /**
    * Pathway for the output speech file.
    */
  var OutputUri: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.OutputUri] = js.native
  /**
    * Number of billable characters synthesized.
    */
  var RequestCharacters: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.RequestCharacters] = js.native
  /**
    ...
    */
  var SampleRate: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.SampleRate] = js.native
  /**
    * ARN for the SNS topic optionally used for providing status notification for a speech synthesis task.
    */
  var SnsTopicArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.SnsTopicArn] = js.native
  /**
  ...
  /**
    ...
    */
  var TaskId: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.TaskId] = js.native
  /**
    * Current status of the individual speech synthesis task.
    */
  var TaskStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.TaskStatus] = js.native
  /**
    * Reason for the current status of a specific speech synthesis task, including errors if the task has failed.
    */
  var TaskStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.TaskStatusReason] = js.native
  /**
    * Specifies whether the input text is plain text or SSML. The default value is plain text. 
    */
  var TextType: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.TextType] = js.native
  /**
    * Voice ID to use for the synthesis. 
    */
  var VoiceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsPollyMod.VoiceId] = js.native
}
