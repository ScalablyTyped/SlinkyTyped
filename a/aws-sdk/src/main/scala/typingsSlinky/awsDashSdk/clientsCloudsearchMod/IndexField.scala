...
trait IndexField extends js.Object {
  var DateArrayOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.DateArrayOptions] = js.native
  var DateOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.DateOptions] = js.native
  var DoubleArrayOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.DoubleArrayOptions] = js.native
  var DoubleOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.DoubleOptions] = js.native
  /**
  ...
  var IndexFieldType: typingsSlinky.awsDashSdk.clientsCloudsearchMod.IndexFieldType = js.native
  var IntArrayOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.IntArrayOptions] = js.native
  var IntOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.IntOptions] = js.native
  var LatLonOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.LatLonOptions] = js.native
  var LiteralArrayOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.LiteralArrayOptions] = js.native
  var LiteralOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.LiteralOptions] = js.native
  var TextArrayOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.TextArrayOptions] = js.native
  var TextOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.TextOptions] = js.native
}
