...
trait DomainStatus extends js.Object {
  var ARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.ARN] = js.native
  /**
  ...
  var DomainId: typingsSlinky.awsDashSdk.clientsCloudsearchMod.DomainId = js.native
  var DomainName: typingsSlinky.awsDashSdk.clientsCloudsearchMod.DomainName = js.native
  var Limits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.Limits] = js.native
  /**
  ...
  /**
    ...
    */
  var SearchInstanceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudsearchMod.SearchInstanceType] = js.native
  /**
