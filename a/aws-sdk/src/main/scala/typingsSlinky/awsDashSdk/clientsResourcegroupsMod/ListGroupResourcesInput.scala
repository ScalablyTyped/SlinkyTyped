package typingsSlinky.awsDashSdk.clientsResourcegroupsMod
...
trait ListGroupResourcesInput extends js.Object {
  ...
  /**
    ...
    */
  var GroupName: typingsSlinky.awsDashSdk.clientsResourcegroupsMod.GroupName = js.native
  /**
    * The maximum number of group member ARNs that are returned in a single call by ListGroupResources, in paginated output. By default, this number is 50.
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupsMod.MaxResults] = js.native
  /**
    * The NextToken value that is returned in a paginated ListGroupResources request. To get the next page of results, run the call again, add the NextToken parameter, and specify the NextToken value.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsResourcegroupsMod.NextToken] = js.native
}
