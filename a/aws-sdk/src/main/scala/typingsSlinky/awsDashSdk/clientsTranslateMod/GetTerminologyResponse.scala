...
trait GetTerminologyResponse extends js.Object {
  /**
    ...
    */
  var TerminologyDataLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranslateMod.TerminologyDataLocation] = js.native
  /**
    * The properties of the custom terminology being retrieved.
    */
  var TerminologyProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsTranslateMod.TerminologyProperties] = js.native
}
