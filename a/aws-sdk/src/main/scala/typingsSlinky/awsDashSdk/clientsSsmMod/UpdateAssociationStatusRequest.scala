...
trait UpdateAssociationStatusRequest extends js.Object {
  /**
    ...
    */
  var AssociationStatus: typingsSlinky.awsDashSdk.clientsSsmMod.AssociationStatus = js.native
  /**
    * The ID of the instance.
    */
  var InstanceId: typingsSlinky.awsDashSdk.clientsSsmMod.InstanceId = js.native
  /**
