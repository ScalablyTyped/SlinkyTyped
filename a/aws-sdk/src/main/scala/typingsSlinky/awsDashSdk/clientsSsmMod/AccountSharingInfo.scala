...
trait AccountSharingInfo extends js.Object {
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AccountId] = js.native
  /**
    * The version of the current document shared with the account.
    */
  var SharedDocumentVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.SharedDocumentVersion] = js.native
}
