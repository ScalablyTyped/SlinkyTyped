...
trait RegisterTaskWithMaintenanceWindowRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxConcurrency: typingsSlinky.awsDashSdk.clientsSsmMod.MaxConcurrency = js.native
  /**
    * The maximum number of errors allowed before this task stops being scheduled.
    */
  var MaxErrors: typingsSlinky.awsDashSdk.clientsSsmMod.MaxErrors = js.native
  /**
