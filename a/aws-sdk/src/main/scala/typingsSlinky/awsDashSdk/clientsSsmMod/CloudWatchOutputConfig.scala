...
trait CloudWatchOutputConfig extends js.Object {
  /**
    ...
    */
  var CloudWatchLogGroupName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.CloudWatchLogGroupName] = js.native
  /**
    * Enables Systems Manager to send command output to CloudWatch Logs.
    */
  var CloudWatchOutputEnabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.CloudWatchOutputEnabled] = js.native
}
