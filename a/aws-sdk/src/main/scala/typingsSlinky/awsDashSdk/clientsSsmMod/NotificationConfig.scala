...
trait NotificationConfig extends js.Object {
  /**
    ...
    */
  var NotificationArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.NotificationArn] = js.native
  /**
  ...
  /**
    ...
    */
  var NotificationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.NotificationType] = js.native
}
