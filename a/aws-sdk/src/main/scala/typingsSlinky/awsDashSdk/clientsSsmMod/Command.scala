...
trait Command extends js.Object {
  /**
    ...
    */
  var CloudWatchOutputConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.CloudWatchOutputConfig] = js.native
  /**
    * A unique identifier for this command.
    */
  var CommandId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.CommandId] = js.native
  /**
    * User-specified information about the command, such as a brief description of what the command should do.
    */
  var Comment: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Comment] = js.native
  /**
    * The number of targets for which the command invocation reached a terminal state. Terminal states include the following: Success, Failed, Execution Timed Out, Delivery Timed Out, Canceled, Terminated, or Undeliverable.
    */
  var CompletedCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.CompletedCount] = js.native
  /**
    * The number of targets for which the status is Delivery Timed Out.
    */
  var DeliveryTimedOutCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.DeliveryTimedOutCount] = js.native
  /**
    * The name of the document requested for execution.
    */
  var DocumentName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.DocumentName] = js.native
  /**
    * The SSM document version.
    */
  var DocumentVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.DocumentVersion] = js.native
  /**
    * The number of targets for which the status is Failed or Execution Timed Out.
    */
  var ErrorCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ErrorCount] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxConcurrency: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.MaxConcurrency] = js.native
  /**
    ...
    */
  var MaxErrors: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.MaxErrors] = js.native
  /**
    * Configurations for sending notifications about command status changes. 
    */
  var NotificationConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.NotificationConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var Parameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Parameters] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceRole: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ServiceRole] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.StatusDetails] = js.native
  /**
    * The number of targets for the command.
    */
  var TargetCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.TargetCount] = js.native
  /**
    * An array of search criteria that targets instances using a Key,Value combination that you specify. Targets is required if you don't provide one or more instance IDs in the call.
    */
  var Targets: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Targets] = js.native
}
...
object Command {
  ...
  def apply(
    ...
    RequestedDateTime: js.Date = null,
