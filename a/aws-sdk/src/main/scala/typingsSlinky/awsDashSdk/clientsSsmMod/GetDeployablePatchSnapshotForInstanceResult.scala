...
trait GetDeployablePatchSnapshotForInstanceResult extends js.Object {
  ...
  /**
    ...
    */
  var Product: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Product] = js.native
  /**
    * A pre-signed Amazon S3 URL that can be used to download the patch snapshot.
    */
  var SnapshotDownloadUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.SnapshotDownloadUrl] = js.native
  /**
    * The user-defined snapshot ID.
    */
  var SnapshotId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.SnapshotId] = js.native
}
