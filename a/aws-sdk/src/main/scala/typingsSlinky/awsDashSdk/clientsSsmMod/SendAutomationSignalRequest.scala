...
trait SendAutomationSignalRequest extends js.Object {
  /**
    ...
    */
  var AutomationExecutionId: typingsSlinky.awsDashSdk.clientsSsmMod.AutomationExecutionId = js.native
  /**
  ...
  /**
    ...
    */
  var SignalType: typingsSlinky.awsDashSdk.clientsSsmMod.SignalType = js.native
}
