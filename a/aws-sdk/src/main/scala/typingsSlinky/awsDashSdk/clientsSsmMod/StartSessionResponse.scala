...
trait StartSessionResponse extends js.Object {
  ...
  /**
    ...
    */
  var StreamUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.StreamUrl] = js.native
  /**
    * An encrypted token value containing session and caller information. Used to authenticate the connection to the instance.
    */
  var TokenValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.TokenValue] = js.native
}
