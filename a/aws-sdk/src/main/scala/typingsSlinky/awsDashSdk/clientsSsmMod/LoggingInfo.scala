...
trait LoggingInfo extends js.Object {
  /**
    ...
    */
  var S3BucketName: typingsSlinky.awsDashSdk.clientsSsmMod.S3BucketName = js.native
  /**
    * (Optional) The Amazon S3 bucket subfolder. 
    */
  var S3KeyPrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.S3KeyPrefix] = js.native
  /**
    * The region where the Amazon S3 bucket is located.
    */
  var S3Region: typingsSlinky.awsDashSdk.clientsSsmMod.S3Region = js.native
}
