...
trait InstanceInformation extends js.Object {
  /**
    ...
    */
  var ActivationId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ActivationId] = js.native
  /**
  ...
  /**
    ...
    */
  var ComputerName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ComputerName] = js.native
  /**
    * The IP address of the managed instance.
    */
  var IPAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.IPAddress] = js.native
  /**
    ...
    */
  var IamRole: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.IamRole] = js.native
  /**
    * The instance ID. 
    */
  ...
  /**
    ...
    */
  var PingStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.PingStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var PlatformType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.PlatformType] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ResourceType] = js.native
}
