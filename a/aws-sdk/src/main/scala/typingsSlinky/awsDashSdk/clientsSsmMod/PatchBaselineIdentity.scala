...
trait PatchBaselineIdentity extends js.Object {
  /**
    ...
    */
  var BaselineDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.BaselineDescription] = js.native
  /**
    * The ID of the patch baseline.
    */
  var BaselineId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.BaselineId] = js.native
  /**
    * The name of the patch baseline.
    */
  var BaselineName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.BaselineName] = js.native
  /**
    * Whether this is the default baseline. Note that Systems Manager supports creating multiple default patch baselines. For example, you can create a default patch baseline for each operating system.
    */
  var DefaultBaseline: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.DefaultBaseline] = js.native
  /**
