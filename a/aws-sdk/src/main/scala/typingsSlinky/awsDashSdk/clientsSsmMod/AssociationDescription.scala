...
trait AssociationDescription extends js.Object {
  /**
    * The association ID.
    */
  var AssociationId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AssociationId] = js.native
  /**
    * The association name.
    */
  var AssociationName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AssociationName] = js.native
  /**
    * The association version.
    */
  var AssociationVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AssociationVersion] = js.native
  /**
    * Specify the target for the association. This target is required for associations that use an Automation document and target resources by using rate controls.
    */
  var AutomationTargetParameterName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AutomationTargetParameterName] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.InstanceId] = js.native
  /**
  ...
  /**
    ...
    */
  var LastSuccessfulExecutionDate: js.UndefOr[js.Date] = js.native
  /**
    * The date when the association was last updated.
    */
  var LastUpdateAssociationDate: js.UndefOr[js.Date] = js.native
  /**
  ...
  /**
    ...
    */
  var ScheduleExpression: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ScheduleExpression] = js.native
  /**
...
object AssociationDescription {
  ...
  def apply(
    ...
    LastSuccessfulExecutionDate: js.Date = null,
    LastUpdateAssociationDate: js.Date = null,
