...
trait TargetLocation extends js.Object {
  /**
    ...
    */
  var Accounts: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Accounts] = js.native
  /**
    * The Automation execution role used by the currently running Automation.
    */
  var ExecutionRoleName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ExecutionRoleName] = js.native
  /**
    * The AWS Regions targeted by the current Automation execution.
    */
  var Regions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.Regions] = js.native
  /**
