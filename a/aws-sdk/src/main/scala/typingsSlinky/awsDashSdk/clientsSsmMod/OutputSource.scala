...
trait OutputSource extends js.Object {
  /**
    ...
    */
  var OutputSourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.OutputSourceId] = js.native
  /**
    * The type of source where the association execution details are stored, for example, Amazon S3.
    */
  var OutputSourceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.OutputSourceType] = js.native
}
