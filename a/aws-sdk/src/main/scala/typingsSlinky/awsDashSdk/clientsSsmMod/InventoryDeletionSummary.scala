...
trait InventoryDeletionSummary extends js.Object {
  /**
    ...
    */
  var RemainingCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.RemainingCount] = js.native
  /**
  ...
  /**
    ...
    */
  var TotalCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.TotalCount] = js.native
}
