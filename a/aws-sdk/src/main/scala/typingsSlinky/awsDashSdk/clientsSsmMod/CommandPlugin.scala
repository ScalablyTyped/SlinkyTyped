...
trait CommandPlugin extends js.Object {
  ...
  /**
    ...
    */
  var ResponseCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ResponseCode] = js.native
  /**
...
object CommandPlugin {
  ...
  def apply(
    ...
    ResponseFinishDateTime: js.Date = null,
    ResponseStartDateTime: js.Date = null,
