...
trait AutomationExecution extends js.Object {
  /**
    * The execution ID.
    */
  var AutomationExecutionId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AutomationExecutionId] = js.native
  /**
    * The execution status of the Automation.
    */
  var AutomationExecutionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.AutomationExecutionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ProgressCounters: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ProgressCounters] = js.native
  /**
    * A list of resolved targets in the rate control execution.
    */
  var ResolvedTargets: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.ResolvedTargets] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetLocations: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.TargetLocations] = js.native
  /**
    * The specified key-value mapping of document parameters to target resources.
    */
  var TargetMaps: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.TargetMaps] = js.native
  /**
    * The parameter name.
    */
