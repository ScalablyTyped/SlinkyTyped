...
trait CreateActivationRequest extends js.Object {
  /**
    ...
    */
  var DefaultInstanceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.DefaultInstanceName] = js.native
  /**
  ...
  /**
    ...
    */
  var IamRole: typingsSlinky.awsDashSdk.clientsSsmMod.IamRole = js.native
  /**
    * Specify the maximum number of managed instances you want to register. The default value is 1 instance.
    */
  var RegistrationLimit: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.RegistrationLimit] = js.native
  /**
