...
trait InstancePatchState extends js.Object {
  ...
  /**
    ...
    */
  var InstallOverrideList: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.InstallOverrideList] = js.native
  /**
  ...
  /**
    * Reserved for future use. 
    */
  var RebootOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsSsmMod.RebootOption] = js.native
  /**
