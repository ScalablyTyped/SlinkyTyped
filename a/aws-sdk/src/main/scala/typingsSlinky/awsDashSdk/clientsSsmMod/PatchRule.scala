...
trait PatchRule extends js.Object {
  /**
    ...
    */
  var ApproveAfterDays: typingsSlinky.awsDashSdk.clientsSsmMod.ApproveAfterDays = js.native
  /**
  ...
  /**
    ...
    */
  var PatchFilterGroup: typingsSlinky.awsDashSdk.clientsSsmMod.PatchFilterGroup = js.native
}
