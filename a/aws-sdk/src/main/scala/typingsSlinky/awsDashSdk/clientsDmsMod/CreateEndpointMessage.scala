...
trait CreateEndpointMessage extends js.Object {
  ...
  /**
    ...
    */
  var DmsTransferSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.DmsTransferSettings] = js.native
  /**
    ...
    */
  var DynamoDbSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.DynamoDbSettings] = js.native
  /**
    ...
    */
  var ElasticsearchSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.ElasticsearchSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var KinesisSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.KinesisSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var MongoDbSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.MongoDbSettings] = js.native
  /**
  ...
  var RedshiftSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.RedshiftSettings] = js.native
  /**
    * Settings in JSON format for the target Amazon S3 endpoint. For more information about the available settings, see Extra Connection Attributes When Using Amazon S3 as a Target for AWS DMS in the AWS Database Migration Service User Guide. 
    */
  var S3Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsDmsMod.S3Settings] = js.native
  /**
