...
trait LookupEventsRequest extends js.Object {
  ...
  /**
    ...
    */
  var EventCategory: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudtrailMod.EventCategory] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudtrailMod.MaxResults] = js.native
  /**
    * The token to use to get the next page of results after a previous API call. This token must be passed in with the same parameters that were specified in the the original call. For example, if the original call specified an AttributeKey of 'Username' with a value of 'root', the call with NextToken should include those same parameters.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudtrailMod.NextToken] = js.native
  /**
