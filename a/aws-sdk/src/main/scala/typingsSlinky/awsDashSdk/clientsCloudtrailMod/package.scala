...
package object clientsCloudtrailMod {
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.ApiCallRateInsight
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.insight
  import typingsSlinky.awsDashSdk.libServiceMod.ServiceConfigurationOptions
  import typingsSlinky.node.Buffer

  type Boolean = scala.Boolean
  type ByteBuffer = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | java.lang.String
