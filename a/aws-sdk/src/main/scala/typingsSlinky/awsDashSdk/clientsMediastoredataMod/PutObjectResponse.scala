...
trait PutObjectResponse extends js.Object {
  ...
  /**
    ...
    */
  var ETag: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediastoredataMod.ETag] = js.native
  /**
    * The storage class where the object was persisted. The class should be “Temporal”.
    */
  var StorageClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediastoredataMod.StorageClass] = js.native
}
