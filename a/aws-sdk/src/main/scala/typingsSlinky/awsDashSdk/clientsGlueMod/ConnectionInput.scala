...
trait ConnectionInput extends js.Object {
  /**
    ...
    */
  var ConnectionProperties: typingsSlinky.awsDashSdk.clientsGlueMod.ConnectionProperties = js.native
  /**
    * The type of the connection. Currently, only JDBC is supported; SFTP is not supported.
    */
  var ConnectionType: typingsSlinky.awsDashSdk.clientsGlueMod.ConnectionType = js.native
  /**
