...
trait Connection extends js.Object {
  /**
    ...
    */
  var ConnectionProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ConnectionProperties] = js.native
  /**
    * The type of the connection. Currently, only JDBC is supported; SFTP is not supported.
    */
  var ConnectionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ConnectionType] = js.native
  /**
  ...
  /**
    ...
    */
  var MatchCriteria: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.MatchCriteria] = js.native
  /**
  ...
  /**
    ...
    */
  var PhysicalConnectionRequirements: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.PhysicalConnectionRequirements] = js.native
}
