...
trait DataCatalogEncryptionSettings extends js.Object {
  /**
    ...
    */
  var ConnectionPasswordEncryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ConnectionPasswordEncryption] = js.native
  /**
    * Specifies the encryption-at-rest configuration for the Data Catalog.
    */
  var EncryptionAtRest: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.EncryptionAtRest] = js.native
}
