...
trait Crawl extends js.Object {
  ...
  /**
    ...
    */
  var LogGroup: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.LogGroup] = js.native
  /**
    * The log stream associated with the crawl.
    */
  var LogStream: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.LogStream] = js.native
  /**
