...
trait TransformParameters extends js.Object {
  /**
    ...
    */
  var FindMatchesParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.FindMatchesParameters] = js.native
  /**
    ...
    */
  var TransformType: typingsSlinky.awsDashSdk.clientsGlueMod.TransformType = js.native
}
