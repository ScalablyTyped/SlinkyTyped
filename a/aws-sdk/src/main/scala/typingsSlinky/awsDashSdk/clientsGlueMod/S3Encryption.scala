...
trait S3Encryption extends js.Object {
  /**
    ...
    */
  var KmsKeyArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.KmsKeyArn] = js.native
  /**
    * The encryption mode to use for Amazon S3 data.
    */
  var S3EncryptionMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.S3EncryptionMode] = js.native
}
