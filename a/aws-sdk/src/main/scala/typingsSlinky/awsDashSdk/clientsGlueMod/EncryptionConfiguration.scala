...
trait EncryptionConfiguration extends js.Object {
  /**
    ...
    */
  var CloudWatchEncryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.CloudWatchEncryption] = js.native
  /**
    * The encryption configuration for job bookmarks.
    */
  var JobBookmarksEncryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.JobBookmarksEncryption] = js.native
  /**
