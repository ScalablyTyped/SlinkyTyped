...
trait SchemaChangePolicy extends js.Object {
  /**
    ...
    */
  var DeleteBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.DeleteBehavior] = js.native
  /**
    * The update behavior when the crawler finds a changed schema.
    */
  var UpdateBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.UpdateBehavior] = js.native
}
