...
trait GetPlanResponse extends js.Object {
  /**
    ...
    */
  var PythonScript: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.PythonScript] = js.native
  /**
    * The Scala code to perform the mapping.
    */
  var ScalaCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ScalaCode] = js.native
}
