...
trait CreateScriptRequest extends js.Object {
  /**
    ...
    */
  var DagEdges: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.DagEdges] = js.native
  /**
    * A list of the nodes in the DAG.
    */
  var DagNodes: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.DagNodes] = js.native
  /**
    * The programming language of the resulting code from the DAG.
    */
  var Language: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.Language] = js.native
}
