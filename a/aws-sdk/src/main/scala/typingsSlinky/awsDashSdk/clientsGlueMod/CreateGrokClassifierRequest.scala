...
trait CreateGrokClassifierRequest extends js.Object {
  /**
    ...
    */
  var Classification: typingsSlinky.awsDashSdk.clientsGlueMod.Classification = js.native
  /**
  ...
  /**
    ...
    */
  var GrokPattern: typingsSlinky.awsDashSdk.clientsGlueMod.GrokPattern = js.native
  /**
