...
trait UpdateGrokClassifierRequest extends js.Object {
  /**
    ...
    */
  var Classification: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.Classification] = js.native
  /**
    * Optional custom grok patterns used by this classifier.
    */
  var CustomPatterns: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.CustomPatterns] = js.native
  /**
    * The grok pattern used by this classifier.
    */
  var GrokPattern: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.GrokPattern] = js.native
  /**
