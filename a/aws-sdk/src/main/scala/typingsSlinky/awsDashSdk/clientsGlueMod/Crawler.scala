...
trait Crawler extends js.Object {
  ...
  /**
    ...
    */
  var CrawlerSecurityConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.CrawlerSecurityConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var DatabaseName: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.DatabaseName] = js.native
  /**
  ...
  /**
    ...
    */
  var Role: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.Role] = js.native
  /**
    * For scheduled crawlers, the schedule when the crawler runs.
    */
  var Schedule: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.Schedule] = js.native
  /**
    * The policy that specifies update and delete behaviors for the crawler.
    */
  var SchemaChangePolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.SchemaChangePolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var TablePrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.TablePrefix] = js.native
  /**
