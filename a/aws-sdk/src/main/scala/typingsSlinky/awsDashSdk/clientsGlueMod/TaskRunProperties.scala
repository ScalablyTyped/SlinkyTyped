...
trait TaskRunProperties extends js.Object {
  /**
    ...
    */
  var ExportLabelsTaskRunProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ExportLabelsTaskRunProperties] = js.native
  /**
    * The configuration properties for a find matches task run.
    */
  var FindMatchesTaskRunProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.FindMatchesTaskRunProperties] = js.native
  /**
    * The configuration properties for an importing labels task run.
    */
  var ImportLabelsTaskRunProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.ImportLabelsTaskRunProperties] = js.native
  /**
    * The configuration properties for a labeling set generation task run.
    */
  var LabelingSetGenerationTaskRunProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.LabelingSetGenerationTaskRunProperties] = js.native
  /**
    * The type of task run.
    */
  var TaskType: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.TaskType] = js.native
}
