...
trait Classifier extends js.Object {
  /**
    ...
    */
  var CsvClassifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.CsvClassifier] = js.native
  /**
    * A classifier that uses grok.
    */
  var GrokClassifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.GrokClassifier] = js.native
  /**
    * A classifier for JSON content.
    */
  var JsonClassifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.JsonClassifier] = js.native
  /**
    * A classifier for XML content.
    */
  var XMLClassifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlueMod.XMLClassifier] = js.native
}
