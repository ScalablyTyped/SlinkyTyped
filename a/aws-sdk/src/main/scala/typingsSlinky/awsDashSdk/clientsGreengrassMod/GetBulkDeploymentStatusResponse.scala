...
trait GetBulkDeploymentStatusResponse extends js.Object {
  /**
    ...
    */
  var BulkDeploymentMetrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.BulkDeploymentMetrics] = js.native
  /**
    * The status of the bulk deployment.
    */
  var BulkDeploymentStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.BulkDeploymentStatus] = js.native
  /**
