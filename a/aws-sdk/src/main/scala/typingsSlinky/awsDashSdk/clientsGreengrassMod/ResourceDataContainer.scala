...
trait ResourceDataContainer extends js.Object {
  /**
    ...
    */
  var LocalDeviceResourceData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.LocalDeviceResourceData] = js.native
  /**
    * Attributes that define the local volume resource.
    */
  var LocalVolumeResourceData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.LocalVolumeResourceData] = js.native
  /**
    * Attributes that define an Amazon S3 machine learning resource.
    */
  var S3MachineLearningModelResourceData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.S3MachineLearningModelResourceData] = js.native
  /**
    * Attributes that define an Amazon SageMaker machine learning resource.
    */
  var SageMakerMachineLearningModelResourceData: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsGreengrassMod.SageMakerMachineLearningModelResourceData
  ] = js.native
  /**
    * Attributes that define a secret resource, which references a secret from AWS Secrets Manager.
    */
  var SecretsManagerSecretResourceData: js.UndefOr[typingsSlinky.awsDashSdk.clientsGreengrassMod.SecretsManagerSecretResourceData] = js.native
}
