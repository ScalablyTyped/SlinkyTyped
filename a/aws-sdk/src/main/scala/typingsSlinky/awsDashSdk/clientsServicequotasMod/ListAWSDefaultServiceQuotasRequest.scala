...
trait ListAWSDefaultServiceQuotasRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.MaxResults] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.NextToken] = js.native
  /**
