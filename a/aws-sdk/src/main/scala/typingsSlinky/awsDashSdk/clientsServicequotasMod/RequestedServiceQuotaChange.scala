...
trait RequestedServiceQuotaChange extends js.Object {
  ...
  /**
    ...
    */
  var GlobalQuota: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.GlobalQuota] = js.native
  /**
  ...
  /**
    ...
    */
  var QuotaArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.QuotaArn] = js.native
  /**
    * Specifies the service quota that you want to use.
    */
  var QuotaCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.QuotaCode] = js.native
  /**
    * Name of the service quota.
    */
  var QuotaName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.QuotaName] = js.native
  /**
    * The IAM identity who submitted the service quota increase request.
    */
  var Requester: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.Requester] = js.native
  /**
    * Specifies the service that you want to use.
    */
  var ServiceCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.ServiceCode] = js.native
  /**
    * The name of the AWS service specified in the increase request. 
    */
  var ServiceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.ServiceName] = js.native
  /**
