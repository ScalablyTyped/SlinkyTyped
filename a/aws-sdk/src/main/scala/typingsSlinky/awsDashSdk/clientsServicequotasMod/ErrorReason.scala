...
trait ErrorReason extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.ErrorCode] = js.native
  /**
    * The error message that provides more detail.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicequotasMod.ErrorMessage] = js.native
}
