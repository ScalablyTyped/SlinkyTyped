...
trait ListRepositoryAssociationsRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.MaxResults] = js.native
  /**
    * List of names to use as a filter.
    */
  var Names: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.Names] = js.native
  /**
  ...
  /**
    ...
    */
  var Owners: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.Owners] = js.native
  /**
    * List of provider types to use as a filter.
    */
  var ProviderTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.ProviderTypes] = js.native
  /**
