...
trait ListRepositoryAssociationsResponse extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.NextToken] = js.native
  /**
    * A list of repository associations that meet the criteria of the request.
    */
  var RepositoryAssociationSummaries: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.RepositoryAssociationSummaries
  ] = js.native
}
