...
trait AssociateRepositoryRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.ClientRequestToken] = js.native
  /**
    * The repository to associate.
    */
  var Repository: typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.Repository = js.native
}
