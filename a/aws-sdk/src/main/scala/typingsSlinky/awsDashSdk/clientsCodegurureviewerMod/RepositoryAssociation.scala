...
trait RepositoryAssociation extends js.Object {
  ...
  /**
    ...
    */
  var AssociationId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.AssociationId] = js.native
  /**
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.Name] = js.native
  /**
    * The owner of the repository.
    */
  var Owner: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.Owner] = js.native
  /**
    * The provider type of the repository association.
    */
  var ProviderType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.ProviderType] = js.native
  /**
  ...
  /**
    ...
    */
  var StateReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodegurureviewerMod.StateReason] = js.native
}
