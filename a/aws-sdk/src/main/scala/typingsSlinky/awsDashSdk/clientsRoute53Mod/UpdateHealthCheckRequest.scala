...
trait UpdateHealthCheckRequest extends js.Object {
  /**
    ...
    */
  var AlarmIdentifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.AlarmIdentifier] = js.native
  /**
  ...
  /**
    ...
    */
  var Disabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.Disabled] = js.native
  /**
    ...
    */
  var EnableSNI: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.EnableSNI] = js.native
  /**
    ...
    */
  var FailureThreshold: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.FailureThreshold] = js.native
  /**
    ...
    */
  var FullyQualifiedDomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.FullyQualifiedDomainName] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.HealthCheckVersion] = js.native
  /**
    ...
    */
  var HealthThreshold: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.HealthThreshold] = js.native
  /**
    ...
    */
  var IPAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.IPAddress] = js.native
  /**
    ...
    */
  var InsufficientDataHealthStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.InsufficientDataHealthStatus] = js.native
  /**
    * Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.
    */
  var Inverted: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.Inverted] = js.native
  /**
    * The port on the endpoint on which you want Amazon Route 53 to perform health checks.
    */
  var Port: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.Port] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourcePath: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.ResourcePath] = js.native
  /**
    ...
    */
  var SearchString: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.SearchString] = js.native
}
