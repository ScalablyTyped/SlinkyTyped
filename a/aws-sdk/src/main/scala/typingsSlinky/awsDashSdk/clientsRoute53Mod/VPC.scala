...
trait VPC extends js.Object {
  var VPCId: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.VPCId] = js.native
  /**
    * (Private hosted zones only) The region that an Amazon VPC was created in.
    */
  var VPCRegion: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.VPCRegion] = js.native
}
