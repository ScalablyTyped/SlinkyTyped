...
trait ListTrafficPolicyVersionsResponse extends js.Object {
  ...
  /**
    ...
    */
  var TrafficPolicies: typingsSlinky.awsDashSdk.clientsRoute53Mod.TrafficPolicies = js.native
  /**
    ...
    */
  var TrafficPolicyVersionMarker: typingsSlinky.awsDashSdk.clientsRoute53Mod.TrafficPolicyVersionMarker = js.native
}
