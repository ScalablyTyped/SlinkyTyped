...
trait HealthCheck extends js.Object {
  ...
  /**
    ...
    */
  var CloudWatchAlarmConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.CloudWatchAlarmConfiguration] = js.native
  /**
    * A complex type that contains detailed information about one health check.
    */
  var HealthCheckConfig: typingsSlinky.awsDashSdk.clientsRoute53Mod.HealthCheckConfig = js.native
  /**
    * The version of the health check. You can optionally pass this value in a call to UpdateHealthCheck to prevent overwriting another change to the health check.
    */
  var HealthCheckVersion: typingsSlinky.awsDashSdk.clientsRoute53Mod.HealthCheckVersion = js.native
  /**
  ...
  /**
    ...
    */
  var LinkedService: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.LinkedService] = js.native
}
