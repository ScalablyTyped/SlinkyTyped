...
trait TrafficPolicyInstance extends js.Object {
  ...
  /**
    ...
    */
  var Message: typingsSlinky.awsDashSdk.clientsRoute53Mod.Message = js.native
  /**
  ...
  /**
    ...
    */
  var TTL: typingsSlinky.awsDashSdk.clientsRoute53Mod.TTL = js.native
  /**
    * The ID of the traffic policy that Amazon Route 53 used to create resource record sets in the specified hosted zone.
    */
  var TrafficPolicyId: typingsSlinky.awsDashSdk.clientsRoute53Mod.TrafficPolicyId = js.native
  /**
  ...
  /**
    ...
    */
  var TrafficPolicyVersion: typingsSlinky.awsDashSdk.clientsRoute53Mod.TrafficPolicyVersion = js.native
}
