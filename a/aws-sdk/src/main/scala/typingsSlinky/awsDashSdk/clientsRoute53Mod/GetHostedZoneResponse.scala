...
trait GetHostedZoneResponse extends js.Object {
  /**
    ...
    */
  var DelegationSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.DelegationSet] = js.native
  /**
    * A complex type that contains general information about the specified hosted zone.
    */
  var HostedZone: typingsSlinky.awsDashSdk.clientsRoute53Mod.HostedZone = js.native
  /**
    * A complex type that contains information about the VPCs that are associated with the specified hosted zone.
    */
  var VPCs: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53Mod.VPCs] = js.native
}
