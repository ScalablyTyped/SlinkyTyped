...
trait ListInstancesInput extends js.Object {
  ...
  /**
    ...
    */
  var InstanceFleetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.InstanceFleetType] = js.native
  /**
    * The identifier of the instance group for which to list the instances.
    */
  var InstanceGroupId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.InstanceGroupId] = js.native
  /**
