...
trait Cluster extends js.Object {
  ...
  /**
    ...
    */
  var Ec2InstanceAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.Ec2InstanceAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceCollectionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.InstanceCollectionType] = js.native
  /**
    * Attributes for Kerberos configuration when Kerberos authentication is enabled using a security configuration. For more information see Use Kerberos Authentication in the EMR Management Guide.
    */
  var KerberosAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.KerberosAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var RepoUpgradeOnBoot: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.RepoUpgradeOnBoot] = js.native
  /**
  ...
  /**
    ...
    */
  var ScaleDownBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsEmrMod.ScaleDownBehavior] = js.native
  /**
