...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.clusterRunning
import typingsSlinky.awsDashSdk.awsDashSdkStrings.clusterTerminated
import typingsSlinky.awsDashSdk.awsDashSdkStrings.stepComplete
...
trait EMR extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_clusterRunning(state: clusterRunning, params: DescribeClusterInput with Anon_Waiter): Request[DescribeClusterOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_clusterRunning(
    state: clusterRunning,
    params: DescribeClusterInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeClusterOutput, scala.Unit]
  ): Request[DescribeClusterOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_clusterTerminated(state: clusterTerminated, params: DescribeClusterInput with Anon_Waiter): Request[DescribeClusterOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_clusterTerminated(
    state: clusterTerminated,
    params: DescribeClusterInput with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_stepComplete(state: stepComplete, params: DescribeStepInput with Anon_Waiter): Request[DescribeStepOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_stepComplete(
    state: stepComplete,
    params: DescribeStepInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeStepOutput, scala.Unit]
  ): Request[DescribeStepOutput, AWSError] = js.native
}
