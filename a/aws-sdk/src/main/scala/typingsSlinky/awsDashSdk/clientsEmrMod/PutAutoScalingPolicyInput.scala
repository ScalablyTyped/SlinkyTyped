...
trait PutAutoScalingPolicyInput extends js.Object {
  /**
    ...
    */
  var AutoScalingPolicy: typingsSlinky.awsDashSdk.clientsEmrMod.AutoScalingPolicy = js.native
  /**
    * Specifies the ID of a cluster. The instance group to which the automatic scaling policy is applied is within this cluster.
    */
  var ClusterId: typingsSlinky.awsDashSdk.clientsEmrMod.ClusterId = js.native
  /**
    * Specifies the ID of the instance group to which the automatic scaling policy is applied.
    */
  var InstanceGroupId: typingsSlinky.awsDashSdk.clientsEmrMod.InstanceGroupId = js.native
}
