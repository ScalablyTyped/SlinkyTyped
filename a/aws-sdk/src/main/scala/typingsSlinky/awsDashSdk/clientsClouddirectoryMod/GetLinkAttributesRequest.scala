...
trait GetLinkAttributesRequest extends js.Object {
  ...
  /**
    ...
    */
  var ConsistencyLevel: js.UndefOr[typingsSlinky.awsDashSdk.clientsClouddirectoryMod.ConsistencyLevel] = js.native
  /**
  ...
  /**
    ...
    */
  var TypedLinkSpecifier: typingsSlinky.awsDashSdk.clientsClouddirectoryMod.TypedLinkSpecifier = js.native
}
