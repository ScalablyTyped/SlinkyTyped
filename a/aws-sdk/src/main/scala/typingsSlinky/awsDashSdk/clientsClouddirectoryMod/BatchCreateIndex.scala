...
trait BatchCreateIndex extends js.Object {
  /**
    ...
    */
  var BatchReferenceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsClouddirectoryMod.BatchReferenceName] = js.native
  /**
  ...
  /**
    ...
    */
  var LinkName: js.UndefOr[typingsSlinky.awsDashSdk.clientsClouddirectoryMod.LinkName] = js.native
  /**
