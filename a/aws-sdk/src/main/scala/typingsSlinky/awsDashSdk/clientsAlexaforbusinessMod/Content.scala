...
trait Content extends js.Object {
  /**
    ...
    */
  var AudioList: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.AudioList] = js.native
  /**
    * The list of SSML messages.
    */
  var SsmlList: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SsmlList] = js.native
  /**
    * The list of text messages.
    */
  var TextList: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.TextList] = js.native
}
