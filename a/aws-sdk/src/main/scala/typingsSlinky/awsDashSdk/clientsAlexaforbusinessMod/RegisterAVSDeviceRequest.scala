...
trait RegisterAVSDeviceRequest extends js.Object {
  /**
    ...
    */
  var AmazonId: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.AmazonId = js.native
  /**
    * The client ID of the OEM used for code-based linking authorization on an AVS device.
    */
  var ClientId: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ClientId = js.native
  /**
  ...
  /**
    ...
    */
  var ProductId: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ProductId = js.native
  /**
    * The code that is obtained after your AVS device has made a POST request to LWA as a part of the Device Authorization Request component of the OAuth code-based linking specification.
    */
  var UserCode: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.UserCode = js.native
}
