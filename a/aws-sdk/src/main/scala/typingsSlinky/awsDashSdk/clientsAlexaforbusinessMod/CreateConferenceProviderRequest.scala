...
trait CreateConferenceProviderRequest extends js.Object {
  ...
  /**
    ...
    */
  var ConferenceProviderName: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ConferenceProviderName = js.native
  /**
    * Represents a type within a list of predefined types.
    */
  var ConferenceProviderType: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ConferenceProviderType = js.native
  /**
    * The IP endpoint and protocol for calling.
    */
  var IPDialIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.IPDialIn] = js.native
  /**
    * The meeting settings for the conference provider.
    */
  var MeetingSetting: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.MeetingSetting = js.native
  /**
    * The information for PSTN conferencing.
    */
  var PSTNDialIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.PSTNDialIn] = js.native
}
