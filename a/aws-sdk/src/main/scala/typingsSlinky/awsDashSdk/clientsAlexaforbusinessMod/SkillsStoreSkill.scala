...
trait SkillsStoreSkill extends js.Object {
  /**
    ...
    */
  var IconUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.IconUrl] = js.native
  /**
    * Sample utterances that interact with the skill.
    */
  var SampleUtterances: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SampleUtterances] = js.native
  /**
    * Short description about the skill.
    */
  var ShortDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ShortDescription] = js.native
  /**
    * Information about the skill.
    */
  var SkillDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SkillDetails] = js.native
  /**
    * The ARN of the skill.
    */
  var SkillId: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SkillId] = js.native
  /**
    * The name of the skill.
    */
  var SkillName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SkillName] = js.native
  /**
