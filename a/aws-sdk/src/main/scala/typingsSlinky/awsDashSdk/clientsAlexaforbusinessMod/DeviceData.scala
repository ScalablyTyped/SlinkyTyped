...
trait DeviceData extends js.Object {
  ...
  /**
    ...
    */
  var DeviceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceName] = js.native
  /**
    * The serial number of a device.
    */
  var DeviceSerialNumber: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceSerialNumber] = js.native
  /**
    * The status of a device.
    */
  var DeviceStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceStatus] = js.native
  /**
    * Detailed information about a device's status.
    */
  var DeviceStatusInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceStatusInfo] = js.native
  /**
    * The type of a device.
    */
  var DeviceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceType] = js.native
  /**
    * The MAC address of a device.
    */
  var MacAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.MacAddress] = js.native
  /**
  ...
  /**
    ...
    */
  var SoftwareVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.SoftwareVersion] = js.native
}
