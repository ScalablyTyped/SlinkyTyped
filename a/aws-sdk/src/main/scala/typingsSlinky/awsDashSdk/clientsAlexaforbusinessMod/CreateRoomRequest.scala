...
trait CreateRoomRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ClientRequestToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ProviderCalendarId: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ProviderCalendarId] = js.native
  /**
    * The name for the room.
    */
  var RoomName: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.RoomName = js.native
  /**
