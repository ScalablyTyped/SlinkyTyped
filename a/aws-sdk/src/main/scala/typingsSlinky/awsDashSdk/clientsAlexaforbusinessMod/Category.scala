...
trait Category extends js.Object {
  /**
    ...
    */
  var CategoryId: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.CategoryId] = js.native
  /**
    * The name of the skill store category.
    */
  var CategoryName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.CategoryName] = js.native
}
