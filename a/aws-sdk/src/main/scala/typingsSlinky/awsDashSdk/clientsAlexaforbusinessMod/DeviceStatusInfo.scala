...
trait DeviceStatusInfo extends js.Object {
  /**
    ...
    */
  var ConnectionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ConnectionStatus] = js.native
  /**
    * One or more device status detail descriptions.
    */
  var DeviceStatusDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DeviceStatusDetails] = js.native
}
