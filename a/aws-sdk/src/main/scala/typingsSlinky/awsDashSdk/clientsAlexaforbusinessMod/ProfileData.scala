...
trait ProfileData extends js.Object {
  /**
    ...
    */
  var Address: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Address] = js.native
  /**
    * The distance unit of a room profile.
    */
  var DistanceUnit: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DistanceUnit] = js.native
  /**
  ...
  /**
    ...
    */
  var ProfileName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ProfileName] = js.native
  /**
    * The temperature unit of a room profile.
    */
  var TemperatureUnit: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.TemperatureUnit] = js.native
  /**
    * The time zone of a room profile.
    */
  var Timezone: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Timezone] = js.native
  /**
    * The wake word of a room profile.
    */
  var WakeWord: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.WakeWord] = js.native
}
