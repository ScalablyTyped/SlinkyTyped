...
trait SendAnnouncementRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ClientRequestToken = js.native
  /**
    * The announcement content. This can contain only one of the three possible announcement types (text, SSML or audio).
    */
  var Content: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Content = js.native
  /**
  ...
  /**
    ...
    */
  var TimeToLiveInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.TimeToLiveInSeconds] = js.native
}
