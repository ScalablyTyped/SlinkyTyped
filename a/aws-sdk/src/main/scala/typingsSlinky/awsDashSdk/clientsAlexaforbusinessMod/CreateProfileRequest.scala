...
trait CreateProfileRequest extends js.Object {
  /**
    ...
    */
  var Address: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Address = js.native
  /**
  ...
  /**
    ...
    */
  var DistanceUnit: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.DistanceUnit = js.native
  /**
  ...
  /**
    ...
    */
  var MaxVolumeLimit: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.MaxVolumeLimit] = js.native
  /**
  ...
  /**
    ...
    */
  var ProfileName: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.ProfileName = js.native
  /**
  ...
  /**
    ...
    */
  var TemperatureUnit: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.TemperatureUnit = js.native
  /**
    * The time zone used by a room profile.
    */
  var Timezone: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Timezone = js.native
  /**
    * A wake word for Alexa, Echo, Amazon, or a computer.
    */
  var WakeWord: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.WakeWord = js.native
}
