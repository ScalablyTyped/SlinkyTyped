...
package object clientsAlexaforbusinessMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.EAP_TLS
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.VOICE
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.WORK
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.`en-US`
