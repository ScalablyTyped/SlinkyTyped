...
trait IPDialIn extends js.Object {
  /**
    ...
    */
  var CommsProtocol: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.CommsProtocol = js.native
  /**
    * The IP address.
    */
  var Endpoint: typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.Endpoint = js.native
}
