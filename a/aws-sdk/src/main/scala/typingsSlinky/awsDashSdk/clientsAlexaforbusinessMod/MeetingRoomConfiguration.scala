...
trait MeetingRoomConfiguration extends js.Object {
  /**
    ...
    */
  var EndOfMeetingReminder: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.EndOfMeetingReminder] = js.native
  /**
    * Settings to automatically book the room if available for a configured duration when joining a meeting with Alexa. 
    */
  var InstantBooking: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.InstantBooking] = js.native
  /**
    * Settings for requiring a check in when a room is reserved. Alexa can cancel a room reservation if it's not checked into. This makes the room available for others. Users can check in by joining the meeting with Alexa or an AVS device, or by saying “Alexa, check in.” 
    */
  var RequireCheckIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAlexaforbusinessMod.RequireCheckIn] = js.native
  /**
