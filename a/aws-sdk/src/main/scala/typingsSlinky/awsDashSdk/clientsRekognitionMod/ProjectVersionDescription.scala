...
trait ProjectVersionDescription extends js.Object {
  ...
  /**
    ...
    */
  var EvaluationResult: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.EvaluationResult] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.OutputConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var TestingDataResult: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.TestingDataResult] = js.native
  /**
    * The manifest file that represents the training results.
    */
  var TrainingDataResult: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.TrainingDataResult] = js.native
  /**
