...
trait NotificationChannel extends js.Object {
  /**
    ...
    */
  var RoleArn: typingsSlinky.awsDashSdk.clientsRekognitionMod.RoleArn = js.native
  /**
    * The Amazon SNS topic to which Amazon Rekognition to posts the completion status.
    */
  var SNSTopicArn: typingsSlinky.awsDashSdk.clientsRekognitionMod.SNSTopicArn = js.native
}
