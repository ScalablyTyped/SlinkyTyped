...
trait OutputConfig extends js.Object {
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.S3Bucket] = js.native
  /**
    * The prefix applied to the training output files. 
    */
  var S3KeyPrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.S3KeyPrefix] = js.native
}
