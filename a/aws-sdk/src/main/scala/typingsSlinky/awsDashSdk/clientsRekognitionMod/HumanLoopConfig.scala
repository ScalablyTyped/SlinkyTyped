...
trait HumanLoopConfig extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsSlinky.awsDashSdk.clientsRekognitionMod.FlowDefinitionArn = js.native
  /**
    * The name of the human review used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsSlinky.awsDashSdk.clientsRekognitionMod.HumanLoopName = js.native
}
