...
trait HumanLoopActivationOutput extends js.Object {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsRekognitionMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.native
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.HumanLoopActivationReasons] = js.native
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.HumanLoopArn] = js.native
}
