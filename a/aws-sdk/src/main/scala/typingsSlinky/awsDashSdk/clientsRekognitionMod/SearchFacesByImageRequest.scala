...
trait SearchFacesByImageRequest extends js.Object {
  ...
  /**
    ...
    */
  var Image: typingsSlinky.awsDashSdk.clientsRekognitionMod.Image = js.native
  /**
    * Maximum number of faces to return. The operation returns the maximum number of faces with the highest confidence in the match.
    */
  var MaxFaces: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.MaxFaces] = js.native
  /**
    ...
    */
  var QualityFilter: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.QualityFilter] = js.native
}
