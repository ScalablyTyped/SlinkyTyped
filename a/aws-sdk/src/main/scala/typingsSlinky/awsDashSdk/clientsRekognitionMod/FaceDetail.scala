...
trait FaceDetail extends js.Object {
  /**
    ...
    */
  var AgeRange: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.AgeRange] = js.native
  /**
    * Indicates whether or not the face has a beard, and the confidence level in the determination.
    */
  var Beard: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Beard] = js.native
  /**
  ...
  /**
    ...
    */
  var Emotions: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Emotions] = js.native
  /**
    * Indicates whether or not the face is wearing eye glasses, and the confidence level in the determination.
    */
  var Eyeglasses: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Eyeglasses] = js.native
  /**
  ...
  /**
    ...
    */
  var Gender: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Gender] = js.native
  /**
    * Indicates the location of landmarks on the face. Default attribute.
    */
  var Landmarks: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Landmarks] = js.native
  /**
    * Indicates whether or not the mouth on the face is open, and the confidence level in the determination.
    */
  var MouthOpen: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.MouthOpen] = js.native
  /**
    * Indicates whether or not the face has a mustache, and the confidence level in the determination.
    */
  var Mustache: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Mustache] = js.native
  /**
    * Indicates the pose of the face as determined by its pitch, roll, and yaw. Default attribute.
    */
  var Pose: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Pose] = js.native
  /**
  ...
  /**
    ...
    */
  var Smile: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Smile] = js.native
  /**
    * Indicates whether or not the face is wearing sunglasses, and the confidence level in the determination.
    */
  var Sunglasses: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Sunglasses] = js.native
}
