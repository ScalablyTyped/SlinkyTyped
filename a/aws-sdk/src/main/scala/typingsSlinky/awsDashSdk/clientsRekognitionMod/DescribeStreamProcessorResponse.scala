...
trait DescribeStreamProcessorResponse extends js.Object {
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.RoleArn] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamProcessorArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.StreamProcessorArn] = js.native
}
