...
trait DetectModerationLabelsResponse extends js.Object {
  /**
    ...
    */
  var HumanLoopActivationOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.HumanLoopActivationOutput] = js.native
  /**
    * Array of detected Moderation labels and the time, in milliseconds from the start of the video, they were detected.
    */
  var ModerationLabels: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.ModerationLabels] = js.native
  /**
