...
trait StartFaceDetectionRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.ClientRequestToken] = js.native
  /**
    ...
    */
  var FaceAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.FaceAttributes] = js.native
  /**
    * An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use JobTag to group related jobs and identify them in the completion notification.
    */
  var JobTag: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.JobTag] = js.native
  /**
    * The ARN of the Amazon SNS topic to which you want Amazon Rekognition Video to publish the completion status of the face detection operation.
    */
  var NotificationChannel: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.NotificationChannel] = js.native
  /**
    * The video in which you want to detect faces. The video must be stored in an Amazon S3 bucket.
    */
  var Video: typingsSlinky.awsDashSdk.clientsRekognitionMod.Video = js.native
}
