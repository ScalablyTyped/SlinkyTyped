...
trait FaceRecord extends js.Object {
  /**
    ...
    */
  var Face: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.Face] = js.native
  /**
    * Structure containing attributes of the face that the algorithm detected.
    */
  var FaceDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsRekognitionMod.FaceDetail] = js.native
}
