...
trait AwsSecurityFinding extends js.Object {
  ...
  /**
    ...
    */
  var Compliance: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.Compliance] = js.native
  /**
  ...
  /**
    ...
    */
  var Network: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.Network] = js.native
  /**
    * A user-defined note added to a finding.
    */
  var Note: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.Note] = js.native
  /**
  ...
  /**
    ...
    */
  var Remediation: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.Remediation] = js.native
  /**
  ...
  /**
    ...
    */
  var Severity: typingsSlinky.awsDashSdk.clientsSecurityhubMod.Severity = js.native
  /**
  ...
  /**
    ...
    */
  var VerificationState: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.VerificationState] = js.native
  /**
    * The workflow state of a finding. 
    */
  var WorkflowState: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.WorkflowState] = js.native
}
