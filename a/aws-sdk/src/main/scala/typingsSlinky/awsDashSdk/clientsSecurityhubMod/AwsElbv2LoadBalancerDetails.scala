...
trait AwsElbv2LoadBalancerDetails extends js.Object {
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.AvailabilityZones] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsSecurityhubMod.SecurityGroups] = js.native
  /**
