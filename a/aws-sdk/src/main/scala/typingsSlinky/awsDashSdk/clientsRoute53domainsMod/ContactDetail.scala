...
trait ContactDetail extends js.Object {
  ...
  /**
    ...
    */
  var City: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.City] = js.native
  /**
    * Indicates whether the contact is a person, company, association, or public organization. If you choose an option other than PERSON, you must enter an organization name, and you can't enable privacy protection for the contact.
    */
  var ContactType: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.ContactType] = js.native
  /**
    * Code for the country of the contact's address.
    */
  var CountryCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.CountryCode] = js.native
  /**
    * Email address of the contact.
    */
  var Email: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.Email] = js.native
  /**
  ...
  /**
    ...
    */
  var State: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.State] = js.native
  /**
    * The zip or postal code of the contact's address.
    */
  var ZipCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.ZipCode] = js.native
}
