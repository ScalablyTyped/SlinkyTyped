...
trait GetDomainDetailResponse extends js.Object {
  ...
  /**
    ...
    */
  var DomainName: typingsSlinky.awsDashSdk.clientsRoute53domainsMod.DomainName = js.native
  /**
  ...
  /**
    ...
    */
  var RegistrarName: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.RegistrarName] = js.native
  /**
    * Web address of the registrar.
    */
  var RegistrarUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.RegistrarUrl] = js.native
  /**
    * Reserved for future use.
    */
  var RegistryDomainId: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.RegistryDomainId] = js.native
  /**
    * Reseller of the domain. Domains registered or transferred using Amazon Route 53 domains will have "Amazon" as the reseller. 
    */
  var Reseller: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.Reseller] = js.native
  /**
