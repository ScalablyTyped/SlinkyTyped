...
trait RenewDomainRequest extends js.Object {
  /**
    ...
    */
  var CurrentExpiryYear: typingsSlinky.awsDashSdk.clientsRoute53domainsMod.CurrentExpiryYear = js.native
  /**
  ...
  /**
    ...
    */
  var DurationInYears: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.DurationInYears] = js.native
}
