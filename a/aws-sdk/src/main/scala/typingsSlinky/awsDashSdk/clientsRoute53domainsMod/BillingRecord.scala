...
trait BillingRecord extends js.Object {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.DomainName] = js.native
  /**
    * The ID of the invoice that is associated with the billing record.
    */
  var InvoiceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.InvoiceId] = js.native
  /**
  ...
  /**
    ...
    */
  var Price: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53domainsMod.Price] = js.native
}
