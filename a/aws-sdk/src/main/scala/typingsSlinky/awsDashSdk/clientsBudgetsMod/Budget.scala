...
trait Budget extends js.Object {
  ...
  /**
    ...
    */
  var BudgetType: typingsSlinky.awsDashSdk.clientsBudgetsMod.BudgetType = js.native
  /**
    * The actual and forecasted cost or usage that the budget tracks.
    */
  var CalculatedSpend: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.CalculatedSpend] = js.native
  /**
  ...
  /**
    ...
    */
  var PlannedBudgetLimits: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.PlannedBudgetLimits] = js.native
  /**
    ...
    */
  var TimePeriod: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.TimePeriod] = js.native
  /**
    ...
    */
  var TimeUnit: typingsSlinky.awsDashSdk.clientsBudgetsMod.TimeUnit = js.native
}
