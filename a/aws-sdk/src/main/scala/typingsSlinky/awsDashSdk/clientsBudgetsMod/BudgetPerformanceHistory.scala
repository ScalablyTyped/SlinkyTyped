...
trait BudgetPerformanceHistory extends js.Object {
  var BudgetName: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.BudgetName] = js.native
  var BudgetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.BudgetType] = js.native
  /**
    * A list of amounts of cost or usage that you created budgets for, compared to your actual costs or usage.
    */
  var BudgetedAndActualAmountsList: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.BudgetedAndActualAmountsList] = js.native
  /**
    * The history of the cost filters for a budget during the specified time period.
    */
  var CostFilters: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.CostFilters] = js.native
  /**
    * The history of the cost types for a budget during the specified time period.
    */
  var CostTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.CostTypes] = js.native
  var TimeUnit: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.TimeUnit] = js.native
}
