...
trait Notification extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typingsSlinky.awsDashSdk.clientsBudgetsMod.ComparisonOperator = js.native
  /**
    ...
    */
  var NotificationState: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.NotificationState] = js.native
  /**
    * Whether the notification is for how much you have spent (ACTUAL) or for how much you're forecasted to spend (FORECASTED).
    */
  var NotificationType: typingsSlinky.awsDashSdk.clientsBudgetsMod.NotificationType = js.native
  /**
  ...
  /**
    ...
    */
  var ThresholdType: js.UndefOr[typingsSlinky.awsDashSdk.clientsBudgetsMod.ThresholdType] = js.native
}
