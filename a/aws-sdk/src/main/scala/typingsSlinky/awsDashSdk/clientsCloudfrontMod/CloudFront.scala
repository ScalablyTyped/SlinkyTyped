...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.distributionDeployed
import typingsSlinky.awsDashSdk.awsDashSdkStrings.invalidationCompleted
import typingsSlinky.awsDashSdk.awsDashSdkStrings.streamingDistributionDeployed
...
import typingsSlinky.awsDashSdk.libServicesCloudfrontMod.CloudFrontCustomizations
...
trait CloudFront extends CloudFrontCustomizations {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_distributionDeployed(state: distributionDeployed, params: GetDistributionRequest with Anon_Waiter): Request[GetDistributionResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_distributionDeployed(
    state: distributionDeployed,
    params: GetDistributionRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetDistributionResult, Unit]
  ): Request[GetDistributionResult, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_invalidationCompleted(state: invalidationCompleted, params: GetInvalidationRequest with Anon_Waiter): Request[GetInvalidationResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_invalidationCompleted(
    state: invalidationCompleted,
    params: GetInvalidationRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetInvalidationResult, Unit]
  ): Request[GetInvalidationResult, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_streamingDistributionDeployed(state: streamingDistributionDeployed, params: GetStreamingDistributionRequest with Anon_Waiter): Request[GetStreamingDistributionResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_streamingDistributionDeployed(
    state: streamingDistributionDeployed,
    params: GetStreamingDistributionRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetStreamingDistributionResult, Unit]
  ): Request[GetStreamingDistributionResult, AWSError] = js.native
}
