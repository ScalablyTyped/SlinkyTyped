...
trait FieldLevelEncryptionSummary extends js.Object {
  ...
  /**
    ...
    */
  var ContentTypeProfileConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.ContentTypeProfileConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryArgProfileConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.QueryArgProfileConfig] = js.native
}
