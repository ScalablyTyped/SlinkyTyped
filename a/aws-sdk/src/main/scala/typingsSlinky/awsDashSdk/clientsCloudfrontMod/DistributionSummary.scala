...
trait DistributionSummary extends js.Object {
  ...
  /**
    ...
    */
  var AliasICPRecordals: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.AliasICPRecordals] = js.native
  /**
    * A complex type that contains information about CNAMEs (alternate domain names), if any, for this distribution.
    */
  var Aliases: typingsSlinky.awsDashSdk.clientsCloudfrontMod.Aliases = js.native
  /**
    * A complex type that contains zero or more CacheBehavior elements.
    */
  var CacheBehaviors: typingsSlinky.awsDashSdk.clientsCloudfrontMod.CacheBehaviors = js.native
  /**
  ...
  /**
    ...
    */
  var CustomErrorResponses: typingsSlinky.awsDashSdk.clientsCloudfrontMod.CustomErrorResponses = js.native
  /**
    * A complex type that describes the default cache behavior if you don't specify a CacheBehavior element or if files don't match any of the values of PathPattern in CacheBehavior elements. You must create exactly one default cache behavior.
    */
  var DefaultCacheBehavior: typingsSlinky.awsDashSdk.clientsCloudfrontMod.DefaultCacheBehavior = js.native
  /**
  ...
  /**
    ...
    */
  var HttpVersion: typingsSlinky.awsDashSdk.clientsCloudfrontMod.HttpVersion = js.native
  /**
  ...
  /**
    ...
    */
  var OriginGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.OriginGroups] = js.native
  /**
    * A complex type that contains information about origins for this distribution.
    */
  var Origins: typingsSlinky.awsDashSdk.clientsCloudfrontMod.Origins = js.native
  /**
    * A complex type that contains information about price class for this streaming distribution. 
    */
  var PriceClass: typingsSlinky.awsDashSdk.clientsCloudfrontMod.PriceClass = js.native
  /**
    * A complex type that identifies ways in which you want to restrict distribution of your content.
    */
  var Restrictions: typingsSlinky.awsDashSdk.clientsCloudfrontMod.Restrictions = js.native
  /**
  ...
  /**
    ...
    */
  var ViewerCertificate: typingsSlinky.awsDashSdk.clientsCloudfrontMod.ViewerCertificate = js.native
  /**
