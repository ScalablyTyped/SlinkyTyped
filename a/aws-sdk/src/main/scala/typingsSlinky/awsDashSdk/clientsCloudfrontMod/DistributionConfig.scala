...
trait DistributionConfig extends js.Object {
  /**
    ...
    */
  var Aliases: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.Aliases] = js.native
  /**
    * A complex type that contains zero or more CacheBehavior elements. 
    */
  var CacheBehaviors: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.CacheBehaviors] = js.native
  /**
  ...
  /**
    ...
    */
  var CustomErrorResponses: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.CustomErrorResponses] = js.native
  /**
  ...
  /**
    ...
    */
  var HttpVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.HttpVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var PriceClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.PriceClass] = js.native
  /**
    * A complex type that identifies ways in which you want to restrict distribution of your content.
    */
  var Restrictions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.Restrictions] = js.native
  /**
    ...
    */
  var ViewerCertificate: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.ViewerCertificate] = js.native
  /**
