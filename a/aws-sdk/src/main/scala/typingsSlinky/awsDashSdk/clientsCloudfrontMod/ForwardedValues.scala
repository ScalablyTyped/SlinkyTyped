...
trait ForwardedValues extends js.Object {
  ...
  /**
    ...
    */
  var Headers: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.Headers] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryStringCacheKeys: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.QueryStringCacheKeys] = js.native
}
