...
trait CustomOriginConfig extends js.Object {
  ...
  /**
    ...
    */
  var OriginProtocolPolicy: typingsSlinky.awsDashSdk.clientsCloudfrontMod.OriginProtocolPolicy = js.native
  /**
  ...
  /**
    ...
    */
  var OriginSslProtocols: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.OriginSslProtocols] = js.native
}
