...
trait CacheBehavior extends js.Object {
  var AllowedMethods: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.AllowedMethods] = js.native
  /**
  ...
  /**
    ...
    */
  var ForwardedValues: typingsSlinky.awsDashSdk.clientsCloudfrontMod.ForwardedValues = js.native
  /**
    * A complex type that contains zero or more Lambda function associations for a cache behavior.
    */
  var LambdaFunctionAssociations: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.LambdaFunctionAssociations] = js.native
  /**
  ...
  /**
    ...
    */
  var ViewerProtocolPolicy: typingsSlinky.awsDashSdk.clientsCloudfrontMod.ViewerProtocolPolicy = js.native
}
