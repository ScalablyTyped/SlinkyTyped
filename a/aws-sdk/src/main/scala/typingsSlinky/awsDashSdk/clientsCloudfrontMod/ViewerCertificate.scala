...
trait ViewerCertificate extends js.Object {
  ...
  /**
    * This field is no longer used. Use one of the following fields instead:    ACMCertificateArn     IAMCertificateId     CloudFrontDefaultCertificate   
    */
  var CertificateSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.CertificateSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MinimumProtocolVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.MinimumProtocolVersion] = js.native
  /**
    ...
    */
  var SSLSupportMethod: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.SSLSupportMethod] = js.native
}
