...
trait LambdaFunctionAssociation extends js.Object {
  /**
    ...
    */
  var EventType: typingsSlinky.awsDashSdk.clientsCloudfrontMod.EventType = js.native
  /**
  ...
  /**
    ...
    */
  var LambdaFunctionARN: typingsSlinky.awsDashSdk.clientsCloudfrontMod.LambdaFunctionARN = js.native
}
