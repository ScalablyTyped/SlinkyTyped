...
trait Origin extends js.Object {
  /**
    ...
    */
  var CustomHeaders: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.CustomHeaders] = js.native
  /**
    * A complex type that contains information about a custom origin. If the origin is an Amazon S3 bucket, use the S3OriginConfig element instead.
    */
  var CustomOriginConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.CustomOriginConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var S3OriginConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudfrontMod.S3OriginConfig] = js.native
}
