...
trait ScalingInstruction extends js.Object {
  /**
    ...
    */
  var CustomizedLoadMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.CustomizedLoadMetricSpecification
  ] = js.native
  /**
    ...
    */
  var DisableDynamicScaling: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.DisableDynamicScaling] = js.native
  /**
  ...
  /**
    ...
    */
  var PredefinedLoadMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.PredefinedLoadMetricSpecification
  ] = js.native
  /**
  ...
  var PredictiveScalingMaxCapacityBehavior: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.PredictiveScalingMaxCapacityBehavior
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var PredictiveScalingMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.PredictiveScalingMode] = js.native
  /**
  ...
  /**
    ...
    */
  var ScalableDimension: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalableDimension = js.native
  /**
    ...
    */
  var ScalingPolicyUpdateBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingPolicyUpdateBehavior] = js.native
  /**
    ...
    */
  var ScheduledActionBufferTime: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScheduledActionBufferTime] = js.native
  /**
    * The namespace of the AWS service.
    */
  var ServiceNamespace: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ServiceNamespace = js.native
  /**
    ...
    */
  var TargetTrackingConfigurations: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.TargetTrackingConfigurations = js.native
}
