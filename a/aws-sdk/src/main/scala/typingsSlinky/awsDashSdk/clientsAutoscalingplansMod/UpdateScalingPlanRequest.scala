...
trait UpdateScalingPlanRequest extends js.Object {
  /**
    ...
    */
  var ApplicationSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ApplicationSource] = js.native
  /**
    * The scaling instructions.
    */
  var ScalingInstructions: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingInstructions] = js.native
  /**
