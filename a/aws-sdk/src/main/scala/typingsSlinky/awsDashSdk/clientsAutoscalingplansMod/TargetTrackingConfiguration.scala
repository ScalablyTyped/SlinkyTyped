...
trait TargetTrackingConfiguration extends js.Object {
  ...
  var CustomizedScalingMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.CustomizedScalingMetricSpecification
  ] = js.native
  /**
    ...
    */
  var DisableScaleIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.DisableScaleIn] = js.native
  /**
  ...
  var PredefinedScalingMetricSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.PredefinedScalingMetricSpecification
  ] = js.native
  /**
