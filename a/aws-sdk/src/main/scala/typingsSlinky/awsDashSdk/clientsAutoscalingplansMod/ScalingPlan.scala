package typingsSlinky.awsDashSdk.clientsAutoscalingplansMod
...
trait ScalingPlan extends js.Object {
  /**
    ...
    */
  var ApplicationSource: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ApplicationSource = js.native
  /**
  ...
  /**
    ...
    */
  var ScalingInstructions: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingInstructions = js.native
  /**
    * The name of the scaling plan.
    */
  var ScalingPlanName: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingPlanName = js.native
  /**
    * The version number of the scaling plan.
    */
  var ScalingPlanVersion: typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingPlanVersion = js.native
  /**
