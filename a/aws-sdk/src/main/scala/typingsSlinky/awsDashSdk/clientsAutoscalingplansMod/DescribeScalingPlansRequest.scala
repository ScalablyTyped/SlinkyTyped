...
trait DescribeScalingPlansRequest extends js.Object {
  /**
    ...
    */
  var ApplicationSources: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ApplicationSources] = js.native
  /**
  ...
  /**
    ...
    */
  var ScalingPlanNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingPlanNames] = js.native
  /**
    * The version number of the scaling plan. If you specify a scaling plan version, you must also specify a scaling plan name.
    */
  var ScalingPlanVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingplansMod.ScalingPlanVersion] = js.native
}
