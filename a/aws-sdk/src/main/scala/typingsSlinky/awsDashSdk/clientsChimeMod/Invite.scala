...
trait Invite extends js.Object {
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsChimeMod.EmailAddress] = js.native
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsChimeMod.EmailStatus] = js.native
  /**
    * The invite ID.
    */
