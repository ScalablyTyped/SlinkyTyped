...
trait PhoneNumber extends js.Object {
  ...
  /**
    ...
    */
  var CallingName: js.UndefOr[typingsSlinky.awsDashSdk.clientsChimeMod.CallingName] = js.native
  /**
    * The outbound calling name status.
    */
  var CallingNameStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsChimeMod.CallingNameStatus] = js.native
  /**
