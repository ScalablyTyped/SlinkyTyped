...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.anyInstanceInService
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceDeregistered
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceInService
...
trait ELB extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_anyInstanceInService(state: anyInstanceInService, params: DescribeEndPointStateInput with Anon_Waiter): Request[DescribeEndPointStateOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_anyInstanceInService(
    state: anyInstanceInService,
    params: DescribeEndPointStateInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeEndPointStateOutput, Unit]
  ): Request[DescribeEndPointStateOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceDeregistered(state: instanceDeregistered, params: DescribeEndPointStateInput with Anon_Waiter): Request[DescribeEndPointStateOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceDeregistered(
    state: instanceDeregistered,
    params: DescribeEndPointStateInput with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceInService(state: instanceInService, params: DescribeEndPointStateInput with Anon_Waiter): Request[DescribeEndPointStateOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceInService(
    state: instanceInService,
    params: DescribeEndPointStateInput with Anon_Waiter,
