...
trait DescribeAccessPointsInput extends js.Object {
  /**
    ...
    */
  var LoadBalancerNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.LoadBalancerNames] = js.native
  /**
    * The marker for the next set of results. (You received this marker from a previous call.)
    */
  var Marker: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.Marker] = js.native
  /**
    * The maximum number of results to return with this call (a number from 1 to 400). The default is 400.
    */
  var PageSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PageSize] = js.native
}
