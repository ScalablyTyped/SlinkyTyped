...
trait PolicyTypeDescription extends js.Object {
  ...
  /**
    ...
    */
  var PolicyAttributeTypeDescriptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PolicyAttributeTypeDescriptions] = js.native
  /**
    * The name of the policy type.
    */
  var PolicyTypeName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PolicyTypeName] = js.native
}
