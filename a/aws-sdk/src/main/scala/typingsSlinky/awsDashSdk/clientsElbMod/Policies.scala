...
trait Policies extends js.Object {
  /**
    ...
    */
  var AppCookieStickinessPolicies: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.AppCookieStickinessPolicies] = js.native
  /**
    * The stickiness policies created using CreateLBCookieStickinessPolicy.
    */
  var LBCookieStickinessPolicies: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.LBCookieStickinessPolicies] = js.native
  /**
