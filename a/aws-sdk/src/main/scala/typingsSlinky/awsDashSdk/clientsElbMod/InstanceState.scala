package typingsSlinky.awsDashSdk.clientsElbMod
...
trait InstanceState extends js.Object {
  /**
    ...
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.Description] = js.native
  /**
    * The ID of the instance.
    */
  var InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.InstanceId] = js.native
  /**
    ...
    */
  var ReasonCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.ReasonCode] = js.native
  /**
    * The current state of the instance. Valid values: InService | OutOfService | Unknown 
    */
  var State: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.State] = js.native
}
