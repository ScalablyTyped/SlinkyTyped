...
trait AppCookieStickinessPolicy extends js.Object {
  /**
    ...
    */
  var CookieName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.CookieName] = js.native
  /**
    * The mnemonic name for the policy being created. The name must be unique within a set of policies for this load balancer.
    */
  var PolicyName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PolicyName] = js.native
}
