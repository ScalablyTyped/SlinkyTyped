...
trait CreateLoadBalancerPolicyInput extends js.Object {
  ...
  /**
    ...
    */
  var PolicyAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PolicyAttributes] = js.native
  /**
    * The name of the load balancer policy to be created. This name must be unique within the set of policies for this load balancer.
    */
  var PolicyName: typingsSlinky.awsDashSdk.clientsElbMod.PolicyName = js.native
  /**
    * The name of the base policy type. To get the list of policy types, use DescribeLoadBalancerPolicyTypes.
    */
  var PolicyTypeName: typingsSlinky.awsDashSdk.clientsElbMod.PolicyTypeName = js.native
}
