...
trait PolicyAttributeDescription extends js.Object {
  /**
    ...
    */
  var AttributeName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.AttributeName] = js.native
  /**
    * The value of the attribute.
    */
  var AttributeValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.AttributeValue] = js.native
}
