...
trait Listener extends js.Object {
  /**
    ...
    */
  var InstancePort: typingsSlinky.awsDashSdk.clientsElbMod.InstancePort = js.native
  /**
  ...
  /**
    ...
    */
  var Protocol: typingsSlinky.awsDashSdk.clientsElbMod.Protocol = js.native
  /**
    * The Amazon Resource Name (ARN) of the server certificate.
    */
  var SSLCertificateId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.SSLCertificateId] = js.native
}
