...
trait ListenerDescription extends js.Object {
  /**
    * The listener.
    */
  var Listener: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.Listener] = js.native
  /**
    * The policies. If there are no policies enabled, the list is empty.
    */
  var PolicyNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbMod.PolicyNames] = js.native
}
