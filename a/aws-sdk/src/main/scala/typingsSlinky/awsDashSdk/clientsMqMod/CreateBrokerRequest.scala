package typingsSlinky.awsDashSdk.clientsMqMod
...
trait CreateBrokerRequest extends js.Object {
  ...
  /**
    ...
    */
  var DeploymentMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsMqMod.DeploymentMode] = js.native
  /**
    * Encryption options for the broker.
    */
  var EncryptionOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsMqMod.EncryptionOptions] = js.native
  /**
    * Required. The type of broker engine. Note: Currently, Amazon MQ supports only ACTIVEMQ.
    */
  var EngineType: js.UndefOr[typingsSlinky.awsDashSdk.clientsMqMod.EngineType] = js.native
  /**
  ...
  /**
    ...
    */
  var Logs: js.UndefOr[typingsSlinky.awsDashSdk.clientsMqMod.Logs] = js.native
  /**
