...
trait RouteSettings extends js.Object {
  /**
    ...
    */
  var DataTraceEnabled: js.UndefOr[__boolean] = js.native
  /**
    * Specifies whether detailed metrics are enabled.
    */
  var DetailedMetricsEnabled: js.UndefOr[__boolean] = js.native
  /**
    * Specifies the logging level for this route: INFO, ERROR, or OFF. This property affects the log entries pushed to Amazon CloudWatch Logs. Supported only for WebSocket APIs.
    */
  var LoggingLevel: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.LoggingLevel] = js.native
  /**
    * Specifies the throttling burst limit. Supported only for WebSocket APIs.
    */
  var ThrottlingBurstLimit: js.UndefOr[__integer] = js.native
  /**
    * Specifies the throttling rate limit. Supported only for WebSocket APIs.
    */
  var ThrottlingRateLimit: js.UndefOr[__double] = js.native
}
