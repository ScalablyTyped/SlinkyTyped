...
trait DomainNameConfiguration extends js.Object {
  /**
    ...
    */
  var ApiGatewayDomainName: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var DomainNameStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.DomainNameStatus] = js.native
  /**
    * An optional text message containing detailed information about status of the domain name migration.
    */
  var DomainNameStatusMessage: js.UndefOr[__string] = js.native
  /**
    * The endpoint type.
    */
  var EndpointType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.EndpointType] = js.native
  /**
    * The Amazon Route 53 Hosted Zone ID of the endpoint.
    */
  var HostedZoneId: js.UndefOr[__string] = js.native
  /**
    * The Transport Layer Security (TLS) version of the security policy for this domain name. The valid values are TLS_1_0 and TLS_1_2.
    */
  var SecurityPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.SecurityPolicy] = js.native
}
