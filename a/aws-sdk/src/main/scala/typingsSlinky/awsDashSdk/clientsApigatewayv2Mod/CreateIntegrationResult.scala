...
trait CreateIntegrationResult extends js.Object {
  ...
  /**
    ...
    */
  var ConnectionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.ConnectionType] = js.native
  /**
    ...
    */
  var ContentHandlingStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.ContentHandlingStrategy] = js.native
  /**
  ...
  /**
    ...
    */
  var IntegrationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.IntegrationType] = js.native
  /**
  ...
  /**
    ...
    */
  var PassthroughBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.PassthroughBehavior] = js.native
  /**
