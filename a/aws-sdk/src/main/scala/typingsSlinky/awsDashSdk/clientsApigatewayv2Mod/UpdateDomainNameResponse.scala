...
trait UpdateDomainNameResponse extends js.Object {
  ...
  /**
    ...
    */
  var DomainNameConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.DomainNameConfigurations] = js.native
  /**
    * The collection of tags associated with a domain name.
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsApigatewayv2Mod.Tags] = js.native
}
