...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.NetworkConfiguration] = js.native
  /**
