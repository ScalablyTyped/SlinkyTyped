...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.Principal = js.native
  /**
