package typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod
...
trait Target extends js.Object {
  ...
  /**
    ...
    */
  var BatchParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.BatchParameters] = js.native
  /**
    * Contains the Amazon ECS task definition and task count to be used if the event target is an Amazon ECS task. For more information about Amazon ECS tasks, see Task Definitions  in the Amazon EC2 Container Service Developer Guide.
    */
  var EcsParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.EcsParameters] = js.native
  /**
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.InputTransformer] = js.native
  /**
    ...
    */
  var KinesisParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.KinesisParameters] = js.native
  /**
    * The Amazon Resource Name (ARN) of the IAM role to be used for this target when the rule is triggered. If one rule triggers multiple targets, you can use a different IAM role for each target.
    */
  var RoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.RoleArn] = js.native
  /**
    * Parameters used when you are using the rule to invoke Amazon EC2 Run Command.
    */
  var RunCommandParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.RunCommandParameters] = js.native
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.SqsParameters] = js.native
}
