...
trait DescribeRuleResponse extends js.Object {
  ...
  /**
    ...
    */
  var EventBusName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.EventBusName] = js.native
  /**
    * The event pattern. For more information, see Event Patterns in the Amazon EventBridge User Guide.
    */
  var EventPattern: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.EventPattern] = js.native
  /**
    * If this is a managed rule, created by an AWS service on your behalf, this field displays the principal name of the AWS service that created the rule.
    */
  var ManagedBy: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.ManagedBy] = js.native
  /**
  ...
  /**
    ...
    */
  var ScheduleExpression: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.ScheduleExpression] = js.native
  /**
