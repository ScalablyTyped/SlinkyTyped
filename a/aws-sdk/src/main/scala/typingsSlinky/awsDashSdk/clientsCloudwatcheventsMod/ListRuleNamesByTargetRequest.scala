...
trait ListRuleNamesByTargetRequest extends js.Object {
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.NextToken] = js.native
  /**
    * The Amazon Resource Name (ARN) of the target resource.
    */
  var TargetArn: typingsSlinky.awsDashSdk.clientsCloudwatcheventsMod.TargetArn = js.native
}
