...
trait OptionGroupOption extends js.Object {
  ...
  /**
    ...
    */
  var OptionsConflictsWith: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.OptionsConflictsWith] = js.native
  /**
    * The options that are prerequisites for this option.
    */
  var OptionsDependedOn: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.OptionsDependedOn] = js.native
  /**
