...
trait DBCluster extends js.Object {
  ...
  /**
    ...
    */
  var ActivityStreamMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.ActivityStreamMode] = js.native
  /**
    * The status of the database activity stream.
    */
  var ActivityStreamStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.ActivityStreamStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var DBClusterOptionGroupMemberships: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.DBClusterOptionGroupMemberships] = js.native
  /**
  ...
  var ScalingConfigurationInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.ScalingConfigurationInfo] = js.native
  /**
