...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBClusterSnapshotAvailable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBClusterSnapshotDeleted
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBInstanceAvailable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBInstanceDeleted
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBSnapshotAvailable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.dBSnapshotDeleted
...
trait RDS extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBInstanceAvailable(state: dBInstanceAvailable, params: DescribeDBInstancesMessage with Anon_Waiter): Request[DBInstanceMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBInstanceAvailable(
    state: dBInstanceAvailable,
    params: DescribeDBInstancesMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DBInstanceMessage, Unit]
  ): Request[DBInstanceMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBInstanceDeleted(state: dBInstanceDeleted, params: DescribeDBInstancesMessage with Anon_Waiter): Request[DBInstanceMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBInstanceDeleted(
    state: dBInstanceDeleted,
    params: DescribeDBInstancesMessage with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBSnapshotAvailable(state: dBSnapshotAvailable, params: DescribeDBSnapshotsMessage with Anon_Waiter): Request[DBSnapshotMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBSnapshotAvailable(
    state: dBSnapshotAvailable,
    params: DescribeDBSnapshotsMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DBSnapshotMessage, Unit]
  ): Request[DBSnapshotMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBSnapshotDeleted(state: dBSnapshotDeleted, params: DescribeDBSnapshotsMessage with Anon_Waiter): Request[DBSnapshotMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBSnapshotDeleted(
    state: dBSnapshotDeleted,
    params: DescribeDBSnapshotsMessage with Anon_Waiter,
