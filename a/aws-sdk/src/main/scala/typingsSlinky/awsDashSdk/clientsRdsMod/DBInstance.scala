...
trait DBInstance extends js.Object {
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.Endpoint] = js.native
  /**
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typingsSlinky.awsDashSdk.clientsRdsMod.PendingModifiedValues] = js.native
  /**
