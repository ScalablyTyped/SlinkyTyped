...
trait Finding extends js.Object {
  ...
  var Resource: typingsSlinky.awsDashSdk.clientsGuarddutyMod.Resource = js.native
  /**
    * The version of the schema used for the finding.
    */
  var SchemaVersion: String = js.native
  var Service: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Service] = js.native
  /**
