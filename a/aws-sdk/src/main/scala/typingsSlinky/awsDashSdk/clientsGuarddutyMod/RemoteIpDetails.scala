...
trait RemoteIpDetails extends js.Object {
  /**
    ...
    */
  var City: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.City] = js.native
  /**
    * Country code of the remote IP address.
    */
  var Country: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Country] = js.native
  /**
    * Location information of the remote IP address.
    */
  var GeoLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.GeoLocation] = js.native
  /**
  ...
  /**
    ...
    */
  var Organization: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Organization] = js.native
}
