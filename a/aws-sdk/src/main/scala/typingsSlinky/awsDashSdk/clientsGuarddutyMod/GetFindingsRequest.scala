...
trait GetFindingsRequest extends js.Object {
  ...
  /**
    ...
    */
  var FindingIds: typingsSlinky.awsDashSdk.clientsGuarddutyMod.FindingIds = js.native
  /**
    * Represents the criteria used for sorting findings.
    */
  var SortCriteria: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.SortCriteria] = js.native
}
