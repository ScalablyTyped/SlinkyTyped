...
trait NetworkConnectionAction extends js.Object {
  ...
  /**
    ...
    */
  var LocalPortDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.LocalPortDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var RemoteIpDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.RemoteIpDetails] = js.native
  /**
    * Remote port information of the connection.
    */
  var RemotePortDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.RemotePortDetails] = js.native
}
