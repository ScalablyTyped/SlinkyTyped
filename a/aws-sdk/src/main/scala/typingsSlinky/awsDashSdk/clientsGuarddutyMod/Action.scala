...
trait Action extends js.Object {
  ...
  /**
    ...
    */
  var AwsApiCallAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.AwsApiCallAction] = js.native
  /**
    * Information about the DNS_REQUEST action described in this finding.
    */
  var DnsRequestAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.DnsRequestAction] = js.native
  /**
    * Information about the NETWORK_CONNECTION action described in this finding.
    */
  var NetworkConnectionAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.NetworkConnectionAction] = js.native
  /**
    * Information about the PORT_PROBE action described in this finding.
    */
  var PortProbeAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.PortProbeAction] = js.native
}
