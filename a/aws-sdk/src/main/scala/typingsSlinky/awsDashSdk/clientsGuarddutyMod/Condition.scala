...
trait Condition extends js.Object {
  /**
    ...
    */
  var Eq: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Eq] = js.native
  /**
    * Represents an equal condition to be applied to a single field when querying for findings.
    */
  var Equals: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Equals] = js.native
  /**
  ...
  /**
    ...
    */
  var Neq: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Neq] = js.native
  /**
    * Represents an not equal condition to be applied to a single field when querying for findings.
    */
  var NotEquals: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.NotEquals] = js.native
}
