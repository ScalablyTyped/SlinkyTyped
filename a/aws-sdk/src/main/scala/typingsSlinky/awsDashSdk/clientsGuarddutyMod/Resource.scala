...
trait Resource extends js.Object {
  /**
    ...
    */
  var AccessKeyDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.AccessKeyDetails] = js.native
  /**
    * The information about the EC2 instance associated with the activity that prompted GuardDuty to generate a finding.
    */
  var InstanceDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.InstanceDetails] = js.native
  /**
