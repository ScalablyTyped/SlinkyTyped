...
trait UpdateThreatIntelSetRequest extends js.Object {
  ...
  /**
    ...
    */
  var Location: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Location] = js.native
  /**
    * The unique ID that specifies the ThreatIntelSet that you want to update.
    */
  var Name: js.UndefOr[typingsSlinky.awsDashSdk.clientsGuarddutyMod.Name] = js.native
  /**
    * The unique ID that specifies the ThreatIntelSet that you want to update.
    */
