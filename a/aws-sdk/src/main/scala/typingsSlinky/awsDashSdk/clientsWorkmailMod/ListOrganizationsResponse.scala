...
trait ListOrganizationsResponse extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.NextToken] = js.native
  /**
    * The overview of owned organizations presented as a list of organization summaries.
    */
  var OrganizationSummaries: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.OrganizationSummaries] = js.native
}
