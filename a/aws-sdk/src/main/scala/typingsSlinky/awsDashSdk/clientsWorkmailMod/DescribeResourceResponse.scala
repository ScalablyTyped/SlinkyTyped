...
trait DescribeResourceResponse extends js.Object {
  /**
    ...
    */
  var BookingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.BookingOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.ResourceId] = js.native
  /**
