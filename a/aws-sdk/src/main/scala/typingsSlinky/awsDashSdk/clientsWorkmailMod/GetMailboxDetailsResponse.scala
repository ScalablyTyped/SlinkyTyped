...
trait GetMailboxDetailsResponse extends js.Object {
  /**
    ...
    */
  var MailboxQuota: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.MailboxQuota] = js.native
  /**
    * The current mailbox size, in MB, for the specified user.
    */
  var MailboxSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorkmailMod.MailboxSize] = js.native
}
