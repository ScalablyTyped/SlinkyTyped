...
package object clientsCodebuildMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.OAUTH
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.SECRETS_MANAGER
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.TEST
