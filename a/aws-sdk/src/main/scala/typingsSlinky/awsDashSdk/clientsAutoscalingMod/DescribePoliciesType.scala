...
trait DescribePoliciesType extends js.Object {
  ...
  /**
    ...
    */
  var MaxRecords: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MaxRecords] = js.native
  /**
  ...
  /**
    ...
    */
  var PolicyNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.PolicyNames] = js.native
  /**
    * One or more policy types. The valid values are SimpleScaling, StepScaling, and TargetTrackingScaling.
    */
  var PolicyTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.PolicyTypes] = js.native
}
