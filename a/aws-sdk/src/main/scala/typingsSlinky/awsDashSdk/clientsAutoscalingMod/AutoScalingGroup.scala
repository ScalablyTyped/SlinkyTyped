package typingsSlinky.awsDashSdk.clientsAutoscalingMod
...
trait AutoScalingGroup extends js.Object {
  ...
  /**
    ...
    */
  var AvailabilityZones: typingsSlinky.awsDashSdk.clientsAutoscalingMod.AvailabilityZones = js.native
  /**
  ...
  /**
    ...
    */
  var EnabledMetrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.EnabledMetrics] = js.native
  /**
    * The amount of time, in seconds, that Amazon EC2 Auto Scaling waits before checking the health status of an EC2 instance that has come into service.
    */
  var HealthCheckGracePeriod: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.HealthCheckGracePeriod] = js.native
  /**
  ...
  /**
    ...
    */
  var Instances: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.Instances] = js.native
  /**
  ...
  /**
    ...
    */
  var LoadBalancerNames: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.LoadBalancerNames] = js.native
  /**
    * The maximum amount of time, in seconds, that an instance can be in service. Valid Range: Minimum value of 604800.
    */
  var MaxInstanceLifetime: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MaxInstanceLifetime] = js.native
  /**
  ...
  /**
    ...
    */
  var MixedInstancesPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MixedInstancesPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var SuspendedProcesses: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.SuspendedProcesses] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetGroupARNs: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.TargetGroupARNs] = js.native
  /**
    * The termination policies for the group.
    */
  var TerminationPolicies: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.TerminationPolicies] = js.native
  /**
