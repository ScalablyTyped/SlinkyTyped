...
trait CompleteLifecycleActionType extends js.Object {
  ...
  /**
    ...
    */
  var LifecycleActionResult: typingsSlinky.awsDashSdk.clientsAutoscalingMod.LifecycleActionResult = js.native
  /**
    * A universally unique identifier (UUID) that identifies a specific lifecycle action associated with an instance. Amazon EC2 Auto Scaling sends this token to the notification target you specified when you created the lifecycle hook.
    */
  var LifecycleActionToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.LifecycleActionToken] = js.native
  /**
