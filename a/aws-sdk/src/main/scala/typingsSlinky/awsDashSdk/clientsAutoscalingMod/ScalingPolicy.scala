...
trait ScalingPolicy extends js.Object {
  ...
  /**
    ...
    */
  var Cooldown: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.Cooldown] = js.native
  /**
    * The estimated time, in seconds, until a newly launched instance can contribute to the CloudWatch metrics.
    */
  var EstimatedInstanceWarmup: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.EstimatedInstanceWarmup] = js.native
  /**
  ...
  /**
    ...
    */
  var MinAdjustmentMagnitude: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MinAdjustmentMagnitude] = js.native
  /**
    * Available for backward compatibility. Use MinAdjustmentMagnitude instead.
    */
  var MinAdjustmentStep: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MinAdjustmentStep] = js.native
  /**
  ...
  /**
    ...
    */
  var StepAdjustments: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.StepAdjustments] = js.native
  /**
    * A target tracking scaling policy.
    */
  var TargetTrackingConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.TargetTrackingConfiguration] = js.native
}
