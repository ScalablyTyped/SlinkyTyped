...
trait DescribeAccountLimitsAnswer extends js.Object {
  /**
    ...
    */
  var MaxNumberOfAutoScalingGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MaxNumberOfAutoScalingGroups] = js.native
  /**
    * The maximum number of launch configurations allowed for your AWS account. The default limit is 200 per AWS Region.
    */
  var MaxNumberOfLaunchConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.MaxNumberOfLaunchConfigurations] = js.native
  /**
    * The current number of groups for your AWS account.
    */
  var NumberOfAutoScalingGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.NumberOfAutoScalingGroups] = js.native
  /**
    * The current number of launch configurations for your AWS account.
    */
  var NumberOfLaunchConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.NumberOfLaunchConfigurations] = js.native
}
