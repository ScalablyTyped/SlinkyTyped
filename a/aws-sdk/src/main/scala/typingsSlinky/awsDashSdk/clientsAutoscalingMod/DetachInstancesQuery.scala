...
trait DetachInstancesQuery extends js.Object {
  ...
  /**
    ...
    */
  var InstanceIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.InstanceIds] = js.native
  /**
    * Indicates whether the Auto Scaling group decrements the desired capacity value by the number of instances detached.
    */
  var ShouldDecrementDesiredCapacity: typingsSlinky.awsDashSdk.clientsAutoscalingMod.ShouldDecrementDesiredCapacity = js.native
}
