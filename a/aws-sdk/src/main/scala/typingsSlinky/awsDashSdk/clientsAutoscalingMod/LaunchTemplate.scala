...
trait LaunchTemplate extends js.Object {
  /**
    ...
    */
  var LaunchTemplateSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.LaunchTemplateSpecification] = js.native
  /**
    ...
    */
  var Overrides: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.Overrides] = js.native
}
