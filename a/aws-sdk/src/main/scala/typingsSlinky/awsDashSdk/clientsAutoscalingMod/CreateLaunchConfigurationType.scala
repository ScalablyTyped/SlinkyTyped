...
trait CreateLaunchConfigurationType extends js.Object {
  /**
    ...
    */
  var AssociatePublicIpAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.AssociatePublicIpAddress] = js.native
  /**
    ...
    */
  var BlockDeviceMappings: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.BlockDeviceMappings] = js.native
  /**
  ...
  /**
    ...
    */
  var ClassicLinkVPCSecurityGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.ClassicLinkVPCSecurityGroups] = js.native
  /**
    ...
    */
  var EbsOptimized: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.EbsOptimized] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceMonitoring: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.InstanceMonitoring] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.SecurityGroups] = js.native
  /**
    ...
    */
  var SpotPrice: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.SpotPrice] = js.native
  /**
