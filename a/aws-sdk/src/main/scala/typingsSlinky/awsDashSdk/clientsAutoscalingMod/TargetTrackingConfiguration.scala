...
trait TargetTrackingConfiguration extends js.Object {
  /**
    ...
    */
  var CustomizedMetricSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.CustomizedMetricSpecification] = js.native
  /**
    * Indicates whether scaling in by the target tracking scaling policy is disabled. If scaling in is disabled, the target tracking scaling policy doesn't remove instances from the Auto Scaling group. Otherwise, the target tracking scaling policy can remove instances from the Auto Scaling group. The default is false.
    */
  var DisableScaleIn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.DisableScaleIn] = js.native
  /**
    * A predefined metric. You must specify either a predefined metric or a customized metric.
    */
  var PredefinedMetricSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.PredefinedMetricSpecification] = js.native
  /**
