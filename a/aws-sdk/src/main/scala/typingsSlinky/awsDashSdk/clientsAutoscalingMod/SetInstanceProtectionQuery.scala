...
trait SetInstanceProtectionQuery extends js.Object {
  ...
  /**
    ...
    */
  var InstanceIds: typingsSlinky.awsDashSdk.clientsAutoscalingMod.InstanceIds = js.native
  /**
    * Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.
    */
  var ProtectedFromScaleIn: typingsSlinky.awsDashSdk.clientsAutoscalingMod.ProtectedFromScaleIn = js.native
}
