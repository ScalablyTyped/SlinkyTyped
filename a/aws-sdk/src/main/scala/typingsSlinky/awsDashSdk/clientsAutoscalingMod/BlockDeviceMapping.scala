...
trait BlockDeviceMapping extends js.Object {
  ...
  /**
    ...
    */
  var Ebs: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.Ebs] = js.native
  /**
    ...
    */
  var NoDevice: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.NoDevice] = js.native
  /**
