...
trait InstancesDistribution extends js.Object {
  ...
  /**
    ...
    */
  var OnDemandBaseCapacity: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.OnDemandBaseCapacity] = js.native
  /**
    ...
    */
  var OnDemandPercentageAboveBaseCapacity: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsAutoscalingMod.OnDemandPercentageAboveBaseCapacity
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var SpotInstancePools: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.SpotInstancePools] = js.native
  /**
