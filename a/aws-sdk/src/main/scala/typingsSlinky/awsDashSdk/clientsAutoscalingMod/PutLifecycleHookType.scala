...
trait PutLifecycleHookType extends js.Object {
  ...
  /**
    ...
    */
  var HeartbeatTimeout: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.HeartbeatTimeout] = js.native
  /**
  ...
  /**
    ...
    */
  var LifecycleTransition: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.LifecycleTransition] = js.native
  /**
