...
trait MixedInstancesPolicy extends js.Object {
  /**
    ...
    */
  var InstancesDistribution: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.InstancesDistribution] = js.native
  /**
    * The launch template and instance types (overrides). This parameter must be specified when creating a mixed instances policy.
    */
  var LaunchTemplate: js.UndefOr[typingsSlinky.awsDashSdk.clientsAutoscalingMod.LaunchTemplate] = js.native
}
