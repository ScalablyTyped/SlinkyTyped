...
trait CreateApplicationVersionMessage extends js.Object {
  ...
  /**
    ...
    */
  var AutoCreateApplication: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.AutoCreateApplication] = js.native
  /**
    * Settings for an AWS CodeBuild build.
    */
  var BuildConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.BuildConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var SourceBuildInformation: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SourceBuildInformation] = js.native
  /**
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Tags] = js.native
  /**
    ...
    */
  var VersionLabel: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.VersionLabel = js.native
}
