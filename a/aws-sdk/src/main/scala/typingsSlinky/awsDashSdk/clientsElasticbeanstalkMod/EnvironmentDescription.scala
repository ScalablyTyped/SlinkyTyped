...
trait EnvironmentDescription extends js.Object {
  /**
    ...
    */
  var AbortableOperationInProgress: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.AbortableOperationInProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var EndpointURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.EndpointURL] = js.native
  /**
    * The environment's Amazon Resource Name (ARN), which can be used in other API requests that require an ARN.
    */
  var EnvironmentArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.EnvironmentArn] = js.native
  /**
  ...
  /**
    ...
    */
  var EnvironmentLinks: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.EnvironmentLinks] = js.native
  /**
