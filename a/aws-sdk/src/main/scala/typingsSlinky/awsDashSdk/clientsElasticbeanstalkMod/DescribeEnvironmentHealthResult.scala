...
trait DescribeEnvironmentHealthResult extends js.Object {
  /**
    ...
    */
  var ApplicationMetrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.ApplicationMetrics] = js.native
  /**
    * Descriptions of the data that contributed to the environment's current health status.
    */
  var Causes: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Causes] = js.native
  /**
  ...
  /**
    ...
    */
  var EnvironmentName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.EnvironmentName] = js.native
  /**
