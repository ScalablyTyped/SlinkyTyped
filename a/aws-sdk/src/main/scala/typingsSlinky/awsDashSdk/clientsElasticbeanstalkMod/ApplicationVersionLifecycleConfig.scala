...
trait ApplicationVersionLifecycleConfig extends js.Object {
  /**
    ...
    */
  var MaxAgeRule: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.MaxAgeRule] = js.native
  /**
    * Specify a max count rule to restrict the number of application versions that are retained for an application.
    */
  var MaxCountRule: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.MaxCountRule] = js.native
}
