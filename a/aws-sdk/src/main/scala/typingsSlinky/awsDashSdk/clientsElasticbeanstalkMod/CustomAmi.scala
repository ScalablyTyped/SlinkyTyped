...
trait CustomAmi extends js.Object {
  /**
    ...
    */
  var ImageId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.ImageId] = js.native
  /**
    * The type of virtualization used to create the custom AMI.
    */
  var VirtualizationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.VirtualizationType] = js.native
}
