...
trait EnvironmentInfoDescription extends js.Object {
  /**
    ...
    */
  var Ec2InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Ec2InstanceId] = js.native
  /**
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Message] = js.native
  /**
