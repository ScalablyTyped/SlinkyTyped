...
trait ApplicationMetrics extends js.Object {
  ...
  /**
    ...
    */
  var Latency: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Latency] = js.native
  /**
    * Average number of requests handled by the web server per second over the last 10 seconds.
    */
  var RequestCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.RequestCount] = js.native
  /**
    * Represents the percentage of requests over the last 10 seconds that resulted in each type of status code response.
    */
  var StatusCodes: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.StatusCodes] = js.native
}
