...
trait CreatePlatformVersionRequest extends js.Object {
  ...
  /**
    ...
    */
  var PlatformName: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformName = js.native
  /**
    * The number, such as 1.0.2, for the new platform version.
    */
  var PlatformVersion: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformVersion = js.native
  /**
