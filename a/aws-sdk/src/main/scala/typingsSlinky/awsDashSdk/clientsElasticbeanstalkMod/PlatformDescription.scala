...
trait PlatformDescription extends js.Object {
  /**
    ...
    */
  var CustomAmiList: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.CustomAmiList] = js.native
  /**
  ...
  /**
    ...
    */
  var Maintainer: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.Maintainer] = js.native
  /**
    * The operating system used by the platform.
    */
  var OperatingSystemName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.OperatingSystemName] = js.native
  /**
    * The version of the operating system used by the platform.
    */
  var OperatingSystemVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.OperatingSystemVersion] = js.native
  /**
    * The ARN of the platform.
    */
  var PlatformArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformArn] = js.native
  /**
    * The category of the platform.
    */
  var PlatformCategory: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformCategory] = js.native
  /**
    * The name of the platform.
    */
  var PlatformName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformName] = js.native
  /**
    * The AWS account ID of the person who created the platform.
    */
  var PlatformOwner: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformOwner] = js.native
  /**
    * The status of the platform.
    */
  var PlatformStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformStatus] = js.native
  /**
    * The version of the platform.
    */
  var PlatformVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.PlatformVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var SolutionStackName: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SolutionStackName] = js.native
  /**
    * The additions supported by the platform.
    */
  var SupportedAddonList: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SupportedAddonList] = js.native
  /**
    * The tiers supported by the platform.
    */
  var SupportedTierList: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SupportedTierList] = js.native
}
