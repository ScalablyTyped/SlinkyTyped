...
trait DeleteEnvironmentConfigurationMessage extends js.Object {
  /**
    ...
    */
  var ApplicationName: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.ApplicationName = js.native
  /**
    * The name of the environment to delete the draft configuration from.
    */
  var EnvironmentName: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.EnvironmentName = js.native
}
