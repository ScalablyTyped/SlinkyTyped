...
trait SourceBuildInformation extends js.Object {
  /**
    ...
    */
  var SourceLocation: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SourceLocation = js.native
  /**
    * Location where the repository is stored.    CodeCommit     S3   
    */
  var SourceRepository: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SourceRepository = js.native
  /**
    * The type of repository.    Git     Zip   
    */
  var SourceType: typingsSlinky.awsDashSdk.clientsElasticbeanstalkMod.SourceType = js.native
}
