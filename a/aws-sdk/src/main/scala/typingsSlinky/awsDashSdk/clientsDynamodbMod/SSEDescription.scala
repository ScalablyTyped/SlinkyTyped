...
trait SSEDescription extends js.Object {
  ...
  /**
    ...
    */
  var KMSMasterKeyArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.KMSMasterKeyArn] = js.native
  /**
    ...
    */
  var SSEType: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.SSEType] = js.native
  /**
