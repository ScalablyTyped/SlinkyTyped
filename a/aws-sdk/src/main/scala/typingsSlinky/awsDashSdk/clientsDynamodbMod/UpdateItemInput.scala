...
trait UpdateItemInput extends js.Object {
  /**
    ...
    */
  var AttributeUpdates: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.AttributeUpdates] = js.native
  /**
    ...
    */
  var ConditionExpression: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ConditionExpression] = js.native
  /**
    * This is a legacy parameter. Use ConditionExpression instead. For more information, see ConditionalOperator in the Amazon DynamoDB Developer Guide.
    */
  var ConditionalOperator: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ConditionalOperator] = js.native
  /**
  ...
  /**
    ...
    */
  var Key: typingsSlinky.awsDashSdk.clientsDynamodbMod.Key = js.native
  var ReturnConsumedCapacity: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ReturnConsumedCapacity] = js.native
  /**
    * Determines whether item collection metrics are returned. If set to SIZE, the response includes statistics about item collections, if any, that were modified during the operation are returned in the response. If set to NONE (the default), no statistics are returned.
    */
  var ReturnItemCollectionMetrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ReturnItemCollectionMetrics] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateExpression: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.UpdateExpression] = js.native
}
