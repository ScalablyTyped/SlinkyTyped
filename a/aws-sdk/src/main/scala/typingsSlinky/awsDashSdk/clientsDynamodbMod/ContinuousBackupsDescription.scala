...
trait ContinuousBackupsDescription extends js.Object {
  /**
    ...
    */
  var ContinuousBackupsStatus: typingsSlinky.awsDashSdk.clientsDynamodbMod.ContinuousBackupsStatus = js.native
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.PointInTimeRecoveryDescription] = js.native
}
