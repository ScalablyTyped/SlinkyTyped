...
trait BackupDetails extends js.Object {
  ...
  /**
    ...
    */
  var BackupStatus: typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupStatus = js.native
  /**
    ...
    */
  var BackupType: typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupType = js.native
}
