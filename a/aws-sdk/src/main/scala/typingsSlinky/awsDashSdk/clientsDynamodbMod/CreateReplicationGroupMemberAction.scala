...
trait CreateReplicationGroupMemberAction extends js.Object {
  ...
  /**
    ...
    */
  var KMSMasterKeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.KMSMasterKeyId] = js.native
  /**
    * Replica-specific provisioned throughput. If not specified, uses the source table's provisioned throughput settings.
    */
  var ProvisionedThroughputOverride: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ProvisionedThroughputOverride] = js.native
  /**
    * The Region where the new replica will be created.
    */
  var RegionName: typingsSlinky.awsDashSdk.clientsDynamodbMod.RegionName = js.native
}
