...
trait SourceTableDetails extends js.Object {
  ...
  /**
    ...
    */
  var ItemCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ItemCount] = js.native
  /**
    * Schema of the table. 
    */
  ...
  /**
    ...
    */
  var TableId: typingsSlinky.awsDashSdk.clientsDynamodbMod.TableId = js.native
  /**
