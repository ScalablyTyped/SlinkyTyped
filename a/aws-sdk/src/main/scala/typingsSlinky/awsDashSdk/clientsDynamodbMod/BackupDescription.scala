...
trait BackupDescription extends js.Object {
  /**
    ...
    */
  var BackupDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupDetails] = js.native
  /**
    * Contains the details of the table when the backup was created. 
    */
  var SourceTableDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.SourceTableDetails] = js.native
  /**
    * Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.
    */
  var SourceTableFeatureDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.SourceTableFeatureDetails] = js.native
}
