...
trait GlobalSecondaryIndexDescription extends js.Object {
  /**
    ...
    */
  var Backfilling: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.Backfilling] = js.native
  /**
  ...
  /**
    ...
    */
  var IndexStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.IndexStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.KeySchema] = js.native
  /**
    * Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected. 
    */
  var Projection: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.Projection] = js.native
  /**
