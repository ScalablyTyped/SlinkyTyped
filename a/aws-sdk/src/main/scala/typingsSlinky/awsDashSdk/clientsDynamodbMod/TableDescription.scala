...
trait TableDescription extends js.Object {
  /**
    ...
    */
  var ArchivalSummary: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ArchivalSummary] = js.native
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.AttributeDefinitions] = js.native
  /**
    * Contains the details for the read/write capacity mode.
    */
  var BillingModeSummary: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BillingModeSummary] = js.native
  /**
  ...
  /**
    ...
    */
  var RestoreSummary: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.RestoreSummary] = js.native
  /**
    * The description of the server-side encryption status on the specified table.
    */
  var SSEDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.SSEDescription] = js.native
  /**
