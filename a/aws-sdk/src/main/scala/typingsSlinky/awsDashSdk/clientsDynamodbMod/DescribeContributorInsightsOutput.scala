...
trait DescribeContributorInsightsOutput extends js.Object {
  /**
    ...
    */
  var ContributorInsightsRuleList: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ContributorInsightsRuleList] = js.native
  /**
    * Current Status contributor insights.
    */
  var ContributorInsightsStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ContributorInsightsStatus] = js.native
  /**
    ...
    */
  var FailureException: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.FailureException] = js.native
  /**
