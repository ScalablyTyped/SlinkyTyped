...
trait FailureException extends js.Object {
  /**
    ...
    */
  var ExceptionDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ExceptionDescription] = js.native
  /**
    * Exception name.
    */
  var ExceptionName: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ExceptionName] = js.native
}
