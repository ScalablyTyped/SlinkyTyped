...
trait CreateGlobalSecondaryIndexAction extends js.Object {
  /**
    ...
    */
  var IndexName: typingsSlinky.awsDashSdk.clientsDynamodbMod.IndexName = js.native
  /**
    * The key schema for the global secondary index.
    */
  var KeySchema: typingsSlinky.awsDashSdk.clientsDynamodbMod.KeySchema = js.native
  /**
    * Represents attributes that are copied (projected) from the table into an index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.
    */
  var Projection: typingsSlinky.awsDashSdk.clientsDynamodbMod.Projection = js.native
  /**
    ...
    */
  var ProvisionedThroughput: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.ProvisionedThroughput] = js.native
}
