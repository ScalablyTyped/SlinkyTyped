...
trait SourceTableFeatureDetails extends js.Object {
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.GlobalSecondaryIndexes] = js.native
  /**
    * Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. 
    */
  var LocalSecondaryIndexes: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.LocalSecondaryIndexes] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeToLiveDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.TimeToLiveDescription] = js.native
}
