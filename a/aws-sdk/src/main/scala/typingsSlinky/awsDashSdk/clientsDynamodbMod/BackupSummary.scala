...
trait BackupSummary extends js.Object {
  /**
    ...
    */
  var BackupArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupArn] = js.native
  /**
  ...
  /**
    ...
    */
  var BackupName: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupName] = js.native
  /**
    * Size of the backup in bytes.
    */
  var BackupSizeBytes: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupSizeBytes] = js.native
  /**
    * Backup can be in one of the following states: CREATING, ACTIVE, DELETED.
    */
  var BackupStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupStatus] = js.native
  /**
    ...
    */
  var BackupType: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.BackupType] = js.native
  /**
    * ARN associated with the table.
    */
  var TableArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.TableArn] = js.native
  /**
    * Unique identifier for the table.
    */
  var TableId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.TableId] = js.native
  /**
    * Name of the table.
    */
  var TableName: js.UndefOr[typingsSlinky.awsDashSdk.clientsDynamodbMod.TableName] = js.native
}
