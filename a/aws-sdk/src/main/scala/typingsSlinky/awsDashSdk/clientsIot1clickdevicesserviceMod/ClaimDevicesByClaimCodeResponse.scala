...
trait ClaimDevicesByClaimCodeResponse extends js.Object {
  /**
    ...
    */
  var ClaimCode: js.UndefOr[__stringMin12Max40] = js.native
  /**
...
object ClaimDevicesByClaimCodeResponse {
  @scala.inline
  def apply(ClaimCode: __stringMin12Max40 = null, Total: Int | Double = null): ClaimDevicesByClaimCodeResponse = {
