...
trait DescribeCompanyNetworkConfigurationResponse extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.SecurityGroupIds] = js.native
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.SubnetIds] = js.native
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.VpcId] = js.native
}
