...
trait DescribeFleetMetadataResponse extends js.Object {
  /**
    ...
    */
  var CompanyCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.CompanyCode] = js.native
  /**
  ...
  /**
    ...
    */
  var FleetName: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.FleetName] = js.native
  /**
    * The current state of the fleet.
    */
  var FleetStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.FleetStatus] = js.native
  /**
