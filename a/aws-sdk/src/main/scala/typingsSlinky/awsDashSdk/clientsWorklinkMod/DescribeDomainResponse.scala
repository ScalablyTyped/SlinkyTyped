...
trait DescribeDomainResponse extends js.Object {
  /**
    ...
    */
  var AcmCertificateArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.AcmCertificateArn] = js.native
  /**
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.DomainName] = js.native
  /**
    * The current state for the domain.
    */
  var DomainStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.DomainStatus] = js.native
}
