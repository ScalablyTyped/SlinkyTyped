...
trait UpdateCompanyNetworkConfigurationRequest extends js.Object {
  ...
  /**
    ...
    */
  var SecurityGroupIds: typingsSlinky.awsDashSdk.clientsWorklinkMod.SecurityGroupIds = js.native
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: typingsSlinky.awsDashSdk.clientsWorklinkMod.SubnetIds = js.native
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: typingsSlinky.awsDashSdk.clientsWorklinkMod.VpcId = js.native
}
