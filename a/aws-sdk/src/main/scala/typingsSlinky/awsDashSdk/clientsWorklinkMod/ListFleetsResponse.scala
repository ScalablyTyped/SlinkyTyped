...
trait ListFleetsResponse extends js.Object {
  /**
    ...
    */
  var FleetSummaryList: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.FleetSummaryList] = js.native
  /**
    * The pagination token used to retrieve the next page of results for this operation. If there are no more pages, this value is null.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsWorklinkMod.NextToken] = js.native
}
