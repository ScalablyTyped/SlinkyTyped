...
trait GetLicenseConfigurationResponse extends js.Object {
  /**
    ...
    */
  var AutomatedDiscoveryInformation: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.AutomatedDiscoveryInformation] = js.native
  /**
    * Summaries of the licenses consumed by resources.
    */
  var ConsumedLicenseSummaryList: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.ConsumedLicenseSummaryList] = js.native
  /**
  ...
  /**
    ...
    */
  var LicenseCountingType: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.LicenseCountingType] = js.native
  /**
    * License rules.
    */
  ...
  /**
    ...
    */
  var ManagedResourceSummaryList: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.ManagedResourceSummaryList] = js.native
  /**
  ...
  /**
    * Product information.
    */
  var ProductInformationList: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.ProductInformationList] = js.native
  /**
