package typingsSlinky.awsDashSdk.clientsLicensemanagerMod
...
trait ConsumedLicenseSummary extends js.Object {
  ...
  /**
    ...
    */
  var ResourceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsLicensemanagerMod.ResourceType] = js.native
}
