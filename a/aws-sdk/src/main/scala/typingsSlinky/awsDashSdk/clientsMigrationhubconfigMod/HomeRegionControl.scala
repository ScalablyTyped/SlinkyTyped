package typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod
...
trait HomeRegionControl extends js.Object {
  /**
    ...
    */
  var ControlId: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.ControlId] = js.native
  /**
    * The AWS Region that's been set as home region. For example, "us-west-2" or "eu-central-1" are valid home regions.
    */
  var HomeRegion: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.HomeRegion] = js.native
  /**
  ...
  /**
    ...
    */
  var Target: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.Target] = js.native
}
