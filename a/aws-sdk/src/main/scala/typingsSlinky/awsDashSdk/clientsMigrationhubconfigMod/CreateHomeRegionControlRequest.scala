...
trait CreateHomeRegionControlRequest extends js.Object {
  /**
    ...
    */
  var DryRun: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.DryRun] = js.native
  /**
    * The name of the home region of the calling account.
    */
  var HomeRegion: typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.HomeRegion = js.native
  /**
    * The account for which this command sets up a home region control. The Target is always of type ACCOUNT.
    */
  var Target: typingsSlinky.awsDashSdk.clientsMigrationhubconfigMod.Target = js.native
}
