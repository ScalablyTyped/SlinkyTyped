...
trait PutResourceAttributesRequest extends js.Object {
  /**
    ...
    */
  var DryRun: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.DryRun] = js.native
  /**
    * Unique identifier that references the migration task. Do not store personal data in this field. 
    */
  var MigrationTaskName: typingsSlinky.awsDashSdk.clientsMigrationhubMod.MigrationTaskName = js.native
  /**
    * The name of the ProgressUpdateStream. 
    */
  var ProgressUpdateStream: typingsSlinky.awsDashSdk.clientsMigrationhubMod.ProgressUpdateStream = js.native
  /**
    ...
    */
  var ResourceAttributeList: typingsSlinky.awsDashSdk.clientsMigrationhubMod.ResourceAttributeList = js.native
}
