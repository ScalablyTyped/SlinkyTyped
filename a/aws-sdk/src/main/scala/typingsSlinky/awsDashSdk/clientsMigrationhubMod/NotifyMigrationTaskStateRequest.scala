...
trait NotifyMigrationTaskStateRequest extends js.Object {
  ...
  /**
    ...
    */
  var NextUpdateSeconds: typingsSlinky.awsDashSdk.clientsMigrationhubMod.NextUpdateSeconds = js.native
  /**
  ...
  /**
    ...
    */
  var Task: typingsSlinky.awsDashSdk.clientsMigrationhubMod.Task = js.native
  /**
