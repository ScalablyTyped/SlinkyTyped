...
trait MigrationTaskSummary extends js.Object {
  /**
    ...
    */
  var MigrationTaskName: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.MigrationTaskName] = js.native
  /**
    * Indication of the percentage completion of the task.
    */
  var ProgressPercent: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.ProgressPercent] = js.native
  /**
    * An AWS resource used for access control. It should uniquely identify the migration tool as it is used for all updates made by the tool.
    */
  var ProgressUpdateStream: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.ProgressUpdateStream] = js.native
  /**
    * Status of the task.
    */
  var Status: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.Status] = js.native
  /**
    * Detail information of what is being done within the overall status state.
    */
  var StatusDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsMigrationhubMod.StatusDetail] = js.native
  /**
