...
trait Layer extends js.Object {
  ...
  /**
    ...
    */
  var CloudWatchLogsConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworksMod.CloudWatchLogsConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var LifecycleEventConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworksMod.LifecycleEventConfiguration] = js.native
  /**
    * The layer name.
    */
  ...
  /**
    ...
    */
  var VolumeConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworksMod.VolumeConfigurations] = js.native
}
