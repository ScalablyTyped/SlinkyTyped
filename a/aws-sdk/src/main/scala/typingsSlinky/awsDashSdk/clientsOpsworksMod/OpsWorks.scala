package typingsSlinky.awsDashSdk.clientsOpsworksMod

import typingsSlinky.awsDashSdk.Anon_Waiter
import typingsSlinky.awsDashSdk.awsDashSdkStrings.appExists
import typingsSlinky.awsDashSdk.awsDashSdkStrings.deploymentSuccessful
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceOnline
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceRegistered
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceStopped
import typingsSlinky.awsDashSdk.awsDashSdkStrings.instanceTerminated
...
trait OpsWorks extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_appExists(state: appExists, params: DescribeAppsRequest with Anon_Waiter): Request[DescribeAppsResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_appExists(
    state: appExists,
    params: DescribeAppsRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeAppsResult, Unit]
  ): Request[DescribeAppsResult, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_deploymentSuccessful(state: deploymentSuccessful, params: DescribeDeploymentsRequest with Anon_Waiter): Request[DescribeDeploymentsResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_deploymentSuccessful(
    state: deploymentSuccessful,
    params: DescribeDeploymentsRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeDeploymentsResult, Unit]
  ): Request[DescribeDeploymentsResult, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceOnline(state: instanceOnline, params: DescribeInstancesRequest with Anon_Waiter): Request[DescribeInstancesResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceOnline(
    state: instanceOnline,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceRegistered(state: instanceRegistered, params: DescribeInstancesRequest with Anon_Waiter): Request[DescribeInstancesResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceRegistered(
    state: instanceRegistered,
    params: DescribeInstancesRequest with Anon_Waiter,
