...
trait GetMediaForFragmentListOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.ContentType] = js.native
  /**
    ...
    */
  var Payload: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.Payload] = js.native
}
