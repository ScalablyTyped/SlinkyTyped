package typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod
...
trait GetHLSStreamingSessionURLOutput extends js.Object {
  /**
    ...
    */
  var HLSStreamingSessionURL: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.HLSStreamingSessionURL
  ] = js.native
}
