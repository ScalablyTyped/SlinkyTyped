...
trait GetDASHStreamingSessionURLInput extends js.Object {
  /**
    ...
    */
  var DASHFragmentSelector: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.DASHFragmentSelector
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var Expires: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.Expires] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.StreamName] = js.native
}
