...
trait GetHLSStreamingSessionURLInput extends js.Object {
  /**
    ...
    */
  var ContainerFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.ContainerFormat] = js.native
  /**
  ...
  /**
    ...
    */
  var HLSFragmentSelector: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.HLSFragmentSelector] = js.native
  /**
