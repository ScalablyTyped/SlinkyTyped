...
trait FragmentSelector extends js.Object {
  /**
    ...
    */
  var FragmentSelectorType: typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.FragmentSelectorType = js.native
  /**
    * The range of timestamps to return.
    */
  var TimestampRange: typingsSlinky.awsDashSdk.clientsKinesisvideoarchivedmediaMod.TimestampRange = js.native
}
