...
trait JobDescriptor extends js.Object {
  /**
    ...
    */
  var ConfirmationRequired: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.ConfirmationRequired] = js.native
  /**
  ...
  /**
    ...
    */
  var JobArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.JobArn] = js.native
  /**
    * The ID for the specified job.
    */
  var JobId: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.JobId] = js.native
  /**
  ...
  /**
    ...
    */
  var SuspendedCause: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.SuspendedCause] = js.native
  /**
...
object JobDescriptor {
  ...
  def apply(
    ...
    SuspendedDate: js.Date = null,
    TerminationDate: js.Date = null
  ): JobDescriptor = {
