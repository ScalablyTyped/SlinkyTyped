...
trait CreateAccessPointRequest extends js.Object {
  ...
  var PublicAccessBlockConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.PublicAccessBlockConfiguration] = js.native
  /**
    * If you include this field, Amazon S3 restricts access to this access point to requests from the specified Virtual Private Cloud (VPC).
    */
  var VpcConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3controlMod.VpcConfiguration] = js.native
}
