...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.loadBalancerAvailable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.loadBalancerExists
import typingsSlinky.awsDashSdk.awsDashSdkStrings.loadBalancersDeleted
import typingsSlinky.awsDashSdk.awsDashSdkStrings.targetDeregistered
import typingsSlinky.awsDashSdk.awsDashSdkStrings.targetInService
...
trait ELBv2 extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_loadBalancerAvailable(state: loadBalancerAvailable, params: DescribeLoadBalancersInput with Anon_Waiter): Request[DescribeLoadBalancersOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_loadBalancerAvailable(
    state: loadBalancerAvailable,
    params: DescribeLoadBalancersInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeLoadBalancersOutput, Unit]
  ): Request[DescribeLoadBalancersOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_loadBalancerExists(state: loadBalancerExists, params: DescribeLoadBalancersInput with Anon_Waiter): Request[DescribeLoadBalancersOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_loadBalancerExists(
    state: loadBalancerExists,
    params: DescribeLoadBalancersInput with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_loadBalancersDeleted(state: loadBalancersDeleted, params: DescribeLoadBalancersInput with Anon_Waiter): Request[DescribeLoadBalancersOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_loadBalancersDeleted(
    state: loadBalancersDeleted,
    params: DescribeLoadBalancersInput with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_targetDeregistered(state: targetDeregistered, params: DescribeTargetHealthInput with Anon_Waiter): Request[DescribeTargetHealthOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_targetDeregistered(
    state: targetDeregistered,
    params: DescribeTargetHealthInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeTargetHealthOutput, Unit]
  ): Request[DescribeTargetHealthOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_targetInService(state: targetInService, params: DescribeTargetHealthInput with Anon_Waiter): Request[DescribeTargetHealthOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_targetInService(
    state: targetInService,
    params: DescribeTargetHealthInput with Anon_Waiter,
