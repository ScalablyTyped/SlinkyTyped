...
trait ModifyTargetGroupInput extends js.Object {
  /**
    ...
    */
  var HealthCheckEnabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.HealthCheckEnabled] = js.native
  /**
    ...
    */
  var HealthCheckIntervalSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.HealthCheckIntervalSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckPort: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.HealthCheckPort] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckTimeoutSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.HealthCheckTimeoutSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var Matcher: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.Matcher] = js.native
  /**
    * The Amazon Resource Name (ARN) of the target group.
    */
  var TargetGroupArn: typingsSlinky.awsDashSdk.clientsElbv2Mod.TargetGroupArn = js.native
  /**
