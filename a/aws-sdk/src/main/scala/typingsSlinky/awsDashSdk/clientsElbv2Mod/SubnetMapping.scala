...
trait SubnetMapping extends js.Object {
  /**
    ...
    */
  var AllocationId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.AllocationId] = js.native
  /**
    * [Network Load Balancers] The private IPv4 address for an internal load balancer.
    */
  var PrivateIPv4Address: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.PrivateIPv4Address] = js.native
  /**
    * The ID of the subnet.
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.SubnetId] = js.native
}
