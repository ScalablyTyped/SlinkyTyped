...
trait SslPolicy extends js.Object {
  /**
    * The ciphers.
    */
  var Ciphers: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.Ciphers] = js.native
  /**
  ...
  /**
    * The protocols.
    */
  var SslProtocols: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.SslProtocols] = js.native
}
