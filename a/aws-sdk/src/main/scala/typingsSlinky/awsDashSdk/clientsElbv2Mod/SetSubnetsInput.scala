...
trait SetSubnetsInput extends js.Object {
  ...
  /**
    ...
    */
  var SubnetMappings: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.SubnetMappings] = js.native
  /**
    * The IDs of the public subnets. You must specify subnets from at least two Availability Zones. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings.
    */
  var Subnets: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.Subnets] = js.native
}
