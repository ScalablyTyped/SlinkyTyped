...
trait ModifyListenerInput extends js.Object {
  ...
  /**
    ...
    */
  var ListenerArn: typingsSlinky.awsDashSdk.clientsElbv2Mod.ListenerArn = js.native
  /**
    * The port for connections from clients to the load balancer.
    */
  var Port: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.Port] = js.native
  /**
