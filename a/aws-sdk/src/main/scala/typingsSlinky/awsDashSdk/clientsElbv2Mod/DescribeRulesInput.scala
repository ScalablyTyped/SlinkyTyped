...
trait DescribeRulesInput extends js.Object {
  /**
    ...
    */
  var ListenerArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.ListenerArn] = js.native
  /**
    * The marker for the next set of results. (You received this marker from a previous call.)
    */
  var Marker: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.Marker] = js.native
  /**
    * The maximum number of results to return with this call.
    */
  var PageSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.PageSize] = js.native
  /**
    * The Amazon Resource Names (ARN) of the rules.
    */
  var RuleArns: js.UndefOr[typingsSlinky.awsDashSdk.clientsElbv2Mod.RuleArns] = js.native
}
