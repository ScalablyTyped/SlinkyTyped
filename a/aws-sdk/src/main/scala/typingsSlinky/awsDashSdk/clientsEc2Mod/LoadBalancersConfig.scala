...
trait LoadBalancersConfig extends js.Object {
  /**
    ...
    */
  var ClassicLoadBalancersConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.ClassicLoadBalancersConfig] = js.native
  /**
    * The target groups.
    */
  var TargetGroupsConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TargetGroupsConfig] = js.native
}
