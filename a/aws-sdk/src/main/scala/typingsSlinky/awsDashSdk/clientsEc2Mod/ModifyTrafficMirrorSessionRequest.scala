...
trait ModifyTrafficMirrorSessionRequest extends js.Object {
  ...
  /**
    ...
    */
  var TrafficMirrorFilterId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TrafficMirrorFilterId] = js.native
  /**
    * The ID of the Traffic Mirror session.
    */
  var TrafficMirrorSessionId: typingsSlinky.awsDashSdk.clientsEc2Mod.TrafficMirrorSessionId = js.native
  /**
    * The Traffic Mirror target. The target must be in the same VPC as the source, or have a VPC peering connection with the source.
    */
  var TrafficMirrorTargetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TrafficMirrorTargetId] = js.native
  /**
