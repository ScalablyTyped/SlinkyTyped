...
trait CreateRouteRequest extends js.Object {
  ...
  /**
    ...
    */
  var EgressOnlyInternetGatewayId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.EgressOnlyInternetGatewayId] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.InstanceId] = js.native
  /**
  ...
  /**
    ...
    */
  var NatGatewayId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.NatGatewayId] = js.native
  /**
    * The ID of a network interface.
    */
  var NetworkInterfaceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.NetworkInterfaceId] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcPeeringConnectionId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.VpcPeeringConnectionId] = js.native
}
