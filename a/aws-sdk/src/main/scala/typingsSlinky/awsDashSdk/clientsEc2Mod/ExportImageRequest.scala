...
trait ExportImageRequest extends js.Object {
  ...
  /**
    ...
    */
  var DiskImageFormat: typingsSlinky.awsDashSdk.clientsEc2Mod.DiskImageFormat = js.native
  /**
  ...
  /**
    * The ID of the image.
    */
  var ImageId: typingsSlinky.awsDashSdk.clientsEc2Mod.ImageId = js.native
  /**
