...
trait CapacityReservationSpecification extends js.Object {
  /**
    ...
    */
  var CapacityReservationPreference: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.CapacityReservationPreference] = js.native
  /**
    * Information about the target Capacity Reservation.
    */
  var CapacityReservationTarget: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.CapacityReservationTarget] = js.native
}
