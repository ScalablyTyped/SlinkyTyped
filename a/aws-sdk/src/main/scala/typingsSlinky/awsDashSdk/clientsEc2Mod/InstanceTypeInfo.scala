...
trait InstanceTypeInfo extends js.Object {
  ...
  /**
    ...
    */
  var EbsInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.EbsInfo] = js.native
  /**
    * Describes the FPGA accelerator settings for the instance type.
    */
  var FpgaInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.FpgaInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var GpuInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.GpuInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var InferenceAcceleratorInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.InferenceAcceleratorInfo] = js.native
  /**
    * Describes the disks for the instance type.
    */
  var InstanceStorageInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.InstanceStorageInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var MemoryInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.MemoryInfo] = js.native
  /**
    * Describes the network settings for the instance type.
    */
  var NetworkInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.NetworkInfo] = js.native
  /**
    * Describes the placement group settings for the instance type.
    */
  var PlacementGroupInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.PlacementGroupInfo] = js.native
  /**
    * Describes the processor.
    */
  var ProcessorInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.ProcessorInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var VCpuInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.VCpuInfo] = js.native
}
