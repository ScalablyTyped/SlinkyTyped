...
trait SpotInstanceRequest extends js.Object {
  ...
  /**
    ...
    */
  var InstanceInterruptionBehavior: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.InstanceInterruptionBehavior] = js.native
  /**
  ...
  /**
    ...
    */
  var LaunchSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.LaunchSpecification] = js.native
  /**
