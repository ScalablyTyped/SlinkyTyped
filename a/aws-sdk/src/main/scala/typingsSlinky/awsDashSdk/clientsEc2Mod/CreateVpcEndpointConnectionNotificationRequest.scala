...
trait CreateVpcEndpointConnectionNotificationRequest extends js.Object {
  ...
  /**
    ...
    */
  var ServiceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.ServiceId] = js.native
  /**
    * The ID of the endpoint. 
    */
  var VpcEndpointId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.VpcEndpointId] = js.native
}
