...
trait ModifyFpgaImageAttributeRequest extends js.Object {
  ...
  /**
    * The ID of the AFI.
    */
  var FpgaImageId: typingsSlinky.awsDashSdk.clientsEc2Mod.FpgaImageId = js.native
  /**
  ...
  /**
    * The operation type.
    */
  var OperationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.OperationType] = js.native
  /**
