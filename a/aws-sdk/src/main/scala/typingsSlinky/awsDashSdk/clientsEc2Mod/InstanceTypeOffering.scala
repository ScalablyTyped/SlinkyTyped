...
trait InstanceTypeOffering extends js.Object {
  ...
  /**
    ...
    */
  var Location: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.Location] = js.native
  /**
    * The location type.
    */
  var LocationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.LocationType] = js.native
}
