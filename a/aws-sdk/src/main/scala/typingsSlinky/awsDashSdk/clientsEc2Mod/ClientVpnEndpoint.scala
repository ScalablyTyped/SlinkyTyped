...
trait ClientVpnEndpoint extends js.Object {
  ...
  /**
    ...
    */
  var TransportProtocol: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TransportProtocol] = js.native
  /**
    * The protocol used by the VPN session.
    */
  var VpnProtocol: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.VpnProtocol] = js.native
}
