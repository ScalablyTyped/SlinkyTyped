...
trait CreateNetworkAclEntryRequest extends js.Object {
  ...
  /**
    ...
    */
  var IcmpTypeCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.IcmpTypeCode] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkAclId: typingsSlinky.awsDashSdk.clientsEc2Mod.NetworkAclId = js.native
  /**
    * TCP or UDP protocols: The range of ports the rule applies to. Required if specifying protocol 6 (TCP) or 17 (UDP).
    */
  var PortRange: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.PortRange] = js.native
  /**
  ...
  /**
    ...
    */
  var RuleAction: typingsSlinky.awsDashSdk.clientsEc2Mod.RuleAction = js.native
  /**
