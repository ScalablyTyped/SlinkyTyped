...
trait ModifyTrafficMirrorFilterRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var TrafficDirection: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TrafficDirection] = js.native
  /**
    * The ID of the Traffic Mirror rule.
    */
  var TrafficMirrorFilterRuleId: typingsSlinky.awsDashSdk.clientsEc2Mod.TrafficMirrorFilterRuleId = js.native
}
