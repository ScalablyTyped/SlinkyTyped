...
trait NetworkInfo extends js.Object {
  /**
    ...
    */
  var EnaSupport: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.EnaSupport] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkPerformance: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.NetworkPerformance] = js.native
}
