...
trait DeleteLaunchTemplateRequest extends js.Object {
  ...
  /**
    ...
    */
  var LaunchTemplateId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.LaunchTemplateId] = js.native
  /**
    * The name of the launch template. You must specify either the launch template ID or launch template name in the request.
    */
  var LaunchTemplateName: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.LaunchTemplateName] = js.native
}
