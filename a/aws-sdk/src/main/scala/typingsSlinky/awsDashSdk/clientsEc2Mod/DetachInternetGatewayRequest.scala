...
trait DetachInternetGatewayRequest extends js.Object {
  ...
  /**
    ...
    */
  var InternetGatewayId: typingsSlinky.awsDashSdk.clientsEc2Mod.InternetGatewayId = js.native
  /**
    * The ID of the VPC.
    */
  var VpcId: typingsSlinky.awsDashSdk.clientsEc2Mod.VpcId = js.native
}
