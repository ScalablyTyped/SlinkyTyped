...
trait VpcPeeringConnectionVpcInfo extends js.Object {
  ...
  /**
    ...
    */
  var CidrBlockSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.CidrBlockSet] = js.native
  /**
    * The IPv6 CIDR block for the VPC.
    */
  var Ipv6CidrBlockSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.Ipv6CidrBlockSet] = js.native
  /**
