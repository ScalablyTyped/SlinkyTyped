...
trait ExportToS3TaskSpecification extends js.Object {
  /**
    ...
    */
  var ContainerFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.ContainerFormat] = js.native
  /**
    * The format for the exported image.
    */
  var DiskImageFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.DiskImageFormat] = js.native
  /**
