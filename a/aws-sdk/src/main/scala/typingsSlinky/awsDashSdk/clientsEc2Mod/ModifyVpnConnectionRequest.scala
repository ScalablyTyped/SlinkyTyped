...
trait ModifyVpnConnectionRequest extends js.Object {
  /**
    ...
    */
  var CustomerGatewayId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.CustomerGatewayId] = js.native
  /**
  ...
  /**
    ...
    */
  var TransitGatewayId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.TransitGatewayId] = js.native
  /**
    * The ID of the VPN connection.
    */
  var VpnConnectionId: typingsSlinky.awsDashSdk.clientsEc2Mod.VpnConnectionId = js.native
  /**
    * The ID of the virtual private gateway at the AWS side of the VPN connection.
    */
  var VpnGatewayId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.VpnGatewayId] = js.native
}
