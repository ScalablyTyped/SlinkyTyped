...
trait SpotFleetRequestConfigData extends js.Object {
  /**
    ...
    */
  var AllocationStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.AllocationStrategy] = js.native
  /**
  ...
  /**
    ...
    */
  var ExcessCapacityTerminationPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.ExcessCapacityTerminationPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var LoadBalancersConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.LoadBalancersConfig] = js.native
  /**
    * The order of the launch template overrides to use in fulfilling On-Demand capacity. If you specify lowestPrice, Spot Fleet uses price to determine the order, launching the lowest price first. If you specify prioritized, Spot Fleet uses the priority that you assign to each Spot Fleet launch template override, launching the highest priority first. If you do not specify a value, Spot Fleet defaults to lowestPrice.
    */
  var OnDemandAllocationStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsEc2Mod.OnDemandAllocationStrategy] = js.native
  /**
