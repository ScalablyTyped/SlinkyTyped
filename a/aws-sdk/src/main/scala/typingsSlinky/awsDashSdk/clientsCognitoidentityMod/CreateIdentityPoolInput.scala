...
trait CreateIdentityPoolInput extends js.Object {
  ...
  /**
    ...
    */
  var DeveloperProviderName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityMod.DeveloperProviderName] = js.native
  /**
    * A string that you provide.
    */
  var IdentityPoolName: typingsSlinky.awsDashSdk.clientsCognitoidentityMod.IdentityPoolName = js.native
  /**
