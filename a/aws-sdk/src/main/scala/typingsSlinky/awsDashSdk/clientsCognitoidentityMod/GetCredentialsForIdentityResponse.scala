...
trait GetCredentialsForIdentityResponse extends js.Object {
  /**
    ...
    */
  var Credentials: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityMod.Credentials] = js.native
  /**
    * A unique identifier in the format REGION:GUID.
    */
  var IdentityId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityMod.IdentityId] = js.native
}
