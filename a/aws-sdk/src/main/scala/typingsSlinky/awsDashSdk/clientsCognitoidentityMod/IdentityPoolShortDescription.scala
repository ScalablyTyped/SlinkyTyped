...
trait IdentityPoolShortDescription extends js.Object {
  /**
    ...
    */
  var IdentityPoolId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityMod.IdentityPoolId] = js.native
  /**
    * A string that you provide.
    */
  var IdentityPoolName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityMod.IdentityPoolName] = js.native
}
