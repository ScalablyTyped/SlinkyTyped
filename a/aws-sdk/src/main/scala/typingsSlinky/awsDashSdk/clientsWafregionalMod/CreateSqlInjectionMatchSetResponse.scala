...
trait CreateSqlInjectionMatchSetResponse extends js.Object {
  /**
    ...
    */
  var ChangeToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.ChangeToken] = js.native
  /**
    * A SqlInjectionMatchSet.
    */
  var SqlInjectionMatchSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.SqlInjectionMatchSet] = js.native
}
