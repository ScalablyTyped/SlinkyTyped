...
trait LoggingConfiguration extends js.Object {
  /**
    ...
    */
  var LogDestinationConfigs: typingsSlinky.awsDashSdk.clientsWafregionalMod.LogDestinationConfigs = js.native
  /**
    * The parts of the request that you want redacted from the logs. For example, if you redact the cookie field, the cookie field in the firehose will be xxx. 
    */
  var RedactedFields: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.RedactedFields] = js.native
  /**
