...
trait ListLoggingConfigurationsResponse extends js.Object {
  /**
    ...
    */
  var LoggingConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.LoggingConfigurations] = js.native
  /**
    ...
    */
  var NextMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.NextMarker] = js.native
}
