...
trait RateBasedRule extends js.Object {
  ...
  /**
    ...
    */
  var MetricName: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.MetricName] = js.native
  /**
  ...
  /**
    ...
    */
  var RateKey: typingsSlinky.awsDashSdk.clientsWafregionalMod.RateKey = js.native
  /**
    * The maximum number of requests, which have an identical value in the field specified by the RateKey, allowed in a five-minute period. If the number of requests exceeds the RateLimit and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.
    */
  var RateLimit: typingsSlinky.awsDashSdk.clientsWafregionalMod.RateLimit = js.native
  /**
