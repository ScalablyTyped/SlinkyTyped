...
trait HTTPRequest extends js.Object {
  ...
  /**
    ...
    */
  var Country: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.Country] = js.native
  /**
    * The HTTP version specified in the sampled web request, for example, HTTP/1.1.
    */
  var HTTPVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.HTTPVersion] = js.native
  /**
