...
trait CreateWebACLRequest extends js.Object {
  /**
    ...
    */
  var ChangeToken: typingsSlinky.awsDashSdk.clientsWafregionalMod.ChangeToken = js.native
  /**
  ...
  /**
    ...
    */
  var MetricName: typingsSlinky.awsDashSdk.clientsWafregionalMod.MetricName = js.native
  /**
