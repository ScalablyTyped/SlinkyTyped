...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafregionalMod.TimeWindow] = js.native
}
