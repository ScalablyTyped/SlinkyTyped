...
trait NamespaceProperties extends js.Object {
  /**
    ...
    */
  var DnsProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.DnsProperties] = js.native
  /**
    * A complex type that contains the name of an HTTP namespace.
    */
  var HttpProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.HttpProperties] = js.native
}
