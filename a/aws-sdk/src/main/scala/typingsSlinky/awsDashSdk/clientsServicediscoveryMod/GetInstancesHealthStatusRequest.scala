...
trait GetInstancesHealthStatusRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.MaxResults] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.NextToken] = js.native
  /**
