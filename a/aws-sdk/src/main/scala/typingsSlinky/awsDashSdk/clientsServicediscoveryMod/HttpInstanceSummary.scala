...
trait HttpInstanceSummary extends js.Object {
  /**
    ...
    */
  var Attributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.Attributes] = js.native
  /**
    * If you configured health checking in the service, the current health status of the service instance.
    */
  var HealthStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.HealthStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var NamespaceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.NamespaceName] = js.native
  /**
    * The name of the service that you specified when you registered the instance.
    */
  var ServiceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicediscoveryMod.ServiceName] = js.native
}
