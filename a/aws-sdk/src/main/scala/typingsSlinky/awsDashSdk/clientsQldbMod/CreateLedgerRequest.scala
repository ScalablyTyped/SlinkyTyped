package typingsSlinky.awsDashSdk.clientsQldbMod
...
trait CreateLedgerRequest extends js.Object {
  /**
    ...
    */
  var DeletionProtection: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbMod.DeletionProtection] = js.native
  /**
  ...
  /**
    ...
    */
  var PermissionsMode: typingsSlinky.awsDashSdk.clientsQldbMod.PermissionsMode = js.native
  /**
    * The key-value pairs to add as tags to the ledger that you want to create. Tag keys are case sensitive. Tag values are case sensitive and can be null.
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbMod.Tags] = js.native
}
