...
trait ListJournalS3ExportsRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbMod.MaxResults] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbMod.NextToken] = js.native
}
