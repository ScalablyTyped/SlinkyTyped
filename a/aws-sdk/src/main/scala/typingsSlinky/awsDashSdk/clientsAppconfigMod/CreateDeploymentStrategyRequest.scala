...
trait CreateDeploymentStrategyRequest extends js.Object {
  ...
  /**
    ...
    */
  var GrowthFactor: typingsSlinky.awsDashSdk.clientsAppconfigMod.GrowthFactor = js.native
  /**
  ...
  /**
    ...
    */
  var ReplicateTo: typingsSlinky.awsDashSdk.clientsAppconfigMod.ReplicateTo = js.native
  /**
