...
trait UpdateDeploymentStrategyRequest extends js.Object {
  ...
  /**
    ...
    */
  var GrowthFactor: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppconfigMod.GrowthFactor] = js.native
  /**
    * The algorithm used to define how percentage grows over time.
    */
  var GrowthType: js.UndefOr[typingsSlinky.awsDashSdk.clientsAppconfigMod.GrowthType] = js.native
}
