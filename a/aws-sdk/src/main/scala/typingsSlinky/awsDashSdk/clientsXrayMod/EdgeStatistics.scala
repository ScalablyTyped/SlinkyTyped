...
trait EdgeStatistics extends js.Object {
  /**
    ...
    */
  var ErrorStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ErrorStatistics] = js.native
  /**
    * Information about requests that failed with a 5xx Server Error status code.
    */
  var FaultStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.FaultStatistics] = js.native
  /**
