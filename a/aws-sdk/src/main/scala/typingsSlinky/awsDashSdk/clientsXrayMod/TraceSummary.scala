...
trait TraceSummary extends js.Object {
  /**
    ...
    */
  var Annotations: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.Annotations] = js.native
  /**
  ...
  /**
    ...
    */
  var ErrorRootCauses: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ErrorRootCauses] = js.native
  /**
    * A collection of FaultRootCause structures corresponding to the the trace segments.
    */
  var FaultRootCauses: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.FaultRootCauses] = js.native
  /**
  ...
  /**
    ...
    */
  var Http: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.Http] = js.native
  /**
  ...
  /**
    ...
    */
  var ResponseTimeRootCauses: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ResponseTimeRootCauses] = js.native
  /**
