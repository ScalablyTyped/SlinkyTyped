...
trait GetTraceSummariesRequest extends js.Object {
  ...
  /**
    ...
    */
  var SamplingStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.SamplingStrategy] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeRangeType: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.TimeRangeType] = js.native
}
