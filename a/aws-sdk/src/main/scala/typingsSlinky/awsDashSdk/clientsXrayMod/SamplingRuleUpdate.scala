...
trait SamplingRuleUpdate extends js.Object {
  ...
  /**
    ...
    */
  var HTTPMethod: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.HTTPMethod] = js.native
  /**
    * Matches the hostname from a request URL.
    */
  var Host: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.Host] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ResourceARN] = js.native
  /**
  ...
  /**
    ...
    */
  var RuleName: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.RuleName] = js.native
  /**
    * Matches the name that the service uses to identify itself in segments.
    */
  var ServiceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ServiceName] = js.native
  /**
    * Matches the origin that the service uses to identify its type in segments.
    */
  var ServiceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ServiceType] = js.native
  /**
    * Matches the path from a request URL.
    */
  var URLPath: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.URLPath] = js.native
}
