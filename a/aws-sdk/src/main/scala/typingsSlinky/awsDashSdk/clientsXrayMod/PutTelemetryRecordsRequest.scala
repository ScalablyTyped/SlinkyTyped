...
trait PutTelemetryRecordsRequest extends js.Object {
  /**
    * 
    */
  var EC2InstanceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.EC2InstanceId] = js.native
  /**
    * 
    */
  var Hostname: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.Hostname] = js.native
  /**
    * 
    */
