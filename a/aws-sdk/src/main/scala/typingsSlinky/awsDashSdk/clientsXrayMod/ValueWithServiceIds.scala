...
trait ValueWithServiceIds extends js.Object {
  /**
    ...
    */
  var AnnotationValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.AnnotationValue] = js.native
  /**
    * Services to which the annotation applies.
    */
  var ServiceIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsXrayMod.ServiceIds] = js.native
}
