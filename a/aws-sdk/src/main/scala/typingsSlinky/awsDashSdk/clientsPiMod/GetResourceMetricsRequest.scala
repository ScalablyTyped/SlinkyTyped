...
trait GetResourceMetricsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsPiMod.MaxResults] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceType: typingsSlinky.awsDashSdk.clientsPiMod.ServiceType = js.native
  /**
