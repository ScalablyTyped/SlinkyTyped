...
trait Flow extends js.Object {
  ...
  var Source: typingsSlinky.awsDashSdk.clientsMediaconnectMod.Source = js.native
  /**
    * The current status of the flow.
    */
  var Status: typingsSlinky.awsDashSdk.clientsMediaconnectMod.Status = js.native
}
