...
trait DescribeHumanLoopResponse extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.FlowDefinitionArn = js.native
  /**
    * The Amazon Resource Name (ARN) of the human loop.
    */
  var HumanLoopArn: typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.HumanLoopArn = js.native
  /**
  ...
  /**
    ...
    */
  var HumanLoopStatus: typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.HumanLoopStatus = js.native
}
