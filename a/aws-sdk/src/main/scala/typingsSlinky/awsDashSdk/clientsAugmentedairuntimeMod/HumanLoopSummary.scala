...
trait HumanLoopSummary extends js.Object {
  ...
  /**
    ...
    */
  var FailureReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.FailureReason] = js.native
  /**
    * The Amazon Resource Name (ARN) of the flow definition.
    */
  var FlowDefinitionArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.FlowDefinitionArn] = js.native
  /**
    * The name of the human loop.
    */
  var HumanLoopName: js.UndefOr[typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.HumanLoopName] = js.native
  /**
    * The status of the human loop. Valid values:
    */
  var HumanLoopStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsAugmentedairuntimeMod.HumanLoopStatus] = js.native
}
