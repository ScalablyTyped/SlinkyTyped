package typingsSlinky.awsDashSdk.clientsDatapipelineMod
...
trait DeactivatePipelineInput extends js.Object {
  /**
    ...
    */
  var cancelActive: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatapipelineMod.cancelActive] = js.native
  /**
