...
trait TestIdentityProviderResponse extends js.Object {
  /**
    ...
    */
  var Message: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.Message] = js.native
  /**
    * The response that is returned from your API Gateway.
    */
  var Response: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.Response] = js.native
  /**
    * The HTTP status code that is the response from your API Gateway.
    */
  var StatusCode: typingsSlinky.awsDashSdk.clientsTransferMod.StatusCode = js.native
  /**
    * The endpoint of the service used to authenticate a user.
    */
  var Url: typingsSlinky.awsDashSdk.clientsTransferMod.Url = js.native
}
