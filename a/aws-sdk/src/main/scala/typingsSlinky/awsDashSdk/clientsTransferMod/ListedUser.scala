...
trait ListedUser extends js.Object {
  ...
  /**
    ...
    */
  var SshPublicKeyCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.SshPublicKeyCount] = js.native
  /**
    * The name of the user whose ARN was specified. User names are used for authentication purposes.
    */
  var UserName: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.UserName] = js.native
}
