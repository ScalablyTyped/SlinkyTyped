...
trait CreateUserRequest extends js.Object {
  /**
    ...
    */
  var HomeDirectory: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.HomeDirectory] = js.native
  /**
    ...
    */
  var HomeDirectoryMappings: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.HomeDirectoryMappings] = js.native
  /**
    ...
    */
  var HomeDirectoryType: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.HomeDirectoryType] = js.native
  /**
    ...
    */
  var Policy: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.Policy] = js.native
  /**
    ...
    */
  var Role: typingsSlinky.awsDashSdk.clientsTransferMod.Role = js.native
  /**
  ...
  /**
    ...
    */
  var SshPublicKeyBody: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.SshPublicKeyBody] = js.native
  /**
    * Key-value pairs that can be used to group and search for users. Tags are metadata attached to users for any purpose.
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsTransferMod.Tags] = js.native
  /**
    ...
    */
  var UserName: typingsSlinky.awsDashSdk.clientsTransferMod.UserName = js.native
}
