...
trait SshPublicKey extends js.Object {
  ...
  /**
    ...
    */
  var SshPublicKeyBody: typingsSlinky.awsDashSdk.clientsTransferMod.SshPublicKeyBody = js.native
  /**
    * The SshPublicKeyId parameter contains the identifier of the public key.
    */
  var SshPublicKeyId: typingsSlinky.awsDashSdk.clientsTransferMod.SshPublicKeyId = js.native
}
