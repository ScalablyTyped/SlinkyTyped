...
trait UpdateAction extends js.Object {
  ...
  /**
    ...
    */
  var ServiceUpdateSeverity: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticacheMod.ServiceUpdateSeverity] = js.native
  /**
    * The status of the service update
    */
  var ServiceUpdateStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticacheMod.ServiceUpdateStatus] = js.native
  /**
    * Reflects the nature of the service update 
    */
  var ServiceUpdateType: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticacheMod.ServiceUpdateType] = js.native
  /**
    * If yes, all nodes in the replication group have been updated by the recommended apply-by date. If no, at least one node in the replication group have not been updated by the recommended apply-by date. If N/A, the replication group was created after the recommended apply-by date.
    */
  var SlaMet: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticacheMod.SlaMet] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateActionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsElasticacheMod.UpdateActionStatus] = js.native
  /**
