...
import typingsSlinky.awsDashSdk.clientsS3Mod.Tag
...
trait ManagedUploadOptions extends js.Object {
  ...
  /**
    ...
    */
  var service: js.UndefOr[typingsSlinky.awsDashSdk.clientsS3Mod.^] = js.native
  /**
...
object ManagedUploadOptions {
  ...
  def apply(
    ...
    service: typingsSlinky.awsDashSdk.clientsS3Mod.^ = null,
