...
trait DBInstance extends js.Object {
  ...
  /**
    ...
    */
  var DBSubnetGroup: js.UndefOr[typingsSlinky.awsDashSdk.clientsDocdbMod.DBSubnetGroup] = js.native
  /**
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typingsSlinky.awsDashSdk.clientsDocdbMod.Endpoint] = js.native
  /**
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typingsSlinky.awsDashSdk.clientsDocdbMod.PendingModifiedValues] = js.native
  /**
...
object DBInstance {
  ...
  def apply(
    ...
    InstanceCreateTime: js.Date = null,
