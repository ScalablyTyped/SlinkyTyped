...
trait BackupSummary extends js.Object {
  ...
  var BackupArn: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupArn
  ] = js.native
  /**
  ...
  var BackupName: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupName
  ] = js.native
  /**
  ...
  var BackupStatus: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupStatus
  ] = js.native
  /**
  ...
  var BackupType: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupType
  ] = js.native
  /**
