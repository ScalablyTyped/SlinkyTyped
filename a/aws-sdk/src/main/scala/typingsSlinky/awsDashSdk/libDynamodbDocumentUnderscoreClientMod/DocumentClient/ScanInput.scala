...
trait ScanInput extends js.Object {
  ...
  var ConditionalOperator: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ConditionalOperator
  ] = js.native
  /**
  ...
  var ConsistentRead: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ConsistentRead
  ] = js.native
  /**
  ...
  var IndexName: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.IndexName
  ] = js.native
  /**
  ...
  var ProjectionExpression: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ProjectionExpression
  ] = js.native
  var ReturnConsumedCapacity: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ReturnConsumedCapacity
  ] = js.native
  /**
  ...
  var Select: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.Select
  ] = js.native
  /**
