...
trait CreateTableInput extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.AttributeDefinitions = js.native
  /**
  ...
  var BillingMode: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BillingMode
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var KeySchema: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.KeySchema = js.native
  /**
  ...
  var ProvisionedThroughput: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ProvisionedThroughput
  ] = js.native
  /**
    * Represents the settings used to enable server-side encryption.
    */
  var SSESpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.SSESpecification
  ] = js.native
  /**
