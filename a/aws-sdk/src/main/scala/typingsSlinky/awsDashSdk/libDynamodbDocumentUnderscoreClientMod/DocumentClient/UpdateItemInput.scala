...
trait UpdateItemInput extends js.Object {
  ...
  var AttributeUpdates: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.AttributeUpdates
  ] = js.native
  /**
  ...
  var UpdateExpression: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.UpdateExpression
  ] = js.native
}
