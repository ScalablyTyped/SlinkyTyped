...
trait SSEDescription extends js.Object {
  ...
  var KMSMasterKeyArn: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.KMSMasterKeyArn
  ] = js.native
  /**
  ...
  var SSEType: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.SSEType
  ] = js.native
  /**
