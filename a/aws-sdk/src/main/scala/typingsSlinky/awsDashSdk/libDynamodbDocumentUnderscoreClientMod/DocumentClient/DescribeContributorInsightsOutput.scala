...
trait DescribeContributorInsightsOutput extends js.Object {
  ...
  var ContributorInsightsRuleList: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ContributorInsightsRuleList
  ] = js.native
  /**
    * Current Status contributor insights.
    */
  var ContributorInsightsStatus: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ContributorInsightsStatus
  ] = js.native
  /**
    ...
    */
  var FailureException: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.FailureException
  ] = js.native
  /**
...
object DescribeContributorInsightsOutput {
  ...
  def apply(
    ...
    LastUpdateDateTime: js.Date = null,
