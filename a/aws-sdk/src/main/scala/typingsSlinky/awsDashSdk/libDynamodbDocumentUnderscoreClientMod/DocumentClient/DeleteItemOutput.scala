...
trait DeleteItemOutput extends js.Object {
  ...
  var ConsumedCapacity: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ConsumedCapacity
  ] = js.native
  /**
  ...
  var ItemCollectionMetrics: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ItemCollectionMetrics
  ] = js.native
}
