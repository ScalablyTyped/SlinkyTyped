...
trait TransactWriteItemsInput extends js.Object {
  ...
  var ClientRequestToken: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ClientRequestToken
  ] = js.native
  ...
  var ReturnItemCollectionMetrics: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ReturnItemCollectionMetrics
  ] = js.native
  /**
