package typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod

import typingsSlinky.awsDashSdk.clientsDynamodbMod.ClientConfiguration
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BatchGetItemInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BatchGetItemOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BatchWriteItemInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BatchWriteItemOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.CreateSetOptions
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.DeleteItemInput
...
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.DynamoDbSet
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.GetItemInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.GetItemOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.PutItemInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.PutItemOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.QueryInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.QueryOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ScanInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ScanOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TransactGetItemsInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TransactGetItemsOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TransactWriteItemsInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TransactWriteItemsOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.UpdateItemInput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.UpdateItemOutput
import typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.binaryType
