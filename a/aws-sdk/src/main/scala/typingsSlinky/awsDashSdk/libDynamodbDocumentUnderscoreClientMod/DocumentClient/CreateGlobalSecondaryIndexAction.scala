...
trait CreateGlobalSecondaryIndexAction extends js.Object {
  /**
    ...
    */
  var IndexName: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.IndexName = js.native
  /**
  ...
  /**
    ...
    */
  var Projection: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.Projection = js.native
  /**
