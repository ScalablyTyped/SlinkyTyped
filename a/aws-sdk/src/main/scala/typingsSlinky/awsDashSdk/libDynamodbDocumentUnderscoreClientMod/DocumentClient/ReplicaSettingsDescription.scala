...
trait ReplicaSettingsDescription extends js.Object {
  /**
    ...
    */
  var RegionName: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.RegionName = js.native
  /**
  ...
  var ReplicaStatus: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ReplicaStatus
  ] = js.native
}
