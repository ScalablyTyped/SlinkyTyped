...
trait StreamSpecification extends js.Object {
  /**
    ...
    */
  var StreamEnabled: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.StreamEnabled = js.native
  /**
  ...
  var StreamViewType: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.StreamViewType
  ] = js.native
}
