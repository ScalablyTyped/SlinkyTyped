...
trait SourceTableDetails extends js.Object {
  ...
  var ItemCount: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ItemCount
  ] = js.native
  /**
    * Schema of the table. 
    */
  ...
  /**
    ...
    */
  var ProvisionedThroughput: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ProvisionedThroughput = js.native
  /**
    * ARN of the table for which backup was created. 
    */
  var TableArn: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TableArn
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var TableId: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TableId = js.native
  /**
