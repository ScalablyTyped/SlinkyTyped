...
trait ContinuousBackupsDescription extends js.Object {
  /**
    ...
    */
  var ContinuousBackupsStatus: typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ContinuousBackupsStatus = js.native
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[
    typingsSlinky.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.PointInTimeRecoveryDescription
  ] = js.native
}
