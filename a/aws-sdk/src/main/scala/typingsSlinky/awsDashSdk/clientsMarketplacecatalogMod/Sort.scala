...
trait Sort extends js.Object {
  /**
    ...
    */
  var SortBy: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.SortBy] = js.native
  /**
    * The sorting order. Can be ASCENDING or DESCENDING. The default value is DESCENDING.
    */
  var SortOrder: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.SortOrder] = js.native
}
