package typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod
...
trait ChangeSummary extends js.Object {
  /**
    ...
    */
  var ChangeType: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.ChangeType] = js.native
  /**
    * The entity to be changed.
    */
  var Entity: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.Entity] = js.native
  /**
    * An array of ErrorDetail objects associated with the change.
    */
  var ErrorDetailList: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.ErrorDetailList] = js.native
}
