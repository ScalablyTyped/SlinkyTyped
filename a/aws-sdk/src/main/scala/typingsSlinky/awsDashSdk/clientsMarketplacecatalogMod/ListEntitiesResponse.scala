...
trait ListEntitiesResponse extends js.Object {
  /**
    ...
    */
  var EntitySummaryList: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.EntitySummaryList] = js.native
  /**
    * The value of the next token if it exists. Null if there is no more result.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacecatalogMod.NextToken] = js.native
}
