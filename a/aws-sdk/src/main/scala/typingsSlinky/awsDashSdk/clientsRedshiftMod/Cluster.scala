...
trait Cluster extends js.Object {
  ...
  /**
    ...
    */
  var ClusterSnapshotCopyStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ClusterSnapshotCopyStatus] = js.native
  /**
  ...
  /**
    * 
    */
  var DataTransferProgress: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.DataTransferProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticIpStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ElasticIpStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.Endpoint] = js.native
  /**
  ...
  /**
    ...
    */
  var HsmStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.HsmStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.PendingModifiedValues] = js.native
  /**
  ...
  /**
    ...
    */
  var ResizeInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ResizeInfo] = js.native
  /**
    * A value that describes the status of a cluster restore action. This parameter returns null if the cluster was not created by restoring a snapshot.
    */
  var RestoreStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.RestoreStatus] = js.native
  /**
