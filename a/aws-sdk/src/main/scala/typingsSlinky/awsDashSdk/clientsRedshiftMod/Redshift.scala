...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.clusterAvailable
import typingsSlinky.awsDashSdk.awsDashSdkStrings.clusterDeleted
import typingsSlinky.awsDashSdk.awsDashSdkStrings.clusterRestored
import typingsSlinky.awsDashSdk.awsDashSdkStrings.snapshotAvailable
...
trait Redshift extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_clusterAvailable(state: clusterAvailable, params: DescribeClustersMessage with Anon_Waiter): Request[ClustersMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_clusterAvailable(
    state: clusterAvailable,
    params: DescribeClustersMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ ClustersMessage, Unit]
  ): Request[ClustersMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_clusterDeleted(state: clusterDeleted, params: DescribeClustersMessage with Anon_Waiter): Request[ClustersMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_clusterDeleted(
    state: clusterDeleted,
    params: DescribeClustersMessage with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_clusterRestored(state: clusterRestored, params: DescribeClustersMessage with Anon_Waiter): Request[ClustersMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_clusterRestored(
    state: clusterRestored,
    params: DescribeClustersMessage with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_snapshotAvailable(state: snapshotAvailable, params: DescribeClusterSnapshotsMessage with Anon_Waiter): Request[SnapshotMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_snapshotAvailable(
    state: snapshotAvailable,
    params: DescribeClusterSnapshotsMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ SnapshotMessage, Unit]
  ): Request[SnapshotMessage, AWSError] = js.native
}
