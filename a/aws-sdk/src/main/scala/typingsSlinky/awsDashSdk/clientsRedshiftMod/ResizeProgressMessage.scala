...
trait ResizeProgressMessage extends js.Object {
  ...
  /**
    ...
    */
  var ImportTablesCompleted: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ImportTablesCompleted] = js.native
  /**
    * The names of tables that are being currently imported. Valid Values: List of table names.
    */
  var ImportTablesInProgress: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ImportTablesInProgress] = js.native
  /**
    * The names of tables that have not been yet imported. Valid Values: List of table names
    */
  var ImportTablesNotStarted: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.ImportTablesNotStarted] = js.native
  /**
