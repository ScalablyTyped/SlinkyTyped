...
trait EventSubscription extends js.Object {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.EventCategoriesList] = js.native
  /**
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typingsSlinky.awsDashSdk.clientsRedshiftMod.SourceIdsList] = js.native
  /**
...
object EventSubscription {
  ...
  def apply(
    ...
    Status: String = null,
    SubscriptionCreationTime: js.Date = null,
    Tags: TagList = null
  ): EventSubscription = {
