...
trait ListJobsInput extends js.Object {
  ...
  var Marker: js.UndefOr[typingsSlinky.awsDashSdk.clientsImportexportMod.Marker] = js.native
  var MaxJobs: js.UndefOr[typingsSlinky.awsDashSdk.clientsImportexportMod.MaxJobs] = js.native
}
