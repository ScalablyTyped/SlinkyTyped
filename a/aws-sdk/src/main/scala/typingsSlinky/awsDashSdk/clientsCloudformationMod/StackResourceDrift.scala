...
trait StackResourceDrift extends js.Object {
  ...
  /**
    ...
    */
  var PhysicalResourceIdContext: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.PhysicalResourceIdContext] = js.native
  /**
    * A collection of the resource properties whose actual values differ from their expected values. These will be present only for resources whose StackResourceDriftStatus is MODIFIED. 
    */
  var PropertyDifferences: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.PropertyDifferences] = js.native
  /**
