...
trait StackSummary extends js.Object {
  ...
  /**
    ...
    */
  var StackName: typingsSlinky.awsDashSdk.clientsCloudformationMod.StackName = js.native
  /**
    * The current status of the stack.
    */
  var StackStatus: typingsSlinky.awsDashSdk.clientsCloudformationMod.StackStatus = js.native
  /**
    * Success/Failure message associated with the stack status.
    */
  var StackStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.StackStatusReason] = js.native
  /**
    * The template description of the template used to create the stack.
    */
  var TemplateDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.TemplateDescription] = js.native
}
