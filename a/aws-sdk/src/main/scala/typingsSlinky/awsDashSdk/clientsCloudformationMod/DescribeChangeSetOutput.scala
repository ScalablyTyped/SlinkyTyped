...
trait DescribeChangeSetOutput extends js.Object {
  /**
    ...
    */
  var Capabilities: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Capabilities] = js.native
  /**
    * The ARN of the change set.
    */
  var ChangeSetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ChangeSetId] = js.native
  /**
    * The name of the change set.
    */
  var ChangeSetName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ChangeSetName] = js.native
  /**
    * A list of Change structures that describes the resources AWS CloudFormation changes if you execute the change set.
    */
  var Changes: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Changes] = js.native
  /**
  ...
  /**
    ...
    */
  var ExecutionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ExecutionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var NotificationARNs: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.NotificationARNs] = js.native
  /**
    * A list of Parameter structures that describes the input parameters and their values used to create the change set. For more information, see the Parameter data type.
    */
  var Parameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Parameters] = js.native
  /**
    * The rollback triggers for AWS CloudFormation to monitor during stack creation and updating operations, and for the specified monitoring period afterwards.
    */
  var RollbackConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.RollbackConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Tags] = js.native
}
