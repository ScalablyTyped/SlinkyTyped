...
trait Output extends js.Object {
  ...
  /**
    ...
    */
  var ExportName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ExportName] = js.native
  /**
    * The key associated with the output.
    */
  var OutputKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.OutputKey] = js.native
  /**
    * The value associated with the output.
    */
  var OutputValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.OutputValue] = js.native
}
