...
trait RollbackConfiguration extends js.Object {
  /**
    ...
    */
  var MonitoringTimeInMinutes: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.MonitoringTimeInMinutes] = js.native
  /**
    ...
    */
  var RollbackTriggers: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.RollbackTriggers] = js.native
}
