...
trait PropertyDifference extends js.Object {
  ...
  /**
    ...
    */
  var DifferenceType: typingsSlinky.awsDashSdk.clientsCloudformationMod.DifferenceType = js.native
  /**
  ...
  /**
    ...
    */
  var PropertyPath: typingsSlinky.awsDashSdk.clientsCloudformationMod.PropertyPath = js.native
}
