...
trait StackSetOperationResultSummary extends js.Object {
  /**
    ...
    */
  var Account: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Account] = js.native
  /**
    * The results of the account gate function AWS CloudFormation invokes, if present, before proceeding with stack set operations in an account
    */
  var AccountGateResult: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.AccountGateResult] = js.native
  /**
    * The name of the AWS region for this operation result.
    */
  var Region: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.Region] = js.native
  /**
