...
trait RecordHandlerProgressInput extends js.Object {
  ...
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var OperationStatus: typingsSlinky.awsDashSdk.clientsCloudformationMod.OperationStatus = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var ResourceModel: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ResourceModel] = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var StatusMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.StatusMessage] = js.native
}
