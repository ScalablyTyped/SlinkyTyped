...
trait ParameterDeclaration extends js.Object {
  ...
  /**
    ...
    */
  var NoEcho: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.NoEcho] = js.native
  /**
    * The criteria that AWS CloudFormation uses to validate parameter values.
    */
  var ParameterConstraints: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ParameterConstraints] = js.native
  /**
  ...
  /**
    ...
    */
  var ParameterType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ParameterType] = js.native
}
