...
trait StackEvent extends js.Object {
  ...
  /**
    ...
    */
  var EventId: typingsSlinky.awsDashSdk.clientsCloudformationMod.EventId = js.native
  /**
    * The logical name of the resource specified in the template.
    */
  var LogicalResourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.LogicalResourceId] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ResourceProperties] = js.native
  /**
    * Current status of the resource.
    */
  var ResourceStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ResourceStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.ResourceType] = js.native
  /**
    * The unique ID name of the instance of the stack.
    */
  var StackId: typingsSlinky.awsDashSdk.clientsCloudformationMod.StackId = js.native
  /**
