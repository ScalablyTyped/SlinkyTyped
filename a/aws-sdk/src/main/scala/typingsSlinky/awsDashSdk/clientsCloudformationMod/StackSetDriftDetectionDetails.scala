...
trait StackSetDriftDetectionDetails extends js.Object {
  ...
  /**
    ...
    */
  var DriftedStackInstancesCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.DriftedStackInstancesCount] = js.native
  /**
    * The number of stack instances for which the drift detection operation failed.
    */
  var FailedStackInstancesCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.FailedStackInstancesCount] = js.native
  /**
    * The number of stack instances that are currently being checked for drift.
    */
  var InProgressStackInstancesCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.InProgressStackInstancesCount] = js.native
  /**
    * The number of stack instances which match the expected template and parameter configuration of the stack set.
    */
  var InSyncStackInstancesCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.InSyncStackInstancesCount] = js.native
  /**
  ...
  /**
    ...
    */
  var TotalStackInstancesCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.TotalStackInstancesCount] = js.native
}
