...
trait StackSetOperation extends js.Object {
  ...
  /**
    ...
    */
  var StackSetDriftDetectionDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.StackSetDriftDetectionDetails] = js.native
  /**
    * The ID of the stack set.
    */
  var StackSetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudformationMod.StackSetId] = js.native
  /**
