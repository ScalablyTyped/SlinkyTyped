...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafMod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafMod.TimeWindow] = js.native
}
