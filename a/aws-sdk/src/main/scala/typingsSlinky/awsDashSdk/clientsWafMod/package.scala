...
package object clientsWafMod {
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.Country_
  ...
  type ByteMatchTargetString = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsDashSdk.awsDashSdkStrings.`2015-08-24`
