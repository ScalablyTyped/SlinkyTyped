...
trait ListLoggingConfigurationsResponse extends js.Object {
  /**
    ...
    */
  var LoggingConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafMod.LoggingConfigurations] = js.native
  /**
    ...
    */
  var NextMarker: js.UndefOr[typingsSlinky.awsDashSdk.clientsWafMod.NextMarker] = js.native
}
