...
trait DeregisterStreamConsumerInput extends js.Object {
  /**
    ...
    */
  var ConsumerARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.ConsumerARN] = js.native
  /**
    * The name that you gave to the consumer.
    */
  var ConsumerName: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.ConsumerName] = js.native
  /**
    ...
    */
  var StreamARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.StreamARN] = js.native
}
