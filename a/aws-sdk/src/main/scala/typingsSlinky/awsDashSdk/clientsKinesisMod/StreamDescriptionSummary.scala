...
trait StreamDescriptionSummary extends js.Object {
  ...
  /**
    ...
    */
  var EncryptionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.EncryptionType] = js.native
  /**
  ...
  /**
    ...
    */
  var KeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.KeyId] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamName: typingsSlinky.awsDashSdk.clientsKinesisMod.StreamName = js.native
  /**
    ...
    */
  var StreamStatus: typingsSlinky.awsDashSdk.clientsKinesisMod.StreamStatus = js.native
}
