...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.streamExists
import typingsSlinky.awsDashSdk.awsDashSdkStrings.streamNotExists
...
trait Kinesis extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_streamExists(state: streamExists, params: DescribeStreamInput with Anon_Waiter): Request[DescribeStreamOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_streamExists(
    state: streamExists,
    params: DescribeStreamInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeStreamOutput, Unit]
  ): Request[DescribeStreamOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_streamNotExists(state: streamNotExists, params: DescribeStreamInput with Anon_Waiter): Request[DescribeStreamOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_streamNotExists(
    state: streamNotExists,
    params: DescribeStreamInput with Anon_Waiter,
