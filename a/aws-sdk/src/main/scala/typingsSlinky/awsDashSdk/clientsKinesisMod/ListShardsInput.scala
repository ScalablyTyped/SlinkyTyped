...
trait ListShardsInput extends js.Object {
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.NextToken] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisMod.StreamName] = js.native
}
