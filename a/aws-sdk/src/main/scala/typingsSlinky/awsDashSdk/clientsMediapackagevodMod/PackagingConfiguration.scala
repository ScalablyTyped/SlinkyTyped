...
trait PackagingConfiguration extends js.Object {
  ...
  var CmafPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackagevodMod.CmafPackage] = js.native
  var DashPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackagevodMod.DashPackage] = js.native
  var HlsPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackagevodMod.HlsPackage] = js.native
  /**
    * The ID of the PackagingConfiguration.
    */
  var Id: js.UndefOr[__string] = js.native
  var MssPackage: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediapackagevodMod.MssPackage] = js.native
  /**
