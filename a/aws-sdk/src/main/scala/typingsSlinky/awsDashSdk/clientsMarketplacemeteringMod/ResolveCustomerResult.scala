...
trait ResolveCustomerResult extends js.Object {
  /**
    ...
    */
  var CustomerIdentifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod.CustomerIdentifier] = js.native
  /**
    * The product code is returned to confirm that the buyer is registering for your product. Subsequent BatchMeterUsage calls should be made using this product code.
    */
  var ProductCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod.ProductCode] = js.native
}
