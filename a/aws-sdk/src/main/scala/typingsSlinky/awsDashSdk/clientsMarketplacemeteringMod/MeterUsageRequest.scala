package typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod
...
trait MeterUsageRequest extends js.Object {
  ...
  /**
    ...
    */
  var ProductCode: typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod.ProductCode = js.native
  /**
  ...
  /**
    ...
    */
  var UsageDimension: typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod.UsageDimension = js.native
  /**
    * Consumption value for the hour. Defaults to 0 if not specified.
    */
  var UsageQuantity: js.UndefOr[typingsSlinky.awsDashSdk.clientsMarketplacemeteringMod.UsageQuantity] = js.native
}
