...
package object clientsIamMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.PermissionsBoundaryPolicy
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.textSlashcsv
  ...
  type BootstrapDatum = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  ...
  */
  ...
  type ReportContentType = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
