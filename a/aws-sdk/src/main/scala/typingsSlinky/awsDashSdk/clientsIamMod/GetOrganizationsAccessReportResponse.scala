...
trait GetOrganizationsAccessReportResponse extends js.Object {
  /**
    ...
    */
  var AccessDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsIamMod.AccessDetails] = js.native
  var ErrorDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsIamMod.ErrorDetails] = js.native
  /**
