...
trait GetTranscriptRequest extends js.Object {
  ...
  /**
    ...
    */
  var ContactId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.ContactId] = js.native
  /**
    * The maximum number of results to return in the page. Default: 10. 
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.MaxResults] = js.native
  /**
  ...
  /**
    ...
    */
  var ScanDirection: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.ScanDirection] = js.native
  /**
  ...
  /**
    ...
    */
  var StartPosition: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.StartPosition] = js.native
}
