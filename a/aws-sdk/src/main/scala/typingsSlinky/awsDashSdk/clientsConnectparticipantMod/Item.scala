...
trait Item extends js.Object {
  ...
  /**
    ...
    */
  var DisplayName: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.DisplayName] = js.native
  /**
    * The ID of the item.
    */
  ...
  /**
    ...
    */
  var ParticipantId: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.ParticipantId] = js.native
  /**
    * The role of the sender. For example, is it a customer, agent, or system.
    */
  var ParticipantRole: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.ParticipantRole] = js.native
  /**
