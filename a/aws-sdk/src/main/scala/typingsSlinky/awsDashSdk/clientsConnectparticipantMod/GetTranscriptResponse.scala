...
trait GetTranscriptResponse extends js.Object {
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.NextToken] = js.native
  /**
    * The list of messages in the session.
    */
  var Transcript: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.Transcript] = js.native
}
