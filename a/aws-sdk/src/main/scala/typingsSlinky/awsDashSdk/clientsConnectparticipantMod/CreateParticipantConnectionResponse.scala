...
trait CreateParticipantConnectionResponse extends js.Object {
  /**
    ...
    */
  var ConnectionCredentials: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.ConnectionCredentials] = js.native
  /**
    * Creates the participant's websocket connection.
    */
  var Websocket: js.UndefOr[typingsSlinky.awsDashSdk.clientsConnectparticipantMod.Websocket] = js.native
}
