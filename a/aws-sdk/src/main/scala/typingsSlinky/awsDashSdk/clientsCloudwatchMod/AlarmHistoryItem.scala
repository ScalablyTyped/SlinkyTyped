...
trait AlarmHistoryItem extends js.Object {
  ...
  /**
    ...
    */
  var HistoryData: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.HistoryData] = js.native
  /**
    * The type of alarm history item.
    */
  var HistoryItemType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.HistoryItemType] = js.native
  /**
    * A summary of the alarm history, in text format.
    */
  var HistorySummary: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.HistorySummary] = js.native
  /**
