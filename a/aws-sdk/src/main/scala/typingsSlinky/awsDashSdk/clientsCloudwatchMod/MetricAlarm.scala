...
trait MetricAlarm extends js.Object {
  /**
    ...
    */
  var ActionsEnabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.ActionsEnabled] = js.native
  /**
  ...
  /**
    ...
    */
  var AlarmArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.AlarmArn] = js.native
  /**
  ...
  /**
    ...
    */
  var AlarmDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.AlarmDescription] = js.native
  /**
    * The name of the alarm.
    */
  var AlarmName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.AlarmName] = js.native
  /**
    * The arithmetic operation to use when comparing the specified statistic and threshold. The specified statistic value is used as the first operand.
    */
  var ComparisonOperator: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.ComparisonOperator] = js.native
  /**
    * The number of data points that must be breaching to trigger the alarm.
    */
  var DatapointsToAlarm: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.DatapointsToAlarm] = js.native
  /**
    * The dimensions for the metric associated with the alarm.
    */
  var Dimensions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Dimensions] = js.native
  /**
    * Used only for alarms based on percentiles. If ignore, the alarm state does not change during periods with too few data points to be statistically significant. If evaluate or this parameter is not used, the alarm is always evaluated and possibly changes state no matter how many data points are available.
    */
  var EvaluateLowSampleCountPercentile: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.EvaluateLowSampleCountPercentile] = js.native
  /**
    * The number of periods over which data is compared to the specified threshold.
    */
  var EvaluationPeriods: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.EvaluationPeriods] = js.native
  /**
    * The percentile statistic for the metric associated with the alarm. Specify a value between p0.0 and p100.
    */
  var ExtendedStatistic: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.ExtendedStatistic] = js.native
  /**
  ...
  /**
    ...
    */
  var MetricName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.MetricName] = js.native
  /**
  ...
  /**
    ...
    */
  var Namespace: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Namespace] = js.native
  /**
  ...
  /**
    ...
    */
  var Period: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Period] = js.native
  /**
    * An explanation for the alarm state, in text format.
    */
  var StateReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.StateReason] = js.native
  /**
  ...
  /**
    ...
    */
  var Statistic: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Statistic] = js.native
  /**
    * The value to compare with the specified statistic.
    */
  var Threshold: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Threshold] = js.native
  /**
  ...
  /**
    ...
    */
  var TreatMissingData: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.TreatMissingData] = js.native
  /**
