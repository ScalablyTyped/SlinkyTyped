...
trait GetMetricWidgetImageInput extends js.Object {
  /**
    ...
    */
  var MetricWidget: typingsSlinky.awsDashSdk.clientsCloudwatchMod.MetricWidget = js.native
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.OutputFormat] = js.native
}
