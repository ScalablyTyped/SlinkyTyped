...
trait GetMetricStatisticsInput extends js.Object {
  ...
  /**
    ...
    */
  var ExtendedStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.ExtendedStatistics] = js.native
  /**
    * The name of the metric, with or without spaces.
    */
  var MetricName: typingsSlinky.awsDashSdk.clientsCloudwatchMod.MetricName = js.native
  /**
    * The namespace of the metric, with or without spaces.
    */
  var Namespace: typingsSlinky.awsDashSdk.clientsCloudwatchMod.Namespace = js.native
  /**
    ...
    */
  var Period: typingsSlinky.awsDashSdk.clientsCloudwatchMod.Period = js.native
  /**
  ...
  /**
    ...
    */
  var Statistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Statistics] = js.native
  /**
