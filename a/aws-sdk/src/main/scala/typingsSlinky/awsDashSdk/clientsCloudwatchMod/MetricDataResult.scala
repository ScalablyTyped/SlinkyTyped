...
trait MetricDataResult extends js.Object {
  ...
  /**
    ...
    */
  var StatusCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.StatusCode] = js.native
  /**
    * The timestamps for the data points, formatted in Unix timestamp format. The number of timestamps always matches the number of values and the value for Timestamps[x] is Values[x].
    */
  var Timestamps: js.UndefOr[typingsSlinky.awsDashSdk.clientsCloudwatchMod.Timestamps] = js.native
  /**
