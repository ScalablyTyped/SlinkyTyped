...
trait Observation extends js.Object {
  ...
  /**
    ...
    */
  var LogFilter: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.LogFilter] = js.native
  /**
    * The log group name.
    */
  var LogGroup: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.LogGroup] = js.native
  /**
    * The log text of the observation.
    */
  var LogText: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.LogText] = js.native
  /**
    * The name of the observation metric.
    */
  var MetricName: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.MetricName] = js.native
  /**
    * The namespace of the observation metric.
    */
  var MetricNamespace: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.MetricNamespace] = js.native
  /**
    * The source resource ARN of the observation.
    */
  var SourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.SourceARN] = js.native
  /**
    * The source type of the observation.
    */
  var SourceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.SourceType] = js.native
  /**
  ...
  /**
    ...
    */
  var Unit: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.Unit] = js.native
  /**
    * The value of the source observation metric.
    */
  var Value: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.Value] = js.native
}
