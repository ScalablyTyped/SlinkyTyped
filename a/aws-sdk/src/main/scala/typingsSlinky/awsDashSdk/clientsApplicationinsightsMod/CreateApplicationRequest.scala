...
trait CreateApplicationRequest extends js.Object {
  /**
    ...
    */
  var OpsCenterEnabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.OpsCenterEnabled] = js.native
  /**
    *  The SNS topic provided to Application Insights that is associated to the created opsItem. Allows you to receive notifications for updates to the opsItem. 
    */
  var OpsItemSNSTopicArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.OpsItemSNSTopicArn] = js.native
  /**
