...
trait DescribeComponentResponse extends js.Object {
  var ApplicationComponent: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.ApplicationComponent] = js.native
  /**
    * The list of resource ARNs that belong to the component.
    */
  var ResourceList: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.ResourceList] = js.native
}
