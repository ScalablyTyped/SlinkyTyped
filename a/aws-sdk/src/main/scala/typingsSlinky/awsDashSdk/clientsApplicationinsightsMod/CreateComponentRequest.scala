...
trait CreateComponentRequest extends js.Object {
  /**
    ...
    */
  var ComponentName: typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.ComponentName = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceList: typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.ResourceList = js.native
}
