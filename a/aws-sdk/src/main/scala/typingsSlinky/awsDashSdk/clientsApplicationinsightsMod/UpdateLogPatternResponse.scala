...
trait UpdateLogPatternResponse extends js.Object {
  /**
    ...
    */
  var LogPattern: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.LogPattern] = js.native
  /**
    * The name of the resource group.
    */
  var ResourceGroupName: js.UndefOr[typingsSlinky.awsDashSdk.clientsApplicationinsightsMod.ResourceGroupName] = js.native
}
