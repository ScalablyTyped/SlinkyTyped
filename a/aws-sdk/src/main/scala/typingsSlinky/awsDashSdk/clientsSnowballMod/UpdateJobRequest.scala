...
trait UpdateJobRequest extends js.Object {
  /**
    ...
    */
  var AddressId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.AddressId] = js.native
  /**
  ...
  /**
    ...
    */
  var JobId: typingsSlinky.awsDashSdk.clientsSnowballMod.JobId = js.native
  /**
  ...
  /**
    ...
    */
  var RoleARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.RoleARN] = js.native
  /**
    * The updated shipping option value of this job's ShippingDetails object.
    */
  var ShippingOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.ShippingOption] = js.native
  /**
