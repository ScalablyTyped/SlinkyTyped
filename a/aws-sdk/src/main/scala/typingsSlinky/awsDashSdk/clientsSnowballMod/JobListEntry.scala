...
trait JobListEntry extends js.Object {
  ...
  /**
    ...
    */
  var JobState: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.JobState] = js.native
  /**
    * The type of job.
    */
  var JobType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.JobType] = js.native
  /**
