...
trait CreateClusterRequest extends js.Object {
  /**
    ...
    */
  var AddressId: typingsSlinky.awsDashSdk.clientsSnowballMod.AddressId = js.native
  /**
  ...
  /**
    ...
    */
  var JobType: typingsSlinky.awsDashSdk.clientsSnowballMod.JobType = js.native
  /**
    ...
    */
  var KmsKeyARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.KmsKeyARN] = js.native
  /**
    * The Amazon Simple Notification Service (Amazon SNS) notification settings for this cluster.
    */
  var Notification: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.Notification] = js.native
  /**
  ...
  /**
    ...
    */
  var RoleARN: typingsSlinky.awsDashSdk.clientsSnowballMod.RoleARN = js.native
  /**
    ...
    */
  var ShippingOption: typingsSlinky.awsDashSdk.clientsSnowballMod.ShippingOption = js.native
  /**
    ...
    */
  var SnowballType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSnowballMod.SnowballType] = js.native
}
