...
trait HIT extends js.Object {
  ...
  /**
    ...
    */
  var HITReviewStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsMturkMod.HITReviewStatus] = js.native
  /**
    * The status of the HIT and its assignments. Valid Values are Assignable | Unassignable | Reviewable | Reviewing | Disposed. 
    */
  var HITStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsMturkMod.HITStatus] = js.native
  /**
