...
trait GetDocumentTextDetectionRequest extends js.Object {
  /**
    ...
    */
  var JobId: typingsSlinky.awsDashSdk.clientsTextractMod.JobId = js.native
  /**
    * The maximum number of results to return per paginated call. The largest value you can specify is 1,000. If you specify a value greater than 1,000, a maximum of 1,000 results is returned. The default value is 1,000.
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.MaxResults] = js.native
  /**
