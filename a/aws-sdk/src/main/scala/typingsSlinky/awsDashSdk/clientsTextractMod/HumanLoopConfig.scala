...
trait HumanLoopConfig extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsSlinky.awsDashSdk.clientsTextractMod.FlowDefinitionArn = js.native
  /**
    * The name of the human workflow used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsSlinky.awsDashSdk.clientsTextractMod.HumanLoopName = js.native
}
