...
trait Block extends js.Object {
  /**
    ...
    */
  var BlockType: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.BlockType] = js.native
  /**
  ...
  /**
    ...
    */
  var EntityTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.EntityTypes] = js.native
  /**
    * The location of the recognized text on the image. It includes an axis-aligned, coarse bounding box that surrounds the text, and a finer-grain polygon for more accurate spatial information. 
    */
  var Geometry: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.Geometry] = js.native
  /**
  ...
  /**
    ...
    */
  var SelectionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.SelectionStatus] = js.native
  /**
