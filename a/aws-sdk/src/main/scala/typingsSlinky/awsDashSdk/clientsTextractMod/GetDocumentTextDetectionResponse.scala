package typingsSlinky.awsDashSdk.clientsTextractMod
...
trait GetDocumentTextDetectionResponse extends js.Object {
  ...
  /**
    ...
    */
  var DocumentMetadata: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.DocumentMetadata] = js.native
  /**
    * The current status of the text detection job.
    */
  var JobStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.JobStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.StatusMessage] = js.native
  /**
    * A list of warnings that occurred during the text-detection operation for the document.
    */
  var Warnings: js.UndefOr[typingsSlinky.awsDashSdk.clientsTextractMod.Warnings] = js.native
}
