...
trait NotificationChannel extends js.Object {
  /**
    ...
    */
  var RoleArn: typingsSlinky.awsDashSdk.clientsTextractMod.RoleArn = js.native
  /**
    * The Amazon SNS topic that Amazon Textract posts the completion status to.
    */
  var SNSTopicArn: typingsSlinky.awsDashSdk.clientsTextractMod.SNSTopicArn = js.native
}
