...
trait CreateConnectionInput extends js.Object {
  /**
    ...
    */
  var ConnectionName: typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ConnectionName = js.native
  /**
    ...
    */
  var ProviderType: typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ProviderType = js.native
}
