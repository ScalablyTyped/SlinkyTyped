...
trait Connection extends js.Object {
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ConnectionArn] = js.native
  /**
    * The name of the connection. Connection names must be unique in an AWS user account.
    */
  var ConnectionName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ConnectionName] = js.native
  /**
    * The current status of the connection. 
    */
  var ConnectionStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ConnectionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ProviderType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarconnectionsMod.ProviderType] = js.native
}
