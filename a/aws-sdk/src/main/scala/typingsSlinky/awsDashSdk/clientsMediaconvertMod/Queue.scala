...
trait Queue extends js.Object {
  ...
  /**
    ...
    */
  var PricingPlan: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.PricingPlan] = js.native
  /**
    * The estimated number of jobs with a PROGRESSING status.
    */
  var ProgressingJobsCount: js.UndefOr[__integer] = js.native
  /**
    * Details about the pricing plan for your reserved queue. Required for reserved queues and not applicable to on-demand queues.
    */
  var ReservationPlan: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.ReservationPlan] = js.native
  /**
  ...
  /**
    ...
    */
  var SubmittedJobsCount: js.UndefOr[__integer] = js.native
  /**
    * Specifies whether this on-demand queue is system or custom. System queues are built in. You can't modify or delete system queues. You can create and modify custom queues.
    */
  var Type: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Type] = js.native
}
