...
trait ReservationPlanSettings extends js.Object {
  /**
    ...
    */
  var Commitment: typingsSlinky.awsDashSdk.clientsMediaconvertMod.Commitment = js.native
  /**
    * Specifies whether the term of your reserved queue pricing plan is automatically extended (AUTO_RENEW) or expires (EXPIRE) at the end of the term. When your term is auto renewed, you extend your commitment by 12 months from the auto renew date. You can cancel this commitment.
    */
  var RenewalType: typingsSlinky.awsDashSdk.clientsMediaconvertMod.RenewalType = js.native
  /**
