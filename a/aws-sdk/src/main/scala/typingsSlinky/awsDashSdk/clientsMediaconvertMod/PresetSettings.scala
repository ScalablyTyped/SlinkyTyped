...
trait PresetSettings extends js.Object {
  ...
  /**
    ...
    */
  var ContainerSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.ContainerSettings] = js.native
  /**
    ...
    */
  var VideoDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.VideoDescription] = js.native
}
