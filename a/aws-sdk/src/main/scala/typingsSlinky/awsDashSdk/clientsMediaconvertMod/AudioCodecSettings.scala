...
trait AudioCodecSettings extends js.Object {
  /**
    ...
    */
  var AacSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AacSettings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value AC3.
    */
  var Ac3Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Ac3Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value AIFF.
    */
  var AiffSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AiffSettings] = js.native
  /**
    * Type of Audio codec.
    */
  ...
  /**
    ...
    */
  var Eac3AtmosSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Eac3AtmosSettings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value EAC3.
    */
  var Eac3Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Eac3Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value MP2.
    */
  var Mp2Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Mp2Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value WAV.
    */
  var WavSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.WavSettings] = js.native
}
