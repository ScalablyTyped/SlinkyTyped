...
trait CaptionDestinationSettings extends js.Object {
  /**
    ...
    */
  var BurninDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.BurninDestinationSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var DvbSubDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DvbSubDestinationSettings] = js.native
  /**
    * Settings specific to embedded/ancillary caption outputs, including 608/708 Channel destination number.
    */
  var EmbeddedDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.EmbeddedDestinationSettings] = js.native
  /**
    * Settings specific to IMSC caption outputs.
    */
  var ImscDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.ImscDestinationSettings] = js.native
  /**
    * Settings for SCC caption output.
    */
  var SccDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.SccDestinationSettings] = js.native
  /**
    * Settings for Teletext caption output
    */
  var TeletextDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TeletextDestinationSettings] = js.native
  /**
    * Settings specific to TTML caption outputs, including Pass style information (TtmlStylePassthrough).
    */
  var TtmlDestinationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TtmlDestinationSettings] = js.native
}
