...
trait AudioSelector extends js.Object {
  ...
  /**
    ...
    */
  var LanguageCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.LanguageCode] = js.native
  /**
    * Specifies a time delta in milliseconds to offset the audio from the input video.
    */
  var Offset: js.UndefOr[__integerMinNegative2147483648Max2147483647] = js.native
  /**
    * Selects a specific PID from within an audio source (e.g. 257 selects PID 0x101).
    */
  var Pids: js.UndefOr[__listOf__integerMin1Max2147483647] = js.native
  /**
    ...
    */
  var ProgramSelection: js.UndefOr[__integerMin0Max8] = js.native
  /**
    * Use these settings to reorder the audio channels of one input to match those of another input. This allows you to combine the two files into a single output, one after the other.
    */
  var RemixSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.RemixSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var Tracks: js.UndefOr[__listOf__integerMin1Max2147483647] = js.native
}
