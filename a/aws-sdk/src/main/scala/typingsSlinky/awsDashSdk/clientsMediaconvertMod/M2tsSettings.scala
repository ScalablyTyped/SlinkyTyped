...
trait M2tsSettings extends js.Object {
  ...
  /**
    ...
    */
  var DvbNitSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DvbNitSettings] = js.native
  /**
    * Inserts DVB Service Description Table (NIT) at the specified table repetition interval.
    */
  var DvbSdtSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DvbSdtSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var DvbTdtSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DvbTdtSettings] = js.native
  /**
