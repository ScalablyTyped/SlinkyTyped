...
trait JobSettings extends js.Object {
  /**
    ...
    */
  var AdAvailOffset: js.UndefOr[__integerMinNegative1000Max1000] = js.native
  /**
    * Settings for ad avail blanking.  Video can be blanked or overlaid with an image, and audio muted during SCTE-35 triggered ad avails.
    */
  var AvailBlanking: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AvailBlanking] = js.native
  /**
  ...
  /**
    ...
    */
  var MotionImageInserter: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.MotionImageInserter] = js.native
  /**
    * Settings for your Nielsen configuration. If you don't do Nielsen measurement and analytics, ignore these settings. When you enable Nielsen configuration (nielsenConfiguration), MediaConvert enables PCM to ID3 tagging for all outputs in the job. To enable Nielsen configuration programmatically, include an instance of nielsenConfiguration in your JSON job specification. Even if you don't include any children of nielsenConfiguration, you still enable the setting.
    */
  var NielsenConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.NielsenConfiguration] = js.native
  /**
    ...
    */
  var OutputGroups: js.UndefOr[__listOfOutputGroup] = js.native
  /**
    * Contains settings used to acquire and adjust timecode information from inputs.
    */
  var TimecodeConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TimecodeConfig] = js.native
  /**
    ...
    */
  var TimedMetadataInsertion: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TimedMetadataInsertion] = js.native
}
