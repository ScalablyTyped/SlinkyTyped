...
trait CaptionSourceSettings extends js.Object {
  /**
    ...
    */
  var AncillarySourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AncillarySourceSettings] = js.native
  /**
    * DVB Sub Source Settings
    */
  var DvbSubSourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DvbSubSourceSettings] = js.native
  /**
    * Settings for embedded captions Source
    */
  var EmbeddedSourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.EmbeddedSourceSettings] = js.native
  /**
    ...
    */
  var FileSourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.FileSourceSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var TeletextSourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TeletextSourceSettings] = js.native
  /**
    * Settings specific to caption sources that are specified by track number. Currently, this is only IMSC captions in an IMF package. If your caption source is IMSC 1.1 in a separate xml file, use FileSourceSettings instead of TrackSourceSettings.
    */
  var TrackSourceSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.TrackSourceSettings] = js.native
}
