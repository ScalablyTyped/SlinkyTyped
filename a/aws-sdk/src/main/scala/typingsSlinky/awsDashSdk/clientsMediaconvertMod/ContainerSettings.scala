...
trait ContainerSettings extends js.Object {
  ...
  /**
    ...
    */
  var F4vSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.F4vSettings] = js.native
  /**
    ...
    */
  var M2tsSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.M2tsSettings] = js.native
  /**
    * Settings for TS segments in HLS
    */
  var M3u8Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.M3u8Settings] = js.native
  /**
    * Settings for MOV Container.
    */
  var MovSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.MovSettings] = js.native
  /**
    * Settings for MP4 container. You can create audio-only AAC outputs with this container.
    */
  var Mp4Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Mp4Settings] = js.native
  /**
    * Settings for MP4 segments in DASH
    */
  var MpdSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.MpdSettings] = js.native
}
