...
trait Job extends js.Object {
  /**
    ...
    */
  var AccelerationSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AccelerationSettings] = js.native
  /**
    ...
    */
  var AccelerationStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.AccelerationStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var BillingTagsSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.BillingTagsSource] = js.native
  /**
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[__integer] = js.native
  /**
  ...
  /**
    ...
    */
  var JobPercentComplete: js.UndefOr[__integer] = js.native
  /**
    * The job template that the job is created from, if it is created from a job template.
    */
  var JobTemplate: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputGroupDetails: js.UndefOr[__listOfOutputGroupDetail] = js.native
  /**
  ...
  /**
    ...
    */
  var RetryCount: js.UndefOr[__integer] = js.native
  /**
  ...
  /**
    ...
    */
  var SimulateReservedQueue: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.SimulateReservedQueue] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusUpdateInterval: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.StatusUpdateInterval] = js.native
  /**
    * Information about when jobs are submitted, started, and finished is specified in Unix epoch format in seconds.
    */
  var Timing: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Timing] = js.native
  /**
    * User-defined metadata that you want to associate with an MediaConvert job. You specify metadata in key/value pairs.
    */
  var UserMetadata: js.UndefOr[__mapOf__string] = js.native
}
