...
trait VideoCodecSettings extends js.Object {
  ...
  /**
    ...
    */
  var FrameCaptureSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.FrameCaptureSettings] = js.native
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value H_264.
    */
  var H264Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.H264Settings] = js.native
  /**
    * Settings for H265 codec
    */
  var H265Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.H265Settings] = js.native
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value MPEG2.
    */
  var Mpeg2Settings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.Mpeg2Settings] = js.native
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value PRORES.
    */
  var ProresSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.ProresSettings] = js.native
}
