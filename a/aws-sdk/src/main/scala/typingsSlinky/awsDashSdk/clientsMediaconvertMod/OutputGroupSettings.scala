...
trait OutputGroupSettings extends js.Object {
  /**
    ...
    */
  var CmafGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.CmafGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to DASH_ISO_GROUP_SETTINGS.
    */
  var DashIsoGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.DashIsoGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to FILE_GROUP_SETTINGS.
    */
  var FileGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.FileGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to HLS_GROUP_SETTINGS.
    */
  var HlsGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.HlsGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to MS_SMOOTH_GROUP_SETTINGS.
    */
  var MsSmoothGroupSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediaconvertMod.MsSmoothGroupSettings] = js.native
  /**
