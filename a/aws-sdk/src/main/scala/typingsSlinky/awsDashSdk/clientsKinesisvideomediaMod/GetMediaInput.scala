...
trait GetMediaInput extends js.Object {
  /**
    ...
    */
  var StartSelector: typingsSlinky.awsDashSdk.clientsKinesisvideomediaMod.StartSelector = js.native
  /**
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideomediaMod.StreamName] = js.native
}
