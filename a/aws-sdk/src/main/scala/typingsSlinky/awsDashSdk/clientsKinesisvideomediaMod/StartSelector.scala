...
trait StartSelector extends js.Object {
  ...
  /**
    ...
    */
  var ContinuationToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideomediaMod.ContinuationToken] = js.native
  /**
    ...
    */
  var StartSelectorType: typingsSlinky.awsDashSdk.clientsKinesisvideomediaMod.StartSelectorType = js.native
  /**
