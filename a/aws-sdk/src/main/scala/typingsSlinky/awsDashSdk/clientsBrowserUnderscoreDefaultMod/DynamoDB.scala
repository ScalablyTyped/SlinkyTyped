...
import typingsSlinky.awsDashSdk.clientsDynamodbMod.^
...
object DynamoDB extends js.Object {
  @js.native
  class Converter ()
    extends typingsSlinky.awsDashSdk.clientsDynamodbMod.Converter
  ...
  class DocumentClient ()
    extends typingsSlinky.awsDashSdk.clientsDynamodbMod.DocumentClient {
