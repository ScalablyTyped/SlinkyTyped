package typingsSlinky.awsDashSdk.clientsSesv2Mod
...
trait CreateConfigurationSetRequest extends js.Object {
  /**
    ...
    */
  var ConfigurationSetName: typingsSlinky.awsDashSdk.clientsSesv2Mod.ConfigurationSetName = js.native
  /**
    * An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
    */
  var DeliveryOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.DeliveryOptions] = js.native
  /**
    * An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.ReputationOptions] = js.native
  /**
    * An object that defines whether or not Amazon SES can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.SendingOptions] = js.native
  var SuppressionOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.SuppressionOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.TrackingOptions] = js.native
}
