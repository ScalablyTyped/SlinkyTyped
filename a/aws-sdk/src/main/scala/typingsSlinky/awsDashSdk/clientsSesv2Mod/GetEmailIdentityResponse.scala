...
trait GetEmailIdentityResponse extends js.Object {
  /**
    ...
    */
  var DkimAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.DkimAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var IdentityType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.IdentityType] = js.native
  /**
    * An object that contains information about the Mail-From attributes for the email identity.
    */
  var MailFromAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesv2Mod.MailFromAttributes] = js.native
  /**
