...
package object clientsSesv2Mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsDashSdk.awsDashSdkStrings.AWS_SES
  ...
  */
  ...
  type RawMessageData = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
  type RblName = String
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsDashSdk.awsDashSdkStrings.`2019-09-27`
