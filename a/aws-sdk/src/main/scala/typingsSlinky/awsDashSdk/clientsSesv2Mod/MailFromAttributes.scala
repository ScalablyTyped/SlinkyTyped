...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typingsSlinky.awsDashSdk.clientsSesv2Mod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typingsSlinky.awsDashSdk.clientsSesv2Mod.MailFromDomainStatus = js.native
}
