...
trait CreateDeliverabilityTestReportResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestStatus: typingsSlinky.awsDashSdk.clientsSesv2Mod.DeliverabilityTestStatus = js.native
  /**
    * A unique string that identifies the predictive inbox placement test.
    */
  var ReportId: typingsSlinky.awsDashSdk.clientsSesv2Mod.ReportId = js.native
}
