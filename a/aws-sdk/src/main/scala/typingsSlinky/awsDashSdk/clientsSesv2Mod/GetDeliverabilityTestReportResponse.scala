...
trait GetDeliverabilityTestReportResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestReport: typingsSlinky.awsDashSdk.clientsSesv2Mod.DeliverabilityTestReport = js.native
  /**
    * An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.
    */
  var IspPlacements: typingsSlinky.awsDashSdk.clientsSesv2Mod.IspPlacements = js.native
  /**
