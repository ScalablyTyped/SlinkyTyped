...
trait DirectoryConnectSettings extends js.Object {
  ...
  /**
    ...
    */
  var SubnetIds: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.SubnetIds = js.native
  /**
    * The identifier of the VPC in which the AD Connector is created.
    */
  var VpcId: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.VpcId = js.native
}
