...
trait DomainController extends js.Object {
  /**
    ...
    */
  var AvailabilityZone: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.AvailabilityZone] = js.native
  /**
  ...
  /**
    ...
    */
  var DomainControllerId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.DomainControllerId] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.SubnetId] = js.native
  /**
    * The identifier of the VPC that contains the domain controller.
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.VpcId] = js.native
}
...
object DomainController {
  ...
  def apply(
    ...
    StatusLastUpdatedDateTime: js.Date = null,
