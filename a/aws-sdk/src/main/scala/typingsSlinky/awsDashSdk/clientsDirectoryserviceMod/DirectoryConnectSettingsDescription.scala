...
trait DirectoryConnectSettingsDescription extends js.Object {
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.AvailabilityZones] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroupId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.SecurityGroupId] = js.native
  /**
    * A list of subnet identifiers in the VPC that the AD Connector is in.
    */
  var SubnetIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.SubnetIds] = js.native
  /**
