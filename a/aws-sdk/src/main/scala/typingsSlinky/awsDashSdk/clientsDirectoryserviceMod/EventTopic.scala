...
trait EventTopic extends js.Object {
  ...
  /**
    ...
    */
  var TopicArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TopicArn] = js.native
  /**
    * The name of an AWS SNS topic the receives status messages from the directory.
    */
  var TopicName: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TopicName] = js.native
}
