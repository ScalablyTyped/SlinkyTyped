...
trait LDAPSSettingInfo extends js.Object {
  /**
    ...
    */
  var LDAPSStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.LDAPSStatus] = js.native
  /**
    * Describes a state change for LDAPS.
    */
  var LDAPSStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.LDAPSStatusReason] = js.native
  /**
