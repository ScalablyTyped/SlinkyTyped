...
trait CreateTrustRequest extends js.Object {
  ...
  /**
    ...
    */
  var TrustDirection: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustDirection = js.native
  /**
    * The trust password. The must be the same password that was used when creating the trust relationship on the external domain.
    */
  var TrustPassword: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustPassword = js.native
  /**
