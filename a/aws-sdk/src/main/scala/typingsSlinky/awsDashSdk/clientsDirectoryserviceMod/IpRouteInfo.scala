...
trait IpRouteInfo extends js.Object {
  ...
  /**
    ...
    */
  var CidrIp: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.CidrIp] = js.native
  /**
    * Description of the IpRouteInfo.
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var IpRouteStatusMsg: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.IpRouteStatusMsg] = js.native
  /**
    * The reason for the IpRouteStatusMsg.
    */
  var IpRouteStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.IpRouteStatusReason] = js.native
}
