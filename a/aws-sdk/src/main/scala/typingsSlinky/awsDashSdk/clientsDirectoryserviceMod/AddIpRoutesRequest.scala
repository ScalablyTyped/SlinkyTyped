...
trait AddIpRoutesRequest extends js.Object {
  ...
  /**
    ...
    */
  var IpRoutes: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.IpRoutes = js.native
  /**
  ...
  var UpdateSecurityGroupForDirectoryControllers: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.UpdateSecurityGroupForDirectoryControllers
  ] = js.native
}
