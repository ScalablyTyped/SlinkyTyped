...
trait ConditionalForwarder extends js.Object {
  /**
    ...
    */
  var DnsIpAddrs: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.DnsIpAddrs] = js.native
  /**
    * The fully qualified domain name (FQDN) of the remote domains pointed to by the conditional forwarder.
    */
  var RemoteDomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.RemoteDomainName] = js.native
  /**
    * The replication scope of the conditional forwarder. The only allowed value is Domain, which will replicate the conditional forwarder to all of the domain controllers for your AWS directory.
    */
  var ReplicationScope: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.ReplicationScope] = js.native
}
