...
trait RadiusSettings extends js.Object {
  ...
  /**
    ...
    */
  var RadiusRetries: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.RadiusRetries] = js.native
  /**
  ...
  /**
    ...
    */
  var RadiusTimeout: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.RadiusTimeout] = js.native
  /**
  ...
  /**
    * Not currently used.
    */
  var UseSameUsername: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.UseSameUsername] = js.native
}
