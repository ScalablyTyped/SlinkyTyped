...
trait UpdateTrustResult extends js.Object {
  var RequestId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.RequestId] = js.native
  /**
    * Identifier of the trust relationship.
    */
  var TrustId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustId] = js.native
}
