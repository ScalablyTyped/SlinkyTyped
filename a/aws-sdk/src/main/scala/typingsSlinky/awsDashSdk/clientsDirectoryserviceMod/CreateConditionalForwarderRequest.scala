...
trait CreateConditionalForwarderRequest extends js.Object {
  ...
  /**
    ...
    */
  var DnsIpAddrs: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.DnsIpAddrs = js.native
  /**
    * The fully qualified domain name (FQDN) of the remote domain with which you will set up a trust relationship.
    */
  var RemoteDomainName: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.RemoteDomainName = js.native
}
