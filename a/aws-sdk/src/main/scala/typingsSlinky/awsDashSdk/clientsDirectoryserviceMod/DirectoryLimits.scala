...
trait DirectoryLimits extends js.Object {
  ...
  /**
    ...
    */
  var CloudOnlyDirectoriesLimitReached: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.CloudOnlyDirectoriesLimitReached
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var ConnectedDirectoriesLimitReached: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.ConnectedDirectoriesLimitReached
  ] = js.native
}
