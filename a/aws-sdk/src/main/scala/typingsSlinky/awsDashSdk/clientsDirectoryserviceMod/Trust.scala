...
trait Trust extends js.Object {
  ...
  /**
    ...
    */
  var TrustDirection: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustDirection] = js.native
  /**
  ...
  /**
    ...
    */
  var TrustState: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustState] = js.native
  /**
    * The reason for the TrustState.
    */
  var TrustStateReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustStateReason] = js.native
  /**
    * The trust relationship type. Forest is the default.
    */
  var TrustType: js.UndefOr[typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.TrustType] = js.native
}
