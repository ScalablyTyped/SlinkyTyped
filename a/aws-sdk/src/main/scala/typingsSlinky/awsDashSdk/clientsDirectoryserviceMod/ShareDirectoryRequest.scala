...
trait ShareDirectoryRequest extends js.Object {
  ...
  /**
    ...
    */
  var ShareMethod: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.ShareMethod = js.native
  /**
  ...
  /**
    ...
    */
  var ShareTarget: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.ShareTarget = js.native
}
