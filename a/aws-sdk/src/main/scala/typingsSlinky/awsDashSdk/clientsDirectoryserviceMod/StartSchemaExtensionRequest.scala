...
trait StartSchemaExtensionRequest extends js.Object {
  /**
    ...
    */
  var CreateSnapshotBeforeSchemaExtension: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.CreateSnapshotBeforeSchemaExtension = js.native
  /**
    * A description of the schema extension.
    */
  var Description: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.Description = js.native
  /**
  ...
  /**
    ...
    */
  var LdifContent: typingsSlinky.awsDashSdk.clientsDirectoryserviceMod.LdifContent = js.native
}
