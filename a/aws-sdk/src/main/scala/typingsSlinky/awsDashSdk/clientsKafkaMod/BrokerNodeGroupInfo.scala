...
trait BrokerNodeGroupInfo extends js.Object {
  /**
    ...
    */
  var BrokerAZDistribution: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.BrokerAZDistribution] = js.native
  /**
    * 
  ...
  /**
    ...
    */
  var StorageInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.StorageInfo] = js.native
}
