...
trait Prometheus extends js.Object {
  /**
    ...
    */
  var JmxExporter: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.JmxExporter] = js.native
  /**
    * 
    Indicates whether you want to enable or disable the Node Exporter.
    
    */
  var NodeExporter: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.NodeExporter] = js.native
}
