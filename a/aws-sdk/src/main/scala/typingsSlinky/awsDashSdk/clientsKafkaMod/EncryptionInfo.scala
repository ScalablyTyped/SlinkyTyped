...
trait EncryptionInfo extends js.Object {
  /**
    ...
    */
  var EncryptionAtRest: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.EncryptionAtRest] = js.native
  /**
    * 
    The details for encryption in transit.
    
    */
  var EncryptionInTransit: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.EncryptionInTransit] = js.native
}
