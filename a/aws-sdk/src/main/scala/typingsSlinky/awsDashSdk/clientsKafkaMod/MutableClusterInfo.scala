...
trait MutableClusterInfo extends js.Object {
  ...
  /**
    ...
    */
  var ConfigurationInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.ConfigurationInfo] = js.native
  /**
    * 
    Specifies which Apache Kafka metrics Amazon MSK gathers and sends to Amazon CloudWatch for this cluster.
    
    */
  var EnhancedMonitoring: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.EnhancedMonitoring] = js.native
  /**
    * 
  ...
  /**
    ...
    */
  var OpenMonitoring: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.OpenMonitoring] = js.native
}
