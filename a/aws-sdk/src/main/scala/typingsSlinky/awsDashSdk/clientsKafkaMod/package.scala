...
package object clientsKafkaMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.BROKER
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.DEFAULT
  ...
  */
  ...
  type __blob = Buffer | scala.scalajs.js.typedarray.Uint8Array | Blob | String
