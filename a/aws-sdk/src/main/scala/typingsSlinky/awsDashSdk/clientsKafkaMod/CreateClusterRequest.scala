...
trait CreateClusterRequest extends js.Object {
  /**
    ...
    */
  var BrokerNodeGroupInfo: typingsSlinky.awsDashSdk.clientsKafkaMod.BrokerNodeGroupInfo = js.native
  /**
    * 
    Includes all client authentication related information.
    
    */
  var ClientAuthentication: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.ClientAuthentication] = js.native
  /**
    * 
  ...
  /**
    ...
    */
  var EncryptionInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.EncryptionInfo] = js.native
  /**
    * 
