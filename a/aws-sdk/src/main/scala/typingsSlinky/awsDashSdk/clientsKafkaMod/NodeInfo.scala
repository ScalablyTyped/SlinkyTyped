...
trait NodeInfo extends js.Object {
  ...
  /**
    ...
    */
  var BrokerNodeInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.BrokerNodeInfo] = js.native
  /**
    * 
    The instance type.
  ...
  /**
    ...
    */
  var NodeType: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.NodeType] = js.native
  /**
    * 
    The ZookeeperNodeInfo.
    
    */
  var ZookeeperNodeInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsKafkaMod.ZookeeperNodeInfo] = js.native
}
