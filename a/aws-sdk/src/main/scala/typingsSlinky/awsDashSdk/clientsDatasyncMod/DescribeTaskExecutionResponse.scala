...
trait DescribeTaskExecutionResponse extends js.Object {
  ...
  var Options: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.Options] = js.native
  /**
  ...
  /**
    ...
    */
  var TaskExecutionArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.TaskExecutionArn] = js.native
}
