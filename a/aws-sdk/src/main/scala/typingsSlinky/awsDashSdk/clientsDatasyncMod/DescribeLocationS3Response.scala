...
trait DescribeLocationS3Response extends js.Object {
  ...
  /**
    ...
    */
  var LocationArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.LocationArn] = js.native
  /**
    * The URL of the Amazon S3 location that was described.
    */
  var LocationUri: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.LocationUri] = js.native
  var S3Config: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.S3Config] = js.native
  /**
    ...
    */
  var S3StorageClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.S3StorageClass] = js.native
}
