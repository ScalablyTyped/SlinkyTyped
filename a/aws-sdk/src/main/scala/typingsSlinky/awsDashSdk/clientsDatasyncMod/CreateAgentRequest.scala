...
trait CreateAgentRequest extends js.Object {
  /**
    ...
    */
  var ActivationKey: typingsSlinky.awsDashSdk.clientsDatasyncMod.ActivationKey = js.native
  /**
  ...
  /**
    ...
    */
  var VpcEndpointId: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.VpcEndpointId] = js.native
}
