...
trait CreateLocationEfsRequest extends js.Object {
  /**
    ...
    */
  var Ec2Config: typingsSlinky.awsDashSdk.clientsDatasyncMod.Ec2Config = js.native
  /**
    * The Amazon Resource Name (ARN) for the Amazon EFS file system.
    */
  var EfsFilesystemArn: typingsSlinky.awsDashSdk.clientsDatasyncMod.EfsFilesystemArn = js.native
  /**
