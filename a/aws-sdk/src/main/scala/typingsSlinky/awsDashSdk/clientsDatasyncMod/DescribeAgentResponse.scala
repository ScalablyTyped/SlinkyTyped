...
trait DescribeAgentResponse extends js.Object {
  ...
  /**
    ...
    */
  var EndpointType: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.EndpointType] = js.native
  /**
  ...
  /**
    ...
    */
  var PrivateLinkConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.PrivateLinkConfig] = js.native
  /**
