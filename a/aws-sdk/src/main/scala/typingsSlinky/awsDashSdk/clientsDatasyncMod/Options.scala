...
trait Options extends js.Object {
  /**
    ...
    */
  var Atime: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.Atime] = js.native
  /**
    * A value that limits the bandwidth used by AWS DataSync. For example, if you want AWS DataSync to use a maximum of 1 MB, set this value to 1048576 (=1024*1024).
    */
  var BytesPerSecond: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.BytesPerSecond] = js.native
  /**
    ...
    */
  var Gid: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.Gid] = js.native
  /**
    ...
    */
  var Mtime: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.Mtime] = js.native
  /**
    ...
    */
  var OverwriteMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.OverwriteMode] = js.native
  /**
    ...
    */
  var PosixPermissions: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.PosixPermissions] = js.native
  /**
    ...
    */
  var PreserveDeletedFiles: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.PreserveDeletedFiles] = js.native
  /**
    ...
    */
  var PreserveDevices: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.PreserveDevices] = js.native
  /**
    ...
    */
  var TaskQueueing: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.TaskQueueing] = js.native
  /**
    ...
    */
  var Uid: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.Uid] = js.native
  /**
    ...
    */
  var VerifyMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsDatasyncMod.VerifyMode] = js.native
}
