...
trait Schedule extends js.Object {
  /**
    ...
    */
  var CopyTags: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.CopyTags] = js.native
  /**
    * The creation rule.
    */
  var CreateRule: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.CreateRule] = js.native
  /**
    * The rule for cross-Region snapshot copies.
    */
  var CrossRegionCopyRules: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.CrossRegionCopyRules] = js.native
  /**
    * The rule for enabling fast snapshot restore.
    */
  var FastRestoreRule: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.FastRestoreRule] = js.native
  /**
  ...
  /**
    * The retention rule.
    */
  var RetainRule: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.RetainRule] = js.native
  /**
