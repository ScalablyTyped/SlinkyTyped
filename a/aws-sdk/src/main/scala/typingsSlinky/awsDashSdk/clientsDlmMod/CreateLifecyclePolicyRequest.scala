...
trait CreateLifecyclePolicyRequest extends js.Object {
  ...
  /**
    ...
    */
  var ExecutionRoleArn: typingsSlinky.awsDashSdk.clientsDlmMod.ExecutionRoleArn = js.native
  /**
    * The configuration details of the lifecycle policy.
    */
  var PolicyDetails: typingsSlinky.awsDashSdk.clientsDlmMod.PolicyDetails = js.native
  /**
