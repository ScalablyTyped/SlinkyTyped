...
trait CrossRegionCopyRule extends js.Object {
  /**
    ...
    */
  var CmkArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.CmkArn] = js.native
  /**
  ...
  /**
    ...
    */
  var Encrypted: typingsSlinky.awsDashSdk.clientsDlmMod.Encrypted = js.native
  /**
    * The retention rule.
    */
  ...
  /**
    * The target Region.
    */
  var TargetRegion: typingsSlinky.awsDashSdk.clientsDlmMod.TargetRegion = js.native
}
