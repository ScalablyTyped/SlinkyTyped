...
trait UpdateLifecyclePolicyRequest extends js.Object {
  ...
  /**
    ...
    */
  var ExecutionRoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.ExecutionRoleArn] = js.native
  /**
    * The configuration of the lifecycle policy. You cannot update the policy type or the resource type.
    */
  var PolicyDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsDlmMod.PolicyDetails] = js.native
  /**
    * The identifier of the lifecycle policy.
    */
  var PolicyId: typingsSlinky.awsDashSdk.clientsDlmMod.PolicyId = js.native
  /**
