...
trait DescribeProductAsAdminOutput extends js.Object {
  /**
    ...
    */
  var Budgets: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Budgets] = js.native
  /**
    * Information about the product view.
    */
  var ProductViewDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProductViewDetail] = js.native
  /**
    * Information about the provisioning artifacts (also known as versions) for the specified product.
    */
  var ProvisioningArtifactSummaries: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningArtifactSummaries] = js.native
  /**
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Tags] = js.native
}
