...
trait StackInstance extends js.Object {
  ...
  /**
    ...
    */
  var Region: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Region] = js.native
  /**
    ...
    */
  var StackInstanceStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackInstanceStatus] = js.native
}
