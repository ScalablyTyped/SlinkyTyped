...
trait RecordDetail extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisionedProductName] = js.native
  /**
    * The type of provisioned product. The supported values are CFN_STACK and CFN_STACKSET.
    */
  var ProvisionedProductType: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisionedProductType] = js.native
  /**
  ...
  /**
    ...
    */
  var RecordErrors: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.RecordErrors] = js.native
  /**
  ...
  /**
    * One or more tags.
    */
  var RecordTags: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.RecordTags] = js.native
  /**
    * The record type.    PROVISION_PRODUCT     UPDATE_PROVISIONED_PRODUCT     TERMINATE_PROVISIONED_PRODUCT   
    */
  var RecordType: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.RecordType] = js.native
  /**
