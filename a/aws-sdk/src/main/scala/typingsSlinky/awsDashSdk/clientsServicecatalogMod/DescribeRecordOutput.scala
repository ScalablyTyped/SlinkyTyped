...
trait DescribeRecordOutput extends js.Object {
  ...
  /**
    ...
    */
  var RecordDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.RecordDetail] = js.native
  /**
    * Information about the product created as the result of a request. For example, the output for a CloudFormation-backed product that creates an S3 bucket would include the S3 bucket URL.
    */
  var RecordOutputs: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.RecordOutputs] = js.native
}
