...
trait UpdateProvisioningPreferences extends js.Object {
  /**
    ...
    */
  var StackSetAccounts: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetAccounts] = js.native
  /**
    ...
    */
  var StackSetFailureToleranceCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetFailureToleranceCount] = js.native
  /**
  ...
  var StackSetFailureTolerancePercentage: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetFailureTolerancePercentage
  ] = js.native
  /**
    ...
    */
  var StackSetMaxConcurrencyCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetMaxConcurrencyCount] = js.native
  /**
    ...
    */
  var StackSetMaxConcurrencyPercentage: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetMaxConcurrencyPercentage
  ] = js.native
  /**
    ...
    */
  var StackSetOperationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetOperationType] = js.native
  /**
    ...
    */
  var StackSetRegions: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StackSetRegions] = js.native
}
