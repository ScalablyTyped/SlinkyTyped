...
trait ResourceChange extends js.Object {
  ...
  /**
    ...
    */
  var LogicalResourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.LogicalResourceId] = js.native
  /**
    * The ID of the resource, if it was already created.
    */
  var PhysicalResourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.PhysicalResourceId] = js.native
  /**
    * If the change type is Modify, indicates whether the existing resource is deleted and replaced with a new one.
    */
  var Replacement: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Replacement] = js.native
  /**
  ...
  /**
    * The change scope.
    */
  var Scope: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Scope] = js.native
}
