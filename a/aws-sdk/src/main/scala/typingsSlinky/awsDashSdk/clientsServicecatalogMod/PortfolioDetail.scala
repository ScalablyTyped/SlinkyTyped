...
trait PortfolioDetail extends js.Object {
  ...
  /**
    ...
    */
  var Id: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Id] = js.native
  /**
    * The name of the portfolio provider.
    */
  var ProviderName: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProviderName] = js.native
}
