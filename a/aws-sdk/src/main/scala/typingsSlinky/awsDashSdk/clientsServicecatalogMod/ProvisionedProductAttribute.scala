...
trait ProvisionedProductAttribute extends js.Object {
  ...
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.IdempotencyToken] = js.native
  /**
  ...
  /**
    ...
    */
  var PhysicalId: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.PhysicalId] = js.native
  /**
  ...
  /**
    ...
    */
  var UserArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.UserArn] = js.native
  /**
    * The ARN of the IAM user in the session. This ARN might contain a session ID.
    */
  var UserArnSession: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.UserArnSession] = js.native
}
