...
trait CreateProductInput extends js.Object {
  ...
  /**
    ...
    */
  var IdempotencyToken: typingsSlinky.awsDashSdk.clientsServicecatalogMod.IdempotencyToken = js.native
  /**
  ...
  /**
    * The type of product.
    */
  var ProductType: typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProductType = js.native
  /**
  ...
  /**
    ...
    */
  var SupportDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.SupportDescription] = js.native
  /**
    * The contact email for product support.
    */
  var SupportEmail: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.SupportEmail] = js.native
  /**
    * The contact URL for product support.
    */
  var SupportUrl: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.SupportUrl] = js.native
  /**
    * One or more tags.
    */
