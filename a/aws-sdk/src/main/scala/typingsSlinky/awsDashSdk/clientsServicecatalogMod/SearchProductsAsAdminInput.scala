...
trait SearchProductsAsAdminInput extends js.Object {
  ...
  /**
    ...
    */
  var PageSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.PageSize] = js.native
  /**
    * The page token for the next set of results. To retrieve the first set of results, use null.
    */
  var PageToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.PageToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ProductSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProductSource] = js.native
  /**
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.SortOrder] = js.native
}
