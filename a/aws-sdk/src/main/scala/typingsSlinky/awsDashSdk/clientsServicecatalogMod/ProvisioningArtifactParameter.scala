...
trait ProvisioningArtifactParameter extends js.Object {
  /**
    * The default value.
    */
  var DefaultValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.DefaultValue] = js.native
  /**
    * The description of the parameter.
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var ParameterConstraints: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ParameterConstraints] = js.native
  /**
    * The parameter key.
    */
  var ParameterKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ParameterKey] = js.native
  /**
    * The parameter type.
    */
  var ParameterType: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ParameterType] = js.native
}
