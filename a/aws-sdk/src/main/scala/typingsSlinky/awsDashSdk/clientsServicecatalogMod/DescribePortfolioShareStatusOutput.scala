...
trait DescribePortfolioShareStatusOutput extends js.Object {
  /**
    ...
    */
  var OrganizationNodeValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.OrganizationNodeValue] = js.native
  /**
  ...
  /**
    ...
    */
  var ShareDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ShareDetails] = js.native
  /**
