...
trait RecordOutput extends js.Object {
  ...
  /**
    * The output key.
    */
  var OutputKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.OutputKey] = js.native
  /**
    * The output value.
    */
  var OutputValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.OutputValue] = js.native
}
