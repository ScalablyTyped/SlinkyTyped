...
trait DescribeProvisionedProductOutput extends js.Object {
  /**
    ...
    */
  var CloudWatchDashboards: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.CloudWatchDashboards] = js.native
  /**
    * Information about the provisioned product.
    */
  var ProvisionedProductDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisionedProductDetail] = js.native
}
