...
trait DescribeProvisioningParametersOutput extends js.Object {
  /**
    ...
    */
  var ConstraintSummaries: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ConstraintSummaries] = js.native
  /**
    * Information about the parameters used to provision the product.
    */
  var ProvisioningArtifactParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningArtifactParameters] = js.native
  /**
    * An object that contains information about preferences, such as regions and accounts, for the provisioning artifact.
    */
  var ProvisioningArtifactPreferences: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningArtifactPreferences
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var UsageInstructions: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.UsageInstructions] = js.native
}
