...
trait ProvisionProductInput extends js.Object {
  ...
  /**
    ...
    */
  var NotificationArns: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.NotificationArns] = js.native
  /**
  ...
  /**
    ...
    */
  var ProvisionedProductName: typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisionedProductName = js.native
  /**
  ...
  /**
    ...
    */
  var ProvisioningParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningParameters] = js.native
  /**
    * An object that contains information about the provisioning preferences for a stack set.
    */
  var ProvisioningPreferences: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningPreferences] = js.native
  /**
    * One or more tags.
    */
