...
trait DescribeCopyProductStatusOutput extends js.Object {
  /**
    ...
    */
  var CopyProductStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.CopyProductStatus] = js.native
  /**
    * The status message.
    */
  var StatusDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.StatusDetail] = js.native
  /**
