...
trait ShareDetails extends js.Object {
  /**
    * List of errors.
    */
  var ShareErrors: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ShareErrors] = js.native
  /**
    * List of accounts for whom the operation succeeded.
    */
  var SuccessfulShares: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.SuccessfulShares] = js.native
}
