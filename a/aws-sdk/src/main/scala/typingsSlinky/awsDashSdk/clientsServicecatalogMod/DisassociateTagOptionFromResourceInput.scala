...
trait DisassociateTagOptionFromResourceInput extends js.Object {
  /**
    ...
    */
  var ResourceId: typingsSlinky.awsDashSdk.clientsServicecatalogMod.ResourceId = js.native
  /**
    * The TagOption identifier.
    */
  var TagOptionId: typingsSlinky.awsDashSdk.clientsServicecatalogMod.TagOptionId = js.native
}
