...
trait DescribeProvisionedProductPlanOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductPlanDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisionedProductPlanDetails] = js.native
  /**
    * Information about the resource changes that will occur when the plan is executed.
    */
  var ResourceChanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ResourceChanges] = js.native
}
