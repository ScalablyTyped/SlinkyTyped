...
trait DescribeProductOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProductViewSummary: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProductViewSummary] = js.native
  /**
    * Information about the provisioning artifacts for the specified product.
    */
  var ProvisioningArtifacts: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.ProvisioningArtifacts] = js.native
}
