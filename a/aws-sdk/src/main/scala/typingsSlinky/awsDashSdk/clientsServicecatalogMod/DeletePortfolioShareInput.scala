...
trait DeletePortfolioShareInput extends js.Object {
  ...
  /**
    * The AWS account ID.
    */
  var AccountId: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.AccountId] = js.native
  /**
    * The organization node to whom you are going to stop sharing.
    */
  var OrganizationNode: js.UndefOr[typingsSlinky.awsDashSdk.clientsServicecatalogMod.OrganizationNode] = js.native
  /**
