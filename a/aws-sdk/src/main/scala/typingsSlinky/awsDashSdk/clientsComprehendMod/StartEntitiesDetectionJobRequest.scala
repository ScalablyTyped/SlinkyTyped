...
trait StartEntitiesDetectionJobRequest extends js.Object {
  ...
  /**
    ...
    */
  var EntityRecognizerArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendMod.EntityRecognizerArn] = js.native
  /**
    * Specifies the format and location of the input data for the job.
    */
  var InputDataConfig: typingsSlinky.awsDashSdk.clientsComprehendMod.InputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageCode: typingsSlinky.awsDashSdk.clientsComprehendMod.LanguageCode = js.native
  /**
    * Specifies where to send the output files.
    */
  var OutputDataConfig: typingsSlinky.awsDashSdk.clientsComprehendMod.OutputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var VpcConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendMod.VpcConfig] = js.native
}
