...
trait InputDataConfig extends js.Object {
  /**
    ...
    */
  var InputFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendMod.InputFormat] = js.native
  /**
    ...
    */
  var S3Uri: typingsSlinky.awsDashSdk.clientsComprehendMod.S3Uri = js.native
}
