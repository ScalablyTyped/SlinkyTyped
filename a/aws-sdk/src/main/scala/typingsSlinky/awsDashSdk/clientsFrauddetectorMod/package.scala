...
package object clientsFrauddetectorMod {
  ...
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.DETECTORPL
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.ONLINE_FRAUD_INSIGHTS
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.SAGEMAKER
