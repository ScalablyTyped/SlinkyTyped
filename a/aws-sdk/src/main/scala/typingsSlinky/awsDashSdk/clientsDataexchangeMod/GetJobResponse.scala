...
trait GetJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var State: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.State] = js.native
  /**
    * The job type.
    */
  var Type: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Type] = js.native
  /**
