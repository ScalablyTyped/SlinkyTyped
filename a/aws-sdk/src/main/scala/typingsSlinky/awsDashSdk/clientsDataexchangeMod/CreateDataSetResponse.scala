...
trait CreateDataSetResponse extends js.Object {
  /**
    ...
    */
  var Arn: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Arn] = js.native
  /**
    * The type of file your data is stored in. Currently, the supported asset type is S3_SNAPSHOT.
    */
  var AssetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.AssetType] = js.native
  /**
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Description] = js.native
  /**
    * The unique identifier for the data set.
    */
  var Id: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Id] = js.native
  /**
    * The name of the data set.
    */
  var Name: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Name] = js.native
  /**
    * A property that defines the data set as OWNED by the account (for providers) or ENTITLED to the account (for subscribers).
    */
  var Origin: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Origin] = js.native
  /**
