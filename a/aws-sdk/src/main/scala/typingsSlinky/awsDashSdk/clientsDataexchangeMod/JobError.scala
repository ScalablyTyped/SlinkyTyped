...
trait JobError extends js.Object {
  /**
    ...
    */
  var Code: typingsSlinky.awsDashSdk.clientsDataexchangeMod.Code = js.native
  var Details: js.UndefOr[typingsSlinky.awsDashSdk.clientsDataexchangeMod.Details] = js.native
  /**
