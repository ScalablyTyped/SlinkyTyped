...
trait AddPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsSlinky.awsDashSdk.clientsLambdaMod.Action = js.native
  /**
    * For Alexa Smart Home functions, a token that must be supplied by the invoker.
    */
  var EventSourceToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.EventSourceToken] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsSlinky.awsDashSdk.clientsLambdaMod.Principal = js.native
  /**
