...
trait InvocationRequest extends js.Object {
  ...
  /**
    ...
    */
  var InvocationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.InvocationType] = js.native
  /**
    * Set to Tail to include the execution log in the response.
    */
  var LogType: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LogType] = js.native
  /**
