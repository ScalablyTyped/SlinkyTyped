...
trait UpdateFunctionCodeRequest extends js.Object {
  ...
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.S3Bucket] = js.native
  /**
    * The Amazon S3 key of the deployment package.
    */
  var S3Key: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.S3Key] = js.native
  /**
    * For versioned objects, the version of the deployment package object to use.
    */
  var S3ObjectVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.S3ObjectVersion] = js.native
  /**
