package typingsSlinky.awsDashSdk.clientsLambdaMod
...
trait FunctionConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var DeadLetterConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.DeadLetterConfig] = js.native
  /**
    * The function's description.
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var Handler: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Handler] = js.native
  /**
    * The KMS key that's used to encrypt the function's environment variables. This key is only returned if you've configured a customer managed CMK.
    */
  var KMSKeyArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.KMSKeyArn] = js.native
  /**
  ...
  /**
    ...
    */
  var LastUpdateStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LastUpdateStatus] = js.native
  /**
    * The reason for the last update that was performed on the function.
    */
  var LastUpdateStatusReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LastUpdateStatusReason] = js.native
  /**
    * The reason code for the last update that was performed on the function.
    */
  var LastUpdateStatusReasonCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LastUpdateStatusReasonCode] = js.native
  /**
  ...
  /**
    ...
    */
  var MemorySize: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.MemorySize] = js.native
  /**
  ...
  /**
    ...
    */
  var Runtime: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Runtime] = js.native
  /**
    * The current state of the function. When the state is Inactive, you can reactivate the function by invoking it.
    */
  var State: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.State] = js.native
  /**
    * The reason for the function's current state.
    */
  var StateReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.StateReason] = js.native
  /**
    * The reason code for the function's current state. When the code is Creating, you can't invoke or modify the function.
    */
  var StateReasonCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.StateReasonCode] = js.native
  /**
    * The amount of time that Lambda allows a function to run before stopping it.
    */
  var Timeout: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Timeout] = js.native
  /**
  ...
  /**
    ...
    */
  var Version: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Version] = js.native
  /**
