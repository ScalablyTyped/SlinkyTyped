...
trait LayersListItem extends js.Object {
  ...
  /**
    ...
    */
  var LayerArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LayerArn] = js.native
  /**
    * The name of the layer.
    */
  var LayerName: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LayerName] = js.native
}
