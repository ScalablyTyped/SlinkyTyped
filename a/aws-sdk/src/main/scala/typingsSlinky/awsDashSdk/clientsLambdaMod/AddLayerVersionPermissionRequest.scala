...
trait AddLayerVersionPermissionRequest extends js.Object {
  ...
  /**
    ...
    */
  var LayerName: typingsSlinky.awsDashSdk.clientsLambdaMod.LayerName = js.native
  /**
    * With the principal set to *, grant permission to all accounts in the specified organization.
    */
  var OrganizationId: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.OrganizationId] = js.native
  /**
  ...
  /**
    ...
    */
  var StatementId: typingsSlinky.awsDashSdk.clientsLambdaMod.StatementId = js.native
  /**
    * The version number.
    */
