...
trait DestinationConfig extends js.Object {
  /**
    ...
    */
  var OnFailure: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.OnFailure] = js.native
  /**
    * The destination configuration for successful invocations.
    */
  var OnSuccess: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.OnSuccess] = js.native
}
