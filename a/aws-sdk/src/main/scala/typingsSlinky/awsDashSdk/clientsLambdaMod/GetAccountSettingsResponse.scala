...
trait GetAccountSettingsResponse extends js.Object {
  /**
    ...
    */
  var AccountLimit: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.AccountLimit] = js.native
  /**
    * The number of functions and amount of storage in use.
    */
  var AccountUsage: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.AccountUsage] = js.native
}
