...
trait UpdateFunctionEventInvokeConfigRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaximumEventAgeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.MaximumEventAgeInSeconds] = js.native
  /**
    * The maximum number of times to retry when the function returns an error.
    */
  var MaximumRetryAttempts: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.MaximumRetryAttempts] = js.native
  /**
    * A version number or alias name.
    */
  var Qualifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Qualifier] = js.native
}
