...
trait GetLayerVersionResponse extends js.Object {
  /**
    ...
    */
  var CompatibleRuntimes: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.CompatibleRuntimes] = js.native
  /**
  ...
  /**
    ...
    */
  var LayerVersionArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LayerVersionArn] = js.native
  /**
    * The layer's software license.
    */
  var LicenseInfo: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.LicenseInfo] = js.native
  /**
    * The version number.
    */
