...
trait CreateEventSourceMappingRequest extends js.Object {
  /**
    ...
    */
  var BatchSize: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.BatchSize] = js.native
  /**
    * (Streams) If the function returns an error, split the batch in two and retry.
    */
  var BisectBatchOnFunctionError: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.BisectBatchOnFunctionError] = js.native
  /**
    * (Streams) An Amazon SQS queue or Amazon SNS topic destination for discarded records.
    */
  var DestinationConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.DestinationConfig] = js.native
  /**
    * Disables the event source mapping to pause polling and invocation.
    */
  var Enabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.Enabled] = js.native
  /**
  ...
  /**
    ...
    */
  var FunctionName: typingsSlinky.awsDashSdk.clientsLambdaMod.FunctionName = js.native
  /**
    * The maximum amount of time to gather records before invoking the function, in seconds.
    */
  var MaximumBatchingWindowInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.MaximumBatchingWindowInSeconds] = js.native
  /**
    * (Streams) The maximum age of a record that Lambda sends to a function for processing.
    */
  var MaximumRecordAgeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.MaximumRecordAgeInSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var ParallelizationFactor: js.UndefOr[typingsSlinky.awsDashSdk.clientsLambdaMod.ParallelizationFactor] = js.native
  /**
...
object CreateEventSourceMappingRequest {
  ...
  def apply(
    ...
    StartingPositionTimestamp: js.Date = null
