...
package object clientsFsxMod {
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.EXPORT_TO_REPOSITORY
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.FAILED_FILES_ONLY
  import typingsSlinky.awsDashSdk.awsDashSdkStrings.REPORT_CSV_20191124
