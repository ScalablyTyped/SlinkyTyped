...
trait DescribeFileSystemsRequest extends js.Object {
  /**
    ...
    */
  var FileSystemIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.FileSystemIds] = js.native
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.MaxResults] = js.native
  /**
