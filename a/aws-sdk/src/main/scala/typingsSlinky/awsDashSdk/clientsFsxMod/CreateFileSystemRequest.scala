...
trait CreateFileSystemRequest extends js.Object {
  ...
  /**
    ...
    */
  var FileSystemType: typingsSlinky.awsDashSdk.clientsFsxMod.FileSystemType = js.native
  var KmsKeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.KmsKeyId] = js.native
  var LustreConfiguration: js.UndefOr[CreateFileSystemLustreConfiguration] = js.native
  /**
    * A list of IDs specifying the security groups to apply to all network interfaces created for file system access. This list isn't returned in later requests to describe the file system.
    */
  var SecurityGroupIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.SecurityGroupIds] = js.native
  /**
    ...
    */
  var StorageCapacity: typingsSlinky.awsDashSdk.clientsFsxMod.StorageCapacity = js.native
  /**
    ...
    */
  var SubnetIds: typingsSlinky.awsDashSdk.clientsFsxMod.SubnetIds = js.native
  /**
    ...
    */
  var Tags: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.Tags] = js.native
  /**
