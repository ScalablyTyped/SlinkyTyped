...
trait FileSystem extends js.Object {
  ...
  /**
    ...
    */
  var DNSName: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.DNSName] = js.native
  var FailureDetails: js.UndefOr[FileSystemFailureDetails] = js.native
  /**
    * The system-generated, unique 17-digit ID of the file system.
    */
  var FileSystemId: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.FileSystemId] = js.native
  /**
    * The type of Amazon FSx file system, either LUSTRE or WINDOWS.
    */
  var FileSystemType: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.FileSystemType] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkInterfaceIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.NetworkInterfaceIds] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.ResourceARN] = js.native
  /**
    * The storage capacity of the file system in gigabytes (GB).
    */
  var StorageCapacity: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.StorageCapacity] = js.native
  /**
    ...
    */
  var SubnetIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.SubnetIds] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.VpcId] = js.native
  /**
