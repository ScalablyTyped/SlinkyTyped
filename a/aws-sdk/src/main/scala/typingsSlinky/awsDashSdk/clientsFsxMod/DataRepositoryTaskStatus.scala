...
trait DataRepositoryTaskStatus extends js.Object {
  /**
    ...
    */
  var FailedCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.FailedCount] = js.native
  /**
  ...
  /**
    ...
    */
  var SucceededCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.SucceededCount] = js.native
  /**
    * The total number of files that the task will process. While a task is executing, the sum of SucceededCount plus FailedCount may not equal TotalCount. When the task is complete, TotalCount equals the sum of SucceededCount plus FailedCount.
    */
  var TotalCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.TotalCount] = js.native
}
