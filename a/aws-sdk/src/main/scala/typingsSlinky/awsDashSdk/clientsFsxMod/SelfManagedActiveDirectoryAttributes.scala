...
trait SelfManagedActiveDirectoryAttributes extends js.Object {
  /**
    ...
    */
  var DnsIps: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.DnsIps] = js.native
  /**
  ...
  /**
    ...
    */
  var OrganizationalUnitDistinguishedName: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.OrganizationalUnitDistinguishedName] = js.native
  /**
