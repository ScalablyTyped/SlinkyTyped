...
trait DescribeBackupsResponse extends js.Object {
  /**
    ...
    */
  var Backups: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.Backups] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.NextToken] = js.native
}
