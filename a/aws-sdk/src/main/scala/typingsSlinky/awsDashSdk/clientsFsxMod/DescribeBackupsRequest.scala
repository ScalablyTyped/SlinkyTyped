...
trait DescribeBackupsRequest extends js.Object {
  /**
    ...
    */
  var BackupIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.BackupIds] = js.native
  /**
    * (Optional) Filters structure. Supported names are file-system-id and backup-type.
    */
  var Filters: js.UndefOr[typingsSlinky.awsDashSdk.clientsFsxMod.Filters] = js.native
  /**
