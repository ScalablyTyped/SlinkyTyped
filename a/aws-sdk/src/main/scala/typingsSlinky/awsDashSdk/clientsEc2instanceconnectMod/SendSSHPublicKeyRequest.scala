...
trait SendSSHPublicKeyRequest extends js.Object {
  /**
    ...
    */
  var AvailabilityZone: typingsSlinky.awsDashSdk.clientsEc2instanceconnectMod.AvailabilityZone = js.native
  /**
    * The EC2 instance you wish to publish the SSH key to.
    */
  var InstanceId: typingsSlinky.awsDashSdk.clientsEc2instanceconnectMod.InstanceId = js.native
  /**
    * The OS user on the EC2 instance whom the key may be used to authenticate as.
    */
  var InstanceOSUser: typingsSlinky.awsDashSdk.clientsEc2instanceconnectMod.InstanceOSUser = js.native
  /**
    * The public key to be published to the instance. To use it after publication you must have the matching private key.
    */
  var SSHPublicKey: typingsSlinky.awsDashSdk.clientsEc2instanceconnectMod.SSHPublicKey = js.native
}
