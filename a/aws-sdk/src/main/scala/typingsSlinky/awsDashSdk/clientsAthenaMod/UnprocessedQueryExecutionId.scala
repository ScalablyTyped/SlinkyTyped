...
trait UnprocessedQueryExecutionId extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.ErrorCode] = js.native
  /**
    * The error message returned when the query execution failed to process, if applicable.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.ErrorMessage] = js.native
  /**
