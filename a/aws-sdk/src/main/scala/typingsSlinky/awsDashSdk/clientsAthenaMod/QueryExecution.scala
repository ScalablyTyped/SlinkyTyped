...
trait QueryExecution extends js.Object {
  ...
  /**
    ...
    */
  var QueryExecutionContext: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.QueryExecutionContext] = js.native
  /**
    * The unique identifier for each query execution.
    */
  var QueryExecutionId: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.QueryExecutionId] = js.native
  /**
    * The location in Amazon S3 where query results were stored and the encryption option, if any, used for query results. These are known as "client-side settings". If workgroup settings override client-side settings, then the query uses the location for the query results and the encryption configuration that are specified for the workgroup.
    */
  var ResultConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.ResultConfiguration] = js.native
  /**
    * The type of query statement that was run. DDL indicates DDL query statements. DML indicates DML (Data Manipulation Language) query statements, such as CREATE TABLE AS SELECT. UTILITY indicates query statements other than DDL and DML, such as SHOW CREATE TABLE, or DESCRIBE &lt;table&gt;.
    */
  var StatementType: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.StatementType] = js.native
  /**
