...
trait NamedQuery extends js.Object {
  ...
  /**
    ...
    */
  var NamedQueryId: js.UndefOr[typingsSlinky.awsDashSdk.clientsAthenaMod.NamedQueryId] = js.native
  /**
    * The SQL query statements that comprise the query.
    */
  var QueryString: typingsSlinky.awsDashSdk.clientsAthenaMod.QueryString = js.native
  /**
