...
trait ResolverRule extends js.Object {
  /**
    ...
    */
  var Arn: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.Arn] = js.native
  /**
    ...
    */
  var CreatorRequestId: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.CreatorRequestId] = js.native
  /**
    * DNS queries for this domain name are forwarded to the IP addresses that are specified in TargetIps. If a query matches multiple resolver rules (example.com and www.example.com), the query is routed using the resolver rule that contains the most specific domain name (www.example.com).
    */
  var DomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.DomainName] = js.native
  /**
  ...
  /**
    ...
    */
  var ShareStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.ShareStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.StatusMessage] = js.native
  /**
