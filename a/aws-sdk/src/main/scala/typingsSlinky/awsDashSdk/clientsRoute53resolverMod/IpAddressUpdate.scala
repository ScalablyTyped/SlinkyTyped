...
trait IpAddressUpdate extends js.Object {
  /**
    * The new IP address.
    */
  var Ip: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.Ip] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.SubnetId] = js.native
}
