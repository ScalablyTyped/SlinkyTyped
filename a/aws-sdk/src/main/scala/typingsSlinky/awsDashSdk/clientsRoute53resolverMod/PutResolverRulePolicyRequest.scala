...
trait PutResolverRulePolicyRequest extends js.Object {
  /**
    ...
    */
  var Arn: typingsSlinky.awsDashSdk.clientsRoute53resolverMod.Arn = js.native
  /**
    ...
    */
  var ResolverRulePolicy: typingsSlinky.awsDashSdk.clientsRoute53resolverMod.ResolverRulePolicy = js.native
}
