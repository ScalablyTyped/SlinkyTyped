...
trait TargetAddress extends js.Object {
  /**
    ...
    */
  var Ip: typingsSlinky.awsDashSdk.clientsRoute53resolverMod.Ip = js.native
  /**
    * The port at Ip that you want to forward DNS queries to.
    */
  var Port: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.Port] = js.native
}
