...
trait ListResolverRuleAssociationsResponse extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.MaxResults] = js.native
  /**
    * If more than MaxResults rule associations match the specified criteria, you can submit another ListResolverRuleAssociation request to get the next group of results. In the next request, specify the value of NextToken from the previous response. 
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.NextToken] = js.native
  /**
    ...
    */
  var ResolverRuleAssociations: js.UndefOr[typingsSlinky.awsDashSdk.clientsRoute53resolverMod.ResolverRuleAssociations] = js.native
}
