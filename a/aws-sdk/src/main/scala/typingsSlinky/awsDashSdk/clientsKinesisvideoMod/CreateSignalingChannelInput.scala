...
trait CreateSignalingChannelInput extends js.Object {
  /**
    ...
    */
  var ChannelName: typingsSlinky.awsDashSdk.clientsKinesisvideoMod.ChannelName = js.native
  /**
    * A type of the signaling channel that you are creating. Currently, SINGLE_MASTER is the only supported channel type. 
    */
  var ChannelType: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoMod.ChannelType] = js.native
  /**
    * A structure containing the configuration for the SINGLE_MASTER channel type. 
    */
  var SingleMasterConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsKinesisvideoMod.SingleMasterConfiguration] = js.native
  /**
