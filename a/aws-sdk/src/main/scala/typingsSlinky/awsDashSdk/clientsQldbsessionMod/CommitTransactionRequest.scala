...
trait CommitTransactionRequest extends js.Object {
  /**
    ...
    */
  var CommitDigest: typingsSlinky.awsDashSdk.clientsQldbsessionMod.CommitDigest = js.native
  /**
    * Specifies the transaction id of the transaction to commit.
    */
  var TransactionId: typingsSlinky.awsDashSdk.clientsQldbsessionMod.TransactionId = js.native
}
