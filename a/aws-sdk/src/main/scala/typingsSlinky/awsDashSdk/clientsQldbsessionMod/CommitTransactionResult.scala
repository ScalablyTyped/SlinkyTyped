...
trait CommitTransactionResult extends js.Object {
  /**
    ...
    */
  var CommitDigest: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbsessionMod.CommitDigest] = js.native
  /**
    * The transaction id of the committed transaction.
    */
  var TransactionId: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbsessionMod.TransactionId] = js.native
}
