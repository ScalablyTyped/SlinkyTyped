...
trait ValueHolder extends js.Object {
  /**
    ...
    */
  var IonBinary: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbsessionMod.IonBinary] = js.native
  /**
    * An Amazon Ion plaintext value contained in a ValueHolder structure. 
    */
  var IonText: js.UndefOr[typingsSlinky.awsDashSdk.clientsQldbsessionMod.IonText] = js.native
}
