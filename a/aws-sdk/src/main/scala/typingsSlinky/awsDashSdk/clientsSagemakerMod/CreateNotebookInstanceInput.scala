...
trait CreateNotebookInstanceInput extends js.Object {
  ...
  /**
    ...
    */
  var DirectInternetAccess: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DirectInternetAccess] = js.native
  /**
    * The type of ML compute instance to launch for the notebook instance.
    */
  var InstanceType: typingsSlinky.awsDashSdk.clientsSagemakerMod.InstanceType = js.native
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.KmsKeyId] = js.native
  /**
  ...
  /**
    ...
    */
  var RootAccess: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.RootAccess] = js.native
  /**
    * The VPC security group IDs, in the form sg-xxxxxxxx. The security groups must be for the same VPC as specified in the subnet. 
    */
  var SecurityGroupIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SecurityGroupIds] = js.native
  /**
    * The ID of the subnet in a VPC to which you would like to have a connectivity from your ML compute instance. 
    */
  var SubnetId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SubnetId] = js.native
  /**
