...
trait CompilationJobSummary extends js.Object {
  ...
  /**
    ...
    */
  var CompilationJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.CompilationJobArn = js.native
  /**
  ...
  /**
    ...
    */
  var CompilationJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.CompilationJobStatus = js.native
  /**
