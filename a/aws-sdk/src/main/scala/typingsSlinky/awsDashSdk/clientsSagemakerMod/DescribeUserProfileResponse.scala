...
trait DescribeUserProfileResponse extends js.Object {
  ...
  /**
    ...
    */
  var SingleSignOnUserIdentifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SingleSignOnUserIdentifier] = js.native
  /**
    * The SSO user value.
    */
  ...
  /**
    ...
    */
  var UserProfileArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.UserProfileArn] = js.native
  /**
  ...
  /**
    ...
    */
  var UserSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.UserSettings] = js.native
}
