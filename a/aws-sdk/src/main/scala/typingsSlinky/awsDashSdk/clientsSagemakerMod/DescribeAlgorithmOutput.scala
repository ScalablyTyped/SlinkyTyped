...
trait DescribeAlgorithmOutput extends js.Object {
  ...
  /**
    ...
    */
  var AlgorithmStatusDetails: typingsSlinky.awsDashSdk.clientsSagemakerMod.AlgorithmStatusDetails = js.native
  /**
  ...
  /**
    ...
    */
  var ProductId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ProductId] = js.native
  /**
    * Details about training jobs run by this algorithm.
    */
  var TrainingSpecification: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingSpecification = js.native
  /**
