...
trait LabelingJobAlgorithmsConfig extends js.Object {
  ...
  /**
    ...
    */
  var LabelingJobAlgorithmSpecificationArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobAlgorithmSpecificationArn = js.native
  /**
    * Provides configuration information for a labeling job.
    */
  var LabelingJobResourceConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobResourceConfig] = js.native
}
