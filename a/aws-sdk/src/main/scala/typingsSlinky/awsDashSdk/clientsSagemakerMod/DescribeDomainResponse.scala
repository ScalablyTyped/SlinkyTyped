...
trait DescribeDomainResponse extends js.Object {
  /**
    ...
    */
  var AuthMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AuthMode] = js.native
  /**
    * The creation time.
    */
  ...
  /**
    ...
    */
  var VpcId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.VpcId] = js.native
}
