...
trait MonitoringScheduleConfig extends js.Object {
  /**
    ...
    */
  var MonitoringJobDefinition: typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringJobDefinition = js.native
  /**
    * Configures the monitoring schedule.
    */
  var ScheduleConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ScheduleConfig] = js.native
}
