...
trait DescribeNotebookInstanceOutput extends js.Object {
  ...
  /**
    ...
    */
  var InstanceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.InstanceType] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkInterfaceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NetworkInterfaceId] = js.native
  /**
    * The Amazon Resource Name (ARN) of the notebook instance.
    */
  var NotebookInstanceArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NotebookInstanceArn] = js.native
  /**
    ...
    */
  var NotebookInstanceLifecycleConfigName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NotebookInstanceLifecycleConfigName] = js.native
  /**
    * The name of the Amazon SageMaker notebook instance. 
    */
  var NotebookInstanceName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NotebookInstanceName] = js.native
  /**
    * The status of the notebook instance.
    */
  var NotebookInstanceStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NotebookInstanceStatus] = js.native
  /**
