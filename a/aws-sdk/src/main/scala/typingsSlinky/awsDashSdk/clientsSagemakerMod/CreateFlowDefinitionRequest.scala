...
trait CreateFlowDefinitionRequest extends js.Object {
  /**
    ...
    */
  var FlowDefinitionName: typingsSlinky.awsDashSdk.clientsSagemakerMod.FlowDefinitionName = js.native
  /**
    * An object containing information about the events that trigger a human workflow.
    */
  var HumanLoopActivationConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.HumanLoopActivationConfig] = js.native
  /**
    * An object containing information about the tasks the human reviewers will perform.
    */
  var HumanLoopConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.HumanLoopConfig = js.native
  /**
