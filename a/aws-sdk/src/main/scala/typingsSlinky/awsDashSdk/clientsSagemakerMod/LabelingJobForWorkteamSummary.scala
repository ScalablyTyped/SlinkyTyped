...
trait LabelingJobForWorkteamSummary extends js.Object {
  ...
  /**
    ...
    */
  var JobReferenceCode: typingsSlinky.awsDashSdk.clientsSagemakerMod.JobReferenceCode = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobName] = js.native
  /**
    * The configured number of workers per data object.
    */
  var NumberOfHumanWorkersPerDataObject: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NumberOfHumanWorkersPerDataObject] = js.native
  /**
    * 
    */
