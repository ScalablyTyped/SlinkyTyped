...
trait HumanTaskUiSummary extends js.Object {
  ...
  /**
    ...
    */
  var HumanTaskUiArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.HumanTaskUiArn = js.native
  /**
    * The name of the human task user interface.
    */
  var HumanTaskUiName: typingsSlinky.awsDashSdk.clientsSagemakerMod.HumanTaskUiName = js.native
}
