...
trait MonitoringJobDefinition extends js.Object {
  ...
  /**
    ...
    */
  var MonitoringAppSpecification: typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringAppSpecification = js.native
  /**
    * The array of inputs for the monitoring job. Currently we support monitoring an Amazon SageMaker Endpoint.
    */
  var MonitoringInputs: typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringInputs = js.native
  /**
    * The array of outputs from the monitoring job to be uploaded to Amazon Simple Storage Service (Amazon S3).
    */
  var MonitoringOutputConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringOutputConfig = js.native
  /**
    * Identifies the resources, ML compute instances, and ML storage volumes to deploy for a monitoring job. In distributed processing, you specify more than one instance.
    */
  var MonitoringResources: typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringResources = js.native
  /**
