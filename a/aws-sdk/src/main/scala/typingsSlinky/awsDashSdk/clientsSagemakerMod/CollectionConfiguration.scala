...
trait CollectionConfiguration extends js.Object {
  /**
    ...
    */
  var CollectionName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CollectionName] = js.native
  /**
    * Parameter values for the tensor collection. The allowed parameters are "name", "include_regex", "reduction_config", "save_config", "tensor_names", and "save_histogram".
    */
  var CollectionParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CollectionParameters] = js.native
}
