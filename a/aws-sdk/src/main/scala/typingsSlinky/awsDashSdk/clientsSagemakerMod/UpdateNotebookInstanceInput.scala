...
trait UpdateNotebookInstanceInput extends js.Object {
  ...
  /**
    ...
    */
  var DisassociateAdditionalCodeRepositories: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsSagemakerMod.DisassociateAdditionalCodeRepositories
  ] = js.native
  /**
    * The name or URL of the default Git repository to remove from this notebook instance. This operation is idempotent. If you specify a Git repository that is not associated with the notebook instance when you call this method, it does not throw an error.
    */
  var DisassociateDefaultCodeRepository: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DisassociateDefaultCodeRepository] = js.native
  /**
