...
trait DescribeAppResponse extends js.Object {
  /**
    ...
    */
  var AppArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AppArn] = js.native
  /**
    * The name of the app.
    */
  ...
  /**
    ...
    */
  var ResourceSpec: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ResourceSpec] = js.native
  /**
    * The status.
    */
