...
trait DescribeAutoMLJobResponse extends js.Object {
  /**
    ...
    */
  var AutoMLJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobArn = js.native
  /**
    * Returns information on the job's artifacts found in AutoMLJobArtifacts.
    */
  var AutoMLJobArtifacts: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobArtifacts] = js.native
  /**
    * Returns the job's config.
    */
  var AutoMLJobConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobConfig] = js.native
  /**
    * Returns the name of a job.
    */
  var AutoMLJobName: typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobName = js.native
  /**
    * Returns the job's objective.
    */
  var AutoMLJobObjective: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobObjective] = js.native
  /**
    * Returns the job's AutoMLJobSecondaryStatus.
    */
  var AutoMLJobSecondaryStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobSecondaryStatus = js.native
  /**
    * Returns the job's AutoMLJobStatus.
    */
  var AutoMLJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobStatus = js.native
  /**
  ...
  /**
    ...
    */
  var GenerateCandidateDefinitionsOnly: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.GenerateCandidateDefinitionsOnly] = js.native
  /**
  ...
  /**
    ...
    */
  var ProblemType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ProblemType] = js.native
  /**
    ...
    */
  var ResolvedAttributes: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ResolvedAttributes] = js.native
  /**
    * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that has read permission to the input data location and write permission to the output data location in Amazon S3.
    */
  var RoleArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.RoleArn = js.native
}
