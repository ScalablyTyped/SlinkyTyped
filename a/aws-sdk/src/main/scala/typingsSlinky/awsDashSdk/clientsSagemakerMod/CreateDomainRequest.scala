...
trait CreateDomainRequest extends js.Object {
  /**
    ...
    */
  var AuthMode: typingsSlinky.awsDashSdk.clientsSagemakerMod.AuthMode = js.native
  /**
  ...
  /**
    ...
    */
  var DomainName: typingsSlinky.awsDashSdk.clientsSagemakerMod.DomainName = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: typingsSlinky.awsDashSdk.clientsSagemakerMod.VpcId = js.native
}
