...
trait TrainingJobSummary extends js.Object {
  ...
  /**
    ...
    */
  var TrainingJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobArn = js.native
  /**
    * The name of the training job that you want a summary for.
    */
  var TrainingJobName: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobName = js.native
  /**
    * The status of the training job.
    */
  var TrainingJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobStatus = js.native
}
