...
trait ParameterRanges extends js.Object {
  /**
    ...
    */
  var CategoricalParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CategoricalParameterRanges] = js.native
  /**
    * The array of ContinuousParameterRange objects that specify ranges of continuous hyperparameters that a hyperparameter tuning job searches.
    */
  var ContinuousParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ContinuousParameterRanges] = js.native
  /**
    * The array of IntegerParameterRange objects that specify ranges of integer hyperparameters that a hyperparameter tuning job searches.
    */
  var IntegerParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.IntegerParameterRanges] = js.native
}
