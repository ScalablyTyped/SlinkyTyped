...
trait AutoMLJobCompletionCriteria extends js.Object {
  /**
    ...
    */
  var MaxAutoMLJobRuntimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxAutoMLJobRuntimeInSeconds] = js.native
  /**
    * The maximum number of times a training job is allowed to run.
    */
  var MaxCandidates: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxCandidates] = js.native
  /**
    * The maximum time, in seconds, a job is allowed to run.
    */
  var MaxRuntimePerTrainingJobInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxRuntimePerTrainingJobInSeconds] = js.native
}
