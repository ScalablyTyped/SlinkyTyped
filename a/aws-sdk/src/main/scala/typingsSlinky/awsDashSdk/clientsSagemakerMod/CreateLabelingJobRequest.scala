...
trait CreateLabelingJobRequest extends js.Object {
  /**
    ...
    */
  var HumanTaskConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.HumanTaskConfig = js.native
  /**
  ...
  /**
    ...
    */
  var LabelAttributeName: typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelAttributeName = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobAlgorithmsConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobAlgorithmsConfig] = js.native
  /**
    * The name of the labeling job. This name is used to identify the job in a list of labeling jobs.
    */
  var LabelingJobName: typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobName = js.native
  /**
