...
trait InputConfig extends js.Object {
  /**
    ...
    */
  var DataInputConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.DataInputConfig = js.native
  /**
    * Identifies the framework in which the model was trained. For example: TENSORFLOW.
    */
  var Framework: typingsSlinky.awsDashSdk.clientsSagemakerMod.Framework = js.native
  /**
