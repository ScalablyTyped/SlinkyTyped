...
trait ResourceLimits extends js.Object {
  /**
    ...
    */
  var MaxNumberOfTrainingJobs: typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxNumberOfTrainingJobs = js.native
  /**
    * The maximum number of concurrent training jobs that a hyperparameter tuning job can launch.
    */
  var MaxParallelTrainingJobs: typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxParallelTrainingJobs = js.native
}
