...
trait DebugHookConfig extends js.Object {
  /**
    ...
    */
  var CollectionConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CollectionConfigurations] = js.native
  /**
    * Configuration information for the debug hook parameters.
    */
  var HookParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.HookParameters] = js.native
  /**
