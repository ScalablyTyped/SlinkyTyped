...
trait DebugRuleEvaluationStatus extends js.Object {
  ...
  /**
    ...
    */
  var RuleConfigurationName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.RuleConfigurationName] = js.native
  /**
  ...
  /**
    ...
    */
  var RuleEvaluationStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.RuleEvaluationStatus] = js.native
  /**
    * Details from the rule evaluation.
    */
  var StatusDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.StatusDetails] = js.native
}
