...
trait UserSettings extends js.Object {
  ...
  /**
    ...
    */
  var JupyterServerAppSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.JupyterServerAppSettings] = js.native
  /**
    * The kernel gateway app settings.
    */
  var KernelGatewayAppSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.KernelGatewayAppSettings] = js.native
  /**
    * The security groups.
    */
  ...
  /**
    ...
    */
  var SharingSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SharingSettings] = js.native
  /**
    * The TensorBoard app settings.
    */
  var TensorBoardAppSettings: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TensorBoardAppSettings] = js.native
}
