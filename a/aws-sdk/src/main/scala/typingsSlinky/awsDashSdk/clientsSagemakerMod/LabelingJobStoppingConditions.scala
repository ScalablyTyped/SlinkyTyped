...
trait LabelingJobStoppingConditions extends js.Object {
  /**
    ...
    */
  var MaxHumanLabeledObjectCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxHumanLabeledObjectCount] = js.native
  /**
    * The maximum number of input data objects that should be labeled.
    */
  var MaxPercentageOfInputDatasetLabeled: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxPercentageOfInputDatasetLabeled] = js.native
}
