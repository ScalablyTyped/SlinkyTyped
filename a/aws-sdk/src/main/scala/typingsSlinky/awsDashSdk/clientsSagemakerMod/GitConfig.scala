...
trait GitConfig extends js.Object {
  /**
    ...
    */
  var Branch: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.Branch] = js.native
  /**
  ...
  /**
    ...
    */
  var SecretArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SecretArn] = js.native
}
