...
trait DescribeProcessingJobResponse extends js.Object {
  /**
    ...
    */
  var AppSpecification: typingsSlinky.awsDashSdk.clientsSagemakerMod.AppSpecification = js.native
  /**
    * The ARN of an AutoML job associated with this processing job.
    */
  var AutoMLJobArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AutoMLJobArn] = js.native
  /**
  ...
  /**
    ...
    */
  var ExitMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ExitMessage] = js.native
  /**
    * The configuration information used to create an experiment.
    */
  var ExperimentConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ExperimentConfig] = js.native
  /**
    * A string, up to one KB in size, that contains the reason a processing job failed, if it failed.
    */
  var FailureReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.FailureReason] = js.native
  /**
  ...
  /**
    ...
    */
  var MonitoringScheduleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MonitoringScheduleArn] = js.native
  /**
    * Networking options for a processing job.
    */
  var NetworkConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NetworkConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var ProcessingInputs: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingInputs] = js.native
  /**
    * The Amazon Resource Name (ARN) of the processing job.
    */
  var ProcessingJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingJobArn = js.native
  /**
    * The name of the processing job. The name must be unique within an AWS Region in the AWS account.
    */
  var ProcessingJobName: typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingJobName = js.native
  /**
    * Provides the status of a processing job.
    */
  var ProcessingJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingJobStatus = js.native
  /**
    * Output configuration for the processing job.
    */
  var ProcessingOutputConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingOutputConfig] = js.native
  /**
    * Identifies the resources, ML compute instances, and ML storage volumes to deploy for a processing job. In distributed training, you specify more than one instance.
    */
  var ProcessingResources: typingsSlinky.awsDashSdk.clientsSagemakerMod.ProcessingResources = js.native
  /**
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.RoleArn] = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingJobArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobArn] = js.native
}
