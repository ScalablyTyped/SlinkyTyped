...
trait StoppingCondition extends js.Object {
  /**
    ...
    */
  var MaxRuntimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxRuntimeInSeconds] = js.native
  /**
    ...
    */
  var MaxWaitTimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxWaitTimeInSeconds] = js.native
}
