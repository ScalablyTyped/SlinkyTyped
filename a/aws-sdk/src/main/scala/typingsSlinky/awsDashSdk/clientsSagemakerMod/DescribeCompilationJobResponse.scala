...
trait DescribeCompilationJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var FailureReason: typingsSlinky.awsDashSdk.clientsSagemakerMod.FailureReason = js.native
  /**
    * Information about the location in Amazon S3 of the input model artifacts, the name and shape of the expected data inputs, and the framework in which the model was trained.
    */
  var InputConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.InputConfig = js.native
  /**
  ...
  /**
    ...
    */
  var ModelArtifacts: typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelArtifacts = js.native
  /**
    * Information about the output location for the compiled model and the target device that the model runs on.
    */
  var OutputConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.OutputConfig = js.native
  /**
  ...
  /**
    ...
    */
  var StoppingCondition: typingsSlinky.awsDashSdk.clientsSagemakerMod.StoppingCondition = js.native
}
