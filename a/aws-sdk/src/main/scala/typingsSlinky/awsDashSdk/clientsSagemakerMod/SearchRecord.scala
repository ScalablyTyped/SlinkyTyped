...
trait SearchRecord extends js.Object {
  /**
    ...
    */
  var Experiment: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.Experiment] = js.native
  /**
    * A TrainingJob object that is returned as part of a Search request.
    */
  var TrainingJob: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJob] = js.native
  /**
    * A summary of the properties of a trial.
    */
  var Trial: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.Trial] = js.native
  /**
    * A summary of the properties of a trial component.
    */
  var TrialComponent: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrialComponent] = js.native
}
