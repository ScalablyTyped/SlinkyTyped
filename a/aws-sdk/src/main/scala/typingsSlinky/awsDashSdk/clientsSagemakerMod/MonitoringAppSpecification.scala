...
trait MonitoringAppSpecification extends js.Object {
  ...
  /**
    ...
    */
  var ContainerEntrypoint: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ContainerEntrypoint] = js.native
  /**
    * The container image to be run by the monitoring job.
    */
  var ImageUri: typingsSlinky.awsDashSdk.clientsSagemakerMod.ImageUri = js.native
  /**
