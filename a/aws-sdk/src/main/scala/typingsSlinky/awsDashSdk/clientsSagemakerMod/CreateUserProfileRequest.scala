...
trait CreateUserProfileRequest extends js.Object {
  /**
    ...
    */
  var DomainId: typingsSlinky.awsDashSdk.clientsSagemakerMod.DomainId = js.native
  /**
  ...
  /**
    ...
    */
  var UserProfileName: typingsSlinky.awsDashSdk.clientsSagemakerMod.UserProfileName = js.native
  /**
