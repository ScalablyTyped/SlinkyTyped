...
trait DescribeEndpointConfigOutput extends js.Object {
  ...
  var DataCaptureConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DataCaptureConfig] = js.native
  /**
    * The Amazon Resource Name (ARN) of the endpoint configuration.
    */
  var EndpointConfigArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.EndpointConfigArn = js.native
  /**
