...
trait DataCaptureConfig extends js.Object {
  /**
    * 
    */
  var CaptureContentTypeHeader: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CaptureContentTypeHeader] = js.native
  /**
    * 
    */
  ...
  /**
    * 
    */
  var EnableCapture: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.EnableCapture] = js.native
  /**
    * 
    */
