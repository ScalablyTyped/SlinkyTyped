...
trait ParameterRange extends js.Object {
  /**
    ...
    */
  var CategoricalParameterRangeSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsSagemakerMod.CategoricalParameterRangeSpecification
  ] = js.native
  /**
    * A ContinuousParameterRangeSpecification object that defines the possible values for a continuous hyperparameter.
    */
  var ContinuousParameterRangeSpecification: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsSagemakerMod.ContinuousParameterRangeSpecification
  ] = js.native
  /**
    * A IntegerParameterRangeSpecification object that defines the possible values for an integer hyperparameter.
    */
  var IntegerParameterRangeSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.IntegerParameterRangeSpecification] = js.native
}
