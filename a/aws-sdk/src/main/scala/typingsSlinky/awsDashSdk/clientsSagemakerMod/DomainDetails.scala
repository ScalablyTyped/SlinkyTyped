...
trait DomainDetails extends js.Object {
  ...
  /**
    ...
    */
  var DomainArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DomainArn] = js.native
  /**
    * The domain ID.
    */
  ...
  /**
    * The domain name.
    */
  var DomainName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DomainName] = js.native
  /**
