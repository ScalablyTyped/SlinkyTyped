...
trait ModelPackageContainerDefinition extends js.Object {
  /**
    ...
    */
  var ContainerHostname: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ContainerHostname] = js.native
  /**
    * The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored. If you are using your own custom algorithm instead of an algorithm provided by Amazon SageMaker, the inference code must meet Amazon SageMaker requirements. Amazon SageMaker supports both registry/repository[:tag] and registry/repository[@digest] image path formats. For more information, see Using Your Own Algorithms with Amazon SageMaker.
    */
  var Image: typingsSlinky.awsDashSdk.clientsSagemakerMod.Image = js.native
  /**
    * An MD5 hash of the training algorithm that identifies the Docker image used for training.
    */
  var ImageDigest: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ImageDigest] = js.native
  /**
