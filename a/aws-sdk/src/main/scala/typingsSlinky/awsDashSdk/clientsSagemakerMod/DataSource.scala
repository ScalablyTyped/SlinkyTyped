...
trait DataSource extends js.Object {
  /**
    ...
    */
  var FileSystemDataSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.FileSystemDataSource] = js.native
  /**
    * The S3 location of the data source that is associated with a channel.
    */
  var S3DataSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.S3DataSource] = js.native
}
