...
trait LabelingJobSummary extends js.Object {
  ...
  /**
    ...
    */
  var LabelCounters: typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelCounters = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobOutput] = js.native
  /**
    * The current status of the labeling job. 
    */
  var LabelingJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobStatus = js.native
  /**
