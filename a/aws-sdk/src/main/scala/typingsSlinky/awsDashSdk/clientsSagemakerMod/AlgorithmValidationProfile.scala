...
trait AlgorithmValidationProfile extends js.Object {
  ...
  /**
    ...
    */
  var TrainingJobDefinition: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobDefinition = js.native
  /**
    * The TransformJobDefinition object that describes the transform job that Amazon SageMaker runs to validate your algorithm.
    */
  var TransformJobDefinition: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformJobDefinition] = js.native
}
