...
trait USD extends js.Object {
  /**
    ...
    */
  var Cents: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.Cents] = js.native
  /**
    * The whole number of dollars in the amount.
    */
  var Dollars: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.Dollars] = js.native
  /**
    * Fractions of a cent, in tenths.
    */
  var TenthFractionsOfACent: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TenthFractionsOfACent] = js.native
}
