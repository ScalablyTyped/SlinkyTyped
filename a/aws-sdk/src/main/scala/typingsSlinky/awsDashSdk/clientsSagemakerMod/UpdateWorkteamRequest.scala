...
trait UpdateWorkteamRequest extends js.Object {
  ...
  /**
    ...
    */
  var MemberDefinitions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MemberDefinitions] = js.native
  /**
    * Configures SNS topic notifications for available or expiring work items
    */
  var NotificationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.NotificationConfiguration] = js.native
  /**
    * The name of the work team to update.
    */
  var WorkteamName: typingsSlinky.awsDashSdk.clientsSagemakerMod.WorkteamName = js.native
}
