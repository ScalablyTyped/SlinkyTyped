...
trait AutoMLCandidate extends js.Object {
  /**
    * The candidate name.
    */
  var CandidateName: typingsSlinky.awsDashSdk.clientsSagemakerMod.CandidateName = js.native
  /**
    * The candidate's status.
    */
  var CandidateStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.CandidateStatus = js.native
  /**
    * The candidate's steps.
    */
  var CandidateSteps: typingsSlinky.awsDashSdk.clientsSagemakerMod.CandidateSteps = js.native
  /**
    * The creation time.
    */
  ...
  var FinalAutoMLJobObjectiveMetric: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.FinalAutoMLJobObjectiveMetric] = js.native
  /**
  ...
  /**
    ...
    */
  var ObjectiveStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.ObjectiveStatus = js.native
}
