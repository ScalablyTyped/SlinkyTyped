...
trait HumanTaskConfig extends js.Object {
  /**
    ...
    */
  var AnnotationConsolidationConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.AnnotationConsolidationConfig = js.native
  /**
    ...
    */
  var MaxConcurrentTaskCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxConcurrentTaskCount] = js.native
  /**
    * The number of human workers that will label an object. 
    */
  var NumberOfHumanWorkersPerDataObject: typingsSlinky.awsDashSdk.clientsSagemakerMod.NumberOfHumanWorkersPerDataObject = js.native
  /**
  ...
  /**
    ...
    */
  var PublicWorkforceTaskPrice: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.PublicWorkforceTaskPrice] = js.native
  /**
    ...
    */
  var TaskAvailabilityLifetimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TaskAvailabilityLifetimeInSeconds] = js.native
  /**
    * A description of the task for your human workers.
    */
  var TaskDescription: typingsSlinky.awsDashSdk.clientsSagemakerMod.TaskDescription = js.native
  /**
    * Keywords used to describe the task so that workers on Amazon Mechanical Turk can discover the task.
    */
  var TaskKeywords: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TaskKeywords] = js.native
  /**
    * The amount of time that a worker has to complete a task.
    */
  var TaskTimeLimitInSeconds: typingsSlinky.awsDashSdk.clientsSagemakerMod.TaskTimeLimitInSeconds = js.native
  /**
    * A title for the task for your human workers.
    */
  var TaskTitle: typingsSlinky.awsDashSdk.clientsSagemakerMod.TaskTitle = js.native
  /**
    * Information about the user interface that workers use to complete the labeling task.
    */
  var UiConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.UiConfig = js.native
  /**
