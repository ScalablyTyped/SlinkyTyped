...
trait DescribeHyperParameterTuningJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var HyperParameterTuningJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobArn = js.native
  /**
    * The HyperParameterTuningJobConfig object that specifies the configuration of the tuning job.
    */
  var HyperParameterTuningJobConfig: typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobConfig = js.native
  /**
    * The name of the tuning job.
    */
  var HyperParameterTuningJobName: typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobName = js.native
  /**
    * The status of the tuning job: InProgress, Completed, Failed, Stopping, or Stopped.
    */
  var HyperParameterTuningJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobStatus = js.native
  /**
  ...
  /**
    ...
    */
  var ObjectiveStatusCounters: typingsSlinky.awsDashSdk.clientsSagemakerMod.ObjectiveStatusCounters = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingJobStatusCounters: typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobStatusCounters = js.native
  /**
