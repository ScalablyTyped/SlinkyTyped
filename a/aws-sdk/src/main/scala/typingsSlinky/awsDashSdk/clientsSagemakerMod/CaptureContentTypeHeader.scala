...
trait CaptureContentTypeHeader extends js.Object {
  /**
    * 
    */
  var CsvContentTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CsvContentTypes] = js.native
  /**
    * 
    */
  var JsonContentTypes: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.JsonContentTypes] = js.native
}
