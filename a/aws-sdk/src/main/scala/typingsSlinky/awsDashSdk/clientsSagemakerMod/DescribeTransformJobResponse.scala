...
trait DescribeTransformJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var BatchStrategy: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.BatchStrategy] = js.native
  /**
    * A timestamp that shows when the transform Job was created.
    */
  var CreationTime: js.Date = js.native
  var DataProcessing: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DataProcessing] = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.LabelingJobArn] = js.native
  /**
    * The maximum number of parallel requests on each instance node that can be launched in a transform job. The default value is 1.
    */
  var MaxConcurrentTransforms: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxConcurrentTransforms] = js.native
  /**
    * The maximum payload size, in MB, used in the transform job.
    */
  var MaxPayloadInMB: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.MaxPayloadInMB] = js.native
  /**
    * The name of the model used in the transform job.
    */
  var ModelName: typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelName = js.native
  /**
  ...
  /**
    ...
    */
  var TransformInput: typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformInput = js.native
  /**
    * The Amazon Resource Name (ARN) of the transform job.
    */
  var TransformJobArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformJobArn = js.native
  /**
  ...
  /**
    ...
    */
  var TransformJobStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformJobStatus = js.native
  /**
    * Identifies the Amazon S3 location where you want Amazon SageMaker to save the results from the transform job.
    */
  var TransformOutput: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformOutput] = js.native
  /**
    * Describes the resources, including ML instance types and ML instance count, to use for the transform job.
    */
  var TransformResources: typingsSlinky.awsDashSdk.clientsSagemakerMod.TransformResources = js.native
  /**
