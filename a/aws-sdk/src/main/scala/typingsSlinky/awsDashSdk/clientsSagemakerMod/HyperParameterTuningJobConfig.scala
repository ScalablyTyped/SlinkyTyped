...
trait HyperParameterTuningJobConfig extends js.Object {
  /**
    ...
    */
  var HyperParameterTuningJobObjective: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobObjective] = js.native
  /**
    * The ParameterRanges object that specifies the ranges of hyperparameters that this tuning job searches.
    */
  var ParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ParameterRanges] = js.native
  /**
    * The ResourceLimits object that specifies the maximum number of training jobs and parallel training jobs for this tuning job.
    */
  var ResourceLimits: typingsSlinky.awsDashSdk.clientsSagemakerMod.ResourceLimits = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingJobEarlyStoppingType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobEarlyStoppingType] = js.native
  /**
    * The tuning job's completion criteria.
    */
  var TuningJobCompletionCriteria: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TuningJobCompletionCriteria] = js.native
}
