...
trait AutoMLJobArtifacts extends js.Object {
  /**
    ...
    */
  var CandidateDefinitionNotebookLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CandidateDefinitionNotebookLocation] = js.native
  /**
    * The URL to the notebook location.
    */
  var DataExplorationNotebookLocation: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DataExplorationNotebookLocation] = js.native
}
