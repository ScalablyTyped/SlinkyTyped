...
trait DescribeModelPackageOutput extends js.Object {
  /**
    ...
    */
  var CertifyForMarketplace: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CertifyForMarketplace] = js.native
  /**
  ...
  /**
    ...
    */
  var InferenceSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.InferenceSpecification] = js.native
  /**
    * The Amazon Resource Name (ARN) of the model package.
    */
  var ModelPackageArn: typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelPackageArn = js.native
  /**
  ...
  /**
    ...
    */
  var ModelPackageStatus: typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelPackageStatus = js.native
  /**
    * Details about the current status of the model package.
    */
  var ModelPackageStatusDetails: typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelPackageStatusDetails = js.native
  /**
    * Details about the algorithm that was used to create the model package.
    */
  var SourceAlgorithmSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SourceAlgorithmSpecification] = js.native
  /**
