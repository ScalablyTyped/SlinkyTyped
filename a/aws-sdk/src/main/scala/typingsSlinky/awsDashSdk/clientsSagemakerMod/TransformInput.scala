...
trait TransformInput extends js.Object {
  /**
    ...
    */
  var CompressionType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CompressionType] = js.native
  /**
    * The multipurpose internet mail extension (MIME) type of the data. Amazon SageMaker uses the MIME type with each http call to transfer data to the transform job.
    */
  var ContentType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ContentType] = js.native
  /**
  ...
  /**
    ...
    */
  var SplitType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SplitType] = js.native
}
