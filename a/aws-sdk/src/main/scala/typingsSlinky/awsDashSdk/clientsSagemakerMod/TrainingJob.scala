...
trait TrainingJob extends js.Object {
  /**
    ...
    */
  var AlgorithmSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.AlgorithmSpecification] = js.native
  /**
  ...
  /**
    ...
    */
  var BillableTimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.BillableTimeInSeconds] = js.native
  var CheckpointConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.CheckpointConfig] = js.native
  /**
    * A timestamp that indicates when the training job was created.
    */
  var CreationTime: js.UndefOr[js.Date] = js.native
  var DebugHookConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DebugHookConfig] = js.native
  /**
    * Information about the debug rule configuration.
    */
  var DebugRuleConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DebugRuleConfigurations] = js.native
  /**
    * Information about the evaluation status of the rules for the training job.
    */
  var DebugRuleEvaluationStatuses: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.DebugRuleEvaluationStatuses] = js.native
  /**
  ...
  /**
    ...
    */
  var FinalMetricDataList: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.FinalMetricDataList] = js.native
  /**
    * Algorithm-specific parameters.
    */
  var HyperParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.HyperParameters] = js.native
  /**
    * An array of Channel objects that describes each data input channel.
    */
  var InputDataConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.InputDataConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var ModelArtifacts: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ModelArtifacts] = js.native
  /**
    * The S3 path where model artifacts that you configured when creating the job are stored. Amazon SageMaker creates subfolders for model artifacts.
    */
  var OutputDataConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.OutputDataConfig] = js.native
  /**
    * Resources, including ML compute instances and ML storage volumes, that are configured for model training.
    */
  var ResourceConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.ResourceConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var SecondaryStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SecondaryStatus] = js.native
  /**
    * A history of all of the secondary statuses that the training job has transitioned through.
    */
  var SecondaryStatusTransitions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.SecondaryStatusTransitions] = js.native
  /**
    ...
    */
  var StoppingCondition: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.StoppingCondition] = js.native
  /**
    * An array of key-value pairs. For more information, see Using Cost Allocation Tags in the AWS Billing and Cost Management User Guide.
    */
  var Tags: js.UndefOr[TagList] = js.native
  var TensorBoardOutputConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TensorBoardOutputConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingJobName: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobName] = js.native
  /**
    ...
    */
  var TrainingJobStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingJobStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingTimeInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsSagemakerMod.TrainingTimeInSeconds] = js.native
  /**
