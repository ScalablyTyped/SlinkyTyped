...
trait FeaturizationConfig extends js.Object {
  /**
    ...
    */
  var Featurizations: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Featurizations] = js.native
  /**
    ...
    */
  var ForecastDimensions: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.ForecastDimensions] = js.native
  /**
