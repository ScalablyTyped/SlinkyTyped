...
trait DatasetSummary extends js.Object {
  ...
  /**
    * The dataset type.
    */
  var DatasetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.DatasetType] = js.native
  /**
    * The domain associated with the dataset.
    */
  var Domain: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Domain] = js.native
  /**
