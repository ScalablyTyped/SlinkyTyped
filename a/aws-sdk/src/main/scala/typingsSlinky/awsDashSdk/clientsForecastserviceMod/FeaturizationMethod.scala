...
trait FeaturizationMethod extends js.Object {
  /**
    ...
    */
  var FeaturizationMethodName: typingsSlinky.awsDashSdk.clientsForecastserviceMod.FeaturizationMethodName = js.native
  /**
    ...
    */
  var FeaturizationMethodParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.FeaturizationMethodParameters] = js.native
}
