...
trait DescribeDatasetImportJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var DataSource: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.DataSource] = js.native
  /**
  ...
  /**
    ...
    */
  var FieldStatistics: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.FieldStatistics] = js.native
  /**
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Message] = js.native
  /**
    ...
    */
  var Status: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Status] = js.native
  /**
    ...
    */
  var TimestampFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.TimestampFormat] = js.native
}
