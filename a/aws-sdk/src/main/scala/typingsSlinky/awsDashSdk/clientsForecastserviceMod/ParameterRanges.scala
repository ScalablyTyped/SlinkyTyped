...
trait ParameterRanges extends js.Object {
  /**
    ...
    */
  var CategoricalParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.CategoricalParameterRanges] = js.native
  /**
    * Specifies the tunable range for each continuous hyperparameter.
    */
  var ContinuousParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.ContinuousParameterRanges] = js.native
  /**
    * Specifies the tunable range for each integer hyperparameter.
    */
  var IntegerParameterRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.IntegerParameterRanges] = js.native
}
