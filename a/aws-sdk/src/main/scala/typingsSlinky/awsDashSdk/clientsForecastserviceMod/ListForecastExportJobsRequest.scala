...
trait ListForecastExportJobsRequest extends js.Object {
  /**
    ...
    */
  var Filters: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Filters] = js.native
  /**
    * The number of items to return in the response.
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.MaxResults] = js.native
  /**
    * If the result of the previous request was truncated, the response includes a NextToken. To retrieve the next set of results, use the token in the next request. Tokens expire after 24 hours.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.NextToken] = js.native
}
