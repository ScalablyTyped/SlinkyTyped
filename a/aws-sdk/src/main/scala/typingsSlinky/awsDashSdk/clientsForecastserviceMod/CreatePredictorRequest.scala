...
trait CreatePredictorRequest extends js.Object {
  ...
  /**
    ...
    */
  var EncryptionConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.EncryptionConfig] = js.native
  /**
    * Used to override the default evaluation parameters of the specified algorithm. Amazon Forecast evaluates a predictor by splitting a dataset into training data and testing data. The evaluation parameters define how to perform the split and the number of iterations.
    */
  var EvaluationParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.EvaluationParameters] = js.native
  /**
    * The featurization configuration.
    */
  var FeaturizationConfig: typingsSlinky.awsDashSdk.clientsForecastserviceMod.FeaturizationConfig = js.native
  /**
  ...
  /**
    ...
    */
  var InputDataConfig: typingsSlinky.awsDashSdk.clientsForecastserviceMod.InputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingParameters: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.TrainingParameters] = js.native
}
