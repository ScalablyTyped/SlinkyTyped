...
trait WindowSummary extends js.Object {
  /**
    ...
    */
  var EvaluationType: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.EvaluationType] = js.native
  /**
  ...
  /**
    ...
    */
  var Metrics: js.UndefOr[typingsSlinky.awsDashSdk.clientsForecastserviceMod.Metrics] = js.native
  /**
