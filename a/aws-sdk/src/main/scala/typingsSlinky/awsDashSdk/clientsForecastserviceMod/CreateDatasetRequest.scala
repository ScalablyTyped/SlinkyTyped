...
trait CreateDatasetRequest extends js.Object {
  ...
  /**
    ...
    */
  var DatasetType: typingsSlinky.awsDashSdk.clientsForecastserviceMod.DatasetType = js.native
  /**
  ...
  /**
    ...
    */
  var Schema: typingsSlinky.awsDashSdk.clientsForecastserviceMod.Schema = js.native
}
