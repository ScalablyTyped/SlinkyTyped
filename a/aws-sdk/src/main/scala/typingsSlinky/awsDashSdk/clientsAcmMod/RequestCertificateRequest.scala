...
trait RequestCertificateRequest extends js.Object {
  ...
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.IdempotencyToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ValidationMethod: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.ValidationMethod] = js.native
}
