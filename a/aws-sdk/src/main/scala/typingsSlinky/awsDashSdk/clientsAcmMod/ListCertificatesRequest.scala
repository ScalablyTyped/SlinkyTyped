...
trait ListCertificatesRequest extends js.Object {
  /**
    ...
    */
  var CertificateStatuses: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.CertificateStatuses] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxItems: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.MaxItems] = js.native
  /**
    * Use this parameter only when paginating results and only in a subsequent request after you receive a response with truncated results. Set it to the value of NextToken from the response you just received.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.NextToken] = js.native
}
