...
trait ExportCertificateResponse extends js.Object {
  ...
  /**
    ...
    */
  var CertificateChain: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.CertificateChain] = js.native
  /**
    * The encrypted private key associated with the public key in the certificate. The key is output in PKCS #8 format and is base64 PEM-encoded. 
    */
  var PrivateKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsAcmMod.PrivateKey] = js.native
}
