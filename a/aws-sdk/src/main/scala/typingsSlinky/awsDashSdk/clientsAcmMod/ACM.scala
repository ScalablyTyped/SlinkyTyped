...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.certificateValidated
...
trait ACM extends Service {
  @JSName("config")
  var config_ACM: ConfigBase with ClientConfiguration = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_certificateValidated(state: certificateValidated, params: DescribeCertificateRequest with Anon_Waiter): Request[DescribeCertificateResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_certificateValidated(
    state: certificateValidated,
    params: DescribeCertificateRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeCertificateResponse, Unit]
  ): Request[DescribeCertificateResponse, AWSError] = js.native
}
