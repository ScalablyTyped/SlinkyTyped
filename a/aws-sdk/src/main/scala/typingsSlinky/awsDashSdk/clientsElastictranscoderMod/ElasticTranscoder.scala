...
import typingsSlinky.awsDashSdk.awsDashSdkStrings.jobComplete
...
trait ElasticTranscoder extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_jobComplete(state: jobComplete, params: ReadJobRequest with Anon_Waiter): Request[ReadJobResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_jobComplete(
    state: jobComplete,
    params: ReadJobRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ ReadJobResponse, Unit]
  ): Request[ReadJobResponse, AWSError] = js.native
}
