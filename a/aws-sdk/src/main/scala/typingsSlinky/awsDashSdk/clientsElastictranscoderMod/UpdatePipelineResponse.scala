...
trait UpdatePipelineResponse extends js.Object {
  /**
    ...
    */
  var Pipeline: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Pipeline] = js.native
  /**
    ...
    */
  var Warnings: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Warnings] = js.native
}
