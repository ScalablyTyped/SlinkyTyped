...
trait CreateJobPlaylist extends js.Object {
  ...
  /**
    ...
    */
  var HlsContentProtection: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.HlsContentProtection] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputKeys: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.OutputKeys] = js.native
  /**
    * The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
    */
  var PlayReadyDrm: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.PlayReadyDrm] = js.native
}
