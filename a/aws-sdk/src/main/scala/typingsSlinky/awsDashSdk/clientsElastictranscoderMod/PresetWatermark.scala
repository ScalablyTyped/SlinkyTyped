...
trait PresetWatermark extends js.Object {
  /**
    ...
    */
  var HorizontalAlign: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.HorizontalAlign] = js.native
  /**
  ...
  /**
    ...
    */
  var Opacity: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Opacity] = js.native
  /**
  ...
  /**
    ...
    */
  var Target: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Target] = js.native
  /**
    ...
    */
  var VerticalAlign: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.VerticalAlign] = js.native
  /**
