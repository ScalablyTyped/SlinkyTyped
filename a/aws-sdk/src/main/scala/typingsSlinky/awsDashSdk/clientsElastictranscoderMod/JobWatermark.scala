...
trait JobWatermark extends js.Object {
  /**
    ...
    */
  var Encryption: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Encryption] = js.native
  /**
  ...
  /**
    ...
    */
  var PresetWatermarkId: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.PresetWatermarkId] = js.native
}
