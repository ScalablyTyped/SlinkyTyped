...
trait PipelineOutputConfig extends js.Object {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Permissions] = js.native
  /**
    ...
    */
  var StorageClass: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.StorageClass] = js.native
}
