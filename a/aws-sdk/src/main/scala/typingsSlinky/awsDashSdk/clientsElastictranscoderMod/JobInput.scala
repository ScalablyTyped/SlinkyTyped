...
trait JobInput extends js.Object {
  ...
  /**
    ...
    */
  var DetectedProperties: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.DetectedProperties] = js.native
  /**
  ...
  /**
    ...
    */
  var FrameRate: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.FrameRate] = js.native
  /**
    ...
    */
  var InputCaptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.InputCaptions] = js.native
  /**
    ...
    */
  var Interlaced: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Interlaced] = js.native
  /**
  ...
  /**
    ...
    */
  var Resolution: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Resolution] = js.native
  /**
    * Settings for clipping an input. Each input can have different clip settings.
    */
  var TimeSpan: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.TimeSpan] = js.native
}
