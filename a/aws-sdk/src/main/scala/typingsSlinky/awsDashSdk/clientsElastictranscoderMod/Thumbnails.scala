...
trait Thumbnails extends js.Object {
  /**
    ...
    */
  var AspectRatio: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.AspectRatio] = js.native
  /**
  ...
  /**
    ...
    */
  var PaddingPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.PaddingPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var SizingPolicy: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.SizingPolicy] = js.native
}
