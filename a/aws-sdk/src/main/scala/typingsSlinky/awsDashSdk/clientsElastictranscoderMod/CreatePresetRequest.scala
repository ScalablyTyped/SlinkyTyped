...
trait CreatePresetRequest extends js.Object {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Description] = js.native
  /**
    * The name of the preset. We recommend that the name be unique within the AWS account, but uniqueness is not enforced.
    */
  var Name: typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Name = js.native
  /**
    * A section of the request body that specifies the thumbnail parameters, if any.
    */
  var Thumbnails: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.Thumbnails] = js.native
  /**
