...
trait Captions extends js.Object {
  /**
    ...
    */
  var CaptionFormats: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.CaptionFormats] = js.native
  /**
    * Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave CaptionSources blank.
    */
  var CaptionSources: js.UndefOr[typingsSlinky.awsDashSdk.clientsElastictranscoderMod.CaptionSources] = js.native
  /**
