package typingsSlinky.awsDashSdk.clientsMediatailorMod
...
trait GetPlaybackConfigurationResponse extends js.Object {
  ...
  /**
    ...
    */
  var CdnConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediatailorMod.CdnConfiguration] = js.native
  /**
    * The configuration for DASH content. 
    */
  var DashConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediatailorMod.DashConfiguration] = js.native
  /**
    * The configuration for HLS content. 
    */
  var HlsConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediatailorMod.HlsConfiguration] = js.native
  /**
    * The configuration for pre-roll ad insertion.
    */
  var LivePreRollConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsMediatailorMod.LivePreRollConfiguration] = js.native
  /**
