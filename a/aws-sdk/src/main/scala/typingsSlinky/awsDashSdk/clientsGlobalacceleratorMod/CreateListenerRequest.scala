...
trait CreateListenerRequest extends js.Object {
  ...
  /**
    ...
    */
  var ClientAffinity: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.ClientAffinity] = js.native
  /**
    * A unique, case-sensitive identifier that you provide to ensure the idempotency—that is, the uniqueness—of the request.
    */
  var IdempotencyToken: typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.IdempotencyToken = js.native
  /**
    * The list of port ranges to support for connections from clients to your accelerator.
    */
  var PortRanges: typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.PortRanges = js.native
  /**
    * The protocol for connections from clients to your accelerator.
    */
  var Protocol: typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.Protocol = js.native
}
