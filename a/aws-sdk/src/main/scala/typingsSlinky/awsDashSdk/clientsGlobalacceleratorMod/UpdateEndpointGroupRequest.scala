...
trait UpdateEndpointGroupRequest extends js.Object {
  /**
    ...
    */
  var EndpointConfigurations: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.EndpointConfigurations] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckIntervalSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckIntervalSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckPort: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckPort] = js.native
  /**
    * The protocol that AWS Global Accelerator uses to check the health of endpoints that are part of this endpoint group. The default value is TCP.
    */
  var HealthCheckProtocol: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckProtocol] = js.native
  /**
    * The number of consecutive health checks required to set the state of a healthy endpoint to unhealthy, or to set an unhealthy endpoint to healthy. The default value is 3.
    */
  var ThresholdCount: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.ThresholdCount] = js.native
  /**
    ...
    */
  var TrafficDialPercentage: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.TrafficDialPercentage] = js.native
}
