...
trait UpdateListenerRequest extends js.Object {
  ...
  /**
    ...
    */
  var PortRanges: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.PortRanges] = js.native
  /**
    * The updated protocol for the connections from clients to the accelerator.
    */
  var Protocol: js.UndefOr[typingsSlinky.awsDashSdk.clientsGlobalacceleratorMod.Protocol] = js.native
}
