...
trait CreateAccountStatus extends js.Object {
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsSlinky.awsDashSdk.clientsOrganizationsMod.AccountId] = js.native
  /**
    * The account name given to the account when it was created.
    */
  var AccountName: js.UndefOr[typingsSlinky.awsDashSdk.clientsOrganizationsMod.AccountName] = js.native
  /**
