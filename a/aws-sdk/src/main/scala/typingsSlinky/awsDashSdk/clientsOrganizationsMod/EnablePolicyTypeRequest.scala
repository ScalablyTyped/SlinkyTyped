...
trait EnablePolicyTypeRequest extends js.Object {
  /**
    ...
    */
  var PolicyType: typingsSlinky.awsDashSdk.clientsOrganizationsMod.PolicyType = js.native
  /**
    ...
    */
  var RootId: typingsSlinky.awsDashSdk.clientsOrganizationsMod.RootId = js.native
}
