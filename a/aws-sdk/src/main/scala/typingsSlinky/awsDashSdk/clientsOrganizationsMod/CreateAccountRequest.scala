...
trait CreateAccountRequest extends js.Object {
  /**
    ...
    */
  var AccountName: typingsSlinky.awsDashSdk.clientsOrganizationsMod.AccountName = js.native
  /**
    * The email address of the owner to assign to the new member account. This email address must not already be associated with another AWS account. You must use a valid email address to complete account creation. You can't access the root user of the account or remove an account that was created with an invalid email address.
    */
  var Email: typingsSlinky.awsDashSdk.clientsOrganizationsMod.Email = js.native
  /**
  ...
  /**
    ...
    */
  var RoleName: js.UndefOr[typingsSlinky.awsDashSdk.clientsOrganizationsMod.RoleName] = js.native
}
