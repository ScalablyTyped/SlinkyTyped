...
trait PutRecordBatchResponseEntry extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ErrorCode] = js.native
  /**
    * The error message for an individual record result.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ErrorMessage] = js.native
  /**
