...
trait BufferingHints extends js.Object {
  /**
    ...
    */
  var IntervalInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.IntervalInSeconds] = js.native
  /**
    ...
    */
  var SizeInMBs: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.SizeInMBs] = js.native
}
