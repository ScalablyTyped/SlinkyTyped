...
trait SplunkDestinationConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var HECEndpoint: typingsSlinky.awsDashSdk.clientsFirehoseMod.HECEndpoint = js.native
  /**
    * This type can be either "Raw" or "Event."
    */
  var HECEndpointType: typingsSlinky.awsDashSdk.clientsFirehoseMod.HECEndpointType = js.native
  /**
    * This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.
    */
  var HECToken: typingsSlinky.awsDashSdk.clientsFirehoseMod.HECToken = js.native
  /**
