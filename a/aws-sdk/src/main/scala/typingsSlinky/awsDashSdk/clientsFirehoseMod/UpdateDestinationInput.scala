...
trait UpdateDestinationInput extends js.Object {
  ...
  /**
    ...
    */
  var ElasticsearchDestinationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ElasticsearchDestinationUpdate] = js.native
  /**
    * Describes an update for a destination in Amazon S3.
    */
  var ExtendedS3DestinationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ExtendedS3DestinationUpdate] = js.native
  /**
    * Describes an update for a destination in Amazon Redshift.
    */
  var RedshiftDestinationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.RedshiftDestinationUpdate] = js.native
  /**
    * [Deprecated] Describes an update for a destination in Amazon S3.
    */
  var S3DestinationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.S3DestinationUpdate] = js.native
  /**
    * Describes an update for a destination in Splunk.
    */
  var SplunkDestinationUpdate: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.SplunkDestinationUpdate] = js.native
}
