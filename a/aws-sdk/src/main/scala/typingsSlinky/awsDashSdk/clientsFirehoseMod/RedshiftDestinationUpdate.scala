...
trait RedshiftDestinationUpdate extends js.Object {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ClusterJDBCURL] = js.native
  /**
    * The COPY command.
    */
  var CopyCommand: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.CopyCommand] = js.native
  /**
    * The user password.
    */
  var Password: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.Password] = js.native
  /**
  ...
  /**
    ...
    */
  var Username: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.Username] = js.native
}
