...
trait DestinationDescription extends js.Object {
  /**
    ...
    */
  var DestinationId: typingsSlinky.awsDashSdk.clientsFirehoseMod.DestinationId = js.native
  /**
    * The destination in Amazon ES.
    */
  var ElasticsearchDestinationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ElasticsearchDestinationDescription] = js.native
  /**
    * The destination in Amazon S3.
    */
  var ExtendedS3DestinationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ExtendedS3DestinationDescription] = js.native
  /**
    * The destination in Amazon Redshift.
    */
  var RedshiftDestinationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.RedshiftDestinationDescription] = js.native
  /**
    * [Deprecated] The destination in Amazon S3.
    */
  var S3DestinationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.S3DestinationDescription] = js.native
  /**
    * The destination in Splunk.
    */
  var SplunkDestinationDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.SplunkDestinationDescription] = js.native
}
