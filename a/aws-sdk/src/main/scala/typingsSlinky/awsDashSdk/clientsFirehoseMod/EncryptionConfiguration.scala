...
trait EncryptionConfiguration extends js.Object {
  /**
    * The encryption key.
    */
  var KMSEncryptionConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.KMSEncryptionConfig] = js.native
  /**
    * Specifically override existing encryption information to ensure that no encryption is used.
    */
  var NoEncryptionConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.NoEncryptionConfig] = js.native
}
