...
trait SplunkDestinationDescription extends js.Object {
  ...
  /**
    ...
    */
  var HECAcknowledgmentTimeoutInSeconds: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.HECAcknowledgmentTimeoutInSeconds] = js.native
  /**
    * The HTTP Event Collector (HEC) endpoint to which Kinesis Data Firehose sends your data.
    */
  var HECEndpoint: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.HECEndpoint] = js.native
  /**
    * This type can be either "Raw" or "Event."
    */
  var HECEndpointType: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.HECEndpointType] = js.native
  /**
    * A GUID you obtain from your Splunk cluster when you create a new HEC endpoint.
    */
  var HECToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.HECToken] = js.native
  /**
