...
trait DeliveryStreamDescription extends js.Object {
  ...
  /**
    ...
    */
  var DeliveryStreamARN: typingsSlinky.awsDashSdk.clientsFirehoseMod.DeliveryStreamARN = js.native
  /**
    * Indicates the server-side encryption (SSE) status for the delivery stream.
    */
  var DeliveryStreamEncryptionConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsFirehoseMod.DeliveryStreamEncryptionConfiguration
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var DeliveryStreamStatus: typingsSlinky.awsDashSdk.clientsFirehoseMod.DeliveryStreamStatus = js.native
  /**
    ...
    */
  var DeliveryStreamType: typingsSlinky.awsDashSdk.clientsFirehoseMod.DeliveryStreamType = js.native
  /**
    * The destinations.
    */
