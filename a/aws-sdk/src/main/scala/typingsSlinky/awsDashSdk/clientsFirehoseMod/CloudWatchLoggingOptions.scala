...
trait CloudWatchLoggingOptions extends js.Object {
  ...
  /**
    ...
    */
  var LogGroupName: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.LogGroupName] = js.native
  /**
    * The CloudWatch log stream name for logging. This value is required if CloudWatch logging is enabled.
    */
  var LogStreamName: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.LogStreamName] = js.native
}
