...
trait ExtendedS3DestinationConfiguration extends js.Object {
  /**
    ...
    */
  var BucketARN: typingsSlinky.awsDashSdk.clientsFirehoseMod.BucketARN = js.native
  /**
    * The buffering option.
    */
  var BufferingHints: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.BufferingHints] = js.native
  /**
  ...
  /**
    ...
    */
  var CompressionFormat: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.CompressionFormat] = js.native
  /**
    * The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.
    */
  var DataFormatConversionConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.DataFormatConversionConfiguration] = js.native
  /**
    * The encryption configuration. If no value is specified, the default is no encryption.
    */
  var EncryptionConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.EncryptionConfiguration] = js.native
  /**
    * A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see Custom Prefixes for Amazon S3 Objects.
    */
  var ErrorOutputPrefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ErrorOutputPrefix] = js.native
  /**
    * The "YYYY/MM/DD/HH" time format prefix is automatically used for delivered Amazon S3 files. You can also specify a custom prefix, as described in Custom Prefixes for Amazon S3 Objects.
    */
  var Prefix: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.Prefix] = js.native
  /**
  ...
  /**
    ...
    */
  var S3BackupMode: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.S3BackupMode] = js.native
}
