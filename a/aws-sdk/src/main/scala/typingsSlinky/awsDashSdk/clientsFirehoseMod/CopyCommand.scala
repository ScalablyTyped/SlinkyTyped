...
trait CopyCommand extends js.Object {
  /**
    ...
    */
  var CopyOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.CopyOptions] = js.native
  /**
    * A comma-separated list of column names.
    */
  var DataTableColumns: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.DataTableColumns] = js.native
  /**
    * The name of the target table. The table must already exist in the database.
    */
  var DataTableName: typingsSlinky.awsDashSdk.clientsFirehoseMod.DataTableName = js.native
}
