...
trait DeliveryStreamEncryptionConfiguration extends js.Object {
  /**
    ...
    */
  var FailureDescription: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.FailureDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var KeyType: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.KeyType] = js.native
  /**
