...
trait Serializer extends js.Object {
  /**
    ...
    */
  var OrcSerDe: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.OrcSerDe] = js.native
  /**
    * A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see Apache Parquet.
    */
  var ParquetSerDe: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ParquetSerDe] = js.native
}
