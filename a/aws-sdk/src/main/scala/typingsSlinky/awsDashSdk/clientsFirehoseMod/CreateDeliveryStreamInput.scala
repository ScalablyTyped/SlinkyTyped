...
trait CreateDeliveryStreamInput extends js.Object {
  ...
  /**
    ...
    */
  var ElasticsearchDestinationConfiguration: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsFirehoseMod.ElasticsearchDestinationConfiguration
  ] = js.native
  /**
    * The destination in Amazon S3. You can specify only one destination.
    */
  var ExtendedS3DestinationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.ExtendedS3DestinationConfiguration] = js.native
  /**
    * When a Kinesis data stream is used as the source for the delivery stream, a KinesisStreamSourceConfiguration containing the Kinesis data stream Amazon Resource Name (ARN) and the role ARN for the source stream.
    */
  var KinesisStreamSourceConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.KinesisStreamSourceConfiguration] = js.native
  /**
    * The destination in Amazon Redshift. You can specify only one destination.
    */
  var RedshiftDestinationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.RedshiftDestinationConfiguration] = js.native
  /**
    * [Deprecated] The destination in Amazon S3. You can specify only one destination.
    */
  var S3DestinationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.S3DestinationConfiguration] = js.native
  /**
    * The destination in Splunk. You can specify only one destination.
    */
  var SplunkDestinationConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.SplunkDestinationConfiguration] = js.native
  /**
