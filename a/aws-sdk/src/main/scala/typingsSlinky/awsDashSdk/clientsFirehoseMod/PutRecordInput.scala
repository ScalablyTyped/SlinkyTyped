...
trait PutRecordInput extends js.Object {
  /**
    ...
    */
  var DeliveryStreamName: typingsSlinky.awsDashSdk.clientsFirehoseMod.DeliveryStreamName = js.native
  /**
    * The record.
    */
  var Record: typingsSlinky.awsDashSdk.clientsFirehoseMod.Record = js.native
}
