...
trait DataFormatConversionConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var InputFormatConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.InputFormatConfiguration] = js.native
  /**
    * Specifies the serializer that you want Kinesis Data Firehose to use to convert the format of your data to the Parquet or ORC format.
    */
  var OutputFormatConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.OutputFormatConfiguration] = js.native
  /**
    * Specifies the AWS Glue Data Catalog table that contains the column information.
    */
  var SchemaConfiguration: js.UndefOr[typingsSlinky.awsDashSdk.clientsFirehoseMod.SchemaConfiguration] = js.native
}
