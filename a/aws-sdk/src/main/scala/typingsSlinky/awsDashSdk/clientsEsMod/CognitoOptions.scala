...
trait CognitoOptions extends js.Object {
  ...
  /**
    ...
    */
  var IdentityPoolId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.IdentityPoolId] = js.native
  /**
    * Specifies the role ARN that provides Elasticsearch permissions for accessing Cognito resources.
    */
  var RoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.RoleArn] = js.native
  /**
    * Specifies the Cognito user pool ID for Kibana authentication.
    */
  var UserPoolId: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.UserPoolId] = js.native
}
