...
trait ElasticsearchDomainStatus extends js.Object {
  ...
  /**
    ...
    */
  var DomainId: typingsSlinky.awsDashSdk.clientsEsMod.DomainId = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticsearchClusterConfig: typingsSlinky.awsDashSdk.clientsEsMod.ElasticsearchClusterConfig = js.native
  var ElasticsearchVersion: js.UndefOr[ElasticsearchVersionString] = js.native
  /**
    *  Specifies the status of the EncryptionAtRestOptions.
    */
  var EncryptionAtRestOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.EncryptionAtRestOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var NodeToNodeEncryptionOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.NodeToNodeEncryptionOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceSoftwareOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.ServiceSoftwareOptions] = js.native
  /**
