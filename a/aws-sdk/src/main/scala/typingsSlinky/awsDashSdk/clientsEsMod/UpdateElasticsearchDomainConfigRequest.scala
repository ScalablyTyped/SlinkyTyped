...
trait UpdateElasticsearchDomainConfigRequest extends js.Object {
  ...
  /**
    ...
    */
  var AdvancedOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.AdvancedOptions] = js.native
  /**
    * Options to specify the Cognito user and identity pools for Kibana authentication. For more information, see Amazon Cognito Authentication for Kibana.
    */
  var CognitoOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.CognitoOptions] = js.native
  /**
    * Options to specify configuration that will be applied to the domain endpoint.
    */
  var DomainEndpointOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.DomainEndpointOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var EBSOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.EBSOptions] = js.native
  /**
    * The type and number of instances to instantiate for the domain cluster.
    */
  var ElasticsearchClusterConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.ElasticsearchClusterConfig] = js.native
  /**
    * Map of LogType and LogPublishingOption, each containing options to publish a given type of Elasticsearch log.
    */
  var LogPublishingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.LogPublishingOptions] = js.native
  /**
    * Option to set the time, in UTC format, for the daily automated snapshot. Default value is 0 hours. 
    */
  var SnapshotOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.SnapshotOptions] = js.native
  /**
    * Options to specify the subnets and security groups for VPC endpoint. For more information, see Creating a VPC in VPC Endpoints for Amazon Elasticsearch Service Domains
    */
  var VPCOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.VPCOptions] = js.native
}
