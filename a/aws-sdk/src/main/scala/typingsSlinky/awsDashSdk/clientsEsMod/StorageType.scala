...
trait StorageType extends js.Object {
  var StorageSubTypeName: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.StorageSubTypeName] = js.native
  /**
    * List of limits that are applicable for given storage type. 
    */
  var StorageTypeLimits: js.UndefOr[StorageTypeLimitList] = js.native
  var StorageTypeName: js.UndefOr[typingsSlinky.awsDashSdk.clientsEsMod.StorageTypeName] = js.native
}
