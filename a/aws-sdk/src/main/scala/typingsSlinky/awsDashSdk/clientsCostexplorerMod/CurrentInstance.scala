...
trait CurrentInstance extends js.Object {
  ...
  /**
    ...
    */
  var ResourceDetails: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ResourceDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceUtilization: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ResourceUtilization] = js.native
  /**
