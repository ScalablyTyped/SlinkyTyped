...
trait GetSavingsPlansPurchaseRecommendationRequest extends js.Object {
  /**
    ...
    */
  var LookbackPeriodInDays: typingsSlinky.awsDashSdk.clientsCostexplorerMod.LookbackPeriodInDays = js.native
  /**
  ...
  /**
    ...
    */
  var PaymentOption: typingsSlinky.awsDashSdk.clientsCostexplorerMod.PaymentOption = js.native
  /**
  ...
  /**
    ...
    */
  var TermInYears: typingsSlinky.awsDashSdk.clientsCostexplorerMod.TermInYears = js.native
}
