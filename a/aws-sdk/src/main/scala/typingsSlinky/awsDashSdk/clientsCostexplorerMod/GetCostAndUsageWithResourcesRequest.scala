...
trait GetCostAndUsageWithResourcesRequest extends js.Object {
  ...
  /**
    ...
    */
  var Granularity: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.Granularity] = js.native
  /**
  ...
  /**
    ...
    */
  var NextPageToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.NextPageToken] = js.native
  /**
