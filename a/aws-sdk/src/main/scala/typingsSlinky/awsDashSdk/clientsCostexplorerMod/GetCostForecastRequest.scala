...
trait GetCostForecastRequest extends js.Object {
  ...
  /**
    ...
    */
  var Granularity: typingsSlinky.awsDashSdk.clientsCostexplorerMod.Granularity = js.native
  /**
    ...
    */
  var Metric: typingsSlinky.awsDashSdk.clientsCostexplorerMod.Metric = js.native
  /**
    * Cost Explorer always returns the mean forecast as a single point. You can request a prediction interval around the mean by specifying a confidence level. The higher the confidence level, the more confident Cost Explorer is about the actual value falling in the prediction interval. Higher confidence levels result in wider prediction intervals.
    */
  var PredictionIntervalLevel: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.PredictionIntervalLevel] = js.native
  /**
