...
trait CoverageHours extends js.Object {
  /**
    ...
    */
  var CoverageHoursPercentage: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.CoverageHoursPercentage] = js.native
  /**
    * The number of instance running hours that On-Demand Instances covered.
    */
  var OnDemandHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.OnDemandHours] = js.native
  /**
    * The number of instance running hours that reservations covered.
    */
  var ReservedHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ReservedHours] = js.native
  /**
    * The total instance usage, in hours.
    */
  var TotalRunningHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalRunningHours] = js.native
}
