...
trait Coverage extends js.Object {
  /**
    ...
    */
  var CoverageCost: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.CoverageCost] = js.native
  /**
    * The amount of instance usage that the reservation covered, in hours.
    */
  var CoverageHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.CoverageHours] = js.native
  /**
    * The amount of instance usage that the reservation covered, in normalized units.
    */
  var CoverageNormalizedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.CoverageNormalizedUnits] = js.native
}
