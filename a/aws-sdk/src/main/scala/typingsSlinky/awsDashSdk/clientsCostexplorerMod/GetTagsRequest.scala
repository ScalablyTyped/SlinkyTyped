...
trait GetTagsRequest extends js.Object {
  ...
  /**
    ...
    */
  var SearchString: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.SearchString] = js.native
  /**
    * The key of the tag that you want to return values for.
    */
  var TagKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TagKey] = js.native
  /**
