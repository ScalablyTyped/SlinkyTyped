...
trait ReservationAggregates extends js.Object {
  /**
    ...
    */
  var AmortizedRecurringFee: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.AmortizedRecurringFee] = js.native
  /**
    * The upfront cost of your reservation, amortized over the reservation period.
    */
  var AmortizedUpfrontFee: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.AmortizedUpfrontFee] = js.native
  /**
    ...
    */
  var NetRISavings: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.NetRISavings] = js.native
  /**
    * How much your reservation would cost if charged On-Demand rates.
    */
  var OnDemandCostOfRIHoursUsed: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.OnDemandCostOfRIHoursUsed] = js.native
  /**
    * How many reservation hours that you purchased.
    */
  var PurchasedHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.PurchasedHours] = js.native
  /**
    ...
    */
  var PurchasedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.PurchasedUnits] = js.native
  /**
    * The total number of reservation hours that you used.
    */
  var TotalActualHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalActualHours] = js.native
  /**
    ...
    */
  var TotalActualUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalActualUnits] = js.native
  /**
    * The total cost of your reservation, amortized over the reservation period.
    */
  var TotalAmortizedFee: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalAmortizedFee] = js.native
  /**
    * How much you could save if you use your entire reservation.
    */
  var TotalPotentialRISavings: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalPotentialRISavings] = js.native
  /**
    * The number of reservation hours that you didn't use.
    */
  var UnusedHours: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.UnusedHours] = js.native
  /**
    ...
    */
  var UnusedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.UnusedUnits] = js.native
  /**
    * The percentage of reservation time that you used.
    */
  var UtilizationPercentage: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.UtilizationPercentage] = js.native
  /**
    ...
    */
  var UtilizationPercentageInUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.UtilizationPercentageInUnits] = js.native
}
