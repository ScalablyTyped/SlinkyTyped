...
trait CoverageNormalizedUnits extends js.Object {
  /**
    ...
    */
  var CoverageNormalizedUnitsPercentage: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsCostexplorerMod.CoverageNormalizedUnitsPercentage
  ] = js.native
  /**
    * The number of normalized units that are covered by On-Demand Instances instead of a reservation.
    */
  var OnDemandNormalizedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.OnDemandNormalizedUnits] = js.native
  /**
    * The number of normalized units that a reservation covers.
    */
  var ReservedNormalizedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ReservedNormalizedUnits] = js.native
  /**
    * The total number of normalized units that you used.
    */
  var TotalRunningNormalizedUnits: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TotalRunningNormalizedUnits] = js.native
}
