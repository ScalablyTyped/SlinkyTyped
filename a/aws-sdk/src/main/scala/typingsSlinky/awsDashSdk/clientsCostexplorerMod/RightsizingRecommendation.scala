...
trait RightsizingRecommendation extends js.Object {
  ...
  /**
    ...
    */
  var CurrentInstance: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.CurrentInstance] = js.native
  /**
    *  Details for modification recommendations. 
    */
  var ModifyRecommendationDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ModifyRecommendationDetail] = js.native
  /**
    * Recommendation to either terminate or modify the resource.
    */
  var RightsizingType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.RightsizingType] = js.native
  /**
    * Details for termination recommendations.
    */
  var TerminateRecommendationDetail: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TerminateRecommendationDetail] = js.native
}
