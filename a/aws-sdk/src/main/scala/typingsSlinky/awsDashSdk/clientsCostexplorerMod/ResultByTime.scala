...
trait ResultByTime extends js.Object {
  /**
    ...
    */
  var Estimated: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.Estimated] = js.native
  /**
    * The groups that this time period includes.
    */
  var Groups: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.Groups] = js.native
  /**
