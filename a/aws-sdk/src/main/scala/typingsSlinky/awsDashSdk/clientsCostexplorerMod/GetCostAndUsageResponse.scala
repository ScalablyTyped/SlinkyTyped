...
trait GetCostAndUsageResponse extends js.Object {
  /**
    ...
    */
  var GroupDefinitions: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.GroupDefinitions] = js.native
  /**
  ...
  /**
    ...
    */
  var ResultsByTime: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ResultsByTime] = js.native
}
