...
trait GetDimensionValuesRequest extends js.Object {
  /**
    ...
    */
  var Context: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.Context] = js.native
  /**
    * The name of the dimension. Each Dimension is available for a different Context. For more information, see Context. 
    */
  var Dimension: typingsSlinky.awsDashSdk.clientsCostexplorerMod.Dimension = js.native
  /**
