...
trait GetReservationPurchaseRecommendationRequest extends js.Object {
  ...
  /**
    ...
    */
  var AccountScope: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.AccountScope] = js.native
  /**
  ...
  /**
    ...
    */
  var PaymentOption: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.PaymentOption] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceSpecification: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.ServiceSpecification] = js.native
  /**
    * The reservation term that you want recommendations for.
    */
  var TermInYears: js.UndefOr[typingsSlinky.awsDashSdk.clientsCostexplorerMod.TermInYears] = js.native
}
