...
trait CreateServerRequest extends js.Object {
  ...
  /**
    ...
    */
  var BackupId: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.BackupId] = js.native
  /**
  ...
  /**
    ...
    */
  var CustomCertificate: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.CustomCertificate] = js.native
  /**
    ...
    */
  var CustomDomain: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.CustomDomain] = js.native
  /**
    * Supported on servers running Chef Automate 2. A private key in PEM format for connecting to the server by using HTTPS. The private key must not be encrypted; it cannot be protected by a password or passphrase. If you specify a custom private key, you must also specify values for CustomDomain and CustomCertificate.
    */
  var CustomPrivateKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.CustomPrivateKey] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceProfileArn: typingsSlinky.awsDashSdk.clientsOpsworkscmMod.InstanceProfileArn = js.native
  /**
  ...
  /**
    ...
    */
  var KeyPair: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.KeyPair] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceRoleArn: typingsSlinky.awsDashSdk.clientsOpsworkscmMod.ServiceRoleArn = js.native
  /**
