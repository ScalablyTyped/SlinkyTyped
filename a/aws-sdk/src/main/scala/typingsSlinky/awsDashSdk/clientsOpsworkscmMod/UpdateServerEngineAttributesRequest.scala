...
trait UpdateServerEngineAttributesRequest extends js.Object {
  /**
    ...
    */
  var AttributeName: typingsSlinky.awsDashSdk.clientsOpsworkscmMod.AttributeName = js.native
  /**
    * The value to set for the attribute. 
    */
  var AttributeValue: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.AttributeValue] = js.native
  /**
