...
trait AssociateNodeRequest extends js.Object {
  /**
    ...
    */
  var EngineAttributes: typingsSlinky.awsDashSdk.clientsOpsworkscmMod.EngineAttributes = js.native
  /**
    * The name of the node. 
    */
  var NodeName: typingsSlinky.awsDashSdk.clientsOpsworkscmMod.NodeName = js.native
  /**
