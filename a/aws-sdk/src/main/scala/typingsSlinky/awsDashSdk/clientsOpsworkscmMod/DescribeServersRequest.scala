...
trait DescribeServersRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.MaxResults] = js.native
  /**
    * This is not currently implemented for DescribeServers requests. 
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.NextToken] = js.native
  /**
    * Describes the server with the specified ServerName.
    */
  var ServerName: js.UndefOr[typingsSlinky.awsDashSdk.clientsOpsworkscmMod.ServerName] = js.native
}
