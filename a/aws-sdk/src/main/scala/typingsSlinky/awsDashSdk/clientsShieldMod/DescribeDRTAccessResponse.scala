...
trait DescribeDRTAccessResponse extends js.Object {
  /**
    ...
    */
  var LogBucketList: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.LogBucketList] = js.native
  /**
    * The Amazon Resource Name (ARN) of the role the DRT used to access your AWS account.
    */
  var RoleArn: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.RoleArn] = js.native
}
