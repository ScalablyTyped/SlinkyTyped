...
trait AttackProperty extends js.Object {
  /**
    ...
    */
  var AttackLayer: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.AttackLayer] = js.native
  /**
    ...
    */
  var AttackPropertyIdentifier: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.AttackPropertyIdentifier] = js.native
  /**
    * The array of Contributor objects that includes the top five contributors to an attack. 
    */
  var TopContributors: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.TopContributors] = js.native
  /**
  ...
  /**
    ...
    */
  var Unit: js.UndefOr[typingsSlinky.awsDashSdk.clientsShieldMod.Unit] = js.native
}
