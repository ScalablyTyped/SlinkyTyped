...
trait ComplianceViolator extends js.Object {
  /**
    * The resource ID.
    */
  var ResourceId: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.ResourceId] = js.native
  /**
  ...
  /**
    ...
    */
  var ViolationReason: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.ViolationReason] = js.native
}
