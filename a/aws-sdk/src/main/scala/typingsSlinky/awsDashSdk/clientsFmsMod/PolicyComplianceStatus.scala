...
trait PolicyComplianceStatus extends js.Object {
  /**
    ...
    */
  var EvaluationResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.EvaluationResults] = js.native
  /**
    * Details about problems with dependent services, such as AWS WAF or AWS Config, that are causing a resource to be noncompliant. The details include the name of the dependent service and the error message received that indicates the problem with the service.
    */
  var IssueInfoMap: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.IssueInfoMap] = js.native
  /**
