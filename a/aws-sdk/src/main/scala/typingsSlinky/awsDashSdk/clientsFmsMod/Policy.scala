...
trait Policy extends js.Object {
  ...
  /**
    ...
    */
  var PolicyUpdateToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.PolicyUpdateToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceTags: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.ResourceTags] = js.native
  /**
    ...
    */
  var ResourceType: typingsSlinky.awsDashSdk.clientsFmsMod.ResourceType = js.native
  /**
    * An array of ResourceType.
    */
  var ResourceTypeList: js.UndefOr[typingsSlinky.awsDashSdk.clientsFmsMod.ResourceTypeList] = js.native
  /**
    * Details about the security service that is being used to protect the resources.
    */
  var SecurityServicePolicyData: typingsSlinky.awsDashSdk.clientsFmsMod.SecurityServicePolicyData = js.native
}
