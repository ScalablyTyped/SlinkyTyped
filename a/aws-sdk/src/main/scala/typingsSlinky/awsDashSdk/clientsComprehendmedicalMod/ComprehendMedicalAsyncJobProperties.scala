...
trait ComprehendMedicalAsyncJobProperties extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.InputDataConfig] = js.native
  /**
    * The identifier assigned to the detection job.
    */
  var JobId: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.JobId] = js.native
  /**
    * The name that you assigned to the detection job.
    */
  var JobName: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.JobName] = js.native
  /**
    * The current status of the detection job. If the status is FAILED, the Message field shows the reason for the failure.
    */
  var JobStatus: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.JobStatus] = js.native
  /**
    * The AWS Key Management Service key, if any, used to encrypt the output files. 
    */
  var KMSKey: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.KMSKey] = js.native
  /**
    * The language code of the input documents.
    */
  var LanguageCode: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.LanguageCode] = js.native
  /**
    * The path to the file that describes the results of a batch job.
    */
  var ManifestFilePath: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.ManifestFilePath] = js.native
  /**
  ...
  /**
    ...
    */
  var ModelVersion: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.ModelVersion] = js.native
  /**
    * The output data configuration that you supplied when you created the detection job.
    */
  var OutputDataConfig: js.UndefOr[typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.OutputDataConfig] = js.native
  /**
