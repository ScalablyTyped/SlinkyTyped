...
trait StartPHIDetectionJobRequest extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.InputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageCode: typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.LanguageCode = js.native
  /**
    * Specifies where to send the output files.
    */
  var OutputDataConfig: typingsSlinky.awsDashSdk.clientsComprehendmedicalMod.OutputDataConfig = js.native
}
