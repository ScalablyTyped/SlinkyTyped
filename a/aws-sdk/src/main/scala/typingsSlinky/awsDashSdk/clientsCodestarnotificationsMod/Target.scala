...
trait Target extends js.Object {
  /**
    ...
    */
  var TargetAddress: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.TargetAddress] = js.native
  /**
    * The target type. Can be an Amazon SNS topic.
    */
  var TargetType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.TargetType] = js.native
}
