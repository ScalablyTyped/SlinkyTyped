...
trait CreateNotificationRuleRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.ClientRequestToken] = js.native
  /**
    * The level of detail to include in the notifications for this resource. BASIC will include only the contents of the event as it would appear in AWS CloudWatch. FULL will include any supplemental information provided by AWS CodeStar Notifications and/or the service for the resource for which the notification is created.
    */
  var DetailType: typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.DetailType = js.native
  /**
    * A list of event types associated with this notification rule. For a list of allowed events, see EventTypeSummary.
    */
  var EventTypeIds: typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.EventTypeIds = js.native
  /**
  ...
  /**
    ...
    */
  var Targets: typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.Targets = js.native
}
