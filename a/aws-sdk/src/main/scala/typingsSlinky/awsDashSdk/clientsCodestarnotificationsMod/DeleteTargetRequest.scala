...
trait DeleteTargetRequest extends js.Object {
  /**
    ...
    */
  var ForceUnsubscribeAll: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.ForceUnsubscribeAll] = js.native
  /**
    * The Amazon Resource Name (ARN) of the SNS topic to delete.
    */
  var TargetAddress: typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.TargetAddress = js.native
}
