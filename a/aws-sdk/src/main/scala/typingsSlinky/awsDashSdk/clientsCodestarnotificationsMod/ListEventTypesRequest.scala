...
trait ListEventTypesRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.MaxResults] = js.native
  /**
    * An enumeration token that, when provided in a request, returns the next batch of the results.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.NextToken] = js.native
}
