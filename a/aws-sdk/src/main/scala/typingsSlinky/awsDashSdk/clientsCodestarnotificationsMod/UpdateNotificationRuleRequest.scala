...
trait UpdateNotificationRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var DetailType: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.DetailType] = js.native
  /**
    * A list of event types associated with this notification rule.
    */
  var EventTypeIds: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.EventTypeIds] = js.native
  /**
  ...
  /**
    ...
    */
  var Targets: js.UndefOr[typingsSlinky.awsDashSdk.clientsCodestarnotificationsMod.Targets] = js.native
}
