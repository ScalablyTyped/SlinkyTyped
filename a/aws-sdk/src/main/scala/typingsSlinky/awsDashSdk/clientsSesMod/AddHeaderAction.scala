...
trait AddHeaderAction extends js.Object {
  /**
    ...
    */
  var HeaderName: typingsSlinky.awsDashSdk.clientsSesMod.HeaderName = js.native
  /**
    * Must be less than 2048 characters, and must not contain newline characters ("\r" or "\n").
    */
  var HeaderValue: typingsSlinky.awsDashSdk.clientsSesMod.HeaderValue = js.native
}
