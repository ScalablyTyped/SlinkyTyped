...
trait IdentityVerificationAttributes extends js.Object {
  /**
    ...
    */
  var VerificationStatus: typingsSlinky.awsDashSdk.clientsSesMod.VerificationStatus = js.native
  /**
    * The verification token for a domain identity. Null for email address identities.
    */
  var VerificationToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.VerificationToken] = js.native
}
