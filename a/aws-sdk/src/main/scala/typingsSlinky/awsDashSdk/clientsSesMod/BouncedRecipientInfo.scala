...
trait BouncedRecipientInfo extends js.Object {
  /**
    ...
    */
  var BounceType: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.BounceType] = js.native
  /**
  ...
  /**
    ...
    */
  var RecipientDsnFields: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.RecipientDsnFields] = js.native
}
