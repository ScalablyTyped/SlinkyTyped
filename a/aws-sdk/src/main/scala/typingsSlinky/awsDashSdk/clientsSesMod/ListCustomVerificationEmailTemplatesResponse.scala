...
trait ListCustomVerificationEmailTemplatesResponse extends js.Object {
  /**
    ...
    */
  var CustomVerificationEmailTemplates: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.CustomVerificationEmailTemplates] = js.native
  /**
    * A token indicating that there are additional custom verification email templates available to be listed. Pass this token to a subsequent call to ListTemplates to retrieve the next 50 custom verification email templates.
    */
  var NextToken: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.NextToken] = js.native
}
