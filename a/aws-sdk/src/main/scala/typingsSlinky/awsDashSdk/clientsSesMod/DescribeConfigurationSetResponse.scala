...
trait DescribeConfigurationSetResponse extends js.Object {
  /**
    ...
    */
  var ConfigurationSet: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.ConfigurationSet] = js.native
  var DeliveryOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.DeliveryOptions] = js.native
  /**
    * A list of event destinations associated with the configuration set. 
    */
  var EventDestinations: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.EventDestinations] = js.native
  /**
    * An object that represents the reputation settings for the configuration set. 
    */
  var ReputationOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.ReputationOptions] = js.native
  /**
    * The name of the custom open and click tracking domain associated with the configuration set.
    */
  var TrackingOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.TrackingOptions] = js.native
}
