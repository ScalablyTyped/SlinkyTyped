...
trait UpdateCustomVerificationEmailTemplateRequest extends js.Object {
  /**
    ...
    */
  var FailureRedirectionURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.FailureRedirectionURL] = js.native
  /**
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.SuccessRedirectionURL] = js.native
  /**
    * The content of the custom verification email. The total size of the email must be less than 10 MB. The message body may contain HTML, with some limitations. For more information, see Custom Verification Email Frequently Asked Questions in the Amazon SES Developer Guide.
    */
  var TemplateContent: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.TemplateContent] = js.native
  /**
    * The name of the custom verification email template that you want to update.
    */
  var TemplateName: typingsSlinky.awsDashSdk.clientsSesMod.TemplateName = js.native
  /**
