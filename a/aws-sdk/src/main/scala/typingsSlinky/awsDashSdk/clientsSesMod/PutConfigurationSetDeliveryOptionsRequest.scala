...
trait PutConfigurationSetDeliveryOptionsRequest extends js.Object {
  /**
    ...
    */
  var ConfigurationSetName: typingsSlinky.awsDashSdk.clientsSesMod.ConfigurationSetName = js.native
  /**
    * Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS).
    */
  var DeliveryOptions: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.DeliveryOptions] = js.native
}
