...
trait ReceiptAction extends js.Object {
  /**
    ...
    */
  var AddHeaderAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.AddHeaderAction] = js.native
  /**
    * Rejects the received email by returning a bounce response to the sender and, optionally, publishes a notification to Amazon Simple Notification Service (Amazon SNS).
    */
  var BounceAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.BounceAction] = js.native
  /**
    * Calls an AWS Lambda function, and optionally, publishes a notification to Amazon SNS.
    */
  var LambdaAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.LambdaAction] = js.native
  /**
    * Saves the received message to an Amazon Simple Storage Service (Amazon S3) bucket and, optionally, publishes a notification to Amazon SNS.
    */
  var S3Action: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.S3Action] = js.native
  /**
    * Publishes the email content within a notification to Amazon SNS.
    */
  var SNSAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.SNSAction] = js.native
  /**
    * Terminates the evaluation of the receipt rule set and optionally publishes a notification to Amazon SNS.
    */
  var StopAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.StopAction] = js.native
  /**
    * Calls Amazon WorkMail and, optionally, publishes a notification to Amazon Amazon SNS.
    */
  var WorkmailAction: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.WorkmailAction] = js.native
}
