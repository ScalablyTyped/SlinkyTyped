...
trait SetIdentityNotificationTopicRequest extends js.Object {
  /**
    ...
    */
  var Identity: typingsSlinky.awsDashSdk.clientsSesMod.Identity = js.native
  /**
    * The type of notifications that will be published to the specified Amazon SNS topic.
    */
  var NotificationType: typingsSlinky.awsDashSdk.clientsSesMod.NotificationType = js.native
  /**
