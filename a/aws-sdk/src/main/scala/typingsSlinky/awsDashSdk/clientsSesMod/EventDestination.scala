...
trait EventDestination extends js.Object {
  /**
    ...
    */
  var CloudWatchDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.CloudWatchDestination] = js.native
  /**
    * Sets whether Amazon SES publishes events to this destination when you send an email with the associated configuration set. Set to true to enable publishing to this destination; set to false to prevent publishing to this destination. The default value is false.
    */
  var Enabled: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.Enabled] = js.native
  /**
    * An object that contains the delivery stream ARN and the IAM role ARN associated with an Amazon Kinesis Firehose event destination.
    */
  var KinesisFirehoseDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.KinesisFirehoseDestination] = js.native
  /**
  ...
  /**
    ...
    */
  var SNSDestination: js.UndefOr[typingsSlinky.awsDashSdk.clientsSesMod.SNSDestination] = js.native
}
