...
trait ChallengeResponseType extends js.Object {
  /**
    * The challenge name
    */
  var ChallengeName: js.UndefOr[typingsSlinky.awsDashSdk.clientsCognitoidentityserviceproviderMod.ChallengeName] = js.native
  /**
    * The challenge response.
    */
  var ChallengeResponse: js.UndefOr[
    typingsSlinky.awsDashSdk.clientsCognitoidentityserviceproviderMod.ChallengeResponse
  ] = js.native
}
