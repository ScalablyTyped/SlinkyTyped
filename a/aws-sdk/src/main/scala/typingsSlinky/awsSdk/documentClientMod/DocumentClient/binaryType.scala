...
import typingsSlinky.awsSdk.documentClientMod.File
...
object binaryType {
  ...
  @scala.inline
  implicit def apply(value: typingsSlinky.awsSdk.documentClientMod.Blob): binaryType = value.asInstanceOf[binaryType]
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: File): binaryType = value.asInstanceOf[binaryType]
  @scala.inline
