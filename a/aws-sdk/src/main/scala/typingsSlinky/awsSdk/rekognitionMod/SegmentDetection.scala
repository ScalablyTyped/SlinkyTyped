...
trait SegmentDetection extends StObject {
  ...
  /**
    ...
    */
  var ShotSegment: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.ShotSegment] = js.native
  ...
  /**
    ...
    */
  var TechnicalCueSegment: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.TechnicalCueSegment] = js.native
