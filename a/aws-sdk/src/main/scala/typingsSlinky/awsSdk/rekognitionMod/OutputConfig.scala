...
trait OutputConfig extends StObject {
  ...
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.S3Bucket] = js.native
  
  /**
    * The prefix applied to the training output files. 
    */
  var S3KeyPrefix: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.S3KeyPrefix] = js.native
}
object OutputConfig {
