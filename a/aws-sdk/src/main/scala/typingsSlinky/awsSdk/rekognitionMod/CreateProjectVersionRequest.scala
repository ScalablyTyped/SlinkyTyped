...
trait CreateProjectVersionRequest extends StObject {
  ...
  /**
    ...
    */
  var OutputConfig: typingsSlinky.awsSdk.rekognitionMod.OutputConfig = js.native
  ...
  /**
    ...
    */
  var TestingData: typingsSlinky.awsSdk.rekognitionMod.TestingData = js.native
  
  /**
    * The dataset to use for training. 
    */
  var TrainingData: typingsSlinky.awsSdk.rekognitionMod.TrainingData = js.native
  
  /**
    * A name for the version of the model. This value must be unique.
    */
  var VersionName: typingsSlinky.awsSdk.rekognitionMod.VersionName = js.native
}
