...
trait HumanLoopActivationOutput extends js.Object {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typingsSlinky.awsSdk.rekognitionMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.native
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.HumanLoopActivationReasons] = js.native
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typingsSlinky.awsSdk.rekognitionMod.HumanLoopArn] = js.native
}
