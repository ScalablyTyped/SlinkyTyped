...
object GetContentModerationRequest {
  ...
  @scala.inline
  implicit class GetContentModerationRequestOps[Self <: GetContentModerationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSortBy(value: ContentModerationSortBy): Self = this.set("SortBy", value.asInstanceOf[js.Any])
