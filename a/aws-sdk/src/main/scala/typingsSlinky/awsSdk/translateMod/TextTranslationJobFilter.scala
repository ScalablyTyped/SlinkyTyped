...
object TextTranslationJobFilter {
  ...
  implicit class TextTranslationJobFilterMutableBuilder[Self <: TextTranslationJobFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubmittedAfterTime(value: js.Date): Self = StObject.set(x, "SubmittedAfterTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubmittedAfterTimeUndefined: Self = StObject.set(x, "SubmittedAfterTime", js.undefined)
    
    @scala.inline
    def setSubmittedBeforeTime(value: js.Date): Self = StObject.set(x, "SubmittedBeforeTime", value.asInstanceOf[js.Any])
