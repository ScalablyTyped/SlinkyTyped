...
object TextTranslationJobFilter {
  ...
  implicit class TextTranslationJobFilterOps[Self <: TextTranslationJobFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubmittedAfterTime(value: js.Date): Self = this.set("SubmittedAfterTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSubmittedAfterTime: Self = this.set("SubmittedAfterTime", js.undefined)
    @scala.inline
    def setSubmittedBeforeTime(value: js.Date): Self = this.set("SubmittedBeforeTime", value.asInstanceOf[js.Any])
    @scala.inline
