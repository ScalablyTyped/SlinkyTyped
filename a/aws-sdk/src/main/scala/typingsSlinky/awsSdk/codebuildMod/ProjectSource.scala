...
object ProjectSource {
  ...
  implicit class ProjectSourceOps[Self <: ProjectSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuth(value: SourceAuth): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGitCloneDepth(value: GitCloneDepth): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGitSubmodulesConfig(value: GitSubmodulesConfig): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInsecureSsl(value: WrapperBoolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReportBuildStatus(value: WrapperBoolean): Self = {
        val ret = this.duplicate
