...
object GetPatchBaselineResult {
  ...
  implicit class GetPatchBaselineResultOps[Self <: GetPatchBaselineResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPatchGroups(value: PatchGroupList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PatchGroups")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPatchGroups: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PatchGroups")(js.undefined)
        ret
    }
    @scala.inline
