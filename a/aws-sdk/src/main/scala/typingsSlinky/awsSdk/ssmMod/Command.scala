...
object Command {
  ...
  implicit class CommandOps[Self <: Command] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpiresAfter(value: js.Date): Self = this.set("ExpiresAfter", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRequestedDateTime(value: js.Date): Self = this.set("RequestedDateTime", value.asInstanceOf[js.Any])
    @scala.inline
