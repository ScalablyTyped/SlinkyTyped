...
object CommandPlugin {
  ...
  implicit class CommandPluginOps[Self <: CommandPlugin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponseFinishDateTime(value: js.Date): Self = this.set("ResponseFinishDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteResponseFinishDateTime: Self = this.set("ResponseFinishDateTime", js.undefined)
    
    @scala.inline
    def setResponseStartDateTime(value: js.Date): Self = this.set("ResponseStartDateTime", value.asInstanceOf[js.Any])
