...
object InstanceInformation {
  ...
  implicit class InstanceInformationMutableBuilder[Self <: InstanceInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastAssociationExecutionDate(value: js.Date): Self = StObject.set(x, "LastAssociationExecutionDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastAssociationExecutionDateUndefined: Self = StObject.set(x, "LastAssociationExecutionDate", js.undefined)
    
    @scala.inline
    def setLastPingDateTime(value: js.Date): Self = StObject.set(x, "LastPingDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastPingDateTimeUndefined: Self = StObject.set(x, "LastPingDateTime", js.undefined)
    
    @scala.inline
    def setLastSuccessfulAssociationExecutionDate(value: js.Date): Self = StObject.set(x, "LastSuccessfulAssociationExecutionDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRegistrationDate(value: js.Date): Self = StObject.set(x, "RegistrationDate", value.asInstanceOf[js.Any])
