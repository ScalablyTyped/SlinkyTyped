...
object ListComplianceSummariesResult {
  ...
  implicit class ListComplianceSummariesResultOps[Self <: ListComplianceSummariesResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComplianceSummaryItems(value: ComplianceSummaryItemList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComplianceSummaryItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutComplianceSummaryItems: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComplianceSummaryItems")(js.undefined)
        ret
    }
    @scala.inline
