...
object AssociationFilter {
  ...
  implicit class AssociationFilterOps[Self <: AssociationFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKey(value: AssociationFilterKey): Self = this.set("key", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setValue(value: AssociationFilterValue): Self = this.set("value", value.asInstanceOf[js.Any])
  }
}
