...
object InstancePatchState {
  ...
  implicit class InstancePatchStateMutableBuilder[Self <: InstancePatchState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastNoRebootInstallOperationTime(value: js.Date): Self = StObject.set(x, "LastNoRebootInstallOperationTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOperationEndTime(value: js.Date): Self = StObject.set(x, "OperationEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOperationStartTime(value: js.Date): Self = StObject.set(x, "OperationStartTime", value.asInstanceOf[js.Any])
