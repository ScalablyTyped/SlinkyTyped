...
object InstancePatchState {
  ...
  implicit class InstancePatchStateOps[Self <: InstancePatchState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperationEndTime(value: js.Date): Self = this.set("OperationEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOperationStartTime(value: js.Date): Self = this.set("OperationStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastNoRebootInstallOperationTime(value: js.Date): Self = this.set("LastNoRebootInstallOperationTime", value.asInstanceOf[js.Any])
