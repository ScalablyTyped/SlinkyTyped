...
object InventoryDeletionStatusItem {
  ...
  implicit class InventoryDeletionStatusItemOps[Self <: InventoryDeletionStatusItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeletionStartTime(value: js.Date): Self = this.set("DeletionStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastStatusUpdateTime(value: js.Date): Self = this.set("LastStatusUpdateTime", value.asInstanceOf[js.Any])
