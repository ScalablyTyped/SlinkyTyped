...
object ResourceDataSyncItem {
  ...
  implicit class ResourceDataSyncItemOps[Self <: ResourceDataSyncItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastSuccessfulSyncTime(value: js.Date): Self = this.set("LastSuccessfulSyncTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSyncCreatedTime(value: js.Date): Self = this.set("SyncCreatedTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSyncCreatedTime: Self = this.set("SyncCreatedTime", js.undefined)
    @scala.inline
    def setSyncLastModifiedTime(value: js.Date): Self = this.set("SyncLastModifiedTime", value.asInstanceOf[js.Any])
    @scala.inline
