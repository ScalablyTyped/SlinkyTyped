...
object ResourceDataSyncItem {
  ...
  implicit class ResourceDataSyncItemMutableBuilder[Self <: ResourceDataSyncItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastSuccessfulSyncTime(value: js.Date): Self = StObject.set(x, "LastSuccessfulSyncTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSyncCreatedTime(value: js.Date): Self = StObject.set(x, "SyncCreatedTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSyncCreatedTimeUndefined: Self = StObject.set(x, "SyncCreatedTime", js.undefined)
    
    @scala.inline
    def setSyncLastModifiedTime(value: js.Date): Self = StObject.set(x, "SyncLastModifiedTime", value.asInstanceOf[js.Any])
