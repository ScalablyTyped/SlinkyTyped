...
object ListResourceComplianceSummariesResult {
  ...
  implicit class ListResourceComplianceSummariesResultOps[Self <: ListResourceComplianceSummariesResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceComplianceSummaryItems(value: ResourceComplianceSummaryItemList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResourceComplianceSummaryItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResourceComplianceSummaryItems: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResourceComplianceSummaryItems")(js.undefined)
        ret
    }
  }
