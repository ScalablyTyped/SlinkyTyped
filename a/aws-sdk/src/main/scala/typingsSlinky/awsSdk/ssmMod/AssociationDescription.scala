...
object AssociationDescription {
  ...
  implicit class AssociationDescriptionOps[Self <: AssociationDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastSuccessfulExecutionDate(value: js.Date): Self = this.set("LastSuccessfulExecutionDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastSuccessfulExecutionDate: Self = this.set("LastSuccessfulExecutionDate", js.undefined)
    @scala.inline
    def setLastUpdateAssociationDate(value: js.Date): Self = this.set("LastUpdateAssociationDate", value.asInstanceOf[js.Any])
    @scala.inline
