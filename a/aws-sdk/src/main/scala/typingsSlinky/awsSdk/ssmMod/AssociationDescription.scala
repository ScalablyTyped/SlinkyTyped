...
object AssociationDescription {
  ...
  implicit class AssociationDescriptionMutableBuilder[Self <: AssociationDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastSuccessfulExecutionDate(value: js.Date): Self = StObject.set(x, "LastSuccessfulExecutionDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastSuccessfulExecutionDateUndefined: Self = StObject.set(x, "LastSuccessfulExecutionDate", js.undefined)
    
    @scala.inline
    def setLastUpdateAssociationDate(value: js.Date): Self = StObject.set(x, "LastUpdateAssociationDate", value.asInstanceOf[js.Any])
