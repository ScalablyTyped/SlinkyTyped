...
object ListResourceDataSyncResult {
  ...
  implicit class ListResourceDataSyncResultOps[Self <: ListResourceDataSyncResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceDataSyncItems(value: ResourceDataSyncItemList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResourceDataSyncItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResourceDataSyncItems: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResourceDataSyncItems")(js.undefined)
        ret
    }
  }
