...
object StepExecution {
  ...
  implicit class StepExecutionMutableBuilder[Self <: StepExecution] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExecutionEndTime(value: js.Date): Self = StObject.set(x, "ExecutionEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExecutionEndTimeUndefined: Self = StObject.set(x, "ExecutionEndTime", js.undefined)
    
    @scala.inline
    def setExecutionStartTime(value: js.Date): Self = StObject.set(x, "ExecutionStartTime", value.asInstanceOf[js.Any])
