...
object StepExecution {
  ...
  implicit class StepExecutionOps[Self <: StepExecution] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExecutionEndTime(value: js.Date): Self = this.set("ExecutionEndTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteExecutionEndTime: Self = this.set("ExecutionEndTime", js.undefined)
    @scala.inline
    def setExecutionStartTime(value: js.Date): Self = this.set("ExecutionStartTime", value.asInstanceOf[js.Any])
    @scala.inline
