...
object TlsValidationContext {
  ...
  @scala.inline
  implicit class TlsValidationContextOps[Self <: TlsValidationContext] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTrust(value: TlsValidationContextTrust): Self = this.set("trust", value.asInstanceOf[js.Any])
  }
