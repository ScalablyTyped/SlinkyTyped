...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait VirtualRouterStatusCode extends js.Object
...
object VirtualRouterStatusCode {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): VirtualRouterStatusCode = value.asInstanceOf[VirtualRouterStatusCode]
}
