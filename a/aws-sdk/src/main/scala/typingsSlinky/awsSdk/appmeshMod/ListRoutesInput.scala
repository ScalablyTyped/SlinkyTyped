...
object ListRoutesInput {
  ...
  @scala.inline
  implicit class ListRoutesInputOps[Self <: ListRoutesInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLimit(value: ListRoutesLimit): Self = this.set("limit", value.asInstanceOf[js.Any])
