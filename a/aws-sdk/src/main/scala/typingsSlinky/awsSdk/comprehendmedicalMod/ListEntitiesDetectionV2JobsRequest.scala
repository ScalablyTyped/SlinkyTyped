...
@js.native
trait ListEntitiesDetectionV2JobsRequest extends StObject {
...
object ListEntitiesDetectionV2JobsRequest {
  ...
  @scala.inline
  def apply(): ListEntitiesDetectionV2JobsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListEntitiesDetectionV2JobsRequest]
  }
  
  @scala.inline
  implicit class ListEntitiesDetectionV2JobsRequestMutableBuilder[Self <: ListEntitiesDetectionV2JobsRequest] (val x: Self) extends AnyVal {
