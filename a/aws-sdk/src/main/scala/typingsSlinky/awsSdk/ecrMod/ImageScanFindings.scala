...
object ImageScanFindings {
  ...
  implicit class ImageScanFindingsOps[Self <: ImageScanFindings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImageScanCompletedAt(value: js.Date): Self = this.set("imageScanCompletedAt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteImageScanCompletedAt: Self = this.set("imageScanCompletedAt", js.undefined)
    
    @scala.inline
    def setVulnerabilitySourceUpdatedAt(value: js.Date): Self = this.set("vulnerabilitySourceUpdatedAt", value.asInstanceOf[js.Any])
