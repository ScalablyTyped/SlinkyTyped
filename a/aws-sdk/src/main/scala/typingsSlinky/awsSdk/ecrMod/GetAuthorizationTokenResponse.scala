...
object GetAuthorizationTokenResponse {
  ...
  implicit class GetAuthorizationTokenResponseOps[Self <: GetAuthorizationTokenResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAuthorizationData(value: AuthorizationDataList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("authorizationData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAuthorizationData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("authorizationData")(js.undefined)
        ret
    }
  }
