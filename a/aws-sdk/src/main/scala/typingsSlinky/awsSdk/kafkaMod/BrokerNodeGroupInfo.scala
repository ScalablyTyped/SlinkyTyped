...
trait BrokerNodeGroupInfo extends StObject {
  ...
  /**
    ...
    */
  var BrokerAZDistribution: js.UndefOr[typingsSlinky.awsSdk.kafkaMod.BrokerAZDistribution] = js.native
  ...
  /**
    ...
    */
  var StorageInfo: js.UndefOr[typingsSlinky.awsSdk.kafkaMod.StorageInfo] = js.native
}
