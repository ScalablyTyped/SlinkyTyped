...
object BrokerEBSVolumeInfo {
  ...
  implicit class BrokerEBSVolumeInfoOps[Self <: BrokerEBSVolumeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKafkaBrokerNodeId(value: string): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("KafkaBrokerNodeId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVolumeSizeGB(value: integer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VolumeSizeGB")(value.asInstanceOf[js.Any])
        ret
    }
  }
