...
/* Inlined aws-sdk.aws-sdk/clients/machinelearning.DescribeMLModelsInput & {  $waiter ? :aws-sdk.aws-sdk/lib/service.WaiterConfiguration} */
@js.native
trait DescribeMLModelsInputwait extends js.Object {
  @JSName("$waiter")
