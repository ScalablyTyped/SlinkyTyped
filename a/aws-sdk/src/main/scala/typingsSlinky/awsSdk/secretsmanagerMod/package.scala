...
package object secretsmanagerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.`tag-key`
    - typingsSlinky.awsSdk.awsSdkStrings.`tag-value`
    - typingsSlinky.awsSdk.awsSdkStrings.all__
    - java.lang.String
  */
  type FilterNameStringType = typingsSlinky.awsSdk.secretsmanagerMod._FilterNameStringType | java.lang.String
  type FilterValueStringType = java.lang.String
  type FilterValuesStringList = js.Array[typingsSlinky.awsSdk.secretsmanagerMod.FilterValueStringType]
  type FiltersListType = js.Array[typingsSlinky.awsSdk.secretsmanagerMod.Filter]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.desc_
    - java.lang.String
  */
  type SortOrderType = typingsSlinky.awsSdk.secretsmanagerMod._SortOrderType | java.lang.String
  ...
  type ValidationErrorsType = js.Array[typingsSlinky.awsSdk.secretsmanagerMod.ValidationErrorsEntry]
  /* Rewritten from type alias, can be one of: 
