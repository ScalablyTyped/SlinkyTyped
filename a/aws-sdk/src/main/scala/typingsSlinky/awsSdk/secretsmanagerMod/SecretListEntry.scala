...
object SecretListEntry {
  ...
  implicit class SecretListEntryMutableBuilder[Self <: SecretListEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastAccessedDate(value: js.Date): Self = StObject.set(x, "LastAccessedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastRotatedDate(value: js.Date): Self = StObject.set(x, "LastRotatedDate", value.asInstanceOf[js.Any])
