...
object SecretListEntry {
  ...
  implicit class SecretListEntryOps[Self <: SecretListEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeletedDate(value: js.Date): Self = this.set("DeletedDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastAccessedDate(value: js.Date): Self = this.set("LastAccessedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastAccessedDate: Self = this.set("LastAccessedDate", js.undefined)
    
    @scala.inline
    def setLastChangedDate(value: js.Date): Self = this.set("LastChangedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastChangedDate: Self = this.set("LastChangedDate", js.undefined)
    
    @scala.inline
    def setLastRotatedDate(value: js.Date): Self = this.set("LastRotatedDate", value.asInstanceOf[js.Any])
