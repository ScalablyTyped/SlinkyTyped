...
object WindowSummary {
  ...
  implicit class WindowSummaryOps[Self <: WindowSummary] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTestWindowEnd(value: js.Date): Self = this.set("TestWindowEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTestWindowEnd: Self = this.set("TestWindowEnd", js.undefined)
    @scala.inline
    def setTestWindowStart(value: js.Date): Self = this.set("TestWindowStart", value.asInstanceOf[js.Any])
    @scala.inline
