...
@js.native
trait SizeConstraint extends StObject {
  ...
  /**
    ...
    */
  var ComparisonOperator: typingsSlinky.awsSdk.wafMod.ComparisonOperator = js.native
  ...
  /**
    ...
    */
  var Size: typingsSlinky.awsSdk.wafMod.Size = js.native
...
object SizeConstraint {
  ...
  @scala.inline
  implicit class SizeConstraintMutableBuilder[Self <: SizeConstraint] (val x: Self) extends AnyVal {
