...
trait ByteMatchTuple extends StObject {
  ...
  /**
    ...
    */
  var PositionalConstraint: typingsSlinky.awsSdk.wafMod.PositionalConstraint = js.native
...
object ByteMatchTuple {
  ...
  implicit class ByteMatchTupleMutableBuilder[Self <: ByteMatchTuple] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetStringUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "TargetString", value.asInstanceOf[js.Any])
