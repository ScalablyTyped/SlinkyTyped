...
object ExecutionTrigger {
  ...
  implicit class ExecutionTriggerOps[Self <: ExecutionTrigger] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTriggerDetail(value: TriggerDetail): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("triggerDetail")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTriggerDetail: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("triggerDetail")(js.undefined)
        ret
    }
    @scala.inline
