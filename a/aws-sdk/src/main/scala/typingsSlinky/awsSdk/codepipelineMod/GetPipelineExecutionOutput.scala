...
object GetPipelineExecutionOutput {
  ...
  implicit class GetPipelineExecutionOutputOps[Self <: GetPipelineExecutionOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPipelineExecution(value: PipelineExecution): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pipelineExecution")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPipelineExecution: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("pipelineExecution")(js.undefined)
        ret
    }
  }
