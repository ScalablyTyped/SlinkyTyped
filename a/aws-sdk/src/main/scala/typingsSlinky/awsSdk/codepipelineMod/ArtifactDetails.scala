...
object ArtifactDetails {
  ...
  implicit class ArtifactDetailsOps[Self <: ArtifactDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaximumCount(value: MaximumArtifactCount): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("maximumCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinimumCount(value: MinimumArtifactCount): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("minimumCount")(value.asInstanceOf[js.Any])
        ret
    }
  }
