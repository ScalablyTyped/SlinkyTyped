...
trait FailedResource extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsSlinky.awsSdk.resourcegroupsMod.ErrorCode] = js.native
  /**
    * The error message text associated with the failure.
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsSdk.resourcegroupsMod.ErrorMessage] = js.native
  /**
