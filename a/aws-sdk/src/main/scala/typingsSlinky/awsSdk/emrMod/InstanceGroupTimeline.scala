...
object InstanceGroupTimeline {
  ...
  implicit class InstanceGroupTimelineOps[Self <: InstanceGroupTimeline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndDateTime(value: js.Date): Self = this.set("EndDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEndDateTime: Self = this.set("EndDateTime", js.undefined)
    @scala.inline
    def setReadyDateTime(value: js.Date): Self = this.set("ReadyDateTime", value.asInstanceOf[js.Any])
    @scala.inline
