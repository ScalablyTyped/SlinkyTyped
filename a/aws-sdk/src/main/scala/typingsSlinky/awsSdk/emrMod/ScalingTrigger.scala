...
object ScalingTrigger {
  ...
  implicit class ScalingTriggerOps[Self <: ScalingTrigger] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCloudWatchAlarmDefinition(value: CloudWatchAlarmDefinition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CloudWatchAlarmDefinition")(value.asInstanceOf[js.Any])
        ret
    }
  }
