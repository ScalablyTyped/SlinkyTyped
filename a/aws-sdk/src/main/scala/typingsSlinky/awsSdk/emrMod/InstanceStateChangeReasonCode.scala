...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait InstanceStateChangeReasonCode extends js.Object
...
object InstanceStateChangeReasonCode {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): InstanceStateChangeReasonCode = value.asInstanceOf[InstanceStateChangeReasonCode]
}
