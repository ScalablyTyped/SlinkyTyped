...
object ListServiceQuotaIncreaseRequestsInTemplateResponse {
  ...
  implicit class ListServiceQuotaIncreaseRequestsInTemplateResponseOps[Self <: ListServiceQuotaIncreaseRequestsInTemplateResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withServiceQuotaIncreaseRequestInTemplateList(value: ServiceQuotaIncreaseRequestInTemplateList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ServiceQuotaIncreaseRequestInTemplateList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutServiceQuotaIncreaseRequestInTemplateList: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ServiceQuotaIncreaseRequestInTemplateList")(js.undefined)
        ret
    }
  }
