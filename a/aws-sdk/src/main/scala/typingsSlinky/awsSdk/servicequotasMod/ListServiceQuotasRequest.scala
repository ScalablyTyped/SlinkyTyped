...
object ListServiceQuotasRequest {
  ...
  @scala.inline
  def apply(ServiceCode: ServiceCode): ListServiceQuotasRequest = {
    val __obj = js.Dynamic.literal(ServiceCode = ServiceCode.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListServiceQuotasRequest]
  }
  
  @scala.inline
  implicit class ListServiceQuotasRequestMutableBuilder[Self <: ListServiceQuotasRequest] (val x: Self) extends AnyVal {
