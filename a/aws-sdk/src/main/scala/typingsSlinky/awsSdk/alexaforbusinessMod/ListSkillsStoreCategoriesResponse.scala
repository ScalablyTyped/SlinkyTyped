...
trait ListSkillsStoreCategoriesResponse extends js.Object {
  /**
    ...
    */
  var CategoryList: js.UndefOr[typingsSlinky.awsSdk.alexaforbusinessMod.CategoryList] = js.native
  /**
...
object ListSkillsStoreCategoriesResponse {
  ...
  implicit class ListSkillsStoreCategoriesResponseOps[Self <: ListSkillsStoreCategoriesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCategoryList(value: CategoryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CategoryList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutCategoryList: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CategoryList")(js.undefined)
        ret
    }
    @scala.inline
