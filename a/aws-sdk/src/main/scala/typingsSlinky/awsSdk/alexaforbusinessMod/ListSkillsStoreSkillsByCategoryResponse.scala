...
object ListSkillsStoreSkillsByCategoryResponse {
  ...
  implicit class ListSkillsStoreSkillsByCategoryResponseOps[Self <: ListSkillsStoreSkillsByCategoryResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSkillsStoreSkills(value: SkillsStoreSkillList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SkillsStoreSkills")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSkillsStoreSkills: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SkillsStoreSkills")(js.undefined)
        ret
    }
  }
