...
trait RegisterAVSDeviceRequest extends js.Object {
  ...
  /**
    ...
    */
  var AmazonId: typingsSlinky.awsSdk.alexaforbusinessMod.AmazonId = js.native
  
  /**
    * The client ID of the OEM used for code-based linking authorization on an AVS device.
    */
  var ClientId: typingsSlinky.awsSdk.alexaforbusinessMod.ClientId = js.native
  ...
  /**
    ...
    */
  var ProductId: typingsSlinky.awsSdk.alexaforbusinessMod.ProductId = js.native
  ...
  /**
    ...
    */
  var UserCode: typingsSlinky.awsSdk.alexaforbusinessMod.UserCode = js.native
}
