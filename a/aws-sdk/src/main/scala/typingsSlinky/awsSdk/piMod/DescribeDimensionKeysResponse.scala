...
object DescribeDimensionKeysResponse {
  ...
  implicit class DescribeDimensionKeysResponseOps[Self <: DescribeDimensionKeysResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlignedEndTime(value: js.Date): Self = this.set("AlignedEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAlignedEndTime: Self = this.set("AlignedEndTime", js.undefined)
    
    @scala.inline
    def setAlignedStartTime(value: js.Date): Self = this.set("AlignedStartTime", value.asInstanceOf[js.Any])
