...
object ConfigurationOptionsConfi {
  ...
  def apply(
    ...
    workmailmessageflow: typingsSlinky.awsSdk.workmailmessageflowMod.ClientConfiguration = null,
    workspaces: typingsSlinky.awsSdk.workspacesMod.ClientConfiguration = null,
    xray: typingsSlinky.awsSdk.xrayMod.ClientConfiguration = null
