...
object SharedIniFileCredentialsOptions {
  @scala.inline
  def apply(
    callback: /* err */ js.UndefOr[js.Error] => Unit = null,
    disableAssumeRole: js.UndefOr[Boolean] = js.undefined,
    filename: String = null,
    httpOptions: HTTPOptions = null,
    profile: String = null,
    tokenCodeFn: (/* mfaSerial */ String, /* callback */ js.Function2[/* err */ js.UndefOr[js.Error], /* token */ js.UndefOr[String], Unit]) => Unit = null
