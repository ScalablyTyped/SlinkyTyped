...
object MetricAlarm {
  ...
  implicit class MetricAlarmOps[Self <: MetricAlarm] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlarmConfigurationUpdatedTimestamp(value: js.Date): Self = this.set("AlarmConfigurationUpdatedTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStateUpdatedTimestamp(value: js.Date): Self = this.set("StateUpdatedTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
