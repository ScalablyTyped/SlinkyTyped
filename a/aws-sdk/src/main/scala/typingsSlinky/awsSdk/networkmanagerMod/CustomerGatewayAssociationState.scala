...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait CustomerGatewayAssociationState extends js.Object
...
object CustomerGatewayAssociationState {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): CustomerGatewayAssociationState = value.asInstanceOf[CustomerGatewayAssociationState]
}
