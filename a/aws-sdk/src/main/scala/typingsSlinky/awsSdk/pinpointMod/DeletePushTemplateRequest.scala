...
@js.native
trait DeletePushTemplateRequest extends StObject {
...
object DeletePushTemplateRequest {
  ...
  @scala.inline
  implicit class DeletePushTemplateRequestMutableBuilder[Self <: DeletePushTemplateRequest] (val x: Self) extends AnyVal {
