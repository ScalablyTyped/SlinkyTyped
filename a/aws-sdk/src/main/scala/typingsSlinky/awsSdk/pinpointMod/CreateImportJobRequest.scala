...
trait CreateImportJobRequest extends js.Object {
  ...
  var ImportJobRequest: typingsSlinky.awsSdk.pinpointMod.ImportJobRequest = js.native
}
...
object CreateImportJobRequest {
  ...
  implicit class CreateImportJobRequestOps[Self <: CreateImportJobRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImportJobRequest(value: ImportJobRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ImportJobRequest")(value.asInstanceOf[js.Any])
        ret
    }
  }
