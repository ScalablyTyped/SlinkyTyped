...
trait UpdateEndpointsBatchRequest extends js.Object {
  ...
  var EndpointBatchRequest: typingsSlinky.awsSdk.pinpointMod.EndpointBatchRequest = js.native
}
...
object UpdateEndpointsBatchRequest {
  ...
  implicit class UpdateEndpointsBatchRequestOps[Self <: UpdateEndpointsBatchRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndpointBatchRequest(value: EndpointBatchRequest): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EndpointBatchRequest")(value.asInstanceOf[js.Any])
        ret
    }
  }
