...
trait ListTemplateVersionsResponse extends js.Object {
  var TemplateVersionsResponse: typingsSlinky.awsSdk.pinpointMod.TemplateVersionsResponse = js.native
}
...
object ListTemplateVersionsResponse {
  ...
  implicit class ListTemplateVersionsResponseOps[Self <: ListTemplateVersionsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTemplateVersionsResponse(value: TemplateVersionsResponse): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TemplateVersionsResponse")(value.asInstanceOf[js.Any])
        ret
    }
  }
