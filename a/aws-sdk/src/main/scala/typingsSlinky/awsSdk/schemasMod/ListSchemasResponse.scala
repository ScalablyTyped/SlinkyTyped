...
object ListSchemasResponse {
  ...
  implicit class ListSchemasResponseOps[Self <: ListSchemasResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSchemasVarargs(value: SchemaSummary*): Self = this.set("Schemas", js.Array(value :_*))
    @scala.inline
    def setSchemas(value: listOfSchemaSummary): Self = this.set("Schemas", value.asInstanceOf[js.Any])
    @scala.inline
