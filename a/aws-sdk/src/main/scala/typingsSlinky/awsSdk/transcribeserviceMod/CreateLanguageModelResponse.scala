...
trait CreateLanguageModelResponse extends js.Object {
  ...
  /**
    ...
    */
  var BaseModelName: js.UndefOr[typingsSlinky.awsSdk.transcribeserviceMod.BaseModelName] = js.native
  
  /**
    * The data access role and Amazon S3 prefixes you've chosen to create your custom language model.
    */
  var InputDataConfig: js.UndefOr[typingsSlinky.awsSdk.transcribeserviceMod.InputDataConfig] = js.native
  ...
  /**
    ...
    */
  var ModelName: js.UndefOr[typingsSlinky.awsSdk.transcribeserviceMod.ModelName] = js.native
  
  /**
    * The status of the custom language model. When the status is COMPLETED the model is ready to use.
    */
  var ModelStatus: js.UndefOr[typingsSlinky.awsSdk.transcribeserviceMod.ModelStatus] = js.native
}
