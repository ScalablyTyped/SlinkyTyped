...
object ApplicationDetail {
  ...
  implicit class ApplicationDetailOps[Self <: ApplicationDetail] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateTimestamp(value: js.Date): Self = this.set("CreateTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCreateTimestamp: Self = this.set("CreateTimestamp", js.undefined)
    
    @scala.inline
    def setLastUpdateTimestamp(value: js.Date): Self = this.set("LastUpdateTimestamp", value.asInstanceOf[js.Any])
