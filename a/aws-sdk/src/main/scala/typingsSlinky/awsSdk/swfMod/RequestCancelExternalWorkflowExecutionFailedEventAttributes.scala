...
object RequestCancelExternalWorkflowExecutionFailedEventAttributes {
  ...
  @scala.inline
  implicit class RequestCancelExternalWorkflowExecutionFailedEventAttributesMutableBuilder[Self <: RequestCancelExternalWorkflowExecutionFailedEventAttributes] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCause(value: RequestCancelExternalWorkflowExecutionFailedCause): Self = StObject.set(x, "cause", value.asInstanceOf[js.Any])
