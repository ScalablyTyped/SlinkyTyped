...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait WorkflowExecutionTimeoutType extends js.Object
...
object WorkflowExecutionTimeoutType {
  ...
  @scala.inline
  implicit def apply(value: String): WorkflowExecutionTimeoutType = value.asInstanceOf[WorkflowExecutionTimeoutType]
}
