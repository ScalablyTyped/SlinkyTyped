...
@js.native
trait WorkflowTypeConfiguration extends StObject {
...
object WorkflowTypeConfiguration {
  ...
  @scala.inline
  implicit class WorkflowTypeConfigurationMutableBuilder[Self <: WorkflowTypeConfiguration] (val x: Self) extends AnyVal {
