...
object CancelWorkflowExecutionFailedEventAttributes {
  ...
  @scala.inline
  implicit class CancelWorkflowExecutionFailedEventAttributesOps[Self <: CancelWorkflowExecutionFailedEventAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCause(value: CancelWorkflowExecutionFailedCause): Self = this.set("cause", value.asInstanceOf[js.Any])
