...
object DescribeFleetsResult {
  ...
  implicit class DescribeFleetsResultMutableBuilder[Self <: DescribeFleetsResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFleets(value: FleetList): Self = StObject.set(x, "Fleets", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFleetsUndefined: Self = StObject.set(x, "Fleets", js.undefined)
    
    @scala.inline
    def setFleetsVarargs(value: Fleet*): Self = StObject.set(x, "Fleets", js.Array(value :_*))
