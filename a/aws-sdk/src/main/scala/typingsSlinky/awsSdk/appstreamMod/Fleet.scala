...
object Fleet {
  ...
  implicit class FleetOps[Self <: Fleet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComputeCapacityStatus(value: ComputeCapacityStatus): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ComputeCapacityStatus")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withState(value: FleetState): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFleetErrors(value: FleetErrors): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FleetErrors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFleetErrors: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FleetErrors")(js.undefined)
        ret
    }
    @scala.inline
