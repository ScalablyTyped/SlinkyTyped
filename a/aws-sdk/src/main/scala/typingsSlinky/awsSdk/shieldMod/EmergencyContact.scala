...
trait EmergencyContact extends js.Object {
  /**
    ...
    */
  var ContactNotes: js.UndefOr[typingsSlinky.awsSdk.shieldMod.ContactNotes] = js.native
  /**
  ...
  /**
    ...
    */
  var PhoneNumber: js.UndefOr[typingsSlinky.awsSdk.shieldMod.PhoneNumber] = js.native
}
