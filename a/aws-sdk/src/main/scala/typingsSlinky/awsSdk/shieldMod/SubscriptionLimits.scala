...
trait SubscriptionLimits extends StObject {
  ...
  /**
    ...
    */
  var ProtectionGroupLimits: typingsSlinky.awsSdk.shieldMod.ProtectionGroupLimits = js.native
  
  /**
    * Limits settings on protections for your subscription. 
    */
  var ProtectionLimits: typingsSlinky.awsSdk.shieldMod.ProtectionLimits = js.native
}
