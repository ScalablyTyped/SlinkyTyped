...
object TimeRange {
  ...
  implicit class TimeRangeOps[Self <: TimeRange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFromInclusive(value: js.Date): Self = this.set("FromInclusive", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFromInclusive: Self = this.set("FromInclusive", js.undefined)
    
    @scala.inline
    def setToExclusive(value: js.Date): Self = this.set("ToExclusive", value.asInstanceOf[js.Any])
