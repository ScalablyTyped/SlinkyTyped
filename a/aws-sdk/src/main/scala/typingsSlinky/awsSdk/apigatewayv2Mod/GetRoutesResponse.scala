...
object GetRoutesResponse {
  ...
  @scala.inline
  implicit class GetRoutesResponseOps[Self <: GetRoutesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: listOfRoute): Self = this.set("Items", value.asInstanceOf[js.Any])
    @scala.inline
