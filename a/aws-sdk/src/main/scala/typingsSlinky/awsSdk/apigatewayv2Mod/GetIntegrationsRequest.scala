...
@js.native
trait GetIntegrationsRequest extends StObject {
...
object GetIntegrationsRequest {
  ...
  @scala.inline
  implicit class GetIntegrationsRequestMutableBuilder[Self <: GetIntegrationsRequest] (val x: Self) extends AnyVal {
