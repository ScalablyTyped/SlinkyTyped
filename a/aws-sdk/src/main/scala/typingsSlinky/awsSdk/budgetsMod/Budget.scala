...
trait Budget extends js.Object {
  ...
  /**
    ...
    */
  var BudgetType: typingsSlinky.awsSdk.budgetsMod.BudgetType = js.native
  
  /**
    * The actual and forecasted cost or usage that the budget tracks.
    */
  var CalculatedSpend: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.CalculatedSpend] = js.native
  ...
  /**
    ...
    */
  var PlannedBudgetLimits: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.PlannedBudgetLimits] = js.native
