...
trait UpdateBudgetActionRequest extends StObject {
  ...
  var ActionThreshold: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.ActionThreshold] = js.native
  
  /**
    *  This specifies if the action needs manual or automatic approval. 
    */
  var ApprovalModel: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.ApprovalModel] = js.native
  
  var BudgetName: typingsSlinky.awsSdk.budgetsMod.BudgetName = js.native
  
  var Definition: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.Definition] = js.native
  ...
  var NotificationType: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.NotificationType] = js.native
