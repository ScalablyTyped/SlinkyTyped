...
trait IamActionDefinition extends js.Object {
  ...
  /**
    ...
    */
  var Groups: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.Groups] = js.native
  
  /**
    *  The Amazon Resource Name (ARN) of the policy to be attached. 
    */
  var PolicyArn: typingsSlinky.awsSdk.budgetsMod.PolicyArn = js.native
  
  /**
    *  A list of roles to be attached. There must be at least one role. 
    */
  var Roles: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.Roles] = js.native
  
  /**
    *  A list of users to be attached. There must be at least one user. 
    */
  var Users: js.UndefOr[typingsSlinky.awsSdk.budgetsMod.Users] = js.native
}
