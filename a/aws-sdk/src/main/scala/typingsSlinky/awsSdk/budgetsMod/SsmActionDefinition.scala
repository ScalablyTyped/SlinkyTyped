...
trait SsmActionDefinition extends StObject {
  ...
  /**
    *  The action subType. 
    */
  var ActionSubType: typingsSlinky.awsSdk.budgetsMod.ActionSubType = js.native
  
  /**
    *  The EC2 and RDS instance IDs. 
    */
  var InstanceIds: typingsSlinky.awsSdk.budgetsMod.InstanceIds = js.native
  
  /**
    *  The Region to run the SSM document. 
    */
  var Region: typingsSlinky.awsSdk.budgetsMod.Region = js.native
}
