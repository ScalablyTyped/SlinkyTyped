...
trait ActionHistory extends js.Object {
  ...
  /**
    ...
    */
  var ActionHistoryDetails: typingsSlinky.awsSdk.budgetsMod.ActionHistoryDetails = js.native
  
  /**
    *  This distinguishes between whether the events are triggered by the user or generated by the system. 
    */
  var EventType: typingsSlinky.awsSdk.budgetsMod.EventType = js.native
