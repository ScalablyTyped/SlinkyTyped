...
trait Action extends js.Object {
  ...
  /**
    ...
    */
  var ActionThreshold: typingsSlinky.awsSdk.budgetsMod.ActionThreshold = js.native
  
  /**
    *  The type of action. This defines the type of tasks that can be carried out by this action. This field also determines the format for definition. 
    */
  var ActionType: typingsSlinky.awsSdk.budgetsMod.ActionType = js.native
  
  /**
    *  This specifies if the action needs manual or automatic approval. 
    */
  var ApprovalModel: typingsSlinky.awsSdk.budgetsMod.ApprovalModel = js.native
  ...
  /**
    ...
    */
  var Definition: typingsSlinky.awsSdk.budgetsMod.Definition = js.native
