...
trait LoggingConfiguration extends js.Object {
  /**
    ...
    */
  var LogDestinationConfigs: typingsSlinky.awsSdk.wafv2Mod.LogDestinationConfigs = js.native
  /**
    ...
    */
  var RedactedFields: js.UndefOr[typingsSlinky.awsSdk.wafv2Mod.RedactedFields] = js.native
  /**
