...
object TextTransformation {
  ...
  @scala.inline
  implicit class TextTransformationOps[Self <: TextTransformation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPriority(value: TextTransformationPriority): Self = this.set("Priority", value.asInstanceOf[js.Any])
    @scala.inline
    def setType(value: TextTransformationType): Self = this.set("Type", value.asInstanceOf[js.Any])
  }
