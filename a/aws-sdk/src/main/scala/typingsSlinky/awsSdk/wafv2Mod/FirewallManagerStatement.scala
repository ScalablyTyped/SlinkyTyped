...
trait FirewallManagerStatement extends StObject {
  ...
  var ManagedRuleGroupStatement: js.UndefOr[typingsSlinky.awsSdk.wafv2Mod.ManagedRuleGroupStatement] = js.native
  
  var RuleGroupReferenceStatement: js.UndefOr[typingsSlinky.awsSdk.wafv2Mod.RuleGroupReferenceStatement] = js.native
}
