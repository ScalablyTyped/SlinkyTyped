...
trait FirewallManagerRuleGroup extends js.Object {
  /**
    ...
    */
  var FirewallManagerStatement: typingsSlinky.awsSdk.wafv2Mod.FirewallManagerStatement = js.native
  /**
    * The name of the rule group. You cannot change the name of a rule group after you create it.
    */
  var Name: EntityName = js.native
  var OverrideAction: typingsSlinky.awsSdk.wafv2Mod.OverrideAction = js.native
  /**
