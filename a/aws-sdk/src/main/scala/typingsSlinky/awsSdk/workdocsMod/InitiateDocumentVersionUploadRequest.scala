...
object InitiateDocumentVersionUploadRequest {
  ...
  implicit class InitiateDocumentVersionUploadRequestOps[Self <: InitiateDocumentVersionUploadRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentCreatedTimestamp(value: js.Date): Self = this.set("ContentCreatedTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteContentCreatedTimestamp: Self = this.set("ContentCreatedTimestamp", js.undefined)
    @scala.inline
    def setContentModifiedTimestamp(value: js.Date): Self = this.set("ContentModifiedTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
