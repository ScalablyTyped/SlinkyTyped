...
object InitializeClusterRequest {
  ...
  implicit class InitializeClusterRequestOps[Self <: InitializeClusterRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSignedCert(value: Cert): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SignedCert")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTrustAnchor(value: Cert): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TrustAnchor")(value.asInstanceOf[js.Any])
        ret
    }
  }
