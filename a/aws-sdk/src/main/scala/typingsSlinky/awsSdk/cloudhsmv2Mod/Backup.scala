...
object Backup {
  ...
  implicit class BackupOps[Self <: Backup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopyTimestamp(value: js.Date): Self = this.set("CopyTimestamp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeleteTimestamp(value: js.Date): Self = this.set("DeleteTimestamp", value.asInstanceOf[js.Any])
