...
object Backup {
  ...
  implicit class BackupMutableBuilder[Self <: Backup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopyTimestamp(value: js.Date): Self = StObject.set(x, "CopyTimestamp", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeleteTimestamp(value: js.Date): Self = StObject.set(x, "DeleteTimestamp", value.asInstanceOf[js.Any])
