...
object UpdateRobotApplicationResponse {
  ...
  @scala.inline
  def apply(): UpdateRobotApplicationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateRobotApplicationResponse]
  }
  
  @scala.inline
  implicit class UpdateRobotApplicationResponseMutableBuilder[Self <: UpdateRobotApplicationResponse] (val x: Self) extends AnyVal {
