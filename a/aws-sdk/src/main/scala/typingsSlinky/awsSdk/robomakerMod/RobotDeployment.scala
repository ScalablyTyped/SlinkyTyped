...
object RobotDeployment {
  ...
  implicit class RobotDeploymentOps[Self <: RobotDeployment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeploymentFinishTime(value: js.Date): Self = this.set("deploymentFinishTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDeploymentFinishTime: Self = this.set("deploymentFinishTime", js.undefined)
    
    @scala.inline
    def setDeploymentStartTime(value: js.Date): Self = this.set("deploymentStartTime", value.asInstanceOf[js.Any])
