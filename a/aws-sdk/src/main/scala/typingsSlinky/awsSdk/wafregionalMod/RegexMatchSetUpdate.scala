...
trait RegexMatchSetUpdate extends js.Object {
  ...
  /**
    ...
    */
  var RegexMatchTuple: typingsSlinky.awsSdk.wafregionalMod.RegexMatchTuple = js.native
}
...
object RegexMatchSetUpdate {
  ...
  implicit class RegexMatchSetUpdateOps[Self <: RegexMatchSetUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRegexMatchTuple(value: RegexMatchTuple): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RegexMatchTuple")(value.asInstanceOf[js.Any])
        ret
    }
  }
