...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait BlackoutSlateNetworkEndBlackout extends js.Object
...
object BlackoutSlateNetworkEndBlackout {
  ...
  @scala.inline
  implicit def apply(value: String): BlackoutSlateNetworkEndBlackout = value.asInstanceOf[BlackoutSlateNetworkEndBlackout]
}
