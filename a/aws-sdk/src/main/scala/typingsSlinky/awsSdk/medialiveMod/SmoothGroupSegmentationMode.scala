...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait SmoothGroupSegmentationMode extends js.Object
...
object SmoothGroupSegmentationMode {
  ...
  @scala.inline
  implicit def apply(value: String): SmoothGroupSegmentationMode = value.asInstanceOf[SmoothGroupSegmentationMode]
}
