...
object HlsMediaStoreSettings {
  ...
  implicit class HlsMediaStoreSettingsOps[Self <: HlsMediaStoreSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMediaStoreStorageClass(value: HlsMediaStoreStorageClass): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MediaStoreStorageClass")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutMediaStoreStorageClass: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MediaStoreStorageClass")(js.undefined)
        ret
    }
    @scala.inline
