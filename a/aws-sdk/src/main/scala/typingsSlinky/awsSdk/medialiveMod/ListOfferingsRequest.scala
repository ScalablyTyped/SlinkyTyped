...
object ListOfferingsRequest {
  ...
  implicit class ListOfferingsRequestOps[Self <: ListOfferingsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChannelConfiguration(value: string): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ChannelConfiguration")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutChannelConfiguration: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ChannelConfiguration")(js.undefined)
        ret
    }
    @scala.inline
