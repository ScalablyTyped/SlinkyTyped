...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait HlsId3SegmentTaggingState extends js.Object
...
object HlsId3SegmentTaggingState {
  ...
  @scala.inline
  implicit def apply(value: String): HlsId3SegmentTaggingState = value.asInstanceOf[HlsId3SegmentTaggingState]
}
