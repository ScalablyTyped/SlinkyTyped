...
@js.native
trait DescribeInputDeviceResponse extends StObject {
...
object DescribeInputDeviceResponse {
  ...
  @scala.inline
  implicit class DescribeInputDeviceResponseMutableBuilder[Self <: DescribeInputDeviceResponse] (val x: Self) extends AnyVal {
