...
trait IssueCertificateRequest extends StObject {
  ...
  /**
    ...
    */
  var Validity: typingsSlinky.awsSdk.acmpcaMod.Validity = js.native
}
object IssueCertificateRequest {
  ...
  implicit class IssueCertificateRequestMutableBuilder[Self <: IssueCertificateRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCsrUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "Csr", value.asInstanceOf[js.Any])
