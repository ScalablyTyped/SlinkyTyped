...
import typingsSlinky.awsSdk.awsSdkStrings.ACCOUNT
...
object migrationhubconfigMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.migrationhubconfigMod.apiVersion] = js.native
  }
  ...
  object HomeRegionControl {
    ...
    implicit class HomeRegionControlMutableBuilder[Self <: HomeRegionControl] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRequestedTime(value: js.Date): Self = StObject.set(x, "RequestedTime", value.asInstanceOf[js.Any])
