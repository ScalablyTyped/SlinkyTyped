...
import typingsSlinky.awsSdk.anon.DescribeAssetRequestwaite
import typingsSlinky.awsSdk.anon.DescribePortalRequestwait
import typingsSlinky.awsSdk.awsSdkStrings.assetActive
import typingsSlinky.awsSdk.awsSdkStrings.assetModelActive
import typingsSlinky.awsSdk.awsSdkStrings.assetModelNotExists
import typingsSlinky.awsSdk.awsSdkStrings.assetNotExists
import typingsSlinky.awsSdk.awsSdkStrings.portalActive
import typingsSlinky.awsSdk.awsSdkStrings.portalNotExists
...
trait IoTSiteWise extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_assetModelActive(state: assetModelActive, params: typingsSlinky.awsSdk.anon.DescribeAssetModelRequest): Request[DescribeAssetModelResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_assetModelActive(
    state: assetModelActive,
    params: typingsSlinky.awsSdk.anon.DescribeAssetModelRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeAssetModelResponse, Unit]
  ): Request[DescribeAssetModelResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_assetModelNotExists(state: assetModelNotExists, params: typingsSlinky.awsSdk.anon.DescribeAssetModelRequest): Request[DescribeAssetModelResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_assetModelNotExists(
    state: assetModelNotExists,
    params: typingsSlinky.awsSdk.anon.DescribeAssetModelRequest,
