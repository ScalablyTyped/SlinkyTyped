...
object DescribeAccessPolicyResponse {
  ...
  implicit class DescribeAccessPolicyResponseOps[Self <: DescribeAccessPolicyResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessPolicyCreationDate(value: js.Date): Self = this.set("accessPolicyCreationDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setAccessPolicyLastUpdateDate(value: js.Date): Self = this.set("accessPolicyLastUpdateDate", value.asInstanceOf[js.Any])
    @scala.inline
