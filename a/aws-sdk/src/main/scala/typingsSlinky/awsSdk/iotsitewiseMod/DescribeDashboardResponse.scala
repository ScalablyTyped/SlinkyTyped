...
object DescribeDashboardResponse {
  ...
  implicit class DescribeDashboardResponseOps[Self <: DescribeDashboardResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDashboardCreationDate(value: js.Date): Self = this.set("dashboardCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDashboardLastUpdateDate(value: js.Date): Self = this.set("dashboardLastUpdateDate", value.asInstanceOf[js.Any])
