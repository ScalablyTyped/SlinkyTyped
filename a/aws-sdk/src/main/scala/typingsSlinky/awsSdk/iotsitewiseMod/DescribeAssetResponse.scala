...
object DescribeAssetResponse {
  ...
  implicit class DescribeAssetResponseOps[Self <: DescribeAssetResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetCreationDate(value: js.Date): Self = this.set("assetCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAssetLastUpdateDate(value: js.Date): Self = this.set("assetLastUpdateDate", value.asInstanceOf[js.Any])
