...
trait DescribeAssetResponse extends StObject {
  ...
  /**
    ...
    */
  var assetCreationDate: js.Date = js.native
  ...
  /**
    ...
    */
  var assetLastUpdateDate: js.Date = js.native
...
object DescribeAssetResponse {
  ...
  implicit class DescribeAssetResponseMutableBuilder[Self <: DescribeAssetResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetCreationDate(value: js.Date): Self = StObject.set(x, "assetCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAssetLastUpdateDate(value: js.Date): Self = StObject.set(x, "assetLastUpdateDate", value.asInstanceOf[js.Any])
