...
trait DescribeAssetModelResponse extends StObject {
  ...
  /**
    ...
    */
  var assetModelCreationDate: js.Date = js.native
  ...
  /**
    ...
    */
  var assetModelLastUpdateDate: js.Date = js.native
...
object DescribeAssetModelResponse {
  ...
  implicit class DescribeAssetModelResponseMutableBuilder[Self <: DescribeAssetModelResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetModelCreationDate(value: js.Date): Self = StObject.set(x, "assetModelCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAssetModelLastUpdateDate(value: js.Date): Self = StObject.set(x, "assetModelLastUpdateDate", value.asInstanceOf[js.Any])
