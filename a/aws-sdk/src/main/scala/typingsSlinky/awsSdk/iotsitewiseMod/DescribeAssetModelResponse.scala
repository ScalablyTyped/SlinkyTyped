...
object DescribeAssetModelResponse {
  ...
  implicit class DescribeAssetModelResponseOps[Self <: DescribeAssetModelResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetModelCreationDate(value: js.Date): Self = this.set("assetModelCreationDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setAssetModelLastUpdateDate(value: js.Date): Self = this.set("assetModelLastUpdateDate", value.asInstanceOf[js.Any])
    @scala.inline
