...
trait DescribeProjectResponse extends StObject {
  ...
  /**
    ...
    */
  var projectCreationDate: js.Date = js.native
  ...
  /**
    ...
    */
  var projectLastUpdateDate: js.Date = js.native
...
object DescribeProjectResponse {
  ...
  implicit class DescribeProjectResponseMutableBuilder[Self <: DescribeProjectResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProjectCreationDate(value: js.Date): Self = StObject.set(x, "projectCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProjectLastUpdateDate(value: js.Date): Self = StObject.set(x, "projectLastUpdateDate", value.asInstanceOf[js.Any])
