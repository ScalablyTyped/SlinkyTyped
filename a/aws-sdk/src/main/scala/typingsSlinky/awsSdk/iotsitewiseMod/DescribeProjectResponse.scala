...
object DescribeProjectResponse {
  ...
  implicit class DescribeProjectResponseOps[Self <: DescribeProjectResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProjectCreationDate(value: js.Date): Self = this.set("projectCreationDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProjectId(value: ID): Self = this.set("projectId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProjectLastUpdateDate(value: js.Date): Self = this.set("projectLastUpdateDate", value.asInstanceOf[js.Any])
