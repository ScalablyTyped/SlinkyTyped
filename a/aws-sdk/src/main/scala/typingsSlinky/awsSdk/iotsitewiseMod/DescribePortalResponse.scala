...
object DescribePortalResponse {
  ...
  implicit class DescribePortalResponseOps[Self <: DescribePortalResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPortalCreationDate(value: js.Date): Self = this.set("portalCreationDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPortalId(value: ID): Self = this.set("portalId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPortalLastUpdateDate(value: js.Date): Self = this.set("portalLastUpdateDate", value.asInstanceOf[js.Any])
