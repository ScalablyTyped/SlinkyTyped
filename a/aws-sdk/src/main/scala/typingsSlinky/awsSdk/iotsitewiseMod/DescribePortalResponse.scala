...
trait DescribePortalResponse extends StObject {
  ...
  /**
    ...
    */
  var portalCreationDate: js.Date = js.native
  ...
  /**
    ...
    */
  var portalLastUpdateDate: js.Date = js.native
...
object DescribePortalResponse {
  ...
  implicit class DescribePortalResponseMutableBuilder[Self <: DescribePortalResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPortalCreationDate(value: js.Date): Self = StObject.set(x, "portalCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPortalLastUpdateDate(value: js.Date): Self = StObject.set(x, "portalLastUpdateDate", value.asInstanceOf[js.Any])
