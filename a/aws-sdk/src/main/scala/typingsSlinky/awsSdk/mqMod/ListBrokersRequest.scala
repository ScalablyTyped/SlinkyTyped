...
@js.native
trait ListBrokersRequest extends StObject {
...
object ListBrokersRequest {
  ...
  @scala.inline
  def apply(): ListBrokersRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListBrokersRequest]
  }
  
  @scala.inline
  implicit class ListBrokersRequestMutableBuilder[Self <: ListBrokersRequest] (val x: Self) extends AnyVal {
