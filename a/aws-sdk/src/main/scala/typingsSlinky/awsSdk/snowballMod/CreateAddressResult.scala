...
object CreateAddressResult {
  ...
  @scala.inline
  implicit class CreateAddressResultOps[Self <: CreateAddressResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddressId(value: String): Self = this.set("AddressId", value.asInstanceOf[js.Any])
