...
trait DescribeReturnShippingLabelRequest extends js.Object {
  ...
  /**
    ...
    */
  var JobId: js.UndefOr[typingsSlinky.awsSdk.snowballMod.JobId] = js.native
}
object DescribeReturnShippingLabelRequest {
  ...
  @scala.inline
  implicit class DescribeReturnShippingLabelRequestOps[Self <: DescribeReturnShippingLabelRequest] (val x: Self) extends AnyVal {
