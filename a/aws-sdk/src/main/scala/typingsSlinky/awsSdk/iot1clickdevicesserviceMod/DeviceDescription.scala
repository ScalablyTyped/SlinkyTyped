...
object DeviceDescription {
  ...
  def apply(
    ...
    RemainingLife: js.UndefOr[doubleMin0Max100] = js.undefined,
    ...
    if (!js.isUndefined(RemainingLife)) __obj.updateDynamic("RemainingLife")(RemainingLife.get.asInstanceOf[js.Any])
