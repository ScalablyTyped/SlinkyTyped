...
trait RebootWorkspacesRequest extends js.Object {
  /**
    ...
    */
  var RebootWorkspaceRequests: typingsSlinky.awsSdk.workspacesMod.RebootWorkspaceRequests = js.native
}
...
object RebootWorkspacesRequest {
  ...
  implicit class RebootWorkspacesRequestOps[Self <: RebootWorkspacesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRebootWorkspaceRequests(value: RebootWorkspaceRequests): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RebootWorkspaceRequests")(value.asInstanceOf[js.Any])
        ret
    }
  }
