...
trait StartWorkspacesRequest extends js.Object {
  /**
    ...
    */
  var StartWorkspaceRequests: typingsSlinky.awsSdk.workspacesMod.StartWorkspaceRequests = js.native
}
...
object StartWorkspacesRequest {
  ...
  implicit class StartWorkspacesRequestOps[Self <: StartWorkspacesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStartWorkspaceRequests(value: StartWorkspaceRequests): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartWorkspaceRequests")(value.asInstanceOf[js.Any])
        ret
    }
  }
