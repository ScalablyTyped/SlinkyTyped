...
object MigrateWorkspaceResult {
  ...
  implicit class MigrateWorkspaceResultOps[Self <: MigrateWorkspaceResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withoutSourceWorkspaceId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceWorkspaceId")(js.undefined)
        ret
    }
    @scala.inline
    def withTargetWorkspaceId(value: WorkspaceId): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TargetWorkspaceId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTargetWorkspaceId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TargetWorkspaceId")(js.undefined)
        ret
    }
  }
