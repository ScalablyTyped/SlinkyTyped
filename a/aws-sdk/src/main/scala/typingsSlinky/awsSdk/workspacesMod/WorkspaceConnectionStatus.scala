...
object WorkspaceConnectionStatus {
  ...
  implicit class WorkspaceConnectionStatusOps[Self <: WorkspaceConnectionStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConnectionStateCheckTimestamp(value: js.Date): Self = this.set("ConnectionStateCheckTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteConnectionStateCheckTimestamp: Self = this.set("ConnectionStateCheckTimestamp", js.undefined)
    
    @scala.inline
    def setLastKnownUserConnectionTimestamp(value: js.Date): Self = this.set("LastKnownUserConnectionTimestamp", value.asInstanceOf[js.Any])
