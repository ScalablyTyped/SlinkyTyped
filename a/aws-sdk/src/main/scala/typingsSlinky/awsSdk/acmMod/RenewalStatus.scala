...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait RenewalStatus extends js.Object

object RenewalStatus {
  @scala.inline
  def PENDING_AUTO_RENEWAL: typingsSlinky.awsSdk.awsSdkStrings.PENDING_AUTO_RENEWAL = "PENDING_AUTO_RENEWAL".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.PENDING_AUTO_RENEWAL]
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): RenewalStatus = value.asInstanceOf[RenewalStatus]
}
