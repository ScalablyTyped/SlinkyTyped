...
trait UpdateServerEngineAttributesRequest extends StObject {
  ...
  /**
    ...
    */
  var AttributeName: typingsSlinky.awsSdk.opsworkscmMod.AttributeName = js.native
  
  /**
    * The value to set for the attribute. 
    */
  var AttributeValue: js.UndefOr[typingsSlinky.awsSdk.opsworkscmMod.AttributeValue] = js.native
