...
object DeltaTime {
  ...
  implicit class DeltaTimeOps[Self <: DeltaTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOffsetSeconds(value: OffsetSeconds): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offsetSeconds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTimeExpression(value: TimeExpression): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("timeExpression")(value.asInstanceOf[js.Any])
        ret
    }
  }
