...
object ListDatasetContentsRequest {
  ...
  implicit class ListDatasetContentsRequestMutableBuilder[Self <: ListDatasetContentsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScheduledBefore(value: js.Date): Self = StObject.set(x, "scheduledBefore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScheduledBeforeUndefined: Self = StObject.set(x, "scheduledBefore", js.undefined)
    
    @scala.inline
    def setScheduledOnOrAfter(value: js.Date): Self = StObject.set(x, "scheduledOnOrAfter", value.asInstanceOf[js.Any])
