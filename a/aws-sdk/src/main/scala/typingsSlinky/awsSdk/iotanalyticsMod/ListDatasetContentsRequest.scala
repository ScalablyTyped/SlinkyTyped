...
object ListDatasetContentsRequest {
  ...
  implicit class ListDatasetContentsRequestOps[Self <: ListDatasetContentsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScheduledBefore(value: js.Date): Self = this.set("scheduledBefore", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteScheduledBefore: Self = this.set("scheduledBefore", js.undefined)
    
    @scala.inline
    def setScheduledOnOrAfter(value: js.Date): Self = this.set("scheduledOnOrAfter", value.asInstanceOf[js.Any])
