...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStarted(value: js.Date): Self = this.set("started", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStopped(value: js.Date): Self = this.set("stopped", value.asInstanceOf[js.Any])
    @scala.inline
