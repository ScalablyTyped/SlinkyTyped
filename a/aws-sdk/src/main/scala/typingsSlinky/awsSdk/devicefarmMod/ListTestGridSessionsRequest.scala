...
object ListTestGridSessionsRequest {
  ...
  implicit class ListTestGridSessionsRequestOps[Self <: ListTestGridSessionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndTimeAfter(value: js.Date): Self = this.set("endTimeAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEndTimeAfter: Self = this.set("endTimeAfter", js.undefined)
    
    @scala.inline
    def setEndTimeBefore(value: js.Date): Self = this.set("endTimeBefore", value.asInstanceOf[js.Any])
