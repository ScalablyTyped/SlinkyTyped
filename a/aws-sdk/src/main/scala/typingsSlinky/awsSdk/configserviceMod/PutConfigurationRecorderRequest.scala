...
object PutConfigurationRecorderRequest {
  ...
  implicit class PutConfigurationRecorderRequestOps[Self <: PutConfigurationRecorderRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigurationRecorder(value: ConfigurationRecorder): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConfigurationRecorder")(value.asInstanceOf[js.Any])
        ret
    }
  }
