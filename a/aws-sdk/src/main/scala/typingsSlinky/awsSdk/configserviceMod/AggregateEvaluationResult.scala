...
object AggregateEvaluationResult {
  ...
  implicit class AggregateEvaluationResultOps[Self <: AggregateEvaluationResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfigRuleInvokedTime(value: js.Date): Self = this.set("ConfigRuleInvokedTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setResultRecordedTime(value: js.Date): Self = this.set("ResultRecordedTime", value.asInstanceOf[js.Any])
    @scala.inline
