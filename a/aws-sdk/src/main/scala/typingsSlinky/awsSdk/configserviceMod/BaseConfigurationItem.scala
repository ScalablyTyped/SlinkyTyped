...
object BaseConfigurationItem {
  ...
  implicit class BaseConfigurationItemOps[Self <: BaseConfigurationItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfigurationItemCaptureTime(value: js.Date): Self = this.set("configurationItemCaptureTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResourceCreationTime(value: js.Date): Self = this.set("resourceCreationTime", value.asInstanceOf[js.Any])
