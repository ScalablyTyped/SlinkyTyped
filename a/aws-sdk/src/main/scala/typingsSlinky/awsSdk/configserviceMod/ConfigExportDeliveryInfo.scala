...
object ConfigExportDeliveryInfo {
  ...
  implicit class ConfigExportDeliveryInfoMutableBuilder[Self <: ConfigExportDeliveryInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastAttemptTime(value: js.Date): Self = StObject.set(x, "lastAttemptTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastSuccessfulTime(value: js.Date): Self = StObject.set(x, "lastSuccessfulTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastSuccessfulTimeUndefined: Self = StObject.set(x, "lastSuccessfulTime", js.undefined)
    
    @scala.inline
    def setNextDeliveryTime(value: js.Date): Self = StObject.set(x, "nextDeliveryTime", value.asInstanceOf[js.Any])
