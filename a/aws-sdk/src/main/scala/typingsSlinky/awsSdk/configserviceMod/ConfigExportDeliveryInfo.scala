...
object ConfigExportDeliveryInfo {
  ...
  implicit class ConfigExportDeliveryInfoOps[Self <: ConfigExportDeliveryInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastAttemptTime(value: js.Date): Self = this.set("lastAttemptTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastSuccessfulTime(value: js.Date): Self = this.set("lastSuccessfulTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastSuccessfulTime: Self = this.set("lastSuccessfulTime", js.undefined)
    @scala.inline
    def setNextDeliveryTime(value: js.Date): Self = this.set("nextDeliveryTime", value.asInstanceOf[js.Any])
    @scala.inline
