...
object ConfigurationRecorderStatus {
  ...
  implicit class ConfigurationRecorderStatusOps[Self <: ConfigurationRecorderStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastStartTime(value: js.Date): Self = this.set("lastStartTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastStatusChangeTime(value: js.Date): Self = this.set("lastStatusChangeTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastStatusChangeTime: Self = this.set("lastStatusChangeTime", js.undefined)
    @scala.inline
    def setLastStopTime(value: js.Date): Self = this.set("lastStopTime", value.asInstanceOf[js.Any])
    @scala.inline
