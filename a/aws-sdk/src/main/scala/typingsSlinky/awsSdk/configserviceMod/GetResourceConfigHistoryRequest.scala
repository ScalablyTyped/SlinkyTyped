...
object GetResourceConfigHistoryRequest {
  ...
  implicit class GetResourceConfigHistoryRequestOps[Self <: GetResourceConfigHistoryRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEarlierTime(value: js.Date): Self = this.set("earlierTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEarlierTime: Self = this.set("earlierTime", js.undefined)
    @scala.inline
    def setLaterTime(value: js.Date): Self = this.set("laterTime", value.asInstanceOf[js.Any])
    @scala.inline
