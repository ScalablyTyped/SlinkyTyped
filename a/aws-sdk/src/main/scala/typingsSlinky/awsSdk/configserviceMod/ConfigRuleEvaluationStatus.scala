...
object ConfigRuleEvaluationStatus {
  ...
  implicit class ConfigRuleEvaluationStatusOps[Self <: ConfigRuleEvaluationStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstActivatedTime(value: js.Date): Self = this.set("FirstActivatedTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastDeactivatedTime(value: js.Date): Self = this.set("LastDeactivatedTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastFailedEvaluationTime(value: js.Date): Self = this.set("LastFailedEvaluationTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastFailedEvaluationTime: Self = this.set("LastFailedEvaluationTime", js.undefined)
    @scala.inline
    def setLastFailedInvocationTime(value: js.Date): Self = this.set("LastFailedInvocationTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastFailedInvocationTime: Self = this.set("LastFailedInvocationTime", js.undefined)
    @scala.inline
    def setLastSuccessfulEvaluationTime(value: js.Date): Self = this.set("LastSuccessfulEvaluationTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastSuccessfulEvaluationTime: Self = this.set("LastSuccessfulEvaluationTime", js.undefined)
    @scala.inline
    def setLastSuccessfulInvocationTime(value: js.Date): Self = this.set("LastSuccessfulInvocationTime", value.asInstanceOf[js.Any])
    @scala.inline
