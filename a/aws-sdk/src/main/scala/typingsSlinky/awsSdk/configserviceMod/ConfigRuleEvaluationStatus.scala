...
object ConfigRuleEvaluationStatus {
  ...
  implicit class ConfigRuleEvaluationStatusMutableBuilder[Self <: ConfigRuleEvaluationStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstActivatedTime(value: js.Date): Self = StObject.set(x, "FirstActivatedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastDeactivatedTime(value: js.Date): Self = StObject.set(x, "LastDeactivatedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastFailedEvaluationTime(value: js.Date): Self = StObject.set(x, "LastFailedEvaluationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastFailedEvaluationTimeUndefined: Self = StObject.set(x, "LastFailedEvaluationTime", js.undefined)
    
    @scala.inline
    def setLastFailedInvocationTime(value: js.Date): Self = StObject.set(x, "LastFailedInvocationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastFailedInvocationTimeUndefined: Self = StObject.set(x, "LastFailedInvocationTime", js.undefined)
    
    @scala.inline
    def setLastSuccessfulEvaluationTime(value: js.Date): Self = StObject.set(x, "LastSuccessfulEvaluationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastSuccessfulEvaluationTimeUndefined: Self = StObject.set(x, "LastSuccessfulEvaluationTime", js.undefined)
    
    @scala.inline
    def setLastSuccessfulInvocationTime(value: js.Date): Self = StObject.set(x, "LastSuccessfulInvocationTime", value.asInstanceOf[js.Any])
