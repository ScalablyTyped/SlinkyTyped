...
object UserType {
  ...
  implicit class UserTypeOps[Self <: UserType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUserCreateDate(value: js.Date): Self = this.set("UserCreateDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUserCreateDate: Self = this.set("UserCreateDate", js.undefined)
    @scala.inline
    def setUserLastModifiedDate(value: js.Date): Self = this.set("UserLastModifiedDate", value.asInstanceOf[js.Any])
    @scala.inline
