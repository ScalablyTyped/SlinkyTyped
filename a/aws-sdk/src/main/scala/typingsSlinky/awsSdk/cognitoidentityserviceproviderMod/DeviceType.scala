...
object DeviceType {
  ...
  implicit class DeviceTypeOps[Self <: DeviceType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeviceCreateDate(value: js.Date): Self = this.set("DeviceCreateDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeviceLastAuthenticatedDate(value: js.Date): Self = this.set("DeviceLastAuthenticatedDate", value.asInstanceOf[js.Any])
