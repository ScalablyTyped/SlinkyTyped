...
object ec2instanceconnectMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.ec2instanceconnectMod.apiVersion] = js.native
  }
  ...
  trait SendSSHPublicKeyRequest extends StObject {
    ...
    /**
      ...
      */
    var AvailabilityZone: typingsSlinky.awsSdk.ec2instanceconnectMod.AvailabilityZone = js.native
    
    /**
      * The EC2 instance you wish to publish the SSH key to.
      */
    var InstanceId: typingsSlinky.awsSdk.ec2instanceconnectMod.InstanceId = js.native
    
    /**
      * The OS user on the EC2 instance whom the key may be used to authenticate as.
      */
    var InstanceOSUser: typingsSlinky.awsSdk.ec2instanceconnectMod.InstanceOSUser = js.native
    
    /**
      * The public key to be published to the instance. To use it after publication you must have the matching private key.
      */
    var SSHPublicKey: typingsSlinky.awsSdk.ec2instanceconnectMod.SSHPublicKey = js.native
  }
