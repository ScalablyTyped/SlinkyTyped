...
object DescribeAppResponse {
  ...
  implicit class DescribeAppResponseMutableBuilder[Self <: DescribeAppResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastHealthCheckTimestamp(value: js.Date): Self = StObject.set(x, "LastHealthCheckTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastHealthCheckTimestampUndefined: Self = StObject.set(x, "LastHealthCheckTimestamp", js.undefined)
    
    @scala.inline
    def setLastUserActivityTimestamp(value: js.Date): Self = StObject.set(x, "LastUserActivityTimestamp", value.asInstanceOf[js.Any])
