...
object ListTrialsRequest {
  ...
  implicit class ListTrialsRequestOps[Self <: ListTrialsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreatedAfter(value: js.Date): Self = this.set("CreatedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteCreatedAfter: Self = this.set("CreatedAfter", js.undefined)
    
    @scala.inline
    def setCreatedBefore(value: js.Date): Self = this.set("CreatedBefore", value.asInstanceOf[js.Any])
