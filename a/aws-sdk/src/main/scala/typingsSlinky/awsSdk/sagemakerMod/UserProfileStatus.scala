...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait UserProfileStatus extends js.Object
...
object UserProfileStatus {
  ...
  @scala.inline
  def InService: typingsSlinky.awsSdk.awsSdkStrings.InService = "InService".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.InService]
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): UserProfileStatus = value.asInstanceOf[UserProfileStatus]
}
