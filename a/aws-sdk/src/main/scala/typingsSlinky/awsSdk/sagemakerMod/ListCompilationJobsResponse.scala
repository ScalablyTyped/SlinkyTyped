...
object ListCompilationJobsResponse {
  ...
  implicit class ListCompilationJobsResponseOps[Self <: ListCompilationJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCompilationJobSummaries(value: CompilationJobSummaries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CompilationJobSummaries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
