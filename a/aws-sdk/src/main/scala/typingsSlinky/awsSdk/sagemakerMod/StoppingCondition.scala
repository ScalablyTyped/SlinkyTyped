...
trait StoppingCondition extends js.Object {
  /**
    ...
    */
  var MaxRuntimeInSeconds: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.MaxRuntimeInSeconds] = js.native
  /**
    ...
    */
  var MaxWaitTimeInSeconds: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.MaxWaitTimeInSeconds] = js.native
}
