...
trait FileSystemConfig extends js.Object {
  ...
  /**
    ...
    */
  var DefaultGid: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.DefaultGid] = js.native
  
  /**
    * The default POSIX user ID (UID). If not specified, defaults to 1000.
    */
  var DefaultUid: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.DefaultUid] = js.native
  
  /**
    * The path within the image to mount the user's EFS home directory. The directory should be empty. If not specified, defaults to /home/sagemaker-user.
    */
  var MountPath: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.MountPath] = js.native
}
