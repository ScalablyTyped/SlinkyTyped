...
trait HyperParameterTuningJobWarmStartConfig extends js.Object {
  /**
    ...
    */
  var ParentHyperParameterTuningJobs: typingsSlinky.awsSdk.sagemakerMod.ParentHyperParameterTuningJobs = js.native
  /**
...
object HyperParameterTuningJobWarmStartConfig {
  ...
  implicit class HyperParameterTuningJobWarmStartConfigOps[Self <: HyperParameterTuningJobWarmStartConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withParentHyperParameterTuningJobs(value: ParentHyperParameterTuningJobs): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ParentHyperParameterTuningJobs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withWarmStartType(value: HyperParameterTuningJobWarmStartType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("WarmStartType")(value.asInstanceOf[js.Any])
        ret
    }
  }
