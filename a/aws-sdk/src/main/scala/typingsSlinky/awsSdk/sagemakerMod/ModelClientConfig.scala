...
trait ModelClientConfig extends js.Object {
  /**
    ...
    */
  var InvocationsMaxRetries: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.InvocationsMaxRetries] = js.native
  /**
    * The timeout value in seconds for an invocation request.
    */
  var InvocationsTimeoutInSeconds: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.InvocationsTimeoutInSeconds] = js.native
}
