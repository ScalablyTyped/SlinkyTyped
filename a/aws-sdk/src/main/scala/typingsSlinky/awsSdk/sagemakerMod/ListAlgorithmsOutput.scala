...
trait ListAlgorithmsOutput extends js.Object {
  /**
    ...
    */
  var AlgorithmSummaryList: typingsSlinky.awsSdk.sagemakerMod.AlgorithmSummaryList = js.native
  /**
...
object ListAlgorithmsOutput {
  ...
  implicit class ListAlgorithmsOutputOps[Self <: ListAlgorithmsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlgorithmSummaryList(value: AlgorithmSummaryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AlgorithmSummaryList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
