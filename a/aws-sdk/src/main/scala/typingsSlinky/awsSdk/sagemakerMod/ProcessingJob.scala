...
object ProcessingJob {
  ...
  implicit class ProcessingJobOps[Self <: ProcessingJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProcessingEndTime(value: js.Date): Self = this.set("ProcessingEndTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setProcessingStartTime(value: js.Date): Self = this.set("ProcessingStartTime", value.asInstanceOf[js.Any])
    @scala.inline
