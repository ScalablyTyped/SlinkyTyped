...
trait ListSubscribedWorkteamsResponse extends js.Object {
  ...
  /**
    ...
    */
  var SubscribedWorkteams: typingsSlinky.awsSdk.sagemakerMod.SubscribedWorkteams = js.native
}
...
object ListSubscribedWorkteamsResponse {
  ...
  implicit class ListSubscribedWorkteamsResponseOps[Self <: ListSubscribedWorkteamsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubscribedWorkteams(value: SubscribedWorkteams): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SubscribedWorkteams")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
