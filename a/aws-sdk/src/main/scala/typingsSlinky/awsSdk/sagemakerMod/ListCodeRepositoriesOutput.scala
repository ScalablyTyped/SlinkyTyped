...
trait ListCodeRepositoriesOutput extends js.Object {
  /**
    ...
    */
  var CodeRepositorySummaryList: typingsSlinky.awsSdk.sagemakerMod.CodeRepositorySummaryList = js.native
  /**
...
object ListCodeRepositoriesOutput {
  ...
  implicit class ListCodeRepositoriesOutputOps[Self <: ListCodeRepositoriesOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCodeRepositorySummaryList(value: CodeRepositorySummaryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CodeRepositorySummaryList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
