...
trait InputConfig extends js.Object {
  /**
    ...
    */
  var DataInputConfig: typingsSlinky.awsSdk.sagemakerMod.DataInputConfig = js.native
  /**
    * Identifies the framework in which the model was trained. For example: TENSORFLOW.
    */
  var Framework: typingsSlinky.awsSdk.sagemakerMod.Framework = js.native
  /**
...
object InputConfig {
  ...
  implicit class InputConfigOps[Self <: InputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataInputConfig(value: DataInputConfig): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataInputConfig")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
