...
trait SecondaryStatusTransition extends js.Object {
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.StatusMessage] = js.native
}

object SecondaryStatusTransition {
  @scala.inline
  def apply(StartTime: js.Date, Status: SecondaryStatus): SecondaryStatusTransition = {
  ...
  implicit class SecondaryStatusTransitionOps[Self <: SecondaryStatusTransition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStatus(value: SecondaryStatus): Self = {
        val ret = this.duplicate
