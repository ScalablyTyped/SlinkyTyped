...
object ExecutionStatus {
  ...
  @scala.inline
  def CompletedWithViolations: typingsSlinky.awsSdk.awsSdkStrings.CompletedWithViolations = "CompletedWithViolations".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.CompletedWithViolations]
  @scala.inline
