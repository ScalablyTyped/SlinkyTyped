...
object ListAppImageConfigsRequest {
  ...
  implicit class ListAppImageConfigsRequestOps[Self <: ListAppImageConfigsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModifiedTimeAfter(value: js.Date): Self = this.set("ModifiedTimeAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteModifiedTimeAfter: Self = this.set("ModifiedTimeAfter", js.undefined)
    
    @scala.inline
    def setModifiedTimeBefore(value: js.Date): Self = this.set("ModifiedTimeBefore", value.asInstanceOf[js.Any])
