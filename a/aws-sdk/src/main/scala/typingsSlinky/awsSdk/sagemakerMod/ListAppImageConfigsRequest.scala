...
trait ListAppImageConfigsRequest extends StObject {
  ...
  /**
    ...
    */
  var ModifiedTimeAfter: js.UndefOr[js.Date] = js.native
  
  /**
    * A filter that returns only AppImageConfigs modified on or before the specified time.
    */
  var ModifiedTimeBefore: js.UndefOr[js.Date] = js.native
...
object ListAppImageConfigsRequest {
  ...
  implicit class ListAppImageConfigsRequestMutableBuilder[Self <: ListAppImageConfigsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModifiedTimeAfter(value: js.Date): Self = StObject.set(x, "ModifiedTimeAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setModifiedTimeAfterUndefined: Self = StObject.set(x, "ModifiedTimeAfter", js.undefined)
    
    @scala.inline
    def setModifiedTimeBefore(value: js.Date): Self = StObject.set(x, "ModifiedTimeBefore", value.asInstanceOf[js.Any])
