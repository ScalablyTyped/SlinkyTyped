...
object ListHyperParameterTuningJobsResponse {
  ...
  implicit class ListHyperParameterTuningJobsResponseOps[Self <: ListHyperParameterTuningJobsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHyperParameterTuningJobSummaries(value: HyperParameterTuningJobSummaries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HyperParameterTuningJobSummaries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
