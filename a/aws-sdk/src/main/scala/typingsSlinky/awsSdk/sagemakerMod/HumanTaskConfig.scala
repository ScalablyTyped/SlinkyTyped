...
trait HumanTaskConfig extends js.Object {
  /**
    ...
    */
  var AnnotationConsolidationConfig: typingsSlinky.awsSdk.sagemakerMod.AnnotationConsolidationConfig = js.native
  /**
    ...
    */
  var MaxConcurrentTaskCount: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.MaxConcurrentTaskCount] = js.native
  /**
    * The number of human workers that will label an object. 
    */
  var NumberOfHumanWorkersPerDataObject: typingsSlinky.awsSdk.sagemakerMod.NumberOfHumanWorkersPerDataObject = js.native
  /**
  ...
  /**
    ...
    */
  var TaskAvailabilityLifetimeInSeconds: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.TaskAvailabilityLifetimeInSeconds] = js.native
  /**
    * A description of the task for your human workers.
    */
  var TaskDescription: typingsSlinky.awsSdk.sagemakerMod.TaskDescription = js.native
  /**
    * Keywords used to describe the task so that workers on Amazon Mechanical Turk can discover the task.
    */
  var TaskKeywords: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.TaskKeywords] = js.native
  /**
    * The amount of time that a worker has to complete a task.
    */
  var TaskTimeLimitInSeconds: typingsSlinky.awsSdk.sagemakerMod.TaskTimeLimitInSeconds = js.native
  /**
    * A title for the task for your human workers.
    */
  var TaskTitle: typingsSlinky.awsSdk.sagemakerMod.TaskTitle = js.native
  /**
    * Information about the user interface that workers use to complete the labeling task.
    */
  var UiConfig: typingsSlinky.awsSdk.sagemakerMod.UiConfig = js.native
  /**
...
object HumanTaskConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(MaxConcurrentTaskCount)) __obj.updateDynamic("MaxConcurrentTaskCount")(MaxConcurrentTaskCount.get.asInstanceOf[js.Any])
