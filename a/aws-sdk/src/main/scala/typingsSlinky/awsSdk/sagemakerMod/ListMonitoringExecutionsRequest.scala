...
object ListMonitoringExecutionsRequest {
  ...
  implicit class ListMonitoringExecutionsRequestOps[Self <: ListMonitoringExecutionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScheduledTimeAfter(value: js.Date): Self = this.set("ScheduledTimeAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteScheduledTimeAfter: Self = this.set("ScheduledTimeAfter", js.undefined)
    
    @scala.inline
    def setScheduledTimeBefore(value: js.Date): Self = this.set("ScheduledTimeBefore", value.asInstanceOf[js.Any])
