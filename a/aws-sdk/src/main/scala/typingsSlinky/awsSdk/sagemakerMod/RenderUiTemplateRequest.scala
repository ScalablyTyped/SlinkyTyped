...
trait RenderUiTemplateRequest extends StObject {
  ...
  /**
    ...
    */
  var HumanTaskUiArn: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.HumanTaskUiArn] = js.native
  ...
  /**
    ...
    */
  var UiTemplate: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.UiTemplate] = js.native
}
