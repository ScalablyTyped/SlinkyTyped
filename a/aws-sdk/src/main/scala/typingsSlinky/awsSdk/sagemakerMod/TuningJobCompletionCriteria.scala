...
object TuningJobCompletionCriteria {
  ...
  implicit class TuningJobCompletionCriteriaOps[Self <: TuningJobCompletionCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTargetObjectiveMetricValue(value: TargetObjectiveMetricValue): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TargetObjectiveMetricValue")(value.asInstanceOf[js.Any])
        ret
    }
  }
