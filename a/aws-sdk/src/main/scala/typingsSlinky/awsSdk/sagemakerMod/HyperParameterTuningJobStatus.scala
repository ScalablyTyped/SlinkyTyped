...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait HyperParameterTuningJobStatus extends js.Object
...
object HyperParameterTuningJobStatus {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): HyperParameterTuningJobStatus = value.asInstanceOf[HyperParameterTuningJobStatus]
}
