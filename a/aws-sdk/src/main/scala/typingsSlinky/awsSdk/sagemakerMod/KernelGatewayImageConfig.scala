...
trait KernelGatewayImageConfig extends StObject {
  ...
  /**
    ...
    */
  var FileSystemConfig: js.UndefOr[typingsSlinky.awsSdk.sagemakerMod.FileSystemConfig] = js.native
  
  /**
    * The specification of the Jupyter kernels in the image.
    */
  var KernelSpecs: typingsSlinky.awsSdk.sagemakerMod.KernelSpecs = js.native
}
