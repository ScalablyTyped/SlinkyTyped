...
trait ResourceConfig extends js.Object {
  ...
  /**
    ...
    */
  var VolumeSizeInGB: typingsSlinky.awsSdk.sagemakerMod.VolumeSizeInGB = js.native
}
...
object ResourceConfig {
  ...
  implicit class ResourceConfigOps[Self <: ResourceConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInstanceCount(value: TrainingInstanceCount): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InstanceCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInstanceType(value: TrainingInstanceType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InstanceType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVolumeSizeInGB(value: VolumeSizeInGB): Self = {
        val ret = this.duplicate
