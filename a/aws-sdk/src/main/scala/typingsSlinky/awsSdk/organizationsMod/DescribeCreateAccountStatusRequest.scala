...
object DescribeCreateAccountStatusRequest {
  ...
  implicit class DescribeCreateAccountStatusRequestOps[Self <: DescribeCreateAccountStatusRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateAccountRequestId(value: CreateAccountRequestId): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateAccountRequestId")(value.asInstanceOf[js.Any])
        ret
    }
  }
