...
object ListParentsRequest {
  ...
  @scala.inline
  implicit class ListParentsRequestOps[Self <: ListParentsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setChildId(value: ChildId): Self = this.set("ChildId", value.asInstanceOf[js.Any])
    @scala.inline
