...
object ListChildrenRequest {
  ...
  @scala.inline
  implicit class ListChildrenRequestOps[Self <: ListChildrenRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildType(value: ChildType): Self = this.set("ChildType", value.asInstanceOf[js.Any])
