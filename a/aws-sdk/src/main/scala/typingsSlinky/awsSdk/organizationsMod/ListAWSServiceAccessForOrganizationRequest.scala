...
object ListAWSServiceAccessForOrganizationRequest {
  ...
  @scala.inline
  def apply(): ListAWSServiceAccessForOrganizationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListAWSServiceAccessForOrganizationRequest]
  }
  
  @scala.inline
  implicit class ListAWSServiceAccessForOrganizationRequestMutableBuilder[Self <: ListAWSServiceAccessForOrganizationRequest] (val x: Self) extends AnyVal {
