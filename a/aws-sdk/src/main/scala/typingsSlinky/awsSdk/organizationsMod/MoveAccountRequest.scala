...
object MoveAccountRequest {
  ...
  implicit class MoveAccountRequestOps[Self <: MoveAccountRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDestinationParentId(value: ParentId): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DestinationParentId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSourceParentId(value: ParentId): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceParentId")(value.asInstanceOf[js.Any])
        ret
    }
  }
