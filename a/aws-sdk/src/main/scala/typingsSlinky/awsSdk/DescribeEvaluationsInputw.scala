...
import typingsSlinky.awsSdk.machinelearningMod.EvaluationFilterVariable
...
/* Inlined aws-sdk.aws-sdk/clients/machinelearning.DescribeEvaluationsInput & {  $waiter ? :aws-sdk.aws-sdk/lib/service.WaiterConfiguration} */
@js.native
trait DescribeEvaluationsInputw extends js.Object {
  @JSName("$waiter")
...
object DescribeEvaluationsInputw {
  @scala.inline
  def apply(): DescribeEvaluationsInputw = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeEvaluationsInputw]
  }
  @scala.inline
  implicit class DescribeEvaluationsInputwOps[Self <: DescribeEvaluationsInputw] (val x: Self) extends AnyVal {
    @scala.inline
