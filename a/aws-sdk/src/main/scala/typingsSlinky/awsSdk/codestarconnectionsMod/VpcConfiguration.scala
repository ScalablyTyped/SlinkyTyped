...
trait VpcConfiguration extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: typingsSlinky.awsSdk.codestarconnectionsMod.SecurityGroupIds = js.native
  /**
    * The ID of the subnet or subnets associated with the Amazon VPC connected to the infrastructure where your provider type is installed.
    */
  var SubnetIds: typingsSlinky.awsSdk.codestarconnectionsMod.SubnetIds = js.native
  /**
    * The value of the Transport Layer Security (TLS) certificate associated with the infrastructure where your provider type is installed.
    */
  var TlsCertificate: js.UndefOr[typingsSlinky.awsSdk.codestarconnectionsMod.TlsCertificate] = js.native
  /**
    * The ID of the Amazon VPC connected to the infrastructure where your provider type is installed.
    */
  var VpcId: typingsSlinky.awsSdk.codestarconnectionsMod.VpcId = js.native
}
