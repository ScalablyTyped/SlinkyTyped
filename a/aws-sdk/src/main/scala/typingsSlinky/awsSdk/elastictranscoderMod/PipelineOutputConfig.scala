...
trait PipelineOutputConfig extends js.Object {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typingsSlinky.awsSdk.elastictranscoderMod.Permissions] = js.native
  /**
    ...
    */
  var StorageClass: js.UndefOr[typingsSlinky.awsSdk.elastictranscoderMod.StorageClass] = js.native
}
