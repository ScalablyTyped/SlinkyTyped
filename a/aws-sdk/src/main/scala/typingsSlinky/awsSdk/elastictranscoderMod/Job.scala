...
trait Job extends js.Object {
  ...
  /**
    ...
    */
  var Playlists: js.UndefOr[typingsSlinky.awsSdk.elastictranscoderMod.Playlists] = js.native
  /**
  ...
  /**
    ...
    */
  var Timing: js.UndefOr[typingsSlinky.awsSdk.elastictranscoderMod.Timing] = js.native
  /**
...
object Job {
  ...
  implicit class JobOps[Self <: Job] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOutput(value: JobOutput): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutputs(value: JobOutputs): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPlaylists(value: Playlists): Self = {
        val ret = this.duplicate
