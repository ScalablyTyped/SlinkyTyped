...
object QueryExecutionStatus {
  ...
  implicit class QueryExecutionStatusOps[Self <: QueryExecutionStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompletionDateTime(value: js.Date): Self = this.set("CompletionDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSubmissionDateTime(value: js.Date): Self = this.set("SubmissionDateTime", value.asInstanceOf[js.Any])
    @scala.inline
