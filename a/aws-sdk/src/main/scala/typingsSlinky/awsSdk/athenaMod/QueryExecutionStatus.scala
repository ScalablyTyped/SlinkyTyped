...
object QueryExecutionStatus {
  ...
  implicit class QueryExecutionStatusMutableBuilder[Self <: QueryExecutionStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCompletionDateTime(value: js.Date): Self = StObject.set(x, "CompletionDateTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubmissionDateTime(value: js.Date): Self = StObject.set(x, "SubmissionDateTime", value.asInstanceOf[js.Any])
