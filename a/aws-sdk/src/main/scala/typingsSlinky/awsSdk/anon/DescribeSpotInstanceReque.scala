...
import typingsSlinky.awsSdk.ec2Mod.SpotInstanceRequestId
...
object DescribeSpotInstanceReque {
  ...
  @scala.inline
  implicit class DescribeSpotInstanceRequeMutableBuilder[Self <: DescribeSpotInstanceReque] (val x: Self) extends AnyVal {
