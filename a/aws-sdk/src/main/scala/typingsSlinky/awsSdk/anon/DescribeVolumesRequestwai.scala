...
import typingsSlinky.awsSdk.ec2Mod.VolumeId
...
object DescribeVolumesRequestwai {
  ...
  @scala.inline
  implicit class DescribeVolumesRequestwaiMutableBuilder[Self <: DescribeVolumesRequestwai] (val x: Self) extends AnyVal {
