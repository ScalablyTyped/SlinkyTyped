...
import typingsSlinky.awsSdk.ec2Mod.DescribeVpcsMaxResults
...
import typingsSlinky.awsSdk.ec2Mod.VpcId
import typingsSlinky.awsSdk.ec2Mod.VpcIdStringList
...
object DescribeVpcsRequestwaiter {
  ...
  @scala.inline
  implicit class DescribeVpcsRequestwaiterMutableBuilder[Self <: DescribeVpcsRequestwaiter] (val x: Self) extends AnyVal {
