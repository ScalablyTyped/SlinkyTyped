...
import typingsSlinky.awsSdk.ec2Mod.ImageId
...
object DescribeImagesRequestwait {
  ...
  implicit class DescribeImagesRequestwaitOps[Self <: DescribeImagesRequestwait] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExecutableUsersVarargs(value: typingsSlinky.awsSdk.ec2Mod.String*): Self = this.set("ExecutableUsers", js.Array(value :_*))
    ...
    @scala.inline
    def setOwnersVarargs(value: typingsSlinky.awsSdk.ec2Mod.String*): Self = this.set("Owners", js.Array(value :_*))
