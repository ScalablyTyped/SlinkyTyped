...
import typingsSlinky.awsSdk.ec2Mod.DescribeNetworkInterfacesMaxResults
import typingsSlinky.awsSdk.ec2Mod.FilterList
import typingsSlinky.awsSdk.ec2Mod.NetworkInterfaceIdList
...
object DescribeNetworkInterfaces {
  ...
  implicit class DescribeNetworkInterfacesOps[Self <: DescribeNetworkInterfaces] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxResults(value: DescribeNetworkInterfacesMaxResults): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNetworkInterfaceIds(value: NetworkInterfaceIdList): Self = {
        val ret = this.duplicate
