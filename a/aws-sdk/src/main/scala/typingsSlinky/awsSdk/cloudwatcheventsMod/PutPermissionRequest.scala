...
trait PutPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typingsSlinky.awsSdk.cloudwatcheventsMod.Action] = js.native
  ...
  /**
    ...
    */
  var Principal: js.UndefOr[typingsSlinky.awsSdk.cloudwatcheventsMod.Principal] = js.native
