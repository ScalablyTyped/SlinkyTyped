...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsSlinky.awsSdk.cloudwatcheventsMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typingsSlinky.awsSdk.cloudwatcheventsMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsSlinky.awsSdk.cloudwatcheventsMod.Principal = js.native
  /**
    * An identifier string for the external account that you are granting permissions to. If you later want to revoke the permission for this external account, specify this StatementId when you run RemovePermission.
    */
  var StatementId: typingsSlinky.awsSdk.cloudwatcheventsMod.StatementId = js.native
}
