...
object apigatewaymanagementapiMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.apigatewaymanagementapiMod.apiVersion] = js.native
  }
  ...
  object GetConnectionResponse {
    ...
    implicit class GetConnectionResponseMutableBuilder[Self <: GetConnectionResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConnectedAt(value: js.Date): Self = StObject.set(x, "ConnectedAt", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLastActiveAt(value: js.Date): Self = StObject.set(x, "LastActiveAt", value.asInstanceOf[js.Any])
