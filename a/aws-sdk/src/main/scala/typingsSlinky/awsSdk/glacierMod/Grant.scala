...
trait Grant extends js.Object {
  ...
  /**
    * The grantee.
    */
  var Grantee: js.UndefOr[typingsSlinky.awsSdk.glacierMod.Grantee] = js.native
  
  /**
    * Specifies the permission given to the grantee. 
    */
  var Permission: js.UndefOr[typingsSlinky.awsSdk.glacierMod.Permission] = js.native
}
object Grant {
