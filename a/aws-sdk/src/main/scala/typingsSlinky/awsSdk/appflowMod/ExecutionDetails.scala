...
trait ExecutionDetails extends StObject {
  ...
  /**
    ...
    */
  var mostRecentExecutionTime: js.UndefOr[js.Date] = js.native
}
object ExecutionDetails {
  ...
  implicit class ExecutionDetailsMutableBuilder[Self <: ExecutionDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMostRecentExecutionTime(value: js.Date): Self = StObject.set(x, "mostRecentExecutionTime", value.asInstanceOf[js.Any])
