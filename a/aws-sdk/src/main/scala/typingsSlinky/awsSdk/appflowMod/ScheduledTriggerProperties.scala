...
trait ScheduledTriggerProperties extends StObject {
  ...
  /**
    ...
    */
  var scheduleEndTime: js.UndefOr[js.Date] = js.native
  ...
  /**
    ...
    */
  var scheduleStartTime: js.UndefOr[js.Date] = js.native
...
object ScheduledTriggerProperties {
  ...
  implicit class ScheduledTriggerPropertiesMutableBuilder[Self <: ScheduledTriggerProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScheduleEndTime(value: js.Date): Self = StObject.set(x, "scheduleEndTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScheduleStartTime(value: js.Date): Self = StObject.set(x, "scheduleStartTime", value.asInstanceOf[js.Any])
