...
object ScheduledTriggerProperties {
  ...
  implicit class ScheduledTriggerPropertiesOps[Self <: ScheduledTriggerProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScheduleEndTime(value: js.Date): Self = this.set("scheduleEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteScheduleEndTime: Self = this.set("scheduleEndTime", js.undefined)
    
    @scala.inline
    def setScheduleStartTime(value: js.Date): Self = this.set("scheduleStartTime", value.asInstanceOf[js.Any])
