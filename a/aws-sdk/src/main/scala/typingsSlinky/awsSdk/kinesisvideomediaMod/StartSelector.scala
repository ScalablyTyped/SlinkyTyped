...
trait StartSelector extends js.Object {
  ...
  /**
    ...
    */
  var ContinuationToken: js.UndefOr[typingsSlinky.awsSdk.kinesisvideomediaMod.ContinuationToken] = js.native
  ...
  /**
    ...
    */
  var StartSelectorType: typingsSlinky.awsSdk.kinesisvideomediaMod.StartSelectorType = js.native
...
object StartSelector {
  ...
  implicit class StartSelectorOps[Self <: StartSelector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStartTimestamp(value: js.Date): Self = this.set("StartTimestamp", value.asInstanceOf[js.Any])
