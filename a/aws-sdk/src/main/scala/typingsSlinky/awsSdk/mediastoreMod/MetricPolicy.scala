...
trait MetricPolicy extends js.Object {
  /**
    ...
    */
  var ContainerLevelMetrics: typingsSlinky.awsSdk.mediastoreMod.ContainerLevelMetrics = js.native
  /**
    ...
    */
  var MetricPolicyRules: js.UndefOr[typingsSlinky.awsSdk.mediastoreMod.MetricPolicyRules] = js.native
}
