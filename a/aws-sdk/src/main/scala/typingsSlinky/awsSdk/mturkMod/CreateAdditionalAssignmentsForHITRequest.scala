...
object CreateAdditionalAssignmentsForHITRequest {
  ...
  implicit class CreateAdditionalAssignmentsForHITRequestOps[Self <: CreateAdditionalAssignmentsForHITRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumberOfAdditionalAssignments(value: Integer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NumberOfAdditionalAssignments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
