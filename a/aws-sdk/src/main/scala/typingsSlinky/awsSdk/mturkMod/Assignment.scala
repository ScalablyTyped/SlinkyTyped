...
object Assignment {
  ...
  implicit class AssignmentOps[Self <: Assignment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcceptTime(value: js.Date): Self = this.set("AcceptTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setApprovalTime(value: js.Date): Self = this.set("ApprovalTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setAutoApprovalTime(value: js.Date): Self = this.set("AutoApprovalTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRejectionTime(value: js.Date): Self = this.set("RejectionTime", value.asInstanceOf[js.Any])
    @scala.inline
