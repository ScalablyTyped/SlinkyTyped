...
object Assignment {
  ...
  implicit class AssignmentMutableBuilder[Self <: Assignment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcceptTime(value: js.Date): Self = StObject.set(x, "AcceptTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setApprovalTime(value: js.Date): Self = StObject.set(x, "ApprovalTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAutoApprovalTime(value: js.Date): Self = StObject.set(x, "AutoApprovalTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRejectionTime(value: js.Date): Self = StObject.set(x, "RejectionTime", value.asInstanceOf[js.Any])
