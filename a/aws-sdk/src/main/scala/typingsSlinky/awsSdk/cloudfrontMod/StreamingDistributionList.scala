...
object StreamingDistributionList {
  ...
  implicit class StreamingDistributionListOps[Self <: StreamingDistributionList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: StreamingDistributionSummary*): Self = this.set("Items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: StreamingDistributionSummaryList): Self = this.set("Items", value.asInstanceOf[js.Any])
