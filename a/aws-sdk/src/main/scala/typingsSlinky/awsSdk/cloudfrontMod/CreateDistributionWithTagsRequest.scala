...
object CreateDistributionWithTagsRequest {
  ...
  implicit class CreateDistributionWithTagsRequestOps[Self <: CreateDistributionWithTagsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDistributionConfigWithTags(value: DistributionConfigWithTags): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DistributionConfigWithTags")(value.asInstanceOf[js.Any])
        ret
    }
  }
