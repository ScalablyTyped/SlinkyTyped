...
object CloudFrontOriginAccessIdentityList {
  ...
  implicit class CloudFrontOriginAccessIdentityListOps[Self <: CloudFrontOriginAccessIdentityList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: CloudFrontOriginAccessIdentitySummary*): Self = this.set("Items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: CloudFrontOriginAccessIdentitySummaryList): Self = this.set("Items", value.asInstanceOf[js.Any])
