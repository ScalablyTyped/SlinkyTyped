...
trait PutScalingPolicyRequest extends js.Object {
  /**
    ...
    */
  var PolicyName: typingsSlinky.awsSdk.applicationautoscalingMod.PolicyName = js.native
  /**
    ...
    */
  var PolicyType: js.UndefOr[typingsSlinky.awsSdk.applicationautoscalingMod.PolicyType] = js.native
  /**
  ...
  /**
    ...
    */
  var StepScalingPolicyConfiguration: js.UndefOr[typingsSlinky.awsSdk.applicationautoscalingMod.StepScalingPolicyConfiguration] = js.native
  /**
  ...
  var TargetTrackingScalingPolicyConfiguration: js.UndefOr[
    typingsSlinky.awsSdk.applicationautoscalingMod.TargetTrackingScalingPolicyConfiguration
  ] = js.native
}
...
object PutScalingPolicyRequest {
  ...
  @scala.inline
  implicit class PutScalingPolicyRequestOps[Self <: PutScalingPolicyRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withStepScalingPolicyConfiguration(value: StepScalingPolicyConfiguration): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTargetTrackingScalingPolicyConfiguration(value: TargetTrackingScalingPolicyConfiguration): Self = {
        val ret = this.duplicate
