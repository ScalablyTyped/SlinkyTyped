...
@js.native
trait DescribeScalingActivitiesRequest extends StObject {
...
object DescribeScalingActivitiesRequest {
  ...
  @scala.inline
  def apply(ServiceNamespace: ServiceNamespace): DescribeScalingActivitiesRequest = {
  ...
  @scala.inline
  implicit class DescribeScalingActivitiesRequestMutableBuilder[Self <: DescribeScalingActivitiesRequest] (val x: Self) extends AnyVal {
