...
import typingsSlinky.awsSdk.awsSdkStrings.RDS
...
object piMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.piMod.apiVersion] = js.native
  }
  ...
  object DescribeDimensionKeysResponse {
    ...
    implicit class DescribeDimensionKeysResponseMutableBuilder[Self <: DescribeDimensionKeysResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlignedEndTime(value: js.Date): Self = StObject.set(x, "AlignedEndTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAlignedEndTimeUndefined: Self = StObject.set(x, "AlignedEndTime", js.undefined)
      
      @scala.inline
      def setAlignedStartTime(value: js.Date): Self = StObject.set(x, "AlignedStartTime", value.asInstanceOf[js.Any])
