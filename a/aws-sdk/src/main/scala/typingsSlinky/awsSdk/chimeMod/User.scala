...
object User {
  ...
  implicit class UserOps[Self <: User] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInvitedOn(value: js.Date): Self = this.set("InvitedOn", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRegisteredOn(value: js.Date): Self = this.set("RegisteredOn", value.asInstanceOf[js.Any])
