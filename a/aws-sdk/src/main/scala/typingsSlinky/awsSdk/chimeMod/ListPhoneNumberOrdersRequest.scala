...
object ListPhoneNumberOrdersRequest {
  ...
  @scala.inline
  def apply(): ListPhoneNumberOrdersRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListPhoneNumberOrdersRequest]
  }
  
  @scala.inline
  implicit class ListPhoneNumberOrdersRequestMutableBuilder[Self <: ListPhoneNumberOrdersRequest] (val x: Self) extends AnyVal {
