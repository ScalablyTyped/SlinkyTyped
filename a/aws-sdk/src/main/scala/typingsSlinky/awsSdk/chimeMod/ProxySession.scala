...
trait ProxySession extends StObject {
  ...
  /**
    ...
    */
  var EndedTimestamp: js.UndefOr[js.Date] = js.native
  ...
  /**
    ...
    */
  var GeoMatchLevel: js.UndefOr[typingsSlinky.awsSdk.chimeMod.GeoMatchLevel] = js.native
  
  /**
    * The country and area code for the proxy phone number.
    */
  var GeoMatchParams: js.UndefOr[typingsSlinky.awsSdk.chimeMod.GeoMatchParams] = js.native
  ...
  /**
    ...
    */
  var NumberSelectionBehavior: js.UndefOr[typingsSlinky.awsSdk.chimeMod.NumberSelectionBehavior] = js.native
  
  /**
    * The proxy session participants.
    */
  var Participants: js.UndefOr[typingsSlinky.awsSdk.chimeMod.Participants] = js.native
...
object ProxySession {
  ...
  implicit class ProxySessionMutableBuilder[Self <: ProxySession] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndedTimestamp(value: js.Date): Self = StObject.set(x, "EndedTimestamp", value.asInstanceOf[js.Any])
