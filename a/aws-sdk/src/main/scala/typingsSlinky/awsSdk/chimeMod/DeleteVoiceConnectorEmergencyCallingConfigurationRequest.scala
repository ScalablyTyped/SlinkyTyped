...
object DeleteVoiceConnectorEmergencyCallingConfigurationRequest {
  ...
  @scala.inline
  implicit class DeleteVoiceConnectorEmergencyCallingConfigurationRequestOps[Self <: DeleteVoiceConnectorEmergencyCallingConfigurationRequest] (val x: Self) extends AnyVal {
