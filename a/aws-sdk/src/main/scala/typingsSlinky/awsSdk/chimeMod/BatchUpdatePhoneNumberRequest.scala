...
object BatchUpdatePhoneNumberRequest {
  ...
  implicit class BatchUpdatePhoneNumberRequestOps[Self <: BatchUpdatePhoneNumberRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdatePhoneNumberRequestItems(value: UpdatePhoneNumberRequestItemList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UpdatePhoneNumberRequestItems")(value.asInstanceOf[js.Any])
        ret
    }
  }
