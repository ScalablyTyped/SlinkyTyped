...
trait RetentionSettings extends js.Object {
  /**
    ...
    */
  var ConversationRetentionSettings: js.UndefOr[typingsSlinky.awsSdk.chimeMod.ConversationRetentionSettings] = js.native
  /**
    * The chat room retention settings.
    */
  var RoomRetentionSettings: js.UndefOr[typingsSlinky.awsSdk.chimeMod.RoomRetentionSettings] = js.native
}
