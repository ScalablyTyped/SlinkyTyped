...
trait ReplicationTaskIndividualAssessment extends StObject {
  ...
  /**
    ...
    */
  var ReplicationTaskIndividualAssessmentStartDate: js.UndefOr[js.Date] = js.native
...
object ReplicationTaskIndividualAssessment {
  ...
  implicit class ReplicationTaskIndividualAssessmentMutableBuilder[Self <: ReplicationTaskIndividualAssessment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicationTaskIndividualAssessmentStartDate(value: js.Date): Self = StObject.set(x, "ReplicationTaskIndividualAssessmentStartDate", value.asInstanceOf[js.Any])
