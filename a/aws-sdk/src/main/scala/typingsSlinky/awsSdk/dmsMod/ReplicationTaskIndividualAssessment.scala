...
object ReplicationTaskIndividualAssessment {
  ...
  implicit class ReplicationTaskIndividualAssessmentOps[Self <: ReplicationTaskIndividualAssessment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicationTaskIndividualAssessmentStartDate(value: js.Date): Self = this.set("ReplicationTaskIndividualAssessmentStartDate", value.asInstanceOf[js.Any])
    @scala.inline
