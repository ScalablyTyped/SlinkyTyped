...
object DescribeReplicationTaskIndividualAssessmentsMessage {
  ...
  @scala.inline
  implicit class DescribeReplicationTaskIndividualAssessmentsMessageOps[Self <: DescribeReplicationTaskIndividualAssessmentsMessage] (val x: Self) extends AnyVal {
