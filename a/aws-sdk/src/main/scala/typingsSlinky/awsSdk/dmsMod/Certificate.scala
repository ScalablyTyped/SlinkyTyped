...
object Certificate {
  ...
  implicit class CertificateOps[Self <: Certificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertificateCreationDate(value: js.Date): Self = this.set("CertificateCreationDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValidFromDate(value: js.Date): Self = this.set("ValidFromDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteValidFromDate: Self = this.set("ValidFromDate", js.undefined)
    
    @scala.inline
    def setValidToDate(value: js.Date): Self = this.set("ValidToDate", value.asInstanceOf[js.Any])
