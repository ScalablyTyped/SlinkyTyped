...
trait ReplicationTaskAssessmentRun extends StObject {
  ...
  /**
    ...
    */
  var ReplicationTaskAssessmentRunCreationDate: js.UndefOr[js.Date] = js.native
...
object ReplicationTaskAssessmentRun {
  ...
  implicit class ReplicationTaskAssessmentRunMutableBuilder[Self <: ReplicationTaskAssessmentRun] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicationTaskAssessmentRunCreationDate(value: js.Date): Self = StObject.set(x, "ReplicationTaskAssessmentRunCreationDate", value.asInstanceOf[js.Any])
