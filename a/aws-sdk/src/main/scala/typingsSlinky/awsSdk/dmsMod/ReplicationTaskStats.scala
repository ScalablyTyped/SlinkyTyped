...
object ReplicationTaskStats {
  ...
  implicit class ReplicationTaskStatsOps[Self <: ReplicationTaskStats] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFreshStartDate(value: js.Date): Self = this.set("FreshStartDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFreshStartDate: Self = this.set("FreshStartDate", js.undefined)
    @scala.inline
    def setFullLoadFinishDate(value: js.Date): Self = this.set("FullLoadFinishDate", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFullLoadStartDate(value: js.Date): Self = this.set("FullLoadStartDate", value.asInstanceOf[js.Any])
    @scala.inline
