...
object TableStatistics {
  ...
  implicit class TableStatisticsMutableBuilder[Self <: TableStatistics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullLoadEndTime(value: js.Date): Self = StObject.set(x, "FullLoadEndTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFullLoadStartTime(value: js.Date): Self = StObject.set(x, "FullLoadStartTime", value.asInstanceOf[js.Any])
