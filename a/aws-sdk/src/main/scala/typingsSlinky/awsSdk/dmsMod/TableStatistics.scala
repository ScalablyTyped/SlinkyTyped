...
object TableStatistics {
  ...
  implicit class TableStatisticsOps[Self <: TableStatistics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFullLoadEndTime(value: js.Date): Self = this.set("FullLoadEndTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFullLoadStartTime(value: js.Date): Self = this.set("FullLoadStartTime", value.asInstanceOf[js.Any])
