...
object GetParametersForImportResponse {
  ...
  implicit class GetParametersForImportResponseMutableBuilder[Self <: GetParametersForImportResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImportTokenUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "ImportToken", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParametersValidTo(value: js.Date): Self = StObject.set(x, "ParametersValidTo", value.asInstanceOf[js.Any])
