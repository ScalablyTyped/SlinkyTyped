...
object KeyMetadata {
  ...
  implicit class KeyMetadataOps[Self <: KeyMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeletionDate(value: js.Date): Self = this.set("DeletionDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValidTo(value: js.Date): Self = this.set("ValidTo", value.asInstanceOf[js.Any])
