...
object GenerateDataKeyPairResponse {
  ...
  implicit class GenerateDataKeyPairResponseMutableBuilder[Self <: GenerateDataKeyPairResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKeyCiphertextBlobUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "PrivateKeyCiphertextBlob", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrivateKeyPlaintextUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "PrivateKeyPlaintext", value.asInstanceOf[js.Any])
