...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait NamespaceDeletionStatus extends js.Object
...
object NamespaceDeletionStatus {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): NamespaceDeletionStatus = value.asInstanceOf[NamespaceDeletionStatus]
}
