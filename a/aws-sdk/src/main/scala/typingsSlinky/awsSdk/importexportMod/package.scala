...
package object importexportMod {
  ...
  type ArtifactList = js.Array[typingsSlinky.awsSdk.importexportMod.Artifact]
  type Carrier = java.lang.String
  type ClientConfiguration = typingsSlinky.awsSdk.serviceMod.ServiceConfigurationOptions with typingsSlinky.awsSdk.importexportMod.ClientApiVersions
