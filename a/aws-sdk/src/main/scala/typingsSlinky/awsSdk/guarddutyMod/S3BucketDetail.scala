...
trait S3BucketDetail extends js.Object {
  ...
  /**
    ...
    */
  var DefaultServerSideEncryption: js.UndefOr[typingsSlinky.awsSdk.guarddutyMod.DefaultServerSideEncryption] = js.native
  /**
  ...
  /**
    ...
    */
  var Owner: js.UndefOr[typingsSlinky.awsSdk.guarddutyMod.Owner] = js.native
  /**
    * Describes the public access policies that apply to the S3 bucket.
    */
  var PublicAccess: js.UndefOr[typingsSlinky.awsSdk.guarddutyMod.PublicAccess] = js.native
  /**
