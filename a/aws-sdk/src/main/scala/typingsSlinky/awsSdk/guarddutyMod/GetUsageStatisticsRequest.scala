...
trait GetUsageStatisticsRequest extends js.Object {
  ...
  /**
    ...
    */
  var UsageCriteria: typingsSlinky.awsSdk.guarddutyMod.UsageCriteria = js.native
  /**
    * The type of usage statistics to retrieve.
    */
  var UsageStatisticType: typingsSlinky.awsSdk.guarddutyMod.UsageStatisticType = js.native
}
