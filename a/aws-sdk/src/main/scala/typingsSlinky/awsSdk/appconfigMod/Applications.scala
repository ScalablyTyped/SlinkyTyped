...
object Applications {
  ...
  implicit class ApplicationsOps[Self <: Applications] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Application*): Self = this.set("Items", js.Array(value :_*))
    @scala.inline
    def setItems(value: ApplicationList): Self = this.set("Items", value.asInstanceOf[js.Any])
    @scala.inline
