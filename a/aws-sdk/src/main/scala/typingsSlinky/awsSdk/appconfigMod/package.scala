...
package object appconfigMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.awsSdk.awsSdkStrings.PERCENTAGE_UPDATED
    - typingsSlinky.awsSdk.awsSdkStrings.ROLLBACK_STARTED
    - typingsSlinky.awsSdk.awsSdkStrings.ROLLBACK_COMPLETED
    - typingsSlinky.awsSdk.awsSdkStrings.BAKE_TIME_STARTED
    - typingsSlinky.awsSdk.awsSdkStrings.DEPLOYMENT_STARTED
    - typingsSlinky.awsSdk.awsSdkStrings.DEPLOYMENT_COMPLETED
    - java.lang.String
  */
  type DeploymentEventType = typingsSlinky.awsSdk.appconfigMod._DeploymentEventType | java.lang.String
  type DeploymentEvents = js.Array[typingsSlinky.awsSdk.appconfigMod.DeploymentEvent]
  ...
  */
  ...
  type HostedConfigurationVersionSummaryList = js.Array[typingsSlinky.awsSdk.appconfigMod.HostedConfigurationVersionSummary]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.APPCONFIG
    - typingsSlinky.awsSdk.awsSdkStrings.CLOUDWATCH_ALARM
    - typingsSlinky.awsSdk.awsSdkStrings.INTERNAL_ERROR
    - java.lang.String
  */
  type TriggeredBy = typingsSlinky.awsSdk.appconfigMod._TriggeredBy | java.lang.String
