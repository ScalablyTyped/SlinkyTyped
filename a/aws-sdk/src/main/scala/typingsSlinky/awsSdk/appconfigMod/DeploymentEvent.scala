...
trait DeploymentEvent extends StObject {
  ...
  /**
    ...
    */
  var OccurredAt: js.UndefOr[js.Date] = js.native
  ...
  /**
    ...
    */
  var TriggeredBy: js.UndefOr[typingsSlinky.awsSdk.appconfigMod.TriggeredBy] = js.native
}
object DeploymentEvent {
  ...
  implicit class DeploymentEventMutableBuilder[Self <: DeploymentEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOccurredAt(value: js.Date): Self = StObject.set(x, "OccurredAt", value.asInstanceOf[js.Any])
