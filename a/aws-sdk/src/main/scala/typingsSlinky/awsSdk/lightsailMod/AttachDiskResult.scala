...
@js.native
trait AttachDiskResult extends StObject {
...
object AttachDiskResult {
  ...
  @scala.inline
  def apply(): AttachDiskResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AttachDiskResult]
  }
  
  @scala.inline
  implicit class AttachDiskResultMutableBuilder[Self <: AttachDiskResult] (val x: Self) extends AnyVal {
