...
@js.native
trait CreateDiskFromSnapshotResult extends StObject {
...
object CreateDiskFromSnapshotResult {
  ...
  @scala.inline
  def apply(): CreateDiskFromSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateDiskFromSnapshotResult]
  }
  
  @scala.inline
  implicit class CreateDiskFromSnapshotResultMutableBuilder[Self <: CreateDiskFromSnapshotResult] (val x: Self) extends AnyVal {
