...
@js.native
trait TestAlarmResult extends StObject {
...
object TestAlarmResult {
  ...
  @scala.inline
  def apply(): TestAlarmResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TestAlarmResult]
  }
  
  @scala.inline
  implicit class TestAlarmResultMutableBuilder[Self <: TestAlarmResult] (val x: Self) extends AnyVal {
