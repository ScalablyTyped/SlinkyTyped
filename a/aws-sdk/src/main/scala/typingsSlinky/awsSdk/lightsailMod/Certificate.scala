...
object Certificate {
  ...
  implicit class CertificateOps[Self <: Certificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIssuedAt(value: js.Date): Self = this.set("issuedAt", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRevokedAt(value: js.Date): Self = this.set("revokedAt", value.asInstanceOf[js.Any])
    @scala.inline
