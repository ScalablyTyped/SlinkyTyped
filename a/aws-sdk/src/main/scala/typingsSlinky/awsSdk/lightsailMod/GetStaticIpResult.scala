...
object GetStaticIpResult {
  ...
  implicit class GetStaticIpResultOps[Self <: GetStaticIpResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStaticIp(value: StaticIp): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("staticIp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutStaticIp: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("staticIp")(js.undefined)
        ret
    }
  }
