...
object DeleteInstanceSnapshotResult {
  ...
  @scala.inline
  def apply(): DeleteInstanceSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteInstanceSnapshotResult]
  }
  
  @scala.inline
  implicit class DeleteInstanceSnapshotResultMutableBuilder[Self <: DeleteInstanceSnapshotResult] (val x: Self) extends AnyVal {
