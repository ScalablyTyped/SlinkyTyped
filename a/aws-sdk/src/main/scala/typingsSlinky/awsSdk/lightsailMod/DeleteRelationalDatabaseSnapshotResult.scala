...
object DeleteRelationalDatabaseSnapshotResult {
  ...
  @scala.inline
  def apply(): DeleteRelationalDatabaseSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteRelationalDatabaseSnapshotResult]
  }
  
  @scala.inline
  implicit class DeleteRelationalDatabaseSnapshotResultMutableBuilder[Self <: DeleteRelationalDatabaseSnapshotResult] (val x: Self) extends AnyVal {
