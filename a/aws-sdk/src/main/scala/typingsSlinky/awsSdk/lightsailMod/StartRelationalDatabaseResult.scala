...
@js.native
trait StartRelationalDatabaseResult extends StObject {
...
object StartRelationalDatabaseResult {
  ...
  @scala.inline
  def apply(): StartRelationalDatabaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StartRelationalDatabaseResult]
  }
  
  @scala.inline
  implicit class StartRelationalDatabaseResultMutableBuilder[Self <: StartRelationalDatabaseResult] (val x: Self) extends AnyVal {
