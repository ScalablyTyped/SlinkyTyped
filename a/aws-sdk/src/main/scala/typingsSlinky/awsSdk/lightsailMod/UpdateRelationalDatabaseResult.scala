...
object UpdateRelationalDatabaseResult {
  ...
  @scala.inline
  def apply(): UpdateRelationalDatabaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateRelationalDatabaseResult]
  }
  
  @scala.inline
  implicit class UpdateRelationalDatabaseResultMutableBuilder[Self <: UpdateRelationalDatabaseResult] (val x: Self) extends AnyVal {
