...
object HostKeyAttributes {
  ...
  implicit class HostKeyAttributesOps[Self <: HostKeyAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotValidAfter(value: js.Date): Self = this.set("notValidAfter", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNotValidAfter: Self = this.set("notValidAfter", js.undefined)
    @scala.inline
    def setNotValidBefore(value: js.Date): Self = this.set("notValidBefore", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWitnessedAt(value: js.Date): Self = this.set("witnessedAt", value.asInstanceOf[js.Any])
    @scala.inline
