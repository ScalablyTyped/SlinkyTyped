...
object HostKeyAttributes {
  ...
  implicit class HostKeyAttributesMutableBuilder[Self <: HostKeyAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotValidAfter(value: js.Date): Self = StObject.set(x, "notValidAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNotValidAfterUndefined: Self = StObject.set(x, "notValidAfter", js.undefined)
    
    @scala.inline
    def setNotValidBefore(value: js.Date): Self = StObject.set(x, "notValidBefore", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWitnessedAt(value: js.Date): Self = StObject.set(x, "witnessedAt", value.asInstanceOf[js.Any])
