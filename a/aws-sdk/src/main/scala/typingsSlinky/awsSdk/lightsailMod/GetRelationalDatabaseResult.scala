...
object GetRelationalDatabaseResult {
  ...
  implicit class GetRelationalDatabaseResultOps[Self <: GetRelationalDatabaseResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRelationalDatabase(value: RelationalDatabase): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("relationalDatabase")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutRelationalDatabase: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("relationalDatabase")(js.undefined)
        ret
    }
  }
