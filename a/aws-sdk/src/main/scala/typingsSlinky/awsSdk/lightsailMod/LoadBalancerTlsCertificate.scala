...
object LoadBalancerTlsCertificate {
  ...
  implicit class LoadBalancerTlsCertificateMutableBuilder[Self <: LoadBalancerTlsCertificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIssuedAt(value: js.Date): Self = StObject.set(x, "issuedAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRevokedAt(value: js.Date): Self = StObject.set(x, "revokedAt", value.asInstanceOf[js.Any])
