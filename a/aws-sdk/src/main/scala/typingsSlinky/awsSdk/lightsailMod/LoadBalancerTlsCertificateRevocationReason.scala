...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait LoadBalancerTlsCertificateRevocationReason extends js.Object
...
object LoadBalancerTlsCertificateRevocationReason {
  ...
  @scala.inline
  implicit def apply(value: String): LoadBalancerTlsCertificateRevocationReason = value.asInstanceOf[LoadBalancerTlsCertificateRevocationReason]
}
