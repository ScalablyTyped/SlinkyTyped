...
@js.native
trait DeleteDiskSnapshotResult extends StObject {
...
object DeleteDiskSnapshotResult {
  ...
  @scala.inline
  def apply(): DeleteDiskSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteDiskSnapshotResult]
  }
  
  @scala.inline
  implicit class DeleteDiskSnapshotResultMutableBuilder[Self <: DeleteDiskSnapshotResult] (val x: Self) extends AnyVal {
