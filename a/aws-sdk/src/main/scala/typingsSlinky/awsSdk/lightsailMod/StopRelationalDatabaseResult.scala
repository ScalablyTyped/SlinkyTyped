...
object StopRelationalDatabaseResult {
  ...
  @scala.inline
  def apply(): StopRelationalDatabaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StopRelationalDatabaseResult]
  }
  
  @scala.inline
  implicit class StopRelationalDatabaseResultMutableBuilder[Self <: StopRelationalDatabaseResult] (val x: Self) extends AnyVal {
