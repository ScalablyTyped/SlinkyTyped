...
@js.native
trait DeleteCertificateResult extends StObject {
...
object DeleteCertificateResult {
  ...
  @scala.inline
  def apply(): DeleteCertificateResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteCertificateResult]
  }
  
  @scala.inline
  implicit class DeleteCertificateResultMutableBuilder[Self <: DeleteCertificateResult] (val x: Self) extends AnyVal {
