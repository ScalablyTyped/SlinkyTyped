...
@js.native
trait CreateRelationalDatabaseFromSnapshotResult extends StObject {
...
object CreateRelationalDatabaseFromSnapshotResult {
  ...
  @scala.inline
  def apply(): CreateRelationalDatabaseFromSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateRelationalDatabaseFromSnapshotResult]
  }
  
  @scala.inline
  implicit class CreateRelationalDatabaseFromSnapshotResultMutableBuilder[Self <: CreateRelationalDatabaseFromSnapshotResult] (val x: Self) extends AnyVal {
