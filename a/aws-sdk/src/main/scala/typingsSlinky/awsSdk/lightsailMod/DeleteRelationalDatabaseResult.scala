...
object DeleteRelationalDatabaseResult {
  ...
  @scala.inline
  def apply(): DeleteRelationalDatabaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteRelationalDatabaseResult]
  }
  
  @scala.inline
  implicit class DeleteRelationalDatabaseResultMutableBuilder[Self <: DeleteRelationalDatabaseResult] (val x: Self) extends AnyVal {
