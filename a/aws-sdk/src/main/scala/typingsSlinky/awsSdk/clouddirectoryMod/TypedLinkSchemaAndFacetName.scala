...
trait TypedLinkSchemaAndFacetName extends js.Object {
  ...
  /**
    ...
    */
  var TypedLinkName: typingsSlinky.awsSdk.clouddirectoryMod.TypedLinkName = js.native
}
...
object TypedLinkSchemaAndFacetName {
  ...
  implicit class TypedLinkSchemaAndFacetNameOps[Self <: TypedLinkSchemaAndFacetName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTypedLinkName(value: TypedLinkName): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TypedLinkName")(value.asInstanceOf[js.Any])
        ret
    }
  }
