...
trait GetScalingPlanResourceForecastDataRequest extends js.Object {
  ...
  /**
    ...
    */
  var ForecastDataType: typingsSlinky.awsSdk.autoscalingplansMod.ForecastDataType = js.native
  /**
...
object GetScalingPlanResourceForecastDataRequest {
  ...
  implicit class GetScalingPlanResourceForecastDataRequestOps[Self <: GetScalingPlanResourceForecastDataRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withForecastDataType(value: ForecastDataType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ForecastDataType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
