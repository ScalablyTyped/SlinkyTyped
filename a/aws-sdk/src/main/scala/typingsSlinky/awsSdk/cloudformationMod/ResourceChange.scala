...
trait ResourceChange extends js.Object {
  ...
  /**
    ...
    */
  var Replacement: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.Replacement] = js.native
  ...
  /**
    ...
    */
  var Scope: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.Scope] = js.native
}
