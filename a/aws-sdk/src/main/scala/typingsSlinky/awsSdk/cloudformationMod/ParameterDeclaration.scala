...
trait ParameterDeclaration extends js.Object {
  ...
  /**
    ...
    */
  var ParameterConstraints: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.ParameterConstraints] = js.native
  /**
  ...
  /**
    ...
    */
  var ParameterType: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.ParameterType] = js.native
}
