...
trait StackEvent extends js.Object {
  ...
  /**
    ...
    */
  var EventId: typingsSlinky.awsSdk.cloudformationMod.EventId = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceProperties: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.ResourceProperties] = js.native
  /**
    * Current status of the resource.
    */
  var ResourceStatus: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.ResourceStatus] = js.native
  /**
...
object StackEvent {
  @scala.inline
  def apply(EventId: EventId, StackId: StackId, StackName: StackName, Timestamp: js.Date): StackEvent = {
  ...
  implicit class StackEventOps[Self <: StackEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceProperties(value: ResourceProperties): Self = {
        val ret = this.duplicate
