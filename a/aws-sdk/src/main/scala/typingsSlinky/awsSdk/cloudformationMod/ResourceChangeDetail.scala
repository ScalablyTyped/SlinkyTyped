...
trait ResourceChangeDetail extends js.Object {
  /**
    ...
    */
  var CausingEntity: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.CausingEntity] = js.native
  /**
    ...
    */
  var ChangeSource: js.UndefOr[typingsSlinky.awsSdk.cloudformationMod.ChangeSource] = js.native
  /**
