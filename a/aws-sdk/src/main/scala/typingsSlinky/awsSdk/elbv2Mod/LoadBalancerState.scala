...
object LoadBalancerState {
  ...
  implicit class LoadBalancerStateMutableBuilder[Self <: LoadBalancerState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCode(value: LoadBalancerStateEnum): Self = StObject.set(x, "Code", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCodeUndefined: Self = StObject.set(x, "Code", js.undefined)
    
    @scala.inline
    def setReason(value: StateReason): Self = StObject.set(x, "Reason", value.asInstanceOf[js.Any])
