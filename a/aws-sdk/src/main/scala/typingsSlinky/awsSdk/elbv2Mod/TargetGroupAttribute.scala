...
object TargetGroupAttribute {
  ...
  @scala.inline
  implicit class TargetGroupAttributeOps[Self <: TargetGroupAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKey(value: TargetGroupAttributeKey): Self = this.set("Key", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteKey: Self = this.set("Key", js.undefined)
    
    @scala.inline
    def setValue(value: TargetGroupAttributeValue): Self = this.set("Value", value.asInstanceOf[js.Any])
