...
object GenericRevisionInfo {
  ...
  implicit class GenericRevisionInfoMutableBuilder[Self <: GenericRevisionInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstUsedTime(value: js.Date): Self = StObject.set(x, "firstUsedTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFirstUsedTimeUndefined: Self = StObject.set(x, "firstUsedTime", js.undefined)
    
    @scala.inline
    def setLastUsedTime(value: js.Date): Self = StObject.set(x, "lastUsedTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastUsedTimeUndefined: Self = StObject.set(x, "lastUsedTime", js.undefined)
    
    @scala.inline
    def setRegisterTime(value: js.Date): Self = StObject.set(x, "registerTime", value.asInstanceOf[js.Any])
