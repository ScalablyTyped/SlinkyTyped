...
trait GetHealthCheckCountResponse extends js.Object {
  /**
    ...
    */
  var HealthCheckCount: typingsSlinky.awsSdk.route53Mod.HealthCheckCount = js.native
}
...
object GetHealthCheckCountResponse {
  ...
  implicit class GetHealthCheckCountResponseOps[Self <: GetHealthCheckCountResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHealthCheckCount(value: HealthCheckCount): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HealthCheckCount")(value.asInstanceOf[js.Any])
        ret
    }
  }
