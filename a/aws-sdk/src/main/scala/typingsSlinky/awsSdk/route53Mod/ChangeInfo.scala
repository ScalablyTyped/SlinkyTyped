...
trait ChangeInfo extends StObject {
  ...
  /**
    ...
    */
  var SubmittedAt: js.Date = js.native
}
object ChangeInfo {
  
  @scala.inline
  def apply(Id: ResourceId, Status: ChangeStatus, SubmittedAt: js.Date): ChangeInfo = {
  ...
  implicit class ChangeInfoMutableBuilder[Self <: ChangeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubmittedAt(value: js.Date): Self = StObject.set(x, "SubmittedAt", value.asInstanceOf[js.Any])
  }
}
