...
trait GetCheckerIpRangesResponse extends js.Object {
  /**
    ...
    */
  var CheckerIpRanges: typingsSlinky.awsSdk.route53Mod.CheckerIpRanges = js.native
}
...
object GetCheckerIpRangesResponse {
  ...
  implicit class GetCheckerIpRangesResponseOps[Self <: GetCheckerIpRangesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheckerIpRanges(value: CheckerIpRanges): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CheckerIpRanges")(value.asInstanceOf[js.Any])
        ret
    }
  }
