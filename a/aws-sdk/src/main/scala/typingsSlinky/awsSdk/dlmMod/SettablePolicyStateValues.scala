...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait SettablePolicyStateValues extends js.Object
...
object SettablePolicyStateValues {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): SettablePolicyStateValues = value.asInstanceOf[SettablePolicyStateValues]
}
