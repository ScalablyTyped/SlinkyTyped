...
object GetLifecyclePoliciesResponse {
  ...
  implicit class GetLifecyclePoliciesResponseOps[Self <: GetLifecyclePoliciesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPoliciesVarargs(value: LifecyclePolicySummary*): Self = this.set("Policies", js.Array(value :_*))
    @scala.inline
    def setPolicies(value: LifecyclePolicySummaryList): Self = this.set("Policies", value.asInstanceOf[js.Any])
    @scala.inline
