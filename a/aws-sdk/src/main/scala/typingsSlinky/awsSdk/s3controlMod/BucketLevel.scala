...
trait BucketLevel extends StObject {
  ...
  /**
    ...
    */
  var ActivityMetrics: js.UndefOr[typingsSlinky.awsSdk.s3controlMod.ActivityMetrics] = js.native
  
  /**
    * A container for the bucket-level prefix-level metrics for S3 Storage Lens
    */
  var PrefixLevel: js.UndefOr[typingsSlinky.awsSdk.s3controlMod.PrefixLevel] = js.native
}
object BucketLevel {
