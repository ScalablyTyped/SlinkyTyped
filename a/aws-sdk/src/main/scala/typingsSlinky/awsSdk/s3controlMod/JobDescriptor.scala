...
object JobDescriptor {
  ...
  implicit class JobDescriptorOps[Self <: JobDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuspendedDate(value: js.Date): Self = this.set("SuspendedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSuspendedDate: Self = this.set("SuspendedDate", js.undefined)
    
    @scala.inline
    def setTerminationDate(value: js.Date): Self = this.set("TerminationDate", value.asInstanceOf[js.Any])
