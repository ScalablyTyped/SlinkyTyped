...
object JobDescriptor {
  ...
  implicit class JobDescriptorMutableBuilder[Self <: JobDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuspendedDate(value: js.Date): Self = StObject.set(x, "SuspendedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSuspendedDateUndefined: Self = StObject.set(x, "SuspendedDate", js.undefined)
    
    @scala.inline
    def setTerminationDate(value: js.Date): Self = StObject.set(x, "TerminationDate", value.asInstanceOf[js.Any])
