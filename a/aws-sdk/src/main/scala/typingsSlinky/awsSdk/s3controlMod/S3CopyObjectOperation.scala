...
object S3CopyObjectOperation {
  ...
  implicit class S3CopyObjectOperationMutableBuilder[Self <: S3CopyObjectOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModifiedSinceConstraint(value: js.Date): Self = StObject.set(x, "ModifiedSinceConstraint", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnModifiedSinceConstraint(value: js.Date): Self = StObject.set(x, "UnModifiedSinceConstraint", value.asInstanceOf[js.Any])
