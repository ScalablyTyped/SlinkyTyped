...
object S3CopyObjectOperation {
  ...
  implicit class S3CopyObjectOperationOps[Self <: S3CopyObjectOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModifiedSinceConstraint(value: js.Date): Self = this.set("ModifiedSinceConstraint", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnModifiedSinceConstraint(value: js.Date): Self = this.set("UnModifiedSinceConstraint", value.asInstanceOf[js.Any])
