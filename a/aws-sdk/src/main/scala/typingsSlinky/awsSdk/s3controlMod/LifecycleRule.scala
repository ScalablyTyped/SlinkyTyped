...
trait LifecycleRule extends StObject {
  ...
  /**
    ...
    */
  var AbortIncompleteMultipartUpload: js.UndefOr[typingsSlinky.awsSdk.s3controlMod.AbortIncompleteMultipartUpload] = js.native
  ...
  /**
    ...
    */
  var ID: js.UndefOr[typingsSlinky.awsSdk.s3controlMod.ID] = js.native
  
  /**
    * The noncurrent version expiration of the lifecycle rule.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var NoncurrentVersionExpiration: js.UndefOr[typingsSlinky.awsSdk.s3controlMod.NoncurrentVersionExpiration] = js.native
