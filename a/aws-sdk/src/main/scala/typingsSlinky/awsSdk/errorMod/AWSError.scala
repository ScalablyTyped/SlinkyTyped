package typingsSlinky.awsSdk.errorMod
...
@js.native
trait AWSError extends js.Object {
...
object AWSError {
  ...
  @scala.inline
  def apply(code: String, message: String, name: String, time: js.Date): AWSError = {
  ...
  @scala.inline
  implicit class AWSErrorOps[Self <: AWSError] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRetryable(value: Boolean): Self = this.set("retryable", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRetryable: Self = this.set("retryable", js.undefined)
