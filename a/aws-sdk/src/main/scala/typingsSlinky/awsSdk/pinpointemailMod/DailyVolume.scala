...
trait DailyVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typingsSlinky.awsSdk.pinpointemailMod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typingsSlinky.awsSdk.pinpointemailMod.VolumeStatistics] = js.native
}
