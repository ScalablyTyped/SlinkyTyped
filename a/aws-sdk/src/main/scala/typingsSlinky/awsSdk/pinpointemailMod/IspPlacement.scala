...
trait IspPlacement extends js.Object {
  /**
    ...
    */
  var IspName: js.UndefOr[typingsSlinky.awsSdk.pinpointemailMod.IspName] = js.native
  /**
    * An object that contains inbox placement metrics for a specific email provider.
    */
  var PlacementStatistics: js.UndefOr[typingsSlinky.awsSdk.pinpointemailMod.PlacementStatistics] = js.native
}
