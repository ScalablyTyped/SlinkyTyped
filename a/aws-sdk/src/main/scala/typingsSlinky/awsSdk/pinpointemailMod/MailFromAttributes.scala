...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typingsSlinky.awsSdk.pinpointemailMod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typingsSlinky.awsSdk.pinpointemailMod.MailFromDomainStatus = js.native
}
...
object MailFromAttributes {
  ...
  implicit class MailFromAttributesOps[Self <: MailFromAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMailFromDomainStatus(value: MailFromDomainStatus): Self = {
        val ret = this.duplicate
