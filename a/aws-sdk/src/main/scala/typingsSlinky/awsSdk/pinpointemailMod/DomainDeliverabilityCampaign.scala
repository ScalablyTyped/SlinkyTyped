...
object DomainDeliverabilityCampaign {
  ...
  implicit class DomainDeliverabilityCampaignOps[Self <: DomainDeliverabilityCampaign] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstSeenDateTime(value: js.Date): Self = this.set("FirstSeenDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastSeenDateTime(value: js.Date): Self = this.set("LastSeenDateTime", value.asInstanceOf[js.Any])
    @scala.inline
