...
object DomainDeliverabilityCampaign {
  ...
  implicit class DomainDeliverabilityCampaignMutableBuilder[Self <: DomainDeliverabilityCampaign] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstSeenDateTime(value: js.Date): Self = StObject.set(x, "FirstSeenDateTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLastSeenDateTime(value: js.Date): Self = StObject.set(x, "LastSeenDateTime", value.asInstanceOf[js.Any])
