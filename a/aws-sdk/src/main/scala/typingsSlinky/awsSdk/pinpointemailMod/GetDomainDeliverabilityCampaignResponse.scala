...
trait GetDomainDeliverabilityCampaignResponse extends js.Object {
  /**
    ...
    */
  var DomainDeliverabilityCampaign: typingsSlinky.awsSdk.pinpointemailMod.DomainDeliverabilityCampaign = js.native
}
...
object GetDomainDeliverabilityCampaignResponse {
  ...
  implicit class GetDomainDeliverabilityCampaignResponseOps[Self <: GetDomainDeliverabilityCampaignResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDomainDeliverabilityCampaign(value: DomainDeliverabilityCampaign): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DomainDeliverabilityCampaign")(value.asInstanceOf[js.Any])
        ret
    }
  }
