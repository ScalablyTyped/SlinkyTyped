...
object DBClusterSnapshotMessage {
  ...
  implicit class DBClusterSnapshotMessageOps[Self <: DBClusterSnapshotMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDBClusterSnapshots(value: DBClusterSnapshotList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DBClusterSnapshots")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDBClusterSnapshots: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DBClusterSnapshots")(js.undefined)
        ret
    }
    @scala.inline
