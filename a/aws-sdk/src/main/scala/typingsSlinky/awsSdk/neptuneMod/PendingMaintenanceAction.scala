...
object PendingMaintenanceAction {
  ...
  implicit class PendingMaintenanceActionOps[Self <: PendingMaintenanceAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutoAppliedAfterDate(value: js.Date): Self = this.set("AutoAppliedAfterDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAutoAppliedAfterDate: Self = this.set("AutoAppliedAfterDate", js.undefined)
    
    @scala.inline
    def setCurrentApplyDate(value: js.Date): Self = this.set("CurrentApplyDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setForcedApplyDate(value: js.Date): Self = this.set("ForcedApplyDate", value.asInstanceOf[js.Any])
