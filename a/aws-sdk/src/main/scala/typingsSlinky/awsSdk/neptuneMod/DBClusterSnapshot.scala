...
object DBClusterSnapshot {
  ...
  implicit class DBClusterSnapshotOps[Self <: DBClusterSnapshot] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClusterCreateTime(value: js.Date): Self = this.set("ClusterCreateTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSnapshotCreateTime(value: js.Date): Self = this.set("SnapshotCreateTime", value.asInstanceOf[js.Any])
    @scala.inline
