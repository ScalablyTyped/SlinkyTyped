...
@js.native
trait CreateDBClusterEndpointOutput extends StObject {
...
object CreateDBClusterEndpointOutput {
  ...
  @scala.inline
  def apply(): CreateDBClusterEndpointOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateDBClusterEndpointOutput]
  }
  
  @scala.inline
  implicit class CreateDBClusterEndpointOutputMutableBuilder[Self <: CreateDBClusterEndpointOutput] (val x: Self) extends AnyVal {
