...
object CopyDBClusterParameterGroupMessage {
  ...
  implicit class CopyDBClusterParameterGroupMessageOps[Self <: CopyDBClusterParameterGroupMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSourceDBClusterParameterGroupIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceDBClusterParameterGroupIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTargetDBClusterParameterGroupDescription(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TargetDBClusterParameterGroupDescription")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTargetDBClusterParameterGroupIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TargetDBClusterParameterGroupIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
