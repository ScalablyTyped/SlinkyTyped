...
/* Inlined aws-sdk.aws-sdk/clients/ec2.DescribeInstancesRequest & {  $waiter ? :aws-sdk.aws-sdk/lib/service.WaiterConfiguration} */
@js.native
trait DescribeInstancesRequestw extends js.Object {
  @JSName("$waiter")
...
object DescribeInstancesRequestw {
  @scala.inline
  def apply(): DescribeInstancesRequestw = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeInstancesRequestw]
  }
  @scala.inline
  implicit class DescribeInstancesRequestwOps[Self <: DescribeInstancesRequestw] (val x: Self) extends AnyVal {
    @scala.inline
