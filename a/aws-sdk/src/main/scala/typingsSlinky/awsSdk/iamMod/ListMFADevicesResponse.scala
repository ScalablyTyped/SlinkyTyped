...
object ListMFADevicesResponse {
  ...
  implicit class ListMFADevicesResponseOps[Self <: ListMFADevicesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMFADevicesVarargs(value: MFADevice*): Self = this.set("MFADevices", js.Array(value :_*))
    
    @scala.inline
    def setMFADevices(value: mfaDeviceListType): Self = this.set("MFADevices", value.asInstanceOf[js.Any])
