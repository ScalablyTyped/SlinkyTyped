...
@js.native
trait ListAttachedRolePoliciesResponse extends StObject {
...
object ListAttachedRolePoliciesResponse {
  ...
  @scala.inline
  def apply(): ListAttachedRolePoliciesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListAttachedRolePoliciesResponse]
  }
  
  @scala.inline
  implicit class ListAttachedRolePoliciesResponseMutableBuilder[Self <: ListAttachedRolePoliciesResponse] (val x: Self) extends AnyVal {
