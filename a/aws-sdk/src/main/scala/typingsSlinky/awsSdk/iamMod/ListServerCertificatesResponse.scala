...
object ListServerCertificatesResponse {
  ...
  implicit class ListServerCertificatesResponseOps[Self <: ListServerCertificatesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServerCertificateMetadataListVarargs(value: ServerCertificateMetadata*): Self = this.set("ServerCertificateMetadataList", js.Array(value :_*))
    
    @scala.inline
    def setServerCertificateMetadataList(value: serverCertificateMetadataListType): Self = this.set("ServerCertificateMetadataList", value.asInstanceOf[js.Any])
