...
object GetCredentialReportResponse {
  ...
  implicit class GetCredentialReportResponseOps[Self <: GetCredentialReportResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentUint8Array(value: js.typedarray.Uint8Array): Self = this.set("Content", value.asInstanceOf[js.Any])
    @scala.inline
    def setContent(value: ReportContentType): Self = this.set("Content", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteContent: Self = this.set("Content", js.undefined)
    @scala.inline
    def setGeneratedTime(value: js.Date): Self = this.set("GeneratedTime", value.asInstanceOf[js.Any])
    @scala.inline
