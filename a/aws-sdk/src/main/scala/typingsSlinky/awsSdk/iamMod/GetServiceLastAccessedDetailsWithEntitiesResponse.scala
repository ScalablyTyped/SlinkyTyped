...
object GetServiceLastAccessedDetailsWithEntitiesResponse {
  ...
  implicit class GetServiceLastAccessedDetailsWithEntitiesResponseOps[Self <: GetServiceLastAccessedDetailsWithEntitiesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJobCompletionDate(value: js.Date): Self = this.set("JobCompletionDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setJobCreationDate(value: js.Date): Self = this.set("JobCreationDate", value.asInstanceOf[js.Any])
