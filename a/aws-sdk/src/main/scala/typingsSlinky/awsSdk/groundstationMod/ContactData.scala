...
object ContactData {
  ...
  implicit class ContactDataOps[Self <: ContactData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPostPassEndTime(value: js.Date): Self = this.set("postPassEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePostPassEndTime: Self = this.set("postPassEndTime", js.undefined)
    
    @scala.inline
    def setPrePassStartTime(value: js.Date): Self = this.set("prePassStartTime", value.asInstanceOf[js.Any])
