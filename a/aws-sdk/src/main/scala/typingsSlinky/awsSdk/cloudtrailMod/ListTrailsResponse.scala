...
object ListTrailsResponse {
  ...
  implicit class ListTrailsResponseOps[Self <: ListTrailsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTrails(value: Trails): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Trails")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTrails: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Trails")(js.undefined)
        ret
    }
  }
