...
object PublicKey {
  ...
  implicit class PublicKeyOps[Self <: PublicKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValidityEndTime(value: js.Date): Self = this.set("ValidityEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteValidityEndTime: Self = this.set("ValidityEndTime", js.undefined)
    
    @scala.inline
    def setValidityStartTime(value: js.Date): Self = this.set("ValidityStartTime", value.asInstanceOf[js.Any])
