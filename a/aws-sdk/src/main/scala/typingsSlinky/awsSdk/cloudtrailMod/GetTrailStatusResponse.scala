...
object GetTrailStatusResponse {
  ...
  implicit class GetTrailStatusResponseMutableBuilder[Self <: GetTrailStatusResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestCloudWatchLogsDeliveryTime(value: js.Date): Self = StObject.set(x, "LatestCloudWatchLogsDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestDeliveryTime(value: js.Date): Self = StObject.set(x, "LatestDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestDigestDeliveryTime(value: js.Date): Self = StObject.set(x, "LatestDigestDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestNotificationTime(value: js.Date): Self = StObject.set(x, "LatestNotificationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLatestNotificationTimeUndefined: Self = StObject.set(x, "LatestNotificationTime", js.undefined)
    
    @scala.inline
    def setStartLoggingTime(value: js.Date): Self = StObject.set(x, "StartLoggingTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStartLoggingTimeUndefined: Self = StObject.set(x, "StartLoggingTime", js.undefined)
    
    @scala.inline
    def setStopLoggingTime(value: js.Date): Self = StObject.set(x, "StopLoggingTime", value.asInstanceOf[js.Any])
