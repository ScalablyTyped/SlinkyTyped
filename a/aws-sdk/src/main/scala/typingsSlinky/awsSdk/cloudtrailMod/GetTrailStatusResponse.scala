...
object GetTrailStatusResponse {
  ...
  implicit class GetTrailStatusResponseOps[Self <: GetTrailStatusResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestCloudWatchLogsDeliveryTime(value: js.Date): Self = this.set("LatestCloudWatchLogsDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestDeliveryTime(value: js.Date): Self = this.set("LatestDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestDigestDeliveryTime(value: js.Date): Self = this.set("LatestDigestDeliveryTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLatestNotificationTime(value: js.Date): Self = this.set("LatestNotificationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLatestNotificationTime: Self = this.set("LatestNotificationTime", js.undefined)
    
    @scala.inline
    def setStartLoggingTime(value: js.Date): Self = this.set("StartLoggingTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStartLoggingTime: Self = this.set("StartLoggingTime", js.undefined)
    
    @scala.inline
    def setStopLoggingTime(value: js.Date): Self = this.set("StopLoggingTime", value.asInstanceOf[js.Any])
