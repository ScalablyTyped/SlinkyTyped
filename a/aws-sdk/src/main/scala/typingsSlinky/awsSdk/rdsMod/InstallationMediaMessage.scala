...
object InstallationMediaMessage {
  ...
  implicit class InstallationMediaMessageOps[Self <: InstallationMediaMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInstallationMedia(value: InstallationMediaList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InstallationMedia")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInstallationMedia: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InstallationMedia")(js.undefined)
        ret
    }
    @scala.inline
