...
object DBClusterBacktrack {
  ...
  implicit class DBClusterBacktrackMutableBuilder[Self <: DBClusterBacktrack] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBacktrackRequestCreationTime(value: js.Date): Self = StObject.set(x, "BacktrackRequestCreationTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBacktrackedFrom(value: js.Date): Self = StObject.set(x, "BacktrackedFrom", value.asInstanceOf[js.Any])
