...
object DBClusterBacktrack {
  ...
  implicit class DBClusterBacktrackOps[Self <: DBClusterBacktrack] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBacktrackRequestCreationTime(value: js.Date): Self = this.set("BacktrackRequestCreationTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBacktrackRequestCreationTime: Self = this.set("BacktrackRequestCreationTime", js.undefined)
    
    @scala.inline
    def setBacktrackTo(value: js.Date): Self = this.set("BacktrackTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBacktrackTo: Self = this.set("BacktrackTo", js.undefined)
    
    @scala.inline
    def setBacktrackedFrom(value: js.Date): Self = this.set("BacktrackedFrom", value.asInstanceOf[js.Any])
