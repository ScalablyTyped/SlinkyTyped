...
@js.native
trait DescribeDBProxyTargetsRequest extends StObject {
...
object DescribeDBProxyTargetsRequest {
  ...
  @scala.inline
  implicit class DescribeDBProxyTargetsRequestMutableBuilder[Self <: DescribeDBProxyTargetsRequest] (val x: Self) extends AnyVal {
