...
object DBCluster {
  ...
  implicit class DBClusterOps[Self <: DBCluster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEarliestBacktrackTime(value: js.Date): Self = this.set("EarliestBacktrackTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEarliestBacktrackTime: Self = this.set("EarliestBacktrackTime", js.undefined)
    
    @scala.inline
    def setEarliestRestorableTime(value: js.Date): Self = this.set("EarliestRestorableTime", value.asInstanceOf[js.Any])
