...
object RestoreDBInstanceToPointInTimeMessage {
  ...
  implicit class RestoreDBInstanceToPointInTimeMessageOps[Self <: RestoreDBInstanceToPointInTimeMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSourceDBInstanceIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceDBInstanceIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSourceDBInstanceIdentifier: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceDBInstanceIdentifier")(js.undefined)
        ret
    }
    @scala.inline
    def withSourceDbiResourceId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceDbiResourceId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSourceDbiResourceId: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceDbiResourceId")(js.undefined)
        ret
    }
    @scala.inline
