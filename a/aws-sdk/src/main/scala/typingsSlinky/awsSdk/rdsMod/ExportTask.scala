...
object ExportTask {
  ...
  implicit class ExportTaskMutableBuilder[Self <: ExportTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTaskEndTime(value: js.Date): Self = StObject.set(x, "TaskEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTaskEndTimeUndefined: Self = StObject.set(x, "TaskEndTime", js.undefined)
    
    @scala.inline
    def setTaskStartTime(value: js.Date): Self = StObject.set(x, "TaskStartTime", value.asInstanceOf[js.Any])
