...
object ExportTask {
  ...
  implicit class ExportTaskOps[Self <: ExportTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSnapshotTime(value: js.Date): Self = this.set("SnapshotTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTaskEndTime(value: js.Date): Self = this.set("TaskEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTaskEndTime: Self = this.set("TaskEndTime", js.undefined)
    
    @scala.inline
    def setTaskStartTime(value: js.Date): Self = this.set("TaskStartTime", value.asInstanceOf[js.Any])
