...
object DescribeDBEngineVersionsMessage {
  ...
  implicit class DescribeDBEngineVersionsMessageMutableBuilder[Self <: DescribeDBEngineVersionsMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeAll(value: BooleanOptional): Self = StObject.set(x, "IncludeAll", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIncludeAllUndefined: Self = StObject.set(x, "IncludeAll", js.undefined)
