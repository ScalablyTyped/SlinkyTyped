...
object Certificate {
  ...
  implicit class CertificateOps[Self <: Certificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomerOverrideValidTill(value: js.Date): Self = this.set("CustomerOverrideValidTill", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setValidTill(value: js.Date): Self = this.set("ValidTill", value.asInstanceOf[js.Any])
    @scala.inline
