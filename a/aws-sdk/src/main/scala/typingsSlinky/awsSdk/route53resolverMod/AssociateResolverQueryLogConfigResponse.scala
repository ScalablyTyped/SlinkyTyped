...
trait AssociateResolverQueryLogConfigResponse extends js.Object {
  ...
  /**
    ...
    */
  var ResolverQueryLogConfigAssociation: js.UndefOr[typingsSlinky.awsSdk.route53resolverMod.ResolverQueryLogConfigAssociation] = js.native
}
object AssociateResolverQueryLogConfigResponse {
  ...
  @scala.inline
  implicit class AssociateResolverQueryLogConfigResponseOps[Self <: AssociateResolverQueryLogConfigResponse] (val x: Self) extends AnyVal {
