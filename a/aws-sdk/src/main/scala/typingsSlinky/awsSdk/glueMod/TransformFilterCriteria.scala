...
object TransformFilterCriteria {
  ...
  implicit class TransformFilterCriteriaMutableBuilder[Self <: TransformFilterCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastModifiedAfter(value: js.Date): Self = StObject.set(x, "LastModifiedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastModifiedAfterUndefined: Self = StObject.set(x, "LastModifiedAfter", js.undefined)
    
    @scala.inline
    def setLastModifiedBefore(value: js.Date): Self = StObject.set(x, "LastModifiedBefore", value.asInstanceOf[js.Any])
