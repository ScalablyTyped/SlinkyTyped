...
object TransformFilterCriteria {
  ...
  implicit class TransformFilterCriteriaOps[Self <: TransformFilterCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastModifiedAfter(value: js.Date): Self = this.set("LastModifiedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastModifiedAfter: Self = this.set("LastModifiedAfter", js.undefined)
    
    @scala.inline
    def setLastModifiedBefore(value: js.Date): Self = this.set("LastModifiedBefore", value.asInstanceOf[js.Any])
