...
object DateColumnStatisticsData {
  ...
  implicit class DateColumnStatisticsDataOps[Self <: DateColumnStatisticsData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaximumValue(value: js.Date): Self = this.set("MaximumValue", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMaximumValue: Self = this.set("MaximumValue", js.undefined)
    
    @scala.inline
    def setMinimumValue(value: js.Date): Self = this.set("MinimumValue", value.asInstanceOf[js.Any])
