...
object TaskRunFilterCriteria {
  ...
  implicit class TaskRunFilterCriteriaOps[Self <: TaskRunFilterCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStartedAfter(value: js.Date): Self = this.set("StartedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStartedAfter: Self = this.set("StartedAfter", js.undefined)
    
    @scala.inline
    def setStartedBefore(value: js.Date): Self = this.set("StartedBefore", value.asInstanceOf[js.Any])
