...
object TaskRunFilterCriteria {
  ...
  implicit class TaskRunFilterCriteriaMutableBuilder[Self <: TaskRunFilterCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStartedAfter(value: js.Date): Self = StObject.set(x, "StartedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStartedAfterUndefined: Self = StObject.set(x, "StartedAfter", js.undefined)
    
    @scala.inline
    def setStartedBefore(value: js.Date): Self = StObject.set(x, "StartedBefore", value.asInstanceOf[js.Any])
