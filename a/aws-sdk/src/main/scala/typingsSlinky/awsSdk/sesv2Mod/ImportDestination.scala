...
trait ImportDestination extends StObject {
  ...
  /**
    ...
    */
  var ContactListDestination: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.ContactListDestination] = js.native
  
  /**
    * An object that contains the action of the import job towards suppression list.
    */
  var SuppressionListDestination: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.SuppressionListDestination] = js.native
}
