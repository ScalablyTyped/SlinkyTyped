...
trait FailureInfo extends StObject {
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.ErrorMessage] = js.native
  
  /**
    * An Amazon S3 presigned URL that contains all the failed records and related information.
    */
  var FailedRecordsS3Url: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.FailedRecordsS3Url] = js.native
}
object FailureInfo {
