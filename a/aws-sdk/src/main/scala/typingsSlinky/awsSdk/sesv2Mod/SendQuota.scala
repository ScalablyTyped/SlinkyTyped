...
trait SendQuota extends js.Object {
  ...
  /**
    ...
    */
  var Max24HourSend: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.Max24HourSend] = js.native
  
  /**
    * The maximum number of emails that you can send per second in the current AWS Region. This value is also called your maximum sending rate or your maximum TPS (transactions per second) rate.
    */
  var MaxSendRate: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.MaxSendRate] = js.native
  
  /**
    * The number of emails sent from your Amazon SES account in the current AWS Region over the past 24 hours.
    */
  var SentLast24Hours: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.SentLast24Hours] = js.native
}
object SendQuota {
