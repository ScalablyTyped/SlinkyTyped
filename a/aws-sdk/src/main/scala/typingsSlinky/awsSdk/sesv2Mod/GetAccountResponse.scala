...
trait GetAccountResponse extends js.Object {
  ...
  /**
    ...
    */
  var SendQuota: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.SendQuota] = js.native
  /**
  ...
  /**
    ...
    */
  var SuppressionAttributes: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.SuppressionAttributes] = js.native
}
...
object GetAccountResponse {
  ...
  implicit class GetAccountResponseOps[Self <: GetAccountResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuppressionAttributes(value: SuppressionAttributes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SuppressionAttributes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSuppressionAttributes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SuppressionAttributes")(js.undefined)
        ret
    }
  }
