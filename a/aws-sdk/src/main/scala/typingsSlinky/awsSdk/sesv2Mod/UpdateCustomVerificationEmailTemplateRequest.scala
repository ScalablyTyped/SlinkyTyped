...
trait UpdateCustomVerificationEmailTemplateRequest extends js.Object {
  ...
  /**
    ...
    */
  var FailureRedirectionURL: typingsSlinky.awsSdk.sesv2Mod.FailureRedirectionURL = js.native
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: typingsSlinky.awsSdk.sesv2Mod.SuccessRedirectionURL = js.native
  
  /**
    * The content of the custom verification email. The total size of the email must be less than 10 MB. The message body may contain HTML, with some limitations. For more information, see Custom Verification Email Frequently Asked Questions in the Amazon SES Developer Guide.
    */
  var TemplateContent: typingsSlinky.awsSdk.sesv2Mod.TemplateContent = js.native
