...
trait AccountDetails extends js.Object {
  ...
  /**
    ...
    */
  var AdditionalContactEmailAddresses: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.AdditionalContactEmailAddresses] = js.native
  
  /**
    * The language you would prefer for the case. The contact language can be one of ENGLISH or JAPANESE.
    */
  var ContactLanguage: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.ContactLanguage] = js.native
  ...
  /**
    ...
    */
  var MailType: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.MailType] = js.native
  
  /**
    * Information about the review of the latest details you submitted.
    */
  var ReviewDetails: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.ReviewDetails] = js.native
  
  /**
    * A description of the types of email that you plan to send.
    */
  var UseCaseDescription: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.UseCaseDescription] = js.native
  
  /**
    * The URL of your website. This information helps us better understand the type of content that you plan to send.
    */
  var WebsiteURL: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.WebsiteURL] = js.native
}
