...
trait DedicatedIp extends js.Object {
  ...
  /**
    * An IPv4 address.
    */
  var Ip: typingsSlinky.awsSdk.sesv2Mod.Ip = js.native
  
  /**
    * The name of the dedicated IP pool that the IP address is associated with.
    */
  var PoolName: js.UndefOr[typingsSlinky.awsSdk.sesv2Mod.PoolName] = js.native
  ...
  /**
    ...
    */
  var WarmupStatus: typingsSlinky.awsSdk.sesv2Mod.WarmupStatus = js.native
}
object DedicatedIp {
