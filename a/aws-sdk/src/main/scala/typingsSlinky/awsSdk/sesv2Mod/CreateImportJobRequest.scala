...
trait CreateImportJobRequest extends StObject {
  ...
  /**
    ...
    */
  var ImportDataSource: typingsSlinky.awsSdk.sesv2Mod.ImportDataSource = js.native
  
  /**
    * The destination for the import job.
    */
  var ImportDestination: typingsSlinky.awsSdk.sesv2Mod.ImportDestination = js.native
}
