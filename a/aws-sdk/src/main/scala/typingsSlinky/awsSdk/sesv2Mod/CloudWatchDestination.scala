...
object CloudWatchDestination {
  ...
  implicit class CloudWatchDestinationOps[Self <: CloudWatchDestination] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDimensionConfigurations(value: CloudWatchDimensionConfigurations): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DimensionConfigurations")(value.asInstanceOf[js.Any])
        ret
    }
  }
