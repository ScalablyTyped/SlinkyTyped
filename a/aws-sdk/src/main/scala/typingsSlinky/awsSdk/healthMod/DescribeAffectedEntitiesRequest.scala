...
@js.native
trait DescribeAffectedEntitiesRequest extends StObject {
...
object DescribeAffectedEntitiesRequest {
  ...
  @scala.inline
  implicit class DescribeAffectedEntitiesRequestMutableBuilder[Self <: DescribeAffectedEntitiesRequest] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFilter(value: EntityFilter): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
