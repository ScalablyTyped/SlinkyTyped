...
object DescribeEventsForOrganizationRequest {
  ...
  @scala.inline
  implicit class DescribeEventsForOrganizationRequestOps[Self <: DescribeEventsForOrganizationRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFilter(value: OrganizationEventFilter): Self = this.set("filter", value.asInstanceOf[js.Any])
    @scala.inline
