...
object ListImageRecipesResponse {
  ...
  implicit class ListImageRecipesResponseOps[Self <: ListImageRecipesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImageRecipeSummaryList(value: ImageRecipeSummaryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageRecipeSummaryList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutImageRecipeSummaryList: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("imageRecipeSummaryList")(js.undefined)
        ret
    }
    @scala.inline
