...
trait WriteRequest extends js.Object {
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.DeleteRequest] = js.native
  /**
    * A request to perform a PutItem operation.
    */
  var PutRequest: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.PutRequest] = js.native
}
