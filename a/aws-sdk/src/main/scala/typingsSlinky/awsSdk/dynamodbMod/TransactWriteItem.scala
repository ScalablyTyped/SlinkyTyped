...
trait TransactWriteItem extends js.Object {
  /**
    ...
    */
  var ConditionCheck: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.ConditionCheck] = js.native
  /**
    * A request to perform a DeleteItem operation.
    */
  var Delete: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.Delete] = js.native
  /**
    * A request to perform a PutItem operation.
    */
  var Put: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.Put] = js.native
  /**
    * A request to perform an UpdateItem operation.
    */
  var Update: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.Update] = js.native
}
