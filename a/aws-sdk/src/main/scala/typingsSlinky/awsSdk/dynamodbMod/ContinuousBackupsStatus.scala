...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait ContinuousBackupsStatus extends js.Object
...
object ContinuousBackupsStatus {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): ContinuousBackupsStatus = value.asInstanceOf[ContinuousBackupsStatus]
}
