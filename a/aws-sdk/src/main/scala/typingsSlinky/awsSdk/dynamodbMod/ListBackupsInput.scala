...
object ListBackupsInput {
  ...
  implicit class ListBackupsInputOps[Self <: ListBackupsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTimeRangeLowerBound(value: js.Date): Self = this.set("TimeRangeLowerBound", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTimeRangeLowerBound: Self = this.set("TimeRangeLowerBound", js.undefined)
    @scala.inline
    def setTimeRangeUpperBound(value: js.Date): Self = this.set("TimeRangeUpperBound", value.asInstanceOf[js.Any])
    @scala.inline
