...
trait DescribeContributorInsightsOutput extends js.Object {
  ...
  /**
    ...
    */
  var ContributorInsightsRuleList: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.ContributorInsightsRuleList] = js.native
  ...
  /**
    ...
    */
  var FailureException: js.UndefOr[typingsSlinky.awsSdk.dynamodbMod.FailureException] = js.native
...
object DescribeContributorInsightsOutput {
  ...
  implicit class DescribeContributorInsightsOutputOps[Self <: DescribeContributorInsightsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastUpdateDateTime(value: js.Date): Self = this.set("LastUpdateDateTime", value.asInstanceOf[js.Any])
