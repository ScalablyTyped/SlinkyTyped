...
trait ListStatementsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[ListStatementsLimit] = js.native
...
object ListStatementsRequest {
  ...
  @scala.inline
  implicit class ListStatementsRequestOps[Self <: ListStatementsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxResults(value: ListStatementsLimit): Self = this.set("MaxResults", value.asInstanceOf[js.Any])
