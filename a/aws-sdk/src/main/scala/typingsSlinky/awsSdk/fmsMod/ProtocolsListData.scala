...
trait ProtocolsListData extends StObject {
  ...
  /**
    ...
    */
  var ListId: js.UndefOr[typingsSlinky.awsSdk.fmsMod.ListId] = js.native
  ...
  /**
    ...
    */
  var PreviousProtocolsList: js.UndefOr[typingsSlinky.awsSdk.fmsMod.PreviousProtocolsList] = js.native
  
  /**
    * An array of protocols in the AWS Firewall Manager protocols list.
    */
  var ProtocolsList: typingsSlinky.awsSdk.fmsMod.ProtocolsList = js.native
}
