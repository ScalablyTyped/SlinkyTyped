...
trait SecurityServicePolicyData extends js.Object {
  /**
    ...
    */
  var ManagedServiceData: js.UndefOr[typingsSlinky.awsSdk.fmsMod.ManagedServiceData] = js.native
  /**
...
object SecurityServicePolicyData {
  ...
  implicit class SecurityServicePolicyDataOps[Self <: SecurityServicePolicyData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: SecurityServiceType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withManagedServiceData(value: ManagedServiceData): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ManagedServiceData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutManagedServiceData: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ManagedServiceData")(js.undefined)
        ret
    }
  }
