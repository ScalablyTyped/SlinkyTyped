...
object BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {
  ...
  implicit class BatchAssociateApprovalRuleTemplateWithRepositoriesOutputOps[Self <: BatchAssociateApprovalRuleTemplateWithRepositoriesOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAssociatedRepositoryNames(value: RepositoryNameList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("associatedRepositoryNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withErrors(value: BatchAssociateApprovalRuleTemplateWithRepositoriesErrorsList): Self = {
        val ret = this.duplicate
