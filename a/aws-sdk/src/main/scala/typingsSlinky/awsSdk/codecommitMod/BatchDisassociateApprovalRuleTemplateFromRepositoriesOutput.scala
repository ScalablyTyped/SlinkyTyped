...
object BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput {
  ...
  implicit class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutputOps[Self <: BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisassociatedRepositoryNames(value: RepositoryNameList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disassociatedRepositoryNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withErrors(value: BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorsList): Self = {
        val ret = this.duplicate
