...
object GetApiKeysRequest {
  ...
  implicit class GetApiKeysRequestOps[Self <: GetApiKeysRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIncludeValues(value: NullableBoolean): Self = this.set("includeValues", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIncludeValues: Self = this.set("includeValues", js.undefined)
    @scala.inline
