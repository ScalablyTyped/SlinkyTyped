...
object GetApiKeyRequest {
  ...
  implicit class GetApiKeyRequestOps[Self <: GetApiKeyRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIncludeValue(value: NullableBoolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIncludeValue: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("includeValue")(js.undefined)
        ret
    }
  }
