...
package object applicationinsightsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.HEALTH
    - java.lang.String
  */
  type CloudWatchEventSource = typingsSlinky.awsSdk.applicationinsightsMod._CloudWatchEventSource | java.lang.String
