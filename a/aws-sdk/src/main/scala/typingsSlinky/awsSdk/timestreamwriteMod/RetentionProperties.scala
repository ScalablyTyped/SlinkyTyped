...
trait RetentionProperties extends js.Object {
  ...
  /**
    ...
    */
  var MagneticStoreRetentionPeriodInDays: typingsSlinky.awsSdk.timestreamwriteMod.MagneticStoreRetentionPeriodInDays = js.native
  
  /**
    * The duration for which data must be stored in the memory store. 
    */
  var MemoryStoreRetentionPeriodInHours: typingsSlinky.awsSdk.timestreamwriteMod.MemoryStoreRetentionPeriodInHours = js.native
}
