...
object HsmClientCertificateMessage {
  ...
  implicit class HsmClientCertificateMessageOps[Self <: HsmClientCertificateMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHsmClientCertificates(value: HsmClientCertificateList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HsmClientCertificates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHsmClientCertificates: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HsmClientCertificates")(js.undefined)
        ret
    }
    @scala.inline
