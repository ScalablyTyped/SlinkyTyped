...
object OrderableClusterOptionsMessage {
  ...
  implicit class OrderableClusterOptionsMessageOps[Self <: OrderableClusterOptionsMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOrderableClusterOptions(value: OrderableClusterOptionsList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OrderableClusterOptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOrderableClusterOptions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OrderableClusterOptions")(js.undefined)
        ret
    }
  }
