...
object Cluster {
  ...
  implicit class ClusterMutableBuilder[Self <: Cluster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpectedNextSnapshotScheduleTime(value: js.Date): Self = StObject.set(x, "ExpectedNextSnapshotScheduleTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextMaintenanceWindowStartTime(value: js.Date): Self = StObject.set(x, "NextMaintenanceWindowStartTime", value.asInstanceOf[js.Any])
