...
object Cluster {
  ...
  implicit class ClusterOps[Self <: Cluster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpectedNextSnapshotScheduleTime(value: js.Date): Self = this.set("ExpectedNextSnapshotScheduleTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNextMaintenanceWindowStartTime(value: js.Date): Self = this.set("NextMaintenanceWindowStartTime", value.asInstanceOf[js.Any])
