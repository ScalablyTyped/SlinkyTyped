...
object ModifyClusterMaintenanceMessage {
  ...
  implicit class ModifyClusterMaintenanceMessageOps[Self <: ModifyClusterMaintenanceMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeferMaintenanceEndTime(value: js.Date): Self = this.set("DeferMaintenanceEndTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeferMaintenanceStartTime(value: js.Date): Self = this.set("DeferMaintenanceStartTime", value.asInstanceOf[js.Any])
