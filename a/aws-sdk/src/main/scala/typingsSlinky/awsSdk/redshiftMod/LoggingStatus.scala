...
object LoggingStatus {
  ...
  implicit class LoggingStatusMutableBuilder[Self <: LoggingStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastFailureTime(value: js.Date): Self = StObject.set(x, "LastFailureTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastFailureTimeUndefined: Self = StObject.set(x, "LastFailureTime", js.undefined)
    
    @scala.inline
    def setLastSuccessfulDeliveryTime(value: js.Date): Self = StObject.set(x, "LastSuccessfulDeliveryTime", value.asInstanceOf[js.Any])
