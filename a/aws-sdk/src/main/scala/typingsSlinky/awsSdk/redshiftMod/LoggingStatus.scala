...
object LoggingStatus {
  ...
  implicit class LoggingStatusOps[Self <: LoggingStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastFailureTime(value: js.Date): Self = this.set("LastFailureTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastFailureTime: Self = this.set("LastFailureTime", js.undefined)
    @scala.inline
    def setLastSuccessfulDeliveryTime(value: js.Date): Self = this.set("LastSuccessfulDeliveryTime", value.asInstanceOf[js.Any])
    @scala.inline
