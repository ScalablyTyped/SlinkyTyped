...
object AnalyzerSummary {
  ...
  @scala.inline
  def apply(arn: AnalyzerArn, createdAt: js.Date, name: Name, status: AnalyzerStatus, `type`: Type): AnalyzerSummary = {
  ...
  implicit class AnalyzerSummaryMutableBuilder[Self <: AnalyzerSummary] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastResourceAnalyzedAt(value: js.Date): Self = StObject.set(x, "lastResourceAnalyzedAt", value.asInstanceOf[js.Any])
