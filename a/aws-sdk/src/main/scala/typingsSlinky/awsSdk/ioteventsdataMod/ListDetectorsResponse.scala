...
object ListDetectorsResponse {
  ...
  implicit class ListDetectorsResponseOps[Self <: ListDetectorsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDetectorSummaries(value: DetectorSummaries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detectorSummaries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDetectorSummaries: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("detectorSummaries")(js.undefined)
        ret
    }
    @scala.inline
