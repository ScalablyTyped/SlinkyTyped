...
trait ListQueuesRequest extends js.Object {
  ...
  /**
    * The type of queue.
    */
  var QueueTypes: js.UndefOr[typingsSlinky.awsSdk.connectMod.QueueTypes] = js.native
}
...
object ListQueuesRequest {
  ...
  implicit class ListQueuesRequestOps[Self <: ListQueuesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQueueTypes(value: QueueTypes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("QueueTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutQueueTypes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("QueueTypes")(js.undefined)
        ret
    }
  }
