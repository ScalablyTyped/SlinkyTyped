...
trait RoutingProfile extends js.Object {
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsSlinky.awsSdk.connectMod.InstanceId] = js.native
  
  /**
    * The channels agents can handle in the Contact Control Panel (CCP) for this routing profile.
    */
  var MediaConcurrencies: js.UndefOr[typingsSlinky.awsSdk.connectMod.MediaConcurrencies] = js.native
