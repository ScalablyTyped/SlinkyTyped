...
@js.native
trait ListLambdaFunctionsRequest extends StObject {
...
object ListLambdaFunctionsRequest {
  ...
  @scala.inline
  def apply(InstanceId: InstanceId): ListLambdaFunctionsRequest = {
    val __obj = js.Dynamic.literal(InstanceId = InstanceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListLambdaFunctionsRequest]
  }
  
  @scala.inline
  implicit class ListLambdaFunctionsRequestMutableBuilder[Self <: ListLambdaFunctionsRequest] (val x: Self) extends AnyVal {
