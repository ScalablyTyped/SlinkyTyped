...
trait ListContactFlowsRequest extends js.Object {
  /**
    ...
    */
  var ContactFlowTypes: js.UndefOr[typingsSlinky.awsSdk.connectMod.ContactFlowTypes] = js.native
  /**
...
object ListContactFlowsRequest {
  ...
  implicit class ListContactFlowsRequestOps[Self <: ListContactFlowsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContactFlowTypes(value: ContactFlowTypes): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ContactFlowTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutContactFlowTypes: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ContactFlowTypes")(js.undefined)
        ret
    }
    @scala.inline
