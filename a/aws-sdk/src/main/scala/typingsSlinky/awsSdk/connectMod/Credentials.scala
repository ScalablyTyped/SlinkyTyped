...
object Credentials {
  ...
  implicit class CredentialsMutableBuilder[Self <: Credentials] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessTokenExpiration(value: js.Date): Self = StObject.set(x, "AccessTokenExpiration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefreshTokenExpiration(value: js.Date): Self = StObject.set(x, "RefreshTokenExpiration", value.asInstanceOf[js.Any])
