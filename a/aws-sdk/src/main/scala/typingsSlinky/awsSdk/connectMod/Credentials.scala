...
object Credentials {
  ...
  implicit class CredentialsOps[Self <: Credentials] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessTokenExpiration(value: js.Date): Self = this.set("AccessTokenExpiration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefreshTokenExpiration(value: js.Date): Self = this.set("RefreshTokenExpiration", value.asInstanceOf[js.Any])
