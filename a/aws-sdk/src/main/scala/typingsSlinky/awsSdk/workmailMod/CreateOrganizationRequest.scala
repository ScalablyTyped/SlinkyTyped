...
trait CreateOrganizationRequest extends StObject {
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsSlinky.awsSdk.workmailMod.DirectoryId] = js.native
  
  /**
    * The email domains to associate with the organization.
    */
  var Domains: js.UndefOr[typingsSlinky.awsSdk.workmailMod.Domains] = js.native
