...
trait DescribedSecurityPolicy extends StObject {
  ...
  /**
    ...
    */
  var Fips: js.UndefOr[typingsSlinky.awsSdk.transferMod.Fips] = js.native
  
  /**
    * Specifies the name of the security policy that is attached to the server.
    */
  var SecurityPolicyName: typingsSlinky.awsSdk.transferMod.SecurityPolicyName = js.native
