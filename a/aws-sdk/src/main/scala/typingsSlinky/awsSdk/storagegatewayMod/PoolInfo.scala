...
trait PoolInfo extends js.Object {
  ...
  /**
    ...
    */
  var PoolARN: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.PoolARN] = js.native
  
  /**
    * The name of the custom tape pool. PoolName can use all ASCII characters, except '/' and '\'.
    */
  var PoolName: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.PoolName] = js.native
  
  /**
    * Status of the custom tape pool. Pool can be ACTIVE or DELETED.
    */
  var PoolStatus: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.PoolStatus] = js.native
  
  /**
    * Tape retention lock time is set in days. Tape retention lock can be enabled for up to 100 years (36,500 days).
    */
  var RetentionLockTimeInDays: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.RetentionLockTimeInDays] = js.native
  ...
  /**
    ...
    */
  var RetentionLockType: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.RetentionLockType] = js.native
