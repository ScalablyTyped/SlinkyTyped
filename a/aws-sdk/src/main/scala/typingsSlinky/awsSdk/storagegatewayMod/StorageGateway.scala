...
trait StorageGateway extends Service {
  ...
  /**
    ...
    */
  def createTapePool(): Request[CreateTapePoolOutput, AWSError] = js.native
  def createTapePool(callback: js.Function2[/* err */ AWSError, /* data */ CreateTapePoolOutput, Unit]): Request[CreateTapePoolOutput, AWSError] = js.native
  /**
    * Creates a new custom tape pool. You can use custom tape pool to enable tape retention lock on tapes that are archived in the custom pool.
    */
  def createTapePool(params: CreateTapePoolInput): Request[CreateTapePoolOutput, AWSError] = js.native
  def createTapePool(
    params: CreateTapePoolInput,
    callback: js.Function2[/* err */ AWSError, /* data */ CreateTapePoolOutput, Unit]
  ): Request[CreateTapePoolOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def deleteAutomaticTapeCreationPolicy(): Request[DeleteAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  def deleteAutomaticTapeCreationPolicy(
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteAutomaticTapeCreationPolicyOutput, Unit]
  ): Request[DeleteAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  /**
    * Deletes the automatic tape creation policy of a gateway. If you delete this policy, new virtual tapes must be created manually. Use the Amazon Resource Name (ARN) of the gateway in your request to remove the policy.
    */
  def deleteAutomaticTapeCreationPolicy(params: DeleteAutomaticTapeCreationPolicyInput): Request[DeleteAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  def deleteAutomaticTapeCreationPolicy(
  ...
  /**
    ...
    */
  def deleteTapePool(): Request[DeleteTapePoolOutput, AWSError] = js.native
  def deleteTapePool(callback: js.Function2[/* err */ AWSError, /* data */ DeleteTapePoolOutput, Unit]): Request[DeleteTapePoolOutput, AWSError] = js.native
  /**
    * Delete a custom tape pool. A custom tape pool can only be deleted if there are no tapes in the pool and if there are no automatic tape creation policies that reference the custom tape pool.
    */
  def deleteTapePool(params: DeleteTapePoolInput): Request[DeleteTapePoolOutput, AWSError] = js.native
  def deleteTapePool(
    params: DeleteTapePoolInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteTapePoolOutput, Unit]
  ): Request[DeleteTapePoolOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def listAutomaticTapeCreationPolicies(): Request[ListAutomaticTapeCreationPoliciesOutput, AWSError] = js.native
  def listAutomaticTapeCreationPolicies(
    callback: js.Function2[/* err */ AWSError, /* data */ ListAutomaticTapeCreationPoliciesOutput, Unit]
  ): Request[ListAutomaticTapeCreationPoliciesOutput, AWSError] = js.native
  /**
    * Lists the automatic tape creation policies for a gateway. If there are no automatic tape creation policies for the gateway, it returns an empty list. This operation is only supported for tape gateways.
    */
  def listAutomaticTapeCreationPolicies(params: ListAutomaticTapeCreationPoliciesInput): Request[ListAutomaticTapeCreationPoliciesOutput, AWSError] = js.native
  def listAutomaticTapeCreationPolicies(
  ...
  /**
    ...
    */
  def listTapePools(): Request[ListTapePoolsOutput, AWSError] = js.native
  def listTapePools(callback: js.Function2[/* err */ AWSError, /* data */ ListTapePoolsOutput, Unit]): Request[ListTapePoolsOutput, AWSError] = js.native
  /**
    * Lists custom tape pools. You specify custom tape pools to list by specifying one or more custom tape pool Amazon Resource Names (ARNs). If you don't specify a custom tape pool ARN, the operation lists all custom tape pools. This operation supports pagination. You can optionally specify the Limit parameter in the body to limit the number of tape pools in the response. If the number of tape pools returned in the response is truncated, the response includes a Marker element that you can use in your subsequent request to retrieve the next set of tape pools.
    */
  def listTapePools(params: ListTapePoolsInput): Request[ListTapePoolsOutput, AWSError] = js.native
  def listTapePools(
    params: ListTapePoolsInput,
    callback: js.Function2[/* err */ AWSError, /* data */ ListTapePoolsOutput, Unit]
  ): Request[ListTapePoolsOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def updateAutomaticTapeCreationPolicy(): Request[UpdateAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  def updateAutomaticTapeCreationPolicy(
    callback: js.Function2[/* err */ AWSError, /* data */ UpdateAutomaticTapeCreationPolicyOutput, Unit]
  ): Request[UpdateAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  /**
    * Updates the automatic tape creation policy of a gateway. Use this to update the policy with a new set of automatic tape creation rules. This is only supported for tape gateways. By default, there is no automatic tape creation policy.  A gateway can have only one automatic tape creation policy. 
    */
  def updateAutomaticTapeCreationPolicy(params: UpdateAutomaticTapeCreationPolicyInput): Request[UpdateAutomaticTapeCreationPolicyOutput, AWSError] = js.native
  def updateAutomaticTapeCreationPolicy(
