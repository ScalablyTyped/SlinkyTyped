...
trait DescribeGatewayInformationOutput extends js.Object {
  ...
  /**
    ...
    */
  var GatewayNetworkInterfaces: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.GatewayNetworkInterfaces] = js.native
  
  /**
    * A value that indicates the operating state of the gateway.
    */
  var GatewayState: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.GatewayState] = js.native
  ...
  /**
    ...
    */
  var HostEnvironment: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.HostEnvironment] = js.native
  
  /**
    * The date on which the last software update was applied to the gateway. If the gateway has never been updated, this field does not return a value in the response.
    */
  var LastSoftwareUpdate: js.UndefOr[typingsSlinky.awsSdk.storagegatewayMod.LastSoftwareUpdate] = js.native
