...
object GetRecommendationsResponse {
  ...
  implicit class GetRecommendationsResponseOps[Self <: GetRecommendationsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProfileEndTime(value: js.Date): Self = this.set("profileEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProfileStartTime(value: js.Date): Self = this.set("profileStartTime", value.asInstanceOf[js.Any])
