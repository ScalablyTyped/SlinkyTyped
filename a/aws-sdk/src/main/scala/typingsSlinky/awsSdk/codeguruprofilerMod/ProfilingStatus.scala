...
object ProfilingStatus {
  ...
  implicit class ProfilingStatusMutableBuilder[Self <: ProfilingStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestAgentOrchestratedAt(value: js.Date): Self = StObject.set(x, "latestAgentOrchestratedAt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLatestAgentOrchestratedAtUndefined: Self = StObject.set(x, "latestAgentOrchestratedAt", js.undefined)
    
    @scala.inline
    def setLatestAgentProfileReportedAt(value: js.Date): Self = StObject.set(x, "latestAgentProfileReportedAt", value.asInstanceOf[js.Any])
