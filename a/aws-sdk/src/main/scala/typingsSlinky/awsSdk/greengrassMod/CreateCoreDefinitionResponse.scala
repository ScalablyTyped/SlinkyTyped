...
@js.native
trait CreateCoreDefinitionResponse extends StObject {
...
object CreateCoreDefinitionResponse {
  ...
  @scala.inline
  def apply(): CreateCoreDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateCoreDefinitionResponse]
  }
  
  @scala.inline
  implicit class CreateCoreDefinitionResponseMutableBuilder[Self <: CreateCoreDefinitionResponse] (val x: Self) extends AnyVal {
