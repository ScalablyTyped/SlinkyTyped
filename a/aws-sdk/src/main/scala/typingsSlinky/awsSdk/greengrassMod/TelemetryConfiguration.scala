...
trait TelemetryConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationSyncStatus: js.UndefOr[typingsSlinky.awsSdk.greengrassMod.ConfigurationSyncStatus] = js.native
  
  /**
    * Configure telemetry to be on or off.
    */
  var Telemetry: typingsSlinky.awsSdk.greengrassMod.Telemetry = js.native
}
