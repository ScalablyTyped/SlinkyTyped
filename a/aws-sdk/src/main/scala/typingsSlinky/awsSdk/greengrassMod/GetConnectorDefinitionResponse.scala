...
@js.native
trait GetConnectorDefinitionResponse extends StObject {
...
object GetConnectorDefinitionResponse {
  ...
  @scala.inline
  def apply(): GetConnectorDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetConnectorDefinitionResponse]
  }
  
  @scala.inline
  implicit class GetConnectorDefinitionResponseMutableBuilder[Self <: GetConnectorDefinitionResponse] (val x: Self) extends AnyVal {
