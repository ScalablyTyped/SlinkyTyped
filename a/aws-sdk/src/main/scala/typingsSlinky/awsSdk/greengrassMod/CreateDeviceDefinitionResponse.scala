...
@js.native
trait CreateDeviceDefinitionResponse extends StObject {
...
object CreateDeviceDefinitionResponse {
  ...
  @scala.inline
  def apply(): CreateDeviceDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateDeviceDefinitionResponse]
  }
  
  @scala.inline
  implicit class CreateDeviceDefinitionResponseMutableBuilder[Self <: CreateDeviceDefinitionResponse] (val x: Self) extends AnyVal {
