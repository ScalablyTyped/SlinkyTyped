...
object GetSubscriptionDefinitionResponse {
  ...
  @scala.inline
  def apply(): GetSubscriptionDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetSubscriptionDefinitionResponse]
  }
  
  @scala.inline
  implicit class GetSubscriptionDefinitionResponseMutableBuilder[Self <: GetSubscriptionDefinitionResponse] (val x: Self) extends AnyVal {
