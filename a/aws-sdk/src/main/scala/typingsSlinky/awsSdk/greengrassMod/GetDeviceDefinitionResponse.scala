...
object GetDeviceDefinitionResponse {
  ...
  @scala.inline
  def apply(): GetDeviceDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetDeviceDefinitionResponse]
  }
  
  @scala.inline
  implicit class GetDeviceDefinitionResponseMutableBuilder[Self <: GetDeviceDefinitionResponse] (val x: Self) extends AnyVal {
