...
trait Resource extends js.Object {
  ...
  /**
    ...
    */
  var ResourceDataContainer: typingsSlinky.awsSdk.greengrassMod.ResourceDataContainer = js.native
}
...
object Resource {
  ...
  implicit class ResourceOps[Self <: Resource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceDataContainer(value: ResourceDataContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResourceDataContainer")(value.asInstanceOf[js.Any])
        ret
    }
  }
