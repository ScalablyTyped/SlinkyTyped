...
object CreateResourceDefinitionRequest {
  ...
  @scala.inline
  implicit class CreateResourceDefinitionRequestMutableBuilder[Self <: CreateResourceDefinitionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialVersion(value: ResourceDefinitionVersion): Self = StObject.set(x, "InitialVersion", value.asInstanceOf[js.Any])
