...
object GetResourceDefinitionResponse {
  ...
  @scala.inline
  def apply(): GetResourceDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetResourceDefinitionResponse]
  }
  
  @scala.inline
  implicit class GetResourceDefinitionResponseMutableBuilder[Self <: GetResourceDefinitionResponse] (val x: Self) extends AnyVal {
