...
@js.native
trait CreateResourceDefinitionResponse extends StObject {
...
object CreateResourceDefinitionResponse {
  ...
  @scala.inline
  implicit class CreateResourceDefinitionResponseMutableBuilder[Self <: CreateResourceDefinitionResponse] (val x: Self) extends AnyVal {
