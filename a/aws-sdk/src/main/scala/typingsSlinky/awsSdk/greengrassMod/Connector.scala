...
object Connector {
  ...
  implicit class ConnectorOps[Self <: Connector] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnectorArn(value: string): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConnectorArn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withParameters(value: mapOfString): Self = {
        val ret = this.duplicate
