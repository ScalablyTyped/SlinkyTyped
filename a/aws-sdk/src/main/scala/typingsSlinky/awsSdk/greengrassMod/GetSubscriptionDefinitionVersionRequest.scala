...
object GetSubscriptionDefinitionVersionRequest {
  ...
  implicit class GetSubscriptionDefinitionVersionRequestOps[Self <: GetSubscriptionDefinitionVersionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubscriptionDefinitionVersionId(value: string): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SubscriptionDefinitionVersionId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
