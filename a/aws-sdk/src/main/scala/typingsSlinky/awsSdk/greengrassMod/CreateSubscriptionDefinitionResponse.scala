...
@js.native
trait CreateSubscriptionDefinitionResponse extends StObject {
...
object CreateSubscriptionDefinitionResponse {
  ...
  @scala.inline
  implicit class CreateSubscriptionDefinitionResponseMutableBuilder[Self <: CreateSubscriptionDefinitionResponse] (val x: Self) extends AnyVal {
