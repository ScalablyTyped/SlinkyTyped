...
object ListSecurityProfilesResponse {
  ...
  implicit class ListSecurityProfilesResponseOps[Self <: ListSecurityProfilesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSecurityProfileIdentifiers(value: SecurityProfileIdentifiers): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("securityProfileIdentifiers")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSecurityProfileIdentifiers: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("securityProfileIdentifiers")(js.undefined)
        ret
    }
  }
