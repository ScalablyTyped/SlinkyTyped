...
object ElasticsearchAction {
  ...
  implicit class ElasticsearchActionOps[Self <: ElasticsearchAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndpoint(value: ElasticsearchEndpoint): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endpoint")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withId(value: ElasticsearchId): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("id")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIndex(value: ElasticsearchIndex): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: ElasticsearchType): Self = {
        val ret = this.duplicate
