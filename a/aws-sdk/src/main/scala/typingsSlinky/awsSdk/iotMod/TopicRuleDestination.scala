...
object TopicRuleDestination {
  ...
  implicit class TopicRuleDestinationOps[Self <: TopicRuleDestination] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHttpUrlProperties(value: HttpUrlDestinationProperties): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("httpUrlProperties")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHttpUrlProperties: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("httpUrlProperties")(js.undefined)
        ret
    }
    @scala.inline
