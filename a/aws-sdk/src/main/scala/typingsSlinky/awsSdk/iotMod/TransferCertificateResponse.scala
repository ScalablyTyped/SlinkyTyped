...
object TransferCertificateResponse {
  ...
  implicit class TransferCertificateResponseOps[Self <: TransferCertificateResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransferredCertificateArn(value: CertificateArn): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transferredCertificateArn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTransferredCertificateArn: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transferredCertificateArn")(js.undefined)
        ret
    }
  }
