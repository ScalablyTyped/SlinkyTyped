...
object ListMitigationActionsResponse {
  ...
  implicit class ListMitigationActionsResponseOps[Self <: ListMitigationActionsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActionIdentifiers(value: MitigationActionIdentifierList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("actionIdentifiers")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutActionIdentifiers: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("actionIdentifiers")(js.undefined)
        ret
    }
    @scala.inline
