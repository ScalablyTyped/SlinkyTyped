...
object IotSiteWiseAction {
  ...
  implicit class IotSiteWiseActionOps[Self <: IotSiteWiseAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPutAssetPropertyValueEntries(value: PutAssetPropertyValueEntryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("putAssetPropertyValueEntries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
