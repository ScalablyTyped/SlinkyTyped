...
object ActiveViolation {
  ...
  implicit class ActiveViolationOps[Self <: ActiveViolation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastViolationTime(value: js.Date): Self = this.set("lastViolationTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setViolationStartTime(value: js.Date): Self = this.set("violationStartTime", value.asInstanceOf[js.Any])
    @scala.inline
