...
object ActiveViolation {
  ...
  implicit class ActiveViolationMutableBuilder[Self <: ActiveViolation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastViolationTime(value: js.Date): Self = StObject.set(x, "lastViolationTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setViolationStartTime(value: js.Date): Self = StObject.set(x, "violationStartTime", value.asInstanceOf[js.Any])
