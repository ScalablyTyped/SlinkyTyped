...
object TransferData {
  ...
  implicit class TransferDataMutableBuilder[Self <: TransferData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcceptDate(value: js.Date): Self = StObject.set(x, "acceptDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAcceptDateUndefined: Self = StObject.set(x, "acceptDate", js.undefined)
    
    @scala.inline
    def setRejectDate(value: js.Date): Self = StObject.set(x, "rejectDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransferDate(value: js.Date): Self = StObject.set(x, "transferDate", value.asInstanceOf[js.Any])
