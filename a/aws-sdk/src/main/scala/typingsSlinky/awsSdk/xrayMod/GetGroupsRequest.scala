...
object GetGroupsRequest {
  ...
  @scala.inline
  implicit class GetGroupsRequestOps[Self <: GetGroupsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setNextToken(value: GetGroupsNextToken): Self = this.set("NextToken", value.asInstanceOf[js.Any])
    @scala.inline
