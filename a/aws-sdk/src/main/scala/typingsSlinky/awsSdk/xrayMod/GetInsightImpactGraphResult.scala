...
object GetInsightImpactGraphResult {
  ...
  implicit class GetInsightImpactGraphResultOps[Self <: GetInsightImpactGraphResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceGraphEndTime(value: js.Date): Self = this.set("ServiceGraphEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteServiceGraphEndTime: Self = this.set("ServiceGraphEndTime", js.undefined)
    
    @scala.inline
    def setServiceGraphStartTime(value: js.Date): Self = this.set("ServiceGraphStartTime", value.asInstanceOf[js.Any])
