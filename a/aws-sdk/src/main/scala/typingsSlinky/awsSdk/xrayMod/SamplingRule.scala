...
trait SamplingRule extends js.Object {
  ...
  /**
    ...
    */
  var FixedRate: typingsSlinky.awsSdk.xrayMod.FixedRate = js.native
  /**
    * Matches the HTTP method of a request.
    */
  var HTTPMethod: typingsSlinky.awsSdk.xrayMod.HTTPMethod = js.native
  /**
    * Matches the hostname from a request URL.
    */
  var Host: typingsSlinky.awsSdk.xrayMod.Host = js.native
  /**
    * The priority of the sampling rule.
    */
  var Priority: typingsSlinky.awsSdk.xrayMod.Priority = js.native
  /**
    * A fixed number of matching requests to instrument per second, prior to applying the fixed rate. The reservoir is not used directly by services, but applies to all services using the rule collectively.
    */
  var ReservoirSize: typingsSlinky.awsSdk.xrayMod.ReservoirSize = js.native
  /**
    * Matches the ARN of the AWS resource on which the service runs.
    */
  var ResourceARN: typingsSlinky.awsSdk.xrayMod.ResourceARN = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceName: typingsSlinky.awsSdk.xrayMod.ServiceName = js.native
  /**
    * Matches the origin that the service uses to identify its type in segments.
    */
  var ServiceType: typingsSlinky.awsSdk.xrayMod.ServiceType = js.native
  /**
    * Matches the path from a request URL.
    */
  var URLPath: typingsSlinky.awsSdk.xrayMod.URLPath = js.native
  /**
    * The version of the sampling rule format (1).
    */
  var Version: typingsSlinky.awsSdk.xrayMod.Version = js.native
}
...
object SamplingRule {
  ...
  implicit class SamplingRuleOps[Self <: SamplingRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFixedRate(value: FixedRate): Self = {
    ...
    @scala.inline
    def withReservoirSize(value: ReservoirSize): Self = {
        val ret = this.duplicate
