...
object ManagedActionHistoryItem {
  ...
  implicit class ManagedActionHistoryItemOps[Self <: ManagedActionHistoryItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExecutedTime(value: js.Date): Self = this.set("ExecutedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFinishedTime(value: js.Date): Self = this.set("FinishedTime", value.asInstanceOf[js.Any])
