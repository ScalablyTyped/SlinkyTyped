...
object ListPlatformBranchesRequest {
  ...
  @scala.inline
  implicit class ListPlatformBranchesRequestMutableBuilder[Self <: ListPlatformBranchesRequest] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFilters(value: SearchFilters): Self = StObject.set(x, "Filters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFiltersUndefined: Self = StObject.set(x, "Filters", js.undefined)
    
    @scala.inline
    def setFiltersVarargs(value: SearchFilter*): Self = StObject.set(x, "Filters", js.Array(value :_*))
    
    @scala.inline
    def setMaxRecords(value: PlatformBranchMaxRecords): Self = StObject.set(x, "MaxRecords", value.asInstanceOf[js.Any])
