...
trait PlatformBranchSummary extends StObject {
  ...
  /**
    ...
    */
  var BranchName: js.UndefOr[typingsSlinky.awsSdk.elasticbeanstalkMod.BranchName] = js.native
  ...
  /**
    ...
    */
  var BranchOrder: js.UndefOr[typingsSlinky.awsSdk.elasticbeanstalkMod.BranchOrder] = js.native
