...
trait EnvironmentDescription extends js.Object {
  ...
  /**
    ...
    */
  var OperationsRole: js.UndefOr[typingsSlinky.awsSdk.elasticbeanstalkMod.OperationsRole] = js.native
...
object EnvironmentDescription {
  ...
  implicit class EnvironmentDescriptionOps[Self <: EnvironmentDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateUpdated(value: js.Date): Self = this.set("DateUpdated", value.asInstanceOf[js.Any])
