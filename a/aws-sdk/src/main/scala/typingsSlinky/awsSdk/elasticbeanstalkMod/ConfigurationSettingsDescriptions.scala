...
object ConfigurationSettingsDescriptions {
  ...
  implicit class ConfigurationSettingsDescriptionsOps[Self <: ConfigurationSettingsDescriptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigurationSettings(value: ConfigurationSettingsDescriptionList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConfigurationSettings")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutConfigurationSettings: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConfigurationSettings")(js.undefined)
        ret
    }
  }
