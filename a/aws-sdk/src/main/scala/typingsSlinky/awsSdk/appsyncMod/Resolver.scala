...
object Resolver {
  ...
  implicit class ResolverOps[Self <: Resolver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResolverArn(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolverArn")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutResolverArn: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolverArn")(js.undefined)
        ret
    }
    @scala.inline
