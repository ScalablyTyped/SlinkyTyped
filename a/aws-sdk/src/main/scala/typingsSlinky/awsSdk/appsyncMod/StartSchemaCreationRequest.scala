...
object StartSchemaCreationRequest {
  ...
  implicit class StartSchemaCreationRequestOps[Self <: StartSchemaCreationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefinitionUint8Array(value: js.typedarray.Uint8Array): Self = this.set("definition", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefinition(value: _Blob): Self = this.set("definition", value.asInstanceOf[js.Any])
  }
}
