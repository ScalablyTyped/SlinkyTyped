...
trait AnomalyMonitor extends StObject {
  ...
  /**
    ...
    */
  var MonitorDimension: js.UndefOr[typingsSlinky.awsSdk.costexplorerMod.MonitorDimension] = js.native
  ...
  /**
    ...
    */
  var MonitorType: typingsSlinky.awsSdk.costexplorerMod.MonitorType = js.native
}
