...
object MemberDetail {
  ...
  implicit class MemberDetailOps[Self <: MemberDetail] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInvitedTime(value: js.Date): Self = this.set("InvitedTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPercentOfGraphUtilizationUpdatedTime(value: js.Date): Self = this.set("PercentOfGraphUtilizationUpdatedTime", value.asInstanceOf[js.Any])
    @scala.inline
