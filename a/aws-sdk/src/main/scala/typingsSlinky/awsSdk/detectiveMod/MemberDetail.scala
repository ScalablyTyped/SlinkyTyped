...
object MemberDetail {
  ...
  implicit class MemberDetailMutableBuilder[Self <: MemberDetail] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInvitedTime(value: js.Date): Self = StObject.set(x, "InvitedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPercentOfGraphUtilizationUpdatedTime(value: js.Date): Self = StObject.set(x, "PercentOfGraphUtilizationUpdatedTime", value.asInstanceOf[js.Any])
