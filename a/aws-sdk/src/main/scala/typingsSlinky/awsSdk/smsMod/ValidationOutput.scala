...
trait ValidationOutput extends StObject {
  ...
  /**
    ...
    */
  var latestValidationTime: js.UndefOr[js.Date] = js.native
...
object ValidationOutput {
  ...
  implicit class ValidationOutputMutableBuilder[Self <: ValidationOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLatestValidationTime(value: js.Date): Self = StObject.set(x, "latestValidationTime", value.asInstanceOf[js.Any])
