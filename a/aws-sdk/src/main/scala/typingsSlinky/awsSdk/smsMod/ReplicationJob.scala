...
object ReplicationJob {
  ...
  implicit class ReplicationJobOps[Self <: ReplicationJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextReplicationRunStartTime(value: js.Date): Self = this.set("nextReplicationRunStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeedReplicationTime(value: js.Date): Self = this.set("seedReplicationTime", value.asInstanceOf[js.Any])
