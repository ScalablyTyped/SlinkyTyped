...
object ReplicationJob {
  ...
  implicit class ReplicationJobMutableBuilder[Self <: ReplicationJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextReplicationRunStartTime(value: js.Date): Self = StObject.set(x, "nextReplicationRunStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeedReplicationTime(value: js.Date): Self = StObject.set(x, "seedReplicationTime", value.asInstanceOf[js.Any])
