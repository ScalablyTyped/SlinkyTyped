...
object ListCopyJobsInput {
  ...
  implicit class ListCopyJobsInputMutableBuilder[Self <: ListCopyJobsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setByCreatedAfter(value: js.Date): Self = StObject.set(x, "ByCreatedAfter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setByCreatedAfterUndefined: Self = StObject.set(x, "ByCreatedAfter", js.undefined)
    
    @scala.inline
    def setByCreatedBefore(value: js.Date): Self = StObject.set(x, "ByCreatedBefore", value.asInstanceOf[js.Any])
