...
object BackupJob {
  ...
  implicit class BackupJobOps[Self <: BackupJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpectedCompletionDate(value: js.Date): Self = this.set("ExpectedCompletionDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStartBy(value: js.Date): Self = this.set("StartBy", value.asInstanceOf[js.Any])
