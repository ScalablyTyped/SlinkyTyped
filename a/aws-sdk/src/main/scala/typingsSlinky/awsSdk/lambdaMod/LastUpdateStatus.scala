...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait LastUpdateStatus extends js.Object

object LastUpdateStatus {
  @scala.inline
  def Successful_ : typingsSlinky.awsSdk.awsSdkStrings.Successful_ = "Successful".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.Successful_]
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): LastUpdateStatus = value.asInstanceOf[LastUpdateStatus]
}
