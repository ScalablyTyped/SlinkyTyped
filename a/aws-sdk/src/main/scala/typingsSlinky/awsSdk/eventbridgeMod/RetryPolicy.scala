...
trait RetryPolicy extends js.Object {
  ...
  /**
    ...
    */
  var MaximumEventAgeInSeconds: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.MaximumEventAgeInSeconds] = js.native
  
  /**
    * The maximum number of retry attempts to make before the request fails. Retry attempts continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is met.
    */
  var MaximumRetryAttempts: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.MaximumRetryAttempts] = js.native
}
object RetryPolicy {
