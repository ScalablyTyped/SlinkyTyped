...
trait PutPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.Action] = js.native
  ...
  /**
    ...
    */
  var Principal: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.Principal] = js.native
