...
trait DescribeReplayResponse extends js.Object {
  ...
  /**
    ...
    */
  var ReplayName: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.ReplayName] = js.native
...
object DescribeReplayResponse {
  ...
  implicit class DescribeReplayResponseOps[Self <: DescribeReplayResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventEndTime(value: js.Date): Self = this.set("EventEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEventEndTime: Self = this.set("EventEndTime", js.undefined)
    
    @scala.inline
    def setEventLastReplayedTime(value: js.Date): Self = this.set("EventLastReplayedTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEventStartTime(value: js.Date): Self = this.set("EventStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReplayEndTime(value: js.Date): Self = this.set("ReplayEndTime", value.asInstanceOf[js.Any])
