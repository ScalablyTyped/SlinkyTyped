...
trait Target extends js.Object {
  ...
  /**
    ...
    */
  var HttpParameters: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.HttpParameters] = js.native
  /**
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.InputTransformer] = js.native
  /**
  ...
  /**
    ...
    */
  var RunCommandParameters: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.RunCommandParameters] = js.native
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typingsSlinky.awsSdk.eventbridgeMod.SqsParameters] = js.native
}
