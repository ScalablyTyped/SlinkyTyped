...
object ReportInstanceStatusRequest {
  ...
  implicit class ReportInstanceStatusRequestOps[Self <: ReportInstanceStatusRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInstances(value: InstanceIdStringList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Instances")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withReasonCodes(value: ReasonCodesList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ReasonCodes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
