...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait SpotInstanceInterruptionBehavior extends js.Object
...
object SpotInstanceInterruptionBehavior {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): SpotInstanceInterruptionBehavior = value.asInstanceOf[SpotInstanceInterruptionBehavior]
}
