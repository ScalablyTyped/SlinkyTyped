...
object Host {
  ...
  implicit class HostOps[Self <: Host] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllocationTime(value: js.Date): Self = this.set("AllocationTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReleaseTime(value: js.Date): Self = this.set("ReleaseTime", value.asInstanceOf[js.Any])
