...
object Host {
  ...
  implicit class HostMutableBuilder[Self <: Host] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllocationTime(value: js.Date): Self = StObject.set(x, "AllocationTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReleaseTime(value: js.Date): Self = StObject.set(x, "ReleaseTime", value.asInstanceOf[js.Any])
