...
object DescribePublicIpv4PoolsRequest {
  ...
  implicit class DescribePublicIpv4PoolsRequestOps[Self <: DescribePublicIpv4PoolsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxResults(value: PoolMaxResults): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPoolIds(value: PublicIpv4PoolIdStringList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PoolIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutPoolIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PoolIds")(js.undefined)
        ret
    }
  }
