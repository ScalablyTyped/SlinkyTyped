...
object ImportClientVpnClientCertificateRevocationListRequest {
  ...
  @scala.inline
  implicit class ImportClientVpnClientCertificateRevocationListRequestOps[Self <: ImportClientVpnClientCertificateRevocationListRequest] (val x: Self) extends AnyVal {
