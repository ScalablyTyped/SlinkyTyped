...
object DescribeDhcpOptionsRequest {
  ...
  implicit class DescribeDhcpOptionsRequestOps[Self <: DescribeDhcpOptionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDhcpOptionsIds(value: DhcpOptionsIdStringList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DhcpOptionsIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutDhcpOptionsIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DhcpOptionsIds")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMaxResults(value: DescribeDhcpOptionsMaxResults): Self = {
        val ret = this.duplicate
