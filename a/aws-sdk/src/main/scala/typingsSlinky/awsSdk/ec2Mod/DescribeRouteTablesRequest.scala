...
object DescribeRouteTablesRequest {
  ...
  @scala.inline
  implicit class DescribeRouteTablesRequestMutableBuilder[Self <: DescribeRouteTablesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxResults(value: DescribeRouteTablesMaxResults): Self = StObject.set(x, "MaxResults", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRouteTableIds(value: RouteTableIdStringList): Self = StObject.set(x, "RouteTableIds", value.asInstanceOf[js.Any])
