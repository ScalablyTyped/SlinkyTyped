...
object SlotDateTimeRangeRequest {
  ...
  implicit class SlotDateTimeRangeRequestOps[Self <: SlotDateTimeRangeRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEarliestTime(value: js.Date): Self = this.set("EarliestTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setLatestTime(value: js.Date): Self = this.set("LatestTime", value.asInstanceOf[js.Any])
  }
