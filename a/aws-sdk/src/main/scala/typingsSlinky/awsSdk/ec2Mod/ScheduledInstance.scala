...
object ScheduledInstance {
  ...
  implicit class ScheduledInstanceOps[Self <: ScheduledInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextSlotStartTime(value: js.Date): Self = this.set("NextSlotStartTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPreviousSlotEndTime(value: js.Date): Self = this.set("PreviousSlotEndTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTermEndDate(value: js.Date): Self = this.set("TermEndDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTermEndDate: Self = this.set("TermEndDate", js.undefined)
    @scala.inline
    def setTermStartDate(value: js.Date): Self = this.set("TermStartDate", value.asInstanceOf[js.Any])
    @scala.inline
