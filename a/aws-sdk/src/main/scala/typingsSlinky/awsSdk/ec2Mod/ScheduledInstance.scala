...
object ScheduledInstance {
  ...
  implicit class ScheduledInstanceMutableBuilder[Self <: ScheduledInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNextSlotStartTime(value: js.Date): Self = StObject.set(x, "NextSlotStartTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreviousSlotEndTime(value: js.Date): Self = StObject.set(x, "PreviousSlotEndTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTermEndDate(value: js.Date): Self = StObject.set(x, "TermEndDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTermEndDateUndefined: Self = StObject.set(x, "TermEndDate", js.undefined)
    
    @scala.inline
    def setTermStartDate(value: js.Date): Self = StObject.set(x, "TermStartDate", value.asInstanceOf[js.Any])
