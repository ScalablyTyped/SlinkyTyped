...
object ProvisionedBandwidth {
  ...
  implicit class ProvisionedBandwidthOps[Self <: ProvisionedBandwidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProvisionTime(value: js.Date): Self = this.set("ProvisionTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRequestTime(value: js.Date): Self = this.set("RequestTime", value.asInstanceOf[js.Any])
    @scala.inline
