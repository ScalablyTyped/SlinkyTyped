...
object DescribeInternetGatewaysRequest {
  ...
  implicit class DescribeInternetGatewaysRequestOps[Self <: DescribeInternetGatewaysRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInternetGatewayIds(value: InternetGatewayIdList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InternetGatewayIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutInternetGatewayIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InternetGatewayIds")(js.undefined)
        ret
    }
    @scala.inline
    def withMaxResults(value: DescribeInternetGatewaysMaxResults): Self = {
        val ret = this.duplicate
