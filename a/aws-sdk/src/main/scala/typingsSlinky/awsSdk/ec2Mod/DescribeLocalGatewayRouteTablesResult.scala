...
object DescribeLocalGatewayRouteTablesResult {
  ...
  implicit class DescribeLocalGatewayRouteTablesResultOps[Self <: DescribeLocalGatewayRouteTablesResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalGatewayRouteTablesVarargs(value: LocalGatewayRouteTable*): Self = this.set("LocalGatewayRouteTables", js.Array(value :_*))
    @scala.inline
    def setLocalGatewayRouteTables(value: LocalGatewayRouteTableSet): Self = this.set("LocalGatewayRouteTables", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLocalGatewayRouteTables: Self = this.set("LocalGatewayRouteTables", js.undefined)
    @scala.inline
