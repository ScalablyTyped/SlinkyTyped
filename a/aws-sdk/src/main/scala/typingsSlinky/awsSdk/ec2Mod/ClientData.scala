...
object ClientData {
  ...
  implicit class ClientDataOps[Self <: ClientData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUploadEnd(value: js.Date): Self = this.set("UploadEnd", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUploadStart(value: js.Date): Self = this.set("UploadStart", value.asInstanceOf[js.Any])
