...
object ClientData {
  ...
  implicit class ClientDataMutableBuilder[Self <: ClientData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUploadEnd(value: js.Date): Self = StObject.set(x, "UploadEnd", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUploadStart(value: js.Date): Self = StObject.set(x, "UploadStart", value.asInstanceOf[js.Any])
