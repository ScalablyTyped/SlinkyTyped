...
object DescribeConversionTasksResult {
  ...
  implicit class DescribeConversionTasksResultOps[Self <: DescribeConversionTasksResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConversionTasks(value: DescribeConversionTaskList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConversionTasks")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutConversionTasks: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConversionTasks")(js.undefined)
        ret
    }
  }
