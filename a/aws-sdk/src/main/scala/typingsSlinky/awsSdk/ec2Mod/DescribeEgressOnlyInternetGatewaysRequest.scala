...
object DescribeEgressOnlyInternetGatewaysRequest {
  ...
  implicit class DescribeEgressOnlyInternetGatewaysRequestOps[Self <: DescribeEgressOnlyInternetGatewaysRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEgressOnlyInternetGatewayIds(value: EgressOnlyInternetGatewayIdList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EgressOnlyInternetGatewayIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEgressOnlyInternetGatewayIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EgressOnlyInternetGatewayIds")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMaxResults(value: DescribeEgressOnlyInternetGatewaysMaxResults): Self = {
        val ret = this.duplicate
