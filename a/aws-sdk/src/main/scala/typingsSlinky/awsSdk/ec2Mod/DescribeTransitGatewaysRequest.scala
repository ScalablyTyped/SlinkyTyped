...
object DescribeTransitGatewaysRequest {
  ...
  implicit class DescribeTransitGatewaysRequestOps[Self <: DescribeTransitGatewaysRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransitGatewayIds(value: TransitGatewayIdStringList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TransitGatewayIds")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTransitGatewayIds: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TransitGatewayIds")(js.undefined)
        ret
    }
  }
