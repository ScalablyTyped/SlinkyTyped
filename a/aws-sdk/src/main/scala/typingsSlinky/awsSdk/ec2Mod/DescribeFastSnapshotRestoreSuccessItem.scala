...
object DescribeFastSnapshotRestoreSuccessItem {
  ...
  implicit class DescribeFastSnapshotRestoreSuccessItemMutableBuilder[Self <: DescribeFastSnapshotRestoreSuccessItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisabledTime(value: js.Date): Self = StObject.set(x, "DisabledTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisabledTimeUndefined: Self = StObject.set(x, "DisabledTime", js.undefined)
    
    @scala.inline
    def setDisablingTime(value: js.Date): Self = StObject.set(x, "DisablingTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisablingTimeUndefined: Self = StObject.set(x, "DisablingTime", js.undefined)
    
    @scala.inline
    def setEnabledTime(value: js.Date): Self = StObject.set(x, "EnabledTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnabledTimeUndefined: Self = StObject.set(x, "EnabledTime", js.undefined)
    
    @scala.inline
    def setEnablingTime(value: js.Date): Self = StObject.set(x, "EnablingTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEnablingTimeUndefined: Self = StObject.set(x, "EnablingTime", js.undefined)
    
    @scala.inline
    def setOptimizingTime(value: js.Date): Self = StObject.set(x, "OptimizingTime", value.asInstanceOf[js.Any])
