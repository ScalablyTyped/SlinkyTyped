...
object OnDemandOptionsRequest {
  ...
  @scala.inline
  implicit class OnDemandOptionsRequestOps[Self <: OnDemandOptionsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCapacityReservationOptions(value: CapacityReservationOptionsRequest): Self = this.set("CapacityReservationOptions", value.asInstanceOf[js.Any])
    @scala.inline
