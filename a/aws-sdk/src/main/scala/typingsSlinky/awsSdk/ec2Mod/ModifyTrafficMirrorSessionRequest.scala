...
trait ModifyTrafficMirrorSessionRequest extends js.Object {
  ...
  /**
    ...
    */
  var TrafficMirrorFilterId: js.UndefOr[typingsSlinky.awsSdk.ec2Mod.TrafficMirrorFilterId] = js.native
  /**
  ...
  /**
    ...
    */
  var TrafficMirrorTargetId: js.UndefOr[typingsSlinky.awsSdk.ec2Mod.TrafficMirrorTargetId] = js.native
  /**
...
object ModifyTrafficMirrorSessionRequest {
  ...
  implicit class ModifyTrafficMirrorSessionRequestOps[Self <: ModifyTrafficMirrorSessionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoveFields(value: TrafficMirrorSessionFieldList): Self = {
        val ret = this.duplicate
