...
@js.native
trait AcceptTransitGatewayVpcAttachmentRequest extends StObject {
...
object AcceptTransitGatewayVpcAttachmentRequest {
  ...
  @scala.inline
  implicit class AcceptTransitGatewayVpcAttachmentRequestMutableBuilder[Self <: AcceptTransitGatewayVpcAttachmentRequest] (val x: Self) extends AnyVal {
