...
@js.native
trait EnableFastSnapshotRestoreSuccessItem extends StObject {
...
object EnableFastSnapshotRestoreSuccessItem {
  ...
  @scala.inline
  implicit class EnableFastSnapshotRestoreSuccessItemMutableBuilder[Self <: EnableFastSnapshotRestoreSuccessItem] (val x: Self) extends AnyVal {
