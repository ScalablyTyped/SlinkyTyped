...
@js.native
trait CreateTransitGatewayPrefixListReferenceRequest extends js.Object {
...
object CreateTransitGatewayPrefixListReferenceRequest {
  ...
  @scala.inline
  implicit class CreateTransitGatewayPrefixListReferenceRequestOps[Self <: CreateTransitGatewayPrefixListReferenceRequest] (val x: Self) extends AnyVal {
