...
object DescribeFleetInstancesRequest {
  ...
  @scala.inline
  def apply(FleetId: FleetId): DescribeFleetInstancesRequest = {
    val __obj = js.Dynamic.literal(FleetId = FleetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescribeFleetInstancesRequest]
  }
  
  @scala.inline
  implicit class DescribeFleetInstancesRequestMutableBuilder[Self <: DescribeFleetInstancesRequest] (val x: Self) extends AnyVal {
