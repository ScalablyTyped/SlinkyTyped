...
@js.native
trait GetTransitGatewayPrefixListReferencesRequest extends js.Object {
...
object GetTransitGatewayPrefixListReferencesRequest {
  ...
  @scala.inline
  implicit class GetTransitGatewayPrefixListReferencesRequestOps[Self <: GetTransitGatewayPrefixListReferencesRequest] (val x: Self) extends AnyVal {
