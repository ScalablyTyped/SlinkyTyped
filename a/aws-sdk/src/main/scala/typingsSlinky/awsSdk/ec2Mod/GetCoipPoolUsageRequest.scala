...
object GetCoipPoolUsageRequest {
  ...
  @scala.inline
  def apply(PoolId: CoipPoolId): GetCoipPoolUsageRequest = {
    val __obj = js.Dynamic.literal(PoolId = PoolId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetCoipPoolUsageRequest]
  }
  
  @scala.inline
  implicit class GetCoipPoolUsageRequestMutableBuilder[Self <: GetCoipPoolUsageRequest] (val x: Self) extends AnyVal {
