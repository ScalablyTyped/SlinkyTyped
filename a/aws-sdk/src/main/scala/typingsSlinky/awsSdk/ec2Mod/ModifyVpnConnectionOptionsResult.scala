...
@js.native
trait ModifyVpnConnectionOptionsResult extends js.Object {
...
object ModifyVpnConnectionOptionsResult {
  ...
  @scala.inline
  implicit class ModifyVpnConnectionOptionsResultOps[Self <: ModifyVpnConnectionOptionsResult] (val x: Self) extends AnyVal {
