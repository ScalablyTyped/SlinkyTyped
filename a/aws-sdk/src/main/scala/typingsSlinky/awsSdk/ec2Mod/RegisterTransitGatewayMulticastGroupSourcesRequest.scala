...
object RegisterTransitGatewayMulticastGroupSourcesRequest {
  ...
  @scala.inline
  implicit class RegisterTransitGatewayMulticastGroupSourcesRequestOps[Self <: RegisterTransitGatewayMulticastGroupSourcesRequest] (val x: Self) extends AnyVal {
    @scala.inline
