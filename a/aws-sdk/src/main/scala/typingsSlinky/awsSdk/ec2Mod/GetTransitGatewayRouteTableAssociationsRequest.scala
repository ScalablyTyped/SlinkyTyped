...
object GetTransitGatewayRouteTableAssociationsRequest {
  ...
  @scala.inline
  def apply(TransitGatewayRouteTableId: TransitGatewayRouteTableId): GetTransitGatewayRouteTableAssociationsRequest = {
  ...
  @scala.inline
  implicit class GetTransitGatewayRouteTableAssociationsRequestMutableBuilder[Self <: GetTransitGatewayRouteTableAssociationsRequest] (val x: Self) extends AnyVal {
