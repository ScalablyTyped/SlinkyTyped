...
object CacheNodeUpdateStatus {
  ...
  implicit class CacheNodeUpdateStatusOps[Self <: CacheNodeUpdateStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNodeDeletionDate(value: js.Date): Self = this.set("NodeDeletionDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNodeDeletionDate: Self = this.set("NodeDeletionDate", js.undefined)
    
    @scala.inline
    def setNodeUpdateEndDate(value: js.Date): Self = this.set("NodeUpdateEndDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNodeUpdateInitiatedDate(value: js.Date): Self = this.set("NodeUpdateInitiatedDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNodeUpdateInitiatedDate: Self = this.set("NodeUpdateInitiatedDate", js.undefined)
    
    @scala.inline
    def setNodeUpdateStartDate(value: js.Date): Self = this.set("NodeUpdateStartDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNodeUpdateStatusModifiedDate(value: js.Date): Self = this.set("NodeUpdateStatusModifiedDate", value.asInstanceOf[js.Any])
