...
object UpdateAction {
  ...
  implicit class UpdateActionOps[Self <: UpdateAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceUpdateRecommendedApplyByDate(value: js.Date): Self = this.set("ServiceUpdateRecommendedApplyByDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteServiceUpdateRecommendedApplyByDate: Self = this.set("ServiceUpdateRecommendedApplyByDate", js.undefined)
    
    @scala.inline
    def setServiceUpdateReleaseDate(value: js.Date): Self = this.set("ServiceUpdateReleaseDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpdateActionAvailableDate(value: js.Date): Self = this.set("UpdateActionAvailableDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpdateActionStatusModifiedDate(value: js.Date): Self = this.set("UpdateActionStatusModifiedDate", value.asInstanceOf[js.Any])
