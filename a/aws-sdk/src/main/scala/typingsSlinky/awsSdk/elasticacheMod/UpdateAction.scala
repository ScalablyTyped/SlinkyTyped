...
object UpdateAction {
  ...
  implicit class UpdateActionMutableBuilder[Self <: UpdateAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceUpdateRecommendedApplyByDate(value: js.Date): Self = StObject.set(x, "ServiceUpdateRecommendedApplyByDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setServiceUpdateRecommendedApplyByDateUndefined: Self = StObject.set(x, "ServiceUpdateRecommendedApplyByDate", js.undefined)
    
    @scala.inline
    def setServiceUpdateReleaseDate(value: js.Date): Self = StObject.set(x, "ServiceUpdateReleaseDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpdateActionAvailableDate(value: js.Date): Self = StObject.set(x, "UpdateActionAvailableDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUpdateActionStatusModifiedDate(value: js.Date): Self = StObject.set(x, "UpdateActionStatusModifiedDate", value.asInstanceOf[js.Any])
