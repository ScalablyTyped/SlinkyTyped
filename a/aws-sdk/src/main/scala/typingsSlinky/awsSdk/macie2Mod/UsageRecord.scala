...
trait UsageRecord extends js.Object {
  ...
  /**
    ...
    */
  var freeTrialStartDate: js.UndefOr[js.Date] = js.native
  /**
...
object UsageRecord {
  @scala.inline
  def apply(accountId: string = null, freeTrialStartDate: js.Date = null, usage: listOfUsageByAccount = null): UsageRecord = {
