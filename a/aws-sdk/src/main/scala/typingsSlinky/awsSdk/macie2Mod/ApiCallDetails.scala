...
object ApiCallDetails {
  ...
  implicit class ApiCallDetailsOps[Self <: ApiCallDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstSeen(value: js.Date): Self = this.set("firstSeen", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFirstSeen: Self = this.set("firstSeen", js.undefined)
    @scala.inline
    def setLastSeen(value: js.Date): Self = this.set("lastSeen", value.asInstanceOf[js.Any])
    @scala.inline
