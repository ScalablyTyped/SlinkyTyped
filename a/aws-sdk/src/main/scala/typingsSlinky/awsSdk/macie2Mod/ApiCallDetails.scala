...
object ApiCallDetails {
  ...
  implicit class ApiCallDetailsMutableBuilder[Self <: ApiCallDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstSeen(value: js.Date): Self = StObject.set(x, "firstSeen", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFirstSeenUndefined: Self = StObject.set(x, "firstSeen", js.undefined)
    
    @scala.inline
    def setLastSeen(value: js.Date): Self = StObject.set(x, "lastSeen", value.asInstanceOf[js.Any])
