...
object UserPausedDetails {
  ...
  implicit class UserPausedDetailsOps[Self <: UserPausedDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJobExpiresAt(value: js.Date): Self = this.set("jobExpiresAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJobPausedAt(value: js.Date): Self = this.set("jobPausedAt", value.asInstanceOf[js.Any])
