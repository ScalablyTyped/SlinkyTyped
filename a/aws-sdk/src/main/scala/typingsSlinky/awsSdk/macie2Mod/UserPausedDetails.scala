...
trait UserPausedDetails extends StObject {
  ...
  /**
    ...
    */
  var jobExpiresAt: js.UndefOr[js.Date] = js.native
  ...
  /**
    ...
    */
  var jobPausedAt: js.UndefOr[js.Date] = js.native
}
object UserPausedDetails {
  ...
  implicit class UserPausedDetailsMutableBuilder[Self <: UserPausedDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJobExpiresAt(value: js.Date): Self = StObject.set(x, "jobExpiresAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJobPausedAt(value: js.Date): Self = StObject.set(x, "jobPausedAt", value.asInstanceOf[js.Any])
