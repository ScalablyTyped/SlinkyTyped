...
object Task {
  ...
  implicit class TaskOps[Self <: Task] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConnectivityAt(value: js.Date): Self = this.set("connectivityAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setExecutionStoppedAt(value: js.Date): Self = this.set("executionStoppedAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPullStartedAt(value: js.Date): Self = this.set("pullStartedAt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePullStartedAt: Self = this.set("pullStartedAt", js.undefined)
    
    @scala.inline
    def setPullStoppedAt(value: js.Date): Self = this.set("pullStoppedAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStoppedAt(value: js.Date): Self = this.set("stoppedAt", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStoppingAt(value: js.Date): Self = this.set("stoppingAt", value.asInstanceOf[js.Any])
