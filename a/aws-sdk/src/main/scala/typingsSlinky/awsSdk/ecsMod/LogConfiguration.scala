...
object LogConfiguration {
  ...
  implicit class LogConfigurationOps[Self <: LogConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOptions(value: LogConfigurationOptionsMap): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSecretOptions(value: SecretList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("secretOptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutSecretOptions: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("secretOptions")(js.undefined)
        ret
    }
  }
