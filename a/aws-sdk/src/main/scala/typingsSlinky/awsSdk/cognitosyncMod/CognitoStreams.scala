...
trait CognitoStreams extends js.Object {
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsSlinky.awsSdk.cognitosyncMod.StreamName] = js.native
  /**
    ...
    */
  var StreamingStatus: js.UndefOr[typingsSlinky.awsSdk.cognitosyncMod.StreamingStatus] = js.native
}
