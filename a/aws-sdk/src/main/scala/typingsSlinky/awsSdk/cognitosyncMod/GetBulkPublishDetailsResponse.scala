...
object GetBulkPublishDetailsResponse {
  ...
  implicit class GetBulkPublishDetailsResponseMutableBuilder[Self <: GetBulkPublishDetailsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBulkPublishCompleteTime(value: js.Date): Self = StObject.set(x, "BulkPublishCompleteTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBulkPublishCompleteTimeUndefined: Self = StObject.set(x, "BulkPublishCompleteTime", js.undefined)
    
    @scala.inline
    def setBulkPublishStartTime(value: js.Date): Self = StObject.set(x, "BulkPublishStartTime", value.asInstanceOf[js.Any])
