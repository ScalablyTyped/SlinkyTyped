...
object GetBulkPublishDetailsResponse {
  ...
  implicit class GetBulkPublishDetailsResponseOps[Self <: GetBulkPublishDetailsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBulkPublishCompleteTime(value: js.Date): Self = this.set("BulkPublishCompleteTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBulkPublishCompleteTime: Self = this.set("BulkPublishCompleteTime", js.undefined)
    
    @scala.inline
    def setBulkPublishStartTime(value: js.Date): Self = this.set("BulkPublishStartTime", value.asInstanceOf[js.Any])
