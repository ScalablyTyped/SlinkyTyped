...
trait RulesSourceList extends StObject {
  ...
  /**
    ...
    */
  var GeneratedRulesType: typingsSlinky.awsSdk.networkfirewallMod.GeneratedRulesType = js.native
  
  /**
    * 
    */
  var TargetTypes: typingsSlinky.awsSdk.networkfirewallMod.TargetTypes = js.native
