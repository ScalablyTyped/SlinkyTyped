...
trait ListFirewallsRequest extends js.Object {
  ...
  /**
    ...
    */
  var VpcIds: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.VpcIds] = js.native
}
object ListFirewallsRequest {
  ...
  @scala.inline
  implicit class ListFirewallsRequestOps[Self <: ListFirewallsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVpcIds(value: VpcIds): Self = this.set("VpcIds", value.asInstanceOf[js.Any])
