...
trait RuleVariables extends js.Object {
  ...
  /**
    ...
    */
  var IPSets: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.IPSets] = js.native
  
  /**
    * A list of port ranges. 
    */
  var PortSets: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.PortSets] = js.native
}
