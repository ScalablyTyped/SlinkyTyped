...
trait LogDestinationConfig extends js.Object {
  ...
  /**
    ...
    */
  var LogDestinationType: typingsSlinky.awsSdk.networkfirewallMod.LogDestinationType = js.native
  ...
  /**
    ...
    */
  var LogType: typingsSlinky.awsSdk.networkfirewallMod.LogType = js.native
}
