...
trait RulesSource extends StObject {
  ...
  /**
    ...
    */
  var RulesSourceList: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.RulesSourceList] = js.native
  ...
  /**
    ...
    */
  var RulesString: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.RulesString] = js.native
  ...
  /**
    ...
    */
  var StatefulRules: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.StatefulRules] = js.native
  
  /**
    * Stateless inspection criteria to be used in a stateless rule group. 
    */
  var StatelessRulesAndCustomActions: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.StatelessRulesAndCustomActions] = js.native
}
object RulesSource {
