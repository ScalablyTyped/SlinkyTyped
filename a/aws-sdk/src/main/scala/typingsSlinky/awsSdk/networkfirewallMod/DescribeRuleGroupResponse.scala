...
trait DescribeRuleGroupResponse extends StObject {
  ...
  /**
    ...
    */
  var RuleGroup: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.RuleGroup] = js.native
  
  /**
    * The high-level properties of a rule group. This, along with the RuleGroup, define the rule group. You can retrieve all objects for a rule group by calling DescribeRuleGroup. 
    */
  var RuleGroupResponse: typingsSlinky.awsSdk.networkfirewallMod.RuleGroupResponse = js.native
...
object DescribeRuleGroupResponse {
  ...
  @scala.inline
  implicit class DescribeRuleGroupResponseMutableBuilder[Self <: DescribeRuleGroupResponse] (val x: Self) extends AnyVal {
