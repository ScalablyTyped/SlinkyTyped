...
trait TCPFlagField extends js.Object {
  ...
  /**
    ...
    */
  var Flags: typingsSlinky.awsSdk.networkfirewallMod.Flags = js.native
...
object TCPFlagField {
  ...
  @scala.inline
  implicit class TCPFlagFieldOps[Self <: TCPFlagField] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFlagsVarargs(value: TCPFlag*): Self = this.set("Flags", js.Array(value :_*))
    
    @scala.inline
    def setFlags(value: Flags): Self = this.set("Flags", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMasksVarargs(value: TCPFlag*): Self = this.set("Masks", js.Array(value :_*))
    
    @scala.inline
    def setMasks(value: Flags): Self = this.set("Masks", value.asInstanceOf[js.Any])
