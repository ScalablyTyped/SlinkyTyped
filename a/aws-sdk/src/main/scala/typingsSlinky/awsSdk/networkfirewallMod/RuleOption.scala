...
trait RuleOption extends js.Object {
  ...
  /**
    * 
    */
  var Keyword: typingsSlinky.awsSdk.networkfirewallMod.Keyword = js.native
  
  /**
    * 
    */
  var Settings: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.Settings] = js.native
}
object RuleOption {
