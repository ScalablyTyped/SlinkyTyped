...
trait CustomAction extends StObject {
  ...
  /**
    ...
    */
  var ActionDefinition: typingsSlinky.awsSdk.networkfirewallMod.ActionDefinition = js.native
  
  /**
    * The descriptive name of the custom action. You can't change the name of a custom action after you create it.
    */
  var ActionName: typingsSlinky.awsSdk.networkfirewallMod.ActionName = js.native
}
object CustomAction {
