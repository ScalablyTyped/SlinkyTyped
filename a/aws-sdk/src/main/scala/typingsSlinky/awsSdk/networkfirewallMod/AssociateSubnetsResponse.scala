...
trait AssociateSubnetsResponse extends js.Object {
  ...
  /**
    ...
    */
  var SubnetMappings: js.UndefOr[typingsSlinky.awsSdk.networkfirewallMod.SubnetMappings] = js.native
...
object AssociateSubnetsResponse {
  ...
  @scala.inline
  implicit class AssociateSubnetsResponseOps[Self <: AssociateSubnetsResponse] (val x: Self) extends AnyVal {
