...
object Fragment {
  ...
  implicit class FragmentOps[Self <: Fragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProducerTimestamp(value: js.Date): Self = this.set("ProducerTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteProducerTimestamp: Self = this.set("ProducerTimestamp", js.undefined)
    
    @scala.inline
    def setServerTimestamp(value: js.Date): Self = this.set("ServerTimestamp", value.asInstanceOf[js.Any])
