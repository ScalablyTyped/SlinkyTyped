...
object Fragment {
  ...
  implicit class FragmentMutableBuilder[Self <: Fragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProducerTimestamp(value: js.Date): Self = StObject.set(x, "ProducerTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProducerTimestampUndefined: Self = StObject.set(x, "ProducerTimestamp", js.undefined)
    
    @scala.inline
    def setServerTimestamp(value: js.Date): Self = StObject.set(x, "ServerTimestamp", value.asInstanceOf[js.Any])
