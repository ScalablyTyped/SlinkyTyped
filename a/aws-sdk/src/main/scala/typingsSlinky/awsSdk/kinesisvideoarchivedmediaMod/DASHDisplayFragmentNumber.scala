...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait DASHDisplayFragmentNumber extends js.Object
...
object DASHDisplayFragmentNumber {
  ...
  @scala.inline
  implicit def apply(value: java.lang.String): DASHDisplayFragmentNumber = value.asInstanceOf[DASHDisplayFragmentNumber]
}
