...
object ExportEC2InstanceRecommendationsRequest {
  ...
  @scala.inline
  implicit class ExportEC2InstanceRecommendationsRequestMutableBuilder[Self <: ExportEC2InstanceRecommendationsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldsToExport(value: ExportableInstanceFields): Self = StObject.set(x, "fieldsToExport", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFieldsToExportUndefined: Self = StObject.set(x, "fieldsToExport", js.undefined)
    
    @scala.inline
    def setFieldsToExportVarargs(value: ExportableInstanceField*): Self = StObject.set(x, "fieldsToExport", js.Array(value :_*))
