...
package object stsMod {
  
  type Audience = java.lang.String
  
  type ClientConfiguration = typingsSlinky.awsSdk.serviceMod.ServiceConfigurationOptions with typingsSlinky.awsSdk.stsMod.ClientApiVersions
  ...
  */
  ...
  type policyDescriptorListType = js.Array[typingsSlinky.awsSdk.stsMod.PolicyDescriptorType]
  ...
  type tagKeyListType = js.Array[typingsSlinky.awsSdk.stsMod.tagKeyType]
  
  type tagKeyType = java.lang.String
  
  type tagListType = js.Array[typingsSlinky.awsSdk.stsMod.Tag]
