...
trait AddHeaderAction extends js.Object {
  /**
    ...
    */
  var HeaderName: typingsSlinky.awsSdk.sesMod.HeaderName = js.native
  /**
    * Must be less than 2048 characters, and must not contain newline characters ("\r" or "\n").
    */
  var HeaderValue: typingsSlinky.awsSdk.sesMod.HeaderValue = js.native
}
...
object AddHeaderAction {
  ...
  implicit class AddHeaderActionOps[Self <: AddHeaderAction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHeaderName(value: HeaderName): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HeaderName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHeaderValue(value: HeaderValue): Self = {
        val ret = this.duplicate
