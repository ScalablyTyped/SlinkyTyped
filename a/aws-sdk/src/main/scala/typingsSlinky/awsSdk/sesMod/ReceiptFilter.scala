...
object ReceiptFilter {
  ...
  implicit class ReceiptFilterOps[Self <: ReceiptFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIpFilter(value: ReceiptIpFilter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IpFilter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withName(value: ReceiptFilterName): Self = {
        val ret = this.duplicate
