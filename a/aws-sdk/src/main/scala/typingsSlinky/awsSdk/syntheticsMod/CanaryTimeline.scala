...
object CanaryTimeline {
  ...
  implicit class CanaryTimelineMutableBuilder[Self <: CanaryTimeline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastStarted(value: js.Date): Self = StObject.set(x, "LastStarted", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastStartedUndefined: Self = StObject.set(x, "LastStarted", js.undefined)
    
    @scala.inline
    def setLastStopped(value: js.Date): Self = StObject.set(x, "LastStopped", value.asInstanceOf[js.Any])
