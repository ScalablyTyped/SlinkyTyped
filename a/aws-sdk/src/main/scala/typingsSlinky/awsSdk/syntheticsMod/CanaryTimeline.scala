...
object CanaryTimeline {
  ...
  implicit class CanaryTimelineOps[Self <: CanaryTimeline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastStarted(value: js.Date): Self = this.set("LastStarted", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastStarted: Self = this.set("LastStarted", js.undefined)
    
    @scala.inline
    def setLastStopped(value: js.Date): Self = this.set("LastStopped", value.asInstanceOf[js.Any])
