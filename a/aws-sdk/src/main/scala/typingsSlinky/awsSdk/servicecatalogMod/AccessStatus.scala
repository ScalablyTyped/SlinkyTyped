...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait AccessStatus extends js.Object

object AccessStatus {
  @scala.inline
  def ENABLED: typingsSlinky.awsSdk.awsSdkStrings.ENABLED = "ENABLED".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.ENABLED]
  @scala.inline
  def UNDER_CHANGE: typingsSlinky.awsSdk.awsSdkStrings.UNDER_CHANGE = "UNDER_CHANGE".asInstanceOf[typingsSlinky.awsSdk.awsSdkStrings.UNDER_CHANGE]
  @scala.inline
  ...
  @scala.inline
  implicit def apply(value: String): AccessStatus = value.asInstanceOf[AccessStatus]
}
