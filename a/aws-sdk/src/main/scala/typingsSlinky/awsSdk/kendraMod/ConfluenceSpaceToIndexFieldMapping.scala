...
object ConfluenceSpaceToIndexFieldMapping {
  ...
  @scala.inline
  implicit class ConfluenceSpaceToIndexFieldMappingOps[Self <: ConfluenceSpaceToIndexFieldMapping] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourceFieldName(value: ConfluenceSpaceFieldName): Self = this.set("DataSourceFieldName", value.asInstanceOf[js.Any])
