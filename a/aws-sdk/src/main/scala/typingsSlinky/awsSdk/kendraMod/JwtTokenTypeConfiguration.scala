...
trait JwtTokenTypeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ClaimRegex: js.UndefOr[typingsSlinky.awsSdk.kendraMod.ClaimRegex] = js.native
  
  /**
    * The group attribute field.
    */
  var GroupAttributeField: js.UndefOr[typingsSlinky.awsSdk.kendraMod.GroupAttributeField] = js.native
  
  /**
    * The issuer of the token.
    */
  var Issuer: js.UndefOr[typingsSlinky.awsSdk.kendraMod.Issuer] = js.native
  
  /**
    * The location of the key.
    */
  var KeyLocation: typingsSlinky.awsSdk.kendraMod.KeyLocation = js.native
  ...
  /**
    ...
    */
  var UserNameAttributeField: js.UndefOr[typingsSlinky.awsSdk.kendraMod.UserNameAttributeField] = js.native
}
