...
trait VideoCodecSettings extends js.Object {
  ...
  /**
    ...
    */
  var Vp8Settings: js.UndefOr[typingsSlinky.awsSdk.mediaconvertMod.Vp8Settings] = js.native
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value VP9.
    */
  var Vp9Settings: js.UndefOr[typingsSlinky.awsSdk.mediaconvertMod.Vp9Settings] = js.native
}
