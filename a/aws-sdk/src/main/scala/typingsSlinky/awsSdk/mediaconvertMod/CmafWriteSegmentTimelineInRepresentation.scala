...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait CmafWriteSegmentTimelineInRepresentation extends js.Object
...
object CmafWriteSegmentTimelineInRepresentation {
  ...
  @scala.inline
  implicit def apply(value: String): CmafWriteSegmentTimelineInRepresentation = value.asInstanceOf[CmafWriteSegmentTimelineInRepresentation]
}
