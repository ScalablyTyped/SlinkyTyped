...
object BurninDestinationSettings {
  ...
  implicit class BurninDestinationSettingsOps[Self <: BurninDestinationSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAlignment(value: BurninSubtitleAlignment): Self = {
    ...
    @scala.inline
    def withBackgroundColor(value: BurninSubtitleBackgroundColor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withFontColor(value: BurninSubtitleFontColor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOutlineColor(value: BurninSubtitleOutlineColor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShadowColor(value: BurninSubtitleShadowColor): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTeletextSpacing(value: BurninSubtitleTeletextSpacing): Self = {
        val ret = this.duplicate
