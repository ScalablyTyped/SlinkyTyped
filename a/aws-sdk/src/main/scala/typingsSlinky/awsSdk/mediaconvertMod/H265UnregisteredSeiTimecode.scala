...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait H265UnregisteredSeiTimecode extends js.Object
...
object H265UnregisteredSeiTimecode {
  ...
  @scala.inline
  implicit def apply(value: String): H265UnregisteredSeiTimecode = value.asInstanceOf[H265UnregisteredSeiTimecode]
}
