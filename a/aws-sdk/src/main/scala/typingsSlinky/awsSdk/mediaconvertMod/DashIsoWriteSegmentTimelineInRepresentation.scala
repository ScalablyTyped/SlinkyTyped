...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait DashIsoWriteSegmentTimelineInRepresentation extends js.Object
...
object DashIsoWriteSegmentTimelineInRepresentation {
  ...
  @scala.inline
  implicit def apply(value: String): DashIsoWriteSegmentTimelineInRepresentation = value.asInstanceOf[DashIsoWriteSegmentTimelineInRepresentation]
}
