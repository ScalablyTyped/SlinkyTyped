...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
trait H264SpatialAdaptiveQuantization extends js.Object
...
object H264SpatialAdaptiveQuantization {
  ...
  @scala.inline
  implicit def apply(value: String): H264SpatialAdaptiveQuantization = value.asInstanceOf[H264SpatialAdaptiveQuantization]
}
