...
trait CreateApplicationResponse extends js.Object {
  /**
    ...
    */
  var ApplicationSummary: typingsSlinky.awsSdk.kinesisanalyticsMod.ApplicationSummary = js.native
}
...
object CreateApplicationResponse {
  ...
  implicit class CreateApplicationResponseOps[Self <: CreateApplicationResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApplicationSummary(value: ApplicationSummary): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ApplicationSummary")(value.asInstanceOf[js.Any])
        ret
    }
  }
