...
trait MappingParameters extends js.Object {
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.CSVMappingParameters] = js.native
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.JSONMappingParameters] = js.native
}
