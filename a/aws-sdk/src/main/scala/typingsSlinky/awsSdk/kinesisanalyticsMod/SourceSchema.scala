...
trait SourceSchema extends StObject {
  ...
  /**
    ...
    */
  var RecordColumns: typingsSlinky.awsSdk.kinesisanalyticsMod.RecordColumns = js.native
  
  /**
    * Specifies the encoding of the records in the streaming source. For example, UTF-8.
    */
  var RecordEncoding: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.RecordEncoding] = js.native
  
  /**
    * Specifies the format of the records on the streaming source.
    */
  var RecordFormat: typingsSlinky.awsSdk.kinesisanalyticsMod.RecordFormat = js.native
}
object SourceSchema {
