...
trait UpdateApplicationRequest extends js.Object {
  ...
  /**
    ...
    */
  var ApplicationUpdate: typingsSlinky.awsSdk.kinesisanalyticsMod.ApplicationUpdate = js.native
  /**
...
object UpdateApplicationRequest {
  ...
  implicit class UpdateApplicationRequestOps[Self <: UpdateApplicationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApplicationUpdate(value: ApplicationUpdate): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ApplicationUpdate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
