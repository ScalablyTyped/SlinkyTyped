...
trait RecordFormat extends js.Object {
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.MappingParameters] = js.native
  /**
    * The type of record format.
    */
  var RecordFormatType: typingsSlinky.awsSdk.kinesisanalyticsMod.RecordFormatType = js.native
}
