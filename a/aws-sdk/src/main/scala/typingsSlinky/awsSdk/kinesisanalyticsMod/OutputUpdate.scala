...
trait OutputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.KinesisFirehoseOutputUpdate] = js.native
  /**
    * Describes an Amazon Kinesis stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.KinesisStreamsOutputUpdate] = js.native
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsSlinky.awsSdk.kinesisanalyticsMod.LambdaOutputUpdate] = js.native
  /**
