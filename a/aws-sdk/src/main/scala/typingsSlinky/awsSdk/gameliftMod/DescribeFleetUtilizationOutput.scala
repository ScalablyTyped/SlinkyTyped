...
object DescribeFleetUtilizationOutput {
  ...
  implicit class DescribeFleetUtilizationOutputOps[Self <: DescribeFleetUtilizationOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFleetUtilization(value: FleetUtilizationList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FleetUtilization")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutFleetUtilization: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FleetUtilization")(js.undefined)
        ret
    }
    @scala.inline
