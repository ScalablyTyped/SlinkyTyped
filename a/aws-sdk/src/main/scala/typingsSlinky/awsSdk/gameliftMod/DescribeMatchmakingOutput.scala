...
object DescribeMatchmakingOutput {
  ...
  implicit class DescribeMatchmakingOutputOps[Self <: DescribeMatchmakingOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTicketList(value: MatchmakingTicketList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TicketList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTicketList: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TicketList")(js.undefined)
        ret
    }
  }
