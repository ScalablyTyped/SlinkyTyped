...
object DescribeEC2InstanceLimitsOutput {
  ...
  implicit class DescribeEC2InstanceLimitsOutputOps[Self <: DescribeEC2InstanceLimitsOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEC2InstanceLimits(value: EC2InstanceLimitList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EC2InstanceLimits")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutEC2InstanceLimits: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EC2InstanceLimits")(js.undefined)
        ret
    }
  }
