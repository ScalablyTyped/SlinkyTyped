...
object GameServer {
  ...
  implicit class GameServerMutableBuilder[Self <: GameServer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastClaimTime(value: js.Date): Self = StObject.set(x, "LastClaimTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastClaimTimeUndefined: Self = StObject.set(x, "LastClaimTime", js.undefined)
    
    @scala.inline
    def setLastHealthCheckTime(value: js.Date): Self = StObject.set(x, "LastHealthCheckTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastHealthCheckTimeUndefined: Self = StObject.set(x, "LastHealthCheckTime", js.undefined)
    
    @scala.inline
    def setRegistrationTime(value: js.Date): Self = StObject.set(x, "RegistrationTime", value.asInstanceOf[js.Any])
