...
object TopicsDetectionJobProperties {
  ...
  implicit class TopicsDetectionJobPropertiesOps[Self <: TopicsDetectionJobProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNumberOfTopics(value: Integer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NumberOfTopics")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutNumberOfTopics: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NumberOfTopics")(js.undefined)
        ret
    }
    @scala.inline
