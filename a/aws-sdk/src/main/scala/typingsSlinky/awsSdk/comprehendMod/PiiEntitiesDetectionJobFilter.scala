...
@js.native
trait PiiEntitiesDetectionJobFilter extends StObject {
...
object PiiEntitiesDetectionJobFilter {
  ...
  @scala.inline
  def apply(): PiiEntitiesDetectionJobFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PiiEntitiesDetectionJobFilter]
  }
  
  @scala.inline
  implicit class PiiEntitiesDetectionJobFilterMutableBuilder[Self <: PiiEntitiesDetectionJobFilter] (val x: Self) extends AnyVal {
