...
object ListPiiEntitiesDetectionJobsRequest {
  ...
  @scala.inline
  implicit class ListPiiEntitiesDetectionJobsRequestOps[Self <: ListPiiEntitiesDetectionJobsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilter(value: PiiEntitiesDetectionJobFilter): Self = this.set("Filter", value.asInstanceOf[js.Any])
