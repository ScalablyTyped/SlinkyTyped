...
object marketplacecommerceanalyticsMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.marketplacecommerceanalyticsMod.apiVersion] = js.native
  }
  ...
  */
  ...
  object GenerateDataSetRequest {
    ...
    implicit class GenerateDataSetRequestMutableBuilder[Self <: GenerateDataSetRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDataSetPublicationDate(value: js.Date): Self = StObject.set(x, "dataSetPublicationDate", value.asInstanceOf[js.Any])
