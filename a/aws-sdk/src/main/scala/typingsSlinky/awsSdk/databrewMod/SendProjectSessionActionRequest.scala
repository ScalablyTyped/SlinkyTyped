...
trait SendProjectSessionActionRequest extends StObject {
  ...
  /**
    ...
    */
  var Preview: js.UndefOr[typingsSlinky.awsSdk.databrewMod.Preview] = js.native
  
  var RecipeStep: js.UndefOr[typingsSlinky.awsSdk.databrewMod.RecipeStep] = js.native
  
  /**
    * The index from which to preview a step. This index is used to preview the result of steps that have already been applied, so that the resulting view frame is from earlier in the view frame stack.
    */
  var StepIndex: js.UndefOr[typingsSlinky.awsSdk.databrewMod.StepIndex] = js.native
  
  var ViewFrame: js.UndefOr[typingsSlinky.awsSdk.databrewMod.ViewFrame] = js.native
}
