...
trait ViewFrame extends js.Object {
  ...
  /**
    ...
    */
  var ColumnRange: js.UndefOr[typingsSlinky.awsSdk.databrewMod.ColumnRange] = js.native
  ...
  /**
    ...
    */
  var StartColumnIndex: typingsSlinky.awsSdk.databrewMod.StartColumnIndex = js.native
}
object ViewFrame {
