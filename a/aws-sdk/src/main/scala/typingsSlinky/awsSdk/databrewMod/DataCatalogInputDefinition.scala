...
trait DataCatalogInputDefinition extends js.Object {
  ...
  /**
    ...
    */
  var CatalogId: js.UndefOr[typingsSlinky.awsSdk.databrewMod.CatalogId] = js.native
  
  /**
    * The name of a database in the Data Catalog.
    */
  var DatabaseName: typingsSlinky.awsSdk.databrewMod.DatabaseName = js.native
  
  /**
    * The name of a database table in the Data Catalog. This table corresponds to a DataBrew dataset.
    */
  var TableName: typingsSlinky.awsSdk.databrewMod.TableName = js.native
