...
trait Condition extends js.Object {
  /**
    ...
    */
  var HttpErrorCodeReturnedEquals: js.UndefOr[typingsSlinky.awsSdk.s3Mod.HttpErrorCodeReturnedEquals] = js.native
  /**
    * The object key name prefix when the redirect is applied. For example, to redirect requests for ExamplePage.html, the key prefix will be ExamplePage.html. To redirect request for all pages with the prefix docs/, the key prefix will be /docs, which identifies all objects in the docs/ folder. Required when the parent element Condition is specified and sibling HttpErrorCodeReturnedEquals is not specified. If both conditions are specified, both must be true for the redirect to be applied.
    */
  var KeyPrefixEquals: js.UndefOr[typingsSlinky.awsSdk.s3Mod.KeyPrefixEquals] = js.native
}
...
object Condition {
  ...
  implicit class ConditionOps[Self <: Condition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHttpErrorCodeReturnedEquals(value: HttpErrorCodeReturnedEquals): Self = {
    ...
    @scala.inline
    def withKeyPrefixEquals(value: KeyPrefixEquals): Self = {
        val ret = this.duplicate
