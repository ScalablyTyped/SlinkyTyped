...
object UploadPartCopyRequest {
  ...
  implicit class UploadPartCopyRequestOps[Self <: UploadPartCopyRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopySourceIfModifiedSince(value: js.Date): Self = this.set("CopySourceIfModifiedSince", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCopySourceIfUnmodifiedSince(value: js.Date): Self = this.set("CopySourceIfUnmodifiedSince", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setCopySourceSSECustomerKeyUint8Array(value: js.typedarray.Uint8Array): Self = this.set("CopySourceSSECustomerKey", value.asInstanceOf[js.Any])
    @scala.inline
