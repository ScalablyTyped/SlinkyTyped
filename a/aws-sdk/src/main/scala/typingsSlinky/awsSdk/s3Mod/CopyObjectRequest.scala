...
trait CopyObjectRequest extends js.Object {
  ...
  /**
    ...
    */
  var MetadataDirective: js.UndefOr[typingsSlinky.awsSdk.s3Mod.MetadataDirective] = js.native
  /**
  ...
  /**
    ...
    */
  var TaggingDirective: js.UndefOr[typingsSlinky.awsSdk.s3Mod.TaggingDirective] = js.native
  /**
...
object CopyObjectRequest {
  ...
  implicit class CopyObjectRequestOps[Self <: CopyObjectRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMetadataDirective(value: MetadataDirective): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTaggingDirective(value: TaggingDirective): Self = {
        val ret = this.duplicate
