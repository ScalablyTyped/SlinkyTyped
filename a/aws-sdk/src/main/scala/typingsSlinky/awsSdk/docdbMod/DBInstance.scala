...
object DBInstance {
  ...
  implicit class DBInstanceOps[Self <: DBInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstanceCreateTime(value: js.Date): Self = this.set("InstanceCreateTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLatestRestorableTime(value: js.Date): Self = this.set("LatestRestorableTime", value.asInstanceOf[js.Any])
    @scala.inline
