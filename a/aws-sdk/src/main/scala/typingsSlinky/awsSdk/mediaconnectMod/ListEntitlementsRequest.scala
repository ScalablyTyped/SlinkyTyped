...
@js.native
trait ListEntitlementsRequest extends StObject {
...
object ListEntitlementsRequest {
  ...
  @scala.inline
  implicit class ListEntitlementsRequestMutableBuilder[Self <: ListEntitlementsRequest] (val x: Self) extends AnyVal {
