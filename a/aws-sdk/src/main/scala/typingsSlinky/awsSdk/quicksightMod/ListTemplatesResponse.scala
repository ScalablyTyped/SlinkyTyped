...
object ListTemplatesResponse {
  ...
  implicit class ListTemplatesResponseOps[Self <: ListTemplatesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTemplateSummaryList(value: TemplateSummaryList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TemplateSummaryList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutTemplateSummaryList: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TemplateSummaryList")(js.undefined)
        ret
    }
  }
