...
object ListThemeAliasesRequest {
  ...
  @scala.inline
  def apply(AwsAccountId: AwsAccountId, ThemeId: RestrictiveResourceId): ListThemeAliasesRequest = {
  ...
  @scala.inline
  implicit class ListThemeAliasesRequestMutableBuilder[Self <: ListThemeAliasesRequest] (val x: Self) extends AnyVal {
