...
object ListIAMPolicyAssignmentsForUserResponse {
  ...
  implicit class ListIAMPolicyAssignmentsForUserResponseOps[Self <: ListIAMPolicyAssignmentsForUserResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveAssignments(value: ActiveIAMPolicyAssignmentList): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ActiveAssignments")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutActiveAssignments: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ActiveAssignments")(js.undefined)
        ret
    }
    @scala.inline
