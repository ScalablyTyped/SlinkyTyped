...
object workmailmessageflowMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsSlinky.awsSdk.workmailmessageflowMod.apiVersion] = js.native
  }
  ...
  object GetRawMessageContentResponse {
    ...
    implicit class GetRawMessageContentResponseMutableBuilder[Self <: GetRawMessageContentResponse] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMessageContentUint8Array(value: js.typedarray.Uint8Array): Self = StObject.set(x, "messageContent", value.asInstanceOf[js.Any])
    }
  }
