...
trait RegionDescription extends js.Object {
  ...
  /**
    ...
    */
  var RegionName: js.UndefOr[typingsSlinky.awsSdk.directoryserviceMod.RegionName] = js.native
  
  /**
    * Specifies if the Region is the primary Region or an additional Region.
    */
  var RegionType: js.UndefOr[typingsSlinky.awsSdk.directoryserviceMod.RegionType] = js.native
