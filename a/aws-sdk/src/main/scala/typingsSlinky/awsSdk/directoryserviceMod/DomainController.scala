...
object DomainController {
  ...
  implicit class DomainControllerMutableBuilder[Self <: DomainController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLaunchTime(value: js.Date): Self = StObject.set(x, "LaunchTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStatusLastUpdatedDateTime(value: js.Date): Self = StObject.set(x, "StatusLastUpdatedDateTime", value.asInstanceOf[js.Any])
