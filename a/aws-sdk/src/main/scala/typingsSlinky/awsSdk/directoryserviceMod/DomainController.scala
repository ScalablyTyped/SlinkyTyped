...
object DomainController {
  ...
  implicit class DomainControllerOps[Self <: DomainController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLaunchTime(value: js.Date): Self = this.set("LaunchTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStatusLastUpdatedDateTime(value: js.Date): Self = this.set("StatusLastUpdatedDateTime", value.asInstanceOf[js.Any])
    @scala.inline
