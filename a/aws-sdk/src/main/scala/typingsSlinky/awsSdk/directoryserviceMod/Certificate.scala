...
object Certificate {
  ...
  implicit class CertificateMutableBuilder[Self <: Certificate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpiryDateTime(value: js.Date): Self = StObject.set(x, "ExpiryDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpiryDateTimeUndefined: Self = StObject.set(x, "ExpiryDateTime", js.undefined)
    
    @scala.inline
    def setRegisteredDateTime(value: js.Date): Self = StObject.set(x, "RegisteredDateTime", value.asInstanceOf[js.Any])
