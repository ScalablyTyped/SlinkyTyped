...
object DetectorModelDefinition {
  ...
  implicit class DetectorModelDefinitionOps[Self <: DetectorModelDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInitialStateName(value: StateName): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initialStateName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStates(value: States): Self = {
        val ret = this.duplicate
