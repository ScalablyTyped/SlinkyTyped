...
trait RenewDomainRequest extends js.Object {
  /**
    ...
    */
  var CurrentExpiryYear: typingsSlinky.awsSdk.route53domainsMod.CurrentExpiryYear = js.native
  /**
  ...
  /**
    ...
    */
  var DurationInYears: js.UndefOr[typingsSlinky.awsSdk.route53domainsMod.DurationInYears] = js.native
}
