...
package object route53domainsMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.CA_LEGAL_REPRESENTATIVE
    - typingsSlinky.awsSdk.awsSdkStrings.CA_LEGAL_REPRESENTATIVE_CAPACITY
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.IT_NATIONALITY
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsSlinky.awsSdk.awsSdkStrings.INTERNAL_TRANSFER_OUT_DOMAIN
    - typingsSlinky.awsSdk.awsSdkStrings.INTERNAL_TRANSFER_IN_DOMAIN
    - java.lang.String
  */
