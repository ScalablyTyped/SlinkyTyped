...
object ImportTask {
  ...
  implicit class ImportTaskMutableBuilder[Self <: ImportTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImportCompletionTime(value: js.Date): Self = StObject.set(x, "importCompletionTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setImportCompletionTimeUndefined: Self = StObject.set(x, "importCompletionTime", js.undefined)
    
    @scala.inline
    def setImportDeletedTime(value: js.Date): Self = StObject.set(x, "importDeletedTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setImportDeletedTimeUndefined: Self = StObject.set(x, "importDeletedTime", js.undefined)
    
    @scala.inline
    def setImportRequestTime(value: js.Date): Self = StObject.set(x, "importRequestTime", value.asInstanceOf[js.Any])
