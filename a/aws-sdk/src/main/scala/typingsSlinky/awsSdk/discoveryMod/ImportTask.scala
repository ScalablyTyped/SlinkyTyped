...
object ImportTask {
  ...
  implicit class ImportTaskOps[Self <: ImportTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImportCompletionTime(value: js.Date): Self = this.set("importCompletionTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteImportCompletionTime: Self = this.set("importCompletionTime", js.undefined)
    @scala.inline
    def setImportDeletedTime(value: js.Date): Self = this.set("importDeletedTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteImportDeletedTime: Self = this.set("importDeletedTime", js.undefined)
    @scala.inline
    def setImportRequestTime(value: js.Date): Self = this.set("importRequestTime", value.asInstanceOf[js.Any])
    @scala.inline
