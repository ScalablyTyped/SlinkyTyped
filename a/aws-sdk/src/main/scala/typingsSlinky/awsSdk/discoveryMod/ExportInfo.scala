...
object ExportInfo {
  ...
  implicit class ExportInfoMutableBuilder[Self <: ExportInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExportRequestTime(value: js.Date): Self = StObject.set(x, "exportRequestTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestedEndTime(value: js.Date): Self = StObject.set(x, "requestedEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequestedEndTimeUndefined: Self = StObject.set(x, "requestedEndTime", js.undefined)
    
    @scala.inline
    def setRequestedStartTime(value: js.Date): Self = StObject.set(x, "requestedStartTime", value.asInstanceOf[js.Any])
