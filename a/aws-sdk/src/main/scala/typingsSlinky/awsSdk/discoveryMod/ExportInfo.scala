...
object ExportInfo {
  ...
  implicit class ExportInfoOps[Self <: ExportInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExportRequestTime(value: js.Date): Self = this.set("exportRequestTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequestedEndTime(value: js.Date): Self = this.set("requestedEndTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRequestedEndTime: Self = this.set("requestedEndTime", js.undefined)
    
    @scala.inline
    def setRequestedStartTime(value: js.Date): Self = this.set("requestedStartTime", value.asInstanceOf[js.Any])
