...
object DescribeAgentsResponse {
  ...
  implicit class DescribeAgentsResponseOps[Self <: DescribeAgentsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAgentsInfo(value: AgentsInfo): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("agentsInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAgentsInfo: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("agentsInfo")(js.undefined)
        ret
    }
    @scala.inline
