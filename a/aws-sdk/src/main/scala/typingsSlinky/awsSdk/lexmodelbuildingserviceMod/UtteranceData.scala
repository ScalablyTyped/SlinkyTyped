...
object UtteranceData {
  ...
  implicit class UtteranceDataOps[Self <: UtteranceData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstUtteredDate(value: js.Date): Self = this.set("firstUtteredDate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFirstUtteredDate: Self = this.set("firstUtteredDate", js.undefined)
    @scala.inline
    def setLastUtteredDate(value: js.Date): Self = this.set("lastUtteredDate", value.asInstanceOf[js.Any])
    @scala.inline
