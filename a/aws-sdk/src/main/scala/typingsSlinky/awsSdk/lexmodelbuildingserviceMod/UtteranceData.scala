...
object UtteranceData {
  ...
  implicit class UtteranceDataMutableBuilder[Self <: UtteranceData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFirstUtteredDate(value: js.Date): Self = StObject.set(x, "firstUtteredDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFirstUtteredDateUndefined: Self = StObject.set(x, "firstUtteredDate", js.undefined)
    
    @scala.inline
    def setLastUtteredDate(value: js.Date): Self = StObject.set(x, "lastUtteredDate", value.asInstanceOf[js.Any])
