...
import typingsSlinky.awsSdk.mod.Request
...
object mod {
  ...
  object AmazonDaxClientOptions {
    ...
    implicit class AmazonDaxClientOptionsMutableBuilder[Self <: AmazonDaxClientOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApiVersion(value: String | js.Date): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setApiVersionDate(value: js.Date): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
