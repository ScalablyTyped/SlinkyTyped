...
trait AmazonDaxClientOptions extends js.Object {
  ...
  var apiVersion: js.UndefOr[String | js.Date] = js.native
...
object AmazonDaxClientOptions {
  ...
  implicit class AmazonDaxClientOptionsOps[Self <: AmazonDaxClientOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersionDate(value: js.Date): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setApiVersion(value: String | js.Date): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
