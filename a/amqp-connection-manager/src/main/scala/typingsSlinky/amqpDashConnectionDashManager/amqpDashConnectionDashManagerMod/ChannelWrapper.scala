...
import typingsSlinky.amqpDashConnectionDashManager.Anon_Name
import typingsSlinky.amqpDashConnectionDashManager.amqpDashConnectionDashManagerStrings.close
import typingsSlinky.amqpDashConnectionDashManager.amqpDashConnectionDashManagerStrings.error
...
trait ChannelWrapper extends EventEmitter {
  ...
  def addListener_connect(
    event: typingsSlinky.amqpDashConnectionDashManager.amqpDashConnectionDashManagerStrings.connect,
    listener: js.Function0[Unit]
  ): this.type = js.native
  @JSName("addListener")
  def addListener_error(event: error, listener: js.Function2[/* err */ js.Error, /* info */ Anon_Name, Unit]): this.type = js.native
  /**
  ...
  @JSName("on")
  def on_error(event: error, listener: js.Function2[/* err */ js.Error, /* info */ Anon_Name, Unit]): this.type = js.native
  @JSName("once")
  ...
  @JSName("once")
  def once_error(event: error, listener: js.Function2[/* err */ js.Error, /* info */ Anon_Name, Unit]): this.type = js.native
  ...
  @JSName("prependListener")
  def prependListener_error(event: error, listener: js.Function2[/* err */ js.Error, /* info */ Anon_Name, Unit]): this.type = js.native
  ...
  @JSName("prependOnceListener")
  def prependOnceListener_error(event: error, listener: js.Function2[/* err */ js.Error, /* info */ Anon_Name, Unit]): this.type = js.native
  /**
  	 * @see amqplib
  	 * @param exchange
  	 * @param routingKey
