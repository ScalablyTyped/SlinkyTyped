...
object anon {
  ...
  trait Connection extends StObject {
    ...
    var connection: typingsSlinky.amqplib.mod.Connection = js.native
  ...
  object Connection {
    ...
    implicit class ConnectionMutableBuilder[Self <: Connection] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConnection(value: typingsSlinky.amqplib.mod.Connection): Self = StObject.set(x, "connection", value.asInstanceOf[js.Any])
