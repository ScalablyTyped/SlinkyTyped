...
import typingsSlinky.anydbDashSql.Anon_LOWER
...
trait AnydbSql extends DatabaseConnection {
  ...
  def transaction[T](fn: js.Function1[/* tx */ Transaction, typingsSlinky.bluebird.bluebirdMod.^[T]]): typingsSlinky.bluebird.bluebirdMod.^[T] = js.native
}
