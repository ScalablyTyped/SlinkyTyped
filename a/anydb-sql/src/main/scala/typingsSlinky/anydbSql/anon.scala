...
object anon {
  ...
  object LOWER {
    ...
    implicit class LOWERMutableBuilder[Self <: LOWER] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLOWER(value: typingsSlinky.anydbSql.mod.Column[String] => typingsSlinky.anydbSql.mod.Column[String]): Self = StObject.set(x, "LOWER", js.Any.fromFunction1(value))
    }
  }
  ...
  object RTRIM {
    ...
    implicit class RTRIMMutableBuilder[Self <: RTRIM] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRTRIM(value: typingsSlinky.anydbSql.mod.Column[String] => typingsSlinky.anydbSql.mod.Column[String]): Self = StObject.set(x, "RTRIM", js.Any.fromFunction1(value))
    }
  }
