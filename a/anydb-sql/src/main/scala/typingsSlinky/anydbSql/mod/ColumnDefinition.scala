...
trait ColumnDefinition extends StObject {
  ...
  var references: js.UndefOr[typingsSlinky.anydbSql.anon.Column] = js.native
...
object ColumnDefinition {
  ...
  implicit class ColumnDefinitionMutableBuilder[Self <: ColumnDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReferences(value: typingsSlinky.anydbSql.anon.Column): Self = StObject.set(x, "references", value.asInstanceOf[js.Any])
