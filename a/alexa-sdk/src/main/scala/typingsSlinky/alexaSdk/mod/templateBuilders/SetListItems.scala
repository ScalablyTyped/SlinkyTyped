...
object SetListItems {
  @scala.inline
  def apply[/* <: typingsSlinky.alexaSdk.mod.templateBuilders.TemplateBuilder[T] */ T](setListItems: js.Array[ListItem] => T): SetListItems[T] = {
    val __obj = js.Dynamic.literal(setListItems = js.Any.fromFunction1(setListItems))
    __obj.asInstanceOf[SetListItems[T]]
  }
  @scala.inline
  implicit class SetListItemsOps[Self <: SetListItems[_], /* <: typingsSlinky.alexaSdk.mod.templateBuilders.TemplateBuilder[T] */ T] (val x: Self with SetListItems[T]) extends AnyVal {
    @scala.inline
