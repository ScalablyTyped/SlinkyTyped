...
object RequestBody {
  @scala.inline
  def apply[/* <: typingsSlinky.alexaSdk.mod.Request */ T](context: RequestContext, request: T, session: Session, version: String): RequestBody[T] = {
  ...
  @scala.inline
  implicit class RequestBodyOps[Self <: RequestBody[_], /* <: typingsSlinky.alexaSdk.mod.Request */ T] (val x: Self with RequestBody[T]) extends AnyVal {
    @scala.inline
