...
object AlexaObject {
  @scala.inline
  def apply[/* <: typingsSlinky.alexaSdk.mod.Request */ T](
    _callback: js.Any,
    _context: js.Any,
    _event: js.Any,
    appId: js.Any,
  ...
  @scala.inline
  implicit class AlexaObjectOps[Self <: AlexaObject[_], /* <: typingsSlinky.alexaSdk.mod.Request */ T] (val x: Self with AlexaObject[T]) extends AnyVal {
    @scala.inline
