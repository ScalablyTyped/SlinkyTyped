...
import typingsSlinky.alexaDashSdk.Anon_Subtitle
...
class ResponseBuilder protected () extends js.Object {
  def this(alexaHandler: Handler[Request]) = this()
  /**
  ...
  def playVideo(source: String, metadata: Anon_Subtitle): ResponseBuilder = js.native
  /**
