...
object mod {
  ...
  class AbstractChainedBatchCls[K, V] protected ()
    extends typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[K, V] {
  ...
  trait AbstractIterator[K, V] extends AbstractOptions {
    ...
    var db: typingsSlinky.abstractLeveldown.mod.AbstractLevelDOWN[K, V] = js.native
  ...
  object AbstractIterator {
    ...
    implicit class AbstractIteratorMutableBuilder[Self <: AbstractIterator[_, _], K, V] (val x: Self with (AbstractIterator[K, V])) extends AnyVal {
      ...
      @scala.inline
      def setDb(value: typingsSlinky.abstractLeveldown.mod.AbstractLevelDOWN[K, V]): Self = StObject.set(x, "db", value.asInstanceOf[js.Any])
  ...
  trait AbstractLevelDOWN[K, V] extends AbstractOptions {
    ...
    def batch(): typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
    def batch(array: js.Array[AbstractBatch[K, V]], cb: ErrorCallback): typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
    def batch(array: js.Array[AbstractBatch[K, V]], options: AbstractOptions, cb: ErrorCallback): typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
  ...
  class AbstractLevelDOWNCls[K, V] protected ()
    extends typingsSlinky.abstractLeveldown.mod.AbstractLevelDOWN[K, V] {
    // tslint:disable-next-line no-unnecessary-generics
  ...
  */
  ...
  object AbstractBatch {
    ...
    @scala.inline
    def DelBatch[K, V](key: K, `type`: del): typingsSlinky.abstractLeveldown.mod.DelBatch[K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.abstractLeveldown.mod.DelBatch[K, V]]
    }
    
    @scala.inline
    def PutBatch[K, V](key: K, `type`: put, value: V): typingsSlinky.abstractLeveldown.mod.PutBatch[K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.abstractLeveldown.mod.PutBatch[K, V]]
    }
  }
  ...
  Instantiable1[
          /* db */ js.Any, 
          typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[js.Object, js.Object]
        ] {
    
    // tslint:disable-next-line no-unnecessary-generics
    def apply[K, V](db: js.Any): typingsSlinky.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
  }
  ...
  Instantiable1[
          /* location */ String, 
          typingsSlinky.abstractLeveldown.mod.AbstractLevelDOWN[js.Object, js.Object]
        ] {
    
    // tslint:disable-next-line no-unnecessary-generics
    def apply[K, V](location: String): typingsSlinky.abstractLeveldown.mod.AbstractLevelDOWN[K, V] = js.native
  }
