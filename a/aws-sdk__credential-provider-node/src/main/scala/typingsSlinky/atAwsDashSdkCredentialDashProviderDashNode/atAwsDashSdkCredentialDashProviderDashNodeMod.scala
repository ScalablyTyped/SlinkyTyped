...
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashIni.atAwsDashSdkCredentialDashProviderDashIniMod.FromIniInit
import typingsSlinky.atAwsDashSdkCredentialDashProviderDashNode.atAwsDashSdkCredentialDashProviderDashNodeStrings.AWS_EC2_METADATA_DISABLED
