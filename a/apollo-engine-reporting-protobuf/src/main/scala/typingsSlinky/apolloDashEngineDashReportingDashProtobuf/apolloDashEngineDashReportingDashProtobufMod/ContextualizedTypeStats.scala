...
import typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.IContextualizedTypeStats
...
class ContextualizedTypeStats ()
  extends typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats {
...
object ContextualizedTypeStats extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def create(properties: IContextualizedTypeStats): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decodeDelimited(reader: Uint8Array): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedTypeStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def toObject(
    message: typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats
