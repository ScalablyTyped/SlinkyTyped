...
import typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.IContextualizedQueryLatencyStats
...
class ContextualizedQueryLatencyStats ()
  extends typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats {
...
object ContextualizedQueryLatencyStats extends js.Object {
  /**
    ...
    */
  def create(): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  def create(properties: IContextualizedQueryLatencyStats): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  def decodeDelimited(reader: Uint8Array): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedQueryLatencyStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def toObject(
    message: typingsSlinky.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedQueryLatencyStats
