...
import typingsSlinky.apolloEngineReportingProtobuf.protobufMod.IContextualizedQueryLatencyStats
...
object ContextualizedQueryLatencyStats extends js.Object {
  ...
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  ...
  def decode(reader: Uint8Array): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
  ...
  def decodeDelimited(reader: Uint8Array): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    */
  def toObject(message: typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats): StringDictionary[js.Any] = js.native
  def toObject(
