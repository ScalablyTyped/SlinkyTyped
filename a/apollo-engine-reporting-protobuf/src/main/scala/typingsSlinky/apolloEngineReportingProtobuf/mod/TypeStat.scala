...
import typingsSlinky.apolloEngineReportingProtobuf.protobufMod.ITypeStat
...
object TypeStat extends js.Object {
  ...
  /**
    ...
    */
  def decode(reader: Reader): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat = js.native
  def decode(reader: Reader, length: Double): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat = js.native
  def decode(reader: Uint8Array): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat = js.native
  def decode(reader: Uint8Array, length: Double): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat = js.native
  /**
  ...
  def decodeDelimited(reader: Uint8Array): typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat = js.native
  /**
  ...
  /**
    ...
    */
  def toObject(message: typingsSlinky.apolloEngineReportingProtobuf.protobufMod.TypeStat): StringDictionary[js.Any] = js.native
  def toObject(
