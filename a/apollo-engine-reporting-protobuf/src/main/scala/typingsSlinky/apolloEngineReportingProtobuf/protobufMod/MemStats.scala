...
object MemStats extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): MemStats = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): MemStats = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): MemStats = js.native
  /**
