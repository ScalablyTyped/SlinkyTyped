...
trait IDetails extends js.Object {
  ...
  var deprecatedVariables: js.UndefOr[StringDictionary[js.typedarray.Uint8Array] | Null] = js.undefined
...
object IDetails {
  @scala.inline
  def apply(
    deprecatedVariables: js.UndefOr[Null | StringDictionary[js.typedarray.Uint8Array]] = js.undefined,
