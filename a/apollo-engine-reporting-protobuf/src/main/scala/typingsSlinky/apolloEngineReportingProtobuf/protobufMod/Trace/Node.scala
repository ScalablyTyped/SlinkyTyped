...
import typingsSlinky.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.index
import typingsSlinky.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.responseName
