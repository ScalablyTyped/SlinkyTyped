...
object StatsReport extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): StatsReport = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): StatsReport = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): StatsReport = js.native
  /**
