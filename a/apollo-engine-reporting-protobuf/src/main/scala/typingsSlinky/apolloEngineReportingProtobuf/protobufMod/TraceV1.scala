...
object TraceV1 extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): TraceV1 = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): TraceV1 = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): TraceV1 = js.native
  /**
