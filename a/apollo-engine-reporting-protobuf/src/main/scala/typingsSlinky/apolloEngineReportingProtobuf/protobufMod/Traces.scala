...
object Traces extends js.Object {
  ...
  def decode(reader: js.typedarray.Uint8Array): Traces = js.native
  def decode(reader: js.typedarray.Uint8Array, length: Double): Traces = js.native
  /**
  ...
  def decodeDelimited(reader: js.typedarray.Uint8Array): Traces = js.native
  /**
