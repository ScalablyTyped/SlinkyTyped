...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.antvScale.antvScaleStrings.base
    - typingsSlinky.antvScale.antvScaleStrings.linear
    - typingsSlinky.antvScale.antvScaleStrings.cat
    - typingsSlinky.antvScale.antvScaleStrings.log
    - typingsSlinky.antvScale.antvScaleStrings.pow
    - typingsSlinky.antvScale.antvScaleStrings.identity
    - typingsSlinky.antvScale.antvScaleStrings.time
    - typingsSlinky.antvScale.antvScaleStrings.timeCat
  */
  trait ScaleType extends StObject
  object ScaleType {
    
    @scala.inline
    def base: typingsSlinky.antvScale.antvScaleStrings.base = "base".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.base]
    
    @scala.inline
    def cat: typingsSlinky.antvScale.antvScaleStrings.cat = "cat".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.cat]
    
    @scala.inline
    def identity: typingsSlinky.antvScale.antvScaleStrings.identity = "identity".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.identity]
    
    @scala.inline
    def linear: typingsSlinky.antvScale.antvScaleStrings.linear = "linear".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.linear]
    
    @scala.inline
    def log: typingsSlinky.antvScale.antvScaleStrings.log = "log".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.log]
    
    @scala.inline
    def pow: typingsSlinky.antvScale.antvScaleStrings.pow = "pow".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.pow]
    
    @scala.inline
    def time: typingsSlinky.antvScale.antvScaleStrings.time = "time".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.time]
    
    @scala.inline
    def timeCat: typingsSlinky.antvScale.antvScaleStrings.timeCat = "timeCat".asInstanceOf[typingsSlinky.antvScale.antvScaleStrings.timeCat]
  }
