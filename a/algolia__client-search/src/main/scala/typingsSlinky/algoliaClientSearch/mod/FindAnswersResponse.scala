...
import typingsSlinky.algoliaClientSearch.anon.Answer
import typingsSlinky.algoliaClientSearch.anon.Avg
import typingsSlinky.algoliaClientSearch.anon.Match
...
@js.native
trait FindAnswersResponse[TObject] extends js.Object {
...
object FindAnswersResponse {
  ...
  @scala.inline
  implicit class FindAnswersResponseOps[Self <: FindAnswersResponse[_], TObject] (val x: Self with FindAnswersResponse[TObject]) extends AnyVal {
    ...
    @scala.inline
    def setHits(value: js.Array[Hit[TObject]] with (js.Array[Hit[TObject with Answer]])): Self = this.set("hits", value.asInstanceOf[js.Any])
