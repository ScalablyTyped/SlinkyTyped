...
import typingsSlinky.algoliaClientSearch.mod.SearchSynonymsResponse
...
object ReadonlyPromiseSearchSyno {
  ...
  @scala.inline
  implicit class ReadonlyPromiseSearchSynoOps[Self <: ReadonlyPromiseSearchSyno] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[SearchSynonymsResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    @scala.inline
    def setFinally(value: () => js.Promise[SearchSynonymsResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
    @scala.inline
