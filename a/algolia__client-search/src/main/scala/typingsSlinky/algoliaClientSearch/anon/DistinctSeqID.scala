...
import typingsSlinky.algoliaClientSearch.mod.HighlightResult
import typingsSlinky.algoliaClientSearch.mod.RankingInfo
import typingsSlinky.algoliaClientSearch.mod.SnippetResult
