...
object ReadonlyPromiseSearchResp {
  ...
  @scala.inline
  implicit class ReadonlyPromiseSearchRespOps[Self <: ReadonlyPromiseSearchResp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[SearchResponse[Rule] | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[SearchResponse[Rule]]): Self = this.set("finally", js.Any.fromFunction0(value))
