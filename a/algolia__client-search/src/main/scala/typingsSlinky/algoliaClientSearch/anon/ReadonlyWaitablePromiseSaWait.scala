...
import typingsSlinky.algoliaClientSearch.mod.SaveSynonymResponse
...
object ReadonlyWaitablePromiseSaWait {
  ...
  implicit class ReadonlyWaitablePromiseSaWaitOps[Self <: ReadonlyWaitablePromiseSaWait] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[SaveSynonymResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    @scala.inline
    def setFinally(value: () => js.Promise[SaveSynonymResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
    @scala.inline
