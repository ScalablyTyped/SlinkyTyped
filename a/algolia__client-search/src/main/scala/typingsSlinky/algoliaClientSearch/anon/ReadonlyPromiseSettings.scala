...
object ReadonlyPromiseSettings {
  ...
  @scala.inline
  implicit class ReadonlyPromiseSettingsOps[Self <: ReadonlyPromiseSettings] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[Settings | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    @scala.inline
    def setFinally(value: () => js.Promise[Settings]): Self = this.set("finally", js.Any.fromFunction0(value))
    @scala.inline
