...
import typingsSlinky.algoliaClientSearch.mod.BatchActionType
import typingsSlinky.algoliaClientSearch.mod.ScopeType
import typingsSlinky.algoliaClientSearch.mod.StrategyType
import typingsSlinky.algoliaClientSearch.mod.SynonymType
...
object algoliaClientSearchStrings {
  ...
  @js.native
  sealed trait exactPhrase extends StObject
  @scala.inline
  def exactPhrase: exactPhrase = "exactPhrase".asInstanceOf[exactPhrase]
  
  @js.native
  sealed trait excludeWords extends StObject
  @scala.inline
