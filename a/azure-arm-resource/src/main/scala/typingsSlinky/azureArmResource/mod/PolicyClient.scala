...
object PolicyClient {
  ...
  class default protected ()
    extends typingsSlinky.azureArmResource.policyClientMod.default {
    /**
  ...
  class PolicyClient protected ()
    extends typingsSlinky.azureArmResource.policyClientMod.PolicyClient {
    /**
      * Initializes a new instance of the PolicyClient class.
      * @constructor
      *
  ...
  object PolicyModels {
    ...
    @js.native
    class BaseResource ()
      extends typingsSlinky.azureArmResource.policyClientMod.PolicyModels.BaseResource
    
    @JSImport("azure-arm-resource", "PolicyClient.PolicyModels.CloudError")
    @js.native
    class CloudError protected ()
      extends typingsSlinky.azureArmResource.policyClientMod.PolicyModels.CloudError {
