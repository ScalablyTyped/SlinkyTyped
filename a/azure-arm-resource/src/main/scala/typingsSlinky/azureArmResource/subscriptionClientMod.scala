...
import typingsSlinky.azureArmResource.subscriptionOperationsMod.Operations
import typingsSlinky.azureArmResource.subscriptionOperationsMod.Subscriptions
import typingsSlinky.azureArmResource.subscriptionOperationsMod.Tenants
...
object subscriptionClientMod {
  ...
  object SubscriptionModels {
    ...
    @js.native
    class BaseResource ()
      extends typingsSlinky.azureArmResource.subscriptionModelsMod.BaseResource
