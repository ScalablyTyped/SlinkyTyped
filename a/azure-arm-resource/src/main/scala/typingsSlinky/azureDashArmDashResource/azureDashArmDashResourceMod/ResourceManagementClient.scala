...
import typingsSlinky.msDashRestDashAzure.msDashRestDashAzureMod.AzureServiceClientOptions
...
object ResourceManagementClient extends js.Object {
  ...
  class ResourceManagementClient protected ()
    extends typingsSlinky.azureDashArmDashResource.libResourceResourceManagementClientMod.ResourceManagementClient {
    /**
  ...
  class default protected ()
    extends typingsSlinky.azureDashArmDashResource.libResourceResourceManagementClientMod.default {
    /**
      * Initializes a new instance of the ResourceManagementClient class.
      * @constructor
      *
  ...
  object ResourceManagementModels extends js.Object {
    ...
    class CloudError protected ()
      extends typingsSlinky.azureDashArmDashResource.libResourceResourceManagementClientMod.ResourceManagementModels.CloudError {
