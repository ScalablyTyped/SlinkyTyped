...
import typingsSlinky.azureDashArmDashResource.libFeatureModelsMod.FeatureOperationsListResult
import typingsSlinky.azureDashArmDashResource.libFeatureModelsMod.FeatureResult
