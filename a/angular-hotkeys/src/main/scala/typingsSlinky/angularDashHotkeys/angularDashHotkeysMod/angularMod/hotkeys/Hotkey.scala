...
import typingsSlinky.angularDashHotkeys.angularDashHotkeysStrings.INPUT
import typingsSlinky.angularDashHotkeys.angularDashHotkeysStrings.SELECT
import typingsSlinky.angularDashHotkeys.angularDashHotkeysStrings.TEXTAREA
...
object Hotkey {
  @scala.inline
  def apply(
    callback: (Event, typingsSlinky.angularDashHotkeys.angularDashHotkeysMod.angularMod.hotkeys.Hotkey) => Unit,
