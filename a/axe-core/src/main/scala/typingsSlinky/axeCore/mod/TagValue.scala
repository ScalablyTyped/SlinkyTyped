...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.axeCore.axeCoreStrings.wcag2a
  - typingsSlinky.axeCore.axeCoreStrings.wcag2aa
  - typingsSlinky.axeCore.axeCoreStrings.section508
  - typingsSlinky.axeCore.axeCoreStrings.`best-practice`
*/
