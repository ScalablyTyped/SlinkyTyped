...
package object mod {
  type CheckLocale = org.scalablytyped.runtime.StringDictionary[typingsSlinky.axeCore.AnonFail]
  type ElementContext = org.scalajs.dom.raw.Node | java.lang.String | typingsSlinky.axeCore.mod.ContextObject
  type RuleLocale = org.scalablytyped.runtime.StringDictionary[typingsSlinky.axeCore.AnonDescription]
