...
object PoolConfig {
  ...
  implicit class PoolConfigOps[Self <: PoolConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReset(value: (/* connection */ Connection, /* done */ js.Function1[/* error */ js.Error, Unit]) => Unit): Self = this.set("reset", js.Any.fromFunction2(value))
    @scala.inline
    def deleteReset: Self = this.set("reset", js.undefined)
    @scala.inline
    def setShouldDestroyConnection(value: /* error */ js.Error => Boolean): Self = this.set("shouldDestroyConnection", js.Any.fromFunction1(value))
    @scala.inline
