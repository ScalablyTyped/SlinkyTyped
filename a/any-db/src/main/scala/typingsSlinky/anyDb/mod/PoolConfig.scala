...
object PoolConfig {
  ...
  def apply(
    ...
    onConnect: (/* connection */ Connection, /* ready */ js.Function2[/* error */ js.Error, /* result */ Connection, Unit]) => Unit = null,
    reapInterval: js.UndefOr[Double] = js.undefined,
    refreshIdle: js.UndefOr[Boolean] = js.undefined,
    reset: (/* connection */ Connection, /* done */ js.Function1[/* error */ js.Error, Unit]) => Unit = null,
    shouldDestroyConnection: /* error */ js.Error => Boolean = null
  ): PoolConfig = {
