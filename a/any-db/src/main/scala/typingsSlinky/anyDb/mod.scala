...
object mod {
  ...
  @JSImport("any-db", "createConnection")
  @js.native
  def createConnection(opts: ConnectOpts, callback: js.Function2[/* error */ js.Error, /* connection */ Connection, Unit]): Connection = js.native
  @JSImport("any-db", "createConnection")
  @js.native
  def createConnection(url: String): Connection = js.native
  @JSImport("any-db", "createConnection")
  @js.native
  def createConnection(url: String, callback: js.Function2[/* error */ js.Error, /* connection */ Connection, Unit]): Connection = js.native
  ...
  object PoolConfig {
    ...
    implicit class PoolConfigMutableBuilder[Self <: PoolConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReset(value: (/* connection */ Connection, /* done */ js.Function1[/* error */ js.Error, Unit]) => Unit): Self = StObject.set(x, "reset", js.Any.fromFunction2(value))
      
      @scala.inline
      def setResetUndefined: Self = StObject.set(x, "reset", js.undefined)
      
      @scala.inline
      def setShouldDestroyConnection(value: /* error */ js.Error => Boolean): Self = StObject.set(x, "shouldDestroyConnection", js.Any.fromFunction1(value))
