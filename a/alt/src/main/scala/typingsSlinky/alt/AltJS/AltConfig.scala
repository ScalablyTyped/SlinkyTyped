...
object AltConfig {
  @scala.inline
  def apply(
    batchingFunction: /* callback */ js.Function1[/* repeated */ js.Any, _] => Unit = null,
    deserialize: /* deserializeFn */ js.Function1[/* serialData */ String, js.Object] => Unit = null,
    dispatcher: js.Any = null,
    serialize: /* serializeFn */ js.Function1[/* data */ js.Object, String] => Unit = null,
