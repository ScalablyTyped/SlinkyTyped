...
class Application protected () extends js.Object {
  ...
  val Explorers: typingsSlinky.activexDashOutlook.Outlook.Explorers = js.native
  ...
  val Inspectors: typingsSlinky.activexDashOutlook.Outlook.Inspectors = js.native
  ...
  var OutlookDotApplication_typekey: typingsSlinky.activexDashOutlook.Outlook.Application = js.native
  ...
  val Reminders: typingsSlinky.activexDashOutlook.Outlook.Reminders = js.native
  val Session: NameSpace = js.native
  val TimeZones: typingsSlinky.activexDashOutlook.Outlook.TimeZones = js.native
