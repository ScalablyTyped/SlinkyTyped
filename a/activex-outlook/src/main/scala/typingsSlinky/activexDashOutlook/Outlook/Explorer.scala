...
class Explorer protected () extends js.Object {
  val AccountSelector: typingsSlinky.activexDashOutlook.Outlook.AccountSelector = js.native
  val Application: typingsSlinky.activexDashOutlook.Outlook.Application = js.native
  val AttachmentSelection: typingsSlinky.activexDashOutlook.Outlook.AttachmentSelection = js.native
  ...
  val NavigationPane: typingsSlinky.activexDashOutlook.Outlook.NavigationPane = js.native
  var `Outlook.Explorer_typekey`: Explorer = js.native
  val Panes: typingsSlinky.activexDashOutlook.Outlook.Panes = js.native
  val Parent: js.Any = js.native
  val Selection: typingsSlinky.activexDashOutlook.Outlook.Selection = js.native
