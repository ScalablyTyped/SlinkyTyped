...
class CardView protected () extends js.Object {
  ...
  val AutoFormatRules: typingsSlinky.activexDashOutlook.Outlook.AutoFormatRules = js.native
  ...
  val ViewFields: typingsSlinky.activexDashOutlook.Outlook.ViewFields = js.native
