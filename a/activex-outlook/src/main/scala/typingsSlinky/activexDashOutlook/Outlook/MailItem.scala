...
class MailItem protected () extends js.Object {
  ...
  val Recipients: typingsSlinky.activexDashOutlook.Outlook.Recipients = js.native
  ...
  val ReplyRecipients: typingsSlinky.activexDashOutlook.Outlook.Recipients = js.native
