...
import typingsSlinky.activexDashStdole.stdole.StdPicture
...
class DoNotUseMeFolder protected () extends js.Object {
  ...
  val Folders: typingsSlinky.activexDashOutlook.Outlook.Folders = js.native
  val FullFolderPath: String = js.native
  var InAppFolderSyncObject: Boolean = js.native
  val IsSharePointFolder: Boolean = js.native
  val Items: typingsSlinky.activexDashOutlook.Outlook.Items = js.native
  ...
  val Store: typingsSlinky.activexDashOutlook.Outlook.Store = js.native
  val StoreID: String = js.native
  val UnReadItemCount: Double = js.native
  val UserDefinedProperties: typingsSlinky.activexDashOutlook.Outlook.UserDefinedProperties = js.native
  val UserPermissions: js.Any = js.native
  val Views: typingsSlinky.activexDashOutlook.Outlook.Views = js.native
