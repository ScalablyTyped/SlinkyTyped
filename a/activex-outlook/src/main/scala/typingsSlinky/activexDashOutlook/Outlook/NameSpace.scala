...
class NameSpace protected () extends js.Object {
  val Accounts: typingsSlinky.activexDashOutlook.Outlook.Accounts = js.native
  val AddressLists: typingsSlinky.activexDashOutlook.Outlook.AddressLists = js.native
  ...
  val Stores: typingsSlinky.activexDashOutlook.Outlook.Stores = js.native
  val SyncObjects: typingsSlinky.activexDashOutlook.Outlook.SyncObjects = js.native
