...
class PropertyAccessor protected ()
  extends typingsSlinky.activexOutlook.Outlook.PropertyAccessor {
  /* CompleteClass */
  ...
  override var OutlookDotPropertyAccessor_typekey: typingsSlinky.activexOutlook.Outlook.PropertyAccessor = js.native
  /* CompleteClass */
