...
class OlkOptionButton protected ()
  extends typingsSlinky.activexOutlook.Outlook.OlkOptionButton {
  /* CompleteClass */
  ...
  override var OutlookDotOlkOptionButton_typekey: typingsSlinky.activexOutlook.Outlook.OlkOptionButton = js.native
  /* CompleteClass */
