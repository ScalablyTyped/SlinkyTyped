...
class UserProperty protected ()
  extends typingsSlinky.activexOutlook.Outlook.UserProperty {
  /* CompleteClass */
  ...
  override var OutlookDotUserProperty_typekey: typingsSlinky.activexOutlook.Outlook.UserProperty = js.native
  /* CompleteClass */
