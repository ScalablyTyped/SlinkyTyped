...
class FormRegion protected ()
  extends typingsSlinky.activexOutlook.Outlook.FormRegion {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val Inspector: typingsSlinky.activexOutlook.Outlook.Inspector = js.native
  /* CompleteClass */
  ...
  override var OutlookDotFormRegion_typekey: typingsSlinky.activexOutlook.Outlook.FormRegion = js.native
  /* CompleteClass */
