...
class CalendarModule protected ()
  extends typingsSlinky.activexOutlook.Outlook.CalendarModule {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val NavigationGroups: typingsSlinky.activexOutlook.Outlook.NavigationGroups = js.native
  /* CompleteClass */
  override val NavigationModuleType: OlNavigationModuleType = js.native
  /* CompleteClass */
  @JSName("Outlook.CalendarModule_typekey")
  override var OutlookDotCalendarModule_typekey: typingsSlinky.activexOutlook.Outlook.CalendarModule = js.native
  /* CompleteClass */
