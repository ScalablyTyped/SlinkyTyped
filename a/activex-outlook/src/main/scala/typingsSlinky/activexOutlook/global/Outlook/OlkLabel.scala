...
class OlkLabel protected ()
  extends typingsSlinky.activexOutlook.Outlook.OlkLabel {
  /* CompleteClass */
  ...
  override var OutlookDotOlkLabel_typekey: typingsSlinky.activexOutlook.Outlook.OlkLabel = js.native
  /* CompleteClass */
  override var TextAlign: OlTextAlign = js.native
  /* CompleteClass */
  override var UseHeaderColor: Boolean = js.native
  /* CompleteClass */
