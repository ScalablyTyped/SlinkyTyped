...
object ContactsModule {
  ...
  implicit class ContactsModuleOps[Self <: ContactsModule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOutlookDotContactsModule_typekey(value: ContactsModule): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.ContactsModule_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
