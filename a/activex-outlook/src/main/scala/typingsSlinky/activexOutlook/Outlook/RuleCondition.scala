...
object RuleCondition {
  ...
  implicit class RuleConditionOps[Self <: RuleCondition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOutlookDotRuleCondition_typekey(value: RuleCondition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.RuleCondition_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
