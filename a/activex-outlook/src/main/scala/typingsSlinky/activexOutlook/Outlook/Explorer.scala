...
trait Explorer extends js.Object {
  val AccountSelector: typingsSlinky.activexOutlook.Outlook.AccountSelector
  val Application: typingsSlinky.activexOutlook.Outlook.Application
  val AttachmentSelection: typingsSlinky.activexOutlook.Outlook.AttachmentSelection
  val Caption: String
  ...
  var Height: Double
  var Left: Double
  val NavigationPane: typingsSlinky.activexOutlook.Outlook.NavigationPane
  @JSName("Outlook.Explorer_typekey")
  var OutlookDotExplorer_typekey: Explorer
  val Panes: typingsSlinky.activexOutlook.Outlook.Panes
  val Parent: js.Any
