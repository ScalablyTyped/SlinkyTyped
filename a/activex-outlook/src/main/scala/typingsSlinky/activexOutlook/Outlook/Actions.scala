...
object Actions {
  ...
  implicit class ActionsOps[Self <: Actions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Action): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Item")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOutlookDotActions_typekey(value: Actions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.Actions_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
