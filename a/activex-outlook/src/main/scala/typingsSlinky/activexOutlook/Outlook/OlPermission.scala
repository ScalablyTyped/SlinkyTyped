...
*/
trait OlPermission extends js.Object
object OlPermission {
  
  @scala.inline
  def olDoNotForward: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def olPermissionTemplate: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def olUnrestricted: `0` = 0.asInstanceOf[`0`]
}
