...
object Accounts {
  ...
  implicit class AccountsOps[Self <: Accounts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Account): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Item")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOutlookDotAccounts_typekey(value: Accounts): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.Accounts_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
