...
object Exceptions {
  ...
  implicit class ExceptionsOps[Self <: Exceptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItem(value: js.Any => Exception): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Item")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOutlookDotExceptions_typekey(value: Exceptions): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.Exceptions_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
