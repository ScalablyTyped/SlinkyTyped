...
*/
trait OlMailingAddress extends StObject
object OlMailingAddress {
  
  @scala.inline
  def olBusiness: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def olHome: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def olNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def olOther: `3` = 3.asInstanceOf[`3`]
}
