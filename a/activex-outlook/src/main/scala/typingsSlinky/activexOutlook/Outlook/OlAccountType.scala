...
object OlAccountType {
  ...
  @scala.inline
  def olExchange: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def olHttp: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def olImap: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def olOtherAccount: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def olPop3: `2` = 2.asInstanceOf[`2`]
}
