...
object SimpleItems {
  ...
  implicit class SimpleItemsOps[Self <: SimpleItems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOutlookDotSimpleItems_typekey(value: SimpleItems): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.SimpleItems_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
