...
object PropertyPages {
  ...
  implicit class PropertyPagesOps[Self <: PropertyPages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdd(value: (js.Any, String) => Unit): Self = {
    ...
    @scala.inline
    def withOutlookDotPropertyPages_typekey(value: PropertyPages): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Outlook.PropertyPages_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
