...
object OlFormRegistry {
  ...
  @scala.inline
  def olDefaultRegistry: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def olFolderRegistry: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def olOrganizationRegistry: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def olPersonalRegistry: `2` = 2.asInstanceOf[`2`]
}
