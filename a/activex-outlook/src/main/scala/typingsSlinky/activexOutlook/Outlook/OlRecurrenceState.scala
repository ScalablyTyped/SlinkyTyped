...
object OlRecurrenceState {
  @scala.inline
  def olApptException: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def olApptMaster: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def olApptNotRecurring: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def olApptOccurrence: `2` = 2.asInstanceOf[`2`]
}
