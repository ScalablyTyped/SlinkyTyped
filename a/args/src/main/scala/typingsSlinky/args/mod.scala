...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsSlinky.args.mod.args = js.native
  ...
  type _To = typingsSlinky.args.mod.args
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsSlinky.args.mod.args = ^
  
  @js.native
  trait args extends StObject {
    
    def command(name: String, description: String): typingsSlinky.args.mod.args = js.native
    def command(name: String, description: String, init: js.UndefOr[scala.Nothing], aliases: js.Array[String]): typingsSlinky.args.mod.args = js.native
    def command(
      name: String,
      description: String,
      init: js.Function3[
    ...
    ): typingsSlinky.args.mod.args = js.native
    def command(
      name: String,
      description: String,
      init: js.Function3[
    ...
    def example(usage: String, description: String): typingsSlinky.args.mod.args = js.native
    
    def examples(list: js.Array[Example]): typingsSlinky.args.mod.args = js.native
    
    def option(name: String, description: String): typingsSlinky.args.mod.args = js.native
    def option(
      name: String,
      description: String,
    ...
    def option(name: String, description: String, defaultValue: js.Any): typingsSlinky.args.mod.args = js.native
    def option(name: String, description: String, defaultValue: js.Any, init: OptionInitFunction): typingsSlinky.args.mod.args = js.native
    def option(name: js.Tuple2[String, String], description: String): typingsSlinky.args.mod.args = js.native
    def option(
    ...
    def option(name: js.Tuple2[String, String], description: String, defaultValue: js.Any): typingsSlinky.args.mod.args = js.native
    def option(
      name: js.Tuple2[String, String],
      description: String,
      defaultValue: js.Any,
    ...
    def options(list: js.Array[Option]): typingsSlinky.args.mod.args = js.native
