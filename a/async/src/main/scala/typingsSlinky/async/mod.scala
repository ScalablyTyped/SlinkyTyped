...
import typingsSlinky.async.anon.RetryOptionsaritynumberun
...
object mod {
  ...
  @js.native
  def constant(values: js.Any*): AsyncFunction[_, js.Error] = js.native
  ...
  @js.native
  def reflect[T, E](fn: AsyncFunction[T, E]): js.Function1[/* callback */ js.Function2[/* err */ Null, /* result */ Error[E, T], Unit], Unit] = js.native
  ...
  {[ K in keyof R ]: async.async.AsyncAutoTask<R[K], R, E>}
    */ typingsSlinky.async.asyncStrings.AsyncAutoTasks with TopLevel[R]
