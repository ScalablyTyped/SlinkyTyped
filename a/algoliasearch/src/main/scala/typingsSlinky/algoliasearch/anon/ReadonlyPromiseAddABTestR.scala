...
import typingsSlinky.algoliaClientAnalytics.mod.AddABTestResponse
...
object ReadonlyPromiseAddABTestR {
  ...
  @scala.inline
  implicit class ReadonlyPromiseAddABTestROps[Self <: ReadonlyPromiseAddABTestR] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[AddABTestResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[AddABTestResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
