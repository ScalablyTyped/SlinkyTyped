...
import typingsSlinky.algoliaClientSearch.mod.UpdateApiKeyResponse
...
@js.native
trait ReadonlyWaitablePromiseUp extends js.Object {
...
object ReadonlyWaitablePromiseUp {
  ...
  @scala.inline
  implicit class ReadonlyWaitablePromiseUpOps[Self <: ReadonlyWaitablePromiseUp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[UpdateApiKeyResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[UpdateApiKeyResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
