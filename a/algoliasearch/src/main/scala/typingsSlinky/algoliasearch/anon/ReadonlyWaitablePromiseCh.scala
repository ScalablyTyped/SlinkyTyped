...
import typingsSlinky.algoliaClientSearch.mod.ChunkedBatchResponse
...
object ReadonlyWaitablePromiseCh {
  ...
  @scala.inline
  implicit class ReadonlyWaitablePromiseChOps[Self <: ReadonlyWaitablePromiseCh] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[ChunkedBatchResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[ChunkedBatchResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
