...
import typingsSlinky.algoliaClientSearch.mod.BatchResponse
...
trait ReadonlyWaitablePromiseBa extends js.Object {
  def `catch`[TResult](): js.Promise[BatchResponse | TResult] = js.native
  def `finally`(): js.Promise[BatchResponse] = js.native
...
object ReadonlyWaitablePromiseBa {
  ...
  @scala.inline
  implicit class ReadonlyWaitablePromiseBaOps[Self <: ReadonlyWaitablePromiseBa] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[BatchResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    @scala.inline
    def setFinally(value: () => js.Promise[BatchResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
    @scala.inline
