...
trait LocalizedHitInterface extends js.Object {
  ...
  /**
    ...
    */
  var city: js.UndefOr[js.Array[String]] = js.native
  /**
  ...
  /**
    ...
    */
  var county: js.UndefOr[js.Array[String]] = js.native
  ...
  /**
    ...
    */
  var locale_names: js.Array[String] = js.native
...
object LocalizedHitInterface {
  ...
  @scala.inline
  implicit class LocalizedHitInterfaceOps[Self <: LocalizedHitInterface] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withLocale_names(value: js.Array[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCity(value: js.Array[String]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withCounty(value: js.Array[String]): Self = {
        val ret = this.duplicate
