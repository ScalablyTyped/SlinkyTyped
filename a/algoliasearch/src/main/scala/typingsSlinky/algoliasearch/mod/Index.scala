...
trait Index extends js.Object {
  ...
  def addApiKey(
    ...
    cb: js.Function2[/* err */ js.Error, /* res */ AddApiKeyTask, Unit]
  ): Unit = js.native
  /**
  ...
  /**
    * Add a list of objects
    */
  def addObject(`object`: js.Object, objectID: String, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
    * Add list of objects
    */
  ...
  def addObjects(
    ...
    cb: js.Function2[/* err */ js.Error, /* res */ MultiObjectTask, Unit]
  ): Unit = js.native
  /**
    * Save a rule object
    */
  ...
  def browse(
    ...
    cb: js.Function2[/* err */ js.Error, /* res */ BrowseResponse, Unit]
  ): Unit = js.native
  /**
  ...
  /**
    * Browse an index from a cursor
    */
  def browseFrom(cursor: String, cb: js.Function2[/* err */ js.Error, /* res */ BrowseResponse, Unit]): Unit = js.native
  /**
  ...
  /**
    * Clear an index content
    */
  def clearIndex(cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def clearRules(options: RuleOption, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * Clear all synonyms of an index
    */
  def clearSynonyms(options: SynonymOption, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * Deletes an index specific key
    */
  def deleteApiKey(key: String, cb: js.Function2[/* err */ js.Error, /* res */ DeleteApiKeyTask, Unit]): Unit = js.native
  /**
  ...
  /**
    * Delete objects that matches the query
    */
  def deleteBy(params: js.Object, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
    * Delete objects that matches the query
    */
  ...
  /**
    * Delete objects that matches the query
    */
  def deleteByQuery(query: String, params: js.Object, cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  /**
  ...
  /**
    * Delete a specific object
    */
  def deleteObject(objectID: String, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * Delete a list of objects
    */
  def deleteObjects(objectIDs: js.Array[String], cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * Gets the rights of an index specific key
    */
  def getApiKey(key: String, cb: js.Function2[/* err */ js.Error, /* res */ ApiKey, Unit]): Unit = js.native
  /**
  ...
  def getObject(
    ...
    cb: js.Function2[/* err */ js.Error, /* res */ js.Object, Unit]
  ): Unit = js.native
  /**
  ...
  /**
    * Get a specific rule
    */
  def getRule(identifier: String, cb: js.Function2[/* err */ js.Error, /* res */ Rule, Unit]): Unit = js.native
  /**
  ...
  /**
    * Get an index settings
    */
  def getSettings(cb: js.Function2[/* err */ js.Error, /* res */ IndexSettings, Unit]): Unit = js.native
  /**
    * Get a specific synonym
    */
  def getSynonym(identifier: String, cb: js.Function2[/* err */ js.Error, /* res */ Synonym, Unit]): Unit = js.native
  /**
    * Get a specific synonym
    */
  ...
  /**
    * List index user keys
    */
  def listApiKeys(cb: js.Function2[/* err */ js.Error, /* res */ js.Array[ApiKey], Unit]): Unit = js.native
  /**
  ...
  /**
    * Add or replace a specific object
    */
  def saveObject(`object`: js.Object, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * Add or replace several objects
    */
  def saveObjects(objects: js.Array[js.Object], cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
    * Save a rule object
    */
  ...
  /**
    * Save a rule object
    */
  def saveRule(rule: Rule, options: RuleOption, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
    * Save a synonym object
    */
  ...
  /**
    * Search in an index
    */
  def search[T](params: QueryParameters, cb: js.Function2[/* err */ js.Error, /* res */ Response[T], Unit]): Unit = js.native
  /**
    * Search in an index
    */
  def searchForFacetValues(options: Parameters): js.Promise[typingsSlinky.algoliasearch.mod.SearchForFacetValues.Response] = js.native
  /**
    * Search in an index
    */
  def searchForFacetValues(
    ...
    cb: js.Function2[
      /* err */ js.Error, 
      /* res */ typingsSlinky.algoliasearch.mod.SearchForFacetValues.Response, 
      Unit
    ]
  ): Unit = js.native
  /**
  ...
  /**
    * Search a rules
    */
  def searchRules(options: SearchRuleOptions, cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  /**
    * Search a synonyms
    */
  ...
  /**
    * Search a synonyms
    */
  def searchSynonyms(options: SearchSynonymOptions, cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  /**
  ...
  /**
    * Wait for an indexing task to be compete
    */
  def waitTask(taskID: Double, cb: js.Function2[/* err */ js.Error, /* res */ TaskStatus, Unit]): Unit = js.native
}
