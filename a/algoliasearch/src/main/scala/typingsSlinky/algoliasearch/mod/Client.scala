...
trait Client extends js.Object {
  ...
  /**
    * Perform multiple operations with one API call to reduce latency
    */
  def batch(action: js.Array[Action], cb: js.Function2[/* err */ js.Error, /* res */ BatchTask, Unit]): Unit = js.native
  /**
    * clear browser cache
    */
  ...
  def copyIndex(
    ...
    cb: js.Function2[/* err */ js.Error, /* res */ UpdateIndexTask, Unit]
  ): Unit = js.native
  /**
  ...
  /**
    * Delete a specific index
    */
  def deleteIndex(name: String, cb: js.Function2[/* err */ js.Error, /* res */ Task, Unit]): Unit = js.native
  /**
  ...
  /**
    * List all your indices along with their associated information (number of entries, disk size, etc.)
    */
  def listIndexes(cb: js.Function2[/* err */ js.Error, /* res */ js.Any, Unit]): Unit = js.native
  /**
  ...
  /**
    * Move index to a new one (and will overwrite the original one)
    */
  def moveIndex(from: String, to: String, cb: js.Function2[/* err */ js.Error, /* res */ UpdateIndexTask, Unit]): Unit = js.native
  /**
