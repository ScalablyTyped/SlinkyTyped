...
trait IndexSettings extends js.Object {
  ...
  {[ key in std.Partial<'nl' | 'de' | 'fi'> ]: std.Array<string>}
    */ typingsSlinky.algoliasearch.algoliasearchStrings.IndexSettings with js.Any
  ] = js.undefined
  /**
...
object IndexSettings {
  ...
  {[ key in std.Partial<'nl' | 'de' | 'fi'> ]: std.Array<string>}
    */ typingsSlinky.algoliasearch.algoliasearchStrings.IndexSettings with js.Any = null,
