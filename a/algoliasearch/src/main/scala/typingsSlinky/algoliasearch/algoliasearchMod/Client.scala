...
import typingsSlinky.algoliasearch.Anon_IndexName
import typingsSlinky.algoliasearch.Anon_IndexNameParams
import typingsSlinky.algoliasearch.Anon_Logs
...
trait Client extends js.Object {
  ...
  /**
    * Get 1000 last events
    */
  def getLogs(options: LogsOptions, cb: js.Function2[/* err */ js.Error, /* res */ Anon_Logs, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def searchForFacetValues(queries: js.Array[Anon_IndexNameParams]): js.Promise[
    js.Array[typingsSlinky.algoliasearch.algoliasearchMod.SearchForFacetValues.Response]
  ] = js.native
  /**
