...
import typingsSlinky.algoliasearch.Anon_Avg
...
trait Response[T] extends js.Object {
  ...
  /**
    ...
    */
  var facets_stats: js.UndefOr[StringDictionary[Anon_Avg]] = js.undefined
  /**
...
object Response {
  ...
  def apply[T](
    ...
    facets_stats: StringDictionary[Anon_Avg] = null,
    index: String = null,
