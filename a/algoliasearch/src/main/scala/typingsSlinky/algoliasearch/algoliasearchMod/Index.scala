...
import typingsSlinky.algoliasearch.Anon_ForwardToReplicas
import typingsSlinky.algoliasearch.Anon_Results
...
trait Index extends js.Object {
  ...
  /**
    * Search in an index
    */
  def searchForFacetValues(options: Parameters): js.Promise[typingsSlinky.algoliasearch.algoliasearchMod.SearchForFacetValues.Response] = js.native
  /**
    * Search in an index
    */
  def searchForFacetValues(
    ...
    cb: js.Function2[
      /* err */ js.Error, 
      /* res */ typingsSlinky.algoliasearch.algoliasearchMod.SearchForFacetValues.Response, 
      Unit
    ]
  ): Unit = js.native
  /**
