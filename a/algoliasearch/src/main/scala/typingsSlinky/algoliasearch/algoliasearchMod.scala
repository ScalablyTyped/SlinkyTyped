...
import typingsSlinky.algoliasearch.anon.WithoutCredentialsAnalyti
import typingsSlinky.algoliasearch.anon.WithoutCredentialsRecomme
...
@JSImport("algoliasearch/dist/algoliasearch", JSImport.Namespace)
@js.native
object algoliasearchMod extends js.Object {
  ...
  type InitAnalyticsOptions = Partial[ClientTransporterOptions] with WithoutCredentialsAnalyti
  type InitRecommendationOptions = Partial[ClientTransporterOptions] with WithoutCredentialsRecomme
