...
object AnimeAnimParams {
  ...
  implicit class AnimeAnimParamsOps[Self <: AnimeAnimParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetsHTMLElement(value: HTMLElement): Self = this.set("targets", value.asInstanceOf[js.Any])
    @scala.inline
    def setTargetsVarargs(value: AnimeTarget*): Self = this.set("targets", js.Array(value :_*))
    @scala.inline
    def setTargetsSVGElement(value: SVGElement): Self = this.set("targets", value.asInstanceOf[js.Any])
    @scala.inline
    def setTargetsNodeList(value: NodeList): Self = this.set("targets", value.asInstanceOf[js.Any])
    @scala.inline
