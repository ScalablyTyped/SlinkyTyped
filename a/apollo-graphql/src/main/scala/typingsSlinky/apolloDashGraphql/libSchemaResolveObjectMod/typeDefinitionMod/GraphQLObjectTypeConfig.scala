package typingsSlinky.apolloDashGraphql.libSchemaResolveObjectMod.typeDefinitionMod

import typingsSlinky.apolloDashGraphql.libSchemaResolveObjectMod.GraphQLObjectResolver
