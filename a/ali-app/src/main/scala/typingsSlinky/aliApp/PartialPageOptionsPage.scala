...
trait PartialPageOptionsPage extends js.Object {
  ...
  var onError: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.native
  var onHide: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.native
  var onLaunch: js.UndefOr[
    js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit]
  ] = js.native
  var onPullDownRefresh: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.native
  ...
  var selectAllComponents: js.UndefOr[js.Function1[/* selector */ String, js.Array[typingsSlinky.aliApp.my.Component]]] = js.native
  var selectComponent: js.UndefOr[js.Function1[/* selector */ String, typingsSlinky.aliApp.my.Component]] = js.native
...
object PartialPageOptionsPage {
  ...
  implicit class PartialPageOptionsPageOps[Self <: PartialPageOptionsPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnError(value: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnHide(value: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnLaunch(value: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnPullDownRefresh(value: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnShow(value: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelectAllComponents(value: /* selector */ String => js.Array[typingsSlinky.aliApp.my.Component]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelectComponent(value: /* selector */ String => typingsSlinky.aliApp.my.Component): Self = {
        val ret = this.duplicate
