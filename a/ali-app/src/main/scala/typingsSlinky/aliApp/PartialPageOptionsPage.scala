...
trait PartialPageOptionsPage extends js.Object {
  ...
  var onError: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.undefined
  var onHide: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.undefined
  var onLaunch: js.UndefOr[
    js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit]
  ] = js.undefined
  var onPullDownRefresh: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit]] = js.undefined
  ...
  var selectAllComponents: js.UndefOr[js.Function1[/* selector */ String, js.Array[typingsSlinky.aliApp.my.Component]]] = js.undefined
  var selectComponent: js.UndefOr[js.Function1[/* selector */ String, typingsSlinky.aliApp.my.Component]] = js.undefined
...
object PartialPageOptionsPage {
  ...
  def apply(
    ...
    id: String = null,
    is: String = null,
    onError: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit] = null,
    onHide: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit] = null,
    onLaunch: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit] = null,
    onPullDownRefresh: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.Page, Unit] = null,
    onShow: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.Page, /* options */ Options, Unit] = null,
    pageScrollTo: /* option */ js.UndefOr[PageScrollToOptions] => Unit = null,
    properties: js.Any = null,
    route: () => Unit = null,
    selectAllComponents: /* selector */ String => js.Array[typingsSlinky.aliApp.my.Component] = null,
    selectComponent: /* selector */ String => typingsSlinky.aliApp.my.Component = null,
