...
object ScanOptions {
  ...
  implicit class ScanOptionsOps[Self <: ScanOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHideAlbum(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideAlbum")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutHideAlbum: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hideAlbum")(js.undefined)
        ret
    }
    @scala.inline
    def withSuccess(value: /* res */ ScanCodeData => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withType(value: scanType): Self = {
        val ret = this.duplicate
