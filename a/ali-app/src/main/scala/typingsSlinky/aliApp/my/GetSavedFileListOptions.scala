...
import typingsSlinky.aliApp.AnonFileList
...
trait GetSavedFileListOptions
  ...
  @JSName("success")
  var success_GetSavedFileListOptions: js.UndefOr[js.Function1[/* res */ AnonFileList, Unit]] = js.native
}
...
object GetSavedFileListOptions {
  ...
  implicit class GetSavedFileListOptionsOps[Self <: GetSavedFileListOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonFileList => Unit): Self = {
