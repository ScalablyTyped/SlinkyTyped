...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.aliApp.aliAppStrings.input
  - typingsSlinky.aliApp.aliAppStrings.form
  - typingsSlinky.aliApp.aliAppStrings.submit
  - typingsSlinky.aliApp.aliAppStrings.scroll
  - typingsSlinky.aliApp.aliAppStrings.tap
  - typingsSlinky.aliApp.aliAppStrings.longpress
