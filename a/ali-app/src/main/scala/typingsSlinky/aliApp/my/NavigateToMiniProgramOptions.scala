...
import typingsSlinky.aliApp.aliAppStrings.develop
import typingsSlinky.aliApp.aliAppStrings.release
import typingsSlinky.aliApp.aliAppStrings.trial
...
object NavigateToMiniProgramOptions {
  ...
  implicit class NavigateToMiniProgramOptionsOps[Self <: NavigateToMiniProgramOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnvVersion(value: develop | trial | release | String): Self = {
        val ret = this.duplicate
