...
import typingsSlinky.aliApp.aliAppStrings.ancestor
import typingsSlinky.aliApp.aliAppStrings.child
import typingsSlinky.aliApp.aliAppStrings.descendant
import typingsSlinky.aliApp.aliAppStrings.parent
...
object ComponentRelation {
  ...
  implicit class ComponentRelationOps[Self <: ComponentRelation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withType(value: parent | child | ancestor | descendant): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("type")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLinkChanged(value: /* target */ Component => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("linkChanged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutLinkChanged: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("linkChanged")(js.undefined)
        ret
    }
    @scala.inline
    def withLinked(value: /* target */ Component => Unit): Self = {
        val ret = this.duplicate
