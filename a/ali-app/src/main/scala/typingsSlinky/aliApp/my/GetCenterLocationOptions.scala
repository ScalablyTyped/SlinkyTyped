...
import typingsSlinky.aliApp.AnonLatitude
...
trait GetCenterLocationOptions
  ...
  @JSName("success")
  var success_GetCenterLocationOptions: js.UndefOr[js.Function1[/* res */ AnonLatitude, Unit]] = js.native
}
...
object GetCenterLocationOptions {
  ...
  implicit class GetCenterLocationOptionsOps[Self <: GetCenterLocationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSuccess(value: /* res */ AnonLatitude => Unit): Self = {
