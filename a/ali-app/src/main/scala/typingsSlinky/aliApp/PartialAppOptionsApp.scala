...
trait PartialAppOptionsApp extends js.Object {
  ...
  var getCurrentPage: js.UndefOr[js.Function0[typingsSlinky.aliApp.my.Page]] = js.undefined
  var globalData: js.UndefOr[js.Object] = js.undefined
  var onError: js.UndefOr[js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.App, /* msg */ String, Unit]] = js.undefined
  var onHide: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.App, Unit]] = js.undefined
  ...
  var onUnlaunch: js.UndefOr[js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.App, Unit]] = js.undefined
}
...
object PartialAppOptionsApp {
  ...
  def apply(
    data: js.Any = null,
    getCurrentPage: () => typingsSlinky.aliApp.my.Page = null,
    globalData: js.Object = null,
    onError: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.App, /* msg */ String, Unit] = null,
    onHide: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.App, Unit] = null,
    onLaunch: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.App, /* option */ LaunchOptions, Unit] = null,
    onShow: js.ThisFunction1[/* this */ typingsSlinky.aliApp.my.App, /* option */ LaunchOptions, Unit] = null,
    onUnlaunch: js.ThisFunction0[/* this */ typingsSlinky.aliApp.my.App, Unit] = null
