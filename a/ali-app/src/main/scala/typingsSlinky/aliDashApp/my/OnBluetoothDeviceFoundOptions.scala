...
import typingsSlinky.aliDashApp.Anon_Devices
...
trait OnBluetoothDeviceFoundOptions
  ...
  @JSName("success")
  var success_OnBluetoothDeviceFoundOptions: js.UndefOr[js.Function1[/* res */ Anon_Devices, Unit]] = js.undefined
}
...
object OnBluetoothDeviceFoundOptions {
  ...
  def apply(
    ...
    success: /* res */ Anon_Devices => Unit = null
