...
import typingsSlinky.aliDashApp.Anon_4000
import typingsSlinky.aliDashApp.aliDashAppStrings.TINYAPP
import typingsSlinky.aliDashApp.aliDashAppStrings.WINDOWS
import typingsSlinky.aliDashApp.aliDashAppStrings.alipay
import typingsSlinky.aliDashApp.aliDashAppStrings.merchant
...
trait ZMCreditBorrowOptions
  ...
  @JSName("success")
  var success_ZMCreditBorrowOptions: js.UndefOr[js.Function1[/* res */ Anon_4000, Unit]] = js.undefined
}
...
object ZMCreditBorrowOptions {
  ...
  def apply(
    ...
    success: /* res */ Anon_4000 => Unit = null
