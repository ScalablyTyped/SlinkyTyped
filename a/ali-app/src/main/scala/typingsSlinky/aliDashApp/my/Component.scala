...
import typingsSlinky.aliDashApp.Anon_Bubbles
...
trait Component extends js.Object {
  ...
  /**
  		 ...
  		 */
  def selectAllComponents(selector: String): js.Array[typingsSlinky.aliDashApp.my.Component] = js.native
  /**
  		 * 使用选择器选择组件实例节点
  		 * 返回匹配到的第一个组件实例对象
  		 */
  def selectComponent(selector: String): typingsSlinky.aliDashApp.my.Component = js.native
  /**
