...
import typingsSlinky.aliDashApp.Anon_Connected
...
trait OnBLEConnectionStateChangedOptions
  ...
  @JSName("success")
  var success_OnBLEConnectionStateChangedOptions: js.UndefOr[js.Function1[/* res */ Anon_Connected, Unit]] = js.undefined
}
...
object OnBLEConnectionStateChangedOptions {
  ...
  def apply(
    ...
    success: /* res */ Anon_Connected => Unit = null
