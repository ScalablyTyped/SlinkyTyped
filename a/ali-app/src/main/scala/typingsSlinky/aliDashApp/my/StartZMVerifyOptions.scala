...
import typingsSlinky.aliDashApp.Anon_Passed
...
trait StartZMVerifyOptions
  ...
  var bizNo: String
  	// 认证标识
  @JSName("success")
  var success_StartZMVerifyOptions: js.UndefOr[js.Function1[/* res */ Anon_Passed, Unit]] = js.undefined
}
...
object StartZMVerifyOptions {
  ...
  def apply(
    ...
    success: /* res */ Anon_Passed => Unit = null
