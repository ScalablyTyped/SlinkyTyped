...
import typingsSlinky.aliDashApp.aliDashAppStrings.ADDRESSBOOK
import typingsSlinky.aliDashApp.aliDashAppStrings.BACKGROUNDER
import typingsSlinky.aliDashApp.aliDashAppStrings.CAMERA
import typingsSlinky.aliDashApp.aliDashAppStrings.LBS
import typingsSlinky.aliDashApp.aliDashAppStrings.LBSSERVICE
import typingsSlinky.aliDashApp.aliDashAppStrings.MICROPHONE
import typingsSlinky.aliDashApp.aliDashAppStrings.NOTIFICATION
import typingsSlinky.aliDashApp.aliDashAppStrings.PHOTO
import typingsSlinky.aliDashApp.aliDashAppStrings.SELFSTARTING
import typingsSlinky.aliDashApp.aliDashAppStrings.SHORTCUT
