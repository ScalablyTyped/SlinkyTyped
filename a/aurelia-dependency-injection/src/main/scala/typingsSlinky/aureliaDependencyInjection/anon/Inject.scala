...
object Inject {
  @scala.inline
  def apply[/* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs, TBase](): Inject[TArgs, TBase] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Inject[TArgs, TBase]]
  }
  @scala.inline
  implicit class InjectOps[Self <: Inject[_, _], /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs, TBase] (val x: Self with (Inject[TArgs, TBase])) extends AnyVal {
    @scala.inline
