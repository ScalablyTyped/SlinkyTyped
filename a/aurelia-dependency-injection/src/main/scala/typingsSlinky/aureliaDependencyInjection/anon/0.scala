...
object `0` {
  @scala.inline
  def apply[TBase, /* <: typingsSlinky.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs](get: (Container, PrimitiveOrDependencyCtor[TBase, TImpl, TArgs]) => TImpl): `0`[TBase, TImpl, TArgs] = {
    val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get))
    __obj.asInstanceOf[`0`[TBase, TImpl, TArgs]]
  }
  @scala.inline
  implicit class `0Ops`[Self <: `0`[_, _, _], TBase, /* <: typingsSlinky.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs] (val x: Self with (`0`[TBase, TImpl, TArgs])) extends AnyVal {
    @scala.inline
