...
object Registration_ {
  @scala.inline
  def apply[TBase, /* <: typingsSlinky.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs](
  ...
  @scala.inline
  implicit class Registration_Ops[Self <: Registration_[_, _, _], TBase, /* <: typingsSlinky.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs] (val x: Self with (Registration_[TBase, TImpl, TArgs])) extends AnyVal {
    @scala.inline
