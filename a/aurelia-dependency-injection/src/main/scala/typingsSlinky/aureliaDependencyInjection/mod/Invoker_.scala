...
object Invoker_ {
  ...
  @scala.inline
  implicit class Invoker_Ops[Self <: Invoker_[_, _, _], TBase, /* <: typingsSlinky.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typingsSlinky.aureliaDependencyInjection.mod.Args[TBase] */ TArgs] (val x: Self with (Invoker_[TBase, TImpl, TArgs])) extends AnyVal {
    @scala.inline
