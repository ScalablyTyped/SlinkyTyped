...
object Strategy extends js.Object {
  ...
  /* 1 */ @js.native
  object singleton
    extends TopLevel[typingsSlinky.aureliaDependencyInjection.mod.Strategy.singleton with Double]
  
  @js.native
  sealed trait transient extends Strategy
  /* 2 */ @js.native
  object transient
    extends TopLevel[typingsSlinky.aureliaDependencyInjection.mod.Strategy.transient with Double]
}
