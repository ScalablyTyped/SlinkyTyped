...
@js.native
class StrategyResolver[TBase, TImpl /* <: Impl[TBase] */, TArgs /* <: Args[TBase] */, TStrategyKey /* <: /* keyof aurelia-dependency-injection.aurelia-dependency-injection.StrategyState<TBase, TImpl, TArgs> */ String */] protected () extends StObject {
  def this(
