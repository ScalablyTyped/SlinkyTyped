...
import typingsSlinky.amapJsApiCitySearch.AnonInfo
...
trait EventMap extends js.Object {
  ...
  var error: Event_[typingsSlinky.amapJsApiCitySearch.amapJsApiCitySearchStrings.error, AnonInfo] = js.native
}
