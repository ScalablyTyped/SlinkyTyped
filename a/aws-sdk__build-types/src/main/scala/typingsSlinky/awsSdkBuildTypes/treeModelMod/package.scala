...
package object treeModelMod {
  ...
  type NamedAndDocumented[T] = typingsSlinky.awsSdkBuildTypes.treeModelMod.Documented with typingsSlinky.awsSdkBuildTypes.treeModelMod.Named with T
  
  type NormalizedOperationMap = org.scalablytyped.runtime.StringDictionary[typingsSlinky.awsSdkBuildTypes.treeModelMod.NormalizedOperation]
