...
object AdditionalDocumentation {
  ...
  implicit class AdditionalDocumentationOps[Self <: AdditionalDocumentation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdditionalDocumentation(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("additionalDocumentation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutAdditionalDocumentation: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("additionalDocumentation")(js.undefined)
        ret
    }
  }
