...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: /* e */ js.UndefOr[SyntheticFocusEvent[HTMLDivElement]] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: /* e */ js.UndefOr[SyntheticFocusEvent[HTMLDivElement]] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
