...
object Telemetry extends js.Object {
  ...
  class Exception protected ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.Exception {
    /**
  ...
  class Metric protected ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.Metric {
    /**
  ...
  /**
    ...
    */
  class PageView ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.PageView {
    def this(name: String) = this()
  ...
  class PageViewPerformance protected ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.PageViewPerformance {
    /**
      * Constructs a new instance of the PageEventTelemetry object
      */
  ...
  class RemoteDependencyData protected ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.RemoteDependencyData {
    /**
  ...
  class Trace protected ()
    extends typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.Trace {
    /**
      * Constructs a new instance of the MetricTelemetry object
      */
  ...
  object Common extends js.Object {
    ...
    class Envelope protected ()
      ...
      /* CompleteClass */
      @JSName("data")
      override var data_Envelope: typingsSlinky.applicationinsightsJs.Microsoft.ApplicationInsights.Telemetry.Common.Base = js.native
      /* CompleteClass */
