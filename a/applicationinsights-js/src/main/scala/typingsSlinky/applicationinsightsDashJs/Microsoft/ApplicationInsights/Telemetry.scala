...
import typingsSlinky.applicationinsightsDashJs.AI.DataPoint
import typingsSlinky.applicationinsightsDashJs.AI.ExceptionDetails
import typingsSlinky.applicationinsightsDashJs.AI.MessageData
import typingsSlinky.applicationinsightsDashJs.AI.PageViewData
import typingsSlinky.applicationinsightsDashJs.AI.PageViewPerfData
import typingsSlinky.applicationinsightsDashJs.AI.SeverityLevel
import typingsSlinky.applicationinsightsDashJs.Anon_DomProcessing
import typingsSlinky.applicationinsightsDashJs.Anon_Duration
import typingsSlinky.applicationinsightsDashJs.Anon_Exceptions
...
object Telemetry extends js.Object {
  ...
  class RemoteDependencyData protected ()
    extends typingsSlinky.applicationinsightsDashJs.AI.RemoteDependencyData
       with ISerializable {
    /**
  ...
  object Common extends js.Object {
    @js.native
    class Base ()
      extends typingsSlinky.applicationinsightsDashJs.Microsoft.Telemetry.Base
         with ISerializable {
      /**
        * The set of fields for a serializeable object.
        * This defines the serialization order and a value of true/false
    ...
    class Data[TDomain] protected ()
      extends typingsSlinky.applicationinsightsDashJs.Microsoft.Telemetry.Data[TDomain]
         with ISerializable {
      /**
    ...
    class Envelope protected () extends IEnvelope {
      /**
        * Constructs a new instance of telemetry data.
        */
      def this(data: typingsSlinky.applicationinsightsDashJs.Microsoft.Telemetry.Base, name: String) = this()
      /**
        * The set of fields for a serializeable object.
        * This defines the serialization order and a value of true/false
        * for each field defines whether the field is required or not.
