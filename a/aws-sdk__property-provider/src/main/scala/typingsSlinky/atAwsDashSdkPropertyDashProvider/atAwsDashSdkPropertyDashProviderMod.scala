...
@js.native
object atAwsDashSdkPropertyDashProviderMod extends js.Object {
  @js.native
  class ProviderError protected ()
    extends typingsSlinky.atAwsDashSdkPropertyDashProvider.buildProviderErrorMod.ProviderError {
