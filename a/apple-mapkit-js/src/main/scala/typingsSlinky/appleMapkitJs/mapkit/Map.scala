...
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`double-tap`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`drag-end`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`drag-start`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`long-press`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`map-type-change`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`region-change-end`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`region-change-start`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`scroll-end`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`scroll-start`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`single-tap`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`user-location-change`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`user-location-error`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`zoom-end`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.`zoom-start`
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.deselect
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.dragging
import typingsSlinky.appleMapkitJs.appleMapkitJsStrings.select
...
trait Map extends js.Object {
  ...
  def addEventListener_deselect[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typingsSlinky.appleMapkitJs.anon.Annotation, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_dragging[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typingsSlinky.appleMapkitJs.anon.Coordinate, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
