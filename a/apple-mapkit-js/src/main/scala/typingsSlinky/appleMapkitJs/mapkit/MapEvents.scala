...
trait MapEvents[T] extends js.Object {
  var deselect: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Annotation
  ...
  var dragging: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Coordinate
  ...
  // Annotation Events
  var select: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Annotation
