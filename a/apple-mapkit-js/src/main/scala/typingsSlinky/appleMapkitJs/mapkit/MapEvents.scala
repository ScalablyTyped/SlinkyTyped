...
object MapEvents {
  ...
  implicit class MapEventsOps[Self <: MapEvents[_], T] (val x: Self with MapEvents[T]) extends AnyVal {
    ...
    @scala.inline
    def setDeselect(value: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Annotation): Self = this.set("deselect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDragging(value: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Coordinate): Self = this.set("dragging", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSelect(value: EventBase[T] with typingsSlinky.appleMapkitJs.anon.Annotation): Self = this.set("select", value.asInstanceOf[js.Any])
    @scala.inline
