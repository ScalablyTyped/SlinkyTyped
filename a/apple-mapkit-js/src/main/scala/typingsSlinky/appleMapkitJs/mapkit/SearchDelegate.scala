...
object SearchDelegate {
  ...
  implicit class SearchDelegateOps[Self <: SearchDelegate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAutocompleteDidError(value: /* error */ js.Error => Unit): Self = this.set("autocompleteDidError", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSearchDidError(value: /* error */ js.Error => Unit): Self = this.set("searchDidError", js.Any.fromFunction1(value))
