...
class Coordinate protected ()
  extends typingsSlinky.appleMapkitJs.mapkit.Coordinate {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(): typingsSlinky.appleMapkitJs.mapkit.Coordinate = js.native
  /**
    * Returns a Boolean value indicating whether two coordinates are equal.
    */
  /* CompleteClass */
  override def equals(anotherCoordinate: typingsSlinky.appleMapkitJs.mapkit.Coordinate): Boolean = js.native
  /**
    * Returns the map point that corresponds to the coordinate.
    */
  /* CompleteClass */
  override def toMapPoint(): typingsSlinky.appleMapkitJs.mapkit.MapPoint = js.native
  /**
    * Returns the unwrapped map point that corresponds to the coordinate.
    */
  /* CompleteClass */
  override def toUnwrappedMapPoint(): typingsSlinky.appleMapkitJs.mapkit.MapPoint = js.native
}
