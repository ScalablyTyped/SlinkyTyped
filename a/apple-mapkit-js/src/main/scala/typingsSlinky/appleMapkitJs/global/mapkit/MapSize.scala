...
class MapSize protected ()
  extends typingsSlinky.appleMapkitJs.mapkit.MapSize {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(): typingsSlinky.appleMapkitJs.mapkit.MapSize = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(anotherSize: typingsSlinky.appleMapkitJs.mapkit.MapSize): Boolean = js.native
}
