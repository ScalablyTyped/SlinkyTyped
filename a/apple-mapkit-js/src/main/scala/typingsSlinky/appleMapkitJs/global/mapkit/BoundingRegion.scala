...
class BoundingRegion protected ()
  extends typingsSlinky.appleMapkitJs.mapkit.BoundingRegion {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(): typingsSlinky.appleMapkitJs.mapkit.BoundingRegion = js.native
  /**
    * Returns the coordinate region that corresponds to the calling bounding region.
    */
  /* CompleteClass */
  override def toCoordinateRegion(): typingsSlinky.appleMapkitJs.mapkit.CoordinateRegion = js.native
}
