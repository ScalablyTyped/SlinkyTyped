...
class MapPoint protected ()
  extends typingsSlinky.appleMapkitJs.mapkit.MapPoint {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(): typingsSlinky.appleMapkitJs.mapkit.MapPoint = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(anotherPoint: typingsSlinky.appleMapkitJs.mapkit.MapPoint): Boolean = js.native
  /**
    * Returns a coordinate containing the latitude and longitude corresponding
    * to a map point.
    */
  /* CompleteClass */
  override def toCoordinate(): typingsSlinky.appleMapkitJs.mapkit.Coordinate = js.native
}
