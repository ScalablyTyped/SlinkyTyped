...
class MapRect protected ()
  extends typingsSlinky.appleMapkitJs.mapkit.MapRect {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var origin: typingsSlinky.appleMapkitJs.mapkit.MapPoint = js.native
  /**
    * The width and height of a rectangle, starting from the origin point.
    */
  /* CompleteClass */
  override var size: typingsSlinky.appleMapkitJs.mapkit.MapSize = js.native
  /**
    * Returns a copy of a map rectangle.
    */
  /* CompleteClass */
  override def copy(): typingsSlinky.appleMapkitJs.mapkit.MapRect = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def equals(anotherRect: typingsSlinky.appleMapkitJs.mapkit.MapRect): Boolean = js.native
  /**
    * @param scaleFactor The scale factor.
    * @param scaleCenter The center map point for scaling.
    */
  /* CompleteClass */
  override def scale(scaleFactor: Double, scaleCenter: typingsSlinky.appleMapkitJs.mapkit.MapPoint): typingsSlinky.appleMapkitJs.mapkit.MapRect = js.native
  /**
