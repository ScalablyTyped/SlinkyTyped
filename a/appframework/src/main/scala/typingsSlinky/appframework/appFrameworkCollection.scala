...
trait appFrameworkCollection extends js.Object {
  ...
  def off(eventName: String, fn: js.Function1[/* e */ typingsSlinky.std.Event, _]): appFrameworkCollection = js.native
  ...
  def on(eventName: String, fn: js.Function1[/* e */ typingsSlinky.std.Event, _]): appFrameworkCollection = js.native
