...
object anon {
  ...
  object DocBlocksRegExp {
    ...
    implicit class DocBlocksRegExpMutableBuilder[Self <: DocBlocksRegExp] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDocBlocksRegExp(value: js.RegExp): Self = StObject.set(x, "docBlocksRegExp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInlineRegExp(value: js.RegExp): Self = StObject.set(x, "inlineRegExp", value.asInstanceOf[js.Any])
    }
  }
