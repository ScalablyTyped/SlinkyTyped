...
trait Backend[T] extends js.Object {
  ...
  def cleanAsync(): typingsSlinky.bluebird.mod.^[Unit] = js.native
  def cleanAsync(cb: js.Function1[/* error */ js.UndefOr[js.Error], Unit]): typingsSlinky.bluebird.mod.^[Unit] = js.native
  ...
  def endAsync(transaction: T): typingsSlinky.bluebird.mod.^[Unit] = js.native
  def endAsync(transaction: T, cb: js.Function1[/* err */ js.Error | Null, Unit]): typingsSlinky.bluebird.mod.^[Unit] = js.native
  
  def get(bucket: String, key: Value): Unit = js.native
  def get(bucket: String, key: Value, cb: Action): Unit = js.native
  
  def getAsync(bucket: String, key: Value): typingsSlinky.bluebird.mod.^[_] = js.native
  def getAsync(bucket: String, key: Value, cb: js.Function2[/* err */ js.Error | Null, /* value */ js.Any, Unit]): typingsSlinky.bluebird.mod.^[_] = js.native
  ...
  def unionAsync(bucket: String, keys: js.Array[Value]): typingsSlinky.bluebird.mod.^[js.Array[_]] = js.native
  def unionAsync(
    bucket: String,
    keys: js.Array[Value],
    cb: js.Function2[/* error */ js.UndefOr[js.Error], /* results */ js.Array[_], Unit]
  ): typingsSlinky.bluebird.mod.^[js.Array[_]] = js.native
}
