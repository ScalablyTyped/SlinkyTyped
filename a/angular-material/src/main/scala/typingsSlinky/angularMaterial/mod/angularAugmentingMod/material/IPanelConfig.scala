...
object IPanelConfig {
  ...
  implicit class IPanelConfigMutableBuilder[Self <: IPanelConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttachToElement(value: Element): Self = StObject.set(x, "attachTo", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOriginElement(value: Element): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
