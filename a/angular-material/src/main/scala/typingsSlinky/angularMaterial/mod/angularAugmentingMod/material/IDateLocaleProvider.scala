...
object IDateLocaleProvider {
  ...
  implicit class IDateLocaleProviderOps[Self <: IDateLocaleProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatDate(value: js.Date => String): Self = this.set("formatDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMonthHeaderFormatter(value: js.Date => String): Self = this.set("monthHeaderFormatter", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParseDate(value: String => js.Date): Self = this.set("parseDate", js.Any.fromFunction1(value))
