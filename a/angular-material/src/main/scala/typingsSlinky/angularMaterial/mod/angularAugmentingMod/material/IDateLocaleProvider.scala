...
object IDateLocaleProvider {
  ...
  implicit class IDateLocaleProviderMutableBuilder[Self <: IDateLocaleProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatDate(value: js.Date => String): Self = StObject.set(x, "formatDate", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMonthHeaderFormatter(value: js.Date => String): Self = StObject.set(x, "monthHeaderFormatter", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParseDate(value: String => js.Date): Self = StObject.set(x, "parseDate", js.Any.fromFunction1(value))
