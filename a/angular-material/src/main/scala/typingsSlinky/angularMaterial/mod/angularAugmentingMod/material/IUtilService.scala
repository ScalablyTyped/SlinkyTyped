...
trait IUtilService extends js.Object {
  ...
  def debounce[T /* <: Function */](func: T, wait: js.UndefOr[scala.Nothing], scope: js.UndefOr[scala.Nothing], invokeApply: Boolean): T = js.native
  def debounce[T /* <: Function */](func: T, wait: js.UndefOr[scala.Nothing], scope: js.Any): T = js.native
  def debounce[T /* <: Function */](func: T, wait: js.UndefOr[scala.Nothing], scope: js.Any, invokeApply: Boolean): T = js.native
  def debounce[T /* <: Function */](func: T, wait: Double): T = js.native
  def debounce[T /* <: Function */](func: T, wait: Double, scope: js.UndefOr[scala.Nothing], invokeApply: Boolean): T = js.native
