...
@js.native
trait AnonALIGNEND extends js.Object {
...
object AnonALIGNEND {
  @scala.inline
  def apply(ALIGN_END: String, ALIGN_START: String, CENTER: String, OFFSET_END: String, OFFSET_START: String): AnonALIGNEND = {
    ...
    __obj.asInstanceOf[AnonALIGNEND]
  }
  @scala.inline
  implicit class AnonALIGNENDOps[Self <: AnonALIGNEND] (val x: Self) extends AnyVal {
    @scala.inline
