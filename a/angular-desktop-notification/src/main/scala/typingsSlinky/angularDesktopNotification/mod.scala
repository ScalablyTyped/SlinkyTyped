...
import typingsSlinky.angularDesktopNotification.anon.Default
  ...
  object angularAugmentingMod {
    ...
    object desktopNotification {
      ...
      trait IDesktopNotificationService extends StObject {
        ...
        def show(title: String, options: org.scalajs.dom.experimental.NotificationOptions): Unit = js.native
