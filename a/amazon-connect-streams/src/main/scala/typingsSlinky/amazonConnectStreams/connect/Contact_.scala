...
import typingsSlinky.amazonConnectStreams.AnonLabel
...
trait Contact_ extends js.Object {
  ...
  /**
    ...
    */
  def getAttributes(): StringDictionary[AnonLabel] = js.native
  /**
...
object Contact_ {
  ...
  def apply(
    ...
    getAttributes: () => StringDictionary[AnonLabel],
  ...
  implicit class Contact_Ops[Self <: Contact_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAttributes(value: () => StringDictionary[AnonLabel]): Self = {
        val ret = this.duplicate
