...
trait LogEntry extends StObject {
  ...
  /**
    ...
    */
  def withException(err: js.Error): LogEntry = js.native
...
object LogEntry {
  ...
  @scala.inline
  def apply(withException: js.Error => LogEntry, withObject: js.Object => LogEntry): LogEntry = {
  ...
  implicit class LogEntryMutableBuilder[Self <: LogEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWithException(value: js.Error => LogEntry): Self = StObject.set(x, "withException", js.Any.fromFunction1(value))
