...
package object connect {
  /**
    ...
    * signed-in agent.
    */
  type AgentCallback = js.Function1[/* agent */ typingsSlinky.amazonConnectStreams.connect.Agent_, scala.Unit]
  ...
  /**
    ...
    */
  type ContactCallback = js.Function1[/* contact */ typingsSlinky.amazonConnectStreams.connect.Contact_, scala.Unit]
  /**
    *
    * A callback to receive agent details
    *
    ...
    * signed-in agent.
    */
  type MuteCallback = js.Function1[/* muteState */ typingsSlinky.amazonConnectStreams.connect.MuteState, scala.Unit]
  /*
