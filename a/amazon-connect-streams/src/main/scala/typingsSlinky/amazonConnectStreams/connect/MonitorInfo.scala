...
trait MonitorInfo extends StObject {
  ...
  val joinTime: js.Date = js.native
}
object MonitorInfo {
  
  @scala.inline
  def apply(agentName: String, customerName: String, joinTime: js.Date): MonitorInfo = {
  ...
  implicit class MonitorInfoMutableBuilder[Self <: MonitorInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJoinTime(value: js.Date): Self = StObject.set(x, "joinTime", value.asInstanceOf[js.Any])
  }
}
