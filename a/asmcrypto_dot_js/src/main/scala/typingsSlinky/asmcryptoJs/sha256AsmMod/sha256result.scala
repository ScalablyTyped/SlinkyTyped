package typingsSlinky.asmcryptoJs.sha256AsmMod
...
object sha256result {
  ...
  @scala.inline
  implicit class sha256resultOps[Self <: sha256result] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    ): Self = this.set("hmac_init", js.Any.fromFunction16(value))
    @scala.inline
