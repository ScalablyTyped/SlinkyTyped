...
import typingsSlinky.asmcryptoJs.anon.CBC
import typingsSlinky.asmcryptoJs.anon.Dictkey
import typingsSlinky.asmcryptoJs.anon.GCM
import typingsSlinky.asmcryptoJs.asmcryptoJsNumbers.`16`
...
object aesAsmMod {
  ...
  class AESAsm protected () extends StObject {
    def this(foreign: js.Any, heap: js.typedarray.ArrayBuffer) = this()
