...
@js.native
class MockSubscriptionNetworkInterface protected () extends MockNetworkInterface {
...
@JSImport("apollo-react/lib/test-utils", "mockSubscriptionNetworkInterface")
@js.native
object mockSubscriptionNetworkInterface extends js.Object {
  def apply(mockedSubscriptions: js.Array[MockedSubscription], mockedResponses: MockedResponse*): MockSubscriptionNetworkInterface = js.native
}
