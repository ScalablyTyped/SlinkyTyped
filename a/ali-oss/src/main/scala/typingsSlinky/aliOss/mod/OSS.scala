...
import typingsSlinky.aliOss.anon.Acl
import typingsSlinky.aliOss.anon.AllowEmpty
import typingsSlinky.aliOss.anon.DataPutChannelConf
import typingsSlinky.aliOss.anon.Enable
import typingsSlinky.aliOss.anon.EndTime
import typingsSlinky.aliOss.anon.Error
import typingsSlinky.aliOss.anon.Etag
import typingsSlinky.aliOss.anon.Name
import typingsSlinky.aliOss.anon.ResRules
import typingsSlinky.aliOss.anon.Rules
import typingsSlinky.aliOss.anon.SourceBucketName
import typingsSlinky.aliOss.anon.Timeout
...
trait OSS extends js.Object {
  ...
  /**
    * Create a new bucket.
    */
  def putBucket(name: String): js.Promise[typingsSlinky.aliOss.anon.Bucket] = js.native
  def putBucket(name: String, options: PutBucketOptions): js.Promise[typingsSlinky.aliOss.anon.Bucket] = js.native
  // ACL operations
  /**
