...
import typingsSlinky.aliOss.AnonAcl
import typingsSlinky.aliOss.AnonAllowEmpty
import typingsSlinky.aliOss.AnonBucket
import typingsSlinky.aliOss.AnonDataPutChannelConf
import typingsSlinky.aliOss.AnonEnable
import typingsSlinky.aliOss.AnonEndTime
import typingsSlinky.aliOss.AnonError
import typingsSlinky.aliOss.AnonEtag
import typingsSlinky.aliOss.AnonName
import typingsSlinky.aliOss.AnonResRules
import typingsSlinky.aliOss.AnonRules
import typingsSlinky.aliOss.AnonSourceBucketName
import typingsSlinky.aliOss.AnonTimeout
