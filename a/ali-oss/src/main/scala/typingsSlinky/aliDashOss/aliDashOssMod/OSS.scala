...
import typingsSlinky.aliDashOss.Anon_Acl
import typingsSlinky.aliDashOss.Anon_AllowEmpty
import typingsSlinky.aliDashOss.Anon_Bucket
import typingsSlinky.aliDashOss.Anon_DataResNormalSuccessResponse
import typingsSlinky.aliDashOss.Anon_Enable
import typingsSlinky.aliDashOss.Anon_EndTime
import typingsSlinky.aliDashOss.Anon_Error
import typingsSlinky.aliDashOss.Anon_Etag
import typingsSlinky.aliDashOss.Anon_HeadersTimeout
import typingsSlinky.aliDashOss.Anon_Name
import typingsSlinky.aliDashOss.Anon_ResRules
import typingsSlinky.aliDashOss.Anon_ResRulesArray
import typingsSlinky.aliDashOss.Anon_SourceBucketName
...
trait OSS extends js.Object {
  ...
  /**
    ...
    */
  def completeMultipartUpload(name: String, uploadId: String, parts: js.Array[Anon_Etag]): js.Promise[CompleteMultipartUploadResult] = js.native
  def completeMultipartUpload(
    name: String,
    uploadId: String,
    parts: js.Array[Anon_Etag],
  ...
  /**
    ...
    */
  def createVod(id: String, name: String, time: Anon_EndTime): js.Promise[NormalSuccessResponse] = js.native
  def createVod(id: String, name: String, time: Anon_EndTime, options: RequestOptions): js.Promise[NormalSuccessResponse] = js.native
  /**
  ...
  /**
    ...
    */
  def getBucketACL(name: String): js.Promise[Anon_Acl] = js.native
  def getBucketACL(name: String, options: RequestOptions): js.Promise[Anon_Acl] = js.native
  /**
    * Get CORS rules of the bucket object.
    */
  def getBucketCORS(name: String): js.Promise[Anon_ResRulesArray] = js.native
  /**
  ...
  /**
    ...
    */
  def getBucketLifecycle(name: String): js.Promise[Anon_ResRules] = js.native
  def getBucketLifecycle(name: String, options: RequestOptions): js.Promise[Anon_ResRules] = js.native
  /**
    * Get bucket location
    */
  ...
  /**
    ...
    */
  def getBucketLogging(name: String): js.Promise[Anon_Enable] = js.native
  def getBucketLogging(name: String, options: RequestOptions): js.Promise[Anon_Enable] = js.native
  /**
    * Get the bucket request Referer white list.
    */
  def getBucketReferer(name: String): js.Promise[Anon_AllowEmpty] = js.native
  def getBucketReferer(name: String, options: RequestOptions): js.Promise[Anon_AllowEmpty] = js.native
  /**
    * Get the bucket website config.
    */
  def getBucketWebsite(name: String): js.Promise[Anon_Error] = js.native
  def getBucketWebsite(name: String, options: RequestOptions): js.Promise[Anon_Error] = js.native
  /**
    * Get live channel info.
    */
  def getChannel(id: String): js.Promise[Anon_DataResNormalSuccessResponse] = js.native
  def getChannel(id: String, options: RequestOptions): js.Promise[Anon_DataResNormalSuccessResponse] = js.native
  /**
  ...
  /**
    * Create a new bucket.
    */
  def putBucket(name: String): js.Promise[Anon_Bucket] = js.native
  def putBucket(name: String, options: PutBucketOptions): js.Promise[Anon_Bucket] = js.native
  // ACL operations
  /**
  ...
  /**
    ...
    */
  def putStream(name: String, stream: js.Any): js.Promise[Anon_Name] = js.native
  def putStream(name: String, stream: js.Any, options: PutStreamOptions): js.Promise[Anon_Name] = js.native
  /**
    * Restore Object.
    */
  ...
  def uploadPartCopy(
    ...
    partNo: Double,
    range: String,
    sourceData: Anon_SourceBucketName,
    options: Anon_HeadersTimeout
  ): js.Promise[UploadPartResult] = js.native
  /**
    * Use the bucket.
    */
