...
object Config {
  ...
  implicit class ConfigOps[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtensionsVarargs(value: js.Function0[typingsSlinky.graphqlExtensions.mod.GraphQLExtension[js.Any]]*): Self = this.set("extensions", js.Array(value :_*))
    @scala.inline
    def setExtensions(value: js.Array[js.Function0[typingsSlinky.graphqlExtensions.mod.GraphQLExtension[_]]]): Self = this.set("extensions", value.asInstanceOf[js.Any])
    @scala.inline
