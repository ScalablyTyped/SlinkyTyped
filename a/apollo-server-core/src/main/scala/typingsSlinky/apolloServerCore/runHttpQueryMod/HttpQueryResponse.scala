...
object HttpQueryResponse {
  ...
  implicit class HttpQueryResponseOps[Self <: HttpQueryResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGraphqlResponse(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("graphqlResponse")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResponseInit(value: ApolloServerHttpResponse): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("responseInit")(value.asInstanceOf[js.Any])
        ret
    }
  }
