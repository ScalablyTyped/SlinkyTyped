package typingsSlinky.apolloServerCore.pluginTestHarnessMod
...
import typingsSlinky.apolloServerTypes.mod.GraphQLRequestMetrics
...
/* Inlined apollo-server-types.apollo-server-types.GraphQLRequestContextExecutionDidStart<TContext> & {  request :apollo-server-core.apollo-server-core/dist/utils/pluginTestHarness.IPluginTestHarnessGraphqlRequest} */
@js.native
trait IPluginTestHarnessExecutionDidStart[TContext] extends js.Object {
  ...
  val request: GraphQLRequest with IPluginTestHarnessGraphqlRequest = js.native
...
object IPluginTestHarnessExecutionDidStart {
  ...
  def apply[TContext](
    ...
    request: GraphQLRequest with IPluginTestHarnessGraphqlRequest,
    schema: GraphQLSchema,
    schemaHash: SchemaHash,
    source: js.UndefOr[String] with String
  ): IPluginTestHarnessExecutionDidStart[TContext] = {
    ...
    __obj.asInstanceOf[IPluginTestHarnessExecutionDidStart[TContext]]
  }
  
  @scala.inline
  implicit class IPluginTestHarnessExecutionDidStartOps[Self <: IPluginTestHarnessExecutionDidStart[_], TContext] (val x: Self with IPluginTestHarnessExecutionDidStart[TContext]) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: GraphQLRequest with IPluginTestHarnessGraphqlRequest): Self = this.set("request", value.asInstanceOf[js.Any])
