package typingsSlinky.atAwsDashSdkSsecDashMiddleware

import typingsSlinky.atAwsDashSdkSsecDashMiddleware.atAwsDashSdkSsecDashMiddlewareMod.SsecMiddlewareConfiguration
import typingsSlinky.atAwsDashSdkSsecDashMiddleware.atAwsDashSdkSsecDashMiddlewareMod.SsecPropertiesConfiguration
...
object atAwsDashSdkSsecDashMiddlewareMod extends js.Object {
  ...
  {[ sourceProperty in keyof Input ]:? {  targetProperty  :string,   hashTargetProperty  :string}}
    */ typingsSlinky.atAwsDashSdkSsecDashMiddleware.atAwsDashSdkSsecDashMiddlewareStrings.SsecPropertiesConfiguration with js.Any
}
