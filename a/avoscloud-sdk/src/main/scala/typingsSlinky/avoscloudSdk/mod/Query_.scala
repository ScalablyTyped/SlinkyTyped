...
import typingsSlinky.avoscloudSdk.mod.Query.CountOptions
import typingsSlinky.avoscloudSdk.mod.Query.FindOptions
import typingsSlinky.avoscloudSdk.mod.Query.FirstOptions
