...
@js.native
class Collection[T] ()
  extends typingsSlinky.avoscloudDashSdk.avoscloudDashSdkMod.Collection[T] {
  def this(models: js.Array[typingsSlinky.avoscloudDashSdk.avoscloudDashSdkMod.Object]) = this()
  def this(models: js.Array[typingsSlinky.avoscloudDashSdk.avoscloudDashSdkMod.Object], options: Options) = this()
}
