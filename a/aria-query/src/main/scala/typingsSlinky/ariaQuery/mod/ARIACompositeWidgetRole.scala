...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.ariaQuery.ariaQueryStrings.combobox
  - typingsSlinky.ariaQuery.ariaQueryStrings.grid
  - typingsSlinky.ariaQuery.ariaQueryStrings.listbox
  - typingsSlinky.ariaQuery.ariaQueryStrings.menu
  - typingsSlinky.ariaQuery.ariaQueryStrings.menubar
  - typingsSlinky.ariaQuery.ariaQueryStrings.radiogroup
  - typingsSlinky.ariaQuery.ariaQueryStrings.tablist
  - typingsSlinky.ariaQuery.ariaQueryStrings.tree
  - typingsSlinky.ariaQuery.ariaQueryStrings.treegrid
*/
