package typingsSlinky.angularMocks.mod.angularAugmentingMod.animate
...
object IAnimateService {
  ...
  implicit class IAnimateServiceOps[Self <: IAnimateService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCloseAndFlush(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("closeAndFlush")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
