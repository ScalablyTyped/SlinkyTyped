...
object InlineEditStateless
  extends ExternalComponentWithAttributesWithRefType[tag.type, typingsSlinky.atlaskitInlineEdit.mod.InlineEditStateless] {
  ...
  ): BuildingComponent[tag.type, typingsSlinky.atlaskitInlineEdit.mod.InlineEditStateless] = {
