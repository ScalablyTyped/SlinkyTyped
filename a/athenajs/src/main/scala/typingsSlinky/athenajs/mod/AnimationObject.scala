...
import typingsSlinky.athenajs.AnonHeight
...
trait AnimationObject extends js.Object {
  ...
  var frames: js.Array[AnonHeight] = js.native
...
object AnimationObject {
  @scala.inline
  def apply(frames: js.Array[AnonHeight]): AnimationObject = {
  ...
  implicit class AnimationObjectOps[Self <: AnimationObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFrames(value: js.Array[AnonHeight]): Self = {
