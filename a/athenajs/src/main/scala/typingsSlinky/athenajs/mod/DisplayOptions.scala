...
object DisplayOptions {
  ...
  implicit class DisplayOptionsMutableBuilder[Self <: DisplayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayers(value: js.Array[Boolean]): Self = StObject.set(x, "layers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLayersUndefined: Self = StObject.set(x, "layers", js.undefined)
    
    @scala.inline
    def setLayersVarargs(value: Boolean*): Self = StObject.set(x, "layers", js.Array(value :_*))
