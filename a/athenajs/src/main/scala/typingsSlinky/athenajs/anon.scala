...
object anon {
  ...
  object CTRL {
    ...
    implicit class CTRLMutableBuilder[Self <: CTRL] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSPACE(value: typingsSlinky.athenajs.athenajsNumbers.`32`): Self = StObject.set(x, "SPACE", value.asInstanceOf[js.Any])
