...
object Object3DGroup {
  @scala.inline
  def apply[/* <: typingsSlinky.amapJsApiMap3d.AMap.Object3D */ C](
    DEPTH_TEST: Boolean,
    add: C => Unit,
    children: js.Array[C],
    geometry: Geometry3D,
  ...
  @scala.inline
  implicit class Object3DGroupOps[Self <: Object3DGroup[_], /* <: typingsSlinky.amapJsApiMap3d.AMap.Object3D */ C] (val x: Self with Object3DGroup[C]) extends AnyVal {
    @scala.inline
