...
object Object3D {
  ...
  object Line {
    ...
    implicit class LineMutableBuilder[Self <: Line] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeometry(value: typingsSlinky.amapJsApiMap3d.AMap.Geometry3D.Line): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Mesh {
    ...
    implicit class MeshMutableBuilder[Self <: Mesh] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeometry(value: typingsSlinky.amapJsApiMap3d.AMap.Geometry3D.Mesh): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Points {
    ...
    implicit class PointsMutableBuilder[Self <: Points] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeometry(value: typingsSlinky.amapJsApiMap3d.AMap.Geometry3D.Points): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
    }
  }
