...
object Color {
  ...
  implicit class ColorOps[Self <: Color] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeightVarargs(value: Double*): Self = this.set("height", js.Array(value :_*))
    
    @scala.inline
    def setHeight(value: Double | js.Array[Double]): Self = this.set("height", value.asInstanceOf[js.Any])
