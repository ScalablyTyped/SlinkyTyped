...
import typingsSlinky.auth0DashLock.auth0DashLockStrings.forgotPassword
import typingsSlinky.auth0DashLock.auth0DashLockStrings.login
import typingsSlinky.auth0DashLock.auth0DashLockStrings.signUp
