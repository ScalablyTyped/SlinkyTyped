package typingsSlinky.auth0DashLock

import typingsSlinky.auth0DashLock.auth0DashLockStrings.`false`
import typingsSlinky.auth0DashLock.auth0DashLockStrings.`true`
import typingsSlinky.auth0DashLock.auth0DashLockStrings.checkbox
import typingsSlinky.auth0DashLock.auth0DashLockStrings.select
import typingsSlinky.auth0DashLock.auth0DashLockStrings.text
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Rewritten from type alias, can be one of: 
  - typings.auth0DashLock.Auth0LockAdditionalSelectSignUpField
  - typings.auth0DashLock.Auth0LockAdditionalTextSignUpField
  - typings.auth0DashLock.Auth0LockAdditionalCheckboxSignUpField
*/
