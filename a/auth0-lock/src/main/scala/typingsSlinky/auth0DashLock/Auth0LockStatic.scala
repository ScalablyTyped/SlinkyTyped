...
import typingsSlinky.auth0DashLock.auth0DashLockStrings.authenticated
import typingsSlinky.auth0DashLock.auth0DashLockStrings.authorization_error
import typingsSlinky.auth0DashLock.auth0DashLockStrings.hide
import typingsSlinky.auth0DashLock.auth0DashLockStrings.show
import typingsSlinky.auth0DashLock.auth0DashLockStrings.unrecoverable_error
