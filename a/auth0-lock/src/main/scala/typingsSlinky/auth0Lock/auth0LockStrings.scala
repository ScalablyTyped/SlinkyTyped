...
object auth0LockStrings {
  ...
  @js.native
  sealed trait authorization_error extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait forgotPassword extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait unrecoverable_error extends StObject
  @scala.inline
