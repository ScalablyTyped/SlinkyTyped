...
object Auth0LockAvatarOptions {
  ...
  implicit class Auth0LockAvatarOptionsOps[Self <: Auth0LockAvatarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisplayName(value: (String, Auth0LockAvatarDisplayNameCallback) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("displayName")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUrl(value: (String, Auth0LockAvatarUrlCallback) => Unit): Self = {
        val ret = this.duplicate
