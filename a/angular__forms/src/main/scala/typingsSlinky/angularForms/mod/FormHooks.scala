...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.angularForms.angularFormsStrings.change
  - typingsSlinky.angularForms.angularFormsStrings.blur
  - typingsSlinky.angularForms.angularFormsStrings.submit
*/
