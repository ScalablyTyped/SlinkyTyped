...
import typingsSlinky.atAngularForms.Anon_EmitEvent
import typingsSlinky.atAngularForms.Anon_EmitEventEmitModelToViewChange
...
class FormControl () extends AbstractControl {
  ...
  def patchValue(value: js.Any, options: Anon_EmitEventEmitModelToViewChange): Unit = js.native
  /**
  ...
  def reset(formState: js.Any, options: Anon_EmitEvent): Unit = js.native
  def setValue(value: js.Any, options: Anon_EmitEventEmitModelToViewChange): Unit = js.native
}
