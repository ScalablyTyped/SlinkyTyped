...
class FormGroup protected () extends AbstractControl {
  ...
  def patchValue(value: StringDictionary[js.Any], options: Anon_EmitEvent): Unit = js.native
  /**
  ...
  def setValue(value: StringDictionary[js.Any], options: Anon_EmitEvent): Unit = js.native
}
