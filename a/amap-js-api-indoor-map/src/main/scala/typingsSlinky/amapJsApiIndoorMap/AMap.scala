...
import typingsSlinky.amapJsApiIndoorMap.anon.Buildingid
  ...
  object IndoorMap {
    ...
    */
    ...
    object SearchResult {
      ...
      @scala.inline
      def SearchErrorResult(error: js.Error, id: String, status: `1`): typingsSlinky.amapJsApiIndoorMap.AMap.IndoorMap.SearchErrorResult = {
        val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsSlinky.amapJsApiIndoorMap.AMap.IndoorMap.SearchErrorResult]
      }
      
      @scala.inline
      def SearchSuccessResult(building: Building, id: String, status: `0`): typingsSlinky.amapJsApiIndoorMap.AMap.IndoorMap.SearchSuccessResult = {
        ...
        __obj.asInstanceOf[typingsSlinky.amapJsApiIndoorMap.AMap.IndoorMap.SearchSuccessResult]
      }
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public
      - typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection
      - typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop
    */
    trait ShopCategory extends StObject
    object ShopCategory {
      
      @scala.inline
      def connection: typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection = "connection".asInstanceOf[typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection]
      
      @scala.inline
      def public: typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public = "public".asInstanceOf[typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public]
      
      @scala.inline
      def shop: typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop = "shop".asInstanceOf[typingsSlinky.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop]
    }
  }
}
