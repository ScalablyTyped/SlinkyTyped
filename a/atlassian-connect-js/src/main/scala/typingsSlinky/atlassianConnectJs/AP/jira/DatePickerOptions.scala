package typingsSlinky.atlassianConnectJs.AP.jira

import org.scalajs.dom.raw.HTMLElement
import typingsSlinky.atlassianConnectJs.anon.Left
...
trait DatePickerOptions extends js.Object {
  ...
  /**
    ...
    */
  def onSelect(isoDate: String, date: js.Date): Unit = js.native
...
object DatePickerOptions {
  ...
  implicit class DatePickerOptionsOps[Self <: DatePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSelect(value: (String, js.Date) => Unit): Self = this.set("onSelect", js.Any.fromFunction2(value))
