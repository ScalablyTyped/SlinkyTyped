...
trait PartialDatePickerOptions extends StObject {
  ...
  var onSelect: js.UndefOr[js.Function2[/* isoDate */ String, /* date */ js.Date, Unit]] = js.native
...
object PartialDatePickerOptions {
  ...
  implicit class PartialDatePickerOptionsMutableBuilder[Self <: PartialDatePickerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSelect(value: (/* isoDate */ String, /* date */ js.Date) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
