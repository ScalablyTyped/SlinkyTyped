...
@js.native
trait AnonAppAppArgs extends js.Object {
  var app: String = js.native
  var appArgs: js.UndefOr[String] = js.native
  var channelId: String = js.native
}

object AnonAppAppArgs {
  @scala.inline
  def apply(app: String, channelId: String): AnonAppAppArgs = {
    val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any], channelId = channelId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAppAppArgs]
  }
  @scala.inline
  implicit class AnonAppAppArgsOps[Self <: AnonAppAppArgs] (val x: Self) extends AnyVal {
    @scala.inline
