...
@js.native
trait AnonConnectiontype extends js.Object {
...
object AnonConnectiontype {
  @scala.inline
  def apply(app: String, external_host: String, format: String): AnonConnectiontype = {
    ...
    __obj.asInstanceOf[AnonConnectiontype]
  }
  @scala.inline
  implicit class AnonConnectiontypeOps[Self <: AnonConnectiontype] (val x: Self) extends AnyVal {
    @scala.inline
