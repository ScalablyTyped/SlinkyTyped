...
@js.native
trait AnonEncapsulation extends js.Object {
...
object AnonEncapsulation {
  @scala.inline
  def apply(app: String, external_host: String, format: String): AnonEncapsulation = {
    ...
    __obj.asInstanceOf[AnonEncapsulation]
  }
  @scala.inline
  implicit class AnonEncapsulationOps[Self <: AnonEncapsulation] (val x: Self) extends AnyVal {
    @scala.inline
