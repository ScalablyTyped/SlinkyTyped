...
object StatusInfo {
  ...
  implicit class StatusInfoOps[Self <: StatusInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLast_reload_time(value: js.Date): Self = this.set("last_reload_time", value.asInstanceOf[js.Any])
    @scala.inline
    def setStartup_time(value: js.Date): Self = this.set("startup_time", value.asInstanceOf[js.Any])
  }
