...
object ChannelUnhold {
  ...
  @scala.inline
  def apply(application: String, channel: Channel, timestamp: js.Date, `type`: String): ChannelUnhold = {
  ...
  @scala.inline
  implicit class ChannelUnholdOps[Self <: ChannelUnhold] (val x: Self) extends AnyVal {
