...
import typingsSlinky.ariClient.AnonOperationString
...
trait Playback extends Resource {
  ...
  def control(params: AnonOperationString): js.Promise[Unit] = js.native
  def control(params: AnonOperationString, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
