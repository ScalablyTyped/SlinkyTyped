...
@js.native
trait AnonCallerId extends js.Object {
...
object AnonCallerId {
  @scala.inline
  def apply(channelId: String, endpoint: String): AnonCallerId = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any], endpoint = endpoint.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCallerId]
  }
  @scala.inline
  implicit class AnonCallerIdOps[Self <: AnonCallerId] (val x: Self) extends AnyVal {
    @scala.inline
