...
@js.native
trait AnonIfExists extends js.Object {
...
object AnonIfExists {
  @scala.inline
  def apply(channelId: String, format: String, name: String): AnonIfExists = {
    ...
    __obj.asInstanceOf[AnonIfExists]
  }
  @scala.inline
  implicit class AnonIfExistsOps[Self <: AnonIfExists] (val x: Self) extends AnyVal {
    @scala.inline
