...
object AnonMedia {
  @scala.inline
  def apply(bridgeId: String, media: String | js.Array[String], playbackId: String): AnonMedia = {
  ...
  @scala.inline
  implicit class AnonMediaOps[Self <: AnonMedia] (val x: Self) extends AnyVal {
    @scala.inline
