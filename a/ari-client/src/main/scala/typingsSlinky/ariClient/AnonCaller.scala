...
@js.native
trait AnonCaller extends js.Object {
...
object AnonCaller {
  @scala.inline
  def apply(channelId: String): AnonCaller = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCaller]
  }
  @scala.inline
  implicit class AnonCallerOps[Self <: AnonCaller] (val x: Self) extends AnyVal {
    @scala.inline
