...
@js.native
trait AnonSkipms extends js.Object {
...
object AnonSkipms {
  @scala.inline
  def apply(channelId: String, media: String | js.Array[String]): AnonSkipms = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any], media = media.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSkipms]
  }
  @scala.inline
  implicit class AnonSkipmsOps[Self <: AnonSkipms] (val x: Self) extends AnyVal {
    @scala.inline
