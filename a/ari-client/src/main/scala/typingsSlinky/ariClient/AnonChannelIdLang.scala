...
@js.native
trait AnonChannelIdLang extends js.Object {
...
object AnonChannelIdLang {
  @scala.inline
  def apply(channelId: String, media: String | js.Array[String], playbackId: String): AnonChannelIdLang = {
    ...
    __obj.asInstanceOf[AnonChannelIdLang]
  }
  @scala.inline
  implicit class AnonChannelIdLangOps[Self <: AnonChannelIdLang] (val x: Self) extends AnyVal {
    @scala.inline
