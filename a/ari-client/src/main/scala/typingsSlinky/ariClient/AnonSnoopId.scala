...
@js.native
trait AnonSnoopId extends js.Object {
...
object AnonSnoopId {
  @scala.inline
  def apply(app: String, channelId: String): AnonSnoopId = {
    val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any], channelId = channelId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSnoopId]
  }
  @scala.inline
  implicit class AnonSnoopIdOps[Self <: AnonSnoopId] (val x: Self) extends AnyVal {
    @scala.inline
