...
@js.native
trait AnonChannelIdVariable extends js.Object {
  var channelId: String = js.native
  var variable: String = js.native
}

object AnonChannelIdVariable {
  @scala.inline
  def apply(channelId: String, variable: String): AnonChannelIdVariable = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any], variable = variable.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonChannelIdVariable]
  }
  @scala.inline
  implicit class AnonChannelIdVariableOps[Self <: AnonChannelIdVariable] (val x: Self) extends AnyVal {
    @scala.inline
