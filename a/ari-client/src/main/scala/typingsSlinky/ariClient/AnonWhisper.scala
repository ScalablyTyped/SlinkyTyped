...
@js.native
trait AnonWhisper extends js.Object {
...
object AnonWhisper {
  @scala.inline
  def apply(app: String): AnonWhisper = {
    val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonWhisper]
  }
  @scala.inline
  implicit class AnonWhisperOps[Self <: AnonWhisper] (val x: Self) extends AnyVal {
    @scala.inline
