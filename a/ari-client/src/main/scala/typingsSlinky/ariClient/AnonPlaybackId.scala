...
@js.native
trait AnonPlaybackId extends js.Object {
...
object AnonPlaybackId {
  @scala.inline
  def apply(media: String | js.Array[String], playbackId: String): AnonPlaybackId = {
    val __obj = js.Dynamic.literal(media = media.asInstanceOf[js.Any], playbackId = playbackId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonPlaybackId]
  }
  @scala.inline
  implicit class AnonPlaybackIdOps[Self <: AnonPlaybackId] (val x: Self) extends AnyVal {
    @scala.inline
