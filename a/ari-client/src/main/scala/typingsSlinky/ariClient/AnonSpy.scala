...
@js.native
trait AnonSpy extends js.Object {
...
object AnonSpy {
  @scala.inline
  def apply(app: String, channelId: String, snoopId: String): AnonSpy = {
    ...
    __obj.asInstanceOf[AnonSpy]
  }
  @scala.inline
  implicit class AnonSpyOps[Self <: AnonSpy] (val x: Self) extends AnyVal {
    @scala.inline
