...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.axiosMockAdapter.mod.AsymmetricMatcher
    - typingsSlinky.axiosMockAdapter.mod.RequestDataMatcher
  */
  trait AsymmetricRequestDataMatcher extends StObject
  object AsymmetricRequestDataMatcher {
    
    @scala.inline
    def AsymmetricMatcher(asymmetricMatch: js.Function): typingsSlinky.axiosMockAdapter.mod.AsymmetricMatcher = {
      val __obj = js.Dynamic.literal(asymmetricMatch = asymmetricMatch.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.axiosMockAdapter.mod.AsymmetricMatcher]
    }
    
    @scala.inline
    def RequestDataMatcher(): typingsSlinky.axiosMockAdapter.mod.RequestDataMatcher = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.axiosMockAdapter.mod.RequestDataMatcher]
    }
  }
  ...
  trait MockAdapter extends StObject {
    ...
    def onAny(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onAny(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onAny(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onAny(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onAny(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onAny")
    ...
    def onDelete(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onDelete(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onDelete(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onDelete(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onDelete(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onDelete")
    ...
    def onGet(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onGet(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onGet(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onGet(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onGet(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onGet")
    ...
    def onHead(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onHead(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onHead(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onHead(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onHead(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onHead")
    ...
    def onList(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onList(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onList(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onList(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onList(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onList")
    ...
    def onOptions(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onOptions(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onOptions(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onOptions(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onOptions(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onOptions")
    ...
    def onPatch(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPatch(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onPatch(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPatch(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onPatch(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onPatch")
    ...
    def onPost(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPost(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onPost(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPost(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onPost(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onPost")
    ...
    def onPut(matcher: js.RegExp, body: js.UndefOr[scala.Nothing], headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPut(matcher: js.RegExp, body: String): RequestHandler = js.native
    def onPut(matcher: js.RegExp, body: String, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    def onPut(matcher: js.RegExp, body: AsymmetricRequestDataMatcher): RequestHandler = js.native
    def onPut(matcher: js.RegExp, body: AsymmetricRequestDataMatcher, headers: AsymmetricHeadersMatcher): RequestHandler = js.native
    @JSName("onPut")
