...
object RequestMode {
  ...
  @scala.inline
  def cors: typingsSlinky.apolloDashServerDashEnv.apolloDashServerDashEnvStrings.cors = this.cast("cors")
  @scala.inline
  def navigate: typingsSlinky.apolloDashServerDashEnv.apolloDashServerDashEnvStrings.navigate = this.cast("navigate")
  @scala.inline
  def `no-cors`: typingsSlinky.apolloDashServerDashEnv.apolloDashServerDashEnvStrings.`no-cors` = this.cast("no-cors")
  @scala.inline
