...
import typingsSlinky.atAntDashDesignIconsDashReactDashNative.libFillMod.FillGlyphMapType
import typingsSlinky.atAntDashDesignIconsDashReactDashNative.libFillMod.IconFillProps
...
abstract class SharedApply_IconFillProps_2008361208[ComponentRef <: js.Object] (implicit pw: ExternalPropsWriterProvider)
