...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.ALL_NEW
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.ALL_OLD
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.AND
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.INDEXES
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.NONE
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.OR
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.SIZE
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.TOTAL
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.UPDATED_NEW
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.UPDATED_OLD
...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreExpectedAttributeValueMod._ExpectedAttributeValue
...
@JSImport("@aws-sdk/client-dynamodb-browser/types/DeleteItemInput", JSImport.Namespace)
@js.native
object typesDeleteItemInputMod extends js.Object {
  ...
  trait DeleteItemInput extends InputTypesUnion {
    ...
    var Expected: js.UndefOr[
        StringDictionary[_ExpectedAttributeValue] | (js.Iterable[js.Tuple2[String, _ExpectedAttributeValue]])
      ] = js.native
    /**
    ...
    var ExpressionAttributeValues: js.UndefOr[
        StringDictionary[_AttributeValue] | (js.Iterable[js.Tuple2[String, _AttributeValue]])
      ] = js.native
    /**
      ...
      */
    var Key: StringDictionary[_AttributeValue] | (js.Iterable[js.Tuple2[String, _AttributeValue]]) = js.native
    /**
