...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreReplicaGlobalSecondaryIndexSettingsUpdateMod._ReplicaGlobalSecondaryIndexSettingsUpdate
...
trait _ReplicaSettingsUpdate extends js.Object {
  ...
  var ReplicaGlobalSecondaryIndexSettingsUpdate: js.UndefOr[
    js.Array[_ReplicaGlobalSecondaryIndexSettingsUpdate] | js.Iterable[_ReplicaGlobalSecondaryIndexSettingsUpdate]
  ] = js.undefined
  /**
...
object _ReplicaSettingsUpdate {
  ...
  def apply(
    RegionName: String,
    ReplicaGlobalSecondaryIndexSettingsUpdate: js.Array[_ReplicaGlobalSecondaryIndexSettingsUpdate] | js.Iterable[_ReplicaGlobalSecondaryIndexSettingsUpdate] = null,
