...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreCreateReplicaActionMod._CreateReplicaAction
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreDeleteReplicaActionMod._DeleteReplicaAction
