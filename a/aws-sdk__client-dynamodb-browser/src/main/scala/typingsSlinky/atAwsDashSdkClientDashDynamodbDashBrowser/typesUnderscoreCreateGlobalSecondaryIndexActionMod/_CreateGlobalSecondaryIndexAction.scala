package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreCreateGlobalSecondaryIndexActionMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreKeySchemaElementMod._KeySchemaElement
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreProjectionMod._Projection
...
trait _CreateGlobalSecondaryIndexAction extends js.Object {
  ...
  /**
    ...
    */
  var KeySchema: js.Array[_KeySchemaElement] | js.Iterable[_KeySchemaElement]
  /**
...
object _CreateGlobalSecondaryIndexAction {
  ...
  def apply(
    IndexName: String,
    KeySchema: js.Array[_KeySchemaElement] | js.Iterable[_KeySchemaElement],
