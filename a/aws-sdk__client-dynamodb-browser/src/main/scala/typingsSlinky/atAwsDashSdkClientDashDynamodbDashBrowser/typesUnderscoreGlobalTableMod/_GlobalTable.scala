...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreReplicaMod._Replica
...
trait _GlobalTable extends js.Object {
  ...
  /**
    ...
    */
  var ReplicationGroup: js.UndefOr[js.Array[_Replica] | js.Iterable[_Replica]] = js.undefined
}
...
object _GlobalTable {
  ...
  def apply(
    ...
    ReplicationGroup: js.Array[_Replica] | js.Iterable[_Replica] = null
  ): _GlobalTable = {
