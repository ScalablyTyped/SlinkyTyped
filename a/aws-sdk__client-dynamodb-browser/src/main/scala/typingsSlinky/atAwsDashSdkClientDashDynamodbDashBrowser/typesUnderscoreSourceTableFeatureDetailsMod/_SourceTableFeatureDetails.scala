package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSourceTableFeatureDetailsMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexInfoMod._GlobalSecondaryIndexInfo
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexInfoMod._LocalSecondaryIndexInfo
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSSEDescriptionMod._SSEDescription
...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreTimeToLiveDescriptionMod._TimeToLiveDescription
...
trait _SourceTableFeatureDetails extends js.Object {
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[js.Array[_GlobalSecondaryIndexInfo] | js.Iterable[_GlobalSecondaryIndexInfo]] = js.undefined
  /**
    ...
    */
  var LocalSecondaryIndexes: js.UndefOr[js.Array[_LocalSecondaryIndexInfo] | js.Iterable[_LocalSecondaryIndexInfo]] = js.undefined
  /**
...
object _SourceTableFeatureDetails {
  @scala.inline
  def apply(
    GlobalSecondaryIndexes: js.Array[_GlobalSecondaryIndexInfo] | js.Iterable[_GlobalSecondaryIndexInfo] = null,
    LocalSecondaryIndexes: js.Array[_LocalSecondaryIndexInfo] | js.Iterable[_LocalSecondaryIndexInfo] = null,
