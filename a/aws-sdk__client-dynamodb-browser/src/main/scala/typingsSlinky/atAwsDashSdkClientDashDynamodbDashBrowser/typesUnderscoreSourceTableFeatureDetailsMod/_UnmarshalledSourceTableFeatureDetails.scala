...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexInfoMod._UnmarshalledGlobalSecondaryIndexInfo
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexInfoMod._UnmarshalledLocalSecondaryIndexInfo
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSSEDescriptionMod._UnmarshalledSSEDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreStreamSpecificationMod._UnmarshalledStreamSpecification
