package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSourceTableDetailsMod
...
trait _UnmarshalledSourceTableDetails extends _SourceTableDetails {
  ...
  var TableCreationDateTime__UnmarshalledSourceTableDetails: js.Date
}
