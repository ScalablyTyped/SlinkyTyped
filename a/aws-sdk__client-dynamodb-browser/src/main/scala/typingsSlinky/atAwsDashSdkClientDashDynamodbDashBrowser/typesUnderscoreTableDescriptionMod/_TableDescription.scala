package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreTableDescriptionMod
...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexDescriptionMod._GlobalSecondaryIndexDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreKeySchemaElementMod._KeySchemaElement
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexDescriptionMod._LocalSecondaryIndexDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreProvisionedThroughputDescriptionMod._ProvisionedThroughputDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreRestoreSummaryMod._RestoreSummary
