...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreWriteRequestMod._WriteRequest
...
@JSImport("@aws-sdk/client-dynamodb-browser/types/BatchWriteItemInput", JSImport.Namespace)
@js.native
object typesBatchWriteItemInputMod extends js.Object {
  ...
  trait BatchWriteItemInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var RequestItems: (StringDictionary[js.Array[_WriteRequest] | js.Iterable[_WriteRequest]]) | (js.Iterable[js.Tuple2[String, js.Array[_WriteRequest] | js.Iterable[_WriteRequest]]]) = js.native
    /**
