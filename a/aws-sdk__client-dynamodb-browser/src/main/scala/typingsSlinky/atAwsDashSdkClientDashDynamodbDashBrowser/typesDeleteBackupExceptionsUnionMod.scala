...
@JSImport("@aws-sdk/client-dynamodb-browser/types/DeleteBackupExceptionsUnion", JSImport.Namespace)
@js.native
object typesDeleteBackupExceptionsUnionMod extends js.Object {
