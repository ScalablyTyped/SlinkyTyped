package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingPolicyDescriptionMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingTargetTrackingScalingPolicyConfigurationDescriptionMod._AutoScalingTargetTrackingScalingPolicyConfigurationDescription
