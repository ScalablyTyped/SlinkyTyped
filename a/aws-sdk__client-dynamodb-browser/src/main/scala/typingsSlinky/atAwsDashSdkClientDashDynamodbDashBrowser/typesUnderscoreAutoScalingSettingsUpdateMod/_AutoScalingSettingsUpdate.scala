package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingSettingsUpdateMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingPolicyUpdateMod._AutoScalingPolicyUpdate
