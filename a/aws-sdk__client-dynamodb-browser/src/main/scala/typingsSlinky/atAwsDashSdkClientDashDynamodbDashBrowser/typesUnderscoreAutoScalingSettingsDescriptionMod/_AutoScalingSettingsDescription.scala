package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingSettingsDescriptionMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingPolicyDescriptionMod._AutoScalingPolicyDescription
...
trait _AutoScalingSettingsDescription extends js.Object {
  ...
  var ScalingPolicies: js.UndefOr[
    js.Array[_AutoScalingPolicyDescription] | js.Iterable[_AutoScalingPolicyDescription]
  ] = js.undefined
}
...
object _AutoScalingSettingsDescription {
  ...
  def apply(
    ...
    ScalingPolicies: js.Array[_AutoScalingPolicyDescription] | js.Iterable[_AutoScalingPolicyDescription] = null
