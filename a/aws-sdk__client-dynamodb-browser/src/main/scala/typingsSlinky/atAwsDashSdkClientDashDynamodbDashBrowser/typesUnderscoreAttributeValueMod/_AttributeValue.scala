package typingsSlinky.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAttributeValueMod
...
trait _AttributeValue extends js.Object {
  /**
  ...
  /**
    ...
    */
  var L: js.UndefOr[js.Array[_AttributeValue] | js.Iterable[_AttributeValue]] = js.undefined
  /**
...
object _AttributeValue {
  ...
  def apply(
    ...
    L: js.Array[_AttributeValue] | js.Iterable[_AttributeValue] = null,
    M: StringDictionary[_AttributeValue] | (js.Iterable[js.Tuple2[String, _AttributeValue]]) = null,
    N: String = null,
    ...
    __obj.asInstanceOf[_AttributeValue]
  }
}
