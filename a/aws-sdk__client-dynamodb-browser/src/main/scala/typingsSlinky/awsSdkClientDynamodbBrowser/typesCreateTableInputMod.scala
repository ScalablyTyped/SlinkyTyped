...
object typesCreateTableInputMod {
  ...
  object CreateTableInput {
    ...
    implicit class CreateTableInputMutableBuilder[Self <: CreateTableInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGlobalSecondaryIndexesIterable(value: js.Iterable[GlobalSecondaryIndex]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLocalSecondaryIndexesIterable(value: js.Iterable[LocalSecondaryIndex]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
