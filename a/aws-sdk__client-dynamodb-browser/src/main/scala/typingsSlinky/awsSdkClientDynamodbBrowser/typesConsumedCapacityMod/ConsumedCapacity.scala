...
object ConsumedCapacity {
  ...
  implicit class ConsumedCapacityOps[Self <: ConsumedCapacity] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGlobalSecondaryIndexesIterable(value: js.Iterable[js.Tuple2[String, Capacity]]): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    def setGlobalSecondaryIndexes(value: StringDictionary[Capacity] | (js.Iterable[js.Tuple2[String, Capacity]])): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteGlobalSecondaryIndexes: Self = this.set("GlobalSecondaryIndexes", js.undefined)
    @scala.inline
    def setLocalSecondaryIndexesIterable(value: js.Iterable[js.Tuple2[String, Capacity]]): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    def setLocalSecondaryIndexes(value: StringDictionary[Capacity] | (js.Iterable[js.Tuple2[String, Capacity]])): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
