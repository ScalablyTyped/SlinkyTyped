...
object QueryInput {
  ...
  implicit class QueryInputOps[Self <: QueryInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKeyConditionExpression(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKeyConditionsIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("KeyConditions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withKeyConditions(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("KeyConditions")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withQueryFilterIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("QueryFilter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withQueryFilter(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("QueryFilter")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withScanIndexForward(value: Boolean): Self = {
        val ret = this.duplicate
