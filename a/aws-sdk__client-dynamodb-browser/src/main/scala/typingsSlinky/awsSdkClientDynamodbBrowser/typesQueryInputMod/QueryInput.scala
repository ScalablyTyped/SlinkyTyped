...
object QueryInput {
  ...
  def apply(
    ...
    KeyConditions: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]]) = null,
    Limit: js.UndefOr[Double] = js.undefined,
    ProjectionExpression: String = null,
    QueryFilter: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]]) = null,
