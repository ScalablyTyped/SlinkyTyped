...
@JSImport("@aws-sdk/client-dynamodb-browser/types/DescribeContinuousBackupsInput", JSImport.Namespace)
@js.native
object typesDescribeContinuousBackupsInputMod extends js.Object {
  @js.native
