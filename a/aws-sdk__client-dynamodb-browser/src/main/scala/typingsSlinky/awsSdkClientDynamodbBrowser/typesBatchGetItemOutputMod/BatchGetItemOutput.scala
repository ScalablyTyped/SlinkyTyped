package typingsSlinky.awsSdkClientDynamodbBrowser.typesBatchGetItemOutputMod
...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesKeysAndAttributesMod.UnmarshalledKeysAndAttributes
