...
trait WriteRequest extends js.Object {
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typingsSlinky.awsSdkClientDynamodbBrowser.typesDeleteRequestMod.DeleteRequest] = js.undefined
  /**
    * <p>A request to perform a <code>PutItem</code> operation.</p>
    */
  var PutRequest: js.UndefOr[typingsSlinky.awsSdkClientDynamodbBrowser.typesPutRequestMod.PutRequest] = js.undefined
}
