...
object typesQueryInputMod {
  ...
  object QueryInput {
    ...
    implicit class QueryInputMutableBuilder[Self <: QueryInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExclusiveStartKey(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = StObject.set(x, "ExclusiveStartKey", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExclusiveStartKeyIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = StObject.set(x, "ExclusiveStartKey", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setExpressionAttributeValues(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = StObject.set(x, "ExpressionAttributeValues", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExpressionAttributeValuesIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = StObject.set(x, "ExpressionAttributeValues", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setKeyConditionExpression(value: String): Self = StObject.set(x, "KeyConditionExpression", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKeyConditionExpressionUndefined: Self = StObject.set(x, "KeyConditionExpression", js.undefined)
      
      @scala.inline
      def setKeyConditions(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "KeyConditions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setKeyConditionsIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = StObject.set(x, "KeyConditions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setQueryFilter(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "QueryFilter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setQueryFilterIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = StObject.set(x, "QueryFilter", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setScanIndexForward(value: Boolean): Self = StObject.set(x, "ScanIndexForward", value.asInstanceOf[js.Any])
