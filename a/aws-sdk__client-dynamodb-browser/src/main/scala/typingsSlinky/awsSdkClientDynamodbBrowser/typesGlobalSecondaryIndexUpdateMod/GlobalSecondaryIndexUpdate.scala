...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesCreateGlobalSecondaryIndexActionMod.CreateGlobalSecondaryIndexAction
import typingsSlinky.awsSdkClientDynamodbBrowser.typesDeleteGlobalSecondaryIndexActionMod.DeleteGlobalSecondaryIndexAction
import typingsSlinky.awsSdkClientDynamodbBrowser.typesUpdateGlobalSecondaryIndexActionMod.UpdateGlobalSecondaryIndexAction
