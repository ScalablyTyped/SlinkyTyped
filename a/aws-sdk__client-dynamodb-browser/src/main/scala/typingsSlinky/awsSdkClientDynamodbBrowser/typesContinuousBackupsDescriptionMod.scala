...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesPointInTimeRecoveryDescriptionMod.PointInTimeRecoveryDescription
import typingsSlinky.awsSdkClientDynamodbBrowser.typesPointInTimeRecoveryDescriptionMod.UnmarshalledPointInTimeRecoveryDescription
...
object typesContinuousBackupsDescriptionMod {
  ...
  trait ContinuousBackupsDescription extends StObject {
    ...
    var PointInTimeRecoveryDescription: js.UndefOr[
        typingsSlinky.awsSdkClientDynamodbBrowser.typesPointInTimeRecoveryDescriptionMod.PointInTimeRecoveryDescription
      ] = js.native
  }
