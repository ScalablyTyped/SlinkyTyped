...
object AttributeValue {
  ...
  implicit class AttributeValueOps[Self <: AttributeValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("B", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("B", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setB(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = this.set("B", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBSVarargs(value: (js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String)*): Self = this.set("BS", js.Array(value :_*))
    
    @scala.inline
    def setBSIterable(value: js.Iterable[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String]): Self = this.set("BS", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLIterable(value: js.Iterable[AttributeValue]): Self = this.set("L", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setL(value: js.Array[AttributeValue] | js.Iterable[AttributeValue]): Self = this.set("L", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteL: Self = this.set("L", js.undefined)
    
    @scala.inline
    def setMIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = this.set("M", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setM(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = this.set("M", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNSIterable(value: js.Iterable[String]): Self = this.set("NS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNS(value: js.Array[String] | js.Iterable[String]): Self = this.set("NS", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSSIterable(value: js.Iterable[String]): Self = this.set("SS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSS(value: js.Array[String] | js.Iterable[String]): Self = this.set("SS", value.asInstanceOf[js.Any])
