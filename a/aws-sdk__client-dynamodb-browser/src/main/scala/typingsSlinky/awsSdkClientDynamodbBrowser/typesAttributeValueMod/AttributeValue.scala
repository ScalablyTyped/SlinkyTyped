...
object AttributeValue {
  @scala.inline
  def apply(
    B: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String = null,
    BOOL: js.UndefOr[Boolean] = js.undefined,
    BS: (js.Array[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String]) | (js.Iterable[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String]) = null,
