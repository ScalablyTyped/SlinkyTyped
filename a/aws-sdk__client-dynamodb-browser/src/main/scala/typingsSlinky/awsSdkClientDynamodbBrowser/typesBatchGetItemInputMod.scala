...
object typesBatchGetItemInputMod {
  ...
  trait BatchGetItemInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var RequestItems: StringDictionary[KeysAndAttributes] | (js.Iterable[js.Tuple2[String, KeysAndAttributes]]) = js.native
  ...
  object BatchGetItemInput {
    ...
    implicit class BatchGetItemInputMutableBuilder[Self <: BatchGetItemInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRequestItems(value: StringDictionary[KeysAndAttributes] | (js.Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = StObject.set(x, "RequestItems", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRequestItemsIterable(value: js.Iterable[js.Tuple2[String, KeysAndAttributes]]): Self = StObject.set(x, "RequestItems", value.asInstanceOf[js.Any])
