...
object BatchGetItemInput {
  ...
  implicit class BatchGetItemInputOps[Self <: BatchGetItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestItemsIterable(value: js.Iterable[js.Tuple2[String, KeysAndAttributes]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RequestItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRequestItems(value: StringDictionary[KeysAndAttributes] | (js.Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RequestItems")(value.asInstanceOf[js.Any])
        ret
    }
