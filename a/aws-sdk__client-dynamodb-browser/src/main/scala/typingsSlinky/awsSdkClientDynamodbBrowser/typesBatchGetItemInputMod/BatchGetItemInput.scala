package typingsSlinky.awsSdkClientDynamodbBrowser.typesBatchGetItemInputMod
...
object BatchGetItemInput {
  ...
  implicit class BatchGetItemInputOps[Self <: BatchGetItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestItemsIterable(value: js.Iterable[js.Tuple2[String, KeysAndAttributes]]): Self = this.set("RequestItems", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequestItems(value: StringDictionary[KeysAndAttributes] | (js.Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = this.set("RequestItems", value.asInstanceOf[js.Any])
