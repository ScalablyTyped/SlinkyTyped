...
object CreateTableInput {
  ...
  def apply(
    ...
    GlobalSecondaryIndexes: js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex] = null,
    LocalSecondaryIndexes: js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex] = null,
