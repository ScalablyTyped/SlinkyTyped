...
object CreateTableInput {
  ...
  implicit class CreateTableInputOps[Self <: CreateTableInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGlobalSecondaryIndexesIterable(value: js.Iterable[GlobalSecondaryIndex]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GlobalSecondaryIndexes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GlobalSecondaryIndexes")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withLocalSecondaryIndexesIterable(value: js.Iterable[LocalSecondaryIndex]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LocalSecondaryIndexes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LocalSecondaryIndexes")(value.asInstanceOf[js.Any])
        ret
    }
