package typingsSlinky.awsSdkClientDynamodbBrowser.typesCreateTableInputMod

import typingsSlinky.awsSdkClientDynamodbBrowser.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientDynamodbBrowser.typesAttributeDefinitionMod.AttributeDefinition
import typingsSlinky.awsSdkClientDynamodbBrowser.typesGlobalSecondaryIndexMod.GlobalSecondaryIndex
import typingsSlinky.awsSdkClientDynamodbBrowser.typesKeySchemaElementMod.KeySchemaElement
import typingsSlinky.awsSdkClientDynamodbBrowser.typesLocalSecondaryIndexMod.LocalSecondaryIndex
...
object CreateTableInput {
  ...
  implicit class CreateTableInputOps[Self <: CreateTableInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGlobalSecondaryIndexesIterable(value: js.Iterable[GlobalSecondaryIndex]): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex]): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLocalSecondaryIndexesIterable(value: js.Iterable[LocalSecondaryIndex]): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex]): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
