...
object typesConditionMod {
  ...
  object Condition {
    ...
    implicit class ConditionMutableBuilder[Self <: Condition] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributeValueList(value: js.Array[AttributeValue] | js.Iterable[AttributeValue]): Self = StObject.set(x, "AttributeValueList", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttributeValueListIterable(value: js.Iterable[AttributeValue]): Self = StObject.set(x, "AttributeValueList", value.asInstanceOf[js.Any])
