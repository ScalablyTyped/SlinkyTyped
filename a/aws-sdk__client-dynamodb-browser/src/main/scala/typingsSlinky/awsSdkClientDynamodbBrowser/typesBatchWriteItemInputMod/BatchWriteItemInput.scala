package typingsSlinky.awsSdkClientDynamodbBrowser.typesBatchWriteItemInputMod
...
object BatchWriteItemInput {
  ...
  implicit class BatchWriteItemInputOps[Self <: BatchWriteItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRequestItemsIterable(value: js.Iterable[js.Tuple2[String, js.Array[WriteRequest] | js.Iterable[WriteRequest]]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RequestItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRequestItems(
