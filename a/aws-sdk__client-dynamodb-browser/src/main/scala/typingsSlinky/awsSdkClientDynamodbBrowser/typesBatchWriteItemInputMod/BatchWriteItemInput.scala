...
object BatchWriteItemInput {
  ...
  implicit class BatchWriteItemInputOps[Self <: BatchWriteItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestItemsIterable(value: js.Iterable[js.Tuple2[String, js.Array[WriteRequest] | js.Iterable[WriteRequest]]]): Self = this.set("RequestItems", value.asInstanceOf[js.Any])
