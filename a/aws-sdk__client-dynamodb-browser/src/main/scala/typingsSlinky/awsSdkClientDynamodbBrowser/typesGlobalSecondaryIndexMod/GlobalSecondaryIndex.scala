...
trait GlobalSecondaryIndex extends js.Object {
  ...
  /**
    ...
    */
  var Projection: typingsSlinky.awsSdkClientDynamodbBrowser.typesProjectionMod.Projection
  /**
    ...
    */
  var ProvisionedThroughput: typingsSlinky.awsSdkClientDynamodbBrowser.typesProvisionedThroughputMod.ProvisionedThroughput
}
