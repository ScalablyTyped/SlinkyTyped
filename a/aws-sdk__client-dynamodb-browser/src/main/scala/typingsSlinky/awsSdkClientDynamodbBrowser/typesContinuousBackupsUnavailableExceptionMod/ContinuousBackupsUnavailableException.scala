...
trait ContinuousBackupsUnavailableException
  ...
  @JSName("name")
  var name_ContinuousBackupsUnavailableException: typingsSlinky.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.ContinuousBackupsUnavailableException
}
