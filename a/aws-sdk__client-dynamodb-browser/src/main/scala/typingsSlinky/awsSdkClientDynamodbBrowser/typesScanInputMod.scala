...
object typesScanInputMod {
  ...
  object ScanInput {
    ...
    implicit class ScanInputMutableBuilder[Self <: ScanInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScanFilter(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "ScanFilter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScanFilterIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = StObject.set(x, "ScanFilter", value.asInstanceOf[js.Any])
