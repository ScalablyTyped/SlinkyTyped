package typingsSlinky.awsSdkClientDynamodbBrowser.typesAutoScalingSettingsUpdateMod

import typingsSlinky.awsSdkClientDynamodbBrowser.typesAutoScalingPolicyUpdateMod.UnmarshalledAutoScalingPolicyUpdate
