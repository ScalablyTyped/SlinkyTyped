package typingsSlinky.awsSdkClientDynamodbBrowser.typesExpectedAttributeValueMod
...
object ExpectedAttributeValue {
  ...
  implicit class ExpectedAttributeValueOps[Self <: ExpectedAttributeValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttributeValueListIterable(value: js.Iterable[AttributeValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AttributeValueList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAttributeValueList(value: js.Array[AttributeValue] | js.Iterable[AttributeValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AttributeValueList")(value.asInstanceOf[js.Any])
        ret
    }
