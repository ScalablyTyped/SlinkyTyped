...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesAttributeDefinitionMod.UnmarshalledAttributeDefinition
import typingsSlinky.awsSdkClientDynamodbBrowser.typesGlobalSecondaryIndexDescriptionMod.UnmarshalledGlobalSecondaryIndexDescription
import typingsSlinky.awsSdkClientDynamodbBrowser.typesKeySchemaElementMod.UnmarshalledKeySchemaElement
import typingsSlinky.awsSdkClientDynamodbBrowser.typesLocalSecondaryIndexDescriptionMod.UnmarshalledLocalSecondaryIndexDescription
...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesRestoreSummaryMod.UnmarshalledRestoreSummary
import typingsSlinky.awsSdkClientDynamodbBrowser.typesSsedescriptionMod.UnmarshalledSSEDescription
import typingsSlinky.awsSdkClientDynamodbBrowser.typesStreamSpecificationMod.UnmarshalledStreamSpecification
...
trait UnmarshalledTableDescription extends TableDescription {
  ...
  var CreationDateTime_UnmarshalledTableDescription: js.UndefOr[js.Date] = js.native
  /**
...
object UnmarshalledTableDescription {
  ...
  implicit class UnmarshalledTableDescriptionOps[Self <: UnmarshalledTableDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttributeDefinitions(value: js.Array[UnmarshalledAttributeDefinition]): Self = {
    ...
    @scala.inline
    def withGlobalSecondaryIndexes(value: js.Array[UnmarshalledGlobalSecondaryIndexDescription]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withLocalSecondaryIndexes(value: js.Array[UnmarshalledLocalSecondaryIndexDescription]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRestoreSummary(value: UnmarshalledRestoreSummary): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withStreamSpecification(value: UnmarshalledStreamSpecification): Self = {
        val ret = this.duplicate
