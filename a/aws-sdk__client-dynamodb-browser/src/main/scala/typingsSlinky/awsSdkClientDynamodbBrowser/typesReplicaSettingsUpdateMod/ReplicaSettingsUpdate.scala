...
object ReplicaSettingsUpdate {
  ...
  def apply(
    RegionName: String,
    ReplicaGlobalSecondaryIndexSettingsUpdate: js.Array[ReplicaGlobalSecondaryIndexSettingsUpdate] | js.Iterable[ReplicaGlobalSecondaryIndexSettingsUpdate] = null,
