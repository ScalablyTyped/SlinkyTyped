...
object ReplicaSettingsUpdate {
  ...
  implicit class ReplicaSettingsUpdateOps[Self <: ReplicaSettingsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicaGlobalSecondaryIndexSettingsUpdateIterable(value: js.Iterable[ReplicaGlobalSecondaryIndexSettingsUpdate]): Self = this.set("ReplicaGlobalSecondaryIndexSettingsUpdate", value.asInstanceOf[js.Any])
