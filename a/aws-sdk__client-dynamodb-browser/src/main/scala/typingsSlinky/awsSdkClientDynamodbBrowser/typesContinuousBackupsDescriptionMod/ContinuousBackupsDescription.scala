package typingsSlinky.awsSdkClientDynamodbBrowser.typesContinuousBackupsDescriptionMod
...
object ContinuousBackupsDescription {
  ...
  implicit class ContinuousBackupsDescriptionOps[Self <: ContinuousBackupsDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContinuousBackupsStatus(value: ENABLED | DISABLED | String): Self = {
