...
object serviceMetadataMod {
  ...
  @JSImport("@aws-sdk/client-dynamodb-browser/model/ServiceMetadata", "ServiceMetadata")
  @js.native
  ...
  @JSImport("@aws-sdk/client-dynamodb-browser/model/ServiceMetadata", "clientVersion")
  @js.native
