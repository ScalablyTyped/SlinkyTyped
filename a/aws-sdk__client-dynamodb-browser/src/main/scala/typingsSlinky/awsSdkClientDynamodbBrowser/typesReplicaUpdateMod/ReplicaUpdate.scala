...
import typingsSlinky.awsSdkClientDynamodbBrowser.typesCreateReplicaActionMod.CreateReplicaAction
import typingsSlinky.awsSdkClientDynamodbBrowser.typesDeleteReplicaActionMod.DeleteReplicaAction
