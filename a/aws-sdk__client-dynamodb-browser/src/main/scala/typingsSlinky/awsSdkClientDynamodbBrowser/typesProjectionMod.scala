...
object typesProjectionMod {
  ...
  object Projection {
    ...
    implicit class ProjectionMutableBuilder[Self <: Projection] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNonKeyAttributes(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "NonKeyAttributes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNonKeyAttributesIterable(value: js.Iterable[String]): Self = StObject.set(x, "NonKeyAttributes", value.asInstanceOf[js.Any])
