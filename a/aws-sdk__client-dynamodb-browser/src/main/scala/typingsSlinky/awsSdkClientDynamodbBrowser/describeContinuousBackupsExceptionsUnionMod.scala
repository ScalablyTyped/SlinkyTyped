...
@JSImport("@aws-sdk/client-dynamodb-browser/types/DescribeContinuousBackupsExceptionsUnion", JSImport.Namespace)
@js.native
object describeContinuousBackupsExceptionsUnionMod extends js.Object {
