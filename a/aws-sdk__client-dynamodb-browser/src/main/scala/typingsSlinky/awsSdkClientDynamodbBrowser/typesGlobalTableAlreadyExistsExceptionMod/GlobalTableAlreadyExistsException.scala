...
trait GlobalTableAlreadyExistsException
  ...
  @JSName("name")
  var name_GlobalTableAlreadyExistsException: typingsSlinky.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.GlobalTableAlreadyExistsException
}
