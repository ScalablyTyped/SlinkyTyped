...
object typesBatchWriteItemInputMod {
  ...
  object BatchWriteItemInput {
    ...
    implicit class BatchWriteItemInputMutableBuilder[Self <: BatchWriteItemInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRequestItemsIterable(value: js.Iterable[js.Tuple2[String, js.Array[WriteRequest] | js.Iterable[WriteRequest]]]): Self = StObject.set(x, "RequestItems", value.asInstanceOf[js.Any])
