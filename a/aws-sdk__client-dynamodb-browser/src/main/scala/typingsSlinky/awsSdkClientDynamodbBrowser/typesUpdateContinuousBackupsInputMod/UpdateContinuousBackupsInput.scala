...
trait UpdateContinuousBackupsInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var PointInTimeRecoverySpecification: typingsSlinky.awsSdkClientDynamodbBrowser.typesPointInTimeRecoverySpecificationMod.PointInTimeRecoverySpecification
  /**
