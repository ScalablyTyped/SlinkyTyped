...
object ItemCollectionMetrics {
  ...
  implicit class ItemCollectionMetricsOps[Self <: ItemCollectionMetrics] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemCollectionKeyIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = this.set("ItemCollectionKey", value.asInstanceOf[js.Any])
    @scala.inline
    def setItemCollectionKey(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = this.set("ItemCollectionKey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSizeEstimateRangeGBIterable(value: js.Iterable[Double]): Self = this.set("SizeEstimateRangeGB", value.asInstanceOf[js.Any])
    @scala.inline
    def setSizeEstimateRangeGB(value: js.Array[Double] | js.Iterable[Double]): Self = this.set("SizeEstimateRangeGB", value.asInstanceOf[js.Any])
    @scala.inline
