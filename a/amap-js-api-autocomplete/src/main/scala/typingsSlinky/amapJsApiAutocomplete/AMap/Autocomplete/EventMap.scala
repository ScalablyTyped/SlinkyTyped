...
trait EventMap extends js.Object {
  var choose: Event_[typingsSlinky.amapJsApiAutocomplete.amapJsApiAutocompleteStrings.choose, AnonTip] = js.native
  var complete: Event_[
    typingsSlinky.amapJsApiAutocomplete.amapJsApiAutocompleteStrings.complete, 
    SearchResult | AnonInfo
  ] = js.native
  var error: Event_[typingsSlinky.amapJsApiAutocomplete.amapJsApiAutocompleteStrings.error, AnonInfo] = js.native
  var select: Event_[typingsSlinky.amapJsApiAutocomplete.amapJsApiAutocompleteStrings.select, AnonTip] = js.native
}
...
object EventMap {
  ...
  implicit class EventMapOps[Self <: EventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChoose(value: Event_[choose, AnonTip]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("choose")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withComplete(value: Event_[complete, SearchResult | AnonInfo]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelect(value: Event_[select, AnonTip]): Self = {
        val ret = this.duplicate
