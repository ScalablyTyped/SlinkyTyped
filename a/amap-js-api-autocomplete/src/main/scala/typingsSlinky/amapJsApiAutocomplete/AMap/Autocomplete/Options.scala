...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(closeResultOnScroll)) __obj.updateDynamic("closeResultOnScroll")(closeResultOnScroll.get.asInstanceOf[js.Any])
    if (datatype != null) __obj.updateDynamic("datatype")(datatype.asInstanceOf[js.Any])
    if (input != null) __obj.updateDynamic("input")(input.asInstanceOf[js.Any])
    if (lang != null) __obj.updateDynamic("lang")(lang.asInstanceOf[js.Any])
    if (!js.isUndefined(outPutDirAuto)) __obj.updateDynamic("outPutDirAuto")(outPutDirAuto.get.asInstanceOf[js.Any])
