package typingsSlinky.apollographqlGraphqlPlaygroundHtml
...
object renderPlaygroundPageMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.apollographqlGraphqlPlaygroundHtml.apollographqlGraphqlPlaygroundHtmlStrings.line
    - typingsSlinky.apollographqlGraphqlPlaygroundHtml.apollographqlGraphqlPlaygroundHtmlStrings.block
    - typingsSlinky.apollographqlGraphqlPlaygroundHtml.apollographqlGraphqlPlaygroundHtmlStrings.underline
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.apollographqlGraphqlPlaygroundHtml.apollographqlGraphqlPlaygroundHtmlStrings.dark
    - typingsSlinky.apollographqlGraphqlPlaygroundHtml.apollographqlGraphqlPlaygroundHtmlStrings.light
  */
