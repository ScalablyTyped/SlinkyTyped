package typingsSlinky.awsSdkClientKinesisBrowser.typesDescribeStreamOutputMod

import typingsSlinky.awsSdkClientKinesisBrowser.outputTypesUnionMod.OutputTypesUnion
import typingsSlinky.awsSdkClientKinesisBrowser.typesStreamDescriptionMod.UnmarshalledStreamDescription
...
object DescribeStreamOutput {
  ...
  implicit class DescribeStreamOutputOps[Self <: DescribeStreamOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStreamDescription(value: UnmarshalledStreamDescription): Self = {
        val ret = this.duplicate
