...
@JSImport("@aws-sdk/client-kinesis-browser/types/DescribeStreamConsumerInput", JSImport.Namespace)
@js.native
object typesDescribeStreamConsumerInputMod extends js.Object {
  @js.native
