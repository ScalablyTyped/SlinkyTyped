package typingsSlinky.awsSdkClientKinesisBrowser.typesIncreaseStreamRetentionPeriodOutputMod
...
object IncreaseStreamRetentionPeriodOutput {
  ...
  @scala.inline
  implicit class IncreaseStreamRetentionPeriodOutputOps[Self <: IncreaseStreamRetentionPeriodOutput] (val x: Self) extends AnyVal {
