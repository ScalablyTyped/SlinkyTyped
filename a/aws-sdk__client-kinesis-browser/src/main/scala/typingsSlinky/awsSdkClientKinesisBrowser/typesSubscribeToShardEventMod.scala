...
object typesSubscribeToShardEventMod {
  ...
  object SubscribeToShardEvent {
    ...
    implicit class SubscribeToShardEventMutableBuilder[Self <: SubscribeToShardEvent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRecords(value: js.Array[Record] | js.Iterable[Record]): Self = StObject.set(x, "Records", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRecordsIterable(value: js.Iterable[Record]): Self = StObject.set(x, "Records", value.asInstanceOf[js.Any])
