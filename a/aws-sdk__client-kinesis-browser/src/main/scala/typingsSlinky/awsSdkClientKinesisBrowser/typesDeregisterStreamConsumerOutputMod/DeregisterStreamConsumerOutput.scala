package typingsSlinky.awsSdkClientKinesisBrowser.typesDeregisterStreamConsumerOutputMod
...
object DeregisterStreamConsumerOutput {
  ...
  @scala.inline
  implicit class DeregisterStreamConsumerOutputOps[Self <: DeregisterStreamConsumerOutput] (val x: Self) extends AnyVal {
