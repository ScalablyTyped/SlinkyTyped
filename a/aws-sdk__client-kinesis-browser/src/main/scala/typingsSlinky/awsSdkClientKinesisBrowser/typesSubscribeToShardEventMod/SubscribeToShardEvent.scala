...
object SubscribeToShardEvent {
  ...
  implicit class SubscribeToShardEventOps[Self <: SubscribeToShardEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRecordsIterable(value: js.Iterable[Record]): Self = this.set("Records", value.asInstanceOf[js.Any])
    @scala.inline
    def setRecords(value: js.Array[Record] | js.Iterable[Record]): Self = this.set("Records", value.asInstanceOf[js.Any])
  }
