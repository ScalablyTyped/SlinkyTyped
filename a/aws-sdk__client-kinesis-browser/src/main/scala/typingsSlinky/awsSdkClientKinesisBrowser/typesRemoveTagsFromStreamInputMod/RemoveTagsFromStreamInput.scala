package typingsSlinky.awsSdkClientKinesisBrowser.typesRemoveTagsFromStreamInputMod
...
object RemoveTagsFromStreamInput {
  ...
  @scala.inline
  def apply(StreamName: String, TagKeys: js.Array[String] | js.Iterable[String]): RemoveTagsFromStreamInput = {
  ...
  implicit class RemoveTagsFromStreamInputOps[Self <: RemoveTagsFromStreamInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagKeysIterable(value: js.Iterable[String]): Self = this.set("TagKeys", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTagKeys(value: js.Array[String] | js.Iterable[String]): Self = this.set("TagKeys", value.asInstanceOf[js.Any])
