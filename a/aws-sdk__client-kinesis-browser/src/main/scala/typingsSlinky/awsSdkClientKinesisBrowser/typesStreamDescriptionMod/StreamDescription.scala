...
object StreamDescription {
  ...
  implicit class StreamDescriptionOps[Self <: StreamDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnhancedMonitoringIterable(value: js.Iterable[EnhancedMetrics]): Self = this.set("EnhancedMonitoring", value.asInstanceOf[js.Any])
    @scala.inline
    def setEnhancedMonitoring(value: js.Array[EnhancedMetrics] | js.Iterable[EnhancedMetrics]): Self = this.set("EnhancedMonitoring", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setShardsIterable(value: js.Iterable[Shard]): Self = this.set("Shards", value.asInstanceOf[js.Any])
    @scala.inline
    def setShards(value: js.Array[Shard] | js.Iterable[Shard]): Self = this.set("Shards", value.asInstanceOf[js.Any])
    @scala.inline
    def setStreamARN(value: String): Self = this.set("StreamARN", value.asInstanceOf[js.Any])
    @scala.inline
    def setStreamCreationTimestampDate(value: js.Date): Self = this.set("StreamCreationTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
    def setStreamCreationTimestamp(value: js.Date | String | Double): Self = this.set("StreamCreationTimestamp", value.asInstanceOf[js.Any])
    @scala.inline
