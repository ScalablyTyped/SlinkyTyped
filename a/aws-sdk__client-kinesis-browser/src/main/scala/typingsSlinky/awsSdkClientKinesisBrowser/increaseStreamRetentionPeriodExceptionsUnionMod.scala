...
@JSImport("@aws-sdk/client-kinesis-browser/types/IncreaseStreamRetentionPeriodExceptionsUnion", JSImport.Namespace)
@js.native
object increaseStreamRetentionPeriodExceptionsUnionMod extends js.Object {
