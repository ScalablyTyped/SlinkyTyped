...
@JSImport("@aws-sdk/client-kinesis-browser/types/ListTagsForStreamExceptionsUnion", JSImport.Namespace)
@js.native
object listTagsForStreamExceptionsUnionMod extends js.Object {
