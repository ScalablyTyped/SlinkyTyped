...
@JSImport("@aws-sdk/client-kinesis-browser/types/DescribeStreamConsumerExceptionsUnion", JSImport.Namespace)
@js.native
object describeStreamConsumerExceptionsUnionMod extends js.Object {
