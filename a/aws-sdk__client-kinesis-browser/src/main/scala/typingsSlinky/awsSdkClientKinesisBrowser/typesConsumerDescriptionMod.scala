...
object typesConsumerDescriptionMod {
  ...
  object ConsumerDescription {
    ...
    implicit class ConsumerDescriptionMutableBuilder[Self <: ConsumerDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConsumerCreationTimestamp(value: js.Date | String | Double): Self = StObject.set(x, "ConsumerCreationTimestamp", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConsumerCreationTimestampDate(value: js.Date): Self = StObject.set(x, "ConsumerCreationTimestamp", value.asInstanceOf[js.Any])
