...
object typesPutRecordsInputMod {
  ...
  object PutRecordsInput {
    ...
    implicit class PutRecordsInputMutableBuilder[Self <: PutRecordsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRecords(value: js.Array[PutRecordsRequestEntry] | js.Iterable[PutRecordsRequestEntry]): Self = StObject.set(x, "Records", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRecordsIterable(value: js.Iterable[PutRecordsRequestEntry]): Self = StObject.set(x, "Records", value.asInstanceOf[js.Any])
