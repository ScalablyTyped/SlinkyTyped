...
object typesKmsoptinrequiredMod {
  ...
  object KMSOptInRequired {
    ...
    implicit class KMSOptInRequiredMutableBuilder[Self <: KMSOptInRequired] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSOptInRequired): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
