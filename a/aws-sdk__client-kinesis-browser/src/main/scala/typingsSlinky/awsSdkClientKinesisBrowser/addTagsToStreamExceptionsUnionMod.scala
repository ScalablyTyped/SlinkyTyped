...
@JSImport("@aws-sdk/client-kinesis-browser/types/AddTagsToStreamExceptionsUnion", JSImport.Namespace)
@js.native
object addTagsToStreamExceptionsUnionMod extends js.Object {
