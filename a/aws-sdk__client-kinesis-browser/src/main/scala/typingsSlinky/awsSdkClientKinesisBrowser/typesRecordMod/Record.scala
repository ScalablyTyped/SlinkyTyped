...
object Record {
  ...
  implicit class RecordOps[Self <: Record] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApproximateArrivalTimestampDate(value: js.Date): Self = this.set("ApproximateArrivalTimestamp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setApproximateArrivalTimestamp(value: js.Date | String | Double): Self = this.set("ApproximateArrivalTimestamp", value.asInstanceOf[js.Any])
