package typingsSlinky.awsSdkClientKinesisBrowser.typesGetShardIteratorInputMod
...
object GetShardIteratorInput {
  ...
  implicit class GetShardIteratorInputOps[Self <: GetShardIteratorInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withShardIteratorType(value: AT_SEQUENCE_NUMBER | AFTER_SEQUENCE_NUMBER | TRIM_HORIZON | LATEST | AT_TIMESTAMP | String): Self = {
        val ret = this.duplicate
