...
trait Shard extends js.Object {
  ...
  /**
    ...
    */
  var HashKeyRange: typingsSlinky.awsSdkClientKinesisBrowser.typesHashKeyRangeMod.HashKeyRange
  /**
  ...
  /**
    ...
    */
  var SequenceNumberRange: typingsSlinky.awsSdkClientKinesisBrowser.typesSequenceNumberRangeMod.SequenceNumberRange
  /**
