...
object typesMergeShardsInputMod {
  ...
  object MergeShardsInput {
    ...
    implicit class MergeShardsInputMutableBuilder[Self <: MergeShardsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdjacentShardToMerge(value: String): Self = StObject.set(x, "AdjacentShardToMerge", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShardToMerge(value: String): Self = StObject.set(x, "ShardToMerge", value.asInstanceOf[js.Any])
