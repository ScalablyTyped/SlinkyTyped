...
@JSImport("@aws-sdk/client-kinesis-browser/types/StopStreamEncryptionExceptionsUnion", JSImport.Namespace)
@js.native
object stopStreamEncryptionExceptionsUnionMod extends js.Object {
