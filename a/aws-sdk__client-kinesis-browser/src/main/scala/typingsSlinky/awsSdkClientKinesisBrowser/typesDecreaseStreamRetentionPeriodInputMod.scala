...
@JSImport("@aws-sdk/client-kinesis-browser/types/DecreaseStreamRetentionPeriodInput", JSImport.Namespace)
@js.native
object typesDecreaseStreamRetentionPeriodInputMod extends js.Object {
  @js.native
