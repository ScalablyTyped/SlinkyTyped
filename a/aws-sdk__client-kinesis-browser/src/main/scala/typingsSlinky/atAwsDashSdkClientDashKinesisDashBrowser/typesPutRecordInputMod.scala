...
@JSImport("@aws-sdk/client-kinesis-browser/types/PutRecordInput", JSImport.Namespace)
@js.native
object typesPutRecordInputMod extends js.Object {
  @js.native
  trait PutRecordInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Data: scala.scalajs.js.typedarray.ArrayBuffer | scala.scalajs.js.typedarray.ArrayBufferView | String = js.native
    /**
