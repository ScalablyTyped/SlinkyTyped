...
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreConsumerMod._UnmarshalledConsumer
...
object typesListStreamConsumersOutputMod extends js.Object {
  ...
  trait ListStreamConsumersOutput extends OutputTypesUnion {
    ...
    /**
      ...
      */
    var Consumers: js.UndefOr[js.Array[_UnmarshalledConsumer]] = js.native
    /**
