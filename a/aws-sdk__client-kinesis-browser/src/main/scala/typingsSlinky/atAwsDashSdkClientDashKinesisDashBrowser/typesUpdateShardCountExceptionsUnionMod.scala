...
@JSImport("@aws-sdk/client-kinesis-browser/types/UpdateShardCountExceptionsUnion", JSImport.Namespace)
@js.native
object typesUpdateShardCountExceptionsUnionMod extends js.Object {
