...
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscorePutRecordsRequestEntryMod._PutRecordsRequestEntry
...
object typesPutRecordsInputMod extends js.Object {
  ...
  trait PutRecordsInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Records: js.Array[_PutRecordsRequestEntry] | js.Iterable[_PutRecordsRequestEntry] = js.native
    /**
