package typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreSubscribeToShardEventStreamMod

import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreSubscribeToShardEventMod._UnmarshalledSubscribeToShardEvent
