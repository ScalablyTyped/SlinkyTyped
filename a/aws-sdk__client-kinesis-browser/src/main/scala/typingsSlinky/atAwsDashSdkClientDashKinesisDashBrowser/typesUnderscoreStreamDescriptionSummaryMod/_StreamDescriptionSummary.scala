...
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreEnhancedMetricsMod._EnhancedMetrics
...
trait _StreamDescriptionSummary extends js.Object {
  ...
  /**
    ...
    */
  var EnhancedMonitoring: js.Array[_EnhancedMetrics] | js.Iterable[_EnhancedMetrics]
  /**
...
object _StreamDescriptionSummary {
  @scala.inline
  def apply(
    EnhancedMonitoring: js.Array[_EnhancedMetrics] | js.Iterable[_EnhancedMetrics],
