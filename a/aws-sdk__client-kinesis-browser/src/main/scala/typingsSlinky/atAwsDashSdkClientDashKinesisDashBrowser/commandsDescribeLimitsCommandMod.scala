...
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesDescribeLimitsInputMod.DescribeLimitsInput
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesDescribeLimitsOutputMod.DescribeLimitsOutput
