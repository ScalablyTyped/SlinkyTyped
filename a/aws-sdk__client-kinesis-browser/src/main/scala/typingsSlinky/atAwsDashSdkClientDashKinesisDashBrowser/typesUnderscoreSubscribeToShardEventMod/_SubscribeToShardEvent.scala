package typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreSubscribeToShardEventMod

import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreRecordMod._Record
...
trait _SubscribeToShardEvent extends js.Object {
  ...
  /**
    * <p/>
    */
  var Records: js.Array[_Record] | js.Iterable[_Record]
}
...
object _SubscribeToShardEvent {
  ...
  def apply(
    ...
    Records: js.Array[_Record] | js.Iterable[_Record]
