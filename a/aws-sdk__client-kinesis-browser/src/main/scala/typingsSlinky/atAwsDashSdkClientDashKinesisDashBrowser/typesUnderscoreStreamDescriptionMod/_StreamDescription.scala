...
import typingsSlinky.atAwsDashSdkClientDashKinesisDashBrowser.typesUnderscoreShardMod._Shard
...
trait _StreamDescription extends js.Object {
  ...
  /**
    ...
    */
  var Shards: js.Array[_Shard] | js.Iterable[_Shard]
  /**
...
object _StreamDescription {
  ...
  def apply(
    ...
    Shards: js.Array[_Shard] | js.Iterable[_Shard],
    StreamARN: String,
