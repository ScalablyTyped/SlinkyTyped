...
trait IToast extends js.Object {
  ...
  var open: IPromise[_]
  var scope: typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToastScope
  var toastId: Double
}
...
object IToast {
  ...
  def apply(
    ...
    isOpened: Boolean,
    open: IPromise[_],
    scope: typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToastScope,
    toastId: Double
  ): IToast = {
