...
trait IToastrConfig
  extends typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToastConfig
     with typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToastContainerConfig
