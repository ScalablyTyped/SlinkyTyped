...
import typingsSlinky.angularDashToastr.Anon_Progressbar
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IToastOptions
  extends typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToastBaseConfig {
...
object IToastOptions {
  ...
  def apply(
    ...
    onHidden: (/* wasClicked */ Boolean, /* toast */ typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToast) => Unit = null,
    onShown: /* toast */ typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToast => Unit = null,
    onTap: /* toast */ typingsSlinky.angularDashToastr.angularDashToastrMod.angularMod.toastr.IToast => Unit = null,
