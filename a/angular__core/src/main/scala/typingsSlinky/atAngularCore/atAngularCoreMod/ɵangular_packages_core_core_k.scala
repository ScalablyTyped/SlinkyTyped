...
@js.native
class ɵangular_packages_core_core_k protected ()
  extends ɵangular_packages_core_core_j
     with DebugElement {
  def this(nativeNode: js.Any, parent: js.Any, _debugContext: ɵangular_packages_core_core_z) = this()
  /* CompleteClass */
