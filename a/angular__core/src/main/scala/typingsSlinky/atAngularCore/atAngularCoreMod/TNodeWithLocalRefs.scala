...
object TNodeWithLocalRefs {
  ...
  def ɵangular_packages_core_core_bf(
    ...
    `type`: TNodeType,
    attrs: TAttributes = null,
    child: typingsSlinky.atAngularCore.atAngularCoreMod.ɵangular_packages_core_core_bf | TTextNode | TElementContainerNode | TContainerNode | TProjectionNode = null,
    classes: StylingMapArray | TStylingContext = null,
    initialInputs: InitialInputData = null,
    inputs: PropertyAliases = null,
    localNames: js.Array[String | Double] = null,
    next: TNode = null,
    outputs: PropertyAliases = null,
    parent: typingsSlinky.atAngularCore.atAngularCoreMod.ɵangular_packages_core_core_bf | TElementContainerNode = null,
  ...
  def TElementContainerNode(
    ...
    `type`: TNodeType,
    attrs: TAttributes = null,
    child: ɵangular_packages_core_core_bf | TTextNode | TContainerNode | typingsSlinky.atAngularCore.atAngularCoreMod.TElementContainerNode | TProjectionNode = null,
    classes: StylingMapArray | TStylingContext = null,
    initialInputs: InitialInputData = null,
    inputs: PropertyAliases = null,
    localNames: js.Array[String | Double] = null,
    next: TNode = null,
    outputs: PropertyAliases = null,
    parent: ɵangular_packages_core_core_bf | typingsSlinky.atAngularCore.atAngularCoreMod.TElementContainerNode = null,
    projectionNext: TNode = null,
    styles: StylingMapArray | TStylingContext = null,
    tagName: String = null
  ): TNodeWithLocalRefs = {
