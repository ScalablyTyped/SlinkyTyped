...
object RendererStyleFlags2 extends js.Object {
  ...
  /* 2 */ val DashCase: typingsSlinky.atAngularCore.atAngularCoreMod.RendererStyleFlags2.DashCase with Double = js.native
  /* 1 */ val Important: typingsSlinky.atAngularCore.atAngularCoreMod.RendererStyleFlags2.Important with Double = js.native
  @JSBracketAccess
