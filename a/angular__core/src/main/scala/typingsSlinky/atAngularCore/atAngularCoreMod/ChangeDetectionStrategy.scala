...
object ChangeDetectionStrategy extends js.Object {
  ...
  /* 1 */ val Default: typingsSlinky.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy.Default with Double = js.native
  /* 0 */ val OnPush: typingsSlinky.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy.OnPush with Double = js.native
  @JSBracketAccess
