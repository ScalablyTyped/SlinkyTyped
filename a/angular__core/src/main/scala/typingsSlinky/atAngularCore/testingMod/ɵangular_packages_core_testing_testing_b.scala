...
class ɵangular_packages_core_testing_testing_b ()
  extends typingsSlinky.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_b
...
object ɵangular_packages_core_testing_testing_b extends js.Object {
  ...
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef): typingsSlinky.atAngularCore.testingTestingMod.TestBed = js.native
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.atAngularCore.testingTestingMod.TestBed = js.native
  /**
    ...
    * @publicApi
    */
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef): typingsSlinky.atAngularCore.testingTestingMod.TestBed = js.native
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.atAngularCore.testingTestingMod.TestBed = js.native
