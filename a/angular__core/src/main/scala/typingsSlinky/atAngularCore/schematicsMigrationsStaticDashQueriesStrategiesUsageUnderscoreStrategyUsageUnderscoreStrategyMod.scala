...
import typingsSlinky.atAngularCore.schematicsMigrationsStaticDashQueriesStrategiesTimingDashStrategyMod.TimingResult
import typingsSlinky.atAngularCore.schematicsMigrationsStaticDashQueriesStrategiesTimingDashStrategyMod.TimingStrategy
