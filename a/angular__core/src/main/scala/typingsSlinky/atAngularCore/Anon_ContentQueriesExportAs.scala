...
import typingsSlinky.atAngularCore.atAngularCoreMod.DirectiveDefFeature
...
import typingsSlinky.atAngularCore.atAngularCoreMod.SelectorFlags
...
trait Anon_ContentQueriesExportAs[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string] | undefined}
    */ typingsSlinky.atAngularCore.atAngularCoreStrings.Anon_ContentQueriesExportAs with js.Any
  ] = js.native
  /**
