...
import typingsSlinky.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy
import typingsSlinky.atAngularCore.atAngularCoreMod.ComponentDefFeature
import typingsSlinky.atAngularCore.atAngularCoreMod.ComponentTemplate
import typingsSlinky.atAngularCore.atAngularCoreMod.ContentQueriesFunction
import typingsSlinky.atAngularCore.atAngularCoreMod.DirectiveTypesOrFactory
import typingsSlinky.atAngularCore.atAngularCoreMod.FactoryFn
import typingsSlinky.atAngularCore.atAngularCoreMod.HostBindingsFunction
import typingsSlinky.atAngularCore.atAngularCoreMod.PipeTypesOrFactory
import typingsSlinky.atAngularCore.atAngularCoreMod.SchemaMetadata
import typingsSlinky.atAngularCore.atAngularCoreMod.Type
import typingsSlinky.atAngularCore.atAngularCoreMod.ViewEncapsulation
import typingsSlinky.atAngularCore.atAngularCoreMod.ViewQueriesFunction
import typingsSlinky.atAngularCore.atAngularCoreMod.ɵCssSelectorList
import typingsSlinky.atAngularCore.atAngularCoreMod.ɵRenderFlags
...
trait Anon_ChangeDetection[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string]}
    */ typingsSlinky.atAngularCore.atAngularCoreStrings.Anon_ChangeDetection with js.Any
  ] = js.native
  /**
