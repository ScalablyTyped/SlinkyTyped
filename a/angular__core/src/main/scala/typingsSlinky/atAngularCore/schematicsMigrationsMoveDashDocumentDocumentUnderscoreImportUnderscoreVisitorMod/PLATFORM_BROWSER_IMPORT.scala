...
import typingsSlinky.atAngularCore.atAngularCoreStrings.`@angular/platform-browser`
...
@js.native
object PLATFORM_BROWSER_IMPORT extends TopLevel[`@angular/platform-browser`]
