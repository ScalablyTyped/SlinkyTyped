...
trait Anon_ContentQueries[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string]}
    */ typingsSlinky.atAngularCore.atAngularCoreStrings.Anon_ContentQueries with js.Any
  ] = js.undefined
  /**
...
object Anon_ContentQueries {
  ...
  {[ P in keyof T ]:? string | [string, string]}
    */ typingsSlinky.atAngularCore.atAngularCoreStrings.Anon_ContentQueries with js.Any = null,
