...
import typingsSlinky.angularCore.testingTestingMod.MetadataOverride
import typingsSlinky.angularCore.testingTestingMod.TestBedStatic
...
object testingMod {
  ...
  class InjectSetupWrapper protected ()
    extends typingsSlinky.angularCore.testingTestingMod.InjectSetupWrapper {
  ...
  class TestComponentRenderer ()
    extends typingsSlinky.angularCore.testingTestingMod.TestComponentRenderer
  ...
  @js.native
  def getTestBed(): typingsSlinky.angularCore.testingTestingMod.TestBed = js.native
  ...
  @js.native
  def withModule(moduleDef: TestModuleMetadata): typingsSlinky.angularCore.testingTestingMod.InjectSetupWrapper = js.native
  @JSImport("@angular/core/testing", "withModule")
  @js.native
  ...
  class ɵTestingCompiler ()
    extends typingsSlinky.angularCore.testingTestingMod.ɵTestingCompiler
  
  @JSImport("@angular/core/testing", "\u0275TestingCompilerFactory")
  @js.native
  abstract class ɵTestingCompilerFactory ()
    extends typingsSlinky.angularCore.testingTestingMod.ɵTestingCompilerFactory
  
  @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_a")
  @js.native
  class ɵangularPackagesCoreTestingTestingA ()
    extends typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA
  /* static members */
  object ɵangularPackagesCoreTestingTestingA {
    ...
    @js.native
    def createComponent[T](component: Type[T]): typingsSlinky.angularCore.testingTestingMod.ComponentFixture[T] = js.native
    ...
    @js.native
    def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef): typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_a.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
    /**
    ...
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_a.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: Type[_], platform: PlatformRef): typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_a.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: Type[_], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
  ...
  class ɵangularPackagesCoreTestingTestingB ()
    extends typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingB
  /* static members */
  object ɵangularPackagesCoreTestingTestingB {
    ...
    @js.native
    def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef): typingsSlinky.angularCore.testingTestingMod.TestBed = js.native
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_b.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.angularCore.testingTestingMod.TestBed = js.native
    /**
      * Initialize the environment for testing with a compiler factory, a PlatformRef, and an
      * angular module. These are common to every test in the suite.
      *
    ...
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_b.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: Type[_], platform: PlatformRef): typingsSlinky.angularCore.testingTestingMod.TestBed = js.native
    @JSImport("@angular/core/testing", "\u0275angular_packages_core_testing_testing_b.initTestEnvironment")
    @js.native
    def initTestEnvironment(ngModule: Type[_], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsSlinky.angularCore.testingTestingMod.TestBed = js.native
  ...
  @js.native
  def ɵangularPackagesCoreTestingTestingC(): typingsSlinky.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingB = js.native
}
