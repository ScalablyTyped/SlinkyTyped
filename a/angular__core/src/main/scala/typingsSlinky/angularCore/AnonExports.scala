...
@js.native
trait AnonExports[T] extends js.Object {
...
object AnonExports {
  @scala.inline
  def apply[T](`type`: T): AnonExports[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonExports[T]]
  }
  @scala.inline
  implicit class AnonExportsOps[Self[t] <: AnonExports[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
