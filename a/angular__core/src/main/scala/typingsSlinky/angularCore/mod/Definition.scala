...
object Definition {
  @scala.inline
  def apply[/* <: typingsSlinky.angularCore.mod.DefinitionFactory[_] */ DF](): Definition[DF] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Definition[DF]]
  }
  @scala.inline
  implicit class DefinitionOps[Self <: Definition[_], /* <: typingsSlinky.angularCore.mod.DefinitionFactory[_] */ DF] (val x: Self with Definition[DF]) extends AnyVal {
    @scala.inline
