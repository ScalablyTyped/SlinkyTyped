...
trait InjectorTypeWithProviders[T] extends StObject {
  ...
  var providers: js.UndefOr[
    js.Array[
      typingsSlinky.angularCore.mod.Type[_] | ValueProvider | ExistingProvider | FactoryProvider | ConstructorProvider | StaticClassProvider | ClassProvider | js.Array[_]
    ]
  ] = js.native
}
object InjectorTypeWithProviders {
  ...
  implicit class InjectorTypeWithProvidersMutableBuilder[Self <: InjectorTypeWithProviders[_], T] (val x: Self with InjectorTypeWithProviders[T]) extends AnyVal {
    ...
    def setProvidersVarargs(
      value: (typingsSlinky.angularCore.mod.Type[js.Any] | ValueProvider | ExistingProvider | FactoryProvider | ConstructorProvider | StaticClassProvider | ClassProvider | js.Array[js.Any])*
