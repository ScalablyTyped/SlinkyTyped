...
trait PlatformReflectionCapabilities extends StObject {
  ...
  /**
    ...
    */
  def annotations(`type`: typingsSlinky.angularCore.mod.Type[_]): js.Array[_] = js.native
  
  def factory(`type`: typingsSlinky.angularCore.mod.Type[_]): js.Function = js.native
  ...
  def importUri(`type`: typingsSlinky.angularCore.mod.Type[_]): String = js.native
  ...
  /**
    ...
    */
  def parameters(`type`: typingsSlinky.angularCore.mod.Type[_]): js.Array[js.Array[_]] = js.native
  
  /**
    * Return a object literal which describes the annotations on Class fields/properties.
    */
  def propMetadata(typeOrFunc: typingsSlinky.angularCore.mod.Type[_]): StringDictionary[js.Array[_]] = js.native
  ...
  def resourceUri(`type`: typingsSlinky.angularCore.mod.Type[_]): String = js.native
...
object PlatformReflectionCapabilities {
  ...
  @scala.inline
  def apply(
    annotations: typingsSlinky.angularCore.mod.Type[_] => js.Array[_],
    factory: typingsSlinky.angularCore.mod.Type[_] => js.Function,
    getter: String => ɵGetterFn,
    guards: js.Any => StringDictionary[js.Any],
    hasLifecycleHook: (js.Any, String) => Boolean,
    importUri: typingsSlinky.angularCore.mod.Type[_] => String,
    isReflectionEnabled: () => Boolean,
    method: String => ɵMethodFn,
    parameters: typingsSlinky.angularCore.mod.Type[_] => js.Array[js.Array[_]],
    propMetadata: typingsSlinky.angularCore.mod.Type[_] => StringDictionary[js.Array[_]],
    resolveEnum: (js.Any, String) => js.Any,
    resolveIdentifier: (String, String, js.Array[String], js.Any) => js.Any,
    resourceUri: typingsSlinky.angularCore.mod.Type[_] => String,
  ...
  implicit class PlatformReflectionCapabilitiesMutableBuilder[Self <: PlatformReflectionCapabilities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnotations(value: typingsSlinky.angularCore.mod.Type[_] => js.Array[_]): Self = StObject.set(x, "annotations", js.Any.fromFunction1(value))
    
    @scala.inline
    def setFactory(value: typingsSlinky.angularCore.mod.Type[_] => js.Function): Self = StObject.set(x, "factory", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setImportUri(value: typingsSlinky.angularCore.mod.Type[_] => String): Self = StObject.set(x, "importUri", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setParameters(value: typingsSlinky.angularCore.mod.Type[_] => js.Array[js.Array[_]]): Self = StObject.set(x, "parameters", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPropMetadata(value: typingsSlinky.angularCore.mod.Type[_] => StringDictionary[js.Array[_]]): Self = StObject.set(x, "propMetadata", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setResourceUri(value: typingsSlinky.angularCore.mod.Type[_] => String): Self = StObject.set(x, "resourceUri", js.Any.fromFunction1(value))
