...
object TQuery {
  ...
  implicit class TQueryOps[Self <: TQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCrossesNgTemplate(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("crossesNgTemplate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withElementEnd(value: TNode => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("elementEnd")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withElementStart(value: (TView, TNode) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("elementStart")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withEmbeddedTView(value: (TNode, Double) => TQuery | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("embeddedTView")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withIndexInDeclarationView(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("indexInDeclarationView")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMetadata(value: TQueryMetadata): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("metadata")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTemplate(value: (TView, TNode) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("template")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withMatches(value: js.Array[Double]): Self = {
        val ret = this.duplicate
