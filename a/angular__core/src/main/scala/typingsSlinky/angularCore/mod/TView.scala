...
object TView {
  ...
  implicit class TViewMutableBuilder[Self <: TView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(
      value: (TNode | ɵPipeDef[js.Any] | ɵDirectiveDef[js.Any] | ɵComponentDef[js.Any] | Double | TStylingRange | TStylingKey | typingsSlinky.angularCore.mod.Type[js.Any] | InjectionToken[js.Any] | TI18n | I18nUpdateOpCodes | TIcu | Null | String)*
