...
trait ModuleWithProviders[T] extends StObject {
  ...
  var ngModule: typingsSlinky.angularCore.mod.Type[T] = js.native
...
object ModuleWithProviders {
  ...
  @scala.inline
  def apply[T](ngModule: typingsSlinky.angularCore.mod.Type[T]): ModuleWithProviders[T] = {
  ...
  implicit class ModuleWithProvidersMutableBuilder[Self <: ModuleWithProviders[_], T] (val x: Self with ModuleWithProviders[T]) extends AnyVal {
    ...
    @scala.inline
    def setNgModule(value: typingsSlinky.angularCore.mod.Type[T]): Self = StObject.set(x, "ngModule", value.asInstanceOf[js.Any])
