...
object TQueries {
  ...
  implicit class TQueriesOps[Self <: TQueries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEmbeddedTView(value: TNode => TQueries | Null): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("embeddedTView")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetByIndex(value: Double => TQuery): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getByIndex")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTrack(value: TQuery => Unit): Self = {
        val ret = this.duplicate
