...
import typingsSlinky.angularCore.anon.Parent
...
abstract class Injector () extends StObject {
  ...
  /**
    ...
    */
  def get[T](token: typingsSlinky.angularCore.mod.Type[T]): T = js.native
  def get[T](token: typingsSlinky.angularCore.mod.Type[T], notFoundValue: T): T = js.native
  def get[T](token: typingsSlinky.angularCore.mod.Type[T], notFoundValue: T, flags: InjectFlags): T = js.native
  def get[T](
    token: typingsSlinky.angularCore.mod.Type[T],
