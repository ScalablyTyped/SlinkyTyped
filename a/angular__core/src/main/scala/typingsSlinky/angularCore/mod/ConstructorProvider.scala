...
trait ConstructorProvider
  ...
  /**
    ...
    */
  var provide: typingsSlinky.angularCore.mod.Type[_] = js.native
}
object ConstructorProvider {
  
  @scala.inline
  def apply(provide: typingsSlinky.angularCore.mod.Type[_]): ConstructorProvider = {
  ...
  implicit class ConstructorProviderMutableBuilder[Self <: ConstructorProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProvide(value: typingsSlinky.angularCore.mod.Type[_]): Self = StObject.set(x, "provide", value.asInstanceOf[js.Any])
  }
}
