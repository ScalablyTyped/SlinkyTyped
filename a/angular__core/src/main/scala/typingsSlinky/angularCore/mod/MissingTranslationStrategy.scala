...
object MissingTranslationStrategy extends StObject {
  ...
  /* 0 */ val Error: typingsSlinky.angularCore.mod.MissingTranslationStrategy.Error with Double = js.native
  
  @js.native
  sealed trait Ignore extends MissingTranslationStrategy
  /* 2 */ val Ignore: typingsSlinky.angularCore.mod.MissingTranslationStrategy.Ignore with Double = js.native
  
  @js.native
  sealed trait Warning extends MissingTranslationStrategy
  /* 1 */ val Warning: typingsSlinky.angularCore.mod.MissingTranslationStrategy.Warning with Double = js.native
}
