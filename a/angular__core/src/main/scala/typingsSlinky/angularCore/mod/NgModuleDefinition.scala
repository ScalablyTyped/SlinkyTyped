...
object NgModuleDefinition {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(isRoot = isRoot.asInstanceOf[js.Any], modules = modules.asInstanceOf[js.Any], providers = providers.asInstanceOf[js.Any], providersByKey = providersByKey.asInstanceOf[js.Any], factory = factory.asInstanceOf[js.Any])
