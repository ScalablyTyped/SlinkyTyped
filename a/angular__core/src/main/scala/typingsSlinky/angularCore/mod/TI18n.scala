...
object TI18n {
  ...
  def apply(create: I18nMutateOpCodes, update: I18nUpdateOpCodes, vars: Double, icus: js.Array[TIcu] = null): TI18n = {
    val __obj = js.Dynamic.literal(create = create.asInstanceOf[js.Any], update = update.asInstanceOf[js.Any], vars = vars.asInstanceOf[js.Any], icus = icus.asInstanceOf[js.Any])
