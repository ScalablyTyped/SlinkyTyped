...
object ViewEncapsulation extends StObject {
  ...
  /* 0 */ val Emulated: typingsSlinky.angularCore.mod.ViewEncapsulation.Emulated with Double = js.native
  ...
  /* 2 */ val None: typingsSlinky.angularCore.mod.ViewEncapsulation.None with Double = js.native
  ...
  /* 3 */ val ShadowDom: typingsSlinky.angularCore.mod.ViewEncapsulation.ShadowDom with Double = js.native
}
