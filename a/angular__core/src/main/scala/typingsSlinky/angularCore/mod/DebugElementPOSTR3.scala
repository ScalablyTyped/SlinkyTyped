...
trait DebugElementPOSTR3
  ...
  val nativeElement_DebugElementPOSTR3: Element | Null = js.native
}
...
object DebugElementPOSTR3 {
  ...
  implicit class DebugElementPOSTR3Ops[Self <: DebugElementPOSTR3] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNativeElement(value: Element): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nativeElement")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNativeElementNull: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nativeElement")(null)
        ret
    }
  }
