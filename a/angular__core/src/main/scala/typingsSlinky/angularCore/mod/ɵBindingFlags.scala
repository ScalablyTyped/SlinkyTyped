...
import typingsSlinky.angularCore.angularCoreNumbers.`15`
...
import typingsSlinky.angularCore.angularCoreNumbers.`48`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.angularCore.angularCoreNumbers.`48`
  - typingsSlinky.angularCore.angularCoreNumbers.`15`
*/
