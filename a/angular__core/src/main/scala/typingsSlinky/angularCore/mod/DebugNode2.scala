...
trait DebugNode2 extends StObject {
  ...
  /**
    ...
    */
  var factories: js.Array[typingsSlinky.angularCore.mod.Type[_]] = js.native
...
object DebugNode2 {
  ...
  def apply(
    ...
    factories: js.Array[typingsSlinky.angularCore.mod.Type[_]],
  ...
  implicit class DebugNode2MutableBuilder[Self <: DebugNode2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFactories(value: js.Array[typingsSlinky.angularCore.mod.Type[_]]): Self = StObject.set(x, "factories", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFactoriesVarargs(value: typingsSlinky.angularCore.mod.Type[js.Any]*): Self = StObject.set(x, "factories", js.Array(value :_*))
