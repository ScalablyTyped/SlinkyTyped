...
import typingsSlinky.angularCore.angularCoreStrings.`Brand for PlayerFactory that nothing will match`
...
object ɵPlayerFactory {
  ...
  implicit class ɵPlayerFactoryOps[Self <: ɵPlayerFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def with__brand__(value: `Brand for PlayerFactory that nothing will match`): Self = {
