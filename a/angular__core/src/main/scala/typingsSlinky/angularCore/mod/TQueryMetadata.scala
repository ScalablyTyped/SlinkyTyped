...
trait TQueryMetadata extends StObject {
  ...
  var predicate: typingsSlinky.angularCore.mod.Type[_] | InjectionToken[_] | js.Array[String] = js.native
...
object TQueryMetadata {
  ...
  def apply(
    descendants: Boolean,
    isStatic: Boolean,
    predicate: typingsSlinky.angularCore.mod.Type[_] | InjectionToken[_] | js.Array[String],
    read: js.Any
  ): TQueryMetadata = {
  ...
  implicit class TQueryMetadataMutableBuilder[Self <: TQueryMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPredicate(value: typingsSlinky.angularCore.mod.Type[_] | InjectionToken[_] | js.Array[String]): Self = StObject.set(x, "predicate", value.asInstanceOf[js.Any])
