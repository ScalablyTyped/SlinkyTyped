...
object RendererStyleFlags2 extends StObject {
  ...
  /* 2 */ val DashCase: typingsSlinky.angularCore.mod.RendererStyleFlags2.DashCase with Double = js.native
  ...
  /* 1 */ val Important: typingsSlinky.angularCore.mod.RendererStyleFlags2.Important with Double = js.native
}
