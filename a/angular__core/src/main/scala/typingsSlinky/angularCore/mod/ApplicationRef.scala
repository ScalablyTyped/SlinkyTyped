...
class ApplicationRef () extends StObject {
  ...
  def bootstrap[C](componentOrFactory: typingsSlinky.angularCore.mod.Type[C]): ComponentRef[C] = js.native
  def bootstrap[C](componentOrFactory: typingsSlinky.angularCore.mod.Type[C], rootSelectorOrNode: String): ComponentRef[C] = js.native
  def bootstrap[C](componentOrFactory: typingsSlinky.angularCore.mod.Type[C], rootSelectorOrNode: js.Any): ComponentRef[C] = js.native
  
  /**
    * Get a list of component types registered to this application.
    * This list is populated even before the component is created.
    */
  val componentTypes: js.Array[typingsSlinky.angularCore.mod.Type[_]] = js.native
