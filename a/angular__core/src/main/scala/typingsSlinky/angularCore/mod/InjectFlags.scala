...
object InjectFlags extends js.Object {
  ...
  /* 1 */ @js.native
  object Host
    extends TopLevel[typingsSlinky.angularCore.mod.InjectFlags.Host with Double]
  ...
  /* 8 */ @js.native
  object Optional
    extends TopLevel[typingsSlinky.angularCore.mod.InjectFlags.Optional with Double]
  ...
  /* 2 */ @js.native
  object Self
    extends TopLevel[typingsSlinky.angularCore.mod.InjectFlags.Self with Double]
  ...
  /* 4 */ @js.native
  object SkipSelf
    extends TopLevel[typingsSlinky.angularCore.mod.InjectFlags.SkipSelf with Double]
}
