...
trait NodeInjectorDebug extends StObject {
  ...
  /**
    ...
    */
  var providers: js.Array[typingsSlinky.angularCore.mod.Type[_] | ɵDirectiveDef[_] | ɵComponentDef[_]] = js.native
  
  /**
    * A list of providers associated with this injector visible to the view of the component only.
    */
  var viewProviders: js.Array[typingsSlinky.angularCore.mod.Type[_]] = js.native
}
object NodeInjectorDebug {
  ...
  def apply(
    ...
    providers: js.Array[typingsSlinky.angularCore.mod.Type[_] | ɵDirectiveDef[_] | ɵComponentDef[_]],
    viewProviders: js.Array[typingsSlinky.angularCore.mod.Type[_]]
  ): NodeInjectorDebug = {
  ...
  implicit class NodeInjectorDebugMutableBuilder[Self <: NodeInjectorDebug] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProviders(value: js.Array[typingsSlinky.angularCore.mod.Type[_] | ɵDirectiveDef[_] | ɵComponentDef[_]]): Self = StObject.set(x, "providers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProvidersVarargs(
      value: (typingsSlinky.angularCore.mod.Type[js.Any] | ɵDirectiveDef[js.Any] | ɵComponentDef[js.Any])*
    ): Self = StObject.set(x, "providers", js.Array(value :_*))
    
    @scala.inline
    def setViewProviders(value: js.Array[typingsSlinky.angularCore.mod.Type[_]]): Self = StObject.set(x, "viewProviders", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setViewProvidersVarargs(value: typingsSlinky.angularCore.mod.Type[js.Any]*): Self = StObject.set(x, "viewProviders", js.Array(value :_*))
  }
}
