...
trait R3Injector extends StObject {
  ...
  def get[T](token: typingsSlinky.angularCore.mod.Type[T], notFoundValue: js.Any): T = js.native
  def get[T](token: typingsSlinky.angularCore.mod.Type[T], notFoundValue: js.Any, flags: InjectFlags): T = js.native
