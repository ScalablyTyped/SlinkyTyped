...
object queryDefinitionMod {
  ...
  object QueryTiming extends StObject {
    ...
    /* 1 */ val DYNAMIC: typingsSlinky.angularCore.queryDefinitionMod.QueryTiming.DYNAMIC with Double = js.native
    
    @js.native
    sealed trait STATIC extends QueryTiming
    /* 0 */ val STATIC: typingsSlinky.angularCore.queryDefinitionMod.QueryTiming.STATIC with Double = js.native
  }
  ...
  object QueryType extends StObject {
    ...
    /* 1 */ val ContentChild: typingsSlinky.angularCore.queryDefinitionMod.QueryType.ContentChild with Double = js.native
    
    @js.native
    sealed trait ViewChild extends QueryType
    /* 0 */ val ViewChild: typingsSlinky.angularCore.queryDefinitionMod.QueryType.ViewChild with Double = js.native
  }
