...
*/
trait fmDragState extends js.Object
object fmDragState {
  
  @scala.inline
  def fmDragStateEnter: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def fmDragStateLeave: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def fmDragStateOver: `2` = 2.asInstanceOf[`2`]
}
