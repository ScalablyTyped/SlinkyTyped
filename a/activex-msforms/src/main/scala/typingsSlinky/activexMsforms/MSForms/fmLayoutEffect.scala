...
*/
trait fmLayoutEffect extends StObject
object fmLayoutEffect {
  
  @scala.inline
  def _fmLayoutEffectRespond: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def fmLayoutEffectInitiate: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def fmLayoutEffectNone: `0` = 0.asInstanceOf[`0`]
}
