...
object ToggleButton {
  ...
  implicit class ToggleButtonOps[Self <: ToggleButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMSFormsDotToggleButton_typekey(value: ToggleButton): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MSForms.ToggleButton_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
