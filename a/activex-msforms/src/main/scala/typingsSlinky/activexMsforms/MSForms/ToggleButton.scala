...
object ToggleButton {
  ...
  @scala.inline
  implicit class ToggleButtonMutableBuilder[Self <: ToggleButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSFormsDotToggleButton_typekey(value: ToggleButton): Self = StObject.set(x, "MSForms.ToggleButton_typekey", value.asInstanceOf[js.Any])
