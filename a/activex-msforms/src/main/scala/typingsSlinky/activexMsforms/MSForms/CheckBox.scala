...
object CheckBox {
  ...
  def apply(
    ...
    GroupName: String,
    Locked: Boolean,
    MSFormsDotCheckBox_typekey: CheckBox,
  ...
  implicit class CheckBoxMutableBuilder[Self <: CheckBox] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSFormsDotCheckBox_typekey(value: CheckBox): Self = StObject.set(x, "MSForms.CheckBox_typekey", value.asInstanceOf[js.Any])
