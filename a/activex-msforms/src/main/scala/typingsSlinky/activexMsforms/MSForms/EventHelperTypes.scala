...
import typingsSlinky.activexMsforms.activexMsformsStrings.Action
import typingsSlinky.activexMsforms.activexMsformsStrings.ActionX
import typingsSlinky.activexMsforms.activexMsformsStrings.ActionY
import typingsSlinky.activexMsforms.activexMsformsStrings.ActualDx
import typingsSlinky.activexMsforms.activexMsformsStrings.ActualDy
import typingsSlinky.activexMsforms.activexMsformsStrings.Cancel
import typingsSlinky.activexMsforms.activexMsformsStrings.CancelDisplay
import typingsSlinky.activexMsforms.activexMsformsStrings.Data
import typingsSlinky.activexMsforms.activexMsformsStrings.Description
import typingsSlinky.activexMsforms.activexMsformsStrings.DragState
import typingsSlinky.activexMsforms.activexMsformsStrings.Effect
import typingsSlinky.activexMsforms.activexMsformsStrings.HelpContext
import typingsSlinky.activexMsforms.activexMsformsStrings.HelpFile
import typingsSlinky.activexMsforms.activexMsformsStrings.Index
import typingsSlinky.activexMsforms.activexMsformsStrings.Number
import typingsSlinky.activexMsforms.activexMsformsStrings.RequestDx
import typingsSlinky.activexMsforms.activexMsformsStrings.RequestDy
import typingsSlinky.activexMsforms.activexMsformsStrings.SCode
import typingsSlinky.activexMsforms.activexMsformsStrings.Shift
import typingsSlinky.activexMsforms.activexMsformsStrings.Source
import typingsSlinky.activexMsforms.activexMsformsStrings.State
...
object EventHelperTypes {
  ...
  type ContainerBeforeDragOverArgNames = js.Tuple8[
    Cancel, 
    typingsSlinky.activexMsforms.activexMsformsStrings.Control, 
    Data, 
    X, 
    Y, 
    State, 
