...
class HTMLCheckbox protected ()
  extends typingsSlinky.activexMsforms.MSForms.HTMLCheckbox {
  /* CompleteClass */
  ...
  override var MSFormsDotHTMLCheckbox_typekey: typingsSlinky.activexMsforms.MSForms.HTMLCheckbox = js.native
  /* CompleteClass */
