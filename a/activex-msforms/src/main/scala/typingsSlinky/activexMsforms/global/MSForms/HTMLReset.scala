...
class HTMLReset protected ()
  extends typingsSlinky.activexMsforms.MSForms.HTMLReset {
  /* CompleteClass */
  ...
  override var MSFormsDotHTMLReset_typekey: typingsSlinky.activexMsforms.MSForms.HTMLReset = js.native
}
