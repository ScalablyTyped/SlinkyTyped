...
class HTMLSubmit protected ()
  extends typingsSlinky.activexMsforms.MSForms.HTMLSubmit {
  /* CompleteClass */
  ...
  override var MSFormsDotHTMLSubmit_typekey: typingsSlinky.activexMsforms.MSForms.HTMLSubmit = js.native
  /* CompleteClass */
