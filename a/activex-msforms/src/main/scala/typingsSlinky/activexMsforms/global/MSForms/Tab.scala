...
@js.native
class Tab protected ()
  extends typingsSlinky.activexMsforms.MSForms.Tab {
  /* CompleteClass */
  override var Accelerator: String = js.native
  /* CompleteClass */
  override var Caption: String = js.native
  /* CompleteClass */
  override var ControlTipText: String = js.native
  /* CompleteClass */
  ...
  override var MSFormsDotTab_typekey: typingsSlinky.activexMsforms.MSForms.Tab = js.native
  /* CompleteClass */
