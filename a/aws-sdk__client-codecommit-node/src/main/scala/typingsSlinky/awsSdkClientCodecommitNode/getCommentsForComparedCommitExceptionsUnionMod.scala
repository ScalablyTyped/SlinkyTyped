...
@JSImport("@aws-sdk/client-codecommit-node/types/GetCommentsForComparedCommitExceptionsUnion", JSImport.Namespace)
@js.native
object getCommentsForComparedCommitExceptionsUnionMod extends js.Object {
