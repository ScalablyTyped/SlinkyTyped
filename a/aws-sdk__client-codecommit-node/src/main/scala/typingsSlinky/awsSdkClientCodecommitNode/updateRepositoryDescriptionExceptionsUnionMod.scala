...
object updateRepositoryDescriptionExceptionsUnionMod {
  ...
  */
  ...
  object UpdateRepositoryDescriptionExceptionsUnion {
    ...
    def InvalidRepositoryDescriptionException(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCodecommitNode.typesInvalidRepositoryDescriptionExceptionMod.InvalidRepositoryDescriptionException]
    }
