package typingsSlinky.awsSdkClientCodecommitNode.typesEncryptionKeyNotFoundExceptionMod
...
trait EncryptionKeyNotFoundException
  ...
  @JSName("name")
  var name_EncryptionKeyNotFoundException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyNotFoundException = js.native
}
...
object EncryptionKeyNotFoundException {
  ...
  def apply(
    ...
    details: EncryptionKeyNotFoundExceptionDetails,
    message: String,
  ...
  @scala.inline
  implicit class EncryptionKeyNotFoundExceptionOps[Self <: EncryptionKeyNotFoundException] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setName(
      value: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyNotFoundException
