...
object RepositoryTrigger {
  ...
  implicit class RepositoryTriggerOps[Self <: RepositoryTrigger] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventsIterable(value: js.Iterable[all | updateReference | createReference | deleteReference | String]): Self = this.set("events", value.asInstanceOf[js.Any])
    @scala.inline
    def setEvents(
    ...
    @scala.inline
    def setBranchesIterable(value: js.Iterable[String]): Self = this.set("branches", value.asInstanceOf[js.Any])
    @scala.inline
    def setBranches(value: js.Array[String] | js.Iterable[String]): Self = this.set("branches", value.asInstanceOf[js.Any])
    @scala.inline
