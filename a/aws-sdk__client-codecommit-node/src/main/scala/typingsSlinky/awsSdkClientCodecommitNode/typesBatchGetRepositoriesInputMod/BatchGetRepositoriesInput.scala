package typingsSlinky.awsSdkClientCodecommitNode.typesBatchGetRepositoriesInputMod
...
object BatchGetRepositoriesInput {
  ...
  implicit class BatchGetRepositoriesInputOps[Self <: BatchGetRepositoriesInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRepositoryNamesVarargs(value: String*): Self = this.set("repositoryNames", js.Array(value :_*))
    
    @scala.inline
    def setRepositoryNamesIterable(value: js.Iterable[String]): Self = this.set("repositoryNames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRepositoryNames(value: js.Array[String] | js.Iterable[String]): Self = this.set("repositoryNames", value.asInstanceOf[js.Any])
