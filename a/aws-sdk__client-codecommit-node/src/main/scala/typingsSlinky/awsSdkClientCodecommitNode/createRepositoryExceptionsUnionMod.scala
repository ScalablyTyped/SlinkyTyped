...
@JSImport("@aws-sdk/client-codecommit-node/types/CreateRepositoryExceptionsUnion", JSImport.Namespace)
@js.native
object createRepositoryExceptionsUnionMod extends js.Object {
