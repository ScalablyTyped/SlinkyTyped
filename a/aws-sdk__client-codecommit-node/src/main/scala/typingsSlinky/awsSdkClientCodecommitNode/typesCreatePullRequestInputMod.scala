...
object typesCreatePullRequestInputMod {
  ...
  object CreatePullRequestInput {
    ...
    implicit class CreatePullRequestInputMutableBuilder[Self <: CreatePullRequestInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTargets(value: js.Array[Target] | js.Iterable[Target]): Self = StObject.set(x, "targets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTargetsIterable(value: js.Iterable[Target]): Self = StObject.set(x, "targets", value.asInstanceOf[js.Any])
