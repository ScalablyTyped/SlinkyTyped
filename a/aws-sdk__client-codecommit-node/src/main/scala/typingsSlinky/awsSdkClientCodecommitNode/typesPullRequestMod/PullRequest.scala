...
object PullRequest {
  ...
  implicit class PullRequestOps[Self <: PullRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastActivityDateDate(value: js.Date): Self = this.set("lastActivityDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLastActivityDate(value: js.Date | String | Double): Self = this.set("lastActivityDate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPullRequestTargetsIterable(value: js.Iterable[PullRequestTarget]): Self = this.set("pullRequestTargets", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPullRequestTargets(value: js.Array[PullRequestTarget] | js.Iterable[PullRequestTarget]): Self = this.set("pullRequestTargets", value.asInstanceOf[js.Any])
