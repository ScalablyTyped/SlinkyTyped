package typingsSlinky.awsSdkClientCodecommitNode.typesUpdateDefaultBranchInputMod
...
object UpdateDefaultBranchInput {
  ...
  implicit class UpdateDefaultBranchInputOps[Self <: UpdateDefaultBranchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultBranchName(value: String): Self = this.set("defaultBranchName", value.asInstanceOf[js.Any])
