...
object typesPutFileInputMod {
  ...
  object PutFileInput {
    ...
    implicit class PutFileInputMutableBuilder[Self <: PutFileInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFileContent(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = StObject.set(x, "fileContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFileContentArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "fileContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFileContentArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "fileContent", value.asInstanceOf[js.Any])
