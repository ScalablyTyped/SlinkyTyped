...
trait ReferenceTypeNotSupportedException
  ...
  @JSName("name")
  var name_ReferenceTypeNotSupportedException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.ReferenceTypeNotSupportedException = js.native
}
