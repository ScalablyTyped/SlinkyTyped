...
object PullRequestEvent {
  ...
  implicit class PullRequestEventOps[Self <: PullRequestEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventDateDate(value: js.Date): Self = this.set("eventDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEventDate(value: js.Date | String | Double): Self = this.set("eventDate", value.asInstanceOf[js.Any])
