...
@JSImport("@aws-sdk/client-codecommit-node/types/UpdatePullRequestStatusExceptionsUnion", JSImport.Namespace)
@js.native
object updatePullRequestStatusExceptionsUnionMod extends js.Object {
