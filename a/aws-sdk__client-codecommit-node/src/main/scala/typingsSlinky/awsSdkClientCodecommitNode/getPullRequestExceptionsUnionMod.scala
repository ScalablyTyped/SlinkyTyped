...
@JSImport("@aws-sdk/client-codecommit-node/types/GetPullRequestExceptionsUnion", JSImport.Namespace)
@js.native
object getPullRequestExceptionsUnionMod extends js.Object {
