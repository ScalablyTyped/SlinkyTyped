...
object Commit {
  ...
  implicit class CommitOps[Self <: Commit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParentsIterable(value: js.Iterable[String]): Self = this.set("parents", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParents(value: js.Array[String] | js.Iterable[String]): Self = this.set("parents", value.asInstanceOf[js.Any])
