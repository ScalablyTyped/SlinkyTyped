...
object typesPullRequestMod {
  ...
  object PullRequest {
    ...
    implicit class PullRequestMutableBuilder[Self <: PullRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLastActivityDate(value: js.Date | String | Double): Self = StObject.set(x, "lastActivityDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastActivityDateDate(value: js.Date): Self = StObject.set(x, "lastActivityDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setPullRequestTargets(value: js.Array[PullRequestTarget] | js.Iterable[PullRequestTarget]): Self = StObject.set(x, "pullRequestTargets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPullRequestTargetsIterable(value: js.Iterable[PullRequestTarget]): Self = StObject.set(x, "pullRequestTargets", value.asInstanceOf[js.Any])
