...
object typesUpdateDefaultBranchInputMod {
  ...
  object UpdateDefaultBranchInput {
    ...
    @scala.inline
    def apply(defaultBranchName: String, repositoryName: String): UpdateDefaultBranchInput = {
    ...
    implicit class UpdateDefaultBranchInputMutableBuilder[Self <: UpdateDefaultBranchInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultBranchName(value: String): Self = StObject.set(x, "defaultBranchName", value.asInstanceOf[js.Any])
