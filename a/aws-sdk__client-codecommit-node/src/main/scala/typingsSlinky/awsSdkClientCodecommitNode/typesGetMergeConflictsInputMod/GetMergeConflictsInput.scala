package typingsSlinky.awsSdkClientCodecommitNode.typesGetMergeConflictsInputMod
...
object GetMergeConflictsInput {
  ...
  implicit class GetMergeConflictsInputOps[Self <: GetMergeConflictsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDestinationCommitSpecifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("destinationCommitSpecifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMergeOption(value: FAST_FORWARD_MERGE | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSourceCommitSpecifier(value: String): Self = {
        val ret = this.duplicate
