...
object typesCommitIdRequiredExceptionMod {
  ...
  trait CommitIdRequiredException
    ...
    var name: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.CommitIdRequiredException = js.native
  }
  object CommitIdRequiredException {
    ...
    implicit class CommitIdRequiredExceptionMutableBuilder[Self <: CommitIdRequiredException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(
        value: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.CommitIdRequiredException
