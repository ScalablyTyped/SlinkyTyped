...
trait RepositoryTriggerEventsListRequiredException
  ...
  @JSName("name")
  var name_RepositoryTriggerEventsListRequiredException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.RepositoryTriggerEventsListRequiredException
}
