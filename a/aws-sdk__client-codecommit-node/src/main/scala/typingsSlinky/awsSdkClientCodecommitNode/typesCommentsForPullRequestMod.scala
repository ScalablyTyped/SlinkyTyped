...
object typesCommentsForPullRequestMod {
  ...
  object CommentsForPullRequest {
    ...
    implicit class CommentsForPullRequestMutableBuilder[Self <: CommentsForPullRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComments(value: js.Array[Comment] | js.Iterable[Comment]): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCommentsIterable(value: js.Iterable[Comment]): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
