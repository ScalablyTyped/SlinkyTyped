...
object deleteBranchExceptionsUnionMod {
  ...
  */
  trait DeleteBranchExceptionsUnion extends StObject
  object DeleteBranchExceptionsUnion {
    ...
    def DefaultBranchCannotBeDeletedException(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCodecommitNode.typesDefaultBranchCannotBeDeletedExceptionMod.DefaultBranchCannotBeDeletedException]
    }
