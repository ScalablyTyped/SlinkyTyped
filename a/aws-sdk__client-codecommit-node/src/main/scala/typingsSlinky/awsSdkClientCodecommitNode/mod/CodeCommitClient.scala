...
@JSImport("@aws-sdk/client-codecommit-node", "CodeCommitClient")
@js.native
class CodeCommitClient protected ()
  extends typingsSlinky.awsSdkClientCodecommitNode.codeCommitClientMod.CodeCommitClient {
