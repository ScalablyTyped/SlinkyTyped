...
@JSImport("@aws-sdk/client-codecommit-node", "GetCommentsForComparedCommitCommand")
@js.native
class GetCommentsForComparedCommitCommand protected ()
  extends typingsSlinky.awsSdkClientCodecommitNode.getCommentsForComparedCommitCommandMod.GetCommentsForComparedCommitCommand {
