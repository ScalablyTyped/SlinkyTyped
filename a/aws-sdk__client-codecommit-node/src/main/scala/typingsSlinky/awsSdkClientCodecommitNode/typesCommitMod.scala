...
import typingsSlinky.awsSdkClientCodecommitNode.typesUserInfoMod.UnmarshalledUserInfo
...
object typesCommitMod {
  ...
  object Commit {
    ...
    implicit class CommitMutableBuilder[Self <: Commit] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setParents(value: js.Array[String] | js.Iterable[String]): Self = StObject.set(x, "parents", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setParentsIterable(value: js.Iterable[String]): Self = StObject.set(x, "parents", value.asInstanceOf[js.Any])
