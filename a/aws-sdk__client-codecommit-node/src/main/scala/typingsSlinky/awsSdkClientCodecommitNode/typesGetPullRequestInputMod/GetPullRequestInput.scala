package typingsSlinky.awsSdkClientCodecommitNode.typesGetPullRequestInputMod
...
@js.native
trait GetPullRequestInput extends InputTypesUnion {
  /**
...
object GetPullRequestInput {
  @scala.inline
  def apply(pullRequestId: String): GetPullRequestInput = {
