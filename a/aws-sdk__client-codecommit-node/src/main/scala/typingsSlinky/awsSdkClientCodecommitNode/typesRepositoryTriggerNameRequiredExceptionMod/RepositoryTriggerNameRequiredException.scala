...
trait RepositoryTriggerNameRequiredException
  ...
  @JSName("name")
  var name_RepositoryTriggerNameRequiredException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.RepositoryTriggerNameRequiredException
}
