...
object typesPullRequestEventMod {
  ...
  object PullRequestEvent {
    ...
    implicit class PullRequestEventMutableBuilder[Self <: PullRequestEvent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEventDate(value: js.Date | String | Double): Self = StObject.set(x, "eventDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEventDateDate(value: js.Date): Self = StObject.set(x, "eventDate", value.asInstanceOf[js.Any])
