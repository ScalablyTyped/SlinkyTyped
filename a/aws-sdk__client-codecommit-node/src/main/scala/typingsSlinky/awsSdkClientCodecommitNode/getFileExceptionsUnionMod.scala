  ...
  */
  ...
  object GetFileExceptionsUnion {
    ...
    def FileDoesNotExistException(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCodecommitNode.typesFileDoesNotExistExceptionMod.FileDoesNotExistException]
    }
    ...
    def FileTooLargeException(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException]
    }
    ...
    def InvalidCommitException(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsSlinky.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException]
    }
