...
object PutFileInput {
  ...
  implicit class PutFileInputOps[Self <: PutFileInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFileContentArrayBufferView(value: js.typedarray.ArrayBufferView): Self = this.set("fileContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFileContentArrayBuffer(value: js.typedarray.ArrayBuffer): Self = this.set("fileContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFileContent(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = this.set("fileContent", value.asInstanceOf[js.Any])
