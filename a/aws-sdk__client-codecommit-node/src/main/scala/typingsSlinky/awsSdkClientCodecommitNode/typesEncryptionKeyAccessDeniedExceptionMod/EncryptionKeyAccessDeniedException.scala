...
trait EncryptionKeyAccessDeniedException
  ...
  @JSName("name")
  var name_EncryptionKeyAccessDeniedException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyAccessDeniedException = js.native
}
object EncryptionKeyAccessDeniedException {
  ...
  implicit class EncryptionKeyAccessDeniedExceptionOps[Self <: EncryptionKeyAccessDeniedException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(
      value: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyAccessDeniedException
