package typingsSlinky.awsSdkClientCodecommitNode.typesCreatePullRequestInputMod
...
object CreatePullRequestInput {
  ...
  @scala.inline
  def apply(targets: js.Array[Target] | js.Iterable[Target], title: String): CreatePullRequestInput = {
  ...
  implicit class CreatePullRequestInputOps[Self <: CreatePullRequestInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetsIterable(value: js.Iterable[Target]): Self = this.set("targets", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTargets(value: js.Array[Target] | js.Iterable[Target]): Self = this.set("targets", value.asInstanceOf[js.Any])
