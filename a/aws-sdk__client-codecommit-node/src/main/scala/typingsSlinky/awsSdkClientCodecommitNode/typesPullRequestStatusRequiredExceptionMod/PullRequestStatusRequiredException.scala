...
trait PullRequestStatusRequiredException
  ...
  @JSName("name")
  var name_PullRequestStatusRequiredException: typingsSlinky.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.PullRequestStatusRequiredException
}
