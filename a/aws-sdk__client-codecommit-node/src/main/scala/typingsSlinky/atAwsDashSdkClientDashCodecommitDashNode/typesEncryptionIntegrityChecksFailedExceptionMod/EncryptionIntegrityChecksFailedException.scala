...
trait EncryptionIntegrityChecksFailedException
  extends ServiceException[_EncryptionIntegrityChecksFailedExceptionDetails]
  ...
  @JSName("name")
  var name_EncryptionIntegrityChecksFailedException: typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.EncryptionIntegrityChecksFailedException = js.native
}
