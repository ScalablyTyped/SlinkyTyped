...
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreTargetMod._Target
...
object typesCreatePullRequestInputMod extends js.Object {
  ...
  trait CreatePullRequestInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var targets: js.Array[_Target] | js.Iterable[_Target] = js.native
    /**
