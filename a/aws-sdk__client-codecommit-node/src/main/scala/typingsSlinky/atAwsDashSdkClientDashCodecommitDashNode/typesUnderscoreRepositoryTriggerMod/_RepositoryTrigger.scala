package typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreRepositoryTriggerMod

import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.all
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.createReference
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.deleteReference
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.updateReference
...
trait _RepositoryTrigger extends js.Object {
  /**
    ...
    */
  var branches: js.UndefOr[js.Array[String] | js.Iterable[String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: (js.Array[all | updateReference | createReference | deleteReference | String]) | (js.Iterable[all | updateReference | createReference | deleteReference | String])
  /**
...
object _RepositoryTrigger {
  ...
  def apply(
    ...
    name: String,
    branches: js.Array[String] | js.Iterable[String] = null,
