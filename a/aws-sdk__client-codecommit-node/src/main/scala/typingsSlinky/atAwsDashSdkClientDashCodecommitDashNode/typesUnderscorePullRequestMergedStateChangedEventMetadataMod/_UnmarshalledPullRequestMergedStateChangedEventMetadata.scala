package typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestMergedStateChangedEventMetadataMod

import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreMergeMetadataMod._UnmarshalledMergeMetadata
