package typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreRepositoryMetadataMod
...
trait _UnmarshalledRepositoryMetadata extends _RepositoryMetadata {
  /**
    ...
    */
  @JSName("creationDate")
  var creationDate__UnmarshalledRepositoryMetadata: js.UndefOr[js.Date] = js.undefined
  /**
    * <p>The date and time the repository was last modified, in timestamp format.</p>
    */
  @JSName("lastModifiedDate")
  var lastModifiedDate__UnmarshalledRepositoryMetadata: js.UndefOr[js.Date] = js.undefined
}
