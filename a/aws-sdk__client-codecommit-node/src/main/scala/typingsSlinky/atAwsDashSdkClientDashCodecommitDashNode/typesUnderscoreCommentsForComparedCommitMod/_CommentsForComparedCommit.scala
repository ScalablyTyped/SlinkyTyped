package typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreCommentsForComparedCommitMod

import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreCommentMod._Comment
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscoreLocationMod._Location
...
trait _CommentsForComparedCommit extends js.Object {
  ...
  /**
    ...
    */
  var comments: js.UndefOr[js.Array[_Comment] | js.Iterable[_Comment]] = js.undefined
  /**
...
object _CommentsForComparedCommit {
  ...
  def apply(
    ...
    comments: js.Array[_Comment] | js.Iterable[_Comment] = null,
