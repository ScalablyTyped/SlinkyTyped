...
@JSImport("@aws-sdk/client-codecommit-node/types/DeleteRepositoryInput", JSImport.Namespace)
@js.native
object typesDeleteRepositoryInputMod extends js.Object {
  @js.native
  trait DeleteRepositoryInput extends InputTypesUnion {
    /**
