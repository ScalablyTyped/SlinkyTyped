...
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestCreatedEventMetadataMod._PullRequestCreatedEventMetadata
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestMergedStateChangedEventMetadataMod._PullRequestMergedStateChangedEventMetadata
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestSourceReferenceUpdatedEventMetadataMod._PullRequestSourceReferenceUpdatedEventMetadata
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestStatusChangedEventMetadataMod._PullRequestStatusChangedEventMetadata
