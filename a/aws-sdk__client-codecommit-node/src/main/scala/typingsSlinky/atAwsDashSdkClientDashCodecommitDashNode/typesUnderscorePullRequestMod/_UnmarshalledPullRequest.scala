...
import typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.typesUnderscorePullRequestTargetMod._UnmarshalledPullRequestTarget
...
trait _UnmarshalledPullRequest extends _PullRequest {
  /**
    ...
    */
  @JSName("creationDate")
  var creationDate__UnmarshalledPullRequest: js.UndefOr[js.Date] = js.undefined
  /**
    * <p>The day and time of the last user or system activity on the pull request, in timestamp format.</p>
    */
  @JSName("lastActivityDate")
  var lastActivityDate__UnmarshalledPullRequest: js.UndefOr[js.Date] = js.undefined
  /**
