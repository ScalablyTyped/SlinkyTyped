...
trait EncryptionKeyAccessDeniedException
  ...
  @JSName("name")
  var name_EncryptionKeyAccessDeniedException: typingsSlinky.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.EncryptionKeyAccessDeniedException = js.native
}
