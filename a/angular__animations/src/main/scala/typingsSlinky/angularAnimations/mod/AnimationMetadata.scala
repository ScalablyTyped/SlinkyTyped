...
object AnimationMetadata {
  ...
  @scala.inline
  implicit class AnimationMetadataOps[Self <: AnimationMetadata] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: AnimationMetadataType): Self = this.set("type", value.asInstanceOf[js.Any])
  }
