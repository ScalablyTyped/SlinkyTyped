...
import typingsSlinky.apolloProtobufjs.mod.IEnum
...
class Enum protected ()
  extends typingsSlinky.apolloProtobufjs.mod.Enum {
  /**
...
object Enum {
  ...
  @js.native
  def fromJSON(name: String, json: IEnum): typingsSlinky.apolloProtobufjs.mod.Enum = js.native
}
