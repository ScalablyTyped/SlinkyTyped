...
object util {
  ...
  @JSImport("@apollo/protobufjs/light", "util.Long")
  @js.native
  def Long: Constructor[typingsSlinky.long.mod.Long] = js.native
  ...
  object LongBits {
    ...
    @JSImport("@apollo/protobufjs/light", "util.LongBits.from")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("@apollo/protobufjs/light", "util.LongBits.fromHash")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("@apollo/protobufjs/light", "util.LongBits.fromNumber")
    @js.native
    def fromNumber(value: Double): typingsSlinky.apolloProtobufjs.mod.util.LongBits = js.native
    
    /** Zero bits. */
    /* static member */
    @JSImport("@apollo/protobufjs/light", "util.LongBits.zero")
    @js.native
    def zero: typingsSlinky.apolloProtobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("@apollo/protobufjs/light", "util.LongBits.zeroHash")
    @js.native
    ...
    @scala.inline
    def zero_=(x: typingsSlinky.apolloProtobufjs.mod.util.LongBits): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("zero")(x.asInstanceOf[js.Any])
  }
  
  @scala.inline
  def Long_=(x: Constructor[typingsSlinky.long.mod.Long]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Long")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.asPromise")
  @js.native
  ...
  object base64 {
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.base64.decode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.base64.encode")
    @js.native
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("@apollo/protobufjs/light", "util.base64.length")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.base64.test")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.camelCase")
  @js.native
  ...
  object codegen {
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.codegen")
    @js.native
    ...
    @JSImport("@apollo/protobufjs/light", "util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.compareFieldsById")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.decorateEnum")
  @js.native
  def decorateEnum(`object`: js.Object): typingsSlinky.apolloProtobufjs.mod.Enum = js.native
  
  /** Decorator root (TypeScript). */
  @JSImport("@apollo/protobufjs/light", "util.decorateRoot")
  @js.native
  def decorateRoot: typingsSlinky.apolloProtobufjs.mod.Root = js.native
  @scala.inline
  def decorateRoot_=(x: typingsSlinky.apolloProtobufjs.mod.Root): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("decorateRoot")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.decorateType")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.fetch")
  @js.native
  ...
  object float {
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("@apollo/protobufjs/light", "util.float.readDoubleBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("@apollo/protobufjs/light", "util.float.readDoubleLE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("@apollo/protobufjs/light", "util.float.readFloatBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("@apollo/protobufjs/light", "util.float.readFloatLE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.float.writeDoubleBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("@apollo/protobufjs/light", "util.float.writeDoubleLE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("@apollo/protobufjs/light", "util.float.writeFloatBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("@apollo/protobufjs/light", "util.float.writeFloatLE")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.inquire")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.isInteger")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.isObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.isReserved")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.isSet")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.isString")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("@apollo/protobufjs/light", "util.lcFirst")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.longFromHash")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/light", "util.longToHash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.merge")
  @js.native
  ...
  /**
    ...
    * @returns Buffer
    */
  @JSImport("@apollo/protobufjs/light", "util.newBuffer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.newError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.oneOfGetter")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.oneOfSetter")
  @js.native
  ...
  object path {
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.path.isAbsolute")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.path.normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.path.resolve")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.pool")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.safeProp")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.toArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.toJSONOptions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/light", "util.toObject")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("@apollo/protobufjs/light", "util.ucFirst")
  @js.native
  ...
  object utf8 {
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("@apollo/protobufjs/light", "util.utf8.length")
    @js.native
    def length(string: String): Double = js.native
    ...
    /**
      ...
      * @returns String read
      */
    @JSImport("@apollo/protobufjs/light", "util.utf8.read")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@apollo/protobufjs/light", "util.utf8.write")
    @js.native
