...
object Reader extends js.Object {
  /**
    ...
    */
  def create(buffer: scala.scalajs.js.typedarray.Uint8Array | scala.scalajs.js.typedarray.Uint8Array): typingsSlinky.apolloProtobufjs.mod.Reader | typingsSlinky.apolloProtobufjs.mod.BufferReader = js.native
}
