...
import typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.IToJSONOptions
...
class Namespace protected ()
  extends typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.Namespace {
  /**
...
object Namespace extends js.Object {
  /**
    ...
    */
  def arrayToJSON(array: js.Array[typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.ReflectionObject]): js.UndefOr[StringDictionary[js.Any]] = js.native
  def arrayToJSON(
    array: js.Array[typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.ReflectionObject],
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: StringDictionary[js.Any]): typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.Namespace = js.native
