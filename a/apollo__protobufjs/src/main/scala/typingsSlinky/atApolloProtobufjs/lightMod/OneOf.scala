...
import typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.IOneOf
import typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.OneOfDecorator
...
class OneOf protected ()
  extends typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.OneOf {
  /**
...
object OneOf extends js.Object {
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: IOneOf): typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.OneOf = js.native
}
