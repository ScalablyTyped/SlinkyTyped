...
import typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.IEnum
...
class Enum protected ()
  extends typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.Enum {
  /**
...
object Enum extends js.Object {
  /**
    ...
    */
  def fromJSON(name: String, json: IEnum): typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.Enum = js.native
}
