...
object rpc extends js.Object {
  ...
  class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typingsSlinky.atApolloProtobufjs.atApolloProtobufjsMod.rpc.Service = js.native
    /**
