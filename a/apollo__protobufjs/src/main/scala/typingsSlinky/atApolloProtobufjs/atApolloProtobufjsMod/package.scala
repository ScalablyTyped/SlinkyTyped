...
package object atApolloProtobufjsMod {
  ...
  type Codegen = js.Function2[
    ...
    /* repeated */ js.Any, 
    (/* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias @apollo/protobufjs.@apollo/protobufjs.Codegen */ js.Object) | js.Function
  ]
  /**
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsSlinky.atApolloProtobufjs.atApolloProtobufjsStrings.Properties with T
  /**
