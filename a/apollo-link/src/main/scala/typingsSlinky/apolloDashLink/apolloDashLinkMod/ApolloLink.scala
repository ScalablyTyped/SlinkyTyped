...
@js.native
class ApolloLink ()
  extends typingsSlinky.apolloDashLink.libLinkMod.ApolloLink {
...
object ApolloLink extends js.Object {
  ...
  var execute_Original: js.Function2[
    ...
    typingsSlinky.zenDashObservableDashTs.libZenObservableMod.Observable[FetchResult[StringDictionary[_], Record[String, _], Record[String, _]]]
  ] = js.native
  @JSName("from")
  ...
  def execute(link: this.type, operation: GraphQLRequest): typingsSlinky.zenDashObservableDashTs.libZenObservableMod.Observable[FetchResult[StringDictionary[_], Record[String, _], Record[String, _]]] = js.native
