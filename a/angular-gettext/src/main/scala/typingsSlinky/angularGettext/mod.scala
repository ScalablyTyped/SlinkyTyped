package typingsSlinky.angularGettext
...
object mod {
  ...
  object angularAugmentingMod {
    ...
    object gettext {
      ...
      trait gettextCatalog extends StObject {
        ...
        def loadRemote(url: String): IHttpPromise[_] = js.native
  ...
  type gettextCatalog = typingsSlinky.angularGettext.mod.angularAugmentingMod.gettext.gettextCatalog
}
