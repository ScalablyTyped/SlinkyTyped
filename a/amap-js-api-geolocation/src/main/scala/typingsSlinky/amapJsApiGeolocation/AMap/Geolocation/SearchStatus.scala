...
object SearchStatus {
  ...
  @scala.inline
  def complete: typingsSlinky.amapJsApiGeolocation.amapJsApiGeolocationStrings.complete = this.cast("complete")
  @scala.inline
  def error: typingsSlinky.amapJsApiGeolocation.amapJsApiGeolocationStrings.error = this.cast("error")
}
