...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonDomHTMLElement(value: HTMLElement): Self = this.set("buttonDom", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCircleOptions(value: typingsSlinky.amapJsApi.AMap.Circle.Options[_]): Self = this.set("circleOptions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMarkerOptions(value: typingsSlinky.amapJsApi.AMap.Marker.Options[_]): Self = this.set("markerOptions", value.asInstanceOf[js.Any])
