...
import typingsSlinky.amapDashJsDashApiDashGeolocation.amapDashJsDashApiDashGeolocationStrings.all
import typingsSlinky.amapDashJsDashApiDashGeolocation.amapDashJsDashApiDashGeolocationStrings.base
...
trait Options extends js.Object {
  ...
  /**
    * 定位点Circle的配置
    */
  var circleOptions: js.UndefOr[typingsSlinky.amapDashJsDashApi.AMap.Circle.Options[_]] = js.undefined
  /**
    * 是否转换成高德坐标
    */
  ...
  /**
    * 定位点Marker的配置
    */
  var markerOptions: js.UndefOr[typingsSlinky.amapDashJsDashApi.AMap.Marker.Options[_]] = js.undefined
  /**
    * 缓存毫秒数
    */
...
object Options {
  ...
  def apply(
    ...
    circleOptions: typingsSlinky.amapDashJsDashApi.AMap.Circle.Options[_] = null,
    ...
    markerOptions: typingsSlinky.amapDashJsDashApi.AMap.Marker.Options[_] = null,
