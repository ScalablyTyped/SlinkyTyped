...
import typingsSlinky.appleMusicApi.AppleMusicApi.Song
...
object anon {
  ...
  object AlbumName {
    ...
    implicit class AlbumNameMutableBuilder[Self <: AlbumName] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setArtwork(value: typingsSlinky.appleMusicApi.AppleMusicApi.Artwork): Self = StObject.set(x, "artwork", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setEditorialNotes(value: typingsSlinky.appleMusicApi.AppleMusicApi.EditorialNotes): Self = StObject.set(x, "editorialNotes", value.asInstanceOf[js.Any])
  ...
  object Artwork {
    ...
    implicit class ArtworkMutableBuilder[Self <: Artwork] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDescription(value: typingsSlinky.appleMusicApi.AppleMusicApi.EditorialNotes): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
  ...
  trait Curator extends StObject {
    ...
    var curator: Relationship[typingsSlinky.appleMusicApi.AppleMusicApi.Curator] = js.native
  ...
  object Curator {
    ...
    @scala.inline
    def apply(curator: Relationship[typingsSlinky.appleMusicApi.AppleMusicApi.Curator]): Curator = {
    ...
    implicit class CuratorMutableBuilder[Self <: Curator] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCurator(value: Relationship[typingsSlinky.appleMusicApi.AppleMusicApi.Curator]): Self = StObject.set(x, "curator", value.asInstanceOf[js.Any])
