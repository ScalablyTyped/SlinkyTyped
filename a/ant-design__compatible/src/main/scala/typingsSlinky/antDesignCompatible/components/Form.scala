...
import typingsSlinky.antDesignCompatible.formFormMod.FormLayout
import typingsSlinky.antDesignCompatible.formFormMod.FormProps
import typingsSlinky.antDesignCompatible.formFormMod.WrappedFormUtils
...
object Form {
  @JSImport("@ant-design/compatible/lib/form", JSImport.Default)
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def form(value: WrappedFormUtils[_]): this.type = set("form", value.asInstanceOf[js.Any])
    @scala.inline
