...
object anon {
  ...
  object Reference {
    ...
    @scala.inline
    def apply(Reference: typingsSlinky.activexVbide.VBIDE.Reference): Reference = {
    ...
    implicit class ReferenceMutableBuilder[Self <: Reference] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReference(value: typingsSlinky.activexVbide.VBIDE.Reference): Self = StObject.set(x, "Reference", value.asInstanceOf[js.Any])
    }
  }
}
