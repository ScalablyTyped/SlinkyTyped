...
object CursorTypeEnum {
  @scala.inline
  def adOpenDynamic: `2` = this.cast(2)
  @scala.inline
  def adOpenForwardOnly: `0` = this.cast(0)
  @scala.inline
  def adOpenKeyset: `1` = this.cast(1)
  @scala.inline
  def adOpenStatic: `3` = this.cast(3)
  @scala.inline
  def adOpenUnspecified: `-1` = this.cast(-1)
  @scala.inline
