...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.activexAdodb.activexAdodbNumbers.`-1`
*/
trait CursorTypeEnum extends StObject
object CursorTypeEnum {
  
  @scala.inline
  def adOpenDynamic: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def adOpenForwardOnly: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def adOpenKeyset: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def adOpenStatic: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def adOpenUnspecified: `-1` = -1.asInstanceOf[`-1`]
}
