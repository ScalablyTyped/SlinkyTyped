...
*/
trait AffectEnum extends StObject
object AffectEnum {
  
  @scala.inline
  def adAffectAll: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def adAffectAllChapters: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def adAffectCurrent: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def adAffectGroup: `2` = 2.asInstanceOf[`2`]
}
