...
object Error {
  ...
  implicit class ErrorOps[Self <: Error] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withADODBDotError_typekey(value: Error): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ADODB.Error_typekey")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNativeError(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NativeError")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
