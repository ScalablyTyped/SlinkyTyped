...
*/
trait ADCPROP_UPDATECRITERIA_ENUM extends js.Object
object ADCPROP_UPDATECRITERIA_ENUM {
  
  @scala.inline
  def adCriteriaAllCols: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def adCriteriaKey: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def adCriteriaTimeStamp: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def adCriteriaUpdCols: `2` = 2.asInstanceOf[`2`]
}
