...
object NotifyMethods extends StObject {
  ...
  /* 4 */ val netSend: typingsSlinky.azdata.mod.NotifyMethods.netSend with Double = js.native
  
  @js.native
  sealed trait none extends NotifyMethods
  /* 0 */ val none: typingsSlinky.azdata.mod.NotifyMethods.none with Double = js.native
  ...
  /* 1 */ val notifyEmail: typingsSlinky.azdata.mod.NotifyMethods.notifyEmail with Double = js.native
  
  @js.native
  sealed trait pager extends NotifyMethods
  /* 2 */ val pager: typingsSlinky.azdata.mod.NotifyMethods.pager with Double = js.native
}
