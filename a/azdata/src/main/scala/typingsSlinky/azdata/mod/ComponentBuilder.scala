...
object ComponentBuilder {
  @scala.inline
  def apply[/* <: typingsSlinky.azdata.mod.Component */ T](
    component: () => T,
  ...
  @scala.inline
  implicit class ComponentBuilderOps[Self <: ComponentBuilder[_], /* <: typingsSlinky.azdata.mod.Component */ T] (val x: Self with ComponentBuilder[T]) extends AnyVal {
    @scala.inline
