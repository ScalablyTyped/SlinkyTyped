...
object MessageHandler {
  @scala.inline
  def apply[/* <: typingsSlinky.azdata.mod.nb.IMessage */ T](handle: T => Unit | Thenable[Unit]): MessageHandler[T] = {
    val __obj = js.Dynamic.literal(handle = js.Any.fromFunction1(handle))
    __obj.asInstanceOf[MessageHandler[T]]
  }
  @scala.inline
  implicit class MessageHandlerOps[Self <: MessageHandler[_], /* <: typingsSlinky.azdata.mod.nb.IMessage */ T] (val x: Self with MessageHandler[T]) extends AnyVal {
    @scala.inline
