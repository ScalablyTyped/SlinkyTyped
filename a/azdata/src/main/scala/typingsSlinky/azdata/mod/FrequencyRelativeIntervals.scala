...
object FrequencyRelativeIntervals extends StObject {
  ...
  /* 1 */ val First: typingsSlinky.azdata.mod.FrequencyRelativeIntervals.First with Double = js.native
  
  @js.native
  sealed trait Fourth extends FrequencyRelativeIntervals
  /* 8 */ val Fourth: typingsSlinky.azdata.mod.FrequencyRelativeIntervals.Fourth with Double = js.native
  
  @js.native
  sealed trait Last extends FrequencyRelativeIntervals
  /* 16 */ val Last: typingsSlinky.azdata.mod.FrequencyRelativeIntervals.Last with Double = js.native
  
  @js.native
  sealed trait Second extends FrequencyRelativeIntervals
  /* 2 */ val Second: typingsSlinky.azdata.mod.FrequencyRelativeIntervals.Second with Double = js.native
  
  @js.native
  sealed trait Third extends FrequencyRelativeIntervals
  /* 4 */ val Third: typingsSlinky.azdata.mod.FrequencyRelativeIntervals.Third with Double = js.native
}
