...
object ColumnType extends StObject {
  ...
  /* 2 */ val button: typingsSlinky.azdata.mod.ColumnType.button with Double = js.native
  
  @js.native
  sealed trait checkBox extends ColumnType
  /* 1 */ val checkBox: typingsSlinky.azdata.mod.ColumnType.checkBox with Double = js.native
  
  @js.native
  sealed trait text extends ColumnType
  /* 0 */ val text: typingsSlinky.azdata.mod.ColumnType.text with Double = js.native
}
