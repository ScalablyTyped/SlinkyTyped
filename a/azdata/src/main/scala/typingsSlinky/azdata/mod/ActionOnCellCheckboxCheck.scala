...
object ActionOnCellCheckboxCheck extends StObject {
  ...
  /* 1 */ val customAction: typingsSlinky.azdata.mod.ActionOnCellCheckboxCheck.customAction with Double = js.native
  
  @js.native
  sealed trait selectRow extends ActionOnCellCheckboxCheck
  /* 0 */ val selectRow: typingsSlinky.azdata.mod.ActionOnCellCheckboxCheck.selectRow with Double = js.native
}
