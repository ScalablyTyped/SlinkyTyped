...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.azdata.azdataStrings.color
  - typingsSlinky.azdata.azdataStrings.date
  - typingsSlinky.azdata.azdataStrings.`datetime-local`
  - typingsSlinky.azdata.azdataStrings.email
  - typingsSlinky.azdata.azdataStrings.month
  - typingsSlinky.azdata.azdataStrings.number
  - typingsSlinky.azdata.azdataStrings.password
  - typingsSlinky.azdata.azdataStrings.range
  - typingsSlinky.azdata.azdataStrings.search
  - typingsSlinky.azdata.azdataStrings.text
  - typingsSlinky.azdata.azdataStrings.time
  - typingsSlinky.azdata.azdataStrings.url
  - typingsSlinky.azdata.azdataStrings.week
*/
