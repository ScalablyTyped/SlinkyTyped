...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.azdata.azdataStrings.`flex-start`
  - typingsSlinky.azdata.azdataStrings.`flex-end`
  - typingsSlinky.azdata.azdataStrings.center
  - typingsSlinky.azdata.azdataStrings.`space-between`
  - typingsSlinky.azdata.azdataStrings.`space-around`
