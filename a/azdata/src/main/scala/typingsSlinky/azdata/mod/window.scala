...
object window {
  ...
  object MessageLevel extends StObject {
    ...
    /* 0 */ val Error: typingsSlinky.azdata.mod.window.MessageLevel.Error with Double = js.native
    
    @js.native
    sealed trait Information extends MessageLevel
    /* 2 */ val Information: typingsSlinky.azdata.mod.window.MessageLevel.Information with Double = js.native
    
    @js.native
    sealed trait Warning extends MessageLevel
    /* 1 */ val Warning: typingsSlinky.azdata.mod.window.MessageLevel.Warning with Double = js.native
  }
