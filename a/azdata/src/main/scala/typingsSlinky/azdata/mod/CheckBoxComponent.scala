...
- typingsSlinky.azdata.mod.CheckBoxProperties because var conflicts: CSSStyles, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined checked, label */ @js.native
