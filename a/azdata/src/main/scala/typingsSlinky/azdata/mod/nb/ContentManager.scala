...
object ContentManager {
  ...
  implicit class ContentManagerOps[Self <: ContentManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetNotebookContents(value: Uri => Thenable[INotebookContents]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNotebookContents")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSave(value: (Uri, INotebookContents) => Thenable[INotebookContents]): Self = {
        val ret = this.duplicate
