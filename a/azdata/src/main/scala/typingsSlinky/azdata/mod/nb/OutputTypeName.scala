...
/* Rewritten from type alias, can be one of: 
  - typingsSlinky.azdata.azdataStrings.execute_result
  - typingsSlinky.azdata.azdataStrings.display_data
  - typingsSlinky.azdata.azdataStrings.stream
  - typingsSlinky.azdata.azdataStrings.error
  - typingsSlinky.azdata.azdataStrings.update_display_data
*/
