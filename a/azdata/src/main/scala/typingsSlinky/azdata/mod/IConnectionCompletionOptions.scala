...
object IConnectionCompletionOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(showConnectionDialogOnError)) __obj.updateDynamic("showConnectionDialogOnError")(showConnectionDialogOnError.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showDashboard)) __obj.updateDynamic("showDashboard")(showDashboard.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showFirewallRuleOnError)) __obj.updateDynamic("showFirewallRuleOnError")(showFirewallRuleOnError.get.asInstanceOf[js.Any])
