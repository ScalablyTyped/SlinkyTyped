...
object NotebookManager {
  ...
  implicit class NotebookManagerOps[Self <: NotebookManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withContentManager(value: ContentManager): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("contentManager")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSessionManager(value: SessionManager): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("sessionManager")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withServerManager(value: ServerManager): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("serverManager")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutServerManager: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("serverManager")(js.undefined)
        ret
    }
  }
