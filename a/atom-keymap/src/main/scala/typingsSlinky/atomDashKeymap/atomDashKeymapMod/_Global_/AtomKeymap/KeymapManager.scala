package typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.raw.HTMLElement
import org.scalajs.dom.raw.KeyboardEvent
import typingsSlinky.atomDashKeymap.Anon_Command
import typingsSlinky.atomDashKeymap.Anon_Priority
import typingsSlinky.atomDashKeymap.Anon_PriorityNumber
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.AddedKeystrokeResolver
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.FailedKeybindingMatch
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.FailedKeymapFileRead
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.FullKeybindingMatch
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.KeymapLoaded
import typingsSlinky.atomDashKeymap.atomDashKeymapMod._Global_.AtomKeymap.Events.PartialKeybindingMatch
...
trait KeymapManager extends js.Object {
  ...
  def findKeyBindings(params: Anon_Command): js.Array[KeyBinding] = js.native
  // Accessing Bindings
  ...
  def loadKeymap(bindingsPath: String, options: Anon_Priority): Unit = js.native
  ...
  def watchKeymap(filePath: String, options: Anon_PriorityNumber): Unit = js.native
}
