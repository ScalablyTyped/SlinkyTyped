...
object IRouteService {
  ...
  implicit class IRouteServiceOps[Self <: IRouteService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdateParams(value: StringDictionary[String] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateParams")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCurrent(value: ICurrentRoute): Self = {
        val ret = this.duplicate
