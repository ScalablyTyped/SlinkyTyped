...
object IAsideOptions {
  ...
  implicit class IAsideOptionsOps[Self <: IAsideOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnBeforeHide(value: /* aside */ IAside => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnBeforeShow(value: /* aside */ IAside => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnHide(value: /* aside */ IAside => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnShow(value: /* aside */ IAside => Unit): Self = {
        val ret = this.duplicate
