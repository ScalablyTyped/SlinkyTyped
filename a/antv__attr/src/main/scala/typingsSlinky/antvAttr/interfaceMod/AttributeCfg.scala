package typingsSlinky.antvAttr.interfaceMod
...
object AttributeCfg {
  ...
  implicit class AttributeCfgOps[Self <: AttributeCfg] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScalesVarargs(value: typingsSlinky.antvScale.mod.Scale*): Self = this.set("scales", js.Array(value :_*))
    
    @scala.inline
    def setScales(value: js.Array[typingsSlinky.antvScale.mod.Scale]): Self = this.set("scales", value.asInstanceOf[js.Any])
