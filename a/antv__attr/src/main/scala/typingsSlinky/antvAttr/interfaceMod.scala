...
object interfaceMod {
  ...
  abstract class Scale protected ()
    extends typingsSlinky.antvScale.mod.Scale {
  ...
  trait AttributeCfg extends StObject {
    ...
    val scales: js.Array[typingsSlinky.antvScale.mod.Scale] = js.native
  ...
  object AttributeCfg {
    ...
    @scala.inline
    def apply(scales: js.Array[typingsSlinky.antvScale.mod.Scale]): AttributeCfg = {
    ...
    implicit class AttributeCfgMutableBuilder[Self <: AttributeCfg] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScales(value: js.Array[typingsSlinky.antvScale.mod.Scale]): Self = StObject.set(x, "scales", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScalesVarargs(value: typingsSlinky.antvScale.mod.Scale*): Self = StObject.set(x, "scales", js.Array(value :_*))
