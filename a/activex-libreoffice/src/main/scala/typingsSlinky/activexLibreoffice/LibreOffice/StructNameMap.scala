...
object StructNameMap {
  ...
  implicit class StructNameMapOps[Self <: StructNameMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComDotsunDotstarDoti18nDotCurrency(value: typingsSlinky.activexLibreoffice.com_.sun.star.i18n.Currency): Self = this.set("com.sun.star.i18n.Currency", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComDotsunDotstarDotlangDotEventObject(value: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject): Self = this.set("com.sun.star.lang.EventObject", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setComDotsunDotstarDotutilDotDate(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date): Self = this.set("com.sun.star.util.Date", value.asInstanceOf[js.Any])
    @scala.inline
