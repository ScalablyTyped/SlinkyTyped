...
object XQuery {
  ...
  implicit class XQueryOps[Self <: XQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsInstalled(value: (String, String, js.Array[Boolean]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsInstalled")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withSearchFile(value: (String, String, js.Array[Boolean], js.Array[String]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SearchFile")(js.Any.fromFunction4(value))
        ret
    }
  }
