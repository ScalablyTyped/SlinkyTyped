...
package object registry {
  /**
    ...
    * a jar file)).;
    */
  type CannotRegisterImplementationException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    * -thread safe
    */
  type DefaultRegistry = typingsSlinky.activexLibreoffice.com_.sun.star.registry.XSimpleRegistry
  /**
    ...
    */
  type ImplementationRegistration = typingsSlinky.activexLibreoffice.com_.sun.star.registry.XImplementationRegistration
  /** signals that the registry is invalid or an operation on the registry failed. */
  type InvalidRegistryException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** signals that the value of the key is invalid or does not have the appropriate key type. */
  type InvalidValueException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** is thrown if entries of two registries are contradictory in the context of {@link XSimpleRegistry.mergeKey()} e() method. */
  type MergeConflictException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    * Guarantees: -thread safe
    */
  type SimpleRegistry = typingsSlinky.activexLibreoffice.com_.sun.star.registry.XSimpleRegistry
}
