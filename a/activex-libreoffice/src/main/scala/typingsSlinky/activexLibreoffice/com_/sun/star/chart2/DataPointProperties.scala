...
trait DataPointProperties
  ...
  var Gradient: typingsSlinky.activexLibreoffice.com_.sun.star.awt.Gradient = js.native
  var GradientName: String = js.native
  var Hatch: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.Hatch = js.native
  ...
  var Symbol: typingsSlinky.activexLibreoffice.com_.sun.star.chart2.Symbol = js.native
  /**
