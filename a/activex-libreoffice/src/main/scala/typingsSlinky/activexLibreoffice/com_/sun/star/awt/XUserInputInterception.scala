...
object XUserInputInterception {
  ...
  implicit class XUserInputInterceptionOps[Self <: XUserInputInterception] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddMouseClickHandler(value: XMouseClickHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addMouseClickHandler")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRemoveMouseClickHandler(value: XMouseClickHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeMouseClickHandler")(js.Any.fromFunction1(value))
        ret
    }
  }
