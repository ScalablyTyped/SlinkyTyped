...
object XDataSource {
  ...
  implicit class XDataSourceOps[Self <: XDataSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataSequences(value: SafeArray[XLabeledDataSequence]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataSequences")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDataSequences(value: () => SafeArray[XLabeledDataSequence]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataSequences")(js.Any.fromFunction0(value))
        ret
    }
  }
