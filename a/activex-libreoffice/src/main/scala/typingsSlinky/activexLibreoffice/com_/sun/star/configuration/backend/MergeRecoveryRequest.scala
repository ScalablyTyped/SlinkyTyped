...
object MergeRecoveryRequest {
  ...
  implicit class MergeRecoveryRequestOps[Self <: MergeRecoveryRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withErrorLayerId(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ErrorLayerId")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsRemovalRequest(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsRemovalRequest")(value.asInstanceOf[js.Any])
        ret
    }
  }
