...
object XTreeEditListener {
  ...
  implicit class XTreeEditListenerOps[Self <: XTreeEditListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNodeEdited(value: (XTreeNode, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nodeEdited")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withNodeEditing(value: XTreeNode => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nodeEditing")(js.Any.fromFunction1(value))
        ret
    }
  }
