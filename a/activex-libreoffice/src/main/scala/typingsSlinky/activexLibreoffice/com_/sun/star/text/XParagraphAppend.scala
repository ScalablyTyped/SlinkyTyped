...
object XParagraphAppend {
  ...
  implicit class XParagraphAppendOps[Self <: XParagraphAppend] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFinishParagraph(value: PropertyValues => XTextRange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("finishParagraph")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFinishParagraphInsert(value: (PropertyValues, XTextRange) => XTextRange): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("finishParagraphInsert")(js.Any.fromFunction2(value))
        ret
    }
  }
