...
object XCellRangeFormula {
  ...
  implicit class XCellRangeFormulaOps[Self <: XCellRangeFormula] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFormulaArray(value: SafeArray[SafeArray[String]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FormulaArray")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetFormulaArray(value: () => SafeArray[SafeArray[String]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFormulaArray")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetFormulaArray(value: SeqEquiv[SeqEquiv[String]] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFormulaArray")(js.Any.fromFunction1(value))
        ret
    }
  }
