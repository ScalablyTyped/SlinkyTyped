...
object XSlideShowView {
  ...
  implicit class XSlideShowViewOps[Self <: XSlideShowView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanvas(value: XSpriteCanvas): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Canvas")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCanvasArea(value: Rectangle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CanvasArea")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTransformation(value: AffineMatrix2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Transformation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTranslationOffset(value: IntegerSize2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TranslationOffset")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withAddTransformationChangedListener(value: XModifyListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addTransformationChangedListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetCanvas(value: () => XSpriteCanvas): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCanvas")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetCanvasArea(value: () => Rectangle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCanvasArea")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetTransformation(value: () => AffineMatrix2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTransformation")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetTranslationOffset(value: () => IntegerSize2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTranslationOffset")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRemoveTransformationChangedListener(value: XModifyListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeTransformationChangedListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetMouseCursor(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setMouseCursor")(js.Any.fromFunction1(value))
        ret
    }
  }
