...
object GetExpression {
  ...
  implicit class GetExpressionOps[Self <: GetExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsFixedLanguage(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsFixedLanguage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsShowFormula(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsShowFormula")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withVariableSubtype(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VariableSubtype")(value.asInstanceOf[js.Any])
        ret
    }
  }
