...
object UnoControlListBoxModel {
  ...
  implicit class UnoControlListBoxModelOps[Self <: UnoControlListBoxModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItemSeparatorPos(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ItemSeparatorPos")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMultiSelection(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withSelectedItems(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SelectedItems")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStringItemList(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StringItemList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
