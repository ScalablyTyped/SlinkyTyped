...
trait EnhancedCustomShapeExtrusion extends js.Object {
  ...
  var ProjectionMode: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.ProjectionMode
  /**
  ...
  var ShadeMode: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.ShadeMode
