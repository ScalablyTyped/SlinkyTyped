...
object XRowSet {
  ...
  implicit class XRowSetOps[Self <: XRowSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddRowSetListener(value: XRowSetListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addRowSetListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRemoveRowSetListener(value: XRowSetListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeRowSetListener")(js.Any.fromFunction1(value))
        ret
    }
  }
