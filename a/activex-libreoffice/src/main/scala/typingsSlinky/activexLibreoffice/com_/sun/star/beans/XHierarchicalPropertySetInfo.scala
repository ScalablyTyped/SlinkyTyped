...
object XHierarchicalPropertySetInfo {
  ...
  implicit class XHierarchicalPropertySetInfoOps[Self <: XHierarchicalPropertySetInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetPropertyByHierarchicalName(value: String => Property): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPropertyByHierarchicalName")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withHasPropertyByHierarchicalName(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasPropertyByHierarchicalName")(js.Any.fromFunction1(value))
        ret
    }
  }
