...
object XAxisSupplier {
  ...
  implicit class XAxisSupplierOps[Self <: XAxisSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAxis(value: Double => XAxis): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAxis")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSecondaryAxis(value: Double => XAxis): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSecondaryAxis")(js.Any.fromFunction1(value))
        ret
    }
  }
