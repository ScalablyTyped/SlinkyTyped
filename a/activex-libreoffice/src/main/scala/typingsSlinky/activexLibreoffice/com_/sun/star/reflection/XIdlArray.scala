...
object XIdlArray {
  ...
  implicit class XIdlArrayOps[Self <: XIdlArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: (js.Any, Double) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetLen(value: js.Any => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLen")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRealloc(value: (js.Array[_], Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("realloc")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSet(value: (js.Array[_], Double, js.Any) => Unit): Self = {
        val ret = this.duplicate
