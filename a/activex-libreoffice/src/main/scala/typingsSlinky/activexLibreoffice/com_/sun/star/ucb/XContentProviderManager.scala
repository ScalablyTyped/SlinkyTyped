...
object XContentProviderManager {
  ...
  implicit class XContentProviderManagerOps[Self <: XContentProviderManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDeregisterContentProvider(value: (XContentProvider, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deregisterContentProvider")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withQueryContentProvider(value: String => XContentProvider): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryContentProvider")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withQueryContentProviders(value: () => SafeArray[ContentProviderInfo]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryContentProviders")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRegisterContentProvider(value: (XContentProvider, String, Boolean) => XContentProvider): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerContentProvider")(js.Any.fromFunction3(value))
        ret
    }
  }
