...
object StringResourceWithLocation {
  ...
  implicit class StringResourceWithLocationOps[Self <: StringResourceWithLocation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: (String, Boolean, Locale, String, String, XInteractionHandler) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction6(value))
        ret
    }
  }
