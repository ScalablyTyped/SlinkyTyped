...
object XContainer {
  ...
  implicit class XContainerOps[Self <: XContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddContainerListener(value: XContainerListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addContainerListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveContainerListener(value: XContainerListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeContainerListener")(js.Any.fromFunction1(value))
        ret
    }
  }
