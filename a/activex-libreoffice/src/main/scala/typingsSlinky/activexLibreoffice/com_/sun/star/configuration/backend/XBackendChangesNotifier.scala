...
object XBackendChangesNotifier {
  ...
  implicit class XBackendChangesNotifierOps[Self <: XBackendChangesNotifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddChangesListener(value: (XBackendChangesListener, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addChangesListener")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRemoveChangesListener(value: (XBackendChangesListener, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeChangesListener")(js.Any.fromFunction2(value))
        ret
    }
  }
