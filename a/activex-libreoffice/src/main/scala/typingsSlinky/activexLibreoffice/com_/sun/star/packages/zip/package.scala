...
package object zip {
  /**
    ...
    */
  type ZipException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    * @since OOo 1.1.2
    */
  type ZipIOException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
}
