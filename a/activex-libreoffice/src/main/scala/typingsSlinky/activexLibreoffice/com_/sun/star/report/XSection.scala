...
object XSection {
  ...
  implicit class XSectionOps[Self <: XSection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanGrow(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CanGrow")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCanShrink(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CanShrink")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withConditionalPrintExpression(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConditionalPrintExpression")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withForceNewPage(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ForceNewPage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGroup(value: XGroup): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withKeepTogether(value: Boolean): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withNewRowOrCol(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NewRowOrCol")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRepeatSection(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RepeatSection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
