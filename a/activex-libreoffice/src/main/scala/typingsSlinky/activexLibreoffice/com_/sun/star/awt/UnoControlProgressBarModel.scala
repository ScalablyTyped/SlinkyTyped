...
object UnoControlProgressBarModel {
  ...
  implicit class UnoControlProgressBarModelOps[Self <: UnoControlProgressBarModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProgressValue(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgressValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProgressValueMax(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgressValueMax")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withProgressValueMin(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgressValueMin")(value.asInstanceOf[js.Any])
        ret
    }
  }
