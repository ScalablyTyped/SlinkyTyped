...
object XUriReferenceFactory {
  ...
  implicit class XUriReferenceFactoryOps[Self <: XUriReferenceFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMakeAbsolute(value: (XUriReference, XUriReference, Boolean, RelativeUriExcessParentSegments) => XUriReference): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("makeAbsolute")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withMakeRelative(value: (XUriReference, XUriReference, Boolean, Boolean, Boolean) => XUriReference): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("makeRelative")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withParse(value: String => XUriReference): Self = {
        val ret = this.duplicate
