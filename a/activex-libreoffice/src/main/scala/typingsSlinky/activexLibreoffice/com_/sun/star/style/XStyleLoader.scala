...
object XStyleLoader {
  ...
  implicit class XStyleLoaderOps[Self <: XStyleLoader] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStyleLoaderOptions(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StyleLoaderOptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetStyleLoaderOptions(value: () => SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStyleLoaderOptions")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLoadStylesFromURL(value: (String, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadStylesFromURL")(js.Any.fromFunction2(value))
        ret
    }
  }
