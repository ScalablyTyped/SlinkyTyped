...
object XFrames {
  ...
  implicit class XFramesOps[Self <: XFrames] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppend(value: XFrame => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("append")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withQueryFrames(value: Double => SafeArray[XFrame]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryFrames")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemove(value: XFrame => Unit): Self = {
        val ret = this.duplicate
