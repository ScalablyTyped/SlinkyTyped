...
object XLayerManager {
  ...
  implicit class XLayerManagerOps[Self <: XLayerManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttachShapeToLayer(value: (XShape, XLayer) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attachShapeToLayer")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetLayerForShape(value: XShape => XLayer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLayerForShape")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsertNewByIndex(value: Double => XLayer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertNewByIndex")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemove(value: XLayer => Unit): Self = {
        val ret = this.duplicate
