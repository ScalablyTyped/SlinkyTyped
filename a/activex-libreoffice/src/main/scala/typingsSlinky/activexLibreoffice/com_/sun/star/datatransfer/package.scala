...
package object datatransfer {
  ...
  /**
    ...
    */
  type DataFormatTranslator = typingsSlinky.activexLibreoffice.com_.sun.star.datatransfer.XDataFormatTranslator
  ...
  /**
    ...
    */
  type MimeContentTypeFactory = typingsSlinky.activexLibreoffice.com_.sun.star.datatransfer.XMimeContentTypeFactory
  ...
  /**
    ...
    */
  type UnsupportedFlavorException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
}
