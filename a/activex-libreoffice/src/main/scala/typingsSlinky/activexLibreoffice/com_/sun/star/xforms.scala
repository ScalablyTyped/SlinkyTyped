...
import typingsSlinky.activexLibreoffice.com_.sun.star.form.submission.XSubmissionVetoListener
...
import typingsSlinky.activexLibreoffice.com_.sun.star.util.VetoException
...
import typingsSlinky.activexLibreoffice.com_.sun.star.xml.dom.events.XEvent
import typingsSlinky.activexLibreoffice.com_.sun.star.xml.dom.events.XEventTarget
...
object xforms {
  ...
  object XFormsUIHelper1 {
    ...
    implicit class XFormsUIHelper1MutableBuilder[Self <: XFormsUIHelper1] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNewModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String) => XModel): Self = StObject.set(x, "newModel", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRemoveModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String) => Unit): Self = StObject.set(x, "removeModel", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRenameModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String, String) => Unit): Self = StObject.set(x, "renameModel", js.Any.fromFunction3(value))
  ...
  trait XSubmission
    extends XPropertySet
       with XNamed
       with typingsSlinky.activexLibreoffice.com_.sun.star.form.submission.XSubmission
  object XSubmission {
