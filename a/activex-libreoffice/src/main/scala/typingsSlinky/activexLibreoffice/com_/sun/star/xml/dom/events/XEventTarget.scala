...
object XEventTarget {
  ...
  implicit class XEventTargetOps[Self <: XEventTarget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddEventListener(value: (String, XEventListener, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addEventListener")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withDispatchEvent(value: XEvent => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dispatchEvent")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveEventListener(value: (String, XEventListener, Boolean) => Unit): Self = {
        val ret = this.duplicate
