...
object XTransferDataAccess {
  ...
  implicit class XTransferDataAccessOps[Self <: XTransferDataAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetData(value: SeqEquiv[DataFlavor] => SafeArray[_]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getData")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withQueryDataSize(value: SeqEquiv[DataFlavor] => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryDataSize")(js.Any.fromFunction1(value))
        ret
    }
  }
