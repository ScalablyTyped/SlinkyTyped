...
object TextMarkupDescriptor {
  ...
  implicit class TextMarkupDescriptorOps[Self <: TextMarkupDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("aIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNLength(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nLength")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("nType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withXMarkupInfoContainer(value: XStringKeyMap): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("xMarkupInfoContainer")(value.asInstanceOf[js.Any])
        ret
    }
  }
