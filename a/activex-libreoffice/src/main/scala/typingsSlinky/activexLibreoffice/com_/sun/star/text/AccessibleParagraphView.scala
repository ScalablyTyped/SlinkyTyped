...
import typingsSlinky.activexLibreoffice.com_.sun.star.accessibility.XAccessibleEditableText
...
import typingsSlinky.activexLibreoffice.com_.sun.star.accessibility.XAccessibleTextAttributes
