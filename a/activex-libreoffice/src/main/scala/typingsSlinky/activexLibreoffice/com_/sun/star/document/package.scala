...
package object document {
  /**
    ...
    * @since OOo 3.1
    */
  type ChangedByOthersRequest = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** interface to maintain a list of document revisions */
  type DocumentRevisionListPersistence = typingsSlinky.activexLibreoffice.com_.sun.star.document.XDocumentRevisionListPersistence
  /**
    ...
    * @since OOo 3.4
    */
  type EmptyUndoStackException = typingsSlinky.activexLibreoffice.com_.sun.star.util.InvalidStateException
  /**
    ...
    */
  type Events = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameReplace
  /**
    ...
    * @see TypeDetection
    */
  type ExtendedTypeDetection = typingsSlinky.activexLibreoffice.com_.sun.star.document.XExtendedFilterDetection
  type FilterAdapter = typingsSlinky.activexLibreoffice.com_.sun.star.document.XFilterAdapter
  /** @since LibreOffice 4.1 */
  type FilterConfigRefresh = typingsSlinky.activexLibreoffice.com_.sun.star.util.XRefreshable
  /** @since LibreOffice 4.1 */
  type IndexedPropertyValues = typingsSlinky.activexLibreoffice.com_.sun.star.container.XIndexContainer
  /**
    ...
    * LinkTarget} .
    */
  type LinkTargets = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    * Is used for interaction handle to query user decision regarding storing to a location where no lock file can be created.
    * @since OOo 3.0
    */
  type LockFileIgnoreRequest = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  /** @since LibreOffice 4.1 */
  type NamedPropertyValues = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameContainer
  /** allows to import document properties from OOXML format */
  type OOXMLDocumentPropertiesImporter = typingsSlinky.activexLibreoffice.com_.sun.star.document.XOOXMLDocumentPropertiesImporter
  /**
    ...
    * @since OOo 1.1.2
    */
  type OleEmbeddedServerRegistration = typingsSlinky.activexLibreoffice.com_.sun.star.uno.XInterface
  /** This service is for a {@link PDFDialog} */
  type PDFDialog = typingsSlinky.activexLibreoffice.com_.sun.star.ui.dialogs.FilterOptionsDialog
  /**
    ...
    * @since OOo 3.4
    */
  type UndoContextNotClosedException = typingsSlinky.activexLibreoffice.com_.sun.star.util.InvalidStateException
  /**
    ...
    * @since OOo 2.0
    */
  type XMLOasisBasicImporter = typingsSlinky.activexLibreoffice.com_.sun.star.document.XXMLOasisBasicImporter
}
