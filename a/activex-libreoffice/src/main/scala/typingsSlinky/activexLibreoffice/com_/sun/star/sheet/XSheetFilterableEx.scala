...
object XSheetFilterableEx {
  ...
  implicit class XSheetFilterableExOps[Self <: XSheetFilterableEx] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateFilterDescriptorByObject(value: XSheetFilterable => XSheetFilterDescriptor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createFilterDescriptorByObject")(js.Any.fromFunction1(value))
        ret
    }
  }
