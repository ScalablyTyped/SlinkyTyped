...
object XSubmit {
  ...
  implicit class XSubmitOps[Self <: XSubmit] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddSubmitListener(value: XSubmitListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addSubmitListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveSubmitListener(value: XSubmitListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeSubmitListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSubmit(value: (XControl, MouseEvent) => Unit): Self = {
        val ret = this.duplicate
