...
object XResourceFactoryManager {
  ...
  implicit class XResourceFactoryManagerOps[Self <: XResourceFactoryManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddResourceFactory(value: (String, XResourceFactory) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addResourceFactory")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetResourceFactory(value: String => XResourceFactory): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getResourceFactory")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveResourceFactoryForReference(value: XResourceFactory => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeResourceFactoryForReference")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveResourceFactoryForURL(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeResourceFactoryForURL")(js.Any.fromFunction1(value))
        ret
    }
  }
