...
object XDatabaseRegistrationsListener {
  ...
  implicit class XDatabaseRegistrationsListenerOps[Self <: XDatabaseRegistrationsListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangedDatabaseLocation(value: DatabaseRegistrationEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changedDatabaseLocation")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRegisteredDatabaseLocation(value: DatabaseRegistrationEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registeredDatabaseLocation")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRevokedDatabaseLocation(value: DatabaseRegistrationEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("revokedDatabaseLocation")(js.Any.fromFunction1(value))
        ret
    }
  }
