...
object XSpreadsheets {
  ...
  implicit class XSpreadsheetsOps[Self <: XSpreadsheets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCopyByName(value: (String, String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("copyByName")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withInsertNewByName(value: (String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertNewByName")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withMoveByName(value: (String, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("moveByName")(js.Any.fromFunction2(value))
        ret
    }
  }
