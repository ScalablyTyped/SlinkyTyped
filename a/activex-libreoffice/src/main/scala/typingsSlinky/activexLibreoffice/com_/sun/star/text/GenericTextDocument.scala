...
import typingsSlinky.activexLibreoffice.com_.sun.star.tiledrendering.XTiledRenderable
...
- typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.text.XTextDocument because var conflicts: CurrentController. Inlined getText, reformat, Text */ @js.native
