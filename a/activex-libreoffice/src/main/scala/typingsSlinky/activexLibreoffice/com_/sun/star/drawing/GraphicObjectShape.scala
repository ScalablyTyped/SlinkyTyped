...
object GraphicObjectShape {
  ...
  implicit class GraphicObjectShapeOps[Self <: GraphicObjectShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGraphicObjectFillBitmap(value: XBitmap): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GraphicObjectFillBitmap")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGraphicStreamURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GraphicStreamURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
