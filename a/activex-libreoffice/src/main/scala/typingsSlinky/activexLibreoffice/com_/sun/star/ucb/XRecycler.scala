...
object XRecycler {
  ...
  implicit class XRecyclerOps[Self <: XRecycler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTrashContent(value: (XCommandProcessor, XContentIdentifier) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("trashContent")(js.Any.fromFunction2(value))
        ret
    }
  }
