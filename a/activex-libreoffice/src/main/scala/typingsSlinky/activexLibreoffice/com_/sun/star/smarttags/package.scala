...
package object smarttags {
  /**
    ...
    * @since OOo 2.3
    */
  type SmartTagAction = typingsSlinky.activexLibreoffice.com_.sun.star.smarttags.XSmartTagAction
  /**
    ...
    * @since OOo 2.3
    */
  type SmartTagRecognizer = typingsSlinky.activexLibreoffice.com_.sun.star.smarttags.XSmartTagRecognizer
}
