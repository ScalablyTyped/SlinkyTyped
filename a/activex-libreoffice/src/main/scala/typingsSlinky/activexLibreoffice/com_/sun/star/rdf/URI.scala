...
object URI {
  ...
  implicit class URIOps[Self <: URI] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateKnown(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createKnown")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateNS(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createNS")(js.Any.fromFunction2(value))
        ret
    }
  }
