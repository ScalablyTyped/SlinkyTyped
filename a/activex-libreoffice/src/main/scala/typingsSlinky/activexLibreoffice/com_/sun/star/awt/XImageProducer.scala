...
object XImageProducer {
  ...
  implicit class XImageProducerOps[Self <: XImageProducer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddConsumer(value: XImageConsumer => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addConsumer")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveConsumer(value: XImageConsumer => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeConsumer")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withStartProduction(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startProduction")(js.Any.fromFunction0(value))
        ret
    }
  }
