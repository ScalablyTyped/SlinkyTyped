...
object XWizardController {
  ...
  implicit class XWizardControllerOps[Self <: XWizardController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfirmFinish(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("confirmFinish")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCreatePage(value: (XWindow, Double) => XWizardPage): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPage")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnActivatePage(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onActivatePage")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnDeactivatePage(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onDeactivatePage")(js.Any.fromFunction1(value))
        ret
    }
  }
