...
object XDataFormatTranslator {
  ...
  implicit class XDataFormatTranslatorOps[Self <: XDataFormatTranslator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDataFlavorFromSystemDataType(value: js.Any => DataFlavor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataFlavorFromSystemDataType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSystemDataTypeFromDataFlavor(value: DataFlavor => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSystemDataTypeFromDataFlavor")(js.Any.fromFunction1(value))
        ret
    }
  }
