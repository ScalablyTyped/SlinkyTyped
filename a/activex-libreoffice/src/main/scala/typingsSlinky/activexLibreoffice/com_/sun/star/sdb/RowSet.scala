...
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.RowSet because var conflicts: CursorName, FetchDirection, FetchSize, ResultSetConcurrency, ResultSetType. Inlined Command, DataSourceName, EscapeProcessing, MaxFieldSize, MaxRows, Password, QueryTimeOut, TransactionIsolation, TypeMap, URL, User */ trait RowSet
