...
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XRowUpdate because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XColumnLocate because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XRow because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XResultSetUpdate because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XResultSet because Already inherited
...
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.ResultSet because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.RowSet because var conflicts: CursorName, FetchDirection, FetchSize, ResultSetConcurrency, ResultSetType. Inlined Command, DataSourceName, EscapeProcessing, MaxFieldSize, MaxRows, Password, QueryTimeOut, TransactionIsolation, TypeMap, URL, User */ @js.native
trait RowSet
...
object RowSet {
  ...
  implicit class RowSetOps[Self <: RowSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIgnoreResult(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IgnoreResult")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
