...
object Shape {
  ...
  implicit class ShapeOps[Self <: Shape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndPositionInHoriL2R(value: Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EndPositionInHoriL2R")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPositionLayoutDir(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PositionLayoutDir")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStartPositionInHoriL2R(value: Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartPositionInHoriL2R")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTextRange(value: XTextRange): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTransformationInHoriL2R(value: HomogenMatrix3): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TransformationInHoriL2R")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
