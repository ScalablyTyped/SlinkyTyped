...
object DataPilotFieldGroupInfo {
  ...
  implicit class DataPilotFieldGroupInfoOps[Self <: DataPilotFieldGroupInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGroupBy(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GroupBy")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGroups(value: XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Groups")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasAutoEnd(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasAutoEnd")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasAutoStart(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasAutoStart")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasDateValues(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasDateValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSourceField(value: XDataPilotField): Self = {
        val ret = this.duplicate
