...
object XInputSequenceChecker {
  ...
  implicit class XInputSequenceCheckerOps[Self <: XInputSequenceChecker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCheckInputSequence(value: (String, Double, String, Double) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("checkInputSequence")(js.Any.fromFunction4(value))
        ret
    }
  }
