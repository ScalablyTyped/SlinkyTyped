...
object XDataEditorListener {
  ...
  implicit class XDataEditorListenerOps[Self <: XDataEditorListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUpdateDataEditorState(value: DataEditorEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateDataEditorState")(js.Any.fromFunction1(value))
        ret
    }
  }
