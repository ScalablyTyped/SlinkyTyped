...
object XCalendar3 {
  ...
  implicit class XCalendar3Ops[Self <: XCalendar3] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDays2(value: SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Days2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGenitiveMonths2(value: SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GenitiveMonths2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLoadedCalendar2(value: Calendar2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LoadedCalendar2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMonths2(value: SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Months2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPartitiveMonths2(value: SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PartitiveMonths2")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDays2(value: () => SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDays2")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetGenitiveMonths2(value: () => SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getGenitiveMonths2")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetLoadedCalendar2(value: () => Calendar2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLoadedCalendar2")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetMonths2(value: () => SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMonths2")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetPartitiveMonths2(value: () => SafeArray[CalendarItem2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPartitiveMonths2")(js.Any.fromFunction0(value))
        ret
    }
  }
