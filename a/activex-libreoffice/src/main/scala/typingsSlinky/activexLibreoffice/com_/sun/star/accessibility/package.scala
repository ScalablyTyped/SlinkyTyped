...
package object accessibility {
  /**
    ...
    * @since OOo 1.1.2
    */
  type Accessible = typingsSlinky.activexLibreoffice.com_.sun.star.accessibility.XAccessible
  /**
    ...
    * @since OOo 1.1.2
    */
  type IllegalAccessibleComponentStateException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  type MSAAService = typingsSlinky.activexLibreoffice.com_.sun.star.accessibility.XMSAAService
}
