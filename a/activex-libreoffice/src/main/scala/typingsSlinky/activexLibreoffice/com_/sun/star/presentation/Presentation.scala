...
object Presentation {
  ...
  implicit class PresentationOps[Self <: Presentation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllowAnimations(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AllowAnimations")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCustomShow(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CustomShow")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFirstPage(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FirstPage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsAlwaysOnTop(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsAlwaysOnTop")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    def withIsEndless(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsEndless")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsLivePresentation(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsLivePresentation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsMouseVisible(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsMouseVisible")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStartWithNavigator(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StartWithNavigator")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
