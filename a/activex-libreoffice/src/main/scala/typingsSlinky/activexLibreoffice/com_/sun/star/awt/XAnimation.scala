...
object XAnimation {
  ...
  implicit class XAnimationOps[Self <: XAnimation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsAnimationRunning(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isAnimationRunning")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withStartAnimation(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startAnimation")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
