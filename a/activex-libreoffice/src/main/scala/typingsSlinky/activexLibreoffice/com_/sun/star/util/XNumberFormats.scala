...
object XNumberFormats {
  ...
  implicit class XNumberFormatsOps[Self <: XNumberFormats] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddNew(value: (String, Locale) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addNew")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAddNewConverted(value: (String, Locale, Locale) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addNewConverted")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGenerateFormat(value: (Double, Locale, Boolean, Boolean, Double, Double) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("generateFormat")(js.Any.fromFunction6(value))
        ret
    }
    @scala.inline
    def withGetByKey(value: Double => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getByKey")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withQueryKey(value: (String, Locale, Boolean) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryKey")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withQueryKeys(value: (Double, Locale, Boolean) => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryKeys")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRemoveByKey(value: Double => Unit): Self = {
        val ret = this.duplicate
