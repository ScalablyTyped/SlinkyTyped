...
object ItemListEvent {
  ...
  implicit class ItemListEventOps[Self <: ItemListEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItemImageURL(value: Optional[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ItemImageURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withItemPosition(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ItemPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withItemText(value: Optional[String]): Self = {
        val ret = this.duplicate
