...
object ResultSet {
  ...
  implicit class ResultSetOps[Self <: ResultSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCursorName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CursorName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFetchDirection(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FetchDirection")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withResultSetConcurrency(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResultSetConcurrency")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResultSetType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ResultSetType")(value.asInstanceOf[js.Any])
        ret
    }
  }
