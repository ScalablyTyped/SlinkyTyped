...
object XCopyTableListener {
  ...
  implicit class XCopyTableListenerOps[Self <: XCopyTableListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCopiedRow(value: CopyTableRowEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("copiedRow")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCopyRowError(value: CopyTableRowEvent => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("copyRowError")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCopyingRow(value: CopyTableRowEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("copyingRow")(js.Any.fromFunction1(value))
        ret
    }
  }
