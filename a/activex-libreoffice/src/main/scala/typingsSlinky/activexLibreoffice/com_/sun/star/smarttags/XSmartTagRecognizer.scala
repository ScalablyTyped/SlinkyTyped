package typingsSlinky.activexLibreoffice.com_.sun.star.smarttags

import typingsSlinky.activexLibreoffice.LibreOffice.SeqEquiv
import typingsSlinky.activexLibreoffice.`type`
import typingsSlinky.activexLibreoffice.com_.sun.star.frame.XController
import typingsSlinky.activexLibreoffice.com_.sun.star.i18n.XBreakIterator
import typingsSlinky.activexLibreoffice.com_.sun.star.lang.Locale
import typingsSlinky.activexLibreoffice.com_.sun.star.lang.XInitialization
import typingsSlinky.activexLibreoffice.com_.sun.star.text.XTextMarkup
...
object XSmartTagRecognizer {
  ...
  implicit class XSmartTagRecognizerOps[Self <: XSmartTagRecognizer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisplayPropertyPage(value: (Double, Locale) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("displayPropertyPage")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetSmartTagDownloadURL(value: Double => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSmartTagDownloadURL")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withHasPropertyPage(value: (Double, Locale) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasPropertyPage")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRecognize(
      value: (String, Double, Double, SmartTagRecognizerMode, Locale, XTextMarkup, String, XController, XBreakIterator) => Unit
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recognize")(js.Any.fromFunction9(value))
        ret
    }
  }
