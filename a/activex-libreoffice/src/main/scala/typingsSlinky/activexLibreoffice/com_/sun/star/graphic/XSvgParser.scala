...
object XSvgParser {
  ...
  implicit class XSvgParserOps[Self <: XSvgParser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDecomposition(value: (XInputStream, String) => SafeArray[XPrimitive2D]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDecomposition")(js.Any.fromFunction2(value))
        ret
    }
  }
