...
trait Style
  ...
  /**
    ...
    */
  var FollowStyle: String = js.native
  /**
  ...
  /**
    ...
    */
  var IsAutoUpdate: String = js.native
  /**
    ...
    */
  var IsPhysical: Boolean = js.native
  /**
    ...
    * @since OOo 2.0.1
    */
  var ParaStyleConditions: SafeArray[NamedValue] = js.native
  /**
  ...
  /**
    ...
    */
  var StyleInteropGrabBag: SafeArray[PropertyValue] = js.native
  /**
...
object Style {
  ...
  implicit class StyleOps[Self <: Style] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFollowStyle(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("FollowStyle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsAutoUpdate(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsAutoUpdate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsPhysical(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPhysical")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withParaStyleConditions(value: SafeArray[NamedValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ParaStyleConditions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStyleInteropGrabBag(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StyleInteropGrabBag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
