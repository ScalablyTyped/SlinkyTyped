...
import typingsSlinky.activexLibreoffice.com_.sun.star.ui.dialogs.XAsynchronousExecutableDialog
import typingsSlinky.activexLibreoffice.com_.sun.star.ui.dialogs.XDialogClosedListener
...
object PackageManagerDialog {
  ...
  implicit class PackageManagerDialogOps[Self <: PackageManagerDialog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: (XWindow, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCreateAndInstall(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createAndInstall")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
