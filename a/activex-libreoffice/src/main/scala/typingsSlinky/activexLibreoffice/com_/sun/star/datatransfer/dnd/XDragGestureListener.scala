...
object XDragGestureListener {
  ...
  implicit class XDragGestureListenerOps[Self <: XDragGestureListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDragGestureRecognized(value: DragGestureEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dragGestureRecognized")(js.Any.fromFunction1(value))
        ret
    }
  }
