...
object ModuleInfo {
  ...
  implicit class ModuleInfoOps[Self <: ModuleInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withModuleObject(value: XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ModuleObject")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withModuleType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ModuleType")(value.asInstanceOf[js.Any])
        ret
    }
  }
