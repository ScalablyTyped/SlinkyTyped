...
object XAdjustmentListener {
  ...
  implicit class XAdjustmentListenerOps[Self <: XAdjustmentListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdjustmentValueChanged(value: AdjustmentEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("adjustmentValueChanged")(js.Any.fromFunction1(value))
        ret
    }
  }
