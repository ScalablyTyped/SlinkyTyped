...
trait XFont extends XInterface {
  /**
    ...
    */
  val FontDescriptor: typingsSlinky.activexLibreoffice.com_.sun.star.awt.FontDescriptor
  ...
  /**
    ...
    * The unit of measurement is pixels for the device.
    */
  def getFontDescriptor(): typingsSlinky.activexLibreoffice.com_.sun.star.awt.FontDescriptor
  /** returns additional information about the font. */
