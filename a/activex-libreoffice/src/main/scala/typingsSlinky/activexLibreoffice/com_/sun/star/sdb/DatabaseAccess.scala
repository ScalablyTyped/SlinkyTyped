...
object DatabaseAccess {
  ...
  implicit class DatabaseAccessOps[Self <: DatabaseAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnectInfo(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConnectInfo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withConnectURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConnectURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
