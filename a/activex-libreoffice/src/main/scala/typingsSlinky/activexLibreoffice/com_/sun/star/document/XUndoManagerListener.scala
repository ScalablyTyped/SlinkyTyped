...
object XUndoManagerListener {
  ...
  implicit class XUndoManagerListenerOps[Self <: XUndoManagerListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllActionsCleared(value: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject => Unit): Self = this.set("allActionsCleared", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRedoActionsCleared(value: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject => Unit): Self = this.set("redoActionsCleared", js.Any.fromFunction1(value))
    @scala.inline
    def setResetAll(value: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject => Unit): Self = this.set("resetAll", js.Any.fromFunction1(value))
    @scala.inline
