...
trait XUndoManagerListener
  ...
  /**
    ...
    */
  def allActionsCleared(iEvent: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject): Unit
  /**
  ...
  /**
    ...
    */
  def redoActionsCleared(iEvent: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject): Unit
  /** called when the complete undo manager has been reset */
  def resetAll(iEvent: typingsSlinky.activexLibreoffice.com_.sun.star.lang.EventObject): Unit
  /**
