...
object XTransactionBroadcaster {
  ...
  implicit class XTransactionBroadcasterOps[Self <: XTransactionBroadcaster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddTransactionListener(value: XTransactionListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addTransactionListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveTransactionListener(value: XTransactionListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeTransactionListener")(js.Any.fromFunction1(value))
        ret
    }
  }
