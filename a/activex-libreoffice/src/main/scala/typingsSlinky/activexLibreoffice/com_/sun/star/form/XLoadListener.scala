...
object XLoadListener {
  ...
  implicit class XLoadListenerOps[Self <: XLoadListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLoaded(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loaded")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReloaded(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reloaded")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReloading(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reloading")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUnloaded(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unloaded")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUnloading(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("unloading")(js.Any.fromFunction1(value))
        ret
    }
  }
