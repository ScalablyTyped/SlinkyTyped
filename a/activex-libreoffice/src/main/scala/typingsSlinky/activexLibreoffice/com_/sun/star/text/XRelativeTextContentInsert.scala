...
object XRelativeTextContentInsert {
  ...
  implicit class XRelativeTextContentInsertOps[Self <: XRelativeTextContentInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInsertTextContentAfter(value: (XTextContent, XTextContent) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertTextContentAfter")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withInsertTextContentBefore(value: (XTextContent, XTextContent) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertTextContentBefore")(js.Any.fromFunction2(value))
        ret
    }
  }
