...
import typingsSlinky.activexLibreoffice.com_.sun.star.task.XStatusIndicatorFactory
...
object XFrame2 {
  ...
  implicit class XFrame2Ops[Self <: XFrame2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDispatchRecorderSupplier(value: XDispatchRecorderSupplier): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DispatchRecorderSupplier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLayoutManager(value: XInterface): Self = {
        val ret = this.duplicate
