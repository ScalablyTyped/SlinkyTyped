...
object XCachedContentResultSetStubFactory {
  ...
  implicit class XCachedContentResultSetStubFactoryOps[Self <: XCachedContentResultSetStubFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateCachedContentResultSetStub(value: XResultSet => XResultSet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createCachedContentResultSetStub")(js.Any.fromFunction1(value))
        ret
    }
  }
