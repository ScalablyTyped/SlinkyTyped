...
object XCommonEmbedPersist {
  ...
  implicit class XCommonEmbedPersistOps[Self <: XCommonEmbedPersist] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReload(value: (SeqEquiv[PropertyValue], SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("reload")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withStoreOwn(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("storeOwn")(js.Any.fromFunction0(value))
        ret
    }
  }
