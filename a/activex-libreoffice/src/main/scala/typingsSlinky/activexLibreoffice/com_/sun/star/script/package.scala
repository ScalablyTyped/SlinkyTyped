...
package object script {
  ...
  type AllListenerAdapter = typingsSlinky.activexLibreoffice.com_.sun.star.script.XAllListenerAdapterService
  ...
  /**
    ...
    */
  type CannotCreateAdapterException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type Converter = typingsSlinky.activexLibreoffice.com_.sun.star.script.XTypeConverter
  ...
  /**
    ...
    */
  type Engine = typingsSlinky.activexLibreoffice.com_.sun.star.script.XEngine
  ...
  /**
    ...
    */
  type Invocation = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleServiceFactory
  ...
  /**
    ...
    */
  type InvocationAdapterFactory = typingsSlinky.activexLibreoffice.com_.sun.star.script.XInvocationAdapterFactory2
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type JavaScript = typingsSlinky.activexLibreoffice.com_.sun.star.script.Engine
  
  /**
    * is thrown when an operation on a unloaded library is attempted which requires the library being loaded.
    * @since OOo 3.0
    */
  type LibraryNotLoadedException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * Provides documentation for UNO services
    * @since LibreOffice 5.1
    */
  type theServiceDocumenter = typingsSlinky.activexLibreoffice.com_.sun.star.script.XServiceDocumenter
}
