...
object XSignatureCreationResultListener {
  ...
  implicit class XSignatureCreationResultListenerOps[Self <: XSignatureCreationResultListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSignatureCreated(value: (Double, SecurityOperationStatus) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("signatureCreated")(js.Any.fromFunction2(value))
        ret
    }
  }
