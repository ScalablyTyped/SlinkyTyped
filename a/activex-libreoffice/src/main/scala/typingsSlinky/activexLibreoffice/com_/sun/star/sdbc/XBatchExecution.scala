...
object XBatchExecution {
  ...
  implicit class XBatchExecutionOps[Self <: XBatchExecution] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddBatch(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addBatch")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withClearBatch(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearBatch")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withExecuteBatch(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeBatch")(js.Any.fromFunction0(value))
        ret
    }
  }
