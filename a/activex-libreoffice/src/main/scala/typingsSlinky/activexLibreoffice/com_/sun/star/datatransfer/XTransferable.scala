...
object XTransferable {
  ...
  implicit class XTransferableOps[Self <: XTransferable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransferDataFlavors(value: SafeArray[DataFlavor]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TransferDataFlavors")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetTransferData(value: DataFlavor => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTransferData")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetTransferDataFlavors(value: () => SafeArray[DataFlavor]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTransferDataFlavors")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsDataFlavorSupported(value: DataFlavor => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isDataFlavorSupported")(js.Any.fromFunction1(value))
        ret
    }
  }
