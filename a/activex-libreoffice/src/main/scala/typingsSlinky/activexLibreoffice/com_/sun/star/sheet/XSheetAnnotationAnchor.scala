...
object XSheetAnnotationAnchor {
  ...
  implicit class XSheetAnnotationAnchorOps[Self <: XSheetAnnotationAnchor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAnnotation(value: XSheetAnnotation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Annotation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetAnnotation(value: () => XSheetAnnotation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAnnotation")(js.Any.fromFunction0(value))
        ret
    }
  }
