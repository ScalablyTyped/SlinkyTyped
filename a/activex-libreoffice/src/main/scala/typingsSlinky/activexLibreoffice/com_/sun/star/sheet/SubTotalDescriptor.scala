...
object SubTotalDescriptor {
  ...
  implicit class SubTotalDescriptorOps[Self <: SubTotalDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBindFormatsToContent(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BindFormatsToContent")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withEnableUserSortList(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EnableUserSortList")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withInsertPageBreaks(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InsertPageBreaks")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMaxFieldCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaxFieldCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUserSortListIndex(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UserSortListIndex")(value.asInstanceOf[js.Any])
        ret
    }
  }
