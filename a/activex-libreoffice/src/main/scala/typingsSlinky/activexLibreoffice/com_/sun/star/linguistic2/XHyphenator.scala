...
object XHyphenator {
  ...
  @scala.inline
  implicit class XHyphenatorOps[Self <: XHyphenator] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withCreatePossibleHyphens(value: (String, Locale, PropertyValues) => XPossibleHyphens): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPossibleHyphens")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withHyphenate(value: (String, Locale, Double, PropertyValues) => XHyphenatedWord): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hyphenate")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withQueryAlternativeSpelling(value: (String, Locale, Double, PropertyValues) => XHyphenatedWord): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryAlternativeSpelling")(js.Any.fromFunction4(value))
        ret
    }
  }
