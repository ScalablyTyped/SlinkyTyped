...
object XNativeNumberSupplier {
  ...
  implicit class XNativeNumberSupplierOps[Self <: XNativeNumberSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConvertFromXmlAttributes(value: NativeNumberXmlAttributes => Double): Self = this.set("convertFromXmlAttributes", js.Any.fromFunction1(value))
    @scala.inline
    def setConvertToXmlAttributes(value: (Locale, Double) => NativeNumberXmlAttributes): Self = this.set("convertToXmlAttributes", js.Any.fromFunction2(value))
    @scala.inline
    def setGetNativeNumberString(value: (String, Locale, Double) => String): Self = this.set("getNativeNumberString", js.Any.fromFunction3(value))
    @scala.inline
    def setIsValidNatNum(value: (Locale, Double) => Boolean): Self = this.set("isValidNatNum", js.Any.fromFunction2(value))
  }
