...
object XNamedRanges {
  ...
  implicit class XNamedRangesOps[Self <: XNamedRanges] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddNewByName(value: (String, String, CellAddress, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addNewByName")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withAddNewFromTitles(value: (CellRangeAddress, Border) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addNewFromTitles")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withOutputList(value: CellAddress => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("outputList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
