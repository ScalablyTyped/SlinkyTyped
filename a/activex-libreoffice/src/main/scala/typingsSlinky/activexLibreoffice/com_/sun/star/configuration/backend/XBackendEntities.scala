...
object XBackendEntities {
  ...
  implicit class XBackendEntitiesOps[Self <: XBackendEntities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdminEntity(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AdminEntity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOwnerEntity(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OwnerEntity")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetAdminEntity(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAdminEntity")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetOwnerEntity(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOwnerEntity")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsEqualEntity(value: (String, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isEqualEntity")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSupportsEntity(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsEntity")(js.Any.fromFunction1(value))
        ret
    }
  }
