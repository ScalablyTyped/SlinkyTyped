...
object XCompositeLayer {
  ...
  implicit class XCompositeLayerOps[Self <: XCompositeLayer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withListSubLayerIds(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("listSubLayerIds")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withReadSubLayerData(value: (XLayerHandler, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("readSubLayerData")(js.Any.fromFunction2(value))
        ret
    }
  }
