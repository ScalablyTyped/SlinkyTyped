...
object XRangeXMLConversion {
  ...
  implicit class XRangeXMLConversionOps[Self <: XRangeXMLConversion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConvertRangeFromXML(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertRangeFromXML")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withConvertRangeToXML(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertRangeToXML")(js.Any.fromFunction1(value))
        ret
    }
  }
