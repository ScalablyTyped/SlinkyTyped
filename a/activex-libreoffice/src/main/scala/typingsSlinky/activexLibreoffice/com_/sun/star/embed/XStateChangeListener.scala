...
object XStateChangeListener {
  ...
  implicit class XStateChangeListenerOps[Self <: XStateChangeListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChangingState(value: (EventObject, Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changingState")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withStateChanged(value: (EventObject, Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("stateChanged")(js.Any.fromFunction3(value))
        ret
    }
  }
