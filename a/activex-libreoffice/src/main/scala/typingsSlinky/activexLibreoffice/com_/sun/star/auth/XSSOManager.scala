...
object XSSOManager {
  ...
  implicit class XSSOManagerOps[Self <: XSSOManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateAcceptorContext(value: String => XSSOAcceptorContext): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createAcceptorContext")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateInitiatorContext(value: (String, String, String) => XSSOInitiatorContext): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createInitiatorContext")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
