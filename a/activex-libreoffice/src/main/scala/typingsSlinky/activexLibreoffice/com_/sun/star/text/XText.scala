...
object XText {
  ...
  implicit class XTextOps[Self <: XText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInsertTextContent(value: (XTextRange, XTextContent, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertTextContent")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRemoveTextContent(value: XTextContent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeTextContent")(js.Any.fromFunction1(value))
        ret
    }
  }
