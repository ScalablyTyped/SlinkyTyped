...
object XDataReceiver {
  ...
  implicit class XDataReceiverOps[Self <: XDataReceiver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRangeHighlighter(value: XRangeHighlighter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RangeHighlighter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUsedData(value: XDataSource): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UsedData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUsedRangeRepresentations(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UsedRangeRepresentations")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAttachDataProvider(value: XDataProvider => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attachDataProvider")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetRangeHighlighter(value: () => XRangeHighlighter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRangeHighlighter")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetUsedData(value: () => XDataSource): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUsedData")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetUsedRangeRepresentations(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUsedRangeRepresentations")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetArguments(value: SeqEquiv[PropertyValue] => Unit): Self = {
        val ret = this.duplicate
