...
object XMailService {
  ...
  implicit class XMailServiceOps[Self <: XMailService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCurrentConnectionContext(value: XCurrentContext): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CurrentConnectionContext")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSupportedConnectionTypes(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SupportedConnectionTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAddConnectionListener(value: XConnectionListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addConnectionListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withConnect(value: (XCurrentContext, XAuthenticator) => Unit): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetCurrentConnectionContext(value: () => XCurrentContext): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCurrentConnectionContext")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetSupportedConnectionTypes(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSupportedConnectionTypes")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRemoveConnectionListener(value: XConnectionListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeConnectionListener")(js.Any.fromFunction1(value))
        ret
    }
  }
