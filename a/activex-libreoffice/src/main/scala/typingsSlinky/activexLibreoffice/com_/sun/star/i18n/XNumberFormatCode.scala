...
object XNumberFormatCode {
  ...
  implicit class XNumberFormatCodeOps[Self <: XNumberFormatCode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAllFormatCode(value: (Double, Locale) => SafeArray[NumberFormatCode]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllFormatCode")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetAllFormatCodes(value: Locale => SafeArray[NumberFormatCode]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllFormatCodes")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetDefault(value: (Double, Double, Locale) => NumberFormatCode): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDefault")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetFormatCode(value: (Double, Locale) => NumberFormatCode): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFormatCode")(js.Any.fromFunction2(value))
        ret
    }
  }
