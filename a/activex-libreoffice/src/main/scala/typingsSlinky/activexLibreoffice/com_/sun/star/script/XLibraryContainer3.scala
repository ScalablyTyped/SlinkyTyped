...
object XLibraryContainer3 {
  ...
  implicit class XLibraryContainer3Ops[Self <: XLibraryContainer3] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetOriginalLibraryLinkURL(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOriginalLibraryLinkURL")(js.Any.fromFunction1(value))
        ret
    }
  }
