...
object XTextTablesSupplier {
  ...
  implicit class XTextTablesSupplierOps[Self <: XTextTablesSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTextTables(value: XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextTables")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetTextTables(value: () => XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTextTables")(js.Any.fromFunction0(value))
        ret
    }
  }
