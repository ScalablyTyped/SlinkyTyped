...
object XPropertySetOption {
  ...
  implicit class XPropertySetOptionOps[Self <: XPropertySetOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnableChangeListenerNotification(value: Boolean => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enableChangeListenerNotification")(js.Any.fromFunction1(value))
        ret
    }
  }
