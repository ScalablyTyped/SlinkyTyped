...
object XUnitConversion {
  ...
  implicit class XUnitConversionOps[Self <: XUnitConversion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConvertPointToLogic(value: (Point, Double) => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertPointToLogic")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withConvertPointToPixel(value: (Point, Double) => Point): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertPointToPixel")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withConvertSizeToLogic(value: (Size, Double) => Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertSizeToLogic")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withConvertSizeToPixel(value: (Size, Double) => Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertSizeToPixel")(js.Any.fromFunction2(value))
        ret
    }
  }
