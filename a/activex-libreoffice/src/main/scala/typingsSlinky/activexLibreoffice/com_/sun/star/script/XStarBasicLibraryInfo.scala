...
object XStarBasicLibraryInfo {
  ...
  implicit class XStarBasicLibraryInfoOps[Self <: XStarBasicLibraryInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDialogContainer(value: XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DialogContainer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExternalSourceURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ExternalSourceURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLinkTargetURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LinkTargetURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withModuleContainer(value: XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ModuleContainer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetDialogContainer(value: () => XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDialogContainer")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetExternalSourceURL(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getExternalSourceURL")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetLinkTargetURL(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLinkTargetURL")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetModuleContainer(value: () => XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getModuleContainer")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
