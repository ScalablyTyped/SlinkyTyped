...
object MailMessage {
  ...
  implicit class MailMessageOps[Self <: MailMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreate(value: (String, String, String, XTransferable) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("create")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withCreateWithAttachment(value: (String, String, String, XTransferable, MailAttachment) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithAttachment")(js.Any.fromFunction5(value))
        ret
    }
  }
