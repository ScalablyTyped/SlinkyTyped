...
object XSequenceOutputStream {
  ...
  implicit class XSequenceOutputStreamOps[Self <: XSequenceOutputStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWrittenBytes(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("WrittenBytes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetWrittenBytes(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getWrittenBytes")(js.Any.fromFunction0(value))
        ret
    }
  }
