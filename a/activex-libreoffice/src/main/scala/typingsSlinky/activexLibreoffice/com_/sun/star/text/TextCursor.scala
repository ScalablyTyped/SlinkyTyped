...
- typingsSlinky.activexLibreoffice.com_.sun.star.text.XTextCursor because var conflicts: String. Inlined collapseToEnd, collapseToStart, goLeft, goRight, gotoEnd, gotoRange, gotoStart, isCollapsed
...
- typingsSlinky.activexLibreoffice.com_.sun.star.text.XSentenceCursor because var conflicts: String. Inlined gotoEndOfSentence, gotoNextSentence, gotoPreviousSentence, gotoStartOfSentence, isEndOfSentence, isStartOfSentence
- typingsSlinky.activexLibreoffice.com_.sun.star.text.XWordCursor because var conflicts: String. Inlined gotoEndOfWord, gotoNextWord, gotoPreviousWord, gotoStartOfWord, isEndOfWord, isStartOfWord */ @js.native
trait TextCursor
  extends TextRange
