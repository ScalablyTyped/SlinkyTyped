...
object XTopWindowListener {
  ...
  implicit class XTopWindowListenerOps[Self <: XTopWindowListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWindowActivated(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowActivated")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowClosed(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowClosed")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowClosing(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowClosing")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowDeactivated(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowDeactivated")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowMinimized(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowMinimized")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowNormalized(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowNormalized")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withWindowOpened(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("windowOpened")(js.Any.fromFunction1(value))
        ret
    }
  }
