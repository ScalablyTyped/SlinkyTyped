...
import typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.ResultSet
...
object ContentResultSet {
  ...
  implicit class ContentResultSetOps[Self <: ContentResultSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCursorTravelMode(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CursorTravelMode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsRowCountFinal(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsRowCountFinal")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
