...
object XClipboardNotifier {
  ...
  implicit class XClipboardNotifierOps[Self <: XClipboardNotifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddClipboardListener(value: XClipboardListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addClipboardListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveClipboardListener(value: XClipboardListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeClipboardListener")(js.Any.fromFunction1(value))
        ret
    }
  }
