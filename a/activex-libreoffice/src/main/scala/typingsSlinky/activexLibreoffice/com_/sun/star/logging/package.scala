...
package object logging {
  ...
  /**
    ...
    * @since OOo 3.2
    */
  type DocumentIOLogRing = typingsSlinky.activexLibreoffice.com_.sun.star.logging.XSimpleLogRing
  ...
  /**
    ...
    * @since OOo 2.3
    */
  type LoggerPool = typingsSlinky.activexLibreoffice.com_.sun.star.logging.XLoggerPool
}
