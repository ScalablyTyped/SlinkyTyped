...
object XLoggerPool {
  ...
  implicit class XLoggerPoolOps[Self <: XLoggerPool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDefaultLogger(value: XLogger): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DefaultLogger")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDefaultLogger(value: () => XLogger): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDefaultLogger")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetNamedLogger(value: String => XLogger): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNamedLogger")(js.Any.fromFunction1(value))
        ret
    }
  }
