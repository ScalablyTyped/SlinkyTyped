...
/**
  * specifies service of a text field that displays the number of paragraphs contained in the document.
  * @see com.sun.star.text.TextField
  */
@js.native
trait ParagraphCount extends TextField_ {
...
object ParagraphCount {
  ...
  @scala.inline
  implicit class ParagraphCountOps[Self <: ParagraphCount] (val x: Self) extends AnyVal {
    @scala.inline
