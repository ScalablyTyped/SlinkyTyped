...
object ModuleAcceleratorConfiguration {
  ...
  implicit class ModuleAcceleratorConfigurationOps[Self <: ModuleAcceleratorConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateWithModuleIdentifier(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithModuleIdentifier")(js.Any.fromFunction1(value))
        ret
    }
  }
