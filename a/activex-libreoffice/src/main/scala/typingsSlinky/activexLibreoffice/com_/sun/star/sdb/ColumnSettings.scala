...
object ColumnSettings {
  ...
  implicit class ColumnSettingsOps[Self <: ColumnSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControlDefault(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ControlDefault")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withControlModel(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ControlModel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
