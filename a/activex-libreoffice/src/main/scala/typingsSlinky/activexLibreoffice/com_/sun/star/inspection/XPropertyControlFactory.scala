...
object XPropertyControlFactory {
  ...
  implicit class XPropertyControlFactoryOps[Self <: XPropertyControlFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreatePropertyControl(value: (Double, Boolean) => XPropertyControl): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPropertyControl")(js.Any.fromFunction2(value))
        ret
    }
  }
