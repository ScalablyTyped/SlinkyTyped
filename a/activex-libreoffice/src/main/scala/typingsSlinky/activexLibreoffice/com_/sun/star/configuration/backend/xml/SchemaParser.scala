package typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.xml

import typingsSlinky.activexLibreoffice.LibreOffice.SeqEquiv
import typingsSlinky.activexLibreoffice.`type`
import typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XSchema
import typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XSchemaHandler
