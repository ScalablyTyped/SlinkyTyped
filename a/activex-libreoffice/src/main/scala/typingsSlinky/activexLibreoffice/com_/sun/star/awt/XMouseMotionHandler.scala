...
object XMouseMotionHandler {
  ...
  implicit class XMouseMotionHandlerOps[Self <: XMouseMotionHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMouseDragged(value: MouseEvent => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mouseDragged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMouseMoved(value: MouseEvent => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("mouseMoved")(js.Any.fromFunction1(value))
        ret
    }
  }
