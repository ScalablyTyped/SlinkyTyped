...
object XUIElementFactoryRegistration {
  ...
  implicit class XUIElementFactoryRegistrationOps[Self <: XUIElementFactoryRegistration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRegisteredFactories(value: SafeArray[SafeArray[PropertyValue]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RegisteredFactories")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeregisterFactory(value: (String, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deregisterFactory")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetFactory(value: (String, String) => XUIElementFactory): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFactory")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetRegisteredFactories(value: () => SafeArray[SafeArray[PropertyValue]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRegisteredFactories")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRegisterFactory(value: (String, String, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("registerFactory")(js.Any.fromFunction4(value))
        ret
    }
  }
