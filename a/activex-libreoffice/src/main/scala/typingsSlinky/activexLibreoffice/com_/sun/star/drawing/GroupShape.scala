...
- typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XShapeGroup because var conflicts: Position, Size. Inlined enterGroup, leaveGroup */ @js.native
trait GroupShape
  extends Shape
     with XShapes {
  /**
...
object GroupShape {
  ...
  @scala.inline
  implicit class GroupShapeOps[Self <: GroupShape] (val x: Self) extends AnyVal {
    @scala.inline
