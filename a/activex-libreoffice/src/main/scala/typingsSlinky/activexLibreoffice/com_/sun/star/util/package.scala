...
package object util {
  ...
  /**
    ...
    * @see ElementChange
    */
  type ChangesSet = typingsSlinky.activexLibreoffice.LibreOffice.SeqEquiv[typingsSlinky.activexLibreoffice.com_.sun.star.util.ElementChange]
  
  /**
    * this exception can be thrown to prevent the environment of any object from closing
    * @see XCloseListener
    */
  type CloseVetoException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  type InvalidStateException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * Manage cancelable jobs
    * @see XJobManager
    */
  type JobManager = typingsSlinky.activexLibreoffice.com_.sun.star.util.XJobManager
  ...
  type NotLockedException = typingsSlinky.activexLibreoffice.com_.sun.star.util.InvalidStateException
  
  /** indicates that a non-numeric string is to be converted to a number. */
  type NotNumericException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type NumberFormatter = typingsSlinky.activexLibreoffice.com_.sun.star.util.XNumberFormatter2
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type OfficeInstallationDirectories = typingsSlinky.activexLibreoffice.com_.sun.star.util.XOfficeInstallationDirectories
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type PathSettings = typingsSlinky.activexLibreoffice.com_.sun.star.util.XPathSettings
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type PathSubstitution = typingsSlinky.activexLibreoffice.com_.sun.star.util.XStringSubstitution
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type Sortable = typingsSlinky.activexLibreoffice.com_.sun.star.util.XSortable
  ...
  /**
    ...
    */
  type TextSearch = typingsSlinky.activexLibreoffice.com_.sun.star.util.XTextSearch
  ...
  /**
    ...
    * It is possible to search forward or backward in the string.
    */
  type TextSearch2 = typingsSlinky.activexLibreoffice.com_.sun.star.util.XTextSearch2
  
  /** helps to split up a string containing a {@link URL} into its structural parts and assembles the parts into a single string. */
  type URLTransformer = typingsSlinky.activexLibreoffice.com_.sun.star.util.XURLTransformer
  ...
  /**
    ...
    */
  type UriAbbreviation = typingsSlinky.activexLibreoffice.com_.sun.star.util.XStringAbbreviation
  
  /**
    * thrown to indicate a general veto.
    * @since OOo 1.1.2
    */
  type VetoException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @see MacroExpander
    */
  type theMacroExpander = typingsSlinky.activexLibreoffice.com_.sun.star.util.XMacroExpander
  ...
  /**
    ...
    * possibility to share one office user data directory among parallel office installations.
    */
  type theOfficeInstallationDirectories = typingsSlinky.activexLibreoffice.com_.sun.star.util.XOfficeInstallationDirectories
  ...
  /**
    ...
    */
  type thePathSettings = typingsSlinky.activexLibreoffice.com_.sun.star.util.XPathSettings
}
