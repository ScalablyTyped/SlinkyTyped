...
object XFetchProviderForContentAccess {
  ...
  implicit class XFetchProviderForContentAccessOps[Self <: XFetchProviderForContentAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFetchContentIdentifierStrings(value: (Double, Double, Boolean) => FetchResult): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetchContentIdentifierStrings")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withFetchContentIdentifiers(value: (Double, Double, Boolean) => FetchResult): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetchContentIdentifiers")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withFetchContents(value: (Double, Double, Boolean) => FetchResult): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fetchContents")(js.Any.fromFunction3(value))
        ret
    }
  }
