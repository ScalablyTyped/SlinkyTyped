...
object XDependentTextField {
  ...
  implicit class XDependentTextFieldOps[Self <: XDependentTextField] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTextFieldMaster(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextFieldMaster")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAttachTextFieldMaster(value: XPropertySet => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attachTextFieldMaster")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetTextFieldMaster(value: () => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTextFieldMaster")(js.Any.fromFunction0(value))
        ret
    }
  }
