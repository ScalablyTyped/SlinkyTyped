...
object GenericDrawPage {
  ...
  implicit class GenericDrawPageOps[Self <: GenericDrawPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsBackgroundDark(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsBackgroundDark")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withNavigationOrder(value: XIndexAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NavigationOrder")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOrientation(value: PaperOrientation): Self = {
        val ret = this.duplicate
