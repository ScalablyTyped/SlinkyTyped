...
package object sdbc {
  /**
    ...
    */
  type ConnectionPool = typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XConnectionPool
  /**
    ...
    * @see com.sun.star.sdbc.XConnection
    */
  type Driver = typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XDriver
  type DriverManager = typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XDriverManager2
  /**
    ...
    */
  type SQLWarning = typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.SQLException
}
