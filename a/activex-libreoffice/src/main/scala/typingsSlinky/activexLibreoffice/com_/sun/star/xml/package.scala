...
package object xml {
  /**
    ...
    * use a prefix.
    */
  type AttributeContainer = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameContainer
  /**
    * describes an import filter for XML-based file formats.
    * @since OOo 1.1.2
    */
  type ImportFilter = typingsSlinky.activexLibreoffice.com_.sun.star.xml.XImportFilter
  /**
    ...
    */
  type NamespaceContainer = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameContainer
  /**
    ...
    */
  type XMLExportFilter = typingsSlinky.activexLibreoffice.com_.sun.star.document.ExportFilter
}
