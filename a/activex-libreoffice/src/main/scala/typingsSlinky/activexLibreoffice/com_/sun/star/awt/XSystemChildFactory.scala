...
object XSystemChildFactory {
  ...
  implicit class XSystemChildFactoryOps[Self <: XSystemChildFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateSystemChild(value: (js.Any, SeqEquiv[Double], Double) => XWindowPeer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSystemChild")(js.Any.fromFunction3(value))
        ret
    }
  }
