...
trait TextProperties
  ...
  var TextAnimationDirection: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.TextAnimationDirection
  /** This value defines the type of animation. */
  var TextAnimationKind: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.TextAnimationKind
  ...
  var TextHorizontalAdjust: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.TextHorizontalAdjust
  /**
  ...
  var TextVerticalAdjust: typingsSlinky.activexLibreoffice.com_.sun.star.drawing.TextVerticalAdjust
