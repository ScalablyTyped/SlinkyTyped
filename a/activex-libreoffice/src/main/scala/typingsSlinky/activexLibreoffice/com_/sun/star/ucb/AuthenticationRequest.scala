...
object AuthenticationRequest {
  ...
  implicit class AuthenticationRequestOps[Self <: AuthenticationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHasPassword(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasPassword")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasRealm(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasRealm")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasUserName(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasUserName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
