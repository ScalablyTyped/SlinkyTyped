...
object XShapeGroup {
  ...
  implicit class XShapeGroupOps[Self <: XShapeGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEnterGroup(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("enterGroup")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLeaveGroup(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("leaveGroup")(js.Any.fromFunction0(value))
        ret
    }
  }
