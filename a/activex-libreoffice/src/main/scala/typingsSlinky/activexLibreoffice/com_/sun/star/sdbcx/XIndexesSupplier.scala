...
object XIndexesSupplier {
  ...
  implicit class XIndexesSupplierOps[Self <: XIndexesSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIndexes(value: XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Indexes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetIndexes(value: () => XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getIndexes")(js.Any.fromFunction0(value))
        ret
    }
  }
