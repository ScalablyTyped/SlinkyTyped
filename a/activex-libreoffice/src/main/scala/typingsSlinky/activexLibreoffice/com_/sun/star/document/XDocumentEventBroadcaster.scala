...
object XDocumentEventBroadcaster {
  ...
  implicit class XDocumentEventBroadcasterOps[Self <: XDocumentEventBroadcaster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddDocumentEventListener(value: XDocumentEventListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addDocumentEventListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withNotifyDocumentEvent(value: (String, XController2, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notifyDocumentEvent")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRemoveDocumentEventListener(value: XDocumentEventListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeDocumentEventListener")(js.Any.fromFunction1(value))
        ret
    }
  }
