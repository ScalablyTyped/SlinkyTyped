...
object XDocumentRecovery {
  ...
  implicit class XDocumentRecoveryOps[Self <: XDocumentRecovery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRecoverFromFile(value: (String, String, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("recoverFromFile")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withStoreToRecoveryFile(value: (String, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("storeToRecoveryFile")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withWasModifiedSinceLastSave(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("wasModifiedSinceLastSave")(js.Any.fromFunction0(value))
        ret
    }
  }
