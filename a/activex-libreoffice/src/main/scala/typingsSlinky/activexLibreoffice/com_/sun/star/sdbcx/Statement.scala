...
@js.native
trait Statement
  extends typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.Statement {
...
object Statement {
  ...
  implicit class StatementOps[Self <: Statement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUseBookmarks(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseBookmarks")(value.asInstanceOf[js.Any])
        ret
    }
  }
