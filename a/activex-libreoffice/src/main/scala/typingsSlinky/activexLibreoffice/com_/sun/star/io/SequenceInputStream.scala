...
object SequenceInputStream {
  ...
  implicit class SequenceInputStreamOps[Self <: SequenceInputStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateStreamFromSequence(value: SeqEquiv[Double] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createStreamFromSequence")(js.Any.fromFunction1(value))
        ret
    }
  }
