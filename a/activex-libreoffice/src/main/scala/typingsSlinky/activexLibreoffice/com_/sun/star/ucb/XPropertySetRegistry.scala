...
object XPropertySetRegistry {
  ...
  implicit class XPropertySetRegistryOps[Self <: XPropertySetRegistry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOpenPropertySet(value: (String, Boolean) => XPersistentPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("openPropertySet")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRemovePropertySet(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removePropertySet")(js.Any.fromFunction1(value))
        ret
    }
  }
