...
object XFlatParagraph {
  ...
  implicit class XFlatParagraphOps[Self <: XFlatParagraph] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLanguagePortions(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LanguagePortions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withChangeAttributes(value: (Double, Double, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeAttributes")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withChangeText(value: (Double, Double, String, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeText")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withGetLanguageOfText(value: (Double, Double) => Locale): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLanguageOfText")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetLanguagePortions(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLanguagePortions")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetPrimaryLanguageOfText(value: (Double, Double) => Locale): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPrimaryLanguageOfText")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsChecked(value: Double => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isChecked")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetChecked(value: (Double, Boolean) => Unit): Self = {
        val ret = this.duplicate
