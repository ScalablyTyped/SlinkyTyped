...
object XMenuBarMergingAcceptor {
  ...
  implicit class XMenuBarMergingAcceptorOps[Self <: XMenuBarMergingAcceptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRemoveMergedMenuBar(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeMergedMenuBar")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetMergedMenuBar(value: XIndexAccess => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setMergedMenuBar")(js.Any.fromFunction1(value))
        ret
    }
  }
