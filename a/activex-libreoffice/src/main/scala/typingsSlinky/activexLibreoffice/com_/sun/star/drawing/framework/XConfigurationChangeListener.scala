...
object XConfigurationChangeListener {
  ...
  implicit class XConfigurationChangeListenerOps[Self <: XConfigurationChangeListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNotifyConfigurationChange(value: ConfigurationChangeEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notifyConfigurationChange")(js.Any.fromFunction1(value))
        ret
    }
  }
