...
package object linguistic2 {
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type ConversionDictionaryList = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XConversionDictionaryList
  ...
  /**
    ...
    */
  type DictionaryList = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XSearchableDictionaryList
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type HangulHanjaConversionDictionary = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.ConversionDictionary
  
  type LanguageGuessing = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XLanguageGuessing
  
  /** the set of linguistic relevant properties. */
  type LinguProperties = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XLinguProperties
  
  /** offers linguistic functionality. Is to be used to access spell checker, hyphenator and thesaurus. */
  type LinguServiceManager = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XLinguServiceManager2
  ...
  /**
    ...
    * @since OOo 3.0.1
    */
  type Proofreader = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XProofreader
  ...
  /**
    ...
    * @since OOo 3.0.1
    */
  type ProofreadingIterator = typingsSlinky.activexLibreoffice.com_.sun.star.linguistic2.XProofreadingIterator
}
