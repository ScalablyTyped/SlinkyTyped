...
object XLibraryContainerExport {
  ...
  implicit class XLibraryContainerExportOps[Self <: XLibraryContainerExport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExportLibrary(value: (String, String, XInteractionHandler) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("exportLibrary")(js.Any.fromFunction3(value))
        ret
    }
  }
