...
object XHatchWindow {
  ...
  implicit class XHatchWindowOps[Self <: XHatchWindow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHatchBorderSize(value: Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HatchBorderSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSetController(value: XHatchWindowController => Unit): Self = {
        val ret = this.duplicate
