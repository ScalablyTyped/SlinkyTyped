...
package object io {
  ...
  type AlreadyConnectedException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  ...
  /**
    ...
    */
  type BufferSizeExceededException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  ...
  /**
    ...
    */
  type ConnectException = typingsSlinky.activexLibreoffice.com_.sun.star.io.SocketException
  
  /** is thrown when an input or output error has occurred. */
  type IOException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type NoRouteToHostException = typingsSlinky.activexLibreoffice.com_.sun.star.io.SocketException
  
  /** is thrown when a read/write operation is tried on an instance that has not been chained properly. */
  type NotConnectedException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  ...
  /**
    ...
    */
  type Pipe = typingsSlinky.activexLibreoffice.com_.sun.star.io.XPipe
  
  /** This service allows to wrap a sequence of bytes with a output stream object. */
  type SequenceOutputStream = typingsSlinky.activexLibreoffice.com_.sun.star.io.XSequenceOutputStream
  
  /** Thrown to indicate that there is an error in the underlying protocol, such as a TCP error. */
  type SocketException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  
  /** This service allows to get access to temp files. */
  type TempFile = typingsSlinky.activexLibreoffice.com_.sun.star.io.XTempFile
  ...
  /**
    ...
    */
  type TextInputStream = typingsSlinky.activexLibreoffice.com_.sun.star.io.XTextInputStream2
  ...
  /**
    ...
    */
  type TextOutputStream = typingsSlinky.activexLibreoffice.com_.sun.star.io.XTextOutputStream2
  
  /** is thrown when the `EOF` is reached during reading a datatype ( `long` , `string` , etc.). */
  type UnexpectedEOFException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  
  /** is thrown when the IP address of a host could not be determined. */
  type UnknownHostException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  
  /** is thrown when inconsistent data comes up while reading a complex data type ( `string` or object). */
  type WrongFormatException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
}
