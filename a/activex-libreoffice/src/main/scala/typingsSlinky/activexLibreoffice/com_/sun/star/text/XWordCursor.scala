...
object XWordCursor {
  ...
  implicit class XWordCursorOps[Self <: XWordCursor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGotoEndOfWord(value: Boolean => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gotoEndOfWord")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGotoNextWord(value: Boolean => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gotoNextWord")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGotoPreviousWord(value: Boolean => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gotoPreviousWord")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGotoStartOfWord(value: Boolean => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("gotoStartOfWord")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIsEndOfWord(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isEndOfWord")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsStartOfWord(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isStartOfWord")(js.Any.fromFunction0(value))
        ret
    }
  }
