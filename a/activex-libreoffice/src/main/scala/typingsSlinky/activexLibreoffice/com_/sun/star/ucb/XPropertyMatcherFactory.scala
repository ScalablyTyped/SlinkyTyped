...
object XPropertyMatcherFactory {
  ...
  implicit class XPropertyMatcherFactoryOps[Self <: XPropertyMatcherFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreatePropertyMatcher(value: SeqEquiv[SearchCriterium] => XPropertyMatcher): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPropertyMatcher")(js.Any.fromFunction1(value))
        ret
    }
  }
