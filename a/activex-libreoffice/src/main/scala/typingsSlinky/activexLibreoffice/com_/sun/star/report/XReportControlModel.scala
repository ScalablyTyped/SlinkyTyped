...
object XReportControlModel {
  ...
  implicit class XReportControlModelOps[Self <: XReportControlModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPrintWhenGroupChange(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PrintWhenGroupChange")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFormatCondition(value: () => XFormatCondition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createFormatCondition")(js.Any.fromFunction0(value))
        ret
    }
  }
