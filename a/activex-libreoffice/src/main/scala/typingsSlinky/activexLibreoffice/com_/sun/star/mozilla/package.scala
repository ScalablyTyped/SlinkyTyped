...
package object mozilla {
  
  /** Allows to execute dispatch for a menu item and handles listeners for changes in menu items. */
  type MenuProxy = typingsSlinky.activexLibreoffice.com_.sun.star.mozilla.XMenuProxy
  
  /** Listens for changes in menu items. */
  type MenuProxyListener = typingsSlinky.activexLibreoffice.com_.sun.star.mozilla.XMenuProxyListener
  ...
  /**
    ...
    */
  type MozillaBootstrap = typingsSlinky.activexLibreoffice.com_.sun.star.mozilla.XMozillaBootstrap
}
