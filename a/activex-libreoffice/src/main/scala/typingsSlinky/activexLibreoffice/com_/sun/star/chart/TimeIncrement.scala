...
object TimeIncrement {
  ...
  implicit class TimeIncrementOps[Self <: TimeIncrement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMajorTimeInterval(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MajorTimeInterval")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinorTimeInterval(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinorTimeInterval")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTimeResolution(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TimeResolution")(value.asInstanceOf[js.Any])
        ret
    }
  }
