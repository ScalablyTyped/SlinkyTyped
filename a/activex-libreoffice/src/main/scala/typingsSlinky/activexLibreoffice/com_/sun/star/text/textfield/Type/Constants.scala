package typingsSlinky.activexLibreoffice.com_.sun.star.text.textfield.Type
...
object Constants {
  ...
  @scala.inline
  def AUTHOR: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def DATE: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def DOCINFO_TITLE: `10` = 10.asInstanceOf[`10`]
  
  @scala.inline
  def EXTENDED_FILE: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def EXTENDED_TIME: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def MEASURE: `9` = 9.asInstanceOf[`9`]
  
  @scala.inline
  def PAGE: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def PAGES: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def PAGE_NAME: `14` = 14.asInstanceOf[`14`]
  
  @scala.inline
  def PRESENTATION_DATE_TIME: `13` = 13.asInstanceOf[`13`]
  
  @scala.inline
  def PRESENTATION_FOOTER: `12` = 12.asInstanceOf[`12`]
  
  @scala.inline
  def PRESENTATION_HEADER: `11` = 11.asInstanceOf[`11`]
  
  @scala.inline
  def TABLE: `5` = 5.asInstanceOf[`5`]
