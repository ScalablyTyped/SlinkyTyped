...
object XPresentationPage {
  ...
  implicit class XPresentationPageOps[Self <: XPresentationPage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNotesPage(value: XDrawPage): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("NotesPage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetNotesPage(value: () => XDrawPage): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNotesPage")(js.Any.fromFunction0(value))
        ret
    }
  }
