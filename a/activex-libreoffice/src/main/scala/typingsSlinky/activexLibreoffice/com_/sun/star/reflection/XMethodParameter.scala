...
object XMethodParameter {
  ...
  implicit class XMethodParameterOps[Self <: XMethodParameter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsIn(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isIn")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsOut(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isOut")(js.Any.fromFunction0(value))
        ret
    }
  }
