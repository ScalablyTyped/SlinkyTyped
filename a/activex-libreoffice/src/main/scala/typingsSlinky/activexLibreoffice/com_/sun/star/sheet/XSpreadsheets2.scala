...
object XSpreadsheets2 {
  ...
  implicit class XSpreadsheets2Ops[Self <: XSpreadsheets2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImportSheet(value: (XSpreadsheetDocument, String, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("importSheet")(js.Any.fromFunction3(value))
        ret
    }
  }
