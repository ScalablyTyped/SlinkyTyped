...
object XNumberingFormatter {
  ...
  implicit class XNumberingFormatterOps[Self <: XNumberingFormatter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMakeNumberingString(value: (SeqEquiv[PropertyValue], Locale) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("makeNumberingString")(js.Any.fromFunction2(value))
        ret
    }
  }
