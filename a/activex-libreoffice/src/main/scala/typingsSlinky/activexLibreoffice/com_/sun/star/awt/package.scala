...
package object awt {
  /**
    ...
    * @since OOo 1.1.2
    */
  type AccessibleListBoxList = typingsSlinky.activexLibreoffice.com_.sun.star.awt.AccessibleList
  /**
    * An implementation which uses the message queue to call the callback implementation asynchronously.
    * @see XRequestCallback
    */
  type AsyncCallback = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XRequestCallback
  /** specifies a provider for container windows implementing the {@link com.sun.star.awt.XWindow} interface. */
  type ContainerWindowProvider = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XContainerWindowProvider
  /** specifies a provider for dialogs implementing the {@link com.sun.star.awt.XDialog} interface. */
  type DialogProvider2 = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XDialogProvider2
  /**
    ...
    */
  type MenuBar = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XMenuBar
  /** @since LibreOffice 4.1 */
  type Pointer = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XPointer
  /**
    ...
    */
  type PopupMenu = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XPopupMenu
  /**
    ...
    */
  type PrinterException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    * mechanism to discover and manage printers
    * @since LibreOffice 4.1
    */
  type PrinterServer = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XPrinterServer
  /**
    ...
    */
  type SpinningProgressControlModel = typingsSlinky.activexLibreoffice.com_.sun.star.awt.AnimatedImagesControlModel
  /** specifies a standard tab controller. */
  type TabController = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XTabController
  /**
    ...
    */
  type Toolkit = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XToolkit2
  /** specifies a dialog control. */
  type UnoControlDialog = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XUnoControlDialog
  /**
    * specifies a file control.
    *
    * A file control extends the {@link UnoControlEdit} with a file dialog.
    */
  type UnoControlFileControl = typingsSlinky.activexLibreoffice.com_.sun.star.awt.UnoControlEdit
  /** specifies a fixed line control. */
  type UnoControlFixedLine = typingsSlinky.activexLibreoffice.com_.sun.star.awt.UnoControl
  /** specifies a group box control. */
  type UnoControlGroupBox = typingsSlinky.activexLibreoffice.com_.sun.star.awt.UnoControl
  /** identifies a control model. */
  type XControlModel = typingsSlinky.activexLibreoffice.com_.sun.star.uno.XInterface
  /**
    ...
    */
  type XDisplayBitmap = typingsSlinky.activexLibreoffice.com_.sun.star.uno.XInterface
  /** identifies a menu bar. */
  type XMenuBar = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XMenu
  /**
    ...
    */
  type XToggleButton = typingsSlinky.activexLibreoffice.com_.sun.star.awt.XItemEventBroadcaster
}
