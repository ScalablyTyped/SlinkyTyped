...
import typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XMasterPageTarget
...
import typingsSlinky.activexLibreoffice.com_.sun.star.form.XFormsSupplier
