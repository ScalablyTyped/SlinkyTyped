...
object CharType {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ANY_CHAR: `0` = 0.asInstanceOf[`0`]
    ...
    @scala.inline
    def END_PUNCTUATION: `21` = 21.asInstanceOf[`21`]
    
    @scala.inline
    def FINAL_PUNCTUATION: `29` = 29.asInstanceOf[`29`]
    ...
    @scala.inline
    def INITIAL_PUNCTUATION: `28` = 28.asInstanceOf[`28`]
    ...
    @scala.inline
    def START_PUNCTUATION: `20` = 20.asInstanceOf[`20`]
