...
object DocumentIndex {
  ...
  implicit class DocumentIndexOps[Self <: DocumentIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMainEntryCharacterStyleName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MainEntryCharacterStyleName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUseAlphabeticalSeparators(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseAlphabeticalSeparators")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUseCombinedEntries(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseCombinedEntries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUseDash(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseDash")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUseKeyAsEntry(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseKeyAsEntry")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUsePP(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UsePP")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUseUpperCase(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseUpperCase")(value.asInstanceOf[js.Any])
        ret
    }
  }
