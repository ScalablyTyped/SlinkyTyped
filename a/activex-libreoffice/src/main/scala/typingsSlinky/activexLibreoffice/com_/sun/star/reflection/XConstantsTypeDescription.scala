...
object XConstantsTypeDescription {
  ...
  implicit class XConstantsTypeDescriptionOps[Self <: XConstantsTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConstants(value: SafeArray[XConstantTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Constants")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetConstants(value: () => SafeArray[XConstantTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getConstants")(js.Any.fromFunction0(value))
        ret
    }
  }
