...
package object embed {
  ...
  type EmbeddedObjectCreator = typingsSlinky.activexLibreoffice.com_.sun.star.embed.XEmbeddedObjectCreator
  /** This is a service that allows to get access to a file system folder using storage hierarchy. */
  type FileSystemStorage = typingsSlinky.activexLibreoffice.com_.sun.star.embed.BaseStorage
  /**
    ...
    */
  type FileSystemStorageFactory = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleServiceFactory
  /** @since LibreOffice 4.1 */
  type HatchWindowFactory = typingsSlinky.activexLibreoffice.com_.sun.star.embed.XHatchWindowFactory
  /**
    * This exception can be thrown in case a storage is invalid.
    *
    * For example in case it is broken one.
    */
  type InvalidStorageException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  /**
    * This exception can be thrown in case a linked object is misused.
    *
    * Or if embedded object is misused as a linked object.
    */
  type LinkageMisuseException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** @since LibreOffice 4.1 */
  type MSOLEObjectSystemCreator = typingsSlinky.activexLibreoffice.com_.sun.star.embed.XEmbedObjectClipboardCreator
  /**
    ...
    */
  type NeedsRunningStateException = typingsSlinky.activexLibreoffice.com_.sun.star.embed.WrongStateException
  /** This exception can be thrown in case the object can not provide own visual area currently. */
  type NoVisualAreaSizeException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** @since LibreOffice 4.1 */
  type OLEEmbeddedObjectFactory = typingsSlinky.activexLibreoffice.com_.sun.star.embed.XEmbeddedObjectCreator
  /** @since LibreOffice 4.1 */
  type OOoEmbeddedObjectFactory = typingsSlinky.activexLibreoffice.com_.sun.star.embed.XEmbeddedObjectCreator
  /**
    * This exception can be thrown in case container wants to avoid objects saving.
    * @see XEmbeddedClient
    */
  type ObjectSaveVetoException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    */
  type StorageFactory = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleServiceFactory
  /** This exception can wrap an exception thrown during {@link XStorage} methods execution. */
  type StorageWrappedTargetException = typingsSlinky.activexLibreoffice.com_.sun.star.lang.WrappedTargetException
  /** This exception can be thrown in case the object's state does not allow to call requested functionality. */
  type WrongStateException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
