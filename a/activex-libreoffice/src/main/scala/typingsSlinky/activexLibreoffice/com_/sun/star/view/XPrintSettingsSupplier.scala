...
object XPrintSettingsSupplier {
  ...
  implicit class XPrintSettingsSupplierOps[Self <: XPrintSettingsSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrintSettings(value: XPropertySet): Self = this.set("PrintSettings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGetPrintSettings(value: () => XPropertySet): Self = this.set("getPrintSettings", js.Any.fromFunction0(value))
  }
}
