...
package object container {
  ...
  /**
    ...
    */
  type ElementExistException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type NoSuchElementException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
}
