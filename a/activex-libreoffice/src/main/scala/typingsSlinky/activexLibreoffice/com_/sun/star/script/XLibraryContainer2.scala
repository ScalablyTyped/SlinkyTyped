...
object XLibraryContainer2 {
  ...
  implicit class XLibraryContainer2Ops[Self <: XLibraryContainer2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetLibraryLinkURL(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLibraryLinkURL")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIsLibraryLink(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isLibraryLink")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withIsLibraryReadOnly(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isLibraryReadOnly")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRenameLibrary(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("renameLibrary")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withSetLibraryReadOnly(value: (String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setLibraryReadOnly")(js.Any.fromFunction2(value))
        ret
    }
  }
