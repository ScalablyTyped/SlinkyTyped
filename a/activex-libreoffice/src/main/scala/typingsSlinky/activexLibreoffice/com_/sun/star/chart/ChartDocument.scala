...
object ChartDocument {
  ...
  implicit class ChartDocumentOps[Self <: ChartDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHasMainTitle(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasMainTitle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHasSubTitle(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HasSubTitle")(value.asInstanceOf[js.Any])
        ret
    }
  }
