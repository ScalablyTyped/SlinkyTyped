...
package object reflection {
  /**
    ...
    * @since OOo 1.1.2
    */
  type InvalidTypeNameException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    * This exception denotes a checked exception (wrapping an originating exception) and may be thrown upon using invocation API.
    * @see XIdlMethod
    */
  type InvocationTargetException = typingsSlinky.activexLibreoffice.com_.sun.star.lang.WrappedTargetException
  /**
    * thrown in case that a certain type name does not exist.
    * @since OOo 1.1.2
    */
  type NoSuchTypeNameException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    */
  type ProxyFactory = typingsSlinky.activexLibreoffice.com_.sun.star.reflection.XProxyFactory
  /** @since LibreOffice 4.0 */
  type theCoreReflection = typingsSlinky.activexLibreoffice.com_.sun.star.reflection.XIdlReflection
}
