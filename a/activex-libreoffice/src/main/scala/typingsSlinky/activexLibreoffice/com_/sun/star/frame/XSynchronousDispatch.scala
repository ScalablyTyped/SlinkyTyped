...
object XSynchronousDispatch {
  ...
  implicit class XSynchronousDispatchOps[Self <: XSynchronousDispatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDispatchWithReturnValue(value: (URL, SeqEquiv[PropertyValue]) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dispatchWithReturnValue")(js.Any.fromFunction2(value))
        ret
    }
  }
