...
object XAccessibleHypertext {
  ...
  implicit class XAccessibleHypertextOps[Self <: XAccessibleHypertext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHyperLinkCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HyperLinkCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetHyperLink(value: Double => XAccessibleHyperlink): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getHyperLink")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetHyperLinkCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getHyperLinkCount")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetHyperLinkIndex(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getHyperLinkIndex")(js.Any.fromFunction1(value))
        ret
    }
  }
