...
object XExternalSheetCache {
  ...
  implicit class XExternalSheetCacheOps[Self <: XExternalSheetCache] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllRows(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AllRows")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetAllColumns(value: Double => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllColumns")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAllRows(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllRows")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetCellValue(value: (Double, Double, js.Any) => Unit): Self = {
        val ret = this.duplicate
