...
import typingsSlinky.activexLibreoffice.com_.sun.star.chart2.data.XDataReceiver
import typingsSlinky.activexLibreoffice.com_.sun.star.chart2.data.XDataSource
import typingsSlinky.activexLibreoffice.com_.sun.star.chart2.data.XRangeHighlighter
...
import typingsSlinky.activexLibreoffice.com_.sun.star.util.XNumberFormats
