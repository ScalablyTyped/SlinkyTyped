...
object XScriptURIHelper {
  ...
  implicit class XScriptURIHelperOps[Self <: XScriptURIHelper] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRootStorageURI(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RootStorageURI")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetRootStorageURI(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRootStorageURI")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetScriptURI(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getScriptURI")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetStorageURI(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStorageURI")(js.Any.fromFunction1(value))
        ret
    }
  }
