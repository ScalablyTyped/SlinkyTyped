...
object XInterfaceTypeDescription2 {
  ...
  implicit class XInterfaceTypeDescription2Ops[Self <: XInterfaceTypeDescription2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBaseTypes(value: SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BaseTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOptionalBaseTypes(value: SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OptionalBaseTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetBaseTypes(value: () => SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getBaseTypes")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetOptionalBaseTypes(value: () => SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOptionalBaseTypes")(js.Any.fromFunction0(value))
        ret
    }
  }
