...
object DOMExceptionType {
  ...
  @scala.inline
  def DOMSTRING_SIZE_ERR: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def HIERARCHY_REQUEST_ERR: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def INDEX_SIZE_ERR: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def INUSE_ATTRIBUTE_ERR: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def INVALID_ACCESS_ERR: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def INVALID_CHARACTER_ERR: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def INVALID_MODIFICATION_ERR: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def INVALID_STATE_ERR: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def NAMESPACE_ERR: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def NOT_FOUND_ERR: `11` = 11.asInstanceOf[`11`]
  
  @scala.inline
  def NOT_SUPPORTED_ERR: `12` = 12.asInstanceOf[`12`]
  
  @scala.inline
  def NO_DATA_ALLOWED_ERR: `9` = 9.asInstanceOf[`9`]
  
  @scala.inline
  def NO_MODIFICATION_ALLOWED_ERR: `10` = 10.asInstanceOf[`10`]
  
  @scala.inline
  def SYNTAX_ERR: `13` = 13.asInstanceOf[`13`]
  
  @scala.inline
  def WRONG_DOCUMENT_ERR: `14` = 14.asInstanceOf[`14`]
}
