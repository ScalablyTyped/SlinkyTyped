...
object XBlob {
  ...
  implicit class XBlobOps[Self <: XBlob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetBytes(value: (Double, Double) => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getBytes")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPosition(value: (SeqEquiv[Double], Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("position")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withPositionOfBlob(value: (XBlob, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("positionOfBlob")(js.Any.fromFunction2(value))
        ret
    }
  }
