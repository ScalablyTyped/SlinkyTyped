  ...
  implicit class XTransliterationOps[Self <: XTransliteration] (val x: Self) extends AnyVal {
    ...
    def withEquals(
      value: (String, Double, Double, js.Array[Double], String, Double, Double, js.Array[Double]) => Boolean
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("equals")(js.Any.fromFunction8(value))
        ret
    }
    @scala.inline
    def withFolding(value: (String, Double, Double, js.Array[SeqEquiv[Double]]) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("folding")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withGetAvailableModules(value: (Locale, Double) => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAvailableModules")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLoadModule(value: (TransliterationModules, Locale) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadModule")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withLoadModuleByImplName(value: (String, Locale) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadModuleByImplName")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withLoadModuleNew(value: (SeqEquiv[TransliterationModulesNew], Locale) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadModuleNew")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withLoadModulesByImplNames(value: (SeqEquiv[String], Locale) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadModulesByImplNames")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withTransliterate(value: (String, Double, Double, js.Array[SeqEquiv[Double]]) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transliterate")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withTransliterateRange(value: (String, String) => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transliterateRange")(js.Any.fromFunction2(value))
        ret
    }
  }
