...
object XMembersAccess {
  ...
  implicit class XMembersAccessOps[Self <: XMembersAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLocaleIndependentElementNames(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LocaleIndependentElementNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetLocaleIndependentElementNames(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLocaleIndependentElementNames")(js.Any.fromFunction0(value))
        ret
    }
  }
