...
object RedlinePortion {
  ...
  implicit class RedlinePortionOps[Self <: RedlinePortion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsInHeaderFooter(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsInHeaderFooter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMergeLastPara(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MergeLastPara")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineAuthor(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineAuthor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineComment(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineComment")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineDateTime(value: DateTime): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineDateTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineIdentifier(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineIdentifier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineSuccessorData(value: PropertyValues): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineSuccessorData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineText(value: XText): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineText")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRedlineType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RedlineType")(value.asInstanceOf[js.Any])
        ret
    }
  }
