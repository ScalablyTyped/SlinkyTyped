...
object DatabaseSetNumber {
  ...
  @scala.inline
  implicit class DatabaseSetNumberOps[Self <: DatabaseSetNumber] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withDataCommandType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataCommandType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetNumber(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SetNumber")(value.asInstanceOf[js.Any])
        ret
    }
  }
