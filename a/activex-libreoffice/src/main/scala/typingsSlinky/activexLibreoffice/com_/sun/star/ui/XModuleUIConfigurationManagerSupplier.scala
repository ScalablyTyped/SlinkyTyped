...
object XModuleUIConfigurationManagerSupplier {
  ...
  implicit class XModuleUIConfigurationManagerSupplierOps[Self <: XModuleUIConfigurationManagerSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetUIConfigurationManager(value: String => XUIConfigurationManager): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUIConfigurationManager")(js.Any.fromFunction1(value))
        ret
    }
  }
