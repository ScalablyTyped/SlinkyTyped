...
object XCsvLogFormatter {
  ...
  implicit class XCsvLogFormatterOps[Self <: XCsvLogFormatter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumnnames(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Columnnames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLogEventNo(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LogEventNo")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLogSource(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LogSource")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLogThread(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LogThread")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLogTimestamp(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LogTimestamp")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withFormatMultiColumn(value: SeqEquiv[String] => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("formatMultiColumn")(js.Any.fromFunction1(value))
        ret
    }
  }
