...
object XVolatileResult {
  ...
  implicit class XVolatileResultOps[Self <: XVolatileResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddResultListener(value: XResultListener => Unit): Self = this.set("addResultListener", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRemoveResultListener(value: XResultListener => Unit): Self = this.set("removeResultListener", js.Any.fromFunction1(value))
  }
}
