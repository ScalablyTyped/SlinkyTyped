...
package object ucb {
  ...
  /**
    ...
    * @version 1.0
    */
  type AlreadyInitializedException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /** is a factory for {@link CachedContentResultSet} implementations. */
  type CachedContentResultSetFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XCachedContentResultSetFactory
  
  /** is a factory for {@link CachedContentResultSetStub} implementations. */
  type CachedContentResultSetStubFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XCachedContentResultSetStubFactory
  
  /** is a factory for {@link CachedDynamicResultSet} implementations. */
  type CachedDynamicResultSetFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XCachedDynamicResultSetFactory
  
  /** is a factory for {@link CachedDynamicResultSetStub} implementations. */
  type CachedDynamicResultSetStubFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XCachedDynamicResultSetStubFactory
  ...
  /**
    ...
    */
  type CmisContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @version 1.0
    */
  type CommandAbortedException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /** is a factory for {@link ContentProviderProxy} implementations. */
  type ContentProviderProxyFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProviderFactory
  
  /**
    * A {@link ContentTransmitter} is a service that provides
    * @deprecated Deprecated
    */
  type ContentTransmitter = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentTransmitter
  ...
  /**
    ...
    */
  type DefaultHierarchyDataSource = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.HierarchyDataSource
  ...
  /**
    ...
    * @version 1.0
    */
  type DuplicateCommandIdentifierException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @version 1.0
    */
  type DuplicateProviderException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type DynamicResultSet = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XDynamicResultSet
  ...
  /**
    ...
    * @see Content
    */
  type ExpandContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.ContentProvider
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type FTPContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  
  type GIOContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  
  type GnomeVFSContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type HelpContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type HierarchyContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @version 1.0
    */
  type IllegalIdentifierException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * An interaction request to inform the client of a "transfer" command that the supplied source URL is not supported.
    * @see XCommandProcessor
    */
  type InteractiveBadTransferURLException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * An error indicating that a lock that has been previously obtained by this OOo session has expired.
    * @since OOo 3.3
    */
  type InteractiveLockingLockExpiredException = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.InteractiveLockingException
  ...
  /**
    ...
    * @since OOo 3.3
    */
  type InteractiveLockingNotLockedException = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.InteractiveLockingException
  ...
  /**
    ...
    */
  type InteractiveNetworkException = typingsSlinky.activexLibreoffice.com_.sun.star.task.ClassifiedInteractionRequest
  
  /** A network error specifying a general failure. */
  type InteractiveNetworkGeneralException = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.InteractiveNetworkException
  
  /** A network error specifying an off line condition. */
  type InteractiveNetworkOffLineException = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.InteractiveNetworkException
  
  /** This exception is thrown to indicate that a Listener is already set while only one is allowed. */
  type ListenerAlreadySetException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * specifies the access type of a lock.
    * @see LockEntry
    */
  type LockType = typingsSlinky.activexLibreoffice.activexLibreofficeNumbers.`0`
  ...
  /**
    ...
    * @version 1.0
    */
  type MissingInputStreamException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type ODMAContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type PackageContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type PropertiesManager = typingsSlinky.activexLibreoffice.com_.sun.star.beans.XPropertySetInfo
  ...
  /**
    ...
    * @version 1.0
    */
  type ResultSetException = typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.SQLException
  
  /** This exception is thrown to indicate that a needed service was not registered. */
  type ServiceNotFoundException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type SimpleFileAccess = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XSimpleFileAccess3
  
  /** is a factory for {@link DynamicResultSet} implementations, which will be sorted according to the given sorting options. */
  type SortedDynamicResultSetFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XSortedDynamicResultSetFactory
  
  /** creates instances of the service {@link PropertySetRegistry} . */
  type Store = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XPropertySetRegistryFactory
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type TransientDocumentsContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @version 1.0
    */
  type UnsupportedCommandException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type WebDAVContentProvider = typingsSlinky.activexLibreoffice.com_.sun.star.ucb.XContentProvider
  ...
  /**
    ...
    * @version 1.0
    */
  type XInteractionReplaceExistingData = typingsSlinky.activexLibreoffice.com_.sun.star.task.XInteractionContinuation
}
