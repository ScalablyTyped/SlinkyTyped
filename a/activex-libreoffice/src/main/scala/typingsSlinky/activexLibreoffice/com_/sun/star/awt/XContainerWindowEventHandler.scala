...
object XContainerWindowEventHandler {
  ...
  implicit class XContainerWindowEventHandlerOps[Self <: XContainerWindowEventHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSupportedMethodNames(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SupportedMethodNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCallHandlerMethod(value: (XWindow, js.Any, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("callHandlerMethod")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetSupportedMethodNames(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSupportedMethodNames")(js.Any.fromFunction0(value))
        ret
    }
  }
