...
trait XMutableGridDataModel extends XGridDataModel {
  ...
  /**
    ...
    */
  def addRow(Heading: js.Any, Data: SeqEquiv[_]): Unit
  /**
    ...
    */
  def addRows(Headings: SeqEquiv[_], Data: SeqEquiv[SeqEquiv[_]]): Unit
  /**
    ...
    */
  def insertRow(Index: Double, Heading: js.Any, Data: SeqEquiv[_]): Unit
  /**
    ...
    * @throws com::sun::star::lang::IndexOutOfBoundsException if `Index` is smaller than `0` or greater than the number of rows in the model.
    */
  def insertRows(Index: Double, Headings: SeqEquiv[_], Data: SeqEquiv[SeqEquiv[_]]): Unit
  ...
  /**
    ...
    */
  def updateRowData(ColumnIndexes: SeqEquiv[Double], RowIndex: Double, Values: SeqEquiv[_]): Unit
  /**
