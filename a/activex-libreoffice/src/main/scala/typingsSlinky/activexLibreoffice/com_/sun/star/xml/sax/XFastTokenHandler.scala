...
object XFastTokenHandler {
  ...
  implicit class XFastTokenHandlerOps[Self <: XFastTokenHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetTokenFromUTF8(value: SeqEquiv[Double] => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTokenFromUTF8")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetUTF8Identifier(value: Double => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUTF8Identifier")(js.Any.fromFunction1(value))
        ret
    }
  }
