...
object XSheetOperation {
  ...
  implicit class XSheetOperationOps[Self <: XSheetOperation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClearContents(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearContents")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withComputeFunction(value: GeneralFunction => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("computeFunction")(js.Any.fromFunction1(value))
        ret
    }
  }
