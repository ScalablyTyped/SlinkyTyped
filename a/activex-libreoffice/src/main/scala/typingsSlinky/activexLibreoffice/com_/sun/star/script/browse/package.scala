...
package object browse {
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type BrowseNodeFactory = typingsSlinky.activexLibreoffice.com_.sun.star.script.browse.XBrowseNodeFactory
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type theBrowseNodeFactory = typingsSlinky.activexLibreoffice.com_.sun.star.script.browse.XBrowseNodeFactory
}
