...
object XUIElementSettings {
  ...
  implicit class XUIElementSettingsOps[Self <: XUIElementSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetSettings(value: Boolean => XIndexAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSettings")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetSettings(value: XIndexAccess => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSettings")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdateSettings(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateSettings")(js.Any.fromFunction0(value))
        ret
    }
  }
