...
object XInteractionRequestStringResolver {
  ...
  implicit class XInteractionRequestStringResolverOps[Self <: XInteractionRequestStringResolver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetStringFromInformationalRequest(value: XInteractionRequest => Optional[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStringFromInformationalRequest")(js.Any.fromFunction1(value))
        ret
    }
  }
