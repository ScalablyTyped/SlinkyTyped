...
object XAccessibleTextMarkup {
  ...
  implicit class XAccessibleTextMarkupOps[Self <: XAccessibleTextMarkup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetTextMarkup(value: (Double, Double) => TextSegment): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTextMarkup")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetTextMarkupAtIndex(value: (Double, Double) => SafeArray[TextSegment]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTextMarkupAtIndex")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetTextMarkupCount(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTextMarkupCount")(js.Any.fromFunction1(value))
        ret
    }
  }
