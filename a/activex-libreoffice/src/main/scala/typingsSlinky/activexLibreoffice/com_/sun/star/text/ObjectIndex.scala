...
object ObjectIndex {
  ...
  implicit class ObjectIndexOps[Self <: ObjectIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateFromOtherEmbeddedObjects(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromOtherEmbeddedObjects")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFromStarCalc(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromStarCalc")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFromStarChart(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromStarChart")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFromStarDraw(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromStarDraw")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFromStarImage(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromStarImage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateFromStarMath(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromStarMath")(value.asInstanceOf[js.Any])
        ret
    }
  }
