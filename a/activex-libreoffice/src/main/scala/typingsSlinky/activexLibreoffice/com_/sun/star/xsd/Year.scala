...
object Year {
  ...
  @scala.inline
  implicit class YearOps[Self <: Year] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withMaxExclusiveInt(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaxExclusiveInt")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaxInclusiveInt(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaxInclusiveInt")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinExclusiveInt(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinExclusiveInt")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinInclusiveInt(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinInclusiveInt")(value.asInstanceOf[js.Any])
        ret
    }
  }
