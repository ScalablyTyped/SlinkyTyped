...
package object uri {
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type ExternalUriReferenceTranslator = typingsSlinky.activexLibreoffice.com_.sun.star.uri.XExternalUriReferenceTranslator
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type UriReferenceFactory = typingsSlinky.activexLibreoffice.com_.sun.star.uri.XUriReferenceFactory
  ...
  /**
    ...
    * @since OOo 2.3
    */
  type UriSchemeParserVndDOTsunDOTstarDOTexpand = typingsSlinky.activexLibreoffice.com_.sun.star.uri.XUriSchemeParser
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type UriSchemeParserVndDOTsunDOTstarDOTscript = typingsSlinky.activexLibreoffice.com_.sun.star.uri.XUriSchemeParser
  
  /**
    * creates " vnd.sun.star.pkg " URL references.
    * @since OOo 2.0
    */
  type VndSunStarPkgUrlReferenceFactory = typingsSlinky.activexLibreoffice.com_.sun.star.uri.XVndSunStarPkgUrlReferenceFactory
}
