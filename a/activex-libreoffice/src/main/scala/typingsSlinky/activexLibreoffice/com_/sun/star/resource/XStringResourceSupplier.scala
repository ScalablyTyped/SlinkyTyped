...
object XStringResourceSupplier {
  ...
  implicit class XStringResourceSupplierOps[Self <: XStringResourceSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStringResource(value: XStringResourceResolver): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StringResource")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetStringResource(value: () => XStringResourceResolver): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStringResource")(js.Any.fromFunction0(value))
        ret
    }
  }
