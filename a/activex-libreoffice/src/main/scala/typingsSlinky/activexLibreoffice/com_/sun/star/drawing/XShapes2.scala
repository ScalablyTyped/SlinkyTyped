...
object XShapes2 {
  ...
  implicit class XShapes2Ops[Self <: XShapes2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddBottom(value: XShape => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addBottom")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAddTop(value: XShape => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addTop")(js.Any.fromFunction1(value))
        ret
    }
  }
