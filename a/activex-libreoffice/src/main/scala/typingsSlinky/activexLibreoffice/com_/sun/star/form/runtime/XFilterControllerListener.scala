...
object XFilterControllerListener {
  ...
  implicit class XFilterControllerListenerOps[Self <: XFilterControllerListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDisjunctiveTermAdded(value: FilterEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disjunctiveTermAdded")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDisjunctiveTermRemoved(value: FilterEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disjunctiveTermRemoved")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withPredicateExpressionChanged(value: FilterEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("predicateExpressionChanged")(js.Any.fromFunction1(value))
        ret
    }
  }
