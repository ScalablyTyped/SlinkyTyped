...
object XInterfaceMethodTypeDescription {
  ...
  implicit class XInterfaceMethodTypeDescriptionOps[Self <: XInterfaceMethodTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExceptions(value: SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Exceptions")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withParameters(value: SafeArray[XMethodParameter]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Parameters")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withReturnType(value: XTypeDescription): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ReturnType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetExceptions(value: () => SafeArray[XTypeDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getExceptions")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetParameters(value: () => SafeArray[XMethodParameter]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getParameters")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetReturnType(value: () => XTypeDescription): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getReturnType")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsOneway(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isOneway")(js.Any.fromFunction0(value))
        ret
    }
  }
