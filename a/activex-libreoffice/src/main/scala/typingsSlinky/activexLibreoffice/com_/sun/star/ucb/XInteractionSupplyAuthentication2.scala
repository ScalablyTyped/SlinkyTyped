...
object XInteractionSupplyAuthentication2 {
  ...
  implicit class XInteractionSupplyAuthentication2Ops[Self <: XInteractionSupplyAuthentication2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanUseSystemCredentials(value: js.Array[Boolean] => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("canUseSystemCredentials")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetUseSystemCredentials(value: Boolean => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setUseSystemCredentials")(js.Any.fromFunction1(value))
        ret
    }
  }
