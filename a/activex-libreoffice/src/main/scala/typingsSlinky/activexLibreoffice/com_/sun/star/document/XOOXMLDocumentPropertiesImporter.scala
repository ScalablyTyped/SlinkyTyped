...
object XOOXMLDocumentPropertiesImporter {
  ...
  implicit class XOOXMLDocumentPropertiesImporterOps[Self <: XOOXMLDocumentPropertiesImporter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImportProperties(value: (XStorage, XDocumentProperties) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("importProperties")(js.Any.fromFunction2(value))
        ret
    }
  }
