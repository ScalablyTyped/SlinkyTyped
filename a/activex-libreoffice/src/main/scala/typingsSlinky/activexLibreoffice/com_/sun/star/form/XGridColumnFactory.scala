...
object XGridColumnFactory {
  ...
  implicit class XGridColumnFactoryOps[Self <: XGridColumnFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumnTypes(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ColumnTypes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateColumn(value: String => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createColumn")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetColumnTypes(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getColumnTypes")(js.Any.fromFunction0(value))
        ret
    }
  }
