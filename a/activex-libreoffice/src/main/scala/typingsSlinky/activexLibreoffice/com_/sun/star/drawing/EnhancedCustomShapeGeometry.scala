...
object EnhancedCustomShapeGeometry {
  ...
  implicit class EnhancedCustomShapeGeometryOps[Self <: EnhancedCustomShapeGeometry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAdjustmentValues(value: SafeArray[EnhancedCustomShapeAdjustmentValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AdjustmentValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withEquations(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Equations")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExtrusion(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Extrusion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHandles(value: SafeArray[PropertyValues]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPath(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Path")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextPath(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextRotateAngle(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextRotateAngle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withViewBox(value: Rectangle): Self = {
        val ret = this.duplicate
