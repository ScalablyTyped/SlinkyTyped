...
object XPresenterHelper {
  ...
  implicit class XPresenterHelperOps[Self <: XPresenterHelper] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCaptureMouse(value: XWindow => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("captureMouse")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateCanvas(value: (XWindow, Double, String) => XCanvas): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createCanvas")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCreateSharedCanvas(value: (XSpriteCanvas, XWindow, XCanvas, XWindow, XWindow) => XCanvas): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSharedCanvas")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withCreateWindow(value: (XWindow, Boolean, Boolean, Boolean, Boolean) => XWindow): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWindow")(js.Any.fromFunction5(value))
        ret
    }
    @scala.inline
    def withGetWindowExtentsRelative(value: (XWindow, XWindow) => Rectangle): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getWindowExtentsRelative")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withLoadBitmap(value: (String, XCanvas) => XBitmap): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("loadBitmap")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withReleaseMouse(value: XWindow => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("releaseMouse")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withToTop(value: XWindow => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("toTop")(js.Any.fromFunction1(value))
        ret
    }
  }
