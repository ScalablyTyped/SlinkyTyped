...
- typingsSlinky.activexLibreoffice.com_.sun.star.configuration.GroupElement because var conflicts: Name, Parent. Inlined 
- typingsSlinky.activexLibreoffice.com_.sun.star.configuration.SetElement because var conflicts: Name, Parent. Inlined  */ @js.native
