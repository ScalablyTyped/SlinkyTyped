...
object XChartTypeTemplate {
  ...
  implicit class XChartTypeTemplateOps[Self <: XChartTypeTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataInterpreter(value: XDataInterpreter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataInterpreter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withApplyStyle(value: (XDataSeries, Double, Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("applyStyle")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withChangeDiagram(value: XDiagram => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeDiagram")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withChangeDiagramData(value: (XDiagram, XDataSource, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("changeDiagramData")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withCreateDiagramByDataSource(value: (XDataSource, SeqEquiv[PropertyValue]) => XDiagram): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createDiagramByDataSource")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetChartTypeForNewSeries(value: SeqEquiv[XChartType] => XChartType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getChartTypeForNewSeries")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetDataInterpreter(value: () => XDataInterpreter): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataInterpreter")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withMatchesTemplate(value: (XDiagram, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("matchesTemplate")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withResetStyles(value: XDiagram => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resetStyles")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSupportsCategories(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("supportsCategories")(js.Any.fromFunction0(value))
        ret
    }
  }
