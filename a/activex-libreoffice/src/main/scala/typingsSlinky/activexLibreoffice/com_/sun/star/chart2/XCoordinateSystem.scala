...
object XCoordinateSystem {
  ...
  implicit class XCoordinateSystemOps[Self <: XCoordinateSystem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCoordinateSystemType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CoordinateSystemType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withViewServiceName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ViewServiceName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetAxisByDimension(value: (Double, Double) => XAxis): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAxisByDimension")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetCoordinateSystemType(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCoordinateSystemType")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetMaximumAxisIndexByDimension(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMaximumAxisIndexByDimension")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetViewServiceName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getViewServiceName")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetAxisByDimension(value: (Double, XAxis, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setAxisByDimension")(js.Any.fromFunction3(value))
        ret
    }
  }
