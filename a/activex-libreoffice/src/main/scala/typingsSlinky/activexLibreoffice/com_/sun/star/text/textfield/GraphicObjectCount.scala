...
/**
  * specifies service of a text field that displays the number of graphic objects contained in the document.
  * @see com.sun.star.text.TextField
  */
@js.native
trait GraphicObjectCount extends TextField_ {
...
object GraphicObjectCount {
  ...
  @scala.inline
  implicit class GraphicObjectCountOps[Self <: GraphicObjectCount] (val x: Self) extends AnyVal {
    @scala.inline
