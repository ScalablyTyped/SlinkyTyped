...
object XRubySelection {
  ...
  implicit class XRubySelectionOps[Self <: XRubySelection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetRubyList(value: Boolean => SafeArray[PropertyValues]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRubyList")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetRubyList(value: (SeqEquiv[PropertyValues], Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setRubyList")(js.Any.fromFunction2(value))
        ret
    }
  }
