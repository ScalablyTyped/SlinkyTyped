...
object XKeyAlteration {
  ...
  implicit class XKeyAlterationOps[Self <: XKeyAlteration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddKey(value: (XPropertySet, XPropertySet) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addKey")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDropKey(value: (XPropertySet, XPropertySet) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dropKey")(js.Any.fromFunction2(value))
        ret
    }
  }
