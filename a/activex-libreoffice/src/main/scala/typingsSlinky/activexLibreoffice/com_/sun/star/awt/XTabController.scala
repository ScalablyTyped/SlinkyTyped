...
object XTabController {
  ...
  implicit class XTabControllerOps[Self <: XTabController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainer(value: XControlContainer): Self = this.set("Container", value.asInstanceOf[js.Any])
    @scala.inline
    def setControls(value: SafeArray[XControl]): Self = this.set("Controls", value.asInstanceOf[js.Any])
    @scala.inline
    def setActivateFirst(value: () => Unit): Self = this.set("activateFirst", js.Any.fromFunction0(value))
    @scala.inline
    def setActivateLast(value: () => Unit): Self = this.set("activateLast", js.Any.fromFunction0(value))
    @scala.inline
    def setActivateTabOrder(value: () => Unit): Self = this.set("activateTabOrder", js.Any.fromFunction0(value))
    @scala.inline
    def setAutoTabOrder(value: () => Unit): Self = this.set("autoTabOrder", js.Any.fromFunction0(value))
    @scala.inline
    def setGetContainer(value: () => XControlContainer): Self = this.set("getContainer", js.Any.fromFunction0(value))
    @scala.inline
    def setGetControls(value: () => SafeArray[XControl]): Self = this.set("getControls", js.Any.fromFunction0(value))
    @scala.inline
    def setGetModel(value: () => XTabControllerModel): Self = this.set("getModel", js.Any.fromFunction0(value))
    @scala.inline
    def setSetContainer(value: XControlContainer => Unit): Self = this.set("setContainer", js.Any.fromFunction1(value))
    @scala.inline
    def setSetModel(value: XTabControllerModel => Unit): Self = this.set("setModel", js.Any.fromFunction1(value))
  }
