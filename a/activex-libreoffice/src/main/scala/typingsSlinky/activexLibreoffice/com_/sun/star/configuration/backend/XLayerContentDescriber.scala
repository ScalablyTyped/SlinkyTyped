...
object XLayerContentDescriber {
  ...
  implicit class XLayerContentDescriberOps[Self <: XLayerContentDescriber] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDescribeLayer(value: (XLayerHandler, SeqEquiv[PropertyInfo]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("describeLayer")(js.Any.fromFunction2(value))
        ret
    }
  }
