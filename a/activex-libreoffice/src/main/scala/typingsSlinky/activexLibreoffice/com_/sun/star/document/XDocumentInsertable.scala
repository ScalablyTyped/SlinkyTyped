...
object XDocumentInsertable {
  ...
  implicit class XDocumentInsertableOps[Self <: XDocumentInsertable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInsertDocumentFromURL(value: (String, SeqEquiv[PropertyValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertDocumentFromURL")(js.Any.fromFunction2(value))
        ret
    }
  }
