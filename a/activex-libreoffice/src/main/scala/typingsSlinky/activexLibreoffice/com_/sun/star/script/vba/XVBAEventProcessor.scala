...
object XVBAEventProcessor {
  ...
  implicit class XVBAEventProcessorOps[Self <: XVBAEventProcessor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withHasVbaEventHandler(value: (Double, SeqEquiv[_]) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasVbaEventHandler")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withProcessVbaEvent(value: (Double, SeqEquiv[_]) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("processVbaEvent")(js.Any.fromFunction2(value))
        ret
    }
  }
