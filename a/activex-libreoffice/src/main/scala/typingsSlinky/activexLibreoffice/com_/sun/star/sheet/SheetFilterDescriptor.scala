...
object SheetFilterDescriptor {
  ...
  implicit class SheetFilterDescriptorOps[Self <: SheetFilterDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCopyOutputData(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CopyOutputData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOutputPosition(value: CellAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OutputPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSaveOutputPosition(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SaveOutputPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withUseRegularExpressions(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UseRegularExpressions")(value.asInstanceOf[js.Any])
        ret
    }
  }
