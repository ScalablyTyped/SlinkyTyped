...
object TableAutoFormat {
  ...
  implicit class TableAutoFormatOps[Self <: TableAutoFormat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIncludeBackground(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IncludeBackground")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIncludeJustify(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IncludeJustify")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeNumberFormat(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IncludeNumberFormat")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIncludeWidthAndHeight(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IncludeWidthAndHeight")(value.asInstanceOf[js.Any])
        ret
    }
  }
