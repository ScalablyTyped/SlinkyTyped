...
object ChartDataRowProperties {
  ...
  implicit class ChartDataRowPropertiesOps[Self <: ChartDataRowProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataErrorProperties(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataErrorProperties")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataMeanValueProperties(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataMeanValueProperties")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataRegressionProperties(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataRegressionProperties")(value.asInstanceOf[js.Any])
        ret
    }
  }
