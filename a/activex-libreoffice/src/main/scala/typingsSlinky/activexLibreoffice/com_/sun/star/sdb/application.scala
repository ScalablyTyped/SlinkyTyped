...
import typingsSlinky.activexLibreoffice.com_.sun.star.frame.XTitle
import typingsSlinky.activexLibreoffice.com_.sun.star.frame.XTitleChangeBroadcaster
import typingsSlinky.activexLibreoffice.com_.sun.star.frame.XTitleChangeListener
