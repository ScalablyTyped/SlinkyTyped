...
object ChainedTextFrame {
  ...
  implicit class ChainedTextFrameOps[Self <: ChainedTextFrame] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withChainNextName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ChainNextName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withChainPrevName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ChainPrevName")(value.asInstanceOf[js.Any])
        ret
    }
  }
