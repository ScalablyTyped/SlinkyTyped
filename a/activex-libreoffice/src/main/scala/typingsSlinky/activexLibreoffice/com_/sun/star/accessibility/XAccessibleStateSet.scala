...
object XAccessibleStateSet {
  ...
  implicit class XAccessibleStateSetOps[Self <: XAccessibleStateSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStates(value: SafeArray[Double]): Self = {
    ...
    @scala.inline
    def withContainsAll(value: SeqEquiv[Double] => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("containsAll")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetStates(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getStates")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
