...
object XLinePolyPolygon2D {
  ...
  implicit class XLinePolyPolygon2DOps[Self <: XLinePolyPolygon2D] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetPoint(value: (Double, Double) => RealPoint2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPoint")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetPoints(value: (Double, Double, Double, Double) => SafeArray[SafeArray[RealPoint2D]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPoints")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withSetPoint(value: (RealPoint2D, Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPoint")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withSetPoints(value: (SeqEquiv[SeqEquiv[RealPoint2D]], Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPoints")(js.Any.fromFunction2(value))
        ret
    }
  }
