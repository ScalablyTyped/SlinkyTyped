package typingsSlinky.activexLibreoffice.com_.sun.star.sheet.ConditionOperator2
...
object Constants {
  ...
  @scala.inline
  def DUPLICATE: `10` = 10.asInstanceOf[`10`]
  ...
  @scala.inline
  def NOT_DUPLICATE: `11` = 11.asInstanceOf[`11`]
