...
object XPropertySetRegistryFactory {
  ...
  implicit class XPropertySetRegistryFactoryOps[Self <: XPropertySetRegistryFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreatePropertySetRegistry(value: String => XPropertySetRegistry): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createPropertySetRegistry")(js.Any.fromFunction1(value))
        ret
    }
  }
