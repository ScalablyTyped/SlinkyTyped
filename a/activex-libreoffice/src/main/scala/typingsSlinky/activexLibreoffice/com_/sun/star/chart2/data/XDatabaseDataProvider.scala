...
import typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XParameters
...
import typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.XRowSetListener
...
object XDatabaseDataProvider {
  ...
  implicit class XDatabaseDataProviderOps[Self <: XDatabaseDataProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDetailFields(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DetailFields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMasterFields(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MasterFields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
