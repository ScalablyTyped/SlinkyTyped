...
object XPropertyAccess {
  ...
  implicit class XPropertyAccessOps[Self <: XPropertyAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPropertyValues(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PropertyValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetPropertyValues(value: () => SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPropertyValues")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetPropertyValues(value: SeqEquiv[PropertyValue] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPropertyValues")(js.Any.fromFunction1(value))
        ret
    }
  }
