...
object XTask {
  ...
  implicit class XTaskOps[Self <: XTask] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withArrangeWindowsHorizontal(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrangeWindowsHorizontal")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withArrangeWindowsVertical(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("arrangeWindowsVertical")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTileWindows(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("tileWindows")(js.Any.fromFunction0(value))
        ret
    }
  }
