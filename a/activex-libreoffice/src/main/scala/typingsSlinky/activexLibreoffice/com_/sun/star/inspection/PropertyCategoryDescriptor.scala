...
object PropertyCategoryDescriptor {
  ...
  implicit class PropertyCategoryDescriptorOps[Self <: PropertyCategoryDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProgrammaticName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ProgrammaticName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUIName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UIName")(value.asInstanceOf[js.Any])
        ret
    }
  }
