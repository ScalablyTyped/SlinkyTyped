...
object XEmbeddedObjectResolver {
  ...
  implicit class XEmbeddedObjectResolverOps[Self <: XEmbeddedObjectResolver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResolveEmbeddedObjectURL(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resolveEmbeddedObjectURL")(js.Any.fromFunction1(value))
        ret
    }
  }
