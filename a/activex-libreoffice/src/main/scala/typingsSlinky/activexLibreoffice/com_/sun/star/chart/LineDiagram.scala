...
object LineDiagram {
  ...
  implicit class LineDiagramOps[Self <: LineDiagram] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSplineOrder(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SplineOrder")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSplineResolution(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SplineResolution")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSplineType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SplineType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSymbolBitmapURL(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SymbolBitmapURL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSymbolSize(value: Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SymbolSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSymbolType(value: Double): Self = {
        val ret = this.duplicate
