...
object XStarBasicAccess {
  ...
  implicit class XStarBasicAccessOps[Self <: XStarBasicAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLibraryContainer(value: XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LibraryContainer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAddDialog(value: (String, String, SeqEquiv[Double]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addDialog")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withAddModule(value: (String, String, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addModule")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withCreateLibrary(value: (String, String, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createLibrary")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withGetLibraryContainer(value: () => XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLibraryContainer")(js.Any.fromFunction0(value))
        ret
    }
  }
