...
package object graphic {
  ...
  /**
    ...
    */
  type GraphicProvider = typingsSlinky.activexLibreoffice.com_.sun.star.graphic.XGraphicProvider
  ...
  /**
    ...
    */
  type GraphicRasterizer = typingsSlinky.activexLibreoffice.com_.sun.star.graphic.XGraphicRasterizer
  
  /** Service that describes the necessary interfaces and properties for tooling involved with {@link XPrimitive2D} interfaces */
  type Primitive2DTools = typingsSlinky.activexLibreoffice.com_.sun.star.graphic.XPrimitive2DRenderer
  
  /** @since LibreOffice 4.1 */
  type PrimitiveFactory2D = typingsSlinky.activexLibreoffice.com_.sun.star.graphic.XPrimitiveFactory2D
  ...
  /**
    ...
    * usage
    */
  type SvgTools = typingsSlinky.activexLibreoffice.com_.sun.star.graphic.XSvgParser
}
