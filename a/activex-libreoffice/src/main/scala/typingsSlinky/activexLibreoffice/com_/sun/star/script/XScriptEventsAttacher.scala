...
object XScriptEventsAttacher {
  ...
  implicit class XScriptEventsAttacherOps[Self <: XScriptEventsAttacher] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttachEvents(value: (SeqEquiv[XInterface], XScriptListener, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attachEvents")(js.Any.fromFunction3(value))
        ret
    }
  }
