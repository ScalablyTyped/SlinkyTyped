...
object XDataPilotTable2 {
  ...
  implicit class XDataPilotTable2Ops[Self <: XDataPilotTable2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDrillDownData(value: CellAddress => SafeArray[SafeArray[_]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDrillDownData")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetOutputRangeByType(value: Double => CellRangeAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOutputRangeByType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetPositionData(value: CellAddress => DataPilotTablePositionData): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPositionData")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsertDrillDownSheet(value: CellAddress => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertDrillDownSheet")(js.Any.fromFunction1(value))
        ret
    }
  }
