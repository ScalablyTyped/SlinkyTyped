...
object TextFieldMaster {
  ...
  implicit class TextFieldMasterOps[Self <: TextFieldMaster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDependentTextFields(value: SafeArray[XDependentTextField]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DependentTextFields")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
