...
object XCertificateContainer {
  ...
  implicit class XCertificateContainerOps[Self <: XCertificateContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddCertificate(value: (String, String, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addCertificate")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withHasCertificate(value: (String, String) => CertificateContainerStatus): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasCertificate")(js.Any.fromFunction2(value))
        ret
    }
  }
