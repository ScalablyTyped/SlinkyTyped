...
trait XCanvasFont extends XInterface {
  ...
  val FontRequest: typingsSlinky.activexLibreoffice.com_.sun.star.rendering.FontRequest
  /**
  ...
  /** Query the {@link FontRequest} that was used to generate this object. */
  def getFontRequest(): typingsSlinky.activexLibreoffice.com_.sun.star.rendering.FontRequest
}
