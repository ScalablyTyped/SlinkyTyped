...
object XConfigurationControllerBroadcaster {
  ...
  implicit class XConfigurationControllerBroadcasterOps[Self <: XConfigurationControllerBroadcaster] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddConfigurationChangeListener(value: (XConfigurationChangeListener, String, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addConfigurationChangeListener")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withNotifyEvent(value: ConfigurationChangeEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("notifyEvent")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveConfigurationChangeListener(value: XConfigurationChangeListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeConfigurationChangeListener")(js.Any.fromFunction1(value))
        ret
    }
  }
