...
object XModel2 {
  ...
  implicit class XModel2Ops[Self <: XModel2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAvailableViewControllerNames(value: SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AvailableViewControllerNames")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withControllers(value: XEnumeration): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Controllers")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCreateDefaultViewController(value: XFrame => XController2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createDefaultViewController")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateViewController(value: (String, SeqEquiv[PropertyValue], XFrame) => XController2): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createViewController")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetAvailableViewControllerNames(value: () => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAvailableViewControllerNames")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetControllers(value: () => XEnumeration): Self = {
        val ret = this.duplicate
