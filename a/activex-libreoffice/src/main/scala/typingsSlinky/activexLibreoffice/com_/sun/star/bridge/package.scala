...
package object bridge {
  ...
  type BridgeExistsException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    */
  type BridgeFactory = typingsSlinky.activexLibreoffice.com_.sun.star.bridge.XBridgeFactory2
  ...
  /**
    ...
    */
  type OleApplicationRegistration = typingsSlinky.activexLibreoffice.com_.sun.star.uno.XInterface
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type OleBridgeSupplier = typingsSlinky.activexLibreoffice.com_.sun.star.bridge.XBridgeSupplier
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type OleBridgeSupplier2 = typingsSlinky.activexLibreoffice.com_.sun.star.bridge.XBridgeSupplier2
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type OleBridgeSupplierVar1 = typingsSlinky.activexLibreoffice.com_.sun.star.bridge.OleBridgeSupplier2
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type OleObjectFactory = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XMultiServiceFactory
  
  /** provides the ability to access remote processes, resolving them by an UNO url. ; */
  type UnoUrlResolver = typingsSlinky.activexLibreoffice.com_.sun.star.bridge.XUnoUrlResolver
}
