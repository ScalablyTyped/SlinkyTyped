...
object DocumentDigitalSignatures {
  ...
  @scala.inline
  implicit class DocumentDigitalSignaturesOps[Self <: DocumentDigitalSignatures] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withCreateWithVersion(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithVersion")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateWithVersionAndValidSignature(value: (String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithVersionAndValidSignature")(js.Any.fromFunction2(value))
        ret
    }
  }
