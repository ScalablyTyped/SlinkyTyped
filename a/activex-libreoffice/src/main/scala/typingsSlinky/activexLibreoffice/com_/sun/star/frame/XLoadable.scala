...
object XLoadable {
  ...
  implicit class XLoadableOps[Self <: XLoadable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInitNew(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initNew")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withLoad(value: SeqEquiv[PropertyValue] => Unit): Self = {
        val ret = this.duplicate
