...
- typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XControlShape because var conflicts: Position, Size. Inlined Control, getControl, setControl */ trait ControlShape extends Shape {
  /**
