...
- typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XShapeDescriptor because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XShape because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.drawing.XControlShape because var conflicts: Position, Size. Inlined Control, getControl, setControl */ @js.native
trait ControlShape extends Shape {
...
object ControlShape {
  ...
  @scala.inline
  implicit class ControlShapeOps[Self <: ControlShape] (val x: Self) extends AnyVal {
