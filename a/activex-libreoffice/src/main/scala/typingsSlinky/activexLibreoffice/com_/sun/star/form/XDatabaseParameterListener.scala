...
object XDatabaseParameterListener {
  ...
  implicit class XDatabaseParameterListenerOps[Self <: XDatabaseParameterListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withApproveParameter(value: DatabaseParameterEvent => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("approveParameter")(js.Any.fromFunction1(value))
        ret
    }
  }
