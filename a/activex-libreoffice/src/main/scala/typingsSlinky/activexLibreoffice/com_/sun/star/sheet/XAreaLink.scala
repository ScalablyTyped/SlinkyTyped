...
object XAreaLink {
  ...
  implicit class XAreaLinkOps[Self <: XAreaLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDestArea(value: CellRangeAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DestArea")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSourceArea(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SourceArea")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDestArea(value: () => CellRangeAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDestArea")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetSourceArea(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSourceArea")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetDestArea(value: CellRangeAddress => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setDestArea")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetSourceArea(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setSourceArea")(js.Any.fromFunction1(value))
        ret
    }
  }
