...
package object backend {
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type AuthenticationFailedException = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendSetupException
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type BackendAccessException = typingsSlinky.activexLibreoffice.com_.sun.star.lang.WrappedTargetException
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type CannotConnectException = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendSetupException
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type ConnectionLostException = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendAccessException
  
  /**
    * allows importing data from one configuration repository into another.
    * @since OOo 1.1.2
    */
  type DataImporter = typingsSlinky.activexLibreoffice.com_.sun.star.task.XJob
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type DefaultBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.Backend
  
  /**
    * allows scanning a configuration data repository for available components .
    * @since OOo 1.1.2
    */
  type HierarchyBrowser = typingsSlinky.activexLibreoffice.com_.sun.star.task.XJob
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type InsufficientAccessRightsException = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendAccessException
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type InvalidAuthenticationMechanismException = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendSetupException
  ...
  /**
    ...
    * @see PropertyInfo
    */
  type LayerDescriber = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XLayerContentDescriber
  
  /** implements {@link MultiLayerStratum} that provides access to a multiple layers of configuration data from LDAP source */
  type LdapMultiLayerStratum = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.MultiLayerStratum
  
  /**
    * implements {@link SingleBackend} that stores data in an LDAP directory.
    * @since OOo 1.1.2
    */
  type LdapSingleBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SingleBackend
  
  /** implements {@link SingleLayerStratum} that provides access to a single layer of configuration data from LDAP source */
  type LdapSingleStratum = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SingleLayerStratum
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type LocalDataImporter = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.DataImporter
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type LocalHierarchyBrowser = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.HierarchyBrowser
  
  /** implements {@link SchemaSupplier} providing access to local configuration schemas */
  type LocalSchemaSupplier = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SchemaSupplier
  
  /**
    * implements {@link SingleBackend} that stores data in the local file system using the OOR XML formats.
    * @since OOo 1.1.2
    */
  type LocalSingleBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SingleBackend
  
  /** implements {@link SingleLayerStratum} that provides access to a singe layer of configuration data from local file system */
  type LocalSingleStratum = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SingleLayerStratum
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type MergeImporter = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.Importer
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type OfflineBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendAdapter
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type OnlineBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendAdapter
  
  /** implements {@link SingleLayerStratum} that provides access to a singe layer of configuration data from external data store */
  type PlatformBackend = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.SingleLayerStratum
  
  /** provides access to configuration schemas */
  type SchemaSupplier = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XSchemaSupplier
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type SingleBackendAdapter = typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.BackendAdapter
}
