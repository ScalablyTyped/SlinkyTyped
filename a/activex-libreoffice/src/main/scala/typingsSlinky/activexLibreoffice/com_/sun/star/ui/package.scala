...
package object ui {
  /**
    ...
    */
  type ContextChangeEventMultiplexer = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XContextChangeEventMultiplexer
  /**
    * provides access to the global accelerator (aka shortcut) configuration set.
    * @since OOo 2.0
    */
  type GlobalAcceleratorConfiguration = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XAcceleratorConfiguration
  /** @since LibreOffice 4.1 */
  type ImageManager = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XImageManager
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleUICategoryDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleUICommandDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleWindowStateConfiguration = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameContainer
  /**
    ...
    * @since OOo 2.0
    */
  type UICategoryDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    * specifies a user interface configuration manager which controls all customizable user interface elements of an object.
    * @since OOo 2.0
    */
  type UIConfigurationManager = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XUIConfigurationManager2
  /**
    ...
    * @since OOo 2.0
    */
  type UIElementFactory = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XUIElementFactory
  /**
    ...
    * @since OOo 2.0
    */
  type UIElementFactoryManager = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XUIElementFactoryManager
  /**
    ...
    * @since OOo 3.1
    */
  type WindowContentFactory = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleComponentFactory
  /**
    ...
    * @since LibreOffice 4.1
    */
  type WindowContentFactoryManager = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleComponentFactory
  /**
    ...
    * @since OOo 2.0
    */
  type WindowStateConfiguration = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    ...
    */
  type theModuleUIConfigurationManagerSupplier = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XModuleUIConfigurationManagerSupplier
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theUICategoryDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theUIElementFactoryManager = typingsSlinky.activexLibreoffice.com_.sun.star.ui.XUIElementFactoryManager
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theWindowContentFactoryManager = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleComponentFactory
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theWindowStateConfiguration = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
}
