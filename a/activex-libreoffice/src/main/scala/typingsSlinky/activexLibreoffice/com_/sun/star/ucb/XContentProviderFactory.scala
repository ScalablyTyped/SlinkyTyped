...
object XContentProviderFactory {
  ...
  implicit class XContentProviderFactoryOps[Self <: XContentProviderFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateContentProvider(value: String => XContentProvider): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createContentProvider")(js.Any.fromFunction1(value))
        ret
    }
  }
