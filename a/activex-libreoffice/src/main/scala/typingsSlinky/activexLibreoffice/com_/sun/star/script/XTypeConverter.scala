...
object XTypeConverter {
  ...
  implicit class XTypeConverterOps[Self <: XTypeConverter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConvertTo(value: (js.Any, `type`) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertTo")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withConvertToSimpleType(value: (js.Any, TypeClass) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertToSimpleType")(js.Any.fromFunction2(value))
        ret
    }
  }
