...
object XSheetCellCursor {
  ...
  implicit class XSheetCellCursorOps[Self <: XSheetCellCursor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCollapseToCurrentArray(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseToCurrentArray")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCollapseToCurrentRegion(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseToCurrentRegion")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCollapseToMergedArea(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseToMergedArea")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCollapseToSize(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("collapseToSize")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withExpandToEntireColumns(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expandToEntireColumns")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withExpandToEntireRows(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("expandToEntireRows")(js.Any.fromFunction0(value))
        ret
    }
  }
