...
object DataPilotSource {
  ...
  implicit class DataPilotSourceOps[Self <: DataPilotSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumnFieldCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ColumnFieldCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withColumnGrand(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ColumnGrand")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataFieldCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataFieldCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRowFieldCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RowFieldCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRowGrand(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RowGrand")(value.asInstanceOf[js.Any])
        ret
    }
  }
