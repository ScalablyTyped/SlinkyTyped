...
object PolyPolygonBezierDescriptor {
  ...
  implicit class PolyPolygonBezierDescriptorOps[Self <: PolyPolygonBezierDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGeometry(value: PolyPolygonBezierCoords): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Geometry")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPolyPolygonBezier(value: PolyPolygonBezierCoords): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PolyPolygonBezier")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
