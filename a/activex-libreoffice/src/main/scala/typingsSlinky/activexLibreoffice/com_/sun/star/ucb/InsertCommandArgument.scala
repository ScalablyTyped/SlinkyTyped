...
object InsertCommandArgument {
  ...
  implicit class InsertCommandArgumentOps[Self <: InsertCommandArgument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withData(value: XInputStream): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Data")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withReplaceExisting(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ReplaceExisting")(value.asInstanceOf[js.Any])
        ret
    }
  }
