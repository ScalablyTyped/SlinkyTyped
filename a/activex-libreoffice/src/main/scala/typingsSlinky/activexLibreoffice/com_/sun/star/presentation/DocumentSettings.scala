...
object DocumentSettings {
  ...
  implicit class DocumentSettingsOps[Self <: DocumentSettings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsPrintDrawing(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPrintDrawing")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsPrintHandout(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPrintHandout")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsPrintHiddenPages(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPrintHiddenPages")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsPrintNotes(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPrintNotes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsPrintOutline(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsPrintOutline")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
