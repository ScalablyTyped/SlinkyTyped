...
object XSchema {
  ...
  implicit class XSchemaOps[Self <: XSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withReadComponent(value: XSchemaHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("readComponent")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReadSchema(value: XSchemaHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("readSchema")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReadTemplates(value: XSchemaHandler => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("readTemplates")(js.Any.fromFunction1(value))
        ret
    }
  }
