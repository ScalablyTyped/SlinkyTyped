...
object XConfigurationControllerRequestQueue {
  ...
  implicit class XConfigurationControllerRequestQueueOps[Self <: XConfigurationControllerRequestQueue] (val x: Self) extends AnyVal {
    ...
    def withHasPendingRequests(value: () => Boolean): Self = {
        ...
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasPendingRequests")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withPostChangeRequest(value: XConfigurationChangeRequest => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("postChangeRequest")(js.Any.fromFunction1(value))
        ret
    }
  }
