...
object XResourceFactory {
  ...
  implicit class XResourceFactoryOps[Self <: XResourceFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateResource(value: XResourceId => XResource): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createResource")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withReleaseResource(value: XResource => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("releaseResource")(js.Any.fromFunction1(value))
        ret
    }
  }
