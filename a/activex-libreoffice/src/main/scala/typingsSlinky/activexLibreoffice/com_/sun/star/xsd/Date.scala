...
trait Date extends XDataType {
  /**
    ...
    */
  var MaxExclusiveDate: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
  /**
    * specifies the inclusive upper bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-maxInclusive
    */
  var MaxInclusiveDate: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
  /**
    * specifies the exclusive lower bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-minExclusive
    */
  var MinExclusiveDate: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
  /**
    * specifies the inclusive lower bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-minInclusive
    */
  var MinInclusiveDate: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
}
