...
object Date {
  ...
  implicit class DateOps[Self <: Date] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxExclusiveDate(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date): Self = this.set("MaxExclusiveDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMaxInclusiveDate(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date): Self = this.set("MaxInclusiveDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinExclusiveDate(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date): Self = this.set("MinExclusiveDate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMinInclusiveDate(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date): Self = this.set("MinInclusiveDate", value.asInstanceOf[js.Any])
  }
}
