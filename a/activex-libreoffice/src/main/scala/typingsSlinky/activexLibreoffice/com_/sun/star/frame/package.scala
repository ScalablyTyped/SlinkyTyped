...
package object frame {
  ...
  type AppDispatchProvider = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XAppDispatchProvider
  ...
  /**
    ...
    */
  type AutoRecovery = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDispatch
  
  /** @since LibreOffice 4.1 */
  type Bibliography = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  ...
  /**
    ...
    * @see XDesktop
    */
  type Components = typingsSlinky.activexLibreoffice.com_.sun.star.container.XEnumerationAccess
  ...
  /**
    ...
    */
  type ContentHandler = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XNotifyingDispatch
  ...
  /**
    ...
    */
  type ContentHandlerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XLoaderFactory
  ...
  /**
    ...
    */
  type Desktop = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDesktop2
  
  /** @deprecated Deprecated */
  type DesktopTasks = typingsSlinky.activexLibreoffice.com_.sun.star.container.XEnumerationAccess
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type DispatchHelper = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDispatchHelper
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type DispatchRecorder = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDispatchRecorder
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type DispatchRecorderSupplier = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDispatchRecorderSupplier
  ...
  /**
    ...
    */
  type DocumentTemplates = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDocumentTemplates
  
  /**
    * This exception can be thrown in case an object is initialized second time.
    * @since OOo 1.1.2
    */
  type DoubleInitializationException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @see Desktop
    */
  type Frame = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XFrame2
  ...
  /**
    ...
    */
  type FrameLoaderFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XLoaderFactory
  ...
  /**
    ...
    * @see XFramesSupplier
    */
  type FramesContainer = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XFrames
  ...
  /**
    ...
    */
  type GlobalEventBroadcaster = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XGlobalEventBroadcaster
  
  /**
    * This exception can be thrown in case arguments are wrong.
    * @since OOo 1.1.2
    */
  type IllegalArgumentIOException = typingsSlinky.activexLibreoffice.com_.sun.star.io.IOException
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type LayoutManager = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XLayoutManager2
  ...
  /**
    ...
    * [out] list.
    */
  type MediaTypeDetectionHelper = typingsSlinky.activexLibreoffice.com_.sun.star.util.XStringMapping
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleManager = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModuleManager2
  
  /** @since LibreOffice 4.2 */
  type OfficeFrameLoader = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XSynchronousFrameLoader
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type PopupMenuControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  ...
  /**
    ...
    */
  type SessionManager = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XSessionManagerClient
  
  /** @deprecated Deprecated */
  type Settings = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type StatusbarController = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XStatusbarController
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type StatusbarControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  
  /** @since LibreOffice 4.1 */
  type TaskCreator = typingsSlinky.activexLibreoffice.com_.sun.star.lang.XSingleServiceFactory
  ...
  /**
    ...
    */
  type TerminationVetoException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type ToolbarControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  
  /**
    * specifies a factory for com::sun::star::ucb::TransientDocumentsDocumentContents.
    * @since OOo 2.0
    */
  type TransientDocumentsDocumentContentFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XTransientDocumentsDocumentContentFactory
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type UICommandDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
  
  /**
    * This exception can be thrown in case an office module could not be classified or does not have a valid configuration.
    * @since OOo 2.0
    */
  type UnknownModuleException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  
  /**
    * Prior to LibreOffice 4.3, this singleton was only available as a (single-instance) {@link AutoRecovery} service.
    * @since LibreOffice 4.3
    */
  type theAutoRecovery = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDispatch
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theDesktop = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XDesktop2
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theGlobalEventBroadcaster = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XGlobalEventBroadcaster
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type thePopupMenuControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theStatusbarControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theToolbarControllerFactory = typingsSlinky.activexLibreoffice.com_.sun.star.frame.XUIControllerFactory
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theUICommandDescription = typingsSlinky.activexLibreoffice.com_.sun.star.container.XNameAccess
}
