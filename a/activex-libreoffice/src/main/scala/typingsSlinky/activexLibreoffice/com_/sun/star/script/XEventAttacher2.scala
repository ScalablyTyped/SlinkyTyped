...
object XEventAttacher2 {
  ...
  implicit class XEventAttacher2Ops[Self <: XEventAttacher2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttachMultipleEventListeners(value: (XInterface, SeqEquiv[EventListener]) => SafeArray[XEventListener]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("attachMultipleEventListeners")(js.Any.fromFunction2(value))
        ret
    }
  }
