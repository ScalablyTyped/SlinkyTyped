...
object EnhancedCustomShapeTextPath {
  ...
  implicit class EnhancedCustomShapeTextPathOps[Self <: EnhancedCustomShapeTextPath] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withScaleX(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ScaleX")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextPath(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextPath")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextPathMode(value: EnhancedCustomShapeTextPathMode): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextPathMode")(value.asInstanceOf[js.Any])
        ret
    }
  }
