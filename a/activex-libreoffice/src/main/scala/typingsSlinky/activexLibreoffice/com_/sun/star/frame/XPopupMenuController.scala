...
object XPopupMenuController {
  ...
  implicit class XPopupMenuControllerOps[Self <: XPopupMenuController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetPopupMenu(value: XPopupMenu => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setPopupMenu")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withUpdatePopupMenu(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updatePopupMenu")(js.Any.fromFunction0(value))
        ret
    }
  }
