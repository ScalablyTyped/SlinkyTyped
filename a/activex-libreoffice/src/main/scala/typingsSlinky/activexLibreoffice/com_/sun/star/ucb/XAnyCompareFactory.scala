...
object XAnyCompareFactory {
  ...
  implicit class XAnyCompareFactoryOps[Self <: XAnyCompareFactory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateAnyCompareByName(value: String => XAnyCompare): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createAnyCompareByName")(js.Any.fromFunction1(value))
        ret
    }
  }
