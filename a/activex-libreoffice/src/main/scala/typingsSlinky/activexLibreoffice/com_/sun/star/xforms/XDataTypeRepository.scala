...
import typingsSlinky.activexLibreoffice.com_.sun.star.xsd.XDataType
...
object XDataTypeRepository {
  ...
  implicit class XDataTypeRepositoryOps[Self <: XDataTypeRepository] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCloneDataType(value: (String, String) => XDataType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cloneDataType")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetBasicDataType(value: Double => XDataType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getBasicDataType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetDataType(value: String => XDataType): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRevokeDataType(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("revokeDataType")(js.Any.fromFunction1(value))
        ret
    }
  }
