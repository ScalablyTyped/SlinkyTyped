...
@js.native
trait ResultSet
  extends typingsSlinky.activexLibreoffice.com_.sun.star.sdbc.ResultSet
     with XCancellable
     with XRowLocate
     with XDeleteRows {
  /**
...
object ResultSet {
  ...
  implicit class ResultSetOps[Self <: ResultSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCanUpdateInsertedRows(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CanUpdateInsertedRows")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsBookmarkable(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsBookmarkable")(value.asInstanceOf[js.Any])
        ret
    }
  }
