...
object XLevelsSupplier {
  ...
  implicit class XLevelsSupplierOps[Self <: XLevelsSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLevels(value: XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Levels")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetLevels(value: () => XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getLevels")(js.Any.fromFunction0(value))
        ret
    }
  }
