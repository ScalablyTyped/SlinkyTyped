...
trait OLE2Shape extends Shape {
  ...
  var PersistName: String = js.native
}
...
object OLE2Shape {
  ...
  implicit class OLE2ShapeOps[Self <: OLE2Shape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPersistName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PersistName")(value.asInstanceOf[js.Any])
        ret
    }
  }
