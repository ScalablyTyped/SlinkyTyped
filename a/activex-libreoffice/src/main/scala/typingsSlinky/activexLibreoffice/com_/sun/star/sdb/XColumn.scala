...
trait XColumn extends XInterface {
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  val Date: typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
  /**
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  val Time: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
  /**
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  def getDate(): typingsSlinky.activexLibreoffice.com_.sun.star.util.Date
  /**
    * gets the value of a column in the current row as a double.
    * @returns the column value
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  def getTime(): typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
  /**
    * gets the value of a column in the current row as a datetime object.
    * @returns the column value
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
