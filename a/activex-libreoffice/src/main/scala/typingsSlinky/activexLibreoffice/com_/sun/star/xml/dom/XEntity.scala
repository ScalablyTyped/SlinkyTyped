...
object XEntity {
  ...
  implicit class XEntityOps[Self <: XEntity] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withNotationName(value: String): Self = {
    ...
    @scala.inline
    def withGetNotationName(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getNotationName")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
