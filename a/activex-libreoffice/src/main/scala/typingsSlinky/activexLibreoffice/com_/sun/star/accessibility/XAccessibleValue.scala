...
object XAccessibleValue {
  ...
  implicit class XAccessibleValueOps[Self <: XAccessibleValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetMaximumValue(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMaximumValue")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetMinimumValue(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMinimumValue")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withSetCurrentValue(value: js.Any => Boolean): Self = {
        val ret = this.duplicate
