...
object XGalleryTheme {
  ...
  implicit class XGalleryThemeOps[Self <: XGalleryTheme] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInsertDrawingByIndex(value: (XComponent, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertDrawingByIndex")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withInsertGraphicByIndex(value: (XGraphic, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertGraphicByIndex")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withInsertURLByIndex(value: (String, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertURLByIndex")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
