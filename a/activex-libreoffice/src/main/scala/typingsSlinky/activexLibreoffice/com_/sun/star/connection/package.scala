...
package object connection {
  /**
    ...
    */
  type Acceptor = typingsSlinky.activexLibreoffice.com_.sun.star.connection.XAcceptor
  /** Is thrown, when there is another thread already accepting on this instance. */
  type AlreadyAcceptingException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /** Is thrown, when it is not possible to accept on a local resource. */
  type ConnectionSetupException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
  /**
    ...
    */
  type Connector = typingsSlinky.activexLibreoffice.com_.sun.star.connection.XConnector
  /** Is thrown in case no one is accepting on the specified resource. */
  type NoConnectException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.Exception
}
