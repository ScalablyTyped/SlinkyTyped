...
object XCellAddressable {
  ...
  implicit class XCellAddressableOps[Self <: XCellAddressable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCellAddress(value: CellAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CellAddress")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetCellAddress(value: () => CellAddress): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCellAddress")(js.Any.fromFunction0(value))
        ret
    }
  }
