...
object XSheetDataProvider {
  ...
  implicit class XSheetDataProviderOps[Self <: XSheetDataProvider] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateDataSequenceByFormulaTokens(value: SeqEquiv[FormulaToken] => XDataSequence): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createDataSequenceByFormulaTokens")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withCreateDataSequenceByFormulaTokensPossible(value: SeqEquiv[FormulaToken] => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createDataSequenceByFormulaTokensPossible")(js.Any.fromFunction1(value))
        ret
    }
  }
