package typingsSlinky.activexLibreoffice.com_.sun.star.ucb.NameClash
...
object Constants {
  ...
  @scala.inline
  def ASK: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def ERROR: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def KEEP: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def OVERWRITE: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def RENAME: `2` = 2.asInstanceOf[`2`]
}
