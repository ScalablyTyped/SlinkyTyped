...
object Wizard {
  ...
  implicit class WizardOps[Self <: Wizard] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateMultiplePathsWizard(value: (SeqEquiv[SeqEquiv[Double]], XWizardController) => Unit): Self = this.set("createMultiplePathsWizard", js.Any.fromFunction2(value))
    @scala.inline
    def setCreateSinglePathWizard(value: (SeqEquiv[Double], XWizardController) => Unit): Self = this.set("createSinglePathWizard", js.Any.fromFunction2(value))
  }
