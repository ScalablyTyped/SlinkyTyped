...
object XAccessibleSelection {
  ...
  implicit class XAccessibleSelectionOps[Self <: XAccessibleSelection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSelectedAccessibleChildCount(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SelectedAccessibleChildCount")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withClearAccessibleSelection(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearAccessibleSelection")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDeselectAccessibleChild(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deselectAccessibleChild")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSelectedAccessibleChild(value: Double => XAccessible): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSelectedAccessibleChild")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetSelectedAccessibleChildCount(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSelectedAccessibleChildCount")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withIsAccessibleChildSelected(value: Double => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isAccessibleChildSelected")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectAccessibleChild(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectAccessibleChild")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSelectAllAccessibleChildren(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("selectAllAccessibleChildren")(js.Any.fromFunction0(value))
        ret
    }
  }
