...
object XImplicitIDContainer {
  ...
  implicit class XImplicitIDContainerOps[Self <: XImplicitIDContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddWithImplicitID(value: js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addWithImplicitID")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveByImplicitID(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeByImplicitID")(js.Any.fromFunction1(value))
        ret
    }
  }
