...
object XMenuProxyListener {
  ...
  implicit class XMenuProxyListenerOps[Self <: XMenuProxyListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMenuChangedMultiple(value: SeqEquiv[MenuMultipleChange] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("menuChangedMultiple")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMenuChangedSingle(value: SeqEquiv[MenuSingleChange] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("menuChangedSingle")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withMenuItemDeleted(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("menuItemDeleted")(js.Any.fromFunction1(value))
        ret
    }
  }
