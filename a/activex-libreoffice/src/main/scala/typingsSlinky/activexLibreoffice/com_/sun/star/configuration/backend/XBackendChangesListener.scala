...
object XBackendChangesListener {
  ...
  implicit class XBackendChangesListenerOps[Self <: XBackendChangesListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComponentDataChanged(value: ComponentChangeEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("componentDataChanged")(js.Any.fromFunction1(value))
        ret
    }
  }
