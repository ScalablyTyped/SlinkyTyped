...
object XStatement {
  ...
  implicit class XStatementOps[Self <: XStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExecuteQuery(value: String => XResultSet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeQuery")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withExecuteUpdate(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeUpdate")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
