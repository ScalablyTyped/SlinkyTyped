...
object XFormComponentValidityListener {
  ...
  implicit class XFormComponentValidityListenerOps[Self <: XFormComponentValidityListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withComponentValidityChanged(value: EventObject => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("componentValidityChanged")(js.Any.fromFunction1(value))
        ret
    }
  }
