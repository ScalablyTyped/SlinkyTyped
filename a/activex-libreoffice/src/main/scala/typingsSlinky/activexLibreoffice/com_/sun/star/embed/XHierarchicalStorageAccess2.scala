...
object XHierarchicalStorageAccess2 {
  ...
  implicit class XHierarchicalStorageAccess2Ops[Self <: XHierarchicalStorageAccess2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOpenEncryptedStreamByHierarchicalName(value: (String, Double, SeqEquiv[NamedValue]) => XExtendedStorageStream): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("openEncryptedStreamByHierarchicalName")(js.Any.fromFunction3(value))
        ret
    }
  }
