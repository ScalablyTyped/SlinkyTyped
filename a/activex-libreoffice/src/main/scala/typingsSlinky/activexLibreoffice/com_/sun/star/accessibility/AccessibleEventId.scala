...
object AccessibleEventId {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ACTION_CHANGED: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def ACTIVE_DESCENDANT_CHANGED: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def ACTIVE_DESCENDANT_CHANGED_NOFOCUS: `34` = 34.asInstanceOf[`34`]
    
    @scala.inline
    def BOUNDRECT_CHANGED: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def CARET_CHANGED: `20` = 20.asInstanceOf[`20`]
    
    @scala.inline
    def CHILD: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def COLUMN_CHANGED: `40` = 40.asInstanceOf[`40`]
    
    @scala.inline
    def CONTENT_FLOWS_FROM_RELATION_CHANGED: `12` = 12.asInstanceOf[`12`]
    
    @scala.inline
    def CONTENT_FLOWS_TO_RELATION_CHANGED: `13` = 13.asInstanceOf[`13`]
    
    @scala.inline
    def CONTROLLED_BY_RELATION_CHANGED: `14` = 14.asInstanceOf[`14`]
    
    @scala.inline
    def CONTROLLER_FOR_RELATION_CHANGED: `15` = 15.asInstanceOf[`15`]
    
    @scala.inline
    def DESCRIPTION_CHANGED: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def HYPERTEXT_CHANGED: `24` = 24.asInstanceOf[`24`]
    
    @scala.inline
    def INVALIDATE_ALL_CHILDREN: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def LABELED_BY_RELATION_CHANGED: `17` = 17.asInstanceOf[`17`]
    
    @scala.inline
    def LABEL_FOR_RELATION_CHANGED: `16` = 16.asInstanceOf[`16`]
    
    @scala.inline
    def LISTBOX_ENTRY_COLLAPSED: `33` = 33.asInstanceOf[`33`]
    
    @scala.inline
    def LISTBOX_ENTRY_EXPANDED: `32` = 32.asInstanceOf[`32`]
    
    @scala.inline
    def MEMBER_OF_RELATION_CHANGED: `18` = 18.asInstanceOf[`18`]
    
    @scala.inline
    def NAME_CHANGED: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def PAGE_CHANGED: `38` = 38.asInstanceOf[`38`]
    
    @scala.inline
    def ROLE_CHANGED: `41` = 41.asInstanceOf[`41`]
    
    @scala.inline
    def SECTION_CHANGED: `39` = 39.asInstanceOf[`39`]
    
    @scala.inline
    def SELECTION_CHANGED: `9` = 9.asInstanceOf[`9`]
    
    @scala.inline
    def SELECTION_CHANGED_ADD: `35` = 35.asInstanceOf[`35`]
    
    @scala.inline
    def SELECTION_CHANGED_REMOVE: `36` = 36.asInstanceOf[`36`]
    
    @scala.inline
    def SELECTION_CHANGED_WITHIN: `37` = 37.asInstanceOf[`37`]
    
    @scala.inline
    def STATE_CHANGED: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def SUB_WINDOW_OF_RELATION_CHANGED: `19` = 19.asInstanceOf[`19`]
    
    @scala.inline
    def TABLE_CAPTION_CHANGED: `25` = 25.asInstanceOf[`25`]
    
    @scala.inline
    def TABLE_COLUMN_DESCRIPTION_CHANGED: `26` = 26.asInstanceOf[`26`]
    
    @scala.inline
    def TABLE_COLUMN_HEADER_CHANGED: `27` = 27.asInstanceOf[`27`]
    
    @scala.inline
    def TABLE_MODEL_CHANGED: `28` = 28.asInstanceOf[`28`]
    
    @scala.inline
    def TABLE_ROW_DESCRIPTION_CHANGED: `29` = 29.asInstanceOf[`29`]
    
    @scala.inline
    def TABLE_ROW_HEADER_CHANGED: `30` = 30.asInstanceOf[`30`]
    
    @scala.inline
    def TABLE_SUMMARY_CHANGED: `31` = 31.asInstanceOf[`31`]
    
    @scala.inline
    def TEXT_ATTRIBUTE_CHANGED: `23` = 23.asInstanceOf[`23`]
    
    @scala.inline
    def TEXT_CHANGED: `22` = 22.asInstanceOf[`22`]
    
    @scala.inline
    def TEXT_SELECTION_CHANGED: `21` = 21.asInstanceOf[`21`]
    
    @scala.inline
    def VALUE_CHANGED: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def VISIBLE_DATA_CHANGED: `10` = 10.asInstanceOf[`10`]
  }
}
