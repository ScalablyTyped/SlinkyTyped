...
object XSimpleTabController {
  ...
  implicit class XSimpleTabControllerOps[Self <: XSimpleTabController] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withActiveTabID(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ActiveTabID")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withActivateTab(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("activateTab")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withAddTabListener(value: XTabListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addTabListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetActiveTabID(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getActiveTabID")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetTabProps(value: Double => SafeArray[NamedValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTabProps")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsertTab(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertTab")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemoveTab(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeTab")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveTabListener(value: XTabListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeTabListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetTabProps(value: (Double, SeqEquiv[NamedValue]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setTabProps")(js.Any.fromFunction2(value))
        ret
    }
  }
