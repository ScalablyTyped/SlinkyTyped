...
object XStringRepresentation {
  ...
  implicit class XStringRepresentationOps[Self <: XStringRepresentation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConvertToControlValue(value: js.Any => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("convertToControlValue")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withConvertToPropertyValue(value: (String, `type`) => js.Any): Self = {
        val ret = this.duplicate
