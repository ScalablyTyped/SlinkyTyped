...
- typingsSlinky.activexLibreoffice.com_.sun.star.sdb.XSingleSelectQueryAnalyzer because Already inherited
- typingsSlinky.activexLibreoffice.com_.sun.star.sdb.XSingleSelectQueryComposer because var conflicts: Query. Inlined appendFilterByColumn, appendGroupByColumn, appendHavingClauseByColumn, appendOrderByColumn, ElementaryQuery, setFilter, setGroup, setHavingClause, setOrder, setStructuredFilter, setStructuredHavingClause */ @js.native
