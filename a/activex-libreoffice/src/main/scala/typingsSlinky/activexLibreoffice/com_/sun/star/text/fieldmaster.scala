...
object fieldmaster {
  ...
  object Bibliography {
    ...
    def apply(
    ...
    ): typingsSlinky.activexLibreoffice.com_.sun.star.text.fieldmaster.Bibliography = {
      ...
      __obj.asInstanceOf[typingsSlinky.activexLibreoffice.com_.sun.star.text.fieldmaster.Bibliography]
    }
    
    @scala.inline
    implicit class BibliographyMutableBuilder[Self <: typingsSlinky.activexLibreoffice.com_.sun.star.text.fieldmaster.Bibliography] (val x: Self) extends AnyVal {
