...
object XBitmap {
  ...
  implicit class XBitmapOps[Self <: XBitmap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDIB(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DIB")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaskDIB(value: SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaskDIB")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetDIB(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDIB")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetMaskDIB(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMaskDIB")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
