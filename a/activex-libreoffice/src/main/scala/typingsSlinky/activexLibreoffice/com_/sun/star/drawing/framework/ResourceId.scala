...
object ResourceId {
  ...
  implicit class ResourceIdOps[Self <: ResourceId] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateEmpty(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createEmpty")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withCreateWithAnchor(value: (String, XResourceId) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithAnchor")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withCreateWithAnchorURL(value: (String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithAnchorURL")(js.Any.fromFunction2(value))
        ret
    }
  }
