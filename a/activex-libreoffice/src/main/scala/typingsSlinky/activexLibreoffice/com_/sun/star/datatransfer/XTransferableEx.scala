...
object XTransferableEx {
  ...
  implicit class XTransferableExOps[Self <: XTransferableEx] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withQueryTransferDataFlavors(value: SeqEquiv[DataFlavor] => SafeArray[DataFlavor]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("queryTransferDataFlavors")(js.Any.fromFunction1(value))
        ret
    }
  }
