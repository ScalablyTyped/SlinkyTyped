...
object ClosedBezierShape {
  ...
  def apply(
    ...
    ParaWidows: Double,
    PolyPolygonBezierDescriptor: PolyPolygonBezierDescriptor,
    Position: Point,
    Printable: Boolean,
