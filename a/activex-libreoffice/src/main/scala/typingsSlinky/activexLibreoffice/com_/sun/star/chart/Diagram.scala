...
object Diagram {
  ...
  implicit class DiagramOps[Self <: Diagram] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAutomaticPosition(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AutomaticPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAutomaticSize(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AutomaticSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataCaption(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataCaption")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMissingValueTreatment(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MissingValueTreatment")(value.asInstanceOf[js.Any])
        ret
    }
  }
