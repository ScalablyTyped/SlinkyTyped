...
object XManifestWriter {
  ...
  implicit class XManifestWriterOps[Self <: XManifestWriter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withWriteManifestSequence(value: (XOutputStream, SeqEquiv[SeqEquiv[PropertyValue]]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("writeManifestSequence")(js.Any.fromFunction2(value))
        ret
    }
  }
