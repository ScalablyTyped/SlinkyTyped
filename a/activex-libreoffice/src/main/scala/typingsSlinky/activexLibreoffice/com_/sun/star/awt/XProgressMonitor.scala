...
object XProgressMonitor {
  ...
  implicit class XProgressMonitorOps[Self <: XProgressMonitor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddText(value: (String, String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addText")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRemoveText(value: (String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeText")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withUpdateText(value: (String, String, Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("updateText")(js.Any.fromFunction3(value))
        ret
    }
  }
