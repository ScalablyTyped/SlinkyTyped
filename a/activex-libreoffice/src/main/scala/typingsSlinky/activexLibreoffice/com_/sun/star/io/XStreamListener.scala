...
object XStreamListener {
  ...
  implicit class XStreamListenerOps[Self <: XStreamListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withStarted(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("started")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withTerminated(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("terminated")(js.Any.fromFunction0(value))
        ret
    }
  }
