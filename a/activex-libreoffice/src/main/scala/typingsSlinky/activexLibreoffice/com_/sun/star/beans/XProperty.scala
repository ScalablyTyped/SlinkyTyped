...
object XProperty {
  ...
  implicit class XPropertyOps[Self <: XProperty] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAsProperty(value: Property): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AsProperty")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetAsProperty(value: () => Property): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAsProperty")(js.Any.fromFunction0(value))
        ret
    }
  }
