...
object XSearchable {
  ...
  implicit class XSearchableOps[Self <: XSearchable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateSearchDescriptor(value: () => XSearchDescriptor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSearchDescriptor")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withFindAll(value: XSearchDescriptor => XIndexAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findAll")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFindFirst(value: XSearchDescriptor => XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findFirst")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFindNext(value: (XInterface, XSearchDescriptor) => XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("findNext")(js.Any.fromFunction2(value))
        ret
    }
  }
