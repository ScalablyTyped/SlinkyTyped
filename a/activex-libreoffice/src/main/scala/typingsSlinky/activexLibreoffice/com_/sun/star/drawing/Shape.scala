...
object Shape {
  ...
  implicit class ShapeOps[Self <: Shape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withInteropGrabBag(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InteropGrabBag")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withMoveProtect(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MoveProtect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withNavigationOrder(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withShapeUserDefinedAttributes(value: XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ShapeUserDefinedAttributes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSizeProtect(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SizeProtect")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTransformation(value: HomogenMatrix3): Self = {
        val ret = this.duplicate
