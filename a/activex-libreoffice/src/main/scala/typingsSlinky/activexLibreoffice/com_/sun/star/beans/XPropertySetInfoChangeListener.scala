...
object XPropertySetInfoChangeListener {
  ...
  implicit class XPropertySetInfoChangeListenerOps[Self <: XPropertySetInfoChangeListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withPropertySetInfoChange(value: PropertySetInfoChangeEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("propertySetInfoChange")(js.Any.fromFunction1(value))
        ret
    }
  }
