...
object XEngine {
  ...
  implicit class XEngineOps[Self <: XEngine] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRoot(value: XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Root")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAddEngineListener(value: XEngineListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addEngineListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withCompile(value: (String, String, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("compile")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetRoot(value: () => XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRoot")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withRemoveEngineListener(value: XEngineListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeEngineListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRun(value: (String, XInterface, SeqEquiv[_]) => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("run")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withRunAsync(value: (String, XInterface, SeqEquiv[_], XEngineListener) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("runAsync")(js.Any.fromFunction4(value))
        ret
    }
    @scala.inline
    def withSetLibraryAccess(value: XLibraryAccess => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setLibraryAccess")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetRoot(value: XInterface => Unit): Self = {
        val ret = this.duplicate
