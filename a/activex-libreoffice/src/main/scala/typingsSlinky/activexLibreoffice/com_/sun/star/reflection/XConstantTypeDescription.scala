...
object XConstantTypeDescription {
  ...
  implicit class XConstantTypeDescriptionOps[Self <: XConstantTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConstantValue(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConstantValue")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetConstantValue(value: () => js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getConstantValue")(js.Any.fromFunction0(value))
        ret
    }
  }
