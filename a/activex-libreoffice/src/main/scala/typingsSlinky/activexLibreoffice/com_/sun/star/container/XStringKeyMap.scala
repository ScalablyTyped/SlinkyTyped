...
object XStringKeyMap {
  ...
  implicit class XStringKeyMapOps[Self <: XStringKeyMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetKeyByIndex(value: Double => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getKeyByIndex")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetValueByIndex(value: Double => js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInsertValue(value: (String, js.Any) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertValue")(js.Any.fromFunction2(value))
        ret
    }
  }
