...
object TableRow {
  ...
  implicit class TableRowOps[Self <: TableRow] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIsStartOfNewPage(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsStartOfNewPage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOptimalHeight(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OptimalHeight")(value.asInstanceOf[js.Any])
        ret
    }
  }
