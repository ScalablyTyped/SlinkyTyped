...
object IllustrationsIndex {
  ...
  implicit class IllustrationsIndexOps[Self <: IllustrationsIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateFromLabels(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CreateFromLabels")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLabelCategory(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LabelCategory")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLabelDisplayType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LabelDisplayType")(value.asInstanceOf[js.Any])
        ret
    }
  }
