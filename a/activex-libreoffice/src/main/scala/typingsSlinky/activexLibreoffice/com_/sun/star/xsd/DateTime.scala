...
object DateTime {
  ...
  implicit class DateTimeOps[Self <: DateTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxExclusiveDateTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.DateTime): Self = this.set("MaxExclusiveDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setMaxInclusiveDateTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.DateTime): Self = this.set("MaxInclusiveDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinExclusiveDateTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.DateTime): Self = this.set("MinExclusiveDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setMinInclusiveDateTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.DateTime): Self = this.set("MinInclusiveDateTime", value.asInstanceOf[js.Any])
  }
