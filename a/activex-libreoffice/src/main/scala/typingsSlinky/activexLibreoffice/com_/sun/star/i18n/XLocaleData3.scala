...
object XLocaleData3 {
  ...
  @scala.inline
  implicit class XLocaleData3Ops[Self <: XLocaleData3] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withGetAllCalendars2(value: Locale => SafeArray[Calendar2]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllCalendars2")(js.Any.fromFunction1(value))
        ret
    }
  }
