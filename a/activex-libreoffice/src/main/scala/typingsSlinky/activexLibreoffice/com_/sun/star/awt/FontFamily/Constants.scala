package typingsSlinky.activexLibreoffice.com_.sun.star.awt.FontFamily
...
object Constants {
  @scala.inline
  def DECORATIVE: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def DONTKNOW: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def MODERN: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def ROMAN: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def SCRIPT: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def SWISS: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def SYSTEM: `6` = 6.asInstanceOf[`6`]
}
