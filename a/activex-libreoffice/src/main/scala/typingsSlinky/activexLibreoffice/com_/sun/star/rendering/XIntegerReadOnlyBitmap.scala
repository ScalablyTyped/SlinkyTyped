...
object XIntegerReadOnlyBitmap {
  ...
  implicit class XIntegerReadOnlyBitmapOps[Self <: XIntegerReadOnlyBitmap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMemoryLayout(value: IntegerBitmapLayout): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MemoryLayout")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetData(value: (js.Array[IntegerBitmapLayout], IntegerRectangle2D) => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getData")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetMemoryLayout(value: () => IntegerBitmapLayout): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMemoryLayout")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetPixel(value: (js.Array[IntegerBitmapLayout], IntegerPoint2D) => SafeArray[Double]): Self = {
        val ret = this.duplicate
