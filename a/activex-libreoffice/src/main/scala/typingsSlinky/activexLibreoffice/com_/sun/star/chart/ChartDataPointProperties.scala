...
object ChartDataPointProperties {
  ...
  implicit class ChartDataPointPropertiesOps[Self <: ChartDataPointProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withLabelPlacement(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPercentageNumberFormat(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PercentageNumberFormat")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSegmentOffset(value: Double): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextWordWrap(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextWordWrap")(value.asInstanceOf[js.Any])
        ret
    }
  }
