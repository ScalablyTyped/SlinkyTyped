...
object InteractionHandler {
  ...
  implicit class InteractionHandlerOps[Self <: InteractionHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateWithParentAndContext(value: (XWindow, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithParentAndContext")(js.Any.fromFunction2(value))
        ret
    }
  }
