package typingsSlinky.activexLibreoffice.com_.sun.star.report.inspection

import typingsSlinky.activexLibreoffice.com_.sun.star.inspection.PropertyCategoryDescriptor
import typingsSlinky.activexLibreoffice.com_.sun.star.inspection.XObjectInspectorModel
...
object DefaultComponentInspectorModel {
  ...
  implicit class DefaultComponentInspectorModelOps[Self <: DefaultComponentInspectorModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateWithHelpSection(value: (Double, Double) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createWithHelpSection")(js.Any.fromFunction2(value))
        ret
    }
  }
