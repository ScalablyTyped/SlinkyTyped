...
object XGridControl {
  ...
  implicit class XGridControlOps[Self <: XGridControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddGridControlListener(value: XGridControlListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addGridControlListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveGridControlListener(value: XGridControlListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeGridControlListener")(js.Any.fromFunction1(value))
        ret
    }
  }
