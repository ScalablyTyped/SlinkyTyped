...
object XDataSeries {
  ...
  implicit class XDataSeriesOps[Self <: XDataSeries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDataPointByIndex(value: Double => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataPointByIndex")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withResetAllDataPoints(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resetAllDataPoints")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withResetDataPoint(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("resetDataPoint")(js.Any.fromFunction1(value))
        ret
    }
  }
