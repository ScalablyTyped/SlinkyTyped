...
object XRemoteContentProviderDistributor {
  ...
  implicit class XRemoteContentProviderDistributorOps[Self <: XRemoteContentProviderDistributor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnectToRemoteAcceptor(value: (String, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("connectToRemoteAcceptor")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withDisconnectFromAll(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disconnectFromAll")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDisconnectFromRemoteAcceptor(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("disconnectFromRemoteAcceptor")(js.Any.fromFunction1(value))
        ret
    }
  }
