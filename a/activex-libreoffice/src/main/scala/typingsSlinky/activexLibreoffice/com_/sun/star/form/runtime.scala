...
object runtime {
  ...
  trait FormOperations extends XFormOperations {
    ...
    /**
      ...
      */
    def createWithFormController(Controller: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController): Unit = js.native
  }
  object FormOperations {
    
    @scala.inline
    def apply(
      Controller: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController,
      Cursor: XRowSet,
      ...
      createWithFormController: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController => Unit,
      dispose: () => Unit,
      execute: Double => Unit,
    ...
    implicit class FormOperationsMutableBuilder[Self <: FormOperations] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreateWithFormController(value: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController => Unit): Self = StObject.set(x, "createWithFormController", js.Any.fromFunction1(value))
    }
  }
  ...
  trait XFormController
    ...
    /**
      ...
      */
    def addChildController(ChildController: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController): Unit = js.native
  ...
  object XFormController {
    ...
    def apply(
      ...
      addChildController: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController => Unit,
    ...
    ): typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController = {
      ...
      __obj.asInstanceOf[typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController]
    }
    
    @scala.inline
    implicit class XFormControllerMutableBuilder[Self <: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddChildController(value: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController => Unit): Self = StObject.set(x, "addChildController", js.Any.fromFunction1(value))
  ...
  trait XFormOperations extends XComponent {
    ...
    /**
      ...
      */
    var Controller: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController = js.native
  ...
  object XFormOperations {
    ...
    implicit class XFormOperationsMutableBuilder[Self <: XFormOperations] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setController(value: typingsSlinky.activexLibreoffice.com_.sun.star.form.runtime.XFormController): Self = StObject.set(x, "Controller", value.asInstanceOf[js.Any])
