...
import typingsSlinky.activexLibreoffice.com_.sun.star.chart.XChartData
...
object ChartDocumentWrapper {
  ...
  def apply(
    ...
    Data: XChartData,
    Diagram: typingsSlinky.activexLibreoffice.com_.sun.star.chart.XDiagram,
    DrawPage: XDrawPage,
    HasLegend: Boolean,
    ...
    getData: () => XChartData,
    getDiagram: () => typingsSlinky.activexLibreoffice.com_.sun.star.chart.XDiagram,
    ...
    setDiagram: typingsSlinky.activexLibreoffice.com_.sun.star.chart.XDiagram => Unit,
