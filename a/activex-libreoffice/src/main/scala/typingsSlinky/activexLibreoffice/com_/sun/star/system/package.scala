...
package object system {
  /**
    ...
    */
  type SimpleCommandMail = typingsSlinky.activexLibreoffice.com_.sun.star.system.XSimpleMailClientSupplier
  /**
    ...
    * @see com.sun.star.system.XSimpleMailClient
    */
  type SimpleSystemMail = typingsSlinky.activexLibreoffice.com_.sun.star.system.XSimpleMailClientSupplier
  /**
    ...
    */
  type SystemShellExecute = typingsSlinky.activexLibreoffice.com_.sun.star.system.XSystemShellExecute
}
