...
object XAsyncJob {
  ...
  implicit class XAsyncJobOps[Self <: XAsyncJob] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExecuteAsync(value: (SeqEquiv[NamedValue], XJobListener) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeAsync")(js.Any.fromFunction2(value))
        ret
    }
  }
