...
object XRemoteContentProviderDoneListener {
  ...
  implicit class XRemoteContentProviderDoneListenerOps[Self <: XRemoteContentProviderDoneListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDoneWithRemoteContentProviders(value: XRemoteContentProviderAcceptor => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("doneWithRemoteContentProviders")(js.Any.fromFunction1(value))
        ret
    }
  }
