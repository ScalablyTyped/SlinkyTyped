...
object XProfileDiscover {
  ...
  implicit class XProfileDiscoverOps[Self <: XProfileDiscover] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDefaultProfile(value: MozillaProductType => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDefaultProfile")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetProfileCount(value: MozillaProductType => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getProfileCount")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetProfileExists(value: (MozillaProductType, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getProfileExists")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetProfileList(value: (MozillaProductType, js.Array[SeqEquiv[String]]) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getProfileList")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetProfilePath(value: (MozillaProductType, String) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getProfilePath")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withIsProfileLocked(value: (MozillaProductType, String) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isProfileLocked")(js.Any.fromFunction2(value))
        ret
    }
  }
