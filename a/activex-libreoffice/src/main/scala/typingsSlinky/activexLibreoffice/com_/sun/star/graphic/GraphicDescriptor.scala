...
object GraphicDescriptor {
  ...
  implicit class GraphicDescriptorOps[Self <: GraphicDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGraphicType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GraphicType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSize100thMM(value: Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Size100thMM")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withSizePixel(value: Size): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SizePixel")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
