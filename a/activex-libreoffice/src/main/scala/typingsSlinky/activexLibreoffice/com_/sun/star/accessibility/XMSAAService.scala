...
object XMSAAService {
  ...
  implicit class XMSAAServiceOps[Self <: XMSAAService] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAccObjectPtr(value: (Double, Double, Double) => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAccObjectPtr")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withHandleWindowOpened(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("handleWindowOpened")(js.Any.fromFunction1(value))
        ret
    }
  }
