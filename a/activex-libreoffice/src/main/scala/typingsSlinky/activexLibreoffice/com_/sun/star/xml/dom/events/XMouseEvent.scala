...
object XMouseEvent {
  ...
  implicit class XMouseEventOps[Self <: XMouseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withRelatedTarget(value: XEventTarget): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetMetaKey(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMetaKey")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRelatedTarget(value: () => XEventTarget): Self = {
        val ret = this.duplicate
    ...
    def withInitMouseEvent(
      value: (String, Boolean, Boolean, XAbstractView, Double, Double, Double, Double, Double, Boolean, Boolean, Boolean, Boolean, Double, XEventTarget) => Unit
        ...
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("initMouseEvent")(js.Any.fromFunction15(value))
        ret
    }
  }
