...
object EmbedMapUnits {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ONE_1000TH_INCH: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def ONE_100TH_INCH: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def ONE_100TH_MM: `0` = 0.asInstanceOf[`0`]
    
    @scala.inline
    def ONE_10TH_INCH: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def ONE_10TH_MM: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def ONE_CM: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def ONE_INCH: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def ONE_MM: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def PIXEL: `10` = 10.asInstanceOf[`10`]
