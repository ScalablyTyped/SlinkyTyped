...
object XParametricPolyPolygon2D {
  ...
  implicit class XParametricPolyPolygon2DOps[Self <: XParametricPolyPolygon2D] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetColor(value: Double => SafeArray[ColorComponent]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withGetOutline(value: Double => XPolyPolygon2D): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOutline")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetPointColor(value: RealPoint2D => SafeArray[ColorComponent]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getPointColor")(js.Any.fromFunction1(value))
        ret
    }
  }
