...
import typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XLayer
import typingsSlinky.activexLibreoffice.com_.sun.star.configuration.backend.XLayerHandler
