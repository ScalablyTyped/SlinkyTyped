...
object XExtendedTransliteration {
  ...
  implicit class XExtendedTransliterationOps[Self <: XExtendedTransliteration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTransliterateChar2Char(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transliterateChar2Char")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTransliterateChar2String(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transliterateChar2String")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withTransliterateString2String(value: (String, Double, Double) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("transliterateString2String")(js.Any.fromFunction3(value))
        ret
    }
  }
