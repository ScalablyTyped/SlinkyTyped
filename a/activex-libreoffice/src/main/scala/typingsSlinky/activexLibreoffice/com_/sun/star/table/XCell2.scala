...
object XCell2 {
  ...
  implicit class XCell2Ops[Self <: XCell2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSetFormulaResult(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFormulaResult")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSetFormulaString(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setFormulaString")(js.Any.fromFunction1(value))
        ret
    }
  }
