...
object ConditionalText {
  ...
  implicit class ConditionalTextOps[Self <: ConditionalText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFalseContent(value: String): Self = this.set("FalseContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setIsConditionTrue(value: Boolean): Self = this.set("IsConditionTrue", value.asInstanceOf[js.Any])
    @scala.inline
    def setTrueContent(value: String): Self = this.set("TrueContent", value.asInstanceOf[js.Any])
  }
