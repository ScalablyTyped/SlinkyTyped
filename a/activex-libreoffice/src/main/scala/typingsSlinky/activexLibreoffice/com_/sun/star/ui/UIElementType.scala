...
object UIElementType {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def COUNT: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def DOCKINGWINDOW: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def FLOATINGWINDOW: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def MENUBAR: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def POPUPMENU: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def PROGRESSBAR: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def STATUSBAR: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def TOOLBAR: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def TOOLPANEL: `7` = 7.asInstanceOf[`7`]
