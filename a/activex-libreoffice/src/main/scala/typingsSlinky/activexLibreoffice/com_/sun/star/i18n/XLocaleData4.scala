...
object XLocaleData4 {
  ...
  implicit class XLocaleData4Ops[Self <: XLocaleData4] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetDateAcceptancePatterns(value: Locale => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDateAcceptancePatterns")(js.Any.fromFunction1(value))
        ret
    }
  }
