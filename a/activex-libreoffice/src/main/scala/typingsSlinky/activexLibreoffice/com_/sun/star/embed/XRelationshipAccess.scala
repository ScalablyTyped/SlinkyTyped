...
object XRelationshipAccess {
  ...
  implicit class XRelationshipAccessOps[Self <: XRelationshipAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAllRelationships(value: SafeArray[SafeArray[StringPair]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AllRelationships")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withClearRelationships(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clearRelationships")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetAllRelationships(value: () => SafeArray[SafeArray[StringPair]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllRelationships")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRelationshipByID(value: String => SafeArray[StringPair]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRelationshipByID")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetRelationshipsByType(value: String => SafeArray[SafeArray[StringPair]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRelationshipsByType")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetTargetByID(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTargetByID")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetTypeByID(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTypeByID")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withHasByID(value: String => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("hasByID")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withInsertRelationshipByID(value: (String, SeqEquiv[StringPair], Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertRelationshipByID")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withInsertRelationships(value: (SeqEquiv[SeqEquiv[StringPair]], Boolean) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("insertRelationships")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withRemoveRelationshipByID(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeRelationshipByID")(js.Any.fromFunction1(value))
        ret
    }
  }
