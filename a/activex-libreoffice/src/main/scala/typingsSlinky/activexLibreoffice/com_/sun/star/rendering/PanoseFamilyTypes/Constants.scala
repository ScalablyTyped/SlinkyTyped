package typingsSlinky.activexLibreoffice.com_.sun.star.rendering.PanoseFamilyTypes
...
object Constants {
  ...
  @scala.inline
  def DECORATIVE: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def NO_FIT: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def PICTORIAL: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def SCRIPT: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def TEXT_DISPLAY: `2` = 2.asInstanceOf[`2`]
}
