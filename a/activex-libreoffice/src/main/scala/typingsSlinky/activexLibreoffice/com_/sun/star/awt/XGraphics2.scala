...
object XGraphics2 {
  ...
  implicit class XGraphics2Ops[Self <: XGraphics2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withClear(value: Rectangle => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("clear")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDrawImage(value: (Double, Double, Double, Double, Double, XGraphic) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("drawImage")(js.Any.fromFunction6(value))
        ret
    }
  }
