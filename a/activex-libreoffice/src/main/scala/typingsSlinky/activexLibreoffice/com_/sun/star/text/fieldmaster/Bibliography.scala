...
object Bibliography {
  ...
  implicit class BibliographyOps[Self <: Bibliography] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBracketAfter(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BracketAfter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withBracketBefore(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BracketBefore")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsNumberEntries(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsNumberEntries")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIsSortByPosition(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IsSortByPosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSortKeys(value: SafeArray[PropertyValues]): Self = {
        val ret = this.duplicate
