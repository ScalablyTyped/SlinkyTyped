...
object XMenuProxy {
  ...
  implicit class XMenuProxyOps[Self <: XMenuProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddMenuProxyListener(value: XMenuProxyListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addMenuProxyListener")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withExecuteMenuItem(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("executeMenuItem")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withRemoveMenuProxyListener(value: XMenuProxyListener => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("removeMenuProxyListener")(js.Any.fromFunction1(value))
        ret
    }
  }
