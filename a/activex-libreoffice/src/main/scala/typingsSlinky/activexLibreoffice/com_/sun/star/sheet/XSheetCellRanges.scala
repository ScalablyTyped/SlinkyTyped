...
object XSheetCellRanges {
  ...
  implicit class XSheetCellRangesOps[Self <: XSheetCellRanges] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCells(value: XEnumerationAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Cells")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRangeAddresses(value: SafeArray[CellRangeAddress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RangeAddresses")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRangeAddressesAsString(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RangeAddressesAsString")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetCells(value: () => XEnumerationAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getCells")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRangeAddresses(value: () => SafeArray[CellRangeAddress]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRangeAddresses")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetRangeAddressesAsString(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getRangeAddressesAsString")(js.Any.fromFunction0(value))
        ret
    }
  }
