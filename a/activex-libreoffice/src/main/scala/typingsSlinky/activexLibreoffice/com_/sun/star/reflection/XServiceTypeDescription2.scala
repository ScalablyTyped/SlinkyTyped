...
object XServiceTypeDescription2 {
  ...
  implicit class XServiceTypeDescription2Ops[Self <: XServiceTypeDescription2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConstructors(value: SafeArray[XServiceConstructorDescription]): Self = {
    ...
    @scala.inline
    def withGetConstructors(value: () => SafeArray[XServiceConstructorDescription]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getConstructors")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withIsSingleInterfaceBased(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isSingleInterfaceBased")(js.Any.fromFunction0(value))
        ret
    }
  }
