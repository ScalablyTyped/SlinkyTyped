...
object XStatisticDisplay {
  ...
  implicit class XStatisticDisplayOps[Self <: XStatisticDisplay] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDownBar(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DownBar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinMaxLine(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinMaxLine")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUpBar(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UpBar")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDownBar(value: () => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDownBar")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetMinMaxLine(value: () => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getMinMaxLine")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetUpBar(value: () => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getUpBar")(js.Any.fromFunction0(value))
        ret
    }
  }
