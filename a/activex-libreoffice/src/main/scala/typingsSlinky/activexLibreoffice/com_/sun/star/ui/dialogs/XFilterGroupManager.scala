...
object XFilterGroupManager {
  ...
  implicit class XFilterGroupManagerOps[Self <: XFilterGroupManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppendFilterGroup(value: (String, SeqEquiv[StringPair]) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("appendFilterGroup")(js.Any.fromFunction2(value))
        ret
    }
  }
