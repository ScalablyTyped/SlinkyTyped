...
import typingsSlinky.activexLibreoffice.com_.sun.star.chart.X3DDefaultSetter
...
trait Diagram
  ...
  var RelativeSize: typingsSlinky.activexLibreoffice.com_.sun.star.chart2.RelativeSize = js.native
...
object Diagram {
  ...
  implicit class DiagramOps[Self <: Diagram] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConnectBars(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConnectBars")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataTableHBorder(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataTableHBorder")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataTableOutline(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataTableOutline")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDataTableVBorder(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataTableVBorder")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withExternalData(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ExternalData")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGroupBarsPerAxis(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("GroupBarsPerAxis")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withPosSizeExcludeLabels(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PosSizeExcludeLabels")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRelativePosition(value: RelativePosition): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RelativePosition")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRelativeSize(value: RelativeSize): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RelativeSize")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRightAngledAxes(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RightAngledAxes")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSortByXValues(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("SortByXValues")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
