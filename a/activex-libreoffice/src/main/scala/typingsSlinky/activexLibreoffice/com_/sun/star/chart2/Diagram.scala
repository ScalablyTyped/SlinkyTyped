...
trait Diagram
  ...
  /**
    ...
    */
  var RelativePosition: typingsSlinky.activexLibreoffice.com_.sun.star.chart2.RelativePosition
  /** The size of the diagram as relative size of the page size. */
  var RelativeSize: typingsSlinky.activexLibreoffice.com_.sun.star.chart2.RelativeSize
