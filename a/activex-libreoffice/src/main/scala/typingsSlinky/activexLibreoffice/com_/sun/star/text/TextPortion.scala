...
object TextPortion {
  ...
  implicit class TextPortionOps[Self <: TextPortion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBookmark(value: XTextContent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Bookmark")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withControlCharacter(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ControlCharacter")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDocumentIndexMark(value: XTextContent): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInContentMetadata(value: XTextContent): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("InContentMetadata")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withTextField(value: XTextField): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextField")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTextPortionType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("TextPortionType")(value.asInstanceOf[js.Any])
        ret
    }
  }
