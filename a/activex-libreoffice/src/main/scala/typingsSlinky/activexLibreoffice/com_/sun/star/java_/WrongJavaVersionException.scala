...
object WrongJavaVersionException {
  ...
  implicit class WrongJavaVersionExceptionOps[Self <: WrongJavaVersionException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDetectedVersion(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DetectedVersion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHighestSupportedVersion(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HighestSupportedVersion")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withLowestSupportedVersion(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LowestSupportedVersion")(value.asInstanceOf[js.Any])
        ret
    }
  }
