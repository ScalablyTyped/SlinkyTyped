...
object EmbeddedObjectDescriptor {
  ...
  implicit class EmbeddedObjectDescriptorOps[Self <: EmbeddedObjectDescriptor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOutplaceDispatchInterceptor(value: XDispatchProviderInterceptor): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OutplaceDispatchInterceptor")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRecoveryStorage(value: XStorage): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RecoveryStorage")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withStoreVisualReplacement(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("StoreVisualReplacement")(value.asInstanceOf[js.Any])
        ret
    }
  }
