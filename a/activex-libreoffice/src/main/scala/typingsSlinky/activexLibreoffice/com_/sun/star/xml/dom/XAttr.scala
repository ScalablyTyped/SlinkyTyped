...
object XAttr {
  ...
  implicit class XAttrOps[Self <: XAttr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOwnerElement(value: XElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("OwnerElement")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withGetOwnerElement(value: () => XElement): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOwnerElement")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withGetSpecified(value: () => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSpecified")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
