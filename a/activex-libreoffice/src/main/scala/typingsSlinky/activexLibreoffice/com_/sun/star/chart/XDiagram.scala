...
object XDiagram {
  ...
  implicit class XDiagramOps[Self <: XDiagram] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDiagramType(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DiagramType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetDataPointProperties(value: (Double, Double) => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataPointProperties")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetDataRowProperties(value: Double => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDataRowProperties")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetDiagramType(value: () => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getDiagramType")(js.Any.fromFunction0(value))
        ret
    }
  }
