...
import typingsSlinky.activexLibreoffice.com_.sun.star.view.XScreenCursor
...
object TextViewCursor {
  ...
  @scala.inline
  implicit class TextViewCursorOps[Self <: TextViewCursor] (val x: Self) extends AnyVal {
    @scala.inline
