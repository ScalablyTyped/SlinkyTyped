...
object UnoControlPatternFieldModel {
  ...
  implicit class UnoControlPatternFieldModelOps[Self <: UnoControlPatternFieldModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEditMask(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EditMask")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withLiteralMask(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("LiteralMask")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
