...
object DataFlavor {
  ...
  implicit class DataFlavorOps[Self <: DataFlavor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withDataType(value: `type`): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DataType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withHumanPresentableName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("HumanPresentableName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
