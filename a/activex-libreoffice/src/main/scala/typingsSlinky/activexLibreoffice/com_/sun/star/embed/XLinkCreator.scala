...
object XLinkCreator {
  ...
  implicit class XLinkCreatorOps[Self <: XLinkCreator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateInstanceLink(value: (XStorage, String, SeqEquiv[PropertyValue], SeqEquiv[PropertyValue]) => XInterface): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createInstanceLink")(js.Any.fromFunction4(value))
        ret
    }
  }
