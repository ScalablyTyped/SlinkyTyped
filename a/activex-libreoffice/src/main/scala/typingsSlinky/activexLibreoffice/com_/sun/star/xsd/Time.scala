...
trait Time extends XDataType {
  /**
    ...
    */
  var MaxExclusiveTime: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
  /**
    * specifies the inclusive upper bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-maxInclusive
    */
  var MaxInclusiveTime: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
  /**
    * specifies the exclusive lower bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-minExclusive
    */
  var MinExclusiveTime: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
  /**
    * specifies the inclusive lower bound for the value
    * @see http://www.w3.org/TR/xmlschema-2/#rf-minInclusive
    */
  var MinInclusiveTime: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time
}
