...
object Time {
  ...
  implicit class TimeOps[Self <: Time] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withMaxExclusiveTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaxExclusiveTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMaxInclusiveTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MaxInclusiveTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinExclusiveTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinExclusiveTime")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withMinInclusiveTime(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Time): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("MinInclusiveTime")(value.asInstanceOf[js.Any])
        ret
    }
  }
