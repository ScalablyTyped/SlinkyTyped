...
object XIndexEntrySupplier {
  ...
  implicit class XIndexEntrySupplierOps[Self <: XIndexEntrySupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetIndexCharacter(value: (String, Locale, String) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getIndexCharacter")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withGetIndexFollowPageWord(value: (Boolean, Locale) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getIndexFollowPageWord")(js.Any.fromFunction2(value))
        ret
    }
  }
