...
object ParagraphStyle {
  ...
  implicit class ParagraphStyleMutableBuilder[Self <: ParagraphStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParaBottomMarginRelative(value: Double): Self = StObject.set(x, "ParaBottomMarginRelative", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParaLeftMarginRelative(value: Double): Self = StObject.set(x, "ParaLeftMarginRelative", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParaRightMarginRelative(value: Double): Self = StObject.set(x, "ParaRightMarginRelative", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParaTopMarginRelative(value: Double): Self = StObject.set(x, "ParaTopMarginRelative", value.asInstanceOf[js.Any])
