...
object XMarkableStream {
  ...
  implicit class XMarkableStreamOps[Self <: XMarkableStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateMark(value: () => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createMark")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDeleteMark(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("deleteMark")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withJumpToFurthest(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("jumpToFurthest")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withJumpToMark(value: Double => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("jumpToMark")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOffsetToMark(value: Double => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("offsetToMark")(js.Any.fromFunction1(value))
        ret
    }
  }
