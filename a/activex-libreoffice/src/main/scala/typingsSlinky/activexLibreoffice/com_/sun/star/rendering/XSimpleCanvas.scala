...
trait XSimpleCanvas extends XInterface {
  ...
  val CurrentFillColor: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color
  /**
  ...
  val CurrentPenColor: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color
  ...
  /**
    ...
    */
  val FontMetrics: typingsSlinky.activexLibreoffice.com_.sun.star.rendering.FontMetrics
  /**
  ...
  /** Retrieve color currently used for fills */
  def getCurrentFillColor(): typingsSlinky.activexLibreoffice.com_.sun.star.util.Color
  /**
    * Retrieve currently selected font.
    * @returns the font instance that's currently used for rendering text.
    */
  ...
  /** Retrieve color currently used for lines. */
  def getCurrentPenColor(): typingsSlinky.activexLibreoffice.com_.sun.star.util.Color
  /**
  ...
  /**
    ...
    * @returns the font metrics of the currently selected font.
    */
  def getFontMetrics(): typingsSlinky.activexLibreoffice.com_.sun.star.rendering.FontMetrics
  /**
    * Select a font.
    *
  ...
  /**
    ...
    */
  def setFillColor(nsRgbaColor: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Unit
  /**
    ...
    * @param nsRgbaColor RGBA color tuple, interpreted in the sRGB color space.
    */
  def setPenColor(nsRgbaColor: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Unit
