...
object XSimpleCanvas {
  ...
  implicit class XSimpleCanvasOps[Self <: XSimpleCanvas] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentFillColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = this.set("CurrentFillColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentFont(value: XCanvasFont): Self = this.set("CurrentFont", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentPenColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = this.set("CurrentPenColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetCurrentFillColor(value: () => typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = this.set("getCurrentFillColor", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetCurrentFont(value: () => XCanvasFont): Self = this.set("getCurrentFont", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetCurrentPenColor(value: () => typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = this.set("getCurrentPenColor", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetFillColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color => Unit): Self = this.set("setFillColor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetPenColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color => Unit): Self = this.set("setPenColor", js.Any.fromFunction1(value))
