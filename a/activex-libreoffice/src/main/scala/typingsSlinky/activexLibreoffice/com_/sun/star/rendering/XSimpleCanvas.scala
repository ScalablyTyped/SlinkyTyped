...
object XSimpleCanvas {
  ...
  implicit class XSimpleCanvasMutableBuilder[Self <: XSimpleCanvas] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentFillColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = StObject.set(x, "CurrentFillColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentFont(value: XCanvasFont): Self = StObject.set(x, "CurrentFont", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurrentPenColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = StObject.set(x, "CurrentPenColor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGetCurrentFillColor(value: () => typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = StObject.set(x, "getCurrentFillColor", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetCurrentFont(value: () => XCanvasFont): Self = StObject.set(x, "getCurrentFont", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetCurrentPenColor(value: () => typingsSlinky.activexLibreoffice.com_.sun.star.util.Color): Self = StObject.set(x, "getCurrentPenColor", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetFillColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color => Unit): Self = StObject.set(x, "setFillColor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSetPenColor(value: typingsSlinky.activexLibreoffice.com_.sun.star.util.Color => Unit): Self = StObject.set(x, "setPenColor", js.Any.fromFunction1(value))
