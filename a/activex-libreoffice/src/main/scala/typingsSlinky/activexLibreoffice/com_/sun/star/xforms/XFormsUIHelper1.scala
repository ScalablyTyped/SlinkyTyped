...
trait XFormsUIHelper1 extends js.Object {
  ...
  def newModel(xModel: typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, sName: String): XModel
  ...
  def removeModel(xModel: typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, sName: String): Unit
  def renameInstance(sFrom: String, sTo: String, sURL: String, bURLOnce: Boolean): Unit
  def renameModel(xModel: typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, sFrom: String, sTo: String): Unit
