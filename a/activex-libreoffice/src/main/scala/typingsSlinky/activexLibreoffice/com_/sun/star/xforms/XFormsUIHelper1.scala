...
object XFormsUIHelper1 {
  ...
  implicit class XFormsUIHelper1Ops[Self <: XFormsUIHelper1] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String) => XModel): Self = this.set("newModel", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setRemoveModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String) => Unit): Self = this.set("removeModel", js.Any.fromFunction2(value))
    @scala.inline
    def setRenameInstance(value: (String, String, String, Boolean) => Unit): Self = this.set("renameInstance", js.Any.fromFunction4(value))
    @scala.inline
    def setRenameModel(value: (typingsSlinky.activexLibreoffice.com_.sun.star.frame.XModel, String, String) => Unit): Self = this.set("renameModel", js.Any.fromFunction3(value))
    @scala.inline
