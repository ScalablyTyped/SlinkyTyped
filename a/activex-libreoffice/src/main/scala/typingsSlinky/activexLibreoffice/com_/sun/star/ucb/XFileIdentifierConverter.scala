...
object XFileIdentifierConverter {
  ...
  implicit class XFileIdentifierConverterOps[Self <: XFileIdentifierConverter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetFileProviderLocality(value: String => Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFileProviderLocality")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetFileURLFromSystemPath(value: (String, String) => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFileURLFromSystemPath")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withGetSystemPathFromFileURL(value: String => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getSystemPathFromFileURL")(js.Any.fromFunction1(value))
        ret
    }
  }
