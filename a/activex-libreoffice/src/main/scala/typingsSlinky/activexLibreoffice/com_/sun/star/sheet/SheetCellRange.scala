...
import typingsSlinky.activexLibreoffice.com_.sun.star.chart.XChartDataArray
...
import typingsSlinky.activexLibreoffice.com_.sun.star.table.XAutoFormattable
...
import typingsSlinky.activexLibreoffice.com_.sun.star.util.XImportable
import typingsSlinky.activexLibreoffice.com_.sun.star.util.XIndent
import typingsSlinky.activexLibreoffice.com_.sun.star.util.XMergeable
...
object SheetCellRange {
  ...
  @scala.inline
  implicit class SheetCellRangeOps[Self <: SheetCellRange] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withAbsoluteName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AbsoluteName")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withConditionalFormat(value: XSheetConditionalEntries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConditionalFormat")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withConditionalFormatLocal(value: XSheetConditionalEntries): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ConditionalFormatLocal")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withValidation(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Validation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withValidationLocal(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ValidationLocal")(value.asInstanceOf[js.Any])
        ret
    }
  }
