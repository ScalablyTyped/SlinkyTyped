...
package object java_ {
  /**
    ...
    * @since OOo 2.0
    */
  type InvalidJavaSettingsException = typingsSlinky.activexLibreoffice.com_.sun.star.java_.JavaInitializationException
  /**
    ...
    * @since OOo 1.1.2
    */
  type JavaDisabledException = typingsSlinky.activexLibreoffice.com_.sun.star.java_.JavaInitializationException
  /**
    ...
    * @since OOo 1.1.2
    */
  type JavaInitializationException = typingsSlinky.activexLibreoffice.com_.sun.star.uno.DeploymentException
  /**
    ...
    * @since OOo 1.1.2
    */
  type JavaNotConfiguredException = typingsSlinky.activexLibreoffice.com_.sun.star.java_.JavaInitializationException
  /**
    * indicates that no suitable JRE was found.
    * @since OOo 2.0
    */
  type JavaNotFoundException = typingsSlinky.activexLibreoffice.com_.sun.star.java_.JavaInitializationException
  /**
    ...
    */
  type JavaVirtualMachine = typingsSlinky.activexLibreoffice.com_.sun.star.java_.XJavaVM
  /**
    * indicates that the office must be restarted before a JRE can be used.
    * @since OOo 2.0
    */
  type RestartRequiredException = typingsSlinky.activexLibreoffice.com_.sun.star.java_.JavaInitializationException
}
