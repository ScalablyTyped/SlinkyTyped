...
trait XXPathExtension extends XInterface {
  val Libxml2ExtensionHandle: typingsSlinky.activexLibreoffice.com_.sun.star.xml.xpath.Libxml2ExtensionHandle
  def getLibxml2ExtensionHandle(): typingsSlinky.activexLibreoffice.com_.sun.star.xml.xpath.Libxml2ExtensionHandle
}
