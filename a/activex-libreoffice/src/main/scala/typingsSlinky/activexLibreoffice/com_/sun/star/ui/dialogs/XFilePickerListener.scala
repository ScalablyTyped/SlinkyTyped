...
object XFilePickerListener {
  ...
  @scala.inline
  implicit class XFilePickerListenerOps[Self <: XFilePickerListener] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withControlStateChanged(value: FilePickerEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("controlStateChanged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withDialogSizeChanged(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("dialogSizeChanged")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withDirectoryChanged(value: FilePickerEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("directoryChanged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withFileSelectionChanged(value: FilePickerEvent => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fileSelectionChanged")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withHelpRequested(value: FilePickerEvent => String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("helpRequested")(js.Any.fromFunction1(value))
        ret
    }
  }
