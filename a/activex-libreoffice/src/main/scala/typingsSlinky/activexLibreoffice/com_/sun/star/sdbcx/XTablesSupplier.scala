...
object XTablesSupplier {
  ...
  implicit class XTablesSupplierOps[Self <: XTablesSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withTables(value: XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Tables")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetTables(value: () => XNameAccess): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getTables")(js.Any.fromFunction0(value))
        ret
    }
  }
