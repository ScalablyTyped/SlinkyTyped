...
object XScannerManager2 {
  ...
  implicit class XScannerManager2Ops[Self <: XScannerManager2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withConfigureScannerAndScan(value: (js.Array[ScannerContext], XEventListener) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("configureScannerAndScan")(js.Any.fromFunction2(value))
        ret
    }
  }
