...
object XOrdinalSuffix {
  ...
  implicit class XOrdinalSuffixOps[Self <: XOrdinalSuffix] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetOrdinalSuffix(value: (Double, Locale) => SafeArray[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getOrdinalSuffix")(js.Any.fromFunction2(value))
        ret
    }
  }
