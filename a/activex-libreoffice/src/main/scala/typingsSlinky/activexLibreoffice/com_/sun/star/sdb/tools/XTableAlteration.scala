...
object XTableAlteration {
  ...
  implicit class XTableAlterationOps[Self <: XTableAlteration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAddColumn(value: (XPropertySet, XPropertySet) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("addColumn")(js.Any.fromFunction2(value))
        ret
    }
    @scala.inline
    def withAlterColumnByName(value: (XPropertySet, String, XPropertySet) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("alterColumnByName")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withDropColumn(value: (XPropertySet, String) => Unit): Self = {
        val ret = this.duplicate
