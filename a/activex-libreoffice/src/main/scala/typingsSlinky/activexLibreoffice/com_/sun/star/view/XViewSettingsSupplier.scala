...
object XViewSettingsSupplier {
  ...
  implicit class XViewSettingsSupplierOps[Self <: XViewSettingsSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withViewSettings(value: XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ViewSettings")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetViewSettings(value: () => XPropertySet): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getViewSettings")(js.Any.fromFunction0(value))
        ret
    }
  }
