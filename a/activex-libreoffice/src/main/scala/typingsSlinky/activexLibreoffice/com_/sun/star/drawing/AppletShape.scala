...
object AppletShape {
  ...
  implicit class AppletShapeOps[Self <: AppletShape] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAppletCode(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppletCode")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppletCodeBase(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppletCodeBase")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppletCommands(value: SafeArray[PropertyValue]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppletCommands")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppletIsScript(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppletIsScript")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAppletName(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AppletName")(value.asInstanceOf[js.Any])
        ret
    }
  }
