package typingsSlinky.activexLibreoffice.com_.sun.star.form.submission
...
object XSubmissionSupplier {
  ...
  implicit class XSubmissionSupplierOps[Self <: XSubmissionSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withSubmission(value: XSubmission): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Submission")(value.asInstanceOf[js.Any])
        ret
    }
  }
