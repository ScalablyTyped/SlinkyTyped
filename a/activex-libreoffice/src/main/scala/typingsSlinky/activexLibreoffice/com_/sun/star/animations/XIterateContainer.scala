...
object XIterateContainer {
  ...
  implicit class XIterateContainerOps[Self <: XIterateContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withIterateInterval(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IterateInterval")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withIterateType(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("IterateType")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
