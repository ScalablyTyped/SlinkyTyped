...
import typingsSlinky.activexLibreoffice.com_.sun.star.awt.XImageProducer
...
object XImageProducerSupplier {
  ...
  implicit class XImageProducerSupplierOps[Self <: XImageProducerSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withImageProducer(value: XImageProducer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ImageProducer")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withGetImageProducer(value: () => XImageProducer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getImageProducer")(js.Any.fromFunction0(value))
        ret
    }
  }
