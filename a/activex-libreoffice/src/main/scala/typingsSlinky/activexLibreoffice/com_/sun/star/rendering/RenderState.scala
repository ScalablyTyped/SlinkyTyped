...
object RenderState {
  ...
  implicit class RenderStateOps[Self <: RenderState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCompositeOperation(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("CompositeOperation")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withDeviceColor(value: SafeArray[ColorComponent]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("DeviceColor")(value.asInstanceOf[js.Any])
        ret
    }
  }
