...
import typingsSlinky.activexLibreoffice.com_.sun.star.form.binding.XListEntrySource
import typingsSlinky.activexLibreoffice.com_.sun.star.form.validation.XValidator
import typingsSlinky.activexLibreoffice.com_.sun.star.form.validation.XValidityConstraintListener
...
object Binding {
  ...
  implicit class BindingOps[Self <: Binding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBindingNamespaces(value: XNameContainer): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("BindingNamespaces")(value.asInstanceOf[js.Any])
        ret
    }
  }
