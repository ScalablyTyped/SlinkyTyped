...
object XStringResourcePersistence {
  ...
  implicit class XStringResourcePersistenceOps[Self <: XStringResourcePersistence] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExportBinary(value: () => SafeArray[Double]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("exportBinary")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withImportBinary(value: SeqEquiv[Double] => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("importBinary")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withSetComment(value: String => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("setComment")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withStoreToStorage(value: (XStorage, String, String) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("storeToStorage")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withStoreToURL(value: (String, String, String, XInteractionHandler) => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("storeToURL")(js.Any.fromFunction4(value))
        ret
    }
  }
