...
object XPrinter {
  ...
  implicit class XPrinterOps[Self <: XPrinter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEndPage(value: () => Unit): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("endPage")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withStart(value: (String, Double, Boolean) => Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("start")(js.Any.fromFunction3(value))
        ret
    }
    @scala.inline
    def withStartPage(value: () => XDevice): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("startPage")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
