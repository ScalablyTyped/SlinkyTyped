...
object UndoManagerEvent {
  ...
  implicit class UndoManagerEventOps[Self <: UndoManagerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withUndoActionTitle(value: String): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UndoActionTitle")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUndoContextDepth(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("UndoContextDepth")(value.asInstanceOf[js.Any])
        ret
    }
  }
