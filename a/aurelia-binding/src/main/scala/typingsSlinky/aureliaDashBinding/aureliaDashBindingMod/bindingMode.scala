...
object bindingMode extends js.Object {
  ...
  /* 3 */ val fromView: typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.bindingMode.fromView with Double = js.native
  /* 0 */ val oneTime: typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.bindingMode.oneTime with Double = js.native
  /* 1 */ val oneWay: typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.bindingMode.oneWay with Double = js.native
  /* 1 */ val toView: typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.bindingMode.toView with Double = js.native
  /* 2 */ val twoWay: typingsSlinky.aureliaDashBinding.aureliaDashBindingMod.bindingMode.twoWay with Double = js.native
  @JSBracketAccess
