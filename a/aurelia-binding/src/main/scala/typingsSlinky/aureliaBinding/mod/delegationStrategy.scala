...
object delegationStrategy extends StObject {
  ...
  /* 2 */ val bubbling: typingsSlinky.aureliaBinding.mod.delegationStrategy.bubbling with Double = js.native
  ...
  /* 1 */ val capturing: typingsSlinky.aureliaBinding.mod.delegationStrategy.capturing with Double = js.native
  ...
  /* 0 */ val none: typingsSlinky.aureliaBinding.mod.delegationStrategy.none with Double = js.native
}
