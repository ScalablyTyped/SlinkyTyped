...
object ObjectObservationAdapter {
  ...
  implicit class ObjectObservationAdapterMutableBuilder[Self <: ObjectObservationAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetObserver(value: (js.Any, String, js.PropertyDescriptor) => js.UndefOr[InternalPropertyObserver | Null]): Self = StObject.set(x, "getObserver", js.Any.fromFunction3(value))
  }
}
