...
object ObjectObservationAdapter {
  ...
  implicit class ObjectObservationAdapterOps[Self <: ObjectObservationAdapter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetObserver(value: (js.Any, String, js.PropertyDescriptor) => js.UndefOr[InternalPropertyObserver | Null]): Self = this.set("getObserver", js.Any.fromFunction3(value))
  }
