...
class AmplitudeClient () extends js.Object {
  ...
  var Identify: Instantiable0[typingsSlinky.amplitudeDashJs.amplitudeDashJsMod.Identify] = js.native
  var Revenue: Instantiable0[typingsSlinky.amplitudeDashJs.amplitudeDashJsMod.Revenue] = js.native
