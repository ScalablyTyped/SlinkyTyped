...
object Carrier {
  ...
  def apply(
    ...
    if (!js.isUndefined(carrier)) __obj.updateDynamic("carrier")(carrier.get.asInstanceOf[js.Any])
    if (!js.isUndefined(city)) __obj.updateDynamic("city")(city.get.asInstanceOf[js.Any])
    if (!js.isUndefined(country)) __obj.updateDynamic("country")(country.get.asInstanceOf[js.Any])
    if (!js.isUndefined(device_manufacturer)) __obj.updateDynamic("device_manufacturer")(device_manufacturer.get.asInstanceOf[js.Any])
    if (!js.isUndefined(device_model)) __obj.updateDynamic("device_model")(device_model.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dma)) __obj.updateDynamic("dma")(dma.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ip_address)) __obj.updateDynamic("ip_address")(ip_address.get.asInstanceOf[js.Any])
    if (!js.isUndefined(language)) __obj.updateDynamic("language")(language.get.asInstanceOf[js.Any])
    if (!js.isUndefined(os_name)) __obj.updateDynamic("os_name")(os_name.get.asInstanceOf[js.Any])
    if (!js.isUndefined(os_version)) __obj.updateDynamic("os_version")(os_version.get.asInstanceOf[js.Any])
    if (!js.isUndefined(platform)) __obj.updateDynamic("platform")(platform.get.asInstanceOf[js.Any])
    if (!js.isUndefined(region)) __obj.updateDynamic("region")(region.get.asInstanceOf[js.Any])
    if (!js.isUndefined(version_name)) __obj.updateDynamic("version_name")(version_name.get.asInstanceOf[js.Any])
