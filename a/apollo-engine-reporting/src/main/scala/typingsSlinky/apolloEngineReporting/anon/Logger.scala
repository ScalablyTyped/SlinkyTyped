...
trait Logger extends js.Object {
  var logger: js.UndefOr[typingsSlinky.apolloServerTypes.mod.Logger] = js.native
...
object Logger {
  ...
  implicit class LoggerOps[Self <: Logger] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLogger(value: typingsSlinky.apolloServerTypes.mod.Logger): Self = this.set("logger", value.asInstanceOf[js.Any])
    @scala.inline
