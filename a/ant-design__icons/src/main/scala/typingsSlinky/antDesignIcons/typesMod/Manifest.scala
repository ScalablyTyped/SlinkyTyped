...
object Manifest {
  ...
  implicit class ManifestOps[Self <: Manifest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withFill(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("fill")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOutline(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("outline")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withTwotone(value: js.Array[String]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("twotone")(value.asInstanceOf[js.Any])
        ret
    }
  }
