...
import typingsSlinky.antDesignIcons.anon.PrimaryColor
...
object HelperRenderOptions {
  @scala.inline
  def apply(extraSVGAttrs: StringDictionary[String] = null, placeholders: PrimaryColor = null): HelperRenderOptions = {
