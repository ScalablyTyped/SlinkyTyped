...
object twoTonePrimaryColorMod {
  ...
  @JSImport("@ant-design/icons/dist/components/twoTonePrimaryColor", "getTwoToneColor")
  @js.native
  def getTwoToneColor(): TwoToneColor = js.native
  
  @JSImport("@ant-design/icons/dist/components/twoTonePrimaryColor", "setTwoToneColor")
  @js.native
