...
import typingsSlinky.antDesignIcons.anon.PickIconComponentPropsari
...
object Dist {
  ...
  @JSImport("@ant-design/icons/dist", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: Dist.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickIconComponentPropsari): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
