package typingsSlinky.ansiDashStyles

import typingsSlinky.ansiDashStyles.escapeDashCodeMod.EscapeCode.BackgroundColor
import typingsSlinky.ansiDashStyles.escapeDashCodeMod.EscapeCode.CodePair
import typingsSlinky.ansiDashStyles.escapeDashCodeMod.EscapeCode.Color
import typingsSlinky.ansiDashStyles.escapeDashCodeMod.EscapeCode.ColorType
import typingsSlinky.ansiDashStyles.escapeDashCodeMod.EscapeCode.Modifier
...
@js.native
object ansiDashStylesMod extends js.Object {
  ...
  val bgColor: BackgroundColor with ColorType with Anon_Close = js.native
  ...
  val color: Color with ColorType with Anon_Close = js.native
