...
import typingsSlinky.amapDashJsDashSdk.Anon_ContentOffset
import typingsSlinky.amapDashJsDashSdk.Anon_Name
...
class Marker () extends EventBindable {
  ...
  def getLabel(): Anon_ContentOffset = js.native
  ...
  def setLabel(label: Anon_ContentOffset): Unit = js.native
