...
class MarkerClusterer protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addMarker(marker: typingsSlinky.amapJsSdk.AMap.Marker): Unit = js.native
  /**
    * 添加一组需进行聚合的点标记
    */
  /* CompleteClass */
  override def addMarkers(markers: js.Array[typingsSlinky.amapJsSdk.AMap.Marker]): Unit = js.native
  /**
    * 从地图上彻底清除所有聚合点标记
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getMap(): typingsSlinky.amapJsSdk.AMap.Map = js.native
  /**
    * 获取该点聚合中的点标记集合
    */
  /* CompleteClass */
  override def getMarkers(): js.Array[typingsSlinky.amapJsSdk.AMap.Marker] = js.native
  /**
    * 获取地图中点标记的最大聚合级别
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeMarker(marker: typingsSlinky.amapJsSdk.AMap.Marker): Unit = js.native
  /**
    * 删除一组聚合的点标记
    * @param markers
    */
  /* CompleteClass */
  override def removeMarkers(markers: js.Array[typingsSlinky.amapJsSdk.AMap.Marker]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setMarkers(markers: js.Array[typingsSlinky.amapJsSdk.AMap.Marker]): Unit = js.native
  /**
    * 设置地图中点标记的最大聚合级别
    * @param zoom
    */
