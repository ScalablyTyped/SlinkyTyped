package typingsSlinky.awsSdkHttpSerialization.mod
...
trait DerivedHttpRequest extends js.Object {
  var body: js.UndefOr[js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String] = js.undefined
...
object DerivedHttpRequest {
  @scala.inline
  def apply(
    body: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String = null,
