...
import typingsSlinky.antvUtil.anon.Call
import typingsSlinky.antvUtil.anon.`0`
import typingsSlinky.antvUtil.cacheMod.default
import typingsSlinky.antvUtil.getRangeMod.RangeType
import typingsSlinky.antvUtil.groupByMod.ObjectType
import typingsSlinky.antvUtil.parseRadiusMod.RadiusType
import typingsSlinky.antvUtil.throttleMod.OptionsType
...
object mod extends js.Object {
  ...
  def pick[T](`object`: typingsSlinky.antvUtil.pickMod.ObjectType[T], keys: js.Array[String]): typingsSlinky.antvUtil.pickMod.ObjectType[T] = js.native
  ...
  def sortBy[T](arr: js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]], key: String): js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]] = js.native
  def sortBy[T](arr: js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]], key: js.Array[String]): js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]] = js.native
  def sortBy[T](arr: js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]], key: js.Function): js.Array[typingsSlinky.antvUtil.sortByMod.ObjectType[T]] = js.native
  
  def startsWith(arr: String, e: String): Boolean = js.native
  def startsWith[T](arr: js.Array[T], e: T): Boolean = js.native
  
  def substitute[T](str: String, o: typingsSlinky.antvUtil.substituteMod.ObjectType[T]): String = js.native
