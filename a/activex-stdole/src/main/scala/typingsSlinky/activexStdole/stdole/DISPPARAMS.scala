...
object DISPPARAMS {
  ...
  implicit class DISPPARAMSOps[Self <: DISPPARAMS] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCArgs(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cArgs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withCNamedArgs(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("cNamedArgs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRgdispidNamedArgs(value: Double): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rgdispidNamedArgs")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRgvarg(value: js.Any): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("rgvarg")(value.asInstanceOf[js.Any])
        ret
    }
  }
