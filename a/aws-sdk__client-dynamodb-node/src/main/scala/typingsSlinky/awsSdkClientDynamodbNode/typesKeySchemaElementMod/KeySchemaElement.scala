package typingsSlinky.awsSdkClientDynamodbNode.typesKeySchemaElementMod

import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.HASH
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.RANGE
...
object KeySchemaElement {
  ...
  implicit class KeySchemaElementOps[Self <: KeySchemaElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withKeyType(value: HASH | RANGE | String): Self = {
        val ret = this.duplicate
