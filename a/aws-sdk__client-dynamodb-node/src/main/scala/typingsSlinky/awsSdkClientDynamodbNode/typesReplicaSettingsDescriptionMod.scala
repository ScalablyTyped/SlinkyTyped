...
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsDescriptionMod.ReplicaGlobalSecondaryIndexSettingsDescription
...
object typesReplicaSettingsDescriptionMod {
  ...
  object ReplicaSettingsDescription {
    ...
    implicit class ReplicaSettingsDescriptionMutableBuilder[Self <: ReplicaSettingsDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReplicaGlobalSecondaryIndexSettingsIterable(value: js.Iterable[ReplicaGlobalSecondaryIndexSettingsDescription]): Self = StObject.set(x, "ReplicaGlobalSecondaryIndexSettings", value.asInstanceOf[js.Any])
