...
object UnmarshalledAttributeValue {
  ...
  implicit class UnmarshalledAttributeValueOps[Self <: UnmarshalledAttributeValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setB(value: js.typedarray.Uint8Array): Self = this.set("B", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteB: Self = this.set("B", js.undefined)
    
    @scala.inline
    def setBSVarargs(value: js.typedarray.Uint8Array*): Self = this.set("BS", js.Array(value :_*))
    
    @scala.inline
    def setBS(value: js.Array[js.typedarray.Uint8Array]): Self = this.set("BS", value.asInstanceOf[js.Any])
