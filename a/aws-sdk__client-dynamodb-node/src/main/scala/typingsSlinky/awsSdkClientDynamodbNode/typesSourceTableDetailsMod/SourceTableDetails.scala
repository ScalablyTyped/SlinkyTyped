package typingsSlinky.awsSdkClientDynamodbNode.typesSourceTableDetailsMod
...
object SourceTableDetails {
  ...
  implicit class SourceTableDetailsOps[Self <: SourceTableDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeySchemaIterable(value: js.Iterable[KeySchemaElement]): Self = this.set("KeySchema", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setKeySchema(value: js.Array[KeySchemaElement] | js.Iterable[KeySchemaElement]): Self = this.set("KeySchema", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProvisionedThroughput(value: ProvisionedThroughput): Self = this.set("ProvisionedThroughput", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTableCreationDateTimeDate(value: js.Date): Self = this.set("TableCreationDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTableCreationDateTime(value: js.Date | String | Double): Self = this.set("TableCreationDateTime", value.asInstanceOf[js.Any])
