...
object PointInTimeRecoveryDescription {
  ...
  implicit class PointInTimeRecoveryDescriptionOps[Self <: PointInTimeRecoveryDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEarliestRestorableDateTimeDate(value: js.Date): Self = this.set("EarliestRestorableDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setEarliestRestorableDateTime(value: js.Date | String | Double): Self = this.set("EarliestRestorableDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEarliestRestorableDateTime: Self = this.set("EarliestRestorableDateTime", js.undefined)
    @scala.inline
    def setLatestRestorableDateTimeDate(value: js.Date): Self = this.set("LatestRestorableDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setLatestRestorableDateTime(value: js.Date | String | Double): Self = this.set("LatestRestorableDateTime", value.asInstanceOf[js.Any])
    @scala.inline
