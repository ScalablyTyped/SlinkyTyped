...
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaDescriptionMod.ReplicaDescription
...
object typesGlobalTableDescriptionMod {
  ...
  object GlobalTableDescription {
    ...
    implicit class GlobalTableDescriptionMutableBuilder[Self <: GlobalTableDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCreationDateTime(value: js.Date | String | Double): Self = StObject.set(x, "CreationDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCreationDateTimeDate(value: js.Date): Self = StObject.set(x, "CreationDateTime", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setReplicationGroup(value: js.Array[ReplicaDescription] | js.Iterable[ReplicaDescription]): Self = StObject.set(x, "ReplicationGroup", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReplicationGroupIterable(value: js.Iterable[ReplicaDescription]): Self = StObject.set(x, "ReplicationGroup", value.asInstanceOf[js.Any])
