...
import typingsSlinky.awsSdkClientDynamodbNode.typesAttributeDefinitionMod.UnmarshalledAttributeDefinition
import typingsSlinky.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexDescriptionMod.GlobalSecondaryIndexDescription
import typingsSlinky.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexDescriptionMod.UnmarshalledGlobalSecondaryIndexDescription
...
import typingsSlinky.awsSdkClientDynamodbNode.typesLocalSecondaryIndexDescriptionMod.UnmarshalledLocalSecondaryIndexDescription
...
import typingsSlinky.awsSdkClientDynamodbNode.typesRestoreSummaryMod.UnmarshalledRestoreSummary
...
object typesTableDescriptionMod {
  ...
  object TableDescription {
    ...
    implicit class TableDescriptionMutableBuilder[Self <: TableDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndexDescription] | js.Iterable[GlobalSecondaryIndexDescription]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGlobalSecondaryIndexesIterable(value: js.Iterable[GlobalSecondaryIndexDescription]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndexDescription] | js.Iterable[LocalSecondaryIndexDescription]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLocalSecondaryIndexesIterable(value: js.Iterable[LocalSecondaryIndexDescription]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
