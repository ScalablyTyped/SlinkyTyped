...
object ProvisionedThroughputDescription {
  ...
  implicit class ProvisionedThroughputDescriptionOps[Self <: ProvisionedThroughputDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastDecreaseDateTimeDate(value: js.Date): Self = this.set("LastDecreaseDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastDecreaseDateTime(value: js.Date | String | Double): Self = this.set("LastDecreaseDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLastDecreaseDateTime: Self = this.set("LastDecreaseDateTime", js.undefined)
    @scala.inline
    def setLastIncreaseDateTimeDate(value: js.Date): Self = this.set("LastIncreaseDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setLastIncreaseDateTime(value: js.Date | String | Double): Self = this.set("LastIncreaseDateTime", value.asInstanceOf[js.Any])
    @scala.inline
