package typingsSlinky.awsSdkClientDynamodbNode.typesReplicaSettingsDescriptionMod
...
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsDescriptionMod.UnmarshalledReplicaGlobalSecondaryIndexSettingsDescription
