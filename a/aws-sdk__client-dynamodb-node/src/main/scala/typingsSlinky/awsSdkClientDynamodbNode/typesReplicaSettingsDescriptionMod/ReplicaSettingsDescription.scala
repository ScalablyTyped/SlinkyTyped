...
object ReplicaSettingsDescription {
  ...
  implicit class ReplicaSettingsDescriptionOps[Self <: ReplicaSettingsDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicaGlobalSecondaryIndexSettingsIterable(value: js.Iterable[ReplicaGlobalSecondaryIndexSettingsDescription]): Self = this.set("ReplicaGlobalSecondaryIndexSettings", value.asInstanceOf[js.Any])
    @scala.inline
