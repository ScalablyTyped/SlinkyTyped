...
object PutItemInput {
  ...
  implicit class PutItemInputOps[Self <: PutItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = this.set("Item", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItem(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = this.set("Item", value.asInstanceOf[js.Any])
