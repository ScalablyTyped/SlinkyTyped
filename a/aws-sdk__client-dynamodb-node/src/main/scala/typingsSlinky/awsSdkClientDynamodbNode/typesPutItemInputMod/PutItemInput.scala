package typingsSlinky.awsSdkClientDynamodbNode.typesPutItemInputMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_NEW
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_OLD
...
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.SIZE
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.TOTAL
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.UPDATED_NEW
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.UPDATED_OLD
import typingsSlinky.awsSdkClientDynamodbNode.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientDynamodbNode.typesAttributeValueMod.AttributeValue
import typingsSlinky.awsSdkClientDynamodbNode.typesExpectedAttributeValueMod.ExpectedAttributeValue
...
trait PutItemInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var Item: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]]) = js.native
  /**
...
object PutItemInput {
  ...
  implicit class PutItemInputOps[Self <: PutItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItemIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Item")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withItem(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("Item")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withExpectedIterable(value: js.Iterable[js.Tuple2[String, ExpectedAttributeValue]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReturnItemCollectionMetrics(value: SIZE | NONE | String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withReturnValues(value: NONE | ALL_OLD | UPDATED_OLD | ALL_NEW | UPDATED_NEW | String): Self = {
        val ret = this.duplicate
