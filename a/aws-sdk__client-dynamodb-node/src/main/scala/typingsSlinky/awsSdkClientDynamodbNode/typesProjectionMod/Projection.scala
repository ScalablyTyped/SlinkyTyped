...
import typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.INCLUDE
...
object Projection {
  ...
  implicit class ProjectionOps[Self <: Projection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNonKeyAttributesIterable(value: js.Iterable[String]): Self = this.set("NonKeyAttributes", value.asInstanceOf[js.Any])
    @scala.inline
    def setNonKeyAttributes(value: js.Array[String] | js.Iterable[String]): Self = this.set("NonKeyAttributes", value.asInstanceOf[js.Any])
    @scala.inline
