...
object ScanInput {
  ...
  def apply(
    ...
    AttributesToGet: js.Array[String] | js.Iterable[String] = null,
    ConditionalOperator: AND | OR | String = null,
    ConsistentRead: js.UndefOr[Boolean] = js.undefined,
    ExclusiveStartKey: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]]) = null,
    ExpressionAttributeNames: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]) = null,
    ExpressionAttributeValues: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]]) = null,
    FilterExpression: String = null,
    IndexName: String = null,
    Limit: js.UndefOr[Double] = js.undefined,
    ProjectionExpression: String = null,
    ReturnConsumedCapacity: INDEXES | TOTAL | NONE | String = null,
    ScanFilter: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]]) = null,
