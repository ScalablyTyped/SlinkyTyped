...
object ScanInput {
  ...
  implicit class ScanInputOps[Self <: ScanInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScanFilterIterable(value: js.Iterable[js.Tuple2[String, Condition]]): Self = this.set("ScanFilter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScanFilter(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = this.set("ScanFilter", value.asInstanceOf[js.Any])
