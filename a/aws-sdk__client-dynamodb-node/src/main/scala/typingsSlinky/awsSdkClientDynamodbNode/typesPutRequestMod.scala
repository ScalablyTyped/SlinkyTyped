...
object typesPutRequestMod {
  ...
  object PutRequest {
    ...
    implicit class PutRequestMutableBuilder[Self <: PutRequest] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItem(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
    }
  }
