...
object typesReplicaNotFoundExceptionMod {
  ...
  trait ReplicaNotFoundException
    ...
    var name: typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ReplicaNotFoundException = js.native
  }
  object ReplicaNotFoundException {
    ...
    implicit class ReplicaNotFoundExceptionMutableBuilder[Self <: ReplicaNotFoundException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(
        value: typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ReplicaNotFoundException
