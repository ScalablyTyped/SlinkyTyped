package typingsSlinky.awsSdkClientDynamodbNode.typesAutoScalingSettingsDescriptionMod

import typingsSlinky.awsSdkClientDynamodbNode.typesAutoScalingPolicyDescriptionMod.UnmarshalledAutoScalingPolicyDescription
