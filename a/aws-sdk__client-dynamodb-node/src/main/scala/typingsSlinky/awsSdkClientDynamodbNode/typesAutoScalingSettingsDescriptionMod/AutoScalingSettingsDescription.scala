...
object AutoScalingSettingsDescription {
  ...
  implicit class AutoScalingSettingsDescriptionOps[Self <: AutoScalingSettingsDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScalingPoliciesIterable(value: js.Iterable[AutoScalingPolicyDescription]): Self = this.set("ScalingPolicies", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScalingPolicies(value: js.Array[AutoScalingPolicyDescription] | js.Iterable[AutoScalingPolicyDescription]): Self = this.set("ScalingPolicies", value.asInstanceOf[js.Any])
