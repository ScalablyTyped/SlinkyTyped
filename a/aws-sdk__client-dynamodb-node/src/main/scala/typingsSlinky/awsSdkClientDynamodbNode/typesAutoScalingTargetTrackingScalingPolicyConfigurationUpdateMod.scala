...
object typesAutoScalingTargetTrackingScalingPolicyConfigurationUpdateMod {
  ...
  type UnmarshalledAutoScalingTargetTrackingScalingPolicyConfigurationUpdate = AutoScalingTargetTrackingScalingPolicyConfigurationUpdate
}
