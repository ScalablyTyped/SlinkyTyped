...
object typesUpdateItemInputMod {
  ...
  object UpdateItemInput {
    ...
    implicit class UpdateItemInputMutableBuilder[Self <: UpdateItemInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributeUpdatesIterable(value: js.Iterable[js.Tuple2[String, AttributeValueUpdate]]): Self = StObject.set(x, "AttributeUpdates", value.asInstanceOf[js.Any])
