...
object GlobalTableDescription {
  ...
  implicit class GlobalTableDescriptionOps[Self <: GlobalTableDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreationDateTimeDate(value: js.Date): Self = this.set("CreationDateTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreationDateTime(value: js.Date | String | Double): Self = this.set("CreationDateTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReplicationGroupIterable(value: js.Iterable[ReplicaDescription]): Self = this.set("ReplicationGroup", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReplicationGroup(value: js.Array[ReplicaDescription] | js.Iterable[ReplicaDescription]): Self = this.set("ReplicationGroup", value.asInstanceOf[js.Any])
