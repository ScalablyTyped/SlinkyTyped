...
trait PointInTimeRecoveryUnavailableException
  ...
  @JSName("name")
  var name_PointInTimeRecoveryUnavailableException: typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.PointInTimeRecoveryUnavailableException
}
