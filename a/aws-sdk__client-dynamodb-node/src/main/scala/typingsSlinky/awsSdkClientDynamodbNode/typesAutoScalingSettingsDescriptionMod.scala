...
import typingsSlinky.awsSdkClientDynamodbNode.typesAutoScalingPolicyDescriptionMod.AutoScalingPolicyDescription
...
object typesAutoScalingSettingsDescriptionMod {
  ...
  object AutoScalingSettingsDescription {
    ...
    implicit class AutoScalingSettingsDescriptionMutableBuilder[Self <: AutoScalingSettingsDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setScalingPolicies(value: js.Array[AutoScalingPolicyDescription] | js.Iterable[AutoScalingPolicyDescription]): Self = StObject.set(x, "ScalingPolicies", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setScalingPoliciesIterable(value: js.Iterable[AutoScalingPolicyDescription]): Self = StObject.set(x, "ScalingPolicies", value.asInstanceOf[js.Any])
