...
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaMod.UnmarshalledReplica
...
object typesGlobalTableMod {
  ...
  object GlobalTable {
    ...
    implicit class GlobalTableMutableBuilder[Self <: GlobalTable] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReplicationGroup(value: js.Array[Replica] | js.Iterable[Replica]): Self = StObject.set(x, "ReplicationGroup", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReplicationGroupIterable(value: js.Iterable[Replica]): Self = StObject.set(x, "ReplicationGroup", value.asInstanceOf[js.Any])
