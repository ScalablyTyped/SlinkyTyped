package typingsSlinky.awsSdkClientDynamodbNode.typesUpdateGlobalTableInputMod
...
object UpdateGlobalTableInput {
  ...
  implicit class UpdateGlobalTableInputOps[Self <: UpdateGlobalTableInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicaUpdatesIterable(value: js.Iterable[ReplicaUpdate]): Self = this.set("ReplicaUpdates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReplicaUpdates(value: js.Array[ReplicaUpdate] | js.Iterable[ReplicaUpdate]): Self = this.set("ReplicaUpdates", value.asInstanceOf[js.Any])
