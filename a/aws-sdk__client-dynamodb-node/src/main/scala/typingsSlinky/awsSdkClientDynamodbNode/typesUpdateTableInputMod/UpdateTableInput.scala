...
trait UpdateTableInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var SSESpecification: js.UndefOr[typingsSlinky.awsSdkClientDynamodbNode.typesSsespecificationMod.SSESpecification] = js.undefined
  /**
...
object UpdateTableInput {
  ...
  def apply(
    ...
    GlobalSecondaryIndexUpdates: js.Array[GlobalSecondaryIndexUpdate] | js.Iterable[GlobalSecondaryIndexUpdate] = null,
