package typingsSlinky.awsSdkClientDynamodbNode.typesUpdateTableInputMod

import typingsSlinky.awsSdkClientDynamodbNode.inputTypesUnionMod.InputTypesUnion
import typingsSlinky.awsSdkClientDynamodbNode.typesAttributeDefinitionMod.AttributeDefinition
import typingsSlinky.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexUpdateMod.GlobalSecondaryIndexUpdate
import typingsSlinky.awsSdkClientDynamodbNode.typesProvisionedThroughputMod.ProvisionedThroughput
import typingsSlinky.awsSdkClientDynamodbNode.typesSsespecificationMod.SSESpecification
...
trait UpdateTableInput extends InputTypesUnion {
  ...
  var ProvisionedThroughput: js.UndefOr[
    typingsSlinky.awsSdkClientDynamodbNode.typesProvisionedThroughputMod.ProvisionedThroughput
  ] = js.native
  
  /**
    * <p>The new server-side encryption settings for the specified table.</p>
    */
  var SSESpecification: js.UndefOr[typingsSlinky.awsSdkClientDynamodbNode.typesSsespecificationMod.SSESpecification] = js.native
...
object UpdateTableInput {
  ...
  implicit class UpdateTableInputOps[Self <: UpdateTableInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGlobalSecondaryIndexUpdatesIterable(value: js.Iterable[GlobalSecondaryIndexUpdate]): Self = this.set("GlobalSecondaryIndexUpdates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGlobalSecondaryIndexUpdates(value: js.Array[GlobalSecondaryIndexUpdate] | js.Iterable[GlobalSecondaryIndexUpdate]): Self = this.set("GlobalSecondaryIndexUpdates", value.asInstanceOf[js.Any])
