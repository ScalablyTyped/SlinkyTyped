package typingsSlinky.awsSdkClientDynamodbNode.typesCreateGlobalTableInputMod
...
object CreateGlobalTableInput {
  ...
  @scala.inline
  def apply(GlobalTableName: String, ReplicationGroup: js.Array[Replica] | js.Iterable[Replica]): CreateGlobalTableInput = {
  ...
  implicit class CreateGlobalTableInputOps[Self <: CreateGlobalTableInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplicationGroupIterable(value: js.Iterable[Replica]): Self = this.set("ReplicationGroup", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setReplicationGroup(value: js.Array[Replica] | js.Iterable[Replica]): Self = this.set("ReplicationGroup", value.asInstanceOf[js.Any])
