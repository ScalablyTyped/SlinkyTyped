package typingsSlinky.awsSdkClientDynamodbNode.typesUpdateItemInputMod
...
import typingsSlinky.awsSdkClientDynamodbNode.typesAttributeValueUpdateMod.AttributeValueUpdate
...
object UpdateItemInput {
  ...
  implicit class UpdateItemInputOps[Self <: UpdateItemInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withAttributeUpdatesIterable(value: js.Iterable[js.Tuple2[String, AttributeValueUpdate]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("AttributeUpdates")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withAttributeUpdates(
    ...
    @scala.inline
    def withUpdateExpression(value: String): Self = {
        val ret = this.duplicate
