package typingsSlinky.awsSdkClientDynamodbNode.typesTableDescriptionMod
...
import typingsSlinky.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexDescriptionMod.GlobalSecondaryIndexDescription
import typingsSlinky.awsSdkClientDynamodbNode.typesKeySchemaElementMod.KeySchemaElement
import typingsSlinky.awsSdkClientDynamodbNode.typesLocalSecondaryIndexDescriptionMod.LocalSecondaryIndexDescription
import typingsSlinky.awsSdkClientDynamodbNode.typesProvisionedThroughputDescriptionMod.ProvisionedThroughputDescription
import typingsSlinky.awsSdkClientDynamodbNode.typesRestoreSummaryMod.RestoreSummary
...
trait TableDescription extends js.Object {
  ...
  /**
    ...
    */
  var RestoreSummary: js.UndefOr[typingsSlinky.awsSdkClientDynamodbNode.typesRestoreSummaryMod.RestoreSummary] = js.native
  /**
  ...
  var StreamSpecification: js.UndefOr[
    typingsSlinky.awsSdkClientDynamodbNode.typesStreamSpecificationMod.StreamSpecification
  ] = js.native
  /**
...
object TableDescription {
  ...
  implicit class TableDescriptionOps[Self <: TableDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAttributeDefinitionsIterable(value: js.Iterable[AttributeDefinition]): Self = this.set("AttributeDefinitions", value.asInstanceOf[js.Any])
    @scala.inline
    def setAttributeDefinitions(value: js.Array[AttributeDefinition] | js.Iterable[AttributeDefinition]): Self = this.set("AttributeDefinitions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGlobalSecondaryIndexesIterable(value: js.Iterable[GlobalSecondaryIndexDescription]): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndexDescription] | js.Iterable[GlobalSecondaryIndexDescription]): Self = this.set("GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLocalSecondaryIndexesIterable(value: js.Iterable[LocalSecondaryIndexDescription]): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
    def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndexDescription] | js.Iterable[LocalSecondaryIndexDescription]): Self = this.set("LocalSecondaryIndexes", value.asInstanceOf[js.Any])
    @scala.inline
