...
object typesItemCollectionMetricsMod {
  ...
  object ItemCollectionMetrics {
    ...
    implicit class ItemCollectionMetricsMutableBuilder[Self <: ItemCollectionMetrics] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemCollectionKey(value: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]])): Self = StObject.set(x, "ItemCollectionKey", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemCollectionKeyIterable(value: js.Iterable[js.Tuple2[String, AttributeValue]]): Self = StObject.set(x, "ItemCollectionKey", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemCollectionKeyUndefined: Self = StObject.set(x, "ItemCollectionKey", js.undefined)
      
      @scala.inline
      def setSizeEstimateRangeGB(value: js.Array[Double] | js.Iterable[Double]): Self = StObject.set(x, "SizeEstimateRangeGB", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSizeEstimateRangeGBIterable(value: js.Iterable[Double]): Self = StObject.set(x, "SizeEstimateRangeGB", value.asInstanceOf[js.Any])
