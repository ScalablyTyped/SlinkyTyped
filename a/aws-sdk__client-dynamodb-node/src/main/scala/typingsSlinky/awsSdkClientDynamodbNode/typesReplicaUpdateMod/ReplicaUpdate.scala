...
import typingsSlinky.awsSdkClientDynamodbNode.typesCreateReplicaActionMod.CreateReplicaAction
import typingsSlinky.awsSdkClientDynamodbNode.typesDeleteReplicaActionMod.DeleteReplicaAction
