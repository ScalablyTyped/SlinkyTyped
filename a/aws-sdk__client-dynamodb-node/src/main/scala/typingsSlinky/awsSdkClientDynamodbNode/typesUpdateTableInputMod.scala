...
object typesUpdateTableInputMod {
  ...
  object UpdateTableInput {
    ...
    implicit class UpdateTableInputMutableBuilder[Self <: UpdateTableInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAttributeDefinitions(value: js.Array[AttributeDefinition] | js.Iterable[AttributeDefinition]): Self = StObject.set(x, "AttributeDefinitions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAttributeDefinitionsIterable(value: js.Iterable[AttributeDefinition]): Self = StObject.set(x, "AttributeDefinitions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setGlobalSecondaryIndexUpdates(value: js.Array[GlobalSecondaryIndexUpdate] | js.Iterable[GlobalSecondaryIndexUpdate]): Self = StObject.set(x, "GlobalSecondaryIndexUpdates", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGlobalSecondaryIndexUpdatesIterable(value: js.Iterable[GlobalSecondaryIndexUpdate]): Self = StObject.set(x, "GlobalSecondaryIndexUpdates", value.asInstanceOf[js.Any])
