...
trait CreateGlobalSecondaryIndexAction extends js.Object {
  ...
  /**
    ...
    */
  var Projection: typingsSlinky.awsSdkClientDynamodbNode.typesProjectionMod.Projection
  /**
    ...
    */
  var ProvisionedThroughput: typingsSlinky.awsSdkClientDynamodbNode.typesProvisionedThroughputMod.ProvisionedThroughput
}
