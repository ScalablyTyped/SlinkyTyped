...
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
import typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.UnmarshalledReplicaGlobalSecondaryIndexSettingsUpdate
...
object typesReplicaSettingsUpdateMod {
  ...
  trait ReplicaSettingsUpdate extends StObject {
    ...
    var ReplicaGlobalSecondaryIndexSettingsUpdate: js.UndefOr[
        (js.Array[
          typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
        ]) | (js.Iterable[
          typingsSlinky.awsSdkClientDynamodbNode.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
        ])
      ] = js.native
  ...
  object ReplicaSettingsUpdate {
    ...
    implicit class ReplicaSettingsUpdateMutableBuilder[Self <: ReplicaSettingsUpdate] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setReplicaGlobalSecondaryIndexSettingsUpdateIterable(value: js.Iterable[ReplicaGlobalSecondaryIndexSettingsUpdate]): Self = StObject.set(x, "ReplicaGlobalSecondaryIndexSettingsUpdate", value.asInstanceOf[js.Any])
