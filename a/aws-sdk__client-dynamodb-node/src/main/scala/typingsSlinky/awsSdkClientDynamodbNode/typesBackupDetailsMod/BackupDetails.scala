...
object BackupDetails {
  ...
  implicit class BackupDetailsOps[Self <: BackupDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackupCreationDateTimeDate(value: js.Date): Self = this.set("BackupCreationDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setBackupCreationDateTime(value: js.Date | String | Double): Self = this.set("BackupCreationDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setBackupExpiryDateTimeDate(value: js.Date): Self = this.set("BackupExpiryDateTime", value.asInstanceOf[js.Any])
    @scala.inline
    def setBackupExpiryDateTime(value: js.Date | String | Double): Self = this.set("BackupExpiryDateTime", value.asInstanceOf[js.Any])
    @scala.inline
