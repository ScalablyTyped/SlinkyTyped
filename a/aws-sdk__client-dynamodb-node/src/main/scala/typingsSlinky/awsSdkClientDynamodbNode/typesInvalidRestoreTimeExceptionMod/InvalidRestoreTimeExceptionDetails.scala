...
@js.native
trait InvalidRestoreTimeExceptionDetails extends js.Object {
  /**
    * _ErrorMessage shape
    */
...
object InvalidRestoreTimeExceptionDetails {
  ...
  @scala.inline
  implicit class InvalidRestoreTimeExceptionDetailsOps[Self <: InvalidRestoreTimeExceptionDetails] (val x: Self) extends AnyVal {
    @scala.inline
