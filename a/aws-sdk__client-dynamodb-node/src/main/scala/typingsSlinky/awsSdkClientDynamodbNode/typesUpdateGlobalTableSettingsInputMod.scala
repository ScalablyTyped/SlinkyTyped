...
object typesUpdateGlobalTableSettingsInputMod {
  ...
  object UpdateGlobalTableSettingsInput {
    ...
    implicit class UpdateGlobalTableSettingsInputMutableBuilder[Self <: UpdateGlobalTableSettingsInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGlobalTableGlobalSecondaryIndexSettingsUpdateIterable(value: js.Iterable[GlobalTableGlobalSecondaryIndexSettingsUpdate]): Self = StObject.set(x, "GlobalTableGlobalSecondaryIndexSettingsUpdate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setReplicaSettingsUpdate(value: js.Array[ReplicaSettingsUpdate] | js.Iterable[ReplicaSettingsUpdate]): Self = StObject.set(x, "ReplicaSettingsUpdate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setReplicaSettingsUpdateIterable(value: js.Iterable[ReplicaSettingsUpdate]): Self = StObject.set(x, "ReplicaSettingsUpdate", value.asInstanceOf[js.Any])
