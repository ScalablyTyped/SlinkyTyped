package typingsSlinky.awsSdkClientDynamodbNode.typesBatchWriteItemOutputMod
...
import typingsSlinky.awsSdkClientDynamodbNode.typesWriteRequestMod.UnmarshalledWriteRequest
...
object BatchWriteItemOutput {
  ...
  implicit class BatchWriteItemOutputOps[Self <: BatchWriteItemOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withItemCollectionMetrics(value: StringDictionary[js.Array[UnmarshalledItemCollectionMetrics]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withUnprocessedItems(value: StringDictionary[js.Array[UnmarshalledWriteRequest]]): Self = {
        val ret = this.duplicate
