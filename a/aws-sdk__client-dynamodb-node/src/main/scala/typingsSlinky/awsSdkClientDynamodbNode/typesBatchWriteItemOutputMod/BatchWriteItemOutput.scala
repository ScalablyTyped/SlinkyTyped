...
object BatchWriteItemOutput {
  ...
  def apply(
    ...
    ItemCollectionMetrics: StringDictionary[js.Array[UnmarshalledItemCollectionMetrics]] = null,
    UnprocessedItems: StringDictionary[js.Array[UnmarshalledWriteRequest]] = null
