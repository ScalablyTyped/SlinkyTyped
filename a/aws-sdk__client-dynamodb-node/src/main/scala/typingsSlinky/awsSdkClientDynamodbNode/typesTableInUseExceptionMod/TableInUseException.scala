...
trait TableInUseException
  ...
  @JSName("name")
  var name_TableInUseException: typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.TableInUseException = js.native
}
object TableInUseException {
  ...
  implicit class TableInUseExceptionOps[Self <: TableInUseException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.TableInUseException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
