...
object typesProvisionedThroughputDescriptionMod {
  ...
  object ProvisionedThroughputDescription {
    ...
    implicit class ProvisionedThroughputDescriptionMutableBuilder[Self <: ProvisionedThroughputDescription] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLastDecreaseDateTime(value: js.Date | String | Double): Self = StObject.set(x, "LastDecreaseDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastDecreaseDateTimeDate(value: js.Date): Self = StObject.set(x, "LastDecreaseDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastDecreaseDateTimeUndefined: Self = StObject.set(x, "LastDecreaseDateTime", js.undefined)
      
      @scala.inline
      def setLastIncreaseDateTime(value: js.Date | String | Double): Self = StObject.set(x, "LastIncreaseDateTime", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLastIncreaseDateTimeDate(value: js.Date): Self = StObject.set(x, "LastIncreaseDateTime", value.asInstanceOf[js.Any])
