...
@JSImport("@aws-sdk/client-dynamodb-node/types/UpdateTimeToLiveExceptionsUnion", JSImport.Namespace)
@js.native
object typesUpdateTimeToLiveExceptionsUnionMod extends js.Object {
