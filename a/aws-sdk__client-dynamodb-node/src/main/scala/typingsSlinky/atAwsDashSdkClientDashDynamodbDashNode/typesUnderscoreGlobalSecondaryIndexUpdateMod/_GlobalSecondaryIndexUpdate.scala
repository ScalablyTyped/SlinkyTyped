package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreGlobalSecondaryIndexUpdateMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreCreateGlobalSecondaryIndexActionMod._CreateGlobalSecondaryIndexAction
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreDeleteGlobalSecondaryIndexActionMod._DeleteGlobalSecondaryIndexAction
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreUpdateGlobalSecondaryIndexActionMod._UpdateGlobalSecondaryIndexAction
