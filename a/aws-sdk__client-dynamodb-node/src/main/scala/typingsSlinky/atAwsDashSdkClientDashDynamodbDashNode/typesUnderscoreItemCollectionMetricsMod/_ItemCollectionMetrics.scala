package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreItemCollectionMetricsMod
...
object _ItemCollectionMetrics {
  @scala.inline
  def apply(
    ItemCollectionKey: StringDictionary[_AttributeValue] | (js.Iterable[js.Tuple2[String, _AttributeValue]]) = null,
    SizeEstimateRangeGB: js.Array[Double] | js.Iterable[Double] = null
