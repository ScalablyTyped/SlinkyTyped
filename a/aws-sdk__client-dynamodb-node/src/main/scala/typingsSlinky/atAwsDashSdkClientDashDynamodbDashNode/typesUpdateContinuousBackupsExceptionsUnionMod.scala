...
@JSImport("@aws-sdk/client-dynamodb-node/types/UpdateContinuousBackupsExceptionsUnion", JSImport.Namespace)
@js.native
object typesUpdateContinuousBackupsExceptionsUnionMod extends js.Object {
