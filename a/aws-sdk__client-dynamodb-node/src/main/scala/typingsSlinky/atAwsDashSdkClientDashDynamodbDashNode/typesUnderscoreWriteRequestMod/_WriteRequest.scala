...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreDeleteRequestMod._DeleteRequest
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscorePutRequestMod._PutRequest
