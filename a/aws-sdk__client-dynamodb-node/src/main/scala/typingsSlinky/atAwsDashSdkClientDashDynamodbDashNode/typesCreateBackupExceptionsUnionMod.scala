...
@JSImport("@aws-sdk/client-dynamodb-node/types/CreateBackupExceptionsUnion", JSImport.Namespace)
@js.native
object typesCreateBackupExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.atAwsDashSdkClientDashDynamodbDashNode.typesContinuousBackupsUnavailableExceptionMod.ContinuousBackupsUnavailableException
    - typings.atAwsDashSdkClientDashDynamodbDashNode.typesBackupInUseExceptionMod.BackupInUseException
