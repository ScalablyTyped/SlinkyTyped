package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreTableDescriptionMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.ACTIVE
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.CREATING
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.DELETING
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.UPDATING
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreAttributeDefinitionMod._AttributeDefinition
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreGlobalSecondaryIndexDescriptionMod._GlobalSecondaryIndexDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreKeySchemaElementMod._KeySchemaElement
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreLocalSecondaryIndexDescriptionMod._LocalSecondaryIndexDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreProvisionedThroughputDescriptionMod._ProvisionedThroughputDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreRestoreSummaryMod._RestoreSummary
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreSSEDescriptionMod._SSEDescription
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreStreamSpecificationMod._StreamSpecification
...
trait _TableDescription extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[js.Array[_AttributeDefinition] | js.Iterable[_AttributeDefinition]] = js.undefined
  /**
  ...
  var GlobalSecondaryIndexes: js.UndefOr[
    js.Array[_GlobalSecondaryIndexDescription] | js.Iterable[_GlobalSecondaryIndexDescription]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[js.Array[_KeySchemaElement] | js.Iterable[_KeySchemaElement]] = js.undefined
  /**
  ...
  var LocalSecondaryIndexes: js.UndefOr[
    js.Array[_LocalSecondaryIndexDescription] | js.Iterable[_LocalSecondaryIndexDescription]
  ] = js.undefined
  /**
...
object _TableDescription {
  @scala.inline
  def apply(
    AttributeDefinitions: js.Array[_AttributeDefinition] | js.Iterable[_AttributeDefinition] = null,
    CreationDateTime: js.Date | String | Double = null,
    GlobalSecondaryIndexes: js.Array[_GlobalSecondaryIndexDescription] | js.Iterable[_GlobalSecondaryIndexDescription] = null,
    ItemCount: Int | Double = null,
    KeySchema: js.Array[_KeySchemaElement] | js.Iterable[_KeySchemaElement] = null,
    LatestStreamArn: String = null,
    LatestStreamLabel: String = null,
    LocalSecondaryIndexes: js.Array[_LocalSecondaryIndexDescription] | js.Iterable[_LocalSecondaryIndexDescription] = null,
