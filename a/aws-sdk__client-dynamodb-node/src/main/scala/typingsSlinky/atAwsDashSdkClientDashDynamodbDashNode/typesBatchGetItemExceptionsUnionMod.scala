...
@JSImport("@aws-sdk/client-dynamodb-node/types/BatchGetItemExceptionsUnion", JSImport.Namespace)
@js.native
object typesBatchGetItemExceptionsUnionMod extends js.Object {
