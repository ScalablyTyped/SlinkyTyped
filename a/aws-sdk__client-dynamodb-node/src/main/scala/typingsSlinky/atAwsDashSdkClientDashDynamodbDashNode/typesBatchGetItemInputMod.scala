...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreKeysAndAttributesMod._KeysAndAttributes
...
@JSImport("@aws-sdk/client-dynamodb-node/types/BatchGetItemInput", JSImport.Namespace)
@js.native
object typesBatchGetItemInputMod extends js.Object {
  @js.native
  trait BatchGetItemInput extends InputTypesUnion {
    /**
    ...
    /**
      ...
      */
    var RequestItems: StringDictionary[_KeysAndAttributes] | (js.Iterable[js.Tuple2[String, _KeysAndAttributes]]) = js.native
    /**
