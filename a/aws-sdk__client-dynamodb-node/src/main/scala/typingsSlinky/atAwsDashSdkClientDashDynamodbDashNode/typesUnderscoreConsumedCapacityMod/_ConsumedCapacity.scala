package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreConsumedCapacityMod

import org.scalablytyped.runtime.StringDictionary
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreCapacityMod._Capacity
...
trait _ConsumedCapacity extends js.Object {
  ...
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[StringDictionary[_Capacity] | (js.Iterable[js.Tuple2[String, _Capacity]])] = js.undefined
  /**
    * <p>The amount of throughput consumed on each local index affected by the operation.</p>
    */
  var LocalSecondaryIndexes: js.UndefOr[StringDictionary[_Capacity] | (js.Iterable[js.Tuple2[String, _Capacity]])] = js.undefined
  /**
...
object _ConsumedCapacity {
  ...
  def apply(
    ...
    GlobalSecondaryIndexes: StringDictionary[_Capacity] | (js.Iterable[js.Tuple2[String, _Capacity]]) = null,
    LocalSecondaryIndexes: StringDictionary[_Capacity] | (js.Iterable[js.Tuple2[String, _Capacity]]) = null,
