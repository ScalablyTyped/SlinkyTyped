...
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreAutoScalingTargetTrackingScalingPolicyConfigurationDescriptionMod._AutoScalingTargetTrackingScalingPolicyConfigurationDescription
