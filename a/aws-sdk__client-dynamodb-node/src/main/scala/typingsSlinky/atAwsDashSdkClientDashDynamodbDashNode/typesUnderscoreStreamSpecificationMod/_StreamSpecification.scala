package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreStreamSpecificationMod

import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.KEYS_ONLY
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.NEW_AND_OLD_IMAGES
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.NEW_IMAGE
import typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.atAwsDashSdkClientDashDynamodbDashNodeStrings.OLD_IMAGE
