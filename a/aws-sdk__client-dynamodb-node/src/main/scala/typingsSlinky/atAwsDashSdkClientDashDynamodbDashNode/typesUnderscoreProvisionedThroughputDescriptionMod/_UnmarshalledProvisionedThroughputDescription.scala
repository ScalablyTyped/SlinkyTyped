package typingsSlinky.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreProvisionedThroughputDescriptionMod
...
trait _UnmarshalledProvisionedThroughputDescription extends _ProvisionedThroughputDescription {
  ...
  var LastDecreaseDateTime__UnmarshalledProvisionedThroughputDescription: js.UndefOr[js.Date] = js.undefined
  /**
    * <p>The date and time of the last provisioned throughput increase for this table.</p>
    */
  @JSName("LastIncreaseDateTime")
  var LastIncreaseDateTime__UnmarshalledProvisionedThroughputDescription: js.UndefOr[js.Date] = js.undefined
}
