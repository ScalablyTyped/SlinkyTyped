...
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.AES_128
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.AES_256
...
object typesGenerateDataKeyInputMod {
  ...
  object GenerateDataKeyInput {
    ...
    @scala.inline
    implicit class GenerateDataKeyInputMutableBuilder[Self <: GenerateDataKeyInput] (val x: Self) extends AnyVal {
