package typingsSlinky.awsSdkClientKmsBrowser.typesEnableKeyRotationOutputMod
...
object EnableKeyRotationOutput {
  ...
  @scala.inline
  implicit class EnableKeyRotationOutputOps[Self <: EnableKeyRotationOutput] (val x: Self) extends AnyVal {
