package typingsSlinky.awsSdkClientKmsBrowser.typesEncryptOutputMod
...
object EncryptOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, CiphertextBlob: js.typedarray.Uint8Array = null, KeyId: String = null): EncryptOutput = {
