...
object typesImportKeyMaterialInputMod {
  ...
  object ImportKeyMaterialInput {
    ...
    implicit class ImportKeyMaterialInputMutableBuilder[Self <: ImportKeyMaterialInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptedKeyMaterial(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = StObject.set(x, "EncryptedKeyMaterial", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptedKeyMaterialArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "EncryptedKeyMaterial", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptedKeyMaterialArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "EncryptedKeyMaterial", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setImportToken(value: js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | String): Self = StObject.set(x, "ImportToken", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImportTokenArrayBuffer(value: js.typedarray.ArrayBuffer): Self = StObject.set(x, "ImportToken", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setImportTokenArrayBufferView(value: js.typedarray.ArrayBufferView): Self = StObject.set(x, "ImportToken", value.asInstanceOf[js.Any])
