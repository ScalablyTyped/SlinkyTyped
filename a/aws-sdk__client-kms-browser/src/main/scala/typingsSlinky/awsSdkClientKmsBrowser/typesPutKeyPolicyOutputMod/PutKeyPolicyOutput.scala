package typingsSlinky.awsSdkClientKmsBrowser.typesPutKeyPolicyOutputMod
...
object PutKeyPolicyOutput {
  ...
  @scala.inline
  implicit class PutKeyPolicyOutputOps[Self <: PutKeyPolicyOutput] (val x: Self) extends AnyVal {
    @scala.inline
