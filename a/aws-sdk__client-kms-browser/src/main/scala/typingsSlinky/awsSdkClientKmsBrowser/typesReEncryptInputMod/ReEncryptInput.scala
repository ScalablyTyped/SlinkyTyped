package typingsSlinky.awsSdkClientKmsBrowser.typesReEncryptInputMod
...
object ReEncryptInput {
  ...
  def apply(
    ...
    DestinationEncryptionContext: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]) = null,
    GrantTokens: js.Array[String] | js.Iterable[String] = null,
    SourceEncryptionContext: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]]) = null
  ): ReEncryptInput = {
