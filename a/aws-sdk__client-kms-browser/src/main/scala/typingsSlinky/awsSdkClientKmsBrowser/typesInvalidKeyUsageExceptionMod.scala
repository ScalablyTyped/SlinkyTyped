...
object typesInvalidKeyUsageExceptionMod {
  ...
  trait InvalidKeyUsageException
    ...
    var name: typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidKeyUsageException = js.native
  }
  object InvalidKeyUsageException {
    
    @scala.inline
    def apply(name: typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidKeyUsageException): InvalidKeyUsageException = {
    ...
    implicit class InvalidKeyUsageExceptionMutableBuilder[Self <: InvalidKeyUsageException] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setName(value: typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidKeyUsageException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
