...
object typesGrantConstraintsMod {
  ...
  object GrantConstraints {
    ...
    implicit class GrantConstraintsMutableBuilder[Self <: GrantConstraints] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEncryptionContextEquals(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = StObject.set(x, "EncryptionContextEquals", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptionContextEqualsIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = StObject.set(x, "EncryptionContextEquals", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptionContextEqualsUndefined: Self = StObject.set(x, "EncryptionContextEquals", js.undefined)
      
      @scala.inline
      def setEncryptionContextSubset(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = StObject.set(x, "EncryptionContextSubset", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEncryptionContextSubsetIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = StObject.set(x, "EncryptionContextSubset", value.asInstanceOf[js.Any])
