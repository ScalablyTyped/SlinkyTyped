...
object InvalidGrantIdException {
  ...
  implicit class InvalidGrantIdExceptionOps[Self <: InvalidGrantIdException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidGrantIdException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
