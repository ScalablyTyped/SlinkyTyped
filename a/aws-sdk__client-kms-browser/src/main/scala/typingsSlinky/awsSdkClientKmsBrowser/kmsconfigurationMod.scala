...
object kmsconfigurationMod {
  ...
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<KMSResolvableConfiguration, KMSResolvedConfiguration> */ js.Any = js.native
  ...
  object KMSConfiguration {
    ...
    @scala.inline
    def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): KMSConfiguration = {
    ...
    @scala.inline
    implicit class KMSConfigurationMutableBuilder[Self <: KMSConfiguration] (val x: Self) extends AnyVal {
  ...
  trait KMSResolvedConfiguration extends KMSConfiguration {
    ...
    def streamCollector_MKMSResolvedConfiguration(stream: js.Any): js.Promise[js.typedarray.Uint8Array] = js.native
    @JSName("streamCollector")
