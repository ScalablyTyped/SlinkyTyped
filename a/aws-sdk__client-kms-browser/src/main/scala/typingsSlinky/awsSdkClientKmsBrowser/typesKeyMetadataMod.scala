...
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.AWS
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.AWS_KMS
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.CUSTOMER
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.Disabled
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.ENCRYPT_DECRYPT
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.EXTERNAL
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.Enabled
...
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.PendingDeletion
import typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.PendingImport
...
object typesKeyMetadataMod {
  ...
  object KeyMetadata {
    ...
    implicit class KeyMetadataMutableBuilder[Self <: KeyMetadata] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDeletionDate(value: js.Date | String | Double): Self = StObject.set(x, "DeletionDate", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDeletionDateDate(value: js.Date): Self = StObject.set(x, "DeletionDate", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValidTo(value: js.Date | String | Double): Self = StObject.set(x, "ValidTo", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValidToDate(value: js.Date): Self = StObject.set(x, "ValidTo", value.asInstanceOf[js.Any])
  ...
  object UnmarshalledKeyMetadata {
    ...
    implicit class UnmarshalledKeyMetadataMutableBuilder[Self <: UnmarshalledKeyMetadata] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setValidTo(value: js.Date): Self = StObject.set(x, "ValidTo", value.asInstanceOf[js.Any])
