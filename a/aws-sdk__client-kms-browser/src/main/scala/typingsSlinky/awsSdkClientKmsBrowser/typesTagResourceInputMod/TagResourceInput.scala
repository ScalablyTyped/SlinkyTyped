package typingsSlinky.awsSdkClientKmsBrowser.typesTagResourceInputMod
...
object TagResourceInput {
  @scala.inline
  def apply(KeyId: String, Tags: js.Array[Tag] | js.Iterable[Tag]): TagResourceInput = {
  ...
  implicit class TagResourceInputOps[Self <: TagResourceInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagsIterable(value: js.Iterable[Tag]): Self = this.set("Tags", value.asInstanceOf[js.Any])
    @scala.inline
    def setTags(value: js.Array[Tag] | js.Iterable[Tag]): Self = this.set("Tags", value.asInstanceOf[js.Any])
    @scala.inline
