package typingsSlinky.awsSdkClientKmsBrowser.typesCancelKeyDeletionInputMod
...
object CancelKeyDeletionInput {
  ...
  @scala.inline
  implicit class CancelKeyDeletionInputOps[Self <: CancelKeyDeletionInput] (val x: Self) extends AnyVal {
