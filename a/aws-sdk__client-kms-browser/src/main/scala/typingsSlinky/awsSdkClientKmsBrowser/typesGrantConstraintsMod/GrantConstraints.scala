...
object GrantConstraints {
  ...
  implicit class GrantConstraintsOps[Self <: GrantConstraints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncryptionContextEqualsIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("EncryptionContextEquals", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEncryptionContextEquals(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("EncryptionContextEquals", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEncryptionContextEquals: Self = this.set("EncryptionContextEquals", js.undefined)
    
    @scala.inline
    def setEncryptionContextSubsetIterable(value: js.Iterable[js.Tuple2[String, String]]): Self = this.set("EncryptionContextSubset", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEncryptionContextSubset(value: StringDictionary[String] | (js.Iterable[js.Tuple2[String, String]])): Self = this.set("EncryptionContextSubset", value.asInstanceOf[js.Any])
