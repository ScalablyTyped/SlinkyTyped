package typingsSlinky.awsSdkClientKmsBrowser.typesGenerateRandomOutputMod
...
object GenerateRandomOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, Plaintext: js.typedarray.Uint8Array = null): GenerateRandomOutput = {
