package typingsSlinky.awsSdkClientKmsBrowser.typesListGrantsInputMod
...
@js.native
trait ListGrantsInput extends InputTypesUnion {
  /**
...
object ListGrantsInput {
  ...
  @scala.inline
  implicit class ListGrantsInputOps[Self <: ListGrantsInput] (val x: Self) extends AnyVal {
    @scala.inline
