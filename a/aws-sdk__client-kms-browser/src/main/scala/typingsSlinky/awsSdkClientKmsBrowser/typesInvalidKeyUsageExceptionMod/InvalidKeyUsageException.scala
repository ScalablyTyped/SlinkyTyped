...
object InvalidKeyUsageException {
  ...
  implicit class InvalidKeyUsageExceptionOps[Self <: InvalidKeyUsageException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typingsSlinky.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidKeyUsageException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
