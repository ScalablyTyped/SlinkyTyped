...
object typesDeleteImportedKeyMaterialInputMod {
  ...
  object DeleteImportedKeyMaterialInput {
    ...
    @scala.inline
    implicit class DeleteImportedKeyMaterialInputMutableBuilder[Self <: DeleteImportedKeyMaterialInput] (val x: Self) extends AnyVal {
