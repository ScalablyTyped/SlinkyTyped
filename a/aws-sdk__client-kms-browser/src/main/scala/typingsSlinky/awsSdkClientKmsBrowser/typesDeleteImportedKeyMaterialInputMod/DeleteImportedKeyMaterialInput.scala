package typingsSlinky.awsSdkClientKmsBrowser.typesDeleteImportedKeyMaterialInputMod
...
object DeleteImportedKeyMaterialInput {
  ...
  @scala.inline
  implicit class DeleteImportedKeyMaterialInputOps[Self <: DeleteImportedKeyMaterialInput] (val x: Self) extends AnyVal {
    @scala.inline
