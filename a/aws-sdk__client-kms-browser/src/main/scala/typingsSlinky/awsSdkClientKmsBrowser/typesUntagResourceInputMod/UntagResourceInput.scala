package typingsSlinky.awsSdkClientKmsBrowser.typesUntagResourceInputMod
...
object UntagResourceInput {
  ...
  @scala.inline
  def apply(KeyId: String, TagKeys: js.Array[String] | js.Iterable[String]): UntagResourceInput = {
