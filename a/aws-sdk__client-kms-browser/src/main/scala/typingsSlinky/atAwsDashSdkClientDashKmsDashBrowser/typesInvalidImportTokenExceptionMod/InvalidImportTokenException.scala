...
trait InvalidImportTokenException
  ...
  @JSName("name")
  var name_InvalidImportTokenException: typingsSlinky.atAwsDashSdkClientDashKmsDashBrowser.atAwsDashSdkClientDashKmsDashBrowserStrings.InvalidImportTokenException = js.native
}
