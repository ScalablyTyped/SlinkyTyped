...
@JSImport("@aws-sdk/client-kms-browser/types/ListAliasesExceptionsUnion", JSImport.Namespace)
@js.native
object typesListAliasesExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    - typings.atAwsDashSdkClientDashKmsDashBrowser.typesDependencyTimeoutExceptionMod.DependencyTimeoutException
    - typings.atAwsDashSdkClientDashKmsDashBrowser.typesInvalidMarkerExceptionMod.InvalidMarkerException
