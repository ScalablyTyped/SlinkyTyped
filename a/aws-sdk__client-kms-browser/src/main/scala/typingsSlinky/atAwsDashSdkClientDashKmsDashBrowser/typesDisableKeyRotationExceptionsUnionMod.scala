...
@JSImport("@aws-sdk/client-kms-browser/types/DisableKeyRotationExceptionsUnion", JSImport.Namespace)
@js.native
object typesDisableKeyRotationExceptionsUnionMod extends js.Object {
