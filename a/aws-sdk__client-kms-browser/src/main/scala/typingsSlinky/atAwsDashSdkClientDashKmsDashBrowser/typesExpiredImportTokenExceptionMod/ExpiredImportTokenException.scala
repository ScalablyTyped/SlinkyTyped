...
trait ExpiredImportTokenException
  ...
  @JSName("name")
  var name_ExpiredImportTokenException: typingsSlinky.atAwsDashSdkClientDashKmsDashBrowser.atAwsDashSdkClientDashKmsDashBrowserStrings.ExpiredImportTokenException = js.native
}
