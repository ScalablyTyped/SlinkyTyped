...
@js.native
object typesRevokeGrantExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.atAwsDashSdkClientDashKmsDashBrowser.typesInvalidGrantIdExceptionMod.InvalidGrantIdException
