...
object Term {
  ...
  implicit class TermOps[Self <: Term] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoefficient(value: () => typingsSlinky.algebraJs.mod.algebra.js_.Fraction): Self = this.set("coefficient", js.Any.fromFunction0(value))
    
    @scala.inline
    def setCoefficientsVarargs(value: typingsSlinky.algebraJs.mod.algebra.js_.Fraction*): Self = this.set("coefficients", js.Array(value :_*))
    
    @scala.inline
    def setCoefficients(value: js.Array[typingsSlinky.algebraJs.mod.algebra.js_.Fraction]): Self = this.set("coefficients", value.asInstanceOf[js.Any])
