...
import typingsSlinky.azure.Anon_KeyVersionEndpointEnvironmentName
...
trait RoleEnvironmentInterface extends EventEmitter {
  ...
  /**
    ...
    */
  def setStatus(roleInstanceStatus: String, expirationUtc: js.Date, callback: ErrorCallback): Unit = js.native
}
