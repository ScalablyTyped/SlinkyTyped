package typingsSlinky.algoliaClientCommon.anon

import typingsSlinky.algoliaTransporter.mod.HostOptions
import typingsSlinky.algoliaTransporter.mod.QueryParameters
...
trait Headers extends js.Object {
  /**
    ...
    */
  val headers: js.UndefOr[typingsSlinky.algoliaTransporter.mod.Headers] = js.native
  /**
...
object Headers {
  ...
  implicit class HeadersOps[Self <: Headers] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeaders(value: typingsSlinky.algoliaTransporter.mod.Headers): Self = this.set("headers", value.asInstanceOf[js.Any])
    @scala.inline
