...
object anon {
  ...
  object Headers {
    ...
    implicit class HeadersMutableBuilder[Self <: Headers] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHeaders(value: typingsSlinky.algoliaTransporter.mod.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
  ...
  trait Transporter extends StObject {
    ...
    val transporter: typingsSlinky.algoliaTransporter.mod.Transporter = js.native
  }
  object Transporter {
    
    @scala.inline
    def apply(transporter: typingsSlinky.algoliaTransporter.mod.Transporter): Transporter = {
    ...
    implicit class TransporterMutableBuilder[Self <: Transporter] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTransporter(value: typingsSlinky.algoliaTransporter.mod.Transporter): Self = StObject.set(x, "transporter", value.asInstanceOf[js.Any])
    }
  }
}
