...
object atAntDashDesignIconsDashAngularMod extends js.Object {
  ...
  class IconDirective protected ()
    extends typingsSlinky.atAntDashDesignIconsDashAngular.publicUnderscoreApiMod.IconDirective {
    def this(
  ...
  class IconService protected ()
    extends typingsSlinky.atAntDashDesignIconsDashAngular.publicUnderscoreApiMod.IconService {
    def this(
