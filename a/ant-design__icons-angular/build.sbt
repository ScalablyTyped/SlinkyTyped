...
version := "9.0.1-f685c6"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-web" % "0.6.6",
  "org.scalablytyped.slinky" %%% "angular__animations" % "10.0.7-f162cf",
  "org.scalablytyped.slinky" %%% "angular__common" % "10.0.7-a2a9db",
  "org.scalablytyped.slinky" %%% "angular__compiler" % "10.0.7-17a148",
  "org.scalablytyped.slinky" %%% "angular__core" % "10.0.7-8ec873",
  "org.scalablytyped.slinky" %%% "angular__platform-browser" % "10.0.7-712aa7",
