...
object InspectResult {
  ...
  implicit class InspectResultOps[Self <: InspectResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccessTime(value: js.Date): Self = this.set("accessTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAccessTime: Self = this.set("accessTime", js.undefined)
    
    @scala.inline
    def setChangeTime(value: js.Date): Self = this.set("changeTime", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setModifyTime(value: js.Date): Self = this.set("modifyTime", value.asInstanceOf[js.Any])
