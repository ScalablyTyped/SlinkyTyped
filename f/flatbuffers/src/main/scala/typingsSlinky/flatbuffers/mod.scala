package typingsSlinky.flatbuffers
...
object mod {
  ...
  object flatbuffers {
    ...
    object Long {
      ...
      @js.native
      def ZERO: typingsSlinky.flatbuffers.mod.global.flatbuffers.Long = js.native
      @scala.inline
      def ZERO_=(x: typingsSlinky.flatbuffers.mod.global.flatbuffers.Long): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
    ...
    object flatbuffers {
      ...
      object Table {
        ...
        implicit class TableMutableBuilder[Self <: Table] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setBb(value: ByteBuffer): Self = StObject.set(x, "bb", value.asInstanceOf[js.Any])
          
          @scala.inline
          def setBbNull: Self = StObject.set(x, "bb", null)
          
          @scala.inline
          def setBb_pos(value: Double): Self = StObject.set(x, "bb_pos", value.asInstanceOf[js.Any])
        }
      }
    }
  }
