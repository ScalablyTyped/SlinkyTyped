...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFallbackFocusHTMLElement(value: HTMLElement): Self = this.set("fallbackFocus", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInitialFocusHTMLElement(value: HTMLElement): Self = this.set("initialFocus", value.asInstanceOf[js.Any])
    @scala.inline
