package typingsSlinky.focusTrap
...
object mod {
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFallbackFocusHTMLElement(value: HTMLElement): Self = StObject.set(x, "fallbackFocus", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInitialFocusHTMLElement(value: HTMLElement): Self = StObject.set(x, "initialFocus", value.asInstanceOf[js.Any])
