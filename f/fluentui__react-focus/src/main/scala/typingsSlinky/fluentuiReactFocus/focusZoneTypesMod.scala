...
object focusZoneTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsSlinky.fluentuiReactFocus.fluentuiReactFocusNumbers.`0`
    - typingsSlinky.fluentuiReactFocus.fluentuiReactFocusNumbers.`1`
    - typingsSlinky.fluentuiReactFocus.fluentuiReactFocusNumbers.`2`
  */
  ...
  trait IFocusZoneProps extends HTMLAttributes[HTMLElement | FocusZone] {
    ...
    /**
      ...
      */
    @JSName("onFocus")
    var onFocus_IFocusZoneProps: js.UndefOr[js.Function1[/* event */ SyntheticFocusEvent[HTMLElement | FocusZone], Unit]] = js.native
    ...
    /**
      ...
      */
    var shouldEnterInnerZone: js.UndefOr[js.Function1[/* ev */ SyntheticKeyboardEvent[HTMLElement], Boolean]] = js.native
  ...
  object IFocusZoneProps {
    ...
    implicit class IFocusZonePropsMutableBuilder[Self <: IFocusZoneProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponentRefRefObject(value: ReactRef[IFocusZone]): Self = StObject.set(x, "componentRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIsInnerZoneKeystroke(value: /* ev */ SyntheticKeyboardEvent[HTMLElement] => Boolean): Self = StObject.set(x, "isInnerZoneKeystroke", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFocus(value: /* event */ SyntheticFocusEvent[HTMLElement | FocusZone] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setShouldEnterInnerZone(value: /* ev */ SyntheticKeyboardEvent[HTMLElement] => Boolean): Self = StObject.set(x, "shouldEnterInnerZone", js.Any.fromFunction1(value))
