...
object IFocusZoneProps {
  ...
  implicit class IFocusZonePropsOps[Self <: IFocusZoneProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefRefObject(value: ReactRef[IFocusZone]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsInnerZoneKeystroke(value: /* ev */ SyntheticKeyboardEvent[HTMLElement] => Boolean): Self = this.set("isInnerZoneKeystroke", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnFocus(value: /* event */ SyntheticFocusEvent[HTMLElement | FocusZone] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShouldEnterInnerZone(value: /* ev */ SyntheticKeyboardEvent[HTMLElement] => Boolean): Self = this.set("shouldEnterInnerZone", js.Any.fromFunction1(value))
