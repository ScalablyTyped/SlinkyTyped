...
import typingsSlinky.formatjsEcma402Abstract.anon.LongEraData
...
import typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod.IntervalFormatsData
...
object typesMod {
  ...
  trait RawDateTimeLocaleInternalData extends StObject {
    ...
    var timeZoneName: typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod.TimeZoneNameData = js.native
  ...
  object RawDateTimeLocaleInternalData {
    ...
    def apply(
      ...
      pm: String,
      timeFormat: Full,
      timeZoneName: typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod.TimeZoneNameData,
      weekday: Narrow
    ...
    implicit class RawDateTimeLocaleInternalDataMutableBuilder[Self <: RawDateTimeLocaleInternalData] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTimeZoneName(value: typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod.TimeZoneNameData): Self = StObject.set(x, "timeZoneName", value.asInstanceOf[js.Any])
