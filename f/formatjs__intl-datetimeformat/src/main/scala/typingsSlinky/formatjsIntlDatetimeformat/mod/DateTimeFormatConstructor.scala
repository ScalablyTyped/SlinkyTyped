...
trait DateTimeFormatConstructor
  extends Instantiable0[DateTimeFormat]
     ...
     with Instantiable2[
      ...
      /* options */ typingsSlinky.formatjsIntlDatetimeformat.typesMod.DateTimeFormatOptions, 
      DateTimeFormat
    ] {
  ...
  def apply(locales: String, options: typingsSlinky.formatjsIntlDatetimeformat.typesMod.DateTimeFormatOptions): DateTimeFormat = js.native
