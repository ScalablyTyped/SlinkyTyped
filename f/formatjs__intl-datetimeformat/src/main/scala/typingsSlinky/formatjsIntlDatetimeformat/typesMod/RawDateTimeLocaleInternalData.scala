...
object RawDateTimeLocaleInternalData {
  ...
  implicit class RawDateTimeLocaleInternalDataOps[Self <: RawDateTimeLocaleInternalData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTimeZoneName(value: typingsSlinky.formatjsEcma402Abstract.typesDateTimeMod.TimeZoneNameData): Self = this.set("timeZoneName", value.asInstanceOf[js.Any])
