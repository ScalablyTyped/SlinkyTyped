...
object Transition {
  ...
  def DirectionalTransition(
    ...
    __obj.asInstanceOf[typingsSlinky.figma.mod.global.DirectionalTransition]
  }
  
  @scala.inline
  def SimpleTransition(duration: Double, easing: Easing, `type`: DISSOLVE | SMART_ANIMATE): typingsSlinky.figma.mod.global.SimpleTransition = {
    val __obj = js.Dynamic.literal(duration = duration.asInstanceOf[js.Any], easing = easing.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsSlinky.figma.mod.global.SimpleTransition]
  }
}
