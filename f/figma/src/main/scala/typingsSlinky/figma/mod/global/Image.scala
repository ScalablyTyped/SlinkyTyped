...
object Image {
  ...
  implicit class ImageOps[Self <: Image] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetBytesAsync(value: () => js.Promise[js.typedarray.Uint8Array]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getBytesAsync")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
