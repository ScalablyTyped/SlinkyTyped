package typingsSlinky.fsTreeDiff.anon
...
object Entries {
  @scala.inline
  def apply[/* <: typingsSlinky.fsTreeDiff.entryMod.BaseEntry */ T](): Entries[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Entries[T]]
  }
  @scala.inline
  implicit class EntriesOps[Self <: Entries[_], /* <: typingsSlinky.fsTreeDiff.entryMod.BaseEntry */ T] (val x: Self with Entries[T]) extends AnyVal {
    @scala.inline
