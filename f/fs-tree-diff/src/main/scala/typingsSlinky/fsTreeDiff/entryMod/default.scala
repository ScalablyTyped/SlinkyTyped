package typingsSlinky.fsTreeDiff.entryMod
...
class default protected () extends Entry {
  ...
  def this(relativePath: String, size: js.UndefOr[scala.Nothing], mtime: js.Date) = this()
  ...
  def this(relativePath: String, size: js.UndefOr[scala.Nothing], mtime: js.Date, mode: Double) = this()
