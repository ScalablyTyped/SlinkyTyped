...
object mod {
  ...
  @JSImport("fast64", "decode")
  @js.native
  def decode(base64: String, options: Options): js.typedarray.Uint8Array = js.native
  ...
  @JSImport("fast64", "urldecode")
  @js.native
  def urldecode(base64: String, options: Options): js.typedarray.Uint8Array = js.native
