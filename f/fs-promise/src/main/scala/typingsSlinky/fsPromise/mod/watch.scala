...
object watch extends js.Object {
  ...
  /**
    ...
    */
  def apply(filename: PathLike, options: typingsSlinky.node.AnonEncodingPersistent): FSWatcher = js.native
  def apply(
    filename: PathLike,
    options: typingsSlinky.node.AnonEncodingPersistent,
    listener: js.Function2[/* event */ String, /* filename */ String | Buffer, Unit]
  ): FSWatcher = js.native
  /**
    * Watch for changes on `filename`, where `filename` is either a file or a directory, returning an `FSWatcher`.
    ...
    * If `recursive` is not supplied, the default of `false` is used.
    */
  def apply(filename: PathLike, options: typingsSlinky.node.AnonPersistent): FSWatcher = js.native
  def apply(
    filename: PathLike,
    options: typingsSlinky.node.AnonPersistent,
    listener: js.Function2[/* event */ String, /* filename */ String, Unit]
  ): FSWatcher = js.native
  /**
    * Watch for changes on `filename`, where `filename` is either a file or a directory, returning an `FSWatcher`.
    ...
    * If `recursive` is not supplied, the default of `false` is used.
    */
  def apply(filename: PathLike, options: typingsSlinky.node.AnonRecursive): FSWatcher = js.native
  def apply(
    filename: PathLike,
    options: typingsSlinky.node.AnonRecursive,
    listener: js.Function2[/* event */ String, /* filename */ Buffer, Unit]
  ): FSWatcher = js.native
