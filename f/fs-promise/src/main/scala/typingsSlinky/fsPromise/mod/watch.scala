...
object watch extends js.Object {
  ...
  /**
    ...
    */
  def apply(filename: PathLike, options: typingsSlinky.node.anon.EncodingPersistent): FSWatcher = js.native
  def apply(
    filename: PathLike,
    options: typingsSlinky.node.anon.EncodingPersistent,
    listener: js.Function2[/* event */ String, /* filename */ String | Buffer, Unit]
  ): FSWatcher = js.native
  def apply(filename: PathLike, options: typingsSlinky.node.anon.Persistent): FSWatcher = js.native
  def apply(
    filename: PathLike,
  ...
  /**
    ...
    * If `recursive` is not supplied, the default of `false` is used.
    */
  def apply(filename: PathLike, options: typingsSlinky.node.anon.Recursive): FSWatcher = js.native
  def apply(
    filename: PathLike,
