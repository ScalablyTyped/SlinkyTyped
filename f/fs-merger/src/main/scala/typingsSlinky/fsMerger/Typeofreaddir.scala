...
trait Typeofreaddir extends js.Object {
  ...
  def apply(
    path: PathLike,
    options: typingsSlinky.node.AnonWithFileTypes,
    callback: js.Function2[/* err */ ErrnoException | Null, /* files */ js.Array[String], Unit]
  ): Unit = js.native
  def apply(
    path: PathLike,
  ...
  def __promisify__(path: PathLike, options: typingsSlinky.node.AnonWithFileTypes): js.Promise[js.Array[String]] = js.native
