...
import typingsSlinky.fabric.Anon_Axis1
import typingsSlinky.fabric.Anon_Center
import typingsSlinky.fabric.Anon_X1
...
class Line () extends Object {
  ...
  /**
  	 ...
  	 * @private
  	 */
  def calcLinePoints(): Anon_X1 = js.native
  /**
  	 * Produces a function that calculates distance from canvas edge to Line origin.
  	 */
  def makeEdgeToOriginGetter(propertyNames: Anon_Axis1, originValues: Anon_Center): js.Function = js.native
}
