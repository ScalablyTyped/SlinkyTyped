...
class Polyline protected ()
  extends typingsSlinky.fabric.fabricDashImplMod.Polyline {
  /**
  	 * Constructor
...
object Polyline extends js.Object {
  ...
  /**
  	 ...
  	 * @param [options] Options object
  	 */
  def fromElement(element: SVGElement): typingsSlinky.fabric.fabricDashImplMod.Polyline = js.native
  def fromElement(element: SVGElement, options: IPolylineOptions): typingsSlinky.fabric.fabricDashImplMod.Polyline = js.native
  /**
  	 * Returns fabric.Polyline instance from an object representation
  	 * @param object Object to create an instance from
  	 */
  def fromObject(`object`: js.Any): typingsSlinky.fabric.fabricDashImplMod.Polyline = js.native
}
