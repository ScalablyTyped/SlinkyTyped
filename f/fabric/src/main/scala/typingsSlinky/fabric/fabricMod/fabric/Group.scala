...
import typingsSlinky.fabric.fabricDashImplMod.IGroupOptions
...
/**
	 ...
	 */
class Group ()
  extends typingsSlinky.fabric.fabricDashImplMod.Group {
  def this(objects: js.Array[typingsSlinky.fabric.fabricDashImplMod.Object]) = this()
  def this(objects: js.Array[typingsSlinky.fabric.fabricDashImplMod.Object], options: IGroupOptions) = this()
  def this(
    objects: js.Array[typingsSlinky.fabric.fabricDashImplMod.Object],
