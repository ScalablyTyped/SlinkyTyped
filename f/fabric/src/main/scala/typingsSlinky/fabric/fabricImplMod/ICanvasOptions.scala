...
object ICanvasOptions {
  ...
  def apply(
    ...
    altSelectionKey: js.UndefOr[Null | String] = js.undefined,
    ...
    selectionLineWidth: js.UndefOr[Double] = js.undefined,
    ...
    targetFindTolerance: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(altSelectionKey)) __obj.updateDynamic("altSelectionKey")(altSelectionKey.asInstanceOf[js.Any])
    if (backgroundColor != null) __obj.updateDynamic("backgroundColor")(backgroundColor.asInstanceOf[js.Any])
    if (backgroundImage != null) __obj.updateDynamic("backgroundImage")(backgroundImage.asInstanceOf[js.Any])
    if (!js.isUndefined(backgroundVpt)) __obj.updateDynamic("backgroundVpt")(backgroundVpt.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(controlsAboveOverlay)) __obj.updateDynamic("controlsAboveOverlay")(controlsAboveOverlay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isDrawingMode)) __obj.updateDynamic("isDrawingMode")(isDrawingMode.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(overlayVpt)) __obj.updateDynamic("overlayVpt")(overlayVpt.get.asInstanceOf[js.Any])
    if (!js.isUndefined(perPixelTargetFind)) __obj.updateDynamic("perPixelTargetFind")(perPixelTargetFind.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preserveObjectStacking)) __obj.updateDynamic("preserveObjectStacking")(preserveObjectStacking.get.asInstanceOf[js.Any])
    if (!js.isUndefined(renderOnAddRemove)) __obj.updateDynamic("renderOnAddRemove")(renderOnAddRemove.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectionFullyContained)) __obj.updateDynamic("selectionFullyContained")(selectionFullyContained.get.asInstanceOf[js.Any])
    if (selectionKey != null) __obj.updateDynamic("selectionKey")(selectionKey.asInstanceOf[js.Any])
    if (!js.isUndefined(selectionLineWidth)) __obj.updateDynamic("selectionLineWidth")(selectionLineWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skipOffscreen)) __obj.updateDynamic("skipOffscreen")(skipOffscreen.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skipTargetFind)) __obj.updateDynamic("skipTargetFind")(skipTargetFind.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(stopContextMenu)) __obj.updateDynamic("stopContextMenu")(stopContextMenu.get.asInstanceOf[js.Any])
    if (!js.isUndefined(svgViewportTransformation)) __obj.updateDynamic("svgViewportTransformation")(svgViewportTransformation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(targetFindTolerance)) __obj.updateDynamic("targetFindTolerance")(targetFindTolerance.get.asInstanceOf[js.Any])
