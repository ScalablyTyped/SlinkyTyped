...
trait Channel extends StObject {
  ...
  /** Mask image object */
  var mask: js.UndefOr[typingsSlinky.fabric.fabricImplMod.Image] = js.native
}
object Channel {
  ...
  implicit class ChannelMutableBuilder[Self <: Channel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMask(value: typingsSlinky.fabric.fabricImplMod.Image): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
