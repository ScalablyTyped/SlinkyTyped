...
object EMAILSIGNIN {
  ...
  implicit class EMAILSIGNINOps[Self <: EMAILSIGNIN] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withEMAIL_SIGNIN(value: Operation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("EMAIL_SIGNIN")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withPASSWORD_RESET(value: Operation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("PASSWORD_RESET")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRECOVER_EMAIL(value: Operation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("RECOVER_EMAIL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withREVERT_SECOND_FACTOR_ADDITION(value: Operation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("REVERT_SECOND_FACTOR_ADDITION")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVERIFY_AND_CHANGE_EMAIL(value: Operation): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("VERIFY_AND_CHANGE_EMAIL")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withVERIFY_EMAIL(value: Operation): Self = {
        val ret = this.duplicate
