...
import typingsSlinky.ffiNapi.anon.RTLDDEFAUL
...
object mod {
  ...
  @js.native
  val Callback: typingsSlinky.ffiNapi.mod.Callback = js.native
  ...
  @js.native
  val Library: typingsSlinky.ffiNapi.mod.Library = js.native
