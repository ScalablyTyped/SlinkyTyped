...
object FsLightboxProps {
  ...
  implicit class FsLightboxPropsOps[Self <: FsLightboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomSourcesVarargs(value: ReactElement*): Self = this.set("customSources", js.Array(value :_*))
    @scala.inline
    def setCustomSources(value: js.Array[ReactElement]): Self = this.set("customSources", value.asInstanceOf[js.Any])
    @scala.inline
