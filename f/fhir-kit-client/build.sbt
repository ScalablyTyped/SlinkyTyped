...
version := "1.1-dt-20200515Z-2b860d"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20200515Z-d20e38",
  "org.scalablytyped.slinky" %%% "form-data" % "3.0.0-5f101b",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20200515Z-39e1e6",
