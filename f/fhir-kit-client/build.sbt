...
version := "1.1-dt-20190614Z-5737ca"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20191014Z-787a02",
  "org.scalablytyped.slinky" %%% "form-data" % "2.5.1-207e75",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20190322Z-eb6e9c",
