...
version := "1.1-dt-20190614Z-d8d859"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20191014Z-f4832c",
  "org.scalablytyped.slinky" %%% "form-data" % "2.5.1-2fe4b7",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20190322Z-19d924",
