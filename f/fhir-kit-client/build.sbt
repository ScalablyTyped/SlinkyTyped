...
version := "1.1-dt-20201002Z-0468c9"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20201002Z-b81006",
  "org.scalablytyped.slinky" %%% "form-data" % "3.0.0-ee7e6b",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20201002Z-a3c8e0",
