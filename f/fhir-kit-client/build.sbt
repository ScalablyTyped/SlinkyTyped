...
version := "1.1-dt-20200515Z-28b1ad"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20200515Z-d4560a",
  "org.scalablytyped.slinky" %%% "form-data" % "2.5.1-cb3aa6",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20200515Z-deda5a",
