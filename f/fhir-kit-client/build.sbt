...
version := "1.1-dt-20200225Z-603ed0"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20200226Z-67f23e",
  "org.scalablytyped.slinky" %%% "form-data" % "2.5.1-c3cd72",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20200226Z-6acc70",
