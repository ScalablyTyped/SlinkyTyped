...
version := "1.1-dt-20201002Z-d657e6"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.slinky" %%% "fhir" % "0.0-unknown-dt-20201002Z-c12e16",
  "org.scalablytyped.slinky" %%% "form-data" % "3.0.0-113260",
  "org.scalablytyped.slinky" %%% "json-patch" % "0.0-unknown-dt-20201002Z-c928e8",
