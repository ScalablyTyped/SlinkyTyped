...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.MessageHeader
...
object Anon263 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MessageHeader): Anon263 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon263]
  }
  @scala.inline
  implicit class Anon263Ops[Self <: Anon263] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: MessageHeader): Self = {
        val ret = this.duplicate
