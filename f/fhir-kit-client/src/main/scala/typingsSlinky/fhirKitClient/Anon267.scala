...
object Anon267 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: OperationDefinition): Anon267 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon267]
  }
  @scala.inline
  implicit class Anon267Ops[Self <: Anon267] (val x: Self) extends AnyVal {
    @scala.inline
