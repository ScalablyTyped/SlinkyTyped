...
object AnonOptionsOptionsResourceType {
  @scala.inline
  def apply(id: String, resourceType: ChargeItem): AnonOptionsOptionsResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOptionsOptionsResourceType]
  }
  @scala.inline
  implicit class AnonOptionsOptionsResourceTypeOps[Self <: AnonOptionsOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
