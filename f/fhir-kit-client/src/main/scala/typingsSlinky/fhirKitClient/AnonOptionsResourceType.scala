...
object AnonOptionsResourceType {
  @scala.inline
  def apply(id: String, resourceType: AppointmentResponse): AnonOptionsResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOptionsResourceType]
  }
  @scala.inline
  implicit class AnonOptionsResourceTypeOps[Self <: AnonOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: AppointmentResponse): Self = {
        val ret = this.duplicate
