...
object Anon246 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ImagingStudy): Anon246 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon246]
  }
  @scala.inline
  implicit class Anon246Ops[Self <: Anon246] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: ImagingStudy): Self = {
        val ret = this.duplicate
