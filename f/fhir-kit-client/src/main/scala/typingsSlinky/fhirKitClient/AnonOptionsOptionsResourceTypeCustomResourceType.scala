...
object AnonOptionsOptionsResourceTypeCustomResourceType {
  @scala.inline
  def apply(id: String, resourceType: CustomResourceType, version: String): AnonOptionsOptionsResourceTypeCustomResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOptionsOptionsResourceTypeCustomResourceType]
  }
  @scala.inline
  implicit class AnonOptionsOptionsResourceTypeCustomResourceTypeOps[Self <: AnonOptionsOptionsResourceTypeCustomResourceType] (val x: Self) extends AnyVal {
    @scala.inline
