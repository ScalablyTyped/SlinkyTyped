...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.CommunicationRequest
...
object Anon2 {
  @scala.inline
  def apply(id: String, resourceType: CommunicationRequest): Anon2 = {
  ...
  implicit class Anon2Ops[Self <: Anon2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: CommunicationRequest): Self = {
        val ret = this.duplicate
