...
object AnonIdStringJSONPatchArrayOptionsOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CareTeam): AnonIdStringJSONPatchArrayOptionsOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonIdStringJSONPatchArrayOptionsOptions]
  }
  @scala.inline
  implicit class AnonIdStringJSONPatchArrayOptionsOptionsOps[Self <: AnonIdStringJSONPatchArrayOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: CareTeam): Self = {
        val ret = this.duplicate
