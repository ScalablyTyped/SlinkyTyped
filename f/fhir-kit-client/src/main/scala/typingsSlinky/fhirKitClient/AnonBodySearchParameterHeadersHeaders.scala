...
object AnonBodySearchParameterHeadersHeaders {
  ...
  @scala.inline
  implicit class AnonBodySearchParameterHeadersHeadersOps[Self <: AnonBodySearchParameterHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBody(value: SearchParameter): Self = {
    ...
    @scala.inline
    def withResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.SearchParameter): Self = {
        val ret = this.duplicate
