...
object Anon248 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ImmunizationRecommendation): Anon248 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon248]
  }
  @scala.inline
  implicit class Anon248Ops[Self <: Anon248] (val x: Self) extends AnyVal {
    @scala.inline
