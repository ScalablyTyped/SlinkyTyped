...
object Anon296 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Specimen): Anon296 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon296]
  }
  @scala.inline
  implicit class Anon296Ops[Self <: Anon296] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Specimen): Self = {
        val ret = this.duplicate
