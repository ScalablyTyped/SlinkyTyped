...
object Anon260 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MedicationRequest): Anon260 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon260]
  }
  @scala.inline
  implicit class Anon260Ops[Self <: Anon260] (val x: Self) extends AnyVal {
    @scala.inline
