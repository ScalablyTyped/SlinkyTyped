...
trait Anon251 extends js.Object {
  ...
  var resourceType: Linkage = js.native
}

object Anon251 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Linkage): Anon251 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon251]
  }
  @scala.inline
  implicit class Anon251Ops[Self <: Anon251] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Linkage): Self = {
        val ret = this.duplicate
