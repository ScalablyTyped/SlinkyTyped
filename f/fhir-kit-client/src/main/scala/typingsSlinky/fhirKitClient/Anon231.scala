...
@js.native
trait Anon231 extends js.Object {
...
object Anon231 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Encounter): Anon231 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon231]
  }
  @scala.inline
  implicit class Anon231Ops[Self <: Anon231] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Encounter): Self = {
        val ret = this.duplicate
