...
object Anon237 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ExplanationOfBenefit): Anon237 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon237]
  }
  @scala.inline
  implicit class Anon237Ops[Self <: Anon237] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: ExplanationOfBenefit): Self = {
        val ret = this.duplicate
