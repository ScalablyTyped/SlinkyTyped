...
object AnonVersionString {
  @scala.inline
  def apply(id: String, resourceType: AppointmentResponse, version: String): AnonVersionString = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonVersionString]
  }
  @scala.inline
  implicit class AnonVersionStringOps[Self <: AnonVersionString] (val x: Self) extends AnyVal {
    @scala.inline
