...
trait Anon239 extends js.Object {
  ...
  var resourceType: Flag = js.native
}

object Anon239 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Flag): Anon239 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon239]
  }
  @scala.inline
  implicit class Anon239Ops[Self <: Anon239] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Flag): Self = {
        val ret = this.duplicate
