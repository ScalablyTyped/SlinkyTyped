...
object Anon283 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Questionnaire): Anon283 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon283]
  }
  @scala.inline
  implicit class Anon283Ops[Self <: Anon283] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Questionnaire): Self = {
        val ret = this.duplicate
