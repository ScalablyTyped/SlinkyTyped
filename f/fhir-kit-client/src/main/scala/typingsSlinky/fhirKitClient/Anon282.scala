...
object Anon282 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Provenance): Anon282 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon282]
  }
  @scala.inline
  implicit class Anon282Ops[Self <: Anon282] (val x: Self) extends AnyVal {
    @scala.inline
