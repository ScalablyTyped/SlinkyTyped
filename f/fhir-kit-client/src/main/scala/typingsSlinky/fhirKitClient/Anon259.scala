...
object Anon259 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MedicationDispense): Anon259 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon259]
  }
  @scala.inline
  implicit class Anon259Ops[Self <: Anon259] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: MedicationDispense): Self = {
        val ret = this.duplicate
