...
object AnonResourceTypeResourceType {
  @scala.inline
  def apply(id: String, resourceType: ResourceType): AnonResourceTypeResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonResourceTypeResourceType]
  }
  @scala.inline
  implicit class AnonResourceTypeResourceTypeOps[Self <: AnonResourceTypeResourceType] (val x: Self) extends AnyVal {
    @scala.inline
