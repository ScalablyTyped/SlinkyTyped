...
@js.native
trait Anon294 extends js.Object {
...
object Anon294 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ServiceDefinition): Anon294 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon294]
  }
  @scala.inline
  implicit class Anon294Ops[Self <: Anon294] (val x: Self) extends AnyVal {
    @scala.inline
