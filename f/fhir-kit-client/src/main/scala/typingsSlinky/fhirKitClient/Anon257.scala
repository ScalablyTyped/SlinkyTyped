...
@js.native
trait Anon257 extends js.Object {
  var JSONPatch: js.Array[OpPatch] = js.native
  var headers: js.UndefOr[Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[Options] = js.native
  var resourceType: Medication = js.native
}

object Anon257 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Medication): Anon257 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon257]
  }
  @scala.inline
  implicit class Anon257Ops[Self <: Anon257] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Medication): Self = {
        val ret = this.duplicate
