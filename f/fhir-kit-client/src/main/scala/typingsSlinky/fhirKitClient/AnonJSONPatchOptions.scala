...
object AnonJSONPatchOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: AdverseEvent): AnonJSONPatchOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonJSONPatchOptions]
  }
  @scala.inline
  implicit class AnonJSONPatchOptionsOps[Self <: AnonJSONPatchOptions] (val x: Self) extends AnyVal {
    @scala.inline
