...
object Anon272 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: PaymentNotice): Anon272 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon272]
  }
  @scala.inline
  implicit class Anon272Ops[Self <: Anon272] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: PaymentNotice): Self = {
        val ret = this.duplicate
