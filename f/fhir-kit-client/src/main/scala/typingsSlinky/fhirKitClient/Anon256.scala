...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Media
...
object Anon256 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Media): Anon256 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon256]
  }
  @scala.inline
  implicit class Anon256Ops[Self <: Anon256] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Media): Self = {
        val ret = this.duplicate
