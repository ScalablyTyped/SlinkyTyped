...
@js.native
trait Anon298 extends js.Object {
  var JSONPatch: js.Array[OpPatch] = js.native
  var headers: js.UndefOr[Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[Options] = js.native
  var resourceType: StructureMap = js.native
}

object Anon298 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: StructureMap): Anon298 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon298]
  }
  @scala.inline
  implicit class Anon298Ops[Self <: Anon298] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: StructureMap): Self = {
        val ret = this.duplicate
