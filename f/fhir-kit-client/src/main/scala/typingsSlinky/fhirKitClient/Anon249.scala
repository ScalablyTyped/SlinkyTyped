...
object Anon249 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ImplementationGuide): Anon249 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon249]
  }
  @scala.inline
  implicit class Anon249Ops[Self <: Anon249] (val x: Self) extends AnyVal {
    @scala.inline
