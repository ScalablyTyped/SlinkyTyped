...
object Anon261 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MedicationStatement): Anon261 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon261]
  }
  @scala.inline
  implicit class Anon261Ops[Self <: Anon261] (val x: Self) extends AnyVal {
    @scala.inline
