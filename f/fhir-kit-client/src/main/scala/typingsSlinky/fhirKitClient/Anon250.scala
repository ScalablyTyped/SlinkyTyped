...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Library
...
trait Anon250 extends js.Object {
  ...
  var resourceType: Library = js.native
}

object Anon250 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Library): Anon250 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon250]
  }
  @scala.inline
  implicit class Anon250Ops[Self <: Anon250] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Library): Self = {
        val ret = this.duplicate
