...
object Anon258 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MedicationAdministration): Anon258 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon258]
  }
  @scala.inline
  implicit class Anon258Ops[Self <: Anon258] (val x: Self) extends AnyVal {
    @scala.inline
