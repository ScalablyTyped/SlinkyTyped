...
object AnonBodyCoverage {
  @scala.inline
  def apply(body: Coverage, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Coverage): AnonBodyCoverage = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyCoverage]
  }
  @scala.inline
  implicit class AnonBodyCoverageOps[Self <: AnonBodyCoverage] (val x: Self) extends AnyVal {
    @scala.inline
