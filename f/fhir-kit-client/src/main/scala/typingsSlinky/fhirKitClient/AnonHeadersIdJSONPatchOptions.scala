...
object AnonHeadersIdJSONPatchOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: AuditEvent): AnonHeadersIdJSONPatchOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHeadersIdJSONPatchOptions]
  }
  @scala.inline
  implicit class AnonHeadersIdJSONPatchOptionsOps[Self <: AnonHeadersIdJSONPatchOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: AuditEvent): Self = {
        val ret = this.duplicate
