...
@js.native
trait AnonBodyOperationOutcomeHeadersHeaders extends js.Object {
...
object AnonBodyOperationOutcomeHeadersHeaders {
  @scala.inline
  def apply(
    body: OperationOutcome,
    id: String,
    resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.OperationOutcome
  ): AnonBodyOperationOutcomeHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyOperationOutcomeHeadersHeaders]
  }
  @scala.inline
  implicit class AnonBodyOperationOutcomeHeadersHeadersOps[Self <: AnonBodyOperationOutcomeHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
