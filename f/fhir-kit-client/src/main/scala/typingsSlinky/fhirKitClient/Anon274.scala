...
object Anon274 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Person): Anon274 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon274]
  }
  @scala.inline
  implicit class Anon274Ops[Self <: Anon274] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Person): Self = {
        val ret = this.duplicate
