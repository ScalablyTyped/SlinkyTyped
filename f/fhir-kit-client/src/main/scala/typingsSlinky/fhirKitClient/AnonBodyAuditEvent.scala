...
object AnonBodyAuditEvent {
  @scala.inline
  def apply(body: AuditEvent, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.AuditEvent): AnonBodyAuditEvent = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyAuditEvent]
  }
  @scala.inline
  implicit class AnonBodyAuditEventOps[Self <: AnonBodyAuditEvent] (val x: Self) extends AnyVal {
    @scala.inline
