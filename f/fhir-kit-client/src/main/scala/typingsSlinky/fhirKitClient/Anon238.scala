...
object Anon238 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: FamilyMemberHistory): Anon238 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon238]
  }
  @scala.inline
  implicit class Anon238Ops[Self <: Anon238] (val x: Self) extends AnyVal {
    @scala.inline
