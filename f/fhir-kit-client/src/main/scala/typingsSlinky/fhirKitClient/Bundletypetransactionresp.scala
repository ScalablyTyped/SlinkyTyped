...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.`transaction-response`
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Inlined fhir.fhir.Bundle & {  type  :'transaction-response'} */
@js.native
trait Bundletypetransactionresp extends js.Object {
  /**
  ...
  /**
    ...
    */
  var `type`: code with `transaction-response` = js.native
}

object Bundletypetransactionresp {
  @scala.inline
  def apply(`type`: code with `transaction-response`): Bundletypetransactionresp = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Bundletypetransactionresp]
  }
  @scala.inline
  implicit class BundletypetransactionrespOps[Self <: Bundletypetransactionresp] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withType(value: code with `transaction-response`): Self = {
