...
object Anon243 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: GuidanceResponse): Anon243 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon243]
  }
  @scala.inline
  implicit class Anon243Ops[Self <: Anon243] (val x: Self) extends AnyVal {
    @scala.inline
