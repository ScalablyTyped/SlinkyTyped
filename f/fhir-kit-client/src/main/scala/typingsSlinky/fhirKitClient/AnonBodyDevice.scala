...
object AnonBodyDevice {
  @scala.inline
  def apply(body: Device, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Device): AnonBodyDevice = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyDevice]
  }
  @scala.inline
  implicit class AnonBodyDeviceOps[Self <: AnonBodyDevice] (val x: Self) extends AnyVal {
    @scala.inline
