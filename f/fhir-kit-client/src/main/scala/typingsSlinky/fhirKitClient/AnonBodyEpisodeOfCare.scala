...
object AnonBodyEpisodeOfCare {
  @scala.inline
  def apply(body: EpisodeOfCare, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.EpisodeOfCare): AnonBodyEpisodeOfCare = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyEpisodeOfCare]
  }
  @scala.inline
  implicit class AnonBodyEpisodeOfCareOps[Self <: AnonBodyEpisodeOfCare] (val x: Self) extends AnyVal {
    @scala.inline
