...
object Anon262 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MessageDefinition): Anon262 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon262]
  }
  @scala.inline
  implicit class Anon262Ops[Self <: Anon262] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: MessageDefinition): Self = {
        val ret = this.duplicate
