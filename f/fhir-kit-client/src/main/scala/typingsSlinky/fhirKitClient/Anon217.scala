...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Coverage
...
object Anon217 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Coverage): Anon217 = {
  ...
  implicit class Anon217Ops[Self <: Anon217] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: Coverage): Self = {
        val ret = this.duplicate
