...
object AnonBodyTHeadersHeaders {
  @scala.inline
  def apply[T](body: T, id: String, resourceType: CustomResourceType): AnonBodyTHeadersHeaders[T] = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBodyTHeadersHeaders[T]]
  }
  @scala.inline
  implicit class AnonBodyTHeadersHeadersOps[Self[t] <: AnonBodyTHeadersHeaders[t], T] (val x: Self[T]) extends AnyVal {
    @scala.inline
