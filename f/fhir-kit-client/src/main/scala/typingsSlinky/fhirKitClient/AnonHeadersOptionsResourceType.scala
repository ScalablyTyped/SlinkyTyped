...
object AnonHeadersOptionsResourceType {
  @scala.inline
  def apply(body: Appointment, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Appointment): AnonHeadersOptionsResourceType = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHeadersOptionsResourceType]
  }
  @scala.inline
  implicit class AnonHeadersOptionsResourceTypeOps[Self <: AnonHeadersOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
