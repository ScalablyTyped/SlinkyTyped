...
object Anon307 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: VisionPrescription): Anon307 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon307]
  }
  @scala.inline
  implicit class Anon307Ops[Self <: Anon307] (val x: Self) extends AnyVal {
    @scala.inline
