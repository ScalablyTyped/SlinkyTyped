...
object Anon279 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ProcedureRequest): Anon279 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon279]
  }
  @scala.inline
  implicit class Anon279Ops[Self <: Anon279] (val x: Self) extends AnyVal {
    @scala.inline
