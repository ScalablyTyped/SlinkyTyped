...
trait Anon270 extends js.Object {
  ...
  var resourceType: Parameters = js.native
}

object Anon270 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Parameters): Anon270 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon270]
  }
  @scala.inline
  implicit class Anon270Ops[Self <: Anon270] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Parameters): Self = {
        val ret = this.duplicate
