...
object Anon301 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: SupplyDelivery): Anon301 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon301]
  }
  @scala.inline
  implicit class Anon301Ops[Self <: Anon301] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: SupplyDelivery): Self = {
        val ret = this.duplicate
