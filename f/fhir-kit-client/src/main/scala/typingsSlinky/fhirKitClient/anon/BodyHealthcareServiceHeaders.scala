...
trait BodyHealthcareServiceHeaders extends StObject {
  ...
  var resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.HealthcareService = js.native
}
object BodyHealthcareServiceHeaders {
  ...
  implicit class BodyHealthcareServiceHeadersMutableBuilder[Self <: BodyHealthcareServiceHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.HealthcareService): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
