...
object BodyBinaryHeadersHeaders {
  @scala.inline
  def apply(body: Binary, id: String, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Binary): BodyBinaryHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyBinaryHeadersHeaders]
  }
  @scala.inline
  implicit class BodyBinaryHeadersHeadersOps[Self <: BodyBinaryHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBody(value: Binary): Self = {
    ...
    @scala.inline
    def withResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Binary): Self = {
        val ret = this.duplicate
