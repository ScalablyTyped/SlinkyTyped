...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Immunization
...
object `39` {
  @scala.inline
  def apply(id: String, resourceType: Immunization): `39` = {
  ...
  implicit class `39Ops`[Self <: `39`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: Immunization): Self = {
        val ret = this.duplicate
