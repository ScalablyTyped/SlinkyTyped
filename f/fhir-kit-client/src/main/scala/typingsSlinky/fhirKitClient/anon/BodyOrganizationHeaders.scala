...
@js.native
trait BodyOrganizationHeaders extends StObject {
...
object BodyOrganizationHeaders {
  ...
  @scala.inline
  implicit class BodyOrganizationHeadersMutableBuilder[Self <: BodyOrganizationHeaders] (val x: Self) extends AnyVal {
