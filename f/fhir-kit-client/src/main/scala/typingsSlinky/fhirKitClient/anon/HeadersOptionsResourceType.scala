...
object HeadersOptionsResourceType {
  ...
  @scala.inline
  implicit class HeadersOptionsResourceTypeOps[Self <: HeadersOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Appointment): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
