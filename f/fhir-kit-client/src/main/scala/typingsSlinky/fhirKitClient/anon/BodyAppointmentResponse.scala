...
object BodyAppointmentResponse {
  ...
  implicit class BodyAppointmentResponseOps[Self <: BodyAppointmentResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: AppointmentResponse): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.AppointmentResponse): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
