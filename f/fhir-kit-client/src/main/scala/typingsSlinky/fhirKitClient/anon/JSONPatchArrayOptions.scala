...
@js.native
trait JSONPatchArrayOptions extends StObject {
...
object JSONPatchArrayOptions {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CapabilityStatement): JSONPatchArrayOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[JSONPatchArrayOptions]
  }
  
  @scala.inline
  implicit class JSONPatchArrayOptionsMutableBuilder[Self <: JSONPatchArrayOptions] (val x: Self) extends AnyVal {
