...
object `301` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: StructureMap): `301` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`301`]
  }
  
  @scala.inline
  implicit class `301MutableBuilder`[Self <: `301`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: StructureMap): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
