...
object BodyVisionPrescription {
  ...
  implicit class BodyVisionPrescriptionMutableBuilder[Self <: BodyVisionPrescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.VisionPrescription): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
