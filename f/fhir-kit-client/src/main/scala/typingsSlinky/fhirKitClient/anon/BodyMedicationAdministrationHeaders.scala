...
object BodyMedicationAdministrationHeaders {
  ...
  implicit class BodyMedicationAdministrationHeadersOps[Self <: BodyMedicationAdministrationHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MedicationAdministration): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
