...
object IdJSONPatchOptions {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Appointment): IdJSONPatchOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdJSONPatchOptions]
  }
  
  @scala.inline
  implicit class IdJSONPatchOptionsOps[Self <: IdJSONPatchOptions] (val x: Self) extends AnyVal {
