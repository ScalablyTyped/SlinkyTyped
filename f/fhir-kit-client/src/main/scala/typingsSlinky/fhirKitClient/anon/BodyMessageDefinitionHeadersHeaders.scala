...
@js.native
trait BodyMessageDefinitionHeadersHeaders extends js.Object {
...
object BodyMessageDefinitionHeadersHeaders {
  @scala.inline
  def apply(
    body: MessageDefinition,
    id: String,
    resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.MessageDefinition
  ): BodyMessageDefinitionHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyMessageDefinitionHeadersHeaders]
  }
  @scala.inline
  implicit class BodyMessageDefinitionHeadersHeadersOps[Self <: BodyMessageDefinitionHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
