...
object BodyHeadersIdOptionsResourceType {
  ...
  @scala.inline
  implicit class BodyHeadersIdOptionsResourceTypeOps[Self <: BodyHeadersIdOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: AdverseEvent): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.AdverseEvent): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
