...
@js.native
trait BodyOperationDefinitionHeaders extends js.Object {
...
object BodyOperationDefinitionHeaders {
  ...
  @scala.inline
  implicit class BodyOperationDefinitionHeadersOps[Self <: BodyOperationDefinitionHeaders] (val x: Self) extends AnyVal {
