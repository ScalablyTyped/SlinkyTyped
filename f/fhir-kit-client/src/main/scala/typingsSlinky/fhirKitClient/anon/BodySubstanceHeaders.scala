...
@js.native
trait BodySubstanceHeaders extends js.Object {
...
object BodySubstanceHeaders {
  ...
  @scala.inline
  implicit class BodySubstanceHeadersOps[Self <: BodySubstanceHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Substance): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Substance): Self = this.set("resourceType", value.asInstanceOf[js.Any])
