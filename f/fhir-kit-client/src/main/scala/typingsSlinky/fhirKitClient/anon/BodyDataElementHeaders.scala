...
@js.native
trait BodyDataElementHeaders extends js.Object {
...
object BodyDataElementHeaders {
  ...
  @scala.inline
  implicit class BodyDataElementHeadersOps[Self <: BodyDataElementHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: DataElement): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.DataElement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
