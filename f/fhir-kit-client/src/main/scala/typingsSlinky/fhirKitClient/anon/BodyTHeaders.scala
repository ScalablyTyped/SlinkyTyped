...
object BodyTHeaders {
  @scala.inline
  def apply[/* <: typingsSlinky.fhirKitClient.mod.CustomResource */ T](body: T, id: String, resourceType: CustomResourceType): BodyTHeaders[T] = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyTHeaders[T]]
  }
  @scala.inline
  implicit class BodyTHeadersOps[Self <: BodyTHeaders[_], /* <: typingsSlinky.fhirKitClient.mod.CustomResource */ T] (val x: Self with BodyTHeaders[T]) extends AnyVal {
    @scala.inline
