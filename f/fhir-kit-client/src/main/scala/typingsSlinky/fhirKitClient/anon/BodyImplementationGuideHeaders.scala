...
@js.native
trait BodyImplementationGuideHeaders extends js.Object {
...
object BodyImplementationGuideHeaders {
  ...
  @scala.inline
  implicit class BodyImplementationGuideHeadersOps[Self <: BodyImplementationGuideHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ImplementationGuide): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ImplementationGuide): Self = this.set("resourceType", value.asInstanceOf[js.Any])
