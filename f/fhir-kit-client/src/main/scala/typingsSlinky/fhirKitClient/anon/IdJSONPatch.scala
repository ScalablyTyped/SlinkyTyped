...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.ActivityDefinition
...
@js.native
trait IdJSONPatch extends js.Object {
  ...
  var resourceType: ActivityDefinition = js.native
}
object IdJSONPatch {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ActivityDefinition): IdJSONPatch = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdJSONPatch]
  }
  
  @scala.inline
  implicit class IdJSONPatchOps[Self <: IdJSONPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ActivityDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
