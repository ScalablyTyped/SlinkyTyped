...
@js.native
trait BodyRiskAssessmentHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.RiskAssessment = js.native
}
object BodyRiskAssessmentHeaders {
  ...
  @scala.inline
  implicit class BodyRiskAssessmentHeadersOps[Self <: BodyRiskAssessmentHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: RiskAssessment): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.RiskAssessment): Self = this.set("resourceType", value.asInstanceOf[js.Any])
