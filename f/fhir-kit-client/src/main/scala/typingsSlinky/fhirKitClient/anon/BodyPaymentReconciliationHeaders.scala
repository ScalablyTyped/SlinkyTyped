...
@js.native
trait BodyPaymentReconciliationHeaders extends js.Object {
...
object BodyPaymentReconciliationHeaders {
  ...
  @scala.inline
  implicit class BodyPaymentReconciliationHeadersOps[Self <: BodyPaymentReconciliationHeaders] (val x: Self) extends AnyVal {
