...
object BodyPaymentReconciliation {
  ...
  @scala.inline
  implicit class BodyPaymentReconciliationOps[Self <: BodyPaymentReconciliation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: PaymentReconciliation): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.PaymentReconciliation): Self = this.set("resourceType", value.asInstanceOf[js.Any])
