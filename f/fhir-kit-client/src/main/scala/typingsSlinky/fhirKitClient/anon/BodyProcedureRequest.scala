...
object BodyProcedureRequest {
  ...
  @scala.inline
  implicit class BodyProcedureRequestOps[Self <: BodyProcedureRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ProcedureRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
