...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Slot
...
trait `298` extends js.Object {
  ...
  var resourceType: Slot = js.native
}

object `298` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Slot): `298` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`298`]
  }
  @scala.inline
  implicit class `298Ops`[Self <: `298`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: Slot): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
