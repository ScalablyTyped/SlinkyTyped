...
@js.native
trait BodyHeadersIdOptions extends js.Object {
...
object BodyHeadersIdOptions {
  ...
  @scala.inline
  implicit class BodyHeadersIdOptionsOps[Self <: BodyHeadersIdOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: ActivityDefinition): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ActivityDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
