...
object BodyConsent {
  ...
  @scala.inline
  implicit class BodyConsentOps[Self <: BodyConsent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Consent): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Consent): Self = this.set("resourceType", value.asInstanceOf[js.Any])
