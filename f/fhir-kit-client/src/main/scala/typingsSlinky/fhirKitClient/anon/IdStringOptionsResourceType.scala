...
@js.native
trait IdStringOptionsResourceType extends js.Object {
...
object IdStringOptionsResourceType {
  ...
  @scala.inline
  def apply(id: String, resourceType: CareTeam): IdStringOptionsResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringOptionsResourceType]
  }
  
  @scala.inline
  implicit class IdStringOptionsResourceTypeOps[Self <: IdStringOptionsResourceType] (val x: Self) extends AnyVal {
