...
@js.native
trait IdStringJSONPatchArrayOptions extends js.Object {
  ...
  var resourceType: CareTeam = js.native
}
object IdStringJSONPatchArrayOptions {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CareTeam): IdStringJSONPatchArrayOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringJSONPatchArrayOptions]
  }
  
  @scala.inline
  implicit class IdStringJSONPatchArrayOptionsOps[Self <: IdStringJSONPatchArrayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: CareTeam): Self = this.set("resourceType", value.asInstanceOf[js.Any])
