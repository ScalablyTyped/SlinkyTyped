...
object IdStringJSONPatchArrayOptions {
  ...
  @scala.inline
  implicit class IdStringJSONPatchArrayOptionsMutableBuilder[Self <: IdStringJSONPatchArrayOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: CareTeam): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
