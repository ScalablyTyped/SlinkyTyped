...
object BodyCompartmentDefinitionHeaders {
  ...
  @scala.inline
  implicit class BodyCompartmentDefinitionHeadersMutableBuilder[Self <: BodyCompartmentDefinitionHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.CompartmentDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
