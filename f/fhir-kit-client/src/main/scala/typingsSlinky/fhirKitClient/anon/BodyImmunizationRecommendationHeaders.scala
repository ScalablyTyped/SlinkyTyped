...
@js.native
trait BodyImmunizationRecommendationHeaders extends js.Object {
...
object BodyImmunizationRecommendationHeaders {
  ...
  @scala.inline
  implicit class BodyImmunizationRecommendationHeadersOps[Self <: BodyImmunizationRecommendationHeaders] (val x: Self) extends AnyVal {
    @scala.inline
