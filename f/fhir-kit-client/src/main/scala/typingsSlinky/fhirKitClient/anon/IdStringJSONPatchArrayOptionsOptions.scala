...
object IdStringJSONPatchArrayOptionsOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CareTeam): IdStringJSONPatchArrayOptionsOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringJSONPatchArrayOptionsOptions]
  }
  @scala.inline
  implicit class IdStringJSONPatchArrayOptionsOptionsOps[Self <: IdStringJSONPatchArrayOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
