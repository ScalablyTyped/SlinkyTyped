...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.transaction
...
object Bundletypetransaction {
  ...
  @scala.inline
  implicit class BundletypetransactionMutableBuilder[Self <: Bundletypetransaction] (val x: Self) extends AnyVal {
