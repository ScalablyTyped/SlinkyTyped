...
object JSONPatchArrayOptionsOptionsResourceType {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ChargeItem): JSONPatchArrayOptionsOptionsResourceType = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[JSONPatchArrayOptionsOptionsResourceType]
  }
  @scala.inline
  implicit class JSONPatchArrayOptionsOptionsResourceTypeOps[Self <: JSONPatchArrayOptionsOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
