...
trait `257` extends StObject {
  ...
  var resourceType: Measure = js.native
}
object `257` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Measure): `257` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`257`]
  }
  
  @scala.inline
  implicit class `257MutableBuilder`[Self <: `257`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Measure): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
