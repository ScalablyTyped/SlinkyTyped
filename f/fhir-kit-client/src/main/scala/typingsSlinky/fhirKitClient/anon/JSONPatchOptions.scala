...
@js.native
trait JSONPatchOptions extends js.Object {
...
object JSONPatchOptions {
  ...
  @scala.inline
  implicit class JSONPatchOptionsOps[Self <: JSONPatchOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: AdverseEvent): Self = {
        val ret = this.duplicate
