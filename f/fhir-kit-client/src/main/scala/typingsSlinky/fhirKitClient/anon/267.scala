...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.NamingSystem
...
object `267` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: NamingSystem): `267` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`267`]
  }
  @scala.inline
  implicit class `267Ops`[Self <: `267`] (val x: Self) extends AnyVal {
    @scala.inline
