...
object BodyCapabilityStatement {
  ...
  @scala.inline
  implicit class BodyCapabilityStatementOps[Self <: BodyCapabilityStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.CapabilityStatement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
