...
object BodyMeasureReport {
  @scala.inline
  def apply(body: MeasureReport, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.MeasureReport): BodyMeasureReport = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyMeasureReport]
  }
  @scala.inline
  implicit class BodyMeasureReportOps[Self <: BodyMeasureReport] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MeasureReport): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
