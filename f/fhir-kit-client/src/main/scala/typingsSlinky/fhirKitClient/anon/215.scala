...
trait `215` extends StObject {
  ...
  var resourceType: Composition = js.native
}
object `215` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Composition): `215` = {
  ...
  implicit class `215MutableBuilder`[Self <: `215`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Composition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
