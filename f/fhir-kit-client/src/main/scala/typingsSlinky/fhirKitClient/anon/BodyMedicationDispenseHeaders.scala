...
@js.native
trait BodyMedicationDispenseHeaders extends js.Object {
...
object BodyMedicationDispenseHeaders {
  ...
  @scala.inline
  implicit class BodyMedicationDispenseHeadersOps[Self <: BodyMedicationDispenseHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MedicationDispense): Self = this.set("resourceType", value.asInstanceOf[js.Any])
