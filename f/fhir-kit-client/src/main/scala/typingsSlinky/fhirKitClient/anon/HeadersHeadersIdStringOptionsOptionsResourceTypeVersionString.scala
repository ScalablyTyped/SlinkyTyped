...
trait HeadersHeadersIdStringOptionsOptionsResourceTypeVersionString extends js.Object {
  ...
  var resourceType: BodySite = js.native
  var version: String = js.native
}

object HeadersHeadersIdStringOptionsOptionsResourceTypeVersionString {
  @scala.inline
  def apply(id: String, resourceType: BodySite, version: String): HeadersHeadersIdStringOptionsOptionsResourceTypeVersionString = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersHeadersIdStringOptionsOptionsResourceTypeVersionString]
  }
  @scala.inline
  implicit class HeadersHeadersIdStringOptionsOptionsResourceTypeVersionStringOps[Self <: HeadersHeadersIdStringOptionsOptionsResourceTypeVersionString] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: BodySite): Self = {
        val ret = this.duplicate
