...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.RequestGroup
...
object `187` {
  @scala.inline
  def apply(id: String, resourceType: RequestGroup, version: String): `187` = {
  ...
  implicit class `187Ops`[Self <: `187`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: RequestGroup): Self = {
        val ret = this.duplicate
