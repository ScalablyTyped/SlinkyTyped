...
object `284` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ProcessResponse): `284` = {
  ...
  implicit class `284Ops`[Self <: `284`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ProcessResponse): Self = this.set("resourceType", value.asInstanceOf[js.Any])
