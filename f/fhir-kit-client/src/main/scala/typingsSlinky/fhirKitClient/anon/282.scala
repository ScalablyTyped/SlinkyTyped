...
object `282` {
  ...
  @scala.inline
  implicit class `282Ops`[Self <: `282`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ProcedureRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
