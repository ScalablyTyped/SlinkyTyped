...
object `282` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ProcedureRequest): `282` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`282`]
  }
  
  @scala.inline
  implicit class `282MutableBuilder`[Self <: `282`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ProcedureRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
