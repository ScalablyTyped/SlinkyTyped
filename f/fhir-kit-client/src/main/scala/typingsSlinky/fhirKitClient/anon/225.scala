...
object `225` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: DeviceMetric): `225` = {
  ...
  implicit class `225MutableBuilder`[Self <: `225`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: DeviceMetric): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
