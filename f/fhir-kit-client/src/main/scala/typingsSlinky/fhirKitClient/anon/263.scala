...
trait `263` extends StObject {
  ...
  var resourceType: MedicationRequest = js.native
}
object `263` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: MedicationRequest): `263` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`263`]
  }
  
  @scala.inline
  implicit class `263MutableBuilder`[Self <: `263`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: MedicationRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
