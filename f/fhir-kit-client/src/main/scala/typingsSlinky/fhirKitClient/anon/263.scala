...
object `263` {
  ...
  @scala.inline
  implicit class `263Ops`[Self <: `263`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: MedicationRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
