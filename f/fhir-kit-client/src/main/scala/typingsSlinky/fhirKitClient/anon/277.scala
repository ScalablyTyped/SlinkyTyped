...
trait `277` extends StObject {
  ...
  var resourceType: Person = js.native
}
object `277` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Person): `277` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`277`]
  }
  
  @scala.inline
  implicit class `277MutableBuilder`[Self <: `277`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Person): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
