...
object `217` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Condition): `217` = {
  ...
  implicit class `217MutableBuilder`[Self <: `217`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Condition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
