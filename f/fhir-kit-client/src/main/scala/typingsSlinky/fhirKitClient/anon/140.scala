...
object `140` {
  ...
  @scala.inline
  def apply(id: String, resourceType: ExplanationOfBenefit, version: String): `140` = {
  ...
  implicit class `140MutableBuilder`[Self <: `140`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ExplanationOfBenefit): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
