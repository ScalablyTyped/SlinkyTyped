...
object BodyPerson {
  ...
  @scala.inline
  implicit class BodyPersonOps[Self <: BodyPerson] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Person): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Person): Self = this.set("resourceType", value.asInstanceOf[js.Any])
