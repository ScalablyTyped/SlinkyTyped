...
object BodyBundletypetransaction {
  ...
  @scala.inline
  implicit class BodyBundletypetransactionOps[Self <: BodyBundletypetransaction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Bundletypetransaction): Self = this.set("body", value.asInstanceOf[js.Any])
