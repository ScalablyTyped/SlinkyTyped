...
object BodyT {
  @scala.inline
  def apply[/* <: typingsSlinky.fhirKitClient.mod.CustomResource */ T](body: T, resourceType: CustomResourceType): BodyT[T] = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyT[T]]
  }
  @scala.inline
  implicit class BodyTOps[Self <: BodyT[_], /* <: typingsSlinky.fhirKitClient.mod.CustomResource */ T] (val x: Self with BodyT[T]) extends AnyVal {
    @scala.inline
