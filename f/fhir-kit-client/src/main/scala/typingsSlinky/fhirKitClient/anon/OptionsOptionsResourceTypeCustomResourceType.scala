...
object OptionsOptionsResourceTypeCustomResourceType {
  @scala.inline
  def apply(id: String, resourceType: CustomResourceType, version: String): OptionsOptionsResourceTypeCustomResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[OptionsOptionsResourceTypeCustomResourceType]
  }
  @scala.inline
  implicit class OptionsOptionsResourceTypeCustomResourceTypeOps[Self <: OptionsOptionsResourceTypeCustomResourceType] (val x: Self) extends AnyVal {
    @scala.inline
