...
trait `218` extends StObject {
  ...
  var resourceType: Consent = js.native
}
object `218` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Consent): `218` = {
  ...
  implicit class `218MutableBuilder`[Self <: `218`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Consent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
