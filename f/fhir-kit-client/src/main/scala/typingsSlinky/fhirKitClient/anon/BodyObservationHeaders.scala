...
@js.native
trait BodyObservationHeaders extends StObject {
...
object BodyObservationHeaders {
  ...
  @scala.inline
  implicit class BodyObservationHeadersMutableBuilder[Self <: BodyObservationHeaders] (val x: Self) extends AnyVal {
