...
@js.native
trait IdJSONPatchOptionsResourceType extends StObject {
...
object IdJSONPatchOptionsResourceType {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Basic): IdJSONPatchOptionsResourceType = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdJSONPatchOptionsResourceType]
  }
  
  @scala.inline
  implicit class IdJSONPatchOptionsResourceTypeMutableBuilder[Self <: IdJSONPatchOptionsResourceType] (val x: Self) extends AnyVal {
