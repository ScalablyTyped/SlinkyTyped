...
object BodyTestReport {
  @scala.inline
  def apply(body: TestReport, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.TestReport): BodyTestReport = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyTestReport]
  }
  @scala.inline
  implicit class BodyTestReportOps[Self <: BodyTestReport] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: TestReport): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.TestReport): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
