...
object BodyProcedureHeadersHeaders {
  ...
  def apply(
    body: Procedure,
    id: String,
    resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Procedure
  ): BodyProcedureHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyProcedureHeadersHeaders]
  }
  @scala.inline
  implicit class BodyProcedureHeadersHeadersOps[Self <: BodyProcedureHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    def duplicate: Self = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x)).asInstanceOf[Self]
    @scala.inline
    def combineWith[Other <: js.Any](other: Other): Self with Other = (js.Dynamic.global.Object.assign(js.Dynamic.literal(), x, other.asInstanceOf[js.Any])).asInstanceOf[Self with Other]
    @scala.inline
    def withBody(value: Procedure): Self = {
    ...
    @scala.inline
    def withResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Procedure): Self = {
        val ret = this.duplicate
