...
object BodyGraphDefinition {
  ...
  @scala.inline
  implicit class BodyGraphDefinitionOps[Self <: BodyGraphDefinition] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.GraphDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
