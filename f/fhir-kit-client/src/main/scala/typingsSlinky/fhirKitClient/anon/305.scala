...
object `305` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: TestScript): `305` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`305`]
  }
  @scala.inline
  implicit class `305Ops`[Self <: `305`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: TestScript): Self = {
        val ret = this.duplicate
