...
object BodyServiceDefinitionHeaders {
  ...
  implicit class BodyServiceDefinitionHeadersMutableBuilder[Self <: BodyServiceDefinitionHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ServiceDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
