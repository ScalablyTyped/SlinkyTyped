...
@js.native
trait BodyServiceDefinitionHeaders extends js.Object {
  var body: ServiceDefinition = js.native
  var headers: js.UndefOr[typingsSlinky.request.mod.Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[typingsSlinky.request.mod.Options] = js.native
  var resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.ServiceDefinition = js.native
}
...
object BodyServiceDefinitionHeaders {
  ...
  @scala.inline
  implicit class BodyServiceDefinitionHeadersOps[Self <: BodyServiceDefinitionHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: ServiceDefinition): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ServiceDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
