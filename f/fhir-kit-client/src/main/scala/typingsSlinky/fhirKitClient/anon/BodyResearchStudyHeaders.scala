...
@js.native
trait BodyResearchStudyHeaders extends StObject {
...
object BodyResearchStudyHeaders {
  ...
  @scala.inline
  implicit class BodyResearchStudyHeadersMutableBuilder[Self <: BodyResearchStudyHeaders] (val x: Self) extends AnyVal {
