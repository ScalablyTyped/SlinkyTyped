...
object BodyMedicationAdministration {
  ...
  implicit class BodyMedicationAdministrationOps[Self <: BodyMedicationAdministration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withBody(value: MedicationAdministration): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("body")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MedicationAdministration): Self = {
        val ret = this.duplicate
