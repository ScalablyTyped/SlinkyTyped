...
@js.native
trait BodyPaymentNoticeHeaders extends js.Object {
...
object BodyPaymentNoticeHeaders {
  ...
  @scala.inline
  implicit class BodyPaymentNoticeHeadersOps[Self <: BodyPaymentNoticeHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: PaymentNotice): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.PaymentNotice): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
