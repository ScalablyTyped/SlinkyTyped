...
object BodySequence {
  ...
  @scala.inline
  implicit class BodySequenceOps[Self <: BodySequence] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Sequence): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Sequence): Self = this.set("resourceType", value.asInstanceOf[js.Any])
