...
@js.native
trait BodySupplyRequestHeaders extends StObject {
...
object BodySupplyRequestHeaders {
  ...
  @scala.inline
  implicit class BodySupplyRequestHeadersMutableBuilder[Self <: BodySupplyRequestHeaders] (val x: Self) extends AnyVal {
