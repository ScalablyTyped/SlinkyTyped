...
object HeadersHeadersIdStringJSONPatchArrayOptionsOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Claim): HeadersHeadersIdStringJSONPatchArrayOptionsOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersHeadersIdStringJSONPatchArrayOptionsOptions]
  }
  @scala.inline
  implicit class HeadersHeadersIdStringJSONPatchArrayOptionsOptionsOps[Self <: HeadersHeadersIdStringJSONPatchArrayOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
