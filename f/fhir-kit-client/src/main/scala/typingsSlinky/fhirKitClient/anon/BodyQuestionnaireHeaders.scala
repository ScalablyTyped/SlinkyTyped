...
@js.native
trait BodyQuestionnaireHeaders extends js.Object {
...
object BodyQuestionnaireHeaders {
  ...
  @scala.inline
  implicit class BodyQuestionnaireHeadersOps[Self <: BodyQuestionnaireHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Questionnaire): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Questionnaire): Self = this.set("resourceType", value.asInstanceOf[js.Any])
