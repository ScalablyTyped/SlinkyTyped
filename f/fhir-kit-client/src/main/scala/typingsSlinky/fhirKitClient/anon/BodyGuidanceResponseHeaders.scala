...
@js.native
trait BodyGuidanceResponseHeaders extends js.Object {
...
object BodyGuidanceResponseHeaders {
  ...
  @scala.inline
  implicit class BodyGuidanceResponseHeadersOps[Self <: BodyGuidanceResponseHeaders] (val x: Self) extends AnyVal {
    @scala.inline
