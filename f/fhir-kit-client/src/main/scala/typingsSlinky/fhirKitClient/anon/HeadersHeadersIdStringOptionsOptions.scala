...
object HeadersHeadersIdStringOptionsOptions {
  @scala.inline
  def apply(id: String, resourceType: Claim): HeadersHeadersIdStringOptionsOptions = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersHeadersIdStringOptionsOptions]
  }
  @scala.inline
  implicit class HeadersHeadersIdStringOptionsOptionsOps[Self <: HeadersHeadersIdStringOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
