...
object `299` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Specimen): `299` = {
  ...
  implicit class `299Ops`[Self <: `299`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Specimen): Self = this.set("resourceType", value.asInstanceOf[js.Any])
