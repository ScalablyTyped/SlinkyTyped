...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.Subscription
...
trait `299` extends js.Object {
  ...
  var resourceType: Subscription = js.native
}

object `299` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Subscription): `299` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`299`]
  }
  @scala.inline
  implicit class `299Ops`[Self <: `299`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Subscription): Self = {
        val ret = this.duplicate
