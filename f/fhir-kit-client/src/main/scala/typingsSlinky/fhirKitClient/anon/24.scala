...
trait `24` extends js.Object {
  ...
  var resourceType: EligibilityRequest = js.native
}

object `24` {
  @scala.inline
  def apply(id: String, resourceType: EligibilityRequest): `24` = {
  ...
  implicit class `24Ops`[Self <: `24`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: EligibilityRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
