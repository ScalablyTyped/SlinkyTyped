...
object BodyLinkage {
  @scala.inline
  def apply(body: Linkage, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Linkage): BodyLinkage = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyLinkage]
  }
  @scala.inline
  implicit class BodyLinkageOps[Self <: BodyLinkage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Linkage): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Linkage): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
