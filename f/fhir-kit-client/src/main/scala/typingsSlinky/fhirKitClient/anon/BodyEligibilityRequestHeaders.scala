...
@js.native
trait BodyEligibilityRequestHeaders extends js.Object {
...
object BodyEligibilityRequestHeaders {
  ...
  @scala.inline
  implicit class BodyEligibilityRequestHeadersOps[Self <: BodyEligibilityRequestHeaders] (val x: Self) extends AnyVal {
