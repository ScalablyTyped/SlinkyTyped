...
object BodyImmunization {
  @scala.inline
  def apply(body: Immunization, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Immunization): BodyImmunization = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyImmunization]
  }
  @scala.inline
  implicit class BodyImmunizationOps[Self <: BodyImmunization] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: Immunization): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Immunization): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
