...
@js.native
trait BodyEndpoint extends js.Object {
...
object BodyEndpoint {
  ...
  @scala.inline
  implicit class BodyEndpointOps[Self <: BodyEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Endpoint): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Endpoint): Self = this.set("resourceType", value.asInstanceOf[js.Any])
