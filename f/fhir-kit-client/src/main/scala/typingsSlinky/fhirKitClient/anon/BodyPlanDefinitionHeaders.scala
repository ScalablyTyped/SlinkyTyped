...
@js.native
trait BodyPlanDefinitionHeaders extends StObject {
...
object BodyPlanDefinitionHeaders {
  ...
  @scala.inline
  implicit class BodyPlanDefinitionHeadersMutableBuilder[Self <: BodyPlanDefinitionHeaders] (val x: Self) extends AnyVal {
