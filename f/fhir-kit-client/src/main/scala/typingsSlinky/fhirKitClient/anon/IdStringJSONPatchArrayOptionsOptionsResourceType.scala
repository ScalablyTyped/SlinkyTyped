...
object IdStringJSONPatchArrayOptionsOptionsResourceType {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ClaimResponse): IdStringJSONPatchArrayOptionsOptionsResourceType = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringJSONPatchArrayOptionsOptionsResourceType]
  }
  @scala.inline
  implicit class IdStringJSONPatchArrayOptionsOptionsResourceTypeOps[Self <: IdStringJSONPatchArrayOptionsOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
