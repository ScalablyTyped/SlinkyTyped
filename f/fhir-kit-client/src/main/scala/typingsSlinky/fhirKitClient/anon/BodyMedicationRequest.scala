...
object BodyMedicationRequest {
  ...
  implicit class BodyMedicationRequestMutableBuilder[Self <: BodyMedicationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MedicationRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
