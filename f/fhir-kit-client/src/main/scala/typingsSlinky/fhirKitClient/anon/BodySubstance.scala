...
@js.native
trait BodySubstance extends StObject {
...
object BodySubstance {
  ...
  @scala.inline
  def apply(body: Substance, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Substance): BodySubstance = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodySubstance]
  }
  
  @scala.inline
  implicit class BodySubstanceMutableBuilder[Self <: BodySubstance] (val x: Self) extends AnyVal {
