...
@js.native
trait BodySequenceHeadersHeaders extends js.Object {
...
object BodySequenceHeadersHeaders {
  @scala.inline
  def apply(
    body: Sequence,
    id: String,
    resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Sequence
  ): BodySequenceHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodySequenceHeadersHeaders]
  }
  @scala.inline
  implicit class BodySequenceHeadersHeadersOps[Self <: BodySequenceHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
