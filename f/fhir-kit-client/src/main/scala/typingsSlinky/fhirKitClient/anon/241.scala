...
object `241` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: FamilyMemberHistory): `241` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`241`]
  }
  
  @scala.inline
  implicit class `241MutableBuilder`[Self <: `241`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: FamilyMemberHistory): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
