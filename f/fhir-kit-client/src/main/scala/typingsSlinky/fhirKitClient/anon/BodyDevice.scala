...
@js.native
trait BodyDevice extends js.Object {
...
object BodyDevice {
  ...
  @scala.inline
  implicit class BodyDeviceOps[Self <: BodyDevice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Device): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Device): Self = this.set("resourceType", value.asInstanceOf[js.Any])
