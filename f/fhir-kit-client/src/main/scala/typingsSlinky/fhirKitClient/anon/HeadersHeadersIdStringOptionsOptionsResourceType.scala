...
object HeadersHeadersIdStringOptionsOptionsResourceType {
  @scala.inline
  def apply(id: String, resourceType: ClinicalImpression): HeadersHeadersIdStringOptionsOptionsResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersHeadersIdStringOptionsOptionsResourceType]
  }
  @scala.inline
  implicit class HeadersHeadersIdStringOptionsOptionsResourceTypeOps[Self <: HeadersHeadersIdStringOptionsOptionsResourceType] (val x: Self) extends AnyVal {
    @scala.inline
