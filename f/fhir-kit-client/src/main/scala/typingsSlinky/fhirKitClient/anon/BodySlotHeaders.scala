...
object BodySlotHeaders {
  @scala.inline
  def apply(body: Slot, id: String, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Slot): BodySlotHeaders = {
  ...
  implicit class BodySlotHeadersOps[Self <: BodySlotHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Slot): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
