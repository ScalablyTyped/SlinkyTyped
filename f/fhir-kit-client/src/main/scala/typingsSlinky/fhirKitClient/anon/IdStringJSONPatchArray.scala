...
@js.native
trait IdStringJSONPatchArray extends js.Object {
...
object IdStringJSONPatchArray {
  ...
  @scala.inline
  implicit class IdStringJSONPatchArrayOps[Self <: IdStringJSONPatchArray] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Bundle): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
