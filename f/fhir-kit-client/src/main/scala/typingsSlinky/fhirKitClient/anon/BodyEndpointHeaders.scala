...
@js.native
trait BodyEndpointHeaders extends StObject {
...
object BodyEndpointHeaders {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BodyEndpointHeaders]
  }
  
  @scala.inline
  implicit class BodyEndpointHeadersMutableBuilder[Self <: BodyEndpointHeaders] (val x: Self) extends AnyVal {
