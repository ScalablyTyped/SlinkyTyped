...
object `242` {
  ...
  @scala.inline
  implicit class `242MutableBuilder`[Self <: `242`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Flag): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
