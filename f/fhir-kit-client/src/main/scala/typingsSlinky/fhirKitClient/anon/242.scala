...
object `242` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Flag): `242` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`242`]
  }
  @scala.inline
  implicit class `242Ops`[Self <: `242`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: Flag): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
