...
@js.native
trait OptionsResourceTypeCustomResourceType extends js.Object {
...
object OptionsResourceTypeCustomResourceType {
  ...
  @scala.inline
  def apply(id: String, resourceType: CustomResourceType, version: String): OptionsResourceTypeCustomResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[OptionsResourceTypeCustomResourceType]
  }
  
  @scala.inline
  implicit class OptionsResourceTypeCustomResourceTypeOps[Self <: OptionsResourceTypeCustomResourceType] (val x: Self) extends AnyVal {
