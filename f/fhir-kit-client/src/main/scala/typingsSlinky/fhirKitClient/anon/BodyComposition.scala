...
object BodyComposition {
  ...
  @scala.inline
  implicit class BodyCompositionOps[Self <: BodyComposition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Composition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
