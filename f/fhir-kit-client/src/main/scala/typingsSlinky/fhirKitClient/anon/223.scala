...
trait `223` extends js.Object {
  ...
  var resourceType: DeviceRequest = js.native
}

object `223` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: DeviceRequest): `223` = {
  ...
  implicit class `223Ops`[Self <: `223`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: DeviceRequest): Self = {
        val ret = this.duplicate
