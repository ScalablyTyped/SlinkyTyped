...
trait `223` extends StObject {
  ...
  var resourceType: Device = js.native
}
object `223` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Device): `223` = {
  ...
  implicit class `223MutableBuilder`[Self <: `223`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Device): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
