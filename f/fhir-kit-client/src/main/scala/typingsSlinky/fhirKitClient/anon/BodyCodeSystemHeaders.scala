...
@js.native
trait BodyCodeSystemHeaders extends js.Object {
...
object BodyCodeSystemHeaders {
  ...
  @scala.inline
  implicit class BodyCodeSystemHeadersOps[Self <: BodyCodeSystemHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: CodeSystem): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.CodeSystem): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
