...
@js.native
trait JSONPatchArrayOptionsOptions extends js.Object {
...
object JSONPatchArrayOptionsOptions {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: CapabilityStatement): JSONPatchArrayOptionsOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[JSONPatchArrayOptionsOptions]
  }
  @scala.inline
  implicit class JSONPatchArrayOptionsOptionsOps[Self <: JSONPatchArrayOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
