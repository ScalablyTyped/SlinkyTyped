...
object OptionsOptionsResourceTypeVersionString {
  @scala.inline
  def apply(id: String, resourceType: Basic, version: String): OptionsOptionsResourceTypeVersionString = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[OptionsOptionsResourceTypeVersionString]
  }
  @scala.inline
  implicit class OptionsOptionsResourceTypeVersionStringOps[Self <: OptionsOptionsResourceTypeVersionString] (val x: Self) extends AnyVal {
    @scala.inline
