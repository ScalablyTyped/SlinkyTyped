...
object BodyEncounter {
  ...
  @scala.inline
  implicit class BodyEncounterOps[Self <: BodyEncounter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Encounter): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.Encounter): Self = this.set("resourceType", value.asInstanceOf[js.Any])
