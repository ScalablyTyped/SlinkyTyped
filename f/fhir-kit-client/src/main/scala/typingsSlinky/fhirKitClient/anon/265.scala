...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.NutritionOrder
...
trait `265` extends js.Object {
  ...
  var resourceType: NutritionOrder = js.native
}

object `265` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: NutritionOrder): `265` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`265`]
  }
  @scala.inline
  implicit class `265Ops`[Self <: `265`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: NutritionOrder): Self = {
        val ret = this.duplicate
