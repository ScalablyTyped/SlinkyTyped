...
object IdStringOptionsOptions {
  @scala.inline
  def apply(id: String, resourceType: CareTeam): IdStringOptionsOptions = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringOptionsOptions]
  }
  @scala.inline
  implicit class IdStringOptionsOptionsOps[Self <: IdStringOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
