...
@js.native
trait BodyQuestionnaireResponseHeaders extends js.Object {
...
object BodyQuestionnaireResponseHeaders {
  ...
  @scala.inline
  implicit class BodyQuestionnaireResponseHeadersOps[Self <: BodyQuestionnaireResponseHeaders] (val x: Self) extends AnyVal {
    @scala.inline
