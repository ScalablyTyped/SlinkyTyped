...
object BodyPatientHeadersHeaders {
  @scala.inline
  def apply(body: Patient, id: String, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Patient): BodyPatientHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyPatientHeadersHeaders]
  }
  @scala.inline
  implicit class BodyPatientHeadersHeadersOps[Self <: BodyPatientHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
