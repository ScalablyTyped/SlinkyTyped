...
trait `283` extends StObject {
  ...
  var resourceType: ProcessRequest = js.native
}
object `283` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ProcessRequest): `283` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`283`]
  }
  
  @scala.inline
  implicit class `283MutableBuilder`[Self <: `283`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ProcessRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
