...
object HeadersHeadersOptionsOptions {
  @scala.inline
  def apply(resourceType: typingsSlinky.fhirKitClient.mod.ResourceType): HeadersHeadersOptionsOptions = {
  ...
  @scala.inline
  implicit class HeadersHeadersOptionsOptionsOps[Self <: HeadersHeadersOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
