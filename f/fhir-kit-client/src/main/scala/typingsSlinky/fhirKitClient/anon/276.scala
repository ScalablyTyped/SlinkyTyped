...
object `276` {
  ...
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: PaymentReconciliation): `276` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`276`]
  }
  
  @scala.inline
  implicit class `276Ops`[Self <: `276`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: PaymentReconciliation): Self = this.set("resourceType", value.asInstanceOf[js.Any])
