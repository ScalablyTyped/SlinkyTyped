...
object `276` {
  ...
  @scala.inline
  implicit class `276MutableBuilder`[Self <: `276`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: PaymentReconciliation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
