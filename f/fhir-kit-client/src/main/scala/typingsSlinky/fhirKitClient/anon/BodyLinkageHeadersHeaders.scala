...
object BodyLinkageHeadersHeaders {
  @scala.inline
  def apply(body: Linkage, id: String, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Linkage): BodyLinkageHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyLinkageHeadersHeaders]
  }
  @scala.inline
  implicit class BodyLinkageHeadersHeadersOps[Self <: BodyLinkageHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
