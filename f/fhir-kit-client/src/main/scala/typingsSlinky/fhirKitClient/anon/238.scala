...
trait `238` extends js.Object {
  ...
  var resourceType: FamilyMemberHistory = js.native
}

object `238` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: FamilyMemberHistory): `238` = {
  ...
  implicit class `238Ops`[Self <: `238`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: FamilyMemberHistory): Self = {
        val ret = this.duplicate
