...
@js.native
trait BodyResearchSubjectHeaders extends js.Object {
...
object BodyResearchSubjectHeaders {
  ...
  @scala.inline
  implicit class BodyResearchSubjectHeadersOps[Self <: BodyResearchSubjectHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ResearchSubject): Self = this.set("resourceType", value.asInstanceOf[js.Any])
