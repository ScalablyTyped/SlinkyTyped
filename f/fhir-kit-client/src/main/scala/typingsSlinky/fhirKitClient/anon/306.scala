...
object `306` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ValueSet): `306` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`306`]
  }
  @scala.inline
  implicit class `306Ops`[Self <: `306`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: ValueSet): Self = {
        val ret = this.duplicate
