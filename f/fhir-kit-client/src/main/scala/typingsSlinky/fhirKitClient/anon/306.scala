...
trait `306` extends js.Object {
  ...
  var resourceType: Task = js.native
}

object `306` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Task): `306` = {
  ...
  implicit class `306Ops`[Self <: `306`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Task): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
