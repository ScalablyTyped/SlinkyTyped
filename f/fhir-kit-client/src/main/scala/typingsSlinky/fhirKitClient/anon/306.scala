...
object `306` {
  ...
  @scala.inline
  implicit class `306MutableBuilder`[Self <: `306`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Task): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
