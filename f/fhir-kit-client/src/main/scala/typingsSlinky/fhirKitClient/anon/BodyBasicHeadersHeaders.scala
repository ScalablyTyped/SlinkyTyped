...
object BodyBasicHeadersHeaders {
  @scala.inline
  def apply(body: Basic, id: String, resourceType: typingsSlinky.fhirKitClient.fhirKitClientStrings.Basic): BodyBasicHeadersHeaders = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BodyBasicHeadersHeaders]
  }
  @scala.inline
  implicit class BodyBasicHeadersHeadersOps[Self <: BodyBasicHeadersHeaders] (val x: Self) extends AnyVal {
    @scala.inline
