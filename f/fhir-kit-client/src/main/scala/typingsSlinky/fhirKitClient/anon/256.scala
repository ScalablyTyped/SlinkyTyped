...
trait `256` extends StObject {
  ...
  var resourceType: Location = js.native
}
object `256` {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Location): `256` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`256`]
  }
  
  @scala.inline
  implicit class `256MutableBuilder`[Self <: `256`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Location): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
