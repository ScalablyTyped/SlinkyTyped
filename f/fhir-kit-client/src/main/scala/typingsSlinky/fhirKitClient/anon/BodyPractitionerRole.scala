...
object BodyPractitionerRole {
  ...
  @scala.inline
  implicit class BodyPractitionerRoleOps[Self <: BodyPractitionerRole] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.PractitionerRole): Self = this.set("resourceType", value.asInstanceOf[js.Any])
