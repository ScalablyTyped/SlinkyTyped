...
@js.native
trait Bundletypesearchset extends StObject {
...
object Bundletypesearchset {
  ...
  @scala.inline
  implicit class BundletypesearchsetMutableBuilder[Self <: Bundletypesearchset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: code with searchset): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
