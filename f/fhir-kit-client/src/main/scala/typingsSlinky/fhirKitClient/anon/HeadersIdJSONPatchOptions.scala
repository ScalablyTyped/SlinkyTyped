...
object HeadersIdJSONPatchOptions {
  ...
  @scala.inline
  implicit class HeadersIdJSONPatchOptionsOps[Self <: HeadersIdJSONPatchOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: AuditEvent): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
