...
@js.native
trait HeadersIdJSONPatchOptions extends StObject {
  ...
  var resourceType: AuditEvent = js.native
}
object HeadersIdJSONPatchOptions {
  
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: AuditEvent): HeadersIdJSONPatchOptions = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersIdJSONPatchOptions]
  }
  
  @scala.inline
  implicit class HeadersIdJSONPatchOptionsMutableBuilder[Self <: HeadersIdJSONPatchOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: AuditEvent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
