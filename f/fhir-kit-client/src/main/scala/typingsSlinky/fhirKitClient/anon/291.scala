...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.ResearchStudy
...
trait `291` extends js.Object {
  ...
  var resourceType: ResearchStudy = js.native
}

object `291` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ResearchStudy): `291` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`291`]
  }
  @scala.inline
  implicit class `291Ops`[Self <: `291`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: ResearchStudy): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
