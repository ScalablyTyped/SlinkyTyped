...
@js.native
trait BodyEnrollmentRequestHeaders extends js.Object {
...
object BodyEnrollmentRequestHeaders {
  ...
  @scala.inline
  implicit class BodyEnrollmentRequestHeadersOps[Self <: BodyEnrollmentRequestHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: EnrollmentRequest): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.EnrollmentRequest): Self = this.set("resourceType", value.asInstanceOf[js.Any])
