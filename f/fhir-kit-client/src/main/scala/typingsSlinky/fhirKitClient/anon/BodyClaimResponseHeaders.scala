...
@js.native
trait BodyClaimResponseHeaders extends js.Object {
...
object BodyClaimResponseHeaders {
  ...
  @scala.inline
  implicit class BodyClaimResponseHeadersOps[Self <: BodyClaimResponseHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.ClaimResponse): Self = this.set("resourceType", value.asInstanceOf[js.Any])
