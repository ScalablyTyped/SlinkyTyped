...
object `308` {
  ...
  @scala.inline
  implicit class `308MutableBuilder`[Self <: `308`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: TestScript): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
