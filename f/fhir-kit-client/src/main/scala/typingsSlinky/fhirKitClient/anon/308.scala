...
@js.native
trait `308` extends js.Object {
  var JSONPatch: js.Array[OpPatch] = js.native
  var headers: js.UndefOr[typingsSlinky.request.mod.Headers] = js.native
  var id: String = js.native
  var options: js.UndefOr[typingsSlinky.request.mod.Options] = js.native
  var resourceType: TestScript = js.native
}

object `308` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: TestScript): `308` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`308`]
  }
  @scala.inline
  implicit class `308Ops`[Self <: `308`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: TestScript): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
