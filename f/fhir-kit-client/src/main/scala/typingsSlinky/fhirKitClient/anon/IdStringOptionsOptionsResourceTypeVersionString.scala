...
object IdStringOptionsOptionsResourceTypeVersionString {
  @scala.inline
  def apply(id: String, resourceType: Binary, version: String): IdStringOptionsOptionsResourceTypeVersionString = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[IdStringOptionsOptionsResourceTypeVersionString]
  }
  @scala.inline
  implicit class IdStringOptionsOptionsResourceTypeVersionStringOps[Self <: IdStringOptionsOptionsResourceTypeVersionString] (val x: Self) extends AnyVal {
    @scala.inline
