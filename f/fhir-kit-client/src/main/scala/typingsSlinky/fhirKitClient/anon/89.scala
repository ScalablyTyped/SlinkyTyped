...
object `89` {
  ...
  @scala.inline
  def apply(id: String, resourceType: ServiceDefinition): `89` = {
  ...
  implicit class `89MutableBuilder`[Self <: `89`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: ServiceDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
