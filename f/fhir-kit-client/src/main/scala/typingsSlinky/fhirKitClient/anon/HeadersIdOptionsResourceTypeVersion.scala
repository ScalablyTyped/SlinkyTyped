...
trait HeadersIdOptionsResourceTypeVersion extends js.Object {
  ...
  var resourceType: Appointment = js.native
...
object HeadersIdOptionsResourceTypeVersion {
  ...
  @scala.inline
  def apply(id: String, resourceType: Appointment, version: String): HeadersIdOptionsResourceTypeVersion = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeadersIdOptionsResourceTypeVersion]
  }
  
  @scala.inline
  implicit class HeadersIdOptionsResourceTypeVersionOps[Self <: HeadersIdOptionsResourceTypeVersion] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: Appointment): Self = this.set("resourceType", value.asInstanceOf[js.Any])
