...
object BodyAllergyIntolerance {
  ...
  @scala.inline
  implicit class BodyAllergyIntoleranceOps[Self <: BodyAllergyIntolerance] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.AllergyIntolerance): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
