...
@js.native
trait BodyMedicationStatementHeaders extends js.Object {
...
object BodyMedicationStatementHeaders {
  ...
  @scala.inline
  implicit class BodyMedicationStatementHeadersOps[Self <: BodyMedicationStatementHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.MedicationStatement): Self = this.set("resourceType", value.asInstanceOf[js.Any])
