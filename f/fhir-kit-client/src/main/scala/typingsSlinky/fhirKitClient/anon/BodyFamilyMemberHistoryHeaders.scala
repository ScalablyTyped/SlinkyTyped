...
@js.native
trait BodyFamilyMemberHistoryHeaders extends js.Object {
...
object BodyFamilyMemberHistoryHeaders {
  ...
  @scala.inline
  implicit class BodyFamilyMemberHistoryHeadersOps[Self <: BodyFamilyMemberHistoryHeaders] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBody(value: FamilyMemberHistory): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.FamilyMemberHistory): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
