...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.HealthcareService
...
object `244` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: HealthcareService): `244` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`244`]
  }
  @scala.inline
  implicit class `244Ops`[Self <: `244`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: HealthcareService): Self = {
        val ret = this.duplicate
