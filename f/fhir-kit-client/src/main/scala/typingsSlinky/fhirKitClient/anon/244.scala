...
object `244` {
  ...
  @scala.inline
  implicit class `244MutableBuilder`[Self <: `244`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: GraphDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
