...
object `244` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: GraphDefinition): `244` = {
  ...
  implicit class `244Ops`[Self <: `244`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceType(value: GraphDefinition): Self = this.set("resourceType", value.asInstanceOf[js.Any])
    @scala.inline
