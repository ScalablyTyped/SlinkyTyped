...
object `278` {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Procedure): `278` = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[`278`]
  }
  @scala.inline
  implicit class `278Ops`[Self <: `278`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Procedure): Self = {
        val ret = this.duplicate
