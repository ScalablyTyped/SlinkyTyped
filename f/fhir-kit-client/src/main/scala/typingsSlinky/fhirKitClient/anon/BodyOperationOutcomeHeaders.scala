...
@js.native
trait BodyOperationOutcomeHeaders extends js.Object {
...
object BodyOperationOutcomeHeaders {
  ...
  @scala.inline
  implicit class BodyOperationOutcomeHeadersOps[Self <: BodyOperationOutcomeHeaders] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: OperationOutcome): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: String): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResourceType(value: typingsSlinky.fhirKitClient.fhirKitClientStrings.OperationOutcome): Self = this.set("resourceType", value.asInstanceOf[js.Any])
