...
object Anon273 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: PaymentReconciliation): Anon273 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon273]
  }
  @scala.inline
  implicit class Anon273Ops[Self <: Anon273] (val x: Self) extends AnyVal {
    @scala.inline
