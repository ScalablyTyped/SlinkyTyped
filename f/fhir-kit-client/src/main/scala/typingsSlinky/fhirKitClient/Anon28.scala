...
import typingsSlinky.fhirKitClient.fhirKitClientStrings.ExpansionProfile
...
object Anon28 {
  @scala.inline
  def apply(id: String, resourceType: ExpansionProfile): Anon28 = {
  ...
  implicit class Anon28Ops[Self <: Anon28] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withResourceType(value: ExpansionProfile): Self = {
        val ret = this.duplicate
