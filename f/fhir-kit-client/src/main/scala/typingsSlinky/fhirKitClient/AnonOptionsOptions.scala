...
object AnonOptionsOptions {
  @scala.inline
  def apply(id: String, resourceType: CapabilityStatement): AnonOptionsOptions = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOptionsOptions]
  }
  @scala.inline
  implicit class AnonOptionsOptionsOps[Self <: AnonOptionsOptions] (val x: Self) extends AnyVal {
    @scala.inline
