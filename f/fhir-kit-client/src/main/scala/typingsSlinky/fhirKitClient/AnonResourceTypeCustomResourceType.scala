...
object AnonResourceTypeCustomResourceType {
  @scala.inline
  def apply(id: String, resourceType: CustomResourceType): AnonResourceTypeCustomResourceType = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonResourceTypeCustomResourceType]
  }
  @scala.inline
  implicit class AnonResourceTypeCustomResourceTypeOps[Self <: AnonResourceTypeCustomResourceType] (val x: Self) extends AnyVal {
    @scala.inline
