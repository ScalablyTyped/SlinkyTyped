...
object AnonHeadersIdJSONPatch {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: AllergyIntolerance): AnonHeadersIdJSONPatch = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonHeadersIdJSONPatch]
  }
  @scala.inline
  implicit class AnonHeadersIdJSONPatchOps[Self <: AnonHeadersIdJSONPatch] (val x: Self) extends AnyVal {
    @scala.inline
