...
object Anon280 {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: ProcessRequest): Anon280 = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon280]
  }
  @scala.inline
  implicit class Anon280Ops[Self <: Anon280] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: ProcessRequest): Self = {
        val ret = this.duplicate
