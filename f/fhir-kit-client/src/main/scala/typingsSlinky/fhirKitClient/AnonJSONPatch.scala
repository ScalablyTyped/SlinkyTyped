...
@js.native
trait AnonJSONPatch extends js.Object {
...
object AnonJSONPatch {
  @scala.inline
  def apply(JSONPatch: js.Array[OpPatch], id: String, resourceType: Account): AnonJSONPatch = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonJSONPatch]
  }
  @scala.inline
  implicit class AnonJSONPatchOps[Self <: AnonJSONPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: Account): Self = {
        val ret = this.duplicate
