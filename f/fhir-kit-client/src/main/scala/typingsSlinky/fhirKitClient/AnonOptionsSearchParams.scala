...
object AnonOptionsSearchParams {
  @scala.inline
  def apply(searchParams: SearchParams): AnonOptionsSearchParams = {
    val __obj = js.Dynamic.literal(searchParams = searchParams.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonOptionsSearchParams]
  }
  @scala.inline
  implicit class AnonOptionsSearchParamsOps[Self <: AnonOptionsSearchParams] (val x: Self) extends AnyVal {
    @scala.inline
