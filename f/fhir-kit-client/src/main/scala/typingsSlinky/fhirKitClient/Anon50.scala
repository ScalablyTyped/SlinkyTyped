...
object Anon50 {
  @scala.inline
  def apply(id: String, resourceType: MedicationAdministration): Anon50 = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon50]
  }
  @scala.inline
  implicit class Anon50Ops[Self <: Anon50] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withResourceType(value: MedicationAdministration): Self = {
        val ret = this.duplicate
