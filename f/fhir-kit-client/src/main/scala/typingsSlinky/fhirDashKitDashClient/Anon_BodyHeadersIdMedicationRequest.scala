...
trait Anon_BodyHeadersIdMedicationRequest extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MedicationRequest
}
...
object Anon_BodyHeadersIdMedicationRequest {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MedicationRequest,
