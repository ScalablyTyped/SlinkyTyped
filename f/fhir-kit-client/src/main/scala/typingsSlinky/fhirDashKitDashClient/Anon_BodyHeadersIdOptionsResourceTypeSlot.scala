...
trait Anon_BodyHeadersIdOptionsResourceTypeSlot extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Slot
}
...
object Anon_BodyHeadersIdOptionsResourceTypeSlot {
  ...
  def apply(
    body: Slot,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Slot,
