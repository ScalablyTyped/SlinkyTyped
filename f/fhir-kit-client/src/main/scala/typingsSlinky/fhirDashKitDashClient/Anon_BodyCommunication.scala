...
trait Anon_BodyCommunication extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Communication
}
...
object Anon_BodyCommunication {
  ...
  def apply(
    body: Communication,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Communication,
