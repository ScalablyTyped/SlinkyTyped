...
trait Anon_BodyFamilyMemberHistory extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.FamilyMemberHistory
}
...
object Anon_BodyFamilyMemberHistory {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.FamilyMemberHistory,
