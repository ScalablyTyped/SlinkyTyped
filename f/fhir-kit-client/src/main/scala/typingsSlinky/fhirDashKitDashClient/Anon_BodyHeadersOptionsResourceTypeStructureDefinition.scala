...
trait Anon_BodyHeadersOptionsResourceTypeStructureDefinition extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.StructureDefinition
}
...
object Anon_BodyHeadersOptionsResourceTypeStructureDefinition {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.StructureDefinition,
