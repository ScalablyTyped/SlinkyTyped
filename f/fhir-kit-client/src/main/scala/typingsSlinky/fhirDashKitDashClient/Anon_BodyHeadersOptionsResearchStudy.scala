...
trait Anon_BodyHeadersOptionsResearchStudy extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ResearchStudy
}
...
object Anon_BodyHeadersOptionsResearchStudy {
  ...
  def apply(
    body: ResearchStudy,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ResearchStudy,
