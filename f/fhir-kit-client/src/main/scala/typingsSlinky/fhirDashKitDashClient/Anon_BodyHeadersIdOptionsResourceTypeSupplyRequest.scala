...
trait Anon_BodyHeadersIdOptionsResourceTypeSupplyRequest extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SupplyRequest
}
...
object Anon_BodyHeadersIdOptionsResourceTypeSupplyRequest {
  ...
  def apply(
    body: SupplyRequest,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SupplyRequest,
