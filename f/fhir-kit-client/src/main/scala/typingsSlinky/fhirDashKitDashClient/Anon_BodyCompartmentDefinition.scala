...
trait Anon_BodyCompartmentDefinition extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CompartmentDefinition
}
...
object Anon_BodyCompartmentDefinition {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CompartmentDefinition,
