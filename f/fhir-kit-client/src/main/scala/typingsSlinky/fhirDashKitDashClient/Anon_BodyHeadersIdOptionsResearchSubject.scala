...
trait Anon_BodyHeadersIdOptionsResearchSubject extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ResearchSubject
}
...
object Anon_BodyHeadersIdOptionsResearchSubject {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ResearchSubject,
