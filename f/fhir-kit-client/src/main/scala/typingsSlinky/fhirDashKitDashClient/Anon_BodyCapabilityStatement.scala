...
trait Anon_BodyCapabilityStatement extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CapabilityStatement
}
...
object Anon_BodyCapabilityStatement {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CapabilityStatement,
