...
trait Anon_BodyHeadersOptionsResourceTypeStructureMap extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.StructureMap
}
...
object Anon_BodyHeadersOptionsResourceTypeStructureMap {
  ...
  def apply(
    body: StructureMap,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.StructureMap,
