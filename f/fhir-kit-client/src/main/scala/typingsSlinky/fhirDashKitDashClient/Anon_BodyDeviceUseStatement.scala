...
trait Anon_BodyDeviceUseStatement extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DeviceUseStatement
}
...
object Anon_BodyDeviceUseStatement {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DeviceUseStatement,
