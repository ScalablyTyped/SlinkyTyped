...
trait Anon_BodyHeadersIdImplementationGuide extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ImplementationGuide
}
...
object Anon_BodyHeadersIdImplementationGuide {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ImplementationGuide,
