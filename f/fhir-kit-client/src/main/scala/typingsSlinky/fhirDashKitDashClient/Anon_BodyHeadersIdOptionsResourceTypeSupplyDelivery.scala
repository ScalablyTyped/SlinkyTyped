...
trait Anon_BodyHeadersIdOptionsResourceTypeSupplyDelivery extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SupplyDelivery
}
...
object Anon_BodyHeadersIdOptionsResourceTypeSupplyDelivery {
  ...
  def apply(
    body: SupplyDelivery,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SupplyDelivery,
