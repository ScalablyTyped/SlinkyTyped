...
trait Anon_BodyHeadersOptionsPerson extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Person
}
...
object Anon_BodyHeadersOptionsPerson {
  ...
  def apply(
    body: Person,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Person,
