...
trait Anon_BodyHeadersIdOptionsQuestionnaireResponse extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.QuestionnaireResponse
}
...
object Anon_BodyHeadersIdOptionsQuestionnaireResponse {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.QuestionnaireResponse,
