...
trait Anon_BodyHeadersMedia extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Media
}
...
object Anon_BodyHeadersMedia {
  ...
  def apply(
    body: Media,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Media,
