...
trait Anon_BodyHeadersIdMeasure extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Measure
}
...
object Anon_BodyHeadersIdMeasure {
  ...
  def apply(
    body: Measure,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Measure,
