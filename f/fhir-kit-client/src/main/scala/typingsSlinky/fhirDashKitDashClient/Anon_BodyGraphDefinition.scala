...
trait Anon_BodyGraphDefinition extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.GraphDefinition
}
...
object Anon_BodyGraphDefinition {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.GraphDefinition,
