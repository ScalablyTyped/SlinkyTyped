...
trait Anon_BodyDeviceHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Device
}
...
object Anon_BodyDeviceHeaders {
  ...
  def apply(
    body: Device,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Device,
