...
trait Anon_BodyHeadersIdOptionsResourceTypeSpecimen extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Specimen
}
...
object Anon_BodyHeadersIdOptionsResourceTypeSpecimen {
  ...
  def apply(
    body: Specimen,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Specimen,
