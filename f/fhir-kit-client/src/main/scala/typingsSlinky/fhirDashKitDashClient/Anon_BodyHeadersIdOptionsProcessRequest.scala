...
trait Anon_BodyHeadersIdOptionsProcessRequest extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ProcessRequest
}
...
object Anon_BodyHeadersIdOptionsProcessRequest {
  ...
  def apply(
    body: ProcessRequest,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ProcessRequest,
