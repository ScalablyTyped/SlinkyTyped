...
trait Anon_BodyClaimResponse extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ClaimResponse
}
...
object Anon_BodyClaimResponse {
  ...
  def apply(
    body: ClaimResponse,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ClaimResponse,
