...
trait Anon_BodyClinicalImpressionHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ClinicalImpression
}
...
object Anon_BodyClinicalImpressionHeaders {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ClinicalImpression,
