...
trait Anon_BodyCareTeamHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CareTeam
}
...
object Anon_BodyCareTeamHeaders {
  ...
  def apply(
    body: CareTeam,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CareTeam,
