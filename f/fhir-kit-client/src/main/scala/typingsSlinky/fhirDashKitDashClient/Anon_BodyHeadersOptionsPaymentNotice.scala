...
trait Anon_BodyHeadersOptionsPaymentNotice extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.PaymentNotice
}
...
object Anon_BodyHeadersOptionsPaymentNotice {
  ...
  def apply(
    body: PaymentNotice,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.PaymentNotice,
