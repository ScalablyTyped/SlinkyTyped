...
trait Anon_BodyCondition extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Condition
}
...
object Anon_BodyCondition {
  ...
  def apply(
    body: Condition,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Condition,
