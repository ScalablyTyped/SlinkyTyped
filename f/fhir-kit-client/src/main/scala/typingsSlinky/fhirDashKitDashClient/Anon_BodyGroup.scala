...
trait Anon_BodyGroup extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Group
}
...
object Anon_BodyGroup {
  ...
  def apply(
    body: Group,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Group,
