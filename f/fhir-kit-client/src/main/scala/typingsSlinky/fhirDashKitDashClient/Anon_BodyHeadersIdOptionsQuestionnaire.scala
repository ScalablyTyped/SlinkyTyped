...
trait Anon_BodyHeadersIdOptionsQuestionnaire extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Questionnaire
}
...
object Anon_BodyHeadersIdOptionsQuestionnaire {
  ...
  def apply(
    body: Questionnaire,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Questionnaire,
