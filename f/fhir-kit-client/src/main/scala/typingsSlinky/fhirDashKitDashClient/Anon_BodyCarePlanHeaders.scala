...
trait Anon_BodyCarePlanHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CarePlan
}
...
object Anon_BodyCarePlanHeaders {
  ...
  def apply(
    body: CarePlan,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CarePlan,
