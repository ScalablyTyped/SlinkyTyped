...
trait Anon_BodyHeadersIdOptionsResourceTypeValueSet extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ValueSet
}
...
object Anon_BodyHeadersIdOptionsResourceTypeValueSet {
  ...
  def apply(
    body: ValueSet,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ValueSet,
