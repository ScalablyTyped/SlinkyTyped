...
trait Anon_BodyGoal extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Goal
}
...
object Anon_BodyGoal {
  ...
  def apply(
    body: Goal,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Goal,
