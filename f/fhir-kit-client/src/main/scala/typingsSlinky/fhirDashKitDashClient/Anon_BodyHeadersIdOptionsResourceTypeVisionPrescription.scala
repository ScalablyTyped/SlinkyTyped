...
trait Anon_BodyHeadersIdOptionsResourceTypeVisionPrescription extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.VisionPrescription
}
...
object Anon_BodyHeadersIdOptionsResourceTypeVisionPrescription {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.VisionPrescription,
