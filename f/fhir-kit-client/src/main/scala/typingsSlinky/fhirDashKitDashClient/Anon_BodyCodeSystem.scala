...
trait Anon_BodyCodeSystem extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CodeSystem
}
...
object Anon_BodyCodeSystem {
  ...
  def apply(
    body: CodeSystem,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.CodeSystem,
