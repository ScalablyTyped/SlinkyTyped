...
trait Anon_BodyDetectedIssue extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DetectedIssue
}
...
object Anon_BodyDetectedIssue {
  ...
  def apply(
    body: DetectedIssue,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DetectedIssue,
