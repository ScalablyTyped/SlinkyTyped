...
trait Anon_BasicBody extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Basic
}
...
object Anon_BasicBody {
  ...
  def apply(
    body: Basic,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Basic,
