...
trait Anon_AppointmentBody extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Appointment
}
...
object Anon_AppointmentBody {
  ...
  def apply(
    body: Appointment,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Appointment,
