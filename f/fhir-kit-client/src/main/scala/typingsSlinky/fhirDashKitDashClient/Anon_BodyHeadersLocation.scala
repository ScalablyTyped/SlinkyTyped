...
trait Anon_BodyHeadersLocation extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Location
}
...
object Anon_BodyHeadersLocation {
  ...
  def apply(
    body: Location,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Location,
