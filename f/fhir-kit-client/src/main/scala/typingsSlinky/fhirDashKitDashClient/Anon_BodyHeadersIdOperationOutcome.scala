...
trait Anon_BodyHeadersIdOperationOutcome extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.OperationOutcome
}
...
object Anon_BodyHeadersIdOperationOutcome {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.OperationOutcome,
