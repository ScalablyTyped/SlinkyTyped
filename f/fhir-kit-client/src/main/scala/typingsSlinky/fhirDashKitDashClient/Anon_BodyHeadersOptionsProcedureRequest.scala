...
trait Anon_BodyHeadersOptionsProcedureRequest extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ProcedureRequest
}
...
object Anon_BodyHeadersOptionsProcedureRequest {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ProcedureRequest,
