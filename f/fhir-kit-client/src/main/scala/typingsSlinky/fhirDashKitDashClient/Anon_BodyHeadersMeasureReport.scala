...
trait Anon_BodyHeadersMeasureReport extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MeasureReport
}
...
object Anon_BodyHeadersMeasureReport {
  ...
  def apply(
    body: MeasureReport,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MeasureReport,
