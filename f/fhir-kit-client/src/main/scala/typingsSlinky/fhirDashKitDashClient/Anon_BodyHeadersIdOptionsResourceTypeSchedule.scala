...
trait Anon_BodyHeadersIdOptionsResourceTypeSchedule extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Schedule
}
...
object Anon_BodyHeadersIdOptionsResourceTypeSchedule {
  ...
  def apply(
    body: Schedule,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Schedule,
