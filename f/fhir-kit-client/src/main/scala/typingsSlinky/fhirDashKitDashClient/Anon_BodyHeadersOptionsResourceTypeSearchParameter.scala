...
trait Anon_BodyHeadersOptionsResourceTypeSearchParameter extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SearchParameter
}
...
object Anon_BodyHeadersOptionsResourceTypeSearchParameter {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.SearchParameter,
