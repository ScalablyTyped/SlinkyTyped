...
trait Anon_BodyHeadersOptionsResourceTypeServiceDefinition extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ServiceDefinition
}
...
object Anon_BodyHeadersOptionsResourceTypeServiceDefinition {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ServiceDefinition,
