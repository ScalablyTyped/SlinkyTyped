...
trait Anon_BodyCompositionHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Composition
}
...
object Anon_BodyCompositionHeaders {
  ...
  def apply(
    body: Composition,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.Composition,
