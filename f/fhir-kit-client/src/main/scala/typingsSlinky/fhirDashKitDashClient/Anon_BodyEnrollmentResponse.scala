...
trait Anon_BodyEnrollmentResponse extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.EnrollmentResponse
}
...
object Anon_BodyEnrollmentResponse {
  ...
  def apply(
    ...
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.EnrollmentResponse,
