...
trait Anon_BodyHeadersIdImagingStudy extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ImagingStudy
}
...
object Anon_BodyHeadersIdImagingStudy {
  ...
  def apply(
    body: ImagingStudy,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.ImagingStudy,
