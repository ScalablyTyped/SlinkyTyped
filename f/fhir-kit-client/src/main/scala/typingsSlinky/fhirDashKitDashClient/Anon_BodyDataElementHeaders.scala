...
trait Anon_BodyDataElementHeaders extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DataElement
}
...
object Anon_BodyDataElementHeaders {
  ...
  def apply(
    body: DataElement,
    id: String,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.DataElement,
