...
trait Anon_BodyHeadersMessageHeader extends js.Object {
  ...
  var resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MessageHeader
}
...
object Anon_BodyHeadersMessageHeader {
  ...
  def apply(
    body: MessageHeader,
    resourceType: typingsSlinky.fhirDashKitDashClient.fhirDashKitDashClientStrings.MessageHeader,
