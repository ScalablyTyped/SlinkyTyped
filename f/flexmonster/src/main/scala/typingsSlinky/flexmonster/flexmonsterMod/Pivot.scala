package typingsSlinky.flexmonster.flexmonsterMod

import typingsSlinky.flexmonster.Anon_Blocking
import typingsSlinky.flexmonster.Anon_CallbackHandler
import typingsSlinky.flexmonster.Anon_CallbackHandlerError
import typingsSlinky.flexmonster.Anon_CallbackHandlerErrorFormat
import typingsSlinky.flexmonster.Anon_IgnoreScroll
import typingsSlinky.flexmonster.Anon_IsRemoved
import typingsSlinky.flexmonster.Anon_Slice
...
trait Pivot extends js.Object {
  ...
  def alert(options: Anon_Blocking): Unit = js.native
  ...
  def getData(options: Anon_Slice, callbackHandler: String): Unit = js.native
  def getData(options: Anon_Slice, callbackHandler: String, updateHandler: String): Unit = js.native
  def getData(
    options: Anon_Slice,
    callbackHandler: String,
  ...
  def openCalculatedValueEditor(uniqueName: String, callbackHandler: js.Function1[/* response */ Anon_IsRemoved, Unit]): Unit = js.native
