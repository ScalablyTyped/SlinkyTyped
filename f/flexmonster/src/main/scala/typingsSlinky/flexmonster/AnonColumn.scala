...
trait AnonColumn extends js.Object {
  var column: js.UndefOr[js.Array[AnonTuple]] = js.native
  var row: js.UndefOr[js.Array[AnonTuple]] = js.native
}
...
object AnonColumn {
  ...
  implicit class AnonColumnOps[Self <: AnonColumn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withColumn(value: js.Array[AnonTuple]): Self = {
    ...
    @scala.inline
    def withRow(value: js.Array[AnonTuple]): Self = {
        val ret = this.duplicate
