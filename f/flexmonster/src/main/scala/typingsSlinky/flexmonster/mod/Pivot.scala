...
import typingsSlinky.flexmonster.anon.Blocking
import typingsSlinky.flexmonster.anon.GetAxisFormat
import typingsSlinky.flexmonster.anon.GetData
import typingsSlinky.flexmonster.anon.GetNumberFormat
import typingsSlinky.flexmonster.anon.IgnoreScroll
import typingsSlinky.flexmonster.anon.IsRemoved
...
trait Pivot extends js.Object {
  ...
  def getData(options: typingsSlinky.flexmonster.anon.Slice, callbackHandler: String): Unit = js.native
  def getData(options: typingsSlinky.flexmonster.anon.Slice, callbackHandler: String, updateHandler: String): Unit = js.native
  def getData(
    options: typingsSlinky.flexmonster.anon.Slice,
    callbackHandler: String,
