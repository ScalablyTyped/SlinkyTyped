...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.telemetry.EventData
import typingsSlinky.firefoxDashWebextDashBrowser.browser.telemetry.ScalarData
