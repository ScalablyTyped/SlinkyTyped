...
import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.ExtensionURL
import typingsSlinky.firefoxDashWebextDashBrowser.browser.devtools.inspectedWindow.Resource
import typingsSlinky.firefoxDashWebextDashBrowser.browser.devtools.panels.ElementsPanel
import typingsSlinky.firefoxDashWebextDashBrowser.browser.devtools.panels.ExtensionPanel
import typingsSlinky.firefoxDashWebextDashBrowser.browser.devtools.panels.SourcesPanel
import typingsSlinky.firefoxDashWebextDashBrowser.browser.devtools.panels._Create
