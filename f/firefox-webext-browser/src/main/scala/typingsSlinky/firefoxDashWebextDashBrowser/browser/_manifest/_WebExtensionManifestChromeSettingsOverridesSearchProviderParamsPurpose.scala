...
object _WebExtensionManifestChromeSettingsOverridesSearchProviderParamsPurpose {
  ...
  @scala.inline
  def contextmenu: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.contextmenu = this.cast("contextmenu")
  @scala.inline
  def homepage: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.homepage = this.cast("homepage")
  @scala.inline
  def keyword: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.keyword = this.cast("keyword")
  @scala.inline
  def newtab: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.newtab = this.cast("newtab")
  @scala.inline
  def searchbar: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.searchbar = this.cast("searchbar")
}
