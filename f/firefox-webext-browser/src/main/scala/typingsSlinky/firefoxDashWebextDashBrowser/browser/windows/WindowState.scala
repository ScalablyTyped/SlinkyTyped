...
object WindowState {
  ...
  @scala.inline
  def docked: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.docked = this.cast("docked")
  @scala.inline
  def fullscreen: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.fullscreen = this.cast("fullscreen")
  @scala.inline
  def maximized: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.maximized = this.cast("maximized")
  @scala.inline
  def minimized: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.minimized = this.cast("minimized")
  @scala.inline
