...
import typingsSlinky.firefoxDashWebextDashBrowser.Anon_IndexWindowId
...
object move extends js.Object {
  def apply(tabIds: js.Array[Double], moveProperties: Anon_IndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
  /**
    ...
    */
  def apply(tabIds: Double, moveProperties: Anon_IndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
}
