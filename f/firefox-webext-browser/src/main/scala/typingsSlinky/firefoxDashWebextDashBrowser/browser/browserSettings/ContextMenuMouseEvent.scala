...
object ContextMenuMouseEvent {
  ...
  @scala.inline
  def mousedown: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.mousedown = this.cast("mousedown")
  @scala.inline
  def mouseup: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.mouseup = this.cast("mouseup")
}
