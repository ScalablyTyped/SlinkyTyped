...
trait _UrlbarOnResultsRequestedEvent[TCallback] extends js.Object {
...
object _UrlbarOnResultsRequestedEvent {
  ...
  def apply[TCallback](
    ...
    __obj.asInstanceOf[_UrlbarOnResultsRequestedEvent[TCallback]]
  }
}
