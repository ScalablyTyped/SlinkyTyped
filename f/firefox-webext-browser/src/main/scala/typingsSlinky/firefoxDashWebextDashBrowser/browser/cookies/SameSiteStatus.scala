...
object SameSiteStatus {
  ...
  @scala.inline
  def lax: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.lax = this.cast("lax")
  @scala.inline
  def no_restriction: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.no_restriction = this.cast("no_restriction")
  @scala.inline
  def strict: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.strict = this.cast("strict")
}
