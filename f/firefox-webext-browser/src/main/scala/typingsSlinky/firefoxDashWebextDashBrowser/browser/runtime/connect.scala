...
import typingsSlinky.firefoxDashWebextDashBrowser.Anon_IncludeTlsChannelId
...
object connect extends js.Object {
  ...
  def apply(extensionId: String, connectInfo: Anon_IncludeTlsChannelId): Port = js.native
}
