...
object _WebExtensionManifestChromeSettingsOverridesSearchProviderParamsCondition {
  ...
  @scala.inline
  def pref: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.pref = this.cast("pref")
  @scala.inline
  def purpose: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.purpose = this.cast("purpose")
}
