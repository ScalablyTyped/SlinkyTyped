...
object OnChangedCause {
  ...
  @scala.inline
  def evicted: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.evicted = this.cast("evicted")
  @scala.inline
  def expired: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.expired = this.cast("expired")
  @scala.inline
  def expired_overwrite: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.expired_overwrite = this.cast("expired_overwrite")
  @scala.inline
  def explicit: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.explicit = this.cast("explicit")
  @scala.inline
  def overwrite: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.overwrite = this.cast("overwrite")
}
