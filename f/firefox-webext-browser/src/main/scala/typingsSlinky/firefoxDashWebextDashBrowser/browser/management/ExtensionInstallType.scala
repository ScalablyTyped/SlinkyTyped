package typingsSlinky.firefoxDashWebextDashBrowser.browser.management
...
object ExtensionInstallType {
  ...
  @scala.inline
  def development: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.development = this.cast("development")
  @scala.inline
  def normal: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.normal = this.cast("normal")
  @scala.inline
  def other: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.other = this.cast("other")
  @scala.inline
  def sideload: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.sideload = this.cast("sideload")
}
