package typingsSlinky.firefoxDashWebextDashBrowser.browser.userScripts

import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.MatchPattern
import typingsSlinky.firefoxDashWebextDashBrowser.browser.extensionTypes.ExtensionFileOrCode
import typingsSlinky.firefoxDashWebextDashBrowser.browser.extensionTypes.PlainJSONValue
