...
object RequestUpdateCheckStatus {
  ...
  @scala.inline
  def no_update: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.no_update = this.cast("no_update")
  @scala.inline
  def throttled: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.throttled = this.cast("throttled")
  @scala.inline
  def update_available: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.update_available = this.cast("update_available")
}
