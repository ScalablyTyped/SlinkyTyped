package typingsSlinky.firefoxDashWebextDashBrowser.browser.types
...
object SettingScope {
  ...
  @scala.inline
  def incognito_persistent: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.incognito_persistent = this.cast("incognito_persistent")
  @scala.inline
  def incognito_session_only: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.incognito_session_only = this.cast("incognito_session_only")
  @scala.inline
  def regular: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.regular = this.cast("regular")
  @scala.inline
  def regular_only: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.regular_only = this.cast("regular_only")
}
