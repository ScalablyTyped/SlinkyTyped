package typingsSlinky.firefoxDashWebextDashBrowser.browser.idle
...
object IdleState {
  @scala.inline
  def active: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.active = this.cast("active")
  @scala.inline
