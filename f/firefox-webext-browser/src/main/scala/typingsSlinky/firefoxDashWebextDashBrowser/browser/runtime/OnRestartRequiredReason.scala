...
object OnRestartRequiredReason {
  @scala.inline
  def app_update: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.app_update = this.cast("app_update")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def os_update: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.os_update = this.cast("os_update")
  @scala.inline
  def periodic: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.periodic = this.cast("periodic")
}
