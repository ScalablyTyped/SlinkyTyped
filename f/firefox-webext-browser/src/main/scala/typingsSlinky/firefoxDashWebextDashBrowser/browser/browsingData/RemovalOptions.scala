package typingsSlinky.firefoxDashWebextDashBrowser.browser.browsingData

import typingsSlinky.firefoxDashWebextDashBrowser.Anon_Extension
...
trait RemovalOptions extends js.Object {
  ...
  /**
    ...
    */
  var originTypes: js.UndefOr[Anon_Extension] = js.undefined
  /**
