...
import typingsSlinky.firefoxDashWebextDashBrowser.Anon_ContextsEditable
...
@js.native
object onShown
  extends TopLevel[WebExtEvent[js.Function2[/* info */ Anon_ContextsEditable, /* tab */ Tab, Unit]]]
