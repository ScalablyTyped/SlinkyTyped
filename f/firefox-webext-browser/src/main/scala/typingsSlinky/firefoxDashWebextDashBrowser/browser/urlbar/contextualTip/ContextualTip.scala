package typingsSlinky.firefoxDashWebextDashBrowser.browser.urlbar.contextualTip

import typingsSlinky.firefoxDashWebextDashBrowser.Anon_DefaultIcon
...
trait ContextualTip extends js.Object {
  ...
  var icon: js.UndefOr[Anon_DefaultIcon] = js.undefined
