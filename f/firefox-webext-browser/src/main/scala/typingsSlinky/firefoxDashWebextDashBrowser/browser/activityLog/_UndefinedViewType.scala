...
object _UndefinedViewType {
  @scala.inline
  def background: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.background = this.cast("background")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def devtools_page: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.devtools_page = this.cast("devtools_page")
  @scala.inline
  def devtools_panel: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.devtools_panel = this.cast("devtools_panel")
  @scala.inline
