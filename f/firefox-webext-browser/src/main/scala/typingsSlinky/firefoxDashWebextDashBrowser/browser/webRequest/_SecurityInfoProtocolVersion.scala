...
object _SecurityInfoProtocolVersion {
  @scala.inline
  def TLSv1: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.TLSv1 = this.cast("TLSv1")
  @scala.inline
  def TLSv1DOT1: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.TLSv1DOT1 = this.cast("TLSv1.1")
  @scala.inline
  def TLSv1DOT2: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.TLSv1DOT2 = this.cast("TLSv1.2")
  @scala.inline
  def TLSv1DOT3: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.TLSv1DOT3 = this.cast("TLSv1.3")
  @scala.inline
