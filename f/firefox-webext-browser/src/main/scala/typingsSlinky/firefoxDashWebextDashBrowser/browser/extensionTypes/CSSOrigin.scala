package typingsSlinky.firefoxDashWebextDashBrowser.browser.extensionTypes
...
object CSSOrigin {
  @scala.inline
  def author: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.author = this.cast("author")
  @scala.inline
