package typingsSlinky.firefoxDashWebextDashBrowser.browser.omnibox
...
object OnInputEnteredDisposition {
  ...
  @scala.inline
  def currentTab: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.currentTab = this.cast("currentTab")
  @scala.inline
  def newBackgroundTab: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.newBackgroundTab = this.cast("newBackgroundTab")
  @scala.inline
  def newForegroundTab: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.newForegroundTab = this.cast("newForegroundTab")
}
