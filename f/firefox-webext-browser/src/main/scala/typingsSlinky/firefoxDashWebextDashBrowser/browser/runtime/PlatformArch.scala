...
object PlatformArch {
  @scala.inline
  def arm: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.arm = this.cast("arm")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def `x86-32`: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.`x86-32` = this.cast("x86-32")
  @scala.inline
  def `x86-64`: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.`x86-64` = this.cast("x86-64")
}
