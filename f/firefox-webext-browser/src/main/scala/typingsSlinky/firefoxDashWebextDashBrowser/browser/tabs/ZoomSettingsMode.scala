...
object ZoomSettingsMode {
  @scala.inline
  def automatic: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.automatic = this.cast("automatic")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def disabled: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.disabled = this.cast("disabled")
  @scala.inline
  def manual: typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.manual = this.cast("manual")
}
