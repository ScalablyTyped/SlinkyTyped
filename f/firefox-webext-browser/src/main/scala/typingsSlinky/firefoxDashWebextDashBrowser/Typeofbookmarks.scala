...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.bookmarks.BookmarkTreeNode
import typingsSlinky.firefoxDashWebextDashBrowser.browser.bookmarks.CreateDetails
