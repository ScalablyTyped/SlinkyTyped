...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.storage.StorageArea
import typingsSlinky.firefoxDashWebextDashBrowser.browser.storage.StorageChange
