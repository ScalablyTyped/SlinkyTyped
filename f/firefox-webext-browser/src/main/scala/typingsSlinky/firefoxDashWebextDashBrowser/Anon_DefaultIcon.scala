...
import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.IconPath
import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.ThemeIcons
