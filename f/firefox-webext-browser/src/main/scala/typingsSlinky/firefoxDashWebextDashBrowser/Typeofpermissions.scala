...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.permissions.AnyPermissions
import typingsSlinky.firefoxDashWebextDashBrowser.browser.permissions.Permissions
