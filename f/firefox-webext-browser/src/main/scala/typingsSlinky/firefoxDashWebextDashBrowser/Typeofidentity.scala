...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.identity.AccountInfo
...
trait Typeofidentity extends js.Object {
  ...
  def launchWebAuthFlow(details: Anon_Interactive): js.Promise[String] = js.native
  /**
