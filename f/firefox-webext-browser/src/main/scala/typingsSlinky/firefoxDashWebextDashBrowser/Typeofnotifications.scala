...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.notifications.CreateNotificationOptions
import typingsSlinky.firefoxDashWebextDashBrowser.browser.notifications.PermissionLevel
import typingsSlinky.firefoxDashWebextDashBrowser.browser.notifications.UpdateNotificationOptions
