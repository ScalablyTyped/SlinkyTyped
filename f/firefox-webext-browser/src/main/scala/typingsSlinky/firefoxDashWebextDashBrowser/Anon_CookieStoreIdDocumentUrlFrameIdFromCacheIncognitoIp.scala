...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest.HttpHeaders
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest.ResourceType
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest.UrlClassification
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp extends js.Object {
...
object Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp = {
    ...
    __obj.asInstanceOf[Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognitoIp]
  }
}
