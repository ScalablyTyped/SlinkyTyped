...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webNavigation.TransitionType
...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.windows.WindowType
...
object firefoxDashWebextDashBrowserStrings {
  ...
  sealed trait app
    extends WindowType
       with typingsSlinky.firefoxDashWebextDashBrowser.browser.tabs.WindowType
  ...
  sealed trait auto_bookmark
    extends TransitionType
       with typingsSlinky.firefoxDashWebextDashBrowser.browser.history.TransitionType
  ...
  sealed trait auto_toplevel
    extends typingsSlinky.firefoxDashWebextDashBrowser.browser.history.TransitionType
