...
import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.ExtensionID
import typingsSlinky.firefoxDashWebextDashBrowser.browser._manifest.NativeManifest
import typingsSlinky.firefoxDashWebextDashBrowser.firefoxDashWebextDashBrowserStrings.pkcs11
