...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.downloads.DownloadItem
import typingsSlinky.firefoxDashWebextDashBrowser.browser.downloads.DownloadQuery
