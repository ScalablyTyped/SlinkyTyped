...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.history.HistoryItem
import typingsSlinky.firefoxDashWebextDashBrowser.browser.history.VisitItem
