...
trait Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognito extends js.Object {
...
object Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognito {
  @scala.inline
  def apply(
    frameId: Double,
    fromCache: Boolean,
  ...
  ): Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognito = {
    ...
    __obj.asInstanceOf[Anon_CookieStoreIdDocumentUrlFrameIdFromCacheIncognito]
  }
}
