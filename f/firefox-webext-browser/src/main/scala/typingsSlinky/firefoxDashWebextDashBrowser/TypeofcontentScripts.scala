...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.contentScripts.RegisteredContentScript
import typingsSlinky.firefoxDashWebextDashBrowser.browser.contentScripts.RegisteredContentScriptOptions
