...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.userScripts.RegisteredUserScript
import typingsSlinky.firefoxDashWebextDashBrowser.browser.userScripts.UserScriptOptions
