...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.omnibox.DefaultSuggestResult
import typingsSlinky.firefoxDashWebextDashBrowser.browser.omnibox.OnInputEnteredDisposition
import typingsSlinky.firefoxDashWebextDashBrowser.browser.omnibox.SuggestResult
