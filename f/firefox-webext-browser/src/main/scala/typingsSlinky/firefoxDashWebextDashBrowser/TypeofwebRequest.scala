...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest.BlockingResponse
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest.SecurityInfo
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnAuthRequiredEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnBeforeRedirectEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnBeforeRequestEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnBeforeSendHeadersEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnCompletedEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnErrorOccurredEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnHeadersReceivedEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnResponseStartedEvent
import typingsSlinky.firefoxDashWebextDashBrowser.browser.webRequest._WebRequestOnSendHeadersEvent
