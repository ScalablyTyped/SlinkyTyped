...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.extensionTypes.InjectDetails
import typingsSlinky.firefoxDashWebextDashBrowser.browser.runtime.Port
import typingsSlinky.firefoxDashWebextDashBrowser.browser.tabs.PageSettings
import typingsSlinky.firefoxDashWebextDashBrowser.browser.tabs.Tab
import typingsSlinky.firefoxDashWebextDashBrowser.browser.tabs.ZoomSettings
import typingsSlinky.firefoxDashWebextDashBrowser.browser.tabs._TabsOnUpdatedEvent
...
trait Typeoftabs extends js.Object {
  ...
  /**
    ...
    */
  val onActivated: WebExtEvent[js.Function1[/* activeInfo */ Anon_PreviousTabId, Unit]] = js.native
  /**
  ...
  val onAttached: WebExtEvent[js.Function2[/* tabId */ Double, /* attachInfo */ Anon_NewPosition, Unit]] = js.native
  /* tabs events */
  /**
  ...
  val onDetached: WebExtEvent[js.Function2[/* tabId */ Double, /* detachInfo */ Anon_OldPosition, Unit]] = js.native
  /**
    * Fired when the highlighted or selected tabs in a window changes.
    * @deprecated Please use `tabs.onHighlighted`.
    */
  val onHighlightChanged: js.UndefOr[WebExtEvent[js.Function1[/* selectInfo */ Anon_TabIds, Unit]]] = js.native
  /** Fired when the highlighted or selected tabs in a window changes. */
  val onHighlighted: WebExtEvent[js.Function1[/* highlightInfo */ Anon_TabIds, Unit]] = js.native
  /**
    ...
    */
  val onMoved: WebExtEvent[js.Function2[/* tabId */ Double, /* moveInfo */ Anon_FromIndex, Unit]] = js.native
  /** Fired when a tab is closed. */
  val onRemoved: WebExtEvent[js.Function2[/* tabId */ Double, /* removeInfo */ Anon_IsWindowClosing, Unit]] = js.native
  ...
  val onZoomChange: WebExtEvent[js.Function1[/* ZoomChangeInfo */ Anon_NewZoomFactor, Unit]] = js.native
  /**
  ...
  def highlight(highlightInfo: Anon_Populate): js.Promise[typingsSlinky.firefoxDashWebextDashBrowser.browser.windows.Window] = js.native
  /**
  ...
  def moveInSuccession(tabIds: js.Array[Double], tabId: Double, options: Anon_Append): js.Promise[_] = js.native
  ...
  def query(queryInfo: Anon_ActiveAttention): js.Promise[js.Array[Tab]] = js.native
  /**
    * Reload a tab.
  ...
  def reload(tabId: Double, reloadProperties: Anon_BypassCache): js.Promise[Unit] = js.native
  ...
  def sendMessage(tabId: Double, message: js.Any, options: Anon_FrameIdNumber): js.Promise[_] = js.native
  /**
