...
import typingsSlinky.firefoxDashWebextDashBrowser.browser.downloads.BooleanDelta
import typingsSlinky.firefoxDashWebextDashBrowser.browser.downloads.DoubleDelta
import typingsSlinky.firefoxDashWebextDashBrowser.browser.downloads.StringDelta
