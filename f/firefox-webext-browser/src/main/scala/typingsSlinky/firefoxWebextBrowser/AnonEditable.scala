...
@js.native
trait AnonEditable extends js.Object {
...
object AnonEditable {
  @scala.inline
  def apply(contexts: js.Array[ContextType], editable: Boolean, menuIds: Double | js.Array[String]): AnonEditable = {
    ...
    __obj.asInstanceOf[AnonEditable]
  }
  @scala.inline
  implicit class AnonEditableOps[Self <: AnonEditable] (val x: Self) extends AnyVal {
    @scala.inline
