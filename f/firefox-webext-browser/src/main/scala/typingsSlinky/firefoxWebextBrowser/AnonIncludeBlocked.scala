...
@js.native
trait AnonIncludeBlocked extends js.Object {
...
object AnonIncludeBlocked {
  @scala.inline
  def apply(): AnonIncludeBlocked = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnonIncludeBlocked]
  }
  @scala.inline
  implicit class AnonIncludeBlockedOps[Self <: AnonIncludeBlocked] (val x: Self) extends AnyVal {
    @scala.inline
