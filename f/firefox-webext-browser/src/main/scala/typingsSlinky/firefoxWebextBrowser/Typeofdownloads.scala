...
trait Typeofdownloads extends js.Object {
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function1[/* downloadDelta */ AnonCanResume, Unit]] = js.native
  /* downloads events */
  ...
  /**
    ...
    */
  def download(options: AnonBody): js.Promise[Double] = js.native
  /**
  ...
  def getFileIcon(downloadId: Double, options: AnonSize): js.Promise[String] = js.native
