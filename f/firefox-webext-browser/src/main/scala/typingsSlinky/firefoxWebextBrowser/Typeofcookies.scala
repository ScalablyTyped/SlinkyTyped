...
trait Typeofcookies extends js.Object {
  ...
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function1[/* changeInfo */ AnonCause, Unit]] = js.native
  /* cookies functions */
  /**
    ...
    */
  def get(details: AnonFirstPartyDomain): js.Promise[Cookie] = js.native
  /**
    ...
    */
  def getAll(details: AnonDomain): js.Promise[js.Array[Cookie]] = js.native
  ...
  /**
    ...
    */
  def remove(details: AnonFirstPartyDomain): js.Promise[AnonStoreId] = js.native
  /**
    * Sets a cookie with the given cookie data; may overwrite equivalent cookies if they exist.
    * @param details Details about the cookie being set.
    */
  def set(details: AnonExpirationDate): js.Promise[Cookie] = js.native
}

object Typeofcookies {
  @scala.inline
  def apply(
    get: AnonFirstPartyDomain => js.Promise[Cookie],
  ...
  implicit class TypeofcookiesOps[Self <: Typeofcookies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: AnonFirstPartyDomain => js.Promise[Cookie]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAll(value: AnonDomain => js.Promise[js.Array[Cookie]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAll")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAllCookieStores(value: () => js.Promise[js.Array[CookieStore]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllCookieStores")(js.Any.fromFunction0(value))
        ret
    }
    @scala.inline
    def withOnChanged(value: WebExtEvent[js.Function1[/* changeInfo */ AnonCause, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRemove(value: AnonFirstPartyDomain => js.Promise[AnonStoreId]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSet(value: AnonExpirationDate => js.Promise[Cookie]): Self = {
        val ret = this.duplicate
