...
trait TypeofactivityLog extends js.Object {
  ...
  val onExtensionActivity: ActivityLogOnExtensionActivityEvent[js.Function1[/* details */ AnonData, Unit]] = js.native
}
...
object TypeofactivityLog {
  ...
  implicit class TypeofactivityLogOps[Self <: TypeofactivityLog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnExtensionActivity(value: ActivityLogOnExtensionActivityEvent[js.Function1[/* details */ AnonData, Unit]]): Self = {
