...
@js.native
trait AnonAlternateurls extends js.Object {
  ...
  /**
    ...
    */
  var params: js.UndefOr[js.Array[AnonCondition]] = js.native
...
object AnonAlternateurls {
  @scala.inline
  def apply(name: String, search_url: String): AnonAlternateurls = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], search_url = search_url.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAlternateurls]
  }
  @scala.inline
  implicit class AnonAlternateurlsOps[Self <: AnonAlternateurls] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withParams(value: js.Array[AnonCondition]): Self = {
        val ret = this.duplicate
