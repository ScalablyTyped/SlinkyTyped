...
@js.native
trait AnonOriginUrl extends js.Object {
...
object AnonOriginUrl {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonOriginUrl]
  }
  @scala.inline
  implicit class AnonOriginUrlOps[Self <: AnonOriginUrl] (val x: Self) extends AnyVal {
    @scala.inline
