...
object Typeofurlbar {
  ...
  implicit class TypeofurlbarOps[Self <: Typeofurlbar] (val x: Self) extends AnyVal {
    ...
    def withOnBehaviorRequested(
      value: UrlbarOnBehaviorRequestedEvent[js.Function1[/* query */ Query, active | inactive | restricting]]
    ): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnQueryCanceled(value: UrlbarOnQueryCanceledEvent[js.Function1[/* query */ Query, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onQueryCanceled")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnResultsRequested(value: UrlbarOnResultsRequestedEvent[js.Function1[/* query */ Query, js.Array[Result]]]): Self = {
        val ret = this.duplicate
