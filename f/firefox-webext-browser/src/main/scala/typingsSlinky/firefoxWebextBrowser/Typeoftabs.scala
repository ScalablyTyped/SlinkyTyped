...
import typingsSlinky.firefoxWebextBrowser.browser.extensionTypes.ImageDetails
import typingsSlinky.firefoxWebextBrowser.browser.extensionTypes.InjectDetails
import typingsSlinky.firefoxWebextBrowser.browser.runtime.Port
import typingsSlinky.firefoxWebextBrowser.browser.tabs.PageSettings
import typingsSlinky.firefoxWebextBrowser.browser.tabs.Tab
import typingsSlinky.firefoxWebextBrowser.browser.tabs.TabsOnUpdatedEvent
...
trait Typeoftabs extends js.Object {
  ...
  /**
    ...
    */
  val onActivated: WebExtEvent[js.Function1[/* activeInfo */ AnonPreviousTabId, Unit]] = js.native
  /**
  ...
  val onDetached: WebExtEvent[js.Function2[/* tabId */ Double, /* detachInfo */ AnonOldPosition, Unit]] = js.native
  /**
    * Fired when the highlighted or selected tabs in a window changes.
    * @deprecated Please use `tabs.onHighlighted`.
    */
  val onHighlightChanged: js.UndefOr[WebExtEvent[js.Function1[/* selectInfo */ AnonTabIds, Unit]]] = js.native
  /** Fired when the highlighted or selected tabs in a window changes. */
  val onHighlighted: WebExtEvent[js.Function1[/* highlightInfo */ AnonTabIds, Unit]] = js.native
  /**
    ...
    */
  val onMoved: WebExtEvent[js.Function2[/* tabId */ Double, /* moveInfo */ AnonFromIndex, Unit]] = js.native
  /** Fired when a tab is closed. */
  val onRemoved: WebExtEvent[js.Function2[/* tabId */ Double, /* removeInfo */ AnonIsWindowClosing, Unit]] = js.native
  ...
  def connect(tabId: Double, connectInfo: AnonFrameIdName): Port = js.native
  /** Creates a new tab. */
  def create(createProperties: AnonActive): js.Promise[Tab] = js.native
  /**
  ...
  def highlight(highlightInfo: AnonPopulate): js.Promise[typingsSlinky.firefoxWebextBrowser.browser.windows.Window] = js.native
  /**
  ...
  def move(tabIds: js.Array[Double], moveProperties: AnonIndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
  /**
    ...
    */
  def move(tabIds: Double, moveProperties: AnonIndexWindowId): js.Promise[Tab | js.Array[Tab]] = js.native
  /**
  ...
  def moveInSuccession(tabIds: js.Array[Double], tabId: Double, options: AnonAppend): js.Promise[_] = js.native
  ...
  def reload(tabId: Double, reloadProperties: AnonBypassCache): js.Promise[Unit] = js.native
  ...
  def sendMessage(tabId: Double, message: js.Any, options: AnonFrameIdNumber): js.Promise[_] = js.native
  /**
