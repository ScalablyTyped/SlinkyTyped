...
trait TypeofcontextMenus extends js.Object {
  ...
  /**
    ...
    */
  def create(createProperties: AnonChecked): Double | String = js.native
  def create(createProperties: AnonChecked, callback: js.Function0[Unit]): Double | String = js.native
  /**
  ...
  /**
    ...
    */
  def overrideContext(contextOptions: AnonBookmarkId): Unit = js.native
  /**
