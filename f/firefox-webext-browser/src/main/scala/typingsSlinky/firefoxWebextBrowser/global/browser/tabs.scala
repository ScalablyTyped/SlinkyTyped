...
import typingsSlinky.firefoxWebextBrowser.anon.Active
import typingsSlinky.firefoxWebextBrowser.anon.ActiveIndex
import typingsSlinky.firefoxWebextBrowser.anon.Append
import typingsSlinky.firefoxWebextBrowser.anon.Attention
import typingsSlinky.firefoxWebextBrowser.anon.Audible
import typingsSlinky.firefoxWebextBrowser.anon.BypassCache
import typingsSlinky.firefoxWebextBrowser.anon.FrameIdName
import typingsSlinky.firefoxWebextBrowser.anon.FromIndex
import typingsSlinky.firefoxWebextBrowser.anon.Highlighted
import typingsSlinky.firefoxWebextBrowser.anon.IndexWindowId
import typingsSlinky.firefoxWebextBrowser.anon.IsWindowClosing
import typingsSlinky.firefoxWebextBrowser.anon.NewPosition
import typingsSlinky.firefoxWebextBrowser.anon.NewZoomFactor
import typingsSlinky.firefoxWebextBrowser.anon.OldPosition
import typingsSlinky.firefoxWebextBrowser.anon.Populate
import typingsSlinky.firefoxWebextBrowser.anon.PreviousTabId
import typingsSlinky.firefoxWebextBrowser.anon.TabIds
import typingsSlinky.firefoxWebextBrowser.anon.WindowIdNumber
import typingsSlinky.firefoxWebextBrowser.anon.`3`
