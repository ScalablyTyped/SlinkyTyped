...
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.MoveDestination
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.OnChangedChangeInfo
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.OnChildrenReorderedReorderInfo
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.OnMovedMoveInfo
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.OnRemovedRemoveInfo
import typingsSlinky.firefoxWebextBrowser.browser.bookmarks.UpdateChanges
