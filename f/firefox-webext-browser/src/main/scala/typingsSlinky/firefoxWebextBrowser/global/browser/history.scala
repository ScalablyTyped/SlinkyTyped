...
import typingsSlinky.firefoxWebextBrowser.browser.history.AddUrlDetails
import typingsSlinky.firefoxWebextBrowser.browser.history.DeleteRangeRange
import typingsSlinky.firefoxWebextBrowser.browser.history.DeleteUrlDetails
import typingsSlinky.firefoxWebextBrowser.browser.history.GetVisitsDetails
import typingsSlinky.firefoxWebextBrowser.browser.history.HistoryItem
import typingsSlinky.firefoxWebextBrowser.browser.history.OnTitleChangedChanged
import typingsSlinky.firefoxWebextBrowser.browser.history.OnVisitRemovedRemoved
import typingsSlinky.firefoxWebextBrowser.browser.history.SearchQuery
