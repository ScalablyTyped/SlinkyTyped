...
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.GetPanelDetails
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.GetTitleDetails
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.IsOpenDetails
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.SetIconDetails
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.SetPanelDetails
import typingsSlinky.firefoxWebextBrowser.browser.sidebarAction.SetTitleDetails
