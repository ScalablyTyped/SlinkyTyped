...
object TypeofwebNavigation {
  ...
  implicit class TypeofwebNavigationOps[Self <: TypeofwebNavigation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAllFrames(value: TabIdNumber => js.Promise[js.Array[ParentFrameId]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getAllFrames")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetFrame(value: FrameId => js.Promise[ErrorOccurred]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("getFrame")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withOnBeforeNavigate(value: WebNavigationOnBeforeNavigateEvent[js.Function1[/* details */ ProcessId, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onBeforeNavigate")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnCommitted(value: WebNavigationOnCommittedEvent[js.Function1[/* details */ TimeStamp, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onCommitted")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnCompleted(value: WebNavigationOnCompletedEvent[js.Function1[/* details */ Url, Unit]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnDOMContentLoaded(value: WebNavigationOnDOMContentLoadedEvent[js.Function1[/* details */ Url, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onDOMContentLoaded")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnErrorOccurred(value: WebNavigationOnErrorOccurredEvent[js.Function1[/* details */ Error, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onErrorOccurred")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnHistoryStateUpdated(value: WebNavigationOnHistoryStateUpdatedEvent[js.Function1[/* details */ TimeStamp, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onHistoryStateUpdated")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnReferenceFragmentUpdated(value: WebNavigationOnReferenceFragmentUpdatedEvent[js.Function1[/* details */ TimeStamp, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onReferenceFragmentUpdated")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withOnTabReplaced(value: WebExtEvent[js.Function1[/* details */ ReplacedTabId, Unit]]): Self = {
        val ret = this.duplicate
