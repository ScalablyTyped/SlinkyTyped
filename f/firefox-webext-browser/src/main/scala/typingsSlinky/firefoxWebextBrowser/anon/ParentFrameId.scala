...
@js.native
trait ParentFrameId extends js.Object {
...
object ParentFrameId {
  
  @scala.inline
  def apply(frameId: Double, parentFrameId: Double, tabId: Double, url: String): ParentFrameId = {
    ...
    __obj.asInstanceOf[ParentFrameId]
  }
  
  @scala.inline
  implicit class ParentFrameIdOps[Self <: ParentFrameId] (val x: Self) extends AnyVal {
