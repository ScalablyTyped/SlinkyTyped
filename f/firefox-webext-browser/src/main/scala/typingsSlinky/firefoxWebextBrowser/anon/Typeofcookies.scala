...
object Typeofcookies {
  ...
  implicit class TypeofcookiesOps[Self <: Typeofcookies] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGet(value: FirstPartyDomain => js.Promise[Cookie]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("get")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withGetAll(value: Domain => js.Promise[js.Array[Cookie]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnChanged(value: WebExtEvent[js.Function1[/* changeInfo */ Cause, Unit]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onChanged")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withRemove(value: FirstPartyDomain => js.Promise[StoreId]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("remove")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withSet(value: ExpirationDate => js.Promise[Cookie]): Self = {
        val ret = this.duplicate
