...
object Alternateurls {
  ...
  implicit class AlternateurlsOps[Self <: Alternateurls] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsVarargs(value: Condition*): Self = this.set("params", js.Array(value :_*))
    
    @scala.inline
    def setParams(value: js.Array[Condition]): Self = this.set("params", value.asInstanceOf[js.Any])
