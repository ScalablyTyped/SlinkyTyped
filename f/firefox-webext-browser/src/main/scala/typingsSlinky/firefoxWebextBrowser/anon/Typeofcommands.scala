...
trait Typeofcommands extends js.Object {
  ...
  def getAll(): js.Promise[js.Array[typingsSlinky.firefoxWebextBrowser.browser.commands.Command]] = js.native
  /**
...
object Typeofcommands {
  @scala.inline
  def apply(
    getAll: () => js.Promise[js.Array[typingsSlinky.firefoxWebextBrowser.browser.commands.Command]],
  ...
  implicit class TypeofcommandsOps[Self <: Typeofcommands] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withGetAll(value: () => js.Promise[js.Array[typingsSlinky.firefoxWebextBrowser.browser.commands.Command]]): Self = {
    ...
    @scala.inline
    def withUpdate(value: Description => js.Promise[Unit]): Self = {
        val ret = this.duplicate
