...
trait Typeofbookmarks extends js.Object {
  /**
    ...
    */
  val onChanged: WebExtEvent[js.Function2[/* id */ String, /* changeInfo */ AnonTitleUrl, Unit]] = js.native
  /**
    ...
    */
  val onChildrenReordered: js.UndefOr[WebExtEvent[js.Function2[/* id */ String, /* reorderInfo */ AnonChildIds, Unit]]] = js.native
  /* bookmarks events */
  ...
  def move(id: String, destination: AnonIndex): js.Promise[BookmarkTreeNode] = js.native
  ...
  def search(query: AnonQuery): js.Promise[js.Array[BookmarkTreeNode]] = js.native
  /**
    ...
    */
  def update(id: String, changes: AnonTitle): js.Promise[BookmarkTreeNode] = js.native
}
