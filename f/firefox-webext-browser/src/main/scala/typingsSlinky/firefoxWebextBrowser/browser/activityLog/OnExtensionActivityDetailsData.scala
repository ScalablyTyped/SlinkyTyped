...
@js.native
trait OnExtensionActivityDetailsData extends js.Object {
...
object OnExtensionActivityDetailsData {
  ...
  @scala.inline
  implicit class OnExtensionActivityDetailsDataOps[Self <: OnExtensionActivityDetailsData] (val x: Self) extends AnyVal {
