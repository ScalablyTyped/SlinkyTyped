package typingsSlinky.firefoxWebextBrowser.browser.devtools.inspectedWindow
...
@js.native
trait EvalReturnExceptionInfo extends js.Object {
...
object EvalReturnExceptionInfo {
  ...
  @scala.inline
  implicit class EvalReturnExceptionInfoOps[Self <: EvalReturnExceptionInfo] (val x: Self) extends AnyVal {
