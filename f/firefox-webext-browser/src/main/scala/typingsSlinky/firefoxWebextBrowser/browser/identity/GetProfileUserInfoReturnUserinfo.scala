...
@js.native
trait GetProfileUserInfoReturnUserinfo extends js.Object {
...
object GetProfileUserInfoReturnUserinfo {
  ...
  @scala.inline
  implicit class GetProfileUserInfoReturnUserinfoOps[Self <: GetProfileUserInfoReturnUserinfo] (val x: Self) extends AnyVal {
