...
object ProtocolHandler {
  ...
  implicit class ProtocolHandlerOps[Self <: ProtocolHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withProtocol(value: String | ProtocolHandlerProtocol): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("protocol")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withUriTemplate(value: ExtensionURL | HttpURL): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("uriTemplate")(value.asInstanceOf[js.Any])
        ret
    }
  }
