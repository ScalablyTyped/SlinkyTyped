package typingsSlinky.firefoxWebextBrowser.browser.pageAction
...
object SetIconDetails {
  ...
  implicit class SetIconDetailsOps[Self <: SetIconDetails] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImageDataImageData(value: ImageData): Self = this.set("imageData", value.asInstanceOf[js.Any])
