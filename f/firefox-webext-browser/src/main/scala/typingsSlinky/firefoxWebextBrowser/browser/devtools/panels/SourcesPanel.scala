...
object SourcesPanel {
  ...
  implicit class SourcesPanelOps[Self <: SourcesPanel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withCreateSidebarPane(value: /* title */ String => js.Promise[ExtensionSidebarPane]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSidebarPane")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
    def withoutCreateSidebarPane: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("createSidebarPane")(js.undefined)
        ret
    }
  }
