...
import typingsSlinky.firefoxWebextBrowser.anon.Chromestyle
import typingsSlinky.firefoxWebextBrowser.anon.Contentscripts
...
import typingsSlinky.firefoxWebextBrowser.anon.Pingtype
...
trait WebExtensionManifest extends js.Object {
  ...
  var browser_action: js.UndefOr[Browserstyle] = js.native
  ...
  var telemetry: js.UndefOr[Pingtype] = js.native
...
object WebExtensionManifest {
  ...
  implicit class WebExtensionManifestOps[Self <: WebExtensionManifest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackground(value: Page | Persistent): Self = this.set("background", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBackground: Self = this.set("background", js.undefined)
    
    @scala.inline
    def setBrowser_action(value: Browserstyle): Self = this.set("browser_action", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCommands(value: StringDictionary[Suggestedkey]): Self = this.set("commands", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDeveloper(value: NameUrl): Self = this.set("developer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIcons(value: NumberDictionary[ExtensionFileUrl]): Self = this.set("icons", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPage_action(value: Defaulticon): Self = this.set("page_action", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSidebar_action(value: Defaultpanel): Self = this.set("sidebar_action", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSidebar_action: Self = this.set("sidebar_action", js.undefined)
    
    @scala.inline
    def setTelemetry(value: Pingtype): Self = this.set("telemetry", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUser_scripts(value: Apiscript): Self = this.set("user_scripts", value.asInstanceOf[js.Any])
