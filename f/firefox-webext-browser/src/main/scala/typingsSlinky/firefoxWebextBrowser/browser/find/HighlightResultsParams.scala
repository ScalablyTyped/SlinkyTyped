package typingsSlinky.firefoxWebextBrowser.browser.find
...
@js.native
trait HighlightResultsParams extends js.Object {
...
object HighlightResultsParams {
  ...
  @scala.inline
  implicit class HighlightResultsParamsOps[Self <: HighlightResultsParams] (val x: Self) extends AnyVal {
