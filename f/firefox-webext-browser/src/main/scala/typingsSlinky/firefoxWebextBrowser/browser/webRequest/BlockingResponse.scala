...
import typingsSlinky.firefoxWebextBrowser.anon.BinaryValue
...
object BlockingResponse {
  ...
  implicit class BlockingResponseOps[Self <: BlockingResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthCredentials(value: Password): Self = this.set("authCredentials", value.asInstanceOf[js.Any])
