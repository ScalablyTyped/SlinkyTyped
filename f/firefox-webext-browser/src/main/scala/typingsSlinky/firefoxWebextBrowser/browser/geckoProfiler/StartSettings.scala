package typingsSlinky.firefoxWebextBrowser.browser.geckoProfiler
...
@js.native
trait StartSettings extends js.Object {
...
object StartSettings {
  ...
  @scala.inline
  def apply(bufferSize: Double, features: js.Array[ProfilerFeature], interval: Double): StartSettings = {
  ...
  @scala.inline
  implicit class StartSettingsOps[Self <: StartSettings] (val x: Self) extends AnyVal {
