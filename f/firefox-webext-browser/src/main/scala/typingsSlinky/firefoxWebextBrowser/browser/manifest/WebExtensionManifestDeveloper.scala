...
@js.native
trait WebExtensionManifestDeveloper extends js.Object {
...
object WebExtensionManifestDeveloper {
  ...
  @scala.inline
  implicit class WebExtensionManifestDeveloperOps[Self <: WebExtensionManifestDeveloper] (val x: Self) extends AnyVal {
