...
object UpdateNotificationOptions {
  ...
  implicit class UpdateNotificationOptionsOps[Self <: UpdateNotificationOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonsVarargs(value: UpdateNotificationOptionsButtons*): Self = this.set("buttons", js.Array(value :_*))
    
    @scala.inline
    def setButtons(value: js.Array[UpdateNotificationOptionsButtons]): Self = this.set("buttons", value.asInstanceOf[js.Any])
