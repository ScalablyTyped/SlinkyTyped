...
object UrlbarOnBehaviorRequestedEvent {
  ...
  @scala.inline
  implicit class UrlbarOnBehaviorRequestedEventOps[Self <: UrlbarOnBehaviorRequestedEvent[_], TCallback] (val x: Self with UrlbarOnBehaviorRequestedEvent[TCallback]) extends AnyVal {
    @scala.inline
