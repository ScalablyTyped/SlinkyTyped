...
@js.native
trait OnChildrenReorderedReorderInfo extends js.Object {
...
object OnChildrenReorderedReorderInfo {
  ...
  @scala.inline
  implicit class OnChildrenReorderedReorderInfoOps[Self <: OnChildrenReorderedReorderInfo] (val x: Self) extends AnyVal {
