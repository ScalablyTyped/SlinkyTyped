package typingsSlinky.firefoxWebextBrowser.browser.events
...
object UrlFilter {
  ...
  implicit class UrlFilterOps[Self <: UrlFilter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPortsVarargs(value: (Double | (js.Tuple2[Double, Double]))*): Self = this.set("ports", js.Array(value :_*))
    
    @scala.inline
    def setPorts(value: js.Array[Double | (js.Tuple2[Double, Double])]): Self = this.set("ports", value.asInstanceOf[js.Any])
