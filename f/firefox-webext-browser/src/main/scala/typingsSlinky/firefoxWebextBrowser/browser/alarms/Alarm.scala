package typingsSlinky.firefoxWebextBrowser.browser.alarms
...
object Alarm {
  @scala.inline
  def apply(name: String, scheduledTime: Double, periodInMinutes: js.UndefOr[Double] = js.undefined): Alarm = {
