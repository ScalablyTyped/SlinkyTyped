...
import typingsSlinky.firefoxWebextBrowser.browser.notifications.CreateNotificationOptions
import typingsSlinky.firefoxWebextBrowser.browser.notifications.PermissionLevel
import typingsSlinky.firefoxWebextBrowser.browser.notifications.UpdateNotificationOptions
