...
trait TypeofuserScripts extends js.Object {
  ...
  /**
    ...
    */
  val onBeforeScript: WebExtEvent[js.Function1[/* userScript */ AnonDefineGlobals, Unit]] = js.native
...
object TypeofuserScripts {
  ...
  implicit class TypeofuserScriptsOps[Self <: TypeofuserScripts] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withOnBeforeScript(value: WebExtEvent[js.Function1[/* userScript */ AnonDefineGlobals, Unit]]): Self = {
