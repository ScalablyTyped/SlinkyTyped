...
import typingsSlinky.fnandoSparkline.anon.Value
...
object mod {
  ...
  */
  ...
  object SparklineNonNativeOptions {
    ...
    @scala.inline
    def SparklineOptions(): typingsSlinky.fnandoSparkline.mod.SparklineOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsSlinky.fnandoSparkline.mod.SparklineOptions]
    }
    
    @scala.inline
    def SparklineOptionsFetch[TEntry](fetch: TEntry => Double): typingsSlinky.fnandoSparkline.mod.SparklineOptionsFetch[TEntry] = {
      val __obj = js.Dynamic.literal(fetch = js.Any.fromFunction1(fetch))
      __obj.asInstanceOf[typingsSlinky.fnandoSparkline.mod.SparklineOptionsFetch[TEntry]]
    }
  }
