...
object FastFieldConfig {
  ...
  implicit class FastFieldConfigOps[Self <: FastFieldConfig[_], T] (val x: Self with FastFieldConfig[T]) extends AnyVal {
    ...
    @scala.inline
    def setAsFunctionComponent(value: ReactComponentClass[FieldInputProps[_] | js.Object]): Self = this.set("as", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAsComponentClass(value: ReactComponentClass[FieldInputProps[_] | js.Object]): Self = this.set("as", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setChildrenFunction1(value: /* props */ FieldProps[_, _] => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    
    @scala.inline
    def setChildren(value: (js.Function1[/* props */ FieldProps[_, _], ReactElement]) | ReactElement): Self = this.set("children", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteChildren: Self = this.set("children", js.undefined)
    
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[(FieldProps[_, _]) | js.Object]): Self = this.set("component", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[(FieldProps[_, _]) | js.Object]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRender(value: /* props */ FieldProps[_, _] => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
