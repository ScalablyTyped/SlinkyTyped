...
trait FastFieldConfig[T] extends js.Object {
  var children: js.UndefOr[(js.Function1[/* props */ FastFieldProps[_], TagMod[Any]]) | TagMod[Any]] = js.undefined
  var className: js.UndefOr[String] = js.undefined
  var component: js.UndefOr[String | (ReactComponentClass[FastFieldProps[_] | Unit])] = js.undefined
  var innerRef: js.UndefOr[js.Function1[/* instance */ js.Any, Unit]] = js.undefined
  var name: String
  var render: js.UndefOr[js.Function1[/* props */ FastFieldProps[_], TagMod[Any]]] = js.undefined
...
object FastFieldConfig {
  ...
  def apply[T](
    name: String,
    children: (js.Function1[/* props */ FastFieldProps[_], TagMod[Any]]) | TagMod[Any] = null,
    className: String = null,
    component: String | (ReactComponentClass[FastFieldProps[_] | Unit]) = null,
    innerRef: /* instance */ js.Any => Unit = null,
    render: /* props */ FastFieldProps[_] => TagMod[Any] = null,
    shouldUpdate: (/* nextProps */ T with GenericFieldHTMLAttributes with AnonFormik, /* props */ js.Object) => Boolean = null,
    `type`: String = null,
