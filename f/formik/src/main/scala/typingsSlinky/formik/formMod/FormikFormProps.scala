package typingsSlinky.formik.formMod
...
@js.native
trait FormikFormProps extends js.Object {
...
object FormikFormProps {
  ...
  @scala.inline
  implicit class FormikFormPropsOps[Self <: FormikFormProps] (val x: Self) extends AnyVal {
