...
trait FormikConfig[Values]
  ...
  /**
    ...
    */
  var children: js.UndefOr[(js.Function1[/* props */ FormikProps[Values], ReactElement]) | ReactElement] = js.native
  /**
    * Form component to render
    */
  var component: js.UndefOr[ReactComponentClass[FormikProps[Values]] | ReactElement] = js.native
  ...
  /**
    ...
    * @deprecated
    */
  var render: js.UndefOr[js.Function1[/* props */ FormikProps[Values], ReactElement]] = js.native
  /**
...
object FormikConfig {
  ...
  implicit class FormikConfigOps[Self <: FormikConfig[_], Values] (val x: Self with FormikConfig[Values]) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction1(value: /* props */ FormikProps[Values] => ReactElement): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    def setChildren(value: (js.Function1[/* props */ FormikProps[Values], ReactElement]) | ReactElement): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteChildren: Self = this.set("children", js.undefined)
    @scala.inline
    def setComponentReactElement(value: ReactElement): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentFunctionComponent(value: ReactComponentClass[FormikProps[Values]]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponentComponentClass(value: ReactComponentClass[FormikProps[Values]]): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    def setComponent(value: ReactComponentClass[FormikProps[Values]] | ReactElement): Self = this.set("component", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInnerRefRefObject(value: ReactRef[FormikProps[Values]]): Self = this.set("innerRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRender(value: /* props */ FormikProps[Values] => ReactElement): Self = this.set("render", js.Any.fromFunction1(value))
    @scala.inline
