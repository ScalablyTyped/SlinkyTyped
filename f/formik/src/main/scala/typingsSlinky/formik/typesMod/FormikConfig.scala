...
trait FormikConfig[Values]
  ...
  var children: js.UndefOr[(js.Function1[/* props */ FormikProps[Values], TagMod[Any]]) | TagMod[Any]] = js.undefined
  var component: js.UndefOr[ReactComponentClass[FormikProps[Values]] | TagMod[Any]] = js.undefined
  ...
  var render: js.UndefOr[js.Function1[/* props */ FormikProps[Values], TagMod[Any]]] = js.undefined
...
object FormikConfig {
  ...
  def apply[Values](
    ...
    children: (js.Function1[/* props */ FormikProps[Values], TagMod[Any]]) | TagMod[Any] = null,
