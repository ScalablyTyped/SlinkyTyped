...
object fieldMod {
  ...
  object FieldConfig {
    ...
    implicit class FieldConfigMutableBuilder[Self <: FieldConfig[_], V] (val x: Self with FieldConfig[V]) extends AnyVal {
      ...
      @scala.inline
      def setAsComponentClass(value: ReactComponentClass[FieldInputProps[V] | js.Object]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsFunctionComponent(value: ReactComponentClass[FieldInputProps[V] | js.Object]): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAsUndefined: Self = StObject.set(x, "as", js.undefined)
      
      @scala.inline
      def setChildren(value: (js.Function1[/* props */ FieldProps[V, _], ReactElement]) | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ FieldProps[V, _] => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[(FieldProps[V, _]) | js.Object]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[(FieldProps[V, _]) | js.Object]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRender(value: /* props */ FieldProps[V, _] => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
