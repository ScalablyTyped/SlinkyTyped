...
object fieldArrayMod {
  ...
  trait FieldArrayConfig extends StObject {
    ...
    /**
      ...
      */
    var children: js.UndefOr[js.Function1[/* props */ FieldArrayRenderProps, ReactElement]] = js.native
    ...
    /**
      ...
      */
    var render: js.UndefOr[js.Function1[/* props */ FieldArrayRenderProps, ReactElement]] = js.native
  ...
  object FieldArrayConfig {
    ...
    implicit class FieldArrayConfigMutableBuilder[Self <: FieldArrayConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: /* props */ FieldArrayRenderProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setComponent(value: String | (ReactComponentClass[FieldArrayRenderProps | Unit])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[FieldArrayRenderProps | Unit]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[FieldArrayRenderProps | Unit]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRender(value: /* props */ FieldArrayRenderProps => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
