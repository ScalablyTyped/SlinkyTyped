...
object anon {
  ...
  @js.native
  trait Dirty[Values /* <: FormikValues */] extends StObject {
  ...
  trait FnCallE extends StObject {
    ...
    def apply(e: SyntheticFocusEvent[_]): Unit = js.native
  ...
  object Formik {
    ...
    @scala.inline
    implicit class FormikMutableBuilder[Self <: Formik[_], Values] (val x: Self with Formik[Values]) extends AnyVal {
      
      @scala.inline
      def setFormik(value: FormikContextType[Values]): Self = StObject.set(x, "formik", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait PickDetailedHTMLPropsForm extends StObject {
    ...
    var ref: js.UndefOr[Ref[HTMLFormElement]] = js.native
  ...
  object PickDetailedHTMLPropsForm {
    ...
    @scala.inline
    def apply(): PickDetailedHTMLPropsForm = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickDetailedHTMLPropsForm]
    }
    
    @scala.inline
    implicit class PickDetailedHTMLPropsFormMutableBuilder[Self <: PickDetailedHTMLPropsForm] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[HTMLFormElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
