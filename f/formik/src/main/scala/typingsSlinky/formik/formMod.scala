...
object formMod {
  ...
  /* Inlined std.Pick<react.react.FormHTMLAttributes<std.HTMLFormElement>, std.Exclude<keyof react.react.FormHTMLAttributes<std.HTMLFormElement>, 'onReset' | 'onSubmit'>> */
  @js.native
  trait FormikFormProps extends StObject {
  ...
  object FormikFormProps {
    
    @scala.inline
    def apply(): FormikFormProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FormikFormProps]
    }
    
    @scala.inline
    implicit class FormikFormPropsMutableBuilder[Self <: FormikFormProps] (val x: Self) extends AnyVal {
