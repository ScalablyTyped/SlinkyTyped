...
object typesMod {
  ...
  object FormikConfig {
    ...
    implicit class FormikConfigMutableBuilder[Self <: FormikConfig[_], Values] (val x: Self with FormikConfig[Values]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: (js.Function1[/* props */ FormikProps[Values], ReactElement]) | ReactElement): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction1(value: /* props */ FormikProps[Values] => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setComponent(value: ReactComponentClass[FormikProps[Values]] | ReactElement): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[FormikProps[Values]]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[FormikProps[Values]]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInnerRefRefObject(value: ReactRef[FormikProps[Values]]): Self = StObject.set(x, "innerRef", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRender(value: /* props */ FormikProps[Values] => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  {[ K in keyof Values ]:? Values[K] extends std.Array<any>? Values[K][number] extends object? std.Array</ * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias formik.formik/dist/types.FormikErrors<Values[K][number]> * / object> | string | std.Array<string> : string | std.Array<string> : Values[K] extends object? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias formik.formik/dist/types.FormikErrors<Values[K]> * / object : string}
    */ typingsSlinky.formik.formikStrings.FormikErrors with TopLevel[js.Any]
  ...
  {[ K in keyof Values ]:? Values[K] extends std.Array<any>? Values[K][number] extends object? std.Array</ * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias formik.formik/dist/types.FormikTouched<Values[K][number]> * / object> : boolean : Values[K] extends object? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias formik.formik/dist/types.FormikTouched<Values[K]> * / object : boolean}
    */ typingsSlinky.formik.formikStrings.FormikTouched with TopLevel[js.Any]
  ...
  object SharedRenderProps {
    ...
    implicit class SharedRenderPropsMutableBuilder[Self <: SharedRenderProps[_], T] (val x: Self with SharedRenderProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: /* props */ T => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setComponent(value: String | (ReactComponentClass[T | Unit])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentComponentClass(value: ReactComponentClass[T | Unit]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentFunctionComponent(value: ReactComponentClass[T | Unit]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setComponentUndefined: Self = StObject.set(x, "component", js.undefined)
      
      @scala.inline
      def setRender(value: /* props */ T => ReactElement): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
