...
@js.native
trait AnonError[Values] extends js.Object {
  ...
  def setFieldTouched(field: /* keyof Values */ String, isTouched: js.UndefOr[scala.Nothing], shouldValidate: Boolean): Unit = js.native
