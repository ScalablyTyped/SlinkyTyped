...
object WithFormikConfig {
  @scala.inline
  def apply[Props, /* <: typingsSlinky.formik.typesMod.FormikValues */ Values, DeprecatedPayload](handleSubmit: (Values, FormikBag[Props, Values]) => Unit): WithFormikConfig[Props, Values, DeprecatedPayload] = {
  ...
  @scala.inline
  implicit class WithFormikConfigOps[Self <: WithFormikConfig[_, _, _], Props, /* <: typingsSlinky.formik.typesMod.FormikValues */ Values, DeprecatedPayload] (val x: Self with (WithFormikConfig[Props, Values, DeprecatedPayload])) extends AnyVal {
    @scala.inline
