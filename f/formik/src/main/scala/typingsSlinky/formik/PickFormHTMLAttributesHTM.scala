...
object PickFormHTMLAttributesHTM {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PickFormHTMLAttributesHTM]
  }
  @scala.inline
  implicit class PickFormHTMLAttributesHTMOps[Self <: PickFormHTMLAttributesHTM] (val x: Self) extends AnyVal {
    @scala.inline
