...
object PickFormHTMLAttributesHTM {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onChange: SyntheticEvent[EventTarget with HTMLFormElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onEmptied: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onEncrypted: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onEnded: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onError: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onFocus: SyntheticFocusEvent[HTMLFormElement] => Unit = null,
    onInput: SyntheticEvent[EventTarget with HTMLFormElement, Event_] => Unit = null,
    onInvalid: SyntheticEvent[EventTarget with HTMLFormElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onLoadStart: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onLoadedData: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    ...
    onPause: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onPlay: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onPlaying: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    ...
    onProgress: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onRateChange: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onScroll: SyntheticUIEvent[HTMLFormElement] => Unit = null,
    onSeeked: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onSeeking: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onSelect: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onStalled: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onSuspend: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onTimeUpdate: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
    onWaiting: SyntheticEvent[Event_, HTMLFormElement] => Unit = null,
