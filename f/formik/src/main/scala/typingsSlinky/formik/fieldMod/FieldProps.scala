...
import typingsSlinky.formik.anon.OnBlur
...
trait FieldProps[V] extends js.Object {
  var field: OnBlur = js.native
  var form: FormikProps[V] = js.native
}

object FieldProps {
  @scala.inline
  def apply[V](field: OnBlur, form: FormikProps[V]): FieldProps[V] = {
  ...
  implicit class FieldPropsOps[Self[v] <: FieldProps[v], V] (val x: Self[V]) extends AnyVal {
    ...
    @scala.inline
    def withField(value: OnBlur): Self[V] = {
