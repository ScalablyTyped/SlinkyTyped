...
trait FieldConfig extends js.Object {
  var children: js.UndefOr[(js.Function1[/* props */ FieldProps[_], TagMod[Any]]) | TagMod[Any]] = js.undefined
  var component: js.UndefOr[String | (ReactComponentClass[FieldProps[_] | Unit])] = js.undefined
  var innerRef: js.UndefOr[js.Function1[/* instance */ js.Any, Unit]] = js.undefined
  var name: String
  var render: js.UndefOr[js.Function1[/* props */ FieldProps[_], TagMod[Any]]] = js.undefined
...
object FieldConfig {
  ...
  def apply(
    name: String,
    children: (js.Function1[/* props */ FieldProps[_], TagMod[Any]]) | TagMod[Any] = null,
    component: String | (ReactComponentClass[FieldProps[_] | Unit]) = null,
    innerRef: /* instance */ js.Any => Unit = null,
    render: /* props */ FieldProps[_] => TagMod[Any] = null,
    `type`: String = null,
