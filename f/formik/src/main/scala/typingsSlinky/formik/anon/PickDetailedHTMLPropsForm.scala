...
object PickDetailedHTMLPropsForm {
  ...
  @scala.inline
  implicit class PickDetailedHTMLPropsFormOps[Self <: PickDetailedHTMLPropsForm] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRef(value: Ref[HTMLFormElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
