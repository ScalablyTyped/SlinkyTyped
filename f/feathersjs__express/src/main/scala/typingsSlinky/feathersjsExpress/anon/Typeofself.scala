...
trait Typeofself extends js.Object {
  ...
  /**
    ...
    */
  def static(root: String): typingsSlinky.serveStatic.mod.RequestHandler[Response_[_]] = js.native
  /**
    * This is a built-in middleware function in Express. It serves static files and is based on serve-static.
    */
  def static(root: String, options: ServeStaticOptions[Response_[_]]): typingsSlinky.serveStatic.mod.RequestHandler[Response_[_]] = js.native
  /**
    * This is a built-in middleware function in Express. It serves static files and is based on serve-static.
    */
  @JSName("static")
