...
object ServiceWorkerRegistration {
  ...
  implicit class ServiceWorkerRegistrationOps[Self <: ServiceWorkerRegistration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setServiceWorkerRegistration(value: org.scalajs.dom.experimental.serviceworkers.ServiceWorkerRegistration): Self = this.set("serviceWorkerRegistration", value.asInstanceOf[js.Any])
