...
trait Affiliation
  ...
  var shipping: js.UndefOr[typingsSlinky.firebase.mod.analytics.Currency] = js.undefined
  var tax: js.UndefOr[typingsSlinky.firebase.mod.analytics.Currency] = js.undefined
...
object Affiliation {
  ...
  def apply(
    ...
    shipping: typingsSlinky.firebase.mod.analytics.Currency = null,
    tax: typingsSlinky.firebase.mod.analytics.Currency = null,
