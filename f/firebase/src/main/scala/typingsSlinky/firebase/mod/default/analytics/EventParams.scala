...
trait EventParams extends StObject {
  ...
  var items: js.UndefOr[js.Array[typingsSlinky.firebase.mod.firebase.analytics.Item]] = js.native
  ...
  var promotions: js.UndefOr[js.Array[typingsSlinky.firebase.mod.firebase.analytics.Promotion]] = js.native
...
object EventParams {
  ...
  implicit class EventParamsMutableBuilder[Self <: EventParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[typingsSlinky.firebase.mod.firebase.analytics.Item]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: typingsSlinky.firebase.mod.firebase.analytics.Item*): Self = StObject.set(x, "items", js.Array(value :_*))
    ...
    @scala.inline
    def setPromotions(value: js.Array[typingsSlinky.firebase.mod.firebase.analytics.Promotion]): Self = StObject.set(x, "promotions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPromotionsUndefined: Self = StObject.set(x, "promotions", js.undefined)
    
    @scala.inline
    def setPromotionsVarargs(value: typingsSlinky.firebase.mod.firebase.analytics.Promotion*): Self = StObject.set(x, "promotions", js.Array(value :_*))
