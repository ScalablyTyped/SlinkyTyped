...
object EventParams {
  ...
  implicit class EventParamsOps[Self <: EventParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: typingsSlinky.firebase.mod.firebase.analytics.Item*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[typingsSlinky.firebase.mod.firebase.analytics.Item]): Self = this.set("items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPromotionsVarargs(value: typingsSlinky.firebase.mod.firebase.analytics.Promotion*): Self = this.set("promotions", js.Array(value :_*))
    
    @scala.inline
    def setPromotions(value: js.Array[typingsSlinky.firebase.mod.firebase.analytics.Promotion]): Self = this.set("promotions", value.asInstanceOf[js.Any])
