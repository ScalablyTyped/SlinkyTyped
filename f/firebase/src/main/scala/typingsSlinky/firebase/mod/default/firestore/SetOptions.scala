...
object SetOptions {
  ...
  implicit class SetOptionsOps[Self <: SetOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMergeFieldsVarargs(value: (String | typingsSlinky.firebase.mod.firebase.firestore.FieldPath)*): Self = this.set("mergeFields", js.Array(value :_*))
    
    @scala.inline
    def setMergeFields(value: js.Array[String | typingsSlinky.firebase.mod.firebase.firestore.FieldPath]): Self = this.set("mergeFields", value.asInstanceOf[js.Any])
