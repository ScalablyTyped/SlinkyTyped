...
object functions {
  ...
  @js.native
  def apply(): typingsSlinky.firebase.mod.firebase.functions.Functions = js.native
  @JSImport("firebase", "default.functions")
  @js.native
  def apply(app: App): typingsSlinky.firebase.mod.firebase.functions.Functions = js.native
  ...
  class Functions protected () extends StObject {
    ...
    /**
      ...
      */
    def httpsCallable(name: String): typingsSlinky.firebase.mod.firebase.functions.HttpsCallable = js.native
    def httpsCallable(name: String, options: typingsSlinky.firebase.mod.firebase.functions.HttpsCallableOptions): typingsSlinky.firebase.mod.firebase.functions.HttpsCallable = js.native
  ...
  */
  ...
  type HttpsCallable = js.Function1[
    ...
    js.Promise[typingsSlinky.firebase.mod.firebase.functions.HttpsCallableResult]
  ]
  ...
  trait HttpsError extends Error {
    ...
    /**
      ...
      */
    val code: typingsSlinky.firebase.mod.firebase.functions.FunctionsErrorCode = js.native
  ...
  object HttpsError {
    ...
    @scala.inline
    def apply(
      code: typingsSlinky.firebase.mod.firebase.functions.FunctionsErrorCode,
      message: String,
      name: String
    ): HttpsError = {
    ...
    implicit class HttpsErrorMutableBuilder[Self <: HttpsError] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCode(value: typingsSlinky.firebase.mod.firebase.functions.FunctionsErrorCode): Self = StObject.set(x, "code", value.asInstanceOf[js.Any])
