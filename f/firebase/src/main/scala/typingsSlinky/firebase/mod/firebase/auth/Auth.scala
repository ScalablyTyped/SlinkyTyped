...
import typingsSlinky.firebase.mod.firebase.Observer
import typingsSlinky.firebase.mod.firebase.Unsubscribe
import typingsSlinky.firebase.mod.firebase.User
import typingsSlinky.firebase.mod.firebase.app.App
import typingsSlinky.firebase.mod.firebase.auth.Auth.Persistence
...
trait Auth extends StObject {
  ...
  def onAuthStateChanged(nextOrObserver: Observer[_, js.Error], error: js.UndefOr[scala.Nothing], completed: Unsubscribe): Unsubscribe = js.native
  ...
  def onIdTokenChanged(nextOrObserver: Observer[_, js.Error], error: js.UndefOr[scala.Nothing], completed: Unsubscribe): Unsubscribe = js.native
