...
package object auth {
  ...
  /**
    ...
    */
  type EmailAuthProvider = typingsSlinky.firebase.mod.firebase.auth.EmailAuthProviderInstance
  ...
  /**
    ...
    * changes.
    */
  type FacebookAuthProvider = typingsSlinky.firebase.mod.firebase.auth.FacebookAuthProviderInstance
  ...
  /**
    ...
    * changes.
    */
  type GithubAuthProvider = typingsSlinky.firebase.mod.firebase.auth.GithubAuthProviderInstance
  ...
  /**
    ...
    * changes.
    */
  type GoogleAuthProvider = typingsSlinky.firebase.mod.firebase.auth.GoogleAuthProviderInstance
  ...
  /**
    ...
    *
    */
  type PhoneAuthCredential = typingsSlinky.firebase.mod.firebase.auth.AuthCredential
  ...
  /**
    ...
    */
  type PhoneAuthProvider = typingsSlinky.firebase.mod.firebase.auth.PhoneAuthProviderInstance
  
  /**
    * The class for asserting ownership of a phone second factor.
    */
  type PhoneMultiFactorAssertion = typingsSlinky.firebase.mod.firebase.auth.MultiFactorAssertion
  ...
  /**
    ...
    *     thrown.
    */
  type RecaptchaVerifier = typingsSlinky.firebase.mod.firebase.auth.RecaptchaVerifierInstance
  ...
  /**
    ...
    * changes.
    */
  type TwitterAuthProvider = typingsSlinky.firebase.mod.firebase.auth.TwitterAuthProviderInstance
}
