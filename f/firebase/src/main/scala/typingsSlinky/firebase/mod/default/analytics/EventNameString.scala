...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsSlinky.firebase.firebaseStrings.checkout_progress
  - typingsSlinky.firebase.firebaseStrings.exception
  - typingsSlinky.firebase.firebaseStrings.generate_lead
  - typingsSlinky.firebase.firebaseStrings.login
  - typingsSlinky.firebase.firebaseStrings.page_view
  - typingsSlinky.firebase.firebaseStrings.purchase
  - typingsSlinky.firebase.firebaseStrings.refund
  - typingsSlinky.firebase.firebaseStrings.remove_from_cart
