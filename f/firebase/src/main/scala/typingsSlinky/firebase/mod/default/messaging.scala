...
object messaging {
  ...
  trait MessagePayload extends StObject {
    ...
    /**
      ...
      */
    var fcmOptions: js.UndefOr[typingsSlinky.firebase.mod.firebase.messaging.FcmOptions] = js.native
    ...
    /**
      ...
      */
    var notification: js.UndefOr[typingsSlinky.firebase.mod.firebase.messaging.NotificationPayload] = js.native
  }
  object MessagePayload {
    ...
    implicit class MessagePayloadMutableBuilder[Self <: MessagePayload] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFcmOptions(value: typingsSlinky.firebase.mod.firebase.messaging.FcmOptions): Self = StObject.set(x, "fcmOptions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setNotification(value: typingsSlinky.firebase.mod.firebase.messaging.NotificationPayload): Self = StObject.set(x, "notification", value.asInstanceOf[js.Any])
