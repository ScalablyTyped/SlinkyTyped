...
object DocumentChange {
  ...
  implicit class DocumentChangeOps[Self <: DocumentChange[_], T] (val x: Self with DocumentChange[T]) extends AnyVal {
    ...
    @scala.inline
    def setDoc(value: typingsSlinky.firebase.mod.firebase.firestore.QueryDocumentSnapshot[T]): Self = this.set("doc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: typingsSlinky.firebase.mod.firebase.firestore.DocumentChangeType): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
