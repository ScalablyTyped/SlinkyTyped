...
trait DocumentChange[T] extends StObject {
  ...
  val doc: typingsSlinky.firebase.mod.firebase.firestore.QueryDocumentSnapshot[T] = js.native
  ...
  val `type`: typingsSlinky.firebase.mod.firebase.firestore.DocumentChangeType = js.native
}
object DocumentChange {
  
  @scala.inline
  def apply[T](
    doc: typingsSlinky.firebase.mod.firebase.firestore.QueryDocumentSnapshot[T],
    newIndex: Double,
    oldIndex: Double,
    `type`: typingsSlinky.firebase.mod.firebase.firestore.DocumentChangeType
  ): DocumentChange[T] = {
  ...
  implicit class DocumentChangeMutableBuilder[Self <: DocumentChange[_], T] (val x: Self with DocumentChange[T]) extends AnyVal {
    ...
    @scala.inline
    def setDoc(value: typingsSlinky.firebase.mod.firebase.firestore.QueryDocumentSnapshot[T]): Self = StObject.set(x, "doc", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: typingsSlinky.firebase.mod.firebase.firestore.DocumentChangeType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
