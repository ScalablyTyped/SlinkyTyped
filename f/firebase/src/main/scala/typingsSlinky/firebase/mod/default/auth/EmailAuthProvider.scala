...
class EmailAuthProvider ()
  extends typingsSlinky.firebase.mod.firebase.auth.EmailAuthProviderInstance
/* static members */
@JSImport("firebase", "auth.EmailAuthProvider")
@js.native
object EmailAuthProvider extends js.Object {
  ...
  /**
    ...
    */
  def credential(email: String, password: String): typingsSlinky.firebase.mod.firebase.auth.AuthCredential = js.native
  ...
  /**
    ...
    * @return The auth provider credential.
    */
  def credentialWithLink(email: String, emailLink: String): typingsSlinky.firebase.mod.firebase.auth.AuthCredential = js.native
}
