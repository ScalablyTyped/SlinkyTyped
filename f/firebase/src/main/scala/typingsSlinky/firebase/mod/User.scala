...
import typingsSlinky.firebase.mod.User.MultiFactorUser
import typingsSlinky.firebase.mod.auth.ActionCodeSettings
import typingsSlinky.firebase.mod.auth.ApplicationVerifier
import typingsSlinky.firebase.mod.auth.AuthCredential
import typingsSlinky.firebase.mod.auth.AuthProvider
import typingsSlinky.firebase.mod.auth.ConfirmationResult
import typingsSlinky.firebase.mod.auth.IdTokenResult
import typingsSlinky.firebase.mod.auth.MultiFactorAssertion
import typingsSlinky.firebase.mod.auth.MultiFactorInfo
import typingsSlinky.firebase.mod.auth.MultiFactorSession
import typingsSlinky.firebase.mod.auth.UserCredential
