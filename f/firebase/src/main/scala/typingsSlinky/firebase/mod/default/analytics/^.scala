...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def apply(): typingsSlinky.firebase.mod.firebase.analytics.Analytics = js.native
  def apply(app: App): typingsSlinky.firebase.mod.firebase.analytics.Analytics = js.native
}
