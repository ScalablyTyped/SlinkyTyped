...
import typingsSlinky.firebase.anon.ServiceWorkerRegistration
import typingsSlinky.firebase.mod.firebase.CompleteFn
import typingsSlinky.firebase.mod.firebase.ErrorFn
import typingsSlinky.firebase.mod.firebase.NextFn
...
trait Messaging extends js.Object {
  ...
  def onBackgroundMessage(nextOrObserver: NextFn[MessagePayload], error: ErrorFn[js.Error]): Unsubscribe = js.native
  def onBackgroundMessage(nextOrObserver: NextFn[MessagePayload], error: ErrorFn[js.Error], completed: CompleteFn): Unsubscribe = js.native
  def onBackgroundMessage(nextOrObserver: Observer[MessagePayload, js.Error]): Unsubscribe = js.native
  def onBackgroundMessage(
    nextOrObserver: Observer[MessagePayload, js.Error],
    error: js.UndefOr[scala.Nothing],
    completed: CompleteFn
  ): Unsubscribe = js.native
  def onBackgroundMessage(nextOrObserver: Observer[MessagePayload, js.Error], error: ErrorFn[js.Error]): Unsubscribe = js.native
  def onBackgroundMessage(
    nextOrObserver: Observer[MessagePayload, js.Error],
    error: ErrorFn[js.Error],
    completed: CompleteFn
  ): Unsubscribe = js.native
