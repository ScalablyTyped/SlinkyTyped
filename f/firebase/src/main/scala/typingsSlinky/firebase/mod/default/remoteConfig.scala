  ...
  */
  ...
  trait RemoteConfig extends StObject {
    ...
    /**
      * Gets all config.
      */
    def getAll(): StringDictionary[typingsSlinky.firebase.mod.firebase.remoteConfig.Value] = js.native
    ...
    /**
      ...
      */
    def getValue(key: String): typingsSlinky.firebase.mod.firebase.remoteConfig.Value = js.native
    
    /**
      * The status of the last fetch <i>attempt</i>.
      */
    var lastFetchStatus: typingsSlinky.firebase.mod.firebase.remoteConfig.FetchStatus = js.native
    
    /**
      * Defines the log level to use.
      */
    def setLogLevel(logLevel: typingsSlinky.firebase.mod.firebase.remoteConfig.LogLevel): Unit = js.native
    
    /**
      * Defines configuration for the Remote Config SDK.
      */
    var settings: typingsSlinky.firebase.mod.firebase.remoteConfig.Settings = js.native
  }
  object RemoteConfig {
    ...
    def apply(
      ...
      getAll: () => StringDictionary[typingsSlinky.firebase.mod.firebase.remoteConfig.Value],
      getBoolean: String => Boolean,
      getNumber: String => Double,
      getString: String => String,
      getValue: String => typingsSlinky.firebase.mod.firebase.remoteConfig.Value,
      lastFetchStatus: typingsSlinky.firebase.mod.firebase.remoteConfig.FetchStatus,
      setLogLevel: typingsSlinky.firebase.mod.firebase.remoteConfig.LogLevel => Unit,
      settings: typingsSlinky.firebase.mod.firebase.remoteConfig.Settings
    ): RemoteConfig = {
    ...
    implicit class RemoteConfigMutableBuilder[Self <: RemoteConfig] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetAll(value: () => StringDictionary[typingsSlinky.firebase.mod.firebase.remoteConfig.Value]): Self = StObject.set(x, "getAll", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setGetValue(value: String => typingsSlinky.firebase.mod.firebase.remoteConfig.Value): Self = StObject.set(x, "getValue", js.Any.fromFunction1(value))
      
      @scala.inline
      def setLastFetchStatus(value: typingsSlinky.firebase.mod.firebase.remoteConfig.FetchStatus): Self = StObject.set(x, "lastFetchStatus", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSetLogLevel(value: typingsSlinky.firebase.mod.firebase.remoteConfig.LogLevel => Unit): Self = StObject.set(x, "setLogLevel", js.Any.fromFunction1(value))
      
      @scala.inline
      def setSettings(value: typingsSlinky.firebase.mod.firebase.remoteConfig.Settings): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Value extends StObject {
    ...
    /**
      ...
      */
    def getSource(): typingsSlinky.firebase.mod.firebase.remoteConfig.ValueSource = js.native
  }
  object Value {
    ...
    def apply(
      ...
      asNumber: () => Double,
      asString: () => String,
      getSource: () => typingsSlinky.firebase.mod.firebase.remoteConfig.ValueSource
    ): Value = {
    ...
    implicit class ValueMutableBuilder[Self <: Value] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetSource(value: () => typingsSlinky.firebase.mod.firebase.remoteConfig.ValueSource): Self = StObject.set(x, "getSource", js.Any.fromFunction0(value))
    }
  }
