...
object RemoteConfig {
  ...
  implicit class RemoteConfigOps[Self <: RemoteConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetAll(value: () => StringDictionary[typingsSlinky.firebase.mod.firebase.remoteConfig.Value]): Self = this.set("getAll", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetValue(value: String => typingsSlinky.firebase.mod.firebase.remoteConfig.Value): Self = this.set("getValue", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLastFetchStatus(value: typingsSlinky.firebase.mod.firebase.remoteConfig.FetchStatus): Self = this.set("lastFetchStatus", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSetLogLevel(value: typingsSlinky.firebase.mod.firebase.remoteConfig.LogLevel => Unit): Self = this.set("setLogLevel", js.Any.fromFunction1(value))
    
    @scala.inline
    def setSettings(value: typingsSlinky.firebase.mod.firebase.remoteConfig.Settings): Self = this.set("settings", value.asInstanceOf[js.Any])
  }
}
