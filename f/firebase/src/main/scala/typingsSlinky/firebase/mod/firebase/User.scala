...
import typingsSlinky.firebase.anon.DisplayName
import typingsSlinky.firebase.mod.firebase.User.MultiFactorUser
import typingsSlinky.firebase.mod.firebase.auth.ActionCodeSettings
import typingsSlinky.firebase.mod.firebase.auth.ApplicationVerifier
import typingsSlinky.firebase.mod.firebase.auth.AuthCredential
import typingsSlinky.firebase.mod.firebase.auth.AuthProvider
import typingsSlinky.firebase.mod.firebase.auth.ConfirmationResult
import typingsSlinky.firebase.mod.firebase.auth.IdTokenResult
import typingsSlinky.firebase.mod.firebase.auth.MultiFactorAssertion
import typingsSlinky.firebase.mod.firebase.auth.MultiFactorInfo
import typingsSlinky.firebase.mod.firebase.auth.MultiFactorSession
import typingsSlinky.firebase.mod.firebase.auth.UserCredential
import typingsSlinky.firebase.mod.firebase.auth.UserMetadata
