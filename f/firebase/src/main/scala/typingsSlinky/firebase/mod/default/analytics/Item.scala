...
trait Item extends StObject {
  ...
  var discount: js.UndefOr[typingsSlinky.firebase.mod.firebase.analytics.Currency] = js.native
  ...
  var price: js.UndefOr[typingsSlinky.firebase.mod.firebase.analytics.Currency] = js.native
...
object Item {
  ...
  implicit class ItemMutableBuilder[Self <: Item] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDiscount(value: typingsSlinky.firebase.mod.firebase.analytics.Currency): Self = StObject.set(x, "discount", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrice(value: typingsSlinky.firebase.mod.firebase.analytics.Currency): Self = StObject.set(x, "price", value.asInstanceOf[js.Any])
