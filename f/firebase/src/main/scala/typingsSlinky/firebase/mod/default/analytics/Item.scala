...
object Item {
  ...
  implicit class ItemOps[Self <: Item] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDiscount(value: typingsSlinky.firebase.mod.firebase.analytics.Currency): Self = this.set("discount", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrice(value: typingsSlinky.firebase.mod.firebase.analytics.Currency): Self = this.set("price", value.asInstanceOf[js.Any])
