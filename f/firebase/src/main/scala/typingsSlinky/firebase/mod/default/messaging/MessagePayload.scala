...
object MessagePayload {
  ...
  implicit class MessagePayloadOps[Self <: MessagePayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFcmOptions(value: typingsSlinky.firebase.mod.firebase.messaging.FcmOptions): Self = this.set("fcmOptions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFcmOptions: Self = this.set("fcmOptions", js.undefined)
    
    @scala.inline
    def setNotification(value: typingsSlinky.firebase.mod.firebase.messaging.NotificationPayload): Self = this.set("notification", value.asInstanceOf[js.Any])
