...
class FieldValue protected () extends StObject {
  ...
  /**
    ...
    */
  def isEqual(other: typingsSlinky.firebase.mod.firebase.firestore.FieldValue): Boolean = js.native
}
/* static members */
object FieldValue {
  ...
  @js.native
  def arrayRemove(elements: js.Any*): typingsSlinky.firebase.mod.firebase.firestore.FieldValue = js.native
  ...
  @js.native
  def arrayUnion(elements: js.Any*): typingsSlinky.firebase.mod.firebase.firestore.FieldValue = js.native
  ...
  @js.native
  def delete(): typingsSlinky.firebase.mod.firebase.firestore.FieldValue = js.native
  ...
  @js.native
  def increment(n: Double): typingsSlinky.firebase.mod.firebase.firestore.FieldValue = js.native
  ...
  @js.native
  def serverTimestamp(): typingsSlinky.firebase.mod.firebase.firestore.FieldValue = js.native
}
