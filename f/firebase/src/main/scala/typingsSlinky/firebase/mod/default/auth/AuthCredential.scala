...
abstract class AuthCredential ()
  extends typingsSlinky.firebase.mod.firebase.auth.AuthCredential
/* static members */
@JSImport("firebase", "auth.AuthCredential")
@js.native
object AuthCredential extends js.Object {
  
  def fromJSON(json: String): typingsSlinky.firebase.mod.firebase.auth.AuthCredential | Null = js.native
  /**
    ...
    *     AuthCredential.
    */
  def fromJSON(json: js.Object): typingsSlinky.firebase.mod.firebase.auth.AuthCredential | Null = js.native
}
