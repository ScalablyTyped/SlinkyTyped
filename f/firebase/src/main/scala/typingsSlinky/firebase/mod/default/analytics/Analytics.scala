...
trait Analytics extends js.Object {
  ...
  /**
    ...
    */
  def logEvent[T /* <: String */](eventName: typingsSlinky.firebase.mod.firebase.analytics.CustomEventName[T]): Unit = js.native
  def logEvent[T /* <: String */](
    eventName: typingsSlinky.firebase.mod.firebase.analytics.CustomEventName[T],
    eventParams: js.UndefOr[scala.Nothing],
    options: typingsSlinky.firebase.mod.firebase.analytics.AnalyticsCallOptions
  ): Unit = js.native
  def logEvent[T /* <: String */](
    eventName: typingsSlinky.firebase.mod.firebase.analytics.CustomEventName[T],
  ...
  def setCurrentScreen(screenName: String, options: typingsSlinky.firebase.mod.firebase.analytics.AnalyticsCallOptions): Unit = js.native
  
  /**
    * Use gtag 'config' command to set 'user_id'.
    */
  def setUserId(id: String): Unit = js.native
  def setUserId(id: String, options: typingsSlinky.firebase.mod.firebase.analytics.AnalyticsCallOptions): Unit = js.native
  
  /**
    * Use gtag 'config' command to set all params specified.
    */
  def setUserProperties(properties: typingsSlinky.firebase.mod.firebase.analytics.CustomParams): Unit = js.native
  def setUserProperties(
    properties: typingsSlinky.firebase.mod.firebase.analytics.CustomParams,
    options: typingsSlinky.firebase.mod.firebase.analytics.AnalyticsCallOptions
  ): Unit = js.native
}
