...
class Firestore protected () extends js.Object {
  ...
  /**
    ...
    */
  def batch(): typingsSlinky.firebase.mod.firebase.firestore.WriteBatch = js.native
  ...
  /**
    ...
    */
  def collectionGroup(collectionId: String): typingsSlinky.firebase.mod.firebase.firestore.Query[typingsSlinky.firebase.mod.firebase.firestore.DocumentData] = js.native
  ...
  /**
    ...
    */
  def doc(documentPath: String): typingsSlinky.firebase.mod.firebase.firestore.DocumentReference[typingsSlinky.firebase.mod.firebase.firestore.DocumentData] = js.native
  ...
  def enablePersistence(settings: typingsSlinky.firebase.mod.firebase.firestore.PersistenceSettings): js.Promise[Unit] = js.native
  ...
  def runTransaction[T](
    updateFunction: js.Function1[
      /* transaction */ typingsSlinky.firebase.mod.firebase.firestore.Transaction, 
      js.Promise[T]
    ]
  ...
  /**
    ...
    */
  def settings(settings: typingsSlinky.firebase.mod.firebase.firestore.Settings): Unit = js.native
