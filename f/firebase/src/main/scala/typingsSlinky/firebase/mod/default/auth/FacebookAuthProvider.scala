...
class FacebookAuthProvider ()
  extends typingsSlinky.firebase.mod.firebase.auth.FacebookAuthProviderInstance
/* static members */
@JSImport("firebase", "auth.FacebookAuthProvider")
@js.native
object FacebookAuthProvider extends js.Object {
  ...
  /**
    ...
    */
  def credential(token: String): typingsSlinky.firebase.mod.firebase.auth.OAuthCredential = js.native
}
