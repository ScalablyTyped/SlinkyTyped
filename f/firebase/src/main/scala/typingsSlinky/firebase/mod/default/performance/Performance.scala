package typingsSlinky.firebase.mod.default.performance
...
object Performance {
  ...
  implicit class PerformanceOps[Self <: Performance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTrace(value: String => typingsSlinky.firebase.mod.firebase.performance.Trace): Self = this.set("trace", js.Any.fromFunction1(value))
  }
}
