...
trait SnapshotMetadata extends StObject {
  ...
  /**
    ...
    */
  def isEqual(other: typingsSlinky.firebase.mod.firebase.firestore.SnapshotMetadata): Boolean = js.native
}
object SnapshotMetadata {
  ...
  def apply(
    ...
    isEqual: typingsSlinky.firebase.mod.firebase.firestore.SnapshotMetadata => Boolean
  ): SnapshotMetadata = {
  ...
  implicit class SnapshotMetadataMutableBuilder[Self <: SnapshotMetadata] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsEqual(value: typingsSlinky.firebase.mod.firebase.firestore.SnapshotMetadata => Boolean): Self = StObject.set(x, "isEqual", js.Any.fromFunction1(value))
  }
}
