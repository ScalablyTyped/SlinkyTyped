...
class ActionCodeURL protected ()
  extends typingsSlinky.firebase.mod.firebase.auth.ActionCodeURL
/* static members */
@JSImport("firebase", "auth.ActionCodeURL")
@js.native
object ActionCodeURL extends js.Object {
  ...
  /**
    ...
    */
  def parseLink(link: String): typingsSlinky.firebase.mod.firebase.auth.ActionCodeURL | Null = js.native
}
