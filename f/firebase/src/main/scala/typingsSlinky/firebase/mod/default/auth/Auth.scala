...
object Auth extends js.Object {
  ...
  object Persistence extends js.Object {
    ...
    /**
      ...
      */
    var LOCAL: typingsSlinky.firebase.mod.firebase.auth.Auth.Persistence = js.native
    
    /**
      * Indicates that the state will only be stored in memory and will be cleared
      * when the window or activity is refreshed.
      */
    var NONE: typingsSlinky.firebase.mod.firebase.auth.Auth.Persistence = js.native
    ...
    /**
      ...
      */
    var SESSION: typingsSlinky.firebase.mod.firebase.auth.Auth.Persistence = js.native
  }
}
