...
import typingsSlinky.firebase.Anon_DisplayName
import typingsSlinky.firebase.firebaseMod.auth.ActionCodeSettings
import typingsSlinky.firebase.firebaseMod.auth.ApplicationVerifier
import typingsSlinky.firebase.firebaseMod.auth.AuthCredential
import typingsSlinky.firebase.firebaseMod.auth.AuthProvider
import typingsSlinky.firebase.firebaseMod.auth.ConfirmationResult
import typingsSlinky.firebase.firebaseMod.auth.IdTokenResult
import typingsSlinky.firebase.firebaseMod.auth.UserCredential
import typingsSlinky.firebase.firebaseMod.auth.UserMetadata
...
trait User extends UserInfo {
  ...
  /**
    ...
    */
  def updateProfile(profile: Anon_DisplayName): js.Promise[Unit] = js.native
}
