...
import typingsSlinky.firebase.firebaseMod.Observer
import typingsSlinky.firebase.firebaseMod.Unsubscribe
import typingsSlinky.firebase.firebaseMod.User
import typingsSlinky.firebase.firebaseMod.app.App
import typingsSlinky.firebase.firebaseMod.auth.Auth.Persistence
