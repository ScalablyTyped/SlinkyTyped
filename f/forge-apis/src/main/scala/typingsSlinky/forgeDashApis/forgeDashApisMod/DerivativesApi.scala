...
import typingsSlinky.forgeDashApis.Anon_AcceptEncoding
import typingsSlinky.forgeDashApis.Anon_AcceptEncodingString
import typingsSlinky.forgeDashApis.Anon_Height
import typingsSlinky.forgeDashApis.Anon_Range
import typingsSlinky.forgeDashApis.Anon_XAdsForce
...
class DerivativesApi () extends js.Object {
  ...
  /**
    ...
    */
  def getFormats(opts: Anon_AcceptEncoding, oauth2Client: AuthClient, credentials: AuthToken): js.Promise[ApiResponse] = js.native
  /**
    ...
    */
  def getManifest(urn: String, opts: Anon_AcceptEncodingString, oauth2Client: AuthClient, credentials: AuthToken): js.Promise[ApiResponse] = js.native
  /**
    ...
    */
  def getMetadata(urn: String, opts: Anon_AcceptEncodingString, oauth2Client: AuthClient, credentials: AuthToken): js.Promise[ApiResponse] = js.native
  /**
  ...
  def getModelviewMetadata(
    urn: String,
    guid: String,
    opts: Anon_AcceptEncodingString,
    oauth2Client: AuthClient,
    credentials: AuthToken
  ): js.Promise[ApiResponse] = js.native
  /**
  ...
  /**
    ...
    */
  def getThumbnail(urn: String, opts: Anon_Height, oauth2Client: AuthClient, credentials: AuthToken): js.Promise[ApiResponse] = js.native
  /**
    ...
    */
  def translate(job: JobPayload, opts: Anon_XAdsForce, oauth2Client: AuthClient, credentials: AuthToken): js.Promise[ApiResponse] = js.native
}
