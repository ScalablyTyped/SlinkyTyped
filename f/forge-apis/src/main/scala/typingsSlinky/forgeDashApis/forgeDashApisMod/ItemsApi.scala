package typingsSlinky.forgeDashApis.forgeDashApisMod

import typingsSlinky.forgeDashApis.Anon_FilterDirectionFilterExtensionType
import typingsSlinky.forgeDashApis.Anon_FilterExtensionTypeFilterId
import typingsSlinky.forgeDashApis.Anon_FilterExtensionTypeFilterIdFilterType
...
class ItemsApi () extends js.Object {
  ...
  def getItemRefs(
    projectId: String,
    itemId: String,
    opts: Anon_FilterExtensionTypeFilterId,
  ...
  def getItemRelationshipsRefs(
    projectId: String,
    itemId: String,
    opts: Anon_FilterDirectionFilterExtensionType,
    oauth2Client: AuthClient,
    credentials: AuthToken
  ): js.Promise[ApiResponse] = js.native
  /**
  ...
  def getItemVersions(
    projectId: String,
    itemId: String,
    opts: Anon_FilterExtensionTypeFilterIdFilterType,
    oauth2Client: AuthClient,
    credentials: AuthToken
  ): js.Promise[ApiResponse] = js.native
  /**
