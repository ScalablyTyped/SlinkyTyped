...
object CreateStorageDataRelationshipsTarget {
  ...
  @scala.inline
  implicit class CreateStorageDataRelationshipsTargetOps[Self <: CreateStorageDataRelationshipsTarget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: StorageRelationshipsTargetData): Self = this.set("data", value.asInstanceOf[js.Any])
