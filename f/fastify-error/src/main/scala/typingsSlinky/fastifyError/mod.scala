package typingsSlinky.fastifyError
...
object mod {
  ...
  @JSImport("fastify-error", JSImport.Default)
  @js.native
  def default(code: String, message: String, statusCode: js.UndefOr[scala.Nothing], Base: js.Error): FastifyError = js.native
  @JSImport("fastify-error", JSImport.Default)
  @js.native
  def default(code: String, message: String, statusCode: Double): FastifyError = js.native
  @JSImport("fastify-error", JSImport.Default)
  @js.native
  def default(code: String, message: String, statusCode: Double, Base: js.Error): FastifyError = js.native
