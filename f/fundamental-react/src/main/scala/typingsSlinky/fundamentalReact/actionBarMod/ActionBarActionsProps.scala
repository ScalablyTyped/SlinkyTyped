...
/* Inlined {  className ? :string,   ref ? :react.react.Ref<std.HTMLDivElement>} & react.react.HTMLAttributes<std.HTMLDivElement> */
trait ActionBarActionsProps extends js.Object {
  // RDFa Attributes
