...
import typingsSlinky.fundamentalReact.AnonClose
...
/* Inlined {  buttonProps ? :{[x: string] : any},   className ? :string,   customStyles ? :{[x: string] : any},   disableStyles ? :boolean,   dismissible ? :boolean,   link ? :string,   linkProps ? :{[x: string] : any},   linkText ? :string,   localizedText ? :{  close  :string},   type ? :fundamental-react.fundamental-react/lib/Alert/Alert.AlertType, onCloseClicked ? (event : react.react.MouseEvent<std.HTMLButtonElement, std.MouseEvent>): void} & react.react.HTMLAttributes<std.HTMLDivElement> */
trait AlertProps extends js.Object {
  ...
  var onCloseClicked: js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]] = js.undefined
  // Composition Events
...
object AlertProps {
  ...
  def apply(
    ...
    onCloseClicked: /* event */ SyntheticMouseEvent[HTMLButtonElement] => Unit = null,
