...
trait WeakValidationMapSideNavLExpanded extends js.Object {
  ...
  var onClick: js.UndefOr[
    Validator[js.UndefOr[(js.Function1[/* e */ SyntheticMouseEvent[Element], Unit]) | Null]]
  ] = js.undefined
...
object WeakValidationMapSideNavLExpanded {
  ...
  def apply(
    ...
    onClick: Validator[js.UndefOr[(js.Function1[/* e */ SyntheticMouseEvent[Element], Unit]) | Null]] = null,
