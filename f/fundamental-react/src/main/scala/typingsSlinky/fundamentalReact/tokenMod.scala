...
object tokenMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[TokenProps] = js.native
  ...
  trait TokenProps extends StObject {
    ...
    var onClick: (js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]] = js.native
  ...
  object TokenProps {
    ...
    implicit class TokenPropsMutableBuilder[Self <: TokenProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(
        value: (js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]]
  ...
  type _To = ReactComponentClass[TokenProps]
  
  /* This means you don't have to write `default`, but can instead just say `tokenMod.foo` */
  override def _to: ReactComponentClass[TokenProps] = default
}
