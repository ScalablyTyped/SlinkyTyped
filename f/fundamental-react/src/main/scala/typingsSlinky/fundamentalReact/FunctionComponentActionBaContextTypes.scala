...
import typingsSlinky.fundamentalReact.actionBarMod.ActionBarHeaderProps
import typingsSlinky.fundamentalReact.fundamentalReactStrings.ActionBarDotHeader
...
trait FunctionComponentActionBaContextTypes extends js.Object {
  ...
  def apply(props: PropsWithChildren[ActionBarHeaderProps]): ReactElement | Null = js.native
  def apply(props: PropsWithChildren[ActionBarHeaderProps], context: js.Any): ReactElement | Null = js.native
}
