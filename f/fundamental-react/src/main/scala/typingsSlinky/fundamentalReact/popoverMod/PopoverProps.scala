...
object PopoverProps {
  ...
  def apply(
    ...
    body: TagMod[Any] = null,
    children: TagMod[Any] = null,
    className: String = null,
    color: String = null,
    contentEditable: Booleanish | inherit = null,
    contextMenu: String = null,
    control: TagMod[Any] = null,
    ...
    if (!js.isUndefined(disableEdgeDetection)) __obj.updateDynamic("disableEdgeDetection")(disableEdgeDetection.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disableKeyPressHandler)) __obj.updateDynamic("disableKeyPressHandler")(disableKeyPressHandler.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useArrowKeyNavigation)) __obj.updateDynamic("useArrowKeyNavigation")(useArrowKeyNavigation.get.asInstanceOf[js.Any])
