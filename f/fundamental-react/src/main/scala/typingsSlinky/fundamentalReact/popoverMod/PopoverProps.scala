...
object PopoverProps {
  ...
  implicit class PopoverPropsOps[Self <: PopoverProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: ReactElement): Self = this.set("body", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisableEdgeDetection(value: Boolean): Self = this.set("disableEdgeDetection", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableEdgeDetection: Self = this.set("disableEdgeDetection", js.undefined)
    @scala.inline
    def setDisableKeyPressHandler(value: Boolean): Self = this.set("disableKeyPressHandler", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableKeyPressHandler: Self = this.set("disableKeyPressHandler", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnClickOutside(value: /* event */ MouseEvent | TouchEvent | FocusEvent => Unit): Self = this.set("onClickOutside", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnEscapeKey(value: () => Unit): Self = this.set("onEscapeKey", js.Any.fromFunction0(value))
    @scala.inline
    def deleteOnEscapeKey: Self = this.set("onEscapeKey", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setPlacement(value: PopperPlacement): Self = this.set("placement", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPopperProps(value: js.Any): Self = this.set("popperProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePopperProps: Self = this.set("popperProps", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setType(value: PopoverTypes): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setUseArrowKeyNavigation(value: Boolean): Self = this.set("useArrowKeyNavigation", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUseArrowKeyNavigation: Self = this.set("useArrowKeyNavigation", js.undefined)
    @scala.inline
    def setVocab(value: String): Self = this.set("vocab", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVocab: Self = this.set("vocab", js.undefined)
    @scala.inline
    def setWidthSizingType(value: PopperSizingTypes): Self = this.set("widthSizingType", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWidthSizingType: Self = this.set("widthSizingType", js.undefined)
  }
