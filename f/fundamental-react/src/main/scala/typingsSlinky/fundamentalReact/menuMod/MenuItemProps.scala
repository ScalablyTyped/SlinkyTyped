...
object MenuItemProps {
  ...
  implicit class MenuItemPropsOps[Self <: MenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddonProps(value: js.Any): Self = this.set("addonProps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAddonProps: Self = this.set("addonProps", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setUrlProps(value: js.Any): Self = this.set("urlProps", value.asInstanceOf[js.Any])
    @scala.inline
