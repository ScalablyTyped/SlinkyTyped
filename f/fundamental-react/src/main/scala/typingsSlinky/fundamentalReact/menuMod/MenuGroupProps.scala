...
/* Inlined {  title  :string,   className ? :string,   headingLevel ? :2 | 3 | 4 | 5 | 6,   titleProps ? :{[x: string] : any}} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait MenuGroupProps extends js.Object {
  // RDFa Attributes
...
object MenuGroupProps {
  @scala.inline
  def apply(): MenuGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuGroupProps]
  }
  @scala.inline
  implicit class MenuGroupPropsOps[Self <: MenuGroupProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withTitleProps(value: StringDictionary[js.Any]): Self = {
        val ret = this.duplicate
