...
/* Inlined {  title :string,   className :string | undefined,   headingLevel :2 | 3 | 4 | 5 | 6 | undefined,   titleProps :{[x: string] : any} | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
...
object MenuGroupProps {
  @scala.inline
  def apply(title: String with js.UndefOr[String]): MenuGroupProps = {
  ...
  implicit class MenuGroupPropsOps[Self <: MenuGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitle(value: String with js.UndefOr[String]): Self = this.set("title", value.asInstanceOf[js.Any])
    @scala.inline
