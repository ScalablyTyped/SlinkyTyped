package typingsSlinky.fundamentalReact.busyIndicatorMod
...
import typingsSlinky.fundamentalReact.anon.Loading
...
/* Inlined {  show :boolean,   className :string | undefined,   localizedText :{  loading :string | undefined} | undefined,   size :fundamental-react.fundamental-react/lib/BusyIndicator/BusyIndicator.BusyIndicatorSizes | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait BusyIndicatorProps extends js.Object {
  ...
  var localizedText: js.UndefOr[Loading] = js.native
  ...
  var size: js.UndefOr[BusyIndicatorSizes] = js.native
...
object BusyIndicatorProps {
  ...
  @scala.inline
  implicit class BusyIndicatorPropsOps[Self <: BusyIndicatorProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalizedText(value: Loading): Self = this.set("localizedText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSize(value: BusyIndicatorSizes): Self = this.set("size", value.asInstanceOf[js.Any])
