...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/List/List.ListProps> */
@js.native
trait WeakValidationMapListProp extends js.Object {
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[HTMLAnchorElement]]]] = js.native
...
object WeakValidationMapListProp {
  @scala.inline
  def apply(): WeakValidationMapListProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapListProp]
  }
  @scala.inline
  implicit class WeakValidationMapListPropOps[Self <: WeakValidationMapListProp] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withNoBorder(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRef(value: Validator[js.UndefOr[Null | Ref[HTMLAnchorElement]]]): Self = {
        val ret = this.duplicate
