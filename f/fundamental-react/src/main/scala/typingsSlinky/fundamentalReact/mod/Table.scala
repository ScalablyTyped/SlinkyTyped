...
object Table {
  ...
  @js.native
  def displayName: js.UndefOr[String | typingsSlinky.fundamentalReact.fundamentalReactStrings.Table] = js.native
  @scala.inline
  def displayName_=(x: js.UndefOr[String | typingsSlinky.fundamentalReact.fundamentalReactStrings.Table]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
