...
import typingsSlinky.fundamentalReact.FunctionComponentPanelAct
import typingsSlinky.fundamentalReact.FunctionComponentPanelBod
import typingsSlinky.fundamentalReact.FunctionComponentPanelFil
import typingsSlinky.fundamentalReact.FunctionComponentPanelFoo
import typingsSlinky.fundamentalReact.FunctionComponentPanelHea
import typingsSlinky.fundamentalReact.FunctionComponentPanelHeaCall
import typingsSlinky.fundamentalReact.PartialPanelProps
import typingsSlinky.fundamentalReact.WeakValidationMapPanelPro
