...
object formRadioItemMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[FormRadioItemProps] = js.native
  ...
  type _To = ReactComponentClass[FormRadioItemProps]
  
  /* This means you don't have to write `default`, but can instead just say `formRadioItemMod.foo` */
  override def _to: ReactComponentClass[FormRadioItemProps] = default
}
