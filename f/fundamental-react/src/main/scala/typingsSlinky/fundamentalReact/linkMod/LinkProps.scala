...
/* Inlined {  className :string | undefined,   href :string | undefined,   disabled :boolean | undefined,   disableStyles :boolean | undefined,   ref :react.react.Ref<std.HTMLAnchorElement> | undefined} & react.react.HTMLAttributes<std.HTMLAnchorElement> */
@js.native
