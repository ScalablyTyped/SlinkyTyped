...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/Breadcrumb/Breadcrumb.BreadcrumbProps> */
@js.native
trait PartialBreadcrumbProps extends js.Object {
  ...
  var ref: js.UndefOr[Ref[HTMLUListElement]] = js.native
...
object PartialBreadcrumbProps {
  @scala.inline
  def apply(): PartialBreadcrumbProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBreadcrumbProps]
  }
  @scala.inline
  implicit class PartialBreadcrumbPropsOps[Self <: PartialBreadcrumbProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `withAria-autocomplete`(value: none | `inline` | list_ | both): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withAria-current`(value: Boolean | page | step | location | date | time_): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withAria-dropeffect`(value: none | copy | execute | link_ | move | popup): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def `withAria-haspopup`(value: Boolean | menu_ | listbox | tree | grid | dialog): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withRef(value: Ref[HTMLUListElement]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("ref")(value.asInstanceOf[js.Any])
        ret
    }
