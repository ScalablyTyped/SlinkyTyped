...
object busyIndicatorMod extends Shortcut {
  ...
  @js.native
  val default: ReactComponentClass[BusyIndicatorProps] = js.native
  ...
  */
  ...
  type _To = ReactComponentClass[BusyIndicatorProps]
  
  /* This means you don't have to write `default`, but can instead just say `busyIndicatorMod.foo` */
  override def _to: ReactComponentClass[BusyIndicatorProps] = default
}
