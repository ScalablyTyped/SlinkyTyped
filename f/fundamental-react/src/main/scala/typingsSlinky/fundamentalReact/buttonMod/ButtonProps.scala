...
trait ButtonProps extends js.Object {
  ...
  var onClick: (js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]]) with js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.native
  ...
  var ref: js.UndefOr[ReactRef[HTMLButtonElement]] = js.native
...
object ButtonProps {
  ...
  implicit class ButtonPropsOps[Self <: ButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(
      value: (js.UndefOr[js.Function1[/* event */ SyntheticMouseEvent[HTMLButtonElement], Unit]]) with js.UndefOr[MouseEventHandler[HTMLButtonElement]]
    ...
    @scala.inline
    def setRef(value: ReactRef[HTMLButtonElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
