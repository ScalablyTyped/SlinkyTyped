...
object treeViewMod {
  ...
  @js.native
  trait TreeColProps extends StObject {
  ...
  object TreeColProps {
    ...
    @scala.inline
    implicit class TreeColPropsMutableBuilder[Self <: TreeColProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait TreeHeadProps extends StObject {
  ...
  @js.native
  trait TreeRowProps extends StObject {
  ...
  trait TreeView
    ...
    var displayName: typingsSlinky.fundamentalReact.fundamentalReactStrings.TreeView = js.native
  }
  
  /* Inlined {  disableStyles :boolean | undefined,   expandData :{[rowId: string] : boolean} | undefined,   isExpandAll :boolean | undefined,   onExpandChange :(expandData : {[rowId: string] : boolean}): void | undefined} & react.react.HTMLAttributes<std.HTMLDivElement> */
  @js.native
  trait TreeViewProps extends StObject {
    ...
    var expandData: js.UndefOr[StringDictionary[Boolean]] = js.native
    ...
    var isExpandAll: js.UndefOr[Boolean] = js.native
    ...
    var onExpandChange: js.UndefOr[js.Function1[/* expandData */ StringDictionary[Boolean], Unit]] = js.native
