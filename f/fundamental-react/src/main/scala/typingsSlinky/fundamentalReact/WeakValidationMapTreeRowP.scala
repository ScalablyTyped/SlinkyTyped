...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeRowProps> */
@js.native
trait WeakValidationMapTreeRowP extends js.Object {
  ...
  var isParent: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.native
  ...
  var onExpandClick: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]] = js.native
  ...
  var rowId: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.native
...
object WeakValidationMapTreeRowP {
  @scala.inline
  def apply(): WeakValidationMapTreeRowP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapTreeRowP]
  }
  @scala.inline
  implicit class WeakValidationMapTreeRowPOps[Self <: WeakValidationMapTreeRowP] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withIsParent(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnExpandClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onExpandClick")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutOnExpandClick: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onExpandClick")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withRowId(value: Validator[js.UndefOr[Null | String]]): Self = {
        val ret = this.duplicate
