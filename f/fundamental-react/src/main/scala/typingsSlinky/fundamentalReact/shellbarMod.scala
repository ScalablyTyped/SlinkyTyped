...
object shellbarMod {
  ...
  object default {
    ...
    @js.native
    def displayName: typingsSlinky.fundamentalReact.fundamentalReactStrings.Shellbar = js.native
    @scala.inline
    def displayName_=(x: typingsSlinky.fundamentalReact.fundamentalReactStrings.Shellbar): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  
  type Shellbar = ReactComponentClass[ShellbarProps]
  ...
  object ShellbarProps {
    ...
    implicit class ShellbarPropsMutableBuilder[Self <: ShellbarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBackAction(value: /* event */ SyntheticMouseEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "backAction", js.Any.fromFunction1(value))
