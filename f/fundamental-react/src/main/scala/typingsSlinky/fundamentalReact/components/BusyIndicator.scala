...
import typingsSlinky.fundamentalReact.busyIndicatorMod.BusyIndicatorProps
...
object BusyIndicator {
  ...
  def apply(show: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[BusyIndicatorProps]))
  }
  
  @JSImport("fundamental-react", "BusyIndicator")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def localizedText(value: Loading): this.type = set("localizedText", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def size(value: BusyIndicatorSizes): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BusyIndicatorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
