...
object Dialog {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def contentProps(value: js.Any): this.type = set("contentProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def footerProps(value: js.Any): this.type = set("footerProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def header(value: String): this.type = set("header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def headerProps(value: js.Any): this.type = set("headerProps", value.asInstanceOf[js.Any])
