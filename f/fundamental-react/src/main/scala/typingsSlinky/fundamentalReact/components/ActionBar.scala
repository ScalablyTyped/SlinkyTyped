...
object ActionBar {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def actionClassName(value: String): this.type = set("actionClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def buttonContainerClassName(value: String): this.type = set("buttonContainerClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def descriptionProps(value: js.Any): this.type = set("descriptionProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def headingLevel(value: js.Any): this.type = set("headingLevel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def onBackClick(value: /* repeated */ js.Any => _): this.type = set("onBackClick", js.Any.fromFunction1(value))
