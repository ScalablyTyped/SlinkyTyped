...
object Menu {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def addonBefore(value: Boolean): this.type = set("addonBefore", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PropsWithChildren[MenuProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  ...
  object Item {
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[slinky.web.html.li.tag.type, js.Object] {
      ...
      @scala.inline
      def addonProps(value: js.Any): this.type = set("addonProps", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def urlProps(value: js.Any): this.type = set("urlProps", value.asInstanceOf[js.Any])
  ...
  object List {
    ...
    class Builder (val args: js.Array[js.Any])
      ...
      @scala.inline
      def separated(value: Boolean): this.type = set("separated", value.asInstanceOf[js.Any])
    ...
    def withProps(p: PropsWithChildren[MenuListProps]): typingsSlinky.fundamentalReact.components.Menu.List.Builder = new typingsSlinky.fundamentalReact.components.Menu.List.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    
    implicit def make(companion: List.type): typingsSlinky.fundamentalReact.components.Menu.List.Builder = new typingsSlinky.fundamentalReact.components.Menu.List.Builder(js.Array(this.component, js.Dictionary.empty))()
  }
  ...
  object Group {
    ...
    def withProps(p: PropsWithChildren[MenuGroupProps]): typingsSlinky.fundamentalReact.components.Menu.Group.Builder = new typingsSlinky.fundamentalReact.components.Menu.Group.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
    
    @scala.inline
    def apply(title: String with js.UndefOr[String]): typingsSlinky.fundamentalReact.components.Menu.Group.Builder = {
      val __props = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
      new typingsSlinky.fundamentalReact.components.Menu.Group.Builder(js.Array(this.component, __props.asInstanceOf[PropsWithChildren[MenuGroupProps]]))
    }
  }
}
