...
object Breadcrumb {
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): typingsSlinky.fundamentalReact.components.Breadcrumb.Item.Builder = new typingsSlinky.fundamentalReact.components.Breadcrumb.Item.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: PropsWithChildren[BreadcrumbItemProps]): typingsSlinky.fundamentalReact.components.Breadcrumb.Item.Builder = new typingsSlinky.fundamentalReact.components.Breadcrumb.Item.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[slinky.web.html.ul.tag.type, HTMLUListElement] {
