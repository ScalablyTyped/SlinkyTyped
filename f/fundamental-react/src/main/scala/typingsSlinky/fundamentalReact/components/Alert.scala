...
import typingsSlinky.fundamentalReact.alertMod.AlertProps
import typingsSlinky.fundamentalReact.alertMod.AlertType
import typingsSlinky.fundamentalReact.alertMod.default
...
object Alert
  ...
  def apply(mods: TagMod[tag.type]*): BuildingComponent[tag.type, default] = new slinky.core.BuildingComponent[slinky.web.html.div.tag.type, typingsSlinky.fundamentalReact.alertMod.default](js.Array(component.asInstanceOf[js.Any], js.Dictionary.empty)).apply(mods: _*)
