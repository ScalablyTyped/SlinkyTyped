...
object LocalizationEditor {
  ...
  def withProps(p: PropsWithChildren[LocalizationEditorProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  @scala.inline
  def apply(control: ButtonProps, menu: js.Array[InputProps]): Builder = {
    val __props = js.Dynamic.literal(control = control.asInstanceOf[js.Any], menu = menu.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PropsWithChildren[LocalizationEditorProps]]))
  }
}
