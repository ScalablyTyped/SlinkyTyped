...
import typingsSlinky.fundamentalReact.anon.CounterLabel
...
object Counter {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def localizedText(value: CounterLabel): this.type = set("localizedText", value.asInstanceOf[js.Any])
    @scala.inline
    def notification(value: Boolean): this.type = set("notification", value.asInstanceOf[js.Any])
    @scala.inline
  ...
  def withProps(p: PropsWithChildren[CounterProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
