...
import typingsSlinky.fundamentalReact.avatarMod.AvatarProps
...
object Avatar {
  ...
  @JSImport("fundamental-react", "Avatar")
  @js.native
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def tile(value: Boolean): this.type = set("tile", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def zoom(value: Boolean): this.type = set("zoom", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: AvatarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @scala.inline
  def apply(placeholder: js.UndefOr[Boolean] with js.UndefOr[String]): Builder = {
