...
import typingsSlinky.fundamentalReact.titleMod.TitleProps
...
object Title {
  ...
  class Builder (val args: js.Array[js.Any])
    ...
    @scala.inline
    def levelStyle(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("levelStyle", value.asInstanceOf[js.Any])
  ...
  @scala.inline
  def apply(level: `1` | `2` | `3` | `4` | `5` | `6`): Builder = {
