...
import typingsSlinky.fundamentalReact.layoutPanelMod.LayoutPanelHeadProps
...
object LayoutPanel {
  ...
  object Actions {
    ...
    implicit def make(companion: Actions.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Actions] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Actions](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Actions] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Actions](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Body {
    ...
    implicit def make(companion: Body.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Body] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Body](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Body] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Body](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Filters {
    ...
    implicit def make(companion: Filters.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Filters] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Filters](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Filters] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Filters](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Footer {
    ...
    implicit def make(companion: Footer.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Footer] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Footer](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Footer] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Footer](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Head {
    
    @scala.inline
    def apply(title: js.UndefOr[Boolean] with js.UndefOr[String]): Builder = {
      val __props = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[LayoutPanelHeadProps]))
    }
    ...
    class Builder (val args: js.Array[js.Any])
      extends AnyVal
         with StBuildingComponent[tag.type, typingsSlinky.fundamentalReact.mod.LayoutPanel.Head] {
      ...
      @scala.inline
      def headingStyle(value: `2` | `3` | `4` | `5` | `6`): this.type = set("headingStyle", value.asInstanceOf[js.Any])
  ...
  object Header {
    ...
    implicit def make(companion: Header.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Header] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Header](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Header] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel.Header](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  implicit def make(companion: LayoutPanel.type): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HTMLAttributes[HTMLDivElement]): SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel] = new SharedBuilder_HTMLAttributes_798200686[typingsSlinky.fundamentalReact.mod.LayoutPanel](js.Array(this.component, p.asInstanceOf[js.Any]))
}
