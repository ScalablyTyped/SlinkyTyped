...
object LayoutPanel {
  ...
  class Builder (val args: js.Array[js.Any])
    extends AnyVal
       with StBuildingComponent[tag.type, typingsSlinky.fundamentalReact.mod.LayoutPanel] {
  ...
  implicit def make(companion: LayoutPanel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
}
