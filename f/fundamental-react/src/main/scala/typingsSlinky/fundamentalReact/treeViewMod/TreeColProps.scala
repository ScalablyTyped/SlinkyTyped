package typingsSlinky.fundamentalReact.treeViewMod
...
/* Inlined {  className ? :string} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait TreeColProps extends js.Object {
  // RDFa Attributes
...
object TreeColProps {
  ...
  @scala.inline
  implicit class TreeColPropsOps[Self <: TreeColProps] (val x: Self) extends AnyVal {
    @scala.inline
