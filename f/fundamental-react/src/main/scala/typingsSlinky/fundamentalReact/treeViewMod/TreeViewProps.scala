...
/* Inlined {  customStyles ? :{[x: string] : any},   disableStyles ? :boolean,   expandData ? :{[rowId: string] : boolean},   isExpandAll ? :boolean, onExpandChange ? (expandData : {[rowId: string] : boolean}): void} & react.react.HTMLAttributes<std.HTMLDivElement> */
