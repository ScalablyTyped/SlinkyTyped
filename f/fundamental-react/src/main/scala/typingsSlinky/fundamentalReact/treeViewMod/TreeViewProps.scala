...
/* Inlined {  disableStyles ? :boolean,   expandData ? :{[rowId: string] : boolean},   isExpandAll ? :boolean, onExpandChange ? (expandData : {[rowId: string] : boolean}): void} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
...
object TreeViewProps {
  ...
  implicit class TreeViewPropsOps[Self <: TreeViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withExpandData(value: StringDictionary[Boolean]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withIsExpandAll(value: Boolean): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isExpandAll")(value.asInstanceOf[js.Any])
        ret
    }
    @scala.inline
    def withoutIsExpandAll: Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("isExpandAll")(js.undefined)
        ret
    }
    @scala.inline
    ...
    @scala.inline
    def withOnExpandChange(value: /* expandData */ StringDictionary[Boolean] => Unit): Self = {
        val ret = this.duplicate
