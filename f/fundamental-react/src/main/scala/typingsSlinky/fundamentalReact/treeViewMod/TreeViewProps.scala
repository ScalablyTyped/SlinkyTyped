...
object TreeViewProps {
  ...
  implicit class TreeViewPropsOps[Self <: TreeViewProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpandData(value: StringDictionary[Boolean]): Self = this.set("expandData", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsExpandAll(value: Boolean): Self = this.set("isExpandAll", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsExpandAll: Self = this.set("isExpandAll", js.undefined)
    ...
    @scala.inline
    def setOnExpandChange(value: /* expandData */ StringDictionary[Boolean] => Unit): Self = this.set("onExpandChange", js.Any.fromFunction1(value))
