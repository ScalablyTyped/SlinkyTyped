...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeItemProps> */
@js.native
trait PartialTreeItemProps extends js.Object {
...
object PartialTreeItemProps {
  @scala.inline
  def apply(): PartialTreeItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTreeItemProps]
  }
  @scala.inline
  implicit class PartialTreeItemPropsOps[Self <: PartialTreeItemProps] (val x: Self) extends AnyVal {
    @scala.inline
