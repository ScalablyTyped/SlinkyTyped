...
trait PartialLocalizationEditor extends StObject {
  ...
  var control: js.UndefOr[ButtonProps] = js.native
  ...
  var menu: js.UndefOr[js.Array[InputProps]] = js.native
...
object PartialLocalizationEditor {
  ...
  @scala.inline
  implicit class PartialLocalizationEditorMutableBuilder[Self <: PartialLocalizationEditor] (val x: Self) extends AnyVal {
