...
@js.native
trait WeakValidationMapBreadcru extends js.Object {
...
object WeakValidationMapBreadcru {
  ...
  @scala.inline
  implicit class WeakValidationMapBreadcruOps[Self <: WeakValidationMapBreadcru] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | Ref[HTMLUListElement]]]): Self = this.set("ref", value.asInstanceOf[js.Any])
