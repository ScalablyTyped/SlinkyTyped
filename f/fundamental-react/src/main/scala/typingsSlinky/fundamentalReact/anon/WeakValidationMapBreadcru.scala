...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/Breadcrumb/Breadcrumb.BreadcrumbProps> */
@js.native
trait WeakValidationMapBreadcru extends StObject {
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[HTMLUListElement]]]] = js.native
...
object WeakValidationMapBreadcru {
  
  @scala.inline
  def apply(): WeakValidationMapBreadcru = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapBreadcru]
  }
  
  @scala.inline
  implicit class WeakValidationMapBreadcruMutableBuilder[Self <: WeakValidationMapBreadcru] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | Ref[HTMLUListElement]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
