...
/* Inlined react.react.WeakValidationMap<react.react.HTMLAttributes<std.HTMLDivElement>> */
@js.native
trait WeakValidationMapHTMLAttr extends StObject {
...
object WeakValidationMapHTMLAttr {
  
  @scala.inline
  def apply(): WeakValidationMapHTMLAttr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapHTMLAttr]
  }
  
  @scala.inline
  implicit class WeakValidationMapHTMLAttrMutableBuilder[Self <: WeakValidationMapHTMLAttr] (val x: Self) extends AnyVal {
