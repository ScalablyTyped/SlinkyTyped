...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/Breadcrumb/Breadcrumb.BreadcrumbItemProps> */
@js.native
...
object PartialBreadcrumbItemProp {
  ...
  @scala.inline
  implicit class PartialBreadcrumbItemPropMutableBuilder[Self <: PartialBreadcrumbItemProp] (val x: Self) extends AnyVal {
