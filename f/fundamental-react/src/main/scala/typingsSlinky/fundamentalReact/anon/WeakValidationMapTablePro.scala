...
trait WeakValidationMapTablePro extends StObject {
  ...
  var headers: js.UndefOr[Validator[js.UndefOr[(js.Array[ReactElement | String]) | Null]]] = js.native
...
object WeakValidationMapTablePro {
  ...
  implicit class WeakValidationMapTableProMutableBuilder[Self <: WeakValidationMapTablePro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeaders(value: Validator[js.UndefOr[(js.Array[ReactElement | String]) | Null]]): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
