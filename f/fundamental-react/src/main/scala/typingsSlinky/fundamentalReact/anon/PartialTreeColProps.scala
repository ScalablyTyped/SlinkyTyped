...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeColProps> */
@js.native
trait PartialTreeColProps extends js.Object {
...
object PartialTreeColProps {
  @scala.inline
  def apply(): PartialTreeColProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTreeColProps]
  }
  @scala.inline
  implicit class PartialTreeColPropsOps[Self <: PartialTreeColProps] (val x: Self) extends AnyVal {
    @scala.inline
