...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/LocalizationEditor/LocalizationEditor.LocalizationEditorProps> */
@js.native
trait WeakValidationMapLocaliza extends StObject {
  ...
  var control: js.UndefOr[Validator[js.UndefOr[ButtonProps | Null]]] = js.native
  ...
  var inputClassName: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.native
  ...
  var listProps: js.UndefOr[Validator[js.UndefOr[_ | Null]]] = js.native
  
  var menu: js.UndefOr[Validator[js.UndefOr[js.Array[InputProps] | Null]]] = js.native
  ...
  var popoverProps: js.UndefOr[Validator[js.UndefOr[_ | Null]]] = js.native
  ...
  var textarea: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.native
...
object WeakValidationMapLocaliza {
  
  @scala.inline
  def apply(): WeakValidationMapLocaliza = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapLocaliza]
  }
  
  @scala.inline
  implicit class WeakValidationMapLocalizaMutableBuilder[Self <: WeakValidationMapLocaliza] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControl(value: Validator[js.UndefOr[ButtonProps | Null]]): Self = StObject.set(x, "control", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputClassName(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "inputClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "listProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListPropsUndefined: Self = StObject.set(x, "listProps", js.undefined)
    
    @scala.inline
    def setMenu(value: Validator[js.UndefOr[js.Array[InputProps] | Null]]): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPopoverProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTextarea(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "textarea", value.asInstanceOf[js.Any])
