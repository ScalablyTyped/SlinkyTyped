...
object WeakValidationMapLocaliza {
  ...
  implicit class WeakValidationMapLocalizaOps[Self <: WeakValidationMapLocaliza] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def withControl(value: Validator[js.UndefOr[ButtonProps | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withInputClassName(value: Validator[js.UndefOr[Null | String]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withListProps(value: Validator[js.UndefOr[_ | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withMenu(value: Validator[js.UndefOr[js.Array[InputProps] | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withPopoverProps(value: Validator[js.UndefOr[_ | Null]]): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withTextarea(value: Validator[js.UndefOr[Boolean | Null]]): Self = {
        val ret = this.duplicate
