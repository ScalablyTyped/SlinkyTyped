...
@js.native
trait WeakValidationMapLocaliza extends js.Object {
...
object WeakValidationMapLocaliza {
  ...
  @scala.inline
  implicit class WeakValidationMapLocalizaOps[Self <: WeakValidationMapLocaliza] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControl(value: Validator[js.UndefOr[ButtonProps | Null]]): Self = this.set("control", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputClassName(value: Validator[js.UndefOr[Null | String]]): Self = this.set("inputClassName", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setListProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("listProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteListProps: Self = this.set("listProps", js.undefined)
    
    @scala.inline
    def setMenu(value: Validator[js.UndefOr[js.Array[InputProps] | Null]]): Self = this.set("menu", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPopoverProps(value: Validator[js.UndefOr[_ | Null]]): Self = this.set("popoverProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTextarea(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("textarea", value.asInstanceOf[js.Any])
