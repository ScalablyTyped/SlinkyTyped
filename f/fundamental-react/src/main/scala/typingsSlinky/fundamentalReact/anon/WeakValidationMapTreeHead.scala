...
object WeakValidationMapTreeHead {
  ...
  implicit class WeakValidationMapTreeHeadOps[Self <: WeakValidationMapTreeHead] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonProps(value: Validator[js.UndefOr[Null | StringDictionary[_]]]): Self = this.set("buttonProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsExpanded(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("isExpanded", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnExpandAll(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = this.set("onExpandAll", value.asInstanceOf[js.Any])
