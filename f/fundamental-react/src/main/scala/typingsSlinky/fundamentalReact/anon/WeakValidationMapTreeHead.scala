...
object WeakValidationMapTreeHead {
  ...
  @scala.inline
  implicit class WeakValidationMapTreeHeadMutableBuilder[Self <: WeakValidationMapTreeHead] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonProps(value: Validator[js.UndefOr[Null | StringDictionary[_]]]): Self = StObject.set(x, "buttonProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIsExpanded(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isExpanded", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnExpandAll(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = StObject.set(x, "onExpandAll", value.asInstanceOf[js.Any])
