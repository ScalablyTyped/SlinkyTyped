...
object WeakValidationMapSwitchPr {
  ...
  @scala.inline
  implicit class WeakValidationMapSwitchPrMutableBuilder[Self <: WeakValidationMapSwitchPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInputPropsUndefined: Self = StObject.set(x, "inputProps", js.undefined)
    
    @scala.inline
    def setInternalLabels(value: Validator[js.UndefOr[Checked | Null]]): Self = StObject.set(x, "internalLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInternalLabelsUndefined: Self = StObject.set(x, "internalLabels", js.undefined)
    
    @scala.inline
    def setLabelProps(value: Validator[js.UndefOr[_ | Null]]): Self = StObject.set(x, "labelProps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelPropsUndefined: Self = StObject.set(x, "labelProps", js.undefined)
    
    @scala.inline
    def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    @scala.inline
    def setSemantic(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "semantic", value.asInstanceOf[js.Any])
