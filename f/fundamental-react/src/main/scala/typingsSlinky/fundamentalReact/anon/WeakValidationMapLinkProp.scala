...
object WeakValidationMapLinkProp {
  ...
  @scala.inline
  implicit class WeakValidationMapLinkPropOps[Self <: WeakValidationMapLinkProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Validator[js.UndefOr[Null | Ref[HTMLAnchorElement]]]): Self = this.set("ref", value.asInstanceOf[js.Any])
