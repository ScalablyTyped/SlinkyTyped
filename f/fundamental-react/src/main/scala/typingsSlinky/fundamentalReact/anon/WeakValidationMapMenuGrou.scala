...
@js.native
trait WeakValidationMapMenuGrou extends js.Object {
...
object WeakValidationMapMenuGrou {
  ...
  @scala.inline
  implicit class WeakValidationMapMenuGrouOps[Self <: WeakValidationMapMenuGrou] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTitleProps(value: Validator[js.UndefOr[Null | StringDictionary[_]]]): Self = this.set("titleProps", value.asInstanceOf[js.Any])
