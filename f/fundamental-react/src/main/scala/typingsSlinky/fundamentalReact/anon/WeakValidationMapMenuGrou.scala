...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/Menu/Menu.MenuGroupProps> */
@js.native
trait WeakValidationMapMenuGrou extends StObject {
  ...
  var titleProps: js.UndefOr[Validator[js.UndefOr[Null | StringDictionary[_]]]] = js.native
...
object WeakValidationMapMenuGrou {
  
  @scala.inline
  def apply(): WeakValidationMapMenuGrou = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapMenuGrou]
  }
  
  @scala.inline
  implicit class WeakValidationMapMenuGrouMutableBuilder[Self <: WeakValidationMapMenuGrou] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadingLevel(value: Validator[js.UndefOr[`2` | `3` | `4` | `5` | `6` | Null]]): Self = StObject.set(x, "headingLevel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleProps(value: Validator[js.UndefOr[Null | StringDictionary[_]]]): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
