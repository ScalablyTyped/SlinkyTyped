...
object PartialMenuListProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(addonBefore)) __obj.updateDynamic("addonBefore")(addonBefore.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(separated)) __obj.updateDynamic("separated")(separated.get.asInstanceOf[js.Any])
