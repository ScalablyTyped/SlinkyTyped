...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/Menu/Menu.MenuListProps> */
@js.native
trait PartialMenuListProps extends js.Object {
  ...
  var addonBefore: js.UndefOr[Boolean] = js.native
  ...
  var separated: js.UndefOr[Boolean] = js.native
...
object PartialMenuListProps {
  ...
  implicit class PartialMenuListPropsOps[Self <: PartialMenuListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddonBefore(value: Boolean): Self = this.set("addonBefore", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeparated(value: Boolean): Self = this.set("separated", value.asInstanceOf[js.Any])
