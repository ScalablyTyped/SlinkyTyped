...
trait Link extends js.Object {
  ...
  var name: js.UndefOr[ReactElement] = js.native
...
object Link {
  ...
  implicit class LinkOps[Self <: Link] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNameReactElement(value: ReactElement): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setName(value: ReactElement): Self = this.set("name", value.asInstanceOf[js.Any])
