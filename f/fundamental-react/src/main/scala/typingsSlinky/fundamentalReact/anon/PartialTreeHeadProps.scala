...
@js.native
trait PartialTreeHeadProps extends StObject {
...
object PartialTreeHeadProps {
  ...
  @scala.inline
  implicit class PartialTreeHeadPropsMutableBuilder[Self <: PartialTreeHeadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnExpandAll(value: /* repeated */ js.Any => _): Self = StObject.set(x, "onExpandAll", js.Any.fromFunction1(value))
