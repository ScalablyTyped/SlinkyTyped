...
/* Inlined std.Partial<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeHeadProps> */
@js.native
trait PartialTreeHeadProps extends js.Object {
  ...
  var onExpandAll: js.UndefOr[js.Function1[/* repeated */ js.Any, _]] = js.native
...
object PartialTreeHeadProps {
  @scala.inline
  def apply(): PartialTreeHeadProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTreeHeadProps]
  }
  @scala.inline
  implicit class PartialTreeHeadPropsOps[Self <: PartialTreeHeadProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withOnExpandAll(value: /* repeated */ js.Any => _): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onExpandAll")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
