...
object WeakValidationMapTreeRowP {
  ...
  @scala.inline
  implicit class WeakValidationMapTreeRowPMutableBuilder[Self <: WeakValidationMapTreeRowP] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsParent(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isParent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnExpandClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = StObject.set(x, "onExpandClick", value.asInstanceOf[js.Any])
