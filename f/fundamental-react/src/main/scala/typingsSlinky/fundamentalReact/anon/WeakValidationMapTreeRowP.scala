...
object WeakValidationMapTreeRowP {
  ...
  implicit class WeakValidationMapTreeRowPOps[Self <: WeakValidationMapTreeRowP] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsParent(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("isParent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnExpandClick(value: Validator[js.UndefOr[(js.Function1[/* repeated */ _, _]) | Null]]): Self = this.set("onExpandClick", value.asInstanceOf[js.Any])
    @scala.inline
