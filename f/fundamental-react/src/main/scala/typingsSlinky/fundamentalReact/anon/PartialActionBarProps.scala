...
trait PartialActionBarProps extends js.Object {
  ...
  var actionClassName: js.UndefOr[String] = js.native
  var actionProps: js.UndefOr[js.Any] = js.native
  ...
  var buttonContainerClassName: js.UndefOr[String] = js.native
  ...
  var descriptionProps: js.UndefOr[js.Any] = js.native
  ...
  var onBackClick: js.UndefOr[js.Function1[/* repeated */ js.Any, _]] = js.native
...
object PartialActionBarProps {
  @scala.inline
  def apply(): PartialActionBarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialActionBarProps]
  }
  @scala.inline
  implicit class PartialActionBarPropsOps[Self <: PartialActionBarProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def withActionClassName(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withActionProps(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withActions(value: TagMod[Any]): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("actions")(value.asInstanceOf[js.Any])
        ret
    }
    ...
    @scala.inline
    def withButtonContainerClassName(value: String): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withDescriptionProps(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withHeadingLevel(value: js.Any): Self = {
        val ret = this.duplicate
    ...
    @scala.inline
    def withOnBackClick(value: /* repeated */ js.Any => _): Self = {
        val ret = this.duplicate
        ret.asInstanceOf[js.Dynamic].updateDynamic("onBackClick")(js.Any.fromFunction1(value))
        ret
    }
    @scala.inline
